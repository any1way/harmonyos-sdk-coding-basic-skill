...
scraped_at: 2026-06-01T10:48:25+08:00
doc_updated_at: 2026-01-21
content_hash: sha256:4eed4f06847cb3ef92f04ef723fa8fe3685872db13a9203fe217018acbc76914
---
## ArkUI
...
通话中，如果应用是非通话界面在前台，则需要显示画中画界面用于返回通话界面，详见在应用程序中使用[画中画功能](../../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/在应用程序中使用画中画功能/window-pipwindow.md)。
...
@ohos.hiviewdfx.hiAppEvent.d.ts中的[onReceive](<../../../../../../../harmonyos-references/调测调优/Performance Analysis Kit（性能分析服务）/ArkTS API/@ohos.hiviewdfx.hiAppEvent (应用事件打点)/js-apis-hiviewdfx-hiappevent.md#watcher>)、[takeNext](<../../../../../../../harmonyos-references/调测调优/Performance Analysis Kit（性能分析服务）/ArkTS API/@ohos.hiviewdfx.hiAppEvent (应用事件打点)/js-apis-hiviewdfx-hiappevent.md#takenext>)接口。

hiappevent.h中的[OH\_HiAppEvent\_OnReceive](<../../../../../../../harmonyos-references/调测调优/Performance Analysis Kit（性能分析服务）/C API/头文件/hiappevent.h/capi-hiappevent-h.md#oh_hiappevent_onreceive>)接口。
