...
scraped_at: 2026-06-01T10:55:46+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:ae4213c0fa5d28dc597ffd94f6107806a188dbe58ca83345df3a871adad5b464
---
...
| API使用情况举例 | 使用的最高版本API为5.0.0(12)。 | 使用的最高版本API为5.0.1(13)。 | 使用的最高版本API为5.0.1(13)。  应用使用到的某个API在5.0.2(14)进行了行为变更，变更要求应用适配并且未做[版本隔离](../影响应用兼容性的关键信息/app-compatibility-influence-factor.md#section84462041135416)。 | 使用的最高版本API为5.0.1(13)。  应用使用到的某个API在5.0.2(14)进行了行为变更，变更要求应用适配，但变更在5.0.2(14)进行[版本隔离](../影响应用兼容性的关键信息/app-compatibility-influence-factor.md#section84462041135416)。 |
...
* **[API兼容性保护和告警屏蔽](API兼容性保护和告警屏蔽/app-compatibility-apis-compatibility.md)**
* **[CAPI兼容性保护高阶用法](CAPI兼容性保护高阶用法/c-api-compatibility-warning.md)**
* **[应用升级targetSDKVersion兼容低版本指导](应用升级targetSDKVersion兼容低版本指导/app-compatibility-upgrade.md)**
* **[应用集成三方库（har包）的兼容性指导](应用集成三方库（har包）的兼容性指导/app-compatibility-third-har.md)**
* **[应用集成“集成态hsp”的兼容性指导](应用集成“集成态hsp”的兼容性指导/app-compatibility-share-hsp.md)**
* **[UI自定义组件兼容性指导](UI自定义组件兼容性指导/app-compatibility-ui-component.md)**
