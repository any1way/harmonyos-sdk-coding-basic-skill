...
scraped_at: 2026-06-12T10:34:20+08:00
doc_updated_at: 2026-04-21
content_hash: sha256:3245b46afb2fffd026f86e32efb8bc745e67927a2d1ee3028cd620e6a0e02ea5
---
**解决措施**
...
2. 通过[getRdbStore](<../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.relationalStore (关系型数据库)/Functions/arkts-apis-data-relationalstore-f.md#relationalstoregetrdbstore>)获取保存在沙箱路径下的db文件
