...
scraped_at: 2026-06-12T10:35:11+08:00
doc_updated_at: 2026-04-21
content_hash: sha256:cb000fdb4e8f71e8d79078ec9b8125e4bad2b0c662975d0870ac948106bff2fc
---
fileIo.writeSync方法中的WriteOptions.offset表示期望的文件写入位置。可以通过[filelo.read](<../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileioread>)获取偏移量offset，然后在之前的数据位置继续写入数据。参考代码如下：
