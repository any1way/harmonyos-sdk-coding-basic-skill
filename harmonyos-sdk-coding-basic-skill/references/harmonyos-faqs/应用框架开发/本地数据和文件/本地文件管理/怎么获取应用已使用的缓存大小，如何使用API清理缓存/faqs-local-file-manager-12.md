...
scraped_at: 2026-06-12T10:34:55+08:00
doc_updated_at: 2026-03-17
content_hash: sha256:6eb58293d3b9c65cf5d1ec70432eabd08ec93ac9c3d5a343341f7803438eee9b
---
**解决措施**

获取应用已使用缓存大小可以通过[storageStatistics.getCurrentBundleStats](<../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.storageStatistics (应用空间统计)/js-apis-file-storage-statistics.md#storagestatisticsgetcurrentbundlestats9>)来获取。清理缓存需要调用context的cacheDir获取缓存，然后调用系统[@ohos.file.fs](<../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md>) 接口，判断是文件或者文件夹，再分别删除缓存。
