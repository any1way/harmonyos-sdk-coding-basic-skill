...
scraped_at: 2026-06-12T10:35:25+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:2e689ea9a95fceb2630fddbeca9b271b375f66964a915321805cb912ae1b39cc
---
官网中保存用户文件提供的方法是FilePicker需要拉起系统应用，再由用户选择具体路径保存文件的，参考文档：[保存用户文件](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/选择与保存用户文件/保存用户文件/save-user-file.md>)。
