...
scraped_at: 2026-06-01T17:03:48+08:00
doc_updated_at: 2026-04-27
content_hash: sha256:772aa011eccacd7900399cb901127ef52b5fd2559c2a9e4d14b70604a65a4774
---
...
* 方案一：使用router的命名路由接口router.pushNamedRoute()跳转。
  ...
  参考地址：[页面路由 (@ohos.router)](<../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/设置组件导航和页面路由/页面路由 (@ohos.router)(不推荐)/arkts-routing.md>)
...
* 方案三：使用基于navigation组件的自定义路由框架跳转。
  ...
  方案二虽然可以实现跨模块跳转的功能，但当模块间跳转需求增多，各个模块间将存在非常复杂的依赖关系，甚至会导致多个HAR/HSP间循环依赖。为了解决模块间的强耦合关系，并且提升页面加载性能，推荐[跨包路由](<../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/设置组件导航和页面路由/Router切换Navigation/arkts-router-to-navigation.md#跨包路由>)。
