...
scraped_at: 2026-06-12T10:23:51+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:db93c75ede597f1ddcd2987e4f79cdd7cc8e5362e449d8ed7352b948f62b8410
---
**问题场景**
...
开发者可以通过DevEco Studio中Code Linter检查工具识别应用代码中的循环依赖并进行代码重构，消除循环依赖影响，工具详情请参考[代码Code Linter检查](<../../../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查/ide-code-linter.md>)。操作步骤如下：

1. 在工程根目录下创建code-linter.json5配置文件，请参考[配置代码检查规则](<../../../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查/ide-code-linter.md#section19310459444>)，rules新增"@security/no-cycle": "error"来配置循环依赖检查规则。
