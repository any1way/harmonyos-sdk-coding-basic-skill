...
scraped_at: 2026-06-12T10:36:33+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:80b28da00a316277b6d6634d54bf54a3566bb1614e23c442caacbb105827587e
---
**问题场景：**
...
应用可以监听页面加载异常的相关事件如[onErrorReceive](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#onerrorreceive>)、[onHttpErrorReceive](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#onhttperrorreceive>)和[onSslErrorEventReceive](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#onsslerroreventreceive9>)等，在对应的回调中按需实现业务逻辑，如使用[loadurl](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#loadurl>)加载自定义错误页；本文以[onErrorReceive](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#onerrorreceive>)为例对主资源报错的场景进行处理，加载本地错误页面资源文件。
