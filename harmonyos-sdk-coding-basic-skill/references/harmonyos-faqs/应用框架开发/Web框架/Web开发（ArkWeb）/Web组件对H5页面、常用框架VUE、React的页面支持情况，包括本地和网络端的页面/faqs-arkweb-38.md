...
scraped_at: 2026-06-12T10:35:53+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:425754b2895b7b10177ce29ec455b96a765dbe93e8a7e3698c389fae7bc1b247
---
Web组件支持H5页面及常用框架Vue和React。

Web组件支持加载网络页面、本地页面和HTML文本数据。详情及代码示例请参考[使用Web组件加载页面](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/管理网页加载与浏览记录/使用Web组件加载页面/web-page-loading-with-web-components.md)。
...
2. 加载本地页面时，[resource协议加载本地资源](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/管理网页加载与浏览记录/使用Web组件加载页面/web-page-loading-with-web-components.md#resource协议加载本地资源)：
