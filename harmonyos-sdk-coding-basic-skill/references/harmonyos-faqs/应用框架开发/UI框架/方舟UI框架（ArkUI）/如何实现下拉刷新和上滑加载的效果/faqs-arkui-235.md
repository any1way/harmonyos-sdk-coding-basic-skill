...
scraped_at: 2026-06-12T10:29:36+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:d04c657c69fef6295a4dfdf752be45f58f2095f9a1b74cac3475f733b6520546
---
使用[onTouch事件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)，在putDownPullUpRefresh方法里判断触摸事件是否满足下拉刷新和上滑加载的条件，同时使用条件渲染判断是否显示刷新和加载的布局。
