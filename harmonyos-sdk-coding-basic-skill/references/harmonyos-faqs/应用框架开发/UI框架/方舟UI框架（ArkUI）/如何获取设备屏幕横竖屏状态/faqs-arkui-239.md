...
scraped_at: 2026-06-12T10:29:41+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:5971b341a134b8315d853d50fa7ede102d9ee461e70efc536fdb1a061990b72d
---
方法一：利用媒体查询
...
可通过[display.getDefaultDisplaySync](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#displaygetdefaultdisplaysync9>)方法获取到[Display](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#display>)实例，再通过此实例获取其rotation属性即可获取屏幕横竖屏状态。
