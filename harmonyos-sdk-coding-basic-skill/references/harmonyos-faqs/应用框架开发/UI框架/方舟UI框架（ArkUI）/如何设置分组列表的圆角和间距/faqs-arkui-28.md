...
content_hash: sha256:de858652b0130a989be6ae2a464b7d08774b8f326f5fd6e251c606c9f7c20332
---
通过[ListItemGroup](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItemGroup/ts-container-listitemgroup.md)中的ListItemGroupStyle设置分组列表的圆角，List的[space](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#接口)设置间距。可参考如下代码：
