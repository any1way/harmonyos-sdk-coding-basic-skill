...
scraped_at: 2026-06-12T10:26:12+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:03316fc87c80e2e1886490098b9f0bfb74b6d1759c1eec67b1a303d3b73f4f72
---
在页面跳转时使用[pushPath()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#pushpath12)，添加onPop回调接收入栈页面出栈时的返回结果。当页面返回时，通过[pop()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#pop11)设置result参数并传递给目标页面，由onPop回调接收返回参数。示例代码如下：
