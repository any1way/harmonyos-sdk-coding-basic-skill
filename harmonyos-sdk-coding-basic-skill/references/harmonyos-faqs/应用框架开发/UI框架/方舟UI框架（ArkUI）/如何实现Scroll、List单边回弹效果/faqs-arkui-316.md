...
scraped_at: 2026-06-12T10:30:53+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:5eb2b5c84c3ae04a094b26c9e5d4ea8af6d9827c047b3bb69a9dec4ad5ce1135
---
1. [Scroll组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)：在onDidScroll里获取currentOffset().yOffset来控制单边回弹效果；

2. [List组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)：在onDidScroll里获取currentOffset().yOffset来控制，还可以通过onScrollIndex实现单边回弹效果。
