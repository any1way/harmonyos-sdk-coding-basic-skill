...
content_hash: sha256:d04f4e3e573bcdca4f8956f13805511c9d6142667bf5a1c0112faabb079ed435
---
**问题描述**
...
* 使用[web](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/ts-basic-components-web.md>)组件提供网页显示的方式来接入，在h5页面中使用相关播放器加载svga动画。
