...
scraped_at: 2026-06-12T10:32:19+08:00
doc_updated_at: 2026-04-27
content_hash: sha256:9f2da6ca741e5cea34dd28716a4ad69384286916907c27192a3b05dfdd78cf02
---
**可能原因一**
...
路由表配置时，可以根据[系统路由表](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/设置组件导航和页面路由/组件导航(Navigation) (推荐)/Navigation跨包路由/arkts-navigation-cross-package.md#系统路由表>)配置步骤一步一步来配置。
...
通过[hideNavBar](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#hidenavbar9)属性确认当前NavBar是否处于隐藏状态，当设置为true时，NavBar会被隐藏。如果此时页面栈为空，页面表现上会处于白屏。
