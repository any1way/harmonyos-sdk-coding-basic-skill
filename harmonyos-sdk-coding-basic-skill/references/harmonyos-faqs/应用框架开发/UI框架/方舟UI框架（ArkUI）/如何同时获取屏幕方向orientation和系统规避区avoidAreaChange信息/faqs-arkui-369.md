...
scraped_at: 2026-06-12T10:31:51+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:bf9ea43d4dc8b63dc88c292d349016e2dfef17b7603fa00d92c396ffb8b11af3
---
以折叠屏形态变化时触发为示例，可以在EntryAbility.ets文件中通过[on('avoidAreaChange')](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#onavoidareachange9>)接口监听窗口系统规避区的变化，在callback中获取avoidAreaChange信息，并通过Display实例获取屏幕方向orientation等信息。
...
[开启当前窗口系统规避区变化的监听](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#onavoidareachange9>) [显示设备当前显示的方向枚举](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#orientation10>)
