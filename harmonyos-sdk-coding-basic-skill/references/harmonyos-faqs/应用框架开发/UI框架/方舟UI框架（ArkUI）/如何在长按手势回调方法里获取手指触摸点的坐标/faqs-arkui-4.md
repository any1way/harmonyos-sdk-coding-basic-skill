...
scraped_at: 2026-06-12T10:26:06+08:00
doc_updated_at: 2026-03-17
content_hash: sha256:753855584c2cc80d5ab7bb41f99ef74042319ea23549307e442d6a15371b63f9
---
使用[组合手势](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/添加手势响应/组合手势/arkts-gesture-events-combined-gestures.md>)的顺序识别，当长按手势事件结束后触发拖动手势事件。在手势回调方法里获取event（[GestureEvent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/手势公共接口/ts-gesture-common.md#gestureevent对象说明)类型）的fingerList（[FingerInfo[]](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-gesture-common#fingerinfo8对象说明)类型），获取到localX和localY数值，表示相对于当前组件元素原始区域左上角的坐标位置。可参考如下代码：
