...
scraped_at: 2026-06-12T10:31:35+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:b28966cf9fede50ab7fdf4b2eef1179f1b8f132d38089436eefb2fea80f17aa4
---
**问题描述**
...
2. 获取并缓存窗口对象，可参考：[Interface (Window)](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md>)。
3. 在点击进入图片预览页时，使用窗口对象调用[setSpecificSystemBarEnabled()](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setspecificsystembarenabled11>)接口设置状态栏为隐藏状态。
4. 点击蒙层退出预览时，使用窗口对象调用[setSpecificSystemBarEnabled()](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setspecificsystembarenabled11>)接口设置状态栏为显示状态。
...
1. 调用[setWindowLayoutFullScreen()](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setwindowlayoutfullscreen9>)接口设置窗口全屏。
2. 使用[getWindowAvoidArea()](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.uiExtension (uiExtension)/js-apis-arkui-uiextension.md#getwindowavoidarea>)接口获取布局遮挡区域（例如状态栏、导航条）。
