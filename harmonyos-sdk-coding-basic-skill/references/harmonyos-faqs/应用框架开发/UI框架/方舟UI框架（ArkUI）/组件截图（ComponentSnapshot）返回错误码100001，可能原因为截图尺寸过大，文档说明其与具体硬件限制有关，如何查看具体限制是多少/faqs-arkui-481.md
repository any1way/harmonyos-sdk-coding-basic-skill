...
scraped_at: 2026-06-12T10:33:57+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:48eec8e785df67ce4921d871efdaba9cc8075cb3f6530c0f3f75d8370039e580
---
...
常见值为“width: 8192 height: 8192”，表示最大绘制纹理尺寸的长宽都需要在8192像素以内。比较待截图组件的尺寸，以便确认截图失败是否为该原因导致，如果是，请调整所截图组件的大小，或实现为滚动截图后自行拼接。实现请参考[截取长内容（滚动截图）](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/UI系统场景化能力/使用组件截图（ComponentSnapshot）/arkts-uicontext-component-snapshot.md#截取长内容滚动截图>)和[长截图](../../../../../best-practices/媒体/图片/长截图/bpta-long-snapshot-practice.md)。
