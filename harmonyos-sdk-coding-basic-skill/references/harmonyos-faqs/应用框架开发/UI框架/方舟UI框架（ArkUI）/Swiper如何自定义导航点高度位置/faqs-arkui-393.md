...
scraped_at: 2026-06-12T10:32:22+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:34827f8013b8999152ed86e159133e48e8b59346566fe48365fdd6c68c2de43e
---
**问题描述**

[Swiper](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md)组件内置[indicator](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md#indicator)UI样式有宽高，不支持自定义修改。
...
2. 使用[LazyForEach](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)循环渲染Column组件，并设置合适的高度和外边距，例如在Stack组件内设置[alignContent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/行列与堆叠/Stack/ts-container-stack.md#aligncontent): Alignment.Bottom参数，表示底部对齐，也可以采用[位置设置](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/位置设置/ts-universal-attributes-location.md)的方式，直接指定指示器位置。
