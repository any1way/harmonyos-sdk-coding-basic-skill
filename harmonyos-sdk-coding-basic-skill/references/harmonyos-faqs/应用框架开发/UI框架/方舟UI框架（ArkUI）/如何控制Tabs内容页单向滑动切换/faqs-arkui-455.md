...
scraped_at: 2026-06-12T10:33:26+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:4b967bd905c4d00ee0148ba4c837038002afdbfb86ab0cd4add00dccfa5647df
---
**背景知识**

[scrollable](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#scrollable)：设置是否可以通过滑动页面进行Tab页面切换，默认支持向左向右两个方向滑动。

gesture：通用属性手势绑定，可绑定[TapGesture](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/TapGesture/ts-basic-gestures-tapgesture.md)、[LongPressGesture](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/LongPressGesture/ts-basic-gestures-longpressgesture.md)、[PanGesture](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md)、[PinchGesture](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/PinchGesture/ts-basic-gestures-pinchgesture.md)、[RotationGesture](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/RotationGesture/ts-basic-gestures-rotationgesture.md)、[SwipeGesture](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/SwipeGesture/ts-basic-gestures-swipegesture.md)等手势。

**解决方案**

1. 创建活动手势的[PanGestureOptions](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#pangestureoptions)，指定滑动方向为向右滑动。
