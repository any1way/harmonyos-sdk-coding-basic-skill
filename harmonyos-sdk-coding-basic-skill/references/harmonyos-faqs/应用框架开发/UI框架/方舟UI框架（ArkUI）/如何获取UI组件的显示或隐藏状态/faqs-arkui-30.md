...
scraped_at: 2026-06-12T10:26:31+08:00
doc_updated_at: 2026-03-17
content_hash: sha256:2fb01d506d5c8858453e308246255f31a6851068def5f2ddf8e80272bb0f95b6
---
...
[@Watch装饰器：状态变量更改通知](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Watch装饰器：状态变量更改通知/arkts-watch.md>)、[if/else：条件渲染](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ifelse：条件渲染/arkts-rendering-control-ifelse.md>)
