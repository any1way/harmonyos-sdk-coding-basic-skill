...
scraped_at: 2026-06-12T10:32:05+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:10aec77082740b50f905dab27b792f67f3198ac47afc7cd734adcf505a61a204
---
模拟点击事件是指在程序中通过代码模拟触摸操作，模拟用户在界面上的点击行为，常用于自动化测试或绕过UI限制的场景。例如，使用onTouch触发按钮外区域的触摸事件，通过BuilderNode的方法传递touchEvent事件，从而实现模拟点击按钮的[TapGesture](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/TapGesture/ts-basic-gestures-tapgesture.md)手势点击事件。
