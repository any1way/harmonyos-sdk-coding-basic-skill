...
scraped_at: 2026-06-12T10:26:35+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:a7db8464dea77b16b6a1621da542b135844dcbdb49d4da4c964e4b83d04385b3
---
可以通过PanGesture绑定滑动手势事件，并使用[onActionEnd](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#事件)回调里的[velocityY](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/手势公共接口/ts-gesture-common.md#gestureevent对象说明)字段生成离手惯性滚动动画。示例如下，具体滚动的速率可以通过调整参数达到预期效果。
