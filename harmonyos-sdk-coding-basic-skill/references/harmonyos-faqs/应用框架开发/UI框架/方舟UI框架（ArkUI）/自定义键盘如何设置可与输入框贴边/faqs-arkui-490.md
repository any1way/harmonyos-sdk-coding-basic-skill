...
scraped_at: 2026-06-12T10:34:07+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:9f047214049e06ef5f8b0a3b637467ae279c2e8a87c1e259fa25b56c69d98e77
---
...
2、还可以通过设置keyboardAvoidDistance来实现和键盘贴边，示例参见：[设置弹出框避让软键盘的距离](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用弹窗/弹出框 (Dialog)/基础自定义弹出框 (CustomDialog)/arkts-common-components-custom-dialog.md#设置弹出框避让软键盘的距离>)。
