...
scraped_at: 2026-06-12T10:25:05+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:2b683513594dc6040bf9f615ea8f1702253750d96759a30201a36b12a97c717c
---
ArkTS与C/C++之间交互，涉及到跨语言调用中数据转换，以及跨线程交互等内容。沿用Node-API标准实现，支持的Node-API接口可参见[Node-API支持的数据类型和接口](../../../../../harmonyos-guides/NDK开发/代码开发/使用Node-API实现ArkTSJS与CC++语言交互/Node-API支持的数据类型和接口/napi-data-types-interfaces.md)。
...
1. OHPM HAR包依赖：
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/8R-7117QRZC7Z7Qr9VxyrQ/zh-cn_image_0000002229604253.png?HW-CC-KV=V1&HW-CC-Date=20260612T022503Z&HW-CC-Expire=86400&HW-CC-Sign=0CCCFC6C790D2EF98FE83AE1D403B7361FF80EB865284D5F5850D3F847278DEF)
