...
scraped_at: 2026-06-12T10:25:43+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:b74313398e5a8ec199a13f11b792899b823109f05b1518dd0afa124c5ef0eb63
---
**解决措施**
...
1. 缩短napi\_value对象的生命周期——使句柄的生命周期比native方法的调用生命周期更短。
   ...
   关于句柄的相关代码使用可参考：[生命周期管理](../../../../../harmonyos-guides/NDK开发/代码开发/使用Node-API实现ArkTSJS与CC++语言交互/Node-API开发规范/napi-guidelines.md#生命周期管理)
...
2. 延长napi\_value对象的生命周期——在native方法外创建和引用napi\_value对象。
   ...
   关于引用相关接口的使用可以参考：[使用callback方式示例](../../../../../harmonyos-guides/NDK开发/代码开发/使用Node-API实现ArkTSJS与CC++语言交互/Node-API典型使用场景/使用Node-API接口进行异步任务开发/use-napi-asynchronous-task.md#使用callback方式示例)
