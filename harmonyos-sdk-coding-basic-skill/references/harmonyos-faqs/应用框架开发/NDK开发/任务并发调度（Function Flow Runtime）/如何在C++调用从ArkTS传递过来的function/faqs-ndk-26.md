...
content_hash: sha256:cf103be166a4533fcc36bc1da5cf326a763c70654bd1e85aa90794fce0221c01
---
...
[Native侧方法的实现](../../../../../harmonyos-guides/NDK开发/代码开发/使用Node-API实现ArkTSJS与CC++语言交互/使用Node-API实现跨语言交互开发流程/use-napi-process.md#native侧方法的实现)
