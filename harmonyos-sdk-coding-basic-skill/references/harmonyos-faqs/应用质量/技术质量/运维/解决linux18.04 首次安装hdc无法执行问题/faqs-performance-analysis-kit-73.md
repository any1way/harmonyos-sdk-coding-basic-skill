...
content_hash: sha256:6189e359992a58190601961c6a655607666308eb6bfd6ebb4b38e5748956aa07
---
**问题现象**
...
* 使用绝对路径执行hdc命令。
  ...
  ```
* 修改环境变量增加hdc命令所在目录，可参考hdc[环境准备](../../../../../harmonyos-guides/系统/调测调优/调试命令/hdc/hdc.md#环境准备)章节配置环境变量。
