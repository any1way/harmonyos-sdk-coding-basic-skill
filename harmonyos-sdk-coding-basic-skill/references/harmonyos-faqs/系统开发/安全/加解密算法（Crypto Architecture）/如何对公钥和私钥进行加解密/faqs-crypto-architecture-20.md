...
scraped_at: 2026-06-12T10:36:59+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:524894132ea8d64f34f3acaf9e69eba6f4b51caffd62f21b055e9d75702118ab
---
使用 `@kit.CryptoArchitectureKit` 提供的密码学能力，可实现非对称加密中“公钥加密、私钥解密”的典型场景。

首先，通过 `[Base64Helper](<../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@ohos.util (util工具函数)/js-apis-util.md#base64helper9>)` 对预先定义的“公钥”和“私钥”字符串进行解码，得到原始字节数据，并将其转换为十六进制字符串，为后续密钥生成做准备。
