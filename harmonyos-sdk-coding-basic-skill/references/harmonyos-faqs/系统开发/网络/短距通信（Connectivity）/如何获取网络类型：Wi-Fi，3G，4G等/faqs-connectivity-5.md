...
scraped_at: 2026-06-12T10:38:11+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:3bb1ce76d5b6c5c91a16cde9cae15966975b27cb425f7ab0ccf55cdbe299e7f9
---
先通过[getNetCapabilities](<../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.connection (网络连接管理)/js-apis-net-connection.md#connectiongetnetcapabilities>)去获取网络的类型，判断默认网络是Wi-Fi还是蜂窝。

如果是Wi-Fi，则直接确认网络类型是Wi-Fi。如果是在蜂窝连接情况下，可以调用[radio.getSignalInformation](<../../../../../harmonyos-references/Telephony Kit（蜂窝通信服务）/ArkTS API/@ohos.telephony.radio (网络搜索)/js-apis-radio.md#radiogetsignalinformation7>)获取指定SIM卡槽对应的注册网络信号强度信息列表，返回[SignalInformation](<../../../../../harmonyos-references/Telephony Kit（蜂窝通信服务）/ArkTS API/@ohos.telephony.radio (网络搜索)/js-apis-radio.md#signalinformation>)对象的数组，其中，返回的signalType代表[网络类型NetworkType](<../../../../../harmonyos-references/Telephony Kit（蜂窝通信服务）/ArkTS API/@ohos.telephony.radio (网络搜索)/js-apis-radio.md#networktype>)，signalType的值对应网络类型如下：
