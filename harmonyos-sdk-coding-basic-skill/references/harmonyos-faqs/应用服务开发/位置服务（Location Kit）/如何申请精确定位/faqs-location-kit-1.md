...
scraped_at: 2026-06-01T17:04:43+08:00
doc_updated_at: 2026-03-10
content_hash: sha256:3986e155abf325ef18265dd8de9a47863f272a5dee71ab343e232f98999857c2
---
**问题场景**
...
精准定位结果grantStatus返回2，表示未授权，请求无效可能原因有：未在设置文件中声明目标权限、权限名非法、部分权限存在特殊申请条件，在申请对应权限时未满足其指定的条件。其他相应请求权限，返回的错误码，可参考[PermissionRequestResult](<../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/security/PermissionRequestResult/js-apis-permissionrequestresult.md>)。
