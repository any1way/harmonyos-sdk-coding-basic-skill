...
content_hash: sha256:9882f5422b329e47680c5185823f8864f428933d23ab2f24f07b9660ef5a9843
---
**问题现象**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/shC4aZXKTmmj2WevoiBjpA/zh-cn_image_0000002251128405.png?HW-CC-KV=V1&HW-CC-Date=20260612T024331Z&HW-CC-Expire=86400&HW-CC-Sign=CB147DACCC93C1A8F62209410902F71839F03D48C7148CF5D41C09E78660AB2D)

**问题原因**

**场景一**

字节码HAR（H）使用的依赖包XXX未配置在本模块的oh-package.json5的dependencies或dynamicDependencies中（错误地配置在了工程级oh-package.json5中），请参考[字节码HAR约束条件](../../../../harmonyos-guides/构建应用/配置构建流程/构建HAR/ide-hvigor-build-har.md#section38518561610)。
...
用户在工程级oh-package.json5和模块级oh-package.json5中同时依赖了XXX包的不同版本，请参考[字节码HAR约束条件](../../../../harmonyos-guides/构建应用/配置构建流程/构建HAR/ide-hvigor-build-har.md#section38518561610)。
...
将HSP包转成HAR包后，未删除"packageType"，导致按字节码进行打包的时候未解析其相关依赖，请参考[HSP转HAR指导](../../../../harmonyos-guides/基础入门/开发基础知识/典型场景的开发指导/HSP转HAR指导/hsp-to-har.md#hsp转har的操作步骤)。
...
应用依赖了包XXX，该XXX包在构建时使用了[增量构建](../../../../harmonyos-guides/构建应用/提升构建效率/增量构建/ide-hvigor-incremental-build.md)的方式，且同时修改了模块级oh-package.json5中的version字段，导致了XXX包中部分文件在寻址时还是用老的版本号去寻址，进而导致找不到相关文件。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/FO_gWVzASpyjUzACkgoKlQ/zh-cn_image_0000002215928680.png?HW-CC-KV=V1&HW-CC-Date=20260612T024331Z&HW-CC-Expire=86400&HW-CC-Sign=BB16A3930E4479EF92DFD2B7FA8F98EA7869D2EA12359327C057B80A35DF2685)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/50/v3/FiEaYDkxTIi0ilrPNP9sGg/zh-cn_image_0000002216088460.png?HW-CC-KV=V1&HW-CC-Date=20260612T024331Z&HW-CC-Expire=86400&HW-CC-Sign=34FE6ED442A2A8A9C1452DCA79AF0356DF56931BBAE2C508AA4CE9E04AEBADB6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/bULVcR6sQGO0XgS80FPW7Q/zh-cn_image_0000002251048357.png?HW-CC-KV=V1&HW-CC-Date=20260612T024331Z&HW-CC-Expire=86400&HW-CC-Sign=37D560495FDE0E3E3A30F7EBCAC6F09B9ED4CBE5BA6D051A8342C4A3FE87CC78)
