...
content_hash: sha256:0b49d8e950b0a032e0d70a1f02c49c54464e569bf7d236e935fd6a699bc3b128
---
**问题现象**
...
1. 将依赖包上传至私仓，配置私仓依赖，具体配置可参考[ohpm-repo私仓搭建工具](../../../../harmonyos-guides/开发环境搭建/工程创建/模块管理/ohpm-repo私仓搭建工具/ide-ohpm-repo.md)。
2. 或者在项目级别的oh-package.json5文件中添加[overrides](../../../../harmonyos-guides/命令行工具/三方依赖管理工具（ohpm）/oh-package.json5/ide-oh-package-json5.md#zh-cn_topic_0000001792256137_overrides)配置，覆盖依赖信息，将依赖替换为另一个版本。
