...
content_hash: sha256:159d44ed1d7e899f8440d76de2bf4ef12c917602a726e706dbda459304a36992
---
**问题现象**
...
通过[监听系统的多模态按键事件](<../../../../../harmonyos-references/基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.inputConsumer (全局快捷键)/js-apis-inputconsumer.md#inputconsumeronkeypressed16>)，拦截手机的音量的上下键的系统事件上报，并插入开发者自己的业务逻辑（比如相机拍摄、翻页阅读等功能），具体示例代码如下：
