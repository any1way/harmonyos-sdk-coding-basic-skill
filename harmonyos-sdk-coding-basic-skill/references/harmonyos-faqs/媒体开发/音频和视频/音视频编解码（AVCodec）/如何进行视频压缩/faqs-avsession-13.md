...
content_hash: sha256:33c7d8a3c62097b83a2729e13b4a3e666262c2c91fc66d2e76d3a3e0e8dda5c6
---
**问题现象**
...
使用AVCodec Kit视频编码功能，将未经压缩的视频数据传输至视频编码器进行编码处理，通过设定所需的编码格式、比特率、帧率等参数，并对编码输出进行控制，从而实现视频文件的压缩目的，编码器参数配置范围请参考：[获取支持的编解码能力](<../../../../../harmonyos-guides/媒体/AVCodec Kit（音视频编解码服务）/音视频编解码/获取支持的编解码能力/obtain-supported-codecs.md>)。
...
AVTranscoder使用方式及常见问题请参考文档：[视频转码](<../../../../../harmonyos-guides/媒体/Media Kit（媒体服务）/媒体开发指导(ArkTS)/视频转码/使用AVTranscoder实现视频转码(ArkTS)/using-avtranscoder-for-transcodering.md>)。
