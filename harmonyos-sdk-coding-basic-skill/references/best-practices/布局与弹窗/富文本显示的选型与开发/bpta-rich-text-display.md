...
scraped_at: 2026-06-11T16:55:59+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:5cdbff929fa8b9888c0716680b9b3713e33586e0828df5ad9e95e71f54af4dcb
---
## 概述
...
| 技术方案 | [Text](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)/[RichEditor](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md)+ [StyledString](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#styledstring) 属性字符串 | [Text](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)+[Span](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Span/ts-basic-components-span.md)子组件 | [Text](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)+ [enableDataDetector()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md#enabledatadetector11) 文本识别 | [RichEditor](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md)+ [addTextSpan()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addtextspan) | [Web](<../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/ts-basic-components-web.md>) | [RichText](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichText/ts-basic-components-richtext.md)(Deprecated) |
| --- | --- | --- | --- | --- | --- | --- |
| 支持元素种类 | 文本、图片、自定义 | [Span](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Span/ts-basic-components-span.md)、[ImageSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/ImageSpan/ts-basic-components-imagespan.md)、 [SymbolSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/SymbolSpan/ts-basic-components-symbolspan.md)、 [ContainerSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/ContainerSpan/ts-basic-components-containerspan.md) | [TextDataDetectorType](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#textdatadetectortype11枚举说明) 中的类型，包括电话号码、 链接、邮箱、地址、时间 | 文本、图片、自定义 | 丰富，HTML标签元素 | 支持[标签范围](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichText/ts-basic-components-richtext.md#支持标签)内的元素 |
| 扩展元素类型 | 支持 | 不支持 | 不支持 | 支持 | 不支持 | 不支持 |
| 自定义元素样式 | 支持 | [Span](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Span/ts-basic-components-span.md)、[ImageSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/ImageSpan/ts-basic-components-imagespan.md)、 [SymbolSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/SymbolSpan/ts-basic-components-symbolspan.md)、[ContainerSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/ContainerSpan/ts-basic-components-containerspan.md) 组件属性范围内的样式设置 | 支持颜色、装饰线设置 | 支持 | 通过css支持 | 通过css有限支持 |
| 元素事件类型 | 点击、长按 | [Span](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Span/ts-basic-components-span.md)、[ImageSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/ImageSpan/ts-basic-components-imagespan.md)支持点击 | 点击 | 点击、长按 | 点击 | 不支持 |
| 自定义元素事件 | 支持 | 支持 | 不支持 | 支持 | 支持 | 不支持 |
| 自定义扩展信息 | 支持 | 自行维护 | 自行维护 | 自行维护 | 自行维护 | 自行维护 |
| 加载HTML文本 并渲染显示 | 仅支持<p>、<span>、 <img> | 不支持 | 不支持 | 不支持 | 支持 | 有限支持：[标签范围](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichText/ts-basic-components-richtext.md#支持标签) |
...
| [Text](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)/[RichEditor](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md)+ [StyledString](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#styledstring) 属性字符串 | [Text](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)+[Span](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Span/ts-basic-components-span.md) 等Text的子组件 | [Text](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)+ [enableDataDetector()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md#enabledatadetector11) 文本识别方法 | [RichEditor](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md)+ [addTextSpan()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addtextspan) 类似方法 | [Web](<../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/ts-basic-components-web.md>) | [RichText](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichText/ts-basic-components-richtext.md)(Deprecated) |
| --- | --- | --- | --- | --- | --- |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/ujWFMzAwR6iWwOiSK0Ozhg/zh-cn_image_0000002383675044.png?HW-CC-KV=V1&HW-CC-Date=20260611T085557Z&HW-CC-Expire=86400&HW-CC-Sign=1EF0A056908CFA7ABD249CDACCABC8333F50C733DD05F22666B9C74981854653 "点击放大")

从上图可以看出，在简单场景中通常使用[Text](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)+[Span](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Span/ts-basic-components-span.md)组件，因为其使用简便且能满足需求，可以优先考虑。相比之下，[RichEditor](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md)+[addTextSpan()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addtextspan)较为复杂，适用于更复杂的场景。而[Text](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)/[RichEditor](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md)+[StyledString](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#styledstring)属性字符串的使用虽然更为复杂，但其兼容性更高，功能更丰富，可以根据具体场景自定义组件，适用范围更广。以下将详细介绍几种常见属性字符串的应用案例。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/6xbLma-TQWKXEtymVQf9NA/zh-cn_image_0000002383515160.png?HW-CC-KV=V1&HW-CC-Date=20260611T085557Z&HW-CC-Expire=86400&HW-CC-Sign=DB6A382741534C0F07AAEC0D9AB20D816EDDFF97F21D0555C27ABEDBC8A41008)

### 实现原理

只需对文中的@昵称和#话题等文字设置高亮样式，并添加点击跳转事件，点击后跳转至相应的话题详情页面或用户详情页面。选择的方案如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/ncg5anGjTPm-JbeEv-R2Uw/zh-cn_image_0000002417154469.png?HW-CC-KV=V1&HW-CC-Date=20260611T085557Z&HW-CC-Expire=86400&HW-CC-Sign=CF5C155DC2F5210356627BF5C693A5A379A4230FB2B126FFBC2BE04EE0300260 "点击放大")

可以通过属性字符串[StyledString](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#styledstring)中的[TextStyle](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle)属性设置样式，并通过[GestureStyle](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#gesturestyle)属性实现点击事件。

### 开发步骤

1. 初始化时通过[TextStyle](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle)属性定义文字样式，包括文字颜色、大小等。
...
2. 使用[GestureStyle](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#gesturestyle)属性定义点击超链接时的跳转事件。
...
5. 将生成的属性信息拼接成属性字符串，并绑定到[Text](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)组件以进行渲染显示。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/ERvqWTsCQ0aQ_AN_hmtg2w/zh-cn_image_0000002417234329.png?HW-CC-KV=V1&HW-CC-Date=20260611T085557Z&HW-CC-Expire=86400&HW-CC-Sign=04812C500E930A6EB78F01AFA2F7B093291E728BF5A20B2F3112BF0D348C06A0)

### 实现原理

文本中显示为表情图片，需要调整其样式设置，而无需编辑文本信息。以下是可选方案：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/AtdwBSWmTNikH8aaS6zdgA/zh-cn_image_0000002383675048.png?HW-CC-KV=V1&HW-CC-Date=20260611T085557Z&HW-CC-Expire=86400&HW-CC-Sign=6E361FE7D217720AE99533FD7AEF316A18354B262388784DFD76E318C996A119 "点击放大")

可以先获取输入字符对应的图片，然后通过属性字符串[StyledString](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#styledstring)的[ImageAttachment](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#imageattachment)属性加载图片，并使用[UserDataSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#userdataspan)属性存储自定义扩展信息。
...
3. 将输入的文本转换为图片，使用[ImageAttachment](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#imageattachment)，设置图片资源和大小等。
...
4. 将生成的属性信息拼接成属性字符串，并绑定到[Text](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)组件以进行渲染显示。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/iwVrtVyMTGe_WGP8iplhow/zh-cn_image_0000002383515168.png?HW-CC-KV=V1&HW-CC-Date=20260611T085557Z&HW-CC-Expire=86400&HW-CC-Sign=AEBDDEC9F66F06263D0A23B76A1CE29777D6F06AB080B36F9FDEAB1EA3A5150A)

### 实现原理

文本中包含一个系统小图标和一段高亮显示的文字，点击可跳转至详情页面。选择方案如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/G5mQGAhzSdyewxPKPMuB4Q/zh-cn_image_0000002417154473.png?HW-CC-KV=V1&HW-CC-Date=20260611T085557Z&HW-CC-Expire=86400&HW-CC-Sign=5A9139CD7777A026C0B250BAEB3DE3AD0A90AB266536103C51553DDF21883873 "点击放大")

需要自定义一个包含系统图标的超链接文本，可以通过属性字符串[StyledString](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#styledstring)中的[ImageAttachment](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#imageattachment)属性来加载系统图片，并通过[TextStyle](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle)属性设置来调整字体样式，点击事件则可以通过[GestureStyle](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#gesturestyle)属性来实现。
...
6. 将生成的属性信息拼接成属性字符串，并绑定到[Text](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)组件以进行渲染显示。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/F28bl6p5TnWR0-H9VKfDKw/zh-cn_image_0000002417234337.png?HW-CC-KV=V1&HW-CC-Date=20260611T085557Z&HW-CC-Expire=86400&HW-CC-Sign=60E71EAEBF1CB8365A4FAFCEBC86E7D817F8D654C204726F5CF9E43431A965E2)

### 实现原理

文本中包含一个小图标、文字和背景颜色的复杂样式。以下是选择方案：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/9ShCeQqkT2Wvd_zUvafZVg/zh-cn_image_0000002383675052.png?HW-CC-KV=V1&HW-CC-Date=20260611T085557Z&HW-CC-Expire=86400&HW-CC-Sign=0C1004B1EF11C66B17627644CCD24E02198053BAFA8ADB56D790041BDB253ECD "点击放大")

需要通过属性字符串[StyledString](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#styledstring)属性中的自定义[CustomSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#customspan)来进行绘制。

### 开发步骤

1. 创建自定义的[CustomSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#customspan)以绘制自定义样式。
...
4. 将生成的属性信息拼接成属性字符串，并绑定到[Text](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)组件以进行渲染和显示。
