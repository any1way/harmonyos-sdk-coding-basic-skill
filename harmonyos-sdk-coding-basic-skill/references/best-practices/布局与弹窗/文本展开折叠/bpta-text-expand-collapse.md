...
scraped_at: 2026-06-11T16:54:28+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:87a0a353252d4d9d8328d06fea78ee535d7dbc04cf24fdee472d3bba957c26c9
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e3/v3/3oMLYNTvRZqnOKzz5TpPpA/zh-cn_image_0000002340609309.png?HW-CC-KV=V1&HW-CC-Date=20260611T085427Z&HW-CC-Expire=86400&HW-CC-Sign=A181E9E16170B8A4A4DA90B3614C0343D35D6A48A56BC1266B40991EB373B1A7 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/01/v3/ay-zUL6aTRWhbC-DsDzfaw/zh-cn_image_0000002306649880.png?HW-CC-KV=V1&HW-CC-Date=20260611T085427Z&HW-CC-Expire=86400&HW-CC-Sign=F7A4DDEC21860D3DE039ADF294006DB42FEC7F7A04ED408A66A3CA67B6CC5EE5 "点击放大")

### 实现原理

需要计算出“...”前最后一个文字的索引和显示行高，以确定“收起”“展开”按钮的位置，其原理如图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/FTJ7wLsiQcqHiTEErLozmw/zh-cn_image_0000002306490160.png?HW-CC-KV=V1&HW-CC-Date=20260611T085427Z&HW-CC-Expire=86400&HW-CC-Sign=5492A5FD1AA4C1390CFFF354D1FB06AF37DB09136AF5E036D992613188B47683 "点击放大")

计算文本高度，结合按钮和“...”的宽度，计算收起文本最后一个文字的坐标，换算为对应内容索引，截断显示相应的内容。

分别添加“收起”“展开”按钮及交互，进行文本截断内容和全部内容展示的切换。

本示例使用measureTextSize()方法判断文字的高度，API20新增[getParagraphs20+](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (MeasureUtils)/arkts-apis-uicontext-measureutils.md#getparagraphs20>)方法测算文本。getParagraphs()方法代码量更少，更直观的获取显示行数。

### 开发步骤

1. 计算原始文本高度。

   使用[measureTextSize()](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (MeasureUtils)/arkts-apis-uicontext-measureutils.md#measuretextsize12>)方法来判断总体文字的高度。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/P4FG4MY5QYy0sEI3c9eqFg/zh-cn_image_0000002340489169.png?HW-CC-KV=V1&HW-CC-Date=20260611T085427Z&HW-CC-Expire=86400&HW-CC-Sign=7D00F8DB811444B85AA84514761E8B42F807D9A0ECA071BCA99B69ED309B5915 "点击放大")

### 实现原理

需要计算出“...”前最后一个文字的索引和显示行高，以确定“收起”“展开”按钮的位置，其原理如图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/QxzKdrCeRRSacbL7oyj0Bw/zh-cn_image_0000002340609313.png?HW-CC-KV=V1&HW-CC-Date=20260611T085427Z&HW-CC-Expire=86400&HW-CC-Sign=FC977F5F5450718229A8CEBEAD4EF59E2F2E369020BBF418A6B1975B80117CFC "点击放大")
...
1. 引用[graphics.text](<../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md>)解析文本、确定内容大小。
