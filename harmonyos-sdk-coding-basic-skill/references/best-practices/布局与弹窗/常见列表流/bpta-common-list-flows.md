...
content_hash: sha256:e61dbbeccb81e30d4e9160ea2fedcecd5c76da81946453d7832e2212cf3eba2b
---
## 概述
...
列表流主要使用[List](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)组件，按垂直方向线性排列子组件[ListItemGroup](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItemGroup/ts-container-listitemgroup.md)或[ListItem](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md)，混合渲染任意数量的图文视图，从而构建列表内容。在实际场景中，一般会根据需要，结合其它基础组件，形成相对复杂的交互功能。
...
Refresh组件可以进行页面下拉操作并显示刷新动效，List组件配合使用Swiper、Grid等基础组件用于页面的整体构建，再通过List组件的[sticky](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#sticky9)属性、[onReachEnd()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#onreachend)事件和Refresh组件的[onRefreshing()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Refresh/ts-container-refresh.md#onrefreshing)事件，实现下滑模拟刷新、上滑模拟添加数据及列表标题吸顶的效果。
...
1. 顶部搜索框区域。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2c/v3/oaPXNWQgRGWDP_iRlE7f0A/zh-cn_image_0000002229337205.png?HW-CC-KV=V1&HW-CC-Date=20260611T085429Z&HW-CC-Expire=86400&HW-CC-Sign=EBFF163DF5A8A7E3BB7385E7FE3953FCA2D0A0D062C3AA093A8EDCF8FF2AD745 "点击放大")
2. 在List的第一个ListItem分组中，使用Swiper组件构建页面轮播图内容。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/Mds4ahVTQemGkg9d8wOr8A/zh-cn_image_0000002194011424.png?HW-CC-KV=V1&HW-CC-Date=20260611T085429Z&HW-CC-Expire=86400&HW-CC-Sign=0099FE0831769A232819571AB81903B9C915915F628AAA10AFE78CBC64AB0786 "点击放大")
3. 在List的第二个ListItem分组中，使用Grid组件构建页面网格区域。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/9hydYT5rSe-QFqFKHnHTVQ/zh-cn_image_0000002193851800.png?HW-CC-KV=V1&HW-CC-Date=20260611T085429Z&HW-CC-Expire=86400&HW-CC-Sign=B1A6B4CB4A9A2F285D7BDCFE9DF4C23EC07BC3BC02E499F95FAD1164B54F3D5D "点击放大")
4. 推荐内容及列表内容的构建。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/DwcE5bemRQeBRgJ3FfN10A/zh-cn_image_0000002194011412.png?HW-CC-KV=V1&HW-CC-Date=20260611T085429Z&HW-CC-Expire=86400&HW-CC-Sign=D28F8CE452EEE4B56BF6E678341F9ECF2F0E2A4116EE5D3C0488398A600C9B59 "点击放大")
5. 将构建好的页面内容，放在Refresh组件内部，并给List和Refresh组件添加对应的[onReachEnd()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#onreachend)和[onRefreshing()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Refresh/ts-container-refresh.md#onrefreshing)回调，实现下拉模拟刷新和上滑添加列表数据的效果。
...
通过Tabs组件，配合使用Stack、Scroll、Search以及List等基础组件构建完整页面，再使用List组件的[nestedScroll](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#nestedscroll10)属性，结合calc计算高度，实现中间Tabs页签区域吸顶展示的效果。
...
1. 构建Tabs的自定义tabBar内容。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/q1VgG9kjRT-uL-_FXi7aYw/zh-cn_image_0000002229451669.png?HW-CC-KV=V1&HW-CC-Date=20260611T085429Z&HW-CC-Expire=86400&HW-CC-Sign=43B5B4C3938E03931B8120E3D5926141479DC6B3A5E10D0490A26A360394E3C6 "点击放大")
2. 构建顶部搜索区域。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/44/v3/t7WDU6I1RGab19eKvd_UDg/zh-cn_image_0000002229337189.png?HW-CC-KV=V1&HW-CC-Date=20260611T085429Z&HW-CC-Expire=86400&HW-CC-Sign=8F48D256CAB5B00B37E546B2A7D64F8EBDAE60AF7230AAE5440AAD9B615DB05C "点击放大")
3. 图片占位区域、自定义导航内容及列表内容构建。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/G6kv_gbkStCscubz2sj9Bw/zh-cn_image_0000002194011428.png?HW-CC-KV=V1&HW-CC-Date=20260611T085429Z&HW-CC-Expire=86400&HW-CC-Sign=CCA2FC4AB2B0DC770611A44FFFFDDDE5A228684C0D245B2F02AABA9673704F2F "点击放大")
4. 给List组件添加的[nestedScroll](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#nestedscroll10)属性，结合calc计算实现中间自定义Tab页签区域吸顶展示的效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7e/v3/ocpAGygsQlmoffWTUmuBKg/zh-cn_image_0000002229337229.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085429Z&HW-CC-Expire=86400&HW-CC-Sign=0CEFA859C8DF7B8462EAF3BC31A54BE43E88ACA7C549A0DEA550CB2ED46B21F5 "点击放大")
...
左侧List作为城市列表，右侧List为城市首字母快捷导航列表，通过ListItem对对应数据进行渲染展示，并使用Stack堆叠容器组件，字母导航列表覆盖城市列表上方，再给对应List添加[sticky](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#sticky9)属性和[onScrollIndex()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#onscrollindex)方法，实现两个列表数据间的联动效果。
...
4. 最后，给城市列表添加[sticky](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#sticky9)属性实现标题吸顶效果，及添加[onScrollIndex()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#onscrollindex)方法，通过selectNavIndex变量与字母导航列表内容进行关联，控制的对应字母导航内容的选中状态。

   在字母导航列表中，添加点击事件，在点击事件中通过城市列表控制器cityScroller的[scrollToIndex()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scrolltoindex)事件，控制城市列表内容的改变，实现二者数据的联动效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/Xleb4GpGTHKVlUqKvIpf2w/zh-cn_image_0000002194011392.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085429Z&HW-CC-Expire=86400&HW-CC-Sign=8DDBB696C3AFA88F5C3B64781AAB901D879F9F602A27A1E7A899A8A083BEFE31 "点击放大")
...
左右各用一个List实现，分别设置其[onScrollIndex()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#onscrollindex)事件，左侧List在回调中判断数据项切换时，调用右侧List滚动到相应类别的对应位置，右侧同理。
...
2. 给左侧导航列表添加点击事件，右侧分类详情列表添加[onScrollIndex()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#onscrollindex)事件，并调用自定义事件listChange方法，在listChange方法内部根据isGoods变量的值，调用对应列表控制器的[scrollToIndex()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scrolltoindex)事件，实现导航列表和分类详情数据的联动效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0e/v3/RaT7g3YpTW22J9jxcHTLeA/zh-cn_image_0000002193851840.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085429Z&HW-CC-Expire=86400&HW-CC-Sign=62693E6145803D396F038D090074FDFD5848CF8349B04F53BE973F1A4DC61F77 "点击放大")
