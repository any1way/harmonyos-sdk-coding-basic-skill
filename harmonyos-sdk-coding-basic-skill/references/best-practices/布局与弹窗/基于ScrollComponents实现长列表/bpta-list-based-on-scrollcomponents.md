...
content_hash: sha256:fce4a6f9fdb69412a6a20b1da760f53945d52f1072736b6829d3a0792f43489f
---
## 概述
...
ScrollComponents三方库基于系统[NodeAdapter](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#nodeadapter12>)、[BuilderNode](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/BuilderNode/js-apis-arkui-buildernode.md>)、[FrameNode](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md>)、[Prefetcher](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.Prefetcher (Prefetching)/js-apis-arkui-prefetcher.md>)、[FrameCallback](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (FrameCallback)/arkts-apis-uicontext-framecallback.md>)的能力，通过高效的组件复用、分帧预创建组件、动态内容预创建和懒加载等技术，实现了高性能的滑动效果。此外，它还基于FrameNode封装了系统List、WaterFlow、Grid组件，提供了一系列ViewManager，为开发者提供了多种系统滑动组件的能力，如列表项样式设置、首尾偏移量调整、滚动监听、边缘渐隐等，旨在简化开发流程的同时满足开发者的常规需求。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6e/v3/G7_Zpof3Tu-mwaDtobmALA/zh-cn_image_0000002356692034.png?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=2046D136F1DDEFAE936058756A26158689771984011677F8E3D9607EC479322A "点击放大")
...
2. ListManager初始化
   ...
   12. .width('100%')
   13. .edgeEffect(EdgeEffect.Spring)
   14. .layoutWeight(1)
   15. .contentStartOffset(20)// Sets the offset at the start of the content area
   16. .contentEndOffset(20)// Sets the offset at the end of the content area
   17. .scrollBar(BarState.Off)// Set the scrollbar status
   18. // ...
   19. .alignListItem(ListItemAlign.Start)// Set the direction of the List cross axis
   20. .lanes(1)// Set the number of layout columns or rows in the List portlet
   21. .fadingEdge(true, { fadingEdgeLength: LengthMetrics.vp(80) })
   22. // Nested scrolling: Set up a scrolling scheme
   23. .nestedScroll({
   24. scrollForward: NestedScrollMode.PARENT_FIRST, // The parent component scrolls first, scrolls to the edge, and then scrolls itself
   25. scrollBackward: NestedScrollMode.SELF_FIRST // Itself rolls first, and then the parent component scrolls to the edge
   26. })
   ```

   [SameItemListPage.ets](https://gitcode.com/harmonyos_samples/ListScrollComponent/blob/master/entry/src/main/ets/pages/SameItemListPage.ets#L110-L167)
3. 设置数据源渲染组件
...
4. 复用子节点模板
   ...
   2. 列表项内子组件可拆分组合
      ...
      **图2** 可拆分组件复用创建流程图  
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/WVG2IK0oTFawaJZsjY6puQ/zh-cn_image_0000002390372089.png?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=FE19CE5A777F61047948924C153AE5453998FC9937DD3F7FA5E0164EF89F39D3 "点击放大")
      ...
      **图3** 日志效果图  
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/kjZItf9gQ4KKL-ybF31KfA/zh-cn_image_0000002356851962.png?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=21272E64AE77BDA11FB552D74002A195BEAF92D3DD1E3986E04D82B0D8BAEC33 "点击放大")
...
**图4** 商品分类列表展示效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/PWC-cQpRQ9m1mGttZ6gnAA/zh-cn_image_0000002390452013.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=AC260427DE37746020FCFFB19FB9FDC90F5D84C44C52B7DC0EF4306D236E4FCD "点击放大")
...
1. 定义Item复用的模板
   ...
   [GroupLayoutListPage.ets](https://gitcode.com/harmonyos_samples/ListScrollComponent/blob/master/entry/src/main/ets/pages/GroupLayoutListPage.ets#L343-L394)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/BUGopfxvQoiKNl5_yjg05w/zh-cn_image_0000002356692062.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=4825901C4477DC8FE2F910C14BDE9916FD929C153321FA7F80E4D27E8E8B011D "点击放大")
...
**图6** 加速首屏渲染效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b/v3/b-qE-ankRe-wWHEVjYtQgw/zh-cn_image_0000002390372125.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=BF0FACCCD5A14A8B414C6E26A95C3A8C82E9E627795368820D7A222C85C39C19 "点击放大")
...
**图7** @Reusable测试结果  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/v5bVLHeeRsW1-pVV020NXw/zh-cn_image_0000002356852002.png?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=F3D6A43C694597FC2D91B01FECB7DA5B0961ED0D29D1DE95EE5019E557D46D41 "点击放大")

在ScrollComponents中，网络请求期间主线程空闲时间较少，请求结束后首屏组件的绘帧耗时较短。

**图8** ScrollComponents测试结果  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e3/v3/xYrdC9CCRNyy2y-ymDv41g/zh-cn_image_0000002390452049.png?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=AFEFC782C430452158849D54662174B05578973952BA29DB00C5D10536DD6E6E "点击放大")
...
下拉刷新是提升用户体验的关键功能，它既要确保数据无缝加载，又要保持流畅的交互效果。建议采用懒加载方式刷新数据，以避免媒体资源加载导致的UI渲染阻塞。实现逻辑可参考[实现下拉刷新上拉加载更多](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Refresh/ts-container-refresh.md#示例6实现下拉刷新上拉加载更多)。

**图9** 下拉刷新效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/TTVJruP3RWiImQLrAJDCqQ/zh-cn_image_0000002356692086.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=5126B059489CD5D8C8B8635C3CB524E41DBD1ECC8D7450B1D8518147AF5BE40E "点击放大")
...
10. @State isLoadMore: boolean = false;
11. // ...
12. @Builder
13. buildListView() {
14. RecyclerView({
15. viewManager: this.myListManager
16. })
17. }

19. build() {
20. // ...
21. Refresh({ refreshing: $$this.isRefreshing }) {
22. Column() {
23. this.buildListView();
24. // ...
25. }
26. }
27. .layoutWeight(1)
28. .onRefreshing(() => {
29. this.myViewModel.loadData((_isSuccess) => {
...
[DifferentItemListPage.ets](https://gitcode.com/harmonyos_samples/ListScrollComponent/blob/master/entry/src/main/ets/pages/DifferentItemListPage.ets#L34-L167)
...
**图10** 上拉加载效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/g-rXRO8uT5WtcwwOHEAAOA/zh-cn_image_0000002390372141.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=DBD12876F19E376BF149E8B85A5DB67E0F9CE9E2C198649F1A8ACF28A3AB52B8 "点击放大")
...
11. // ...
12. initView() {
13. this.myListManager.setItemViewStyle((_item, _index, _data: ESObject) => {
14. })
15. this.myListManager.setViewStyle({ space: 10, scroller: this.scroller })
16. // ...
17. .onReachEnd(() => {
18. if (!this.isLoadMore) {
19. this.isLoadMore = true;
20. this.myViewModel.loadDataMore((_isSuccess) => {
21. this.isLoadMore = false;
22. });
23. }
24. })
25. }
...
28. buildListView() {
29. RecyclerView({
30. viewManager: this.myListManager
31. })
32. }

34. build() {
35. // ...
36. Refresh({ refreshing: $$this.isRefreshing }) {
37. Column() {
38. this.buildListView();
39. if (this.isLoadMore) {
40. Row() {
41. LoadingProgress()
42. .width(20)
43. .height(20)
44. .color('#999999')
45. Text($r('app.string.loading_more'))
46. .fontSize(14)
47. .fontColor('#999999')
48. .margin({ left: 8 })
49. }
...
[DifferentItemListPage.ets](https://gitcode.com/harmonyos_samples/ListScrollComponent/blob/master/entry/src/main/ets/pages/DifferentItemListPage.ets#L35-L168)
...
**图11** 无限滑动效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/Dw3hHH50Sxew5Mw4WX1h6A/zh-cn_image_0000002356852014.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=D338FEA8EC72B92BA67333B29B9F8D9731885969914EDB0356886C39149A176B "点击放大")
...
4. 监听滑动组件子组件变化事件
   ...
   [CombineItemListPage.ets](https://gitcode.com/harmonyos_samples/ListScrollComponent/blob/master/entry/src/main/ets/pages/CombineItemListPage.ets#L32-L132)
5. 自定义Image组件，双向绑定数据
   ...
   [CombineItemListPage.ets](https://gitcode.com/harmonyos_samples/ListScrollComponent/blob/master/entry/src/main/ets/pages/CombineItemListPage.ets#L226-L263)
...
**图12** 侧滑删除效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/PEF_Jc0eQfyzhPiv3J3Zlw/zh-cn_image_0000002390452057.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=1D2C8EEF85A2FC98E8D47AFDF388F9A9462E9221FDB2906F54B3E5B70A31F5BD "点击放大")
...
List组件作为整个首页长列表的容器，通过ListItem对不同模块进行视图界面的定制，常用于门户首页、商城首页等多类型视图展示的列表信息流场景。多类型列表项场景（List+ListHeaderView）参考：[常见列表流开发实践：多类型列表项场景](../常见列表流/bpta-common-list-flows.md#section20614147618)。

**图13** ListHeaderView滑动效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/-FUqxyGTTc6qRT9QKCcvnA/zh-cn_image_0000002356692098.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=54E03A50038AD4890207236FEAF47A7447B6A02E71116EB5168D84514E0ACF87 "点击放大")
...
37. @Component
38. export struct ListHeaderView {
39. build() {
40. Column() {
41. // ListHeaderView: You can set up various types of subassemblies
42. // Swiper(...){...}
43. // Grid(...){...}
44. // CustomComponent(...){...}
45. Stack({ alignContent: Alignment.Center }) {
46. Image($r('app.media.pic1'))
47. Row() {
48. Text($r('app.string.i_am'))
49. .fontSize(16)
50. .fontColor('#333')
51. Text(' ListHeaderView')
52. .fontSize(16)
53. .fontColor('#333')
54. }
55. }
...
[GroupLayoutListPage.ets](https://gitcode.com/harmonyos_samples/ListScrollComponent/blob/master/entry/src/main/ets/pages/GroupLayoutListPage.ets#L128-L479)
...
Tabs嵌套List的吸顶效果，常用于新闻和资讯类应用的首页。长列表Tabs吸顶功能参考：[常见列表流开发实践：Tabs吸顶场景](../常见列表流/bpta-common-list-flows.md#section103354617711)

**图14** Tabs的TabBar吸顶效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/uWvSLv6oQLSvKka78gm3mA/zh-cn_image_0000002390372145.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=6FF7DC0BAD0148CC5C6D81B6E73D13B6C4BC6B7A689D387CF82C19BEA0945C4A "点击放大")
...
双列表同向联动，左侧分类列表用于快速索引，内容列表依据分类进行分组，常用于商品分类选择、通讯录、城市选择、分组选择等页面。长列表分组吸顶功能参考：[常见列表流开发实践：分组吸顶场景](../常见列表流/bpta-common-list-flows.md#section16551551888)。

本案例实现商品分类选择页面列表头部分类吸顶效果，如下图所示。

**图15** 分组布局组头吸顶效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/FmeK23MjTcGRqhhBwJ2Qzg/zh-cn_image_0000002356852018.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=440C4ABE2EC0284D6C940C692014408F75DDBF955E6BA856E3935FC33A6EECFB "点击放大")
...
通过选择左侧的一级列表，右侧的二级列表数据将相应更新，常用于商品分类选择、编辑风格等二级类别选择页面。长列表二级联动功能参考：[常见列表流开发实践：二级联动场景](../常见列表流/bpta-common-list-flows.md#section323632114913)。

本场景以商品分类列表页面为例，分别使用List组件展示左侧分类导航和右侧导航内容。进入页面后，点击左侧分类导航，右侧将展示对应的分类详情列表数据；滑动右侧列表内容时，列表标题将吸顶显示，同时左侧对应的导航内容高亮显示。

**图16** 长列表二级联动效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/bYdGTg8jTmGWNSLeCuzIQw/zh-cn_image_0000002390452065.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=9C1F9125AC84A5AB787184D307275B94D862B8C228335AAA803352BFFAA8FAB8 "点击放大")
...
3. 为左侧导航列表添加点击事件，为右侧分类详情列表添加[onScrollIndex()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#onscrollindex)事件，并调用自定义的listChange方法。在listChange方法内部，根据isGoods变量的值，调用相应列表控制器的[scrollToIndex()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scrolltoindex)方法，以实现导航列表和分类详情数据的联动效果。
...
**图17** 动态切换列数效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/VkZF5FgLRDmwqc2lKc94SQ/zh-cn_image_0000002356692102.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=8B6AA5D15A0E34980E8C099412A24FEBFDE221DDB2D53826E73F4B4DD1B72417 "点击放大")
...
通过设置[fadingEdge](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/滚动组件通用接口/ts-container-scrollable-common.md#fadingedge14)属性来实现边缘渐隐效果，效果如图所示。

**图18** 边缘渐隐效果图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/84/v3/lnMVC1lnRLqCNv6DBFrWIg/zh-cn_image_0000002390372153.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085523Z&HW-CC-Expire=86400&HW-CC-Sign=6B137D707AC9D2CC3B815B5AF93E916EBC5C4D4E445B8A43DA55C90DCC2EB89F "点击放大")
