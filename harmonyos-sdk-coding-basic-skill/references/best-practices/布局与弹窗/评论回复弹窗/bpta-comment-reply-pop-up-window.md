...
scraped_at: 2026-06-11T16:55:05+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:77818eb6ef2a0b2e1ff4bb658f718023e1547f635807359ecf8d809fb9454777
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/naRqxYNpRq20Wuz6q9KNwA/zh-cn_image_0000002229337549.png?HW-CC-KV=V1&HW-CC-Date=20260611T085452Z&HW-CC-Expire=86400&HW-CC-Sign=A496C7DFB37DE958CAC809BB2A3349F613573A836360C17FBAC97132D7746CAA "点击放大")
...
* [组件导航（Navigation）](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/设置组件导航和页面路由/组件导航(Navigation) (推荐)/arkts-navigation-navigation.md>)
* [支持图文混排和文本交互式编辑的组件（RichEditor）](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md)
* [自定义弹窗（CustomDialog）](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/弹窗/自定义弹窗 (CustomDialog)/ts-methods-custom-dialog-box.md>)
* [半模态转场（.bindSheet）](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/模态转场设置/半模态转场/ts-universal-attributes-sheet-transition.md#bindsheet)

## 实现原理

### 弹窗组件选型

通过对[CustomDialog自定义弹窗](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/弹窗/自定义弹窗 (CustomDialog)/ts-methods-custom-dialog-box.md>)、[bindSheet半模态弹窗](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/模态转场设置/半模态转场/ts-universal-attributes-sheet-transition.md#bindsheet)、Navigation Dialog（即[页面显示类型](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/设置组件导航和页面路由/组件导航(Navigation) (推荐)/Navigation子页面/arkts-navigation-navdestination.md#页面显示类型>)中的弹窗类型）三种弹窗方案进行尝试，发现自定义弹窗和半模态弹窗有一定规格限制，会产生一些无法避免的问题，最终选用Navigation Dialog（即[页面显示类型](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/设置组件导航和页面路由/组件导航(Navigation) (推荐)/Navigation子页面/arkts-navigation-navdestination.md#页面显示类型>)中的弹窗类型）方案实现评论模块弹窗。以下对三种方案优劣势进行一个详细的说明。

* [CustomDialog自定义弹窗](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/弹窗/自定义弹窗 (CustomDialog)/ts-methods-custom-dialog-box.md>)
  ...
  [PromptAction.openCustomDialog](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (PromptAction)/arkts-apis-uicontext-promptaction.md#opencustomdialog12>)与自定义弹窗呈现效果相同，不再赘述。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/-kCG2CLkREu9Jcg8YEECyQ/zh-cn_image_0000002193852164.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085452Z&HW-CC-Expire=86400&HW-CC-Sign=FF9E4F82C0BF595146C663C7E8FED3EFB3428B8B200A57101309611A18F511C6 "点击放大")
* [bindSheet半模态弹窗](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/模态转场设置/半模态转场/ts-universal-attributes-sheet-transition.md#bindsheet)
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1/v3/Vc2nr88nSUyWnv2FFsI-Xg/zh-cn_image_0000002194011744.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085452Z&HW-CC-Expire=86400&HW-CC-Sign=46AA2F527DF62BA91F2BAB6A90CF933AE579B6D7BD5A0C8DF741AD1D34ACC83A "点击放大")
* Navigation Dialog
...
Navigation Dialog（即[页面显示类型](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/设置组件导航和页面路由/组件导航(Navigation) (推荐)/Navigation子页面/arkts-navigation-navdestination.md#页面显示类型>)中的弹窗类型）在z轴的层级较低，评论模块如果基于该方案实现，那么在其他使用了CustomDialog、bindSheet的弹窗模块（例如评论列表）中调用评论模块，评论模块会在其他弹窗模块下层，所以其他弹窗模块也需要一同改为Navigation Dialog（即[页面显示类型](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/设置组件导航和页面路由/组件导航(Navigation) (推荐)/Navigation子页面/arkts-navigation-navdestination.md#页面显示类型>)中的弹窗类型）实现，通过路由栈进行弹窗层级的控制。

### 编辑区域组件及方法选型

编辑区域支持输入文字、表情、@好友等内容。目前支持图文混排和文本交互式编辑的组件，[RichEditor](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md)是不二的选择。针对添加表情，可使用[RichEditorController.addImageSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addimagespan)方法实现。@好友可使用[RichEditorController.addTextSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addtextspan)和[RichEditorController.addBuilderSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addbuilderspan11)两种方法实现，通过以下对两种方法的分析对比，最终选择addBuilderSpan实现@好友功能。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/09/v3/-2hlAS9KSA2pPibPDwrpOg/zh-cn_image_0000002229337541.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085452Z&HW-CC-Expire=86400&HW-CC-Sign=DC84518C37D7B9D915F367C039AFF52E5096CA892E89C9355E94F78F8BFAD66C "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/aWgGEVOcQWCZIp6dLoXmHA/zh-cn_image_0000002193852160.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085452Z&HW-CC-Expire=86400&HW-CC-Sign=890BFF56481C3DF2EDE2C5FEE48C3C4B13F2E6E2CD065C82F7E59E1CBE42355D "点击放大")

本文选择自定义键盘来控制软键盘和表情面板的切换。通过设置[RichEditor.customKeyboard](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#customkeyboard)为表情面板组件的构建函数EmojiKeyboard，来展示表情面板，设置该属性为undefined，则展示默认软键盘。通过这种方式在软键盘与表情面板切换时也无需手动进行richEditor焦点的处理。
...
为保证切换软键盘和表情面板时，评论模块整体高度不发生改变，则需要获取软键盘高度对表情面板高度进行计算和手动设置。有可能软键盘高度被手动更改，所以需要通过[keyboardHeightChange](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#onkeyboardheightchange7>)事件对软键盘高度进行监听，当高度大于0时，更新记录软键盘高度的状态变量。注意在组件销毁前取消对应的监听事件。
...
* 添加表情
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/UpvPc9WcSoS-H01cesBJ5Q/zh-cn_image_0000002194011748.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085452Z&HW-CC-Expire=86400&HW-CC-Sign=36596AE970537F2BF878F33510474C21ED2FB8A25A6809A4A35D0CF90B30CF35 "点击放大")

  在表情面板或常用表情列表中点击表情时可通过[RichEditorController.addImageSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addimagespan)在编辑区域进行添加图片表情，注意需要设置offset属性为当前光标位置，当前光标的位置可通过[RichEditorController.getCaretOffset](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#getcaretoffset10)获取。这样使得表情在当前光标后添加，否则默认在内容的最后方添加，后文类似的添加操作都遵循此规则。
...
* @好友
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/HQmmVe4YQzqXvMtHhdxGzA/zh-cn_image_0000002229452041.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085452Z&HW-CC-Expire=86400&HW-CC-Sign=BD6DAD18E2DF27BA8879947549B9D1182C5FFBDD4F9E2D1C6838DFEFC87E900B "点击放大")

  点击@按钮时，通过[RichEditorController.addTextSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addtextspan)添加@符号，并显示好友列表。同时需要监听[RichEditor.aboutToIMEInput](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#abouttoimeinput)事件 ，该事件在输入内容前触发回调，在回调中获取要输入的内容，如果输入的内容为@，则相当于点击了@按钮的效果，这样统一了点击@按钮和键盘输入@的逻辑，方便后续一些细节的处理。
  ...
  在好友列表中点击好友头像时，通过[RichEditorController.getSpans](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#getspans)可以获取光标前一个span的内容，若光标前一个span是内容为@的textSpan，则先删除，然后通过[RichEditorController.addBuilderSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addbuilderspan11)将“@[好友昵称]”以指定的样式作为一个整体添加到编辑区域中。
...
* 删除内容
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e2/v3/szsqxPZpSb2glYabFoROzQ/zh-cn_image_0000002229452037.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085452Z&HW-CC-Expire=86400&HW-CC-Sign=DC8B271545692B6DAD01C26EAF0737A311202043452EF55F29F6B13155876316 "点击放大")

  监听[RichEditor.aboutToDelete](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#abouttodelete)事件，可通过回调中返回false阻止编辑区域默认的删除行为。在第一次删除builderSpan（@好友）的时候，先使用[RichEditorController.setSelection](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#setselection11)对整体进行选中，再次点击删除键时选中内容在RichEditor中会默认被整体删除。
...
* 内容获取与展示
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/nwGhbd6-Rl67pwoBVSmtcQ/zh-cn_image_0000002229337545.png?HW-CC-KV=V1&HW-CC-Date=20260611T085452Z&HW-CC-Expire=86400&HW-CC-Sign=30A4E8350426E7F49C755B38B5C8A1EB30C91EC90881EED02DC38625B67A355B "点击放大")

  可以通过[RichEditorController.getSpans](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#getspans)来获取编辑区域所有的内容，获取到的内容在getSpans方法的返回值中表现为[RichEditorTextSpanResult](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#richeditortextspanresult)和[RichEditorImageSpanResult](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#richeditorimagespanresult)两种类型。上文中提到过文字、图片表情、@好友三种内容与这两种类型的对应关系如下表：

  | 本文中的定义 | 对应编辑区域内容 | 添加方式 | getSpans方法返回值中对应的类型 |
  | --- | --- | --- | --- |
  | textSpan | 连续的文字 | 键盘输入或[RichEditorController.addTextSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addtextspan) | [RichEditorTextSpanResult](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#richeditortextspanresult) |
  | imageSpan | 图片表情 | [RichEditorController.addImageSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addimagespan) | [RichEditorImageSpanResult](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#richeditorimagespanresult) |
  | builderSpan | @[好友昵称] | [RichEditorController.addBuilderSpan](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addbuilderspan11) | [RichEditorImageSpanResult](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#richeditorimagespanresult) |
