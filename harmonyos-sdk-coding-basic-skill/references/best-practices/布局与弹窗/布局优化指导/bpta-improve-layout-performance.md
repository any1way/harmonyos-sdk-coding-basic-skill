...
scraped_at: 2026-06-11T16:54:30+08:00
doc_updated_at: 2026-03-19
content_hash: sha256:c53eee4949af12d66c0b40d4ef60472c4891fc8fc8487ad07b3928fa8f23c86d
---
## ArkUI框架执行流程
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/fXfMmX9rRWOt9BJfk-vMgw/zh-cn_image_0000002229450845.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085428Z&HW-CC-Expire=86400&HW-CC-Sign=C1F1E1114B5BBE58DAE8F7C5183F873A0EF02E0150DB368428A910FFB6762B4B "点击放大")

应用界面更新的过程主要分为两个过程：**数据处理过程和UI更新过程**。

1. 数据处理过程中主要是对状态数据进行更新，状态数据指的是所定义的@State等相关的数据。数据变化时，会有一定的更新耗时，并且数据关联的组件数量，也影响下一步UI更新的耗时，在开发过程中需要避免无效的数据更新，从而减少冗余的UI更新耗时。关于这部分的优化措施可以参考《[状态管理最佳实践](../../声明式语法/状态管理最佳实践/bpta-status-management.md)》。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/hx5xaze3SiCYIFceRVGjqw/zh-cn_image_0000002229336385.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085428Z&HW-CC-Expire=86400&HW-CC-Sign=AE72FA7036758288599F8E14E0F7AD70360E616A68AE47008A96E0C1069D4AEF "点击放大")

确定实际的脏节点数组后，根据脏节点数组来拿到对应的脏节点对象，通过递归遍历children进行Measure过程，如果该对象布局参数没有发生变化，就会跳过对应的Measure阶段。当Measure执行完成后，进行layout阶段。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/PISqenG0TtyoSllGSHxQzA/zh-cn_image_0000002194010580.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085428Z&HW-CC-Expire=86400&HW-CC-Sign=0EA27292DD26322BDCC1ABEF83888237B93485CDA2F74B9BA9CB23B47EC292EC "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/W6oYZHnJSE-aIhs7OCnpZA/zh-cn_image_0000002193850984.png?HW-CC-KV=V1&HW-CC-Date=20260611T085428Z&HW-CC-Expire=86400&HW-CC-Sign=9CF2788345F6FAE85EC6C99267C9F70C31F519DA604A514BEC2C275A4BCA7F75 "点击放大")
...
**图1** 扁平化布局示意图   
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/lo56PX9wSKKvctrv4h2lew/zh-cn_image_0000002194010584.png?HW-CC-KV=V1&HW-CC-Date=20260611T085428Z&HW-CC-Expire=86400&HW-CC-Sign=38F9D54891331909649D407903FCDCF43E88B5DE864F4298EAD5852FF32E97A0 "点击放大")
...
* [RelativeContainer](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/组件布局/构建布局/相对布局 (RelativeContainer)/arkts-layout-development-relative-layout.md>) 通过相对布局实现扁平化。
* [绝对定位](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/位置设置/ts-universal-attributes-location.md#position) 通过锚点定位实现扁平化。
* [Grid](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/列表与网格/创建网格 (GridGridItem)/arkts-layout-development-create-grid.md>) 通过二维布局实现扁平化。
...
在列表场景下会采用[List](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)、[Grid](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)、[WaterFlow](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)等组件配合[ForEach](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/ForEach/ts-rendering-control-foreach.md)或者[LazyForEach](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)来实现，ForEach适合内容长度确定，内容在两屏以内的列表。LazyForEach适合长度超过两屏的列表情况，并且当内容布局相对固定的情况下，配合组件复用的方式来减少滑动过程中的组件创建。在[长列表加载丢帧优化](../../性能/性能场景优化案例/界面渲染性能优化/长列表加载丢帧优化/bpta-best-practices-long-list.md)中，介绍了较为详细的实践案例，这里我们仅引用一些关键性能收益数据。
...
* 使用[Row](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/行列与堆叠/Row/ts-container-row.md)、[Column](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/行列与堆叠/Column/ts-container-column.md)构建线性布局。
* 使用[Stack](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/行列与堆叠/Stack/ts-container-stack.md)构建层叠布局。

上述布局都属于线性布局，顾名思义，在线性布局中排布的组件是按照特定的方向线性放置，如横向/纵向/Z序方向。除上述布局类型外，还有一些复杂布局能力，如[Flex](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/行列与堆叠/Flex/ts-container-flex.md)、[List](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)、[Grid](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)、[RelativeContainer](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/行列与堆叠/RelativeContainer/ts-container-relativecontainer.md)和自定义布局等。
...
**图2** List宽高不固定   
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/T3crHFw3RheH856Y--maaQ/zh-cn_image_0000002229336365.png?HW-CC-KV=V1&HW-CC-Date=20260611T085428Z&HW-CC-Expire=86400&HW-CC-Sign=D95B5355E1EF3AC89313547BBCC930D6E773AF2ED3A2F6311E30B9E5D051284F "点击放大")

**图3** List宽高固定   
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/m1pCZlQ7TKyVD7JZm9HGpQ/zh-cn_image_0000002194010576.png?HW-CC-KV=V1&HW-CC-Date=20260611T085428Z&HW-CC-Expire=86400&HW-CC-Sign=856B90B34E67514CFA2037983226DBA8069E4C591A91D24F9654C3E1661FF9B5 "点击放大")
...
性能是一个涉及许多方面的复杂问题。DevEco Studio提供了工具可以为您提供关于性能瓶颈发生位置的明确提示，使用工具Profiler 查看性能参数可以参考[使用Profiler进行性能调优](../../../harmonyos-guides/优化应用性能/使用Profiler进行性能调优/ide-profiler-introduction.md)，使用ArkUI Inspector查看组件树结构可以参考[布局分析](../../../harmonyos-guides/编写与调试应用/应用调试/布局分析/ide-arkui-inspector.md)。
