...
scraped_at: 2026-06-11T16:59:02+08:00
doc_updated_at: 2026-05-22
content_hash: sha256:8800c5d24ac00047738d80560919670899e238689e76a29b666ee9697fb7f2e3
---
## 概述
...
1. 广播与扫描阶段：服务端创建[GattServer](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#gattserver>)实例，定义服务特征并配置广播参数，验证蓝牙状态后启动广播，使自身可被发现；客户端确保蓝牙开启，设置扫描过滤条件，注册设备发现回调并启动扫描，收集可连接设备。
2. 连接管理阶段：服务端调用[on('connectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onconnectionstatechange>)订阅GATT profile协议的连接状态变化事件，管理连接生命周期；客户端基于扫描到的服务端广播地址创建[GattClientDevice](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#gattclientdevice>)实例，调用[on('BLEConnectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onbleconnectionstatechange>)订阅GATT profile协议的连接状态变化事件，发起连接请求，成功后获取服务与特征，启用特征值通知功能，为数据传输做准备。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1a/v3/6oLkOw83SwWdGg3w-ge_kA/zh-cn_image_0000002492448638.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085901Z&HW-CC-Expire=86400&HW-CC-Sign=908AC4FB4E9F154FBB34A475FF93672FB3E32CDCF75FFE54E87F440584C62DA1 "点击放大")

### 关键技术

实现BLE通信能力主要需要使用[@ohos.bluetooth.ble (蓝牙ble模块)](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md>)、[@ohos.bluetooth.access (蓝牙access模块)](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md>)中提供的API能力，服务端主要使用[开启蓝牙](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessenablebluetooth>)、[创建服务器实例](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blecreategattserver>)、[发送BLE广播](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestartadvertising>)、[特征值变化通知](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#notifycharacteristicchanged>)等API；客户端主要使用[开启蓝牙](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessenablebluetooth>)、[订阅BLE设备扫描结果](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#bleonbledevicefind>)、[BLE设备扫描](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestartblescan>)、[蓝牙连接](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#connect>)、[订阅蓝牙低功耗设备的特征值变化](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onblecharacteristicchange>)、[订阅蓝牙低功耗设备的连接状态变化事件](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onbleconnectionstatechange>)、[持久化存储蓝牙设备的虚拟MAC地址](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessaddpersistentdeviceid16>)等API。
...
1. 检查蓝牙是否开启，若未开启则调用[enableBluetooth()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessenablebluetooth>)接口开启蓝牙；
2. 调用[createGattServer()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blecreategattserver>)接口创建[GattServer](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#gattserver>)实例，即表示创建GATT连接中的服务端；
3. 调用[addService()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#addservice>)接口在服务端添加服务；
4. 调用[startAdvertising()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestartadvertising>)接口开始发送BLE广播，向连接的客户端设备提供数据；
5. 调用[on('connectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onconnectionstatechange>)方法在服务端订阅GATT profile协议的连接状态变化事件；
6. 调用[notifyCharacteristicChanged()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#notifycharacteristicchanged>)接口，在服务端特征值发生变化时，主动通知已连接的客户端设备。

**客户端**

1. 检查蓝牙是否开启，若未开启则调用[enableBluetooth()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessenablebluetooth>)接口开启蓝牙；
2. 调用[ble.on('BLEDeviceFind')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#bleonbledevicefind>)接口订阅BLE设备扫描结果上报事件，并调用[startBLEScan()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestartblescan>)接口发起BLE扫描流程；
3. 调用[createGattClientDevice(deviceId)](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blecreategattclientdevice>)接口，基于扫描到的服务端的广播地址创建[GattClientDevice](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#gattclientdevice>)实例，即表示创建GATT连接中的客户端；
4. 调用[on('BLEConnectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onbleconnectionstatechange>)接口订阅GATT profile协议的连接状态变化事件，随后调用[connect()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#connect>)接口发起连接远端BLE设备；
5. 当[on('BLEConnectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onbleconnectionstatechange>)回调函数返回的连接状态为[STATE\_CONNECTED](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.constant (蓝牙constant模块)/js-apis-bluetooth-constant.md#profileconnectionstate>)时，调用[getServices()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#getservices>)进行服务发现，获取服务端设备支持的所有服务；
6. [getServices()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#getservices>)发现服务后，调用[setCharacteristicChangeNotification()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangenotification>)启用接收服务端特征值内容变更通知，并调用[on('BLECharacteristicChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onblecharacteristicchange>)接口订阅蓝牙低功耗设备的特征值变化事件；
7. 启用接收服务端特征值内容变更通知成功后，客户端调用[writeCharacteristicValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#writecharacteristicvalue>)或[writeDescriptorValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#writedescriptorvalue>)向指定的服务端特征值或描述符写入数据。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/wCJHi8UmRW2IB6DthFov2A/zh-cn_image_0000002524568343.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085901Z&HW-CC-Expire=86400&HW-CC-Sign=3FF910CE56F3B38070FF02B18866AA248BF5F3191FE3821F541FCE5876CF9A41 "点击放大")

**关键技术**

服务端：

1. 调用[access.getState()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessgetstate>)接口查询设备的蓝牙状态，根据返回的[BluetoothState](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#bluetoothstate>)值判断蓝牙是否开启，若未开启则调用[enableBluetooth()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessenablebluetooth>)接口开启蓝牙；
2. 调用[startAdvertising()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestartadvertising11-1>)接口，开启广播，只有服务端先开启广播，客户端才能搜索到设备；
3. 完成广播后，调用[stopAdvertising()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestopadvertising>)接口，停止广播。

客户端：

1. 调用[access.getState()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessgetstate>)接口查询设备的蓝牙状态，根据返回的[BluetoothState](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#bluetoothstate>)值判断蓝牙是否开启，若未开启则调用[enableBluetooth()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessenablebluetooth>)接口开启蓝牙；
2. 调用[startBLEScan()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestartblescan>)接口，通过[ScanOptions](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#scanoptions>)参数设置扫描参数配置，通过Array<[ScanFilter](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#scanfilter>)>参数设置扫描结果的过滤策略集合，进行扫描，同时调用[ble.on('BLEDeviceFind')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#bleonbledevicefind>)方法订阅BLE设备扫描结果上报事件，处理扫描结果；
3. 调用[connect()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#connect>)接口连接远端BLE设备；
4. 调用[stopBLEScan()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestopblescan>)接口停止蓝牙扫描。开发者可根据具体业务需求，在适当时机停止蓝牙扫描，例如扫描到目标设备后或断开连接时。

### 实现流程

**服务端**

1. 开启广播前，需要先查询蓝牙是否可用，根据返回结果[BluetoothState](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#bluetoothstate>)的值来判断蓝牙是否开启，当取值是STATE\_ON 或STATE\_TURNING\_ON返回true，表示蓝牙已开启。
...
2. 如果蓝牙未开启，服务端设备需要调用[access.enableBluetooth()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessenablebluetooth>)接口开启蓝牙。
...
3. 调用[createGattServer()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blecreategattserver>)创建一个Gatt服务的实例，并调用[addService()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#addservice>)接口，添加服务。服务添加成功后，调用[startAdvertising()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestartadvertising>)接口开始广播。
...
4. 广播目的达成后（如被目标设备扫描到），调用[stopAdvertising()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestopadvertising>)接口，停止广播。
...
1. 客户端设备使用蓝牙功能时，同样需要开启蓝牙，开启方法与[服务端](bpta-bluetooth-low-energy.md#li384712431593)相同。
   ...
   开启蓝牙后，调用[startBLEScan()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestartblescan>)接口启动BLE扫描流程。扫描时，可通过配置过滤策略集合Array<[ScanFilter](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#scanfilter>)>和扫描参数[ScanOptions](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#scanoptions>)，主动扫描发现周围广播中特定类型的低功耗蓝牙设备。
   ...
   在发起BLE扫描并构建[ScanFilter](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#scanfilter>)扫描过滤器时，建议根据具体业务需求设定过滤条件，以精准捕获符合特定条件的广播数据包。典型过滤维度包括但不限于：
   ...
   * 地址可能改变：设备取消配对或蓝牙服务下电时，随机MAC地址会变更，导致过滤失效。
   ...
   onBLEDeviceFind方法中通过[ble.on('BLEDeviceFind')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#bleonbledevicefind>)订阅BLE设备扫描结果上报事件，并将扫描到的设备存放到可用设备列表中。
...
3. 根据具体业务需求，在适当时机调用[stopBLEScan()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestopblescan>)接口停止蓝牙扫描。
...
1. 调用[on('stateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessonstatechange>)方法订阅蓝牙设备开关状态事件；
2. 调用[on('connectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onconnectionstatechange>)方法订阅GATT profile协议的连接状态变化事件。

客户端：

1. 调用[on('stateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessonstatechange>)方法订阅蓝牙设备开关状态事件；
2. 调用[on('BLEConnectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onbleconnectionstatechange>)方法订阅GATT profile协议的连接状态变化事件；
3. 当[on('BLEConnectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onbleconnectionstatechange>)方法返回的状态值为[STATE\_CONNECTED](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.constant (蓝牙constant模块)/js-apis-bluetooth-constant.md#profileconnectionstate>)时，调用[addPersistentDeviceId()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessaddpersistentdeviceid16>)方法持久化存储蓝牙设备的虚拟MAC地址；
4. 当应用启动或者页面显示时，调用[getPersistentDeviceIds()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessgetpersistentdeviceids16>)方法获取应用持久化存储过的蓝牙虚拟MAC地址，并向对端设备发起连接。

### 实现流程

**服务端**

1. 调用[access.on('stateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessonstatechange>)方法订阅蓝牙设备开关状态事件。
...
2. 调用[on('connectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onconnectionstatechange>)订阅GATT profile协议的连接状态变化事件。
...
1. 调用[access.on('stateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessonstatechange>)订阅蓝牙设备开关状态事件。
...
2. 使用[on('BLEConnectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onbleconnectionstatechange>)订阅GATT profile协议的连接状态变化事件，并调用[addPersistentDeviceId()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessaddpersistentdeviceid16>)方法持久化存储蓝牙设备的虚拟MAC地址。

   客户端通过GattClientDevice实例监听连接状态变化，当连接成功时，将对端设备的虚拟MAC地址通过[addPersistentDeviceId()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessaddpersistentdeviceid16>)接口固化到系统存储中。这一步骤至关重要，它使应用在下次启动时无需重新扫描，可直接使用已保存的设备ID发起连接，显著提升连接效率。同时，客户端还将启用特征值通知功能，为后续数据传输做准备。
...
3. 使用[getPersistentDeviceIds()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessgetpersistentdeviceids16>)方法获取应用持久化存储过的蓝牙虚拟MAC地址，实现BLE自动重连。
...
1. 调用[notifyCharacteristicChanged()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#notifycharacteristicchanged>)方法，主动通知已连接的客户端设备特征值的变化。

客户端：

1. 调用[on('BLEConnectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onbleconnectionstatechange>)，订阅GATT profile协议的连接状态变化事件；
   * 根据回调返回的连接状态信息处理不同连接状态下的业务逻辑。
   * 当[ProfileConnectionState](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.constant (蓝牙constant模块)/js-apis-bluetooth-constant.md#profileconnectionstate>)连接状态为“已连接”时：
     + 首先调用[getServices()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#getservices>)进行服务发现，获取服务端设备支持的所有服务；
     + 随后调用[setCharacteristicChangeNotification()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangenotification>)，启用接收服务端特征值内容变更通知的能力；
     + 在启用接收服务端特征值内容变更通知成功后，才能调用下一次读取或写入操作，如[readCharacteristicValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#readcharacteristicvalue>)、[readDescriptorValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#readdescriptorvalue>)、[writeCharacteristicValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#writecharacteristicvalue>)、[writeDescriptorValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#writedescriptorvalue>)、[setCharacteristicChangeNotification()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangenotification>)和[setCharacteristicChangeIndication()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangeindication>)。
   * 当[ProfileConnectionState](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.constant (蓝牙constant模块)/js-apis-bluetooth-constant.md#profileconnectionstate>)连接状态为“已断开连接”时：
     + 更新连接状态；
     + 打印GATT链路断开的原因日志信息。
2. 调用[on('BLECharacteristicChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onblecharacteristicchange>)订阅蓝牙低功耗设备的特征值变化事件。
...
| 步骤 | 操作 | 依赖条件 | 未满足影响 |
| --- | --- | --- | --- |
| 1. 连接建立 | [on('BLEConnectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onbleconnectionstatechange>) -> [STATE\_CONNECTED](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.constant (蓝牙constant模块)/js-apis-bluetooth-constant.md#profileconnectionstate>) | 创建[GattClientDevice](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#gattclientdevice>)实例 | 后续操作均无法执行 |
| 2. 注册通知监听 | [setCharacteristicChangeNotification()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangenotification>) | 1. 需要先调用[getServices()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#getservices>)，获取到server端所有支持的能力，且需包含指定的入参特征值UUID；  2. 异步回调结果返回后，才能调用下一次读取或者写入操作。 | 通知无法触发，操作阻塞 |
| 3. 特征值或者描述符写入 | [writeCharacteristicValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#writecharacteristicvalue>)或者[writeDescriptorValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#writedescriptorvalue>) | 1. 已建立GATT连接；  2. 已成功注册特征值监听；  3. 依赖上一次异步操作完成，包括通知、读取、写入等接口；  4. 写入的数据格式正确。 | 通信失败或忽略配置 |

### 实现流程

**服务端**

1. 调用[notifyCharacteristicChanged()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#notifycharacteristicchanged>)，特征值发生变化时，主动通知已连接的客户端设备。
...
1. 调用[setCharacteristicChangeNotification()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangenotification>)接口，向服务端发送设置通知此特征值请求。
...
2. 订阅蓝牙低功耗设备的特征值变化事件[on('BLECharacteristicChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onblecharacteristicchange>)。需要先调用[setCharacteristicChangeNotification()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangenotification>)接口或[setCharacteristicChangeIndication()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangeindication>)接口才能接收server端的通知。
...
通过[on('BLEConnectionStateChange')](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onbleconnectionstatechange>)接口订阅GATT profile协议的连接状态变化事件，当返回的状态值[ProfileConnectionState](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.constant (蓝牙constant模块)/js-apis-bluetooth-constant.md#profileconnectionstate>)为STATE\_CONNECTED时，表示本端与对端蓝牙设备间的Profile已成功连接。随后，调用[getServices()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#getservices-1>)获取服务端设备支持的所有服务能力。

### 扫描获取的deviceId与真实地址不同

基于信息安全考虑，此处获取的设备地址为虚拟MAC地址，真实MAC地址不直接暴露。

在API 16及后续版本中，HarmonyOS提供了无需配对即可将蓝牙虚拟MAC地址固化的API接口：[access.addPersistentDeviceId()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessaddpersistentdeviceid16>)。

由于应用通过蓝牙扫描获取到的未配对或未固化（参考如下说明）的设备MAC地址为虚拟随机地址，若需该虚拟随机地址不发生改变，可调用[addPersistentDeviceId()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessaddpersistentdeviceid16>)接口持久化存储虚拟随机地址。

说明

1. 使用蓝牙虚拟MAC地址固化API需申请[ohos.permission.PERSISTENT\_BLUETOOTH\_PEERS\_MAC](../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/应用权限列表/受限开放权限/restricted-permissions.md#ohospermissionpersistent_bluetooth_peers_mac)权限，并在[ACL](https://developer.huawei.com/consumer/cn/doc/app/agc-help-apply-acl-0000002394212138)权限审核通过后方可使用。
...
3. 蓝牙虚拟MAC地址固化的API接口比喻：想象你常去的咖啡店会给熟客发放一张**专属会员卡**（虚拟MAC地址）。
   ...
   * **固化后场景**：店员将你的会员卡号永久记录在系统中（[addPersistentDeviceId()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#accessaddpersistentdeviceid16>)）。今后进店，直接刷旧卡（原虚拟地址），系统自动识别你的身份（快速回连），无需重新办理会员卡（无需重复扫描）。

### 蓝牙数据传输报错失败

请检查应用逻辑，确认双端通信发送新消息需等待前次操作回调完成，例如有如下场景需要注意：

* [getServices()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#getservices>)必须在建立GATT连接后优先调用，且需在其完成服务发现后，才能执行后续特征值/描述符操作（如读写、订阅通知等）。
* [setCharacteristicChangeNotification()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangenotification>)异步回调结果返回后，才能调用下一次读取或者写入操作，如[readCharacteristicValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#readcharacteristicvalue>)、[readDescriptorValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#readdescriptorvalue>)、[writeCharacteristicValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#writecharacteristicvalue>)、[writeDescriptorValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#writedescriptorvalue>)、[setCharacteristicChangeNotification()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangenotification>)和[setCharacteristicChangeIndication()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangeindication>)。
* [writeCharacteristicValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#writecharacteristicvalue>)或者[writeDescriptorValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#writedescriptorvalue>)异步回调结果返回后，才能调用下一次读取或者写入操作，如[readCharacteristicValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#readcharacteristicvalue>)、[readDescriptorValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#readdescriptorvalue>)、[writeCharacteristicValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#writecharacteristicvalue>)、[writeDescriptorValue()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#writedescriptorvalue>)、[setCharacteristicChangeNotification()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangenotification>)和[setCharacteristicChangeIndication()](<../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#setcharacteristicchangeindication>)。
