...
scraped_at: 2026-06-12T10:15:40+08:00
doc_updated_at: 2026-05-30
content_hash: sha256:233034ec77da3e4b431f141a65eed58e14947e008904217cb77ceb30d7d673a1
---
## 概述
...
* 冗余空回调
  ...
  建议开发者优先使用[Code Linter扫描工具](<../../../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查/ide-code-linter.md>)进行代码检查，重点关注[@performance/hp-arkui-avoid-empty-callback](<../../../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查规则/性能规则@performance/@performancehp-arkui-avoid-empty-callback/ide_hp-arkui-avoid-empty-callback.md>)规则。若扫描结果中出现该规则相关问题，可参考本章节提供的优化建议进行调整。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/45/v3/nkXrws7kSHWplO8UUV_6IA/zh-cn_image_0000002193850140.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=DF07B6051B3263AD112635002CD2E167CC1FF0459AF15B799938BC77EA60E507 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/_dX3mx3uSOScxtaUPOlccg/zh-cn_image_0000002194009712.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=202B0AD85DBE5260BA3A7FA34168B72D5C1F8D8E05D63DAB0707D0C7191AF0A2 "点击放大")

**图3** 案例二onWillScroll事件回调耗时  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/gBsS12X-QyKTlZ7Z4fdL7g/zh-cn_image_0000002194009728.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=480AA9F4AA4761BF5524BEC810A553BF8DC7DE6F18DC74B93D32BEF6F6A64EF7 "点击放大")

* 帧率对比

**图4** onWillScroll执行耗时操作的丢帧率  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/46/v3/fR3XoBwbScC9mwboWyVGPw/zh-cn_image_0000002194009704.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=36BA706CEC4EEDB5F8F674505A730B71363BFAE5E92D0F4CCC5F167C296823FF "点击放大")

**图5** onWillScroll不执行耗时操作的丢帧率  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/hAJLGBB1Toe-q9x8d1MLjg/zh-cn_image_0000002193850112.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=5C227943C07BB81C3A39F349A10C23F7F6B32E99A07812B22C4BAFBFF8B56A80 "点击放大")

**图6** 首帧Trace详细信息  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/T2t3YhNHQe2hVM3s0ir5kw/zh-cn_image_0000002231669457.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=3DDFDC3FD7F978A4FBDC384E9CEBBFAC2728ECC9832400FD4B6A43B3DD20E298 "点击放大")
...
本案例在onWillScroll事件回调的开始开启打点追踪，在事件回调结束前停止性能打点追踪，用以测试有无耗时操作的性能差异。关于本例中使用性能打点的介绍，请参考[@ohos.hiTraceMeter (性能打点)](<../../../../../harmonyos-references/Performance Analysis Kit（性能分析服务）/ArkTS API/@ohos.hiTraceMeter (性能打点)/js-apis-hitracemeter.md>)。案例中关于帧率检测，丢帧分析，请参考[帧率问题分析](../../../性能分析/帧率问题分析/bpta-zhenlv.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/lIMd5Gn-Tsq7pP2FcxDQzg/zh-cn_image_0000002194009716.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=6C248738CFBAD2EC7BB62663A93F02E8D397E67C8BEDA6E539A48641D1311B3D "点击放大")

**图8** 正例滑动时单个aboutToReuse耗时  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/5NyKLaP0QVWDUf_fN_lk8g/zh-cn_image_0000002231555137.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=45EBF371C7A52D3C6D93EF23809E315F9900C0479FC658F316C6DC782EE4ECA6 "点击放大")
...
本案例中子组件生成函数itemGenerator以及键值生成函数keyGenerator详细信息，请参考[LazyForEach](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)。获取索引数据函数getData的说明，请参考[IDataSource说明](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md#idatasource)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/aJHQw8lvQ6ixS9eNewR1ng/zh-cn_image_0000002229335521.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=3B8CC7E74961F60B3563D26AB9E78BCB5901CCED76AFC046896A5DC1A40DCE2D)

**图10** itemGenerator中不执行耗时操作的滑动效果  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/Q4c9pp-aQESVLTkzpALtoA/zh-cn_image_0000002194009708.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=FF23967FF7DD101F33E7EFD39C98B413485462B695444EB2FA97DA2DA5045A4B)
...
建议开发者优先使用[Code Linter扫描工具](<../../../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查/ide-code-linter.md>)进行代码检查，重点关注[@performance/hp-arkui-use-taskpool-for-web-request](<../../../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查规则/性能规则@performance/@performancehp-arkui-use-taskpool-for-web-request/ide-hp-arkui-use-taskpool-for-web-request.md>)规则。若扫描结果中出现该规则相关问题，可参考本章节提供的优化建议进行调整。

**ResourceManager**

ResourceManager通过getXXXSync接口同步获取资源的方式有两种，1、通过resource对象获取resourceManager.getStringSync($r('app.string.test'))；2、通过id获取resourceManager.getStringSync($r('app.string.test').id)。 下面以[getStringSync](<../../../../../harmonyos-references/Localization Kit（本地化开发服务）/ArkTS API/@ohos.resourceManager (资源管理)/js-apis-resource-manager.md#getstringsync9>)为例，测试一下这两种参数在方法中的使用是否会有耗时区别。
...
* 通过resource对象获取（当前已被废弃不推荐使用）
  ...
  12. try {
  13. this.getUIContext().getHostContext()!.resourceManager.getStringSync($r('app.string.test'))
  14. } catch (error) {
...
**图11** 通过资源对象获取数据的耗时  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/23/v3/px8nTHZOSk6kNMW7D_zGyA/zh-cn_image_0000002229335497.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=67F0B929CE86B5431B4045F36D50ED00C2BABEFA16C515ECB76B72DD98B33ECB "点击放大")

**图12** 通过资源id获取数据的耗时  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/64/v3/vfL2rmRNTrG-XhqSLBN5Cg/zh-cn_image_0000002193850108.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=BD7066048077036FF4F28D8FF04D6E610CC5DF42C6A735446957A4BE081EA4C1 "点击放大")
...
建议开发者优先使用[Code Linter扫描工具](<../../../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查/ide-code-linter.md>)进行代码检查，重点关注[@performance/hp-arkui-use-word-break-to-replace-zero-width-space](<../../../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查规则/性能规则@performance/@performancehp-arkui-use-word-break-to-replace-zero-width-space/ide_hp-ar_77809357.md>)规则。若扫描结果中出现该规则相关问题，可参考本章节提供的优化建议进行调整。
...
避免在文本组件内使用零宽空格(\u200b)的形式来设置断行规则，推荐使用[wordBreak](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md#wordbreak11)，wordBreak在使用性能方面优于零宽空格。例如推荐用法为：Text(this.diskName).wordBreak(WordBreak.BREAK\_ALL)。

说明

常见高耗时接口有：[getInspectorByKey](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#getinspectorbykey9)、[getInspectorTree](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#getinspectortree9)、[sendEventByKey](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#sendeventbykey9)、[sendTouchEvent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#sendtouchevent9)、[sendKeyEvent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#sendkeyevent9)、[sendMouseEvent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#sendmouseevent9)。
...
以[瀑布流使用案例](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md#示例1使用基本瀑布流)为基础进行代码改造,得到如下代码,瀑布流在即将触底时调用异步函数mockRequestData获取新数据，并将新数据写入数据源。异步函数mockRequestData用于模拟耗时的网络请求，从rawfile目录下读取数据，将数据处理后返回。
...
**图13** 不使用多线程的Trace信息  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/d0i60lgUTbahuIqwYNGxIg/zh-cn_image_0000002229450001.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=81287D2BE9A15AD074FC113B343B1C32A6FD72923A512A3276A35CCEF85701FE "点击放大")

从图中可以看到，在主线程中出现了大块的耗时，直接导致用户在滑动的时候能感受到明显的卡顿。异步回调函数最后也由主线程执行，所以应该尽量避免在回调函数中执行耗时操作。可以使用系统自带的[@ohos.taskpool（启动任务池）](<../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@ohos.taskpool (启动任务池)/js-apis-taskpool.md>)多线程能力，将耗时任务交由子线程执行，避免主线程的长时间阻塞，以下为使用TaskPool优化后的代码：
...
**图14** 使用多线程的Trace信息  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/XXhatqCmS8aZV3JxIuYeCw/zh-cn_image_0000002229335505.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=06077603D588364C0495721831333F4BCA1DAFE549EADF9BCD2125A696191FE9 "点击放大")
...
**图15** 主线程反序列化耗时  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/B6Vt6ehkTfOlSFUngaTaOg/zh-cn_image_0000002229335525.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=581EB0E4C42A85149934A82D2362F835A0D09B85F7392F520AB4F7F4D5E5D2F4 "点击放大")
...
关于@Sendable装饰器的详细介绍以及使用限制，请参考[Sendable对象简介](../../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/UNiYDxJLQDakbEzR5HCogw/zh-cn_image_0000002229449973.png?HW-CC-KV=V1&HW-CC-Date=20260612T021535Z&HW-CC-Expire=86400&HW-CC-Sign=1B21BB24A127FFEC2DC28CC8D1ABA109BD1619BA0019B744E3D087DE46DCE8C2 "点击放大")
