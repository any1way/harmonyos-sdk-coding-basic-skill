...
scraped_at: 2026-06-12T10:15:46+08:00
doc_updated_at: 2026-05-22
content_hash: sha256:f190470dc6045a18c93abe77708b8ca39584dce150cfee5d70ec8374b3165dec
---
## 概述
...
对于希望快速实现高性能流畅滑动长列表的开发者，可以使用ScrollComponents库直接实现。该库内置了组件复用、列表项子组件组合复用、懒加载、复用池共享等优化功能，并支持预创建和预加载，大幅减少了开发者的性能调优成本。具体实现细节和最佳实践可参考《[基于ScrollComponents实现长列表](../../../../布局与弹窗/基于ScrollComponents实现长列表/bpta-list-based-on-scrollcomponents.md)》。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/UzC6awe_Q7GhA1gP48wawg/zh-cn_image_0000002229450381.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=90275FD5CC2BFBD2DA32859D03268EE4724EDA6650A916452CE0EADE45B0B266 "点击放大")

**图2** 10000条数据量下ForEach和LazyForEach最佳实践滑动对比   
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/d1f-4mgjTae5Cqg83ozyaw/zh-cn_image_0000002229335845.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=1F7EA25F65B3EF2BFE76C09006919163530BCCA8032BF00561CC9B29A4C683ED "点击放大")
...
* 方式一，循环渲染
  ...
  通过[循环渲染（ForEach）](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ForEach：循环渲染/arkts-rendering-control-foreach.md>)从数组中获取数据，并为每个数据项创建相应的组件，可减少代码复杂度。
...
* 方式二，数据懒加载
  ...
  通过[数据懒加载（LazyForEach）](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md>)从提供的数据源中按需迭代数据，并在每次迭代过程中创建相应的组件。
...
**图3** ForEach渲染过程示意图   
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/aI4Z6jFrQoSLZIVWqFEGVQ/zh-cn_image_0000002229335841.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=ADE97BF2431CF7D974ED0F5E6FC4805F98425E614BE4BD6F14000EB015870F13 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/BfyqThFoRJiKgh_l6jJd-Q/zh-cn_image_0000002229335869.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=EEB1747D51920DFE18E3882BB40A8F8A0357EB5585C78AAB91E611D7A16F7228 "点击放大")
...
详细的使用规则可以参考ForEach的[使用建议](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ForEach：循环渲染/arkts-rendering-control-foreach.md#使用建议>)和LazyForEach的[使用限制](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md#使用限制>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/88/v3/11wM3p3HQ4yDn89uwf6YGA/zh-cn_image_0000002229335821.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=D4646515CBC6431C0356EEF43E1E8E950E029AF3FE6F675A39822A8F0626076F "点击放大")
...
建议开发者优先使用[代码Code Linter检查](<../../../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查/ide-code-linter.md>)工具进行代码扫描，重点关注[@performance/hp-arkui-set-cache-count-for-lazyforeach-grid](<../../../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查规则/性能规则@performance/@performancehp-arkui-set-cache-count-for-lazyforeach-grid/ide_hp-arkui-se_93975829.md>)规则。若扫描结果中出现该规则相关问题，可参考本章节提供的优化建议进行调整。
...
**图6** 缓存作用区域与渲染过程示意图   
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/PLUSXyVqSnuo7-NIHLGdEQ/zh-cn_image_0000002229335857.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=4F0B9709F4FF10683FD2544ED08F37D020456FEFE5F492D79EED1733A0EE219B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2b/v3/ywPe7fsCSe2KD7EogKpsmw/zh-cn_image_0000002194010084.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=38D230A2D5A796A72D5ECD2782B5E04EB4AB5DF13F569EF4A701D4BBDE59EEB6 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/0fz4aMJITV2Iow1hNPJxfA/zh-cn_image_0000002229450385.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=8E050DBE310625D814A3571C8E3F2CA4522CBF095446EF65842E1C1C562A1D67 "点击放大")
...
在应用列表界面，创建DataSourcePrefetching和[BasicPrefetcher](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.Prefetcher (Prefetching)/js-apis-arkui-prefetcher.md#basicprefetcher>)对象。BasicPrefetcher提供了一种智能数据预取算法，以根据屏幕上可见区域的实时变化和预取持续时间的变化来决定应预取哪些数据项。在List的onScrollIndex回调中，调用BasicPrefetcher的visibleAreaChanged()方法，传入List的可见区域起始坐标。在可见区域变化时，实时更新预取的范围。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/6lim6m3jTIenfmAD5adRGQ/zh-cn_image_0000002229335833.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=D3780E87CC3DE67EE0B63D64392857B458CF4BD14871F5C4438E8D13F942F8B3 "点击放大")

cachedCount=5 CPU占比为3.96%

**图10** cachedCount=40 CPU占比trace图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/02/v3/wQyC8YtpSriMFJMH86U94Q/zh-cn_image_0000002229450353.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=03A3E2F5CA94E041D635D5EEC51F762A182162CFB05225A31D4A0E703F2E6011 "点击放大")

cachedCount=40 CPU占比为5.04%

**图11** 动态预加载 CPU占比trace图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/8cAt6tDkRk-I5-bfIoVfaA/zh-cn_image_0000002229335837.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=5D9C9F0C501224DD227CAFB7F0B77C82B0682ECCE2DC301E81E433D19252CCD2 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/ZUycJpVhScullrll1LNoIA/zh-cn_image_0000002229450357.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=3F0B72D4BF68E0297F2CD8B564B3CD82C28C52CB877202D35CBBBC42F1122CDE "点击放大")

当cachedCount设置为5时，首屏加载时长为530.4ms。

**图13** cachedCount=40 首屏加载时长trace图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6/v3/KWBlh5jGQ3uXvz7s98ZPKw/zh-cn_image_0000002194010048.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=33C7EB1CBAA24DA813ED95900990E94B413BA5D9395127AE08851AF9C1FBBF2A "点击放大")

当cachedCount设置为40时，首屏加载时长为1.8s。

**图14** 动态预加载 首屏加载时长trace图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7/v3/r-TB2ulcTKaESCvJNvs6gA/zh-cn_image_0000002229335897.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=E55AA724F286F9B7CC8EF87BB5103E9387E3A63F2F17982FCDD76C4C667545C6 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/ktfiKeKkSRKXvyCR3JSS-g/zh-cn_image_0000002194010072.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=8B6B82E121C58DCF194059E153970FB90F06B0A58BB53C3D36A0709EADEF5CD5 "点击放大")
...
需要注意的是复用组件中有@Builder自定义构建函数时，状态变量推荐使用[按引用传递](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md#按引用传递参数>)。@Builder装饰的函数默认按值传递，当传递的参数为状态变量时，状态变量的改变不会引起@Builder方法内的UI刷新。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/NYvjmMFGQK6IuzW4TyHPBg/zh-cn_image_0000002229335881.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=38319E33EC2E9E5FD4EE71B96CAF096794AB085217C56836E77553DD53D50F9E "点击放大")

从图中可以看见，泳道中红色和绿色间隔出现，其中红色区域表示丢帧，绿色表示正常，对红色丢帧区域进行耗时分析：

**图17** 丢帧耗时分析   
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/41/v3/9UFsXUkKQju8lEYB-eh0TQ/zh-cn_image_0000002229335825.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=7D14DE1498DBE2587326AC5FBF5DEC225C48D18E8B888992EF6B53F79917303C "点击放大")

**图18** 对丢帧部分的放大分析（整体耗时13.430ms）

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/VfYsn-FKSYydd30jA3OuaQ/zh-cn_image_0000002194010100.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=F809582998D09C1187C48F4206000260187CA4E648227E0C5D4C28711B352ECD "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/YKX47SZFQgqfCFsklk-zyg/zh-cn_image_0000002229335861.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=6B27F5348B773AC73B7034ACC493E0477C248017D93A4806B5941CFCC6092F86 "点击放大")

上图显示列表快速滑动15.8秒，泳道全绿表示无丢帧，丢帧率为0%。放大分析某帧，如下图所示：

**图20** 组件复用后某帧耗时分析

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/4WkGydXIRTCQ6mHvVoDlog/zh-cn_image_0000002229335853.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=FD9ADCBF7AC6C42BE16666E95EA9908604EA52FC7C54D53736CF0E74103785F2 "点击放大")
...
**图21** 布局优化前后的层级变化   
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/iyi8440ITUKTGj-ofiY_Ug/zh-cn_image_0000002229450369.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=FB271DEE35EC0535C3D515569385731ED54C962DD28E0C6BAAF2B478D3082553 "点击放大")
...
**图22** 额外嵌套后的布局层级   
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/6gCDCrcXSfGnQ0WYtu3rHQ/zh-cn_image_0000002229335829.png?HW-CC-KV=V1&HW-CC-Date=20260612T021541Z&HW-CC-Expire=86400&HW-CC-Sign=93CEA8CA9B6DEDC8063B8560162B480C571B60813E5CE553AF992F8C848DA5FA "点击放大")
