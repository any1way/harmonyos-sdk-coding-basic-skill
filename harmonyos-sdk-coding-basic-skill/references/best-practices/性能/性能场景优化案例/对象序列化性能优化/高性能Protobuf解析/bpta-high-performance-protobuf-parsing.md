...
scraped_at: 2026-06-01T17:01:02+08:00
doc_updated_at: 2026-03-19
content_hash: sha256:d787cc22b62347392e6b5c77faac6947a8d16920dcdafcb6ac6a65e706feb93d
---
## 概述
...
2. 代码生成
   * 基于 .proto 结构生成高效的encode()/decode()方法，支持[@Sendable装饰器](../../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md#sendable装饰器)以避免跨线程传输时的内存拷贝。
3. 路径绑定
...
4. 通过[@Concurrent装饰器](../../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/TaskPool简介/taskpool-introduction.md#concurrent装饰器)定义子线程任务，在任务内部调用步骤3中插件自动生成代码中暴露的静态方法decode()，以完成相应的数据处理逻辑。
...
* Sendable对象转换：通过TurboTransProtobufPlugin插件，生成[@Sendable装饰器](../../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md#sendable装饰器)的类，支持跨线程内存共享。
...
* 子线程解析：利用HarmonyOS的[worker](../../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/Worker简介/worker-introduction.md)功能，将大数据解析任务调度至子线程执行，防止主线程阻塞。
