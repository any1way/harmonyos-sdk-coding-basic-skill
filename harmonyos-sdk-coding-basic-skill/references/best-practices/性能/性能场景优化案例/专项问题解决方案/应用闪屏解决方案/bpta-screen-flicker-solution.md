...
scraped_at: 2026-06-12T10:16:11+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:39ba4ba699d875e3976ed91826e9b79cb17399839c9959560a5f533d73f2f384
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/06/v3/t602wmIoSmytM3YDFzBCvA/zh-cn_image_0000002229337129.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021605Z&HW-CC-Expire=86400&HW-CC-Sign=B698307C227682D8C3F8FE57F369E55E14A6AE760A8EC3B5FDB59788CF9D7A5D "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/23/v3/rplSJiOpSuKYGVBb85BhuQ/zh-cn_image_0000002229337141.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021605Z&HW-CC-Expire=86400&HW-CC-Sign=B0E2352A2B4FCB18BBFA8AF772F97E895AA956E221330A70DF2157DBB5B9B227 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/k8h7KLxuTIW0Kw4uKzCa2Q/zh-cn_image_0000002229451637.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021605Z&HW-CC-Expire=86400&HW-CC-Sign=F6BBBE790434182DAE22580CD11F842C709ED79E750BF75FD26D22A10DCFEA15 "点击放大")
...
在左右跟手翻页过程中，通过 [TabsAnimationEvent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#tabsanimationevent11对象说明) 事件获取手指滑动距离，改变下划线在前后两个子页签间的位置。离手触发翻页动画时，同步触发下划线动画，确保下划线与页面左右转场动画同步。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/eDXfbkcuQDSIiqedkTr0Yw/zh-cn_image_0000002229337133.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021605Z&HW-CC-Expire=86400&HW-CC-Sign=77E658F261007F716EC6CF16CBD45204BEDA4634EA36AC609AF9D35E26550333 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/P_Jjg-KxQ3eKuQBPvvi88g/zh-cn_image_0000002229337137.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021605Z&HW-CC-Expire=86400&HW-CC-Sign=9DFB94E7DB815F40137EB4D71D2E53996CDE6B48D6FEC69C7BA5FC9C3EFBCE2D "点击放大")
...
ForEach提供了一个名为keyGenerator的参数，这是一个函数，开发者可以通过它自定义键值生成规则。如果开发者没有定义keyGenerator函数，则ArkUI框架会使用默认的键值生成函数，即(item: Object, index: number) => { return index + '\_\_' + JSON.stringify(item); }。可参考[键值生成规则](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ForEach：循环渲染/arkts-rendering-control-foreach.md#键值生成规则>)。

在使用ForEach的过程中，若对键值生成规则理解不足，将导致错误的使用方式。错误使用会导致功能问题，如渲染结果非预期，或性能问题，如渲染性能下降。

**解决措施**

在ForEach第三个参数中定义自定义键值的生成规则，即(item: NewsData, index?: number) => item.id，这样可以在渲染时降低重复组件的渲染开销，从而消除闪屏问题。可参考[ForEach组件使用建议](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ForEach：循环渲染/arkts-rendering-control-foreach.md#使用建议>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/Tybo5bY7REOLEhWGHE1xNg/zh-cn_image_0000002194011344.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021605Z&HW-CC-Expire=86400&HW-CC-Sign=06880FEF6AD84178E627047386F1410AA1553EC9767D8BCB68E543B2EE615423 "点击放大")
