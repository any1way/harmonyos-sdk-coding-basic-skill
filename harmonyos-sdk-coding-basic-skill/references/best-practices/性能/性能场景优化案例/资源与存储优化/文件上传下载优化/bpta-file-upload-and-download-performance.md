...
content_hash: sha256:71863da300c21aeb7e0cd6046629681a41d3686996fb65f697e390cdc3e64f55
---
## 概述
...
**图1** 模块流程图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/BeoDvPbkQ6CYpN59HaacEg/zh-cn_image_0000002229451197.png?HW-CC-KV=V1&HW-CC-Date=20260612T021557Z&HW-CC-Expire=86400&HW-CC-Sign=98B2392C39870BF06D6B6DA88FFCF34C66A714E300506EFD2FCF9FF5F9267B26 "点击放大")
...
**图2** 上传数量和耗时对比图表  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/Lk9aQi3EQ1aWOK8bVnoljw/zh-cn_image_0000002193851324.png?HW-CC-KV=V1&HW-CC-Date=20260612T021557Z&HW-CC-Expire=86400&HW-CC-Sign=CBD2762CB082A4AC0474CF96847448537D0C8EDD7BD673BC2AA9E14558848EC1 "点击放大")
...
**图3** 断点续传上传流程图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b4/v3/33VrKParTDacHOrR0jMrwA/zh-cn_image_0000002193851312.png?HW-CC-KV=V1&HW-CC-Date=20260612T021557Z&HW-CC-Expire=86400&HW-CC-Sign=C2088B3299A548BF34F83BE40F8D0F27F466E634ED6502FE2A1616B7608C80A9 "点击放大")
...
对文件进行上传下载过程中，若在错误的任务状态下调用了不应使用的接口，在不支持的状态上操作任务，任务分组不存在或已移除等情况，均会导致无法正常停止、恢复文件的上传下载任务。具体可参考[上传下载错误码](<../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/错误码/上传下载错误码/errorcode-request.md>)。

### 多文件下载监听

文件下载监听是指在单文件下载的功能基础上，同时进行多个文件下载进度和状态的监听管理。实际开发中，需要使用request上传下载模块实现，包括监听每个文件下载任务的进度，任务是否暂停，下载是否完成等状态情况。相关规格说明参考[request.agent.create()](<../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md#requestagentcreate10-1>)。

以具体场景为例，下图是常见的多文件下载列表：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/EioJKptTSbaerBWJdDCtLQ/zh-cn_image_0000002229451201.png?HW-CC-KV=V1&HW-CC-Date=20260612T021557Z&HW-CC-Expire=86400&HW-CC-Sign=13D6F9D5CA16CFB39147C788C278CF7084125474EA7E878D99F0E3408DB20BBD "点击放大")
