...
scraped_at: 2026-06-12T10:15:56+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:0bb28e38cc40bacc07c5517aab99589ea37efddafd1786b834d82cd12defe394
---
## 概述
...
3. [生命周期管理](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件生命周期/arkts-page-custom-components-lifecycle.md>)：释放不再使用的系统资源，包括应用内存、监听事件、网络句柄。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/cD7_dyOWTmGy8ZYgRrBy1w/zh-cn_image_0000002193852104.png?HW-CC-KV=V1&HW-CC-Date=20260612T021554Z&HW-CC-Expire=86400&HW-CC-Sign=B6F8160894D2BB681DB075566CF74A4B7D1C87AA306B4AFA110F6E2E974880BC "点击放大")
...
* 在页面生命周期中，调用对应生命周期的方法，创建或销毁资源。如在[onPageShow()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#onpageshow)方法中创建资源，在[onPageHide()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#onpagehide)方法中销毁对应的资源。
* 在组件生命周期中，调用对应生命周期的方法，创建或销毁资源。如在[aboutToAppear()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoappear)方法中创建资源，在[aboutToDisappear()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttodisappear)方法中销毁不再使用的对象、注销不再使用的订阅事件。
* 调用组件自带的方法，创建、销毁组件。如调用XComponent的[onDestroy()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md#ondestroy)方法。
...
**图2** Purgeable内存访问流程图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/AOL4WDZBSTqs_n57nm2NRQ/zh-cn_image_0000002229451973.png?HW-CC-KV=V1&HW-CC-Date=20260612T021554Z&HW-CC-Expire=86400&HW-CC-Sign=A62E243946F9137820CA6627E2D65ED6ADD10EB24E65959B26300C5A097D0F99)

Purgeable内存回收流程图如下所示。当引用计数为0时，丢弃Purgeable内存中的数据，并标记为已回收。

**图3** Purgeable内存回收流程图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/yFJBsrNRTyikPtiAIhQ-sg/zh-cn_image_0000002194011688.png?HW-CC-KV=V1&HW-CC-Date=20260612T021554Z&HW-CC-Expire=86400&HW-CC-Sign=2B119891DC128CE6A0DF090F9336C7EDADB826CE800BBD7D8731A7399BACDAE0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/FHUP32P4Rs6NjS6ddkoGZA/zh-cn_image_0000002193852108.png?HW-CC-KV=V1&HW-CC-Date=20260612T021554Z&HW-CC-Expire=86400&HW-CC-Sign=CA286DEF362DD081C214544151DB8C7C65D4E1A719D7900E899BB7833BF6E438 "点击放大")
...
2. [布局优化](../../界面渲染性能优化/长列表加载丢帧优化/bpta-best-practices-long-list.md#section155051250172217)：通过减少布局嵌套层级，减少过度绘制可以产生较大的性能收益。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/UoTufrMxS-S5rhPTOHHBMg/zh-cn_image_0000002194011684.png?HW-CC-KV=V1&HW-CC-Date=20260612T021554Z&HW-CC-Expire=86400&HW-CC-Sign=AB25B0079185A5CD86FC62F662B341A0D9430E2CBC1009A48C87EF0627CC1B55 "点击放大")
...
* 使用Sendable：符合Sendable协议的数据可以在ArkTS并发实例间传递，从而减少拷贝的开销及其内存。关于Sendable的详细内容可参考[《Sendable开发指导》](../../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md)。
* 使用可共享对象：共享对象SharedArrayBuffer，拥有固定长度，可以存储任何类型的数据，包括数字、字符串等。共享对象传输是指SharedArrayBuffer支持在多线程之间传递，传递之后的SharedArrayBuffer对象和原始的SharedArrayBuffer对象指向同一块内存，进而达到内存共享的目的。详细内容可参考[《SharedArrayBuffer对象》](../../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/SharedArrayBuffer对象/shared-arraybuffer-object.md)。
