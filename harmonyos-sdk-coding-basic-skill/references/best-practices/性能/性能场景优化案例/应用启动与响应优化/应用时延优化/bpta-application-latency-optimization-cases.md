...
scraped_at: 2026-06-12T10:15:53+08:00
doc_updated_at: 2026-05-30
content_hash: sha256:07ea059b16e66bcb7782ec7f54e7c800dd078b716b2c89de6a964f72b86f0a83
---
## 应用时延概述

在移动终端应用开发中，完成时延是指用户操作移动终端时，从输入触控指令到界面完全刷新结束并达到可以阅读的稳定状态所用时间，点击时延依据界面转场类型可以分为界面内跳转和界面间跳转两种。完成时延作为用户体验关键指标，直接影响用户对响应速度和交互流畅性的感知，主要影响用户对触控交互及时性和愉悦性的体验评价。关于响应时延阶段的分析，请参考[《点击响应时延分析》](../../../性能分析/点击响应时延分析/bpta-click-to-click-response-optimization.md)。关于完成时延阶段的分析，请参考[《点击完成时延分析》](../../../性能分析/点击完成时延分析/bpta-click-to-complete-delay-analysis.md)。

在一定时延水平以上，时延越短越好，当时延小于一定水平后，用户的流畅体验不再继续提升。建议应用或元服务内点击操作响应时延应≤100ms，应用或元服务内点击操作完成时延≤900ms，更多体验建议，请参考指南[《应用性能体验建议》](../../../../../harmonyos-guides/应用体验建议/应用性能体验建议/performance-experience-suggestions.md)。本文将给出时延问题常见优化方案。

**图1** 点击完成起止点示意图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/HZMkAIGHR5y0VVyTvG561w/zh-cn_image_0000002229337521.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=5B4B634B9AAD83FE033EFFC7976835A2BC264CC1B80FCBE99E8F2EBE48BC837E "点击放大")

**图2** 页面转场过程解析  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1a/v3/kWuqm4zQRkaLUcuD9qAKPA/zh-cn_image_0000002229452017.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=26AD1C2234F22E24C523DEA80FEDCFCD487AA5C3D2BCE791B0A84A903BBF6A7F "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8e/v3/aQJOO5DcTduQy84JbDSe8w/zh-cn_image_0000002229337533.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=DEB95F47E07419AC33C902019B21A0A8A522D68185C0E943509A127109769413 "点击放大")

分解关系结构后，单个子项界面由6个构成元素组成，元素排列以线性风格为主，使用的组件包括Image、Badge和Text。

**图4** 单个ListItem界面示意

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/0FGa9IJ4Sp6RA6dTIKUQBQ/zh-cn_image_0000002193852136.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=EA9724B2968ECD26078473695C3F6815C80FCB36CA60CF310B6D1ACDE3D232F4 "点击放大")
...
**图5** Flex布局下的界面层级关系  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/bqeeZL76RVaGa7yWRDqIzg/zh-cn_image_0000002229452013.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=8FB58937F26FDCC255C636D96ED25B973AE317993AF439F21DC8DE56705E6EE2)

**图6** 相对布局下的界面层级关系

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/45/v3/o3EaSLZ_RVaUHXm5y5_PMw/zh-cn_image_0000002229452029.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=A08B0F8001DC56F28F195B11AAE199FFC20285774ECD499E0276104742FEC644)
...
7. // The camera page is triggered once every time it is hidden.
8. onPageHide() {
9. setTimeout(this.releaseCamera, 200);
10. }

12. // Release resources
13. public async releaseCamera() {
14. try {
15. // Photo mode session class pause
16. captureSession?.stop();
17. // Photo mode conversation class release
18. captureSession?.release();
19. // The photo input object class is closed.
20. cameraInput?.close();
21. // Preview output object class release
22. previewOutput?.release();
23. // Photo output object class release
24. cameraOutput?.release();
25. } catch (e) {
26. hilog.error(0x00, 'release input output error:', JSON.stringify(e));
27. }
28. }
```
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/jEzN3-y9Rcm3QZXmMQpMUA/zh-cn_image_0000002229337529.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=17D3BA8AB542F3B24FFD242376E55C99585161FB501B34462D9523E9CE167B40 "点击放大")

日志关注从应用接收TouchDown事件到pan识别的耗时，该过程耗时127ms。注：日志信息和trace图非同一时间获取，性能数据存在差异，提供的数值仅供参考。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/KW6stti6TtWd7zEnUyC8PQ/zh-cn_image_0000002229452021.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=C423F7CE843D613811CB4E09415A2035298096E571DFCB9E21E2F36B045EB173 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/7dNMnHEeSFuPnAm4G0XI6A/zh-cn_image_0000002194011720.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=8C15EA3174CDE6607040103C339366260FA52A5DCB54DFD9749D9DC55CAF26A5 "点击放大")

对应日志过程耗时42ms。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/Tfi9UjxFRzqJ_gbHIEO-yg/zh-cn_image_0000002229452025.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=5BAD71A3FB3047AF59BE95F95DFD5E8C036F1324525299D35C0A1D9CE7C477AF "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/08/v3/bYefNDiLR3qEDaXTe7gpsA/zh-cn_image_0000002193852132.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=E903555BF266601FE60FC9C77129CBAB429BA5EF3AC69D85F01E12FABFFBD58B "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/nNCGIgZXTGuV6h2q93eGKQ/zh-cn_image_0000002229337537.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=9D92B769C74D369787A942EF1AA832BBC92B5C747FFC7F2D5EAAEA10E4180421 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/kbMIKljvT_Sr3Mxh6yoVnw/zh-cn_image_0000002229337525.png?HW-CC-KV=V1&HW-CC-Date=20260612T021549Z&HW-CC-Expire=86400&HW-CC-Sign=3249211D78F0CA7495515B3C70F2CECAAB1144DBE3A0E3583244A498B304A0EC "点击放大")
