...
scraped_at: 2026-06-12T10:14:40+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:9cf2986f06f1cb14fcb4a7cc5313dddea6156672620931b86c0e076a14563a28
---
## 概述
...
**图1** 感知流畅性示意图   
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/xdj-BIU8QLGC9Gfv4hSgrg/zh-cn_image_0000002194011640.png?HW-CC-KV=V1&HW-CC-Date=20260612T021437Z&HW-CC-Expire=86400&HW-CC-Sign=FB4E154AB70EB35DD37734C6B0353FF5D268ED3E023ED047FDB131A106607A3A "点击放大")
...
**图2** 应用启动优化前后对比图   
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/TI76buhJQMqih_QOBNUm_Q/zh-cn_image_0000002193852052.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021437Z&HW-CC-Expire=86400&HW-CC-Sign=0A80B4EFE0FF41268BCA9C5EC6A6227A31487E464069E3209A7AB1AABC0867DB "点击放大")
...
4. 根据评测结果迭代优化：开发者可以根据评测出来的结果，对应用进行迭代优化，满足用户的需求并提供更好的体验。具体关于点击响应的优化，可以参考最佳实践文章[《点击响应时延分析》](../性能分析/点击响应时延分析/bpta-click-to-click-response-optimization.md)。
...
2. 根据动效选择实现方式：在确定了动效的设计原则后，需要根据具体的技术和平台选择合适的实现方式。选择合适的实现方式需要考虑到动效的复杂度、性能要求、跨平台兼容性等。具体可以参考最佳实践[《动画使用指导》](../../动画与转场/动画使用指导/bpta-fair-use-animation.md)与[《页面间转场》](../../动画与转场/页面间转场/bpta-page-transition.md)。
3. 根据评测指标评估动效流畅性：设计实现后，进行动效流畅性评估，指标包括加载时延、最大连续丢帧数等。评估可以发现解决性能问题，确保用户获得流畅交互体验。
4. 根据评测结果迭代优化：开发者可以根据评测出来的结果，对应用进行迭代优化，满足用户的需求并提供更好的体验。具体关于丢帧的优化，具体可以参考最佳实践[《长列表加载丢帧优化》](../性能场景优化案例/界面渲染性能优化/长列表加载丢帧优化/bpta-best-practices-long-list.md)。
...
**图3** 最大连续丢帧数优化前后对比图   
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/JPNgaRu0RjG6TrhgQ3A5PQ/zh-cn_image_0000002194011636.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021437Z&HW-CC-Expire=86400&HW-CC-Sign=8AAE8DC5532D7AA96153B4006950D56163A7DEABB99FD85F493C7CADC479EB1E "点击放大")
