...
scraped_at: 2026-06-01T16:43:06+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:3c4c2322a1cc69aacd0bd5ebaa41ac32ab9c5da81791af4d0c388a01486ee07e
---
...
* [分层架构设计](../分层架构设计/bpta-layered-architecture-design.md)：将应用划分为产品定制层、基础特性层和公共能力层，降低层间依赖性，提升代码可维护性。分层架构设计明确每层的职责和层间的交互机制，提供清晰的结构化开发框架。
* [模块化设计](../模块化设计/bpta-modular-design.md)：将应用分解为多个功能模块，每个模块执行特定的功能。模块化设计提高代码的可理解性和可复用性，简化应用扩展和维护，降低系统各部分之间的耦合度。
