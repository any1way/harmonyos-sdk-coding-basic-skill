...
scraped_at: 2026-06-11T16:56:05+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:3504ab06dd0867a2d2bf9ee4577570422a4760c69d095aead76c070e25d20b96
---
## 概述

在声明式UI编程范式中，UI是应用程序状态的函数，应用程序状态的修改会更新相应的UI界面。ArkUI采用了[MVVM](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/MVVM模式（V1）/arkts-mvvm.md>)模式，其中ViewModel将数据与视图绑定在一起，更新数据的时候直接更新视图。如下图所示：

**图1** ArkUI的MVVM模式

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/ebsqUNggRrGfv6N3_s87Cg/zh-cn_image_0000002428028998.png?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=6B479897BFB43D41F4754785F4E4E1E5B88929CEEEA098D6CD6C3721E305EAA7 "点击放大")

ArkUI提供了一系列装饰器实现ViewModel的能力，如[@Prop装饰器：父子单向同步](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Prop装饰器：父子单向同步/arkts-prop.md>)、[@Link装饰器：父子双向同步](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Link装饰器：父子双向同步/arkts-link.md>)、[@Provide装饰器和@Consume装饰器：与后代组件双向同步](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Provide装饰器和@Consume装饰器：与后代组件双向同步/arkts-provide-and-consume.md>)、[LocalStorage：页面级UI状态存储](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md>)等。当自定义组件内变量被装饰器装饰时变为状态变量，状态变量的改变会引起UI的渲染刷新。
...
建议开发者优先使用[Code Linter扫描工具](<../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查/ide-code-linter.md>)进行代码检查，重点关注[@performance/hp-arkui-remove-redundant-state-var](<../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查规则/性能规则@performance/@performancehp-arkui-remove-redundant-state-var/ide-hp-arkui-remove-redundant-state-var.md>)规则。若扫描结果中出现该规则相关问题，可参考本章节提供的优化建议进行调整。
...
建议开发者优先使用[Code Linter扫描工具](<../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查/ide-code-linter.md>)进行代码检查，重点关注[@performance/hp-arkui-remove-unchanged-state-var](<../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查规则/性能规则@performance/@performancehp-arkui-remove-unchanged-state-var/ide-hp-arkui-remove-unchanged-state-var.md>)规则。若扫描结果中出现该规则相关问题，可参考本章节提供的优化建议进行调整。
...
状态变量发生变化时，ArkUI会查询依赖该状态变量的组件并执行依赖该状态变量的组件的更新方法，完成组件渲染的行为。通过使用临时变量的计算代替直接操作状态变量，可以使ArkUI仅在最后一次状态变量变更时查询并渲染组件，减少不必要的行为，从而提高应用性能。状态变量行为可参考[@State装饰器：组件内状态](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@State装饰器：组件内状态/arkts-state.md>)。
...
组件内独享的状态的生命周期和组件同步，状态的定义和更新都在组件内，组件销毁，状态也随即消失。常见于界面UI元素数据，比如当前按钮是否可用、文字是否高亮等。组件内独享的状态使用[@State装饰器](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@State装饰器：组件内状态/arkts-state.md>)，被@State装饰器修饰后状态的修改只会触发当前组件实例的重新渲染。如下图主题列表上单个主题组件内使用@State修饰主题是否被选中的变量，当在界面点击主题时在组件内直接修改状态值。此时，只有当前主题的组件实例会重新渲染，其他主题组件不会重新渲染。

**图2** HMOS世界App主题选择交互图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/32/v3/TDZDRN6KRvOaK7Y5pn0sIQ/zh-cn_image_0000002193850696.png?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=AD803139F91429185CE56142B504E6B01FE43BC23C4AD2FA06CDD3A69035CB3A "点击放大")
...
* 父子组件间共享状态：如下图，”父组件”和其子组件”子组件A”、”子组件B”共享状态loading。
  ...
  **图3** 父子组件间共享状态场景  
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/YoOiG0sbQoCqDhRdo01slw/zh-cn_image_0000002229336085.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=68DF8057FD187FE9162211761580F60F1429C8A2C43D073116F74A24CA37802F "点击放大")

* 不同子树上组件间共享状态：如下图，祖先组件的左子树上”孙子组件AAA”和右子树上”孙子组件BAA”共享状态loading。

  **图4** 不同子树上组件间状态共享场景  
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/rtdsqJOfQGq4-j1yTw3ezA/zh-cn_image_0000002229336109.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=B46F65717097207991B30133D34C28326F6532E8491B357FA61776DD2E721C87 "点击放大")
* 不同组件树间共享状态：如下图，组件树A内”子组件AA”和组件树B内”孙子组件BAA”共享状态loading。

  **图5** 不同组件树间共享状态的场景  
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/WoxYooiRS8mY_IE2g2UaxA/zh-cn_image_0000002483580622.png?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=AEEEB21701EF56F3F0B269503AAF5A6355D3D0248D33F0F61859DA4CFF909AB8 "点击放大")

对于上述三种场景，ArkUI提供了[@State+@Prop](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Prop装饰器：父子单向同步/arkts-prop.md#父组件state到子组件prop简单数据类型同步>)、[@State+@Link](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Link装饰器：父子双向同步/arkts-link.md#简单类型和类对象类型的link>)、[@State+@Observed+@ObjectLink](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Observed装饰器和@ObjectLink装饰器：嵌套类对象属性变化/arkts-observed-and-objectlink.md>)、[@Provide+@Consume](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Provide装饰器和@Consume装饰器：与后代组件双向同步/arkts-provide-and-consume.md>)、[AppStorage](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/AppStorage：应用全局的UI状态存储/arkts-appstorage.md>)、[LocalStorage](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md>)六种装饰器组合以解决不同范围内的组件间状态共享。按照共享范围能力从小到大，各装饰器组合的共享范围能力和生命周期如下：
...
3. LocalStorage：共享范围为[UIAbility](<../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/UIAbility组件/UIAbility组件概述/uiability-overview.md>)内以页面为单位的不同组件树间的共享。存储在LocalStorage中的状态的生命周期与LocalStorage绑定。LocalStorage的生命周期由应用程序决定，当应用释放最后一个指向LocalStorage的引用时，LocalStorage被垃圾回收。
...
**图6** HMOS世界App界面组件示意图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/dYxkxM2LSjifQBBE052C0A/zh-cn_image_0000002229450585.png?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=CE59372476776E3E722A27B17A0ACE7D5366EFA78DFBDBE272D3B545DC4AF136 "点击放大")

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0c/v3/a6fBD7sUSj-KnK9O7REZcQ/zh-cn_image_0000002229450573.png?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=2061146383DB871D6DC9EB8A1F712F0450FB496D13F30F25D9AA08681CB97039 "点击放大")
...
项目中使用[Navigation组件](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/设置组件导航和页面路由/组件导航(Navigation) (推荐)/arkts-navigation-navigation.md>)管理路由，定义“appNavigationStack”变量表示应用当前的路由信息。现“DiscoverView”组件和“ResourceListView”组件需要共享路由信息状态。按照@State+@Prop层层传递的方案，当前各组件的设计如下：

**图7** @State+@Prop当前组件设计图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/wFZER3QwTPywaBILKqONmw/zh-cn_image_0000002229336125.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=49BC110C9A44F5A609E6A145C8911697F4640FFABFD0682198776CA1E48A0C1B "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/41/v3/NMP9QNWwTqq8pjlE-ILu1Q/zh-cn_image_0000002194010292.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=36A5524FC438A44EE5C49C533225C0194A5383B7BE6AD2A896F0C884AD858033 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/l9gdRfTHS_qmW7GbIXYJtw/zh-cn_image_0000002194010312.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=5D5EF8378F06AABDC437D18D7E393B21A6C01FFCFEE942CF4C702A0000361913 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/BuAwma5uRR-BBAkN7VNbMw/zh-cn_image_0000002229450605.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=3F91ED83EB12671956414B4C0C9F89D125BF24D1E77F06688A581296845A8B8F "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/QU6lUxu5QHi0LY8SLkkDQg/zh-cn_image_0000002229450565.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=0A645862E97BC69C72CCAF4B4A1BF57054F423F87453D9391F902E9015007B19 "点击放大")
...
5. AppStorage：适合对于整个应用而言“全局”的变量或应用的[主线程](<../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/线程模型/thread-model-stage.md>)内多个UIAbility实例间的状态共享，如用户信息。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/CsMFig13QpSm5S-QiOPMow/zh-cn_image_0000002193850732.png?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=60C244E0676358A09635BB207C7B563888831B9E2115FF979D3EA7269B125F93 "点击放大")

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/fDpi2ugRQYOiQPjhHrXcYg/zh-cn_image_0000002229450577.png?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=765AD5643DCAE9259D57AB742E42E694EA1187195F9E7D80BED9C400A8F8905D "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/ggYzztIUQkKdnrqjFM5zSA/zh-cn_image_0000002229336089.png?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=9D05F71ACEEC7E1FE6DACD7F82EE69B9E1F43E6AA8FEF737437C091EFFDAC18F "点击放大")
...
建议开发者优先使用[Code Linter扫描工具](<../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查/ide-code-linter.md>)进行代码检查，重点关注[@performance/multiple-associations-state-var-check](<../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查规则/性能规则@performance/@performancemultiple-associations-state-var-check/ide-multi-associations-state-var-check.md>)规则。若扫描结果中出现该规则相关问题，可参考本章节提供的优化建议进行调整。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/ODmKMEiwR6u2DaNfUJb6Zg/zh-cn_image_0000002229450581.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=7BBD05BF87A1383306F1D05EBEA508684DB07BB5080F37317AE72D0459E5D0DB "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bb/v3/TjP_yd04RRqsj_WaZjsPXQ/zh-cn_image_0000002193850736.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085603Z&HW-CC-Expire=86400&HW-CC-Sign=DA3FFB6C953675595D728A794F682BD4651B0E1094C95C3704B4E7003FDFE41B "点击放大")
...
当组件关系复杂或跨越层级过多时，推荐使用[EventHub](<../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/EventHub/js-apis-inner-application-eventhub.md>)或者[Emitter](<../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/进程线程通信/@ohos.events.emitter (Emitter)/js-apis-emitter.md>)自定义事件发布订阅的方式。当数据源改变时发布事件，依赖该数据源的组件通过订阅事件来获取数据源的改变，完成业务逻辑的处理，从而实现组件的精准刷新。
