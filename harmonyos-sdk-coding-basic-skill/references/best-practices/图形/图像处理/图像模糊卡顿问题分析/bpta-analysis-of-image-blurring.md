...
content_hash: sha256:d0c5d4ca847676ebd6d507218a496b4c29781a8129e4f039618e42dfb80cfdcc
---
## 概述
...
2. 默认选择场景化体检，点击任一手动性能体检项（页面间转场、页面内转场、页面滑动）即可进入对应体检界面。本文以“手动性能页面间转场体检”为例进行说明。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0f/v3/8disUeoKQ0CeT0y5wWpXkw/zh-cn_image_0000002539662815.png?HW-CC-KV=V1&HW-CC-Date=20260612T020654Z&HW-CC-Expire=86400&HW-CC-Sign=DF864460C2AC05C17225CA09698487AB7B07D7BC90310E2A7B8506D886C7F014 "点击放大")
3. 完成体检后，打开体检报告并点击展开“转场卡顿率”部分。如果检测结果显示黄色或红色警告，且提示“可能故障原因”为“动态模糊绘制丢帧诊断”，则表明存在图像模糊性能问题。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/ZSBdfoqlS0aJpz86RtYtSg/zh-cn_image_0000002507943106.png?HW-CC-KV=V1&HW-CC-Date=20260612T020654Z&HW-CC-Expire=86400&HW-CC-Sign=E197A76AC2B1B75EF9CBC5B7CF6F16DD2DF48D26CA5FA5AC5BB05831583D020A "点击放大")
...
在使用动态模糊对图片组件进行处理时，若检测结果异常，动态模糊绘制过程中出现丢帧情况。建议改用静态模糊，以优化图片模糊性能。动态模糊与静态模糊的概念及使用场景，请参阅相关文档：[使用场景](../图像模糊动效优化/bpta-fuzzy-scene-performance-optimization.md#section4945532519)。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4e/v3/SoSKGWI3QpasPMfykdKqQQ/zh-cn_image_0000002539782787.png?HW-CC-KV=V1&HW-CC-Date=20260612T020654Z&HW-CC-Expire=86400&HW-CC-Sign=4BB4B278A4904B1225B03051C464CDF43E6EE1E27C5CDB304C376E1869897612 "点击放大")

例如，从检测报告中的可能故障原因中，点击组件所在源码文件，可跳转定位至TestStructPage.ets页面中的Column组件处。在示例代码中，使用了[blur](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#blur)动态模糊API对图片组件进行模糊处理，导致在检测中总耗时过长和丢帧。
...
针对图片模糊场景，建议使用静态模糊。通过静态模糊和动态模糊性能[效果对比](../图像模糊动效优化/bpta-fuzzy-scene-performance-optimization.md#section12488810070)，可以发现在模糊效果类似的条件下，静态模糊的性能要优于动态模糊。建议开发者在组件背景和内容无需实时更新的场景中，优先使用静态模糊，可以减少应用卡顿与丢帧，提升用户体验。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/nGs-3K5zSKuXkzAClzAydQ/zh-cn_image_0000002508102952.png?HW-CC-KV=V1&HW-CC-Date=20260612T020654Z&HW-CC-Expire=86400&HW-CC-Sign=F8B24552E91C57422D014C34B81F54248B0FE694C9B74155BA5FD87F1B40286D "点击放大")

例如，从检测报告中可能故障原因中，点击组件所在源码文件，可跳转定位至ReduceBlurRadius.ets页面中的Text组件处。在示例代码中，使用了[backdropBlur()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backdropblur)对Text组件进行背景模糊，其模糊半径为2。
...
| 模糊API | 模糊类型 | 优化建议 |
| --- | --- | --- |
| [blur](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#blur) | 内容模糊 | 1、若是图片组件，建议使用静态模糊；  2、若是非图片组件或不适用静态模糊的场景，建议减小模糊半径； |
| [backdropBlur](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backdropblur) | 背景模糊 |
| [backgroundBlurStyle](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundblurstyle9) | 背景模糊 |
| [foregroundBlurStyle](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/视效与模糊/组件内容模糊/ts-universal-attributes-foreground-blur-style.md#foregroundblurstyle) | 内容模糊 |
| [backgroundEffect](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundeffect11) | 背景模糊 |
