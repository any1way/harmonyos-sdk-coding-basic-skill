...
scraped_at: 2026-06-12T10:06:54+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:90e1d57a35aadc8e59c3b840a88790e9f722ac707866bc43670ca278b296167a
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/JY_A-HvGSWio-AlgD69BUg/zh-cn_image_0000002337772197.png?HW-CC-KV=V1&HW-CC-Date=20260612T020652Z&HW-CC-Expire=86400&HW-CC-Sign=6994ACDC383344B68C160D753762F68D3DA31B8A7A3C1D62679F3B0249D69FD4)
...
* **静态模糊**：静态模糊是指对输入的静态内容进行模糊处理并获取一张模糊后的图像的模糊。适用于需要为静态图像提供模糊化效果的场景。[Effect Kit](<../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.effectKit (图像效果)/js-apis-effectkit.md>)在Filter图像效果类中提供了[blur](<../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.effectKit (图像效果)/js-apis-effectkit.md#blur>)接口，可用于定义模糊半径，数值越大模糊效果越明显。

* **动态模糊**：动态模糊是指模糊效果会随着每帧模糊内容和模糊半径的变化，进行实时变化的模糊。适用于模糊内容需要实时刷新和更改的场景。系统针对组件内容、背景的动态模糊提供了两种实现动态模糊的方法：[backgroundBlurStyle](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundblurstyle9)和[foregroundBlurStyle](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/视效与模糊/组件内容模糊/ts-universal-attributes-foreground-blur-style.md#foregroundblurstyle)。这两个方法不能指定模糊半径、提亮、饱和度、蒙版颜色等具体参数，只能调用底层将这些参数封装好的[模糊样式](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#blurstyle9)来实现不同风格的模糊效果。同时系统也为开发者提供了能够自定义参数的[backgroundEffect](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundeffect11)，可以对组件背景实现自定义模糊动效。如果只需要对组件进行简单的模糊处理，系统还提供了与静态模糊类似的简单方法[blur](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#blur)和[backdropBlur](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backdropblur)，只需要定义模糊半径即可。
...
**图1** 动态模糊  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/XrCOs7m7RP6_1V6zaOaCjw/zh-cn_image_0000002193850416.gif?HW-CC-KV=V1&HW-CC-Date=20260612T020652Z&HW-CC-Expire=86400&HW-CC-Sign=50A9A665D84D3EB097DE4258548611168137E5F79BBB1BCDDC8387B660BB7E2F "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/34/v3/8EErv8sMTE2PyRzbnn4IhA/zh-cn_image_0000002229450281.gif?HW-CC-KV=V1&HW-CC-Date=20260612T020652Z&HW-CC-Expire=86400&HW-CC-Sign=3D53690EDD8B56AA859B5D821D5F20614FE3987A46515FDAF0D8302BF99F9D38 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/KcM-4jndT3yEuwPdMvKLCw/zh-cn_image_0000002229450285.png?HW-CC-KV=V1&HW-CC-Date=20260612T020652Z&HW-CC-Expire=86400&HW-CC-Sign=645BD37655716DE4A74A4ED04B1C95465ABCD2A02210100CFDB3BAD1F6C2AB99 "点击放大")

如上图所示，通过RenderFrame（执行GPU绘制）标签可以看出，动态模糊转场平均渲染耗时为6.113ms。同时从Present Fence（图形上屏信号）标签可以看出动态模糊转场平均帧率为108.0fps。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/WJmEukHVRn2zH_6rYSoCmQ/zh-cn_image_0000002229335801.png?HW-CC-KV=V1&HW-CC-Date=20260612T020652Z&HW-CC-Expire=86400&HW-CC-Sign=F08995718BFD3B9B31FD7C01BB43D2AA83726FE32F778A5D8CC26CD202828D4B "点击放大")
