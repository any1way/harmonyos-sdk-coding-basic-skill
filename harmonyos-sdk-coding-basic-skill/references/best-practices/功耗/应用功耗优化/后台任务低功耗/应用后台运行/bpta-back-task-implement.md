...
scraped_at: 2026-06-12T10:16:50+08:00
doc_updated_at: 2026-05-22
content_hash: sha256:1dda06954ee5cb475e258f5909959ccb1f00831e8a5ce7d3ba164e5dc54073a3
---
## 概述
...
* [后台硬件资源使用建议](../../../../../harmonyos-guides/应用体验建议/应用功耗体验建议/后台场景/后台硬件资源使用/standard-background-hardware.md)、[后台硬件资源最佳实践](../后台硬件资源合理使用/bpta-use-of-background-hardware-resources.md)：后台进程CPU负载约束（长时任务、短时任务）；应用退到后台无长时任务时使用蓝牙、网络资源、麦克风或者扬声器、GPS资源；退到后台禁止使用传感器。
* [后台软件资源使用建议](../../../../../harmonyos-guides/应用体验建议/应用功耗体验建议/后台场景/后台软件资源使用/standard-background-software.md)、[后台软件资源最佳实践](../后台软件资源合理使用/bpta-use-of-background-software-resources.md)：后台合理使用上传下载、使用音频服务、使用定位导航服务、使用系统资源。
* [Background Tasks Kit简介（后台任务开发服务指南）](<../../../../../harmonyos-guides/应用框架/Background Tasks Kit（后台任务开发服务）/Background Tasks Kit简介/background-task-overview.md>)：后台任务的功能介绍、资源使用约束、后台任务类型。

## 实现原理

### 后台任务类型

标准系统支持规范内受约束的后台任务，包括短时任务、长时任务、延迟任务、代理提醒。开发者可以根据如下介绍，选择合适的[后台任务](<../../../../../harmonyos-guides/应用框架/Background Tasks Kit（后台任务开发服务）/Background Tasks Kit简介/background-task-overview.md#后台任务类型>)，以满足应用退至后台后继续运行的需求。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/soOJWDNURHaNOltFIQe9uQ/zh-cn_image_0000002193850856.png?HW-CC-KV=V1&HW-CC-Date=20260612T021649Z&HW-CC-Expire=86400&HW-CC-Sign=ECF27ACEEFFAE088D9C5799B111D6A7E255C426A815E3D5F11DB2DE45B024636 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/xrc7AD2CSwCBUhptu5x91g/zh-cn_image_0000002193850852.png?HW-CC-KV=V1&HW-CC-Date=20260612T021649Z&HW-CC-Expire=86400&HW-CC-Sign=8E2C95AEB2D87C7999CD1490AF9F08D2DA49BAB1AEC9BE076089084061498F70 "点击放大")
...
4. 在小文件下载、缓存、信息发送等场景中，应用退至后台时，可使用backgroundTaskManager.requestSuspendDelay()接口，后台应用申请短时任务。短时任务的申请和使用过程中的约束与限制请参考[指南](<../../../../../harmonyos-guides/应用框架/Background Tasks Kit（后台任务开发服务）/短时任务(ArkTS)/transient-task.md#约束与限制>)。
...
* **系统息屏场景/应用置于后台场景：**前台应用在自动息屏后，会被识别为置于后台。此时，应用可以申请短时任务，剩余时长上限为3分钟（如下图所示，delayTime为180000ms）。![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/9VpLCSEmRUqF2paiF2aGMw/zh-cn_image_0000002193850864.png?HW-CC-KV=V1&HW-CC-Date=20260612T021649Z&HW-CC-Expire=86400&HW-CC-Sign=A9E3BDB8655FEF58AC1C17896F88AE46ACBD2746CCF9362C50FB3A9FE0C9E0B2)
* 当短时任务的剩余时间不足时，系统会触发回调，停止任务。![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/Acti_--QT8-Q27URsGJG-g/zh-cn_image_0000002229450725.png?HW-CC-KV=V1&HW-CC-Date=20260612T021649Z&HW-CC-Expire=86400&HW-CC-Sign=4E1A898073BA8805B8379498B008842908BD71B376B349CF7D17237C0253492A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/wAONcweLTICFZcEFOM6G7A/zh-cn_image_0000002194010444.png?HW-CC-KV=V1&HW-CC-Date=20260612T021649Z&HW-CC-Expire=86400&HW-CC-Sign=BF79D4CC5BF9A734C25E602E398F53E094AD0A3581CE952CAFB6A20F68ACFB4F "点击放大")
...
* 在定位和导航应用场景中，应用前台运行时开启位置订阅，控制台定期打印位置信息。![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/XHGiZ7-ZQlatf7FMUhad8A/zh-cn_image_0000002229450733.png?HW-CC-KV=V1&HW-CC-Date=20260612T021649Z&HW-CC-Expire=86400&HW-CC-Sign=6FE16265E8124B5B383EE06A090B10B4867DA87E93EF68BC03FB62E92145BCB1)

* 在定位和导航应用场景中，应用退至后台持续运行，控制台日志定时打印位置信息。![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/2JiXnAzNSKCcNhY9G9XtVw/zh-cn_image_0000002194010448.png?HW-CC-KV=V1&HW-CC-Date=20260612T021649Z&HW-CC-Expire=86400&HW-CC-Sign=FC9BC03AFBDB86446B0547E669812ECE99132980DD63B23F25526668563C3899)
