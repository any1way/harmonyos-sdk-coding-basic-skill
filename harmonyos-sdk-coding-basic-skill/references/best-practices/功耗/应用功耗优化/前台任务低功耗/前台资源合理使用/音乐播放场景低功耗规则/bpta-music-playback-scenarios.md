...
content_hash: sha256:466be861f2733b81018f5a6435b0d939a53b5be4e63ca2aa09398ee8624a57a9
---
## 规则

* 音乐类应用静音时关闭音效处理算法。
* 音乐类应用播放时设置正确应用类型，走系统低功耗方案。
* 音乐类应用在后台播放时无需设置播放状态，通过接入[AVSession Kit（音视频播控服务）](<../../../../../../harmonyos-guides/媒体/AVSession Kit（音视频播控服务）/avsession-kit.md>)，设置资源的时长、播放状态（暂停、播放）、播放位置、倍速即可，不需要应用实时更新播放进度。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/KXEl5q-bSumw1KggwBeuBw/zh-cn_image_0000002193850672.png?HW-CC-KV=V1&HW-CC-Date=20260612T021638Z&HW-CC-Expire=86400&HW-CC-Sign=28DCD0DFA52677D41957A7FD6F5501EC42F47570185DC68BF46C09E7F4AD68E3 "点击放大")
