...
content_hash: sha256:40fb2032eda71bcd8c3b7dbb89477c6594db37226fac4f7f3f62c158e7e61a18
---
## 应用UI进程空跑介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/AoHGQVrbTOKyJqmFaYolLA/zh-cn_image_0000002555774310.png?HW-CC-KV=V1&HW-CC-Date=20260612T021624Z&HW-CC-Expire=86400&HW-CC-Sign=9DBB755FCF09B04D65FDFA614D48A316DC2453E2C1E5D40540781778540F00A5 "点击放大")

开发者可进一步在空刷帧中搜索“FlushMessages”，如下图所示，当“FlushMessages”下方存在“UI skip”时，表示该帧未递交任何绘制指令，属于UI空跑。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/u6uafo2KTHCqbHdwyy4j0w/zh-cn_image_0000002586294233.png?HW-CC-KV=V1&HW-CC-Date=20260612T021624Z&HW-CC-Expire=86400&HW-CC-Sign=0E9EACA8FD92AE5815DDC7219B65725E00CB77D35F6F6CE37E22E98D0DD7E2FC "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/I7QqHk6fSbiTM3Bycma4Sg/zh-cn_image_0000002555614690.png?HW-CC-KV=V1&HW-CC-Date=20260612T021624Z&HW-CC-Expire=86400&HW-CC-Sign=EE124CFAC6B217A12C9AA05EDB8A167AE0971FC47E2168258683474A38B4782D "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/aT4iLJPYT_2eP3DH-HOAbw/zh-cn_image_0000002586174287.png?HW-CC-KV=V1&HW-CC-Date=20260612T021624Z&HW-CC-Expire=86400&HW-CC-Sign=0F17518DD6DF2584F65C5189615A8F0BF16452FFB553D79583869C0ED54B3CFD "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e/v3/8ewwM9SWSMe5nxxZEG5ReA/zh-cn_image_0000002555774312.png?HW-CC-KV=V1&HW-CC-Date=20260612T021624Z&HW-CC-Expire=86400&HW-CC-Sign=085AE004DEAF7D05B96501AB2D9027457A360EF32104D61BF8B40F5B83BD3E9E "点击放大")

3. 查看单帧详情信息

   在More栏，点击其中一帧，在应用的主线程泳道，查看H:DisplaySyncId关键字的Trace，依据Type确认根因类型。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/rLUgsTSCQQK1RVJLTSYtlA/zh-cn_image_0000002586294237.png?HW-CC-KV=V1&HW-CC-Date=20260612T021624Z&HW-CC-Expire=86400&HW-CC-Sign=06E00827047B3994D318685EDE285F27A03223BB69210289F9349227E0B5EE6E "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/NmSHG3-SQcCumYWQVxTVrw/zh-cn_image_0000002555614692.png?HW-CC-KV=V1&HW-CC-Date=20260612T021624Z&HW-CC-Expire=86400&HW-CC-Sign=1C6DCAB2F4CD5F75FC921555FF354DC796560429895748713F8ECEF2FCF0C33D "点击放大")
...
DisplaySync支持开发者以[指定帧率运行UI业务](<../../../../harmonyos-guides/图形/ArkGraphics 2D（方舟2D图形服务）/使用可变帧率能力定制不同内容的绘制帧率/请求UI绘制帧率/displaysync-ui.md>)，主要用于精细控制绘制帧率的场景，如动态帧率动画、为特定UI组件设置独立于系统刷新率的绘制帧率等。

推荐的优化措施：

1. 若开发者希望注册监听窗口帧率变化用于分析UI卡顿、丢帧、FPS监控等场景，建议通过接入ohos.window提供的[frameMetricsMeasured](<../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#onframemetricsmeasured22>)接口，该接口仅在客户端UI内容发生重绘时（如页面切换、与可响应组件交互、设置背景色和透明度等）触发注册的回调。

2. 在使用DisplaySync实现自定义动画、独立的UI绘制控制等场景时，需做好生命周期管理，具体优化方案参照[displaySync优化案例](../../功耗场景优化案例/Vsync低功耗优化/bpta-vsync-power-optimization.md)。
