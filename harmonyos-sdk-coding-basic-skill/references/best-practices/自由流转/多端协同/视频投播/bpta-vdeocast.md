...
scraped_at: 2026-06-12T10:12:30+08:00
doc_updated_at: 2026-05-30
content_hash: sha256:ce68fe067d57c2ccdf9e18cc42734fdf8e7cc43b5544ff29c33314627f55467a
---
## 概述
...
详细版本、设备和使用限制见[约束与限制](<../../../../harmonyos-guides/媒体/AVSession Kit（音视频播控服务）/分布式媒体会话/使用投播组件/投播开发指导/distributed-playback-guide.md#约束与限制>)。

## 用户体验

**体验视频**

[](https://contentcenter-videovali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_300_3/3c/v3/AVfJPpTtRFi0E1jitFZBNQ/zh-cn_media_0000002311894292.mp4?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=132EBDF076D0F5F44C1B8F4710C62AAC6CBF62FC88EC4EA9240B7CBDB9C2121F)
...
本文案例提供本端播放和视频投播两种播放模式，体验路径和交互流程图如下。用户可以在本端和远端播放视频，在投播模式下，用户可以通过遥控界面实现快进/快退、切换上下集、音量调节（支持物理键控制）、进度条拖动跳转、选集切换控制功能，应用接入时，可根据实际需求参考本文实现，并按照[应用接入播控自检表](<../../../../harmonyos-guides/媒体/AVSession Kit（音视频播控服务）/应用接入播控自检/应用接入播控自检表/playback-control-access-checklist.md>)完成基础功能验证，确保应用基础体验。
...
| 概念 | 解释 |
| --- | --- |
| **媒体会话（[AVSession](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVSession)/arkts-apis-avsession-avsession.md>)）** | 音视频管控服务，用于对系统中所有音视频行为进行统一的管理。 |
| **投播组件（[AVCastPicker](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS组件/@ohos.multimedia.avCastPicker (投播组件)/ohos-multimedia-avcastpicker.md>)****）** | 系统级的投播组件，可嵌入应用界面的UI组件。当用户点击该组件后，系统将进行设备发现、连接、认证等流程，应用仅需要通过接口获取投播中相关的回调信息。 |
| **投播控制器（[AVCastController](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVCastController)/arkts-apis-avsession-avcastcontroller.md>)****）** | 在投播后，由应用发起的用于控制远端播放的接口，包括播放、暂停、调节音量、设置播放模式、设置播放速度等能力。 |

投播功能通过AVSession建立设备连接，由AVCastController控制远端播放。详见[运作机制](<../../../../harmonyos-guides/媒体/AVSession Kit（音视频播控服务）/分布式媒体会话/使用投播组件/播控特性简介/distributed-playback-overview.md#运作机制>)。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/eayBng8KSSGwHRplaTQMiA/zh-cn_image_0000002345973089.png?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=CC57DEE3B2D3A9456803DE87C52BBF5E746FC7CC847F42D0962FC51DE64D5355 "点击放大")
...
完成投播功能，建议参考如下流程接入，其中本端视频显示和控制可参考[视频播放组件](<../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/媒体展示/视频播放 (Video)/arkts-common-components-video-player.md>)、[使用AVPlayer播放视频(ArkTS)](<../../../../harmonyos-guides/媒体/Media Kit（媒体服务）/媒体开发指导(ArkTS)/播放/使用AVPlayer播放视频(ArkTS)/video-playback.md>)、[使用AVPlayer播放视频(C/C++)](<../../../../harmonyos-guides/媒体/Media Kit（媒体服务）/媒体开发指导(CC++)/播放/使用AVPlayer播放视频(CC++)/using-ndk-avplayer-for-video-playback.md>)等视频实现方案根据功能诉求自行实现，本文从接入播控中心进行介绍。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0b/v3/pc9aS79AQaG3PshjSUhGEg/zh-cn_image_0000002345853277.png?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=19BE54973B8A0BA49871DA0780BDAD13B261C4C701BFD0F84C05A197F6CBE629 "点击放大")

## 接入播控中心

投播功能依赖于播控中心，因此必须接入播控中心才能实现投播功能。播控中心不仅能够控制本端设备的播放，还能控制远端设备的播放。本章节将简要介绍应用接入播控中心的开发流程。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/x6ecPIaJTwi-mivWCixvyw/zh-cn_image_0000002346524017.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=20661C3CCAA7311F42FDF95833FA1E0C198124FADAC672E3BFA7F41E2F1068BD "点击放大")

### 媒体会话初始化

1. [avSession.createAVSession()](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Functions/arkts-apis-avsession-f.md#avsessioncreateavsession10>)创建avsession，类型为video。
2. 设置后台长时播放任务，确保应用退至后台后播放不会停止。
3. [videoSession.setLaunchAbility()](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVSession)/arkts-apis-avsession-avsession.md#setlaunchability10>)设置一个WantAgent用于拉起会话的Ability。
4. [videoSession.activate()](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVSession)/arkts-apis-avsession-avsession.md#activate10>)激活videoSession。
...
[videoSession.setAVMetadata()](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVSession)/arkts-apis-avsession-avsession.md#setavmetadata10>)上传元数据，从而在播控中心界面进行展示。如媒体ID（assetId）、标题（title）、播控中心显示的图片（mediaImage）、媒体时长（duration）。
...
[](https://contentcenter-videovali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_300_3/57/v3/mf6J30y2QPuwmMoiXOlVOg/zh-cn_media_0000002311894304.mp4?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=32197A204837AF868F0144451C4315C95D5ABCB1938A5AA08AE4C6CB9A4DDB7A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/z1jV3iSnQN6Xp2C6H2VovQ/zh-cn_image_0000002345973101.png?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=A86AE02E0675E8313A071E3525521B0E99448B989A3C6D70FEE3FEA1ED624CA2 "点击放大")
...
2. 绘制AVCastPicker，AVCastPicker是投播组件，点击后系统会弹出设备选择半模态。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/VtDRr9AuQ_C8TDoLh4On6A/zh-cn_image_0000002473018785.jpg?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=64156599DCDEC6FDA52AF8151D9965819C6CFDF96BE041C824D47055795448A0 "点击放大")
...
3. 当用户选择设备并设备切换成功后触发[videoSession.on('outputDeviceChange')](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVSession)/arkts-apis-avsession-avsession.md#onoutputdevicechange10>)事件，应用可选择停止本地播放并跳转到遥控页面（或保持本端继续播放），此时播控中心会自动接管远端设备的播放控制，开发者无需额外设置。
...
4. 设置avCastController资源，完成以下三步后远端设备即可投播视频，以播放网络资源为例。
   1. 构建[avSession.AVQueueItem](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interfaces (其他)/arkts-apis-avsession-i.md#avqueueitem10>)。需要传入assetId（播放列表媒体ID，应用自定义）、title（媒体标题）、artist（媒体专辑作者）、mediaUri（媒体URI）、mediaType（媒体类型）、mediaImage（媒体图片像素数据）、duration（媒体播放时长）。
   2. [avCastController.prepare(playItem)](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVCastController)/arkts-apis-avsession-avcastcontroller.md#prepare10-1>)准备播放媒体资源，即进行播放资源的加载和缓冲。
   3. [avCastController.start(playItem)](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVCastController)/arkts-apis-avsession-avcastcontroller.md#start10-1>)启动播放媒体资源。
...
[](https://contentcenter-videovali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_300_3/30/v3/0cWx-zzcRTuwQGUAL7jJbw/zh-cn_media_0000002312054100.mp4?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=A1F236C14CA3582D5218D04562C1181CD9615677814168A11DD2CC03BDE16B98)
...
设备切换依赖于videosession监听设备改变事件，可以通过stopCasting终止投播切换设备，也可以通过[avCastPicker.select()](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Class (AVCastPickerHelper)/arkts-apis-avsession-avcastpickerhelper.md#select14>)进行切换。均会触发[videoSession.on('outputDeviceChange')](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVSession)/arkts-apis-avsession-avsession.md#onoutputdevicechange10>)事件，当切换到远端设备播放，本端应该跳转到遥控器界面，当切换回本端设备播放，应当停止投播并跳转到视频播放页面。应用时序图如下，具体实现见开发步骤。

**时序图**

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/04/v3/pX-Dv1XfQc2dRn6Zu-sdBQ/zh-cn_image_0000002311894312.png?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=9D0D31C189D2DB3D8508C6F8B253ABBD0430BFD8639E1F3032689FE269417544 "点击放大")

**开发步骤**

可以直接使用AVCastPicker切换设备，系统会自动弹出设备选择半模态弹窗，用户可直接选择目标设备完成切换。开发者无需额外处理弹窗逻辑。也可以使用[avCastPicker.select()](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Class (AVCastPickerHelper)/arkts-apis-avsession-avcastpickerhelper.md#select14>) 接口切换设备。

当设备切换时，[videoSession.on('outputDeviceChange')](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVSessionController)/arkts-apis-avsession-avsessioncontroller.md#onoutputdevicechange10>)事件将被触发，开发者可在回调中处理设备切换逻辑：若切换至远端设备则跳转至遥控页面，若切回本端设备则恢复本地播放，实现播放控制的无缝切换。
...
[](https://contentcenter-videovali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_300_3/1a/v3/0uoxTRRxR0qniPAjcDqg1w/zh-cn_media_0000002345973105.mp4?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=4E8E23DDA51B010C3F22069FD0018B0004201343C3612877811D597C7F8BFE5B)
...
当视频在远端设备播放时，为了控制远端视频的播放应用需要监听远端视频播放状态并同步显示本端，通过远端设备或本端播控中心控制，都会直接改变远端设备的播放状态，并触发[avCastController.on('playbackStateChange')](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVCastController)/arkts-apis-avsession-avcastcontroller.md#onplaybackstatechange10>)。应用时序图如下，具体实现见开发步骤。

**时序图**

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/14NNFozJTN21ZjkewaOBIw/zh-cn_image_0000002345853289.png?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=7C7D562F6588ED4AC0B4CA4D9FD0A77729FF8242D2DD7C2D44CB91661BDB5D76 "点击放大")

**开发步骤**

当需要在本地遥控界面同步显示远端视频的播放状态时，可通过[avCastController.on('playbackStateChange')](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVCastController)/arkts-apis-avsession-avcastcontroller.md#onplaybackstatechange10>) 监听状态变化，并使用过滤器筛选目标状态。
...
[](https://contentcenter-videovali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_300_3/c7/v3/uBvlqEZRSay1AumRopDm2A/zh-cn_media_0000002312054104.mp4?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=5A607EBE1D81F0A39A7D409D94549103EE3BBC03F4634BBBC4AB7EC4B2C78202)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/zcolKn9FTlSLMQiiDAKjgQ/zh-cn_image_0000002311894316.png?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=3367975C347B04DD8D1DCA647A1FFD131BBF2304D7B13BA25B6BB2F7365D46AB "点击放大")

**开发步骤**

控制远端设备状态可通过[avCastController.sendControlCommand()](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVCastController)/arkts-apis-avsession-avcastcontroller.md#sendcontrolcommand10>)接口实现，支持多种播放控制命令，包括：暂停、停止、下一首、上一首、快进、快退、跳转、音量调节和倍速设置。只需修改command字段即可切换不同功能，具体命令与功能的对应关系请参考[AVCastControlCommandType](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Types/arkts-apis-avsession-t.md#avcontrolcommandtype10>)。
...
1. 构建[avSession.AVQueueItem](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interfaces (其他)/arkts-apis-avsession-i.md#avqueueitem10>)。
2. [avCastController.prepare(playItem)](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVCastController)/arkts-apis-avsession-avcastcontroller.md#prepare10-1>)。
3. [avCastController.start(playItem)](<../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVCastController)/arkts-apis-avsession-avcastcontroller.md#start10-1>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/qCI_YBooRwGggcitYWjSxw/zh-cn_image_0000002346644421.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021224Z&HW-CC-Expire=86400&HW-CC-Sign=852441668EBBD23005C2234150C9D0ED97B2CEA1E0FDB23A00EB5EE490762033)
...
用户通过“无线投屏”功能实现手机等设备和大屏等的镜像投屏，然后打开视频应用进入视频播放，此时会自动切换为资源投播，详见[镜像投屏自动切换资源投播](<../../../../harmonyos-guides/媒体/AVSession Kit（音视频播控服务）/分布式媒体会话/使用投播组件/投播开发指导/distributed-playback-guide.md#镜像投屏自动切换资源投播>)。目前投播暂不支持视频弹幕功能，若应用想优先保证弹幕体验，可不接入此功能。
