...
scraped_at: 2026-06-12T10:12:52+08:00
doc_updated_at: 2026-05-22
content_hash: sha256:3ef868d5ecac09183dac4070813aace6177366c15e7eab7fde2b90fc1d058497
---
## 概述
...
拖拽过程中的数据传输基于统一数据管理框架（Unified Data Management Framework，UDMF）实现，UDMF为多对多跨应用数据共享场景提供了[标准化数据通路](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md>)和[标准化数据结构](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.uniformDataStruct (标准化数据结构)/js-apis-data-uniformdatastruct.md>)。统一数据对象[UnifiedData](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#unifieddata>)提供了封装一组数据记录的方法，其中数据记录[UnifiedRecord](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#unifiedrecord>)可为一条HTML记录、一条图片记录等。UnifiedRecord支持调用[addEntry()](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#addentry15>)接口在当前数据记录中添加指定数据类型和内容的数据，通过此方法增加的数据类型和内容代表同一内容的不同表现形式。例如，对于一段文字，可以构造html和text两种样式的entry。通过这种方式，接收方能够按需选择接收。
...
* [本地文件拖拽保存](bpta-unified-drag-and-drop.md#section722512624716)：拖拽本地的文件，落入方调用[startDataLoading()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#startdataloading15)接口获取数据，根据需要选择是否将文件保存到落入方沙箱路径。
...
[拖拽的流程](https://developer.huawei.com/consumer/cn/doc/design-guides/hmi-scenes-drag-0000001795410277#section1417334354817)可以分为三部分：发起拖拽、拖拽中和释放拖拽。其中，拖出方通过[draggable()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/拖拽控制/ts-universal-attributes-drag-drop.md#draggable)和[onDragStart()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)等接口处理拖出数据，拖入方通过[allowDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/拖拽控制/ts-universal-attributes-drag-drop.md#allowdrop)和[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)等接口处理拖入数据，拖拽数据使用UDMF统一数据对象[UnifiedData](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#unifieddata>)进行封装。
...
[默认支持拖出能力的组件](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md)，如[Search](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Search/ts-basic-components-search.md)、[Hyperlink](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Hyperlink/ts-container-hyperlink.md)等，在拖出时会使用组件的默认拖出响应。其中[Search](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Search/ts-basic-components-search.md)组件默认拖拽内容为选中的文字，[Hyperlink](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Hyperlink/ts-container-hyperlink.md)组件默认拖拽内容为超链接地址。如果想自定义组件的拖拽内容，需要在组件的[onDragStart()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)接口中将自定义数据封装成[UnifiedData](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#unifieddata>)数据对象，通过[DragEvent](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragevent7)的[setData()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#setdata10)接口设置拖出数据。对于其他非默认组件或自定义组件，如果想实现其拖出功能，需要将组件的[draggable()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/拖拽控制/ts-universal-attributes-drag-drop.md#draggable)属性设置为true，并自定义组件的拖拽内容。以RichEditor组件为例：
...
可以在[onDragStart()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)接口中处理拖拽信息，例如为图片添加水印，详情见[拖拽图像增加水印](bpta-unified-drag-and-drop.md#section197593813453)。

### 拖拽中

通过标准手势发起拖拽后，系统会默认将组件本身的截图作为[拖拽背板图](<../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/支持统一拖拽/arkts-common-events-drag-event.md#拖拽背板图>)。如果想自定义拖拽背板图，需要在组件的[onDragStart()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)回调中设置[DragItemInfo](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragiteminfo)，传入自定义背板图。此外，可以在拖拽目标组件上注册[onDragMove()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragmove)监听，并在回调函数中实时获取拖拽过程中的信息，如拖拽点的坐标等。以Image组件为例，示例代码如下：
...
只有监听了[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)事件，拖拽在组件范围内移动时，才会触发[onDragMove()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragmove)事件。

### 释放拖拽

[默认支持拖入能力的组件](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)，如[Search](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Search/ts-basic-components-search.md)组件等，将目标拖入组件区域内会使用默认拖入响应。如果想自定义组件的拖入响应，需要将组件的[allowDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/拖拽控制/ts-universal-attributes-drag-drop.md#allowdrop)属性设置为允许拖入的数据类型，并在其[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)接口中通过[DragEvent](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragevent7)的[getData()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#getdata10)接口获取拖入数据后，读取其中的UnifiedRecord记录的集合。对于每条记录，调用[getTypes()](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#gettypes12>)方法获取其中包含的数据类型，取出所需要的数据。以Text组件获取拖拽文字为例：
...
可以在[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)接口中处理接收到的数据，例如将图片识别为文字以显示在只支持文字的组件上，详情见[AI识别拖拽内容](bpta-unified-drag-and-drop.md#section4125035104613)。
...
**图1** 拖拽图片增加水印  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/kYyt3f97ReiNzJmBRSSZbA/zh-cn_image_0000002315615638.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021231Z&HW-CC-Expire=86400&HW-CC-Sign=680492DEBB2C6EA61DFDE9A529B87A66F1489C531D7F8EB51BD1B162DA062100 "点击放大")

**实现原理**

在拖出对象的[onDragStart()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)接口中获取图像信息，调用系统绘制能力[drawing](<../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/js-apis-graphics-drawing.md>)在图像上绘制水印，通过[DragEvent](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragevent7)的[setData()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#setdata10)接口将水印图像设置为拖拽数据。

**开发步骤**

1. 将拖出方Image组件的[draggable()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/拖拽控制/ts-universal-attributes-drag-drop.md#draggable)属性设置为true。
...
2. 在拖出对象的[onDragStart()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)接口中，获取图像信息并将其转换成[PixelMap](<../../../../harmonyos-references/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)。
...
3. 将图片绘制到[Canvas](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/画布绘制/Canvas/ts-components-canvas-canvas.md)画布上，并获取拖拽时间作为水印绘制到画布上的指定位置，得到添加水印的图像。
...
4. 将图像打包保存在文件中，调用[DragEvent](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragevent7)的[setData()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#setdata10)接口将水印图像设置为拖拽数据。
   ...
   7. fileIo.openSync(`${this.context!.filesDir}/watermark.png`, fileIo.OpenMode.CREATE | fileIo.OpenMode.READ_WRITE);
...
[拖拽背板图](<../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/支持统一拖拽/arkts-common-events-drag-event.md#拖拽背板图>)用于在拖拽过程中展示用户拖动的数据，可以自定义拖拽背板图。

**运行效果**

**图2** 自定义拖拽背板  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/yeJkGGiVTAGyxo12yDNkTw/zh-cn_image_0000002349574333.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021231Z&HW-CC-Expire=86400&HW-CC-Sign=681AA031411F14EA3A7A7593DA9ACBD0B80A85C608C2429D90246720C72292E5 "点击放大")

**实现原理**

在拖出对象的[onDragStart()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)接口中，自定义[PixelMap](<../../../../harmonyos-references/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)作为拖拽过程中的背板图。
...
2. 将自定义组件转换成PixelMap，作为拖拽过程中显示的图片。
   ...
   由于[CustomBuilder](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8)需要离线渲染之后才能使用，存在一定的性能开销和时延，因此推荐开发者优先使用[DragItemInfo](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragiteminfo)中的[PixelMap](<../../../../harmonyos-references/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)方式返回背板图。
3. 在拖出对象的[onPreDrag()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#onpredrag12)接口中，预先创建背板图。
...
4. 在拖出对象的[onDragStart()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)接口中，将回调的PixelMap作为拖拽过程中的背板图。
...
**图3** AI识别拖拽内容  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/o-GYrjxPSWS3QkgI93YC2g/zh-cn_image_0000002349614541.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021231Z&HW-CC-Expire=86400&HW-CC-Sign=7C1F94470A5241EDC9F9E0C2E394228B8A8F2CA493240BCF5DB4D948239A6E70 "点击放大")

**实现原理**

在拖入对象的[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)接口中，通过[DragEvent](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragevent7)的[getData()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#getdata10)接口获取拖拽数据后，调用系统能力[textRecognition（文字识别）](<../../../../harmonyos-references/Core Vision Kit（基础视觉服务）/ArkTS API/textRecognition（文字识别）/core-vision-text-recognition-api.md>)得到图像中的文字信息。

**开发步骤**

1. 在拖拽释放区域的[allowDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/拖拽控制/ts-universal-attributes-drag-drop.md#allowdrop)接口中设置允许拖入的数据类型为[uniformTypeDescriptor.UniformDataType.IMAGE](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.uniformTypeDescriptor (标准化数据定义与描述)/js-apis-data-uniformtypedescriptor.md#uniformdatatype>)。
...
2. 在拖入对象的[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)接口中，调用[DragEvent](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragevent7)的[getData()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#getdata10)接口获取拖拽数据。
...
3. 将拖拽数据转换成颜色数据格式为BGRA\_8888的[PixelMap](<../../../../harmonyos-references/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)类型的视觉信息。
...
对于本地文件的拖拽，建议构造FileUri类型的数据进行拖拽。在文件落入时，应通过调用[startDataLoading()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#startdataloading15)接口获取数据，如需将文件保存在本地，可设置[datasyncoptions](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#datasyncoptions15)参数的destUri值，将文件保存至本地沙箱路径中。
...
**图4** 在线图片拖拽  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/04/v3/cbleKujWQNKIZfbwUcMiRA/zh-cn_image_0000002315775454.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021231Z&HW-CC-Expire=86400&HW-CC-Sign=2AC29A38313A0134DE3E2A348152A74A4E9DAC9C0EDE0ABB3283FF7BC8FC619F "点击放大")
...
在落入方[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)回调中获取拖拽数据，得到访问图片的链接，同时根据业务需要选择是否将图片下载到本地。本示例模拟了需要下载的场景。
...
2. 设置拖出方Image组件的[draggable()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/拖拽控制/ts-universal-attributes-drag-drop.md#draggable)属性为true。
...
3. 在落入方Image组件的[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)回调中获取图片的uri，绑定到落入方组件上，触发UI刷新。
...
4. 在落入方Image组件的[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)回调里调用[request](<../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md#导入模块>)的[downloadFile()](<../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md#requestdownloadfile9>)方法下载图片资源。
...
**图5** 本地视频拖拽  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d/v3/PxFw_XFMQwKTUI938vhhHA/zh-cn_image_0000002315615654.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021231Z&HW-CC-Expire=86400&HW-CC-Sign=601C52E45DB6A5F6C3B3B4DFE367FF7FB7690ECC7648473DE70DE72738B3E357 "点击放大")

**实现原理**

为了实现文件的拖拽，通常会构建一个[uniformDataStruct.FileUri](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.uniformDataStruct (标准化数据结构)/js-apis-data-uniformdatastruct.md#fileuri15>)类型的数据对象，传入文件的uri，并通过设置fileType属性来区分不同的文件类型。在接收方的[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)回调函数中获取uri，进而访问该文件。建议使用UDMF的[startDataLoading()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#startdataloading15)接口获取文件，并展示获取进度。如果接收方需要将文件拷贝到本地，可以通过向参数[datasyncoptions](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#datasyncoptions15)传入destUri来指定目标路径，UDMF将会把文件拷贝至该路径。

**实现步骤：**

1. 设置拖出方Video组件的[draggable()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/拖拽控制/ts-universal-attributes-drag-drop.md#draggable)属性为true。
...
2. 在拖出视频的[onDragStart()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)回调中，将视频文件复制到沙箱目录。构造[uniformDataStruct.FileUri](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.uniformDataStruct (标准化数据结构)/js-apis-data-uniformdatastruct.md#fileuri15>)类型的数据，将oriUri设置为沙箱路径下视频文件的uri。
...
3. 在拖入方Video组件的[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)回调里调用[startDataLoading()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#startdataloading15)接口获取拖拽的数据，提取uri并绑定到落入方Video组件上。同时由于设置了[datasyncoptions](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#datasyncoptions15)中的destUri参数，UDMF会将视频保存到本地的沙箱路径中。
...
此场景涉及拖拽图片与文字混合的内容。对于轻量级的图文混排内容，可以通过向[Text](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md#接口)组件中添加[Span](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Span/ts-basic-components-span.md#接口)和[ImageSpan](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/ImageSpan/ts-basic-components-imagespan.md#接口)子组件来实现。此外，使用[RichEditor](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#接口)组件也可构建图文混排内容。如何选择适合的图文混排组件，请参考[如何选择图文混排方案](../../../../harmonyos-faqs/应用框架开发/UI框架/方舟UI框架（ArkUI）/如何选择图文混排的实现方案/faqs-arkui-23.md)。
...
**图6** Text组件图文混排拖拽  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/VQ_Np5JITTiO0jRKga6qyw/zh-cn_image_0000002349574337.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021231Z&HW-CC-Expire=86400&HW-CC-Sign=BA9387665CFDD9279002E2D5F1473DBB2590B4C80837695A91F699E787626686 "点击放大")

**实现原理**

[Text](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md#接口)组件默认具有拖出能力，在拖入区域中分别接收文本和图片对应的UnifiedRecord数据，绑定至拖入Text组件的[Span](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Span/ts-basic-components-span.md#接口)和[ImageSpan](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/ImageSpan/ts-basic-components-imagespan.md#接口)子组件上，实现较为简单，但是不支持交互式编辑，且拖入方组件需要预先和拖出方组件保持一致的样式，灵活性较差。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/ZkcH9WpAQ3WFGU8aCZj1cw/zh-cn_image_0000002349614553.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021231Z&HW-CC-Expire=86400&HW-CC-Sign=E64855F3AAE893A17DF778BFFB1D679F0E5EFC9CF1F1C5361243061DCD8A494B "点击放大")

**实现原理**

RichEditor组件默认具备拖出的能力，并且支持交互式编辑，在拖出方不需要手动构造拖拽的数据，在拖入方通过[addImageSpan()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addimagespan)方法和[addTextSpan()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addtextspan)方法动态地将图片和文字的内容添加到拖入方RichEditor组件上。通过这种方式，在拖入方声明RichEditor组件即可，接收到的图文内容可以动态地添加，使用起来更加方便灵活，代码开发较为简单，核心代码如下：
...
使用RichEditor组件时，需要在[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)回调里手动调用[DragEvent](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragevent7)的[setResult()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#setdata10)接口设置拖拽结果，否则会执行系统默认的[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)接口导致文字落入两次。参见[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)接口。
...
**图8** 多Entry图文混排拖拽  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/5PHI-OYRRta6E_j_ElQHiA/zh-cn_image_0000002315775466.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021231Z&HW-CC-Expire=86400&HW-CC-Sign=548B3CA20B858F3C33683FBCD8127629AD8A6BB18C9DBB93ED9E18E48CDFFDE6 "点击放大")
...
1. 在拖出方RichEditor组件的[onDragStart()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)回调中，根据选中的内容构造拖拽数据。
...
4. 在落入方[onDrop()](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)回调里获取拖拽数据，调用[getEntry()](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#getentry15>)接口读取所需要格式的数据。
...
需要应用[声明支持分屏](../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/智慧多窗应用开发指南/应用适配智慧多窗/应用声明支持智慧多窗/multi-window-support.md#声明支持分屏)，并根据需求自定义拖拽响应。

**运行效果如下图所示**

**图9** 分屏拖拽  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/3ttYY2nFTNeAYLHUvElLuw/zh-cn_image_0000002315615670.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021231Z&HW-CC-Expire=86400&HW-CC-Sign=55C2AC0B1AD0698299994D979F513E8BAB411FD6E3046A74EDAC07F8D71EBA20 "点击放大")
...
需要满足跨设备拖拽开发指导中的[约束与限制](../跨设备拖拽/bpta-distribute-drag-cast.md#section990465462314)，并根据需求自定义拖拽响应。

**结果展示**

**图10** 跨设备拖拽效果展示  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/1QNSpTPhQRG9HEihS3j-jA/zh-cn_image_0000002349574349.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021231Z&HW-CC-Expire=86400&HW-CC-Sign=80C6EE53E4BE42867A04C013B4FF1337C3BE6D74EB15ACE4780C447E89C666F6 "点击放大")

## 拖入小艺和中转站

将数据拖入系统的中转站，可以实现跨应用数据拖拽和跨设备数据流转。将数据拖入小艺，可以利用系统的AI能力处理拖拽数据。小艺和中转站支持落入[标准化数据通路](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#unifiedrecord>)中定义的数据类型，开发者需要在起拖时构造相应的数据。

**使用限制**

应用本身预置的[资源文件](../../../../harmonyos-guides/基础入门/资源分类与访问/resource-categories-and-access.md#资源组目录)（即应用在安装前的HAP包中已经存在的资源文件）不支持拖入小艺和中转站。

**运行效果如下图所示**

**图11** 将数据拖入小艺  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/ye-XxeyhSMWSlkcLZdJ4Qw/zh-cn_image_0000002349614565.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021231Z&HW-CC-Expire=86400&HW-CC-Sign=B24197A46B0DBB97BA793C98D549D89C0C9F277D262C83F1C37F4059F26CF8BD "点击放大")

**图12** 将数据拖入中转站  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/lZSPbEFJTfaVuxqNA32ryQ/zh-cn_image_0000002315775482.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021231Z&HW-CC-Expire=86400&HW-CC-Sign=16238DD009ED02601EE8A2CEF708660966016720F6250C7F3940FB190920B110 "点击放大")

## 常见问题

### 模拟器无法识别AI拖拽内容

模拟器不支持[textRecognition](<../../../../harmonyos-guides/AI/Core Vision Kit（基础视觉服务）/通用文字识别/core-vision-text-recognition.md>)接口的调用，建议使用真机进行调试，详细请参见基础视觉服务[模拟器支持情况](<../../../../harmonyos-guides/AI/Core Vision Kit（基础视觉服务）/Core Vision Kit简介/core-vision-introduction.md#模拟器支持情况>)。

### 拖拽的触发手势长按浮起与长按手势之间存在冲突

若组件既需要处理长按手势，又需要支持可拖拽能力（拖拽的触发为长按500ms并移动10vp)，则可通过 parallelGesture 实现多个手势事件的处理，而不产生冲突。详细请参见[绑定手势方法](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/绑定手势/绑定手势事件/ts-gesture-settings.md)。
