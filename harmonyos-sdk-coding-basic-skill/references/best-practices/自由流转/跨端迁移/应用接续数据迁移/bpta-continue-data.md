...
scraped_at: 2026-06-12T10:12:19+08:00
doc_updated_at: 2026-05-30
content_hash: sha256:cb8571144e41291662aa95ba1e6a25182436e82127dd7169107da69d855ec009
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/84/v3/tLvZvvp9SO6E9Dz6yV1Mcw/zh-cn_image_0000002563683642.png?HW-CC-KV=V1&HW-CC-Date=20260612T021217Z&HW-CC-Expire=86400&HW-CC-Sign=35B05526E9FE1AC7C972BECCB157D422DB49AB854CFD3CEFC50A89345879C5E7 "点击放大")

实现原理见[运作机制](../应用接续概述/bpta-continue-cast.md#section1218874218264)。

## 开发步骤

接入应用接续需要[启用应用接续能力](../应用接续概述/bpta-continue-cast.md#section15192222815)、[配置应用启动模式类型](../应用接续概述/bpta-continue-cast.md#section10604645308)、[源端保存迁移数据](../应用接续概述/bpta-continue-cast.md#section634613594303)和[对端恢复数据](../应用接续概述/bpta-continue-cast.md#section12346113618453)，具体开发流程见[应用接续概述](../应用接续概述/bpta-continue-cast.md)，本文只关注在不同场景下迁移数据方案的选择。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/kcGt1MEOQUKSrgfjuTc9JA/zh-cn_image_0000002594323411.png?HW-CC-KV=V1&HW-CC-Date=20260612T021217Z&HW-CC-Expire=86400&HW-CC-Sign=E4658DC43227201DD009E5B43AD83F0D0CE94EE249B1126A900CD7CEE71F64B1)
...
1. 源端保存迁移数据
   ...
   在源端UIAbility的[onContinue()](<../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#oncontinue>)接口中创建分布式数据对象并保存数据，执行流程如下：
   ...
   * 当前，wantParams中“sessionId”字段在迁移流程中被系统占用，建议开发者在wantParams中定义其他key值存储该分布式数据对象生成的id，避免数据异常。
   ...
   52. try {
   53. await this.d_object.save(wantParam.targetDevice as string);
   54. } catch (error) {
   55. hilog.error(DOMAIN_NUMBER, TAG, 'Failed to save. Error: ', JSON.stringify(error) ?? '');
   56. }
