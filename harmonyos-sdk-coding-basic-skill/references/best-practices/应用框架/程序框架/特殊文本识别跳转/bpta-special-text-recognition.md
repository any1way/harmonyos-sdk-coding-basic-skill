...
content_hash: sha256:d57fc3495a01b891912df0d87c8663661f93c34dbb99aa81b7eb8d203e2eae4d
---
## 概述
...
[](https://contentcenter-videovali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_300_3/aa/v3/mICBWdD5RUSwy5uIbn_iMQ/zh-cn_media_0000002284820694.mp4?HW-CC-KV=V1&HW-CC-Date=20260611T085724Z&HW-CC-Expire=86400&HW-CC-Sign=A0F993B8C5E60C52D03FCC13833F7CD6F77935DAEFD5C20EDE5A09E12B2C53E0)
...
Text组件提供了[enableDataDetector](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md#enabledatadetector11)属性，通过将该属性设置为true，即可进行文本特殊实体识别。一段文字中若包含标准HTTP/HTTPS链接、App Linking链接、日期、电话号码、地址、邮箱等，则这些特殊文本会被自动识别为可点击的链接格式。手势点击和鼠标右键点击实体，会根据实体类型弹出对应的实体操作菜单，鼠标左键点击实体会直接响应菜单的第一个选项。

常用的文本与输入组件是否支持设置[enableDataDetector](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md#enabledatadetector11)属性如下表所示。
...
2. 组件样式设置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/64/v3/g6BqehXvTOat2R0dSWUMJQ/zh-cn_image_0000002319470057.png?HW-CC-KV=V1&HW-CC-Date=20260611T085724Z&HW-CC-Expire=86400&HW-CC-Sign=D22EDDB6D20637C0B07B52D11EBE233E0464FA45BCE2B062E003781C1983C265 "点击放大")
3. 启用特殊文本识别。

   在Text组件上启用[enableDataDetector](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md#enabledatadetector11)属性，即可实现对一段文字中的链接、日期、电话号码、地址、邮箱等特殊文本进行自动识别并标记。
...
4. 识别效果验证。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/56HXRpQSSQuEUNSIk0jzvQ/zh-cn_image_0000002284820702.png?HW-CC-KV=V1&HW-CC-Date=20260611T085724Z&HW-CC-Expire=86400&HW-CC-Sign=F8911EF99F030D84FDF60602B4C180E10670A2B8623C4B3EA70DEDED00773835 "点击放大")
