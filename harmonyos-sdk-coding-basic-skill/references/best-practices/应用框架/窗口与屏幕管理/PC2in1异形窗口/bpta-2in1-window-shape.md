...
scraped_at: 2026-06-11T16:58:37+08:00
doc_updated_at: 2026-05-22
content_hash: sha256:0b0c9cc79435eaefe46e0341d61064d1a8a889c2bfe596f15a80cf6b269c1d47
---
## 概述
...
简单来说，掩码即是由数字1描绘的窗口形状点阵图。具体使用可参考[setWindowMask()](<../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setwindowmask12>)接口。
...
1. 为使用setWindowMask()等接口，需要额外配置syscap.json文件，在模块/src/main目录下，创建syscap.json文件，填入以下内容：
   ...
   13. }
   ```
2. 具体代码中，使用createSubWindow()创建子窗口（参考[设置应用子窗口](../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/管理应用窗口（Stage模型）/application-window-stage.md#设置应用子窗口)），或使用createWindow()接口创建悬浮窗（参考[设置悬浮窗受限开放](../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/管理应用窗口（Stage模型）/application-window-stage.md#设置全局悬浮窗受限开放)），设置窗口的位置、大小及其他属性等，然后使用setUIContent()接口设置窗口加载的page页面。
...
**图1** 圆形子窗口效果  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/odarM0gDQMqpKN9rUhMS9Q/zh-cn_image_0000002229337273.png?HW-CC-KV=V1&HW-CC-Date=20260611T085834Z&HW-CC-Expire=86400&HW-CC-Sign=ED1BBAA78356AB8560FB1F468F435768B501195D2BC13C72B9237685A9F51EC8 "点击放大")

**图2** 三角形子窗口效果  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/i09OCQvFTmucGRdsz3a-wA/zh-cn_image_0000002194011476.png?HW-CC-KV=V1&HW-CC-Date=20260611T085834Z&HW-CC-Expire=86400&HW-CC-Sign=F6DE5B17BB07FF4D822084C99C727295CB8610DA842EE949036B5E15AC4985BD "点击放大")
...
**图3** 不规则示例图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/88/v3/0VdCym4xRG6TWdJuO-ehXw/zh-cn_image_0000002229451765.png?HW-CC-KV=V1&HW-CC-Date=20260611T085834Z&HW-CC-Expire=86400&HW-CC-Sign=6BDBAC216A627DD8B647F23EBE7442F60F0A930359E3E6CAB36CCAD7D6C1EC9D)
...
**图4** 不规则形状子窗口效果  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/7wktg0Z-QTi9OAK9Bk5NtA/zh-cn_image_0000002193851884.png?HW-CC-KV=V1&HW-CC-Date=20260611T085834Z&HW-CC-Expire=86400&HW-CC-Sign=7BB0AFDBD19E7E712A48775E85719F277F255CA585D44AB1A03EB4A25E0B2D94)
