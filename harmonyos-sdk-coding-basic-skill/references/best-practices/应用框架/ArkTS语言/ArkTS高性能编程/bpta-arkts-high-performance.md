...
scraped_at: 2026-06-01T16:45:48+08:00
doc_updated_at: 2026-03-19
content_hash: sha256:e54fb220eb1237b9e10ef8d2bfdcbb7f2541126f9837c7798a659b4fe6f583d4
---
## 概述
...
建议开发者优先使用[Code Linter代码检查](<../../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查/ide-code-linter.md>)进行代码检查，重点关注[@performance/hp-performance-no-closures](<../../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查规则/性能规则@performance/@performancehp-performance-no-closures/ide_hp-performance-no-closures.md>)规则。若扫描结果中出现该规则相关问题，可参考本章节提供的优化建议进行调整。
...
详细请参见：[延迟加载（lazy import）](<../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS运行时/ArkTS模块化/延迟加载 (lazy import)/arkts-lazy-import.md>)。
