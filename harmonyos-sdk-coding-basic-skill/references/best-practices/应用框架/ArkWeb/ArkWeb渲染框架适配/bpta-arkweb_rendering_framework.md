...
scraped_at: 2026-06-11T16:58:51+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:f343a7a9c645591aa829a765e7f7c50c76455d587f1e09f4be9c93669ada092b
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/JrFeJOaPSTaDyLcDeAhQtg/zh-cn_image_0000002194010404.png?HW-CC-KV=V1&HW-CC-Date=20260611T085850Z&HW-CC-Expire=86400&HW-CC-Sign=D8C76BD25DE427331396A73B1C960C13F1244914626C5CD187AE8422C2261AE5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/2D4brgbAS0yPt8BTAtVXmw/zh-cn_image_0000002229450681.png?HW-CC-KV=V1&HW-CC-Date=20260611T085850Z&HW-CC-Expire=86400&HW-CC-Sign=70415D8E0CCD1FBD25CAE827EFD306F1FEBD8F15E78D24768C942A79387411CE)
...
前端可以使用native.makePhoneCall(..) 的方式进行调用。且方法的参数支持基本类型、字典对象、函数等，对于JSBridge的设计提供了便利。关于Web.javaScriptProxy()以及WebviewController.registerJavaScriptProxy()的使用方法可以参考《[前端页面调用应用侧函数](../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/在应用中使用前端页面JavaScript/前端页面调用应用侧函数/web-in-page-app-function-invoking.md)》。

通过对比，javaScriptProxy注入对象的方式构造JSBridge是一个比较好的技术选型。建议JSBridge的实现基于注入机制进行设计，并考虑分层设计来提高其通用性和灵活性，下图展示一种分层设计思路：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/kRjMTIp9QLy7bFsd9hcumw/zh-cn_image_0000002229450697.png?HW-CC-KV=V1&HW-CC-Date=20260611T085850Z&HW-CC-Expire=86400&HW-CC-Sign=727B1BF7B3A3A7C74C04AF1DDAA8B1B382CEE41E7826FE1099C34CA34977C7A4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/df/v3/5nfXIRwLTwCmF4WeDe1ysw/zh-cn_image_0000002229450693.png?HW-CC-KV=V1&HW-CC-Date=20260611T085850Z&HW-CC-Expire=86400&HW-CC-Sign=85B185A8D912D29DDDF70927D580967828ABBFC8AB84D304D285692FAB0B527F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/Boxc34hxSQOFlk7g6rP8EQ/zh-cn_image_0000002229450701.png?HW-CC-KV=V1&HW-CC-Date=20260611T085850Z&HW-CC-Expire=86400&HW-CC-Sign=E08FDE2331A2C3137E259D2B5CAFB6346AEA48635E99D44587CACDBCDA4BC677)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/kqANfnwqQq2PR5wj1H_YWw/zh-cn_image_0000002229450685.png?HW-CC-KV=V1&HW-CC-Date=20260611T085850Z&HW-CC-Expire=86400&HW-CC-Sign=11E99BEE51EED3F49FC96F1AB9AF98D9725AD0ED060A528452524094C0DB57C0)

离屏节点动态上下树：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/lkdSakX-QaapwM_AhdHRuw/zh-cn_image_0000002229450689.png?HW-CC-KV=V1&HW-CC-Date=20260611T085850Z&HW-CC-Expire=86400&HW-CC-Sign=1BD16930BDDB043E3739C874A05E388E76E9C2D033C6A780AE4605D7AE0FB216)
...
实现中可以使用map容器把embedType和离屏节点的builder()函数进行关联，当makeNode()执行时，取出embedType对应的builder()函数来创建rootNode节点，最后把rootNode节点关联的FrameNode返回，达到离屏节点动态上树、H5渲染出原生组件的效果。同层渲染可以参考文档《[同层渲染绘制Video和Button组件](../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/同层渲染/web-same-layer.md)》
