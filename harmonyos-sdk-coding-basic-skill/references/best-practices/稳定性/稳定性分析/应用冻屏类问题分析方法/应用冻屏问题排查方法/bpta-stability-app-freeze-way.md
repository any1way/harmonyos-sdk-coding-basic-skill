...
content_hash: sha256:72711f3caca3d3d58386a29c129bb7db220ab76c064de1edeb8f7b9bf1b8eff2
---
注意

应用冻屏日志获取方法与日志规格详见[日志获取](<../../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/故障检测/AppFreeze（应用冻屏）检测/appfreeze-guidelines.md#日志获取>)和[日志规格](<../../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/故障检测/AppFreeze（应用冻屏）检测/appfreeze-guidelines.md#日志规格>)。
...
DevEco Studio会收集设备的故障日志并归档到FaultLog下。具体可参考[FaultLog](../../../../../harmonyos-guides/编写与调试应用/日志与故障分析/故障分析/FaultLog/ide-fault-log.md)。
...
4. 对比warning/block事件，观察watchdog任务在队列中的移动情况。参考：[AppFreeze（应用冻屏）检测](<../../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/故障检测/AppFreeze（应用冻屏）检测/appfreeze-guidelines.md>)。
...
1. warning/block栈一致，卡锁
   ...
   堆栈显示等锁卡死，通过反汇编获取对应代码行，排查其他线程栈和代码上下文锁的使用解决故障，请参考：[通过llvm-addr2line工具定位行号](../../应用异常退出类问题分析方法/CppCrash类问题分析方法/bpta-stability-app-crash-cpp-way.md#li186453444512)。
...
5. 应用退出
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/9Y-1Uq5YT4GoRWFm4MFFMA/zh-cn_image_0000002404125181.png?HW-CC-KV=V1&HW-CC-Date=20260612T021744Z&HW-CC-Expire=86400&HW-CC-Sign=8ECEA3FF1338C6AC3745F4C225B36978A66AACA8C57AE39E1689AB3CFECC713F)![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/r5Wz0_3aRBWqtsE2ydS0uA/zh-cn_image_0000002370405640.png?HW-CC-KV=V1&HW-CC-Date=20260612T021744Z&HW-CC-Expire=86400&HW-CC-Sign=3B0BE5A03D30D26C19F6CDC5805FF4E9BD760AA8842D96ADEDB792B4B4D93ED6)例如示例：APP\_INPUT\_BLOCK 类型在07:24:08.167上报，应用主线程在07:24:01.581后就没有打印了，可排查是否为FormManagerService: [form\_mgr\_proxy.cpp(GetFormsInfoByApp:1128)]中的逻辑超时。

   应用高频打印输出同类日志：分析对应输出表示的场景及其合理性

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/ZPcvlWGPRDiGWngnkXuCpQ/zh-cn_image_0000002404045345.png?HW-CC-KV=V1&HW-CC-Date=20260612T021744Z&HW-CC-Expire=86400&HW-CC-Sign=30C1E72870434AE58A3CE1CFEB9465910640F9E26A2D323147DD2E97CE38D6A0)例如示例：进程在被杀死前在大量输出，对应的ImageEffect领域需排查此日志是否正常，是否陷入死循环或频繁调用场景。

### 结合trace信息

当前应用冻屏获取trace仅支持log版本，请参考[查看log版本信息](../../../../../harmonyos-guides/系统/调测调优/调试命令/hilog/hilog.md#查看log版本信息)。trace规格及获取详见[hitrace](../../../../../harmonyos-guides/系统/调测调优/调试命令/hitrace/hitrace.md)。

1. 进程频繁执行密集任务超时

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/FGySmCuST-WXdeNu6sopJw/zh-cn_image_0000002370565524.png?HW-CC-KV=V1&HW-CC-Date=20260612T021744Z&HW-CC-Expire=86400&HW-CC-Sign=A8556F9A869B8C1418F38524E11A036AE20FF0DA7A7AAF52D473110EC74E7902 "点击放大")![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5f/v3/VBx9Mp3cTJ6ZOwQKFYInvA/zh-cn_image_0000002404125185.png?HW-CC-KV=V1&HW-CC-Date=20260612T021744Z&HW-CC-Expire=86400&HW-CC-Sign=F657292C7ADEA6B767AC36014BB14C80477694C0B5054BDB10576077DF38B460)
...
2. 进程执行某一任务超时
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/dQXICXj6RuKFXr2Tyd404w/zh-cn_image_0000002370405644.png?HW-CC-KV=V1&HW-CC-Date=20260612T021744Z&HW-CC-Expire=86400&HW-CC-Sign=C9B53B33DF54627628781102E2BE6F9A30B5212CD9BF22A1F2AEC21509CFDCF3 "点击放大")

   示例为：OHOS::AppExecFwk::FormMgrAdapter::GetFormsInfoByApp接口执行时长达到8s。
3. 进程多段任务累积超时

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/PbaeFhiyTUSwPDanjjLCig/zh-cn_image_0000002404045349.png?HW-CC-KV=V1&HW-CC-Date=20260612T021744Z&HW-CC-Expire=86400&HW-CC-Sign=D072D8D68BB9DA1C6ABE7E182B9342729C5C6AB58C8CABA7B2E6D27D4AAB2F6B "点击放大")示例中：三段任务累积到达6s超时，判断场景为屏幕旋转后页面动画超时。
