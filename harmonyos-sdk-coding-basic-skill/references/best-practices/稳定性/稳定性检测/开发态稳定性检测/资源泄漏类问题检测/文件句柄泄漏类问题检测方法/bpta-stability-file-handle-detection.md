...
scraped_at: 2026-06-01T17:02:07+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:3a4ac10a4a2cf03bc67366befd017569563e3e620078e49dfdc1df0ca372899b
---
...
1. 修改应用代码，做一个测试按钮，点击这个按钮枚举下进程的所有句柄。
   ...
   ```
   1. import { fileIo, ListFileOptions } from '@kit.CoreFileKit';
   ...
   24. fileIo.listFile("/proc/self/fd", listFileOption, (err: BusinessError, fileNames: Array<string>) => {
   25. if (err) {
