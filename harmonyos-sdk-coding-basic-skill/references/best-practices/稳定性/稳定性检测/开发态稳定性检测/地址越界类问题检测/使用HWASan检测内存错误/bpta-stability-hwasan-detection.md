...
scraped_at: 2026-06-12T10:17:13+08:00
doc_updated_at: 2026-05-30
content_hash: sha256:d26f709e5e1d750523af19a1d1998591ea0f08f04fcbab6598841c26d2cbd510
---
HWASan的能力概述和检测原理可参考[地址越界检测能力概述](../地址越界检测能力概述/bpta-stability-address-sanitizer-overview.md)以及[HWASan检测原理](../地址越界检测工具原理/bpta-stability-address-sanitizer-principle.md#section187526511146)，适用于开发态调试压测场景。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/0lOYBkCFRdmBPFmvBKhPFw/zh-cn_image_0000002613938015.png?HW-CC-KV=V1&HW-CC-Date=20260612T021711Z&HW-CC-Expire=86400&HW-CC-Sign=470DBE01F8322778DA71CFA5D6BE2C7ADA57B94B3C85DC0C35A87DA042A663EA "点击放大")
...
1. 修改工程目录下的AppScope/app.json5文件，添加HWASan配置开关。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/71/v3/EsG9pntKTqemYnUj1P_THA/zh-cn_image_0000002404125093.png?HW-CC-KV=V1&HW-CC-Date=20260612T021711Z&HW-CC-Expire=86400&HW-CC-Sign=065AA9F684EB5008E5340F2FF0EF8D6F0C98ABCAF97567FDFAF620F0B97FC412)
2. 在hvigorw命令后加上**-p** **ohos-enable-hwasan=true**的选项，执行hvigorw命令，更多options参考[hvigorw文档](../../../../../../harmonyos-guides/命令行工具/命令行构建工具（hvigorw）/ide-hvigor-commandline.md)。
...
1. 修改工程目录下的AppScope/app.json5文件，添加HWASan配置开关。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/jac0toRYRkS_skpBdbX0tg/zh-cn_image_0000002370405544.png?HW-CC-KV=V1&HW-CC-Date=20260612T021711Z&HW-CC-Expire=86400&HW-CC-Sign=994ADD87319700484F65828E660FEA57D10636A1DA432188BD23DEEBACCBDBBE)
2. 在需要使能HWASan的模块中，通过添加构建参数开启HWASan检测插桩，在对应模块的模块级build-profile.json5中添加命令参数。
   ...
   5. }
   6. }
   7. // DevEco Studio 6.1.0 Beta1及以上版本，同时开启有源码和无源码的C++的HWASan检测插桩
   8. "buildOption": {
   9. "externalNativeOptions": {
   10. "arguments": ["-DOHOS_ENABLE_HWASAN=ON", "-DOHOS_ENABLE_BINXO=ON"]
   11. }
   12. }
   ```
...
在AppScope/app.json5和模块build-profile.json5配置对应HWASan项后，可直接执行hvigorw命令，更多options参考[hvigorw文档](../../../../../../harmonyos-guides/命令行工具/命令行构建工具（hvigorw）/ide-hvigor-commandline.md)。
...
2. 当程序出现内存错误时，弹出HWASan log信息，点击信息中的链接即可跳转至引起内存错误的代码处。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/rWxWO4_sSm270O7GlGRuwg/zh-cn_image_0000002370565428.png?HW-CC-KV=V1&HW-CC-Date=20260612T021711Z&HW-CC-Expire=86400&HW-CC-Sign=9ED8668F4C2F19FE879EB927D6E18A2B5281695524E147C4D52EBC73F044025B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/H4UafoJ3SpyfrpJWZ2neQg/zh-cn_image_0000002505468708.png?HW-CC-KV=V1&HW-CC-Date=20260612T021711Z&HW-CC-Expire=86400&HW-CC-Sign=CEB3B8540506744306EC9CA21A979BEE176426536AB11F271F5F1B5EDD4732C5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0f/v3/zAFrQ9LdRSKQg9RasyW7CQ/zh-cn_image_0000002537308659.png?HW-CC-KV=V1&HW-CC-Date=20260612T021711Z&HW-CC-Expire=86400&HW-CC-Sign=DE46BC6C05DA742D78CAA3BF99A9FA7BE531A3E7713F881E76CB113E8F8DF3B1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/IKaxParATXSnqsh5lJ4-7w/zh-cn_image_0000002505469052.png?HW-CC-KV=V1&HW-CC-Date=20260612T021711Z&HW-CC-Expire=86400&HW-CC-Sign=7BD95F2A36367ADC30A933DACE44ADF7DBF585AF075051EEABE974494AE7DC57)
...
请参看[日志获取方式](<../../../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/故障检测/AddrSanitizer（地址越界）检测/address-sanitizer-guidelines.md#日志获取方式>)和[HWASan日志规格](<../../../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/故障检测/AddrSanitizer（地址越界）检测/address-sanitizer-guidelines.md#hwasan日志规格>)。
