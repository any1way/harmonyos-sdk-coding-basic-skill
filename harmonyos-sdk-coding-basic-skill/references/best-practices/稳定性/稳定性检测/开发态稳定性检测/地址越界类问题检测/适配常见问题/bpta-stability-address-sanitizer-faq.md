...
scraped_at: 2026-06-01T17:01:58+08:00
doc_updated_at: 2026-05-30
content_hash: sha256:ba066c15352f90c674c907429d2a97320cbeb98a7d4739876740fa26f9d560fe
---
...
要避免这种情况，请在ArkTS/JS侧使用bigint存储超出Number精度的地址。更换Node-API接口为[napi\_create\_bigint\_int64](../../../../../../harmonyos-guides/NDK开发/代码开发/使用Node-API实现ArkTSJS与CC++语言交互/Node-API使用指导/使用Node-API接口操作bigint类型值/use-napi-about-bigint.md#napi_create_bigint_int64)和[napi\_get\_value\_bigint\_int64](../../../../../../harmonyos-guides/NDK开发/代码开发/使用Node-API实现ArkTSJS与CC++语言交互/Node-API使用指导/使用Node-API接口操作bigint类型值/use-napi-about-bigint.md#napi_get_value_bigint_int64)。
...
这种情况下可考虑对HWASan 参数进行调参，调参方法可参考[HWASan参数配置](../使用HWASan检测内存错误/bpta-stability-hwasan-detection.md#section1496994494018)，设置heap\_history\_size\_main\_thread大于当前的个数（如上当前为102300）。
