...
content_hash: sha256:faae4c3c50268d62976d2c4df2970c8a081f62b4db131cbab18e34a6ab9cc119
---
ArkTS通过引用编译好的so文件来调用native方法。为避免不规范引用导致的运行时异常和故障排查成本，开发者应按照本文的标准进行引用。

NDK工程创建步骤及目录结构可参考：[创建NDK工程](../../../../../harmonyos-guides/NDK开发/创建NDK工程/create-with-ndk.md)。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/StabilityCodingSpecification/library/src/main/ets/components/Index.ets#L21-L45)
