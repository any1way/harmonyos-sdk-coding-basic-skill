...
scraped_at: 2026-06-11T16:59:56+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:092bfcb0e25e0558664ba99c3e2bee68da9cf10f3498b74b3a1392cba58615f7
---
## 概述
...
长截图功能适用于支持滚动的UI组件，比如List组件、Scroll组件、Web组件等。本文将以List组件和Web组件为例来介绍长截图功能的开发，分别通过控制器[Scroller](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scroller)和[WebviewController](<../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md>)，结合UIContext的[getComponentSnapshot().get()](<../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md#get12-1>)方法，实现长截图功能。

## 实现原理

List组件和Web组件实现长截图功能的原理相同，均可以通过模拟用户滚动行为，然后使用getComponentSnapshot().get()方法逐步截取不同位置的画面，将这些画面通过拼接得到长截图。Web组件通过[WebviewController](<../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md>)的相关API控制组件滚动，List组件通过[Scroller](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scroller)的相关API控制组件滚动。

长截图拼接原理如下，将每次滚动新进入屏幕的内容裁剪后，拼接到之前的屏幕截图，依次类推。

**图1** 长截图拼接原理图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/yghcwEQpQ0iDQMxmO7bpzw/zh-cn_image_0000002229449985.png?HW-CC-KV=V1&HW-CC-Date=20260611T085950Z&HW-CC-Expire=86400&HW-CC-Sign=1359D51783DCC73F1606E08726CC03EF0A94B0B860018D075D7C61B9275EC1BC "点击放大")

长截图主要流程如下：

**图2** 滚动长截图流程

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/LAtzkrMNSsGlDsggpdkBvg/zh-cn_image_0000002407557206.png?HW-CC-KV=V1&HW-CC-Date=20260611T085950Z&HW-CC-Expire=86400&HW-CC-Sign=A8BEE0CD759D55B11FF51588C02537934E4491C0847FC5EBB343DED42C553A08 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/NWbd1Ox6Rv-W0vQb5qV7ZQ/zh-cn_image_0000002193850120.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085950Z&HW-CC-Expire=86400&HW-CC-Sign=85E06AA77EBC714F6E71C5A61C1027F9FA24186A08D9F88B72AD5034982F3648 "点击放大")
...
6. 使用安全控件SaveButton保存截图相册。
   ...
   通过安全控件[SaveButton](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/SaveButton/ts-security-components-savebutton.md)结合[photoAccessHelper](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/js-apis-photoaccesshelper.md>)模块保存截图到相册。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/sW4y7fmqSHiood6S3wFoLw/zh-cn_image_0000002193850136.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085950Z&HW-CC-Expire=86400&HW-CC-Sign=CAABB51B7C50FC48B3C609C5DB4E600C43D5638E5F3FD6AF61E6647235D8A298 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/_h8inCErTaSKovajGD9oFA/zh-cn_image_0000002522310291.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085950Z&HW-CC-Expire=86400&HW-CC-Sign=803AB84ADB8614A5A8DCCFC0CAC4E4E23F71A08DDFAC5C94F580B8A4DFE78408 "点击放大")
...
此外，Web组件还可以使用[webPageSnapshot()](<../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#webpagesnapshot12>)方法进行网页全量截图，比较适合结构简单、静态元素的页面长截图。如果网页中有动态资源，结构相对复杂，比如有固定的标题头等，推荐上面的滚动长截图方案。使用webPageSnapshot()方法实现长截图的步骤如下：
