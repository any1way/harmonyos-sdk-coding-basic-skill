...
scraped_at: 2026-06-11T17:00:33+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:05391af18a32eae96ac856e3f9757c9e3b865c959f82fd717f4158a1ee664f8c
---
## 概述

本文适用于视频播放类应用开发，针对市场上主流视频播放应用常见场景，介绍如何基于[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)系统播放器实现嵌入式短视频播放。本文指导开发者实现以下几种场景：
...
通过[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)实现视频资源加载、播放、暂停、停止、退出操作，包含了静音播放、倍数设置和字幕挂载等功能，实现原理详情可参考[《基于AVPlayer基础播控实践》](../基于AVPlayer基础播控实践/bpta-avplayer-basic-control.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6a/v3/QZxFbiHjTeaFhbbp03htdA/zh-cn_image_0000002485843225.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090019Z&HW-CC-Expire=86400&HW-CC-Sign=2BEE818AFC3D93DA390E177981DB34BF70CBDC97CEA5ACEDD2064F7FA73AA5A9 "点击放大")

### 开发步骤

具体开发步骤可参考基于AVPlayer播放长视频实践的[焦点管理开发步骤](../基于AVPlayer播放长视频实践/bpta-avplayer-long-video.md#section1716082163419)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/SvMTAoSNTyWs4fwXQbAMUw/zh-cn_image_0000002485723289.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090019Z&HW-CC-Expire=86400&HW-CC-Sign=D5DCFFEB82BC70D5975792BEEA6A6FE50AE8E65A82B87C7B60B8B5F0FB4547C7 "点击放大")

### 开发步骤

具体开发步骤可参考基于AVPlayer播放长视频实践的[前后台感知开发步骤](../基于AVPlayer播放长视频实践/bpta-avplayer-long-video.md#section1448773335411)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/dQALom75QyqHLRAoZNFYTw/zh-cn_image_0000002452803500.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090019Z&HW-CC-Expire=86400&HW-CC-Sign=A67881822D6CABA0B06003E6D4CEE7BD37B4997740DD04DF8E5D015A7A81A343 "点击放大")

### 开发步骤

具体开发步骤可参考基于AVPlayer播放长视频实践的[横竖屏切换和旋转感知开发步骤](../基于AVPlayer播放长视频实践/bpta-avplayer-long-video.md#section1257185216407)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/1bQbsLdiRXOb4P9KZlcllw/zh-cn_image_0000002452643884.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090019Z&HW-CC-Expire=86400&HW-CC-Sign=93B5984FA50DA490DFA1711150B4E4BD6D79F3A75D9465C285B5604BE1F5D3C7 "点击放大")

### 开发步骤

具体开发步骤可参考基于AVPlayer播放长视频实践的[画中画播放开发步骤](../基于AVPlayer播放长视频实践/bpta-avplayer-long-video.md#section4691194231313)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/bF6k7Q43RVCoIZQ9rNMkSA/zh-cn_image_0000002485843233.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090019Z&HW-CC-Expire=86400&HW-CC-Sign=2D49899238BC31DF9522BE422E98964B8FC9705E2C08242F2196B1809C758C75 "点击放大")

### 开发步骤

具体开发步骤可参考基于AVPlayer播放长视频实践的[视频首帧显示开发步骤](../基于AVPlayer播放长视频实践/bpta-avplayer-long-video.md#section27212108403)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/EwwY5p0UTraWpJbG1TcH_Q/zh-cn_image_0000002485723317.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090019Z&HW-CC-Expire=86400&HW-CC-Sign=41F17BFEF1A8D3E2ECA9F4011DAE59A6BA3B5F438A168F5FC508F15FC09916F3 "点击放大")

### 实现原理

使用[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)组件实现视频播放列表页面。通过监听列表滑动[onScrollStop()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#onscrollstop)事件，在滑动停止时获取滑动偏移量offset，计算首个可完全展示的视频的索引，切换至该视频播放，实现视频列表中首个可见视频自动播放效果。

逻辑如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3/v3/OtysbFJGRQ-Zdi8QBebunQ/zh-cn_image_0000002455462614.png?HW-CC-KV=V1&HW-CC-Date=20260611T090019Z&HW-CC-Expire=86400&HW-CC-Sign=9676EEF229A296FCFC50FDDA9EDD3BB585A61DBA08E8FF5A323981A399CAC81C "点击放大")
...
2. 声明initAVPlayer()方法初始化[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)实例。
...
3. 创建setStateChangeCallback()状态回调函数，[AVPlayerState](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Types/arkts-apis-media-t.md#avplayerstate9>)状态为prepared时，使用[emitter.emit()](<../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/进程线程通信/@ohos.events.emitter (Emitter)/js-apis-emitter.md#emitteremit>)传递当前[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)实例的高度和宽度。
...
4. 使用[getDefaultDisplaySync()](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#displaygetdefaultdisplaysync9>)方法获取当前屏幕宽度，以默认16:9的屏幕比例，通过屏幕宽度计算[RelativeContainer](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/行列与堆叠/RelativeContainer/ts-container-relativecontainer.md)组件的高度和宽度，计算[ListItem](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md)所需高度；订阅[AVPlayerState](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Types/arkts-apis-media-t.md#avplayerstate9>)状态为prepared的事件，获取[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)实例的高度和宽度。
...
5. 根据[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)实例的高度、宽度计算设置[XComponent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)的高度、宽度。
...
7. 在页面的[onDidBuild()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#ondidbuild12)函数中加载模拟视频数据，初始化加载首个视频数据。
...
8. 根据所需播放视频的索引，获取视频相关信息，使用videoReset()方法重置[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)实例，随后利用获取的视频信息调用[initAVPlayer()](bpta-avplayer-embeded-short-video.md#li71231589325)方法重新初始化，设置该实例的surfaceId，确保其在指定surfaceId的组件上播放。
...
9. 用[List](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)显示视频列表，使用[LazyForEach](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)对列表数据进行懒加载。
...
10. 创建[XComponent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)组件，其提供用于图形绘制和媒体数据写入的Surface，负责将其嵌入视图中，用于视频播放。
...
11. 在[XComponent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)组件的[onLoad()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md#onload)加载事件中，使用[getXComponentSurfaceId()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md#getxcomponentsurfaceid9)获取该播放组件的Id，将其Id设置到[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)的surfaceId上，即可实现在该组件上播放视频。
...
12. 设置[List](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)的[onScrollStop()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md#onscrollstop)事件，在列表滑动停止时触发，根据滑动偏移量及单个[ListItem](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md)的高度计算当前屏幕内首个可完整显示的视频索引。若计算得出的视频索引与当前播放视频索引不符，则使用play()方法重新初始化[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)，切换至计算得出的视频进行播放。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/rMU-T13MQaicpg7wRZBMKg/zh-cn_image_0000002452643900.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090019Z&HW-CC-Expire=86400&HW-CC-Sign=49F1B5FF3D37448B3688E46850480422E120E266F970E42F138DE9FBC88FD349 "点击放大")

### 实现原理

基于[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)与[XComponent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)实现视频播放，通过切换AVPlayer的surfaceId控制不同XComponent播放视频，实现转场效果，使用[seek()](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md#seek9>)方法跳转至指定位置播放，主要分为两部分：

**列表页面跳转到详情页面**：当点击正在播放的视频时，记录当前播放视频的索引、播放进度、总时长、surfaceId信息，并在页面跳转[pushPathByName()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#pushpathbyname10)方法中传入此视频信息。在视频播放详情页面使用[getParamByIndex()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#getparambyindex10)接收传入信息，根据接收的视频信息使用initAVPlayer()初始化AVPlayer实例，初始化新的XComponent组件和surfaceID，将其绑定到AVPlayer上，使用seek()方法从记录的播放进度开始播放；

**详情页面返回到列表页面**：在详情页面点击返回时，记录当前播放视频的索引、播放进度、总时长、原surfaceId信息，并在页面回调[onBackPressed()](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onbackpressed10>)函数中，使用[pop()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/MultiNavigation/ohos-arkui-advanced-multinavigation.md#pop)方法传入此视频信息，根据接收的视频信息，使用play(index)初始化AVPlayer，将其surfaceId设置为原surfaceId，使用seek()方法从记录的播放进度开始播放。

逻辑如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/aNdABv7ESYGuBWelUmyJeg/zh-cn_image_0000002485843257.png?HW-CC-KV=V1&HW-CC-Date=20260611T090019Z&HW-CC-Expire=86400&HW-CC-Sign=5976BE530CD21FEDFAC70D964A1AC8168804D773F61454FA3BF478405773A49F "点击放大")
...
3. 在首页的[Navigation](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)组件中使用[getPathStack()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#getpathstack19)获取页面路由信息。
...
4. 在[pushPathByName()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#pushpathbyname10)基础上封装pushByName()方法，用于页面跳转时的参数传递。
...
5. 设置[XComponent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)的点击事件，当用户点击当前播放的视频时，保存当前播放进度，然后使用[pushByName()](bpta-avplayer-embeded-short-video.md#li1647811562593)方法，在页面跳转的同时将当前播放视频相关信息传递到视频详情页面。
...
6. 基于[getParamByIndex()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#getparambyindex10)封装getLastParams()方法，用于页面跳转后获取传递的参数。
...
7. 在视频详情页面的[aboutToAppear()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoappear)事件中，使用[getLastParams()](bpta-avplayer-embeded-short-video.md#li1482553124015)方法获取传递的参数信息，取消[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)实例的静音设置。
...
8. 在视频详情页面创建[XComponent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md#xcomponent19)组件。
...
9. [XComponent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md#xcomponent19)的[onLoad()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md#onload)事件中重新初始化[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)实例，将跳转时的播放时间进度currentTime传递给[AVPlayer](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)，然后使用[seek()](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md#seek9>)跳转到currentTime时间帧继续播放。
...
11. 在视频列表页面的点击跳转事件[pushByName()](bpta-avplayer-embeded-short-video.md#li1647811562593)方法中，使用回调函数接收详情页面返回参数信息，随后调用[play()](bpta-avplayer-embeded-short-video.md#li37514173917)方法，设置[seekTime](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md#seek9>)为currentTime以继续播放。
