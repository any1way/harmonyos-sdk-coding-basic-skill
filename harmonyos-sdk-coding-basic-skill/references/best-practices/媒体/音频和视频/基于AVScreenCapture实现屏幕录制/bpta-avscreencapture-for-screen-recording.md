...
scraped_at: 2026-06-11T17:02:24+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:42707d68c4d2d8c46f2d1611623c210d83c744e9f7b430d341fe35ee929c3a39
---
## 概述
...
开发者如果想要了解音视频编码相关内容，可以参考：[音频编码](<../../../../harmonyos-guides/媒体/AVCodec Kit（音视频编解码服务）/音视频编解码/音频编码/audio-encoding.md>)和[视频编码](<../../../../harmonyos-guides/媒体/AVCodec Kit（音视频编解码服务）/音视频编解码/视频编码/video-encoding.md>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/BvLw4oojQd-6C2jM7AmAOw/zh-cn_image_0000002358208918.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090213Z&HW-CC-Expire=86400&HW-CC-Sign=62C39ACBF8434D95CF7F5DE746E1FBE480338B6D0AC1EC5A8AF8F7B29C8CE363 "点击放大")

### 实现原理

**调用流程图**

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/p_VOxHMRT8aMztXzXcF56g/zh-cn_image_0000002439565978.png?HW-CC-KV=V1&HW-CC-Date=20260611T090213Z&HW-CC-Expire=86400&HW-CC-Sign=F120477012CC5A007180D5C635C308843A4B65D3C1D1296605D8F750B769926A)
...
1. 获取文件信息。
   ...
   5. try {
   6. this.file = fileIo.openSync(this.path, fileIo.OpenMode.READ_WRITE | fileIo.OpenMode.CREATE);
   7. } catch (error) {
...
3. 配置录制参数并初始化AVScreenCaptureRecorder对象。
   ...
   以下配置了屏幕录制参数，除了fd配置外，其余配置均为可选。未配置时，将采用默认值。默认值可参考：[AVScreenCaptureRecordConfig](<../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interfaces (其他)/arkts-apis-media-i.md#avscreencapturerecordconfig12>)。
   ...
   6. // 用于写入文件的文件描述符（fd）
   7. fd: (this.file as fileIo.File).fd,
   8. // 可选参数及其默认值
...
5. 通过stopRecording()停止录制并关闭文件。
   ...
   14. // 关闭文件
   15. fileIo.close((this.file as fileIo.File).fd);
   16. } catch (error) {
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/MAa-A2lnR5GJ5QQmZzGyDA/zh-cn_image_0000002358368862.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090213Z&HW-CC-Expire=86400&HW-CC-Sign=78417E972AECA10140608A202F128A844D712824E132D09030EF63F52034D66C "点击放大")

### 实现原理

**调用流程图**

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/23/v3/zvBUldu0R9OkZTKtQXDzsQ/zh-cn_image_0000002473046625.png?HW-CC-KV=V1&HW-CC-Date=20260611T090213Z&HW-CC-Expire=86400&HW-CC-Sign=6C255CC02B5311E41E39710997CA6ACE4EA99920F9C7368D91FC9DED524D21EF "点击放大")
...
1. 获取文件信息并调用Native侧方法传递参数。
   ...
   9. try {
   10. // 获取文件信息
   11. this.file = fileIo.openSync(this.filepath, fileIo.OpenMode.READ_WRITE | fileIo.OpenMode.CREATE);
   12. // ...
   ...
   这里获取屏幕宽高的实现代码与上述内容一致，都是通过ArkTS接口获取的。开发者也可以选择在Native侧获取，参考：[oh\_display\_manager.h](<../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/oh_display_manager.h/capi-oh-display-manager-h.md>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5b/v3/uUwD6LOYTaao6axzNFWegg/zh-cn_image_0000002358208954.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090213Z&HW-CC-Expire=86400&HW-CC-Sign=C7A3706EB124CD156CABEE6DB69AF870FC3ADB25C5F4E0EB13DECCFC3762CC47 "点击放大")

### 实现原理

**调用流程图**

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6b/v3/2_q7DYjLSHOLlmY7T2mh0g/zh-cn_image_0000002472889049.png?HW-CC-KV=V1&HW-CC-Date=20260611T090213Z&HW-CC-Expire=86400&HW-CC-Sign=4E96343211465384D270D9F7635E58DA2237CD6836FFE1EB32FF296E4775DA29 "点击放大")
...
1. 获取文件信息并调用Native侧方法传递参数。
   ...
   8. try {
   9. // 获取文件信息
   10. this.file = fileIo.openSync(this.filepath, fileIo.OpenMode.READ_WRITE | fileIo.OpenMode.CREATE);
   ...
   通过ArkTS侧接口获取屏幕宽高，Native侧获取方法参考：[oh\_display\_manager.h](<../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/oh_display_manager.h/capi-oh-display-manager-h.md>)。
...
屏幕录制时，涉及的[OH\_AVScreenCaptureConfig](<../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_AVScreenCaptureConfig/capi-avscreencapture-oh-avscreencaptureconfig.md>)相关配置项包括录制模式（[OH\_CaptureMode](<../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture_base.h/capi-native-avscreen-capture-base-h.md#oh_capturemode>) ）、数据格式（[OH\_DataType](<../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture_base.h/capi-native-avscreen-capture-base-h.md#oh_datatype>)）、音频参数（[OH\_AudioInfo](<../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_AudioInfo/capi-avscreencapture-oh-audioinfo.md>)）、视频参数（[OH\_VideoInfo](<../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_VideoInfo/capi-avscreencapture-oh-videoinfo.md>)）以及录制文件参数（[OH\_RecorderInfo](<../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_RecorderInfo/capi-avscreencapture-oh-recorderinfo.md>)）。
