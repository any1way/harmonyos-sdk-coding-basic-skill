...
content_hash: sha256:be7828662e3c9b5d782105d540587f0f85fb083b84d90cedcf2f143c7dea3d2b
---
## 概述

短视频通常以移动智能终端为播放载体，通过社交或视频平台快速传播。本文围绕主流短视频应用的常见场景，包括基础播控、横竖屏切换与旋转感知、长按视频倍速播放、前后台感知、自动连播等，指导开发者基于[Video](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/图片与视频/Video/ts-media-components-video.md)组件实现短视频播放功能。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/EKlmdCmAQUaoKE9b4hTN1Q/zh-cn_image_0000002555239530.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090138Z&HW-CC-Expire=86400&HW-CC-Sign=2F3FA69FCA14A114353EE31BBC48D6107FF65349300C3F2C74A0054F2CCF405B "点击放大")

### 实现原理

具体实现原理可参考《基于Video组件播放长视频》的[基础播控实现原理](../基于Video组件播放长视频/bpta-video-component-long-video.md#section1669421012353)。

### 开发步骤

具体开发步骤可参考《基于Video组件播放长视频》的[基础播控开发步骤](../基于Video组件播放长视频/bpta-video-component-long-video.md#section18477202813352)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/yHro7SzuQGiopCeWJmQ6Rw/zh-cn_image_0000002585679465.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090138Z&HW-CC-Expire=86400&HW-CC-Sign=FFCCE9C083494173440E2B38A891399380DAAA8BFA26A37E024D9ADC95D40706 "点击放大")

### 实现原理

* 自动旋转：在[model.json5配置文件](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)中配置"orientation"字段，设置orientation为[AUTO\_ROTATION\_RESTRICTED](../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口旋转/window-rotation.md#自动旋转方向类型)，应用会跟随传感器自动旋转。

  说明

  须提前打开设备的控制中心，取消旋转锁定，否则自动旋转不生效。
* 手动切换：通过[setPreferredOrientation()](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setpreferredorientation9>)设置应用的主窗口显示方向[Orientation](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Enums/arkts-apis-window-e.md#orientation9>)：
  + USER\_ROTATION\_LANDSCAPE：旋转到横屏。
  + USER\_ROTATION\_PORTRAIT：旋转到竖屏。

### 开发步骤

开发步骤详情可参考《基于Video组件播放长视频》的[横竖屏切换和旋转感知开发步骤](../基于Video组件播放长视频/bpta-video-component-long-video.md#section3703101910168)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/Kxkux0DxSFOLJmmeyHCzoQ/zh-cn_image_0000002555079910.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090138Z&HW-CC-Expire=86400&HW-CC-Sign=9B4299BB3E6004FE798D30854B21AEA9CD61FFD70D66AC0C838F9E76FE535791 "点击放大")

### 实现原理

设置[Swiper](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md)组件的[cachedCount](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md#cachedcount15)属性预加载子组件个数，提前加载并缓存下一个视频内容，确保滑动时无卡顿，提升短视频切换的流畅性。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/X-EqF_eBQSWjztsC9sbTMQ/zh-cn_image_0000002585799527.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090138Z&HW-CC-Expire=86400&HW-CC-Sign=05BCA9B5D546D67EF2B6A6E5A1A2CC39CA43B865CB7159C9866388E3744E6310 "点击放大")

### 实现原理

绑定长按手势事件[LongPressGesture](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/LongPressGesture/ts-basic-gestures-longpressgesture.md)，当用户长按视频边缘时，动态设置[VideoOptions](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/图片与视频/Video/ts-media-components-video.md#videooptions对象说明)中的视频播放倍速currentProgressRate，从而实现视频倍速播放功能。

### 开发步骤

1. 绑定LongPressGesture长按手势事件，在[onAction()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/LongPressGesture/ts-basic-gestures-longpressgesture.md#onaction)方法中设置视频播放倍速值为2倍速，即PlaybackSpeed.Speed\_Forward\_2\_00\_X，在[onActionEnd()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/LongPressGesture/ts-basic-gestures-longpressgesture.md#onactionend)方法中，恢复初始播放速度为PlaybackSpeed.Speed\_Forward\_1\_00\_X。具体视频播放倍速选项请参考[PlaybackSpeed枚举说明](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/图片与视频/Video/ts-media-components-video.md#playbackspeed8枚举说明)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/ZDrfPCxiRY23I1AjXSmMtw/zh-cn_image_0000002555239532.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090138Z&HW-CC-Expire=86400&HW-CC-Sign=D2F5CE0DB3F96C731F179EF392335B3DC704B0A5E5F9BA4B2CB33EFF1B7A6BE2 "点击放大")

### 实现原理

通过[onForeground()](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/UIAbility组件/UIAbility组件生命周期/uiability-lifecycle.md#onforeground>)和[onBackground()](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/UIAbility组件/UIAbility组件生命周期/uiability-lifecycle.md#onbackground>)生命周期方法监听应用前后台状态变化，根据状态变化播放或暂停视频：

* 当应用从前台切到后台时，调用[VideoController](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/图片与视频/Video/ts-media-components-video.md#videocontroller)的[pause()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/图片与视频/Video/ts-media-components-video.md#pause)方法暂停视频；
* 当应用回到前台时，调用VideoController的[start()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/图片与视频/Video/ts-media-components-video.md#start)方法继续播放视频。

### 开发步骤

1. 在EntryAbility.ets文件中，使用[AppStorage.setOrCreate()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/应用级变量的状态管理/ts-state-management.md#setorcreate10)设置并缓存应用前后台状态isForeGround：
...
2. 在VideoPlayer自定义组件里对状态变量isForeGround添加[@Watch装饰器](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Watch装饰器：状态变量更改通知/arkts-watch.md>)，通过回调函数foregroundStatus监听状态变量的变化。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/CbwZ19H7QRS7jniYjiPIXw/zh-cn_image_0000002585679469.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090138Z&HW-CC-Expire=86400&HW-CC-Sign=687DFF0554E31809788E3A7D6C018C5BBDC48EF7D08E9C4DCC3E29B2E08CE173 "点击放大")

### 实现原理

系统音量面板[AVVolumePanel](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS组件/@ohos.multimedia.avVolumePanel (音量面板)/ohos-multimedia-avvolumepanel.md>)提供了展示和调节系统音量的功能。结合[LongPressGesture](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/LongPressGesture/ts-basic-gestures-longpressgesture.md)长按手势事件和[PanGesture](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md)滑动手势事件，设置滑动方向为竖直方向，长按触屏后，上滑增大音量，下滑减小音量，实现控制系统音量功能。
...
2. 绑定[LongPressGesture](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/LongPressGesture/ts-basic-gestures-longpressgesture.md)和[PanGesture](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md)组合而成的Sequence组合手势。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/x1R362khQvy0qe7Sb7Kg5A/zh-cn_image_0000002555079912.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090138Z&HW-CC-Expire=86400&HW-CC-Sign=529082A6D8DAA4D6EC344B4FC3787EF4A450D78F21F562D2202648A0431CEE36 "点击放大")

### 实现原理

1. 在视频播放结束时，触发[onFinish()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/图片与视频/Video/ts-media-components-video.md#onfinish)事件，通过Swiper组件的[showNext()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md#shownext)切换下一个视频。
2. 在Swiper的[onAnimationStart()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md#onanimationstart9)回调中更新视频索引值。
3. 监听视频索引值变化，使用[reset()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/图片与视频/Video/ts-media-components-video.md#reset12)、start()分别重置和播放视频。
