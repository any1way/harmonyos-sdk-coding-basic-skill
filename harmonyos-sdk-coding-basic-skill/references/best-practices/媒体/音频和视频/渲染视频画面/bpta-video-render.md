...
scraped_at: 2026-06-11T17:02:00+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:4dfe1d16a1d37bf2a034bd0dd3a49f1ee435fc4bb94623c3f827609a856b043c
---
...
3. 启动解码器、解码输入子线程、解码输出子线程。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4f/v3/xZBOG6TsTW6UUUD-k0qX6Q/zh-cn_image_0000002484614821.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T090159Z&HW-CC-Expire=86400&HW-CC-Sign=A4C8FC4DF9D1B2D5E15C19A9BD6B2F5CCBF50D7CF77FF7B71E05FB1068AB385E "点击放大")
4. 通过OnNeedInputBuffer获取可用的AVBuffer后，在解码输入子线程中，将解封装器读取视频数据填充到AVBuffer中，并提交给解码器进行解码。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bf/v3/Xe1P5h6JT6OEmHO_Eqesxg/zh-cn_image_0000002451534962.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T090159Z&HW-CC-Expire=86400&HW-CC-Sign=F03487686EB5D95206760C198E6CF3B75B86C430811FC79B79F8676115CFE994 "点击放大")
5. 通过OnNeedOutputBuffer获取解码的视频数据后，在解码输出子线程中，将解码后的视频数据提交给输出Surface（即XComponent的NativeWindow）。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8e/v3/GDFjLG8AR5-A7XXw0Q4Acg/zh-cn_image_0000002451375366.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T090159Z&HW-CC-Expire=86400&HW-CC-Sign=651F899F01FBAC12EB591FDE461C6097D797317C533BB3F4B038F8D508477E11 "点击放大")
...
3. 获取XComponent的NativeWindow对象，并根据XComponent的NativeWindow对象创建EGLSurface。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/rOwkAR3jSOS7DxsLS7dtuw/zh-cn_image_0000002484494809.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T090159Z&HW-CC-Expire=86400&HW-CC-Sign=051E10522D4E4A4629D9E163FC05D7B2A6016D8676B936EFA5E2A49590F5F01A "点击放大")
...
5. 启动解码器、解码输入子线程、解码输出子线程。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/8wmQjdDjSXKRmyKl6nymTg/zh-cn_image_0000002484614829.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T090159Z&HW-CC-Expire=86400&HW-CC-Sign=516BE301A5868DB3BA38CFB7E092A0B12B45AB00AB1D680115B0D5702670FB8D "点击放大")
...
7. 通过OnNeedOutputBuffer获取解码的视频数据后，在解码输出子线程中，将解码后的视频数据提交给输出Surface（当前Surface为NativeImage的NativeWindow对象）。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/ecm_RfQFSACjA_BGs_JgNg/zh-cn_image_0000002451534970.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T090159Z&HW-CC-Expire=86400&HW-CC-Sign=62502ADF5BD23280BF70E807FB2F3091315781E6D295A1B60C58F2A8FAB60A8D "点击放大")
8. 通过NativeImage，将视频图像缓存更新至OpenGL的纹理上。
9. 通过eglSwapBuffers交换前后缓冲区的内容，并将渲染结果显示在屏幕。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/cbOeRtJiTv6qNT_3CRRZdQ/zh-cn_image_0000002451375374.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T090159Z&HW-CC-Expire=86400&HW-CC-Sign=32A773444776F6984E1247EA2AF59E6490B5197763D4EB920389E3977C8286F9 "点击放大")
...
8. 通过OH\_NativeImage\_AttachContext()绑定上下文，再通过OH\_NativeImage\_UpdateSurfaceImage()将视频图像缓存更新至OpenGL的纹理上。
   ...
   31. ret = OH_NativeImage_GetTransformMatrix(nativeImage_, matrix_);
   32. if (ret != 0) {
   33. OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "OpenGLRenderThread",
   34. "OH_NativeImage_GetTransformMatrix failed, ret: %{public}d", ret);
   35. return;
   36. }

   38. int32_t transformTmp = 2;
   39. ComputeTransformByMatrix(transformTmp, matrix_);

   41. DrawVideoImage();
   42. }
   ```

   [OpenGLRenderThread.cpp](https://gitcode.com/harmonyos_samples/video-render/blob/master/entry/src/main/cpp/render/src/OpenGLRenderThread.cpp#L427-L468)
...
3. 获取XComponent的NativeWindow对象，并根据XComponent的NativeWindow对象创建Vulkan的Surface用于显示。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/FcF5hOXTTZWXxDZSI3vkpw/zh-cn_image_0000002484494813.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T090159Z&HW-CC-Expire=86400&HW-CC-Sign=372C8C3D25A098DA069FC4CB6A386CB235718AD011F6315CF18DA4A636168B4A "点击放大")
...
9. Vulkan根据NativeBuffer创建对应的ImageView用于采样，同时，创建对应格式的采样器，通过采样器将YUV格式的图像转化成RGBA的图像，最后，通过渲染管道进行显示。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/OmnkFyhPRYSBRLhnRaCOBA/zh-cn_image_0000002484614833.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T090159Z&HW-CC-Expire=86400&HW-CC-Sign=AAB7BA6C08BA984853633AA76735BA0040730F43494D82A6AA99480FFEE0098D "点击放大")
