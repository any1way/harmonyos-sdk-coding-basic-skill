...
scraped_at: 2026-06-11T17:01:02+08:00
doc_updated_at: 2026-06-10
content_hash: sha256:a1d613d9b9a98d6f8e7150f0bb66ab4598196844ec9c68973d9de04ec0b5969d
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a2/v3/FJOy5F_2TUiUvdw327bFgw/zh-cn_image_0000002555217465.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=06805FE238F57D50F3634176012E94BB32E6A7D1A980F39EB3B92BC6531B913C "点击放大") ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/AVYOwO2JToOryD6Qg8NZTQ/zh-cn_image_0000002524217568.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=74E2A138095F9591CD43A93D6A94583C43D8BA8D304C378F09D8FE2C22237E3A "点击放大")

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/3OH3CjvuQ8mZNh9eA1rQAA/zh-cn_image_0000002591983530.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=E319BDCF0BC461BD5AE4F7B323E5CA94DB6BAAA9D62CBB610E9F780039E057C5 "点击放大")

## 场景分析

| 场景名称 | 描述 | 实现方案 |
| --- | --- | --- |
| [基础播控](bpta-playing-pcm-audio-based-audiorenderer.md#section1764813377511) | 音频资源的加载、播放、暂停、退出等操作。 | 使用[AudioRenderer](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)接口实现。 |
| [跳转播放](bpta-playing-pcm-audio-based-audiorenderer.md#section16920851193717) | 滑动进度条精准跳转到指定时间进行播放。 | 使用[Slider组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/按钮与选择/Slider/ts-basic-components-slider.md)实现进度条，在AudioRenderer的[on('writeData')](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#onwritedata11>)回调中触发进度调节。 |
| [静音播放](bpta-playing-pcm-audio-based-audiorenderer.md#section125715278533) | 点击按钮设置静音播放。 | 使用[AudioRenderer](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)的[setSilentModeAndMixWithOthers()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#setsilentmodeandmixwithothers12>)方法控制静音状态。 |
| [切换歌曲播放](bpta-playing-pcm-audio-based-audiorenderer.md#section590418431566) | 点击上一首或下一首或歌单列表中的歌曲进行不同歌曲播放。 | 在AudioRenderer的[on('writeData')](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#onwritedata11>)回调中，将获取到的不同的歌曲资源写入数据缓冲区，实现播放不同歌曲的功能。 |
| [倍速设置](bpta-playing-pcm-audio-based-audiorenderer.md#section189460361122) | 选择不同档位调节播放速度。 | 使用[AudioRenderer](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)的[setSpeed()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#setspeed11>)设置播放倍速。 |
| [音量设置](bpta-playing-pcm-audio-based-audiorenderer.md#section88718617116) | 滑动音量调节面板调节播放音量。 | 使用[AudioRenderer](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)的[setVolume()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#setvolume9>)设置播放音量。 |
| [接入播控中心](bpta-playing-pcm-audio-based-audiorenderer.md#section06660114245) | 通过播控中心，控制播放、暂停、切换音频、调整播放进度、切换循环模式 | 通过[AVSessionKit](<../../../../../harmonyos-guides/媒体/AVSession Kit（音视频播控服务）/avsession-kit.md>)音频播控服务实现音频应用接入播控中心。 |
...
| [接入播控中心冷启动和历史歌单](bpta-playing-pcm-audio-based-audiorenderer.md#section476545143517) | 应用退出后，播控中心显示历史歌单，点击播控中心播放按钮拉起应用播放，或者点击歌单拉起应用播放。 | 注册并适配后台启动模式的[播放意图](<../../../../../harmonyos-guides/AI/Intents Kit（意图框架服务）/习惯推荐方案/接入方案/intents-habit-rec-access-programme.md>)，即可实现接入。 |
| [低功耗音频播放](<../../../../../harmonyos-guides/媒体/Audio Kit（音频服务）/音频播放/低功耗音频播放/power-saving-for-playback.md>) | 低功耗音频播放是一种通过软硬芯协同设计实现的音频渲染方案。其核心机制是增大音频渲染器的内部缓存，使系统能够一次性填充大量音频数据，从而允许主处理器长时间休眠，减少频繁处理音频数据的功耗，显著降低系统级功耗负载。 | 具体介绍和实现方案参考：[低功耗音频播放](<../../../../../harmonyos-guides/媒体/Audio Kit（音频服务）/音频播放/低功耗音频播放/power-saving-for-playback.md>)。 |

## 基础播控

### 场景描述

通过[AudioRenderer](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)实现基础的音频播放控制能力，包括音频资源加载、播放、暂停、停止及退出等操作。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/PE9Xs8HBToWhwE2B2qij_g/zh-cn_image_0000002524057574.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=86FDB9190E1BCCD84DD1014CC65FC3A4495E9E74AA3D9CF927C2636C2CAE17E6 "点击放大")

### 实现原理

开发者可以通过[AudioRenderer](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)的接口，创建AudioRenderer实例，在AudioRenderer的[on('writeData')](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#onwritedata11>)回调中，将获取的歌曲资源写入回调事件中，实现资源加载。通过AudioRenderer的[start()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#start8>)、[pause()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#pause8>)、[stop()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#stop8>)和[release()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#release8>)接口实现音频的播放、暂停、停止和资源释放操作。

[AudioRenderer](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)中的不同接口调用和其状态的变化关系参考[AudioRenderer状态变化示意图](<../../../../../harmonyos-guides/媒体/Audio Kit（音频服务）/音频播放/使用AudioRenderer开发音频播放功能(ArkTs)/using-audiorenderer-for-playback.md>)。
...
3. 设置[on('writeData')](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#onwritedata11>)回调，将获取的歌曲资源写入回调事件中，实现资源加载。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/fEej72kOTBa3gDSZJJzY-g/zh-cn_image_0000002555217467.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=A8B0C3168A5E1506F832FADF89057CC99CBF0903BFCFD6EA79C68B9F1AB7E172 "点击放大")

### 实现原理

在pcm文件中，每1秒时间对应的音频帧数是固定的，并且每音频帧的字节数是固定的，所以歌曲在不同时长对应的资源起始位置也可以计算出来。当用户拖动进度条到指定时间后，计算出当前时间对应当前资源的起始位置，在AudioRenderer的on('writeData')回调中，从对应的起始位置开始获取歌曲资源并写入回调中，从而实现跳转播放。另外一种方案可以参考[基于OHAudio播放PCM音频](../基于OHAudio播放PCM音频/bpta-playing-pcm-audio-based-ohaudio.md)中[跳转播放](../基于OHAudio播放PCM音频/bpta-playing-pcm-audio-based-ohaudio.md#section16920851193717)的[实现原理](../基于OHAudio播放PCM音频/bpta-playing-pcm-audio-based-ohaudio.md#section5752111843915)一节。
...
* 采样率：等于每秒帧数，采样率为48000代表每秒包含48000音频帧。使用[createAudioRenderer()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Functions/arkts-apis-audio-f.md#audiocreateaudiorenderer8>)接口创建AudioRenderer实例时，通过配置[options](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#audiorendereroptions8>)属性，设置音频流信息[streamInfo](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#audiostreaminfo8>)中的采样率[samplingRate](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#audiosamplingrate8>)来设置。
* 通道数：决定音频帧大小，1帧 = 所有声道各取1个采样点。使用[createAudioRenderer()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Functions/arkts-apis-audio-f.md#audiocreateaudiorenderer8>)接口创建AudioRenderer实例时，通过配置[options](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#audiorendereroptions8>)属性，设置音频流信息[streamInfo](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#audiostreaminfo8>)中的通道数[channels](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#audiochannel8>)来设置。
* 采样位深：决定音频帧大小，单位为位（bit)，1字节 = 8位。使用[createAudioRenderer()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Functions/arkts-apis-audio-f.md#audiocreateaudiorenderer8>)接口创建AudioRenderer实例时，通过配置[options](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#audiorendereroptions8>)属性，设置音频流信息[streamInfo](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#audiostreaminfo8>)中的采样格式[sampleFormat](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#audiosampleformat8>)来获得，其对应关系如下表格。
...
4. 在AudioRenderer的[on('writeData')](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#onwritedata11>)回调中，从对应的数据偏移位置开始获取歌曲资源并写入回调中。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b0/v3/UU6Bas4PTcu4Zc2CnxlZQg/zh-cn_image_0000002524217570.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=EEBF2BEE3C4DACA8A25A75C2539CA3B5FC8198CBDA362AB6E609BF427E1BF3F3 "点击放大")

### 实现原理

使用[AudioRenderer](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)的[setSilentModeAndMixWithOthers()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#setsilentmodeandmixwithothers12>)方法来开启或关闭静音模式，参数设置为true，表示开启静音播放模式。

### 开发步骤

调用[setSilentModeAndMixWithOthers()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#setsilentmodeandmixwithothers12>)接口，开启或关闭静音模式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/n-_mpL_0S0iF6vg14s-Ikg/zh-cn_image_0000002555337439.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=CFE5BB26CE87D10923B139B8A31EB278CE4F6A66004727FAC7630AF3FEFE23D1 "点击放大")

### 实现原理

通过加载不同的资源文件，并在AudioRenderer的[on('writeData')](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#onwritedata11>)回调中，读取资源数据，从而完成歌曲切换场景。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/nenqsz28S5yAuNIJGJcoOw/zh-cn_image_0000002622303659.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=B5F63E0D4D5D64A71A8696A544BF6CDE9BDB0BEE87188700025C6920427953FC "点击放大")

### 实现原理

通过选择不同档位获取目标速度值，输入到[AudioRenderer](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)的[setSpeed()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#setspeed11>)接口中，实现设置播放速度的功能。

### 开发步骤

1. 通过选择不同档位获取速度值，传入[setSpeed()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#setspeed11>)接口中。
...
2. 根据支持的倍数范围，通过[setSpeed()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#setspeed11>)接口设置播放的倍数值。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/xDe0UrUJSFOYKR8sPtYoCw/zh-cn_image_0000002555217469.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=EB89CF720346E7C5CB9B0779CEDEEE509CCD24342C69F7CE11E3B411E32B7E4A "点击放大")

### 实现原理

通过调节面板获取目标音量值，输入到[AudioRenderer](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)的[setVolume()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#setvolume9>)接口中，实现设置播放音量的功能。

### 开发步骤

1. 通过调节面板获取音量值，传入[setVolume()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#setvolume9>)接口中。
...
2. 通过[setVolume()](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#setvolume9>)接口设置播放音量。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/HGTdyZZPQii-PvV1xbA1Jg/zh-cn_image_0000002524217572.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=CBC5E0D0478B1B90E1F7C7A1AF895D428FAB44055D4929F975E110503F44120C "点击放大") ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/CoSXocO7ROeuulwqhYBjdw/zh-cn_image_0000002555337441.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=A6EF41713AF7182E4272ED9A196B0526F6C18C43C2B58536770E8DFE1A89F6D7 "点击放大") ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/1JZ9JdrxTZeXhBAzxYmbAA/zh-cn_image_0000002524057578.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=C69609BAB79762E3167C7EAAC4549D2B8A1F889164EA362281D47941597CA703 "点击放大")

### 实现原理

通过[AVSessionKit](<../../../../../harmonyos-guides/媒体/AVSession Kit（音视频播控服务）/avsession-kit.md>)音频播控服务实现音频应用接入播控中心。

### 开发步骤

1. 通过[createAVSession()](<../../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Functions/arkts-apis-avsession-f.md#avsessioncreateavsession10>)创建AVSession实例并激活媒体会话，[AVSessionType](<../../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Types/arkts-apis-avsession-t.md#avsessiontype10>)设置为audio。
...
5. 应用状态上报播控中心，当音频状态发生改变时，需要通过[setAVPlaybackState()](<../../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVSession)/arkts-apis-avsession-avsession.md#setavplaybackstate10>)向播控中心上报视频状态，来达到播控中心与应用的状态同步，包括播放状态（state）、播放位置（position）、当前媒体播放时长（duration）等。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/AOwIRdKSQ7mT2l6J_hTAkQ/zh-cn_image_0000002555217471.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=5244D9DAF4986D6AD670D65AAF15C620764B331A31E188B3802BEEE42BB6AB0C "点击放大")
...
1. 在module.json5配置文件中配置[ohos.permission.KEEP\_BACKGROUND\_RUNNING](../../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/应用权限列表/开放权限（系统授权）/permissions-for-all.md#ohospermissionkeep_background_running)权限和后台模式audioPlayback。
...
2. 创建后台任务管理类，实现后台任务的申请（startContinuousTask）与取消（stopContinuousTask），长时任务类型选择[AUDIO\_PLAYBACK](<../../../../../harmonyos-references/Background Tasks Kit（后台任务开发服务）/ArkTS API/@ohos.resourceschedule.backgroundTaskManager (后台任务管理)/js-apis-resourceschedule-backgroundtaskmanager.md#backgroundmode>)，表示音频后台播放。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/BUnS9haKSoSIQGfqdCcQnQ/zh-cn_image_0000002524217574.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=410E9B0D9A74D67D40F7D75B8CA50A02A58D5F6D458E6BC7CECF187364354107 "点击放大") ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/7PajzzNbQ7uYkNRFlgCwPg/zh-cn_image_0000002555337449.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=C2A74F16314FFE4A23985111DDF486EE517D0A20D02DB69AD73FDC90E67FD544 "点击放大")

### 实现原理

注册并适配[意图调用](<../../../../../harmonyos-guides/AI/Intents Kit（意图框架服务）/习惯推荐方案/接入方案/intents-habit-rec-access-programme.md>)，实现一键冷启动播放和历史歌单。

### 开发步骤

1. 注册播放意图。应用按照播放业务，选择PlayMusicList意图，编辑对应的意图配置PROJECT\_HOME/entry/src/main/resources/base/profile/insight\_intent.json文件，实现播放意图注册，具体步骤参考：[意图注册](<../../../../../harmonyos-guides/AI/Intents Kit（意图框架服务）/习惯推荐方案/接入方案/intents-habit-rec-access-programme.md>)。
...
3. 设置歌单信息，通过[setAVMetadata](<../../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interface (AVSession)/arkts-apis-avsession-avsession.md#setavmetadata10>)接口设置当前播放的歌单信息，系统媒体信息根据应用上报实时刷新，若应用接入歌单功能，则确保在[AVMetadata](<../../../../../harmonyos-references/AVSession Kit（音视频播控服务）/ArkTS API/@ohos.multimedia.avsession (媒体会话管理)/Interfaces (其他)/arkts-apis-avsession-i.md#avmetadata10>)中一直携带歌单数据。
