...
scraped_at: 2026-06-11T17:01:00+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:1e6aec3e88eebe520769927cdd7fa6bc789a161136ea21c54d34fa213543a838
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/99/v3/qlLzQwesSRO37nA4TwPy4w/zh-cn_image_0000002524057588.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=2E785B8420FA3214781998666CB97B21B0CBCACF1CED72E8C5B07F70E4F3AA7B "点击放大") ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/viE3s9skSkiTZcdNYoJj1Q/zh-cn_image_0000002555217487.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=3F79055E8BE037D24E0B9005F0586DBE2A65C16380C3726D1D0E66B997684886 "点击放大") ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/bNv5oWWoT6yse2M4nLPt9w/zh-cn_image_0000002524217594.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=C27D30127A5E5BDEF6C49BC15CB406DBF3EB6A0AF29619DB57F4D40E13CDA946 "点击放大")

## 场景分析

| 场景名称 | 描述 | 实现方案 |
| --- | --- | --- |
| [基础播控](bpta-playing-pcm-audio-based-ohaudio.md#section1764813377511) | 音频资源的加载、播放、暂停、退出等操作。 | 使用[OHAudio](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/模块/OHAudio/capi-ohaudio.md>)接口实现。 |
| [跳转播放](bpta-playing-pcm-audio-based-ohaudio.md#section16920851193717) | 滑动进度条精准跳转到指定时间进行播放。 | 使用[Slider组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/按钮与选择/Slider/ts-basic-components-slider.md)实现进度条，在[OH\_AudioStreamBuilder\_SetRendererWriteDataCallback()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_setrendererwritedatacallback>)设置的回调函数中，从跳转的目标位置开始获取歌曲资源并写入回调中，从而实现跳转播放。 |
| [静音播放](bpta-playing-pcm-audio-based-ohaudio.md#section125715278533) | 通过界面按钮切换音频播放静音状态，实现一键开启或关闭静音。 | 使用[OH\_AudioRenderer\_SetSilentModeAndMixWithOthers()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_setsilentmodeandmixwithothers>)方法控制静音状态。 |
| [切换歌曲播放](bpta-playing-pcm-audio-based-ohaudio.md#section590418431566) | 点击上一首、下一首或歌单列表中的其他歌曲来进行切换歌曲播放。 | 调用[OH\_AudioStreamBuilder\_SetRendererWriteDataCallback()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_setrendererwritedatacallback>)接口，设置写入音频数据的回调。在回调函数中，  将获取到的不同的歌曲资源写入数据缓冲区，实现播放不同歌曲的功能。 |
| [倍速设置](bpta-playing-pcm-audio-based-ohaudio.md#section189460361122) | 滑动倍速调节面板调节播放速度。 | 使用[OH\_AudioRenderer\_SetSpeed()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_setspeed>)设置播放倍速。 |
| [音量设置](bpta-playing-pcm-audio-based-ohaudio.md#section88718617116) | 滑动音量调节面板调节播放音量。 | 使用[OH\_AudioRenderer\_SetVolume()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_setvolume>)设置播放音量。 |
...
通过[OHAudio](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/模块/OHAudio/capi-ohaudio.md>)接口实现核心音频播放控制能力，包括音频资源加载、播放、暂停、停止及退出等操作。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2b/v3/c59-CiaLTz-gWaKeTNCW_A/zh-cn_image_0000002555337465.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=0916D9C2A036C268FA6DCB20B8423AA6C98C884FF418043218ABF79A6F585339 "点击放大")

### 实现原理

开发者可以通过[OH\_AudioStreamBuilder\_Create()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_create>)的接口，创建音频流构造器实例，调用[OH\_AudioStreamBuilder\_SetRendererWriteDataCallback()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_setrendererwritedatacallback>)接口设置写入音频数据的回调函数，将获取的音频数据写入回调函数中，实现资源加载。通过[OH\_AudioRenderer\_Start()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_start>)、[OH\_AudioRenderer\_Pause()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_pause>)、[OH\_AudioRenderer\_Stop()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_stop>)、[OH\_AudioRenderer\_Release()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_release>)接口实现音频的播放、暂停、停止和退出操作。OHAudio的不同接口调用和其状态的变化关系参考[OHAudio音频播放状态变化示意图](<../../../../../harmonyos-guides/媒体/Audio Kit（音频服务）/音频播放/推荐使用OHAudio开发音频播放功能(CC++)/using-ohaudio-for-playback.md>)。
...
3. 调用[OH\_AudioStreamBuilder\_SetRendererWriteDataCallback()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_setrendererwritedatacallback>)接口设置写入音频数据的回调函数，将获取的歌曲资源写入回调函数中，实现资源加载。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/EGmFlv-YSbWv_1TvzlZl8g/zh-cn_image_0000002524057598.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=801F04E113164082C006D19521B1A66B2BF631B00798041772E734B756895611 "点击放大")

### 实现原理

在[基于AudioRender播放PCM音频](../基于AudioRenderer播放PCM音频/bpta-playing-pcm-audio-based-audiorenderer.md)中[跳转播放](../基于AudioRenderer播放PCM音频/bpta-playing-pcm-audio-based-audiorenderer.md#section16920851193717)的[实现原理](../基于AudioRenderer播放PCM音频/bpta-playing-pcm-audio-based-audiorenderer.md#section5752111843915)一节中，介绍了通过每1s走过的字节数来判断对应资源起始位置的方法来实现seek，本章节将介绍另一种实现方法，通过计算目标时间和歌曲总时长的比例，来计算目标时间对应的音频帧的起始位置。音频本质的是连续的采样流，无论采集、编码、播放、网络传输等都不可能一个字节一个字节处理，必须按音频帧分块处理。
...
每1秒PCM对应的字节数的计算方法参考[基于AudioRender播放PCM音频](../基于AudioRenderer播放PCM音频/bpta-playing-pcm-audio-based-audiorenderer.md)中[跳转播放](../基于AudioRenderer播放PCM音频/bpta-playing-pcm-audio-based-audiorenderer.md#section16920851193717)的[实现原理](../基于AudioRenderer播放PCM音频/bpta-playing-pcm-audio-based-audiorenderer.md#section5752111843915)。
...
4. 在[OH\_AudioStreamBuilder\_SetRendererWriteDataCallback()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_setrendererwritedatacallback>)设置的回调函数中，从对应的起始位置开始获取歌曲资源并写入回调中，从而实现跳转播放。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/oG3cmudgTaOQxEEEIzPDyw/zh-cn_image_0000002555217499.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=14A1FFB9651328DAE9E1C9B832745A1342BEF2F5F6B063E47808E1859AC3F559 "点击放大")

### 实现原理

使用[OH\_AudioRenderer\_SetSilentModeAndMixWithOthers()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_setsilentmodeandmixwithothers>)方法控制静音状态。

### 开发步骤

调用[OH\_AudioRenderer\_SetSilentModeAndMixWithOthers()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_setsilentmodeandmixwithothers>)接口，第二个入参中传入true，即可设置成静音播放模式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/iIbXlV2oSHKKmp8lnjCBfQ/zh-cn_image_0000002524217620.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=869124A753038BAF011452D9C74573CACE505C82EAAC16C1064F83595FE1C80C "点击放大")

### 实现原理

通过加载不同的资源文件，并在[OH\_AudioStreamBuilder\_SetRendererWriteDataCallback()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_setrendererwritedatacallback>)接口的回调中，读取资源数据，从而完成歌曲切换场景。
...
3. 调用[OH\_AudioStreamBuilder\_SetRendererWriteDataCallback()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_setrendererwritedatacallback>)接口，设置写入音频数据的回调。在回调函数中，将获取到的不同的歌曲资源写入数据缓冲区，实现播放不同歌曲的功能。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/iBA-w355Tduk3dwMBFuE-Q/zh-cn_image_0000002555337493.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=1F6ACDE055284F1C0D95346083EF9BC2B9DFF34DB4BC5A10C76ED0C1D5D5FECC "点击放大")

### 实现原理

通过调节面板获取目标速度值，输入到[OH\_AudioRenderer\_SetSpeed()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_setspeed>)接口中，实现设置播放倍速的功能。

### 开发步骤

1. 通过调节面板获取速度值，传入[OH\_AudioRenderer\_SetSpeed()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_setspeed>)接口中。
...
2. 根据支持的倍数范围，通过[OH\_AudioRenderer\_SetSpeed()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_setspeed>)接口设置播放的倍数值。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/03/v3/iYmMamiSQKOUdjiRe93e_g/zh-cn_image_0000002524057630.gif?HW-CC-KV=V1&HW-CC-Date=20260611T090035Z&HW-CC-Expire=86400&HW-CC-Sign=2986A6E899A3D9B16F1AE3AD30B81DBFF7C5A5938BDBC2779948E0AD960CFCEF "点击放大")

### 实现原理

通过调节面板获取目标音量值，输入到[OH\_AudioRenderer\_SetVolume()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_setvolume>)接口中，实现设置播放音量的功能。
...
2. 调用[OH\_AudioRenderer\_SetVolume()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_setvolume>)接口，第二个参数中传入设置的音量值，设置当前音频流音量。
