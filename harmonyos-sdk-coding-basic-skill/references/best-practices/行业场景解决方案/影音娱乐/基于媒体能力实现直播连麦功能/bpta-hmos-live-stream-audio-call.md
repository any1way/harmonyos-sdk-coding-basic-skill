...
scraped_at: 2026-06-12T10:14:09+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:2ea1565c5dd3afd4fff5a914c0ea8a9bf9d52987248beb109051659230d5abe0
---
## 概述
...
对于直播应用开发者而言，客户端开播侧的核心技术为音视频采集与编码，相关内容已在[基于媒体能力实现直播单播功能](../基于媒体能力实现直播单播功能/bpta-hmos-live-stream-solution.md)中重点阐述。在直播连麦场景下，新增对连麦方（主播/粉丝）音视频流的解码与渲染开发。

因此，本文将聚焦于客户端开播侧的音视频流解码播放，详细介绍对应的技术实现方案。关于直播推拉流协议、云上服务器转码与分发等内容，本文暂不涉及。直播连麦系统的处理链路可参考下图：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/32/v3/BmYzed8WSMmLfhrG-BJh2w/zh-cn_image_0000002549729061.png?HW-CC-KV=V1&HW-CC-Date=20260612T021407Z&HW-CC-Expire=86400&HW-CC-Sign=ED0ADDCCF2D08A8CA5183197558BFC0E40EE68A10599946F21E714B7EEFF6AC2 "点击放大")

## 直播连麦架构

以两路主播连麦场景为例，云端、应用客户端及系统的分层技术架构图如下图所示。实际直播场景支持多路连麦，每一路客户端的技术方案和基本原理均相似。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/L5e_v0rlQw-Gmqka7p89pg/zh-cn_image_0000002518209536.png?HW-CC-KV=V1&HW-CC-Date=20260612T021407Z&HW-CC-Expire=86400&HW-CC-Sign=55FE9E41E6359459C772688291616FA0C6E1732FF7A8ECCE5E4B840B052B4F60 "点击放大")
...
由上述流程可见，业务调度、信令通信等云端服务是可以跨端通用的。与基础单播场景相比，连麦场景的主要差异在于开播端需要新增音频和视频的解码播放能力，该能力可通过系统底座的Audio Kit、AVCodec Kit、Graphic Kit等接口进行开发实现。一般而言，看播端拉流的音频和视频数据来源于云端，并在云端完成了合流操作。因此，连麦场景看播端解决方案与单播场景一致，开发者可参考媒体直播单播场景的[看播端解决方案](../基于媒体能力实现直播单播功能/bpta-hmos-live-stream-solution.md#section1818019424273)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/h5OtgjcwRHezM1-kJ8m7TA/zh-cn_image_0000002518369668.png?HW-CC-KV=V1&HW-CC-Date=20260612T021407Z&HW-CC-Expire=86400&HW-CC-Sign=104BE219F29D9686992AE01F03E2E4CEFF0C051B01763FED72E02443858F5D23 "点击放大")

### 开发步骤

**（一）本端开播录制**

开播端本端主播连麦录制的场景与单播场景解决方案一致，可以参考媒体直播单播场景的[开播端解决方案](../基于媒体能力实现直播单播功能/bpta-hmos-live-stream-solution.md#section1343131711158)。
...
由[上文架构](bpta-hmos-live-stream-audio-call.md#section1270917618481)看出，看播端拉流的音频和视频数据来源于云端，并在云端完成了合流操作。因此，看播端解决方案与基础单播场景一致，开发者可参考媒体直播单播场景的[看播端解决方案](../基于媒体能力实现直播单播功能/bpta-hmos-live-stream-solution.md#section1818019424273)。
