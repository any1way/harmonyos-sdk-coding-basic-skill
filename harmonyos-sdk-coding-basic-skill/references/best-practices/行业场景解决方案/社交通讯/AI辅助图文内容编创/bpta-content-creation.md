...
scraped_at: 2026-06-12T10:14:22+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:36e86c8335aa991a4e4cca7a1682683f56494872eddec8a05a7b6a738aeb13dd
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0/v3/HcPuiQd6RjKLdqdb4fWy3A/zh-cn_image_0000002229451385.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021417Z&HW-CC-Expire=86400&HW-CC-Sign=C4E287C90CD5C3365B8D5F551C80BAC53C0BB3A533FD08D1F1E917B112EA4BD2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/-7MBhj20Ro-TSVvDxbs8UA/zh-cn_image_0000002229336901.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021417Z&HW-CC-Expire=86400&HW-CC-Sign=7FD771C1999D3E08202AF04EEE8EA97D7614DA08315FD78ADF600E5FA291C8F3)
...
8. static createPixelMap(uri: string): ImageInfo | undefined {
9. let imageInfo: ImageInfo | undefined;
10. try {
11. let file = fileIo.openSync(uri, fileIo.OpenMode.READ_ONLY);
12. let displayName = file.name;
13. let imageResource = image.createImageSource(file.fd);
14. let pixelMap = imageResource.createPixelMapSync(FileUtils.options);
15. imageInfo = { imagePixelMap: pixelMap, imageName: displayName };
16. fileIo.closeSync(file);
17. } catch (error) {
18. Logger.error(FileUtils.tag, `createPixelMap error: ${JSON.stringify(error)}`);
19. }
20. return imageInfo;
21. }
```
...
本章节只介绍主干流程的关键代码，要实现自定义相机还需要其他配置，可详细关注封装模块CameraService文件，Moving Photo的使用可查看相关Api使用：[动图照片](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.multimedia.movingphotoview (动态照片)/ohos-multimedia-movingphotoview.md>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/lfIGAHeMQBWAiuMB97Jtsg/zh-cn_image_0000002229336897.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021417Z&HW-CC-Expire=86400&HW-CC-Sign=FBBF5F4635FF5A8EA32F88057A4568051F01BBA710D662FF34DF56C3E087581F "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/FJwtx-QlRduHZ2QF8gjSuA/zh-cn_image_0000002229336905.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021417Z&HW-CC-Expire=86400&HW-CC-Sign=3029DCE8B3B963952DBFA37BDB163D4D2EC0863F6530663585CB99D765F5CCD9 "点击放大")
...
应用接续可以按需迁移路由栈，也可选择动态配置，仅对特定页面开启接续，此处仅设置最后的图文编辑页面GraphicCreationPage开启接续能力。按需迁移路由栈的方法具体可参考[按需迁移页面栈](../../../自由流转/跨端迁移/应用接续概述/bpta-continue-cast.md#section1924112387418)。
...
42. try {
43. fileIo.statSync(filePath);
44. let uri: string = fileUri.getUriFromPath(filePath);
45. let stat = fileIo.statSync(filePath);
