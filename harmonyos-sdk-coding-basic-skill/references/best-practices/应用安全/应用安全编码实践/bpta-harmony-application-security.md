...
content_hash: sha256:77542825fd49d7ba709312380bd3f746fd38f13ce6f13cb358ed530f85dfb110
---
## 概述
...
隐式want是通过action条件匹配的方式来筛选组件，凡是满足条件的应用组件都有被启动的可能。如果携带个人数据，则恶意应用有可能劫持携带的个人数据。应用程序如果要携带个人数据，需要显式指定目标应用组件（bundle名、ability名）或者将个人数据匿名化。示例中的context的获取方式请参见[获取UIAbility的上下文信息](<../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/UIAbility组件/UIAbility组件基本用法/uiability-usage.md#获取uiability的上下文信息>)。
...
4. // Check function
5. function checkWant(want: Want): boolean {
6. if (want === null || want === undefined) {
7. return false;
8. }
9. if (want.parameters === null || want.parameters === undefined) {
10. return false;
11. }
12. return true;
13. }
...
18. if (checkWant(want)) {
19. hilog.info(0x0000, 'privacy', 'correct want');
20. } else {
21. hilog.info(0x0000, 'privacy', 'invalid want');
22. }
23. }
24. }
```

[CheckWantOne.ets](https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/Privacy/privacy/src/main/ets/pages/CheckWantOne.ets#L23-L46)
...
5. // Check function
6. function checkWant(want: Want): boolean {
7. try {
8. if (want.parameters && want.parameters['test']) {
9. let testParam = want.parameters['test'] as Record<string, Object>;
10. if (testParam && typeof testParam === 'object') {
11. let uri = testParam['uri'] as string;
12. if (uri) {
13. hilog.info(0x0000, 'privacy', 'get uri string: ' + uri);
14. } else {
15. hilog.error(0x0000, 'privacy', 'uri parameter is missing');
16. return false;
17. }
18. } else {
19. hilog.error(0x0000, 'privacy', 'test parameter is not an object');
20. return false;
21. }
22. } else {
23. hilog.error(0x0000, 'privacy', 'parameters or test key is missing');
24. return false;
25. }
26. } catch (err) {
27. let error = err as BusinessError;
28. hilog.error(0x0000, 'privacy', `checkWant failed: code is ${err.code}, message is ${err.message}`);
29. return false;
30. }
31. return true;
32. }
...
36. hilog.info(0x0000, 'testTag', '%{public}s', 'Ability onCreate');
37. if (checkWant(want)) {
38. hilog.info(0x0000, 'privacy', 'correct want');
39. } else {
40. hilog.info(0x0000, 'privacy', 'invalid want');
41. }
42. }
43. }
```

[CheckWantTwo.ets](https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/Privacy/privacy/src/main/ets/pages/CheckWantTwo.ets#L22-L64)
