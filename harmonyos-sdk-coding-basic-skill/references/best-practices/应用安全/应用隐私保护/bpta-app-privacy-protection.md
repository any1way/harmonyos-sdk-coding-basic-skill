...
content_hash: sha256:0f002dd78711503adcd35088d7336dd11b4e930ae8ce6a23501d54e81040d1c1
---
## 概述
...
3. 减少使用存储权限。
   ...
   过多的存储访问权限可能会导致用户隐私数据的泄露，应该减少使用存储权限，仅请求访问应用程序所需的数据，可以用[Picker](<../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.picker (选择器)/js-apis-file-picker.md>)来减少对用户存储数据的访问权限。
4. 动态申请敏感权限。
...
5. 数据加密处理。
   ...
   存储敏感数据应该进行加密处理，具体可以参考《[应用数据安全](../应用数据安全/bpta-app-data-security.md)》。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/01/v3/hVLztc3WTJ2ZgbD-1fTHJQ/zh-cn_image_0000002194010840.png?HW-CC-KV=V1&HW-CC-Date=20260612T021423Z&HW-CC-Expire=86400&HW-CC-Sign=5603E45195A0F78214F62C03DA252FABD443B3800379B1DAF095143684840156 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/ashys8UqQ22m6iWOp59t9w/zh-cn_image_0000002193851252.png?HW-CC-KV=V1&HW-CC-Date=20260612T021423Z&HW-CC-Expire=86400&HW-CC-Sign=19D3A15ED8A28A8FD62EB1D28631AD601BAD41E520A286ED5F9888D9E573BD6F "点击放大")
...
权限的申请具体可以参考：[向用户申请授权](../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/向用户申请授权/request-user-authorization.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/tI375knFTFW7gKse0Y6nHg/zh-cn_image_0000002193851256.png?HW-CC-KV=V1&HW-CC-Date=20260612T021423Z&HW-CC-Expire=86400&HW-CC-Sign=B3DC992C3EEB6DD73DE724781D23474E0E8CCC0F4696DF4C28BBE71530F400D1 "点击放大")
...
5. // ...
6. {
7. "name": "ohos.permission.CAMERA",
8. "reason": "$string:camera_reason",
9. "usedScene": {
10. "abilities": [
11. "EntryAbility"
12. ],
...
[module.json5](https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/AppPrivacyProtection/entry/src/main/module.json5#L3-L83)
