...
scraped_at: 2026-06-12T10:14:30+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:73122d8f23d2af087b902dcf8b6cfcc4f94edbc74e0f982c7b80bfb7dccbb4dd
---
## 概述
...
构建[字节码HAR](../../../harmonyos-guides/构建应用/配置构建流程/构建HAR/ide-hvigor-build-har.md#section16598338112415)时有以下三种方式：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/44/v3/k9C0SyRoTgSurP6b6DOLkg/zh-cn_image_0000002194010408.png?HW-CC-KV=V1&HW-CC-Date=20260612T021429Z&HW-CC-Expire=86400&HW-CC-Sign=C821FFE6AABB70B1B2E28FAA9A1E0964B229301BC13E01162B38B6E873D9CF1F "点击放大")

**图2** DevEco Studio指定模块编译

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4/v3/FouqzlPJQJmT2NtaPzl8Sg/zh-cn_image_0000002229336225.png?HW-CC-KV=V1&HW-CC-Date=20260612T021429Z&HW-CC-Expire=86400&HW-CC-Sign=C80A5D81F09DD72365E81484F566B9A3AD271019DA8DFB1DCE4C6CDE057396B0 "点击放大")
...
**图3** 编译配置文件  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/Na_uuT5kSqKMJvrm9V3reA/zh-cn_image_0000002229336217.png?HW-CC-KV=V1&HW-CC-Date=20260612T021429Z&HW-CC-Expire=86400&HW-CC-Sign=352A55163BA794DACCA543999AFF17BA2A2D81D0D5E0D91A7C50EC3FC2A738AD "点击放大")

新建工程时，每个模块下都有obfuscation-rules.txt文件，用于配置混淆。

**图4** 混淆配置文件  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/moFNPX3rSJSSkvpx2EtaPg/zh-cn_image_0000002229336209.png?HW-CC-KV=V1&HW-CC-Date=20260612T021429Z&HW-CC-Expire=86400&HW-CC-Sign=40026E62FDD06F27613E8895235DC663DD0EBA2D36C52E8BF75330E467115952 "点击放大")
...
混淆选项具体的使用方法和样例代码可以参考[代码混淆](../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS编译工具链/ArkGuard源码混淆工具/ArkGuard混淆原理及功能/source-obfuscation.md)。
...
在编译一个模块时，生效的混淆规则是当前编译模块混淆规则和依赖模块混淆规则的合并结果。具体规则请参考：[混淆规则合并策略](../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS编译工具链/ArkGuard源码混淆工具/ArkGuard混淆原理及功能/source-obfuscation.md#混淆规则合并策略)。
...
* 混淆名称映射表及系统API白名单目录：build/[…]/release/obfuscation
  ...
  **图5** DevEco Studio编译产物与缓存文件  
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/88/v3/fxSg9xsEQza260pY8Fs0XA/zh-cn_image_0000002194010432.png?HW-CC-KV=V1&HW-CC-Date=20260612T021429Z&HW-CC-Expire=86400&HW-CC-Sign=35E74A59352095AB6D879E805E39674737E42FECCE18341C8720EB3F38C78496)
...
经过混淆的应用程序中代码名称会发生更改，因此报错栈与源码不完全一致，crash时打印的报错栈会难以理解，如何处理请参考[报错栈还原](../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS编译工具链/ArkGuard源码混淆工具/ArkGuard混淆开启指南/source-obfuscation-guide.md#报错栈还原)。

### 反混淆工具hstack

hstack需要将Node.js配置到环境变量中，详细使用说明请参考[堆栈解析工具（hstack）](../../../harmonyos-guides/命令行工具/堆栈解析工具（hstack）/ide-command-line-hstack.md)。

### 常见报错案例

请参考[ArkGuard混淆常见问题](../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS编译工具链/ArkGuard源码混淆工具/ArkGuard混淆常见问题/source-obfuscation-questions.md)。
