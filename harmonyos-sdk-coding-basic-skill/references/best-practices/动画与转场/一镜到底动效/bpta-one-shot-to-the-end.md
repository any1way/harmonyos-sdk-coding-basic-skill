...
scraped_at: 2026-06-11T16:56:43+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:d8d556a76c1c78077a3416b53aef435a73c83e87b5ac9b2b9a81b403e7ee5855
---
## 概述
...
* 共享元素
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/nLwfFJ6zQGqqNITQBRv7MA/zh-cn_image_0000002193851792.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=5A621089DB61E13696FE30CEE23606F86D3835D09DE2BBFD518AA3B6958015A2)
* 共享容器

  当一组元素在过渡时包含明确的边界，可使用容器来让转换过程有连续感。容器通过大小、高度、圆角等属性进行补间过渡转换，容器内的元素可通过淡入淡出或共享元素的手法进行过渡。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/CqDnJyQeQMmfT4WutdZJrg/zh-cn_image_0000002229451681.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=510EE4A477A9536A21C5EA1ABE287363F5E8E24103A273AE22D7EF152CB407F8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/99/v3/WyRhC6o1QBSEQJg9IfY1Nw/zh-cn_image_0000002194011368.png?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=E766508D1C9E0DDEEE8959325C19A6F00CD43B8F574A65B0A1D67F9939F3D066)
...
[NodeContainer](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义占位组件/NodeContainer/ts-basic-components-nodecontainer.md)作为一个占位容器组件，主要是用于自定义节点以及自定义节点树的显示和复用。NodeController提供了一系列生命周期回调，通过[makeNode()](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/NodeController/js-apis-arkui-nodecontroller.md#makenode>)回调返回一个 [FrameNode](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#framenode-1>)节点树的根节点。将[FrameNode](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md>)节点树挂载到对应的[NodeContainer](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义占位组件/NodeContainer/ts-basic-components-nodecontainer.md)下。同时提供了[aboutToAppear()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoappear)、[aboutToDisappear()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttodisappear)、[aboutToResize()](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/NodeController/js-apis-arkui-nodecontroller.md#abouttoresize>)、[onTouchEvent()](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/NodeController/js-apis-arkui-nodecontroller.md#ontouchevent>)、[rebuild()](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/NodeController/js-apis-arkui-nodecontroller.md#rebuild>)五个回调方法用于监听对应的NodeContainer的状态。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/8QGYmFK8RyajnAUtff8ofQ/zh-cn_image_0000002229451661.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=AC1E680FC669056C934797BC84D3E2420F398DA81B3AAA322C4DBE50B48FE529)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/rulI29EFT1iGfXpBYzam4w/zh-cn_image_0000002455271744.png?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=744D4C673D3B623EC5BE30FFC5EEC83CC2E1A15A7DD35830793E87C9D92F0479)

### 使用geometryTransition()共享元素转场

[geometryTransition()](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/动画/组件内隐式共享元素转场 (geometryTransition)/ts-transition-animation-geometrytransition.md>)接口用于组件内隐式共享元素转场，在视图状态切换过程中提供丝滑的上下文继承过渡体验。
...
Navigation通过[customNavContentTransition()](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#customnavcontenttransition11)事件提供自定义转场动画的能力，通过如下三步可以定义一个自定义的转场动画。

1. 构建一个自定义转场动画工具类CustomNavigationUtils，通过一个Map管理各个页面自定义动画对象CustomTransition，页面在创建的时候将自己的自定义转场动画对象注册进去，销毁的时候解注册。
2. 实现一个转场协议对象[NavigationAnimatedTransition](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navigationanimatedtransition11)，其中timeout属性表示转场结束的超时时间，默认为1000ms，transition属性为自定义的转场动画方法，开发者要在这里实现自己的转场动画逻辑，系统会在转场开始时调用该方法，onTransitionEnd为转场结束时的回调。
...
* 双指放大转场
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/kIInU_d3TjKf6Ot_fG_W0w/zh-cn_image_0000002194011400.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=97CD17FE68138DD548D737E416CDBB3614A13963AD9CF46468598D5265E15333)
...
* 查看大图转场
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bb/v3/ZPCSRWn4TY-ZWM07pGUE-A/zh-cn_image_0000002193851824.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=1A29D0D186FD8454B775360DB2851561C977CA2A9608E33A0862060553789ACB)
...
* 半模态转场
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/PT7IhBl7Skm-H1di7mJ23A/zh-cn_image_0000002193851788.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=3DABB225820BEE5212F81DB872F9C9C772367FF50914E858B0AB908FA1F6AB7B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/zvexhrHTQcazOb-z5bZ5tg/zh-cn_image_0000002229337185.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=746DC6F22AA933200BB2DB2618DBD88CEECAAA19F257C621D9B15CE1254DFEE5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/OvpVZVArRVKtU_eXHhlDjg/zh-cn_image_0000002194011396.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=0AD79908044CD3782BCE1A4E7A392DEA6C7F5EEE9E67FCC766FF40BDD2AD0E38)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/g8xaz0F3QmGb5fGYlTYa6A/zh-cn_image_0000002229451697.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=4299BE188ADE2FF8397E5BA28E85AF300ACD91A1FC9D75F9CCB2628AD66E2338)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/1lJ-DfMzScqZ69BihnUuYw/zh-cn_image_0000002229337193.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=D5C405C5A6740C5A5EE35BBC6AF77E0AFBDC6FC3E04A269EA6DB3BF06939A88E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/lGCuL8eNSb2qFRLBtTy6pQ/zh-cn_image_0000002193851796.gif?HW-CC-KV=V1&HW-CC-Date=20260611T085626Z&HW-CC-Expire=86400&HW-CC-Sign=42D3AB218BB6C928655E54AFBCBCC0628A6A5F3B2AEDFDD94AC7806D5A5C6856)
