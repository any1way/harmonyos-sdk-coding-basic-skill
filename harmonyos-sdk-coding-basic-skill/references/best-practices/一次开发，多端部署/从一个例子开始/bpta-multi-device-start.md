...
content_hash: sha256:5c0ad56059a3f44d6c3221dcf7b8e5abc5900d8040e00594a2be055ff229ebec
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/FVwZho79TGaY_DCcXsAV5g/zh-cn_image_0000002417910860.png?HW-CC-KV=V1&HW-CC-Date=20260612T020709Z&HW-CC-Expire=86400&HW-CC-Sign=8FF2CF788B5A6EB4FD2405925F0C9A10AFC2B2952A6384AC91EEB8D5281D6E86 "点击放大")
...
完成UX设计后，接下来需要考虑如何将设计转化为实际可运行的工程，在本文[多设备工程部署](../多设备工程部署与发布/bpta-multi-device-ide.md)中，将详细介绍一多的工程创建及管理等，本小节仅介绍最基础的工程创建及多设备预览调试。

### 工程创建

一多应用的工程创建过程，与传统应用并无较大差异。只需在工程创建过程中，注意在“Device Type”选项中勾选所有该应用期望运行的目标设备类型，保证后续该应用可以在所有目标设备上正确安装即可。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/Kz4fgJVfR2SoTVWI1NxH1w/zh-cn_image_0000002552894591.png?HW-CC-KV=V1&HW-CC-Date=20260612T020709Z&HW-CC-Expire=86400&HW-CC-Sign=D641D34CB49F03BFE204114C9FC43AD4E7C0BA2F0AC377B2D8C7336AC3F99F6E "点击放大")

### 预览调试

在代码开发过程中，可以开启预览器，并打开“Multi-profile preview”开关，实时观察应用在不同设备下的表现。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/AlTvP99DQHyj06PKRmmzOw/zh-cn_image_0000002355145441.jpg?HW-CC-KV=V1&HW-CC-Date=20260612T020709Z&HW-CC-Expire=86400&HW-CC-Sign=F6B0DAD2B225AC3821CD336DE85CF54DF80D45927C7F1F8BE5C9650BD9083903 "点击放大")

特别的，还可以点击“+ New Profile”按钮，新增自定义预览器。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/sHptRbyqRGGtedqglN8rKw/zh-cn_image_0000002321146750.jpg?HW-CC-KV=V1&HW-CC-Date=20260612T020709Z&HW-CC-Expire=86400&HW-CC-Sign=27CD92437BAEC580830AFC1FA39E67B0398028A440041C41820D4D42375F45E0 "点击放大")
...
* 将天气主页划分为9个基础区域，如：
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/z5lhcPbdQvSHPAqBO07bfA/zh-cn_image_0000002355265301.png?HW-CC-KV=V1&HW-CC-Date=20260612T020709Z&HW-CC-Expire=86400&HW-CC-Sign=08AFF7600F6A8A330A9895D158278687B652074AC0D31E52C3BC1B6B214D02CD "点击放大")
* 基础区域9仅在大设备上显示（需要在大设备上展开侧边导航栏），基础区域1-8虽然在各设备上始终展示但其尺寸及区域内的布局基本保持不变（区域8需要向下滑动设备至底部，下方示例图不做展示），可以结合[自适应布局](../多设备界面开发/界面元素自适应变化/自适应布局/bpta-multi-device-adaptive-layout.md)能力以[自定义组件](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/创建自定义组件/arkts-create-custom-components.md>)的形式分别实现这9个基础区域。

  |  | 小设备 | 中设备 | 大设备 |
  | --- | --- | --- | --- |
  | 主页 |  |  |  |
* 基础区域1-8之间的布局在不同设备上有较大差异，可以使用响应式布局中的[栅格](../多设备界面开发/界面布局响应式变化/响应式布局/bpta-multi-device-responsive-layout.md#section1061332817545)能力实现组件间的布局效果。
* 展开和隐藏侧边栏的功能可以通过[侧边栏组件](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/栅格与分栏/SideBarContainer/ts-container-sidebarcontainer.md)来实现。侧边栏是大设备上独有的，借助响应式布局中的[媒体查询](../多设备界面开发/界面布局响应式变化/响应式布局/bpta-multi-device-responsive-layout.md#section1950102518311)能力，控制仅在大设备上展示侧边栏即可。
...
设备屏幕可能无法一次性显示区域2-8的所有内容，故需要在外层增加滚动组件（即Scroll组件）以支持上下滚动。不同设备下区域2-8的相对位置一共有三套不同的布局，可以借助响应式布局中的[栅格](../多设备界面开发/界面布局响应式变化/响应式布局/bpta-multi-device-responsive-layout.md#section1061332817545)实现这一效果。本示例中将栅格在不同场景下分别划分为4列、8列和12列，区域2-8在不同场景下的布局如下表所示。
...
另外主页右侧的城市天气详情，支持左右滑动切换城市，可以使用[Swiper组件](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md)实现目标效果：
...
在本文的[多设备功能开发](../多设备功能开发/多设备功能开发/bpta-multi-device-function.md)章节中，将详细展开介绍。
