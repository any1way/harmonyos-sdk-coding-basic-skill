...
scraped_at: 2026-06-12T10:09:56+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:1e7e067dbe10eb30fcf3e3749568642e30f91338abbee3ecc6136e1fde1dfafe
---
## 概述

折叠屏提供独特的手持操作体验“悬停态”，用户可以将设备半折后立在桌面上，实现免手持体验。悬停态适用于不需要频繁交互的任务，如视频通话、视频播放、拍照和听歌。进入悬停态时，中间弯折区域难以操作且显示内容会变形，建议页面内容进行折痕区避让适配。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/bBZ7SFpGSkKsY-Ej0evgdg/zh-cn_image_0000002194010932.png?HW-CC-KV=V1&HW-CC-Date=20260612T020954Z&HW-CC-Expire=86400&HW-CC-Sign=AC35B76A6795C59CB58C7F6BC665F35EF8E592D4D4C71E01CF7D2CC53CEEE849 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/rZBkGmxiTgW8YwBSpV0npw/zh-cn_image_0000002193851340.png?HW-CC-KV=V1&HW-CC-Date=20260612T020954Z&HW-CC-Expire=86400&HW-CC-Sign=D8BECB35685B84897C2867D0AB9328E89E4FE0A0156CF60C69EC3DBA73E52060)

## 使用FolderStack组件实现悬停态

### 实现原理

[FolderStack](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/系统预置UI组件库/FolderStack/ts-container-folderstack.md)是系统提供的ArkTS组件，继承自[层叠布局Stack](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/组件布局/构建布局/层叠布局 (Stack)/arkts-layout-development-stack-layout.md>)。在Stack组件的基础上，FolderStack提供监控设备是否进入悬停态并进行重新布局的能力。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/41/v3/6UBU8WJ6RX2WwGZWbFrXuw/zh-cn_image_0000002229451233.png?HW-CC-KV=V1&HW-CC-Date=20260612T020954Z&HW-CC-Expire=86400&HW-CC-Sign=79D3E287C66C828AF0A53540E2B477223A2215B40AA10C7FDDAD4BB97BB54CD4 "点击放大")

## 使用FoldSplitContainer组件实现悬停态

### 实现原理

[FoldSplitContainer](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/系统预置UI组件库/FoldSplitContainer/ohos-arkui-advanced-foldsplitcontainer.md)是系统提供的分栏类型的ArkTS组件，可以实现折叠屏二分栏、三分栏在展开态、悬停态以及折叠态的区域控制。其中二分栏是上下分栏，三分栏是在二分栏基础上加上侧边栏。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/mowfNX0KQT6x6XZZSd15zw/zh-cn_image_0000002229451229.png?HW-CC-KV=V1&HW-CC-Date=20260612T020954Z&HW-CC-Expire=86400&HW-CC-Sign=8F1455B68A7A2F83FA129168825FFCF66D723B14866E8878EDEB0E07C5D0101A "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/ETtP3OomQMKYKmZcQaqhUw/zh-cn_image_0000002194010928.png?HW-CC-KV=V1&HW-CC-Date=20260612T020954Z&HW-CC-Expire=86400&HW-CC-Sign=D7DDDFF8604E66CB32014BC0914D4B1ECC6E117FAE082D1F58BF67BC1EF41D13 "点击放大")
...
1. 监听悬停态：通过[display.on('foldStatusChange')](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#displayonfoldstatuschange10>)接口监听设备是否进入半折叠态，同时通过display的[orientation属性](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#属性>)判断设备是否横屏，当两种状态都满足时即判断设备进入悬停态。
2. 调整布局：当设备进入悬停态后，通过[display.getCurrentFoldCreaseRegion()](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#displaygetcurrentfoldcreaseregion10>)接口获取折叠屏折痕区域的位置和大小，计算并设置上下半屏组件的尺寸和位置完成悬停态布局。

说明

在退出应用或者退出需要监听折叠态变化的页面时，需要调用[display.off('foldStatusChange')](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#displayofffoldstatuschange10>)接口取消监听，避免出现意想不到的问题。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/pafQPH3XScGDcmSKa0osZA/zh-cn_image_0000002229451225.png?HW-CC-KV=V1&HW-CC-Date=20260612T020954Z&HW-CC-Expire=86400&HW-CC-Sign=1F7503C6FA35929FB3701FB7875ED9339D88C55E80E48FED7166403519144E9E "点击放大")
