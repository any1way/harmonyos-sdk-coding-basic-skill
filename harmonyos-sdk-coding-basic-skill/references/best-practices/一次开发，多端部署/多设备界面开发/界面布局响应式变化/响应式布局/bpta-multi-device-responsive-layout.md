...
scraped_at: 2026-06-12T10:09:34+08:00
doc_updated_at: 2026-06-10
content_hash: sha256:4f51f37ec580aa9d23f71195fd728df71d7822e0f93769d17188ac6d5e8d4be7
---
## 概述
...
**图1** 响应式布局示意图1  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/KR8jAzOCTl2PSglCsUAxSg/zh-cn_image_0000002355146009.png?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=23F21ADC799B12ED8458CE5B8C59EE4190C45D98B6C799AA0051492938B29EA7 "点击放大")

**图2** 响应式布局示意图2  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7/v3/CrFXPSYSRwCveVwbVhFx6g/zh-cn_image_0000002321147306.png?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=54884087355DCF52E522567FE66A5AD0A9FDA447F1261AFEB3FD5487303E9606 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/euXCNsEcRl6Rf5Fei0l2kQ/zh-cn_image_0000002583460597.png?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=34CE789C2EEB81DBECD8565BF9F398B6944523EDEF0054B0FC5E7FB9DD35B4B0 "点击放大")

说明

1. 由于官网无法涵盖所有产品的断点区间，说明中提供补充方法：开发者可通过[display](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md>)模块接口获取屏幕宽高属性，自行判断当前设备所属的横纵断点区间。
...
从API version 22起，开发者可利用响应式系统环境变量装饰器@Env读取断点信息。当组件所在窗口尺寸发生变化时，@Env装饰的断点环境变量将更新，并触发与该断点环境变量关联的组件刷新，从而实现界面内容的同步更新。装饰变量声明如下，更多场景请参考[@Env：环境变量](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习响应式环境变量/@Env：环境变量/arkts-env-system-property.md>)。
...
断点环境变量具体使用方式请参考@Env：环境变量[使用场景](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习响应式环境变量/@Env：环境变量/arkts-env-system-property.md#使用场景>)。环境变量初始化流程请参考[@Env初始化流程](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习响应式环境变量/@Env：环境变量/arkts-env-system-property.md#env初始化流程>)。
...
2. WindowUtil类中创建窗口信息类对象，使用[getWindowWidthBreakpoint()](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getwindowwidthbreakpoint13>)与[getWindowHeightBreakpoint()](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getwindowheightbreakpoint13>)获取当前窗口横向断点与纵向断点。通过[on('windowSizeChange')](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#onwindowsizechange7>)开启窗口尺寸变化的监听，并在监听回调中重新获取断点。
...
为了提供独特的用户体验，类方形小窗口设计为独特布局。常见场景为手机上下1:1分屏或小方形屏（如Pura X系列产品的外屏），可使用横向断点为sm，纵向断点为md进行区分，示意图如下。更多详情和示例代码请参考[阔折叠应用开发](../../../../多端设备体验提升/手机/阔折叠应用开发/bpta-purax-guide.md)。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/Ve-Cc51aRlyGHw6OfZk2MQ/zh-cn_image_0000002355146073.png?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=A995304AAB479A0A19F60CA62ABADEB7B0374454D1225EC29B56109B975CE706)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1/v3/UvusqPSOTmeRCYUQAGn-7A/zh-cn_image_0000002321147370.jpg?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=166DA777C3CB7F5BCBCD8DBCFF19EACC94223C8B964EA3BDE37385ADD1A82DE9 "点击放大")
...
2. 使用@Watch装饰器监听状态变量isFullScreen的变化，以判断视频是否全屏播放，并在显示或隐藏时同步修改窗口方向。全屏播放时，未使用断点的窗口设置逻辑如下：需要将窗口设置为AUTO\_ROTATION\_LANDSCAPE属性的情况包括手机、双折叠屏（X 系列）的折叠态与半折态。
   ...
   **图4** **手机效果图**  
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/QoxYAs3OSvusap6SFdg1lg/zh-cn_image_0000002355265933.jpg?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=98C89BDA532B7123A3119FCFDAD5C8613D24F483959C12D4A07F6D809BEF8DB4 "点击放大")

   **图5** **双折叠屏（X系列）半折态**  
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0d/v3/pWdUgPSKRm6UCyvwbnlfDA/zh-cn_image_0000002321307226.jpg?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=068A08BE4EE691A64BAF83CD1B87D9D201F060CE18A4A8C0627F89581401C503 "点击放大")
...
本小节主要介绍媒体查询跟断点的结合，即如何借助媒体查询能力，监听断点的变化，关于媒体查询的相关介绍请参见[媒体查询](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/UI系统场景化能力/媒体查询 (@ohos.mediaquery)/arkts-layout-development-media-query.md>)。
...
**图6** 栅格示意图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/18/v3/ae2Qs0HIS4u7Sgh11z8L-g/zh-cn_image_0000002461092273.png?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=2D7516CA2EB96DFD768035A48BD5D301F803506728E2074BA9CAAC22E8F786F7 "点击放大")
...
* ArkUI在API version 9对栅格组件做了重构，推出了新的栅格组件[GridRow](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/栅格与分栏/GridRow/ts-container-gridrow.md)和[GridCol](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/栅格与分栏/GridCol/ts-container-gridcol.md)，同时原有的[GridContainer组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/已停止维护的组件与接口/GridContainer/ts-container-gridcontainer.md)及[栅格设置](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/已停止维护的组件与接口/栅格设置/ts-universal-attributes-grid.md)已经废弃。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e8/v3/UlUus2KlTiulumuwHdI9BA/zh-cn_image_0000002355265993.gif?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=E7C351BD10CE3EC419B2B15F7DABF8B5785282A43E90E3554AF47C6E44E207B0 "点击放大")
...
考虑到[组件通用属性](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/ts-component-general-attributes.md)中已经有margin和padding，栅格组件不再单独提供额外的margin属性，直接使用通用属性即可。借助margin或者padding属性，均可以控制栅格组件与父容器左右边缘的距离，但是二者也存在一些差异：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/18/v3/w7CRc8zbS36TG6UENdvewA/zh-cn_image_0000002355266017.png?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=F95D7C7338CF777E3434A8DC01A32B271549A52DCE465537418522AF5B8B846F "点击放大")
...
响应式组件的实现原理与开发步骤，可参考[组件布局场景](../组件布局场景/bpta-multi-device-component-layout.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6e/v3/2ulS16EpR5qOu5rVv3sa3w/zh-cn_image_0000002427564766.png?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=6BF5A8031F810F09DC7AF072BDB3D2BA9FC70559E85784138B5ED1C27A94D90A "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/FmS_OhhaReiaZkUw__TKNQ/zh-cn_image_0000002460966061.png?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=710E7D92A133DD540F425FBFEBA5244FB441EE39CE75267A85FD0E2B9EAEEDF0 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/jjd2S7UGSKCyTluCqZT9MQ/zh-cn_image_0000002427408746.png?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=D510A3ED144F9128D8C89AC4696A20B7457790124F4CE6F9738125E0A53DAA48 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/_bSfBPdUT1uOm-xd1zSgrw/zh-cn_image_0000002321147530.png?HW-CC-KV=V1&HW-CC-Date=20260612T020930Z&HW-CC-Expire=86400&HW-CC-Sign=FACA08949B6A0DAEB29A81A5CD3280C59EB02638C90B1AB96C3A9AF2156774E4 "点击放大")
...
关于响应式布局样式的开发实现，可参考[页面布局场景](../页面布局场景/bpta-multi-device-page-layout.md)。
...
若开发者需要应用随dpi改变刷新布局，可使用[on('densityUpdate')](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIObserver)/arkts-apis-uicontext-uiobserver.md#ondensityupdate12>)监听屏幕像素密度变化，并在监听回调中重新获取断点并刷新UI。

若开发者不希望应用受显示缩放影响布局，可以使用[setDefaultDensityEnabled()](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (WindowStage)/arkts-apis-window-windowstage.md#setdefaultdensityenabled12>)设置应用是否使用系统默认Density，true表示使用系统默认Density，窗口不跟随系统显示大小变化重新布局；false表示不使用系统默认Density，窗口跟随系统显示大小变化重新布局。
...
[PX](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#px10)（屏幕像素单位）：px，屏幕上的实际像素：1px代表手机屏幕上的一个像素点。

[VP](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#vp10)（虚拟像素单位）：vp，屏幕密度相关像素，根据屏幕像素密度转换为屏幕物理像素，当数值不带单位时，默认单位vp。vp与px的比例与屏幕像素密度有关。

[FP](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#fp10)（字体像素单位）：fp，字体像素大小默认情况下与vp相同，即默认情况下1fp = 1vp。如果用户在设置中选择了更大的字体，字体的实际显示大小就会在vp的基础上乘以scale系数，即 1fp = 1vp \* scale。

常见像素单位之间的转化请参考[vp2px](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#vp2px12>)/[px2vp](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#px2vp12>)/[fp2px](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#fp2px12>)/[px2fp](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#px2fp12>)/[lpx2px](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#lpx2px12>)/[px2lpx](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#px2lpx12>)等接口。
...
* 智慧屏设备，可参考[如何判断当前设备是智慧屏](../../../../多端设备体验提升/智慧屏/智慧屏应用开发/bpta-matetv-guide.md#section6168122172416)进行区分。

* 智能穿戴设备，可参考[一多应用中如何区分智能穿戴设备](../../../../多端设备体验提升/穿戴/智能穿戴应用开发/bpta-smartwatch.md#section1748314426272)进行区分。
