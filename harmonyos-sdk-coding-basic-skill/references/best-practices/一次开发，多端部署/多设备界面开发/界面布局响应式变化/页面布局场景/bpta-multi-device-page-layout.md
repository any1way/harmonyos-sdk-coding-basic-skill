...
scraped_at: 2026-06-12T10:09:44+08:00
doc_updated_at: 2026-03-19
content_hash: sha256:2e9f17d34f4b305685ec1cdb924ca6586ea163bfc27bc1cbd26d027ec1f2d5ec
---
...
设置不同横向断点下，[List组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)的lanes、space属性实现目标效果。
...
设置不同横向断点下，[WaterFlow组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)的columnsTemplate属性实现目标效果。
...
设置不同横向断点下，[Swiper组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md)的displayCount、prevMargin、nextMargin和indicator属性实现目标效果。
...
网格布局将容器按行和列划分为规则的网格，每个子组件严格对齐，实现均分和占比能力，详情请参考[创建网格](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/列表与网格/创建网格 (GridGridItem)/arkts-layout-development-create-grid.md>)；瀑布流布局子组件高度支持自定义，无需对齐，适合展示高度不一的内容，详情请参考[创建瀑布流](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/列表与网格/创建瀑布流（WaterFlow）/arkts-layout-development-create-waterflow.md>)。

**实现方案**

设置不同横向断点下，[Grid组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)的columnsTemplate属性实现目标效果。在不设置Grid组件行数的情况下，行数 = 展示元素数量 / 列数。Grid组件其他布局模式，请参考[rowsTemplate](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Grid/ts-container-grid.md#rowstemplate)。
...
在不同横向断点下，动态控制[SideBarContainer组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/栅格与分栏/SideBarContainer/ts-container-sidebarcontainer.md)的showSideBar和sideBarWidth属性实现目标效果。
...
设置不同横向断点下，[Navigation组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的mode属性实现目标效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/ReIjMOqMRKGf_3sIBsx_1g/zh-cn_image_0000002509292755.png?HW-CC-KV=V1&HW-CC-Date=20260612T020935Z&HW-CC-Expire=86400&HW-CC-Sign=D3B1DC4BB0C08785E65F7C72E88251A550979EC23C2842DE5391EE270222008A "点击放大")
...
在不同横向断点下，动态控制[SideBarContainer组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/栅格与分栏/SideBarContainer/ts-container-sidebarcontainer.md)的showSideBar、sideBarWidth属性，和[Navigation组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的mode、navBarWidth属性实现目标效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/hh8nH-LSQIOxdtEL8LLKjg/zh-cn_image_0000002509132789.png?HW-CC-KV=V1&HW-CC-Date=20260612T020935Z&HW-CC-Expire=86400&HW-CC-Sign=4F177C060F25608290CB056F79FFFE8E92D47277B9431433F781E5CA0FCF70DB "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/_KItfBasQUeB3vTagefo1w/zh-cn_image_0000002509292759.png?HW-CC-KV=V1&HW-CC-Date=20260612T020935Z&HW-CC-Expire=86400&HW-CC-Sign=68D5B51D22099EF910564432A133A409C23322ECCB2B9F4FA65A8E2A57B2CC57 "点击放大")
...
设置不同横向断点下，[GridRow组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/栅格与分栏/GridRow/ts-container-gridrow.md)的columns、breakpoints属性，和[GridCol组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/栅格与分栏/GridCol/ts-container-gridcol.md)的span属性实现目标效果。
...
设置不同横向断点下，[Tabs组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)的barPosition、vertical、barHeight、barWidth和barMode属性实现目标效果。
...
在xl断点下或使用PC/2in1设备，首页调用SideBarContainer组件，传入侧边栏区域组件和内容区域组件。此时可以结合[@State](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@State装饰器：组件内状态/arkts-state.md>)和[@Link](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Link装饰器：父子双向同步/arkts-link.md>)装饰器，同步所需要的参数信息，如当前选中的一级目录索引和二级目录索引，可以用于呈现与页签强相关的页面内容。
...
设置不同横向断点下，[GridRow组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/栅格与分栏/GridRow/ts-container-gridrow.md)的columns、breakpoints属性和[GridCol组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/栅格与分栏/GridCol/ts-container-gridcol.md)的span、offset属性实现目标效果。
