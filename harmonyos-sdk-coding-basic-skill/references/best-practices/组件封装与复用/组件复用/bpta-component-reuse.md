...
scraped_at: 2026-06-11T16:54:26+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:fdb29a12d90da8497838dd311cbad350499a031c4aa5d83db51a50cc4ad9e9e5
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/wPdV4MIsTtS8ghR0EVWhNA/zh-cn_image_0000002306983630.png?HW-CC-KV=V1&HW-CC-Date=20260611T085423Z&HW-CC-Expire=86400&HW-CC-Sign=DAA6797ED69968E057E75B55BB3EAC81BA5CBDC1E85FB698EF7A6D9E3281D07D "点击放大")

### 实现原理

ArkUI提供了[@Reusable装饰器](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md>)以实现自定义组件的复用，其原理如图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/BhG10G6TSR-B9RdDYKesAg/zh-cn_image_0000002341062601.png?HW-CC-KV=V1&HW-CC-Date=20260611T085423Z&HW-CC-Expire=86400&HW-CC-Sign=3D59012851DBA5DFF0E1EE977635A5046B3455E5B63E68145259468123A59BA4 "点击放大")

1. 标记了@Reusable的自定义组件listItem列表项，在滑动出屏幕一定范围后，从组件树上被移除，组件的对象实例被放入CustomNode虚拟结点（与自定义组件一一对应的自定义结点）。
2. 在不断滑动过程中，列表的RecycleManager将这些CustomNode虚拟结点回收，根据[复用标识](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/其他/复用标识/ts-universal-attributes-reuse-id.md)分组，形成CachedRecycleNodes的集合，即视图对象的复用缓存池。
...
更多注意事项参考指南[限制条件](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md#限制条件>)。

### 列表项结构类型相同

这种场景下，列表中的每一项都是由相同类型的元素和布局构成，列表项组件可以作为复用逻辑的基本单位。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/i3E8FpoLTD6wNr4VuWnEkw/zh-cn_image_0000002321247750.png?HW-CC-KV=V1&HW-CC-Date=20260611T085423Z&HW-CC-Expire=86400&HW-CC-Sign=3E92FF3216F7772268E496DBC868F61E64CFCDDD4E956F3352A340F946EDA115 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/34/v3/Uzp1l2HkTFSCiaayYpE9yA/zh-cn_image_0000002355045581.png?HW-CC-KV=V1&HW-CC-Date=20260611T085423Z&HW-CC-Expire=86400&HW-CC-Sign=49D1F8610AC7B7606B9D4A07A03751F437A841251F481DB30D165816FC6BAEFC "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/WX07ilQTQZO2P5E0SRJjzg/zh-cn_image_0000002306983638.png?HW-CC-KV=V1&HW-CC-Date=20260611T085423Z&HW-CC-Expire=86400&HW-CC-Sign=595BB7C520F85049F452F2CB13CF159042AE68256C00C335310154B5C5FF62D8 "点击放大")

因此，可以创建五种复用子组件，通过子组件的选择组合，实现不同类型的列表项。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0/v3/-MIS6Se2ThiYxXIP7AULgg/zh-cn_image_0000002341062605.png?HW-CC-KV=V1&HW-CC-Date=20260611T085423Z&HW-CC-Expire=86400&HW-CC-Sign=1F95D07DAA06FEA040096A54F37C1E2D5CA9A8DDD99AF7599BB76F1C8789C0DC "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/WaytUeZuRYepNS6iFzjgnw/zh-cn_image_0000002307143354.png?HW-CC-KV=V1&HW-CC-Date=20260611T085423Z&HW-CC-Expire=86400&HW-CC-Sign=2F94D16FF1F9C894FFEB48E896CA72F265CC3A8A8BED2FF6C6D54716527C1194 "点击放大")
...
此时可以自定义一个全局的复用缓存池NodePool，利用[BuilderNode](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md>)的节点复用能力，根据页面状态创建、回收、复用子组件，实现这种跨页面多个列表间的组件复用。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/RWM-eD7GQ5iJ6VAl3uHP7g/zh-cn_image_0000002340902753.png?HW-CC-KV=V1&HW-CC-Date=20260611T085423Z&HW-CC-Expire=86400&HW-CC-Sign=C94E62AC7BE443E6B71D606D8A127D829957FB9BCC60007F8037AA2943954F1A "点击放大")

在需要布局自定义组件的位置，使用[NodeContainer](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义占位组件/NodeContainer/ts-basic-components-nodecontainer.md)占位，然后继承[NodeController](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/NodeController/js-apis-arkui-nodecontroller.md>)实现NodeItem结点类，其内部需要持有[BuilderNode](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md>)实例以实现结点的创建和复用，同时需要持有视图相应的数据对象以更新界面显示。
...
当组件数量较多，集中预创建本身也耗时较长，容易导致主线程阻塞。ArkUI中提供了[onIdle()接口](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (FrameCallback)/arkts-apis-uicontext-framecallback.md#onidle12>)，会返回每一帧帧尾的空闲时间，可以将组件预创建分布到每一帧帧尾的空闲时间中执行，这样预创建过程就被平摊在多个周期里执行，避免集中运行的耗时影响，进而优化应用体验。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/yoik7HiOQ3mH59iIEFXZwQ/zh-cn_image_0000002306983642.png?HW-CC-KV=V1&HW-CC-Date=20260611T085423Z&HW-CC-Expire=86400&HW-CC-Sign=4AC2B8E5DD30E420A5932E4AE9A59DE50EB5D0BC6A32017702C738630DA80C26 "点击放大")
...
在可复用组件中使用[attributeUpdater](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/AttributeUpdater/js-apis-arkui-attributeupdater.md>)可以控制指定属性的刷新，避免不必要的重绘、减少渲染负载，从而提升应用性能。
...
在可复用组件中，建议使用[@Link](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Link装饰器：父子双向同步/arkts-link.md>)/[@ObjectLink](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Observed装饰器和@ObjectLink装饰器：嵌套类对象属性变化/arkts-observed-and-objectlink.md>)替代[@Prop](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Prop装饰器：父子单向同步/arkts-prop.md>)。因为@Prop装饰变量时会进行深拷贝，增加了创建时间及内存消耗，而改用@Link/@ObjectLink，变量会共享同一地址。
...
如果可复用组件中使用了[@Link](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Link装饰器：父子双向同步/arkts-link.md>)/[@ObjectLink](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Observed装饰器和@ObjectLink装饰器：嵌套类对象属性变化/arkts-observed-and-objectlink.md>)/[@Prop](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Prop装饰器：父子单向同步/arkts-prop.md>)等自动同步父子组件数据的状态变量，则不需要在aboutToReuse()中对这些数据重复赋值。如果重新赋值这些变量，会导致组件的内容重新触发状态刷新，造成额外的计算更新耗时。
...
* 使用[Code Linter扫描工具](<../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查/ide-code-linter.md>)进行代码检查，重点关注[@performance/hp-arkui-use-reusable-component](<../../../harmonyos-guides/编写与调试应用/代码编辑/代码检查/Code Linter代码检查规则/性能规则@performance/@performancehp-arkui-use-reusable-component/ide_hp-arkui-use-reusable-component.md>)规则。
* 通过Profiler工具抓取Trace，搜索组件名称，根据BuildRecycle字段识别是否触发复用渲染。具体可参考[通过Trace识别懒加载渲染流程](../../性能/性能分析/性能分析简介/bpta-optimization-overview.md#section1588117331934)。
* 通过Profiler工具抓取Trace，识别是否发生丢帧，判断子组件创建的次数。具体分析过程可参考[优化长列表-组件复用性能分析](../../性能/性能场景优化案例/界面渲染性能优化/长列表加载丢帧优化/bpta-best-practices-long-list.md#section1069111015296)。
