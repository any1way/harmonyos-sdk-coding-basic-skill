...
scraped_at: 2026-06-11T16:54:27+08:00
doc_updated_at: 2026-03-17
content_hash: sha256:bfffb70e25d27cc9b0e3f38529ab4759d2674be188cf3421bef087ef931cd30e
---
## 概述

组件复用的本质是自定义组件的缓存池。使用@Reusable装饰器标记自定义组件后，当该组件进入销毁流程时，将改为进入缓存池。当需要创建此自定义组件时，优先尝试从缓存池中寻找对应reuseId的自定义组件，若未找到再进行创建。此缓存池的实例位于@Reusable标记的自定义组件的父自定义组件上，会随父自定义组件的销毁一并销毁。关于自定义组件复用的详细使用方法，可参考[组件复用](../组件复用/bpta-component-reuse.md)文档。综上所述，组件复用的关键概念如下：
...
1. 在DevEco Studio中启动AppAnalyzer工具，详细请参见[AppAnalyzer](../../性能/性能检测/开发态性能检测/bpta-performance-detection.md#section135451444171)。
2. 本文展示的[正反例代码](https://gitcode.com/harmonyos_samples/BestPracticeSnippets/tree/master/ComponentReuse)分别位于positive和negative模块中，检测时需选择相应模块。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/nhSLrFPpSdOBUbnqCgGOnA/zh-cn_image_0000002480217994.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=5E9E411FED9687EF27F91A192DFD7CD93BF9A44E3BF4734388E0F48E69E0C3FE "点击放大")
3. 点击工具“手动性能页面滑动体检”，按照提示进行检测操作。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/vloovGKNRN207aurs9Ziyg/zh-cn_image_0000002480218014.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=2AF94B1A4D7AFE77D4C5D4DAB15786EF8A200DC017CEF67CF2988A96EDC54818 "点击放大")
4. 通过分析检测结果，结合滑动过程中列表卡片的创建次数，可以分析出当前列表的组件未使用复用或者复用未生效。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/5rHHp-eyS-q3h1YNOZpm6g/zh-cn_image_0000002512377915.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=82832058018D9A4D7189ADADAC5D32F6F58B73AF90D4DA8278BF0F4AE7F7EF7E "点击放大")
...
* **场景一：****列表项结构类型相同**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/jh3C9kGvSh-XpV3ShuUbsQ/zh-cn_image_0000002450073708.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=A40C85A2F8D42204657B7DCC4B5DDAD3A0461490C490F18EB50F6A201902B84A "点击放大")
...
* **场景二：****列表项结构类型不同**
  ...
  **①"总-分式"子组件可变结构**：ListItem的根组件只有一个，且根组件整体结构组成不变，局部子组件进行替换。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/cMSkUH1ISuKiUFvy7UT2Fw/zh-cn_image_0000002450237612.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=5A481021139F9BF1BA7F78CA49AE6353ACC72B4F2EC5C956153AFF3DA92DB540 "点击放大")
  ...
  **②分类组合式结构**：ListItem的根组件有多种类型，不同类型的根组件布局组成不同。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/pZftG2zURveJ5xHwyZwgFA/zh-cn_image_0000002450237740.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=9102FFC2114582639CE39509379313517D67FCDED0F09A9ECC63286B44CA77FF "点击放大")
...
* **场景三****：****列表项内子组件可拆分组合**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/kUEGFi4oTLG7-9yxLvAwpg/zh-cn_image_0000002483317849.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=3F95315B84A61347E3570F6893147D61BE04BD53749F744CB22624EDD1CAB5AC "点击放大")
...
* **场景一：父组件未使用复用，子组件使用复用**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/PcIaXK8HSV6jcNVVr7z5pQ/zh-cn_image_0000002450078536.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=4BBFCC891D1219C43CC7802D855AC43D5F0F8575FBAF2BC1A3198BE48096D8E6 "点击放大")
...
* **场景二：复用嵌套**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/mEl0Z2hRQxSaOkUVQUpAag/zh-cn_image_0000002450082776.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=122159A8B2DB7B4BF6846C7856C79CD5640E31645E7002E6983870FABE229961 "点击放大")
...
* **场景三：****reuseId分类过粗**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/88/v3/0Bow28H6RhGoL0wHd65r9Q/zh-cn_image_0000002483202361.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=EC1E824517F645C451270454608FEBAE0B649408049BA6AAEE16128FB8013F76 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f7/v3/Th1cGl0PSH2LrVsaGokE8A/zh-cn_image_0000002443220450.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=A0BD51F4A56E6B795BBE3C3676DFD3300C97C2E4302D8D825B5D7FA91278E4B5 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/24/v3/HG-rnHhjQL6BqcKiPuB-tQ/zh-cn_image_0000002476460317.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=304F0CB43566F0C59C01211934511CF8AF5A945A384D5730E68005D1B5B66A96 "点击放大")

上述案例中，BuildRecycle是典型的复用成功回调，此处执行耗时过长造成了应用丢帧，虽然当前操作在帧间，但是长耗时仍然会影响下一帧的执行。通过耗时函数检测，可以定位到具体的耗时方法。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/xZxHIciRQHS6dknGGAAaKQ/zh-cn_image_0000002476540529.png?HW-CC-KV=V1&HW-CC-Date=20260611T085422Z&HW-CC-Expire=86400&HW-CC-Sign=96498BA89D83EF01773DA85112ABF1522676376C145C85F4337D70367E3A3983 "点击放大")
...
复用过程的更新与状态管理的标准更新一致，可参考文档：[状态管理最佳实践](../../声明式语法/状态管理最佳实践/bpta-status-management.md)。
