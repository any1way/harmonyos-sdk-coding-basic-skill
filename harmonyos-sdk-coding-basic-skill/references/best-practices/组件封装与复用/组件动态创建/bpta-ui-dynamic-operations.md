...
scraped_at: 2026-06-11T16:54:20+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:560985d328e7c0b69888b3d282ba28e465e9d257c610cb9edecfbfd859babd97
---
## 概述
...
**图1** 组件预创建原理图  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/56/v3/ulj3ELLdTP6DIxXIalkbfQ/zh-cn_image_0000002194010524.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T085417Z&HW-CC-Expire=86400&HW-CC-Sign=55A4A6555D377BA929527140DD96A470652983E5FCA7BFFBE155F911159BB705 "点击放大")
...
相比之下，使用ArkUI的[自定义组件节点 (FrameNode)](<../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义组件节点 (FrameNode)/arkts-user-defined-arktsnode-framenode.md>)，可以避免创建自定义组件对象和状态变量对象，无需进行依赖收集，从而显著提升组件创建的速度。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/niHr5E3uTSywqJRmL4LSkg/zh-cn_image_0000002229450801.png?HW-CC-KV=V1&HW-CC-Date=20260611T085417Z&HW-CC-Expire=86400&HW-CC-Sign=6BB7F34B55D0C66D6166BA16266C41D9DEF4CBEA433296426B119CDB44107548 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/SG9ktlNXQrW2qSKo-YOGlQ/zh-cn_image_0000002194010516.png?HW-CC-KV=V1&HW-CC-Date=20260611T085417Z&HW-CC-Expire=86400&HW-CC-Sign=8A8AD619D45BA551AC7D1AC037AFD553FEA66CD4CEF5ED7E8761157DDBD3A520 "点击放大")
...
1. 创建自定义节点。
2. 实现[NodeController](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/NodeController/js-apis-arkui-nodecontroller.md>)，用于自定义节点的创建、显示、更新等操作的管理，并负责将自定义节点挂载到[NodeContainer](../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义占位组件/NodeContainer/ts-basic-components-nodecontainer.md#nodecontainer-1)上。
...
* 更新自定义节点
  ...
  更新自定义节点，可参考BuilderNode的[update()](<../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/BuilderNode/js-apis-arkui-buildernode.md#update>)方法。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/gml6L8GMQNiTzsDlX_2SyA/zh-cn_image_0000002194010508.png?HW-CC-KV=V1&HW-CC-Date=20260611T085417Z&HW-CC-Expire=86400&HW-CC-Sign=D2D9AEC7D2E7B7208A37D97B5100CFA6FF6DABAF042357D3541B4795022B55E9 "点击放大")
...
1. 以上示例场景在声明式开发范式下的完成时延为13.7ms（根据设备和场景不同，数据会有差异，本数据仅供参考），如下图所示。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/frN5q8p_Rq2rYiI9iBmfYw/zh-cn_image_0000002194010520.png?HW-CC-KV=V1&HW-CC-Date=20260611T085417Z&HW-CC-Expire=86400&HW-CC-Sign=9FA021E8D1962A3D0A3282C40477C5485597DF4A8866BCD0FF64117AD500009D "点击放大")
2. 以上示例场景在FrameNode扩展模式下的完成时延为6.1ms（根据设备和场景不同，数据会有差异，本数据仅供参考），如下图所示。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/UmKz4zdKQOWV_rrZGAFv7w/zh-cn_image_0000002229450785.png?HW-CC-KV=V1&HW-CC-Date=20260611T085417Z&HW-CC-Expire=86400&HW-CC-Sign=AB7E3CC56D3A13D4F65784A9EE2D4CA4FDDD06EDB54FBD70939B419E5C5A3E2E "点击放大")
