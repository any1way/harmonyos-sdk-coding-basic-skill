...
scraped_at: 2026-06-12T10:13:46+08:00
doc_updated_at: 2026-05-30
content_hash: sha256:b3b214fe5a2150af06d3d92a1a659bc03c2898ff73ddcc6b8c8773aeca87aae0
---
## 概述
...
本文档适用于轻量级智能穿戴应用开发，针对智能穿戴应用请参考[智能穿戴](../智能穿戴应用开发/bpta-smartwatch.md)。

## 体验应用

### 搭建环境和创建项目

* 搭建环境：请参考[安装DevEco Studio](<../../../../harmonyos-guides/开发环境搭建/下载与安装DevEco Studio/ide-software-install.md>)，配置开发环境。
* 创建项目：请参考[创建一个新的工程](../../../../harmonyos-guides/开发环境搭建/工程创建/创建一个新的工程/ide-create-new-project.md)，模板选择“[Lite]Empty Ability”，设备类型选择“Lite Wearable”。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/nl-XkfVUQm2NMjk4RBBrGQ/zh-cn_image_0000002230878012.png?HW-CC-KV=V1&HW-CC-Date=20260612T021343Z&HW-CC-Expire=86400&HW-CC-Sign=FBA4A584EDB35D7476D4123AA2CBFD9185949508992CCC0BC2A02EB9585DCBD5 "点击放大")

### 工程目录介绍

HelloWorld工程目录如下图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/VlrCCpoORnu1xUVgczX9WA/zh-cn_image_0000002231037832.png?HW-CC-KV=V1&HW-CC-Date=20260612T021343Z&HW-CC-Expire=86400&HW-CC-Sign=CE51456B1AD236F03EC8CFD260CC448F1AAD0A0ADB01439B510C3D392A517AD7 "点击放大")
...
使用预览器查看效果，请参考[查看ArkTS/JS预览效果](../../../../harmonyos-guides/编写与调试应用/界面预览/查看ArkTSJS预览效果/ide-previewer-arkts-js.md)。
...
* 在Lite Wearable中运行应用/服务，需要根据[应用/元服务签名](../../../../harmonyos-guides/编写与调试应用/配置调试签名/ide-signing.md)，提前对应用/服务进行签名。

  说明

  因Lite Wearable设备无法与DevEco Studio进行连接，因此在对Lite Wearable应用/服务签名时，不能采用自动化签名方案，只能使用[手动签名](../../../../harmonyos-guides/编写与调试应用/配置调试签名/ide-signing.md#section297715173233)，然后再手动配置签名信息。
...
具体开发步骤可参考开发[示例](../../../../harmonyos-references/ArkUI（方舟UI框架）/JS组件/兼容JS的类Web开发范式（ArkUI.Lite）/容器组件/list/js-lite-components-container-list.md#示例)。
...
1. 在“pages”目录右键，选择“New > Page”，将“Page name”设置为“details”。如果使用其他方式添加页面，则在添加页面后需要修改配置文件config.json中的pages标签。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/JmDClQbGT5GgTapGUo1SxA/zh-cn_image_0000002266037277.png?HW-CC-KV=V1&HW-CC-Date=20260612T021343Z&HW-CC-Expire=86400&HW-CC-Sign=B839C114886A1137216E29023D203809203242231D885252387C9C15934CD2D9 "点击放大")
...
6. 使用Preview预览效果，详情请参考[查看ArkTS/JS预览效果](../../../../harmonyos-guides/编写与调试应用/界面预览/查看ArkTSJS预览效果/ide-previewer-arkts-js.md)。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/t6uEbQZYRqOsFSNcBs9JFg/zh-cn_image_0000002265917341.png?HW-CC-KV=V1&HW-CC-Date=20260612T021343Z&HW-CC-Expire=86400&HW-CC-Sign=C064E7F2824BF4889406DADDAA1C0B27193766CB10335294757B9C0D55636A1E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/08/v3/c1fXakkFSSyvQMhoB4YFcg/zh-cn_image_0000002230878016.png?HW-CC-KV=V1&HW-CC-Date=20260612T021343Z&HW-CC-Expire=86400&HW-CC-Sign=E0ADB4ACD5B77A4AAC0EAD34A6CB592767A650686647237807C5C8B06BA043BE "点击放大")
...
4. 在preview中预览在轻量级智能穿戴上的显示效果，如下图所示。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/d1t83M0ySHOa5WahVa5hSg/zh-cn_image_0000002231037836.png?HW-CC-KV=V1&HW-CC-Date=20260612T021343Z&HW-CC-Expire=86400&HW-CC-Sign=FA79F160053A84BC29EA57F0D56B9621DA137EF088CDD1069C1110CF05B8F1B1 "点击放大")
...
1. 多语言资源文件放在[文件组织](<../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (兼容JS的类Web开发范式)/框架说明/文件组织/js-framework-file.md>)中指定的i18n文件夹内，命名规则为：语言-国家/地区.json，如zh-CN.json为简体中文，en-US.json为英文。限制词取值要求可参考[定义资源文件](<../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (兼容JS的类Web开发范式)/框架说明/多语言支持/js-framework-multiple-languages.md#定义资源文件>)。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/TGniIVtRQSSQBcw2C05hwg/zh-cn_image_0000002505798198.png?HW-CC-KV=V1&HW-CC-Date=20260612T021343Z&HW-CC-Expire=86400&HW-CC-Sign=A142F6702F524C19EC667DCFBA22BCDC7BEDA80B51BA7A32D7EEB19EB7CA9A07)
...
2. 创建语言资源文件后，在配置文件中配置索引和语言的映射关系，格式为："key值索引": "语言文本"，如下所示。
   ...
   6. }
   ```
3. 配置好语言资源文件后，可在hml文件或js文件中使用$t方法引用资源，详细请参考[引用资源](<../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (兼容JS的类Web开发范式)/框架说明/多语言支持/js-framework-multiple-languages.md#引用资源>)中的简单格式化方法。
...
2. 检查添加的udid是否超过10个。
3. 检查签名证书是否过期。
4. 手动签名详情请参考[手动签名](../../../../harmonyos-guides/编写与调试应用/配置调试签名/ide-signing.md#section297715173233)。
