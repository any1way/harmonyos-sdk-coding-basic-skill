...
scraped_at: 2026-06-12T10:18:50+08:00
doc_updated_at: 2026-06-02
content_hash: sha256:1754f8bd025a631ef00389e4a10de03d63491c776c15624b9a5bd3a3d5743a12
---
## 概述
...
HarmonyOS多目标产物支持[HAP](../../../harmonyos-guides/基础入门/开发基础知识/应用程序包基础知识/应用程序包开发与使用/HAP/hap-package.md)（应用安装的基本单位，每个HAP都对应一个应用模块）、[HAR](../../../harmonyos-guides/基础入门/开发基础知识/应用程序包基础知识/应用程序包开发与使用/HAR/har-package.md)（静态共享包）、[HSP](../../../harmonyos-guides/基础入门/开发基础知识/应用程序包基础知识/应用程序包开发与使用/HSP/in-app-hsp.md)（动态共享包）以及App（由多个HAP打包一起上架的完整应用程序）包多种类型的包，以满足不同业务场景下的应用开发和定制需求。

### 多目标产物定制项

目前多目标产物支持的定制项信息如下表所示，表中已给出每一项的作用。详细的每一个定制项的配置方法可以参考：[配置多目标产物](../../../harmonyos-guides/构建应用/配置构建流程/配置多目标产物/ide-customized-multi-targets-and-products.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/DmTk40rYSDamdkpHGEgGdA/zh-cn_image_0000002523454541.png?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=9FE675EBCA88E1B38A76B7B38F7A0E5FA0C29630AA23A6CF04B70CE1E4500E9E "点击放大")
...
4. 实现不同目标产物需要定制的业务逻辑。
   * 通过[source源码集-sourceRoots配置](../../../harmonyos-guides/构建应用/配置构建流程/配置多目标产物/能力说明/ide-customized-multi-targets-and-products-guides.md#section18668905913)的差异性代码空间，实现标题（代码文件）多目标效果。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/5x4vaZtXSECjw5caeLnkvA/zh-cn_image_0000002229335589.png?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=69F93C941BDD0F0E7771BC8AF0EBA0A7D51404B43B98A69AB7DF53F69D237AD4) ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/aWKebOBGSqiSu5Ltn9f4FQ/zh-cn_image_0000002193850196.png?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=3D56FB8D14D37CB39746ECCC97D1BF05EF9D044B33A1D790DC8F39E526060065)
     ...
     在Index.ets文件中，通过import packageName的方式，省略sourceRoot，可以实现不同target下的差异化构建（ import xxx from '<packageName>/sourceFileName'）。该能力具体可参考：[source源码集-sourceRoots配置](../../../harmonyos-guides/构建应用/配置构建流程/配置多目标产物/能力说明/ide-customized-multi-targets-and-products-guides.md#section18668905913)。
   ...
   * 在HAR模块引用差异性资源，实现页面中资源多目标效果。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/3EvwzLPZRXWOJO3XFSKJGw/zh-cn_image_0000002194009792.png?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=EA7F71C0788399043ABA46BC2220485BA2F65C49D374FDB3FA2AEDD57B585978) ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/hJ2Gto9hRjy_BY9o8QsasQ/zh-cn_image_0000002194009796.png?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=FC2514618A6E6A5229F9CCF0703F8E88F2E5D5B345D9867910C0B7391042A059)
   ...
   * 在HAR模块中通过不同自定义参数信息跳转到不同页面，实现路由跳转多目标效果。
     ...
     **图1** official版本  
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/oYzSMJgyRWyum2efTyKuwg/zh-cn_image_0000002229335573.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=CF325780917F5280E65EA2C2C05E73497F10AB1EBA66FBDD6E6E005406A1DD00)

     **图2** test版本  
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1b/v3/JxtnwgEySfeQm1n7akq-Zw/zh-cn_image_0000002193850204.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=CF5DE80858F14435EAE8A4A2D402436793027C7FF99E6F35D1FAAB8EC92539F4)

     在先前的案例中，已经介绍了如何在sourceRoots目录配置的差异性代码空间中实现对同名文件中的同名方法的调用。这里主要介绍在不同的target中如何调用不同名的文件中的不同方法。

     首先，需要通过配置文件中配置的自定义参数[生成相应的BuildProfile.ets文件](../../../harmonyos-guides/构建应用/定制构建/获取自定义编译参数/能力说明/ide-hvigor-get-build-profile-para-guide.md#section8279154125918)。上述HAR模块的配置文件中，我们配置了buildProfileFields自定义参数"productName"，在official和test版本中分别配置了不同的值"official"和"test"。这样我们构建不同的产物版本就会生成不同的"productName"值，用于在代码工程中区分不同的产物版本。
...
5. 选择不同的product构建出不同的目标产物。
   ...
   **图3** 构建图示  
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/n6dv-bb9SeO38s-b8ORkmg/zh-cn_image_0000002229450045.png?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=ECBA30939B06AACDE4F1AEC283E70231C797AF16AD78D525CA4ED50F93244FF1)
   ...
   **图4** Official版本
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/FWDJtiefRtGXBK3FMAeE8g/zh-cn_image_0000002194009800.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=656321F43A2D0F9878C1505B45D984229E761CBEF4790DA9EE04DFB101E9DDF0)

   **图5** Test版本  
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/rHsrjCS7T4eYClNkOF9R0w/zh-cn_image_0000002229335577.gif?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=B85DE182C10B1E3C61C90BD56952FE12DAD235EC386B0AAD4D02517228597A66)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/l3Ty0Fc3T-KUwSEvP1FpJQ/zh-cn_image_0000002229335565.png?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=96CAFA60770B64EF952FA5AAF511743CAC56A60C56FB75E12889D08DFDFB1EB2 "点击放大")

然后进入到签名配置页面，点击加号，添加签名信息：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/yGdwWKQfT_S0j9LKm_cUtw/zh-cn_image_0000002229450081.png?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=D09ABB45CD572F55879C2CB6251335E07B405B439EB4E0EFE4F648ABE7681F4C "点击放大")

然后选择对应的bundle name，并填写上面配置的"signingConfig"信息（每个product产物都需要配置）：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0c/v3/EWQsh_knTyeTa85DdKgyFQ/zh-cn_image_0000002193850180.png?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=4EABFD90DA7D26FAE898B30D7E2D917500676A0817DE79A0CA649F7140954F20 "点击放大")

点击ok之后，进行签名即可。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/FPAj4bHQTRuSFFJbLeeRvw/zh-cn_image_0000002193850208.png?HW-CC-KV=V1&HW-CC-Date=20260612T021834Z&HW-CC-Expire=86400&HW-CC-Sign=9CA5609A327B9532D136EAB5624F1DCD1F4C1970A88D49A756431E90590F4079 "点击放大")
