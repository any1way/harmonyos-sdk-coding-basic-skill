...
scraped_at: 2026-06-11T15:32:07+08:00
doc_updated_at: 2026-06-10
content_hash: sha256:7be456ecd76e757d523185a4e444af4f59243c9ac5d4e4ef72605de89eb5600c
---
安装三方库。
...
从ohpm 6.0.2.636版本开始，可以在 install 命令后面配置 --odm\_r2\_project\_root 参数。当存在overrideDependencyMap配置，且其配置项对应的配置文件内存在相对路径的依赖配置时，ohpm会基于工程根路径解析和查询相对路径，详情参见[odm\_r2\_project\_root](../../ohpmrc/ide-ohpmrc.md#section136621053184912)。
...
从ohpm 6.0.2.636版本开始，可以在 install 命令后面配置 --resolve\_conflict\_strict 参数，ohpm会按照严格模式处理依赖版本冲突，详情参见[resolve\_conflict\_strict](../../ohpmrc/ide-ohpmrc.md#section1942983310492)。
...
从ohpm 6.0.2.636版本开始，可以在 install 命令后面配置 --resolve\_conflict 参数，ohpm会自动处理依赖版本冲突，详情参见[resolve\_conflict](../../ohpmrc/ide-ohpmrc.md#section368717475562)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/Jwd434PUQ3m_0n12FER3jg/zh-cn_image_0000002602066517.png?HW-CC-KV=V1&HW-CC-Date=20260611T072921Z&HW-CC-Expire=86400&HW-CC-Sign=D8889F21D44C39B411F058272E5942C7EA4A4A59160D727A9B98E9B582E42A1B "点击放大")
