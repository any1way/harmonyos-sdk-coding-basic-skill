...
scraped_at: 2026-06-01T15:27:23+08:00
doc_updated_at: 2026-04-22
content_hash: sha256:2b1ff70d21aa41e5a5e43f7a49a519e309fc85c08732cae28516271e4a391529
---
设置ohpm用户级配置项。
...
ohpm 从命令行和 .ohpmrc 文件中获取其配置设置。有关更多 .ohpmrc 文件信息和可用配置选项，请参阅 [ohpmrc](../../ohpmrc/ide-ohpmrc.md) 章节。

注意

ohpm config 仅支持配置项字段（默认项字段请查阅 [ohpmrc](../../ohpmrc/ide-ohpmrc.md#zh-cn_topic_0000001792216397_默认配置项) 章节），且仅支持修改**用户级目录**下的 .ohpmrc 文件。
...
生成的加密结果可以配置到项目级或用户级 .ohpmrc 文件中，用于[敏感配置项](../../ohpmrc/ide-ohpmrc.md#section18322038185010)。
