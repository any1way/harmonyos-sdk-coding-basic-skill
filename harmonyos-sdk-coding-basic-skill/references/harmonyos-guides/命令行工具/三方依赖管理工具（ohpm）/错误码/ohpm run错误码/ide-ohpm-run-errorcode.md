...
scraped_at: 2026-06-01T15:27:52+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:676fdd80dc26b383b9d6b37fb0696af469b4ea9b49d26f335c98a16ff680fa32
---
## 00611001 脚本执行失败
...
修改脚本别名，具体请参考[约束](<../../常用命令/ohpm run/ide-ohpm-run.md#zh-cn_topic_0000001792216413_约束>)。
...
检查oh-package-lock.json5文件是否符合规定的格式，具体请参考[oh-package.json5](../../oh-package.json5/ide-oh-package-json5.md)。
...
传递参数配置时，确保以--开头，以指示需要添加或覆盖的参数。具体请参考[传递参数](<../../常用命令/ohpm run/ide-ohpm-run.md#zh-cn_topic_0000001792216413_传递参数>)。
