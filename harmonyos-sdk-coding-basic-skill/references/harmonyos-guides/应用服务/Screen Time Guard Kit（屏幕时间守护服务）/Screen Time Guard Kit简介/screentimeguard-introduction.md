...
scraped_at: 2026-06-01T15:10:52+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:42d759e7b812dba881e21e6667320fcbea3ae7084ab4d58d71f628561219e907
---
在应用安全隐私保护前提下，为开发者提供屏幕使用时间管控、应用使用限制等开放能力，满足不同用户对时间管理多样化诉求，更好的服务终端用户。

## 能力介绍

[用户授权管理](../用户授权管理/概述/screentimeguard-interface-call-auth-overview.md)：用来管理用户的授权信息，分别为请求用户授权访问，取消授权访问，授权情况查询。

[应用选择页](../应用选择页/概述/screentimeguard-app-picker-overview.md)：提供接口拉起具有不同功能的半模态页面，用户可在页面中勾选想进行管理的应用、快速跳转到其它应用。

[守护策略管理](../守护策略管理/概述/screentimeguard-guard-strategy-manage-overview.md)：提供接口实现时间策略的添加、修改、查询、删除、启动和停止操作。

[应用访问限制](../应用访问限制/概述/screentimeguard-apps-restriction-overview.md)：对选定范围内的应用进行立即生效的允许/禁止管理。
