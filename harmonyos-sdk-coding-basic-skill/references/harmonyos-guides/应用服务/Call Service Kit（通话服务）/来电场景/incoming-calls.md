...
scraped_at: 2026-06-11T15:05:18+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:8dcd8cb8ce95b1d256bc1e1ace640a06d04eec8a6bea5ee3df9f52c39236a0ce
---
## 场景介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/m4kY4y_nSIu3mx2ln7jcpg/zh-cn_image_0000002622858707.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070517Z&HW-CC-Expire=86400&HW-CC-Sign=7140D3129ACBCAA3493A536E045EE8B7486E7BC55A1384684CCAF1DF176BF571)

### 来电场景：拒接流程图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/aZ5PHBpqTS2BEoSWSSbwAQ/zh-cn_image_0000002622698827.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070517Z&HW-CC-Expire=86400&HW-CC-Sign=E63570C4EE697300428577A7413986D305591DF1C04507F8476A926AC29DD4E0)

## 接口说明

来电场景的接口，由[voipCall](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md>)提供。更多接口信息详见[接口文档](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md>)。
...
2. 为了感知到用户在横幅通知上做的接听、挂断、静音与解除静音等操作，应用需要注册voipCallUiEvent事件。建议在上报来电之前注册。
   ...
   4. });
   ```
3. 应用内部建立通话连接之后，需要向Call Service Kit上报来电，并携带通话信息，详见[VoipCallAttribute](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcallattribute>)。
   ...
   对于视频通话，可以通过参数[isVoiceAnswerSupported](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcallattribute>)指定是否允许语音接听，示例代码如下：
...
4. 接收到来电之后，用户可以选择接听或拒接。
   ...
   * 上报两次状态（推荐）。
     ...
     以语音通话为例，应用在接收到[VOIP\_CALL\_EVENT\_VOICE\_ANSWER](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcalluievent>)事件回调之后，立即向Call Service Kit上报[VOIP\_CALL\_STATE\_ANSWERED](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcallstate>)状态，并同时执行应用内接听。

     在完成应用内接听之后，再向Call Service Kit上报[VOIP\_CALL\_STATE\_ACTIVE](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcallstate>)状态，系统会更新通话横幅。
   ...
   * 只上报一次状态。
   ...
   以语音通话为例，应用在接收到[VOIP\_CALL\_EVENT\_VOICE\_ANSWER](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcalluievent>)事件回调之后，执行应用内接听。

   一直到完成应用内接听后，再向Call Service Kit上报[VOIP\_CALL\_STATE\_ACTIVE](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcallstate>)状态。
   ...
   如果用户在横幅通知上点击拒接，则应用在接收到[VOIP\_CALL\_EVENT\_REJECT](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcalluievent>)事件回调之后，在应用内完成拒接，然后向Call Service Kit 上报[VOIP\_CALL\_STATE\_DISCONNECTED](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcallstate>)状态，系统会取消横幅通知。
...
5. 在通话过程中，用户可以根据需要，可以静音或解除静音。
   ...
   以静音为例，用户在横幅上点击静音，Call Service Kit会给应用回调[VOIP\_CALL\_EVENT\_MUTED](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcalluievent>)事件。

   应用在完成静音后，应向Call Service Kit上报[AUDIO\_EVENT\_MUTED](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#callaudioevent>)音频状态。
   ...
   | --- | --- |
   |  |  |
6. 用户在横幅点击挂断，Call Service Kit会给应用回调[VOIP\_CALL\_EVENT\_HANGUP](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcalluievent>)事件。

   应用收到该事件后，应在应用内完成挂断，然后，向Call Service Kit上报[VOIP\_CALL\_STATE\_DISCONNECTED](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcallstate>)状态，系统会取消横幅通知。
