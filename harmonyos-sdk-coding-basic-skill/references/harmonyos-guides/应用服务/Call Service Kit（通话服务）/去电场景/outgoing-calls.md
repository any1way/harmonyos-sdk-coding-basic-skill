...
content_hash: sha256:314a3f1341c92de2cb4a2590d0f980651eefe83563dd049d0d9fe9d525aa59a4
---
## 场景介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1a/v3/AImptectR3qJDkRSyMRQOg/zh-cn_image_0000002592219270.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070517Z&HW-CC-Expire=86400&HW-CC-Sign=A69D51F1D970B6594974D24123C6EE3BFF9BD4A1030933012077DE08A1432CD5)

## 接口说明

去电场景的接口，由[voipCall](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md>)提供。更多接口信息详见[接口文档](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md>)。
...
2. 为了感知到用户在实况窗上做的静音与解除静音、挂断通话等操作，应用需要注册voipCallUiEvent事件。建议在上报去电之前注册。
   ...
   4. });
   ```
3. 应用内部建立通话连接之后，需要向Call Service Kit上报去电，并携带通话信息，详见[VoipCallAttribute](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcallattribute>)。
   ...
   上报去电时，通话状态必须是VOIP\_CALL\_STATE\_DIALING，否则Call Service Kit会认为参数不合法而返回[1007200001错误码](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/ArkTS API错误码/call-error-code.md#section1007200001-参数无效>)。
4. 如果对端接听，应用需要向Call Service Kit上报通话状态[VOIP\_CALL\_STATE\_ACTIVE](<../../../../harmonyos-references/Call Service Kit（通话服务）/ArkTS API/voipCall (应用内通话管理)/call-voipcall.md#voipcallstate>)。系统会更新通话胶囊，开始展示通话计时。
...
5. 去电场景，用户也可以拉起通知中心面板，在实况窗通知上执行静音或解除静音。
   ...
   开发方法与来电场景相同，详见[来电场景：静音与解除静音](../来电场景/incoming-calls.md#开发步骤)。
6. 去电场景，用户也可以拉起通知中心面板，在实况窗通知上点击挂断。

   开发方式与来电场景相同，详见[来电场景：用户点击挂断](../来电场景/incoming-calls.md#开发步骤)。
