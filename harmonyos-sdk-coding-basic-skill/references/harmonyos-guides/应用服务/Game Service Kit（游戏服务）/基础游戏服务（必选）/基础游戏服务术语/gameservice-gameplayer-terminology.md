...
content_hash: sha256:5b0ca527649600e2f592333c24ff2f7468239dc04e2e5bb2a256fbd7db983b14
---
## M
...
| 系统 | 名称 | 组成 | 说明 |
| --- | --- | --- | --- |
| HarmonyOS 5.0及以上系统 | gamePlayerId | 根据[配置APP ID映射关系](../游戏登录/网络游戏登录/使用华为账号登录（必选）/gameservice-gameplayer-huawei.md#配置app-id映射关系)时的选择openId或playerId。 | 用于华为账号登录的玩家标识。  不同游戏下，同一玩家的gamePlayerId不同。 |
