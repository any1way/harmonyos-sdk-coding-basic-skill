...
scraped_at: 2026-06-01T15:03:37+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:238e41f7e8143c2a1a65b9a3be5a028885b6dc1a2b27fa0cbe4417d735c017d8
---
...
1. 登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)，在“开发与服务”下选择项目及项目下的游戏，获取“应用”下的APP ID和Client ID。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/R04HQTPHQ_ef4MbfMnuPQw/zh-cn_image_0000002613639271.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=E68F0467B89292CB04476191EE530A23127E99D377319CBA91207B4983CEFEC9)
...
1. 登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)，在“开发与服务”下选择项目及项目下的游戏，左侧菜单选择“构建 > 游戏服务”，在右侧点击“新增配置”。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/arwefnu5SXuABOkOaWfrqQ/zh-cn_image_0000002613519377.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=3557FE0BA910FA9B802939FB91D5E4E2FCC766276A55F9E2D9DFCAF97473DA9A)
2. 在弹出的“新增配置信息”窗口中选择HAP游戏和APK游戏，完成后点击“下一步”。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/FjOUqoWUT_KE3qGb9dSawA/zh-cn_image_0000002582959580.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=9FEFD86988FD4A841B0082F5618717247A275443CF14485EFD0D8F135E78F232)
...
3. 在弹出的窗口中继续填写信息，完成后点击“下一步”。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/tutARJu-RIifupYKonvPew/zh-cn_image_0000002583119506.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=7B81942D52D3DFAC51BEE7A22CBC990C259379A8DC439E3AC050588CD8283C4C)

   | 信息项 | 说明 |
   | --- | --- |
   | 支持数据继承的玩家标识类型 | 请选择HarmonyOS 4及以下游戏的玩家标识类型：  - **playerId**：老系统游戏确认使用**playerId**作为玩家标识，请选择“**playerId**”。选择后，新系统游戏的玩家标识gamePlayerId=playerId。  - **openId**：如下情况请选择“**openId**”  - 情况一：老系统游戏确认使用**openId**作为玩家标识。  - 情况二：老系统游戏确认使用**unionId**作为玩家标识。此时，请同时勾选“使用了unionId”，并通过[转换ID](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/REST API/转换ID/gameservice-convertid.md>)用gamePlayerId（openId）换取unionId，若unionId未在游戏侧找到玩家记录，则当前玩家为新系统游戏的新用户。  - 情况三：部分游戏由于处于playerId替换为openId方案的过渡期，导致老系统游戏的玩家标识存在**playerId与openId混用**的情况，例如A玩家使用openId，B玩家使用playerId。此时，若无法通过gamePlayerId在游戏侧找到玩家记录，可通过[转换ID](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/REST API/转换ID/gameservice-convertid.md>)接口用gamePlayerId（openId）换取playerId，若playerId能在游戏侧找到玩家记录，表明该玩家是使用playerId作为玩家标识的老用户，否则该玩家为新系统游戏的新用户。  - 情况四：HarmonyOS 4及以下游戏未上架时。 |
...
4. （可选）填写开发者服务器的回调地址，回调地址要求支持HTTPS协议，且具有合法商用证书，完成后点击“确定”提交APP ID映射关系的审批申请。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/9UahMrw_QDucfTOk_h2OUw/zh-cn_image_0000002613639273.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=107169F0C0D5BEFD40440B933FC5F6261647D74A68FEFC2D5F642C12D6953ED0)

   若用户注销华为账号，华为游戏服务器向开发者服务器发送事件通知，通知游戏自行清理账号数据。
5. 若出现异常情况，将在如下提示框以红字提醒。建议点击“取消”并重新配置映射关系，若忽略异常情况点击“确定”继续提交申请，可能会造成映射关系审批不通过。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/7UYfeWBfQeil-jiaAiR4vQ/zh-cn_image_0000002613519379.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=CB38DE18CDB9996A220D6EF719FDAC51E486841A6C410C10E5E39F7B29C998F2)
6. 提交申请后，华为工作人员完成审核需要1-3个工作日，请耐心等待。APP ID映射关系生效后如需重新配置，请先提交映射关系的删除申请。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/7z0OzebKQFqYweu_KEMKfQ/zh-cn_image_0000002582959582.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=D889CDC336B9EAAF3F0EE1114DF7909CA08549E33EDCE3343BDA2BE8F1F54E07)

   配置/删除APP ID映射关系的审核结果将通过互动中心或邮件进行通知。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/KgnJewO6RjqfqRonsJE7sA/zh-cn_image_0000002583119508.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=2264032D66EB9238FDF434AA67363407387B06161347979113CE18690FE29F3C)

## 业务流程

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/pXOdPtW0SCyON2ic3x1NQw/zh-cn_image_0000002613639275.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=4B2BD84DB73CD19412AA883969334BDD173272AD333BD06C18A73AD15823DD03)
...
3. 游戏调用[on](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayeronplayerchanged>)接口注册事件监听。若监听到[PlayerChangedEvent](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#playerchangedevent>)事件，先清除本地缓存信息，再重新调用[unionLogin](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunionlogin>)登录逻辑，showLoginDialog设置为true，重新拉起联合登录面板。
4. 游戏调用[unionLogin](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunionlogin>)接口。

   说明

   建议使用session缓存登录状态，玩家下次登录进入游戏无需再调用[unionLogin](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunionlogin>)接口，但仍需调用[verifyLocalPlayer](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerverifylocalplayer>)接口。
5. 向玩家展示联合登录面板。
6. 玩家选择“华为账号登录”。
...
8. 【**异步流程**】玩家信息核验。建议在服务端校验玩家信息，若没有服务器，无需校验一致性。
   ...
   1. 游戏调用[createLoginWithHuaweiIDRequest](<../../../../../../../harmonyos-references/Account Kit（华为账号服务）/ArkTS API/authentication (华为账号应用统一认证服务)/account-api-authentication.md#createloginwithhuaweiidrequest>)接口，获取用于服务器校验的Authorization Code。

      说明

      Authorization Code只有5分钟有效期，且仅能使用一次，不可复用。
   2. 游戏向开发者服务器上传Authorization Code、gamePlayerId等信息。
   3. 开发者服务器携带Authorization Code，请求[获取用户级凭证](<../../../../../../../harmonyos-references/Account Kit（华为账号服务）/REST API/开放接口调用凭证/获取用户级凭证/account-api-obtain-user-token.md>)接口，获取Access Token。
   4. 开发者服务器携带Access Token，请求[获取玩家标识](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/REST API/获取玩家标识/gameservice-getplayerinfo.md>)接口，获取gamePlayerId。
   5. 开发者服务器把从华为游戏服务器获取的gamePlayerId与客户端获取的gamePlayerId进行一致性核验。若核验不通过，已通过合规校验进入游戏的玩家也需强制退出游戏。
9. 游戏调用[verifyLocalPlayer](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerverifylocalplayer>)接口，校验当前用户设备登录华为账号的实名认证、未成年人防沉迷信息。校验通过后，玩家进入游戏。若校验未通过请根据返回的[错误码](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/ArkTS API错误码/gameservice-error-code.md>)进行相应处理。
10. 若玩家在游戏内创建角色，建议游戏调用[savePlayerRole](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayersaveplayerrole>)上报角色信息。
...
| [on](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayeronplayerchanged>)(type: 'playerChanged', callback: Callback<PlayerChangedResult>): void | 玩家变化事件监听接口，通过Callback回调获取玩家变化结果信息。 |
| [unionLogin](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunionlogin>)(context: common.UIAbilityContext, loginParam: UnionLoginParam): Promise<UnionLoginResult> | 华为账号和游戏官方账号联合登录接口，通过Promise对象获取返回值。 |
...
| [savePlayerRole](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayersaveplayerrole>)(context: common.UIAbilityContext, request: GSKPlayerRole): Promise<void> | 保存角色信息到华为游戏服务器，使用默认的上下文信息，通过Promise对象获取返回值。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/LO_fWmoMQX2rtAE-rDuWzg/zh-cn_image_0000002613519381.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=BEB7111C7C21A8C5DC15B48D63024FC33FF942D2F6777B08BFD911D4C546505A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/IJrffqJlRh69ppiyxRQmwg/zh-cn_image_0000002582959584.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=25933697C57D2734D7CA5DE184D424D535AE3C19F7A054020B8F33EAD3EE1395)

若当前华为账号同意过游戏服务隐私协议，后续使用该华为账号登录的游戏将不会再弹出隐私协议窗口。

### 注册事件监听

调用[on](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayeronplayerchanged>)接口注册[PlayerChangedEvent](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#playerchangedevent>)事件监听，及时感知游戏过程中账号的变化。
...
| --- | --- | --- |
| 场景一 | 玩家点击“欢迎横幅->管理->切换”或者点击“欢迎横幅->管理->X”。  详情请参见[欢迎横幅管理游戏账号](gameservice-gameplayer-huawei.md#欢迎横幅管理游戏账号)。 | 若监听到账号变化，游戏应先清除本地缓存信息（session或其他用户缓存），再重新调用[unionLogin](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunionlogin>)接口（showLoginDialog设置为true），重新拉起联合登录面板。 |
| 场景二 | 用户在设备上切换华为账号后，游戏重启但没有调用unionLogin，直接调用verifyLocalPlayer。此时，verifyLocalPlayer接口会返回[1002000015](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/ArkTS API错误码/gameservice-error-code.md#section1002000015-当前玩家信息无效>)错误码，同时触发on回调。 | 若监听到账号变化，游戏应先清除本地缓存信息（session或其他用户缓存），再重新调用[unionLogin](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunionlogin>)接口（showLoginDialog设置为true），重新拉起联合登录面板。 |

### 展示联合登录面板

调用[unionLogin](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunionlogin>)接口，向玩家展示联合登录面板。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/XRByQ2XWR_2hJVoD-olWVA/zh-cn_image_0000002582959578.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=0FA171D17AF11FA4A18ABC15B9C1ADEE48186A76A9EA3D2A086CBAC2E83D49F0)

用户完成登录流程后，游戏顶部弹出欢迎横幅，并向游戏返回accountName（选择华为账号登录返回值为hw\_account）、accountIdentifier（选择华为账号登录返回值为hw\_account）、gamePlayerId等信息。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/JzxDJxrZT6-RxGs3STUh1A/zh-cn_image_0000002583119510.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=9C4D56F43873F16D660F53D2C2CC6CEFEF0CD9AC9AE431E5955B5299502B67DE)
...
由于[unionLogin](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunionlogin>)接口返回的gamePlayerId存在被篡改的风险，建议在开发者服务端核验玩家信息，即从开发者服务器获取gamePlayerId与[unionLogin](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunionlogin>)接口返回的gamePlayerId做比对，确保玩家信息一致性。若无服务器，无需校验一致性。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/YQjgOhCaTBOZJF5e18lYEg/zh-cn_image_0000002613639277.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=8516EB6896DD170DECE6DE549AE228258C61147991EC6FFBE18E00968205D1FF)

1. 调用[createLoginWithHuaweiIDRequest](<../../../../../../../harmonyos-references/Account Kit（华为账号服务）/ArkTS API/authentication (华为账号应用统一认证服务)/account-api-authentication.md#createloginwithhuaweiidrequest>)创建认证请求并设置参数。
   ...
   调用[AuthenticationController](<../../../../../../../harmonyos-references/Account Kit（华为账号服务）/ArkTS API/authentication (华为账号应用统一认证服务)/account-api-authentication.md#authenticationcontroller>)对象的[executeRequest](<../../../../../../../harmonyos-references/Account Kit（华为账号服务）/ArkTS API/authentication (华为账号应用统一认证服务)/account-api-authentication.md#executerequest>)方法执行认证请求，并在Callback中处理认证结果，获取到Authorization Code。
   ...
   23. }
   ```
2. 游戏向开发者服务器上传[unionLogin](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunionlogin>)接口返回的gamePlayerId。
3. 携带Authorization Code，请求[获取用户级凭证](<../../../../../../../harmonyos-references/Account Kit（华为账号服务）/REST API/开放接口调用凭证/获取用户级凭证/account-api-obtain-user-token.md>)接口，获取Access Token。

   说明

   由于Access Token的有效期仅为60分钟，当Access Token失效或者即将失效时（可通过[NSP\_STATUS错误码](<../../../../../../../harmonyos-references/Account Kit（华为账号服务）/REST API/开放接口调用凭证/解析凭证/account-api-get-token-info.md#错误码>)判断），可以使用Refresh Token（有效期180天）通过[获取用户级凭证](<../../../../../../../harmonyos-references/Account Kit（华为账号服务）/REST API/开放接口调用凭证/获取用户级凭证/account-api-obtain-user-token.md>)向华为账号服务器请求获取新的Access Token。
4. 携带Access Token，请求[获取玩家标识](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/REST API/获取玩家标识/gameservice-getplayerinfo.md>)接口，获取华为服务器侧的玩家标识gamePlayerId。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/cYJFM0axQO241fyZNd6KKg/zh-cn_image_0000002613519383.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=4E5D0D0628731A3CF3D69798760A43E140F8D296592877ECD22BC8F94D66DA7C)
...
调用[savePlayerRole](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayersaveplayerrole>)接口，将角色信息上报至华为游戏服务器。
...
1. 在[on](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayeronplayerchanged>)接口回调中清理游戏的登录缓存。
2. 在[on](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayeronplayerchanged>)接口回调中重新调用[unionLogin](<../../../../../../../harmonyos-references/Game Service Kit（游戏服务）/ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunionlogin>)接口，将**showLoginDialog**参数设置为**true**，即可强制拉起联合登录面板，允许玩家重新选择华为账号登录或游戏官方账号登录。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/5em_ZjVjTauwBeUuHWDdbw/zh-cn_image_0000002582959586.png?HW-CC-KV=V1&HW-CC-Date=20260601T070148Z&HW-CC-Expire=86400&HW-CC-Sign=F8E94516F30EF176AB8EB61AF83518EC1A913435F0C77B3D3C6AE14ACC195E38)
