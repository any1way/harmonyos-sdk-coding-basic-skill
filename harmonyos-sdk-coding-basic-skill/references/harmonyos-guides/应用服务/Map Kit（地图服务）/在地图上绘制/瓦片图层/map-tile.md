...
scraped_at: 2026-06-11T15:10:20+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:f01170e878236c04938a1a832734a2ef07cfb78597b82088fa4e7c374466ac64
---
## 场景介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6b/v3/V8-Uz38pTxGacg-t4XqwZw/zh-cn_image_0000002592219478.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T071019Z&HW-CC-Expire=86400&HW-CC-Sign=E700409C094989B0459599202082F04D86339B828FC48F0C8036C4737F2C31C8 "点击放大")

## 接口说明

瓦片图层功能主要由[TileOverlayParams](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#tileoverlayparams>)、[TileOverlayOptions](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#tileoverlayoptions>)、[addTileOverlay](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Class (MapComponentController)/map-map-mapcomponentcontroller.md#addtileoverlay>)和[TileOverlay](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (TileOverlay)/map-map-tileoverlay.md>)提供，更多接口及使用方法请参见[接口文档](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (TileOverlay)/map-map-tileoverlay.md>)。

| 接口名 | 描述 |
| --- | --- |
| [TileOverlayParams](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#tileoverlayparams>) | 瓦片图层参数。 |
| [TileOverlayOptions](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#tileoverlayoptions>) | 瓦片图层参数。 |
| [addTileOverlay](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Class (MapComponentController)/map-map-mapcomponentcontroller.md#addtileoverlay>)(params: [mapCommon.TileOverlayParams](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#tileoverlayparams>) | [mapCommon.TileOverlayOptions](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#tileoverlayoptions>)): [TileOverlay](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (TileOverlay)/map-map-tileoverlay.md>) | 为地图增加瓦片图层。 |
| [TileOverlay](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (TileOverlay)/map-map-tileoverlay.md>) | 瓦片图层，支持更新和查询相关属性。 |
