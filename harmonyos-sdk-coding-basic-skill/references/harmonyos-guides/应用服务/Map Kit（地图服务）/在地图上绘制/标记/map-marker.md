...
scraped_at: 2026-06-11T15:10:00+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:bfdda29bb03aa007484f5f5a211c8f14709fd17c4612d92073136c3f251fed51
---
## 场景介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/j3WShIemRhaNI6oym7rhWw/zh-cn_image_0000002622858903.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070956Z&HW-CC-Expire=86400&HW-CC-Sign=C58F6691F6C78353B7BB626ED3FA0442037DCFFBCB74ABB8E066D798A34D5EBE "点击放大")

## 接口说明

添加标记功能主要由[MarkerOptions](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#markeroptions>)、[addMarker](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Class (MapComponentController)/map-map-mapcomponentcontroller.md#addmarker>)和[Marker](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (Marker)/map-map-marker.md>)提供，更多接口及使用方法请参见[接口文档](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (Marker)/map-map-marker.md>)。

| 接口名 | 描述 |
| --- | --- |
| [MarkerOptions](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#markeroptions>) | 标记参数。 |
| [addMarker](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Class (MapComponentController)/map-map-mapcomponentcontroller.md#addmarker>)(options: [mapCommon.MarkerOptions](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#markeroptions>)): Promise<[Marker](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (Marker)/map-map-marker.md>)> | 在地图上添加标记。 |
| [Marker](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (Marker)/map-map-marker.md>) | 标记，支持更新和查询相关属性。 |
...
1. 导入相关模块。
   ...
   ```
2. 添加标记，在callback方法中创建初始化参数并新建[Marker](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (Marker)/map-map-marker.md>)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/0bO7rsz9SQG4BKkOznvJ8w/zh-cn_image_0000002622699023.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070956Z&HW-CC-Expire=86400&HW-CC-Sign=8599204F97D8C4149ABCFC14FC617355598E1E5BFDDCE3FA1713F7078317E6DA "点击放大")
...
通过在[MarkerOptions](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#markeroptions>)中将icon属性设置为自定义图标的资源，可将默认标记图标修改成自定义图标。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/45/v3/bioFqAtAQjyNYHTErlXrOw/zh-cn_image_0000002592219462.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070956Z&HW-CC-Expire=86400&HW-CC-Sign=86335D9E068A825D1B3C65CDE06690E5DD814125C81F061F7F04DDFCA7794EA0 "点击放大")

### 控制Marker文字显隐

通过[setAnnotationVisible](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (Marker)/map-map-marker.md#setannotationvisible>)方法可以控制Marker文字显隐，还可以通过[isAnnotationVisible](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (Marker)/map-map-marker.md#isannotationvisible>)方法来获取Marker文字显隐的状态。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/tDVNl4knR3C4ihajH8l9wg/zh-cn_image_0000002592379396.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070956Z&HW-CC-Expire=86400&HW-CC-Sign=2ECFE82AFE3D01DD32A59F565080CB6D3965C43A7E58598076DC6FFC57AF2176 "点击放大")

**图2** 隐藏Marker文字之后

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/1_WLILm1STehTiK1J5jMVA/zh-cn_image_0000002622858905.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070956Z&HW-CC-Expire=86400&HW-CC-Sign=092EC3F21A31F6BE22D1FA3821A90C81F575B4A84D5C27217BF468C17FE6F8E1 "点击放大")

### 碰撞检测

通过在[MarkerOptions](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#markeroptions>)中设置collisionRule属性，可以设置标记的冲突处理规则。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/CRpIoSivTiy8Eqo6M-U4zw/zh-cn_image_0000002622699025.gif?HW-CC-KV=V1&HW-CC-Date=20260611T070956Z&HW-CC-Expire=86400&HW-CC-Sign=2722DED64D0378A5A8C1EF677629B255E52204C1E4C3AD1DB5DC10787F7EF9BE "点击放大")
...
1. 将[Marker](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (Marker)/map-map-marker.md>)的拖拽属性设置为true。
2. 调用[on(type: 'markerDragStart' , callback: Callback<Marker>)](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (MapEventManager)/map-map-mapeventmanager.md#onmarkerdragstart>)方法监听标记是否开始拖拽。
3. 调用[on(type: 'markerDrag' , callback: Callback<Marker>)](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (MapEventManager)/map-map-mapeventmanager.md#onmarkerdrag>)，监听标记拖动过程。
4. 调用[on(type: 'markerDragEnd' , callback: Callback<Marker>)](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (MapEventManager)/map-map-mapeventmanager.md#onmarkerdragend>)，监听标记拖动结束事件。
...
```
1. let callback = (markerLong: map.Marker) => {
2. console.info("markerLongClick", `callback markerLongClick = ${markerLong.getId()}`);
3. };
4. this.mapEventManager.onMarkerLongClick(callback);
```
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/sKMFOEJwQJetSlZluHx0RA/zh-cn_image_0000002592219464.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070956Z&HW-CC-Expire=86400&HW-CC-Sign=BC2B48413E22B25FCA7375E294D2A02FDC5BE97B468C6F6757F291F1B47C7B19 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c9/v3/N5cTwrMBRsybxxnQdZiyYg/zh-cn_image_0000002592379398.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070956Z&HW-CC-Expire=86400&HW-CC-Sign=38F0983CC5E830D38CB6C8C64438A1E5AE7C2A116630FAA5CF78A848A6B9C48B "点击放大")
...
| 接口名 | 描述 |
| --- | --- |
| [AlphaAnimation](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Class (AlphaAnimation)/map-map-alphaanimation.md>) | 控制透明度的动画类。 |
| [RotateAnimation](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Class (RotateAnimation)/map-map-rotateanimation.md>) | 控制旋转的动画类。 |
| [ScaleAnimation](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Class (ScaleAnimation)/map-map-scaleanimation.md>) | 控制缩放的动画类。 |
| [TranslateAnimation](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Class (TranslateAnimation)/map-map-translateanimation.md>) | 控制平移的动画类。 |
| [PlayImageAnimation](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Class (PlayImageAnimation)/map-map-playimageanimation.md>) | 控制多张图片的动画类。 |
| [AnimationSet](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Class (AnimationSet)/map-map-animationset.md>) | 动画集合。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/RmPVDpbZTxitg9YiRP-8DA/zh-cn_image_0000002622858907.gif?HW-CC-KV=V1&HW-CC-Date=20260611T070956Z&HW-CC-Expire=86400&HW-CC-Sign=BE120F05E51E31729DC8C9EF3FB8C385A969C70754624D197DA54B1AFD77FBAE "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/fyrXOwQJRae0GcB2oJOuRw/zh-cn_image_0000002622699027.gif?HW-CC-KV=V1&HW-CC-Date=20260611T070956Z&HW-CC-Expire=86400&HW-CC-Sign=D817842B0A5AC66AB6EA609E13E2069BAAC19E8ECF2E1253BE7CEFF53BB5C8FE "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/tcxq7ZelT9eaWHzLOfUhow/zh-cn_image_0000002592219466.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070956Z&HW-CC-Expire=86400&HW-CC-Sign=1907600488FDC2401BCE57F5C92CA7D944FBA9BEFFC827BE4A1E4DEB6ABAF877 "点击放大")
