...
content_hash: sha256:c5ee98c4012bf70e9e10c0221b2e5b96470bff411dce016bed7bfba36ee2c6f6
---
## 场景介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/fWvPNRFuSMm_cLFZ-h7nVA/zh-cn_image_0000002622699041.gif?HW-CC-KV=V1&HW-CC-Date=20260611T071022Z&HW-CC-Expire=86400&HW-CC-Sign=F7653F35B837818E1C9B04BEB95742E9264F33DAF0F96EF2D33C6D40E90B9AFB "点击放大")

## 接口说明

流场图层功能主要由[FlowFieldOverlayParams](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#flowfieldoverlayparams>)、[addFlowFieldOverlay](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Class (MapComponentController)/map-map-mapcomponentcontroller.md#addflowfieldoverlay>)和[FlowFieldOverlay](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (FlowFieldOverlay)/map-map-flowfieldoverlay.md>)提供，更多接口及使用方法请参见[接口文档](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (FlowFieldOverlay)/map-map-flowfieldoverlay.md>)。

| 接口名 | 描述 |
| --- | --- |
| [FlowFieldOverlayParams](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#flowfieldoverlayparams>) | 流场覆盖物参数。 |
| [addFlowFieldOverlay](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Class (MapComponentController)/map-map-mapcomponentcontroller.md#addflowfieldoverlay>)(params: mapCommon.[FlowFieldOverlayParams](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#flowfieldoverlayparams>)): Promise<[FlowFieldOverlay](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (FlowFieldOverlay)/map-map-flowfieldoverlay.md>)> | 新增流场覆盖物。 |
| [FlowFieldOverlay](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/map（地图显示功能）/Interface (FlowFieldOverlay)/map-map-flowfieldoverlay.md>) | 流场覆盖物管理对象。 |
...
[FlowFieldOverlayParams](<../../../../../harmonyos-references/Map Kit（地图服务）/ArkTS API/mapCommon（地图属性模型）/map-common.md#flowfieldoverlayparams>)类的data参数格式为GRIB2规范的json数据。GRIB2是一种由世界气象组织（WMO）定义的二进制数据格式，主要用于存储和传输气象和气候数据。
