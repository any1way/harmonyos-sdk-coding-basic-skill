...
content_hash: sha256:ec7b24c2da4743e9734030a1358dbbe8954098512fa811d4ab41f766afc942ac
---
1. 加签私钥和上传到商户平台的公钥是否配对。
2. 排查待加签字符串是否正确拼接。 对象内的待加签字段需要排序后再拼接。对象内的嵌套的下一级对象也需要排序后再拼接。具体示例参考[签名规则](<../../../../../harmonyos-references/Payment Kit（鸿蒙支付服务）/REST API/公共说明/payment-rest-overview.md#签名规则>)。
