...
scraped_at: 2026-06-11T15:15:44+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:ba178c2e0411b74b4df13413fa4fecd60e7b7923d5206e8fb48dc82af3411c33
---
数字车钥匙开通完成后，车主APP可以通过车控指令远程控制车辆的开门等操作。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1b/v3/f62ZMlaiQIigMOASIYzAVQ/zh-cn_image_0000002592379572.png?HW-CC-KV=V1&HW-CC-Date=20260611T071543Z&HW-CC-Expire=86400&HW-CC-Sign=A4C628C664C5EB07A79DC365F7BC0C9406D4179072767AD6044A792D5350B862)

典型的交互流程如下:

* 通过[queryICCEConnectionState](<../../../../../harmonyos-references/Wallet Kit（钱包服务）/ArkTS API/walletPass（Pass卡片能力）/wallet-walletpass.md#queryicceconnectionstate>)接口检查车控蓝牙的连接状态，如果未连接则使用[startICCEConnection](<../../../../../harmonyos-references/Wallet Kit（钱包服务）/ArkTS API/walletPass（Pass卡片能力）/wallet-walletpass.md#starticceconnection>)主动连接。
* 通过[registerICCEListener](<../../../../../harmonyos-references/Wallet Kit（钱包服务）/ArkTS API/walletPass（Pass卡片能力）/wallet-walletpass.md#registericcelistener>)注册监听，接收华为钱包发送的消息。
* 车主APP可以通过[sendICCERKEMessage](<../../../../../harmonyos-references/Wallet Kit（钱包服务）/ArkTS API/walletPass（Pass卡片能力）/wallet-walletpass.md#sendiccerkemessage>)接口发送车控指令。
* 用户退出数字钥匙车控页面，通过[unregisterICCEListener](<../../../../../harmonyos-references/Wallet Kit（钱包服务）/ArkTS API/walletPass（Pass卡片能力）/wallet-walletpass.md#unregistericcelistener>)接口取消监听。

## 开发步骤

1. 车主APP使用[创建Wallet Kit服务](<../../创建Wallet Kit服务/wallet-preparations.md>)时注册的服务号和[申请钥匙卡片](<../../../../../harmonyos-references/Wallet Kit（钱包服务）/REST API/数字车钥匙接口/wallet-rest-api-carkey.md#申请钥匙卡片>)时定义的卡券唯一标识，通过[queryICCEConnectionState](<../../../../../harmonyos-references/Wallet Kit（钱包服务）/ArkTS API/walletPass（Pass卡片能力）/wallet-walletpass.md#queryicceconnectionstate>)判断车钥匙的蓝牙链路状态。
   ...
   29. }
   ```
2. 如果[queryICCEConnectionState](<../../../../../harmonyos-references/Wallet Kit（钱包服务）/ArkTS API/walletPass（Pass卡片能力）/wallet-walletpass.md#queryicceconnectionstate>)接口返回连接状态connectionState为未配对0时，需要调用[startICCEConnection](<../../../../../harmonyos-references/Wallet Kit（钱包服务）/ArkTS API/walletPass（Pass卡片能力）/wallet-walletpass.md#starticceconnection>)主动创建蓝牙链接。
   ...
   29. }
   ```
3. 车主APP通过[registerICCEListener](<../../../../../harmonyos-references/Wallet Kit（钱包服务）/ArkTS API/walletPass（Pass卡片能力）/wallet-walletpass.md#registericcelistener>)注册监听华为钱包发送的消息。
   ...
   44. }
   ```
4. 车主APP通过[sendICCERKEMessage](<../../../../../harmonyos-references/Wallet Kit（钱包服务）/ArkTS API/walletPass（Pass卡片能力）/wallet-walletpass.md#sendiccerkemessage>)接口发送车控指令。
   ...
   34. }
   ```
5. 用户退出数字钥匙车控页面，车主APP通过[unregisterICCEListener](<../../../../../harmonyos-references/Wallet Kit（钱包服务）/ArkTS API/walletPass（Pass卡片能力）/wallet-walletpass.md#unregistericcelistener>)接口取消监听。
