...
scraped_at: 2026-06-11T15:09:15+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:787cf9fee6cef3f05a884b1f3a11dcaa3c54d3d22db0d6f9a3d95ac52d9ac62b
---
## 简介

开发者可以通过[liveViewManager](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md>)模块构建本地实况窗，完成实况窗的整个生命周期流程（包括创建、更新与结束）。请注意，只有应用在前台运行，即用户实际使用应用并且产生了服务合约的情况下，开发者才可以创建实况窗；与此同时，本地更新或结束实况窗依赖于开发者的应用进程，所以我们更推荐开发者在本地创建实况窗后使用Push Kit更新或结束实况窗。
...
在项目中导入[liveViewManager](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md>)，并新建实况窗控制类（例如LiveViewController），构造isLiveViewEnabled()方法，用于校验实况窗开关（设置>应用和元服务>应用名>实况窗）是否打开。打开实况窗开关是创建实况窗的前提条件。示例代码如下：
...
调用[liveViewManager.startLiveView](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveviewmanagerstartliveview>)创建实况窗，该API接口传入参数为实况窗实例（liveViewManager.[LiveView](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveview>)）。

### 进度可视化模板

进度可视化模板适用于打车、外卖等场景。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/OssBfY1ZRUynAO9IxCmbcA/zh-cn_image_0000002592379348.png?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=B4A239B6AE2B50CD9DB34127AEF088DC26ED43FA46B6BD2DD54D39B2621175B0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/1_PnTpuwSJyw5WxbMfdLCQ/zh-cn_image_0000002622858857.png?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=4A3AEA0600BA06048C02583398DD4A86B167D4AE393C090669871FA86C19DC9E)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bf/v3/v2KLbVRZSQeePlKJcm_Avw/zh-cn_image_0000002622698977.png?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=13A496BA3938BE32626675BF1D63336C736A9A46575DDECA9B04A35123C82964)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/3tnp_dDoR3iCH-c2UlV5sQ/zh-cn_image_0000002592219416.png?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=38138A9899286EFB39F90553E1136C7F1548933A1C1D87D578956CBD8FD476D5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/oRwfB_z8SpWoEinTKaJNFQ/zh-cn_image_0000002592379350.png?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=53A9A16A983A8F38465428C8D82B15D9C9E1C78208ABDE25A14B332CC5CB2D81)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/gjsrBFXITyaYMP8WhhhEAg/zh-cn_image_0000002622858859.png?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=14F857B7012053ACFCD7EB334E1CBF6C7878EDE9D721FA044E2262E9B456246A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/RcE1RUOMSSGEpAokKCPGuQ/zh-cn_image_0000002622698979.png?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=FECE2112B507F4A01127E6C2D9A759C569A5AAFC5FA4132C97FCCBBF838604BA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/6Z8vbUoeQgWygG4QwzeXmw/zh-cn_image_0000002592219418.gif?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=65A89CA0D362033858D8264283CFBB2286974AE1F866E858518D3AC6ADEBBEC7)
...
16. return {
17. id : 6, // 实况窗ID，开发者生成。
18. event : "FLIGHT", // 实况窗的应用场景。FLIGHT：航班。
19. liveViewData : {
20. primary : {
21. title : "计划出发",
22. content : [
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/EzC9BCIaTGmNEuUx1wPOAw/zh-cn_image_0000002592379352.png?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=5298CB283831FBB0624E88DBED46CDDD555C39B1E9D5B540B30073E89DA34F47)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/FYA4ZpPeSMq1si7xIv-GfA/zh-cn_image_0000002622858861.png?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=DC75A067410DC94AA11E1B750FA97F856DC5214C67604AC04C22499B575A9492)
...
* 进入地理围栏。
* 离开地理围栏。
* 进入地理围栏并持续时间大于[geofence](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#geofence>).delayTime（延迟触发时间）。
* 离开地理围栏并持续时间大于[geofence](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#geofence>).delayTime（延迟触发时间）。
...
34. ];
35. // 构建延迟触发条件
36. const trigger = await LiveViewController.buildTrigger();
37. trigger.condition.monitorEvent = liveViewManager.MonitorEvent.MONITOR_TYPE_LEAVE;
38. // 注册基于地理位置触发结束的实况窗
39. return await liveViewManager.stopLiveViewByTrigger(defaultView, trigger);
40. }

42. private static async buildDefaultView(): Promise<liveViewManager.LiveView> {
43. return {
44. // 构造实况窗请求体
45. id: 0, // 实况窗ID，开发者生成。
46. event: "EXPRESS", // 实况窗的应用场景。EXPRESS：快递。
47. liveViewData: {
48. primary: {
49. title: "快递已送达",
50. content: [
51. { text: "请前往" },
52. { text: " XXX店 ", textColor: "#FF0A59F7" },
53. { text: "取快递" },
54. ],
55. keepTime: 15,
56. clickAction: await LiveViewController.buildWantAgent(),
57. layoutData: {
58. layoutType: liveViewManager.LayoutType.LAYOUT_TYPE_PICKUP,
59. title: "快递码",
60. content: "72988",
61. underlineColor: "#FF0A59F7",
62. descPic: "express.png" // 扩展区右侧产品描述图，取值为“/resources/rawfile”路径下的文件名或image.PixelMap
63. }
64. }
65. }
66. };
...
69. private static async buildTrigger(): Promise<liveViewManager.Trigger> {
70. return {
71. // 构造基于地理位置的实况窗提醒的触发条件
72. type: liveViewManager.TriggerType.TRIGGER_TYPE_GEOFENCE,
73. displayTime: 15,
74. condition: {
75. // 触发条件：设备进入坐标点半径2000米范围内
76. longitude: 116.3971356415625,
77. latitude: 39.91800603311188,
78. coordinateSystemType: liveViewManager.CoordinateSystemType.COORDINATE_TYPE_GCJ02,
79. monitorEvent: liveViewManager.MonitorEvent.MONITOR_TYPE_ENTRY,
80. radius: 2000,
81. delayTime: 0
82. }
83. }
...
86. private static async isLiveViewEnabled(): Promise<boolean> {
87. return await liveViewManager.isLiveViewEnabled();
88. }

90. private static async isGeofenceTriggerEnabled(): Promise<boolean> {
91. return await liveViewManager.isGeofenceTriggerEnabled();
92. }

94. private static async buildWantAgent(): Promise<Want> {
95. const wantAgentInfo: wantAgent.WantAgentInfo = {
96. wants: [
97. {
98. bundleName: 'xxx.xxx.xxx', // 应用实际bundleName
99. abilityName: 'EntryAbility'
100. } as Want
101. ],
102. actionType: wantAgent.OperationType.START_ABILITIES,
103. requestCode: 0,
104. actionFlags: [wantAgent.WantAgentFlags.UPDATE_PRESENT_FLAG]
105. };
106. const agent = await wantAgent.getWantAgent(wantAgentInfo);
107. return agent;
108. }
109. }
```
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/g8qRh4JVTzm0hg07GC80Gg/zh-cn_image_0000002622698981.png?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=D888ED567240AA8D7FF6631E9C3BDF3F5C944ED46EA6CDE5745762745AFA9182)

说明

胶囊形态各模板参数固定，与创建实况窗时的模板类型无关。可创建的胶囊类型有：文本胶囊、计时器胶囊、进度胶囊，详情请参见[CapsuleData](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#capsuledata>)。

除了实况窗卡片形态，开发者还需考虑实况窗胶囊形态的展示效果。若开发者创建实况窗时还想同步创建实况窗胶囊，则需在liveViewManager.[LiveView](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveview>)（结构体）中携带胶囊所需的参数liveViewData.[capsule](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveviewdata>)（不同胶囊类型携带不同的参数）。示例代码如下：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/kgLMtX_dRJGa_lq3E7jrFQ/zh-cn_image_0000002592219420.png?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=A41041D126CC9144649916CF5422CEC33B8A8E1829986BD1DC72077CA86F6F85)

外屏实况窗适用于在小折叠屏的外屏显示实况窗的简要信息，方便用户可以在折叠状态便捷查看。

若开发者创建实况窗时需要同步创建，则需在liveViewManager.[LiveView](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveview>)（结构体）中携带外屏所需的参数liveViewData.[external](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveviewdata>)。示例代码如下：
...
开发者若需要使用实况窗计时器，则需在liveViewManager.[LiveView](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveview>)（结构体）中配置[timer](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveview>)字段，并在当前支持的字段中使用占位符：**${placeholder.timer}**。

例如：固定区的文本内容中使用占位符，系统将替代占位符为实况窗计时器。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/c_yxiiwmSDekJrbg1xnJ4g/zh-cn_image_0000002592379354.png?HW-CC-KV=V1&HW-CC-Date=20260611T070913Z&HW-CC-Expire=86400&HW-CC-Sign=56346B0D773C70EAA0C6624E571C222A8F3924003CDD27D1A37146C9537A103D)
...
请调用wantAgent.[getWantAgent](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantAgent (WantAgent模块)/js-apis-app-ability-wantagent.md#wantagentgetwantagent-1>)()构造点击动作字段所需的参数值，当前实况窗支持的点击动作如下：

* 点击实况窗的默认动作：在liveViewManager.[LiveView](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveview>)（结构体）中携带胶囊所需的参数liveViewData.primary.[clickAction](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#primarydata>)字段。
* 点击辅助区的跳转动作：在liveViewManager.[LiveView](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveview>)（结构体）中携带胶囊所需的参数liveViewData.primary.extensionData.[clickAction](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#extensiondata>)字段。

## 本地更新和结束实况窗

调用[liveViewManager.isLiveViewEnabled](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveviewmanagerisliveviewenabled>)()确认实况窗开关打开后，调用liveViewManager的[updateLiveView](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveviewmanagerupdateliveview>)更新实况窗，调用[stopLiveView](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md#liveviewmanagerstopliveview>)结束实况窗。更新时需要修改请求体中对应的参数。示例代码如下：
...
更详细的参数请参考[Live View Kit ArkTS API参考](<../../../../../harmonyos-references/Live View Kit（实况窗服务）/ArkTS API/liveViewManager/liveview-liveviewmanager.md>)。

说明

以上是应用在本地创建、更新和结束实况窗通知的全部流程。此外，应用也可以通过Push Kit实现远程[创建、更新和结束实况窗消息](<../../../Push Kit（推送服务）/推送场景化消息/推送实况窗消息/push-update-liveview.md>)。
