...
content_hash: sha256:ad0be6b839e4a62aa667773691e2cb2e2a20f86c807f5515b9b743cae3c81265
---
## 场景介绍
...
2. 构造分享数据，可添加多条分享记录。
   ...
   13. });
   ```
3. 启动分享面板，并配置不显示打印快捷操作。如需屏蔽其他系统级快捷操作，请参考[ShareAbilityType](<../../../../../../harmonyos-references/Share Kit（分享服务）/ArkTS API/systemShare（分享）/share-system-share.md#shareabilitytype>)介绍。
