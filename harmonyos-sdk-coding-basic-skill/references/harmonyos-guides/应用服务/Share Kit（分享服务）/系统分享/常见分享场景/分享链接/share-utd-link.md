...
scraped_at: 2026-06-11T15:15:15+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:57b6a314973b7efb0210ef8178beeed1fb36f241fdb15d04758aa5573211c27a
---
## 分享App Linking直达应用

使用App Linking分享应用，目标设备接收后可直达应用，参见：[使用App Linking实现应用间跳转](<../../../../../应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/应用间跳转/拉起指定应用/使用App Linking实现应用间跳转/app-linking-startup.md>)。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/eR7kWlofQPOzvT64u2tTgg/zh-cn_image_0000002622859057.png?HW-CC-KV=V1&HW-CC-Date=20260611T071514Z&HW-CC-Expire=86400&HW-CC-Sign=62941127203C30DED0142FB9B0E2444F9929898E0C67C55BF057E0693672D409)
...
2. 在应用配置文件（src/main/module.json5）的[skills](../../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#skills标签)配置中增加关联配置。参见：[声明应用关联的网站域名](<../../../../App Linking Kit（应用链接服务）/通过App Linking应用链接拉起指定应用/app-linking-startupapp.md#在modulejson5中配置关联的网址域名>)。
3. 使用App Linking发起系统分享。
   ...
   49. }
   ```
4. 目标应用处理App Linking。参见：[拉起方实现跳转指导](<../../../../App Linking Kit（应用链接服务）/通过App Linking应用链接拉起指定应用/app-linking-startupapp.md#处理传入的链接>)。
