...
scraped_at: 2026-06-11T15:15:27+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:8adaff7945fed5e4dd4cc205d2054586997083148f6f0f6bb43b465609fd980b
---
...
* 若类型不匹配，则跳过已注册的沙箱接口能力，采用华为分享默认逻辑接收文件数据。参考：[目标设备接收分享数据一步直达体验](<../../../Share Kit体验规范/目标设备接收分享数据一步直达体验/share-access-one-step.md>)。
...
当本次沙箱接收回调触发时，如果应用因为业务实现需要拒绝本次接收时，可使用[ReceivableTarget.reject()](<../../../../../../harmonyos-references/Share Kit（分享服务）/ArkTS API/harmonyShare（华为分享）/share-harmony-share.md#reject-1>)方法拒绝本次接收。
