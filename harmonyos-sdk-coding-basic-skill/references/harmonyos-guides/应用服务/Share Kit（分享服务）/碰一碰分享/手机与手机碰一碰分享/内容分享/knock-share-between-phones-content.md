...
scraped_at: 2026-06-11T15:15:21+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:8a95ac2ffe6132de5a121870d594542756302d26b1969679f103c02aaec94654
---
## 注册碰一碰事件
...
* 文本提示**可碰一碰分享至 HarmonyOS 5 及以上版本手机**。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/6tdGPSo1SLWsvdeb5p1-fA/zh-cn_image_0000002592219618.png?HW-CC-KV=V1&HW-CC-Date=20260611T071520Z&HW-CC-Expire=86400&HW-CC-Sign=B5C1B6A00FEC94C3571A50618FD3CE506845FA84CD8349A79F2ED35FA71599CE)
* 动图提示**可碰一碰分享**。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/vbWKQswiQB6WnenEwg_ICQ/zh-cn_image_0000002592379552.png?HW-CC-KV=V1&HW-CC-Date=20260611T071520Z&HW-CC-Expire=86400&HW-CC-Sign=6A7ABBC67B67CEEFFAFA96BF47A0AD5258FC9AEB5F64CF644D18E7C807C7F322)
...
3. 待云端存储的图片下载完成时，调用[sharableTarget.updateShareData](<../../../../../../harmonyos-references/Share Kit（分享服务）/ArkTS API/harmonyShare（华为分享）/share-harmony-share.md#updatesharedata>)接口更新预览图信息。
...
通过链接形式指定应用跳转，通常有2种方式：[使用App Linking实现应用间跳转](<../../../../../应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/应用间跳转/拉起指定应用/使用App Linking实现应用间跳转/app-linking-startup.md>)和[使用Deep Linking实现应用间跳转](<../../../../../应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/应用间跳转/拉起指定应用/使用Deep Linking实现应用间跳转/deep-linking-startup.md>)。
...
结合[App Linking Kit（应用链接服务）](<../../../../App Linking Kit（应用链接服务）/App Linking Kit简介/applinking-introduction.md>)能力，在指定应用未安装时，可实现直达应用市场等能力，进一步提升用户体验。

* 当应用已安装时，App Linking可直接拉起应用。
* 当应用未安装时，App Linking的默认行为是通过系统浏览器打开链接对应的网页。通过App Linking Kit的直达应用市场能力，可以实现在应用未安装时直接跳转应用市场。详情参见：[直达应用市场能力](<../../../../App Linking Kit（应用链接服务）/通过直达应用市场能力跳转至应用市场下载详情页/applinking-direct-to-ag.md>)。配合[延迟链接能力](<../../../../App Linking Kit（应用链接服务）/通过延迟链接跳转至应用详情页/applinking-deferredlink.md>)，即便触发碰一碰分享时应用未安装，待下载启动后仍能获取之前分享的链接，提升了用户体验，也提升了链接转换率。
...
进入需要分享的页面，通过[harmonyShare.on('knockShare')](<../../../../../../harmonyos-references/Share Kit（分享服务）/ArkTS API/harmonyShare（华为分享）/share-harmony-share.md#onknockshare>)注册碰一碰分享事件，当宿主应用接收到系统发出的碰一碰事件回调时，可能由于某些原因无法发起分享，此时为保证用户体验，需及时终止分享，避免用户的长时间等待。

根据应用的实际场景，参考以下方式处理：

### 当前界面无可分享内容

从6.0.2(22)版本开始，当前界面的内容不支持碰一碰分享时，开发者可通过[sharableTarget.clarifyNonShare()](<../../../../../../harmonyos-references/Share Kit（分享服务）/ArkTS API/harmonyShare（华为分享）/share-harmony-share.md#clarifynonshare>)终止本次分享，并引导用户前往可分享界面再次尝试。

效果图：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/QCyOaglHRDmOScqtCemstA/zh-cn_image_0000002592379556.png?HW-CC-KV=V1&HW-CC-Date=20260611T071520Z&HW-CC-Expire=86400&HW-CC-Sign=EC927D75C21C241A39AC480CFD4669F7F8DEDC882DD5E3F31ABFC48892A81AF2)
...
从5.0.3(15)版本开始，由于网络或者业务原因无法发起分享时，开发者可通过[sharableTarget.reject()](<../../../../../../harmonyos-references/Share Kit（分享服务）/ArkTS API/harmonyShare（华为分享）/share-harmony-share.md#reject>)终止本次分享，并提示用户终止的原因。
