...
scraped_at: 2026-06-11T15:15:23+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:fb13c3154a681235d5a90051a5e9c0c08381c69dfe95209cac64e18b71af4723
---
## 注册碰一碰事件
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/5iet05hoTsWXyOSsmavOVQ/zh-cn_image_0000002622859065.png?HW-CC-KV=V1&HW-CC-Date=20260611T071522Z&HW-CC-Expire=86400&HW-CC-Sign=3E4F9785574B2BC16DDF3D5425B3EE6F7BDCEF301AF59D541FF010096770BA04)

**图2** 竖屏应用示例

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/IKipuOWrTdmgz-ZV2lVdpw/zh-cn_image_0000002622699185.png?HW-CC-KV=V1&HW-CC-Date=20260611T071522Z&HW-CC-Expire=86400&HW-CC-Sign=69CA6227654437374BBB0D380F1D70C388B0DA3D793C2358B4AECC1EDB3427BD)

## 注册单向分享能力

通过碰一碰分享邀请好友加入组队房间，若双方都同时在组队房间内互相邀请，无法相互加入对方的组队房间。

针对以上场景，Share Kit提供单向仅发送能力。参考：[SendCapabilityRegistry](<../../../../../../harmonyos-references/Share Kit（分享服务）/ArkTS API/harmonyShare（华为分享）/share-harmony-share.md#sendcapabilityregistry>)的sendOnly属性。
...
预览图设置参考：[设置分享预览](../内容分享/knock-share-between-phones-content.md#设置分享预览)。

## 处理组队链接

当目标应用被分享拉起时，可以通过[onCreate](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#oncreate>)或[onNewWant](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onnewwant>)回调中获取传入的want参数。其中want.uri字段为邀请组队的链接，通过链接上携带的参数信息，处理组队邀请的业务逻辑。
...
参考：[异常场景终止分享](../内容分享/knock-share-between-phones-content.md#异常场景需终止分享)。
