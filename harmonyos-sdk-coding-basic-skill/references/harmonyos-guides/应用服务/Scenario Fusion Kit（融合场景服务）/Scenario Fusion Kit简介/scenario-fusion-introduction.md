...
content_hash: sha256:2f73d56ecbc5610c246352ea39ed4e79720734ca4ee6cf67599593da5d9be7d3
---
...
| 场景化API | 请参见[支持的国家/地区](../附录/支持的国家地区/scenario-fusion-appendix-support-regions.md)。 |
...
* 本Kit支持模拟器开发，通用差异可参考[模拟器与真机的差异](../../../编写与调试应用/使用模拟器运行应用/概述/模拟器与真机的差异/ide-emulator-specification.md#section1227613205203)。
