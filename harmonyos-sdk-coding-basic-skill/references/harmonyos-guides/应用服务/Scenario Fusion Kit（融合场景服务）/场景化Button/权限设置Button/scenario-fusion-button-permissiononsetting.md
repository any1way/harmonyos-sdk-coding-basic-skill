...
scraped_at: 2026-06-01T15:10:23+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:439d590abe7a02e95190e5b229add0d84ddae3f62a42b0b50fcdd4aa30ba8bc4
---
## 场景介绍
...
在调用此接口前，应用需要先调用[requestPermissionsFromUser](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.abilityAccessCtrl (程序访问控制管理)/js-apis-abilityaccessctrl.md#requestpermissionsfromuser9>)，如果用户在首次权限设置弹框时已授权，调用当前接口将无法拉起二次授权页面。

## 前提条件

* 调用[requestPermissionsFromUser](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.abilityAccessCtrl (程序访问控制管理)/js-apis-abilityaccessctrl.md#requestpermissionsfromuser9>)接口，用户在首次权限设置弹框时拒绝授权。
* 参见[开发准备](../../开发准备/scenario-fusion-preparations.md)。
