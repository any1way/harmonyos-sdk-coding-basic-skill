...
scraped_at: 2026-06-01T15:10:18+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:4153129d61381371c5be92579b321064f3482b63e3835ee9747eab7a3819cf5b
---
## 场景介绍

选择头像Button功能可以帮助开发者调用对应Button组件快速拉起头像选择页面，供用户完成华为账号头像或其他头像的选择与展示。

运行示例代码单击头像按钮，拉起选择头像页面来设置头像（完整场景可参考[获取头像昵称](<../../../Account Kit（华为账号服务）/获取华为账号用户信息/获取头像昵称/account-get-avatar-nickname.md>)）。

## 前提条件

参见[开发前提](<../../../Account Kit（华为账号服务）/获取华为账号用户信息/获取头像昵称/account-get-avatar-nickname.md#开发前提>)。
