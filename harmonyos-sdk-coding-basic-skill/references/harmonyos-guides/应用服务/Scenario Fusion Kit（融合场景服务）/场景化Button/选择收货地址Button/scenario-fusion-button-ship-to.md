...
scraped_at: 2026-06-01T15:10:20+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:f4c8b04d1caf87afa1232353328e03e33e93d1433b3600aba11b17ac77671c12
---
## 场景介绍

选择收货地址Button功能可以帮助开发者调用对应Button组件快速拉起地址选择页面，并返回用户选择的收货地址。

运行示例代码单击“选择收货地址”按钮，拉起选择地址页面选择已保存的地址，也可单击“管理/新增收货地址”进入添加收货地址页面（完整场景可参考[获取收货地址](<../../../Account Kit（华为账号服务）/获取华为账号用户信息/获取收货地址/account-choose-address-dev.md>)）。

## 前提条件

参见[开发前提](<../../../Account Kit（华为账号服务）/获取华为账号用户信息/获取收货地址/account-choose-address-dev.md#开发前提>)。
