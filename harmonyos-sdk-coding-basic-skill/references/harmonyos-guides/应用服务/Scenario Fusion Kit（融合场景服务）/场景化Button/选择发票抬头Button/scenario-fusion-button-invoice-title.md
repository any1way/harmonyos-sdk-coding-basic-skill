...
scraped_at: 2026-06-01T15:10:21+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:31b7d168ab3c8a603ea170a0d99b82112f6a0f1ef100e6fb0479843561760e12
---
## 场景介绍

选择发票抬头Button功能可以帮助开发者调用对应Button组件跳转发票抬头选择页面，供用户完成已保存发票抬头的选择。

运行示例代码单击“选择发票抬头”按钮，拉起选择发票抬头页面可选择已保存发票，也可单击“管理发票抬头”进入新增企业/个人发票抬头页面（完整场景请参考[获取发票抬头](<../../../Account Kit（华为账号服务）/获取华为账号用户信息/获取发票抬头/account-select-invoice-title.md>)）。

## 前提条件

参见[开发前提](<../../../Account Kit（华为账号服务）/获取华为账号用户信息/获取发票抬头/account-select-invoice-title.md#开发前提>)。
