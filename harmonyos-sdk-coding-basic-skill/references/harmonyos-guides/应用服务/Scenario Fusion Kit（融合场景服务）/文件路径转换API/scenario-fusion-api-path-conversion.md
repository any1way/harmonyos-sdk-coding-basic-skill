...
scraped_at: 2026-06-01T15:10:31+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:7e874aa2a706d7c5dba011a0cf84b35eacc208ea00cff8ac0348052dedd01bf3
---
## 场景介绍
...
以下是获取转换文件uri信息的接口说明，更多接口及使用方法请参见[fileUriService（文件路径转换API）](<../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/fileUriService（文件路径转换API）/scenario-fusion-fileuriresult.md>)。

| 接口名 | 描述 |
| --- | --- |
| [convertFileUris](<../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/fileUriService（文件路径转换API）/scenario-fusion-fileuriresult.md#convertfileuris>)(sourceFileUris: Array<string>): Promise<Array<[FileUriResult](<../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/fileUriService（文件路径转换API）/scenario-fusion-fileuriresult.md#fileuriresult>)>> | 获取转换文件uri信息的请求对象。 |
