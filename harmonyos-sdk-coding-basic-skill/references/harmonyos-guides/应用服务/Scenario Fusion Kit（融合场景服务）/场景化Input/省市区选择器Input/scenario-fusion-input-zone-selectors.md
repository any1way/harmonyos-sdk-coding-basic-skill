...
scraped_at: 2026-06-11T15:14:05+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:b7ef98f939af29df4baed619b1e579aa3c4912d5617c8765bf756187fabc894a
---
## 场景介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c/v3/JRL1KsysQ4yidUGxCaL0kQ/zh-cn_image_0000002592219580.png?HW-CC-KV=V1&HW-CC-Date=20260611T071404Z&HW-CC-Expire=86400&HW-CC-Sign=35D2E96BFB253BFADC6A57CCCDAD57C45E0C7B09608773A52D5C96FEC574B30D)

## 前提条件

参见[开发准备](<../../../Map Kit（地图服务）/开发准备/map-config-agc.md>)。
...
2. 在容器中声明FunctionalInput，指定FunctionalInput的inputType，并设置对应的回调函数，代码如下：
   ...
   * 可从返回结果中自行处理结果回填至组件中。
   * 组件支持显示两种类型的图标：symbol和image，"icon"设置为symbol资源时，请使用"[iconSymbolModifier](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS组件/functionalInputComponentManager(场景化融合Input组件管理)/scenario-fusion-functionalinputcomponentmanager.md#functionalinputparams>)"进行图标事件、样式的设置；设置为image资源时，请使用"[iconImgModifier](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS组件/functionalInputComponentManager(场景化融合Input组件管理)/scenario-fusion-functionalinputcomponentmanager.md#functionalinputparams>)"进行图标事件、样式的设置。
   * functionalInput支持[智能填充](../../智能填充服务/智能填充概述/scenario-fusion-introduction-to-smart-fill.md)，对应支持的[ContentType](../../智能填充服务/ContentType使用场景说明/scenario-fusion-intelligentfilling-appendix.md)为"ADDRESS\_CITY\_AND\_STATE"。

   其他参数请参考：[FunctionalInput（Input组件）](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS组件/FunctionalInput（Input组件）/scenario-fusion-functionalinput.md>)。
