...
content_hash: sha256:d05649ab1efeb1891f03582cb2bec0a65a9a77bab34462eed34522490841301e
---
## 场景介绍
...
以下是使用Promise异步回调获取系统信息属性的接口说明，更多接口及使用方法请参见[atomicService（融合场景化API）](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md>)。

| 接口名 | 描述 |
| --- | --- |
| [getSystemInfo](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md#getsysteminfo>)(properties?: Array<[SystemInfoType](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md#systeminfotype>)>): Promise<[SystemInfo](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md#systeminfo>)> | 获取系统信息属性的方法，支持获取设备、网络状态、屏幕、语言、主题等系统信息的请求对象，包含请求参数。 |
