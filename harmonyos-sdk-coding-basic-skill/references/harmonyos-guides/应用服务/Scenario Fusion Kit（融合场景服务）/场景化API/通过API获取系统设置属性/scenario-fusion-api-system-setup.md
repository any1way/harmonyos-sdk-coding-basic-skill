...
scraped_at: 2026-06-01T15:10:29+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:7c17750603633fe1f2ab2d17e0816f098768b9e83d4bbafd499119261d514304
---
## 场景介绍
...
以下是获取系统设置属性的接口说明，更多接口及使用方法请参见[atomicService（融合场景化API）](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md>)。

| 接口名 | 描述 |
| --- | --- |
| [getSystemSetting](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md#getsystemsetting>)(properties?: Array<[SystemSettingType](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md#systemsettingtype>)>): [SystemSettingInfo](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md#systemsettinginfo>) | 获取系统设置属性的方法，支持获取蓝牙、定位、Wi-Fi开关信息，以及设备方向信息的请求对象。 |
