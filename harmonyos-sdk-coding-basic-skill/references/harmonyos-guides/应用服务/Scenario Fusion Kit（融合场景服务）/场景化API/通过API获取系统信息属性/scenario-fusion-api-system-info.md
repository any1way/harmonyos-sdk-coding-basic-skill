...
scraped_at: 2026-06-01T15:10:27+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:8d8d4b09623e22b18c62d327d3ba015fafd4d4b94b027ea2813ec444524fc733
---
## 场景介绍
...
以下是获取系统信息属性的接口说明，更多接口及使用方法请参见[atomicService（融合场景化API）](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md>)。

| 接口名 | 描述 |
| --- | --- |
| [getSystemInfoSync](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md#getsysteminfosync>)(properties?: Array<[SystemInfoType](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md#systeminfotype>)>): [SystemInfo](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md#systeminfo>) | 获取系统信息属性的方法，支持获取设备、网络状态、屏幕、语言、主题等系统信息的请求对象，包含请求参数。  **说明：**  getSystemInfoSync接口不支持获取windowWidth、windowHeight、statusBarHeight和screenSafeArea属性，如需获取可使用[getSystemInfo](<../../../../../harmonyos-references/Scenario Fusion Kit（融合场景服务）/ArkTS API/atomicService（融合场景化API）/scenario-fusion-atomicservice.md#getsysteminfo>)接口。 |
