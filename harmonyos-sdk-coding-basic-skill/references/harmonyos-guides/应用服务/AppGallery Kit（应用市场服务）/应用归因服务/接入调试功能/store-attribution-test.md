...
scraped_at: 2026-06-01T15:00:55+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:c1aa3dc0f4613aa3e90941bdff8df84043bf2cb23175a96518504bcf014d88f3
---
...
应用归因服务接入调试功能提供以下接口，具体API说明详见[接口文档](<../../../../../harmonyos-references/AppGallery Kit（应用市场服务）/ArkTS API/attributionTestManager（应用归因接入调试功能）/store-attributiontestmanager.md>)。
...
1. 导入相关模块。
   ...
   ```
2. 构造参数，入参为[AdSourceInfo](<../../../../../harmonyos-references/AppGallery Kit（应用市场服务）/ArkTS API/attributionTestManager（应用归因接入调试功能）/store-attributiontestmanager.md#adsourceinfo>)、publickey。
   ...
   20. }
   ```
3. 调用[attributionTestManager.validateSource](<../../../../../harmonyos-references/AppGallery Kit（应用市场服务）/ArkTS API/attributionTestManager（应用归因接入调试功能）/store-attributiontestmanager.md#attributiontestmanagervalidatesource>)方法验证归因来源。
...
1. 导入相关模块。
   ...
   3. import { BusinessError,deviceInfo } from '@kit.BasicServicesKit';
   ```
2. 构造参数，入参为[PostbackInfo](<../../../../../harmonyos-references/AppGallery Kit（应用市场服务）/ArkTS API/attributionTestManager（应用归因接入调试功能）/store-attributiontestmanager.md#postbackinfo>)。
   ...
   16. }
   ```
3. 调用[attributionTestManager.setPostback](<../../../../../harmonyos-references/AppGallery Kit（应用市场服务）/ArkTS API/attributionTestManager（应用归因接入调试功能）/store-attributiontestmanager.md#attributiontestmanagersetpostback>)方法设置归因结果回传数据。
...
2. 构造参数adTechId。
   ...
   ```
3. 调用[attributionTestManager.flushPostbacks](<../../../../../harmonyos-references/AppGallery Kit（应用市场服务）/ArkTS API/attributionTestManager（应用归因接入调试功能）/store-attributiontestmanager.md#attributiontestmanagerflushpostbacks>)方法触发归因结果回传。
