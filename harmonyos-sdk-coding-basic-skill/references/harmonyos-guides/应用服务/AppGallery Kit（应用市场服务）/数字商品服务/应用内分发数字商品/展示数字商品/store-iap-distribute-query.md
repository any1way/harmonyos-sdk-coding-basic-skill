...
scraped_at: 2026-06-01T15:00:29+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:634687f2dea2f8710a81a2875f5a712a37a10c20167ecc8564e0af0094dc4947
---
...
1. 判断当前登录的华为账号所在的服务地是否支持数字商品服务应用内支付。
   ...
   在使用应用内支付之前，应用需要向IAP Kit发送[queryEnvironmentStatus](<../../../../../../harmonyos-references/IAP Kit（应用内支付服务）/ArkTS API/IAP/iap-iap.md#iapqueryenvironmentstatus>)请求，以此判断用户当前登录的华为账号所在服务地是否在IAP Kit支持结算的国家/地区中。
...
2. 查询商品信息。
   ...
   [queryProducts](<../../../../../../harmonyos-references/IAP Kit（应用内支付服务）/ArkTS API/IAP/iap-iap.md#iapqueryproducts>)每次只能查询一种类型的商品，单次查询请勿超过200条。
