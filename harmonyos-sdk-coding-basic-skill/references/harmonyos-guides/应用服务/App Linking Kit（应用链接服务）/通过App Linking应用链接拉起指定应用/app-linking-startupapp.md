...
scraped_at: 2026-06-11T15:05:05+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:29857c30d29d663627b2451567116711f66d0337562a06788de9a80253914908
---
## 场景介绍
...
3. 在左侧导航栏中选择“增长 > App Linking > 应用链接”，点击“创建”。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f7/v3/VVGzLmOnSPCzN85nxGfY6A/zh-cn_image_0000002622858677.png?HW-CC-KV=V1&HW-CC-Date=20260611T070503Z&HW-CC-Expire=86400&HW-CC-Sign=A7C49B4F7DBB036B58C2BF22358EE14BA44175BEE173B02B52DA6BB25FB2CC4F)
4. 填写[建立域名与应用关联关系](app-linking-startupapp.md#建立域名与应用关联关系)的网址域名，例如：https://www.example.com。必须输入精确的域名，不可输入包含特殊字符的模糊网址。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/P9J4xx9iTHqCpb60XyB98g/zh-cn_image_0000002622698797.png?HW-CC-KV=V1&HW-CC-Date=20260611T070503Z&HW-CC-Expire=86400&HW-CC-Sign=01468F61EB8DF27B2C3701B82299143478E047FE9C07EA98A0C08C78C3C04E4E)
5. 设置完成后点击“发布”，AGC会对该网站域名的配置文件所包含的应用与本项目内的应用列表进行交集校验。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/2gnoqQmnTcK7IYndf0EKcQ/zh-cn_image_0000002592219236.png?HW-CC-KV=V1&HW-CC-Date=20260611T070503Z&HW-CC-Expire=86400&HW-CC-Sign=C53F058313E2E6D076D14977F0F6D7687FE4017CAE202B9685E10D0CD401857E)

   * 如果域名的配置文件中存在本项目中的应用，则发布成功，点击“查看”可显示该域名关联的应用信息。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5/v3/cVg56YhNQiuCtpuEkjli4A/zh-cn_image_0000002592379170.png?HW-CC-KV=V1&HW-CC-Date=20260611T070503Z&HW-CC-Expire=86400&HW-CC-Sign=421E6B2A508195C6004FE8E5E41507D0C66BE90E2C65DE888E1F993976CFE571)
   * 如果还在校验中，则状态为“发布中”。
   * 如果配置文件中没有包含任何本项目中的应用，则发布失败，点击“查看”可显示发布失败原因。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/dD76LZ0cTbmPykfNQdF5LA/zh-cn_image_0000002622858679.png?HW-CC-KV=V1&HW-CC-Date=20260611T070503Z&HW-CC-Expire=86400&HW-CC-Sign=8BD06B1252919BF6743C9F3758E89AA3A1DA0EB62838B2163BCC4B1E70806A07)

### 在module.json5中配置关联的网址域名

在应用的[module.json5文件](../../../基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)中进行如下配置，以声明应用关联的域名地址，并开启域名校验开关。当URL符合module.json5中配置的host和路径规则时，可拉起开发者的App。
...
1. 对应用进行[手动签名](../../../编写与调试应用/配置调试签名/ide-signing.md#section297715173233)。
...
拉起方应用通过[UIAbilityContext.openLink()](<../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#openlink12>)接口，传入目标应用的链接，拉起目标应用。
...
3. 在“entry/src/main/ets/pages/Index.ets”文件中，使用[UIAbilityContext.openLink()](<../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#openlink12>)接口打开应用。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c9/v3/2tX8ufhBSmua4rlsPNeApg/zh-cn_image_0000002622698799.gif?HW-CC-KV=V1&HW-CC-Date=20260611T070503Z&HW-CC-Expire=86400&HW-CC-Sign=1057C0BD0A4DF493397065FF2CFEBD90BE2FD63F71D1A70414EE400757941CC7)
...
* 如果存在其他消息，请联系[技术支持](../../../../harmonyos-releases/获取支持与帮助/support.md)获取帮助。
