...
scraped_at: 2026-06-11T15:05:08+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:8e6b9635da320a3682fa7c932f3319c402fb4b064b49ad59ea751ced142c9f82
---
## 场景介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/sPvVFqr9TTCsmphYPDg07w/zh-cn_image_0000002592379174.gif?HW-CC-KV=V1&HW-CC-Date=20260611T070506Z&HW-CC-Expire=86400&HW-CC-Sign=7910E8164363BAD97CD41F5883C7D644315FC0CFDC3198B822700965512F1D3A)
...
* 只能获取通过App Linking域名校验的应用链接，请参见[在AGC为应用创建关联的网址域名](<../通过App Linking应用链接拉起指定应用/app-linking-startupapp.md#在agc为应用创建关联的网址域名>)。建议在首次启动签署隐私协议后再调用延迟链接接口，确保此时域名校验通过。

## 开发步骤

1. 获取延迟链接。

   1. 在入口类文件页面Index.ets中添加如下代码。当应用首次启动时，调用[deferredLink.popDeferredLink()](<../../../../harmonyos-references/App Linking Kit（应用链接服务）/ArkTS API/deferredLink (延迟链接能力)/applinking-deferredlink-api.md#popdeferredlink>)接口，获取用户此前点击的该应用相关链接。
...
2. 验证应用被拉起效果。
   ...
   拉起方应用可调用[UIAbilityContext.openLink()](<../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#openlink12>)接口，传入目标应用的链接，从而拉起目标应用。
