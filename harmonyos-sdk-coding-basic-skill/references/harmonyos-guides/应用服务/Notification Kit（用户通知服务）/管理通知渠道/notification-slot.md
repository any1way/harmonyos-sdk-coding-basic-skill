...
scraped_at: 2026-06-11T15:11:03+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:daeaf06d997e16d52e38feea3ed9963f9ac4298e44dd112e0e4db05d71833d4e
---
...
| SlotType | 取值 | 分类 | [对应Push消息分类标准](<../../Push Kit（推送服务）/开发准备/申请推送场景化消息权益/push-apply-right.md#通知消息分类标准与提醒方式>) | 通知中心 | 横幅 | 锁屏 | 铃声/振动 | 状态栏图标 | 自动亮屏 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
通知渠道主要接口如下。其他接口介绍详情参见[@ohos.notificationManager (NotificationManager模块)](<../../../../harmonyos-references/Notification Kit（用户通知服务）/ArkTS API/@ohos.notificationManager (NotificationManager模块)/js-apis-notificationmanager.md>)。
...
除了可以使用addSlot()创建通知渠道，还可以在发布通知的[NotificationRequest](<../../../../harmonyos-references/Notification Kit（用户通知服务）/ArkTS API/notification/NotificationRequest/js-apis-inner-notification-notificationrequest.md#notificationrequest-1>)中携带notificationSlotType字段，如果对应渠道不存在，会自动创建。
...
1. 导入notificationManager模块。
   ...
   [ManageNotificationWays.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Notification-Kit/Notification/entry/src/main/ets/filemanager/ManageNotificationWays.ets#L16-L23)
2. 创建指定类型的通知渠道。
   ...
   [ManageNotificationWays.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Notification-Kit/Notification/entry/src/main/ets/filemanager/ManageNotificationWays.ets#L33-L43)
3. 查询指定类型的通知渠道。
   ...
   [ManageNotificationWays.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Notification-Kit/Notification/entry/src/main/ets/filemanager/ManageNotificationWays.ets#L48-L64)
4. 删除指定类型的通知渠道。
   ...
   [ManageNotificationWays.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Notification-Kit/Notification/entry/src/main/ets/filemanager/ManageNotificationWays.ets#L69-L81)
