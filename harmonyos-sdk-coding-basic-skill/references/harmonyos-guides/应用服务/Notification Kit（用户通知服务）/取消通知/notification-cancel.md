...
scraped_at: 2026-06-01T15:07:44+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:ea58ab3e073de39cb0d8c4f6fe1cf14ac9bdccaee481bfab07f09c2b4e985677
---
...
通知取消接口如下。接口详情参见[@ohos.notificationManager (NotificationManager模块)](<../../../../harmonyos-references/Notification Kit（用户通知服务）/ArkTS API/@ohos.notificationManager (NotificationManager模块)/js-apis-notificationmanager.md>)。
...
1. 导入模块。
   ...
   [CancelNotification.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Notification-Kit/Notification/entry/src/main/ets/filemanager/CancelNotification.ets#L16-L23)
2. 发布通知。

   参考[发布文本类型通知](../发布通知/发布文本类型通知/text-notification.md)。
3. 取消通知。
   ...
   [CancelNotification.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Notification-Kit/Notification/entry/src/main/ets/filemanager/CancelNotification.ets#L58-L68)
