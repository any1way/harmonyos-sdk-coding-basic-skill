...
scraped_at: 2026-06-01T15:03:20+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:8a39d739b9145ae6a5bed18ab39a2ee26f1ec5fe00d78ff348a9eb207f1b5bee
---
## 场景介绍
...
详细接口说明可参考[接口文档](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceManager (空间管理)/enterprisespace-spacemanager.md#setworkspacestatusbaricon>)。

| 接口名 | 描述 |
| --- | --- |
| [setWorkspaceStatusBarIcon](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceManager (空间管理)/enterprisespace-spacemanager.md#setworkspacestatusbaricon>)(statusBarIcon: [StatusBarIcon](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceManager (空间管理)/enterprisespace-spacemanager.md#statusbaricon>), workspaceId?: number): Promise<void> | 设置工作空间状态栏图标。使用Promise异步回调。 |
...
1. 导入Enterprise Space Kit模块。
   ...
   ```
2. 调用[setWorkspaceStatusBarIcon](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceManager (空间管理)/enterprisespace-spacemanager.md#setworkspacestatusbaricon>)接口，设置工作空间状态栏图标，并且查看打印信息。
