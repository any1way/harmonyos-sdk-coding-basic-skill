...
scraped_at: 2026-06-01T15:03:04+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:79529de8b06d9c1584efb3b3a7211eb37fb2db1b210cb6f7766a7c6a120a48f0
---
## 场景介绍
...
详细接口说明可参考[接口文档](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceManager (空间管理)/enterprisespace-spacemanager.md#createworkspace>)。

| 接口名 | 描述 |
| --- | --- |
| [createWorkspace](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceManager (空间管理)/enterprisespace-spacemanager.md#createworkspace>)(localName: string, workspaceType: [WorkspaceType](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceManager (空间管理)/enterprisespace-spacemanager.md#workspacetype>), params?: [CreateWorkspaceParams](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceManager (空间管理)/enterprisespace-spacemanager.md#createworkspaceparams>)): Promise<[WorkspaceInfo](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceManager (空间管理)/enterprisespace-spacemanager.md#workspaceinfo>)> | 创建工作空间并返回结果。使用Promise异步回调。 |
...
1. 导入Enterprise Space Kit模块。
   ...
   ```
2. 调用[createWorkspace](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceManager (空间管理)/enterprisespace-spacemanager.md#createworkspace>)接口，创建工作空间，并且查看打印信息。
