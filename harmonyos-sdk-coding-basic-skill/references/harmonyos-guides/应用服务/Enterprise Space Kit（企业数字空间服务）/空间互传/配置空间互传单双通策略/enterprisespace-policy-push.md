...
scraped_at: 2026-06-01T15:03:02+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:ca95212734ba899639f527ac2c9279b9d4ae6ba89b3e9fa00224557b3326e51b
---
## 场景介绍
...
详细接口说明可参考[接口文档](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceDataTransfer (空间数据传输)/enterprisespace-spacedatatransfer.md#policypush>)。

| 接口名 | 描述 |
| --- | --- |
| [policyPush](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceDataTransfer (空间数据传输)/enterprisespace-spacedatatransfer.md#policypush>)(policyContext: string): void | 配置空间互传单双通策略。 |
...
1. 导入Enterprise Space Kit模块。
   ...
   ```
2. 调用[policyPush](<../../../../../harmonyos-references/Enterprise Space Kit（企业数字空间服务）/ArkTS API/spaceDataTransfer (空间数据传输)/enterprisespace-spacedatatransfer.md#policypush>)接口，配置空间互传单双通策略，并且查看打印信息。
