...
scraped_at: 2026-06-01T15:04:24+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:9c38c507970f450bad543c4c83b51b499c290c6db94beda4c598aec781c6e0c4
---
## 场景介绍
...
此接口使用日常活动数据类型读权限，参考[权限说明](../../../数据类型/权限说明/health-permission-description.md)。
...
| 接口名 | 描述 |
| --- | --- |
| [readActivityReport](<../../../../../../../harmonyos-references/Health Service Kit（运动健康服务）/ArkTS API/healthService (运动健康联动服务)/health-api-healthservice.md#workoutreadactivityreport>)(): Promise<[ActivityReport](<../../../../../../../harmonyos-references/Health Service Kit（运动健康服务）/ArkTS API/healthService (运动健康联动服务)/health-api-healthservice.md#activityreport>)> | 读取实时三环数据。 |
...
* 需先通过[用户授权](../../../PhoneTablet应用开发/管理用户授权/health-add-permissions.md#用户授权)接口引导用户授权，用户授权日常活动数据类型读权限（参考[权限说明](../../../数据类型/权限说明/health-permission-description.md)）后，才有权限读取实时三环数据。
...
1. 导入运动健康服务功能模块及相关公共模块。
   ...
   ```
2. 调用[readActivityReport](<../../../../../../../harmonyos-references/Health Service Kit（运动健康服务）/ArkTS API/healthService (运动健康联动服务)/health-api-healthservice.md#workoutreadactivityreport>)方法读取实时三环数据，并处理返回结果。
