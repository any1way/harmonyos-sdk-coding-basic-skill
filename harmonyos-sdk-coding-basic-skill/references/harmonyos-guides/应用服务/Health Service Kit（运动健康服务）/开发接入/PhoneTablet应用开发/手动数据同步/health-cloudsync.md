...
scraped_at: 2026-06-01T15:04:18+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:052ada97a3d0e7949c7a42e39e774a9e70d859cd13b9175a9ed6905aa201d0da
---
## 场景介绍
...
| 接口名 | 描述 |
| --- | --- |
| [syncAll](<../../../../../../harmonyos-references/Health Service Kit（运动健康服务）/ArkTS API/healthStore (运动健康数据服务)/health-api-healthstore.md#healthstoresyncall>)(): Promise<void> | 用户主动触发数据同步。 |
...
* 需先通过[用户授权](../管理用户授权/health-add-permissions.md#用户授权)接口引导用户授权，参见[AuthorizationRequest](<../../../../../../harmonyos-references/Health Service Kit（运动健康服务）/ArkTS API/healthStore (运动健康数据服务)/health-api-healthstore.md#authorizationrequest>)中scopes参数。用户授权数据同步权限后，才可调用手动数据同步接口。
...
1. 导入运动健康服务功能模块及相关公共模块。
   ...
   ```
2. 调用[syncAll](<../../../../../../harmonyos-references/Health Service Kit（运动健康服务）/ArkTS API/healthStore (运动健康数据服务)/health-api-healthstore.md#healthstoresyncall>)方法同步数据，并处理返回结果。
