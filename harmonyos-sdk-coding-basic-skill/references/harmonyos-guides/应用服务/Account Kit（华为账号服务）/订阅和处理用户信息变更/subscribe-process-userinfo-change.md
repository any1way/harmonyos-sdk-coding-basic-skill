...
scraped_at: 2026-06-11T15:03:05+08:00
doc_updated_at: 2026-06-10
content_hash: sha256:34a769c1d6a6744a825afe3919e13c1d562b60b07f0caa1f903195289b3fcb6d
---
## 概述
...
1. 登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)，选择“开发与服务”。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/fPmybzSnTWO6cTlKDoGxMw/zh-cn_image_0000002592818954.png?HW-CC-KV=V1&HW-CC-Date=20260611T070304Z&HW-CC-Expire=86400&HW-CC-Sign=79FF74E96EEB67A771B5F224462B2D2111A8A23DAF91D170E42DBA6419044BC1)
2. 在项目列表选择项目。
3. 进入“项目设置 > 开放能力管理”页面，点击“RISC”对应的“管理”。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/tpcHfnqyRBy-w5EQpgywmA/zh-cn_image_0000002623418601.png?HW-CC-KV=V1&HW-CC-Date=20260611T070304Z&HW-CC-Expire=86400&HW-CC-Sign=C4E898696E8C32F3256A32B87E9639CFEED5A22F79C14BAD9E8F369CE6CA8929)
4. 点击“启用”按钮。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/04/v3/3HgQMYJMSKSTCtl4FHxo6A/zh-cn_image_0000002623418729.png?HW-CC-KV=V1&HW-CC-Date=20260611T070304Z&HW-CC-Expire=86400&HW-CC-Sign=7D47318FB5736E6A66A769986CA88D66FC88A4DE049F0ECC95834150BCB4F8CA)
5. 点击“订阅通知”按钮，在弹窗中配置“回调地址”及“订阅范围”，然后点击“提交”。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/rSxFViBNT2SSYZhBWTIcKQ/zh-cn_image_0000002623420773.png?HW-CC-KV=V1&HW-CC-Date=20260611T070304Z&HW-CC-Expire=86400&HW-CC-Sign=6CB54E93223AB2B2F1D607DD3591BC4A2865E690662D2ABDB164BF146B49E65A)
...
2. **处理消息体。**
   ...
   * **JSON数组格式消息体**
   ...
   | subject | 用户信息变更事件对应的消息体，格式为json，包含字段说明如下：  - sub：触发事件用户的UnionID（用户在同一个开发者下的所有应用中，此值唯一）。具体格式要求请参考[OpenID和UnionID的格式说明](<../Account Kit常见问题/OpenID和UnionID的格式说明/account-faq-9.md>)。  - subject\_type：固定为“iss\_sub”。  - extra：触发事件用户的OpenID（用户在同一个应用中，此值唯一）。具体格式要求请参考[OpenID和UnionID的格式说明](<../Account Kit常见问题/OpenID和UnionID的格式说明/account-faq-9.md>)。  - iss：标识消息投递者，固定为“id.cloud.huawei.com”。 |
