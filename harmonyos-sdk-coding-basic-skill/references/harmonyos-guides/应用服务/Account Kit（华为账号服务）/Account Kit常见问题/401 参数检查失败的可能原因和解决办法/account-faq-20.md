...
content_hash: sha256:a2693731544f8c92a951ffd6677fdf9ac01b7d84afa02da844ecb5c8ceeeb126
---
**问题现象**
...
2. 检查module type为entry的模块下module.json5中的client\_id配置的值是否正确，请参考[配置Client ID](<../../开发准备/配置Client ID/account-client-id.md>)。
3. 请使用手动签名方式配置签名，请参考[配置签名和指纹](../../开发准备/配置签名和指纹/account-sign-fingerprints.md)。
