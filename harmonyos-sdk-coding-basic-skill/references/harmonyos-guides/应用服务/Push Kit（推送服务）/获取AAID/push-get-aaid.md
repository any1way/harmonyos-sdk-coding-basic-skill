...
scraped_at: 2026-06-01T15:09:49+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:3a1d389fabdaedd0df82d4c110afd45db2a0226ad5608eb6d2a281ee3848ea86
---
...
| 接口名 | 描述 |
| --- | --- |
| [getAAID](<../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/AAID（应用匿名标识符）/push-aaid-api.md#aaidgetaaid-1>)(): Promise<string> | 获取AAID，使用Promise异步返回结果。 |
| [deleteAAID](<../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/AAID（应用匿名标识符）/push-aaid-api.md#aaiddeleteaaid-1>)(): Promise<void> | 删除AAID，使用Promise异步返回结果。 |
...
1. 导入AAID模块及相关公共模块。
   ...
   ```
2. 调用AAID.[getAAID](<../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/AAID（应用匿名标识符）/push-aaid-api.md#aaidgetaaid-1>)()方法获取AAID信息。
