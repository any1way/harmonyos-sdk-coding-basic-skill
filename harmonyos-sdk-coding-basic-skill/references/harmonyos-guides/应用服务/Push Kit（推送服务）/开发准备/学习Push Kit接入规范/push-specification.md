...
scraped_at: 2026-06-01T15:09:28+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:afbc6e00a198953a441a48ee7cd4ea0756d740756ad9a53b2ca5be6194ca13dd
---
...
* 遵守[通知内容管理细则](../../附录/通知内容管理细则/push-detail-rules.md)。

## 通知内容

为保障推送内容信息的合法性、真实客观性、一致性、可读性，以及用户良好的通知使用体验，请您遵守[通知内容管理细则](../../附录/通知内容管理细则/push-detail-rules.md)。
...
* 避免出现其他可能影响终端用户体验的行为。
* 应用使用Push Kit时，推荐接入[应用内通知设置快捷入口](<../../../Notification Kit（用户通知服务）/应用内通知设置快捷入口开发指导/notification-shortcut-settings.md>)，便于用户找到应用内的通知分类控制开关，提升用户通知管理的体验，减少应用通知关闭率。
