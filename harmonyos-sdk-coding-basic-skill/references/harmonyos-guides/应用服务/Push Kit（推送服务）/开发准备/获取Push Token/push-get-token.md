...
scraped_at: 2026-06-01T15:09:32+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:6e1d69c5b61d9dd2713dfb1118b434cb67c9f4fd150d10b196805f55679cedc9
---
## 场景介绍

说明

Push Kit对Push Token进行了权益校验，请在进行开发前先阅读[开通推送服务](../开通推送服务/push-config-setting.md)章节，完成相关配置。

Push Token标识了每台设备上每个应用，开发者调用[getToken](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/pushService（推送服务基础能力）/push-pushservice.md#pushservicegettoken-1>)()接口向Push Kit服务端请求Push Token，获取到之后使用Push Token来推送消息。

Push Token一般情况不会变化，仅下列场景会导致之前的Push Token发生变化而失效：

* 卸载应用后重新安装。
* 设备恢复出厂设置。
* 应用显式调用[deleteToken](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/pushService（推送服务基础能力）/push-pushservice.md#pushservicedeletetoken-1>)()接口后重新调用[getToken](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/pushService（推送服务基础能力）/push-pushservice.md#pushservicegettoken-1>)()接口。
* 应用显式调用[deleteAAID](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/AAID（应用匿名标识符）/push-aaid-api.md#aaiddeleteaaid-1>)()接口后重新调用[getToken](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/pushService（推送服务基础能力）/push-pushservice.md#pushservicegettoken-1>)()接口。
* 将设备（仅涉及Wearable设备）拿到海外其他国家或者地区后，系统会更新设备的token。更新后的token通过[pushService.on('tokenUpdate')](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/pushService（推送服务基础能力）/push-pushservice.md#pushserviceontokenupdate>)接口的回调返回。
...
* 只有在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)平台[开通推送服务](../开通推送服务/push-config-setting.md)后，[getToken](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/pushService（推送服务基础能力）/push-pushservice.md#pushservicegettoken-1>)方法才会返回Push Token。
...
| 接口名 | 描述 |
| --- | --- |
| [getToken](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/pushService（推送服务基础能力）/push-pushservice.md#pushservicegettoken-1>)(): Promise<string> | 以Promise形式获取Push Token。 |
| [deleteToken](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/pushService（推送服务基础能力）/push-pushservice.md#pushservicedeletetoken-1>)(): Promise<void> | 以Promise形式删除Push Token。 |

## 获取Push Token

1. Push Kit对Push Token进行了权益校验，请在进行开发前先阅读[开通推送服务](../开通推送服务/push-config-setting.md)章节，完成相关配置。
2. 导入pushService模块及相关公共模块。
   ...
   ```
3. 建议在您的UIAbility（例如EntryAbility）的[onCreate](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#oncreate>)()方法中调用[getToken](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/pushService（推送服务基础能力）/push-pushservice.md#pushservicegettoken-1>)()接口获取Push Token并上报到您的服务端，方便您的服务端向终端推送消息。代码示例：
...
若您获取Push Token时发生APP身份验证失败错误（1000900010），请参考[ArkTS API错误码](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/ArkTS API错误码/push-error-code.md#section1000900010-app身份验证失败>)排查。

## 删除Push Token

说明

删除Push Token后，本应用下的所有Push Kit历史数据会一并删除。非必要情况，请您不要主动调用[deleteToken](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/pushService（推送服务基础能力）/push-pushservice.md#pushservicedeletetoken-1>)()接口。
...
1. 导入pushService模块。
   ...
   ```
2. 调用PushService.[deleteToken](<../../../../../harmonyos-references/Push Kit（推送服务）/ArkTS API/pushService（推送服务基础能力）/push-pushservice.md#pushservicedeletetoken-1>)()接口删除Push Token。代码示例：
