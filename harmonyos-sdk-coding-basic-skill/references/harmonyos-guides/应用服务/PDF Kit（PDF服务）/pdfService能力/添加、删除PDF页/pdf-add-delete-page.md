...
scraped_at: 2026-06-01T15:08:58+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:17ced484b8e5e74772de12bf94abd330a8a530165fac80a3ab43769248955942
---
在PDF文档中添加或删除页面，包括：
...
| 接口名 | 描述 |
| --- | --- |
| [insertBlankPage](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#insertblankpage>)(index: number, width: number, height: number): PdfPage | 在指定位置插入空白PDF页。 |
| [getPage](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#getpage>)(index: number): PdfPage | 获取指定页的对象。 |
| [insertPageFromDocument](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#insertpagefromdocument>)(document: PdfDocument, fromIndex: number, pageCount: number, index: number): PdfPage | 将其他文档的页添加到当前文档。 |
| [deletePage](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#deletepage>)(index: number, count: number): void | 删除指定的PDF页。 |
