...
scraped_at: 2026-06-11T15:12:27+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:bcf53e59365bea4e5fe42de8f3a7622c76aa8780a4a1e04cf22c4811c2bd0126
---
支持编辑PDF页面内容，包括：
...
* 添加、修改、删除批注。
  ...
  通过索引指定PDF页面添加批注，并对批注在页面中的位置，字体、批注边框等设置，批注提供了多种风格样式，包括：文本批注[TextAnnotationInfo](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#textannotationinfo>)、下划线批注[LineAnnotationInfo](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#lineannotationinfo>)、高亮批注[HighlightAnnotationInfo](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#highlightannotationinfo>)、删除线批注[StrikethroughAnnotationInfo](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#strikethroughannotationinfo>)等共13种。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/FMkJ2jioTtia6cZErxyaRA/zh-cn_image_0000002592379470.png?HW-CC-KV=V1&HW-CC-Date=20260611T071226Z&HW-CC-Expire=86400&HW-CC-Sign=0451BA4091B24D9454747CC8681AE86A124DEEB1FE18CD7E83301A40667A4482)

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [addTextObject](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#addtextobject>)(text: string, x: number, y: number, style: TextStyle): void | 添加文本内容，只可按行添加。 |
| [addImageObject](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#addimageobject>)(path: string, x: number, y: number, width: number, height: number): void | 在PDF文档的页面中添加图片。 |
| [deleteGraphicsObject](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#deletegraphicsobject>)(object: GraphicsObject): void | 删除指定的GraphicsObject。 |
| [addAnnotation](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#addannotation>)(annotationInfo: PdfAnnotationInfo): PdfAnnotation | 在当前页添加批注。 |
