...
scraped_at: 2026-06-01T15:09:09+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:8018b3ebc6747ecb5fbe2e88673a31672c5dc92aec9c584cedaa3ce9d2fa9a84
---
## 场景介绍

通过加载本地路径的PDF文档，实现打开PDF文档的预览功能。当PDF文档做了批注等相关的信息时，可以使用保存功能。

和pdfService的打开和保存能力相同，具体区别查看pdfService的[打开和保存PDF文档](../../pdfService能力/打开和保存PDF文档/pdf-open-document.md)的场景介绍。

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [loadDocument](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfViewManager（PDF预览）/pdf-arkts-pdfviewmanage.md#loaddocument>)(path: string, password?: string, initPageIndex?: number, onProgress?: Callback<number>): Promise<pdfService.ParseResult> | 加载PDF文档。 |
| [saveDocument](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfViewManager（PDF预览）/pdf-arkts-pdfviewmanage.md#savedocument>)(path: string, onProgress?: Callback<number>): Promise<number> | 保存PDF文档，使用Promise异步回调。 |
