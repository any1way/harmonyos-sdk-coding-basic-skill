...
scraped_at: 2026-06-01T15:09:14+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:0e424f4c19a56026d94b54c31a0f57992ce0f6a0ef0865a8a0e66aec2928bcbc
---
## 场景介绍

调用[getPagePixelMap](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfViewManager（PDF预览）/pdf-arkts-pdfviewmanage.md#getpagepixelmap>)方法，将指定PDF缩略图转化为图片。

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [getPagePixelMap](<../../../../../harmonyos-references/PDF Kit（PDF服务）/ArkTS API/pdfViewManager（PDF预览）/pdf-arkts-pdfviewmanage.md#getpagepixelmap>)(pageIndex: number, isSync?: boolean): Promise<image.PixelMap> | 获取对应PDF页面的缩略图，使用Promise异步回调。 |
