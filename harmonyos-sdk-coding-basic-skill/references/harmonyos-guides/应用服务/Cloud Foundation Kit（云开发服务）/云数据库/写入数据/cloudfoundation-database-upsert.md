...
content_hash: sha256:ac629c470d01f3d14b0a0c9ecc908782fdb3adc24d5c00c6239766d1d100a96d
---
开发者可以通过[upsert()](<../../../../../harmonyos-references/Cloud Foundation Kit（云开发服务）/ArkTS API/cloudDatabase (云数据库模块)/cloudfoundation-clouddatabase.md#upsert>)将一个或者一组对象写入到当前存储区中。在写入对象时，如果在存储区已经存在主键相同的对象，则更新已有的对象；如果不存在，则写入一个新的对象。写入的数据可以来自于新建对象，或者从存储区查询出来的对象。
