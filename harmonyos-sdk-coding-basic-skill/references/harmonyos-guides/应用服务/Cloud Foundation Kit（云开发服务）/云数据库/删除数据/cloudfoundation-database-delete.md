...
scraped_at: 2026-06-01T15:02:21+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:27b924bff9a16b51444a06c969c0d1d5527fab9803ec5fd76de1336991f16606
---
开发者可以通过[delete()](<../../../../../harmonyos-references/Cloud Foundation Kit（云开发服务）/ArkTS API/cloudDatabase (云数据库模块)/cloudfoundation-clouddatabase.md#delete>)删除单个对象或者一组对象。删除数据时，云数据库会根据传入对象主键删除相应的数据，不会比对该对象其它属性与存储的数据是否一致。删除一组对象时，删除操作是原子性的，即对象列表中的对象要么全部删除成功，要么全部删除失败。
