...
scraped_at: 2026-06-01T15:02:18+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:c07fc05233a76104e7b085ec94be4e0023e28a10ee88d7a9f6581807f25edf55
---
## 约束与限制
...
已[引入对象类型文件](../引入对象类型文件/cloudfoundation-database-add-file.md)。
...
3. 在业务代码中，使用AGC开发平台上创建的存储区“QuickStartDemo”类初始化DatabaseZone。
   ...
   * cloudDatabase.zone方法接收的入参为“存储区名称”，即cloudDBZoneName，请参见[新增存储区](../新增存储区/cloudfoundation-database-add-zone.md)章节。
