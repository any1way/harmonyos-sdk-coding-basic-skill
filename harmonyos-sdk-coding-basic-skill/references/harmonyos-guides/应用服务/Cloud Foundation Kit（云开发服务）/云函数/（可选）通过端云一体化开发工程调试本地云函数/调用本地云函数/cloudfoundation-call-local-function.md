...
scraped_at: 2026-06-11T15:05:40+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:d9db2d81d30cfc16af636e6d9dd35845b7dddc00262b737fbd6e9c508644edf8
---
## 约束与限制
...
调用本地云函数之前，请按照以下示例设置“设备端口”到“主机端口”的映射。详情请参见[创建反向端口转发任务](../../../../../系统/调测调优/调试命令/hdc/hdc.md#创建反向端口转发任务)。
...
1. 在项目中导入cloudFunction组件。
   ...
   ```
2. 调用[call()](<../../../../../../harmonyos-references/Cloud Foundation Kit（云开发服务）/ArkTS API/cloudFunction (云函数模块)/cloudfoundation-cloudfunction.md#call>)方法设置函数，在方法中传入函数名称和本地启动的云函数地址，返回调用结果。
