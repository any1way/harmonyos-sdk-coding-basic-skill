...
scraped_at: 2026-06-11T15:05:38+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:ba9231a2a32fa260a5ee5b2f3725a2f663a90d2b482d12d5a0c1e1b2b4749b04
---
## 约束与限制
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/6Aeqyoy3RXSjIIko0aDnxw/zh-cn_image_0000002622698857.png?HW-CC-KV=V1&HW-CC-Date=20260611T070537Z&HW-CC-Expire=86400&HW-CC-Sign=4E22EAD5AF923B29843BD5CEF097C1302C7D3B60FB5B6C99B4FA4351456D8787)
...
1. 在项目中导入cloudFunction组件。
   ...
   ```
2. 调用[call()](<../../../../../../harmonyos-references/Cloud Foundation Kit（云开发服务）/ArkTS API/cloudFunction (云函数模块)/cloudfoundation-cloudfunction.md#call>)方法设置函数，在方法中传入函数名称，返回调用结果。
...
3. 如果需要关注函数的返回值，可调用result属性获取。
   ...
   value为步骤2中调用call()方法返回的cloudFunction.FunctionResult对象，返回值为云函数body返回的值，以[测试函数](../测试函数/cloudfoundation-test-function.md)时返回的结果为例，value.result = {"simple":"example"}。
