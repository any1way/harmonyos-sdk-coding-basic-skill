...
scraped_at: 2026-06-11T15:06:03+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:aa1b666661aa7e835bbf45bd9d93b0021206177eca3e3f4bdb2b13fad34b1703
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/MIpxY9FxRTy1E4X0LkZI2w/zh-cn_image_0000002622858749.png?HW-CC-KV=V1&HW-CC-Date=20260611T070602Z&HW-CC-Expire=86400&HW-CC-Sign=DAFB741819A3F0050F969C77DBC2C1A27D5C096C3A4A6DCE458846B5BF4D6695)

1. [开发函数](../../云函数/开发云函数/开发函数/Node.js/cloudfoundation-develop-function-nodejs.md)：按照云函数接口规范开发函数。
2. [创建函数](../../云函数/开发云函数/创建函数/cloudfoundation-create-and-config-function.md)：函数业务代码开发完成后，即可在AGC云端创建函数。
3. [测试函数](../../云函数/开发云函数/测试函数/cloudfoundation-test-function.md)：对函数进行测试，以确保函数代码运行正常。
...
[端云一体化工程](../../../../开发环境搭建/工程创建/模块管理/端云一体化开发/开发端云工程/开发云侧工程/开发云函数/开发函数/agc-harmonyos-clouddev-funccoding.md)预加载云函数示例如下。其中，axios依赖库为网络请求库，需要在“cloudfunctions/云函数名称/package.json”的“dependencies”中添加axios的1.7.7或以上版本依赖。
