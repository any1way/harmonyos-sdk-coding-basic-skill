...
scraped_at: 2026-06-01T15:02:26+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:7e200370ebbe8c50d369d863cbe84ce9019d80ac01f298d705abea5c01dac7d2
---
...
* 已[初始化存储实例](../初始化存储实例/cloudfoundation-storage-initialize-bucket.md)。
* 已[上传指定文件至云侧](../上传指定文件至云侧/cloudfoundation-storage-upload-file.md)。

## 操作步骤

1. 调用[StorageBucket.downloadFile](<../../../../../harmonyos-references/Cloud Foundation Kit（云开发服务）/ArkTS API/cloudStorage (云存储模块)/cloudfoundation-cloudstorage.md#downloadfile>)接口创建下载任务，监听下载任务的progress、completed、failed等事件。
2. 启动下载任务。

   说明

   下载成功后，文件将保存在[context.cacheDir](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md#属性>)目录下。
...
如果本地已存在同名文件，下载文件将出现异常，可以通过设置[DownloadParams.overwrite](<../../../../../harmonyos-references/Cloud Foundation Kit（云开发服务）/ArkTS API/cloudStorage (云存储模块)/cloudfoundation-cloudstorage.md#downloadparams>)来决定是否覆盖本地文件。
