...
content_hash: sha256:12cfb84cac14156bb7bc13fe9301d6a1460e43fa990d12c8ddb930267eb49780
---
## 约束与限制
...
已[开通云存储服务](../../开发准备/开通云存储服务/cloudfoundation-enable-storage.md)。

## 操作步骤

调用[cloudStorage.bucket](<../../../../../harmonyos-references/Cloud Foundation Kit（云开发服务）/ArkTS API/cloudStorage (云存储模块)/cloudfoundation-cloudstorage.md#bucket>)初始化一个存储实例。支持使用两种方式初始化实例：
