...
scraped_at: 2026-06-01T15:00:13+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:b79098ac350b686750d1c1e05ad23c3e5f327c988390c388914a7187bc099c0d
---
## 场景介绍
...
开发者需要在广告请求参数[AdRequestParams](<../../../../../harmonyos-references/Ads Kit（广告服务）/ArkTS API/@ohos.advertising (广告服务框架)/js-apis-advertising.md#adrequestparams>)中添加实时竞价相关参数。
...
开发者需要在广告请求成功后的回调AdLoadListener.[onAdLoadSuccess](<../../../../../harmonyos-references/Ads Kit（广告服务）/ArkTS API/@ohos.advertising (广告服务框架)/js-apis-advertising.md#onadloadsuccess>)或MultiSlotsAdLoadListener.[onAdLoadSuccess](<../../../../../harmonyos-references/Ads Kit（广告服务）/ArkTS API/@ohos.advertising (广告服务框架)/js-apis-advertising.md#onadloadsuccess>)中，处理广告返回的实时竞价结果[Advertisement](<../../../../../harmonyos-references/Ads Kit（广告服务）/ArkTS API/advertisement/Advertisement (请求的广告内容)/js-apis-advertisement.md#advertisement>).biddingInfo。

实时竞价结果信息如下所示：

说明

回传竞价结果，需要申请使用Internet网络权限[ohos.permission.INTERNET](../../../../系统/安全/程序访问控制/应用权限管控/应用权限列表/开放权限（系统授权）/permissions-for-all.md#ohospermissioninternet)。详细申请权限流程请参考[开发准备](../../开发准备/development-preparation.md)。
