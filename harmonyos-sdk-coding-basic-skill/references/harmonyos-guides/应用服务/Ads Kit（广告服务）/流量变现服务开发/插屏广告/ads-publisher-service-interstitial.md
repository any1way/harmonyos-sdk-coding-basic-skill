...
content_hash: sha256:bc4e70cf890d982c905b24c4ee18972f59e158658ec9519ea6eacd84018659a2
---
## 场景介绍

插屏广告是一种在应用开启、暂停或退出时以全屏或半屏的形式弹出的广告形式，展示时机巧妙避开用户对应用的正常体验，尺寸大，曝光效果好。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/A6m8fWJTQ0KUCR-wRkZ42g/zh-cn_image_0000002622858641.png?HW-CC-KV=V1&HW-CC-Date=20260611T070333Z&HW-CC-Expire=86400&HW-CC-Sign=66846A5DCA6F289C99388B6F73A70D6E7C86872A52501B7A5512861E8047EA93)
...
2. 事件订阅。
   ...
   在订阅到公共事件后，可以从[CommonEventData](<../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/进程线程通信/commonEvent/CommonEventData/js-apis-inner-commonevent-commoneventdata.md>)的parameters参数中使用interstitial\_ad\_status作为key值获取插屏广告页面变化状态。
...
2. 展示广告。
   ...
   开发者需要调用[showAd](<../../../../../harmonyos-references/Ads Kit（广告服务）/ArkTS API/@ohos.advertising (广告服务框架)/js-apis-advertising.md#advertisingshowad>)方法来展示广告，ads为[请求广告](ads-publisher-service-interstitial.md#请求广告)返回的广告信息，在每次展示广告前需要注册[事件订阅](ads-publisher-service-interstitial.md#事件订阅)中定义的监听器。
