...
scraped_at: 2026-06-11T15:03:34+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:a01e588f1098b914748a4f36e183c64da62ec194485b20a50b730654e412db23
---
## 场景介绍

激励广告是一种全屏幕的视频广告，用户可以选择点击观看，以换取相应奖励。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/X8WuIhrKSJmHklJQJYKN8Q/zh-cn_image_0000002592379132.png?HW-CC-KV=V1&HW-CC-Date=20260611T070332Z&HW-CC-Expire=86400&HW-CC-Sign=985649C13A0A12F05DDE65B83A877C219F90944C1AF1F3C8FF5D4E29B4B9E800)
...
| [showAd](<../../../../../harmonyos-references/Ads Kit（广告服务）/ArkTS API/@ohos.advertising (广告服务框架)/js-apis-advertising.md#advertisingshowad>)(ad: Advertisement, options: AdDisplayOptions, context?: common.UIAbilityContext): void | 展示广告，通过AdDisplayOptions进行广告展示参数设置。  说明：为了保证广告能正确展示，该接口必须和请求广告接口配套使用。 |
...
3. 请求单广告位广告。
   ...
   需要先创建一个AdLoader对象，通过AdLoader的[loadAd](<../../../../../harmonyos-references/Ads Kit（广告服务）/ArkTS API/@ohos.advertising (广告服务框架)/js-apis-advertising.md#loadad>)方法请求广告，最后通过[AdLoadListener](<../../../../../harmonyos-references/Ads Kit（广告服务）/ArkTS API/@ohos.advertising (广告服务框架)/js-apis-advertising.md#adloadlistener>)，来监听广告的加载状态。
...
2. 事件订阅。
   ...
   在订阅到公共事件后，可以从[CommonEventData](<../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/进程线程通信/commonEvent/CommonEventData/js-apis-inner-commonevent-commoneventdata.md>)的parameters参数中获取激励广告页面变化状态和奖励信息。
...
2. 展示广告。
   ...
   开发者需要调用[showAd](<../../../../../harmonyos-references/Ads Kit（广告服务）/ArkTS API/@ohos.advertising (广告服务框架)/js-apis-advertising.md#advertisingshowad>)方法来展示广告，ads为[请求广告](ads-publisher-service-reward.md#请求广告)返回的广告信息，在每次展示广告前需要注册[事件订阅](ads-publisher-service-reward.md#事件订阅)中定义的监听器。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/XwoCDVLMSFOh6VdOFq7scw/zh-cn_image_0000002622858639.png?HW-CC-KV=V1&HW-CC-Date=20260611T070332Z&HW-CC-Expire=86400&HW-CC-Sign=9E26F96A5BC2A4C2D783D7552FA68DFD5E7887BAEEF5286AD17E14A46251C4E6)
...
1. 设置激励广告的奖励配置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/q9sVPMn2SEKNYaqR5RZmxQ/zh-cn_image_0000002622698761.png?HW-CC-KV=V1&HW-CC-Date=20260611T070332Z&HW-CC-Expire=86400&HW-CC-Sign=684E7F460D40455D94EB2649B680D5F3AEFDF422DB7997694FCF1CF9E957595C)
...
5. 获取公钥列表。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0/v3/ieuGRfLZTHCWczHtQz9o1w/zh-cn_image_0000002592219200.png?HW-CC-KV=V1&HW-CC-Date=20260611T070332Z&HW-CC-Expire=86400&HW-CC-Sign=4C5F0858F57775AC92D1DB654FF02DB441EE8B6B76E007EB033601FE672AFDCF)

   通过点击上图所示的“获取密钥”按钮弹出如下所示的弹框，获取“开发者ID”和“密钥”。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/0fl0w-T9ScCpPSKETDByiw/zh-cn_image_0000002592379134.png?HW-CC-KV=V1&HW-CC-Date=20260611T070332Z&HW-CC-Expire=86400&HW-CC-Sign=B71AC1D66FCA9CD304BE6AE4366FB6D905FD96A10DB78AE6E8BA16275FEA1455)
