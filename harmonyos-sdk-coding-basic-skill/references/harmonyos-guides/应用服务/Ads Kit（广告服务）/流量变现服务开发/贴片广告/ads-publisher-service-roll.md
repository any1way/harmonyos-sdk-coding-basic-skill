...
content_hash: sha256:9368a3abbb32df47d84b9e8f9503104e257b5093f99d6cd5c0dd21ddac77fdfa
---
## 场景介绍

贴片广告是一种在视频播放前、视频播放中或视频播放结束后插入的视频或图片广告。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/VdAfk0EXRLSgdMkJRPenrw/zh-cn_image_0000002592219202.png?HW-CC-KV=V1&HW-CC-Date=20260611T070335Z&HW-CC-Expire=86400&HW-CC-Sign=5CD4C8AE451A479897FB87B80B5F7314D94499633685679ED6B2DAF9A3A9926C)
...
3. 请求单广告位广告。
   ...
   需要创建一个AdLoader对象，通过AdLoader的[loadAd](<../../../../../harmonyos-references/Ads Kit（广告服务）/ArkTS API/@ohos.advertising (广告服务框架)/js-apis-advertising.md#loadad>)方法请求广告，最后通过[AdLoadListener](<../../../../../harmonyos-references/Ads Kit（广告服务）/ArkTS API/@ohos.advertising (广告服务框架)/js-apis-advertising.md#adloadlistener>)来监听广告的加载状态。

   在请求贴片广告时，需要在[AdOptions](<../../../../../harmonyos-references/Ads Kit（广告服务）/ArkTS API/@ohos.advertising (广告服务框架)/js-apis-advertising.md#adoptions>)中设置参数：totalDuration。
...
2. 展示广告。
   ...
   | onMediaError | 广告播放失败。 | - playTime：类型number，单位ms，广告播放时长，-1为异常值。  - errorCode：类型number，错误码ID。  - errorMsg：类型string，错误信息。  错误码的详细介绍请参见AVPlayer.[on('error')](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md#onerror9>)错误码。 | - |
