...
scraped_at: 2026-06-11T15:13:43+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:0f1b704f20206d54574ca4be04a9bb45525843ceb379148101fa1592cfa1d9be
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/fCKPi4LdRpGZHSSyvG96yQ/zh-cn_image_0000002592219578.png?HW-CC-KV=V1&HW-CC-Date=20260611T071342Z&HW-CC-Expire=86400&HW-CC-Sign=F7928533168EE61712BBE15E38047ECC9F96B2FAC35554CEB5C16F1DB6137532)
...
| 接口名 | 描述 |
| --- | --- |
| [getDefaultHandler](<../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/bookParser（书籍解析能力）/reader-book-parser.md#getdefaulthandler>)(path: string): Promise<BookParserHandler> | 获取书籍默认解析器。 |
| [init](<../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/readerCore（阅读核心能力）/reader-read-core.md#init>)(context: common.UIAbilityContext): Promise<void> | 初始化ReadPageComponent控制器。  初始化接口需要优先于ReaderComponentController的其他接口之前执行。 |
...
| [registerBookParser](<../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/readerCore（阅读核心能力）/reader-read-core.md#registerbookparser>)(bookParserHandler: bookParser.BookParserHandler): void | 注册书籍解析器。  需要在startPlay接口调用之前执行。 |
| [startPlay](<../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/readerCore（阅读核心能力）/reader-read-core.md#startplay>)(spineIndex: number, domPos: string): Promise<void> | 以指定阅读进度打开书籍，使用Promise异步回调。  需要在registerBookParser接口调用之后执行。 |
...
3. 构建ReadPageComponent组件，用于显示阅读内容。
   ...
   19. }
   ```
4. 通过提前导入到[应用沙箱目录](<../../../../应用框架/Core File Kit（文件基础服务）/应用文件/应用沙箱目录/app-sandbox-directory.md>)中的书籍文件，初始化书籍解析器。调用[startPlay](<../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/readerCore（阅读核心能力）/reader-read-core.md#startplay>)接口，以指定进度渲染阅读器页面。
