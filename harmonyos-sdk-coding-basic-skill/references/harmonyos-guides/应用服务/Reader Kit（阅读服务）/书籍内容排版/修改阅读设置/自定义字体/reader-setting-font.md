...
scraped_at: 2026-06-11T15:13:44+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:830b6520d33da9a05a05e7aa57a86bc43fe26ea50c023b27f44513a0259aa9b4
---
当应用需要支持自定义字体时，开发者可通过[ReaderSetting](<../../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/readerCore（阅读核心能力）/reader-read-core.md#readersetting>)的fontPath属性，实现对阅读内容字体的实时修改。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0e/v3/XNsfiauPR2yAore46qnkAA/zh-cn_image_0000002592379512.png?HW-CC-KV=V1&HW-CC-Date=20260611T071344Z&HW-CC-Expire=86400&HW-CC-Sign=15D48E6CA6FD55B61489F2E09E109E6D77FCE4D1995FFEEDCA52038FF9EB969E)
...
| [on('resourceRequest')](<../../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/readerCore（阅读核心能力）/reader-read-core.md#onresourcerequest>) | 注册资源请求回调，如果设置了自定义背景，字体时，排版引擎会通过此接口获取对应的资源ArrayBuffer。 |
| [off('resourceRequest')](<../../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/readerCore（阅读核心能力）/reader-read-core.md#offresourcerequest>) | 注销资源请求回调接口，可在页面销毁时调用。 |

## 开发准备

* 进行自定义字体之前，请先确保已经“[构建阅读器](../../构建阅读器/reader-read-page.md)”。
...
2. 定义字体文件存放路径：
   ...
   * 若资源放在项目resources/rawfile/fonts文件夹下。
     ...
     ```
   * 若资源放在[应用沙箱目录](<../../../../../应用框架/Core File Kit（文件基础服务）/应用文件/应用沙箱目录/app-sandbox-directory.md>)下。
