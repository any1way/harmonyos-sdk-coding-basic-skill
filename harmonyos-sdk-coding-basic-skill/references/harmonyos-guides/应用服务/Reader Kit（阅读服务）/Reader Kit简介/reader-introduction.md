...
scraped_at: 2026-06-01T15:10:06+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:8f18574ff111607ce5fdb84aeb0be60c4af53bb461b2fc998249e76b673f735d
---
...
* ReadPageComponent
  ...
  Reader Kit封装的阅读页UI组件[ReadPageComponent](<../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS组件/ReadPageComponent（阅读页组件）/reader-api-readpagecomponent.md>)（ets），支持对书籍排版内容的显示、多种翻页交互和翻页动效，以及翻页阅读过程中阅读器所需要的进度、行为感知能力。
* BookParser

  电子书解析引擎[bookParser](<../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/bookParser（书籍解析能力）/reader-book-parser.md>)，支持txt、epub、mobi、azw、azw3格式书籍文件的解析。
* spine(书脊)

  书的背脊；平装书或精装书封面和封底的联结处。一般印有书名、作者名、出版单位名等。在Reader Kit中，spine(书脊)定义了书籍内容的阅读顺序，每一个[SpineItem](<../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/bookParser（书籍解析能力）/reader-book-parser.md#spineitem>)表示一个可阅读的内容节点，标识着可阅读的一个内容资源。
