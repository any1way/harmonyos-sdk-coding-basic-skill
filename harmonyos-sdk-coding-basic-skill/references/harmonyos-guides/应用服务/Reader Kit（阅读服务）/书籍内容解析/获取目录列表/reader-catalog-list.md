...
content_hash: sha256:eeadca3fee5ec2a02564b04e849b564616c5f0ccb3a98c6d19529b03573966f3
---
当应用需要展示书籍目录列表时，开发者可通过解析能力获取目录节点列表，实现目录列表中章节名称按顺序、层级的展示。当用户点击目录节点时，开发者也需要获取目录位置及资源信息，用于跳转到指定位置。

## 业务流程

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/CYbJQ3taRhGvUBkGZTivAg/zh-cn_image_0000002622699139.png?HW-CC-KV=V1&HW-CC-Date=20260611T071340Z&HW-CC-Expire=86400&HW-CC-Sign=09042885D7AE9A44A81FC3A0931720528C65053BEE31BF4F310D270417AEC5C8)
...
| [getCatalogList](<../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/bookParser（书籍解析能力）/reader-book-parser.md#getcataloglist>)(): CatalogItem[] | 获取书籍目录列表。 |
| [getDomPosByCatalogHref](<../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/bookParser（书籍解析能力）/reader-book-parser.md#getdomposbycataloghref>)(href: string): string | 获取阅读起始位置domPos。 |
| [getSpineList](<../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/bookParser（书籍解析能力）/reader-book-parser.md#getspinelist>)(): SpineItem[] | 获取书脊内容列表。 |
