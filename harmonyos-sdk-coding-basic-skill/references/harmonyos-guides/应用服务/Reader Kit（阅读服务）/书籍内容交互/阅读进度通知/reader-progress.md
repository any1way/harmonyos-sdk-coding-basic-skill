...
scraped_at: 2026-06-01T15:10:13+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:1bfaa1810a8abe0a92d4ddd5c9471d787176cc1ac6a458ca9865caa1586a290d
---
...
| 接口名 | 描述 |
| --- | --- |
| [on('pageShow')](<../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/readerCore（阅读核心能力）/reader-read-core.md#onpageshow>) | 注册章节内容分页展示结果回调。 |
| [off('pageShow')](<../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/readerCore（阅读核心能力）/reader-read-core.md#offpageshow>) | 注销章节内容分页展示结果回调，可在页面销毁时调用。 |

## 开发准备

在进行阅读进度通知监听之前，请先确保已经“[构建阅读器](../../书籍内容排版/构建阅读器/reader-read-page.md)”。
...
1. 通过ReaderComponentController组件控制器监听页面展示回调。
   ...
   开发者可在on('pageShow')接口回调中将阅读进度实时保存到数据库当中，防止用户异常退出阅读器时的进度丢失。当用户下次继续阅读时，可将保存domPos及resourceIndex属性传入到[startPlay](<../../../../../harmonyos-references/Reader Kit（阅读服务）/ArkTS API/readerCore（阅读核心能力）/reader-read-core.md#startplay>)接口中，用于阅读进度的恢复。
