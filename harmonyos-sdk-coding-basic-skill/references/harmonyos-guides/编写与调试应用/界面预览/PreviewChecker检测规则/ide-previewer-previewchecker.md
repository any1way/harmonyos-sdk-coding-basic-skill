...
scraped_at: 2026-06-01T15:24:04+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:a664c48651024e61ca11f0c30d76148d100815477a35329e11aae4b98ba93816
---
...
由于能力缺失，预览器无法确保HSP是可以正常运行的。界面代码调用HSP可能会在预览运行时无法按预期执行，未正确初始化的接口调用可能会导致运行异常，从而影响界面渲染结果。建议待预览的组件及其依赖的组件避免引用HSP，或为该HSP设置Mock实现，更多关于Mock实现的介绍请参考[预览数据模拟](../预览数据模拟/ide-previewer-mock.md)。
