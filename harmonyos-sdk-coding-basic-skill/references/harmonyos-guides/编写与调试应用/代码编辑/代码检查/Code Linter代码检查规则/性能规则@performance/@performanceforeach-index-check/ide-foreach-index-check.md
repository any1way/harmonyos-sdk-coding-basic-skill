...
scraped_at: 2026-06-01T15:21:51+08:00
doc_updated_at: 2026-01-15
content_hash: sha256:ee76f110ab7180b3cdd3e96322d6a75e8d96d1d9078d6ed706846e8777f67342
---
使用Foreach组件时，不建议在keyGenerator中使用index作为返回值或者返回值的一部分，可能会导致性能问题。

[滑动丢帧场景](<../../../../../../应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ForEach：循环渲染/arkts-rendering-control-foreach.md#渲染性能降低>)下，建议优先修改。
