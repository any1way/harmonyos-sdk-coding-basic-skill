...
content_hash: sha256:ad3a4986099a8984eadeb3719f13c2c866321ccd2e4926a823ea550f70db56d3
---
...
* 该规则建议在对.ts文件进行检查时使用。如需检查.ets文件，建议使用[@hw-stylistic/space-before-function-paren](../../ArkTS代码风格规则@hw-stylistic/@hw-stylisticspace-before-function-paren/ide-space-before-function-paren-stylistic.md)。
