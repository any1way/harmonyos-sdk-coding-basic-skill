...
content_hash: sha256:78f5438b5de1c513da112a513afdf9bd59efb1d1cbdd4d7245e3ac4715e24660
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/4GkvyikjSDirHKBpnYiWmw/zh-cn_image_0000002602066101.png?HW-CC-KV=V1&HW-CC-Date=20260611T072806Z&HW-CC-Expire=86400&HW-CC-Sign=EF510C76E8E8A646CE248EFF54795391615AF4DB65AD21A3E3FAB1EE802E439B)
...
1. 在欢迎页单击**Customize > All settings… > Appearance & Behavior > System Settings > HTTP Proxy**进入HTTP Proxy设置界面。如果已经打开了工程，可以单击**File > Settings**（macOS为**DevEco Studio > Preferences/Settings**） **> Appearance & Behavior > System Settings > HTTP Proxy**进入HTTP Proxy设置界面。
   ...
   * **Proxy authentication**配置项，如果代理服务器需要通过认证鉴权才能访问，则需要配置。否则，请跳过该配置项。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/IMy3RhD3QiitE8iV5z0kEg/zh-cn_image_0000002571386990.png?HW-CC-KV=V1&HW-CC-Date=20260611T072806Z&HW-CC-Expire=86400&HW-CC-Sign=576015C145D798D068894F2631D5816133E89E18802B8EE0242566374F130B45)
...
1. 进入*C:\Users\用户名*目录，打开**.npmrc**文件。如果该目录下没有**.npmrc**文件，请新建一个。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/wDE-KN1rSCGT0zC7DEabNA/zh-cn_image_0000002571546624.png?HW-CC-KV=V1&HW-CC-Date=20260611T072806Z&HW-CC-Expire=86400&HW-CC-Sign=770B2D0C9C39FF37F5DD5139167F0D122C7203395A9EEFBC747274A916F284FE)
2. 修改npm仓库信息，示例如下所示：
...
5. 代理配置完成后，打开命令行工具，执行如下命令验证网络是否正常。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bf/v3/n0V43soOTVS2YnhKIeHjYA/zh-cn_image_0000002602066103.png?HW-CC-KV=V1&HW-CC-Date=20260611T072806Z&HW-CC-Expire=86400&HW-CC-Sign=F57AB1E7813D5CE6CF3DC611DC7137AE1E7436D62AAB48A3A4D2B5B60BB3B5AF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/PHkTZJ4TTg6uMTlCvaHtFw/zh-cn_image_0000002602066107.png?HW-CC-KV=V1&HW-CC-Date=20260611T072806Z&HW-CC-Expire=86400&HW-CC-Sign=895D17A757DCB5B1CCBBEB40E634585F294FC8246B8C07DF6482C889F3A7254E)

说明：ohpm默认校验registry仓库地址证书。如果环境检查中ohpm registry access出现'SELF\_SIGNED\_CERT\_IN\_CHAIN'或'UNABLE\_TO\_VERIFY\_LEAF\_SIGNATURE'等证书校验错误时，请查看[FAQ-问题现象2](<../../../../harmonyos-faqs/DevEco Studio/环境准备/环境检查时显示ohpm registry access不通过/faqs-development-environment-10.md>)解决证书校验错误问题。
...
5. 代理配置完成后，执行如下命令验证网络是否正常。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/SF-8zaXuRfabihSN1Zq5jA/zh-cn_image_0000002571386992.png?HW-CC-KV=V1&HW-CC-Date=20260611T072806Z&HW-CC-Expire=86400&HW-CC-Sign=FA8DA53DC67807271967470EB375EC2796E430B815B9F2092C2C85A94565CCDD)
