...
scraped_at: 2026-06-11T15:29:54+08:00
doc_updated_at: 2026-06-10
content_hash: sha256:179ebe7e53224e0b8a15043bd26bac5e58d69af4cbd0d2976b2a5c090035c8a6
---
...
将设备与电脑进行连接，并对应用/元服务签名，具体请参考[使用本地真机运行应用](../../../使用本地真机运行应用/ide-run-device.md)和[应用/元服务签名](../../../配置调试签名/ide-signing.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/L3WuAijXQVuC57s7aJ5uyQ/zh-cn_image_0000002571386942.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=6F5B18AFAD273C8AE5A363A3C69D13F1D0745234C2B872975379D820D28FF0CC)
...
* **方式一：通过DevEco Studio进行编译与安装，从DevEco Studio 6.0.2 Beta1版本开始支持。**
  1. 点击菜单栏**Run** > **Edit Configurations** **>** **Diagnostics**，勾选**Black Coverage**，开启黑盒覆盖率测试。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/nW8ir5CFQk-yvVVaaGhrPg/zh-cn_image_0000002602186109.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=82B8B8F4589DB001E49249FAE0C2150ACEBAC65ED9D1010EF10248BB8D173989)
  2. 点击工具栏![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/9zc6nuGLRn-CdZ6q899Lvg/zh-cn_image_0000002602066051.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=471DC810D33D6FF316B4CCA6B74ACA79E559D87FC0E47B0F5F9D2F981DA8C7B9)，DevEco Studio会启动编译插桩，并推包安装到设备上。
* **方式二：通过命令行进行编译与安装**
  1. 执行hvigor插桩编译命令，编译后在{projectPath}/{moduleName}/.test/default/intermediates/ohosTest路径下会生成init\_coverage.json文件，供后续生成覆盖率报告使用。
     ...
     + moduleName：执行测试的模块。
     + targetName/productName：当前生效的target/product，可以通过点击DevEco Studio右上方![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/O9lTq5GjT5SBN8dK5mteDw/zh-cn_image_0000002602186115.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=4387FBC1ADD214C8A0BC631F5E27F4289B8C32D9D9103577AD06E4A16F00EB95)图标进行查看。

     说明

     如果HAP依赖HSP，需要单独编译HSP，将以上命令的assembleHap替换为assembleHsp即可。
  2. 如果设备上已存在待测试的应用，先卸载应用，不存在则跳过此步骤，关于hdc工具的使用指导请参考[hdc](../../../../系统/调测调优/调试命令/hdc/hdc.md)。
...
* 针对UIAbility和存在onDump方法的ExtensionAbility，执行命令生成覆盖率数据。UIAbility从DevEco Studio 5.1.0 Release版本开始支持，ExtensionAbility从DevEco Studio 6.0.1 Beta1版本开始支持。
  ...
  ```
* 针对UIAbility，退出应用，触发[onDestroy()回调](<../../../../应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/UIAbility组件/UIAbility组件生命周期/uiability-lifecycle.md#ondestroy>)，生成覆盖率数据。
* 针对存在onDestroy方法的ExtensionAbility，Ability销毁时，触发onDestroy()回调，生成覆盖率数据。从DevEco Studio 6.0.1 Beta1版本开始支持。
* 针对UIAbility，支持通过[EventHub接口](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/EventHub/js-apis-inner-application-eventhub.md>)通知UIAbility生成覆盖率数据。从DevEco Studio 6.0.2 Beta1版本开始支持。
...
3. 在本地找到报告文件路径并在浏览器中打开，查看代码覆盖率详情，关于覆盖率的计算方式请参考[查看覆盖率报告](ide-ui-test.md#section10394362109)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/tZag0q79TNqbUG0FuRvcCg/zh-cn_image_0000002602186117.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=2C6187B8442BEFE23C1650E86652CDE3C081979F1478A21C0F46D91961ABB3CB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/7rlZbUocQrCYCj2XBn_HxA/zh-cn_image_0000002602066057.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=2A2EA5C1D884413253F3623287269082FB0B2E8827B93ECEEDC048A06BE1E754)
...
* 测试覆盖率报告左侧的标识：
  ...
  + Nx：表示当前可执行代码行被执行了N次。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/eiQOiw2JQpyWmZ8cvRYq2w/zh-cn_image_0000002602066061.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=F10D35F320BDC3B65976BC5A052D3C85FF6ABE69426A1B9BEF9E6507B0FDAE1B)
* **通过注释语法忽略指定代码**
...
* **functions**
  ...
  + **regions**
    ...
    - 如果方法内没有任何实现，是个空方法，则regions数组只有一个元素，即方法对应的代码区域，示例如下。
      ...
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/pvvsItgbRYyvG2xaS9F6rw/zh-cn_image_0000002571386940.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=0B826FA1B09D114B6DA1CE0B915064FE4498CC214159D7D1B50D6EBA30EEC837)
    ...
    - 如果方法内只有一个代码区域，则regions数组有两个元素，示例如下。
      ...
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/M_tdjUHuRa-CXTihabVwTQ/zh-cn_image_0000002571546568.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=E2E59DE068A03EF8D8B864F57E94D47BBE49DAFFA0C10AFAB3935100F38A6010)
    ...
    - 如果方法内存在多个代码区域，则每新增一个代码区域，regions数组就增加一个元素，示例如下。
      ...
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/34/v3/O0UiaX0uRC2aOPiNnCDzOA/zh-cn_image_0000002571546580.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=9C3020E12191B68BF7FC7C5A4E0F3719FA975D324ED0279EC8B2B7A2FB669FB6)
  ...
  + **branches**
    ...
    **示例一：**调用eeee(2)。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/84/v3/IJBCxsDeSry6ipHwEBsmJg/zh-cn_image_0000002571386946.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=685A3347E245961DD3686639F7CD491988195D79E80B16B93B7BA034113B60E0)
    ...
    **示例二：**调用bbb(2)和bbb(-1)，该方法触发两次。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/0RfUUpx0QIGVBiO1FcpSog/zh-cn_image_0000002602066053.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=E9D882B08E6E2F45AF791E96767C12896EB0007AB7B0E7EE28357DDD3D2971C4)
...
* **exeLine**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/44/v3/Kk3-bQ8uQVC6ObNyUpav9Q/zh-cn_image_0000002602066049.png?HW-CC-KV=V1&HW-CC-Date=20260611T072953Z&HW-CC-Expire=86400&HW-CC-Sign=ED2C51DAF4FA189FFFA5ED97A9548D47CA7C09D4AE84D4ED9D9C4E93C6098F08)
