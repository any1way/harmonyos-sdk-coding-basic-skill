...
scraped_at: 2026-06-11T15:30:03+08:00
doc_updated_at: 2026-06-10
content_hash: sha256:45e77ed1c14e171d607f166ab7cfd89fcbaeb6a7cc62fa04d0b22a2b48f26b0e
---
从DevEco Studio 6.1.0 Beta1版本开始，AppAnalyzer新增上架合规体检，针对AppGallery应用的上架合规要求进行检测，提前发现需要重点关注的合规事项，了解应做和不应做的事项，避免常见误区。

## 进行体检

1. 确保[DevEco Studio与真机设备已连接](../../../使用本地真机运行应用/ide-run-device.md)，并对应用进行[签名](../../../配置调试签名/ide-signing.md)。
2. 通过以下任意一种方式，打开AppAnalyzer。
   * 单击菜单栏**Tools >** **AppAnalyzer**，打开AppAnalyzer页面。
   * 在编辑窗口右侧的工具栏，点击**AppAnalyzer**或![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/ILupC-amQ0WNpzUZvTo_HA/zh-cn_image_0000002602186205.png?HW-CC-KV=V1&HW-CC-Date=20260611T073003Z&HW-CC-Expire=86400&HW-CC-Sign=6D6CCAE8EA85290A9D62F8881B2340B39059DE89B83AEE58BA3F855A9190E015)，打开AppAnalyzer页面。
3. 点击右上角![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/iqJquBRqQCK9lwy16S-mcQ/zh-cn_image_0000002602186207.png?HW-CC-KV=V1&HW-CC-Date=20260611T073003Z&HW-CC-Expire=86400&HW-CC-Sign=CDF88ACF9D9454C77976B302208E01D0150F07CFF4EE5A032C5B5927D3AF5687)图标选择Product、Target和构建模式，点击**Apply**后，在AppAnalyzer的首页中可查看对应的编译产物和构建模式。关于Product、Target、构建模式的介绍请参考[配置多目标产物](../../../../构建应用/配置构建流程/配置多目标产物/能力说明/ide-customized-multi-targets-and-products-guides.md)和[指定构建模式](../../../../构建应用/定制构建/灵活定制编译选项/能力说明/ide-hvigor-compilation-options-customizing-guide.md#section192461528194916)。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/5sfWzU58QlSojEi_FzMvXw/zh-cn_image_0000002571546670.png?HW-CC-KV=V1&HW-CC-Date=20260611T073003Z&HW-CC-Expire=86400&HW-CC-Sign=1159164DEF9296DC24B785E3AA60CFB39DBD470D320610130165E7629514D27F)
4. 在**AppAnalyzer**页面，选择**上架合规体检**，选择预置的体检卡片，或根据需要自定义卡片。
   * 点击预置的体检卡片开始体检，如需查看卡片包含的体检规则，请点击卡片右上角的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/6J5-AupgRVyktqBTO3TOOA/zh-cn_image_0000002602186209.png?HW-CC-KV=V1&HW-CC-Date=20260611T073003Z&HW-CC-Expire=86400&HW-CC-Sign=B89013B76628C2BB4790E0A776B9F917EC83A9F73A6C2850CBBCEC28803CAE63)按钮，规则详情请参考[体检规则](ide-app-analyzer-ag-policy.md#section63875091019)。
   * 如果需要自定义体检规则，点击**+**，选择体检规则。
5. 开始体检后，请等待AppAnalyzer完成构建、签名、安装等操作，并根据界面提示，登录应用账号后点击继续按钮![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/u-7aP2McQG2Ud2YzUrRlhw/zh-cn_image_0000002571387032.png?HW-CC-KV=V1&HW-CC-Date=20260611T073003Z&HW-CC-Expire=86400&HW-CC-Sign=67E9A6B4B14BC45006A163CC2FFD4797A63DA5A60132182B35E07EA39E87BD60)，继续测试；或者无需登录账号，直接点击![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/AoFsYevxTq-gCWsqXYPW5Q/zh-cn_image_0000002602186211.png?HW-CC-KV=V1&HW-CC-Date=20260611T073003Z&HW-CC-Expire=86400&HW-CC-Sign=01604216480E05061BB19F9D10E59320D94B01C2B277BE7CCFA44EC864760165)按钮继续测试。在测试过程中，请保持连接的设备为解锁亮屏状态。
6. 测试完成后，查看测试报告，针对测试不通过的规则，AppAnalyzer会给出应该做和不应该做的事项，以及对应的优化建议。

   如果在体检中遇到问题，可点击报告右上角的**User Feedback**向我们反馈。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7c/v3/QyWg6RB1RlCNmSyUlT6-dw/zh-cn_image_0000002602186201.png?HW-CC-KV=V1&HW-CC-Date=20260611T073003Z&HW-CC-Expire=86400&HW-CC-Sign=354C29B6F12C7C23AC1A123A13F5A8D663D3E06CDF71C7962C425228144EAE51)
