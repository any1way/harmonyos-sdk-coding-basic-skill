...
scraped_at: 2026-06-11T15:28:50+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:bf5ae871427bbe33ba2f9a659eabb13240f104f29ad283358d6b9fda017e43f8
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/ELRPcKyPQLKE7XTNK_abww/zh-cn_image_0000002571545318.png?HW-CC-KV=V1&HW-CC-Date=20260611T072811Z&HW-CC-Expire=86400&HW-CC-Sign=E69A1F65A7D521FB005F31D61B72C2A16BC208ECF71EC0EB99DDE46C9798947B)
...
2. 如果CPU支持虚拟化，打开控制面板 > 程序 > 程序和功能 > 启动或关闭Windows功能（Windows11系统中打开系统 > 可选功能 > 相关设置 > 更多Windows功能），检查功能“Hyper-V”、“Windows虚拟机监控程序平台”、“虚拟机平台”是否存在。
   ...
   * 如果存在，勾选这三个功能，点击确定并重启电脑。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/_EzFtkjRTdaYCfoBwrfprg/zh-cn_image_0000002571545310.png?HW-CC-KV=V1&HW-CC-Date=20260611T072811Z&HW-CC-Expire=86400&HW-CC-Sign=49E1EDFACCF0C48B5C0A27CDD5406F04350ED5136F544C38A568D20DB5F8985F)
...
4. 如果按照上述步骤无法解决，打开**任务管理器->性能**，若显示虚拟化已禁用或未开启，则是BIOS中虚拟化没有开启，请根据计算机的主板型号，进入BIOS设置界面，并开启虚拟化功能。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/ivdvgFjcQPyVJ071zZp4PA/zh-cn_image_0000002602064805.png?HW-CC-KV=V1&HW-CC-Date=20260611T072811Z&HW-CC-Expire=86400&HW-CC-Sign=B65F3AC57585F7096462C318202FDAD9693B822B7098B835A249C0E98E607727)
...
当前计算机不支持使用模拟器，建议更换支持模拟器的计算机，详细请参考[使用环境](../概述/使用环境/ide-emulator-requirements.md)。
...
1. 首先打开**任务管理器>详细信息**，在列表表头右键**>选择列**，找到并勾选“**提交大小**”，点击“**提交大小**”列进行排序，关闭部分提交大小占用高的进程。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/FLNEIp-cQB-ZRILuVowG0g/zh-cn_image_0000002602064801.png?HW-CC-KV=V1&HW-CC-Date=20260611T072811Z&HW-CC-Expire=86400&HW-CC-Sign=58C61EF9C94BE78D7B130729BD004E28BF2EA5F4313B1CF5C46F3BFD13DEFC8C)
2. 打开**任务管理器>性能>内存**页面，确保已提交内存的剩余量大于模拟器设置的RAM大小。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/gjCH1ydqR4mfdRN24SiAmg/zh-cn_image_0000002571385682.png?HW-CC-KV=V1&HW-CC-Date=20260611T072811Z&HW-CC-Expire=86400&HW-CC-Sign=5D80BFB01D7D8506764DCFF66E107DD3629A1D5FC13455AB0C96356BC4A53420)
...
* 重新下载镜像，具体请参考[创建模拟器](../管理模拟器/创建模拟器/ide-emulator-create.md)。
* 删除已创建的模拟器，然后重新创建模拟器。
...
升级显卡驱动，如果原显卡不支持OpenGL则需要更换显卡，具体要求请参考[使用环境](../概述/使用环境/ide-emulator-requirements.md)。
...
1. 执行如下命令，结束hdc的进程，然后尝试重新连接，更多关于hdc工具的使用指导请参考[hdc](../../../系统/调测调优/调试命令/hdc/hdc.md)。

   ```
   1. hdc kill
   ```
2. 若按照步骤1操作后还是不能连接，请重启DevEco Studio和模拟器，然后尝试重新连接。
3. 重新下载模拟器镜像，具体请参考[创建模拟器](../管理模拟器/创建模拟器/ide-emulator-create.md)。
...
* 请参考[9568347 解析本地so文件失败](../../../系统/调测调优/调试命令/bm工具/bm-tool.md#section9568347-解析本地so文件失败)。
...
建议在创建模拟器时增加模拟器的运行内存（RAM）大小，请参考[创建模拟器](../管理模拟器/创建模拟器/ide-emulator-create.md#section1764055173710)。
...
更换系统类型再使用模拟器，具体运行环境要求请参考[使用环境](../概述/使用环境/ide-emulator-requirements.md)。
