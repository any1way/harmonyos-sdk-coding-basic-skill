...
scraped_at: 2026-06-11T15:30:30+08:00
doc_updated_at: 2026-06-10
content_hash: sha256:051d3117c7f37fc5953b5600aadd59d2a100115f80fbd2b544434bd64e3884ac
---
...
更多关于多目标产物的实践请参考[多目标产物构建开发实践](../../../../../best-practices/编译构建/多目标产物构建/bpta-multi-target.md)。
...
每一个target均可以指定支持的设备类型deviceType，也可以不定义。如果不定义，则该target默认支持module.json5/[config.json](../../../../基础入门/开发基础知识/应用配置文件（FA模型）/应用配置文件概述（FA模型）/application-configuration-file-overview-fa.md)中定义的设备类型。
...
在未定义target的分发规则distributionFilter时，以module配置[distributionFilter](../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#distributionfilter标签)/[distroFilter](../../../../基础入门/开发基础知识/应用配置文件（FA模型）/module对象内部结构/module-structure.md#distrofilter对象的内部结构)分发规则为准。
...
2. 支持hap、hsp、har（请注意：开启[文件/文件夹名称混淆](../../../../应用框架/ArkTS（方舟编程语言）/ArkTS编译工具链/ArkGuard源码混淆工具/ArkGuard混淆原理及功能/source-obfuscation.md#section-enable-filename-obfuscation)的har模块需要使用-keep-file-name指定sourceRoot，sourcePath，sourceFileName对应的文件/文件夹名称不被混淆）。
...
10. {
11. "name": "productA",
12. "compatibleSdkVersion": "6.1.1(24)",
13. "runtimeOS": "HarmonyOS",
14. },
15. {
16. "name": "productB",
17. "compatibleSdkVersion": "6.1.1(24)",
...
24. {
25. "name": "productB",
26. "compatibleSdkVersion": "6.1.1(24)",
...
14. "compatibleSdkVersion": "6.1.1(24)",
...
15. "compatibleSdkVersion": "6.1.1(24)",
...
23. "compatibleSdkVersion": "6.1.1(24)",
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/pgrykhz7SIWMn638LJTvkg/zh-cn_image_0000002602066415.png?HW-CC-KV=V1&HW-CC-Date=20260611T072642Z&HW-CC-Expire=86400&HW-CC-Sign=12E4E83F1D3909270A13CFC22D53E854C364947E71A0511FEA2B28771839C2A8)
...
products中的icon和label字段在编译时会替换[app.json5](../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/app.json5配置文件/app-configuration-file.md)中对应的字段，app.json5和module.json5均可以配置这两个字段，如果都配置，优先级顺序请参考[配置优先级](../../../../基础入门/开发基础知识/典型场景的开发指导/配置应用图标和名称/layered-image.md#配置优先级和生成策略)。
...
16. "compatibleSdkVersion": "6.1.1(24)",
...
22. "compatibleSdkVersion": "6.1.1(24)",
...
单击右上角的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/HAGPoWhjQaKQYRQoczMZow/zh-cn_image_0000002571387294.png?HW-CC-KV=V1&HW-CC-Date=20260611T072642Z&HW-CC-Expire=86400&HW-CC-Sign=409CC1A35DBE592B854870F345D0560A0AC07903D71CD597B5D417B6E05F11CB)图标，指定需要打包的**Product**及**Target**，然后单击**Apply**保存。例如选择"ProductA"中，entry模块对应的"free" Target。

* **Product**：选择需要构建的APP包。
* **Build Mode**：选择[编译模式](../../../定制构建/灵活定制编译选项/能力说明/ide-hvigor-compilation-options-customizing-guide.md#section192461528194916)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/4hfcxdCrS0uij5cim3D_Gg/zh-cn_image_0000002602066409.png?HW-CC-KV=V1&HW-CC-Date=20260611T072642Z&HW-CC-Expire=86400&HW-CC-Sign=DAA0BEF3E8ACE36D9D77C9136F196AF3C6D723F086E11A83B964FE92BA7FBD71)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/tY9zSkPrQHK2gCfno9iX2w/zh-cn_image_0000002571546928.png?HW-CC-KV=V1&HW-CC-Date=20260611T072642Z&HW-CC-Expire=86400&HW-CC-Sign=B7C9245C231DD5B9FE5E37D636FFA4C4AE760260B2495DA2E15E9A79869775DD)

## 调试和运行指定的Target

使用DevEco Studio调试或运行应用/元服务时，每个模块只能选择其中的一个target运行，可以通过单击右上角的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/vbaADDwDQqOT7FE9NrVypw/zh-cn_image_0000002602186467.png?HW-CC-KV=V1&HW-CC-Date=20260611T072642Z&HW-CC-Expire=86400&HW-CC-Sign=5E0E6FBB74B19AE8125B6A0E6AC9948F9AFC2CD85F373125A2CB750A63545575)图标，指定需要调试或运行的**Product**下对应的**Module Target**，然后单击**Apply**保存。

说明

在选择需要调试或运行的target时，需要注意选择该target所属的Product，否则将找不到可调试和运行的target。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/wukWwwzYTNukuxSEF5mHmg/zh-cn_image_0000002602066411.png?HW-CC-KV=V1&HW-CC-Date=20260611T072642Z&HW-CC-Expire=86400&HW-CC-Sign=68F7E8D8994B665A64AF484AB31B842F37A53BEC9AA53766F92F7A881166925E)
...
* 使用配置文件配置align target和fallback target，仅支持DevEco Studio界面**Build**菜单栏功能，不支持**Run**菜单栏功能，可通过[hdc命令行工具](../../../../系统/调测调优/调试命令/hdc/hdc.md)进行推包运行、调试。

多个target的优先级顺序为：align target > 命令行指定模块target > 父级模块target > fallback target > default。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2b/v3/989wGrpeSGurf70i9pkSMA/zh-cn_image_0000002571546934.png?HW-CC-KV=V1&HW-CC-Date=20260611T072642Z&HW-CC-Expire=86400&HW-CC-Sign=B412F021DE34579B2123B8724D0D87B5F13B850E0B21A2E19A3EC93A5BBA5853)
