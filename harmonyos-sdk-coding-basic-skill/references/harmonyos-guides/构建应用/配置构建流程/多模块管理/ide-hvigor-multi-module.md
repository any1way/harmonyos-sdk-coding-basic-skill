...
scraped_at: 2026-06-01T15:25:51+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:42ac8d520f52155ec52e08437bf468592d996804f88af8234f97905db9d1cfdc
---
...
工程级build-profile.json5配置文件中"modules"字段，用于记录工程下的模块信息，主要包含模块名称、模块的源码路径以及模块的 target 信息。target信息主要用于定制多目标构建产物，更多详细信息可参考[配置多目标产物](../配置多目标产物/ide-customized-multi-targets-and-products.md)章节。
...
Hvigor支持在[hvigorconfig.ts脚本](../../概述/构建系统生命周期/ide-hvigor-life-cycle.md#section810245135914)中动态添加或排除某个模块，具体API及示例可参考[HvigorConfig](../../扩展构建能力/扩展构建API/基础构建能力/ide-hvigor-api.md#section7253174081515)。
...
更多构建HAR/HSP包命令，可参考[命令行工具](../../../命令行工具/命令行构建工具（hvigorw）/ide-hvigor-commandline.md#section9580122622012)章节。
