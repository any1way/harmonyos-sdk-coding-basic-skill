...
scraped_at: 2026-06-01T15:26:11+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:f01d821ab2a6bd711291c9eca9fd018b1d4bf764c01fc6dd0d14b1035d3c325f
---
...
* 通过命令行构建：
  + 执行命令，其中<task>替换为具体任务名：
    ...
    ```
  + 在[hvigor-config.json5](../../配置文件/hvigor-config.json5文件/ide-hvigor-set-options.md)中配置execution.daemon选项。
...
* 修改[hvigor-config.json5文件](../../配置文件/hvigor-config.json5文件/ide-hvigor-set-options.md)中的nodeOptions.maxOldSpaceSize配置。
* 执行命令修改守护进程内存，示例如下：
...
* 修改[hvigor-config.json5文件](../../配置文件/hvigor-config.json5文件/ide-hvigor-set-options.md)中的nodeOptions.maxSemiSpaceSize配置。
* 执行命令修改守护进程内存，示例如下：
