...
scraped_at: 2026-06-01T15:26:12+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:4d31c623980f9b0c52a078a2d4f2ffbf7f14f79de32c1e467918668c08f7d7d7
---
...
* 通过命令行构建：
  + 执行命令，其中<task>替换为具体任务名：
    ...
    ```
  + 在[hvigor-config.json5](../../配置文件/hvigor-config.json5文件/ide-hvigor-set-options.md)中配置execution.parallel选项。
