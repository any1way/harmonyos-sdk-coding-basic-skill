...
scraped_at: 2026-06-01T15:26:13+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:68864785b114d252293d1669bdc7598a59c0d9dd1b5668f4b758f683b58bd32f
---
...
* 通过命令行构建：
  + 执行命令，其中<task>替换为具体任务名：
    ...
    ```
  + 在[hvigor-config.json5](../../配置文件/hvigor-config.json5文件/ide-hvigor-set-options.md)中配置execution.incremental选项。
