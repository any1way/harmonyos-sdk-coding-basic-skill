...
scraped_at: 2026-06-01T15:26:37+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:a21e1a24565b2001e2b8aa15959fcfe10c7697ae214497f535b389e984747b38
---
...
1. 在[hvigor-config.json5](../../../配置文件/hvigor-config.json5文件/ide-hvigor-set-options.md)中调整线程相关配置：hvigor.pool.maxSize、ohos.arkCompile.maxSize、hvigor.enableMemoryCache。
2. 执行任务时关闭[parallel模式](../../../提升构建效率/并行构建/ide-hvigor-improve-performance.md)。
...
参考[最佳实践：模块化设计](../../../../../best-practices/应用架构/模块化设计/bpta-modular-design.md)。
...
* 通过[pickFirsts、pickLasts或select字段](../../../配置构建流程/配置CPP/ide-hvigor-cpp.md#section17675528161517)设置.so文件的优先级。
...
网络不通，或[ohpm镜像仓库地址](../../../../命令行工具/三方依赖管理工具（ohpm）/ohpmrc/ide-ohpmrc.md#zh-cn_topic_0000001792216397_默认配置项)、oh-package.json5中依赖的包名、版本号不正确。
...
2. [关闭守护进程](../../../提升构建效率/守护进程/ide-hvigor-daemon.md)后重新编译，验证该问题是否与守护进程有关。
