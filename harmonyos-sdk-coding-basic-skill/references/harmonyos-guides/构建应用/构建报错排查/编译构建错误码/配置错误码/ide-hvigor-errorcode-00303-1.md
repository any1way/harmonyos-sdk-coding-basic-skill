...
scraped_at: 2026-06-01T15:26:36+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:414ca2d10d2a362c67d7242962a10026f181111abeb91c542e8a0a44a1e09e2f
---
...
1、确保在工程级oh-package.json5中正确配置[parameterFile](../../../../命令行工具/三方依赖管理工具（ohpm）/oh-package.json5/ide-oh-package-json5.md#section122411462820)字段。
...
确保[abiFilters](../../../配置构建流程/配置CPP/ide-hvigor-cpp.md#section0721057575)配置的是有效值。
...
在工程级oh-package.json5文件中添加[parameterFile](../../../../命令行工具/三方依赖管理工具（ohpm）/oh-package.json5/ide-oh-package-json5.md#section122411462820)字段，并确保配置正确。
...
具体配置方式请参考[声明权限](../../../../系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)，需要满足以下条件：
...
在module.json5中type为form的ExtensionAbility中配置[metadata字段](<../../../../应用框架/Form Kit（卡片开发服务）/ArkTS卡片开发（推荐）/配置ArkTS卡片的配置文件/arkts-ui-widget-configuration.md>)。
...
在module.json5中type为form的ExtensionAbility中增加metadata字段，补充一个name为“ohos.extension.form”的对象值，并配置对应的resource值，具体配置方式参考[配置卡片的配置文件](<../../../../应用框架/Form Kit（卡片开发服务）/ArkTS卡片开发（推荐）/配置ArkTS卡片的配置文件/arkts-ui-widget-configuration.md>)。
...
2. 检查项目根目录下的[hvigorconfig.ts文件](../../../概述/构建系统生命周期/ide-hvigor-life-cycle.md#section810245135914)，确保includeNode方法的参数name字段存在且非空。
...
2. 检查项目根目录下的[hvigorconfig.ts文件](../../../概述/构建系统生命周期/ide-hvigor-life-cycle.md#section810245135914)，确保includeNode方法的参数srcPath字段存在且非空。
...
检查项目根目录下的[hvigorconfig.ts文件](../../../概述/构建系统生命周期/ide-hvigor-life-cycle.md#section810245135914)，确保includeNode方法的参数srcPath字段为相对路径。
...
将当前har模块配置为[字节码har](../../../配置构建流程/构建HAR/ide-hvigor-build-har.md#section16598338112415)。
...
确保buildVersion是一个有效值，具体要求请参考[app.json5的buildVersion](../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/app.json5配置文件/app-configuration-file.md#配置文件标签)。
