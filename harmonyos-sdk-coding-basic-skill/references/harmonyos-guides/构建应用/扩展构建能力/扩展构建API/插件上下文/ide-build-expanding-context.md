...
scraped_at: 2026-06-01T15:26:21+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:76b4a83e567172c1d2e373641816957aaed0f29b7fc490db54cb5f62c12531cb
---
## OhosPluginId
...
| 类型 | 说明 |
| --- | --- |
| [Product](../基础构建能力/ide-hvigor-api.md#section1553414254713) | 当前构建指定的product对象 |
...
| 类型 | 说明 |
| --- | --- |
| [SdkDetails](../基础构建能力/ide-hvigor-api.md#section1463642114714) | SDK相关的信息 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (target: [Target](../基础构建能力/ide-hvigor-api.md#section12392182963714)) => void | 是 | 入参类型为Target，返回类型为void的函数 |
