...
scraped_at: 2026-06-11T15:32:53+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:ee41e20b6fc23a4813d3d67d7ca3de7be25bd548b9cd4888af45926b8b2a2f06
---
## 功能介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/YfFrR0JdTc2zkAp4D8JDrg/zh-cn_image_0000002558607840.png?HW-CC-KV=V1&HW-CC-Date=20260611T073251Z&HW-CC-Expire=86400&HW-CC-Sign=9E8C42BCF6D58D0FC8934A8EE1996AA476BC26E5AE9544A8960FEAE5772AD72D)
...
2. 所有命令执行前需完成[hdc环境配置](../../../../系统/调测调优/调试命令/hdc/hdc.md)，并进入shell模式。
...
2. 故障注入统计（Input Message Statistics）
   ...
   | 类型 | 描述 |
   | --- | --- |
   | type | 事件或控件注入的类型，事件注入类型范围请参考[随机测试命令参数](wukong-guidelines.md#随机测试)，控件注入类型范围请参考[ArkTS组件](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/arkui-declarative-comp.md)。 |
