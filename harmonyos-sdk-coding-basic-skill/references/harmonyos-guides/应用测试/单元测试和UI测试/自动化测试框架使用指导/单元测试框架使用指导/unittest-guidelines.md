...
scraped_at: 2026-06-11T15:32:43+08:00
doc_updated_at: 2026-04-21
content_hash: sha256:f5706a7d545693072807cc387de6860240ea647c358fbbba3893c7b4f757a70f
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/6kBtbrVlQx6EE9Tn80YCqQ/zh-cn_image_0000002581217681.png?HW-CC-KV=V1&HW-CC-Date=20260611T073202Z&HW-CC-Expire=86400&HW-CC-Sign=600B077CE4D8348CA036975F3C34A4E90B9DF2842A43BC024E7432C0414C3E47)

## 单元测试框架发布方式

单元测试框架以ohpm包独立发布，版本信息详见[服务组件官网](https://ohpm.openharmony.cn/#/cn/detail/@ohos%2Fhypium)。开发者下载DevEco Studio后，在应用工程中的[oh-package.json5](../../../../命令行工具/三方依赖管理工具（ohpm）/oh-package.json5/ide-oh-package-json5.md)文件中devDependencies节点中配置版本号即可使用对应版本框架功能。
...
测试脚本基于DevEco Studio编写，请下载[DevEco Studio](https://developer.huawei.com/consumer/cn/download/)并完成[hdc配置](../../../../系统/调测调优/调试命令/hdc/hdc.md#环境准备)。

### 新建测试脚本

参考[DevEco Studio指导](<../../../../编写与调试应用/开发自测试/测试框架/代码测试/Instrument Test/ide-instrument-test.md#section36049271219>)创建ArkTS测试用例。
...
下面给出测试类级别即测试文件执行示例，其他请参考[运行模式](<../../../../编写与调试应用/开发自测试/测试框架/代码测试/Instrument Test/ide-instrument-test.md#section1574003717165>)。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/dbxiE2wrSymGulvpkNDlMA/zh-cn_image_0000002550777586.png?HW-CC-KV=V1&HW-CC-Date=20260611T073202Z&HW-CC-Expire=86400&HW-CC-Sign=9B58C14BAB672734B54BEBDECD48A7AB4AE035BD2A2EAD61E9A60C56B7E9D9F9)

* 查看测试结果

测试执行后可直接在DevEco Studio中查看测试结果。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/S2Rhpp8lTE2tTr4uCHnPxQ/zh-cn_image_0000002581377645.png?HW-CC-KV=V1&HW-CC-Date=20260611T073202Z&HW-CC-Expire=86400&HW-CC-Sign=1CFB3939791814A429E244FAD391AC895AED0B725C0CF67D8971EA0087B518C4)

* 查看测试用例覆盖率

执行测试用例后可以查看测试用例覆盖率，具体操作请参考[覆盖率统计模式](<../../../../编写与调试应用/开发自测试/测试框架/代码测试/Instrument Test/ide-instrument-test.md#section1989615417457>)章节内的内容。
...
以下是单元测试过程中的常用命令，其他aa test命令及含义说明参考[命令指南说明](../../../../系统/调测调优/调试命令/aa工具/aa-tool.md)。
...
仅支持Mock应用工程中自定义对象，不支持Mock系统API对象。如需Mock系统API，请参考[系统模块Mock指南](../../../../编写与调试应用/开发自测试/测试框架/Mock能力/ide-test-mock.md#section8353132513310)。
