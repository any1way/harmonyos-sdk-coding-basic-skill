...
scraped_at: 2026-06-01T10:56:44+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:1fb09070a30c7afff372da9a70c92a585a0b8816574c5ae9e0fe6c57ea15d3a8
---
...
| 属性名称 | 含义 | 数据类型 | 是否可缺省 |
| --- | --- | --- | --- |
| [app](../app对象内部结构/app-structure.md) | 标识应用的全局配置信息。同一个应用的不同HAP的app配置必须保持一致。 | 对象 | 不可缺省。 |
| [deviceConfig](../deviceConfig内部结构/deviceconfig-structure.md) | 标识应用在具体设备上的配置信息。 | 对象 | 不可缺省。 |
| [module](../module对象内部结构/module-structure.md) | 标识HAP的配置信息。该标签下的配置只对当前HAP生效。 | 对象 | 不可缺省。 |
