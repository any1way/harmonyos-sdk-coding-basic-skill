...
scraped_at: 2026-06-12T11:54:07+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:80724c8e2b0f1e047450f16b17c33590ff77ec6dfb4a5eddefb177e042a77cbf
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/U96bXkmsTFq9fIo61hTCyw/zh-cn_image_0000002622857295.png?HW-CC-KV=V1&HW-CC-Date=20260612T035406Z&HW-CC-Expire=86400&HW-CC-Sign=0B89C23608CB79ADE4B17999FA5E6EB47604C6AF94B8152A56C24E46928B2AC6)
...
* **方式一：配置app.json5**
  ...
  [app.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/bmsSample/LayeredImage1/AppScope/app.json5#L16-L29)
* **方式二：配置module.json5**
  ...
  [module.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/bmsSample/LayeredImage1/entry/src/main/module.json5#L16-L74)
...
* **方式一：配置app.json5**
  ...
  3. 在[app.json5配置文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-configuration-file)中引用分层图标资源文件。示例如下：
     ...
     [app.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/bmsSample/LayeredImage2/AppScope/app.json5#L16-L29)
* **方式二：配置module.json5**
  ...
  3. 如果需要在桌面显示UIAbility图标，除了需要配置icon与label字段，还需要在skills标签下面的entities中添加"entity.system.home"、actions中添加"ohos.want.action.home"。
     ...
     [module.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/bmsSample/LayeredImage2/entry/src/main/module.json5#L16-L75)
