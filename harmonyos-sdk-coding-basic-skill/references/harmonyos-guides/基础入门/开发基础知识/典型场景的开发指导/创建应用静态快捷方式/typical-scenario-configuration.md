...
content_hash: sha256:31a174532fbfbdc9e3c0838cc3e3e17da73d2fdd85f039f247d8501f37e39eca
---
...
3. 在应用的module.json5文件中配置metadata，指向快捷方式的配置文件。
   ...
   [module.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/bmsSample/TypicalScenarioConfiguration/entry/src/main/module.json5#L16-L79)

安装应用后，长按桌面上的应用图标，图标上方会显示开发者配置的快捷方式：“添加收藏”和“分享好友”。点击相应标签，可启动对应的组件。应用配置的静态快捷方式在桌面上的展示效果如下图所示。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/Xh7IPIS6S5eA134wPFPFGA/zh-cn_image_0000002592377786.jpg?HW-CC-KV=V1&HW-CC-Date=20260612T035404Z&HW-CC-Expire=86400&HW-CC-Sign=5D9304F89AEF1B24DEE6FD39F84E6B11367B3AD5470FEC4B7A1714CE0D3D81D7)
