...
scraped_at: 2026-06-11T15:19:29+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:9e515ca884799a656bc8c279020f9c5dfdc6df04bd19fdef215597c9684fde72
---
## 使用场景
...
1. **在线构图**：AI推理框架需要调用NNRt的构图接口将推理框架的模型图转换为NNRt内部模型图。而系统内置的MindSpore Lite推理框架（具体可参考[MindSpore Lite Kit](<../../MindSpore Lite Kit（昇思推理框架服务）/模型部署/使用MindSpore Lite进行模型推理 (CC++)/mindspore-lite-guidelines.md>)）通过MindIR模型图对接NNRt。由于MindIR模型图和NNRt内部模型图格式兼容，因此MindSpore Lite无需调用NNRt的构图接口即可对接NNRt。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/18/v3/wd0jOIGuQGqh1DMLvNExxw/zh-cn_image_0000002592219794.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T071928Z&HW-CC-Expire=86400&HW-CC-Sign=584E037DF31CC2DB4EEBA587A35DAD33DC51C4FC5BBEA60F0B2D005A7F3498EC)
...
* [MindSpore Lite Kit](<../../MindSpore Lite Kit（昇思推理框架服务）/MindSpore Lite Kit简介/mindspore-lite-kit-introduction.md>)：HarmonyOS内置的轻量化AI引擎，提供统一推理接口和多后端硬件加速能力，使能手机、PC/2in1、TV等全场景智能应用。
