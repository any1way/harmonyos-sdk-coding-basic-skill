...
scraped_at: 2026-06-11T15:17:04+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:634c62700991986afdf3a9d77ed4bccf2210109e55ba6c07c649b125e206db7b
---
## 核函数运行验证时算子存在精度问题
...
1. 进行CPU域的功能验证，观察是否有日志报错。
   ...
   参考[工程化算子开发](../算子实现/工程化算子开发/工程化算子开发概述/cannkit-overview-of-engineering-operator.md)章节，编写CPU侧的运行验证代码，并进行运行验证。得到CPU域的精度比对结果如下。
...
2. gdb调试。下面的样例展示了拉起leakyrelu算子CPU侧运行程序的样例，该样例程序会直接抛出异常，直接gdb运行，查看调用栈信息分析定位即可。其他场景下开发者可以使用gdb打断点等基本操作进行调试。使用gdb调试AscendC程序的详细内容请参考[gdb调试](../算子调试调优/调测功能介绍/更多功能/gdb调试/cannkit-gdb.md)。
...
2. 如果有重复，重新打开一个终端窗口，按照[环境准备](../环境准备/cannkit-environment-preparation.md)章节设置环境变量。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/iVLNVznDSEucvxOWKMBzSQ/zh-cn_image_0000002592219690.png?HW-CC-KV=V1&HW-CC-Date=20260611T071702Z&HW-CC-Expire=86400&HW-CC-Sign=E4BD314772952FD30D0A315B66A054995CCC88E9380BFE02FD09DD4EA99E8413)
...
2. 获取日志文件。
   ...
   通过命令行方式，日志落盘地址由[Simulator仿真参数](../附录/调测工具样例与参数说明/ascendebug调测工具参数说明/cannkit-cli-parameters.md#simulator仿真参数)接口指定，缺省为当前操作路径的debug\_op.log。请根据实际路径打开日志文件。
3. 截取调测命令，重新执行后再分析。
   ...
   2. 手动拷贝opc npu compile start后的命令，如图2所示，并在终端窗口执行，通过打屏或者落盘的日志文件进一步分析问题。
      ...
      **图2** NPU编译命令
      ...
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bf/v3/EShu4S6NTN63u0V584jRyQ/zh-cn_image_0000002592379624.png?HW-CC-KV=V1&HW-CC-Date=20260611T071702Z&HW-CC-Expire=86400&HW-CC-Sign=838F8A86F445C9AFC25506CCB51CE894A7E5F9E62875CC495E1FEB2E1A7023C2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/aJEifVVnT2ySvYo1hiOhiA/zh-cn_image_0000002622859133.png?HW-CC-KV=V1&HW-CC-Date=20260611T071702Z&HW-CC-Expire=86400&HW-CC-Sign=003D3F4A24A899F963F0045EA77827EB22AB6AAFAC32693F3CC257B903864607)
...
2. 获取日志文件。
   ...
   通过命令行方式，日志落盘地址由[NPU调测参数](../附录/调测工具样例与参数说明/ascendebug调测工具参数说明/cannkit-cli-parameters.md#npu调测参数)接口指定，缺省为当前操作路径的debug\_op.log。请根据实际路径打开日志文件。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/56/v3/mE40aoavQEqrECO3Jy0eCg/zh-cn_image_0000002622699253.png?HW-CC-KV=V1&HW-CC-Date=20260611T071702Z&HW-CC-Expire=86400&HW-CC-Sign=D791CA392FDA94E225B94FB9F137A746E3E4031C795E040B85A538507BC7CE8A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/ugS0WG_BQsOnXJQ3aqeb8g/zh-cn_image_0000002592219692.png?HW-CC-KV=V1&HW-CC-Date=20260611T071702Z&HW-CC-Expire=86400&HW-CC-Sign=B3F8F397F53A65F359508C15503ABEBE180B6996CB5B84D7A9AFB0C3861D9A28)
...
2. 截取Tiling调测命令，重新执行，根据提示进一步定位Tiling代码问题。
   ...
   执行命令之前，请确保当前终端[环境准备](../环境准备/cannkit-environment-preparation.md)设置并生效。
...
* 建议4：请参考[Simulator仿真参数](../附录/调测工具样例与参数说明/ascendebug调测工具参数说明/cannkit-cli-parameters.md#simulator仿真参数)设置CAModel仿真参数，如block num建议设置为1。
