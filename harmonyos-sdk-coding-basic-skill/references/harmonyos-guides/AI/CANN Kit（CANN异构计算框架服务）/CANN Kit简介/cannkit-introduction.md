...
scraped_at: 2026-06-01T15:12:29+08:00
doc_updated_at: 2026-05-12
content_hash: sha256:7262427dc9921445ffbf369724e277a07a9729d41dc0b9b5ea4cb1acaf59bf64
---
...
* 可变data\_type：用于模型输入输出数据类型多样性的场景，无需修改训练好的模型，在使用OMG工具进行[模型转换](../模型转换/离线模型转换/OMG参数/cannkit-overall-parameter.md)时，通过指定输入、输出数据类型使得同一个模型适用于不同输入输出的场景。
