...
content_hash: sha256:6371221f2cdc1bd354a0d0befdc4f91065840272c79ac73dadb379fd2c71f728
---
## 简介
...
6. ### 新增外挂lora，追加以下内容
7. "lora_config": {
8. "rank": 32, ### LoRA秩大小，影响模型表达能力
9. "alpha": 32, ### LoRA缩放因子，通常设置为与rank相同的值
10. "quant_state": false ### 是否启用量化状态，在LoRA训练中建议设为False
11. }
12. }
13. }
14. }
...
参考[量化参数提取导出](../插件式量化/cannkit-plug-in-quantification.md#量化参数提取导出)。量化参数导出的作用是输出量化文件和导出onnx所用的fake\_quant\_weight.pth。
