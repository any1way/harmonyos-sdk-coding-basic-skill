...
scraped_at: 2026-06-11T15:18:41+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:5b97f07344cecd17d614b0de07868dc0ef29fb05348167185d088b74c066ed90
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/x4Zs5_OUQx-ItFGEargi2g/zh-cn_image_0000002592219756.png?HW-CC-KV=V1&HW-CC-Date=20260611T071840Z&HW-CC-Expire=86400&HW-CC-Sign=6E6AD1186CF6437A5AB2C723D05C0512C535FBA3F40013A2E46BD04338DAC12F)
...
21. switch (name) {
22. case InsightIntentExecutorImpl.VIEW_TRAVEL_GUIDES:
23. return this.viewTravelGuides(param, pageLoader);
24. default:
25. break;
26. }
...
41. */
42. private viewTravelGuides(param: Record<string, Object>,
43. pageLoader: window.WindowStage): Promise<insightIntent.ExecuteResult> {
44. return new Promise((resolve, reject) => {
45. pageLoader.loadContent('pages/TravelGuidePage')
46. .then(() => {
47. const entityId: string = (typeof param.entityId === 'string') ? param.entityId : '';
48. console.info(`Intent param, entityId: ${entityId}`);
49. const data: insightIntent.ExecuteResult = {
50. code: 0,
51. result: {
...
58. console.error(`Intent execute failed, Code: ${err?.code}, message: ${err?.message}`);
59. const data: insightIntent.ExecuteResult = {
60. code: -1,
61. result: {
