...
scraped_at: 2026-06-01T15:14:28+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:7a4eb47738ea30d41f8211c5f27c624de48fbf05e52c39832cd1e0ef3740afc1
---
## 适用场景
...
1. 引用相关类添加至工程。
   ...
   ```
2. 配置输入文本框和按钮，调用分词[textProcessing.getWordSegment](<../../../../harmonyos-references/Natural Language Kit（自然语言理解服务）/ArkTS API/textProcessing（文本处理）/natural-language-text-processing-api.md#textprocessinggetwordsegment>)接口。
   ...
   25. })
   ```
3. 在界面上展示分词结果[WordSegment](<../../../../harmonyos-references/Natural Language Kit（自然语言理解服务）/ArkTS API/textProcessing（文本处理）/natural-language-text-processing-api.md#wordsegment>)。
