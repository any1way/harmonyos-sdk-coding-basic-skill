...
scraped_at: 2026-06-01T15:14:30+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:d8510bd4b7839a622c3f4d1a47b192855557d02078c5058cb218d43286f1a892
---
## 适用场景
...
2. 配置输入文本框。
   ...
   11. })
   ```
3. 配置按钮，调用实体抽取[textProcessing.getEntity](<../../../../harmonyos-references/Natural Language Kit（自然语言理解服务）/ArkTS API/textProcessing（文本处理）/natural-language-text-processing-api.md#textprocessinggetentity>)接口。
