...
scraped_at: 2026-06-11T15:19:37+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:c7653f2f43db71efced83d5913d0d7e1f05a10f26545902574d7dcf82c55a0c8
---
## 场景介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/09/v3/vzRr_JNkSBGTOcQvTzRgjw/zh-cn_image_0000002592219796.png?HW-CC-KV=V1&HW-CC-Date=20260611T071936Z&HW-CC-Expire=86400&HW-CC-Sign=264B1220DE7B68C3ABADA2346378E8B3578F62070290AE85D96D797A848A0839)

**图2** 活体检测示意图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/76/v3/BfpjjbF0SQ6GjKNt-rzVRQ/zh-cn_image_0000002592379730.png?HW-CC-KV=V1&HW-CC-Date=20260611T071936Z&HW-CC-Expire=86400&HW-CC-Sign=068289533EB4691BEB9EA017DCA3CC338F62C6FACD88D5AD4D215FAFBE231F9D)
...
以下仅列出demo中调用的部分主要接口，具体API说明详见[API参考](<../../../../harmonyos-references/Vision Kit（场景化视觉服务）/ArkTS API/interactiveLiveness（人脸活体检测）/vision-interactive-liveness.md>)。

| 接口名 | 描述 |
| --- | --- |
| [startLivenessDetection](<../../../../harmonyos-references/Vision Kit（场景化视觉服务）/ArkTS API/interactiveLiveness（人脸活体检测）/vision-interactive-liveness.md#startlivenessdetection>)(config: InteractiveLivenessConfig): Promise<boolean> | 跳转到人脸活体检测页面的入口 |
| [getInteractiveLivenessResult](<../../../../harmonyos-references/Vision Kit（场景化视觉服务）/ArkTS API/interactiveLiveness（人脸活体检测）/vision-interactive-liveness.md#getinteractivelivenessresult>)(): Promise<InteractiveLivenessResult> | 获取人脸活体检测的结果。使用Promise异步回调 |
...
1. 将实现人脸活体检测相关的类添加至工程。
   ...
   ```
2. 在module.json5文件中添加CAMERA权限，其中reason，abilities标签必填，配置方式参见[requestPermissions标签说明](../../../系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md#在配置文件中声明权限)。
...
6. 触发CAMERA权限校验。
   ...
   14. }
   ```
7. 配置人脸活体检测控件的配置项[InteractiveLivenessConfig](<../../../../harmonyos-references/Vision Kit（场景化视觉服务）/ArkTS API/interactiveLiveness（人脸活体检测）/vision-interactive-liveness.md#interactivelivenessconfig>)，用于跳转到人脸活体检测控件。

   配置中具体的参数可参考[API文档](<../../../../harmonyos-references/Vision Kit（场景化视觉服务）/ArkTS API/interactiveLiveness（人脸活体检测）/vision-interactive-liveness.md>)。
   ...
   5. };
   ```
8. 调用interactiveLiveness的[startLivenessDetection](<../../../../harmonyos-references/Vision Kit（场景化视觉服务）/ArkTS API/interactiveLiveness（人脸活体检测）/vision-interactive-liveness.md#startlivenessdetection>)接口，判断跳转到人脸活体检测控件是否成功。
   ...
   16. }
   ```
9. 检测结束后回到当前界面，可调用interactiveLiveness的[getInteractiveLivenessResult](<../../../../harmonyos-references/Vision Kit（场景化视觉服务）/ArkTS API/interactiveLiveness（人脸活体检测）/vision-interactive-liveness.md#getinteractivelivenessresult>)接口，验证人脸活体检测的结果。
