...
content_hash: sha256:4c25e75a5dcfd5751b5d9201cbe69b1b1986d200bffb645357347d0e97c6ffcd
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/jVYUiMtYS9-3odCyhAiUaA/zh-cn_image_0000002622859239.png?HW-CC-KV=V1&HW-CC-Date=20260611T071919Z&HW-CC-Expire=86400&HW-CC-Sign=F89AC77F18A6596F1DF326E8E5510DB71863E1E0F26B5513D5BAD6088FFA70EC)
...
以下仅列出demo中调用的部分主要接口，具体API说明详见[API参考](<../../../../harmonyos-references/Vision Kit（场景化视觉服务）/ArkTS组件/CardRecognition（卡证识别控件）/vision-card-recognition.md>)。

| 接口名 | 描述 |
| --- | --- |
| [CardRecognition](<../../../../harmonyos-references/Vision Kit（场景化视觉服务）/ArkTS组件/CardRecognition（卡证识别控件）/vision-card-recognition.md#cardrecognition>) | 卡证识别控件 |
| [CardRecognitionResult](<../../../../harmonyos-references/Vision Kit（场景化视觉服务）/ArkTS组件/CardRecognition（卡证识别控件）/vision-card-recognition.md#cardrecognitionresult>) | 卡证识别结果 |
...
2. 配置页面的布局，选择需要识别的卡证类型和需要识别的卡证页面，配置对应设置项，在回调中获取结果返回值。
   ...
   从5.1.1(19)开始，[CardRecognition](<../../../../harmonyos-references/Vision Kit（场景化视觉服务）/ArkTS组件/CardRecognition（卡证识别控件）/vision-card-recognition.md#cardrecognition>)接口中的callback参数废弃，请使用onResult代替。

   以下分别为身份证、银行卡、护照、驾驶证、行驶证、港澳居民来往内地通行证、台湾居民来往大陆通行证的示例代码。

   ```
   1. const TAG = 'CardRecognition';
   ...
   8. // 银行卡
   9. CardRecognition({
   10. supportType: CardType.CARD_BANK,
   11. // 银行卡为单面识别
   12. cardSide: CardSide.FRONT,
   13. cardRecognitionConfig: {
   14. defaultShootingMode: ShootingMode.MANUAL,
   15. isPhotoSelectionSupported: true,
   16. cardContentConfig: { bankCard: { isBankNumberDialogShown: true} }
   17. },
   18. onResult: ((params: CardRecognitionResult) => {
   19. hilog.info(0x0001, TAG, `params code: ${params.code}`);
   20. hilog.info(0x0001, TAG, `params cardType: ${params.cardType}`);
   21. hilog.info(0x0001, TAG, `params cardInfo: ${JSON.stringify(params.cardInfo?.main)}`);
   22. })})
   23. }
   24. .height('100%')
   25. .width('100%')
   ...
   8. // 护照
   9. CardRecognition({
   10. supportType: CardType.CARD_PASSPORT,
   11. // 护照为单面识别
   12. cardSide: CardSide.FRONT,
   13. cardRecognitionConfig: {
   14. defaultShootingMode: ShootingMode.MANUAL,
   ...
   18. hilog.info(0x0001, TAG, `params code: ${params.code}`);
   19. hilog.info(0x0001, TAG, `params cardType: ${params.cardType}`);
   20. hilog.info(0x0001, TAG, `params cardInfo: ${JSON.stringify(params.cardInfo?.main)}`);
   21. })})
   22. }
   23. .height('100%')
   24. .width('100%')
   ...
   8. // 驾驶证
   9. CardRecognition({
   10. supportType: CardType.CARD_DRIVER_LICENSE,
   11. // 驾驶证可双面识别
   12. cardSide: CardSide.DEFAULT,
   13. cardRecognitionConfig: {
   14. defaultShootingMode: ShootingMode.MANUAL,
   ...
   8. // 行驶证
   9. CardRecognition({
   10. supportType: CardType.CARD_VEHICLE_LICENSE,
   11. // 行驶证可双面识别
   12. cardSide: CardSide.DEFAULT,
   13. cardRecognitionConfig: {
   14. defaultShootingMode: ShootingMode.MANUAL,
   ...
   8. // 港澳居民来往内地通行证
   9. CardRecognition({
   10. supportType: CardType.CARD_MAINLAND_TRAVEL_PERMIT_HK_MO,
   11. // 港澳居民来往内地通行证可双面识别
   12. cardSide: CardSide.DEFAULT,
   13. cardRecognitionConfig: {
   14. defaultShootingMode: ShootingMode.MANUAL,
   ...
   8. // 台湾居民来往大陆通行证
   9. CardRecognition({
   10. supportType: CardType.CARD_MAINLAND_TRAVEL_PERMIT_TW,
   11. // 台湾居民来往大陆通行证可双面识别
   12. cardSide: CardSide.DEFAULT,
   13. cardRecognitionConfig: {
   14. defaultShootingMode: ShootingMode.MANUAL,
