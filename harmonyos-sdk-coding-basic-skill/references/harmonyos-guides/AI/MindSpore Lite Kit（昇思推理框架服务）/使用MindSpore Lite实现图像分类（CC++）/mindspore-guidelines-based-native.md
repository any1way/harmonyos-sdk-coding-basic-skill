...
scraped_at: 2026-06-11T15:19:21+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:f83329806af55aa7c9cb0bc4d48778e8c5ca94d4386ec515c4745f95a1f0e2e3
---
## 场景说明

开发者可以使用[MindSpore](<../../../../harmonyos-references/MindSpore Lite Kit（昇思推理框架服务）/C API/模块/MindSpore/capi-mindspore.md>)，在UI代码中直接集成MindSpore Lite能力，快速部署AI算法，进行AI模型推理，实现图像分类的应用。
...
如果开发者有其他图像分类的预训练模型，请参考[MindSpore Lite 模型转换](<../使用MindSpore Lite进行模型转换/mindspore-lite-converter-guidelines.md>)介绍，将原始模型转换成.ms格式。

### 编写推理代码

在 entry/src/main/cpp/mslite\_napi.cpp，调用[MindSpore](<../../../../harmonyos-references/MindSpore Lite Kit（昇思推理框架服务）/C API/模块/MindSpore/capi-mindspore.md>)实现端侧推理，推理代码流程如下。
...
1. 引用对应的头文件
   ...
   [mslite\_napi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MindSporeLiteKit/MindSporeLiteCDemo/entry/src/main/cpp/mslite_napi.cpp#L16-L28)
2. 读取模型文件
   ...
   [mslite\_napi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MindSporeLiteKit/MindSporeLiteCDemo/entry/src/main/cpp/mslite_napi.cpp#L30-L35)
   ...
   [mslite\_napi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MindSporeLiteKit/MindSporeLiteCDemo/entry/src/main/cpp/mslite_napi.cpp#L57-L84)
3. 创建上下文，设置线程数、设备类型等参数，并加载模型。本样例模型，不支持使用NNRt推理。
   ...
   [mslite\_napi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MindSporeLiteKit/MindSporeLiteCDemo/entry/src/main/cpp/mslite_napi.cpp#L86-L136)
4. 设置模型输入数据，执行模型推理。
   ...
   [mslite\_napi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MindSporeLiteKit/MindSporeLiteCDemo/entry/src/main/cpp/mslite_napi.cpp#L37-L39)
   ...
   [mslite\_napi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MindSporeLiteKit/MindSporeLiteCDemo/entry/src/main/cpp/mslite_napi.cpp#L41-L55)
   ...
   [mslite\_napi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MindSporeLiteKit/MindSporeLiteCDemo/entry/src/main/cpp/mslite_napi.cpp#L138-L179)
5. 调用以上方法，实现完整的模型推理流程。
   ...
   [mslite\_napi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MindSporeLiteKit/MindSporeLiteCDemo/entry/src/main/cpp/mslite_napi.cpp#L181-L255)
...
1. 在 entry/src/main/cpp/types/libentry/Index.d.ts，定义ArkTS接口runDemo() 。内容如下：
   ...
   [index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MindSporeLiteKit/MindSporeLiteCDemo/entry/src/main/cpp/types/libentry/index.d.ts#L16-L18)
...
1. 此处以获取相册图片为例，调用[@ohos.file.picker](<../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.picker (选择器)/js-apis-file-picker.md>) 实现相册图片文件的选择。
2. 根据模型的输入尺寸，调用[@ohos.multimedia.image](<../../../../harmonyos-references/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/模块描述/arkts-apis-image.md>) （实现图片处理）、[@ohos.file.fs](<../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md>) （实现基础文件操作） API对选择图片进行裁剪、获取图片buffer数据，并进行标准化处理。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MindSporeLiteKit/MindSporeLiteCDemo/entry/src/main/ets/pages/Index.ets#L16-L338)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6b/v3/H2WWEDp3RSOXCRUom-egGQ/zh-cn_image_0000002592219792.png?HW-CC-KV=V1&HW-CC-Date=20260611T071919Z&HW-CC-Expire=86400&HW-CC-Sign=27068AE07AC1D95935A0EC9A1C6119912E57578D3A6BCDC71F44DF2A3CF32B18) ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/ozn-1paVQNuZ1rJQikyboA/zh-cn_image_0000002592379724.png?HW-CC-KV=V1&HW-CC-Date=20260611T071919Z&HW-CC-Expire=86400&HW-CC-Sign=127EE3B81AFF902D908024796C0B1E50ED2EFE0410CAC326093101F6E4848622)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1a/v3/gC02xkDsRJOPiISluONjug/zh-cn_image_0000002622859233.png?HW-CC-KV=V1&HW-CC-Date=20260611T071919Z&HW-CC-Expire=86400&HW-CC-Sign=2FD0F37C47D92D708357FAF7265EF280740802D639B221CDD5AA2F1B85D551B3) ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/C6yh0dGpSfaUh8y-A62iIA/zh-cn_image_0000002592379726.png?HW-CC-KV=V1&HW-CC-Date=20260611T071919Z&HW-CC-Expire=86400&HW-CC-Sign=5C7F38579403F2837B1F7AA238B16386C4AEA72929C974E7B2074B6E8237C3E1)
