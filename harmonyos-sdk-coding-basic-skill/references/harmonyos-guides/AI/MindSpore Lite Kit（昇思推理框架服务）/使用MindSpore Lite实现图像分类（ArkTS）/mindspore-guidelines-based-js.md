...
scraped_at: 2026-06-11T15:19:20+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:59303deff8c38f582cb8a7fcda07a95b10c4f7530e53cbe836e5a0d21c6e7443
---
## 场景说明

开发者可以使用[@ohos.ai.mindSporeLite](<../../../../harmonyos-references/MindSpore Lite Kit（昇思推理框架服务）/ArkTS API/@ohos.ai.mindSporeLite (端侧AI框架)/js-apis-mindsporelite.md>)，在UI代码中集成MindSpore Lite能力，快速部署AI算法，进行AI模型推理，实现图像分类的应用。

图像分类可实现对图像中物体的识别，在医学影像分析、自动驾驶、电子商务、人脸识别等领域有广泛的应用。

若需基于本Demo适配自有模型，请优先选择静态Shape模型。由于ArkTS暂不支持动态Shape，如确有相关需求，请参考[使用MindSpore Lite实现图像分类（C/C++）](<../使用MindSpore Lite实现图像分类（CC++）/mindspore-guidelines-based-native.md>)，通过Native侧的[OH\_AI\_ModelResize](<../../../../harmonyos-references/MindSpore Lite Kit（昇思推理框架服务）/C API/头文件/model.h/capi-model-h.md#oh_ai_modelresize>)接口对模型inputs进行动态调整。
...
这里给出MindSpore Lite推理的通用开发流程中涉及的一些接口，具体请见下列表格。更多接口及详细内容，请见[@ohos.ai.mindSporeLite (推理能力)](<../../../../harmonyos-references/MindSpore Lite Kit（昇思推理框架服务）/ArkTS API/@ohos.ai.mindSporeLite (端侧AI框架)/js-apis-mindsporelite.md>)。
...
1. 工程默认设备定义的能力集可能不包含MindSporeLite。需在DevEco Studio工程的entry/src/main目录下，手动创建syscap.json文件，内容如下：
   ...
   13. }
   ```
2. 调用[@ohos.ai.mindSporeLite](<../../../../harmonyos-references/MindSpore Lite Kit（昇思推理框架服务）/ArkTS API/@ohos.ai.mindSporeLite (端侧AI框架)/js-apis-mindsporelite.md>)实现端侧推理。具体开发过程及细节如下：
   ...
   [model.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MindSporeLiteKit/MindSporeLiteArkTSDemo/entry/src/main/ets/pages/model.ets#L16-L48)
...
3. 加载模型文件，调用推理函数，对相册选择的图片进行推理，并对推理结果进行处理。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MindSporeLiteKit/MindSporeLiteArkTSDemo/entry/src/main/ets/pages/Index.ets#L16-L351)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/G23Yjs__SyiZHrLkDS6JZQ/zh-cn_image_0000002592219790.png?HW-CC-KV=V1&HW-CC-Date=20260611T071919Z&HW-CC-Expire=86400&HW-CC-Sign=D48E5EA52074D12F205C28204DD22B255543F77DFE89816F60D09E14C795A90B) ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/1EnTV6U9ST2kO1z35VwchQ/zh-cn_image_0000002592379724.png?HW-CC-KV=V1&HW-CC-Date=20260611T071919Z&HW-CC-Expire=86400&HW-CC-Sign=AB41A5B3BB13888B683768CBFD42546C56AF894A96C84B00DCE03AB25710B57E)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/01/v3/roDbTCuyTF6cA6XRA5XMEA/zh-cn_image_0000002622859233.png?HW-CC-KV=V1&HW-CC-Date=20260611T071919Z&HW-CC-Expire=86400&HW-CC-Sign=7789233DC176E19620900CF7433AD270AD7F67146A49941EBA281A290D1EEFB4) ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/nRzeL1IMSYyG664DswejIQ/zh-cn_image_0000002622699353.png?HW-CC-KV=V1&HW-CC-Date=20260611T071919Z&HW-CC-Expire=86400&HW-CC-Sign=923FBE4CBD8EC6DB551831D3BE7EF10608C696580191239750FB2BB0100DB69B)
