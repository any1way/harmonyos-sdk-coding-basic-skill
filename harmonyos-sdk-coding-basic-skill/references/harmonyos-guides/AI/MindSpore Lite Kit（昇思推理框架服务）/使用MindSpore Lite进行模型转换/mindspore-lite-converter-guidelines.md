...
scraped_at: 2026-06-01T15:14:17+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:5889708c34a787d987a647e1b4303dd0f784082e0fbb0023a823a9051c81fd08
---
## 场景介绍

MindSpore Lite AI模型部署流程是：

1. 开发者首先将原始模型（如：ONNX、CAFFE等）用MindSpore Lite模型转换工具，生成后缀为.ms的模型文件。MindSpore Lite Kit所支持的ONNX算子，可查询[MindSpore Lite Kit算子支持列表](<../附录/MindSpore Lite Kit算子支持列表/mindspore-lite-supported-operators.md>)，以确保模型转换成功。
2. 然后在代码中调用MindSpore Lite推理引擎接口，执行[模型推理](<../模型部署/使用MindSpore Lite进行模型推理 (CC++)/mindspore-lite-guidelines.md>)。
