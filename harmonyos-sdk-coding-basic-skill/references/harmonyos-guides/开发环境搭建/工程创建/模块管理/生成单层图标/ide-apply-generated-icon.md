...
content_hash: sha256:6807229483c26d89c6e3fc3ec9f482eb112f2d156d1f43f04828c2451a5d5cd5
---
...
1. 在工程中选中模块或文件，右键单击**New > Image Asset**，进入图标配置页面。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/avMzc6j9T2CFFEDfjPypLg/zh-cn_image_0000002571546492.png?HW-CC-KV=V1&HW-CC-Date=20260611T072209Z&HW-CC-Expire=86400&HW-CC-Sign=F8340BCF781D433CE175770E800A782725270FB0834998F2729570EC9F25D620 "点击放大")
2. 需要根据向导配置图标样式、大小等基本信息。
   ...
   * **Foreground Layer**：分层图标资源前景层。可配置下列字段信息：
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/7KbFDUO1RMOY3uL4Y2pDBQ/zh-cn_image_0000002571546494.png?HW-CC-KV=V1&HW-CC-Date=20260611T072209Z&HW-CC-Expire=86400&HW-CC-Sign=8EA696F62147521E367F4023E0CB3976B223E121FFD72D983833ECC6D2AE8553)
   ...
   * **Background Layer**：分层图标资源背景层。请配置下列字段信息：
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/18/v3/VsZBz-mPRWepCSYZfkio6g/zh-cn_image_0000002602065975.png?HW-CC-KV=V1&HW-CC-Date=20260611T072209Z&HW-CC-Expire=86400&HW-CC-Sign=D058C8162C6A84C8F4258ECC77C546D8A4BD9D5ED9C3A4D0E187FFC6EB043C74)
3. 点击**Next**，确认图标的存储路径和相应的尺寸信息，图标将默认存放在**resources** 目录下。点击**Finish**完成图标生成。
   ...
   * xxxldpi：表示超特大规模的屏幕密度（Extra Extra Extra Large-scale Dots Per Inch），适用于dpi取值为(480, 640]的设备。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/WrZt9j8qSp--WBe-FU0coQ/zh-cn_image_0000002571386860.png?HW-CC-KV=V1&HW-CC-Date=20260611T072209Z&HW-CC-Expire=86400&HW-CC-Sign=74FEAC622B684335C48369C23D28D73CD92DA007B53D0238EC10C4EBFED80D80)
4. 如需配置桌面或设置页面出现的应用图标，可将module.json5文件中icon字段修改为新生成的图标名称；如需修改启动页的icon图标，可将module.json5文件中startWindowIcon字段修改为新生成的图标名称。

   说明

   * 当上述字段配置了新生成的图标名称后，系统会根据当前设备状态优先从相匹配的限定词目录，即步骤3生成的不同尺寸的图标文件中寻找资源。具体请参考[资源匹配](../../../../基础入门/资源分类与访问/resource-categories-and-access.md)。
