...
scraped_at: 2026-06-01T15:18:08+08:00
doc_updated_at: 2026-01-15
content_hash: sha256:e7c3b26c81d9fb0f6c5722319f64f971b713c5a0f6c11570312dc14f631d7679
---
## 什么是端云一体化开发

为丰富HarmonyOS对云端开发的支持、实现端云联动，DevEco Studio以[Cloud Foundation Kit（云开发服务）](<../../../../../应用服务/Cloud Foundation Kit（云开发服务）/Cloud Foundation Kit简介/cloudfoundation-introduction.md>)为底座、在传统的“端开发”基础上新增“云开发”能力：开发者选择云开发工程模板，可创建一个同时包含端侧工程与云侧工程的端云一体化工程。之后，开发者在云侧工程对云函数或者云数据库等服务进行开发、调试和部署，而后在端侧工程通过Cloud Foundation Kit调用部署的云端服务。
...
DevEco Studio目前预置了通用云开发模板（[CloudDev]Empty Ability），该模板当前使用[Cloud Foundation Kit（云开发服务）](<../../../../../应用服务/Cloud Foundation Kit（云开发服务）/Cloud Foundation Kit简介/cloudfoundation-introduction.md>)搭建了基础的演示项目，不含业务属性。您可参考模板学习如何进行基础的端云工程开发，后续开发时可删除预置的页面代码。

[点击此处](../附录：云开发工程模板/通用云开发模板/agc-harmonyos-clouddev-emptyability.md)了解通用云开发模板的更多信息。
...
1. 选择云开发工程模板，根据工程向导[创建端云一体化开发工程](../开发端云工程/创建端云一体化开发工程/agc-harmonyos-clouddev-devproject.md)。
2. 分别为Cloud Foundation Kit提供的各个服务完成端云代码的开发、调试和部署。
   ...
   1. 开发云侧工程：在云侧工程开发Cloud Foundation Kit提供的服务，目前包括云函数、云对象和云数据库。
      * [开发云函数](../开发端云工程/开发云侧工程/开发云函数/agc-harmonyos-clouddev-cloudfunctions.md)：在云侧工程下创建并配置函数、开发函数代码、调试函数、部署函数到AGC云端。
      * [开发云对象](../开发端云工程/开发云侧工程/开发云对象/agc-harmonyos-clouddev-cloudobj.md)：在云侧工程下创建云对象、开发云对象代码、调试云对象、部署云对象到AGC云端。
      * [开发云数据库](../开发端云工程/开发云侧工程/开发云数据库/agc-harmonyos-clouddev-clouddb.md)：在云侧工程下创建对象类型、在对象类型中添加数据条目、部署云数据库到AGC云端。
   2. [部署云侧工程](../开发端云工程/部署云侧工程/agc-harmonyos-clouddev-deploy.md)：云侧工程代码开发调试完毕后，一键部署云侧工程到AGC云端。
   3. [开发端侧工程](../开发端云工程/开发端侧工程/agc-harmonyos-clouddev-appdevelop.md)：在端侧工程下通过Cloud Foundation Kit调用部署的云侧代码，包括调用云函数、调用云对象、访问云数据库、调用云存储。
...
支持[关联注册应用进行自动签名](../../../../../编写与调试应用/配置调试签名/ide-signing.md#section20943184413328)和[手动签名](../../../../../编写与调试应用/配置调试签名/ide-signing.md#section297715173233)两种方式。

### 模拟器支持情况

从6.0.0(20) Beta5版本开始支持模拟器开发，但与真机存在部分能力差异，详情请参见[模拟器与真机的差异](../../../../../编写与调试应用/使用模拟器运行应用/概述/模拟器与真机的差异/ide-emulator-specification.md)。

关于如何使用模拟器调试，请参见[使用模拟器调试](<../../../../../应用服务/Cloud Foundation Kit（云开发服务）/使用模拟器调试/cloudfoundation-emulator.md>)。
