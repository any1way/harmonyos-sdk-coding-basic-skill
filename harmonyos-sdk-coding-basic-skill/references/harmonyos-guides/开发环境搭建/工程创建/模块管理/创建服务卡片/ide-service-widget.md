...
scraped_at: 2026-06-11T15:22:11+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:cb944f0140fa303a168391ce47384cf630eaf2a7a885191bfb9a50d0d39f5e89
---
## 概述

[服务卡片（简称“卡片”）](<../../../../应用框架/Form Kit（卡片开发服务）/Form Kit简介/formkit-overview.md>)可将元服务/应用的重要信息以卡片的形式展示在桌面，用户可通过快捷手势使用卡片，通过轻量交互行为实现服务直达、减少层级跳转的目的。

卡片类型分静态卡片和动态卡片两种。静态卡片内存占用较小，有助于实现整机内存优化，可实现静态信息展示、刷新和点击跳转；动态卡片支持自定义交互、动效、滑动等功能，功能丰富但内存占用较大。

从编译产物角度，卡片包产物分为共包和独立包两种类型，详情请参考[创建ArkTS卡片](<../../../../应用框架/Form Kit（卡片开发服务）/ArkTS卡片开发（推荐）/创建ArkTS卡片/arkts-ui-widget-creation.md>)。
...
[创建一个工程](../../创建一个新的工程/ide-create-new-project.md)后，可以通过如下方法进行创建卡片。
...
2. 在**Choose a Template for Your Service Widget**界面中，选择卡片模板，单击**Next**。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/UCuczkgMSBuIa-LaNJP_Jg/zh-cn_image_0000002571386872.png?HW-CC-KV=V1&HW-CC-Date=20260611T072211Z&HW-CC-Expire=86400&HW-CC-Sign=CEEADA28A251752354DCE21110D1C2FE290E4DB88DE34060E8F3D5F6A71EBA36)
3. 在**Configure Your Service Widget**界面中，配置卡片的基本信息，包括：
   ...
   * **Module name：**卡片所属的模块。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/A7ojR1Z7Tg-E4jbKfvxarw/zh-cn_image_0000002602065987.png?HW-CC-KV=V1&HW-CC-Date=20260611T072211Z&HW-CC-Expire=86400&HW-CC-Sign=F507A30202651D78C53921408CC8AC4D259037B1FAAEF319A6C65E19126756FF)
4. 单击**Finish**完成卡片的创建。创建完成后，工具会自动创建出卡片的布局文件，并在form\_config.json文件中写入服务卡片的属性字段，关于各字段的说明请参考[配置文件说明](<../../../../应用框架/Form Kit（卡片开发服务）/ArkTS卡片开发（推荐）/配置ArkTS卡片的配置文件/arkts-ui-widget-configuration.md>)。
5. 卡片创建完成后，请根据开发指导，完成卡片的开发，详情请参考[服务卡片开发指南](<../../../../应用框架/Form Kit（卡片开发服务）/ArkTS卡片开发（推荐）/ArkTS卡片提供方开发指导/arkts-ui-widget.md>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/-gnIjs7QTriIpsqvpndeWA/zh-cn_image_0000002602065989.png?HW-CC-KV=V1&HW-CC-Date=20260611T072211Z&HW-CC-Expire=86400&HW-CC-Sign=EC002CC7DB82B367B0221FBD8F729A6FEC57A637FDAAC19E1E4CC58FFA475819)

关于预览器的使用详细说明请参考[界面预览](../../../../编写与调试应用/界面预览/ide-previewer-01.md)。
