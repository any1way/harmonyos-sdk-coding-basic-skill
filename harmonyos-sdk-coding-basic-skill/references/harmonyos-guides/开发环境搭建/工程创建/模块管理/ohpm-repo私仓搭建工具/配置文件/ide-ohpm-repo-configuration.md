...
scraped_at: 2026-06-01T15:17:16+08:00
doc_updated_at: 2026-03-17
content_hash: sha256:632d7cddce03b297083c1e0c83833b21f16aeaa1a9878be400a39dbde6a076e9
---
...
* type: 插件名称，为custom。custom是自定义存储插件类型，自定义存储插件[开发流程见官方文档](../附录/自定义存储插件/ide-ohpm-repo-storageplugin.md)。
* config: 插件配置，具体为：
...
ohpm-repo从2.3.0版本开始支持自定义认证插件（需配套使用1.8.0及以上版本ohpm命令行工具），允许您开发定制化的认证插件来对接您自己的用户信息系统。自定义认证插件开发流程见[认证插件说明文档](../附录/自定义认证插件/ide-custom-auth-plugin.md)。
...
ohpm-repo从5.1.3版本开始支持自定义元数据规则校验，可以对oh-package.json5中部分字段开发定制化的校验规则。自定义元数据规则校验插件开发流程见[自定义元数据规则校验插件说明文档](../附录/自定义元数据规则校验插件/自定义元数据规则校验插件配置/ide-custom-metadata-rule-validation-config.md)。
