...
scraped_at: 2026-06-01T15:17:38+08:00
doc_updated_at: 2026-01-15
content_hash: sha256:c889ca82d643d2ab234b5e5948793ae6d8fc685ee4efcef2bff0eadbc9d76740
---
ohpm-repo 5.4.0版本开始，支持导入包权限数据。

## 前提条件

已成功执行 [export\_userinfo 命令](<../ohpm-repo export_userinfo/ide-ohpm-repo-export-userinfo.md>)、[import\_userinfo 命令](<../ohpm-repo import_userinfo/ide-ohpm-repo-import-userinfo.md>)、[batch\_download 命令](<../ohpm-repo batch_download/ide-ohpm-repo-batch-download.md>)、[batch\_publish 命令](<../ohpm-repo batch_publish/ide-ohpm-repo-batch-publish.md>)、[export\_pkgPermission 命令](<../ohpm-repo export_pkgPermission/ide-ohpm-repo-export-pkgpermission.md>)，确保每个包指定的包文件、用户和组织都存在。
...
在import\_pkgPermission命令后面配置<pkg\_permission\_list>参数，指定执行[export\_pkgPermission 命令](<../ohpm-repo export_pkgPermission/ide-ohpm-repo-export-pkgpermission.md>)导出的.json文件。
...
当[export\_pkgPermission命令](<../ohpm-repo export_pkgPermission/ide-ohpm-repo-export-pkgpermission.md>)导出的json文件中仅包含一个仓库的包权限数据时，可在import\_pkgPermission命令后面配置--target-repo <string>，用于指定待导入的仓库名称。
