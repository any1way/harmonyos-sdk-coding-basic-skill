...
scraped_at: 2026-06-01T15:17:36+08:00
doc_updated_at: 2026-01-15
content_hash: sha256:fa6b3bf41f7cd28d0511eada67b4c41c4e8009a09ac149589269b5b91722619b
---
导入用户DB数据。

## 前提条件

已成功执行[export\_userinfo 命令](<../ohpm-repo export_userinfo/ide-ohpm-repo-export-userinfo.md>)。
...
必须在import\_userinfo命令后面配置<zip\_file>参数，指定执行[export\_userinfo 命令](<../ohpm-repo export_userinfo/ide-ohpm-repo-export-userinfo.md>)导出的zip文件。
