...
scraped_at: 2026-06-01T15:17:33+08:00
doc_updated_at: 2026-01-15
content_hash: sha256:e2c1d3cdee78663f387e4310d6a569ea8b7d0296ea3096c6a758932f7805fa34
---
批量上传包文件。

## 前提条件

已成功执行[batch\_download 命令](<../ohpm-repo batch_download/ide-ohpm-repo-batch-download.md>)、 [export\_userinfo 命令](<../ohpm-repo export_userinfo/ide-ohpm-repo-export-userinfo.md>)、[import\_userinfo 命令](<../ohpm-repo import_userinfo/ide-ohpm-repo-import-userinfo.md>)，确保每个包指定的包文件、用户和组织都存在。
...
必须在batch\_publish命令后面配置<zip\_file>参数，指定执行[batch\_download命令](<../ohpm-repo batch_download/ide-ohpm-repo-batch-download.md>)导出的zip文件。
...
ohpm-repo 5.3.0版本开始支持配置多个仓库，当[batch\_download命令](<../ohpm-repo batch_download/ide-ohpm-repo-batch-download.md>)导出的zip文件中仅包含一个仓库目录时，可在batch\_publish命令后面配置--target-repo <string>，用于指定待上传的仓库名称。未配置默认上传仓库名称与[batch\_download命令](<../ohpm-repo batch_download/ide-ohpm-repo-batch-download.md>)导出的zip文件中的目录仓库名称保持一致，否则将报错。
