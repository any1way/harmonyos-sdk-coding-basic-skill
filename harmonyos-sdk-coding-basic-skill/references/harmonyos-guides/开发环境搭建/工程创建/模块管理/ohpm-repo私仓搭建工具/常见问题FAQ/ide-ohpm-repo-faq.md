...
scraped_at: 2026-06-01T15:17:44+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:7ce2cee761457c69fc82631f7250bc049e8aaf5e3160a43a6b70ddea38bd2957
---
## ohpm-repo私仓工具获取与升级

* 从[下载中心](https://developer.huawei.com/consumer/cn/download/ohpm-repo)上获取最新ohpm-repo工具包。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/_OK_PIfLQGSUADaajoyYUw/zh-cn_image_0000002602064959.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=CC8C5CAA1DF7807C04760C4FFC291491F059FC038307F218235E60D2F349F83B "点击放大")
* ohpm-repo升级指导：在升级之前请务必进行好数据的备份，具体的升级指导文档见：[ohpm-repo版本升级](../附录/版本升级/ide-ohpm-repo-upgrade.md)。
...
1. **账户的注册**
   ...
   * 通过ohpm-repo管理界面的注册按钮新增用户类型：
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/24f7nHHoTfiBgr9lGM68hA/zh-cn_image_0000002602185009.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=F94F743A78E4C943C7A95B2A2E523E83444932670A18205658FC9A57BB4D407E "点击放大")
   * 登录任一管理员账户，能够在ohpm-repo的用户管理界面新增用户并管理其他用户（删除用户，变更用户类型，重置密码）：

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/jRGUQBqcR3KPX1N378VFrQ/zh-cn_image_0000002602064963.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=214CEE5424842195F526B5FD7CD3872EEAEDF91B6D93FFE68A455E610723B5A6 "点击放大")
2. **账户的权限说明**
   * 系统管理员：允许有多个系统管理员。
...
1. **组织创建与组织权限的编辑**
   * 组织的新增和删除：登录系统管理员账户，在组织管理界面，通过新增按钮创建组织，当前系统管理员默认成为该组织的管理员；通过删除按钮删除组织。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/05/v3/Uez8poaMTA624CssvcopKQ/zh-cn_image_0000002602064965.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=071CB9B9D173CA7C5CD561819A98D296809E6A97A294B616D7A3B981D4D5C519 "点击放大")
   * 组织普通成员的添加和删除：登录组织管理员的账户，在组织管理界面，选中需要添加用户的组织的详情按钮，然后在成员界面通过新增按钮添加组织成员，通过删除按钮删除组织成员。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b0/v3/HmT7jXfCRour1voSVK1Whg/zh-cn_image_0000002602185015.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=B0D4E94B398E3D8EA32E2AF370241FAA45FC7FBCDCDA73B2E7BB7DD5B335612F "点击放大")
   * 组织管理员的添加和删除：登录系统管理员账户，在组织管理界面，选中需要添加用户的组织的编辑组织管理员按钮，然后在编辑组织管理员界面通过新增组织管理员按钮添加组织管理员，通过删除按钮删除组织管理员。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/1d9PwjhsT9qmKJgl3ubpUA/zh-cn_image_0000002602064979.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=5D01CD5C3FBC6DFC1BF32F249EC367442AA0B67B91ABC842722FA74D98A88AB6 "点击放大")
2. **组织的权限说明**
   * 组织用户：允许有多个组织用户。
     + 上传包：能够上传带有该组织的三方包
     + 下架包：能够下架成员自己上传的三方包
...
* 三方包数据：可以存放在本地文件（file storage）,sftp服务器（sftp storage）和自定义插件存储（custom storage，包括各种云存储）。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/ANkwZeW2T2KA4IMTg3yXPA/zh-cn_image_0000002571385852.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=D402927F90F083F1A9A5487D24AA598F9A1300F656EFF1E58E0394D27F5A29B5 "点击放大")
...
* **自定义AccessToken认证（对接自定义的用户数据）：**AccessToken是ohpm-repo 2.3.0版本新引入的认证机制（需配套使用1.8.0及以上版本的ohpm命令行工具），如果开发者不想把用户的数据存储在所配置的db存储路径中，可以[自定义认证插件](../附录/自定义认证插件/ide-custom-auth-plugin.md)，对接自定义的用户数据。AccessToken的有效性由自定义的用户数据认证。配置只读AccessToken获得读权限，配置读写AccessToken获得读写权限。
...
* **现象**：在git-bash终端下运行ohpm publish命令出现 “The content of private key in the key\_path error”错误，报错截图为：
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/1U6f1fEQTeKc-mA5DtWNww/zh-cn_image_0000002571385844.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=01729C080FC7B298A3BA059DC9C19FFC29CA7A6804EF89FCB64ED0DAE3BE2A7C "点击放大")
...
3. 有两种获得.tgz的方法：
   * 当使用DevEco Studio软件时，点击release发布，可获得.tgz包，具体步骤请参考：[开发动态共享包](../../开发发布和管理共享包/开发动态共享包/ide-hsp.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/Ph9ruQ7SQo-fLHIPdeKj5g/zh-cn_image_0000002602185023.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=4CB44497D66BC7EE4B03FF7E0B864AB5E07C4B70BE9CC9A58A318028F5A48404 "点击放大")
...
* **现象**：报错信息如下：
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/THDgoeSQT1ikumnNONgkQA/zh-cn_image_0000002571385840.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=7B15A85C487450CBD622564DDD5D35CDA4D090A52912DE379DC6581A8E155BB2 "点击放大")
...
* **现象**：报错信息如下：
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/iostoZNRS3aYtX56v1eaRw/zh-cn_image_0000002571545480.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=29B1651289BE0FEA508C640D9BC20F4E9603E554751C5693064626E464D7C3ED "点击放大")
...
* **解决方法**：有一些三方包包含组织名，只有发布包的用户在该组织下才具有发包的能力。报错信息表明已经有管理员账户添加了该包组织，但是当前账户没有在该组织的成员里面。在ohpm中包的命名格式为@<group>/<package\_name>，其中<group>为组织名，找到创建<group>组织的负责人账户，然后负责人账户登录ohpm-repo管理界面，进入组织的详情里，添加需要发包的账户为组织的成员，成员即可发布具有对应组织名的包。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/yiTjO1PbRPS4Fb7Q_-3OdA/zh-cn_image_0000002602064969.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=4479DD9BAEA60A9875AB6017C061C626A5E12FE664748AC3FD8F350DA277DCCC "点击放大")
...
* **现象**：ohpm执行publish命令，命令行报错信息为：Same ohpm package is exists!
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/x7YPp-lQRta8LTPGBzqR8g/zh-cn_image_0000002571545476.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=531B001E23539658C9045F9CB906AC69425347EF326759042EF24A705F6C7A34 "点击放大")
...
* 当添加了uplink的时候，首先确认是否在管理仓库的地方，选用了新增的uplink，下图表示新增的uplink没有被选中，uplink处为空：
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/k5pasDydQE2eeKjs_d_nCg/zh-cn_image_0000002602185007.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=FA7EA2B773C0765C440D670B2C3BC361639A314E7C04EDDD10E1CD6241AF10F0 "点击放大")
* 如果新增的uplink中存在所需的三方包，但是下载不下来，可能是需要配置uplink的代理信息，配置位置如下：

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/fcjebmMlRuKsjaDT9BRf-g/zh-cn_image_0000002602064961.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=767CA3CC116F1FA19F4725539666C8C9E6B543A129901E6366DF5F93509BA364 "点击放大")
...
* **现象**：访问ohpm-repo私仓管理界面的页面功能，报错“非法请求”。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/IkTKJQNOSiiAacRibHqJZA/zh-cn_image_0000002571545478.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=1459C5ABD8EAF6B49F16650910D80A32FBA1D0230A90D55E1C24037AA0615BB2 "点击放大")
...
* **现象**：打开ohpm-repo私仓管理界面，访问仓库管理页面中uplink代理配置页面，或访问认证管理页面中证书认证配置页面，报错“加密组件无效”，且已经配置的信息被清空。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/1CHNp3AFSJuS0bEJfKLjlQ/zh-cn_image_0000002602185011.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=933C71860BA7A6BDDDE621989B2C24203709BCDF4BCEF12EB02A108FFA68262B "点击放大")

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/9tCKt6bDRTK7Mul91VltCg/zh-cn_image_0000002571385842.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=3927A4B9F34E1D6A69431848AB7F4F7005DDBAECB204FD84D0CDFC4809EB7432 "点击放大")
...
* **现象**：访问ohpm-repo私仓管理界面，在ohpm-repo管理界面报错“非法请求”，在ohpm-repo运行日志报错：“verify reverse proxy usage: set "use\_reverse\_proxy" to false in config.yaml if not used, or refresh "x-forwarded-for" in Nginx if it is.”。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/Uo9wT8RsSuamybX5tF7P3Q/zh-cn_image_0000002571385838.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=E00D2B387C78BFE422BF0C23A07691E2341744F14EDAEDCA6A6B9C70B46CCE86)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/u1mvfcBRTWO1fx4DaytyZQ/zh-cn_image_0000002571545486.png?HW-CC-KV=V1&HW-CC-Date=20260601T071744Z&HW-CC-Expire=86400&HW-CC-Sign=6191B07864E51B27D30D09B1EA0A2FE950C546874B2110FD7DBFC9631667702C "点击放大")

* **原因分析**：在ohpm-repo私仓5.0.7版本中，配置文件新增配置项[use\_reverse\_proxy](../配置文件/ide-ohpm-repo-configuration.md#section1074004784011)，用于判断是否已使用反向代理。如果配置use\_reverse\_proxy值为true，但未使用反向代理或者在配置反向代理时未刷新x-forwarded-for值，将导致从请求头获取到x-forwarded-for值为空，报此错误。
...
6. 重新打开命令行终端，即可使用 [ohpm-repo 相关命令](../相关命令/ide-ohpm-repo-command.md)。
...
5. 输入下面的命令使配置生效后，即可使用 [ohpm-repo 相关命令](../相关命令/ide-ohpm-repo-command.md)。
