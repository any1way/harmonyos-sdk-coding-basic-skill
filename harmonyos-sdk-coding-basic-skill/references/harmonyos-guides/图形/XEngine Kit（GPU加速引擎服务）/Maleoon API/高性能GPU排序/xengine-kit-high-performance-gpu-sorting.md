...
scraped_at: 2026-06-01T14:58:48+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:82ac8bc60046aacf9262791cdaefddc4791370433328111d1be1fc3f60a09cb9
---
...
对于Vulkan，使用[HMS\_XEG\_EnumerateDeviceExtensionProperties](<../../../../../harmonyos-references/XEngine Kit（GPU加速引擎服务）/C API/模块/XEngine/xengine-kit-xengine.md#hms_xeg_enumeratedeviceextensionproperties>)扩展特性查询接口进行查询，如查询结果包含XEG\_HPS\_RADIX\_SORT\_EXTENSION\_NAME，则表示支持该特性，若查询结果未包含，则表示不支持该特性。

## 接口说明

以下接口为使用高性能GPU排序所需要使用的接口，关于这些接口的详细说明见[接口文档](<../../../../../harmonyos-references/XEngine Kit（GPU加速引擎服务）/C API/模块/XEngine/xengine-kit-xengine.md>)。
...
1. 调用[HMS\_XEG\_EnumerateDeviceExtensionProperties](<../../../../../harmonyos-references/XEngine Kit（GPU加速引擎服务）/C API/模块/XEngine/xengine-kit-xengine.md#hms_xeg_enumeratedeviceextensionproperties>)接口，获取XEngine支持的扩展信息，只有在支持XEG\_HPS\_RADIX\_SORT\_EXTENSION\_NAME扩展时才可以使用高性能GPU排序接口。
...
3. 声明实例句柄。
   ...
   ```
4. 调用[HMS\_XEG\_CreateHPS](<../../../../../harmonyos-references/XEngine Kit（GPU加速引擎服务）/C API/模块/XEngine/xengine-kit-xengine.md#hms_xeg_createhps>)接口，实例化句柄。
   ...
   ```
5. 构造排序描述符，调用[HMS\_XEG\_CmdRadixSortHPS](<../../../../../harmonyos-references/XEngine Kit（GPU加速引擎服务）/C API/模块/XEngine/xengine-kit-xengine.md#hms_xeg_cmdradixsorthps>)接口录制排序命令。
