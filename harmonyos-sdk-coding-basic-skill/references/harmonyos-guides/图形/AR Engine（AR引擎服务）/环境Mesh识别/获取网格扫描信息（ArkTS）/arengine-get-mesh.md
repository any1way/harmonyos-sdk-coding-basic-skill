...
content_hash: sha256:d8242f03714661ef35b510306bc160d6b0814f5b8bae611971962c21c96ca3e6
---
本章节给出了关键开发步骤，完整代码可以参考[示例代码](https://gitcode.com/HarmonyOS_Samples/arengine_samplecode_clientdemo_arkts)。

## 约束与限制

从5.1.0(18)开始，获取网格扫描信息能力支持部分Phone、部分Tablet设备。请参考[硬件要求](../../开发准备/arengine-preparations.md#硬件要求)判断设备是否支持环境Mesh识别特性（[ARENGINE\_FEATURE\_TYPE\_MESH](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arfeaturetype>)）。

## 接口说明

网格扫描主要依赖[ARSceneMesh](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arscenemesh>)，以下接口为AR网格扫描相关接口。详细接口和说明，请参考[AR Engine API参考](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md>)。

| 接口名 | 描述 |
| --- | --- |
| [ARSceneMesh.getVertices](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arscenemeshgetvertices>) | 获取场景网格中的顶点坐标数据。 |
| [ARSceneMesh.getVertexNormals](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arscenemeshgetvertexnormals>) | 获取场景网格中的顶点法线坐标数据。 |
| [ARSceneMesh.getTriangleIndices](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arscenemeshgettriangleindices>) | 获取场景网格中的三角形索引数据。 |
| [ARSceneMesh.release](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arscenemeshrelease>) | 释放环境网格数据对象。 |
...
| [ARHitResult.createAnchor](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arhitresultcreateanchor>) | 在交点（intersection）创建一个锚点。 |
| [ARHitResult.release](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arhitresultrelease>) | 释放命中检测结果对象占用的内存。 |
...
| [ARPose.release](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arposerelease>) | 释放位姿对象占用的内存。 |
...
首先初始化AR会话和AR场景，可以参考[初始化AR会话和AR场景](../../管理AR会话/管理AR会话（ArkTS）/arengine-arsession.md#初始化ar会话和ar场景)章节。
...
自定义数据转换方法arrayBufferFloat32ToNumber及arrayBufferInt32ToNumber可以参考[数据类型转换说明](<../../AR Engine常见问题/数据类型转换说明/arengine-arraybuffer-info.md>)。
