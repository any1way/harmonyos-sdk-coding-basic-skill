...
content_hash: sha256:934d23d6d47ea4e72922087d74b993c24f7c2ec2c7c69b4e1468e926e0f9f131
---
本章节给出了关键开发步骤，完整代码可以参考[示例代码](https://gitcode.com/HarmonyOS_Samples/arengine_samplecode_clientdemo_arkts)。

## 约束与限制

从5.1.0(18)开始，获取深度估计信息能力支持部分Phone、部分Tablet设备。请参考[硬件要求](../../开发准备/arengine-preparations.md#硬件要求)判断设备是否支持深度估计特性（[ARENGINE\_FEATURE\_TYPE\_DEPTH](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arfeaturetype>)）。

## 接口说明

获取深度估计信息可以通过[ARFrame](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arframe>)帧对象获取，以下接口为深度估计相关接口。详细接口和说明，请参考[AR Engine API参考](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md>)。
...
| [ARFrame.acquireDepthImage16Bits](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arframeacquiredepthimage16bits>) | 获取当前帧对应的深度图像对象。 |
| [ARFrame.acquireDepthConfidenceImage](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arframeacquiredepthconfidenceimage>) | 获取当前帧的深度置信度图像。 |
...
自定义数据转换方法arrayBufferInt32ToNumber可参考[数据类型转换说明](<../../AR Engine常见问题/数据类型转换说明/arengine-arraybuffer-info.md>)。
