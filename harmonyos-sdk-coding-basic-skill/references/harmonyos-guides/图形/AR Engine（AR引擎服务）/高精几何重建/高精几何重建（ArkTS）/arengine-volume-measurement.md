...
scraped_at: 2026-06-01T14:55:55+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:79d94b591761a62f786a2c874f2696bcce8c900cf416e39075dbf80439ed02fe
---
## 约束与限制

从6.0.0(20)开始，高精几何重建能力支持部分Phone、部分Tablet设备。请参考[硬件要求](../../开发准备/arengine-preparations.md#硬件要求)判断设备是否支持高精几何重建特性（[ARENGINE\_FEATURE\_TYPE\_SEMANTIC\_DENSE](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arfeaturetype>)）。

## 接口说明

高精几何重建主要依赖[ARSemanticDenseData](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arsemanticdensedata>)，以下接口为高精几何重建的相关接口。详细接口和说明，请参考[AR Engine API参考](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md>)。
...
| [ARFrame.acquireSemanticDense](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arframeacquiresemanticdense>) | 返回当前帧的高精几何重建对象数据。 |
| [ARSemanticDenseData.acquireCubeData](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arsemanticdensedataacquirecubedata>) | 返回一个高精几何重建对象的立方体数据信息的列表。 |
| [ARSemanticDenseData.release](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arsemanticdensedatarelease>) | 释放高精几何重建对象数据。 |
...
更改semanticDenseMode为[ARSemanticDenseMode](<../../../../../harmonyos-references/AR Engine（AR引擎服务）/ArkTS API/arEngine（AR增强现实能力）/arengine-api-arengine.md#arsemanticdensemode>).CUBE\_VOLUME，启用体积测量识别能力。
