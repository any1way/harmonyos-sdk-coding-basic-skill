...
scraped_at: 2026-06-01T14:56:29+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:54c940115ee1b67f9539578fc61ab595283b36e6542697d920e0cc51ca3bc342
---
...
详细的接口说明请参考[NativeDisplaySoloist](<../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/模块/NativeDisplaySoloist/capi-nativedisplaysoloist.md>)。

## 开发示例

本范例是通过Drawing在Native侧实现图形的绘制，通过异步线程设置期望的帧率，再根据帧率进行图形的绘制并将其呈现在NativeWindow上，图形绘制部分可参考[使用Drawing实现图形绘制与显示](../../图形绘制与显示/图形绘制与显示开发概述/graphic-drawing-overview.md)。
...
[CMakeLists.txt](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/DisplaySoloist/entry/src/main/cpp/CMakeLists.txt#L23-L25)
...
[sample\_xcomponent.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/DisplaySoloist/entry/src/main/cpp/samples/sample_xcomponent.h#L17-L33)

```
1. #include <native_display_soloist/native_display_soloist.h>
```

[sample\_xcomponent.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/DisplaySoloist/entry/src/main/cpp/samples/sample_xcomponent.cpp#L18-L20)
...
1. 定义ArkTS接口文件XComponentContext.ts，用来对接Native层。
   ...
   [XComponentContext.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/DisplaySoloist/entry/src/main/ets/interface/XComponentContext.ts#L15-L23)
2. 定义演示页面，包含两个XComponent组件。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/DisplaySoloist/entry/src/main/ets/pages/Index.ets#L15-L144)
3. 在 Native C++层获取NativeXComponent。建议使用单例模式保存XComponent。此步骤需要在napi\_init的过程中处理。
   ...
   [plugin\_manager.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/DisplaySoloist/entry/src/main/cpp/plugin/plugin_manager.h#L25-L40)
   ...
   [plugin\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/DisplaySoloist/entry/src/main/cpp/plugin/plugin_manager.cpp#L49-L91)
4. Native层配置帧率和注册回调函数。
   ...
   [sample\_xcomponent.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/DisplaySoloist/entry/src/main/cpp/samples/sample_xcomponent.cpp#L74-L120)
   ...
   * 在页面跳转时，应进行NapiUnregister和NapiDestroy操作，避免内存泄漏问题。
   ...
   51. if (id == "xcomponentId_30") {
   52. range = {30, 120, 30};
   53. }

   55. if (id == "xcomponentId_120") {
   56. range = {30, 120, 120};
   57. }
   ...
   [sample\_xcomponent.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/DisplaySoloist/entry/src/main/cpp/samples/sample_xcomponent.cpp#L25-L471)
5. TS层注册和取消注册每帧回调，销毁OH\_DisplaySoloist实例。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/DisplaySoloist/entry/src/main/ets/pages/Index.ets#L30-L135)
