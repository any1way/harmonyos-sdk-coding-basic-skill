...
scraped_at: 2026-06-01T14:56:35+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:f79cc328a44f9d12246895a42c8e7067332de522478b5aee1108249ed4de3701
---
## 场景介绍
...
创建Canvas常用接口如下表所示，详细的使用和参数说明请见[drawing\_canvas.h](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_canvas.h/capi-drawing-canvas-h.md>)。
...
2. 导入依赖的相关头文件。
   ...
   [sample\_graphics.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.h#L25-L27)

   ```
   1. #include <native_drawing/drawing_surface.h>
   ```

   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L33-L35)
3. 从XComponent对应的NativeWindow中获取BufferHandle对象。NativeWindow相关的API请参考[\_native\_window](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/模块/NativeWindow/capi-nativewindow.md>)。
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L222-L228)
4. 从BufferHandle中获取对应的内存地址。
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L229-L236)
5. 创建窗口画布。
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L242-L254)
...
7. 利用XComponent完成显示。
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L346-L351)
...
1. 导入依赖的相关头文件。
   ...
   [sample\_graphics.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.h#L20-L28)
2. 创建基于CPU的Canvas。需要通过OH\_Drawing\_BitmapCreate()接口创建一个位图对象（具体可参考[图片绘制](../../图元绘制/图片绘制（CC++）/pixelmap-drawing-c.md)），并通过OH\_Drawing\_CanvasBind()接口将位图绑定到Canvas中，从而使得Canvas绘制的内容可以输出到位图中。
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L261-L275)
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L276-L279)
3. 将上一步中创建的位图绘制到[窗口画布](canvas-get-result-draw-c.md#获取可直接显示的canvas画布)上。
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L361-L364)
...
2. 导入依赖的相关头文件。
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L16-L18)

   ```
   1. #include <native_drawing/drawing_pixel_map.h>
   ```

   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L26-L28)
3. 需要通过OH\_Drawing\_PixelMapGetFromOhPixelMapNative()接口创建一个像素图对象（具体可参考[图片绘制](../../图元绘制/图片绘制（CC++）/pixelmap-drawing-c.md)），并通过OH\_Drawing\_CanvasCreateWithPixelMap()接口借助像素图对象创建Canvas。
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L1079-L1131)
...
4. 将上一步中创建的像素图绘制到[窗口画布](canvas-get-result-draw-c.md#获取可直接显示的canvas画布)上。
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L1116-L1126)
...
2. 导入依赖的头文件。
   ...
   [sample\_graphics.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.h#L35-L38)
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L31-L36)
3. 初始化EGL上下文。
   ...
   [sample\_graphics.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.h#L131-L136)
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L71-L136)
4. 创建GPU后端Canvas。GPU后端Canvas需要借助Surface对象来获取，需先创建surface，surface的API请参考[drawing\_surface.h](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_surface.h/capi-drawing-surface-h.md>)。通过OH\_Drawing\_GpuContextCreateFromGL接口创建绘图上下文，再将这个上下文作为参数创建surface，最后通过OH\_Drawing\_SurfaceGetCanvas接口从surface中获取到canvas。
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L304-L319)
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L320-L323)
5. 将上一步中的绘制结果拷贝到[窗口画布](canvas-get-result-draw-c.md#获取可直接显示的canvas画布)上。
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L375-L381)
6. 使用完之后需要将EGL上下文销毁。
   ...
   [sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L138-L160)
