...
scraped_at: 2026-06-01T14:56:33+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:a6236efd6ef42a42336a902d4de9e2d3dc4c77f29c8d51b3acb00b002b73a824
---
## 场景介绍
...
通过[RenderNode](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md>)获取可直接上屏显示的Canvas画布。
...
1. 导入依赖的相关文件。
   ...
   [CanvasGetResult.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/CanvasGetResult.ets#L18-L20)

   ```
   1. import { drawing } from '@kit.ArkGraphics2D';
   ```

   [CanvasGetResult.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/CanvasGetResult.ets#L23-L25)
2. 添加自定义RenderNode。
   ...
   [CanvasGetResult.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/CanvasGetResult.ets#L28-L51)
3. 添加自定义[NodeController](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/NodeController/js-apis-arkui-nodecontroller.md>)。
   ...
   [CanvasGetResult.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/CanvasGetResult.ets#L53-L80)
4. 重写自定义RenderNode的[draw()](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#draw>)函数，获取Canvas进行自定义的绘制操作，即本章下文中的内容。
   ...
   [CanvasGetResult.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/CanvasGetResult.ets#L31-L49)
5. 将自定义NodeController进行显示。
   ...
   [CanvasGetResult.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/CanvasGetResult.ets#L159-L189)
...
1. 导入依赖的相关文件。
   ...
   [CanvasGetResult.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/CanvasGetResult.ets#L17-L26)
2. 添加自定义RenderNode。
3. 添加自定义[NodeController](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/NodeController/js-apis-arkui-nodecontroller.md>)。
4. 在MyNodeController的aboutToAppear()函数中创建PixelMap。
5. 重写自定义RenderNode的[draw()](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#draw>)函数，在其中获取离屏Canvas进行绘制：
   ...
   [CanvasGetResult.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/CanvasGetResult.ets#L82-L157)
