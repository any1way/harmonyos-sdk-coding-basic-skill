...
scraped_at: 2026-06-01T14:56:47+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:9a61a575543fc161fdaf33b3c969d9fc21fc809c4aa61276c3e379fe68bdd907
---
## 场景介绍
...
几何形状绘制的常用接口如下表所示，详细的使用和参数说明请见[drawing\_canvas.h](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_canvas.h/capi-drawing-canvas-h.md>)。
...
点只能基于画笔在画布上进行绘制，通过使用OH\_Drawing\_CanvasDrawPoint()接口绘制点。接口接受两个参数，一个是画布对象Canvas，请确保已创建或获取得到画布Canvas，具体可见[画布的获取与绘制结果的显示（C/C++）](../../画布的获取与绘制结果的显示/画布的获取与绘制结果的显示（CC++）/canvas-get-result-draw-c.md)；另一个是要绘制的点的指针。
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L876-L901)

效果如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/UrOMh6TrSFeSe4_2JM2eaQ/zh-cn_image_0000002613519151.png?HW-CC-KV=V1&HW-CC-Date=20260601T065648Z&HW-CC-Expire=86400&HW-CC-Sign=3286A49F7F8B050DA0F9FD382544B2088ADAD34C64E9A3B299F52F0B4AF6DC34)

## 绘制圆弧

可以使用画笔或画刷在画布上进行圆弧的绘制，通过使用OH\_Drawing\_CanvasDrawArc()接口绘制圆弧。使用接口需要传入4个参数，分别如下：

* 需要画布对象Canvas，请确保已创建或获取得到画布Canvas，具体可见[画布的获取与绘制结果的显示（C/C++）](../../画布的获取与绘制结果的显示/画布的获取与绘制结果的显示（CC++）/canvas-get-result-draw-c.md)。
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L906-L924)

效果如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/n-NpQzV8R3mI3y21wqe_fg/zh-cn_image_0000002582959352.png?HW-CC-KV=V1&HW-CC-Date=20260601T065648Z&HW-CC-Expire=86400&HW-CC-Sign=71C3E4023C9CC71DC0C7B30946DDDA303AA83775C49D349B9E3F7C4237211F5B)
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L929-L947)

效果如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/2MasRnF-Ql-5tIUJgkWFCg/zh-cn_image_0000002583119280.png?HW-CC-KV=V1&HW-CC-Date=20260601T065648Z&HW-CC-Expire=86400&HW-CC-Sign=3049A2813973092D6068A015BE3BEDF6A8ACF0CE9E850C775CF4E6041F93126D)

## 绘制路径

可以使用画笔或画刷在画布上进行路径的绘制，路径具体可以用于绘制直线、弧线、贝塞尔曲线等，也可以通过路径组合的方式组成其他复杂的形状。

绘制路径的相关接口和实现如下，详细的使用和参数说明请见[drawing\_path](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_path.h/capi-drawing-path-h.md>)。常用的接口如下：
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L952-L999)

效果如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/88/v3/tUkEir0UTuG8luADHhSBug/zh-cn_image_0000002613639047.png?HW-CC-KV=V1&HW-CC-Date=20260601T065648Z&HW-CC-Expire=86400&HW-CC-Sign=18257CE76DFB1D4C1F44C93F443E784924675576B94F5E958181F636F452ADED)

## 绘制区域

区域不是一个特定的形状，可以设置为指定的矩形或路径，也可以对两个区域进行组合操作。可以使用画笔或画刷在画布上进行区域的绘制。详细的API说明请参考[drawing\_region.h](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_region.h/capi-drawing-region-h.md>)。
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L1004-L1030)

效果如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/jRRxYqZkTXatiCHfkIVdtg/zh-cn_image_0000002613519145.jpg?HW-CC-KV=V1&HW-CC-Date=20260601T065648Z&HW-CC-Expire=86400&HW-CC-Sign=40C1021296979BB14ABC34335D98DBE55A63CDC88F07A0E86CBCC3DA6CCCE95B)
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L1035-L1050)

效果如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/D-45jJuvR4K8GkoA725vTg/zh-cn_image_0000002613519153.png?HW-CC-KV=V1&HW-CC-Date=20260601T065648Z&HW-CC-Expire=86400&HW-CC-Sign=04BA7A7FF4D1FAB3FA6E5D5E65236AC7B7F42915EFB9A80315D8C579AA7C3E7C)
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L1055-L1074)

效果如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/airUVj0nSWykcEjVsNuJiA/zh-cn_image_0000002582959354.png?HW-CC-KV=V1&HW-CC-Date=20260601T065648Z&HW-CC-Expire=86400&HW-CC-Sign=5760B03BFFFE9DBB538285B14DE0A1CC77BE03874F631534B9E868BEACE38F6F)
