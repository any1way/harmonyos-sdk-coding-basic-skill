...
scraped_at: 2026-06-11T15:00:25+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:d0cb013b694f902c0c4791794e6ad5b9a7f182b124df27ccc19dbb1b99e3e6c6
---
...
可以使用setBlendMode()接口将混合模式应用于画刷或画笔中，该接口需要接受一个参数BlendMode，即混合模式的类型，具体可参考[BlendMode](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Enums/arkts-apis-graphics-drawing-e.md#blendmode>)。
...
[ComplexEffect.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/ComplexEffect.ets#L16-L19)
...
[ComplexEffect.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/ComplexEffect.ets#L61-L84)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/gejvsDM9TJedosc5hYZoWA/zh-cn_image_0000002592379008.png?HW-CC-KV=V1&HW-CC-Date=20260611T070024Z&HW-CC-Expire=86400&HW-CC-Sign=4803AB5466AA4E5C6196F5CCD652B1211E0FDF4CBA25807D8668A6EF92533FF0)
...
[ComplexEffect.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/ComplexEffect.ets#L87-L112)
...
着色器相关接口和具体参数的说明请见[ShaderEffect](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (ShaderEffect)/arkts-apis-graphics-drawing-shadereffect.md>)。
...
[ComplexEffect.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/ComplexEffect.ets#L116-L138)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/jLFRK84wRZuZOb1S9dzL0w/zh-cn_image_0000002592219076.png?HW-CC-KV=V1&HW-CC-Date=20260611T070024Z&HW-CC-Expire=86400&HW-CC-Sign=F269423A2D16D446E402B00E410095733651BEB9493F12AA17CDC614ACF41BF0)
...
[ComplexEffect.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/ComplexEffect.ets#L142-L163)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/5UXjXpYGQNq7ng46NhvLIQ/zh-cn_image_0000002592379010.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070024Z&HW-CC-Expire=86400&HW-CC-Sign=6EEA020B70A1B98C64C10CA20F37F08ED07B1A6518E2F5D403D9BCF5FAC97098)
...
[ComplexEffect.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/ComplexEffect.ets#L167-L188)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/vCFqZMYFRVOCJKJusiGigA/zh-cn_image_0000002622858517.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T070024Z&HW-CC-Expire=86400&HW-CC-Sign=C1AF3A2B9FE65F59AD00623A2692AAB2DAB09E1287A16375569B0944166ADAAD)

## 滤波器效果

滤波器效果可基于画刷或画笔实现。当前支持不同的滤波器效果，比如图像滤波器、颜色滤波器、蒙版滤波器。

滤波器相关接口和具体参数的说明请见[ImageFilter](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (ImageFilter)/arkts-apis-graphics-drawing-imagefilter.md>)。

### 颜色滤波器效果

颜色滤波器可基于画笔或画刷实现，颜色滤波器的相关接口和具体参数的说明请见[ColorFilter](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (ColorFilter)/arkts-apis-graphics-drawing-colorfilter.md>)。
...
[ComplexEffect.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/ComplexEffect.ets#L192-L220)
...
图像滤波器可基于画笔或画刷来实现，图像滤波器的相关接口和具体参数的说明请见[ImageFilter](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (ImageFilter)/arkts-apis-graphics-drawing-imagefilter.md>)。
...
[ComplexEffect.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/ComplexEffect.ets#L224-L247)
...
蒙版滤波器可基于画笔或画刷实现，蒙版滤波器的相关接口和具体参数的说明请见[MaskFilter](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (MaskFilter)/arkts-apis-graphics-drawing-maskfilter.md>)。

可使用createBlurMaskFilter()接口创建想要设置具有模糊效果的蒙版滤波器。接口接受2个参数，分别为：

* blurType：用于指定要应用的模糊类型，详细分类请参考[BlurType](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Enums/arkts-apis-graphics-drawing-e.md#blurtype12>)。
...
[ComplexEffect.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/ArkTSGraphicsDraw/entry/src/main/ets/drawing/pages/ComplexEffect.ets#L251-L274)
