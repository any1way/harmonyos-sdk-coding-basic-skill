...
scraped_at: 2026-06-11T15:00:27+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:e1d91bf4b2250572276fc43f10bf4910bb94d2a2facdee29cd479f89a655fb50
---
...
可以使用OH\_Drawing\_BrushSetBlendMode()接口将混合模式应用于画刷中，使用OH\_Drawing\_PenSetBlendMode()接口将混合模式应用于画笔中。这两个接口都需要接受一个参数OH\_Drawing\_BlendMode，即混合模式的类型，具体可参考[OH\_Drawing\_BlendMode](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_types.h/capi-drawing-types-h.md#oh_drawing_blendmode>)。
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L604-L631)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/i6LlyU-LQKi1dRCB7dFR4w/zh-cn_image_0000002622858521.png?HW-CC-KV=V1&HW-CC-Date=20260611T070026Z&HW-CC-Expire=86400&HW-CC-Sign=1FF8895200A634A693A9DD5722A55E210CFF40E2EEC36716EB573DC0675E498E)
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L636-L660)
...
着色器相关接口和具体参数的说明请见[drawing\_shader\_effect](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_shader_effect.h/capi-drawing-shader-effect-h.md>)。
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L665-L694)

此例绘制的具有线性渐变着色器效果的矩形如下所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/NZsmaFX1S76H43pAAKplUQ/zh-cn_image_0000002592379016.png?HW-CC-KV=V1&HW-CC-Date=20260611T070026Z&HW-CC-Expire=86400&HW-CC-Sign=10163A5EABE3775444A04758431EA43CD5C6EC95F0090DD3F0C136F8A6706D9C)
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L699-L727)

此例绘制的具有径向渐变着色器效果的矩形如下所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d3/v3/g02m5AYJQlS9txUpOGo64g/zh-cn_image_0000002622858523.png?HW-CC-KV=V1&HW-CC-Date=20260611T070026Z&HW-CC-Expire=86400&HW-CC-Sign=0941AE2CB90C291D58302449C1D9A9E94250F380F7EDADD064E74E0978FE56A8)
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L732-L758)

此例绘制的具有扇形渐变着色器效果的矩形如下所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/ougG4UgGSneNsWHa3633uA/zh-cn_image_0000002622698645.png?HW-CC-KV=V1&HW-CC-Date=20260611T070026Z&HW-CC-Expire=86400&HW-CC-Sign=14F18FD6EF81ACDA249DBAD3AA6C720D70F34B848F7D538D441514C7FC19F6FA)
...
滤波器相关接口和具体参数的说明请见[drawing\_filter.h](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_filter.h/capi-drawing-filter-h.md>)。

### 颜色滤波器效果

颜色滤波器可基于画笔或画刷实现，颜色滤波器的相关接口和具体参数的说明请见[drawing\_color\_filter.h](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_color_filter.h/capi-drawing-color-filter-h.md>)。
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L763-L799)
...
图像滤波器可基于画笔或画刷来实现，图像滤波器的相关接口和具体参数的说明请见[drawing\_image\_filter.h](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_image_filter.h/capi-drawing-image-filter-h.md>)。
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L804-L835)
...
蒙版滤波器可基于画笔或画刷实现，蒙版滤波器的相关接口和具体参数的说明请见[drawing\_mask\_filter.h](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_mask_filter.h/capi-drawing-mask-filter-h.md>)。

可使用OH\_Drawing\_MaskFilterCreateBlur()接口创建想要设置具有模糊效果的蒙版滤波器。接口接受3个参数，分别为：

* blurType：用于指定要应用的模糊类型，详细分类请参考[OH\_Drawing\_BlurType](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_mask_filter.h/capi-drawing-mask-filter-h.md#oh_drawing_blurtype>)。
...
[sample\_graphics.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/Drawing/NDKGraphicsDraw/entry/src/main/cpp/samples/sample_graphics.cpp#L840-L870)
