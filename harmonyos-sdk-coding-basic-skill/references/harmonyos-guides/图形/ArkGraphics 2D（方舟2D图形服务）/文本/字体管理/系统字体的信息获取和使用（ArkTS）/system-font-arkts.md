...
scraped_at: 2026-06-11T15:00:34+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:b7bd8dcd797d05899ed448f6c2c57a49eca5313a66ffee0421a3e9da2076d353
---
## 场景介绍
...
以下是系统字体相关的常用接口和结构体，ArkTS侧对外接口由ArkUI提供，详细接口说明请见[@ohos.font](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.font (注册自定义字体)/js-apis-font.md>)。
...
2. 获取系统字体信息。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/SystemFontInfoGet/entry/src/main/ets/pages/Index.ets#L140-L142)
3. 在获取系统字体信息之后通过日志打印字体信息。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/SystemFontInfoGet/entry/src/main/ets/pages/Index.ets#L144-L164)

以下打印的示例为应用设备系统对应的部分系统字体配置信息情况，不同设备系统配置信息可能不同，此处仅示意。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/fcErZfWPRgqXJy-FEYj6QA/zh-cn_image_0000002592219104.png?HW-CC-KV=V1&HW-CC-Date=20260611T070033Z&HW-CC-Expire=86400&HW-CC-Sign=6EA74CA5C62AD855A25096D04FB88B377F83CDC2111CFA37A55887C6F4FF97D6)
...
2. 创建textStyle1，指定fontFamilies为“HarmonyOS Sans SC”，默认中文字体为“HarmonyOS Sans SC”。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/SystemFontInfoGet/entry/src/main/ets/pages/Index.ets#L28-L34)
3. 创建textStyle2，指定fontFamilies为“HarmonyOS Sans TC”（该两种字体易于观察同一文字字型差异）。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/SystemFontInfoGet/entry/src/main/ets/pages/Index.ets#L36-L42)
4. 创建段落生成器。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/SystemFontInfoGet/entry/src/main/ets/pages/Index.ets#L44-L55)
5. 先后将textStyle1和textStyle2添加到段落样式中并添加文字。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/SystemFontInfoGet/entry/src/main/ets/pages/Index.ets#L57-L65)
6. 生成段落，用于后续绘制使用。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/SystemFontInfoGet/entry/src/main/ets/pages/Index.ets#L68-L70)

效果展示如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/mU9Y2BwTQ7W9e98w5S2koA/zh-cn_image_0000002592379038.png?HW-CC-KV=V1&HW-CC-Date=20260611T070033Z&HW-CC-Expire=86400&HW-CC-Sign=AFDB51376F2C8B60D18F88715009794AEFC2E66446D1238CAACA7432B0CA155A)
