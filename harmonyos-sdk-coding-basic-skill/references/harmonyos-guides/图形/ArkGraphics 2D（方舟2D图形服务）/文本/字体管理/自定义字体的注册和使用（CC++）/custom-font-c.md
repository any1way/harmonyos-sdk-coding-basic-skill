...
scraped_at: 2026-06-01T14:56:56+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:edbc9872c73ff81270b432cf4e92f5934547ecedcc3fa7a06e989a61fe3972b4
---
## 场景介绍
...
注册使用自定义字体的相关接口如下所示，详细接口说明请参考[Drawing](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/模块/Drawing/capi-drawing.md>)。
...
3. 创建字体管理器，建议优先使用OH\_Drawing\_CreateSharedFontCollection()创建可共享的字体集对象。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L168-L170)
4. 设置自定义字体的字体家族名和字体文件所在的沙箱路径。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L171-L176)
5. 在字体管理器中使用OH\_Drawing\_RegisterFont()注册自定义字体。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L177-L180)
6. 确保自定义字体注册成功后，使用OH\_Drawing\_CreateTextStyle()接口创建文本样式对象，并使用OH\_Drawing\_SetTextStyleFontFamilies()接口加入自定义字体。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L183-L188)
7. 生成最终段落文本，使用自定义字体，以便实现最终的文本绘制和显示。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L190-L212)
8. 如果需要释放自定义字体，可以使用OH\_Drawing\_UnregisterFont接口。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L214-L228)
