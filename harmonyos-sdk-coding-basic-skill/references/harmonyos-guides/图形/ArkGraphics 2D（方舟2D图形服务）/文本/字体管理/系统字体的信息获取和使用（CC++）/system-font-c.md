...
scraped_at: 2026-06-11T15:00:37+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:00c5bb6a15ab15dba0bba642c99a4f0f9359063e6ade60d17625aec57d49f8f5
---
## 场景介绍
...
以下是系统字体相关的常用接口和结构体，详细接口说明请参考[Drawing](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/模块/Drawing/capi-drawing.md>)。
...
2. 导入依赖的相关头文件。
   ...
   ```
3. 获取系统字体的配置信息，可以通过返回的状态码确定获取信息是否成功，状态码的包含的具体情况和对应含义可见[OH\_Drawing\_FontConfigInfoErrorCode](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_text_typography.h/capi-drawing-text-typography-h.md#oh_drawing_fontconfiginfoerrorcode>)。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L242-L248)
4. 系统字体的配置信息[OH\_Drawing\_FontConfigInfo](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/结构体/OH_Drawing_FontConfigInfo/capi-drawing-oh-drawing-fontconfiginfo.md>)包含以下几类信息：

   * 系统字体文件路径数量。
   * 通用字体集列表数量。
   * 备用字体集列表数量。
   * 系统字体文件路径列表。
   * 通用字体集列表，具体信息可见[OH\_Drawing\_FontGenericInfo](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/结构体/OH_Drawing_FontGenericInfo/capi-drawing-oh-drawing-fontgenericinfo.md>)结构体。
   * 备用字体集列表，具体信息可见[OH\_Drawing\_FontFallbackGroup](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/结构体/OH_Drawing_FontFallbackGroup/capi-drawing-oh-drawing-fontfallbackgroup.md>)结构体。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L250-L271)

   以下打印的示例为应用设备系统对应的部分系统字体配置信息情况，不同设备系统配置信息可能不同，此处仅示意。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/7LyEpmEaR2ufeYhQg03Usw/zh-cn_image_0000002592219106.png?HW-CC-KV=V1&HW-CC-Date=20260611T070036Z&HW-CC-Expire=86400&HW-CC-Sign=C2961E4359868FCD9A7C818F16A4479E38AEA4CF9BBEDA74F0B165B9D0480BB8)
...
3. 创建字体管理器，建议优先使用OH\_Drawing\_CreateSharedFontCollection创建可共享的字体集对象。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L276-L278)
4. 创建一个文本样式对象，即OH\_Drawing\_TextStyle对象，用于设置文本样式。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L279-L281)
5. [获取系统字体信息](system-font-c.md#获取系统字体信息)，获取系统字体的字体家族名，并在文本样式中设置为该系统字体。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L283-L291)
6. 生成最终段落文本，以便实现最终的文本绘制和显示。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L293-L315)
...
1. 确保已成功注册自定义字体，用于保证禁用系统字体后文本的正常显示，具体可见[自定义字体的注册和使用](../自定义字体的注册和使用（CC++）/custom-font-c.md)。
...
4. 创建字体管理器，建议优先使用OH\_Drawing\_CreateSharedFontCollection创建可共享的字体集对象。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L328-L330)
5. 禁用系统字体。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L332-L334)
6. 创建文本样式对象，使用注册成功的自定义字体。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L337-L358)
7. 生成最终的段落文本，以便实现最终的文本绘制和显示。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKThemFontAndCustomFontText/entry/src/main/cpp/samples/sample_bitmap.cpp#L360-L383)
