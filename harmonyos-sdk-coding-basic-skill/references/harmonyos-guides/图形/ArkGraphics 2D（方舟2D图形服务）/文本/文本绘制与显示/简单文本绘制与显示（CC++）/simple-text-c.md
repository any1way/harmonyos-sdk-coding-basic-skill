...
scraped_at: 2026-06-11T15:00:45+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:79f2aafe28895c33d278705a83b177e00408b7ef76c73c07a323f84081c31b31
---
## 场景介绍
...
1. 创建Canvas画布对象，画布Canvas对象创建方法具体可见[画布的获取与绘制结果的显示](../../../图形绘制与显示/画布的获取与绘制结果的显示/画布的获取与绘制结果的显示（CC++）/canvas-get-result-draw-c.md)。
2. 初始化段落样式，设置文本对齐方式为居中对齐。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKDrawingSimpleText/entry/src/main/cpp/samples/sample_bitmap.cpp#L165-L170)
3. 初始化文本样式，此处设置字体颜色为纯黑色，字体大小为60，字重为400。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKDrawingSimpleText/entry/src/main/cpp/samples/sample_bitmap.cpp#L172-L178)
4. 初始化段落对象，并添加文本。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKDrawingSimpleText/entry/src/main/cpp/samples/sample_bitmap.cpp#L180-L193)
5. 排版段落并进行文本绘制。
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKDrawingSimpleText/entry/src/main/cpp/samples/sample_bitmap.cpp#L195-L201)
6. 释放内存
   ...
   [sample\_bitmap.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKDrawingSimpleText/entry/src/main/cpp/samples/sample_bitmap.cpp#L203-L210)

## 效果展示

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/50/v3/nnuw-aAqTjWcGxJ2mspgoA/zh-cn_image_0000002622858561.png?HW-CC-KV=V1&HW-CC-Date=20260611T070044Z&HW-CC-Expire=86400&HW-CC-Sign=328AC1222A39EFB05A742D43D2C7B445248CFA97E01E94E2265BCA89B52076EF)
