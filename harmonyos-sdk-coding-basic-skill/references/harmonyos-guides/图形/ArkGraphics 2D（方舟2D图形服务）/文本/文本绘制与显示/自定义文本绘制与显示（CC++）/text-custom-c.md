...
scraped_at: 2026-06-11T15:00:48+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:c9a1eebfa6f8cd579c5339cde3368ee54229537c0eea7a8fb7d1dd9804d9c4e5
---
...
文本塑形中常用接口如下表所示，详细接口说明参考[drawing\_text\_typography.h](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_text_typography.h/capi-drawing-text-typography-h.md>)和[drawing\_text\_blob.h](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_text_blob.h/capi-drawing-text-blob-h.md>)。
...
3. 创建段落样式，并使用构造段落生成器ParagraphBuilder生成段落实例。
   ...
   [draw\_text\_impl.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKComplexText1/entry/src/main/cpp/samples/draw_text_impl.cpp#L1096-L1107)
4. 设置文本样式，添加文本内容。
   ...
   [draw\_text\_impl.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKComplexText1/entry/src/main/cpp/samples/draw_text_impl.cpp#L1108-L1113)
5. 创建行对象。获取行中所有文字的塑形结果。
   ...
   [draw\_text\_impl.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKComplexText1/entry/src/main/cpp/samples/draw_text_impl.cpp#L1115-L1123)
6. 该步骤是文本塑形流程中的自定义绘制环节。通过调用OH\_Drawing\_GetRunGlyphs()方法获取文本中每个字符对应的字形序号，再结合OH\_Drawing\_GetRunFont()方法获取的字体对象，即可唯一确定每个字形的具体图形信息。
   ...
   [draw\_text\_impl.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKComplexText1/entry/src/main/cpp/samples/draw_text_impl.cpp#L1124-L1168)
7. 释放内存
   ...
   [draw\_text\_impl.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/NDKComplexText1/entry/src/main/cpp/samples/draw_text_impl.cpp#L1170-L1179)

效果展示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/NfDWnLonRd6yqkZ2NXsfww/zh-cn_image_0000002592379064.png?HW-CC-KV=V1&HW-CC-Date=20260611T070046Z&HW-CC-Expire=86400&HW-CC-Sign=C4ADB69C72C6FCF44A6B08A6DE9F058DCB85509C26530B01B19F0474B1C85315)
