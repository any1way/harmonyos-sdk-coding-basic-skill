...
scraped_at: 2026-06-11T15:00:44+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:9f5ccaa02201537bc180faed743e5b5d724865e277e4ab97f18fe90ffcb59637
---
...
文本塑形中常用接口如下表所示，详细接口说明参考[@ohos.graphics.text (文本模块)](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#paragraph>)和[@ohos.graphics.drawing (drawing TextBlob)](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (TextBlob)/arkts-apis-graphics-drawing-textblob.md>)。
...
2. 创建段落样式，并使用构造段落生成器ParagraphBuilder生成段落实例。
   ...
   [IndependentShaping.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/ComplexTextDrawing/entry/src/main/ets/pages/shape/IndependentShaping.ets#L52-L62)
3. 添加文本内容。
   ...
   [IndependentShaping.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/ComplexTextDrawing/entry/src/main/ets/pages/shape/IndependentShaping.ets#L65-L67)
4. 创建行对象。获取行中所有文字的塑形结果。
   ...
   [IndependentShaping.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/ComplexTextDrawing/entry/src/main/ets/pages/shape/IndependentShaping.ets#L69-L76)
5. 该步骤是文本塑形流程中的自定义绘制环节。通过调用getGlyphs()方法获取文本中每个字符对应的字形序号，再结合getFont()方法获取的字体对象，即可唯一确定每个字形的具体图形信息。
   ...
   [IndependentShaping.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics2D/TextEngine/ComplexTextDrawing/entry/src/main/ets/pages/shape/IndependentShaping.ets#L78-L99)

效果展示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/o33AIDr-S9SuHpsN4FUbGg/zh-cn_image_0000002592379054.png?HW-CC-KV=V1&HW-CC-Date=20260611T070043Z&HW-CC-Expire=86400&HW-CC-Sign=880B279947F8630FD0B766E0BE72513BA882C6DAAC710AA5D3AAE802245EE6C1)
