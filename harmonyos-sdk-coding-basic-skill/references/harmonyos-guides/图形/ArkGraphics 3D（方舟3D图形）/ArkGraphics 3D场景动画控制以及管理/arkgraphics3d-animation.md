...
scraped_at: 2026-06-01T14:57:26+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:0c8d1ce62031d65bb2bab66256038035c4affa87c4ffc512065f670e79689853
---
...
1. 导入相关模块。
   ...
   [animation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/arkgraphic/animation.ets#L16-L18)
2. 加载场景资源。
   ...
   [animation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/arkgraphic/animation.ets#L46-L90)
3. 获取动画并注册回调。
   ...
   * onFinished()：动画播放完成或执行finish操作时触发。
   ...
   [animation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/arkgraphic/animation.ets#L53-L77)
4. 创建相机与设置场景渲染参数。
   ...
   [animation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/arkgraphic/animation.ets#L78-L85)
5. 构建界面与动画控制。
   ...
   * 跳转（seek）：按比例跳转动画进度（例如seek(0.3)跳至总时长的30%）。
   ...
   [animation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/arkgraphic/animation.ets#L112-L203)
