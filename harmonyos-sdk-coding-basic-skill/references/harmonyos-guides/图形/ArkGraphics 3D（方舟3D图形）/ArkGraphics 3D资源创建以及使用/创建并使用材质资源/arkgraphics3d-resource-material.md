...
scraped_at: 2026-06-01T14:57:23+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:30c7cd34b446cd57473cd529338728b62f9b6e34dac38838f10b6b7fbe145baa
---
...
ArkGraphics 3D中的材质类型通过[MaterialType](<../../../../../harmonyos-references/ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneResource/js-apis-inner-scene-resources.md#materialtype>)枚举指定，目前支持以下两种类型：
...
材质的创建一般通过[SceneResourceFactory.createMaterial()](<../../../../../harmonyos-references/ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/Scene/js-apis-inner-scene.md#creatematerial>)方法完成，需指定材质名称和类型。不同类型的材质支持不同的参数配置，开发者可按需选择以实现预期的渲染效果。
...
所有材质均具备以下基础属性（如materialType、shadowReceiver、blend等）可通过设置[Material](<../../../../../harmonyos-references/ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneResource/js-apis-inner-scene-resources.md#material>)类型对象实现，用于控制材质的类型及其渲染基础行为：
...
符合glTF标准的基于物理渲染（PBR）的金属-粗糙度材质，通过设置[MetallicRoughnessMaterial](<../../../../../harmonyos-references/ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneResource/js-apis-inner-scene-resources.md#metallicroughnessmaterial20>)实现，其中各项属性采用[MaterialProperty](<../../../../../harmonyos-references/ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneResource/js-apis-inner-scene-resources.md#materialproperty20>)类型封装，支持绑定纹理和设置因子（factor）值。具体属性包括：
...
1. 导入相关模块。
   ...
   [resource.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/arkgraphic/resource.ets#L16-L19)
2. 加载场景并设置渲染参数。
   ...
   [resource.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/arkgraphic/resource.ets#L177-L206)
3. 初始化相机。
   ...
   [resource.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/arkgraphic/resource.ets#L188-L192)
4. 获取几何体节点。
   ...
   [resource.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/arkgraphic/resource.ets#L194-L199)
5. 创建Shader材质（空白）。
   ...
   [resource.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/arkgraphic/resource.ets#L23-L42)
6. 创建并绑定Shader资源。
   ...
   [resource.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/arkgraphic/resource.ets#L44-L69)
7. 应用Shader材质到几何体节点。
   ...
   [resource.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/arkgraphic/resource.ets#L222-L285)
...
1. 导入相关模块。
   ...
   [pbr\_clearcoat.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/material/pbr_clearcoat.ets#L16-L20)
2. 加载场景资源。
   ...
   [pbr\_clearcoat.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/material/pbr_clearcoat.ets#L48-L116)
3. 获取几何体节点并预加载纹理。
   ...
   [pbr\_clearcoat.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/material/pbr_clearcoat.ets#L61-L77)
4. 配置环境光照。
   ...
   [pbr\_clearcoat.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/material/pbr_clearcoat.ets#L80-L95)
5. 创建相机并设置视角。
   ...
   [pbr\_clearcoat.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/material/pbr_clearcoat.ets#L97-L103)
6. 切换清漆层纹理。
   ...
   [pbr\_clearcoat.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/material/pbr_clearcoat.ets#L120-L127)
7. 调整清漆层强度。
   ...
   [pbr\_clearcoat.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/material/pbr_clearcoat.ets#L130-L138)
8. 切换粗糙度纹理。
   ...
   [pbr\_clearcoat.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/material/pbr_clearcoat.ets#L141-L148)
9. 调整清漆层粗糙度。
   ...
   [pbr\_clearcoat.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkGraphics3D/entry/src/main/ets/material/pbr_clearcoat.ets#L151-L159)
