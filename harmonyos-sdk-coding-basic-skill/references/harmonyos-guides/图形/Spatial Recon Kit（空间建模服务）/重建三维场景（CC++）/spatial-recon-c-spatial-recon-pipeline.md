...
scraped_at: 2026-06-01T14:58:36+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:4c69136fd2db1e21939c40e02b7f3aede46a5fd80dd43dcc79756d134f1a93c5
---
## 概要
...
1. 使用AR Engine的数据结构。
2. 依据[HMS\_SpatialRecon\_DataFrame](<../../../../harmonyos-references/Spatial Recon Kit（空间建模服务）/C API/结构体/HMS_SpatialRecon_DataFrame/capi-spatialrecon-hms-spatialrecon-dataframe.md>)结构体的定义组装数据。
...
21. AREngine_ARFrame *arFrame = nullptr;
...
开发者也可以手动依据[HMS\_SpatialRecon\_DataFrame](<../../../../harmonyos-references/Spatial Recon Kit（空间建模服务）/C API/结构体/HMS_SpatialRecon_DataFrame/capi-spatialrecon-hms-spatialrecon-dataframe.md>)结构体的定义进行自定义配置。
...
在获取了必要的输入以后，开发者可以调用[HMS\_SpatialRecon\_StartSession](<../../../../harmonyos-references/Spatial Recon Kit（空间建模服务）/C API/头文件/spatial_recon_interface.h/capi-spatial-recon-interface-h.md#hms_spatialrecon_startsession>)函数进行重建。

开发者需要根据当前应用是否处于前台运行，在每一次调用[HMS\_SpatialRecon\_StartSession](<../../../../harmonyos-references/Spatial Recon Kit（空间建模服务）/C API/头文件/spatial_recon_interface.h/capi-spatial-recon-interface-h.md#hms_spatialrecon_startsession>)函数之后，使用[HMS\_SpatialRecon\_SetRunningMode](<../../../../harmonyos-references/Spatial Recon Kit（空间建模服务）/C API/头文件/spatial_recon_interface.h/capi-spatial-recon-interface-h.md#hms_spatialrecon_setrunningmode>)设定对应的运行模式，让操作系统可以更好地分配计算资源。
...
Spatial Recon Kit提供了相关的接口，在调用[HMS\_SpatialRecon\_StartSession](<../../../../harmonyos-references/Spatial Recon Kit（空间建模服务）/C API/头文件/spatial_recon_interface.h/capi-spatial-recon-interface-h.md#hms_spatialrecon_startsession>)启动重建以后，可以通过调用[HMS\_SpatialRecon\_PauseSession](<../../../../harmonyos-references/Spatial Recon Kit（空间建模服务）/C API/头文件/spatial_recon_interface.h/capi-spatial-recon-interface-h.md#hms_spatialrecon_pausesession>)接口暂停重建，通过调用[HMS\_SpatialRecon\_ResumeSession](<../../../../harmonyos-references/Spatial Recon Kit（空间建模服务）/C API/头文件/spatial_recon_interface.h/capi-spatial-recon-interface-h.md#hms_spatialrecon_resumesession>)接口继续重建。
...
调用[HMS\_SpatialRecon\_StartSession](<../../../../harmonyos-references/Spatial Recon Kit（空间建模服务）/C API/头文件/spatial_recon_interface.h/capi-spatial-recon-interface-h.md#hms_spatialrecon_startsession>)函数时，如果传入的writeInfo非空，重建结束以后会根据writeInfo配置的信息自动保存结果。如果传入的writeInfo为空，可以在重建结束以后手动保存结果。
