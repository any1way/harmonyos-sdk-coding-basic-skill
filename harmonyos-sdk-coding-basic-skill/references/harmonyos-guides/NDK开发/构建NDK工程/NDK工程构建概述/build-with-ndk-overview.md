...
scraped_at: 2026-06-01T15:14:47+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:2d063c376d39a67f20c16e507ba0a1b7e3960085744c4aa1fdd1816436cd342d
---
...
* 从源码构建
  ...
  + 可以使用DevEco Studio提供的C++应用模板，[用DevEco Studio来编译构建](<../使用DevEco Studio模板构建NDK工程/build-with-ndk-ide.md>)
  + 也可以[使用命令行CMake来编译构建](../使用命令行CMake构建NDK工程/build-with-ndk-cmake.md)
* [使用预构建库构建](../在NDK工程中使用预构建库/build-with-ndk-prebuilts.md)
