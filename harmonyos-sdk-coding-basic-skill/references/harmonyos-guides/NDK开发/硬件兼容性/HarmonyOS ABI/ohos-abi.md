...
content_hash: sha256:08d47ac4249c25201ae89cdf91f30b588e601225ffb6860d856c379ffb109849
---
...
当前通过[DevEco Studio构建NDK工程](<../../构建NDK工程/使用DevEco Studio模板构建NDK工程/build-with-ndk-ide.md>)时，不支持armeabi-v7a编译环境。如需要在HarmonyOS中使用该编译环境，需要通过[CMake方式构建](../../构建NDK工程/使用命令行CMake构建NDK工程/build-with-ndk-cmake.md)。
