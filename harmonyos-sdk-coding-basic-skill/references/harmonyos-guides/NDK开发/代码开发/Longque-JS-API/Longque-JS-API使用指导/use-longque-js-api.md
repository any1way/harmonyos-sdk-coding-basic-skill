...
scraped_at: 2026-06-01T15:16:36+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:66c9bafb7d5ea08f1eae16ac92f29d436fc200def13899f905524132a4478a87
---
...
本示例展示了在 JSVM 中使用 Longque JS API 的方式，JSVM-API 接口开发流程参考[使用JSVM-API实现JS与C/C++语言交互开发流程](../../使用JSVM-API实现JS与CC++语言交互/使用JSVM-API实现JS与CC++语言交互开发流程/use-jsvm-process.md)，本文仅对接口对应C++相关代码进行展示。
