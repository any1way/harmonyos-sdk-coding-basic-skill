...
scraped_at: 2026-06-11T15:21:37+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:bfbb9b42e0f38c2d675892512fc9134cc88aef3a8abe8487228ede8879684e62
---
## 场景介绍
...
常用接口如下表所示，具体API说明详见[Native\_Bundle](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/C API/模块/Native_Bundle/capi-native-bundle.md>)。

| 接口名 | 描述 |
| --- | --- |
| [OH\_NativeBundle\_GetCurrentApplicationInfo](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/C API/头文件/native_interface_bundle.h/capi-native-interface-bundle-h.md#oh_nativebundle_getcurrentapplicationinfo>) | 获取应用自身相关信息。 |
| [OH\_NativeBundle\_GetAppId](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/C API/头文件/native_interface_bundle.h/capi-native-interface-bundle-h.md#oh_nativebundle_getappid>) | 获取自身应用的appId信息。 |
| [OH\_NativeBundle\_GetAppIdentifier](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/C API/头文件/native_interface_bundle.h/capi-native-interface-bundle-h.md#oh_nativebundle_getappidentifier>) | 获取自身应用的appIdentifier信息。 |
| [OH\_NativeBundle\_GetMainElementName](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/C API/头文件/native_interface_bundle.h/capi-native-interface-bundle-h.md#oh_nativebundle_getmainelementname>) | 获取自身应用入口的信息。 |
| [OH\_NativeBundle\_GetCompatibleDeviceType](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/C API/头文件/native_interface_bundle.h/capi-native-interface-bundle-h.md#oh_nativebundle_getcompatibledevicetype>) | 获取自身应用适用的设备类型。 |
| [OH\_NativeBundle\_IsDebugMode](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/C API/头文件/native_interface_bundle.h/capi-native-interface-bundle-h.md#oh_nativebundle_isdebugmode>) | 查询当前应用的调试模式。从API version 20开始支持。 |
| [OH\_NativeBundle\_GetModuleMetadata](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/C API/头文件/native_interface_bundle.h/capi-native-interface-bundle-h.md#oh_nativebundle_getmodulemetadata>) | 获取当前应用的元数据信息。从API version 20开始支持。 |
| [OH\_NativeBundle\_GetAbilityResourceInfo](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/C API/头文件/native_interface_bundle.h/capi-native-interface-bundle-h.md#oh_nativebundle_getabilityresourceinfo>) | 获取支持打开特定文件类型的组件资源信息列表。从API version 21开始支持。 |

## 开发步骤

**1. 创建工程**

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/h4kJoUbtTuWoZh3L8eJmcA/zh-cn_image_0000002622859273.png?HW-CC-KV=V1&HW-CC-Date=20260611T072136Z&HW-CC-Expire=86400&HW-CC-Sign=399D191A0ACA5D79B51EBED21AACBAAAE3D5E0D91B70795491D6DCA40282B7D1)
...
2. 打开src/main/cpp/napi\_init.cpp文件，添加头文件。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/bmsSample/NativeBundleGuidelines/entry/src/main/cpp/napi_init.cpp#L16-L24)
...
1. 打开src/main/cpp/napi\_init.cpp文件，文件Init会对当前方法进行初始化映射，这里定义对外的接口。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/bmsSample/NativeBundleGuidelines/entry/src/main/cpp/napi_init.cpp#L381-L410)
2. 在src/main/cpp/napi\_init.cpp文件中获取Native的包信息对象，并转为js的包信息对象，即可在js侧获取应用的信息：
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/bmsSample/NativeBundleGuidelines/entry/src/main/cpp/napi_init.cpp#L51-L202)
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/bmsSample/NativeBundleGuidelines/entry/src/main/cpp/napi_init.cpp#L204-L379)
...
1. 在src/main/cpp/types/libentry/Index.d.ts文件中，声明暴露接口。
   ...
   [Index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/bmsSample/NativeBundleGuidelines/entry/src/main/cpp/types/libentry/Index.d.ts#L15-L25)
...
1. 打开src/main/ets/pages/Index.ets，导入"libentry.so"，调用Native接口打印出获取的信息内容。示例如下：
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/bmsSample/NativeBundleGuidelines/entry/src/main/ets/pages/Index.ets#L16-L60)

关于包管理NDK接口说明，可参考[Native\_Bundle模块介绍](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/C API/模块/Native_Bundle/capi-native-bundle.md>)。
