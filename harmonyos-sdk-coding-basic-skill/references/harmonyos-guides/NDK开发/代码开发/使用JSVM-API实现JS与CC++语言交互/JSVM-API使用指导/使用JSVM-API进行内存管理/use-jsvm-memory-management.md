...
scraped_at: 2026-06-01T15:16:17+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:38829c90431c5e215778833c71f2d276b78d137ae520403f50a5b80a8573cf67
---
## 简介
...
JSVM-API接口开发流程请参考[使用JSVM-API实现JS与C/C++语言交互开发流程](../../使用JSVM-API实现JS与CC++语言交互开发流程/use-jsvm-process.md)。本文仅展示接口对应C++及ArkTS相关代码。
