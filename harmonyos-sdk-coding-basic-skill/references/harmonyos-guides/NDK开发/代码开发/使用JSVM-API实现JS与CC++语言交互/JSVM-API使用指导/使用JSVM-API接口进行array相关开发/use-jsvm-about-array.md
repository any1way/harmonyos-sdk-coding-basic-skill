...
scraped_at: 2026-06-01T15:16:03+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:23c11ecc26902bb80fd05e4ba83a79387990ac1227c266791b71aae8cbb3a980
---
## 简介
...
JSVM-API 接口开发流程参考[使用 JSVM-API 实现 JS 与 C/C++ 语言交互开发流程](../../使用JSVM-API实现JS与CC++语言交互开发流程/use-jsvm-process.md)，本文仅对接口对应 C++ 相关代码进行展示。
