...
scraped_at: 2026-06-01T15:16:02+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:abb6829169b3e283c4c03f2a4298a2a5908fe2391c1a995b88d4d7cc290f8feb
---
## 简介
...
JSVM-API 接口开发流程参考[使用JSVM-API实现JS与C/C++语言交互开发流程](../../使用JSVM-API实现JS与CC++语言交互开发流程/use-jsvm-process.md)，本文仅对接口对应 C++ 相关代码进行展示。
