...
scraped_at: 2026-06-01T15:15:58+08:00
doc_updated_at: 2026-03-17
content_hash: sha256:8d3e1285b1a1e25df5fc6bf37fba36933934a423d493588a7ecfa4dc460eb6a3
---
## 简介

JSVM-API WebAssembly 接口提供了 WebAssembly 字节码编译、WebAssembly 函数优化、WebAssembly cache 序列化和反序列化的能力。

权限要求：WebAssembly相关接口需要应用拥有JIT权限才能执行，可参考[JSVM 申请JIT权限指导](<../../JSVM-API典型使用场景指导/JSVM-API 申请JIT权限指导/jsvm-apply-jit-profile.md>)申请对应权限。
...
参考 [使用JSVM-API实现JS与C/C++语言交互开发流程](../../使用JSVM-API实现JS与CC++语言交互开发流程/use-jsvm-process.md) 了解 JSVM-API 接口开发流程。本文仅展示接口对应的 C++ 代码。
