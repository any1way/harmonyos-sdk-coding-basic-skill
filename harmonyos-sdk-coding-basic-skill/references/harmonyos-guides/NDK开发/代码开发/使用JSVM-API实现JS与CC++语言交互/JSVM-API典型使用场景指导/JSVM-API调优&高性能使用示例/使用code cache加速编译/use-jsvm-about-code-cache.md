...
scraped_at: 2026-06-01T15:16:33+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:c34e7931bc3f8a4ae7482cb5f170c9b483919f89980e037f8f056f0d92deb110
---
##code cache简介
...
其中使用到的JSVM-API可以参考 [JSVM数据类型与接口说明](<../../../JSVM-API 支持的数据类型和接口/jsvm-data-types-interfaces.md>)，这里仅展示调用的步骤。

外层跨语言交互的部分可以参考 [使用JSVM-API实现JS与C/C++语言交互开发流程](../../../使用JSVM-API实现JS与CC++语言交互开发流程/use-jsvm-process.md)。
