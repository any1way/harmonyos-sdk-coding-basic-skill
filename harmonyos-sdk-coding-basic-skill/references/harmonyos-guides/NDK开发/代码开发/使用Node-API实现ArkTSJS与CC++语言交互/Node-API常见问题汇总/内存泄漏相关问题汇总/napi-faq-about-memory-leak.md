...
scraped_at: 2026-06-01T15:15:45+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:ccd34e1610fe8b39f0d0c86e2aea0c99740b7a104eed9f268aa93a4e1e25d03f
---
...
[基础内存分析：Allocation分析](../../../../../优化应用性能/基础内存：Allocation分析/ide-insight-session-allocations.md)
...
[使用Node-API接口进行生命周期相关开发](../../Node-API使用指导/使用Node-API接口进行生命周期相关开发/use-napi-life-cycle.md)

使用Node-API时导致内存泄漏的常见原因：

1. napi\_value不在napi\_handle\_scope管理中，导致napi\_value持有的ArkTS对象无法释放，该问题常见于[直接使用uv\_queue\_work的场景](../../Node-API开发规范/napi-guidelines.md#异步任务)中。解决方法是添加napi\_open\_handle\_scope和napi\_close\_handle\_scope接口。

   此类泄漏可通过snapshot分析定位原因，泄漏的ArkTS对象distance为1，即不知道被谁持有，这种情况下一般就是被native（napi\_value是个指针，指向native持有者）持有了，且napi\_value不在napi\_handle\_scope范围内，可参考[易错API的使用规范](../../../../../../best-practices/稳定性/稳定性优化/稳定性编码规范/易错API的使用规范/bpta-stability-coding-standard-api.md#section1219614634615)。
