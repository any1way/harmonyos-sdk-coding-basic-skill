...
scraped_at: 2026-06-11T15:20:45+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:d87db0e1549e600feb37e80b2d3c41d45060261e792d299030551a1a499f1ec7
---
...
1. 排查是否存在多线程安全问题（概率较大）。
   ...
   [常见多线程安全问题](../../../../../../best-practices/稳定性/稳定性检测/开发态稳定性检测/方舟类问题检测/方舟运行时检测/bpta-stability-ark-runtime-detection.md#section19357830121120)

   DevEco Studio开关：

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/JNRmEXFfSlqFGfdLDA_sXw/zh-cn_image_0000002622859259.png?HW-CC-KV=V1&HW-CC-Date=20260611T072043Z&HW-CC-Expire=86400&HW-CC-Sign=82245F97EBFD984723212739A15D323559C62C536A93EAB1ACF94132EAA28067)
...
[方舟运行时API](../../../../../../best-practices/稳定性/稳定性优化/稳定性编码规范/易错API的使用规范/bpta-stability-coding-standard-api.md#section1219614634615)。
...
上面提到，C++线程都是抛任务到ArkTS线程，进而执行ArkTS方法。关于线程安全，可参考[使用Node-API接口进行线程安全开发](../../Node-API典型使用场景/使用Node-API接口进行线程安全开发/use-napi-thread-safety.md)。

另外，开发过程中也可以打开[方舟多线程检测](../../../../../../best-practices/稳定性/稳定性检测/开发态稳定性检测/方舟类问题检测/方舟运行时检测/bpta-stability-ark-runtime-detection.md#section75786272088)开关，这个开关可以拦截多线程安全问题。
...
1. 关于保存napi\_env：
   ...
   [napi\_env禁止缓存的原因是什么](../../../../../../harmonyos-faqs/应用框架开发/NDK开发/NDK开发/napi_env禁止缓存的原因是什么/faqs-ndk-73.md) 。
2. 该问题的关键在于：
...
* 可参考文档：
  ...
  [napi\_create\_reference、napi\_delete\_reference](../../Node-API使用指导/使用Node-API接口进行生命周期相关开发/use-napi-life-cycle.md)
...
[使用Node-API接口注册和使用环境清理钩子](../../Node-API使用指导/使用Node-API接口注册和使用环境清理钩子/use-napi-about-cleanuphook.md)
...
[使用Node-API接口进行生命周期相关开发](../../Node-API使用指导/使用Node-API接口进行生命周期相关开发/use-napi-life-cycle.md#napi_open_handle_scopenapi_close_handle_scope)。
