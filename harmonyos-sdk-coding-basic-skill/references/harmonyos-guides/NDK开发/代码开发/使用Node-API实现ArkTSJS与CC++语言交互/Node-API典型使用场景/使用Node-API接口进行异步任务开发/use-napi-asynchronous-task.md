...
scraped_at: 2026-06-11T15:20:28+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:29451708e482e5dbfedde8f18d857f39b7595216fa76ecba99ce1213d4052f6a
---
## 场景介绍

[napi\_create\_async\_work](../../../../../../harmonyos-references/Node-API/napi.md#napi_create_async_work)是Node-API接口之一，用于创建一个异步工作对象。在需要执行耗时操作的场景中使用，避免阻塞env所在的ArkTS线程，确保应用程序的性能和响应速度。例如以下场景：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5b/v3/C4EvOPe9T_ulIa1kW3bgxg/zh-cn_image_0000002622859257.png?HW-CC-KV=V1&HW-CC-Date=20260611T072026Z&HW-CC-Expire=86400&HW-CC-Sign=1D9BADE7AF20891C3BE6403938DA3EB95181B06DF380836FCB4833801DF2CCC9)

## 使用Promise方式示例

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/BzjECh_EQ8KYq56pLvT__g/zh-cn_image_0000002622699377.png?HW-CC-KV=V1&HW-CC-Date=20260611T072026Z&HW-CC-Expire=86400&HW-CC-Sign=5028FD3A34215CC481860276391ADA9D7CB1A0B50860A62217FE8B775F842B24)
...
2. 使用napi\_create\_async\_work创建异步任务，使用napi\_queue\_async\_work将任务加入队列，等待执行。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/cpp/napi_init.cpp#L16-L78)
3. 定义异步任务的第一个回调函数，该函数在工作线程中执行，处理具体的业务逻辑。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/cpp/napi_init.cpp#L28-L34)
4. 定义异步任务的第二个回调函数，该函数在主线程执行，将结果传递给ArkTS侧。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/cpp/napi_init.cpp#L36-L52)
5. 模块注册及ArkTS侧调用接口。
   ...
   [Index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/cpp/types/libentry/Index.d.ts#L15-L18)
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/ets/pages/Index.ets#L54-L58)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/p70p3KWuQjyuLru0t2B6Yw/zh-cn_image_0000002592219816.png?HW-CC-KV=V1&HW-CC-Date=20260611T072026Z&HW-CC-Expire=86400&HW-CC-Sign=7AA1A2A381A1AA549F16A4CC0A66FF3923F41094CF79E8D813B69C7064DDE621)
...
1. 使用napi\_create\_async\_work创建异步任务，并使用napi\_queue\_async\_work将异步任务加入队列，等待执行。
   ...
   [callback.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/cpp/callback.cpp#L16-L80)
2. 定义异步任务的第一个回调函数，该函数在工作线程中执行，处理具体的业务逻辑。
   ...
   [callback.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/cpp/callback.cpp#L30-L36)
3. 定义异步任务的第二个回调函数，该函数在主线程执行，将结果传递给ArkTS侧。
   ...
   [callback.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/cpp/callback.cpp#L38-L57)
4. 模块注册以及ArkTS侧调用接口。
   ...
   [Index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/cpp/types/libentry1/Index.d.ts#L16-L18)
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/ets/pages/Index.ets#L64-L68)
...
### 基于[Worker](../../../../../应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/Worker简介/worker-introduction.md)实现的C++子线程与ArkTS子线程交互场景
...
2. Worker线程示例代码。
   ...
   [Worker.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/ets/workers/Worker.ets#L16-L30)
3. ArkTS线程代码。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/ets/pages/Index.ets#L74-L81)
...
### 基于[Taskpool](../../../../../应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/TaskPool简介/taskpool-introduction.md)实现的C++子线程与ArkTS子线程交互场景
...
1. ArkTS线程代码。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPIAsynchronousTask/entry/src/main/ets/pages/Index.ets#L87-L89)
...
* 在任务的执行时序上，napi\_async\_work仅保证complete\_cb在execute\_cb之后执行。不同napi\_async\_work的execute\_cb在各自的工作线程上运行，因此无法保证不同execute\_cb的执行顺序。如果任务执行需要顺序，建议使用napi\_threadsafe\_function系列接口，这些接口是保序的。具体使用方法可参考[链接](../使用Node-API接口进行线程安全开发/use-napi-thread-safety.md)。
