...
scraped_at: 2026-06-01T15:15:33+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:4ae1d1e65e82ac380f566449f439f250fadcf41fbd106a58927a789465446fd7
---
## 场景介绍
...
建议使用[napi\_load\_module\_with\_info](../使用Node-API接口进行模块加载/use-napi-load-module-with-info.md)来进行模块加载，该接口支持了更多的场景。
...
* **加载系统模块**
  ...
  [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPILoadModule/entry/src/main/cpp/napi_init.cpp#L18-L54)
* **加载ets目录下文件中的模块**
  ...
  [Test.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPILoadModule/entry/src/main/ets/Test.ets#L15-L21)
...
1. 需要在模块的build-profile.json5文件中进行以下配置：
   ...
   [build-profile.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPILoadModule/entry/build-profile.json5#L18-L34)
2. 使用napi\_load\_module加载Test文件，调用函数test以及获取变量value：
   ...
   [file.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/NodeAPI/NodeAPIClassicUseCases/NodeAPILoadModule/entry/src/main/cpp/file.cpp#L18-L51)
