...
scraped_at: 2026-06-11T15:19:42+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:4c2704919b10e1b14f832f5337ccf65303cacd979c8861010183847935bcc6ab
---
...
* **[Node-API](../代码开发/使用Node-API实现ArkTSJS与CC++语言交互/Node-API简介/napi-introduction.md)**

  曾用名NAPI，是HarmonyOS中提供ArkTS/JS与C/C++跨语言调用的接口，该接口基于Node.js的Node-API扩展而来，但不完全兼容。

### NDK目录简介

获取NDK开发包，请参考[NDK开发工具目录](../构建NDK工程/使用命令行CMake构建NDK工程/build-with-ndk-cmake.md#获取ndk开发包)。

* build目录：放置预定义的toolchain脚本文件[hmos.toolchain.cmake](../构建NDK工程/NDK工程构建概述/build-with-ndk-overview.md#hmostoolchaincmake简介)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/tdBSbkDVQlaQvD4f2D1N8w/zh-cn_image_0000002592219798.png?HW-CC-KV=V1&HW-CC-Date=20260611T071942Z&HW-CC-Expire=86400&HW-CC-Sign=CE5B5F162C3E86DD680E853F7AE08A7425CAE53CB2A57D6B677458FBECE84082)
...
* llvm文件夹：放置NDK提供的编译器
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/CrjeW2IgTfWXL-mCp4TBkw/zh-cn_image_0000002592379732.png?HW-CC-KV=V1&HW-CC-Date=20260611T071942Z&HW-CC-Expire=86400&HW-CC-Sign=1C62CB36606CD7E6B1DE7B73A0176372E324564264A168EFD438CFEADDF38B53)
