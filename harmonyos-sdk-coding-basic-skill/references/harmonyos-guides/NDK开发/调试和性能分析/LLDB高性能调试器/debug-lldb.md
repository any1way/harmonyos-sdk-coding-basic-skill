...
scraped_at: 2026-06-11T15:21:46+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:03754db237a7543571244f8a9a4a7a3a3998ef6f0f1b157f31c3a7c11b0f006f
---
## 概述
...
* 远程调试（**主要调试方式**）
  ...
  + 一键调试：
    ...
    - 下载DevEco Studio，根据IDE的调试方法即可进行一键调试：[通过DevEco Studio调试](../调试和性能分析概述/debug-performance-profiling-overview.md)。
  ...
  + 手动调试：
    ...
    - PC上准备lldb，如windows系统则使用**lldb.exe**, 稍后将使用lldb与OH设备上的lldb-server远程连接进行调试。
      ...
      ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/nJBGHg3qRdaUUgyXm8TLQQ/zh-cn_image_0000002592219850.png?HW-CC-KV=V1&HW-CC-Date=20260611T072145Z&HW-CC-Expire=86400&HW-CC-Sign=680C5FE6CC6F9B24C3F23E301ACCBBCD5BE881BCC453809DCDBE5BD5A3E65FF8)
  + 设备状态与调试支持矩阵（分三种情况）：
