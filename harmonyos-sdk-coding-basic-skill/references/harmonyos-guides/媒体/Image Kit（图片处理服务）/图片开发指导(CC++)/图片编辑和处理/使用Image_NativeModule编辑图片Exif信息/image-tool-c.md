...
content_hash: sha256:b93e99c9813539b752b81e3864e7f01e89db31e26c2422dfdb284c35113e2dee
---
...
系统目前仅支持对部分Exif信息的查看和修改，具体支持的范围请参见：[变量](<../../../../../../harmonyos-references/Image Kit（图片处理服务）/C API/头文件/image_common.h/capi-image-common-h.md#变量>)里的OHOS\_IMAGE\_PROPERTY\_XXX类型。需要注意的是，DNG格式图片仅支持读取Exif信息，不支持修改。
...
Exif信息的读取与编辑相关C API接口的详细介绍请参见[OH\_ImageSourceNative\_GetImageProperty()](<../../../../../../harmonyos-references/Image Kit（图片处理服务）/C API/头文件/image_source_native.h/capi-image-source-native-h.md#oh_imagesourcenative_getimageproperty>)和[OH\_ImageSourceNative\_ModifyImageProperty()](<../../../../../../harmonyos-references/Image Kit（图片处理服务）/C API/头文件/image_source_native.h/capi-image-source-native-h.md#oh_imagesourcenative_modifyimageproperty>)。
...
1. 导入相关头文件。
   ...
   [loadImageSource.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Image/ImageNativeSample/entry/src/main/cpp/loadImageSource.cpp#L17-L22)
...
6. 在成功创建ImageSource对象后，读取、编辑Exif信息。
   ...
   创建ImageSource对象可参考[图片解码](../../图片解码/使用Image_NativeModule完成图片解码/image-source-c.md)。
