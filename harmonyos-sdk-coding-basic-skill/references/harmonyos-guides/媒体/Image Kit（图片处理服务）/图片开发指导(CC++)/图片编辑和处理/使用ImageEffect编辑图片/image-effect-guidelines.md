...
content_hash: sha256:f653d950ababa380bb88d2a111bd9d83120b26918a35fde1235849c7bb7a6f54
---
## 场景介绍
...
详细的接口说明请参考[ImageEffect](<../../../../../../harmonyos-references/Image Kit（图片处理服务）/C API/模块/ImageEffect/capi-imageeffect.md>)。
...
3. 设置处理数据。
   ...
   **场景一：设置OH\_PixelmapNative输入类型。**
   ...
   OH\_PixelmapNative的具体使用方法请参考[Pixelmap开发指导](../../../图片开发指导(依赖JS对象)(不再推荐)/位图操作/image-pixelmap-operation-native.md)。
   ...
   **场景二：设置OH\_NativeBuffer输入类型。**
   ...
   OH\_NativeBuffer的具体使用方法请参考[NativeBuffer开发指导](<../../../../../图形/ArkGraphics 2D（方舟2D图形服务）/图形缓冲区/NativeBuffer开发指导 (CC++)/native-buffer-guidelines.md>)。
   ...
   **场景五：设置OHNativeWindow输入类型。**
   ...
   XComponent模块的具体使用方法请参考[XComponent组件参考](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)。

   NativeWindow模块的具体使用方法请参考[OHNativeWindow](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/模块/NativeWindow/capi-nativewindow.md>)。

   Camera的具体使用方法请参考[Camera预览参考](<../../../../Camera Kit（相机服务）/开发相机应用基础能力(CC++)/预览(CC++)/native-camera-preview.md>)。
