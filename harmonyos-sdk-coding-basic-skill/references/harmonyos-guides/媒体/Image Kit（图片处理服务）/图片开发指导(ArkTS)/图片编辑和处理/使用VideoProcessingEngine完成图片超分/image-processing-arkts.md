...
scraped_at: 2026-06-11T14:56:55+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:82df98bb4fd18914f940096925da3f6d2a96de7ea861ac83aa7a112de5858b23
---
本模块提供图片细节增强的[ArkTS接口](<../../../../../../harmonyos-references/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.videoProcessingEngine (视频处理引擎)/js-apis-videoprocessingengine.md>)，通过调用本模块，可以实现图片内容的清晰度增强及缩放功能，处理后的数据可以用于送显和输出。
...
1. 当前仅支持处理同时满足以下条件的图片：
   ...
   * 处理的PixelMap对象需为[DMA内存](../../图片解码/图片解码内存优化(ArkTS)/image-allocator-type.md#内存类型介绍)。
