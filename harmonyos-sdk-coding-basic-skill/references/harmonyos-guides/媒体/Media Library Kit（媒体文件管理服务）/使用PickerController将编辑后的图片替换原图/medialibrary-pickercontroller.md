...
scraped_at: 2026-06-11T14:58:18+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:5d5605cd750b8aaa3ae3d88fea9092439f752fa046fc729544a15053dd933e44
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/k2ZJpZHMQ16lZjx2vxxK4w/zh-cn_image_0000002592219038.gif?HW-CC-KV=V1&HW-CC-Date=20260611T065816Z&HW-CC-Expire=86400&HW-CC-Sign=C66DADBE203927FA82343BC4CB786B3BF875667695824199025FAB476C0CDE4B)
...
2. 创建参数列表。
   ...
   ```
3. 调用[replacePhotoPickerPreview()](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.PhotoPickerComponent (PhotoPicker组件)/ohos-file-photopickercomponent.md#replacephotopickerpreview15>)替换图片/视频。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/iCVRrkuvTFW__KvY8r9zww/zh-cn_image_0000002592378972.gif?HW-CC-KV=V1&HW-CC-Date=20260611T065816Z&HW-CC-Expire=86400&HW-CC-Sign=D05AC1BDC1461313C362260AF40AD6BE1C4317421042315B66C1E950DD70BE9F)
...
2. 创建参数列表。
   ...
   3. @State replaceUrl: string = ''; // 原图编辑后的沙箱URI
   ```
3. 调用[saveTrustedPhotoAssets()](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.PhotoPickerComponent (PhotoPicker组件)/ohos-file-photopickercomponent.md#savetrustedphotoassets15>)保存图片/视频到图库。
   ...
   该接口使用依赖[pickerController.replacePhotoPickerPreview](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.PhotoPickerComponent (PhotoPicker组件)/ohos-file-photopickercomponent.md#replacephotopickerpreview15>)，需要先执行[pickerController.replacePhotoPickerPreview](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.PhotoPickerComponent (PhotoPicker组件)/ohos-file-photopickercomponent.md#replacephotopickerpreview15>)后才能执行[pickerController.saveTrustedPhotoAssets](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.PhotoPickerComponent (PhotoPicker组件)/ohos-file-photopickercomponent.md#savetrustedphotoassets15>)。
