...
scraped_at: 2026-06-11T14:58:16+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:7fb633c7fac09f556a58bb12f95d6d945d6be9aa7f44690cc281e55ff6dace86
---
开发者可以在布局中嵌入AlbumPickerComponent组件，通过此组件，应用无需申请权限，即可访问公共目录中的相册列表。

需配合[使用PhotoPicker组件访问图片/视频](../使用PhotoPicker组件访问图片视频/component-guidelines-photoviewpicker.md)一起使用，用户通过AlbumPickerComponent组件选择对应相册并通知PhotoPickerComponent组件刷新成对应相册的图片和视频。

界面效果如图所示。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/5zB2sEBzTXeA5Q8PeoxWaA/zh-cn_image_0000002622858477.png?HW-CC-KV=V1&HW-CC-Date=20260611T065815Z&HW-CC-Expire=86400&HW-CC-Sign=5C8C8BC0A4AE9DB4A0379A4B6548B2A7B99B88C5DAE05A3F5BBCE81D2A994524)
...
2. 创建相册组件配置选项实例（AlbumPickerOptions）。
   ...
   通过AlbumPickerOptions，开发者可配置相册页主题颜色，详见[AlbumPickerOptions API参考](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.AlbumPickerComponent (Album Picker组件)/ohos-file-albumpickercomponent.md#albumpickeroptions>)。
...
3. 初始化组件配置选项实例（AlbumPickerOptions）。
   ...
   ```
4. 创建[AlbumPickerComponent](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.AlbumPickerComponent (Album Picker组件)/ohos-file-albumpickercomponent.md#albumpickercomponent>)组件。
