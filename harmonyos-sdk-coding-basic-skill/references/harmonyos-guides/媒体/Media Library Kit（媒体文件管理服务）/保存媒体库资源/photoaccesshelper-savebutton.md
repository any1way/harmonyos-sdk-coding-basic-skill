...
scraped_at: 2026-06-11T14:58:14+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:7548565e65ed17b2d9fabb24d74e9c1f31dbed3ab731450969e87c5834dadb6f
---
...
调用[phAccessHelper.getSupportedPhotoFormats](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Interface (PhotoAccessHelper)/arkts-apis-photo_93807367.md#getsupportedphotoformats18>)接口获取支持保存的图片类型资源格式。
...
[Scene1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MediaLibraryKit/SaveButtonSample/entry/src/main/ets/pages/Scene1.ets#L16-L93)

## 使用安全控件保存媒体库资源

安全控件的介绍可参考[SaveButton](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/SaveButton/ts-security-components-savebutton.md)。保存前可以通过调用[registerChange](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Interface (PhotoAccessHelper)/arkts-apis-photo_93807367.md#registerchange>)接口注册对默认URI（[DEFAULT\_PHOTO\_URI](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Enums/arkts-apis-photoaccesshelper-e.md#defaultchangeuri>)）的监听。资源保存成功后，根据接收到该资源的[NOTIFY\_ADD](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Enums/arkts-apis-photoaccesshelper-e.md#notifytype>)通知完成后续业务。
...
1. 设置安全控件按钮属性。
2. 创建安全控件按钮。
3. 调用[registerChange](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Interface (PhotoAccessHelper)/arkts-apis-photo_93807367.md#registerchange>)接口注册对默认URI（[DEFAULT\_PHOTO\_URI](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Enums/arkts-apis-photoaccesshelper-e.md#defaultchangeuri>)）的监听。
4. 调用[MediaAssetChangeRequest.createImageAssetRequest](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-mediaassetchangerequest#createimageassetrequest11)和[PhotoAccessHelper.applyChanges](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Interface (PhotoAccessHelper)/arkts-apis-photo_93807367.md#applychanges11>)接口创建图片资源。
5. 调用[getAsset](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-mediaassetchangerequest#getasset11)接口获取保存的资产，并获取资产URI。在接收到资产URI的[NOTIFY\_ADD](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Enums/arkts-apis-photoaccesshelper-e.md#notifytype>)通知后，完成后续业务。
...
[Scene2.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MediaLibraryKit/SaveButtonSample/entry/src/main/ets/pages/Scene2.ets#L16-L168)
...
1. 指定待保存到媒体库的[应用文件](<../../../应用框架/Core File Kit（文件基础服务）/应用文件/应用文件访问与管理/应用文件访问(ArkTS)/app-file-access.md>)uri（需为应用沙箱路径）。
2. 指定待保存照片的创建选项，包括文件后缀和照片类型，标题和照片子类型可选。
3. 调用[showAssetsCreationDialog](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Interface (PhotoAccessHelper)/arkts-apis-photo_93807367.md#showassetscreationdialog12>)，基于弹窗授权的方式获取的目标[媒体文件](<../../../应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#媒体文件uri>)uri。
...
[Scene3.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MediaLibraryKit/SaveButtonSample/entry/src/main/ets/pages/Scene3.ets#L16-L141)
