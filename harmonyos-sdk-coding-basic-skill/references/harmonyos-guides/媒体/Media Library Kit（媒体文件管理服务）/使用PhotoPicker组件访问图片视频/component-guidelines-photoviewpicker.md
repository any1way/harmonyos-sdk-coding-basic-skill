...
scraped_at: 2026-06-01T11:31:00+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:68c604007afa581a7ab4922b88973cb7a2f368f2442d7936bf7fe100037e6c3b
---
...
2. 创建Picker组件配置选项实例（PickerOptions）和控制实例（PickerController）。
   ...
   通过PickerOptions，开发者可配置Picker宫格的样式（如勾选框背景色、文本颜色等）、滑动预览方向、最大选择数量等参数，详见[PickerOptions API参考](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.PhotoPickerComponent (PhotoPicker组件)/ohos-file-photopickercomponent.md#pickeroptions>)。
...
3. 应用界面出现时，初始化组件配置选项实例（PickerOptions）。
   ...
   此处仅列举实例用到的参数，当前支持的配置项及其取值范围详见[PickerOptions API参考](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.PhotoPickerComponent (PhotoPicker组件)/ohos-file-photopickercomponent.md#pickeroptions>)。
...
4. 实现回调函数。
   ...
   * 进退大图、切换大图回调，上报的大图相关信息详见[PhotoBrowserInfo](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.PhotoPickerComponent (PhotoPicker组件)/ohos-file-photopickercomponent.md#photobrowserinfo>)。
   * 勾选图片/视频，将上报图片URI供应用使用。

     说明

     + 回调返回的所有URI均为只读URI，开发者可以根据结果集中的URI读取文件数据。但不能在Picker的回调中直接使用此URI打开文档，需要定义一个全局变量保存URI，样例可参考[指定URI读取文件数据](../使用Picker选择媒体库资源/photoaccesshelper-photoviewpicker.md#指定uri读取文件数据)、[指定URI获取图片或视频资源](../使用Picker选择媒体库资源/photoaccesshelper-photoviewpicker.md#指定uri获取图片或视频资源)。
     + 如需获取元数据，可通过[文件管理](<../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md>)和[文件URI](<../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fileuri (文件URI)/js-apis-file-fileuri.md>)接口，根据uri获取部分文件属性信息，比如文件大小、访问时间、修改时间、文件名、文件路径等。
   * 点击图片（缩略图item），将上报图片/视频信息[ItemInfo](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.PhotoPickerComponent (PhotoPicker组件)/ohos-file-photopickercomponent.md#iteminfo>)；
   * 点击相机item，可默认拉起系统相机或应用自行处理。如何自行拉起相机请参考[cameraPicker.pick](<../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.cameraPicker (相机选择器)/js-apis-camerapicker.md#camerapickerpick>)。

   支持的回调事件及其参数请参考[PhotoPickerComponent API参考](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.PhotoPickerComponent (PhotoPicker组件)/ohos-file-photopickercomponent.md#photopickercomponent>)。
   ...
   72. }
   ```
5. 创建[PhotoPickerComponent](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.PhotoPickerComponent (PhotoPicker组件)/ohos-file-photopickercomponent.md#photopickercomponent>)组件。
...
6. 通过PickerController向Picker组件发送数据，实现控制PhotoPickerComponent组件行为。
   ...
   存在多种用法，详见[PickerController](<../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS组件/@ohos.file.PhotoPickerComponent (PhotoPicker组件)/ohos-file-photopickercomponent.md#pickercontroller>)API文档。
