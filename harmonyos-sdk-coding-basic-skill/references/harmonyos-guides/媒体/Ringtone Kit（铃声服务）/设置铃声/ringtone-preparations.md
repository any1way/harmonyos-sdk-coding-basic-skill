...
scraped_at: 2026-06-01T11:31:19+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:7e6f1bae3cfb7cdbb60e68728a392b17303d31d7447060c13797247a1db8a28a
---
1. 导入ringtone模块和相关公共模块。
   ...
   ```
2. 调用[ringtone.getSupportedRingtoneTypes](<../../../../harmonyos-references/Ringtone Kit（铃声服务）/ArkTS API/ringtone（铃声服务）/ringtone-ringtone.md#ringtonegetsupportedringtonetypes>)接口，查询支持设置的铃声类型。
   ...
   ```
3. 调用[ringtone.getSupportedDataTypes](<../../../../harmonyos-references/Ringtone Kit（铃声服务）/ArkTS API/ringtone（铃声服务）/ringtone-ringtone.md#ringtonegetsupporteddatatypes>)接口，查询支持的数据类型。当前支持格式：MP3，OGG，FLAC，AAC，MP2，M4A。
   ...
   ```
4. 调用[ringtone.startRingtoneSetting](<../../../../harmonyos-references/Ringtone Kit（铃声服务）/ArkTS API/ringtone（铃声服务）/ringtone-ringtone.md#ringtonestartringtonesetting>)接口拉起设置弹窗，用户设置铃声后返回设置的铃声类型。
   ...
   7. });
   ```
5. 调用[ringtone.getSupportedMaxDuration](<../../../../harmonyos-references/Ringtone Kit（铃声服务）/ArkTS API/ringtone（铃声服务）/ringtone-ringtone.md#ringtonegetsupportedmaxduration>)接口，获取当前铃声支持的最大时长。
