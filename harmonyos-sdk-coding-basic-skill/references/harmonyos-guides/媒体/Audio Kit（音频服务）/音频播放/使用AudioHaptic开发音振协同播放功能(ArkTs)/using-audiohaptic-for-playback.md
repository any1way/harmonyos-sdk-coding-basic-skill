...
scraped_at: 2026-06-11T14:53:49+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:59bb24ee4be86659434c5edb609649302c9d7b78d1922a34d190daf4b87ddd0e
---
AudioHaptic提供音频与振动协同播放及管理的方法，适用于需要在播放音频时同步发起振动的场景，如来电铃声随振、键盘按键反馈、消息通知反馈等。

## 开发指导

使用AudioHaptic播放音频并同步开启振动，涉及到音频及振动资源的管理、音频时延模式及音频流使用类型的配置、音振播放器的创建及管理等。本开发指导将以一次音振协同播放的过程为例，向开发者讲解如何使用AudioHaptic进行音振协同播放，建议配合[audioHaptic](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audioHaptic (音振协同)/js-apis-audiohaptic.md>)的API说明阅读。

### 权限申请

如果应用创建的AudioHapticPlayer需要触发振动，则需要校验应用是否拥有该权限：ohos.permission.VIBRATE。

1. [声明权限](../../../../系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)。
2. [向用户申请授权](../../../../系统/安全/程序访问控制/应用权限管控/申请应用权限/向用户申请授权/request-user-authorization.md)。
...
1. 获取音振管理器实例，并注册音频及振动资源，资源支持情况可以查看[AudioHapticManager](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audioHaptic (音振协同)/js-apis-audiohaptic.md#audiohapticmanager>)。

   说明

   开发者可通过如下两种方式注册资源：

   * 方式1：使用[registerSource](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audioHaptic (音振协同)/js-apis-audiohaptic.md#registersource>)接口，通过文件URI来注册资源。
   * 方式2（推荐）：从API version 20开始，支持使用[registerSourceFromFd](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audioHaptic (音振协同)/js-apis-audiohaptic.md#registersourcefromfd20>)接口，通过文件描述符来注册资源，更便于开发者使用。
   ...
   [haptic.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRendererSampleJS/entry/src/main/ets/pages/haptic.ets#L16-L117)
2. 设置音振播放器参数，各参数作用可以查看[AudioHapticManager](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audioHaptic (音振协同)/js-apis-audiohaptic.md#audiohapticmanager>)。
   ...
   [haptic.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRendererSampleJS/entry/src/main/ets/pages/haptic.ets#L83-L89)
3. 调用[createPlayer](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audioHaptic (音振协同)/js-apis-audiohaptic.md#createplayer>)方法，创建AudioHapticPlayer实例。
   ...
   [haptic.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRendererSampleJS/entry/src/main/ets/pages/haptic.ets#L24-L107)
4. 调用[start](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audioHaptic (音振协同)/js-apis-audiohaptic.md#start>)方法，开启音频播放并同步开启振动。
   ...
   [haptic.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRendererSampleJS/entry/src/main/ets/pages/haptic.ets#L127-L143)
5. 调用[stop](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audioHaptic (音振协同)/js-apis-audiohaptic.md#stop>)方法，停止音频播放并同步停止振动。
   ...
   [haptic.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRendererSampleJS/entry/src/main/ets/pages/haptic.ets#L154-L170)
6. 调用[release](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audioHaptic (音振协同)/js-apis-audiohaptic.md#release>)方法，释放AudioHapticPlayer实例。
   ...
   [haptic.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRendererSampleJS/entry/src/main/ets/pages/haptic.ets#L181-L197)
7. 调用[unregisterSource](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audioHaptic (音振协同)/js-apis-audiohaptic.md#unregistersource>)方法，将已注册的音频及振动资源移除注册。
   ...
   [haptic.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRendererSampleJS/entry/src/main/ets/pages/haptic.ets#L198-L214)
