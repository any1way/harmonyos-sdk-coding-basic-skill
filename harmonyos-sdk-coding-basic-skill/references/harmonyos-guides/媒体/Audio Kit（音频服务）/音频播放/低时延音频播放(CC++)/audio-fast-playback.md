...
content_hash: sha256:09c6f17512ed64e8a8cc6341b68515b5fc3ff47e5903575c8c96d23936eb194f
---
...
* 支持低时延模式的音频输出设备。
* 可通过[OH\_AudioRenderer\_GetFastStatus()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_getfaststatus>)验证当前设备是否支持低时延模式。
...
为使用低时延模式，开发者需要参考[推荐使用OHAudio开发音频播放功能(C/C++)](../推荐使用OHAudio开发音频播放功能(CC++)/using-ohaudio-for-playback.md)进行音频开发。
...
[renderer.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRendererSampleC/entry/src/main/cpp/renderer.cpp#L184-L187)
...
* 开发者通过调用[OH\_AudioRenderer\_GetFastStatus()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_getfaststatus>)来获取音频播放流是否正在低时延状态下工作。
* 在部分特殊场景（如：存在更高优先级流、当前连接设备不支持等）下，开发者可以通过调用[OH\_AudioRenderer\_OnFastStatusChange()](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiorenderer.h/capi-native-audiorenderer-h.md#oh_audiorenderer_onfaststatuschange>)来获取低时延状态改变事件。
...
播放的音频数据需要通过回调接口写入。开发者要实现回调接口，使用[OH\_AudioStreamBuilder\_SetRendererWriteDataCallback](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_setrendererwritedatacallback>)设置写入音频数据的回调函数，在设置音频回调函数时，回调函数[OH\_AudioRenderer\_OnWriteDataCallback](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiorenderer_onwritedatacallback>)（从API version 12开始支持）用于写入音频数据。

开发音频播放功能的示例代码请参考：[推荐使用OHAudio开发音频播放功能(C/C++)](../推荐使用OHAudio开发音频播放功能(CC++)/using-ohaudio-for-playback.md)。
...
[renderer.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRendererSampleC/entry/src/main/cpp/renderer.cpp#L56-L180)
