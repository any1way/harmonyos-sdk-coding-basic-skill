...
scraped_at: 2026-06-01T11:26:54+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:45896e508e31509446b3c0260f7c8d2bf5cc70fbd589c8fea45d37197293b127
---
本模块提供音频输入设备管理能力，包括查询输入设备信息、监听设备连接状态变化等。具体API说明可参考文档[AudioRoutingManager](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRoutingManager)/arkts-apis-audio-audioroutingmanager.md>)。
...
[FindAndListenAudioInputDevice.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRoutingManagerSampleJS/entry/src/main/ets/pages/FindAndListenAudioInputDevice.ets#L16-L24)
...
使用[getDevices](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRoutingManager)/arkts-apis-audio-audioroutingmanager.md#getdevices9>)方法可以获取当前所有输入设备的信息。
...
[FindAndListenAudioInputDevice.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRoutingManagerSampleJS/entry/src/main/ets/pages/FindAndListenAudioInputDevice.ets#L17-L93)
...
[FindAndListenAudioInputDevice.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRoutingManagerSampleJS/entry/src/main/ets/pages/FindAndListenAudioInputDevice.ets#L18-L60)
