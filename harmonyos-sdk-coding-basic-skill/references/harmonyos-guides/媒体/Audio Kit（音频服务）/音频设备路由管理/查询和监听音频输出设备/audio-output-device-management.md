...
scraped_at: 2026-06-01T11:26:55+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:878524268d1ca541b64920211915dd0a6086af5254c016a4947d01f2398ec2d8
---
...
本模块提供音频输出设备管理能力，包括查询设备信息和监听连接状态变化。具体API说明请参考文档[AudioRoutingManager](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRoutingManager)/arkts-apis-audio-audioroutingmanager.md>)。
...
[FindAndListenAudioOutputDevice.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRoutingManagerSampleJS/entry/src/main/ets/pages/FindAndListenAudioOutputDevice.ets#L16-L31)
...
使用[getDevices](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRoutingManager)/arkts-apis-audio-audioroutingmanager.md#getdevices9>)方法可以获取当前所有输出设备的信息。
...
[FindAndListenAudioOutputDevice.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRoutingManagerSampleJS/entry/src/main/ets/pages/FindAndListenAudioOutputDevice.ets#L17-L92)
...
监听设备连接状态变化可以监听到全部的设备连接状态变化，不建议作为应用处理自动暂停的依据。应用如需处理自动暂停相关业务，可参考[音频流输出设备变更原因](../响应输出设备变更时合理暂停/audio-output-device-change.md#音频流输出设备变更原因)。
...
[FindAndListenAudioOutputDevice.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRoutingManagerSampleJS/entry/src/main/ets/pages/FindAndListenAudioOutputDevice.ets#L18-L75)

### 获取最高优先级输出设备信息

使用[getPreferOutputDeviceForRendererInfo](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRoutingManager)/arkts-apis-audio-audioroutingmanager.md#getpreferoutputdeviceforrendererinfo10>)方法, 可以获取当前最高优先级的输出设备。
...
[FindAndListenAudioOutputDevice.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRoutingManagerSampleJS/entry/src/main/ets/pages/FindAndListenAudioOutputDevice.ets#L19-L156)
...
[FindAndListenAudioOutputDevice.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRoutingManagerSampleJS/entry/src/main/ets/pages/FindAndListenAudioOutputDevice.ets#L20-L123)

## 通过AudioSession查询和监听音频输出设备

应用使用播放器的SDK播放音频流，不持有[AudioRenderer](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)对象，因此无法灵活控制播放设备的选择和状态监听。从API version 20开始，AudioSession不仅增加了焦点管理功能，还提供了音频输出设备管理功能，包括设置默认输出设备和监听设备变化。请参考以下文档获取更多信息：

* ArkTS API：[AudioSessionManager](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioSessionManager)/arkts-apis-audio-audiosessionmanager.md>)
* C API：[native\_audio\_session\_manager.h](<../../../../../harmonyos-references/Audio Kit（音频服务）/C API/头文件/native_audio_session_manager.h/capi-native-audio-session-manager-h.md>)
...
[ListenDeviceByAudioSession.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRoutingManagerSampleJS/entry/src/main/ets/pages/ListenDeviceByAudioSession.ets#L20-L27)

### 设置本机默认音频输出设备

[setDefaultOutputDevice](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioSessionManager)/arkts-apis-audio-audiosessionmanager.md#setdefaultoutputdevice20>)可以用于设置本机默认输出设备。
...
[ListenDeviceByAudioSession.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRoutingManagerSampleJS/entry/src/main/ets/pages/ListenDeviceByAudioSession.ets#L16-L157)

### 查询本机默认音频输出设备

应用可以通过[getDefaultOutputDevice](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioSessionManager)/arkts-apis-audio-audiosessionmanager.md#getdefaultoutputdevice20>)查询本机默认输出设备类型。

说明

本接口用于查询通过[setDefaultOutputDevice](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interface (AudioSessionManager)/arkts-apis-audio-audiosessionmanager.md#setdefaultoutputdevice20>)接口设置的输出设备。
...
[ListenDeviceByAudioSession.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRoutingManagerSampleJS/entry/src/main/ets/pages/ListenDeviceByAudioSession.ets#L164-L167)

### 监听输出设备变化

应用可以通过注册[CurrentOutputDeviceChangedEvent](<../../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#currentoutputdevicechangedevent20>)监听输出设备的连接状态变化。
...
[ListenDeviceByAudioSession.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/AudioRoutingManagerSampleJS/entry/src/main/ets/pages/ListenDeviceByAudioSession.ets#L39-L86)
