...
scraped_at: 2026-06-01T11:27:00+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:3acf29d337b2dcd425ddf95b9c02f94fc7653870e5f2f48a36ba8d2f1616f3e9
---
...
在音频通话开始和结束时，应用可以自行检查当前的[音频场景模式](../音频通话开发概述/audio-call-overview.md#音频场景模式)和[铃声模式](../音频通话开发概述/audio-call-overview.md#铃声模式)，以便采取合适的音频管理及提示策略。
...
该过程与[使用AudioRenderer开发音频播放功能(ArkTs)](../../音频播放/使用AudioRenderer开发音频播放功能(ArkTs)/using-audiorenderer-for-playback.md)过程相似，关键区别在于audioRendererInfo参数和音频数据来源。audioRendererInfo参数中，音频流使用类型usage需设置为VoIP通话：STREAM\_USAGE\_VOICE\_COMMUNICATION。
...
[VoIpDemoForAudioRenderer.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/VoipCallSampleJS/entry/src/main/ets/pages/VoIpDemoForAudioRenderer.ets#L16-L263)

## 使用AudioCapturer录制本端的通话声音

该过程与[使用AudioCapturer开发音频录制功能(ArkTs)](../../音频录制/使用AudioCapturer开发音频录制功能(ArkTS)/using-audiocapturer-for-recording.md)过程相似，关键区别在于audioCapturerInfo参数和音频数据流向。audioCapturerInfo参数中音源类型source需设置为语音通话：SOURCE\_TYPE\_VOICE\_COMMUNICATION。

所有录制均需要申请麦克风权限：ohos.permission.MICROPHONE，申请方式请参考[向用户申请授权](../../../../系统/安全/程序访问控制/应用权限管控/申请应用权限/向用户申请授权/request-user-authorization.md)。
...
[VoIpDemoForAudioCapturer.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Audio/VoipCallSampleJS/entry/src/main/ets/pages/VoIpDemoForAudioCapturer.ets#L16-L232)
