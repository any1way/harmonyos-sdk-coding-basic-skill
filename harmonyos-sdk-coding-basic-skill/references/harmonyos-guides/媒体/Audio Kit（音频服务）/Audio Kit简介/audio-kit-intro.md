...
scraped_at: 2026-06-11T14:53:35+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:5f6db6f013ef8e4d8bf1af373734e7b0948c934c9cbcaa6ec7efde3e13cd9c74
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e/v3/TOIUfUePQh2nkg9EdAj2jw/zh-cn_image_0000002592218956.png?HW-CC-KV=V1&HW-CC-Date=20260611T065335Z&HW-CC-Expire=86400&HW-CC-Sign=B51D3BEE801148F8F83ABCA51BA1B34AD3C473C81F4D264DF6FC5DEDB0242A66)
...
音频流基础信息通过[AudioStreamInfo](<../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#audiostreaminfo8>)表示，包含采样、声道、位宽、编码信息，是创建音频播放或录制流的必要参数，描述了音频数据的基本属性。在配置时开发者需要保证基础信息与传输的音频数据相匹配，音频系统才能正确处理数据。
...
* 播放场景
  ...
  音频播放场景的信息，通过[StreamUsage](<../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#streamusage>)进行描述。

  StreamUsage指音频流本身的用途类型，包括媒体、语音通信、语音播报、通知、铃声等。
* 录制场景

  音频流录制场景的信息，通过[SourceType](<../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#sourcetype8>)进行描述。

  SourceType指音频流中录音源的类型，包括麦克风音频源、语音识别音频源、语音通话音频源等。

可参考[使用合适的音频流类型](../使用合适的音频流类型/using-right-streamusage-and-sourcetype.md)进行设置。
...
* 支持的音频采样率（Hz）：8000、11025、12000、16000、22050、24000、32000、44100、48000、64000、8820012+、96000，17640012+、19200012+具体参考枚举[AudioSamplingRate](<../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#audiosamplingrate8>)。

  不同设备支持的采样率规格会存在差异。
* 支持单声道、双声道，具体参考[AudioChannel](<../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#audiochannel8>)。
* 支持的采样格式：U8（无符号8位整数）、S16LE（带符号的16位整数，小尾数）、S24LE（带符号的24位整数，小尾数）、S32LE（带符号的32位整数，小尾数）、F32LE（带符号的32位浮点数，小尾数），具体参考[AudioSampleFormat](<../../../../harmonyos-references/Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#audiosampleformat8>)。
