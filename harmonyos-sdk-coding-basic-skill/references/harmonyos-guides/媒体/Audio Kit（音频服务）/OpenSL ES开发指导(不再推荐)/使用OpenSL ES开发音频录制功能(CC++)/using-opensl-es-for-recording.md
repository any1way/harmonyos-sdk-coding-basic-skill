...
scraped_at: 2026-06-01T11:27:15+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:7002a806407530bf54d7bf9ffdf9b5ad155fa6aba41e2b889357cb6f5d728a81
---
...
OHAudio的开发指南请参考：[推荐使用OHAudio开发音频录制功能(C/C++)](../../音频录制/推荐使用OHAudio开发音频录制功能(CC++)/using-ohaudio-for-recording.md)。

考虑到一些接入HarmonyOS较早的应用开发者，这里提供了一份OpenSL ES接口切换到OHAudio的对照参考：[从OpenSL ES切换到OHAudio(C/C++)](<../从OpenSL ES切换到OHAudio(CC++)/replace-opensles-by-ohaudio.md>)，便于开发者能够更快的在新版本切换到使用新接口。
