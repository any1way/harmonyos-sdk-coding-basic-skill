...
scraped_at: 2026-06-11T14:56:40+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:4dae0f0e14aa1f545174fc4fbbc402ecc7d142f6bd8a0bcda4bddf8efe16c842
---
...
2. 导入BusinessError模块抛出Drm Kit接口的错误码。
   ...
   ```
3. 调用[createAVPlayer](<../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Functions/arkts-apis-media-f.md#mediacreateavplayer9>)，创建AVPlayer实例并设置DRM信息监听事件。
   ...
   9. }
   ```
4. 调用[createMediaKeySystem](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Functions/arkts-apis-drm-f.md#drmcreatemediakeysystem>)和[createMediaKeySession](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySystem)/arkts-apis-drm-mediakeysystem.md#createmediakeysession>)根据DRM信息中的uuid创建MediaKeySystem和MediaKeySession实例。
   ...
   20. }
   ```
5. 调用[generateMediaKeyRequest](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md#generatemediakeyrequest>)生成媒体密钥请求，并调用[processMediaKeyResponse](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md#processmediakeyresponse>)处理媒体密钥响应。
   ...
   17. });
   ```
6. 调用[requireSecureDecoderModule](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md#requiresecuredecodermodule>)和[setDecryptionConfig](<../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md#setdecryptionconfig11>)，在处理媒体密钥响应成功后设置解密session。
