...
scraped_at: 2026-06-01T11:29:32+08:00
doc_updated_at: 2026-04-10
content_hash: sha256:6f8b8dc8061df2edc8bda7d69da69f7984e4eb763235e77bf6c9a41b7641c6d7
---
...
详细的API说明请参考[@ohos.multimedia.drm(数字版权保护)](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/模块描述/arkts-apis-drm.md>)。
...
2. 导入BusinessError模块抛出Drm Kit接口的错误码。
   ...
   ```
3. （可选）调用[getMediaKeySystems](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Functions/arkts-apis-drm-f.md#drmgetmediakeysystems12>)，获取设备支持的DRM解决方案名称和唯一标识的列表。
...
4. （可选）调用[isMediaKeySystemSupported](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Functions/arkts-apis-drm-f.md#drmismediakeysystemsupported>)，查询设备是否支持对应DRM解决方案名称、媒体类型、安全保护级别的DRM解决方案。
...
5. 调用[createMediaKeySystem](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Functions/arkts-apis-drm-f.md#drmcreatemediakeysystem>)，创建MediaKeySystem实例。
...
6. （可选）调用[on('keySystemRequired')](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySystem)/arkts-apis-drm-mediakeysystem.md#onkeysystemrequired>)，设置MediaKeySystem状态监听事件。
   ...
   4. });
   ```
7. （可选）调用[getCertificateStatus](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySystem)/arkts-apis-drm-mediakeysystem.md#getcertificatestatus>)，获取设备DRM证书状态。

   ```
   1. let certificateStatus: drm.CertificateStatus = mediaKeySystem.getCertificateStatus();
   ```
8. （可选）调用[generateKeySystemRequest](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySystem)/arkts-apis-drm-mediakeysystem.md#generatekeysystemrequest>)和[processKeySystemResponse](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySystem)/arkts-apis-drm-mediakeysystem.md#processkeysystemresponse>)，生成设备DRM证书请求与处理设备DRM证书响应。
   ...
   16. });
   ```
9. 调用[createMediaKeySession](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySystem)/arkts-apis-drm-mediakeysystem.md#createmediakeysession>)，创建MediaKeySession实例。
...
10. （可选）设置MediaKeySession状态监听事件。
    ...
    * 使用[on('keyRequired')](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md#onkeyrequired>)接口监听媒体密钥请求事件，此时建议完成媒体密钥请求与处理流程。
      ...
      4. });
      ```
    * 使用[on('keyExpired')](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md#onkeyexpired>)接口监听媒体密钥过期事件。
      ...
      3. });
      ```
    * 使用[on('expirationUpdate')](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md#onexpirationupdate>)接口监听媒体密钥有效期更新事件。
      ...
      3. });
      ```
    * 使用[on('keysChange')](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md#onkeyschange>)接口监听媒体密钥变换事件。
      ...
      5. });
      ```
11. （可选）调用[requireSecureDecoderModule](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md#requiresecuredecodermodule>)，查询是否需要安全解码。
    ...
    6. }
    ```
12. 调用[generateMediaKeyRequest](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md#generatemediakeyrequest>)和[processMediaKeyResponse](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md#processmediakeyresponse>)，生成媒体密钥请求与处理媒体密钥响应。
    ...
    35. });
    ```
13. （可选）调用[restoreOfflineMediaKey](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md#restoreofflinemediakeys>)，恢复离线媒体密钥。
    ...
    5. });
    ```
14. （可选）调用[checkMediaKeyStatus](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md#checkmediakeystatus>)，检查媒体密钥状态。
    ...
    7. }
    ```
15. （可选）调用[getOfflineMediaKeyIds](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySystem)/arkts-apis-drm-mediakeysystem.md#getofflinemediakeyids>)获取离线媒体密钥标识列表，调用[getOfflineMediaKeyStatus](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySystem)/arkts-apis-drm-mediakeysystem.md#getofflinemediakeystatus>)获取离线媒体密钥状态，调用[clearOfflineMediaKeys](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySystem)/arkts-apis-drm-mediakeysystem.md#clearofflinemediakeys>)删除离线媒体密钥。
