...
scraped_at: 2026-06-01T11:29:36+08:00
doc_updated_at: 2026-04-10
content_hash: sha256:2dc57c4667b4500bc07248f222801c46530ce33cf69c95db365ca99d1e0cc8bc
---
## 功能介绍
...
在创建DRM之前，需获取到DRM信息(参考[媒体数据解析](<../../AVCodec Kit（音视频编解码服务）/媒体数据封装与解析/媒体数据解析/audio-video-demuxer.md#开发步骤>)开发步骤第4步)。

## 开发指导

详细的API说明请参考[Drm](<../../../../harmonyos-references/DRM Kit（数字版权保护服务）/C API/模块/Drm/capi-drm.md>)。
...
2. 获取设备支持的DRM解决方案名称和唯一标识的列表。
   ...
   获取到设备支持的DRM解决方案的名称和唯一标识的列表后，与DRM信息做匹配，创建对应的DRM解决方案。DRM信息可通过[媒体数据解析](<../../AVCodec Kit（音视频编解码服务）/媒体数据封装与解析/媒体数据解析/audio-video-demuxer.md#开发步骤>)开发步骤第4步获取，
...
6. 生成媒体密钥请求与处理媒体密钥响应。
   ...
   根据需要设置音频解密配置(详见[音频解码开发指南开发步骤](<../../AVCodec Kit（音视频编解码服务）/音视频编解码/音频解码/audio-decoding.md#开发步骤>)第4步)、设置视频解密配置(详见[视频解码开发指南开发步骤Surface模式](<../../AVCodec Kit（音视频编解码服务）/音视频编解码/视频解码/video-decoding.md#surface模式>)第4步或[Buffer模式](<../../AVCodec Kit（音视频编解码服务）/音视频编解码/视频解码/video-decoding.md#buffer模式>)第4步)，实现DRM内容解密。
