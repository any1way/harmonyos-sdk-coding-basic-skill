...
scraped_at: 2026-06-11T14:55:52+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:111abdb450df3827e7435404b268d532b3e60e30250417c6bbfdb9d50aec35e4
---
在使用相机过程中，当遇到相机模式切换、前后置镜头切换等场景时，会不可避免地出现预览流替换。为优化用户体验，可合理使用动效过渡。本文主要介绍如何使用预览流截图，并通过ArkUI提供的[animateToImmediately](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#animatetoimmediately23>)接口触发显式动画功能，实现下方三种核心场景动效。

* 模式切换动效，使用预览流截图做模糊动效过渡。

  图片为从录像模式切换为拍照模式的效果。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/6gW-D_OlTIalKY6JZjNcAg/zh-cn_image_0000002622858439.gif?HW-CC-KV=V1&HW-CC-Date=20260611T065550Z&HW-CC-Expire=86400&HW-CC-Sign=EFB9EC25B49D8C27FA40BBDC280B3D673845E05CC9612B5226AD59746A0CFD5A)
* 前后置切换动效，使用预览流截图做翻转模糊动效过渡。

  图片为从前置相机切换为后置相机的效果。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/l0XSgeZTQpaa6HNLQi1huw/zh-cn_image_0000002622698561.gif?HW-CC-KV=V1&HW-CC-Date=20260611T065550Z&HW-CC-Expire=86400&HW-CC-Sign=B14E4894B0C6C30CA90C082FA3F45A60D03D0129A06FF8E4647C79EE98A8B569)
* 拍照闪黑动效，使用闪黑组件覆盖预览流实现闪黑动效过渡。

  图片为点击完成拍摄的效果。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/uLfG0ulVTmawJh67H9jyCw/zh-cn_image_0000002592219000.gif?HW-CC-KV=V1&HW-CC-Date=20260611T065550Z&HW-CC-Expire=86400&HW-CC-Sign=0CB3415130903A67C53D9E9B1F5076C9B23788F8B1B246549161CF710BEC0C94)
...
1. 导入依赖，需要导入相机框架、图片、ArkUI相关领域依赖。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/pages/Index.ets#L16-L20)
2. 构建闪黑组件。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/pages/Index.ets#L51-L65)
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/pages/Index.ets#L373-L383)
3. 实现闪黑动效。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/pages/Index.ets#L296-L313)
4. 触发闪黑动效。

   点击或触控拍照按钮，更新[@StorageLink](<../../../../应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/AppStorage：应用全局的UI状态存储/arkts-appstorage.md#storagelink>)绑定CaptureClick的值，触发onCaptureClick方法，动效开始播放。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/pages/Index.ets#L337-L342)
...
2. 获取预览流截图。
   ...
   预览流截图通过图形提供的[image.createPixelMapFromSurface](<../../../../../harmonyos-references/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Functions/arkts-apis-image-f.md#imagecreatepixelmapfromsurface11>)接口实现，surfaceId为当前预览流的surfaceId，size为当前预览流profile的宽高。创建截图工具类（ts文件），导入依赖，导出获取截图方法供页面使用，截图工具类实现参考：
   ...
   [BlurAnimateUtil.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/common/utils/BlurAnimateUtil.ts#L22-L73)
3. 构建截图组件。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/pages/Index.ets#L385-L400)
4. （按实际情况选择）实现模糊出现动效。
   ...
   由于图形提供的[image.createPixelMapFromSurface](<../../../../../harmonyos-references/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Functions/arkts-apis-image-f.md#imagecreatepixelmapfromsurface11>)接口是通过截取surface内容获取[PixelMap](<../../../../../harmonyos-references/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)，其内容和[XComponent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)组件绘制逻辑不同，需要根据**前后置**镜头做不同的**图片内容旋转补偿**和**组件旋转补偿**。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/pages/Index.ets#L93-L132)
5. 实现模糊消失动效。

   模糊消失动效：由新模式预览流首帧回调[on('frameStart')](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (PreviewOutput)/arkts-apis-camera-previewoutput.md#onframestart>)触发，截图组件模糊到清晰，显示新预览流。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/pages/Index.ets#L137-L156)
6. （按实际情况选择）实现模糊翻转动效。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/pages/Index.ets#L158-L291)
7. 按需触发动效。

   模式切换动效触发：点击或触控模式按钮立即执行doSurfaceShot截图方法，更新[@StorageLink](<../../../../应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/AppStorage：应用全局的UI状态存储/arkts-appstorage.md#storagelink>)绑定modeChange的值，触发onModeChange方法，开始动效。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/pages/Index.ets#L315-L320)

   前后置切换动效触发：点击或触控前后置切换按钮立即执行doSurfaceShot截图方法，更新[@StorageLink](<../../../../应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/AppStorage：应用全局的UI状态存储/arkts-appstorage.md#storagelink>)绑定switchCamera的值，触发onSwitchCamera方法，开始动效。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/pages/Index.ets#L322-L328)

   模糊消失动效触发：监听预览流首帧回调[on('frameStart')](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (PreviewOutput)/arkts-apis-camera-previewoutput.md#onframestart>)，更新[@StorageLink](<../../../../应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/AppStorage：应用全局的UI状态存储/arkts-appstorage.md#storagelink>)绑定frameStart的值，触发onFrameStart方法，开始动效。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/cameraAnimSample/entry/src/main/ets/pages/Index.ets#L330-L335)
