...
scraped_at: 2026-06-11T14:56:08+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:ecc1fc59f27a9ad83af75ef11434fdf8cc49379d35d3868bdbb473b2d6f1c28d
---
相机预配置（Preconfig），对常用的场景和分辨率进行了预配置集成，可简化开发相机应用流程，提高应用的开发效率。

开发者在开发相机应用时，在获取到[CameraDevice](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interfaces (其他)/arkts-apis-camera-i.md#cameradevice>)之后，如果遵循通用流程开发，步骤较为繁琐。需要先调用[CameraManager](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (CameraManager)/arkts-apis-camera-cameramanager.md>)的[getSupportedOutputCapability](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (CameraManager)/arkts-apis-camera-cameramanager.md#getsupportedoutputcapability11>)来查询当前相机在指定模式下所支持的各类输出的配置信息，拿到[CameraOutputCapability](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interfaces (其他)/arkts-apis-camera-i.md#cameraoutputcapability>)之后，应用开发者还需要对里面的各类数据进行解析，筛选，找到自己需要的配置数据[Profile](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interfaces (其他)/arkts-apis-camera-i.md#profile>)以及[VideoProfile](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interfaces (其他)/arkts-apis-camera-i.md#videoprofile>)。最后使用对应的Profile以及VideoProfile创建对应的[PreviewOutput](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (PreviewOutput)/arkts-apis-camera-previewoutput.md>)、[PhotoOutput](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (PhotoOutput)/arkts-apis-camera-photooutput.md>)以及[VideoOutput](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (VideoOutput)/arkts-apis-camera-videooutput.md>)。

为了解决上述问题，优化应用开发流程，系统针对拍照（[PhotoSession](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (PhotoSession)/arkts-apis-camera-photosession.md>)）、录像（[VideoSession](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (VideoSession)/arkts-apis-camera-videosession.md>)）两类场景，提供了[preconfig](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (PhotoSession)/arkts-apis-camera-photosession.md#preconfig12>)接口帮助开发者快速完成相机参数配置。推荐仅需要自定义拍照界面的无需开发专业相机应用的开发者，使用相机预配置功能快速开发应用。

在开发相机应用时，需要先[申请相关权限](../../申请相机开发的权限/camera-preparation.md)。以拍照（PhotoSession）为例，相机预配置（Preconfig）开发流程与[通用流程](../拍照实践(ArkTS)/camera-shooting-case.md)开发，存在以下差异：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/71/v3/WFiwfgkHRju4IHfymbRzGw/zh-cn_image_0000002622698575.png?HW-CC-KV=V1&HW-CC-Date=20260611T065606Z&HW-CC-Expire=86400&HW-CC-Sign=9DA2F7E85F4A28B95D1478AF6829E6D9EE653B25210A8852F872073BD39A79A0)

**其他相关能力：**

* [CameraPicker](../通过系统相机拍照和录像(CameraPicker)/camera-picker.md)：无需开发相机功能，拉起系统相机获取照片或视频。
* [调用全量相机接口开发](<../../Camera Kit简介/camera-overview.md>)：可开发自定义界面、分辨率、图像效果的专业相机应用。

## 规格说明

系统提供了4种预配置类型（[PreconfigType](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Enums/arkts-apis-camera-e.md#preconfigtype12>)），分别为PRECONFIG\_720P、PRECONFIG\_1080P、PRECONFIG\_4K、PRECONFIG\_HIGH\_QUALITY。以及3种画幅比例规格（[PreconfigRatio](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Enums/arkts-apis-camera-e.md#preconfigratio12>)），1:1画幅（PRECONFIG\_RATIO\_1\_1）、4:3画幅（PRECONFIG\_RATIO\_4\_3）、16:9画幅（PRECONFIG\_RATIO\_16\_9）。

注意

由于不同的设备所支持的能力不同。使用相机预配置（Preconfig）功能时，需要先调用[canPreconfig](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (PhotoSession)/arkts-apis-camera-photosession.md#canpreconfig12>)检查对应的PreconfigType和PreconfigRatio的组合在当前设备上是否支持。
...
详细的API说明请参考[Camera API参考](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/js-apis-camera.md>)。
...
2. 创建输出流Output。
   ...
   创建预览输出流时，涉及参数surfaceId。XComponent组件为预览流提供Surface（获取surfaceId请参考[getXcomponentSurfaceId](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md#getxcomponentsurfaceid9)方法），而XComponent的能力由UI提供，相关介绍可参考[XComponent组件参考](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)。

   创建cameraManager对象的方法可参考[getCameraManager](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Functions/arkts-apis-camera-f.md#cameragetcameramanager>)。
   ...
   26. }
   ```
3. 调用[CameraManager](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (CameraManager)/arkts-apis-camera-cameramanager.md>)中的[createCameraInput](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (CameraManager)/arkts-apis-camera-cameramanager.md#createcamerainput>)方法，创建输入流Input。
   ...
   20. }
   ```
4. 调用[createSession](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (CameraManager)/arkts-apis-camera-cameramanager.md#createsession11>)创建会话（Session）。

   说明

   SceneMode需要指定为NORMAL\_PHOTO或NORMAL\_VIDEO，对应拍照场景[PhotoSession](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (PhotoSession)/arkts-apis-camera-photosession.md>)和录像场景[VideoSession](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (VideoSession)/arkts-apis-camera-videosession.md>)。
   ...
   13. }
   ```
5. 调用[canPreconfig](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (PhotoSession)/arkts-apis-camera-photosession.md#canpreconfig12>)检查对应的PreconfigType和PreconfigRatio的组合在当前设备上是否支持。确认支持后，调用[preconfig](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (PhotoSession)/arkts-apis-camera-photosession.md#preconfig12>)启用Preconfig配置。
   ...
   若当前模式为普通录像模式，且[PreconfigType](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Enums/arkts-apis-camera-e.md#preconfigtype12>)使用PRECONFIG\_HIGH\_QUALITY类型时，为避免录制失败，请务必将[AVRecorderProfile](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interfaces (其他)/arkts-apis-media-i.md#avrecorderprofile9>)配置文件中videoCodec参数必须配置为[VIDEO\_HEVC](<../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Enums/arkts-apis-media-e.md#codecmimetype8>)，isHdr参数配置为true。
