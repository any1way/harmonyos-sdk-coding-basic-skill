...
scraped_at: 2026-06-01T11:29:05+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:3d96c3e24b33190df8b0ca8f5428dba82c7eecc06cbe589176caffa16350da68
---
HarmonyOS支持调用接口，录制HDR Vivid视频，可以拍出层次表现更细腻、光影细节更丰富的画面，提升画面质感，呈现更卓越的视觉效果。

当前示例提供完整的HDR Vivid录像开发步骤，方便开发者实现录制HDR Vivid视频的功能。更多HDR Vivid的开发指导，请参考[使用HDR Vivid特性开发媒体应用](<../../../使用HDR Vivid特性开发媒体应用/multimedia-hdr-vivid.md>)。

在参考以下示例前，建议开发者查看[相机开发指导(ArkTS)](../../开发相机应用必选能力(ArkTS)/相机管理(ArkTS)/camera-device-management.md)的具体章节，了解[设备输入](../../开发相机应用必选能力(ArkTS)/设备输入(ArkTS)/camera-device-input.md)、[会话管理](../../开发相机应用必选能力(ArkTS)/会话管理(ArkTS)/camera-session-management.md)、[录像](../录像(ArkTS)/camera-recording.md)等单个流程。
...
2. 获取预览、录像的配置项。
   ...
   HDR录像的输出格式需要设置成10bit的CAMERA\_FORMAT\_YCRCB\_P010。具体参考[setColorSpace](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (ColorManagement)/arkts-apis-camera-colormanagement.md#setcolorspace12>)。
...
6. 设置色彩空间。
   ...
   如果是SDR录像色彩空间需要设置为BT709\_LIMIT，如果是HDR录像色彩空间需要设置为BT2020\_HLG\_LIMIT。具体参考[setColorSpace](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (ColorManagement)/arkts-apis-camera-colormanagement.md#setcolorspace12>)。建议在提交会话配置之前调用[setColorSpace](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (ColorManagement)/arkts-apis-camera-colormanagement.md#setcolorspace12>)。
...
7. 实现HDR录像。
   ...
   如需在提交会话配置后，设置视频防抖模式和色彩空间，为避免相机输出流配置异常，请先通过[setVideoStabilizationMode](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (Stabilization)/arkts-apis-camera-stabilization.md#setvideostabilizationmode11>)方法4. 设置视频防抖后，再通过[setColorSpace](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (ColorManagement)/arkts-apis-camera-colormanagement.md#setcolorspace12>)方法完成6.设置色彩空间。
