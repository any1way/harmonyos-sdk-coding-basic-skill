...
scraped_at: 2026-06-01T11:28:33+08:00
doc_updated_at: 2026-05-28
content_hash: sha256:ee6092edf855311209a23f4c73822dde890624b81bf1d2ef59b0738da603a85d
---
...
详细的API说明请参考[@ohos.multimedia.cameraPicker (相机选择器)](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.cameraPicker (相机选择器)/js-apis-camerapicker.md>)。
...
1. 导入相关接口，导入方法如下。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/CameraPicker/entry/src/main/ets/pages/Index.ets#L17-L20)
2. 配置[PickerProfile](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.cameraPicker (相机选择器)/js-apis-camerapicker.md#pickerprofile>)。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/CameraPicker/entry/src/main/ets/pages/Index.ets#L27-L45)

   fileIo接口调用方法请参考：[createRandomAccessFileSync](<../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileiocreaterandomaccessfilesync10>)和[getUriFromPath](<../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fileuri (文件URI)/js-apis-file-fileuri.md#fileurigeturifrompath>)。
3. 调用picker拍摄接口获取拍摄的结果。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/CameraPicker/entry/src/main/ets/pages/Index.ets#L47-L55)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/CameraPicker/entry/src/main/ets/pages/Index.ets#L16-L96)
