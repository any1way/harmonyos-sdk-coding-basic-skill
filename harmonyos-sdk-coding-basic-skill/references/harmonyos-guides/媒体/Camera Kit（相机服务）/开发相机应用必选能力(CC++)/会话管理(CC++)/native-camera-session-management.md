...
scraped_at: 2026-06-01T11:29:09+08:00
doc_updated_at: 2026-03-23
content_hash: sha256:da1eed122527845b5fc13086d72e45db23a0531c05800d61d7e89ebf65bb7fac
---
...
* 添加闪光灯、调整焦距等配置。具体支持的配置及接口说明请参考[OH\_Camera](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/模块/OH_Camera/capi-oh-camera.md>)。
...
2. 在CMake脚本中链接相关动态库。
   ...
   5. )
   ```
3. 调用[OH\_CameraManager\_CreateCaptureSession()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/camera_manager.h/capi-camera-manager-h.md#oh_cameramanager_createcapturesession>)方法创建一个会话。
   ...
   13. }
   ```
4. 调用[OH\_CaptureSession\_SetSessionMode()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_setsessionmode>)方法配置会话模式。
   ...
   8. }
   ```
5. 调用[OH\_CaptureSession\_BeginConfig()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_beginconfig>)方法配置会话。
   ...
   8. }
   ```
6. 使能。向会话中添加相机的输入流和输出流，调用[OH\_CaptureSession\_AddInput()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_addinput>)添加相机的输入流；调用[OH\_CaptureSession\_AddPreviewOutput()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_addpreviewoutput>)和[OH\_CaptureSession\_AddPhotoOutput()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_addphotooutput>)添加相机的输出流。以下示例代码以添加预览流previewOutput和拍照流photoOutput为例，即当前模式支持拍照和预览。

   调用[OH\_CaptureSession\_CommitConfig()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_commitconfig>)和[OH\_CaptureSession\_Start()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_start>)方法提交相关配置，并启动会话。
   ...
   38. }
   ```
7. 会话控制。调用[OH\_CaptureSession\_Stop()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_stop>)方法可以停止当前会话。调用[OH\_CaptureSession\_RemovePhotoOutput()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_removephotooutput>)和[OH\_CaptureSession\_AddVideoOutput()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_addvideooutput>)方法可以完成会话切换控制。以下示例代码以移除拍照流photoOutput，添加视频流videoOutput为例，完成了拍照到录像的切换。
