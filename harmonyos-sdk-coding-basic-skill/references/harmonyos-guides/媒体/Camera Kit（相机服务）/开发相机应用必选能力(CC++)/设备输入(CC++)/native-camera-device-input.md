...
scraped_at: 2026-06-01T11:29:07+08:00
doc_updated_at: 2026-03-23
content_hash: sha256:97608e402c68859e1098e235d6497fb86474e4d2c75ea0592442480c94e49830
---
...
2. 在CMake脚本中链接相关动态库。
   ...
   5. )
   ```
3. 通过[OH\_CameraManager\_CreateCameraInput()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/camera_manager.h/capi-camera-manager-h.md#oh_cameramanager_createcamerainput>)方法，获取cameraInput对象。
   ...
   在相机设备输入之前需要先完成相机管理，详细开发步骤请参考[相机管理](<../相机管理 (CC++)/native-camera-device-management.md>)。
4. 通过[OH\_CameraManager\_GetSupportedSceneModes()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/camera_manager.h/capi-camera-manager-h.md#oh_cameramanager_getsupportedscenemodes>)方法，获取当前相机设备支持的模式列表，列表中存储了相机设备支持的所有模式[Camera\_SceneMode](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/camera.h/capi-camera-h.md#camera_scenemode>)。
   ...
   17. }
   ```
5. 通过[OH\_CameraManager\_GetSupportedCameraOutputCapabilityWithSceneMode()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/camera_manager.h/capi-camera-manager-h.md#oh_cameramanager_getsupportedcameraoutputcapabilitywithscenemode>)方法，获取当前设备在当前模式下支持的所有输出流，如预览流、拍照流等。输出流在[Camera\_OutputCapability](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/结构体/Camera_OutputCapability/capi-oh-camera-camera-outputcapability.md>)中的各个profile字段中。根据相机设备指定模式[Camera\_SceneMode](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/camera.h/capi-camera-h.md#camera_scenemode>)的不同，需要向Session中添加对应类型的输出流，请参考会话管理[开发步骤](../会话管理(CC++)/native-camera-session-management.md#开发步骤)中的第6步。
