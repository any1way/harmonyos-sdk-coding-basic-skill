...
scraped_at: 2026-06-01T11:28:30+08:00
doc_updated_at: 2026-03-27
content_hash: sha256:23e3fee60c1a90390fa217f07a931f41d348f5ddb77859ea6ad24c30bf7ffa2b
---
...
1. 导入camera接口，接口中提供了相机相关的属性和方法，导入方法如下。
   ...
   ```
2. 通过[getCameraManager](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Functions/arkts-apis-camera-f.md#cameragetcameramanager>)方法，获取cameraManager对象。
...
通过注册cameraStatus事件，通过回调返回监听结果，callback返回CameraStatusInfo参数，参数的具体内容可参考相机管理器回调接口实例[CameraStatusInfo](<../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interfaces (其他)/arkts-apis-camera-i.md#camerastatusinfo>)。
