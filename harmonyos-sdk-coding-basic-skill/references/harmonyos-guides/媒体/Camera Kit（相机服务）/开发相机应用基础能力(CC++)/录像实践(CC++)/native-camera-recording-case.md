...
scraped_at: 2026-06-11T14:56:23+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:7427cad839d638b3731891f99df27ec662c132c6c6d0b98aebe98c5a6ea9f53f
---
在开发相机应用时，需要先[申请相关权限](../../申请相机开发的权限/camera-preparation.md)。

当前示例提供完整的录像流程及其接口调用顺序的介绍。对于单个流程（如[设备输入](../../开发相机应用必选能力(CC++)/设备输入(CC++)/native-camera-device-input.md)、[会话管理](../../开发相机应用必选能力(CC++)/会话管理(CC++)/native-camera-session-management.md)、[录像](../录像(CC++)/native-camera-recording.md)）的介绍请参考具体章节。

## 开发流程

在获取到相机支持的输出流能力后，开始创建录像流，开发流程如下。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/A7Zvz1OWQF6c53ewpDeGRw/zh-cn_image_0000002592378948.png?HW-CC-KV=V1&HW-CC-Date=20260611T065622Z&HW-CC-Expire=86400&HW-CC-Sign=B00BF7EA38A71B284DBE274227BED1A06CB097F05AF2E062EC302E3A767F23F8)
