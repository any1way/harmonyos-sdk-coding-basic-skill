...
scraped_at: 2026-06-11T14:56:20+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:43fa96cd4e910f34af4491fa5482125cb56fbf0830ba04e728f2a528bd51e1f4
---
在开发相机应用时，需要先[申请相关权限](../../申请相机开发的权限/camera-preparation.md)。

当前示例提供完整的拍照流程及其接口调用顺序的介绍。对于单个流程（如设备输入、会话管理、拍照）的介绍请参考[相机开发指导(Native)](<../../开发相机应用必选能力(CC++)/相机管理 (CC++)/native-camera-device-management.md>)的具体章节。

## 开发流程

在获取到相机支持的输出流能力后，开始创建拍照流，开发流程如下。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/G3Hm55NdQLWphfvEqOV63g/zh-cn_image_0000002592219014.png?HW-CC-KV=V1&HW-CC-Date=20260611T065618Z&HW-CC-Expire=86400&HW-CC-Sign=8B0B49D715EDB50D731F3E69A8DC24E65D05B9D4A77828493B1040F57A0248A7)
