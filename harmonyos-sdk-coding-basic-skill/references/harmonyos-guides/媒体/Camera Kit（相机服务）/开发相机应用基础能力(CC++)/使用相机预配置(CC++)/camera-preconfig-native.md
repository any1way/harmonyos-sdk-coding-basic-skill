...
scraped_at: 2026-06-01T11:29:29+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:080216a74790a231e639414147df4a03e5f2aa86e3837af0cb7d5db8876592fb
---
相机预配置（Preconfig），对常用的场景和分辨率进行了预配置集成，可简化开发相机应用流程，提高应用的开发效率。

开发者在开发相机应用时，在获取到CameraDevice之后，如果遵循通用流程开发，步骤较为繁琐。需要先查询当前相机在指定模式下所支持的各类输出的配置信息，拿到[Camera\_OutputCapability](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/结构体/Camera_OutputCapability/capi-oh-camera-camera-outputcapability.md>)之后，应用开发者还需要对里面的各类数据进行解析，筛选，找到自己需要的配置数据[Camera\_Profile](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/结构体/Camera_Profile/capi-oh-camera-camera-profile.md>)和[Camera\_VideoProfile](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/结构体/Camera_VideoProfile/capi-oh-camera-camera-videoprofile.md>)。最后使用对应的Profile以及VideoProfile创建对应的[Camera\_PreviewOutput](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/结构体/Camera_PreviewOutput/capi-oh-camera-camera-previewoutput.md>)、[Camera\_PhotoOutput](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md>)以及[Camera\_VideoOutput](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/结构体/Camera_VideoOutput/capi-oh-camera-camera-videooutput.md>)。

为了解决上述问题，优化应用开发流程，系统针对拍照、录像两类场景（即[Camera\_SceneMode](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/camera.h/capi-camera-h.md#camera_scenemode>)为NORMAL\_PHOTO或NORMAL\_VIDEO），提供了[OH\_CameraManager\_CreatePreviewOutputUsedInPreconfig](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/camera_manager.h/capi-camera-manager-h.md#oh_cameramanager_createpreviewoutputusedinpreconfig>)、[OH\_CameraManager\_CreatePhotoOutputUsedInPreconfig](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/camera_manager.h/capi-camera-manager-h.md#oh_cameramanager_createphotooutputusedinpreconfig>)、[OH\_CameraManager\_CreateVideoOutputUsedInPreconfig](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/camera_manager.h/capi-camera-manager-h.md#oh_cameramanager_createvideooutputusedinpreconfig>)接口帮助开发者快速完成相机参数配置。推荐仅需要自定义拍照界面的无需开发专业相机应用的开发者，使用相机预配置功能快速开发应用。

## 规格说明

系统提供了4种预配置类型（[Camera\_PreconfigType](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/camera.h/capi-camera-h.md#camera_preconfigtype>)），分别为PRECONFIG\_720P、PRECONFIG\_1080P、PRECONFIG\_4K、PRECONFIG\_HIGH\_QUALITY。以及3种画幅比例规格（[Camera\_PreconfigRatio](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/camera.h/capi-camera-h.md#camera_preconfigratio>)），1:1画幅（PRECONFIG\_RATIO\_1\_1）、4:3画幅（PRECONFIG\_RATIO\_4\_3）、16:9画幅（PRECONFIG\_RATIO\_16\_9）。

注意

由于不同的设备所支持的能力不同。使用相机预配置（preconfig）功能时，需要先调用[OH\_CaptureSession\_CanPreconfig](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_canpreconfig>)或[OH\_CaptureSession\_CanPreconfigWithRatio](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_canpreconfigwithratio>)检查对应的PreconfigType和PreconfigRatio的组合在当前设备上是否支持。
