...
scraped_at: 2026-06-01T11:29:22+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:6a04bb54b9ef73d0ddaa5a79bb83adcd42a44084c268be0cf41ae592c6801b66
---
...
2. 在CMake脚本中链接相关动态库。
   ...
   5. )
   ```
3. 通过[OH\_CaptureSession\_IsMacroSupported()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_ismacrosupported>)方法，检测当前设备是否支持微距能力。
   ...
   [camera\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/NDKPhotoVideoSample/entry/src/main/cpp/camera_manager.cpp#L870-L890)
4. 使用[OH\_CaptureSession\_EnableMacro()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_enablemacro>)方法开启或关闭微距能力。
   ...
   [camera\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/NDKPhotoVideoSample/entry/src/main/cpp/camera_manager.cpp#L892-L903)

## 状态监听

从API version 20开始，支持监听微距能力是否发生改变。

通过[OH\_CaptureSession\_RegisterMacroStatusChangeCallback()](<../../../../../harmonyos-references/Camera Kit（相机服务）/C API/头文件/capture_session.h/capi-capture-session-h.md#oh_capturesession_registermacrostatuschangecallback>)函数注册回调，返回监听结果。
...
[camera\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Media/Camera/NDKPhotoVideoSample/entry/src/main/cpp/camera_manager.cpp#L1517-L1542)
