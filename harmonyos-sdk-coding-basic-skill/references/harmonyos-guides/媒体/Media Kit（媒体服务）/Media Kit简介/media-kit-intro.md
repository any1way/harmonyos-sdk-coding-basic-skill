...
scraped_at: 2026-06-11T14:57:30+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:c9ea1908f6a6ab640b61670d54908c4095708bf7d9e4e21f47b9c8d3ce8ec0d1
---
...
详细流媒体开发流程请参考[流媒体播放开发指导](../媒体开发指导(ArkTS)/播放/使用AVPlayer播放流媒体(ArkTS)/streaming-media-playback-development-guide.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/zYzxdHWXR1etJ_LZBAD_qw/zh-cn_image_0000002592219024.png?HW-CC-KV=V1&HW-CC-Date=20260611T065729Z&HW-CC-Expire=86400&HW-CC-Sign=A2F0DDFDE477F08E54FD6409734196BE89395236BB61572065EBC7D85131251A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/gTfVeA1CSXqtfEhuy9RD0g/zh-cn_image_0000002592378958.png?HW-CC-KV=V1&HW-CC-Date=20260611T065729Z&HW-CC-Expire=86400&HW-CC-Sign=F3EAD672D6C595FF72539F53F9E4BB17B249F6C784E23CBB295E3978C05BE0AD)
...
1. 应用从XComponent组件获取窗口SurfaceID，获取方式参考[XComponent](../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/MS20thXwSiSHxLGZQBSgBQ/zh-cn_image_0000002622858465.png?HW-CC-KV=V1&HW-CC-Date=20260611T065729Z&HW-CC-Expire=86400&HW-CC-Sign=B9F7EE542F7C5A191939986F5F9847B9ABA7FF9C446C7B0C651D1A9DA33504C8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/rgOEizhlT8S0MRZA5eKqmA/zh-cn_image_0000002622698587.png?HW-CC-KV=V1&HW-CC-Date=20260611T065729Z&HW-CC-Expire=86400&HW-CC-Sign=6E4E9F4B5E6758A1114A28B0A0BBE91C23B934F94C8E0E6B106CB91DE3E2E693)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/23M6jfU_QnmOKV7PHZZrcQ/zh-cn_image_0000002592219026.png?HW-CC-KV=V1&HW-CC-Date=20260611T065729Z&HW-CC-Expire=86400&HW-CC-Sign=3C3F905449C36285C5613B72A086D283BD384A83170772C9C8C6CF02DFB245BB)
...
支持的音视频源参考[媒体数据解析](<../../AVCodec Kit（音视频编解码服务）/媒体数据封装与解析/媒体数据解析/audio-video-demuxer.md>)。
...
支持的视频源参考[视频解码](<../../AVCodec Kit（音视频编解码服务）/音视频编解码/视频解码/video-decoding.md>)。
...
* 支持转码时降低视频分辨率。
  ...
  目标视频宽、高不能大于源视频宽、高，且不能设置为奇数，详情请参考[设置正确的视频宽高](<../../AVCodec Kit（音视频编解码服务）/音视频编解码/获取支持的编解码能力/obtain-supported-codecs.md#设置正确的视频宽高>)。
* 支持的源视频格式：

  当前转码支持的源视频格式依赖于系统解码器和解封装支持的格式，详细情况请参考[AVCodec支持的格式](<../../AVCodec Kit（音视频编解码服务）/AVCodec支持的格式/avcodec-support-formats.md#媒体数据解析>)。
* 支持的目标视频格式：
