...
scraped_at: 2026-06-11T14:57:48+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:2bb4abaac9635c1305087ef5bf194b1c53d736ef14c2497a6e6f461b72070c98
---
...
* **码率转换**
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/38gqiyz5SJCX7x0LmvqY-w/zh-cn_image_0000002592378962.png?HW-CC-KV=V1&HW-CC-Date=20260611T065746Z&HW-CC-Expire=86400&HW-CC-Sign=D9EE3B7223F8ABBCD29849DFB2AF501C5F90583F23968F61AE115814E3933529)

  分辨率和帧率的系数由以下经验公式计算可得。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/Kf6iS6UxTtOYejN6--00Rg/zh-cn_image_0000002622858469.png?HW-CC-KV=V1&HW-CC-Date=20260611T065746Z&HW-CC-Expire=86400&HW-CC-Sign=BEC7718725825087EC3C2152FDA902287E764B3EB3DFC936D5368D96FD401F40)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/tVodHnMRRn-XQP19kbG_9g/zh-cn_image_0000002622698591.png?HW-CC-KV=V1&HW-CC-Date=20260611T065746Z&HW-CC-Expire=86400&HW-CC-Sign=44C66C572EA51390AEFAB37C0D3EF7AF60FF2E82AC5B51C50C2EF4F632BA763B)
...
具体如何使用转码能力对视频进行转码，可以参见文档：[用AVTranscoder实现视频转码](../使用AVTranscoder实现视频转码(ArkTS)/using-avtranscoder-for-transcodering.md)。

## 使用异步线程的方式进行转码

本示例使用的是worker线程的方式来实现异步线程进行转码，worker线程的详细使用方式，可以参见文档:

* [Worker线程使用说明](<../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@ohos.worker (启动一个Worker)/js-apis-worker.md>)
