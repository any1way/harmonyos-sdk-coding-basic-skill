...
scraped_at: 2026-06-11T14:57:37+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:e133232db7da0cb5271c283cee997316e39cdc1456b80d45d8efd6fce988bdcb
---
当前仅支持视频播放前设置外挂字幕。
...
1. 调用[addSubtitleFromFd](<../../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md#addsubtitlefromfd12>)，使用视频播放的AVPlayer实例设置外挂字幕资源。
   ...
   ```
2. 调用[on('subtitleUpdate')](<../../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md#onsubtitleupdate12>)接口，注册字幕回调函数。
