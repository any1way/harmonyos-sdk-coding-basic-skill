...
scraped_at: 2026-06-11T14:58:06+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:57ba54d3fe65f1af7f957911361c83171e3773c5f3bca8280da62cc1b26c2d80
---
从API version 20开始支持使用NDK接口（C/C++）实现视频转码。

使用[AVTranscoder](<../../../Media Kit简介/media-kit-intro.md#avtranscoder>)可以实现视频转码功能，从API 12开始，转码功能可在手机、平板、2in1设备上作为系统提供的基础能力使用。可以通过调用[canIUse](<../../../../../../harmonyos-references/C API/模块/Init/init.md#caniuse>)接口来判断当前设备是否支持AVTranscoder。当canIUse("SystemCapability.Multimedia.Media.AVTranscoder")返回值为true时，表示可以使用转码能力。

本开发指导将以“开始转码-暂停转码-恢复转码-完成转码”的一次完整流程为示例，向开发者讲解AVTranscoder视频转码相关功能。

**图1** 转码状态变化示意图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/MJDYG-kfRumcVHnLYDyPQQ/zh-cn_image_0000002622698595.png?HW-CC-KV=V1&HW-CC-Date=20260611T065804Z&HW-CC-Expire=86400&HW-CC-Sign=24E7BD5277DB4094CC93352472AD4D1C0CCB2C2735A3E2E780817808B2075BEC)

状态的详细说明请参考[OH\_AVTranscoder\_State](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/avtranscoder_base.h/capi-avtranscoder-base-h.md#oh_avtranscoder_state>)。
...
详细的API说明请参考[AVTranscoder](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/模块/AVTranscoder/capi-avtranscoder.md>)。
