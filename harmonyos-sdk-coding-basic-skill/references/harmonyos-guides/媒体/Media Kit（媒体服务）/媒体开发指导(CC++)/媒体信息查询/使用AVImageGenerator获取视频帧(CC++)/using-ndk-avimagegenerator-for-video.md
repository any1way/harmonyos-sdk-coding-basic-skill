...
content_hash: sha256:77a8883a32141399ceb3a1ff1c9e99d0a8e0172aff7a7e0a001557c5e9dc4f17
---
...
（可选）开发者可以使用[OH\_AVMetadataExtractor\_FetchMetadata()](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/avmetadata_extractor.h/capi-avmetadata-extractor-h.md#oh_avmetadataextractor_fetchmetadata>)获取媒体资源时长信息[OH\_AVMETADATA\_EXTRACTOR\_DURATION](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/avmetadata_extractor_base.h/capi-avmetadata-extractor-base-h.md#变量>)，进而选择获取视频帧的时间。使用需引入如下头文件。
...
开发者通过引入[avimage\_generator.h](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/avimage_generator.h/capi-avimage-generator-h.md>)、[avimage\_generator\_base.h](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/avimage_generator_base.h/capi-avimage-generator-base-h.md>)和[native\_averrors.h](<../../../../../../harmonyos-references/AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md>)头文件，使用获取视频帧相关API。

详细的API说明请参考[AVImageGenerator API参考](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/模块/AVImageGenerator/capi-avimagegenerator.md>)。

1. 使用[OH\_AVImageGenerator\_Create()](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/avimage_generator.h/capi-avimage-generator-h.md#oh_avimagegenerator_create>)创建实例。
   ...
   ```
2. 设置视频资源的文件描述符：调用[OH\_AVImageGenerator\_SetFDSource()](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/avimage_generator.h/capi-avimage-generator-h.md#oh_avimagegenerator_setfdsource>)。
...
3. （可选）获取媒体资源时长信息，并指定获取视频帧的时间。
   ...
   46. }
   ```
4. 获取指定时间的视频帧：调用[OH\_AVImageGenerator\_FetchFrameByTime()](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/avimage_generator.h/capi-avimage-generator-h.md#oh_avimagegenerator_fetchframebytime>)，可以获取到一个OH\_PixelmapNative对象，该对象可用于图片显示。
   ...
   66. }
   ```
5. 释放资源：调用[OH\_AVImageGenerator\_Release()](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/avimage_generator.h/capi-avimage-generator-h.md#oh_avimagegenerator_release>)销毁实例，释放资源。
