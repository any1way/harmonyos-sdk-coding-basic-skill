...
scraped_at: 2026-06-11T14:57:53+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:c470885a0fc13f3a606c5c764914f84ed3c9d2831c210a11e4dea0bbda38ba64
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/uxsjMOHeQJG_u5Hk23BRmg/zh-cn_image_0000002622698589.png?HW-CC-KV=V1&HW-CC-Date=20260611T065752Z&HW-CC-Expire=86400&HW-CC-Sign=6876E53042DFF91E0881ABE6F93D6EC5A4B43B7BEE20AA4F6E80AAD8AA72A9E0)
...
3. 配置音频录制参数，调用OH\_AVRecorder\_Prepare()接口，此时进入prepared状态。
   ...
   * 录制输出的url地址（即示例里avConfig中的url），形式为fd://xx (fd number)。需要调用基础文件操作接口实现应用文件访问能力，获取方式参考[应用文件访问与管理](<../../../../../应用框架/Core File Kit（文件基础服务）/应用文件/应用文件访问与管理/应用文件访问(CC++)/native-fileio-guidelines.md>)。
   ...
   11. config.profile.fileFormat = AVRECORDER_CFT_MP3;
...
99. config.profile.fileFormat = AVRECORDER_CFT_MP3;
