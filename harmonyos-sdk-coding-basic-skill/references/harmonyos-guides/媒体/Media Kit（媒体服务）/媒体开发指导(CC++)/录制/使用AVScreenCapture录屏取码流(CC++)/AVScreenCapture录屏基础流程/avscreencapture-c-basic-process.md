...
scraped_at: 2026-06-11T14:57:56+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:3c3ee55a28ca965170d7729a083348d349d562e9a78b8e36accf2bc37ab6ba2d
---
屏幕录制功能支持开发者获取屏幕数据，适用于屏幕录制、会议共享、直播等场景。开发者可通过调用[AVScreenCapture](<../../../../Media Kit简介/media-kit-intro.md#avscreencapture>)模块的C API，采集设备内外的音视频数据源。该模块需与窗口管理（Window）、图形处理（Graphic）等模块协同工作，以完成完整的视频采集流程。

从API version 22开始，在PC/2in1设备上录屏时新增如下能力：

* 支持在熄屏但不锁屏的情况下保持录制：需要申请权限**ohos.permission.TIMEOUT\_SCREENOFF\_DISABLE\_LOCK**。配置方式请参见[声明权限](../../../../../../系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)。
* 支持在录制屏幕时不再弹出隐私告警弹窗：需要申请权限**ohos.permission.CUSTOM\_SCREEN\_RECORDING**。配置方式请参见[受限开放权限](../../../../../../系统/安全/程序访问控制/应用权限管控/应用权限列表/受限开放权限/restricted-permissions.md)。

## 流程介绍

基础屏幕录制功能涉及到AVScreenCapture实例创建、音视频参数配置、回调设置、开始与停止、结果处理、资源释放等步骤。

在此基础上，开发者可以根据视频录制、直播等特定场景进行更高级的设置，详情参见[AVScreenCapture录屏自定义场景](../AVScreenCapture录屏自定义场景/avscreencapture-c-custom-scenarios.md)。

基础流程如下图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/wDhgRMonRnKG0y8TJP5itA/zh-cn_image_0000002622698593.png?HW-CC-KV=V1&HW-CC-Date=20260611T065755Z&HW-CC-Expire=86400&HW-CC-Sign=94D1B0779133DC628971AC4EC41D502EC990ECAD80C1AA0C6DF6B1660D15E2E3)
...
* 在录屏取码流场景中，屏幕录制启动时会弹出隐私保护弹框，包含“屏幕隐私保护”选项。勾选后，隐私信息（如横幅通知、控制中心、通话界面等）将被屏蔽。不同产品上的隐私信息可能有差异，以实际录制结果为准。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/ZPV1rmzhSw-WUZik1wwsdA/zh-cn_image_0000002592219032.png?HW-CC-KV=V1&HW-CC-Date=20260611T065755Z&HW-CC-Expire=86400&HW-CC-Sign=84CF31F88B809B9FBD94FC111FF8726536F511009D83C29838B926E35A243652)
...
实例化对象，通过[OH\_AVScreenCapture\_Create](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture.h/capi-native-avscreen-capture-h.md#oh_avscreencapture_create>)创建[OH\_AVScreenCapture](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_AVScreenCapture/capi-avscreencapture-oh-avscreencapture.md>)。
...
创建AVScreenCapture实例后，可设置屏幕录制所需要的音频参数[OH\_AudioInfo](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_AudioInfo/capi-avscreencapture-oh-audioinfo.md>)，包括内录、麦克风音频[OH\_AudioCaptureInfo](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_AudioCaptureInfo/capi-avscreencapture-oh-audiocaptureinfo.md>)和输出规格[OH\_AudioEncInfo](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_AudioEncInfo/capi-avscreencapture-oh-audioencinfo.md>)。

如果配置了采集麦克风音频数据，需：

* 配置麦克风权限ohos.permission.MICROPHONE，配置方式请参见[向用户申请权限](../../../../../../系统/安全/程序访问控制/应用权限管控/申请应用权限/向用户申请授权/request-user-authorization.md)。
* 申请长时任务，申请方式请参见[申请长时任务](<../../../../../../应用框架/Background Tasks Kit（后台任务开发服务）/长时任务(ArkTS)/continuous-task.md>)。
...
录屏的视频采集信息[OH\_VideoInfo](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_VideoInfo/capi-avscreencapture-oh-videoinfo.md>)包含录屏输入规格配置[OH\_VideoCaptureInfo](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_VideoCaptureInfo/capi-avscreencapture-oh-videocaptureinfo.md>)和录屏输出规格配置[OH\_VideoEncInfo](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_VideoEncInfo/capi-avscreencapture-oh-videoencinfo.md>)。
...
AVScreenCapture实例的配置信息为[OH\_AVScreenCaptureConfig](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_AVScreenCaptureConfig/capi-avscreencapture-oh-avscreencaptureconfig.md>)，包括录制数据格式[OH\_VideoInfo](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_VideoInfo/capi-avscreencapture-oh-videoinfo.md>)、音视频采集参数[OH\_AudioInfo](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_AudioInfo/capi-avscreencapture-oh-audioinfo.md>)、录屏模式[OH\_CaptureMode](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture_base.h/capi-native-avscreen-capture-base-h.md#oh_capturemode>)等，录屏模式包含OH\_CAPTURE\_HOME\_SCREEN、OH\_CAPTURE\_SPECIFIED\_SCREEN、OH\_CAPTURE\_SPECIFIED\_WINDOW。

配置完成后通过[OH\_AVScreenCapture\_Init](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture.h/capi-native-avscreen-capture-h.md#oh_avscreencapture_init>)将配置项设置到[OH\_AVScreenCapture](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/结构体/OH_AVScreenCapture/capi-avscreencapture-oh-avscreencapture.md>)中。
...
回调函数主要用来监听录屏过程中的错误发生、音视频流生成和录屏状态变更等事件，详细内容请参考：错误回调[OH\_AVScreenCaptureOnError](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture_base.h/capi-native-avscreen-capture-base-h.md#oh_avscreencaptureonerror>)、状态回调[OH\_AVScreenCapture\_SetStateCallback](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture.h/capi-native-avscreen-capture-h.md#oh_avscreencapture_setstatecallback>)和获取数据回调[OH\_AVScreenCapture\_SetDataCallback](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture.h/capi-native-avscreen-capture-h.md#oh_avscreencapture_setdatacallback>)。
...
启动录屏[OH\_AVScreenCapture\_StartScreenCapture](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture.h/capi-native-avscreen-capture-h.md#oh_avscreencapture_startscreencapture>)后，开始采集原始码流，通过回调[OH\_AVScreenCapture\_OnBufferAvailable](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture_base.h/capi-native-avscreen-capture-base-h.md#oh_avscreencapture_onbufferavailable>)来监听当前是否有码流的产生，通过回调[OH\_AVScreenCapture\_OnStateChange](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture_base.h/capi-native-avscreen-capture-base-h.md#oh_avscreencapture_onstatechange>)来监听启动状态的变更。

在回调接口中，可以调用获取音频码流[OH\_AVScreenCapture\_AcquireAudioBuffer](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture.h/capi-native-avscreen-capture-h.md#oh_avscreencapture_acquireaudiobuffer>)和获取视频码流[OH\_AVScreenCapture\_AcquireVideoBuffer](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture.h/capi-native-avscreen-capture-h.md#oh_avscreencapture_acquirevideobuffer>)的接口来获取录屏的原始码流。
...
调用[OH\_AVScreenCapture\_StopScreenCapture](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture.h/capi-native-avscreen-capture-h.md#oh_avscreencapture_stopscreencapture>)后应用会停止录屏或屏幕共享，释放麦克风。
...
调用[OH\_AVScreenCapture\_Release](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture.h/capi-native-avscreen-capture-h.md#oh_avscreencapture_release>)释放创建的OH\_AVScreenCapture实例，需要在停止录屏后释放。
...
录屏模式会使用到屏幕ID（displayId）和窗口ID（missionIds）。获取方式请分别参考：[OH\_NativeDisplayManager\_CreateAllDisplays](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/oh_display_manager.h/capi-oh-display-manager-h.md#oh_nativedisplaymanager_createalldisplays>)和[getWindowProperties](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#getwindowproperties9>)。

### 录制指定屏幕

即[OH\_CAPTURE\_SPECIFIED\_SCREEN](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture_base.h/capi-native-avscreen-capture-base-h.md#oh_capturemode>)模式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/iLrYWSlVTU6tMvuGEdcd0g/zh-cn_image_0000002592378966.png?HW-CC-KV=V1&HW-CC-Date=20260611T065755Z&HW-CC-Expire=86400&HW-CC-Sign=76559839818CF9542D7F5CCD4526F0398B02D03FE13D7F0445FD66F30098B6E5)

### 录制主屏幕

即[OH\_CAPTURE\_HOME\_SCREEN](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture_base.h/capi-native-avscreen-capture-base-h.md#oh_capturemode>)模式。
...
即[OH\_CAPTURE\_SPECIFIED\_WINDOW](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture_base.h/capi-native-avscreen-capture-base-h.md#oh_capturemode>)模式。
...
10. int32_t* missionIds = new int32_t[1]{61}; // 表示弹出的Picker默认选中61号窗口。
11. config.videoInfo.videoCapInfo.missionIDs = &missionIds[0];
12. int32_t missionIdsLen = sizeof(missionIds) / sizeof(missionIds[0]);
13. config.videoInfo.videoCapInfo.missionIDsLen = static_cast<int32_t>(missionIdsLen);

15. // 在配置参数结束后执行"delete[] missionIds"。
```

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/0kH2LZYgTauWsCack8McYA/zh-cn_image_0000002622858473.png?HW-CC-KV=V1&HW-CC-Date=20260611T065755Z&HW-CC-Expire=86400&HW-CC-Sign=35016C309C55229D777CA5D64223C2CE20DC77097B7969DF14DFD3344A102F6B)
...
9. // 传入多个窗口Id。
10. int32_t* missionIds = new int32_t[2]{60, 61}; // 表示期望同时录制60、61号窗口。
11. config.videoInfo.videoCapInfo.missionIDs = &missionIds[0];
12. int32_t missionIdsLen = sizeof(missionIds) / sizeof(missionIds[0]);
13. config.videoInfo.videoCapInfo.missionIDsLen = static_cast<int32_t>(missionIdsLen);
...
在PC/2in1设备上，是否弹出选择共享内容弹窗受录制模式控制，在Phone/Tablet设备上可以通过[OH\_AVScreenCapture\_StrategyForPickerPopUp](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture.h/capi-native-avscreen-capture-h.md#oh_avscreencapture_strategyforpickerpopup>)配置选择共享内容弹窗模式，无需指定录制模式。
...
* API参考：详细的API描述请见[native\_avscreen\_capture.h](<../../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/native_avscreen_capture.h/capi-native-avscreen-capture-h.md>)。
