...
scraped_at: 2026-06-01T11:30:53+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:a71253cfa073467544b61838342ac7c9e07b79a7ffcd77c42dc9074677985ddc
---
本模块提供视频细节增强的[C API接口](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/模块/VideoProcessing/capi-videoprocessing.md>)，通过调用本模块的接口，可以实现视频流图像内容的清晰度增强及缩放功能，处理后的数据可以用于送显、播放和录制。
...
10. 启动细节增强处理。
    ...
    ```
11. 调用[OH\_VideoProcessing\_Stop()](<../../../../../../harmonyos-references/Media Kit（媒体服务）/C API/头文件/video_processing.h/capi-video-processing-h.md#oh_videoprocessing_stop>)停止细节增强。
