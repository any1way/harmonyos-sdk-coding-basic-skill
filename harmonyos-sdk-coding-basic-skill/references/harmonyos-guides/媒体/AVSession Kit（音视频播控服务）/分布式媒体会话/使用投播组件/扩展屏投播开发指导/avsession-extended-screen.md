...
scraped_at: 2026-06-11T14:55:19+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:dfb9b9ddd36891ab5835bd75476db5236869622d34706bf19e9708f01f9aa366
---
通过本节开发指导，可在系统镜像投屏后，获取投屏设备信息，实现扩展屏模式的投播，实现双屏协作的能力。

## 运作机制

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/QiJdBmuNT1qA8qVkxjrmEg/zh-cn_image_0000002592218986.png?HW-CC-KV=V1&HW-CC-Date=20260611T065352Z&HW-CC-Expire=86400&HW-CC-Sign=176EF088DCC4414DBCCF0B2BCA5194B5124DA2E29054E58FB53091AE6A384017)
...
1. UIAbility A创建AVSession, 获取可用扩展屏投播设备并注册监听。
   ...
   获取的屏幕信息CastDisplayInfo中包含屏幕ID，屏幕名称、状态以及分辨率宽度、高度基础属性，其中屏幕id 值同于[Display](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#display>)的id，如需要获取更详细的信息可参考[Display获取设备信息说明](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#displaygetalldisplays9>)。
