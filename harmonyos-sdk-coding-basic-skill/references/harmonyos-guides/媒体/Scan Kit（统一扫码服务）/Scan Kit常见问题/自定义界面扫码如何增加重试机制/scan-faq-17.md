...
scraped_at: 2026-06-01T14:55:24+08:00
doc_updated_at: 2026-05-07
content_hash: sha256:ca7c14688834d0a410e5fa243b8c3227a754a7e78662d4caf26771fb269e76e2
---
**问题现象**

调用customScan.[init](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/customScan (自定义界面扫码)/scan-customscan-api.md#customscaninit>)成功后，调用customScan.[start](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/customScan (自定义界面扫码)/scan-customscan-api.md#customscanstart-1>)启动相机流时抛出1000500001内部错误。

**解决措施**

可以尝试增加扫码相机流重试机制。

先暂停并释放相机流（customScan.[stop](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/customScan (自定义界面扫码)/scan-customscan-api.md#customscanstop>)、customScan.[release](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/customScan (自定义界面扫码)/scan-customscan-api.md#customscanrelease>)），再重启相机流（customScan.[init](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/customScan (自定义界面扫码)/scan-customscan-api.md#customscaninit>)、customScan.[start](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/customScan (自定义界面扫码)/scan-customscan-api.md#customscanstart-1>)）。
