...
scraped_at: 2026-06-11T14:58:44+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:a40c343a6b7d7ea21846ed683ad586fe4430362239dc7eac1e923bef77e68df3
---
## 基本概念
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/u2AI7l9hQoeR1oHfF3hQOA/zh-cn_image_0000002592219046.png?HW-CC-KV=V1&HW-CC-Date=20260611T065843Z&HW-CC-Expire=86400&HW-CC-Sign=5856FC66D974F868AE836C521ED46D32B571E1DAA408F46DAF27F41A5DDD7D66)
...
接口返回值有两种返回形式：Callback和Promise回调。下表中为码图生成能力的Callback和Promise形式接口，Callback和Promise只是返回值方式不一样，功能相同。具体API说明详见[接口文档](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/generateBarcode (码图生成)/scan-generatebarcode.md>)。

| 接口名 | 接口描述 |
| --- | --- |
| [createBarcode](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/generateBarcode (码图生成)/scan-generatebarcode.md#generatebarcodecreatebarcode>)(content: string, options: [CreateOptions](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/generateBarcode (码图生成)/scan-generatebarcode.md#createoptions>)): Promise<image.[PixelMap](<../../../../../harmonyos-references/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | 码图生成接口，返回生成的码图，类型为image.PixelMap，可以使用Image组件渲染成图片。使用Promise异步回调。 |
| [createBarcode](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/generateBarcode (码图生成)/scan-generatebarcode.md#generatebarcodecreatebarcode-1>)(content: string, options: CreateOptions, callback: AsyncCallback<image.PixelMap>): void | 码图生成接口，返回生成的码图，类型为image.PixelMap，可以使用Image组件渲染成图片。使用callback异步回调。 |
