...
scraped_at: 2026-06-11T14:58:45+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:c576ca05db323153ae7fd938f5024b4757d9568499bf92b28dc0c1e06304c1ef
---
## 基本概念
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/7dkkm2RbQqCgEnuKlV5ApQ/zh-cn_image_0000002592378980.png?HW-CC-KV=V1&HW-CC-Date=20260611T065844Z&HW-CC-Expire=86400&HW-CC-Sign=3BCA1EAE886471C9BCB03F8E0443AD520B3A53E08889EC71A7145459FE64964D)
...
通过字节数组生成码图，以Promise形式生成码图。具体API说明详见[接口文档](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/generateBarcode (码图生成)/scan-generatebarcode.md>)。

| 接口名 | 接口描述 |
| --- | --- |
| [createBarcode](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/generateBarcode (码图生成)/scan-generatebarcode.md#generatebarcodecreatebarcode-2>)(content: ArrayBuffer, options: [CreateOptions](<../../../../../harmonyos-references/Scan Kit（统一扫码服务）/ArkTS API/generateBarcode (码图生成)/scan-generatebarcode.md#createoptions>)): Promise<image.[PixelMap](<../../../../../harmonyos-references/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | 码图生成接口，返回生成的码图，类型为image.PixelMap，可以使用Image组件渲染成图片。使用Promise异步回调。 |
