...
scraped_at: 2026-06-01T11:27:57+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:a65264fddcbb7f948946dadb529514061603946b05647ba1a94f31340bd316cb
---
## 场景介绍
...
5. 配置解码器。
   ...
   具体开发指导请参考[视频解码Surface模式](../../音视频编解码/视频解码/video-decoding.md#surface模式)“步骤-5：调用OH\_VideoDecoder\_Configure()配置解码器”。
6. 设置surface。
   ...
   * videoDec：视频解码器实例的指针。创建方式可参考[视频解码Surface模式](../../音视频编解码/视频解码/video-decoding.md#surface模式)“步骤-2：创建解码器实例对象”。
...
7. 启动解码器。
   ...
   具体开发指导请参考[视频解码Surface模式](../../音视频编解码/视频解码/video-decoding.md#surface模式)“步骤-8：调用OH\_VideoDecoder\_Start()启动解码器”。
8. 设置surface。
   ...
   1. 如果解码后直接显示，则从XComponent组件获取，获取方式请参考 [XComponent](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)；
   2. 如果解码后接OpenGL后处理，则从NativeImage获取，获取方式请参考 [NativeImage](<../../../../图形/ArkGraphics 2D（方舟2D图形服务）/图形缓冲区/NativeImage开发指导 (CC++)/native-image-guidelines.md>)。
