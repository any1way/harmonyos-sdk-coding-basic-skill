...
scraped_at: 2026-06-01T11:27:33+08:00
doc_updated_at: 2026-04-17
content_hash: sha256:4502f70707c721abe09e98e32011e1b8bb4c9d21b30756a972ed16d915cd41a8
---
...
基础编码流程请参考[视频编码](../视频编码/video-encoding.md)，下面仅针对编码器配置阶段做具体说明。
...
1. 配置编码器参数。
   ...
   videoEnc：视频编码器实例的指针。创建方式可参考[视频编码Surface模式](../视频编码/video-encoding.md#surface模式)“步骤-2：创建编码器实例对象”。
...
2. （可选）在运行过程中动态配置编码器参数。
   ...
   详情可参考[视频编码Surface模式](../视频编码/video-encoding.md#surface模式)“步骤-9：OH\_VideoEncoder\_SetParameter()在运行过程中动态配置编码器参数”。
   ...
   如果需要适配网络波动，推荐结合采用[时域可分层视频编码](../时域可分层视频编码/video-encoding-temporal-scalability.md)配置。
...
基础编码流程请参考[视频编码](../视频编码/video-encoding.md)，下面仅针对编码器配置阶段，对配置实时流媒体编码场景的参数做具体说明。
...
基础编码流程请参考[视频编码](../视频编码/video-encoding.md)，下面仅针对编码器配置阶段，对配置离线编码场景的编码参数做具体说明。
