...
content_hash: sha256:6ffc5ed0c643bc5915858556328d7e19ae7dfa5bce2916d1bc7a273534f19d19
---
...
3. 配置异步回调函数。
   ...
   具体可参考：[视频编码Surface模式](../../视频编码/video-encoding.md#surface模式)中的“步骤3：调用OH\_VideoEncoder\_RegisterCallback()设置回调函数”。
4. 配置编码器。
...
5. 获取surface，并设置给相机。
   ...
   具体可参考：[视频编码Surface模式](../../视频编码/video-encoding.md#surface模式)中的“步骤6：获取surface”。
6. 调用OH\_VideoEncoder\_Start()启动编码器。

   具体可参考：[视频编码Surface模式](../../视频编码/video-encoding.md#surface模式)中的“步骤8：调用OH\_VideoEncoder\_Start()启动编码器”。
