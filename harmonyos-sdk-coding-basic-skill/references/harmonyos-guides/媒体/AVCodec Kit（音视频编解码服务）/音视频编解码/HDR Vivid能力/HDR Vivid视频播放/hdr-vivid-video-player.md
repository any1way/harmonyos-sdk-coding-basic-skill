...
scraped_at: 2026-06-01T11:27:49+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:8cb11f56c56cd6af93646720307dd1e694ce4c2b6cc13ffa28fc5b2382e536ad
---
...
2. 配置异步回调函数。
   ...
   具体可参考：[视频解码Surface模式](../../视频解码/video-decoding.md#surface模式)中的“步骤-3：调用OH\_VideoDecoder\_RegisterCallback()设置回调函数”。
3. 配置解码器。

   具体可参考：[视频解码Surface模式](../../视频解码/video-decoding.md#surface模式)中的“步骤-5：调用OH\_VideoDecoder\_Configure()配置解码器”。
4. 设置surface。

   具体可参考：[视频解码Surface模式](../../视频解码/video-decoding.md#surface模式)中的“步骤-6：设置surface”。
5. 调用OH\_VideoDecoder\_Start()启动解码器。

   具体可参考：[视频解码Surface模式](../../视频解码/video-decoding.md#surface模式)中的“步骤-8：调用OH\_VideoDecoder\_Start()启动解码器”。
...
2. 配置异步回调函数。
   ...
   具体可参考：[视频解码Buffer模式](../../视频解码/video-decoding.md#buffer模式)中的“步骤-3：调用OH\_VideoDecoder\_RegisterCallback()设置回调函数”。
3. 配置解码器。

   具体可参考：[视频解码Buffer模式](../../视频解码/video-decoding.md#buffer模式)中的“步骤-5：调用OH\_VideoDecoder\_Configure()配置解码器”。
4. 调用OH\_VideoDecoder\_Start()启动解码器。

   具体可参考：[视频解码Buffer模式](../../视频解码/video-decoding.md#buffer模式)中的“步骤-7：调用OH\_VideoDecoder\_Start()启动解码器”。
5. 获取元数据。
...
2. 将解封装后的视频帧数据送入解码输入队列。
   ...
   后续步骤具体可参考：[视频解码](../../视频解码/video-decoding.md)。
