...
scraped_at: 2026-06-11T14:54:44+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:fa7753e417bf8b93ca994f6bf30fdb05ccf6c29e259a66b45a2f91cbfefe32e5
---
## 基础概念
...
**依赖ROI检测识别能力：** 编码器不具备ROI的检测识别能力，所以ROI编码技术生效依赖于开发者输入的ROI信息。开发者可根据业务场景自行设计并实现ROI识别能力，或通过调用系统相机模块原生提供的人脸区域信息，降低开发成本，具体请参考[相机人脸ROI获取示例](<../../../Camera Kit（相机服务）/开发相机应用基础能力(CC++)/元数据(CC++)/native-camera-metadata.md#状态监听>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/QSO27yfIRRq0Qe1SJPxcWQ/zh-cn_image_0000002622698541.png?HW-CC-KV=V1&HW-CC-Date=20260611T065442Z&HW-CC-Expire=86400&HW-CC-Sign=5C6224154D877B9822E1B47D118AD1850D0BBF88F76F20860BBAC03D91088070)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fd/v3/18Mads0MTzepjg7t9DpiPw/zh-cn_image_0000002592218980.png?HW-CC-KV=V1&HW-CC-Date=20260611T065442Z&HW-CC-Expire=86400&HW-CC-Sign=20AB1851E798496573910673D43E8CB67A73CF8ECE6154B727BB23131EE93681)
...
2. 监听相机元数据回调接口获取人脸位置信息。
   ...
   如何注册相机元数据回调可以参考 [相机元数据状态监听](<../../../Camera Kit（相机服务）/开发相机应用基础能力(ArkTS)/元数据(ArkTS)/camera-metadata.md#状态监听>)。
...
3. Native层解析TS层传递的人脸位置信息。
   ...
   48. napi_get_named_property(env, faceRectObj, "height", &propValue);
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0/v3/xyBoqjQCQm2SoLK6bNWLvw/zh-cn_image_0000002592378914.png?HW-CC-KV=V1&HW-CC-Date=20260611T065442Z&HW-CC-Expire=86400&HW-CC-Sign=D6F3A433AEF6212F037F0A1DCA9044AE31DB9DAB5B235F9953C4C0B0ED40B65C)
...
5. 在编码输入参数回调中配置ROI信息。
   ...
   视频编码的详细操作步骤请参考[视频编码](../视频编码/video-encoding.md)开发指南，下面仅针对ROI编码做具体说明。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/gJoHU0v2TleKrAcaV69w6A/zh-cn_image_0000002622858421.png?HW-CC-KV=V1&HW-CC-Date=20260611T065442Z&HW-CC-Expire=86400&HW-CC-Sign=B42C97928C897850084EB603E3E94B9E2C0C23E56E598EFA149A2B9DD5221E46)
