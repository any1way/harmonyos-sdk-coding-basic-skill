...
content_hash: sha256:0709edbf37456bc630682b115ded06602533ae9731a67dffe81f0e0c474ed739
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/L5sa65-0QtmnXuSJzD4lCQ/zh-cn_image_0000002622858423.png?HW-CC-KV=V1&HW-CC-Date=20260611T065446Z&HW-CC-Expire=86400&HW-CC-Sign=284070F3FEF05C0DD91912237DFD2030E65AB58EEDBF75C94FDA21888BCD056F)
...
基础解码功能请参考[视频解码开发指南](../视频解码/video-decoding.md)，下面仅针对于基础视频解码过程中存在的区别做具体说明。

1. 解码器配置阶段，添加视频可变帧率使能开关。

   示例中的变量说明如下：

   • videoDec：视频解码器实例的指针。创建方式参考[Surface模式下创建解码器实例对象](../视频解码/video-decoding.md#surface模式)。
