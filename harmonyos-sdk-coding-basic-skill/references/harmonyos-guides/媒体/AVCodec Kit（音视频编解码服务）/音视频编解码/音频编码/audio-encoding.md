...
content_hash: sha256:8c102d5929cd553a6bbbe5422c55a7e79fe1e890b81325ba0687084aef6c9f4c
---
开发者可以调用本模块的Native API接口，完成音频编码，即将音频PCM编码压缩成不同的格式。

接口不限制PCM数据的来源，开发者可以调用麦克风录制获取、也可以导入编辑后的PCM数据，通过音频编码，输出对应格式的码流，最后封装为目标格式文件。

当前支持的编码能力请参考[AVCodec支持的格式](../../AVCodec支持的格式/avcodec-support-formats.md#音频编码)。

**适用场景**

* 音频录制

  通过录制传入PCM，然后编码出对应格式的码流，最后[封装](../../媒体数据封装与解析/媒体数据封装/audio-video-muxer.md)为所需格式的音频文件。
* 音频编辑

  编辑PCM后导出音频文件的场景，需要编码成对应音频格式后再[封装](../../媒体数据封装与解析/媒体数据封装/audio-video-muxer.md)成文件。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/Wa8qeINqQr2JM8cw0JT4dw/zh-cn_image_0000002592218972.png?HW-CC-KV=V1&HW-CC-Date=20260611T065429Z&HW-CC-Expire=86400&HW-CC-Sign=7E92009920756ECEECCB4FE8C1C9646F05666B6DF92388ED98B86EDC78FB0BD6)
...
4. 调用OH\_AudioCodec\_Configure设置编码器。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/HZNhnIwrRJG_rcEqL_NJeg/zh-cn_image_0000002592378906.png?HW-CC-KV=V1&HW-CC-Date=20260611T065429Z&HW-CC-Expire=86400&HW-CC-Sign=A88F5AF4B053F023639230BE6C45367AC63A04DCFA850ABB4A39D77F491CB042)

   各音频编码类型参数范围说明：

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/t_Z8ZvO4TFOlHNhTKTYjxA/zh-cn_image_0000002622858413.png?HW-CC-KV=V1&HW-CC-Date=20260611T065429Z&HW-CC-Expire=86400&HW-CC-Sign=686E25F2C36CBECFCFFB09247C8D2D451D36661C184D3852BB24244D33422DBC)
