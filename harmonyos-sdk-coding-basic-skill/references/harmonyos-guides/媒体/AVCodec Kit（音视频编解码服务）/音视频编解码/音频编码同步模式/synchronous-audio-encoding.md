...
content_hash: sha256:938d36bdd0e17b31a6b676a1b962b44601df28e157f22d969b236256e05e8925
---
...
支持的编码能力请参考[AVCodec支持的格式](../../AVCodec支持的格式/avcodec-support-formats.md#音频编码)。

**适用场景**

通常推荐使用异步模式，异步模式请参考[音频编码](../音频编码/audio-encoding.md)。若需要主动请求buffer去编码PCM，则可以使用同步模式。

* 音频录制

  通过录制传入PCM，然后编码成对应格式的码流，最后封装成所需格式的文件。具体封装方法请参考[媒体数据封装](../../媒体数据封装与解析/媒体数据封装/audio-video-muxer.md)。
* 音频编辑

  编辑PCM后导出音频文件的场景，需要编码成对应音频格式，最后封装成所需格式的文件。具体封装方法请参考[媒体数据封装](../../媒体数据封装与解析/媒体数据封装/audio-video-muxer.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/jQVyj9fiSXKn9KqI_Wncaw/zh-cn_image_0000002622698535.png?HW-CC-KV=V1&HW-CC-Date=20260611T065432Z&HW-CC-Expire=86400&HW-CC-Sign=B3507E2ED338943EE5791A584522D0725B221EEAAE8197BE1DAC52F99A75C2BC)
...
3. 调用OH\_AudioCodec\_Configure配置编码器。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/4R4M9MEVQBiC7DfzTrY0nQ/zh-cn_image_0000002592378906.png?HW-CC-KV=V1&HW-CC-Date=20260611T065432Z&HW-CC-Expire=86400&HW-CC-Sign=3B0555BD57EE64454E9202BC4C0608F615056EB843AB3A60B3AA0962E59B721B)

   各音频编码类型参数范围说明：

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/m508bt83TwaYmGCXdYR3Dg/zh-cn_image_0000002622858413.png?HW-CC-KV=V1&HW-CC-Date=20260611T065432Z&HW-CC-Expire=86400&HW-CC-Sign=C45F1B48A9AA4BCC60EBACDF83622FD5284E271A678C8AB7E8ED5EBC253831DD)
