...
content_hash: sha256:13481fe5940c2f9bd08598f72cad7754384c4c476de8c6aae996a71eb3176caa
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/gxAT6Wa5TISCO03DJKTQwg/zh-cn_image_0000002602186625.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=00F532E4EFADE587E27103D932219F9CBB41703C19F3EA9F9FA34BE596CDAC31)
...
2. 填写密钥库文件，若已有的密钥库文件（存储有密钥的.p12文件），单击**Select an existing key**进行选择。下面以新创建密钥库文件为例进行说明。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6/v3/lsLCT6DNS26l3N5fUEWNSg/zh-cn_image_0000002571387470.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=731CE773FFD5A8B34F999913DF4DFB2E34B11BCE988BD592AF5D855D2B65D662)
3. 在**Generate Key**窗口，填写密钥库信息后，点击**Next**。
   ...
   * **Advance Setting**：密钥库文件的高级设置，选填。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/c0MtkceRSwmfpf_8O8-Qgg/zh-cn_image_0000002602186641.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=33A6A16E19C59BBA9AB8CD7451A6DC7C97AEB5313C856D125DD4B3E2E1534356)
4. 在**Generate** **Certificate Request File (CSR)**窗口，设置CSR文件名和CSR文件存储路径后，点击**Finish**。
   ...
   * **Select file save path**：设置CSR文件存储路径。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/AB9Oy1j1QLm_fgcsJR2QFg/zh-cn_image_0000002571387456.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=7B215DC9814D6147B014804CF638DD57F5073FDB803E218B1D71E01BD9A1F644)
5. 创建CSR文件成功，可以在存储路径下获取生成的密钥库文件（.p12）、证书请求文件（.csr）。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/27OWInliT2yydlIxH9zfeQ/zh-cn_image_0000002602066577.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=639132E9E4F97BCAB33453860D934AB985FCC98157F68AD44DA6AC3063B950B1)
...
2. 在**Key Store File**中，可以单击**Choose Existing**选择已有的密钥库文件（存储有密钥的.p12文件）；如果没有密钥库文件，单击**New**进行创建。下面以新创建密钥库文件为例进行说明。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/fkA86LyNTn6WgQ4VJau4VA/zh-cn_image_0000002602066583.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=9DF825A5B25633E25CE6CEF25792BC8986FC1AF59CBE4A520E9E61DFDD8A27F6 "点击放大")
3. 在**Create Key Store**窗口中，填写密钥库信息后，单击**OK**。
   * **Key Store File**：设置密钥库文件存储路径，并填写p12文件名。
   * **Password**：设置密钥库密码，必须由大写字母、小写字母、数字和特殊符号中的两种以上字符的组合，长度至少为8位。请记住该密码，后续签名配置需要使用。
   * **Confirm Password**：再次输入密钥库密码。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/LROZKrEnQ_i98ZFly-eW3g/zh-cn_image_0000002602066571.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=569BE466D41E2D2F110DA28182C5978B398361EEFE626179E2A6EC5168E80F6F "点击放大")
4. 在**Generate Key** **and CSR**界面中，继续填写密钥信息后，单击**Next**。
   ...
   * **Country code(XX)：**选填，[国家码](https://developer.huawei.com/consumer/cn/doc/app/agc-help-connect-api-appendix-countrycode-0000002236201362)。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/U27pnQu-TC6j0Z7WOH71IQ/zh-cn_image_0000002571387460.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=005131C04898C9FED8D44CF308C5E7D72F952C7AB89E84E3A0E39246B6FA1F77)
5. 在**Generate Key** **and CSR**界面，设置CSR文件存储路径和CSR文件名。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/etcZIxibTd6UvA48WEazDQ/zh-cn_image_0000002571547100.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=CB127571D5581989E5D3C8DB42C3F77599BE7AFB743F9F7F88AD2ECEA88694F6 "点击放大")
6. 单击**OK**按钮，创建CSR文件成功，可以在存储路径下获取生成的密钥库文件（.p12）和证书请求文件（.csr）。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/qrzEO2AiTyeTNyQSNumj1A/zh-cn_image_0000002602066581.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=CFB4B86E4ECF2E222C6F4C0545C09F071AE9BDE6FAB12700B464AA09D4A185F2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/45/v3/qPI2cP5STyugV7KKXllhmw/zh-cn_image_0000002571387468.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=DCBB54A5E0C4D7DE9CC3E81B7917EBFBD0E641ABE5EFB5741919EE67011CB918 "点击放大")
...
1. 单击**Build > Build Hap(s)/APP(s) > Build APP(s)**，等待编译构建完成已签名的应用包。
   ...
   当未指定[构建模式](../../构建应用/定制构建/灵活定制编译选项/能力说明/ide-hvigor-compilation-options-customizing-guide.md#section192461528194916)时，构建APP包，默认Release模式；构建HAP/HSP/HAR包，默认Debug模式。

   即**Build APP(s)**时，默认构建的APP包为Release类型，符合上架要求，开发者无需进行另外设置。
2. 编译构建完成后，可以在工程目录**build > outputs > default**下，获取带签名的应用包。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/KeMXhSA-TMSVpxdtykyGJQ/zh-cn_image_0000002602066573.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=25E5A509F95361FDC241E3FE0A92AAE72BA23216C6F3429E32F1174F4E0916C0)
...
1. 在DevEco Studio菜单栏，点击**Build > Upload Product。**若未登录，请点击**Sign in**登录华为开发者账号。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2/v3/C52NTilOTnmGGRnmXdBy6Q/zh-cn_image_0000002602066575.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=1B998920BC5203523982A92E253C4A000DDB5C1DBA49DD9D3D5A1EDB3D7004C4 "点击放大")
2. 登录成功后，返回DevEco Studio进入软件包上传界面。确认当前工程的product信息，选择需要上传的软件包类型，点击**OK**开始上传。
   ...
   * 上传的product可以通过点击DevEco Studio编辑区域右上方![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/1Jka-eJaR-C5jgyq9MBFrA/zh-cn_image_0000002602186633.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=816F2A11D4BA631E1D0762A26F3D3B40E99AFAD19C86B44EF2F114741084E648)图标进行查看及切换。
   * 可通过app.json5中bundleName/versionName字段修改当前product对应的包名/版本号信息。必须使用当前开发者账号下已在AppGallery注册且真实存在的包名。
   * Build Version值由AGC计算后回传填入。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/gnfJTx-0SY2DETcbBDcrwQ/zh-cn_image_0000002602186629.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=55578382F6FB4AEB45FB2ECB651309125E3D9F3412A09451B637A337B9C954BE)
3. 上传完成后，出现云测试的结果，点击**View Full result in AppGallery Connect**可进入AGC查看软件包上传记录和检测结果，具体请参考[上传软件包](https://developer.huawei.com/consumer/cn/doc/app/agc-help-release-app-upload-pkg-0000002277983368)。点击**Close**关闭上传页面。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/AvKFRKXOTC6iEY47sS9g4A/zh-cn_image_0000002602066585.png?HW-CC-KV=V1&HW-CC-Date=20260611T072857Z&HW-CC-Expire=86400&HW-CC-Sign=07D0CF8339788CAFD474DA9C1CA10437FE240CC57B145011406581C8E44D2059)
