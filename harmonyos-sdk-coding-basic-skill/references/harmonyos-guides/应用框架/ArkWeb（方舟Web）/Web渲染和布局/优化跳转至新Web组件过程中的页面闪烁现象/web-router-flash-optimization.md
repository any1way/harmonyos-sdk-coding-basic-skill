...
scraped_at: 2026-06-11T14:35:14+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:c3f12c909078a650a8a3046cb3def4354b36ea3c7a9912c21c1abba985e37c1a
---
应用使用[Navigation](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)等路由策略导航至Web组件页面时，在网页加载过程中，页面底部可能出现闪烁现象，这会影响用户体验。

## 闪烁原因

使用Navigation等路由策略导航至Web组件页面时，通常根据网页的回调通知判断是否隐藏系统导航栏。若决定隐藏，Web组件布局会进行调整。这一布局调整过程可简化为如下四个阶段：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7e/v3/6vKQHP_lTPmjCGv92WRh9A/zh-cn_image_0000002622858057.png?HW-CC-KV=V1&HW-CC-Date=20260611T063513Z&HW-CC-Expire=86400&HW-CC-Sign=FF238C0DED11B8E1FF45062FE83BBE0286F1C9EDCBF07F38A460E1AA29FC3F4C)
...
[FixingPageFlickering.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ProcessWeb/entry/src/main/ets/pages/FixingPageFlickering.ets#L22-L25)
