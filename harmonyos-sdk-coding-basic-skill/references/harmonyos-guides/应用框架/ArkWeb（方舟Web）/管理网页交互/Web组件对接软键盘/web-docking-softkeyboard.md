...
scraped_at: 2026-06-11T14:35:28+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:d3c39c519f3a3abaaacd43ae74df2a5376d4aa1d093fa86800b5014ee6adabce
---
...
为提升用户体验，可以在页面完成加载后，输入框自动获焦并弹出软键盘。通过调用[showTextInput()](<../../../../../harmonyos-references/IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethod (输入法框架)/js-apis-inputmethod.md#showtextinput10>)设置软键盘自动弹出功能。
...
1. 在应用代码中设置UIContext的软键盘避让模式[setKeyboardAvoidMode()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/安全区域/ts-universal-attributes-expand-safe-area.md#setkeyboardavoidmode11)。ArkWeb组件支持Resize和Offset两种模式。
...
[Entry2Ability.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ManageWebPageInteracts/entry2/src/main/ets/entry2ability/Entry2Ability.ets#L18-L48)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ManageWebPageInteracts/entry2/src/main/ets/pages/Index.ets#L16-L32)

ArkWeb组件将跟随ArkUI重新布局，效果如图1和图2所示。

**图1** Web组件网页默认软键盘避让模式

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/ZamIUVQfRleWUev_Wh7R6A/zh-cn_image_0000002622858061.png?HW-CC-KV=V1&HW-CC-Date=20260611T063526Z&HW-CC-Expire=86400&HW-CC-Sign=BC7CA4A6E12BA6C10ED6C28433FEAADD178910102519C66A2F543227614C98DF)

**图2** Web组件网页跟随Arkui软键盘避让模式

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/A4zqy_LET1yfqL-eAWXV5Q/zh-cn_image_0000002622698183.png?HW-CC-KV=V1&HW-CC-Date=20260611T063526Z&HW-CC-Expire=86400&HW-CC-Sign=72C8B6D066D07DDA8B585B4E4AF388CBC100904E36BFB39B4BF0274971793765)

2.在UIContext的键盘避让模式为Offset模式时，应用可通过[WebKeyboardAvoidMode()](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Enums/arkts-basic-components-web-e.md#webkeyboardavoidmode12>)设置ArkWeb组件的键盘避让模式。Web组件的[WebKeyboardAvoidMode()](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Enums/arkts-basic-components-web-e.md#webkeyboardavoidmode12>)接口优先级高于W3C侧virtualKeyboard.overlayContent。
...
[SetSKBMode\_one.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ManageWebPageInteracts/entry/src/main/ets/pages/SetSKBMode_one.ets#L16-L37)

ArkWeb组件根据避让模式进行避让，效果见图3。

**图3** Web组件网页自身软键盘避让模式

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/4LttrMO_TM6PbklD4Fe06w/zh-cn_image_0000002592218622.png?HW-CC-KV=V1&HW-CC-Date=20260611T063526Z&HW-CC-Expire=86400&HW-CC-Sign=D10198B5DC813B903F66C5CAD0DDAE02621B9E5E72669E9A2F896D0E46165B54)

3.在软键盘弹出时，为使Web组件不发生避让行为，可通过调用[expandSafeArea()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/安全区域/ts-universal-attributes-expand-safe-area.md#expandsafearea)设置Web组件扩展安全区域。更多详细示例可参考[网页中安全区域计算和避让适配](../../处理网页内容/网页中安全区域计算和避让适配/web-safe-area-insets.md)。
...
应用可以通过监听[onInterceptKeyboardAttach](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#oninterceptkeyboardattach12>)回调，在软键盘拉起前，控制软键盘的显示，包括系统默认软键盘、带有特定Enter键的软键盘，或完全自定义软键盘。借助这一功能，开发者能够实现对软键盘的灵活管理。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/gS5eIao2QpmEXLSknf5Vow/zh-cn_image_0000002592378556.png?HW-CC-KV=V1&HW-CC-Date=20260611T063526Z&HW-CC-Expire=86400&HW-CC-Sign=17D05146A71E5E74E568A3582C99D12E0CB93AAB8FCE803CDFE11D5F1A033181)

**图5** ArkWeb自定义键盘字母键盘

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/5wuO-A5HSrutqEgMf_WrOA/zh-cn_image_0000002622858063.png?HW-CC-KV=V1&HW-CC-Date=20260611T063526Z&HW-CC-Expire=86400&HW-CC-Sign=2DF661252803C11CA2027FB5CF8B833FAFEB7D5552D5B1A78C7C0DB2ECE15E5A)

**图6** ArkWeb自定义键盘符号键盘

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/VhE_1Z-sR1KIQQ6RB88f_A/zh-cn_image_0000002622698185.png?HW-CC-KV=V1&HW-CC-Date=20260611T063526Z&HW-CC-Expire=86400&HW-CC-Sign=45D874878DDB3E3184CC745150013FBF3A4CE3B98DCFCCD813BC16FB492ABDF1)
