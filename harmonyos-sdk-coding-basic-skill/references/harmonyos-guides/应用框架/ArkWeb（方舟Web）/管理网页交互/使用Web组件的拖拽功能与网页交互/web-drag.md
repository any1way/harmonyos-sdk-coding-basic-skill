...
scraped_at: 2026-06-11T14:35:34+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:a70583dbeba0acb79ca8cf3ce4d7cc81e089ecb493525dbcb6e174ac51a061a8
---
...
| 监听方法 | 说明 |
| --- | --- |
| [onDragStart](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart) | 不建议使用此方法，否则会影响Web组件的拖拽行为，造成拖拽逻辑不符合预期，如无法触发H5拖拽事件监听，预览图无法创建或预览图错误，拖拽数据无法预置等。 |
| [onDragEnter](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragenter) | 拖拽的元素进入Web区域。 |
| [onDragMove](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragmove) | 拖拽的元素在Web区域移动。 |
| [onDragLeave](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragleave) | 拖拽的元素离开Web区域。 |
| [onDrop](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop15) | 拖拽的元素落入Web区域。 |
| [onDragEnd](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragend10) | 由Web发起的拖拽元素结束拖拽。 |

## 在ArkTS侧实现拖拽相关逻辑

在多数情况下，应用在H5端实现的拖拽功能能够满足需求。如有需要，请参考以下案例，实现在ArkTS端进行拖拽数据读取等操作。

1. [建立应用侧与前端页面数据通道](../../在应用中使用前端页面JavaScript/建立应用侧与前端页面数据通道/web-app-page-data-channel.md)。
...
[DragArkTSPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/WebDragInteraction/entry/src/main/ets/pages/DragArkTSPage.ets#L15-L68)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/6RiTiSHgR12Y4OiQYOuyig/zh-cn_image_0000002592218628.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063532Z&HW-CC-Expire=86400&HW-CC-Sign=4558CB7805EEA1CAACB96FA9FF7DB57ACA40A68FEE2B9E0653DEC5C902CB74F4)

日志打印：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/3pw-U5wjRYqsI6SHK7trKw/zh-cn_image_0000002592378562.png?HW-CC-KV=V1&HW-CC-Date=20260611T063532Z&HW-CC-Expire=86400&HW-CC-Sign=B1CAD44C0DB17611E0CF65901F8F3C0B4058515FA984B03CFF1B45E56C5EF9EA)
...
[SetUAPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/WebDragInteraction/entry/src/main/ets/pages/SetUAPage.ets#L15-L35)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/-AiMwrlTRAu8kA8oFndlxg/zh-cn_image_0000002622858069.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063532Z&HW-CC-Expire=86400&HW-CC-Sign=079BAF4BE87AE12E2FFFCEE182F72F5CE7EC046A6B412691B46EFED2E56A5B92)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/qKrSzv_MTMaCcdrzIoIEdQ/zh-cn_image_0000002622698191.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063532Z&HW-CC-Expire=86400&HW-CC-Sign=C73F40334290618492B9E6B1616B317DB18FFE007F1050BE7AA425D0F3E02152)
...
[ForbidDragPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/WebDragInteraction/entry/src/main/ets/pages/ForbidDragPage.ets#L15-L63)
