...
scraped_at: 2026-06-11T14:35:54+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:d2afdf2b238023a40e89b28136dcbb4287f0efddb0e00f06eaa637ad88880d3e
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/w2uJVlJiQFGMPUZrwUPKQg/zh-cn_image_0000002622698197.png?HW-CC-KV=V1&HW-CC-Date=20260611T063552Z&HW-CC-Expire=86400&HW-CC-Sign=A9D3ADF075815B45ABB2542BE81CA3F5C726042F27933B651539B98E2471AA8A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/srSufls2RbK-zVNIe1ShiA/zh-cn_image_0000002592218636.png?HW-CC-KV=V1&HW-CC-Date=20260611T063552Z&HW-CC-Expire=86400&HW-CC-Sign=6C99C191603B86D794163943B6666D621C77D2B5189D960F8CE476CB17DA4EF7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/7waeWI56Tcu5SSQOJIh71w/zh-cn_image_0000002592378570.png?HW-CC-KV=V1&HW-CC-Date=20260611T063552Z&HW-CC-Expire=86400&HW-CC-Sign=51ED8D7C903FD5F77C5CB0D5BAB2C605C354CDED39D6FC8CED5A3E08173865F8)
...
需要先通过[enableNativeMediaPlayer](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#enablenativemediaplayer12>)接口开启接管网页媒体播放的功能。
...
该功能开启后，网页中有媒体需要播放时，ArkWeb内核会触发[onCreateNativeMediaPlayer](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#oncreatenativemediaplayer12>)注册的回调函数。
...
本地播放器需要实现[NativeMediaPlayerBridge](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Interface (NativeMediaPlayerBridge)/arkts-apis-webview-nativemediaplayerbridge.md>)接口，以便ArkWeb内核对本地播放器进行播控操作。
...
该流程与[同层渲染](../../同层渲染/web-same-layer.md)绘制一致。

1. 在应用启动阶段，应用应保存[UIContext](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)，以便后续的同层渲染绘制流程能够使用该UIContext。
   ...
   [Entry2Ability.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/UsingWebMultimedia/entry2/src/main/ets/entry2ability/Entry2Ability.ets#L18-L63)
...
动态创建组件并绘制到Surface上的详细介绍见[同层渲染](../../同层渲染/web-same-layer.md)。

### 执行ArkWeb内核发送给本地播放器的播控命令

为了方便ArkWeb内核对本地播放器进行播控操作，应用需要令本地播放器实现[NativeMediaPlayerBridge](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Interface (NativeMediaPlayerBridge)/arkts-apis-webview-nativemediaplayerbridge.md>)接口，并根据每个接口方法的功能对本地播放器进行相应操作。
...
在[onCreateNativeMediaPlayer](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#oncreatenativemediaplayer12>)接口中， ArkWeb内核传递一个[NativeMediaPlayerHandler](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Interface (NativeMediaPlayerHandler)/arkts-apis-webview-nativemediaplayerhandler.md>)对象给应用。应用需要通过该对象，将本地播放器的最新状态信息通知给ArkWeb内核。
...
* 涉及网页媒体播放，需在配置文件中配置网络访问权限。添加方法请参考[在配置文件中声明权限](../../../../系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md#在配置文件中声明权限)。
  ...
  6. ]
  ```
* 在应用启动阶段保存[UIContext](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)。
  ...
  24. }
  ```
* 应用侧代码，视频托管使用示例。通过[AVPlayer](<../../../../媒体/Media Kit（媒体服务）/Media Kit简介/media-kit-intro.md#avplayer>)托管Web媒体的播放。
...
* 应用侧代码，视频播放示例, ./PlayerDemo.ets。
  ...
  265. }
  ```
* 前端页面示例。通过[AVPlayer](<../../../../媒体/Media Kit（媒体服务）/Media Kit简介/media-kit-intro.md#avplayer>)托管Web媒体的播放，支持的媒体资源可以参考AVPlayer[支持的格式与协议](<../../../../媒体/Media Kit（媒体服务）/Media Kit简介/media-kit-intro.md#支持的格式与协议>)。
