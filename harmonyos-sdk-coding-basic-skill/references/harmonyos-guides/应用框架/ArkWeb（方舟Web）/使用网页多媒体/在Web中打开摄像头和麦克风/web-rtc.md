...
scraped_at: 2026-06-01T11:09:57+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:ebb71260055293b98583db6ea85daa4d75c921bdc806953757ecb525cc5e6b5c
---
...
Web组件可以通过W3C标准协议接口访问摄像头和麦克风，通过[onPermissionRequest](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#onpermissionrequest9>)接口接收权限请求通知，需在配置文件中声明相应的音视频权限。

* 使用摄像头和麦克风功能前请在module.json5中添加音视频相关权限，权限的添加方法请参考[在配置文件中声明权限](../../../../系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md#在配置文件中声明权限)。
...
* 应用侧代码。
  ...
  [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/UsingWebMultimedia/entry/src/main/ets/pages/Index.ets#L15-L70)
* 前端界面index.html代码。
