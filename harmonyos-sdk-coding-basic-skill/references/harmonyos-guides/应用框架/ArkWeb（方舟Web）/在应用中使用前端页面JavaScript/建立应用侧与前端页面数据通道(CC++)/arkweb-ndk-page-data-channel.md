...
scraped_at: 2026-06-11T14:35:23+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:20deaa46d49f2e61f7831d8e53498e5ad8e6d3918465c1ba91760e0f81660875
---
...
应用使用ArkTS、C++语言混合开发，或本身应用架构较贴近于小程序架构，自带C++侧环境，推荐使用ArkWeb在Native侧提供的[ArkWeb\_ControllerAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md>)、[ArkWeb\_WebMessageAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_WebMessageAPI/capi-web-arkweb-webmessageapi.md>)、[ArkWeb\_WebMessagePortAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_WebMessagePortAPI/capi-web-arkweb-webmessageportapi.md>)实现PostWebMessage功能。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/H_Xo2srnQR-T0xH2gFtRVQ/zh-cn_image_0000002592218618.png?HW-CC-KV=V1&HW-CC-Date=20260611T063521Z&HW-CC-Expire=86400&HW-CC-Sign=A798B7278843C7F9DD5E4165AC209C6D8DA309F89A2A73794C37AD6C9F4BD9D0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/qroM1T6qQLSuPdx2f_OATA/zh-cn_image_0000002622858059.png?HW-CC-KV=V1&HW-CC-Date=20260611T063521Z&HW-CC-Expire=86400&HW-CC-Sign=6FE81935359BB5E1DFD63479D981753CFB71A9293603CCBAD6C8B9D68674E397)
...
在调用API前建议通过[ARKWEB\_MEMBER\_MISSING](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/头文件/arkweb_type.h/capi-arkweb-type-h.md#宏定义>)校验该函数结构体是否有对应函数指针，避免SDK与设备ROM不匹配导致crash问题。[createWebMessagePorts](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md#createwebmessageports>)、[postWebMessage](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md#postwebmessage>)、[close](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_WebMessagePortAPI/capi-web-arkweb-webmessageportapi.md#close>)需运行在UI线程。
...
* ArkTS侧代码
  ...
  [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/UseFrontendJSApp/entry5/src/main/ets/pages/Index.ets#L16-L274)
* Node-API侧暴露ArkTS接口
  ...
  [Index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/UseFrontendJSApp/entry5/src/main/cpp/types/libentry5/Index.d.ts#L16-L29)
* Node-API侧编译配置
...
* Node-API层代码
  ...
  [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/UseFrontendJSApp/entry5/src/main/cpp/hello.cpp#L16-L474)
