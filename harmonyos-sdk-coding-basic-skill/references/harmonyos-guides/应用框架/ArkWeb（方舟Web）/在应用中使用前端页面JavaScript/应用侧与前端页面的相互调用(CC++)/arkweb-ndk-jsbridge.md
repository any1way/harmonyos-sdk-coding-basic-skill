...
scraped_at: 2026-06-11T14:35:22+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:9408cfb88bffbfd534f98962e15adef8da4f607dbe306a9b9ba41943f2c01d0a
---
本指导适用于ArkWeb应用侧与前端网页通信场景，开发者可根据应用架构选择使用ArkWeb Native接口完成业务通信机制（以下简称Native JSBridge）。

针对JSBridge进行性能优化可参考[JSBridge优化解决方案](../../../../../best-practices/性能/性能场景优化案例/Web性能优化/Web加载性能优化/bpta-web-develop-optimization.md#section58781855115017)

## 适用的应用架构

应用使用ArkTS、C++语言混合开发，或本身应用架构较贴近于小程序架构，自带C++侧环境，推荐使用ArkWeb在Native侧提供的[ArkWeb\_ControllerAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md>)、[ArkWeb\_ComponentAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ComponentAPI/capi-web-arkweb-componentapi.md>)实现JSBridge功能。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/6SZCK8EGSdu3G-bnw-dEpQ/zh-cn_image_0000002592218618.png?HW-CC-KV=V1&HW-CC-Date=20260611T063520Z&HW-CC-Expire=86400&HW-CC-Sign=1FD74ADA08901A01638567E9FBF4DFA6E0CC49CB8D992738F644038AA3D75481)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/-AGwj0UfTQ6jWD64HcLjog/zh-cn_image_0000002592378552.png?HW-CC-KV=V1&HW-CC-Date=20260611T063520Z&HW-CC-Expire=86400&HW-CC-Sign=D8388DA51BA35868366DA0931CC4A8C26C6530B4965346EE05F03493F50BB330)
...
另外针对同步接口[registerJavaScriptProxyEx](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md#registerjavascriptproxyex>)和异步接口[registerAsyncJavaScriptProxyEx](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md#registerasyncjavascriptproxyex>)，新增了参数[permission](arkweb-ndk-jsbridge.md#前端页面调用应用侧函数)字段，用于调用权限控制。
...
* ArkTS侧
  ...
  [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/UseFrontendJSApp/entry4/src/main/ets/pages/Index.ets#L39-L52)
* C++侧
  ...
  [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/UseFrontendJSApp/entry4/src/main/cpp/hello.cpp#L247-L296)

### 使用Native接口获取API结构体

在ArkWeb Native侧，需要先获取API结构体，才能调用结构体里的Native API。ArkWeb Native侧API通过函数[OH\_ArkWeb\_GetNativeAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/头文件/arkweb_interface.h/capi-arkweb-interface-h.md#oh_arkweb_getnativeapi>)获取，根据入参type不同，可分别获取[ArkWeb\_ControllerAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md>)、[ArkWeb\_ComponentAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ComponentAPI/capi-web-arkweb-componentapi.md>)结构体。其中，[ArkWeb\_ControllerAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md>)对应ArkTS侧[web\_webview.WebviewController API](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md>)，[ArkWeb\_ComponentAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ComponentAPI/capi-web-arkweb-componentapi.md>)对应ArkTS侧[ArkWeb组件API](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/组件描述/arkts-basic-components-web.md>)。
...
通过[ArkWeb\_ComponentAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ComponentAPI/capi-web-arkweb-componentapi.md>)注册组件生命周期回调，调用接口前，建议通过[ARKWEB\_MEMBER\_MISSING](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/头文件/arkweb_type.h/capi-arkweb-type-h.md#宏定义>)校验该函数结构体中是否存在对应函数指针，以避免SDK与设备ROM不匹配导致crash问题。
...
[hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/UseFrontendJSApp/entry4/src/main/cpp/hello.cpp#L219-L244)

### 前端页面调用应用侧函数

通过[registerJavaScriptProxyEx](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md#registerjavascriptproxyex>)将应用侧函数注册至前端页面，注册后在下次加载或者重新加载后生效。
...
[hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/UseFrontendJSApp/entry4/src/main/cpp/hello.cpp#L135-L149)
...
使用[runJavaScript](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md#runjavascript>)调用前端页面函数。
...
* Node-API侧暴露ArkTS接口
  ...
  [Index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/UseFrontendJSApp/entry4/src/main/cpp/types/libentry4/Index.d.ts#L16-L20)
...
ArkWeb Native侧需要先获取API结构体，才能调用结构体里的Native API。ArkWeb Native侧API通过函数[OH\_ArkWeb\_GetNativeAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/头文件/arkweb_interface.h/capi-arkweb-interface-h.md#oh_arkweb_getnativeapi>)获取，根据入参type不同，可分别获取[ArkWeb\_ControllerAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md>)、[ArkWeb\_ComponentAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ComponentAPI/capi-web-arkweb-componentapi.md>)函数指针结构体。其中，[ArkWeb\_ControllerAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md>)对应ArkTS侧[web\_webview.WebviewController API](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md>)，[ArkWeb\_ComponentAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ComponentAPI/capi-web-arkweb-componentapi.md>)对应ArkTS侧[ArkWeb组件API](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/组件描述/arkts-basic-components-web.md>)。
...
通过[ArkWeb\_ComponentAPI](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ComponentAPI/capi-web-arkweb-componentapi.md>)注册组件生命周期回调，在调用接口前建议通过[ARKWEB\_MEMBER\_MISSING](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/头文件/arkweb_type.h/capi-arkweb-type-h.md#宏定义>)校验该函数结构体是否有对应函数指针，避免SDK与设备ROM不匹配导致crash问题。
...
通过[registerJavaScriptProxy](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md#registerjavascriptproxy>)将应用侧函数注册至前端页面，注册后在下次加载或者重新加载后生效。
...
通过[runJavaScript](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md#runjavascript>)调用前端页面函数。
