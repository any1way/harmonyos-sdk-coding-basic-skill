...
scraped_at: 2026-06-01T11:09:48+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:c71e8dd8a9ac2df24d79aa2181757db1748bb80c6a8fe0b06338caf34d1018e4
---
应用可以通过[onInterceptRequest](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#oninterceptrequest9>)拦截Web组件发起的网络请求，也可以通过SchemeHandler来拦截Web组件发起的网络请求。SchemeHandler提供了ArkTS与NDK两套接口。
...
通过onInterceptRequest接口拦截Web组件发起的网络请求可参考[自定义页面请求响应](../自定义页面请求响应/web-resource-interception-request-mgmt.md)。
...
NDK：[ArkWeb\_OnRequestStart](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/头文件/arkweb_scheme_handler.h/capi-arkweb-scheme-handler-h.md#arkweb_onrequeststart>)

ArkTS：[onRequestStart](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebSchemeHandler)/arkts-apis-webview-webschemehandler.md#onrequeststart12>)

请求结束的回调：

NDK：[ArkWeb\_OnRequestStop](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/头文件/arkweb_scheme_handler.h/capi-arkweb-scheme-handler-h.md#arkweb_onrequeststop>)

ArkTS：[onRequestStop](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebSchemeHandler)/arkts-apis-webview-webschemehandler.md#onrequeststop12>)

注意

* 需要在Web组件初始化之后设置SchemeHandler，否则会设置失败。
* 若想要拦截Web组件发出的第一个请求，可以通过[initializeWebEngine](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#initializewebengine>)方法提前进行Web组件初始化，再设置SchemeHandler实现拦截。详细代码请参考[完整示例](web-scheme-handler.md#完整示例)。
...
在NDK中可以在ets侧先调用testNapi.registerCustomSchemes注册自定义协议，然后调用[initializeWebEngine](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#initializewebengine>)初始化Web内核，示例如下：
...
[EntryAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebSchemeHandler/entry/src/main/ets/entryability/EntryAbility.ets#L22-L59)
...
[hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebSchemeHandler/entry/src/main/cpp/hello.cpp#L19-L28)
...
NDK：[网络错误码(arkweb\_net\_error\_list.h)](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/头文件/arkweb_net_error_list.h/capi-arkweb-net-error-list-h.md>)。

ArkTS：[网络错误码(@ohos.web.netErrorList.d.ts)](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.netErrorList (ArkWeb网络协议栈错误列表)/arkts-apis-neterrorlist.md>)。
...
当希望通过[OH\_ArkWebResourceHandler\_DidFailWithError](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/头文件/arkweb_scheme_handler.h/capi-arkweb-scheme-handler-h.md#oh_arkwebresourcehandler_didfailwitherror>)或者[didFail(code: WebNetErrorList)](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebResourceHandler)/arkts-apis-webview-webresourcehandler.md#didfail12>)结束当前请求时，需要在调用该接口之前通过[OH\_ArkWebResourceHandler\_DidReceiveResponse](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/头文件/arkweb_scheme_handler.h/capi-arkweb-scheme-handler-h.md#oh_arkwebresourcehandler_didreceiveresponse>)或者[didReceiveResponse](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebResourceHandler)/arkts-apis-webview-webresourcehandler.md#didreceiveresponse12>)返回给Web内核一个响应头，否则无法结束请求。

从API version 20开始，可以直接通过[OH\_ArkWebResourceHandler\_DidFailWithErrorV2](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/头文件/arkweb_scheme_handler.h/capi-arkweb-scheme-handler-h.md#oh_arkwebresourcehandler_didfailwitherrorv2>)或者[didFail(code: WebNetErrorList, completeIfNoResponse: boolean)](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebResourceHandler)/arkts-apis-webview-webresourcehandler.md#didfail20>)结束网络请求，不再依赖必须通过[OH\_ArkWebResourceHandler\_DidReceiveResponse](<../../../../../harmonyos-references/ArkWeb（方舟Web）/C API/头文件/arkweb_scheme_handler.h/capi-arkweb-scheme-handler-h.md#oh_arkwebresourcehandler_didreceiveresponse>)或者[didReceiveResponse](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebResourceHandler)/arkts-apis-webview-webresourcehandler.md#didreceiveresponse12>)返回给Web内核一个响应头。
