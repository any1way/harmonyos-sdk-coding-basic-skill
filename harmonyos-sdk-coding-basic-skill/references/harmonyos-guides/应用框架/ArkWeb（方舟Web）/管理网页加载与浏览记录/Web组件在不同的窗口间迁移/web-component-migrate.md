...
scraped_at: 2026-06-11T14:35:48+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:c06d72a86f7821386cfd8567567f77c7bbeb5244ad4c39fb1dc0264bfdd6d76b
---
Web组件能够实现在不同窗口的组件树上进行挂载或移除操作，这一能力使得开发者可以将同一个Web组件在不同窗口间迁移。例如，将浏览器的Tab页拖出成独立窗口，或拖入浏览器的另一个窗口。

Web组件在不同窗口间迁移，是基于[自定义节点](<../../../ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义节点概述/arkts-user-defined-node.md>)能力实现的。实现的基本原理是：通过[BuilderNode](<../../../ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md>)，开发者可创建Web组件的离线节点，并结合[自定义占位节点](<../../../ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义占位节点/arkts-user-defined-place-holder.md>)控制Web节点的挂载与移除。当从一个窗口上移除Web节点，并挂载到另一个窗口中，即完成Web组件在窗口间的迁移。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/6_Y93LrRTbKEs1ikbaVRgQ/zh-cn_image_0000002592378566.png?HW-CC-KV=V1&HW-CC-Date=20260611T063547Z&HW-CC-Expire=86400&HW-CC-Sign=B790156284517611F70BDDA475F5D5253D78E1532C9220128F63E0BB4FEF68D0)
...
[Entry3Ability.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ManageWebPageLoadBrowse/NetReqInterceptCacheWinOps/entry3/src/main/ets/entry3ability/Entry3Ability.ets#L19-L49)
...
[common.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ManageWebPageLoadBrowse/NetReqInterceptCacheWinOps/entry3/src/main/ets/pages/common.ets#L16-L118)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ManageWebPageLoadBrowse/NetReqInterceptCacheWinOps/entry3/src/main/ets/pages/Index.ets#L16-L52)
