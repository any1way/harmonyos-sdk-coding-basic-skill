...
scraped_at: 2026-06-11T14:36:04+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:e8806f4872a3475aebabbe063af86a10e446b682f248e0844c2ed6306dcdbc27
---
...
Web组件的文本选中菜单是一种通过自定义元素实现的上下文交互组件，当用户选中文本时会动态显示，提供复制、分享、标注等语义化操作，具备标准化功能与良好可扩展性，是移动端文本操作的核心功能之一。文本选中菜单在用户长按选中文本或编辑状态下长按出现单手柄时弹出，菜单项横向排列。系统提供默认的菜单实现。应用可通过[editMenuOptions](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#editmenuoptions12>)接口对文本选中菜单进行自定义操作。

1. 通过onCreateMenu方法自定义菜单项，通过操作Array<[TextMenuItem](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#textmenuitem12对象说明)>数组可对显示菜单项进行增减操作，在[TextMenuItem](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#textmenuitem12对象说明)中定义菜单项名称、图标、ID等内容。
2. 通过onMenuItemClick方法处理菜单项点击事件，当返回false时会执行系统默认逻辑。
3. 创建一个[EditMenuOptions](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#editmenuoptions)对象，包含onCreateMenu和onMenuItemClick两个方法，通过Web组件的[editMenuOptions](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#editmenuoptions12>)接口与Web组件绑定。
...
33. items.push(customItem1); // 重复添加选项，以便支持显示更多菜单
34. }
35. return items;
36. }
...
40. // 用户自定义行为
41. console.info('intercept id：CUT')
42. return true; // 返回true不执行系统回调
43. } else if (menuItem.id.equals(TextMenuItemId.COPY)) {
44. // 用户自定义行为
45. console.info('Do not intercept id：COPY')
46. return false; // 返回false执行系统回调
47. } else if (menuItem.id.equals(TextMenuItemId.of('customItem1'))) {
48. // 用户自定义行为
49. console.info('intercept id：customItem1')
50. return true; // 用户自定义菜单选项返回true时点击后不关闭菜单，返回false时关闭菜单
51. } else if (menuItem.id.equals(TextMenuItemId.of('customItem2'))) {
52. // 用户自定义行为
53. console.info('intercept id：customItem2')
54. return true;
55. }
56. return false; // 返回默认值false
57. }

59. @State editMenuOptions: EditMenuOptions = { onCreateMenu: this.onCreateMenu, onMenuItemClick: this.onMenuItemClick }

61. build() {
62. Column() {
63. Web({ src: $rawfile('index.html'), controller: this.controller })
64. .editMenuOptions(this.editMenuOptions)
65. }
66. }
67. }
```

[WebTextMenuItem.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebMenu/entry/src/main/ets/pages/WebTextMenuItem.ets#L15-L84)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/j5x7y4XuQKmAOE3QwEoK9w/zh-cn_image_0000002592378574.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063602Z&HW-CC-Expire=86400&HW-CC-Sign=1B2AF595275B53DB03DCDCF34F8E4F0CB111DD8171A77B864379F071C2EC6625)

## 上下文菜单

上下文菜单是用户通过特定操作（如右键点击或长按富文本）触发的快捷菜单，用于提供与当前操作对象或界面元素相关的功能选项。菜单项纵向排列。系统未提供默认实现，若应用未实现，则不显示上下文菜单。应用需要创建一个[Menu](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/菜单/Menu/ts-basic-components-menu.md)组件并与Web组件绑定，在菜单弹出时可通过Web组件的[onContextMenuShow](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#oncontextmenushow9>)回调接口获取上下文菜单的详细信息，包括点击位置的HTML元素信息及点击位置信息。

1. [Menu](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/菜单/Menu/ts-basic-components-menu.md)组件作为弹出的菜单，包含所有菜单项行为与样式。
2. 使用bindPopup方法将Menu组件与Web组件绑定。当上下文菜单弹出时，将显示创建的Menu组件。
3. 在onContextMenuShow回调中获取上下文菜单事件信息[onContextMenuShowEvent](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Interfaces（其他）/arkts-basic-components-web-i.md#oncontextmenushowevent12>)。其中param为[WebContextMenuParam](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Class (WebContextMenuParam)/arkts-basic-components-web-webcontextmenuparam.md>)类型，包含点击位置对应HTML元素信息和位置信息，result为[WebContextMenuResult](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Class (WebContextMenuResult)/arkts-basic-components-web-webcontextmenuresult.md>)类型，提供常见的菜单能力。
...
[WebContextMenu.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebMenu/entry/src/main/ets/pages/WebContextMenu.ets#L15-L137)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/E2AvB_J1SyWStpi9MrqsuA/zh-cn_image_0000002622858081.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063602Z&HW-CC-Expire=86400&HW-CC-Sign=1B2A05F05D1F811097C74D03A5692D6E4C3BB5BC2ACB3DE66C34F1D36CB45C54)

## 自定义菜单

自定义菜单赋予开发者灵活控制菜单触发时机与视觉呈现的能力，使应用能够根据用户操作场景动态匹配功能入口，显著简化开发过程中的界面适配工作，同时让交互体验更贴近用户直觉。

开发者可通过[bindSelectionMenu](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#bindselectionmenu13>)接口实现自定义菜单功能。目前，已额外支持通过长按图片、链接和文本，触发自定义菜单及自定义文本菜单。

1. 创建[Menu](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/菜单/Menu/ts-basic-components-menu.md)组件作为菜单弹窗。
2. 通过Web组件的[bindSelectionMenu](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#bindselectionmenu13>)方法绑定MenuBuilder菜单弹窗。将[WebElementType](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Enums/arkts-basic-components-web-e.md#webelementtype13>)设置为WebElementType.IMAGE，[responseType](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Enums/arkts-basic-components-web-e.md#webresponsetype13>)设置为WebResponseType.LONG\_PRESS，表示长按图片时弹出菜单。在[options](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Interfaces（其他）/arkts-basic-components-web-i.md#selectionmenuoptionsext13>)中定义菜单显示回调onAppear、菜单消失回调onDisappear、预览窗口preview和菜单类型menuType。
...
[WebBindSelectionMenu.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebMenu/entry/src/main/ets/pages/WebBindSelectionMenu.ets#L15-L94)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/IHXkAuo8QvS0tWdPiNskJg/zh-cn_image_0000002622698203.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063602Z&HW-CC-Expire=86400&HW-CC-Sign=FAB6723F89F222421CF502C37908EDDC73A767528886659A1EE64BDDD6088B27)

自API version 20起，支持绑定长按超链接菜单。可以为图片和链接绑定不同的自定义菜单。

以下示例中，PreviewBuilder定义了超链接对应菜单的弹出内容，用Web组件加载了超链接内容（需要注意PreviewBuilder中的Web组件不会接收事件），使用[Progress组件](<../../../ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加组件/进度条 (Progress)/arkts-common-components-progress-indicator.md>)展示了加载进度。
...
[WebPreviewBuilder.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebMenu/entry/src/main/ets/pages/WebPreviewBuilder.ets#L15-L184)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/NxHCiJhaRWicqRaZPuvYWw/zh-cn_image_0000002592218642.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063602Z&HW-CC-Expire=86400&HW-CC-Sign=67399CB714623751B53FFA226B45AA4AA9E417DB1E981005A7AC2C2E7BEAC367)

## Web菜单保存图片

1. 创建MenuBuilder组件作为菜单弹窗，使用[SaveButton](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/SaveButton/ts-security-components-savebutton.md)组件实现图片保存，通过bindContextMenu将MenuBuilder与Web绑定。
...
[WebSaveImage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebMenu/entry/src/main/ets/pages/WebSaveImage.ets#L15-L140)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/pxbtXqrdQiqMi9rZQ6pqAg/zh-cn_image_0000002592378576.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063602Z&HW-CC-Expire=86400&HW-CC-Sign=970B57544BDE5A49FBEE18ABF33744D1F9D4945D0109FAAA8CAD552C766E28D8)

## Web菜单获取选中文本

Web组件的[editMenuOptions](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#editmenuoptions12>)接口中没有提供获取选中文本的方式。开发者可通过[javaScriptProxy](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#javascriptproxy>)获取到JavaScript的选中文本，实现自定义菜单的逻辑。

1. 创建SelectClass类，通过[javaScriptProxy](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#javascriptproxy>)将SelectClass对象注册到Web组件中。
...
[WebEditMenuOptions.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebMenu/entry/src/main/ets/pages/WebEditMenuOptions.ets#L15-L57)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/ejFhQhYWQSSeNj9YJ4gibw/zh-cn_image_0000002622858083.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063602Z&HW-CC-Expire=86400&HW-CC-Sign=F1B036104232053D62F518ED619196379434241BBDB465E9E05720B59F8C76CF)

## 常见问题

### 如何禁用长按选择时弹出菜单

可通过[editMenuOptions](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#editmenuoptions12>)接口将系统默认菜单全部过滤，此时无菜单项，则不会显示菜单。
...
[WebDisableLongPress.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebMenu/entry/src/main/ets/pages/WebDisableLongPress.ets#L15-L44)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/ruTlrDCnS3-Yr3XWmmS0gQ/zh-cn_image_0000002622698205.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063602Z&HW-CC-Expire=86400&HW-CC-Sign=C64AA47572D28A8F84BFF4D7AF06FBBFFF0C9221E855424B3C8E1E4204D61F45)
...
从API version 21开始，应用可通过[bindSelectionMenu](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#bindselectionmenu13>)接口，实现自定义文本选中菜单。
...
[WebBindSelectionMenuText.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebMenu/entry/src/main/ets/pages/WebBindSelectionMenuText.ets#L15-L96)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/9WmQzSdJTSiodrlfReDwfw/zh-cn_image_0000002592218644.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063602Z&HW-CC-Expire=86400&HW-CC-Sign=86E3DF465AEB33D2E65509F1B3C9ED733A5B74C275307EBB72D23C6F01481BA2)
