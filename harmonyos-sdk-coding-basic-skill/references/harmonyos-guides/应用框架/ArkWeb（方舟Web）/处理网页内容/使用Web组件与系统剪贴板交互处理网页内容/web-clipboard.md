...
content_hash: sha256:dd6a6dd937353ecc98b3935954c1367b38a3d5eaaa7087952a0fb301dd57fcb8
---
开发者能够通过Web组件和系统剪贴板进行交互，实现各种类型数据的复制和粘贴。支持通过[菜单](../使用Web组件菜单处理网页内容/web-menu.md)、键盘快捷键以及[W3C剪贴板接口](https://www.w3.org/TR/clipboard-apis/)对网页内容执行剪切、复制和粘贴操作。

## 通过菜单或键盘快捷键与系统剪贴板交互

开发者能够自定义菜单中的功能选项，当用户选择特定选项时，开发者可以通过调用[cut](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Class (WebContextMenuResult)/arkts-basic-components-web-webcontextmenuresult.md#cut9>)、[copy](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Class (WebContextMenuResult)/arkts-basic-components-web-webcontextmenuresult.md#copy9>)、[copyImage](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Class (WebContextMenuResult)/arkts-basic-components-web-webcontextmenuresult.md#copyimage9>)、[paste](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Class (WebContextMenuResult)/arkts-basic-components-web-webcontextmenuresult.md#paste9>)、[pasteAndMatchStyle](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Class (WebContextMenuResult)/arkts-basic-components-web-webcontextmenuresult.md#pasteandmatchstyle20>)等接口，将网页中的文本、HTML或图片数据复制到系统剪贴板，或从系统剪贴板粘贴到网页的可输入区域。

菜单功能接口的使用可参考[使用Web组件菜单处理网页内容](../使用Web组件菜单处理网页内容/web-menu.md)。

当设备有物理键盘时，用户也能够通过键盘快捷键：CTRL + X（剪切）、CTRL + C（复制）、CTRL + V（粘贴），与剪贴板进行交互。

说明

通过[paste](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Class (WebContextMenuResult)/arkts-basic-components-web-webcontextmenuresult.md#paste9>)、[pasteAndMatchStyle](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/Class (WebContextMenuResult)/arkts-basic-components-web-webcontextmenuresult.md#pasteandmatchstyle20>)接口读取系统剪贴板数据，需[申请访问剪贴板权限](<../../../../系统/基础功能/Basic Services Kit（基础服务）/剪贴板服务/申请访问剪贴板权限/get-pastedata-permission-guidelines.md>)：ohos.permission.READ\_PASTEBOARD。
...
通过异步剪贴板接口read()和readText()方法读取系统剪贴板数据，需[申请访问剪贴板权限](<../../../../系统/基础功能/Basic Services Kit（基础服务）/剪贴板服务/申请访问剪贴板权限/get-pastedata-permission-guidelines.md>)：ohos.permission.READ\_PASTEBOARD。
...
[WebClipboard.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebClipboard/entry/src/main/ets/pages/WebClipboard.ets#L16-L30)
...
**需要权限**：ohos.permission.READ\_PASTEBOARD，应用访问剪贴板内容需[申请访问剪贴板权限](<../../../../系统/基础功能/Basic Services Kit（基础服务）/剪贴板服务/申请访问剪贴板权限/get-pastedata-permission-guidelines.md>)。
...
[module.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebClipboard/entry/src/main/module.json5#L16-L81)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/e8ostURUQ2CINxnVMW1DQw/zh-cn_image_0000002592378578.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063602Z&HW-CC-Expire=86400&HW-CC-Sign=393707117E86F305F40F34C04193C4FFBA19D5DCDEAC4C98EDC9534EF6DDD68C)
...
[WebClipboardEvent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebClipboard/entry/src/main/ets/pages/WebClipboardEvent.ets#L16-L30)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/nbL_GgFLSleuRWQnsbMwrw/zh-cn_image_0000002622858085.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063602Z&HW-CC-Expire=86400&HW-CC-Sign=01FDCD9D5576DE74DF72D10C24BB8961CEA4A51FD4B2A1724D1366DA845D4C32)

## 设置剪贴板复制范围选项

开发者可以通过设置Web组件的[copyOptions](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#copyoptions11>)属性，来指定Web组件上剪贴板复制的范围。可以指定的选项有：CopyOptions.None（不支持复制）、CopyOptions.InApp（支持应用内复制）以及CopyOptions.LocalDevice（支持设备内复制）。默认值为：CopyOptions.LocalDevice，即默认支持设备内部的复制。
...
[WebCopyOptions.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebClipboard/entry/src/main/ets/pages/WebCopyOptions.ets#L16-L32)
