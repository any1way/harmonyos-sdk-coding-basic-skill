...
scraped_at: 2026-06-11T14:36:14+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:4df540ee24f2c8f8dc3718e1f13165be9e79d06e8578a6a7ef8a5b3f2efba195
---
Web组件支持使用DevTools工具调试前端页面。DevTools是Web前端开发调试工具，支持在电脑上调试移动设备前端页面。开发者通过[setWebDebuggingAccess()](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#setwebdebuggingaccess>)接口开启Web组件前端页面调试能力，使用DevTools在电脑上调试移动前端网页，设备需为4.1.0及以上版本。

## 无线调试

从API version 20开始，可使用无线调试接口[setWebDebuggingAccess20+](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#setwebdebuggingaccess20>)，来简化调试流程。
...
1. 在应用代码中开启Web调试开关，应用需要调用[setWebDebuggingAccess20+](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#setwebdebuggingaccess20>)接口，设置TCP Socket端口号并启用Web调试功能。
   ...
   [WebDebuggingWithWiFi.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebDebuggingWithDevtools/entry/src/main/ets/pages/WebDebuggingWithWiFi.ets#L15-L40)

   说明

   代码中使用的8888端口仅作为示例展示，开发者使用过程中，应保证端口号可以被应用使用。如果因为端口被占用或者应用无权限使用等因素导致端口无法被应用使用，会导致接口抛出异常或者ArkWeb无法开启调试模式。
2. 开启调试功能需要在DevEco Studio应用工程hap模块的module.json5文件中增加如下权限，添加方法请参考[在配置文件中声明权限](../../../../系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md#在配置文件中声明权限)。
   ...
   [module.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebDebuggingWithDevtools/entry/src/main/module.json5#L63-L69)
...
2. 修改Chrome调试工具的配置。
   ...
   (2) 在 "Target discovery settings" 中添加被调试设备的IP地址和[setWebDebuggingAccess20+](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#setwebdebuggingaccess20>)接口中指定的port端口，比如：192.168.0.3:8888。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/tuXogVOXSWeJ-HToVMZjAQ/zh-cn_image_0000002622698215.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=D2B4ED62C2FDB7DDCF5DD4C981B03371BC48C9C2C8285793AFAAEE0374885721)

### 开始网页调试

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/UjQ8pD3oQ966QAwu_t4rMQ/zh-cn_image_0000002592218654.png?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=BFC5593F41504FB5AB8BE21613C4B2E2E3116D377143A7B0CB8F74D6C9488D74)

## USB连接调试

### 应用代码开启Web调试开关

调试网页前，需要应用侧代码调用[setWebDebuggingAccess()](<../../../../../harmonyos-references/ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#setwebdebuggingaccess>)接口开启Web调试开关。
...
1. 在应用代码中开启Web调试开关，具体如下：
   ...
   [WebDebuggingWithUSB.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkWeb/ArkWebDebuggingWithDevtools/entry/src/main/ets/pages/WebDebuggingWithUSB.ets#L15-L34)
2. 开启调试功能需要在DevEco Studio应用工程hap模块的module.json5文件中增加如下权限，添加方法请参考[在配置文件中声明权限](../../../../系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md#在配置文件中声明权限)。
...
2. 使用hdc命令连接上设备。
   ...
   * 如果命令返回设备的ID，表示hdc已连接上设备。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/vsGulbNBSb6HbaJqdTKrDQ/zh-cn_image_0000002592378588.png?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=2E885364687420BF1BD595ED955B506094F225F45CDB57F5AC8996F2135893FF)
   * 如果命令返回 [Empty]，则说明hdc还没有发现设备。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/H6_nPwVxRACTxJQCjuwEQg/zh-cn_image_0000002622858095.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=85E0452E81EFE636552A387A98EF0BCF99653BBEE132D3F2A129BD63FCD125CE)
3. 进入hdc shell。
...
**推荐使用[自动映射WebView调试链接](../../../../编写与调试应用/应用调试/自定义运行调试配置/ide-run-debug-configurations.md#section48387420516)**。
...
1. 先在hdc shell里执行如下命令，查询ArkWeb在设备里创建的domain socket。
   ...
   * 如果前几步操作无误，该命令的执行结果将显示用于查询的domain socket端口。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/iIJpMtB_SISgK3a6oLIsIg/zh-cn_image_0000002622698217.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=F922FD47F4E62EA8B83E326BC272B82980CC4334C2DFE833FDEEB65133443F13)
   * 如果没有查询到结果， 请再次确认。
...
2. 将查询到的domain socket转发至电脑的TCP 9222端口。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/rsRfyooiRkaItUfV4WnguA/zh-cn_image_0000002592218656.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=DEEAB57A9985AEE51E6E962726E16573DD6BC747F5C428D04A102C3F9B25F51C)
3. 在命令行里执行如下命令，检查端口是否转发成功。
   ...
   * 如果有返回端口转发的任务，则说明端口转发成功。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a2/v3/BOBVsE0ETmGXCrvIAkIy-A/zh-cn_image_0000002592378590.png?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=D14D3BC3535A2DF4ACB404E5D11B0DEF66909643BE9980A706DC73DA20798920)
   * 如果返回 [Empty]， 则说明端口转发失败。

     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/Wv5y9ozGQCe_K5rLM5GKbw/zh-cn_image_0000002622858097.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=305D99127EFB362F55CE37F4A31B2C6E749234CA323BBD6F43ADD43C6131A323)
...
2. 修改Chrome调试工具的配置。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/gZMnnY05Tvq9Sgkj_6EkaA/zh-cn_image_0000002622698219.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=F0875BDE42F4C5EAE16A48E9E9F1868889422E316193CAE7AF4FD8A005601303)
3. 为了同时调试多个应用，请在Chrome浏览器的调试工具网页内，于“Devices”选项中的“configure”部分添加多个端口号。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b/v3/uwoUxTLnQ-6PVpH4btH1yg/zh-cn_image_0000002592218658.png?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=A199C301FF07CFB0FB3B6F7B495B68EB18D52E79CCB5E48CD009A69377445581)

### 等待发现被调试页面

如果前面的步骤执行成功，Chrome的调试页面将显示待调试的网页。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/Zg5e4liRT2a69Lmy7B28Ug/zh-cn_image_0000002622698215.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=E98288B3AB08326408163A1A6307C03F1A2C0B4809E86BF5ABD668CB174DA654)

### 开始网页调试

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/HOTHsle9TH2XyYJjer4DFg/zh-cn_image_0000002592218654.png?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=BF7EFF33256BFD9B0FD17C71364C871E2C2C8942E54FD3E32B3B62DD9F41A821)
...
* 转发成功后，请用电脑端的Chrome浏览器打开网址 <http://localhost:9222/json> ，URL里的9222需要改为自己实际配置的TCP端口。
  ...
  + 如果网页有内容， 说明端口转发成功，请在Chrome的调试页面[等待被调试页面的出现](web-debugging-with-devtools.md#等待发现被调试页面)。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/tlNpizITTmu0ko6ikY6aKg/zh-cn_image_0000002592378592.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=F3200ECC985150E65422813E04C745EE511314F741CAC3AC43F5D3F8F3D10D51)
  + 如果展示的是错误网页， 说明端口转发失败， 请参阅[端口转发不成功](web-debugging-with-devtools.md#端口转发不成功)中的解决方法。

    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/Tgmbne3XTsSW9jgNumpn6Q/zh-cn_image_0000002622858099.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063613Z&HW-CC-Expire=86400&HW-CC-Sign=AD42601F9782C1382DF2EC2613C3A457679EE6409BEF51F7AC5065E23BA757D0)
