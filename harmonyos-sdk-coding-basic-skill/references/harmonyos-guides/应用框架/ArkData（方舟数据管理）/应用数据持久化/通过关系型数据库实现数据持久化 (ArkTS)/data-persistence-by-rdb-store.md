...
scraped_at: 2026-06-12T11:57:11+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:10151b01b8cb338f294a4fd3022c97464720ef7bb1faeca40532ac349c87afd4
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7e/v3/4F1tN6W0Re6ivf5bYazyIg/zh-cn_image_0000002592377846.jpg?HW-CC-KV=V1&HW-CC-Date=20260612T035710Z&HW-CC-Expire=86400&HW-CC-Sign=BCEA8C987F0D2F6E14D05C6B20E1E64B26955D2AA03C5FE383EF11843BEC65EC)
...
1. 使用关系型数据库实现数据持久化，需要获取一个RdbStore，其中包括建库、建表、升降级等操作。推荐使用事务接口保证数据库升级流程原子性。
   ...
   [RdbDataPersistence.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/RelationalStore/DataSyncAndPersistence/entry/src/main/ets/pages/datapersistence/RdbDataPersistence.ets#L16-L119)
...
2. 获取到RdbStore，完成数据表创建后，调用insert()接口插入数据。示例代码如下所示：
   ...
   [RdbDataPersistence.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/RelationalStore/DataSyncAndPersistence/entry/src/main/ets/pages/datapersistence/RdbDataPersistence.ets#L121-L144)
...
3. 根据谓词指定的实例对象，对数据进行修改或删除。
   ...
   [RdbDataPersistence.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/RelationalStore/DataSyncAndPersistence/entry/src/main/ets/pages/datapersistence/RdbDataPersistence.ets#L146-L186)
4. 根据谓词指定的查询条件查找数据。
   ...
   [RdbDataPersistence.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/RelationalStore/DataSyncAndPersistence/entry/src/main/ets/pages/datapersistence/RdbDataPersistence.ets#L188-L212)
   ...
   [RdbDataPersistence.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/RelationalStore/DataSyncAndPersistence/entry/src/main/ets/pages/datapersistence/RdbDataPersistence.ets#L214-L240)
5. 使用事务对象执行数据的插入、删除和更新操作。
   ...
   [RdbDataPersistence.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/RelationalStore/DataSyncAndPersistence/entry/src/main/ets/pages/datapersistence/RdbDataPersistence.ets#L242-L297)
6. 在同路径下备份数据库。关系型数据库支持手动备份和自动备份（仅系统应用可用）两种方式，具体可见[关系型数据库备份](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-backup-and-restore#关系型数据库备份)。
   ...
   [RdbDataPersistence.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/RelationalStore/DataSyncAndPersistence/entry/src/main/ets/pages/datapersistence/RdbDataPersistence.ets#L299-L311)
7. 从备份数据库中恢复数据。关系型数据库支持两种方式：恢复手动备份数据和恢复自动备份数据（仅系统应用可用），具体可见[关系型数据库数据恢复](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-backup-and-restore#关系型数据库数据恢复)。
   ...
   [RdbDataPersistence.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/RelationalStore/DataSyncAndPersistence/entry/src/main/ets/pages/datapersistence/RdbDataPersistence.ets#L313-L324)
8. 删除数据库。
   ...
   [RdbDataPersistence.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/RelationalStore/DataSyncAndPersistence/entry/src/main/ets/pages/datapersistence/RdbDataPersistence.ets#L326-L336)
