...
scraped_at: 2026-06-01T11:00:00+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:7f7c9789618c871256a18d1a21c0d1fa3f620a8e33d9711121ffc251232e2635
---
## 场景介绍
...
以下是键值型数据库持久化功能的相关接口，更多接口及使用方式请见[分布式键值数据库](<../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.distributedKVStore (分布式键值数据库)/js-apis-distributedkvstore.md>)。
...
3. 使用on()方法订阅分布式数据变化，如需关闭订阅分布式数据变化，调用[off('dataChange')](<../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.distributedKVStore (分布式键值数据库)/js-apis-distributedkvstore.md#offdatachange>)关闭。示例代码如下所示：
...
7. 调用closeKVStore()方法通过storeId的值关闭指定的分布式键值数据库。示例代码如下所示：
   ...
   [KvStoreInterface.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/KvStore/KvStoreSamples/entry/src/main/ets/pages/KvStoreInterface.ets#L247-L269)
8. 调用deleteKVStore()方法通过storeId的值删除指定的分布式键值数据库。示例代码如下所示：
   ...
   [KvStoreInterface.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/KvStore/KvStoreSamples/entry/src/main/ets/pages/KvStoreInterface.ets#L271-L293)
