...
scraped_at: 2026-06-11T14:25:45+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:8b378aeebb44e5820e0c9405b125984aafd3a0d0825c188917542d3b3785ef98
---
## 场景介绍

针对[UTD](<../../../../../harmonyos-references/ArkData（方舟数据管理）/C API/头文件/utd.h/capi-utd-h.md>)标准化数据类型中的部分常见类型，为了方便业务使用，提供了标准化数据结构。例如，系统定义的桌面图标类型（标准化数据类型标识为'OH\_UdsAppItem'）明确定义了相关描述信息。

某些业务场景下应用可以直接使用我们具体定义的UTD标准化数据结构，例如跨应用拖拽场景。拖出方应用可以按照标准化数据结构将拖拽数据写入[绑定拖拽事件](<../../../ArkUI（方舟UI框架）/UI开发 (基于NDK构建UI)/添加交互事件/拖拽事件/ndk-drag-event.md>)，拖入方应用从拖拽事件中读取拖拽数据并按照标准化数据结构进行数据的解析。这使得不同应用间的数据交互遵从相同的标准定义，有效减少了跨应用数据交互的开发工作量。
...
详细的接口说明请参考[uds.h](<../../../../../harmonyos-references/ArkData（方舟数据管理）/C API/头文件/uds.h/capi-uds-h.md>)。
...
[napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Udmf/UniformDataStructure_C/entry/src/main/cpp/napi_init.cpp#L18-L26)
...
[napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Udmf/UniformDataStructure_C/entry/src/main/cpp/napi_init.cpp#L30-L50)
...
[napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Udmf/UniformDataStructure_C/entry/src/main/cpp/napi_init.cpp#L58-L77)
