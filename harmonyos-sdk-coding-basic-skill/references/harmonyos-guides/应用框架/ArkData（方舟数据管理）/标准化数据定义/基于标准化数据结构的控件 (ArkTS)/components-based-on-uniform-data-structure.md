...
scraped_at: 2026-06-01T10:59:53+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:f43fe9c8dc2f298148145636e4638def042f2bd2af3d9a20f147e5bbb0a4d794
---
## 场景介绍
...
在需要展示内容（标题、描述、图片、应用信息）并在点击后跳转至对应来源时，可以使用内容卡片快速的展示信息。开发者只需要调用[ContentFormCard](<../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS 组件/@ohos.data.UdmfComponents (内容卡片)/js-apis-data-udmfcomponents.md#contentformcard>)接口，传入[ContentForm](<../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.uniformDataStruct (标准化数据结构)/js-apis-data-uniformdatastruct.md#contentform14>)数据、卡片宽高、点击事件回调函数即可获得良好的展示效果。

从API version 20开始，支持使用[内容卡片控件](<../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS 组件/@ohos.data.UdmfComponents (内容卡片)/js-apis-data-udmfcomponents.md>)。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Udmf/ContentForm/entry/src/main/ets/pages/Index.ets#L16-L81)
