...
scraped_at: 2026-06-01T11:00:07+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:d907bfd224c0b4b470a47e93476cc45cd224dadc39144b6aff90d114ed9e038a
---
## 场景介绍
...
不同应用间订阅数据库变化通知，请参考[跨应用数据共享](../../跨应用数据共享/跨应用数据共享概述/data-share-overview.md)实现。
...
数据跨设备同步时，数据管理基于设备等级和数据安全标签进行访问控制，具体可见[跨设备同步访问控制机制](<../../数据可靠性与安全性/基于设备分类和数据分级的访问控制 (ArkTS)/access-control-by-device-and-data-level.md#跨设备同步访问控制机制>)。
