...
scraped_at: 2026-06-01T11:00:30+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:a80c748755f70afa2af9b956cd71ff2a4191826c8ff684ab99e7383da349f088
---
## 场景介绍
...
以下是UDMF标准化数据通路的相关接口，更多接口及使用方式请见[标准化数据通路](<../../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md>)和[标准化数据定义与描述](<../../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.uniformTypeDescriptor (标准化数据定义与描述)/js-apis-data-uniformtypedescriptor.md>)。
...
以[PlainText](<../../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.uniformDataStruct (标准化数据结构)/js-apis-data-uniformdatastruct.md#plaintext>)、[HTML](<../../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.uniformDataStruct (标准化数据结构)/js-apis-data-uniformdatastruct.md#html>)、[PixelMap](<../../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.uniformDataStruct (标准化数据结构)/js-apis-data-uniformdatastruct.md#pixelmap15>)三种数据进行多对多数据共享的过程为例说明开发步骤，数据提供方可以通过UDMF提供的insertData接口将数据写入公共数据通路，获取到的返回值（生成的数据的唯一标识符），可用于对其插入的数据进行更新和删除操作。数据访问方则可以通过UDMF提供的查询接口获取当前公共数据通路的全量数据。
...
1. 导入unifiedDataChannel、uniformTypeDescriptor和uniformDataStruct模块。
   ...
   [UdmfInterface.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Udmf/UnifiedDataChannels/entry/src/main/ets/pages/UdmfInterface.ets#L16-L19)
2. 创建一个统一数据对象并插入到UDMF的公共数据通路中。
   ...
   1. 导入对应数据对象模块。
      ...
      [UdmfInterface.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Udmf/UnifiedDataChannels/entry/src/main/ets/pages/UdmfInterface.ets#L21-L24)
   2. 创建并插入数据。
      ...
      [UdmfInterface.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Udmf/UnifiedDataChannels/entry/src/main/ets/pages/UdmfInterface.ets#L27-L77)
3. 更新上一步插入的统一数据对象。
   ...
   [UdmfInterface.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Udmf/UnifiedDataChannels/entry/src/main/ets/pages/UdmfInterface.ets#L81-L116)
4. 删除存储在UDMF公共数据通路中的统一数据对象。
   ...
   [UdmfInterface.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Udmf/UnifiedDataChannels/entry/src/main/ets/pages/UdmfInterface.ets#L120-L156)
...
2. 查询存储在UDMF公共数据通路中的全量统一数据对象。
   ...
   [UdmfInterface.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Udmf/UnifiedDataChannels/entry/src/main/ets/pages/UdmfInterface.ets#L160-L196)
