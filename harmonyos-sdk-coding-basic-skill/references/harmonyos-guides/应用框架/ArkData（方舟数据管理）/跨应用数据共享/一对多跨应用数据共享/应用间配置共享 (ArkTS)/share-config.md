...
scraped_at: 2026-06-01T11:00:28+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:39899b1c8ec14362711b145218be9e7dbcc22b3e2ffd873f9e83de1d4b9a9e08
---
## 场景介绍
...
以下接口为应用间配置共享的相关接口。详细接口和说明，请参考[应用间配置共享接口](<../../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.dataShare (数据共享)/js-apis-data-datashare.md#datasharecreatedataproxyhandle20>)。
...
| allowList | 允许访问该共享配置项的应用程序列表。数组最大长度为256，超过256的部分不生效。数组中每个元素为应用的[appIdentifier](../../../../../基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appidentifier)，单个appIdentifier为只包含数字的字符串，最大长度为128字节，超过128字节的appIdentifier不会生效。可使用[getBundleInfoForSelf](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#bundlemanagergetbundleinfoforself>)接口来获取当前应用的appIdentifier。 | 字符串数组 | 是 |
...
* 通过调用publish接口发布或修改配置项。
  ...
  [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/DataShare/ShareConfig/entry/src/main/ets/pages/Index.ets#L19-L55)
* 通过调用delete接口删除配置项。
  ...
  [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/DataShare/ShareConfig/entry/src/main/ets/pages/Index.ets#L57-L79)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/DataShare/ShareConfig/entry/src/main/ets/pages/Index.ets#L81-L103)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/DataShare/ShareConfig/entry/src/main/ets/pages/Index.ets#L105-L139)
