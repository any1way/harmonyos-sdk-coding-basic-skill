...
scraped_at: 2026-06-01T11:00:26+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:a5b59c2595d460ebb737dbb334e1f36b6ce6000f1e15daf084e961f7074e0e60
---
## 功能简介
...
* [应用间配置共享](<../一对多跨应用数据共享/应用间配置共享 (ArkTS)/share-config.md>)
...
[通过标准化数据通路实现数据共享](<../多对多跨应用数据共享/通过标准化数据通路实现数据共享 (ArkTS)/unified-data-channels.md>)
