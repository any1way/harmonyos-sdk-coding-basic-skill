...
scraped_at: 2026-06-11T14:26:06+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:82f347a4e01d02f6ac34529336b03472bca7edbd723cb532654f0f9304ba8cf9
---
## 场景介绍
...
以下为使用关系型数据库实现端云数据同步的相关接口，更多接口及使用方式可见[关系型数据库](<../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.relationalStore (关系型数据库)/js-apis-data-relationalstore.md>)和[端云服务](<../../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.cloudData (端云服务)/js-apis-data-clouddata.md>)。
