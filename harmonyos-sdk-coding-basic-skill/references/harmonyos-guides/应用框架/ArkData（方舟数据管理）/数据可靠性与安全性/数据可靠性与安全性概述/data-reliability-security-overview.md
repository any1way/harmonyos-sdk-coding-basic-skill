...
scraped_at: 2026-06-01T11:00:16+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:0fc35eaadbb20ae6f9ec8a5880dc2715c58cf521ae7c669fad775b6f98b75e4e
---
## 功能场景
...
HarmonyOS数据库加密时，应用开发者无需传入密钥，只需要设置数据库加密的状态即可。系统会自动帮助开发者将数据库加密，使用[huks通用密钥库系统](<../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md>)，完成数据库密钥的生成及加密保护。
