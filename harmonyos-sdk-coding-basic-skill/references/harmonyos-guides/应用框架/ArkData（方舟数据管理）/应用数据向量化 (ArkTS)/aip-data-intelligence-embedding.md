...
scraped_at: 2026-06-01T11:00:34+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:7a4f6f1c41697e0906fa2ca9477c2d8e101aea22903fb6139be7114bbe0535d0
---
## 场景介绍
...
以下是智慧数据向量化功能的相关接口。更多接口及使用方式请见[智慧数据平台](<../../../../harmonyos-references/ArkData（方舟数据管理）/ArkTS API/@ohos.data.intelligence (智慧数据平台)/js-apis-data-intelligence.md>)。
...
1. 导入模块。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Aip/entry/src/main/ets/pages/Index.ets#L16-L19)
2. 获取文本嵌入模型。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Aip/entry/src/main/ets/pages/Index.ets#L21-L28)
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Aip/entry/src/main/ets/pages/Index.ets#L67-L81)
3. 加载文本嵌入模型。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Aip/entry/src/main/ets/pages/Index.ets#L146-L166)
4. 获取文本的分块。当数据长度超过限定时，使用splitText()接口将其分块，然后再进行数据向量化。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Aip/entry/src/main/ets/pages/Index.ets#L89-L119)
5. 获取给定文本的嵌入向量。给定的文本数据可以是单个文本或文本集合。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Aip/entry/src/main/ets/pages/Index.ets#L127-L141)
6. 释放文本嵌入模型。
...
2. 获取图像嵌入模型。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Aip/entry/src/main/ets/pages/Index.ets#L30-L37)
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Aip/entry/src/main/ets/pages/Index.ets#L170-L185)
3. 加载图像嵌入模型。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Aip/entry/src/main/ets/pages/Index.ets#L192-L206)
4. 获取给定图像的嵌入向量。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Aip/entry/src/main/ets/pages/Index.ets#L214-L229)
5. 释放图像嵌入模型。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkData/Aip/entry/src/main/ets/pages/Index.ets#L237-L251)
