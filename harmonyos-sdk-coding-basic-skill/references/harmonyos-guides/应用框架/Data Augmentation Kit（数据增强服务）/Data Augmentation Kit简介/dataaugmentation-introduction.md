...
content_hash: sha256:7a21061a375ad80c288726f5d54a057ecef9cbaed12b308693a4db9f25c49a83
---
...
* [RAG（检索增强生成）](../RAG/RAG概述/data-augmentation-rag-overview.md)：提供一种结合检索与生成技术的自然语言处理技术，通过动态从外部知识库中检索相关信息，辅助生成更准确、可靠的文本内容。其核心目标是弥补传统生成模型依赖静态知识的不足，实现“知识实时调用”与“内容灵活生成”的融合。
* [智慧化数据检索](../智慧化数据检索-ArkTS/dataaugmentation-retrieval.md)：基于多路召回和重排序，提供了一套知识检索框架。在提供基于倒排索引的传统文本检索的同时，也提供了基于向量索引的语义检索能力。
* [端侧问答模型](../端侧问答模型/dataaugmentation-localchatmodel.md)：提供接入端侧模型问答的方法，以及使用AI模型管家对接LLM，对用户问题进行处理的过程，实现数据不出端智能问答的效果。
