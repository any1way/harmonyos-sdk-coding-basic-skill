...
scraped_at: 2026-06-01T11:11:25+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:281ad5d8cd7b30a622f8efee955d4fc0b84b9f753c0cc8a58628e5e5e40601dd
---
## 功能介绍

分析过程模板用于在RAG运行时，通过流式输出向用户实时呈现结构化的中间结果。该模板包含预设文本和动态占位符，可将大模型的输出或RAG执行中的关键信息组织为连贯文本。开发者可以通过在指定应用[资源目录](../../../../../基础入门/资源分类与访问/resource-categories-and-access.md#资源目录)放置thought\_template.json配置文件，自定义分析过程模板。
...
在应用[资源目录](../../../../../基础入门/资源分类与访问/resource-categories-and-access.md#资源目录)的rawfile/arkdata/rag下创建thought\_template.json文件，若工程中无目标目录则递归创建。
