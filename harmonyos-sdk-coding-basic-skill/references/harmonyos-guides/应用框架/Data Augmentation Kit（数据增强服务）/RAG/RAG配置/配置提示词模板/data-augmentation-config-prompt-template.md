...
scraped_at: 2026-06-01T11:11:23+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:d00ad685b90b9e5fa9a560e970b877df95a4b51e8ea73b7dd568de6d44b632bb
---
## 功能介绍

提示词模板采用结构化的固定格式，将“角色、任务、输入和输出要求”等要素清晰组织起来，使开发者只需填充关键信息，即可稳定、高效地引导模型生成预期结果。开发者可以通过在指定应用[资源目录](../../../../../基础入门/资源分类与访问/resource-categories-and-access.md#资源目录)放置prompt\_template.json配置文件，导入自定义提示词模板。
...
在应用[资源目录](../../../../../基础入门/资源分类与访问/resource-categories-and-access.md#资源目录)的rawfile/arkdata/rag下创建prompt\_template.json文件，若工程中无目标目录则递归创建。
