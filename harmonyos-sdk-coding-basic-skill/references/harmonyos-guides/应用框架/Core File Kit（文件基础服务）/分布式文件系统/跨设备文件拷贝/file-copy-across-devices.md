...
scraped_at: 2026-06-01T11:11:12+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:777ec169dcec02c323e2ce6789aa13cfe5c562b04634e3c3d6d4fbcb27381751
---
分布式文件系统为应用提供了跨设备文件拷贝的能力，开发者可以通过[基础文件接口](<../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md>)进行跨设备拷贝文件。例如：多设备数据流转的场景，设备组网互联之后，设备A上的应用可将沙箱文件拷贝到设备A的分布式目录下。设备B在粘贴时，从B设备的分布式目录下将文件拷贝到对应的沙箱文件中。
...
3. 执行跨设备文件拷贝操作。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/CoreFile/DistributedFileSample/entry/src/main/ets/pages/Index.ets#L157-L187)
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/CoreFile/DistributedFileSample/entry/src/main/ets/pages/Index.ets#L192-L251)
4. 跨设备文件拷贝完成，断开链路。
