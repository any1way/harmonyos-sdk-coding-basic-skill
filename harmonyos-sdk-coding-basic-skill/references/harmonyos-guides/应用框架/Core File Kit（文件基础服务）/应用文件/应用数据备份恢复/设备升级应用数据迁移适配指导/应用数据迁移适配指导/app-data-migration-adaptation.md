...
scraped_at: 2026-06-11T14:36:50+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:6d856d24655cbb417154ee6243c4a82f022d9d970baf09c9bc2384945e2c7e24
---
## 环境准备
...
| DevEco Studio | DevEco Studio NEXT Developer Beta3及之后版本 | 请参考：[DevEco Studio使用指南](../../../../../../开发环境搭建/工具概述/ide-tools-overview.md)。 |
| Compatible SDK | 5.0.0(12) | 请参考：[版本说明](../../../../../../../harmonyos-releases/所有HarmonyOS版本/overview-allversion.md)。 |

## 应用数据迁移适配流程

### 创建新工程

本章节从[创建新工程](../../../../../../开发环境搭建/工程创建/创建一个新的工程/ide-create-new-project.md)开始，指导开发者接入“备份恢复框架”，已经创建工程的开发者可以跳过本节。
...
1. 在**entry/src/main/ets/**目录下，点击 **New > Directory** 创建**backupExtension**目录。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/bl7k01lqS4q6a4ITM9F-_A/zh-cn_image_0000002592218674.png?HW-CC-KV=V1&HW-CC-Date=20260611T063649Z&HW-CC-Expire=86400&HW-CC-Sign=297B90CB6F65542C52C4FEB4512F1C9F1739D46047A62FB72184A4137D9D278B)
2. 点击**entry/src/main/ets/backupExtension/**目录，点击 **New > File** 创建**BackupExtension.ets**文件。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/Ze_BrcLXQQC2MnTiMXGZxw/zh-cn_image_0000002592378608.png?HW-CC-KV=V1&HW-CC-Date=20260611T063649Z&HW-CC-Expire=86400&HW-CC-Sign=E640FF7793EBAB853BA010BCD25556E828AA7D304E409D3E8723EFFCA1E70316)
...
以下步骤以空工程为例，介绍如何配置[module.json5](../../../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#extensionabilities标签)文件：
