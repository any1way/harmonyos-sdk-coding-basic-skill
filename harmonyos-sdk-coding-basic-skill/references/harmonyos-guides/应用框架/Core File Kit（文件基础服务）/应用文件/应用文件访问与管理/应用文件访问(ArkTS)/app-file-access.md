...
scraped_at: 2026-06-01T11:10:40+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:41ddda909e2bb716f00f8d4ec2b480307b7d5afc2d6c1d2c7b3f036567216474
---
应用需要对应用文件目录下的应用文件进行查看、创建、读写、删除、移动、复制、获取属性等访问操作，下文介绍具体方法。

## 接口说明

开发者通过基础文件操作接口（[ohos.file.fs](<../../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md>)）实现应用文件访问能力，主要功能如下表所示。
...
在对应用文件开始访问前，开发者需要[获取应用文件路径](<../../../../Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/应用上下文Context/application-context-stage.md#获取应用文件路径>)。以从UIAbilityContext获取HAP级别的文件路径为例进行说明，UIAbilityContext的获取方式请参见[获取UIAbility的上下文信息](<../../../../Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/UIAbility组件/UIAbility组件基本用法/uiability-usage.md#获取uiability的上下文信息>)。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/CoreFile/FileApiFileSample/entry/src/main/ets/pages/Index.ets#L23-L57)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/CoreFile/FileApiFileSample/entry/src/main/ets/pages/Index.ets#L59-L107)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/CoreFile/FileApiFileSample/entry/src/main/ets/pages/Index.ets#L109-L154)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/CoreFile/FileApiFileSample/entry/src/main/ets/pages/Index.ets#L157-L180)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/CoreFile/FileApiFileSample/entry/src/main/ets/pages/Index.ets#L182-L213)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/CoreFile/FileApiFileSample/entry/src/main/ets/pages/Index.ets#L215-L249)

### 使用文件哈希流

哈希流是一种数据传输和存储技术，可以将任意长度的数据转换为固定长度的哈希值来验证数据的完整性和一致性。以下代码演示了如何使用文件哈希处理接口（[ohos.file.hash](<../../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.hash (文件哈希处理)/js-apis-file-hash.md>)）来处理文件哈希流。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/CoreFile/FileApiFileSample/entry/src/main/ets/pages/Index.ets#L251-L273)
