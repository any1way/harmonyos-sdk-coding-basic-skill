...
content_hash: sha256:52faca3abccd9804e2d4dfe87524532d9b8d0a2f53535e7fa35917a016f64b51
---
...
2. 本示例假设已经在输入法应用中执行，如何实现一个输入法应用，请参考[实现一个输入法应用](../实现一个输入法应用/inputmethod-application-guide.md)开发指导。

## 切换当前输入法子类型

1. 在已完成一个输入法应用的基础上，当输入法应用是当前输入法时，在输入法应用中使用[switchCurrentInputMethodSubtype](<../../../../harmonyos-references/IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethod (输入法框架)/js-apis-inputmethod.md#inputmethodswitchcurrentinputmethodsubtype9>)接口，传入当前输入法的子类型[InputMethodSubtype](<../../../../harmonyos-references/IME Kit（输入法开发服务）/ArkTS API/@ohos.InputMethodSubtype (输入法子类型)/js-apis-inputmethod-subtype.md#inputmethodsubtype>)作为参数即可切换当前输入法子类型。
   ...
   [Submenu.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/InputMethod/KikaInputMethod/entry/src/main/ets/components/Submenu.ets#L80-L90)
...
在已完成一个输入法应用的基础上，当输入法应用是当前输入法时，在输入法应用中使用[switchInputMethod](<../../../../harmonyos-references/IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethod (输入法框架)/js-apis-inputmethod.md#inputmethodswitchinputmethod9>)接口，传入目标输入法的[InputMethodProperty](<../../../../harmonyos-references/IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethod (输入法框架)/js-apis-inputmethod.md#inputmethodproperty8>)信息，即可切换输入法到目标输入法。
...
[Submenu.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/InputMethod/KikaInputMethod/entry/src/main/ets/components/Submenu.ets#L63-L78)

## 切换输入法应用和子类型

在已完成一个输入法应用的基础上，当输入法应用是当前输入法时，在输入法应用中使用[switchCurrentInputMethodAndSubtype](<../../../../harmonyos-references/IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethod (输入法框架)/js-apis-inputmethod.md#inputmethodswitchcurrentinputmethodandsubtype9>)接口，传入目标输入法的[InputMethodProperty](<../../../../harmonyos-references/IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethod (输入法框架)/js-apis-inputmethod.md#inputmethodproperty8>)，目标输入法的子类型[InputMethodSubtype](<../../../../harmonyos-references/IME Kit（输入法开发服务）/ArkTS API/@ohos.InputMethodSubtype (输入法子类型)/js-apis-inputmethod-subtype.md#inputmethodsubtype>)信息，即可切换输入法到目标输入法的指定子类型。
