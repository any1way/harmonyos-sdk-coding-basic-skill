...
scraped_at: 2026-06-11T14:38:14+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:14d9ff01c3ff270b1fdefab5ec07e75196ea5d9a26f02a88a341874076888c01
---
在输入法框架中，可以通过[getController](<../../../../harmonyos-references/IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethod (输入法框架)/js-apis-inputmethod.md#inputmethodgetcontroller9>)方法获取到[InputMethodController](<../../../../harmonyos-references/IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethod (输入法框架)/js-apis-inputmethod.md#inputmethodcontroller>)实例来绑定输入法并监听输入法应用的各种操作，比如插入、删除、选择、光标移动等。这样就可以在自绘编辑框中使用输入法，并实现更加灵活和自由的编辑操作。
...
2. 在控件中，使用Text组件作为自绘编辑框的文本显示组件，使用状态变量inputText作为Text组件要显示的内容。
   ...
   [CustomInput.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/InputMethod/KikaInputMethod/entry/src/main/ets/components/CustomInput.ets#L17-L46)
3. 在控件中获取inputMethodController实例，先在文本点击时调用controller实例的attach方法绑定和拉起软键盘，再注册监听输入法插入文本、删除等方法。本示例仅展示插入、删除。
   ...
   [CustomInput.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/InputMethod/KikaInputMethod/entry/src/main/ets/components/CustomInput.ets#L16-L77)
4. 在应用界面布局中引入该控件即可，此处假设使用界面为Index.ets和控件CustomInput.ets在同一目录下。
   ...
   [PrivatePreview.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/InputMethod/KikaInputMethod/entry/src/main/ets/pages/PrivatePreview.ets#L121-L123)

## 示例效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/p3xoVGkwTFaK5nELvQSzbQ/zh-cn_image_0000002592378668.png?HW-CC-KV=V1&HW-CC-Date=20260611T063812Z&HW-CC-Expire=86400&HW-CC-Sign=C7E5F0CE80B40CF858FA5B09D3CE4959D0ED48F67C3356C426B18F0A354F74AB)
