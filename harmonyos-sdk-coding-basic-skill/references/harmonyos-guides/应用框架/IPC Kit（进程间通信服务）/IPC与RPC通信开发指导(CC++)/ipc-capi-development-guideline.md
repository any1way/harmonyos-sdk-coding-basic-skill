...
scraped_at: 2026-06-11T14:38:29+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:fef32b5a60b8010799779a02d2ad723e880abf4a1bed99d0bedecd3672c92fde
---
## 场景介绍

IPC让运行在不同进程间的Proxy和Stub实现互相通信。IPC CAPI是IPC Kit提供的C语言接口。

IPC CAPI接口不直接提供获取通信代理对象的能力，该功能由[Ability Kit](<../../Ability Kit（程序框架服务）/Ability Kit简介/abilitykit-overview.md>)提供。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a2/v3/bUkVWkh_TYawBAi8DtUOAg/zh-cn_image_0000002592378672.png?HW-CC-KV=V1&HW-CC-Date=20260611T063826Z&HW-CC-Expire=86400&HW-CC-Sign=0C71A89A0AEF22FA0BB7BAC6065E111B59CE1FE42FBA6BA01C0C5437B979E03A)

进程间IPC通道的建立，请参考[Native子进程开发指导（C/C++）](<../../Ability Kit（程序框架服务）/Native子进程开发指导/创建终止Native子进程（CC++）/capi-nativechildprocess-development-guideline.md>)。本文重点介绍IPC CAPI的使用。
...
详细的接口说明请参考[IPCKit](<../../../../harmonyos-references/IPC Kit（进程间通信服务）/C API/模块/IPCKit/capi-ipckit.md>)。
...
[IpcProxy.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Ability/NativeChildProcessIpc/entry/src/main/cpp/IpcProxy.cpp#L16-L129)
...
[IpcStub.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Ability/NativeChildProcessIpc/entry/src/main/cpp/IpcStub.cpp#L16-L136)
