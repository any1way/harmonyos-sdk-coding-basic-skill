...
scraped_at: 2026-06-11T14:34:13+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:2ccb05f0cd0d2fce00375bc9925a034dab4c1786a6251186c6abea5d6986076d
---
...
状态管理接入[hidumper](../../../../系统/调测调优/调试命令/hidumper/hidumper/hidumper.md)，支持通过-jsdump获取状态变量关联的组件、自定义组件树等信息，方便开发者了解状态变量影响的UI范围，写出高性能应用代码。
...
下面的例子为嵌套两层子组件的典型示例，使用了装饰器[@State](<../../UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@State装饰器：组件内状态/arkts-state.md>)和 [@Link](<../../UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Link装饰器：父子双向同步/arkts-link.md>)。开发者可组合使用上述命令，展示前端组件树、状态变量和其影响的组件等信息。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/4EO_u9wPSFiDbR5nLaMJqQ/zh-cn_image_0000002592218566.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063412Z&HW-CC-Expire=86400&HW-CC-Sign=A4361E6575718912AC787EBBC77687726C083F4EA9EED130647DDC8F7E64BBEB)

步骤3：选中状态变量变化的打点，将显示当前状态变量更新触发了哪些组件的刷新，以及对应组件的创建、测量和布局的耗时。

**图2** ArkUI State泳道图示意图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/8IBMG50ZSMCrNQ873SGSJQ/zh-cn_image_0000002592378500.png?HW-CC-KV=V1&HW-CC-Date=20260611T063412Z&HW-CC-Expire=86400&HW-CC-Sign=B249D54493E8BEE81D6D4CA1FEAAEF8BEC344A450C6E26B3398E193F0F82225A)
...
| mode | 状态变量观察模式，包括：  Compatible Mode：状态管理V1状态变量，且其装饰变量的类型没有[@Track](<../../UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理数据对象的状态/@Track装饰器：class对象属性级更新/arkts-track.md>)装饰的属性。  Track Mode：状态管理V1状态变量，且其装饰的类型有@Track装饰的属性。  V2：状态管理V2状态变量。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/h5nWRM4GTKW05-3E3z7PBw/zh-cn_image_0000002622858007.png?HW-CC-KV=V1&HW-CC-Date=20260611T063412Z&HW-CC-Expire=86400&HW-CC-Sign=7564F97B67B2BF77FADAB2C165FECFB159A5AA4034767DD7FB2D880935AE2D74)
...
ArkUI内部针对关键的UI处理流程添加了Trace信息，帮助开发者通过Trace工具观测应用的UI耗时，辅助定位问题。详细Trace说明及案例参考：[常用Trace使用指导](../../../../../best-practices/性能/性能分析/性能分析简介/bpta-optimization-overview.md#section085643405116)。

## Inspector调试能力

ArkUI Inspector是DevEco Studio内置的页面布局检查工具，帮助开发者查看应用的UI层级结构、组件属性和布局效果。详细Inspector使用方法及案例参考：[页面布局检查器ArkUI Inspector使用指导](../../../../编写与调试应用/应用调试/布局分析/ide-arkui-inspector.md)。
