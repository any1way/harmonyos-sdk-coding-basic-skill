...
content_hash: sha256:26219392f95900cb576efc33b343dcfd561bdad6a0f3d3a0c0aacea67e0edd3e
---
...
从API version 9开始，可以使用[getInspectorTree](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#getinspectortree9)接口获取组件树及其属性。

**单个节点**

从API version 10开始，可以使用[getRectangleById](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (ComponentUtils)/arkts-apis-uicontext-componentutils.md#getrectanglebyid>)接口获取组件的大小、位置、平移、缩放、旋转及仿射矩阵等属性信息。
