...
content_hash: sha256:20de13d871248724504c2684e23ac28a3508351039807531eda6f945a6069616
---
## 场景介绍

[OH\_DisplayManager](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/模块/OH_DisplayManager/capi-oh-displaymanager.md>)屏幕管理模块用于提供屏幕的信息查询、屏幕状态变化监听、折叠设备的折叠状态变化监听等能力，应用可根据对应的屏幕信息、屏幕状态变化、屏幕折叠状态适配不同的UI界面显示。
...
常用接口如下表所示。更多API说明请参考[OH\_DisplayManager](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/模块/OH_DisplayManager/capi-oh-displaymanager.md>)。
...
[napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDisplayBasicSample/entry/src/main/cpp/napi_init.cpp#L17-L21)
...
1. 可以通过OH\_NativeDisplayManager\_GetDefaultDisplayRotation获取默认屏幕的旋转角度。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDisplayBasicSample/entry/src/main/cpp/napi_init.cpp#L25-L43)
2. 可以通过OH\_NativeDisplayManager\_CreateDefaultDisplayCutoutInfo获取挖孔屏、刘海屏、瀑布屏等不可用屏幕区域信息。 可通过OH\_NativeDisplayManager\_DestroyDefaultDisplayCutoutInfo销毁挖孔屏、刘海屏、瀑布屏等不可用屏幕区域信息。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDisplayBasicSample/entry/src/main/cpp/napi_init.cpp#L45-L90)
...
[napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDisplayBasicSample/entry/src/main/cpp/napi_init.cpp#L92-L134)
...
1. 可以通过OH\_NativeDisplayManager\_IsFoldable接口查询设备是不是折叠设备。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDisplayBasicSample/entry/src/main/cpp/napi_init.cpp#L136-L145)
2. 可以通过OH\_NativeDisplayManager\_RegisterFoldDisplayModeChangeListener注册屏幕展开/折叠状态变化的监听。 通过OH\_NativeDisplayManager\_UnregisterFoldDisplayModeChangeListener接口取消屏幕展开/折叠状态变化的监听。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDisplayBasicSample/entry/src/main/cpp/napi_init.cpp#L147-L186)
...
[napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDisplayBasicSample/entry/src/main/cpp/napi_init.cpp#L188-L209)
...
[napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDisplayBasicSample/entry/src/main/cpp/napi_init.cpp#L211-L226)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDisplayBasicSample/entry/src/main/ets/pages/Index.ets#L53-L97)
