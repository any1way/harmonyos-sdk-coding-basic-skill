...
scraped_at: 2026-06-11T14:34:02+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:30e6b7b2a28513d51eeb1942451cf8a7c542641f4c048b84eef92454323e9aa3
---
...
本示例中父组件通过添加自定义属性向子组件传递了名称为title的参数，子组件在props中接收。同时子组件也通过事件绑定向上传递了参数text，接收时通过e.detail获取。要绑定子组件事件，父组件事件命名必须遵循事件绑定规则，详见[自定义组件的基本用法](../../../../../harmonyos-references/ArkUI（方舟UI框架）/JS组件/兼容JS的类Web开发范式（ArkUI.Full）/自定义组件/自定义组件的基本用法/js-components-custom-basic-usage.md)。自定义组件效果如下图所示：

**图1** 自定义组件的效果

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/SXxTP54TRiaBWeJtBgX4bg/zh-cn_image_0000002592218556.png?HW-CC-KV=V1&HW-CC-Date=20260611T063401Z&HW-CC-Expire=86400&HW-CC-Sign=76E1883BF9A323AE9968BB37E10FF8EE867FA05EEBDD0AB73580FA5B33C91906)
