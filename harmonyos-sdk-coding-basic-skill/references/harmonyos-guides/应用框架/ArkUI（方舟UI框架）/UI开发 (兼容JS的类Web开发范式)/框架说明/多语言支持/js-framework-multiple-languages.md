...
scraped_at: 2026-06-01T11:07:28+08:00
doc_updated_at: 2026-03-23
content_hash: sha256:19c0af37ac9ab81528d327a361d8d32543f6cfdad7c534ef08ebc148244670db
---
...
资源文件用于存放应用在多种语言场景下的资源内容，开发框架使用JSON文件保存资源定义。在[文件组织](../文件组织/js-framework-file.md)中指定的i18n文件夹内放置语言资源文件，语言资源文件的命名是由语言、文字、国家或地区的限定词通过中划线连接组成，其中文字和国家或地区可以省略，如zh-Hant-HK（中国香港地区使用的繁体中文）、zh-CN（中国使用的简体中文）、zh（中文）。命名规则如下：
...
获取语言功能请参考[@ohos.app.ability.Configuration (环境变量)](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Configuration (环境变量)/js-apis-app-ability-configuration.md>)。
