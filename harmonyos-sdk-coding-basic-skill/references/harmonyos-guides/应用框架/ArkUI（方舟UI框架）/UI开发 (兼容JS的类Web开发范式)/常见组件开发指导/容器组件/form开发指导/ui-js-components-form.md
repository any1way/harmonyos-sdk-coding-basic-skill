...
scraped_at: 2026-06-11T14:33:28+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:6573346b76b6897fa451f276550fb951844f9b5b8ac69128299818285e90e3a8
---
form是一个表单容器，支持容器内[Input](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/JS组件/兼容JS的类Web开发范式（ArkUI.Full）/基础组件/input/js-components-basic-input.md)组件内容的提交和重置。具体用法请参考[form API](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/JS组件/兼容JS的类Web开发范式（ArkUI.Full）/容器组件/form/js-components-container-form.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/VvZdFKCnSLS3gNME0_CkyA/zh-cn_image_0000002592218494.png?HW-CC-KV=V1&HW-CC-Date=20260611T063327Z&HW-CC-Expire=86400&HW-CC-Sign=F38FD14A96F79035C6C5E1E452D0A950ACD4993CE996DD75E5E17C88172A1A42)

## 实现表单缩放

为form组件添加click-effect属性，实现点击表单后的缩放效果，click-effect枚举值请参考[通用属性](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/JS组件/兼容JS的类Web开发范式（ArkUI.Full）/组件通用信息/通用属性/js-components-common-attributes.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/YaWRQ_myTu6BQ9gSEGxcSg/zh-cn_image_0000002592378428.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063327Z&HW-CC-Expire=86400&HW-CC-Sign=3D65518473A2025F9323F10A5C0CF057AE1F0100A6683F95CC8034EC37BD14A4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/53/v3/MUY3rdGWQGOZVwbjEFJClw/zh-cn_image_0000002622857935.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063327Z&HW-CC-Expire=86400&HW-CC-Sign=BD3713515E84BCA1C918F90887F3F345AB328391DDC7DF6C75B4BB0F2C33BBA0)

## 场景示例

在本场景中，开发者可以选择相应选项并提交或重置数据。

创建[Input](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/JS组件/兼容JS的类Web开发范式（ArkUI.Full）/基础组件/input/js-components-basic-input.md)组件，分别设置type属性为checkbox（多选框）和radio（单选框），再使用form组件的onsubmit和onreset事件实现表单数据的提交与重置。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/71/v3/RTPD96PvTyaRU48Xng7Wmw/zh-cn_image_0000002622698057.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063327Z&HW-CC-Expire=86400&HW-CC-Sign=638CA0FB591E71971308F9FB71AE532C138F290BFBC96C8AB6922ADA1E8D3D4F)
