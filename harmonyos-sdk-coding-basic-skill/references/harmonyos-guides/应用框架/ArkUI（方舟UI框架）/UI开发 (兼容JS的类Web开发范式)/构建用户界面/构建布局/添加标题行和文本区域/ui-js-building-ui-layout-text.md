...
scraped_at: 2026-06-11T14:33:16+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:c8a1f8b059d4c3ea050ac8e1e7c0c34798079aa280823406def33feeb97d2eb9
---
实现标题和文本区域最常用的是基础组件text。text组件用于展示文本，可以设置不同的属性和样式，文本内容需要写在标签内容区，完整属性和样式信息请参考[text](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/JS组件/兼容JS的类Web开发范式（ArkUI.Full）/基础组件/text/js-components-basic-text.md)。在页面中插入标题和文本区域的示例如下：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/96q5tnalTzGDdDHNM6Vofg/zh-cn_image_0000002622857927.png?HW-CC-KV=V1&HW-CC-Date=20260611T063315Z&HW-CC-Expire=86400&HW-CC-Sign=0E666EC7461FFD0B10938F7993AB457CC95C17297B3294220FD438FFF0CA4BCD)
