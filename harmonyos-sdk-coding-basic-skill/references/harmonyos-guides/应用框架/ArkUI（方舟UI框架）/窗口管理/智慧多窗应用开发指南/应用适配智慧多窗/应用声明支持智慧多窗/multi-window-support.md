...
scraped_at: 2026-06-01T11:08:55+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:76a09bf98a9fcef57f5a7fc7114ce42ffbf963dabf36ac7fec076d38a8c01f76
---
当应用需要智慧多窗的能力时，可以通过在[module.json5配置文件](../../../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)中对应标签添加相关字段声明支持。

## 声明支持悬浮窗

开发者可以通过在module.json5配置文件中[abilities标签](../../../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#abilities标签)下的**supportWindowMode**属性增加“**floating**”字段或使用缺省值以声明应用支持悬浮窗。
...
| landscape\_auto | 多窗布局动态可变为横向，需要配合API（[enableLandscapeMultiWindow](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#enablelandscapemultiwindow12>) / [disableLandscapeMultiWindow](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#disablelandscapemultiwindow12>)）使用。建议视频类应用配置。 | **系统识别应用为横向全屏播放：**  **手机**  手势触发悬浮窗：横向悬浮窗  手势触发分屏：形成上下分屏  分屏样式切换：不涉及  **折叠屏手机展开态**  手势触发悬浮窗：横向悬浮窗  手势触发分屏：形成上下分屏  分屏样式切换：支持样式切换  **系统识别应用为非横向全屏播放：** 同配置为default |
...
开发者可以通过在module.json5配置文件中[abilities标签](../../../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#abilities标签)下的**supportWindowMode**属性增加“**split**”字段或使用缺省值以声明应用支持分屏。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/yWUdd1t0RNecS7c6K9nOxA/zh-cn_image_0000002613518651.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030856Z&HW-CC-Expire=86400&HW-CC-Sign=0673265CA58BF4CE00CCB7D9F80447E927EEB93D8CABF8C182977FCE8892F2A4)

图2 启动右侧分屏

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/IPToqB40RsaVA5VAY4Yz0Q/zh-cn_image_0000002582958854.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030856Z&HW-CC-Expire=86400&HW-CC-Sign=69D29409317A6C7E8C40ABB7ED2AC97854229E3170D3C7F27DF89A0EBC68CF46)

## 应用内多窗

从HarmonyOS 6.0.0版本开始，新增支持应用内多窗。应用内多窗功能支持应用拉起分屏或全景多窗，方便用户进行多任务处理。

当应用开发者需要使用应用内多窗图标时，可以使用高级组件[MultiWindowEntryInAPP](<../../../../../../../harmonyos-references/UI Design Kit（UI设计套件）/ArkTS组件/MultiWindowEntryInAPP/ui-design-multiwindowentryinapp-api.md>)实现该功能。
