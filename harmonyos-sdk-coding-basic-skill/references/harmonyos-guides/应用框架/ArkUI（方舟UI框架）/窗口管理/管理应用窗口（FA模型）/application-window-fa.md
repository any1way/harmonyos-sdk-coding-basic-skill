...
scraped_at: 2026-06-11T14:34:26+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:93a63341271973508b059843c58706f2877c8f25fceee4a90b1bb1d1c6d1ca51
---
## 基本概念
...
1. 创建/获取子窗口对象。
   ...
   * 可以通过window.createWindow接口创建子窗口。
     ...
     非[自由窗口](../窗口开发术语/window-terminology.md#自由窗口)状态下，子窗口创建后默认是[沉浸式布局](../窗口开发术语/window-terminology.md#沉浸式布局)。

     自由窗口状态下，子窗口参数[decorEnabled](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interfaces (其他)/arkts-apis-window-i.md#configuration9>)为false时，子窗口创建后为沉浸式布局；子窗口参数decorEnabled为true，子窗口创建后为非沉浸式布局。
