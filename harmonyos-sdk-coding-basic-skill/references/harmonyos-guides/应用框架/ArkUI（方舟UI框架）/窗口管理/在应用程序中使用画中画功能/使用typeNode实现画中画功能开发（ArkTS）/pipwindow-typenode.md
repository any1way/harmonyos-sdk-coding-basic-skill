...
scraped_at: 2026-06-11T14:34:37+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:edf3d3160db5b23880a933302d83a01bd9ce0086743255a2146de0e1998efcb4
---
说明
...
54. try {
55. let fileDescriptor = await context.resourceManager.getRawFd('xxx.mp4');
56. if (this.avPlayer) {
57. this.avPlayer.fdSrc = fileDescriptor;
58. }
59. } catch (err) {
60. console.error(`AVPlayer error: ${JSON.stringify(err)}`)
61. }
62. }
63. }
```

[AVPlayer.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/model/AVPlayer.ets#L16-L80)
...
[EntryAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/entryability/EntryAbility.ets#L16-L100)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/pages/Index.ets#L17-L112)
...
[TypeNodeFreePage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/pages/TypeNodeFreePage.ets#L16-L80)
...
165. return;
166. }
167. this.pipController.stopPiP()
168. .then(() => {
...
[PipManager.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/nodefree/PipManager.ets#L16-L208)

以上示例代码对应的示意图如下所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/e0XSIpusSH-9KtYFHDHu-w/zh-cn_image_0000002622858025.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063432Z&HW-CC-Expire=86400&HW-CC-Sign=0EF91A3BF1EBEC7D92951A462EC71AE39469C879E1398E6D8FA5381A8C2C35E6)
...
[EntryAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/entryability/EntryAbility.ets#L18-L99)
...
[RouterImplementPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/pages/RouterImplementPage.ets#L16-L89)
...
[Page1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/route/Page1.ets#L16-L76)
...
186. this.pipController.stopPiP()
187. .then(() => {
...
[PipManager.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/route/PipManager.ets#L16-L228)
...
[XCNodeController.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/route/XCNodeController.ets#L16-L102)

以上示例代码对应的示意图如下所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bb/v3/bJjpX7ITSpKEWlWmlqgUCQ/zh-cn_image_0000002592218584.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063432Z&HW-CC-Expire=86400&HW-CC-Sign=974AAC8E1904D0FCE2F711EFCEBCBC26D7CB40E92AC8157C8B45D7CA3E183DA4)
...
[NavigationImplementPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/pages/NavigationImplementPage.ets#L16-L93)
...
24. PipManager.getInstance().startPip();
25. })
26. Button('stopPip') // 停止画中画
27. .onClick(() => {
28. PipManager.getInstance().stopPip();
29. })
30. Button('updateSize') // 更新视频尺寸
31. .onClick(() => {
32. // 此处设置的宽高应为媒体内容宽高，需要通过媒体相关接口或回调获取
33. // 例如使用AVPlayer播放视频时，可通过videoSizeChange回调获取媒体源更新后的尺寸
34. PipManager.getInstance().updateContentSize(900, 1600);
35. })
36. }
37. .backgroundColor('#4da99797')
38. .size({ width: '100%', height: 60 })
39. .justifyContent(FlexAlign.SpaceAround)
40. }
...
45. .title('page1')
46. .onShown(() => {
47. Logger.info(TAG, 'onShown')
48. PipManager.getInstance().init(this.getUIContext().getHostContext() as Context);
49. PipManager.getInstance().setAutoStart(true);
50. })
51. .onHidden(() => {
52. Logger.info(TAG, 'onHidden')
53. PipManager.getInstance().setAutoStart(false);
54. PipManager.getInstance().removeNode();
55. })
56. }
57. }
```

[Page1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/navigation/Page1.ets#L16-L74)
...
[XCNodeController.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/navigation/XCNodeController.ets#L16-L100)
...
187. return;
188. }
189. this.pipController.stopPiP()
190. .then(() => {
...
[PipManager.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/navigation/PipManager.ets#L16-L230)

以上示例代码对应的示意图如下所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/dDTNxDwOSF-5-q24fpUfQw/zh-cn_image_0000002592218584.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063432Z&HW-CC-Expire=86400&HW-CC-Sign=6A079E6158493D333AC0B8C51E9D968372C7DAE3ACCE4FA129A4CEBB9C9164ED)
...
[AbilityImplementPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/pages/AbilityImplementPage.ets#L16-L91)
...
[XCNodeController.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/ability/XCNodeController.ets#L16-L101)
...
185. return;
186. }
187. this.pipController.stopPiP()
188. .then(() => {
...
[PipManager.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUIWindowPipSamples/WindowPip/entry/src/main/ets/ability/PipManager.ets#L16-L225)

以上示例代码对应的示意图如下所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/XoHMmPShR4-EpJPpPujvwg/zh-cn_image_0000002592218584.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063432Z&HW-CC-Expire=86400&HW-CC-Sign=C7E6F157F9CC229DD7BFB0BAA2000D1111D6070B1B9E0BA0381C1290CF4849BB)
