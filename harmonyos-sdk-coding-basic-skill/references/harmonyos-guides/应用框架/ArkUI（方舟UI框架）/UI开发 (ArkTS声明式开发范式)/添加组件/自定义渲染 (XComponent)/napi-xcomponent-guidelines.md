...
content_hash: sha256:6d2dc0a4a7a1c3ccbaac84aa9af24aa658692efeaee8cc34d0fe7b8776ac69ea
---
## 概述

XComponent组件作为一种渲染组件，可用于EGL/OpenGLES和媒体数据写入，通过使用XComponent持有的“[NativeWindow](<../../../../../图形/ArkGraphics 2D（方舟2D图形服务）/图形缓冲区/NativeWindow开发指导 (CC++)/native-window-guidelines.md>)”渲染画面，满足开发需要实现高级自定义渲染的需求，例如相机预览流的显示和游戏画面的渲染。开发者可通过指定XComponent组件的type字段来实现不同的渲染方式，分别为[XComponentType](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#xcomponenttype10).SURFACE和XComponentType.TEXTURE。对于SURFACE类型，开发者将定制的绘制内容单独展示到屏幕上。对于TEXTURE类型，开发者将定制的绘制内容和XComponent组件的内容合成后展示到屏幕上。
...
XComponent持有一个Surface，开发者能通过调用[NativeWindow](<../../../../../图形/ArkGraphics 2D（方舟2D图形服务）/图形缓冲区/NativeWindow开发指导 (CC++)/native-window-guidelines.md>)等接口，申请并提交Buffer至图形队列，以此方式将自绘制内容传送至该Surface，其主体流程如下：
...
目前ArkUI提供了三种UI组件的创建方式，分别是使用[ArkTS声明式UI描述](../../学习UI范式基本语法/声明式UI描述/arkts-declarative-ui-description.md)创建、使用[ArkTS自定义组件节点](<../../使用自定义能力/自定义节点/自定义组件节点 (FrameNode)/arkts-user-defined-arktsnode-framenode.md>)创建以及使用[NDK接口](<../../../UI开发 (基于NDK构建UI)/基于NDK构建UI概述/ndk-build-ui-overview.md>)创建。
...
XComponent推荐使用两种方式获取XComponent持有Surface的生命周期，分别为在ArkTS侧使用[XComponentController](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md#xcomponentcontroller)管理Surface生命周期，以及在Native侧使用[OH\_ArkUI\_SurfaceHolder](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/OH_ArkUI_SurfaceHolder/capi-nxcomp-arkui-surfaceholder.md>)管理Surface生命周期。
...
* onSurfaceCreated回调
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/XdlM5aLoR8SQ5gCdlYzEgA/zh-cn_image_0000002622697847.png?HW-CC-KV=V1&HW-CC-Date=20260611T063101Z&HW-CC-Expire=86400&HW-CC-Sign=4F607FE1B17479D262D30CDA7D6E5BDAD4B22E0C5674B08F70D4099AE227E1C4)
* onSurfaceChanged回调
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e8/v3/ZM-L8VCpQ8yeD6T68l4yLw/zh-cn_image_0000002592218286.png?HW-CC-KV=V1&HW-CC-Date=20260611T063101Z&HW-CC-Expire=86400&HW-CC-Sign=905A0D5A4FFE82854F9DFABDD82907B2676701A6DDD5B48564F933E31F91D5F5)
* onSurfaceDestroyed回调
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/7ifsqU_FQb2YexxYB9ZPSg/zh-cn_image_0000002592378220.png?HW-CC-KV=V1&HW-CC-Date=20260611T063101Z&HW-CC-Expire=86400&HW-CC-Sign=6464673D27616A536893DF950DBA9147E86E014BD2A285EA33606DAF686B6B57)

对于复杂的交互逻辑需跨语言开发，追求极致渲染性能或业务需求自主控制Surface的创建和销毁的，建议在Native侧使用[OH\_ArkUI\_SurfaceHolder](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/OH_ArkUI_SurfaceHolder/capi-nxcomp-arkui-surfaceholder.md>)管理Surface生命周期。其生命周期触发时机如下：
...
* OnSurfaceCreated回调
  ...
  2. 调用[OH\_ArkUI\_XComponent\_Initialize](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_interface_xcomponent.h/capi-native-interface-xcomponent-h.md#oh_arkui_xcomponent_initialize>)。

  Native侧OnSurfaceCreated的时序如下图：

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/1TEOpfeSTG6TJkYK_sYEEQ/zh-cn_image_0000002622857727.png?HW-CC-KV=V1&HW-CC-Date=20260611T063101Z&HW-CC-Expire=86400&HW-CC-Sign=45E8C048A157D2347332F58516FBB8595F5D4FE4E7F77434881D56C325254200)
* OnSurfaceChanged回调
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/fzDHawYxQ-eJW9CggG5GMw/zh-cn_image_0000002622697849.png?HW-CC-KV=V1&HW-CC-Date=20260611T063101Z&HW-CC-Expire=86400&HW-CC-Sign=877334FB37F7CEFF6ABD270F488F98DFF49D00B92204B55F587121ADC95DCE61)
* OnSurfaceDestroyed回调

  触发时刻：组件下树且autoInitialize=true 或者调用 [OH\_ArkUI\_XComponent\_Finalize](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_interface_xcomponent.h/capi-native-interface-xcomponent-h.md#oh_arkui_xcomponent_finalize>)后触发。

  Native侧OnSurfaceDestroyed的时序图：

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/GjUChy49Tx-wIIsgJOLiRQ/zh-cn_image_0000002592218288.png?HW-CC-KV=V1&HW-CC-Date=20260611T063101Z&HW-CC-Expire=86400&HW-CC-Sign=3A3BEABB3B9C54E53C0613C0F12EB6BDC23C368517196C8CE759FD1D7D4D52AA)
...
* 通过ArkTS声明式UI描述来创建组件并结合XComponentController实现对Surface生命周期的管理。
  ...
  [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ArkTSXComponent/entry/src/main/ets/pages/Index.ets#L15-L114)
* 通过ArkTS声明式UI描述来创建组件并结合OH\_ArkUI\_SurfaceHolders实现对Surface生命周期的管理。
  ...
  [SurfaceHolderDeclarative.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/ets/pages/SurfaceHolderDeclarative.ets#L15-L118)
  ...
  [plugin\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/cpp/manager/plugin_manager.cpp#L628-L671)
...
* 通过ArkTS自定义组件节点来创建组件并结合OH\_ArkUI\_SurfaceHolder实现对Surface生命周期的管理。
  ...
  [SurfaceHolderTypeNode.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/ets/pages/SurfaceHolderTypeNode.ets#L15-L220)
...
* 通过NDK接口来创建组件并使用OH\_ArkUI\_SurfaceHolder实现对Surface生命周期的管理。
  ...
  [SurfaceHolderNDK.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/ets/pages/SurfaceHolderNDK.ets#L15-L107)
  ...
  [plugin\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/cpp/manager/plugin_manager.cpp#L395-L454)
  ...
  [plugin\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/cpp/manager/plugin_manager.cpp#L341-L393)

## OH\_NativeXComponent向OH\_ArkUI\_SurfaceHolder的迁移

从API version 8开始，开发者可以通过基于[OH\_NativeXComponent](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/OH_NativeXComponent/capi-nxcomp-oh-nativexcomponent.md>)实例相关的接口进行XComponent组件Surface的生命周期监听、获取NativeWindow实例以及监听基础事件，实现渲染绘制和响应交互功能。但使用OH\_NativeXComponent相关的接口存在以下问题：
...
* OH\_NativeXComponent
  ...
  [NativeXComponentDeclarative.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/ets/pages/NativeXComponentDeclarative.ets#L45-L59)
* OH\_ArkUI\_SurfaceHolder
  ...
  [SurfaceHolderDeclarative.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/ets/pages/SurfaceHolderDeclarative.ets#L49-L66)
...
* OH\_NativeXComponent
  ...
  [plugin\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/cpp/manager/plugin_manager.cpp#L565-L607)
  ...
  [plugin\_render.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/cpp/render/plugin_render.cpp#L388-L411)
* OH\_ArkUI\_SurfaceHolder
  ...
  [plugin\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/cpp/manager/plugin_manager.cpp#L629-L672)
...
* OH\_NativeXComponent
  ...
  [plugin\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/cpp/manager/plugin_manager.cpp#L219-L287)
* OH\_ArkUI\_SurfaceHolder
  ...
  [plugin\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/cpp/manager/plugin_manager.cpp#L64-L73)
...
* OH\_NativeXComponent
  ...
  [plugin\_render.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/cpp/render/plugin_render.cpp#L396-L409)
* OH\_ArkUI\_SurfaceHolder
  ...
  [plugin\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponent/entry/src/main/cpp/manager/plugin_manager.cpp#L654-L661)
...
以下步骤通过在ArkTS侧创建SURFACE类型的XComponent为例（Native侧如何创建XComponent组件对应的ArkUI\_NodeHandle可参考[ArkUI\_NativeNodeAPI\_1](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeNodeAPI_1/capi-arkui-nativemodule-arkui-nativenodeapi-1.md>)），描述了如何使用XComponent组件调用OH\_ArkUI\_SurfaceHolder相关接口管理Surface生命周期，并在Native侧创建EGL/GLES环境，实现在主页面绘制图形，以及可以改变图形的颜色。
...
1. 在界面中定义XComponent。
   ...
   [PageThree.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponentSample/entry/src/main/ets/pages/PageThree.ets#L15-L210)
2. Node-API模块注册，具体使用请参考[Node-API开发规范](../../../../../NDK开发/代码开发/使用Node-API实现ArkTSJS与CC++语言交互/Node-API开发规范/napi-guidelines.md)。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponentSample/entry/src/main/cpp/napi_init.cpp#L15-L88)
3. 注册XComponent生命周期、事件、无障碍和可变帧率回调，使用CAPI实现往XComponent注册回调函数。
   ...
   [plugin\_manager.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponentSample/entry/src/main/cpp/manager/plugin_manager.h#L31-L107)
   ...
   [plugin\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponentSample/entry/src/main/cpp/manager/plugin_manager.cpp#L33-L656)
   ...
   [plugin\_manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponentSample/entry/src/main/cpp/manager/plugin_manager.cpp#L66-L123)
4. 初始化环境，包括初始化可用的EGLDisplay、确定可用的Surface配置、创建渲染区域Surface、创建并关联上下文等。
   ...
   [EGLConst.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponentSample/entry/src/main/cpp/render/EGLConst.h#L18-L158)
   ...
   [EGLRender.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponentSample/entry/src/main/cpp/render/EGLRender.h#L18-L52)
   ...
   [EGLRender.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeXComponentSample/entry/src/main/cpp/render/EGLRender.cpp#L15-L335)
5. CMakeLists，使用CMake工具链将C++源代码编译成动态链接库文件。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/m9PFMgLfTgCZSenuQIZQBQ/zh-cn_image_0000002592378222.jpeg?HW-CC-KV=V1&HW-CC-Date=20260611T063101Z&HW-CC-Expire=86400&HW-CC-Sign=E451B9B71E8AD04D8BEC71D96EF0225FE5DCE0BFE0BCA42736B94BF96FF3D506)
...
更多AVPlayer用法请参考[AVPlayer](<../../../../../../harmonyos-references/Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)。
...
1. 创建XComponent并传入XComponentController。
   ...
   [XComponentAVPlayer.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/VideoPlayer/entry/src/main/ets/pages/XComponentAVPlayer.ets#L127-L129)
2. 在XComponentController中注册onSurfaceCreated生命周期，并在其中获取surfaceId，将获取到的surfaceId和待播的视频源信息传递给AVPlayer。
   ...
   [XComponentAVPlayer.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/VideoPlayer/entry/src/main/ets/pages/XComponentAVPlayer.ets#L25-L43)
3. 初始化AVPlayer。
   ...
   [AVPlayerController.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/VideoPlayer/entry/src/main/ets/avplayertool/AVPlayerController.ets#L42-L177)
