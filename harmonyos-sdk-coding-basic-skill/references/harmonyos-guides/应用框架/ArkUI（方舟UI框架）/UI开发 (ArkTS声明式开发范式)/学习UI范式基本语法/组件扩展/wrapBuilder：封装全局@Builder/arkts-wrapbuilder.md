...
scraped_at: 2026-06-01T11:02:34+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:a5904f778b92f450719648a198df372c0b1c6a429a114a4d20259cbe255bc170
---
当在一个struct内使用多个全局@Builder函数实现UI的不同效果时，代码维护将变得非常困难，且页面不够整洁。此时，可以使用[wrapBuilder](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/组件扩展装饰器/wrapBuilder/ts-universal-wrapbuilder.md)封装全局@Builder。

在阅读本文档前，建议阅读：[@Builder](../@Builder装饰器：自定义构建函数/arkts-builder.md)。
...
从API version 22开始，推荐开发者使用[mutableBuilder](../mutableBuilder：实现全局@Builder动态更新/arkts-mutablebuilder.md)，支持二次赋值后刷新UI。
...
为了解决这一问题，引入wrapBuilder作为全局@Builder封装函数。wrapBuilder返回WrappedBuilder对象，用于[全局@Builder](../@Builder装饰器：自定义构建函数/arkts-builder.md#全局自定义构建函数)的赋值和传递。
...
1. wrapBuilder方法只能传入[全局@Builder](../@Builder装饰器：自定义构建函数/arkts-builder.md#全局自定义构建函数)方法。
...
[PageTwo.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/wrapbuilder/entry/src/main/ets/pages/PageTwo.ets#L15-L39)
...
[PageThree.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/wrapbuilder/entry/src/main/ets/pages/PageThree.ets#L15-L52)
...
[PageFour.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/wrapbuilder/entry/src/main/ets/pages/PageFour.ets#L15-L43)
...
[PageFive.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/wrapbuilder/entry/src/main/ets/pages/PageFive.ets#L15-L55)
