...
scraped_at: 2026-06-11T14:28:51+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:e89afacc97e0a865808c58194ea68afa10afb1b5564c97331c78de6a90aa65ca
---
当在一个自定义组件内使用多个全局[@Builder](../@Builder装饰器：自定义构建函数/arkts-builder.md)函数实现UI的不同效果时，代码维护将变得非常困难，且页面不够整洁。此时，可以使用[wrapBuilder](../wrapBuilder：封装全局@Builder/arkts-wrapbuilder.md)封装全局@Builder。但是wrapBuilder不支持动态切换@Builder，引入[mutableBuilder](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/组件扩展装饰器/mutableBuilder/ts-universal-mutablebuilder.md)实现全局@Builder的动态切换。
...
为了解决这一问题，引入mutableBuilder作为动态全局@Builder封装函数。mutableBuilder返回MutableBuilder对象，用于[全局@Builder](../@Builder装饰器：自定义构建函数/arkts-builder.md#全局自定义构建函数)的动态刷新。

## 接口说明

mutableBuilder是一个模板函数，返回一个[MutableBuilder](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/组件扩展装饰器/mutableBuilder/ts-universal-mutablebuilder.md#mutablebuilder-2)对象。相比[WrappedBuilder](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/组件扩展装饰器/wrapBuilder/ts-universal-wrapbuilder.md#wrappedbuilder)，MutableBuilder可以实现动态切换全局@Builder。

```
1. declare function mutableBuilder<Args extends Object[]>(builder: BuilderCallback): MutableBuilder<Args>;
```

同时MutableBuilder对象是一个模板类，继承自[WrappedBuilder](../wrapBuilder：封装全局@Builder/arkts-wrapbuilder.md#接口说明)。
...
1. mutableBuilder方法只能传入[全局@Builder](../@Builder装饰器：自定义构建函数/arkts-builder.md#全局自定义构建函数)方法，传入局部@Builder方法编译时报错。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/nmyEaFb1QtK6emoR4Fsw1g/zh-cn_image_0000002592217972.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062850Z&HW-CC-Expire=86400&HW-CC-Sign=AFEC1380BC2CB482783DEC8CA526B005B6CAED6E0BB9366B8DC9896E91920F9B)
...
mutableBuilder对应的@Builder函数中可使用[MutableBinding](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.StateManagement (状态管理)/js-apis-statemanagement.md#mutablebindingt20>)进行包裹来观察状态变量的变化，同时可通过[@Monitor](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-monitor)或[addMonitor](../../../学习UI范式状态管理/辅助接口/addMonitorclearMonitor接口：动态添加取消监听/arkts-new-addmonitor-clearmonitor.md)监听mutableBuilder中@Builder的变化。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/1g_RLscFQR6zHktZE8Znpg/zh-cn_image_0000002592377906.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062850Z&HW-CC-Expire=86400&HW-CC-Sign=F9B368B7D5516DFED317C38B581C9A0934A2B7CB8E417CA40C47ED87915D13F2)
