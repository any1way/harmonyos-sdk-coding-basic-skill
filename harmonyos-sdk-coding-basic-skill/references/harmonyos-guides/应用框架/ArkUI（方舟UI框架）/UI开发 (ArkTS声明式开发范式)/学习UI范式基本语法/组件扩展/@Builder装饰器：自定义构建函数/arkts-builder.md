...
scraped_at: 2026-06-11T14:28:46+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:4f2d4d31e500c488c33979895198fa443de468af722823eca9908191b9f6e85f
---
ArkUI提供轻量的UI元素复用机制@Builder，其内部UI结构固定，仅与使用方进行数据传递。开发者可将重复使用的UI元素抽象成函数，在build函数中调用。

@Builder装饰的函数也称为“自定义构建函数”。

在阅读本文档前，建议提前阅读：[基本语法概述](../../基本语法概述/arkts-basic-syntax-overview.md)、[声明式UI描述](../../声明式UI描述/arkts-declarative-ui-description.md)、[自定义组件-创建自定义组件](../../自定义组件/创建自定义组件/arkts-create-custom-components.md)。

@Builder装饰器和[@Component装饰器](../../自定义组件/创建自定义组件/arkts-create-custom-components.md#component)在功能和使用方式上的主要差异：

1. @Builder装饰器用于封装可复用的UI结构，通过提取重复的布局代码提高开发效率。该装饰器严格禁止在其内部定义[状态变量](../../../学习UI范式状态管理/状态管理术语/arkts-state-management-glossary.md#state-variables状态变量)或使用[自定义组件的生命周期函数](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md)，必须通过参数传递或者访问所属组件的状态变量完成数据交互。
...
[PrivateCustomConstructor.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/PrivateCustomConstructor.ets#L15-L43)
...
[GlobalCustomConstructor.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/GlobalCustomConstructor.ets#L15-L31)
...
* @Builder内UI语法遵循[UI语法规则](../../自定义组件/创建自定义组件/arkts-create-custom-components.md#build函数实现规则)。
...
[ParameterMakeBinding.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/ParameterMakeBinding.ets#L15-L53)
...
[ParameterReference.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/ParameterReference.ets#L15-L44)
...
[ParameterValue.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/ParameterValue.ets#L15-L34)

## 限制条件

1. @Builder装饰的函数内部在没有使用[MutableBinding](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.StateManagement (状态管理)/js-apis-statemanagement.md#mutablebindingt20>)时不允许修改参数值，修改不会触发UI刷新。若[按引用传递参数](arkts-builder.md#按引用传递参数)且仅传入一个参数时，修改参数内部的属性会抛出运行时错误。使用MutableBinding可以帮助开发者在@Builder装饰的函数内部修改参数值，请参考[在@Builder装饰的函数内部修改入参内容](arkts-builder.md#在builder装饰的函数内部修改入参内容)。
...
5. 不允许在@Builder函数里修改参数的属性，否则会抛出运行时错误，从API version 23开始，将返回错误码[140109](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/错误码/UI界面/状态管理错误码/errorcode-statemanagement.md#section140109-builder非法触发参数属性赋值)，示例请参考[在@Builder装饰的函数内部修改入参内容](arkts-builder.md#在builder装饰的函数内部修改入参内容)。

## 使用场景

### 自定义组件内使用自定义构建函数

创建私有的@Builder函数，在Column中使用this.builder()调用。通过[aboutToAppear](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoappear)生命周期函数和按钮的点击事件更新builderValue，实现UI的动态渲染。
...
[InCustomComponent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/InCustomComponent.ets#L15-L60)

示例效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/df/v3/9NCY9pIcQpelvyL_vUf8Qg/zh-cn_image_0000002622697523.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062844Z&HW-CC-Expire=86400&HW-CC-Sign=01BF52EEE6269288664B8ADD4E60D203EDB6210B5F140996BD7E973DAC52168A)
...
[GlobalCustomBuilder.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/GlobalCustomBuilder.ets#L15-L99)

示例效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/rV82YtRGQDyflb97k-vzhw/zh-cn_image_0000002592217962.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062844Z&HW-CC-Expire=86400&HW-CC-Sign=DF3744D3D773BA1E9D97D533720DB14DF1BBDF2148336AAE9EAF49781C67EDF3)
...
[ChangingByDecorator.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/ChangingByDecorator.ets#L15-L62)

示例效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1/v3/K5SZSN4SSxORXQrt9SUWzQ/zh-cn_image_0000002592377896.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062844Z&HW-CC-Expire=86400&HW-CC-Sign=AC2270F6F87E56D4CE95CC24458B5B29625DEE3468A21444B1BCC69A3F85A30F)

### 将@Builder装饰的函数当作CustomBuilder类型使用

当参数类型为[CustomBuilder](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8)时，可以传入定义的@Builder函数。因为CustomBuilder实际上是Function(() => any)或void类型，而@Builder也是Function类型。所以通过传入@Builder可以实现特定效果。
...
[AsCustomBuilder.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/AsCustomBuilder.ets#L15-L68)

示例效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/Nm24_TS0Q-GQcVvhnzOAtQ/zh-cn_image_0000002622857403.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062844Z&HW-CC-Expire=86400&HW-CC-Sign=C41B8CAE10D982EF3890BF60831EE90825E32B0064B2D28EAC3CF09030EE0E24)
...
[NestedBuilderFunctions.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/NestedBuilderFunctions.ets#L15-L143)

示例效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/seTJpUM4TpK8YLhFEEbBzQ/zh-cn_image_0000002622697525.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062844Z&HW-CC-Expire=86400&HW-CC-Sign=6361672169CAEECB03EDE16B7AF17E5A434FE4A949AA7DAD4BEE18E013302ED2)
...
[BuilderCombined.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/BuilderCombined.ets#L15-L105)

示例效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/4gmRJ7pRQx-JYxLXBq_6sQ/zh-cn_image_0000002592217964.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062844Z&HW-CC-Expire=86400&HW-CC-Sign=96884C13017C3D593A3F9841FC99E9BF1DB19B940093F35EBE141C81B688D604)

当通过引用传递方式向@Builder传递参数时，若参数为[@Local](../../../学习UI范式状态管理/状态管理（V2）/管理组件拥有的状态/@Local装饰器：组件内部状态/arkts-new-local.md)装饰的对象，对该对象进行整体赋值会触发@Builder中UI刷新。
...
[BuilderCombinedLocal.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/BuilderCombinedLocal.ets#L15-L97)

示例效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/Mg2TlRy4SFetS9EcZLsH5Q/zh-cn_image_0000002592377898.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062844Z&HW-CC-Expire=86400&HW-CC-Sign=A31F2C26C826E276F2426EFA62D30F4DA3201A935105EB79B73D3F068AB9F841)
...
[AcrossComponents.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/AcrossComponents.ets#L15-L105)

示例效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/R9wytz99QZe21RQ2-Qxk9Q/zh-cn_image_0000002622857405.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062844Z&HW-CC-Expire=86400&HW-CC-Sign=D052659F594F6A51D34D33C8C38BCACFC5CC5C7C484A694D40E104CB9F2EDDF7)

### @Builder支持状态变量刷新

从API version 20开始，开发者可以通过使用UIUtils.makeBinding()函数、Binding类和MutableBinding类实现@Builder函数中状态变量的刷新。详情请参考[makeBinding](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.StateManagement (状态管理)/js-apis-statemanagement.md#makebinding20>)。
...
[BuilderSupports.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/BuilderSupports.ets#L15-L125)

示例效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/07/v3/qLakRjisQiGB8igSj-AEhQ/zh-cn_image_0000002622697527.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062844Z&HW-CC-Expire=86400&HW-CC-Sign=0143E604D249A5C9148266FF159DB70A233475DF8753C11AC42470590702CF92)
...
[MultipleIncorrectUsage1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/MultipleIncorrectUsage1.ets#L15-L49)
...
[MultipleIncorrectUsage2.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/MultipleIncorrectUsage2.ets#L15-L51)
...
[MultipleCorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/MultipleCorrectUsage.ets#L15-L47)
...
在[@ComponentV2](../../自定义组件/创建自定义组件/arkts-create-custom-components.md#componentv2)装饰的自定义组件中，使用简单数据类型不可以触发UI的刷新。
...
[DynamicIncorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/DynamicIncorrectUsage.ets#L15-L56)
...
[DynamicCorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/DynamicCorrectUsage.ets#L15-L98)
...
[BuilderIncorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/BuilderIncorrectUsage.ets#L15-L67)
...
[BuilderCorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/BuilderCorrectUsage.ets#L15-L68)
...
[OutsideIncorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/OutsideIncorrectUsage.ets#L15-L71)
...
[OutsideCorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/OutsideCorrectUsage.ets#L15-L68)
...
[AccessorIncorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/AccessorIncorrectUsage.ets#L15-L51)

使用规格详见状态管理API文档中的[MutableBinding](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.StateManagement (状态管理)/js-apis-statemanagement.md#mutablebindingt20>)。
...
[AccessorCorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/AccessorCorrectUsage.ets#L15-L55)

### 在@Builder装饰的函数内部修改入参内容

不使用[MutableBinding](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.StateManagement (状态管理)/js-apis-statemanagement.md#mutablebindingt20>)的情况下，在@Builder装饰的函数内部修改参数值，修改不会生效且可能造成运行时错误。从API version 23开始，将返回错误码[140109](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/错误码/UI界面/状态管理错误码/errorcode-statemanagement.md#section140109-builder非法触发参数属性赋值)。
...
[ChangingIncorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/ChangingIncorrectUsage.ets#L15-L78)

正确使用[MutableBinding](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.StateManagement (状态管理)/js-apis-statemanagement.md#mutablebindingt20>)可以帮助开发者在@Builder装饰的函数内部修改参数值。
...
[ChangingCorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/ChangingCorrectUsage.ets#L15-L94)

### 在@Watch函数中执行@Builder函数

在[@Watch](../../../学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Watch装饰器：状态变量更改通知/arkts-watch.md)函数中执行@Builder函数，会导致UI刷新异常。
...
[WatchIncorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/WatchIncorrectUsage.ets#L15-L42)
...
[WatchCorrectUsage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/BuilderComponent/entry/src/main/ets/pages/WatchCorrectUsage.ets#L15-L42)
