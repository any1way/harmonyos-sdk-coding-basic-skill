...
scraped_at: 2026-06-11T14:28:41+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:73a9fe3e44a8fcec5bb816f9c7abaef104702d68288ee3b1b0ee9047a4c0f9f6
---
...
在阅读本文档前，开发者需要了解自定义组件基本语法。建议提前阅读：[自定义组件](../../创建自定义组件/arkts-create-custom-components.md)。
...
从API version 20开始，通过配置[BuilderNode](<../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/BuilderNode/js-apis-arkui-buildernode.md>)的[inheritFreezeOptions](<../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/BuilderNode/js-apis-arkui-buildernode.md#inheritfreezeoptions20>)接口为true，实现BuilderNode继承冻结的能力。

## 概述

组件冻结的工作原理是：

1. 开发者通过设置[freezeWhenInactive](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件参数/ts-custom-component-parameter.md#componentoptions)属性，即可激活组件冻结机制。
...
1. [页面路由](<../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.router (页面路由)(不推荐)/js-apis-router.md>)：当前栈顶页面为active状态，非栈顶不可见页面为inactive状态。
2. [TabContent](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md)：只有当前显示的TabContent中的自定义组件处于active状态，其余则为inactive。
3. [LazyForEach](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)：仅当前显示的LazyForEach中的自定义组件为active状态，而缓存节点的组件则为inactive状态。
4. [Navigation](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)：当前显示的NavDestination中的自定义组件为active状态，而其他未显示的NavDestination组件则为inactive状态。需要注意，本文档中涉及的“激活（active）/非激活（inactive）”是指组件冻结的激活/非激活状态，和[NavDestination](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件中的[onActive](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md#onactive17)和[onInactive](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md#oninactive17)不同。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/5-nSK3MRT8Gwkl1ZTaREOw/zh-cn_image_0000002592217950.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=1662712CA801F60B5AE425ACF682D82CAC5117C94A33ACD96B08A924E9BE0E4D)
...
[Page1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/CustomComponentsFreeze/entry/src/main/ets/View/Page1.ets#L15-L49)
...
[PageTwo.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/CustomComponentsFreeze/entry/src/main/ets/View/PageTwo.ets#L15-L43)

在上面的示例中：

1.在页面1中点击first page storageLink + 1，storageLink状态变量改变，[@Watch](../../../../学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Watch装饰器：状态变量更改通知/arkts-watch.md)注册的方法first会被调用。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/u1Dw4IzyRuS7wQ1wmbiMJw/zh-cn_image_0000002592377884.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=33934EC36A6E972A1DDA153D319DBBB948630EF5B32D2A8896419C914EEA56F6)
...
[TabContentTest.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/CustomComponentsFreeze/entry/src/main/ets/View/TabContentTest.ets#L15-L65)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/Vx27g8UZSlGp9nISI6Yz7Q/zh-cn_image_0000002622857391.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=8E6DF89323318FE2A53B30B66532A00727DBD42AE4D4DA0BF950E0C7CBD3B608)
...
[LazyforEachTest.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/CustomComponentsFreeze/entry/src/main/ets/View/LazyforEachTest.ets#L15-L156)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/ct40MfEESxCVfaQxd1URag/zh-cn_image_0000002622697513.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=FA35B53BC9D13B37F0EC18FDCB1C54E1040E8456960BE4616676E74E3ECB3776)
...
[MyNavigationTestStack.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/CustomComponentsFreeze/entry/src/main/ets/View/MyNavigationTestStack.ets#L15-L202)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/gnXMUeSlQtK0jxf4p0GyOA/zh-cn_image_0000002592217952.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=7931E4E378104BEAB13B58E937CF5BCB56D730456E8525E292BB81A5DAB90F10)

### 组件复用

[组件复用](../../自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md)通过重利用缓存池中已存在的节点，而非创建新节点，来优化UI性能并提升应用流畅度。复用池中的节点尽管未在UI组件树上展示，但是状态变量的更改仍会触发UI刷新。为了解决复用池中组件异常刷新问题，可以使用组件冻结避免复用池中的组件刷新。
...
[ComponentReuse.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/CustomComponentsFreeze/entry/src/main/ets/View/ComponentReuse.ets#L16-L72)
...
2. 点击change desc，触发Page的成员变量desc的变化：
   * desc是@State装饰的，其变化会通知给其子组件ChildComponent[@Link](../../../../学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Link装饰器：父子双向同步/arkts-link.md)装饰的desc。
...
3. 再次点击change flag，改变flag为true：
   ...
   * 回调aboutToReuse生命周期，将当前最新的count值同步给子组件。desc是通过[@State](../../../../学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@State装饰器：组件内状态/arkts-state.md)到@Link同步的，所以无需开发者手动在aboutToReuse中赋值。
   * 设置ChildComponent为active状态，并且刷新在inactive时没有刷新的组件，在当前例子中，就是Text(ChildComponent desc: ${this.desc})。

**LazyForEach、组件复用和组件冻结混用场景**

在数据很多的长列表滑动场景下，开发者会使用LazyForEach来按需创建组件，同时配合组件复用降低在滑动过程中因创建和销毁组件带来的开销。但是开发者如果根据其复用类型不同，设置了[reuseId](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/其他/复用标识/ts-universal-attributes-reuse-id.md#reuseid)，或者为了保证滑动性能设置了较大的cacheCount，这就可能使复用池或者LazyForEach缓存较多的节点。在这种情况下，如果开发者触发List下所有子节点的刷新，就会带来节点刷新数量过多的问题，这个时候，可以考虑搭配组件冻结使用。
...
[ComponentReuse1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/CustomComponentsFreeze/entry/src/main/ets/View/ComponentReuse1.ets#L15-L168)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/j58ADPxRSLOGfxSzAhR8iQ/zh-cn_image_0000002592377886.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=DDAD7036E1A2B13B5BD176E782A2DDB6C3FB4A4DFD5243731B8785BD3B42CD0A)

可通过trace观察，仅触发了15个ChildComponent节点的刷新。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/QqSTGyzGS8G3lUFt7gIE5Q/zh-cn_image_0000002622857393.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=479BBF9797002D3888250C79CD154D88704693A409F8A5AB6936F609D1396974)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/VD5btyZHTduinmLU2Jc-Sw/zh-cn_image_0000002622697515.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=5144E23698B5BD7FE8518391EAEFF7CC6370FC29EB8B6ECC46D6AFE0A91C110A)

没有开启组件冻结trace：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/bhIId0ZHSaS8ytQ31Fl4ag/zh-cn_image_0000002592217954.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=791F1C4CD1416C551937F292F9C5646043383DF0DC0B7593C7FB02853308832F)
...
[ComponentMixing.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/CustomComponentsFreeze/entry/src/main/ets/View/ComponentMixing.ets#L15-L185)

代码运行结果图如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/hh1f1iKCSZC8KoCnbGeIoQ/zh-cn_image_0000002592377888.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=E139BE396A2E56305E79F8098581FF8E4FAD54D9B3981C562C1C93AD46FD1783)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/jJwslDqHRc6Uf0A9iStcig/zh-cn_image_0000002622857395.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=D074B8E43F2EBEC48173DAEEB7DD3D8359F98C9E070CF20E185B4F63FB48B2AA)

切换到DelayUpdate标签，点击Incr state，日志中查询Appmonitor，存在2个打印。DelayUpdate中状态变量不会刷新与Update标签中相关的状态变量。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/NdKN6tnBS3WA2NiTWyl--Q/zh-cn_image_0000002622697517.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=1A7685ABDA4B897826D14705941B6BD8695F46B53359385F4BD9086F2C56BE48)

在API version 17及以下：

点击Next page进入下一个页面并返回，标签默认在DelayUpdate，再次点击Incr state，日志中查询Appmonitor，存在4个打印，页面路由返回时，会解冻Tabcontent所有的标签。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/jjXPpeqMRHSZ3AzcclVoPw/zh-cn_image_0000002592217956.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=6A91BF7381B097C6C43650B53E38784AF2B8CD0758F93CC507CEA8FEDB2D259C)

在API version 18及以上：

点击Next page进入下一个页面并返回，标签默认在DelayUpdate，再次点击Incr state，日志中查询Appmonitor，存在2个打印，页面路由返回时，只会解冻对应标签的节点。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/vqHyNKR4TACewWc6iDTN3A/zh-cn_image_0000002592377890.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=D638C2B62DEA8CC1921FCCACA0054534B7F86EA319BDF20A72A3B45B8F8744CC)
...
[ComponentMixing1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/CustomComponentsFreeze/entry/src/main/ets/View/ComponentMixing1.ets#L15-L175)

在组件复用场景中，已经对LazyForEach的节点进行了详细说明，分为屏上节点和cachedCount节点。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/02/v3/sqO4Qc4-QFyBA8LI-YWwAw/zh-cn_image_0000002622857397.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=C9EBA00612F1F9DAAFB1A06AC5F5CD79644C2AD8C55E76DFA0030175A645C5EC)

向下滑动LazyForEach，让cachedCount补充节点，点击add sum，搜索打印日志：sum: Change，出现了8条打印。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/VYDQGo-5RsO5FBY405zp7Q/zh-cn_image_0000002622697519.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=FDD54082D89F145AC6D5ABE7B62F637A172050696AA75862756155B9949472D6)

在API version 17及以下：

灭屏之后亮屏，触发OnPageShow，点击add sum，打印数量为屏上节点与cachedCount数量的总和。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/gPe2GQ4KQUOYI_N0Je-YuQ/zh-cn_image_0000002592217958.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=3B466C0A173D77250CB019563BAA563FC9E1A7ABFDEA889DEC4D0E05D8C10190)

从API version 18开始：

灭屏之后亮屏，触发OnPageShow，点击add sum，只会打印屏上节点数量，不会再解冻cachedCount中的节点。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/2u0qly7xQ3e0OSserc2Psg/zh-cn_image_0000002592377892.png?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=AA8C47DC9EEF6D812763F87DD1906C8DE16936B54AAEB8E608DEAAE6B2E56759)

## 限制条件

### BuilderNode无法继承父组件冻结

在API version 20之前，BuilderNode无法继承父组件冻结。如下面的例子所示，FreezeBuildNode中使用了自定义节点[BuilderNode](<../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/BuilderNode/js-apis-arkui-buildernode.md>)。BuilderNode可以通过命令式动态挂载组件，而组件冻结又是强依赖父子关系来通知是否开启组件冻结。如果父组件使用组件冻结，且组件树的中间层级上又启用了BuilderNode，则BuilderNode的子组件将无法被冻结。
...
[Constraints.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/CustomComponentsFreeze/entry/src/main/ets/View/Constraints.ets#L15-L119)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/84/v3/sHFX-TldQfGiY-ihwl8d4g/zh-cn_image_0000002622857399.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062837Z&HW-CC-Expire=86400&HW-CC-Sign=BA85D3BD422220B3EEC945E85ACF85A1A77D21AC229687AD94AE53EA467F2EE1)
...
当if组件绑定的状态变量condition修改为true时，子组件ChildComponent出复用池并被标记为active状态，但不会触发状态变量count绑定的Watch回调。这是因为组件复用的执行逻辑早于组件解冻的执行逻辑。子组件被复用时会将[脏节点刷新](../../../../学习UI范式状态管理/状态管理原理介绍/arkts-state-management-introduce.md#触发更新)（包括在冻结期间需要延迟刷新的[变量绑定的系统组件](../../../../学习UI范式状态管理/状态管理原理介绍/arkts-state-management-introduce.md#收集依赖)），并清空脏节点列表。在子组件被复用后，重新被标记为active状态，此时子组件执行解冻逻辑，由于复用时清空了脏节点列表，所以此时判断冻结期间无变量改变，不会触发Watch回调。
...
[FreezeReuse.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/CustomComponentsFreeze/entry/src/main/ets/View/FreezeReuse.ets#L15-L75)
