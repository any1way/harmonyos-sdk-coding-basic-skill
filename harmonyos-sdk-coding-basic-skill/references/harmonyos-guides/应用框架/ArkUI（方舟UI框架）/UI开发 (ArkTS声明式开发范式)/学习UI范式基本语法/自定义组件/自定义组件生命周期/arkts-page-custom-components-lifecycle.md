...
scraped_at: 2026-06-11T14:28:28+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:4b56588d1a8acf8f9e87aa4842dd2253b0963fd7582f724c7567060da25a9cb4
---
自定义组件生命周期，即用[@Component](../创建自定义组件/arkts-create-custom-components.md#component)或[@ComponentV2](../创建自定义组件/arkts-create-custom-components.md#componentv2)装饰的自定义组件的生命周期，提供以下生命周期接口：

* [aboutToAppear](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoappear)：组件即将出现时回调该接口，具体时机为在创建自定义组件的新实例后，在执行其build函数之前执行。
* [onDidBuild](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#ondidbuild12)：在组件首次渲染触发的build函数执行完成之后回调该接口，后续组件重新渲染将不回调该接口。开发者可以在这个阶段实现埋点数据上报等不影响实际UI的功能。
* [aboutToDisappear](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttodisappear)：aboutToDisappear函数在自定义组件析构销毁之前执行。不允许在aboutToDisappear函数中改变状态变量，特别是[@Link变量](../../../学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Link装饰器：父子双向同步/arkts-link.md)的修改可能会导致应用程序行为不稳定。

说明

页面生命周期及其相关内容参考[页面路由](<../../../设置组件导航和页面路由/页面路由 (@ohos.router)(不推荐)/arkts-routing.md#生命周期>)。

自定义组件生命周期流程如下图所示。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/x1_IlcdARcWjwt6utVdrWg/zh-cn_image_0000002622857383.png?HW-CC-KV=V1&HW-CC-Date=20260611T062827Z&HW-CC-Expire=86400&HW-CC-Sign=E983A6E2D06655683C438AC732226800D76E1250C3F9998064E78A4DF5FF97B1)
...
当触发事件（比如点击）改变状态变量时，或者[LocalStorage](../../../学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md) / [AppStorage](../../../学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/AppStorage：应用全局的UI状态存储/arkts-appstorage.md)中的属性更改，并导致绑定的状态变量更改其值时：
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/CustomLifecycle/entry/src/main/ets/pages/parent/Index.ets#L16-L86)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/2vOguewtT8ePOYQ09i8hTg/zh-cn_image_0000002622697505.png?HW-CC-KV=V1&HW-CC-Date=20260611T062827Z&HW-CC-Expire=86400&HW-CC-Sign=9F0B464345D8D340E37E96123EB8FC2EC63253D6806D3D710178ED4292B2140E)
