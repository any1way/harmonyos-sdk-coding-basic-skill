...
scraped_at: 2026-06-01T11:02:22+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:62d6f6fbe516adadce2cf70803d8a60953dd632b5fe0133c6a6f2c1ddd90f9ef
---
...
关于组件复用的原理与使用、优化方法、适用场景，请参考[组件复用最佳实践](../../../../../../../../best-practices/组件封装与复用/组件复用/bpta-component-reuse.md)。
...
* @Reusable提供了[aboutToRecycle](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttorecycle10)和[aboutToReuse](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoreuse10)两个生命周期，在组件被回收时调用aboutToRecycle，在组件被复用时调用aboutToReuse。开发者可以在这两个生命周期中实现组件回收、复用相关的业务逻辑。
* @Reusable装饰的自定义组件下有子组件时，会在回收和复用时递归调用子组件的aboutToRecycle和aboutToReuse（与子组件是否被@Reusable标记无关），直到遍历完所有子组件。
* 组件复用前后应保持组件结构不变。针对组件结构存在差异的场景，可以使用[reuseId](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/其他/复用标识/ts-universal-attributes-reuse-id.md#reuseid)来区分不同结构的复用组件。
...
@Reusable装饰器仅用于自定义组件[@Component](../../创建自定义组件/arkts-create-custom-components.md#component)，不可与[@Builder](../../../组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md)搭配使用。

@Reusable不支持跟[@ComponentV2](../../创建自定义组件/arkts-create-custom-components.md#componentv2)搭配使用，@ComponentV2组件复用推荐[@ReusableV2装饰器](../@ReusableV2装饰器：V2组件复用/arkts-new-reusablev2.md)。
...
[ReusableForCustomComponents.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ReusableForCustomComponents.ets#L16-L69)
...
[ReusableIncorrectSample.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ReusableIncorrectSample.ets#L16-L94)
...
[ReusableCorrectSample.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ReusableCorrectSample.ets#L16-L96)
...
[ReusableForIncorrectReuseId.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ReusableForIncorrectReuseId.ets#L16-L106)
...
[ReusableForReuseId.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ReusableForReuseId.ets#L16-L108)
...
[ComponentContentNotSupportReusable.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ComponentContentNotSupportReusable.ets#L16-L70)
...
[DynamicLayoutUpdate.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/DynamicLayoutUpdate.ets#L16-L68)
...
[ListScrollingWithLazyForEach.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ListScrollingWithLazyForEach.ets#L16-L91)
...
[ListScrollingWithIfStatements.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ListScrollingWithIfStatements.ets#L16-L145)
...
[ListScrollingWithForEach.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ListScrollingWithForEach.ets#L16-L152)
...
需要注意的是无需在aboutToReuse中对[@Link](../../../../学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Link装饰器：父子双向同步/arkts-link.md)、[@StorageLink](../../../../学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/AppStorage：应用全局的UI状态存储/arkts-appstorage.md#storagelink)、[@ObjectLink](../../../../学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Observed装饰器和@ObjectLink装饰器：嵌套类对象属性变化/arkts-observed-and-objectlink.md)、[@Consume](../../../../学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Provide装饰器和@Consume装饰器：与后代组件双向同步/arkts-provide-and-consume.md)等自动更新值的状态变量进行更新，可能触发不必要的组件刷新。
...
[ReusableForGridUsageScenario.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ReusableForGridUsageScenario.ets#L16-L101)
...
* 在WaterFlow滑动场景中，FlowItem及其子组件频繁创建和销毁。可以将FlowItem中的组件封装成自定义组件，并使用@Reusable装饰器修饰，实现组件复用。
  ...
  [ReusableForWaterFlowUsageScenario.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ReusableForWaterFlowUsageScenario.ets#L16-L156)
...
* 在Swiper滑动场景中，条目中的子组件频繁创建和销毁。可以将这些子组件封装成自定义组件，并使用@Reusable装饰器修饰，以实现组件复用。
  ...
  [ReusableForSwiperUsageScenario.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ReusableForSwiperUsageScenario.ets#L16-L154)
...
* 可以视作特殊List滑动场景，将ListItem需要移除重建的子组件封装成自定义组件，并使用@Reusable装饰器修饰，使其具备组件复用能力。
  ...
  [ReusableForListItemGroupUsageScenario.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ReusableForListItemGroupUsageScenario.ets#L16-L201)
...
[ReusableForLimitedVariation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ReusableForLimitedVariation.ets#L16-L99)
...
[ReusableForComposite.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ReusableComponent/entry/src/main/ets/pages/ReusableForComposite.ets#L16-L216)
