...
scraped_at: 2026-06-11T14:32:16+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:fa179a5a38281921888e6c3321792a018bc46e19501f5fcaccdca294c0d3318b
---
为了实现更好的转场效果，推荐使用[Navigation转场动画](<../../../设置组件导航和页面路由/组件导航(Navigation) (推荐)/Navigation转场动画/arkts-navigation-animation.md>)和[模态转场](../模态转场/arkts-modal-transition.md)。

两个页面间发生跳转，一个页面消失，另一个页面出现，这时可以配置各自页面的页面转场参数实现自定义的页面转场效果。[页面转场](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/动画/页面间转场 (pageTransition)/ts-page-transition-animation.md>)效果写在pageTransition函数中，通过[PageTransitionEnter](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/动画/页面间转场 (pageTransition)/ts-page-transition-animation.md#pagetransitionenter>)和[PageTransitionExit](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/动画/页面间转场 (pageTransition)/ts-page-transition-animation.md#pagetransitionexit>)指定页面进入和退出的动画效果。
...
上述接口定义了PageTransitionEnter和PageTransitionExit组件，可通过[slide](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/动画/页面间转场 (pageTransition)/ts-page-transition-animation.md#slide>)、[translate](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/动画/页面间转场 (pageTransition)/ts-page-transition-animation.md#translate>)、[scale](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/动画/页面间转场 (pageTransition)/ts-page-transition-animation.md#scale>)、[opacity](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/动画/页面间转场 (pageTransition)/ts-page-transition-animation.md#opacity>)属性定义不同的页面转场效果。对于PageTransitionEnter而言，这些效果表示入场时起点值，对于PageTransitionExit而言，这些效果表示退场的终点值，这一点与组件转场[transition](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/动画/组件内转场 (transition)/ts-transition-animation-component.md>)配置方法类似。此外，PageTransitionEnter提供了onEnter接口进行自定义页面入场动画的回调，PageTransitionExit提供了onExit接口进行自定义页面退场动画的回调。

上述接口中的参数type，表示路由生效的类型，这一点开发者容易混淆其含义。页面转场的两个页面，必定有一个页面退出，一个页面进入。如果通过[pushUrl](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (Router)/arkts-apis-uicontext-router.md#pushurl>)操作从页面A跳转到页面B，则页面A退出，做页面退场动画，页面B进入，做页面入场动画。如果通过[back](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (Router)/arkts-apis-uicontext-router.md#back>)操作从页面B返回到页面A，则页面B退出，做页面退场动画，页面A进入，做页面入场动画。即页面的PageTransitionEnter既可能是由于新增页面(push，入栈)引起的新页面的入场动画，也可能是由于页面返回(back，或pop，出栈)引起的页面栈中老页面的入场动画，为了能区分这两种形式的入场动画，提供了type参数，这样开发者能完全定义所有类型的页面转场效果。
...
[PageTransitionSrc3.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Animation/entry/src/main/ets/pages/pageTransition/template5/PageTransitionSrc3.ets#L45-L55)
...
[PageTransitionDst3.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Animation/entry/src/main/ets/pages/pageTransition/template5/PageTransitionDst3.ets#L45-L55)
...
[type](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/动画/页面间转场 (pageTransition)/ts-page-transition-animation.md#pagetransitionoptions对象说明>)为[RouteType.Push](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/动画/页面间转场 (pageTransition)/ts-page-transition-animation.md#routetype枚举说明>)表示仅对页面栈的push操作生效，type为RouteType.Pop表示仅对页面栈的pop操作生效。
...
[PageTransitionSrc4.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Animation/entry/src/main/ets/pages/pageTransition/template6/PageTransitionSrc4.ets#L45-L61)
...
[PageTransitionDst4.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Animation/entry/src/main/ets/pages/pageTransition/template6/PageTransitionDst4.ets#L45-L61)
...
下面介绍了利用[pushUrl](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (Router)/arkts-apis-uicontext-router.md#pushurl>)跳转能力定义了所有的四种页面转场样式的页面转场动画示例。
...
[pageTransitionSrc1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Animation/entry/src/main/ets/pages/pageTransition/template3/pageTransitionSrc1.ets#L15-L62)
...
[pageTransitionDst1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Animation/entry/src/main/ets/pages/pageTransition/template3/pageTransitionDst1.ets#L15-L62)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0e/v3/6ALP17A9Rv6ea5pjQ0mCvA/zh-cn_image_0000002622697951.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063214Z&HW-CC-Expire=86400&HW-CC-Sign=5EB9601C789B95571CC801E7EB5F4CBE5E2B0CC178FA79976A160A077531A912)
...
[pageTransitionSrc2.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Animation/entry/src/main/ets/pages/pageTransition/template4/pageTransitionSrc2.ets#L15-L57)
...
[pageTransitionDst2.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Animation/entry/src/main/ets/pages/pageTransition/template4/pageTransitionDst2.ets#L15-L57)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4/v3/rt5qpHL1TdiYeEeIHecEKQ/zh-cn_image_0000002592218390.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063214Z&HW-CC-Expire=86400&HW-CC-Sign=49B6B2FDD26DC0CACA9B57974D47DD9FF08B8454B254476D971A287DF507B43F)
