...
scraped_at: 2026-06-11T14:30:28+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:ca9729683ef3e5cbf5c67000bf9dc6b61fb899aa641494c09b28be452fac11b8
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3/v3/7f2LF8v8RQ61sIwd-xUQ5w/zh-cn_image_0000002592378088.png?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=BBB4BE17019F4296B9EF19B2D89518BF55D13A966C5B83F382755C88F0E52FB9)
...
可以通过调用窗口强制全屏布局接口[setWindowLayoutFullScreen()](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setwindowlayoutfullscreen9>)实现界面元素延伸到状态栏和导航区域；然后通过接口[getWindowAvoidArea()](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#getwindowavoidarea9>)和[on('avoidAreaChange')](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#onavoidareachange9>)获取并动态监听避让区域的变更信息，页面布局根据避让区域信息进行动态调整；设置状态栏或导航区域的颜色或显隐等属性与界面元素进行匹配。
...
1. 调用setWindowLayoutFullScreen()接口设置窗口全屏。
   ...
   26. }
   ```
2. 使用[getWindowAvoidArea()](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#getwindowavoidarea9>)接口获取当前布局遮挡区域（此处以状态栏、导航区域为例）。
...
5. 根据实际的UI界面显示或相关UI元素背景颜色等，还可以按需设置状态栏的文字颜色、背景色或设置导航区域的显示或隐藏，以使UI界面效果呈现和谐。状态栏和导航区域默认是透明的，透传的是应用界面的背景色。
   ...
   **图2** 布局避让状态栏和导航区域（此处以导航区域表现为导航条为例给出示意）
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/y93Ei61wQHm9uDlN84LlFQ/zh-cn_image_0000002622857595.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=A4B2E350C22198C69B8117920A424AD00120D040E80691C2DB55CE8CCC36D305)

   **图3** 布局未避让状态栏和导航区域，UI元素重叠（此处以导航区域表现为导航条为例给出示意）

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/5Xd4zbHXSCmRQm_pQm00Qg/zh-cn_image_0000002622697717.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=4F109627BFA9A2743EFDBB9120FB4E3D6E29E719C1B6A73DAFC2FCE4F3738EF5)

### 应用扩展布局，隐藏避让区

此场景下状态栏和导航区域需要隐藏，适用于游戏、电影等应用场景。用户可以通过从底部上滑唤出导航条或三键导航。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/WQeofCTmS4Cl_Lg0yUlQgA/zh-cn_image_0000002592218156.png?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=A18D3B5604C3074B52C216A4EE06950D0D5B516F3BCBC1598BAF81E084972A90)
...
1. 调用setWindowLayoutFullScreen()接口设置窗口全屏。
   ...
   26. }
   ```
2. 调用[setSpecificSystemBarEnabled()](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setspecificsystembarenabled11>)接口设置状态栏和导航区域的具体显隐状态，此场景下将其设置为隐藏。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/CTU5mUZsRkWamfFymmbGRg/zh-cn_image_0000002592378090.png?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=F50761CAFCD8AC30B6F8D7D3D7B2BFDE2B1F2EF66CCE4857EE5A3CF8C502C24B)

针对状态栏和导航区域颜色与界面元素颜色不匹配问题，可以通过如下两种方式实现沉浸式效果：

* 状态栏和导航区域颜色相同场景，可以通过设置窗口的背景色来实现沉浸式效果。窗口背景色可通过[setWindowBackgroundColor()](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setwindowbackgroundcolor9>)进行设置。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/p0rxPZUFQ2aW-Ba4L507yw/zh-cn_image_0000002622857597.png?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=A8B02F3CCDA7B8BC2D61C2E13350FCF4BBF8DD7C52B879CE5ECA03730A8FE96F)
* 状态栏和导航区域颜色不同时，可以使用[expandSafeArea](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/安全区域/ts-universal-attributes-expand-safe-area.md#expandsafearea)属性扩展安全区域属性进行调整。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/71/v3/77PsdcoAT725YkdpTyPL9Q/zh-cn_image_0000002622697719.png?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=A5A17832D371CE21C6BF60192274C30C51D14CE542D49A4F00B66D8C8F7E3A15)
...
* 组件可以设置通用属性safeAreaPadding，给自身添加组件级安全区域。该属性作为一种特殊边距，在提供布局约束的同时作为安全区可以被一些系统组件利用。
  ...
  + safeAreaPadding位于原有的padding内侧。容器自外向内各层分别为border、padding、safeAreaPadding、内容区。当border和padding确定后，若容器可用空间不足以满足safeAreaPadding的设置，则优先分配给左侧和上侧safeAreaPadding、其次分配给右侧和下侧safeAreaPadding。safeAreaPadding实际尺寸确定后，余下空间为内容区。
    ...
    ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/MZ-z53Q3QC-x7t7g57Tmlg/zh-cn_image_0000002592218158.png?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=DF828861683B6CF4D316607192DAF08D75048B128ADF2D140A63185ABB8E1FC7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/9tylYm2eTxuw4bbFriiDww/zh-cn_image_0000002592378092.png?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=8BE751C14E9D31F2AD82D8A2324EE8880BF192D6A5FFC3A003CA453AFC46D331)
...
1. 设置父组件滚动容器和子组件相同的背景色，给父组件设置expandSafeArea属性扩展安全区。
   ...
   **图5** 滚动类容器设置expandSafeArea属性实现沉浸式效果
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/0Af3zqUIR3y9woFgTMaGhg/zh-cn_image_0000002622857599.png?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=D2D9C286987F8C73051A0459ECF18E8224968AC32A30DEE373C9847ADB3F1670)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/K38a32y5Re6yKppThXkxgQ/zh-cn_image_0000002622697721.png?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=ECE2D13C6D58F69B28058443D67DAC9D48B66B87FF3EBE2BBAE98D5166D077EA)

### 底部页签场景

要求页签背景色能够延伸到导航区域（此处以导航区域表现为导航条为例给出示意），但页签内部可操作元素需要在导航区域之上。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/oCMmReD9QLiJhyI3ItdZvw/zh-cn_image_0000002592218160.png?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=F81494E9D4B4A95E270A436D48168047369ECA6220BC57875BD2D7811A170955)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/nYkpAQvtTt6OzJB22p4BOw/zh-cn_image_0000002592378094.png?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=A1B8E6AA909B98504B20C7BC6CFE445D51E86EB1A335B37813ECE0071D1F865D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bb/v3/h_JUOpO4Qge89NpEt6WMow/zh-cn_image_0000002622857601.png?HW-CC-KV=V1&HW-CC-Date=20260611T063027Z&HW-CC-Expire=86400&HW-CC-Sign=284689239696E60EF3501F3F5854CD30D6C1881334BFCC77B896501932D9AC50)
