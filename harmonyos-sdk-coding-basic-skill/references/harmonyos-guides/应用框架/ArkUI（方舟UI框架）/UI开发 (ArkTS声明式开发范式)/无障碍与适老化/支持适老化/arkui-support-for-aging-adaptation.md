...
scraped_at: 2026-06-01T11:06:28+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:24c49f7e3fb3114d797aa20a45be20437f59c96bf5d8f9e1fea26d656d84e28d
---
...
2. 适配方法
   ...
   * [app.json5配置文件](../../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/app.json5配置文件/app-configuration-file.md)适配。
...
3. 获取字体大小和粗细。
   ...
   * 生命周期回调方法[onConfigurationUpdated](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.EnvironmentCallback (系统环境变化监听器)/js-apis-app-ability-environmentcallback.md#onconfigurationupdated>)的config参数可接收字体大小（[fontSizeScale](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Configuration (环境变量)/js-apis-app-ability-configuration.md#configuration>)）与字体粗细（[fontWeightScale](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Configuration (环境变量)/js-apis-app-ability-configuration.md#configuration>)）。
...
* 适老化规则
  ...
  由于在系统字体大于1倍时，组件并没有默认放大，需要通过配置[configuration标签](../../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/app.json5配置文件/app-configuration-file.md#configuration标签)，实现组件放大的适老化功能。
* 如何开启适老化
...
| 触发方式 | 组件名称 |
| --- | --- |
| 长按系统组件触发 | [SideBarContainer](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/栅格与分栏/SideBarContainer/ts-container-sidebarcontainer.md)， [底部页签（tabBar）](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md#tabbar9)，[Navigation](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)，[NavDestination](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navdestination10)， [Tabs](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md) |
| 设置系统字体默认放大 | [PickerDialog](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/弹窗/日历选择器弹窗 (CalendarPickerDialog)/ts-methods-calendarpicker-dialog.md>)， [Button](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/按钮与选择/Button/ts-basic-components-button.md)， [Menu](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/菜单/Menu/ts-basic-components-menu.md)， [Stepper](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/已停止维护的组件与接口/Stepper/ts-basic-components-stepper.md)， [BindSheet](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/模态转场设置/半模态转场/ts-universal-attributes-sheet-transition.md#bindsheet)，[TextInput](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/TextInput/ts-basic-components-textinput.md)，[TextArea](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/TextArea/ts-basic-components-textarea.md)，[Search](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Search/ts-basic-components-search.md)，[SelectionMenu](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/系统预置UI组件库/SelectionMenu/ohos-arkui-advanced-selectionmenu.md)，[Chip](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/系统预置UI组件库/Chip/ohos-arkui-advanced-chip.md)，[Dialog](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/弹窗/弹出框 (Dialog)/ohos-arkui-advanced-dialog.md>)，[Slider](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/按钮与选择/Slider/ts-basic-components-slider.md)， [Progress](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/信息展示/Progress/ts-basic-components-progress.md)， [Badge](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/信息展示/Badge/ts-container-badge.md) |
...
[TextPickerDialog](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/弹窗/文本滑动选择器弹窗 (TextPickerDialog)/ts-methods-textpicker-dialog.md>)组件通过设置系统字体大小触发适老化弹窗。在系统字体为1倍的情况下，适老化不触发；在系统字体大于1倍的情况下，适老化触发。
