...
scraped_at: 2026-06-11T14:32:49+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:7600dfea02de9208884342a31a3741c1f154c89c7388f00ee96a2fa3e3bfa3cc
---
## 概述
...
当应用需要使用换肤功能时，应自定义主题颜色。[CustomTheme](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.theme(主题换肤)/js-apis-arkui-theme.md#customtheme>)用于自定义主题色的内容，其属性可选，仅需对需要修改的token字段赋值，其余token将继承系统默认颜色值，可参考[系统默认的token颜色值](theme_skinning.md#系统缺省token色值)。请参照以下示例自定义主题色：
...
[AppTheme.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ThemeSkinning/entry/src/main/ets/pages/Theme1/AppTheme.ets#L16-L31)

## 设置应用内组件自定义主题色

* 若在页面入口处设置应用内组件自定义主题色，需确保在页面build前执行[ThemeControl](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.theme(主题换肤)/js-apis-arkui-theme.md#themecontrol>).[setDefaultTheme](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.theme(主题换肤)/js-apis-arkui-theme.md#setdefaulttheme>)。

  示例代码中，[onWillApplyTheme](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#onwillapplytheme12)回调函数用于使自定义组件获取当前生效的Theme对象。
  ...
  [Theme1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ThemeSkinning/entry/src/main/ets/pages/Theme1/Theme1.ets#L16-L134)
* 若在UIAbility中设置应用内组件自定义主题色，需在onWindowStageCreate()方法的windowStage.[loadContent](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#loadcontent9>)的完成时回调中调用[ThemeControl](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.theme(主题换肤)/js-apis-arkui-theme.md#themecontrol>).[setDefaultTheme](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.theme(主题换肤)/js-apis-arkui-theme.md#setdefaulttheme>)，设置应用内组件的自定义主题色。
  ...
  [EntryAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ThemeSkinning/entry/src/main/ets/entryability/EntryAbility.ets#L16-L55)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/DxYyYTtKSJq_vyfnQK2Cpw/zh-cn_image_0000002622857877.png?HW-CC-KV=V1&HW-CC-Date=20260611T063248Z&HW-CC-Expire=86400&HW-CC-Sign=2CFCB97E05CCFDE54007699ED9FB8A0E055A284626D5020D61AF5CD99D928F07)
...
通过设置[WithTheme](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/主题/WithTheme/ts-container-with-theme.md)，将自定义主题Theme的配色应用于内部组件的默认样式。在WithTheme的作用范围内，组件的配色会根据Theme的配色进行调整。

说明

在自定义节点[BuilderNode](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/BuilderNode/js-apis-arkui-buildernode.md>)中使用[WithTheme](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/主题/WithTheme/ts-container-with-theme.md)，为了确保显示效果正确，需手动传递系统环境变化事件，触发节点的全量更新，详细请参考[BuilderNode系统环境变化更新](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/BuilderNode/js-apis-arkui-buildernode.md#updateconfiguration12>)。

如示例所示，使用WithTheme({ theme: this.CustomTheme })可将作用域内组件的配色设置为自定义主题风格。后续可以通过更新this.CustomTheme来更换主题风格。[onWillApplyTheme](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#onwillapplytheme12)回调函数用于使自定义组件能够获取当前生效的Theme对象。
...
[Theme2.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ThemeSkinning/entry/src/main/ets/pages/Theme2/Theme2.ets#L16-L79)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/jt6ozOLJQ2-tV6itupBIKg/zh-cn_image_0000002622697999.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063248Z&HW-CC-Expire=86400&HW-CC-Sign=B91F5F29095F9D3C12CBB9E4AE17FEBF53D223DAB27A3948C20AA7B0FB524C2F)

## 设置应用页面局部深浅色

通过[WithTheme](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/主题/WithTheme/ts-container-with-theme.md)可以设置三种颜色模式，跟随系统模式，浅色模式和深色模式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/tF2VAkPjQw-9pUc898C_hQ/zh-cn_image_0000002592218438.png?HW-CC-KV=V1&HW-CC-Date=20260611T063248Z&HW-CC-Expire=86400&HW-CC-Sign=3E104B97B3FB5F1CAE9DBE6B29E6DC674404E2D677156BD51C66B00481A4A2C9)
...
[Theme3.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ThemeSkinning/entry/src/main/ets/pages/Theme3/Theme3.ets#L16-L50)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/PUCa0RcQR9COSBjMir2s4w/zh-cn_image_0000002592378372.png?HW-CC-KV=V1&HW-CC-Date=20260611T063248Z&HW-CC-Expire=86400&HW-CC-Sign=15214168276E2AA401D713AE521B30E0B41A6831513096D9E96D0D03D47A40DB)
...
各个token色值可影响的组件可参考[Colors](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.theme(主题换肤)/js-apis-arkui-theme.md#colors>)接口说明。
