...
scraped_at: 2026-06-11T14:30:45+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:458c5850c34655613ae89913b3a099b1ff6ced4d29cb324a606318f7a1384a65
---
RichEditor是支持图文混排和文本交互式编辑的组件，通常用于响应用户对图文混合内容的输入操作，例如可以输入图文的评论区。具体用法参考[RichEditor](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md)组件的API文档。

对于仅需图文展示而不需要编辑的场景，建议使用[Text](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)组件。

对于需要大量展示Html格式内容的场景，建议使用[RichText](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichText/ts-basic-components-richtext.md)组件。

## 组件构成

下图展示了组件元素的构成。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/I52tHx8VTPO1Fa01_ya7sw/zh-cn_image_0000002622857659.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=9C10C5E107F314BD1C8DF430C8C99554401B5F6D0A80552177B5EB20AA71C571)
...
使用RichEditor(options: [RichEditorStyledStringOptions](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#richeditorstyledstringoptions12))接口可以创建基于属性字符串（[StyledString/MutableStyledString](../属性字符串（StyledStringMutableStyledString）/arkts-styled-string.md)）进行内容管理的RichEditor组件。这种构建方式开发者可以通过在应用侧持有属性字符串对象来管理数据，通过修改属性字符串对象的内容、样式，再传递给组件，即可实现对富文本组件内容的更新。
...
[CreateRichEditor.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/CreateRichEditor.ets#L17-L111)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5b/v3/yYQ-ugRSS1mka8fvLKnI2A/zh-cn_image_0000002622697781.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=54FA74230D211CCD2B423821667DE5A226C3B1AA69BCD47EBD139A5730C7B92C)

### 创建基于Span进行内容管理的RichEditor组件

使用RichEditor(value: [RichEditorOptions](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#richeditoroptions))接口可以创建基于Span进行内容管理的RichEditor组件，通常用于复杂内容场景，开发者通过RichEditorController提供的接口实现内容、样式的管理。
...
[CreateRichEditor.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/CreateRichEditor.ets#L16-L112)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/80OWRM13RP6f1DloKhXy1g/zh-cn_image_0000002592218220.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=B5AFB2EA35FBC4A329D29CE15CD644ABDDC5938DEB4253B9D05C01434178D070)
...
除了直接在组件内输入内容，也可以通过[addTextSpan](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addtextspan)添加文本内容。
...
[AddTextContent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/AddTextContent.ets#L19-L70)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/cnU_3LqqQymLWqOPbAkqsA/zh-cn_image_0000002592378154.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=726EFEF5047BC555F0EFB7FBD16E7D3F262A40A699DF6CB17C68B2330D0C5E50)

### 添加图片内容

通过[addImageSpan](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addimagespan)添加图片内容。
...
[AddImageContent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/AddImageContent.ets#L19-L70)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/II4I9cNOSxWLloINcX2G9g/zh-cn_image_0000002622857661.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=0F048CCD82D07D99CE45610BE4BE83B6D5BE6177295A479ABAD932C39F82DF2A)

### 添加@Builder装饰器修饰的内容

通过[addBuilderSpan](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addbuilderspan11)添加@Builder装饰器修饰的内容。

此接口可用于自定义复杂组件的嵌入，例如在组件内加入自定义图表。

该接口内可通过[RichEditorBuilderSpanOptions](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#richeditorbuilderspanoptions11)设置在组件中添加builder的位置，省略或者为异常值时，则添加builder到所有内容的最后位置。
...
[AddBuilderDecoratorContent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/AddBuilderDecoratorContent.ets#L19-L83)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/K31MWcpDRBK00T4Ek0W9YA/zh-cn_image_0000002622697783.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=27DDCE9D865CC417FBBF6B4700B8874E0C4D51FA921AC7CC887C00186F5AB648)

### 添加SymbolSpan内容

可通过[addSymbolSpan](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#addsymbolspan11)添加Symbol内容。此接口可用于特殊符号的添加，例如在编辑学术论文时，此接口可用于添加各种数学符号。
...
[AddSymbolSpanContent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/AddSymbolSpanContent.ets#L20-L71)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/o2jTI47_T_OnwoYWqAuriA/zh-cn_image_0000002592218222.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=B84CAEE7EBEB323BE8CFC3522264323B75C6845AB94C5A422AFB13F673604CE3)
...
可通过[getSpans](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#getspans)获取组件内所有图文内容的信息，包括图文的内容、id、样式、位置等信息。获取内容位置信息后，可对指定范围内容进行样式的更新。
...
[GetGraphicInfoInComponent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/GetGraphicInfoInComponent.ets#L15-L78)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/dc7kCEP4QIG0ehoFNHfLWA/zh-cn_image_0000002592378156.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=378C343C4C27C5B186F2B27F0432BB43146EAB4C58FAF9E0BD72D3FEF5E818DC)

### 设置无输入时的提示文本

通过[placeholder](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#placeholder12)设置无输入时的提示文本。
...
[SetAttributes.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/SetAttributes.ets#L204-L243)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/LbF4DqywQaKB0XtOmIWJ6w/zh-cn_image_0000002622857663.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=BCEDA289610A74E1A6AC43DACBEAE41EC0AE450EB78222C4667C25FD2B092F6B)

### 设置最大长度

通过[maxLength](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#maxlength18)可以设置富文本的最大可输入字符数。
...
[SetAttributes.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/SetAttributes.ets#L294-L326)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8/v3/TVY5A-0CTM6sq5Se_jR1Rg/zh-cn_image_0000002622697785.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=1375C42E50ABAC4ADDF2A71D41EFE25EAFD7DDD7860BC3BFC83D90E44887C166)
...
通过[onWillChange](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#onwillchange12)添加图文变化前可触发的回调。此回调适用于用户实时数据校验与提醒，例如在用户输入文本时，可在回调内实现对输入内容的检测，若检测到敏感词汇，应立即弹出提示框。此外，它还适用于实时字数统计与限制，对于有字数限制的输入场景，可在回调中实时统计用户输入的字数，并在接近字数上限时提供相应的提示。

通过[onDidChange](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#ondidchange12)添加图文变化后可触发的回调。此回调适用于内容保存与同步，例如在用户完成内容编辑后，可使用该回调自动将最新内容保存至本地或同步至服务器。此外，它还适用于内容状态更新与渲染，例如在待办事项列表应用中，用户编辑富文本格式的待办事项描述后，可使用该回调更新待办事项在列表中的显示样式。

使用[RichEditorStyledStringOptions](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#richeditorstyledstringoptions12)构建的RichEditor组件不支持上述两种回调。
...
[AddEvent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/AddEvent.ets#L108-L177)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/Ippy9PYxQDiR92kPmCFzFQ/zh-cn_image_0000002592218224.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=A8127C2C01C1C30D8E565B7E45642A7E1778BA558522B172370C171C9F8CF65B)

### 添加输入法输入内容前和完成输入后可触发的回调

添加输入法输入内容前和完成输入后可触发的回调。

在添加输入法输入内容前，可以通过[aboutToIMEInput](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#abouttoimeinput)触发回调。在输入法完成输入后，可以通过[onDidIMEInput](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#ondidimeinput12)触发回调。

这两种回调机制适用于文本上屏过程的业务逻辑处理。例如：在用户输入的文本上屏前，利用回调提供联想词汇，在用户完成输入后，执行自动化纠错或格式转换。两种回调的时序依次为：aboutToIMEInput、onDidIMEInput。

使用[RichEditorStyledStringOptions](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#richeditorstyledstringoptions12)构建的组件不支持上述两种回调功能。
...
[AddEvent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/AddEvent.ets#L182-L250)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/HNehWConRYy5barwt9WIGQ/zh-cn_image_0000002592378158.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=F1F2323F67B60B04C6D3FDBB5895147138DA36ED7C8D6CFD86C492C652E1762C)

### 添加完成粘贴前可触发的回调

通过[onPaste](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#onpaste11)回调，来添加粘贴前要处理的流程。
...
[AddEvent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/AddEvent.ets#L17-L344)

### 添加完成剪切前可触发的回调

通过[onCut](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#oncut12)回调，来添加剪切前要处理的流程。
...
[AddEvent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/AddEvent.ets#L348-L403)

### 添加完成复制前可触发的回调

通过[onCopy](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#oncopy12)回调，来添加复制前要处理的流程。
...
[AddEvent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/AddEvent.ets#L408-L464)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/Se1SnBqISeirZ4xXC4NEJg/zh-cn_image_0000002622857665.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=6283AA31F8071FDFC7056CDE46E42B9EE52AFD01F2F08BBD4FA79B980282E403)

更多事件使用请参考[RichEditor事件](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#事件)。
...
通过[caretColor](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#caretcolor12)设置输入框光标和手柄的颜色。
...
[SetAttributes.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/SetAttributes.ets#L158-L199)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6e/v3/jzyvtfsvR82IURCD-daLXg/zh-cn_image_0000002622697787.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=D0A12FD4224E0D06FD133CA91BBBEFF43E5AC971E6121671EA404013C7026856)

### 添加组件内容选择区域或编辑状态下光标位置改变时可触发的回调

通过[onSelectionChange](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#onselectionchange12)来添加组件内容选择区域或编辑状态下光标位置改变时可触发的回调。
...
[AddEvent.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/AddEvent.ets#L51-L103)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/87H6CHYWQsGau6j6bPbiQQ/zh-cn_image_0000002592218226.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=375F91BCF42F5EEDF8D273C37819040CC50F5D3441F556FA3F157566E1B2EE72)

### 设置内容选中区范围

通过[setSelection](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#setselection11)设置组件内的内容选中时部分背板高亮。
...
[BackplaneHighlighting.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/BackplaneHighlighting.ets#L20-L66)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/XS_KKT79Q5qj79TK25_Mpw/zh-cn_image_0000002592378160.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=787B5275E59E09FFDE4A8FB7DD781DB8219250459371101C33BBCABC562AD958)
...
当富文本选择区域变化后显示菜单之前触发[onPrepareMenu](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#属性-1)回调，可在该回调中进行菜单数据设置。
...
[SetAttributes.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/SetAttributes.ets#L582-L683)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/1SP8FWkeSCK0bEHb5ieYtg/zh-cn_image_0000002622857667.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=F5DDD592528125D3C2E307AC7211AA7E5CCC5860D7BC969D6833C33254DA39BC)

### 屏蔽系统服务类菜单项

通过[disableSystemServiceMenuItems](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (TextMenuController)/arkts-apis-uicontext-textmenucontroller.md#disablesystemservicemenuitems20>)屏蔽富文本选择菜单内所有系统服务菜单项。
...
[DisableSystemServiceMenu.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/DisableSystemServiceMenu.ets#L16-L75)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/2nhloBl3T0Cs3VkBkcWbtQ/zh-cn_image_0000002622697789.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=05A9F9A046A6B675D111C8E282233BB161390117E4F6A621ADA87F845D4C1E53)

通过[disableMenuItems](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (TextMenuController)/arkts-apis-uicontext-textmenucontroller.md#disablemenuitems20>)可以屏蔽富文本选择菜单内指定的系统服务菜单项。
...
[DisableMenuItem.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/DisableMenuItem.ets#L16-L74)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bf/v3/7Z94qEJRSKm_NFo159pN2Q/zh-cn_image_0000002592218228.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=7BA787B9DF2C4F6DBCB982B4D164F80589F64DD7203459EF68553E8E7365ABCF)

### 设置自定义选择菜单

通过[bindSelectionMenu](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#bindselectionmenu)设置自定义选择菜单。
...
[SetAttributes.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/SetAttributes.ets#L70-L153)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/84/v3/wPbepoYPTPKrIT4a8PxJzg/zh-cn_image_0000002592378162.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=CEFBD4DC8FD93A707718E0DBEFE95D686A9B1D0D52E934E05B806EC0A69590BA)
...
通过[maxLines](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#maxlines18)可以设置富文本组件内可显示文本的最大行数。
...
[SetAttributes.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/SetAttributes.ets#L248-L289)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/GkUcgSKvQUm7E67H4gTeIg/zh-cn_image_0000002622857669.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=C4623F23FD82A0FF18FB47EAC114175AC65F2DBF59924B6537BAFECD5C8487BC)
...
通过[setTypingStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#settypingstyle11)可以设置用户预设的文本样式。
...
[SetUserPresetTextStyles.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/SetUserPresetTextStyles.ets#L16-L77)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/UPpB77bgSFmsHFVCuNu-jQ/zh-cn_image_0000002622697791.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=F516934D538DA44F8D38124A341967D97E936A841DFEC39A97B4B1095A61FEF9)

### 设置装饰线

通过[decoration](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Span/ts-basic-components-span.md#decoration)设置富文本组件中文本装饰线的样式、颜色和粗细。
...
[SetAttributes.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/SetAttributes.ets#L360-L403)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/6xlAK-6nSL6yLYxc3iPtVg/zh-cn_image_0000002592218230.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=A67AB91AA27261E1731E2A010D2EE65C3CAA28E15E1E75704C4FFBD73294DF1C)

通过[DecorationOptions](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#decorationoptions20)中的enableMultiType设置多装饰线，比如同时设置下划线和中划线。
...
[SetAttributes.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/SetAttributes.ets#L419-L463)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/nl6g-9p5Rgeh2M32wLkoSQ/zh-cn_image_0000002592378164.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=61F659A5480E7EFD52005C456ED89F17B40493FE46425EDB592C99013942C60A)

### 设置垂直居中

通过[textVerticalAlign](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md#textverticalalign20)设置文本段落在垂直方向的对齐方式。
...
[SetAttributes.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/SetAttributes.ets#L472-L522)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/78WrWq0PRUCsKkYAU_KCqw/zh-cn_image_0000002622857671.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=79A8453E5CCD23E050038FA00B332270DA0D0BA2E2290F1C0CEEB815295A130E)

### 设置中西文自动间距

通过[enableAutoSpacing](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/RichEditor/ts-basic-components-richeditor.md#enableautospacing20)设置是否开启中文与西文的自动间距。
...
[SetAttributes.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/richEditor/SetAttributes.ets#L525-L580)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/DlUpWMbJQbWO51O3joEF_g/zh-cn_image_0000002622697793.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063043Z&HW-CC-Expire=86400&HW-CC-Sign=DF44B46AB772439222B4DB3E1034018EF8D0F0DF2557EF38057760F8F9B64D1F)
