...
scraped_at: 2026-06-11T14:30:49+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:192a9a1366cd7a8bef5014a2ca835c0b8a1137537c4f6e36f8923b07e4fc0aee
---
属性字符串StyledString/MutableStyledString（其中MutableStyledString继承自StyledString，下文统称为StyledString），可用于在字符或段落级别上设置文本样式。将StyledString应用到文本组件上，可以采用多种方式修改文本，包括调整字号、添加字体颜色、使文本具备可点击性，以及通过自定义方式绘制文本等。具体使用方法请参考[属性字符串](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md)的API文档。

属性字符串提供多种类型样式对象，涵盖各种常见的文本样式格式，例如文本装饰线样式、文本行高样式、文本阴影样式等。也可以自行创建[CustomSpan](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#customspan)，以应用自定义样式。

## 创建并应用StyledString和MutableStyledString

可以通过[TextController](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md#textcontroller11)提供的[setStyledString](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md#setstyledstring12)方法，将属性字符串附加到文本组件，并推荐在[onPageShow](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#onpageshow)或者文本组件的[onAppear](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/组件变化事件/挂载卸载事件/ts-universal-events-show-hide.md#onappear)回调中触发绑定。

说明

在[aboutToAppear](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期（推荐）/ts-custom-component-new-lifecycle.md#abouttoappear)中调用setStyledString方法时，由于该方法运行阶段组件尚未完成创建并成功挂载节点树，因此无法在页面初始化时显示属性字符串。
...
[CreateApply.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/CreateApply.ets#L17-L46)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/M21K04qTQtychQPccbTZ_w/zh-cn_image_0000002622697801.png?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=49B55785E9D2121E756ED3A4107BA5761C7F7FB6C58431BB8C0A91057703132D)

## 设置文本样式

属性字符串目前提供了多种Style对象，包括[TextStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle)、[TextShadowStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textshadowstyle)、[DecorationStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#decorationstyle)、[BaselineOffsetStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#baselineoffsetstyle)、[LineHeightStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#lineheightstyle)、[LetterSpacingStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#letterspacingstyle)，用于设置文本的各类样式。
...
* 创建及应用文本字体样式对象（TextStyle）
  ...
  [StyledStringTextStyle.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringTextStyle.ets#L15-L63)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/41/v3/tdimqHemTsqLC0KwRl27uQ/zh-cn_image_0000002592218240.png?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=2AB7584462D66CE84FD5FEB3C43E3D667F12272CE0284BEFF790BA0255920E3E)
* 创建及应用文本阴影对象（TextShadowStyle）
  ...
  [StyledStringTextShadowStyle.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringTextShadowStyle.ets#L15-L50)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/jFxl0c4CQ-SwG2U5J508bQ/zh-cn_image_0000002592378174.png?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=78B6B949D8BD67757C686E0596AD9ADDE2054D2B0F89DC802D0101486C4D2DAB)
* 创建及应用文本装饰线对象（DecorationStyle）
  ...
  [StyledStringDecorationStyle.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringDecorationStyle.ets#L15-L73)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/hB4qJx7vT_afi8iqVd2EWQ/zh-cn_image_0000002622857681.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=7136759FC9425CD7A3C7963F64D6FF5423D03BF0167382F52A8158ED80C006BD)
* 创建及应用文本基线偏移量对象（BaselineOffsetStyle）
  ...
  [StyledStringBaselineOffsetStyle.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringBaselineOffsetStyle.ets#L15-L47)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2b/v3/__f9bUSRSY-SfVvtJU1Bwg/zh-cn_image_0000002622697803.png?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=A6160338DACE1AB97D0356C2F495750B890A646B982B7B4654A8E9F69D6F9114)
* 创建及应用文本行高对象（LineHeightStyle）
  ...
  [StyledStringLineHeightStyle.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringLineHeightStyle.ets#L15-L48)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/01/v3/HUfdCUo-R5KkLnVJFS_h0g/zh-cn_image_0000002592218242.png?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=0EB3235CB00FC969991878F58F3A90C4E27192E160006E3871DDAF9C98091466)
* 创建及应用文本字符间距对象（LetterSpacingStyle）
  ...
  [StyledStringLetterSpacingStyle.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringLetterSpacingStyle.ets#L15-L46)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/3vr05EMJR4K85veseRByAw/zh-cn_image_0000002592378176.png?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=8A59AB2A3F742B2890A5F895A928FE8F9C8BED58F8AB2A17E2315502BE682BFD)

## 设置段落样式

可通过[ParagraphStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#paragraphstyle)设置段落样式布局。下图显示了如何分割文本中的段落，段落以换行符 \n 结尾。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/df/v3/nlH3ryW_Ry2xxMwWa529Mw/zh-cn_image_0000002622857683.png?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=5C55EF33EC37BA4F7098CD1E3F6B393C95FE811834B2553489185DFD24BFBADD)
...
[StyledStringParagraphStyleOne.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringParagraphStyleOne.ets#L15-L77)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/qLtpVltXRzOFvJWAxNZdWA/zh-cn_image_0000002622697805.png?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=F42677A14209D91CCDFEDE960E3577406E551B5028F6698D8E116556AB9DE856)

除了可以在创建属性字符串时就预设样式，也可以后续通过[replaceStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#replacestyle)清空原样式替换新样式，同时需要在附加的文本组件controller上主动触发更新绑定的属性字符串。
...
10. */
11. @State message1: string =
12. this.context!.resourceManager.getStringSync($r('app.string.StyledStringParagraphStyle_Text_2').id);
13. titleParagraphStyleAttr: ParagraphStyle = new ParagraphStyle({ textAlign: TextAlign.Center });
14. // 段落首行缩进15vp
15. paragraphStyleAttr1: ParagraphStyle = new ParagraphStyle({ textIndent: LengthMetrics.vp(15) });
16. // 行高样式对象
17. lineHeightStyle1: LineHeightStyle = new LineHeightStyle(new LengthMetrics(24));
18. // 创建含段落样式的对象paragraphStyledString1
19. paragraphStyledString1: MutableStyledString =
20. new MutableStyledString(this.message1, [
21. {
22. start: 0,
23. length: 4,
24. styledKey: StyledStringKey.PARAGRAPH_STYLE,
25. styledValue: this.titleParagraphStyleAttr
26. },
27. {
28. start: 0,
29. length: 4,
30. styledKey: StyledStringKey.LINE_HEIGHT,
31. styledValue: new LineHeightStyle(new LengthMetrics(50))
32. }, {
33. start: 0,
34. length: 4,
35. styledKey: StyledStringKey.FONT,
36. styledValue: new TextStyle({ fontSize: LengthMetrics.vp(24), fontWeight: FontWeight.Bolder })
37. },
38. {
39. start: 5,
40. length: 3,
41. styledKey: StyledStringKey.PARAGRAPH_STYLE,
42. styledValue: this.paragraphStyleAttr1
43. },
44. {
45. start: 5,
46. length: 20,
47. styledKey: StyledStringKey.LINE_HEIGHT,
48. styledValue: this.lineHeightStyle1
49. }
50. ]);
51. paragraphStyleAttr3: ParagraphStyle = new ParagraphStyle({
52. textAlign: TextAlign.End,
53. maxLines: 1,
54. wordBreak: WordBreak.BREAK_ALL,
55. overflow: TextOverflow.Ellipsis
56. });
57. controller: TextController = new TextController();

59. async onPageShow() {
60. this.controller.setStyledString(this.paragraphStyledString1);
61. }

63. build() {
64. Column() {
65. // 显示属性字符串
66. Text(undefined, { controller: this.controller }).width(300)
67. // 请将$r('app.string.Replace_paragraph_style')替换为实际资源文件，在本示例中该资源文件的value值为"替换段落样式"
68. Button($r('app.string.Replace_paragraph_style'))
69. .onClick(() => {
70. this.paragraphStyledString1.replaceStyle({
71. start: 5,
72. length: 3,
73. styledKey: StyledStringKey.PARAGRAPH_STYLE,
74. styledValue: this.paragraphStyleAttr3
75. });
76. this.controller.setStyledString(this.paragraphStyledString1);
77. })
78. }
79. .width('100%')
80. }
...
[StyledStringReplaceParagraphStyle.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringReplaceParagraphStyle.ets#L15-L96)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7/v3/da6vEY8MRBm7hCHwnokRbw/zh-cn_image_0000002592218244.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=0FBD5668FBADDA66450678715A6458A6045F29042ED93E971AB95AEB626987BB)

## 支持将属性字符串转换成Paragraph

可通过[getParagraphs](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (MeasureUtils)/arkts-apis-uicontext-measureutils.md#getparagraphs20>)将属性字符串根据文本布局选项转换成对应的[Paragraph](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#paragraph>)数组。

* 以下示例展示了通过[MeasureUtils](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (MeasureUtils)/arkts-apis-uicontext-measureutils.md>)的getParagraphs方法测算文本，当内容超出最大显示行数的时候，截断文本显示并展示“...全文”的效果。
  ...
  [StyledStringConvertedToParagraph.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringConvertedToParagraph.ets#L15-L221)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/d_W--JauQkm6zpYuqdc_kg/zh-cn_image_0000002592378178.png?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=92F1BD019755B3668C79267F78340C8C26AD29A2FDFDB248ACD98CD3FC12D68D)

## 使用图片

可通过[ImageAttachment](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#imageattachment)来添加图片。

以下示例展示了如何将图片和文本附加到同一个[MutableStyledString](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#mutablestyledstring)对象上，并实现图文混排。

说明

属性字符串的构造函数[constructor](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#constructor)中，当入参value的类型为ImageAttachment或CustomSpan时，styles参数不生效。需要设置styles时，通过[setStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#setstyle)、[insertStyledString](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#insertstyledstring)等方法实现。
...
[StyledStringImageAttachment.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringImageAttachment.ets#L18-L192)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/Dve5AlGwTF-mVcIVhC4jHA/zh-cn_image_0000002622857685.png?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=8AAA4A29ADD090C4F2838B66787F7D005DDD6ED86339FBB7561F3DF23129A24E)

## 设置事件

可通过[GestureStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#gesturestyle)设置onClick、onLongPress事件来使文本响应点击长按事件。

除了初始化属性字符串对象即初始样式对象，亦可通过[setStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#setstyle)接口再叠加新样式或更新已有样式，同时需要在附加的文本组件controller上主动触发更新绑定的属性字符串。
...
[StyledStringGestureStyle.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringGestureStyle.ets#L17-L170)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/1ROkaclEQkGaZwXBsDEb4Q/zh-cn_image_0000002622697807.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=2068B9853FEED0920AED478417701EEE33429FF1481A0A16B23668A25BFC0C62)

## 格式转换

可以通过[toHtml](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#tohtml14)、[fromHtml](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#fromhtml)接口实现属性字符串与HTML格式字符串的相关转换，当前支持转换的HTML标签范围：<p>、<span>、<img>、<br>、<strong>、<b>、<a>、<i>、<em>、<s>、<u>、<del>、<sup>、<sub>。
...
[StyledStringHtml.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringHtml.ets#L18-L107)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0e/v3/cxMyJgIhQBOkDTDPRoDsKg/zh-cn_image_0000002592218246.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=89A21F0E323ECC52F64CC45977E96E19AD58BFDF81DB8046F184744F6621E9DF)
...
* 将HTML中<strong>、<b>、<a>、<i>、<em>、<s>、<u>、<del>、<sup>、<sub>标签及其style属性中的background-color转换为属性字符串并转回HTML。
  ...
  48. */
  49. Button($r('app.string.Converted_HTML_back_to_SpanString')).onClick(async () => {
  50. this.spanString = await StyledString.fromHtml(this.html);
  51. this.controller.setStyledString(this.spanString);
  52. this.resultText = 'Converted HTML back to SpanString successfully.';
  53. }).margin(5)

  55. // 重置：重置HTML和SpanString
  56. // 请将$r('app.string.Reset')替换为实际资源文件，在本示例中该资源文件的value值为"Reset"
  57. Button($r('app.string.Reset')).onClick(() => {
  58. this.html =
  59. "<p>This is <b>b</b> <strong>strong</strong> <em>em</em> <i>i</i> <u>u</u> <del>del</del> <s>s</s> <span   style = \"foreground-color:blue\"> <a href='https://www.example.com'>www.example</a> </span> <span   style=\"background-color: red;\">red span</span> <sup>superscript</sup> and <sub>subscript</sub></p>";
  60. this.spanString = undefined;
  61. this.controller.setStyledString(new StyledString('')); // 使用空的StyledString实例
  62. this.resultText = 'Reset HTML and SpanString successfully.';
  63. }).margin(5)
  64. }.width('100%').padding(20)
  65. }
  66. }
  ```

  [StyledStringHtmlOne.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringHtmlOne.ets#L15-L81)

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4e/v3/ibfpllOKRsCN_ijmsnqOjg/zh-cn_image_0000002592378180.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=7B90913DD51F9175E80FF0AE8795E6934095BC0F5F7B85CD6918D21BAE17CC08)

## 场景示例

该示例通过[ParagraphStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#paragraphstyle)、[LineHeightStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#lineheightstyle)、[TextStyle](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle)对象展示了会员过期提示的效果。
...
[StyledStringSceneExample.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextComponent/entry/src/main/ets/pages/propertyString/StyledStringSceneExample.ets#L18-L180)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/M6TJDk93SKOwtc4uQDByGg/zh-cn_image_0000002622857687.png?HW-CC-KV=V1&HW-CC-Date=20260611T063046Z&HW-CC-Expire=86400&HW-CC-Sign=A4CD8A3926604C433EAD3F3CF7ADBAAEB54E52646C0AA76AEC3051BD163C831C)
