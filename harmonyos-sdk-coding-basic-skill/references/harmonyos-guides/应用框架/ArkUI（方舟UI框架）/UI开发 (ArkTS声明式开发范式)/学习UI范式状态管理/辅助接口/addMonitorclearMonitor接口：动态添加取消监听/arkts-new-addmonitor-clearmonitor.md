...
scraped_at: 2026-06-01T11:03:14+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:eac7f99eecaf18d2592e607fe78aca6ea7712c1eaf7880da9ae5db7e692bf8ef
---
为了动态添加或删除状态管理V2的状态变量的监听函数，开发者可以使用[addMonitor](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.StateManagement (状态管理)/js-apis-statemanagement.md#addmonitor20>)或[clearMonitor](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.StateManagement (状态管理)/js-apis-statemanagement.md#clearmonitor20>)。
...
装饰器[@Monitor](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-monitor)如果声明在[@ObservedV2](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-observedv2-and-trace)和[@ComponentV2](../../../学习UI范式基本语法/自定义组件/创建自定义组件/arkts-create-custom-components.md#componentv2)中，会使得开发者构造出的所有的@ObservedV2和@ComponentV2的实例，都默认有同样的@Monitor的监听回调，且无法取消或删除对应的监听回调。

如果开发者希望动态给@ObservedV2和@ComponentV2实例添加或者删除监听函数，则可以使用[addMonitor](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.StateManagement (状态管理)/js-apis-statemanagement.md#addmonitor20>)和[clearMonitor](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.StateManagement (状态管理)/js-apis-statemanagement.md#clearmonitor20>)接口。
...
* addMonitor设置[isSynchronous](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.StateManagement (状态管理)/js-apis-statemanagement.md#monitoroptions20>)仅第一次有效，即其不能被更改，如果开发者更改isSynchronous，则会打印错误日志。
