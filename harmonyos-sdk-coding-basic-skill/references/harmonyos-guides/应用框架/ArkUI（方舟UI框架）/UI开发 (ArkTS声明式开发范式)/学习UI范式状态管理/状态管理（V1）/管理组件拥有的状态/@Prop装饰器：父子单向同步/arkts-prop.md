...
scraped_at: 2026-06-11T14:29:09+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:5ae8fcd59f630bef2dfed423da924084335e402b51534f2847d5ab1e6275864d
---
@Prop装饰的变量可以和父组件建立单向同步关系。

在阅读@Prop文档前，建议开发者首先了解[@State](../@State装饰器：组件内状态/arkts-state.md)的基本用法。最佳实践请参考[状态管理最佳实践](../../../../../../../../best-practices/声明式语法/状态管理最佳实践/bpta-status-management.md)。常见问题请参考[状态管理常见问题](../../../状态管理常见问题/arkts-state-management-faq.md)。
...
| 允许装饰的变量类型 | Object、class、string、number、boolean、enum类型，以及这些类型的数组。  API version 10开始支持[Date类型](arkts-prop.md#装饰date类型变量)。  API version 11及以上支持[Map](arkts-prop.md#装饰map类型变量)、[Set](arkts-prop.md#装饰set类型变量)类型、undefined和null类型、ArkUI框架定义的联合类型[Length](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length)、[ResourceStr](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr)、[ResourceColor](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor)类型以及这些类型的联合类型，示例见[Prop支持联合类型实例](arkts-prop.md#prop支持联合类型实例)。  支持类型的场景请参考[观察变化](arkts-prop.md#观察变化)。 |
| 不允许装饰的变量类型 | 不支持装饰Function类型。 |
| 嵌套传递层数 | 在组件复用场景，建议@Prop深度嵌套数据不要超过5层，嵌套太多会导致深拷贝占用的空间过大以及GarbageCollection(垃圾回收)，引起性能问题，此时更建议使用[@ObjectLink](../@Observed装饰器和@ObjectLink装饰器：嵌套类对象属性变化/arkts-observed-and-objectlink.md)。 |
| 被装饰变量的初始值 | 允许本地初始化。API version 11及以上，如果和[@Require](../../../../学习UI范式基本语法/@Require装饰器：校验构造传参/arkts-require.md)结合使用，则必须父组件构造传参。 |

## 变量的传递/访问规则说明

| 装饰器使用规则 | 说明 |
| --- | --- |
| 从父组件初始化 | 如果本地有初始化，则是可选的，初始化行为和[@State](../@State装饰器：组件内状态/arkts-state.md#变量的传递访问规则说明)保持一致。没有的话，则必选，支持父组件中的常规变量（常规变量对@Prop赋值，只是数值的初始化，常规变量的变化不会触发UI刷新。只有状态变量才能触发UI刷新）、[@State](../@State装饰器：组件内状态/arkts-state.md)、[@Link](../@Link装饰器：父子双向同步/arkts-link.md)、@Prop、[@Provide](../@Provide装饰器和@Consume装饰器：与后代组件双向同步/arkts-provide-and-consume.md)、[@Consume](../@Provide装饰器和@Consume装饰器：与后代组件双向同步/arkts-provide-and-consume.md)、[@ObjectLink](../@Observed装饰器和@ObjectLink装饰器：嵌套类对象属性变化/arkts-observed-and-objectlink.md)、[@StorageLink](../../管理应用拥有的状态/AppStorage：应用全局的UI状态存储/arkts-appstorage.md#storagelink)、[@StorageProp](../../管理应用拥有的状态/AppStorage：应用全局的UI状态存储/arkts-appstorage.md#storageprop)、[@LocalStorageLink](../../管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md#localstoragelink)和[@LocalStorageProp](../../管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md#localstorageprop)去初始化子组件中的@Prop装饰的变量。 |
| 用于初始化子组件 | @Prop支持初始化子组件中的常规变量、@State、@Link、@Prop、@Provide。 |
| 是否支持组件外访问 | @Prop装饰的变量是私有的，只能在组件内访问。 |

初始化规则图示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/wW0x4R8CTFGFIx6CYkZnfQ/zh-cn_image_0000002622697551.png?HW-CC-KV=V1&HW-CC-Date=20260611T062907Z&HW-CC-Expire=86400&HW-CC-Sign=14AC34C1F346F880D9D9A7698DF9297C064E98DBDCE40743F3601C670FC9099F)
...
* 当装饰的类型是Object或者class复杂类型时，可以观察到自身的赋值和第一层的属性的变化，属性即object.keys(observedObject)返回的所有属性。复杂类型完整示例请参考[从父组件中的@State类对象属性到@Prop简单类型的同步](arkts-prop.md#从父组件中的state类对象属性到prop简单类型的同步)。
  ...
  [PageSeventeen.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageSeventeen.ets#L16-L36)

  ```
  1. @Prop title: Model;
  ```

  [PageSeventeen.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageSeventeen.ets#L42-L45)
  ...
  [PageSeventeen.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageSeventeen.ets#L68-L71)
  ...
  [PageSeventeen.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageSeventeen.ets#L77-L80)
...
[PageOne.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageOne.ets#L16-L44)

## 限制条件

* @Prop装饰变量时会进行深拷贝，在拷贝的过程中除了基本类型、Map、Set、Date、Array外，都会丢失类型。例如，对于通过NAPI提供的复杂类型（如[PixelMap](<../../../../../../../../harmonyos-references/Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)），由于其部分实现在Native侧，因此无法在ArkTS侧通过深拷贝获得完整的数据；同样，RegExp类型在拷贝过程中会丢失原类型，导致被@Prop装饰后无法调用正则相关函数。
...
* 父组件传入undefined时，@Prop装饰的变量仍使用本地默认值进行初始化。
  ...
  [PageTwenty.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageTwenty.ets#L16-L44)
...
[PageTwo.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageTwo.ets#L15-L57)
...
[PageFour.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageFour.ets#L16-L61)
...
[PageFive.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageFive.ets#L16-L55)
...
[PageSix.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageSix.ets#L16-L124)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/eX6PntqOSP-Y-vQSLYEzSQ/zh-cn_image_0000002592217990.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062907Z&HW-CC-Expire=86400&HW-CC-Sign=42808D96EF46D5AF0098E1D05EF1299916914593CC888CE811C3D10F13427C01)
...
[PageSeven.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageSeven.ets#L16-L78)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/84/v3/kF6uJQJYSFCsP2kop3-QCg/zh-cn_image_0000002592377924.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062907Z&HW-CC-Expire=86400&HW-CC-Sign=6458ACA8DE28D68EFA3CAB666F45DC80CCFA413B4F624BF7B0E99B6EBED87A73)
...
[PageEight.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageEight.ets#L15-L37)
...
[PageNine.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageNine.ets#L36-L114)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/U3-NerQaTMuyCY7zUSdtlQ/zh-cn_image_0000002622857431.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062907Z&HW-CC-Expire=86400&HW-CC-Sign=4968689581A5FD383F74D7D5A2C2701E35E62FD7359EAF74281234A6463FE200)
...
[PageNineteen.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageNineteen.ets#L16-L75)
...
[PageTen.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageTen.ets#L16-L64)
...
[PageEleven.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageEleven.ets#L16-L61)
...
[PageTwelve.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageTwelve.ets#L16-L68)
...
[PageThirteen.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Prop/entry/src/main/ets/pages/PageThirteen.ets#L16-L84)
