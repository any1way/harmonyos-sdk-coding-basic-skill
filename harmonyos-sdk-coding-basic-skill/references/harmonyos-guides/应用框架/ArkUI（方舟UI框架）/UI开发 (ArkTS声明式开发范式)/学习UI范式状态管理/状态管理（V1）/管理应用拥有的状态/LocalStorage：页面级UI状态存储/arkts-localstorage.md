...
scraped_at: 2026-06-11T14:29:19+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:48e5b53fb99a5e3f899e0ab8bc47262e4f075e5f432e7df3652f276f76c3b0f7
---
LocalStorage是页面级的UI状态存储，通过@Entry装饰器接收的参数可以在页面内共享同一个LocalStorage实例。LocalStorage支持[UIAbility](<../../../../../../Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/UIAbility组件/UIAbility组件概述/uiability-overview.md>)实例内多个页面间状态共享。

本文仅介绍LocalStorage使用场景和相关的装饰器：@LocalStorageProp和@LocalStorageLink。

在阅读本文档前，需要开发者对状态管理框架有基本的了解。建议提前阅读：[状态管理概述](../../../状态管理概述/arkts-state-management-overview.md)。

LocalStorage还提供了API接口，可以让开发者通过接口在自定义组件外手动触发Storage对应key的增删改查，建议配合[LocalStorage API文档](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/应用级变量的状态管理/ts-state-management.md#localstorage9)阅读。最佳实践请参考[状态管理最佳实践](../../../../../../../../best-practices/声明式语法/状态管理最佳实践/bpta-status-management.md)。
...
* 应用程序可以创建多个LocalStorage实例，LocalStorage实例可以在页面内共享，也可以通过[getSharedLocalStorage](<../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getsharedlocalstorage12>)接口，实现跨页面、跨UIAbility实例共享。
* 组件树的根节点，即被[@Entry](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/@Entry：页面入口/ts-universal-entry.md#entry)装饰的[@Component](../../../../学习UI范式基本语法/自定义组件/创建自定义组件/arkts-create-custom-components.md#component)，可以被分配一个LocalStorage实例，此组件的所有子组件实例将自动获得对该LocalStorage实例的访问权限。
...
| 初始化子节点 | 支持，可用于初始化[@State](../../管理组件拥有的状态/@State装饰器：组件内状态/arkts-state.md)、[@Link](../../管理组件拥有的状态/@Link装饰器：父子双向同步/arkts-link.md)、[@Prop](../../管理组件拥有的状态/@Prop装饰器：父子单向同步/arkts-prop.md)、[@Provide](../../管理组件拥有的状态/@Provide装饰器和@Consume装饰器：与后代组件双向同步/arkts-provide-and-consume.md)。 |
| 是否支持组件外访问 | 否。 |

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/64/v3/yGcm4wvCQIOnpBv8YTOgsQ/zh-cn_image_0000002592218000.png?HW-CC-KV=V1&HW-CC-Date=20260611T062917Z&HW-CC-Expire=86400&HW-CC-Sign=91FA8C3B501C2F7CD7E2E2519B7EB50C5E03EC4467778078198203DA179473F1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0/v3/VJWT8QHlRfOIJHgtqKXVpQ/zh-cn_image_0000002592377934.png?HW-CC-KV=V1&HW-CC-Date=20260611T062917Z&HW-CC-Expire=86400&HW-CC-Sign=AB61F8E58C8A28C493AEF01B968EAB3BA7E4A3D3233231B233734DAC41906632)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/79/v3/QXy3vkwISj6kTHs5VgpvOg/zh-cn_image_0000002622857441.png?HW-CC-KV=V1&HW-CC-Date=20260611T062917Z&HW-CC-Expire=86400&HW-CC-Sign=A31BD6925013139F8E8039B84BC83159CBEC87F3DC928F2F0438F4AA9624EDB8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/n_gwaNeOTLmYdYjJ535D5g/zh-cn_image_0000002622697563.png?HW-CC-KV=V1&HW-CC-Date=20260611T062917Z&HW-CC-Expire=86400&HW-CC-Sign=2225DDB3F93BD56C1D5D2DE6E9A582F235E5E265C6CE4F13FC2114EDD24243C5)
...
[PageOneDoubleSYN.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/PageOneDoubleSYN.ets#L16-L80)
...
[PageTwoSingleSYN.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/PageTwoSingleSYN.ets#L15-L52)
...
[PageTwoWaySYN.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/PageTwoWaySYN.ets#L15-L43)
...
[PageFourStateVariableSYN.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/PageFourStateVariableSYN.ets#L15-L95)

### 将LocalStorage实例从UIAbility共享到一个或多个页面

上面的实例中，LocalStorage的实例仅仅在一个@Entry装饰的组件和其所属的子组件（一个页面）中共享，如果希望其在多个页面中共享，可以在所属UIAbility中创建LocalStorage实例，并调用windowStage.[loadContent](<../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#loadcontent9>)。
...
[EntryAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/entryability/EntryAbility.ets#L17-L71)
...
[PageFiveShare.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/PageFiveShare.ets#L15-L44)
...
[PageFiveShareChange.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/PageFiveShareChange.ets#L15-L55)
...
8. @Component
9. struct TestIndex {
10. // 变量propA和localStorageOne中'PropA'双向同步
...
20. // 使用LocalStorage实例localStorageTwo
...
33. // 变量propB和localStorageTwo中'PropB'双向同步。如果localStorageTwo中没有'PropB'，则使用默认值'Hello World'
...
[PageSixLocalStorage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/PageSixLocalStorage.ets#L15-L58)
...
1. 当自定义组件没有定义属性时，可以只传入一个LocalStorage实例作为入参。
   ...
   8. @Component
   9. struct Index {
   10. // 变量propA和localStorageInstance中'PropA'双向同步
   11. @LocalStorageLink('PropA') propA: string = 'Hello World';
   12. @State count: number = 0;
   ...
   18. .fontSize(50)
   19. .fontWeight(FontWeight.Bold)
   20. // 使用LocalStorage实例localStorageChange
   ...
   [PageSixLocalStorageA.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/PageSixLocalStorageA.ets#L15-L53)
2. 当定义的属性不需要从父组件初始化变量时，第一个参数需要传{}。
   ...
   10. // 变量propA和localStorageBOne中'PropA'双向同步
   11. @LocalStorageLink('PropA') propA: string = 'Hello World';
   12. @State count: number = 0;
   ...
   18. .fontSize(50)
   19. .fontWeight(FontWeight.Bold)
   20. // 使用LocalStorage实例localStorageBTwo
   ...
   32. // 变量propB和localStorageBTwo中'PropB'双向同步。如果localStorageBTwo中没有'PropB'，则使用默认值'Hello World'
   ...
   [PageSixLocalStorageB.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/PageSixLocalStorageB.ets#L15-L57)

### Navigation组件和LocalStorage联合使用

可以通过传递不同的LocalStorage实例给自定义组件，从而实现在[Navigation](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)跳转到不同的页面时，绑定不同的LocalStorage实例，显示对应绑定的值。
...
56. // 显示绑定的LocalStorage中'PropA'对应的值'propA'
57. Text(`${this.propA}`)
...
83. // 如果绑定的LocalStorage中没有'PropB',显示本地初始化的值'Hello World'
84. Text(`${this.propB}`)
...
112. // 如果绑定的LocalStorage中没有'PropC',显示本地初始化的值'pageThreeStack'
113. Text(`${this.propC}`)
...
[PageMyNavigation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/PageMyNavigation.ets#L15-L159)
...
[PageLocalStorageLink.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/PageLocalStorageLink.ets#L15-L80)
...
[LocalArraySample.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/LocalArraySample.ets#L15-L59)
...
[LocalDateSample.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/LocalDateSample.ets#L15-L52)
...
[LocalMapSample.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/LocalMapSample.ets#L15-L51)
...
[LocalSetSample.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/LocalSetSample.ets#L15-L52)
...
[ChangeLocalSetSample.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/LocalStorage/entry/src/main/ets/pages/ChangeLocalSetSample.ets#L15-L45)
