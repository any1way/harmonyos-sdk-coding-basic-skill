...
scraped_at: 2026-06-01T11:03:28+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:6fe2afd8c13bc4bb42cf1bb893516b6405315c086d871e4c0dff6e0faef87ee8
---
本文档主要介绍组件复用从V1向V2的迁移，涉及如下装饰器。

| V1装饰器名称 | V2装饰器名称 |
| --- | --- |
| [@Reusable](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md) | [@ReusableV2](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@ReusableV2装饰器：V2组件复用/arkts-new-reusablev2.md) |
...
* 涉及组件内状态变量的迁移可参考[组件内状态变量迁移指导](../组件内状态变量迁移/arkts-v1-v2-migration-inner-component.md)。

### aboutToRecycle与aboutToReuse迁移

**迁移规则**

* [aboutToRecycle](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttorecycle10)生命周期无需改动，可保留原实现。
* [aboutToReuse](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoreuse18)生命周期在组件复用V2中进行了优化，去除了参数的同时，在复用前会自动重置各状态变量（详情参考[复用前的组件内状态变量重置](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@ReusableV2装饰器：V2组件复用/arkts-new-reusablev2.md#复用前的组件内状态变量重置)），无需开发者在aboutToReuse中手动赋值回初始值。
...
在组件复用V1中，使用[reuseId](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/其他/复用标识/ts-universal-attributes-reuse-id.md#reuseid)属性标记组件的复用组。迁移到组件复用V2后，需更换使用[reuse](../../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/其他/复用选项/ts-universal-attributes-reuse.md#reuse)属性。
...
组件复用V1中，当开发者打开复用组件的冻结开关freezeWhenInactive时，才会冻结复用池中的组件，详细规则参考[自定义组件冻结功能](../../../../学习UI范式基本语法/自定义组件/自定义组件冻结/自定义组件冻结功能（V1）/arkts-custom-components-freeze.md)。而在组件复用V2中，会自动开启冻结，详细规则参考[复用阶段的冻结](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@ReusableV2装饰器：V2组件复用/arkts-new-reusablev2.md#复用阶段的冻结)。

### LazyForEach->Repeat

**迁移规则**

组件复用V1中，经常使用LazyForEach配合组件复用实现高性能懒加载。在组件复用V2中，推荐使用[Repeat](../../../../学习UI范式渲染控制/Repeat：可复用的循环渲染/arkts-new-rendering-control-repeat.md)替代[LazyForEach](../../../../学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md)。Repeat自身能够对组件进行复用，相比LazyForEach具有更简洁的API以及更好的性能。由LazyForEach迁移至Repeat可参考[LazyForEach迁移Repeat](../循环渲染迁移/arkts-v1-v2-migration-rendering-control-repeat.md#lazyforeach迁移repeat)。

## @Reusable->@ReusableV2迁移示例

### if使用场景

@Reusable使用示例请参考[动态布局更新](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md#动态布局更新)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/Q_nYSjQ0SMevDtFoq_phmQ/zh-cn_image_0000002613518005.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030327Z&HW-CC-Expire=86400&HW-CC-Sign=6FD73B4A511AD549C3028652FCDC707A19A1B6FB30E11E47377F5AC8B0B931BF)

### 列表滚动-Repeat使用场景

@Reusable使用示例请参考[列表滚动配合LazyForEach使用](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md#列表滚动配合lazyforeach使用)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/MkrNUVaoSMSQdH_Um9lf1g/zh-cn_image_0000002582958206.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030327Z&HW-CC-Expire=86400&HW-CC-Sign=CDA7051FEFB39D03AEA3F2E42D78F58BB0DEBB87C204B8678EBA52D26529198A)

### 列表滚动-if使用场景

@Reusable使用示例请参考[列表滚动-if使用场景](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md#列表滚动-if使用场景)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/LwNc_QkaTh6KIwJy8cE_Og/zh-cn_image_0000002583118134.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030327Z&HW-CC-Expire=86400&HW-CC-Sign=61AC027B2627BC2E7465303AFC2AAD7ADF512567D961036514E6EBC14D660810)

### 列表滚动-Repeat全量加载使用场景

状态管理V2推荐使用[Repeat全量加载模式](../../../../学习UI范式渲染控制/Repeat：可复用的循环渲染/arkts-new-rendering-control-repeat.md#懒加载能力说明)替代[ForEach](../../../../学习UI范式渲染控制/ForEach：循环渲染/arkts-rendering-control-foreach.md)实现循环渲染。

@Reusable使用示例请参考[列表滚动-ForEach使用场景](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md#列表滚动-foreach使用场景)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d/v3/pNlMql5ZQQunyxv1_7m2Ig/zh-cn_image_0000002613637897.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030327Z&HW-CC-Expire=86400&HW-CC-Sign=FA783005E4D98F421F4263EF7D2A7C7E5DB035E4E2A4C9FFF6C1C9636D8E9F82)

### Grid使用场景

@Reusable使用示例请参考[Grid使用场景](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md#grid使用场景)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4e/v3/0BXq7ap4SDGQjj6aAsJVVg/zh-cn_image_0000002613518007.png?HW-CC-KV=V1&HW-CC-Date=20260601T030327Z&HW-CC-Expire=86400&HW-CC-Sign=64AF6AF9142BA5369503BE7849EFE52965A1D78ABF03B6FA77F4EF635C6A6209)

### WaterFlow使用场景

@Reusable使用示例请参考[WaterFlow使用场景](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md#waterflow使用场景)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/AfsWGOKPTPqmi-DgCYZjaQ/zh-cn_image_0000002582958210.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030327Z&HW-CC-Expire=86400&HW-CC-Sign=FE9A8BF41F04EB076E4684294425E1283CD335F3E62E91B4284AF8581A7DE5C6)

### Swiper使用场景

@Reusable使用示例请参考[Swiper使用场景](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md#swiper使用场景)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/c4v2tp4US_Wk8WBXeDjx1Q/zh-cn_image_0000002583118136.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030327Z&HW-CC-Expire=86400&HW-CC-Sign=D0F4F93B5BF7148EAE5BEC2697DE3B95B93936D280B94B541A345E2110F428C3)

### 列表滚动-ListItemGroup使用场景

@Reusable使用示例请参考[列表滚动-ListItemGroup使用场景](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md#列表滚动-listitemgroup使用场景)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/tXLMl_LtSmuX1c5-BZzSrw/zh-cn_image_0000002613637899.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030327Z&HW-CC-Expire=86400&HW-CC-Sign=0B2FE6E24993F41862BB32A5191F7616F56DF0F19073DC6A173B6A60C23C2103)

### 多种条目类型使用场景

@Reusable使用示例请参考[多种条目类型使用场景](../../../../学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md#多种条目类型使用场景)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/moDDNELiQ22KsxGq9JmsaQ/zh-cn_image_0000002613518009.png?HW-CC-KV=V1&HW-CC-Date=20260601T030327Z&HW-CC-Expire=86400&HW-CC-Sign=6A02A7714C1715028E33EDCDB7C362B70A75959C06004F6BD441F9AF39D96D23)

**组合型**

复用组件间存在多种差异，但通常具备共同的子组件。将三种复用组件以组合型方式转换为[@Builder](../../../../学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md)函数后，内部的共享子组件将统一置于父组件MyComponentV2之下。复用这些子组件时，缓存池在父组件层面实现共享，减少组件创建过程中的资源消耗。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/VNXuiVhYQqG-HfoWO2HP-w/zh-cn_image_0000002582958212.png?HW-CC-KV=V1&HW-CC-Date=20260601T030327Z&HW-CC-Expire=86400&HW-CC-Sign=439E5279810707D78475527CA2E08ECC0615FD20081A29E7E157246149369F97)
