...
scraped_at: 2026-06-01T11:06:19+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:eba6466c4f2add43dda8f48ea3c8a50e8a4e36b758f536c2430c692fc5291a15
---
## 概述
...
DrawModifier可设置遮罩层前景（[drawOverlay](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义绘制设置/ts-universal-attributes-draw-modifier.md#drawoverlay23)）、前景（[drawForeground](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义绘制设置/ts-universal-attributes-draw-modifier.md#drawforeground20)）、内容前景（[drawFront](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义绘制设置/ts-universal-attributes-draw-modifier.md#drawfront)）、内容（[drawContent](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义绘制设置/ts-universal-attributes-draw-modifier.md#drawcontent)）和内容背景（[drawBehind](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义绘制设置/ts-universal-attributes-draw-modifier.md#drawbehind)）的绘制方法，开发者需要重载这些方法，并通过[Canvas](<../使用画布绘制自定义图形 (Canvas)/arkts-drawing-customization-on-canvas.md>)的接口进行自定义绘制。自定义绘制层级图如下所示。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/VNNL5C1oRfO_wnqfDSl2vQ/zh-cn_image_0000002613518479.png?HW-CC-KV=V1&HW-CC-Date=20260601T030619Z&HW-CC-Expire=86400&HW-CC-Sign=29CE962DC4020C48E02A898CDE96E4D8BE301EAFD273EDF6BD91B8DF4B106948)

DrawModifier还提供主动触发重绘的方法[invalidate](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义绘制设置/ts-universal-attributes-draw-modifier.md#invalidate)，该接口开发者无需也无法重载，调用会触发所绑定组件的重绘。
...
* NDK的自定义绘制能力和示例请参考[自定义绘制](<../../../../UI开发 (基于NDK构建UI)/自定义绘制/arkts-user-defined-draw.md>)。
...
[DrawFrontDrawContentDrawBehind.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/DrawModifier/entry/src/main/ets/pages/DrawFrontDrawContentDrawBehind.ets#L16-L215)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/5XBxcD8PT9ed1m7Qvfvdpw/zh-cn_image_0000002582958682.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030619Z&HW-CC-Expire=86400&HW-CC-Sign=36295AA7EB1A4AEBAB6D26173B8EC30580D99547FF3C64C7D478D74931AC7737)
...
[DrawForeground.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/DrawModifier/entry/src/main/ets/pages/DrawForeground.ets#L16-L73)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/Hiph1O4sT7eUARHaMBGDug/zh-cn_image_0000002583118608.png?HW-CC-KV=V1&HW-CC-Date=20260601T030619Z&HW-CC-Expire=86400&HW-CC-Sign=E5C3F76B465223227451A3D8775BBF264EB335FF901437A2891CFA632CB6B5FA)

## 调整自定义绘制Canvas的变换矩阵

从API version 12开始，通过重写DrawModifier中的[drawContent](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义绘制设置/ts-universal-attributes-draw-modifier.md#drawcontent)方法，可以替换组件原本的内容绘制函数。
...
* 如果开发者希望这个画布进行一个预期的变换，应该使用[concatMatrix](<../../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (Canvas)/arkts-apis-graphics-drawing-canvas.md#concatmatrix12>)而不是[setMatrix](<../../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (Canvas)/arkts-apis-graphics-drawing-canvas.md#setmatrix12>)，因为setMatrix会覆盖原本真实canvas上存在的变换矩阵。
...
[Canvas.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/DrawModifier/entry/src/main/ets/pages/Canvas.ets#L16-L122)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/_UE4x08JTZyAMJ0bM0Bs4Q/zh-cn_image_0000002613638375.png?HW-CC-KV=V1&HW-CC-Date=20260601T030619Z&HW-CC-Expire=86400&HW-CC-Sign=B1F8791324355F81AB22B4D20D3978B1299491D84594282689886891734BFCFC)
