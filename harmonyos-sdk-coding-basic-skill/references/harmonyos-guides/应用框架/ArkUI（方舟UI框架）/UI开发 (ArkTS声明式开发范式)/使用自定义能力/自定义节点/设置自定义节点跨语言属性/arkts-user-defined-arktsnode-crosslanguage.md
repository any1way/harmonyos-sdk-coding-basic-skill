...
content_hash: sha256:4896c8fd71211c6b210e162b2294543b5f0e922b84af5a9b05d1c0c8ed613399
---
## 概述

ArkUI支持在前端使用ArkTS语言创建命令式节点，即[FrameNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md>)节点，也可以在Native侧使用C语言创建命令式节点，并且可以混合使用两类节点构建页面。

针对上述场景，ArkUI提供命令式节点跨语言属性设置功能，即使用ArkTS语言创建的命令式节点，可以在Native侧进行属性设置。使用C语言创建的节点，可以在ArkTS侧进行属性设置。

说明

下述示例中，需要先进行Native侧配置，请参考[接入ArkTS页面](<../../../../UI开发 (基于NDK构建UI)/接入ArkTS页面/ndk-access-the-arkts-page.md>)完成。

## 设置和获取跨语言配置

跨语言指的是跨越ArkTS语言和C语言。跨语言配置指的是命令式节点上对于跨语言操作的权限配置。

可以通过[setCrossLanguageOptions](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#setcrosslanguageoptions15>)与[OH\_ArkUI\_NodeUtils\_SetCrossLanguageOption](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#oh_arkui_nodeutils_setcrosslanguageoption>)接口设置当前节点的跨语言配置。如果当前节点无法修改或设置跨语言配置，则会抛出异常信息。

可以使用[getCrossLanguageOptions](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getcrosslanguageoptions15>)与[OH\_ArkUI\_NodeUtils\_GetCrossLanguageOption](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#oh_arkui_nodeutils_getcrosslanguageoption>)接口获取当前节点的跨语言配置。
...
获取节点后，若节点的跨语言配置设置为允许属性设置，ArkTS侧可利用getAttribute接口获取修改Native节点属性的对象，Native侧可利用[setAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeNodeAPI_1/capi-arkui-nativemodule-arkui-nativenodeapi-1.md#setattribute>)接口修改ArkTS节点属性。

以下示例创建了ArkTS的[Scroll](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#scroll12>)类型节点，并在Native侧修改了Scroll的属性。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/XjeneAm3RjGjEoHien99OQ/zh-cn_image_0000002613638365.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030615Z&HW-CC-Expire=86400&HW-CC-Sign=9FD74C8D15DC5426F22C7B803A878945BBF347698CAE5C914863FF203E4B6465)

## 支持跨语言设置属性的节点类型

仅以下节点类型支持跨语言设置节点属性。

| ArkTS侧[TypedFrameNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#typedframenode12>)类型 | Native侧[ArkUI\_NodeType](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodetype>)类型 | ArkTS属性获取接口 | ArkTS控制器获取/绑定接口 |
| --- | --- | --- | --- |
| [Button](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#button12>) | ARKUI\_NODE\_BUTTON | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributebutton20>) | NA |
| [Checkbox](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#checkbox18>) | ARKUI\_NODE\_CHECKBOX | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributecheckbox20>) | NA |
| [Radio](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#radio18>) | ARKUI\_NODE\_RADIO | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributeradio20>) | NA |
| [Slider](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#slider18>) | ARKUI\_NODE\_SLIDER | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributeslider20>) | NA |
| [Toggle](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#toggle18>) | ARKUI\_NODE\_TOGGLE | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributetoggle20>) | NA |
| [Progress](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#progress12>) | ARKUI\_NODE\_PROGRESS | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributeprogress20>) | NA |
| [LoadingProgress](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#loadingprogress12>) | ARKUI\_NODE\_LOADING\_PROGRESS | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributeloadingprogress20>) | NA |
| [Image](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#image12>) | ARKUI\_NODE\_IMAGE | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributeimage20>) | NA |
| [XComponent](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#xcomponent12>) | ARKUI\_NODE\_XCOMPONENT | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributexcomponent20>) | getController |
| [Column](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#column12>) | ARKUI\_NODE\_COLUMN | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributecolumn20>) | NA |
| [Row](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#row12>) | ARKUI\_NODE\_ROW | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributerow20>) | NA |
| [Stack](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#stack12>) | ARKUI\_NODE\_STACK | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributestack20>) | NA |
| [Flex](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#flex12>) | ARKUI\_NODE\_FLEX | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributeflex20>) | NA |
| [RelativeContainer](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#relativecontainer12>) | ARKUI\_NODE\_RELATIVE\_CONTAINER | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributerelativecontainer20>) | NA |
| [Swiper](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#swiper12>) | ARKUI\_NODE\_SWIPER | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributeswiper20>) | [bindController](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#bindcontrollerswiper20>) |
| [Scroll](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#scroll12>) | ARKUI\_NODE\_SCROLL | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributescroll15>) | [bindController](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#bindcontrollerscroll15>) |
| [List](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#list12>) | ARKUI\_NODE\_LIST | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributelist20>) | [bindController](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#bindcontrollerlist20>) |
| [ListItem](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#listitem12>) | ARKUI\_NODE\_LIST\_ITEM | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributelistitem20>) | NA |
| [ListItemGroup](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#listitemgroup12>) | ARKUI\_NODE\_LIST\_ITEM\_GROUP | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributelistitemgroup20>) | NA |
| [WaterFlow](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#waterflow12>) | ARKUI\_NODE\_WATER\_FLOW | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributewaterflow20>) | [bindController](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#bindcontrollerwaterflow20>) |
| [FlowItem](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#flowitem12>) | ARKUI\_NODE\_FLOW\_ITEM | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributeflowitem20>) | NA |
| [Grid](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#grid14>) | ARKUI\_NODE\_GRID | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributegrid20>) | [bindController](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#bindcontrollergrid20>) |
| [GridItem](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#griditem14>) | ARKUI\_NODE\_GRID\_ITEM | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributegriditem20>) | NA |
| [Text](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#text12>) | ARKUI\_NODE\_TEXT | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributetext20>) | [bindController](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#bindcontrollertext20>) |
| [TextInput](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#textinput12>) | ARKUI\_NODE\_TEXT\_INPUT | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributetextinput20>) | [bindController](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#bindcontrollertextinput20>) |
| [TextArea](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#textarea14>) | ARKUI\_NODE\_TEXT\_AREA | [getAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getattributetextarea20>) | [bindController](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#bindcontrollertextarea20>) |
