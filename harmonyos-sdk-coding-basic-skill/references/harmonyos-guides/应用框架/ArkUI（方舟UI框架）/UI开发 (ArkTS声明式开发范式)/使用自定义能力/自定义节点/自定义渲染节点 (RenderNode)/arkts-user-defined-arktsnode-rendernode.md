...
scraped_at: 2026-06-01T11:06:12+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:c58a07934bf2dbcd1118a0be934fc1c24a4169b91dc134d73ee5b123d936c723
---
## 概述

对于不具备自己的渲染环境的三方框架，尽管已实现前端解析、布局及事件处理等功能，但仍需依赖系统的基础渲染和动画能力。[FrameNode](<../自定义组件节点 (FrameNode)/arkts-user-defined-arktsnode-framenode.md>)上的通用属性与通用事件对这类框架而言是冗余的，会导致多次不必要的操作，涵盖布局、事件处理等逻辑。

自定义渲染节点 ([RenderNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md>))是更加轻量的渲染节点，仅具备与渲染相关的功能。它提供了设置基础渲染属性的能力，以及节点的动态添加、删除和自定义绘制的能力。RenderNode能够为第三方框架提供基础的渲染和动画支持。

## 创建和删除节点

RenderNode提供了节点创建和删除的能力。可以通过RenderNode的构造函数创建自定义的RenderNode节点。通过构造函数创建的节点对应一个实体的节点。同时，可以通过RenderNode中的[dispose](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#dispose12>)接口来实现与实体节点的绑定关系的解除。
...
* RenderNode中获取的子树结构由开发通过RenderNode的[appendChild](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#appendchild>)接口传入的参数构建。
...
[OperationNodeTree.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/CustomRenderNode/entry/src/main/ets/pages/OperationNodeTree.ets#L16-L97)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/pJNK-OddTZO3_hf8hPEtFg/zh-cn_image_0000002613638355.png?HW-CC-KV=V1&HW-CC-Date=20260601T030219Z&HW-CC-Expire=86400&HW-CC-Sign=C42B8D7CBB434D182C8470C0B3589FC987013C4270A17AD0BD1155768B0493D3)

## 设置和获取渲染相关属性

RenderNode中可以设置渲染相关的属性，包括：[backgroundColor](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#backgroundcolor>)，[clipToFrame](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#cliptoframe>)，[opacity](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#opacity>)，[size](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#size>)，[position](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#position>)，[frame](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#frame>)，[pivot](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#pivot>)，[scale](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#scale>)，[translation](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#translation>)，[rotation](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#rotation>)，[transform](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#transform>)，[shadowColor](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#shadowcolor>)，[shadowOffset](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#shadowoffset>)，[shadowAlpha](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#shadowalpha>)，[shadowElevation](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#shadowelevation>)，[shadowRadius](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#shadowradius>)，[borderStyle](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#borderstyle12>)，[borderWidth](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#borderwidth12>)，[borderColor](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#bordercolor12>)，[borderRadius](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#borderradius12>)，[shapeMask](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#shapemask12>)，[shapeClip](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#shapeclip12>)，[markNodeGroup](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#marknodegroup12>)等。具体属性支持范围参考[RenderNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md>)接口说明。

说明

* RenderNode中获取的属性为设置的属性值。
* 若未传入参数或者传入参数为非法值则查询获得的为默认值。
* 不建议对[BuilderNode](<../自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md>)中的RenderNode进行修改操作。BuilderNode中具体属性设置是由状态管理实现的，属性更新的时序开发者不可控，BuilderNode和FrameNode中同时设置RenderNode属性可能会导致RenderNode属性设置与预期不相符。
...
[RenderingProperties.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/CustomRenderNode/entry/src/main/ets/pages/RenderingProperties.ets#L16-L218)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e2/v3/iIlnjKybQcOPodFMuJaMAg/zh-cn_image_0000002613518461.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030219Z&HW-CC-Expire=86400&HW-CC-Sign=8E262F63D9F917837015B7DAC6C225A60FF5C71902A759B48E32D7CDB0F8DE63)

## 自定义绘制

通过重写RenderNode中的[draw](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#draw>)方法，可以自定义RenderNode的绘制内容，通过[invalidate](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#invalidate>)接口可以主动触发节点的重新绘制。
...
[CustomDraw.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/CustomRenderNode/entry/src/main/ets/pages/CustomDraw.ets#L16-L113)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/1vRvgFJuSJSE0_Odix2bQQ/zh-cn_image_0000002582958664.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030219Z&HW-CC-Expire=86400&HW-CC-Sign=F751528B7E461657C745235416C7BB25F9A028526C36176FFFBD55946729D257)

## 调整自定义绘制Canvas的变换矩阵

从API version 12开始，通过重写RenderNode中的[draw](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#draw>)方法，可以自定义RenderNode的绘制内容。

通过[concatMatrix](<../../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (Canvas)/arkts-apis-graphics-drawing-canvas.md#concatmatrix12>)可以调整自定义绘制Canvas的变换矩阵。
...
[CustomDrawCanvas.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/CustomRenderNode/entry/src/main/ets/pages/CustomDrawCanvas.ets#L16-L163)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/3F3BVozNQUCKM212g62d2Q/zh-cn_image_0000002583118590.png?HW-CC-KV=V1&HW-CC-Date=20260601T030219Z&HW-CC-Expire=86400&HW-CC-Sign=CB8EFB151A6170C35E8ECFC446B8704F5292133C0E64F5244891AA40982E373C)

**Node-API调用示例：**

C++侧可通过Node-API来获取[Canvas](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/画布绘制/Canvas/ts-components-canvas-canvas.md)，并进行后续的自定义绘制操作。
...
[NativeBridge.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/CustomRenderNode/entry/src/main/cpp/NativeBridge.cpp#L16-L100)
...
[Index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/CustomRenderNode/entry/src/main/cpp/types/libentry/Index.d.ts#L16-L20)
...
[CustomDrawCanvasNative.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/CustomRenderNode/entry/src/main/ets/pages/CustomDrawCanvasNative.ets#L16-L74)

## 设置标签

开发者可利用[label](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#label12>)接口向RenderNode设置标签信息，有助于在使用inspector[检查页面布局](../../../UI系统场景化能力/检查页面布局/arkts-inspector-overview.md)时更清晰区分各节点。
...
[SetLabel.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/CustomRenderNode/entry/src/main/ets/pages/SetLabel.ets#L16-L72)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/6DsCtSOSR2Wibal5Va7tWQ/zh-cn_image_0000002613638357.png?HW-CC-KV=V1&HW-CC-Date=20260601T030219Z&HW-CC-Expire=86400&HW-CC-Sign=CA32862E995009D142475AD8802861197EB368486F99943E6B6D83F757F475C6)
...
从API version 20开始，使用[isDisposed](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md#isdisposed20>)接口查询当前RenderNode对象是否已解除与后端实体节点的引用关系，从而可以在操作节点前检查其有效性，避免潜在风险。
...
36. @Entry
37. @Component
38. export struct CheckRenderNodeDisposed {
...
[CheckRenderNodeDisposed.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/CustomRenderNode/entry/src/main/ets/pages/CheckRenderNodeDisposed.ets#L16-L93)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/9zYbBQXyRJCBb1fGXDi2AA/zh-cn_image_0000002613518463.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030219Z&HW-CC-Expire=86400&HW-CC-Sign=8FAFB1D7F018B871505A584B2BC432D142926C9B3E9528EBDB6EA56E88864A75)
