...
scraped_at: 2026-06-01T11:06:11+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:9edd21f5febe9dedbf9c571a282574fc0c00cec45a44a671427bb46bb40c38c3
---
## 概述

对于拥有自定义前端的第三方框架（如JSON、XML、DOM树等），需将特定的DSL转换为ArkUI的声明式描述。如下图描述了JSON定义的前端框架和ArkUI声明式描述的对应关系。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/WRRe7mUmTxW9m6u_dKh1Rw/zh-cn_image_0000002613518457.png?HW-CC-KV=V1&HW-CC-Date=20260601T030609Z&HW-CC-Expire=86400&HW-CC-Sign=A17F7B6DD92516FF2089B6EDDAEEA814119A3BB8D951B2BECDF01C0D26EC27ED)

上述转换过程需要依赖额外的数据驱动，绑定至[Builder](../../../学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md)中，较为复杂且性能欠佳。这类框架通常依赖于ArkUI的布局、事件处理、基础的节点操作和自定义能力。大部分组件通过自定义实现，但需结合使用部分系统组件以实现混合显示，如下图示例既使用了[FrameNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md>)的自定义方法进行绘制，又使用了系统组件[Column](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/行列与堆叠/Column/ts-container-column.md)及其子组件[Text](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Text/ts-basic-components-text.md)，通过[BuilderNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/BuilderNode/js-apis-arkui-buildernode.md>)的方式将其挂载到根节点的FrameNode上混合显示。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/0lwtN0E3SlOWCvsuhUvi1Q/zh-cn_image_0000002582958660.png?HW-CC-KV=V1&HW-CC-Date=20260601T030609Z&HW-CC-Expire=86400&HW-CC-Sign=B4047DF104421460E003758607EFD146C39438DDA3DCD2B5C9EF8F3EA2410CDC)

[FrameNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md>)的设计初衷正是为了解决上述转换问题。FrameNode表示组件树中的实体节点，与自定义占位容器组件[NodeContainer](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义占位组件/NodeContainer/ts-basic-components-nodecontainer.md)相配合，实现在占位容器内构建一棵自定义的节点树。该节点树支持动态操作，如节点的增加、修改和删除。基础的FrameNode具备设置通用属性和事件回调的功能，同时提供完整的自定义能力，涵盖自定义测量、布局和绘制等方面。

除此之外，ArkUI还提供了获取和遍历系统组件对应代理FrameNode对象的能力（下文简称代理节点）。代理节点能够用于遍历整个UI的树形结构，支持获取系统组件节点的详细信息，以及额外注册组件的事件监听回调。

## 创建和删除节点

FrameNode提供了节点创建和删除的能力。可以通过FrameNode的构造函数创建自定义FrameNode节点，通过构造函数创建的节点对应一个实体的节点。同时，可以通过FrameNode中的[dispose](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#dispose12>)接口来实现与实体节点的绑定关系的解除。
...
[isModifiable](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#ismodifiable12>)用于查询当前节点类型是否为系统组件的代理节点。当FrameNode节点作为系统组件的代理节点的时候，该节点不可修改。即无法修改代理节点的自身属性以及其子节点的结构。

## 获取对应的RenderNode节点

FrameNode提供了[getRenderNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getrendernode>)接口，用于获取FrameNode中的RenderNode。可以通过对获取到的RenderNode对象进行操作，动态修改FrameNode上绘制相关的属性，具体可修改的属性参考[RenderNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/RenderNode/js-apis-arkui-rendernode.md>)的接口。

说明

* 无法获取系统组件代理FrameNode的RenderNode对象。
* BuilderNode中调用[getFrameNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/BuilderNode/js-apis-arkui-buildernode.md#getframenode>)获取得到的FrameNode节点对象中，可以通过getRenderNode获取对应的根节点的RenderNode对象。
...
[FrameNodeTree.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/FrameNode/entry/src/main/ets/pages/framenode/FrameNodeTree.ets#L16-L306)

## 使用moveTo移动命令式节点

使用[moveTo](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#moveto18>)接口可以将FrameNode节点移动到新的父节点下，从而按需改变节点树结构。

说明

当前FrameNode如果不可修改，抛出异常信息。

目标父节点为[typeNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#typenode12>)时会校验子组件类型或个数，不满足抛出异常信息，限制情况请查看[typeNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#typenode12>)描述。

当前不支持对无组件类型的命令式节点进行移动。

当前仅支持以下类型的[TypedFrameNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#typedframenode12>)进行移动操作：[Stack](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#stack12>)、[XComponent](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#xcomponent12>)。对于其他类型的节点，移动操作不会生效。

当前仅支持根节点为以下类型组件的[BuilderNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/BuilderNode/js-apis-arkui-buildernode.md#buildernode-1>)进行移动操作：[Stack](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/行列与堆叠/Stack/ts-container-stack.md)、[XComponent](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)、[EmbeddedComponent](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/EmbeddedComponent/ts-container-embedded-component.md)。对于其他类型的组件，移动操作不会生效。
...
[FrameNodeMoveTo.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/FrameNode/entry/src/main/ets/pages/framenode/FrameNodeMoveTo.ets#L16-L72)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/qz3g1g0NTei6pxPyC_YcSA/zh-cn_image_0000002583118586.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030609Z&HW-CC-Expire=86400&HW-CC-Sign=736FF21F9591D67FBEF0F57CBEC5D0BF9679C865296A40AF60C65FB61527AE45)

## 设置节点通用属性和事件回调

FrameNode提供了[commonAttribute](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#commonattribute12>)和[commonEvent](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#commonevent12>)两个对象用于设置节点的[通用属性](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/ts-component-general-attributes.md)和[设置事件回调](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/公共定义/设置事件回调/ts-uicommonevent.md)。
...
[FrameNodeCommon.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/FrameNode/entry/src/main/ets/pages/framenode/FrameNodeCommon.ets#L16-L196)

## 自定义测量布局与绘制

通过重写[onDraw](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#ondraw12>)方法，可以自定义FrameNode的绘制内容。[invalidate](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#invalidate12>)接口可以主动触发节点的重新绘制。

通过重写[onMeasure](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#onmeasure12>)可以自定义FrameNode的测量方式，使用[measure](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#measure12>)可以主动传递布局约束触发重新测量。

通过重写[onLayout](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#onlayout12>)方法可以自定义FrameNode的布局方式，使用[layout](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#layout12>)方法可以主动传递位置信息并触发重新布局。

[setNeedsLayout](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#setneedslayout12>)可以将当前节点标记，在下一帧触发重新布局。
...
[FrameNodeDraw.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/FrameNode/entry/src/main/ets/pages/framenode/FrameNodeDraw.ets#L16-L166)
...
1. 使用[getFrameNodeById](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getframenodebyid12>)获取。
2. 使用[getFrameNodeByUniqueId](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getframenodebyuniqueid12>)获取。
3. 通过[无感监听](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md>)获取。

说明

1、当前接口提供的可查询的信息包括：

* 节点大小：[getMeasuredSize](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getmeasuredsize12>)，[getUserConfigSize](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuserconfigsize12>)
* 布局信息：[getPositionToWindow](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getpositiontowindow12>)，[getPositionToParent](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getpositiontoparent12>)，[getLayoutPosition](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getlayoutposition12>)，[getUserConfigBorderWidth](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuserconfigborderwidth12>)，[getUserConfigPadding](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuserconfigpadding12>)，[getUserConfigMargin](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuserconfigmargin12>)
* 节点信息：[getId](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getid12>)，[getUniqueId](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuniqueid12>)，[getNodeType](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getnodetype12>)，[getOpacity](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getopacity12>)，[isVisible](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#isvisible12>)，[isClipToFrame](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#iscliptoframe12>)，[isAttached](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#isattached12>)，[getInspectorInfo](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getinspectorinfo12>)，[getCustomProperty](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getcustomproperty12>)

2、无法获取UINode类型节点，例如：JsView节点、[Span](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/Span/ts-basic-components-span.md)、[ContainerSpan](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/文本与输入/ContainerSpan/ts-basic-components-containerspan.md)、[ContentSlot](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义占位组件/ContentSlot/ts-components-contentslot.md)、[ForEach](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/ForEach/ts-rendering-control-foreach.md)、[LazyForEach](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)、if/else组件等。

## 获取节点位置偏移信息

FrameNode提供了查询节点相对窗口、父组件以及屏幕位置偏移的信息接口（[getPositionToWindow](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getpositiontowindow12>)，[getPositionToParent](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getpositiontoparent12>)，[getPositionToScreen](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getpositiontoscreen12>)，[getGlobalPositionOnDisplay](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getglobalpositionondisplay20>)，[getPositionToWindowWithTransform](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getpositiontowindowwithtransform12>)，[getPositionToParentWithTransform](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getpositiontoparentwithtransform12>)，[getPositionToScreenWithTransform](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getpositiontoscreenwithtransform12>)，[getLayoutPosition](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getlayoutposition12>)，[getUserConfigBorderWidth](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuserconfigborderwidth12>)，[getUserConfigPadding](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuserconfigpadding12>)，[getUserConfigMargin](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuserconfigmargin12>)）。

[getPositionToWindow](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getpositiontowindow12>)，[getPositionToParent](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getpositiontoparent12>)，[getPositionToScreen](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getpositiontoscreen12>)三个接口获取到的位置信息关系如下图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/fTNTHDZYSeeWF7FqyujKug/zh-cn_image_0000002613638353.png?HW-CC-KV=V1&HW-CC-Date=20260601T030609Z&HW-CC-Expire=86400&HW-CC-Sign=674408FA9F6E94EE5F2F37DCFDBEB4F405C605E7676D85DB40FD090282AF9D7F)
...
[FrameNodePosition.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/FrameNode/entry/src/main/ets/pages/framenode/FrameNodePosition.ets#L16-L137)

## 通过typeNode创建具体类型的FrameNode节点

通过[typeNode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#typenode12>)创建具体类型的FrameNode节点，可以根据属性获取接口来检索用户设置的属性信息。
...
[FrameNodeTypeNode.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/FrameNode/entry/src/main/ets/pages/framenode/FrameNodeTypeNode.ets#L16-L332)

## 解除当前FrameNode对象对实体FrameNode节点的引用关系

使用[dispose](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#dispose12>)接口可以立即解除当前FrameNode对象对实体FrameNode节点的引用关系。

说明

在调用dispose方法后，FrameNode对象不再对应任何实际的FrameNode节点。此时，若尝试调用以下查询接口：[getMeasuredSize](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getmeasuredsize12>)、[getLayoutPosition](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getlayoutposition12>)、[getUserConfigBorderWidth](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuserconfigborderwidth12>)、[getUserConfigPadding](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuserconfigpadding12>)、[getUserConfigMargin](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuserconfigmargin12>)、[getUserConfigSize](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuserconfigsize12>)，将导致应用程序触发[jscrash](../../../../UI开发调试调优/UI稳定性故障调试/UI稳定性故障分析概述/arkts-stability-guide.md#jscrash)。

通过[getUniqueId](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuniqueid12>)可以判断当前FrameNode是否对应一个实体FrameNode节点。当UniqueId大于0时表示该对象对应一个实体FrameNode节点。
...
[FrameNodeDisposed.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/FrameNode/entry/src/main/ets/pages/framenode/FrameNodeDisposed.ets#L16-L120)

## 查询当前FrameNode是否解除引用

前端节点均绑定有相应的后端实体节点，当节点调用dispose接口解除绑定后，再次调用接口可能会出现crash、返回默认值的情况。

从API version 20开始，使用[isDisposed](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#isdisposed20>)接口查询当前FrameNode对象是否已解除与后端实体节点的引用关系，从而可以在操作节点前检查其有效性，避免潜在风险。
...
[FrameNodeIsDisposed.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/FrameNode/entry/src/main/ets/pages/framenode/FrameNodeIsDisposed.ets#L16-L78)

## FrameNode的数据懒加载能力

提供[NodeAdapter](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#nodeadapter12>)对象替代ArkTS侧的[LazyForEach](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)功能，提供自定义节点的数据懒加载功能，实现按需迭代数据。
...
[FrameNodeLazyForEach.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/FrameNode/entry/src/main/ets/pages/framenode/FrameNodeLazyForEach.ets#L16-L227)

## 查询LazyForEach中的FrameNode节点信息

如果FrameNode子节点中包含[LazyForEach](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)节点，[getChild](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getchild15>)接口支持指定子节点展开模式[ExpandMode](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#expandmode15>)，以不同展开模式获取子节点。
...
可以使用[getFirstChildIndexWithoutExpand](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getfirstchildindexwithoutexpand15>)和[getLastChildIndexWithoutExpand](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getlastchildindexwithoutexpand15>)获取当前节点第一个和最后一个在主节点树上的子节点的序列号，其中子节点序列号按所有子节点计算。
...
[FrameNodeLazyForEachSelect.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/FrameNode/entry/src/main/ets/pages/framenode/FrameNodeLazyForEachSelect.ets#L16-L278)

## 调整自定义绘制Canvas的变换矩阵

从API version 12开始，通过重写FrameNode的[onDraw](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#ondraw12>)方法，可以重写默认绘制方法。

通过[concatMatrix](<../../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (Canvas)/arkts-apis-graphics-drawing-canvas.md#concatmatrix12>)可以调整自定义绘制画布的变换矩阵。

说明

* [getTotalMatrix](<../../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (Canvas)/arkts-apis-graphics-drawing-canvas.md#gettotalmatrix12>)获取的是用来记录绘制指令的临时canvas的变换矩阵。
* 如果开发者希望对画布进行预期的变换，应使用[concatMatrix](<../../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (Canvas)/arkts-apis-graphics-drawing-canvas.md#concatmatrix12>)而不是[setMatrix](<../../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (Canvas)/arkts-apis-graphics-drawing-canvas.md#setmatrix12>)，因为setMatrix会覆盖原本真实canvas上存在的变换矩阵。
...
[FrameNodeCanvas.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/FrameNode/entry/src/main/ets/pages/framenode/FrameNodeCanvas.ets#L16-L148)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/NnnkjxYmSyikU10Y4eGLiQ/zh-cn_image_0000002613518459.png?HW-CC-KV=V1&HW-CC-Date=20260601T030609Z&HW-CC-Expire=86400&HW-CC-Sign=19F22F310CD06526E1160676DC45AA4FC3F08FF05DF8FE555DE5265175E619F6)

## 更新当前帧节点

从API version 21开始，通过使用frameNode的[invalidateAttributes](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#invalidateattributes21>)方法，可以在当前帧触发节点更新，避免组件切换过程中出现闪烁。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/_vCMpVx_Q_KexLubaNDEmg/zh-cn_image_0000002582958662.png?HW-CC-KV=V1&HW-CC-Date=20260601T030609Z&HW-CC-Expire=86400&HW-CC-Sign=2E22C7437E6537CDBAA029CA3DECF3C2048B92CD80823795F2BB1774EE70E5F8)

## 判断节点是否处于渲染状态

从API version 23开始，通过使用FrameNode的[isInRenderState](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#isinrenderstate23>)方法，判断FrameNode节点是否处于渲染状态。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/VxFZdUSJRACweEZJVvuRzQ/zh-cn_image_0000002583118588.png?HW-CC-KV=V1&HW-CC-Date=20260601T030609Z&HW-CC-Expire=86400&HW-CC-Sign=DEDD954F28E9C1427E2224CCAA978FDEB5DF9CD7A20692994A049798A0E45554)
