...
scraped_at: 2026-06-11T14:29:50+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:9327e505cff952bd17b5362c3b6841d2cae0729ae0eb4dafb37c6c33c60d55ab
---
ForEach接口基于数组循环渲染，需要与容器组件配合使用，且接口返回的组件应当是允许包含在ForEach父容器组件中的子组件。例如，[ListItem](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md)组件要求ForEach的父容器组件必须为[List组件](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)。

API参数说明见：[ForEach API参数说明](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/ForEach/ts-rendering-control-foreach.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/TJ6BcJYtSlizi2oppSeZGg/zh-cn_image_0000002592377968.png?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=1AF3A3EC8667518AC77634FAEE97DEAC17FA437A1B7656D0C2AA84731C0E7857)
...
[ForEach1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/ForEach1.ets#L16-L48)

运行效果如下图所示。

**图2** ForEach数据项不存在相同键值案例首次渲染运行效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/DRFnzKvpSDSKbQkCmahdgA/zh-cn_image_0000002622857475.png?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=8EF63F84C273DB87553001B6B7BD94D698584EBD72127C2AF6616C7AF5413AA7)
...
[ForEach2.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/ForEach2.ets#L16-L46)

运行效果如下图所示。

**图3** ForEach数据源存在相同值案例首次渲染运行效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/EVlVcIN0SX2D5B1eRnyqvA/zh-cn_image_0000002622697597.png?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=D0A942888293DA103296573CB80F7155FDB8D501B1F4C68C923A5A7FF609CB10)
...
[ForEach3.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/ForEach3.ets#L16-L55)

运行效果如下图所示。

**图4** ForEach非首次渲染案例运行效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/rOb36AMhQ0q-Xr8sjo73ug/zh-cn_image_0000002592218036.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=9EC6A04126D1EEC2329540F1BDCF6CFE37B8BECFCEAEFB5BC683BE4E72DCA8E5)

从本例可以看出[@State](../../学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@State装饰器：组件内状态/arkts-state.md)能够监听到简单数据类型数组simpleList数组项的变化。
...
[ArticleSkeletonView.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/ArticleSkeletonView.ets#L16-L68)

运行效果如下图所示。

**图5** 骨架屏运行效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/8RwbR2hiR-Gv-g1ZxOja7w/zh-cn_image_0000002592377970.png?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=D73D089C5E07E373C6AB4DD8E66C3F6EF7148AFEEDD224866E5215F2A2D33861)
...
[ArticleListView.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/ArticleListView.ets#L16-L110)

初始运行效果（左图）和手势上滑加载后效果（右图）如下图所示。

**图6** 数据源数组项变化案例运行效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/JwpaqjUCTD-hfpuLHwSlSw/zh-cn_image_0000002622857477.png?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=94285CDBA5F95BE803F17A7EB2BA5B2CACBD0146F3B2C980A05C9A389B05F53B)

在本示例中，ArticleCardChangeSource组件作为ArticleListViewChangeSource组件的子组件，通过[@Prop](../../学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Prop装饰器：父子单向同步/arkts-prop.md)装饰器接收一个ArticleChangeSource对象，用于渲染文章卡片。
...
当数据源的数组项为对象数据类型，并且只修改某个数组项的属性值时，由于数据源为复杂数据类型，ArkUI框架无法监听到@State装饰器修饰的数据源数组项的属性变化，从而无法触发ForEach的重新渲染。为实现ForEach子组件重新渲染，需要结合[@Observed和@ObjectLink](../../学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Observed装饰器和@ObjectLink装饰器：嵌套类对象属性变化/arkts-observed-and-objectlink.md)装饰器使用。例如，在文章列表卡片上点击“点赞”按钮，从而修改文章的点赞数量。
...
[ArticleListView2.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/ArticleListView2.ets#L16-L113)

上述代码的初始运行效果（左图）和点击第1个文章卡片上的点赞图标后的运行效果（右图）如下图所示。

**图7** 数据源数组项子属性变化案例运行效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/df/v3/yloNIkOZSj-3IqNV5X3-qg/zh-cn_image_0000002622697599.png?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=E62F5B51768CA90710C2EF0228CE46CC3DE196C2B2D2A4CA2554278A97EA37DF)
...
在List组件下使用ForEach，并设置[onMove](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/拖拽排序/ts-universal-attributes-drag-sorting.md#onmove)事件，每次迭代生成一个ListItem时，可以使能拖拽排序。拖拽排序离手后，如果组件位置发生变化，将触发onMove事件，上报组件移动原始索引号和目标索引号。在onMove事件中，需要根据上报的起始索引号和目标索引号修改数据源。数据源修改前后，要保持每个数据的键值不变，只是顺序发生变化，才能保证落位动画正常执行。
...
[ForEachSort.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/ForEachSort.ets#L16-L62)

**图8** ForEach拖拽排序效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/q0L1vVi1TgiJLKpRJtvfEQ/zh-cn_image_0000002592218038.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=80E7357F1CCAA7B0CF7C4756E1B79568932DB8CDC063862FAF7DE04CBB44961C)

注释掉onMove事件调用中的两行代码，点击Add one item触发渲染后的效果如下图所示。

**图9** ForEach拖拽排序效果在重新渲染后没有保留

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/SYGotBQUQqGZemeej1pdlw/zh-cn_image_0000002592377972.png?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=422EEBEA0A71CAE92DAA26C0C4BBFB581E28437B507F8152CE14594A68A51BB5)
...
* ForEach在滚动容器组件 [List](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)、[Grid](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)、[Swiper](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md)以及[WaterFlow](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md) 内使用的时候，不建议与[LazyForEach](../LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md) 同时使用。
* 在大量子组件的场景下，ForEach可能会导致卡顿。请考虑使用[LazyForEach](../LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md)替代。最佳实践请参考[使用懒加载优化性能](../../../../../../best-practices/性能/性能场景优化案例/界面渲染性能优化/懒加载优化性能/bpta-lazyforeach-optimization.md)。
...
[AbnormalExample.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/AbnormalExample.ets#L16-L51)

上述代码的初始渲染效果和点击“在第1项后插入新项”文本组件后的渲染效果如下图所示。

**图10** 渲染结果非预期运行效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/i4aL6hDARKaiIG55OW1i6Q/zh-cn_image_0000002622857479.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=77C36174638F5B58F3CEDF8963134CB6E52886142CD00BF75C942D05B327AA49)
...
[BadPerformance.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/BadPerformance.ets#L16-L60)

以上代码的初始渲染效果和点击"Insert Item After First Item"文本组件后的渲染效果如下图所示。

**图11** 渲染性能降低案例运行效果图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/HfbLmzOzRsuG0-lnpO1U4w/zh-cn_image_0000002622697601.gif?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=38CA3A78F2294FAD4F848CDB1284BD5FCD9B56EBE974DFFC3CBB749FB3F98326)

点击“Insert Item After First Item”文本组件后，DevEco Studio的日志打印结果如下所示。

**图12** 渲染性能降低案例日志打印图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/50/v3/D4PkAAeOQwaxoGUJ_hULVg/zh-cn_image_0000002592218040.png?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=1BFFE0AB0B396F990672AEC1BF6B06DE46245D3E26DC018EE11BEC9F9DDCE984)

插入新项后，ForEach为new item、 two、 three三个数组项创建了对应的ReducedChildItem组件，并执行了组件的[aboutToAppear()](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoappear)生命周期函数。这是因为：
...
[ForEach1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/ForEach1.ets#L25-L29)
...
[ArticleListView3.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/ArticleListView3.ets#L16-L131)

**图13** 数据变化不渲染

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/bx0doDaVSH-wxo3FI4a2ww/zh-cn_image_0000002592377974.png?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=35B88CD9E7C20434692B0B7FF81686BE7350C8780A5C9DA82CD952C05AF06E26)
...
[NonNecessaryMem.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/NonNecessaryMem.ets#L16-L59)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/h98A69fUTkaAjCiQfW5K2g/zh-cn_image_0000002622857481.png?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=CD87810C574EEB5DDEFB5A1E441B09072CF7D557E48567710C3F770A6C0442FC)

**图15** 自定义键值生成函数下的内存占用

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/Ed0_dfPSTDWDm1gsacMwxw/zh-cn_image_0000002622697603.png?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=DA1619AA53E50C73CBC981BA721706F7330A0F1D8135A2ECE72203E916CF901A)
...
[CrashNormalExample.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/RenderingControl/entry/src/main/ets/pages/RenderingForeach/CrashNormalExample.ets#L16-L58)

开发者定义keyGenerator函数，应用正常启动：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/8PeVa_mPQz6sc1wcCjX05Q/zh-cn_image_0000002592218042.png?HW-CC-KV=V1&HW-CC-Date=20260611T062948Z&HW-CC-Expire=86400&HW-CC-Sign=F237E5E12D1D94264497F6DBBECE0B7ED6A2705ACD75FD54DA99B79CDF651B43)
