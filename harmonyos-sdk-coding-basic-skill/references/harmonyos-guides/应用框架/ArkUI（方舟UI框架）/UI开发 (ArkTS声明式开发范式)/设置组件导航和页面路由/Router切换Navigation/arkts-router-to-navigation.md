...
content_hash: sha256:ea5617971a09b6442bd1f19fb85338552f2117a34ba02736c3e7acb714cdba3e
---
鉴于组件导航（[Navigation](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)）支持更丰富的动效、一次开发多端部署能力和更灵活的栈操作。本文主要从页面跳转、动效和生命周期等方面介绍如何从Router切换到Navigation。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/router/Index.ets#L16-L128)
...
[PageOne.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/router/PageOne.ets#L16-L41)

而基于Navigation的路由页面分为导航页和子页，导航页又叫[Navbar](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navbar12)，是Navigation包含的子组件，子页是[NavDestination](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)包含的子组件。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/navigation/Index.ets#L16-L39)
...
[PageOne.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/navigation/PageOne.ets#L16-L45)

每个子页面也需要配置到系统配置文件router\_map.json中（参考[系统路由表](<../组件导航(Navigation) (推荐)/Navigation跨包路由/arkts-navigation-cross-package.md#系统路由表>)）。
...
Router通过@ohos.router模块提供的方法来操作页面，建议使用[UIContext](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getRouter](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getrouter>)获取[Router](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (Router)/arkts-apis-uicontext-router.md>)对象。
...
[GetRouter.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/navPathStack/GetRouter.ets#L34-L52)

Navigation通过导航控制器对象[NavPathStack](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navpathstack10)提供的方法来操作页面，需要创建一个栈对象并传入Navigation中。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/navPathStack/Index.ets#L16-L31)
...
[PathStack.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/navPathStack/PathStack.ets#L35-L72)
...
[Router1.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/router/Router1.ets#L16-L46)

**方式二**：子页面通过[OnReady](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md#onready11)回调获取。
...
[Router2.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/router/Router2.ets#L16-L31)
...
[Router3.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/router/Router3.ets#L16-L48)

**方式四**：通过自定义组件查询接口获取，参考[queryNavigationInfo](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件内置方法/ts-custom-component-api.md#querynavigationinfo12)。
...
[Router4.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/router/Router4.ets#L16-L40)
...
Router页面[生命周期](<../页面路由 (@ohos.router)(不推荐)/arkts-routing.md#生命周期>)为@Entry页面中的通用方法，主要有如下四个生命周期：
...
[Comm.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/lifeCycle/Comm.ets#L20-L36)

其生命周期时序如下图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/NFeC3JwVRP2w6Incsji5Cg/zh-cn_image_0000002622697645.png?HW-CC-KV=V1&HW-CC-Date=20260611T063010Z&HW-CC-Expire=86400&HW-CC-Sign=DED4AC4684BB744CBB437F0F7DFA263CE157BD32022610C9C8F90A86FE83062C)

Navigation作为路由容器，其生命周期承载在NavDestination组件上，以组件事件的形式开放。

具体生命周期描述请参考Navigation[页面生命周期](<../组件导航(Navigation) (推荐)/Navigation子页面/arkts-navigation-navdestination.md#页面生命周期>)。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/lifeCycle/Index.ets#L16-L48)

## 转场动画

Router和Navigation都提供了系统的转场动画，也提供了自定义转场的能力。

其中Router自定义页面转场通过通用方法pageTransition()实现，具体可参考Router[页面转场动画](<../../使用动画/转场动画/页面转场动画 (不推荐)/arkts-page-transition-animation.md>)。

Navigation作为路由容器组件，其内部的页面切换动画本质上属于组件跟组件之间的属性动画，可以通过Navigation中的[customNavContentTransition](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#customnavcontenttransition11)事件提供自定义转场动画的能力，具体实现可以参考Navigation[自定义转场](<../组件导航(Navigation) (推荐)/Navigation转场动画/arkts-navigation-animation.md#自定义转场>)。（注意：API version 13之前，Dialog类型的页面默认无转场动画。从API version13开始，Dialog类型的页面支持系统转场动画。）

## 共享元素转场

页面和页面之间跳转的时候需要进行共享元素过渡动画，Router可以通过通用属性sharedTransition来实现共享元素转场，具体可以参考如下链接：

[Router共享元素转场动画](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/动画/共享元素转场 (sharedTransition)/ts-transition-animation-shared-elements.md>)。

Navigation也提供了共享元素一镜到底的转场能力，需要配合geometryTransition属性，在子页面（NavDestination）之间切换时，可以实现共享元素转场，具体可参考[Navigation共享元素转场动画](<../组件导航(Navigation) (推荐)/Navigation转场动画/arkts-navigation-animation.md#共享元素转场>)。

## 跨包路由

Router可以通过命名路由的方式实现跨包跳转。

1. 在想要跳转到的共享包[HAR](../../../../../基础入门/开发基础知识/应用程序包基础知识/应用程序包开发与使用/HAR/har-package.md)或者[HSP](../../../../../基础入门/开发基础知识/应用程序包基础知识/应用程序包开发与使用/HSP/in-app-hsp.md)页面里，给@Entry修饰的自定义组件[EntryOptions](../../学习UI范式基本语法/自定义组件/创建自定义组件/arkts-create-custom-components.md#entry)命名。
   ...
   [Hsp11.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/router/Hsp11.ets#L16-L34)
...
3. 配置成功后需要在跳转的页面中引入命名路由的页面并跳转。
   ...
   [Hsp12.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/router/Hsp12.ets#L16-L57)
...
1. 从HSP（HAR）中完成自定义组件（需要跳转的目标页面）开发，将自定义组件申明为export。
   ...
   [Hsp21.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/router/Hsp21.ets#L16-L25)
2. 在HSP（HAR）的Index.ets中导出组件。
   ...
   [Hsp22.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/router/Hsp22.ets#L16-L18)
...
4. 配置好HSP（HAR）的项目依赖后，在mainPage中导入自定义组件，并添加到pageMap中，即可正常调用。
   ...
   [Hsp23.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/router/Hsp23.ets#L16-L44)
...
具体可参考Navigation[系统路由表](<../组件导航(Navigation) (推荐)/Navigation跨包路由/arkts-navigation-cross-package.md#系统路由表>)。

## 生命周期监听

Router可以通过observer实现注册监听，接口定义请参考Router无感监听[uiObserver.on('routerPageUpdate')](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#uiobserveronrouterpageupdate11>)。
...
[Comm.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/observer/Comm.ets#L16-L31)
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/observer/Index.ets#L16-L47)

## 页面信息查询

为了实现页面内自定义组件跟页面解耦，自定义组件中提供了全局查询页面信息的接口。

Router可以通过[queryRouterPageInfo](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件内置方法/ts-custom-component-api.md#queryrouterpageinfo12)接口查询当前自定义组件所在的Page页面的信息，其返回值包含如下几个属性，其中pageId是页面的唯一标识符：
...
[PageInfo.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/observer/PageInfo.ets#L16-L30)

Navigation也可以通过[queryNavDestinationInfo](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件内置方法/ts-custom-component-api.md#querynavdestinationinfo)接口查询当前自定义组件所在的NavDestination的信息，其返回值包含如下几个属性，其中navDestinationId是页面的唯一标识符：
...
[QueryNav.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/Navigation/entry/src/main/ets/pages/routerToNavigation/observer/QueryNav.ets#L16-L44)

## 路由拦截

Router没有提供路由拦截的能力，开发者需要自行封装路由跳转接口，并在自己封装的接口中做路由拦截的判断并重定向路由。

Navigation提供了[setInterception](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#setinterception12)方法，用于设置Navigation页面跳转拦截回调。具体可以参考文档：Navigation[路由拦截](<../组件导航(Navigation) (推荐)/Navigation页面路由/arkts-navigation-jump.md#路由拦截>)
