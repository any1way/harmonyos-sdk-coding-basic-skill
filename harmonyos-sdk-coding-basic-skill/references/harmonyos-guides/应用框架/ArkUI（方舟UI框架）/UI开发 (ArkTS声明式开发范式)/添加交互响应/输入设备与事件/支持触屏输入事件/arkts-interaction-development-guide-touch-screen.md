...
scraped_at: 2026-06-11T14:31:47+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:7c522eb7ce2e6dbd979b699d1e66f93e29c77be8b16ad239d2453e6061f2c6c2
---
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/3hmNe40ZSriuWmpjquD_QQ/zh-cn_image_0000002622857781.png?HW-CC-KV=V1&HW-CC-Date=20260611T063146Z&HW-CC-Expire=86400&HW-CC-Sign=0F18BCDADA1646B76081A6B527CD25F9096F3B1F505F1E1CAC6ADB1109DEE6A0)

触屏设备是最常见的输入设备，几乎所有手持类终端设备都支持用户通过触控操作。触摸事件也是应用开发者最常处理的事件类型之一。

需要注意的是，对于其他类型的输入设备上的类似触控行为的操作，系统为了交互一致性，也会将其转换为触摸事件派发给应用，如按下**鼠标**左键点击、滑动，既可以接收到Touch事件，也可以接收到鼠标事件。如果要将其与触屏设备产生的触摸事件进行区分，可以通过事件中的[SourceType](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/绑定手势/绑定手势事件/ts-gesture-settings.md#sourcetype枚举说明8)进行判断。

## 触摸事件

触摸事件可以通过通用事件[onTouch](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)在组件上接收，该回调响应遵循命中测试规则。

触摸事件的上报频率会由系统降采样到与屏幕刷新率一致，详见[重采样与历史点](arkts-interaction-development-guide-touch-screen.md#重采样与历史点)章节。

对于支持多点触控的输入设备，使用多根手指同时操作可以产生多个触点，全部的触点信息可以通过[TouchEvent](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明)的touches成员得到，而changedTouches会给出当前事件上报时，是哪些触点在产生变化。

其他更多的事件信息可以从[TouchEvent](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明)的基类[BaseEvent](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/手势控制/自定义手势判定/ts-gesture-customize-judge.md#baseevent8)中获得。

## 阻止冒泡

参考[事件冒泡](../../交互基础机制说明/arkts-interaction-basic-principles.md#事件冒泡)了解冒泡机制，以下是一个简单示例，实现了只要点击在子组件区域内，就阻止父组件接收触摸事件：
...
[PreventBubbling.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/InterAction/entry/src/main/ets/pages/PreventBubbling/PreventBubbling.ets#L16-L54)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/xKFAAYNSRtGVTWWi3fg15A/zh-cn_image_0000002622697903.png?HW-CC-KV=V1&HW-CC-Date=20260611T063146Z&HW-CC-Expire=86400&HW-CC-Sign=9D5D776B15463C22DDAB7EEBB4D7CDE735DDF15B0489C81819BC351C22BDCB27)
...
[Sampling.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/InterAction/entry/src/main/ets/pages/sampling/Sampling.ets#L16-L47)
...
[MultipleFingerInformation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/InterAction/entry/src/main/ets/pages/MultipleFingerInformation/MultipleFingerInformation.ets#L16-L65)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/QjR2PzhBRxCcmxt2Pif7Tw/zh-cn_image_0000002592218342.png?HW-CC-KV=V1&HW-CC-Date=20260611T063146Z&HW-CC-Expire=86400&HW-CC-Sign=9C87584A1AFD3738516BC1ABE76532F18D190D94E8A263953404DEFD3761948F)
...
触控笔操作触摸屏与通过手指操作类似，都会产生触摸事件，可以通过sourceTool进行区分。而对于一些主动式电容笔，上报的触摸事件中，还会包含笔接触屏幕时的夹角信息，可参考[BaseEvent](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/手势处理/手势控制/自定义手势判定/ts-gesture-customize-judge.md#baseevent8)。
