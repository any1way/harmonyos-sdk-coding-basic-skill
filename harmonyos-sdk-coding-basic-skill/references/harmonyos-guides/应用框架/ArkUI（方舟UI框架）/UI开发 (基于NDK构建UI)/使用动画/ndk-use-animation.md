...
scraped_at: 2026-06-01T11:06:52+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:e80d7ab9f813a35a42a9f4b7bcfe54f5a41f1d022dcef67ef5f3a4f98eb4f29f
---
## 使用属性动画

[ArkUI](../../ArkUI简介/arkui-overview.md)开发框架在[NDK](../../../../NDK开发/NDK开发导读/ndk-development-overview.md)接口主要提供属性动画，实现组件出现/消失转场。同时，可以通过Node-API桥接[ArkTS](../../../ArkTS（方舟编程语言）/ArkTS简介/arkts-overview.md)侧帧动画能力，实现Native侧的动画效果。

说明

* 需要从ArkTS侧获取[this.getUIContext()](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义组件/自定义组件内置方法/ts-custom-component-api.md#getuicontext)，传入到Native侧。
* 在Native侧通过[OH\_ArkUI\_GetContextFromNapiValue](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node_napi.h/capi-native-node-napi-h.md#oh_arkui_getcontextfromnapivalue>)方法获取context。
* 需要执行的动画属性变化必须写在[ArkUI\_ContextCallback](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_ContextCallback/capi-arkui-nativemodule-arkui-contextcallback.md>)中的callback中。
...
提供全局[animateTo](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeAnimateAPI_1/capi-arkui-nativemodule-arkui-nativeanimateapi-1.md#animateto>)显式动画接口，来指定由于闭包代码导致的状态变化插入过渡动效。同属性动画，布局类改变宽高的动画，内容都是直接到终点状态。

1. 在.ets文件中创建[NodeContent](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/NodeContent/js-apis-arkui-nodecontent.md>)，把NodeContent作为参数输出到Native方法中。
   ...
   [UseFrameAnimation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/AnimationNDK/entry/src/main/ets/pages/UseFrameAnimation.ets#L22-L49)
2. 解析NodeContent，转换为C中的[ArkUI\_NodeContentHandle](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md>)对象。
   ...
   [NativeEntry.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/AnimationNDK/entry/src/main/cpp/NativeEntry.cpp#L31-L35)
3. 获取[ArkUI\_NativeAnimateAPI\_1](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeAnimateAPI_1/capi-arkui-nativemodule-arkui-nativeanimateapi-1.md>) 对象。
   ...
   [ArkUIAnimate.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/AnimationNDK/entry/src/main/cpp/ArkUIAnimate.h#L114-L118)
4. 设置[ArkUI\_AnimateOption](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md>)参数，通过提供的C方法设置对应的参数。
   ...
   [ArkUIAnimate.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/AnimationNDK/entry/src/main/cpp/ArkUIAnimate.h#L230-L247)
5. 设置回调参数。
   ...
   [ArkUIAnimate.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/AnimationNDK/entry/src/main/cpp/ArkUIAnimate.h#L249-L295)

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/rKc4CBuFRBevUhQzu_jE4A/zh-cn_image_0000002583118644.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030652Z&HW-CC-Expire=86400&HW-CC-Sign=7C18D9DA06E41B978B74EB36A6C887297E43883F3725EF46F7B63AA2259B7840)

## 组件出现/消失转场

组件内转场通过NODE\_XX\_TRANSITION属性（XX包括：OPACITY、TRANSLATE、SCALE、ROTATE、MOVE）配置转场参数，在组件插入和删除时显示过渡动效（通过[NODE\_TRANSFORM\_CENTER](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeattributetype>)属性设置NODE\_SCALE\_TRANSITION和NODE\_ROTATE\_ROTATE动效的中心点坐标）。主要用于容器组件中子组件插入和删除时，提升用户体验。

1. 创建可交互界面，界面中包含Button，点击可以控制转场节点的添加和移除。其中 ArkUI\_NodeContentHandle 类型节点的获取与使用可参考[接入ArkTS页面](../接入ArkTS页面/ndk-access-the-arkts-page.md)。
   ...
   [ArkUITransition.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/AnimationNDK/entry/src/main/cpp/ArkUITransition.h#L24-L131)
2. 创建一个设置了[NODE\_ROTATE\_TRANSITION](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md>), [NODE\_SCALE\_TRANSITION](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md>), [NODE\_TRANSLATE\_TRANSITION](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md>)属性的节点，当目标节点上下树时会播放转场动画。
   ...
   [ArkUITransition.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/AnimationNDK/entry/src/main/cpp/ArkUITransition.h#L31-L68)
3. 在Button的监听回调里添加转场节点上下树逻辑，以此控制转场节点的入场和出场。
   ...
   [ArkUITransition.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/AnimationNDK/entry/src/main/cpp/ArkUITransition.h#L69-L92)

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/b2UhT92qSSa4pO1PAIguHQ/zh-cn_image_0000002613638413.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030652Z&HW-CC-Expire=86400&HW-CC-Sign=92C2FBD4009E423318CB55AA0F48E4C6F7B1C368102910AD4FDC23620E0C4851)

## 使用关键帧动画

[keyframeAnimateTo](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeAnimateAPI_1/capi-arkui-nativemodule-arkui-nativeanimateapi-1.md#keyframeanimateto>)接口来指定若干个关键帧状态，实现分段的动画。同属性动画，布局类改变宽高的动画，内容都是直接到终点状态。

该示例主要演示如何通过[keyframeAnimateTo](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeAnimateAPI_1/capi-arkui-nativemodule-arkui-nativeanimateapi-1.md#keyframeanimateto>)来设置关键帧动画，NDK接口开发的UI界面挂载到ArkTS主页面的完整流程可参考[接入ArkTS页面](../接入ArkTS页面/ndk-access-the-arkts-page.md)。
...
[ArkUIAnimate.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/AnimationNDK/entry/src/main/cpp/ArkUIAnimate.h#L81-L190)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/v3vGyoyiTM2JTQKEpZsT-Q/zh-cn_image_0000002613518517.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030652Z&HW-CC-Expire=86400&HW-CC-Sign=B171C2C032213698EF211FC6DB5E3FCF3C43FBECED7826D3F8E986A60AD55CC6)

## 使用帧动画

帧动画具有逐帧回调的特性，便于开发者在每一帧中调整所需属性。通过提供[onFrame](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_animate.h/capi-native-animate-h.md#oh_arkui_animatoroption_registeronframecallback>)逐帧回调，帧动画允许开发者在应用的每一帧设置属性值，从而实现组件属性值变化的自然过渡，营造出流畅的动画效果。帧动画接口可参考[createAnimator](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeAnimateAPI_1/capi-arkui-nativemodule-arkui-nativeanimateapi-1.md#createanimator>)。

与属性动画相比，帧动画能让开发者实时感知动画进程，即时调整UI值，并具备事件即时响应和可暂停的优势，但在性能方面略逊于属性动画。当属性动画能满足需求时，建议优先采用属性动画接口实现。[animateTo](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeAnimateAPI_1/capi-arkui-nativemodule-arkui-nativeanimateapi-1.md#animateto>)接口的使用可参考[使用属性动画](ndk-use-animation.md#使用属性动画)。

该示例主要演示如何通过[createAnimator](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeAnimateAPI_1/capi-arkui-nativemodule-arkui-nativeanimateapi-1.md#createanimator>)来设置帧动画，完整的示例工程请参考[AnimationNDK](https://gitcode.com/HarmonyOS_Samples/guide-snippets/tree/master/ArkUISample/AnimationNDK)。
...
[ArkUIAnimate.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/AnimationNDK/entry/src/main/cpp/ArkUIAnimate.h#L446-L656)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/UR2CUhg4QMe8epLq4HodFw/zh-cn_image_0000002582958720.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030652Z&HW-CC-Expire=86400&HW-CC-Sign=B66B2D3CF1A66C5F57F4B053354336B147DFBA061783D6DE762F62A8556C8763)
