...
content_hash: sha256:78b662f68cd97f86301f6e92bbab601910f3cd01ae77a3d2ec2d8166b12d4463
---
输入框包含多种交互行为，开发者可注册事件监听并获取状态。以下以多行文本输入框为例进行说明，单行文本输入框添加文本事件监听的步骤与此类似。

要实现实时搜索功能，可注册[NODE\_TEXT\_AREA\_ON\_CHANGE](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)事件，输入框文本发生变化时会收到通知，并能获取当前文本内容。

要实现文字过滤功能，可注册[NODE\_TEXT\_AREA\_ON\_WILL\_INSERT](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)事件，在文字即将插入前会收到通知，通过返回值控制文字是否插入。

要实现用户编辑文字前后页面布局的不同，可注册[NODE\_TEXT\_AREA\_ON\_EDIT\_CHANGE](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)事件，输入框编辑状态切换时会收到通知。

以下示例基于[接入ArkTS页面章节](../../接入ArkTS页面/ndk-access-the-arkts-page.md)，说明如何监听输入框的事件及数据解析。

* 注册事件

  事件注册有统一接口，详情请参见[registerNodeEvent](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeNodeAPI_1/capi-arkui-nativemodule-arkui-nativenodeapi-1.md#registernodeevent>)。输入框支持的事件类型，请参见NativeNode组件支持的事件类型定义[ArkUI\_NodeEventType](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)，搜索前缀NODE\_TEXT\_AREA\_。
  ...
  [manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextAreaEventNDK/entry/src/main/cpp/manager.cpp#L102-L136)
* 注册事件回调

  事件回调注册有统一接口，详情请参见[registerNodeEventReceiver](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeNodeAPI_1/capi-arkui-nativemodule-arkui-nativenodeapi-1.md#registernodeeventreceiver>)。
  ...
  [manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextAreaEventNDK/entry/src/main/cpp/manager.cpp#L144-L166)
* 完整示例
  ...
  [manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/TextAreaEventNDK/entry/src/main/cpp/manager.cpp#L15-L168)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6a/v3/bs-XiWRPTG6YHZ2sqOnjHg/zh-cn_image_0000002613518521.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030659Z&HW-CC-Expire=86400&HW-CC-Sign=CAA4B6D7A4A3866CEB1B8ABF6DC2368239ADC6B699AC873B12BE63D8701BB239)
