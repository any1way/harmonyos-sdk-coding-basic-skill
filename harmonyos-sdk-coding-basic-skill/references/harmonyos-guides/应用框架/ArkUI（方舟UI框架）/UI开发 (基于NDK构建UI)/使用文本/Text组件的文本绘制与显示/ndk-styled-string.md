...
scraped_at: 2026-06-01T11:06:59+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:8150c3f5c71c2772964986f3af3022eb13846d9ab527a97639b2906155d24961
---
部分框架或应用具备自研的文字排版能力，在移植时，这些能力会被对接到[方舟2D图形服务的文本引擎](<../../../../../图形/ArkGraphics 2D（方舟2D图形服务）/文本/文本绘制与显示/复杂文本绘制与显示（CC++）/complex-text-c.md>)。为了避免开发者重复开发文本组件，Text组件提供了接口[NODE\_TEXT\_CONTENT\_WITH\_STYLED\_STRING](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/ArkUI_NodeAttributeType（文本显示类组件相关属性）/capi-native-node-h-nodeattributetype-text.md#node_text_content_with_styled_string>)，可以直接渲染方舟文本引擎生成的文本。

以下场景基于[接入ArkTS页面章节](../../接入ArkTS页面/ndk-access-the-arkts-page.md)，阐述了如何创建字体引擎文本，并利用[ArkUI\_NodeType](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodetype>)进行渲染显示。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/EHXUHACQTYyyY9tYWD8iPw/zh-cn_image_0000002583118648.png?HW-CC-KV=V1&HW-CC-Date=20260601T030659Z&HW-CC-Expire=86400&HW-CC-Sign=C3568483381A64023BDEE5D08BCCE5A3A3E4D114C9388566C420139631059AA7)

## 创建Text组件

创建文本组件时，无需配置文字颜色、字体大小等样式属性，因为这些属性通过字体引擎接口设置。但仍需设置基础的[ArkUI\_NodeAttributeType（通用属性）](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/ArkUI_NodeAttributeType（通用属性）/capi-native-node-h-nodeattributetype-common.md>)，如宽度和高度。如果不指定，组件自动适应文本的宽度和高度。
...
[manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/StyledStringNDK/entry/src/main/cpp/manager.cpp#L105-L126)
...
* 设置段落样式
  ...
  OH\_Drawing\_前缀的接口由方舟字体引擎提供，参考[简单文本绘制与显示（C/C++)](<../../../../../图形/ArkGraphics 2D（方舟2D图形服务）/文本/文本绘制与显示/简单文本绘制与显示（CC++）/simple-text-c.md>)、[复杂文本绘制与显示（C/C++）](<../../../../../图形/ArkGraphics 2D（方舟2D图形服务）/文本/文本绘制与显示/复杂文本绘制与显示（CC++）/complex-text-c.md>)。
...
* 设置文本样式
  ...
  1. [OH\_ArkUI\_StyledString\_PushTextStyle](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/styled_string.h/capi-styled-string-h.md#oh_arkui_styledstring_pushtextstyle>)：将文字样式推入栈中。
  2. [OH\_ArkUI\_StyledString\_AddText](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/styled_string.h/capi-styled-string-h.md#oh_arkui_styledstring_addtext>)：添加要修改样式的文字内容。
  3. [OH\_ArkUI\_StyledString\_PopTextStyle](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/styled_string.h/capi-styled-string-h.md#oh_arkui_styledstring_poptextstyle>)：将文字样式弹出栈。
  ...
  [OH\_Drawing\_CreateTextStyle](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_text_typography.h/capi-drawing-text-typography-h.md#oh_drawing_createtextstyle>)创建文本样式。设置“Hello”字体大小28px，颜色为0xFF707070。设置“World!”字体大小为28px，颜色为0xFF2787D9。
...
[manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/StyledStringNDK/entry/src/main/cpp/manager.cpp#L141-L161)

## 文本布局与绘制

* 文本布局

  文字样式和内容设置完成后，调用字体引擎接口[OH\_Drawing\_TypographyLayout](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_text_typography.h/capi-drawing-text-typography-h.md#oh_drawing_typographylayout>)对文本进行布局，传入最大宽度。超过此宽度的文字会自动换行。
  ...
  [manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/StyledStringNDK/entry/src/main/cpp/manager.cpp#L164-L169)
* 文本绘制
  ...
  [manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/StyledStringNDK/entry/src/main/cpp/manager.cpp#L170-L174)
...
相关字体引擎销毁的接口请参考[OH\_Drawing\_DestroyTextStyle](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_text_typography.h/capi-drawing-text-typography-h.md#oh_drawing_destroytextstyle>) 和 [OH\_Drawing\_DestroyTypographyStyle](<../../../../../../harmonyos-references/ArkGraphics 2D（方舟2D图形服务）/C API/头文件/drawing_text_typography.h/capi-drawing-text-typography-h.md#oh_drawing_destroytypographystyle>)。

Text组件提供[OH\_ArkUI\_StyledString\_Destroy](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/styled_string.h/capi-styled-string-h.md#oh_arkui_styledstring_destroy>)，用于销毁属性字符串对象。
...
[manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/StyledStringNDK/entry/src/main/cpp/manager.cpp#L15-L182)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/XaE7gLKkQMWFg5aspRGYDA/zh-cn_image_0000002613638417.png?HW-CC-KV=V1&HW-CC-Date=20260601T030659Z&HW-CC-Expire=86400&HW-CC-Sign=368B1C91DFC970F684C4D4DE0B3F8960314ED796F7E4C498AFC472E5973FE97F)
