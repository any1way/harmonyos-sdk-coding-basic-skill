...
scraped_at: 2026-06-01T11:06:46+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:828e0ed31ed2dca79225b1ba3ce3cfd052d27eafb4ab3f9be4f8f610cd6e67b4
---
## 占位组件

使用NDK接口构建UI界面时，需要在ArkTS页面创建用于挂载NDK接口创建组件的占位组件。占位组件类型为[ContentSlot](../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/自定义占位组件/ContentSlot/ts-components-contentslot.md)，ContentSlot能够绑定一个[NodeContent](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/NodeContent/js-apis-arkui-nodecontent.md>)对象，该对象可通过Node-API传递到Native侧挂载显示Native组件。
...
* NDK配置文件entry/src/main/cpp/types/libentry/oh-package.json5如下。
  ...
  [oh-package.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/cpp/types/libentry/oh-package.json5#L16-L23)
* 占位组件和其他ArkTS系统组件使用方法相同。详细代码请参考[示例](ndk-access-the-arkts-page.md#示例)。
  ...
  [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/ets/pages/Index.ets#L16-L53)
...
NDK提供的UI组件能力如组件创建、树操作、属性设置、事件注册等是通过函数指针结构体（如[ArkUI\_NativeNodeAPI\_1](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeNodeAPI_1/capi-arkui-nativemodule-arkui-nativenodeapi-1.md>)）进行暴露，该函数指针结构体可以通过[模块查询接口](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_interface.h/capi-native-interface-h.md#oh_arkui_getmoduleinterface>)获取。

说明

* [模块查询接口](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_interface.h/capi-native-interface-h.md#oh_arkui_getmoduleinterface>)带有初始化NDK的逻辑，建议先调用该接口进行全局初始化，再使用NDK进行UI构造。
...
* 组件创建和销毁。
  ...
  获取NDK接口支持的组件范围可以通过查询[ArkUI\_NodeType](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodetype>)枚举值。
* 组件树操作。
...
* 属性设置。
  ...
  获取NDK接口支持的属性范围可以通过查询[ArkUI\_NodeAttributeType](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeattributetype>)枚举值。
* 事件注册。
  ...
  获取NDK接口支持的事件范围可以通过查询[ArkUI\_NodeEventType](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)枚举值。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/kYpVDwlxSFqpyIaMeLuGoA/zh-cn_image_0000002582958718.gif?HW-CC-KV=V1&HW-CC-Date=20260601T030646Z&HW-CC-Expire=86400&HW-CC-Sign=5A67E1F0481011B50132C0582C7DAEC9EDFEBE56B76F6DA890C99FA54BCFFBD7)
...
2. 使用Native模板创建工程，并在Native侧提供Node-API的桥接方法，实现ArkTS侧的NativeNode模块接口。
   ...
   [Index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/cpp/types/libentry/Index.d.ts#L15-L19)
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/cpp/napi_init.cpp#L15-L47)
3. 在NativeEntry.h文件中创建Native界面。
   ...
   [NativeEntry.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/cpp/NativeEntry.h#L15-L66)
   ...
   [NativeEntry.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/cpp/NativeEntry.cpp#L15-L52)
...
4. 由于NDK接口提供的是C接口，为了使用面向对象的方式简化编程和工程管理，这里建议使用C++进行二次封装，下面示例代码展示了示例界面中所需的列表，文本组件封装类。
   ...
   1）获取ArkUI在NDK接口的入口模块[ArkUI\_NativeNodeAPI\_1](<../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeNodeAPI_1/capi-arkui-nativemodule-arkui-nativenodeapi-1.md>)，该结构体模块提供了一系列组件创建、树构建、属性设置和事件注册等函数指针。
   ...
   [NativeModule.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/cpp/NativeModule.h#L15-L50)
   ...
   [ArkUIBaseNode.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/cpp/ArkUIBaseNode.h#L15-L88)
   ...
   [ArkUINode.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/cpp/ArkUINode.h#L15-L83)
   ...
   [ArkUIListNode.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/cpp/ArkUIListNode.h#L15-L43)
   ...
   [ArkUIListItemNode.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/cpp/ArkUIListItemNode.h#L15-L32)
   ...
   [ArkUITextNode.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/cpp/ArkUITextNode.h#L15-L58)
5. 完善步骤3的CreateTextListExample函数，实现Native文本列表的创建和挂载显示。
   ...
   [NormalTextListExample.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/ButtonList/entry/src/main/cpp/NormalTextListExample.h#L15-L60)
