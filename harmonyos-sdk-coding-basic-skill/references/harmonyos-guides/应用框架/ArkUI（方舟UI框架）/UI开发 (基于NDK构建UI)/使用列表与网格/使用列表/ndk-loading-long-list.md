...
scraped_at: 2026-06-01T11:06:55+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:648611f9e82fdccc027b5cae148831af0c77ac96c79cc016c575e9d2297fd354
---
...
参考[接入ArkTS页面](../../接入ArkTS页面/ndk-access-the-arkts-page.md)章节实现列表创建。

## 监听滚动事件

参考[监听组件事件](../../添加交互事件/监听组件事件/ndk-listen-to-component-events.md)章节实现列表滚动事件监听。

## 使用懒加载

### NodeAdapter介绍

NDK提供了NodeAdapter对象替代ArkTS侧的[LazyForEach](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)功能，用于按需生成子组件，NodeAdapter支持在[List](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)/[ListItemGroup](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItemGroup/ts-container-listitemgroup.md)、[Grid](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)、[WaterFlow](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)、[Swiper](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md)组件中使用。

* 设置了NodeAdapter属性的节点，不支持直接通过[addChild](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_NativeNodeAPI_1/capi-arkui-nativemodule-arkui-nativenodeapi-1.md#addchild>)等接口添加子组件。子组件完全由NodeAdapter管理，使用属性方法设置NodeAdapter时，会判断父组件是否已经存在子节点，如果父组件已经存在子节点，则设置NodeAdapter操作失败，返回错误码。
* NodeAdapter通过相关事件通知开发者按需生成组件，类似组件事件机制，开发者使用NodeAdapter时要通过[OH\_ArkUI\_NodeAdapter\_RegisterEventReceiver](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#oh_arkui_nodeadapter_registereventreceiver>)注册事件监听器，在监听器事件中处理逻辑，相关事件通过[ArkUI\_NodeAdapterEventType](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeadaptereventtype>)定义。另外NodeAdapter不会主动释放不在屏幕内显示的组件对象，开发者需要在[NODE\_ADAPTER\_EVENT\_ON\_REMOVE\_NODE\_FROM\_ADAPTER](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeadaptereventtype>)事件中进行组件对象的释放，或者进行缓存复用。下图展示了典型列表滑动场景下的事件触发机制：

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2/v3/O9DVvDyHSRi_0eN1LEYaFA/zh-cn_image_0000002583118646.png?HW-CC-KV=V1&HW-CC-Date=20260601T030655Z&HW-CC-Expire=86400&HW-CC-Sign=9C7CFAC7BFE3BD37E60894E23FBAED65D70C7A99E429641983DB49F31F3BD1BB)
...
[ArkUIListItemAdapter.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/ArkUIListItemAdapter.h#L15-L276)

### 在列表中应用懒加载适配器

1. 在ArkUIListNode中添加SetLazyAdapter函数，给列表节点设置[NODE\_LIST\_NODE\_ADAPTER](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/ArkUI_NodeAttributeType（滚动容器类组件相关属性）/ative-node-h-nodeattributetype-scrollablecontainer.md#node_list_node_adapter>)属性，并将NodeAdapter作为属性入参传入。
   ...
   [ArkUIListNode.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/ArkUIListNode.h#L15-L151)
2. 创建List使用懒加载的示例代码，调用List节点的SetLazyAdapter接口设置懒加载适配器。
   ...
   [LazyTextListExample1.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/LazyTextListExample1.h#L15-L155)
3. 在NativeEntry.cpp中调用List使用懒加载的示例代码。
   ...
   [NativeEntry.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/NativeEntry.cpp#L15-L85)
...
1. 控制列表滚动到指定偏移量位置。
   ...
   [ArkUIListNode.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/ArkUIListNode.h#L16-L144)
2. 控制列表滚动到指定元素。
   ...
   [ArkUIListNode.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/ArkUIListNode.h#L17-L146)
3. 控制列表滚动指定偏移量。
   ...
   [ArkUIListNode.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/ArkUIListNode.h#L19-L147)

## ListItem横划删除

1. [ListItem](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md)设置[NODE\_LIST\_ITEM\_SWIPE\_ACTION](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/ArkUI_NodeAttributeType（滚动容器类组件相关属性）/ative-node-h-nodeattributetype-scrollablecontainer.md#node_list_item_swipe_action>)属性，将[ArkUI\_ListItemSwipeActionOption](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_ListItemSwipeActionOption/arkui-nativemodule-arkui-listitemswipeactionoption.md>)对象作为属性参数传入。
   ...
   [ArkUIListItemNode.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/ArkUIListItemNode.h#L15-L54)
2. 设置创建ListItem和复用ListItem的回调函数。当创建[ListItem](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md)时，创建ListItem的划出组件，并绑定点击事件，在点击事件中执行删除数据源操作。ListItem复用时，更新划出组件的绑定事件。
   ...
   [LazyTextListExample1.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/LazyTextListExample1.h#L16-L156)
3. 添加新的ListItem时，优先复用已缓存的[ListItem](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md)实例，并更新其内容；若无可用缓存，则创建新的ListItem。当回调返回空时，创建一个默认的ListItem作为兜底方案。最后，将生成的节点句柄回填至[OH\_ArkUI\_NodeAdapterEvent\_SetItem](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#oh_arkui_nodeadapterevent_setitem>)事件中，完成绑定。
   ...
   [ArkUIListItemAdapter.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/ArkUIListItemAdapter.h#L16-L271)
4. ArkUIListItemAdapter中新增RemoveItem，用于删除数据源并且调用[OH\_ArkUI\_NodeAdapter\_RemoveItem](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#oh_arkui_nodeadapter_removeitem>)接口通知框架刷新UI。
   ...
   [ArkUIListItemAdapter.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/ArkUIListItemAdapter.h#L17-L272)

## 使用分组列表

1. 分组列表使用[ListItemGroup](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItemGroup/ts-container-listitemgroup.md)组件实现，ListItemGroup支持添加[header](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItemGroup/ts-container-listitemgroup.md#listitemgroupoptions对象说明)、[footer](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItemGroup/ts-container-listitemgroup.md#listitemgroupoptions对象说明)设置函数，支持使用懒加载。
   ...
   [ArkUIListItemGroupNode.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/ArkUIListItemGroupNode.h#L16-L91)
2. [List](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)组件设置吸顶。
   ...
   [ArkUIListNode.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/ArkUIListNode.h#L18-L145)
3. [List](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)组件下使用[ListItemGroup](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/ListItemGroup/ts-container-listitemgroup.md)实现分组列表界面。
   ...
   [LazyTextListExample.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeType/NdkCreateList/entry/src/main/cpp/LazyTextListExample.h#L15-L120)
