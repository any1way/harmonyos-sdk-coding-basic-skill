...
content_hash: sha256:f3ebb46970082658726294f3a60ed6641bb29f31f63fd213155bc4d903e8870d
---
...
1. 创建一个Column节点，用于绑定手势。
   ...
   [Function.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/Function.h#L380-L395)
2. 创建一个单指长按1秒并持续响应的长按手势。
   ...
   [Function.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/Function.h#L249-L256)
3. 将创建的手势和步骤一中创建的Column节点绑定。
   ...
   [Function.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/Function.h#L403-L418)
...
* 点击手势
  ...
  [Function.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/Function.h#L225-L231)
* 滑动手势
  ...
  [Function.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/Function.h#L237-L243)
* 长按手势
...
* 捏合手势
  ...
  [Function.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/Function.h#L262-L269)
* 旋转手势
  ...
  [Function.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/Function.h#L275-L282)
* 快滑手势
  ...
  [Function.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/Function.h#L288-L295)

## 组合手势

可以将多个不同类型的手势组合在一起，形成一个手势组，这个手势组可以作为一个识别整体，达到对用户多个不同类型手势序列的识别目的。

通过设置[ArkUI\_GroupGestureMode](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_gesture.h/capi-native-gesture-h.md#arkui_groupgesturemode>)来指定这个手势组的识别模式，即组内的手势之间的关系，包含顺序识别SEQUENTIAL\_GROUP，并行识别PARALLEL\_GROUP，互斥识别EXCLUSIVE\_GROUP。

### 顺序识别

顺序识别组合手势对应的ArkUI\_GroupGestureMode为SEQUENTIAL\_GROUP。顺序识别组合手势将按照手势的注册顺序识别手势，直到所有的手势识别成功。当顺序识别组合手势中有一个手势识别失败时，后续手势识别均失败。顺序识别手势组仅有最后一个手势可以响应[GESTURE\_EVENT\_ACTION\_END](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_gesture.h/capi-native-gesture-h.md#arkui_gestureeventactiontype>)。
...
[LongPressAndSwipeGesture.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/LongPressAndSwipeGesture.h#L18-L160)
...
[LongPressAndFlickGesture.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/LongPressAndFlickGesture.h#L18-L163)
...
[SwipeAndPinchExclusiveGesture.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/SwipeAndPinchExclusiveGesture.h#L18-L163)
...
1. 创建自定义手势判定回调。
   ...
   [Function.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/Function.h#L419-L440)
2. 绑定手势判定和节点。
...
[Function.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NdkAddInteractionEvent/entry/src/main/cpp/Function.h#L318-L369)
