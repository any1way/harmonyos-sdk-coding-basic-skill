...
scraped_at: 2026-06-01T11:06:50+08:00
doc_updated_at: 2026-05-28
content_hash: sha256:b5dc2b7c250772aa11383074f634cad4c21c25d9f5d94aaaaf1487fbcfe82f96
---
ArkUI开发框架针对拖拽事件提供了[NODE\_ON\_PRE\_DRAG](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)，[NODE\_ON\_DRAG\_START](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)，[NODE\_ON\_DROP](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)，[NODE\_ON\_DRAG\_ENTER](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)，[NODE\_ON\_DRAG\_MOVE](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)，[NODE\_ON\_DRAG\_LEAVE](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)，[NODE\_ON\_DRAG\_END](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)等组件事件，当拖拽在不同的阶段时会触发对应的组件事件，完成对应的数据处理操作，实现期望的拖拽交互能力。
...
1. 组件拖拽设置。
   ...
   通过[OH\_ArkUI\_GetModuleInterface](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_interface.h/capi-native-interface-h.md#oh_arkui_getmoduleinterface>)接口初始化nodeAPI，创建节点等操作均需通过nodeAPI完成。
   ...
   [manager.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/manager.cpp#L121-L125)

   创建Image节点，通过[OH\_ArkUI\_SetNodeDraggable](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/drag_and_drop.h/capi-drag-and-drop-h.md#oh_arkui_setnodedraggable>)设置节点可拖拽，并设置其他相关属性。
   ...
   [thirdmodule.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/thirdmodule.h#L179-L187)
   ...
   [common.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/common.h#L90-L194)
   ...
   [common.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/common.h#L232-L241)
2. 自定义拖拽预览和背板图。

   创建[pixelMap](<../../../../../../harmonyos-references/Image Kit（图片处理服务）/C API/头文件/pixelmap_native.h/capi-pixelmap-native-h.md#oh_pixelmapnative_createpixelmap>)，设置pixelMap的宽高等各项属性。设置Image节点的[ArkUI\_DragPreviewOption](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_DragPreviewOption/capi-arkui-nativemodule-arkui-dragpreviewoption.md>)，可用于设置跟手图的圆角、角标等。
   ...
   [firstmodule.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/firstmodule.h#L325-L356)
3. 设置相关事件。

   C API的事件通过统一的回调来接收，当收到事件时通过[eventType](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)进行区分。
   ...
   [firstmodule.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/firstmodule.h#L153-L200)
4. 处理NODE\_ON\_DRAG\_START事件。

   在NODE\_ON\_DRAG\_START事件中，应用可以执行起拖阶段所需的操作，通常涉及处理起拖过程的数据。例如，创建[OH\_UdmfRecord](<../../../../../../harmonyos-references/ArkData（方舟数据管理）/C API/结构体/OH_UdmfRecord/capi-udmf-oh-udmfrecord.md>)，将用于拖拽图片所需的数据imageValue以[OH\_UdsFileUri](<../../../../../../harmonyos-references/ArkData（方舟数据管理）/C API/结构体/OH_UdsFileUri/capi-udmf-oh-udsfileuri.md>)类型添加到OH\_UdmfRecord中，接着将OH\_UdmfRecord设置到[OH\_UdmfData](<../../../../../../harmonyos-references/ArkData（方舟数据管理）/C API/结构体/OH_UdmfData/capi-udmf-oh-udmfdata.md>)中，最后将OH\_UdmfData设置到[DragEvent](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_DragEvent/capi-arkui-nativemodule-arkui-dragevent.md>)中。
   ...
   [thirdmodule.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/thirdmodule.h#L32-L102)
5. 处理NODE\_ON\_DROP事件。

   在NODE\_ON\_DROP事件中，应用可以执行与落入阶段相关的操作，通常需要获取拖拽过程中传递的数据。例如，引用[udmf\_meta.h](<../../../../../../harmonyos-references/ArkData（方舟数据管理）/C API/头文件/udmf_meta.h/capi-udmf-meta-h.md>)头文件，获取[OH\_UdmfData](<../../../../../../harmonyos-references/ArkData（方舟数据管理）/C API/结构体/OH_UdmfData/capi-udmf-oh-udmfdata.md>)，判断是否存在所需的数据类型，从[OH\_UdmfRecord](<../../../../../../harmonyos-references/ArkData（方舟数据管理）/C API/结构体/OH_UdmfRecord/capi-udmf-oh-udmfrecord.md>)中提取相应的数据，最后销毁指针。
   ...
   [firstmodule.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/firstmodule.h#L88-L225)
...
1. 节点注册事件。
   ...
   创建Button节点，设置按钮相关属性，同时需要注册[NODE\_ON\_TOUCH\_INTERCEPT](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype>)事件。
   ...
   [forthmodule.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/forthmodule.h#L144-L155)
...
2. 接收NODE\_ON\_TOUCH\_INTERCEPT事件。
   ...
   DragAction主动发起拖拽需通过事件触发，在NODE\_ON\_TOUCH\_INTERCEPT事件中执行发起拖拽所需的操作，通过[targetId](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/头文件/native_node.h/capi-native-node-h.md#oh_arkui_nodeevent_gettargetid>)区分不同按钮触发的事件。
   ...
   [forthmodule.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/forthmodule.h#L49-L92)
3. 起拖阶段设置。

   在NODE\_ON\_TOUCH\_INTERCEPT事件中，需要对DragAction进行相关设置。为了主动发起拖拽，需要创建[pixelMap](<../../../../../../harmonyos-references/Image Kit（图片处理服务）/C API/头文件/pixelmap_native.h/capi-pixelmap-native-h.md#oh_pixelmapnative_createpixelmap>)，设置[ArkUI\_DragPreviewOption](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/C API/结构体/ArkUI_DragPreviewOption/capi-arkui-nativemodule-arkui-dragpreviewoption.md>)和跟手点，并将拖拽过程中的文本数据设置到DragAction中。
   ...
   [forthmodule.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/forthmodule.h#L59-L196)
   ...
   [common.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/common.h#L290-L342)
4. 处理NODE\_ON\_DROP事件。
   ...
   [forthmodule.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkUISample/NativeDragDrop/entry/src/main/cpp/forthmodule.h#L110-L240)
