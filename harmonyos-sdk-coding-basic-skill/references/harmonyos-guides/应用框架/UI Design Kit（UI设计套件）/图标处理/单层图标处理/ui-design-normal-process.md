...
scraped_at: 2026-06-11T14:39:06+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:b48814eb706bcc111044d31e7faf2bf546401f291282d1965bfc015469e8f99b
---
## 场景介绍

从5.0.0(12)版本开始， Hds支持单层图标处理能力。

适用于图标为单层资源，且图标展示风格要与华为HarmonyOS Design System设计风格一致的应用场景，典型应用场景可参考分层图标[场景介绍](../（推荐）分层图标处理/ui-design-layered-process.md#场景介绍)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5b/v3/CjG_La0lQKiWcbQREC8PJw/zh-cn_image_0000002592218752.png?HW-CC-KV=V1&HW-CC-Date=20260611T063538Z&HW-CC-Expire=86400&HW-CC-Sign=A88046B5AC63D0B0B15B8A35400FCD413F4461743B5A95FE383C2E89A9D10A88)
...
2. 将图标处理的相关类添加至工程。
   ...
   ```
3. 简单配置页面的布局，调用[单层图标接口](<../../../../../harmonyos-references/UI Design Kit（UI设计套件）/ArkTS API/hdsDrawable/ui-design-hdsdrawable.md#hdsdrawablegethdsicon>)获取处理后的图标信息，也可以调用[异步批量处理接口](<../../../../../harmonyos-references/UI Design Kit（UI设计套件）/ArkTS API/hdsDrawable/ui-design-hdsdrawable.md#hdsdrawablegethdsicons>)。
