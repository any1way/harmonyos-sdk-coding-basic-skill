...
scraped_at: 2026-06-11T14:39:29+08:00
doc_updated_at: 2026-05-07
content_hash: sha256:ee6854dbc6847bd1251cf1d5d8996fe33836ecdd0994c2a80bb1cab79b4b84a6
---
## 场景介绍

从6.0.0(20)版本开始，新增支持设置定时通知弹窗。

[HdsSnackBar](<../../../../../harmonyos-references/UI Design Kit（UI设计套件）/ArkTS组件/HdsSnackBar/ui-design-hdssnackbar.md>)支持定时通知弹窗。当应用开发者需要定时通知提醒弹窗时，可以通过HdsSnackBar的show方法显示HdsSnackBar弹窗，设置duration是大于0的时间表示弹窗是定时消失的，默认定时时间是5000ms。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/zZYD_gQXRaGLykdCNqQfxg/zh-cn_image_0000002622858207.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063929Z&HW-CC-Expire=86400&HW-CC-Sign=3C667EF81F34C7388F6BF92032238ACDD457E6E35BE0006388D89F07B0E743C4)
