...
content_hash: sha256:dd5ebc8a2d150c404becd58a757c891ce8e21932dec859b556a1bf4653676f96
---
## 场景介绍

从6.0.0(20)版本开始，新增支持应用内多窗。

通过应用内多窗组件[MultiWindowEntryInAPP](<../../../../harmonyos-references/UI Design Kit（UI设计套件）/ArkTS组件/MultiWindowEntryInAPP/ui-design-multiwindowentryinapp-api.md>)提供的单应用多窗口接口，实现一个应用多个窗口并行运行的体验。并且可以设置图标大小颜色、背板大小颜色、文字大小颜色等。
...
2. 使用MultiWindowEntryInAPP组件，并且设置组件参数。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/iI_Y0-OvTiSjtRzdGsUSPw/zh-cn_image_0000002622698335.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T063807Z&HW-CC-Expire=86400&HW-CC-Sign=D4619BA0B97757153E43124DB1EB5BF03AE5A6FB124AECEDE7AD6213EA1D30C5)
