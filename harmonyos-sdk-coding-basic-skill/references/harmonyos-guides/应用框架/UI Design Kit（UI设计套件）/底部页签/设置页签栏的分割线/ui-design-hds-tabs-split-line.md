...
scraped_at: 2026-06-11T14:39:23+08:00
doc_updated_at: 2026-05-07
content_hash: sha256:df26df323b78b279056ec88a3ede9a1dec179a6e9bf476e29b98a1c21ac1ccdb
---
## 场景介绍

从6.0.0(20)版本开始，新增支持设置页签栏的分割线。

[HdsTabs](<../../../../../harmonyos-references/UI Design Kit（UI设计套件）/ArkTS组件/HdsTabs/ui-design-hdstabs.md>)容器组件扩展支持页签栏分割线常隐、常显和渐进显隐。当应用开发者需要分割线一直显示、一直隐藏或者内容区超过页签栏8vp后分割线完全消失时，可以通过设置HdsTabs组件的分割线的模式，同时也支持自定义分割线样式。
