...
content_hash: sha256:f4aa27e90029871948feba1e74da453d6414def9baa9486dcb2193e47ff94df9
---
## ArkTS容器集

ArkTS共享容器（[@arkts.collections (ArkTS容器集)](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/模块描述/arkts-apis-arkts-collections.md>)）是一种在并发实例间共享传输的容器类，用于并发场景下的高性能数据传递。它的功能与ECMAScript 262规范定义的容器类似，但存在部分差异，具体可见[共享容器与原生API方法的行为差异对比](arkts-collections-introduction.md#共享容器与原生api方法的行为差异对比)。

ArkTS共享容器在多个并发实例间传递时，默认采用引用传递，允许多个并发实例操作同一容器实例。此外，还支持拷贝传递，即每个并发实例拥有独立的ArkTS容器实例。

ArkTS共享容器不是线程安全的，内部使用了fail-fast（快速失败）机制，即当检测到多个并发实例同时对容器进行结构性修改时，会触发异常。因此，在多线程场景下修改容器内属性时，开发者需要使用ArkTS提供的[异步锁](../异步锁/arkts-async-lock-introduction.md)机制保证ArkTS容器的安全访问。

ArkTS共享容器包含如下几种：[Array](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Array)/arkts-apis-arkts-collections-array.md>)、[Map](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Map)/arkts-apis-arkts-collections-map.md>)、[Set](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Set)/arkts-apis-arkts-collections-set.md>)、TypedArray（[Int8Array](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Int8Array)/arkts-apis-arkts-collections-int8array.md>)、[Uint8Array](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Uint8Array)/arkts-apis-arkts-collections-uint8array.md>)、[Int16Array](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Int16Array)/arkts-apis-arkts-collections-int16array.md>)、[Uint16Array](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Uint16Array)/arkts-apis-arkts-collections-uint16array.md>)、[Int32Array](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Int32Array)/arkts-apis-arkts-collections-int32array.md>)、[Uint32Array](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Uint32Array)/arkts-apis-arkts-collections-uint32array.md>)、[Uint8ClampedArray](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Uint8ClampedArray)/arkts-apis-arkts-collections-uint8clampedarray.md>)、[Float32Array](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Float32Array)/arkts-apis-arkts-collections-float32array.md>)）、[ArrayBuffer](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (ArrayBuffer)/arkts-apis-arkts-collections-arraybuffer.md>)、[BitVector](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (BitVector)/arkts-apis-arkts-collections-bitvector.md>)、[ConcatArray](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Interface (ConcatArray)/arkts-apis-arkts-collections-concatarray.md>)，具体可见[@arkts.collections (ArkTS容器集)](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/模块描述/arkts-apis-arkts-collections.md>)。
...
[ArktsCollectionsIntroduction.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsConcurrent/ConcurrentThreadCommunication/InterThreadCommunicationObjects/SendableObject/SendableObjectRelated/entry/src/main/ets/managers/ArktsCollectionsIntroduction.ets#L16-L62)
...
支持通过[collections.Array.from](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Array)/arkts-apis-arkts-collections-array.md#from>)方法将原生容器Array转换为ArkTS Array容器；支持通过原生容器Array的from方法将 ArkTS Array容器转换为原生容器Array。
...
支持通过[collections.Int8Array.from](<../../../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Int8Array)/arkts-apis-arkts-collections-int8array.md#from-1>)方法将原生容器Int8Array转换为ArkTS Int8Array容器；也支持通过原生容器 Int8Array的from方法将ArkTS Int8Array容器转换为原生容器Int8Array。
