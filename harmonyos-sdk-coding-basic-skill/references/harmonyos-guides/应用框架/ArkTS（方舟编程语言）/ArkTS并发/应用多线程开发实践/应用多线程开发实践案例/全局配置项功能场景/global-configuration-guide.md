...
content_hash: sha256:b117acd9ce7b9bcb912d54a76bfe3259af6768016b53ac9af0145a1ab95717f8
---
对于需要使用进程单例的场景，例如不同并发实例间需要数据保持一致的全局配置项功能，可以采用[共享模块](../../../并发线程间通信/线程间通信对象/Sendable对象/共享模块/arkts-sendable-module.md)来实现。
...
1. 编写全局配置文件。
   ...
   [Config.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsConcurrent/ApplicationMultithreadingDevelopment/PracticalCases/entry/src/main/ets/managers/Config.ets#L16-L68)
2. UI主线程及子线程访问全局配置项。
   ...
   [GlobalConfigurationGuide.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsConcurrent/ApplicationMultithreadingDevelopment/PracticalCases/entry/src/main/ets/managers/GlobalConfigurationGuide.ets#L16-L135)
