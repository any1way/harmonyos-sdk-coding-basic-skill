...
content_hash: sha256:fa20974bbb0b4a26b86aaac8d74c2e232beb660eb0e1003d18febfc7aedc3398
---
...
**表1** XML解析选项，其详细介绍请参见[ParseOptions](<../../../../../../harmonyos-references/ArkTS（方舟编程语言）/ArkTS API/@ohos.xml (XML解析与生成)/js-apis-xml.md#parseoptions>)。
...
1. 引入模块。
   ...
   [ParsingTagsAndValues.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingTagsAndValues.ets#L16-L18)
2. 对XML文本编码后调用XmlPullParser。
   ...
   [ParsingTagsAndValues.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingTagsAndValues.ets#L40-L51)
   ...
   [ParsingTagsAndValues.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingTagsAndValues.ets#L68-L72)
3. 自定义回调函数，本例直接打印出标签及标签值。
   ...
   [ParsingTagsAndValues.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingTagsAndValues.ets#L20-L38)
4. 设置解析选项，调用parseXml函数。
   ...
   [ParsingTagsAndValues.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingTagsAndValues.ets#L52-L55)
...
1. 引入模块。
   ...
   [ParsingAttributesAndValues.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingAttributesAndValues.ets#L15-L17)
2. 对XML文本编码后调用XmlPullParser。
   ...
   [ParsingAttributesAndValues.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingAttributesAndValues.ets#L27-L38)
3. 自定义回调函数，示例直接打印出属性及属性值。
   ...
   [ParsingAttributesAndValues.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingAttributesAndValues.ets#L19-L25)
4. 设置解析选项，调用parseXml函数。
   ...
   [ParsingAttributesAndValues.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingAttributesAndValues.ets#L39-L43)
...
1. 引入模块。
   ...
   [ParsingEventTypesAndElementInformation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingEventTypesAndElementInformation.ets#L16-L18)
2. 对XML文本编码后调用XmlPullParser。
   ...
   [ParsingEventTypesAndElementInformation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingEventTypesAndElementInformation.ets#L34-L43)
3. 自定义回调函数，示例直接打印元素事件类型及元素深度。
   ...
   [ParsingEventTypesAndElementInformation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingEventTypesAndElementInformation.ets#L20-L32)
4. 设置解析选项，调用parseXml函数。
   ...
   [ParsingEventTypesAndElementInformation.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ParsingEventTypesAndElementInformation.ets#L44-L47)
...
[ExampleScenario.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ArkTS/ArkTsCommonLibrary/XmlGenerationParsingAndConversion/XmlParsing/entry/src/main/ets/pages/ExampleScenario.ets#L16-L65)
