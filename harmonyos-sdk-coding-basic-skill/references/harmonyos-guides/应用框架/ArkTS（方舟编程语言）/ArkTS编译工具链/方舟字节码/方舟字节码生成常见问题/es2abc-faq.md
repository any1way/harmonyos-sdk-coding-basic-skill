...
content_hash: sha256:2b6bc5a933f768f43086112caa44406781e3ce91b0ef0603212167083a622122
---
## 字节码生成流程
...
1. 在[工程级build-profile.json5文件](../../../../../构建应用/配置文件/工程级build-profile.json5文件/ide-hvigor-build-profile-app.md)中的useNormalizedOHMUrl配置为true。
...
2. 清除ohpm和编译缓存，下载ohpm包并重新编译，操作如下：
   ...
   * 点击菜单Build->Clean Project，或在控制台执行[ohpm clear](<../../../../../命令行工具/三方依赖管理工具（ohpm）/常用命令/ohpm clean/ide-ohpm-clean.md>)。
   * 点击菜单File->Invalidate Caches...，弹窗选项全选执行并重启。
   * 在控制台执行[ohpm install](<../../../../../命令行工具/三方依赖管理工具（ohpm）/常用命令/ohpm install/ide-ohpm-install.md>)。
...
由于此类异常与代码结构和运行环境相关，目前无法提供完整列表；如上述情况均无法解释，可结合崩溃日志或使用[GDB](<../../../../../AI/CANN Kit（CANN异构计算框架服务）/AscendC算子开发/自定义算子开发/算子调试调优/调测功能介绍/更多功能/gdb调试/cannkit-gdb.md>)/[LLDB](../../../../../NDK开发/调试和性能分析/LLDB高性能调试器/debug-lldb.md)进一步定位。
