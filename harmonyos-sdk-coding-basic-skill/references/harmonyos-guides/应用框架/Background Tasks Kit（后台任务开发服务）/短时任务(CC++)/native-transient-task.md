...
scraped_at: 2026-06-01T11:10:23+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:c041e5b17900ca7fe7ad3b7e79f419ae4636d2d8e06566d4c70bb563f7250c62
---
## 场景介绍
...
申请短时任务的按钮，不可连续点击超过3次，否则会超出短时任务数量限制并报错。使用过程中更多的约束与限制请参考短时任务（ArkTS）的[约束与限制](../短时任务(ArkTS)/transient-task.md#约束与限制)。

## 接口说明

常用接口如下表所示，具体API说明详见[transient\_task\_api.h](<../../../../harmonyos-references/Background Tasks Kit（后台任务开发服务）/C API/头文件/transient_task_api.h/capi-transient-task-api-h.md>)。

| 接口名 | 描述 |
| --- | --- |
| [int32\_t OH\_BackgroundTaskManager\_RequestSuspendDelay(const char \*reason, TransientTask\_Callback callback, TransientTask\_DelaySuspendInfo \*info)](<../../../../harmonyos-references/Background Tasks Kit（后台任务开发服务）/C API/头文件/transient_task_api.h/capi-transient-task-api-h.md#oh_backgroundtaskmanager_requestsuspenddelay>) | 申请短时任务。 |
| [int32\_t OH\_BackgroundTaskManager\_GetRemainingDelayTime(int32\_t requestId, int32\_t \*delayTime)](<../../../../harmonyos-references/Background Tasks Kit（后台任务开发服务）/C API/头文件/transient_task_api.h/capi-transient-task-api-h.md#oh_backgroundtaskmanager_getremainingdelaytime>) | 获取对应短时任务的剩余时间。 |
| [int32\_t OH\_BackgroundTaskManager\_CancelSuspendDelay(int32\_t requestId)](<../../../../harmonyos-references/Background Tasks Kit（后台任务开发服务）/C API/头文件/transient_task_api.h/capi-transient-task-api-h.md#oh_backgroundtaskmanager_cancelsuspenddelay>) | 取消短时任务。 |
| [int32\_t OH\_BackgroundTaskManager\_GetTransientTaskInfo(TransientTask\_TransientTaskInfo \*transientTaskInfo)](<../../../../harmonyos-references/Background Tasks Kit（后台任务开发服务）/C API/头文件/transient_task_api.h/capi-transient-task-api-h.md#oh_backgroundtaskmanager_gettransienttaskinfo>) | 获取所有短时任务信息，如当日剩余总配额等。 |
...
1. 封装函数
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/BackGroundTasksKit/NativeTransientTask/entry/src/main/cpp/napi_init.cpp#L16-L111)
2. 注册函数
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/BackGroundTasksKit/NativeTransientTask/entry/src/main/cpp/napi_init.cpp#L113-L127)
3. 注册模块
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/BackGroundTasksKit/NativeTransientTask/entry/src/main/cpp/napi_init.cpp#L129-L144)
...
[Index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/BackGroundTasksKit/NativeTransientTask/entry/src/main/cpp/types/libentry/Index.d.ts#L16-L23)
...
71. // ...
72. console.info('The returned requestId is ' + requestId);
73. }
...
81. let result = testTransientTask.CancelSuspendDelay();
82. console.info('The return value is ' + result);
83. }

85. GetTransientTaskInfo() {
86. let info = testTransientTask.GetTransientTaskInfo();
87. console.info('The transientTaskInfo is ' + JSON.stringify(info));
88. }
89. }
```

[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/BackGroundTasksKit/NativeTransientTask/entry/src/main/ets/pages/Index.ets#L16-L115)
...
[CMakeLists.txt](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/BackGroundTasksKit/NativeTransientTask/entry/src/main/cpp/CMakeLists.txt#L16-L18)
...
5. 点击 获取所有短时任务信息 按钮，控制台会打印日志，示例如下：
   ...
   ```
   1. The transientTaskInfo is {"remainingQuota":600000,"transientTasks":[]}
   ```
