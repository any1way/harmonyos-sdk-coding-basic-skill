...
content_hash: sha256:b4ce98caf4471563beb097da424be3f023a6e80a3472c06c361365b128433b1e
---
## 设计场景

可切换状态的控件可以处于“已选中”或“未选中”状态，屏幕朗读功能可以从控件的语义属性中推导出默认状态说明标签。在某些情况下，推导出的默认状态说明标签不能完全适用于应用场景，此时可以通过[accessibilityStateDescription](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/无障碍属性/ts-universal-attributes-accessibility.md)指定状态说明标签进行判断。屏幕朗读模式下，若指定了可点击控件的状态说明标签，当用户聚焦控件或执行双击操作后，屏幕朗读会播报指定的状态说明标签。

## accessibilityStateDescription说明

* [description](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/通用属性/无障碍属性/ts-universal-attributes-accessibility.md)：指定组件的状态说明标签，支持string类型和Resource类型，默认值为空。
