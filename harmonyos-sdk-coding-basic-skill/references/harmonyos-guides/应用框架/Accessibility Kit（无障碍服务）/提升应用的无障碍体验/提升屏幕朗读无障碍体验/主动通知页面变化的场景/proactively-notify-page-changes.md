...
content_hash: sha256:395282fd82e3fc96767a2ca754f751bebff4ab925f16966868b519ec187f8ede
---
## 设计场景
...
如下示例实现一个自定义页面切换，通过改变[Stack](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/行列与堆叠/Stack/ts-container-stack.md)子组件Z序的方式实现切换页面的效果：
