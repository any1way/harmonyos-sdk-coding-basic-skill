...
scraped_at: 2026-06-01T11:11:46+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:03c3f3eadb687ac6e00be336b181aceea6128a9c664e95723c862e0ce24fa504
---
在动态卡片中使用[postCardAction](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/postCardAction/js-apis-postcardaction.md#postcardaction-1>)接口的router能力，能够快速拉起动态卡片提供方应用的指定UIAbility(页面)，因此UIAbility较多的应用往往会通过卡片提供不同的跳转按钮，实现一键直达的效果。例如相机卡片，卡片上提供拍照、录像等按钮，点击不同按钮将拉起相机应用的不同UIAbility，从而提升用户的体验。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6/v3/u7waBe96T--LlMw-sHd_6Q/zh-cn_image_0000002613638657.png?HW-CC-KV=V1&HW-CC-Date=20260601T031146Z&HW-CC-Expire=86400&HW-CC-Sign=543FD15F78671D888AB66737DD6AC582FE6F715F42535A755AA7BBCE4F715CAC)

说明

本文主要介绍动态卡片的事件开发。对于静态卡片，请参见[FormLink](../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/卡片/FormLink/ts-container-formlink.md)。
...
2. 构建ArkTS卡片页面代码布局，卡片页面布局中有两个按钮，点击其中一个按钮时调用postCardAction向指定UIAbility发送router事件，并在事件内定义需要传递的内容。
   ...
   [WidgetEventRouterCard.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ApplicationModels/StageServiceWidgetCards/entry/src/main/ets/widgeteventrouter/pages/WidgetEventRouterCard.ets#L16-L80)
3. 处理router事件，在UIAbility中接收router事件并获取参数，根据传递的params不同，选择拉起不同的页面。
   ...
   [EntryAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ApplicationModels/StageServiceWidgetCards/entry/src/main/ets/entryability/EntryAbility.ts#L16-L80)
4. 创建跳转后的UIAbility页面，新建FunA.ets和FunB.ets，构建页面布局。
   ...
   [FunA.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ApplicationModels/StageServiceWidgetCards/entry/src/main/ets/funpages/FunA.ets#L16-L63)
   ...
   [FunB.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ApplicationModels/StageServiceWidgetCards/entry/src/main/ets/funpages/FunB.ets#L16-L63)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6a/v3/EP5DgODESuq_i_9kFSHZWg/zh-cn_image_0000002613518763.gif?HW-CC-KV=V1&HW-CC-Date=20260601T031146Z&HW-CC-Expire=86400&HW-CC-Sign=7E107B17434572374FFF1D6225A04D7E04ECBBC8B8B27F8ED14F9A41761993B3)
