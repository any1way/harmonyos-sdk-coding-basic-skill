...
scraped_at: 2026-06-11T14:37:45+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:1c9cb2f84e1861d0e17fc4949b1f66db2b19babeb45e40fe97da6c1c90dc7cbe
---
本文主要提供主动刷新的开发指导，刷新流程请参考[主动刷新概述](../ArkTS卡片页面刷新概述/arkts-ui-widget-interaction-overview.md#主动刷新)。

## 卡片提供方主动刷新卡片内容

卡片提供方可以通过[updateForm](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formProvider (formProvider)/js-apis-app-form-formprovider.md#formproviderupdateform>)接口进行主动刷新。推荐与卡片生命周期回调[onFormEvent](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.FormExtensionAbility (FormExtensionAbility)/js-apis-app-form-formextensionability.md#formextensionabilityonformevent>)、[onUpdateForm](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.FormExtensionAbility (FormExtensionAbility)/js-apis-app-form-formextensionability.md#formextensionabilityonupdateform>)、[onAddForm](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.FormExtensionAbility (FormExtensionAbility)/js-apis-app-form-formextensionability.md#formextensionabilityonaddform>)接口搭配使用。
...
2. 实现卡片布局，在卡片上添加一个刷新按钮，点击按钮后通过[postCardAction](<../../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/postCardAction/js-apis-postcardaction.md#postcardaction-1>)接口，触发onFormEvent回调。
   ...
   [UpdateByMessageCard.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ApplicationModels/StageServiceWidgetCards/entry/src/main/ets/updatebymessage/pages/UpdateByMessageCard.ets#L16-L75)
3. 在onFormEvent回调函数的实现中，通过updateForm接口刷新卡片数据。
   ...
   [EntryFormAbility.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ApplicationModels/StageServiceWidgetCards/entry/src/main/ets/entryformability/EntryFormAbility.ts#L17-L131)
4. 资源文件如下。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/04/v3/IJcSpza3SmumJbcu5iJkQw/zh-cn_image_0000002592218708.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063742Z&HW-CC-Expire=86400&HW-CC-Sign=28B69033D262C4B0C4FA3E43371A77C425CFCA1B2C6B62D8856E24E616FCC9B2)

## 卡片提供方批量请求刷新卡片内容

从API version 22开始，支持卡片提供方批量请求刷新卡片内容。卡片提供方可以通过[reloadForms](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formProvider (formProvider)/js-apis-app-form-formprovider.md#formproviderreloadforms22>)和[reloadAllForms](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formProvider (formProvider)/js-apis-app-form-formprovider.md#formproviderreloadallforms22>)接口在应用主进程中通知FormExtension进程进行批量更新，仅支持在[UIAbility](<../../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)中调用。
...
2. 实现卡片布局，在卡片上创建两个待刷新的Text。
   ...
   [ReloadByUIAbilityCard.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Form/ReloadFormsDoc/entry/src/main/ets/reloadbyuiability/pages/ReloadByUIAbilityCard.ets#L16-L45)
3. 在FormExtensionAbility中实现onUpdateForm回调，通过updateForm接口定义卡片刷新逻辑。
   ...
   [EntryFormAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Form/ReloadFormsDoc/entry/src/main/ets/entryformability/EntryFormAbility.ets#L16-L66)
4. 在UIAbility的界面中添加两个批量刷新按钮，点击按钮后通过reloadForms或reloadAllForms接口，批量触发FormExtensionAbility中的onUpdateForm回调。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Form/ReloadFormsDoc/entry/src/main/ets/pages/Index.ets#L16-L63)
5. 资源文件如下。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/f7WlaQzQSa-atu7Opntyiw/zh-cn_image_0000002592378642.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063742Z&HW-CC-Expire=86400&HW-CC-Sign=1C528F76CAE835604C612B7F08CDB5F6AA82B40AB212C72C876039778ABE71B4)
