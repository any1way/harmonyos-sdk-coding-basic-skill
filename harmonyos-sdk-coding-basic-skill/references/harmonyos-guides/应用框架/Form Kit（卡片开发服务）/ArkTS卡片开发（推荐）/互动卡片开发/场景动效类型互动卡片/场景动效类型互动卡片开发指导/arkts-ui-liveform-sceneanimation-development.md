...
content_hash: sha256:1a620ab6b614e2ffa2cae030688592266a4a91d2878f8c67dbe695d1b5e7901f
---
...
| 接口名 | 描述 |
| --- | --- |
| [onLiveFormCreate(liveFormInfo: LiveFormInfo, session: UIExtensionContentSession): void](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.LiveFormExtensionAbility (LiveFormExtensionAbility)/js-apis-app-form-liveformextensionability.md#onliveformcreate>) | 互动卡片界面对象创建的回调函数。 |
| [onLiveFormDestroy(liveFormInfo: LiveFormInfo): void](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.LiveFormExtensionAbility (LiveFormExtensionAbility)/js-apis-app-form-liveformextensionability.md#onliveformdestroy>) | 互动卡片界面对象销毁、资源清理的回调函数。 |
| [LiveFormExtensionContext](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/application/LiveFormExtensionContext/js-apis-application-liveformextensioncontext.md>) | LiveFormExtensionAbility的上下文，继承自ExtensionContext。 |
| [startAbilityByLiveForm(want: Want): Promise<void>](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/application/LiveFormExtensionContext/js-apis-application-liveformextensioncontext.md#startabilitybyliveform>) | 拉起互动卡片提供方（应用）的页面。 |
| [formProvider.requestOverflow(formId: string, overflowInfo: formInfo.OverflowInfo): Promise<void>](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formProvider (formProvider)/js-apis-app-form-formprovider.md#formproviderrequestoverflow20>) | 卡片提供方发起互动卡片动效请求。 |
| [formProvider.cancelOverflow(formId: string): Promise<void>](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formProvider (formProvider)/js-apis-app-form-formprovider.md#formprovidercanceloverflow20>) | 卡片提供方发起取消互动卡片动效请求。 |
| [formProvider.getFormRect(formId: string): Promise<formInfo.Rect>](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formProvider (formProvider)/js-apis-app-form-formprovider.md#formprovidergetformrect20>) | 卡片提供方查询卡片位置、尺寸。 |
...
1. 创建互动卡片
   ...
   通过[LiveFormExtensionAbility](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.LiveFormExtensionAbility (LiveFormExtensionAbility)/js-apis-app-form-liveformextensionability.md>)创建互动卡片，创建时加载互动卡片页面。
   ...
   [MyLiveFormExtensionAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Form/FormLiveDemo/entry/src/main/ets/myliveformextensionability/MyLiveFormExtensionAbility.ets#L16-L54)
2. 实现互动卡片页面
   ...
   [MyLiveFormPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Form/FormLiveDemo/entry/src/main/ets/myliveformextensionability/pages/MyLiveFormPage.ets#L15-L148)
3. 互动卡片LiveFormExtensionAbility配置

   在module.json5配置文件中[extensionAbilities标签](../../../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#extensionabilities标签)下配置LiveFormExtensionAbility。
   ...
   [module.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Form/FormLiveDemo/entry/src/main/module.json5#L15-L81)
...
1. 非激活态卡片页面实现
   ...
   非激活态卡片页面开发同普通卡片开发流程完全一致，在widgetCard.ets中完成。widgetCard.ets文件在卡片创建时自动生成，卡片创建流程可以参考[创建ArkTS卡片](../../../创建ArkTS卡片/arkts-ui-widget-creation.md)。在非激活态卡片页面实现点击卡片时，发起卡片动效请求。
   ...
   [WidgetCard.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Form/FormLiveDemo/entry/src/main/ets/widget/pages/WidgetCard.ets#L15-L46)
...
1. 触发互动卡片动效
   ...
   互动卡片通过调用[formProvider.requestOverflow](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formProvider (formProvider)/js-apis-app-form-formprovider.md#formproviderrequestoverflow20>)接口触发动效，调用时需要明确：（1）动效申请范围。（2）动效持续时间。（3）是否使用系统提供的默认切换动效。具体可参考[formInfo.OverflowInfo](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formInfo (formInfo)/js-apis-app-form-forminfo.md#overflowinfo20>)。其中，互动卡片可以通过调用[formProvider.getFormRect](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formProvider (formProvider)/js-apis-app-form-formprovider.md#formprovidergetformrect20>)接口获取卡片尺寸和在窗口内的位置信息。卡片提供方以此计算动效申请范围，单位为vp。计算规则具体请参考[互动卡片请求参数约束](../场景动效类型互动卡片概述/arkts-ui-liveform-sceneanimation-overview.md#请求参数约束)。
   ...
   [EntryFormAbility.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Form/FormLiveDemo/entry/src/main/ets/entryformability/EntryFormAbility.ets#L16-L82)
2. 互动卡片动效工具函数实现
   ...
   [Constants.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Form/FormLiveDemo/entry/src/main/ets/common/Constants.ets#L16-L31)
...
以下是按照本文档代码示例开发而成的效果demo，demo执行动效时，点击按钮，将调用 [formProvider.cancelOverflow](<../../../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formProvider (formProvider)/js-apis-app-form-formprovider.md#formprovidercanceloverflow20>) 接口，打断当前破框动效，卡片切换为非激活态。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/J2XEyGxgTjaNc-OGj4EoYQ/zh-cn_image_0000002592218730.gif?HW-CC-KV=V1&HW-CC-Date=20260611T063804Z&HW-CC-Expire=86400&HW-CC-Sign=9912260EF5116241F1B60EB5F6031DE8CB638AB53D4E13821B3FB21FBBB9E189)
