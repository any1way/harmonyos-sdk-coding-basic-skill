...
scraped_at: 2026-06-11T14:38:10+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:b615ff2d831f4ec58b40487dbe4f1a3f1f408ba971f6aacf80bd2b9f47c7e20b
---
...
FormProvider类有如下API接口，具体的API介绍详见[@ohos.app.form.formProvider (formProvider)](<../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formProvider (formProvider)/js-apis-app-form-formprovider.md>)。
...
FormBindingData类有如下API接口，具体的API介绍详见[@ohos.app.form.formBindingData (卡片数据绑定类)](<../../../../../harmonyos-references/Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formBindingData (卡片数据绑定类)/js-apis-app-form-formbindingdata.md>)。
...
FA卡片开发，即基于[FA模型](<../../../Ability Kit（程序框架服务）/FA模型开发指导/FA模型开发概述/fa-model-development-overview.md>)的卡片提供方开发，主要涉及如下关键步骤：
...
创建FA模型的卡片，需实现卡片的生命周期接口。先参考[DevEco Studio开发服务卡片指南](../../../../开发环境搭建/工程创建/模块管理/创建服务卡片/ide-service-widget.md)生成服务卡片模板。
...
具体的持久化方法可以参考[应用数据持久化概述](../../../ArkData（方舟数据管理）/应用数据持久化/应用数据持久化概述/app-data-persistence-overview.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/-ZFDo5YyQzGhc-yJHMuiRA/zh-cn_image_0000002592378666.png?HW-CC-KV=V1&HW-CC-Date=20260611T063808Z&HW-CC-Expire=86400&HW-CC-Sign=A68740AFF6BB4452A77E54C5DBEED2BC68DFA5E9FDF0EDEEAAAAE4EF65CDD991)
