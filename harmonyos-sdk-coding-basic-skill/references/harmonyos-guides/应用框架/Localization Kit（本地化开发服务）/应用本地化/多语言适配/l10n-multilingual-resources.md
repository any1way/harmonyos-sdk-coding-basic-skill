...
content_hash: sha256:3479a4d1507f522c186f3a4ea4f283f9122cfcb16b8a6fa110cc322394799370
---
## 功能介绍
...
* 本地化接口调用
  ...
  为了确保接口返回值与用户设置保持一致，通常需要在[i18n模块](<../../../../../harmonyos-references/Localization Kit（本地化开发服务）/ArkTS API/@ohos.i18n (国际化-I18n)/js-apis-i18n.md>)和[intl模块](<../../../../../harmonyos-references/Localization Kit（本地化开发服务）/ArkTS API/@ohos.intl (国际化-Intl)/js-apis-intl.md>)接口中传入系统区域ID或系统区域对象。系统区域ID和系统区域对象传入的示例如下：
...
对于应用开发者，仅需关注资源配置，资源文件配置完成后，根据业务需求对资源进行访问。资源文件配置和资源匹配规则请参考[资源分类与访问](../../../../基础入门/资源分类与访问/resource-categories-and-access.md)。
