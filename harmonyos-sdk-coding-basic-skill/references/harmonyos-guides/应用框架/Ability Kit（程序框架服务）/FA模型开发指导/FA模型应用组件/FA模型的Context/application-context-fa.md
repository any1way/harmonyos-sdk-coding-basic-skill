...
scraped_at: 2026-06-01T10:59:12+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:68a33a992db94be5cc56824e82320091953c171726ad4438c3f69b69f0e72549
---
[FA模型](<../../../Ability Kit术语/ability-terminology.md#fa模型>)下只有一个Context。Context中的所有功能都是通过方法来提供的，它提供了一些featureAbility中不存在的方法，相当于featureAbility的一个扩展和补全。
...
最终返回的对象为Context，其对应的接口说明请参见[接口文档](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/FA模型能力的接口/app/Context (FA模型的上下文基类)/js-apis-inner-app-context.md>)。
