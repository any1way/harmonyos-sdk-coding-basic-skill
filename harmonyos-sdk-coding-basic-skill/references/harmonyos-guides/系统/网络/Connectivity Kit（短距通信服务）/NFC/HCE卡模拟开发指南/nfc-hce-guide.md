...
scraped_at: 2026-06-01T11:19:32+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:48fc05cf1e259bece0962f4a4f38778253bac80ecc9b2fe6dc5820852da8dcfd
---
## 简介
...
NFC卡模拟完整的API说明以及实例代码请参考：[NFC卡模拟接口](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.nfc.cardEmulation (标准NFC-cardEmulation)/js-apis-cardemulation.md>)。
...
1. 在配置文件module.json5中，不需要静态声明NFC读卡器选择的应用ID（AID，参考ISO/IEC 7816-4规范），而是通过[start](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.nfc.cardEmulation (标准NFC-cardEmulation)/js-apis-cardemulation.md#start9>)来动态注册。
2. HCE应用的刷卡页面退出时，需要显式调用[stop](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.nfc.cardEmulation (标准NFC-cardEmulation)/js-apis-cardemulation.md#stop9>)来释放动态注册的AID刷卡配置项。
...
5. HCE应用后台刷卡建议使用单独专用的HceAbility实现，以减少[onCreate](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#oncreate>)函数耗时。
6. HceAbility的OnCreate函数中除了[hceService.on](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.nfc.cardEmulation (标准NFC-cardEmulation)/js-apis-cardemulation.md#on8>)外，尽量减少其它操作。
7. HceAbility的OnCreate函数中hceService.on要同步执行，不能异步执行，以免影响HCE通信时序。

注意

* 从API version 9之后的应用开发新增支持[Stage模型](<../../../../../应用框架/Ability Kit（程序框架服务）/Ability Kit术语/ability-terminology.md#stage模型>)，作为目前主推并长期演进的模型。
* HCE示例代码的提供，全部按照[Stage模型](<../../../../../应用框架/Ability Kit（程序框架服务）/Ability Kit术语/ability-terminology.md#stage模型>)来说明。
