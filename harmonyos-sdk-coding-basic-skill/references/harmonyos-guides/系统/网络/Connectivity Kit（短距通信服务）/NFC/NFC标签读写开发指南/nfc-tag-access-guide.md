...
scraped_at: 2026-06-01T11:19:31+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:55bc4efc7a44323863da6d5bbcf8d6a2579d8c278374c124ced9bf4d26c15c1d
---
## 简介
...
NFC标签读写完整的JS API说明以及实例代码请参考：[NFC标签接口](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md>)。
...
1. 在配置文件module.json5中，不需要静态声明过滤读取NFC标签的技术类型，而是通过[tag.registerForegroundDispatch](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#tagregisterforegrounddispatch10>)或者[tag.on](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#tagon11>)来完成动态注册。
...
4. 当应用页面切换到后台时，需要显式调用[tag.unregisterForegroundDispatch](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#tagunregisterforegrounddispatch10>)或者[tag.off](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#tagoff11>)来取消注册，退出前台读卡优先功能。
...
* NFC标签读写示例代码的提供，全部按照[Stage模型](<../../../../../应用框架/Ability Kit（程序框架服务）/Ability Kit术语/ability-terminology.md#stage模型>)来说明。
