...
scraped_at: 2026-06-01T11:19:27+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:f09ba944703876f76c3b1fb21e059482c7a04d4ef950f96a50ac7984e67a7bd7
---
## 简介
...
* 推荐使用API version 15开始支持的扫描方式，该方式支持应用发起和管理多路扫描。该方式支持的上报事件请参考[on('BLEDeviceFind')](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#onbledevicefind15>)。
...
* API version 14及以前支持的扫描方式只支持应用发起单路扫描。该方式支持的上报事件请参考[ble.on('BLEDeviceFind')](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#bleonbledevicefind>)。
...
若本机设备扫描到可连接的BLE广播，则可以和该设备进行通用属性协议（Generic Attribute Profile，GATT）的连接和数据传输，此时本机设备角色也被称为GATT客户端。具体操作请参考[连接和传输数据](../连接和传输数据/gatt-development-guide.md)。

* 推荐使用API version 15开始支持的扫描方式，该方式支持应用发起和管理多路扫描。可通过[createBleScanner](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blecreateblescanner15>)创建扫描实例[BleScanner](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blescanner15>)，并调用[startScan](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#startscan15>)。
...
* API version 14及以前支持的扫描方式只支持应用发起单路扫描。若要再次发起扫描，必须先停止上一路的扫描流程。详情请见[ble.startBLEScan](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestartblescan>)。
...
* 搭配API version 15开始支持的多路扫描方式。详情请见[stopScan](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#stopscan15>)。
...
* 搭配API version 14及以前支持的单路扫描方式。详情请见[ble.stopBLEScan](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestopblescan>)。
...
若本机设备发送的是可连接广播，则可以接受其他设备发起的通用属性协议（Generic Attribute Profile，GATT）连接，此时本机设备角色也被称为GATT服务端。具体操作请参考[连接和传输数据](../连接和传输数据/gatt-development-guide.md)。
...
* 推荐使用API version 11开始支持的广播操作方式。支持在不释放相关广播资源情况下，多次操作启动或者停止指定标识的广播，且支持设置广播持续发送的时间。
  ...
  相关API请参考[ble.startAdvertising](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestartadvertising11>)和[ble.enableAdvertising](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#bleenableadvertising11>)。

  首次启动广播接口[ble.startAdvertising](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestartadvertising11>)会分配广播相关资源，从API version 15开始，该接口支持应用多次调用，实现启动多路广播的功能，并通过不同的广播标识进行管理。
...
* API version 10及以前支持的广播操作方式只支持应用启动单路广播。若要再次启动广播，必须先停止上一路的广播流程。详情请见[ble.startAdvertising](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestartadvertising>)。
...
* 搭配API version 11开始支持的广播方式。相关API请参考[ble.disableAdvertising](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#bledisableadvertising11>)和[ble.stopAdvertising](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestopadvertising11>)。

  完全停止广播接口[ble.stopAdvertising](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestopadvertising11>)会释放所有广播资源，因此首次启动广播分配的广播标识将无效。
...
* 搭配API version 11及以前支持的单路广播方式。相关API请参考[ble.stopAdvertising](<../../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.ble (蓝牙ble模块)/js-apis-bluetooth-ble.md#blestopadvertising>)。
