...
scraped_at: 2026-06-01T11:19:35+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:d4bc6e632ef1d50d618b2977936573ddb115f236ff74ec732bd47e763a698a65
---
## 简介
...
完整的JS API说明以及示例代码请参考：[P2P接口](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.wifiManager (WLAN)/js-apis-wifimanager.md>)。
...
1. import需要的Wi-Fi模块。
   ...
   [P2pSetting.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ConnectivityKit/Wlan/entry/src/main/ets/pages/P2pSetting.ets#L19-L21)
2. 开启设备的Wi-Fi。
...
4. 创建/删除P2P群组。
   ...
   [P2pSetting.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ConnectivityKit/Wlan/entry/src/main/ets/pages/P2pSetting.ets#L44-L65)
5. 示例代码：
   ...
   33. }
   ```
6. 错误码请参见[WIFI错误码](<../../../../../../harmonyos-references/Connectivity Kit（短距通信服务）/错误码/WIFI错误码/errorcode-wifi.md>)。
...
4. 注册"p2pPeerDeviceChange"事件回调，并在回调实现中执行P2P连接。
   ...
   [AvailableP2p.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ConnectivityKit/Wlan/entry/src/main/ets/pages/AvailableP2p.ets#L100-L118)
5. 开始P2P设备发现。
   ...
   [AvailableP2p.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/ConnectivityKit/Wlan/entry/src/main/ets/pages/AvailableP2p.ets#L79-L98)
6. 示例代码：
   ...
   ```
7. 错误码请参见[WIFI错误码](<../../../../../../harmonyos-references/Connectivity Kit（短距通信服务）/错误码/WIFI错误码/errorcode-wifi.md>)。
...
2. 开启设备的Wi-Fi。
3. 需要SystemCapability.Communication.WiFi.P2P系统能力。
4. 通过[wifiP2pLinkedInfo.connectState](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.wifiManager (WLAN)/js-apis-wifimanager.md#p2pconnectstate>)获取P2P连接状态，确保连接状态为CONNECTED。
5. 通过[wifiP2pGroupInfo.goIpAddress](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.wifiManager (WLAN)/js-apis-wifimanager.md#wifip2pgroupinfo>)获取群组IP地址，以便Socket通信。
6. Socket通信请参考[使用Socket访问网络](<../../../Network Kit（网络服务）/访问网络/使用Socket访问网络/socket-connection.md>)。
