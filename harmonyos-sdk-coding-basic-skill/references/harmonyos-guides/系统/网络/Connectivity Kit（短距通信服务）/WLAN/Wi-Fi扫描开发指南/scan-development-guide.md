...
scraped_at: 2026-06-01T11:19:37+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:ffcb4a77d6ca790cacec967f74c9afdede88ee66a2930691f4a86f198e59dac9
---
## 简介
...
完整的JS API说明以及示例代码请参考：[SCAN接口](<../../../../../../harmonyos-references/网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.wifiManager (WLAN)/js-apis-wifimanager.md>)。
...
5. 示例代码：
   ...
   41. }
   ```
6. 错误码详情请参见[WIFI错误码](<../../../../../../harmonyos-references/Connectivity Kit（短距通信服务）/错误码/WIFI错误码/errorcode-wifi.md>)。
