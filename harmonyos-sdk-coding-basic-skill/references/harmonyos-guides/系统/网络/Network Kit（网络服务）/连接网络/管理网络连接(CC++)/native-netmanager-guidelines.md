...
scraped_at: 2026-06-11T14:48:15+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:052c46ad82895d8985b95200d8bc538f934933b3cbd06d0daa1551dec148398d
---
## 场景介绍
...
NetConnection常用接口如下表所示，详细的接口说明请参考[net\_connection.h](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/C API/头文件/net_connection.h/capi-net-connection-h.md>)。
...
[napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/NetConnection_Exploitation_case/entry/src/main/cpp/napi_init.cpp#L16-L20)
...
1. 在源文件中编写调用该API的代码，并将结果封装成一个napi\_value类型的值返回给Node.js环境。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/NetConnection_Exploitation_case/entry/src/main/cpp/napi_init.cpp#L43-L81)
...
2. 将通过napi封装好的napi\_value类型对象初始化导出，通过外部函数接口，将以上两个函数暴露给JavaScript使用。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/NetConnection_Exploitation_case/entry/src/main/cpp/napi_init.cpp#L318-L348)
3. 将上一步中初始化成功的对象通过RegisterEntryModule函数，使用napi\_module\_register函数将模块注册到Node.js中。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/NetConnection_Exploitation_case/entry/src/main/cpp/napi_init.cpp#L352-L364)
4. 在工程的index.d.ts文件中定义两个函数的类型。
   ...
   * NetId函数不接受参数，返回一个数字类型的值。
   ...
   [Index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/NetConnection_Exploitation_case/entry/src/main/cpp/types/libentry/Index.d.ts#L15-L18)
5. 在index.ets文件中对上述封装好的接口进行调用。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/NetConnection_Exploitation_case/entry/src/main/ets/pages/Index.ets#L17-L463)
6. 配置CMakeLists.txt，本模块需要用到的共享库是libnet\_connection.so，在工程自动生成的CMakeLists.txt中的target\_link\_libraries中添加此共享库。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/2rWs-3P_RBOdCkfzfCu-_w/zh-cn_image_0000002592378786.png?HW-CC-KV=V1&HW-CC-Date=20260611T064813Z&HW-CC-Expire=86400&HW-CC-Sign=79C3F8CD08AE4CF7DD66E35005A78604EDF64C40EE825A6A88533414FDAA915F)
...
2. 运行工程，设备上会弹出以下所示图片。
   ...
   * 点击codeNumber时获取的是接口返回的响应状态码。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/GkPygYSNQ5avyYceCvD2Dg/zh-cn_image_0000002622858293.png?HW-CC-KV=V1&HW-CC-Date=20260611T064813Z&HW-CC-Expire=86400&HW-CC-Sign=8E0F3CB78DDFED6AA8B2316ECCA676561373F0A2322E07A869DA3B143FD46776)
3. 点击GetDefaultNet按钮，控制台会打印日志。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/CHr5vcU9Tu2x_BewKJxl1A/zh-cn_image_0000002622698415.png?HW-CC-KV=V1&HW-CC-Date=20260611T064813Z&HW-CC-Expire=86400&HW-CC-Sign=1AF0BE7768A17CF4A95FF7122377DD1D9315E16E36E0EDFF6BD219FE3C53F626)
4. 点击codeNumber按钮，控制台会打印相应的响应状态码。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/Jia-Blq1ReCDQjmV1sPKHA/zh-cn_image_0000002592218854.png?HW-CC-KV=V1&HW-CC-Date=20260611T064813Z&HW-CC-Expire=86400&HW-CC-Sign=11840E09E89F3C2C3ADE66C40CD7F4F5AAC0A485658BE9337BAF40E2ED68B4B5)
