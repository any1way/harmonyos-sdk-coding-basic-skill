...
scraped_at: 2026-06-01T11:20:14+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:a8a9bcffcc4a4e14f314d6f1a0a9fbf4c7e79ab1a111a05aa7f229f7bc3340ee
---
## 简介
...
* 为了保证应用的运行效率，所有API调用都是异步的，对于异步调用的API均提供了Promise的方式，以下示例均采用Promise方式，更多方式可以查阅[@ohos.net.vpnExtension (VPN增强管理)](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.vpnExtension (VPN增强管理)/js-apis-net-vpnextension.md>)。
* 完整的JS API说明以及示例代码请参考：[@ohos.net.vpnExtension (VPN增强管理)](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.vpnExtension (VPN增强管理)/js-apis-net-vpnextension.md>)。
* 使用该功能需要[ohos.permission.INTERNET](../../../../安全/程序访问控制/应用权限管控/应用权限列表/开放权限（系统授权）/permissions-for-all.md#ohospermissioninternet)权限。

## VPN应用的显示体验

借助系统提供的[VPN Extension](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.vpnExtension (VPN增强管理)/js-apis-net-vpnextension.md>)接口开发者可以构建支持不同协议的VPN服务。HarmonyOS系统提供了界面 (UI) 使用户可以了解当前VPN应用服务的启动和连接：
...
[module.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/VPNControl_Case/entry/src/main/module.json5#L53-L76)
...
* 通过VpnConnection.[protect](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.vpnExtension (VPN增强管理)/js-apis-net-vpnextension.md#protect>)保护前一步建立的UDP隧道；
* 构建VPN Config参数，参考[VPN Config参数说明](net-vpnextension.md#vpn-config参数说明)；
* 通过VpnConnection.[create](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.vpnExtension (VPN增强管理)/js-apis-net-vpnextension.md#create>)建立VPN网络连接；
* 处理虚拟网卡的数据，如：读写操作。
...
[StartVpn.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/VPNControl_Case/entry/src/main/ets/pages/StartVpn.ets#L16-L201)

如果您的VPN应用未获取用户信任，系统将弹出VPN连接的授权对话框，当获取用户授权后，系统将自动调用并启动您实现的VPN Extension Ability的[onCreate](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.app.ability.VpnExtensionAbility (三方VPN能力)/js-apis-vpnextensionability.md#vpnextensionabilityoncreate>)方法将被调用。
...
[StopVpn.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/VPNControl_Case/entry/src/main/ets/pages/StopVpn.ets#L16-L20)
...
[StopVpn.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/VPNControl_Case/entry/src/main/ets/pages/StopVpn.ets#L30-L131)

stopVpnExtensionAbility后，您的VPN Extension Ability的[onDestroy](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.app.ability.VpnExtensionAbility (三方VPN能力)/js-apis-vpnextensionability.md#vpnextensionabilityondestroy>)方法将被调用，您可在此时destroy vpn连接。
...
[StopVpn.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/VPNControl_Case/entry/src/main/ets/pages/StopVpn.ets#L49-L72)
...
[GetVpnIdTest.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/VPNControl_Case/entry/src/main/ets/vpnability/GetVpnIdTest.ets#L16-L45)
...
[DestroyVpnTest.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/VPNControl_Case/entry/src/main/ets/vpnability/DestroyVpnTest.ets#L16-L45)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| addresses | Array<[LinkAddress](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.connection (网络连接管理)/js-apis-net-connection.md#linkaddress>)> | 否 | 否 | VPN虚拟网卡的IP地址。 |
| routes | Array<[RouteInfo](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.connection (网络连接管理)/js-apis-net-connection.md#routeinfo>)> | 否 | 是 | VPN虚拟网卡的路由信息(目前最多可配置1024条路由)。 |
...
[SetupVpn.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/VPNControl_Case/entry/src/main/ets/pages/SetupVpn.ets#L16-L20)
...
[SetupVpn.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_NetManager/VPNControl_Case/entry/src/main/ets/pages/SetupVpn.ets#L144-L163)
