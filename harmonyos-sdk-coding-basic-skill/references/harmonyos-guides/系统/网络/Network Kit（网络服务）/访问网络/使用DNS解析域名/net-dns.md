...
scraped_at: 2026-06-01T11:20:09+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:0d6cba34a133f4b08f9d9ae6e462e7e38e351d59c9584d34fbb520d5cdc331fc
---
## 场景介绍
...
| 指定网络连接解析主机名 | 使用特定网络连接[NetHandle](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.connection (网络连接管理)/js-apis-net-connection.md#nethandle>)解析主机名 | API version 23 |
...
1. 导入所需文件。
   ...
   [Unicode.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/DNS_case/entry/src/main/ets/pages/Unicode.ets#L16-L20)
2. 初始化数据成员。
   ...
   [Unicode.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/DNS_case/entry/src/main/ets/pages/Unicode.ets#L26-L20)
3. 获取资源文件中hostName值并赋值。
   ...
   [Unicode.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/DNS_case/entry/src/main/ets/pages/Unicode.ets#L32-L41)
4. 创建网络地址解析函数，将域名转换为IP地址，isChange为是否将域名转码为ASCII编码的标识。
   ...
   [Unicode.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/DNS_case/entry/src/main/ets/pages/Unicode.ets#L43-L73)
5. 获取中文域名地址对应的IP。由于未经过ASCII编码，因此预期结果为获取IP失败。
   ...
   [Unicode.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/DNS_case/entry/src/main/ets/pages/Unicode.ets#L99-L101)
6. 将中文域名转换为对应ASCII编码后获取对应IP。
   ...
   [Unicode.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/DNS_case/entry/src/main/ets/pages/Unicode.ets#L117-L119)
7. 将转换后的ASCII编码转成原中文域名。
   ...
   [Unicode.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/DNS_case/entry/src/main/ets/pages/Unicode.ets#L177-L179)
...
1. 导入所需文件。
   ...
   [DNS.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/DNS_case/entry/src/main/ets/pages/DNS.ets#L16-L19)
2. 初始化数据成员。
   ...
   [DNS.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/DNS_case/entry/src/main/ets/pages/DNS.ets#L25-L27)
3. 使用当前默认网络解析主机名以获取所有IP地址。
   ...
   [DNS.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/DNS_case/entry/src/main/ets/pages/DNS.ets#L41-L47)
4. 使用当前默认网络，指定IP类型解析主机名以获取指定IP地址。
   ...
   [DNS.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/DNS_case/entry/src/main/ets/pages/DNS.ets#L53-L62)
5. 使用指定的网络连接（NetHandle），并按给定的IP类型解析主机名。
   ...
   [DNS.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/DNS_case/entry/src/main/ets/pages/DNS.ets#L68-L99)
