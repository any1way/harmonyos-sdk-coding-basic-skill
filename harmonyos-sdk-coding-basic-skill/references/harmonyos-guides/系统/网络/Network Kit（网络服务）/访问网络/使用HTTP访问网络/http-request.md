...
scraped_at: 2026-06-11T14:48:05+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:b86ff6ecb51fc580ca9647c1ba92d3b2c97f2aac7b0f8a431ec8cc02ca8a6e66
---
## 场景介绍

应用通过HTTP发起一个数据请求，支持常见的GET、POST、OPTIONS、HEAD、PUT、DELETE、TRACE、CONNECT方法。当前提供了2种HTTP请求方式，若请求发送或接收的数据量较少，可使用[HttpRequest.request](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#request>)，若是大文件的上传或者下载，且关注数据发送和接收进度，可使用HTTP请求流式传输[HttpRequest.requestInstream](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#requestinstream10>)。从API version 22开始，若是需要在"HTTP请求-响应"生命周期中的关键节点插入自定义逻辑，可以使用[HTTP拦截器](http-request.md#http拦截器)。

说明

HTTP模块提供了标准的HTTP网络服务能力，Remote Communication Kit（远场通信服务）提供了场景化的网络服务能力，详见[Remote Communication Kit简介](<../../../Remote Communication Kit（远场通信服务）/Remote Communication Kit简介/remote-communication-introduction.md>)，应用可根据自己的需要选择使用。

当前HTTP请求支持的场景如下，以下功能对应的选项可以在HTTP请求的[HttpRequestOptions](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#httprequestoptions>)中进行设置：
...
1. 导入HTTP一般数据请求所需模块
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_case/entry/src/main/ets/pages/Index.ets#L16-L21)
2. 创建HttpRequest对象

   调用[createHttp()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#httpcreatehttp>)方法，创建HttpRequest对象。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_case/entry/src/main/ets/pages/Index.ets#L94-L98)
3. 订阅HTTP响应头事件

   调用该对象的[on()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#onheadersreceive8>)方法，订阅HTTP响应头事件，此接口会比request请求先返回。可以根据业务需要订阅此消息。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_case/entry/src/main/ets/pages/Index.ets#L100-L106)
4. 发起HTTP请求，解析服务器响应事件

   调用该对象的[request()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#httprequest>)方法，传入HTTP请求的url地址和可选参数，发起网络请求，按照实际业务需要，解析返回结果。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_case/entry/src/main/ets/pages/Index.ets#L108-L196)
5. 取消订阅HTTP响应头事件

   调用该对象的[off()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#offheadersreceive8>)方法，取消订阅HTTP响应头事件。
...
6. 调用destroy()方法销毁
   ...
   当该请求使用完毕时，调用[destroy()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#destroy>)方法销毁。
...
2. 创建HTTP流式传输HttpRequest对象
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_case/entry/src/main/ets/pages/Index.ets#L205-L208)
3. 按需订阅HTTP流式响应事件
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_case/entry/src/main/ets/pages/Index.ets#L210-L243)
4. 发起HTTP流式请求，获取服务端数据
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_case/entry/src/main/ets/pages/Index.ets#L245-L286)
5. 取消步骤3中订阅HTTP流式响应事件，并调用destroy()方法销毁流式HTTP请求

   调用该对象的[off()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#offdatareceive10>)方法，取消订阅步骤3中的事件，并且当该请求使用完毕时，调用[destroy()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#destroy>)方法销毁，该方法调用的时机，可以参考步骤4中的示例代码。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_case/entry/src/main/ets/pages/Index.ets#L290-L286)
...
[WebDav.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_case/entry/src/main/ets/pages/WebDav.ets#L16-L303)
...
1. 配置应用信任证书（具体配置方法可参考[网络连接安全配置](../../../../../../best-practices/应用安全/网络连接安全配置/bpta-network-ca-security.md#section5454123841911)）。
2. 配置请求级CA证书：
   * 通过[httprequestoptions](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#httprequestoptions>)的caPath和caData字段配置HTTPS请求CA证书。
   * 通过[websocketrequestoptions](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.webSocket (WebSocket连接)/js-apis-websocket.md#websocketrequestoptions>)的caPath字段配置WebSocket请求CA证书。
   * 通过[tlssecureoptions](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.socket (Socket连接)/js-apis-socket.md#tlssecureoptions9>)的ca字段指定TLS请求CA证书。
3. 配置跳过证书校验：
   * HTTPS：通过[remoteValidation](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#remotevalidation18>) = 'skip' 配置。
   * WebSocket：通过[websocketrequestoptions](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.webSocket (WebSocket连接)/js-apis-websocket.md#websocketrequestoptions>)的skipServerCertVerification = true 配置。
   * TLSSocket：通过[tlsconnectoptions](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.socket (Socket连接)/js-apis-socket.md#tlsconnectoptions9>)的skipRemoteValidation = true 配置。

**调试参考**

* 通过API校验指定证书是否可信：可参考[networkSecurity.certVerification](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.networkSecurity (网络安全校验)/js-apis-networksecurity.md#networksecuritycertverification>)。
...
预置应用级证书的配置例子如下（具体配置路径可参考[网络连接安全配置](../../../../../../best-practices/应用安全/网络连接安全配置/bpta-network-ca-security.md#section5454123841911)）：
...
系统默认信任系统预置的CA证书和用户安装的CA证书，可配置不信任用户安装的CA证书提升安全性。配置不信任用户安装的CA证书可以在src/main/resources/base/profile/network\_config.json进行配置，更多网络连接安全相关的配置可以参考[网络连接安全配置](../../../../../../best-practices/应用安全/网络连接安全配置/bpta-network-ca-security.md#section5454123841911)。
...
该配置用于控制HTTP请求是否允许以明文形式传输。以下为明文HTTP访问权限的配置示例（含应用、组件及域名级配置），以及各字段的详细含义说明。更多网络连接安全相关的配置可以参考[网络连接安全配置](../../../../../../best-practices/应用安全/网络连接安全配置/bpta-network-ca-security.md#section5454123841911)。
...
4. "base-config": {
5. "cleartextTrafficPermitted": true // 可选，自API version 18开始支持该属性。
6. },
7. "domain-config": [
8. {
9. "domains": [
...
13. }
14. ],
15. "cleartextTrafficPermitted": false // 可选，自API version 18开始支持该属性。
16. }
17. ],
18. "component-config": {
...
| Request | boolean | 否 | [Request](<../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md>)从API version 18开始默认支持明文HTTP功能，不可配置。从API version 20开始支持配置开启或关闭明文HTTP功能。true表示支持，false表示不支持，默认为true。 |
...
1. 导入HTTP请求拦截器所需模块。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_interceptor_case/entry/src/main/ets/pages/Index.ets#L16-L20)
2. 调用[createHttp()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#httpcreatehttp>)方法，创建HttpRequest对象。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_interceptor_case/entry/src/main/ets/pages/Index.ets#L132-L135)
3. 调用[HttpInterceptorChain()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#httpinterceptorchain22>)方法，创建拦截器链对象。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_interceptor_case/entry/src/main/ets/pages/Index.ets#L137-L140)
4. 创建拦截器类实现http.HttpInterceptor接口。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_interceptor_case/entry/src/main/ets/pages/Index.ets#L32-L128)
5. 调用[addChain()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#addchain22>)方法，将需要的拦截器实例加入到拦截器链中。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_interceptor_case/entry/src/main/ets/pages/Index.ets#L142-L149)
6. 调用[apply()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#apply22>)方法，将当前配置好的拦截器链附加到httpRequest中。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_interceptor_case/entry/src/main/ets/pages/Index.ets#L151-L154)
7. 创建请求可选项。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_interceptor_case/entry/src/main/ets/pages/Index.ets#L156-L163)
8. 调用该对象的[request()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#request-1>)方法，传入HTTP请求的URL地址和可选参数，发起网络请求，按照实际业务需要，解析服务器响应事件。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_interceptor_case/entry/src/main/ets/pages/Index.ets#L165-L186)
9. 调用[destroy()](<../../../../../../harmonyos-references/网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md#destroy>)方法销毁http请求。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/NetWork_Kit/NetWorkKit_Datatransmission/HTTP_interceptor_case/entry/src/main/ets/pages/Index.ets#L180-L183)
