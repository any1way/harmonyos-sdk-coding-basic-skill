...
scraped_at: 2026-06-01T11:21:34+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:3c73564332e369984591b0956ae6397f462e94a227510971a5617f076b101521
---
## 场景介绍
...
为了保证应用的运行效率，大部分API调用都是异步的，对于异步调用的API均提供了callback和Promise两种方式，以下示例均采用callback函数，更多方式可以查阅[API参考](<../../../../../harmonyos-references/网络/Telephony Kit（蜂窝通信服务）/ArkTS API/@ohos.telephony.call (拨打电话)/js-apis-call.md>)。
...
observer模块为开发者提供订阅和取消订阅通话业务状态的功能。具体API说明详见[接口文档](<../../../../../harmonyos-references/网络/Telephony Kit（蜂窝通信服务）/ArkTS API/@ohos.telephony.observer (observer)/js-apis-observer.md>)。
