...
scraped_at: 2026-06-01T11:20:46+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:a204acb4cfc91aed76caa554f216d680ffcea34a2beb3074228bc826584e41b6
---
...
* 如果要使用的传输协议接口不支持指定网络，则新发起的网络无法使用。如[HTTP](<../../../Network Kit（网络服务）/访问网络/使用HTTP访问网络/http-request.md>)当前只支持默认网络传输，不支持指定网络，所以无法使用。
...
具体API说明详见[接口文档](<../../../../../../harmonyos-references/Network Boost Kit（网络加速服务）/C API/模块/NetworkBoost/network-boost-c-overview.md>)。
...
1. 导入Network Boost Kit模块。
   ...
   2. #include <cstdio>
   ```
2. CMakeLists.txt中添加以下lib，具体请见[C API开发准备](../../开发准备/networkboost-preparations.md#c-api开发准备)。
