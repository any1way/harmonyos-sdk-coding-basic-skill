...
scraped_at: 2026-06-01T11:21:15+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:28ee257bac031bcb13e3f4d1e9d3b8ec0347b461b51e33f308239bd406d32351
---
...
创建一个[ResponseCache](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#responsecache>)实例，将其配置到不同Session中，可以在Session间共享缓存数据。
...
1. 导入模块。
   ...
   ```
2. 创建[ResponseCache](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#responsecache>)实例。其中，pathToFolder即缓存记录文件路径，'/path/dir'请根据实际情况替换为想要存储HTTP缓存的沙箱路径。
...
创建不同的[ResponseCache](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#responsecache>)实例，但对应缓存存储路径相同，将ResponseCache实例配置到不同Session中，可以在Session间共享缓存数据。
