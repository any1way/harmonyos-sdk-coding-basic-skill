...
scraped_at: 2026-06-11T14:49:16+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:82a10236c8da53c04f09868e27a289170045c8ade1274222aeb21794261d0800
---
## 场景介绍
...
具体API说明详见[接口文档](<../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/urpc（高性能rpc通信库）/remote-communication-urpcapi.md>)。
...
4. 配置连接信息，创建发起URPC调用的UrpcStub。
   ...
   ```
   1. // 提前部署好的远程服务器的ip地址和端口号，下面IP地址仅作为示意
