...
scraped_at: 2026-06-11T14:49:05+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:6c797814911667d4dbf297c495ef3d1babc68fc5d390e2d30373be0aefa6cdaf
---
## 约束与限制
...
在需要接续数据请求的场景中，用户可以通过定义[TransferRange](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#transferrange>)对象的from和to属性来控制数据的截取范围。下载的内容可以被准确地截取并拼接到目标文件中，确保数据的完整性和一致性，开发者可以灵活地管理和恢复下载过程。
