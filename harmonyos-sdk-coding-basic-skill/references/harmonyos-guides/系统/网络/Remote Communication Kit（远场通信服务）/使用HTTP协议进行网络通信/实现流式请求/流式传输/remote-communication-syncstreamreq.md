...
scraped_at: 2026-06-01T11:21:09+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:a3dd556ad01332fd0f16e903e79195db9275da8cb5b93981e27b95dd6d0dacb4
---
## 场景介绍
...
具体API说明详见[接口文档](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#uploadfromstream>)。

| 接口名 | 描述 |
| --- | --- |
| uploadFromStream(url: [URLOrString](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#urlorstring>), uploadFrom: [UploadFromStream](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#uploadfromstream-2>)): Promise<[Response](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#response>)> | 从流中上传。 |
| downloadToStream(url: [URLOrString](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#urlorstring>), downloadTo: [DownloadToStream](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#downloadtostream-2>)): Promise<[Response](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#response>)> | 下载到流中。 |
...
5. 调用downloadToStream接口，以流的形式下载数据。
   ...
   9. // 以流的形式下载数据
   10. session.downloadToStream('https://httpbin.org/bytes/10000', fileStream)
   11. .then((resp) => {
