...
scraped_at: 2026-06-01T11:20:55+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:24c6a29e6add5a0ff44ec9b75c3339770c09ba8f6fd0b9a3afeb900ba3ed2ff9
---
...
具体API说明详见[接口文档](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#cancel>)。

| 接口名 | 描述 |
| --- | --- |
| cancel(requestToCancel?: [Request](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#request>)| [Request](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#request>)[]): void | - 取消指定网络请求：传入需要取消的请求，返回值为空。  - 取消所有网络请求：无需传入参数，直接调用，返回值为空。 |
