...
scraped_at: 2026-06-01T11:20:58+08:00
doc_updated_at: 2026-05-12
content_hash: sha256:a42efe38261970964b799b8ca21af22746119775460297b49da266d2be3ddebc
---
...
具体API说明详见[接口文档](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/C API/模块/RemoteCommunication/remote-communication-overview.md#hms_rcp_cancelrequest>)。

| 接口名 | 描述 |
| --- | --- |
| uint32\_t HMS\_Rcp\_CancelRequest([Rcp\_Session](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/C API/模块/RemoteCommunication/remote-communication-overview.md#rcp_session>) \*session, const [Rcp\_Request](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/C API/模块/RemoteCommunication/remote-communication-overview.md#rcp_request>) \*request); | 取消指定或所有正在进行的会话请求。 |
...
3. 创建会话，会话发起请求，并在使用fetch请求后，使用HMS\_Rcp\_CancelRequest取消网络请求。销毁request并关闭session。“http://www.example.com”请根据实际情况替换为想要请求的URL地址。
   ...
   25. // 取消指定request的请求，处理errCode
   26. errCode = HMS_Rcp_CancelRequest(session, request);
   27. // 取消指定session的全部请求，处理errCode
