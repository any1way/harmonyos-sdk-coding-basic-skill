...
scraped_at: 2026-06-01T11:20:57+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:2cba6204a696edcfba9622fdb37e7ca7ce3a57d7e7495e659be83c759bd94163
---
## 约束与限制
...
具体API说明详见[接口文档](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/C API/模块/RemoteCommunication/remote-communication-overview.md#hms_rcp_fetchsync>)。

| 接口名 | 描述 |
| --- | --- |
| [Rcp\_Response](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/C API/模块/RemoteCommunication/remote-communication-overview.md#rcp_response>) \*HMS\_Rcp\_FetchSync([Rcp\_Session](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/C API/模块/RemoteCommunication/remote-communication-overview.md#rcp_session>) \*session, [Rcp\_Request](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/C API/模块/RemoteCommunication/remote-communication-overview.md#rcp_request>) \*request, uint32\_t \*errCode); | 发送一个HTTP请求，并直接返回来自服务器的HTTP响应。 |
...
1. CPP侧导入模块。
   ...
   2. #include <stdio.h>
   ```
2. CMakeLists.txt中添加以下lib。（具体请见[C API开发准备](../../../开发准备/remote-communication-preparations.md#c-api开发准备)）。
...
具体API说明详见[接口文档](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/C API/模块/RemoteCommunication/remote-communication-overview.md#hms_rcp_fetch>)。

| 接口名 | 描述 |
| --- | --- |
| uint32\_t HMS\_Rcp\_Fetch([Rcp\_Session](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/C API/模块/RemoteCommunication/remote-communication-overview.md#rcp_session>) \*session, [Rcp\_Request](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/C API/模块/RemoteCommunication/remote-communication-overview.md#rcp_request>) \*request, const [Rcp\_ResponseCallbackObject](<../../../../../../../harmonyos-references/网络/Remote Communication Kit（远场通信服务）/C API/模块/RemoteCommunication/remote-communication-overview.md#rcp_responsecallbackobject>) \*responseCallback); | 发送一个HTTP请求，并返回来自服务器的HTTP响应。使用responseCallback异步回调。 |
