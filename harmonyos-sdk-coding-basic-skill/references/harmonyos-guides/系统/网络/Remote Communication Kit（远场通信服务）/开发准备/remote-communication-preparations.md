...
scraped_at: 2026-06-01T11:20:51+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:a327233783e5ace98c68fbecabe1d0890ad6261513dd19fb69b117f18c66f0c0
---
## 申请权限
...
HTTP是明文传输协议，为保障数据安全，通常需禁用HTTP，仅允许HTTPS。可通过src/main/resources/base/profile/network\_config.json（该文件不存在时可以手动创建）配置HTTP明文传输策略。相关配置可以参考[明文http访问权限配置说明](<../../Network Kit（网络服务）/访问网络/使用HTTP访问网络/http-request.md#明文http访问权限配置说明>)。

以下示例配置全局允许明文传输，但禁止对 "example.com" 域名使用明文通信。在此设置下，Remote Communication Kit仅能通过HTTPS访问该域名；若尝试发起HTTP请求，将触发错误码[1007900201](<../../../../../harmonyos-references/Remote Communication Kit（远场通信服务）/API错误码/remote-communication-error-code.md#section1007900201-禁止明文传输>)。
