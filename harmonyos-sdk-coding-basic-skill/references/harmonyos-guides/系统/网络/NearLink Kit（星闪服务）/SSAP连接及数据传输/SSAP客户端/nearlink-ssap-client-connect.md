...
scraped_at: 2026-06-01T11:19:55+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:e3a205e27845d1298df156492613d1c975811b457a0d83542b8396e9015e9a74
---
说明
...
| 接口名 | 描述 |
| --- | --- |
| [createClient](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#createclient>)(address: string): Client | 创建ssap客户端实例。 |
| [connect](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#connect>)(): Promise<void> | 向服务端发起连接。 |
| [getServices](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#getservices>)(): Promise<Array<Service>> | 获取服务端支持的服务列表。 |
| [readProperty](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#readproperty>)(property: Property): Promise<Property> | 读取服务端属性。 |
| [writeProperty](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#writeproperty>)(property: Property, writeType: PropertyWriteType): Promise<void> | 写入服务端属性。 |
| [setPropertyNotification](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#setpropertynotification>)(property: Property, enable: boolean): Promise<void> | 启用/禁用某个属性变化的通知。 |
| [on](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#on-propertychange>)(type: 'propertyChange', callback: Callback<Property>): void | 订阅属性变化事件。 |
| [on](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#on-connectionstatechange>)(type: 'connectionStateChange', callback: Callback<ConnectionChangeState>): void | 订阅连接状态变化事件。 |
...
1. 导入相关模块。
   ...
   ```
2. 创建ssap客户端实例。其中参数addr是通过[扫描流程](../../发起星闪扫描/nearlink-start-scan.md)获取的远端设备地址。
...
6. 获取服务端支持的服务列表。
   ...
   9. }
   ```
7. 读取指定服务的属性值，参数property中的[serviceUuid](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#property>)以及[propertyUuid](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#property>)通过步骤6获取。
   ...
   18. }
   ```
8. 写入指定服务的属性值，参数property中的[serviceUuid](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#property>)以及[propertyUuid](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#property>)通过步骤6获取。
   ...
   18. }
   ```
9. 设置支持属性变化通知，参数property中的[serviceUuid](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#property>)以及[propertyUuid](<../../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/ssap（星闪SSAP连接能力）/nearlink-ssap.md#property>)通过步骤6获取。
