...
scraped_at: 2026-06-01T11:19:56+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:0fcca539c86b93de3a1922b9438a0320ca5b5811603b714022c33e80b78382e5
---
...
1. 数据传输通道不保证链路加密。如需加密数传，需先进行配对流程，通过[startPairing](<../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/remoteDevice（对端设备的连接能力）/nearlink-remote-device.md#startpairing>)接口发起。
2. 链路是否加密可通过[getAcbState](<../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/remoteDevice（对端设备的连接能力）/nearlink-remote-device.md#getacbstate>)接口查询，ENCRYPTED状态表示链路已加密。

## 接口说明

| 接口名 | 描述 |
| --- | --- |
| [createPort](<../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/dataTransfer（星闪数传能力）/nearlink-data-transfer-api.md#createport>)(uuid: string): void | 注册端口服务。 |
| [connect](<../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/dataTransfer（星闪数传能力）/nearlink-data-transfer-api.md#connect>)(params: ConnectionParams): Promise<void> | 连接远端设备，建立端口通道。 |
| [writeData](<../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/dataTransfer（星闪数传能力）/nearlink-data-transfer-api.md#writedata>)(params: DataParams): Promise<void> | 通过设备地址和UUID向远端设备发数据。 |
| [on](<../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/dataTransfer（星闪数传能力）/nearlink-data-transfer-api.md#onconnectionstatechanged>)(type: 'connectionStateChanged', callback: Callback<ConnectionResult>): void | 订阅端口通道连接状态变更事件。 |
| [on](<../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/dataTransfer（星闪数传能力）/nearlink-data-transfer-api.md#onreaddata>)(type: 'readData', callback: Callback<DataParams>): void | 订阅端口通道数据接收事件。 |
...
1. 导入相关模块。
   ...
   ```
   1. import { dataTransfer, remoteDevice } from '@kit.NearLinkKit';
...
4. 订阅端口通道连接状态变更事件。
   ...
   ```
   1. let onReceiveConnectionStateEvent:(data: dataTransfer.ConnectionResult) => void =
   2. (data: dataTransfer.ConnectionResult) => {
   3. console.info('data: ' + JSON.stringify(data));
   4. }
   5. try {
   6. dataTransfer.on('connectionStateChanged', onReceiveConnectionStateEvent);
   7. } catch (err) {
