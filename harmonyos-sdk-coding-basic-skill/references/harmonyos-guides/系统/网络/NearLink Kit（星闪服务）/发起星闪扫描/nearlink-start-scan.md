...
scraped_at: 2026-06-01T11:19:53+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:d6273978a13e8adacbdad9dc2b450bda0d4a6b3e1801773854b96601b8321843
---
## 场景介绍
...
| 接口名 | 描述 |
| --- | --- |
| [startScan](<../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/scan（星闪扫描能力）/nearlink-scan.md#startscan>)(filters: Array<ScanFilters>, options?: ScanOptions): Promise<void> | 启动星闪扫描。 |
| [stopScan](<../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/scan（星闪扫描能力）/nearlink-scan.md#stopscan>)(): Promise<void> | 停止星闪扫描。 |
| [on](<../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/scan（星闪扫描能力）/nearlink-scan.md#on-devicefound>)(type: 'deviceFound', callback: Callback<Array<ScanResults>>): void | 订阅扫描结果。 |
| [off](<../../../../../harmonyos-references/NearLink Kit（星闪服务）/ArkTS API/scan（星闪扫描能力）/nearlink-scan.md#off-devicefound>)(type: 'deviceFound', callback?: Callback<Array<ScanResults>>): void | 取消订阅扫描结果。 |
...
2. 定义扫描结果回调，解析扫描结果。
   ...
   27. console.info('nothing, adv data length is 0');
   28. return;
   29. }
