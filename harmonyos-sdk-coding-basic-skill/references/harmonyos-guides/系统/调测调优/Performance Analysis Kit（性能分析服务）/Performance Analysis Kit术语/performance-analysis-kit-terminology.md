...
scraped_at: 2026-06-01T11:25:55+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:f7bc889f2743c3762d7ae1f874a4ad605c01d94b4b143bcdef7cb2877dac61b1
---
## 通用
...
使用[debug模式](../../../../构建应用/定制构建/灵活定制编译选项/能力说明/ide-hvigor-compilation-options-customizing-guide.md#section192461528194916)构建的应用。

### release版本应用

使用[release模式](../../../../构建应用/定制构建/灵活定制编译选项/能力说明/ide-hvigor-compilation-options-customizing-guide.md#section192461528194916)构建的应用。
...
记录线程执行到当前现场（如崩溃、冻屏等）的函数调用顺序。具体说明请参见[调用栈帧内容说明](<../故障检测/崩溃检测/Cpp Crash（进程崩溃）检测/cppcrash-guidelines.md#一般故障场景日志规格>)和[JS混合栈帧内容说明](<../故障检测/崩溃检测/Cpp Crash（进程崩溃）检测/cppcrash-guidelines.md#一般故障场景日志规格>)。
