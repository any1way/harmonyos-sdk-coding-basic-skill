...
content_hash: sha256:59d166066e2f0c4bde22470b7ab1e8731024399a45a08f35d7feade323546b41
---
...
HiLog中定义了DEBUG、INFO、WARN、ERROR、FATAL五种日志级别，并提供了对应的方法输出不同级别的日志，接口如下表所示，具体说明可查阅[log.h](<../../../../../../harmonyos-references/Performance Analysis Kit（性能分析服务）/C API/头文件/log.h/capi-log-h.md>)。
...
如果设置的日志级别低于[全局日志级别](../../../调试命令/hilog/hilog.md#查看和设置日志级别)，OH\_LOG\_SetMinLogLevel()设置不生效。
...
* level：用于指定日志级别。取值见[LogLevel](<../../../../../../harmonyos-references/Performance Analysis Kit（性能分析服务）/C API/头文件/log.h/capi-log-h.md#loglevel>)。
* prefer：用于指定偏好策略。取值见[PreferStrategy](<../../../../../../harmonyos-references/Performance Analysis Kit（性能分析服务）/C API/头文件/log.h/capi-log-h.md#preferstrategy>)。
