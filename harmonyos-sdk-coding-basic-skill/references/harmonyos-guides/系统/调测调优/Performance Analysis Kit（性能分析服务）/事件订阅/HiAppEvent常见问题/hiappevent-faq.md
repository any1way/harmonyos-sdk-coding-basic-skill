...
scraped_at: 2026-06-01T11:25:34+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:acef26b7b25fdb8d9c1191c31067c687da2b1db61ebae048bf70b4c4ae7f736b
---
...
external\_log所在的目录为[应用沙箱目录](<../../../../../应用框架/Core File Kit（文件基础服务）/应用文件/应用沙箱目录/app-sandbox-directory.md>)，目录空间受限。log\_over\_limit字段用于判断external\_log日志文件所在目录的空间是否达到上限。如果log\_over\_limit的值为true，表示external\_log日志文件所在目录空间已达到上限，事件包含的日志文件将无法写入。
...
查看对应的事件介绍章节，确认事件是否包含external\_log：[系统事件](../使用HiAppEvent订阅事件/事件订阅简介/event-subscription-overview.md#系统事件)。
...
* 开发者若没有权限访问设备的“/data/app/el2/100/log/应用包名”目录，可以在应用代码中删除external\_log日志文件。代码示例如下。文件删除接口可以参考[fileIo.unlink](<../../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileiounlink>)。
...
[hiAppEvent.addWatcher](<../../../../../../harmonyos-references/调测调优/Performance Analysis Kit（性能分析服务）/ArkTS API/@ohos.hiviewdfx.hiAppEvent (应用事件打点)/js-apis-hiviewdfx-hiappevent.md#hiappeventaddwatcher>)。
