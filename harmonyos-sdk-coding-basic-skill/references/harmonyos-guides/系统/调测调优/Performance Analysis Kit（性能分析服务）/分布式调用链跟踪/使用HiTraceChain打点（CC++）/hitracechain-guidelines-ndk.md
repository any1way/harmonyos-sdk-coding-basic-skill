...
scraped_at: 2026-06-01T11:25:43+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:910ca551705190b5d6715d636fa65e1c8062960fc2e9eda2cd489fab722da8d6
---
## 接口说明

分布式跟踪接口由HiTraceChain模块提供，详细API请参考[trace.h](<../../../../../../harmonyos-references/Performance Analysis Kit（性能分析服务）/C API/头文件/trace.h/capi-trace-h.md>)。
...
std::thread不支持自动传递HiTraceId，开发示例展示了该场景下分布式跟踪的使用方法。开发者可参考[约束与限制](../HiTraceChain介绍/hitracechain-intro.md#约束与限制)，了解常见的支持与不支持HiTraceChain自动传递的机制。
...
2. 在“entry > src > main > cpp > CMakeLists.txt”文件中新增libhitrace\_ndk.z.so和libhilog\_ndk.z.so动态链接库，完整的文件内容如下：
   ...
   [CMakeLists.txt](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/PerformanceAnalysisKit/HiTrace/HitraceChain_NDK/entry/src/main/cpp/CMakeLists.txt#L1-L17)
3. 编辑“entry > src > main > cpp > napi\_init.cpp”文件，使用HiTraceChain跟踪多线程任务，完整的示例代码如下：
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/PerformanceAnalysisKit/HiTrace/HitraceChain_NDK/entry/src/main/cpp/napi_init.cpp#L16-L124)
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/PerformanceAnalysisKit/HiTrace/HitraceChain_NDK/entry/src/main/ets/pages/Index.ets#L16-L48)
