...
scraped_at: 2026-06-11T14:53:00+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:c472c4eeb8ad4730c3a43ff78f1cd229ea2ee4f5925ee62aa56aa5f253a5ac4c
---
...
本例中仅介绍了部分字段的使用。关于Ability匹配的详细规则参考[显式Want与隐式Want匹配规则](<../../../../应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/信息传递载体Want/显式Want与隐式Want匹配规则/explicit-implicit-want-mappings.md>)。
...
aa dump命令从API version 7开始支持，从API version 9废弃，替换命令为[hidumper](../hidumper/hidumper/hidumper.md) -s AbilityManagerService。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5f/v3/Do5tm99ESdW7hqt5msdWhQ/zh-cn_image_0000002592378866.png?HW-CC-KV=V1&HW-CC-Date=20260611T065258Z&HW-CC-Expire=86400&HW-CC-Sign=10CF25844CF2C0F6E7F8A2D85F026C1D96AB77C673ABCE8E36EEA8603BE14F81)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/ArLogffIR32W3CGWkvda0w/zh-cn_image_0000002622858373.png?HW-CC-KV=V1&HW-CC-Date=20260611T065258Z&HW-CC-Expire=86400&HW-CC-Sign=77C129662CBF871F5A17684E2727883900DB195F8E47B80945B0D57FF3F48AFC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/rsl49167Q0y9la1l2GaXGg/zh-cn_image_0000002622698495.png?HW-CC-KV=V1&HW-CC-Date=20260611T065258Z&HW-CC-Expire=86400&HW-CC-Sign=2CD36F3476774E4374D03F5A4AD3701B540BA06F05C2F43E668261C99C45259F)
...
关于class、level、size、testType等参数的详细说明请参见[命令行执行测试脚本](../../../../应用测试/单元测试和UI测试/自动化测试框架使用指导/单元测试框架使用指导/unittest-guidelines.md#命令行执行测试脚本)。
...
从API version 13开始，开发者可以通过该命令来调试应用的[onMemoryLevel](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.AbilityStage (AbilityStage组件管理器)/js-apis-app-ability-abilitystage.md#onmemorylevel>)生命周期。通过在参数中指定进程的pid和内存使用级别来触发该进程的onMemoryLevel生命周期回调。该命令只提供基本的应用调试能力，不能完全模拟真实的内存加压测试场景。
...
| -h/--help | 帮助信息。 |
| -p | 必选参数，进程pid。 |
| -l | 必选参数，内存使用级别，具体值参考[AbilityConstant.MemoryLevel](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.AbilityConstant (Ability相关常量)/js-apis-app-ability-abilityconstant.md#memorylevel>)。 |
...
签名工具及签名证书的生成方式可以参考：[签名工具指导](../../../../编写与调试应用/配置调试签名/ide-signing.md)。
