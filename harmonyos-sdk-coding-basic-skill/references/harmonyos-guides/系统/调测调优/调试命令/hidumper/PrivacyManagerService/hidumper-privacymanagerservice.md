...
scraped_at: 2026-06-01T11:26:22+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:b02b6b051b2406151d4a8a9acd29cab6acf3607a6700913677ab196314f273c3
---
PrivacyManagerService是访问控制基于[hidumper](../hidumper/hidumper.md)增强开发的命令行能力，可显示访问控制基础信息，获取敏感权限使用记录。

## 环境准备

根据hidumper工具指导，完成[环境准备](../hidumper/hidumper.md#环境要求)。
...
命令所需的tokenId可以通过[atm-tool](../../atm工具/atm-tool.md#查询命令)进行查询。
