...
content_hash: sha256:01ad3356e4f6bf61f61fbbab1f4b5d9a1986a21e336863b81595ccfd93b5bd5f
---
...
2. 基于现有的p12文件数据，调用[cert.createTrustAnchorsWithKeyStore](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#certcreatetrustanchorswithkeystore12>)创建[X509TrustAnchor](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#x509trustanchor11>)数组对象，并返回结果。
...
[CreateTrustanchorFromP12.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/DeviceCertificateKit/CertificateAlgorithmLibrary/entry/src/main/ets/pages/CreateTrustanchorFromP12.ets#L17-L137)
