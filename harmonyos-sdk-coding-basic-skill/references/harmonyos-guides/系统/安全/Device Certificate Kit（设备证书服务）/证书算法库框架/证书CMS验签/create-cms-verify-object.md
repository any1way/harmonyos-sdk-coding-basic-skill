...
content_hash: sha256:786e4ff4a385ef671be0142e1f599d6763907cd3feb01386141c6996f1a04bdc
---
...
1. 导入[证书模块](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md>)。
   ...
   ```
2. 签名的开发步骤查看[CMS签名](../证书CMS签名/create-cms-sign-object.md)。
...
5. 调用[cmsParser.verifySignedData](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#verifysigneddata22>)进行验签。
...
[CreateCmsVerifyObject.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/DeviceCertificateKit/CertificateAlgorithmLibrary/entry/src/main/ets/pages/CreateCmsVerifyObject.ets#L16-L133)
