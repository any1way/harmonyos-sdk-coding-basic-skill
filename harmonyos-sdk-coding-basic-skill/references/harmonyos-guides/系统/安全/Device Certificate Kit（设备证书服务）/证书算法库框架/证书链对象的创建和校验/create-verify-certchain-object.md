...
scraped_at: 2026-06-11T14:43:19+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:ff585c677eb0de7b1a325ec9f1f70709748d921eb7403551ee2ac0b9e1e86844
---
...
1. 导入[证书模块](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md>)。
   ...
   ```
2. 基于已有的证书数据，调用[cert.createX509CertChain](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#certcreatex509certchain11>)创建X509证书链对象，并返回结果。
3. 调用[x509CertChain.getCertList](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#getcertlist11>)获取证书链中的X509证书列表。
4. 调用[x509CertChain.validate](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#validate11>)使用校验参数校验证书链并返回结果。
...
[CreateVerifyCertchainObject.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/DeviceCertificateKit/CertificateAlgorithmLibrary/entry/src/main/ets/pages/CreateVerifyCertchainObject.ets#L16-L125)
