...
scraped_at: 2026-06-11T14:43:18+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:cae6c0be9d262c1dd44b092c209b704bcc79825942d152dc918986589a6466e8
---
...
1. 导入[证书模块](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md>)。
   ...
   ```
2. 基于已有的证书数据，调用[cert.createX509Cert](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#certcreatex509cert-1>)创建X509证书的对象。
3. 基于已有的CRL数据，调用[cert.createX509CRL](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#certcreatex509crl11-1>)创建X509证书吊销列表的对象。
4. 调用[cert.createCertCRLCollection](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#certcreatecertcrlcollection11>)创建[CertCRLCollection](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#certcrlcollection11>)的对象，并返回相应的结果。
5. 调用[CertCRLCollection.selectCerts](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#selectcerts11>)查找所有与[X509CertMatchParameters](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#x509certmatchparameters11>)匹配的证书对象数组，并返回结果。
6. 调用[CertCRLCollection.selectCRLs](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#selectcrls11>)查找所有与[X509CRLMatchParameters](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#x509crlmatchparameters11>)匹配的证书吊销列表数组，并返回结果。
...
[CreateGetCertCrlObject.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/DeviceCertificateKit/CertificateAlgorithmLibrary/entry/src/main/ets/pages/CreateGetCertCrlObject.ets#L18-L110)
