...
scraped_at: 2026-06-11T14:43:23+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:d1abc44fb5f0a55f741b92ce08618061e66b352fe82a91f87bff89cf542b9930
---
...
1. 导入[证书模块](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md>)。
   ...
   ```
2. 调用[cert.createCmsGenerator](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#certcreatecmsgenerator18>)创建cmsGenerator对象。
3. 调用[cmsGenerator.setRecipientEncryptionAlgorithm](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#setrecipientencryptionalgorithm22>)设置加密算法。
4. 调用[cmsGenerator.addRecipientInfo](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#addrecipientinfo22>)添加接收者信息。
5. 调用[cmsGenerator.doFinal](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#dofinal18>)获取CMS最终封装数据。
6. 调用[cmsGenerator.getEncryptedContentData](<../../../../../../harmonyos-references/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#getencryptedcontentdata22>)获取CMS封装密文数据。
...
[CreateCmsEnvelopedObject.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/DeviceCertificateKit/CertificateAlgorithmLibrary/entry/src/main/ets/pages/CreateCmsEnvelopedObject.ets#L16-L111)
