...
scraped_at: 2026-06-11T14:44:01+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:98bd97bd7cba21479eed086f310b8d0a3ede31db0564ec531c851e3c849d77e4
---
## 场景介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/bM1k8xYjQAqqZznoHXtCPA/zh-cn_image_0000002622698371.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T064400Z&HW-CC-Expire=86400&HW-CC-Sign=D3905700E435D7D45BD233DD50C9D5D8E59720704AB2B7C8775FCDCDC4FEBFB5)
...
| 接口名 | 描述 |
| --- | --- |
| [enableTrustedAuthentication](<../../../../../../../harmonyos-references/Device Security Kit（设备安全服务）/ArkTS API/TrustedAuthentication（数字盾服务）/devicesecurity-trusted-auth-api.md#enabletrustedauthentication>)(challenge: Uint8Array, pwdInfo: PasswordInfo, label: TUILable): Promise<AuthInfo> | 创建数字盾密码 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/lo2KVz2GQVOMkYEPhPSJSQ/zh-cn_image_0000002592218810.png?HW-CC-KV=V1&HW-CC-Date=20260611T064400Z&HW-CC-Expire=86400&HW-CC-Sign=719CF5A002A711A805B336BC7E454C811D91E6C2037D1A4B0AD3BA82FC2F7723)
...
2. 确认设备是否具备TUI能力。
   ...
   ```
   1. async function isSupportTUI():Promise<boolean> {
   2. if (canIUse('SystemCapability.Security.TrustedAuthentication')) {
   3. let text = 'a'; // 任意短字符串。
   4. try {
   5. const result = await trustedAuthentication.checkConfirmUITextFormat(text);
   6. if (result.result == 0) {
   7. return true;
   8. }
   9. } catch (error) {
   10. hilog.error(0x0000, TAG, 'The trusted authentication feature is not enabled.');
   11. return false;
   12. }
   13. }
   14. return false;
   15. }
   16. let supportFlag:boolean = await isSupportTUI();
   ```
3. 参考密钥管理服务提供的[密钥生成开发指导](<../../../../Universal Keystore Kit（密钥管理服务）/本地密钥管理/密钥生成导入/密钥生成/生成密钥(ArkTS)/huks-key-generation-arkts.md>)，使用指定的会话密钥别名及指定密钥属性集合完成密钥生成。
...
5. 调用设置密码接口，发起数字盾密码创建申请。
   ...
   ```
6. 参考密钥管理服务提供的[签名/验签指导](<../../../../Universal Keystore Kit（密钥管理服务）/本地密钥管理/密钥使用/签名验签/签名验签(ArkTS)/huks-signing-signature-verification-arkts.md>), 对通过密码设置获取到的authToken数据进行签名，并结束会话。
