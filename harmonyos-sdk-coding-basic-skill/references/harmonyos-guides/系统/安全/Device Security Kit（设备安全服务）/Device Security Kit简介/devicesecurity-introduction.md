...
scraped_at: 2026-06-11T14:43:38+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:aa32303d910f6304f58f3d1dc514633452552116ce38c6b60798feaa6503ed36
---
...
[数字盾服务](../数字盾服务/devicesecurity-trustedauth-service.md)联合[Universal Keystore Kit（密钥管理服务）](<../../Universal Keystore Kit（密钥管理服务）/huks-kit.md>)、[User Authentication Kit（用户认证服务）](<../../User Authentication Kit（用户认证服务）/user-authentication-kit.md>)共同为金融应用数字盾开发提供可信UI、可信认证、可信签名能力。

业务关联如图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/06/v3/0-mvpTgBQduWC6hmlpfBsg/zh-cn_image_0000002622698361.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T064338Z&HW-CC-Expire=86400&HW-CC-Sign=A792E053C06CA85447C74C7D6E26D41308F021F8CD4B7DD0AA343FFD3C65ED05)
...
| 场景 | 国家/地区 |
| --- | --- |
| 应用设备状态检测 | 请参见[支持的国家/地区](../附录/支持的国家地区/devicesecurity-appendix-region.md)。 |
| 安全检测-系统完整性检测 | 只支持中国境内（香港特别行政区、澳门特别行政区、中国台湾除外）。 |
| 安全检测-URL检测 | 只支持中国境内（香港特别行政区、澳门特别行政区、中国台湾除外）。 |
| 安全检测-本地系统完整性检测 | 请参见[支持的国家/地区](../附录/支持的国家地区/devicesecurity-appendix-region.md)。 |
