...
scraped_at: 2026-06-11T14:43:52+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:7b704b52656809031e53225b73e09b81bb255eda663505dc6b4b56435451c05a
---
## 场景介绍
...
开发者可以通过调用[getSupportedSceneModes](<../../../../../../harmonyos-references/Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (CameraManager)/arkts-apis-camera-cameramanager.md#getsupportedscenemodes11>)方法，当返回值为camera.SceneMode.SECURE\_PHOTO，当前设备支持安全摄像头，返回其他值表示当前设备不支持安全摄像头。具体判断方法参考如下示例：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/8QZVFhgITnS_xEed_s4eYw/zh-cn_image_0000002622858247.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T064352Z&HW-CC-Expire=86400&HW-CC-Sign=26416126A7AA72000BF29EB9D4C7A20209DDF31015FAA6510292A67054A615E0)
...
1. 导入camera模块、trustedAppService模块和相关依赖模块。
   ...
   ```
2. 参考[安全相机开发指导](<../../../../../媒体/Camera Kit（相机服务）/开发相机应用基础能力(ArkTS)/安全相机(ArkTS)/camera-secure-photo.md>)，初始化安全相机。
...
3. 创建证明密钥和初始化证明会话。
   ...
   * 调用initializeAttestContext初始化证明会话时，userData的长度必须在16到127 Bytes之间。
   ...
   40. }
   ```
4. 参考[安全相机开发指导](<../../../../../媒体/Camera Kit（相机服务）/开发相机应用基础能力(ArkTS)/安全相机(ArkTS)/camera-secure-photo.md>)，完成安全相机会话的创建，配置输入、输出流，启动预览流和安全数据流。
5. 结束证明会话。
   ...
   如果需要销毁证明密钥，请在结束证明会话后，调用[destroyAttestKey](<../../../../../../harmonyos-references/Device Security Kit（设备安全服务）/ArkTS API/TrustedAppService（可信应用服务）/devicesecurity-taas-api.md#destroyattestkey>)接口。由于安全摄像头、安全地理位置和安全图像压缩、裁剪共用同一个证明密钥，销毁前需要保证安全地理位置功能未在使用该证明密钥。
