...
content_hash: sha256:f8bc2f3974001fe26ed07d0172b31f8ab527de698f8aeac8941cf51243835e8b
---
如果需要在端侧校验安全图像数据或安全地理位置数据签名的有效性，可以使用[Crypto Architecture Kit](<../../../../Crypto Architecture Kit（加解密算法框架服务）/Crypto Architecture Kit简介/crypto-architecture-kit-intro.md>)，使用方法请参考“[使用ECDSA密钥对签名验签](<../../../../Crypto Architecture Kit（加解密算法框架服务）/签名验签/签名验签开发指导/使用ECDSA密钥对签名验签(ArkTS)/crypto-ecdsa-sign-sig-verify.md>)”章节。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/-uxgIq9nQOGQDrviVAh8AA/zh-cn_image_0000002592378742.png?HW-CC-KV=V1&HW-CC-Date=20260611T064356Z&HW-CC-Expire=86400&HW-CC-Sign=DAEF58D8EECACCD90EF46F244AB7D5E2673E4AD3F8F2A93F88FF51356924967E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/kRKW9aXyT8Kgz5js-rqeAg/zh-cn_image_0000002622858249.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T064356Z&HW-CC-Expire=86400&HW-CC-Sign=322616A4546EDE90108B5CBCAD5ADE4E381DB88C3B2462F83157A6F7FE496D8A)
...
安全地理位置数据的结构请参考[TrustedAppService（可信应用服务）](<../../../../../../../harmonyos-references/Device Security Kit（设备安全服务）/ArkTS API/TrustedAppService（可信应用服务）/devicesecurity-taas-api.md>)。
...
在安全摄像头场景和安全地理位置场景中，由于使用的是相同的证明密钥，因此签名验证的流程是一致的。结合“[安全摄像头场景](../../安全摄像头场景/devicesecurity-taas-securecamera.md)”和“[安全地理位置场景](../../安全地理位置场景/devicesecurity-taas-securelocation.md)”中获取到的原始数据和签名结果，验证签名的参考代码（不含异常处理逻辑，由开发者根据业务场景实现）如下：
