...
scraped_at: 2026-06-11T14:43:44+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:30e2b06ecfc105a98d79e87269187f09dbc9434303063de02dbecbc979c22689
---
## 场景介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/WhqBmWjATq6XjXuqZVtQdA/zh-cn_image_0000002592378738.png?HW-CC-KV=V1&HW-CC-Date=20260611T064343Z&HW-CC-Expire=86400&HW-CC-Sign=C32B7C290C44DFCB79F914B9D818BFEE344FD366B07B37542A6C9012033E08DA)
...
以下是DeviceVerify相关接口，包括ArkTS API和REST API，更多接口及使用方法请参见[API参考](<../../../../../harmonyos-references/Device Security Kit（设备安全服务）/ArkTS API/DeviceVerify（应用设备状态检测）/devicesecurity-deviceverify-api.md>)。

| 接口名 | 描述 |
| --- | --- |
| [getDeviceToken(): Promise<string>](<../../../../../harmonyos-references/Device Security Kit（设备安全服务）/ArkTS API/DeviceVerify（应用设备状态检测）/devicesecurity-deviceverify-api.md#getdevicetoken>) | 获取本设备的DeviceToken |
| [checkDeviceToken](<../../../../../harmonyos-references/Device Security Kit（设备安全服务）/REST API/验证deviceToken/devicesecurity-deviceverify-checkdevicetoken.md>) | 验证deviceToken |
| [getDeviceStatus](<../../../../../harmonyos-references/Device Security Kit（设备安全服务）/REST API/查询设备标记状态/devicesecurity-deviceverify-getdevicestatus.md>) | 查询设备标记状态 |
| [setDeviceStatus](<../../../../../harmonyos-references/Device Security Kit（设备安全服务）/REST API/更新设备标记状态/devicesecurity-deviceverify-updatedevicestatus.md>) | 更新设备标记状态 |
| [delDeviceStatus](<../../../../../harmonyos-references/Device Security Kit（设备安全服务）/REST API/删除设备标记状态/devicesecurity-deviceverify-deletedevicestatus.md>) | 删除设备标记状态 |
...
请确保已打开[“应用设备状态检测”开关](<../开发准备/开通Device Security服务/devicesecurity-deviceverify-activateservice.md>)并[申请调试Profile](https://developer.huawei.com/consumer/cn/doc/app/agc-help-debug-profile-0000002248181278)。
...
1. 获取凭证Token，详情请参见[基于服务账号生成鉴权令牌](../开发准备/基于服务账号生成鉴权令牌/devicesecurity-deviceverify-token.md)。
2. 可分别调用checkDeviceToken、getDeviceStatus、setDeviceStatus、delDeviceStatus接口，实现deviceToken验证、查询设备标记状态、更新设备标记状态及删除设备标记状态功能。更多接口信息请参见[REST API](<../../../../../harmonyos-references/Device Security Kit（设备安全服务）/ArkTS API/DeviceVerify（应用设备状态检测）/devicesecurity-deviceverify-api.md>)。
