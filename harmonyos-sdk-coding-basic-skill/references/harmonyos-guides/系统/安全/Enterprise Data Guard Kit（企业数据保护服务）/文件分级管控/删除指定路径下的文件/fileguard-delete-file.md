...
scraped_at: 2026-06-01T11:17:03+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:3ba15ca3463e32941166dfe32fe1c6c4492cafc220532e0d068e5ae5f831a34d
---
## 场景介绍
...
| 接口名 | 描述 |
| --- | --- |
| [deleteFile](<../../../../../../harmonyos-references/安全/Enterprise Data Guard Kit（企业数据保护服务）/ArkTS API/fileGuard (文件分级管控)/dataguard-fileguard.md#deletefile>)(path: string, callback: AsyncCallback<void>): void | 使用Callback方式删除指定路径下的文件。 |
| [deleteFile](<../../../../../../harmonyos-references/安全/Enterprise Data Guard Kit（企业数据保护服务）/ArkTS API/fileGuard (文件分级管控)/dataguard-fileguard.md#deletefile-1>)(path: string): Promise<void> | 使用Promise方式删除指定路径下的文件。 |
...
1. 导入模块。
   ...
   ```
2. 初始化[FileGuard](<../../../../../../harmonyos-references/安全/Enterprise Data Guard Kit（企业数据保护服务）/ArkTS API/fileGuard (文件分级管控)/dataguard-fileguard.md#fileguard>)对象guard，调用接口deleteFile，删除扫描范围内的文件。
