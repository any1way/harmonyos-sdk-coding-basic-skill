...
scraped_at: 2026-06-01T11:17:16+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:08badb2b7d0785300cab0182e99a55314762a84cd76434d1711baad0b6a4efa8
---
## 场景介绍
...
| 接口名 | 描述 |
| --- | --- |
| [deleteEnterpriseRecoveryKey](<../../../../../../harmonyos-references/Enterprise Data Guard Kit（企业数据保护服务）/ArkTS API/recoveryKey（企业恢复密钥）/dataguard-recoverykey.md#deleteenterpriserecoverykey>)(userId: number, signature: Uint8Array): Promise<number> | 使用Promise方式删除企业恢复密钥相关数据。 |
...
1. 导入模块。
   ...
   ```
2. 先调用接口[getAuthChallenge](<../../../../../../harmonyos-references/Enterprise Data Guard Kit（企业数据保护服务）/ArkTS API/recoveryKey（企业恢复密钥）/dataguard-recoverykey.md#getauthchallenge>)，获取挑战值并[签名](../挑战值签名/recoverykey-signature.md)，传入需要删除企业恢复密钥的用户ID和挑战值的签名，再调用接口[deleteEnterpriseRecoveryKey](<../../../../../../harmonyos-references/Enterprise Data Guard Kit（企业数据保护服务）/ArkTS API/recoveryKey（企业恢复密钥）/dataguard-recoverykey.md#deleteenterpriserecoverykey>)，删除企业恢复密钥相关数据。
