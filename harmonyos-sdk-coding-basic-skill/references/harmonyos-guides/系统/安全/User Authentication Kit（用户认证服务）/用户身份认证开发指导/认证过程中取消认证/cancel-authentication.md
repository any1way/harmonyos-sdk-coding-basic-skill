...
scraped_at: 2026-06-01T11:19:10+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:ced21cd9e50a26e20fbc54ab07df75269ad7dcc2929e22b1e4c6aa4ded428702
---
统一用户认证框架提供了cancel接口，当应用在认证过程中，需要取消认证时可调用该接口。

## 接口说明

具体参数、返回值、错误码等描述，请参考对应的[cancel](<../../../../../../harmonyos-references/安全/User Authentication Kit（用户认证服务）/ArkTS API/@ohos.userIAM.userAuth (用户认证)/js-apis-useriam-userauth.md#cancel10>)。

此处仅展示了取消认证操作的接口，在取消认证前，需要先发起认证，发起认证的接口列表、详细说明可参考[发起认证](../发起认证/start-authentication.md)章节和API文档。
...
2. 指定用户认证相关参数[AuthParam](<../../../../../../harmonyos-references/安全/User Authentication Kit（用户认证服务）/ArkTS API/@ohos.userIAM.userAuth (用户认证)/js-apis-useriam-userauth.md#authparam10>)（包括挑战值、认证类型[UserAuthType](<../../../../../../harmonyos-references/安全/User Authentication Kit（用户认证服务）/ArkTS API/@ohos.userIAM.userAuth (用户认证)/js-apis-useriam-userauth.md#userauthtype8>)列表和认证等级[AuthTrustLevel](<../../../../../../harmonyos-references/安全/User Authentication Kit（用户认证服务）/ArkTS API/@ohos.userIAM.userAuth (用户认证)/js-apis-useriam-userauth.md#authtrustlevel8>)），获取认证对象[UserAuthInstance](<../../../../../../harmonyos-references/安全/User Authentication Kit（用户认证服务）/ArkTS API/@ohos.userIAM.userAuth (用户认证)/js-apis-useriam-userauth.md#userauthinstance10>)，并调用[UserAuthInstance.start](<../../../../../../harmonyos-references/安全/User Authentication Kit（用户认证服务）/ArkTS API/@ohos.userIAM.userAuth (用户认证)/js-apis-useriam-userauth.md#start10>)发起认证。此步骤详细说明可参考[发起认证](../发起认证/start-authentication.md)。
3. 使用已经成功发起认证的UserAuthInstance对象调用[UserAuthInstance.cancel](<../../../../../../harmonyos-references/安全/User Authentication Kit（用户认证服务）/ArkTS API/@ohos.userIAM.userAuth (用户认证)/js-apis-useriam-userauth.md#cancel10>)接口取消本次认证。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/UserAuthentication/entry/src/main/ets/pages/Index.ets#L332-L401)
