...
scraped_at: 2026-06-01T11:13:28+08:00
doc_updated_at: 2026-03-20
content_hash: sha256:a65e7fbb871a64b2b1892d28b06c497d9cb44338af878d44c9c4ec6dd28cb66d
---
## 登录

应用在设置“登录”页面时，需要“用户名/账号名”、“密码”在同一个界面，具体可参照[账号密码保存-登录](../自动保存/账号密码保存/passwordvault-save-acc-password.md#账号密码登录)、[账号密码填充-登录](../自动填充/账号密码填充/passwordvault-autofill-acc-password.md#登录)中的介绍。

## 注册

应用在设置“注册”页面时，需要“用户名/账号名”、“新密码”在同一个界面，具体可参照[账号密码保存-注册](../自动保存/账号密码保存/passwordvault-save-acc-password.md#账号密码注册)、[强密码填充-注册](../自动填充/强密码填充/passwordvault-autofill-strong-password.md#注册)中的介绍。

## 修改密码

应用在设置“修改密码”页面时，需要“用户名/账号名”、“旧密码”、“新密码”在同一个界面，具体可参照[账号密码更新-修改账号密码](../自动保存/账号密码更新/passwordvault-update-acc-password.md#修改账号密码)、[账号密码填充-修改密码](../自动填充/账号密码填充/passwordvault-autofill-acc-password.md#修改密码)中的介绍。
