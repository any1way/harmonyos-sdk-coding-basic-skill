...
scraped_at: 2026-06-11T14:40:36+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:6959f803d68f6d709f11ca7584b0f4d6199e58815e102de43e327d957fb1761a
---
## 接口介绍

开发者可以查阅API文档，获取关键资产查询接口的详细说明：[query(query: AssetMap)](<../../../../../../harmonyos-references/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#assetquery>)、同步接口[querySync(query: AssetMap)](<../../../../../../harmonyos-references/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#assetquerysync12>)。
...
| ACCESSIBILITY | 类型为number，取值范围详见[Accessibility](<../../../../../../harmonyos-references/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#accessibility>)。 | 可选 | 基于锁屏状态的访问控制。 |
...
| AUTH\_TYPE | 类型为number，取值范围详见[AuthType](<../../../../../../harmonyos-references/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#authtype>)。 | 可选 | 访问关键资产所需的用户认证类型。 |
| SYNC\_TYPE | 类型为number，取值范围详见[SyncType](<../../../../../../harmonyos-references/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#synctype>)。 | 可选 | 关键资产支持的同步类型。 |
...
| RETURN\_TYPE | 类型为number，取值范围详见[ReturnType](<../../../../../../harmonyos-references/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#returntype>)。 | 可选 | 关键资产查询返回的结果类型。 |
...
本模块提供了异步和同步两套接口，以下为异步接口的使用示例，同步接口详见[@ohos.security.asset (关键资产存储服务)](<../../../../../../harmonyos-references/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md>)。

在指定群组中查询一条关键资产明文的使用示例详见[查询单条群组关键资产明文](../管理群组关键资产(ArkTS)/asset-js-group-access-control.md#查询单条群组关键资产明文)，在指定群组中查询一条关键资产属性的使用示例详见[查询单条群组关键资产属性](../管理群组关键资产(ArkTS)/asset-js-group-access-control.md#查询单条群组关键资产属性)。

在查询前，需确保已有关键资产，可参考[指南文档](../新增关键资产(ArkTS)/asset-js-add.md)新增关键资产，否则将抛出NOT\_FOUND错误（错误码24000002）。
...
1. 引用头文件，定义工具函数。
   ...
   [query\_plaintext.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreArkTS/entry/src/main/ets/operations/query_plaintext.ets#L17-L32)
2. 参考如下示例代码，进行业务功能开发。
   ...
   [query\_plaintext.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreArkTS/entry/src/main/ets/operations/query_plaintext.ets#L36-L64)
...
1. 引用头文件，定义工具函数。
   ...
   [query\_attr.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreArkTS/entry/src/main/ets/operations/query_attr.ets#L17-L26)
2. 参考如下示例代码，进行业务功能开发。
   ...
   [query\_attr.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreArkTS/entry/src/main/ets/operations/query_attr.ets#L30-L57)
...
1. 引用头文件，定义工具函数。
   ...
   [query\_batch\_attrs.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreArkTS/entry/src/main/ets/operations/query_batch_attrs.ets#L17-L26)
2. 参考如下示例代码，进行业务功能开发。
   ...
   [query\_batch\_attrs.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreArkTS/entry/src/main/ets/operations/query_batch_attrs.ets#L30-L59)
