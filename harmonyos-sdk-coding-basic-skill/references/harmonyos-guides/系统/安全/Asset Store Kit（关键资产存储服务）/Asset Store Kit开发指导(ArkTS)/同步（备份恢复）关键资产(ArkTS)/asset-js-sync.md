...
scraped_at: 2026-06-01T11:13:43+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:0311f4af3011d0bc77b6ccd0624da80685a30d68356438077dd15ab84779580e
---
## 新增支持同步的关键资产
...
1. 引用头文件，定义工具函数。
   ...
   [add\_sync.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreArkTS/entry/src/main/ets/operations/add_sync.ets#L17-L26)
2. 参考如下示例代码，进行业务功能开发。
   ...
   [add\_sync.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreArkTS/entry/src/main/ets/operations/add_sync.ets#L30-L55)

## 接入备份恢复扩展能力

为触发应用数据备份恢复，需要[应用接入数据备份恢复](<../../../../../应用框架/Core File Kit（文件基础服务）/应用文件/应用数据备份恢复/应用接入数据备份恢复/app-file-backup-extension.md>)。

## 查询关键资产同步结果

### 接口介绍

通过API文档查看查询关键资产同步结果接口[asset.querySyncResult](<../../../../../../harmonyos-references/安全/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#assetquerysyncresult20>)。
...
1. 引用头文件，定义工具函数。
   ...
   [query\_sync\_result.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreArkTS/entry/src/main/ets/operations/query_sync_result.ets#L17-L20)
2. 参考如下示例代码，进行业务功能开发。
   ...
   [query\_sync\_result.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreArkTS/entry/src/main/ets/operations/query_sync_result.ets#L24-L37)
