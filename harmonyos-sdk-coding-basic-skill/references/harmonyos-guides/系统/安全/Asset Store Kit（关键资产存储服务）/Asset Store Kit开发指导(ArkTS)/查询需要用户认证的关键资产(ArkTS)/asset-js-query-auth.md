...
scraped_at: 2026-06-01T11:13:41+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:e09e63d6df7d3756361c2dc8de8706137f6a5114000c290b37d170c6fa5ef6a1
---
## 接口介绍
...
| 异步接口 | 同步接口 | 说明 |
| --- | --- | --- |
| [preQuery(query: AssetMap)](<../../../../../../harmonyos-references/安全/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#assetprequery>) | [preQuerySync(query: AssetMap)](<../../../../../../harmonyos-references/安全/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#assetprequerysync12>) | 查询预处理。 |
| [query(query: AssetMap)](<../../../../../../harmonyos-references/安全/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#assetquery>) | [querySync(query: AssetMap)](<../../../../../../harmonyos-references/安全/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#assetquerysync12>) | 查询关键资产。 |
| [postQuery(handle: AssetMap)](<../../../../../../harmonyos-references/安全/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#assetpostquery>) | [postQuerySync(handle: AssetMap)](<../../../../../../harmonyos-references/安全/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#assetpostquerysync12>) | 查询后置处理。 |
...
* **preQuery参数列表**
  ...
  | ACCESSIBILITY | 类型为number，取值范围详见[Accessibility](<../../../../../../harmonyos-references/安全/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#accessibility>)。 | 可选 | 基于锁屏状态的访问控制。 |
  ...
  | AUTH\_TYPE | 类型为number，取值范围详见[AuthType](<../../../../../../harmonyos-references/安全/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#authtype>)。 | 可选 | 访问关键资产所需的用户认证类型。 |
  | AUTH\_VALIDITY\_PERIOD | 类型为number，取值范围：1-600，单位为秒。 | 可选 | 用户认证的有效期，默认值为60。 |
  | SYNC\_TYPE | 类型为number，取值范围详见[SyncType](<../../../../../../harmonyos-references/安全/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md#synctype>)。 | 可选 | 关键资产支持的同步类型。 |
...
本模块提供了异步和同步两套接口，以下为异步接口的使用示例，同步接口详见[@ohos.security.asset (关键资产存储服务)](<../../../../../../harmonyos-references/安全/Asset Store Kit（关键资产存储服务）/ArkTS API/@ohos.security.asset (关键资产存储服务)/js-apis-asset.md>)。

在查询前，需确保已有需要用户认证的关键资产，可参考[指南文档](../新增关键资产(ArkTS)/asset-js-add.md)新增关键资产，否则将抛出NOT\_FOUND错误（错误码24000002）。

查询别名是demo\_alias且需要用户认证的关键资产。示例中引入的@ohos.userIAM.userAuth用法详见userAuth文档中的[start](<../../../../../../harmonyos-references/安全/User Authentication Kit（用户认证服务）/ArkTS API/@ohos.userIAM.userAuth (用户认证)/js-apis-useriam-userauth.md#start10>)接口。
...
1. 引用头文件，定义工具函数。
   ...
   [query\_auth.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreArkTS/entry/src/main/ets/operations/query_auth.ets#L16-L32)
2. 参考如下示例代码，进行业务功能开发。
   ...
   [query\_auth.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreArkTS/entry/src/main/ets/operations/query_auth.ets#L34-L129)
