...
scraped_at: 2026-06-11T14:40:44+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:bad11a53d9db124f260cc83dfb8b53b3f92060f640e9003be318aaee1a072113
---
## 接口介绍

开发者可以查阅API文档，获取关键资产查询接口的详细说明：[OH\_Asset\_Query](<../../../../../../harmonyos-references/Asset Store Kit（关键资产存储服务）/C API/头文件/asset_api.h/capi-asset-api-h.md#oh_asset_query>)。
...
| ASSET\_TAG\_ACCESSIBILITY | 类型为uint32\_t，取值范围详见[Asset\_Accessibility](<../../../../../../harmonyos-references/Asset Store Kit（关键资产存储服务）/C API/头文件/asset_type.h/capi-asset-type-h.md#asset_accessibility>)。 | 可选 | 基于锁屏状态的访问控制。 |
...
| ASSET\_TAG\_AUTH\_TYPE | 类型为uint32\_t，取值范围详见[Asset\_AuthType](<../../../../../../harmonyos-references/Asset Store Kit（关键资产存储服务）/C API/头文件/asset_type.h/capi-asset-type-h.md#asset_authtype>)。 | 可选 | 访问关键资产所需的用户认证类型。 |
| ASSET\_TAG\_SYNC\_TYPE | 类型为uint32\_t，取值范围详见[Asset\_SyncType](<../../../../../../harmonyos-references/Asset Store Kit（关键资产存储服务）/C API/头文件/asset_type.h/capi-asset-type-h.md#asset_synctype>)。 | 可选 | 关键资产支持的同步类型。 |
...
| ASSET\_TAG\_RETURN\_TYPE | 类型为uint32\_t，取值范围详见[Asset\_ReturnType](<../../../../../../harmonyos-references/Asset Store Kit（关键资产存储服务）/C API/头文件/asset_type.h/capi-asset-type-h.md#asset_returntype>)。 | 可选 | 关键资产查询返回的结果类型。 |
...
在查询前，需确保已有关键资产，可参考[指南文档](../新增关键资产(CC++)/asset-native-add.md)新增关键资产，否则将抛出NOT\_FOUND错误（错误码24000002）。

### 查询单条关键资产明文

查询别名是demo\_alias的关键资产明文。

在指定群组中查询一条关键资产明文的示例代码详见[查询单条群组关键资产明文](../管理群组关键资产(CC++)/asset-native-group-access-control.md#查询单条群组关键资产明文)。
...
3. 参考如下示例代码，进行业务功能开发。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreNdk/entry/src/main/cpp/napi_init.cpp#L87-L113)

### 查询单条关键资产属性

查询别名是demo\_alias的关键资产属性。

在指定群组中查询一条关键资产属性的示例代码详见[查询单条群组关键资产属性](../管理群组关键资产(CC++)/asset-native-group-access-control.md#查询单条群组关键资产属性)。
...
3. 参考如下示例代码，进行业务功能开发。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreNdk/entry/src/main/cpp/napi_init.cpp#L115-L141)
...
3. 参考如下示例代码，进行业务功能开发。
   ...
   [napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/AssetStoreKit/AssetStoreNdk/entry/src/main/cpp/napi_init.cpp#L143-L171)
