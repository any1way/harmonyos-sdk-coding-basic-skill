...
scraped_at: 2026-06-01T11:14:33+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:c1fede548a5f9a162019cf31fa8d8f3874729587d67c7f9b862b794b5a00c05a
---
...
4. 调用[OH\_CryptoAsymCipher\_Final](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_asym_cipher.h/capi-crypto-asym-cipher-h.md#oh_cryptoasymcipher_final>)，传入明文，获取加密后的数据。

   * OH\_CryptoAsymCipher\_Final输出结果可能为NULL，在访问具体数据前，需要先判断结果是否为NULL，避免产生异常。
   * 当数据量较大时，可以多次调用OH\_CryptoAsymCipher\_Final，即[分段加解密](../使用RSA非对称密钥分段加解密(CC++)/crypto-rsa-asym-encrypt-decrypt-by-segment-ndk.md)。
...
3. 调用[OH\_CryptoAsymCipher\_Final](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_asym_cipher.h/capi-crypto-asym-cipher-h.md#oh_cryptoasymcipher_final>)，传入密文，获取解密后的数据。
...
[PKCS1\_RSA.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/CryptoArchitectureKit/EncryptionDecryption/EncryptionDecryptionGuidanceCpp/entry/src/main/cpp/types/project/rsa/PKCS1_RSA.cpp#L16-L118)
