...
scraped_at: 2026-06-11T14:42:52+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:3383f3a43a74344fbdf2f2819f754ada5283ce3d7eb2a4bbc2b16b853240acec
---
...
PBKDF2是将伪随机函数PRF（Pseudo-Random Function，例如基于散列的[HMAC](../../消息认证码/消息认证码计算HMAC(ArkTS)/crypto-compute-hmac.md)），输入密码明文和盐值，重复多次运算来进行密钥派生。
...
HKDF(HMAC-based Extract-and-Expand Key Derivation Function)是基于[HMAC](../../消息认证码/消息认证码计算HMAC(ArkTS)/crypto-compute-hmac.md)消息身份验证代码的简单密钥派生算法。
