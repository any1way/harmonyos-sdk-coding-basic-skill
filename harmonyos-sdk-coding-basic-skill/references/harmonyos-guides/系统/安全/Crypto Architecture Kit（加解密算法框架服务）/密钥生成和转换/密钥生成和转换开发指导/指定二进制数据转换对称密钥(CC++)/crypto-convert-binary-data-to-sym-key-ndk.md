...
content_hash: sha256:f2121704641790d08ff54148b0d0c1db4e85ab8791dd851783908f1c372bd843
---
...
查看[对称密钥生成和转换规格：3DES](../../密钥生成和转换规格/对称密钥生成和转换规格/crypto-sym-key-generation-conversion-spec.md#section3des)。

1. 获取3DES二进制密钥数据，封装成[Crypto\_DataBlob](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md>)。
2. 调用[OH\_CryptoSymKeyGenerator\_Create](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_sym_key.h/capi-crypto-sym-key-h.md#oh_cryptosymkeygenerator_create>)，指定字符串参数'3DES192'，创建密钥算法为3DES、密钥长度为192位的对称密钥生成器（OH\_CryptoSymKeyGenerator）。
3. 调用[OH\_CryptoSymKeyGenerator\_Convert](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_sym_key.h/capi-crypto-sym-key-h.md#oh_cryptosymkeygenerator_convert>)，根据指定的对称密钥二进制数据生成对称密钥对象（OH\_CryptoSymKey）。
4. 调用[OH\_CryptoSymKey\_GetKeyData](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_sym_key.h/capi-crypto-sym-key-h.md#oh_cryptosymkey_getkeydata>)，获取密钥对象的二进制数据。
...
[3des.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/CryptoArchitectureKit/KeyGenerationConversion/ConvertSymmetricKeyBinaryFormat/entry/src/main/cpp/types/project/3des.cpp#L16-L49)

## 指定二进制数据转换HMAC密钥

查看[对称密钥生成和转换规格：HMAC](../../密钥生成和转换规格/对称密钥生成和转换规格/crypto-sym-key-generation-conversion-spec.md#hmac)。

1. 获取HMAC二进制密钥，封装成[Crypto\_DataBlob](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md>)。
2. 调用[OH\_CryptoSymKeyGenerator\_Create](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_sym_key.h/capi-crypto-sym-key-h.md#oh_cryptosymkeygenerator_create>)，指定字符串参数'HMAC'，创建密钥算法为HMAC、密钥长度为[1, 32768]位的对称密钥生成器（OH\_CryptoSymKeyGenerator）。
3. 调用[OH\_CryptoSymKeyGenerator\_Convert](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_sym_key.h/capi-crypto-sym-key-h.md#oh_cryptosymkeygenerator_convert>)，根据指定的对称密钥二进制数据生成对称密钥对象（OH\_CryptoSymKey）。
4. 调用[OH\_CryptoSymKey\_GetKeyData](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_sym_key.h/capi-crypto-sym-key-h.md#oh_cryptosymkey_getkeydata>)，获取密钥对象的二进制数据。
...
[hmac.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/CryptoArchitectureKit/KeyGenerationConversion/ConvertSymmetricKeyBinaryFormat/entry/src/main/cpp/types/project/hmac.cpp#L16-L50)
