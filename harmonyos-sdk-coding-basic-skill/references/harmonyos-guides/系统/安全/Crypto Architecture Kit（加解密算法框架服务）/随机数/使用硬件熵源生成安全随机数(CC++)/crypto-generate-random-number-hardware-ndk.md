...
scraped_at: 2026-06-11T14:42:50+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:f8e1598395a0b42ec7edd9321a78c49a510088487efedb435750187e96b60e97
---
...
1. 调用[OH\_CryptoRand\_Create](<../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_rand.h/capi-crypto-rand-h.md#oh_cryptorand_create>)，创建随机数生成器。
2. 调用[OH\_CryptoRand\_EnableHardwareEntropy](<../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_rand.h/capi-crypto-rand-h.md#oh_cryptorand_enablehardwareentropy>)，开启硬件熵源。
3. （可选）调用[OH\_CryptoRand\_SetSeed](<../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_rand.h/capi-crypto-rand-h.md#oh_cryptorand_setseed>)，为随机数生成器设置种子。
4. 调用[OH\_CryptoRand\_GenerateRandom](<../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_rand.h/capi-crypto-rand-h.md#oh_cryptorand_generaterandom>)，生成指定长度的安全随机数。指定字节长度范围为1~INT\_MAX。
5. 调用[OH\_CryptoRand\_GetAlgoName](<../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_rand.h/capi-crypto-rand-h.md#oh_cryptorand_getalgoname>)，获取随机数生成器使用的算法名称。
...
35. int randomLength = 24; // 生成24字节的随机数。
...
[rand\_test.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/CryptoArchitectureKit/SecureHardWareRandomNumberGeneration/entry/src/main/cpp/types/project/rand_test.cpp#L16-L71)
