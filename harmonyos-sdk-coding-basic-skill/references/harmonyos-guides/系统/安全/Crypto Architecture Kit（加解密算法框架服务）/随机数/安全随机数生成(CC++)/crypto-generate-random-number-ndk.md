...
scraped_at: 2026-06-11T14:42:48+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:5acd95ab922e0d497fa022e456da4df1ee69bc3cc90a2ed2340d663d659ed67c
---
说明
...
2. （可选）调用[OH\_CryptoRand\_SetSeed](<../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_rand.h/capi-crypto-rand-h.md#oh_cryptorand_setseed>)，为随机数生成器设置种子。
3. 调用[OH\_CryptoRand\_GenerateRandom](<../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_rand.h/capi-crypto-rand-h.md#oh_cryptorand_generaterandom>)，生成指定长度的安全随机数。指定字节长度范围为1~INT\_MAX。
4. 调用[OH\_CryptoRand\_GetAlgoName](<../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_rand.h/capi-crypto-rand-h.md#oh_cryptorand_getalgoname>)，获取随机数生成器使用的算法名称。
...
28. int randomLength = 24; // 生成24字节的随机数。
...
[rand\_test.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/CryptoArchitectureKit/SecureRandomNumberGeneration/entry/src/main/cpp/types/project/rand_test.cpp#L16-L64)
