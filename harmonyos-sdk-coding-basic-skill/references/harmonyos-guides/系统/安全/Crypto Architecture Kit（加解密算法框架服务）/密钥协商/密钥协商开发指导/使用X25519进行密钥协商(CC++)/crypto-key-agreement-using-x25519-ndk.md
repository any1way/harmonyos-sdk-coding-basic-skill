...
scraped_at: 2026-06-11T14:42:26+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:19b2acf23363953568d2d11ba803d642898105ed6b77e5108668347374063ed9
---
对应的算法规格请查看[密钥协商算法规格：X25519](../../密钥协商介绍及算法规格/crypto-key-agreement-overview.md#x25519)。

## 开发步骤

1. 调用[OH\_CryptoAsymKeyGenerator\_Create](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_asym_key.h/capi-crypto-asym-key-h.md#oh_cryptoasymkeygenerator_create>)、[OH\_CryptoAsymKeyGenerator\_Generate](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_asym_key.h/capi-crypto-asym-key-h.md#oh_cryptoasymkeygenerator_generate>)、[OH\_CryptoAsymKeyGenerator\_Convert](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_asym_key.h/capi-crypto-asym-key-h.md#oh_cryptoasymkeygenerator_convert>)生成密钥算法为X25519的非对称密钥（keyPair）。

   如何生成X25519非对称密钥，开发者可参考下文示例，并结合[非对称密钥生成和转换规格：X25519](../../../密钥生成和转换/密钥生成和转换规格/非对称密钥生成和转换规格/crypto-asym-key-generation-conversion-spec.md#x25519)和[随机生成非对称密钥对](../../../密钥生成和转换/密钥生成和转换开发指导/随机生成非对称密钥对(CC++)/crypto-generate-asym-key-pair-randomly-ndk.md)理解。参考文档与当前示例可能存在入参差异，请在阅读时注意区分。
2. 调用[OH\_CryptoKeyAgreement\_Create](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_key_agreement.h/capi-crypto-key-agreement-h.md#oh_cryptokeyagreement_create>)，指定字符串参数'X25519'，创建密钥算法为X25519的密钥协议生成器。
3. 调用[OH\_CryptoKeyAgreement\_GenerateSecret](<../../../../../../../harmonyos-references/Crypto Architecture Kit（加解密算法框架服务）/C API/头文件/crypto_key_agreement.h/capi-crypto-key-agreement-h.md#oh_cryptokeyagreement_generatesecret>)，基于传入的私钥（keyPair.priKey）与公钥（keyPair.pubKey）进行密钥协商，返回共享密钥。
...
25. static OH_Crypto_ErrCode ConvertKeyPairByBlob(OH_CryptoAsymKeyGenerator *x25519Gen, OH_CryptoKeyPair **keyPair)
26. {
...
51. ret = ConvertKeyPairByBlob(x25519Gen, &keyPairA);
...
[X25519.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/CryptoArchitectureKit/KeyNegotiationCpp/entry/src/main/cpp/types/project/X25519.cpp#L16-L111)
