...
scraped_at: 2026-06-01T11:18:40+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:a1bf7a4bd916ceb7b1a0d41c6755b6fc7d75601a154c4765780e0e523a9df5cf
---
从API 23开始，HUKS支持群组密钥功能。群组密钥支持的HUKS密钥操作及详细介绍参考[群组密钥介绍](../群组密钥介绍/huks-group-key-overview.md)，本文档以[AES/CBC/PKCS7加解密](huks-group-key-arkts.md#aescbcpkcs7加解密)、[X25519非对称密钥协商](huks-group-key-arkts.md#x25519非对称密钥协商)、[PBKDF2派生密钥](huks-group-key-arkts.md#pbkdf2派生密钥)为例展示群组密钥使用方法。

**配置文件**

使用群组密钥之前，需要在app.json5文件中配置群组信息，配置方法参考[配置文件示例](../../../../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/app.json5配置文件/app-configuration-file.md#配置文件示例)中assetAccessGroups字段的配置方式。
...
1. 指定密钥别名，密钥别名命名规范参考[密钥生成介绍及算法规格](../../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)。
2. 初始化密钥属性集。需要添加群组密钥标签[HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)，推荐使用[HUKS\_TAG\_KEY\_OVERRIDE](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)，避免密钥被覆盖。
3. 调用[generateKeyItem](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksgeneratekeyitem9>)生成密钥，具体请参考[密钥生成](../../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)。

除此之外，开发者也可以参考[密钥导入](../../../密钥生成导入/密钥导入/密钥导入介绍及算法规格/huks-key-import-overview.md)，导入已有的密钥。

**加密**

1. 指定密钥别名。
2. 指定待加密的数据。
3. 使用[HuksParam](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksparam>)设置加密算法参数配置。需要添加群组密钥标签[HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)。
4. 调用[initSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksinitsession9>)初始化密钥会话，并获取会话的句柄handle。
5. 调用[finishSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksfinishsession9>)结束密钥会话，获取加密后的密文。

**解密**

1. 指定密钥别名。
2. 指定待解密的密文。
3. 使用[HuksParam](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksparam>)设置解密算法参数配置。需要添加群组密钥标签[HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)。
4. 调用[initSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksinitsession9>)初始化密钥会话，并获取会话的句柄handle。
5. 调用[finishSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksfinishsession9>)结束密钥会话，获取解密后的数据。

**删除密钥**

1. 指定密钥别名。
2. 使用[HuksParam](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksparam>)设置密钥删除算法参数配置。需要添加群组密钥标签[HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)。
3. 调用[deleteKeyItem](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksdeletekeyitem9>)删除密钥，具体请参考[密钥删除](../../../密钥删除/密钥删除(ArkTS)/huks-delete-key-arkts.md)。
...
设备A、设备B各自生成一个非对称密钥，具体请参考[密钥生成](../../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)或[密钥导入](../../../密钥生成导入/密钥导入/密钥导入介绍及算法规格/huks-key-import-overview.md)。

密钥生成时，指定参数[HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)，用于生成群组密钥。

**导出密钥**

设备A、B导出非对称密钥对的公钥材料，具体请参考[密钥导出](../../密钥导出/密钥导出(ArkTS)/huks-export-key-arkts.md)。

导出密钥时，指定参数[HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)，用于导出群组密钥。

**密钥协商**

设备A、B分别基于本端私钥和对端设备的公钥，协商出共享密钥。

密钥协商时，指定参数[HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)，用于协商群组密钥。

**删除密钥**

当密钥废弃不用时，设备A、B均需要删除密钥，具体请参考[密钥删除](../../../密钥删除/密钥删除(ArkTS)/huks-delete-key-arkts.md)。

删除密钥时，指定参数[HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)，用于删除群组密钥。
...
1. 指定密钥别名，密钥别名命名规范参考[密钥生成介绍及算法规格](../../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)。
2. 密钥生成时，指定参数[HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)，用于生成群组密钥。
3. 调用[generateKeyItem](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksgeneratekeyitem9>)生成密钥，具体请参考[密钥生成](../../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)。
...
1. 获取密钥别名，指定对应的属性参数HuksOptions，添加参数[HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)，用于派生群组密钥。
2. 调用[initSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksinitsession9>)初始化密钥会话，并获取会话的句柄handle。
3. 调用[updateSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksupdatesession9>)更新密钥会话。
4. 调用[finishSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksfinishsession9>)结束密钥会话，完成派生。

**删除密钥**

当密钥废弃不用时，需要调用[deleteKeyItem](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksdeletekeyitem9>)删除密钥，具体请参考[密钥删除](../../../密钥删除/密钥删除(ArkTS)/huks-delete-key-arkts.md)。
