...
scraped_at: 2026-06-01T11:18:41+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:6d62690c809505e630d9d5fba51fb264add8323e8cafb132852121705af287e7
---
从API 23开始，HUKS支持群组密钥功能。群组密钥支持的HUKS密钥操作及详细介绍参考[群组密钥介绍](../群组密钥介绍/huks-group-key-overview.md)，本文档以[AES/CBC/PKCS7加解密](huks-group-key-ndk.md#aescbcpkcs7加解密)、[X25519非对称密钥协商](huks-group-key-ndk.md#x25519非对称密钥协商)、[PBKDF2派生密钥](huks-group-key-ndk.md#pbkdf2派生密钥)为例展示群组密钥使用方法。
...
2. 初始化密钥属性集。需要添加群组密钥标签[OH\_HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)、[OH\_HUKS\_TAG\_KEY\_OVERRIDE](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)，避免密钥被覆盖。
3. 调用[OH\_Huks\_GenerateKeyItem](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_generatekeyitem>)生成密钥，具体请参考[密钥生成](../../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)。
...
1. 指定密钥别名。
2. 指定待加密的数据。
3. 调用[OH\_Huks\_InitParamSet](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_param.h/capi-native-huks-param-h.md#oh_huks_initparamset>)指定算法参数配置。需要添加群组密钥标签[OH\_HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)。
4. 调用[OH\_Huks\_InitSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_initsession>)初始化密钥会话，并获取会话的句柄handle。
5. 调用[OH\_Huks\_FinishSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_finishsession>)结束密钥会话，获取加密后的密文。
...
3. 调用[OH\_Huks\_InitParamSet](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_param.h/capi-native-huks-param-h.md#oh_huks_initparamset>)指定算法参数配置。需要添加群组密钥标签[OH\_HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)。
4. 调用[OH\_Huks\_InitSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_initsession>)初始化密钥会话，并获取会话的句柄handle。
5. 调用[OH\_Huks\_FinishSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_finishsession>)结束密钥会话，获取解密后的数据。

**删除密钥**

1. 指定密钥别名。
2. 调用[OH\_Huks\_InitParamSet](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_param.h/capi-native-huks-param-h.md#oh_huks_initparamset>)指定算法参数配置。需要添加群组密钥标签[OH\_HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)。
3. 调用[OH\_Huks\_DeleteKeyItem](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_deletekeyitem>)删除密钥，具体请参考[密钥删除](../../../密钥删除/密钥删除(CC++)/huks-delete-key-ndk.md)。

当密钥废弃不用时，需要调用OH\_Huks\_DeleteKeyItem删除密钥，具体请参考[密钥删除](../../../密钥删除/密钥删除(CC++)/huks-delete-key-ndk.md)。
...
密钥生成时，指定参数[OH\_HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)，用于生成群组密钥。

**导出密钥**

设备A、B导出非对称密钥对的公钥材料，具体请参考[密钥导出](../../密钥导出/密钥导出(CC++)/huks-export-key-ndk.md)。

导出密钥时，指定参数[OH\_HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)，用于导出群组密钥。

**密钥协商**

设备A、B分别基于本端私钥和对端设备的公钥，协商出共享密钥。

密钥协商时，指定参数[OH\_HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)，用于协商群组密钥。

**删除密钥**

当密钥废弃不用时，设备A、B均需要删除密钥，具体请参考[密钥删除](../../../密钥删除/密钥删除(CC++)/huks-delete-key-ndk.md)。

删除密钥时，指定参数[OH\_HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)，用于删除群组密钥。
...
1. 指定密钥别名，密钥别名命名规范参考[密钥生成介绍及算法规格](../../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)。
2. 密钥生成时，指定参数[OH\_HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)，用于生成群组密钥。
3. 调用[OH\_Huks\_GenerateKeyItem](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_generatekeyitem>)生成密钥，具体请参考[密钥生成](../../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)。
...
1. 获取密钥别名，指定对应的属性参数HuksOptions，添加参数[OH\_HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)，用于派生群组密钥。
2. 调用[OH\_Huks\_InitParamSet](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_param.h/capi-native-huks-param-h.md#oh_huks_initparamset>)指定算法参数配置。需要添加群组密钥标签[OH\_HUKS\_TAG\_KEY\_ACCESS\_GROUP](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)。
3. 调用[OH\_Huks\_InitSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_initsession>)初始化密钥会话，并获取会话的句柄handle。
4. 调用[OH\_Huks\_UpdateSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_updatesession>)更新密钥会话。
5. 调用[OH\_Huks\_FinishSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_finishsession>)结束密钥会话，完成派生。

**删除密钥**

当密钥废弃不用时，需要调用[OH\_Huks\_DeleteKeyItem](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_deletekeyitem>)删除密钥，具体请参考[密钥删除](../../../密钥删除/密钥删除(CC++)/huks-delete-key-ndk.md)。
