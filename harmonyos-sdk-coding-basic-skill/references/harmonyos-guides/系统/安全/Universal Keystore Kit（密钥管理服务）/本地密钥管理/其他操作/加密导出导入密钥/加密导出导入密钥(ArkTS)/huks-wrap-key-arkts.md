...
scraped_at: 2026-06-01T11:18:36+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:ed3898c2ba2166618771139738f0289a3675c42638449e58021b70b812fc6200
---
...
1. 初始化生成密钥属性集，需要设置[HUKS\_TAG\_IS\_ALLOWED\_WRAP](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)，指定密钥允许导出。
2. 调用[generateKeyItem](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksgeneratekeyitem9>)生成密钥，具体请参考[密钥生成](../../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)。
3. 调用[wrapKeyItem](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukswrapkeyitem20>)加密导出密钥。
4. 调用[unwrapKeyItem](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksunwrapkeyitem20>)加密导入密钥。如果是从普通密钥导入为群组密钥，需要传入TUI PIN类型的AuthToken，认证TUI PIN并获取AuthToken请参考[数字盾服务](<../../../../../Device Security Kit（设备安全服务）/数字盾服务/交易信息密码认证/devicesecurity-trustedauth-verifybypwd.md#开发步骤>)。
