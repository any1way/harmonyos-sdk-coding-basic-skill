...
scraped_at: 2026-06-01T11:17:43+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:62ccf9775a3d00a8dcfbb299ab3a24667d461d2417c99ae9339fe6e6bfab1428
---
以安全导入ECDH密钥对为例，涉及业务侧加密密钥的[密钥生成](../../密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)、[协商](../../../密钥使用/密钥协商/密钥协商介绍及算法规格/huks-key-agreement-overview.md)等操作不在本示例中体现。

具体的场景介绍及支持的算法规格，请参考[密钥导入支持的算法](../密钥导入介绍及算法规格/huks-key-import-overview.md#支持的算法)。

## 开发步骤

1. 设备A（导入设备）将待导入密钥转换成[HUKS密钥材料格式](../../../本地密钥管理基础概念/huks-concepts.md#密钥材料格式)To\_Import\_Key（仅针对非对称密钥，若待导入密钥是对称密钥则可省略此步骤）。
...
6. 设备A封装Caller\_Pk、Caller\_Kek\_Enc、To\_Import\_Key\_Enc等安全导入的密钥材料并发送给设备B，安全导入密钥材料格式见[安全导入密钥材料格式](../密钥导入介绍及算法规格/huks-key-import-overview.md#安全导入密钥材料格式)。
7. 设备B导入封装的加密密钥材料。
8. 设备A、B删除用于安全导入的密钥。
...
[ImportEncryptedKey.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/ImportEncryptedKey/entry/src/main/ets/pages/ImportEncryptedKey.ets#L15-L142)
...
[ImportEncryptedKey.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/ImportEncryptedKey/entry/src/main/ets/pages/ImportEncryptedKey.ets#L144-L265)
...
[ImportEncryptedKey.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/ImportEncryptedKey/entry/src/main/ets/pages/ImportEncryptedKey.ets#L267-L456)
...
[ImportEncryptedKey.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/ImportEncryptedKey/entry/src/main/ets/pages/ImportEncryptedKey.ets#L458-L583)
...
[ImportEncryptedKey.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/ImportEncryptedKey/entry/src/main/ets/pages/ImportEncryptedKey.ets#L585-L665)
