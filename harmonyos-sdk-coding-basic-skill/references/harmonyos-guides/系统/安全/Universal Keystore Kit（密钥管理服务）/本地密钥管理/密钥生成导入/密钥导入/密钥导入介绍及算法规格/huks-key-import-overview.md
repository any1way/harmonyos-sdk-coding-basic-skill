...
scraped_at: 2026-06-01T11:17:40+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:24bc1e0d36dde8e39297fc6ad8ee5a97ee872eddce7718a556ed40b52182e26e
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/e2mdoDP4R1qbj7MxyIBUpw/zh-cn_image_0000002582959086.png?HW-CC-KV=V1&HW-CC-Date=20260601T031741Z&HW-CC-Expire=86400&HW-CC-Sign=4A3C78231E95C699184DA57CCA47E28BCF84CC2E960C58A8F7FAAA1A2157F182)
...
导出密钥接口返回的[公钥明文材料是按照**X.509**格式封装](../../../本地密钥管理基础概念/huks-concepts.md#公钥材料格式)，导入加密密钥接口中的密钥材料需满足**LengthData-Data**的格式封装，形如：[(Lengthpart1Datapart1)……(LengthpartnDatapartn)]。

说明

1. 安全导入密钥时，协商算法支持ECDH和X25519，协商后的Shared\_Key使用AES-GCM算法加密Caller\_Kek。对应算法套件定义见[HuksUnwrapSuite](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksunwrapsuite9>)。
2. 安全导入不支持X.509格式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/BqJb74KjTQWbNaD4m0vRJQ/zh-cn_image_0000002583119012.png?HW-CC-KV=V1&HW-CC-Date=20260601T031741Z&HW-CC-Expire=86400&HW-CC-Sign=76354E92FC9BB10532DF491F247335F89B9B38E4FEC2550C9FFA77207E26F8D0)
...
导出密钥接口返回的[公钥材料格式](../../../本地密钥管理基础概念/huks-concepts.md#公钥材料格式)按照X.509格式封装，导入加密密钥接口返回的密钥材料按照**LengthData-Data**的格式封装，分别是[(LengthEncSm4DataEncSm4)(LengthEncImpKeyDataEncImpKey)]。
...
| --- | --- | --- |
| 对称密钥 | - | 密钥字节数据 |
| 非对称密钥-密钥对 | - | [密钥对材料格式](../../../本地密钥管理基础概念/huks-concepts.md#密钥对材料格式) |
| 非对称密钥-公钥 | ED25519、X25519 | 密钥字节数据，参考[导入X25519密钥公钥](../明文导入密钥(ArkTS)/huks-import-key-in-plaintext-arkts.md#导入x25519密钥公钥) |
