...
scraped_at: 2026-06-01T11:17:41+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:809395a72bc198c3e6f51f38e323e0d8b5d6cd8b0b4891701b7f4162b59c074b
---
分别以导入AES256、RSA2048和X25519密钥为例。具体的场景介绍及支持的算法规格，请参考[密钥导入支持的算法](../密钥导入介绍及算法规格/huks-key-import-overview.md#支持的算法)。

## 开发步骤

1. 指定密钥别名，密钥别名命名规范参考[密钥生成介绍及算法规格](../../密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)。
2. 封装密钥属性集和密钥材料。

   * 密钥属性集同样与密钥生成中指定的密钥属性一致，须包含[HuksKeyAlg](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukskeyalg>)、[HuksKeySize](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukskeysize>)、[HuksKeyPurpose](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukskeypurpose>)属性。
   * 密钥材料须符合[HUKS密钥材料格式](../../../本地密钥管理基础概念/huks-concepts.md#密钥材料格式)，并以Uint8Array形式赋值给[HuksOptions](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksoptions>)的inData字段。
3. 调用[huks.importKeyItem](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksimportkeyitem9>)，传入密钥别名和密钥属性集，即可导入密钥。

   HuksParam和HuksOptions的含义参考：[HuksParam](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksparam>) 和 [HuksOptions](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksoptions>)
...
[AES256.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/ImportKeyPlainText/entry/src/main/ets/pages/AES256.ets#L16-L74)
...
[RSA2048.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/ImportKeyPlainText/entry/src/main/ets/pages/RSA2048.ets#L16-L117)
...
[X25519.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/ImportKeyPlainText/entry/src/main/ets/pages/X25519.ets#L15-L78)

## 调测验证

调用[huks.isKeyItemExist](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksiskeyitemexist9>)验证密钥是否存在，如密钥存在即表示密钥导入成功。
