...
scraped_at: 2026-06-01T11:18:22+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:6407c3c51af9d9ba7c2cf18183e00108b4125c7c08a71b93304195b626a5795b
---
## 接口说明

接口能力由[Universal Keystore Kit](<../../../../Universal Keystore Kit简介/huks-overview.md>)提供，涉及的功能指导请参考：

* [Universal Keystore Kit简介](<../../../../Universal Keystore Kit简介/huks-overview.md>)
* [查询密钥是否存在(ArkTS)](../../../其他操作/查询密钥是否存在/查询密钥是否存在(ArkTS)/huks-check-key-arkts.md)
* [查询密钥是否存在(C/C++)](../../../其他操作/查询密钥是否存在/查询密钥是否存在(CC++)/huks-check-key-ndk.md)
* [生成密钥(ArkTS)](../../../密钥生成导入/密钥生成/生成密钥(ArkTS)/huks-key-generation-arkts.md)
* [生成密钥(C/C++)](../../../密钥生成导入/密钥生成/生成密钥(CC++)/huks-key-generation-ndk.md)
* [匿名密钥证明(ArkTS)](../../../密钥证明/匿名密钥证明(ArkTS)/huks-key-anon-attestation-arkts.md)
* [匿名密钥证明(C/C++)](../../../密钥证明/匿名密钥证明(CC++)/huks-key-anon-attestation-ndk.md)
* [签名/验签(ArkTS)](../../../密钥使用/签名验签/签名验签(ArkTS)/huks-signing-signature-verification-arkts.md)
* [签名/验签(C/C++)](../../../密钥使用/签名验签/签名验签(CC++)/huks-signing-signature-verification-ndk.md)
