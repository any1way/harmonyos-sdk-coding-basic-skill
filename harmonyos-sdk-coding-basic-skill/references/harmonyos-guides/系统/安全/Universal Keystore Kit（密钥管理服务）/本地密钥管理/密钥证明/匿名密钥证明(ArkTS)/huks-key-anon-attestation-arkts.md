...
scraped_at: 2026-06-01T11:18:17+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:e9f62b8a4f133c098a6af0cb967481b9a983a8cdba613dad2448bcdfe7b8fb19
---
在使用本功能时，需确保网络通畅。
...
2. 初始化参数集。
   ...
   [HuksOptions](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksoptions>)中的properties字段中的参数必须包含[HUKS\_TAG\_ATTESTATION\_CHALLENGE](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)属性,可选参数包含[HUKS\_TAG\_ATTESTATION\_ID\_VERSION\_INFO](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)，[HUKS\_TAG\_ATTESTATION\_ID\_ALIAS](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#hukstag>)属性。
3. 生成非对称密钥，具体请参考[密钥生成](../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)。
4. 将密钥别名与参数集作为参数传入[anonAttestKeyItem](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksanonattestkeyitem11>)方法中，即可证明密钥。
...
[AnonymousKeyProof.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/AnonymousKeyProof/entry/src/main/ets/pages/AnonymousKeyProof.ets#L15-L187)
