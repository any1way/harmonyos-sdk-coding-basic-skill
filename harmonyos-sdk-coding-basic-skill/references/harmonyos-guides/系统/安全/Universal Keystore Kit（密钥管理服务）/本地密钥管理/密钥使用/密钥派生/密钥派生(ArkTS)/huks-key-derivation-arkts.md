...
scraped_at: 2026-06-11T14:45:52+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:d415969126586d0c43c847a4bfe34f0e600d6ce0b9e884f3f0ebd8bd3c563ef5
---
以PBKDF2和HKDF256密钥为例，完成密钥派生。具体的场景介绍及支持的算法规格，请参考[密钥派生支持的算法](../密钥派生介绍及算法规格/huks-key-derivation-overview.md#支持的算法)。
...
3. 调用[generateKeyItem](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksgeneratekeyitem9>)生成密钥，具体请参考[密钥生成](../../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md)。
...
2. 调用[initSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksinitsession9>)初始化密钥会话，并获取会话的句柄handle。
3. 调用[updateSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksupdatesession9>)更新密钥会话。
4. 调用[finishSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksfinishsession9>)结束密钥会话，完成派生。

**删除密钥**

当密钥废弃不用时，需要调用[deleteKeyItem](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksdeletekeyitem9>)删除密钥，具体请参考[密钥删除](../../../密钥删除/密钥删除(ArkTS)/huks-delete-key-arkts.md)。
...
[HKDF.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/KeyUsage/KeyDerivation/entry/src/main/ets/pages/HKDF.ets#L17-L120)
...
[HKDF.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/KeyUsage/KeyDerivation/entry/src/main/ets/pages/HKDF.ets#L122-L330)
...
[PBKDF2.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/KeyUsage/KeyDerivation/entry/src/main/ets/pages/PBKDF2.ets#L15-L132)
...
[PBKDF2.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/KeyUsage/KeyDerivation/entry/src/main/ets/pages/PBKDF2.ets#L134-L341)
