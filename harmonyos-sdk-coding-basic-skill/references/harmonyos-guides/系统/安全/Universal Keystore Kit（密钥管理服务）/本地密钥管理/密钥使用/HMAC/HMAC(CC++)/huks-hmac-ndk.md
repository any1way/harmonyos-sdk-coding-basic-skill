...
scraped_at: 2026-06-01T11:18:10+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:668b512b518542772e91c54da336dd32a388912084e6a4956b4914aec71d8840
---
HMAC是密钥相关的哈希运算消息认证码（Hash-based Message Authentication Code）。具体的场景介绍及支持的算法规格，请参考[HMAC介绍及算法规格](../HMAC介绍及算法规格/huks-hmac-overview.md)。
...
2. 初始化密钥属性集。
3. 调用[OH\_Huks\_GenerateKeyItem](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_generatekeyitem>)生成密钥，HMAC支持的规格请参考[密钥生成支持的算法](../../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md#支持的算法)。

除此之外，开发者也可以参考[密钥导入](../../../密钥生成导入/密钥导入/密钥导入介绍及算法规格/huks-key-import-overview.md#支持的算法)的规格介绍，导入已有的密钥。
...
5. 调用[OH\_Huks\_FinishSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_finishsession>)结束密钥会话，获取哈希后的数据。
...
[napi\_init.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/KeyUsage/HMAC/entry/src/main/cpp/napi_init.cpp#L16-L95)
