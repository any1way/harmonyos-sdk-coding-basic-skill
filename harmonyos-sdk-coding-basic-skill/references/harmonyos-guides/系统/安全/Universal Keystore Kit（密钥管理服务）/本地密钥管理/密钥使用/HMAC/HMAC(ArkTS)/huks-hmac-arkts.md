...
scraped_at: 2026-06-01T11:18:09+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:b6e4e13560bc4c611c166aec5774c309e0ce92a05480e169e0c3708ceb276a7a
---
...
2. 初始化密钥属性集。
3. 调用[generateKeyItem](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksgeneratekeyitem9>)生成密钥，HMAC支持的规格请参考[密钥生成支持的算法](../../../密钥生成导入/密钥生成/密钥生成介绍及算法规格/huks-key-generation-overview.md#支持的算法)。
...
1. 获取密钥别名。
2. 获取待运算的数据。
3. 调用[initSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksinitsession9>)初始化密钥会话，并获取会话的句柄handle。
4. 调用[finishSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksfinishsession9>)结束密钥会话，获取哈希后的数据。
...
[HMAC.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/KeyUsage/HMAC/entry/src/main/ets/pages/HMAC.ets#L16-L103)
