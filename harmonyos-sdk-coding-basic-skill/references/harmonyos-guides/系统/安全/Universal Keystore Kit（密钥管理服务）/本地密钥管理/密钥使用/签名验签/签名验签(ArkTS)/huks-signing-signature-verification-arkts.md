...
scraped_at: 2026-06-01T11:17:57+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:0ac7925a41f0f8ebb76dad8e3f4e20d2bd02d554aeb2ca9bddece74aed8358db
---
...
具体的场景介绍及支持的算法规格，请参考[签名/验签支持的算法](../签名验签介绍及算法规格/huks-signing-signature-verification-overview.md#支持的算法)。
...
1. 获取密钥别名。
2. 指定待签名的明文数据。
3. 获取属性参数[HuksOptions](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksoptions>)，包括两个字段properties和inData。inData传入明文数据，properties使用[HuksParam](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksparam>)设置算法参数配置。
...
5. 调用[finishSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksfinishsession9>)结束密钥会话，获取签名signature。

**验签**

1. 获取密钥别名。
2. 获取待验证的签名signature。
3. 获取属性参数[HuksOptions](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksoptions>)，包括两个字段properties和inData。inData传入签名signature，properties使用[HuksParam](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksparam>)设置算法参数配置。
4. 调用[initSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksinitsession9>)初始化密钥会话，并获取会话的句柄handle。
5. 调用[updateSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksupdatesession9>)更新密钥会话。
6. 调用[finishSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksfinishsession9>)结束密钥会话，验证签名。
...
[ECC256SHA256.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/KeyUsage/SigningVerification/entry/src/main/ets/pages/ECC256SHA256.ets#L16-L181)
...
[SM2SM3.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/KeyUsage/SigningVerification/entry/src/main/ets/pages/SM2SM3.ets#L16-L181)
...
[SM2NoDigest.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/KeyUsage/SigningVerification/entry/src/main/ets/pages/SM2NoDigest.ets#L16-L184)
...
[RSASHA256PSS.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/KeyUsage/SigningVerification/entry/src/main/ets/pages/RSASHA256PSS.ets#L16-L191)
...
[RSASHA256PKCS1\_V1\_5.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/KeyUsage/SigningVerification/entry/src/main/ets/pages/RSASHA256PKCS1_V1_5.ets#L16-L183)
...
[RSA2048SHA384PSS.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/UniversalKeystoreKit/KeyUsage/SigningVerification/entry/src/main/ets/pages/RSA2048SHA384PSS.ets#L16-L190)

### ECC/SHA256/携带认证信息的签名类型

前提条件：此功能的示例代码依赖数字盾服务的设置数字盾密码和验证数字盾密码，请参考[数字盾服务](<../../../../../Device Security Kit（设备安全服务）/数字盾服务/devicesecurity-trustedauth-service.md>)的数字盾密码管理和交易信息密码认证。
