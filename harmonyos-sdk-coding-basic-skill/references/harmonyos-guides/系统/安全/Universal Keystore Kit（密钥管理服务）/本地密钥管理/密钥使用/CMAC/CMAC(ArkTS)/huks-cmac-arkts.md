...
content_hash: sha256:746e8949821b500f217ef768743f3535f2c50ef64e44aa26a3cbe0fd59cd3eed
---
...
1. 获取生成密钥算法参数配置。
2. 调用[generateKeyItem](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksgeneratekeyitem9>)生成密钥，支持的规格是128比特长度的密钥。
...
3. 调用[finishSession](<../../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksfinishsession9>)结束密钥会话，获取MAC数据。
