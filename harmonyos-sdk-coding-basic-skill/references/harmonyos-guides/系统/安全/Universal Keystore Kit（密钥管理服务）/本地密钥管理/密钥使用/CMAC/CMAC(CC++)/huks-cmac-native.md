...
scraped_at: 2026-06-01T11:18:12+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:667f65490185d2efc22c463bf8efc33b1c4030a3cdc8907d1953a5878e00ec5d
---
...
1. 获取生成密钥算法参数配置。
2. 调用[OH\_Huks\_GenerateKeyItem](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_generatekeyitem>)生成密钥，支持的规格是128比特长度的密钥。

除此之外，开发者也可以参考[密钥导入](../../../密钥生成导入/密钥导入/密钥导入介绍及算法规格/huks-key-import-overview.md#支持的算法)的规格介绍，导入已有的密钥。

**执行CMAC**

1. 调用[OH\_Huks\_InitParamSet](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_param.h/capi-native-huks-param-h.md#oh_huks_initparamset>)获取算法参数配置。
2. 调用[OH\_Huks\_InitSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_initsession>)和[OH\_Huks\_FinishSession](<../../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_finishsession>)计算MAC值。
