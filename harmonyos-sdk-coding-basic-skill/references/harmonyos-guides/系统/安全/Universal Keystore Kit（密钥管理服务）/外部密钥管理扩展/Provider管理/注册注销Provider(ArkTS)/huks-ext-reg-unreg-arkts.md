...
scraped_at: 2026-06-11T14:46:40+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:9235c1738cd134d253f20d21f5c76ae1be5b273be343c10d1eb611abd6cb67e3
---
...
1. 构造注册参数，需要传入[HUKS\_EXT\_CRYPTO\_TAG\_ABILITY\_NAME](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptotag>)。
2. 调用注册接口[registerProvider](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptoregisterprovider>)。
...
1. 构造注销参数，注销单个ability需要传入[HUKS\_EXT\_CRYPTO\_TAG\_ABILITY\_NAME](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptotag>)参数。批量注销不需要传入[HUKS\_EXT\_CRYPTO\_TAG\_ABILITY\_NAME](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptotag>)参数。
2. 调用注销接口[unregisterProvider](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptounregisterprovider>)。
