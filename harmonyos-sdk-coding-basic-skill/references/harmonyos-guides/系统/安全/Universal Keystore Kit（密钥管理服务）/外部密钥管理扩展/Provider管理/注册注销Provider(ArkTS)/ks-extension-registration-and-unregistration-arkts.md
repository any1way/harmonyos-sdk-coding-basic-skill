...
1. 构造注册参数，需要传入[HUKS\_EXT\_CRYPTO\_TAG\_ABILITY\_NAME](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptotag>)。
2. 调用注册接口[registerProvider](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptoregisterprovider>)。
...
1. 构造注销参数，注销单个ability需要传入[HUKS\_EXT\_CRYPTO\_TAG\_ABILITY\_NAME](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptotag>)参数。批量注销不需要传入[HUKS\_EXT\_CRYPTO\_TAG\_ABILITY\_NAME](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptotag>)参数。
2. 调用注销接口[unregisterProvider](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptounregisterprovider>)。
