...
content_hash: sha256:bf614d78c3cc643130c7eeb7fdb98617a63d635a3c778ac3345f2915e8faa62b
---
## 打开资源

从API 22开始，huksExternalCrypto提供打开/关闭资源功能接口。应用在密钥操作之前（密钥操作、通用操作、PIN码认证等），需要先调用[OH\_Huks\_OpenResource](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_openresource>)打开资源。打开资源需要获取resourceId，resourceId通过调用证书管理系统能力提供的[证书选择接口](<../../../../../../../harmonyos-references/安全/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.certManagerDialog (证书管理对话框模块)/js-apis-certmanagerdialog.md#certificatemanagerdialogopenauthorizedialog22>)获取。
...
2. 初始化参数集：通过[OH\_Huks\_InitExternalCryptoParamSet](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_initexternalcryptoparamset>)、[OH\_Huks\_AddExternalCryptoParams](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_addexternalcryptoparams>)、[OH\_Huks\_BuildExternalCryptoParamSet](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_buildexternalcryptoparamset>)构造参数集paramSet。
3. 调用[OH\_Huks\_OpenResource](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_openresource>)打开资源。
...
生态应用调用证书HAP界面，展示证书列表，用户选择证书，生态应用拿到对应的resourceId，关闭资源依赖于对应的resourceId。具体的场景介绍及规格，请参考[资源管理介绍及规格](../资源管理介绍及规格/huks-resource-management-overview.md)。
...
1. 通过证书管理系统能力提供的[证书选择接口](<../../../../../../../harmonyos-references/安全/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.certManagerDialog (证书管理对话框模块)/js-apis-certmanagerdialog.md#certificatemanagerdialogopenauthorizedialog22>)获取resourceId。
2. 初始化参数集：通过[OH\_Huks\_InitExternalCryptoParamSet](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_initexternalcryptoparamset>)、[OH\_Huks\_AddExternalCryptoParams](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_addexternalcryptoparams>)、[OH\_Huks\_BuildExternalCryptoParamSet](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_buildexternalcryptoparamset>)构造参数集paramSet。
3. 调用[OH\_Huks\_CloseResource](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_closeresource>)关闭资源。该接口会回调[onClearUkeyPinAuthState](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.CryptoExtensionAbility (密钥扩展能力)/js-apis-cryptoextensionability.md#cryptoextensionabilityonclearukeypinauthstate>)清理该资源关联的PIN认证状态，以及会回调[onFinishSession](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.CryptoExtensionAbility (密钥扩展能力)/js-apis-cryptoextensionability.md#cryptoextensionabilityonfinishsession>)清理该资源关联的会话handle。
