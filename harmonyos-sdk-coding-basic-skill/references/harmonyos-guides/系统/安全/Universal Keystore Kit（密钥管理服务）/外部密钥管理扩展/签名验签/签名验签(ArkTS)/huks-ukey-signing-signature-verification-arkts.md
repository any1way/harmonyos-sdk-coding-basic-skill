...
content_hash: sha256:cbb359ccc61e8b2db5654a3689de924971843b4f2b80c767dc6b799aaed63fe2
---
...
2. 指定待签名的明文数据。
3. 获取属性参数[HuksOptions](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksoptions>)，包括两个字段properties和inData。inData传入明文数据，properties传入算法参数配置。
...
2. 获取待验证的签名。
3. 获取属性参数[HuksOptions](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksoptions>)，包括两个字段properties和inData。inData传入签名signature，properties传入算法参数配置。
4. 调用[initSession](<../../../../../../../harmonyos-references/安全/Universal Keystore Kit（密钥管理服务）/ArkTS API/@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksinitsession9>)初始化密钥会话，并获取会话的句柄handle。
