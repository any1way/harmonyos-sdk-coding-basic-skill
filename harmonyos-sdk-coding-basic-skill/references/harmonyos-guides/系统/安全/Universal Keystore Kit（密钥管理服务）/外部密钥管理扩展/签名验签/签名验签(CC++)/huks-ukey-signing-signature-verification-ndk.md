...
scraped_at: 2026-06-01T11:18:56+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:8e1f411224b842886b8b9630162db95d0331bd477be1876b30b907898fe7871e
---
...
具体的场景介绍及支持的算法规格，请参考[签名/验签介绍及算法规格](../签名验签介绍及算法规格/huks-ukey-signing-signature-verification-overview.md)。
...
1. 通过证书管理系统能力提供的[证书选择接口](<../../../../../../../harmonyos-references/安全/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.certManagerDialog (证书管理对话框模块)/js-apis-certmanagerdialog.md#certificatemanagerdialogopenauthorizedialog22>)获取[keyUri](<../../../../../../../harmonyos-references/安全/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.certManagerDialog (证书管理对话框模块)/js-apis-certmanagerdialog.md#certreference22>)作为resourceId，并作为密钥别名，然后[打开资源](../../资源管理/打开资源关闭资源(CC++)/huks-open-close-resource-ndk.md#打开资源)。
2. 获取待验证的签名。
3. 调用[OH\_Huks\_InitParamSet](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_param.h/capi-native-huks-param-h.md#oh_huks_initparamset>)指定算法参数配置，并指定KeyClass参数，tag为[OH\_HUKS\_TAG\_KEY\_CLASS](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_tag>)，值为[OH\_HUKS\_KEY\_CLASS\_EXTENSION](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_type.h/capi-native-huks-type-h.md#oh_huks_keyclasstype>)。
4. 调用[OH\_Huks\_InitSession](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_api.h/capi-native-huks-api-h.md#oh_huks_initsession>)初始化密钥会话，并获取会话的句柄handle。
