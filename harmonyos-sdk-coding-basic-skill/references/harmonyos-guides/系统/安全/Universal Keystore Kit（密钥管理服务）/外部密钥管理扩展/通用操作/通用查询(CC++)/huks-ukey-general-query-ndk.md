...
scraped_at: 2026-06-01T11:19:00+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:c45df913c7dd23186e877555da15dece223010ddb08c6d96aeae75486f13af62
---
从API 22开始，huksExternalCrypto提供通用查询功能接口。从Ukey获取通用属性信息，完成属性查询操作。具体的场景介绍请参考[获取属性介绍及规格](../通用查询介绍及规格/huks-ukey-general-query-overview.md)。
...
1. 构造resourceId和propertyId，先调用[OH\_Huks\_OpenResource](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_openresource>)打开资源。
...
3. 调用[OH\_Huks\_GetProperty](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_getproperty>)获取属性信息。
4. 调用[OH\_Huks\_GetExternalCryptoParam](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_getexternalcryptoparam>)从输出参数集中提取结果。
5. 调用[OH\_Huks\_FreeExternalCryptoParamSet](<../../../../../../../harmonyos-references/Universal Keystore Kit（密钥管理服务）/C API/头文件/native_huks_external_crypto_api.h/capi-native-huks-external-crypto-api-h.md#oh_huks_freeexternalcryptoparamset>)释放参数集资源。
