...
scraped_at: 2026-06-01T11:15:42+08:00
doc_updated_at: 2026-03-23
content_hash: sha256:5be6b2a76fd08ced1a20cf368ab2452e894feb575c9e3325941a834a1f2c0e47
---
## 介绍
...
1. 配置[DocumentSelectOptions](<../../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.picker (选择器)/js-apis-file-picker.md#documentselectoptions>)参数，在文件Picker底部显示“加密分享”按钮。
2. 通过[DocumentViewPicker](<../../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.picker (选择器)/js-apis-file-picker.md#documentviewpicker>)获取文件URI。
...
2. 构造[want](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>)参数。
3. 通过[startAbility](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#startability-2>)将[want](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>)参数传入，使用系统统一打开能力进行打开。
