...
content_hash: sha256:bc744d27c326ad6b8997a7f5d9a998f3735d3008b2ae31df9d88dffc89dbb8cc
---
## 场景介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/JY--s7xlT0KDYcuJacBzhQ/zh-cn_image_0000002622698389.png?HW-CC-KV=V1&HW-CC-Date=20260611T064519Z&HW-CC-Expire=86400&HW-CC-Sign=7B1D744ECCEB80893AB2E3720554B7CF244940D926F9900F1CFA15BD0825182C)
...
| 接口名 | 描述 |
| --- | --- |
| [discover](<../../../../../harmonyos-references/Online Authentication Kit（在线认证服务）/ArkTS API/FIDO/onlineauthentication-fido-api.md#discover>)(context: common.Context): Promise<[DiscoveryData](<../../../../../harmonyos-references/Online Authentication Kit（在线认证服务）/ArkTS API/FIDO/onlineauthentication-fido-api.md#discoverydata>)> | 发现设备的认证能力，返回当前设备软件支持的认证器数据。 |
| [checkPolicy](<../../../../../harmonyos-references/Online Authentication Kit（在线认证服务）/ArkTS API/FIDO/onlineauthentication-fido-api.md#checkpolicy>)(context: common.Context, uafRequest: [UAFMessage](<../../../../../harmonyos-references/Online Authentication Kit（在线认证服务）/ArkTS API/FIDO/onlineauthentication-fido-api.md#uafmessage>)): Promise<void> | 检测用户策略的开启状态。 |
| [processUAFOperation](<../../../../../harmonyos-references/Online Authentication Kit（在线认证服务）/ArkTS API/FIDO/onlineauthentication-fido-api.md#processuafoperation>)(context: common.Context, uafRequest: [UAFMessage](<../../../../../harmonyos-references/Online Authentication Kit（在线认证服务）/ArkTS API/FIDO/onlineauthentication-fido-api.md#uafmessage>), channelBindings?: [ChannelBinding](<../../../../../harmonyos-references/Online Authentication Kit（在线认证服务）/ArkTS API/FIDO/onlineauthentication-fido-api.md#channelbinding>)): Promise<[UAFMessage](<../../../../../harmonyos-references/Online Authentication Kit（在线认证服务）/ArkTS API/FIDO/onlineauthentication-fido-api.md#uafmessage>)> | 用户UAF操作接口，处理UAF协议消息。 |
| [notifyUAFResult](<../../../../../harmonyos-references/Online Authentication Kit（在线认证服务）/ArkTS API/FIDO/onlineauthentication-fido-api.md#notifyuafresult>)(context: common.Context, uafResponse: [UAFMessage](<../../../../../harmonyos-references/Online Authentication Kit（在线认证服务）/ArkTS API/FIDO/onlineauthentication-fido-api.md#uafmessage>)): Promise<void> | 开通结果通知接口。 |
...
3. 开通FIDO免密身份认证。
   ...
   5. 调用notifyUAFResult进行注册结果通知。
      ...
      ```
      1. try {
      2. // 调用notifyUAFResult进行结果通知
      3. await fido.notifyUAFResult(this.uiContext, uafMessage).then(() => {
