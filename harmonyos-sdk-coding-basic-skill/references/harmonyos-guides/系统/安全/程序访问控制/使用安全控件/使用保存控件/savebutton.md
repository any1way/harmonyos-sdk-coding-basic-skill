...
scraped_at: 2026-06-11T14:40:15+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:7df2f5bb78fb226977778dfb3119ec64017ccae7806ced9e220525b9232409a2
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/0wimRmHARAONAFtt9XRDKw/zh-cn_image_0000002622698341.png?HW-CC-KV=V1&HW-CC-Date=20260611T064014Z&HW-CC-Expire=86400&HW-CC-Sign=10F580C26FEDC02FCD2E7D5C08EAD4C03AA9E9132940323AE0597EB5168967BE)
...
* 保存控件仅支持在[应用主窗口和子窗口](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Enums/arkts-apis-window-e.md#windowtype7>)中使用，且不支持在[UIExtension](<../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.uiExtension (uiExtension)/js-apis-arkui-uiextension.md>)中使用。
* 用户点击一次控件，仅获取一次授权调用。
...
* 当开发者需要自定义保存控件的图标和文本时，需要向应用市场申请ohos.permission.CUSTOMIZE\_SAVE\_BUTTON权限。
  ...
  ohos.permission.CUSTOMIZE\_SAVE\_BUTTON受限开放，仅默认样式无法满足业务场景时可申请，申请方式请参考[申请使用受限权限](../../应用权限管控/申请应用权限/申请受限权限/declare-permissions-in-acl.md)。
...
2. 设置图片资源并添加保存控件。
   ...
   保存控件是由图标、文本和背景组成的类似按钮的安全控件。其中，背景是必选的，图标和文本至少选择一个。图标和文本可以从已有的选项中选择，也可以通过[setIcon](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/SaveButton/ts-security-components-savebutton.md#seticon20)和[setText](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/SaveButton/ts-security-components-savebutton.md#settext20)自定义。在声明安全控件的接口时，有传参和不传参两种方式。不传参将默认创建一个包含图标、文本和背景的按钮；传参则根据参数创建，不包含未配置的元素。

   当前示例使用默认参数。具体请参见[SaveButton控件](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/SaveButton/ts-security-components-savebutton.md)。此外，所有安全控件都继承了[安全控件通用属性](../../../../../../harmonyos-references/ArkUI（方舟UI框架）/ArkTS组件/安全控件通用属性/ts-securitycomponent-attributes.md)，可用于定制样式。

   有关将图片保存到媒体库的详细信息，请参考[保存媒体库资源](<../../../../../媒体/Media Library Kit（媒体文件管理服务）/保存媒体库资源/photoaccesshelper-savebutton.md>)。
   ...
   [Save.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Security/SecurityComponent/entry/src/main/ets/securitycomponent/pages/Save.ets#L16-L73)
