...
scraped_at: 2026-06-11T14:50:54+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:a1be120eed8ccba597636df30aa4f6fbe2311655b78ce65af6c1e0710308c512
---
应用在使用Car Kit能力前，开发者需要完成的配置：配置编译模式、配置权限、配置能力。

## 配置编译模式

在打包应用时，请在DevEco Studio中，点击右上角![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/ul8bAneTT4GoHyzrl_V2QA/zh-cn_image_0000002622858335.png?HW-CC-KV=V1&HW-CC-Date=20260611T065053Z&HW-CC-Expire=86400&HW-CC-Sign=8CEFF3EE86A36D07AE3C8C02BCA480028C05A11B680B6287D172AED40C38D0BA)图标，将编译模式修改为“release”，然后点击右下角的“Apply”即可。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/ey-Cj5w5TUWXzQJMDLK_yQ/zh-cn_image_0000002622698457.png?HW-CC-KV=V1&HW-CC-Date=20260611T065053Z&HW-CC-Expire=86400&HW-CC-Sign=56597C8CEF25263182F84100FB085D9AF18B14BD212CDEDE6C92ECFE0DDD1A13)
...
1. 在[skills](../../../../基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#skills标签)中配置导航信息服务的actions。
...
* name取值为hiCarCapability时，代表适配了HiCar的能力。对应的value值根据不同的业务场景取值如下：
  ...
  关于指令的更多详情请查阅[CommandType](<../../../../../harmonyos-references/Car Kit（车服务）/ArkTS API/navigationInfoMgr（导航信息管理）/car-navigationinfomgr.md#commandtype>)。
