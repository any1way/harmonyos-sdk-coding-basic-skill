...
scraped_at: 2026-06-11T14:51:51+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:30b1d76af4beb20d1b0efff5e2b8aa406482a8641c8fcb7c3e06510604917a5c
---
...
机械体设备控制器API的接口使用指导请参见[@ohos.distributedHardware.mechanicManager (机械体控制模块)](<../../../../../harmonyos-references/Mechanic Kit（机械设备管理服务）/ArkTS API/@ohos.distributedHardware.mechanicManager (机械体控制模块)/js-apis-mechanicmanager.md>)。
...
3. 请将SDK更新到API 20或以上版本，具体操作参见[更新指南](<../../../../开发环境搭建/下载与安装DevEco Studio/ide-software-install.md>)。
...
1. 导入机械体设备管理模块。
   ...
   [ApiTestPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MechanicKit/MechanicManagerSample/entry/src/main/ets/pages/ApiTestPage.ets#L16-L18)
2. 获取已连接的机械体列表。
   ...
   [ApiTestPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MechanicKit/MechanicManagerSample/entry/src/main/ets/pages/ApiTestPage.ets#L179-L204)
3. 监听设备的连接状态变化，以便及时响应。
   ...
   [AttachStateChangeCallbackRegister.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MechanicKit/MechanicManagerSample/entry/src/main/ets/pages/AttachStateChangeCallbackRegister.ets#L72-L87)
4. 处理设备的连接与断开的事件。
   ...
   [AttachStateChangeCallbackRegister.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MechanicKit/MechanicManagerSample/entry/src/main/ets/pages/AttachStateChangeCallbackRegister.ets#L22-L34)
5. 取消连接状态的监听。
   ...
   [AttachStateChangeCallbackRegister.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MechanicKit/MechanicManagerSample/entry/src/main/ets/pages/AttachStateChangeCallbackRegister.ets#L108-L111)
...
1. 启用摄像头的目标拍摄功能。
   ...
   [ApiTestPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MechanicKit/MechanicManagerSample/entry/src/main/ets/pages/ApiTestPage.ets#L330-L346)
2. 监听相机跟踪状态的变化。
   ...
   [ApiTestPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MechanicKit/MechanicManagerSample/entry/src/main/ets/pages/ApiTestPage.ets#L400-L420)
3. 处理跟踪状态变化事件。
   ...
   [ApiTestPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MechanicKit/MechanicManagerSample/entry/src/main/ets/pages/ApiTestPage.ets#L25-L60)
4. 取消跟踪状态变化的监听。
   ...
   [ApiTestPage.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/MechanicKit/MechanicManagerSample/entry/src/main/ets/pages/ApiTestPage.ets#L445-L451)
