...
scraped_at: 2026-06-11T14:51:45+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:b564d548f1d22277d0d9d57a692bf69386e4e1149494123fc76e10ca1602934a
---
## 场景介绍

当设备需要获取传感器数据时，可以使用sensor模块，例如：通过订阅方向传感器数据感知用户设备当前的朝向，通过订阅计步传感器数据统计用户的步数等。

详细的接口介绍请参考[Sensor](<../../../../../../harmonyos-references/Sensor Service Kit（传感器服务）/C API/模块/Sensor/capi-sensor.md>)。
...
| OH\_Sensor\_CreateInfos(uint32\_t count) | 用给定的数字创建一个实例数组，请参考[Sensor\_Info](<../../../../../../harmonyos-references/Sensor Service Kit（传感器服务）/C API/结构体/Sensor_Info/capi-sensor-sensor-info.md>)。 |
| OH\_Sensor\_DestroyInfos(Sensor\_Info \*\*sensors, uint32\_t count) | 销毁实例数组并回收内存，请参考[Sensor\_Info](<../../../../../../harmonyos-references/Sensor Service Kit（传感器服务）/C API/结构体/Sensor_Info/capi-sensor-sensor-info.md>)。 |
...
1. 新建一个Native C++工程。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/yzSgFdMRQa6GZl3mFHTubg/zh-cn_image_0000002592378844.png?HW-CC-KV=V1&HW-CC-Date=20260611T065143Z&HW-CC-Expire=86400&HW-CC-Sign=AEE13461A845B9B3BAF2225C7692B81A10FDEC4EE725594FC810370DD64FA361)
2. 配置加速度传感器权限，具体配置方式请参考[声明权限](../../../../安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)。
   ...
   [module.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Sensor/SensorCapiSamples/entry/src/main/module.json5#L65-L71)
...
4. 在oh\_sensor\_capi.cpp文件中编码，首先导入模块。
   ...
   [oh\_sensor\_capi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Sensor/SensorCapiSamples/entry/src/main/cpp/oh_sensor_capi.cpp#L16-L21)
5. 定义常量。
   ...
   [oh\_sensor\_capi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Sensor/SensorCapiSamples/entry/src/main/cpp/oh_sensor_capi.cpp#L23-L33)
6. 定义一个回调函数用来接收传感器数据。
   ...
   [oh\_sensor\_capi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Sensor/SensorCapiSamples/entry/src/main/cpp/oh_sensor_capi.cpp#L35-L82)
7. 获取设备上所有传感器的信息。
   ...
   [oh\_sensor\_capi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Sensor/SensorCapiSamples/entry/src/main/cpp/oh_sensor_capi.cpp#L84-L171)
8. 订阅和取消订阅传感器数据。
   ...
   [oh\_sensor\_capi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Sensor/SensorCapiSamples/entry/src/main/cpp/oh_sensor_capi.cpp#L173-L232)
9. 在Init函数中补充接口。
   ...
   [oh\_sensor\_capi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Sensor/SensorCapiSamples/entry/src/main/cpp/oh_sensor_capi.cpp#L234-L246)
10. 在types/libentry路径下index.d.ts文件中引入Napi接口。
    ...
    [Index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Sensor/SensorCapiSamples/entry/src/main/cpp/types/libentry/Index.d.ts#L16-L19)
11. 编写程序入口调用代码。
    ...
    [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Sensor/SensorCapiSamples/entry/src/main/ets/pages/Index.ets#L16-L71)
