...
scraped_at: 2026-06-11T14:51:49+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:4b2895b3b9cf7e8dbd8d2606a5b9a83292fd3b0c4daadf59dc5ddccb99d4e16c
---
## 场景介绍

当设备需要设置不同的振动效果时，可以调用Vibrator模块，例如：设备的按键可以设置不同强度和不同时长的振动，闹钟和来电可以设置不同强度和时长的单次或周期振动。

详细的接口介绍请参考[Vibrator](<../../../../../../harmonyos-references/Sensor Service Kit（传感器服务）/C API/模块/Vibrator/capi-vibrator.md>)。
...
1. 新建一个Native C++工程。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/WfOEm9MjRKmRqchT6KIPYA/zh-cn_image_0000002592218912.png?HW-CC-KV=V1&HW-CC-Date=20260611T065147Z&HW-CC-Expire=86400&HW-CC-Sign=BB5C5846D61666A7F9249044017A562641687062DFDC9A9EF03F18FF44C30BF4)
2. 控制设备上的振动器，需要申请权限ohos.permission.VIBRATE。具体配置方式请参考[声明权限](../../../../安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)。
   ...
   [module.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorCapiSamples/entry/src/main/module.json5#L64-L70)
...
4. 导入模块。
   ...
   [oh\_vibrator\_capi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorCapiSamples/entry/src/main/cpp/oh_vibrator_capi.cpp#L16-L25)
5. 定义常量。
   ...
   [oh\_vibrator\_capi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorCapiSamples/entry/src/main/cpp/oh_vibrator_capi.cpp#L27-L31)
6. 控制马达在指定时间内持续振动和停止马达振动。
   ...
   [oh\_vibrator\_capi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorCapiSamples/entry/src/main/cpp/oh_vibrator_capi.cpp#L33-L54)
7. 播放自定义振动序列。
   ...
   [oh\_vibrator\_capi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorCapiSamples/entry/src/main/cpp/oh_vibrator_capi.cpp#L56-L105)
8. 在Init函数中补充接口。
   ...
   [oh\_vibrator\_capi.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorCapiSamples/entry/src/main/cpp/oh_vibrator_capi.cpp#L107-L119)
9. 在types/libentry路径下index.d.ts文件中引入Napi接口。
   ...
   [Index.d.ts](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorCapiSamples/entry/src/main/cpp/types/libentry/Index.d.ts#L16-L19)
10. 编写程序入口调用代码。
    ...
    [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorCapiSamples/entry/src/main/ets/pages/Index.ets#L16-L73)
