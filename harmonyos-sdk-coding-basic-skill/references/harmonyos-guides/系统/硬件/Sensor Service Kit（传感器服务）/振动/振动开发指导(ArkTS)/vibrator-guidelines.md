...
scraped_at: 2026-06-11T14:51:47+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:dcfb1403db28c0fe4c52ed67c072cd9233c6560e4d47f4edb39e7a720acd1e95
---
## 场景介绍

当设备需要设置不同的振动效果时，可以调用Vibrator模块，例如：设备的按键可以设置不同强度和不同时长的振动，闹钟和来电可以设置不同强度和时长的单次或周期振动。

详细的接口介绍请参考[@ohos.vibrator (振动)](<../../../../../../harmonyos-references/Sensor Service Kit（传感器服务）/ArkTS API/@ohos.vibrator (振动)/js-apis-vibrator.md>)。
...
| 名称 | 说明 |
| --- | --- |
| 固定时长振动 | 传入一个固定时长，马达按照默认强度和频率触发振动，振动效果描述请参考[VibrateTime](<../../../../../../harmonyos-references/Sensor Service Kit（传感器服务）/ArkTS API/@ohos.vibrator (振动)/js-apis-vibrator.md#vibratetime9>)。 |
| 预置振动 | 系统中的[EffectId](<../../../../../../harmonyos-references/Sensor Service Kit（传感器服务）/ArkTS API/@ohos.vibrator (振动)/js-apis-vibrator.md#effectid>)，这些效果适用于某些固定场景，比如效果"haptic.clock.timer"通常用于用户调整计时器时的振感反馈，振动效果描述请参考[VibratePreset](<../../../../../../harmonyos-references/Sensor Service Kit（传感器服务）/ArkTS API/@ohos.vibrator (振动)/js-apis-vibrator.md#vibratepreset9>)。 |
| 自定义振动 | 自定义振动提供给用户设计自己所需振动效果的能力，用户可通过自定义振动配置文件，并遵循相应规则编排所需振动形式，使能更加开放的振感交互体验，效果描述请参考[VibrateFromFile](<../../../../../../harmonyos-references/Sensor Service Kit（传感器服务）/ArkTS API/@ohos.vibrator (振动)/js-apis-vibrator.md#vibratefromfile10>)。 |
...
1. 新建一个工程。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1a/v3/uViXheuNRK24MzXrgw1hVA/zh-cn_image_0000002622698473.png?HW-CC-KV=V1&HW-CC-Date=20260611T065146Z&HW-CC-Expire=86400&HW-CC-Sign=A20EF60DD77613A81FF0F5B83FEC6C55B179F11DAFE4008139AF50CAB9DA9A6A)
2. 配置权限，具体配置方式请参考[声明权限](../../../../安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)。
   ...
   [module.json5](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/module.json5#L25-L31)
3. 导入模块。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L15-L20)
4. 定义常量。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L22-L25)
5. 振动器查询。
   ...
   **情形一** 查询所有马达信息：
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L504-L515)
   ...
   **情形二** 查询指定设备的一个或多个马达信息：
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L523-L537)
6. 根据指定振动效果和振动属性触发马达振动。
   ...
   **情形一** 按照指定持续时间触发马达振动：
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L281-L301)
   ...
   **情形二** 按照预置振动效果触发马达振动，可先查询振动效果是否被支持，再调用振动接口：
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L238-L273)
   ...
   **情形三** 按照自定义振动配置文件触发马达振动：
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L204-L231)
   ...
   **情形四** Pattern类型的马达振动：
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L308-L343)
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L350-L399)
7. 停止马达的振动。
   ...
   **方式一** 按照指定模式停止对应的马达振动，自定义振动不支持此类停止方式：
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L406-L420)
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L421-L435)
   ...
   **方式二** 停止所有模式的马达振动，包括自定义振动：
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L436-L450)
   ...
   **方式三** 停止指定设备的振动：
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L451-L465)
8. 动态马达状态变化监听。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L90-L480)
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L89-L497)
9. 通过设备ID和马达ID获取预置振动效果信息。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L545-L556)
10. 查询是否支持高清振动。
    ...
    [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Vibrator/VibratorJsSamples/entry/src/main/ets/pages/Index.ets#L563-L575)
