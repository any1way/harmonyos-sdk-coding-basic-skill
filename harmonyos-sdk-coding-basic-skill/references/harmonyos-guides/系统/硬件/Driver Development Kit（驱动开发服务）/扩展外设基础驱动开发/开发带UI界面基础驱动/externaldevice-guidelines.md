...
scraped_at: 2026-06-01T11:23:29+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:524ae750f5d6d216702002b60c74329b3faae396ed89de7fe47fbe4e3d23bbc2
---
## 场景介绍
...
扩展外设管理基本能力如下，更多详情请查阅[@ohos.driver.deviceManager](<../../../../../../harmonyos-references/硬件/Driver Development Kit（驱动开发服务）/ArkTS API/@ohos.driver.deviceManager (外设管理)/js-apis-driver-devicemanager.md>)。
...
1. 创建新工程，请参考[创建一个新的工程](../../../../../开发环境搭建/工程创建/创建一个新的工程/ide-create-new-project.md)，创建一个HarmonyOS工程。
...
2. 在文件中导入相关Kit，并声明想要绑定的USB设备的productId、vendorId以及与驱动通信的Code。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/DriverDemo/entry/src/main/ets/pages/Index.ets#L16-L26)
3. 定义message变量和远程对象变量，后续与驱动通信使用。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/DriverDemo/entry/src/main/ets/pages/Index.ets#L31-L34)
4. 定义查询设备接口，通过queryDevices获取目标设备ID。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/DriverDemo/entry/src/main/ets/pages/Index.ets#L36-L57)
5. 定义获取对应驱动远程对象的接口，通过bindDeviceDriver获取远程对象。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/DriverDemo/entry/src/main/ets/pages/Index.ets#L59-L72)
6. 定义与远程对象通信接口，通过sendMessageRequest与远程对象进行IPC通信。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/DriverDemo/entry/src/main/ets/pages/Index.ets#L74-L105)
7. 渲染UI界面，更多UI界面开发请参考[UI开发](<../../../../../应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/arkts-ui-development.md>)。
   ...
   [Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/DriverDemo/entry/src/main/ets/pages/Index.ets#L107-L123)
8. 接下来请参考[开发无UI界面基础驱动](../开发无UI界面基础驱动/driverextensionability.md)，进行对应驱动的示例代码开发。
