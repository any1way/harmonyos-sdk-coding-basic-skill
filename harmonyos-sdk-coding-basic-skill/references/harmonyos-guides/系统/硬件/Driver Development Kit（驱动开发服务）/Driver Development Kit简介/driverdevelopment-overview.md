...
content_hash: sha256:accdf2112d5ee7a8745c26fa387ec6edb9c7ba12cc8d98170b5e4ee5c675a489
---
...
* 扩展外设驱动客户端：查询驱动并绑定驱动，自定义驱动与设备之间的通信方式以及数据处理方式等，即[带UI界面基础驱动](../扩展外设基础驱动开发/开发带UI界面基础驱动/externaldevice-guidelines.md)。
* 扩展外设驱动：基于DDK能力开发的专业专用扩展外设驱动或扩展外设增强驱动，即[无UI界面基础驱动](../扩展外设基础驱动开发/开发无UI界面基础驱动/driverextensionability.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/QOjvwulIS82NuMfQn9QcxA/zh-cn_image_0000002622858341.png?HW-CC-KV=V1&HW-CC-Date=20260611T065102Z&HW-CC-Expire=86400&HW-CC-Sign=14AB21B056AD8B1DD003FC7DD834C4EADA4E6E7A90AB819DEFB1B4744540AC59)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a/v3/vujLKBokQMiFsOupBQPSmA/zh-cn_image_0000002622698463.png?HW-CC-KV=V1&HW-CC-Date=20260611T065102Z&HW-CC-Expire=86400&HW-CC-Sign=6C08D67DB51677AE063CC946B2AE82ACBF2F100B621AB9E3CFA6FF65D6E1DDB5)

用户使用扩展外设驱动客户端时，扩展外设驱动客户端与扩展外设驱动的绑定流程如图3所示。

**图3** 扩展外设驱动客户端与扩展外设驱动绑定的时序图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/KL_fXsQcRJC7G6pq6WZmvw/zh-cn_image_0000002592218902.png?HW-CC-KV=V1&HW-CC-Date=20260611T065102Z&HW-CC-Expire=86400&HW-CC-Sign=8CB5557696FDE5F84592B20F9020481A7A5833C6AE0CE48DC8251C3622DDD176)
...
| 名称 | 作用 |
| --- | --- |
| PerformanceAnalysisKit | 引入[hilog](<../../../../../harmonyos-references/Performance Analysis Kit（性能分析服务）/ArkTS API/@ohos.hilog (HiLog日志打印)/js-apis-hilog.md>)用于日志打印。 |
| BasicServicesKit | 引入[BusinessError](<../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#businesserror>)用于捕获错误信息。 |
| IPCKit | 引入[rpc](<../../../../../harmonyos-references/IPC Kit（进程间通信服务）/ArkTS API/@ohos.rpc (RPC通信)/js-apis-rpc.md>)用于驱动与客户端IPC（Inter-Process Communication）通信。 |
| AbilityKit | 引入[@ohos.application.Want (Want)](<../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/已停止维护的接口/@ohos.application.Want (Want)/js-apis-application-want.md>)用于生命周期管理。 |
