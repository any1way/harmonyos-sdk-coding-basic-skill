...
scraped_at: 2026-06-11T14:51:12+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:114dbdc11c21d1b17cdd1f4f8e26eacd4bd253862fa44a62c9666310ff11b402
---
## 简介
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/o6z818CPSvyyAzCYnBoe_A/zh-cn_image_0000002622858343.png?HW-CC-KV=V1&HW-CC-Date=20260611T065110Z&HW-CC-Expire=86400&HW-CC-Sign=EC7607A496E9CB23D136316418F368EED869ADD6B6B2535D8B8FB65C8749E40C)
...
详细的接口说明请参考[ScsiPeripheralDDK](<../../../../../../harmonyos-references/Driver Development Kit（驱动开发服务）/C API/模块/ScsiPeripheralDDK/capi-scsiperipheralddk.md>)。
...
1. 初始化DDK。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L111-L114)
2. 打开设备。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L125-L127)
3. 创建缓冲区（可选）。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L142-L144)
4. 检查逻辑单元是否已经准备好（可选）。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L414-L416)
5. 查询SCSI设备的基本信息（可选）。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L226-L228)
6. 获取SCSI设备的容量信息（可选）。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L357-L359)
7. 获取sense data（可选）。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L499-L501)
8. 解析sense data（可选）。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L450-L453)
9. 读取数据（可选）。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L643-L645)
10. 写入数据（可选）。
    ...
    [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L722-L724)
11. 校验指定逻辑块（可选）。
    ...
    [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L766-L768)
12. 以CDB方式发送SCSI命令（可选）。
    ...
    [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L900-L902)
13. 销毁缓冲区（可选）。
    ...
    [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L947-L949)
14. 关闭设备。
    ...
    [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L958-L960)
15. 释放DDK。
    ...
    [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/ScsiPeripheralDemo/entry/src/main/cpp/hello.cpp#L967-L969)
