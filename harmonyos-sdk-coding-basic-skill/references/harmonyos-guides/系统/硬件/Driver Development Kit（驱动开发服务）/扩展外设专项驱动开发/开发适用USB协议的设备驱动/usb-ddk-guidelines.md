...
content_hash: sha256:671e9da0ec8601b61062c6c2e1cf686fbb0b3ba6a627d4a6e1eea6697c3f8238
---
## 简介
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/xJ0NjqvtRpiElnSQ8tCRsQ/zh-cn_image_0000002622858343.png?HW-CC-KV=V1&HW-CC-Date=20260611T065108Z&HW-CC-Expire=86400&HW-CC-Sign=3CA5FA8E3361B5F1B0FDBFB507D0CB2EB57DF1DD03886CDD92C2ACA08D191A2A)
...
详细的接口说明请参考[UsbDdk](<../../../../../../harmonyos-references/Driver Development Kit（驱动开发服务）/C API/模块/UsbDdk/capi-usbddk.md>)。
...
1. 获取设备描述符。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/UsbDriverDemo/entry/src/main/cpp/hello.cpp#L329-L342)
2. 获取配置描述符及声明接口。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/UsbDriverDemo/entry/src/main/cpp/hello.cpp#L296-L319)
3. 获取当前激活接口的备用设置及激活备用设置（可选）。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/UsbDriverDemo/entry/src/main/cpp/hello.cpp#L202-L215)
4. 发送控制读请求、发送控制写请求（可选）。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/UsbDriverDemo/entry/src/main/cpp/hello.cpp#L234-L245)
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/UsbDriverDemo/entry/src/main/cpp/hello.cpp#L366-L378)
5. 创建内存映射缓冲区及发送请求（可选）。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/UsbDriverDemo/entry/src/main/cpp/hello.cpp#L118-L122)
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/UsbDriverDemo/entry/src/main/cpp/hello.cpp#L136-L144)
6. 释放资源。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/UsbDriverDemo/entry/src/main/cpp/hello.cpp#L434-L444)
7. 获取可识别的USB设备列表（独立步骤，可选）。
   ...
   [hello.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/DriverDevelopmentKit/UsbDriverDemo/entry/src/main/cpp/hello.cpp#L220-L229)
