...
scraped_at: 2026-06-01T11:22:45+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:0d6cd0df973b327a823695a985c9aec9a221006a623758c50057ea3384f10b49
---
## 场景介绍
...
按键按下事件常用接口如下表所示，接口详细介绍请参考[@ohos.multimodalInput.inputConsumer](<../../../../../harmonyos-references/基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.inputConsumer (全局快捷键)/js-apis-inputconsumer.md>)。
...
应用开启时调用[on](<../../../../../harmonyos-references/基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.inputConsumer (全局快捷键)/js-apis-inputconsumer.md#inputconsumeronkeypressed16>)方法订阅按键按下事件，应用关闭时再用[off](<../../../../../harmonyos-references/基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.inputConsumer (全局快捷键)/js-apis-inputconsumer.md#inputconsumeroffkeypressed16>)方法取消订阅按键按下事件。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/InputKit/ArkTSInputConsumer/entry/src/main/ets/pages/Index.ets#L16-L168)
