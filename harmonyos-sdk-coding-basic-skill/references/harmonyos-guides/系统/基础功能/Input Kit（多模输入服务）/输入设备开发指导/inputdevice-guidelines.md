...
scraped_at: 2026-06-01T11:22:44+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:ee294cf2b0b44bb37c2b166f4a06d7319153d06ebac58f0e1999fe5d31dd081e
---
## 场景介绍
...
输入设备管理常用接口如下表所示，接口详细介绍请参考[@ohos.multimodalInput.inputDevice](<../../../../../harmonyos-references/基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.inputDevice (输入设备)/js-apis-inputdevice.md>)。
...
1. 调用[getDeviceList](<../../../../../harmonyos-references/基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.inputDevice (输入设备)/js-apis-inputdevice.md#inputdevicegetdevicelist9>)方法查询所有连接的输入设备，调用[getKeyboardType](<../../../../../harmonyos-references/基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.inputDevice (输入设备)/js-apis-inputdevice.md#inputdevicegetkeyboardtype9>)方法遍历所有连接的设备，判断是否有物理键盘，若有则标记已有物理键盘连接，该步骤确保监听设备热插拔之前，检测所有插入的输入设备。
2. 调用[on](<../../../../../harmonyos-references/基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.inputDevice (输入设备)/js-apis-inputdevice.md#inputdeviceonchange9>)接口监听输入设备热插拔事件，若监听到有物理键盘插入，则标记已有物理键盘连接；若监听到有物理键盘拔掉，则标记没有物理键盘连接。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/InputKit/ArkTSInputDevice/entry/src/main/ets/pages/Index.ets#L16-L131)
