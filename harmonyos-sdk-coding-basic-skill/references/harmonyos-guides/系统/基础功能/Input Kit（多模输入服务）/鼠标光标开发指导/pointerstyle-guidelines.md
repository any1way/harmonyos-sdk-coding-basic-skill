...
scraped_at: 2026-06-01T11:22:46+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:066ae60b2d580f7909c92a605c4d6256c9ef1b6dca3e01efb498af02a1ace122
---
## 场景介绍
...
鼠标光标控制常用接口如下表所示，接口详细介绍请参见[@ohos.multimodalInput.pointer](<../../../../../harmonyos-references/基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.pointer (鼠标光标)/js-apis-pointer.md>)。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/InputKit/ArkTsPointer/entry/src/main/ets/pages/Index.ets#L29-L97)

## 设置鼠标光标样式

当开发者设计取色器特性时，可以将鼠标光标样式切换为取色器样式，完成取色后，设置鼠标光标样式为默认样式，该接口设置和查询当前应用内指定窗口的光标样式，总共可设置43种光标样式，具体参考[光标样式](<../../../../../harmonyos-references/基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.pointer (鼠标光标)/js-apis-pointer.md#pointerstyle>)。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/InputKit/ArkTsPointer/entry/src/main/ets/pages/Index.ets#L99-L171)
