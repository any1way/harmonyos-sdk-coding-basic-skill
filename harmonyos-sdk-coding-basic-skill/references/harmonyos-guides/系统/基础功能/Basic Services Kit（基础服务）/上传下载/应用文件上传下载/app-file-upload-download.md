...
scraped_at: 2026-06-01T11:22:06+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:383234c2b158290a55704d23e77c142ed6177d4e0f151e49f5dff1d2b945e1fd
---
应用支持将文件上传到网络服务器，也支持从网络服务器下载资源文件到本地目录。

## 上传应用文件

开发者可以使用上传下载模块（[ohos.request](<../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md>)）的上传接口将本地文件上传。文件上传过程通过系统服务代理完成。在API version 12中，request.agent.create接口增加了设置代理地址的参数，支持设置自定义代理地址。

说明

· 当前上传应用文件功能，request.uploadFile方式仅支持上传应用缓存文件路径（cacheDir）下的文件，request.agent方式支持上传用户公共文件和应用缓存文件路径下的文件。

· 使用上传下载模块，需[声明权限](../../../../安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)：ohos.permission.INTERNET。

· 上传下载模块不支持Charles、Fiddler等代理抓包工具。

· 上传下载模块接口目前暂不支持子线程调用场景，如[TaskPool](../../../../../应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/TaskPool简介/taskpool-introduction.md)等。
...
8. // 新建一个本地应用文件
9. try {
10. let file = fileIo.openSync(cacheDir + '/test.txt', fileIo.OpenMode.READ_WRITE | fileIo.OpenMode.CREATE);
11. fileIo.writeSync(file.fd, 'upload file test');
...
[RequestUpload.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Basic-Services-Kit/request/UploadDownloadGuide/features/uploadanddownload/src/main/ets/upload/RequestUpload.ets#L25-L85)
...
[RequestUpload.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Basic-Services-Kit/request/UploadDownloadGuide/features/uploadanddownload/src/main/ets/upload/RequestUpload.ets#L87-L137)

## 下载网络资源文件至应用文件目录

开发者可以使用上传下载模块（[ohos.request](<../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md>)）的下载接口将网络资源文件下载到应用文件目录。对已下载的网络资源应用文件，开发者可以使用基础文件IO接口（[ohos.file.fs](<../../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md>)）对其进行访问，使用方式与[应用文件访问](<../../../../../应用框架/Core File Kit（文件基础服务）/应用文件/应用文件访问与管理/应用文件访问(ArkTS)/app-file-access.md>)一致。文件下载过程使用系统服务代理完成，在api12中request.agent.create接口增加了设置代理地址参数，支持用户设置自定义代理地址。
...
[RequestDownload.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Basic-Services-Kit/request/UploadDownloadGuide/features/uploadanddownload/src/main/ets/download/RequestDownload.ets#L25-L54)
...
[RequestDownload.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Basic-Services-Kit/request/UploadDownloadGuide/features/uploadanddownload/src/main/ets/download/RequestDownload.ets#L56-L96)

## 下载网络资源文件至用户文件

开发者可以使用[ohos.request](<../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md>)的[request.agent](<../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md#requestagentcreate10>)接口下载网络资源文件到指定的用户文件目录。
...
开发者可以通过调用[DocumentViewPicker](<../../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.picker (选择器)/js-apis-file-picker.md#documentviewpicker>)的[save()](<../../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.picker (选择器)/js-apis-file-picker.md#save>)接口保存文件并获得用户文件的uri，将此uri作为[Config](<../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md#requestagentconfig10>)的saveas字段值进行下载。
...
[DocumentDownload.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Basic-Services-Kit/request/UploadDownloadGuide/features/uploadanddownload/src/main/ets/download/userFile/DocumentDownload.ets#L24-L88)

### 下载音频类文件

开发者可以通过调用[AudioViewPicker](<../../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.picker (选择器)/js-apis-file-picker.md#audioviewpicker>)的[save()](<../../../../../../harmonyos-references/Core File Kit（文件基础服务）/ArkTS API/@ohos.file.picker (选择器)/js-apis-file-picker.md#save-3>)接口保存文件并获得用户文件的uri，将此uri作为[Config](<../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md#requestagentconfig10>)的saveas字段值进行下载。
...
[AudioDownload.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Basic-Services-Kit/request/UploadDownloadGuide/features/uploadanddownload/src/main/ets/download/userFile/AudioDownload.ets#L24-L81)

### 下载图片或视频类文件

开发者可以通过调用PhotoAccessHelper[模块描述](<../../../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/模块描述/arkts-apis-photoaccesshelper.md>)的[createAsset()](<../../../../../../harmonyos-references/Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Interface (PhotoAccessHelper)/arkts-apis-photo_93807367.md#createasset-2>)接口创建媒体文件并获取用户文件的URI，将其作为[Config](<../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md#requestagentconfig10>)的saveas字段值进行下载。

需要权限：[ohos.permission.WRITE\_IMAGEVIDEO](../../../../安全/程序访问控制/应用权限管控/应用权限列表/受限开放权限/restricted-permissions.md#ohospermissionwrite_imagevideo)

权限[ohos.permission.WRITE\_IMAGEVIDEO](../../../../安全/程序访问控制/应用权限管控/应用权限列表/受限开放权限/restricted-permissions.md#ohospermissionwrite_imagevideo)是[权限机制中的基本概念](../../../../安全/程序访问控制/应用权限管控/应用权限管控概述/app-permission-mgmt-overview.md#权限机制中的基本概念)中system\_basic(系统基础服务)级别的[受限开放权限](../../../../安全/程序访问控制/应用权限管控/应用权限列表/受限开放权限/restricted-permissions.md)，normal等级的应用需要将自身的APL等级声明为system\_basic及以上。授权方式为user\_grant，需要[向用户申请授权](../../../../安全/程序访问控制/应用权限管控/申请应用权限/向用户申请授权/request-user-authorization.md)。
...
[MediaDownload.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Basic-Services-Kit/request/UploadDownloadGuide/features/uploadanddownload/src/main/ets/download/userFile/MediaDownload.ets#L26-L121)

## 添加任务速度限制与超时限制

开发者可以使用[ohos.request (上传下载)](<../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md>)模块中的接口上传本地文件或下载网络资源文件。为方便对任务速度及时长进行限制，分别在API version 18中增加了[setMaxSpeed](<../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md#setmaxspeed18>)接口，支持用户设置任务的最高速度限制；在API version 20的[request.agent.create](<../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md#requestagentcreate10-1>)接口中增加了最低限速及超时参数，支持用户自定义最低速度限制以及超时时间。
...
[SpeedLimitDownload.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Basic-Services-Kit/request/UploadDownloadGuide/features/uploadanddownload/src/main/ets/download/SpeedLimitDownload.ets#L24-L93)

## 添加网络配置

### HTTP拦截

开发者可以通过设置配置文件实现HTTP拦截功能。上传下载模块在应用配置文件中禁用HTTP后，无法创建明文HTTP传输的上传下载任务。配置文件在APP中的路径是：src/main/resources/base/profile/network\_config.json。请参考网络管理模块配置文件[网络连接安全配置](../../../../../../best-practices/应用安全/网络连接安全配置/bpta-network-ca-security.md#section5454123841911)，了解需要配置的具体参数。
...
从API version 22开始，开发者可以使用[wantAgent](<../../../../../../harmonyos-references/Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantAgent (WantAgent模块)/js-apis-app-ability-wantagent.md>)接口与上传下载模块结合，实现点击任务通知后跳转至应用指定页面的功能。

### 功能介绍

通过在下载任务的配置[request.agent.Notification](<../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.request (上传下载)/js-apis-request.md#requestagentnotification15>)中设置wantAgent参数，开发者可以指定用户点击通知后要跳转的应用页面及相关参数。当用户点击正在进行或已完成的下载任务通知时，系统会根据wantAgent参数启动指定的应用能力。
...
64. logger.info(TAG, `Request download completed, ${JSON.stringify(progress)}`);
65. // 获取文件状态信息，其中包含大小
66. let filePath = filesDir + '/' + fileName;
67. // 获取文件状态信息，其中包含大小
68. let fileStat = fileIo.statSync(filePath);
69. let fileSize = fileStat.size;
70. logger.info(TAG, `download complete, file= ${url}, size=${fileSize}, progress = 100%`);
71. callback(100, true);
72. // 该方法需用户管理任务生命周期，任务结束后调用remove释放task对象
73. request.agent.remove(task.tid);
74. })
75. }).catch((err: BusinessError) => {
76. logger.error(TAG, `Failed to operate a download task, Code: ${err.code}, message: ${err.message}`);
77. });
78. } catch (error) {
79. let err: BusinessError = error as BusinessError;
80. logger.error(TAG, `Failed to operate a download task, Code: ${err.code}, message: ${err.message}`);
81. }
82. }
```

[WantAgentDownload.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Basic-Services-Kit/request/UploadDownloadGuide/features/uploadanddownload/src/main/ets/download/WantAgentDownload.ets#L26-L110)
