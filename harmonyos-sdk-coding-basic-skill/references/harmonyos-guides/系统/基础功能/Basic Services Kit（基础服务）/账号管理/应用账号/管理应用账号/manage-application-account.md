...
scraped_at: 2026-06-01T11:21:52+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:0e45b718a09614684d9323ef3f7eba7a03bcb050d2c21ecfb59d371c64e7f3ca
---
应用开发者可以使用[@ohos.account.appAccount](<../../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.appAccount (应用账号管理)/js-apis-appaccount.md>)管理本应用的账号数据。
...
1. 调用[createAccount](<../../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.appAccount (应用账号管理)/js-apis-appaccount.md#createaccount9>)接口，根据名称和选项创建应用账号。
...
调用[getAllAccounts](<../../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.appAccount (应用账号管理)/js-apis-appaccount.md#getallaccounts9>)接口查询账号列表。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Account/ManagerApplicationAccount/entry/src/main/ets/pages/Index.ets#L54-L66)
...
1. 调用[getCredential](<../../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.appAccount (应用账号管理)/js-apis-appaccount.md#getcredential9>)接口，获取账号的凭据。
...
1. 调用[setCredential](<../../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.appAccount (应用账号管理)/js-apis-appaccount.md#setcredential9>)接口，设置账号的凭据。
...
1. 调用[setCustomData](<../../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.appAccount (应用账号管理)/js-apis-appaccount.md#setcustomdata9>)接口，设置账号的自定义数据。
...
1. 调用[getCustomData](<../../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.appAccount (应用账号管理)/js-apis-appaccount.md#getcustomdata9>)接口，获取账号的自定义数据。
...
1. 调用[setAuthToken](<../../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.appAccount (应用账号管理)/js-apis-appaccount.md#setauthtoken9>)接口，设置指定授权类型的授权令牌。
...
1. 调用[getAuthToken](<../../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.appAccount (应用账号管理)/js-apis-appaccount.md#getauthtoken9>)接口，获取指定授权类型的授权令牌。
...
指定要删除的账号名称，调用[removeAccount](<../../../../../../../harmonyos-references/基础功能/Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.appAccount (应用账号管理)/js-apis-appaccount.md#removeaccount9>)接口删除账号。
...
[Index.ets](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/Account/ManagerApplicationAccount/entry/src/main/ets/pages/Index.ets#L166-L179)
