...
scraped_at: 2026-06-11T14:50:23+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:6a58a1db2cb33880d61d433344926be4f8e053a0bc92a626162db2d8472f6667
---
## 概述
...
[concurrent\_queue.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/FunctionFlowRuntime/ConcurrentQueue/entry/src/main/cpp/concurrent_queue.h#L18-L26)
...
[concurrent\_queue.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/FunctionFlowRuntime/ConcurrentQueue/entry/src/main/cpp/concurrent_queue.cpp#L17-L110)

说明

ffrt\_queue\_submit\_h\_f接口可以接收裸函数指针任务作为参数，如果任务存在前后处理可以参见[ffrt\_alloc\_auto\_managed\_function\_storage\_base](<../../Function Flow Runtime C API/ffrt-api-guideline-c.md#ffrt_alloc_auto_managed_function_storage_base>)函数查看如何构造任务结构体。
...
| 名称 | 描述 |
| --- | --- |
| [ffrt\_queue\_create](<../../Function Flow Runtime C API/ffrt-api-guideline-c.md#ffrt_queue_t>) | 创建队列。 |
| [ffrt\_queue\_destroy](<../../Function Flow Runtime C API/ffrt-api-guideline-c.md#ffrt_queue_t>) | 销毁队列。 |
| [ffrt\_task\_attr\_set\_queue\_priority](<../../Function Flow Runtime C API/ffrt-api-guideline-c.md#ffrt_task_attr_t>) | 设置队列任务优先级。 |
| [ffrt\_queue\_attr\_set\_max\_concurrency](<../../Function Flow Runtime C API/ffrt-api-guideline-c.md#ffrt_queue_attr_t>) | 设置并发队列的并发度。 |
| [ffrt\_queue\_submit\_h\_f](<../../Function Flow Runtime C API/ffrt-api-guideline-c.md#ffrt_queue_t>) | 向队列提交一个任务。  **说明**：从API version 20开始，支持该接口。 |
