...
scraped_at: 2026-06-11T14:50:24+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:edc24d58f0bf7e103b9033c53714893b60f287767a88c89a927af2c4d8dea215
---
## 概述
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/qVWgCw94QC2EY8FY0w8EHg/zh-cn_image_0000002592218886.png?HW-CC-KV=V1&HW-CC-Date=20260611T065022Z&HW-CC-Expire=86400&HW-CC-Sign=B31BF7C1269AB35F957344333ED8BBE79A8EB7FF7C043E56F792B59198034D59)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b0/v3/E8BHglTMTemV94BCjsXIxA/zh-cn_image_0000002592378820.png?HW-CC-KV=V1&HW-CC-Date=20260611T065022Z&HW-CC-Expire=86400&HW-CC-Sign=764AA8C36411B8373596502A233C8135C725E93959B175151335470C85A8C0B2)
...
[parallel.h](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/FunctionFlowRuntime/TaskGraph/entry/src/main/cpp/parallel.h#L18-L25)
...
[parallel.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/FunctionFlowRuntime/TaskGraph/entry/src/main/cpp/parallel.cpp#L18-L79)
...
ffrt\_submit\_h\_f和ffrt\_submit\_f接口可以接收裸函数指针任务作为参数，如果任务存在前后处理可以参见[ffrt\_alloc\_auto\_managed\_function\_storage\_base](<../../Function Flow Runtime C API/ffrt-api-guideline-c.md#ffrt_alloc_auto_managed_function_storage_base>)函数查看如何构造任务结构体。
...
[parallel.cpp](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20260402/FunctionFlowRuntime/TaskGraph/entry/src/main/cpp/parallel.cpp#L80-L135)
...
ffrt\_submit\_f接口可以接收裸函数指针任务作为参数，如果任务存在前后处理可以参见[ffrt\_alloc\_auto\_managed\_function\_storage\_base](<../../Function Flow Runtime C API/ffrt-api-guideline-c.md#ffrt_alloc_auto_managed_function_storage_base>)函数查看如何构造任务结构体。

各个任务在FFRT内部形成了一棵调用树：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/mE7PYL6cTCuWL4uoR3LEHw/zh-cn_image_0000002622858327.png?HW-CC-KV=V1&HW-CC-Date=20260611T065022Z&HW-CC-Expire=86400&HW-CC-Sign=5D579A302C5D5B750830E984094E0F4DC060D3AD14EA2C38AC4A2F4CEB8849D1)
...
| 名称 | 描述 |
| --- | --- |
| [ffrt\_submit\_f](<../../Function Flow Runtime C API/ffrt-api-guideline-c.md#ffrt_submit_f>) | 提交任务调度执行。  **说明**：从API version 20开始，支持该接口。 |
| [ffrt\_submit\_h\_f](<../../Function Flow Runtime C API/ffrt-api-guideline-c.md#ffrt_submit_h_f>) | 提交任务调度执行并返回任务句柄。  **说明**：从API version 20开始，支持该接口。 |
| [ffrt\_wait\_deps](<../../Function Flow Runtime C API/ffrt-api-guideline-c.md#ffrt_wait_deps>) | 等待依赖的任务完成。 |

说明

* 如何使用FFRT C++ API详见：[FFRT C++接口三方库使用指导](<../../Function Flow Runtime开发指导/ffrt-development-guideline.md#using-ffrt-c-api-1>)。
