...
scraped_at: 2026-06-11T14:50:48+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:10c8315db412d585e84fbca5c3a533b1330d55f1026fed0611f918153059ef74
---
## 场景介绍
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/xO5-MC3uROSYtglFbAdDlA/zh-cn_image_0000002622858333.png?HW-CC-KV=V1&HW-CC-Date=20260611T065047Z&HW-CC-Expire=86400&HW-CC-Sign=5CA54BA09CD35261D328FF34CC69971137835FD74261199C3B36F2C2DB947E8D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/NhzOKqw_Tdq87GknXQaH_w/zh-cn_image_0000002622698455.png?HW-CC-KV=V1&HW-CC-Date=20260611T065047Z&HW-CC-Expire=86400&HW-CC-Sign=A8FE9EBB643C2EB0AEC5D4A07D4D65D0DF81A989245BE7797107421BDB308BC5)
...
为某个任务设置指定的QoS等级。开发者可以根据当前任务的重要程度，为其标记不同等级的QoS，从而获得不同的调度供给。参考[QoS实践指导](../../../../../best-practices/NDK开发/高负载场景线程优先级设置/bpta-thread-priority-setting.md)。
...
取消某个任务设置的QoS等级。参考[QoS实践指导](../../../../../best-practices/NDK开发/高负载场景线程优先级设置/bpta-thread-priority-setting.md)。
...
获取某个任务之前最近一次设置的QoS等级；如果之前未设置任何QoS等级，则返回-1。查看当前任务的QoS等级。参考[QoS实践指导](../../../../../best-practices/NDK开发/高负载场景线程优先级设置/bpta-thread-priority-setting.md)。
