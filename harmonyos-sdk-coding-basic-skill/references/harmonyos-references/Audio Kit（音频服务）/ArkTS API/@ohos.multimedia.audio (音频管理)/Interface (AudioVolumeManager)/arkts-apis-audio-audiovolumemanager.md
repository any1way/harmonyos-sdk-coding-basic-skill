...
scraped_at: 2026-06-01T16:16:55+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:c912ecd82304b54b309fb27299348cdb77ce07e0b8e584820e2b175b88f7d982
---
音量管理。

在使用AudioVolumeManager的接口之前，需先通过[getVolumeManager](<../Interface (AudioManager)/arkts-apis-audio-audiomanager.md#getvolumemanager9>)获取AudioVolumeManager实例。
...
| callback | AsyncCallback<[AudioVolumeGroupManager](<../Interface (AudioVolumeGroupManager)/arkts-apis-audio-audiovolumegroupmanager.md>)> | 是 | 回调函数。当获取音频组音量管理器实例成功，err为undefined，data为获取到的音频组音量管理器实例；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise< [AudioVolumeGroupManager](<../Interface (AudioVolumeGroupManager)/arkts-apis-audio-audiovolumegroupmanager.md>) > | Promise对象，返回音频组音量管理器实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioVolumeGroupManager](<../Interface (AudioVolumeGroupManager)/arkts-apis-audio-audiovolumegroupmanager.md>) | 音频组音量管理器实例。 |
...
| callback | Callback<[VolumeEvent](<../Interfaces (其他)/arkts-apis-audio-i.md#volumeevent9>)> | 是 | 回调函数，返回变化后的音量信息。 |
...
| callback | Callback<[VolumeEvent](<../Interfaces (其他)/arkts-apis-audio-i.md#volumeevent9>)> | 否 | 回调函数，返回变化后的音量信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streamUsage | [StreamUsage](../Enums/arkts-apis-audio-e.md#streamusage) | 是 | 需要获取音量值的音频流。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streamUsage | [StreamUsage](../Enums/arkts-apis-audio-e.md#streamusage) | 是 | 需要获取的最小音量值的音频流。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streamUsage | [StreamUsage](../Enums/arkts-apis-audio-e.md#streamusage) | 是 | 需要获取的最大音量值的音频流。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streamUsage | [StreamUsage](../Enums/arkts-apis-audio-e.md#streamusage) | 是 | 检查是否为静音的音频流。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streamUsage | [StreamUsage](../Enums/arkts-apis-audio-e.md#streamusage) | 是 | 音频流。 |
...
| callback | Callback<[StreamVolumeEvent](<../Interfaces (其他)/arkts-apis-audio-i.md#streamvolumeevent20>)> | 是 | 回调函数，返回变化后的音量信息。 |
...
| callback | Callback<[StreamVolumeEvent](<../Interfaces (其他)/arkts-apis-audio-i.md#streamvolumeevent20>)> | 否 | 回调函数，返回变化后的音量信息。 |
