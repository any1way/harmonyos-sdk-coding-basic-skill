...
scraped_at: 2026-06-01T16:16:54+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:f6e78ced407177882b8303aa82b682806addd7a229e5131bb80baf1fa8e1fba7
---
管理音频组音量。

在使用AudioVolumeGroupManager的接口之前，需先通过[getVolumeGroupManager](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#getvolumegroupmanager9>)获取AudioVolumeGroupManager实例。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getVolumeByStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#getvolumebystream20>)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getVolumeByStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#getvolumebystream20>)替代。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getMinVolumeByStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#getminvolumebystream20>)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getMinVolumeByStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#getminvolumebystream20>)替代。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[getMaxVolumeByStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#getmaxvolumebystream20>)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getMaxVolumeByStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#getmaxvolumebystream20>)替代。
...
从API version 9开始支持，从API version 20开始废弃，建议使用[isSystemMutedForStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#issystemmutedforstream20>)替代。
...
从API version 10开始支持，从API version 20开始废弃，建议使用[isSystemMutedForStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#issystemmutedforstream20>)替代。
...
| 类型 | 说明 |
| --- | --- |
| [AudioRingMode](../Enums/arkts-apis-audio-e.md#audioringmode) | 返回系统的铃声模式。 |
...
监听铃声模式变化事件（当[AudioRingMode](../Enums/arkts-apis-audio-e.md#audioringmode)发生变化时触发）。使用callback异步回调。
...
| callback | Callback<[AudioRingMode](../Enums/arkts-apis-audio-e.md#audioringmode)> | 是 | 回调函数，返回变化后的铃音模式。 |
...
| callback | Callback<[AudioRingMode](../Enums/arkts-apis-audio-e.md#audioringmode)> | 否 | 回调函数，返回变化后的铃音模式。 |
...
| callback | Callback<[MicStateChangeEvent](<../Interfaces (其他)/arkts-apis-audio-i.md#micstatechangeevent9>)> | 是 | 回调函数，返回变更后的麦克风状态。 |
...
| callback | Callback<[MicStateChangeEvent](<../Interfaces (其他)/arkts-apis-audio-i.md#micstatechangeevent9>)> | 否 | 回调函数，返回变更后的麦克风状态。 |
...
从API version 10开始支持，从API version 20开始废弃，建议使用[getVolumeInUnitOfDbByStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#getvolumeinunitofdbbystream20>)替代。
...
| device | [DeviceType](../Enums/arkts-apis-audio-e.md#devicetype) | 是 | 设备类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inputDevice | [AudioDeviceDescriptor](<../Interfaces (其他)/arkts-apis-audio-i.md#audiodevicedescriptor>) | 是 | 获取最大电平值的设备信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| outputDevice | [AudioDeviceDescriptor](<../Interfaces (其他)/arkts-apis-audio-i.md#audiodevicedescriptor>) | 是 | 获取最大电平值的设备信息。 |
