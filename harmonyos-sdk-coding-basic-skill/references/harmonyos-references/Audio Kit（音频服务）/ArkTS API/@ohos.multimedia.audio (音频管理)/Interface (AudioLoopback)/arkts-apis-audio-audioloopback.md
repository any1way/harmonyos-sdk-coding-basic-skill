...
scraped_at: 2026-06-01T16:16:56+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:fdfd8e839916f9504afb1fcf7aaf6356668b63a0b5c18379de353c7589328935
---
提供音频返听的相关接口。

在使用AudioLoopback的接口之前，需先通过[audio.createAudioLoopback](../Functions/arkts-apis-audio-f.md#audiocreateaudioloopback20)获取AudioLoopback实例。

当启用音频返听时，系统会创建低时延渲染器与低时延采集器，实现低时延耳返功能。采集的音频直接通过内部路由返回到渲染器。对于渲染器，其音频焦点策略与[STREAM\_USAGE\_MUSIC](../Enums/arkts-apis-audio-e.md#streamusage)相匹配。对于采集器，其音频焦点策略与[SOURCE\_TYPE\_MIC](../Enums/arkts-apis-audio-e.md#sourcetype8)相匹配。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioLoopbackStatus](../Enums/arkts-apis-audio-e.md#audioloopbackstatus20)> | Promise对象，返回音频返听状态。 |
...
| callback | Callback<[AudioLoopbackStatus](../Enums/arkts-apis-audio-e.md#audioloopbackstatus20)> | 是 | 回调函数，返回当前音频返听的状态。 |
...
| callback | Callback<[AudioLoopbackStatus](../Enums/arkts-apis-audio-e.md#audioloopbackstatus20)> | 否 | 回调函数，返回当前音频返听的状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| preset | [AudioLoopbackReverbPreset](../Enums/arkts-apis-audio-e.md#audioloopbackreverbpreset21) | 是 | 混响模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioLoopbackReverbPreset](../Enums/arkts-apis-audio-e.md#audioloopbackreverbpreset21) | 返回当前音频返听器的混响模式。  在没有被修改的情况下，默认的混响模式是THEATER。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| preset | [AudioLoopbackEqualizerPreset](../Enums/arkts-apis-audio-e.md#audioloopbackequalizerpreset21) | 是 | 均衡器类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioLoopbackEqualizerPreset](../Enums/arkts-apis-audio-e.md#audioloopbackequalizerpreset21) | 返回当前音频返听器的均衡器类型。  在没有被修改的情况下，默认的均衡器类型是FULL。 |
