...
content_hash: sha256:33fc8e7eeeb324ef95df4d2908b4d65f34a53ae0e597da4e8c98168ec24f2948
---
空间音频管理。

在使用AudioSpatializationManager的接口之前，需先通过[getSpatializationManager](<../Interface (AudioManager)/arkts-apis-audio-audiomanager.md#getspatializationmanager18>)获取AudioSpatializationManager实例。
