...
scraped_at: 2026-06-01T16:16:48+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:fcb1c02d1641da2e308d89802149afb3f66e6aab0e2510f731d01f16b23cb3a9
---
提供音频渲染的相关接口。

在使用AudioRenderer的接口之前，需先通过[createAudioRenderer](../Functions/arkts-apis-audio-f.md#audiocreateaudiorenderer8)获取AudioRenderer实例。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| state8+ | [AudioState](../Enums/arkts-apis-audio-e.md#audiostate8) | 是 | 否 | 音频渲染器的状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AudioRendererInfo](<../Interfaces (其他)/arkts-apis-audio-i.md#audiorendererinfo8>)> | 是 | 回调函数。当获取音频渲染器的信息成功，err为undefined，data为获取到的音频渲染器的信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioRendererInfo](<../Interfaces (其他)/arkts-apis-audio-i.md#audiorendererinfo8>)> | Promise对象，返回音频渲染器信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioRendererInfo](<../Interfaces (其他)/arkts-apis-audio-i.md#audiorendererinfo8>) | 返回音频渲染器信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AudioStreamInfo](<../Interfaces (其他)/arkts-apis-audio-i.md#audiostreaminfo8>)> | 是 | 回调函数。当获取音频流信息成功，err为undefined，data为获取到的音频流信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioStreamInfo](<../Interfaces (其他)/arkts-apis-audio-i.md#audiostreaminfo8>)> | Promise对象，返回音频流信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioStreamInfo](<../Interfaces (其他)/arkts-apis-audio-i.md#audiostreaminfo8>) | 返回音频流信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [AudioEffectMode](../Enums/arkts-apis-audio-e.md#audioeffectmode10) | 是 | 音效模式。 |
| callback | AsyncCallback<void> | 是 | 回调函数。当设置当前音效模式成功，err为undefined，否则为错误对象。 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码说明文档](../../../../通用错误码/errorcode-universal.md)和[Audio错误码](../../../错误码/Audio错误码/errorcode-audio.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AudioEffectMode](../Enums/arkts-apis-audio-e.md#audioeffectmode10)> | 是 | 回调函数。当获取当前音效模式成功，err为undefined，data为获取到的当前音效模式；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioEffectMode](../Enums/arkts-apis-audio-e.md#audioeffectmode10)> | Promise对象，返回当前音效模式。 |
...
清空缓冲区（[AudioState](../Enums/arkts-apis-audio-e.md#audiostate8)为STATE\_RUNNING、STATE\_PAUSED、STATE\_STOPPED状态下可用）。使用Promise异步回调。
...
以下错误码的详细介绍请参见[Audio错误码](../../../错误码/Audio错误码/errorcode-audio.md)。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioTimestampInfo](<../Interfaces (其他)/arkts-apis-audio-i.md#audiotimestampinfo19>)> | Promise对象，返回音频流时间戳和当前数据帧位置信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioTimestampInfo](<../Interfaces (其他)/arkts-apis-audio-i.md#audiotimestampinfo19>) | 返回音频流时间戳和当前数据帧位置信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [AudioLatencyType](../Enums/arkts-apis-audio-e.md#audiolatencytype23) | 是 | 获取的时延类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [InterruptMode](../Enums/arkts-apis-audio-e.md#interruptmode9) | 是 | 焦点模型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AudioDeviceDescriptors](../Types/arkts-apis-audio-t.md#audiodevicedescriptors)> | 是 | 回调函数。当获取音频流输出设备信息成功，err为undefined，data为获取到的音频流输出设备信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioDeviceDescriptors](../Types/arkts-apis-audio-t.md#audiodevicedescriptors)> | Promise对象，返回音频流的输出设备信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioDeviceDescriptors](../Types/arkts-apis-audio-t.md#audiodevicedescriptors) | 返回音频流的输出设备信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [ChannelBlendMode](../Enums/arkts-apis-audio-e.md#channelblendmode11) | 是 | 声道混合模式类型。 |
...
* 本接口仅适用于[StreamUsage](../Enums/arkts-apis-audio-e.md#streamusage)为语音消息、VoIP语音通话或者VoIP视频通话的场景，支持听筒、扬声器和系统默认设备。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceType | [DeviceType](../Enums/arkts-apis-audio-e.md#devicetype) | 是 | 设备类型。  仅支持以下设备：EARPIECE（听筒）、SPEAKER（扬声器）和DEFAULT（系统默认设备）。 |
...
调用此方法后，如果AudioRenderer对象获取焦点失败或发生中断事件（如被其他音频打断等），会收到[InterruptEvent](<../Interfaces (其他)/arkts-apis-audio-i.md#interruptevent9>)。建议应用根据InterruptEvent的信息进行进一步处理。更多信息请参阅文档[音频焦点介绍](<../../../../../harmonyos-guides/媒体/Audio Kit（音频服务）/音频焦点和音频会话管理/音频焦点介绍/audio-playback-concurrency.md>)。
...
| callback | Callback<[InterruptEvent](<../Interfaces (其他)/arkts-apis-audio-i.md#interruptevent9>)> | 是 | 回调函数，返回中断事件信息。 |
...
| callback | Callback<[InterruptEvent](<../Interfaces (其他)/arkts-apis-audio-i.md#interruptevent9>)> | 否 | 回调函数，返回中断事件信息。 |
...
| callback | Callback<[AudioState](../Enums/arkts-apis-audio-e.md#audiostate8)> | 是 | 回调函数，返回当前音频的状态。 |
...
| callback | Callback<[AudioState](../Enums/arkts-apis-audio-e.md#audiostate8)> | 否 | 回调函数，返回当前音频的状态。 |
...
| callback | Callback<[AudioDeviceDescriptors](../Types/arkts-apis-audio-t.md#audiodevicedescriptors)> | 是 | 回调函数，返回当前音频流的输出设备描述信息。 |
...
| callback | Callback<[AudioDeviceDescriptors](../Types/arkts-apis-audio-t.md#audiodevicedescriptors)> | 否 | 回调函数，返回当前音频流的输出设备描述信息。 |
...
| callback | Callback<[AudioStreamDeviceChangeInfo](<../Interfaces (其他)/arkts-apis-audio-i.md#audiostreamdevicechangeinfo11>)> | 是 | 回调函数，返回当前音频流的输出设备描述信息及变化原因。 |
...
| callback | Callback<[AudioStreamDeviceChangeInfo](<../Interfaces (其他)/arkts-apis-audio-i.md#audiostreamdevicechangeinfo11>)> | 否 | 回调函数，返回当前音频流的输出设备描述信息及变化原因。 |
...
| callback | [AudioRendererWriteDataCallback](../Types/arkts-apis-audio-t.md#audiorendererwritedatacallback12) | 是 | 回调函数，入参代表应用接收待写入的数据缓冲区。  API version 11 不支持返回回调结果，从 API version 12 开始支持返回回调结果[AudioDataCallbackResult](../Enums/arkts-apis-audio-e.md#audiodatacallbackresult12)。 |
...
| callback | [AudioRendererWriteDataCallback](../Types/arkts-apis-audio-t.md#audiorendererwritedatacallback12) | 否 | 回调函数，入参代表应用接收待写入的数据缓冲区。  API version 11 不支持返回回调结果，从 API version 12 开始支持返回回调结果[AudioDataCallbackResult](../Enums/arkts-apis-audio-e.md#audiodatacallbackresult12)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rate | [AudioRendererRate](../Enums/arkts-apis-audio-e.md#audiorendererrate8) | 是 | 渲染的速率。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AudioRendererRate](../Enums/arkts-apis-audio-e.md#audiorendererrate8)> | 是 | 回调函数。当获取当前渲染速率成功，err为undefined，data为获取到的当前渲染速率；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioRendererRate](../Enums/arkts-apis-audio-e.md#audiorendererrate8)> | Promise对象，返回渲染速率。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioRendererRate](../Enums/arkts-apis-audio-e.md#audiorendererrate8) | 返回渲染速率。 |
...
* 该接口仅支持类型为[STREAM\_USAGE\_MUSIC](../Enums/arkts-apis-audio-e.md#streamusage)、[STREAM\_USAGE\_MOVIE](../Enums/arkts-apis-audio-e.md#streamusage)或[STREAM\_USAGE\_AUDIOBOOK](../Enums/arkts-apis-audio-e.md#streamusage)的音频流。
* 该接口不支持高清通路的响度设置。
...
| --- | --- |
| 6800101 | Parameter verification failed. |
| 6800104 | Operation is not supported on this renderer, e.g. the stream usage of this renderer is not one of [STREAM\_USAGE\_MUSIC](../Enums/arkts-apis-audio-e.md#streamusage),  [STREAM\_USAGE\_MOVIE](../Enums/arkts-apis-audio-e.md#streamusage), or [STREAM\_USAGE\_AUDIOBOOK](../Enums/arkts-apis-audio-e.md#streamusage), or this renderer is routed through the high-resolution playback path. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| strategy | [AudioSessionStrategy](<../Interfaces (其他)/arkts-apis-audio-i.md#audiosessionstrategy12>) | 是 | 音频会话策略。 |
| behavior | number | 是 | 用于设置音频会话行为。  该参数可以是单个标志，也可以是多个标志的按位OR组合。  当前支持的音频会话行为详见[AudioSessionBehaviorFlags](../Enums/arkts-apis-audio-e.md#audiosessionbehaviorflags24)中定义的标志。 |
