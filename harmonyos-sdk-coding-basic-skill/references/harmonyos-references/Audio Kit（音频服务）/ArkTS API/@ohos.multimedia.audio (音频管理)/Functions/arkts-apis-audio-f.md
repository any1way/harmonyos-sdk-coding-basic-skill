...
scraped_at: 2026-06-01T16:16:43+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:22e3f7a856c5ff0e20ff50b52adbe76b1d808f4d335a8cfd8bab21a674b5a309
---
说明
...
| 类型 | 说明 |
| --- | --- |
| [AudioManager](<../Interface (AudioManager)/arkts-apis-audio-audiomanager.md>) | 音频管理器对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [AudioRendererOptions](<../Interfaces (其他)/arkts-apis-audio-i.md#audiorendereroptions8>) | 是 | 配置渲染器。 |
| callback | AsyncCallback<[AudioRenderer](<../Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)> | 是 | 回调函数。当获取音频渲染器成功，err为undefined，data为获取到的音频渲染器对象；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioRenderer](<../Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md>)> | Promise对象，返回音频渲染器对象。 |
...
当设置Mic音频源（即[SourceType](../Enums/arkts-apis-audio-e.md#sourcetype8)为SOURCE\_TYPE\_MIC、SOURCE\_TYPE\_VOICE\_RECOGNITION、SOURCE\_TYPE\_VOICE\_COMMUNICATION、SOURCE\_TYPE\_VOICE\_MESSAGE、SOURCE\_TYPE\_CAMCORDER）时需要该权限。

**参数：**

| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [AudioCapturerOptions](<../Interfaces (其他)/arkts-apis-audio-i.md#audiocaptureroptions8>) | 是 | 配置音频采集器。 |
| callback | AsyncCallback<[AudioCapturer](<../Interface (AudioCapturer)/arkts-apis-audio-audiocapturer.md>)> | 是 | 回调函数。当获取音频采集器成功，err为undefined，data为获取到的音频采集器对象；否则为错误对象。异常将返回error对象：  错误码6800301：表示参数校验异常、权限校验异常或系统处理异常（具体错误查看系统日志）。  错误码6800101：表示必选参数为空或参数类型错误。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioCapturer](<../Interface (AudioCapturer)/arkts-apis-audio-audiocapturer.md>)> | Promise对象，成功将返回音频采集器对象，异常将返回error对象：  错误码6800301：表示参数校验异常、权限校验异常或系统处理异常（具体错误查看系统日志）。  错误码6800101：表示必选参数为空或参数类型错误。 |
...
在使用createAudioLoopback接口之前，需先通过[isAudioLoopbackSupported](<../Interface (AudioStreamManager)/arkts-apis-audio-audiostreammanager.md#isaudioloopbacksupported20>)查询系统返听能力。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioLoopback](<../Interface (AudioLoopback)/arkts-apis-audio-audioloopback.md>)> | Promise对象，成功将返回音频返听器对象，异常将返回error对象。 |
