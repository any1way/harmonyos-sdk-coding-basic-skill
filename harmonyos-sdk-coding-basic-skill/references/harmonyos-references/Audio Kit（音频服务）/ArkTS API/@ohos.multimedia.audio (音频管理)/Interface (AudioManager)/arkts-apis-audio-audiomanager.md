...
scraped_at: 2026-06-01T16:16:45+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:ee4e1c5f19825bc2960bb964977daca52adaf8d8ada1fbc486dc40cbb6e81a06
---
音频音量和设备管理。

在使用AudioManager的接口之前，需先通过[getAudioManager](../Functions/arkts-apis-audio-f.md#audiogetaudiomanager)获取AudioManager实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AudioScene](../Enums/arkts-apis-audio-e.md#audioscene8)> | 是 | 回调函数。当获取音频场景模式成功，err为undefined，data为获取到的音频场景模式；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioScene](../Enums/arkts-apis-audio-e.md#audioscene8)> | Promise对象，返回音频场景模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioScene](../Enums/arkts-apis-audio-e.md#audioscene8) | 音频场景模式。 |
...
| callback | Callback<[AudioScene](../Enums/arkts-apis-audio-e.md#audioscene8)> | 是 | 回调函数，返回当前音频场景模式。 |
...
| callback | Callback<[AudioScene](../Enums/arkts-apis-audio-e.md#audioscene8)> | 否 | 回调函数，返回当前音频场景模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioVolumeManager](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md>) | AudioVolumeManager实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioStreamManager](<../Interface (AudioStreamManager)/arkts-apis-audio-audiostreammanager.md>) | AudioStreamManager实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioRoutingManager](<../Interface (AudioRoutingManager)/arkts-apis-audio-audioroutingmanager.md>) | AudioRoutingManager实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioSessionManager](<../Interface (AudioSessionManager)/arkts-apis-audio-audiosessionmanager.md>) | AudioSessionManager实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioSpatializationManager](<../Interface (AudioSpatializationManager)/arkts-apis-audio-audiospatializationmanager.md>) | AudioSpatializationManager实例。 |
...
* 应用无法直接调节系统音量，建议通过系统音量面板组件调节音量。具体样例和介绍请查看API文档：[音量面板](<../../../ArkTS组件/@ohos.multimedia.avVolumePanel (音量面板)/ohos-multimedia-avvolumepanel.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| volumeType | [AudioVolumeType](../Enums/arkts-apis-audio-e.md#audiovolumetype) | 是 | 音频音量类型。 |
...
从API version 7开始支持，从API version 9开始废弃。在API version 9-19建议使用[getVolume](<../Interface (AudioVolumeGroupManager)/arkts-apis-audio-audiovolumegroupmanager.md#getvolumedeprecated>)替代；API version 20及以后，建议使用[getVolumeByStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#getvolumebystream20>)替代。
...
从API version 7开始支持，从API version 9开始废弃。在API version 9-19建议使用[getMinVolume](<../Interface (AudioVolumeGroupManager)/arkts-apis-audio-audiovolumegroupmanager.md#getminvolumedeprecated>)替代；API version 20及以后，建议使用[getMinVolumeByStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#getminvolumebystream20>)替代。
...
从API version 7开始支持，从API version 9开始废弃。在API version 9-19建议使用[getMaxVolume](<../Interface (AudioVolumeGroupManager)/arkts-apis-audio-audiovolumegroupmanager.md#getmaxvolumedeprecated>)替代；API version 20及以后，建议使用[getMaxVolumeByStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#getmaxvolumebystream20>)替代。
...
从API version 7开始支持，从API version 9开始废弃。在API version 9-19建议使用[isMute](<../Interface (AudioVolumeGroupManager)/arkts-apis-audio-audiovolumegroupmanager.md#ismutedeprecated>)替代；API version 20及以后，建议使用[isSystemMutedForStream](<../Interface (AudioVolumeManager)/arkts-apis-audio-audiovolumemanager.md#issystemmutedforstream20>)替代。
...
从API version 7开始支持，从API version 9开始废弃。在API version 9-19建议使用[isActive](<../Interface (AudioStreamManager)/arkts-apis-audio-audiostreammanager.md#isactivedeprecated>)替代；API version 20及以后，建议使用[isStreamActive](<../Interface (AudioStreamManager)/arkts-apis-audio-audiostreammanager.md#isstreamactive20>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [AudioRingMode](../Enums/arkts-apis-audio-e.md#audioringmode) | 是 | 音频铃声模式。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[getRingerMode](<../Interface (AudioVolumeGroupManager)/arkts-apis-audio-audiovolumegroupmanager.md#getringermode9>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AudioRingMode](../Enums/arkts-apis-audio-e.md#audioringmode)> | 是 | 回调函数。当获取铃声模式成功，err为undefined，data为获取到的铃声模式；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioRingMode](../Enums/arkts-apis-audio-e.md#audioringmode)> | Promise对象，返回系统的铃声模式。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[getDevices](<../Interface (AudioRoutingManager)/arkts-apis-audio-audioroutingmanager.md#getdevices9>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceFlag | [DeviceFlag](../Enums/arkts-apis-audio-e.md#deviceflag) | 是 | 音频设备类型。 |
| callback | AsyncCallback<[AudioDeviceDescriptors](../Types/arkts-apis-audio-t.md#audiodevicedescriptors)> | 是 | 回调函数。当获取音频设备列表成功，err为undefined，data为获取到的音频设备列表；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioDeviceDescriptors](../Types/arkts-apis-audio-t.md#audiodevicedescriptors)> | Promise对象，返回设备列表。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[setCommunicationDevice](<../Interface (AudioRoutingManager)/arkts-apis-audio-audioroutingmanager.md#setcommunicationdevice9>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceType | [ActiveDeviceType](../Enums/arkts-apis-audio-e.md#activedevicetypedeprecated) | 是 | 活跃音频设备类型。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[isCommunicationDeviceActive](<../Interface (AudioRoutingManager)/arkts-apis-audio-audioroutingmanager.md#iscommunicationdeviceactive9>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[isMicrophoneMute](<../Interface (AudioVolumeGroupManager)/arkts-apis-audio-audiovolumegroupmanager.md#ismicrophonemute9>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[on('deviceChange')](<../Interface (AudioRoutingManager)/arkts-apis-audio-audioroutingmanager.md#ondevicechange9>)替代。
...
| callback | Callback<[DeviceChangeAction](<../Interfaces (其他)/arkts-apis-audio-i.md#devicechangeaction>)> | 是 | 回调函数，返回设备更新详情。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[off('deviceChange')](<../Interface (AudioRoutingManager)/arkts-apis-audio-audioroutingmanager.md#offdevicechange9>)替代。
...
| callback | Callback<[DeviceChangeAction](<../Interfaces (其他)/arkts-apis-audio-i.md#devicechangeaction>)> | 否 | 回调函数，返回设备更新详情。 |
...
与[on('audioInterrupt')](<../Interface (AudioRenderer)/arkts-apis-audio-audiorenderer.md#onaudiointerrupt9>)作用一致，均用于监听焦点变化。为无音频流的场景（未曾创建AudioRenderer对象），比如FM、语音唤醒等提供焦点变化监听功能。

说明

从API version 7开始支持，从API version 11开始废弃，建议使用[on('audioInterrupt')](<../Interface (AudioCapturer)/arkts-apis-audio-audiocapturer.md#onaudiointerrupt10>)替代。
...
| interrupt | [AudioInterrupt](<../Interfaces (其他)/arkts-apis-audio-i.md#audiointerruptdeprecated>) | 是 | 音频打断事件类型的参数。 |
| callback | Callback<[InterruptAction](<../Interfaces (其他)/arkts-apis-audio-i.md#interruptactiondeprecated>)> | 是 | 回调函数，返回打断事件信息。 |
...
从API version 7开始支持，从API version 11开始废弃，建议使用[off('audioInterrupt')](<../Interface (AudioCapturer)/arkts-apis-audio-audiocapturer.md#offaudiointerrupt10>)替代。
...
| interrupt | [AudioInterrupt](<../Interfaces (其他)/arkts-apis-audio-i.md#audiointerruptdeprecated>) | 是 | 音频打断事件类型的参数。 |
| callback | Callback<[InterruptAction](<../Interfaces (其他)/arkts-apis-audio-i.md#interruptactiondeprecated>)> | 否 | 回调函数，返回打断事件信息。 |
