...
scraped_at: 2026-06-01T16:16:53+08:00
doc_updated_at: 2026-03-27
content_hash: sha256:c7e7b5a734ea2fcad0633fcb9ee986cbda19cbe6947524fe28c6c1c6a66aef19
---
音频流管理。

在使用AudioStreamManager的接口之前，需先通过[getStreamManager](<../Interface (AudioManager)/arkts-apis-audio-audiomanager.md#getstreammanager9>)获取AudioStreamManager实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AudioRendererChangeInfoArray](../Types/arkts-apis-audio-t.md#audiorendererchangeinfoarray9)> | 是 | 回调函数。当获取当前音频渲染器的信息成功，err为undefined，data为获取到的当前音频渲染器的信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioRendererChangeInfoArray](../Types/arkts-apis-audio-t.md#audiorendererchangeinfoarray9)> | Promise对象，返回当前音频渲染器信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioRendererChangeInfoArray](../Types/arkts-apis-audio-t.md#audiorendererchangeinfoarray9) | 返回当前音频渲染器信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AudioCapturerChangeInfoArray](../Types/arkts-apis-audio-t.md#audiocapturerchangeinfoarray9)> | 是 | 回调函数。当获取当前音频采集器的信息成功，err为undefined，data为获取到的当前音频采集器的信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AudioCapturerChangeInfoArray](../Types/arkts-apis-audio-t.md#audiocapturerchangeinfoarray9)> | Promise对象，返回当前音频采集器信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioCapturerChangeInfoArray](../Types/arkts-apis-audio-t.md#audiocapturerchangeinfoarray9) | 返回当前音频采集器信息。 |
...
| callback | Callback<[AudioRendererChangeInfoArray](../Types/arkts-apis-audio-t.md#audiorendererchangeinfoarray9)> | 是 | 回调函数，返回当前音频渲染器信息。 |
...
| callback18+ | Callback<[AudioRendererChangeInfoArray](../Types/arkts-apis-audio-t.md#audiorendererchangeinfoarray9)> | 否 | 回调函数，返回当前音频渲染器信息。 |
...
| callback | Callback<[AudioCapturerChangeInfoArray](../Types/arkts-apis-audio-t.md#audiocapturerchangeinfoarray9)> | 是 | 回调函数，返回当前音频采集器信息。 |
...
| callback18+ | Callback<[AudioCapturerChangeInfoArray](../Types/arkts-apis-audio-t.md#audiocapturerchangeinfoarray9)> | 否 | 回调函数，返回当前音频采集器信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| volumeType | [AudioVolumeType](../Enums/arkts-apis-audio-e.md#audiovolumetype) | 是 | 音频流类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streamUsage | [StreamUsage](../Enums/arkts-apis-audio-e.md#streamusage) | 是 | 音频流使用类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| usage | [StreamUsage](../Enums/arkts-apis-audio-e.md#streamusage) | 是 | 音频流使用类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sourceType | [SourceType](../Enums/arkts-apis-audio-e.md#sourcetype8) | 是 | 音源类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [AudioLoopbackMode](../Enums/arkts-apis-audio-e.md#audioloopbackmode20) | 是 | 音频返听模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sourceType | [SourceType](../Enums/arkts-apis-audio-e.md#sourcetype8) | 是 | 表示音源类型。 |
