...
scraped_at: 2026-06-01T16:17:04+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:8a5ce7470e21864587890927c6979b9dc3dd05f0018a931270227dc661a377aa
---
音效播放器提供了加载、卸载和播放系统声音的功能。

SystemSoundPlayer需要和[@ohos.multimedia.systemSoundManager](<../../@ohos.multimedia.systemSoundManager (系统声音管理)/js-apis-systemsoundmanager.md>)配合使用，才能完成管理系统音效的功能。
...
系统音效播放器提供了拍照和录制视频音效的播放功能。在调用SystemSoundPlayer的接口前，需要先通过[createSystemSoundPlayer](<../../@ohos.multimedia.systemSoundManager (系统声音管理)/js-apis-systemsoundmanager.md#systemsoundmanagercreatesystemsoundplayer>)创建系统音效播放器对象。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| soundType | [systemSoundManager.SystemSoundType](<../../@ohos.multimedia.systemSoundManager (系统声音管理)/js-apis-systemsoundmanager.md#systemsoundtype>) | 是 | 系统音效类型。 |
