...
scraped_at: 2026-06-01T16:17:15+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:b80939c99076f3a8686da2794f75ea4323d52d8e6498a475f9f2d52cb37e05a7
---
## 概述
...
| [OH\_AudioStream\_Result OH\_AudioRenderer\_GetAudioTimestampInfo(OH\_AudioRenderer\* renderer, int64\_t\* framePosition, int64\_t\* timestamp)](capi-native-audiorenderer-h.md#oh_audiorenderer_getaudiotimestampinfo) | - | 获取输出音频流时间戳和位置信息，适配倍速接口。  获取输出音频流时间戳和位置信息，通常用于进行音画同步对齐，播放位置单位为采样数（samples），时间戳单位为纳秒（nanosecond，ns）。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：参数renderer为nullptr。  AUDIOSTREAM\_ERROR\_ILLEGAL\_STATE：执行状态异常。 |
...
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| [OH\_AudioStream\_State](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_state)\* state | 指向一个用来接收音频流状态的变量。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：参数renderer为nullptr。 |
...
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| [OH\_AudioStream\_SampleFormat](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_sampleformat)\* sampleFormat | 指向一个用来接收音频流采样格式的变量。 |
...
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| [OH\_AudioStream\_LatencyMode](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_latencymode)\* latencyMode | 指向一个用来接收音频流时延模式的变量。 |
...
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| [OH\_AudioStream\_Usage](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_usage)\* usage | 指向一个用来接收输出类型音频流的使用类型的变量。 |
...
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| [OH\_AudioStream\_EncodingType](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_encodingtype)\* encodingType | 指向一个用来接收音频流编码类型的变量。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：  1. 参数renderer为nullptr；  2. 参数clockId无效。  AUDIOSTREAM\_ERROR\_ILLEGAL\_STATE：执行状态异常。 |
...
| [OH\_AudioRenderer\_OnMarkReachedCallback](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiorenderer_onmarkreachedcallback) callback | 当到达目标标记位置时回调。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：  1. 参数renderer为nullptr；  2. 参数samplePos无效。  AUDIOSTREAM\_ERROR\_ILLEGAL\_STATE：执行状态异常。  AUDIOSTREAM\_ERROR\_SYSTEM：出现系统错误。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：  1. 参数renderer为nullptr；  2. 参数volume无效。  AUDIOSTREAM\_ERROR\_ILLEGAL\_STATE：执行状态异常。  AUDIOSTREAM\_ERROR\_SYSTEM：出现系统错误。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：  1. 参数renderer为nullptr；  2. 参数volume为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：  1. 参数renderer为nullptr；  2. 参数count为nullptr。 |
...
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| [OH\_AudioChannelLayout](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_audio_channel_layout.h/capi-native-audio-channel-layout-h.md#oh_audiochannellayout>)\* channelLayout | 指向一个用来接收音频流声道布局的变量的指针。 |
...
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| [OH\_AudioStream\_AudioEffectMode](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_audioeffectmode)\* effectMode | 指向一个用来接收音频流音效模式的变量的指针。 |
...
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| [OH\_AudioStream\_AudioEffectMode](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_audioeffectmode) effectMode | 设置当前音频流的目标音效模式。 |
...
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| [OH\_AudioStream\_PrivacyType](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_privacytype)\* privacy | 用于返回当前流的内录策略。 |
...
本接口仅适用于音频流类型[OH\_AudioStream\_Usage](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_usage)为语音消息、VoIP语音通话或者VoIP视频通话的场景使用，以及可选的设备类型为听筒、扬声器和系统默认设备。
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：  1. 参数renderer为nullptr;  2. 参数deviceType无效。  AUDIOSTREAM\_ERROR\_ILLEGAL\_STATE：执行状态异常。  AUDIOSTREAM\_ERROR\_SYSTEM：出现系统错误。 |
...
| [OH\_AudioInterrupt\_ForceType](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiointerrupt_forcetype) type | 音频流中断类型。 |
| [OH\_AudioInterrupt\_Hint](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiointerrupt_hint) hint | 音频流中断提示类型。 |
...
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| void\* userData | 指向应用自定义的数据存储区域。 |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) error | 音频流播放错误结果。 |
...
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| [OH\_AudioStream\_FastStatus](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_faststatus)\* status | 指向接收低时延状态的指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：参数renderer为nullptr。  AUDIOSTREAM\_ERROR\_ILLEGAL\_STATE：执行状态异常，仅在释放状态之前可用。 |
...
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| void\* userData | 指向应用自定义的数据存储区域。 |
| [OH\_AudioStream\_FastStatus](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_faststatus) status | 返回当前低时延状态。 |
...
设置音频播放的响度值。默认的响度值是0.0dB。音频流播放类型必须是音乐[OH\_AudioStream\_Usage](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_usage).AUDIOSTREAM\_USAGE\_MUSIC，

电影或视频[OH\_AudioStream\_Usage](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_usage).AUDIOSTREAM\_USAGE\_MOVIE，

有声读物（包括听书、相声、评书）、听新闻、播客等[OH\_AudioStream\_Usage](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_usage).AUDIOSTREAM\_USAGE\_AUDIOBOOK。

音频流的时延模式必须是普通时延[OH\_AudioStream\_LatencyMode](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_latencymode).AUDIOSTREAM\_LATENCY\_MODE\_NORMAL。
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：  1. 参数renderer为nullptr，或音频流不支持设置响度；  2. 参数loudnessGain不在响度值范围内。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：  1. 参数renderer为nullptr；  2. 参数loudnessGain为nullptr。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向发生回调的实例。 |
| void\* userData | 指向通过回调函数传递的应用数据指针。 |
...
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| [OH\_AudioStream\_LatencyType](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_latencytype) type | 要获取的时延类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：  1. 参数renderer为nullptr；  2. 参数latencyMs为nullptr；  3. 参数type无效。  AUDIOSTREAM\_ERROR\_SYSTEM：系统内部错误，例如音频服务异常。 |
...
```
1. OH_AudioStream_Result OH_AudioRenderer_SetIndependentAudioSessionStrategy(OH_AudioRenderer* renderer, const OH_AudioSession_Strategy* strategy, uint32_t behavior)
```
...
| --- | --- |
| [OH\_AudioRenderer](../../结构体/OH_AudioRendererStruct/capi-ohaudio-oh-audiorendererstruct.md)\* renderer | 指向[OH\_AudioStreamBuilder\_GenerateRenderer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generaterenderer)创建的音频流实例。 |
| [const OH\_AudioSession\_Strategy](../../结构体/OH_AudioSession_Strategy/capi-ohaudio-oh-audiosession-strategy.md)\* strategy | 用于设置独立的音频会话策略。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：参数为空指针或超出范围。  AUDIOSTREAM\_ERROR\_ILLEGAL\_STATE：执行状态异常。 |
