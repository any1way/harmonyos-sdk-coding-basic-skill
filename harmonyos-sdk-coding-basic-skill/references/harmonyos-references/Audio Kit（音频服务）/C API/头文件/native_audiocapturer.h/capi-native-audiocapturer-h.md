...
scraped_at: 2026-06-01T16:17:09+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:cdd51f7e00354d0224242a63c69d06d20f6683527cd9d91f914cf99fa19360f5
---
## 概述
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AudioCapturer](../../结构体/OH_AudioCapturerStruct/capi-ohaudio-oh-audiocapturerstruct.md)\* capturer | 指向[OH\_AudioStreamBuilder\_GenerateCapturer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generatecapturer)创建的音频流实例。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：参数capturer为nullptr。  AUDIOSTREAM\_ERROR\_ILLEGAL\_STATE：执行状态异常。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：参数capturer为nullptr。 |
...
| --- | --- |
| [OH\_AudioCapturer](../../结构体/OH_AudioCapturerStruct/capi-ohaudio-oh-audiocapturerstruct.md)\* capturer | 指向[OH\_AudioStreamBuilder\_GenerateCapturer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generatecapturer)创建的音频流实例。 |
| [OH\_AudioStream\_SourceType](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_sourcetype)\* sourceType | 指向一个用来接收输入类型音频流的工作场景的变量。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：  1. 参数capturer为nullptr；  2. 参数clockId无效。  AUDIOSTREAM\_ERROR\_ILLEGAL\_STATE：执行状态异常。 |
...
```
1. OH_AudioStream_Result OH_AudioCapturer_SetMuteHint(OH_AudioCapturer* capturer, bool mute)
```
...
| 参数项 | 描述 |
| --- | --- |
| OH\_AudioCapturer\* capturer | 指向[OH\_AudioStreamBuilder\_GenerateCapturer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generatecapturer)创建的音频流实例。 |
...
| [OH\_AudioDeviceDescriptorArray](../../结构体/OH_AudioDeviceDescriptorArray/capi-ohaudio-oh-audiodevicedescriptorarray.md)\* deviceArray | 音频设备描述符数组。 |
...
| [OH\_AudioCapturer](../../结构体/OH_AudioCapturerStruct/capi-ohaudio-oh-audiocapturerstruct.md)\* capturer | 指向[OH\_AudioStreamBuilder\_GenerateCapturer](../native_audiostreambuilder.h/capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_generatecapturer)创建的音频流实例。 |
| void\* userData | 指向应用自定义的数据存储区域。 |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) error | 音频流录制错误结果。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：参数capturer为nullptr。  AUDIOSTREAM\_ERROR\_ILLEGAL\_STATE：执行状态异常，仅在释放状态之前可用。 |
...
| [OH\_AudioStream\_PlaybackCaptureStartState](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_playbackcapturestartstate) state | 表示内录请求是否成功的状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioStream\_Result](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_result) | AUDIOSTREAM\_SUCCESS：函数执行成功。  AUDIOSTREAM\_ERROR\_INVALID\_PARAM：capturer或callback是无效的。  AUDIOSTREAM\_ERROR\_ILLEGAL\_STATE：如果流已经在运行中或者已释放则是非法状态。  AUDIOSTREAM\_ERROR\_SYSTEM：系统内部错误，比如音频服务错误。 |
...
```
1. OH_AudioStream_Result OH_AudioCapturer_SetIndependentAudioSessionStrategy(OH_AudioCapturer* capturer, const OH_AudioSession_Strategy* strategy, uint32_t behavior)
```
