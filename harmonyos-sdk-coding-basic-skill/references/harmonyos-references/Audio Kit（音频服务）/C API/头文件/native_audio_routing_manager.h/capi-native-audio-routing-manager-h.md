...
scraped_at: 2026-06-01T16:17:11+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:51dadd94235f74f76023698c830a8c04e5a2ca83681e36fb1b93b53ab60d4c13
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_AudioRoutingManager](../../结构体/OH_AudioRoutingManager/capi-ohaudio-oh-audioroutingmanager.md) | OH\_AudioRoutingManager | 声明音频路由管理器。用于管理音频路由相关功能。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AudioDevice\_ChangeType](../native_audio_device_base.h/capi-native-audio-device-base-h.md#oh_audiodevice_changetype) type | 设备连接状态类型。 [OH\_AudioDevice\_ChangeType](../native_audio_device_base.h/capi-native-audio-device-base-h.md#oh_audiodevice_changetype) 已连接或断开。 |
| [OH\_AudioDeviceDescriptorArray](../../结构体/OH_AudioDeviceDescriptorArray/capi-ohaudio-oh-audiodevicedescriptorarray.md) \*audioDeviceDescriptorArray | 音频设备描述符数组，指向[OH\_AudioDeviceDescriptorArray](../../结构体/OH_AudioDeviceDescriptorArray/capi-ohaudio-oh-audiodevicedescriptorarray.md)设置音频设备描述符值的指针变量，不要单独释放audioDeviceDescriptorArray指针，而是调用[OH\_AudioRoutingManager\_ReleaseDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_releasedevices)来释放DeviceDescriptor数组。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AudioRoutingManager](../../结构体/OH_AudioRoutingManager/capi-ohaudio-oh-audioroutingmanager.md) \*\*audioRoutingManager | 音频路由管理器句柄。通过[OH\_AudioManager\_GetAudioRoutingManager](capi-native-audio-routing-manager-h.md#oh_audiomanager_getaudioroutingmanager)获取句柄。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AudioCommon\_Result](../native_audio_common.h/capi-native-audio-common-h.md#oh_audiocommon_result) | AUDIOCOMMON\_RESULT\_SUCCESS：函数执行成功。 |
...
| --- | --- |
| [OH\_AudioRoutingManager](../../结构体/OH_AudioRoutingManager/capi-ohaudio-oh-audioroutingmanager.md) \*audioRoutingManager | 音频路由管理器句柄。通过[OH\_AudioManager\_GetAudioRoutingManager](capi-native-audio-routing-manager-h.md#oh_audiomanager_getaudioroutingmanager)获取句柄。 |
| [OH\_AudioDevice\_Flag](../native_audio_device_base.h/capi-native-audio-device-base-h.md#oh_audiodevice_flag) deviceFlag | 音频设备标志，用于选择目标设备的滤波器参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioCommon\_Result](../native_audio_common.h/capi-native-audio-common-h.md#oh_audiocommon_result) | AUDIOCOMMON\_RESULT\_SUCCESS：函数执行成功。  AUDIOCOMMON\_RESULT\_ERROR\_INVALID\_PARAM：  1. 参数audioRoutingManager为nullptr；  2. 参数deviceFlag无效；  3. 参数audioDeviceDescriptorArray为nullptr。  AUDIOCOMMON\_RESULT\_ERROR\_NO\_MEMORY：内存不足。 |
...
| --- | --- |
| [OH\_AudioRoutingManager](../../结构体/OH_AudioRoutingManager/capi-ohaudio-oh-audioroutingmanager.md) \*audioRoutingManager | 音频路由管理器句柄。通过[OH\_AudioManager\_GetAudioRoutingManager](capi-native-audio-routing-manager-h.md#oh_audiomanager_getaudioroutingmanager)获取句柄。 |
| [OH\_AudioDevice\_Usage](../native_audio_device_base.h/capi-native-audio-device-base-h.md#oh_audiodevice_usage) deviceUsage | 指向[OH\_AudioDevice\_Usage](../native_audio_device_base.h/capi-native-audio-device-base-h.md#oh_audiodevice_usage)用于设置要获取的设备种类。 |
| [OH\_AudioDeviceDescriptorArray](../../结构体/OH_AudioDeviceDescriptorArray/capi-ohaudio-oh-audiodevicedescriptorarray.md) \*\*audioDeviceDescriptorArray | 音频设备描述符数组。设置音频设备描述符值的指针变量，不要单独释放audioDeviceDescriptorArray指针，而是调用[OH\_AudioRoutingManager\_ReleaseDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_releasedevices)来释放DeviceDescriptor数组。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioCommon\_Result](../native_audio_common.h/capi-native-audio-common-h.md#oh_audiocommon_result) | AUDIOCOMMON\_RESULT\_SUCCESS：函数执行成功。  AUDIOCOMMON\_RESULT\_ERROR\_INVALID\_PARAM：  1.参数audioRoutingManager为nullptr；  2.参数deviceUsage无效;  3.参数audioDeviceDescriptorArray为nullptr。  AUDIOCOMMON\_RESULT\_ERROR\_NO\_MEMORY：内存不足。 |
...
| --- | --- |
| [OH\_AudioRoutingManager](../../结构体/OH_AudioRoutingManager/capi-ohaudio-oh-audioroutingmanager.md) \*audioRoutingManager | 音频路由管理器句柄。通过[OH\_AudioManager\_GetAudioRoutingManager](capi-native-audio-routing-manager-h.md#oh_audiomanager_getaudioroutingmanager)获取句柄。 |
| [OH\_AudioStream\_Usage](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_usage) streamUsage | 指向[OH\_AudioStream\_Usage](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_usage)用于设置音频输出流的使用场景。 |
| [OH\_AudioDeviceDescriptorArray](../../结构体/OH_AudioDeviceDescriptorArray/capi-ohaudio-oh-audiodevicedescriptorarray.md) \*\*audioDeviceDescriptorArray | 音频设备描述符数组。设置音频设备描述符值的指针变量，不要单独释放audioDeviceDescriptorArray指针，而是调用[OH\_AudioRoutingManager\_ReleaseDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_releasedevices)来释放DeviceDescriptor数组。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioCommon\_Result](../native_audio_common.h/capi-native-audio-common-h.md#oh_audiocommon_result) | AUDIOCOMMON\_RESULT\_SUCCESS：函数执行成功。  AUDIOCOMMON\_RESULT\_ERROR\_INVALID\_PARAM：  1.参数audioRoutingManager为nullptr;  2.参数streamUsage无效;  3.参数audioDeviceDescriptorArray为nullptr。  AUDIOCOMMON\_RESULT\_ERROR\_NO\_MEMORY：内存不足。 |
...
| --- | --- |
| [OH\_AudioRoutingManager](../../结构体/OH_AudioRoutingManager/capi-ohaudio-oh-audioroutingmanager.md) \*audioRoutingManager | 音频路由管理器句柄。通过[OH\_AudioManager\_GetAudioRoutingManager](capi-native-audio-routing-manager-h.md#oh_audiomanager_getaudioroutingmanager)获取句柄。 |
| [OH\_AudioStream\_SourceType](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_sourcetype) sourceType | 指向[OH\_AudioStream\_SourceType](../native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_sourcetype)用于设置音频输入流的使用场景。 |
| [OH\_AudioDeviceDescriptorArray](../../结构体/OH_AudioDeviceDescriptorArray/capi-ohaudio-oh-audiodevicedescriptorarray.md) \*\*audioDeviceDescriptorArray | 音频设备描述符数组。设置音频设备描述符值的指针变量，不要单独释放audioDeviceDescriptorArray指针，而是调用[OH\_AudioRoutingManager\_ReleaseDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_releasedevices)来释放DeviceDescriptor数组。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioCommon\_Result](../native_audio_common.h/capi-native-audio-common-h.md#oh_audiocommon_result) | AUDIOCOMMON\_RESULT\_SUCCESS：函数执行成功。  AUDIOCOMMON\_RESULT\_ERROR\_INVALID\_PARAM：  1.参数audioRoutingManager为nullptr;  2.参数sourceType无效;  3.参数audioDeviceDescriptorArray为nullptr。  AUDIOCOMMON\_RESULT\_ERROR\_NO\_MEMORY：内存不足。 |
...
| --- | --- |
| [OH\_AudioRoutingManager](../../结构体/OH_AudioRoutingManager/capi-ohaudio-oh-audioroutingmanager.md) \*audioRoutingManager | 音频路由管理器句柄。通过[OH\_AudioManager\_GetAudioRoutingManager](capi-native-audio-routing-manager-h.md#oh_audiomanager_getaudioroutingmanager)获取句柄。 |
| [OH\_AudioDevice\_Flag](../native_audio_device_base.h/capi-native-audio-device-base-h.md#oh_audiodevice_flag) deviceFlag | 音频设备标志，用来注册回调。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioCommon\_Result](../native_audio_common.h/capi-native-audio-common-h.md#oh_audiocommon_result) | AUDIOCOMMON\_RESULT\_SUCCESS：函数执行成功。  AUDIOCOMMON\_RESULT\_ERROR\_INVALID\_PARAM：  1. 参数audioRoutingManager为nullptr；  2. 参数deviceFlag无效；  3. 参数callback为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioCommon\_Result](../native_audio_common.h/capi-native-audio-common-h.md#oh_audiocommon_result) | AUDIOCOMMON\_RESULT\_SUCCESS：函数执行成功。  AUDIOCOMMON\_RESULT\_ERROR\_INVALID\_PARAM：  1. 参数audioRoutingManager为nullptr；  2. 参数callback为nullptr。 |
...
| --- | --- |
| [OH\_AudioRoutingManager](../../结构体/OH_AudioRoutingManager/capi-ohaudio-oh-audioroutingmanager.md) \*audioRoutingManager | 音频路由管理器句柄。通过[OH\_AudioManager\_GetAudioRoutingManager](capi-native-audio-routing-manager-h.md#oh_audiomanager_getaudioroutingmanager)获取句柄。 |
| [OH\_AudioDeviceDescriptorArray](../../结构体/OH_AudioDeviceDescriptorArray/capi-ohaudio-oh-audiodevicedescriptorarray.md) \*audioDeviceDescriptorArray | 音频设备描述符数组应当被释放，获取请调用[OH\_AudioRoutingManager\_GetDevices](capi-native-audio-routing-manager-h.md#oh_audioroutingmanager_getdevices)接口。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AudioCommon\_Result](../native_audio_common.h/capi-native-audio-common-h.md#oh_audiocommon_result) | AUDIOCOMMON\_RESULT\_SUCCESS：函数执行成功。  AUDIOCOMMON\_RESULT\_ERROR\_INVALID\_PARAM：  1. 参数audioRoutingManager为nullptr；  2. 参数audioDeviceDescriptorArray为nullptr。 |
...
| [OH\_AudioDevice\_BlockStatus](../native_audio_device_base.h/capi-native-audio-device-base-h.md#oh_audiodevice_blockstatus) status | 音频设备的堵塞状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AudioCommon\_Result](../native_audio_common.h/capi-native-audio-common-h.md#oh_audiocommon_result) | AUDIOCOMMON\_RESULT\_SUCCESS：函数执行成功。  AUDIOCOMMON\_RESULT\_ERROR\_INVALID\_PARAM：  1.参数audioRoutingManager为nullptr；  2.参数supported为nullptr。 |
