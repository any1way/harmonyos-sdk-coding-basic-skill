...
scraped_at: 2026-06-11T16:16:16+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:4f23343962fb29b122a3918b8d465265f67cb598e3ca089441ad9e593d483c7a
---
...
以下错误码的详细介绍请参见[电话子系统错误码](<../../../网络/Telephony Kit（蜂窝通信服务）/错误码/电话子系统错误码/errorcode-telephony.md>)。
...
| --- | --- | --- | --- |
| context | [Context](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>) | 是 | 应用上下文。 |
| predicates | [dataSharePredicates.DataSharePredicates](<../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.dataSharePredicates (数据共享谓词)/js-apis-data-datasharepredicates.md>) | 是 | 查询语句。 |
