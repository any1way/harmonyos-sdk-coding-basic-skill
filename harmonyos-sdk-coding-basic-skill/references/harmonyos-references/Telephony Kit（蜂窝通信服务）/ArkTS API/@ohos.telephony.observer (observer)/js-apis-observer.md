...
scraped_at: 2026-06-11T16:16:10+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:f32b1e3186a9f92c3e9d3cfefa4f6c321635a6acf172cc0dc7ae751191d139db
---
...
| 类型 | 说明 |
| --- | --- |
| [radio.NetworkState](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#networkstate>) | 网络注册状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [radio.SignalInformation](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#signalinformation>) | 网络信号强度信息对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [data.DataConnectState](<../@ohos.telephony.data (蜂窝数据)/js-apis-telephony-data.md#dataconnectstate>) | 描述蜂窝数据链路连接状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [radio.RadioTechnology](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#radiotechnology>) | 无线接入技术。 |
...
| 类型 | 说明 |
| --- | --- |
| [data.DataFlowType](<../@ohos.telephony.data (蜂窝数据)/js-apis-telephony-data.md#dataflowtype>) | 描述蜂窝数据流类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [call.CallState](<../@ohos.telephony.call (拨打电话)/js-apis-call.md#callstate>) | 通话状态码（去电过程仅通知CALL\_STATE\_OFFHOOK状态）。 |
...
| 类型 | 说明 |
| --- | --- |
| [call.CCallState](<../@ohos.telephony.call (拨打电话)/js-apis-call.md#ccallstate23>) | 通话状态码（运营商通话状态码）。 |
...
| 类型 | 说明 |
| --- | --- |
| [sim.CardType](<../@ohos.telephony.sim (SIM卡管理)/js-apis-sim.md#cardtype7>) | 卡类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [sim.SimState](<../@ohos.telephony.sim (SIM卡管理)/js-apis-sim.md#simstate>) | SIM卡状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [call.TelCallState](<../@ohos.telephony.call (拨打电话)/js-apis-call.md#telcallstate21>) | 通话状态码（去电过程通知去电号码状态TEL\_CALL\_STATE\_OFFHOOK和去电接通状态TEL\_CALL\_STATE\_CONNECTED）。 |
...
| callback | Callback<[NetworkState](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#networkstate>)> | 是 | 回调函数，返回网络状态对象。参考radio的[NetworkState](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#networkstate>)。 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码说明文档](../../../通用错误码/errorcode-universal.md)和[电话子系统错误码](<../../../网络/Telephony Kit（蜂窝通信服务）/错误码/电话子系统错误码/errorcode-telephony.md>)。
...
| --- | --- | --- | --- |
| type | string | 是 | 网络状态变化事件，参数固定为'networkStateChange'。 |
| callback | Callback<[NetworkState](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#networkstate>)> | 否 | 回调函数，返回网络状态对象。参考radio的[NetworkState](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#networkstate>)。 |
...
| callback | Callback<Array<[SignalInformation](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#signalinformation>)>> | 是 | 回调函数，返回信号强度对象。参考radio的[SignalInformation](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#signalinformation>)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 信号状态变化事件，参数固定为'signalInfoChange'。 |
| callback | Callback<Array<[SignalInformation](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#signalinformation>)>> | 否 | 回调函数，返回信号强度对象。参考radio的[SignalInformation](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#signalinformation>)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 通话状态变化事件，参数固定为'callStateChange'。 |
| callback | Callback<[CallStateInfo](js-apis-observer.md#callstateinfo11)> | 否 | 回调函数，返回通话状态信息对象。参考call的[CallState](<../@ohos.telephony.call (拨打电话)/js-apis-call.md#callstate>)。  number：电话号码。 |
...
| callback | Callback<[TelCallState](<../@ohos.telephony.call (拨打电话)/js-apis-call.md#telcallstate21>)> | 是 | 回调函数，返回通话状态对象。  应用可获取到TelCallState。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 通话状态变化事件，参数固定为'callStateChange'。 |
| callback | Callback<[TelCallState](<../@ohos.telephony.call (拨打电话)/js-apis-call.md#telcallstate21>)> | 否 | 回调函数，返回通话状态对象。参考call的[TelCallState](<../@ohos.telephony.call (拨打电话)/js-apis-call.md#telcallstate21>)。 |
...
| callback | Callback<[DataConnectionStateInfo](js-apis-observer.md#dataconnectionstateinfo11)> | 是 | 回调函数，返回蜂窝数据链路连接状态信息对象。参考data的[DataConnectState](<../@ohos.telephony.data (蜂窝数据)/js-apis-telephony-data.md#dataconnectstate>)，radio的[RadioTechnology](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#radiotechnology>)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 蜂窝数据链路连接状态事件，参数固定为'cellularDataConnectionStateChange'。 |
| callback | Callback<[DataConnectionStateInfo](js-apis-observer.md#dataconnectionstateinfo11)> | 否 | 回调函数，返回蜂窝数据链路连接状态信息对象。参考data的[DataConnectState](<../@ohos.telephony.data (蜂窝数据)/js-apis-telephony-data.md#dataconnectstate>)，radio的[RadioTechnology](<../@ohos.telephony.radio (网络搜索)/js-apis-radio.md#radiotechnology>)。 |
...
| callback | Callback<[DataFlowType](<../@ohos.telephony.data (蜂窝数据)/js-apis-telephony-data.md#dataflowtype>)> | 是 | 回调函数，返回数据流状态对象。参考data的[DataFlowType](<../@ohos.telephony.data (蜂窝数据)/js-apis-telephony-data.md#dataflowtype>)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 蜂窝数据业务的上下行数据流状态事件，参数固定为'cellularDataFlowChange'。 |
| callback | Callback<[DataFlowType](<../@ohos.telephony.data (蜂窝数据)/js-apis-telephony-data.md#dataflowtype>)> | 否 | 回调函数，返回数据流状态对象。参考data的[DataFlowType](<../@ohos.telephony.data (蜂窝数据)/js-apis-telephony-data.md#dataflowtype>)。 |
...
此接口不包含sim卡的激活状态，具体请参见[sim.isSimActive](<../@ohos.telephony.sim (SIM卡管理)/js-apis-sim.md#simissimactive7>)接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[CCallStateInfo](js-apis-observer.md#ccallstateinfo23)> | 是 | 回调函数，返回通话状态信息对象。  应用可获取到CCallState。 |
| options | [ObserverOptions](js-apis-observer.md#observeroptions11) | 否 | 电话相关事件订阅参数可选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[CCallStateInfo](js-apis-observer.md#ccallstateinfo23)> | 否 | 回调函数，返回通话状态信息对象。  应用可获取到CCallState。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [CardType](<../@ohos.telephony.sim (SIM卡管理)/js-apis-sim.md#cardtype7>) | 否 | 否 | SIM卡类型。 |
| state | [SimState](<../@ohos.telephony.sim (SIM卡管理)/js-apis-sim.md#simstate>) | 否 | 否 | SIM卡状态。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| state | [CallState](<../@ohos.telephony.call (拨打电话)/js-apis-call.md#callstate>) | 否 | 否 | 通话类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| state | [CCallState](<../@ohos.telephony.call (拨打电话)/js-apis-call.md#ccallstate23>) | 否 | 否 | 通话类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| state | [DataConnectState](<../@ohos.telephony.data (蜂窝数据)/js-apis-telephony-data.md#dataconnectstate>) | 否 | 否 | 数据连接状态。 |
