...
scraped_at: 2026-06-01T16:39:26+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:2b1f8c040410788750e874b952cbc38b47321f959d7e00135e885eeecc9281e5
---
...
FunctionalButton需要配合[functionalButtonComponentManager](../functionalButtonComponentManager(场景化融合Button组件管理)/scenario-fusion-functionalbuttoncomponentmanager.md)一起使用。
...
Button组件需要[functionalButtonComponentManager](../functionalButtonComponentManager(场景化融合Button组件管理)/scenario-fusion-functionalbuttoncomponentmanager.md)配合一起使用，完成相应功能。
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| params | functionalButtonComponentManager.[FunctionalButtonParams](../functionalButtonComponentManager(场景化融合Button组件管理)/scenario-fusion-functionalbuttoncomponentmanager.md#functionalbuttonparams) | 是 | @Prop | FunctionalButton组件参数。 |
| controller | functionalButtonComponentManager.[FunctionalButtonController](../functionalButtonComponentManager(场景化融合Button组件管理)/scenario-fusion-functionalbuttoncomponentmanager.md#functionalbuttoncontroller) | 是 | - | FunctionalButton组件控制器，用来接收组件的点击事件。 |
