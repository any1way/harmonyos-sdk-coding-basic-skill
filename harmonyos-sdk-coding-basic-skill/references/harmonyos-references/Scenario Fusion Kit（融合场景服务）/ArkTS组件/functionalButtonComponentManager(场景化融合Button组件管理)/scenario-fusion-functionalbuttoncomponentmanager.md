...
scraped_at: 2026-06-11T16:50:26+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:6ea64e2f187d4fd914e8cd3193536a611a485f7050674991c29bc7367699dff1
---
...
| label | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 按钮展示文字。默认值：空字符串。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
| permissionListParam | Array<[Permissions](../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/应用权限列表/app-permissions.md)> | 否 | 是 | 权限设置Button参数。  **起始版本：** 5.0.2(14)  **元服务API：** 从版本5.0.2(14)开始，该接口支持在元服务中使用。  **说明：**    需设置权限的权限名称列表，权限名称可参考[应用权限列表](../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/应用权限列表/app-permissions.md)。 |
...
| buttonModifier | [ButtonModifier](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#自定义modifier) | 否 | 是 | 设置Button的属性，如设置按钮的样式，颜色等。  **起始版本：** 5.1.0(18)  **元服务API：** 从版本5.1.0(18)开始，该接口支持在元服务中使用。 |
| textModifier | [TextModifier](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#自定义modifier) | 否 | 是 | 设置文本的属性，如设置文本颜色，字体大小，字重等。  **起始版本：** 5.1.0(18)  **元服务API：** 从版本5.1.0(18)开始，该接口支持在元服务中使用。 |
| loadingProgressModifier | [LoadingProgressModifier](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#自定义modifier) | 否 | 是 | 设置加载动效的属性，如设置加载动效的样式，颜色，定制内容区等。  **起始版本：** 5.1.0(18)  **元服务API：** 从版本5.1.0(18)开始，该接口支持在元服务中使用。  **说明：**    使用loadingProgressModifier时，需配合styleOption设置loading为true才能生效。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| code | string | 否 | 是 | 账号用户的临时登录凭证（Authorization Code）。  **说明：**    可通过临时登录凭证获取真实手机号，临时登录凭证时效5分钟，具体操作可参考“[服务端开发](<../../../../harmonyos-guides/应用服务/Account Kit（华为账号服务）/获取华为账号用户信息/获取手机号/快速验证/account-get-phonenumber.md#服务端开发>)”章节。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| bundleName | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 包名。 |
| abilityName | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | Ability名称。默认值：EntryAbility。 |
...
在调用此接口前，应用需要先调用[requestPermissionsFromUser](<../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.abilityAccessCtrl (程序访问控制管理)/js-apis-abilityaccessctrl.md#requestpermissionsfromuser9>)，如果用户在首次弹窗授权时已授权，调用当前接口将无法拉起弹窗。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| permissionResult | Array<abilityAccessCtrl.[GrantStatus](<../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.abilityAccessCtrl (程序访问控制管理)/js-apis-abilityaccessctrl.md#grantstatus>)> | 否 | 否 | 权限设置结果。 |
...
该接口功能依赖Account Kit，参见[createAuthorizationWithHuaweiIDRequest](<../../../Account Kit（华为账号服务）/ArkTS API/authentication (华为账号应用统一认证服务)/account-api-authentication.md#createauthorizationwithhuaweiidrequest>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[GetPhoneNumberResult](scenario-fusion-functionalbuttoncomponentmanager.md#getphonenumberresult)> | 是 | 回调函数。当获取电话号码成功，err为undefined，data为获取到的账号用户的临时登录凭证（Authorization Code）；否则为错误对象。  **说明：**    可通过临时登录凭证获取真实手机号，临时登录凭证时效5分钟，具体操作可参考“[服务端开发](<../../../../harmonyos-guides/应用服务/Account Kit（华为账号服务）/获取华为账号用户信息/获取手机号/快速验证/account-get-phonenumber.md#服务端开发>)”章节。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [FunctionalButtonController](scenario-fusion-functionalbuttoncomponentmanager.md#functionalbuttoncontroller) | [FunctionalButton](../FunctionalButton（Button组件）/scenario-fusion-functionalbutton.md#functionalbutton)组件控制器。 |
...
该接口功能依赖Ability Kit，参见[startAbility](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#startability>)。
...
该接口功能依赖Ability Kit，参见[startAbilityForResult](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#startabilityforresult>)。
...
该接口功能依赖Account Kit，参见[chooseAddress](<../../../Account Kit（华为账号服务）/ArkTS API/shippingAddress (华为账号收货地址管理服务)/account-choose-address.md#chooseaddress>)。
...
该接口功能依赖Account Kit，参见[selectInvoiceTitle](<../../../Account Kit（华为账号服务）/ArkTS API/invoiceAssistant (华为账号发票助手服务)/account-api-invoiceassistant.md#selectinvoicetitle>)。
...
该接口功能依赖Account Kit，参见[createAuthorizationWithHuaweiIDRequest](<../../../Account Kit（华为账号服务）/ArkTS API/authentication (华为账号应用统一认证服务)/account-api-authentication.md#createauthorizationwithhuaweiidrequest>)，[AuthenticationController](<../../../Account Kit（华为账号服务）/ArkTS API/authentication (华为账号应用统一认证服务)/account-api-authentication.md#authenticationcontroller>)，[executeRequest](<../../../Account Kit（华为账号服务）/ArkTS API/authentication (华为账号应用统一认证服务)/account-api-authentication.md#executerequest>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| verifyToken | string | 是 | 验证成功的idToken，三方应用拉起华为账号客户端人脸验证页面时传入此Token，供华为账号客户端校验验证结果，参见[FacialRecognitionVerificationRequest](<../../../Account Kit（华为账号服务）/ArkTS API/realName (华为账号实名认证服务)/account-api-realname.md#facialrecognitionverificationrequest>)。 |
...
该接口功能依赖Map Kit，参见[chooseLocation](<../../../Map Kit（地图服务）/ArkTS API/sceneMap（场景化控件）/map-scenemap.md#chooselocation>)。
...
该接口功能依赖Ability Kit，参见[requestPermissionOnSetting](<../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.abilityAccessCtrl (程序访问控制管理)/js-apis-abilityaccessctrl.md#requestpermissiononsetting12>)。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10004](../ArkTS组件错误码/scenario-fusion-error-code.md#section10004-系统内部异常) | Internal error. |
| [10008](../ArkTS组件错误码/scenario-fusion-error-code.md#section10008-调用方非元服务) | Not atomic service. |
...
| --- | --- |
| [10004](../ArkTS组件错误码/scenario-fusion-error-code.md#section10004-系统内部异常) | Internal error. |
| [10006](../ArkTS组件错误码/scenario-fusion-error-code.md#section10006-获取分享数据失败) | Failed to get data. |
| [10008](../ArkTS组件错误码/scenario-fusion-error-code.md#section10008-调用方非元服务) | Not atomic service. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ButtonType](../../../ArkUI（方舟UI框架）/ArkTS组件/按钮与选择/Button/ts-basic-components-button.md#buttontype枚举说明) | 是 | 描述按钮显示样式。  默认值：ButtonType.Capsule |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 设置字体颜色。  默认值：#ffffff |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 是 | 设置字体大小，[Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length)为number类型时，使用fp单位。  字体默认大小16fp。不支持设置百分比字符串。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | number | [FontWeight](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#fontweight) | 是 | 设置文本的字体粗细，number类型取值[100, 900]，取值间隔为100，默认为400，取值越大，字体越粗。string类型仅支持number类型取值的字符串形式，例如"400"，以及"bold"，"bolder"，"lighter"，"regular"，"medium"，"normal"，分别对应FontWeight中相应的枚举值。  默认值：FontWeight.Normal |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [FontStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#fontstyle) | 是 | 设置字体样式。  默认值：FontStyle.Normal |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | [Resource](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resource) | 是 | 设置字体列表。默认字体'HarmonyOS Sans'，当前支持'[HarmonyOS Sans](https://developer.huawei.com/consumer/cn/doc/design-guides/font-0000001828772001#section51091561209)'字体和[注册自定义字体](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.font (注册自定义字体)/js-apis-font.md>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 是 | 设置组件自身的宽度，缺省时使用元素自身内容需要的宽度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 是 | 设置组件自身的高度，缺省时使用元素自身内容需要的高度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SizeOptions](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#sizeoptions) | 是 | 设置高宽尺寸。举例：  {  width: 20,  height: 50  }  单位：vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ConstraintSizeOptions](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#constraintsizeoptions) | 是 | 设置约束尺寸，组件布局时，进行尺寸范围限制。constraintSize的优先级高于width和height。取值结果参考[constraintSize取值对width/height影响](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#constraintsize)。  默认值：  {  minWidth: 0,  maxWidth: Infinity,  minHeight: 0,  maxHeight: Infinity  }  单位：vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | [Padding](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#padding) | 是 | 设置内边距属性。  参数为Length类型时，四个方向内边距同时生效。  默认值：{left: 16, right: 16}  单位：vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | [Padding](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#padding) | 是 | 设置外边距属性。  参数为Length类型时，四个方向外边距同时生效。  默认值：0  单位：vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 设置组件的背景色。  默认值：#ff007dff |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 图片地址，支持网络图片资源和本地图片资源地址，不支持svg类型的图片。 |
| repeat | [ImageRepeat](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#imagerepeat) | 否 | 设置背景图的重复样式，默认不重复。当设置的背景图片为透明底色图片，且同时设置了backgroundColor时，二者叠加显示，背景颜色在最底部。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SizeOptions](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#sizeoptions) | [ImageSize](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#imagesize) | 是 | 设置背景图像的高度和宽度。当输入为{width: Length, height: Length}对象时，如果只设置一个属性，则第二个属性保持图片原始宽高比进行调整。默认保持原图的比例不变。  width和height取值范围： [0, +∞)  默认值：ImageSize.Auto  **说明：**    设置为小于0的值时，按值为0显示。当设置了height未设置width时，width根据图片原始宽高比进行调整。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Position](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#position) | [Alignment](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#alignment) | 是 | 设置背景图像在组件中显示位置，即相对于组件左上角的坐标，单位vp。  默认值：  {  x: 0,  y: 0  }  x和y值设置百分比时，偏移量是相对组件自身宽高计算的。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [Resource](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resource) | 是 | 元素的不透明度，取值范围为0到1，默认值：1，1表示不透明，0表示完全透明，达到隐藏组件效果，但是在布局中占位。  **说明：**    子组件可以继承父组件的此属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BorderOptions](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#borderoptions) | 是 | 统一边框样式设置接口。  - width：设置边框宽度。  - color：设置边框颜色。  - radius：设置边框圆角半径。  - style：设置边框样式。  **说明：**    边框宽度默认值为0，即不显示边框。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BorderStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#borderstyle) | [EdgeStyles](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#edgestyles9) | 是 | 设置元素的边框样式。  默认值：BorderStyle.Solid |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | [EdgeWidths](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#edgewidths9) | 是 | 设置元素的边框宽度，不支持百分比。  默认值：1，单位：vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | [EdgeColors](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#edgecolors9) | 是 | 设置元素的边框颜色。  默认值：#000000 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | [BorderRadiuses](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#borderradiuses9) | 是 | 设置元素的边框圆角半径，不支持百分比。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BorderImageOption](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/图片边框设置/ts-universal-attributes-border-image.md#borderimageoption对象说明) | 是 | 图片边框或者渐变色边框设置接口。  该接口支持在ArkTS卡片中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ScaleOptions](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/视效与模糊/图形变换/ts-universal-attributes-transformation.md#scaleoptions对象说明) | 是 | 可以分别设置X轴、Y轴、Z轴的缩放比例，默认值为1.0，同时可以通过centerX和centerY设置缩放的中心点。  默认值：  {  x: 1.0,  y: 1.0,  z: 1.0,  centerX:'0.5',  centerY:'0.5'  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Alignment](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#alignment) | 是 | 设置元素内容的对齐方式，只有当设置的width和height大小超过元素本身内容大小时生效。  默认值：Alignment.Center |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Position](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#position) | 是 | 设置元素在位置定位时的锚点，以元素顶部起点作为基准点进行偏移，单位vp。  默认值：  {  x: 0,  y: 1  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 设置图标颜色。默认值：#FFFFFF  **说明：**    设置为异常值时，按值为'#ff666666'显示。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 是 | 设置图标自身的宽度。默认值：20，单位：vp。  取值范围：(-∞, +∞)  填写为负数时，宽度不超过按钮大小；填写正数时，宽度不受限于按钮大小，请合理填写数值。  **说明：**    [LoadingProgress](../../../ArkUI（方舟UI框架）/ArkTS组件/信息展示/LoadingProgress/ts-basic-components-loadingprogress.md)图标始终保持正方形，在显示时边长会取loadingWidth和[loadingHeight](scenario-fusion-functionalbuttoncomponentmanager.md#loadingheight)中的最小值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 是 | 设置图标自身的高度。默认值：20，单位：vp。  取值范围：(-∞, +∞)  填写为负数时，高度不超过按钮大小。填写正数时，高度不受限于按钮大小，请合理填写数值。  **说明：**    [LoadingProgress](../../../ArkUI（方舟UI框架）/ArkTS组件/信息展示/LoadingProgress/ts-basic-components-loadingprogress.md)图标始终保持正方形，在显示时边长会取[loadingWidth](scenario-fusion-functionalbuttoncomponentmanager.md#loadingwidth)和loadingHeight中的最小值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | [Padding](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#padding) | 是 | 设置图标内边距属性。单位：vp。  默认值：0  取值范围：(-∞, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | [Padding](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#padding) | 是 | 设置图标外边距属性。单位：vp。  默认值：{left: -2, right: 2}  取值范围：(-∞, +∞) |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/gpWENhPXR9SVoxa2k8Hqig/zh-cn_image_0000002622700943.png?HW-CC-KV=V1&HW-CC-Date=20260611T085023Z&HW-CC-Expire=86400&HW-CC-Sign=344392C191B88C4AAD033C7B85B8ACC490A70C698E9AE6D6E8C97A728773B439)
