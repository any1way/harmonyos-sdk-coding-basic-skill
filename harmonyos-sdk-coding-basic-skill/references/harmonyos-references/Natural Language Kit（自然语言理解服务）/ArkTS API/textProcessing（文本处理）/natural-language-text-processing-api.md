...
scraped_at: 2026-06-01T16:40:36+08:00
doc_updated_at: 2026-05-12
content_hash: sha256:0992b9e6d54960a8f5d696dfec3c20224ff4b751b0b625f10b7685fa1b051a3c
---
...
| --- | --- | --- | --- | --- |
| word | string | 否 | 否 | 词语。 |
| wordTag | string | 否 | 否 | 词性。词性分类参考[wordTag](../wordTag（词性）/natural-language-word-tag-api.md)。 |
...
| jsonObject | string | 否 | 否 | 实体的其他字段。详情参考[jsonObject](../jsonObject（实体的其他字段）/natural-language-json-object-api.md)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| text | string | 是 | 输入待分析的文本内容。相关规格参考[约束与限制](<../../../../harmonyos-guides/AI/Natural Language Kit（自然语言理解服务）/Natural Language Kit简介/natural-language-introduction.md#约束与限制>)。 |
...
以下错误码的详细介绍请参见[Natural Language Kit错误码](<../../ArkTS API错误码/natural-language-error-code.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| text | string | 是 | 输入的字符串。相关规格参考[约束与限制](<../../../../harmonyos-guides/AI/Natural Language Kit（自然语言理解服务）/Natural Language Kit简介/natural-language-introduction.md#约束与限制>)。 |
