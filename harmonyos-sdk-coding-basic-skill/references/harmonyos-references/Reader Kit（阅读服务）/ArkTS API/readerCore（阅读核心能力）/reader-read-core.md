...
scraped_at: 2026-06-01T16:39:18+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:2b3ce90b416797373133fecf66df31a5ca8a5458c364d70f4761159a01a2f889
---
...
| resourceIndex | number | 否 | 否 | 书脊内容节点索引[SpineItem](../bookParser（书籍解析能力）/reader-book-parser.md#spineitem).index。 |
...
| fontPath | string | 否 | 否 | 字体文件本地路径。  支持两种存放路径：  - 工程目录resources/rawfile文件夹。适合预置字体场景。  - [应用沙箱目录](<../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/应用沙箱目录/app-sandbox-directory.md>)。适合在线下载字体场景。 |
...
| themeBgImg | string | 否 | 否 | 主题背景图路径，用于阅读页背景的绘制。  支持两种存放路径：  - 工程目录resources/rawfile文件夹。适合预置背景图场景。  - [应用沙箱目录](<../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/应用沙箱目录/app-sandbox-directory.md>)。适合在线下载背景图场景。 |
| flipMode | string | 否 | 否 | 翻页方式。  - '0'：仿真。  - '1'：横滑。  默认值为0。 |
| scaledDensity | number | 否 | 否 | 系统显示文本的缩放因子，该值通过[display.getDefaultDisplaySync().scaledDensity](<../../../ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#displaygetdefaultdisplaysync9>)字段获取。  在智慧多窗等场景，文本缩放因子发生变化时，开发者需要调用ReaderComponentController组件控制器的[setPageConfig](reader-read-core.md#setpageconfig)接口更新该属性。 |
...
[ReadPageComponent](../../ArkTS组件/ReadPageComponent（阅读页组件）/reader-api-readpagecomponent.md#readpagecomponent)组件控制器，需要配合ReadPageComponent组件一起使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | common.[UIAbilityContext](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md>) | 是 | 当前应用上下文。 |
...
| [1016910004](<../../ArkTS API错误码/reader-error-code.md#section1016910004>) | Invalid caller. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bookParserHandler | bookParser.[BookParserHandler](../bookParser（书籍解析能力）/reader-book-parser.md#bookparserhandler) | 是 | 书籍解析器。 |
...
| --- | --- |
| [401](../../../通用错误码/errorcode-universal.md#section401-参数检查失败) | Parameter error. |
| [1016900002](<../../ArkTS API错误码/reader-error-code.md#section1016900002>) | Read Page Component is not initialized. |
| [1016900003](<../../ArkTS API错误码/reader-error-code.md#section1016900003>) | Invalid request. |
| [1016900999](<../../ArkTS API错误码/reader-error-code.md#section1016900999>) | Other error. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| spineIndex | number | 是 | 内容资源索引[SpineItem](../bookParser（书籍解析能力）/reader-book-parser.md#spineitem).index。 |
...
| [1016900003](<../../ArkTS API错误码/reader-error-code.md#section1016900003>) | Invalid request. |
| [1016900999](<../../ArkTS API错误码/reader-error-code.md#section1016900999>) | Other error. |
| [1016910001](<../../ArkTS API错误码/reader-error-code.md#section1016910001>) | Invalid spine item. |
| [1016910002](<../../ArkTS API错误码/reader-error-code.md#section1016910002>) | Unexpected spine item resource data. |
| [1016910003](<../../ArkTS API错误码/reader-error-code.md#section1016910003>) | Spine item resource data out of range. |
...
触发[ReadPageComponent](../../ArkTS组件/ReadPageComponent（阅读页组件）/reader-api-readpagecomponent.md#readpagecomponent)组件进行翻页。
...
| callback | bookParser.[CallbackRes](../bookParser（书籍解析能力）/reader-book-parser.md#callbackres)<string, ArrayBuffer> | 是 | 回调函数，string：请求资源路径。ArrayBuffer：请求资源对应的二进制数据。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为“resourceRequest”。 |
| callback | bookParser.[CallbackRes](../bookParser（书籍解析能力）/reader-book-parser.md#callbackres)<string, ArrayBuffer> | 否 | 回调函数，需要传[on('resourceRequest')](reader-read-core.md#onresourcerequest)注册时的回调函数，若不传则注销所有的回调函数。 |
