...
scraped_at: 2026-06-01T16:39:17+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:a819c149778c52b138e9930fc81a961d712ade8d621b0697bfa306479bdc5f5c
---
本模块提供书籍解析的能力，支持对txt、epub、mobi、azw、azw3格式的书籍文件进行解析。通过提前导入到[应用沙箱目录](<../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/应用沙箱目录/app-sandbox-directory.md>)中的书籍文件，初始化[BookParserHandler](reader-book-parser.md#bookparserhandler)。将书籍基本信息、[书脊](<../../../../harmonyos-guides/应用服务/Reader Kit（阅读服务）/Reader Kit简介/reader-introduction.md#基本概念>)内容列表、目录列表和章节内容解析出来。
...
| bookCharset | string | 否 | 是 | 书籍内容的字符集，根据书籍编码格式决定，例如："utf-8"。具体支持格式可参考[TextEncoder](<../../../ArkTS（方舟编程语言）/ArkTS API/@ohos.util (util工具函数)/js-apis-util.md#textencoder>)定义。（预留字段，暂不支持。） |
...
书籍资源请求回调接口，在排版引擎渲染界面时调用，需配合ReaderComponentController的注册接口[on('resourceRequest')](../readerCore（阅读核心能力）/reader-read-core.md#onresourcerequest)使用。如果有自定义背景及字体资源，需要在此返回对应资源。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | string | 是 | 本地书籍文件路径（仅支持当前应用下的[应用沙箱目录](<../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/应用沙箱目录/app-sandbox-directory.md>)）。 |
...
| [1017000999](<../../ArkTS API错误码/reader-error-code.md#section1017000999>) | Other error. |
| [1017010003](<../../ArkTS API错误码/reader-error-code.md#section1017010003>) | Book file format is unexpected. |
| [1017010004](<../../ArkTS API错误码/reader-error-code.md#section1017010004>) | File is not exist. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1017000001](<../../ArkTS API错误码/reader-error-code.md#section1017000001>) | Book parser is not initialized. |
| [1017000999](<../../ArkTS API错误码/reader-error-code.md#section1017000999>) | Other error. |
| [1017010002](<../../ArkTS API错误码/reader-error-code.md#section1017010002>) | Invalid request. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [401](../../../通用错误码/errorcode-universal.md#section401-参数检查失败) | Parameter error. Possible causes: 1.Incorrect parameter types; 2. Parameter out of range. |
| [1017000001](<../../ArkTS API错误码/reader-error-code.md#section1017000001>) | Book parser is not initialized. |
| [1017000999](<../../ArkTS API错误码/reader-error-code.md#section1017000999>) | Other error. |
| [1017010001](<../../ArkTS API错误码/reader-error-code.md#section1017010001>) | Invalid spine item. |
| [1017010002](<../../ArkTS API错误码/reader-error-code.md#section1017010002>) | Invalid request. |
...
开发者通过此接口可获取书封资源。同时排版引擎获取书籍里的图片等资源时，会优先调用该方法，如果获取不到资源会继续调用[on('resourceRequest')](../readerCore（阅读核心能力）/reader-read-core.md#onresourcerequest)获取资源。
