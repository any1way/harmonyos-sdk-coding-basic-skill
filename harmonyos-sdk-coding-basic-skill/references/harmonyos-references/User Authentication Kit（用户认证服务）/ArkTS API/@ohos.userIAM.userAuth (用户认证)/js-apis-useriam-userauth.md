...
scraped_at: 2026-06-11T16:13:39+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:f92dbe5aa52dbf2052a3aa0caa819b035bb00077bb595b86999beda8772f62b0
---
...
以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)和[用户认证错误码](../../错误码/用户认证错误码/errorcode-useriam.md)。
...
| authTrustLevel | [AuthTrustLevel](js-apis-useriam-userauth.md#authtrustlevel8) | 否 | 否 | 期望达到的认证可信等级。典型操作需要的身份认证可信等级，以及身份认证可信等级的划分请参见[认证可信等级划分原则](<../../../../harmonyos-guides/系统/安全/User Authentication Kit（用户认证服务）/User Authentication Kit简介/user-authentication-overview.md#生物认证可信等级划分原则>)。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
以下错误码的详细介绍请参见[用户认证错误码](../../错误码/用户认证错误码/errorcode-useriam.md)。
...
典型场景及举例可参考[认证可信等级划分原则](<../../../../harmonyos-guides/系统/安全/User Authentication Kit（用户认证服务）/User Authentication Kit简介/user-authentication-overview.md#生物认证可信等级划分原则>)。
