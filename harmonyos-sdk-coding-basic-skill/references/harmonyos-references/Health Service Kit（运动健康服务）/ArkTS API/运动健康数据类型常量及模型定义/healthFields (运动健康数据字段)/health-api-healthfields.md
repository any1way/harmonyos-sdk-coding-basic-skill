...
scraped_at: 2026-06-01T16:34:32+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:8a5e9853ada07ceb929246568e4dd280659255efd5f86aca2c04dd93cae71d43
---
本模块提供运动健康数据字段列表。
...
海拔详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| spo2 | Omit<[AggregateMetrics](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#aggregatemetrics>), 'sum' | 'count'> | 否 | 否 | 血氧饱和度聚合统计。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| bodyTemperature | Omit<[AggregateMetrics](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#aggregatemetrics>), 'sum' | 'last'> | 否 | 否 | 体温聚合统计。 |
...
步频详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
私处分泌物采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| step | Omit<[AggregateMetrics](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#aggregatemetrics>), 'max' | 'min' | 'avg' | 'last' | 'count'> | 否 | 否 | 步数聚合统计。 |
| calorie | Omit<[AggregateMetrics](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#aggregatemetrics>), 'max' | 'min' | 'avg' | 'last' | 'count'> | 否 | 否 | 卡路里聚合统计。 |
| distance | Omit<[AggregateMetrics](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#aggregatemetrics>), 'max' | 'min' | 'avg' | 'last' | 'count'> | 否 | 否 | 距离聚合统计。 |
| climbHighAltitude | Omit<[AggregateMetrics](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#aggregatemetrics>), 'max' | 'min' | 'avg' | 'last' | 'count'> | 否 | 否 | 爬高海拔差聚合统计。 |
| isIntensity | Omit<[AggregateMetrics](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#aggregatemetrics>), 'max' | 'min' | 'avg' | 'last' | 'count'> | 否 | 否 | 中高强度聚合统计。 |
| isStand | Omit<[AggregateMetrics](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#aggregatemetrics>), 'max' | 'min' | 'avg' | 'last' | 'count'> | 否 | 否 | 站立聚合统计。 |
...
潜水深度详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
痛经程度采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
运动心率详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| bpm | Omit<[AggregateMetrics](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#aggregatemetrics>), 'avg' | 'sum' | 'count'> | 否 | 否 | 动态心率聚合统计。 |
...
跳跃详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
位置详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
标记点采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
月经流量采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
心情采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
排卵试纸采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
踏频详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
身体症状采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
功率详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
阻力详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| restBpm | Omit<[AggregateMetrics](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#aggregatemetrics>), 'sum' | 'count' | 'max' | 'min' | 'avg'> | 否 | 否 | 静息心率聚合统计。 |
...
| paceMap | [healthStore.PaceValueType](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#pacevaluetype>) | 否 | 是 | 每公里的配速，若未填写，默认为空。单位：秒/公里  例如  '1.0':407.945  '2.0':473.98846  '2.170':473.98846  最后不满一公里的部分，按比例换算为整公里的配速存入。 |
| partTimeMap | [healthStore.PaceValueType](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#pacevaluetype>) | 否 | 是 | 公制分段数据表（key：公里，value：秒），若未填写，默认为空。  其中公里保留到小数点后4位。  Value是一个累积到当前公里的时间如：  - '1.0':3.0  - '2.0':6.0  - '3.0':9.0  - '21.0975':7020.0  - '42.195':18000.0  其中，21.0975，42.195分别为半马和全马的距离（仅半马全马key值小数点后不为0）。 |

## RunningForm

PhoneTabletWearable

跑姿详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
性行为采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
皮肤状态采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| skinTemperature | Omit<[AggregateMetrics](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#aggregatemetrics>), 'sum' | 'last'> | 否 | 否 | 皮肤体温聚合统计。 |

## SkipSpeed

PhoneTabletWearable

跳绳速度详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
睡眠状态采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
速度详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| stressScore | Omit<[AggregateMetrics](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#aggregatemetrics>), 'sum'> | 否 | 否 | 压力得分聚合统计。 |

## StrokeRate

PhoneTabletWearable

桨频采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
划水频率采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
SWOLF采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
...
水温采样数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)/health-api-healthstore.md#sequencepoint>)。
