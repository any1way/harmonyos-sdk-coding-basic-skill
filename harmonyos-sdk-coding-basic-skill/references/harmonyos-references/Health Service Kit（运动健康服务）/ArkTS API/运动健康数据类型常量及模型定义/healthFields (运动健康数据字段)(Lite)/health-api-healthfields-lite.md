...
scraped_at: 2026-06-01T16:34:39+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:43698ce975a772b2d5d13ae0b88e771297146087881934f1bee3c729a6eb2196
---
本模块提供运动健康数据字段列表。
...
海拔详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)(Lite)/health-api-healthstore-lite.md#sequencepoint>)。
...
运动心率详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)(Lite)/health-api-healthstore-lite.md#sequencepoint>)。
...
速度详情数据字段列表，继承[healthStore.SequencePoint](<../../healthStore (运动健康数据服务)(Lite)/health-api-healthstore-lite.md#sequencepoint>)。
...
| groups | [GroupSummary](health-api-healthfields-lite.md#groupsummary)[] | 否 | 否 | 训练组数详情。 |
...
| actions | [ActionSummary](health-api-healthfields-lite.md#actionsummary)[] | 否 | 动作类型组数。 |
...
| **名称** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| exerciseHeartRate | [ExerciseHeartRate](health-api-healthfields-lite.md#exerciseheartrate)[] | 否 | 运动过程实时心率数据数组，单位为次/分钟。 |
