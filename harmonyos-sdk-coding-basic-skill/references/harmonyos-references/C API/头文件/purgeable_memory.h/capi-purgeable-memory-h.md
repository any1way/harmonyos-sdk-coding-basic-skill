...
scraped_at: 2026-06-01T16:41:51+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:61fb917e3cb6e62e6237a8fe502f75f597df020fcc37bcea182d6aa9ff9bd947
---
## 概述
...
**相关模块：** [memory](../../模块/memory/capi-memory.md)
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md) | OH\_PurgeableMemory | 可清除的内存结构。 |
...
| [OH\_PurgeableMemory \*OH\_PurgeableMemory\_Create(size\_t size, OH\_PurgeableMemory\_ModifyFunc func, void \*funcPara)](capi-purgeable-memory-h.md#oh_purgeablememory_create) | - | 创建一个[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)对象。 |
| [bool OH\_PurgeableMemory\_Destroy(OH\_PurgeableMemory \*purgObj)](capi-purgeable-memory-h.md#oh_purgeablememory_destroy) | - | 销毁[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)对象。 |
| [bool OH\_PurgeableMemory\_BeginRead(OH\_PurgeableMemory \*purgObj)](capi-purgeable-memory-h.md#oh_purgeablememory_beginread) | - | 开始读取[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)。 |
| [void OH\_PurgeableMemory\_EndRead(OH\_PurgeableMemory \*purgObj)](capi-purgeable-memory-h.md#oh_purgeablememory_endread) | - | 结束读取[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)。 |
| [bool OH\_PurgeableMemory\_BeginWrite(OH\_PurgeableMemory \*purgObj)](capi-purgeable-memory-h.md#oh_purgeablememory_beginwrite) | - | 开始修改[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)。 |
| [void OH\_PurgeableMemory\_EndWrite(OH\_PurgeableMemory \*purgObj)](capi-purgeable-memory-h.md#oh_purgeablememory_endwrite) | - | 结束修改[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)。 |
| [void \*OH\_PurgeableMemory\_GetContent(OH\_PurgeableMemory \*purgObj)](capi-purgeable-memory-h.md#oh_purgeablememory_getcontent) | - | 获取[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)的内容的指针。 |
| [size\_t OH\_PurgeableMemory\_ContentSize(OH\_PurgeableMemory \*purgObj)](capi-purgeable-memory-h.md#oh_purgeablememory_contentsize) | - | 获取[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)对象的内容大小。 |
| [bool OH\_PurgeableMemory\_AppendModify(OH\_PurgeableMemory \*purgObj, OH\_PurgeableMemory\_ModifyFunc func, void \*funcPara)](capi-purgeable-memory-h.md#oh_purgeablememory_appendmodify) | - | 将修改附加到[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)。 |
...
创建一个[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)对象。
...
| 类型 | 说明 |
| --- | --- |
| [OH\_PurgeableMemory \*](../../结构体/PurgMem/capi-memory-purgmem.md) | 可丢弃内存对象。 |
...
销毁[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)对象。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PurgeableMemory](../../结构体/PurgMem/capi-memory-purgmem.md) \*purgObj | 待销毁的可丢弃内存对象。 |
...
开始读取[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PurgeableMemory](../../结构体/PurgMem/capi-memory-purgmem.md) \*purgObj | 可丢弃内存对象。 |
...
结束读取[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PurgeableMemory](../../结构体/PurgMem/capi-memory-purgmem.md) \*purgObj | 可丢弃内存对象。当此函数执行结束，操作系统可能会稍后回收可丢弃内存对象的内容的内存。 |
...
开始修改[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)。
...
结束修改[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PurgeableMemory](../../结构体/PurgMem/capi-memory-purgmem.md) \*purgObj | 可丢弃内存对象。当此函数执行结束时，操作系统可能会稍后回收可丢弃内存对象的内容的内存。 |
...
获取[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)的内容的指针。
...
获取[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)对象的内容大小。
...
将修改附加到[PurgMem](../../结构体/PurgMem/capi-memory-purgmem.md)。
