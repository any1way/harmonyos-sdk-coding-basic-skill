...
content_hash: sha256:2eacb417eae2acce64c37270b213d0248db69f9f76f334e6c91dbff470e85799
---
```
...
| 名称 | 描述 |
| --- | --- |
| [JSVM\_Value](../JSVM_Value__/capi-jsvm-jsvm-value--8h.md) namedPropertyData | 命名属性回调使用的数据。 |
| [JSVM\_Value](../JSVM_Value__/capi-jsvm-jsvm-value--8h.md) indexedPropertyData | 索引属性回调使用的数据。 |
