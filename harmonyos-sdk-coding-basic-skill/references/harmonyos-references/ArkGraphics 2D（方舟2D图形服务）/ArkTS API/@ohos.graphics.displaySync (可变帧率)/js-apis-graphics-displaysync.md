...
scraped_at: 2026-06-01T16:26:52+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:361fda4786dc8d152faeeddeab8e4a57c8de8bb270356d05ffcbc6df5a4b280e
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rateRange | [ExpectedFrameRateRange](<../../../ArkUI（方舟UI框架）/ArkTS组件/动画/显式动画 (animateTo)/ts-explicit-animation.md#expectedframeraterange11>) | 是 | 设置DisplaySync期望的帧率。 |
...
因此可以使用UIContext的[runScopedTask](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#runscopedtask>)接口来指定start函数执行的UI上下文。
