...
scraped_at: 2026-06-01T16:27:17+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:cd3db4addbb6350a7be6671dc395caebc7af27f5fe17cab27367b6c4bf0dc73f
---
...
| len | number | 是 | 字形个数，由[countText](<../Class (Font)/arkts-apis-graphics-drawing-font.md#counttext12>)获取，该参数为整数。 |
| points | [common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>)[] | 是 | 点数组，用于指定每个字形的坐标，长度必须为len。 |
...
| text | string | 是 | 绘制字形的文本内容。 |
| font | [Font](<../Class (Font)/arkts-apis-graphics-drawing-font.md>) | 是 | 字型对象。 |
| encoding | [TextEncoding](../Enums/arkts-apis-graphics-drawing-e.md#textencoding) | 否 | 编码类型，默认值为TEXT\_ENCODING\_UTF8。当前只有TEXT\_ENCODING\_UTF8生效，其余编码类型也会被视为TEXT\_ENCODING\_UTF8。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pos | Array<[TextBlobRunBuffer](<../Interfaces (其他)/arkts-apis-graphics-drawing-i.md#textblobrunbuffer>)> | 是 | TextBlobRunBuffer数组。 |
| font | [Font](<../Class (Font)/arkts-apis-graphics-drawing-font.md>) | 是 | 字型对象。 |
| bounds | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 否 | 可选，如果不设置，则无边界框。 |
...
| 类型 | 说明 |
| --- | --- |
| [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 文字边界框的矩形区域。 |
