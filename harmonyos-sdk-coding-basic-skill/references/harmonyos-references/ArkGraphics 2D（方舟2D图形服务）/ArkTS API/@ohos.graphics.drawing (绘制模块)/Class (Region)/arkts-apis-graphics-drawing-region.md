...
scraped_at: 2026-06-01T16:27:12+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:8f733c420e08d8ae3e44d8619a769e29017867fceedfad3b8768e3314809fa20
---
区域对象，用于描述所绘制图形的区域信息。
...
| 类型 | 说明 |
| --- | --- |
| [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 返回当前区域的边界矩形。 |
...
| 类型 | 说明 |
| --- | --- |
| [Path](<../Class (Path)/arkts-apis-graphics-drawing-path.md>) | 返回当前区域边界的路径。 |
...
| regionOp | [RegionOp](../Enums/arkts-apis-graphics-drawing-e.md#regionop12) | 是 | 区域合并操作类型。 |
