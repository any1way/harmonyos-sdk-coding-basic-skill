...
scraped_at: 2026-06-11T16:36:42+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:31bd99fc0f066a502658a5d335d0040d7dbed4550ba46f8c4c3d09c132da01a9
---
...
| blendMode | [BlendMode](../Enums/arkts-apis-graphics-drawing-e.md#blendmode) | 是 | 混合模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pixelmap | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 进行采样的图片对象。 |
| tileX | [TileMode](../Enums/arkts-apis-graphics-drawing-e.md#tilemode12) | 是 | 水平方向的平铺模式。 |
| tileY | [TileMode](../Enums/arkts-apis-graphics-drawing-e.md#tilemode12) | 是 | 竖直方向的平铺模式。 |
| samplingOptions | [SamplingOptions](<../Class (SamplingOptions)/arkts-apis-graphics-drawing-samplingoptions.md>) | 是 | 图片采样参数。 |
| matrix | [Matrix](<../Class (Matrix)/arkts-apis-graphics-drawing-matrix.md>) | null | 否 | 可选参数，对图片施加的矩阵变换，如果为空，则不施加任何变换。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| startPt | [common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>) | 是 | 表示渐变的起点。 |
| endPt | [common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>) | 是 | 表示渐变的终点。 |
| colors | Array<number> | 是 | 表示在两个点之间分布的颜色数组，数组中的值为32位（ARGB）无符号整数。 |
| mode | [TileMode](../Enums/arkts-apis-graphics-drawing-e.md#tilemode12) | 是 | 着色器效果平铺模式。 |
...
| matrix | [Matrix](<../Class (Matrix)/arkts-apis-graphics-drawing-matrix.md>) | null | 否 | 矩阵对象，用于对着色器做矩阵变换。默认为null，表示单位矩阵。 |

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/vzyZK9rKRX6zCSxZYTffSA/zh-cn_image_0000002592221338.png?HW-CC-KV=V1&HW-CC-Date=20260611T083641Z&HW-CC-Expire=86400&HW-CC-Sign=49D22922E00CD2F005F1AD997B8DBF7ABE9B839C9892B2787D159C4D80F250CB)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| centerPt | [common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>) | 是 | 表示渐变的圆心。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5/v3/MtDsj8adRGGzLcobgm9nvg/zh-cn_image_0000002592381270.png?HW-CC-KV=V1&HW-CC-Date=20260611T083641Z&HW-CC-Expire=86400&HW-CC-Sign=8AA18F2AA86D290041A323ABE0680AAF42FBED8404A95A882184993F709FBACD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/aSIaqLS_RL2KENnqa3lAkw/zh-cn_image_0000002622860781.png?HW-CC-KV=V1&HW-CC-Date=20260611T083641Z&HW-CC-Expire=86400&HW-CC-Sign=3F35B5B02361F8954B792146DF93DF18F236EB8CC31724E7ACD45A624D7BA80A)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| startPt | [common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>) | 是 | 表示渐变的起始圆的圆心。 |
| startRadius | number | 是 | 表示渐变的起始圆的半径，小于0时无效。该参数为浮点数。 |
| endPt | [common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>) | 是 | 表示渐变的结束圆的圆心。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/x-RzNJ20R5S7wPKW87Kw8Q/zh-cn_image_0000002622700899.png?HW-CC-KV=V1&HW-CC-Date=20260611T083641Z&HW-CC-Expire=86400&HW-CC-Sign=A5CB7B22E9B04FB2B0CBBA4FAAF20B1CD06C598C146D1B47864ED6E6905C111F)
