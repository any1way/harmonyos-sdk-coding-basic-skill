...
scraped_at: 2026-06-11T16:36:32+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:adaf8f5f424f836ae58b40ad7504941631c3201766c6ae50a1c13fff0fa74f88
---
矩阵对象。

表示为3\*3的矩阵，如下图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/uPDgySdgRzKp7ch-0Sg3Ug/zh-cn_image_0000002592381268.png?HW-CC-KV=V1&HW-CC-Date=20260611T083630Z&HW-CC-Expire=86400&HW-CC-Sign=F988636B53AA00A3724F3EF05B5EEF5E142F2FFC0B549B1E02A205606FA108AE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/wPMKzLMLSD2G94-nRAXpqg/zh-cn_image_0000002622860779.png?HW-CC-KV=V1&HW-CC-Date=20260611T083630Z&HW-CC-Expire=86400&HW-CC-Sign=50C030E8A7C1C6DFBFB9B160B66ACC81454CC65CF01E70639A7A9BF5D57F1E80)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | Array<[common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>)> | 是 | 源点数组。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Array<[common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>)> | 源点数组经矩阵变换后的点数组。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/CfTRNgrVTj-XgzI7VbfDMg/zh-cn_image_0000002622700897.png?HW-CC-KV=V1&HW-CC-Date=20260611T083630Z&HW-CC-Expire=86400&HW-CC-Sign=CD876508336B4D8BBBA17A1ADF057E089A76D08D32D5EB4F7C453A04245329A8)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dst | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 目标矩形对象，用于存储源矩形经矩阵变换后的图形的外接矩形。 |
| src | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 源矩形对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 源矩形。 |
| dst | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 目标矩形。 |
| scaleToFit | [ScaleToFit](../Enums/arkts-apis-graphics-drawing-e.md#scaletofit12) | 是 | 源矩形到目标矩形的映射方式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | Array<[common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>)> | 是 | 源点数组，长度必须为count。 |
| dst | Array<[common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>)> | 是 | 目标点数组，长度必须为count。 |
