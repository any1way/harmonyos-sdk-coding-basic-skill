...
scraped_at: 2026-06-11T16:36:25+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:58178915620bc3a5540f91dbefd3091e03035c1b3c720e69ccd40f0f040f8edd
---
承载绘制内容与绘制状态的载体。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pixelmap | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 构造函数入参。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 绘制的矩形区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| roundRect | [RoundRect](<../Class (RoundRect)/arkts-apis-graphics-drawing-roundrect.md>) | 是 | 圆角矩形对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| outer | [RoundRect](<../Class (RoundRect)/arkts-apis-graphics-drawing-roundrect.md>) | 是 | 圆角矩形对象，表示外部圆角矩形边界。 |
| inner | [RoundRect](<../Class (RoundRect)/arkts-apis-graphics-drawing-roundrect.md>) | 是 | 圆角矩形对象，表示内部圆角矩形边界。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| brush | [Brush](<../Class (Brush)/arkts-apis-graphics-drawing-brush.md>) | 是 | 画刷对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path](<../Class (Path)/arkts-apis-graphics-drawing-path.md>) | 是 | 路径对象，可生成阴影。 |
| planeParams | [common2D.Point3d](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point3d12>) | 是 | 表示一个三维向量，用于计算遮挡物相对于画布在z轴上的偏移量，其值取决于x与y坐标。 |
| devLightPos | [common2D.Point3d](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point3d12>) | 是 | 光线相对于画布的位置。 |
| lightRadius | number | 是 | 圆形灯半径，该参数为浮点数。 |
| ambientColor | [common2D.Color](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color>) | 是 | 环境阴影颜色。 |
| spotColor | [common2D.Color](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color>) | 是 | 点阴影颜色。 |
| flag | [ShadowFlag](../Enums/arkts-apis-graphics-drawing-e.md#shadowflag12) | 是 | 阴影标志枚举。 |
...
| --- | --- | --- | --- |
| path | [Path](<../Class (Path)/arkts-apis-graphics-drawing-path.md>) | 是 | 路径对象，可生成阴影。 |
| planeParams | [common2D.Point3d](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point3d12>) | 是 | 表示一个三维向量，用于计算z轴方向的偏移量。 |
| devLightPos | [common2D.Point3d](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point3d12>) | 是 | 光线相对于画布的位置。 |
| lightRadius | number | 是 | 圆形灯半径，该参数为浮点数。 |
| ambientColor | [common2D.Color](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color>) | number | 是 | 环境阴影颜色，可以用16进制ARGB格式的32位无符号整数表示。 |
| spotColor | [common2D.Color](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color>) | number | 是 | 点阴影颜色，可以用16进制ARGB格式的32位无符号整数表示。 |
| flag | [ShadowFlag](../Enums/arkts-apis-graphics-drawing-e.md#shadowflag12) | 是 | 阴影标志枚举。 |
...
| 类型 | 说明 |
| --- | --- |
| [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 返回画布裁剪区域的矩形边界。 |
...
| 类型 | 说明 |
| --- | --- |
| [Matrix](<../Class (Matrix)/arkts-apis-graphics-drawing-matrix.md>) | 返回画布矩阵。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pixelmap | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 图片的PixelMap。 |
| left | number | 是 | 图片位置的左上角x轴坐标，该参数为浮点数。 |
| top | number | 是 | 图片位置的左上角y轴坐标，该参数为浮点数。 |
| samplingOptions12+ | [SamplingOptions](<../Class (SamplingOptions)/arkts-apis-graphics-drawing-samplingoptions.md>) | 否 | 采样选项对象，默认为不使用任何参数构造的原始采样选项对象。 |
...
| --- | --- | --- | --- |
| pixelmap | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 图片的PixelMap。 |
| dstRect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 矩形对象，用于指定画布上图片的绘制区域。 |
| samplingOptions | [SamplingOptions](<../Class (SamplingOptions)/arkts-apis-graphics-drawing-samplingoptions.md>) | 否 | 采样选项对象，默认为不使用任何参数构造的原始采样选项对象。 |
...
| --- | --- | --- | --- |
| pixelmap | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 图片的PixelMap。 |
| srcRect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 矩形对象，用于指定图片的待绘制区域。 |
| dstRect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 矩形对象，用于指定画布上图片的绘制区域。 |
| samplingOptions | [SamplingOptions](<../Class (SamplingOptions)/arkts-apis-graphics-drawing-samplingoptions.md>) | 否 | 采样选项对象，默认为不使用任何参数构造的原始采样选项对象。 |
| constraint | [SrcRectConstraint](../Enums/arkts-apis-graphics-drawing-e.md#srcrectconstraint12) | 否 | 源矩形区域约束类型，默认为STRICT。 |
...
使用指定颜色并按照指定的[BlendMode](../Enums/arkts-apis-graphics-drawing-e.md#blendmode)对画布当前可绘制区域进行填充。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [common2D.Color](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color>) | 是 | ARGB格式的颜色，每个颜色通道的值是0到255之间的整数。 |
| blendMode | [BlendMode](../Enums/arkts-apis-graphics-drawing-e.md#blendmode) | 否 | 颜色混合模式，默认模式为SRC\_OVER。 |
...
使用指定颜色并按照指定的[BlendMode](../Enums/arkts-apis-graphics-drawing-e.md#blendmode)对画布当前可绘制区域进行填充。性能优于[drawColor](arkts-apis-graphics-drawing-canvas.md#drawcolor)接口，推荐使用本接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| vertexMode | [VertexMode](../Enums/arkts-apis-graphics-drawing-e.md#vertexmode23) | 是 | 绘制顶点的连接方式。 |
| vertexCount | number | 是 | 顶点数组元素的数量，值为大于等于3的整数。 |
| positions | Array<[common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>)> | 是 | 描述顶点位置的数组，不能为空，其长度必须等于vertexCount。 |
| texs | Array<[common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>)> | null | 是 | 描述顶点对应纹理空间坐标的数组。其可以为空，表明纹理空间失效；若不为空，其长度必须等于vertexCount。 |
...
| mode | [BlendMode](../Enums/arkts-apis-graphics-drawing-e.md#blendmode) | 是 | 颜色混合模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pixelmap | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 用于绘制网格的像素图。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [common2D.Color](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color>) | number | 是 | 颜色，可以用16进制ARGB格式的无符号整数表示。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| oval | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 矩形区域，该矩形的内切椭圆即为待绘制椭圆。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| arc | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 包含要绘制的圆弧的椭圆的矩形边界。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| points | Array<[common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>)> | 是 | 要绘制的点的数组。长度不能为0。 |
| mode | [PointMode](../Enums/arkts-apis-graphics-drawing-e.md#pointmode12) | 否 | 绘制数组中的点的方式，默认为drawing.PointMode.POINTS。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path](<../Class (Path)/arkts-apis-graphics-drawing-path.md>) | 是 | 要绘制的路径对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| blob | [TextBlob](<../Class (TextBlob)/arkts-apis-graphics-drawing-textblob.md>) | 是 | TextBlob对象。 |
| x | number | 是 | 所绘制出的文字基线（下图蓝线）的左端点（下图红点）的横坐标，该参数为浮点数。 |
| y | number | 是 | 所绘制出的文字基线（下图蓝线）的左端点（下图红点）的纵坐标，该参数为浮点数。 |

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/TyOoL5DuQGuItd3sbTfSHA/zh-cn_image_0000002622700895.png?HW-CC-KV=V1&HW-CC-Date=20260611T083621Z&HW-CC-Expire=86400&HW-CC-Sign=5FC8EE5965C0463B3B266EB3831A67DF46E95493FA34343E1A9885FFF83980D0)
...
| font | [Font](<../Class (Font)/arkts-apis-graphics-drawing-font.md>) | 是 | 字型对象。 |
| x | number | 是 | 所绘制出的字符基线（下图蓝线）的左端点（下图红点）的横坐标，该参数为浮点数。 |
| y | number | 是 | 所绘制出的字符基线（下图蓝线）的左端点（下图红点）的纵坐标，该参数为浮点数。 |

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b2/v3/rCkmH5OqTXibdGvullBm1w/zh-cn_image_0000002622700895.png?HW-CC-KV=V1&HW-CC-Date=20260611T083621Z&HW-CC-Expire=86400&HW-CC-Sign=2A69154F14BD226BF1BF9CDA5AF6F044458BC22211ED5F0E0A2FB5310A644B21)
...
| features | Array<[FontFeature](<../Interfaces (其他)/arkts-apis-graphics-drawing-i.md#fontfeature20>)> | 是 | 字体特征对象数组。参数为空数组时使用TTF(TrueType Font)文件中预设的字体特征。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| region | [Region](<../Class (Region)/arkts-apis-graphics-drawing-region.md>) | 是 | 绘制的区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pen | [Pen](<../Class (Pen)/arkts-apis-graphics-drawing-pen.md>) | 是 | 画笔对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path](<../Class (Path)/arkts-apis-graphics-drawing-path.md>) | 是 | 路径对象。 |
| clipOp | [ClipOp](../Enums/arkts-apis-graphics-drawing-e.md#clipop12) | 否 | 裁剪方式。默认为INTERSECT。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 需要裁剪的矩形区域。 |
| clipOp | [ClipOp](../Enums/arkts-apis-graphics-drawing-e.md#clipop12) | 否 | 裁剪方式。默认为INTERSECT。 |
| doAntiAlias | boolean | 否 | 表示是否使能抗锯齿绘制。true表示使能，false表示不使能。默认为false。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | null | 否 | 矩形对象，用于限制图层大小，默认为当前画布大小。 |
| brush | [Brush](<../Class (Brush)/arkts-apis-graphics-drawing-brush.md>) | null | 否 | 画刷对象，绘制位图时会应用画刷对象的透明度，颜色滤波器效果和混合模式，默认不设置额外效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | [Matrix](<../Class (Matrix)/arkts-apis-graphics-drawing-matrix.md>) | 是 | 矩阵对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| region | [Region](<../Class (Region)/arkts-apis-graphics-drawing-region.md>) | 是 | 区域对象，表示裁剪范围。 |
| clipOp | [ClipOp](../Enums/arkts-apis-graphics-drawing-e.md#clipop12) | 否 | 裁剪方式，默认为INTERSECT。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| roundRect | [RoundRect](<../Class (RoundRect)/arkts-apis-graphics-drawing-roundrect.md>) | 是 | 圆角矩形对象，表示裁剪范围。 |
| clipOp | [ClipOp](../Enums/arkts-apis-graphics-drawing-e.md#clipop12) | 否 | 裁剪方式，默认为INTERSECT。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 矩形区域。 |
...
| --- | --- | --- | --- |
| pixelmap | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 用于绘制网格的像素图。 |
| center | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 分割图像的中心矩形。矩形四条边所在的直线将图像分成了9个部分。 |
| dstRect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 在画布上绘制的目标矩形区域。 |
| filterMode | [FilterMode](../Enums/arkts-apis-graphics-drawing-e.md#filtermode12) | 是 | 过滤模式。 |
...
| --- | --- | --- | --- |
| pixelmap | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 用于绘制网格的像素图。 |
| lattice | [Lattice](<../Class (Lattice)/arkts-apis-graphics-drawing-lattice.md>) | 是 | 矩形网格对象。 |
| dstRect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 目标矩形区域。 |
| filterMode | [FilterMode](../Enums/arkts-apis-graphics-drawing-e.md#filtermode12) | 是 | 过滤模式。 |
