...
scraped_at: 2026-06-01T16:27:00+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:ba409d7f31cffb9a8674c04368f0a0a7429745e923b9c2fb85f8e001d1458348
---
...
| 类型 | 说明 |
| --- | --- |
| [FontHinting](../Enums/arkts-apis-graphics-drawing-e.md#fonthinting12) | 返回字型轮廓效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [FontEdging](../Enums/arkts-apis-graphics-drawing-e.md#fontedging12) | 返回字型边缘效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| typeface | [Typeface](<../Class (Typeface)/arkts-apis-graphics-drawing-typeface.md>) | 是 | 字体样式，包括字体名称、粗细、斜体等属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [Typeface](<../Class (Typeface)/arkts-apis-graphics-drawing-typeface.md>) | 字体。 |
...
| 类型 | 说明 |
| --- | --- |
| [FontMetrics](<../Interfaces (其他)/arkts-apis-graphics-drawing-i.md#fontmetrics>) | FontMetrics属性。 |
...
此接口用于测量原始字符串的文本宽度，若想测量排版后的文本宽度，建议使用[measure.measureText](<../../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (MeasureUtils)/arkts-apis-uicontext-measureutils.md#measuretext12>)替代。
...
| --- | --- | --- | --- |
| text | string | 是 | 文本内容。 |
| encoding | [TextEncoding](../Enums/arkts-apis-graphics-drawing-e.md#textencoding) | 是 | 编码格式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| edging | [FontEdging](../Enums/arkts-apis-graphics-drawing-e.md#fontedging12) | 是 | 字型边缘效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| hinting | [FontHinting](../Enums/arkts-apis-graphics-drawing-e.md#fonthinting12) | 是 | 字型轮廓效果。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>)> | 返回字形边界矩形数组。 |
...
| 类型 | 说明 |
| --- | --- |
| [Path](<../Class (Path)/arkts-apis-graphics-drawing-path.md>) | 返回获取到的文本的路径轮廓。 |
...
| 类型 | 说明 |
| --- | --- |
| [Path](<../Class (Path)/arkts-apis-graphics-drawing-path.md>) | 返回指定字形的路径轮廓。 |
