...
scraped_at: 2026-06-01T16:27:18+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:bc06fa693fc95c16bb0ed434726bb0b3861ebcebf95725f8deef1852751f0a35
---
本模块定义的工具类，仅提供静态的方法，主要完成其他模块和[common2D](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md>)中定义的数据结构的转换功能等操作。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resourceColor | [ResourceColor](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | ResourceColor格式的颜色值（支持所有的4种输入，示例中提供13个示例输入）。其中第4种类型[Resource](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resource)只接受$r('belonging.type.name')构造方法，需要确保该资源在main/resources/base/element目录下已定义(app支持color、string和integer，sys只支持color)。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [common2D.Color](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color>) | 转换后的common2D.Color颜色对象，若转换失败则返回空指针。 |
