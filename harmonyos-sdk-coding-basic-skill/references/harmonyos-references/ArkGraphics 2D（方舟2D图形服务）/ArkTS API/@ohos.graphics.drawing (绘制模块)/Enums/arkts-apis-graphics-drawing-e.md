...
scraped_at: 2026-06-11T16:36:48+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:a59a9df5d6134e43d6e579aa3fd5dec2ffdc5574efd89f89745bb3362cb53cc6
---
说明
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/2tAPwR27TWerjLuLanq_Pg/zh-cn_image_0000002622700915.png?HW-CC-KV=V1&HW-CC-Date=20260611T083647Z&HW-CC-Expire=86400&HW-CC-Sign=4C6A611CB9626922904BA55659A75CE381EE45F048B86D7EAE618E5CB1CCC100)
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| UNDERLINE\_THICKNESS\_VALID | 1 << 0 | 表示[FontMetrics](<../Interfaces (其他)/arkts-apis-graphics-drawing-i.md#fontmetrics>)结构中的underlineThickness（下划线厚度）字段有效。 |
| UNDERLINE\_POSITION\_VALID | 1 << 1 | 表示[FontMetrics](<../Interfaces (其他)/arkts-apis-graphics-drawing-i.md#fontmetrics>)结构中的underlinePosition（下划线位置）字段有效。 |
| STRIKETHROUGH\_THICKNESS\_VALID | 1 << 2 | 表示[FontMetrics](<../Interfaces (其他)/arkts-apis-graphics-drawing-i.md#fontmetrics>)结构中strikethroughThickness（删除线厚度）是有效的。 |
| STRIKETHROUGH\_POSITION\_VALID | 1 << 3 | 表示[FontMetrics](<../Interfaces (其他)/arkts-apis-graphics-drawing-i.md#fontmetrics>)结构中strikethroughPosition（删除线位置）字段有效。 |
| BOUNDS\_INVALID | 1 << 4 | 表示[FontMetrics](<../Interfaces (其他)/arkts-apis-graphics-drawing-i.md#fontmetrics>)结构中的边界度量值（如top、bottom、xMin、xMax）无效。 |

## RectType12+

PhonePC/2in1TabletTVWearable

定义填充网格的矩形类型的枚举。仅在[Lattice](<../Class (Lattice)/arkts-apis-graphics-drawing-lattice.md>)中使用。
...
| FIXEDCOLOR | 2 | 将[Lattice](<../Class (Lattice)/arkts-apis-graphics-drawing-lattice.md>)中fColors数组的颜色绘制到矩形网格中。 |
