...
scraped_at: 2026-06-11T16:36:30+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:0cc7d583f26c9f2a8de654a86bef3d156957054ace5886ddbb77f85a78a483d9
---
...
| fBounds | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | null | 否 | 可选，要绘制的原始边界矩形，矩形参数须为整数，默认为原始图像矩形大小（若矩形参数为小数，会直接舍弃小数部分，转为整数）。 |
| fRectTypes | Array<[RectType](../Enums/arkts-apis-graphics-drawing-e.md#recttype12)> | null | 否 | 可选，填充网格类型的数组，默认为空。如果设置，大小必须为(fXCount + 1) \* (fYCount + 1)。 |
| fColors | Array<[common2D.Color](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color>)> | null | 否 | 可选，填充网格的颜色数组，默认为空。如果设置，大小必须为(fXCount + 1) \* (fYCount + 1)。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/CZcttyIuQ3qAtz9gtwlxxA/zh-cn_image_0000002592221336.png?HW-CC-KV=V1&HW-CC-Date=20260611T083629Z&HW-CC-Expire=86400&HW-CC-Sign=1E7885E79F899A6C4B93D9D470CD21805F4DEE59FA43E82A07D8E25C11AB6FD1)
