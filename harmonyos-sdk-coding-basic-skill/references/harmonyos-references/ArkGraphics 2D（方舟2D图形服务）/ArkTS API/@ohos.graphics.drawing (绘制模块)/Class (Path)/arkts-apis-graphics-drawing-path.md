...
scraped_at: 2026-06-01T16:27:06+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:3213126b040507d878f95a7b8ee5dd0c8949c8bf4f280186b6adfee8d17896ad
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 包含弧的椭圆的矩形边界。 |
...
| pathDirection | [PathDirection](../Enums/arkts-apis-graphics-drawing-e.md#pathdirection12) | 否 | 表示路径方向，默认为顺时针方向。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 椭圆的矩形边界。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 向路径中添加的矩形轮廓。 |
| pathDirection | [PathDirection](../Enums/arkts-apis-graphics-drawing-e.md#pathdirection12) | 否 | 表示路径方向，默认为顺时针方向。 |
...
| matrix | [Matrix](<../Class (Matrix)/arkts-apis-graphics-drawing-matrix.md>)|null | 否 | 表示矩阵对象，默认为单位矩阵。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | [Matrix](<../Class (Matrix)/arkts-apis-graphics-drawing-matrix.md>) | 是 | 表示矩阵对象。 |
...
判断指定坐标点是否被路径包含，判定是否被路径包含的规则参考[PathFillType](../Enums/arkts-apis-graphics-drawing-e.md#pathfilltype12)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pathFillType | [PathFillType](../Enums/arkts-apis-graphics-drawing-e.md#pathfilltype12) | 是 | 表示路径填充规则。 |
...
| 类型 | 说明 |
| --- | --- |
| [PathFillType](../Enums/arkts-apis-graphics-drawing-e.md#pathfilltype12) | 路径填充类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 包含路径的最小矩形区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| points | Array<[common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>)> | 是 | 坐标点数组。 |
...
| pathOp | [PathOp](../Enums/arkts-apis-graphics-drawing-e.md#pathop12) | 是 | 路径操作类型枚举。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>)| null | 是 | 矩形对象，作为出参使用，路径构成矩形时，会被改写为路径表示的矩形，否则不会改变。可以为null，表示无需获取路径表示的矩形。 |
...
| position | [common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>) | 是 | 存储获取到的距离路径起始点distance处的点的坐标。 |
| tangent | [common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>) | 是 | 存储获取到的距离路径起始点distance处的点的切线值，tangent.x表示该点切线的余弦值，tangent.y表示该点切线的正弦值。 |
...
| forceClosed | boolean | 是 | 表示是否按照闭合路径测量，true表示测量时路径会被强制视为已闭合，false表示会根据路径的实际闭合状态测量。 |
| distance | number | 是 | 表示与路径起始点的距离，小于0时会被视作0，大于路径长度时会被视作路径长度。该参数为浮点数。 |
| matrix | [Matrix](<../Class (Matrix)/arkts-apis-graphics-drawing-matrix.md>) | 是 | 矩阵对象，用于存储得到的矩阵。 |
| flags | [PathMeasureMatrixFlags](../Enums/arkts-apis-graphics-drawing-e.md#pathmeasurematrixflags12) | 是 | 矩阵信息维度枚举。 |
...
| 类型 | 说明 |
| --- | --- |
| [PathIterator](<../Class (PathIterator)/arkts-apis-graphics-drawing-pathiterator.md>) | 该路径的迭代器对象。 |
