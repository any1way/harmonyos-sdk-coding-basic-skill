...
scraped_at: 2026-06-01T16:27:20+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:0b3818911dbf6940313783a861bf5c8900bbb0d2520e804c6846e5cd37e5736e
---
字体，如宋体、楷体等。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| typefaceArguments | [TypefaceArguments](<../Class (TypefaceArguments)/arkts-apis-graphics-drawing-typefacearguments.md>) | 是 | 字体属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filePath | string | 是 | 表示字体资源存放的路径。应用沙箱路径和真实物理路径的对应关系请参考[应用沙箱路径和真实物理路径的对应关系](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/应用沙箱目录/app-sandbox-directory.md#应用沙箱路径和真实物理路径的对应关系>)。 |
...
| --- | --- | --- | --- |
| filePath | string | 是 | 表示字体资源存放的路径。应用沙箱路径和真实物理路径的对应关系请参考[应用沙箱路径和真实物理路径的对应关系](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/应用沙箱目录/app-sandbox-directory.md#应用沙箱路径和真实物理路径的对应关系>)。 |
| typefaceArguments | [TypefaceArguments](<../Class (TypefaceArguments)/arkts-apis-graphics-drawing-typefacearguments.md>) | 是 | 表示字体属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rawfile | [Resource](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resource) | 是 | 指定字体文件对应的资源对象。当前只支持$rawfile格式引用的资源对象，对应格式写为$rawfile('filePath')，其中filePath为指定字体文件相对于工程中resources/rawfile目录的相对路径。 |
| typefaceArguments | [TypefaceArguments](<../Class (TypefaceArguments)/arkts-apis-graphics-drawing-typefacearguments.md>) | 是 | 表示字体属性。 |
