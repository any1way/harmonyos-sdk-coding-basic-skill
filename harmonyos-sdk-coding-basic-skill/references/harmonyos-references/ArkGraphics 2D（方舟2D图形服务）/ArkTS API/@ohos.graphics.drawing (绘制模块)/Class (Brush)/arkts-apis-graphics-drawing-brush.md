...
scraped_at: 2026-06-01T16:26:54+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:f55999915732d0964c943868d7948667fc204bdfd5f0144c938ab4ce47e5fb86
---
画刷对象，描述所绘制图形的填充信息。
...
| 类型 | 说明 |
| --- | --- |
| [common2D.Color4f](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color4f20>) | 返回画刷的颜色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | [ImageFilter](<../Class (ImageFilter)/arkts-apis-graphics-drawing-imagefilter.md>) | null | 是 | 图像滤波器，null表示清空图像滤波器效果。 |
