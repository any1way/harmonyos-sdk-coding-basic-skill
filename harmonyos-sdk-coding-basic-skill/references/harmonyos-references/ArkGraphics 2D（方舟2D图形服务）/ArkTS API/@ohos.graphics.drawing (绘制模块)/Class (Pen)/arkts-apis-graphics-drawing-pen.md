...
scraped_at: 2026-06-01T16:27:09+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:c50b9aaed4eb0e6fb4a4e1cb4c01d1b58063bf741b23ad86db34fd4b8597f807
---
画笔对象，描述所绘制图形形状的轮廓信息。
...
设置折线尖角长度与线宽的最大比值，当画笔绘制一条折线，并且[JoinStyle](../Enums/arkts-apis-graphics-drawing-e.md#joinstyle12)为MITER\_JOIN时，若尖角长度与线宽的比值大于限制值，则该折角使用BEVEL\_JOIN绘制。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | [ImageFilter](<../Class (ImageFilter)/arkts-apis-graphics-drawing-imagefilter.md>) | null | 是 | 图像滤波器，null表示清空画笔的图像滤波器效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [ColorFilter](<../Class (ColorFilter)/arkts-apis-graphics-drawing-colorfilter.md>) | 返回颜色滤波器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color4f | [common2D.Color4f](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color4f20>) | 是 | ARGB格式的颜色，每个颜色通道的值是0.0-1.0之间的浮点数，大于1.0时，取1.0，小于0.0时，取0.0。 |
| colorSpace | [colorSpaceManager.ColorSpaceManager](<../../@ohos.graphics.colorSpaceManager (色彩管理)/js-apis-colorspacemanager.md#colorspacemanager>) | null | 是 | 标准色域对象，null表示使用SRGB色域。 |
...
| 类型 | 说明 |
| --- | --- |
| [common2D.Color](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color>) | 返回画笔的颜色。 |
...
| 类型 | 说明 |
| --- | --- |
| [common2D.Color4f](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color4f20>) | 返回画笔的颜色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | [ColorFilter](<../Class (ColorFilter)/arkts-apis-graphics-drawing-colorfilter.md>) | null | 是 | 颜色滤波器。null表示清空颜色滤波器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | [MaskFilter](<../Class (MaskFilter)/arkts-apis-graphics-drawing-maskfilter.md>) | null | 是 | 蒙版滤镜。null表示清空蒙版滤镜。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| effect | [PathEffect](<../Class (PathEffect)/arkts-apis-graphics-drawing-patheffect.md>) | null | 是 | 路径效果对象。null表示清空路径效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shaderEffect | [ShaderEffect](<../Class (ShaderEffect)/arkts-apis-graphics-drawing-shadereffect.md>) | null | 是 | 着色器对象。null表示清空着色器效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shadowLayer | [ShadowLayer](<../Class (ShadowLayer)/arkts-apis-graphics-drawing-shadowlayer.md>) | null | 是 | 阴影层对象。null表示清空阴影层效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [BlendMode](../Enums/arkts-apis-graphics-drawing-e.md#blendmode) | 是 | 颜色的混合模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [JoinStyle](../Enums/arkts-apis-graphics-drawing-e.md#joinstyle12) | 是 | 折线转角样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CapStyle](../Enums/arkts-apis-graphics-drawing-e.md#capstyle12) | 是 | 描述画笔的线帽样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | [Path](<../Class (Path)/arkts-apis-graphics-drawing-path.md>) | 是 | 源路径对象。 |
| dst | [Path](<../Class (Path)/arkts-apis-graphics-drawing-path.md>) | 是 | 目标路径对象。 |
