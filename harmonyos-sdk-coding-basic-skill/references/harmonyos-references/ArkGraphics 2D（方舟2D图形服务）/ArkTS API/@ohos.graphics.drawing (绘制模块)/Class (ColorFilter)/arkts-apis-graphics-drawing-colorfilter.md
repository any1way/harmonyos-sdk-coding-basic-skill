...
scraped_at: 2026-06-01T16:26:58+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:b4e3095947ec281af530687700b5b837ffd3a1c06d135f66826ca5124f10e634
---
颜色滤波器。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mutColor | [common2D.Color](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color>) | number | 是 | 用来进行乘法运算的颜色，ARGB格式的颜色，每个颜色通道是0到255之间的整数。为number类型时必须是16进制ARGB格式的无符号整数。 |
| addColor | [common2D.Color](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#color>) | number | 是 | 用来进行加法运算的颜色，ARGB格式的颜色，每个颜色通道是0到255之间的整数。为number类型时必须是16进制ARGB格式的无符号整数。 |
