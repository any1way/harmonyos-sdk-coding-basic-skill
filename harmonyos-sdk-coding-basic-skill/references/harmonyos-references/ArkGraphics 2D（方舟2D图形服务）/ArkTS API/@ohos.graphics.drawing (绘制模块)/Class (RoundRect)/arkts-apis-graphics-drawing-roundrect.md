...
content_hash: sha256:751cb4b476da095e78de959fd49e2703de30572e560bab0d3ced5fd836588add
---
圆角矩形对象。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [common2D.Rect](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 是 | 需要创建的圆角矩形区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pos | [CornerPos](../Enums/arkts-apis-graphics-drawing-e.md#cornerpos12) | 是 | 圆角位置。 |
...
| 类型 | 说明 |
| --- | --- |
| [common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>) | 返回一个点，其横坐标表示圆角x轴方向上的半径，纵坐标表示y轴方向上的半径。 |
