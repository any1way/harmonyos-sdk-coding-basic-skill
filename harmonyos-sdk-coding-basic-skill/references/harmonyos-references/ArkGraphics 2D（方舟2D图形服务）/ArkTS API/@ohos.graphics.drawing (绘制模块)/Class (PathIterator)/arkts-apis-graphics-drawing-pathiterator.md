...
scraped_at: 2026-06-01T16:27:07+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:9d6c32c689848e5ee8b8d6a46541a589ceb4084647e2b183cc8fa1b1b48d4ed2
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path](<../Class (Path)/arkts-apis-graphics-drawing-path.md>) | 是 | 迭代器绑定的路径对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| points | Array<[common2D.Point](<../../@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#point12>)> | 是 | 坐标点数组，长度必须至少为偏移量加4，以确保能容纳所有类型的路径数据。操作执行后，该数组会被覆盖。填入的坐标点数量取决于操作类型，其中，MOVE填入1个坐标点，LINE填入2个坐标点，QUAD填入3个坐标点，CONIC填入3个坐标点 + 1个权重值（共3.5组），CUBIC填入4个坐标点，CLOSE和DONE不填入任何点。 |
...
| 类型 | 说明 |
| --- | --- |
| [PathIteratorVerb](../Enums/arkts-apis-graphics-drawing-e.md#pathiteratorverb18) | 迭代器包含的路径操作类型。 |
