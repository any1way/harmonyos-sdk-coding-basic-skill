...
scraped_at: 2026-06-01T16:28:07+08:00
doc_updated_at: 2026-03-27
content_hash: sha256:571a1016d87f333ffc3ef28bdf0430a2d625a51fd990d3e073f23e7551c070e4
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [NativePixelMap\_](../../结构体/NativePixelMap_/capi-drawing-nativepixelmap-.md) | NativePixelMap\_ | 声明由图像框架定义的像素图对象。 |
| [OH\_PixelmapNative](../../结构体/OH_PixelmapNative/capi-drawing-oh-pixelmapnative.md) | OH\_PixelmapNative | 声明由图像框架定义的像素图对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NativePixelMap\_](../../结构体/NativePixelMap_/capi-drawing-nativepixelmap-.md)\* nativePixelMap | 指向图像框架定义的像素图对象[NativePixelMap\_](../../结构体/NativePixelMap_/capi-drawing-nativepixelmap-.md)的指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_PixelMap](../../结构体/OH_Drawing_PixelMap/capi-drawing-oh-drawing-pixelmap.md)\* | 函数会返回一个指向本模块定义的像素图对象[OH\_Drawing\_PixelMap](../../结构体/OH_Drawing_PixelMap/capi-drawing-oh-drawing-pixelmap.md)的指针。如果对象返回NULL，表示创建失败；可能的原因是NativePixelMap\_为NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PixelmapNative](../../结构体/OH_PixelmapNative/capi-drawing-oh-pixelmapnative.md)\* pixelmapNative | 指向图像框架定义的像素图对象[OH\_PixelmapNative](../../结构体/OH_PixelmapNative/capi-drawing-oh-pixelmapnative.md)的指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_PixelMap](../../结构体/OH_Drawing_PixelMap/capi-drawing-oh-drawing-pixelmap.md)\* | 函数会返回一个指向本模块定义的像素图对象[OH\_Drawing\_PixelMap](../../结构体/OH_Drawing_PixelMap/capi-drawing-oh-drawing-pixelmap.md)的指针。如果对象返回NULL，表示创建失败；可能的原因是OH\_PixelmapNative为NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_PixelMap](../../结构体/OH_Drawing_PixelMap/capi-drawing-oh-drawing-pixelmap.md)\* pixelMap | 指向像素图对象[OH\_Drawing\_PixelMap](../../结构体/OH_Drawing_PixelMap/capi-drawing-oh-drawing-pixelmap.md)的指针。 |
