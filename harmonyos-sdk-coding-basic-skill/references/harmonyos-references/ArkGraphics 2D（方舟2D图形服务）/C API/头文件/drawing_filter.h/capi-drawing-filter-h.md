...
scraped_at: 2026-06-01T16:27:50+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:1a94d3bbf1c838416b3206e68dc775a7aaafaccca003003b17ae9d7e90cafd12
---
## 概述
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Filter](../../结构体/OH_Drawing_Filter/capi-drawing-oh-drawing-filter.md)\* | 返回创建的滤波器对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_Filter](../../结构体/OH_Drawing_Filter/capi-drawing-oh-drawing-filter.md)\* filter | 指示指向滤波器对象[OH\_Drawing\_Filter](../../结构体/OH_Drawing_Filter/capi-drawing-oh-drawing-filter.md)的指针。 |
| [OH\_Drawing\_ImageFilter](../../结构体/OH_Drawing_ImageFilter/capi-drawing-oh-drawing-imagefilter.md)\* imageFilter | 指示指向图像滤波器[OH\_Drawing\_ImageFilter](../../结构体/OH_Drawing_ImageFilter/capi-drawing-oh-drawing-imagefilter.md)对象的指针，为NULL表示清空滤波器对象中的图像滤波器效果。 |
...
| --- | --- |
| [OH\_Drawing\_Filter](../../结构体/OH_Drawing_Filter/capi-drawing-oh-drawing-filter.md)\* filter | 指示指向滤波器对象[OH\_Drawing\_Filter](../../结构体/OH_Drawing_Filter/capi-drawing-oh-drawing-filter.md)的指针。 |
| [OH\_Drawing\_MaskFilter](../../结构体/OH_Drawing_MaskFilter/capi-drawing-oh-drawing-maskfilter.md)\* maskFilter | 指示指向蒙版滤波器对象[OH\_Drawing\_MaskFilter](../../结构体/OH_Drawing_MaskFilter/capi-drawing-oh-drawing-maskfilter.md)的指针，为NULL表示清空滤波器对象中的蒙版滤波器效果。 |
...
| --- | --- |
| [OH\_Drawing\_Filter](../../结构体/OH_Drawing_Filter/capi-drawing-oh-drawing-filter.md)\* filter | 指示指向滤波器对象[OH\_Drawing\_Filter](../../结构体/OH_Drawing_Filter/capi-drawing-oh-drawing-filter.md)的指针。 |
| [OH\_Drawing\_ColorFilter](../../结构体/OH_Drawing_ColorFilter/capi-drawing-oh-drawing-colorfilter.md)\* colorFilter | 指示指向颜色滤波器对象[OH\_Drawing\_ColorFilter](../../结构体/OH_Drawing_ColorFilter/capi-drawing-oh-drawing-colorfilter.md)的指针，为NULL表示清空滤波器对象中的颜色滤波器效果。 |
...
| --- | --- |
| [OH\_Drawing\_Filter](../../结构体/OH_Drawing_Filter/capi-drawing-oh-drawing-filter.md)\* filter | 指示指向滤波器对象[OH\_Drawing\_Filter](../../结构体/OH_Drawing_Filter/capi-drawing-oh-drawing-filter.md)的指针。 |
| [OH\_Drawing\_ColorFilter](../../结构体/OH_Drawing_ColorFilter/capi-drawing-oh-drawing-colorfilter.md)\* colorFilter | 指示指向颜色滤波器对象[OH\_Drawing\_ColorFilter](../../结构体/OH_Drawing_ColorFilter/capi-drawing-oh-drawing-colorfilter.md)的指针。 |
