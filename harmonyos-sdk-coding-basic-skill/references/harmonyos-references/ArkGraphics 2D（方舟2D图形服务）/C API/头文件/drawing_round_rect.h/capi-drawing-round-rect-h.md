...
scraped_at: 2026-06-01T16:28:13+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:0f190788acb15610470823f7ba7ac48591c032a6e51f444c14915a4be61ca1b9
---
## 概述
...
用于创建一个圆角矩形对象。本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_RoundRect](../../结构体/OH_Drawing_RoundRect/capi-drawing-oh-drawing-roundrect.md)\* | 函数会返回一个指针，指针指向创建的圆角矩形对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [OH\_Drawing\_RoundRect](../../结构体/OH_Drawing_RoundRect/capi-drawing-oh-drawing-roundrect.md)\* roundRect | 指向用于拷贝的圆角矩形对象[OH\_Drawing\_RoundRect](../../结构体/OH_Drawing_RoundRect/capi-drawing-oh-drawing-roundrect.md)的指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_RoundRect](../../结构体/OH_Drawing_RoundRect/capi-drawing-oh-drawing-roundrect.md)\* | 函数会返回一个指针，指针指向创建的新圆角矩形对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_RoundRect](../../结构体/OH_Drawing_RoundRect/capi-drawing-oh-drawing-roundrect.md)\* roundRect | 指向圆角矩形对象的指针。 |
...
| [OH\_Drawing\_Corner\_Radii](../../结构体/OH_Drawing_Point2D/capi-drawing-oh-drawing-point2d.md) radii | 圆角半径结构体OH\_Drawing\_Corner\_Radii，其中包含x轴方向和y轴方向上的半径，半径小于等于0时无效。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Corner\_Radii](../../结构体/OH_Drawing_Point2D/capi-drawing-oh-drawing-point2d.md) | 返回指定圆角位置的圆角半径结构体OH\_Drawing\_Corner\_Radii，其中包含x轴方向和y轴方向上的半径。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_RoundRect](../../结构体/OH_Drawing_RoundRect/capi-drawing-oh-drawing-roundrect.md)\* roundRect | 指向圆角矩形对象[OH\_Drawing\_Point2D](../../结构体/OH_Drawing_Point2D/capi-drawing-oh-drawing-point2d.md)的指针。 |
| float dx | x轴方向偏移量。 |
| float dy | y轴方向偏移量。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行错误码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数roundRect为空。 |
