...
content_hash: sha256:7716302accbb0dd3099c0b5f37ea1f83bfe61d29a68ad740531d483c09d23453
---
## 概述
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PixelmapNative](../../结构体/OH_PixelmapNative/capi-drawing-oh-pixelmapnative.md)\* pixelmap | 创建滤镜的位图。 |
| [OH\_Filter](../../结构体/OH_Filter/capi-effectkit-oh-filter.md)\*\* filter | 用来接收滤镜的二级指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [EffectErrorCode](../effect_types.h/capi-effect-types-h.md#effecterrorcode) | 返回结果参见状态码[EffectErrorCode](../effect_types.h/capi-effect-types-h.md#effecterrorcode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Filter](../../结构体/OH_Filter/capi-effectkit-oh-filter.md)\* filter | 被释放的对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Filter](../../结构体/OH_Filter/capi-effectkit-oh-filter.md)\* filter | 滤镜指针。 |
...
| [OH\_Filter](../../结构体/OH_Filter/capi-effectkit-oh-filter.md)\* filter | 滤镜指针。 |
| float radius | 毛玻璃效果的模糊半径，单位为像素。 |
| [EffectTileMode](../effect_types.h/capi-effect-types-h.md#effecttilemode) tileMode | 着色器效果平铺模式，支持可选的具体模式可见[EffectTileMode](../effect_types.h/capi-effect-types-h.md#effecttilemode)枚举。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [EffectErrorCode](../effect_types.h/capi-effect-types-h.md#effecterrorcode) | 返回结果参见状态码[EffectErrorCode](../effect_types.h/capi-effect-types-h.md#effecterrorcode)。  操作成功则返回EFFECT\_SUCCESS。  无效参数则返回EFFECT\_BAD\_PARAMETER。 |
...
| --- | --- |
| [OH\_Filter](../../结构体/OH_Filter/capi-effectkit-oh-filter.md)\* filter | 滤镜指针。 |
| [OH\_Filter\_ColorMatrix](../../结构体/OH_Filter_ColorMatrix/capi-effectkit-oh-filter-colormatrix.md)\* matrix | 用来创建滤镜的自定义矩阵[OH\_Filter\_ColorMatrix](../../结构体/OH_Filter_ColorMatrix/capi-effectkit-oh-filter-colormatrix.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Filter](../../结构体/OH_Filter/capi-effectkit-oh-filter.md)\* filter | 用来创建位图的滤镜指针。 |
| [OH\_PixelmapNative](../../结构体/OH_PixelmapNative/capi-drawing-oh-pixelmapnative.md)\*\* pixelmap | 用来接收位图的二级指针。 |
