...
scraped_at: 2026-06-01T16:27:55+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:cab94bf4678b60870c0787b989aed5540ca314f79f4fefcb3faecb825580aacc
---
## 概述
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_FontMgr](../../结构体/OH_Drawing_FontMgr/capi-drawing-oh-drawing-fontmgr.md)\* | 返回指向已创建的字体管理对象[OH\_Drawing\_FontMgr](../../结构体/OH_Drawing_FontMgr/capi-drawing-oh-drawing-fontmgr.md)的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_FontMgr](../../结构体/OH_Drawing_FontMgr/capi-drawing-oh-drawing-fontmgr.md)\* drawingFontMgr | 指向字体管理对象[OH\_Drawing\_FontMgr](../../结构体/OH_Drawing_FontMgr/capi-drawing-oh-drawing-fontmgr.md)的指针，由[OH\_Drawing\_FontMgrCreate](capi-drawing-font-mgr-h.md#oh_drawing_fontmgrcreate)获取。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_FontStyleSet](../../结构体/OH_Drawing_FontStyleSet/capi-drawing-oh-drawing-fontstyleset.md)\* | 返回指向已创建的字体样式集对象[OH\_Drawing\_FontStyleSet](../../结构体/OH_Drawing_FontStyleSet/capi-drawing-oh-drawing-fontstyleset.md)的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_FontStyleSet](../../结构体/OH_Drawing_FontStyleSet/capi-drawing-oh-drawing-fontstyleset.md)\* drawingFontStyleSet | 指向字体样式集对象[OH\_Drawing\_FontStyleSet](../../结构体/OH_Drawing_FontStyleSet/capi-drawing-oh-drawing-fontstyleset.md)的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_FontStyleSet](../../结构体/OH_Drawing_FontStyleSet/capi-drawing-oh-drawing-fontstyleset.md)\* | 返回对应的字体样式集对象[OH\_Drawing\_FontStyleSet](../../结构体/OH_Drawing_FontStyleSet/capi-drawing-oh-drawing-fontstyleset.md)，不再需要时，请使用[OH\_Drawing\_FontMgrDestroyFontStyleSet](capi-drawing-font-mgr-h.md#oh_drawing_fontmgrdestroyfontstyleset)释放该对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Typeface](../../结构体/OH_Drawing_Typeface/capi-drawing-oh-drawing-typeface.md)\* | 返回对应的字体样式的字型对象[OH\_Drawing\_Typeface](../../结构体/OH_Drawing_Typeface/capi-drawing-oh-drawing-typeface.md)，不再需要时，请使用[OH\_Drawing\_TypefaceDestroy](../drawing_typeface.h/capi-drawing-typeface-h.md#oh_drawing_typefacedestroy)释放该对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Typeface](../../结构体/OH_Drawing_Typeface/capi-drawing-oh-drawing-typeface.md)\* | 返回对应的字型对象[OH\_Drawing\_Typeface](../../结构体/OH_Drawing_Typeface/capi-drawing-oh-drawing-typeface.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_FontStyleSet](../../结构体/OH_Drawing_FontStyleSet/capi-drawing-oh-drawing-fontstyleset.md)\* fontStyleSet | 指向字体样式集对象[OH\_Drawing\_FontStyleSet](../../结构体/OH_Drawing_FontStyleSet/capi-drawing-oh-drawing-fontstyleset.md)的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Typeface](../../结构体/OH_Drawing_Typeface/capi-drawing-oh-drawing-typeface.md)\* | 如果成功，返回对应的字型对象[OH\_Drawing\_Typeface](../../结构体/OH_Drawing_Typeface/capi-drawing-oh-drawing-typeface.md); 如果失败，返回nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_FontStyleStruct](../../结构体/OH_Drawing_FontStyleStruct/capi-drawing-oh-drawing-fontstylestruct.md) | 返回对应的字体样式。 |
...
| --- | --- |
| [OH\_Drawing\_FontStyleSet](../../结构体/OH_Drawing_FontStyleSet/capi-drawing-oh-drawing-fontstyleset.md)\* fontStyleSet | 指向字体样式集对象[OH\_Drawing\_FontStyleSet](../../结构体/OH_Drawing_FontStyleSet/capi-drawing-oh-drawing-fontstyleset.md)的指针。 |
| [OH\_Drawing\_FontStyleStruct](../../结构体/OH_Drawing_FontStyleStruct/capi-drawing-oh-drawing-fontstylestruct.md) fontStyleStruct | 字体样式对象，包括字体字重、字体宽度和字体斜度信息。 |
