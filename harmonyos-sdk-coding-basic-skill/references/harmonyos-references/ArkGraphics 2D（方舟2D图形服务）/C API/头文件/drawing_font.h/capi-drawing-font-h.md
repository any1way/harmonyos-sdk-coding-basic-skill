...
scraped_at: 2026-06-01T16:27:53+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:51169e40c21956cf89e110a9beb7b0d6dcc8d3eecaea877ac30840f011b02653
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_Drawing\_Font\_Metrics](../../结构体/OH_Drawing_Font_Metrics/capi-drawing-oh-drawing-font-metrics.md) | OH\_Drawing\_Font\_Metrics | 定义字体度量信息的结构体。 |
...
| [bool OH\_Drawing\_FontIsBaselineSnap(const OH\_Drawing\_Font\* font)](capi-drawing-font-h.md#oh_drawing_fontisbaselinesnap) | 当前画布矩阵轴对齐时，获取字型基线是否与像素对齐。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [void OH\_Drawing\_FontSetSubpixel(OH\_Drawing\_Font\* font, bool isSubpixel)](capi-drawing-font-h.md#oh_drawing_fontsetsubpixel) | 设置字型是否使用次像素渲染。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [bool OH\_Drawing\_FontIsSubpixel(const OH\_Drawing\_Font\* font)](capi-drawing-font-h.md#oh_drawing_fontissubpixel) | 获取字型是否使用次像素渲染。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
...
| [bool OH\_Drawing\_FontIsForceAutoHinting(const OH\_Drawing\_Font\* font)](capi-drawing-font-h.md#oh_drawing_fontisforceautohinting) | 获取字型轮廓是否自动调整。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
...
| [OH\_Drawing\_Typeface\* OH\_Drawing\_FontGetTypeface(OH\_Drawing\_Font\* font)](capi-drawing-font-h.md#oh_drawing_fontgettypeface) | 获取字体对象。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [void OH\_Drawing\_FontSetTextSize(OH\_Drawing\_Font\* font, float textSize)](capi-drawing-font-h.md#oh_drawing_fontsettextsize) | 用于给字型对象设置文字大小。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [float OH\_Drawing\_FontGetTextSize(const OH\_Drawing\_Font\* font)](capi-drawing-font-h.md#oh_drawing_fontgettextsize) | 获取字型对象的文字大小。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
...
| [void OH\_Drawing\_FontSetLinearText(OH\_Drawing\_Font\* font, bool isLinearText)](capi-drawing-font-h.md#oh_drawing_fontsetlineartext) | 用于设置线性可缩放字型。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [bool OH\_Drawing\_FontIsLinearText(const OH\_Drawing\_Font\* font)](capi-drawing-font-h.md#oh_drawing_fontislineartext) | 获取字型对象是否使用线性缩放。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [void OH\_Drawing\_FontSetTextSkewX(OH\_Drawing\_Font\* font, float skewX)](capi-drawing-font-h.md#oh_drawing_fontsettextskewx) | 用于给字型设置文本倾斜。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [float OH\_Drawing\_FontGetTextSkewX(const OH\_Drawing\_Font\* font)](capi-drawing-font-h.md#oh_drawing_fontgettextskewx) | 获取字型文本在x轴上的倾斜度。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
...
| [bool OH\_Drawing\_FontIsFakeBoldText(const OH\_Drawing\_Font\* font)](capi-drawing-font-h.md#oh_drawing_fontisfakeboldtext) | 获取是否增加笔画宽度以接近粗体字体。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [void OH\_Drawing\_FontSetScaleX(OH\_Drawing\_Font\* font, float scaleX)](capi-drawing-font-h.md#oh_drawing_fontsetscalex) | 用于设置字型在x轴上的缩放比例。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [float OH\_Drawing\_FontGetScaleX(const OH\_Drawing\_Font\* font)](capi-drawing-font-h.md#oh_drawing_fontgetscalex) | 获取字型在x轴上的缩放比例。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
...
| [OH\_Drawing\_FontHinting OH\_Drawing\_FontGetHinting(const OH\_Drawing\_Font\* font)](capi-drawing-font-h.md#oh_drawing_fontgethinting) | 获取字型轮廓效果枚举类型。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
...
| [bool OH\_Drawing\_FontIsEmbeddedBitmaps(const OH\_Drawing\_Font\* font)](capi-drawing-font-h.md#oh_drawing_fontisembeddedbitmaps) | 获取字型是否转换成位图处理。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
...
| [OH\_Drawing\_FontEdging OH\_Drawing\_FontGetEdging(const OH\_Drawing\_Font\* font)](capi-drawing-font-h.md#oh_drawing_fontgetedging) | 获取字型边缘效果。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  font为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
...
| [const OH\_Drawing\_FontFeatures](../../结构体/OH_Drawing_FontFeatures/capi-drawing-oh-drawing-fontfeatures.md)\* fontFeatures | 指向字体特征容器对象[OH\_Drawing\_FontFeatures](../../结构体/OH_Drawing_FontFeatures/capi-drawing-oh-drawing-fontfeatures.md)的指针。容器中未加入任何字体特征时使用TTF(TrueType Font)文件中预设的字体特征。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行结果。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数font、str、fontFeatures或者textWidth任意一个为空指针或者str的长度为0。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_FontFeatures](../../结构体/OH_Drawing_FontFeatures/capi-drawing-oh-drawing-fontfeatures.md)\* | 函数会返回一个指针，指向创建的字体特征容器对象[OH\_Drawing\_FontFeatures](../../结构体/OH_Drawing_FontFeatures/capi-drawing-oh-drawing-fontfeatures.md)。  如果返回的对象指针为空，则表示字体特征容器对象创建失败。失败的原因可能为：没有可用的内存。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_FontFeatures](../../结构体/OH_Drawing_FontFeatures/capi-drawing-oh-drawing-fontfeatures.md)\* fontFeatures | 指向字体特征容器对象[OH\_Drawing\_FontFeatures](../../结构体/OH_Drawing_FontFeatures/capi-drawing-oh-drawing-fontfeatures.md)的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行结果。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数fontFeatures或name为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行结果。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数fontFeatures为空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| const OH\_Drawing\_Font\* font | 指向字型对象[OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)的指针。 |
| const void\* text | 指向文本的指针。 |
| size\_t byteLength | 表示以字节为单位的文本长度。 |
| [OH\_Drawing\_TextEncoding](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_textencoding) encoding | 文本编码类型。 |
| const OH\_Drawing\_Brush\* brush | 指向画刷对象[OH\_Drawing\_Brush](../../结构体/OH_Drawing_Brush/capi-drawing-oh-drawing-brush.md)的指针。 |
| const OH\_Drawing\_Pen\* pen | 指向画笔对象[OH\_Drawing\_Pen](../../结构体/OH_Drawing_Pen/capi-drawing-oh-drawing-pen.md)的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行操作码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数font、text、textWidth至少有一个为空，或者byteLength为0，或者brush和pen同时存在。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行操作码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数font、glyphs至少有一个为空，或者count不大于0，或者brush和pen同时存在，或者widths和bounds同时为空。 |
...
| [OH\_Drawing\_Point2D](../../结构体/OH_Drawing_Point2D/capi-drawing-oh-drawing-point2d.md)\* points | 字形相对位置存储首地址，用于存储得到的字形相对位置，作为返回值返回给调用者。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行操作码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数font、glyphs、points至少有一个为空，或者count不大于0。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行操作码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数font、spacing至少有一个为空。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)\* | 函数会返回一个指针，指针指向创建的字型对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)\* font | 指向字型对象[OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)\* font | 指向字型对象的指针。 |
| [OH\_Drawing\_Typeface](../../结构体/OH_Drawing_Typeface/capi-drawing-oh-drawing-typeface.md)\* typeface | 指向字体对象的指针，为NULL会使用系统默认字体对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Typeface](../../结构体/OH_Drawing_Typeface/capi-drawing-oh-drawing-typeface.md)\* | OH\_Drawing\_Typeface 函数返回一个指针，指向字体对象[OH\_Drawing\_Typeface](../../结构体/OH_Drawing_Typeface/capi-drawing-oh-drawing-typeface.md)。 |
...
| [OH\_Drawing\_TextEncoding](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_textencoding) encoding | 文本编码类型[OH\_Drawing\_TextEncoding](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_textencoding)。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行错误码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数font、str、textWidth任意一个为NULL或者str的长度为0。 |
...
| size\_t byteLength | 表示以字节为单位的文本长度。 |
| [OH\_Drawing\_TextEncoding](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_textencoding) encoding | 文本编码类型。 |
| [OH\_Drawing\_Rect](../../结构体/OH_Drawing_Rect/capi-drawing-oh-drawing-rect.md)\* bounds | 用于承载获取的边界框，可以为NULL。 |
| float\* textWidth | 表示文本宽度。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行错误码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数font，text，textWidth至少有一个为空，或者byteLength为0。 |
...
| --- | --- |
| [OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)\* font | 指向字型对象[OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)的指针。 |
| [OH\_Drawing\_Font\_Metrics](../../结构体/OH_Drawing_Font_Metrics/capi-drawing-oh-drawing-font-metrics.md)\* fontMetrics | 指向字体度量信息对象[OH\_Drawing\_Font\_Metrics](../../结构体/OH_Drawing_Font_Metrics/capi-drawing-oh-drawing-font-metrics.md)的指针。 |
...
| [OH\_Drawing\_Array](../../结构体/OH_Drawing_Array/capi-drawing-oh-drawing-array.md)\* bounds | 矩形边界数组。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行错误码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数font、glyphs或bounds为空，或者count为零。 |
...
| [OH\_Drawing\_Path](../../结构体/OH_Drawing_Path/capi-drawing-oh-drawing-path.md)\* path | 指向路径对象[OH\_Drawing\_Path](../../结构体/OH_Drawing_Path/capi-drawing-oh-drawing-path.md)的指针, 用于存储得到的字形路径。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行错误码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数font或者path为空， 或者指定glyph不存在。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)\* font | 指示字型对象[OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)的指针。 |
| const void\* text | 指示要获取轮廓路径的文本字符串。 |
| size\_t byteLength | 指示要获取对应文本路径的字节长度，如果此字节长度大于text字符串的字节长度，会发生未定义行为。 |
| [OH\_Drawing\_TextEncoding](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_textencoding) encoding | 指示文本编码格式，支持 UTF-8、UTF-16、UTF-32，以及字形索引，具体类型格式可见[OH\_Drawing\_TextEncoding](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_textencoding)。 |
| float x | 指示文本在绘图区域内以原点为起始位置的X坐标。 |
| float y | 指示文本在绘图区域内以原点为起始位置的Y坐标。 |
| [OH\_Drawing\_Path](../../结构体/OH_Drawing_Path/capi-drawing-oh-drawing-path.md)\* path | 返回获取到的文字轮廓路径对象，作为出参使用。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 返回错误代码。  如果操作成功，则返回 [OH\_DRAWING\_SUCCESS](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode)。  如果 font、text 或 path 中的任何一个为空指针，则返回 [OH\_DRAWING\_ERROR\_INVALID\_PARAMETER](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)\* font | 指示字型对象[OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行错误码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数font为空。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行错误码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数font或者followed其中一个为空。 |
