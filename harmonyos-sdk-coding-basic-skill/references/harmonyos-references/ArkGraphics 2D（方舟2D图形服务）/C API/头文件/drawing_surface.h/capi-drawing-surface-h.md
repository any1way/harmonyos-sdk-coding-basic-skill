...
scraped_at: 2026-06-01T16:28:18+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:4b755e8d4d9ed9023227326f65d6030791e4cfe9f560b063a79102a475916977
---
## 概述
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_GpuContext](../../结构体/OH_Drawing_GpuContext/capi-drawing-oh-drawing-gpucontext.md)\* gpuContext | 指向图形处理器上下文对象的指针[OH\_Drawing\_GpuContext](../../结构体/OH_Drawing_GpuContext/capi-drawing-oh-drawing-gpucontext.md)。 |
| bool flag | 用于控制内存分配是否计入缓存预算。true则计入高速缓存预算，false则不计入高速缓存预算。 |
| [OH\_Drawing\_Image\_Info](../../结构体/OH_Drawing_Image_Info/capi-drawing-oh-drawing-image-info.md) imageInfo | 图片信息[OH\_Drawing\_Image\_Info](../../结构体/OH_Drawing_Image_Info/capi-drawing-oh-drawing-image-info.md)结构体。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Surface](../../结构体/OH_Drawing_Surface/capi-drawing-oh-drawing-surface.md)\* | 返回一个指针，指针指向创建的surface对象[OH\_Drawing\_Surface](../../结构体/OH_Drawing_Surface/capi-drawing-oh-drawing-surface.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_GpuContext](../../结构体/OH_Drawing_GpuContext/capi-drawing-oh-drawing-gpucontext.md)\* gpuContext | 指向图形处理器上下文对象的指针[OH\_Drawing\_GpuContext](../../结构体/OH_Drawing_GpuContext/capi-drawing-oh-drawing-gpucontext.md)。  该图形处理器上下文对象必须由[OH\_Drawing\_GpuContextCreate](../drawing_gpu_context.h/capi-drawing-gpu-context-h.md#oh_drawing_gpucontextcreate)创建，否则surface对象会创建失败。 |
| [OH\_Drawing\_Image\_Info](../../结构体/OH_Drawing_Image_Info/capi-drawing-oh-drawing-image-info.md) imageInfo | 图片信息[OH\_Drawing\_Image\_Info](../../结构体/OH_Drawing_Image_Info/capi-drawing-oh-drawing-image-info.md)结构体。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_Surface](../../结构体/OH_Drawing_Surface/capi-drawing-oh-drawing-surface.md)\* surface | 指向创建的surface对象的指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Canvas](../../结构体/OH_Drawing_Canvas/capi-drawing-oh-drawing-canvas.md)\* | 返回一个指针，指针指向创建的画布对象[OH\_Drawing\_Canvas](../../结构体/OH_Drawing_Canvas/capi-drawing-oh-drawing-canvas.md)。返回的指针不需要由调用者管理。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_Surface](../../结构体/OH_Drawing_Surface/capi-drawing-oh-drawing-surface.md)\* surface | 指向创建的surface对象的指针[OH\_Drawing\_Surface](../../结构体/OH_Drawing_Surface/capi-drawing-oh-drawing-surface.md)。该surface对象必须由[OH\_Drawing\_SurfaceCreateOnScreen](capi-drawing-surface-h.md#oh_drawing_surfacecreateonscreen)创建，否则该接口调用将没有任何效果。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行错误码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数surface为空。 |
