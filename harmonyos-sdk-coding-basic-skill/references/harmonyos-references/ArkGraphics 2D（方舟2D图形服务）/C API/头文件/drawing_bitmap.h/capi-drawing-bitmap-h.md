...
scraped_at: 2026-06-01T16:27:43+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:bda9c105e55051dc52322365b3158a426f34d43a845d1c1c9dabe6b8d7e4f449
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_Drawing\_BitmapFormat](../../结构体/OH_Drawing_BitmapFormat/capi-drawing-oh-drawing-bitmapformat.md) | OH\_Drawing\_BitmapFormat | 结构体用于描述位图像素的格式，包括颜色类型和透明度类型。 |
...
| [uint32\_t OH\_Drawing\_BitmapGetWidth(OH\_Drawing\_Bitmap\* bitmap)](capi-drawing-bitmap-h.md#oh_drawing_bitmapgetwidth) | 用于获取指定位图的宽度。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  bitmap为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [uint32\_t OH\_Drawing\_BitmapGetHeight(OH\_Drawing\_Bitmap\* bitmap)](capi-drawing-bitmap-h.md#oh_drawing_bitmapgetheight) | 用于获取指定位图的高度。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  bitmap为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Bitmap](../../结构体/OH_Drawing_Bitmap/capi-drawing-oh-drawing-bitmap.md)\* | 函数会返回一个指针，指针指向创建的位图对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_Image\_Info](../../结构体/OH_Drawing_Image_Info/capi-drawing-oh-drawing-image-info.md)\* imageInfo | 指向图片信息对象[OH\_Drawing\_Image\_Info](../../结构体/OH_Drawing_Image_Info/capi-drawing-oh-drawing-image-info.md)的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Bitmap](../../结构体/OH_Drawing_Bitmap/capi-drawing-oh-drawing-bitmap.md)\* | 函数返回一个指针，指针指向创建的位图对象[OH\_Drawing\_Bitmap](../../结构体/OH_Drawing_Bitmap/capi-drawing-oh-drawing-bitmap.md)。 |
...
| const [OH\_Drawing\_BitmapFormat](../../结构体/OH_Drawing_BitmapFormat/capi-drawing-oh-drawing-bitmapformat.md)\* bitmapFormat | 位图要初始化设置的像素格式，包括像素的颜色类型和透明度类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ColorFormat](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_colorformat) | 函数返回位图的像素存储格式，支持格式参考[OH\_Drawing\_ColorFormat](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_colorformat)。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_AlphaFormat](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_alphaformat) | 函数返回位图的像素透明度分量，支持格式参考[OH\_Drawing\_AlphaFormat](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_alphaformat)。 |
...
| --- | --- |
| [OH\_Drawing\_Bitmap](../../结构体/OH_Drawing_Bitmap/capi-drawing-oh-drawing-bitmap.md)\* bitmap | 指向位图对象[OH\_Drawing\_Bitmap](../../结构体/OH_Drawing_Bitmap/capi-drawing-oh-drawing-bitmap.md)的指针。 |
| const [OH\_Drawing\_Image\_Info](../../结构体/OH_Drawing_Image_Info/capi-drawing-oh-drawing-image-info.md)\* dstInfo | 指向图片信息对象[OH\_Drawing\_Image\_Info](../../结构体/OH_Drawing_Image_Info/capi-drawing-oh-drawing-image-info.md)的指针。 |
