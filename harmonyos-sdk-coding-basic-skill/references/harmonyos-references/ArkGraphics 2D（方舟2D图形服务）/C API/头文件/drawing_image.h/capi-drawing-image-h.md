...
scraped_at: 2026-06-01T16:27:56+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:f3d7d081320502c4deb3efcae1998100bdd7c1630ef2729343f00464a436e8d3
---
## 概述
...
| [int32\_t OH\_Drawing\_ImageGetWidth(OH\_Drawing\_Image\* image)](capi-drawing-image-h.md#oh_drawing_imagegetwidth) | 获取图片宽度，即每行的像素个数。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  image为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
| [int32\_t OH\_Drawing\_ImageGetHeight(OH\_Drawing\_Image\* image)](capi-drawing-image-h.md#oh_drawing_imagegetheight) | 获取图片高度，即像素行数。  本接口会产生错误码，可以通过[OH\_Drawing\_ErrorCodeGet](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。  image为NULL时返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Image](../../结构体/OH_Drawing_Image/capi-drawing-oh-drawing-image.md)\* | 函数返回一个指针，指针指向创建的图片对象[OH\_Drawing\_Image](../../结构体/OH_Drawing_Image/capi-drawing-oh-drawing-image.md)。 |
...
| --- | --- |
| [OH\_Drawing\_Image](../../结构体/OH_Drawing_Image/capi-drawing-oh-drawing-image.md)\* image | 指向图片对象[OH\_Drawing\_Image](../../结构体/OH_Drawing_Image/capi-drawing-oh-drawing-image.md)的指针。 |
| [OH\_Drawing\_Image\_Info](../../结构体/OH_Drawing_Image_Info/capi-drawing-oh-drawing-image-info.md)\* imageInfo | 指向图片信息对象[OH\_Drawing\_Image\_Info](../../结构体/OH_Drawing_Image_Info/capi-drawing-oh-drawing-image-info.md)的指针，开发者可调用[OH\_Drawing\_Image\_Info](../../结构体/OH_Drawing_Image_Info/capi-drawing-oh-drawing-image-info.md)创建。 |
