...
content_hash: sha256:315dc1a34885119f22b624e004e859d14fb700fa1fb27d8fbd597ebe667f010a
---
## 概述
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)\* | 函数会返回一个指针，指针指向创建的区域对象[OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)\* region | 指向用于拷贝的区域对象[OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)的指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)\* | 函数会返回一个指针，指针指向创建的新区域对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)\* region | 指向区域对象[OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)\* region | 指向区域对象[OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)的指针，操作完成后的区域结果将会保存在此区域对象中。 |
| const [OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)\* other | 指向区域对象[OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)的指针。 |
...
| const [OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)\* clip | 指向区域对象[OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行错误码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INCORRECT\_PARAMETER，表示参数region为空。 |
...
| [OH\_Drawing\_Path](../../结构体/OH_Drawing_Path/capi-drawing-oh-drawing-path.md)\* path | 指向路径对象[OH\_Drawing\_Path](../../结构体/OH_Drawing_Path/capi-drawing-oh-drawing-path.md)的指针。作为出参使用。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行结果。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INCORRECT\_PARAMETER，表示region或path是空指针。 |
...
| --- | --- |
| [const OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)\* region | 指向区域对象[OH\_Drawing\_Region](../../结构体/OH_Drawing_Region/capi-drawing-oh-drawing-region.md)的指针。 |
| [OH\_Drawing\_Rect](../../结构体/OH_Drawing_Rect/capi-drawing-oh-drawing-rect.md)\* rect | 指向矩形对象[OH\_Drawing\_Rect](../../结构体/OH_Drawing_Rect/capi-drawing-oh-drawing-rect.md)的指针。作为出参使用。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行结果。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INCORRECT\_PARAMETER，表示region或rect是空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行结果。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INCORRECT\_PARAMETER，表示region或isComplex是空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行结果。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INCORRECT\_PARAMETER，表示region或isEmpty是空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行结果。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INCORRECT\_PARAMETER，表示region或isRect是空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行结果。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INCORRECT\_PARAMETER，表示region或isContained是空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行结果。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INCORRECT\_PARAMETER，表示region或isReject是空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行结果。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INCORRECT\_PARAMETER，表示region是空指针。 |
