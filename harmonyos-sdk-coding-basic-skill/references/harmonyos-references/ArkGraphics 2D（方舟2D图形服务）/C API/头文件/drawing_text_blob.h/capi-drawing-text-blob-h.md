...
content_hash: sha256:d3fe5163daee3574071f431b037d6ad3e21d133c9ee92a1d35819d95e4b070fc
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_Drawing\_RunBuffer](../../结构体/OH_Drawing_RunBuffer/capi-drawing-oh-drawing-runbuffer.md) | OH\_Drawing\_RunBuffer | 结构体用于描述一块内存，描述文字和位置信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_TextBlobBuilder](../../结构体/OH_Drawing_TextBlobBuilder/capi-drawing-oh-drawing-textblobbuilder.md)\* | 函数会返回一个指针，指针指向创建的文本构造器对象。 |
...
| const [OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)\* font | 指向字体对象[OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)的指针。 |
| [OH\_Drawing\_TextEncoding](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_textencoding) textEncoding | 文本编码类型[OH\_Drawing\_TextEncoding](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_textencoding)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_TextBlob](../../结构体/OH_Drawing_TextBlob/capi-drawing-oh-drawing-textblob.md)\* | 函数返回一个指针，指针指向创建的文本对象[OH\_Drawing\_TextBlob](../../结构体/OH_Drawing_TextBlob/capi-drawing-oh-drawing-textblob.md)。 |
...
| const void\* text | 指向文本的指针。 |
| size\_t byteLength | 文本的字节长度。 |
| [OH\_Drawing\_Point2D](../../结构体/OH_Drawing_Point2D/capi-drawing-oh-drawing-point2d.md)\* point2D | 二维点[OH\_Drawing\_Point2D](../../结构体/OH_Drawing_Point2D/capi-drawing-oh-drawing-point2d.md)数组首地址，数组个数由[OH\_Drawing\_FontCountText](../drawing_font.h/capi-drawing-font-h.md#oh_drawing_fontcounttext)计算结果决定。 |
| const [OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)\* font | 指向字体对象[OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)的指针。 |
| [OH\_Drawing\_TextEncoding](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_textencoding) textEncoding | 文本编码类型[OH\_Drawing\_TextEncoding](../drawing_types.h/capi-drawing-types-h.md#oh_drawing_textencoding)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_TextBlob](../../结构体/OH_Drawing_TextBlob/capi-drawing-oh-drawing-textblob.md)\* textBlob | 指向文本对象[OH\_Drawing\_TextBlob](../../结构体/OH_Drawing_TextBlob/capi-drawing-oh-drawing-textblob.md)的指针。 |
| [OH\_Drawing\_Rect](../../结构体/OH_Drawing_Rect/capi-drawing-oh-drawing-rect.md)\* rect | 指向矩形对象[OH\_Drawing\_Rect](../../结构体/OH_Drawing_Rect/capi-drawing-oh-drawing-rect.md)的指针，开发者可调用[OH\_Drawing\_Rect](../../结构体/OH_Drawing_Rect/capi-drawing-oh-drawing-rect.md)接口创建。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [OH\_Drawing\_TextBlob](../../结构体/OH_Drawing_TextBlob/capi-drawing-oh-drawing-textblob.md)\* textBlob | 指向文本对象[OH\_Drawing\_TextBlob](../../结构体/OH_Drawing_TextBlob/capi-drawing-oh-drawing-textblob.md)的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_TextBlobBuilder](../../结构体/OH_Drawing_TextBlobBuilder/capi-drawing-oh-drawing-textblobbuilder.md)\* textBlobBuilder | 指向文本构造器对象的指针。 |
| const [OH\_Drawing\_Font](../../结构体/OH_Drawing_Font/capi-drawing-oh-drawing-font.md)\* font | 指向字体对象的指针。 |
| int32\_t count | 文字的数量。 |
| const [OH\_Drawing\_Rect](../../结构体/OH_Drawing_Rect/capi-drawing-oh-drawing-rect.md)\* rect | 文本的边界框，为NULL表示不设置边界框。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_TextBlob](../../结构体/OH_Drawing_TextBlob/capi-drawing-oh-drawing-textblob.md)\* | 返回一个指针，指针指向创建的文本对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_TextBlob](../../结构体/OH_Drawing_TextBlob/capi-drawing-oh-drawing-textblob.md)\* textBlob | 指向文本对象的指针。 |
