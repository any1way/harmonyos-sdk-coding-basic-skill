...
scraped_at: 2026-06-01T16:28:39+08:00
doc_updated_at: 2026-05-08
content_hash: sha256:630dc66df61ba54650c6d931895dac7ddfec97352fa69e70b4d8ce852a0035a8
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [Region](../../结构体/Region/capi-nativewindow-region.md) | Region | 表示本地窗口OHNativeWindow需要更新内容的矩形区域（脏区）。 |
| [Rect](../../结构体/Rect/capi-nativewindow-rect.md) | - | 如果rects是空指针nullptr，默认Buffer大小为脏区。 |
| [OHHDRMetaData](../../结构体/OHHDRMetaData/capi-nativewindow-ohhdrmetadata.md) | OHHDRMetaData | HDR元数据结构体定义。 |
| [OHExtDataHandle](../../结构体/OHExtDataHandle/capi-nativewindow-ohextdatahandle.md) | OHExtDataHandle | 扩展数据句柄结构体定义。 |
| [OHIPCParcel](../../结构体/OHIPCParcel/capi-nativewindow-ohipcparcel.md) | OHIPCParcel | 提供对IPC序列化对象的访问功能。 |
| [NativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md) | OHNativeWindow | 提供对OHNativeWindow的访问功能。 |
| [NativeWindowBuffer](../../结构体/NativeWindowBuffer/capi-nativewindow-nativewindowbuffer.md) | OHNativeWindowBuffer | 提供对OHNativeWindowBuffer的访问功能。 |
| [OH\_NativeBuffer](../../结构体/OH_NativeBuffer/capi-oh-nativebuffer-oh-nativebuffer.md) | OH\_NativeBuffer | 提供对OH\_NativeBuffer的访问功能。 |
...
| GET\_FORMAT | 获取本地窗口缓冲区格式，函数中的可变参数是[输出] int32\_t \*format，取值具体可见[OH\_NativeBuffer\_Format](../buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_format)枚举值。 |
| SET\_FORMAT | 设置本地窗口缓冲区格式，函数中的可变参数是[输入] int32\_t format，取值具体可见[OH\_NativeBuffer\_Format](../buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_format)枚举值。 |
| GET\_USAGE | 获取本地窗口读写方式，函数中的可变参数是[输出] uint64\_t \*usage，取值具体可见[OH\_NativeBuffer\_Usage](../native_buffer.h/capi-native-buffer-h.md#oh_nativebuffer_usage)枚举值。 |
| SET\_USAGE | 设置本地窗口缓冲区读写方式，函数中的可变参数是[输入] uint64\_t usage，取值具体可见[OH\_NativeBuffer\_Usage](../native_buffer.h/capi-native-buffer-h.md#oh_nativebuffer_usage)枚举值。 |
| SET\_STRIDE | 设置本地窗口缓冲区步幅，函数中的可变参数是[输入] int32\_t stride。  **废弃版本：** 16 |
| GET\_STRIDE | 获取本地窗口缓冲区步幅，函数中的可变参数是[输出] int32\_t \*stride。  **废弃版本：** 16  **替代方案：** 使用[OH\_NativeWindow\_GetBufferHandleFromNative](capi-external-window-h.md#oh_nativewindow_getbufferhandlefromnative)接口获取BufferHandle实例，从[BufferHandle](../../结构体/BufferHandle/capi-nativewindow-bufferhandle.md)实例中获取stride值。 |
...
| SET\_COLOR\_GAMUT | 设置本地窗口缓冲区色彩空间，函数中的可变参数是[输入] int32\_t colorGamut，取值具体可见[OH\_NativeBuffer\_ColorGamut](../native_buffer.h/capi-native-buffer-h.md#oh_nativebuffer_colorgamut)枚举值。 |
| GET\_COLOR\_GAMUT | 获取本地窗口缓冲区色彩空间，函数中的可变参数是[输出] int32\_t \*colorGamut，取值具体可见[OH\_NativeBuffer\_ColorGamut](../native_buffer.h/capi-native-buffer-h.md#oh_nativebuffer_colorgamut)枚举值。 |
| SET\_TRANSFORM | 设置本地窗口缓冲区变换，函数中的可变参数是[输入] int32\_t transform，取值具体可见[OH\_NativeBuffer\_TransformType](../buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_transformtype)枚举值。 |
| GET\_TRANSFORM | 获取本地窗口缓冲区变换，函数中的可变参数是[输出] int32\_t \*transform，取值具体可见[OH\_NativeBuffer\_TransformType](../buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_transformtype)枚举值。 |
...
说明：此接口不可用，可通过[OH\_NativeImage\_AcquireNativeWindow](../native_image.h/capi-native-image-h.md#oh_nativeimage_acquirenativewindow)创建，或通过XComponent创建。
...
| 类型 | 说明 |
| --- | --- |
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md)\* | 返回一个指针，指向OHNativeWindow的结构体实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md)\* window | 一个OHNativeWindow的结构体实例的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OHNativeWindowBuffer](../../结构体/NativeWindowBuffer/capi-nativewindow-nativewindowbuffer.md)\* buffer | 一个OHNativeWindowBuffer的结构体实例的指针。 |
...
| --- | --- |
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md) \*window | 一个OHNativeWindow的结构体实例的指针。 |
| [OHNativeWindowBuffer](../../结构体/NativeWindowBuffer/capi-nativewindow-nativewindowbuffer.md) \*\*buffer | 一个指向OHNativeWindowBuffer指针的指针（二级指针）。  通过OH\_NativeWindow\_GetBufferHandleFromNative可获取BufferHandle结构体，访问缓冲区内存。 |
...
| [Region](../../结构体/Region/capi-nativewindow-region.md) region | 一个Region结构体，表示一块脏区域，该区域有内容更新。  Region.rectNumber限制最大数量为1000，当rectNumber≤0或者rectNumber>1000时，使用整个buffer作为脏区。  Region.rect以buffer左下角为坐标原点。 |
...
| --- | --- |
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md) \*window | 一个OHNativeWindow的结构体实例的指针。 |
| [OHNativeWindowBuffer](../../结构体/NativeWindowBuffer/capi-nativewindow-nativewindowbuffer.md) \*\*buffer | 一个OHNativeWindowBuffer结构体指针的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [BufferHandle](../../结构体/BufferHandle/capi-nativewindow-bufferhandle.md) | BufferHandle 返回一个指针，指向[BufferHandle](../../结构体/BufferHandle/capi-nativewindow-bufferhandle.md)的结构体实例。 |
...
| --- | --- |
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md) \*window | 一个OHNativeWindow的结构体实例的指针。 |
| const [OHExtDataHandle](../../结构体/OHExtDataHandle/capi-nativewindow-ohextdatahandle.md) \*handle | 指向OHExtDataHandle的指针。 |
...
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md) \*\*window | 一个OHNativeWindow的结构体实例的二级指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md) \*window | 一个[OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md)的结构体实例的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md) \*window | 一个指向[OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md)的结构体实例的指针。 |
| [OHIPCParcel](../../结构体/OHIPCParcel/capi-nativewindow-ohipcparcel.md) \*parcel | 一个指向[OHIPCParcel](../../结构体/OHIPCParcel/capi-nativewindow-ohipcparcel.md)的结构体实例的指针。 |
...
| --- | --- |
| [OHIPCParcel](../../结构体/OHIPCParcel/capi-nativewindow-ohipcparcel.md) \*parcel | 一个指向[OHIPCParcel](../../结构体/OHIPCParcel/capi-nativewindow-ohipcparcel.md)的结构体实例的指针。 |
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md) \*\*window | 一个指向[OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md)的结构体实例的二级指针。 |
...
| --- | --- |
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md) \*window | 一个指向[OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md)的结构体实例的指针。 |
| [OH\_NativeBuffer\_ColorSpace](../buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_colorspace) colorSpace | 为OHNativeWindow设置的颜色空间，其值从[OH\_NativeBuffer\_ColorSpace](../buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_colorspace)获取。 |
...
| --- | --- |
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md) \*window | 一个指向[OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md)的结构体实例的指针。 |
| [OH\_NativeBuffer\_MetadataKey](../buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_metadatakey) metadataKey | Window的元数据类型，其值从[OH\_NativeBuffer\_MetadataKey](../buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_metadatakey)获取。 |
| int32\_t size | uint8\_t向量的大小，其取值范围见[OH\_NativeBuffer\_MetadataKey](../buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_metadatakey)。 |
| metadata | 指向uint8\_t向量的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md) \*window | 一个指向OHNativeWindow的结构体实例的指针。 |
...
| [OHNativeWindow](../../结构体/NativeWindow/capi-nativewindow-nativewindow.md)\* window | 一个指向OHNativeWindow的结构体实例的指针。 |
| [Region](../../结构体/Region/capi-nativewindow-region.md) region | 一个Region结构体，表示一块脏区域，该区域有内容更新。  Region.rectNumber限制最大数量为1000，当rectNumber≤0或者rectNumber>1000时，使用整个buffer作为脏区。  Region.rect以buffer左下角为坐标原点。 |
| [OHNativeWindowBuffer](../../结构体/NativeWindowBuffer/capi-nativewindow-nativewindowbuffer.md)\*\* buffer | 一个指向OHNativeWindowBuffer的二级指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| int32\_t | 执行成功时返回NATIVE\_ERROR\_OK。  window或buffer是空指针时返回NATIVE\_ERROR\_INVALID\_ARGUMENTS。  window的surface成员是空指针时返回NATIVE\_ERROR\_UNKNOWN。  其他返回值可参考[OHNativeErrorCode](../graphic_error_code.h/capi-graphic-error-code-h.md#ohnativeerrorcode)。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 执行成功时返回NATIVE\_ERROR\_OK。  window是空指针时返回NATIVE\_ERROR\_INVALID\_ARGUMENTS。  window的surface成员是空指针时返回NATIVE\_ERROR\_UNKNOWN。  其他返回值可参考[OHNativeErrorCode](../graphic_error_code.h/capi-graphic-error-code-h.md#ohnativeerrorcode)。 |
