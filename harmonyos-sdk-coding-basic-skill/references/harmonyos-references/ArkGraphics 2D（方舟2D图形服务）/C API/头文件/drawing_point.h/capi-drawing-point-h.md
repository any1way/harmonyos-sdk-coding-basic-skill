...
scraped_at: 2026-06-01T16:28:08+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:8e85e70806571570673bbd890ac94364b8f91437cf79d90d3154c5c3309f021d
---
## 概述
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_Point](../../结构体/OH_Drawing_Point/capi-drawing-oh-drawing-point.md)\* | 函数会返回一个指针，指针指向创建的坐标点对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [OH\_Drawing\_Point](../../结构体/OH_Drawing_Point/capi-drawing-oh-drawing-point.md)\* point | 指向坐标点对象[OH\_Drawing\_Point](../../结构体/OH_Drawing_Point/capi-drawing-oh-drawing-point.md)的指针。 |
| float\* x | 表示点的x轴坐标。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行错误码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数point或者x为空。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行错误码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数point或者y为空。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_Point](../../结构体/OH_Drawing_Point/capi-drawing-oh-drawing-point.md)\* point | 指向坐标点对象[OH\_Drawing\_Point](../../结构体/OH_Drawing_Point/capi-drawing-oh-drawing-point.md)的指针。 |
| float x | 表示点的x轴坐标。 |
| float y | 表示点的y轴坐标。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Drawing\_ErrorCode](../drawing_error_code.h/capi-drawing-error-code-h.md#oh_drawing_errorcode) | 函数返回执行错误码。  返回OH\_DRAWING\_SUCCESS，表示执行成功。  返回OH\_DRAWING\_ERROR\_INVALID\_PARAMETER，表示参数point为空。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Drawing\_Point](../../结构体/OH_Drawing_Point/capi-drawing-oh-drawing-point.md)\* point | 指向坐标点对象的指针。 |
