...
scraped_at: 2026-06-01T16:28:35+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:2115e97ea5dc3fe7dfdab257a6583488a8a663bca8295cb0493fd67f82aa3e83
---
## 概述
...
**相关模块：** [NativeVsync](../../模块/NativeVsync/capi-nativevsync.md)
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_NativeVSync\_ExpectedRateRange](../../结构体/OH_NativeVSync_ExpectedRateRange/capi-nativevsync-oh-nativevsync-expectedraterange.md) | OH\_NativeVSync\_ExpectedRateRange | 期望帧率范围结构体。 |
| [OH\_NativeVSync](../../结构体/OH_NativeVSync/capi-nativevsync-oh-nativevsync.md) | OH\_NativeVSync | 提供OH\_NativeVSync结构体声明。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_NativeVSync](../../结构体/OH_NativeVSync/capi-nativevsync-oh-nativevsync.md)\* | 返回一个指向OH\_NativeVSync实例的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| uint64\_t windowID | 表示窗口ID，窗口子进程索引标识符，可以通过[OH\_NativeWindow\_GetSurfaceId](../external_window.h/capi-external-window-h.md#oh_nativewindow_getsurfaceid)接口获取。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_NativeVSync](../../结构体/OH_NativeVSync/capi-nativevsync-oh-nativevsync.md)\* nativeVsync | 一个指向OH\_NativeVSync实例的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| int | 返回值为0表示执行成功，其他返回值可参考[OHNativeErrorCode](../graphic_error_code.h/capi-graphic-error-code-h.md#ohnativeerrorcode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_NativeVSync](../../结构体/OH_NativeVSync/capi-nativevsync-oh-nativevsync.md)\* nativeVsync | 指向[OH\_NativeVSync](../../结构体/OH_NativeVSync/capi-nativevsync-oh-nativevsync.md)实例的指针。 |
| [OH\_NativeVSync\_ExpectedRateRange](../../结构体/OH_NativeVSync_ExpectedRateRange/capi-nativevsync-oh-nativevsync-expectedraterange.md)\* range | 指向[OH\_NativeVSync\_ExpectedRateRange](../../结构体/OH_NativeVSync_ExpectedRateRange/capi-nativevsync-oh-nativevsync-expectedraterange.md)实例的指针。  有效的期望帧率范围为：0 <= 最小值 <= 期望帧率 <= 最大值 <= 144。  期望帧率为0时，表示取消设置期望帧率。  此指针需开发者自行管理生命周期。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| int | 返回值为0表示成功，其他返回值可参考[OHNativeErrorCode](../graphic_error_code.h/capi-graphic-error-code-h.md#ohnativeerrorcode)。 |
