...
scraped_at: 2026-06-01T15:57:30+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:7e1acc0daeefc15f78cc0b5642ddde22e334508fb7e37f901802a52d6355f7d5
---
该模块提供文件分享能力，提供系统应用将公共目录文件统一资源标识符（Uniform Resource Identifier，URI）以读写权限授权给其他应用的接口，授权后应用可通过[@ohos.file.fs](<../@ohos.file.fs (文件管理)/js-apis-file-fs.md>)的相关接口进行相关open、read、write等操作，实现文件分享。
