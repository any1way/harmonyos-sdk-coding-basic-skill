...
scraped_at: 2026-06-01T15:57:26+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:3931e5991357c1003e6904bb24bfabac85bde218e88fdd54a503ee5620e724b5
---
...
数据安全等级详细说明请见[数据安全标签](<../../../../harmonyos-guides/应用框架/ArkData（方舟数据管理）/数据可靠性与安全性/基于设备分类和数据分级的访问控制 (ArkTS)/access-control-by-device-and-data-level.md#数据安全标签>)。
...
以下错误码的详细介绍请参见[基础文件IO错误码](../../错误码/文件管理错误码/errorcode-filemanagement.md#基础文件io错误码)。
