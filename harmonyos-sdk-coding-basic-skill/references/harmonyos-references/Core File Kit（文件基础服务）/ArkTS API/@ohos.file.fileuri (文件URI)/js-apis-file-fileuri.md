...
scraped_at: 2026-06-01T15:57:17+08:00
doc_updated_at: 2026-03-19
content_hash: sha256:020210a7bf4555bd690efd74cc024d3abec22be6413ecb46b84d7edc9e83ed7d
---
该模块提供通过PATH获取文件统一资源标识符（Uniform Resource Identifier，URI），后续可通过使用[@ohos.file.fs](<../@ohos.file.fs (文件管理)/js-apis-file-fs.md>)进行相关open、read、write等操作，实现文件分享。
