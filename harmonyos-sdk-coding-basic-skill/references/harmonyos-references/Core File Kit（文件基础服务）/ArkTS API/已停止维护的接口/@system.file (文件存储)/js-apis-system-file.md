...
scraped_at: 2026-06-01T15:57:37+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:6daa65e0966eeee97a79f019fa12b6b6047e51caf38a747c752e7495880e8c61
---
说明

* 模块维护策略：
  + 对于Lite Wearable设备类型，该模块长期维护，正常使用。
  + 对于支持该模块的其他设备类型，该模块从API Version 10开始不再维护，推荐使用新接口[@ohos.file.fs](<../../@ohos.file.fs (文件管理)/js-apis-file-fs.md>)。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.moveFile](<../../@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileiomovefile>)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.copyFile](<../../@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileiocopyfile>)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.listFile](<../../@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileiolistfile>)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.stat](<../../@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileiostat>)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.unlink](<../../@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileiounlink>)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.write](<../../@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileiowrite>)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.readText](<../../@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileioreadtext>)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.read](<../../@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileioread>)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.access](<../../@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileioaccess>)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.mkdir](<../../@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileiomkdir>)替代。
...
除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.rmdir](<../../@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileiormdir>)替代。
