...
scraped_at: 2026-06-01T15:57:52+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:bafc2130cda07804834c3ec25ccfba4611eb8a5abea55da0daa541716f24c133
---
```
...
| [CloudDisk\_PathInfo](../CloudDisk_PathInfo/capi-clouddisk-clouddisk-pathinfo.md) relativePathInfo | 同步根路径下的文件，相对于同步根路径的相对路径。 |
| [CloudDisk\_OperationType](../../头文件/oh_cloud_disk_manager.h/capi-oh-cloud-disk-manager-h.md#clouddisk_operationtype) operationType | 此文件的变更操作类型（如：创建、删除、移动等）。 |
