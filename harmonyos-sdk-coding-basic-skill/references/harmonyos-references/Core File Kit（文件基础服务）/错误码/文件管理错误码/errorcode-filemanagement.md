...
scraped_at: 2026-06-01T15:58:00+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:53756ffd3db939a9a6df11c45db3b895ab1cf870c2923204657527e73f9b71c3
---
说明
...
1.根据当前系统的[访问控制机制](../../../../harmonyos-guides/系统/安全/程序访问控制/访问控制概述/access-token-overview.md)，应用无法使用分享给其他应用的URI。

2.根据[系统Picker](<../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/应用间跳转/拉起系统应用/system-app-startup.md#拉起系统应用的方式>)的运行机制，通过Picker获取到的URI仅具有临时权限，应用退出或设备重启后如需继续访问，需按[授权持久化](<../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/选择与保存用户文件/授权持久化/file-persistpermission.md>)流程处理。
...
3.确认文件的路径是否为应用内的沙箱路径（[应用沙箱目录与应用沙箱路径](<../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/应用沙箱目录/app-sandbox-directory.md#应用沙箱目录与应用沙箱路径>)），文件管理系统禁止操作应用沙箱以外的文档。
...
3. 完成提交后再修改。
   ...
   * 在调用createImageAssetRequest/createVideoAssetRequest/getWriteCacheHandler/addResource后，需调用[applyChanges](<../../../Media Library Kit（媒体文件管理服务）/ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Interface (PhotoAccessHelper)/arkts-apis-photo_93807367.md#applychanges11>)提交生效。
