...
scraped_at: 2026-06-11T16:14:52+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:c088ed8eb2876cfd46c81aaff0a4be55b385ff078b39b6e795c85a317e0b8884
---
本模块提供了星闪数据传输的功能。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uuid | string | 是 | 可填写16字节星闪服务UUID，或填写2字节支持数传的星闪标准服务UUID。UUID格式参考“[星闪标准服务标识](<../../../../harmonyos-guides/系统/网络/NearLink Kit（星闪服务）/NearLink Kit常见问题/nearlink-faq.md#星闪标准服务uuid的格式>)”。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uuid | string | 是 | 可填写16字节星闪服务UUID，或填写2字节支持数传的星闪标准服务UUID。UUID格式参考“[星闪标准服务](<../../../../harmonyos-guides/系统/网络/NearLink Kit（星闪服务）/NearLink Kit常见问题/nearlink-faq.md#星闪标准服务uuid的格式>)”。 |
...
| 类型 | 说明 |
| --- | --- |
| [ConnectionState](../constant（星闪公共常量定义）/nearlink-constant.md#connectionstate) | 和远端设备的星闪端口通道连接状态。 |
...
| uuid | string | 否 | 否 | 星闪服务UUID，例如：37bea880-fc70-11ea-b720-000000004386。UUID格式参考[星闪标准服务UUID](<../../../../harmonyos-guides/系统/网络/NearLink Kit（星闪服务）/NearLink Kit常见问题/nearlink-faq.md#星闪标准服务uuid的格式>)。 |
...
| state | [ConnectionState](../constant（星闪公共常量定义）/nearlink-constant.md#connectionstate) | 否 | 否 | 与远端设备的连接状态。 |
