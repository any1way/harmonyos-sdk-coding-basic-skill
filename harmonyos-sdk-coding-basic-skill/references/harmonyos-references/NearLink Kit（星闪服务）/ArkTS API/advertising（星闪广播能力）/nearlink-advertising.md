...
scraped_at: 2026-06-11T16:14:47+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:847197a8c19f7fddbd574d3baf51bba262dfe04f32741b121be2f6be06b3d3fd
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| serviceUuids | Array<string> | 否 | 是 | 服务UUID列表。若未配置则默认不携带该字段。UUID格式参考[星闪标准服务UUID](<../../../../harmonyos-guides/系统/网络/NearLink Kit（星闪服务）/NearLink Kit常见问题/nearlink-faq.md#星闪标准服务uuid的格式>)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| serviceUuid | string | 否 | 否 | 表示服务的UUID。UUID格式参考[星闪标准服务UUID](<../../../../harmonyos-guides/系统/网络/NearLink Kit（星闪服务）/NearLink Kit常见问题/nearlink-faq.md#星闪标准服务uuid的格式>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为'advertisingStateChange'，表示星闪广播状态事件。  当调用[sle.startAdvertising](nearlink-advertising.md#startadvertising)、[sle.stopAdvertising](nearlink-advertising.md#stopadvertising)时，均会触发该事件。 |
