...
scraped_at: 2026-06-11T16:14:51+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:7efa0c9e796de5b74c84a3e35c9eeb61bc4224397ab636ee3a87d38c4d9f136e
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| serviceUuid | string | 是 | 服务UUID，用户添加服务时的UUID号，例如：37bea880-fc70-11ea-b720-000000004386。UUID格式参考[星闪标准服务UUID](<../../../../harmonyos-guides/系统/网络/NearLink Kit（星闪服务）/NearLink Kit常见问题/nearlink-faq.md#星闪标准服务uuid的格式>)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| serviceUuid | string | 否 | 否 | 表示服务UUID例如：37bea880-fc70-11ea-b720-000000004386。UUID格式参考[星闪标准服务UUID](<../../../../harmonyos-guides/系统/网络/NearLink Kit（星闪服务）/NearLink Kit常见问题/nearlink-faq.md#星闪标准服务uuid的格式>)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| serviceUuid | string | 否 | 否 | 表示服务UUID，例如：37bea880-fc70-11ea-b720-000000004386。UUID格式参考[星闪标准服务UUID](<../../../../harmonyos-guides/系统/网络/NearLink Kit（星闪服务）/NearLink Kit常见问题/nearlink-faq.md#星闪标准服务uuid的格式>)。 |
| propertyUuid | string | 否 | 否 | 表示Property的UUID，数据格式同serviceUuid。 |
...
| state | [ConnectionState](../constant（星闪公共常量定义）/nearlink-constant.md#connectionstate) | 否 | 否 | 表示和远端设备的连接状态。 |
