...
scraped_at: 2026-06-11T16:14:43+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:a9d128a68574addc2ee5e31e4614de488c6f3fe8c6b3c0c5a5f106e7476f4c30
---
...
| 类型 | 说明 |
| --- | --- |
| [constant.PairingState](../constant（星闪公共常量定义）/nearlink-constant.md#pairingstate) | 和远端设备的配对状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [constant.ConnectionState](../constant（星闪公共常量定义）/nearlink-constant.md#connectionstate) | 和远端设备的连接状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [constant.AcbState](../constant（星闪公共常量定义）/nearlink-constant.md#acbstate) | 和远端设备的逻辑链路连接状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为'pairingStateChange'，表示配对请求事件。  当调用[remoteDevice.startPairing](../remoteDevice（对端设备的连接能力）/nearlink-remote-device.md#startpairing)发起主动配对，或者本机设备收到其他设备的配对请求时，触发该事件。 |
...
| preState | [PairingState](../constant（星闪公共常量定义）/nearlink-constant.md#pairingstate) | 否 | 否 | 本次上报之前的配对状态。 |
| state | [PairingState](../constant（星闪公共常量定义）/nearlink-constant.md#pairingstate) | 否 | 否 | 当前配对状态。 |
...
| preState | [ConnectionState](../constant（星闪公共常量定义）/nearlink-constant.md#connectionstate) | 否 | 否 | 本次上报之前的连接状态。 |
| state | [ConnectionState](../constant（星闪公共常量定义）/nearlink-constant.md#connectionstate) | 否 | 否 | 当前连接状态。 |
...
| state | [AcbState](../constant（星闪公共常量定义）/nearlink-constant.md#acbstate) | 否 | 否 | 当前逻辑链路连接状态。 |
