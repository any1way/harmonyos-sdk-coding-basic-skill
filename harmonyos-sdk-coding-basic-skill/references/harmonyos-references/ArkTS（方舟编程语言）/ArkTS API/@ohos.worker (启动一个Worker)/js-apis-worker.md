...
scraped_at: 2026-06-01T15:36:28+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:b19fe87e91113533486836418ee5ffdbde908c58a442696614d3bd859a3c6f10
---
...
请查看[Worker注意事项](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/Worker简介/worker-introduction.md)，了解Worker使用过程中的相关注意点。
...
| name | string | 否 | 是 | Worker的名称。  默认值为undefined，此时线程名称为'WorkerThread'。  非默认值情况下，对应的线程名称带有'WorkerThread\_'前缀。比如name为'testName'时，对应的线程名称为'WorkerThread\_testName'。  线程名称可通过[HeapMemoryInfo](<../@ohos.util (util工具函数)/js-apis-util.md#heapmemoryinfo24>)的threadName获取  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
Worker线程的优先级枚举，各优先级对应关系请参考[QoS等级定义](<../../../../harmonyos-guides/系统/基础功能/Kernel Enhance Kit（内核增强能力）/QoS 开发指导/qos-guidelines.md#qos等级定义>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scriptURL | string | 是 | Worker线程文件的路径。  路径规则详细参考[文件路径注意事项](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/Worker简介/worker-introduction.md#文件路径注意事项)。 |
...
以下示例展示了在Stage模型的entry模块Index.ets文件中加载Worker文件的方法，使用Library加载Worker线程文件的场景参考[文件路径注意事项](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/Worker简介/worker-introduction.md#文件路径注意事项)。
...
宿主线程可以通过转移对象所有权或拷贝数据的方式向Worker线程发送消息。在传递[Sendable对象](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md)时，使用拷贝数据的方式。
...
宿主线程向Worker线程发送消息，消息中的[Sendable对象](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md)通过引用传递，非Sendable对象通过拷贝数据的方式传递。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| message | Object | 是 | 发送至Worker的数据，该数据对象必须是可序列化对象，序列化支持类型见[序列化支持类型](js-apis-worker.md#序列化支持类型)。如果需要共享数据，支持类型见[Sendable支持的数据类型](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md#sendable支持的数据类型)。 |
...
Worker线程通过转移对象所有权或拷贝数据的方式向宿主线程发送消息。在传递[Sendable对象](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md)时，使用拷贝数据的方式进行传递。
...
Worker线程向宿主线程发送消息，消息中的[Sendable对象](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md)通过引用传递，非Sendable对象通过拷贝数据的方式传递。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| message | Object | 是 | 发送至宿主线程的数据，该数据对象必须是可序列化或可共享，序列化支持类型见[序列化支持类型](js-apis-worker.md#序列化支持类型)，共享支持类型见[Sendable支持的数据类型](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md#sendable支持的数据类型)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scriptURL | string | 是 | Worker线程文件的路径，详细参考[文件路径注意事项](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/Worker简介/worker-introduction.md#文件路径注意事项)。 |
| options | [WorkerOptions](js-apis-worker.md#workeroptions) | 否 | Worker构造的选项。 |

**示例：**

此处以在Stage模型的entry模块Index.ets文件中加载Worker文件为例，使用Library加载Worker线程文件的场景参考[文件路径注意事项](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/Worker简介/worker-introduction.md#文件路径注意事项)。
