...
scraped_at: 2026-06-01T15:35:48+08:00
doc_updated_at: 2026-04-10
content_hash: sha256:dd61083679533c961891bc61d3854661c2f56e2396ef678f87414d06c436d492
---
为支持将JSON字符串解析为共享数据，即[Sendable支持的数据类型](../../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md#sendable支持的数据类型)，ArkTS语言基础库新增了ASON工具。ASON工具支持解析JSON字符串并生成共享数据，用于跨并发实例引用传递，同时也支持将共享数据转换为JSON字符串。
...
| 类型 | 说明 |
| --- | --- |
| [lang.ISendable](<../../@arkts.lang (ArkTS语言基础能力)/js-apis-arkts-lang.md#langisendable>) | 所有Sendable类型的父类型。 |
...
从API 18开始参数修改为Object类型，API 18之前参数只支持ISendable类型（除[Int8Array](<../../@arkts.collections (ArkTS容器集)/Class (Int8Array)/arkts-apis-arkts-collections-int8array.md>)、[Uint8Array](<../../@arkts.collections (ArkTS容器集)/Class (Uint8Array)/arkts-apis-arkts-collections-uint8array.md>)、[Int16Array](<../../@arkts.collections (ArkTS容器集)/Class (Int16Array)/arkts-apis-arkts-collections-int16array.md>)、[Uint16Array](<../../@arkts.collections (ArkTS容器集)/Class (Uint16Array)/arkts-apis-arkts-collections-uint16array.md>)、[Int32Array](<../../@arkts.collections (ArkTS容器集)/Class (Int32Array)/arkts-apis-arkts-collections-int32array.md>)、[Uint32Array](<../../@arkts.collections (ArkTS容器集)/Class (Uint32Array)/arkts-apis-arkts-collections-uint32array.md>)、[Uint8ClampedArray](<../../@arkts.collections (ArkTS容器集)/Class (Uint8ClampedArray)/arkts-apis-arkts-collections-uint8clampedarray.md>)、[Float32Array](<../../@arkts.collections (ArkTS容器集)/Class (Float32Array)/arkts-apis-arkts-collections-float32array.md>)外）。
