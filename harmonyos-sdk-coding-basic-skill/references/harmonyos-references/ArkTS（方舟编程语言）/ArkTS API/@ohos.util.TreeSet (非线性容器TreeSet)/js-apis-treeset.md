...
scraped_at: 2026-06-01T15:36:25+08:00
doc_updated_at: 2026-04-02
content_hash: sha256:c69e84c04d40534bbbc1f37b3fe25a5fc46368b30c0e18b50bafa2b4d526655b
---
TreeSet基于[TreeMap](<../@ohos.util.TreeMap (非线性容器TreeMap)/js-apis-treemap.md>)实现，在TreeSet中，只对value对象进行处理。TreeSet可用于存储一系列值的集合，元素中value唯一且有序。

TreeSet和[HashSet](<../@ohos.util.HashSet (非线性容器HashSet)/js-apis-hashset.md>)中的元素都不允许重复。HashSet中的数据无序存放，而TreeSet是有序存放。HashSet允许插入null值，但TreeSet不建议插入null值，可能会影响排序结果。
