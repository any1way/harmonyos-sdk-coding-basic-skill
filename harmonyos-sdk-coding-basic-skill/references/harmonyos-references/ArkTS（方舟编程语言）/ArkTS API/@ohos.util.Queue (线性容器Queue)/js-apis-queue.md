...
content_hash: sha256:537261895579108318d381bb802152e1d9a98fa4071dd58d87cd7731a2d1c958
---
Queue的特点是先进先出，在尾部增加元素，在头部删除元素。根据循环队列的数据结构实现。

Queue和[Deque](<../@ohos.util.Deque (线性容器Deque)/js-apis-deque.md>)相比，Queue在尾部增加元素，在头部删除元素；而Deque支持在两端进行增删操作。
