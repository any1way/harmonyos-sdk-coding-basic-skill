...
scraped_at: 2026-06-01T15:36:19+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:573bba81ea9a66ad22085a917076d50a02ddbc3828f26f1fe5d29cd5bcc71e36
---
List底层通过单向链表实现，每个节点有一个指向后一个元素的引用。查询元素必须从头遍历，因此查询效率低，但插入和删除效率高。List允许元素为null。

List和[LinkedList](<../@ohos.util.LinkedList (线性容器LinkedList)/js-apis-linkedlist.md>)相比，LinkedList是双向链表，可以快速地在头尾进行增删，而List是单向链表，不支持双向操作。
