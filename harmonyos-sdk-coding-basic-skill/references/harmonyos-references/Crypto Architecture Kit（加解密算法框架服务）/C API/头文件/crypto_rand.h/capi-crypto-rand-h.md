...
scraped_at: 2026-06-11T16:08:28+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:7d120e0d3a40f6d08b091755b11233bf1b30618738f6c1760f712a9b78ab9230
---
## 概述
...
**相关模块：** [CryptoRandApi](../../模块/CryptoRandApi/capi-cryptorandapi.md)
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_CryptoRand](../../结构体/OH_CryptoRand/capi-cryptorandapi-oh-cryptorand.md) | OH\_CryptoRand | 定义随机数生成器结构。 |
...
| [OH\_Crypto\_ErrCode OH\_CryptoRand\_GenerateRandom(OH\_CryptoRand \*ctx, int len, Crypto\_DataBlob \*out)](capi-crypto-rand-h.md#oh_cryptorand_generaterandom) | 生成随机数。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放out内存。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoRand](../../结构体/OH_CryptoRand/capi-cryptorandapi-oh-cryptorand.md) \*\*ctx | 指向随机数生成器实例的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoRand](../../结构体/OH_CryptoRand/capi-cryptorandapi-oh-cryptorand.md) \*ctx | 随机数生成器实例。 |
| int len | 表示生成随机数的长度，单位为byte，范围在[1, INT\_MAX]。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*out | 用于获取随机数的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoRand](../../结构体/OH_CryptoRand/capi-cryptorandapi-oh-cryptorand.md) \*ctx | 指向随机数生成器实例。 |
...
| --- | --- |
| [OH\_CryptoRand](../../结构体/OH_CryptoRand/capi-cryptorandapi-oh-cryptorand.md) \*ctx | 随机数生成器实例。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*seed | 种子数据。 |
