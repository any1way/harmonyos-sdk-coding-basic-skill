...
scraped_at: 2026-06-11T16:08:11+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:387b9c19d433935ae2e94302c3fb5db2c36c088c2c0ae925ba52304a47b7b340
---
## 概述
...
**相关模块：** [CryptoAsymKeyApi](../../模块/CryptoAsymKeyApi/capi-cryptoasymkeyapi.md)
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_CryptoKeyPair](../../结构体/OH_CryptoKeyPair/capi-cryptoasymkeyapi-oh-cryptokeypair.md) | OH\_CryptoKeyPair | 定义密钥对结构体。 |
| [OH\_CryptoPubKey](../../结构体/OH_CryptoPubKey/capi-cryptoasymkeyapi-oh-cryptopubkey.md) | OH\_CryptoPubKey | 定义公钥结构体。 |
| [OH\_CryptoPrivKey](../../结构体/OH_CryptoPrivKey/capi-cryptoasymkeyapi-oh-cryptoprivkey.md) | OH\_CryptoPrivKey | 定义私钥结构体。 |
| [OH\_CryptoAsymKeyGenerator](../../结构体/OH_CryptoAsymKeyGenerator/capi-cryptoasymkeyapi-oh-cryptoasymkeygenerator.md) | OH\_CryptoAsymKeyGenerator | 定义非对称密钥生成器结构体。 |
| [OH\_CryptoPrivKeyEncodingParams](../../结构体/OH_CryptoPrivKeyEncodingParams/capi-crypto-oh-cryptoprivkeyencodingparams.md) | OH\_CryptoPrivKeyEncodingParams | 定义私钥编码参数结构体。 |
| [OH\_CryptoAsymKeySpec](../../结构体/OH_CryptoAsymKeySpec/capi-cryptoasymkeyapi-oh-cryptoasymkeyspec.md) | OH\_CryptoAsymKeySpec | 定义非对称密钥规格结构体。 |
| [OH\_CryptoAsymKeyGeneratorWithSpec](../../结构体/OH_CryptoAsymKeyGeneratorWithSpec/capi-crypto-oh-cryptoasymkeygeneratorwithspec.md) | OH\_CryptoAsymKeyGeneratorWithSpec | 定义带规格的非对称密钥生成器。 |
| [OH\_CryptoEcPoint](../../结构体/OH_CryptoEcPoint/capi-cryptoasymkeyapi-oh-cryptoecpoint.md) | OH\_CryptoEcPoint | 定义EC点结构体。 |
...
| [OH\_Crypto\_ErrCode OH\_CryptoPubKey\_Encode(OH\_CryptoPubKey \*key, Crypto\_EncodingType type, const char \*encodingStandard, Crypto\_DataBlob \*out)](capi-crypto-asym-key-h.md#oh_cryptopubkey_encode) | 根据指定的编码格式输出公钥数据。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放out内存。 |
| [OH\_Crypto\_ErrCode OH\_CryptoPubKey\_GetParam(OH\_CryptoPubKey \*key, CryptoAsymKey\_ParamType item, Crypto\_DataBlob \*value)](capi-crypto-asym-key-h.md#oh_cryptopubkey_getparam) | 从公钥实例获取指定参数。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放value内存。 |
...
| [OH\_Crypto\_ErrCode OH\_CryptoPrivKey\_Encode(OH\_CryptoPrivKey \*key, Crypto\_EncodingType type, const char \*encodingStandard, OH\_CryptoPrivKeyEncodingParams \*params, Crypto\_DataBlob \*out)](capi-crypto-asym-key-h.md#oh_cryptoprivkey_encode) | 从私钥实例获取指定参数。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放out内存。 |
| [OH\_Crypto\_ErrCode OH\_CryptoPrivKey\_GetParam(OH\_CryptoPrivKey \*key, CryptoAsymKey\_ParamType item, Crypto\_DataBlob \*value)](capi-crypto-asym-key-h.md#oh_cryptoprivkey_getparam) | 获取私钥的指定参数。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放value内存。 |
...
| [OH\_Crypto\_ErrCode OH\_CryptoAsymKeySpec\_GetParam(OH\_CryptoAsymKeySpec \*spec, CryptoAsymKey\_ParamType type, Crypto\_DataBlob \*value)](capi-crypto-asym-key-h.md#oh_cryptoasymkeyspec_getparam) | 获取非对称密钥规格的指定参数。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放value内存。 |
...
| [OH\_Crypto\_ErrCode OH\_CryptoEcPoint\_GetCoordinate(OH\_CryptoEcPoint \*point, Crypto\_DataBlob \*x, Crypto\_DataBlob \*y)](capi-crypto-asym-key-h.md#oh_cryptoecpoint_getcoordinate) | 获取EC点的x和y坐标。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放x和y内存 |
...
| [OH\_Crypto\_ErrCode OH\_CryptoEcPoint\_Encode(OH\_CryptoEcPoint \*point, const char \*format, Crypto\_DataBlob \*out)](capi-crypto-asym-key-h.md#oh_cryptoecpoint_encode) | 将EC点编码为指定格式。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放out内存。 |
...
| [OH\_CryptoAsymKeyGenerator](../../结构体/OH_CryptoAsymKeyGenerator/capi-cryptoasymkeyapi-oh-cryptoasymkeygenerator.md) \*\*ctx | 指向非对称密钥生成器上下文的指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_Crypto\_ErrCode](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_errcode) | CRYPTO\_SUCCESS：操作成功。  CRYPTO\_INVALID\_PARAMS：参数无效。  CRYPTO\_NOT\_SUPPORTED：操作不支持。  CRYPTO\_MEMORY\_ERROR：内存错误。  CRYPTO\_OPERTION\_ERROR：调用三方算法库API出错。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoAsymKeyGenerator](../../结构体/OH_CryptoAsymKeyGenerator/capi-cryptoasymkeyapi-oh-cryptoasymkeygenerator.md) \*ctx | 非对称密钥生成器实例。 |
| [OH\_CryptoKeyPair](../../结构体/OH_CryptoKeyPair/capi-cryptoasymkeyapi-oh-cryptokeypair.md) \*\*keyCtx | 指向非对称密钥对实例的指针。 |
...
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*pubKeyData | 公钥数据。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*priKeyData | 私钥数据。 |
| [OH\_CryptoKeyPair](../../结构体/OH_CryptoKeyPair/capi-cryptoasymkeyapi-oh-cryptokeypair.md) \*\*keyCtx | 指向非对称密钥对实例的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoKeyPair](../../结构体/OH_CryptoKeyPair/capi-cryptoasymkeyapi-oh-cryptokeypair.md) \*keyCtx | 密钥对实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_CryptoPubKey](../../结构体/OH_CryptoPubKey/capi-cryptoasymkeyapi-oh-cryptopubkey.md) \* | 返回从密钥对中得到的公钥实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_CryptoPrivKey](../../结构体/OH_CryptoPrivKey/capi-cryptoasymkeyapi-oh-cryptoprivkey.md) \* | 返回从密钥对中得到的私钥实例。 |
...
注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放out内存。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoPubKey](../../结构体/OH_CryptoPubKey/capi-cryptoasymkeyapi-oh-cryptopubkey.md) \*key | 公钥实例。 |
| [Crypto\_EncodingType](capi-crypto-asym-key-h.md#crypto_encodingtype) type | 编码类型。 |
| const char \*encodingStandard | 编码格式。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*out | 输出的公钥结果。 |
...
注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放value内存。
...
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*value | 参数输出值。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoAsymKeyGenerator](../../结构体/OH_CryptoAsymKeyGenerator/capi-cryptoasymkeyapi-oh-cryptoasymkeygenerator.md) \*ctx | 指向非对称加密上下文的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Crypto\_ErrCode](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_errcode) | CRYPTO\_SUCCESS：操作成功。  CRYPTO\_NOT\_SUPPORTED：操作不支持。  CRYPTO\_MEMORY\_ERROR：内存错误。  CRYPTO\_PARAMETER\_CHECK\_FAILED：参数检查失败。  CRYPTO\_OPERTION\_ERROR：调用三方算法库API出错。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoPrivKeyEncodingParams](../../结构体/OH_CryptoPrivKeyEncodingParams/capi-crypto-oh-cryptoprivkeyencodingparams.md) \*\*ctx | 私钥编码参数。 |
...
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*value | 私钥编码参数值。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoPrivKey](../../结构体/OH_CryptoPrivKey/capi-cryptoasymkeyapi-oh-cryptoprivkey.md) \*key | 私钥。 |
| [Crypto\_EncodingType](capi-crypto-asym-key-h.md#crypto_encodingtype) type | 私钥编码类型。 |
| const char \*encodingStandard | 编码标准。  例如"PKCS8"。 |
| [OH\_CryptoPrivKeyEncodingParams](../../结构体/OH_CryptoPrivKeyEncodingParams/capi-crypto-oh-cryptoprivkeyencodingparams.md) \*params | 私钥编码参数，可以为NULL，如果要加密私钥，则应设置此参数。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*out | 编码结果。 |
...
| [OH\_CryptoPrivKey](../../结构体/OH_CryptoPrivKey/capi-cryptoasymkeyapi-oh-cryptoprivkey.md) \*key | 私钥。 |
| [CryptoAsymKey\_ParamType](capi-crypto-asym-key-h.md#cryptoasymkey_paramtype) item | 非对称密钥参数类型。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*value | 输出数据。 |
...
| [OH\_CryptoAsymKeySpec](../../结构体/OH_CryptoAsymKeySpec/capi-cryptoasymkeyapi-oh-cryptoasymkeyspec.md) \*\*spec | 指向EC通用参数规格的指针。 |
...
| int pLen | 素数p的字节长度。 |
| int skLen | 私钥的字节长度。 |
| [OH\_CryptoAsymKeySpec](../../结构体/OH_CryptoAsymKeySpec/capi-cryptoasymkeyapi-oh-cryptoasymkeyspec.md) \*\*spec | 指向DH通用参数规格的指针。 |
...
| [OH\_CryptoAsymKeySpec](../../结构体/OH_CryptoAsymKeySpec/capi-cryptoasymkeyapi-oh-cryptoasymkeyspec.md) \*\*spec | 指向非对称密钥规格的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoAsymKeySpec](../../结构体/OH_CryptoAsymKeySpec/capi-cryptoasymkeyapi-oh-cryptoasymkeyspec.md) \*spec | 非对称密钥规格。 |
| [CryptoAsymKey\_ParamType](capi-crypto-asym-key-h.md#cryptoasymkey_paramtype) type | 非对称密钥参数类型。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*value | 输入数据。 |
...
| --- | --- |
| [OH\_CryptoAsymKeySpec](../../结构体/OH_CryptoAsymKeySpec/capi-cryptoasymkeyapi-oh-cryptoasymkeyspec.md) \*spec | 非对称密钥规格。 |
| [OH\_CryptoAsymKeySpec](../../结构体/OH_CryptoAsymKeySpec/capi-cryptoasymkeyapi-oh-cryptoasymkeyspec.md) \*commonParamsSpec | 通用参数规格。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoAsymKeySpec](../../结构体/OH_CryptoAsymKeySpec/capi-cryptoasymkeyapi-oh-cryptoasymkeyspec.md) \*keySpec | 非对称密钥规格。 |
| [OH\_CryptoAsymKeyGeneratorWithSpec](../../结构体/OH_CryptoAsymKeyGeneratorWithSpec/capi-crypto-oh-cryptoasymkeygeneratorwithspec.md) \*\*generator | 带规格的非对称密钥生成器。 |
...
| --- | --- |
| [OH\_CryptoAsymKeyGeneratorWithSpec](../../结构体/OH_CryptoAsymKeyGeneratorWithSpec/capi-crypto-oh-cryptoasymkeygeneratorwithspec.md) \*generator | 带规格的非对称密钥生成器。 |
| [OH\_CryptoKeyPair](../../结构体/OH_CryptoKeyPair/capi-cryptoasymkeyapi-oh-cryptokeypair.md) \*\*keyPair | 指向密钥对的指针。 |
...
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*ecKeyData | EC点数据，支持"04 || x || y"、"02 || x"或"03 || x"格式。如果ecKeyData参数为NULL，将创建一个空的EC点规格。 |
| [OH\_CryptoEcPoint](../../结构体/OH_CryptoEcPoint/capi-cryptoasymkeyapi-oh-cryptoecpoint.md) \*\*point | 指向EC点的指针。 |
...
注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放x和y内存
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoEcPoint](../../结构体/OH_CryptoEcPoint/capi-cryptoasymkeyapi-oh-cryptoecpoint.md) \*point | EC点。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*x | EC点的x坐标,可以为NULL。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*y | EC点的y坐标,可以为NULL。 |
...
| --- | --- |
| [OH\_CryptoEcPoint](../../结构体/OH_CryptoEcPoint/capi-cryptoasymkeyapi-oh-cryptoecpoint.md) \*point | EC点。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*x | EC点的x坐标。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*y | EC点的y坐标。 |
...
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*out | 编码后的EC点数据。 |
