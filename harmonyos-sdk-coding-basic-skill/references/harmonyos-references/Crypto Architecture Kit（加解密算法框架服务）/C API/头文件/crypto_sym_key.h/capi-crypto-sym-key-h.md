...
scraped_at: 2026-06-11T16:08:36+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:fde06674ec425e991a06cc21567cb98795ac20f7ee12e14d796853c96ed2fb6a
---
## 概述
...
**相关模块：** [CryptoSymKeyApi](../../模块/CryptoSymKeyApi/capi-cryptosymkeyapi.md)
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_CryptoSymKey](../../结构体/OH_CryptoSymKey/capi-cryptosymkeyapi-oh-cryptosymkey.md) | OH\_CryptoSymKey | 定义对称密钥结构体。 |
| [OH\_CryptoSymKeyGenerator](../../结构体/OH_CryptoSymKeyGenerator/capi-cryptosymkeyapi-oh-cryptosymkeygenerator.md) | OH\_CryptoSymKeyGenerator | 定义对称密钥结构。 |
...
| [OH\_Crypto\_ErrCode OH\_CryptoSymKey\_GetKeyData(OH\_CryptoSymKey \*keyCtx, Crypto\_DataBlob \*out)](capi-crypto-sym-key-h.md#oh_cryptosymkey_getkeydata) | 从密钥实例获取对称密钥数据。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放out内存。 |
...
| [OH\_CryptoSymKeyGenerator](../../结构体/OH_CryptoSymKeyGenerator/capi-cryptosymkeyapi-oh-cryptosymkeygenerator.md) \*\*ctx | 指向对称密钥生成器实例的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoSymKeyGenerator](../../结构体/OH_CryptoSymKeyGenerator/capi-cryptosymkeyapi-oh-cryptosymkeygenerator.md) \*ctx | 指向对称密钥生成器实例。 |
| [OH\_CryptoSymKey](../../结构体/OH_CryptoSymKey/capi-cryptosymkeyapi-oh-cryptosymkey.md) \*\*keyCtx | 指向对称密钥的指针。 |
...
| --- | --- |
| [OH\_CryptoSymKeyGenerator](../../结构体/OH_CryptoSymKeyGenerator/capi-cryptosymkeyapi-oh-cryptosymkeygenerator.md) \*ctx | 指向对称密钥生成器实例。 |
| [const Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*keyData | 指向生成对称密钥的数据。 |
| [OH\_CryptoSymKey](../../结构体/OH_CryptoSymKey/capi-cryptosymkeyapi-oh-cryptosymkey.md) \*\*keyCtx | 指向对称密钥实例的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoSymKey](../../结构体/OH_CryptoSymKey/capi-cryptosymkeyapi-oh-cryptosymkey.md) \*keyCtx | 指向对称密钥实例。 |
...
| --- | --- |
| [OH\_CryptoSymKey](../../结构体/OH_CryptoSymKey/capi-cryptosymkeyapi-oh-cryptosymkey.md) \*keyCtx | 指向对称密钥实例。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*out | 获取到的结果。 |
