...
scraped_at: 2026-06-11T16:08:09+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:d65966919a3a9ece88da9b0f83ebddf3601874b206ef4d82d9ddc4b97316498c
---
## 概述
...
**相关模块：** [CryptoAsymCipherApi](../../模块/CryptoAsymCipherApi/capi-cryptoasymcipherapi.md)
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_CryptoAsymCipher](../../结构体/OH_CryptoAsymCipher/capi-cryptoasymcipherapi-oh-cryptoasymcipher.md) | OH\_CryptoAsymCipher | 定义非对称加密结构。 |
| [OH\_CryptoSm2CiphertextSpec](../../结构体/OH_CryptoSm2CiphertextSpec/capi-crypto-oh-cryptosm2ciphertextspec.md) | OH\_CryptoSm2CiphertextSpec | 定义SM2密文规格结构。 |
...
| [OH\_Crypto\_ErrCode OH\_CryptoAsymCipher\_Final(OH\_CryptoAsymCipher \*ctx, const Crypto\_DataBlob \*in, Crypto\_DataBlob \*out)](capi-crypto-asym-cipher-h.md#oh_cryptoasymcipher_final) | 完成非对称加密。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放out内存。 |
...
| [OH\_Crypto\_ErrCode OH\_CryptoSm2CiphertextSpec\_Encode(OH\_CryptoSm2CiphertextSpec \*spec, Crypto\_DataBlob \*out)](capi-crypto-asym-cipher-h.md#oh_cryptosm2ciphertextspec_encode) | 将SM2密文规格编码为DER格式密文。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放out内存。 |
...
| [OH\_CryptoAsymCipher](../../结构体/OH_CryptoAsymCipher/capi-cryptoasymcipherapi-oh-cryptoasymcipher.md) \*\*ctx | 指向非对称加密上下文的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoAsymCipher](../../结构体/OH_CryptoAsymCipher/capi-cryptoasymcipherapi-oh-cryptoasymcipher.md) \*ctx | 非对称加密上下文。 |
| [Crypto\_CipherMode](../crypto_common.h/capi-crypto-common-h.md#crypto_ciphermode) mode | 加密模式是加密还是解密。 |
| [OH\_CryptoKeyPair](../../结构体/OH_CryptoKeyPair/capi-cryptoasymkeyapi-oh-cryptokeypair.md) \*key | 非对称密钥。 |
...
| --- | --- |
| [OH\_CryptoAsymCipher](../../结构体/OH_CryptoAsymCipher/capi-cryptoasymcipherapi-oh-cryptoasymcipher.md) \*ctx | 非对称加密上下文。 |
| [const Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*in | 要加密或解密的数据。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*out | 最终加密或解密的数据。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*sm2Ciphertext | SM2密文DER格式数据，如果为NULL则创建空的SM2密文规格。 |
| [OH\_CryptoSm2CiphertextSpec](../../结构体/OH_CryptoSm2CiphertextSpec/capi-crypto-oh-cryptosm2ciphertextspec.md) \*\*spec | 输出的SM2密文规格。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoSm2CiphertextSpec](../../结构体/OH_CryptoSm2CiphertextSpec/capi-crypto-oh-cryptosm2ciphertextspec.md) \*spec | SM2密文规格。 |
...
| [OH\_CryptoSm2CiphertextSpec](../../结构体/OH_CryptoSm2CiphertextSpec/capi-crypto-oh-cryptosm2ciphertextspec.md) \*spec | SM2密文规格。 |
| [CryptoSm2CiphertextSpec\_item](capi-crypto-asym-cipher-h.md#cryptosm2ciphertextspec_item) item | SM2密文规格项。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*in | 输入数据。 |
