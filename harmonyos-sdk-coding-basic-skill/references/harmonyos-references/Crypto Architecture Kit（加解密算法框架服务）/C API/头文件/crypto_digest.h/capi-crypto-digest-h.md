...
scraped_at: 2026-06-11T16:08:16+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:228d9997467d87fe5bc04c27d0b7bc5169cb49148b7a1f85ef9a581446bd189f
---
## 概述
...
**相关模块：** [CryptoDigestApi](../../模块/CryptoDigestApi/capi-cryptodigestapi.md)
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_CryptoDigest](../../结构体/OH_CryptoDigest/capi-cryptodigestapi-oh-cryptodigest.md) | OH\_CryptoDigest | 定义摘要结构体。 |
...
| [OH\_Crypto\_ErrCode OH\_CryptoDigest\_Final(OH\_CryptoDigest \*ctx, Crypto\_DataBlob \*out)](capi-crypto-digest-h.md#oh_cryptodigest_final) | 完成摘要计算。  注意：使用完成后必须通过[OH\_Crypto\_FreeDataBlob](../crypto_common.h/capi-crypto-common-h.md#oh_crypto_freedatablob)释放out内存。 |
...
| [OH\_CryptoDigest](../../结构体/OH_CryptoDigest/capi-cryptodigestapi-oh-cryptodigest.md) \*\*ctx | 指向摘要实例的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_CryptoDigest](../../结构体/OH_CryptoDigest/capi-cryptodigestapi-oh-cryptodigest.md) \*ctx | 指向摘要实例。 |
...
| --- | --- |
| [OH\_CryptoDigest](../../结构体/OH_CryptoDigest/capi-cryptodigestapi-oh-cryptodigest.md) \*ctx | 指向摘要实例。 |
| [Crypto\_DataBlob](../../结构体/Crypto_DataBlob/capi-cryptocommonapi-crypto-datablob.md) \*out | 返回的Md的计算结果。 |
