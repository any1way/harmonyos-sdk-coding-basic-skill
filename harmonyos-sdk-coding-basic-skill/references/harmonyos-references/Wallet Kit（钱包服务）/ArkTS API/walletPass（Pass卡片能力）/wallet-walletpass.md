...
scraped_at: 2026-06-01T16:39:43+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:41a1421131d4291bf56b6d94d131a4ec9e1d26c080672588e4b1228da4ea378d
---
本模块提供接入钱包服务的能力。
...
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| passStr | string | 是 | 要求JSON String格式，传入的字段以key-value的形式设置在JSON String中，并通过该参数传入。  key包括passType、targetDeviceType。  - passType：[创建Wallet Kit服务](<../../../../harmonyos-guides/应用服务/Wallet Kit（钱包服务）/创建Wallet Kit服务/wallet-preparations.md>)时注册的服务号，需要开发者到华为AGC网站申请。  - targetDeviceType：目标设备类型。取值如下  - phone：手机  - wear：穿戴  - all：手机+穿戴 |
...
以下错误码的详细介绍请参见[ArkTS API错误码](<../ArkTS API错误码/wallet-error-code.md>)
...
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| passStr | string | 是 | 要求JSON String格式，传入的字段以key-value的形式设置在JSON String中，并通过该参数传入。  key包括jweContent。  - jweContent：[生成JWE数据](<../../REST API/数字车钥匙接口/wallet-rest-api-carkey.md#生成jwe数据>)章节生成的开卡签名数据包。 |
...
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| passStr | string | 是 | 要求JSON String格式，传入的字段以key-value的形式设置在JSON String中，并通过该参数传入。  key包括passType、serialNumber。  - passType：[创建Wallet Kit服务](<../../../../harmonyos-guides/应用服务/Wallet Kit（钱包服务）/创建Wallet Kit服务/wallet-preparations.md>)时注册的服务号，需要开发者到华为AGC网站申请。  - serialNumber：[申请钥匙卡片](<../../REST API/数字车钥匙接口/wallet-rest-api-carkey.md#申请钥匙卡片>)时定义的卡券唯一标识。 |
...
| **参数名** | **类型** | **必填** | **说明** |
| --- | --- | --- | --- |
| rkeStr | string | 是 | 要求JSON String格式，传入的字段以key-value的形式设置在JSON String中，并通过该参数传入。  key包括passType、registerName。  - passType：[创建Wallet Kit服务](<../../../../harmonyos-guides/应用服务/Wallet Kit（钱包服务）/创建Wallet Kit服务/wallet-preparations.md>)时注册的服务号，需要开发者到华为AGC网站申请。  - registerName：注册监听的应用名称，一般为包名。 |
| eventNotifyListener | [rpc.RemoteObject](<../../../IPC Kit（进程间通信服务）/ArkTS API/@ohos.rpc (RPC通信)/js-apis-rpc.md#remoteobject>) | 是 | 回调事件，[rpc.RemoteObject](<../../../IPC Kit（进程间通信服务）/ArkTS API/@ohos.rpc (RPC通信)/js-apis-rpc.md#remoteobject>)格式。 |
