...
scraped_at: 2026-06-01T16:32:45+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:cebc7f3e7fe0b3e126580698ddcbfd76f1da795d8e4639b6e5f0ff24aa1fed75
---
...
| **参数名** | **类型** | 必填 | 说明 |
| --- | --- | --- | --- |
| respData | Map<string, Array<advertising.[Advertisement](<../advertisement/Advertisement (请求的广告内容)/js-apis-advertisement.md#advertisement>)>> | 是 | 广告请求回调数据，是以广告位ID为键，存储请求到的广告内容的映射集合。 |
