...
scraped_at: 2026-06-01T15:32:43+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:8cd272c06ea3e38c2feb7fd7febaddedca222e7ad95fcdf5cd06621dd012eb10
---
说明
...
1. 检查Want中的bundleName、moduleName和abilityName是否正确。
2. 确认被调用方（服务端）的Ability类型与调用接口是否匹配。对于ServiceExtensionAbility，应使用[connectServiceExtensionAbility()](<../../ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#connectserviceextensionability>)方法连接。同时需要确保[module.json5配置文件](../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)中extensionAbilities的type设置为与接口匹配的service。
...
1. [Stage模型](<../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Ability Kit术语/ability-terminology.md#stage模型>)下，拉起应用时抛出16000004异常，表示被拉应用调用失败，需要检查被拉应用module.json5的Ability字段的[exported](../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#abilities标签)配置是否为true。该配置字段为true，表示可以被其他应用调用；该配置字段为false，表示不可以被其他应用调用。
...
当应用受到企业设备管理[Enterprise Device Manager](<../../../../harmonyos-guides/系统/基础功能/MDM Kit（企业设备管理服务）/EnterpriseAdminExtensionAbility开发指南/mdm-kit-admin.md>)管控时，方法将返回该错误码。
...
使用隐式启动方式或通过[openLink](<../../ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#openlink12>)跳转其他应用。
...
1. 确保隐式启动的参数配置正确，匹配规则详见[显式Want与隐式Want匹配规则](<../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/信息传递载体Want/显式Want与隐式Want匹配规则/explicit-implicit-want-mappings.md>)。
2. 确保对应的HAP包已安装。
...
1. 启动Ability时传入的[Want](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md#约束限制>)数据过大。
2. 设备解锁前拉起非系统应用。
3. 隐式拉起时未安装应用市场App。
...
1. 对于启动Ability失败时，可以检查传入的[Want](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md#约束限制>)数据是否过大。
...
1. 查看[对应Extension类型](<../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/ExtensionAbility组件/extensionability-overview.md>)严格模式开启条件。
...
该应用没有在app.json5配置文件[multiAppMode](../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/app.json5配置文件/app-configuration-file.md#multiappmode标签)标签中配置应用分身字段，导致该应用不支持分身模式，调用[getCurrentAppCloneIndex](<../../ArkTS API/接口依赖的元素及定义/application/ApplicationContext (应用上下文)/js-apis-inner-application-applicationcontext.md#applicationcontextgetcurrentappcloneindex12>)接口时返回该错误码。

**处理步骤**

参考[应用多实例的配置方法](../../../../harmonyos-guides/基础入门/开发基础知识/典型场景的开发指导/创建应用多实例/multiinstance.md)，在app.json5配置文件中配置multiAppMode标签，开启应用分身功能后，再调用[getCurrentAppCloneIndex](<../../ArkTS API/接口依赖的元素及定义/application/ApplicationContext (应用上下文)/js-apis-inner-application-applicationcontext.md#applicationcontextgetcurrentappcloneindex12>)接口。
...
调用[startAbility](<../../ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#startability>)、[startAbilityForResult](<../../ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#startabilityforresult>)等启动Ability接口时，如果目标应用不支持应用多开，则返回该错误码。

**处理步骤**

调用[startAbility](<../../ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#startability>)、[startAbilityForResult](<../../ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#startabilityforresult>)等启动Ability接口时，确保目标应用支持应用多开，并在app.json5配置文件中配置[multiAppMode](../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/app.json5配置文件/app-configuration-file.md#multiappmode标签)标签开启应用分身功能。
...
指定的[APP\_INSTANCE\_KEY](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantConstant (Want常量)/js-apis-app-ability-wantconstant.md#params>)不存在时，返回该错误码。

**可能原因**

应用的实例中不存在该[APP\_INSTANCE\_KEY](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantConstant (Want常量)/js-apis-app-ability-wantconstant.md#params>)指定的实例。

**处理步骤**

确保传入的[APP\_INSTANCE\_KEY](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantConstant (Want常量)/js-apis-app-ability-wantconstant.md#params>)是一个有效值。
...
[APP\_INSTANCE\_KEY](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantConstant (Want常量)/js-apis-app-ability-wantconstant.md#params>)和[CREATE\_APP\_INSTANCE\_KEY](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantConstant (Want常量)/js-apis-app-ability-wantconstant.md#params>)不支持同时指定。当指定[CREATE\_APP\_INSTANCE\_KEY](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantConstant (Want常量)/js-apis-app-ability-wantconstant.md#params>)的同时指定[APP\_INSTANCE\_KEY](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantConstant (Want常量)/js-apis-app-ability-wantconstant.md#params>)，返回该错误码。
...
参数[APP\_INSTANCE\_KEY](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantConstant (Want常量)/js-apis-app-ability-wantconstant.md#params>)和[CREATE\_APP\_INSTANCE\_KEY](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantConstant (Want常量)/js-apis-app-ability-wantconstant.md#params>)只支持二选一。
...
只允许应用使用[CREATE\_APP\_INSTANCE\_KEY](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantConstant (Want常量)/js-apis-app-ability-wantconstant.md#params>)创建自己的实例，不允许应用间启动时为其他应用创建实例。否则，返回该错误码。
...
删除参数[CREATE\_APP\_INSTANCE\_KEY](<../../ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantConstant (Want常量)/js-apis-app-ability-wantconstant.md#params>)。
...
在[module.json5配置文件](../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)的[abilities标签](../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#abilities标签)中，当前UIAbility的allowSelfRedirect字段取值为“false”。

**处理步骤**

* 如果允许使用App Linking拉起当前UIAbility，开发者需要在[module.json5配置文件](../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)将[abilities标签](../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#abilities标签)的allowSelfRedirect字段设置为true。
...
调用方不在目标应用的[appIdentifierAllowList](../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#extensionabilities标签)中时，返回该错误码。

**可能原因**

[startAppServiceExtensionAbility](<../../ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#startappserviceextensionability20>)、[stopAppServiceExtensionAbility](<../../ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#stopappserviceextensionability20>)接口调用方的app-identifier不在目标[AppServiceExtensionAbility](<../../ArkTS API/Stage模型能力的接口/@ohos.app.ability.AppServiceExtensionAbility (应用后台服务扩展组件)/js-apis-app-ability-a_17903419.md>)的[appIdentifierAllowList](../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#extensionabilities标签)中。

**处理步骤**

将接口调用方的app-identifier配置在目标[AppServiceExtensionAbility](<../../ArkTS API/Stage模型能力的接口/@ohos.app.ability.AppServiceExtensionAbility (应用后台服务扩展组件)/js-apis-app-ability-a_17903419.md>)的[appIdentifierAllowList](../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#extensionabilities标签)中。
...
使用[connectAppServiceExtensionAbility](<../../ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#connectappserviceextensionability20>)接口时服务端还未启动且当前应用无权限拉起目标服务。

**处理步骤**

1. 等待服务端启动后重新连接。
2. 由当前应用拉起目标服务时，需要将接口调用方的app-identifier配置在目标[AppServiceExtensionAbility](<../../ArkTS API/Stage模型能力的接口/@ohos.app.ability.AppServiceExtensionAbility (应用后台服务扩展组件)/js-apis-app-ability-a_17903419.md>)的[appIdentifierAllowList](../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#extensionabilities标签)中。
...
根据需要调整超时时间。超时时间的设置可参见[设置启动参数](<../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/应用启动框架AppStartup/app-startup.md#设置启动参数>)。
...
1. 进程中存在未完成的[onNewProcessRequest](<../../ArkTS API/Stage模型能力的接口/@ohos.app.ability.AbilityStage (AbilityStage组件管理器)/js-apis-app-ability-abilitystage.md#onnewprocessrequest11>)请求。
2. 当启动模式为[specified](<../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/UIAbility组件/UIAbility组件启动模式/uiability-launch-type.md#specified启动模式>)的UIAbility运行在独立进程时，当前进程中存在未完成的[onAcceptWant](<../../ArkTS API/Stage模型能力的接口/@ohos.app.ability.AbilityStage (AbilityStage组件管理器)/js-apis-app-ability-abilitystage.md#onacceptwant>)请求。
