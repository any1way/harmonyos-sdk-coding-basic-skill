...
scraped_at: 2026-06-01T15:32:45+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:047a20e06aea161e6187f9573d843ab3370d46e42181e861568c5265ca08c218
---
说明
...
7. 请求的权限中存在应用未声明的权限。
8. 请求的全局开关类型非法。
9. 指定的权限名不是[user\_grant权限](../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/应用权限列表/开放权限（用户授权）/permissions-for-all-user.md)。
...
检查入参，修正参数值为有效值，有效值请参考各[接口参数说明](<../../ArkTS API/通用能力的接口(推荐)/@ohos.abilityAccessCtrl (程序访问控制管理)/js-apis-abilityaccessctrl.md>)。
...
1. [再次拉起权限设置弹框](<../../ArkTS API/通用能力的接口(推荐)/@ohos.abilityAccessCtrl (程序访问控制管理)/js-apis-abilityaccessctrl.md#requestpermissiononsetting12>)时，传入了manual\_settings授权方式的权限。
2. 授权或取消授权时，传入了非user\_grant和manual\_settings授权方式的权限。
3. [拉起跳转设置页弹窗](<../../ArkTS API/通用能力的接口(推荐)/@ohos.abilityAccessCtrl (程序访问控制管理)/js-apis-abilityaccessctrl.md#openpermissiononsetting22>)时，传入了非manual\_settings授权方式的权限。
