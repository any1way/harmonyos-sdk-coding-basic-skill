...
scraped_at: 2026-06-01T15:32:14+08:00
doc_updated_at: 2026-05-12
content_hash: sha256:62f22035363e3c3a500552376ff7251bbc474866f77c95391dc75d9fa6a8c7e9
---
## 概述
...
| 参数项 | 描述 |
| --- | --- |
| [AbilityBase\_Want](../../结构体/AbilityBase_Want/capi-abilitybase-want.md) \*want | 启动当前应用UIAbility时需要的Want信息。 |
...
| --- | --- |
| [AbilityBase\_Want](../../结构体/AbilityBase_Want/capi-abilitybase-want.md) \*want | 启动当前应用UIAbility时需要的Want信息。 |
| [AbilityRuntime\_StartOptions](../../结构体/AbilityRuntime_StartOptions/capi-abilityruntime-startoptions.md) \*options | 启动当前应用UIAbility时需要的StartOptions信息。如果该参数中[startVisibility](../context_constant.h/capi-context-constant-h.md#abilityruntime_startvisibility)属性的值不为空，必须确保当前应用已添加到状态栏，否则会返回[ABILITY\_RUNTIME\_ERROR\_VISIBILITY\_SETTING\_DISABLED](../ability_runtime_common.h/capi-ability-runtime-common-h.md#abilityruntime_errorcode)错误码。 |
...
| 参数项 | 描述 |
| --- | --- |
| int64\_t\* [versionCode](<../../../ArkTS API/接口依赖的元素及定义/bundleManager/BundleInfo/js-apis-bundlemanager-bundleinfo.md#bundleinfo-1>) | 指向应用包版本号的指针，对应bundleInfo中的versionCode字段。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_ErrorCode](../ability_runtime_common.h/capi-ability-runtime-common-h.md#abilityruntime_errorcode) | 返回执行结果。  ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR - 查询成功。  ABILITY\_RUNTIME\_ERROR\_CODE\_PARAM\_INVALID - 入参versionCode为空。  ABILITY\_RUNTIME\_ERROR\_CODE\_CONTEXT\_NOT\_EXIST - 应用上下文不存在，如在应用创建的[子进程](../../模块/ChildProcess/capi-childprocess.md)中应用级别上下文不存在。  ABILITY\_RUNTIME\_ERROR\_CODE\_GET\_APPLICATION\_INFO\_FAILED - 获取应用信息失败。 |
...
接口不能在应用主线程调用，但可以在应用创建的[子进程](../../模块/ChildProcess/capi-childprocess.md)的主线程中调用。
...
获取本应用首次启动UIAbility时的WantParams参数，WantParams可参考[Want中的parameters参数](<../../../ArkTS API/已停止维护的接口/ability/Want/js-apis-inner-ability-want.md>)。
...
| const int32\_t bufferSize | 缓冲区大小，单位为字节。 |
| int32\_t\* writeLength | 在返回[ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR](../ability_runtime_common.h/capi-ability-runtime-common-h.md#abilityruntime_errorcode)时，表示实际写入缓冲区的字符串长度（单位：字节）。 |
...
获取本应用最近一次启动UIAbility时的WantParams参数，WantParams可参考[Want中的parameters参数](<../../../ArkTS API/已停止维护的接口/ability/Want/js-apis-inner-ability-want.md>)。
...
| int32\_t windowId | 目标页面对应的[窗口ID](<../../../../ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interfaces (其他)/arkts-apis-window-i.md#windowinfo18>)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [AbilityRuntime\_ErrorCode](../ability_runtime_common.h/capi-ability-runtime-common-h.md#abilityruntime_errorcode) | 返回执行结果。  ABILITY\_RUNTIME\_ERROR\_CODE\_NO\_ERROR - 操作成功。  ABILITY\_RUNTIME\_ERROR\_CODE\_PARAM\_INVALID - 入参targetPageName为空或者windowId无效。  ABILITY\_RUNTIME\_ERROR\_CODE\_INTERNAL - 内部错误。 |
