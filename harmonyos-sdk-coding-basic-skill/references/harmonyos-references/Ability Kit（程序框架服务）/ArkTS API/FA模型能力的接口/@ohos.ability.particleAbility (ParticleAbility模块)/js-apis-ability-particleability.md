...
scraped_at: 2026-06-01T15:30:14+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:37f212726b4936294e628c605325ae7347f3e167fe3a6fc83b6b9637b135785f
---
...
组件启动规则详见：[组件启动规则（FA模型）](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/FA模型开发指导/FA模型应用组件/组件启动规则（FA模型）/component-startup-rules-fa.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| parameter | [StartAbilityParameter](../ability/StartAbilityParameter/js-apis-inner-ability-startabilityparameter.md) | 是 | 表示启动的ability。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataAbilityHelper](../../接口依赖的元素及定义/ability/DataAbilityHelper/js-apis-inner-ability-dataabilityhelper.md) | 用来协助其他Ability访问DataAbility的工具类。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[backgroundTaskManager.startBackgroundRunning](<../../../../Background Tasks Kit（后台任务开发服务）/ArkTS API/@ohos.resourceschedule.backgroundTaskManager (后台任务管理)/js-apis-resourceschedule-backgroundtaskmanager.md#backgroundtaskmanagerstartbackgroundrunning>)替代。
...
| request | [NotificationRequest](<../../../../Notification Kit（用户通知服务）/ArkTS API/已停止维护的接口/@ohos.notification (Notification模块)/js-apis-notification.md#notificationrequest>) | 是 | 通知参数，用于显示通知栏的信息。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[backgroundTaskManager.startBackgroundRunning](<../../../../Background Tasks Kit（后台任务开发服务）/ArkTS API/@ohos.resourceschedule.backgroundTaskManager (后台任务管理)/js-apis-resourceschedule-backgroundtaskmanager.md#backgroundtaskmanagerstartbackgroundrunning-1>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[backgroundTaskManager.stopBackgroundRunning](<../../../../Background Tasks Kit（后台任务开发服务）/ArkTS API/@ohos.resourceschedule.backgroundTaskManager (后台任务管理)/js-apis-resourceschedule-backgroundtaskmanager.md#backgroundtaskmanagerstopbackgroundrunning>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[backgroundTaskManager.stopBackgroundRunning](<../../../../Background Tasks Kit（后台任务开发服务）/ArkTS API/@ohos.resourceschedule.backgroundTaskManager (后台任务管理)/js-apis-resourceschedule-backgroundtaskmanager.md#backgroundtaskmanagerstopbackgroundrunning-1>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [Want](<../../已停止维护的接口/@ohos.application.Want (Want)/js-apis-application-want.md>) | 是 | 表示被连接的ServiceAbility。 |
| options | [ConnectOptions](../../接口依赖的元素及定义/ability/ConnectOptions/js-apis-inner-ability-connectoptions.md) | 是 | 连接回调方法。 |
