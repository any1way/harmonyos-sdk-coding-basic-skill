...
scraped_at: 2026-06-01T15:30:28+08:00
doc_updated_at: 2026-03-23
content_hash: sha256:17587be03624d6a2ac0f6707788164fd95155803c88d6ce4c2e624c677a7729b
---
...
Context对象是在featureAbility中创建实例，并通过featureAbility的[getContext](<../../@ohos.ability.featureAbility (FeatureAbility模块)/js-apis-ability-featureability.md#featureabilitygetcontext>)接口返回，因此在使用Context时，必须导入@ohos.ability.featureAbility库。示例如下：
...
示例代码中出现的getBundleInfo相关描述可参考对应[文档](<../../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[ApplicationInfo](../../../接口依赖的元素及定义/bundleManager/ApplicationInfo/js-apis-bundlemanager-applicationinfo.md)> | 是 | 回调函数，返回当前应用程序的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ApplicationInfo](../../../已停止维护的接口/bundle/ApplicationInfo/js-apis-bundle-applicationinfo.md)> | Promise对象，返回当前应用程序的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[bundle.DisplayOrientation](<../../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#displayorientation>)> | 是 | 回调函数，返回屏幕显示方向。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[bundle.DisplayOrientation](<../../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#displayorientation>)> | Promise对象，返回屏幕显示方向。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| orientation | [bundle.DisplayOrientation](<../../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#displayorientation>) | 是 | 指示当前能力的新方向。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| orientation | [bundle.DisplayOrientation](<../../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#displayorientation>) | 是 | 表示屏幕显示方向。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[ProcessInfo](../ProcessInfo/js-apis-inner-app-processinfo.md)> | 是 | 回调函数，返回当前进程的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ProcessInfo](../ProcessInfo/js-apis-inner-app-processinfo.md)> | Promise对象，返回当前进程的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[ElementName](../../../接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md)> | 是 | 回调函数，返回当前ability的ohos.bundleManager.ElementName对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ElementName](../../../接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md)> | Promise对象，返回当前ability的ohos.bundleManager.ElementName对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[HapModuleInfo](../../../接口依赖的元素及定义/bundleManager/HapModuleInfo/js-apis-bundlemanager-hapmoduleinfo.md)> | 是 | 回调函数，返回应用的ModuleInfo对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[HapModuleInfo](../../../接口依赖的元素及定义/bundleManager/HapModuleInfo/js-apis-bundlemanager-hapmoduleinfo.md)> | Promise对象，返回应用的ModuleInfo对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AppVersionInfo](../AppVersionInfo/js-apis-inner-app-appversioninfo.md)> | 是 | 回调函数，返回应用版本信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AppVersionInfo](../AppVersionInfo/js-apis-inner-app-appversioninfo.md)> | Promise对象，返回应用版本信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AbilityInfo](../../../接口依赖的元素及定义/bundleManager/AbilityInfo/js-apis-bundlemanager-abilityinfo.md)> | 是 | 回调函数，返回当前归属Ability详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AbilityInfo](../../../接口依赖的元素及定义/bundleManager/AbilityInfo/js-apis-bundlemanager-abilityinfo.md)> | Promise对象，返回当前归属Ability详细信息。 |
