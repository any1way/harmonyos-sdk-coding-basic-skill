...
scraped_at: 2026-06-01T15:30:21+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:214e76c95c210e9b4e2fb0fc2312e00c739913455dc0a2af48af44a2469e8831
---
定义启动Ability参数，可以作为入参，调用[startAbility](<../../@ohos.ability.featureAbility (FeatureAbility模块)/js-apis-ability-featureability.md#featureabilitystartability>)启动指定的Ability。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| want | [Want](<../../../通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 否 | 否 | 启动Ability的want信息。 |
