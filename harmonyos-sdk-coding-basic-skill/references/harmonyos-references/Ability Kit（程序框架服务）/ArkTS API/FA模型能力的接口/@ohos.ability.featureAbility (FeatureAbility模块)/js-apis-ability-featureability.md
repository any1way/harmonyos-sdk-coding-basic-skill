...
scraped_at: 2026-06-01T15:30:15+08:00
doc_updated_at: 2026-04-13
content_hash: sha256:f9eaea8d1528e2c697a450ca7f38801af6e5c2ab41d6cf21ed639846620c5e98
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| parameter | [StartAbilityParameter](../ability/StartAbilityParameter/js-apis-inner-ability-startabilityparameter.md) | 是 | 表示被启动的Ability。 |
...
| --- | --- | --- | --- |
| parameter | [StartAbilityParameter](../ability/StartAbilityParameter/js-apis-inner-ability-startabilityparameter.md) | 是 | 表示被启动的Ability。 |
| callback | AsyncCallback<[AbilityResult](../../接口依赖的元素及定义/ability/AbilityResult/js-apis-inner-ability-abilityresult.md)> | 是 | 回调函数。当启动Ability成功，err为undefined，data为ability的启动结果；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AbilityResult](../../接口依赖的元素及定义/ability/AbilityResult/js-apis-inner-ability-abilityresult.md)> | Promise对象，返回启动Ability的结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| parameter | [AbilityResult](../../接口依赖的元素及定义/ability/AbilityResult/js-apis-inner-ability-abilityresult.md) | 是 | 表示停止Ability之后返回的结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[Want](<../../已停止维护的接口/@ohos.application.Want (Want)/js-apis-application-want.md>)> | 是 | 回调函数，当获取要拉起的Ability对应的Want成功，err为undefined，data为当前Ability对应的Want；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Want](<../../已停止维护的接口/@ohos.application.Want (Want)/js-apis-application-want.md>)> | Promise对象，返回want信息。 |
...
| options | [ConnectOptions](../../接口依赖的元素及定义/ability/ConnectOptions/js-apis-inner-ability-connectoptions.md) | 是 | 表示连接回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[window.Window](<../../../../ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md>)> | 是 | 回调函数。当获取窗口成功，err为undefined，data为当前Ability对应的窗口；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[window.Window](<../../../../ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md>)> | Promise对象，返回当前Ability对应的窗口。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_Context](<../app/Context (FA模型的上下文基类)/js-apis-inner-app-context.md>) | Context模块。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_AppVersionInfo](../app/AppVersionInfo/js-apis-inner-app-appversioninfo.md) | 应用版本信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_ProcessInfo](../app/ProcessInfo/js-apis-inner-app-processinfo.md) | 进程信息。 |
