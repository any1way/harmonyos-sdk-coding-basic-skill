...
content_hash: sha256:0d987f2ef796f86cfa8524558eb89caa34af751897b99a391993402002446247
---
定义异常监听，可以作为[errorManager.on('error')](<../../../通用能力的接口(推荐)/@ohos.app.ability.errorManager (错误管理模块)/js-apis-app-ability-errormanager.md#errormanageronerror>)的入参监听当前应用发生的异常。
