...
scraped_at: 2026-06-01T15:31:30+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:9c9ce21f2bfc893f247addc5684173f1236f79b1ae7988af564dd0047d58520a
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | string | 是 | 编辑后图片的[uri](<../../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fileuri (文件URI)/js-apis-file-fileuri.md>)，格式为file://<bundleName>/<sandboxPath>。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<AbilityResult> | Promise对象，返回AbilityResult对象，编辑过的图片uri存在want.uri中，[uri](<../../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fileuri (文件URI)/js-apis-file-fileuri.md>)格式为file://<bundleName>/<sandboxPath>。 |

**错误码：**

以下错误码详细介绍参考[通用错误码](../../../../../通用错误码/errorcode-universal.md)和[元能力子系统错误码](../../../../错误码/元能力子系统错误码/errorcode-ability.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pixeMap | [image.PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 编辑过的图片image.PixelMap。 |
| option | [image.PackingOption](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interfaces (其他)/arkts-apis-image-i.md#packingoption>) | 是 | 设置打包参数。 |
