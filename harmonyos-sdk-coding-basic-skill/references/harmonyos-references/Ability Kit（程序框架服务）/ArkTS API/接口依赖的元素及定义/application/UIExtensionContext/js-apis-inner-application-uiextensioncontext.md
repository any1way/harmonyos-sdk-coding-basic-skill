...
scraped_at: 2026-06-11T15:36:00+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:7a72dec2ed578bda1d19001ba7d768cff09d237fdd80dbb57ba385a1083c8d51
---
UIExtensionContext是[UIExtensionAbility](<../../../Stage模型能力的接口/@ohos.app.ability.UIExtensionAbility (带界面的ExtensionAbility组件)/js-apis-app-abili_64670486.md>)的上下文环境，继承自[ExtensionContext](../ExtensionContext/js-apis-inner-application-extensioncontext.md)，提供[UIExtensionAbility](<../../../Stage模型能力的接口/@ohos.app.ability.UIExtensionAbility (带界面的ExtensionAbility组件)/js-apis-app-abili_64670486.md>)的相关配置信息以及操作[UIAbility](<../../../Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)的方法，如启动[UIAbility](<../../../Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)等。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 启动UIAbility时必要的Want，包含待启动UIAbility的名称等信息。 |
...
| --- | --- | --- | --- |
| want | [Want](<../../../通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 启动UIAbility时必要的Want，包含待启动UIAbility的名称等信息。 |
| options | [StartOptions](<../../../Stage模型能力的接口/@ohos.app.ability.StartOptions (startAbility的可选参数)/js-apis-app-ability-startoptions.md>) | 是 | 启动UIAbility所携带的额外参数。 |
| callback | AsyncCallback<void> | 是 | 回调函数。当启动UIAbility成功时，err为undefined，否则为错误对象。 |
...
| --- | --- | --- | --- |
| want | [Want](<../../../通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 启动UIAbility时必要的Want，包含待启动UIAbility的名称等信息。 |
| options | [StartOptions](<../../../Stage模型能力的接口/@ohos.app.ability.StartOptions (startAbility的可选参数)/js-apis-app-ability-startoptions.md>) | 否 | 启动UIAbility所携带的额外参数。 |
...
* 正常情况下可通过调用[terminateSelfWithResult](../UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#terminateselfwithresult)接口使之终止并且返回结果给调用方。
* 异常情况下比如杀死UIAbility会返回异常信息给调用方, 异常信息中resultCode为-1。
* 如果被启动的UIAbility模式是单实例模式, 不同应用多次调用该接口启动这个UIAbility，当这个UIAbility调用[terminateSelfWithResult](../UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#terminateselfwithresult)接口使之终止时，只将正常结果返回给最后一个调用方, 其它调用方返回异常信息, 异常信息中resultCode为-1。
...
| --- | --- | --- | --- |
| want | [Want](<../../../通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 启动UIAbility时必要的Want，包含待启动UIAbility的名称等信息。 |
| callback | AsyncCallback<[AbilityResult](../../ability/AbilityResult/js-apis-inner-ability-abilityresult.md)> | 是 | 回调函数，包含返回给拉起方的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AbilityResult](../../ability/AbilityResult/js-apis-inner-ability-abilityresult.md)> | Promise对象，返回被拉起的UIAbility退出时的返回结果。 |
...
ServiceExtensionAbility是一类特殊的[ExtensionAbility](<../../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/ExtensionAbility组件/extensionability-overview.md>)组件，这类组件由系统提供，通常用于提供指定场景后台服务能力，不支持开发者自定义。ServiceExtensionAbility可以被其他组件连接，并根据调用者的请求信息在后台处理相关事务。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 连接ServiceExtensionAbility的Want信息，包括Ability名称，Bundle名称等。 |
| options | [ConnectOptions](../../ability/ConnectOptions/js-apis-inner-ability-connectoptions.md) | 是 | ConnectOptions类型的回调函数，返回服务连接成功、连接失败、断开的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| parameter | [AbilityResult](../../ability/AbilityResult/js-apis-inner-ability-abilityresult.md) | 是 | 返回给UIExtensionAbility拉起方的信息。 |
| callback | AsyncCallback<void> | 是 | 回调函数。UIExtensionAbility停止成功时，err为undefined，否则为错误对象。 |
...
* 如果不同应用多次调用该接口启动同一个元服务，当这个元服务调用[terminateSelfWithResult](../UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#terminateselfwithresult)接口使之终止时，只将正常结果返回给最后一个调用方, 其它调用方返回异常信息，异常信息中resultCode为-1。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AbilityResult](../../ability/AbilityResult/js-apis-inner-ability-abilityresult.md)> | Promise对象。返回给拉起方的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 启动UIServiceExtensionAbility的Want。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<UIServiceProxy> | Promise对象，连接UIServiceExtensionAbility成功时，返回[UIServiceProxy](../UIServiceProxy/js-apis-inner-application-uiserviceproxy.md)对象，借助该对象可以往UIServiceExtensionAbility发送数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| proxy | [UIServiceProxy](../UIServiceProxy/js-apis-inner-application-uiserviceproxy.md) | 是 | [connectUIServiceExtensionAbility](js-apis-inner-application-uiextensioncontext.md#connectuiserviceextensionability14)返回的Proxy。 |
...
* 深浅色模式生效的优先级：UIExtensionAbility的深浅色模式 > 应用的深浅色模式（[ApplicationContext.setColorMode](<../ApplicationContext (应用上下文)/js-apis-inner-application-applicationcontext.md#applicationcontextsetcolormode11>)）> 系统的深浅色模式。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| colorMode | [ConfigurationConstant.ColorMode](<../../../通用能力的接口(推荐)/@ohos.app.ability.ConfigurationConstant (环境变量相关的常量定义)/js-apis-app-ability-configurationconstant.md#colormode>) | 是 | 设置颜色模式，包括：  - COLOR\_MODE\_DARK：深色模式  - COLOR\_MODE\_LIGHT：浅色模式  - COLOR\_MODE\_NOT\_SET：不设置（跟随系统或应用） |
