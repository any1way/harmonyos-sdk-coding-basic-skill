...
scraped_at: 2026-06-11T15:35:48+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:13d4897c28e9ad0df6da5766886ce773d04620d78f12b468f8369aaedd04d8ca
---
AppServiceExtensionContext模块是[AppServiceExtensionAbility](<../../../Stage模型能力的接口/@ohos.app.ability.AppServiceExtensionAbility (应用后台服务扩展组件)/js-apis-app-ability-a_17903419.md>)的上下文环境，继承自[ExtensionContext](../ExtensionContext/js-apis-inner-application-extensioncontext.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | Want类型参数，传入需要启动的Ability的信息，如Ability名称、Bundle名称等。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | Want类型参数，传入需要连接的Ability的信息，如Ability名称，Bundle名称等。 |
...
| 类型 | 说明 |
| --- | --- |
| number | 返回连接id，客户端可以通过[disconnectServiceExtensionAbility](js-apis-inner-application-_79664473.md#disconnectserviceextensionability)传入该连接id来断开连接。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| connection | number | 是 | 在[connectServiceExtensionAbility](js-apis-inner-application-_79664473.md#connectserviceextensionability)中返回的连接id。 |
...
参见[connectServiceExtensionAbility](js-apis-inner-application-_79664473.md#connectserviceextensionability)。
