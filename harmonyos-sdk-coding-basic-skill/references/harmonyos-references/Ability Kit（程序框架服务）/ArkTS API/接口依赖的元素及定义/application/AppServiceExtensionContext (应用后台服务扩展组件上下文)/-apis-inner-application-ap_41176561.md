...
scraped_at: 2026-06-01T15:31:10+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:c1372239cac66435846dcb34308293c1c754dc48194414afd995064b90c75017
---
...
| 类型 | 说明 |
| --- | --- |
| number | 返回连接id，客户端可以通过[disconnectServiceExtensionAbility](-apis-inner-application-ap_41176561.md#disconnectserviceextensionability)传入该连接id来断开连接。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| connection | number | 是 | 在[connectServiceExtensionAbility](-apis-inner-application-ap_41176561.md#connectserviceextensionability)中返回的连接id。 |
...
参见[connectServiceExtensionAbility](-apis-inner-application-ap_41176561.md#connectserviceextensionability)。
