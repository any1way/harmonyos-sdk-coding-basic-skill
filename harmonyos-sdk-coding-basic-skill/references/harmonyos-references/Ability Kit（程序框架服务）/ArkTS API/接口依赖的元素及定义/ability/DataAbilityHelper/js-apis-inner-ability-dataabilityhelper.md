...
scraped_at: 2026-06-01T15:30:58+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:447696a5a85f35d308e7d1af71bad1a5255933d5ec7dd3c87a3caaf13336284c
---
可以通过[acquireDataAbilityHelper](<../../../FA模型能力的接口/@ohos.ability.featureAbility (FeatureAbility模块)/js-apis-ability-featureability.md#featureabilityacquiredataabilityhelper7>)接口获取DataAbilityHelper对象。
...
insert(uri: string, valuesBucket: [rdb.ValuesBucket](<../../../../../ArkData（方舟数据管理）/ArkTS API/已停止维护的接口/@ohos.data.rdb (关系型数据库)/js-apis-data-rdb.md#valuesbucket>), callback: AsyncCallback<number>): void
...
| valuesBucket | [rdb.ValuesBucket](<../../../../../ArkData（方舟数据管理）/ArkTS API/已停止维护的接口/@ohos.data.rdb (关系型数据库)/js-apis-data-rdb.md#valuesbucket>) | 是 | 表示要插入的数据记录。如果此参数为空，将插入一个空行。 |
...
insert(uri: string, valuesBucket: [rdb.ValuesBucket](<../../../../../ArkData（方舟数据管理）/ArkTS API/已停止维护的接口/@ohos.data.rdb (关系型数据库)/js-apis-data-rdb.md#valuesbucket>)): Promise<number>
...
| --- | --- | --- | --- |
| uri | string | 是 | 表示要插入数据的uri。 |
| valuesBuckets | Array<[rdb.ValuesBucket](<../../../../../ArkData（方舟数据管理）/ArkTS API/已停止维护的接口/@ohos.data.rdb (关系型数据库)/js-apis-data-rdb.md#valuesbucket>)> | 是 | 表示要插入的数据记录数组。 |
...
| valuesBucket | [rdb.ValuesBucket](<../../../../../ArkData（方舟数据管理）/ArkTS API/已停止维护的接口/@ohos.data.rdb (关系型数据库)/js-apis-data-rdb.md#valuesbucket>) | 是 | 表示要更新的数据。 |
| predicates | dataAbility.DataAbilityPredicates | 是 | 表示筛选条件。当此参数为null时，应定义处理逻辑。 |
...
| callback | AsyncCallback<[ResultSet](<../../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.relationalStore (关系型数据库)/Interface (ResultSet)/arkts-apis-data-relationalstore-resultset.md>)> | 是 | 回调函数，返回查询结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ResultSet](<../../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.relationalStore (关系型数据库)/Interface (ResultSet)/arkts-apis-data-relationalstore-resultset.md>)> | Promise对象，返回查询结果。 |
...
| --- | --- | --- | --- |
| uri | string | 是 | 表示待处理的DataAbility。例：'dataability:///com.example.xxx.xxxx'。 |
| operations | Array<[DataAbilityOperation](../../../FA模型能力的接口/ability/DataAbilityOperation/js-apis-inner-ability-dataabilityoperation.md)> | 是 | 表示数据操作数组，其中可以包含对数据库的多个不同操作。 |
| callback | AsyncCallback<Array<[DataAbilityResult](../../../FA模型能力的接口/ability/DataAbilityResult/js-apis-inner-ability-dataabilityresult.md)>> | 是 | 回调函数，在DataAbilityResult数组中返回每个操作的结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[DataAbilityResult](../../../FA模型能力的接口/ability/DataAbilityResult/js-apis-inner-ability-dataabilityresult.md)>> | Promise对象，在DataAbilityResult数组中返回每个操作的结果。 |
