...
content_hash: sha256:0eef4d7e22ede3fa87533c95fd05a78ee4c828e71457b94057904af9b41de343
---
应用[module.json5配置文件](../../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#shortcuts标签)中定义的快捷方式信息，可以通过[getAllShortcutInfoForSelf接口](<../../../通用能力的接口(推荐)/@ohos.bundle.shortcutManager (shortcutManager模块)/js-apis-shortcutmanager.md#shortcutmanagergetallshortcutinfoforself>)获取。
