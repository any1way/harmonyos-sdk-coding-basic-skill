...
scraped_at: 2026-06-01T15:30:35+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:b85a75da70383330916bf490e23493869d793be6fa3b7c414e892071d8e18f48
---
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[ProcessInformation](../../接口依赖的元素及定义/application/ProcessInformation/js-apis-inner-application-processinformation.md)>> | Promise对象，返回接口运行结果及有关运行进程的信息，可进行错误处理或其他自定义处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[ProcessInformation](../../接口依赖的元素及定义/application/ProcessInformation/js-apis-inner-application-processinformation.md)>> | 是 | 回调函数。当接口调用成功，err为undefined，data为当前应用运行进程的信息；否则为错误对象。可进行错误处理或其他自定义处理。 |
...
| observer | [ApplicationStateObserver](../../接口依赖的元素及定义/application/ApplicationStateObserver/js-apis-inner-application-applicationstateobserver.md) | 是 | 应用状态监听器，用于监听应用的生命周期变化。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_AbilityStateData.default](../../接口依赖的元素及定义/application/AbilityStateData/js-apis-inner-application-abilitystatedata.md) | Ability状态信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_AppStateData.default](../../接口依赖的元素及定义/application/AppStateData/js-apis-inner-application-appstatedata.md) | 应用状态信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_ApplicationStateObserver.default](../../接口依赖的元素及定义/application/ApplicationStateObserver/js-apis-inner-application-applicationstateobserver.md) | 应用状态监听器。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_ProcessInformation](../../接口依赖的元素及定义/application/ProcessInformation/js-apis-inner-application-processinformation.md) | 进程信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_ProcessData.default](../../接口依赖的元素及定义/application/ProcessData/js-apis-inner-application-processdata.md) | 进程数据。 |
