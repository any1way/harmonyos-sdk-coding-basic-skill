...
scraped_at: 2026-06-01T15:30:32+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:88bd798666947c5081a8706a9b02485459401c8adc0d54657a8358177f6a4023
---
...
Ability的状态，该类型为枚举，可配合[AbilityRunningInfo](../../接口依赖的元素及定义/application/AbilityRunningInfo/js-apis-inner-application-abilityrunninginfo.md)返回Ability的状态。
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[AbilityRunningInfo](../../接口依赖的元素及定义/application/AbilityRunningInfo/js-apis-inner-application-abilityrunninginfo.md)>> | Promise对象，返回UIAbility运行时的相关信息。开发者可在此进行错误处理或其他自定义处理。 |
...
* 当前仅支持以独立窗口方式拉起元服务。
* 在调用本接口成功后的3秒内，再次调用本接口、[ApplicationContext.restartApp()](<../../接口依赖的元素及定义/application/ApplicationContext (应用上下文)/js-apis-inner-application-applicationcontext.md#applicationcontextrestartapp12>)或[UIAbilityContext.restartApp()](../../接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#restartapp22)接口中的任一接口，系统将返回错误码16000064。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [Context](<../../接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>) | 是 | 当前Ability的上下文。  **说明**：当前仅支持[UIAbilityContext](../../接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md)。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_AbilityRunningInfo](../../接口依赖的元素及定义/application/AbilityRunningInfo/js-apis-inner-application-abilityrunninginfo.md) | AbilityRunningInfo二级模块，提供对Ability运行的相关信息和状态的定义。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_AbilityStateData.default](../../接口依赖的元素及定义/application/AbilityStateData/js-apis-inner-application-abilitystatedata.md) | AbilityStateData二级模块，提供Ability状态信息。 |
