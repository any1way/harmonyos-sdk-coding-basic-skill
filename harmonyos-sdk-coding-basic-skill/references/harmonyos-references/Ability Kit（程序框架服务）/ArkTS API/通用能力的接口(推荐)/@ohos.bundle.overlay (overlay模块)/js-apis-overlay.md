...
scraped_at: 2026-06-01T15:30:52+08:00
doc_updated_at: 2026-04-10
content_hash: sha256:1526d5e840fab6f3c6064ecd33705d3c36c0bcde91556fc39d8d279b4987618c
---
本模块提供overlay特征应用的[OverlayModuleInfo](../../接口依赖的元素及定义/bundleManager/OverlayModuleInfo/js-apis-bundlemanager-overlaymoduleinfo.md)信息查询以及禁用使能的能力。

overlay特征应用指应用中包含有overlay资源包，overlay资源包详见[overlay机制](../../../../../harmonyos-guides/基础入门/资源分类与访问/resource-categories-and-access.md#overlay机制)。

说明

本模块首批接口从API version 10开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。

本模块接口仅适用于stage模型，且仅适用于[静态overlay](../../../../../harmonyos-guides/基础入门/资源分类与访问/resource-categories-and-access.md#静态overlay配置方式)。
...
| moduleName | string | 是 | overlay特征module的名称。 |
| isEnabled | boolean | 是 | 值为true表示使能，值为false表示禁用。 |
| callback | AsyncCallback<void> | 是 | [回调函数](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#asynccallback>)，当设置指定module的overlay禁用使能状态成功时，err为undefined，否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[OverlayModuleInfo](../../接口依赖的元素及定义/bundleManager/OverlayModuleInfo/js-apis-bundlemanager-overlaymoduleinfo.md)> | Promise对象，返回[OverlayModuleInfo](../../接口依赖的元素及定义/bundleManager/OverlayModuleInfo/js-apis-bundlemanager-overlaymoduleinfo.md)。 |
...
| callback | AsyncCallback<[OverlayModuleInfo](../../接口依赖的元素及定义/bundleManager/OverlayModuleInfo/js-apis-bundlemanager-overlaymoduleinfo.md)> | 是 | [回调函数](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#asynccallback>)，当获取当前应用中指定的module的[OverlayModuleInfo](../../接口依赖的元素及定义/bundleManager/OverlayModuleInfo/js-apis-bundlemanager-overlaymoduleinfo.md)信息成功时，err返回undefined。否则回调函数返回具体错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[OverlayModuleInfo](../../接口依赖的元素及定义/bundleManager/OverlayModuleInfo/js-apis-bundlemanager-overlaymoduleinfo.md)>> | Promise对象，返回<Array<[OverlayModuleInfo](../../接口依赖的元素及定义/bundleManager/OverlayModuleInfo/js-apis-bundlemanager-overlaymoduleinfo.md)>>。 |
...
| --- | --- | --- | --- |
| targetModuleName | string | 是 | 指定当前应用中的目标module的名称。 |
| callback | AsyncCallback<Array<[OverlayModuleInfo](../../接口依赖的元素及定义/bundleManager/OverlayModuleInfo/js-apis-bundlemanager-overlaymoduleinfo.md)>> | 是 | [回调函数](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#asynccallback>)，当获取指定的目标module的[OverlayModuleInfo](../../接口依赖的元素及定义/bundleManager/OverlayModuleInfo/js-apis-bundlemanager-overlaymoduleinfo.md)成功时，err返回undefined。否则回调函数返回具体错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_OverlayModuleInfo.OverlayModuleInfo](../../接口依赖的元素及定义/bundleManager/OverlayModuleInfo/js-apis-bundlemanager-overlaymoduleinfo.md#overlaymoduleinfo-1) | OverlayModuleInfo信息。 |
