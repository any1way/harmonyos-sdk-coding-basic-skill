...
scraped_at: 2026-06-01T15:30:42+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:0126d396340816e922daeb6f801b2c504948cc3ee406edb7fb4fb444346d96b7
---
...
| observer | [ErrorObserver](../../接口依赖的元素及定义/application/ErrorObserver/js-apis-inner-application-errorobserver.md) | 是 | 错误观测器。 |
...
| observer | [LoopObserver](../../接口依赖的元素及定义/application/LoopObserver/js-apis-inner-application-loopobserver.md) | 是 | 注册主线程消息处理耗时监听器。 |
...
如果该回调函数执行时间超过1s，可能导致[AppRecovery](<../@ohos.app.ability.appRecovery (应用故障恢复)/js-apis-app-ability-apprecovery.md>)功能不可用。通过解析hilog日志中的begin与Freeze callback execution completed两者的时间差可以计算回调函数执行时长，如果超过1秒，可以尝试采用异步处理、减少阻塞操作、优化数据结构等方法优化回调逻辑，降低执行时长。
...
| observer | [LoopObserver](../../接口依赖的元素及定义/application/LoopObserver/js-apis-inner-application-loopobserver.md) | 否 | 应用主线程观测器标志。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| defaultObserver | [ResourceUsageObserver](js-apis-app-ability-errormanager.md#resourceusageobserver24) | 否 | 新注册的资源观察者，默认值为空。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_ErrorObserver.default](../../接口依赖的元素及定义/application/ErrorObserver/js-apis-inner-application-errorobserver.md) | ErrorObserver模块。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_LoopObserver](../../接口依赖的元素及定义/application/LoopObserver/js-apis-inner-application-loopobserver.md) | LoopObserver模块。 |
...
| CUSTOM | 3 | 表示用户通过[napi\_create\_ark\_runtime](../../../../Node-API/napi.md#napi_create_ark_runtime)从本机代码创建的虚拟机实例。 |
