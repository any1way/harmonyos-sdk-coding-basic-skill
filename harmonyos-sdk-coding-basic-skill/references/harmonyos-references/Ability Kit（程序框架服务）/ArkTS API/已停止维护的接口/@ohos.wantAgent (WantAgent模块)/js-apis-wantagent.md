...
scraped_at: 2026-06-01T15:31:52+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:de356e1c43504311747adf679cbefd3723e0b4302ddd7de64906e566b4212d1b
---
WantAgent模块提供了创建WantAgent实例、获取实例的用户ID、获取want信息、比较WantAgent实例和获取bundle名称等能力。

说明

本模块首批接口从API version 7开始支持，从API version 9废弃，替换模块为[@ohos.app.ability.wantAgent](<../../通用能力的接口(推荐)/@ohos.app.ability.wantAgent (WantAgent模块)/js-apis-app-ability-wantagent.md>)。后续版本的新增接口，采用上角标单独标记接口的起始版本。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [WantAgentInfo](../../接口依赖的元素及定义/wantAgent/WantAgentInfo/js-apis-inner-wantagent-wantagentinfo.md) | 是 | WantAgent信息。 |
...
| --- | --- | --- | --- |
| agent | WantAgent | 是 | WantAgent对象。 |
| triggerInfo | [TriggerInfo](../../接口依赖的元素及定义/wantAgent/TriggerInfo/js-apis-inner-wantagent-triggerinfo.md) | 是 | TriggerInfo对象。 |
