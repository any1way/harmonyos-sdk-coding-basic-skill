...
scraped_at: 2026-06-01T15:31:50+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:928eadea6c32b4da3aee732c88cd5cc5234f5b3bf3e2c023a24f4e7d656f8524
---
...
本模块从API version 9废弃，替换模块为[@ohos.app.ability.Configuration (Configuration)](<../../通用能力的接口(推荐)/@ohos.app.ability.Configuration (环境变量)/js-apis-app-ability-configuration.md>)。
...
| colorMode8+ | [ConfigurationConstant.ColorMode](<../@ohos.application.ConfigurationConstant (ConfigurationConstant)/js-apis-application_68731139.md#colormode>) | 否 | 是 | 表示深浅色模式，取值范围：浅色模式（COLOR\_MODE\_LIGHT），深色模式（COLOR\_MODE\_DARK）。默认为浅色。 |
