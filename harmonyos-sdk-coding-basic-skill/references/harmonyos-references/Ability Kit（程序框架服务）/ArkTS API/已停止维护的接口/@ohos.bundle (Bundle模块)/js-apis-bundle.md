...
scraped_at: 2026-06-01T15:31:54+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:52af687e52469eca06d6831d352f14d6dd7630c3cad76779caffe49f0c92bb08
---
本模块提供应用信息查询能力，支持[包信息](../bundle/BundleInfo/js-apis-bundle-bundleinfo.md)、[应用信息](../bundle/ApplicationInfo/js-apis-bundle-applicationinfo.md)、[Ability组件信息](../bundle/AbilityInfo/js-apis-bundle-abilityinfo.md)等信息的查询，以及应用禁用状态的查询、设置等。

说明

本模块首批接口从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。

从API version 9开始，该模块不再维护，建议使用[@ohos.bundle.bundleManager](<../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md>)替代。
...
权限等级参考[权限APL等级说明](../../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/应用权限管控概述/app-permission-mgmt-overview.md#权限机制中的基本概念)。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ApplicationInfo](../bundle/ApplicationInfo/js-apis-bundle-applicationinfo.md)> | Promise形式返回应用程序信息。 |
...
| callback | AsyncCallback<[ApplicationInfo](../bundle/ApplicationInfo/js-apis-bundle-applicationinfo.md)> | 是 | 程序启动作为入参的回调函数，返回应用程序信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[BundleInfo](../bundle/BundleInfo/js-apis-bundle-bundleinfo.md)>> | Promise形式返回所有可用的BundleInfo |
...
| callback | AsyncCallback<Array<[BundleInfo](../bundle/BundleInfo/js-apis-bundle-bundleinfo.md)>> | 是 | 程序启动作为入参的回调函数，返回所有可用的BundleInfo。 |
...
| callback | AsyncCallback<Array<[BundleInfo](../bundle/BundleInfo/js-apis-bundle-bundleinfo.md)>> | 是 | 程序启动作为入参的回调函数，返回指定用户下所有包的BundleInfo。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[getBundleInfo](<../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#bundlemanagergetbundleinfo14-2>)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[BundleInfo](../bundle/BundleInfo/js-apis-bundle-bundleinfo.md)> | Promise对象，获取成功时返回包信息。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[getBundleInfo](<../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#bundlemanagergetbundleinfo14-1>)替代。
...
| bundleFlags | number | 是 | 用于指定返回的应用信息对象中包含信息的标记。取值范围：参考[BundleFlag说明](js-apis-bundle.md#bundleflagdeprecated)中包信息相关flag。 |
| callback | AsyncCallback<[BundleInfo](../bundle/BundleInfo/js-apis-bundle-bundleinfo.md)> | 是 | 程序启动作为入参的回调函数，返回包信息。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[getBundleInfo](<../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#bundlemanagergetbundleinfo14>)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[ApplicationInfo](../bundle/ApplicationInfo/js-apis-bundle-applicationinfo.md)>> | Promise对象，获取成功时返回应用信息列表。 |
...
| bundleFlags | number | 是 | 用于指定返回的应用信息对象中包含信息的标记。取值范围：参考[BundleFlag说明](js-apis-bundle.md#bundleflagdeprecated)中应用信息相关flag。 |
| userId | number | 是 | 用户ID。默认值：调用方所在用户，取值范围：大于等于0。 |
| callback | AsyncCallback<Array<[ApplicationInfo](../bundle/ApplicationInfo/js-apis-bundle-applicationinfo.md)>> | 是 | 程序启动作为入参的回调函数，返回应用信息列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[BundleInfo](../bundle/BundleInfo/js-apis-bundle-bundleinfo.md)> | 返回值为Promise对象，Promise中包含有关HAP中包含的应用程序的信息。 |
...
| hapFilePath | string | 是 | HAP存放路径，支持当前应用程序的绝对路径和数据目录沙箱路径。 |
| bundleFlags | number | 是 | 用于指定要返回的BundleInfo对象中包含信息的标记。取值范围：参考[BundleFlag说明](js-apis-bundle.md#bundleflagdeprecated)中包信息相关flag。 |
| callback | AsyncCallback<[BundleInfo](../bundle/BundleInfo/js-apis-bundle-bundleinfo.md)> | 是 | 程序启动作为入参的回调函数，返回HAP中包含的应用程序包的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AbilityInfo](../bundle/AbilityInfo/js-apis-bundle-abilityinfo.md)> | Promise形式返回Ability信息。 |
...
| callback | AsyncCallback<[AbilityInfo](../bundle/AbilityInfo/js-apis-bundle-abilityinfo.md)> | 是 | 程序启动作为入参的回调函数，返回Ability信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [AbilityInfo](../bundle/AbilityInfo/js-apis-bundle-abilityinfo.md) | 是 | Ability的配置信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../@ohos.application.Want (Want)/js-apis-application-want.md>) | 是 | 包含要查询的应用Bundle名称的意图。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[AbilityInfo](../bundle/AbilityInfo/js-apis-bundle-abilityinfo.md)>> | Promise形式返回Ability信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../@ohos.application.Want (Want)/js-apis-application-want.md>) | 是 | 指示包含要查询的应用Bundle名称的意图。 |
| bundleFlags | number | 是 | 用于指定返回abilityInfo信息。取值范围：参考[BundleFlag说明](js-apis-bundle.md#bundleflagdeprecated)中Ability信息相关flag。 |
| userId | number | 是 | 用户ID。取值范围：大于等于0。 |
| callback | AsyncCallback<Array<[AbilityInfo](../bundle/AbilityInfo/js-apis-bundle-abilityinfo.md)>> | 是 | 程序启动作为入参的回调函数，返回Ability信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Want](<../@ohos.application.Want (Want)/js-apis-application-want.md>)> | 返回值为Promise对象，Promise中包含拉起指定应用的Want对象。 |
...
| --- | --- | --- | --- |
| bundleName | string | 是 | 要查询的应用Bundle名称。 |
| callback | AsyncCallback<[Want](<../@ohos.application.Want (Want)/js-apis-application-want.md>)> | 是 | 程序启动作为入参的回调函数，返回拉起指定应用的want对象。 |
...
从API version 8开始支持，从API version 9开始废弃，建议使用[getBundleNameByUid](<../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#bundlemanagergetbundlenamebyuid14-1>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[getBundleNameByUid](<../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#bundlemanagergetbundlenamebyuid14>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[resourceManager.getMediaContent](<../../../../Localization Kit（本地化开发服务）/ArkTS API/@ohos.resourceManager (资源管理)/js-apis-resource-manager.md#getmediacontent9>)替代。

getAbilityIcon(bundleName: string, abilityName: string): Promise<image.PixelMap>

通过bundleName和abilityName获取对应Icon的[PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)，使用Promise异步回调。
...
| 类型 | 说明 |
| --- | --- |
| Promise<image.PixelMap> | 返回值为[PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)。 |
...
通过bundleName和abilityName获取对应Icon的[PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)，使用callback异步回调。
...
| bundleName | string | 是 | 要查询的应用Bundle名称。 |
| abilityName | string | 是 | 要查询的Ability组件名。 |
| callback | AsyncCallback<image.PixelMap> | 是 | 程序启动作为入参的回调函数，返回指定[PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)。 |
...
从API version 7开始支持，从API version 9开始废弃，建议使用[包管理子系统通用错误码](../../../错误码/包管理子系统通用错误码/errorcode-bundle.md)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[bundleManager.BundleFlag](<../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#bundleflag>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[bundleManager.AbilityType](<../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#abilitytype>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[bundleManager.DisplayOrientation](<../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#displayorientation>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[bundleManager.LaunchType](<../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#launchtype>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[bundleManager.PermissionGrantState](<../../通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#permissiongrantstate>)替代。
