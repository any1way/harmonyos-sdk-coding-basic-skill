...
content_hash: sha256:10a6c4f3e84a45dee06fde31f9bffcbbeaa57a3be45ca54fb5308a3fd39213e3
---
ConfigurationConstant模块提供配置信息枚举值定义的能力。

说明

本模块首批接口从API version 8开始支持，从API version 9废弃，替换模块为[@ohos.app.ability.ConfigurationConstant (ConfigurationConstant)](<../../通用能力的接口(推荐)/@ohos.app.ability.ConfigurationConstant (环境变量相关的常量定义)/js-apis-app-ability-configurationconstant.md>)。后续版本的新增接口，采用上角标单独标记接口的起始版本。
