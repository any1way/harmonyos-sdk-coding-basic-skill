...
content_hash: sha256:8d198dbe5c89cfb528ee187e425d9b475a70267dd6ea05ae4611bd4ad8f4f7d3
---
...
[注册系统环境变化的监听](<../../接口依赖的元素及定义/application/ApplicationContext (应用上下文)/js-apis-inner-application-applicationcontext.md#applicationcontextonenvironment>)后，在系统环境变化时触发回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [Configuration](<../../通用能力的接口(推荐)/@ohos.app.ability.Configuration (环境变量)/js-apis-app-ability-configuration.md>) | 是 | 变化后的Configuration对象。 |
...
[注册系统环境变化的监听](<../../接口依赖的元素及定义/application/ApplicationContext (应用上下文)/js-apis-inner-application-applicationcontext.md#applicationcontextonenvironment>)后，在系统内存变化时触发回调。
