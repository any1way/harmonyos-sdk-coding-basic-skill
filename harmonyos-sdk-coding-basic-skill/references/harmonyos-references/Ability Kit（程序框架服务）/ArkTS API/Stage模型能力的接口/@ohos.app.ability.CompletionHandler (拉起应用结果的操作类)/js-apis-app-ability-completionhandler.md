...
scraped_at: 2026-06-01T15:29:37+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:1b8fb09161825fd4602684f3fcea3aed4af0a1b361a39ea4767af5950ee30a2e
---
CompletionHandler作为[StartOptions](<../@ohos.app.ability.StartOptions (startAbility的可选参数)/js-apis-app-ability-startoptions.md#startoptions>)和[OpenLinkOptions](<../@ohos.app.ability.OpenLinkOptions (openLink的可选参数)/js-apis-app-ability-openlinkoptions.md#openlinkoptions>)的可选参数，用于处理拉起应用请求的结果。
...
* [startAbility](../../接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#startability-2)
* [startAbilityForResult](../../接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#startabilityforresult-2)
* [openLink](../../接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#openlink12)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| elementName | [ElementName](../../接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md) | 是 | ElementName信息用于标识被拉起应用。通常，ElementName仅包含abilityName和bundleName。moduleName和deviceId信息是否存在取决于调用方是否传入。shortName和uri为空。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| elementName | [ElementName](../../接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md) | 是 | ElementName信息用于标识被拉起应用。  - 通常，ElementName仅包含abilityName和bundleName。moduleName和deviceId信息是否存在取决于调用方是否传入。shortName和uri为空。  - 隐式启动失败时，无法获取ElementName信息。 |
