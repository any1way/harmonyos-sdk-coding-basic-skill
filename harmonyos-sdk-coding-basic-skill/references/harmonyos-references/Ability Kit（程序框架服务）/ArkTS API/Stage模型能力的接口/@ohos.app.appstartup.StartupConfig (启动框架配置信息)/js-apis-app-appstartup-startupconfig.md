...
scraped_at: 2026-06-01T15:30:00+08:00
doc_updated_at: 2026-04-13
content_hash: sha256:a6cdfaaa6bb706cf469457cd354b77394c1963c8b428fbd2fea2d5439b6b17d4
---
本模块提供[应用启动框架](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/应用启动框架AppStartup/app-startup.md>)配置信息的定义。
...
用于配置任务超时时间和启动框架的监听器。详细使用方法可参考[设置启动参数](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/应用启动框架AppStartup/app-startup.md#设置启动参数>)章节。
...
| startupListener | [StartupListener](<../@ohos.app.appstartup.StartupListener (启动框架任务监听器)/js-apis-app-appstartup-startuplistener.md>) | 否 | 是 | 表示启动框架的监听器，该监听器将在所有启动任务完成时调用。 |
