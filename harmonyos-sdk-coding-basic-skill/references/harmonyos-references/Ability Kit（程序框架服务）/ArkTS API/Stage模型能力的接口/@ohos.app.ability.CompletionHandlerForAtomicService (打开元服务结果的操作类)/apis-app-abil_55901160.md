...
content_hash: sha256:fe808cefe8f40a2f34de41469ada7aeb2b4cdff48f10d728a08967f8f3d65826
---
...
CompletionHandlerForAtomicService提供了[onAtomicServiceRequestSuccess](apis-app-abil_55901160.md#onatomicservicerequestsuccess)和[onAtomicServiceRequestFailure](apis-app-abil_55901160.md#onatomicservicerequestfailure)两个回调函数，分别在打开元服务成功和失败时回调。
...
参见[CompletionHandlerForAtomicService示例](apis-app-abil_55901160.md#completionhandlerforatomicservice示例)。
...
| --- | --- | --- | --- |
| appId | string | 是 | 被拉起元服务的appId。 |
| failureCode | [FailureCode](apis-app-abil_55901160.md#failurecode) | 是 | 失败原因的错误码。 |
