...
scraped_at: 2026-06-11T15:34:18+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:b75391f01c5d16598541b353d21f0efa34c981d10bdca8d63995a574c58b00ae
---
CompletionHandlerForAtomicService作为[AtomicServiceOptions](<../@ohos.app.ability.AtomicServiceOptions (openAtomicService可选参数)/js-apis-app-abil_98646972.md>)的可选参数，用于接收打开元服务请求的结果。
...
CompletionHandlerForAtomicService提供了[onAtomicServiceRequestSuccess](js-apis-app-a_85269127.md#onatomicservicerequestsuccess)和[onAtomicServiceRequestFailure](js-apis-app-a_85269127.md#onatomicservicerequestfailure)两个回调函数，分别在打开元服务成功和失败时回调。
...
参见[CompletionHandlerForAtomicService示例](js-apis-app-a_85269127.md#completionhandlerforatomicservice示例)。
...
| --- | --- | --- | --- |
| appId | string | 是 | 被拉起元服务的appId。 |
| failureCode | [FailureCode](js-apis-app-a_85269127.md#failurecode) | 是 | 失败原因的错误码。 |
