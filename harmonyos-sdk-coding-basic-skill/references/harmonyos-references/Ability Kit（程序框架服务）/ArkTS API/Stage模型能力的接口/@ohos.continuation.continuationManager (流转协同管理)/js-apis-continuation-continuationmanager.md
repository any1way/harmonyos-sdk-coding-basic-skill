...
scraped_at: 2026-06-01T15:30:08+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:1cca3737fda50d49c213c09b3f5b807cf431ca9985b017e7fbd00f3661a5fc7c
---
...
从API version 9开始废弃，建议使用[ondevicestatechange](<../../../../网络/Distributed Service Kit（分布式管理服务）/ArkTS API/@ohos.distributedDeviceManager (设备管理)/js-apis-distributeddevicemanager.md#ondevicestatechange>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ContinuationExtraParams](../continuation/ContinuationExtraParams/js-apis-continuation-continuationextraparams.md) | 是 | 过滤可选择设备列表的额外参数。 |
| callback | AsyncCallback<number> | 是 | AsyncCallback形式返回流转管理服务连接后生成的token。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ContinuationExtraParams](../continuation/ContinuationExtraParams/js-apis-continuation-continuationextraparams.md) | 否 | 过滤可选择设备列表的额外参数，该参数可缺省。 |
...
从API version 9开始支持，从API version 22开始废弃，建议使用[onDeviceStateChange](<../../../../网络/Distributed Service Kit（分布式管理服务）/ArkTS API/@ohos.distributedDeviceManager (设备管理)/js-apis-distributeddevicemanager.md#ondevicestatechange>)替代。
...
以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)和[DistributedSchedule错误码](../../../错误码/DistributedSchedule错误码/errorcode-distributedschedule.md)。
...
| callback | Callback<[ContinuationResult](../continuation/ContinuationResult/js-apis-continuation-continuationresult.md)> | 是 | 当用户从设备选择模块中选择设备时调用，返回设备ID、设备类型和设备名称供开发者使用。 |
...
从API version 9开始废弃，建议使用[offDeviceStateChange](<../../../../网络/Distributed Service Kit（分布式管理服务）/ArkTS API/@ohos.distributedDeviceManager (设备管理)/js-apis-distributeddevicemanager.md#offdevicestatechange>)替代。
...
| callback | Callback<[ContinuationResult](../continuation/ContinuationResult/js-apis-continuation-continuationresult.md)> | 否 | 当用户从设备选择模块中选择设备时调用，返回设备ID、设备类型和设备名称供开发者使用。 |
...
| callback | Callback<Array<[ContinuationResult](../continuation/ContinuationResult/js-apis-continuation-continuationresult.md)>> | 是 | 当用户从设备选择模块中选择设备时调用，返回设备ID、设备类型和设备名称供开发者使用。 |
...
| token | number | 是 | 注册后的token。 |
| callback | Callback<Array<[ContinuationResult](../continuation/ContinuationResult/js-apis-continuation-continuationresult.md)>> | 是 | 当用户从设备选择模块中断开设备时调用，返回设备ID、设备类型和设备名称供开发者使用。 |
...
从API version 9开始支持，从API version 22开始废弃，建议使用[offDeviceStateChange](<../../../../网络/Distributed Service Kit（分布式管理服务）/ArkTS API/@ohos.distributedDeviceManager (设备管理)/js-apis-distributeddevicemanager.md#offdevicestatechange>)替代。
...
从API version 9开始废弃，建议使用[startDiscovering](<../../../../网络/Distributed Service Kit（分布式管理服务）/ArkTS API/@ohos.distributedDeviceManager (设备管理)/js-apis-distributeddevicemanager.md#startdiscovering>)替代。
...
从API version 9开始支持，从API version 22开始废弃，建议使用[startDiscovering](<../../../../网络/Distributed Service Kit（分布式管理服务）/ArkTS API/@ohos.distributedDeviceManager (设备管理)/js-apis-distributeddevicemanager.md#startdiscovering>)替代。
...
从API version 9开始废弃，建议使用[getAvailableDeviceListSync](<../../../../网络/Distributed Service Kit（分布式管理服务）/ArkTS API/@ohos.distributedDeviceManager (设备管理)/js-apis-distributeddevicemanager.md#getavailabledevicelistsync>)替代。
...
从API version 9开始支持，从API version 22开始废弃，建议使用[getAvailableDeviceListSync](<../../../../网络/Distributed Service Kit（分布式管理服务）/ArkTS API/@ohos.distributedDeviceManager (设备管理)/js-apis-distributeddevicemanager.md#getavailabledevicelistsync>)替代。
...
从API version 22开始废弃，建议使用[DeviceStateChange](<../../../../网络/Distributed Service Kit（分布式管理服务）/ArkTS API/@ohos.distributedDeviceManager (设备管理)/js-apis-distributeddevicemanager.md#devicestatechange>)替代。
...
从API version 10开始支持，从API version 22开始废弃，建议使用[DeviceBasicInfo](<../../../../网络/Distributed Service Kit（分布式管理服务）/ArkTS API/@ohos.distributedDeviceManager (设备管理)/js-apis-distributeddevicemanager.md#devicebasicinfo>)替代。
...
| 类型 | 说明 |
| --- | --- |
| [\_ContinuationResult](../continuation/ContinuationResult/js-apis-continuation-continuationresult.md) | 表示流转管理入口返回的设备信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_ContinuationExtraParams](../continuation/ContinuationExtraParams/js-apis-continuation-continuationextraparams.md) | 表示流转管理入口中设备选择模块所需的过滤参数。 |
