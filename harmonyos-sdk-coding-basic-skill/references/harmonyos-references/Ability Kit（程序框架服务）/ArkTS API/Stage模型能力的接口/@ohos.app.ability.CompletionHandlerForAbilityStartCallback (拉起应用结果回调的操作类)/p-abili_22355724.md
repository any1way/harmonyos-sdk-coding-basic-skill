...
scraped_at: 2026-06-01T15:29:38+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:c50665ac058c80954bc0e64e9f16efa89a85dc81b28efd556efeb69f36cdbe57
---
CompletionHandlerForAbilityStartCallback作为[AbilityStartCallback](../../接口依赖的元素及定义/application/AbilityStartCallback/js-apis-inner-application-abilitystartcallback.md)的可选参数，用于返回垂域面板拉起指定类型的Ability组件的回调结果。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onRequestSuccess | [OnRequestSuccessFn](p-abili_22355724.md#onrequestsuccessfn) | 否 | 是 | 拉起指定类型的Ability组件成功时的回调函数。  **元服务API**：从API version 21开始，该接口支持在元服务中使用。 |
| onRequestFailure | [OnRequestFailureFn](p-abili_22355724.md#onrequestfailurefn) | 否 | 是 | 拉起指定类型的Ability组件失败时的回调函数。  **元服务API**：从API version 21开始，该接口支持在元服务中使用。 |
...
参见[OnRequestFailureFn](p-abili_22355724.md#onrequestfailurefn)。
...
| failureCode | [AbilityStartFailureCode](p-abili_22355724.md#abilitystartfailurecode) | 是 | 失败原因的错误码。 |
