...
scraped_at: 2026-06-11T15:34:20+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:49454a35be1b7c765bd405b8248d685460fdfe04e5ec0e3b8939bd351e54ab70
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onRequestSuccess | [OnRequestSuccessFn](js-apis_51913223.md#onrequestsuccessfn) | 否 | 是 | 拉起指定类型的Ability组件成功时的回调函数。  **元服务API**：从API version 21开始，该接口支持在元服务中使用。 |
| onRequestFailure | [OnRequestFailureFn](js-apis_51913223.md#onrequestfailurefn) | 否 | 是 | 拉起指定类型的Ability组件失败时的回调函数。  **元服务API**：从API version 21开始，该接口支持在元服务中使用。 |
...
参见[OnRequestFailureFn](js-apis_51913223.md#onrequestfailurefn)。
...
| failureCode | [AbilityStartFailureCode](js-apis_51913223.md#abilitystartfailurecode) | 是 | 失败原因的错误码。 |
