...
scraped_at: 2026-06-01T15:29:45+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:23b59c69bd2ef7ade493dae0a3eba1e67e58155d49e83c2f53756d89d69ff8c5
---
本模块提供意图执行上下文，是[意图执行基类](<../@ohos.app.ability.InsightIntentExecutor (意图执行基类)/js-apis-app-ability-insightintentexecutor.md>)和[@InsightIntentEntry的意图执行基类](<../@ohos.app.ability.InsightIntentEntryExecutor (@InsightIntentEntry的意图执行基类)/js-apis_94625279.md>)的属性，为意图执行提供基础能力，例如启动本应用内的[UIAbility组件](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| instanceId23+ | number | 否 | 否 | 意图实例唯一ID。用于通过[insightIntentProvider.sendExecuteResult接口](<../@ohos.app.ability.insightIntentProvider (意图提供方管理能力)/js-apis-app-ability-insightintentprovider.md#insightintentprovidersendexecuteresult>)和[insightIntentProvider.sendIntentResult接口](<../@ohos.app.ability.insightIntentProvider (意图提供方管理能力)/js-apis-app-ability-insightintentprovider.md#insightintentprovidersendintentresult>)返回指定意图的执行结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 启动UIAbility组件的want信息。 |
...
设置意图执行结果的返回形式，适用于执行模式为[UI\_ABILITY\_FOREGROUND](<../@ohos.app.ability.insightIntent (意图框架基础定义)/js-apis-app-ability-insightintent.md#executemode>)的意图。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| returnMode | [insightIntent.ReturnMode](<../@ohos.app.ability.insightIntent (意图框架基础定义)/js-apis-app-ability-insightintent.md#returnmode23>) | 是 | 意图执行结果的返回形式。 |
...
设置意图执行结果的返回形式，适用于执行模式为[UI\_EXTENSION\_ABILITY](<../@ohos.app.ability.insightIntent (意图框架基础定义)/js-apis-app-ability-insightintent.md#executemode>)的意图。
