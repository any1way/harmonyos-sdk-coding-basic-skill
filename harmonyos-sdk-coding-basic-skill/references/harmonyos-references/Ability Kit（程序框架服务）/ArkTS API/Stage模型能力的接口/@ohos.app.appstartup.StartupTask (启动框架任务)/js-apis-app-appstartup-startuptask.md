...
content_hash: sha256:25c9630c28a68e12f44535d3a21de846157598d8ec9467d76805cb8f9ff81dbe
---
本模块提供[应用启动框架](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/应用启动框架AppStartup/app-startup.md>)任务的相关能力。
...
该类提供启动任务的相关能力，使用[@Sendable装饰器](../../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md#sendable装饰器)装饰。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [AbilityStageContext](../../接口依赖的元素及定义/application/AbilityStageContext/js-apis-inner-application-abilitystagecontext.md) | 是 | [AbilityStage](<../@ohos.app.ability.AbilityStage (AbilityStage组件管理器)/js-apis-app-ability-abilitystage.md>)的上下文环境 |
