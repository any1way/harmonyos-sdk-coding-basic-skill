...
scraped_at: 2026-06-01T15:29:22+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:c19d8ed6011975b8fc2c4409fc436f4fd21fa1b0f2812585330cb67605eaa5d5
---
[UIAbility](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)从创建到销毁过程其生命周期是动态变化的。AbilityLifecycleCallback模块提供监听[UIAbility](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)生命周期变化的能力，可用于统计每个UIAbility的运行时长、执行与UIAbility业务逻辑解耦的数据加载等场景。
...
1. 应用创建AbilityLifecycleCallback对象，并调用[ApplicationContext.on('abilityLifecycle')](<../../接口依赖的元素及定义/application/ApplicationContext (应用上下文)/js-apis-inner-application-applicationcontext.md#applicationcontextonabilitylifecycle>)接口注册UIAbility生命周期变化监听。
2. 当UIAbility生命周期变化时，应用可以通过已注册的AbilityLifecycleCallback对象接收到UIAbility生命周期的变化通知。
3. 当应用不需要监听UIAbility生命周期变化时，需要通过[ApplicationContext.off('abilityLifecycle')](<../../接口依赖的元素及定义/application/ApplicationContext (应用上下文)/js-apis-inner-application-applicationcontext.md#applicationcontextoffabilitylifecycle>)接口取消监听。
...
在UIAbility的[onCreate](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#oncreate>)触发后回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ability | [UIAbility](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>) | 是 | 回调事件对应的UIAbility对象。 |

**示例：**

参见[AbilityLifecycleCallback使用示例](js-apis-app-abi_71548541.md#abilitylifecyclecallback使用示例)。
...
在UIAbility的[onWindowStageCreate](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onwindowstagecreate>)触发后回调。
...
| --- | --- | --- | --- |
| ability | [UIAbility](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>) | 是 | 回调事件对应的UIAbility对象。 |
| windowStage | [window.WindowStage](<../../../../ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (WindowStage)/arkts-apis-window-windowstage.md>) | 是 | 回调事件对应的UIAbility主窗管理器。 |
...
在UIAbility的[onWindowStageDestroy](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onwindowstagedestroy>)触发后回调。
...
在UIAbility的[onDestroy](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#ondestroy>)触发后回调。
...
在UIAbility的[onForeground](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onforeground>)触发后回调。
...
在UIAbility的[onBackground](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onbackground>)触发后回调。
...
在UIAbility的[onContinue](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#oncontinue>)触发后回调。
...
在UIAbility的[onCreate](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#oncreate>)触发前回调。
...
在UIAbility的[onWindowStageCreate](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onwindowstagecreate>)触发前回调。
...
在UIAbility的[onWindowStageDestroy](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onwindowstagedestroy>)触发前回调。
...
在UIAbility的[onForeground](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onforeground>)触发前回调。
...
在UIAbility的[onDestroy](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#ondestroy>)触发前回调。
...
在UIAbility的[onBackground](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onbackground>)触发前回调。
...
在UIAbility的[onNewWant](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onnewwant>)触发前回调。
...
在UIAbility的[onNewWant](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onnewwant>)触发后回调。
...
在UIAbility的[onContinue](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#oncontinue>)触发前回调。
...
在UIAbility的[onWindowStageRestore](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onwindowstagerestore>)触发前回调。
...
在UIAbility的[onWindowStageRestore](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onwindowstagerestore>)触发后回调。
...
在UIAbility的[onSaveState](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onsavestate>)触发前回调。
...
在UIAbility的[onSaveState](<../@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onsavestate>)触发后回调。
...
1. 在[AbilityStage](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/AbilityStage组件管理器/abilitystage.md>)创建时注册监听。
2. 在[AbilityStage](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/AbilityStage组件管理器/abilitystage.md>)销毁时注销监听。
