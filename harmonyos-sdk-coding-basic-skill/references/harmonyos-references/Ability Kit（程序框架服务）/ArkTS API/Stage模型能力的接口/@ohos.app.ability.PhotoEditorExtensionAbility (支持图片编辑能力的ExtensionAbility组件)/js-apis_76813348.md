...
scraped_at: 2026-06-11T15:34:32+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:60453aaaefc9917657187e67604a2b9c0e92ce383d224fecb530a36f9de0b66f
---
PhotoEditorExtensionAbility继承自[ExtensionAbility](<../@ohos.app.ability.ExtensionAbility (扩展能力基类)/js-apis-app-ability-extensionability.md>)，开发者可通过PhotoEditorExtensionAbility实现图片编辑扩展页面。应用通过[startAbilityByType](../../接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#startability)拉起图片编辑类应用扩展面板后，由用户在面板上选择实现了PhotoEditorExtensionAbility的图片编辑扩展页面并拉起该页面。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/50/v3/mTkCIIdgR9S0Z8FTQpLbxA/zh-cn_image_0000002592379790.png?HW-CC-KV=V1&HW-CC-Date=20260611T073431Z&HW-CC-Expire=86400&HW-CC-Sign=B2996C445444BBE5E9B1E4183AF8C787552DE11F10D87C655CA7AB47804085D8)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [PhotoEditorExtensionContext](../../接口依赖的元素及定义/application/PhotoEditorExtensionContext/js-apis-app-ability-photoeditorextensioncontext.md) | 否 | 否 | PhotoEditorExtensionAbility的上下文，提供保存图片能力。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | string | 是 | 待编辑的原始图片[uri](<../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fileuri (文件URI)/js-apis-file-fileuri.md>)，格式为file://<bundleName>/<sandboxPath>。 |
| want | [Want](<../../通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 当前PhotoEditorExtensionAbility的Want类型信息，包括ability名称、bundle名称等。 |
| session | [UIExtensionContentSession](<../@ohos.app.ability.UIExtensionContentSession (带界面扩展能力的界面操作类)/js-apis-app-ability_18888586.md>) | 是 | PhotoEditorExtensionAbility界面内容相关信息。 |
