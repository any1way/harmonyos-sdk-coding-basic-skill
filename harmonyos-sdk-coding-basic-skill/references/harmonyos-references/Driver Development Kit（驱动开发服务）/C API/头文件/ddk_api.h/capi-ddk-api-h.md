...
scraped_at: 2026-06-01T16:13:29+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:957f2178a80e0ab43b291306390b10903bb4fc84e43ce60c7b565a792202d461
---
## 概述
...
**相关模块：** [Ddk](../../模块/BaseDdk/capi-baseddk.md)
...
| [DDK\_Ashmem](../../结构体/DDK_Ashmem/capi-baseddk-ddk-ashmem.md) \*\*ashmem | 指向创建的共享内存的指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [DDK\_RetCode](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) | [DDK\_SUCCESS](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) 调用接口成功。  [DDK\_INVALID\_PARAMETER](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) 入参name为空指针，size的大小为0或者入参ashmem是空指针。  [DDK\_FAILURE](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) 创建共享内存失败或者创建结构体DDK\_Ashmem失败。 |
...
| 参数项 | 描述 |
| --- | --- |
| [DDK\_Ashmem](../../结构体/DDK_Ashmem/capi-baseddk-ddk-ashmem.md) \*ashmem | 要映射的共享内存指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [DDK\_RetCode](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) | [DDK\_SUCCESS](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) 调用接口成功。  [DDK\_NULL\_PTR](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) 入参ashmem为空指针。  [DDK\_FAILURE](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) 共享内存的文件描述符无效。  [DDK\_INVALID\_OPERATION](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) 调用接口MapAshmem失败。 |
...
| 参数项 | 描述 |
| --- | --- |
| [DDK\_Ashmem](../../结构体/DDK_Ashmem/capi-baseddk-ddk-ashmem.md) \*ashmem | 要取消映射的共享内存指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [DDK\_RetCode](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) | [DDK\_SUCCESS](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) 调用接口成功。  [DDK\_NULL\_PTR](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) 入参ashmem为空指针。  [DDK\_FAILURE](../ddk_types.h/capi-ddk-types-h.md#ddk_retcode) 共享内存的文件描述符无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [DDK\_Ashmem](../../结构体/DDK_Ashmem/capi-baseddk-ddk-ashmem.md) \*ashmem | 要销毁的共享内存指针。 |
