...
content_hash: sha256:f71651edee7d167e891e4e8a06c551decdeb6e1d06149b8b17db42b6a60af854
---
```
...
设备内存映射，通过[OH\_Usb\_CreateDeviceMemMap](<../../../../硬件/Driver Development Kit（驱动开发服务）/C API/头文件/usb_ddk_api.h/capi-usb-ddk-api-h.md#oh_usb_createdevicememmap>)创建设备内存映射，使用内存映射后的缓冲区，可提升数据传输性能。
