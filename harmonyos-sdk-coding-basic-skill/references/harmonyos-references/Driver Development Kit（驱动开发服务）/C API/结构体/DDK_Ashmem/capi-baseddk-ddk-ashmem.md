...
content_hash: sha256:527812241ed3222b1a77c2c2e3480c7e19d0774cf1651e76c6165cad6db25007
---
```
...
定义通过接口[OH\_DDK\_CreateAshmem](<../../../../硬件/Driver Development Kit（驱动开发服务）/C API/头文件/ddk_api.h/capi-ddk-api-h.md#oh_ddk_createashmem>)创建的共享内存，共享内存的缓冲区提供更好的性能。

**起始版本：** 12

**相关模块：** [Ddk](../../模块/BaseDdk/capi-baseddk.md)

**所在头文件：** [ddk\_types.h](<../../../../硬件/Driver Development Kit（驱动开发服务）/C API/头文件/ddk_types.h/capi-ddk-types-h.md>)
