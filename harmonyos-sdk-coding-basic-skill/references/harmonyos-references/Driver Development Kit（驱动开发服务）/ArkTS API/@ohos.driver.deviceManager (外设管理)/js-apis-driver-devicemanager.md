...
scraped_at: 2026-06-11T16:22:50+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:f6c4c46ce7094911196e16b94dd05279abdb699c86aeb04edfa4421d49425b19
---
...
以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)和[驱动错误码](../../错误码/驱动错误码/errorcode-devicemanager.md)。
...
| deviceId | number | 是 | 设备ID，通过queryDevices获得。 |
| onDisconnect | AsyncCallback<number> | 是 | 回调函数。当绑定设备断开时，err为undefined，data为解绑的设备ID；否则为错误对象。 |
| callback | AsyncCallback<{deviceId: number; remote: [rpc.IRemoteObject](<../../../IPC Kit（进程间通信服务）/ArkTS API/@ohos.rpc (RPC通信)/js-apis-rpc.md#iremoteobject>);}> | 是 | 回调函数。当绑定设备成功时，err为undefined，data包含设备ID和绑定设备驱动通信对象；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<{deviceId: number; remote: [rpc.IRemoteObject](<../../../IPC Kit（进程间通信服务）/ArkTS API/@ohos.rpc (RPC通信)/js-apis-rpc.md#iremoteobject>);}> | Promise对象，返回一个包含设备ID和IRemoteObject的对象。 |
...
| remote11+ | [rpc.IRemoteObject](<../../../IPC Kit（进程间通信服务）/ArkTS API/@ohos.rpc (RPC通信)/js-apis-rpc.md#iremoteobject>) | 否 | 否 | 远程驱动程序对象。 |
