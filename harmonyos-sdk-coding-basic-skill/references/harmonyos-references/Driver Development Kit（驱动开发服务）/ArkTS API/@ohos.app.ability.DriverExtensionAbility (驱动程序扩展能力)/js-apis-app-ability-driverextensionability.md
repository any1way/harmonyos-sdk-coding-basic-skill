...
scraped_at: 2026-06-11T16:22:46+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:1845bc49f5e012a4513569823c75f912c58e78ba7a388de149be74ed269bb335
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [DriverExtensionContext](../application/DriverExtensionContext/js-apis-inner-application-driverextensioncontext.md) | 否 | 否 | DriverExtension的上下文环境，继承自ExtensionContext。 |
...
Extension生命周期回调，会在[onCreate](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.AbilityStage (AbilityStage组件管理器)/js-apis-app-ability-abilitystage.md#oncreate>)之后回调。返回一个[RemoteObject](<../../../IPC Kit（进程间通信服务）/ArkTS API/@ohos.rpc (RPC通信)/js-apis-rpc.md#remoteobject>)对象，用于客户端和服务端进行通信。
...
| 类型 | 说明 |
| --- | --- |
| rpc.[RemoteObject](<../../../IPC Kit（进程间通信服务）/ArkTS API/@ohos.rpc (RPC通信)/js-apis-rpc.md#remoteobject>) | Promise<rpc.[RemoteObject](<../../../IPC Kit（进程间通信服务）/ArkTS API/@ohos.rpc (RPC通信)/js-apis-rpc.md#remoteobject>)> | 一个RemoteObject对象，用于客户端和服务端进行通信；或一个Promise对象，返回用于通信的RemoteObject对象。 |
...
如果生成返回值[RemoteObject](<../../../IPC Kit（进程间通信服务）/ArkTS API/@ohos.rpc (RPC通信)/js-apis-rpc.md#remoteobject>)依赖一个异步接口，可以使用异步生命周期：
...
| 类型 | 说明 |
| --- | --- |
| \_DriverExtensionContext | DriverExtensionAbility的上下文环境，继承自ExtensionContext，其具体使用方法可参考[DriverExtensionContext](../application/DriverExtensionContext/js-apis-inner-application-driverextensioncontext.md)。 |
