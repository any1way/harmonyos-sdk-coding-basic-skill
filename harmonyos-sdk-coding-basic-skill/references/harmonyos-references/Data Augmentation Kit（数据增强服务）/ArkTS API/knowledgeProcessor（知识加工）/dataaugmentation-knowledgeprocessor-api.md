...
content_hash: sha256:141f73489288f921689f6e7e6e0498a50c360a2bb9c363fbcaae487eab211561
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.BaseContext](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/BaseContext/js-apis-inner-application-basecontext.md>) | 是 | 知识加工对象的上下文。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1021400000](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021400000-内部错误>) | Internal error. |
| [1021400001](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021400001-知识源未配置>) | The knowledge source is not configured. |
| [1021400002](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021400002-知识schema文件不存在>) | The knowledge schema file is not found. |
| [1021400003](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021400003-知识schema内容不合法>) | The knowledge schema content is invalid. |
| [1021400004](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021400004-操作rdb数据源时发生错误>) | An error occurred during operations on the RDB source. |
...
| --- | --- |
| [1021400001](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021400001-知识源未配置>) | The knowledge source is not configured. |
| [1021400002](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021400002-知识schema文件不存在>)  [1021400003](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021400003-知识schema内容不合法>)  [1021400004](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021400004-操作rdb数据源时发生错误>) | The knowledge schema file is not found.  The knowledge schema content is invalid.  An error occurred during operations on the RDB source. |
...
| 名称 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | relationalStore.StoreConfig | 否 | RDB数据库配置。加工数据源为RDB数据库时配置，当前版本仅支持RDB数据源，若不填该参数，接口返回错误码[1021400001](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021400001-知识源未配置>)。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../../通用错误码/errorcode-universal.md#section801-该设备不支持此api) | Device type error. |
| [1021400000](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021400000-内部错误>) | Internal error. |
| [1021400005](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021400005-重复启动知识加工>) | Feature already active. Function called repeatedly. |
