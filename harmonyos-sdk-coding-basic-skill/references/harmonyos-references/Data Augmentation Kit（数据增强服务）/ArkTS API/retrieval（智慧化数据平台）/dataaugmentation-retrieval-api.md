...
scraped_at: 2026-06-01T15:58:05+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:575e9f5f4b98541ff97b756879ff1898b4ef96fa1fd10ba7811f6769d9e6185f
---
...
| context | [common.BaseContext](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/BaseContext/js-apis-inner-application-basecontext.md>) | 否 | 否 | 应用的上下文。  FA模型的应用Context定义。  Stage模型的应用Context定义。 |
...
| 类型 | 说明 |
| --- | --- |
| [relationalStore.StoreConfig](<../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.relationalStore (关系型数据库)/Interfaces (其他)/arkts-apis-data-relationalstore-i.md#storeconfig>) | 数据库配置。 |
...
以下错误码的详细介绍请参见[ArkTS API错误码](<../ArkTS API错误码/dataaugmentation-error-code.md>)。

| 错误码ID | 错误信息 |
| --- | --- |
| [1021200001](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021200001-数据库文件损坏>) | The database is corrupted. |
| [1021200002](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021200002-数据库或事务关闭>) | The database is closed. |
| [1021200003](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021200003-数据库busy>) | The database is busy. |
| [1021200004](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021200004-数据库内存不足>) | The database is out of memory. |
| [1021200100](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021200100-sqlite-通用错误>) | SQLite: Generic error. |
| [1021200101](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021200101-sqlite访问权限被拒绝>) | SQLite: Access permission denied. |
| [1021200102](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021200102-sqlite数据库文件已锁定>) | SQLite: The database file is locked. |
| [1021200103](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021200103-sqlite发生了某种磁盘io错误>) | SQLite: Some kind of disk I/O error occurred. |
| [1021200104](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021200104-wal文件大小超过默认上限>) | SQLite: The WAL file size exceeds the default limit. |
| [1021200105](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021200105-无法打开数据库文件>) | SQLite: Unable to open the database file. |
| [1021201000](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021201000-retrieval-recall-error>) | Retrieval: An error occurred during the reacall phase. |
| [1021201001](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021201001-retrieval-re-ranking-error>) | Retrieval: An error occurred during the re-ranking phase. |
| [1021201002](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021201002-retrieval-numerical-parameter-out-of-range>) | Retrieval: The value of the numerical parameter is outside the constrained range. |
| [1021201003](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021201003-retrieval-invalid-primary-keys>) | Retrieval: There are invalid primary keys. |
| [1021201004](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021201004-retrieval-unsupport-composite-primary-key-in-re-ranking>) | Retrieval: A re-ranking algorithm that does not support composite primary keys was used. |
| [1021201005](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021201005-retrieval-empty-string-field>) | Retrieval: There are fields with empty strings. |
| [1021201006](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021201006-retrieval-illegal-filter-input>) | Retrieval: The filter input is invalid. |
| [1021201007](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021201007-retrieval-invalid-recall-field-name>) | Retrieval: There are invalid recall names in RecallCondition. |
| [1021201008](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021201008-retrieval-vector-similarity-threshold-too-high>) | Retrieval: The vector similarity threshold in VectorQuery is higher than the tiered threshold in VectorRerankParameter. |
| [1021201009](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021201009-retrieval-rerankmethod-parameters-do-not-match-the-channel-type>) | Retrieval: RerankMethod parameters do not match the channel type. |
| [1021201010](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021201010-retrieval-empty-parameter-value>) | Retrieval: There exists a parameter value that should not be empty but is actually empty |
| [1021200012](<../ArkTS API错误码/dataaugmentation-error-code.md#section1021200012-unable-to-generate-embeddings>) | Unable to generate embeddings. |
...
| columns | Record<string, [relationalStore.ValueType](<../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.relationalStore (关系型数据库)/Types/arkts-apis-data-relationalstore-t.md#valuetype>)> | 否 | 否 | 召回列及其内容。 |
