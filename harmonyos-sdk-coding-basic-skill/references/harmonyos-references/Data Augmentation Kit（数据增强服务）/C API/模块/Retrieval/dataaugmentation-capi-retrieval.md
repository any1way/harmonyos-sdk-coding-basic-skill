...
scraped_at: 2026-06-01T15:58:12+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:efd22a9aaf34b228fe43448057aae4cad282298648dcd3e03370b0f6284a3ba7
---
## 概述
...
| 名称 | 描述 |
| --- | --- |
| [aip\_retrieval.h](../../头文件和结构体/aip_retrieval.h/dataaugmentation-aip-retrieval.md) | 提供知识检索相关的接口。 |
| [aip\_retrieval\_condition.h](../../头文件和结构体/aip_retrieval_condition.h/dataaugmentation-aip-retrieval-condition.md) | 提供与检索条件相关的接口。 |
| [aip\_retrieval\_condition\_vector.h](../../头文件和结构体/aip_retrieval_condition_vector.h/dataaugmentation-aip-retrieval-condition-vector.md) | 提供与向量条件相关的接口。 |
| [aip\_retrieval\_query.h](../../头文件和结构体/aip_retrieval_query.h/dataaugmentation-aip-retrieval-query.md) | 提供与检索查询相关的接口。 |
| [aip\_retrieval\_record.h](../../头文件和结构体/aip_retrieval_record.h/dataaugmentation-aip-retrieval-record.md) | 提供与检索结果相关的接口。 |
...
| int [OH\_Retrieval\_SetDbConfig](dataaugmentation-capi-retrieval.md#oh_retrieval_setdbconfig) ([OH\_Retrieval\_DbConfig](dataaugmentation-capi-retrieval.md#oh_retrieval_dbconfig) \*dbConfig, [OH\_Rdb\_ConfigV2](<../../../../ArkData（方舟数据管理）/C API/结构体/OH_Rdb_ConfigV2/capi-rdb-oh-rdb-configv2.md>)\*rdbConfig) | 设置[OH\_Retrieval\_DbConfig](dataaugmentation-capi-retrieval.md#oh_retrieval_dbconfig)中的数据库配置。 |
...
[OH\_Retrieval\_Config](dataaugmentation-capi-retrieval.md#oh_retrieval_config)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)
...
[OH\_Retrieval\_Retriever](dataaugmentation-capi-retrieval.md#oh_retrieval_retriever)、[OH\_Retrieval\_Config](dataaugmentation-capi-retrieval.md#oh_retrieval_config)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)
...
[OH\_Retrieval\_Condition](dataaugmentation-capi-retrieval.md#oh_retrieval_condition)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)、[OH\_Retrieval\_CreateCondition](dataaugmentation-capi-retrieval.md#oh_retrieval_createcondition)
...
[OH\_Retrieval\_Config](dataaugmentation-capi-retrieval.md#oh_retrieval_config)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)、[OH\_Retrieval\_CreateConfig](dataaugmentation-capi-retrieval.md#oh_retrieval_createconfig)
...
[OH\_Retrieval\_DbConfig](dataaugmentation-capi-retrieval.md#oh_retrieval_dbconfig)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)、[OH\_Retrieval\_CreateDbConfig](dataaugmentation-capi-retrieval.md#oh_retrieval_createdbconfig)
...
[OH\_Retrieval\_Query](dataaugmentation-capi-retrieval.md#oh_retrieval_query)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)、[OH\_Retrieval\_CreateQuery](dataaugmentation-capi-retrieval.md#oh_retrieval_createquery)
...
[OH\_Retrieval\_Record](dataaugmentation-capi-retrieval.md#oh_retrieval_record)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)、[OH\_Retrieval\_Retrieve](dataaugmentation-capi-retrieval.md#oh_retrieval_retrieve)
...
[OH\_Retrieval\_Retriever](dataaugmentation-capi-retrieval.md#oh_retrieval_retriever)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)、[OH\_Retrieval\_CreateRetriever](dataaugmentation-capi-retrieval.md#oh_retrieval_createretriever)
...
[OH\_Retrieval\_SubCondition](dataaugmentation-capi-retrieval.md#oh_retrieval_subcondition)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)
...
[OH\_Retrieval\_VectorCondition](dataaugmentation-capi-retrieval.md#oh_retrieval_vectorcondition)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)、[OH\_Retrieval\_CreateVectorCondition](dataaugmentation-capi-retrieval.md#oh_retrieval_createvectorcondition)
...
[OH\_Retrieval\_RecordItem](dataaugmentation-capi-retrieval.md#oh_retrieval_recorditem)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)
...
[OH\_Retrieval\_Record](dataaugmentation-capi-retrieval.md#oh_retrieval_record)、[OH\_Retrieval\_RecordItem](dataaugmentation-capi-retrieval.md#oh_retrieval_recorditem)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)
...
[OH\_Retrieval\_Record](dataaugmentation-capi-retrieval.md#oh_retrieval_record)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)
...
| --- | --- |
| dbConfig | 表示指向[OH\_Retrieval\_DbConfig](dataaugmentation-capi-retrieval.md#oh_retrieval_dbconfig)实例的指针。 |
| rdbConfig | 表示指向数据库配置实例的指针，可能是[OH\_Rdb\_ConfigV2](<../../../../ArkData（方舟数据管理）/C API/结构体/OH_Rdb_ConfigV2/capi-rdb-oh-rdb-configv2.md>)实例。 |
...
[OH\_Retrieval\_DbConfig](dataaugmentation-capi-retrieval.md#oh_retrieval_dbconfig)、[OH\_Rdb\_ConfigV2](<../../../../ArkData（方舟数据管理）/C API/结构体/OH_Rdb_ConfigV2/capi-rdb-oh-rdb-configv2.md>)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)
...
[OH\_Retrieval\_Query](dataaugmentation-capi-retrieval.md#oh_retrieval_query)、[OH\_Aip\_ErrCode](../AIP/dataaugmentation-capi-aip.md#oh_aip_errcode-1)
