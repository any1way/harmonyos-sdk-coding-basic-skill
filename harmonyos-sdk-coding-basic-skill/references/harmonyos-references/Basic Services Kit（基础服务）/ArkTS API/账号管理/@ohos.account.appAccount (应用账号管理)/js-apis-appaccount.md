...
scraped_at: 2026-06-11T16:16:37+08:00
doc_updated_at: 2026-05-28
content_hash: sha256:94d49f802dc1fdb5cbc5f2433fac4661dc8c9d5e176e30c5466fef8d2879d4ef
---
...
以下错误码的详细介绍请参见[账号管理错误码](../../../错误码/账号管理错误码/errorcode-account.md)和[通用错误码](../../../../../通用错误码/errorcode-universal.md)。
...
以下错误码的详细介绍请参见[账号管理错误码](../../../错误码/账号管理错误码/errorcode-account.md)。
...
从API version 8开始支持，从API version 9开始废弃。相关信息建议查看[账号管理错误码](../../../错误码/账号管理错误码/errorcode-account.md)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [Want](<../../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 用于跳转的请求信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [rpc.RemoteObject](<../../../../../IPC Kit（进程间通信服务）/ArkTS API/@ohos.rpc (RPC通信)/js-apis-rpc.md#remoteobject>) | 认证器Authenticator的远程对象。用于跨进程通信。 |
