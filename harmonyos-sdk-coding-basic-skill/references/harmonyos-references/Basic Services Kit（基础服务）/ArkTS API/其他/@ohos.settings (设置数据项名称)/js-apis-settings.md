...
scraped_at: 2026-06-11T16:17:45+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:451f68321402c390d4120c465dfffd1df083bbaef42f28687f972308ffe3e0a4
---
本模块提供访问设置数据项的能力。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | Context | 是 | 应用上下文（仅支持UIAbilityContext和ExtensionContext）。  Stage模型的应用Context定义见[Context](<../../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>)。 |
...
以下错误码详细介绍请参考[设置数据项错误码](../../../错误码/设置数据项错误码/errorcode-settings.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataAbilityHelper | [DataAbilityHelper](<../../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/ability/DataAbilityHelper/js-apis-inner-ability-dataabilityhelper.md>) | 是 | 数据管理辅助类。 |
| name | string | 是 | 数据项的名称。数据项名称分为以下两种：  - 上述任意一个数据库中已存在的数据项。  - 开发者自行添加的数据项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | Context | 是 | 应用上下文（仅支持UIAbilityContext和UIExtensionContext）。  Stage模型的应用Context定义见[Context](<../../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>)。 |
...
| inputMethodId | string | 是 | 输入法扩展在应用内唯一标识[id](<../../../../../IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethod (输入法框架)/js-apis-inputmethod.md#inputmethodproperty8>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [Context](<../../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>) | 是 | 应用上下文（仅支持UIAbilityContext和ExtensionContext）。  Stage模型的应用Context定义见[Context](<../../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>)。 |
...
5. const context: Context = this.getUIContext().getHostContext() as common.UIAbilityContext;
6. try {
7. settings.openDoubleClickSettingsPage(context);
8. } catch (err) {
9. console.error(`Failed to open the DoubleClick settings page. code: ${err?.code}, message: ${err?.message}`);
10. }
```
...
3. settings.isDoubleClickAppForSelf().then((result: boolean) => {
4. console.info(`isDoubleClickAppForSelf result: ${result}`);
5. })
```
