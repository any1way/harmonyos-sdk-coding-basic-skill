...
scraped_at: 2026-06-11T16:17:46+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:6f45570c978a5ce4a1534e0f70f5cd7890d909d11571b0f9f9899c3d64912f01
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | string | [image.PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | JPEG或PNG文件的Uri路径，或者PNG格式文件的位图。 |
| wallpaperType | [WallpaperType](js-apis-wallpaper.md#wallpapertype7) | 是 | 壁纸类型。 |
