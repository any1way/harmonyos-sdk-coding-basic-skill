...
scraped_at: 2026-06-11T16:17:02+08:00
doc_updated_at: 2026-05-08
content_hash: sha256:6fffb463b589693a00cec864ee5a22d0c602e9a9aa3979a212dd3a95cfdb20b2
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| extensionList | Array<string> | 是 | 要加载的[打印扩展能力](<../@ohos.app.ability.PrintExtensionAbility (打印扩展能力)/js-apis-app-ability-printextensionability.md>)列表，列表成员为打印扩展能力的包名，空列表表示加载所有扩展能力。 |
...
| description | string | 否 | 是 | 表示打印机说明。 |
| capability | [PrinterCapability](js-apis-print.md#printercapability24) | 否 | 是 | 表示打印机功能。 |
| options | Object | 否 | 是 | 表示JSON对象字符串。 |
...
| pageRange | [PrinterRange](js-apis-print.md#printerrange24) | 否 | 否 | 表示打印范围大小。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [WatermarkCallback](js-apis-print.md#printwatermarkcallback24) | 否 | 表示注册监听强制水印处理时使用的回调类型。 |
