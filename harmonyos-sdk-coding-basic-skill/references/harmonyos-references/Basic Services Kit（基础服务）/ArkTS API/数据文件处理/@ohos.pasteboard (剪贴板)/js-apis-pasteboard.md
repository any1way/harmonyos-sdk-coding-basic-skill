...
scraped_at: 2026-06-11T16:17:04+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:53442bb357a87ac898efed80b07a8e3d110d05d858fdfae24590f7c259da0673
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | Want内容。 |
...
| want | [Want](<../../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 否 | Want内容。 |
| mimeType | string | 是 | 否 | 默认数据类型。 |
| plainText | string | 是 | 否 | 纯文本内容。 |
| uri | string | 是 | 否 | URI内容。 |
| pixelMap9+ | [image.PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 否 | PixelMap内容。 |
...
以下错误码的详细介绍请参见[通用错误码](../../../../../通用错误码/errorcode-universal.md)和见[剪贴板错误码](../../../错误码/剪贴板错误码/errorcode-pasteboard.md)。
...
| 类型 | 说明 |
| --- | --- |
| [Want](<../../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | Want对象内容。剪贴板内容对象中没有Want内容时，默认返回为undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [image.PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | PixelMap内容。剪贴板内容对象中没有PixelMap内容时，默认返回为undefined。 |
...
以下错误码的详细介绍请参见[通用错误码](../../../../../通用错误码/errorcode-universal.md)和[剪贴板错误码](../../../错误码/剪贴板错误码/errorcode-pasteboard.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | Want对象内容。 |
...
以下错误码的详细介绍请参见[剪贴板错误码](../../../错误码/剪贴板错误码/errorcode-pasteboard.md)。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[unifiedDataChannel.UnifiedData](<../../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#unifieddata>)> | Promise对象，返回系统剪贴板数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [unifiedDataChannel.UnifiedData](<../../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#unifieddata>) | 返回系统剪贴板数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [unifiedDataChannel.UnifiedData](<../../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#unifieddata>) | 是 | 需要写入剪贴板中的数据。 |
