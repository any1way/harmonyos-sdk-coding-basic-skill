...
scraped_at: 2026-06-11T16:18:01+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:09803a018fd6be5d65e221416550bc0ab3d281f298983c3a8ca3d312650df678
---
system.request部件主要给应用提供上传下载文件的基础能力。

说明

* 从API Version 9开始所有接口不再维护，推荐使用新接口[@ohos.request](<../../数据文件处理/@ohos.request (上传下载)/js-apis-request.md>)。
...
从API version 3 开始支持，从API version 9 开始废弃，建议使用[request.uploadFile](<../../数据文件处理/@ohos.request (上传下载)/js-apis-request.md#requestuploadfile9>)替代。
...
从API version 3 开始支持，从API version 9 开始废弃，建议使用[UploadConfig](<../../数据文件处理/@ohos.request (上传下载)/js-apis-request.md#uploadconfig>)替代。
