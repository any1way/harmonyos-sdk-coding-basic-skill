...
scraped_at: 2026-06-11T16:18:04+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:2761a2374296d548f6beee3c155ff6dac78869d4e03d71826eaece610d72dc7d
---
本模块主要由系统时间和系统时区功能组成。开发者可以设置、获取系统时间及系统时区。

说明

* 从API Version 9 开始，该模块接口不再维护，推荐使用新模块接口[@ohos.systemDateTime (系统时间、时区)](<../../其他/@ohos.systemDateTime (系统时间、时区)/js-apis-date-time.md>)。
...
从API version 8开始支持，从API version 9开始废弃。建议使用[systemDateTime.getTime](<../../其他/@ohos.systemDateTime (系统时间、时区)/js-apis-date-time.md#systemdatetimegettime10>)替代。
...
以下错误码的详细介绍请参见[时间时区服务错误码](../../../错误码/时间时区服务错误码/errorcode-time.md)。
...
从API version 8开始支持，从API version 9开始废弃。建议使用[systemDateTime.getUptime](<../../其他/@ohos.systemDateTime (系统时间、时区)/js-apis-date-time.md#systemdatetimegetuptime10>)替代。
...
从API version 8开始支持，从API version 9开始废弃。建议使用[systemDateTime.getTimezone](<../../其他/@ohos.systemDateTime (系统时间、时区)/js-apis-date-time.md#systemdatetimegettimezone>)替代。
...
从API version 8开始支持，从API version 9开始废弃。建议使用[systemDateTime.getTimezone](<../../其他/@ohos.systemDateTime (系统时间、时区)/js-apis-date-time.md#systemdatetimegettimezone-1>)替代。
