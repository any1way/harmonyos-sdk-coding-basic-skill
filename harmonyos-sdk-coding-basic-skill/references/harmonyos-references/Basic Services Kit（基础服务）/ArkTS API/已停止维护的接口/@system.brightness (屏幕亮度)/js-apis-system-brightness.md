...
scraped_at: 2026-06-11T16:17:56+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:5e18d3b766dd4f9453b9bf4aa2d8994a97ec270065d73c5119dde5ebb2c3b76d
---
...
3. console.info('success get brightness value:' + data.value);
4. },
...
2. value: 100,
3. success: () => {
4. console.info('handling set brightness success.');
5. },
...
3. console.info('success get mode:' + data.mode);
4. },
5. fail: (data: string, code: number) => {
...
2. mode: 1,
3. success: () => {
4. console.info('handling set mode success.');
5. },
6. fail: (data: string, code: number) => {
...
除Lite Wearable外，从API version 7开始不再维护，建议使用[window.setWindowKeepScreenOn()](<../../../../../ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setwindowkeepscreenon9>)替代。
...
2. keepScreenOn: true,
3. success: () => {
4. console.info('handling set keep screen on success.');
5. },
6. fail: (data: string, code: number) => {
