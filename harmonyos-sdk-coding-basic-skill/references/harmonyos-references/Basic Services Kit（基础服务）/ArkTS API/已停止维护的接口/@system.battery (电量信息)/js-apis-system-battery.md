...
scraped_at: 2026-06-11T16:17:59+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:5cf8812b1d20efdfa2279e43aaa0507f067f22dc115769adef514574019c9d58
---
该模块提供充电状态及剩余电量的查询功能。
...
* 模块维护策略：
  ...
  - 对于支持该模块的其他设备类型，该模块从API Version 6开始不再维护，建议使用[@ohos.batteryInfo](<../../设备管理/@ohos.batteryInfo (电量信息)/js-apis-battery-info.md>)替代。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| charging | boolean | 否 | 否 | 当前电池是否在充电中。true表示在充电，false表示没有充电，默认为false。  **说明：** 除Lite Wearable外，从API Version 6开始不再维护，建议使用[batteryInfo.chargingStatus](<../../设备管理/@ohos.batteryInfo (电量信息)/js-apis-battery-info.md#常量>)替代。 |
| level | number | 否 | 否 | 当前电池的电量，取值范围：0.00 - 1.00 。  **说明：** 除Lite Wearable外，从API Version 6开始不再维护，建议使用[batteryInfo.batterySOC](<../../设备管理/@ohos.batteryInfo (电量信息)/js-apis-battery-info.md#常量>)替代。 |
