...
breadcrumb: API参考 > 系统 > 基础功能 > Basic Services Kit（基础服务） > ArkTS API > 已停止维护的接口 > @ohos.commonEvent (公共事件模块)(已废弃)
category: harmonyos-references
scraped_at: 2026-06-11T16:17:54+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:f6d8b89a5bc86a15c4c9ee0ef4c2bb2e2e904eee6ea7d19cf942deb12949644d
---
本模块提供了公共事件的能力，包括公共事件的权限列表，发布公共事件，订阅或取消订阅公共事件，获取或修改公共事件结果代码、结果数据等。

说明

* 从API Version 9开始，该接口不再维护，推荐使用新接口[@ohos.commonEventManager](<../../进程线程通信/@ohos.commonEventManager (公共事件模块)/js-apis-commoneventmanager.md>)。
...
全部系统公共事件枚举定义请参见[系统公共事件定义](../系统公共事件定义(待停用)/commonevent-definitions.md)。
...
从 API version 7开始支持，从API version 9开始废弃。建议使用[commonEventManager.publish](<../../进程线程通信/@ohos.commonEventManager (公共事件模块)/js-apis-commoneventmanager.md#commoneventmanagerpublish>)替代。
...
从 API version 7开始支持，从API version 9开始废弃。建议使用[commonEventManager.publish](<../../进程线程通信/@ohos.commonEventManager (公共事件模块)/js-apis-commoneventmanager.md#commoneventmanagerpublish-1>)替代。
...
| options | [CommonEventPublishData](../../进程线程通信/commonEvent/CommonEventPublishData/js-apis-inner-commonevent-commoneventpublishdata.md) | 是 | 表示发布公共事件的属性。 |
| callback | AsyncCallback<void> | 是 | 表示指定的回调方法。 |
...
从 API version 7开始支持，从API version 9开始废弃。建议使用[commonEventManager.createSubscriber](<../../进程线程通信/@ohos.commonEventManager (公共事件模块)/js-apis-commoneventmanager.md#commoneventmanagercreatesubscriber>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| subscribeInfo | [CommonEventSubscribeInfo](../../进程线程通信/commonEvent/CommonEventSubscribeInfo/js-apis-inner-commonevent-commoneventsubscribeinfo.md) | 是 | 表示订阅信息。 |
| callback | AsyncCallback<[CommonEventSubscriber](../../进程线程通信/commonEvent/commonEventSubscriber/js-apis-inner-commonevent-commoneventsubscriber.md)> | 是 | 表示创建订阅者的回调方法。 |
...
从 API version 7开始支持，从API version 9开始废弃。建议使用[commonEventManager.createSubscriber](<../../进程线程通信/@ohos.commonEventManager (公共事件模块)/js-apis-commoneventmanager.md#commoneventmanagercreatesubscriber-1>)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[CommonEventSubscriber](../../进程线程通信/commonEvent/commonEventSubscriber/js-apis-inner-commonevent-commoneventsubscriber.md)> | 返回订阅者对象。 |
...
从 API version 7开始支持，从API version 9开始废弃。建议使用[commonEventManager.subscribe](<../../进程线程通信/@ohos.commonEventManager (公共事件模块)/js-apis-commoneventmanager.md#commoneventmanagersubscribe>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| subscriber | [CommonEventSubscriber](../../进程线程通信/commonEvent/commonEventSubscriber/js-apis-inner-commonevent-commoneventsubscriber.md) | 是 | 表示订阅者对象。 |
| callback | AsyncCallback<[CommonEventData](../../进程线程通信/commonEvent/CommonEventData/js-apis-inner-commonevent-commoneventdata.md)> | 是 | 表示接收公共事件数据的回调函数。 |
...
从 API version 7开始支持，从API version 9开始废弃。建议使用[commonEventManager.unsubscribe](<../../进程线程通信/@ohos.commonEventManager (公共事件模块)/js-apis-commoneventmanager.md#commoneventmanagerunsubscribe>)替代。
