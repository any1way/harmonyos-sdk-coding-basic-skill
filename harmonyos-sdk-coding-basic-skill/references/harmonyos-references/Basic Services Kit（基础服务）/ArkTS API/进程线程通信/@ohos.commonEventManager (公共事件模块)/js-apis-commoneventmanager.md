...
scraped_at: 2026-06-11T16:17:31+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:57c2cce4bdc1c4fd380be56c70e5b78eba45a33dfedcc6c1b746bd88cd07e9a5
---
...
系统公共事件是指由系统服务或系统应用发布的事件，订阅这些公共事件需要特定的权限、使用相应的值，详见[系统定义的公共事件](../系统定义的公共事件/commoneventmanager-definitions.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | string | 是 | 表示要发送的公共事件。详见[系统定义的公共事件](../系统定义的公共事件/commoneventmanager-definitions.md)。 |
| callback | AsyncCallback<void> | 是 | 回调函数。当公共事件发布成功时，err为undefined，否则为错误对象。 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码](../../../../../通用错误码/errorcode-universal.md)和[事件错误码](../../../错误码/事件错误码/errorcode-commoneventservice.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | string | 是 | 表示要发布的公共事件。详见[系统定义的公共事件](../系统定义的公共事件/commoneventmanager-definitions.md)。 |
| options | [CommonEventPublishData](../commonEvent/CommonEventPublishData/js-apis-inner-commonevent-commoneventpublishdata.md) | 是 | 表示发布公共事件的属性。 |
| callback | AsyncCallback<void> | 是 | 回调函数。当公共事件发布成功时，err为undefined，否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| subscribeInfo | [CommonEventSubscribeInfo](../commonEvent/CommonEventSubscribeInfo/js-apis-inner-commonevent-commoneventsubscribeinfo.md) | 是 | 表示订阅信息。 |
| callback | AsyncCallback<[CommonEventSubscriber](../commonEvent/commonEventSubscriber/js-apis-inner-commonevent-commoneventsubscriber.md#commoneventsubscriber-1)> | 是 | 回调函数。当公共事件订阅者创建成功时，err为undefined，否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[CommonEventSubscriber](../commonEvent/commonEventSubscriber/js-apis-inner-commonevent-commoneventsubscriber.md#commoneventsubscriber-1)> | Promise对象，返回创建成功的订阅者对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [CommonEventSubscriber](../commonEvent/commonEventSubscriber/js-apis-inner-commonevent-commoneventsubscriber.md#commoneventsubscriber-1) | 返回订阅者对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| subscriber | [CommonEventSubscriber](../commonEvent/commonEventSubscriber/js-apis-inner-commonevent-commoneventsubscriber.md#commoneventsubscriber-1) | 是 | 表示订阅者对象。 |
| callback | AsyncCallback<[CommonEventData](../commonEvent/CommonEventData/js-apis-inner-commonevent-commoneventdata.md)> | 是 | 回调函数。当公共事件订阅成功后，事件触发时执行的回调函数；否则订阅失败时，err为错误对象。 |
...
| --- | --- | --- | --- |
| subscriber | [CommonEventSubscriber](../commonEvent/commonEventSubscriber/js-apis-inner-commonevent-commoneventsubscriber.md#commoneventsubscriber-1) | 是 | 表示订阅者对象。 |
| callback | Callback<[CommonEventData](../commonEvent/CommonEventData/js-apis-inner-commonevent-commoneventdata.md)> | 是 | 表示接收公共事件数据的回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_CommonEventData](../commonEvent/CommonEventData/js-apis-inner-commonevent-commoneventdata.md) | 表示公共事件的数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_CommonEventSubscriber](../commonEvent/commonEventSubscriber/js-apis-inner-commonevent-commoneventsubscriber.md#commoneventsubscriber-1) | 描述公共事件的订阅者。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_CommonEventSubscribeInfo](../commonEvent/CommonEventSubscribeInfo/js-apis-inner-commonevent-commoneventsubscribeinfo.md) | 用于表示订阅者的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_CommonEventPublishData](../commonEvent/CommonEventPublishData/js-apis-inner-commonevent-commoneventpublishdata.md) | 描述公共事件内容和属性。 |
