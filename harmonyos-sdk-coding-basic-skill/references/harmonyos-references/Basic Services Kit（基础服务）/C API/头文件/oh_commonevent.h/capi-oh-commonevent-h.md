...
scraped_at: 2026-06-11T16:18:20+08:00
doc_updated_at: 2026-03-17
content_hash: sha256:f0eadb9d958bc6e9a76d059a38bd4e60df2cd6077b66c8e02414bd746ec46cdd
---
## 概述
...
**相关模块：** [OH\_CommonEvent](../../模块/OH_CommonEvent/capi-oh-commonevent.md)
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [CommonEvent\_SubscribeInfo](../../结构体/CommonEvent_SubscribeInfo/capi-oh-commonevent-commonevent-subscribeinfo.md) | CommonEvent\_SubscribeInfo | 提供CommonEvent\_SubscribeInfo订阅者信息结构体声明。 |
| [CommonEvent\_PublishInfo](../../结构体/CommonEvent_PublishInfo/capi-oh-commonevent-commonevent-publishinfo.md) | CommonEvent\_PublishInfo | 发布公共事件时使用的公共事件属性对象。 |
| [CommonEvent\_RcvData](../../结构体/CommonEvent_RcvData/capi-oh-commonevent-commonevent-rcvdata.md) | CommonEvent\_RcvData | 提供CommonEvent\_RcvData公共事件回调数据结构体声明。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [CommonEvent\_RcvData](../../结构体/CommonEvent_RcvData/capi-oh-commonevent-commonevent-rcvdata.md) \*data | 公共事件回调数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [CommonEvent\_SubscribeInfo](../../结构体/CommonEvent_SubscribeInfo/capi-oh-commonevent-commonevent-subscribeinfo.md)\* | 成功则返回订阅者信息,失败则返回NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [CommonEvent\_SubscribeInfo](../../结构体/CommonEvent_SubscribeInfo/capi-oh-commonevent-commonevent-subscribeinfo.md)\* info | 订阅者信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [CommonEvent\_SubscribeInfo](../../结构体/CommonEvent_SubscribeInfo/capi-oh-commonevent-commonevent-subscribeinfo.md)\* info | 订阅者信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [CommonEvent\_RcvData](../../结构体/CommonEvent_RcvData/capi-oh-commonevent-commonevent-rcvdata.md)\* rcvData | 公共事件回调数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [CommonEvent\_PublishInfo](../../结构体/CommonEvent_PublishInfo/capi-oh-commonevent-commonevent-publishinfo.md)\* | 创建的公共事件属性对象，创建失败时，返回null。 |
...
| 参数项 | 描述 |
| --- | --- |
| [CommonEvent\_PublishInfo](../../结构体/CommonEvent_PublishInfo/capi-oh-commonevent-commonevent-publishinfo.md)\* info | 要销毁的公共事件属性对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [CommonEvent\_PublishInfo](../../结构体/CommonEvent_PublishInfo/capi-oh-commonevent-commonevent-publishinfo.md)\* info | 公共事件属性对象。 |
...
| --- | --- |
| const char\* event | 公共事件名称。 |
| const [CommonEvent\_PublishInfo](../../结构体/CommonEvent_PublishInfo/capi-oh-commonevent-commonevent-publishinfo.md)\* info | 设置的公共事件属性。 |
