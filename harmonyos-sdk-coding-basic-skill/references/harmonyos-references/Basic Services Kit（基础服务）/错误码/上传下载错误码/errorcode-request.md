...
content_hash: sha256:19426225aad7d0d00d28c4acfcdbdcd5bf5a1ff7c5fa6471f2340e3c1d0554fc
---
说明
...
该错误码表示文件操作异常，可能原因是文件权限不足。具体原因可参考[BusinessError](<../../ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#businesserror>)中的错误信息message。
