...
scraped_at: 2026-06-11T16:15:13+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:b6b388cd959c7e7c1fed334ead1302fa1f2f52805ce5c44cbf0b687e71d3f73d
---
## 概述
...
| 名称 | 描述 |
| --- | --- |
| [network\_boost\_handover.h](../../头文件/network_boost_handover.h/network-boost-c-files-handover.md) | 声明用于连接迁移的API。提供基本的函数，结构体和const定义。 |
| [network\_boost\_quality.h](../../头文件/network_boost_quality.h/network-boost-c-files-quality.md) | 声明用于网络质量的API。提供基本的函数，结构体和const定义。 |
| [network\_boost.h](../../头文件/network_boost.h/network-boost-c-files-boost.md) | 声明用于网络加速的API。提供基本的函数，结构体和const定义。 |
...
| 名称 | 描述 |
| --- | --- |
| struct [NetworkBoost\_DataSpeedAction](../../结构体/NetworkBoost_DataSpeedAction/network-boost-c-struct-data_speed_action.md) | 发包速率建议。 |
| struct [NetworkBoost\_NetHandle](../../结构体/NetworkBoost_NetHandle/network-boost-c-struct-net_handle.md) | NetHandle信息。 |
...
| struct [HMS\_NetworkBoost\_HandoverCallback](../../结构体/HMS_NetworkBoost_HandoverCallback/network-boost-c-struct-handover_callback.md) | 连接迁移回调信息。 |
| struct [NetworkBoost\_NetworkQos](../../结构体/NetworkBoost_NetworkQos/network-boost-c-struct-network_qos.md) | 单条路径的网络质量回调信息。 |
| struct [NetworkBoost\_NetworkQosArray](../../结构体/NetworkBoost_NetworkQosArray/network-boost-c-struct-network_qos_array.md) | 多条路径的网络质量回调信息。 |
| struct [NetworkBoost\_WeakSignalPrediction](../../结构体/NetworkBoost_WeakSignalPrediction/network-boost-c-struct-weak_signal_prediction.md) | 弱信号预测相关信息。 |
| struct [NetworkBoost\_NetworkScene](../../结构体/NetworkBoost_NetworkScene/network-boost-c-struct-network_scene.md) | 网络场景状态变更回调信息。 |
...
| typedef struct [NetworkBoost\_DataSpeedAction](../../结构体/NetworkBoost_DataSpeedAction/network-boost-c-struct-data_speed_action.md) [NetworkBoost\_DataSpeedAction](network-boost-c-overview.md#networkboost_dataspeedaction) | 发包速率建议。 |
| typedef struct [NetworkBoost\_NetHandle](../../结构体/NetworkBoost_NetHandle/network-boost-c-struct-net_handle.md) [NetworkBoost\_NetHandle](network-boost-c-overview.md#networkboost_nethandle) | NetHandle信息。 |
| typedef struct [NetworkBoost\_HandoverStart](../../结构体/NetworkBoost_HandoverStart/network-boost-c-struct-handover_start.md) [NetworkBoost\_HandoverStart](network-boost-c-overview.md#networkboost_handoverstart) | 连接迁移开始信息。 |
| typedef struct [NetworkBoost\_HandoverComplete](../../结构体/NetworkBoost_HandoverComplete/network-boost-c-struct-handover_complete.md) [NetworkBoost\_HandoverComplete](network-boost-c-overview.md#networkboost_handovercomplete) | 连接迁移完成信息。 |
...
| typedef void(\* [HMS\_NetworkBoost\_OnHandoverStart](network-boost-c-overview.md#hms_networkboost_onhandoverstart)) ([NetworkBoost\_HandoverStart](../../结构体/NetworkBoost_HandoverStart/network-boost-c-struct-handover_start.md) \*handoverStart) | 连接迁移开始的回调函数原型。 |
| typedef void(\* [HMS\_NetworkBoost\_OnHandoverComplete](network-boost-c-overview.md#hms_networkboost_onhandovercomplete)) ([NetworkBoost\_HandoverComplete](../../结构体/NetworkBoost_HandoverComplete/network-boost-c-struct-handover_complete.md) \*handoverComplete) | 连接迁移结束的回调函数原型。 |
| typedef struct [HMS\_NetworkBoost\_HandoverCallback](../../结构体/HMS_NetworkBoost_HandoverCallback/network-boost-c-struct-handover_callback.md) [HMS\_NetworkBoost\_HandoverCallback](network-boost-c-overview.md#hms_networkboost_handovercallback) | 连接迁移回调注册函数的参数，包含连接迁移开始和完成的回调函数。 |
...
| typedef struct [NetworkBoost\_NetworkQos](../../结构体/NetworkBoost_NetworkQos/network-boost-c-struct-network_qos.md) [NetworkBoost\_NetworkQos](network-boost-c-overview.md#networkboost_networkqos) | 单条路径的网络质量回调信息。 |
| typedef struct [NetworkBoost\_NetworkQosArray](../../结构体/NetworkBoost_NetworkQosArray/network-boost-c-struct-network_qos_array.md) [NetworkBoost\_NetworkQosArray](network-boost-c-overview.md#networkboost_networkqosarray) | 多条路径的网络质量回调信息。 |
| typedef struct [NetworkBoost\_WeakSignalPrediction](../../结构体/NetworkBoost_WeakSignalPrediction/network-boost-c-struct-weak_signal_prediction.md) [NetworkBoost\_WeakSignalPrediction](network-boost-c-overview.md#networkboost_weaksignalprediction) | 弱信号预测相关信息。 |
| typedef struct [NetworkBoost\_NetworkScene](../../结构体/NetworkBoost_NetworkScene/network-boost-c-struct-network_scene.md) [NetworkBoost\_NetworkScene](network-boost-c-overview.md#networkboost_networkscene) | 网络场景状态变更回调信息。 |
| typedef void(\* [HMS\_NetworkBoost\_NetQosChange](network-boost-c-overview.md#hms_networkboost_netqoschange)) ([NetworkBoost\_NetworkQosArray](../../结构体/NetworkBoost_NetworkQosArray/network-boost-c-struct-network_qos_array.md) \*networkQosArray) | 网络质量变更回调函数原型。 |
| typedef void(\* [HMS\_NetworkBoost\_NetSceneChange](network-boost-c-overview.md#hms_networkboost_netscenechange)) ([NetworkBoost\_NetworkScene](../../结构体/NetworkBoost_NetworkScene/network-boost-c-struct-network_scene.md) \*networkScene) | 网络场景状态变更回调函数原型。 |
| typedef void (\* [HMS\_NetworkBoost\_OnMultiPathRequestResult](network-boost-c-overview.md#hms_networkboost_onmultipathrequestresult))([NetworkBoost\_MultiPathRequestResult](../../结构体/NetworkBoost_MultiPathRequestResult/network-boost-c-struct-multipath_req_result.md)\* result) | 多网请求结果回调函数原型。 |
| typedef void (\* [HMS\_NetworkBoost\_OnMultiPathStateChange](network-boost-c-overview.md#hms_networkboost_onmultipathstatechange))([NetworkBoost\_MultiPathStateChange](../../结构体/NetworkBoost_MultiPathStateChange/network-boost-c-struct-multipath_statechange.md)\* multiPathState) | 多网状态变化回调函数原型。 |
| typedef void (\* [HMS\_NetworkBoost\_OnMultiPathRecommendation](network-boost-c-overview.md#hms_networkboost_onmultipathrecommendation))([NetworkBoost\_MultiPathRecommendation](../../结构体/NetworkBoost_MultiPathRecommendation/network-boost-c-struct-multipath_reco.md)\* recommendation) | 系统多网建议变化回调函数原型。 |
...
| 名称 | 描述 |
| --- | --- |
| int32\_t [HMS\_NetworkBoost\_RegisterHandoverChangeCallback](network-boost-c-overview.md#hms_networkboost_registerhandoverchangecallback) ([HMS\_NetworkBoost\_HandoverCallback](../../结构体/HMS_NetworkBoost_HandoverCallback/network-boost-c-struct-handover_callback.md) \*callback, uint32\_t \*callbackId) | 注册连接迁移回调。 |
...
| int32\_t [HMS\_NetworkBoost\_GetMultiPathQuotaStats](network-boost-c-overview.md#hms_networkboost_getmultipathquotastats)([NetworkBoost\_MultiPathQuota](../../结构体/NetworkBoost_MultiPathQuota/network-boost-c-struct-multipath_quota.md) \*quota) | 获取当前应用多网使用的配额，包括已使用的配额信息和剩余配额信息。 |
...
| int32\_t [HMS\_NetworkBoost\_SetSceneDesc](network-boost-c-overview.md#hms_networkboost_setscenedesc)([NetworkBoost\_SceneDesc](../../结构体/NetworkBoost_SceneDesc/network-boost-c-struct-scene_desc.md) sceneDesc) | 设置业务场景。 |
