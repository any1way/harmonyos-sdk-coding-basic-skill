...
scraped_at: 2026-06-01T16:07:59+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:a3df099bc97e9c01b44c935cc5c31682044260386660fd0f725583d8bd02828a
---
...
涉及错误码均为通用错误码，[通用错误码详细描述查看](../../../../通用错误码/errorcode-universal.md)。
...
以下错误码的详细介绍请参见[ArkTS API错误码](<../ArkTS API错误码/networkboost-arkts-errorcode.md>)和[通用错误码](../../../../通用错误码/errorcode-universal.md)。
...
| newNetHandle | [connection.NetHandle](<../../../Network Kit（网络服务）/ArkTS API/@ohos.net.connection (网络连接管理)/js-apis-net-connection.md#nethandle>) | 否 | 是 | 新链路的NetHandle信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| dataSpeedSimpleAction | [netQuality.DataSpeedSimpleAction](../netQuality（网络质量）/networkboost-netquality.md#dataspeedsimpleaction) | 否 | 否 | 应用发包策略的简单建议。 |
| linkUpBandwidth | [netQuality.RateBps](../netQuality（网络质量）/networkboost-netquality.md#ratebps) | 否 | 否 | 老链路上行带宽。 |
| linkDownBandwidth | [netQuality.RateBps](../netQuality（网络质量）/networkboost-netquality.md#ratebps) | 否 | 否 | 老链路下行带宽。 |
...
| netHandle | [connection.NetHandle](<../../../Network Kit（网络服务）/ArkTS API/@ohos.net.connection (网络连接管理)/js-apis-net-connection.md#nethandle>) | 否 | 否 | 多网链路的netHandle。 |
| pathState | [PathState](networkboost-nethandover.md#pathstate) | 否 | 否 | 多网链路状态。 |
| pathType | [netQuality.PathType](../netQuality（网络质量）/networkboost-netquality.md#pathtype) | 否 | 否 | 多网链路类型。 |
