...
content_hash: sha256:3bbf6e24f306408cae97417e9d431a59a120f48bfe8fc0ab05fc0b26521376b2
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [InputMethod\_InputMethodProxy](../../结构体/InputMethod_InputMethodProxy/capi-inputmethod-inputmethod-inputmethodproxy.md) | InputMethod\_InputMethodProxy | 输入法代理对象。使用此对象可以用于调用使用输入法的方法。 |
...
| 参数项 | 描述 |
| --- | --- |
| [InputMethod\_InputMethodProxy](../../结构体/InputMethod_InputMethodProxy/capi-inputmethod-inputmethod-inputmethodproxy.md) \*inputMethodProxy | 表示指向[InputMethod\_InputMethodProxy](../../结构体/InputMethod_InputMethodProxy/capi-inputmethod-inputmethod-inputmethodproxy.md)实例的指针。inputMethodProxy由调用[OH\_InputMethodController\_Attach](../inputmethod_controller_capi.h/capi-inputmethod-controller-capi-h.md#oh_inputmethodcontroller_attach)获取。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [InputMethod\_ErrorCode](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) | 返回一个特定的错误码。  [IME\_ERR\_OK](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) - 表示成功。  [IME\_ERR\_IMCLIENT](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) - 输入法客户端错误。  [IME\_ERR\_IMMS](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) - 输入法服务错误。  [IME\_ERR\_DETACHED](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) - 未绑定输入法。  [IME\_ERR\_NULL\_POINTER](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) - 非预期的空指针。  具体错误码可以参考[InputMethod\_ErrorCode](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode)。 |
...
| --- | --- |
| [InputMethod\_InputMethodProxy](../../结构体/InputMethod_InputMethodProxy/capi-inputmethod-inputmethod-inputmethodproxy.md) \*inputMethodProxy | 表示指向[InputMethod\_InputMethodProxy](../../结构体/InputMethod_InputMethodProxy/capi-inputmethod-inputmethod-inputmethodproxy.md)实例的指针。inputMethodProxy由调用[OH\_InputMethodController\_Attach](../inputmethod_controller_capi.h/capi-inputmethod-controller-capi-h.md#oh_inputmethodcontroller_attach)获取。 |
| [InputMethod\_AttachOptions](../../结构体/InputMethod_AttachOptions/capi-inputmethod-inputmethod-attachoptions.md) \*options | 表示指向[InputMethod\_AttachOptions](../../结构体/InputMethod_AttachOptions/capi-inputmethod-inputmethod-attachoptions.md)实例的指针，用于获取配置选项。  此接口中只需关注[InputMethod\_RequestKeyboardReason](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_requestkeyboardreason) - 表示请求键盘输入的原因。 |
...
| 类型 | 说明 |
| --- | --- |
| [InputMethod\_ErrorCode](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) | 返回一个特定的错误码。  [IME\_ERR\_OK](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) - 表示成功。  [IME\_ERR\_PARAMCHECK](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) - 表示参数错误。  [IME\_ERR\_IMCLIENT](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) - 输入法客户端错误。  [IME\_ERR\_IMMS](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) - 输入法服务错误。  [IME\_ERR\_DETACHED](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) - 未绑定输入法。  [IME\_ERR\_NULL\_POINTER](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) - 非预期的空指针。  具体错误码可以参考[InputMethod\_ErrorCode](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode)。 |
...
| --- | --- |
| [InputMethod\_InputMethodProxy](../../结构体/InputMethod_InputMethodProxy/capi-inputmethod-inputmethod-inputmethodproxy.md) \*inputMethodProxy | 表示指向[InputMethod\_InputMethodProxy](../../结构体/InputMethod_InputMethodProxy/capi-inputmethod-inputmethod-inputmethodproxy.md)实例的指针。inputMethodProxy由调用[OH\_InputMethodController\_Attach](../inputmethod_controller_capi.h/capi-inputmethod-controller-capi-h.md#oh_inputmethodcontroller_attach)获取。 |
| [InputMethod\_EnterKeyType](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_enterkeytype) enterKey | 回车键类型。 |
| [InputMethod\_TextInputType](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_textinputtype) textType | 输入框类型。 |
...
| --- | --- |
| [InputMethod\_InputMethodProxy](../../结构体/InputMethod_InputMethodProxy/capi-inputmethod-inputmethod-inputmethodproxy.md) \*inputMethodProxy | 表示指向[InputMethod\_InputMethodProxy](../../结构体/InputMethod_InputMethodProxy/capi-inputmethod-inputmethod-inputmethodproxy.md)实例的指针。inputMethodProxy由调用[OH\_InputMethodController\_Attach](../inputmethod_controller_capi.h/capi-inputmethod-controller-capi-h.md#oh_inputmethodcontroller_attach)获取。 |
| [InputMethod\_CursorInfo](../../结构体/InputMethod_CursorInfo/capi-inputmethod-inputmethod-cursorinfo.md) \*cursorInfo | 指向[InputMethod\_CursorInfo](../../结构体/InputMethod_CursorInfo/capi-inputmethod-inputmethod-cursorinfo.md)实例的指针。表示光标信息。 |
...
| --- | --- |
| [InputMethod\_InputMethodProxy](../../结构体/InputMethod_InputMethodProxy/capi-inputmethod-inputmethod-inputmethodproxy.md) \*inputMethodProxy | 表示指向[InputMethod\_InputMethodProxy](../../结构体/InputMethod_InputMethodProxy/capi-inputmethod-inputmethod-inputmethodproxy.md)实例的指针。inputMethodProxy由调用[OH\_InputMethodController\_Attach](../inputmethod_controller_capi.h/capi-inputmethod-controller-capi-h.md#oh_inputmethodcontroller_attach)获取。 |
| [InputMethod\_PrivateCommand](../../结构体/InputMethod_PrivateCommand/capi-inputmethod-inputmethod-privatecommand.md) \*privateCommand[] | 私有命令, 定义在[InputMethod\_PrivateCommand](../../结构体/InputMethod_PrivateCommand/capi-inputmethod-inputmethod-privatecommand.md)，最大大小为32KB。 |
