...
scraped_at: 2026-06-01T15:59:03+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:dbcbec58b75337d19fdd80af95333a60e9b0ba1210ec36e5c75416d8303c071a
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md) | InputMethod\_TextConfig | 输入框的配置信息。 |
...
| 名称 | 描述 |
| --- | --- |
| [InputMethod\_TextConfig \*OH\_TextConfig\_Create(void)](capi-inputmethod-text-config-capi-h.md#oh_textconfig_create) | 创建一个新的[InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md)实例。 |
| [void OH\_TextConfig\_Destroy(InputMethod\_TextConfig \*config)](capi-inputmethod-text-config-capi-h.md#oh_textconfig_destroy) | 销毁一个[InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md)实例。 |
...
创建一个新的[InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md)实例。
...
| 类型 | 说明 |
| --- | --- |
| [InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md) \* | 如果创建成功，返回一个指向新创建的[InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md)实例的指针。  如果创建失败，对象返回NULL，可能的失败原因有应用地址空间满。 |
...
销毁一个[InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md)实例。
...
| 参数项 | 描述 |
| --- | --- |
| [InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md) \*config | 表示指向即将被销毁的[InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md)实例的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md) \*config | 指向即将被设置值的[InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md)实例的指针。 |
| [InputMethod\_TextInputType](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_textinputtype) inputType | 输入框的输入类型。 |
...
| --- | --- |
| [InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md) \*config | 指向即将被设置值的[InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md)实例的指针。 |
| [InputMethod\_EnterKeyType](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_enterkeytype) enterKeyType | 回车键功能类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [InputMethod\_ErrorCode](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) | [InputMethod\_ErrorCode](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode)：  IME\_ERR\_OK = 0：表示成功。  IME\_ERR\_NULL\_POINTER = 12802000：非预期的空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md) \*config | 指向即将被获取值的[InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md)实例的指针。 |
| [InputMethod\_TextInputType](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_textinputtype) \*inputType | 表示指向[InputMethod\_TextInputType](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_textinputtype)实例的指针。 输入框的输入类型。 |
...
| --- | --- |
| [InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md) \*config | 指向即将被获取值的[InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md)实例的指针。 |
| [InputMethod\_EnterKeyType](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_enterkeytype) \*enterKeyType | 表示指向[InputMethod\_EnterKeyType](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_enterkeytype)实例的指针。 输入框的回车键功能类型。 |
...
| --- | --- |
| [InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md) \*config | 指向即将被获取值的[InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md)实例的指针。 |
| [InputMethod\_CursorInfo](../../结构体/InputMethod_CursorInfo/capi-inputmethod-inputmethod-cursorinfo.md) \*\*cursorInfo | 光标信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [InputMethod\_TextConfig](../../结构体/InputMethod_TextConfig/capi-inputmethod-inputmethod-textconfig.md) \*config | 表示文本配置信息。 |
| [InputMethod\_TextAvoidInfo](../../结构体/InputMethod_TextAvoidInfo/capi-inputmethod-inputmethod-textavoidinfo.md) \*\*avoidInfo | 输入框避让信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [InputMethod\_ErrorCode](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode) | [InputMethod\_ErrorCode](../inputmethod_types_capi.h/capi-inputmethod-types-capi-h.md#inputmethod_errorcode)：  IME\_ERR\_OK = 0：表示成功。  IME\_ERR\_PARAMCHECK = 401：参数检查失败。  IME\_ERR\_NULL\_POINTER = 12802000：非预期的空指针。 |
