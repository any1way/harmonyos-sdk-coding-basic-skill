...
scraped_at: 2026-06-01T15:58:42+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:86098c01ca4277c7c24b190f6f6d0f87a83bd322273c00fa106e6256da4f097a
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 用于指定目标应用的Want类型信息，包括ability名称、bundle名称等。 |
...
以下错误码的详细介绍请参见[输入法框架错误码](../../错误码/输入法框架错误码/errorcode-inputmethod-framework.md)，[元能力子系统错误码](<../../../Ability Kit（程序框架服务）/错误码/元能力子系统错误码/errorcode-ability.md>)，[通用错误码说明文档](../../../通用错误码/errorcode-universal.md)。
