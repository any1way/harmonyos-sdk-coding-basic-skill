...
scraped_at: 2026-06-11T16:05:10+08:00
doc_updated_at: 2026-04-10
content_hash: sha256:cfe8066b5e2d4572ab5491f0b4277567ac9ec0f7adbc629bc5605341f582efe4
---
...
不支持[通用属性](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/ts-component-general-attributes.md)
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| controller | [CustomDialogController](<../../../ArkUI（方舟UI框架）/ArkTS组件/弹窗/自定义弹窗 (CustomDialog)/ts-methods-custom-dialog-box.md#customdialogcontroller>) | 是 | - | 输入法切换列表弹窗控制器。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| icon | [Resource](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | 必填。默认图片资源。 |
| selectedIcon | [Resource](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | 必填。选中时的图片资源。 |

## 事件

PhonePC/2in1TabletTVWearable

不支持[通用事件](../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/ts-component-general-events.md)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/0eg_SmdgRuWiznswcm_ldw/zh-cn_image_0000002622860431.png?HW-CC-KV=V1&HW-CC-Date=20260611T080507Z&HW-CC-Expire=86400&HW-CC-Sign=549BC5B2F1B21FE965014516F7B708E24C6D12CC674AC7159342D40D6514B97F)
