...
scraped_at: 2026-06-01T15:58:47+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:09b209c84a56c4cd15c2f6a5b0231890369b3c782bf6f071f3288b38a927df93
---
...
| 类型 | 说明 |
| --- | --- |
| [ElementName](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md>) | 系统输入法设置界面Ability的ElementName。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| target | [InputMethodSubtype](<../@ohos.InputMethodSubtype (输入法子类型)/js-apis-inputmethod-subtype.md#inputmethodsubtype>) | 是 | 目标输入法子类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [InputMethodSubtype](<../@ohos.InputMethodSubtype (输入法子类型)/js-apis-inputmethod-subtype.md#inputmethodsubtype>) | 返回当前输入法子类型对象。 |
...
| inputMethodSubtype | [InputMethodSubtype](<../@ohos.InputMethodSubtype (输入法子类型)/js-apis-inputmethod-subtype.md#inputmethodsubtype>) | 是 | 目标输入法子类型。 |
...
| windowId | number | 否 | 是 | 编辑框所在的窗口Id，该参数应为整数。  推荐使用[getWindowProperties](<../../../ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#getwindowproperties9>)方法获取窗口id属性。 |
...
当自绘控件所在窗口通过[setWindowFocusable](<../../../ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setwindowfocusable9>)设置为不可获焦窗口时，系统将无法保证自绘输入控件与输入法正常交互。若开发者希望在不可获焦窗口中绘制输入框，建议参考[不可获焦窗口中输入框与输入法交互指南](<../../../../harmonyos-guides/应用框架/IME Kit（输入法开发服务）/不可获焦窗口中输入框与输入法交互指南/use-inputmethod-in-not-focusable-window.md>)。
...
以下错误码的详细介绍请参见[输入法框架错误码](../../错误码/输入法框架错误码/errorcode-inputmethod-framework.md)和[通用错误码说明文档](../../../通用错误码/errorcode-universal.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uiContext | [UIContext](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 是 | UIContext实例对象。 |
| textConfig | [TextConfig](js-apis-inputmethod.md#textconfig10) | 是 | 编辑框的配置信息。 |
...
| callback | (inputMethodProperty: [InputMethodProperty](js-apis-inputmethod.md#inputmethodproperty8), inputMethodSubtype: [InputMethodSubtype](<../@ohos.InputMethodSubtype (输入法子类型)/js-apis-inputmethod-subtype.md#inputmethodsubtype>)) => void | 是 | 回调函数，返回输入法属性对象及子类型对象。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 设置监听类型，固定取值为'imeChange'。 |
| callback | (inputMethodProperty: [InputMethodProperty](js-apis-inputmethod.md#inputmethodproperty8), inputMethodSubtype: [InputMethodSubtype](<../@ohos.InputMethodSubtype (输入法子类型)/js-apis-inputmethod-subtype.md#inputmethodsubtype>)) => void | 否 | 回调函数，返回取消订阅的输入法属性对象及子类型对象。 |
...
| callback | AsyncCallback<Array<[InputMethodSubtype](<../@ohos.InputMethodSubtype (输入法子类型)/js-apis-inputmethod-subtype.md#inputmethodsubtype>)>> | 是 | 回调函数，返回指定输入法应用的所有子类型。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[InputMethodSubtype](<../@ohos.InputMethodSubtype (输入法子类型)/js-apis-inputmethod-subtype.md#inputmethodsubtype>)>> | Promise对象，返回指定输入法应用的所有子类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[InputMethodSubtype](<../@ohos.InputMethodSubtype (输入法子类型)/js-apis-inputmethod-subtype.md#inputmethodsubtype>)>> | 是 | 回调函数，返回当前输入法应用的所有子类型。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[InputMethodSubtype](<../@ohos.InputMethodSubtype (输入法子类型)/js-apis-inputmethod-subtype.md#inputmethodsubtype>)>> | Promise对象，返回当前输入法应用的所有子类型。 |
...
从API version 9开始支持，从API version 18开始废弃，建议使用[InputMethodListDialog](<../@ohos.inputMethodList (输入法切换列表控件)/js-apis-inputmethodlist.md#inputmethodlistdialog>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[InputMethodListDialog](<../@ohos.inputMethodList (输入法切换列表控件)/js-apis-inputmethodlist.md#inputmethodlistdialog>)替代。
