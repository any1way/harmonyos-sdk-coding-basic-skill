...
scraped_at: 2026-06-01T15:58:23+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:557be3ddd6f886deb990225f2dcdba8f5c3e31057772181231e8f8c9330b69f0
---
...
以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)和[卡片错误码](../../错误码/卡片错误码/errorcode-form.md)。
...
| formBindingData | [formBindingData.FormBindingData](<../@ohos.app.form.formBindingData (卡片数据绑定类)/js-apis-app-form-formbindingdata.md#formbindingdata>) | 是 | 用于更新的数据。 |
| callback | AsyncCallback<void> | 是 | 回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[formInfo.FormInfo](<../@ohos.app.form.formInfo (formInfo)/js-apis-app-form-forminfo.md>)>> | 是 | 回调函数。返回查询到的卡片信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | [formInfo.FormInfoFilter](<../@ohos.app.form.formInfo (formInfo)/js-apis-app-form-forminfo.md#forminfofilter>) | 是 | 卡片信息过滤器。 |
| callback | AsyncCallback<Array<[formInfo.FormInfo](<../@ohos.app.form.formInfo (formInfo)/js-apis-app-form-forminfo.md>)>> | 是 | 回调函数。返回查询到符合条件的卡片信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | [formInfo.FormInfoFilter](<../@ohos.app.form.formInfo (formInfo)/js-apis-app-form-forminfo.md#forminfofilter>) | 否 | 卡片信息过滤器, 默认为空，不进行过滤。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<Array<[formInfo.FormInfo](<../@ohos.app.form.formInfo (formInfo)/js-apis-app-form-forminfo.md>)>> | Promise对象。返回查询到符合条件的卡片信息。 |
...
**设备行为差异：** 该接口在Wearable中调用会返回[16501000](../../错误码/卡片错误码/errorcode-form.md#section16501000-内部功能错误)错误码。

**参数：**

| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 打开卡片管理页面的请求中的want参数，需包含以下字段。  bundleName: 卡片所属应用的包名。  abilityName: 卡片所属的ability名称。  parameters:  - ohos.extra.param.key.form\_dimension: [卡片尺寸](<../@ohos.app.form.formInfo (formInfo)/js-apis-app-form-forminfo.md#formdimension>)。  - ohos.extra.param.key.form\_name: 卡片名称。  - ohos.extra.param.key.module\_name: 卡片所属的模块名称。 |

说明

如果parameters参数没有填完整或者指定的卡片不存在，就会默认展示[form\_config.json](<../../../../harmonyos-guides/应用框架/Form Kit（卡片开发服务）/ArkTS卡片开发（推荐）/配置ArkTS卡片的配置文件/arkts-ui-widget-configuration.md#卡片配置>)中配置的默认卡片。

**错误码：**

以下错误码的详细介绍请参见[卡片错误码](../../错误码/卡片错误码/errorcode-form.md)。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[formInfo.FormInfo](<../@ohos.app.form.formInfo (formInfo)/js-apis-app-form-forminfo.md#forminfo>)> | Promise对象。返回查询到符合条件的卡片信息。 |
...
卡片提供方发起互动卡片动效请求，只针对[场景动效类型互动卡片](<../../../../harmonyos-guides/应用框架/Form Kit（卡片开发服务）/ArkTS卡片开发（推荐）/配置ArkTS卡片的配置文件/arkts-ui-widget-configuration.md#sceneanimationparams标签>)生效，使用Promise异步回调。

说明

1. 该接口在省电模式场景下不可使用，会报16501000错误码。
2. 当设备热档位进入HOT场景并且没有点击事件的场景下，该接口会报16501000错误码；当热档位进入OVERHEATED时，任何情况下都会报16501000错误码。热档位信息具体可参考[热档位信息](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/设备管理/@ohos.thermal (热管理)/js-apis-thermal.md#thermallevel>)。
...
| overflowInfo | [formInfo.OverflowInfo](<../@ohos.app.form.formInfo (formInfo)/js-apis-app-form-forminfo.md#overflowinfo20>) | 是 | 动效请求参数信息。 |
...
卡片提供方发起取消互动卡片动效请求，只针对[场景动效类型互动卡片](<../../../../harmonyos-guides/应用框架/Form Kit（卡片开发服务）/ArkTS卡片开发（推荐）/配置ArkTS卡片的配置文件/arkts-ui-widget-configuration.md#sceneanimationparams标签>)生效，使用Promise异步回调。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[formInfo.Rect](<../@ohos.app.form.formInfo (formInfo)/js-apis-app-form-forminfo.md#rect20>)> | Promise对象，返回卡片相对屏幕左上角的位置信息和卡片尺寸信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[formInfo.RunningFormInfo](<../@ohos.app.form.formInfo (formInfo)/js-apis-app-form-forminfo.md#runningforminfo20>)> | Promise对象。返回符合条件的卡片信息，包括卡片名称、尺寸等。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[formInfo.RunningFormInfo](<../@ohos.app.form.formInfo (formInfo)/js-apis-app-form-forminfo.md#runningforminfo20>)>> | Promise对象。返回符合条件的卡片信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIAbilityContext](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md>) | 是 | [UIAbility](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)的上下文，做校验使用。 |
| moduleName | string | 是 | 指定卡片的moduleName。 |
| abilityName | string | 是 | 指定卡片的abilityName。 |
| formName | string | 是 | 指定卡片在[form\_config.json](<../../../../harmonyos-guides/应用框架/Form Kit（卡片开发服务）/ArkTS卡片开发（推荐）/配置ArkTS卡片的配置文件/arkts-ui-widget-configuration.md#配置文件字段说明>)中配置的卡片名称。 |
...
在应用主进程通过本接口可以通知FormExtension进程批量更新当前应用程序下已经加桌的所有卡片，仅支持在[UIAbility](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)中调用，使用Promise异步回调。
