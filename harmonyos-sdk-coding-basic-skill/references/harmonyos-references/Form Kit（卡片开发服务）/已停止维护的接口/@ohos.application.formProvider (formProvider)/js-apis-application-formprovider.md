...
scraped_at: 2026-06-01T15:58:34+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:6a97b167b4a08f7a0479452cc29755031bb7d6ddf77884af9c7725cdbe90767f
---
...
从API version 9 开始废弃，建议使用[formProvider](<../../ArkTS API/@ohos.app.form.formProvider (formProvider)/js-apis-app-form-formprovider.md>)替代。
...
| formBindingData | [formBindingData.FormBindingData](<../@ohos.application.formBindingData (卡片数据绑定类)/js-apis-application-formbindingdata.md#formbindingdata>) | 是 | 用于更新的数据。 |
| callback | AsyncCallback<void> | 是 | 回调函数。 |
