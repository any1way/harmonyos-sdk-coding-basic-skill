...
scraped_at: 2026-06-11T16:07:30+08:00
doc_updated_at: 2026-05-28
content_hash: sha256:ce1e43bacd4295246798ce535ae1895b48d7320d1ebe1919b5011560e4bbd8d9
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [Asset\_Blob](../../结构体/Asset_Blob/capi-assettype-asset-blob.md) | Asset\_Blob | 二进制数组类型，即不定长的字节数组。 |
| [Asset\_Value](../../结构体/Asset_Value/capi-assettype-asset-value.md) | Asset\_Value | 关键资产属性的值（内容）。 |
| [Asset\_Attr](../../结构体/Asset_Attr/capi-assettype-asset-attr.md) | Asset\_Attr | 关键资产属性，属性由标签和值组成，以键值对的形式存在。 |
| [Asset\_Result](../../结构体/Asset_Result/capi-assettype-asset-result.md) | Asset\_Result | 单条关键资产的查询结果。 |
| [Asset\_ResultSet](../../结构体/Asset_ResultSet/capi-assettype-asset-resultset.md) | Asset\_ResultSet | 多条关键资产的查询结果。 |
| [Asset\_SyncResult](../../结构体/Asset_SyncResult/capi-assettype-asset-syncresult.md) | Asset\_SyncResult | 关键资产同步结果。 |
...
| ASSET\_TAG\_IS\_PERSISTENT = ASSET\_TYPE\_BOOL | 0x11 | 表示关键资产是否需持久化存储，其值为bool类型。  在调用OH\_Asset\_Add函数时传入该属性需要校验权限ohos.permission.STORE\_PERSISTENT\_DATA，该权限申请方式请参考[声明权限](../../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)。 |
