...
scraped_at: 2026-06-11T16:07:29+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:7fc7475e0911d7e33f24a2f54917c4933a7090b7c89e6bc9d62cca27e6e3f6e2
---
## 概述
...
**相关模块：** [AssetApi](../../模块/AssetApi/capi-assetapi.md)
...
| 名称 | 描述 |
| --- | --- |
| [int32\_t OH\_Asset\_Add(const Asset\_Attr \*attributes, uint32\_t attrCnt)](capi-asset-api-h.md#oh_asset_add) | 新增一条关键资产。  如果要设置[Asset\_Tag](../asset_type.h/capi-asset-type-h.md#asset_tag).ASSET\_TAG\_IS\_PERSISTENT属性，需要申请ohos.permission.STORE\_PERSISTENT\_DATA权限，申请方式请参考[声明权限](../../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)。 |
...
如果要设置[Asset\_Tag](../asset_type.h/capi-asset-type-h.md#asset_tag).ASSET\_TAG\_IS\_PERSISTENT属性，需要申请ohos.permission.STORE\_PERSISTENT\_DATA权限，申请方式请参考[声明权限](../../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)。
...
| 参数项 | 描述 |
| --- | --- |
| const [Asset\_Attr](../../结构体/Asset_Attr/capi-assettype-asset-attr.md) \*attributes | 待新增关键资产的属性集合。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [Asset\_Attr](../../结构体/Asset_Attr/capi-assettype-asset-attr.md) \*query | 待删除关键资产的搜索条件。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [Asset\_Attr](../../结构体/Asset_Attr/capi-assettype-asset-attr.md) \*query | 待更新关键资产的搜索条件。 |
| uint32\_t queryCnt | 待更新关键资产搜索条件的个数。 |
| const [Asset\_Attr](../../结构体/Asset_Attr/capi-assettype-asset-attr.md) \*attributesToUpdate | 待更新关键资产的属性集合。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [Asset\_Attr](../../结构体/Asset_Attr/capi-assettype-asset-attr.md) \*query | 关键资产的查询条件。 |
| uint32\_t queryCnt | 关键资产查询条件的个数。 |
| [Asset\_Blob](../../结构体/Asset_Blob/capi-assettype-asset-blob.md) \*challenge | 挑战值，在后续调用[OH\_Asset\_Query](capi-asset-api-h.md#oh_asset_query)时使用。 |
...
| const [Asset\_Attr](../../结构体/Asset_Attr/capi-assettype-asset-attr.md) \*query | 关键资产的查询条件。 |
| uint32\_t queryCnt | 关键资产查询条件的个数。 |
| [Asset\_ResultSet](../../结构体/Asset_ResultSet/capi-assettype-asset-resultset.md) \*resultSet | 查询结果列表。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [Asset\_Attr](../../结构体/Asset_Attr/capi-assettype-asset-attr.md) \*handle | 待处理的查询句柄，当前包含[OH\_Asset\_PreQuery](capi-asset-api-h.md#oh_asset_prequery)执行成功返回的挑战值。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [Asset\_Attr](../../结构体/Asset_Attr/capi-assettype-asset-attr.md) \*query | 关键资产同步结果的查询条件。 |
| uint32\_t queryCnt | 关键资产同步结果的查询条件个数。 |
| [Asset\_SyncResult](../../结构体/Asset_SyncResult/capi-assettype-asset-syncresult.md) \*syncResult | 查询到的关键资产同步结果。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [Asset\_Result](../../结构体/Asset_Result/capi-assettype-asset-result.md) \*result | 从[OH\_Asset\_Query](capi-asset-api-h.md#oh_asset_query)中获取的查询结果。 |
| [Asset\_Tag](../asset_type.h/capi-asset-type-h.md#asset_tag) tag | 待获取的属性标签。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Asset\_Attr](../../结构体/Asset_Attr/capi-assettype-asset-attr.md) | 如果操作成功，则以Asset\_Attr的形式返回属性，该属性不需要业务进行释放；否则返回NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Asset\_Blob](../../结构体/Asset_Blob/capi-assettype-asset-blob.md) \*blob | 从[OH\_Asset\_PreQuery](capi-asset-api-h.md#oh_asset_prequery)获取的挑战值。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Asset\_ResultSet](../../结构体/Asset_ResultSet/capi-assettype-asset-resultset.md) \*resultSet | 从[OH\_Asset\_Query](capi-asset-api-h.md#oh_asset_query)得到的查询结果列表。 |
