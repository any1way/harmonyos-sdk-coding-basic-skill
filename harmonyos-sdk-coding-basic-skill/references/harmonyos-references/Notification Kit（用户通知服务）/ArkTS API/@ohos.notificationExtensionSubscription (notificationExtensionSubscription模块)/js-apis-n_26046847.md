...
scraped_at: 2026-06-11T16:47:25+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:0ac57e20ea0e90e0b26e2061e0b9eaaf1c6bde9e52c0f05d8d8833050842f4ee
---
...
订阅通知扩展。使用[蓝牙模块](<../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit简介/connectivity-kit-intro.md#蓝牙简介>)相关接口获取蓝牙设备的唯一地址后方可订阅。使用Promise异步回调。
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationExtensionSubscriptionInfo](../notification/NotificationExtensionSubscriptionInfo/js-apis-notif-extsubinfo.md) | 用于描述通知扩展订阅的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationInfo](../notification/NotificationInfo/js-apis-inner-notification-notificationinfo.md) | 通知订阅扩展能力中[onReceiveMessage](<../@ohos.application.NotificationSubscriberExtensionAbility (通知订阅扩展能力)/js-apis-notificatio_96645684.md#onreceivemessage>)回调的通知信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_GrantedBundleInfo](../notification/NotificationCommonDef/js-apis-inner-notification-notificationcommondef.md#grantedbundleinfo22) | 授权应用的包信息。 |
