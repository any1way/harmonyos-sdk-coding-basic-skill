...
scraped_at: 2026-06-01T16:36:58+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:82051de49335711d6df551a977af49132d53949e5bac58b6b2bd84cc50e7b76d
---
本模块提供通知管理的能力，包括发布、取消发布通知，创建、获取、移除通知通道，订阅、取消订阅通知，获取通知的使能状态、角标使能状态，获取通知的相关信息等。

说明

从API version 9开始，该模块不再维护，建议使用[@ohos.notificationManager](<../../@ohos.notificationManager (NotificationManager模块)/js-apis-notificationmanager.md>)替代。
...
从 API version 7开始支持，从API version 9开始废弃。建议使用[notificationManager.BundleOption](../../notification/NotificationCommonDef/js-apis-inner-notification-notificationcommondef.md#bundleoption)替代。
...
| wantAgent | [WantAgent](<../../../../Ability Kit（程序框架服务）/ArkTS API/已停止维护的接口/@ohos.wantAgent (WantAgent模块)/js-apis-wantagent.md>) | 是 | 是 | 点击按钮时触发的WantAgent。 |
...
| briefText | string | 是 | 是 | 通知概要内容，是对通知内容的总结。 |
| expandedTitle | string | 是 | 是 | 通知展开时的标题。 |
| picture | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 是 | 通知的图片内容。 |
...
| wantAgent | [WantAgent](<../../../../Ability Kit（程序框架服务）/ArkTS API/已停止维护的接口/@ohos.wantAgent (WantAgent模块)/js-apis-wantagent.md>) | 是 | 是 | WantAgent封装了应用的行为意图，点击通知时触发该行为。 |
...
| smallIcon | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 是 | 通知小图标。可选字段，大小不超过30KB。 |
| largeIcon | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 是 | 通知大图标。可选字段，大小不超过30KB。 |
...
| notificationFlags8+ | [NotificationFlags](../../notification/NotificationFlags/js-apis-inner-notification-notificationflags.md) | 是 | 否 | 获取NotificationFlags。 |
| removalWantAgent9+ | [WantAgent](<../../../../Ability Kit（程序框架服务）/ArkTS API/已停止维护的接口/@ohos.wantAgent (WantAgent模块)/js-apis-wantagent.md>) | 是 | 是 | 当移除通知时，通知将被重定向到的WantAgent实例。 |
