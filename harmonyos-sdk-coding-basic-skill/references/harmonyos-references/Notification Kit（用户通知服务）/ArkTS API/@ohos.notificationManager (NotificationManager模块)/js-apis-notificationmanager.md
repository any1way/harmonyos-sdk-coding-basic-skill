...
scraped_at: 2026-06-11T16:47:27+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:0cf32cfb99a41cf77644e971505673acb1616c260cbbb578863a6af4dc317172
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [NotificationRequest](../notification/NotificationRequest/js-apis-inner-notification-notificationrequest.md#notificationrequest-1) | 是 | 设置发布通知的内容和相关配置信息。 |
| callback | AsyncCallback<void> | 是 | 回调函数。当发布通知成功，err为undefined，否则为错误对象。 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)、[通知错误码](../../错误码/通知错误码/errorcode-notification.md)、[HTTP错误码](<../../../网络/Network Kit（网络服务）/错误码/HTTP错误码/errorcode-net-http.md>)。
...
以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)和[通知错误码](../../错误码/通知错误码/errorcode-notification.md)。
...
以下错误码的详细介绍请参见[通知错误码](../../错误码/通知错误码/errorcode-notification.md)。
...
| callback | AsyncCallback<[NotificationSlot](../notification/NotificationSlot/js-apis-inner-notification-notificationslot.md)> | 是 | 回调函数。当获取通知渠道成功，err为undefined，data为获取到的NotificationSlot，否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[NotificationSlot](../notification/NotificationSlot/js-apis-inner-notification-notificationslot.md)> | Promise对象，返回通知渠道对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[NotificationSlot](../notification/NotificationSlot/js-apis-inner-notification-notificationslot.md)>> | 是 | 回调函数。当获取通知渠道成功，err为undefined，data为获取到的NotificationSlot数组，否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[NotificationSlot](../notification/NotificationSlot/js-apis-inner-notification-notificationslot.md)>> | Promise对象，返回通知渠道对象。 |
...
以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)、[通知错误码](../../错误码/通知错误码/errorcode-notification.md)、[包管理子系统通用错误码](<../../../Ability Kit（程序框架服务）/错误码/包管理子系统通用错误码/errorcode-bundle.md>)。
...
以下错误码的详细介绍请参见[通知错误码](../../错误码/通知错误码/errorcode-notification.md)、[包管理子系统通用错误码](<../../../Ability Kit（程序框架服务）/错误码/包管理子系统通用错误码/errorcode-bundle.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[NotificationRequest](../notification/NotificationRequest/js-apis-inner-notification-notificationrequest.md#notificationrequest-1)>> | 是 | 回调函数。当获取未删除的通知列表成功，err为undefined，data为获取到的通知列表，否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[NotificationRequest](../notification/NotificationRequest/js-apis-inner-notification-notificationrequest.md#notificationrequest-1)>> | Promise对象，返回当前应用的通知列表。 |
...
获取通知[NotificationRequest](../notification/NotificationRequest/js-apis-inner-notification-notificationrequest.md#notificationrequest-1)中wantAgent字段的部分信息。使用Promise异步回调。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[NotificationParameters](../notification/NotificationRequest/js-apis-inner-notification-notificationrequest.md#notificationparameters24)> | Promise对象，返回wantAgent的部分信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| groupName | string | 是 | 通知组名称，此名称需要在发布通知时通过[NotificationRequest](../notification/NotificationRequest/js-apis-inner-notification-notificationrequest.md#notificationrequest-1)对象指定。 |
...
在使用[NotificationTemplate](../notification/NotificationTemplate/js-apis-inner-notification-notificationtemplate.md)发布通知前，可以通过该接口查询是否支持对应的通知模板。使用callback异步回调。
...
在使用[NotificationTemplate](../notification/NotificationTemplate/js-apis-inner-notification-notificationtemplate.md)发布通知前，可以通过该接口查询是否支持对应的通知模板。使用Promise异步回调。
...
* 仅当应用界面加载完成后（即调用[loadContent](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIExtensionContentSession (带界面扩展能力的界面操作类)/js-apis-app-ability_18888586.md#loadcontent>)成功），方可使用该接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIAbilityContext](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md>) | 是 | 通知弹窗绑定Ability的上下文。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIAbilityContext](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md>) | 是 | 通知弹窗绑定的Ability上下文。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIAbilityContext](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md>) | 是 | 通知设置页面绑定Ability的上下文。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_BundleOption](../notification/NotificationCommonDef/js-apis-inner-notification-notificationcommondef.md#bundleoption) | 指定应用的包信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationActionButton](../notification/NotificationActionButton/js-apis-notif-notificationactionbutton.md) | 通知中显示的操作按钮。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationBasicContent](../notification/NotificationContent/js-apis-inner-notification-notificationcontent.md#notificationbasiccontent) | 描述普通文本通知。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationContent](../notification/NotificationContent/js-apis-inner-notification-notificationcontent.md#notificationcontent-1) | 描述通知内容。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationLongTextContent](../notification/NotificationContent/js-apis-inner-notification-notificationcontent.md#notificationlongtextcontent) | 描述长文本通知。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationMultiLineContent](../notification/NotificationContent/js-apis-inner-notification-notificationcontent.md#notificationmultilinecontent) | 描述多行文本通知。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationPictureContent](../notification/NotificationContent/js-apis-inner-notification-notificationcontent.md#notificationpicturecontent) | 附有图片的通知。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationSystemLiveViewContent](../notification/NotificationContent/js-apis-inner-notification-notificationcontent.md#notificationsystemliveviewcontent) | 系统实况窗通知内容。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationRequest](../notification/NotificationRequest/js-apis-inner-notification-notificationrequest.md#notificationrequest-1) | 通知请求。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationParameters](../notification/NotificationRequest/js-apis-inner-notification-notificationrequest.md#notificationparameters24) | 描述通知请求中wantAgent的部分信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_DistributedOptions](../notification/NotificationRequest/js-apis-inner-notification-notificationrequest.md#distributedoptions8) | 分布式选项。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationSlot](../notification/NotificationSlot/js-apis-inner-notification-notificationslot.md) | 通知渠道。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationTemplate](../notification/NotificationTemplate/js-apis-inner-notification-notificationtemplate.md) | 通知模板。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationUserInput](../notification/NotificationUserInput/js-apis-inner-notification-notificationuserinput.md) | 保存用户输入的通知消息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationCapsule](../notification/NotificationContent/js-apis-inner-notification-notificationcontent.md#notificationcapsule11) | 通知胶囊。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationButton](../notification/NotificationContent/js-apis-inner-notification-notificationcontent.md#notificationbutton11) | 通知按钮。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationTime](../notification/NotificationContent/js-apis-inner-notification-notificationcontent.md#notificationtime11) | 描述通知计时信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NotificationProgress](../notification/NotificationContent/js-apis-inner-notification-notificationcontent.md#notificationprogress11) | 描述通知进度。 |
