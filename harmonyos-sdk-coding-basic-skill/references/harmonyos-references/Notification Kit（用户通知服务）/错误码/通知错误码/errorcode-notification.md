...
scraped_at: 2026-06-11T16:47:49+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:9074afdfe06648c02da0bd4232606fe52195c2526d64081f5bc3dac786136627
---
说明
...
该应用受到[企业设备管理](<../../../../harmonyos-guides/系统/基础功能/MDM Kit（企业设备管理服务）/MDM Kit简介/mdm-kit-intro.md>)的权限管控，应用无法主动退出权限管控名单。
...
应用未设置或未正确设置[NotificationSubscriberExtensionAbility](<../../ArkTS API/@ohos.application.NotificationSubscriberExtensionAbility (通知订阅扩展能力)/js-apis-notificatio_96645684.md>)。

**处理步骤**

应用需创建NotificationSubscriberExtensionAbility，具体配置方法参考[ExtensionAbility组件](<../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/ExtensionAbility组件/extensionability-overview.md>)中的[NotificationSubscriberExtensionAbility](<../../ArkTS API/@ohos.application.NotificationSubscriberExtensionAbility (通知订阅扩展能力)/js-apis-notificatio_96645684.md>)。
