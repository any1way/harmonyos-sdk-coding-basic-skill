...
scraped_at: 2026-06-11T15:37:37+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:d0541fa3b54a12e58c1de628b9b83e72015b3c0e1f27383d6f108d6b57b06f2f
---
...
| children | Array<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)> | 否 | 否 | 所有子元素。 |
...
| parent | [AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement) | 否 | 否 | 元素的父元素。 |
| pluralLineSupported | boolean | 否 | 否 | 表示元素是否支持多行文本。true表示元素支持多行文本，false表示元素不支持多行文本，默认值为false。 |
| rect | [Rect](js-apis-app-accessibilityextensioncontext.md#rect) | 否 | 否 | 元素的面积。 |
| resourceName | string | 否 | 否 | 元素的资源名称。 |
| rootElement | [AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement) | 否 | 否 | 窗口元素的根元素。 |
| screenRect | [Rect](js-apis-app-accessibilityextensioncontext.md#rect) | 否 | 否 | 元素的显示区域。 |
...
| textMoveUnit | [accessibility.TextMoveUnit](<../@ohos.accessibility (辅助功能)/js-apis-accessibility.md#textmoveunit>) | 否 | 否 | 文本被读取时的移动粒度。 |
| triggerAction | [accessibility.Action](<../@ohos.accessibility (辅助功能)/js-apis-accessibility.md#action>) | 否 | 否 | 触发元素事件的动作。 |
| type | [WindowType](js-apis-app-accessibilityextensioncontext.md#windowtype) | 否 | 否 | 元素的窗口类型。 |
...
| hotArea12+ | [Rect](js-apis-app-accessibilityextensioncontext.md#rect) | 否 | 否 | 元素的可触摸区域。 |
| customComponentType18+ | string | 否 | 是 | 自定义组件类型。与元素的[AccessibilityRoleType](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/无障碍属性/ts-universal-attributes-accessibility.md#accessibilityroletype18枚举说明)类型所对应。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)> | Promise对象，返回当前对应的焦点元素。 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)和[无障碍子系统错误码](../../错误码/无障碍子系统错误码/errorcode-accessibility.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)> | 是 | 回调函数，返回当前对应的焦点元素。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)> | Promise对象，返回指定窗口的根节点元素。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)> | 是 | 回调函数，返回指定窗口的根节点元素。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)>> | Promise对象，返回指定屏幕的所有窗口。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)>> | 是 | 回调函数，返回指定屏幕的所有窗口。 |
...
从API version 9开始支持，从API version 10开始废弃，建议使用[AccessibilityExtensionContext.injectGestureSync](js-apis-app-accessibilityextensioncontext.md#accessibilityextensioncontextinjectgesturesyncdeprecated)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| gesturePath | [GesturePath](<../@ohos.accessibility.GesturePath (手势路径)/js-apis-accessibility-gesturepath.md#gesturepath>) | 是 | 表示手势的路径信息。 |
...
无障碍节点元素，在调用AccessibilityElement的方法前，需要先通过[AccessibilityExtensionContext.getFocusElement()](js-apis-app-accessibilityextensioncontext.md#accessibilityextensioncontextgetfocuselementdeprecated)或者[AccessibilityExtensionContext.getWindowRootElement()](js-apis-app-accessibilityextensioncontext.md#accessibilityextensioncontextgetwindowrootelementdeprecated)获取AccessibilityElement实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| actionName | string | 是 | 表示属性的名称，取值参考[Action](<../@ohos.accessibility (辅助功能)/js-apis-accessibility.md#action>)。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)>> | Promise对象，返回满足指定查询关键字的所有节点元素。 |
...
| type | string | 是 | 固定为'content',表示查找的类型为节点元素内容。 |
| condition | string | 是 | 表示查找的条件。 |
| callback | AsyncCallback<Array<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)>> | 是 | 回调函数，返回满足指定查询关键字的所有节点元素。 |
...
| condition | [FocusType](js-apis-app-accessibilityextensioncontext.md#focustype) | 是 | 表示查询焦点元素的类型。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)> | Promise对象，返回满足指定查询焦点元素类型的节点元素。 |
...
| type | string | 是 | 固定为'focusType'，表示查询的类型为节点的焦点元素类型。 |
| condition | [FocusType](js-apis-app-accessibilityextensioncontext.md#focustype) | 是 | 表示查询焦点元素的类型。 |
| callback | AsyncCallback<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)> | 是 | 回调函数，返回满足指定查询焦点元素类型的节点元素。 |
...
| condition | [FocusDirection](js-apis-app-accessibilityextensioncontext.md#focusdirection) | 是 | 表示查询下一焦点元素的方向。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)> | Promise对象，返回满足指定查询下一焦点元素方向的节点元素。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 固定为'focusDirection', 表示查询的类型为节点的下一焦点元素方向。 |
| condition | [FocusDirection](js-apis-app-accessibilityextensioncontext.md#focusdirection) | 是 | 表示下一查询焦点元素的方向。 |
| callback | AsyncCallback<[AccessibilityElement](js-apis-app-accessibilityextensioncontext.md#accessibilityelement)> | 是 | 回调函数，返回满足指定查询下一焦点元素方向的节点元素。 |
