...
content_hash: sha256:50de2a9894def551da43ec565ffd97b458e5ee94db87dabbc04c394fcbbbbefc
---
...
| authId | string | 否 | 否 | 商户证书ID。一个商户可配置多套证书，请妥善保管。获取可参见[准备证书](<../../../../harmonyos-guides/应用服务/Payment Kit（鸿蒙支付服务）/开发准备/准备证书/payment-certificates-config.md>)。 |
| sign | string | 否 | 否 | 签名，使用除了sign字段以外的其他字段计算签名值。可参考[签名规则](<../../REST API/公共说明/payment-rest-overview.md#签名规则>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| context | [UIContext](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 是 | UI上下文对象。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| context | [common.Context](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>) | 是 | 上下文。 |
