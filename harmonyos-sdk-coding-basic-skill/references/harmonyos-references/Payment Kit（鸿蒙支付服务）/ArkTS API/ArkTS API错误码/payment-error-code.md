...
scraped_at: 2026-06-01T16:37:11+08:00
doc_updated_at: 2026-05-12
content_hash: sha256:1b4d541e65bb2b1c4084157c44c38ddfa8f0fe552440258e7f8b8fb66461fed6
---
说明
...
2. 请参见[准备证书](<../../../../harmonyos-guides/应用服务/Payment Kit（鸿蒙支付服务）/开发准备/准备证书/payment-certificates-config.md>)、[签名规则](<../../REST API/公共说明/payment-rest-overview.md#签名规则>)章节进行检查。
...
1. 登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)，开启服务，具体可参见[开启用户身份验证服务权限开关](<../../../../harmonyos-guides/应用服务/Payment Kit（鸿蒙支付服务）/开发准备/（可选）用户身份验证服务接入准备/payment-real-name-preparations.md#开启用户身份验证服务权限开关>)。
2. 检查profile配置是否正确，参考[申请调试证书和调试Profile文件](../../../../harmonyos-guides/编写与调试应用/配置调试签名/ide-signing.md#section081822416419)。
...
[tradeOrderAmount](../promotionService(营销服务)/payment-promotionservice.md#ordercontext)数量异常。

**处理步骤**

检查[tradeOrderAmount](../promotionService(营销服务)/payment-promotionservice.md#ordercontext)入参是否正常。
...
[authId](../promotionService(营销服务)/payment-promotionservice.md#ordercontext)值无效。

**处理步骤**

检查[authId](../promotionService(营销服务)/payment-promotionservice.md#ordercontext)入参是否正常。
...
[sign](../promotionService(营销服务)/payment-promotionservice.md#ordercontext)值无效。

**处理步骤**

检查[sign](../promotionService(营销服务)/payment-promotionservice.md#ordercontext)入参是否正常。
...
[orderContext](../promotionService(营销服务)/payment-promotionservice.md#ordercontext)值无效。

**处理步骤**

检查[orderContext](../promotionService(营销服务)/payment-promotionservice.md#ordercontext)入参是否正常。
...
[mercNo](../promotionService(营销服务)/payment-promotionservice.md#ordercontext)值无效。

**处理步骤**

检查[mercNo](../promotionService(营销服务)/payment-promotionservice.md#ordercontext)入参是否正常。
