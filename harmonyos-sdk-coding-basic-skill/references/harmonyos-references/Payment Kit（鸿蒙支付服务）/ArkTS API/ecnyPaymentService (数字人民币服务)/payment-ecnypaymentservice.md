...
content_hash: sha256:06b5dfb060d82d199e01c83a2c803c16ad3073f34034592fd9e90d77d9b8effd
---
本模块提供数字人民币支付服务。
...
| acqAgtInstnId | string | 否 | 是 | 受理服务机构的金融机构编码（[通过受理服务机构入网](<../../../../harmonyos-guides/应用服务/Payment Kit（鸿蒙支付服务）/开发准备/（可选）数字人民币接入准备/payment-digital-cny-pay-preparations.md>)的商户，此项必填）。若未填写，默认为空。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| context | common.[Context](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>) | 是 | 上下文，不传会报401参数错误。 |
...
8. requestEcnyPaymentPromise() {
9. // 请使用开发者真实的订单信息（orderInfo）
10. const orderInfo: ecnyPaymentService.EcnyOrderInfo = {
11. merchantAppId: "***",
12. merchantNo: "***",
13. acqAgtInstnId: "***",
14. creditorInstitutionId: "***",
15. encryptedKey: "***",
16. encryptedInfo: "***",
17. encryptionSN: "***",
18. extraInfo: "***",
19. lastWalletId: "***"
20. };
21. ecnyPaymentService.requestEcnyPayment(this.context, orderInfo)
22. .then((result: ecnyPaymentService.EcnyPayResult) => {
23. // 支付成功
24. console.info(`succeeded in paying, result.orderNo: ${result.orderNo}, result.extraInfo: ${result.extraInfo}`);
25. })
26. }

28. build() {
29. Column() {
30. Button('requestEcnyPaymentPromise')
31. .type(ButtonType.Capsule)
32. .width('50%')
33. .margin(20)
34. .onClick(() => {
35. this.requestEcnyPaymentPromise();
36. })
37. }
38. .width('100%')
39. .height('100%')
