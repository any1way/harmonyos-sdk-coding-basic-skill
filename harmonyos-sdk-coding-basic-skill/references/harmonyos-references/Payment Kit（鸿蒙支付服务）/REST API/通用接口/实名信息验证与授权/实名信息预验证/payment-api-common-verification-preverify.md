...
scraped_at: 2026-06-01T16:38:26+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:b70b975a2c08657162bd35a2302976f4039a1b1bed9d1808a8b31e420f8586f7
---
## 功能介绍
...
| openId | 是 | String | 用户对外展示的ID（获取方式请参见[获取用户信息](<../../../../../Account Kit（华为账号服务）/REST API/获取用户信息/概述/account-api-get-user-info-overview.md>)）。长度范围为1-512。  **说明：** 入参中的实名信息，必须和 openId用户下的实名信息保持一致。 |
