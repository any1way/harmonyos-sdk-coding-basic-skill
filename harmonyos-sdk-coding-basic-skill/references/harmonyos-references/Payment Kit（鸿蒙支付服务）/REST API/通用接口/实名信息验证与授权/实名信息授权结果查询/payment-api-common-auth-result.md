...
scraped_at: 2026-06-01T16:38:28+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:7db2d64e5f6799856518588beadf7ad8e2f5e60e80a9dcddf679175f0fcfb374
---
## 功能介绍
...
| 参数 | 是否必选 | 类型 | 说明 |
| --- | --- | --- | --- |
| realNameAuthId | 是 | String | 实名信息授权ID。[应用端接口](<../../../../ArkTS API/realNameService(身份验证服务)/payment-realnameservice.md#startrealnameauth>)用户授权实名信息时返回的授权ID，长度范围为1-10。 |
| openId | 是 | String | 用户对外展示的ID（获取方式请参见[获取用户信息](<../../../../../Account Kit（华为账号服务）/REST API/获取用户信息/概述/account-api-get-user-info-overview.md>)）。长度范围为1-512。 |
