...
scraped_at: 2026-06-01T16:38:30+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:af634fbf438803a9b052352c84307604f02967cfcf29edc3df3c56a7e05c62c9
---
## 功能介绍
...
| PayDevAuth | 是 | String | 取值为：[PayDevAuth](../../../../数据模型说明/payment-model.md#paydevauth)的JSON字符串 |
...
| credentialIdNo | 是 | String | 证件编号。最大长度为128。  **说明：** 敏感字段使用SM加密，具体参见[上传开发者公钥及下载华为公钥-SM2加密示例代码参考](<../../../../../../harmonyos-guides/应用服务/Payment Kit（鸿蒙支付服务）/开发准备/（可选）用户身份验证服务接入准备/payment-real-name-preparations.md#上传开发者公钥及下载华为公钥>)。 |
| realName | 是 | String | 用户姓名。最大长度为128。  **说明：** 敏感字段使用SM加密，具体参见[上传开发者公钥及下载华为公钥-SM2加密示例代码参考](<../../../../../../harmonyos-guides/应用服务/Payment Kit（鸿蒙支付服务）/开发准备/（可选）用户身份验证服务接入准备/payment-real-name-preparations.md#上传开发者公钥及下载华为公钥>)。 |
| openId | 是 | String | 用户对外展示的ID（获取方式请参见[获取用户信息](<../../../../../Account Kit（华为账号服务）/REST API/获取用户信息/概述/account-api-get-user-info-overview.md>)）。长度范围为1-512。  **说明：** 入参中的实名信息，需要和做人脸核身的用户保持一致。 不要求与openId用户的实名信息保持一致。 |
