...
content_hash: sha256:c6b33cca926ad5c23481e4eff388f53a8991c112b12f65cfb2b00a003bb9e4eb
---
## 功能介绍
...
| 参数 | 是否必选 | 类型 | 说明 |
| --- | --- | --- | --- |
| verifyResultId | 是 | String | 验证结果ID。[应用端接口](<../../../../ArkTS API/realNameService(身份验证服务)/payment-realnameservice.md#startfaceverification>)返回的验证结果ID。 |
