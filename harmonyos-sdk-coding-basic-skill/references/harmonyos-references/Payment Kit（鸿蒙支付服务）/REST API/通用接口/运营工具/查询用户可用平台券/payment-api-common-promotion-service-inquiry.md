...
scraped_at: 2026-06-01T16:38:33+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:4a7c07b779de7f2d618f0eb6c009a0a26e031d6eb142da7a060ab3da382889e5
---
## 功能介绍
...
| sceneInfos | 是 | List<[RequestSceneInfo](../../../../数据模型说明/payment-model.md#requestsceneinfo)> | 匹配券的场景条件列表，要求列表内的sceneId唯一。如果场景信息匹配上券，对应的sceneId会在响应参数matchedCoupon返回。 |
...
| coupons | 否 | List<[ServCouponInfo](../../../../数据模型说明/payment-model.md#servcouponinfo)> | 场景条件匹配上的平台券信息列表。 |
| matchedCoupon | 否 | List<[SceneMatchedCouponNos](../../../../数据模型说明/payment-model.md#scenematchedcouponnos)> | 各场景条件匹配到的券号信息。 |
