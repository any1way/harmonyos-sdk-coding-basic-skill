...
scraped_at: 2026-06-11T16:49:03+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:2adab02480e6ecf4cbe7d3bb84ddb7602aba155b489c038de61ea45991a15e5b
---
## 功能介绍
...
开发者接入合单支付，首先需要调用该接口获取到预支付ID（prepayId），用prepayId构建[orderStr](../../../../数据模型说明/payment-model.md#orderstr)参数返回给客户端调用支付接口拉起华为支付收银台。
...
| subOrders | 是 | List<[SubMercOrder](../../../../数据模型说明/payment-model.md#submercorder)> | 合单支付子订单信息。 |
...
**resultCode**非400000的错误码请看[公共错误码说明](<../../../REST API错误码/payment-error-code-rest.md#公共错误码说明>)。
