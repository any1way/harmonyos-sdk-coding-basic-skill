...
content_hash: sha256:0236df7f91833368b17794ef84877c3148990425ab76bd5b072fc987bfb23741
---
...
推荐使用[picker](<../../../../harmonyos-guides/媒体/Media Library Kit（媒体文件管理服务）/使用Picker选择媒体库资源/photoaccesshelper-photoviewpicker.md>)获取图片路径。
...
| options | scanBarcode.[ScanOptions](<../scanBarcode (默认界面扫码)/scan-scanbarcode-api.md#scanoptions>) | 否 | 启动图片识码参数。 |

**返回值：**

| **类型** | **说明** |
| --- | --- |
| Promise<Array<scanBarcode.[ScanResult](<../scanBarcode (默认界面扫码)/scan-scanbarcode-api.md#scanresult>)>> | Promise对象，返回识码结果对象。 |
...
| --- | --- | --- | --- |
| inputImage | [InputImage](scan-imagedecode.md#inputimage) | 是 | 待识别的图片信息。 |
| options | scanBarcode.[ScanOptions](<../scanBarcode (默认界面扫码)/scan-scanbarcode-api.md#scanoptions>) | 是 | 启动图片识码参数。 |
| callback | AsyncCallback<Array<scanBarcode.[ScanResult](<../scanBarcode (默认界面扫码)/scan-scanbarcode-api.md#scanresult>)>> | 是 | 回调函数，当图片识码成功，err为undefined，data为获取到的识码结果Array<scanBarcode.[ScanResult](<../scanBarcode (默认界面扫码)/scan-scanbarcode-api.md#scanresult>)>，否则为错误对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| scanResults | Array<scanBarcode.[ScanResult](<../scanBarcode (默认界面扫码)/scan-scanbarcode-api.md#scanresult>)> | 否 | 否 | 扫码结果。 |
| zoomValue | number | 否 | 否 | 相机可变焦距比，通过[setZoomRatio](<../../../Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (Zoom)/arkts-apis-camera-zoom.md#setzoomratio11>)控制相机实现变焦功能。  **说明：**  1. 使用Camera Kit [getZoomRatio](<../../../Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (Zoom)/arkts-apis-camera-zoom.md#getzoomratio11>)接口获取相机当前变焦比zoomRatio。  2. 使用Camera Kit [setZoomRatio](<../../../Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/Interface (Zoom)/arkts-apis-camera-zoom.md#setzoomratio11>)接口设置targetRatio，目标值为zoomRatio \* zoomValue。 |
...
| options | scanBarcode.[ScanOptions](<../scanBarcode (默认界面扫码)/scan-scanbarcode-api.md#scanoptions>) | 否 | 启动图像数据识码参数。 |
