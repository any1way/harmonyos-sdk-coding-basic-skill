...
scraped_at: 2026-06-01T16:26:29+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:6820fdf005ea02ceed089db974b9fad18c850c7e8728642ece60662589e76533
---
说明
...
调整接口调用顺序，可参考自定义界面扫码的[业务流程](<../../../../harmonyos-guides/媒体/Scan Kit（统一扫码服务）/自定义界面扫码/scan-customscan.md#业务流程>)。例如：先调用customScan.init接口，再调用customScan.start。
...
使用[scanBarcode.startScanForResult](<../scanBarcode (默认界面扫码)/scan-scanbarcode-api.md#scanbarcodestartscanforresult>)会返回此错误码，请根据使用场景处理用户取消默认界面扫码后的业务流程。
