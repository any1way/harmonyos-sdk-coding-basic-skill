...
scraped_at: 2026-06-11T16:50:40+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:634d6b0f317e181d94eca6a5063061489a572c83cea3a7055805d9d0cb770f77
---
本模块提供华为分享的事件注册。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [systemShare.SharedData](../systemShare（分享）/share-system-share.md#shareddata) | 是 | 分享数据。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| utd | string | 否 | 否 | 统一数据类型，参考[@ohos.data.uniformTypeDescriptor (标准化数据定义与描述)](<../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.uniformTypeDescriptor (标准化数据定义与描述)/js-apis-data-uniformtypedescriptor.md>)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onDataReceived | Callback<[systemShare.SharedData](../systemShare（分享）/share-system-share.md#shareddata)> | 否 | 否 | 沙箱接收传输完成后回调函数。用于接收已保存至沙箱路径下的文件列表。 |
