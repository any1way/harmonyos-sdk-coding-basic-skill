...
scraped_at: 2026-06-11T16:49:28+08:00
doc_updated_at: 
content_hash: sha256:81370e24093ba1c3b7505451ff41b1edbe9d58db90ca50b6429a5dc4185afeac
---
...
| 参数名 | 类型 | 说明 |
| --- | --- | --- |
| controller | pdfViewManager.[PdfController](<../../ArkTS API/pdfViewManager（PDF预览）/pdf-arkts-pdfviewmanage.md#pdfcontroller>) | PdfView组件控制器。 |
| pageLayout | pdfService.[PageLayout](<../../ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#pagelayout>) | 页面布局显示模式，默认值：LAYOUT\_SINGLE。 |
| isContinuous | boolean | 是否连续预览，true：是，false：否。默认值：false。 |
| showScroll | boolean | 是否显示滚动条，true：显示，false：隐藏。默认值：false。 |
| pageFit | pdfService.[PageFit](<../../ArkTS API/pdfService（PDF服务）/pdf-arkts-pdfservice.md#pagefit>) | 页面适配模式，默认值：FIT\_NONE。 |
