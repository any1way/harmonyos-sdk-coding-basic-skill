...
scraped_at: 2026-06-01T16:38:41+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:fe5ef701a0ad1d16d0201f151bafe8a43a7bb65900c46b85654cb0ed32dcc869
---
本模块为应用提供统一的PDF预览能力。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[image.PixelMap](<../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | Promise对象，返回image.PixelMap类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| listener | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[ScrollParam](pdf-arkts-pdfviewmanage.md#scrollparam)> | 是 | 页面滚动回调函数监听，返回ScrollParam类型数据。 |
...
| onProgress | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<number> | 否 | 加载文档进度回调函数，返回number类型数据，传此参数返回文档加载进度，不传不返回文档加载进度。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<pdfService.[ParseResult](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#parseresult)> | Promise对象，返回ParseResult类型数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| columnCount | pdfService.[PageLayout](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#pagelayout) | 是 | 页面布局模式：单页面：1，双页面：2。 |
...
| 类型 | 说明 |
| --- | --- |
| pdfService.[PageLayout](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#pagelayout) | 页面布局模式：单页面：1，双页面：2。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pageFit | pdfService.[PageFit](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#pagefit) | 是 | 页面的适配模式。 |
...
| 类型 | 说明 |
| --- | --- |
| pdfService.[PageFit](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#pagefit) | 页面的适配模式。 |
...
| --- | --- | --- | --- |
| pageIndex | number | 是 | 指定页索引，0为起始页，小于总页数。 |
| angle | pdfService.[RotationAngle](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#rotationangle) | 是 | 指定页旋转角度。 |
...
| 类型 | 说明 |
| --- | --- |
| pdfService.[RotationAngle](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#rotationangle) | 指定页面的旋转角度。 |
...
| onProgress | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<number> | 否 | 保存文档回调函数进度，返回number类型数据，传此参数返回文档保存进度，不传不返回文档保存进度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| listener | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<Array<[SelectedRects](pdf-arkts-pdfviewmanage.md#selectedrects)>> | 是 | 选中文本拖拽窗口变化回调函数监听，返回SelectedRects类型数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| listener | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<pdfService.[PageFit](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#pagefit)> | 是 | 页面适配变化回调函数监听，返回PageFit类型数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| listener | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<number> | 是 | 页面索引变化回调函数监听，返回页面索引number类型数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| listener | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<number> | 是 | 页面缩放回调函数监听，返回缩放值number类型数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| listener | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[TextSelectedParam](pdf-arkts-pdfviewmanage.md#textselectedparam)> | 是 | 页面文本被选中回调函数监听，返回选中文本TextSelectedParam类型数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| listener | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[SelectedAnnotation](pdf-arkts-pdfviewmanage.md#selectedannotation)> | 是 | 页面批注被选中回调函数监听，返回选中批注SelectedAnnotation类型数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| listener | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[ImageSelectedParam](pdf-arkts-pdfviewmanage.md#imageselectedparam)> | 是 | 页面图片被选中回调函数监听，返回选中图片ImageSelectedParam类型数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| listener | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[RedirectInfo](pdf-arkts-pdfviewmanage.md#redirectinfo)> | 是 | Click动作回调函数监听，返回RedirectInfo类型数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| listener | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[AnnotationChangedParam](pdf-arkts-pdfviewmanage.md#annotationchangedparam)> | 是 | 批注变化时回调函数监听，返回AnnotationChangedParam类型数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| listener | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<number> | 是 | 总页数变化回调函数监听，返回number类型总页数。 |
...
| --- | --- | --- | --- |
| text | string | 是 | 搜索的文本。 |
| listener | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<number> | 是 | 搜索文本回调函数监听，返回number类型的匹配总数。 |
...
| rect | Array<pdfService.[PdfRect](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#pdfrect)> | 是 | 是 | 批注矩形区域。 |
| points | Array<pdfService.[PdfPoint](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#pdfpoint)> | 是 | 是 | 批注坐标。 |
...
| rectArray | Array<pdfService.[PdfRect](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#pdfrect)> | 否 | 否 | 数组PdfRect类型。 |
...
| --- | --- | --- | --- |
| pageIndex | number | 是 | 页面索引。 |
| rectArray | Array<pdfService.[PdfRect](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#pdfrect)> | 是 | 数组PdfRect类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| imageType | pdfService.[ImageFormat](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#imageformat) | 否 | 否 | 选中的图片类型。 |
| buffer | ArrayBuffer | 否 | 是 | buffer参数是图像内容。如果缓冲区为空，则取消选择。 |
| pdfRect | pdfService.[PdfRect](../pdfService（PDF服务）/pdf-arkts-pdfservice.md#pdfrect) | 否 | 是 | 选中的图片在PDF页面的矩形区域。 |
