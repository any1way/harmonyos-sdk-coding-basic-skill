...
scraped_at: 2026-06-11T16:49:26+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:50f8b9a7716fd34f7837c1dad1cb3e2bde7a4fd3514301e69f62e35f3fb787fb
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/Ja70NBtaStWYFC5BjPgeBg/zh-cn_image_0000002592381312.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T084633Z&HW-CC-Expire=86400&HW-CC-Sign=A487DB5F29972D0D50A3F41F36A148FAAC1C27EE081FC812DD0164D43821D9A3)
...
| 类型 | 说明 |
| --- | --- |
| [image.PixelMap](<../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 当前页的image.PixelMap类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [image.PixelMap](<../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 当前页PixelMap。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pixelMap | [image.PixelMap](<../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 否 | 否 | 使用一种特殊的语法来表示直接在内容流内的小图像数据。 |
