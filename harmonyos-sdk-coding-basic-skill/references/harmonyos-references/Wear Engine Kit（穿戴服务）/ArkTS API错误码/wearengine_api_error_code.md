...
scraped_at: 2026-06-11T16:24:42+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:65232bd90a395c8028a99f2550aaef3ad80b2cabfe0899fcce1ea172141a1ea7
---
说明
...
1. 登录开发者联盟[申请接入Wear Engine服务](<../../../harmonyos-guides/系统/硬件/Wear Engine Kit（穿戴服务）/手机侧应用开发/接入准备/申请接入Wear Engine服务/wearengine_apply.md>)，勾选兼容选项。
2. 通过[在线提单](https://developer.huawei.com/consumer/cn/support/feedback/#/)提交问题，华为支持人员会及时处理。
...
参考[请求用户授权](<../../../harmonyos-guides/系统/硬件/Wear Engine Kit（穿戴服务）/手机侧应用开发/请求用户授权/request_user_authorization.md>)，确认用户已授权相关权限。
...
调用[getConnectedDevices](<../ArkTS API/wearEngine（穿戴设备能力开放）/wearengine_api.md#getconnecteddevices>)接口重新获取设备ID。
...
1. 应用的签名证书等信息和云端不一致。
2. [randomId](<../ArkTS API/wearEngine（穿戴设备能力开放）/wearengine_api.md#device>)错误。
...
2. 断开重连设备。
3. 在metadata中配置[clientId](<../../../harmonyos-guides/系统/硬件/Wear Engine Kit（穿戴服务）/手机侧应用开发/接入准备/配置Client ID/configuration_client_id.md>)。
