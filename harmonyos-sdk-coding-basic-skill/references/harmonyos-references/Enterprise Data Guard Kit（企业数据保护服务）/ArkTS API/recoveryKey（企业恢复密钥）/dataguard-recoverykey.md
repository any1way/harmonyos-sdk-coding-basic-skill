...
scraped_at: 2026-06-11T16:10:39+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:962f3b0b64a954274d39e902e58fa842eef273cf7a983b198b1f63b92c5e22c0
---
...
更新企业公钥证书流程，需要先调[getAuthChallenge](dataguard-recoverykey.md#getauthchallenge)接口获取挑战值并[签名](<../../../../harmonyos-guides/系统/安全/Enterprise Data Guard Kit（企业数据保护服务）/企业恢复密钥/挑战值签名/recoverykey-signature.md>)。使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| signature | Uint8Array | 是 | 挑战值的[签名](<../../../../harmonyos-guides/系统/安全/Enterprise Data Guard Kit（企业数据保护服务）/企业恢复密钥/挑战值签名/recoverykey-signature.md>)。 |
...
删除企业恢复密钥相关数据，需要先调[getAuthChallenge](dataguard-recoverykey.md#getauthchallenge)接口获取挑战值并[签名](<../../../../harmonyos-guides/系统/安全/Enterprise Data Guard Kit（企业数据保护服务）/企业恢复密钥/挑战值签名/recoverykey-signature.md>)。使用Promise异步回调。
...
| userType | number | 是 | [用户类型](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.osAccount (系统账号管理)/js-apis-osaccount.md#osaccounttype>)。可以通过调用[getOsAccountType](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.osAccount (系统账号管理)/js-apis-osaccount.md#getosaccounttype9>)获取。 |
...
9. console.info(`Succeeded in verifying user identity by dialog.`);
10. }).catch((error: BusinessError) => {
...
导出用于重置锁屏密码的企业恢复密钥。先需要调用[verifyUserIdentityEnterprise](dataguard-recoverykey.md#verifyuseridentityenterprise)或[verifyUserByDialog](dataguard-recoverykey.md#verifyuserbydialog)接口验证身份，并在30秒内调用此接口。若超时后调用，系统会返回异常代码[1014400001](<../ArkTS API 错误码/dataguard-error-code.md#section1014400001-系统内部错误>)。使用Promise异步回调。
...
以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)和[企业数据保护服务错误码](<../ArkTS API 错误码/dataguard-error-code.md>)。
