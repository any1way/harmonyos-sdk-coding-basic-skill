...
scraped_at: 2026-06-11T16:11:00+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:04b898c1618296e0edb367d5703f5175e53873c8a13b1d67c7e374250ffd5b69
---
...
以下错误码的详细介绍请参见[SOTER免密认证错误码](<../ArkTS API错误码/SOTER/onlineauthentication-error-code-soter.md>)。
...
8. hasAuthKeyPromise.then((result: boolean) => {
9. console.info('Succeeded in doing hasAuthKey. hasAuthKey:', result);
10. // 开发者处理结果
