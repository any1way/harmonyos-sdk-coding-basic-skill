...
scraped_at: 2026-06-11T16:10:55+08:00
doc_updated_at: 2026-05-07
content_hash: sha256:2be66c833d67dce6cded656dc377d74b0c597778eb022322da53d614e026eb3e
---
...
9. };
10. console.info('uafMessage is:', uafMessage);
11. // ...
```
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md#context>) | 是 | ability的context。 |
...
以下错误码的详细介绍请参见[FIDO免密认证错误码](<../ArkTS API错误码/FIDO/onlineauthentication-error-code-fido.md>)。
...
13. console.info('Succeeded in doing processUAFOperation, messageResp:', JSON.stringify(messageResp));
14. // ...
15. } catch (error) {
