...
scraped_at: 2026-06-11T16:11:02+08:00
doc_updated_at: 2026-05-28
content_hash: sha256:7bb7c7f8c50442523c0a98218bf76aafbd368006d3ab7b1226c0d5fd7c616cc0
---
本模块主要提供了以下能力：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md#context>) | 是 | 当前Ability的上下文。 |
...
以下错误码的详细介绍请参见[通行密钥服务错误码](<../ArkTS API错误码/通行密钥/onlineauthentication-error-code-passkey.md>)。
...
9. console.info('Succeeded in doing getClientCapabilities. clientCapabilities:', JSON.stringify(clientCapabilities));
10. } catch (error) {
...
9. console.info('Succeeded in doing getPlatformAuthenticators. platformAuthenticators:',
10. JSON.stringify(platformAuthenticators));
11. } catch (error) {
...
12. console.info('Succeeded in doing register. publicKeyAttestationCredential:',
13. JSON.stringify(publicKeyAttestationCredential));
14. } catch (error) {
...
13. console.info('Succeeded in doing authenticate. pkAssertionCredential:', JSON.stringify(pkAssertionCredential));
14. } catch (error) {
15. const err: BusinessError = error as BusinessError;
16. console.error(`Failed to call discover. Code is ${err.code}, message is ${err.message}`);
17. }
