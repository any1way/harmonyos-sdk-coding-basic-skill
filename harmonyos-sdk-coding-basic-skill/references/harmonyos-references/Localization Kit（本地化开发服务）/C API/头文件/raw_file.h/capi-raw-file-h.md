...
scraped_at: 2026-06-01T16:00:05+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:86bcb8c99f2e72f0ed3537c4eeae8ebeeba9832d4331b63effc6dcd6b8476390
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [RawFileDescriptor](../../结构体/RawFileDescriptor/capi-rawfile-rawfiledescriptor.md) | RawFileDescriptor | 提供rawfile文件描述符信息。RawFileDescriptor是[OH\_ResourceManager\_GetRawFileDescriptor](capi-raw-file-h.md#oh_resourcemanager_getrawfiledescriptor)的输出参数，涵盖了rawfile文件的文件描述符以及在HAP包中的起始位置和长度。 |
| [RawFileDescriptor64](../../结构体/RawFileDescriptor64/capi-rawfile-rawfiledescriptor64.md) | RawFileDescriptor64 | 提供较大rawfile文件描述符信息。RawFileDescriptor64是[OH\_ResourceManager\_GetRawFileDescriptor64](capi-raw-file-h.md#oh_resourcemanager_getrawfiledescriptor64)的输出参数，涵盖了rawfile文件的文件描述符以及在HAP包中的起始位置和长度。 |
| [RawFile](../../结构体/RawFile/capi-rawfile-rawfile.md) | RawFile | 提供对rawfile的访问功能。 |
| [RawFile64](../../结构体/RawFile64/capi-rawfile-rawfile64.md) | RawFile64 | 提供对较大rawfile的访问功能。 |
...
| [void OH\_ResourceManager\_CloseRawFile(RawFile \*rawFile)](capi-raw-file-h.md#oh_resourcemanager_closerawfile) | 关闭已打开的[RawFile](../../结构体/RawFile/capi-rawfile-rawfile.md) 以及释放所有相关联的资源。 |
...
| [void OH\_ResourceManager\_CloseRawFile64(RawFile64 \*rawFile)](capi-raw-file-h.md#oh_resourcemanager_closerawfile64) | 关闭已打开的[RawFile64](../../结构体/RawFile64/capi-rawfile-rawfile64.md) 以及释放所有相关联的资源。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const RawFile](../../结构体/RawFile/capi-rawfile-rawfile.md) \*rawFile | 表示指向[RawFile](../../结构体/RawFile/capi-rawfile-rawfile.md)的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [RawFile](../../结构体/RawFile/capi-rawfile-rawfile.md) \*rawFile | 表示指向[RawFile](../../结构体/RawFile/capi-rawfile-rawfile.md)的指针。 |
...
关闭已打开的[RawFile](../../结构体/RawFile/capi-rawfile-rawfile.md) 以及释放所有相关联的资源。
...
[OH\_ResourceManager\_OpenRawFile](../raw_file_manager.h/capi-raw-file-manager-h.md#oh_resourcemanager_openrawfile)
...
| --- | --- |
| [const RawFile](../../结构体/RawFile/capi-rawfile-rawfile.md) \*rawFile | 表示指向[RawFile](../../结构体/RawFile/capi-rawfile-rawfile.md)的指针。 |
| [RawFileDescriptor](../../结构体/RawFileDescriptor/capi-rawfile-rawfiledescriptor.md) \*descriptor | 显示rawfile文件描述符，以及在HAP包中的起始位置和长度。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const RawFileDescriptor](../../结构体/RawFileDescriptor/capi-rawfile-rawfiledescriptor.md) &descriptor | 包含rawfile文件描述符，以及在HAP包中的起始位置和长度。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const RawFile64](../../结构体/RawFile64/capi-rawfile-rawfile64.md) \*rawFile | 表示指向[RawFile64](../../结构体/RawFile64/capi-rawfile-rawfile64.md)的指针。 |
| void \*buf | 用于接收读取数据的缓冲区指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [RawFile64](../../结构体/RawFile64/capi-rawfile-rawfile64.md) \*rawFile | 表示指向[RawFile64](../../结构体/RawFile64/capi-rawfile-rawfile64.md)的指针。 |
...
关闭已打开的[RawFile64](../../结构体/RawFile64/capi-rawfile-rawfile64.md) 以及释放所有相关联的资源。
...
[OH\_ResourceManager\_OpenRawFile64](../raw_file_manager.h/capi-raw-file-manager-h.md#oh_resourcemanager_openrawfile64)
...
| --- | --- |
| [const RawFile64](../../结构体/RawFile64/capi-rawfile-rawfile64.md) \*rawFile | 表示指向[RawFile64](../../结构体/RawFile64/capi-rawfile-rawfile64.md)的指针。 |
| [RawFileDescriptor64](../../结构体/RawFileDescriptor64/capi-rawfile-rawfiledescriptor64.md) \*descriptor | 显示rawfile文件描述符，以及在HAP包中的起始位置和长度。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const RawFileDescriptor64](../../结构体/RawFileDescriptor64/capi-rawfile-rawfiledescriptor64.md) \*descriptor | 包含rawfile文件描述符，以及在HAP包中的起始位置和长度。 |
