...
scraped_at: 2026-06-01T16:00:09+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:dccfaa97d2754efa5707379a25ebea6228778b8a05e3e54e274033387e9f2940
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [DateTimeRule](../../结构体/DateTimeRule/capi-i18n-datetimerule.md) | DateTimeRule | 时间日期规则。 |
| [InitialTimeZoneRule](../../结构体/InitialTimeZoneRule/capi-i18n-initialtimezonerule.md) | InitialTimeZoneRule | 起始时区规则。 |
| [TimeArrayTimeZoneRule](../../结构体/TimeArrayTimeZoneRule/capi-i18n-timearraytimezonerule.md) | TimeArrayTimeZoneRule | 起始时间戳数组定义的时区规则。 |
| [AnnualTimeZoneRule](../../结构体/AnnualTimeZoneRule/capi-i18n-annualtimezonerule.md) | AnnualTimeZoneRule | 每年生效的时区规则。 |
| [TimeZoneRules](../../结构体/TimeZoneRules/capi-i18n-timezonerules.md) | TimeZoneRules | 完整的时区规则。 |
| [TimeZoneRuleQuery](../../结构体/TimeZoneRuleQuery/capi-i18n-timezonerulequery.md) | TimeZoneRuleQuery | 用于传入查询的信息，并接收查询的结果。 |
...
| [TimeZoneRules](../../结构体/TimeZoneRules/capi-i18n-timezonerules.md)\* rules | 与时区ID对应的完整时区规则[TimeZoneRules](../../结构体/TimeZoneRules/capi-i18n-timezonerules.md)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [I18n\_ErrorCode](../errorcode.h/capi-errorcode-h.md#i18n_errorcode) | 0 - 成功。  8900001 - 传入参数无效。  8900050 - 预期之外的错误，例如内存错误。 |
...
| 参数项 | 描述 |
| --- | --- |
| [TimeArrayTimeZoneRule](../../结构体/TimeArrayTimeZoneRule/capi-i18n-timearraytimezonerule.md)\* rule | 起始时间戳数组定义的时区规则[TimeArrayTimeZoneRule](../../结构体/TimeArrayTimeZoneRule/capi-i18n-timearraytimezonerule.md)。 |
| [TimeZoneRuleQuery](../../结构体/TimeZoneRuleQuery/capi-i18n-timezonerulequery.md)\* query | 用于传入查询的信息，并接收查询的结果。 |
...
| 参数项 | 描述 |
| --- | --- |
| [AnnualTimeZoneRule](../../结构体/AnnualTimeZoneRule/capi-i18n-annualtimezonerule.md)\* rule | 每年生效的时区规则[AnnualTimeZoneRule](../../结构体/AnnualTimeZoneRule/capi-i18n-annualtimezonerule.md)。 |
| [TimeZoneRuleQuery](../../结构体/TimeZoneRuleQuery/capi-i18n-timezonerulequery.md)\* query | 用于传入查询的信息，并接收查询的结果。 |
