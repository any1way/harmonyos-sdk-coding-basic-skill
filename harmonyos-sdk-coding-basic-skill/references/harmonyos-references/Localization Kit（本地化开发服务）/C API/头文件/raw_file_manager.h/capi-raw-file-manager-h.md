...
scraped_at: 2026-06-01T16:00:06+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:37c4eebc3ecba423ed6e262754110b78a3e45872d2889d24415f2256ae8fa45f
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [NativeResourceManager](../../结构体/NativeResourceManager/capi-rawfile-nativeresourcemanager.md) | NativeResourceManager | 代表native侧的ResourceManager。此类封装了JavaScript resource manager的native实现，**ResourceManager**指针可以通过调用[OH\_ResourceManager\_InitNativeResourceManager](capi-raw-file-manager-h.md#oh_resourcemanager_initnativeresourcemanager)方法获取。 |
...
| 类型 | 说明 |
| --- | --- |
| [NativeResourceManager \*](../../结构体/NativeResourceManager/capi-rawfile-nativeresourcemanager.md) | 返回[NativeResourceManager](../../结构体/NativeResourceManager/capi-rawfile-nativeresourcemanager.md)指针，如果失败返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NativeResourceManager](../../结构体/NativeResourceManager/capi-rawfile-nativeresourcemanager.md) \*resMgr | 表示[NativeResourceManager](../../结构体/NativeResourceManager/capi-rawfile-nativeresourcemanager.md)指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const NativeResourceManager](../../结构体/NativeResourceManager/capi-rawfile-nativeresourcemanager.md) \*mgr | 表示指向[NativeResourceManager](../../结构体/NativeResourceManager/capi-rawfile-nativeresourcemanager.md)的指针，此指针是通过调用[OH\_ResourceManager\_InitNativeResourceManager](capi-raw-file-manager-h.md#oh_resourcemanager_initnativeresourcemanager)方法获取的。 |
...
| 类型 | 说明 |
| --- | --- |
| [RawDir \*](../../结构体/RawDir/capi-rawfile-rawdir.md) | 返回[RawDir](../../结构体/RawDir/capi-rawfile-rawdir.md)指针。使用完此指针后，调用[OH\_ResourceManager\_CloseRawDir](../raw_dir.h/capi-raw-dir-h.md#oh_resourcemanager_closerawdir)释放。如果失败或者mgr为空时返回空指针。 |

**参考：**

[OH\_ResourceManager\_InitNativeResourceManager](capi-raw-file-manager-h.md#oh_resourcemanager_initnativeresourcemanager)

[OH\_ResourceManager\_CloseRawDir](../raw_dir.h/capi-raw-dir-h.md#oh_resourcemanager_closerawdir)
...
| 参数项 | 描述 |
| --- | --- |
| [const NativeResourceManager](../../结构体/NativeResourceManager/capi-rawfile-nativeresourcemanager.md) \*mgr | 表示指向[NativeResourceManager](../../结构体/NativeResourceManager/capi-rawfile-nativeresourcemanager.md)的指针，此指针通过调用[OH\_ResourceManager\_InitNativeResourceManager](capi-raw-file-manager-h.md#oh_resourcemanager_initnativeresourcemanager)方法获取。 |
...
| 类型 | 说明 |
| --- | --- |
| [RawFile \*](../../结构体/RawFile/capi-rawfile-rawfile.md) | 返回[RawFile](../../结构体/RawFile/capi-rawfile-rawfile.md)指针。当使用完此指针，调用[OH\_ResourceManager\_CloseRawFile](../raw_file.h/capi-raw-file-h.md#oh_resourcemanager_closerawfile)释放。如果失败或者mgr和fileName为空时返回空指针。 |

**参考：**

[OH\_ResourceManager\_InitNativeResourceManager](capi-raw-file-manager-h.md#oh_resourcemanager_initnativeresourcemanager)

[OH\_ResourceManager\_CloseRawFile](../raw_file.h/capi-raw-file-h.md#oh_resourcemanager_closerawfile)
...
| 类型 | 说明 |
| --- | --- |
| [RawFile64 \*](../../结构体/RawFile64/capi-rawfile-rawfile64.md) | 返回[RawFile64](../../结构体/RawFile64/capi-rawfile-rawfile64.md)指针。当使用完此指针，调用[OH\_ResourceManager\_CloseRawFile64](../raw_file.h/capi-raw-file-h.md#oh_resourcemanager_closerawfile64)释放。如果失败或者mgr和fileName为空时返回空指针。 |

**参考：**

[OH\_ResourceManager\_InitNativeResourceManager](capi-raw-file-manager-h.md#oh_resourcemanager_initnativeresourcemanager)

[OH\_ResourceManager\_CloseRawFile64](../raw_file.h/capi-raw-file-h.md#oh_resourcemanager_closerawfile64)
