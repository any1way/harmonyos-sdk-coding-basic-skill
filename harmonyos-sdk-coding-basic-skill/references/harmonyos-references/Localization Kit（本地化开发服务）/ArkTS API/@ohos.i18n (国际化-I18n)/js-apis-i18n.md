...
scraped_at: 2026-06-01T15:59:46+08:00
doc_updated_at: 2026-05-08
content_hash: sha256:cbaa27e351921386faa70fc6c5dad06ea0414748084a09e8a4ef16bae8d627d3
---
本模块提供系统相关的以及增强的[国际化](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/国际化和本地化概述/i18n-l10n.md>)能力，包括区域管理、电话号码处理、日历等，相关接口为[ECMA 402](https://dev.ecma-international.org/publications-and-standards/standards/ecma-402/)标准中未定义的补充接口。[Intl模块](<../@ohos.intl (国际化-Intl)/js-apis-intl.md>)提供了ECMA 402标准定义的基础国际化接口，与本模块共同使用可提供完整地国际化能力。接口中使用的名词定义如下：
...
* 本模块接口基于[CLDR](https://cldr.unicode.org)国际化数据库实现，随着CLDR标准的迭代演进，接口处理结果可能会相应调整。例如[时间日期格式化接口](js-apis-i18n.md#simplenumberformat18)，其返回值仅适用于界面展示场景，开发者请勿对返回格式进行硬编码或假设性判断，否则可能导致版本兼容问题。其中，API version 12 对应[CLDR 42](https://cldr.unicode.org/index/downloads/cldr-42)版本，具体数据变更详情可查阅[CLDR官方文档](https://cldr.unicode.org/)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| country | string | 是 | 国家地区，要求是[合法的国家地区码](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)。 |
| locale | string | 是 | [表示区域ID的字符串](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)，由语言、脚本、国家地区组成。 |
...
以下错误码的详细介绍请参见[ohos.i18n错误码](../../错误码/I18n错误码/errorcode-i18n.md)和[通用错误码](../../../通用错误码/errorcode-universal.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | 语言，要求是[合法的语言ID](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)。 |
| locale | string | 是 | [表示区域ID的字符串](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)，由语言、脚本、国家地区组成。 |
| sentenceCase | boolean | 否 | true表示按照首字母大写的格式显示文本，false表示按照区域默认的大小写格式显示文本。默认值：true。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | [合法的语言ID](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | [合法的语言ID](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)，例如zh。 |
| region | string | 否 | [合法的国家地区码](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)，例如CN。  默认值：SIM卡国家地区。 |
...
获取系统当前设置的语言。若要监听系统语言变化，可以监听[公共事件](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/进程线程通信/系统定义的公共事件/commoneventmanager-definitions.md#common_event_locale_changed>)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_LOCALE\_CHANGED，具体可参考[系统语言与区域](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/语言与用户偏好/系统语言与区域/i18n-system-language-region.md#开发步骤>)。
...
获取系统当前设置的国家地区。若要监听系统地区变化，可以监听[公共事件](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/进程线程通信/系统定义的公共事件/commoneventmanager-definitions.md#common_event_locale_changed>)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_LOCALE\_CHANGED，具体可参考[系统语言与区域](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/语言与用户偏好/系统语言与区域/i18n-system-language-region.md#开发步骤>)。
...
获取系统当前设置的区域对象。若要监听系统区域变化，可以监听[公共事件](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/进程线程通信/系统定义的公共事件/commoneventmanager-definitions.md#common_event_locale_changed>)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_LOCALE\_CHANGED，具体可参考[系统语言与区域](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/语言与用户偏好/系统语言与区域/i18n-system-language-region.md#开发步骤>)。
...
判断系统时制是否为24小时制。若要监听系统时制变化，可以监听[公共事件](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/进程线程通信/系统定义的公共事件/commoneventmanager-definitions.md#common_event_time_changed>)OHOS::EventFwk::CommonEventSupport::COMMON\_EVENT\_TIME\_CHANGED，具体可参考[用户偏好](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/语言与用户偏好/用户偏好/i18n-user-preferences.md#开发步骤>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | [合法的语言ID](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)或'default'。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 否 | [合法的语言ID](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)。默认值：系统语言。 |
...
以下错误码的详细介绍请参见[ohos.i18n错误码](../../错误码/I18n错误码/errorcode-i18n.md)。
...
判断语言是否为镜像语言。在镜像语言下，UI界面需要[镜像显示](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/国际化界面设计/i18n-ui-design.md#界面镜像>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | [表示区域ID的字符串](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)，由语言、脚本、国家地区组成，例如zh-Hans-CN。 |
| type | string | 否 | 表示历法，取值包括：buddhist, chinese, coptic, ethiopic, hebrew, gregory, indian, islamic\_civil, islamic\_tbla, islamic\_umalqura, japanese, persian。  默认值：区域默认的历法。不同取值代表的含义和使用场景请参考[设置日历和历法](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/设置日历和历法/i18n-calendar.md>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 否 | [表示区域ID的字符串](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)，由语言、脚本、国家地区组成，例如zh-Hans-CN。  默认值：系统当前区域ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| country | string | 是 | 表示电话号码所属的国家地区代码，要求是[合法的国家地区码](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 否 | [表示区域ID的字符串](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)，由语言、脚本、国家地区组成。  默认值：系统当前区域ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | [表示区域ID的字符串](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)，由语言、脚本、国家地区组成。  生成的[BreakIterator](js-apis-i18n.md#breakiterator8)将按照指定区域的规则计算可换行点的位置。 |
...
获取时区跳变规则，时区的跳变逻辑参考[夏令时跳变](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/时区与夏令时国际化/夏令时跳变/i18n-dst-transition.md>)。
...
| locale | string | 是 | [表示区域ID的字符串](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)，由语言、脚本、国家地区组成，如：zh-Hans-CN。 |
| style | string | 否 | 格式化使用的风格，取值包括：'long', 'short', 'narrow'。默认值：short。  不同取值显示效果请参考[数字与度量衡国际化](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/数字与度量衡国际化/i18n-numbers-weights-measures.md>)。 |
...
| locale | string | 否 | [表示区域ID的字符串](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)，由语言、脚本、国家地区组成。如：zh-Hans-CN。  默认值：系统当前区域ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | 待匹配的[区域ID字符串](<../../../../harmonyos-guides/应用框架/Localization Kit（本地化开发服务）/应用国际化/区域ID与文化习惯划分/i18n-locale-culture.md#实现原理>)，如：zh-Hans-CN。 |
...
| path | string | 是 | 待处理的路径，如：/data/out/tmp。 |
| delimiter | string | 否 | 路径分隔符，默认值：/。 |
| locale | [intl.Locale](<../@ohos.intl (国际化-Intl)/js-apis-intl.md#localedeprecated>) | 否 | 区域对象，默认值：系统区域对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [StyledString](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#styledstring) | 格式化后的富文本对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| year | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定年的文本样式。默认值：StyledString默认的文本样式。 |
| month | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定月的文本样式。默认值：StyledString默认的文本样式。 |
| day | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定日的文本样式。默认值：StyledString默认的文本样式。 |
| hour | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定时的文本样式。默认值：StyledString默认的文本样式。 |
| minute | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定分的文本样式。默认值：StyledString默认的文本样式。 |
| second | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定秒的文本样式。默认值：StyledString默认的文本样式。 |
| dayPeriod | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定时段的文本样式。默认值：StyledString默认的文本样式。 |
| weekday | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定星期的文本样式。默认值：StyledString默认的文本样式。 |
| era | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定纪元的文本样式。默认值：StyledString默认的文本样式。 |
| timeZoneName | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定时区名称的文本样式。默认值：StyledString默认的文本样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| numberFormat | [intl.NumberFormat](<../@ohos.intl (国际化-Intl)/js-apis-intl.md#numberformat>) | [SimpleNumberFormat](js-apis-i18n.md#simplenumberformat18) | 是 | 用于格式化数字的对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| integer | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定整数部分的文本样式。默认值：StyledString默认的文本样式。 |
| decimal | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定小数点的文本样式。默认值：StyledString默认的文本样式。 |
| fraction | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定小数部分的文本样式。默认值：StyledString默认的文本样式。 |
| unit | [TextStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#textstyle) | 否 | 是 | 指定单位部分的文本样式。默认值：StyledString默认的文本样式。 |
