...
scraped_at: 2026-06-01T15:59:49+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:9490cea7416284914e263414f54fcaa171187de80c08377c587488bfeb74a9de
---
...
Resource对象通过转换为SendableResource对象后，可以被[Sendable类](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md)持有。Sendable类在跨线程传输后，取出持有的SendableResource对象转为Resource对象，作为参数获取资源。
...
| 类型 | 说明 |
| --- | --- |
| [\_Resource](../global/Resource/js-apis-resource.md#resource-1) | 表示Resource资源信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_SendableResource](../global/SendableResource/js-apis-sendableresource.md#sendableresource-1) | 表示SendableResource资源信息。 |
