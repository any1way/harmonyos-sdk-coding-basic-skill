...
content_hash: sha256:7bd5e21f234ba674781fb89bd3b2fc380c5d09d272e80b91b5b0c3875bce0227
---
...
基于密钥不出[TEE](<../../../../harmonyos-guides/系统/安全/Universal Keystore Kit（密钥管理服务）/本地密钥管理/本地密钥管理基础概念/huks-concepts.md#可信执行环境tee>)原则，此接口不会返回密钥材料内容，只用于表示此次调用是否成功。
...
| token | Uint8Array | 是 | 密钥[二次认证密钥访问控制](<../../../../harmonyos-guides/系统/安全/Universal Keystore Kit（密钥管理服务）/本地密钥管理/密钥使用/访问控制/用户身份认证访问控制简介/huks-identity-authentication-overview.md#二次认证密钥访问控制>)的用户鉴权证明(AuthToken)。 |
| callback | AsyncCallback<[HuksReturnResult](js-apis-huks.md#huksreturnresult9)> | 是 | 回调函数。当密钥操作update成功时，err为undefined，data为获取到的HuksReturnResult；否则为错误对象。 |
...
| handle | number | 是 | updateSession操作的uint64类型的handle值。 |
| options | [HuksOptions](js-apis-huks.md#huksoptions) | 是 | updateSession操作的参数集合。 |
| token | Uint8Array | 否 | 密钥[二次认证密钥访问控制](<../../../../harmonyos-guides/系统/安全/Universal Keystore Kit（密钥管理服务）/本地密钥管理/密钥使用/访问控制/用户身份认证访问控制简介/huks-identity-authentication-overview.md#二次认证密钥访问控制>)的用户鉴权证明(AuthToken)，不填表示不进行二次认证密钥访问控制。 |
...
关于错误码的具体信息，可在[通用错误码](../../../通用错误码/errorcode-universal.md)和[HUKS错误码](../../错误码/HUKS错误码/errorcode-huks.md)中查看。
...
* errorCode的具体信息，请参考[HUKS错误码](../../错误码/HUKS错误码/errorcode-huks.md)。
