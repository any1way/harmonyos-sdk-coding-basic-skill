...
scraped_at: 2026-06-11T16:12:46+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:b6b73f744e7552d8c3de6596992203bce2d40e01c323d53fe746bfb6430ca92e
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| purpose | [certificateManager.CertificatePurpose](<../../../Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.certManager (证书管理模块)/js-apis-certmanager.md#certificatepurpose22>) | 否 | 否 | 表示证书链对应密钥的使用类型。 |
...
| property | Array<[huksExternalCrypto.HuksExternalCryptoParam](<../@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptoparam>)> | 否 | 是 | 属性。 |
...
| params | Array<[huksExternalCrypto.HuksExternalCryptoParam](<../@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptoparam>)> | 是 | 传入的参数，应用身份通过[HUKS\_EXT\_CRYPTO\_TAG\_UID](<../@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptotag>)参数携带。 |
...
| --- | --- | --- | --- |
| handle | string | 是 | 资源句柄。 |
| params | [huks.HuksOptions](<../@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksoptions>) | 是 | 传入的参数，应用身份通过[HUKS\_EXT\_CRYPTO\_TAG\_UID](<../@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptotag>)参数携带。 |
...
| --- | --- | --- | --- |
| initHandle | string | 是 | 资源句柄。 |
| params | [huks.HuksOptions](<../@ohos.security.huks (通用密钥库系统)/js-apis-huks.md#huksoptions>) | 是 | 传入的参数，应用身份可通过[HUKS\_EXT\_CRYPTO\_TAG\_UID](<../@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptotag>)参数携带，还包括算法参数（算法类型、填充模式等）。 |
...
| params | Array<[huksExternalCrypto.HuksExternalCryptoParam](<../@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptoparam>)> | 否 | 操作属性。默认获取签名类型的证书，也可以通过参数[HUKS\_EXT\_CRYPTO\_TAG\_PURPOSE](<../@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptotag>)指定获取证书类型，支持的类型包括签名验签、加解密等。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | Array<[huksExternalCrypto.HuksExternalCryptoParam](<../@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptoparam>)> | 否 | 操作属性。默认获取签名类型的[证书](<../../../../harmonyos-guides/系统/安全/Device Certificate Kit（设备证书服务）/证书管理/证书管理概述/certmanager-overview.md>)，也可以通过参数[HUKS\_EXT\_CRYPTO\_TAG\_PURPOSE](<../@ohos.security.huksExternalCrypto (外部密钥管理)/js-apis-huksexternalcrypto.md#huksexternalcryptotag>)指定获取证书类型，支持的类型包括签名验签、加解密等。 |
