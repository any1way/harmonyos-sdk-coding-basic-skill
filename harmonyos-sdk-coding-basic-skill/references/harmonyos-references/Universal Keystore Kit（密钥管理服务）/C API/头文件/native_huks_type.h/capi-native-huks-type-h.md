...
scraped_at: 2026-06-11T16:13:07+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:3b7041981a31e6d20a884fdb034bb895df4d1cc4a351df6ff48ab8ec1545a63e
---
## 概述
...
| 名称 | 描述 |
| --- | --- |
| [OH\_Huks\_Result](../../结构体/OH_Huks_Result/capi-hukstypeapi-oh-huks-result.md) | 表示状态返回数据，包括返回码和消息。 |
| [OH\_Huks\_Blob](../../结构体/OH_Huks_Blob/capi-hukstypeapi-oh-huks-blob.md) | 定义存放数据的结构体类型。 |
| [OH\_Huks\_Param](../../结构体/OH_Huks_Param/capi-hukstypeapi-oh-huks-param.md) | 定义参数集中的参数结构体类型。 |
| [OH\_Huks\_ParamSet](../../结构体/OH_Huks_ParamSet/capi-hukstypeapi-oh-huks-paramset.md) | 定义参数集的结构体类型。 |
| [OH\_Huks\_CertChain](../../结构体/OH_Huks_CertChain/capi-hukstypeapi-oh-huks-certchain.md) | 定义证书链的结构体类型。 |
| [OH\_Huks\_KeyInfo](../../结构体/OH_Huks_KeyInfo/capi-hukstypeapi-oh-huks-keyinfo.md) | 定义密钥信息的结构体类型。 |
| [OH\_Huks\_PubKeyInfo](../../结构体/OH_Huks_PubKeyInfo/capi-hukstypeapi-oh-huks-pubkeyinfo.md) | 定义公钥信息的结构体类型。 |
| [OH\_Huks\_KeyMaterialRsa](../../结构体/OH_Huks_KeyMaterialRsa/capi-hukstypeapi-oh-huks-keymaterialrsa.md) | 定义Rsa密钥的结构体类型。 |
| [OH\_Huks\_KeyMaterialEcc](../../结构体/OH_Huks_KeyMaterialEcc/capi-hukstypeapi-oh-huks-keymaterialecc.md) | 定义Ecc密钥的结构体类型。 |
| [OH\_Huks\_KeyMaterialDsa](../../结构体/OH_Huks_KeyMaterialDsa/capi-hukstypeapi-oh-huks-keymaterialdsa.md) | 定义Dsa密钥的结构体类型。 |
| [OH\_Huks\_KeyMaterialDh](../../结构体/OH_Huks_KeyMaterialDh/capi-hukstypeapi-oh-huks-keymaterialdh.md) | 定义Dh密钥的结构体类型。 |
| [OH\_Huks\_KeyMaterial25519](../../结构体/OH_Huks_KeyMaterial25519/capi-hukstypeapi-oh-huks-keymaterial25519.md) | 定义25519类型密钥的结构体类型。 |
| [OH\_Huks\_KeyAliasSet](../../结构体/OH_Huks_KeyAliasSet/capi-hukstypeapi-oh-huks-keyaliasset.md) | 定义密钥别名集的结构体类型。 |
...
| OH\_HUKS\_TAG\_TYPE\_BYTES = 5 << 28 | 该Tag的数据类型为[OH\_Huks\_Blob](../../结构体/OH_Huks_Blob/capi-hukstypeapi-oh-huks-blob.md)类型。 |

**参考：**

[OH\_Huks\_Param](../../结构体/OH_Huks_Param/capi-hukstypeapi-oh-huks-param.md)
...
业务在使用存储等级为ECE的密钥时，建议通过感知[锁屏事件](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/进程线程通信/系统定义的公共事件/commoneventmanager-definitions.md#common_event_screen_locked>)来清理使用该密钥创建的会话资源，以保证安全性。
