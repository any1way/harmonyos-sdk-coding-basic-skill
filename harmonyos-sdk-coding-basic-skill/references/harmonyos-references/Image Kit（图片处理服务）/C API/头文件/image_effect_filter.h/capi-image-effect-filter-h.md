...
scraped_at: 2026-06-01T16:22:43+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:d92d7eafee7a1c8cce873464dcee2b17b320ed42b0c9ea6fd4074d6885dc5cce
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ImageEffect\_DataValue](../../结构体/ImageEffect_DataValue/capi-imageeffect-imageeffect-datavalue.md) | ImageEffect\_DataValue | 数据值联合体。 |
| [ImageEffect\_Any](../../结构体/ImageEffect_Any/capi-imageeffect-imageeffect-any.md) | ImageEffect\_Any | 参数结构体。 |
| [ImageEffect\_FilterNames](../../结构体/ImageEffect_FilterNames/capi-imageeffect-imageeffect-filternames.md) | ImageEffect\_FilterNames | 滤镜名信息。 |
| [ImageEffect\_FilterDelegate](../../结构体/ImageEffect_FilterDelegate/capi-imageeffect-imageeffect-filterdelegate.md) | ImageEffect\_FilterDelegate | 自定义滤镜回调函数结构体。 |
| [ImageEffect\_Region](../../结构体/ImageEffect_Region/capi-imageeffect-imageeffect-region.md) | ImageEffect\_Region | 图像区域结构体。 |
| [ImageEffect\_Size](../../结构体/ImageEffect_Size/capi-imageeffect-imageeffect-size.md) | ImageEffect\_Size | 图像尺寸结构体。 |
| [OH\_EffectFilter](../../结构体/OH_EffectFilter/capi-imageeffect-oh-effectfilter.md) | OH\_EffectFilter | 定义滤镜结构类型。 |
| [OH\_EffectFilterInfo](../../结构体/OH_EffectFilterInfo/capi-imageeffect-oh-effectfilterinfo.md) | OH\_EffectFilterInfo | 定义滤镜信息结构体。 |
| [OH\_EffectBufferInfo](../../结构体/OH_EffectBufferInfo/capi-imageeffect-oh-effectbufferinfo.md) | OH\_EffectBufferInfo | 定义图像信息。 |
...
| OH\_EFFECT\_CROP\_FILTER "Crop" | 裁剪滤镜，对应的参数为OH\_EFFECT\_FILTER\_REGION\_KEY，参数类型为[EFFECT\_DATA\_TYPE\_PTR](capi-image-effect-filter-h.md#imageeffect_datatype)，参数值为结构体 [ImageEffect\_Region](../../结构体/ImageEffect_Region/capi-imageeffect-imageeffect-region.md)。  **起始版本：** 12  **系统能力：** SystemCapability.Multimedia.ImageEffect.Core |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilterInfo](../../结构体/OH_EffectFilterInfo/capi-imageeffect-oh-effectfilterinfo.md) \* | 返回一个指向OH\_EffectFilterInfo实例的指针，创建失败时返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_EffectFilterInfo](../../结构体/OH_EffectFilterInfo/capi-imageeffect-oh-effectfilterinfo.md) \*info | 滤镜信息指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](../image_effect_errors.h/capi-image-effect-errors-h.md#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectBufferInfo](../../结构体/OH_EffectBufferInfo/capi-imageeffect-oh-effectbufferinfo.md) \* | 返回一个指向OH\_EffectBufferInfo实例的指针，创建失败时返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_EffectBufferInfo](../../结构体/OH_EffectBufferInfo/capi-imageeffect-oh-effectbufferinfo.md) \*info | 图像信息指针。 |
| void \*addr | 图像虚拟内存地址。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_EffectBufferInfo](../../结构体/OH_EffectBufferInfo/capi-imageeffect-oh-effectbufferinfo.md) \*info | OH\_EffectBufferInfo结构体实例指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](../image_effect_errors.h/capi-image-effect-errors-h.md#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：参数缺失。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_EffectFilter](../../结构体/OH_EffectFilter/capi-imageeffect-oh-effectfilter.md) \*filter | 滤镜指针。 |
| const char \*key | 滤镜参数。 |
| [const ImageEffect\_Any](../../结构体/ImageEffect_Any/capi-imageeffect-imageeffect-any.md) \*value | 滤镜参数值。 |
...
| --- | --- |
| [OH\_EffectFilter](../../结构体/OH_EffectFilter/capi-imageeffect-oh-effectfilter.md) \*filter | 滤镜指针。 |
| [OH\_EffectBufferInfo](../../结构体/OH_EffectBufferInfo/capi-imageeffect-oh-effectbufferinfo.md) \*info | 图像信息OH\_EffectBufferInfo指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilter](../../结构体/OH_EffectFilter/capi-imageeffect-oh-effectfilter.md) \* | 执行成功时返回OH\_EffectFilter实例，否则返回空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilter](../../结构体/OH_EffectFilter/capi-imageeffect-oh-effectfilter.md) \* | 返回一个指向OH\_EffectFilter实例的指针，创建失败时返回空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](../image_effect_errors.h/capi-image-effect-errors-h.md#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针。  EFFECT\_KEY\_ERROR：参数无效。  EFFECT\_PARAM\_ERROR：参数值无效。 |
...
| [OH\_EffectFilter](../../结构体/OH_EffectFilter/capi-imageeffect-oh-effectfilter.md) \*filter | 滤镜指针。 |
| const char \*key | 滤镜参数，例如：OH\_EFFECT\_FILTER\_INTENSITY\_KEY。 |
| [ImageEffect\_Any](../../结构体/ImageEffect_Any/capi-imageeffect-imageeffect-any.md) \*value | 滤镜参数值。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](../image_effect_errors.h/capi-image-effect-errors-h.md#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针。  EFFECT\_KEY\_ERROR：参数无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const OH\_EffectFilterInfo](../../结构体/OH_EffectFilterInfo/capi-imageeffect-oh-effectfilterinfo.md) \*info | 滤镜信息指针OH\_EffectFilterInfo。 |
| [const ImageEffect\_FilterDelegate](../../结构体/ImageEffect_FilterDelegate/capi-imageeffect-imageeffect-filterdelegate.md) \*delegate | 自定义滤镜回调函数ImageEffect\_FilterDelegate。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_FilterNames](../../结构体/ImageEffect_FilterNames/capi-imageeffect-imageeffect-filternames.md) \* | 滤镜名列表。 |
...
| --- | --- |
| const char \*name | 滤镜名。 |
| [OH\_EffectFilterInfo](../../结构体/OH_EffectFilterInfo/capi-imageeffect-oh-effectfilterinfo.md) \*info | 滤镜信息指针OH\_EffectFilterInfo。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](../image_effect_errors.h/capi-image-effect-errors-h.md#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针或其他无效值。 |
...
| --- | --- |
| [OH\_EffectFilter](../../结构体/OH_EffectFilter/capi-imageeffect-oh-effectfilter.md) \*filter | 滤镜指针。 |
| [OH\_PixelmapNative](../../结构体/OH_PixelmapNative/capi-image-nativemodule-oh-pixelmapnative.md) \*inputPixelmap | 输入图像。 |
| [OH\_PixelmapNative](../../结构体/OH_PixelmapNative/capi-image-nativemodule-oh-pixelmapnative.md) \*outputPixelmap | 输出图像。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_EffectFilter](../../结构体/OH_EffectFilter/capi-imageeffect-oh-effectfilter.md) \*filter | OH\_EffectFilter结构体实例指针。 |
