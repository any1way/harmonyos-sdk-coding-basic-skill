...
scraped_at: 2026-06-01T16:22:40+08:00
doc_updated_at: 2026-03-19
content_hash: sha256:4d5f0cdcce094487ff64ebc30a2f6c21b0603ce036168cb44850e5057d4436f3
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_ImageEffect](../../结构体/OH_ImageEffect/capi-imageeffect-oh-imageeffect.md) | OH\_ImageEffect | 定义效果器结构类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_ImageEffect](../../结构体/OH_ImageEffect/capi-imageeffect-oh-imageeffect.md) \* | 返回一个指向OH\_ImageEffect实例的指针，创建失败时返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_ImageEffect](../../结构体/OH_ImageEffect/capi-imageeffect-oh-imageeffect.md) \*imageEffect | 效果器指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilter](../../结构体/OH_EffectFilter/capi-imageeffect-oh-effectfilter.md) \* | 返回一个指向OH\_EffectFilter实例的指针，滤镜名无效时返回空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilter](../../结构体/OH_EffectFilter/capi-imageeffect-oh-effectfilter.md) \* | 返回一个指向OH\_EffectFilter实例的指针，参数无效时返回空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilter](../../结构体/OH_EffectFilter/capi-imageeffect-oh-effectfilter.md) \* | 返回一个指向OH\_EffectFilter实例的指针，替换失败时返回空指针。 |
...
| [OH\_ImageEffect](../../结构体/OH_ImageEffect/capi-imageeffect-oh-imageeffect.md) \*imageEffect | 效果器指针。 |
| const char \*key | 配置参数。 |
| [const ImageEffect\_Any](../../结构体/ImageEffect_Any/capi-imageeffect-imageeffect-any.md) \*value | 配置参数值。 |
...
| --- | --- |
| [OH\_ImageEffect](../../结构体/OH_ImageEffect/capi-imageeffect-oh-imageeffect.md) \*imageEffect | 效果器指针。 |
| [OH\_PixelmapNative](../../结构体/OH_PixelmapNative/capi-image-nativemodule-oh-pixelmapnative.md) \*pixelmap | 指向OH\_PixelmapNative实例的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](../image_effect_errors.h/capi-image-effect-errors-h.md#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针。  EFFECT\_PARAM\_ERROR：如果参数异常导致方法调用失败。 |
...
| --- | --- |
| [OH\_ImageEffect](../../结构体/OH_ImageEffect/capi-imageeffect-oh-imageeffect.md) \*imageEffect | 效果器指针。 |
| [OH\_NativeBuffer](<../../../../ArkGraphics 2D（方舟2D图形服务）/C API/结构体/OH_NativeBuffer/capi-oh-nativebuffer-oh-nativebuffer.md>) \*nativeBuffer | 指向OH\_NativeBuffer实例的指针。 |
...
| --- | --- |
| [OH\_ImageEffect](../../结构体/OH_ImageEffect/capi-imageeffect-oh-imageeffect.md) \*imageEffect | 效果器指针。 |
| [OH\_NativeBuffer](<../../../../ArkGraphics 2D（方舟2D图形服务）/C API/结构体/OH_NativeBuffer/capi-oh-nativebuffer-oh-nativebuffer.md>) \*nativeBuffer | 指向OH\_NativeBuffer实例的指针，允许为空，当输入为空时渲染结果返回到输入的OH\_NativeBuffer对象上。 |
...
| --- | --- |
| [OH\_ImageEffect](../../结构体/OH_ImageEffect/capi-imageeffect-oh-imageeffect.md) \*imageEffect | 效果器指针。 |
| [OH\_PictureNative](../../结构体/OH_PictureNative/capi-image-nativemodule-oh-picturenative.md) \*picture | 指向OH\_PictureNative实例的指针。 |
...
| --- | --- |
| [OH\_ImageEffect](../../结构体/OH_ImageEffect/capi-imageeffect-oh-imageeffect.md) \*imageEffect | 效果器指针。 |
| [OH\_PictureNative](../../结构体/OH_PictureNative/capi-image-nativemodule-oh-picturenative.md) \*picture | 指向OH\_PictureNative实例的指针，允许为空，当输入为空时渲染结果返回到输入的OH\_PictureNative对象上。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_ImageEffect](../../结构体/OH_ImageEffect/capi-imageeffect-oh-imageeffect.md) \*imageEffect | OH\_ImageEffect结构体实例指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](../image_effect_errors.h/capi-image-effect-errors-h.md#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针或参数超出有效范围。  EFFECT\_PARAM\_ERROR：参数缺失或参数错误。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](../image_effect_errors.h/capi-image-effect-errors-h.md#imageeffect_errorcode) | EFFECT\_SUCCESS：方法调用成功。  EFFECT\_ERROR\_PARAM\_INVALID：入参为空指针。  EFFECT\_INPUT\_OUTPUT\_NOT\_SUPPORTED：待处理输入、输出图像数据类型不一致。  EFFECT\_COLOR\_SPACE\_NOT\_MATCH：输入、输出图像色彩空间不匹配。  EFFECT\_ALLOCATE\_MEMORY\_FAILED：内存申请失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_ImageEffect](../../结构体/OH_ImageEffect/capi-imageeffect-oh-imageeffect.md) \* | 反序列化成功时返回OH\_ImageEffect实例，否则返回空指针。 |
