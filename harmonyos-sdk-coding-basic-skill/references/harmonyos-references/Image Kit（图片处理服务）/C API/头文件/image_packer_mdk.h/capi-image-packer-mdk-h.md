...
scraped_at: 2026-06-01T16:22:35+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:5404dc08aceac04f73e89ece92f415feb356aae0a1f93056886d57ec254cd2a4
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ImagePacker\_Opts\_](../../结构体/ImagePacker_Opts_/capi-image-imagepacker-opts-.md) | ImagePacker\_Opts | 定义图像编码选项信息。 |
| [ImagePacker\_Native\_](../../结构体/ImagePacker_Native_/capi-image-imagepacker-native-.md) | ImagePacker\_Native | 为编码器方法定义native层编码器对象。 |
...
| [int32\_t OH\_ImagePacker\_Release(ImagePacker\_Native\* native)](capi-image-packer-mdk-h.md#oh_imagepacker_release) | 释放native层编码器对象[ImagePacker\_Native](../../结构体/ImagePacker_Native_/capi-image-imagepacker-native-.md)。  此API不用于释放JavaScript原生API ImagePacker对象，它用于释放native层对象ImagePacker\_Native。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | [IRNdkErrCode](../image_mdk_common.h/capi-image-mdk-common-h.md#irndkerrcode)：  IMAGE\_RESULT\_SUCCESS：执行成功。  IMAGE\_RESULT\_INVALID\_PARAMETER：参数无效。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImagePacker\_Native](../../结构体/ImagePacker_Native_/capi-image-imagepacker-native-.md)\* | 如果操作成功则返回ImagePacker\_Native指针，否则返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ImagePacker\_Native](../../结构体/ImagePacker_Native_/capi-image-imagepacker-native-.md)\* native | 表明指向native层ImagePacker的指针。 |
| napi\_value source | 表明待编码JavaScript native层PixelMap对象或者ImageSource对象。 |
| [ImagePacker\_Opts](../../结构体/ImagePacker_Opts_/capi-image-imagepacker-opts-.md)\* opts | 表明位图编码的选项。 |
...
释放native层编码器对象[ImagePacker\_Native](../../结构体/ImagePacker_Native_/capi-image-imagepacker-native-.md)。
...
| 参数项 | 描述 |
| --- | --- |
| [ImagePacker\_Native](../../结构体/ImagePacker_Native_/capi-image-imagepacker-native-.md)\* native | 表明native层ImagePacker\_Native值的指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| int32\_t | [IRNdkErrCode](../image_mdk_common.h/capi-image-mdk-common-h.md#irndkerrcode)：  IMAGE\_RESULT\_SUCCESS：执行成功。 |
