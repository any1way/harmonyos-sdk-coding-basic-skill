...
scraped_at: 2026-06-01T16:23:38+08:00
doc_updated_at: 2026-04-10
content_hash: sha256:f0fb7aff703cf7731b7a27162f3d12dc03fe17b98bd1bf6fc6d8c416e4194f44
---
```
...
| 类型 | 说明 |
| --- | --- |
| [OH\_EffectFilterInfo](../OH_EffectFilterInfo/capi-imageeffect-oh-effectfilterinfo.md) | 返回一个指向OH\_EffectFilterInfo实例的指针，创建失败时返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_EffectFilterInfo](../OH_EffectFilterInfo/capi-imageeffect-oh-effectfilterinfo.md) \*info | 滤镜信息指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageEffect\_ErrorCode](../../头文件/image_effect_errors.h/capi-image-effect-errors-h.md#imageeffect_errorcode) | [EFFECT\_SUCCESS](../../头文件/image_effect_errors.h/capi-image-effect-errors-h.md#imageeffect_errorcode)如果方法调用成功。  [EFFECT\_ERROR\_PARAM\_INVALID](../../头文件/image_effect_errors.h/capi-image-effect-errors-h.md#imageeffect_errorcode)如果入参为空指针。 |
...
| --- | --- |
| [OH\_EffectFilterInfo](../OH_EffectFilterInfo/capi-imageeffect-oh-effectfilterinfo.md) \*info | 滤镜信息指针。 |
| uint32\_t size | 滤镜所支持内存类型[ImageEffect\_BufferType](../../头文件/image_effect_filter.h/capi-image-effect-filter-h.md#imageeffect_buffertype)个数。 |
| ImageEffect\_BufferType \*bufferTypeArray | 滤镜所支持内存类型[ImageEffect\_BufferType](../../头文件/image_effect_filter.h/capi-image-effect-filter-h.md#imageeffect_buffertype)数组。 |
...
| --- | --- |
| [OH\_EffectFilterInfo](../OH_EffectFilterInfo/capi-imageeffect-oh-effectfilterinfo.md) \*info | 滤镜信息指针。 |
| uint32\_t size | 滤镜所支持像素格式[ImageEffect\_Format](../../头文件/image_effect_filter.h/capi-image-effect-filter-h.md#imageeffect_format)个数。 |
| ImageEffect\_Format \*formatArray | 滤镜所支持像素格式[ImageEffect\_Format](../../头文件/image_effect_filter.h/capi-image-effect-filter-h.md#imageeffect_format)数组。 |
