...
scraped_at: 2026-06-01T16:22:02+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:7ef67c22b2c7519db8400bcc1bda164130de22571160a50ace82e752499439d8
---
...
各属性详细取值，请参考[PropertyKey](../Enums/arkts-apis-image-e.md#propertykey7)。
...
| orientation | [Orientation](../Enums/arkts-apis-image-e.md#orientation23) | 否 | 是 | 图像方向。 |
...
4. console.info("createInstance successfully.");
5. }
6. }
```
...
要查询的属性的具体信息请参考[PropertyKey](../Enums/arkts-apis-image-e.md#propertykey7)。
...
19. console.error(`Failed to get properties. error.code is ${error.code}, error.message is ${error.message}`);
20. });
21. } else {
...
21. console.info('Succeeded in setting properties.');
...
21. console.error(`Failed to get metadata all properties. error.code is ${error.code}, error.message is ${error.message}`);
22. });
23. } else {
...
20. console.error(`Failed to clone new_metadata. error.code: ${err.code}, error.message: ${err.message}`);
21. });
22. } else {
...
15. let blob = await metaData.exifMetadata.getBlob();
16. if (blob != undefined) {
17. console.info("Succeeded in getting blob.");
