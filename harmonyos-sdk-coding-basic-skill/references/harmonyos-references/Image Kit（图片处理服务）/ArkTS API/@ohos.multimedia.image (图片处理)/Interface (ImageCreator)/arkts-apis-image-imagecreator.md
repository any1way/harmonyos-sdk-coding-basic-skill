...
scraped_at: 2026-06-01T16:21:55+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:5476415489b9e045bb91aab3a697fb8fd62574477edca9ee7082e18571f9c6d0
---
ImageCreator类，作为图片的生产者，用于将图片写入到Surface中。

在调用以下方法前需要先通过[image.createImageCreator](../Functions/arkts-apis-image-f.md#imagecreateimagecreator11)创建ImageCreator实例，ImageCreator不支持多线程。
...
| format9+ | [ImageFormat](../Enums/arkts-apis-image-e.md#imageformat9) | 是 | 否 | 图像格式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[Image](<../Interface (Image)/arkts-apis-image-image.md>)> | 是 | 回调函数，当获取最新图片成功，err为undefined，data为获取到的最新图片；否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [Image](<../Interface (Image)/arkts-apis-image-image.md>) | 是 | 绘制好的buffer图像。 |
