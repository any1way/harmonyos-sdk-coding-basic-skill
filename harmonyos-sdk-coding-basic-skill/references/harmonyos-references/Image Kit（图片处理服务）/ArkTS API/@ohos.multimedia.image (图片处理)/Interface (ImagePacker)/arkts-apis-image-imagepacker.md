...
scraped_at: 2026-06-01T16:21:56+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:ff196a20b90788e8c2940ff127b38ebb657e14f7ae03b30388a0c6481d8e4d4d
---
ImagePacker类，用于图片压缩和编码。

在调用ImagePacker的方法前，需要先通过[image.createImagePacker](../Functions/arkts-apis-image-f.md#imagecreateimagepacker)构建一个ImagePacker实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [ImageSource](<../Interface (ImageSource)/arkts-apis-image-imagesource.md>) | 是 | 编码的ImageSource。 |
| options | [PackingOption](<../Interfaces (其他)/arkts-apis-image-i.md#packingoption>) | 是 | 设置编码参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [PixelMap](<../Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 编码的PixelMap源。 |
| options | [PackingOption](<../Interfaces (其他)/arkts-apis-image-i.md#packingoption>) | 是 | 设置编码参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| picture | [Picture](<../Interface (Picture)/arkts-apis-image-picture.md>) | 是 | 编码的Picture对象。 |
| options | [PackingOption](<../Interfaces (其他)/arkts-apis-image-i.md#packingoption>) | 是 | 设置编码参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pixelmapSequence | Array<[PixelMap](<../Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | 是 | 待编码的PixelMap序列。 |
| options | [PackingOptionsForSequence](<../Interfaces (其他)/arkts-apis-image-i.md#packingoptionsforsequence18>) | 是 | 动图编码参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [PixelMap](<../Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 编码的PixelMap资源。 |
| fd | number | 是 | 文件描述符。取值范围为[0，65535]。 |
| options | [PackingOption](<../Interfaces (其他)/arkts-apis-image-i.md#packingoption>) | 是 | 设置编码参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| picture | [Picture](<../Interface (Picture)/arkts-apis-image-picture.md>) | 是 | 编码的Picture资源。 |
| fd | number | 是 | 文件描述符。取值范围为[0，65535]。 |
| options | [PackingOption](<../Interfaces (其他)/arkts-apis-image-i.md#packingoption>) | 是 | 设置编码参数。 |
...
| --- | --- | --- | --- |
| source | [ImageSource](<../Interface (ImageSource)/arkts-apis-image-imagesource.md>) | 是 | 编码的ImageSource。 |
| option | [PackingOption](<../Interfaces (其他)/arkts-apis-image-i.md#packingoption>) | 是 | 设置编码参数。 |
