...
content_hash: sha256:dae5ff7b68839344c35b069c39ba765b50329cee2fc9ff9426cfc2185e6eb5c1
---
...
要查询的属性的具体信息请参考[HeifsPropertyKey](../Enums/arkts-apis-image-e.md#heifspropertykey23)。
...
17. console.info('Succeeded in getting properties. ',JSON.stringify(data));
...
20. console.info('Succeeded in setting properties.');
...
17. console.info("Succeeding in getting blob.");
18. }
19. }
20. }
```
