...
scraped_at: 2026-06-01T16:22:04+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:2187f898fd945c9fa9eb7652a5ae8ceddfc51bf9b7730017ebe39c018f45e6ff
---
...
| xmageWatermarkMode | number | 否 | 是 | XMAGE水印模式。具体取值请参考[Constants](../Constants/arkts-apis-image-c.md)。 |
...
| xmageColorMode | [XmageColorMode](../Enums/arkts-apis-image-e.md#xmagecolormode23) | 否 | 是 | XMAGE颜色模式。 |
...
| focusMode | [FocusMode](../Enums/arkts-apis-image-e.md#focusmode23) | 否 | 是 | 镜头对焦控制策略，决定相机如何调整焦距。 |
...
20. console.error(`Failed to clone new_metadata. error : ${err}`);
21. });
22. } else {
23. console.error('Metadata is null.');
24. }
