...
scraped_at: 2026-06-01T15:55:49+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:6a0601a0108fe3bbeafbde34fd8dd9b2e1e1d1a870a0c0cb575f9d631829f8cf
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkWeb\_JavaScriptBridgeData](../../结构体/ArkWeb_JavaScriptBridgeData/capi-web-arkweb-javascriptbridgedata.md) | ArkWeb\_JavaScriptBridgeData | 定义JavaScript Bridge数据的基础结构。 |
| [ArkWeb\_WebMessage\*](../../结构体/ArkWeb_WebMessage/capi-web-arkweb-webmessage8h.md) | ArkWeb\_WebMessagePtr | Post Message数据结构体指针。 |
| [ArkWeb\_JavaScriptValue\*](../../结构体/ArkWeb_JavaScriptValue/capi-web-arkweb-javascriptvalue8h.md) | ArkWeb\_JavaScriptValuePtr | JavaScript数据结构体指针。 |
| [ArkWeb\_WebMessagePort\*](../../结构体/ArkWeb_WebMessagePort/capi-web-arkweb-webmessageport8h.md) | ArkWeb\_WebMessagePortPtr | Post Message端口结构体指针。 |
| [ArkWeb\_JavaScriptObject](../../结构体/ArkWeb_JavaScriptObject/capi-web-arkweb-javascriptobject.md) | ArkWeb\_JavaScriptObject | 注入的JavaScript结构体。 |
| [ArkWeb\_ProxyMethod](../../结构体/ArkWeb_ProxyMethod/capi-web-arkweb-proxymethod.md) | ArkWeb\_ProxyMethod | 注入的Proxy方法通用结构体。 |
| [ArkWeb\_ProxyMethodWithResult](../../结构体/ArkWeb_ProxyMethodWithResult/capi-web-arkweb-proxymethodwithresult.md) | ArkWeb\_ProxyMethodWithResult | 注入的Proxy方法通用结构体。 |
| [ArkWeb\_ProxyObject](../../结构体/ArkWeb_ProxyObject/capi-web-arkweb-proxyobject.md) | ArkWeb\_ProxyObject | 注入的Proxy对象通用结构体。 |
| [ArkWeb\_ProxyObjectWithResult](../../结构体/ArkWeb_ProxyObjectWithResult/capi-web-arkweb-proxyobjectwithresult.md) | ArkWeb\_ProxyObjectWithResult | 注入的Proxy对象通用结构体。 |
| [ArkWeb\_ControllerAPI](../../结构体/ArkWeb_ControllerAPI/capi-web-arkweb-controllerapi.md) | ArkWeb\_ControllerAPI | Controller相关的Native API结构体。在调用接口前建议通过ARKWEB\_MEMBER\_MISSING校验该函数结构体是否有对应函数指针，避免SDK与设备ROM不匹配导致崩溃。Controller相关接口需在UI线程中调用OH\_ArkWeb\_GetNativeAPI方法获取。 |
| [ArkWeb\_ComponentAPI](../../结构体/ArkWeb_ComponentAPI/capi-web-arkweb-componentapi.md) | ArkWeb\_ComponentAPI | Component相关的Native API结构体。 |
| [ArkWeb\_WebMessagePortAPI](../../结构体/ArkWeb_WebMessagePortAPI/capi-web-arkweb-webmessageportapi.md) | ArkWeb\_WebMessagePortAPI | Post Message相关的Native API结构体。在调用接口前建议通过ARKWEB\_MEMBER\_MISSING校验该函数结构体是否有对应函数指针，避免SDK与设备ROM不匹配导致崩溃。WebMessagePort相关接口需在UI线程中调用OH\_ArkWeb\_GetNativeAPI方法获取。 |
| [ArkWeb\_WebMessageAPI](../../结构体/ArkWeb_WebMessageAPI/capi-web-arkweb-webmessageapi.md) | ArkWeb\_WebMessageAPI | Post Message数据相关的Native API结构体。在调用接口前建议通过ARKWEB\_MEMBER\_MISSING校验该函数结构体是否有对应函数指针，避免SDK与设备ROM不匹配导致崩溃。WebMessage相关接口需在UI线程中调用OH\_ArkWeb\_GetNativeAPI方法获取。 |
| [ArkWeb\_CookieManagerAPI](../../结构体/ArkWeb_CookieManagerAPI/capi-web-arkweb-cookiemanagerapi.md) | ArkWeb\_CookieManagerAPI | 定义了ArkWeb的CookieManager接口。在调用接口之前，建议使用ARKWEB\_MEMBER\_MISSING检查函数结构体是否有对应的函数指针，避免SDK与设备ROM不匹配导致崩溃。CookieManager相关接口需在UI线程中调用OH\_ArkWeb\_GetNativeAPI方法获取。 |
| [ArkWeb\_JavaScriptValueAPI](../../结构体/ArkWeb_JavaScriptValueAPI/capi-web-arkweb-javascriptvalueapi.md) | ArkWeb\_JavaScriptValueAPI | 定义了ArkWeb的JavaScriptValue接口。在调用接口之前，建议使用ARKWEB\_MEMBER\_MISSING检查函数结构体是否有对应的函数指针，避免SDK与设备ROM不匹配导致崩溃。 |
...
| const [ArkWeb\_JavaScriptBridgeData](../../结构体/ArkWeb_JavaScriptBridgeData/capi-web-arkweb-javascriptbridgedata.md)\* data | JavaScriptBridge数据。 |
...
| --- | --- |
| const char\* webTag | Web组件名称。 |
| const [ArkWeb\_JavaScriptBridgeData](../../结构体/ArkWeb_JavaScriptBridgeData/capi-web-arkweb-javascriptbridgedata.md)\* dataArray | 数组数据。 |
...
| --- | --- |
| const char\* webTag | Web组件名称。 |
| const [ArkWeb\_WebMessagePortPtr](../../结构体/ArkWeb_WebMessagePort/capi-web-arkweb-webmessageport8h.md) port | Post Message端口。 |
| const [ArkWeb\_WebMessagePtr](../../结构体/ArkWeb_WebMessage/capi-web-arkweb-webmessage8h.md) message | Post Message数据。 |
