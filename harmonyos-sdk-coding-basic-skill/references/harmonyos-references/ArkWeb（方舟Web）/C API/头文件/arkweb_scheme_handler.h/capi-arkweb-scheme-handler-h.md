...
scraped_at: 2026-06-11T16:01:53+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:2c3aa6515c6c62362481af489bd11469b957d5281f98e86a0d977d71624bb4b4
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkWeb\_SchemeHandler\_](../../结构体/ArkWeb_SchemeHandler_/capi-web-arkweb-schemehandler.md) | ArkWeb\_SchemeHandler | 该类用于拦截指定scheme的请求。 |
| [ArkWeb\_ResourceHandler\_](../../结构体/ArkWeb_ResourceHandler_/capi-web-arkweb-resourcehandler.md) | ArkWeb\_ResourceHandler | 用于被拦截的URL请求。可以通过ArkWeb\_ResourceHandler发送自定义请求头以及自定义请求体。 |
| [ArkWeb\_Response\_](../../结构体/ArkWeb_Response_/capi-web-arkweb-response.md) | ArkWeb\_Response | 为被拦截的请求构造一个ArkWeb\_Response。 |
| [ArkWeb\_ResourceRequest\_](../../结构体/ArkWeb_ResourceRequest_/capi-web-arkweb-resourcerequest.md) | ArkWeb\_ResourceRequest | 对应内核的一个请求，可以通过OH\_ArkWebResourceRequest\_系列接口获取请求的URL、method、post data以及其他信息。如通过[OH\_ArkWebResourceRequest\_GetUrl](capi-arkweb-scheme-handler-h.md#oh_arkwebresourcerequest_geturl)获取请求的URL。 |
| [ArkWeb\_RequestHeaderList\_](../../结构体/ArkWeb_RequestHeaderList_/capi-web-arkweb-requestheaderlist.md) | ArkWeb\_RequestHeaderList | 请求头列表。 |
| [ArkWeb\_HttpBodyStream\_](../../结构体/ArkWeb_HttpBodyStream_/capi-web-arkweb-httpbodystream.md) | ArkWeb\_HttpBodyStream | 请求的上传数据。使用OH\_ArkWebHttpBodyStream\_接口来读取上传的数据。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_SchemeHandler](../../结构体/ArkWeb_SchemeHandler_/capi-web-arkweb-schemehandler.md)\* schemeHandler | ArkWeb\_SchemeHandler。 |
| [ArkWeb\_ResourceRequest](../../结构体/ArkWeb_ResourceRequest_/capi-web-arkweb-resourcerequest.md)\* resourceRequest | 通过该对象获取请求的信息。 |
| const [ArkWeb\_ResourceHandler](../../结构体/ArkWeb_ResourceHandler_/capi-web-arkweb-resourcehandler.md)\* resourceHandler | 请求的ArkWeb\_ResourceHandler。如果intercept设置为false，则不应使用它。 |
...
| --- | --- |
| const [ArkWeb\_SchemeHandler](../../结构体/ArkWeb_SchemeHandler_/capi-web-arkweb-schemehandler.md)\* schemeHandler | ArkWeb\_SchemeHandler。 |
| const [ArkWeb\_ResourceRequest](../../结构体/ArkWeb_ResourceRequest_/capi-web-arkweb-resourcerequest.md)\* resourceRequest | ArkWeb\_ResourceRequest。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_HttpBodyStream](../../结构体/ArkWeb_HttpBodyStream_/capi-web-arkweb-httpbodystream.md)\* httpBodyStream | ArkWeb\_HttpBodyStream。 |
| uint8\_t\* buffer | 接收数据的buffer。 |
| int bytesRead | OH\_ArkWebHttpBodyStream\_Read后的回调函数。如果bytesRead大于0，则表示buffer已填充了bytesRead大小的数据。开发者可以从buffer中读取数据，如果OH\_ArkWebHttpBodyStream\_IsEOF为false，则开发者可以继续读取剩余的数据。 |
...
| --- | --- |
| const [ArkWeb\_HttpBodyStream](../../结构体/ArkWeb_HttpBodyStream_/capi-web-arkweb-httpbodystream.md)\* httpBodyStream | ArkWeb\_HttpBodyStream。 |
| [ArkWeb\_NetError](../arkweb_net_error_list.h/capi-arkweb-net-error-list-h.md#arkweb_neterror) result | 成功时返回ARKWEB\_NET\_OK，否则请参考[arkweb\_net\_error\_list.h](../arkweb_net_error_list.h/capi-arkweb-net-error-list-h.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_RequestHeaderList](../../结构体/ArkWeb_RequestHeaderList_/capi-web-arkweb-requestheaderlist.md)\* requestHeaderList | 将被销毁的ArkWeb\_RequestHeaderList。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_RequestHeaderList](../../结构体/ArkWeb_RequestHeaderList_/capi-web-arkweb-requestheaderlist.md)\* requestHeaderList | 请求头的列表。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_ResourceRequest](../../结构体/ArkWeb_ResourceRequest_/capi-web-arkweb-resourcerequest.md)\* resourceRequest | ArkWeb\_ResourceRequest。 |
...
| --- | --- |
| const [ArkWeb\_ResourceRequest](../../结构体/ArkWeb_ResourceRequest_/capi-web-arkweb-resourcerequest.md)\* resourceRequest | ArkWeb\_ResourceRequest。 |
| [ArkWeb\_HttpBodyStream](../../结构体/ArkWeb_HttpBodyStream_/capi-web-arkweb-httpbodystream.md)\*\* httpBodyStream | 请求的上传数据。此函数将为httpBodyStream分配内存，调用者必须使用OH\_ArkWebResourceRequest\_DestroyHttpBodyStream释放httpBodyStream。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_HttpBodyStream](../../结构体/ArkWeb_HttpBodyStream_/capi-web-arkweb-httpbodystream.md)\* httpBodyStream | 待销毁的httpBodyStream。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_HttpBodyStream](../../结构体/ArkWeb_HttpBodyStream_/capi-web-arkweb-httpbodystream.md)\* httpBodyStream | ArkWeb\_HttpBodyStream。 |
...
| --- | --- |
| const [ArkWeb\_ResourceRequest](../../结构体/ArkWeb_ResourceRequest_/capi-web-arkweb-resourcerequest.md)\* resourceRequest | ArkWeb\_ResourceRequest。 |
| [ArkWeb\_RequestHeaderList](../../结构体/ArkWeb_RequestHeaderList_/capi-web-arkweb-requestheaderlist.md)\*\* requestHeaderList | 请求的请求头列表。 |
...
| [ArkWeb\_SchemeHandler](../../结构体/ArkWeb_SchemeHandler_/capi-web-arkweb-schemehandler.md)\* schemeHandler | 该scheme的拦截器ArkWeb\_SchemeHandler。只有通过ServiceWorker触发的请求才会通过这个schemeHandler进行通知。 |
...
| [ArkWeb\_SchemeHandler](../../结构体/ArkWeb_SchemeHandler_/capi-web-arkweb-schemehandler.md)\* schemeHandler | 该scheme的拦截器ArkWeb\_SchemeHandler。只有从指定web触发的请求才会通过这个schemeHandler进行通知。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_SchemeHandler](../../结构体/ArkWeb_SchemeHandler_/capi-web-arkweb-schemehandler.md)\*\* schemeHandler | 返回创建的ArkWeb\_SchemeHandler。在不需要时使用[OH\_ArkWeb\_DestroySchemeHandler](capi-arkweb-scheme-handler-h.md#oh_arkweb_destroyschemehandler)销毁它。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_SchemeHandler](../../结构体/ArkWeb_SchemeHandler_/capi-web-arkweb-schemehandler.md)\* schemeHandler | 待销毁的ArkWeb\_SchemeHandler。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_SchemeHandler](../../结构体/ArkWeb_SchemeHandler_/capi-web-arkweb-schemehandler.md)\* schemeHandler | ArkWeb\_SchemeHandler。 |
| void\* userData | 要设置的用户数据。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_SchemeHandler](../../结构体/ArkWeb_SchemeHandler_/capi-web-arkweb-schemehandler.md)\* schemeHandler | 该scheme的SchemeHandler。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_Response](../../结构体/ArkWeb_Response_/capi-web-arkweb-response.md)\*\* response | 返回创建的ArkWeb\_Response。在不需要时使用OH\_ArkWeb\_DestroyResponse进行销毁。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_Response](../../结构体/ArkWeb_Response_/capi-web-arkweb-response.md)\* response | 待销毁的ArkWeb\_Response。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_Response](../../结构体/ArkWeb_Response_/capi-web-arkweb-response.md)\* response | ArkWeb\_Response。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_Response](../../结构体/ArkWeb_Response_/capi-web-arkweb-response.md)\* response | ArkWeb\_Response。 |
| char\*\* url | 解析后的URL。 |
...
| --- | --- |
| [ArkWeb\_Response](../../结构体/ArkWeb_Response_/capi-web-arkweb-response.md)\* response | ArkWeb\_Response。 |
| [ArkWeb\_NetError](../arkweb_net_error_list.h/capi-arkweb-net-error-list-h.md#arkweb_neterror) errorCode | 失败请求的错误码。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkWeb\_NetError](../arkweb_net_error_list.h/capi-arkweb-net-error-list-h.md#arkweb_neterror) | ArkWeb\_Response的错误码。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_ResourceHandler](../../结构体/ArkWeb_ResourceHandler_/capi-web-arkweb-resourcehandler.md)\* resourceHandler | ArkWeb\_ResourceHandler。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_ResourceHandler](../../结构体/ArkWeb_ResourceHandler_/capi-web-arkweb-resourcehandler.md)\* resourceHandler | 该请求的ArkWeb\_ResourceHandler。 |
| const [ArkWeb\_Response](../../结构体/ArkWeb_Response_/capi-web-arkweb-response.md)\* response | 该拦截请求的ArkWeb\_Response。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_ResourceHandler](../../结构体/ArkWeb_ResourceHandler_/capi-web-arkweb-resourcehandler.md)\* resourceHandler | 用于被拦截的URL请求。可以通过ArkWeb\_ResourceHandler发送自定义请求头以及自定义请求体。 |
| [ArkWeb\_NetError](../arkweb_net_error_list.h/capi-arkweb-net-error-list-h.md#arkweb_neterror) errorCode | 该请求的错误码。请参考[arkweb\_net\_error\_list.h](../arkweb_net_error_list.h/capi-arkweb-net-error-list-h.md)。 |
