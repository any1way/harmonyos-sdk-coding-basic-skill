...
scraped_at: 2026-06-01T15:56:12+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:ce1f858dd53122998b8ae77b5348b0a3744c6b3f09e56f0849f8bc17738f08fc
---
```
...
Post Message相关的Native API结构体。在调用接口前建议通过[ARKWEB\_MEMBER\_MISSING](../../头文件/arkweb_type.h/capi-arkweb-type-h.md#宏定义)校验该函数结构体是否有对应函数指针，避免SDK与设备ROM不匹配导致崩溃。WebMessagePort相关接口需在UI线程中调用OH\_ArkWeb\_GetNativeAPI方法获取。
...
| 参数项 | 描述 |
| --- | --- |
| const [ArkWeb\_WebMessagePortPtr](../ArkWeb_WebMessagePort/capi-web-arkweb-webmessageport8h.md) webMessagePort | Post Message端口结构体指针。 |
| const char\* webTag | Web组件名称。 |
| const [ArkWeb\_WebMessagePtr](../ArkWeb_WebMessage/capi-web-arkweb-webmessage8h.md) webMessage | 需要发送的消息。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkWeb\_ErrorCode](../../头文件/arkweb_error_code.h/capi-arkweb-error-code-h.md#arkweb_errorcode) | [ARKWEB\_SUCCESS](../../头文件/arkweb_error_code.h/capi-arkweb-error-code-h.md#arkweb_errorcode) 执行成功。  [ARKWEB\_INVALID\_PARAM](../../头文件/arkweb_error_code.h/capi-arkweb-error-code-h.md#arkweb_errorcode) 参数无效。  [ARKWEB\_INIT\_ERROR](../../头文件/arkweb_error_code.h/capi-arkweb-error-code-h.md#arkweb_errorcode) 初始化失败，没有找到与webTag绑定的Web组件。 |
...
| const [ArkWeb\_WebMessagePortPtr](../ArkWeb_WebMessagePort/capi-web-arkweb-webmessageport8h.md) webMessagePort | Post Message端口结构体指针。 |
| const char\* webTag | Web组件名称。 |
| [ArkWeb\_OnMessageEventHandler](../../头文件/arkweb_type.h/capi-arkweb-type-h.md#arkweb_onmessageeventhandler) messageEventHandler | 处理消息的回调。 |
