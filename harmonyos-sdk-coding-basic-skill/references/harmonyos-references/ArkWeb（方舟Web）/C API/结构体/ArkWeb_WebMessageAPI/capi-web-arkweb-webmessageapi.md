...
scraped_at: 2026-06-11T16:02:19+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:53f7f37c3f29dc510571f738ed857eb160dfb2ef4baf90b5fad5e1a01766a3a0
---
```
...
Post Message数据相关的Native API结构体。在调用接口前建议通过[ARKWEB\_MEMBER\_MISSING](../../头文件/arkweb_type.h/capi-arkweb-type-h.md#宏定义)校验该函数结构体是否有对应函数指针，避免SDK与设备ROM不匹配导致崩溃。WebMessage相关接口需在UI线程中调用OH\_ArkWeb\_GetNativeAPI方法获取。
...
| 类型 | 说明 |
| --- | --- |
| [ArkWeb\_WebMessagePtr](../ArkWeb_WebMessage/capi-web-arkweb-webmessage8h.md) | 消息结构体指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_WebMessagePtr](../ArkWeb_WebMessage/capi-web-arkweb-webmessage8h.md)\* webMessage | 需要销毁的消息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkWeb\_WebMessagePtr](../ArkWeb_WebMessage/capi-web-arkweb-webmessage8h.md) webMessage | 消息结构体指针。 |
| [ArkWeb\_WebMessageType](../../头文件/arkweb_type.h/capi-arkweb-type-h.md#arkweb_webmessagetype) type | 消息类型。 |
