...
content_hash: sha256:00a369d1a3757304a3a2bae59b71f221dd5849ab7ba9f5659b06c7300134ab36
---
实现长按页面元素或鼠标右键弹出的菜单信息。示例代码参考[onContextMenuShow](../事件/arkts-basic-components-web-events.md#oncontextmenushow9)。
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuMediaType](../Enums/arkts-basic-components-web-e.md#contextmenumediatype9) | 网页元素媒体类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuSourceType](../Enums/arkts-basic-components-web-e.md#contextmenusourcetype9) | 菜单事件来源。 |
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuInputFieldType](../Enums/arkts-basic-components-web-e.md#contextmenuinputfieldtype9) | 输入框类型。 |
...
| 类型 | 说明 |
| --- | --- |
| number | 网页元素可编辑标识，参照[ContextMenuEditStateFlags](../Enums/arkts-basic-components-web-e.md#contextmenueditstateflags9)。 |
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuDataMediaType](../Enums/arkts-basic-components-web-e.md#contextmenudatamediatype22) | 网页元素媒体类型。 |
