...
scraped_at: 2026-06-11T16:01:16+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:4b3db46c2c66e7932730ee9769c32afd6c1133fe36b9f383af87f1a30904b2a8
---
通用事件仅支持[onAppear](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/组件变化事件/挂载卸载事件/ts-universal-events-show-hide.md#onappear)、[onDisAppear](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/组件变化事件/挂载卸载事件/ts-universal-events-show-hide.md#ondisappear)、[onBlur](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/焦点事件/ts-universal-focus-event.md#onblur)、[onFocus](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/焦点事件/ts-universal-focus-event.md#onfocus)、[onDragEnd](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragend10)、[onDragEnter](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragenter)、[onDragStart](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)、[onDragMove](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragmove)、[onDragLeave](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragleave)、[onDrop](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondrop)、[onHover](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/交互响应事件/悬浮事件/ts-universal-events-hover.md#onhover)、[onMouse](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md#onmouse)、[onKeyEvent](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/基础输入事件/按键事件/ts-universal-events-key.md#onkeyevent)、[onTouch](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)、[onVisibleAreaChange](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/组件变化事件/组件可见区域变化事件/ts-universal-component-visible-area-change-event.md#onvisibleareachange)。
...
网页触发alert()告警弹窗时触发回调。若不调用[handleCancel](<../Class (JsResult)/arkts-basic-components-web-jsresult.md#handlecancel>)或[handleConfirm](<../Class (JsResult)/arkts-basic-components-web-jsresult.md#handleconfirm>)接口，会造成render进程阻塞。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnAlertEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onalertevent12), boolean> | 是 | 网页触发alert()告警弹窗时触发。  返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认和取消），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终确认结果。当回调返回false时，弹窗的处理结果会被视为取消。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnBeforeUnloadEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onbeforeunloadevent12), boolean> | 是 | 即将完成页面刷新或关闭当前页面时触发。  返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认和取消），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终是否离开当前页面。当回调返回false时，函数中绘制的自定义弹窗无效。 |
...
网页调用confirm()告警时触发此回调。若不调用[handleCancel](<../Class (JsResult)/arkts-basic-components-web-jsresult.md#handlecancel>)或[handleConfirm](<../Class (JsResult)/arkts-basic-components-web-jsresult.md#handleconfirm>)接口，会造成render进程阻塞。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnConfirmEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onconfirmevent12), boolean> | 是 | 网页调用confirm()告警时触发。  返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认和取消），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终确认结果。当回调返回false时，弹窗的处理结果会被视为取消。 |
...
网页调用prompt()告警时触发此回调。若不调用[handleCancel](<../Class (JsResult)/arkts-basic-components-web-jsresult.md#handlecancel>)或[handlePromptConfirm](<../Class (JsResult)/arkts-basic-components-web-jsresult.md#handlepromptconfirm9>)接口，会造成render进程阻塞。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPromptEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onpromptevent12), boolean> | 是 | 网页调用prompt()告警时触发。  返回值boolean。当回调返回true时，应用可以调用自定义弹窗能力（包括确认、取消和输入），并且需要根据用户的确认或取消操作调用JsResult通知Web组件最终处理结果。当回调返回false时，弹窗的处理结果会被视为取消。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnConsoleEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onconsoleevent12), boolean> | 是 | 网页收到JavaScript控制台消息时触发。  返回值boolean。当返回true时，该条消息将不会再打印至hilog日志，返回false时仍会打印至hilog日志。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnDownloadStartEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#ondownloadstartevent12)> | 是 | 开始下载时触发。 |
...
网页加载遇到错误时触发该回调。主资源与子资源出错都会回调该接口，可以通过[isMainFrame](<../Class (WebResourceRequest)/arkts-basic-components-web-webresourcerequest.md#ismainframe>)来判断是否是主资源报错。出于性能考虑，建议此回调中尽量执行简单逻辑。在无网络的情况下，触发此回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnErrorReceiveEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onerrorreceiveevent12)> | 是 | 网页收到 Web 资源加载错误时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnHttpErrorReceiveEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onhttperrorreceiveevent12)> | 是 | 网页收到加载资源返回HTTP错误码时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPageBeginEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onpagebeginevent12)> | 是 | 网页加载开始时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPageEndEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onpageendevent12)> | 是 | 网页加载结束时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnLoadStartedEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onloadstartedevent20)> | 是 | 网页加载开始时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnLoadFinishedEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onloadfinishedevent20)> | 是 | 网页加载结束时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnProgressChangeEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onprogresschangeevent12)> | 是 | 页面加载进度变化时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnTitleReceiveEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#ontitlereceiveevent12)> | 是 | 页面文档标题发生变更时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnRefreshAccessedHistoryEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onrefreshaccessedhistoryevent12)> | 是 | 在导航完成时触发。 |
...
应用处理该回调时，可以调用绑定的webviewController相关接口来恢复页面。例如[refresh](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#refresh>)、[loadUrl](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#loadurl>)等。

组件生命周期回调详情可参考[Web组件的生命周期](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/Web组件的生命周期/web-event-sequence.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnRenderExitedEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onrenderexitedevent12)> | 是 | 渲染过程退出时触发。 |
...
应用可以通过WebviewController接口[terminateRenderProcess](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#terminaterenderprocess12>)来终止关联的渲染进程，这可能会影响同一渲染进程的其他Web组件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnRenderProcessNotRespondingCallback](../Types/arkts-basic-components-web-t.md#onrenderprocessnotrespondingcallback12) | 是 | 渲染进程无响应时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnRenderProcessRespondingCallback](../Types/arkts-basic-components-web-t.md#onrenderprocessrespondingcallback12) | 是 | 渲染进程由无响应状态变回正常运行状态时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnShowFileSelectorEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onshowfileselectorevent12), boolean> | 是 | 用于通知Web组件文件选择的结果。  返回值boolean。当返回值为true时，用户可以调用系统提供的弹窗能力。当返回值为false时，函数中绘制的自定义弹窗无效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnResourceLoadEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onresourceloadevent12)> | 是 | 加载url时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnScaleChangeEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onscalechangeevent12)> | 是 | 当页面显示比例发生变化时，触发该回调。 |
...
当Web组件加载URL之前触发该回调，用于拦截URL并返回响应数据。onInterceptRequest可拦截所有跳转请求并返回响应数据，但无法访问POST请求体（Body）内容，且不支持分片缓冲（buffer）类型数据获取。此类场景需改用[WebSchemeHandler](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebSchemeHandler)/arkts-apis-webview-webschemehandler.md>)实现，依据具体业务需求进行判断。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnInterceptRequestEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#oninterceptrequestevent12), [WebResourceResponse](<../Class (WebResourceResponse)/arkts-basic-components-web-webresourceresponse.md>)> | 是 | 当Web组件加载url之前触发。  返回值[WebResourceResponse](<../Class (WebResourceResponse)/arkts-basic-components-web-webresourceresponse.md>)。返回响应数据则按照响应数据加载，无响应数据则返回null表示按照原来的方式加载。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnHttpAuthRequestEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onhttpauthrequestevent12), boolean> | 是 | 当浏览器需要用户的凭据时触发。  返回值boolean。返回true表示http auth认证成功，返回false表示http auth认证失败。 |
...
* 应用程序需要调用[handler.handleCancel()](<../Class (SslErrorHandler)/arkts-basic-components-web-sslerrorhandler.md#handlecancel9>)或[handler.handleConfirm()](<../Class (SslErrorHandler)/arkts-basic-components-web-sslerrorhandler.md#handleconfirm9>)处理该回调，如果没有处理该回调则默认取消资源加载。handleConfirm()或者handleCancel()的行为可能会被记录下来，以便为将来的SSL错误做出响应。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnSslErrorEventReceiveEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onsslerroreventreceiveevent12)> | 是 | 当网页收到SSL错误时触发。 |
...
通知用户加载资源（主资源+子资源）时发生SSL错误，如果只想处理主资源的SSL错误，请用[isMainFrame](<../Class (WebResourceRequest)/arkts-basic-components-web-webresourcerequest.md#ismainframe>)字段进行区分。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnSslErrorEventCallback](../Types/arkts-basic-components-web-t.md#onsslerroreventcallback12) | 是 | 通知用户加载资源时发生SSL错误。 |
...
* Web组件有三种响应方式：[ClientAuthenticationHandler.confirm](<../Class (ClientAuthenticationHandler)/arkts-web-clientauthenticationhandler.md#confirm10>)（继续）、[ClientAuthenticationHandler.cancel](<../Class (ClientAuthenticationHandler)/arkts-web-clientauthenticationhandler.md#cancel9>)（取消）或[ClientAuthenticationHandler.ignore](<../Class (ClientAuthenticationHandler)/arkts-web-clientauthenticationhandler.md#ignore9>)（忽略）。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnClientAuthenticationEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onclientauthenticationevent12)> | 是 | 当需要用户提供的SSL客户端证书时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnVerifyPinCallback](../Types/arkts-basic-components-web-t.md#onverifypincallback22) | 是 | 当需要用户进行PIN码认证时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPermissionRequestEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onpermissionrequestevent12)> | 是 | 通知收到获取权限请求触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnContextMenuShowEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#oncontextmenushowevent12), boolean> | 是 | 调用时触发的回调，以允许自定义显示上下文菜单。  返回值boolean。返回true表示触发自定义菜单，返回false表示触发的自定义菜单无效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnContextMenuHideCallback](../Types/arkts-basic-components-web-t.md#oncontextmenuhidecallback11) | 是 | 菜单相关回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnScrollEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onscrollevent12)> | 是 | 当页面滚动到指定位置时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnGeolocationShowEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#ongeolocationshowevent12)> | 是 | 回调函数，请求显示地理位置权限时触发，返回地理位置信息请求对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnFullScreenEnterCallback](../Types/arkts-basic-components-web-t.md#onfullscreenentercallback12) | 是 | Web组件进入全屏时的回调信息。 |
...
若不调用[setWebController](<../Class (ControllerHandler)/arkts-basic-components-web-controllerhandler.md#setwebcontroller9>)接口，会造成render进程阻塞。

如果没有创建新窗口，调用[setWebController](<../Class (ControllerHandler)/arkts-basic-components-web-controllerhandler.md#setwebcontroller9>)接口时设置成null，通知Web没有创建新窗口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnWindowNewEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onwindownewevent12)> | 是 | 网页要求用户创建窗口时触发的回调。 |
...
在启用[multiWindowAccess](../属性/arkts-basic-components-web-attributes.md#multiwindowaccess9)的情况下，通知用户新建窗口请求。

说明

* 若不调用[setWebController](<../Class (ControllerHandler)/arkts-basic-components-web-controllerhandler.md#setwebcontroller9>)接口，会造成render进程阻塞。
* 若未创建新窗口，调用[setWebController](<../Class (ControllerHandler)/arkts-basic-components-web-controllerhandler.md#setwebcontroller9>)接口并设置成null，通知Web未创建新窗口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnWindowNewExtEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onwindownewextevent23)> | 是 | 网页要求用户创建窗口时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnSearchResultReceiveEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onsearchresultreceiveevent12)> | 是 | 通知调用方网页页内查找的结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnDataResubmittedEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#ondataresubmittedevent12)> | 是 | 网页表单可以重新提交时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPageVisibleEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onpagevisibleevent12)> | 是 | 旧页面不再呈现，新页面即将可见时触发的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (event:[KeyEvent](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/基础输入事件/按键事件/ts-universal-events-key.md#keyevent对象说明)) => boolean | 是 | 触发的KeyEvent事件。  返回值为boolean类型，true表示将该KeyEvent传入Webview内核，false表示不将该KeyEvent传入ArkWeb内核。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnTouchIconUrlReceivedEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#ontouchiconurlreceivedevent12)> | 是 | 接收到的apple-touch-icon url地址时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnFaviconReceivedEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onfaviconreceivedevent12)> | 是 | 当前页面接收到新的favicon时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnAudioStateChangedEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onaudiostatechangedevent12)> | 是 | 网页上的音频播放状态发生改变时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnFirstContentfulPaintEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onfirstcontentfulpaintevent12)> | 是 | 网页首次内容绘制回调函数。 |
...
onFirstMeaningfulPaint(callback: [OnFirstMeaningfulPaintCallback](../Types/arkts-basic-components-web-t.md#onfirstmeaningfulpaintcallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnFirstMeaningfulPaintCallback](../Types/arkts-basic-components-web-t.md#onfirstmeaningfulpaintcallback12) | 是 | 网页绘制页面主要内容度量信息的回调。 |
...
onLargestContentfulPaint(callback: [OnLargestContentfulPaintCallback](../Types/arkts-basic-components-web-t.md#onlargestcontentfulpaintcallback12))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnLargestContentfulPaintCallback](../Types/arkts-basic-components-web-t.md#onlargestcontentfulpaintcallback12) | 是 | 网页绘制页面最大内容度量信息的回调。 |
...
* onLoadIntercept无法获取到完整的headers，如需获取完整headers建议在[onInterceptRequest](arkts-basic-components-web-events.md#oninterceptrequest9)或者通过WebSchemeHandler的[onRequestStart](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebSchemeHandler)/arkts-apis-webview-webschemehandler.md#onrequeststart12>)中获取。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnLoadInterceptEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onloadinterceptevent12), boolean> | 是 | 导航触发时的回调包括iframe导航，在回调中可以选择允许或者取消此次导航。  返回值为boolean类型。返回true表示取消此次导航，false表示允许此次导航。  返回undefined或null时为false。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnScreenCaptureRequestEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onscreencapturerequestevent12)> | 是 | 通知收到屏幕捕获请求。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnOverScrollEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onoverscrollevent12)> | 是 | 网页过度滚动时触发。 |
...
因该回调调用时网页还未加载，无法在回调中使用有关操作网页的接口，例如[zoomIn](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#zoomin>)、[zoomOut](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#zoomout>)等，可以使用[loadUrl](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#loadurl>)、[getWebId](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#getwebid>)等操作网页不相关的接口。

组件生命周期详情可参考[Web组件的生命周期](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/Web组件的生命周期/web-event-sequence.md)。
...
onNavigationEntryCommitted(callback: [OnNavigationEntryCommittedCallback](../Types/arkts-basic-components-web-t.md#onnavigationentrycommittedcallback11))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnNavigationEntryCommittedCallback](../Types/arkts-basic-components-web-t.md#onnavigationentrycommittedcallback11) | 是 | 网页跳转提交时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnSafeBrowsingCheckResultCallback](../Types/arkts-basic-components-web-t.md#onsafebrowsingcheckresultcallback11) | 是 | 收到网站安全风险检查结果时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (event: [NativeEmbedDataInfo](../Interfaces（其他）/arkts-basic-components-web-i.md#nativeembeddatainfo11)) => void | 是 | 同层标签生命周期变化时触发该回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (event: [NativeEmbedTouchInfo](../Interfaces（其他）/arkts-basic-components-web-i.md#nativeembedtouchinfo11)) => void | 是 | 手指触摸到同层标签时触发该回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnIntelligentTrackingPreventionCallback](../Types/arkts-basic-components-web-t.md#onintelligenttrackingpreventioncallback12) | 是 | 智能防跟踪功能使能时，当追踪者cookie被拦截时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnOverrideUrlLoadingCallback](../Types/arkts-basic-components-web-t.md#onoverrideurlloadingcallback12) | 是 | onOverrideUrlLoading的回调。  返回值boolean。返回true表示中止加载URL，返回false表示继续在Web中加载URL。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnViewportFitChangedCallback](../Types/arkts-basic-components-web-t.md#onviewportfitchangedcallback12) | 是 | 网页meta中viewport-fit配置项更改时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [WebKeyboardCallback](../Types/arkts-basic-components-web-t.md#webkeyboardcallback12) | 是 | 拦截网页拉起软键盘回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnNativeEmbedVisibilityChangeCallback](../Types/arkts-basic-components-web-t.md#onnativeembedvisibilitychangecallback12) | 是 | 同层标签可见性变化时触发该回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [MouseInfoCallback](../Types/arkts-basic-components-web-t.md#mouseinfocallback20) | 是 | 当鼠标/触摸板点击到同层标签时触发该回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnNativeEmbedObjectParamChangeCallback](../Types/arkts-basic-components-web-t.md#onnativeembedobjectparamchangecallback21) | 是 | 增加、修改或删除同层渲染object标签内嵌param元素时触发此回调。 |
...
该功能需通过调用[setErrorPageEnabled](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#seterrorpageenabled20>)接口启用默认错误页后，才会生效。

通过[errorPageEvent.error.getErrorCode()](<../Class (WebResourceError)/arkts-basic-components-web-webresourceerror.md#geterrorcode>)获取的错误码大于0代表http协议错误，小于0代表网络错误。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnOverrideErrorPageCallback](../Types/arkts-basic-components-web-t.md#onoverrideerrorpagecallback20) | 是 | 网页加载遇到错误时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (event?: { data:string | [WebResourceRequest](<../Class (WebResourceRequest)/arkts-basic-components-web-webresourcerequest.md>) }) => boolean | 是 | url的相关信息。  返回值：boolean，true表示阻止此次加载，false表示允许此次加载。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPdfLoadEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onpdfloadevent20)> | 是 | 当PDF加载成功或失败时，会触发回调，通知用户PDF页面加载状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[OnPdfScrollEvent](../Interfaces（其他）/arkts-basic-components-web-i.md#onpdfscrollevent20)> | 是 | 当PDF滚动到垂直方向底部时，会触发回调，通知用户PDF页面已滚动到底。 |
...
* 需配合[blankScreenDetectionConfig](../属性/arkts-basic-components-web-attributes.md#blankscreendetectionconfig22)使用。否则，默认关闭白屏检测功能，不会返回检测到白屏时的回调函数。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnDetectBlankScreenCallback](../Types/arkts-basic-components-web-t.md#ondetectblankscreencallback22) | 是 | Web组件检测到白屏时的回调函数。 |
...
应用处理该回调时，可以调用绑定的WebViewController接口来恢复页面。例如[refresh](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#refresh>)、[loadUrl](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#loadurl>)等。

详情可参考[Web组件的生命周期](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/Web组件的生命周期/web-event-sequence.md)。
...
可以通过startCamera，stopCamera，closeCamera这三个接口来切换摄像头的状态。这三个接口分别对应开启，暂停，停止摄像头功能。示例使用场景详见[startCamera](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#startcamera12>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnCameraCaptureStateChangeCallback](../Types/arkts-basic-components-web-t.md#oncameracapturestatechangecallback23) | 是 | 回调函数。当摄像头捕获状态改变时触发该回调，返回原来的状态和改变后的状态。 |
...
可以通过resumeMicrophone，pauseMicrophone，stopMicrophone这三个接口来切换麦克风的状态。这三个接口功能分别对应解除暂停，暂停，停止麦克风。示例使用场景详见[网页中麦克风的使用](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#resumemicrophone23>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnMicrophoneCaptureStateChangeCallback](../Types/arkts-basic-components-web-t.md#onmicrophonecapturestatechangecallback23) | 是 | 回调函数。当麦克风捕获状态改变时触发该回调，返回原来的状态和改变后的状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [TextSelectionChangeCallback](../Types/arkts-basic-components-web-t.md#textselectionchangecallback23) | 是 | 回调函数，所选区域文本内容改变时触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnFirstScreenPaintCallback](../Types/arkts-basic-components-web-t.md#onfirstscreenpaintcallback23) | 是 | 回调函数，设置Web组件的检测到首屏渲染。 |
