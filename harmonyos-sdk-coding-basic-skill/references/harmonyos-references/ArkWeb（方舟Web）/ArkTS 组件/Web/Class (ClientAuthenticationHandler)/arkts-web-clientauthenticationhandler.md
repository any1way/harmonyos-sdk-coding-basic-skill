...
content_hash: sha256:a7bb1384e529b490f07c7e1086d270535aa50dcf1ee562c47bcff15b5319aebb
---
Web组件返回的SSL客户端证书请求事件的处理对象。示例代码参考[onClientAuthenticationRequest](../事件/arkts-basic-components-web-events.md#onclientauthenticationrequest9)事件。
...
| credentialTypeOrCertChainFile | [CredentialType](../Enums/arkts-basic-components-web-e.md#credentialtype22) | string | 是 | 类型为[CredentialType](../Enums/arkts-basic-components-web-e.md#credentialtype22)时，代表凭据类型；类型为string时，表示证书链文件路径。 |
