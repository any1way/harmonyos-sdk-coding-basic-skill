...
scraped_at: 2026-06-11T16:01:39+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:0b785b87360b20e65f7bdf699b04b8feb2353050ff5864a04ab5e3509e91d0b4
---
说明
...
通过[接口](../组件描述/arkts-basic-components-web.md#接口)定义Web选项。

**系统能力：** SystemCapability.Web.Webview.Core

| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| src | string | [Resource](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | 网页资源地址。如果访问本地资源文件，请使用$rawfile或者resource协议。如果加载应用包外沙箱路径的本地资源文件（文件支持html和txt类型），请使用file://沙箱文件路径。  src不能通过状态变量（例如：@State）动态更改地址，如需更改，请通过[loadUrl()](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#loadurl>)重新加载。 |
| controller | [WebController](<../Class (WebController)/arkts-basic-components-web-webcontroller.md>) | WebviewController | 否 | 否 | 控制器，通过controller可以控制Web组件各种行为（包括页面导航、生命周期状态、JavaScript交互等行为）。从API version 9开始，WebController不再维护，建议使用[WebviewController](../Types/arkts-basic-components-web-t.md#webviewcontroller9)替代。 |
| renderMode12+ | [RenderMode](../Enums/arkts-basic-components-web-e.md#rendermode12) | 否 | 是 | 表示当前Web组件的渲染方式，RenderMode.ASYNC\_RENDER表示Web组件异步渲染，RenderMode.SYNC\_RENDER表示支持Web组件同步渲染能力，默认值RenderMode.ASYNC\_RENDER，该模式不支持动态调整。 |
...
| audioSessionType20+ | [AudioSessionType](../Enums/arkts-basic-components-web-e.md#audiosessiontype20) | 否 | 是 | 应用中Web音频类型。默认值对应[系统音频流类型](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#streamusage>)STREAM\_USAGE\_MUSIC。设置该参数会改变组件音频类型与系统音频类型映射关系，进而影响ArkWeb音频焦点策略。 |

## ScriptItem11+

PhonePC/2in1TabletTVWearable

通过[javaScriptOnDocumentStart](../属性/arkts-basic-components-web-attributes.md#javascriptondocumentstart11)属性注入到Web组件的ScriptItem对象。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| scrollUp | [NestedScrollMode](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#nestedscrollmode10) | 否 | 是 | 可滚动组件往上滚动时的嵌套滚动选项。  默认值：NestedScrollMode.SELF\_FIRST。 |
| scrollDown | [NestedScrollMode](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#nestedscrollmode10) | 否 | 是 | 可滚动组件往下滚动时的嵌套滚动选项。  默认值：NestedScrollMode.SELF\_FIRST。 |
| scrollLeft | [NestedScrollMode](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#nestedscrollmode10) | 否 | 是 | 可滚动组件往左滚动时的嵌套滚动选项。  默认值：NestedScrollMode.SELF\_FIRST。 |
| scrollRight | [NestedScrollMode](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#nestedscrollmode10) | 否 | 是 | 可滚动组件往右滚动时的嵌套滚动选项。  默认值：NestedScrollMode.SELF\_FIRST。 |

## NativeMediaPlayerConfig12+

PhonePC/2in1TabletTVWearable

用于[开启应用接管网页媒体播放功能](../属性/arkts-basic-components-web-attributes.md#enablenativemediaplayer12)的配置信息。
...
从API version 12开始支持，从API version 20开始废弃，建议使用[editMenuOptions](../属性/arkts-basic-components-web-attributes.md#editmenuoptions12)替代。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| content | [ResourceStr](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 显示内容。 |
| startIcon | [ResourceStr](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 显示图标。默认值为空，不显示图标。 |
...
| preview | [CustomBuilder](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 否 | 是 | 自定义选择菜单的预览内容样式，未配置时无预览内容。 |
| menuType | [MenuType](../../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#menutype13枚举说明) | 否 | 是 | 自定义选择菜单类型。  默认值：MenuType.SELECTION\_MENU。  从API version 20起，MenuType.PREVIEW\_MENU支持超链接预览。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| hapticFeedbackMode | [HapticFeedbackMode](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/弹窗控制/菜单控制/ts-universal-attributes-menu.md#hapticfeedbackmode18) | 否 | 是 | 菜单弹出时振动效果。需配置"ohos.permission.VIBRATE"权限  默认值：HapticFeedbackMode.DISABLED，菜单弹出时不振动。 |
...
| result | [JsResult](<../Class (JsResult)/arkts-basic-components-web-jsresult.md>) | 否 | 否 | 通知Web组件用户的操作结果。 |
...
| result | [JsResult](<../Class (JsResult)/arkts-basic-components-web-jsresult.md>) | 否 | 否 | 通知Web组件用户操作行为。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| message | [ConsoleMessage](<../Class (ConsoleMessage)/arkts-basic-components-web-consolemessage.md>) | 否 | 否 | 触发的控制台信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| request | [WebResourceRequest](<../Class (WebResourceRequest)/arkts-basic-components-web-webresourcerequest.md>) | 否 | 否 | 网页请求的封装信息。 |
| error | [WebResourceError](<../Class (WebResourceError)/arkts-basic-components-web-webresourceerror.md>) | 否 | 否 | 网页加载资源错误的封装信息 。 |
...
| --- | --- | --- | --- | --- |
| request | [WebResourceRequest](<../Class (WebResourceRequest)/arkts-basic-components-web-webresourcerequest.md>) | 否 | 否 | 网页请求的封装信息。 |
| response | [WebResourceResponse](<../Class (WebResourceResponse)/arkts-basic-components-web-webresourceresponse.md>) | 否 | 否 | 资源响应的封装信息。 |
...
| isRefreshed | boolean | 否 | 否 | true表示该页面是被重新加载的（调用[refresh9+](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#refresh>)接口），false表示该页面是新加载的。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| renderExitReason | [RenderExitReason](../Enums/arkts-basic-components-web-e.md#renderexitreason9) | 否 | 否 | 渲染进程异常退出的具体原因。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| result | [FileSelectorResult](<../Class (FileSelectorResult)/arkts-basic-components-web-fileselectorresult.md>) | 否 | 否 | 用于通知Web组件文件选择的结果。 |
| fileSelector | [FileSelectorParam](<../Class (FileSelectorParam)/arkts-basic-components-web-fileselectorparam.md>) | 否 | 否 | 文件选择器的相关信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| handler | [HttpAuthHandler](<../Class (HttpAuthHandler)/arkts-basic-components-web-httpauthhandler.md>) | 否 | 否 | 通知Web组件用户操作行为。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| request | [WebResourceRequest](<../Class (WebResourceRequest)/arkts-basic-components-web-webresourcerequest.md>) | 否 | 否 | url请求的相关信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| request | [PermissionRequest](<../Class (PermissionRequest)/arkts-basic-components-web-permissionrequest.md>) | 否 | 否 | 通知Web组件用户操作行为。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| handler | [ScreenCaptureHandler](<../Class (ScreenCaptureHandler)/arkts-basic-components-web-screencapturehandler.md>) | 否 | 否 | 通知Web组件用户操作行为。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| param | [WebContextMenuParam](<../Class (WebContextMenuParam)/arkts-basic-components-web-webcontextmenuparam.md>) | 否 | 否 | 菜单相关参数。 |
| result | [WebContextMenuResult](<../Class (WebContextMenuResult)/arkts-basic-components-web-webcontextmenuresult.md>) | 否 | 否 | 菜单相应事件传入内核。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| handler | [SslErrorHandler](<../Class (SslErrorHandler)/arkts-basic-components-web-sslerrorhandler.md>) | 否 | 否 | 通知Web组件用户操作行为。 |
| error | [SslError](../Enums/arkts-basic-components-web-e.md#sslerror9) | 否 | 否 | 错误码。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| handler | [ClientAuthenticationHandler](<../Class (ClientAuthenticationHandler)/arkts-web-clientauthenticationhandler.md>) | 否 | 否 | 通知Web组件用户操作行为。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| handler | [VerifyPinHandler](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (VerifyPinHandler)/arkts-basic-components-web-verifypinhandler.md>) | 否 | 否 | 通知Web组件用户操作行为。 |
...
| handler | [ControllerHandler](<../Class (ControllerHandler)/arkts-basic-components-web-controllerhandler.md>) | 否 | 否 | 用于设置新建窗口的WebviewController实例。 |
...
| navigationPolicy | [NavigationPolicy](../Enums/arkts-basic-components-web-e.md#navigationpolicy23) | 否 | 否 | 网页请求用户创建新窗口时的窗口打开方式。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| favicon | [PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 否 | 否 | 接收到的favicon图标的PixelMap对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| handler | [DataResubmissionHandler](<../Class (DataResubmissionHandler)/arkts-basic-components-web-dataresubmissionhandler.md>) | 否 | 否 | 表单数据重新提交句柄。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| data | [WebResourceRequest](<../Class (WebResourceRequest)/arkts-basic-components-web-webresourcerequest.md>) | 否 | 否 | url请求的相关信息。 |
...
| controller | [WebController](<../Class (WebController)/arkts-basic-components-web-webcontroller.md>) | [WebviewController9+](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md>) | 否 | 否 | 控制器。从API version 9开始，WebController不再维护，建议使用WebviewController替代。 |
| asyncMethodList12+ | Array<string> | 否 | 是 | 参与注册的应用侧JavaScript对象的异步方法。异步方法无法获取返回值。 |
| permission12+ | string | 否 | 是 | json字符串，默认为空，通过该字符串配置JSBridge的权限管控，可以定义object、method一级的url白名单。  JavaScriptProxy的permission参数支持resource/http/https协议，不支持file协议。  示例请参考[前端页面调用应用侧函数](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/在应用中使用前端页面JavaScript/前端页面调用应用侧函数/web-in-page-app-function-invoking.md)。 |
...
| geolocation | [JsGeolocation](<../Class (JsGeolocation)/arkts-basic-components-web-jsgeolocation.md>) | 否 | 否 | 通知Web组件用户操作行为。 |
...
| reason | [RenderProcessNotRespondingReason](../Enums/arkts-basic-components-web-e.md#renderprocessnotrespondingreason12) | 否 | 否 | 触发渲染进程无响应回调的原因。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| handler | [FullScreenExitHandler](<../Class (FullScreenExitHandler)/arkts-basic-components-web-fullscreenexithandler.md>) | 否 | 否 | 用于退出全屏模式的函数句柄。 |
...
| navigationType | [WebNavigationType](../Enums/arkts-basic-components-web-e.md#webnavigationtype11) | 否 | 否 | 网页跳转的类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| status | [NativeEmbedParamStatus](../Enums/arkts-basic-components-web-e.md#nativeembedparamstatus21) | 否 | 否 | param元素的状态变化类型。 |
...
拦截网页可编辑元素拉起软键盘的回调入参，其中包括[WebKeyboardController](<../Class (WebKeyboardController)/arkts-basic-components-web-webkeyboardcontroller.md>)、可编辑元素的属性。

**系统能力：** SystemCapability.Web.Webview.Core

| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| controller | [WebKeyboardController](<../Class (WebKeyboardController)/arkts-basic-components-web-webkeyboardcontroller.md>) | 否 | 否 | 提供控制自定义键盘的输入、删除、关闭等操作。 |
...
| enterKeyType | number | 否 | 是 | 指定系统软键盘enter键的类型，取值范围见输入框架的定义[EnterKeyType](<../../../../IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethod (输入法框架)/js-apis-inputmethod.md#enterkeytype10>)，该参数为可选参数，默认值为UNSPECIFIED。当useSystemKeyboard为true，并且设置了有效的enterKeyType时候，才有效。 |
| customKeyboard | [CustomBuilder](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 否 | 是 | 指定自定义键盘组件builder，可选参数，当useSystemKeyboard为false时，需要设置该参数，然后Web组件会拉起该自定义键盘。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| status | [NativeEmbedStatus](../Enums/arkts-basic-components-web-e.md#nativeembedstatus11) | 否 | 是 | 同层标签生命周期状态。 |
...
| --- | --- | --- | --- | --- |
| embedId | string | 否 | 是 | 同层标签的唯一id。 |
| touchEvent | [TouchEvent](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明) | 否 | 是 | 手指触摸动作信息。 |
| result12+ | [EventResult](<../Class (EventResult)/arkts-basic-components-web-eventresult.md>) | 否 | 是 | 通知Web组件手势事件的消费结果。 |
...
| --- | --- | --- | --- | --- |
| embedId | string | 否 | 是 | 同层标签的唯一id。 |
| mouseEvent | [MouseEvent](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md#mouseevent对象说明) | 否 | 是 | 鼠标/触摸板点击/长按信息。 |
| result | [EventResult](<../Class (EventResult)/arkts-basic-components-web-eventresult.md>) | 否 | 是 | 通知Web组件鼠标事件的消费结果。 |
...
| --- | --- | --- | --- | --- |
| url | string | 否 | 否 | 页面的URL地址。 |
| result | [PdfLoadResult](../Enums/arkts-basic-components-web-e.md#pdfloadresult20) | 否 | 否 | PDF页面加载结果。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| captureMode | [WebCaptureMode](../Enums/arkts-basic-components-web-e.md#webcapturemode10) | 否 | 否 | Web屏幕捕获模式。 |
...
| blankScreenReason | [DetectedBlankScreenReason](../Enums/arkts-basic-components-web-e.md#detectedblankscreenreason22) | 否 | 否 | 本次检测到白屏时，具体原因与检测的方法相关。 |
...
| detectionMethods | [BlankScreenDetectionMethod](../Enums/arkts-basic-components-web-e.md#blankscreendetectionmethod22)[] | 否 | 是 | 使用检测策略的方法，是一个数组。  注：  1.重复值会忽略。  默认值：[BlankScreenDetectionMethod.DETECTION\_CONTENTFUL\_NODES\_SEVENTEEN]。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| originalState | [CameraCaptureState](../Enums/arkts-basic-components-web-e.md#cameracapturestate23) | 否 | 否 | 原来的状态 |
| newState | [CameraCaptureState](../Enums/arkts-basic-components-web-e.md#cameracapturestate23) | 否 | 否 | 改变后的状态 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| originalState | [MicrophoneCaptureState](../Enums/arkts-basic-components-web-e.md#microphonecapturestate23) | 否 | 否 | 原来的状态。 |
| newState | [MicrophoneCaptureState](../Enums/arkts-basic-components-web-e.md#microphonecapturestate23) | 否 | 否 | 改变后的状态。 |
