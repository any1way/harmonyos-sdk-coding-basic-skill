...
scraped_at: 2026-06-11T16:01:08+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:1fd902743798cf6cb3ae2c219fba267d98e53cccfc1368674c060932af949e16
---
提供具有网页显示能力的Web组件，Web控制能力请参考[模块描述](<../../../ArkTS API/@ohos.web.webview (Webview)/模块描述/arkts-apis-webview.md>)。
...
* [ClientAuthenticationHandler](<../Class (ClientAuthenticationHandler)/arkts-web-clientauthenticationhandler.md>)：客户端证书请求事件。
* [ConsoleMessage](<../Class (ConsoleMessage)/arkts-basic-components-web-consolemessage.md>)：控制台信息。
* [ControllerHandler](<../Class (ControllerHandler)/arkts-basic-components-web-controllerhandler.md>)：新建Web组件的WebviewController对象。
* [DataResubmissionHandler](<../Class (DataResubmissionHandler)/arkts-basic-components-web-dataresubmissionhandler.md>)：表单数据操作对象。
* [EventResult](<../Class (EventResult)/arkts-basic-components-web-eventresult.md>)：同层事件消费结果。
* [FileSelectorParam](<../Class (FileSelectorParam)/arkts-basic-components-web-fileselectorparam.md>)：Web组件获取文件对象。
* [FileSelectorResult](<../Class (FileSelectorResult)/arkts-basic-components-web-fileselectorresult.md>)：Web组件文件选择结果。
* [FullScreenExitHandler](<../Class (FullScreenExitHandler)/arkts-basic-components-web-fullscreenexithandler.md>)：Web组件退出全屏的操作对象。
* [HttpAuthHandler](<../Class (HttpAuthHandler)/arkts-basic-components-web-httpauthhandler.md>)：HttpAuth认证请求相关操作功能对象。
* [JsGeolocation](<../Class (JsGeolocation)/arkts-basic-components-web-jsgeolocation.md>)：地理位置信息权限功能。
* [JsResult](<../Class (JsResult)/arkts-basic-components-web-jsresult.md>)：弹窗操作。
* [PermissionRequest](<../Class (PermissionRequest)/arkts-basic-components-web-permissionrequest.md>)：权限请求。
* [ScreenCaptureHandler](<../Class (ScreenCaptureHandler)/arkts-basic-components-web-screencapturehandler.md>)：屏幕捕获相关权限操作。
* [SslErrorHandler](<../Class (SslErrorHandler)/arkts-basic-components-web-sslerrorhandler.md>)：SSL错误事件操作功能。
* [WebContextMenuParam](<../Class (WebContextMenuParam)/arkts-basic-components-web-webcontextmenuparam.md>)：长按或鼠标右键弹出菜单信息。
* [WebContextMenuResult](<../Class (WebContextMenuResult)/arkts-basic-components-web-webcontextmenuresult.md>)：控制长按或鼠标右键弹出菜单。
* [WebCookie](<../Class (WebCookie)/arkts-basic-components-web-webcookie.md>)：当前应用中Web组件的Cookie管理操作。
* [WebKeyboardController](<../Class (WebKeyboardController)/arkts-basic-components-web-webkeyboardcontroller.md>)：控制自定义键盘。
* [WebResourceError](<../Class (WebResourceError)/arkts-basic-components-web-webresourceerror.md>)：资源管理错误。
* [WebResourceRequest](<../Class (WebResourceRequest)/arkts-basic-components-web-webresourcerequest.md>)：资源获取请求。
* [WebResourceResponse](<../Class (WebResourceResponse)/arkts-basic-components-web-webresourceresponse.md>)：资源获取响应。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [WebOptions](../Interfaces（其他）/arkts-basic-components-web-i.md#weboptions) | 是 | Web组件的初始化配置选项，用于设置加载的网页资源（src）、绑定的控制器（controller）以及渲染模式等行为参数。具体属性结构请参考WebOptions接口定义。 |
...
加载沙箱路径下的本地资源文件，需要开启应用中文件系统的访问[fileAccess](../属性/arkts-basic-components-web-attributes.md#fileaccess)权限。
...
2. 修改EntryAbility.ets。
   ...
   以filesDir为例，获取沙箱路径。若想获取其他路径，请参考[应用文件路径](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/应用上下文Context/application-context-stage.md#获取应用文件路径>)。
