...
scraped_at: 2026-06-01T15:55:10+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:4efdcd4df594f01249de2320ced45102a05c2caa84b98542c289fa47cc8c4bc2
---
通用属性仅支持[aspectRatio](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/布局约束/ts-universal-attributes-layout-constraints.md#aspectratio)、[backdropBlur](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backdropblur)、[backgroundColor](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundcolor)、[bindContentCover](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/模态转场设置/全屏模态转场/ts-universal-attributes-modal-transition.md#bindcontentcover)、[bindContextMenu](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/弹窗控制/菜单控制/ts-universal-attributes-menu.md#bindcontextmenu8)、[bindMenu](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/弹窗控制/菜单控制/ts-universal-attributes-menu.md#bindmenu) 、[bindSheet](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/模态转场设置/半模态转场/ts-universal-attributes-sheet-transition.md#bindsheet)、[borderColor](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/边框设置/ts-universal-attributes-border.md#bordercolor)、[borderRadius](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/边框设置/ts-universal-attributes-border.md#borderradius)、[borderStyle](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/边框设置/ts-universal-attributes-border.md#borderstyle)、[borderWidth](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/边框设置/ts-universal-attributes-border.md#borderwidth)、[clip](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip12)、[constraintSize](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#constraintsize)、[defaultFocus](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/焦点控制/ts-universal-attributes-focus.md#defaultfocus9)、[focusable](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/焦点控制/ts-universal-attributes-focus.md#focusable)、[tabIndex](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/焦点控制/ts-universal-attributes-focus.md#tabindex9)、[groupDefaultFocus](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/焦点控制/ts-universal-attributes-focus.md#groupdefaultfocus9)、[displayPriority](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/布局约束/ts-universal-attributes-layout-constraints.md#displaypriority)、[enabled](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/禁用控制/ts-universal-attributes-enable.md#enabled)、[flexBasis](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/Flex布局/ts-universal-attributes-flex-layout.md#flexbasis)、[flexShrink](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/Flex布局/ts-universal-attributes-flex-layout.md#flexshrink)、[layoutWeight](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#layoutweight)、[id](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#id)、[gridOffset](../../../../ArkUI（方舟UI框架）/ArkTS组件/已停止维护的组件与接口/栅格设置/ts-universal-attributes-grid.md#属性)、[gridSpan](../../../../ArkUI（方舟UI框架）/ArkTS组件/已停止维护的组件与接口/栅格设置/ts-universal-attributes-grid.md#属性)、[useSizeType](../../../../ArkUI（方舟UI框架）/ArkTS组件/已停止维护的组件与接口/栅格设置/ts-universal-attributes-grid.md#属性)、[height](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#height)、[touchable](../../../../ArkUI（方舟UI框架）/ArkTS组件/已停止维护的组件与接口/点击控制/ts-universal-attributes-click.md#touchabledeprecated)、[margin](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#margin)、[markAnchor](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/位置设置/ts-universal-attributes-location.md#markanchor)、[offset](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/位置设置/ts-universal-attributes-location.md#offset)、[width](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#width)、[zIndex](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/Z序控制/ts-universal-attributes-z-order.md#zindex)、[visibility](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/显隐控制/ts-universal-attributes-visibility.md#visibility)、[scale](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/视效与模糊/图形变换/ts-universal-attributes-transformation.md#scale)、[translate](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/视效与模糊/图形变换/ts-universal-attributes-transformation.md#translate)、[responseRegion](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/交互属性/触摸交互控制/触摸热区设置/ts-universal-attributes-touch-target.md#responseregion)、[size](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#size)、[opacity](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/视效与模糊/透明度设置/ts-universal-attributes-opacity.md#opacity)、[shadow](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadow)、[sharedTransition](<../../../../ArkUI（方舟UI框架）/ArkTS组件/动画/共享元素转场 (sharedTransition)/ts-transition-animation-shared-elements.md>)、[transition](<../../../../ArkUI（方舟UI框架）/ArkTS组件/动画/组件内转场 (transition)/ts-transition-animation-component.md>)、[position](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/位置设置/ts-universal-attributes-location.md#position)、[direction](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/位置设置/ts-universal-attributes-location.md#direction)。
...
设置是否开启应用中文件系统的访问。[$rawfile(filepath/filename)](../../../../../harmonyos-guides/基础入门/资源分类与访问/resource-categories-and-access.md#资源访问)中的文件不受该属性影响而被限制访问。API version 11及以前，当属性没有显式调用时，默认开启应用中文件系统的访问。API version 12及以后，当属性没有显式调用时，默认不开启应用中文件系统的访问。
...
javaScriptProxy接口需要和[deleteJavaScriptRegister9+](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#deletejavascriptregister>)接口配合使用，防止内存泄漏。

javaScriptProxy对象的所有参数不支持更新。

注册javaScriptProxy对象时，同步与异步列表请至少选择一项不为空，可同时注册两类方法。

此接口只支持注册一个对象，若需要注册多个对象请使用[registerJavaScriptProxy9+](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#registerjavascriptproxy>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| javaScriptProxy | [JavaScriptProxy](../Interfaces（其他）/arkts-basic-components-web-i.md#javascriptproxy12) | 是 | 参与注册的对象。只能声明方法，不能声明属性。  传入undefined或null时不将javaScriptProxy中的ArkTS对象注册到Web组件中。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [OverScrollMode](../Enums/arkts-basic-components-web-e.md#overscrollmode11) | 是 | 设置Web的过滚动模式为关闭或开启。  传入undefined或null时为OverScrollMode.NEVER。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mixedMode | [MixedMode](../Enums/arkts-basic-components-web-e.md#mixedmode) | 是 | 要设置的混合内容模式。  传入undefined或null时为MixedMode.All。 |
...
* 本接口在ArkWeb内核升级到M132版本后因内核废弃Web SQL，对Web SQL数据库的控制失效。ArkWeb内核版本参考ArkWeb简介[约束与限制](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/ArkWeb简介/web-component-overview.md#约束与限制)。
...
设置是否开启获取地理位置权限。当属性没有显式调用时，默认开启获取地理位置权限。具体使用方式参考[管理位置权限](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/设置基本属性和事件/管理位置权限/web-geolocation-permission.md)。
...
使能多窗口权限时，需要实现onWindowNew事件，示例代码参考[onWindowNew](../事件/arkts-basic-components-web-events.md#onwindownew9)。
...
* 通过@State变量控制横向滚动条的隐藏/显示后，需要调用[controller.refresh()](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#refresh>)生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cacheMode | [CacheMode](../Enums/arkts-basic-components-web-e.md#cachemode) | 是 | 要设置的缓存模式。  传入undefined或null时为CacheMode.Default。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CopyOptions](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#copyoptions9) | 是 | 要设置的剪贴板复制范围选项。  传入undefined或null时为CopyOptions.None。 |
...
当深色模式开启时，Web将启用媒体查询prefers-color-scheme中网页所定义的深色样式，若网页未定义深色样式，则保持原状。如需开启强制深色模式，建议配合[forceDarkAccess](arkts-basic-components-web-attributes.md#forcedarkaccess9)使用。深色模式具体用法可参考[Web深色模式适配](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/设置基本属性和事件/Web深色模式适配/web-set-dark-mode.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [WebDarkMode](../Enums/arkts-basic-components-web-e.md#webdarkmode9) | 是 | 设置Web的深色模式为关闭、开启或跟随系统。  传入null或undefined时为WebDarkMode.Off。 |
...
* 该媒体播放策略将同时管控有声视频。
* 建议为所有Web组件设置相同的[audioExclusive](../Interfaces（其他）/arkts-basic-components-web-i.md#webmediaoptions10)值。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [WebMediaOptions](../Interfaces（其他）/arkts-basic-components-web-i.md#webmediaoptions10) | 是 | 设置Web的媒体策略。  属性参数更新后需重新播放音频方可生效。  传入undefined或null时为{resumeInterval: 0, audioExclusive: true} |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scripts | Array<[ScriptItem](../Interfaces（其他）/arkts-basic-components-web-i.md#scriptitem11)> | 是 | 需要注入的ScriptItem数组。  传入undefined或null时不将JavaScript脚本注入到Web组件中。 |
...
设置Web布局模式。当属性没有显式调用时，默认Web布局跟随系统模式。常见问题请参考[Web组件大小自适应页面内容布局](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/Web渲染和布局/Web组件大小自适应页面内容布局/web-fit-content.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [WebLayoutMode](../Enums/arkts-basic-components-web-e.md#weblayoutmode11) | 是 | 设置web布局模式，跟随系统或自适应布局。  传入null或undefined时为WebLayoutMode.NONE |
...
* 支持嵌套滚动的容器：[Grid](../../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)、[List](../../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/List/ts-container-list.md)、[Scroll](../../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)、[Swiper](../../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md)、[Tabs](../../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)、[WaterFlow](../../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)、[Refresh](../../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Refresh/ts-container-refresh.md)、[bindSheet](../../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/模态转场设置/半模态转场/ts-universal-attributes-sheet-transition.md#bindsheet)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [NestedScrollOptions](../../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/滚动组件通用接口/ts-container-scrollable-common.md#nestedscrolloptions10对象说明) | [NestedScrollOptionsExt](../Interfaces（其他）/arkts-basic-components-web-i.md#nestedscrolloptionsext14)14+ | 是 | 可滚动组件滚动时的嵌套滚动选项。  value为NestedScrollOptions（向前、向后两个方向）类型时，scrollForward、scrollBackward默认滚动选项为[NestedScrollMode.SELF\_FIRST](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#nestedscrollmode10)。  value为NestedScrollOptionsExt（上下左右四个方向）类型时，scrollUp、scrollDown、scrollLeft、scrollRight默认滚动选项为NestedScrollMode.SELF\_FIRST。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| condition | [WebBypassVsyncCondition](../Enums/arkts-basic-components-web-e.md#webbypassvsynccondition20) | 是 | 触发渲染流程跳过vsync调度的条件。  传入undefined或null时为NONE。 |
...
具体使用详情请参考[同层渲染](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/同层渲染/web-same-layer.md#web页面中同层渲染输入框)指南。
...
开启[应用接管网页媒体播放功能](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/使用网页多媒体/托管网页中的媒体播放/app-takeovers-web-media.md)。当属性没有显式调用时，默认不开启接管网页媒体播放功能。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [NativeMediaPlayerConfig](../Interfaces（其他）/arkts-basic-components-web-i.md#nativemediaplayerconfig12) | 是 | enable: 是否开启该功能。  shouldOverlay: 该功能开启后， 应用接管网页视频的播放器画面是否覆盖网页内容。  传入undefined或null时为{enable: false, shouldOverlay: false}。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnAdsBlockedCallback](../Types/arkts-basic-components-web-t.md#onadsblockedcallback12) | 是 | 广告过滤的回调。 |
...
当UIContext设置的键盘避让模式为[KeyboardAvoidMode.RESIZE](<../../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Enums/arkts-apis-uicontext-e.md#keyboardavoidmode11>)模式时，该接口功能不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [WebKeyboardAvoidMode](../Enums/arkts-basic-components-web-e.md#webkeyboardavoidmode12) | 是 | Web软键盘避让模式。  嵌套滚动场景下不推荐使用web软键盘避让，包括RESIZE\_VISUAL与RESIZE\_CONTENT。  默认值：WebKeyboardAvoidMode.RESIZE\_CONTENT避让行为。 |
...
在[onCreateMenu](../../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#oncreatemenu12)中，可以修改、增加、删除菜单选项，如果希望不显示文本菜单，需要返回空数组。

在[onMenuItemClick](../../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#onmenuitemclick12)中，可以自定义菜单选项的回调函数。该函数在菜单选项被点击后触发，并根据返回值决定是否执行系统默认的回调。返回true不执行系统回调，返回false继续执行系统回调。

在[onPrepareMenu20+](../../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#属性-1)中，当文本选择区域变化后显示菜单之前触发该回调，可在该回调中进行修改、增加、删除菜单选项，实现动态更新菜单。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| editMenu | [EditMenuOptions](../../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#editmenuoptions) | 是 | Web自定义文本菜单选项。  菜单项数量，及菜单的content大小、icon图标尺寸，与ArkUI [Menu](../../../../ArkUI（方舟UI框架）/ArkTS组件/菜单/Menu/ts-basic-components-menu.md)组件保持一致。  菜单中系统自带的id枚举值（[TextMenuItemId](../../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#textmenuitemid12)）在Web中仅支持CUT、COPY、PASTE、SELECT\_ALL、TRANSLATE、SEARCH、AI\_WRITER七项。  onMenuItemClick函数中textRange参数在web中无意义，传入值为-1。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| elementType | [WebElementType](../Enums/arkts-basic-components-web-e.md#webelementtype13) | 是 | 菜单的类型。 |
| content | [CustomBuilder](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 菜单的内容。 |
| responseType | [WebResponseType](../Enums/arkts-basic-components-web-e.md#webresponsetype13) | 是 | 菜单的响应类型。 |
| options | [SelectionMenuOptionsExt](../Interfaces（其他）/arkts-basic-components-web-i.md#selectionmenuoptionsext13) | 否 | 菜单的选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [BlurOnKeyboardHideMode](../Enums/arkts-basic-components-web-e.md#bluronkeyboardhidemode14) | 是 | 设置当软键盘收起时Web元素失焦关闭或开启。默认值：BlurOnKeyboardHideMode.SILENT。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [EmbedOptions](../Interfaces（其他）/arkts-basic-components-web-i.md#embedoptions16) | 否 | 同层渲染相关配置。  传入undefined或null时为{supportDefaultIntrinsicSize: false}。 |
...
当enableDataDetector设置为true且[copyOptions](arkts-basic-components-web-attributes.md#copyoptions11)设置为CopyOptions.LocalDevice时，AI菜单功能将被激活。此时，在网页中选中文本后，文本选择菜单能够展示对应的AI菜单项，包括[TextMenuItemId](../../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#textmenuitemid12)中的url（打开链接）、email（新建邮件）、phoneNumber（呼叫）、address（导航至该位置）、dateTime（新建日程提醒）。

AI菜单生效时，需在选中范围内，包括一个完整的AI实体，才能展示对应的选项。该菜单项与[TextMenuItemId](../../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#textmenuitemid12)中的askAI菜单项不同时出现。

示例使用场景详见[使用Web组件的智能分词能力](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/处理网页内容/使用Web组件的智能分词能力/web-data-detector.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [TextDataDetectorConfig](../../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#textdatadetectorconfig11对象说明) | 是 | 文本识别配置。 |
...
AI菜单功能启用时，在网页中选中文本后，文本选择菜单能够展示对应的AI菜单项，包括[TextMenuItemId](../../../../ArkUI（方舟UI框架）/ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#textmenuitemid12)中的url（打开链接）、email（新建邮件）、phoneNumber（呼叫）、address（导航前往）、dateTime（新建日程）。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [GestureFocusMode](../Enums/arkts-basic-components-web-e.md#gesturefocusmode20) | 是 | 设置Web组件手势获焦模式。传入undefined或null时为GestureFocusMode.DEFAULT。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| effect | [WebRotateEffect](../Enums/arkts-basic-components-web-e.md#webrotateeffect22) | 是 | 设置Web组件旋转时，宽高动画过程中组件内容的填充方式。 |
...
* 根据detectConfig的配置，在网页加载后检测到白屏或者近似白屏现象，可触发回调[onDetectedBlankScreen](../事件/arkts-basic-components-web-events.md#ondetectedblankscreen22)。
* 设置后下次导航生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| detectConfig | [BlankScreenDetectionConfig](../Interfaces（其他）/arkts-basic-components-web-i.md#blankscreendetectionconfig22) | 是 | 白屏检测的策略配置。 |
...
* 图片的原始长宽均不小于100px。
* 在[设备类型](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#devicetypes标签)不为2in1的设备上，需要图片渲染宽度超过网页宽度的80%。
...
网页使用智能填充和密码填充前，需要网页接入对应的填充服务。具体接入方法请查看[网页接入智能填充](<../../../../../harmonyos-guides/应用服务/Scenario Fusion Kit（融合场景服务）/智能填充服务/三方框架+H5接入智能填充/H5接入智能填充/scenario-fusion-h5.md>)、[网页接入密码填充](../../../../../harmonyos-guides/系统/安全/密码自动填充服务/网页接入密码保险箱/arkweb-access-password-safe.md)
...
* 当设置了[onContextMenuShow](../事件/arkts-basic-components-web-events.md#oncontextmenushow9)回调并在回调中返回true时，本接口的设置不生效。
...
从API version 8开始支持，从API version 10开始废弃。建议使用[setCustomUserAgent](<../../../ArkTS API/@ohos.web.webview (Webview)/Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#setcustomuseragent10>)10+替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| expandedMenuOptions | Array<[ExpandedMenuItemOptions](../Interfaces（其他）/arkts-basic-components-web-i.md#expandedmenuitemoptionsdeprecated)> | 是 | 扩展菜单选项。  菜单项数量，及菜单的content大小、startIcon图标尺寸，与ArkUI [Menu](../../../../ArkUI（方舟UI框架）/ArkTS组件/菜单/Menu/ts-basic-components-menu.md)组件保持一致。 |
