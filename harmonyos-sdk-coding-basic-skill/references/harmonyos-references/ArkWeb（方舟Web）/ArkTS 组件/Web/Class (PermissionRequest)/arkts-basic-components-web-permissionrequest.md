...
content_hash: sha256:986e4283f2c1940b3b666c36e37fc4e2dc5c7cdc78ddd2ffdf515449b3e6b5b1
---
Web组件返回授权或拒绝权限功能的对象。示例代码参考[onPermissionRequest](../事件/arkts-basic-components-web-events.md#onpermissionrequest9)事件。
...
获取网页所请求的权限资源列表，资源列表类型参考[ProtectedResourceType](../Enums/arkts-basic-components-web-e.md#protectedresourcetype9)。
