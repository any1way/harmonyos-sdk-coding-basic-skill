...
content_hash: sha256:efb9cfebc6ce0e81add428039f4ae6ce769f2218f80596959c4ddd93f245d1fa
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [WebNativeMessagingExtensionContext](<../@ohos.web.WebNativeMessagingExtensionContext (Web Native Messaging Extension Context)/arkts-apis-w_28129980.md>) | 否 | 否 | Web原生消息通信上下文。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [ConnectionInfo](arkts-apis-w_26610392.md#connectioninfo) | 是 | 连接信息对象。 |
