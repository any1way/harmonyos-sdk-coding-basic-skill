...
scraped_at: 2026-06-01T15:55:02+08:00
doc_updated_at: 2026-04-13
content_hash: sha256:1c494bbbca3bbe91923620c3f229385b7390e71683715e7c73534297654047d4
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 表示需要启动的Ability的信息。 |
| options | [StartOptions](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.StartOptions (startAbility的可选参数)/js-apis-app-ability-startoptions.md>) | 否 | 启动选项。 |
...
以下错误码详细介绍请参考[元能力子系统错误码](<../../../Ability Kit（程序框架服务）/错误码/元能力子系统错误码/errorcode-ability.md>)。
