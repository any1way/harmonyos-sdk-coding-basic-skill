...
scraped_at: 2026-06-01T15:54:56+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:ea1ae3e06c3671f66f58a930423dd85d39a9715e267773ce0306456214df51db
---
[CreateNativeMediaPlayerCallback](../Types/arkts-apis-webview-t.md#createnativemediaplayercallback12)回调函数的参数。应用通过该对象，将播放器的状态通知给 ArkWeb 内核。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| status | [PlaybackStatus](../Enums/arkts-apis-webview-e.md#playbackstatus12) | 是 | 播放器的播放状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [NetworkState](../Enums/arkts-apis-webview-e.md#networkstate12) | 是 | 播放器的网络状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [ReadyState](../Enums/arkts-apis-webview-e.md#readystate12) | 是 | 播放器的缓存状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| error | [MediaError](../Enums/arkts-apis-webview-e.md#mediaerror12) | 是 | 错误类型。 |
