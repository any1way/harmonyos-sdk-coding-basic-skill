...
scraped_at: 2026-06-01T15:54:47+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:2ff45cbd14989e52114259f4be43f5cfdc95041ac5b4feea500eddb5a5ee1b60
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| response | [WebSchemeHandlerResponse](<../Class (WebSchemeHandlerResponse)/arkts-apis-webview-webschemehandlerresponse.md>) | 是 | 该拦截请求的响应。 |
...
示例请参考[OnRequestStart](<../Class (WebSchemeHandler)/arkts-apis-webview-webschemehandler.md#onrequeststart12>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| code | [WebNetErrorList](<../../@ohos.web.netErrorList (ArkWeb网络协议栈错误列表)/arkts-apis-neterrorlist.md#webneterrorlist>) | 是 | 网络错误码。 |
