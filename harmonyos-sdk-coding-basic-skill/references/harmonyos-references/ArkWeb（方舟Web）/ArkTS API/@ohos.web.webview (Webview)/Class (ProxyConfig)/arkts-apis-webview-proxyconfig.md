...
scraped_at: 2026-06-01T15:54:28+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:e8162e575daf512c7b8d29696da4cca39aefd2302a4eaeda0c798b625a9dca9b
---
可以通过该类提供的接口对代理进行配置。
...
| schemeFilter | [ProxySchemeFilter](../Enums/arkts-apis-webview-e.md#proxyschemefilter15) | 否 | 与schemeFilter匹配的URL会使用代理。  默认值：MATCH\_ALL\_SCHEMES。  传入undefined或null会抛出异常错误码401。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| schemeFilter | [ProxySchemeFilter](../Enums/arkts-apis-webview-e.md#proxyschemefilter15) | 否 | 与schemeFilter匹配的URL会直接与服务器相连。  默认值：MATCH\_ALL\_SCHEMES。  传入undefined或null会抛出异常错误码401。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[ProxyRule](<../Class (ProxyRule)/arkts-apis-webview-proxyrule.md>)> | 代理规则。 |
