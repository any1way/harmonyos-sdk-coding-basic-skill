...
scraped_at: 2026-06-01T15:54:30+08:00
doc_updated_at: 2026-04-17
content_hash: sha256:35f3bf95135b35718c63667523ceb65b8e5730966c8f0d76dba54db81135bfe1
---
此类用于为应用程序设置代理。
...
设置应用中所有Web使用的代理配置，与[insertBypassRule](<../Class (ProxyConfig)/arkts-apis-webview-proxyconfig.md#insertbypassrule15>)中插入的bypass规则匹配的URL将不会使用代理，而是直接向URL指定的源地址发起请求。代理设置成功后，不保证网络连接后会立即使用新的代理设置，在加载页面之前请等待监听器触发，这个监听器将在UI线程上被调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| proxyConfig | [ProxyConfig](<../Class (ProxyConfig)/arkts-apis-webview-proxyconfig.md>) | 是 | 对代理的配置。 |
| callback | [OnProxyConfigChangeCallback](../Types/arkts-apis-webview-t.md#onproxyconfigchangecallback15) | 是 | 代理设置成功的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnProxyConfigChangeCallback](../Types/arkts-apis-webview-t.md#onproxyconfigchangecallback15) | 是 | 代理配置变更的回调。 |
