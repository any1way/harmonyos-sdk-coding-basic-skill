...
content_hash: sha256:1969fd86869bb50e2a00953e2fbb0a6a83e7c548fa471677556b8f3f7ab0c729
---
Web组件返回的PIN码认证用户处理功能对象。示例代码参考[onVerifyPin](<../../../ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#onverifypin22>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| result | [PinVerifyResult](<../../../ArkTS 组件/Web/Enums/arkts-basic-components-web-e.md#pinverifyresult22>) | 是 | PIN码认证结果。 |
