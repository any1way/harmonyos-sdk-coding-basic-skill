...
scraped_at: 2026-06-11T16:00:38+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:522403c196402c768df2c822288fa0f0fde66c42d8278f94a3baaf9a0b8d3b27
---
...
Web组件销毁后会解绑WebViewController，之后调用WebviewController的非静态方法会抛出[17100001](../../../错误码/Webview错误码/errorcode-webview.md#section17100001-webviewcontroller没有和具体的web组件关联)异常，应注意调用时机和捕获异常，防止进程异常退出。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| secureDnsMode | [SecureDnsMode](../Enums/arkts-apis-webview-e.md#securednsmode10) | 是 | 使用HTTPDNS的模式。 |
...
设置是否启用网页调试功能。详情请参考[DevTools工具](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/Web调试维测/使用DevTools工具调试前端页面/web-debugging-with-devtools.md)。
...
| headers | Array<[WebHeader](<../Interfaces (其他)/arkts-apis-webview-i.md#webheader>)> | 否 | URL的附加HTTP请求头。  默认值： []。  传入undefined或null会抛出异常错误码401。 |

**错误码：**

以下错误码的详细介绍请参见[Webview错误码](../../../错误码/Webview错误码/errorcode-webview.md)、[通用错误码](../../../../通用错误码/errorcode-universal.md)。
...
3.通过沙箱路径加载本地文件，可以参考[web](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/管理网页加载与浏览记录/使用Web组件加载页面/web-page-loading-with-web-components.md#加载本地页面)加载沙箱路径的示例代码。
...
以下错误码的详细介绍请参见[Webview错误码](../../../错误码/Webview错误码/errorcode-webview.md)。
...
示例请参考[前端页面调用应用侧函数](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/在应用中使用前端页面JavaScript/前端页面调用应用侧函数/web-in-page-app-function-invoking.md)。
...
更多示例，请参考[前端页面调用应用侧函数](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/在应用中使用前端页面JavaScript/前端页面调用应用侧函数/web-in-page-app-function-invoking.md)。
...
| callback | AsyncCallback<[JsMessageExt](<../Class (JsMessageExt)/arkts-apis-webview-jsmessageext.md>)> | 是 | 回调执行JavaScript脚本结果。 |
...
异步执行JavaScript脚本，并通过Promise方式返回脚本执行的结果。runJavaScriptExt需要在loadUrl完成后，比如[onPageEnd](<../../../ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#onpageend>)中调用。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[JsMessageExt](<../Class (JsMessageExt)/arkts-apis-webview-jsmessageext.md>)> | Promise实例，返回脚本执行的结果。 |
...
删除通过[registerJavaScriptProxy](arkts-apis-webview-webviewcontroller.md#registerjavascriptproxy)或者[javaScriptProxy](<../../../ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#javascriptproxy>)注册到window上的指定name的应用侧JavaScript对象。删除操作在页面下次（重新）加载后生效。
...
调整当前网页的缩放比例，[zoomAccess](<../../../ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#zoomaccess>)需为true。
...
异步查找网页中所有匹配关键字'searchString'的内容并高亮，结果通过[onSearchResultReceive](<../../../ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#onsearchresultreceive9>)异步返回。
...
| 类型 | 说明 |
| --- | --- |
| Array<[WebMessagePort](<../Interface (WebMessagePort)/arkts-apis-webview-webmessageport.md>)> | web消息端口列表。 |
...
完整示例代码参考[onMessageEventExt](<../Interface (WebMessagePort)/arkts-apis-webview-webmessageport.md#onmessageeventext10>)。
...
| ports | Array<[WebMessagePort](<../Interface (WebMessagePort)/arkts-apis-webview-webmessageport.md>)> | 是 | 要发送的消息端口。 |
...
默认User-Agent定义与使用场景请参考[User-Agent开发指导](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/设置基本属性和事件/User-Agent开发指导/web-default-useragent.md)
...
获取当前网页的页面高度。具体使用详情请参考[获取网页内容高度](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/Web渲染和布局/获取网页内容高度/web-getpage-height.md)。
...
| 类型 | 说明 |
| --- | --- |
| image.[PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 页面favicon图标的PixelMap对象。 |
...
[onLoadIntercept](<../../../ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#onloadintercept10>)在加载开始的时候触发，该时刻还未生成历史节点，所以在onLoadIntercept中调用getBackForwardEntries拿到的历史栈不包括当前正在加载中的跳转。
...
| 类型 | 说明 |
| --- | --- |
| [BackForwardList](<../Interface (BackForwardList)/arkts-apis-webview-backforwardlist.md>) | 当前Webview的历史信息列表。 |
...
1.对文件的操作需要导入文件管理模块，详情请参考[文件管理](<../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md>)。
...
对Web内核赋予自定义协议URL的跨域请求与fetch请求的权限。当Web在跨域fetch自定义协议URL时，该fetch请求可被[onInterceptRequest](<../../../ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#oninterceptrequest9>)事件接口所拦截，从而开发者可以进一步处理该请求。建议在任何Web组件初始化之前调用该接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| schemes | Array<[WebCustomScheme](<../Interfaces (其他)/arkts-apis-webview-i.md#webcustomscheme>)> | 是 | 自定义协议配置，最多支持同时配置10个自定义协议。 |
...
获取当前网站的证书信息。使用Web组件加载https网站，会进行SSL证书校验，该接口会通过Promise异步返回当前网站的X509格式证书（X509Cert证书类型定义见[X509Cert](<../../../../Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#x509cert>)定义），便于开发者展示网站证书信息。
...
获取当前网站的证书信息。使用Web组件加载https网站，会进行SSL证书校验，该接口会通过AsyncCallback异步返回当前网站的X509格式证书（X509Cert证书类型定义见[X509Cert](<../../../../Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md#x509cert>)），便于开发者展示网站证书信息。
...
| additionalHeaders | Array<[WebHeader](<../Interfaces (其他)/arkts-apis-webview-i.md#webheader>)> | 否 | URL的附加HTTP请求头。  默认值： [] |
| prefetchOptions | [PrefetchOptions](<../Class (PrefetchOptions)/arkts-apis-webview-prefetchoptions.md>) | 否 | 用来自定义预取行为的相关选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [RequestInfo](<../Interfaces (其他)/arkts-apis-webview-i.md#requestinfo12>) | 是 | 预获取请求的信息。 |
| additionalHeaders | Array<[WebHeader](<../Interfaces (其他)/arkts-apis-webview-i.md#webheader>)> | 否 | 预获取请求的附加HTTP请求头。  传入undefined或null会抛出异常错误码401。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| delegate | [WebDownloadDelegate](<../Class (WebDownloadDelegate)/arkts-apis-webview-webdownloaddelegate.md>) | 是 | 用来接收下载进度的委托。 |
...
默认User-Agent定义与使用场景，及相关User-Agent接口定义优先级请参考[User-Agent开发指导](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/设置基本属性和事件/User-Agent开发指导/web-default-useragent.md)。
...
当Web组件使能广告过滤功能后，默认所有页面都是开启广告过滤的，支持通过[addAdsBlockDisallowedList](<../Class (AdsBlockManager)/arkts-apis-webview-adsblockmanager.md#addadsblockdisallowedlist12>)指定域名禁用广告过滤。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [RenderProcessMode](../Enums/arkts-apis-webview-e.md#renderprocessmode12) | 是 | 渲染子进程模式。  可以先调用[getRenderProcessMode()](arkts-apis-webview-webviewcontroller.md#getrenderprocessmode12)查看当前设备的ArkWeb渲染子进程模式，枚举值0为单子进程模式，枚举值1为多子进程模式。  手机默认为单渲染子进程模式，平板和PC/2in1默认为多渲染子进程模式。  如果传入RenderProcessMode枚举值之外的非法数字，则默认识别为多渲染子进程模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [RenderProcessMode](../Enums/arkts-apis-webview-e.md#renderprocessmode12) | 渲染子进程模式类型。  调用getRenderProcessMode()获取当前设备的ArkWeb渲染子进程模式，枚举值0为单子进程模式，枚举值1为多子进程模式。  如果获取的值不在RenderProcessMode枚举值范围内，则默认为多渲染子进程模式。 |
...
| 类型 | 说明 |
| --- | --- |
| print.[PrintDocumentAdapter](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.print (打印)/js-apis-print.md#printdocumentadapter11>) | 返回打印文档的适配器。 |
...
| 类型 | 说明 |
| --- | --- |
| [SecurityLevel](../Enums/arkts-apis-webview-e.md#securitylevel11) | 当前网页的安全级别，具体值为NONE、SECURE、WARNING、DANGEROUS。 |
...
| type | [ScrollType](../Enums/arkts-apis-webview-e.md#scrolltype12) | 否 | 网页可触发的滚动类型，支持缺省配置。  - enable为false时，表示禁止ScrollType类型的滚动，当ScrollType缺省时表示禁止所有类型网页滚动。  - enable为true时，ScrollType缺省与否，都表示允许所有类型的网页滚动。  传入null或undefined时会抛出异常错误码401。 |
...
设置是否打印网页背景，该接口与[PrintAttributes](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/数据文件处理/@ohos.print (打印)/js-apis-print.md#printattributes11>)打印参数配置不一致时，本接口设置优先级高于打印参数。
...
通过[registerJavaScriptProxy](arkts-apis-webview-webviewcontroller.md#registerjavascriptproxy)或者[javaScriptProxy](<../../../ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#javascriptproxy>)注入JavaScript对象到window对象中。该接口可以获取最后一次调用注入的对象的frame的URL。
...
| 类型 | 说明 |
| --- | --- |
| [MediaPlaybackState](../Enums/arkts-apis-webview-e.md#mediaplaybackstate12) | 当前网页的播放状态，具体值为NONE、PLAYING、PAUSED、STOPPED。 |
...
为Web组件设置[WebSchemeHandler](<../Class (WebSchemeHandler)/arkts-apis-webview-webschemehandler.md>), [WebSchemeHandler](<../Class (WebSchemeHandler)/arkts-apis-webview-webschemehandler.md>)类用于拦截指定scheme的请求。
...
| handler | [WebSchemeHandler](<../Class (WebSchemeHandler)/arkts-apis-webview-webschemehandler.md>) | 是 | 拦截此协议的拦截器。 |
...
开启当前网页摄像头捕获。使用摄像头功能前请在module.json5中添加权限: ohos.permission.CAMERA，具体权限的添加方法请参考[在配置文件中声明权限](../../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md#在配置文件中声明权限)。
...
| cacheOptions | [CacheOptions](<../Interfaces (其他)/arkts-apis-webview-i.md#cacheoptions12>) | 是 | 用于控制字节码缓存更新。 |
...
1. 首先，在EntryAbility中将[UIContext](<../../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)存到[localStorage](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md>)中。
...
3. 编写用于生成字节码缓存的组件，本例中的本地Javascript资源内容通过文件读取接口读取rawfile目录下的本地文件。
   ...
   JavaScript资源的获取方式也可通过[数据请求](<../../../../网络/Network Kit（网络服务）/ArkTS API/@ohos.net.http (数据请求)/js-apis-http.md>)的方式获取，但此方法获取到的HTTP响应头非标准HTTP响应头格式，需额外将响应头转换成标准HTTP响应头格式后使用。如通过数据请求获取到的响应头是e-tag，则需要将其转换成E-Tag后使用。
4. 编写业务用组件代码。
...
注册回调函数，使用[enableNativeMediaPlayer](<../../../ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#enablenativemediaplayer12>)开启应用接管网页媒体播放功能后，当网页中有播放媒体时，触发注册的回调函数。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [CreateNativeMediaPlayerCallback](../Types/arkts-apis-webview-t.md#createnativemediaplayercallback12) | 是 | 接管网页媒体播放的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [SnapshotInfo](<../Interfaces (其他)/arkts-apis-webview-i.md#snapshotinfo12>) | 是 | 全量绘制结果入参。 |
| callback | AsyncCallback<[SnapshotResult](<../Interfaces (其他)/arkts-apis-webview-i.md#snapshotresult12>)> | 是 | 全量绘制回调结果。 |
...
injectOfflineResources(resourceMaps: Array<[OfflineResourceMap](<../Interfaces (其他)/arkts-apis-webview-i.md#offlineresourcemap12>)>): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resourceMaps | Array<[OfflineResourceMap](<../Interfaces (其他)/arkts-apis-webview-i.md#offlineresourcemap12>)> | 是 | 本地离线资源配置对象，单次调用最大支持注入30个资源，单个资源最大支持10Mb。 |
...
设置一个路径列表，当file协议访问该路径列表中的资源时，允许跨域访问本地文件，也允许跨域访问其他在线资源。此外，当设置了路径列表时，file协议仅允许访问路径列表中的资源（[fileAccess](<../../../ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#fileaccess>)的行为将会被此接口行为覆盖）。

setPathAllowingUniversalAccess放开目录的跨域访问限制是一个高风险操作。基于最小权限原则，当前el1，el2放开的路径是固定的，路径列表中的路径应符合以下任一路径格式：

1.应用文件目录的子目录（应用文件目录通过Ability Kit中的[Context.filesDir](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md#属性>)获取），例如：

* /data/storage/el2/base/files/example
* /data/storage/el2/base/haps/entry/files/example

2.应用资源目录及其子目录（应用资源目录通过Ability Kit中的[Context.resourceDir](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md#属性>)获取），例如：

* /data/storage/el1/bundle/entry/resources/resfile
* /data/storage/el1/bundle/entry/resources/resfile/example

3.从API version 21开始，还包括了应用缓存目录及其子目录（应用缓存目录通过Ability Kit中的[Context.cacheDir](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md#属性>)获取），例如：

* /data/storage/el2/base/cache
* /data/storage/el2/base/haps/entry/cache/example
* 设置的目录路径中，不允许包含cache/web，否则会抛出异常码401。如果设置目录路径是cache，cache/web也不允许访问。

4.从API version 21开始，还包括了应用临时目录及其子目录（应用临时目录通过Ability Kit中的[Context.tempDir](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md#属性>)获取），例如：

* /data/storage/el2/base/temp
* /data/storage/el2/base/haps/entry/temp/example

当路径列表中有其中一个路径不满足以上条件之一，则会抛出异常码401，并且设置路径列表失败。当设置的路径列表为空，则file协议可访问范围以[fileAccess](<../../../ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#fileaccess>)的行为为准。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| features | [BackForwardCacheSupportedFeatures](<../Class (BackForwardCacheSupportedFeatures)/arkts-apis-webview-backforwa_37427919.md>) | 是 | 允许使用特定的页面进入前进后退缓存中。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [BackForwardCacheOptions](<../Class (BackForwardCacheOptions)/arkts-apis-webview-backforwardcacheoptions.md>) | 是 | 用来控制Web组件前进后退缓存相关选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| level | [PressureLevel](../Enums/arkts-apis-webview-e.md#pressurelevel14) | 是 | 需要清理内存的内存等级。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| configuration | [PdfConfiguration](<../Interfaces (其他)/arkts-apis-webview-i.md#pdfconfiguration14>) | 是 | 生成PDF所需参数。 |
| callback | AsyncCallback<[PdfData](<../Class (PdfData)/arkts-apis-webview-pdfdata.md>)> | 是 | 回调返回网页PDF数据流。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PdfData](<../Class (PdfData)/arkts-apis-webview-pdfdata.md>)> | Promise实例，返回网页数据流。 |
...
| 类型 | 说明 |
| --- | --- |
| [ScrollOffset](<../Interfaces (其他)/arkts-apis-webview-i.md#scrolloffset13>) | 网页当前的滚动偏移量（包含过滚动偏移量）。 |
...
| 类型 | 说明 |
| --- | --- |
| [ScrollOffset](<../Interfaces (其他)/arkts-apis-webview-i.md#scrolloffset13>) | 网页当前的滚动偏移量（不包含过滚动偏移量）。 |
...
| 类型 | 说明 |
| --- | --- |
| [HitTestValue](<../Interfaces (其他)/arkts-apis-webview-i.md#hittestvalue>) | 点击区域的元素信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [ControllerAttachState](<../Interfaces (其他)/arkts-apis-webview-i.md#controllerattachstate20>) | WebViewController与Web组件的绑定状态。 |
...
| callback | Callback<[ControllerAttachState](<../Interfaces (其他)/arkts-apis-webview-i.md#controllerattachstate20>)> | 是 | WebViewController绑定状态改变时的回调函数。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 表示注册WebViewController绑定状态事件，固定为"controllerAttachStateChange"。 |
| callback | Callback<[ControllerAttachState](<../Interfaces (其他)/arkts-apis-webview-i.md#controllerattachstate20>)> | 否 | WebViewController绑定状态发生改变时的回调函数，默认情况下不填写回调函数。如果填写了Callback，将仅取消注册该特定的回调。如果不填写Callback，将取消注册所有回调。  传入null或undefined时会抛出异常错误码401。 |
...
异步等待WebViewController与Web组件绑定完成，绑定完成或超时触发回调，通过Promise方式返回当前[ControllerAttachState](<../Interfaces (其他)/arkts-apis-webview-i.md#controllerattachstate20>)状态。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ControllerAttachState](<../Interfaces (其他)/arkts-apis-webview-i.md#controllerattachstate20>)> | Promise实例，返回当前[ControllerAttachState](<../Interfaces (其他)/arkts-apis-webview-i.md#controllerattachstate20>)状态。 |
...
* 当指定了端口port时，ArkWeb会启动一个tcp socket监听。这时可以无线调试网页。详情请参考[无线调试](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/Web调试维测/使用DevTools工具调试前端页面/web-debugging-with-devtools.md#无线调试)。
...
| 类型 | 说明 |
| --- | --- |
| [WebHitTestType](../Enums/arkts-apis-webview-e.md#webhittesttype) | 被点击区域的元素类型。 |
...
* 该接口高度设置为0时，Web网页内容可恢复，键盘弹起避让模式将使用[keyboardAvoidMode()](<../../../ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#keyboardavoidmode12>)声明的模式。
...
在当前接口设置为true时如果页面加载发生错误将触发[onOverrideErrorPage](<../../../ArkTS 组件/Web/事件/arkts-basic-components-web-events.md#onoverrideerrorpage20>)回调，可在该回调接口中设置自定义的错误展示页面。
...
获取页面首屏加载预测信息（详细说明见[BlanklessInfo](<../Interfaces (其他)/arkts-apis-webview-i.md#blanklessinfo20>)），并开始本次加载过渡帧生成，应用根据此信息确定是否需要启用无白屏加载。必须与[setBlanklessLoadingWithKey](arkts-apis-webview-webviewcontroller.md#setblanklessloadingwithkey20)接口配套使用，并且必须在触发加载页面的接口之前或在onLoadIntercept中调用。需在WebViewController与Web组件绑定后才能使用。
...
* 如果发现快照相似度（即[BlanklessInfo](<../Interfaces (其他)/arkts-apis-webview-i.md#blanklessinfo20>)中的similarity）极低，请确认key值是否传递正确。
...
* 请在module.json5中添加权限: ohos.permission.INTERNET和ohos.permission.GET\_NETWORK\_INFO，具体权限的添加方法请参考[在配置文件中声明权限](../../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md#在配置文件中声明权限)。
...
| 类型 | 说明 |
| --- | --- |
| [BlanklessInfo](<../Interfaces (其他)/arkts-apis-webview-i.md#blanklessinfo20>) | 页面首屏加载预测信息，主要包括首屏相似度预测值，首屏加载耗时预测值，应用需根据此信息来决策是否启用无白屏加载插帧。 |
...
| 类型 | 说明 |
| --- | --- |
| [WebBlanklessErrorCode](../Enums/arkts-apis-webview-e.md#webblanklesserrorcode20) | 返回接口调用是否成功，具体见[WebBlanklessErrorCode](../Enums/arkts-apis-webview-e.md#webblanklesserrorcode20)定义。 |
...
| --- | --- | --- | --- |
| key | string | 是 | 唯一标识本页面的key值。必须与getBlanklessInfoWithKey接口的key值相同。  合法取值范围：非空，长度不超过2048个字符。  非法值设置行为：返回错误码WebBlanklessErrorCode，方案不生效。 |
| param | [BlanklessLoadingParam](<../Interfaces (其他)/arkts-apis-webview-i.md#blanklessloadingparam23>) | 是 | 白屏插帧加载的各项参数设置。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [WebBlanklessErrorCode](../Enums/arkts-apis-webview-e.md#webblanklesserrorcode20) | 返回接口调用结果。 |
...
设置Web组件的销毁模式。当Web组件销毁时，销毁模式会影响Web内核资源释放的时机，例如JavaScript运行上下文、渲染上下文等。默认值：[WebDestroyMode.NORMAL\_MODE](../Enums/arkts-apis-webview-e.md#webdestroymode20)（普通模式），由系统决定销毁时机。应用可设置[WebDestroyMode.FAST\_MODE](../Enums/arkts-apis-webview-e.md#webdestroymode20)（快速模式），以立即销毁资源，从而提升特定场景的性能。

说明

[WebDestroyMode.FAST\_MODE](../Enums/arkts-apis-webview-e.md#webdestroymode20)（快速模式）会改变Web组件销毁时机，应用需关注依赖Web组件销毁时机的错误实现，例如：Web组件销毁后仍调用WebviewController的未定义行为，与[WebDestroyMode.NORMAL\_MODE](../Enums/arkts-apis-webview-e.md#webdestroymode20)（普通模式）相比，销毁时机提前，有更高的几率触发未关联绑定的异常（17100001），建议应用捕捉异常，或者通过[getAttachState](arkts-apis-webview-webviewcontroller.md#getattachstate20)方法查询是否绑定状态，来避免稳定性问题。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [WebDestroyMode](../Enums/arkts-apis-webview-e.md#webdestroymode20) | 是 | 设置Web组件的销毁模式。  默认值：WebDestroyMode.NORMAL\_MODE |
...
在Web页面场景，设置全局滚动条模式。不显式调用时，默认为[ScrollbarMode.OVERLAY\_LAYOUT\_SCROLLBAR](../Enums/arkts-apis-webview-e.md#scrollbarmode23) （非常驻滚动条）。

说明

* 根据滚动条模式，改变当前应用所有web滚动条模式为常驻滚动条或非常驻滚动条。
* 若[forceDisplayScrollBar](<../../../ArkTS 组件/Web/属性/arkts-basic-components-web-attributes.md#forcedisplayscrollbar14>)接口与当前接口同时设置，forceDisplayScrollBar接口设置不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scrollbarMode | [ScrollbarMode](../Enums/arkts-apis-webview-e.md#scrollbarmode23) | 是 | 滚动条模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| engineVersion | [ArkWebEngineVersion](../Enums/arkts-apis-webview-e.md#arkwebengineversion20) | 是 | ArkWeb内核版本。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkWebEngineVersion](../Enums/arkts-apis-webview-e.md#arkwebengineversion20) | 返回由[ArkWebEngineVersion](../Enums/arkts-apis-webview-e.md#arkwebengineversion20)所定义的当前使用的ArkWeb内核版本。 |
...
| 类型 | 说明 |
| --- | --- |
| [SiteIsolationMode](../Enums/arkts-apis-webview-e.md#siteisolationmode21) | 站点隔离模式类型。  getSiteIsolationMode()查询当前生效的站点隔离模式。 |
...
对于仅加载可信网页的第三方应用，可以关闭此功能，以提升性能并减少内存占用，同时减少跨域访问的拦截。默认值根据不同的设备而定，PC/Table采用严格站点隔离[SiteIsolationMode.STRICT](../Enums/arkts-apis-webview-e.md#siteisolationmode21)，Phone默认部分站点隔离[SiteIsolationMode.PARTIAL](../Enums/arkts-apis-webview-e.md#siteisolationmode21)。[坚盾守护模式](../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/管理Web组件的网络安全与隐私/坚盾守护模式/web-secure-shield-mode.md)下采用严格站点隔离。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [SiteIsolationMode](../Enums/arkts-apis-webview-e.md#siteisolationmode21) | 是 | 设置站点隔离模式。  默认值取决于设备类型和设备模式：PC/Tablet默认严格站点隔离，Phone默认部分站点隔离；坚盾守护模式默认严格站点隔离。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [WebSoftKeyboardBehaviorMode](../Enums/arkts-apis-webview-e.md#websoftkeyboardbehaviormode22) | 是 | Web软键盘自动控制模式。 |
...
恢复当前网页麦克风捕获。使用麦克风功能前请在module.json5中添加权限: ohos.permission.MICROPHONE，具体权限的添加方法请参考[在配置文件中声明权限](../../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md#在配置文件中声明权限)。
...
| metaData | [UserAgentMetadata](<../Class (UserAgentMetadata)/arkts-apis-webview-useragentmetadata.md>) | 是 | userAgent对应的UserAgentMetadata。可以先使用[getUserAgentMetadata](arkts-apis-webview-webviewcontroller.md#getuseragentmetadata24)获取当前默认值，然后用相应方法进行修改。 |
...
| 类型 | 说明 |
| --- | --- |
| UserAgentMetadata | userAgent对应的[UserAgentMetadata](<../Class (UserAgentMetadata)/arkts-apis-webview-useragentmetadata.md>)。 |
