...
scraped_at: 2026-06-11T16:00:44+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:7b9f151b056e6ccd9ed8a0a7d8563c9b34f0ca9f1fb6005d1ab117ed229b31a8
---
...
在调用本接口前，若尚未创建Web组件且未执行[initializeWebEngine](<../Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#initializewebengine>)方法完成Web内核初始化，必须先调用initializeWebEngine方法进行初始化，否则接口调用无效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| webDownloadItem | [WebDownloadItem](<../Class (WebDownloadItem)/arkts-apis-webview-webdownloaditem.md>) | 是 | 待恢复的下载任务。 |
