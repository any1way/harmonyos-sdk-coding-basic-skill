...
scraped_at: 2026-06-01T15:54:57+08:00
doc_updated_at: 2026-04-13
content_hash: sha256:439f137a716dde97923257d21a3246f155ffe8c302d2d9a37a53a61125923a1f
---
通过WebMessagePort可以进行消息的发送以及接收，发送[WebMessageType](../Enums/arkts-apis-webview-e.md#webmessagetype10)/[WebMessage](../Types/arkts-apis-webview-t.md#webmessage)类型消息给HTML5侧。
...
发送[WebMessage](../Types/arkts-apis-webview-t.md#webmessage)类型消息给HTML5侧，必须先调用[onMessageEvent](arkts-apis-webview-webmessageport.md#onmessageevent)，否则会发送失败。完整示例代码参考[postMessage](<../Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#postmessage>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| message | [WebMessage](../Types/arkts-apis-webview-t.md#webmessage) | 是 | 要发送的消息。 |
...
在应用侧的消息端口上注册回调函数，接收HTML5侧发送过来的[WebMessage](../Types/arkts-apis-webview-t.md#webmessage)类型消息。完整示例代码参考[postMessage](<../Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#postmessage>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (result: [WebMessage](../Types/arkts-apis-webview-t.md#webmessage)) => void | 是 | 接收到的消息。 |
...
发送[WebMessageType](../Enums/arkts-apis-webview-e.md#webmessagetype10)类型消息给HTML5侧，必须先调用[onMessageEventExt](arkts-apis-webview-webmessageport.md#onmessageeventext10)，否则会发送失败。完整示例代码参考[onMessageEventExt](arkts-apis-webview-webmessageport.md#onmessageeventext10)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| message | [WebMessageExt](<../Class (WebMessageExt)/arkts-apis-webview-webmessageext.md>) | 是 | 要发送的消息。 |
...
在应用侧的消息端口上注册回调函数，接收HTML5侧发送过来的[WebMessageType](../Enums/arkts-apis-webview-e.md#webmessagetype10)类型消息。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (result: [WebMessageExt](<../Class (WebMessageExt)/arkts-apis-webview-webmessageext.md>)) => void | 是 | 接收到的消息。 |
...
不需要发送消息时关闭该消息端口。在使用close前，请先使用[createWebMessagePorts](<../Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#createwebmessageports>)创建消息端口。
