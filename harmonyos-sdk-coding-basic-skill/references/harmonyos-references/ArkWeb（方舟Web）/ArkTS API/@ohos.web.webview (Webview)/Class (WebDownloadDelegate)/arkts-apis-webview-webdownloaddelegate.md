...
scraped_at: 2026-06-01T15:54:40+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:6919131ce1ddc53406555bbc1255883da9e7ab4ae8ed5b5f2c39cce0777b3993
---
...
处于PENDING状态的下载任务会首先将文件保存至临时目录。在调用[WebDownloadItem.start](<../Class (WebDownloadItem)/arkts-apis-webview-webdownloaditem.md#start11>)并指定目标路径后，临时文件将被重命名为目标文件名，未完成下载的部分会在调用WebDownloadItem.start并指定目标路径后直接下载到目标路径。若希望避免在调用WebDownloadItem.start前生成临时文件，可先通过[WebDownloadItem.cancel](<../Class (WebDownloadItem)/arkts-apis-webview-webdownloaditem.md#cancel11>)来取消当前的下载任务，之后再使用[WebDownloadManager.resumeDownload](<../Class (WebDownloadManager)/arkts-apis-webview-webdownloadmanager.md#resumedownload11>)来恢复被取消的下载任务。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[WebDownloadItem](<../Class (WebDownloadItem)/arkts-apis-webview-webdownloaditem.md>)> | 是 | 触发下载的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[WebDownloadItem](<../Class (WebDownloadItem)/arkts-apis-webview-webdownloaditem.md>)> | 是 | 下载更新的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[WebDownloadItem](<../Class (WebDownloadItem)/arkts-apis-webview-webdownloaditem.md>)> | 是 | 下载完成的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[WebDownloadItem](<../Class (WebDownloadItem)/arkts-apis-webview-webdownloaditem.md>)> | 是 | 下载失败的回调。 |
