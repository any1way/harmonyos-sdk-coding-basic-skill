...
scraped_at: 2026-06-01T15:54:59+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:da5d45061cda25839309ac1f937f620616602b4a453dcc61ce0f1ed3ec024f6a
---
说明
...
[getLastHitTest](<../Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#getlasthittest18>)接口用于指示光标节点。
...
[WebMessagePort](<../Interface (WebMessagePort)/arkts-apis-webview-webmessageport.md>)接口所支持的数据类型。
...
[runJavaScriptExt](<../Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#runjavascriptext10>)接口脚本执行后返回的结果的类型。
...
[OfflineResourceMap](<../Interfaces (其他)/arkts-apis-webview-i.md#offlineresourcemap12>)对象对应的本地离线资源的接口类型。
...
Scroll滚动类型，用于[setScrollable](<../Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#setscrollable12>)。
...
[handleStatusChanged](<../Interface (NativeMediaPlayerHandler)/arkts-apis-webview-nativemediaplayerhandler.md#handlestatuschanged12>) 接口参数， 用于表示播放器的播放状态。
...
| ERR\_KEY\_NOT\_MATCH | -4 | 未匹配到key值，对于[setBlanklessLoadingWithKey](<../Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#setblanklessloadingwithkey20>)需与[getBlanklessInfoWithKey](<../Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#getblanklessinfowithkey20>)配套使用并且key值一致，否则返回该错误码。 |
| ERR\_SIGNIFICANT\_CHANGE | -5 | 当相似度较低时，系统会判定为跳变太大，[setBlanklessLoadingWithKey](<../Class (WebviewController)/arkts-apis-webview-webviewcontroller.md#setblanklessloadingwithkey20>)接口不会成功启用插帧。 |
| ERR\_DURATION\_OUT\_OF\_RANGE23+ | -6 | 在[BlanklessLoadingParam](<../Interfaces (其他)/arkts-apis-webview-i.md#blanklessloadingparam23>)设置的插帧持续时间超出范围。  **模型约束：** 此接口仅可在Stage模型下使用。 |
| ERR\_EXPIRATION\_TIME\_OUT\_OF\_RANGE23+ | -7 | 在[BlanklessLoadingParam](<../Interfaces (其他)/arkts-apis-webview-i.md#blanklessloadingparam23>)设置的历史帧失效时间超出范围。  **模型约束：** 此接口仅可在Stage模型下使用。 |
