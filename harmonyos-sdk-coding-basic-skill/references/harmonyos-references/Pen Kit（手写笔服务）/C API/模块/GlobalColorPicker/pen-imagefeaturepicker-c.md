...
scraped_at: 2026-06-11T16:23:58+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:c49d82181c1252eb0f4a7086d8eafede7792476d9dcf9f5bc429348974b4e5c5
---
## 概述
...
| 名称 | 描述 |
| --- | --- |
| [native\_gcp\_api.h](<../../../../硬件/Pen Kit（手写笔服务）/C API/头文件和结构体/头文件/native_gcp_api.h/pen-headerfile-declare.md>) | 声明用于对外提供全局取色能力。 |
...
| 名称 | 描述 |
| --- | --- |
| struct [HMS\_GCP\_Color](<../../../../硬件/Pen Kit（手写笔服务）/C API/头文件和结构体/结构体/HMS_GCP_Color/pen-imagefeaturepicker-struct-color.md>) | 定义颜色值的结构体。 |
| struct [HMS\_GCP\_PickedColorInfo](<../../../../硬件/Pen Kit（手写笔服务）/C API/头文件和结构体/结构体/HMS_GCP_PickedColorInfo/pen-imagefeaturepicker-struct-colorinfo.md>) | 定义取色的颜色信息的结构体。 |
...
| 名称 | 描述 |
| --- | --- |
| typedef void(\* [HMS\_GCP\_OnResult](pen-imagefeaturepicker-c.md#hms_gcp_onresult)) (void \*userData, [HMS\_GCP\_PickedColorInfo](<../../../../硬件/Pen Kit（手写笔服务）/C API/头文件和结构体/结构体/HMS_GCP_PickedColorInfo/pen-imagefeaturepicker-struct-colorinfo.md>) colorInfo, const int32\_t code) | 此回调用于接收拾取的颜色结果。 |
