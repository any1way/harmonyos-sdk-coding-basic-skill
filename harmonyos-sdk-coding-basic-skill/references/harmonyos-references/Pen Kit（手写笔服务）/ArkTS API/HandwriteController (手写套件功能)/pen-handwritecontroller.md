...
scraped_at: 2026-06-11T16:23:51+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:493e15860f7be3835ba9c0652272fd8b8e6aac88831fb947c19e585238b73c88
---
...
以下错误码的详细介绍请参见[ArkTS API 错误码](<../../ArkTS API 错误码/pen-error-code.md>)。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PixelMap](<../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | Promise对象，返回缩略图的数据。 |
...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| left | number | 矩形左侧的位置。单位：手写套件组件[HandwriteComponent](../../ArkTS组件/HandwriteComponent（手写套件组件）/pen-handwritecomponent.md)宽度的1/1000。 |
| top | number | 矩形顶部的位置。单位：手写套件组件[HandwriteComponent](../../ArkTS组件/HandwriteComponent（手写套件组件）/pen-handwritecomponent.md)宽度的1/1000。 |
| right | number | 矩形右侧的位置。单位：手写套件组件[HandwriteComponent](../../ArkTS组件/HandwriteComponent（手写套件组件）/pen-handwritecomponent.md)宽度的1/1000。 |
| bottom | number | 矩形底部的位置。单位：手写套件组件[HandwriteComponent](../../ArkTS组件/HandwriteComponent（手写套件组件）/pen-handwritecomponent.md)宽度的1/1000。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| yOffset | number | 是 | 滚动位置的纵坐标绝对值。单位vp。当前可滚动最大距离为[px2vp](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#px2vp12>)(1000000)减去list组件高度。超出范围取边界值。 |
...
使用前需要先[设置context信息](<../../../../harmonyos-guides/系统/硬件/Pen Kit（手写笔服务）/手写功能开发/接入手写套件/pen-suite.md#开发步骤>)。
