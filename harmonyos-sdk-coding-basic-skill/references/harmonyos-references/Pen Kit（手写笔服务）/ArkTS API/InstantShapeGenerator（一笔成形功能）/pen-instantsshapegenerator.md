...
scraped_at: 2026-06-11T16:23:52+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:5a9fae9e01433f2cf9c16ca1ea5cac42155e97f0b3d07852c1144559ab41b7f6
---
一笔成形的功能入口类。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| shapePath | [Path2D](../../../ArkUI（方舟UI框架）/ArkTS组件/画布绘制/Path2D/ts-components-canvas-path2d.md) | 否 | 否 | 图形对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [TouchEvent](../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明) | 是 | 当前触摸点事件。 |
...
| 类型 | 说明 |
| --- | --- |
| [Path2D](../../../ArkUI（方舟UI框架）/ArkTS组件/画布绘制/Path2D/ts-components-canvas-path2d.md) | 形状信息生成的Path2D对象。 |
...
3. try {
4. this.instantShapeGenerator?.setPauseTime(280);
5. } catch (error) {
6. console.error('setPauseTime failed: ', error);
7. }
8. }
```
...
onShapeRecognized(callback: Callback<ShapeInfo>): [InstantShapeGenerator](pen-instantsshapegenerator.md)
