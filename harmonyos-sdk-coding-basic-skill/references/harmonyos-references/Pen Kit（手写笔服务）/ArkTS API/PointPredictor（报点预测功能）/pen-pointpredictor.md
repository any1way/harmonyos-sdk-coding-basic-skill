...
content_hash: sha256:cc18430da4d202a763a51253acf89f1a63368bbddd56432cb045a9082c5ed0bb
---
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| event | [TouchEvent](../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明) | 是 | 当前点信息。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [TouchPoint](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#touchpoint11) | 预测点信息。 |
