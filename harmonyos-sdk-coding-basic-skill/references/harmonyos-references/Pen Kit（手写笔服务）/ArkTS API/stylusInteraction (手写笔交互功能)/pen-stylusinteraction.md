...
scraped_at: 2026-06-11T16:23:54+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:87871488a0efaeb8351a6d74537e21e211c952c865ae31d68c5d72f13791420e
---
...
| --- | --- | --- | --- |
| type | string | 是 | 固定填写"squeeze"字符串，表示手写笔笔身轻捏事件。 |
| receiver | Callback<[SqueezeEvent](pen-stylusinteraction.md#squeezeevent)> | 否 | 回调函数，需要取消注册的手写笔轻捏事件对象，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的轻捏事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 固定填写"doubleTap"字符串，表示手写笔笔身双击事件。 |
| receiver | Callback<[DoubleTapEvent](pen-stylusinteraction.md#doubletapevent)> | 否 | 回调函数，需要取消注册的手写笔双击事件对象，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的双击事件。 |
