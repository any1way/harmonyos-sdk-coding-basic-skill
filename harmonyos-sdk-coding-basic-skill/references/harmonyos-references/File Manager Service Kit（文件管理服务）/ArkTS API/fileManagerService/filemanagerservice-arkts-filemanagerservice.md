...
scraped_at: 2026-06-01T16:33:46+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:b37cbe5f33194db7441c5f2d7f31e3c96dd63d93cc8cc69e7cb6c5598b6d5399
---
...
此接口参数uri的具体使用方式参见用户文件uri介绍中的[文档类URI的使用方式](<../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#文档类uri>)。
...
以下错误码的详细介绍请参见[ArkTS API错误码](<../ArkTS API错误码/filemanagerservice-arkts-errorcode.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fileType | string | 是 | 文件类型对应的UTD-ID，详见[图标格式说明](../../图标格式说明/filemanagerservice-iconformat.md) |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| string | [Resource](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resource) | 文件图标的Base64编码或资源对象 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<string | [Resource](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resource)> | 文件图标的Base64编码或资源对象。使用Promise异步回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| linkUri | string | 是 | 快捷方式文件的URI，调用方对该文件需要有读权限。具体使用方式参见用户文件URI介绍中的[文档类URI的使用方式](<../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#文档类uri>)，快捷方式文件URI的后缀必须为“.hlink”。 |
