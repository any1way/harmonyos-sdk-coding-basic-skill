...
scraped_at: 2026-06-01T16:41:43+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:953376c39f88e2eb49798feb4c0ffe567b295d693b5f13d7a77d2c221722429f
---
...
以下错误码的详细介绍请参见[通用错误码](../../通用错误码/errorcode-universal.md)和[语言基础类库错误码](../../ArkTS（方舟编程语言）/错误码/语言基础类库错误码/errorcode-utils.md)。
...
1.在加载本地so库时，配置模块级oh-package.json5文件的dependencies项。配置说明见[模块级oh-package.json5](../../../harmonyos-guides/命令行工具/三方依赖管理工具（ohpm）/oh-package.json5/ide-oh-package-json5.md#zh-cn_topic_0000001792256137_oh-packagejson5-字段说明)。
...
2.在模块级build-profile.json5中进行配置。配置说明见[模块级build-profile.json5文件](../../../harmonyos-guides/构建应用/配置文件/模块级build-profile.json5文件/ide-hvigor-build-profile.md)。
