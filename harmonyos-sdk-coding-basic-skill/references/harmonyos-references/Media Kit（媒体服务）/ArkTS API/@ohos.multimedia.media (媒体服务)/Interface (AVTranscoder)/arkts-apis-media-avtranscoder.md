...
scraped_at: 2026-06-01T16:24:03+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:3e1749428b7e6f27962d131365095a02fafd4a15b792858d61b07b99ef5b160e
---
视频转码管理类，用于视频转码。在调用AVTranscoder的方法前，需要先通过[createAVTranscoder()](../Functions/arkts-apis-media-f.md#mediacreateavtranscoder12)构建一个AVTranscoder实例。

视频转码demo可参考：[视频转码开发指导](<../../../../../harmonyos-guides/媒体/Media Kit（媒体服务）/媒体开发指导(ArkTS)/视频转码/使用AVTranscoder实现视频转码(ArkTS)/using-avtranscoder-for-transcodering.md>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [AVTranscoderConfig](<../Interfaces (其他)/arkts-apis-media-i.md#avtranscoderconfig12>) | 是 | 配置视频转码的相关参数。 当config中设置的目标视频分辨率宽videoFrameWidth大于原视频的宽或目标视频分辨率高videoFrameHeight大于原视频的高时，会上报错误码401。 |
...
| callback | [Callback<number>](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>) | 是 | 回调函数，返回进度更新事件，函数中的参数number，表示当前转码百分比进度。 |
...
| callback | [Callback<number>](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>) | 否 | 已注册的进度更新事件回调。由于当前回调注册时，仅会保留最后一次注册的回调，建议此参数缺省。 |
...
| callback | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 是 | 转码错误事件回调方法。 |
...
| callback | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 否 | 错误事件回调方法。 |
...
| callback | [Callback<void>](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>) | 是 | 回调函数，返回完成事件回调方法。 |
...
| callback | [Callback<void>](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>) | 否 | 完成事件回调方法。 |
