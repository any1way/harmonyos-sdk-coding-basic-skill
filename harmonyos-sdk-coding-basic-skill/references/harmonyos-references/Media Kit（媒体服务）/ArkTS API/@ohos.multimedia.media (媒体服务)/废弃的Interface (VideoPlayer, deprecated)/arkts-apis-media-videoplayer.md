...
scraped_at: 2026-06-01T16:24:11+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:5052dfed772032b6cf9a6dc90ecd286036e199c7411ad3aff848c094fdfc511b
---
视频播放管理类，用于管理和播放视频媒体。在调用VideoPlayer的方法前，需要先通过[createVideoPlayer()](../Functions/arkts-apis-media-f.md#mediacreatevideoplayerdeprecated)构建一个VideoPlayer实例。

说明

从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md>)替代。
...
| videoScaleType9+ | [VideoScaleType](../Enums/arkts-apis-media-e.md#videoscaletype9) | 否 | 是 | 视频缩放模式。默认值为VIDEO\_SCALE\_TYPE\_FIT。 |
| audioInterruptMode9+ | [audio.InterruptMode](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#interruptmode9>) | 否 | 是 | 音频焦点模式。 |
| currentTime8+ | number | 是 | 否 | 视频的当前播放位置，单位为毫秒（ms）。 |
| duration8+ | number | 是 | 否 | 视频时长，单位为毫秒（ms），返回-1表示直播模式。 |
| state8+ | [VideoPlayState](../Types/arkts-apis-media-t.md#videoplaystatedeprecated) | 是 | 否 | 视频播放的状态。 |
...
* 从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.surfaceId](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#属性>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| surfaceId | string | 是 | 指定SurfaceId，应从XComponent组件获取，获取方式请参考[XComponent](../../../../ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)。 |
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.prepare](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#prepare9>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.prepare](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#prepare9-1>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.play](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#play9>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.play](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#play9-1>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.pause](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#pause9>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.pause](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#pause9-1>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.stop](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#stop9>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.stop](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#stop9-1>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.reset](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#reset9>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.reset](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#reset9-1>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.seek](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#seek9>)替代。
...
| --- | --- | --- | --- |
| timeMs | number | 是 | 指定的跳转时间节点，单位毫秒（ms），取值范围为[0, duration]。 |
| mode | [SeekMode](../Enums/arkts-apis-media-e.md#seekmode8) | 是 | 跳转模式。 |
| callback | AsyncCallback<number> | 是 | 回调函数。跳转到指定播放位置成功时，err为undefined，data为获取到的跳转到的播放位置，否则为错误对象。 |
...
| --- | --- | --- | --- |
| timeMs | number | 是 | 指定的跳转时间节点，单位毫秒（ms），取值范围为[0, duration]。 |
| mode | [SeekMode](../Enums/arkts-apis-media-e.md#seekmode8) | 否 | 基于视频I帧的跳转模式，默认为SEEK\_PREV\_SYNC模式。 |
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.setVolume](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#setvolume9>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.release](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#release9>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.release](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#release9-1>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.getTrackDescription](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#gettrackdescription9>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[MediaDescription](<../Interfaces (其他)/arkts-apis-media-i.md#mediadescription8>)>> | 是 | 回调函数。获取视频轨道信息成功时，err为undefined，data为获取到的视频轨道信息MediaDescription数组，否则为错误对象。 |
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.getTrackDescription](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#gettrackdescription9-1>)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[MediaDescription](<../Interfaces (其他)/arkts-apis-media-i.md#mediadescription8>)>> | Promise对象，返回获取的视频轨道信息MediaDescription数组。 |
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.setSpeed](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#setspeed9>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| speed | number | 是 | 指定播放视频速度，具体见[PlaybackSpeed](../Enums/arkts-apis-media-e.md#playbackspeed8)。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<number> | Promise对象，返回设置的播放速度，具体见[PlaybackSpeed](../Enums/arkts-apis-media-e.md#playbackspeed8)。 |
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.on('stateChange')](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#onstatechange9>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.on('bufferingUpdate')](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#onbufferingupdate9>)替代。
...
| callback | function | 是 | 视频缓存事件回调方法。  [BufferingInfoType](../Enums/arkts-apis-media-e.md#bufferinginfotype8)value值固定为0。 |
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.on('startRenderFrame')](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#onstartrenderframe9>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.on('videoSizeChange')](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#onvideosizechange9>)替代。
...
监听音频焦点变化事件，参考[audio.InterruptEvent](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#interruptevent9>)。

说明

从API version 9开始支持，从API version 9开始废弃，建议使用[AVPlayer.on('audioInterrupt')](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#onaudiointerrupt9>)替代。
...
从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayer.on('error')](<../Interface (AVPlayer)/arkts-apis-media-avplayer.md#onerror9>)替代。
...
| callback | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 是 | 播放错误事件回调方法。 |
