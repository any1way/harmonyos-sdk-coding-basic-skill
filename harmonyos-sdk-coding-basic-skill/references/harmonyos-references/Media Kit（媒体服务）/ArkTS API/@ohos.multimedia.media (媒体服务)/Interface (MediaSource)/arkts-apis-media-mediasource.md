...
content_hash: sha256:56c5b026b77ba4b2fb1dd715f7fa809889afe21862f67d57576c9be1296c6945
---
媒体数据信息。来源于[createMediaSourceWithUrl](../Functions/arkts-apis-media-f.md#mediacreatemediasourcewithurl12)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mimeType | [AVMimeTypes](../Enums/arkts-apis-media-e.md#avmimetypes12) | 是 | 媒体MIME类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resourceLoader | [MediaSourceLoader](<../Interfaces (其他)/arkts-apis-media-i.md#mediasourceloader18>) | 是 | 应用实现的媒体数据获取接口，方便播放器获取数据。 |
