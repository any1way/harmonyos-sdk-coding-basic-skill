...
content_hash: sha256:d7f8630406f69117b761f0d12b6d6c08e434cb191e3e15e70b494bf7bdcf147e
---
说明

从API version 6开始支持，从API version 9开始废弃，建议使用[AVRecorder](<../Interface (AVRecorder)/arkts-apis-media-avrecorder.md>)替代。

音频录制管理类，用于录制音频媒体。在调用AudioRecorder的方法前，需要先通过[createAudioRecorder()](../Functions/arkts-apis-media-f.md#mediacreateaudiorecorderdeprecated) 构建一个AudioRecorder实例。
...
从API version 6开始支持，从API version 9开始废弃，建议使用[AVRecorder.prepare](<../Interface (AVRecorder)/arkts-apis-media-avrecorder.md#prepare9>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [AudioRecorderConfig](<../Interfaces (其他)/arkts-apis-media-i.md#audiorecorderconfigdeprecated>) | 是 | 配置录音的相关参数，包括音频输出URI、编码格式、采样率、声道数、输出格式等。 |
...
从API version 6开始支持，从API version 9开始废弃，建议使用[AVRecorder.start](<../Interface (AVRecorder)/arkts-apis-media-avrecorder.md#start9>)替代。
...
从API version 6开始支持，从API version 9开始废弃，建议使用[AVRecorder.pause](<../Interface (AVRecorder)/arkts-apis-media-avrecorder.md#pause9>)替代。
...
从API version 6开始支持，从API version 9开始废弃，建议使用[AVRecorder.resume](<../Interface (AVRecorder)/arkts-apis-media-avrecorder.md#resume9>)替代。
...
从API version 6开始支持，从API version 9开始废弃，建议使用[AVRecorder.stop](<../Interface (AVRecorder)/arkts-apis-media-avrecorder.md#stop9>)替代。
...
从API version 6开始支持，从API version 9开始废弃，建议使用[AVRecorder.release](<../Interface (AVRecorder)/arkts-apis-media-avrecorder.md#release9>)替代。
...
从API version 6开始支持，从API version 9开始废弃，建议使用[AVRecorder.reset](<../Interface (AVRecorder)/arkts-apis-media-avrecorder.md#reset9>)替代。
...
从API version 6开始支持，从API version 9开始废弃，建议使用[AVRecorder.on('stateChange')](<../Interface (AVRecorder)/arkts-apis-media-avrecorder.md#onstatechange9>)替代。
...
从API version 6开始支持，从API version 9开始废弃，建议使用[AVRecorder.on('error')](<../Interface (AVRecorder)/arkts-apis-media-avrecorder.md#onerror9>)替代。
...
| callback | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 是 | 录制错误事件回调方法。 |
