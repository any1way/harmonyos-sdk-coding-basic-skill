...
scraped_at: 2026-06-11T16:33:28+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:b71f633ccde44beac0b78a69da8f15de4c812c335f4c5098bd57f3692e898e9a
---
屏幕录制管理类，用于进行屏幕录制。在调用AVScreenCaptureRecorder的方法前，需要先通过[createAVScreenCaptureRecorder()](../Functions/arkts-apis-media-f.md#mediacreateavscreencapturerecorder12)创建一个AVScreenCaptureRecorder实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [AVScreenCaptureRecordConfig](<../Interfaces (其他)/arkts-apis-media-i.md#avscreencapturerecordconfig12>) | 是 | 配置屏幕录制的相关参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowIDs | Array<number> | 是 | 需要豁免隐私的窗口列表，包括主窗口id和子窗口id，窗口属性获取方法可以参考[getWindowProperties](<../../../../ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#getwindowproperties9>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pickerMode | [PickerMode](../Enums/arkts-apis-media-e.md#pickermode22) | 是 | 选择Picker模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| excludedWindows | Array<number> | 是 | 需要在Picker中隐藏的窗口列表，窗口属性获取方法可以参考[getWindowProperties](<../../../../ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#getwindowproperties9>)。 |
...
| callback | Callback<[AVScreenCaptureStateCode](../Enums/arkts-apis-media-e.md#avscreencapturestatecode12)> | 是 | 状态切换事件回调方法，[AVScreenCaptureStateCode](../Enums/arkts-apis-media-e.md#avscreencapturestatecode12)表示切换到的状态。 |
...
| callback | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 是 | 录屏错误事件回调方法。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 状态切换事件回调类型，支持的事件：'stateChange'。 |
| callback | Callback<[AVScreenCaptureStateCode](../Enums/arkts-apis-media-e.md#avscreencapturestatecode12)> | 否 | 状态切换事件回调方法，[AVScreenCaptureStateCode](../Enums/arkts-apis-media-e.md#avscreencapturestatecode12)表示切换到的状态，不填此参数则会取消最后一次订阅事件。 |
...
| callback | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 否 | 录屏错误事件回调方法，不填此参数则会取消最后一次订阅事件。 |
