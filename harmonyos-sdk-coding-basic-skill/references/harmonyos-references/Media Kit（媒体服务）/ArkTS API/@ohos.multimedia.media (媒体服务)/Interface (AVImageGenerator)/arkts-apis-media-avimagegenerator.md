...
content_hash: sha256:8ed60b03ed8eda1a13e00b8c84e84e59b226a436a849f2da6c42a04fc32d7320
---
视频缩略图获取类，用于从视频资源中获取缩略图。在调用AVImageGenerator的方法前，需要先通过[createAVImageGenerator()](../Functions/arkts-apis-media-f.md#mediacreateavimagegenerator12)构建一个AVImageGenerator实例。

获取视频缩略图的demo可参考：[获取视频缩略图开发指导](<../../../../../harmonyos-guides/媒体/Media Kit（媒体服务）/媒体开发指导(ArkTS)/媒体信息查询/使用AVImageGenerator提取视频指定时间图像(ArkTS)/avimagegenerator.md>)。
...
| callback | AsyncCallback<[image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | 是 | 回调函数。获取缩略图成功时，err为undefined，data为PixelMap实例，否则为错误对象。 |
...
| queryMode | [AVImageQueryOptions](../Enums/arkts-apis-media-e.md#avimagequeryoptions12) | 是 | 需要获取的缩略图时间点与视频帧的对应关系。 |
| outputSize | [OutputSize](<../Interfaces (其他)/arkts-apis-media-i.md#outputsize20>) | 否 | 定义帧的输出大小。默认按原图大小显示。 |
