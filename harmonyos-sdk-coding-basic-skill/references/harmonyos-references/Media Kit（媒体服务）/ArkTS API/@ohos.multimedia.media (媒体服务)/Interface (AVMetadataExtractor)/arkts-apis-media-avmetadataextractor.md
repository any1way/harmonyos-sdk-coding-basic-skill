...
scraped_at: 2026-06-01T16:23:56+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:7d81874203785718f2da6d49305a720637c13ba96653d9227c9b946eedab8d76
---
元数据获取类，用于从媒体资源中获取元数据、缩略图。在调用AVMetadataExtractor的方法前，需要先通过[media.createAVMetadataExtractor](../Functions/arkts-apis-media-f.md#mediacreateavmetadataextractor11)构建一个AVMetadataExtractor实例。

获取音频或视频元数据、视频缩略图的demo可参考：[使用AVMetadataExtractor提取音视频元数据信息(ArkTS)](<../../../../../harmonyos-guides/媒体/Media Kit（媒体服务）/媒体开发指导(ArkTS)/媒体信息查询/使用AVMetadataExtractor提取音视频元数据信息(ArkTS)/avmetadataextractor.md>)。
...
| options | [AVImageQueryOptions](../Enums/arkts-apis-media-e.md#avimagequeryoptions12) | 是 | 需要获取的缩略图时间点与视频帧的对应关系。 |
| param | [PixelMapParams](<../Interfaces (其他)/arkts-apis-media-i.md#pixelmapparams12>) | 是 | 需要获取的缩略图的格式参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | Promise对象，返回视频缩略图对象。 |
...
| queryOption | [AVImageQueryOptions](../Enums/arkts-apis-media-e.md#avimagequeryoptions12) | 是 | 需要获取的缩略图时间点与视频帧的对应关系。 |
| param | [PixelMapParams](<../Interfaces (其他)/arkts-apis-media-i.md#pixelmapparams12>) | 是 | 需要获取的缩略图的格式参数。 |
| callback | [OnFrameFetched](../Types/arkts-apis-media-t.md#onframefetched23) | 是 | 需要返回的缩略图信息及可能的异常类型。  异常类型请参考具体返回的错误码信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[AVMetadata](<../Interfaces (其他)/arkts-apis-media-i.md#avmetadata11>)> | 是 | 回调函数。异步返回音视频元数据对象（AVMetadata）。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AVMetadata](<../Interfaces (其他)/arkts-apis-media-i.md#avmetadata11>)> | Promise对象。异步返回音视频元数据对象（AVMetadata）。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | 是 | 回调函数。异步返回专辑封面。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | Promise对象。异步返回专辑封面。 |
