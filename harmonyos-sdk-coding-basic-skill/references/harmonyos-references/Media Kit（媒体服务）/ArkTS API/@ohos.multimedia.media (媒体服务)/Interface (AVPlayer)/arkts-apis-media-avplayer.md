...
scraped_at: 2026-06-01T16:23:58+08:00
doc_updated_at: 2026-05-08
content_hash: sha256:c4e61a6c2fb0e2e2ae128d1a1da23c293e50a333de9337fbc2c8659ac9f4e705
---
播放管理类，用于管理和播放媒体资源。在调用AVPlayer的方法前，需要先通过[createAVPlayer()](../Functions/arkts-apis-media-f.md#mediacreateavplayer9)构建一个AVPlayer实例。
...
Audio/Video播放demo可参考：[音频播放开发指导](<../../../../../harmonyos-guides/媒体/Media Kit（媒体服务）/媒体开发指导(ArkTS)/播放/使用AVPlayer播放音频(ArkTS)/using-avplayer-for-playback.md>)、[视频播放开发指导](<../../../../../harmonyos-guides/媒体/Media Kit（媒体服务）/媒体开发指导(ArkTS)/播放/使用AVPlayer播放视频(ArkTS)/video-playback.md>)。
...
| videoScaleType9+ | [VideoScaleType](../Enums/arkts-apis-media-e.md#videoscaletype9) | 否 | 是 | 视频缩放模式，默认VIDEO\_SCALE\_TYPE\_FIT，动态属性。  只允许在**prepared**/**playing**/**paused**/**completed**状态下设置。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| audioInterruptMode9+ | [audio.InterruptMode](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#interruptmode9>) | 否 | 是 | 音频焦点模型，默认SHARE\_MODE，动态属性。  只允许在**prepared**/**playing**/**paused**/**completed**状态下设置。  在第一次调用[play()](arkts-apis-media-avplayer.md#play9)之前设置， 以便此后中断模式生效。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| audioRendererInfo10+ | [audio.AudioRendererInfo](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#audiorendererinfo8>) | 否 | 是 | 设置音频渲染信息。若媒体源包含视频，则usage默认值为STREAM\_USAGE\_MOVIE，否则usage默认值为STREAM\_USAGE\_MUSIC。rendererFlags默认值为0。若默认usage不满足需求，则须主动配置[audio.AudioRendererInfo](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#audiorendererinfo8>)。  只允许在**initialized**状态下设置。  在第一次调用[prepare()](arkts-apis-media-avplayer.md#prepare9)之前设置，以便音频渲染器信息在之后生效。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| audioEffectMode10+ | [audio.AudioEffectMode](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#audioeffectmode10>) | 否 | 是 | 设置音频音效模式，默认值为EFFECT\_DEFAULT，动态属性。audioRendererInfo的usage变动时会恢复为默认值，只允许在**prepared**/**playing**/**paused**/**completed**状态下设置。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| state9+ | [AVPlayerState](../Types/arkts-apis-media-t.md#avplayerstate9) | 是 | 否 | 音视频播放的状态，全状态有效，可查询参数。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| callback12+ | [OnAVPlayerStateChangeHandle](../Types/arkts-apis-media-t.md#onavplayerstatechangehandle12) | 是 | 状态机切换事件回调方法。 |
...
取消监听播放状态机[AVPlayerState](../Types/arkts-apis-media-t.md#avplayerstate9)切换的事件。
...
| callback12+ | [OnAVPlayerStateChangeHandle](../Types/arkts-apis-media-t.md#onavplayerstatechangehandle12) | 否 | 状态机切换事件回调方法。如果填写该参数，仅取消注册此回调的方法，否则取消注册stateChange事件的所有回调方法。 |
...
| callback | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 是 | 错误事件回调方法，使用播放器的过程中发生错误，会提供错误码ID和错误信息。 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码说明文档](../../../../通用错误码/errorcode-universal.md)和[Media错误码](../../../错误码/Media错误码/errorcode-media.md)。
...
| callback12+ | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 否 | 错误事件回调方法，使用播放器的过程中发生错误，会提供错误码ID和错误信息。如果填写该参数，仅取消注册此回调方法，否则取消注册error事件的所有回调方法。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | [MediaSource](<../Interface (MediaSource)/arkts-apis-media-mediasource.md>) | 是 | 流媒体预下载媒体来源。 |
| strategy | [PlaybackStrategy](<../Interfaces (其他)/arkts-apis-media-i.md#playbackstrategy12>) | 否 | 流媒体预下载播放策略。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| strategy | [PlaybackStrategy](<../Interfaces (其他)/arkts-apis-media-i.md#playbackstrategy12>) | 是 | 播放策略。 |
...
设置播放区间，并通过指定的[SeekMode](../Enums/arkts-apis-media-e.md#seekmode8)跳转到区间开始位置。设置之后，只播放音视频文件设定区间内的内容。使用Promise异步回调。可在**initialized**/**prepared**/**paused**/**stopped**/**completed**状态下使用。
...
| mode | [SeekMode](../Enums/arkts-apis-media-e.md#seekmode8) | 否 | 支持SeekMode.SEEK\_PREV\_SYNC和SeekMode.SEEK\_CLOSEST,  默认值: SeekMode.SEEK\_PREV\_SYNC。 |
...
以下错误码的详细介绍请参见[Media错误码](../../../错误码/Media错误码/errorcode-media.md)。
...
如果应用使用到多个短视频频繁切换的场景，为了提升切换性能，可以考虑创建多个AVPlayer对象，提前准备下一个视频，详情参见[在线短视频流畅切换](../../../../../best-practices/行业场景解决方案/影音娱乐/在线短视频流畅切换/bpta-smooth-switching.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mediaType | [MediaType](../Enums/arkts-apis-media-e.md#mediatype8) | 是 | 媒体类型枚举。  **API version 12-19**：仅支持设置MEDIA\_TYPE\_AUD。  **API version 20及以后**：增加支持设置MEDIA\_TYPE\_VID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<Array<[MediaDescription](<../Interfaces (其他)/arkts-apis-media-i.md#mediadescription8>)>> | 是 | 回调函数，当获取音视频轨道信息成功，err为undefined，data为获取到的MediaDescription数组；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[MediaDescription](<../Interfaces (其他)/arkts-apis-media-i.md#mediadescription8>)>> | Promise对象，返回音视频轨道信息MediaDescription数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PlaybackInfo](<../Interfaces (其他)/arkts-apis-media-i.md#playbackinfo12>)> | Promise对象，返回播放器信息PlaybackInfo。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| index | number | 是 | 多音视频资源的轨道索引，可通过[getTrackDescription](arkts-apis-media-avplayer.md#gettrackdescription9-1)接口获取当前资源的所有轨道信息[MediaDescription](<../Interfaces (其他)/arkts-apis-media-i.md#mediadescription8>)。 |
| mode | [SwitchMode](../Enums/arkts-apis-media-e.md#switchmode12) | 否 | 切换视频轨道模式，默认为SMOOTH模式，**仅在DASH协议网络流视频轨切换时生效**，其他场景当前暂不支持。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| index | number | 是 | 多音视频资源的轨道索引，来自[getTrackDescription](arkts-apis-media-avplayer.md#gettrackdescription9-1)接口所获取的轨道信息[MediaDescription](<../Interfaces (其他)/arkts-apis-media-i.md#mediadescription8>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mediaKeySession | [drm.MediaKeySession](<../../../../DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interface (MediaKeySession)/arkts-apis-drm-mediakeysession.md>) | 是 | 解密会话 |
| secureVideoPath | boolean | 是 | 安全视频通路，true表示选择安全视频通路，false表示选择非安全视频通路 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码说明文档](../../../../通用错误码/errorcode-universal.md)。
...
关于drm模块的示例具体可见[@ohos.multimedia.drm](<../../../../DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/模块描述/arkts-apis-drm.md>)。
...
| 类型 | 说明 |
| --- | --- |
| Array<[drm.MediaKeySystemInfo](<../../../../DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interfaces (其他)/arkts-apis-drm-i.md#mediakeysysteminfo>)> | MediaKeySystemInfo数组，MediaKeySystemInfo具有uuid和pssh两个属性。当返回值为undefined时，表示mediaKeySystemInfoUpdate事件未触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| timeMs | number | 是 | 指定的跳转时间节点，单位毫秒（ms），取值范围为[0, [duration](arkts-apis-media-avplayer.md#属性)]。  当模式为[SEEK\_CONTINUOUS](../Enums/arkts-apis-media-e.md#seekmode8)时，可以取值-1，表示SEEK\_CONTINUOUS模式结束。 |
| mode | [SeekMode](../Enums/arkts-apis-media-e.md#seekmode8) | 否 | 基于视频I帧的跳转模式，默认为SEEK\_PREV\_SYNC模式，**仅在视频资源播放时设置**。 |
...
查询媒体源是否支持以SEEK\_CONTINUOUS模式[SeekMode](../Enums/arkts-apis-media-e.md#seekmode8)进行[seek](arkts-apis-media-avplayer.md#seek9)，在prepared/playing/paused/completed状态调用返回实际值，其余状态调用返回false。对于不支持SEEK\_CONTINUOUS模式进行seek的设备，返回false。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | seek生效的事件回调类型，支持的事件：'seekDone'，除SEEK\_CONTINUOUS外的[SeekMode](../Enums/arkts-apis-media-e.md#seekmode8)每次调用seek后都会回调此事件。 |
| callback | Callback<number> | 是 | 回调函数。seek生效的事件回调方法，只会上报用户请求的time位置。  **视频播放：**[SeekMode](../Enums/arkts-apis-media-e.md#seekmode8)会造成实际跳转位置与用户设置产生偏差，精准位置需要通过currentTime获取，事件回调的time仅代表完成用户某一次请求。 |
...
| callback12+ | Callback<number> | 否 | 回调函数。seek生效的事件回调方法，只会上报用户请求的time位置。  **视频播放：**[SeekMode](../Enums/arkts-apis-media-e.md#seekmode8)会造成实际跳转位置与用户设置产生偏差，精准位置需要通过currentTime获取，事件回调的time仅代表完成用户某一次请求。如果填写该参数，仅取消注册此回调的方法，否则取消注册seekDone事件的所有回调方法。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| speed | [PlaybackSpeed](../Enums/arkts-apis-media-e.md#playbackspeed8) | 是 | 指定播放倍速模式。 |
...
| callback | Callback<number> | 是 | 回调函数。当setSpeed成功，上报生效的倍速模式，具体见[PlaybackSpeed](../Enums/arkts-apis-media-e.md#playbackspeed8)。 |
...
| callback12+ | Callback<number> | 否 | 回调函数。当setSpeed成功，上报生效的倍速模式，具体见[PlaybackSpeed](../Enums/arkts-apis-media-e.md#playbackspeed8)。如果填写该参数，仅取消注册此回调方法，否则取消注册speedDone事件的所有回调方法。 |
...
| callback | [OnPlaybackRateDone](../Types/arkts-apis-media-t.md#onplaybackratedone20) | 是 | setPlaybackRate生效的事件回调方法，上报设置后的播放速率。 |
...
| callback | [OnPlaybackRateDone](../Types/arkts-apis-media-t.md#onplaybackratedone20) | 否 | setPlaybackRate生效的事件回调方法，上报设置后的播放速率。如果填写该参数，仅取消注册此回调方法，否则取消注册playbackRateDone事件的所有回调方法。 |
...
| callback | Callback<Array<drm.[MediaKeySystemInfo](<../../../../DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interfaces (其他)/arkts-apis-drm-i.md#mediakeysysteminfo>)>> | 是 | 版权保护信息更新上报事件回调方法，上报MediaKeySystemInfo数组。 |
...
| callback | Callback<Array<drm.[MediaKeySystemInfo](<../../../../DRM Kit（数字版权保护服务）/ArkTS API/@ohos.multimedia.drm (数字版权保护)/Interfaces (其他)/arkts-apis-drm-i.md#mediakeysysteminfo>)>> | 否 | 版权保护信息更新上报事件回调方法，上报版权保护信息数组。如果填写该参数，仅取消注册此回调方法，否则取消注册mediaKeySystemInfoUpdate事件的所有回调方法。 |
...
* 调用此接口时，需确保已设置音频渲染信息AVPlayer.audioRendererInfo，audioRendererInfo的usage参数必须是[STREAM\_USAGE\_MUSIC](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#streamusage>)、[STREAM\_USAGE\_MOVIE](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#streamusage>)、[STREAM\_USAGE\_AUDIOBOOK](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#streamusage>)其中之一。
* 该接口不支持高清通路的响度设置。
* 音频流的时延模式必须是普通时延。
...
| callback | [OnBufferingUpdateHandler](../Types/arkts-apis-media-t.md#onbufferingupdatehandler12) | 是 | 播放缓存事件回调方法。 |
...
| callback | [OnBufferingUpdateHandler](../Types/arkts-apis-media-t.md#onbufferingupdatehandler12) | 否 | 播放缓存事件回调方法。如果填写该参数，仅取消注册此回调方法，否则取消注册bufferingUpdate事件的所有回调方法。 |
...
| callback | [OnVideoSizeChangeHandler](../Types/arkts-apis-media-t.md#onvideosizechangehandler12) | 是 | 视频播放宽高变化事件回调方法。 |
...
| callback12+ | [OnVideoSizeChangeHandler](../Types/arkts-apis-media-t.md#onvideosizechangehandler12) | 否 | 视频播放宽高变化事件回调方法。如果填写该参数，仅取消注册此回调方法，否则取消注册videoSizeChange事件的所有回调方法。 |
...
监听音频焦点变化事件，多个音视频资源同时播放时，会根据音频焦点模型[audio.InterruptMode](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Enums/arkts-apis-audio-e.md#interruptmode9>)触发此事件。应用需根据不同焦点变化事件作相应处理。具体可参考[处理音频焦点事件](<../../../../../harmonyos-guides/媒体/Audio Kit（音频服务）/音频焦点和音频会话管理/音频焦点介绍/audio-playback-concurrency.md>)。
...
| callback | Callback<[audio.InterruptEvent](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#interruptevent9>)> | 是 | 音频焦点变化事件回调方法。 |
...
| callback12+ | Callback<[audio.InterruptEvent](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#interruptevent9>)> | 否 | 音频焦点变化事件回调方法。如果填写该参数，仅取消注册此回调方法，否则取消注册audioInterrupt事件的所有回调方法。 |
...
在订阅此监听时，建议参考[响应输出设备变更时合理暂停](<../../../../../harmonyos-guides/媒体/Audio Kit（音频服务）/音频设备路由管理/响应输出设备变更时合理暂停/audio-output-device-change.md>)自行实现设备连接或者断开时的播放器行为。
...
| callback | Callback<[audio.AudioStreamDeviceChangeInfo](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#audiostreamdevicechangeinfo11>)> | 是 | 回调函数，返回当前音频流的输出设备描述信息及变化原因。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为：'audioOutputDeviceChangeWithInfo'。 |
| callback | Callback<[audio.AudioStreamDeviceChangeInfo](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/Interfaces (其他)/arkts-apis-audio-i.md#audiostreamdevicechangeinfo11>)> | 否 | 回调函数，返回当前音频流的输出设备描述信息及变化原因。如果填写该参数，仅取消注册此回调方法，否则取消注册audioOutputDeviceChangeWithInfo事件的所有回调方法。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fd | number | 是 | 资源句柄，通过[resourceManager.getRawFd](<../../../../Localization Kit（本地化开发服务）/ArkTS API/@ohos.resourceManager (资源管理)/js-apis-resource-manager.md#getrawfd9>)获取。 |
...
| callback | Callback<[SubtitleInfo](<../Interfaces (其他)/arkts-apis-media-i.md#subtitleinfo12>)> | 是 | 外挂字幕事件回调方法。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为：'subtitleUpdate'。 |
| callback | Callback<[SubtitleInfo](<../Interfaces (其他)/arkts-apis-media-i.md#subtitleinfo12>)> | 否 | 取消外挂字幕事件的回调方法。如果填写该参数，仅取消注册此回调方法，否则取消注册subtitleUpdate事件的所有回调方法。 |
...
| callback | [OnTrackChangeHandler](../Types/arkts-apis-media-t.md#ontrackchangehandler12) | 是 | 轨道变更事件回调方法。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为：'trackChange'。 |
| callback | [OnTrackChangeHandler](../Types/arkts-apis-media-t.md#ontrackchangehandler12) | 否 | 取消轨道变更事件的回调方法。如果填写该参数，仅取消注册此回调方法，否则取消注册trackChange事件的所有回调方法。 |
...
| callback | Callback<Array<[MediaDescription](<../Interfaces (其他)/arkts-apis-media-i.md#mediadescription8>)>> | 是 | 轨道信息更新事件回调方法。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为：'trackInfoUpdate'。 |
| callback | Callback<Array<[MediaDescription](<../Interfaces (其他)/arkts-apis-media-i.md#mediadescription8>)>> | 否 | 取消轨道信息更新事件的回调方法。如果填写该参数，仅取消注册此回调方法，否则取消注册trackInfoUpdate事件的所有回调方法。 |
...
| callback | [OnSeiMessageHandle](../Types/arkts-apis-media-t.md#onseimessagehandle18) | 是 | 用于监听SEI信息事件的回调函数，接收订阅的负载类型。 |
...
| callback | [OnSeiMessageHandle](../Types/arkts-apis-media-t.md#onseimessagehandle18) | 否 | 用于监听SEI信息事件的回调函数，接收订阅的负载类型。如果填写该参数，仅取消注册此回调方法，否则取消注册seiMessageReceived事件的所有回调方法。 |
...
* 在调用[prepare()](arkts-apis-media-avplayer.md#prepare9)前先通过[PlaybackStrategy](<../Interfaces (其他)/arkts-apis-media-i.md#playbackstrategy12>)使能超分。
...
| 5410004 | Missing enable super-resolution feature in [PlaybackStrategy](<../Interfaces (其他)/arkts-apis-media-i.md#playbackstrategy12>). Return by promise. |
...
| callback | [OnSuperResolutionChanged](../Types/arkts-apis-media-t.md#onsuperresolutionchanged-18) | 是 | 超分开关事件回调方法。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为：'superResolutionChanged'，当超分算法开启/关闭状态变化时，触发该事件。 |
| callback | [OnSuperResolutionChanged](../Types/arkts-apis-media-t.md#onsuperresolutionchanged-18) | 否 | 超分开关事件回调方法。如果填写该参数，仅取消注册此回调方法，否则取消注册superResolutionChanged事件的所有回调方法。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PlaybackMetrics](../Types/arkts-apis-media-t.md#playbackmetrics23)> | Promise对象，返回当前播放器的指标信息PlaybackMetrics。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<Array<[AVMetricsEvent](<../Interfaces (其他)/arkts-apis-media-i.md#avmetricsevent23>)>> | 是 | 上报的指标事件信息的方法。使用callback异步回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<Array<[AVMetricsEvent](<../Interfaces (其他)/arkts-apis-media-i.md#avmetricsevent23>)>> | 否 | 上报的指标事件信息的方法。使用callback异步回调。 |
