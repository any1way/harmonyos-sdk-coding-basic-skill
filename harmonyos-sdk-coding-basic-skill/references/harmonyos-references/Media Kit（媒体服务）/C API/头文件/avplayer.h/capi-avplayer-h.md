...
scraped_at: 2026-06-01T16:24:34+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:ec7fea4c8e45b9906caa0fcf72ed427386aa8cc98b1b13efc1004fd35887e5e0
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [MediaKeySession](../../结构体/MediaKeySession/capi-avplayer-mediakeysession.md) | MediaKeySession | MediaKeySession类型。 |
| [DRM\_MediaKeySystemInfo](../../结构体/DRM_MediaKeySystemInfo/capi-avplayer-drm-mediakeysysteminfo.md) | DRM\_MediaKeySystemInfo | DRM\_MediaKeySystemInfo类型。 |
...
| [OH\_AVErrCode OH\_AVPlayer\_SetPlaybackSpeed(OH\_AVPlayer \*player, AVPlaybackSpeed speed)](capi-avplayer-h.md#oh_avplayer_setplaybackspeed) | - | 根据指定的[AVPlaybackSpeed](../avplayer_base.h/capi-avplayer-base-h.md#avplaybackspeed)，设置播放器的播放速率。 |
...
| [OH\_AVErrCode OH\_AVPlayer\_SetPlayerCallback(OH\_AVPlayer \*player, AVPlayerCallback callback)](capi-avplayer-h.md#oh_avplayer_setplayercallback) | - | 设置播放器回调函数。  由于通过此方法设置的信息监听回调函数[OH\_AVPlayerOnInfo](../avplayer_base.h/capi-avplayer-base-h.md#oh_avplayeroninfo)和错误监听回调函数[OH\_AVPlayerOnError](../avplayer_base.h/capi-avplayer-base-h.md#oh_avplayeronerror)可以传递的信息有限，也不便于应用区分多个播放器实例。  从API version 12开始，应使用[OH\_AVPlayer\_SetOnInfoCallback](capi-avplayer-h.md#oh_avplayer_setoninfocallback)、[OH\_AVPlayer\_SetOnErrorCallback](capi-avplayer-h.md#oh_avplayer_setonerrorcallback)接口分别设置信息监听回调函数[OH\_AVPlayerOnInfoCallback](../avplayer_base.h/capi-avplayer-base-h.md#oh_avplayeroninfocallback)和错误监听回调函数[OH\_AVPlayerOnErrorCallback](../avplayer_base.h/capi-avplayer-base-h.md#oh_avplayeronerrorcallback)。(API12废弃) |
...
| [bool OH\_AVPlayer\_IsSeekContinuousSupported(OH\_AVPlayer \*player)](capi-avplayer-h.md#oh_avplayer_isseekcontinuoussupported) | - | 检查媒体源是否支持连续跳转。在已准备、播放中、暂停或完成状态下调用时返回实际值；在其他状态下调用时返回 false。对于不支持[AV\_SEEK\_CONTINUOUS](../avplayer_base.h/capi-avplayer-base-h.md#avplayerseekmode)模式跳转操作的设备，返回false。 |
...
| [OH\_AVErrCode OH\_AVPlayer\_SetVideoSuperResolutionEnable(OH\_AVPlayer \*player, bool enabled)](capi-avplayer-h.md#oh_avplayer_setvideosuperresolutionenable) | - | 动态启用或禁用超分辨率。此API可在AVPlayer处于初始化、已准备、播放中、暂停、完成或停止状态时调用。必须在调用prepare之前在[OH\_AVPlaybackStrategy](../../结构体/OH_AVPlaybackStrategy/capi-avplayer-oh-avplaybackstrategy.md)中启用超分辨率功能。 |
...
| [OH\_AVFormat \*OH\_AVPlayer\_GetPlaybackStatisticMetrics(OH\_AVPlayer \*player)](capi-avplayer-h.md#oh_avplayer_getplaybackstatisticmetrics) | - | 获取当前播放器的统计指标信息。设置完播放资源，并且当播放处于准备（prepared）/播放（playing）/暂停（paused）/完成（completed）/停止（stopped）状态时，可调用该接口。  需要注意返回值[OH\_AVFormat](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVFormat/capi-core-oh-avformat.md>)指针对象的生命周期需要用户手动释放。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [DRM\_MediaKeySystemInfo](../../结构体/DRM_MediaKeySystemInfo/capi-avplayer-drm-mediakeysysteminfo.md)\* mediaKeySystemInfo | DRM信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \* | 如果创建成功返回指向OH\_AVPlayer实例的指针，否则返回空指针。  可能的失败原因：  1.PlayerFactory::CreatePlayer执行失败。  2.new PlayerObject执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：设置成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，url为空或者player SetUrlSource执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：fd设置成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player SetFdSource执行失败。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [OH\_AVDataSourceExt](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVDataSourceExt/capi-codecbase-oh-avdatasourceext.md>)\* datasrc | 指向自定义媒体数据的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：设置成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者输入datasrc为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player Prepare执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player Play执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player Pause执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player Stop执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player Reset执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player Release执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player ReleaseSync执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功设置音量。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player SetVolume执行失败。 |
...
默认响度增益0.0dB。播放器流的usage参数必须是[OH\_AudioStream\_Usage](<../../../../Audio Kit（音频服务）/C API/头文件/native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_usage>).AUDIOSTREAM\_USAGE\_MUSIC，

[OH\_AudioStream\_Usage](<../../../../Audio Kit（音频服务）/C API/头文件/native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_usage>).AUDIOSTREAM\_USAGE\_MOVIE，[OH\_AudioStream\_Usage](<../../../../Audio Kit（音频服务）/C API/头文件/native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_usage>).AUDIOSTREAM\_USAGE\_AUDIOBOOK 之一。

音频渲染器的延迟模式必须是[OH\_AudioStream\_LatencyMode](<../../../../Audio Kit（音频服务）/C API/头文件/native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_latencymode>).AUDIOSTREAM\_LATENCY\_MODE\_NORMAL。
...
| [AVPlayerSeekMode](../avplayer_base.h/capi-avplayer-base-h.md#avplayerseekmode) mode | 播放器的跳转模式。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player Seek执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功获取当前播放位置。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player GetCurrentTime执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功获取视频宽度。  AV\_ERR\_INVALID\_VAL：输入player为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功获取视频高度。  AV\_ERR\_INVALID\_VAL：输入player为空指针。 |
...
根据指定的[AVPlaybackSpeed](../avplayer_base.h/capi-avplayer-base-h.md#avplaybackspeed)，设置播放器的播放速率。
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [AVPlaybackSpeed](../avplayer_base.h/capi-avplayer-base-h.md#avplaybackspeed) speed | 速率模式。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功设置播放速率。  AV\_ERR\_INVALID\_VAL：输入player为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功设置播放速率。  AV\_ERR\_OPERATE\_NOT\_PERMIT：如果在不支持的状态下调用或在直播期间调用。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者速率超出范围。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功获取播放速率。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player GetPlaybackSpeed执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | 如果成功获取当前播放器的播放速率，返回[AV\_ERR\_OK](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>)；  否则返回[native\_averrors.h](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md>)中定义的错误码。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [OH\_AudioStream\_Usage](<../../../../Audio Kit（音频服务）/C API/头文件/native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_usage>) streamUsage | player音频流设置的类型。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功设置音频流类型。  AV\_ERR\_INVALID\_VAL：输入player为空指针或者streamUsage值无效。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [OH\_AudioStream\_VolumeMode](<../../../../Audio Kit（音频服务）/C API/头文件/native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_volumemode>) volumeMode | 指定音频流音量模式。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功设置音频流音量模式。  AV\_ERR\_INVALID\_VAL： 输入player为空指针或者volumeMode值无效。  AV\_ERR\_INVALID\_STATE：函数在无效状态下调用，应先处于准备状态。  AV\_ERR\_SERVICE\_DIED：系统错误。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [OH\_AudioInterrupt\_Mode](<../../../../Audio Kit（音频服务）/C API/头文件/native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiointerrupt_mode>) interruptMode | player音频流使用的打断模式。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功设置音频流的打断模式。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者interruptMode值无效。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [OH\_AudioStream\_AudioEffectMode](<../../../../Audio Kit（音频服务）/C API/头文件/native_audiostream_base.h/capi-native-audiostream-base-h.md#oh_audiostream_audioeffectmode>) effectMode | player音频流使用的音效模式。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功设置音频流的音效模式。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者effectMode值无效。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功设置码率。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player SelectBitRate执行失败。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [OHNativeWindow](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/NativeWindow/capi-codecbase-nativewindow.md>) \*window | 指向OHNativeWindow实例的指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功设置播放画面窗口。  AV\_ERR\_INVALID\_VAL：输入player为空指针，输入window为空指针或者player SetVideoSurface执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功获取媒体文件时长。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player GetDuration执行失败。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [AVPlayerState](../avplayer_base.h/capi-avplayer-base-h.md#avplayerstate) \*state | 当前播放状态。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功获取当前播放状态。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player GetState执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功设置循环播放。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player SetLooping执行失败。 |
...
由于通过此方法设置的信息监听回调函数[OH\_AVPlayerOnInfo](../avplayer_base.h/capi-avplayer-base-h.md#oh_avplayeroninfo)和错误监听回调函数[OH\_AVPlayerOnError](../avplayer_base.h/capi-avplayer-base-h.md#oh_avplayeronerror)可以传递的信息有限，也不便于应用区分多个播放器实例。
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [AVPlayerCallback](../../结构体/AVPlayerCallback/capi-avplayer-avplayercallback.md) callback | 回调对象指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功设置播放器回调。  AV\_ERR\_INVALID\_VAL：输入player为空指针，callback.onInfo或onError为空，或者player SetPlayerCallback执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player SelectTrack执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player DeselectTrack执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：成功获取轨道索引。  AV\_ERR\_INVALID\_VAL：输入player为空指针，或者player GetCurrentTrack执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针，callback为空指针，player SetDrmSystemInfoCallback，  SetDrmSystemInfoCallback或SetDrmSystemInfoCallback执行失败。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [DRM\_MediaKeySystemInfo](../../结构体/DRM_MediaKeySystemInfo/capi-avplayer-drm-mediakeysysteminfo.md) \*mediaKeySystemInfo | 媒体密钥系统信息。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针或者内存不足。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [MediaKeySession](../../结构体/MediaKeySession/capi-avplayer-mediakeysession.md) \*mediaKeySession | 具有解密功能的媒体密钥会话实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：输入player为空指针或者player SetDecryptionConfig执行失败。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [OH\_AVPlayerOnInfoCallback](../avplayer_base.h/capi-avplayer-base-h.md#oh_avplayeroninfocallback) callback | 执行回调监听函数的指针，空指针表示取消设置播放器消息回调监听。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_NO\_MEMORY：内存分配失败。  AV\_ERR\_INVALID\_VAL： 输入player为空指针或者函数执行失败。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [OH\_AVPlayerOnErrorCallback](../avplayer_base.h/capi-avplayer-base-h.md#oh_avplayeronerrorcallback) callback | 执行回调监听函数的指针，空指针表示取消设置播放器错误回调监听。 |
| void \*userData | 指向应用调用者设置的实例的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVFormat \*](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVFormat/capi-core-oh-avformat.md>) | 执行成功返回播放器媒体信息，否则返回nullptr。  可能故障原因：  1. 传入player指针不合法。  2. 设置的播放资源不合法。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVFormat \*](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVFormat/capi-core-oh-avformat.md>) | 执行成功按索引下标返回轨道信息，否则返回nullptr。  可能故障原因：  1. 传入player指针不合法。  2. 设置的播放资源不合法。  3. 轨道索引下标超出播放源文件数组界限。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | 函数执行结果。  AV\_ERR\_OK：表示执行成功。  AV\_ERR\_INVALID\_VAL：表示输入的player为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | 函数执行结果。  AV\_ERR\_OK：表示执行成功。  AV\_ERR\_INVALID\_VAL：表示输入的player为空指针。  AV\_ERR\_OPERATE\_NOT\_PERMIT：表示操作不允许。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [OH\_MediaType](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_avcodec_base.h/capi-native-avcodec-base-h.md#oh_mediatype>) mediaType | 指定的媒体类型，参见[native\_avcodec\_base.h](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_avcodec_base.h/capi-native-avcodec-base-h.md>)中的[OH\_MediaType](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_avcodec_base.h/capi-native-avcodec-base-h.md#oh_mediatype>)。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | 函数执行结果。  AV\_ERR\_OK：表示执行成功。  AV\_ERR\_INVALID\_VAL：表示输入参数无效。  AV\_ERR\_OPERATE\_NOT\_PERMIT：表示操作不允许。 |
...
检查媒体源是否支持连续跳转。在已准备、播放中、暂停或完成状态下调用时返回实际值；在其他状态下调用时返回 false。对于不支持[AV\_SEEK\_CONTINUOUS](../avplayer_base.h/capi-avplayer-base-h.md#avplayerseekmode)模式跳转操作的设备，返回false。
...
| [AVPlayerTrackSwitchMode](../avplayer_base.h/capi-avplayer-base-h.md#avplayertrackswitchmode) mode | 切换模式。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [OH\_AVPlayerOnAmplitudeUpdateCallback](../avplayer_base.h/capi-avplayer-base-h.md#oh_avplayeronamplitudeupdatecallback) callback | 回调函数指针，nullptr表示取消注册回调。 |
...
| [OH\_AVPlayerOnSeiMessageReceivedCallback](../avplayer_base.h/capi-avplayer-base-h.md#oh_avplayeronseimessagereceivedcallback) callback | 回调函数指针，nullptr表示取消注册回调。 |
| void \*userData | 指向用户特定数据的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVFormat \*](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVFormat/capi-core-oh-avformat.md>) | 该消息项的SEI。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | 函数执行结果。  AV\_ERR\_OK：表示执行成功。  AV\_ERR\_INVALID\_VAL：表示输入的player为空指针或参数错误。  AV\_ERR\_OPERATE\_NOT\_PERMIT：表示操作不允许。  AV\_ERR\_SUPER\_RESOLUTION\_UNSUPPORTED：表示不支持超分辨率。  AV\_ERR\_SUPER\_RESOLUTION\_NOT\_ENABLED：表示未在[OH\_AVPlaybackStrategy](../../结构体/OH_AVPlaybackStrategy/capi-avplayer-oh-avplaybackstrategy.md)中启用超分辨率功能。 |
...
动态启用或禁用超分辨率。此API可在AVPlayer处于初始化、已准备、播放中、暂停、完成或停止状态时调用。必须在调用prepare之前在[OH\_AVPlaybackStrategy](../../结构体/OH_AVPlaybackStrategy/capi-avplayer-oh-avplaybackstrategy.md)中启用超分辨率功能。
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVPlaybackStrategy \*](../../结构体/OH_AVPlaybackStrategy/capi-avplayer-oh-avplaybackstrategy.md) | 一个播放策略实例，失败时返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVPlaybackStrategy](../../结构体/OH_AVPlaybackStrategy/capi-avplayer-oh-avplaybackstrategy.md) \*strategy | OH\_AVPlaybackStrategy实例。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | 函数执行结果。  AV\_ERR\_OK：表示执行成功。  AV\_ERR\_INVALID\_VAL：表示输入的strategy为空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVPlaybackStrategy](../../结构体/OH_AVPlaybackStrategy/capi-avplayer-oh-avplaybackstrategy.md) \*strategy | avplayer使用的OH\_AVPlaybackStrategy。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVPlaybackStrategy](../../结构体/OH_AVPlaybackStrategy/capi-avplayer-oh-avplaybackstrategy.md) \*strategy | 指向OH\_AVPlaybackStrategy的指针。 |
...
| --- | --- |
| [OH\_AVPlaybackStrategy](../../结构体/OH_AVPlaybackStrategy/capi-avplayer-oh-avplaybackstrategy.md) \*strategy | 指向OH\_AVPlaybackStrategy的指针。 |
| [OH\_MediaType](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_avcodec_base.h/capi-native-avcodec-base-h.md#oh_mediatype>) mediaType | 要静音的媒体类型。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [OH\_AVPlaybackStrategy](../../结构体/OH_AVPlaybackStrategy/capi-avplayer-oh-avplaybackstrategy.md) \*strategy | 播放策略实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVFormat\*](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVFormat/capi-core-oh-avformat.md>) | 返回指向OH\_AVFormat实例的指针。  若player为空指针或无效，则返回空指针。 |
...
| --- | --- |
| [OH\_AVPlayer](../../结构体/OH_AVPlayer/capi-avplayer-oh-avplayer.md) \*player | 指向OH\_AVPlayer实例的指针。 |
| [OH\_AVMediaSource](../../结构体/OH_AVMediaSource/capi-avmedia-source-oh-avmediasource.md) \*source | 媒体源。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | 函数执行结果。  AV\_ERR\_OK：表示执行成功。  AV\_ERR\_INVALID\_VAL：表示输入的player或者source为空指针，或player设置URL源失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVFormat \*](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVFormat/capi-core-oh-avformat.md>) | 返回指向OH\_AVFormat实例的指针。  若player为空指针或无效，或trackIndex无效，则返回空指针。 |
...
需要注意返回值[OH\_AVFormat](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVFormat/capi-core-oh-avformat.md>)指针对象的生命周期需要用户手动释放。
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVFormat \*](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVFormat/capi-core-oh-avformat.md>) | 执行成功返回播放器的统计指标信息（键值详情请参考avplayer\_base.h中的[变量](../avplayer_base.h/capi-avplayer-base-h.md#变量)信息），否则返回nullptr。  可能的失败原因：传入player指针不合法。 |
