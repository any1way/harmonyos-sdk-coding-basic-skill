...
scraped_at: 2026-06-01T16:24:43+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:6c4158e0d07bf6963bb81aa86903a948ac9606e9df719e3744525a9bcfca9071
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_AVSamplesBuffer](../../结构体/OH_AVSamplesBuffer/capi-avsinkbase-oh-avsamplesbuffer.md) | OH\_AVSamplesBuffer | LowPowerAVSink输入数据的结构体。应用在收到DataNeeded回调后需要将数据打包装进OH\_AVSamplesBuffer实例中送给对应的lowpower\_avsink。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVSamplesBuffer](../../结构体/OH_AVSamplesBuffer/capi-avsinkbase-oh-avsamplesbuffer.md) \*samplesBuffer | 指向OH\_AVSamplesBuffer实例的指针。 |
| [OH\_AVBuffer](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVBuffer/capi-core-oh-avbuffer.md>) \*avBuffer | 指向OH\_AVBuffer实例的指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：参数为nullptr或参数非法。  AV\_ERR\_NO\_MEMORY：framePacketBuffer没有足够的剩余容量来追加一个OH\_AVBuffer。  AV\_ERR\_UNKNOWN：未知错误。 |
