...
scraped_at: 2026-06-11T16:34:10+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:b86f51593028b0770d5a5a8122aefdfbb70a69c50721568f9e7c21f4ea84fd2a
---
## 概述
...
**相关模块：** [LowPowerAudioSink](../../模块/LowPowerAudioSink/capi-lowpoweraudiosink.md)
...
| 参数项 | 描述 |
| --- | --- |
| const char\* mime | 音频解码器MIME类型，取值范围请参考[AVCODEC\_MIME\_TYPE](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_avcodec_base.h/capi-native-avcodec-base-h.md#变量>)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_LowPowerAudioSink](../../结构体/OH_LowPowerAudioSink/capi-lowpoweraudiosink-oh-lowpoweraudiosink.md)\* | 如果创建成功返回指向OH\_LowPowerAudioSink实例的指针，否则返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_LowPowerAudioSink](../../结构体/OH_LowPowerAudioSink/capi-lowpoweraudiosink-oh-lowpoweraudiosink.md)\* sink | 指向OH\_LowPowerAudioSink实例的指针。 |
| const [OH\_AVFormat](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVFormat/capi-core-oh-avformat.md>)\* format | 指向OH\_AVFormat的指针，用于配置LowPowerAudioSink的参数。 |
...
| --- | --- |
| [OH\_LowPowerAudioSink](../../结构体/OH_LowPowerAudioSink/capi-lowpoweraudiosink-oh-lowpoweraudiosink.md)\* sink | 指向OH\_LowPowerAudioSink实例的指针。 |
| const [OH\_AVFormat](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVFormat/capi-core-oh-avformat.md>)\* format | 指向OH\_AVFormat的指针，为LowPowerAudioSink设置的参数。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_LowPowerAudioSink](../../结构体/OH_LowPowerAudioSink/capi-lowpoweraudiosink-oh-lowpoweraudiosink.md)\* sink | 指向LowPowerAudioSink实例的指针。 |
| [OH\_AVFormat](<../../../../AVCodec Kit（音视频编解码服务）/C API/结构体/OH_AVFormat/capi-core-oh-avformat.md>)\* format | 指向OH\_AVFormat实例的指针。 |
...
调用此接口前必须调用LowPowerVideoSink的[OH\_LowPowerVideoSink\_SetSyncAudioSink](../lowpower_video_sink.h/capi-lowpower-video-sink-h.md#oh_lowpowervideosink_setsyncaudiosink)方法。
...
启动成功后，LowPowerAudioSink将开始上报[OH\_LowPowerAudioSink\_OnDataNeeded](../lowpower_audio_sink_base.h/capi-lowpower-audio-sink-base-h.md#oh_lowpoweraudiosink_ondataneeded)事件。
...
暂停成功后，LowPowerAudioSink将暂停[OH\_LowPowerAudioSink\_OnDataNeeded](../lowpower_audio_sink_base.h/capi-lowpower-audio-sink-base-h.md#oh_lowpoweraudiosink_ondataneeded)事件的上报。
...
恢复成功后，LowPowerAudioSink将恢复[OH\_LowPowerAudioSink\_OnDataNeeded](../lowpower_audio_sink_base.h/capi-lowpower-audio-sink-base-h.md#oh_lowpoweraudiosink_ondataneeded)事件的上报。
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_averrors.h/capi-native-averrors-h.md#oh_averrcode>) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：参数为nullptr或参数非法。  AV\_ERR\_SERVICE\_DIED：媒体服务端已销毁。 |
...
| --- | --- |
| [OH\_LowPowerAudioSink](../../结构体/OH_LowPowerAudioSink/capi-lowpoweraudiosink-oh-lowpoweraudiosink.md)\* sink | 指向OH\_LowPowerAudioSink实例的指针。 |
| [OH\_AVSamplesBuffer](../../结构体/OH_AVSamplesBuffer/capi-avsinkbase-oh-avsamplesbuffer.md)\* samples | 需要送OH\_AVSamplesBuffer消费的OH\_AVSamplesBuffer实例，支持聚包输入。 |
...
| --- | --- |
| [OH\_LowPowerAudioSink](../../结构体/OH_LowPowerAudioSink/capi-lowpoweraudiosink-oh-lowpoweraudiosink.md)\* sink | 指向OH\_LowPowerAudioSink实例的指针。 |
| [OH\_LowPowerAudioSinkCallback](../../结构体/OH_LowPowerAudioSinkCallback/capi-lowpoweraudiosink-callback.md)\* callback | 指向OH\_LowPowerAudioSinkCallback实例的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_LowPowerAudioSinkCallback](../../结构体/OH_LowPowerAudioSinkCallback/capi-lowpoweraudiosink-callback.md)\* | 返回指向OH\_LowPowerAudioSinkCallback实例的指针。如果内存不足，则返回nullptr。 |
...
| --- | --- |
| [OH\_LowPowerAudioSinkCallback](../../结构体/OH_LowPowerAudioSinkCallback/capi-lowpoweraudiosink-callback.md)\* callback | 指向OH\_LowPowerAudioSinkCallback实例的指针。 |
| [OH\_LowPowerAudioSink\_OnPositionUpdated](../lowpower_audio_sink_base.h/capi-lowpower-audio-sink-base-h.md#oh_lowpoweraudiosink_onpositionupdated) onPositionUpdated | OH\_LowPowerAudioSink\_OnPositionUpdated方法，在PositionUpdate事件触发时调用。 |
...
| --- | --- |
| [OH\_LowPowerAudioSinkCallback](../../结构体/OH_LowPowerAudioSinkCallback/capi-lowpoweraudiosink-callback.md)\* callback | 指向OH\_LowPowerAudioSinkCallback实例的指针。 |
| [OH\_LowPowerAudioSink\_OnDataNeeded](../lowpower_audio_sink_base.h/capi-lowpower-audio-sink-base-h.md#oh_lowpoweraudiosink_ondataneeded) onDataNeeded | OH\_LowPowerAudioSink\_OnDataNeeded方法，在DataNeeded事件触发时调用。 |
| void\* userData | 用户执行回调所依赖的数据。 |
...
| --- | --- |
| [OH\_LowPowerAudioSinkCallback](../../结构体/OH_LowPowerAudioSinkCallback/capi-lowpoweraudiosink-callback.md)\* callback | 指向OH\_LowPowerAudioSinkCallback实例的指针。 |
| [OH\_LowPowerAudioSink\_OnError](../lowpower_audio_sink_base.h/capi-lowpower-audio-sink-base-h.md#oh_lowpoweraudiosink_onerror) onError | OH\_LowPowerAudioSink\_OnError方法，在Error事件触发时调用。 |
| void\* userData | 用户执行回调所依赖的数据。 |
...
| --- | --- |
| [OH\_LowPowerAudioSinkCallback](../../结构体/OH_LowPowerAudioSinkCallback/capi-lowpoweraudiosink-callback.md)\* callback | 指向OH\_LowPowerAudioSinkCallback实例的指针。 |
| [OH\_LowPowerAudioSink\_OnInterrupted](../lowpower_audio_sink_base.h/capi-lowpower-audio-sink-base-h.md#oh_lowpoweraudiosink_oninterrupted) onInterrupted | OH\_LowPowerAudioSink\_OnInterrupted方法，在Interrupted事件触发时调用。 |
| void\* userData | 用户执行回调所依赖的数据。 |
...
| --- | --- |
| [OH\_LowPowerAudioSinkCallback](../../结构体/OH_LowPowerAudioSinkCallback/capi-lowpoweraudiosink-callback.md)\* callback | 指向OH\_LowPowerAudioSinkCallback实例的指针。 |
| [OH\_LowPowerAudioSink\_OnDeviceChanged](../lowpower_audio_sink_base.h/capi-lowpower-audio-sink-base-h.md#oh_lowpoweraudiosink_ondevicechanged) onDeviceChanged | OH\_LowPowerAudioSink\_OnDeviceChanged方法，在DeviceChanged事件触发时调用。 |
| void\* userData | 用户执行回调所依赖的数据。 |
...
| --- | --- |
| [OH\_LowPowerAudioSinkCallback](../../结构体/OH_LowPowerAudioSinkCallback/capi-lowpoweraudiosink-callback.md) \*callback | 指向OH\_LowPowerAudioSinkCallback实例的指针。 |
| [OH\_LowPowerAudioSink\_OnEos](../lowpower_audio_sink_base.h/capi-lowpower-audio-sink-base-h.md#oh_lowpoweraudiosink_oneos) onEos | OH\_LowPowerAudioSink\_OnEos方法，在Eos事件触发时调用。 |
| void\* userData | 用户执行回调所依赖的数据。 |
