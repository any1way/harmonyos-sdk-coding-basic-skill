...
content_hash: sha256:3ec349b586d75c98bdcb42b3702543bb10c942be8cd5b20263d7ad4472a50d1e
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [VideoProcessing\_ColorSpaceInfo](../../结构体/VideoProcessing_ColorSpaceInfo/capi-videoproc-colorspaceinfo.md) | VideoProcessing\_ColorSpaceInfo | 视频颜色空间信息数据结构。 |
| [OH\_VideoProcessing](../../结构体/OH_VideoProcessing/capi-videoprocessing-oh-videoprocessing.md) | OH\_VideoProcessing | 定义视频处理对象。  定义一个OH\_VideoProcessing空指针，调用[OH\_VideoProcessing\_Create](../video_processing.h/capi-video-processing-h.md#oh_videoprocessing_create)创建视频处理实例，该指针在创建实例之前必须为空。用户可以对不同的处理类型创建不同的视频处理实例。 |
| [NativeWindow](../../结构体/NativeWindow/capi-videoprocessing-nativewindow.md) | OHNativeWindow | 定义NativeWindow对象。 |
| [OH\_AVFormat](../../结构体/OH_AVFormat/capi-videoprocessing-oh-avformat.md) | OH\_AVFormat | 定义OH\_AVFormat对象。 |
| [VideoProcessing\_Callback](../../结构体/VideoProcessing_Callback/capi-videoprocessing-videoprocessing-callback.md) | VideoProcessing\_Callback | 视频处理回调对象类型。  定义一个VideoProcessing\_Callback空指针，调用[OH\_VideoProcessingCallback\_Create](../video_processing.h/capi-video-processing-h.md#oh_videoprocessingcallback_create)来创建一个回调对象。创建之前该指针必须为空。通过调用[OH\_VideoProcessing\_RegisterCallback](../video_processing.h/capi-video-processing-h.md#oh_videoprocessing_registercallback)来向视频处理实例注册回调对象。 |
...
[OH\_VideoProcessing\_SetParameter](../video_processing.h/capi-video-processing-h.md#oh_videoprocessing_setparameter)

[OH\_VideoProcessing\_GetParameter](../video_processing.h/capi-video-processing-h.md#oh_videoprocessing_getparameter)
...
[OH\_AVFormat\_SetIntValue](<../../../../AVCodec Kit（音视频编解码服务）/C API/头文件/native_avformat.h/capi-native-avformat-h.md#oh_avformat_setintvalue>)
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_VideoProcessing](../../结构体/OH_VideoProcessing/capi-videoprocessing-oh-videoprocessing.md)\* videoProcessor | 视频处理实例。 |
...
每个新输出buffer填充好数据之后该buffer的索引就会报告给用户。调用[OH\_VideoProcessing\_RenderOutputBuffer](../video_processing.h/capi-video-processing-h.md#oh_videoprocessing_renderoutputbuffer)根据索引来处理渲染并输出该buffer。如果未注册该函数，则输出buffer填充好数据后不会报告用户，而是直接进行处理渲染并输出。
