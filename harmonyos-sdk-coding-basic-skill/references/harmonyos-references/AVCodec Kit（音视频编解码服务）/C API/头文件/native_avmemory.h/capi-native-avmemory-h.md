...
scraped_at: 2026-06-01T16:18:23+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:01709e530d4f28dda5eb9a5af78f5d1cce97d8a6b76b41e4bb7672b4c530eff0
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_AVMemory](../../结构体/OH_AVMemory/capi-core-oh-avmemory.md) | OH\_AVMemory | 为音视频内存接口定义native层对象。 |
...
**替代接口：** [OH\_AVBuffer\_Create](../native_avbuffer.h/capi-native-avbuffer-h.md#oh_avbuffer_create)
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVMemory](../../结构体/OH_AVMemory/capi-core-oh-avmemory.md) \* | 如果创建成功，返回OH\_AVMemory实例的指针，如果失败，返回NULL。  使用结束后需要通过OH\_AVMemory\_Destroy释放内存。  可能的失败原因：  1. size <= 0。  2. 创建OH\_AVMemory失败。  3. OH\_AVMemory内存分配失败。 |
...
**替代接口：** [OH\_AVBuffer\_GetAddr](../native_avbuffer.h/capi-native-avbuffer-h.md#oh_avbuffer_getaddr)

**参数：**

| 参数项 | 描述 |
| --- | --- |
| [struct OH\_AVMemory](../../结构体/OH_AVMemory/capi-core-oh-avmemory.md) \*mem | 指向OH\_AVMemory实例的指针。 |
...
**替代接口：** [OH\_AVBuffer\_GetCapacity](../native_avbuffer.h/capi-native-avbuffer-h.md#oh_avbuffer_getcapacity)
...
**替代接口：** [OH\_AVBuffer\_Destroy](../native_avbuffer.h/capi-native-avbuffer-h.md#oh_avbuffer_destroy)
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：释放成功。  AV\_ERR\_INVALID\_VAL：  1. 输入mem为空指针。  2. 输入mem参数结构校验失败。  3. 输入mem不是开发者创建的。 |
