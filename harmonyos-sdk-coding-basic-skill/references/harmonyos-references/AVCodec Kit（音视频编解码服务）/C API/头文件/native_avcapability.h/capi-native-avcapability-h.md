...
scraped_at: 2026-06-01T16:18:12+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:dc4f3141ad1c0a8331dc39f8c0bb5dc94a5acae121f34bdbf61e53dd68b2beaa
---
## 概述
...
**相关模块：** [AVCapability](../../模块/AVCapability/capi-avcapability.md)
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_AVRange](../../结构体/OH_AVRange/capi-avcapability-oh-avrange.md) | OH\_AVRange | 范围包含最小值和最大值。 |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) | OH\_AVCapability | 为OH\_AVCapability接口定义native层对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| const char \*mime | MIME类型描述字符串，请参阅[AVCODEC\_MIME\_TYPE](../native_avcodec_base.h/capi-native-avcodec-base-h.md#变量)。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) \* | 如果现有编解码器匹配，则返回能力实例，如果指定的MIME类型与任何现有编解码器不匹配，则返回NULL。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVCapability \*\*](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) | 如果找到匹配项，则返回指向OH\_AVCapability实例数组的指针。  如果未找到匹配的编解码器或发生错误，则返回NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) \*capability | 编解码能力指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) \*capability | 编码器能力指针。如果给的是解码器能力指针，会导致未定义行为。 |
| [OH\_AVRange](../../结构体/OH_AVRange/capi-avcapability-oh-avrange.md) \*bitrateRange | 输出参数。编码器码率范围。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向编码器码率范围的指针为空指针。 |
...
| --- | --- |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) \*capability | 编码器能力指针。如果给的是解码器能力指针，会导致未定义行为。 |
| [OH\_BitrateMode](../native_avcodec_base.h/capi-native-avcodec-base-h.md#oh_bitratemode) bitrateMode | 比特率模式。 |
...
| --- | --- |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) \*capability | 编码器能力指针。如果给的是解码器能力指针，会导致未定义行为。 |
| [OH\_AVRange](../../结构体/OH_AVRange/capi-avcapability-oh-avrange.md) \*qualityRange | 输出参数。编码器质量范围。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向编码器质量范围的指针为空指针。 |
...
| --- | --- |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) \*capability | 编码器能力指针。如果给的是解码器能力指针，会导致未定义行为。 |
| [OH\_AVRange](../../结构体/OH_AVRange/capi-avcapability-oh-avrange.md) \*complexityRange | 输出参数。编码器复杂度范围。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向编码器复杂度范围的指针为空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) \*capability | 音频编解码能力指针。如果给的是视频编解码器能力指针，会导致未定义行为。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向采样率数组的指针为空指针，或者指向采样率数组的元素数目的指针为空指针。  AV\_ERR\_UNKNOWN：未知错误。  AV\_ERR\_NO\_MEMORY：内部使用内存分配失败。 |
...
| --- | --- |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) \*capability | 音频编解码能力指针。如果给的是视频编解码器能力指针，会导致未定义行为。 |
| [OH\_AVRange](../../结构体/OH_AVRange/capi-avcapability-oh-avrange.md) \*\*sampleRateRanges | 输出参数。指向采样率范围数组的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向采样率范围数组的指针为空指针，或者指向采样率范围数组的元素数目的指针为空指针。  AV\_ERR\_UNKNOWN：未知错误。  AV\_ERR\_NO\_MEMORY：内部使用内存分配失败。 |
...
| --- | --- |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) \*capability | 音频编解码能力指针。如果给的是视频编解码器能力指针，会导致未定义行为。 |
| [OH\_AVRange](../../结构体/OH_AVRange/capi-avcapability-oh-avrange.md) \*channelCountRange | 输出参数。音频通道计数范围。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向音频通道计数范围的指针为空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) \*capability | 视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向视频宽度对齐的指针为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向视频高度对齐的指针为空指针。 |
...
| [OH\_AVRange](../../结构体/OH_AVRange/capi-avcapability-oh-avrange.md) \*widthRange | 输出参数。视频宽度范围。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者高度不在通过[OH\_AVCapability\_GetVideoHeightRange](capi-native-avcapability-h.md#oh_avcapability_getvideoheightrange)获取支持的高度范围中，或者指向宽度范围的指针为空指针。 |
...
| [OH\_AVRange](../../结构体/OH_AVRange/capi-avcapability-oh-avrange.md) \*heightRange | 输出参数。视频高度范围。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者宽度不在通过[OH\_AVCapability\_GetVideoWidthRange](capi-native-avcapability-h.md#oh_avcapability_getvideowidthrange)获取支持的宽度范围中，或者指向高度范围的指针为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向视频宽度范围的指针为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向视频高度范围的指针为空指针。 |
...
| --- | --- |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) \*capability | 视频编解码能力指针。如果给的是音频编解码器能力指针，会导致未定义行为。 |
| [OH\_AVRange](../../结构体/OH_AVRange/capi-avcapability-oh-avrange.md) \*frameRateRange | 输出参数。视频帧率范围。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向视频帧率范围的指针为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者宽度和高度组合不支持，或者指向帧率范围的指针为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向视频像素格式数组的指针为空指针，或者指向像素格式数组的元素数目的指针为空指针。  AV\_ERR\_UNKNOWN：未知错误。  AV\_ERR\_NO\_MEMORY：内部使用内存分配失败。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVCapability](../../结构体/OH_AVCapability/capi-avcapability-oh-avcapability.md) \*capability | 视频编解码能力指针。 |
| const [OH\_NativeBuffer\_Format](<../../../../ArkGraphics 2D（方舟2D图形服务）/C API/头文件/buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_format>) \*\*nativeBufferFormats | 输出参数。指向OH\_NativeBuffer\_Format数组的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效、能力实例是音频编解码器能力、指向NativeBuffer格式数组的指针为空指针、  或指向NativeBuffer格式数组的元素数目的指针为空指针。  AV\_ERR\_UNKNOWN：未知错误。  AV\_ERR\_NO\_MEMORY：内部使用内存分配失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVErrCode](../native_averrors.h/capi-native-averrors-h.md#oh_averrcode) | AV\_ERR\_OK：执行成功。  AV\_ERR\_INVALID\_VAL：能力实例无效，或者指向档次数组的指针为空指针，或者指向档次数组的元素数目的指针为空指针。  AV\_ERR\_UNKNOWN：未知错误。  AV\_ERR\_NO\_MEMORY：内部使用内存分配失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_AVFormat](../../结构体/OH_AVFormat/capi-core-oh-avformat.md) \* | 返回指向OH\_AVFormat实例的指针。 |
