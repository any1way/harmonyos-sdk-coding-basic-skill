...
scraped_at: 2026-06-11T16:50:32+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:ed1ba5a55f8ddb5b3f22b092f5d42ddcf94dfd298c8f05e1321d54ffb9d75e72
---
...
| **名称** | **值** | **说明** |
| --- | --- | --- |
| INTERNAL\_ERROR | [1019000001](<../ArkTS API错误码/screentimeguard-error-code.md#section1019000001-内部错误>) | 内部错误。 |
| USER\_NOT\_AUTHORIZED | [1019000002](<../ArkTS API错误码/screentimeguard-error-code.md#section1019000002-用户未授权>) | 用户未授权。 |
| USER\_CANCELED | [1019000003](<../ArkTS API错误码/screentimeguard-error-code.md#section1019000003-用户取消>) | 用户取消。 |
| STRATEGIES\_EXCEED\_LIMIT | [1019000004](<../ArkTS API错误码/screentimeguard-error-code.md#section1019000004-策略数量超限>) | 策略数量超限。 |
| STRATEGY\_NAME\_ALREADY\_EXIST | [1019000005](<../ArkTS API错误码/screentimeguard-error-code.md#section1019000005-策略名称重复>) | 策略名称重复。 |
| NONEXISTENT\_STRATEGY | [1019000006](<../ArkTS API错误码/screentimeguard-error-code.md#section1019000006-策略不存在>) | 策略不存在。 |
| STRATEGY\_ALREADY\_EXECUTED | [1019000007](<../ArkTS API错误码/screentimeguard-error-code.md#section1019000007-策略重复执行>) | 策略重复执行。 |
| STRATEGY\_NOT\_STARTED | [1019000008](<../ArkTS API错误码/screentimeguard-error-code.md#section1019000008-策略未执行>) | 策略未执行。 |
| INVALID\_PARAM | [1019000009](<../ArkTS API错误码/screentimeguard-error-code.md#section1019000009-参数检查失败>) | 无效参数。  **起始版本：** 6.0.2(22) |
| SYSCAP\_UNSUPPORTED\_DEVICE | [1019000010](<../ArkTS API错误码/screentimeguard-error-code.md#section1019000010-该设备不支持此api>) | 该设备不支持此API。  **起始版本：** 6.1.1(24) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.UIAbilityContext](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md>) | 是 | [UIAbility](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)的上下文环境。 |
...
以下错误码的详细介绍请参见[ArkTS API错误码](<../ArkTS API错误码/screentimeguard-error-code.md>)和[通用错误码](../../../通用错误码/errorcode-universal.md)。
