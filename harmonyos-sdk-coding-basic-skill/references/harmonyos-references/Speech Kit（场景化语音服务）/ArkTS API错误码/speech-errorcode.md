...
content_hash: sha256:0d97500672a31e6d0badc19e8eb700cb5de8ab3df8ad45de25c260395fc66043
---
说明
...
1. PC端场景下，拉起朗读详情页面时，需要在初始化前设置好[setWindowStage](<../ArkTS API/WindowManager（窗口管理）/speech-windowmanager.md#setwindowstage>)。如果是其他设备类型，可以忽略此步骤。
...
需要首先调用[init](<../ArkTS API/TextReader（朗读控件）/speech-textreader-api.md#init>)方法初始化TextReader。
...
[AICaptionOptions](../ArkTS组件/AICaptionComponent（AI字幕组件）/speech-aicaptioncomponent.md#aicaptionoptions)的源语言、目标语言、字体大小等参数不在范围之内，初始化参数错误。
