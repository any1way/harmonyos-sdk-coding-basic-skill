...
content_hash: sha256:6001f1d729b49ac303107bd8a84bd6b1d39a3a0a7992660bca0774239308007d
---
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| readState | [ReadStateCode](<../../ArkTS API/ReadStateCode（播报状态）/speech-readstatecode.md>) | 是 | @Link | 播报状态。  **说明：**  ReadState使用[@Link装饰器：父子双向同步](<../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Link装饰器：父子双向同步/arkts-link.md>)。 |
