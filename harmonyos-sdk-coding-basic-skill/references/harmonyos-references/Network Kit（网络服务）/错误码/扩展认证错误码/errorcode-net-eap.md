...
scraped_at: 2026-06-01T16:07:47+08:00
doc_updated_at: 2026-05-28
content_hash: sha256:9cd20be9520f92898fdeaf7f875b04298fc33be3d03e3be211fc641f548ec332
---
说明
...
5.通信失败，如socket通信异常、连接断开。此原因常见于[startEthEap](<../../ArkTS API/@ohos.net.eap (扩展认证)/js-apis-net-eap.md#eapstartetheap>)和[logOffEthEap](<../../ArkTS API/@ohos.net.eap (扩展认证)/js-apis-net-eap.md#eaplogoffetheap>)接口，通过日志关键词过滤startEap或stopEap检查命令是否正常下发。

**处理步骤**

1.查看系统日志定位具体异常原因，通过日志关键词过滤supplicant定位EAP报文处理异常，通过日志关键词过滤replyCustomEapData定位回调函数异常；对于[startEthEap](<../../ArkTS API/@ohos.net.eap (扩展认证)/js-apis-net-eap.md#eapstartetheap>)和[logOffEthEap](<../../ArkTS API/@ohos.net.eap (扩展认证)/js-apis-net-eap.md#eaplogoffetheap>)接口触发的通信异常，可通过日志关键词过滤startEap或stopEap进行定位。
