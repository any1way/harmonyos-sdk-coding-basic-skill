...
scraped_at: 2026-06-01T16:07:44+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:45629c541bf78e2a8a314e685dee4c2083a1705da231abeedb0a0cefaa62ba45
---
说明

以下仅介绍本模块特有错误码，通用错误码请参考[通用错误码](../../../../通用错误码/errorcode-universal.md)说明文档。

socket错误码映射关系：2301000 + [内核错误码](../内核错误码/errorcode-kernel.md)。

socket server错误码映射关系：2303100 + [内核错误码](../内核错误码/errorcode-kernel.md)。
...
当[Tlssocket.connect](<../../ArkTS API/@ohos.net.socket (Socket连接)/js-apis-socket.md#connect9>)未调用或者[Tlssocket.connect](<../../ArkTS API/@ohos.net.socket (Socket连接)/js-apis-socket.md#connect9>)执行未成功时发生该错误。
