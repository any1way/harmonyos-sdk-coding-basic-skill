...
scraped_at: 2026-06-01T16:06:52+08:00
doc_updated_at: 2026-05-28
content_hash: sha256:9d7f9bf0319ce6e94283ee6286ef173c59f79a76cb78ed9c1493c886150606a1
---
...
以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)和[扩展认证错误码](../../错误码/扩展认证错误码/errorcode-net-eap.md)。
...
9. eap.regCustomEapHandler(netType, eapCode, eapType, eapData);
10. console.info('regCustomEapHandler success');
```
...
9. eap.unregCustomEapHandler(netType, eapCode, eapType, eapData);
10. console.info('unregCustomEapHandler success');
```
