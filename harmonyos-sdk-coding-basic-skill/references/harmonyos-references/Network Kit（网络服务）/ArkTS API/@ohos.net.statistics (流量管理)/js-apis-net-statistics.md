...
content_hash: sha256:b6c0034c6b1fd5b030e593af2402a0550fde544312224dbfe9657d9da10f8982
---
...
以下错误码的详细介绍参见[流量管理错误码](../../错误码/流量管理错误码/errorcode-net-statistics.md)和[通用错误码](../../../../通用错误码/errorcode-universal.md)。
...
以下错误码的详细介绍参见[流量管理错误码](../../错误码/流量管理错误码/errorcode-net-statistics.md)。
...
| 类型 | 说明 |
| --- | --- |
| [connection.NetBearType](<../@ohos.net.connection (网络连接管理)/js-apis-net-connection.md#netbeartype>) | 枚举网络类型。 |
