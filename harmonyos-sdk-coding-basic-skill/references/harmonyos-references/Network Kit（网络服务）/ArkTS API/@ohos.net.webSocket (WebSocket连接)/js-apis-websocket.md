...
scraped_at: 2026-06-01T16:06:50+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:f6e01700f5fc9570383f035d2c2d429603c83c200a931b0c697187d4445c9ee4
---
...
以下错误码的详细介绍参见[webSocket错误码](../../错误码/webSocket错误码/errorcode-net-websocket.md)和[通用错误码](../../../../通用错误码/errorcode-universal.md)。
...
以下错误码的详细介绍参见[通用错误码](../../../../通用错误码/errorcode-universal.md)。
...
以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)和[webSocket错误码](../../错误码/webSocket错误码/errorcode-net-websocket.md)。
...
| callback | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 是 | 回调函数。 |
...
| callback | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 否 | 回调函数。默认值：200。 |
...
| pingInterval21+ | number | 否 | 是 | 自定义[心跳检测](<../../../../../harmonyos-guides/系统/网络/Network Kit（网络服务）/访问网络/使用WebSocket访问网络/websocket-connection.md#场景介绍>)时间，默认为30s。每pingInterval周期会发起心跳检测，设置为0则表示关闭心跳检测。最大值：30000s，最小值：0s。 |
...
| 'system' | 使用系统默认网络代理。 |
| 'no-proxy' | 不使用网络代理。 |
| [HttpProxy](<../@ohos.net.connection (网络连接管理)/js-apis-net-connection.md#httpproxy10>) | 使用指定的网络代理。 |
