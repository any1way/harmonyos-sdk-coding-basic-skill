...
scraped_at: 2026-06-01T16:06:46+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:53dce0e56b5522d8c3a8caa0872c018077359d75f1d1099230c1fe3424afa34a
---
...
* [@ohos.geolocation](<../../../../Location Kit（位置服务）/ArkTS API/已停止维护的接口/@ohos.geolocation (位置服务)/js-apis-geolocation.md>)、[@ohos.geoLocationManager (位置服务)](<../../../../Location Kit（位置服务）/ArkTS API/@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md>)
* [@ohos.multimedia.audio(音频管理)](<../../../../Audio Kit（音频服务）/ArkTS API/@ohos.multimedia.audio (音频管理)/模块描述/arkts-apis-audio.md>)
* [@ohos.multimedia.camera(相机管理)](<../../../../Camera Kit（相机服务）/ArkTS API/@ohos.multimedia.camera (相机管理)/模块描述/arkts-apis-camera.md>)
...
| 类型 | 说明 |
| --- | --- |
| [\_VpnExtensionContext](../VpnExtensionContext/js-apis-inner-application-vpnextensioncontext.md) | VPN扩展的上下文。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 指示要启动的信息。  **说明：** 从API version 22开始，支持在VPN首次启动时传递want中的parameters字段。 |
...
以下错误码的详细介绍请参见[元能力子系统错误码](<../../../../Ability Kit（程序框架服务）/错误码/元能力子系统错误码/errorcode-ability.md>)和[通用错误码](../../../../通用错误码/errorcode-universal.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [VpnExtensionContext](../VpnExtensionContext/js-apis-inner-application-vpnextensioncontext.md) | 是 | 指定 context。 |
...
以下错误码的详细介绍请参见[VPN错误码](../../错误码/VPN错误码/errorcode-net-vpn.md)和[通用错误码](../../../../通用错误码/errorcode-universal.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| socketFd | number | 是 | 指定保护的 socketfd，该文件描述符通过[getSocketFd](<../@ohos.net.socket (Socket连接)/js-apis-socket.md#getsocketfd10-1>)获取。 |
...
以下错误码的详细介绍请参见[VPN错误码](../../错误码/VPN错误码/errorcode-net-vpn.md)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| addresses | Array<[LinkAddress](<../@ohos.net.connection (网络连接管理)/js-apis-net-connection.md#linkaddress>)> | 否 | 否 | VPN虚拟网卡的IP地址。API version 23之前，最多支持64个IP地址；从API version 23开始，最多支持2000个IP地址。 |
| vpnId20+ | string | 否 | 是 | VPN唯一标识。 |
| routes | Array<[RouteInfo](<../@ohos.net.connection (网络连接管理)/js-apis-net-connection.md#routeinfo>)> | 否 | 是 | VPN虚拟网卡的路由信息（API version 23前最多可配置1024条路由；从API version 23开始最多可配置10000条路由）。 |
