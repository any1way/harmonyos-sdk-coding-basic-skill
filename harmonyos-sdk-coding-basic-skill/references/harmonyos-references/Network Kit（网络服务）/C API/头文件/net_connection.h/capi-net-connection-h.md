...
scraped_at: 2026-06-01T16:06:57+08:00
doc_updated_at: 2026-03-12
content_hash: sha256:83ca4eaf41e047006b220785063ce955c9a56a230b88881628a2474d930da547
---
## 概述
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn\_NetHandle](../../结构体/NetConn_NetHandle/capi-netconnection-netconn-nethandle.md) \*netHandle | 存放网络ID。 |
...
| --- | --- |
| [NetConn\_NetHandle](../../结构体/NetConn_NetHandle/capi-netconnection-netconn-nethandle.md) \*netHandle | 存放网络ID。 |
| [NetConn\_ConnectionProperties](../../结构体/NetConn_ConnectionProperties/capi-netconnection-netconn-connectionproperties.md) \*prop | 存放链路信息。 |
...
| --- | --- |
| [NetConn\_NetHandle](../../结构体/NetConn_NetHandle/capi-netconnection-netconn-nethandle.md) \*netHandle | 存放网络ID。 |
| [NetConn\_NetCapabilities](../../结构体/NetConn_NetCapabilities/capi-netconnection-netconn-netcapabilities.md) \*netCapabilities | 存放能力集。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn\_HttpProxy](../../结构体/NetConn_HttpProxy/capi-netconnection-netconn-httpproxy.md) \*httpProxy | 存放代理配置信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn\_NetHandleList](../../结构体/NetConn_NetHandleList/capi-netconnection-netconn-nethandlelist.md) \*netHandleList | 网络信息列表。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_NetConn\_CustomDnsResolver](../net_connection_type.h/capi-net-connection-type-h.md#oh_netconn_customdnsresolver) resolver | 指向自定义DNS解析器的指针。 |
...
| [NetConn\_NetHandle](../../结构体/NetConn_NetHandle/capi-netconnection-netconn-nethandle.md) \*netHandle | 指针类型，指向包含网络ID的网络句柄。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn\_HttpProxy](../../结构体/NetConn_HttpProxy/capi-netconnection-netconn-httpproxy.md) \*httpProxy | 需要设置的http代理配置信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_NetConn\_AppHttpProxyChange](../net_connection_type.h/capi-net-connection-type-h.md#oh_netconn_apphttpproxychange) appHttpProxyChange | 需要注册的监听回调。 |
...
| 类型 | 说明 |
| --- | --- |
| [NetConn\_ErrorCode](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode) | 结果定义在 [NetConn\_ErrorCode](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode)。  [NETCONN\_SUCCESS](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode) 成功。  [NETCONN\_PERMISSION\_DENIED](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode) 缺少权限。  [NETCONN\_PARAMETER\_ERROR](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode) 参数错误。  [NETCONN\_OPERATION\_FAILED](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode) 无法连接到服务。  [NETCONN\_INTERNAL\_ERROR](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode) 内部错误。 |
...
| 类型 | 说明 |
| --- | --- |
| [NetConn\_ErrorCode](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode) | 结果定义在 [NetConn\_ErrorCode](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode)。  [NETCONN\_SUCCESS](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode) 成功。  [NETCONN\_PARAMETER\_ERROR](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode) 参数错误。  [NETCONN\_OPERATION\_FAILED](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode) 无法连接到服务。  [NETCONN\_INTERNAL\_ERROR](../net_connection_type.h/capi-net-connection-type-h.md#netconn_errorcode) 内部错误。 |
...
| [NetConn\_ProbeResultInfo](../../结构体/NetConn_ProbeResultInfo/capi-netconnection-netconn-proberesultinfo.md) \*probeResultInfo | 丢包率和往返时间（RTT）。 |
...
应用调用该接口需申请精确位置权限。根据[申请位置权限开发指导](<../../../../../../harmonyos-guides/应用服务/Location Kit（位置服务）/开发准备/申请位置权限开发指导/location-permission-guidelines.md>)，调用方需同时申请ohos.permission.APPROXIMATELY\_LOCATION和ohos.permission.LOCATION。
...
| [NetConn\_TraceRouteOption](../../结构体/NetConn_TraceRouteOption/capi-netconnection-netconn-tracerouteoption.md) \*option | 路由参数选项。 |
| [NetConn\_TraceRouteInfo](../../结构体/NetConn_TraceRouteInfo/capi-netconnection-netconn-tracerouteinfo.md) \*traceRouteInfo | 路由结果。需传入数组指针，数组大小代表路由跳数，默认30跳。若自定义跳数，则需保证数组大小与option字段中的maxJumpNumber数值保持一致。 |
