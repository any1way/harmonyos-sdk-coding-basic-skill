...
content_hash: sha256:efbcdc61f9acecfb585b1ab149f8e3ba043978850da39bc3fd84f7ec08a8adb7
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [Http\_Buffer](../../结构体/Http_Buffer/capi-netstack-http-buffer.md) | Http\_Buffer | HTTP缓存结构体。 |
| [Http\_HeaderValue](../../结构体/Http_HeaderValue/capi-netstack-http-headervalue.md) | Http\_HeaderValue | 请求或者响应的标头映射的值类型。 |
| [Http\_HeaderEntry](../../结构体/Http_HeaderEntry/capi-netstack-http-headerentry.md) | Http\_HeaderEntry | 请求或者响应的标头的所有键值对。 |
| [Http\_ClientCert](../../结构体/Http_ClientCert/capi-netstack-http-clientcert.md) | Http\_ClientCert | 发送到服务端的客户端证书配置，服务端将通过客户端证书校验客户端身份。 |
| [Http\_CustomProxy](../../结构体/Http_CustomProxy/capi-netstack-http-customproxy.md) | Http\_CustomProxy | 用户自定义代理配置。 |
| [Http\_Proxy](../../结构体/Http_Proxy/capi-netstack-http-proxy.md) | Http\_Proxy | 代理配置结构体。 |
| [Http\_PerformanceTiming](../../结构体/Http_PerformanceTiming/capi-netstack-http-performancetiming.md) | Http\_PerformanceTiming | HTTP响应时间信息，会在[Http\_Response.performanceTiming](../../结构体/Http_Response/capi-netstack-http-response.md#成员变量)中收集。 |
| [Http\_RequestOptions](../../结构体/Http_RequestOptions/capi-netstack-http-requestoptions.md) | Http\_RequestOptions | 定义HTTP请求配置的结构体。 |
| [Http\_Response](../../结构体/Http_Response/capi-netstack-http-response.md) | Http\_Response | 定义HTTP响应的结构体。 |
| [Http\_Request](../../结构体/Http_Request/capi-netstack-http-request.md) | Http\_Request | HTTP请求结构体。 |
| [Http\_EventsHandler](../../结构体/Http_EventsHandler/capi-netstack-http-eventshandler.md) | Http\_EventsHandler | 监听不同HTTP事件的回调函数。 |
| [Http\_Headers](../../结构体/Http_Headers/capi-netstack-http-headers.md) | Http\_Headers | HTTP请求或者是响应中的标头。 |
...
| 参数项 | 描述 |
| --- | --- |
| [struct Http\_Response](../../结构体/Http_Response/capi-netstack-http-response.md) \*response | HTTP响应结构体，指向Http\_Response的指针，参考[Http\_Response](../../结构体/Http_Response/capi-netstack-http-response.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Http\_Headers](../../结构体/Http_Headers/capi-netstack-http-headers.md) \*headers | 接收到的请求头，指向Http\_Headers的指针，参考[Http\_Headers](../../结构体/Http_Headers/capi-netstack-http-headers.md)。 |
