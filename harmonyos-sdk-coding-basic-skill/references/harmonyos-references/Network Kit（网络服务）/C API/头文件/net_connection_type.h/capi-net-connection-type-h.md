...
scraped_at: 2026-06-01T16:06:58+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:003d4a9fe0bab023a060931fe899992b33d770792532cf386916660df1b2f2b1
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [NetConn\_NetHandle](../../结构体/NetConn_NetHandle/capi-netconnection-netconn-nethandle.md) | NetConn\_NetHandle | 存放网络ID。 |
| [NetConn\_NetCapabilities](../../结构体/NetConn_NetCapabilities/capi-netconnection-netconn-netcapabilities.md) | NetConn\_NetCapabilities | 网络能力集。 |
| [NetConn\_NetAddr](../../结构体/NetConn_NetAddr/capi-netconnection-netconn-netaddr.md) | NetConn\_NetAddr | 网络地址。 |
| [NetConn\_Route](../../结构体/NetConn_Route/capi-netconnection-netconn-route.md) | NetConn\_Route | 路由配置信息。 |
| [NetConn\_HttpProxy](../../结构体/NetConn_HttpProxy/capi-netconnection-netconn-httpproxy.md) | NetConn\_HttpProxy | 代理配置信息。 |
| [NetConn\_ConnectionProperties](../../结构体/NetConn_ConnectionProperties/capi-netconnection-netconn-connectionproperties.md) | NetConn\_ConnectionProperties | 网络连接信息。 |
| [NetConn\_NetHandleList](../../结构体/NetConn_NetHandleList/capi-netconnection-netconn-nethandlelist.md) | NetConn\_NetHandleList | 网络列表。 |
| [NetConn\_NetSpecifier](../../结构体/NetConn_NetSpecifier/capi-netconnection-netconn-netspecifier.md) | NetConn\_NetSpecifier | 网络的特征集。 |
| [NetConn\_NetConnCallback](../../结构体/NetConn_NetConnCallback/capi-netconnection-netconn-netconncallback.md) | NetConn\_NetConnCallback | 网络状态监听回调集合。 |
| [NetConn\_ProbeResultInfo](../../结构体/NetConn_ProbeResultInfo/capi-netconnection-netconn-proberesultinfo.md) | NetConn\_ProbeResultInfo | 定义探测结果信息。 |
| [NetConn\_TraceRouteOption](../../结构体/NetConn_TraceRouteOption/capi-netconnection-netconn-tracerouteoption.md) | NetConn\_TraceRouteOption | 定义网络跟踪路由选项。 |
| [NetConn\_TraceRouteInfo](../../结构体/NetConn_TraceRouteInfo/capi-netconnection-netconn-tracerouteinfo.md) | NetConn\_TraceRouteInfo | 定义跟踪路由信息。 |
...
| 名称 | 描述 |
| --- | --- |
| NETCONN\_MAX\_NET\_SIZE 32 | [NetConn\_NetHandleList](../../结构体/NetConn_NetHandleList/capi-netconnection-netconn-nethandlelist.md)的成员变量netHandles数组的长度。  **起始版本：** 11 |
| NETCONN\_MAX\_BEARER\_TYPE\_SIZE 32 | [NetConn\_NetCapabilities](../../结构体/NetConn_NetCapabilities/capi-netconnection-netconn-netcapabilities.md)的成员变量bearerTypes数组的长度。  **起始版本：** 11 |
| NETCONN\_MAX\_CAP\_SIZE 32 | [NetConn\_NetCapabilities](../../结构体/NetConn_NetCapabilities/capi-netconnection-netconn-netcapabilities.md)的成员变量netCaps数组的长度。  **起始版本：** 11 |
| NETCONN\_MAX\_ADDR\_SIZE 32 | [NetConn\_ConnectionProperties](../../结构体/NetConn_ConnectionProperties/capi-netconnection-netconn-connectionproperties.md)的成员变量netAddrList、dnsList数组的长度。  **起始版本：** 11 |
| NETCONN\_MAX\_ROUTE\_SIZE 64 | [NetConn\_ConnectionProperties](../../结构体/NetConn_ConnectionProperties/capi-netconnection-netconn-connectionproperties.md)的成员变量routeList数组的长度。  **起始版本：** 11 |
| NETCONN\_MAX\_EXCLUSION\_SIZE 256 | [NetConn\_HttpProxy](../../结构体/NetConn_HttpProxy/capi-netconnection-netconn-httpproxy.md)的成员变量exclusionList数组的长度。  **起始版本：** 11 |
| NETCONN\_MAX\_STR\_LEN 256 | [NetConn\_HttpProxy](../../结构体/NetConn_HttpProxy/capi-netconnection-netconn-httpproxy.md)的成员变量host数组的长度。  **起始版本：** 11 |
| NETCONN\_MAX\_RTT\_NUM 4 | [NetConn\_ProbeResultInfo](../../结构体/NetConn_ProbeResultInfo/capi-netconnection-netconn-proberesultinfo.md)的成员变量rtt数组的长度。  **起始版本：** 20 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn\_HttpProxy](../../结构体/NetConn_HttpProxy/capi-netconnection-netconn-httpproxy.md) \*proxy | 变化的代理配置信息,可能是空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn\_NetHandle](../../结构体/NetConn_NetHandle/capi-netconnection-netconn-nethandle.md) \*netHandle | 网络句柄。 |
...
| --- | --- |
| [NetConn\_NetHandle](../../结构体/NetConn_NetHandle/capi-netconnection-netconn-nethandle.md) \*netHandle | 网络句柄。 |
| [NetConn\_NetCapabilities](../../结构体/NetConn_NetCapabilities/capi-netconnection-netconn-netcapabilities.md) \*netCapabilities | 网络能力集。 |
...
| --- | --- |
| [NetConn\_NetHandle](../../结构体/NetConn_NetHandle/capi-netconnection-netconn-nethandle.md) \*netHandle | 网络句柄。 |
| [NetConn\_ConnectionProperties](../../结构体/NetConn_ConnectionProperties/capi-netconnection-netconn-connectionproperties.md) \*connConnetionProperties | 网络连接属性。 |
