...
scraped_at: 2026-06-01T16:35:29+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:ff24abb481830befc8771cba48bd9404043e58a2b25b704a14d0612b15e3f87b
---
说明
...
定位请求参数[LocationRequest](<../../ArkTS API/@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#locationrequest>)、[CurrentLocationRequest](<../../ArkTS API/@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#currentlocationrequest>)中的精度要求(maxAccuracy)值设定过小。

**处理步骤**

请将定位请求参数[LocationRequest](<../../ArkTS API/@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#locationrequest>)、[CurrentLocationRequest](<../../ArkTS API/@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#currentlocationrequest>)中的精度要求(maxAccuracy)适当放宽，可参考如下场景建议：

* 当[scenario](<../../ArkTS API/@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#locationrequestscenario>)为NAVIGATION/TRAJECTORY\_TRACKING/CAR\_HAILING，或者[priority](<../../ArkTS API/@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#locationrequestpriority>)为ACCURACY时，建议设置maxAccuracy为大于10的值。
* 当[scenario](<../../ArkTS API/@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#locationrequestscenario>)为DAILY\_LIFE\_SERVICE/NO\_POWER，或者[priority](<../../ArkTS API/@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#locationrequestpriority>)为LOW\_POWER/FIRST\_FIX时，建议设置maxAccuracy为大于100的值。
...
系统未提前将位置信息进行缓存的情况下，需使用[getCurrentLocation](<../../ArkTS API/@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagergetcurrentlocation>)接口获取实时位置信息。
