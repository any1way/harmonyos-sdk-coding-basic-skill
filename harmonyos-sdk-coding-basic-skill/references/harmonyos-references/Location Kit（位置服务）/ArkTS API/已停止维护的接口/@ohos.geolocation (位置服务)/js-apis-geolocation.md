...
scraped_at: 2026-06-01T16:35:21+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:e44a3195b8552654ae7b3602b18cbf4439156d0d0e13d6920da6b53b1542f459
---
...
从API Version 9开始，该接口不再维护，推荐使用新接口[geoLocationManager](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md>)。
...
如果应用在后台运行时也需要访问设备位置，需要申请LOCATION类型的长时任务，这样应用在切入后台之后，系统可以继续上报位置信息。长时任务申请可参考[长时任务](<../../../../../harmonyos-guides/应用框架/Background Tasks Kit（后台任务开发服务）/长时任务(ArkTS)/continuous-task.md>)。

应用如需使用ohos.permission.LOCATION\_IN\_BACKGROUND权限，需要在设置界面由用户手动授予，具体授权方式可参考[ohos.permission.LOCATION\_IN\_BACKGROUND权限说明](../../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/应用权限列表/开放权限（用户授权）/permissions-for-all-user.md#ohospermissionlocation_in_background)。

开发者可以在应用配置文件中声明所需要的权限，具体可参考[向用户申请授权](../../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/向用户申请授权/request-user-authorization.md)。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.on('locationChange')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanageronlocationchange>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.off('locationChange')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagerofflocationchange>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.on('locationEnabledChange')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanageronlocationenabledchange>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.off('locationEnabledChange')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagerofflocationenabledchange>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.on('cachedGnssLocationsChange')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanageroncachedgnsslocationschange>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.off('cachedGnssLocationsChange')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanageroffcachedgnsslocationschange>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.on('satelliteStatusChange')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanageronsatellitestatuschange>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.off('satelliteStatusChange')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanageroffsatellitestatuschange>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.on('nmeaMessage')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanageronnmeamessage>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.off('nmeaMessage')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanageroffnmeamessage>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.on('gnssFenceStatusChange')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagerongnssfencestatuschange>)替代。
...
| want | [WantAgent](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantAgent (WantAgent模块)/js-apis-app-ability-wantagent.md>) | 是 | 用于接收地理围栏事件上报（进出围栏）。 |
...
从API version 9开始废弃，建议使用[geoLocationManager.off('gnssFenceStatusChange')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanageroffgnssfencestatuschange>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getCurrentLocation](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagergetcurrentlocation>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getCurrentLocation](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagergetcurrentlocation-2>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getLastLocation](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagergetlastlocation>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.isLocationEnabled](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagerislocationenabled>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.isGeocoderAvailable](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagerisgeocoderavailable>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getAddressesFromLocation](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagergetaddressesfromlocation>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getAddressesFromLocation](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagergetaddressesfromlocation-1>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getAddressesFromLocationName](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagergetaddressesfromlocationname>)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[geoLocationManager.getAddressesFromLocationName](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagergetaddressesfromlocationname-1>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.getCachedGnssLocationsSize](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagergetcachedgnsslocationssize>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.getCachedGnssLocationsSize](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagergetcachedgnsslocationssize-1>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.flushCachedGnssLocations](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagerflushcachedgnsslocations>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.flushCachedGnssLocations](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagerflushcachedgnsslocations-1>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.sendCommand](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagersendcommand>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.ReverseGeoCodeRequest](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#reversegeocoderequest>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.GeoCodeRequest](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geocoderequest>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.GeoAddress](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geoaddress>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.LocationRequest](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#locationrequest>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.CurrentLocationRequest](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#currentlocationrequest>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.SatelliteStatusInfo](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#satellitestatusinfo>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.CachedGnssLocationsRequest](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#cachedgnsslocationsrequest>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.Geofence](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geofence>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.GeofenceRequest](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geofencerequest>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.LocationCommand](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#locationcommand>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.Location](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#location>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.LocationRequestPriority](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#locationrequestpriority>)替代。
...
从API version 9开始废弃，建议使用[geoLocationManager.LocationRequestScenario](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#locationrequestscenario>)替代。
...
从API version 9开始废弃，建议使用[位置服务错误码](../../../错误码/位置服务错误码/errorcode-geolocationmanager.md)替代。
