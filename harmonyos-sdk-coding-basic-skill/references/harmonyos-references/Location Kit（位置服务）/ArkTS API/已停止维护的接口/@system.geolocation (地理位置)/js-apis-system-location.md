...
content_hash: sha256:722a9662831ad026c145798d9ece45cc5e8c9cdf4a8e3d05937eac2cb67ddac5
---
...
* 对于支持该模块的其他设备类型，该模块从API Version 9开始，该接口不再维护，推荐使用新接口[geoLocationManager](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md>)。
...
除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.getCurrentLocation](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagergetcurrentlocation>)替代。
...
除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.on('locationChange')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanageronlocationchange>)替代。
...
除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.off('locationChange')](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#geolocationmanagerofflocationchange>)替代。
...
除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.CurrentLocationRequest](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#currentlocationrequest>)替代。
...
除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.Location](<../../@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#location>)替代。
