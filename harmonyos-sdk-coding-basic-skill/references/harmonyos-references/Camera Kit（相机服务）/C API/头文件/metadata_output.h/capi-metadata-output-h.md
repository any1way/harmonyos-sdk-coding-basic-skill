...
scraped_at: 2026-06-01T16:20:46+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:2972d415eaca3a0275e6339c23c653d7d602a8ad9b9175347ad6d618cde4ffac
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [MetadataOutput\_Callbacks](../../结构体/MetadataOutput_Callbacks/capi-oh-camera-metadataoutput-callbacks.md) | MetadataOutput\_Callbacks | 元数据输出的回调。 |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md) | Camera\_MetadataOutput | 元数据输出对象。  可以使用[OH\_CameraManager\_CreateMetadataOutput](../camera_manager.h/capi-camera-manager-h.md#oh_cameramanager_createmetadataoutput)方法创建指针。 |
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void (\*OH\_MetadataOutput\_OnMetadataObjectAvailable)(Camera\_MetadataOutput\* metadataOutput, Camera\_MetadataObject\* metadataObject, uint32\_t size)](capi-metadata-output-h.md#oh_metadataoutput_onmetadataobjectavailable) | OH\_MetadataOutput\_OnMetadataObjectAvailable | 在[MetadataOutput\_Callbacks](../../结构体/MetadataOutput_Callbacks/capi-oh-camera-metadataoutput-callbacks.md)中被调用的元数据输出元数据对象可用回调。 |
| [typedef void (\*OH\_MetadataOutput\_OnError)(Camera\_MetadataOutput\* metadataOutput, Camera\_ErrorCode errorCode)](capi-metadata-output-h.md#oh_metadataoutput_onerror) | OH\_MetadataOutput\_OnError | 在[MetadataOutput\_Callbacks](../../结构体/MetadataOutput_Callbacks/capi-oh-camera-metadataoutput-callbacks.md)中被调用的元数据输出错误回调。 |
...
在[MetadataOutput\_Callbacks](../../结构体/MetadataOutput_Callbacks/capi-oh-camera-metadataoutput-callbacks.md)中被调用的元数据输出元数据对象可用回调。
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md)\* metadataOutput | 传递回调的元数据输出实例。 |
| [Camera\_MetadataObject](../../结构体/Camera_MetadataObject/capi-oh-camera-camera-metadataobject.md)\* metadataObject | 回调传递的元数据实例信息。 |
...
在[MetadataOutput\_Callbacks](../../结构体/MetadataOutput_Callbacks/capi-oh-camera-metadataoutput-callbacks.md)中被调用的元数据输出错误回调。
...
| --- | --- |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md)\* metadataOutput | 传递回调的元数据输出实例。 |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) errorCode | 元数据输出的错误码。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md)\* metadataOutput | 元数据输出实例。 |
| [MetadataOutput\_Callbacks](../../结构体/MetadataOutput_Callbacks/capi-oh-camera-metadataoutput-callbacks.md)\* callback | 要注册的元数据输出回调。 |
...
| --- | --- |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md)\* metadataOutput | 元数据输出实例。 |
| [MetadataOutput\_Callbacks](../../结构体/MetadataOutput_Callbacks/capi-oh-camera-metadataoutput-callbacks.md)\* callback | 要注销的元数据输出回调。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md)\* metadataOutput | 要启动的元数据输出实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md)\* metadataOutput | 要停止的元数据输出实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md)\* metadataOutput | 要释放的元数据输出实例。 |
...
| --- | --- |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md)\* metadataOutput | 元数据输出实例。 |
| [Camera\_MetadataObjectType](../camera.h/capi-camera-h.md#camera_metadataobjecttype)\* types | 用于添加到Camera\_MetadataOutput实例的元数据对象类型数组。 |
...
| --- | --- |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md)\* metadataOutput | 元数据输出实例。 |
| [Camera\_MetadataObjectType](../camera.h/capi-camera-h.md#camera_metadataobjecttype)\* types | 从Camera\_MetadataOutput实例移除的元数据对象类型数组。 |
| uint32\_t size | 元数据对象类型数组长度。 |
