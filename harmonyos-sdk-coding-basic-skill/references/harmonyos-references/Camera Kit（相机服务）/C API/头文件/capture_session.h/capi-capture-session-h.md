...
scraped_at: 2026-06-01T16:20:49+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:e9a2011910e4444d0665254a7aa959d8c210068674f2692cfcea09ca84934933
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [CaptureSession\_Callbacks](../../结构体/CaptureSession_Callbacks/capi-oh-camera-capturesession-callbacks.md) | CaptureSession\_Callbacks | 捕获会话的回调。 |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md) | Camera\_CaptureSession | 捕获会话对象。  可以使用[OH\_CameraManager\_CreateCaptureSession](../camera_manager.h/capi-camera-manager-h.md#oh_cameramanager_createcapturesession)方法创建指针。 |
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void (\*OH\_CaptureSession\_OnFocusStateChange)(Camera\_CaptureSession\* session, Camera\_FocusState focusState)](capi-capture-session-h.md#oh_capturesession_onfocusstatechange) | OH\_CaptureSession\_OnFocusStateChange | 在[CaptureSession\_Callbacks](../../结构体/CaptureSession_Callbacks/capi-oh-camera-capturesession-callbacks.md)中被调用的捕获会话焦点状态回调。 |
| [typedef void (\*OH\_CaptureSession\_OnError)(Camera\_CaptureSession\* session, Camera\_ErrorCode errorCode)](capi-capture-session-h.md#oh_capturesession_onerror) | OH\_CaptureSession\_OnError | 在[CaptureSession\_Callbacks](../../结构体/CaptureSession_Callbacks/capi-oh-camera-capturesession-callbacks.md)中被调用的捕获会话错误回调。 |
...
| [Camera\_ErrorCode OH\_CaptureSession\_SetIso(const Camera\_CaptureSession\* session, int32\_t isoValue)](capi-capture-session-h.md#oh_capturesession_setiso) | - | 设置ISO感光度值。需在[OH\_CaptureSession\_GetSupportedISORange](capi-capture-session-h.md#oh_capturesession_getsupportedisorange)获取到的范围内进行设置，且仅曝光模式为EXPOSURE\_MODE\_LOCKED时生效。 |
...
| [Camera\_ErrorCode OH\_CaptureSession\_SetPhysicalAperture(const Camera\_CaptureSession\* session, double aperture)](capi-capture-session-h.md#oh_capturesession_setphysicalaperture) | - | 设置物理光圈值。 |
...
| [Camera\_ErrorCode OH\_CaptureSession\_SetOISModeCustom(const Camera\_CaptureSession\* session, float pitchBias, float yawBias)](capi-capture-session-h.md#oh_capturesession_setoismodecustom) | - | 为对应轴设置自定义光学防抖偏移值。 |
...
在[CaptureSession\_Callbacks](../../结构体/CaptureSession_Callbacks/capi-oh-camera-capturesession-callbacks.md)中被调用的捕获会话焦点状态回调。
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 传递回调的Camera\_CaptureSession实例。 |
| [Camera\_FocusState](../camera.h/capi-camera-h.md#camera_focusstate) focusState | 回调传递的会话焦点状态。 |
...
在[CaptureSession\_Callbacks](../../结构体/CaptureSession_Callbacks/capi-oh-camera-capturesession-callbacks.md)中被调用的捕获会话错误回调。
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 传递回调的Camera\_CaptureSession实例。 |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) errorCode | 捕获会话的错误码。 |

**参考：**

[CAMERA\_SERVICE\_FATAL\_ERROR](../camera.h/capi-camera-h.md#camera_errorcode)
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 传递回调的Camera\_CaptureSession实例。 |
| [Camera\_SmoothZoomInfo](../../结构体/Camera_SmoothZoomInfo/capi-oh-camera-camera-smoothzoominfo.md)\* smoothZoomInfo | 回调传递的平滑变焦参数信息。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 传递回调的Camera\_CaptureSession实例。 |
| [Camera\_AutoDeviceSwitchStatusInfo](../../结构体/Camera_AutoDeviceSwitchStatusInfo/capi-oh-camera-camera-autodeviceswitchstatusinfo.md)\* autoDeviceSwitchStatusInfo | 回调传递的设备切换状态信息。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 传递回调的Camera\_CaptureSession实例。 |
| [Camera\_SystemPressureLevel](../camera.h/capi-camera-h.md#camera_systempressurelevel) systemPressureLevel | 回调传递的系统压力等级。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 传递回调的Camera\_CaptureSession实例。 |
| [Camera\_ControlCenterStatusInfo](../../结构体/Camera_ControlCenterStatusInfo/capi-oh-camera-camera-controlcenterstatusinfo.md)\* controlCenterStatusInfo | 回调传递的相机控制器效果激活状态。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 传递回调的Camera\_CaptureSession实例。 |
| [CaptureSession\_Callbacks](../../结构体/CaptureSession_Callbacks/capi-oh-camera-capturesession-callbacks.md)\* callback | 要注册的捕获会话事件回调。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 传递回调的Camera\_CaptureSession实例。 |
| [CaptureSession\_Callbacks](../../结构体/CaptureSession_Callbacks/capi-oh-camera-capturesession-callbacks.md)\* callback | 要注销的捕获会话事件回调。 |
...
建议在使用[OH\_CameraManager\_CreateCaptureSession](../camera_manager.h/capi-camera-manager-h.md#oh_cameramanager_createcapturesession)后立即使用此接口。
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_SceneMode](../camera.h/capi-camera-h.md#camera_scenemode) sceneMode | 相机模式。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_OPERATION\_NOT\_ALLOWED：操作不允许。  CAMERA\_SESSION\_CONFIG\_LOCKED：会话配置已锁定。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_PreviewOutput](../../结构体/Camera_PreviewOutput/capi-oh-camera-camera-previewoutput.md)\* previewOutput | 要标记为安全输出的Camera\_PreviewOutput。 |
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_SESSION\_CONFIG\_LOCKED：会话配置已锁定。 |
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_OPERATION\_NOT\_ALLOWED：操作不允许。  CAMERA\_SERVICE\_FATAL\_ERROR：相机服务异常。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md)\* cameraInput | 要添加的相机输入实例。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_OPERATION\_NOT\_ALLOWED：操作不允许。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md)\* cameraInput | 要删除的相机输入实例。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_PreviewOutput](../../结构体/Camera_PreviewOutput/capi-oh-camera-camera-previewoutput.md)\* previewOutput | 要添加的预览输出实例。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_PreviewOutput](../../结构体/Camera_PreviewOutput/capi-oh-camera-camera-previewoutput.md)\* previewOutput | 要删除的预览输出实例。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 要添加的拍照输出实例。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 要删除的拍照输出实例。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_VideoOutput](../../结构体/Camera_VideoOutput/capi-oh-camera-camera-videooutput.md)\* videoOutput | 要添加的录像输出实例。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_VideoOutput](../../结构体/Camera_VideoOutput/capi-oh-camera-camera-videooutput.md)\* videoOutput | 要删除的录像输出实例。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md)\* metadataOutput | 要添加的元数据输出实例。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md)\* metadataOutput | 要删除的元数据输出实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 要启动的Camera\_CaptureSession实例。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_SESSION\_NOT\_CONFIG：捕获会话未配置。  CAMERA\_SERVICE\_FATAL\_ERROR：相机服务异常。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 要停止的Camera\_CaptureSession实例。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_SERVICE\_FATAL\_ERROR：相机服务异常。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 要释放的Camera\_CaptureSession实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_SESSION\_NOT\_CONFIG：捕获会话未配置。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_FlashMode](../camera.h/capi-camera-h.md#camera_flashmode) flashMode | 要检查的闪光灯模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_FlashMode](../camera.h/capi-camera-h.md#camera_flashmode)\* flashMode | 当前闪光灯模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_FlashMode](../camera.h/capi-camera-h.md#camera_flashmode) flashMode | 要设置的闪光灯模式。 |
...
```
1. typedef void (*OH_CaptureSession_OnFlashStateChange)(const Camera_CaptureSession* session, OH_Camera_FlashState flashState)
```
...
| 参数项 | 描述 |
| --- | --- |
| const [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 传递回调的Camera\_CaptureSession指针。 |
| [OH\_Camera\_FlashState](../camera.h/capi-camera-h.md#oh_camera_flashstate) flashState | 回调传递的闪光灯状态。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_RegisterFlashStateChangeCallback(const Camera_CaptureSession* session, OH_CaptureSession_OnFlashStateChange flashStateChange)
```
...
| 参数项 | 描述 |
| --- | --- |
| const [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例指针。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_UnregisterFlashStateChangeCallback(const Camera_CaptureSession* session, OH_CaptureSession_OnFlashStateChange flashStateChange)
```
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_ExposureMode](../camera.h/capi-camera-h.md#camera_exposuremode) exposureMode | 要检查的曝光模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_ExposureMode](../camera.h/capi-camera-h.md#camera_exposuremode)\* exposureMode | 当前的曝光模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_ExposureMode](../camera.h/capi-camera-h.md#camera_exposuremode) exposureMode | 要设置的曝光模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_Point](../../结构体/Camera_Point/capi-oh-camera-camera-point.md)\* point | 当前测量点。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_Point](../../结构体/Camera_Point/capi-oh-camera-camera-point.md) point | 要设置的测量点。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_IsExposureMeteringModeSupported(const Camera_CaptureSession* session, OH_Camera_ExposureMeteringMode exposureMeteringMode, bool* isSupported)
```
...
| --- | --- |
| const [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例指针。 |
| [OH\_Camera\_ExposureMeteringMode](../camera.h/capi-camera-h.md#oh_camera_exposuremeteringmode) exposureMeteringMode | 待检查的曝光测光模式。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_GetExposureMeteringMode(const Camera_CaptureSession* session, OH_Camera_ExposureMeteringMode* exposureMeteringMode)
```
...
| --- | --- |
| const [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例指针。 |
| [OH\_Camera\_ExposureMeteringMode](../camera.h/capi-camera-h.md#oh_camera_exposuremeteringmode)\* exposureMeteringMode | 输出参数，返回当前曝光测光模式。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_OPERATION\_NOT\_ALLOWED：操作不允许，会话或相机状态异常。  CAMERA\_SESSION\_NOT\_CONFIG：捕获会话未配置。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_SetExposureMeteringMode(const Camera_CaptureSession* session, OH_Camera_ExposureMeteringMode exposureMeteringMode)
```
...
| --- | --- |
| const [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例指针。 |
| [OH\_Camera\_ExposureMeteringMode](../camera.h/capi-camera-h.md#oh_camera_exposuremeteringmode) exposureMeteringMode | 待设置的目标曝光测光模式。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_GetSupportedISORange(const Camera_CaptureSession* session, int32_t *minIsoValue, int32_t *maxIsoValue)
```
...
| 参数项 | 描述 |
| --- | --- |
| const [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_GetIso(const Camera_CaptureSession* session, int32_t* isoValue)
```
...
```
1. Camera_ErrorCode OH_CaptureSession_SetIso(const Camera_CaptureSession* session, int32_t isoValue)
```

**描述**

设置ISO感光度值。需在[OH\_CaptureSession\_GetSupportedISORange](capi-capture-session-h.md#oh_capturesession_getsupportedisorange)获取到的范围内进行设置，且仅曝光模式为EXPOSURE\_MODE\_LOCKED时生效。
...
```
1. Camera_ErrorCode OH_CaptureSession_GetSupportedPhysicalApertures(const Camera_CaptureSession* session, OH_Camera_PhysicalAperture** apertures, uint32_t* size)
```
...
| --- | --- |
| const [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [OH\_Camera\_PhysicalAperture](../../结构体/OH_Camera_PhysicalAperture/capi-oh-camera-oh-camera-physicalaperture.md)\*\* apertures | 用于存储物理光圈值的数组指针。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_DeletePhysicalApertures(const Camera_CaptureSession* session, OH_Camera_PhysicalAperture* apertures, uint32_t size)
```
...
| --- | --- |
| const [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例指针。 |
| [OH\_Camera\_PhysicalAperture](../../结构体/OH_Camera_PhysicalAperture/capi-oh-camera-oh-camera-physicalaperture.md)\* apertures | 待删除的物理光圈数组指针。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_GetPhysicalAperture(const Camera_CaptureSession* session, double* aperture)
```
...
```
1. Camera_ErrorCode OH_CaptureSession_SetPhysicalAperture(const Camera_CaptureSession* session, double aperture)
```
...
```
1. Camera_ErrorCode OH_CaptureSession_GetSupportedExposureDurationRange(const Camera_CaptureSession* session, int32_t* minExposureDuration, int32_t* maxExposureDuration)
```
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或者参数不正确。  CAMERA\_OPERATION\_NOT\_ALLOWED：操作不允许。  CAMERA\_SESSION\_NOT\_CONFIG：捕获会话未配置。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_SetExposureDuration(const Camera_CaptureSession* session, int32_t exposureDuration)
```

**描述**

设置曝光时间。单位：微秒。若传感器无法精确使用该曝光时间，系统会自动调整为最近的支持值，并通过[OH\_CaptureSession\_OnExposureDurationChange](capi-capture-session-h.md#oh_capturesession_onexposuredurationchange)回调通知。
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或者参数不正确。  CAMERA\_OPERATION\_NOT\_ALLOWED：操作不允许，会话或相机状态异常。  CAMERA\_SESSION\_NOT\_CONFIG：捕获会话未配置。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_GetExposureDuration(const Camera_CaptureSession* session, int32_t* exposureDuration)
```
...
```
1. typedef void (*OH_CaptureSession_OnExposureDurationChange)(const Camera_CaptureSession* session, int32_t exposureDuration)
```
...
```
1. Camera_ErrorCode OH_CaptureSession_RegisterExposureInfoChangeCallback(const Camera_CaptureSession* session, OH_CaptureSession_OnExposureDurationChange exposureDurationChange)
```
...
```
1. Camera_ErrorCode OH_CaptureSession_UnregisterExposureInfoChangeCallback(const Camera_CaptureSession* session, OH_CaptureSession_OnExposureDurationChange exposureDurationChange)
```
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_FocusMode](../camera.h/capi-camera-h.md#camera_focusmode) focusMode | 要检查的聚焦模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_FocusMode](../camera.h/capi-camera-h.md#camera_focusmode)\* focusMode | 当前聚焦模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_FocusMode](../camera.h/capi-camera-h.md#camera_focusmode) focusMode | 要设置的聚焦模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_Point](../../结构体/Camera_Point/capi-oh-camera-camera-point.md)\* focusPoint | 当前焦点。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_Point](../../结构体/Camera_Point/capi-oh-camera-camera-point.md) focusPoint | 要设置的目标点。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_VideoStabilizationMode](../camera.h/capi-camera-h.md#camera_videostabilizationmode) mode | 要检查的录像防抖模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_VideoStabilizationMode](../camera.h/capi-camera-h.md#camera_videostabilizationmode)\* mode | 当前录像防抖模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_VideoStabilizationMode](../camera.h/capi-camera-h.md#camera_videostabilizationmode) mode | 要设置的录像防抖模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md)\* cameraInput | 要设置的相机输入实例。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_PreviewOutput](../../结构体/Camera_PreviewOutput/capi-oh-camera-camera-previewoutput.md)\* cameraOutput | 要设置的预览输出实例。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* cameraOutput | 要设置的拍照输出实例。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_VideoOutput](../../结构体/Camera_VideoOutput/capi-oh-camera-camera-videooutput.md)\* cameraOutput | 要添加的录像输出实例。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_PreconfigType](../camera.h/capi-camera-h.md#camera_preconfigtype) preconfigType | 要检查的预配置类型。 |
...
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_PreconfigType](../camera.h/capi-camera-h.md#camera_preconfigtype) preconfigType | 要检查的预配置类型。 |
| [Camera\_PreconfigRatio](../camera.h/capi-camera-h.md#camera_preconfigratio) preconfigRatio | 要检查的预配置比例。 |
| bool\* canPreconfig | 是否支持预配置的结果。返回true表示支持预配置，返回false表示不支持。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_PreconfigType](../camera.h/capi-camera-h.md#camera_preconfigtype) preconfigType | 指定的预配置类型。 |
...
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_PreconfigType](../camera.h/capi-camera-h.md#camera_preconfigtype) preconfigType | 指定的预配置类型。 |
| [Camera\_PreconfigRatio](../camera.h/capi-camera-h.md#camera_preconfigratio) preconfigRatio | 指定的预配置比例。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_GetFocusDistance(const Camera_CaptureSession* session, float* focusDistance)
```
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或者参数不正确。  CAMERA\_OPERATION\_NOT\_ALLOWED：操作不允许，会话或输入设备可能异常。  CAMERA\_SESSION\_NOT\_CONFIG：捕获会话未配置。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_SetFocusDistance(const Camera_CaptureSession* session, float focusDistance)
```
...
```
1. Camera_ErrorCode OH_CaptureSession_IsFocusDistanceSupported(const Camera_CaptureSession* session, bool* isSupported)
```
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或者参数不正确。  CAMERA\_SESSION\_NOT\_CONFIG：捕获会话未配置。 |
...
| [Camera\_SmoothZoomMode](../camera.h/capi-camera-h.md#camera_smoothzoommode) smoothZoomMode | 平滑变焦模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [OH\_NativeBuffer\_ColorSpace](<../../../../ArkGraphics 2D（方舟2D图形服务）/C API/头文件/buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_colorspace>)\* colorSpace | 如果方法调用成功，将删除的OH\_NativeBuffer\_ColorSpace列表。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [OH\_NativeBuffer\_ColorSpace](<../../../../ArkGraphics 2D（方舟2D图形服务）/C API/头文件/buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_colorspace>)\* colorSpace | 当前的OH\_NativeBuffer\_ColorSpace。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [OH\_NativeBuffer\_ColorSpace](<../../../../ArkGraphics 2D（方舟2D图形服务）/C API/头文件/buffer_common.h/capi-buffer-common-h.md#oh_nativebuffer_colorspace>) colorSpace | 要设置的目标OH\_NativeBuffer\_ColorSpace。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_QualityPrioritization](../camera.h/capi-camera-h.md#camera_qualityprioritization) qualityPrioritization | 要设置的录像质量优先级，默认为高录像质量。 |
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK = 0：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_SESSION\_NOT\_CONFIG：捕获会话未配置。 |
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK = 0：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_SESSION\_NOT\_CONFIG：捕获会话未配置。  CAMERA\_OPERATION\_NOT\_ALLOWED：不允许操作。 |
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：设置成功。  CAMERA\_INVALID\_ARGUMENT：参数缺失或者参数类型不正确。  CAMERA\_SESSION\_NOT\_CONFIG：相机会话未配置。 |
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：函数调用成功。  CAMERA\_INVALID\_ARGUMENT：参数缺失或者参数类型不正确。  CAMERA\_SESSION\_NOT\_CONFIG：相机会话未配置。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_WhiteBalanceMode](../camera.h/capi-camera-h.md#camera_whitebalancemode)\* whiteBalanceMode | 白平衡模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_WhiteBalanceMode](../camera.h/capi-camera-h.md#camera_whitebalancemode) whiteBalanceMode | 指定的白平衡模式。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_ControlCenterEffectType](../camera.h/capi-camera-h.md#camera_controlcentereffecttype)\*\* types | 如果方法调用成功，将记录支持的Camera\_ControlCenterEffectType列表。 |
...
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例。 |
| [Camera\_ControlCenterEffectType](../camera.h/capi-camera-h.md#camera_controlcentereffecttype)\* types | 如果方法调用成功，要删除的Camera\_ControlCenterEffectType列表。 |
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK = 0：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_SESSION\_NOT\_CONFIG：捕获会话未配置。  CAMERA\_SERVICE\_FATAL\_ERROR：相机服务异常。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 指向Camera\_CaptureSession实例的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | 指向Camera\_CaptureSession的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数缺失或者参数类型不正确。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_GetRAWCaptureZoomRatioRange(const Camera_CaptureSession* session, float* minZoom, float* maxZoom)
```
...
```
1. Camera_ErrorCode OH_CaptureSession_IsOISModeSupported(const Camera_CaptureSession* session, OH_Camera_OISMode oisMode, bool* isSupported)
```
...
| --- | --- |
| const [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例指针。 |
| [OH\_Camera\_OISMode](../camera.h/capi-camera-h.md#oh_camera_oismode) oisMode | 待检查的光学防抖模式。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_GetSupportedOISBiasRange(const Camera_CaptureSession* session, OH_Camera_OISAxes oisAxis, float* minBias, float* maxBias, float* step)
```
...
| --- | --- |
| const [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例指针。 |
| [OH\_Camera\_OISAxes](../camera.h/capi-camera-h.md#oh_camera_oisaxes) oisAxis | 光学防抖轴。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_GetCurrentOISMode(const Camera_CaptureSession* session, OH_Camera_OISMode* oisMode)
```
...
| --- | --- |
| const [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例指针。 |
| [OH\_Camera\_OISMode](../camera.h/capi-camera-h.md#oh_camera_oismode)\* oisMode | 输出参数，返回当前光学防抖模式。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_GetCurrentCustomOISBias(const Camera_CaptureSession* session, float* pitchBias, float* yawBias)
```
...
```
1. Camera_ErrorCode OH_CaptureSession_SetOISMode(const Camera_CaptureSession* session, OH_Camera_OISMode oisMode)
```
...
| --- | --- |
| const [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\* session | Camera\_CaptureSession实例指针。 |
| [OH\_Camera\_OISMode](../camera.h/capi-camera-h.md#oh_camera_oismode) oisMode | 待设置的光学防抖模式。 |
...
```
1. Camera_ErrorCode OH_CaptureSession_SetOISModeCustom(const Camera_CaptureSession* session, float pitchBias, float yawBias)
```
