...
scraped_at: 2026-06-01T16:20:43+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:ba5e4cf99bddcd9d3bec812f44cc3e5bea32dd6042d3401bfb9996370ae01a2d
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [CameraInput\_Callbacks](../../结构体/CameraInput_Callbacks/capi-oh-camera-camerainput-callbacks.md) | CameraInput\_Callbacks | 相机输入错误事件的回调。 |
| [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md) | Camera\_Input | 相机输入对象。可以使用[OH\_CameraManager\_CreateCameraInput](../camera_manager.h/capi-camera-manager-h.md#oh_cameramanager_createcamerainput)方法创建指针。 |
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void (\*OH\_CameraInput\_OnError)(const Camera\_Input\* cameraInput, Camera\_ErrorCode errorCode)](capi-camera-input-h.md#oh_camerainput_onerror) | OH\_CameraInput\_OnError | 在[CameraInput\_Callbacks](../../结构体/CameraInput_Callbacks/capi-oh-camera-camerainput-callbacks.md)中被调用的相机输入错误回调。 |
...
在[CameraInput\_Callbacks](../../结构体/CameraInput_Callbacks/capi-oh-camera-camerainput-callbacks.md)中被调用的相机输入错误回调。
...
| 参数项 | 描述 |
| --- | --- |
| const [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md)\* cameraInput | 传递回调的Camera\_Input。 |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) errorCode | 相机输入的Camera\_ErrorCode。 |

**参考：**

[CAMERA\_CONFLICT\_CAMERA](../camera.h/capi-camera-h.md#camera_errorcode)

[CAMERA\_DEVICE\_DISABLED](../camera.h/capi-camera-h.md#camera_errorcode)

[CAMERA\_DEVICE\_PREEMPTED](../camera.h/capi-camera-h.md#camera_errorcode)
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md)\* cameraInput | Camera\_Input实例。 |
| [CameraInput\_Callbacks](../../结构体/CameraInput_Callbacks/capi-oh-camera-camerainput-callbacks.md)\* callback | 要注册的相机输入更改事件回调。 |
...
| --- | --- |
| [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md)\* cameraInput | Camera\_Input实例。 |
| [CameraInput\_Callbacks](../../结构体/CameraInput_Callbacks/capi-oh-camera-camerainput-callbacks.md)\* callback | 要注销的相机输入更改事件回调。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md)\* cameraInput | 要打开的Camera\_Input实例。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_CONFLICT\_CAMERA：因冲突而无法使用相机。  CAMERA\_DEVICE\_DISABLED：由于安全原因禁用了相机。  CAMERA\_SERVICE\_FATAL\_ERROR：相机服务异常。 |
...
| --- | --- |
| [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md)\* cameraInput | 要打开的Camera\_Input实例。 |
| [Camera\_ConcurrentType](../camera.h/capi-camera-h.md#camera_concurrenttype) type | 指定并发类型。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md)\* cameraInput | 要关闭的Camera\_Input实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md)\* cameraInput | 要释放的Camera\_Input实例。 |
...
| [Camera\_OcclusionDetectionResult](../../结构体/Camera_OcclusionDetectionResult/capi-oh-camera-camera-occlusiondetectionresult.md) occlusionDetectionResult | 相机镜头遮挡、脏污检测结果。 |
