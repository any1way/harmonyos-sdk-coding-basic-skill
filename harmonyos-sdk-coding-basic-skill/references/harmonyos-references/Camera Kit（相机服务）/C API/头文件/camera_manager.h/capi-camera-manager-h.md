...
scraped_at: 2026-06-01T16:20:44+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:c9ecf9d20b1fd7498b740c9be7467fbf4719f3cac0a668397f58e9d621c706a1
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [CameraManager\_Callbacks](../../结构体/CameraManager_Callbacks/capi-oh-camera-cameramanager-callbacks.md) | CameraManager\_Callbacks | 相机设备状态的回调。 |
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void (\*OH\_CameraManager\_StatusCallback)(Camera\_Manager\* cameraManager, Camera\_StatusInfo\* status)](capi-camera-manager-h.md#oh_cameramanager_statuscallback) | OH\_CameraManager\_StatusCallback | 在[CameraManager\_Callbacks](../../结构体/CameraManager_Callbacks/capi-oh-camera-cameramanager-callbacks.md)中被调用的相机管理器状态回调。 |
...
在[CameraManager\_Callbacks](../../结构体/CameraManager_Callbacks/capi-oh-camera-cameramanager-callbacks.md)中被调用的相机管理器状态回调。
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 传递回调的Camera\_Manager。 |
| [Camera\_StatusInfo](../../结构体/Camera_StatusInfo/capi-oh-camera-camera-statusinfo.md)\* status | 每个相机设备的状态信息。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 传递回调的Camera\_Manager。 |
| [Camera\_TorchStatusInfo](../../结构体/Camera_TorchStatusInfo/capi-oh-camera-camera-torchstatusinfo.md)\* status | 手电筒的状态信息。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 传递回调的Camera\_Manager。 |
| [Camera\_FoldStatusInfo](../../结构体/Camera_FoldStatusInfo/capi-oh-camera-camera-foldstatusinfo.md)\* foldStatusInfo | 设备的折叠状态信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [CameraManager\_Callbacks](../../结构体/CameraManager_Callbacks/capi-oh-camera-cameramanager-callbacks.md)\* callback | 要注册的相机设备状态回调。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [CameraManager\_Callbacks](../../结构体/CameraManager_Callbacks/capi-oh-camera-cameramanager-callbacks.md)\* callback | 要注销的相机设备状态回调。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [Camera\_Device](../../结构体/Camera_Device/capi-oh-camera-camera-device.md)\*\* cameras | 如果方法调用成功，将记录支持的Camera\_Device列表。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [Camera\_Device](../../结构体/Camera_Device/capi-oh-camera-camera-device.md)\* cameras | 要删除的Camera\_Device列表。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Device](../../结构体/Camera_Device/capi-oh-camera-camera-device.md)\* camera | 要查询的Camera\_Device。 |
| [Camera\_OutputCapability](../../结构体/Camera_OutputCapability/capi-oh-camera-camera-outputcapability.md)\*\* cameraOutputCapability | 如果方法调用成功，将记录支持的Camera\_OutputCapability。 |
...
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Device](../../结构体/Camera_Device/capi-oh-camera-camera-device.md)\* camera | 要查询的Camera\_Device。 |
| [Camera\_SceneMode](../camera.h/capi-camera-h.md#camera_scenemode) sceneMode | 指定相机模式。 |
| [Camera\_OutputCapability](../../结构体/Camera_OutputCapability/capi-oh-camera-camera-outputcapability.md)\*\* cameraOutputCapability | 如果方法调用成功，将记录支持的Camera\_OutputCapability列表。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [Camera\_OutputCapability](../../结构体/Camera_OutputCapability/capi-oh-camera-camera-outputcapability.md)\* cameraOutputCapability | 要删除的Camera\_OutputCapability。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [Camera\_CaptureSession](../../结构体/Camera_CaptureSession/capi-oh-camera-camera-capturesession.md)\*\* captureSession | 如果方法调用成功，将创建Camera\_CaptureSession。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Device](../../结构体/Camera_Device/capi-oh-camera-camera-device.md)\* camera | 用于创建Camera\_Input实例的Camera\_Device。 |
| [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md)\*\* cameraInput | 如果方法调用成功，将创建Camera\_Input实例。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [Camera\_Position](../camera.h/capi-camera-h.md#camera_position) position | 用于创建Camera\_Input实例的相机位置。 |
| [Camera\_Type](../camera.h/capi-camera-h.md#camera_type) type | 用于创建Camera\_Input实例的相机类型。 |
| [Camera\_Input](../../结构体/Camera_Input/capi-oh-camera-camera-input.md)\*\* cameraInput | 如果方法调用成功，将创建Camera\_Input实例。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Profile](../../结构体/Camera_Profile/capi-oh-camera-camera-profile.md)\* profile | 用于创建Camera\_PreviewOutput实例的相机流配置文件。 |
| const char\* surfaceId | 用于创建Camera\_PreviewOutput实例的surfaceId。 |
| [Camera\_PreviewOutput](../../结构体/Camera_PreviewOutput/capi-oh-camera-camera-previewoutput.md)\*\* previewOutput | 如果方法调用成功，将创建Camera\_PreviewOutput实例。 |
...
```
1. Camera_ErrorCode OH_CameraManager_CreateDeferredPreviewOutput(const Camera_Manager* cameraManager, const Camera_Profile* profile, Camera_PreviewOutput** previewOutput)
```

**描述**

创建延迟预览输出实例。使用结束后，必须调用[OH\_PreviewOutput\_Release](../preview_output.h/capi-preview-output-h.md#oh_previewoutput_release)释放预览输出实例。
...
| 参数项 | 描述 |
| --- | --- |
| [const Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Profile](../../结构体/Camera_Profile/capi-oh-camera-camera-profile.md)\* profile | 用于创建Camera\_PreviewOutput实例的相机流配置文件。 |
| [Camera\_PreviewOutput](../../结构体/Camera_PreviewOutput/capi-oh-camera-camera-previewoutput.md)\*\* previewOutput | 如果方法调用成功，将创建Camera\_PreviewOutput实例。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Profile](../../结构体/Camera_Profile/capi-oh-camera-camera-profile.md)\* profile | 用于创建Camera\_PhotoOutput实例的相机流配置文件。 |
| const char\* surfaceId | 用于创建Camera\_PhotoOutput实例的surfaceId。 |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\*\* photoOutput | 如果方法调用成功，将创建Camera\_PhotoOutput实例。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [const Camera\_VideoProfile](../../结构体/Camera_VideoProfile/capi-oh-camera-camera-videoprofile.md)\* profile | 用于创建Camera\_VideoOutput实例的录像配置文件。 |
| const char\* surfaceId | 用于创建Camera\_VideoOutput实例的surfaceId。 |
| [Camera\_VideoOutput](../../结构体/Camera_VideoOutput/capi-oh-camera-camera-videooutput.md)\*\* videoOutput | 如果方法调用成功，将创建Camera\_VideoOutput实例。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [const Camera\_MetadataObjectType](../camera.h/capi-camera-h.md#camera_metadataobjecttype)\* profile | 用于创建Camera\_MetadataOutput实例的元数据对象类型。 |
| [Camera\_MetadataOutput](../../结构体/Camera_MetadataOutput/capi-oh-camera-camera-metadataoutput.md)\*\* metadataOutput | 如果方法调用成功，将创建Camera\_MetadataOutput实例。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [const Camera\_MetadataObjectType](../camera.h/capi-camera-h.md#camera_metadataobjecttype)\* metadataObjectTypes | 用于创建Camera\_MetadataOutput实例的元数据对象类型数组。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Device](../../结构体/Camera_Device/capi-oh-camera-camera-device.md)\* camera | 要查询的Camera\_Device。 |
| [Camera\_SceneMode](../camera.h/capi-camera-h.md#camera_scenemode)\*\* sceneModes | 如果方法调用成功，将记录支持的场景模式列表。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [Camera\_SceneMode](../camera.h/capi-camera-h.md#camera_scenemode)\* sceneModes | 要删除的场景模式列表。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [Camera\_TorchMode](../camera.h/capi-camera-h.md#camera_torchmode) torchMode | 要检查的相机手电筒模式。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [Camera\_TorchMode](../camera.h/capi-camera-h.md#camera_torchmode) torchMode | 要设置的相机手电筒模式。 |
...
获取指定[Camera\_Position](../camera.h/capi-camera-h.md#camera_position)和[Camera\_Type](../camera.h/capi-camera-h.md#camera_type)的相机镜头，如果该接口返回值为CAMERA\_SERVICE\_FATAL\_ERROR，表示当前设备未查询到该镜头。
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [Camera\_Position](../camera.h/capi-camera-h.md#camera_position) position | 要查询的相机位置。 |
| [Camera\_Type](../camera.h/capi-camera-h.md#camera_type) type | 要查询的相机类型。 |
| [Camera\_Device](../../结构体/Camera_Device/capi-oh-camera-camera-device.md)\* camera | 要查询的Camera\_Device。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [Camera\_DeviceQueryInfo](../../结构体/Camera_DeviceQueryInfo/capi-oh-camera-camera-devicequeryinfo.md)\* deviceQueryInfo | 相机设备的查询信息实例。 |
| uint32\_t\* cameraSize | 查询的所支持的Camera\_Device列表大小。 |
| [Camera\_Device](../../结构体/Camera_Device/capi-oh-camera-camera-device.md)\*\* cameras | 查询的所支持的Camera\_Device列表。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [Camera\_Device](../../结构体/Camera_Device/capi-oh-camera-camera-device.md)\* cameras | 待删除的Camera\_Device列表。 |
...
| --- | --- |
| [Camera\_Manager](../../结构体/Camera_Manager/capi-oh-camera-camera-manager.md)\* cameraManager | 相机管理器实例。 |
| [const Camera\_Device](../../结构体/Camera_Device/capi-oh-camera-camera-device.md)\* camera | 用于查询的Camera\_Device相机设备列表，推荐设置为包含[OH\_CameraManager\_GetCameraDevice](capi-camera-manager-h.md#oh_cameramanager_getcameradevice)获取的前置与后置两个相机设备的相机设备列表。 |
| uint32\_t deviceSize | 用于查询的相机设备列表长度, 必须设置为2（表示前置与后置两个用于并发的相机设备）。 |
| [Camera\_ConcurrentInfo](../../结构体/Camera_ConcurrentInfo/capi-oh-camera-camera-concurrentinfo.md)\*\* cameraConcurrentInfo | 查询到的相机并发能力数组Camera\_ConcurrentInfo，作为入参应当默认设置为空。  如果相机支持并发，cameraConcurrentInfo会被赋值为查询到的相机并发能力数组Camera\_ConcurrentInfo。  如果相机不支持并发，不会对cameraConcurrentInfo进行更改，并且返回错误码[Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode).CAMERA\_SERVICE\_FATAL\_ERROR。 |
| uint32\_t\* infoSize | 查询到的相机并发能力数组长度，作为入参应当默认设置为0。  如果相机支持并发，infoSize会被赋值为查询到的相机并发能力数组长度。  如果相机不支持并发，不会对infoSize进行更改，并且返回错误码[Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode).CAMERA\_SERVICE\_FATAL\_ERROR。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_SERVICE\_FATAL\_ERROR：相机服务异常，或者相机不支持并发。 |
