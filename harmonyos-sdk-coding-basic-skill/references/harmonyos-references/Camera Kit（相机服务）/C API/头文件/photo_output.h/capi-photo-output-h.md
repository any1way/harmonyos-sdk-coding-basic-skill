...
scraped_at: 2026-06-01T16:20:52+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:560ea18e44030ca445149933e3f2577c84fdb70ab23fbb13c2c19264f80ac12c
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [PhotoOutput\_Callbacks](../../结构体/PhotoOutput_Callbacks/capi-oh-camera-photooutput-callbacks.md) | PhotoOutput\_Callbacks | 拍照输出的回调。 |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md) | Camera\_PhotoOutput | 拍照输出对象。  可以使用[OH\_CameraManager\_CreatePhotoOutput](../camera_manager.h/capi-camera-manager-h.md#oh_cameramanager_createphotooutput)方法创建指针。 |
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [typedef void (\*OH\_PhotoOutput\_OnFrameStart)(Camera\_PhotoOutput\* photoOutput)](capi-photo-output-h.md#oh_photooutput_onframestart) | OH\_PhotoOutput\_OnFrameStart | 在[PhotoOutput\_Callbacks](../../结构体/PhotoOutput_Callbacks/capi-oh-camera-photooutput-callbacks.md)中被调用的拍照输出帧启动回调。 |
| [typedef void (\*OH\_PhotoOutput\_OnFrameShutter)(Camera\_PhotoOutput\* photoOutput, Camera\_FrameShutterInfo\* info)](capi-photo-output-h.md#oh_photooutput_onframeshutter) | OH\_PhotoOutput\_OnFrameShutter | 在[PhotoOutput\_Callbacks](../../结构体/PhotoOutput_Callbacks/capi-oh-camera-photooutput-callbacks.md)中被调用的拍照输出帧快门回调。 |
| [typedef void (\*OH\_PhotoOutput\_OnFrameEnd)(Camera\_PhotoOutput\* photoOutput, int32\_t frameCount)](capi-photo-output-h.md#oh_photooutput_onframeend) | OH\_PhotoOutput\_OnFrameEnd | 在[PhotoOutput\_Callbacks](../../结构体/PhotoOutput_Callbacks/capi-oh-camera-photooutput-callbacks.md)中被调用的拍照输出帧结束回调。 |
| [typedef void (\*OH\_PhotoOutput\_OnError)(Camera\_PhotoOutput\* photoOutput, Camera\_ErrorCode errorCode)](capi-photo-output-h.md#oh_photooutput_onerror) | OH\_PhotoOutput\_OnError | 在[PhotoOutput\_Callbacks](../../结构体/PhotoOutput_Callbacks/capi-oh-camera-photooutput-callbacks.md)中被调用的拍照输出错误回调。 |
...
| [Camera\_ErrorCode OH\_PhotoOutput\_Capture(Camera\_PhotoOutput\* photoOutput)](capi-photo-output-h.md#oh_photooutput_capture) | - | 拍摄照片。  必须在[OH\_PreviewOutput\_Release](../preview_output.h/capi-preview-output-h.md#oh_previewoutput_release)之前调用，否则会导致无法拍照。 |
...
在[PhotoOutput\_Callbacks](../../结构体/PhotoOutput_Callbacks/capi-oh-camera-photooutput-callbacks.md)中被调用的拍照输出帧启动回调。
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 传递回调的拍照输出实例。 |
...
在[PhotoOutput\_Callbacks](../../结构体/PhotoOutput_Callbacks/capi-oh-camera-photooutput-callbacks.md)中被调用的拍照输出帧快门回调。
...
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 传递回调的拍照输出实例。 |
| [Camera\_FrameShutterInfo](../../结构体/Camera_FrameShutterInfo/capi-oh-camera-camera-frameshutterinfo.md)\* info | 回调传递的帧快门回调信息。 |
...
在[PhotoOutput\_Callbacks](../../结构体/PhotoOutput_Callbacks/capi-oh-camera-photooutput-callbacks.md)中被调用的拍照输出帧结束回调。
...
在[PhotoOutput\_Callbacks](../../结构体/PhotoOutput_Callbacks/capi-oh-camera-photooutput-callbacks.md)中被调用的拍照输出错误回调。
...
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 传递回调的拍照输出实例。 |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) errorCode | 拍照输出的错误码。 |
...
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 传递回调的拍照输出实例。 |
| [Camera\_CaptureStartInfo](../../结构体/Camera_CaptureStartInfo/capi-oh-camera-camera-capturestartinfo.md)\* Info | 回调传递的拍照开始信息。 |
...
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 传递回调的拍照输出实例。 |
| [OH\_PhotoNative](../../结构体/OH_PhotoNative/capi-oh-camera-oh-photonative.md)\* photo | 回调传递的OH\_PhotoNative。 |
...
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 传递回调的拍照输出实例。 |
| [OH\_MediaAsset](<../../../../Media Library Kit（媒体文件管理服务）/C API/结构体/OH_MediaAsset/capi-mediaassetmanager-oh-mediaasset.md>)\* photoAsset | 回调传递的媒体资源。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 拍照输出实例。 |
| [PhotoOutput\_Callbacks](../../结构体/PhotoOutput_Callbacks/capi-oh-camera-photooutput-callbacks.md)\* callback | 要注册的拍照输出更改事件回调。 |
...
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 拍照输出实例。 |
| [PhotoOutput\_Callbacks](../../结构体/PhotoOutput_Callbacks/capi-oh-camera-photooutput-callbacks.md)\* callback | 要注销的拍照输出更改事件回调。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 用于获取照片旋转角度的拍照输出实例。 |
| int deviceDegree | 当前设备旋转角度。 |
| [Camera\_ImageRotation](../camera.h/capi-camera-h.md#camera_imagerotation)\* imageRotation | 照片旋转角度的结果。 |
...
必须在[OH\_PreviewOutput\_Release](../preview_output.h/capi-preview-output-h.md#oh_previewoutput_release)之前调用，否则会导致无法拍照。
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 用于捕获拍照的拍照输出实例。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Camera\_ErrorCode](../camera.h/capi-camera-h.md#camera_errorcode) | CAMERA\_OK：方法调用成功。  CAMERA\_INVALID\_ARGUMENT：参数丢失或参数类型不正确。  CAMERA\_SESSION\_NOT\_RUNNING：捕获会话未运行。  CAMERA\_SERVICE\_FATAL\_ERROR：相机服务异常。 |
...
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 用于捕获拍照的拍照输出实例。 |
| [Camera\_PhotoCaptureSetting](../../结构体/Camera_PhotoCaptureSetting/capi-oh-camera-camera-photocapturesetting.md) setting | 用于捕获拍照的[Camera\_PhotoCaptureSetting](../../结构体/Camera_PhotoCaptureSetting/capi-oh-camera-camera-photocapturesetting.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 要释放的拍照输出实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 拍照输出实例，用于检查是否支持镜像。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 拍照输出实例，用于确认是否启用镜像拍照。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 传递当前配置文件的拍照输出实例。 |
| [Camera\_Profile](../../结构体/Camera_Profile/capi-oh-camera-camera-profile.md)\*\* profile | 如果方法调用成功，将记录照片输出配置文件。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_Profile](../../结构体/Camera_Profile/capi-oh-camera-camera-profile.md)\* profile | 要被删除的照片配置文件实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 用于检查是否支持动态照片的拍照输出实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 用于启用或禁用动态照片的拍照输出实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 用于获取是否支持拍照画质优先策略的拍照输出实例。 |
| [Camera\_PhotoQualityPrioritization](../camera.h/capi-camera-h.md#camera_photoqualityprioritization) qualityPrioritization | 要检查的拍照画质优先策略。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Camera\_PhotoOutput](../../结构体/Camera_PhotoOutput/capi-oh-camera-camera-photooutput.md)\* photoOutput | 用于设置拍照画质优先策略的拍照输出实例。 |
| [Camera\_PhotoQualityPrioritization](../camera.h/capi-camera-h.md#camera_photoqualityprioritization) qualityPrioritization | 要设置的拍照画质优先策略。 |
