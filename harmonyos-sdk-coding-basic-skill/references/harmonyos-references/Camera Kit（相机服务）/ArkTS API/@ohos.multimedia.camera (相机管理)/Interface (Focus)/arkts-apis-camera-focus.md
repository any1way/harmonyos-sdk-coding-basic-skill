...
scraped_at: 2026-06-01T16:20:05+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:0c19af0a82d2d79238c22c1520e74bf7227b9f0b4471e05c7e44f814d32e4712
---
Focus继承自[FocusQuery](<../Interface (FocusQuery)/arkts-apis-camera-focusquery.md>)。
...
进行设置之前，需要先检查设备是否支持指定的焦距模式，可使用方法[isFocusModeSupported](<../Interface (FocusQuery)/arkts-apis-camera-focusquery.md#isfocusmodesupported11>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| afMode | [FocusMode](../Enums/arkts-apis-camera-e.md#focusmode) | 是 | 指定的焦距模式。传参为null或者undefined，作为0处理，手动对焦模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [FocusMode](../Enums/arkts-apis-camera-e.md#focusmode) | 获取当前设备的焦距模式。接口调用失败会抛出相应错误码并返回undefined，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
| 类型 | 说明 |
| --- | --- |
| [Point](<../Interfaces (其他)/arkts-apis-camera-i.md#point>) | 用于获取当前的焦点。接口调用失败会返回相应错误码，错误码类型为[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
| 类型 | 说明 |
| --- | --- |
| number | 用于获取当前焦距，单位mm。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
