...
scraped_at: 2026-06-01T16:19:58+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:13ebff219fd91ba8d5f478f9fc8308f37e6f56860205963d6d02a96637e1feeb
---
相机管理器类，使用前需要通过[getCameraManager](../Functions/arkts-apis-camera-f.md#cameragetcameramanager)接口获取相机管理实例。
...
| 类型 | 说明 |
| --- | --- |
| Array<[CameraDevice](<../Interfaces (其他)/arkts-apis-camera-i.md#cameradevice>)> | 相机设备列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| camera | [CameraDevice](<../Interfaces (其他)/arkts-apis-camera-i.md#cameradevice>) | 是 | 相机设备，通过[getSupportedCameras](arkts-apis-camera-cameramanager.md#getsupportedcameras)接口获取。传参异常时，会返回错误码[7400101](../../../错误码/Camera错误码/errorcode-camera.md#section7400101-无效入参)。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Array<[SceneMode](../Enums/arkts-apis-camera-e.md#scenemode11)> | 相机支持的模式列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| camera | [CameraDevice](<../Interfaces (其他)/arkts-apis-camera-i.md#cameradevice>) | 是 | 相机设备，通过 [getSupportedCameras](arkts-apis-camera-cameramanager.md#getsupportedcameras) 接口获取。 |
| mode | [SceneMode](../Enums/arkts-apis-camera-e.md#scenemode11) | 是 | 相机模式，通过 [getSupportedSceneModes](arkts-apis-camera-cameramanager.md#getsupportedscenemodes11) 接口获取。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [CameraOutputCapability](<../Interfaces (其他)/arkts-apis-camera-i.md#cameraoutputcapability>) | 相机输出能力。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| camera | [CameraDevice](<../Interfaces (其他)/arkts-apis-camera-i.md#cameradevice>) | 是 | 相机设备信息，通过[getSupportedCameras](arkts-apis-camera-cameramanager.md#getsupportedcameras)接口获取。 |
| mode | [SceneMode](../Enums/arkts-apis-camera-e.md#scenemode11) | 是 | 相机模式，通过[getSupportedSceneModes](arkts-apis-camera-cameramanager.md#getsupportedscenemodes11)接口获取。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| camera | [CameraDevice](<../Interfaces (其他)/arkts-apis-camera-i.md#cameradevice>) | 是 | CameraDevice对象，通过 [getSupportedCameras](arkts-apis-camera-cameramanager.md#getsupportedcameras) 接口获取。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [CameraInput](<../Interface (CameraInput)/arkts-apis-camera-camerainput.md>) | 返回CameraInput实例。接口调用失败会返回相应错误码，错误码类型为[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [CameraPosition](../Enums/arkts-apis-camera-e.md#cameraposition) | 是 | 相机位置，首先通过 [getSupportedCameras](arkts-apis-camera-cameramanager.md#getsupportedcameras) 接口获取支持的相机设备对象，然后根据返回的相机设备对象获取设备位置信息。 |
| type | [CameraType](../Enums/arkts-apis-camera-e.md#cameratype) | 是 | 相机类型，首先通过 [getSupportedCameras](arkts-apis-camera-cameramanager.md#getsupportedcameras) 接口获取支持的相机设备对象，然后根据返回的相机设备对象获取设备类型信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| profile | [Profile](<../Interfaces (其他)/arkts-apis-camera-i.md#profile>) | 是 | 支持的预览配置信息，通过[getSupportedOutputCapability](arkts-apis-camera-cameramanager.md#getsupportedoutputcapability11)接口获取。 |
| surfaceId | string | 是 | 从[XComponent](../../../../ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)或者[ImageReceiver](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (ImageReceiver)/arkts-apis-image-imagereceiver.md>)组件获取的surfaceId。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [PreviewOutput](<../Interface (PreviewOutput)/arkts-apis-camera-previewoutput.md>) | PreviewOutput实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
创建无配置信息的预览输出对象，同步返回结果。该接口需配合[preconfig](<../Interface (PhotoSession)/arkts-apis-camera-photosession.md#preconfig12>)一起使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| profile | [Profile](<../Interfaces (其他)/arkts-apis-camera-i.md#profile>) | 否 | 支持的拍照配置信息，通过[getSupportedOutputCapability](arkts-apis-camera-cameramanager.md#getsupportedoutputcapability11)接口获取。  API version 11时，该参数必填；从API version 12开始，如果使用[preconfig](<../Interface (PhotoSession)/arkts-apis-camera-photosession.md#preconfig12>)进行预配置，传入profile参数会覆盖preconfig的预配置参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [PhotoOutput](<../Interface (PhotoOutput)/arkts-apis-camera-photooutput.md>) | PhotoOutput实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| profile | [VideoProfile](<../Interfaces (其他)/arkts-apis-camera-i.md#videoprofile>) | 是 | 支持的录像配置信息，通过[getSupportedOutputCapability](arkts-apis-camera-cameramanager.md#getsupportedoutputcapability11)接口获取。 |
| surfaceId | string | 是 | 从[AVRecorder](<../../../../Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVRecorder)/arkts-apis-media-avrecorder.md>)获取的surfaceId。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [VideoOutput](<../Interface (VideoOutput)/arkts-apis-camera-videooutput.md>) | VideoOutput实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
创建无配置信息的录像输出对象，同步返回结果。该接口需配合[preconfig](<../Interface (VideoSession)/arkts-apis-camera-videosession.md#preconfig12>)功能一起使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| metadataObjectTypes | Array<[MetadataObjectType](../Enums/arkts-apis-camera-e.md#metadataobjecttype)> | 是 | metadata流类型信息，通过[getSupportedOutputCapability](arkts-apis-camera-cameramanager.md#getsupportedoutputcapability11)接口获取。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [MetadataOutput](<../Interface (MetadataOutput)/arkts-apis-camera-metadataoutput.md>) | MetadataOutput实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [SceneMode](../Enums/arkts-apis-camera-e.md#scenemode11) | 是 | 相机支持的模式。如果传入的参数异常（如超出范围、传入null或未定义等），实际接口不会生效。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [T](<../Interface (Session)/arkts-apis-camera-session.md>) | Session实例。接口调用失败会返回相应的错误码，错误码类型为[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
| callback | AsyncCallback<[CameraStatusInfo](<../Interfaces (其他)/arkts-apis-camera-i.md#camerastatusinfo>)> | 是 | 回调函数，用于获取镜头状态变化信息。 |
...
| callback | AsyncCallback<[CameraStatusInfo](<../Interfaces (其他)/arkts-apis-camera-i.md#camerastatusinfo>)> | 否 | 回调函数，如果指定参数则取消对应callback（callback对象不可是匿名函数），否则取消所有callback。 |
...
| callback | AsyncCallback<[FoldStatusInfo](<../Interfaces (其他)/arkts-apis-camera-i.md#foldstatusinfo12>)> | 是 | 回调函数。返回折叠设备折叠信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'foldStatusChange'。表示折叠设备折叠状态发生变化。 |
| callback | AsyncCallback<[FoldStatusInfo](<../Interfaces (其他)/arkts-apis-camera-i.md#foldstatusinfo12>)> | 否 | 回调函数，返回折叠设备折叠信息。如果指定参数则取消对应callback（callback对象不可是匿名函数），否则取消所有callback。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [TorchMode](../Enums/arkts-apis-camera-e.md#torchmode11) | 是 | 手电筒模式。传参为null或者undefined，作为0处理，手电筒关闭。 |
...
| 类型 | 说明 |
| --- | --- |
| [TorchMode](../Enums/arkts-apis-camera-e.md#torchmode11) | 返回设备当前手电筒模式。 |
...
| callback | AsyncCallback<[TorchStatusInfo](<../Interfaces (其他)/arkts-apis-camera-i.md#torchstatusinfo11>)> | 是 | 回调函数，用于获取手电筒状态变化信息。 |
...
| callback | AsyncCallback<[TorchStatusInfo](<../Interfaces (其他)/arkts-apis-camera-i.md#torchstatusinfo11>)> | 否 | 回调函数，如果指定参数则取消对应callback（callback对象不可是匿名函数），否则取消所有callback。 |
...
获取指定[CameraPosition](../Enums/arkts-apis-camera-e.md#cameraposition)和[CameraType](../Enums/arkts-apis-camera-e.md#cameratype)的相机镜头，如果该接口返回结果为undefined，表示当前设备未查询到该镜头。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [CameraPosition](../Enums/arkts-apis-camera-e.md#cameraposition) | 是 | 需要得到的CameraDevice对象对应的CameraPosition条件。 |
| type | [CameraType](../Enums/arkts-apis-camera-e.md#cameratype) | 是 | 需要得到的CameraDevice对象对应的CameraType条件。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [CameraDevice](<../Interfaces (其他)/arkts-apis-camera-i.md#cameradevice>) | 根据相机位置和相机类型查询的对应相机。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [CameraPosition](../Enums/arkts-apis-camera-e.md#cameraposition) | 是 | 相机的位置。 |
| types | Array<[CameraType](../Enums/arkts-apis-camera-e.md#cameratype)> | 是 | 相机类型数组。 |
| connectType | [ConnectionType](../Enums/arkts-apis-camera-e.md#connectiontype) | 是 | 相机的连接类型。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Array<[CameraDevice](<../Interfaces (其他)/arkts-apis-camera-i.md#cameradevice>)> | 根据相机位置、相机类型数组和连接类型查询符合条件的相机列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cameras | Array<[CameraDevice](<../Interfaces (其他)/arkts-apis-camera-i.md#cameradevice>)> | 是 | 一组CameraDevice相机设备，并得到与这一组CameraDevice对应的并发信息，推荐设置为由[getCameraDevice](arkts-apis-camera-cameramanager.md#getcameradevice18)获取的前置与后置两个用于并发的相机设备。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Array<[CameraConcurrentInfo](<../Interfaces (其他)/arkts-apis-camera-i.md#cameraconcurrentinfo18>)> | 一组CameraDevice相机设备对象对应的并发信息，与CameraDevice相机设备一一对应。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| camera | [CameraDevice](<../Interfaces (其他)/arkts-apis-camera-i.md#cameradevice>) | 是 | 相机设备，通过 [getSupportedCameras](arkts-apis-camera-cameramanager.md#getsupportedcameras) 接口获取。传参异常时，会返回错误码。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| profile | [Profile](<../Interfaces (其他)/arkts-apis-camera-i.md#profile>) | 是 | 支持的拍照配置信息，通过[getSupportedOutputCapability](arkts-apis-camera-cameramanager.md#getsupportedoutputcapability11)接口获取。 |
| surfaceId | string | 是 | 从[ImageReceiver](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (ImageReceiver)/arkts-apis-image-imagereceiver.md>)获取的surfaceId。 |
...
| 类型 | 说明 |
| --- | --- |
| [CaptureSession](<../废弃的Interface (CaptureSession, deprecated)/arkts-apis-camera-capturesession.md>) | CaptureSession实例。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
