...
scraped_at: 2026-06-01T16:20:26+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:29602bbf44b27175d2db431039cfe1ca5d67a305d7a23294a85bd79c4d12b6be
---
录像会话中使用的输出信息，继承[CameraOutput](<../Interface (CameraOutput)/arkts-apis-camera-cameraoutput.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<void> | 是 | 回调函数。当启动录制成功，err为undefined，否则为错误对象。错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'error'，videoOutput创建成功后可监听。录像接口调用出现错误时触发该事件并返回对应错误码，比如调用[start](arkts-apis-camera-videooutput.md#start-1)，[CameraOutput.release](<../Interface (CameraOutput)/arkts-apis-camera-cameraoutput.md#release-1>)接口时出现错误返回对应错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [VideoProfile](<../Interfaces (其他)/arkts-apis-camera-i.md#videoprofile>) | 当前生效的配置信息 |
...
* 启用/关闭录像镜像后，需要通过[getVideoRotation](arkts-apis-camera-videooutput.md#getvideorotation12)获取录像旋转角度以及[updateRotation](<../../../../Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVRecorder)/arkts-apis-media-avrecorder.md#updaterotation12>)更新旋转角度。
...
| 类型 | 说明 |
| --- | --- |
| [ImageRotation](../Enums/arkts-apis-camera-e.md#imagerotation) | 返回录像旋转角度。若接口调用失败，返回undefined。 |
