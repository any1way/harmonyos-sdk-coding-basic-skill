...
scraped_at: 2026-06-01T16:20:07+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:32e355b9a2a01b3e38dc06aaae0fa76b720599b400ba872a12363179af6016d4
---
提供了查询是否支持当前对焦模式的方法。
...
| 类型 | 说明 |
| --- | --- |
| boolean | 检测对焦模式是否支持。true表示支持，false表示不支持。接口调用失败会抛出相应错误码并返回undefined，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
