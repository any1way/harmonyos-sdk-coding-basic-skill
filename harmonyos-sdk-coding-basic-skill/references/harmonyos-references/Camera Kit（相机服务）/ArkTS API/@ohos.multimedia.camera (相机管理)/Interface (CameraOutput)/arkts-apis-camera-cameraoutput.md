...
content_hash: sha256:da06ecc30790e8f3a2d4c594c5d3006646b4e9abe7d664bf807d88b2eac44cb5
---
会话中[Session](<../Interface (Session)/arkts-apis-camera-session.md>)使用的输出信息，output的基类。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<void> | 是 | 回调函数。当释放输出资源成功，err为undefined，否则为错误对象。错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
