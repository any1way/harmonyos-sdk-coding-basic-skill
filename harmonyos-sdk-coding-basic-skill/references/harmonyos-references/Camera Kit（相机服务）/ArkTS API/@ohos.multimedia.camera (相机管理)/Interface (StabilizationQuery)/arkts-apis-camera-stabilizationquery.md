...
content_hash: sha256:d01cdd4bed0805a837b9c74e82ef7b496ab20710234842ab59ac54d829c19d2e
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| vsMode | [VideoStabilizationMode](../Enums/arkts-apis-camera-e.md#videostabilizationmode) | 是 | 视频防抖模式。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| boolean | 返回视频防抖模式是否支持。true表示支持，false表示不支持。接口调用失败会抛出相应错误码并返回undefined，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
