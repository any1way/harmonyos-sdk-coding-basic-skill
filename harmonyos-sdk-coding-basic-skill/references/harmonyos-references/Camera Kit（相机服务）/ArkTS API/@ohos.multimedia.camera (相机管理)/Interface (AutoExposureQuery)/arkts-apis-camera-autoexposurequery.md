...
scraped_at: 2026-06-01T16:19:54+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:a770f00863cfb288ab0aecb8d0bbe738c5ec3b02f5cb172893802abdfb2f19ec
---
...
| 类型 | 说明 |
| --- | --- |
| boolean | 获取是否支持曝光模式，true为支持，false为不支持。接口调用失败会抛出相应错误码并返回undefined，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
3. function isExposureMeteringModeSupported(photoSession: camera.PhotoSession, aeMeteringMode: camera.ExposureMeteringMode): boolean {
4. let isSupported: boolean = false;
5. try {
6. isSupported = photoSession.isExposureMeteringModeSupported(aeMeteringMode);
7. } catch (error) {
8. // 失败返回错误码error.code并处理。
9. let err = error as BusinessError;
10. console.error(`The isExposureMeteringModeSupported call failed. error code: ${err.code}`);
11. }
12. return isSupported;
13. }
```
