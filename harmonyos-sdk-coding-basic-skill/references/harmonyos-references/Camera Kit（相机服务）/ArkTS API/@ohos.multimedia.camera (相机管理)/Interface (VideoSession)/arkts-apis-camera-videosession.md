...
| preconfigRatio | [PreconfigRatio](../Enums/arkts-apis-camera-e.md#preconfigratio12) | 否 | 可选画幅比例，默认为16:9。 |
...
* 建议该接口在[commitConfig](<../Interface (Session)/arkts-apis-camera-session.md#commitconfig11>)和[start](<../Interface (Session)/arkts-apis-camera-session.md#start11-1>)之间调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| quality | [QualityPrioritization](../Enums/arkts-apis-camera-e.md#qualityprioritization14) | 是 | 需要设置的视频质量优先级（默认为高录像质量）。 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)和[Camera错误码](../../../错误码/Camera错误码/errorcode-camera.md)。
...
| callback | AsyncCallback<[ControlCenterStatusInfo](<../Interfaces (其他)/arkts-apis-camera-i.md#controlcenterstatusinfo20>)> | 是 | 回调函数，用于获取当前控制器激活状态。 |
...
| callback | AsyncCallback<[ControlCenterStatusInfo](<../Interfaces (其他)/arkts-apis-camera-i.md#controlcenterstatusinfo20>)> | 否 | 回调函数，如果指定参数则取消对应callback (callback对象不可是匿名函数)，否则参数默认为空，取消所有callback。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[IsoInfo](<../Interfaces (其他)/arkts-apis-camera-i.md#isoinfo22>)> | 是 | 回调函数，用于获取相机当前的ISO值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[IsoInfo](<../Interfaces (其他)/arkts-apis-camera-i.md#isoinfo22>)> | 否 | 回调函数，可选。  如果指定callback参数则注销该callback监听，callback不可是匿名函数。  如果未指定callback，则注销所有已存在的callback监听。 |
