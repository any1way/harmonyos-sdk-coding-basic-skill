...
scraped_at: 2026-06-01T16:20:36+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:5b73c0031c6d14f51e712caebf4dbdc67c03f346cc068b76146457cd12a1cbb9
---
拍照会话类，保存一次相机运行所需要的所有资源[CameraInput](<../Interface (CameraInput)/arkts-apis-camera-camerainput.md>)、[CameraOutput](<../Interface (CameraOutput)/arkts-apis-camera-cameraoutput.md>)，并向相机设备申请完成相机功能(录像，拍照)。

说明

从 API version 10开始支持，从API version 11开始废弃。建议使用[PhotoSession](<../Interface (PhotoSession)/arkts-apis-camera-photosession.md>)、[VideoSession](<../Interface (VideoSession)/arkts-apis-camera-videosession.md>)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.beginConfig](<../Interface (Session)/arkts-apis-camera-session.md#beginconfig11>)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.commitConfig](<../Interface (Session)/arkts-apis-camera-session.md#commitconfig11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<void> | 是 | 回调函数。当提交配置信息成功，err为undefined，否则为错误对象。错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode) |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.commitConfig](<../Interface (Session)/arkts-apis-camera-session.md#commitconfig11-1>)替代。
...
把[CameraInput](<../Interface (CameraInput)/arkts-apis-camera-camerainput.md>)加入到会话。

说明

从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.addInput](<../Interface (Session)/arkts-apis-camera-session.md#addinput11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cameraInput | [CameraInput](<../Interface (CameraInput)/arkts-apis-camera-camerainput.md>) | 是 | 需要添加的CameraInput实例。 |
...
移除[CameraInput](<../Interface (CameraInput)/arkts-apis-camera-camerainput.md>)。

说明

从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.removeInput](<../Interface (Session)/arkts-apis-camera-session.md#removeinput11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cameraInput | [CameraInput](<../Interface (CameraInput)/arkts-apis-camera-camerainput.md>) | 是 | 需要移除的CameraInput实例。 |
...
把[CameraOutput](<../Interface (CameraOutput)/arkts-apis-camera-cameraoutput.md>)加入到会话。

说明

从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.addOutput](<../Interface (Session)/arkts-apis-camera-session.md#addoutput11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cameraOutput | [CameraOutput](<../Interface (CameraOutput)/arkts-apis-camera-cameraoutput.md>) | 是 | 需要添加的CameraOutput实例。 |
...
从会话中移除[CameraOutput](<../Interface (CameraOutput)/arkts-apis-camera-cameraoutput.md>)。

说明

从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.removeOutput](<../Interface (Session)/arkts-apis-camera-session.md#removeoutput11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cameraOutput | [CameraOutput](<../Interface (CameraOutput)/arkts-apis-camera-cameraoutput.md>) | 是 | 需要移除的CameraOutput实例。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.start](<../Interface (Session)/arkts-apis-camera-session.md#start11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<void> | 是 | 回调函数。当开始会话工作成功，err为undefined，否则为错误对象。错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.start](<../Interface (Session)/arkts-apis-camera-session.md#start11-1>)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.stop](<../Interface (Session)/arkts-apis-camera-session.md#stop11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<void> | 是 | 回调函数。当停止会话工作成功，err为undefined，否则为错误对象。错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.stop](<../Interface (Session)/arkts-apis-camera-session.md#stop11-1>)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.release](<../Interface (Session)/arkts-apis-camera-session.md#release11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<void> | 是 | 回调函数。当释放会话资源成功，err为undefined，否则为错误对象。错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Session.release](<../Interface (Session)/arkts-apis-camera-session.md#release11-1>)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Flash.hasFlash](<../Interface (FlashQuery)/arkts-apis-camera-flashquery.md#hasflash11>)替代。
...
| 类型 | 说明 |
| --- | --- |
| boolean | 设备支持闪光灯。true表示支持，false表示不支持。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Flash.isFlashModeSupported](<../Interface (FlashQuery)/arkts-apis-camera-flashquery.md#isflashmodesupported11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| flashMode | [FlashMode](../Enums/arkts-apis-camera-e.md#flashmode) | 是 | 指定闪光灯模式。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| boolean | 检测闪光灯模式是否支持。true表示支持，false表示不支持。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Flash.setFlashMode](<../Interface (Flash)/arkts-apis-camera-flash.md#setflashmode11>)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Flash.getFlashMode](<../Interface (Flash)/arkts-apis-camera-flash.md#getflashmode11>)替代。
...
| 类型 | 说明 |
| --- | --- |
| [FlashMode](../Enums/arkts-apis-camera-e.md#flashmode) | 获取当前设备的闪光灯模式。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.isExposureModeSupported](<../Interface (AutoExposureQuery)/arkts-apis-camera-autoexposurequery.md#isexposuremodesupported11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| aeMode | [ExposureMode](../Enums/arkts-apis-camera-e.md#exposuremode) | 是 | 曝光模式。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| boolean | 获取是否支持曝光模式。true表示支持，false表示不支持。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.getExposureMode](<../Interface (AutoExposure)/arkts-apis-camera-autoexposure.md#getexposuremode11>)替代。
...
| 类型 | 说明 |
| --- | --- |
| [ExposureMode](../Enums/arkts-apis-camera-e.md#exposuremode) | 获取当前曝光模式。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.setExposureMode](<../Interface (AutoExposure)/arkts-apis-camera-autoexposure.md#setexposuremode11>)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.getMeteringPoint](<../Interface (AutoExposure)/arkts-apis-camera-autoexposure.md#getmeteringpoint11>)替代。
...
| 类型 | 说明 |
| --- | --- |
| [Point](<../Interfaces (其他)/arkts-apis-camera-i.md#point>) | 获取当前曝光点。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.setMeteringPoint](<../Interface (AutoExposure)/arkts-apis-camera-autoexposure.md#setmeteringpoint11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| point | [Point](<../Interfaces (其他)/arkts-apis-camera-i.md#point>) | 是 | 曝光点，x,y设置范围应在[0,1]之内，超过范围，如果小于0设置0，大于1设置1。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.getExposureBiasRange](<../Interface (AutoExposureQuery)/arkts-apis-camera-autoexposurequery.md#getexposurebiasrange11>)替代。
...
| 类型 | 说明 |
| --- | --- |
| Array<number> | 获取补偿范围的数组。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.setExposureBias](<../Interface (AutoExposure)/arkts-apis-camera-autoexposure.md#setexposurebias11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| exposureBias | number | 是 | 曝光补偿，[getExposureBiasRange](<../Interface (AutoExposureQuery)/arkts-apis-camera-autoexposurequery.md#getexposurebiasrange11>)查询支持的范围，如果设置超过支持范围的值，自动匹配到就近临界点。曝光补偿存在步长，如步长为0.5。则设置1.2时，获取到实际生效曝光补偿为1.0。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。传参为null或者undefined，作为0处理，曝光补偿设置0。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[AutoExposure.getExposureValue](<../Interface (AutoExposure)/arkts-apis-camera-autoexposure.md#getexposurevalue11>)替代。
...
| 类型 | 说明 |
| --- | --- |
| number | 获取曝光值。曝光补偿存在步长，如步长为0.5。则设置1.2时，获取到实际生效曝光补偿为1.0。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Focus.isFocusModeSupported](<../Interface (FocusQuery)/arkts-apis-camera-focusquery.md#isfocusmodesupported11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| afMode | [FocusMode](../Enums/arkts-apis-camera-e.md#focusmode) | 是 | 指定的焦距模式。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| boolean | 检测对焦模式是否支持。true表示支持，false表示不支持。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Focus.setFocusMode](<../Interface (Focus)/arkts-apis-camera-focus.md#setfocusmode11>)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Focus.getFocusMode](<../Interface (Focus)/arkts-apis-camera-focus.md#getfocusmode11>)替代。
...
| 类型 | 说明 |
| --- | --- |
| [FocusMode](../Enums/arkts-apis-camera-e.md#focusmode) | 获取当前设备的焦距模式。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Focus.setFocusPoint](<../Interface (Focus)/arkts-apis-camera-focus.md#setfocuspoint11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| point | [Point](<../Interfaces (其他)/arkts-apis-camera-i.md#point>) | 是 | 焦点。x,y设置范围应在[0,1]之内，超过范围，如果小于0设置0，大于1设置1。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Focus.getFocusPoint](<../Interface (Focus)/arkts-apis-camera-focus.md#getfocuspoint11>)替代。
...
| 类型 | 说明 |
| --- | --- |
| [Point](<../Interfaces (其他)/arkts-apis-camera-i.md#point>) | 用于获取当前焦点。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Focus.getFocalLength](<../Interface (Focus)/arkts-apis-camera-focus.md#getfocallength11>)替代。
...
| 类型 | 说明 |
| --- | --- |
| number | 用于获取当前焦距。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Zoom.getZoomRatioRange](<../Interface (ZoomQuery)/arkts-apis-camera-zoomquery.md#getzoomratiorange11>)替代。
...
| 类型 | 说明 |
| --- | --- |
| Array<number> | 用于获取可变焦距比范围，返回的数组包括其最小值和最大值。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Zoom.setZoomRatio](<../Interface (Zoom)/arkts-apis-camera-zoom.md#setzoomratio11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| zoomRatio | number | 是 | 可变焦距比，通过[getZoomRatioRange](<../Interface (ZoomQuery)/arkts-apis-camera-zoomquery.md#getzoomratiorange11>)获取支持的变焦范围，如果设置超过支持范围的值，则只保留精度范围内数值。传参为null或者undefined，作为0处理，变焦设置最小值。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Zoom.getZoomRatio](<../Interface (Zoom)/arkts-apis-camera-zoom.md#getzoomratio11>)替代。
...
| 类型 | 说明 |
| --- | --- |
| number | 获取当前的变焦比结果。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Stabilization.isVideoStabilizationModeSupported](<../Interface (StabilizationQuery)/arkts-apis-camera-stabilizationquery.md#isvideostabilizationmodesupported11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| vsMode | [VideoStabilizationMode](../Enums/arkts-apis-camera-e.md#videostabilizationmode) | 是 | 视频防抖模式。传参为null或者undefined，作为0处理，超级防抖模式关闭。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| boolean | 返回视频防抖模式是否支持。true表示支持，false表示不支持。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Stabilization.getActiveVideoStabilizationMode](<../Interface (Stabilization)/arkts-apis-camera-stabilization.md#getactivevideostabilizationmode11>)替代。
...
| 类型 | 说明 |
| --- | --- |
| [VideoStabilizationMode](../Enums/arkts-apis-camera-e.md#videostabilizationmode) | 视频防抖是否正在使用。接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](../Enums/arkts-apis-camera-e.md#cameraerrorcode)。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[Stabilization.setVideoStabilizationMode](<../Interface (Stabilization)/arkts-apis-camera-stabilization.md#setvideostabilizationmode11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [VideoStabilizationMode](../Enums/arkts-apis-camera-e.md#videostabilizationmode) | 是 | 需要设置的视频防抖模式。传参为null或者undefined，作为0处理，超级防抖模式关闭。 |
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[VideoSession.on('focusStateChange')](<../Interface (VideoSession)/arkts-apis-camera-videosession.md#onfocusstatechange11>)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[VideoSession.off('focusStateChange')](<../Interface (VideoSession)/arkts-apis-camera-videosession.md#offfocusstatechange11>)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[VideoSession.on('error')](<../Interface (VideoSession)/arkts-apis-camera-videosession.md#onerror11>)替代。
...
从 API version 10开始支持，从API version 11开始废弃。建议使用[VideoSession.off('error')](<../Interface (VideoSession)/arkts-apis-camera-videosession.md#offerror11>)替代。
