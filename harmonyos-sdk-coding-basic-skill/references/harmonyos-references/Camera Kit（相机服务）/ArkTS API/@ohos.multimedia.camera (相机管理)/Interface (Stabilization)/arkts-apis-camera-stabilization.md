...
content_hash: sha256:52d97174c2b573f3f8770d648096eb33151222a9b2a1e8b28a35b6bb0cb10137
---
Stabilization继承自[StabilizationQuery](<../Interface (StabilizationQuery)/arkts-apis-camera-stabilizationquery.md>)。

提供设备在录像模式下设置视频防抖的操作。

需要会话中有录像流（[VideoOutput](<../Interface (VideoOutput)/arkts-apis-camera-videooutput.md>)）的前提下，才可以对视频进行防抖设置。
...
| 类型 | 说明 |
| --- | --- |
| [VideoStabilizationMode](../Enums/arkts-apis-camera-e.md#videostabilizationmode) | 视频防抖是否正在使用。若接口调用失败，返回undefined。 |
...
设置视频防抖模式。需要先检查设备是否支持对应的防抖模式，可以通过[isVideoStabilizationModeSupported](<../Interface (StabilizationQuery)/arkts-apis-camera-stabilizationquery.md#isvideostabilizationmodesupported11>)方法判断所设置的模式是否支持。建议在[commitConfig](<../Interface (Session)/arkts-apis-camera-session.md#commitconfig11-1>)与[Start](<../Interface (Session)/arkts-apis-camera-session.md#start11-1>)之间设置视频防抖。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [VideoStabilizationMode](../Enums/arkts-apis-camera-e.md#videostabilizationmode) | 是 | 需要设置的视频防抖模式。 |
