...
content_hash: sha256:9aba79e03292694c6d0c57955fd564ba130122532b50c759229b69be857dc6ed
---
WhiteBalance继承自[WhiteBalanceQuery](<../Interface (WhiteBalanceQuery)/arkts-apis-camera-whitebalancequery.md>)。
...
设置白平衡模式。设置之前需要先检查设备是否支持指定的白平衡模式，具体方法请参考[isWhiteBalanceModeSupported](<../Interface (WhiteBalanceQuery)/arkts-apis-camera-whitebalancequery.md#iswhitebalancemodesupported20>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [WhiteBalanceMode](../Enums/arkts-apis-camera-e.md#whitebalancemode20) | 是 | 白平衡模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [WhiteBalanceMode](../Enums/arkts-apis-camera-e.md#whitebalancemode20) | 获取当前白平衡模式。若接口调用失败，返回undefined。 |
...
设置之前需要先检查设备支持的白平衡值范围，具体方法请参考[getWhiteBalanceRange](<../Interface (WhiteBalanceQuery)/arkts-apis-camera-whitebalancequery.md#getwhitebalancerange20>)。
