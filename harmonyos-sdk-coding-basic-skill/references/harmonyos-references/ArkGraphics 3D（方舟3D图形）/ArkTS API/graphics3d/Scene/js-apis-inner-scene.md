...
scraped_at: 2026-06-01T16:30:28+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:b9893bc518dcc2411aecbc933b4817221ca0f8cfdc4e4d2be872b3972eb8011c
---
...
* 关于.shader资源文件，具体请见[.shader资源文件格式要求](<../../../../../harmonyos-guides/图形/ArkGraphics 3D（方舟3D图形）/ArkGraphics 3D资源创建以及使用/.shader资源文件格式要求/arkgraphics3d-shader-resource.md>)。
...
| uri | [ResourceStr](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 3D场景所需的资源文件路径。默认值为undefined。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| node | [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | 否 | 否 | 被射线击中的3D场景节点，可通过该节点操作目标物体（如移动、旋转、隐藏）。 |
| centerDistance | number | 否 | 否 | 命中物体包围盒中心到摄像机中心的距离，单位为世界坐标系下的场景单位（比如cm、m、km等），取值范围大于0。 |
| hitPosition | [Position3](../SceneType/js-apis-inner-scene-types.md#position3) | 否 | 否 | 射线与物体碰撞点的精确世界坐标（{x: number, y: number, z: number}），单位为世界坐标系下的场景单位（比如cm、m、km等）。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| rootNode | [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | 否 | 是 | 限定检测范围：仅检测该节点及其子节点。未设置时检测全场景。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [SceneResourceParameters](js-apis-inner-scene.md#sceneresourceparameters) | 是 | 创建着色器的参数。详细.shader文件格式请参考[.shader资源文件格式要求](<../../../../../harmonyos-guides/图形/ArkGraphics 3D（方舟3D图形）/ArkGraphics 3D资源创建以及使用/.shader资源文件格式要求/arkgraphics3d-shader-resource.md>)。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[Shader](../SceneResource/js-apis-inner-scene-resources.md#shader)> | Promise对象，返回创建的着色器对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Image](../SceneResource/js-apis-inner-scene-resources.md#image)> | Promise对象，返回创建的图像对象。 |
...
| geometry | [GeometryDefinition](../SceneType/js-apis-inner-scene-types.md#geometrydefinition18) | 是 | 几何形状定义，描述要创建的网格形状。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[MeshResource](../SceneResource/js-apis-inner-scene-resources.md#meshresource18)> | Promise对象，返回创建的网格资源对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Sampler](../SceneResource/js-apis-inner-scene-resources.md#sampler20)> | Promise对象，返回创建的采样器对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | [ResourceStr](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 创建场景使用的资源路径，如果未传入资源路径，则默认创建一个空场景。 |
...
| renderingPipeline21+ | [RenderingPipelineType](../SceneType/js-apis-inner-scene-types.md#renderingpipelinetype21) | 否 | 是 | 选择初始渲染管线类型，默认为轻量级前向渲染管线类型。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Camera](../SceneNode/js-apis-inner-scene-nodes.md#camera)> | Promise对象，返回相机对象。 |
...
| --- | --- | --- | --- |
| params | [SceneNodeParameters](js-apis-inner-scene.md#scenenodeparameters) | 是 | 场景节点参数。 |
| lightType | [LightType](../SceneNode/js-apis-inner-scene-nodes.md#lighttype) | 是 | 灯光类型。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[Light](../SceneNode/js-apis-inner-scene-nodes.md#light)> | Promise对象，返回灯光对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Node](../SceneNode/js-apis-inner-scene-nodes.md#node)> | Promise对象，返回节点对象。 |
...
| materialType | [MaterialType](../SceneResource/js-apis-inner-scene-resources.md#materialtype) | 是 | 材质类型。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[Material](../SceneResource/js-apis-inner-scene-resources.md#material)> | Promise对象，返回材质对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Environment](../SceneResource/js-apis-inner-scene-resources.md#environment)> | Promise对象，返回环境对象。 |
...
| --- | --- | --- | --- |
| params | [SceneNodeParameters](js-apis-inner-scene.md#scenenodeparameters) | 是 | 场景节点参数。 |
| mesh | [MeshResource](../SceneResource/js-apis-inner-scene-resources.md#meshresource18) | 是 | 网格数据参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[Geometry](../SceneNode/js-apis-inner-scene-nodes.md#geometry)> | Promise对象，返回几何对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Effect](../SceneResource/js-apis-inner-scene-resources.md#effect21)> | Promise对象，返回特效对象。 |
...
| property | Record<string, string | number | [Vec2](../SceneType/js-apis-inner-scene-types.md#vec2) | [Vec3](../SceneType/js-apis-inner-scene-types.md#vec3) | [Vec4](../SceneType/js-apis-inner-scene-types.md#vec4) | [SceneResource](../SceneResource/js-apis-inner-scene-resources.md#sceneresource-1) | boolean | number[] | string[] | [SceneResource](../SceneResource/js-apis-inner-scene-resources.md#sceneresource-1)[] | [Vec2](../SceneType/js-apis-inner-scene-types.md#vec2)[] | [Vec3](../SceneType/js-apis-inner-scene-types.md#vec3)[] | [Vec4](../SceneType/js-apis-inner-scene-types.md#vec4)[] | null | undefined> | 是 | 否 | 组件的属性集合，以键值对形式存储。支持多种基础类型和复杂类型，用于描述场景组件的各种属性，单位及取值范围取决于具体场景组件。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| shadowResolution | [Vec2](../SceneType/js-apis-inner-scene-types.md#vec2) | 否 | 是 | 表示全局阴影贴图分辨率，单位为像素（px）。默认值为undefined，表示阴影贴图分辨率设置为1024 \* 1024。输入的值需要大于0才能正确生效。如果输入值为浮点数则自动截取整数部分；如果输入值小于或等于0则无视该输入，维持原有配置。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| environment | [Environment](../SceneResource/js-apis-inner-scene-resources.md#environment) | 否 | 否 | 环境对象。 |
| animations | [Animation](../SceneResource/js-apis-inner-scene-resources.md#animation)[] | 是 | 否 | 动画数组，用于保存3D场景中的动画对象。 |
| root | [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | null | 是 | 否 | 3D场景树根节点。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | [ResourceStr](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 待加载的模型文件资源路径，默认值为undefined。 |
...
| type | [NodeType](../SceneNode/js-apis-inner-scene-nodes.md#nodetype) | 否 | 预期返回的节点类型。默认值为空。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | null | 返回请求节点的实例，如果没有找到或者找到的节点类型与传入的参数不相符则返回空。 |
...
| node | [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | 是 | 被导入的节点。 |
| parent | [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | null | 是 | 被导入节点在新场景中的父节点。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | 被导入的节点。 |
...
| parent | [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | null | 是 | 被导入场景在新场景中的父节点。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | 被导入场景的根节点。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | 是 | 组件需要附加到的节点。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | 是 | 组件附加的节点。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | 是 | 被克隆的节点。 |
| parent | [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | 是 | 被克隆的节点在当前所在场景中的目标父节点。被克隆的节点node和目标父节点parent需要属于同一个场景scene。 |
...
| 类型 | 说明 |
| --- | --- |
| [Node](../SceneNode/js-apis-inner-scene-nodes.md#node) | null | 返回克隆节点。克隆失败则返回null。 |
