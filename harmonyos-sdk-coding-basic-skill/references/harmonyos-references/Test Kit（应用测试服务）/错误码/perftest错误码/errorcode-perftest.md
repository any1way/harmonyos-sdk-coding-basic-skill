...
scraped_at: 2026-06-11T16:25:48+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:3457f9c01d555cd804c432e17b06e50c4d86323afc1714f66ff7ded82b661bdb
---
说明
...
1. 尝试通过重试解决IPC传输失败问题。
2. 判断PerfTest对象是否已被销毁，若已销毁需要重新[创建PerfTest对象](<../../ArkTS API/@ohos.test.PerfTest/js-apis-perftest.md#create>)。
...
首先保证[PerfTest.run](<../../ArkTS API/@ohos.test.PerfTest/js-apis-perftest.md#run>)接口已执行完成且未抛出异常，确保测试数据已采集完成，再获取指定数据。
