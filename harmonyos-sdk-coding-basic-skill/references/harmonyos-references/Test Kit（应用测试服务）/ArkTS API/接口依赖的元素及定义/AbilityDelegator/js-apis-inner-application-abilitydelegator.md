...
content_hash: sha256:6093409afe0acd1dd2246906ca3e0d7743e6eabdf85d691facc2903016749c04
---
AbilityDelegator模块可以通过[AbilityMonitor](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/AbilityMonitor/js-apis-inner-application-abilitymonitor.md>)实例来监听和管理[UIAbility](<../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)生命周期的变化。例如获取UIAbility当前状态（如是否已创建/是否在前台等）、查询当前获焦的UIAbility、等待UIAbility进入某个生命周期节点（如等待UIAbility进入onForeground）、启动指定UIAbility、设置超时机制等功能。

AbilityDelegator可以通过[getAbilityDelegator](<../../@ohos.app.ability.abilityDelegatorRegistry (AbilityDelegatorRegistry)/js-apis-app-ability-abilitydelegatorregistry.md#abilitydelegatorregistrygetabilitydelegator>)方法获取。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| monitor | [AbilityMonitor](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/AbilityMonitor/js-apis-inner-application-abilitymonitor.md>) | 是 | [AbilityMonitor](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/AbilityMonitor/js-apis-inner-application-abilitymonitor.md>)实例。 |
| callback | AsyncCallback<void> | 是 | 回调函数。当添加AbilityMonitor实例成功，err为undefined，否则为错误对象。 |

**错误码**：

以下错误码详细介绍请参考[通用错误码](../../../../通用错误码/errorcode-universal.md)和[元能力子系统错误码](<../../../../Ability Kit（程序框架服务）/错误码/元能力子系统错误码/errorcode-ability.md>)。
...
| --- | --- | --- | --- |
| monitor | [AbilityMonitor](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/AbilityMonitor/js-apis-inner-application-abilitymonitor.md>) | 是 | [AbilityMonitor](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/AbilityMonitor/js-apis-inner-application-abilitymonitor.md>)实例。 |
| callback | AsyncCallback<[UIAbility](<../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)> | 是 | 回调函数。当等待与AbilityMonitor实例匹配的Ability到达OnCreate生命周期成功，err为undefined，data为获取到的Ability实例，否则为错误对象。 |
...
| callback | AsyncCallback<[UIAbility](<../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)> | 是 | 表示指定的回调方法。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[UIAbility](<../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)> | Promise对象，返回Ability实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [Context](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>) | 应用[Context](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ability | [UIAbility](<../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>) | 是 | 指定Ability对象。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| number | 指定ability的生命周期状态。状态枚举值使用[AbilityLifecycleState](<../../@ohos.app.ability.abilityDelegatorRegistry (AbilityDelegatorRegistry)/js-apis-app-ability-abilitydelegatorregistry.md#abilitylifecyclestate>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[UIAbility](<../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)> | 是 | 回调函数。当获取当前应用顶部Ability成功，err为undefined，data为获取到的Ability实例；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[UIAbility](<../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)> | Promise对象，返回前应用顶部Ability。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 启动Ability参数。 |
...
| callback | AsyncCallback<[ShellCmdResult](../ShellCmdResult/js-apis-inner-application-shellcmdresult.md#shellcmdresult-1)> | 是 | 回调函数。当执行指定的shell命令成功，err为undefined，data为获取到的执行结果；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ShellCmdResult](../ShellCmdResult/js-apis-inner-application-shellcmdresult.md#shellcmdresult-1)> | Promise对象，返回Shell命令执行结果[ShellCmdResult](../ShellCmdResult/js-apis-inner-application-shellcmdresult.md#shellcmdresult-1)对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| monitor | [AbilityStageMonitor](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/AbilityStageMonitor/js-apis-inner-application-abilitystagemonitor.md>) | 是 | [AbilityStageMonitor](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/AbilityStageMonitor/js-apis-inner-application-abilitystagemonitor.md>) 实例。 |
...
| --- | --- | --- | --- |
| monitor | [AbilityStageMonitor](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/AbilityStageMonitor/js-apis-inner-application-abilitystagemonitor.md>) | 是 | [AbilityStageMonitor](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/AbilityStageMonitor/js-apis-inner-application-abilitystagemonitor.md>) 实例。 |
| callback | AsyncCallback<AbilityStage> | 是 | 回调函数。当等待并返回与给定AbilityStageMonitor中设置的条件匹配的AbilityStage对象的操作成功，err为undefined，data为获取到的[AbilityStage](<../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.AbilityStage (AbilityStage组件管理器)/js-apis-app-ability-abilitystage.md>)对象；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<AbilityStage> | Promise对象，返回[AbilityStage](<../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.AbilityStage (AbilityStage组件管理器)/js-apis-app-ability-abilitystage.md>)对象。 |
