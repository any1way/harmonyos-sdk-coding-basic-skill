...
scraped_at: 2026-06-11T16:25:40+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:98caf3bfd4e34a8512f92349160a77d1b6336b9a97a29f650bf3630f1765ad71
---
...
* 本模块接口在[单元测试框架](../../../../harmonyos-guides/应用测试/单元测试和UI测试/自动化测试框架使用指导/单元测试框架使用指导/unittest-guidelines.md)中使用。
* 本模块接口不支持并发调用。
...
以下错误码的详细介绍请参见[perftest错误码](../../错误码/perftest错误码/errorcode-perftest.md)。
