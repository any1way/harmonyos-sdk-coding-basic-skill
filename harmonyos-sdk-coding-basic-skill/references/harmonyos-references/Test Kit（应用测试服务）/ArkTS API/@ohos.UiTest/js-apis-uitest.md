...
scraped_at: 2026-06-11T16:25:39+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:5d3519a301ff692e22af53711e53a760b5587ab65231263096b0de6458c47fe4
---
...
* 本模块接口在[自动化测试脚本](../../../../harmonyos-guides/应用测试/单元测试和UI测试/自动化测试框架使用指导/UI测试框架使用指导/uitest-guidelines.md#使用arkts接口进行ui测试)中使用。
* 本模块接口不支持并发调用。
...
| COMPONENT\_TEXT\_CHANGED | 5 | [输入框控件](<../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md>)文本变化事件。 |
...
如果控件的无障碍属性[accessibilityLevel](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/无障碍属性/ts-universal-attributes-accessibility.md#accessibilitylevel)设置为'no'或'no-hide-descendants'，无法使用本接口指定目标控件的文本属性用于查找控件，可以使用[On.originalText()](js-apis-uitest.md#originaltext20)接口实现。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| txt | string | 是 | 指定控件文本，用于匹配目标控件文本。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| id | string | 是 | 指定控件的id值。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| tp | string | 是 | 指定控件类型。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| b | boolean | 否 | 指定控件可点击状态。true：可点击。false：不可点击。默认为true。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| b | boolean | 否 | 指定控件可长按点击状态。true：可长按点击。false：不可长按点击。默认为true。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| b | boolean | 否 | 控件可滑动状态。true：可滑动。false：不可滑动。默认为true。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| b | boolean | 否 | 指定控件使能状态。true：使能。false：未使能。默认为true。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| b | boolean | 否 | 控件获焦状态。true：获焦。false：未获焦。默认为true。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| b | boolean | 否 | 指定控件被选中状态。true：被选中。false：未被选中。默认为true。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| b | boolean | 否 | 指定控件被勾选状态。true：被勾选。false：未被勾选。默认为true。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| b | boolean | 否 | 指定控件能否被勾选状态。true：能被勾选。false：不能被勾选。默认为true。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| on | [On](js-apis-uitest.md#on9) | 是 | 特征控件的属性要求。 可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件树，以判断控件间位置关系。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bundleName | string | 是 | 应用窗口的包名。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| val | string | 是 | 控件的描述属性。 可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
| pattern | [MatchPattern](js-apis-uitest.md#matchpattern) | 否 | 指定的文本匹配模式，默认为[EQUALS](js-apis-uitest.md#matchpattern)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| val | string | 是 | 指定控件提示文本。 可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
| pattern | [MatchPattern](js-apis-uitest.md#matchpattern) | 否 | 指定的文本匹配模式，默认为[EQUALS](js-apis-uitest.md#matchpattern)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| displayId | number | 是 | 指定控件所属屏幕ID，取值范围：大于等于0的整数。  **说明：** 传入displayId不存在时，将抛出17000007异常。可通过[getAllDisplays](<../../../ArkUI（方舟UI框架）/ArkTS API/屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#displaygetalldisplays9>)获取当前所有的display对象，并由display对象获取对应的屏幕ID。可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
...
以下错误码的详细介绍请参见[uitest错误码](../../错误码/uitest错误码/errorcode-uitest.md)。
...
如果控件的无障碍属性[accessibilityLevel](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/无障碍属性/ts-universal-attributes-accessibility.md#accessibilitylevel)设置为'no'或'no-hide-descendants'，可以使用本接口指定目标控件的文本属性用于查找控件，使用[On.text()](js-apis-uitest.md#text9)接口不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| text | string | 是 | 指定控件文本，用于匹配目标控件文本。 可以借助[DevEco Testing](<../../../../harmonyos-guides/应用测试/专项测试/DevEco Testing/deveco-testing.md>)中UiViewer获取控件节点属性。 |
| pattern | [MatchPattern](js-apis-uitest.md#matchpattern) | 否 | 指定的文本匹配模式，默认为[EQUALS](js-apis-uitest.md#matchpattern)。 |
...
如果控件的无障碍属性[accessibilityLevel](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/无障碍属性/ts-universal-attributes-accessibility.md#accessibilitylevel)设置为'no'或'no-hide-descendants'，无法使用本接口获取控件的文本信息，可以使用[Component.getOriginalText()](js-apis-uitest.md#getoriginaltext20)获取控件的文本信息。
...
以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)和[uitest错误码](../../错误码/uitest错误码/errorcode-uitest.md)。
...
获取控件对象的文本信息。使用Promise异步回调。如果控件的无障碍属性[accessibilityLevel](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/无障碍属性/ts-universal-attributes-accessibility.md#accessibilitylevel)设置为'no'或'no-hide-descendants'，可以使用本接口获取控件的文本信息，无法使用[Component.getText()](js-apis-uitest.md#gettext9)获取控件的文本信息。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| keyCode | number | 是 | 指定的key值，取值范围：大于等于0的整数。取值范围：[KeyCode键码值](<../../../基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.keyCode (键值)/js-apis-keycode.md#keycode>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key0 | number | 是 | 指定的第一个key值，取值大于等于0的整数，取值范围：[KeyCode键码值](<../../../基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.keyCode (键值)/js-apis-keycode.md#keycode>)。 |
| key1 | number | 是 | 指定的第二个key值，取值大于等于0的整数，取值范围：[KeyCode键码值](<../../../基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.keyCode (键值)/js-apis-keycode.md#keycode>)。 |
| key2 | number | 否 | 指定的第三个key值，取值范围：大于等于0的整数。取值范围：[KeyCode键码值](<../../../基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.keyCode (键值)/js-apis-keycode.md#keycode>)，默认值为0。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| savePath | string | 是 | 文件保存路径。路径需为当前应用的[沙箱路径](<../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/应用沙箱目录/app-sandbox-directory.md>)。 |
...
| key1 | number | 否 | 指定的第一个key值，取值大于等于0的整数，取值范围：[KeyCode键码值](<../../../基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.keyCode (键值)/js-apis-keycode.md#keycode>)，默认值为0。 |
| key2 | number | 否 | 指定的第二个key值，取值大于等于0的整数，取值范围：[KeyCode键码值](<../../../基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.keyCode (键值)/js-apis-keycode.md#keycode>)，默认值为0。 |
...
| btnId | [MouseButton](js-apis-uitest.md#mousebutton10) | 是 | 按下的鼠标按钮。 |
| key1 | number | 否 | 指定的第一个key值，取值大于等于0的整数，取值范围：[KeyCode键码值](<../../../基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.keyCode (键值)/js-apis-keycode.md#keycode>)，默认值0。 |
| key2 | number | 否 | 指定的第二个key值，取值大于等于0的整数，取值范围：[KeyCode键码值](<../../../基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.keyCode (键值)/js-apis-keycode.md#keycode>)，默认值0。 |
...
开始监听指定类型的窗口变化事件，支持设置事件监听的扩展配置，监听到指定窗口变化事件时触发callback回调。仅支持[自由多窗模式](../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由多窗模式)的窗口监听。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| keyCode | number | 是 | 指定的key值，取值大于等于0的整数，取值范围：[KeyCode键码值](<../../../基础功能/Input Kit（多模输入服务）/ArkTS API/@ohos.multimodalInput.keyCode (键值)/js-apis-keycode.md#keycode>)。 |
