...
scraped_at: 2026-06-11T16:19:32+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:3138e1cadc8b5dd3c7d426d5117a841553ce08c4aca46325cacd00b1f8365859
---
## 概述
...
| 名称 | 描述 |
| --- | --- |
| [ffrt\_loop\_t](../../结构体/ffrt_loop_t/capi-ffrt-ffrt-loop-t.md) | loop句柄。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ffrt\_queue\_t](../../结构体/ffrt_queue_t/capi-ffrt-ffrt-queue-t.md) queue | 并发队列。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| FFRT\_C\_API [ffrt\_loop\_t](../../结构体/ffrt_loop_t/capi-ffrt-ffrt-loop-t.md) | 创建成功返回ffrt\_loop\_t对象，  创建失败返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ffrt\_loop\_t](../../结构体/ffrt_loop_t/capi-ffrt-ffrt-loop-t.md) loop | loop对象。 |
...
| [ffrt\_poller\_cb](../type_def.h/capi-type-def-h.md#ffrt_poller_cb) cb | 事件变化时触发的回调函数。 |
...
| void\* data | 事件变化时触发的回调函数的入参。 |
| [ffrt\_timer\_cb](../type_def.h/capi-type-def-h.md#ffrt_timer_cb) cb | 事件变化时触发的回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| FFRT\_C\_API [ffrt\_timer\_t](../type_def.h/capi-type-def-h.md#变量) | 返回定时器句柄。 |
