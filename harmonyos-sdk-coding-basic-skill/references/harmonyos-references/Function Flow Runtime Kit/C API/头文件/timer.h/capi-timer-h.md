...
content_hash: sha256:0d1f446b782c2e1c8461285444014f6b309523a6cedc3c764eb63e681dd95d43
---
## 概述
...
| 参数项 | 描述 |
| --- | --- |
| [ffrt\_qos\_t](../type_def.h/capi-type-def-h.md#变量) qos | QoS等级。 |
| uint64\_t timeout | 超时时间(毫秒)。 |
| void\* data | 超时后回调函数的入参。 |
| [ffrt\_timer\_cb](../type_def.h/capi-type-def-h.md#ffrt_timer_cb) cb | 超时执行的回调函数。 |
