...
scraped_at: 2026-06-11T16:24:18+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:03dee49ca7e1d21683e9d1d2d94e27e0f085d7f62a90d2ea2e5947c2c582fb72
---
## 概述
...
| 参数项 | 描述 |
| --- | --- |
| [Sensor\_Info](../../结构体/Sensor_Info/capi-sensor-sensor-info.md) \*\*infos | - 双指针指向设备上所有传感器的信息。请参考[Sensor\_Info](../../结构体/Sensor_Info/capi-sensor-sensor-info.md)。 |
...
| 类型 | 说明 |
| --- | --- |
| [Sensor\_Result](../oh_sensor_type.h/capi-oh-sensor-type-h.md#sensor_result) | 如果操作成功返回**SENSOR\_SUCCESS**；否则返回[Sensor\_Result](../oh_sensor_type.h/capi-oh-sensor-type-h.md#sensor_result)中定义的错误代码。  [SENSOR\_PARAMETER\_ERROR](../oh_sensor_type.h/capi-oh-sensor-type-h.md#sensor_result)参数检查失败。例如，参数无效；或传入的参数类型不正确。  [SENSOR\_SERVICE\_EXCEPTION](../oh_sensor_type.h/capi-oh-sensor-type-h.md#sensor_result)传感器服务异常。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const Sensor\_SubscriptionId](../../结构体/Sensor_SubscriptionId/capi-sensor-sensor-subscriptionid.md) \*id | - 指向传感器订阅ID的指针。请参考[Sensor\_SubscriptionId](../../结构体/Sensor_SubscriptionId/capi-sensor-sensor-subscriptionid.md)。 |
| [const Sensor\_SubscriptionAttribute](../../结构体/Sensor_SubscriptionAttribute/capi-sensor-sensor-subscriptionattribute.md) \*attribute | - 指向订阅属性的指针，该属性用于指定数据报告频率。请参考[Sensor\_SubscriptionAttribute](../../结构体/Sensor_SubscriptionAttribute/capi-sensor-sensor-subscriptionattribute.md)。 |
| [const Sensor\_Subscriber](../../结构体/Sensor_Subscriber/capi-sensor-sensor-subscriber.md) \*subscriber | - 指向订阅者信息的指针，该信息用于指定的回调函数报告传感器数据。请参考[Sensor\_Subscriber](../../结构体/Sensor_Subscriber/capi-sensor-sensor-subscriber.md)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Sensor\_Result](../oh_sensor_type.h/capi-oh-sensor-type-h.md#sensor_result) | 如果操作成功返回**SENSOR\_SUCCESS**；否则返回[Sensor\_Result](../oh_sensor_type.h/capi-oh-sensor-type-h.md#sensor_result)中定义的错误代码。  [SENSOR\_PERMISSION\_DENIED](../oh_sensor_type.h/capi-oh-sensor-type-h.md#sensor_result)权限验证失败。  [SENSOR\_PARAMETER\_ERROR](../oh_sensor_type.h/capi-oh-sensor-type-h.md#sensor_result)参数检查失败。例如，参数无效；或传入的参数类型不正确。  [SENSOR\_SERVICE\_EXCEPTION](../oh_sensor_type.h/capi-oh-sensor-type-h.md#sensor_result)传感器服务异常。 |
