...
scraped_at: 2026-06-11T16:24:11+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:a7ed2013661d03276dfd558c8f52cc85e6145b052c97d4581d5805685b1027ee
---
...
* 模块维护策略：
  ...
  + 对于支持该模块的其他设备类型，该模块从API version 8开始不再维护，推荐使用新接口[@ohos.sensor](<../@ohos.sensor (传感器)/js-apis-sensor.md>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[ACCELEROMETER](<../@ohos.sensor (传感器)/js-apis-sensor.md#accelerometer9>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[ACCELEROMETER](<../@ohos.sensor (传感器)/js-apis-sensor.md#accelerometerdeprecated-2>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[ORIENTATION](<../@ohos.sensor (传感器)/js-apis-sensor.md#orientationdeprecated>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[ORIENTATION](<../@ohos.sensor (传感器)/js-apis-sensor.md#orientationdeprecated-2>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[PROXIMITY](<../@ohos.sensor (传感器)/js-apis-sensor.md#proximitydeprecated>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[PROXIMITY](<../@ohos.sensor (传感器)/js-apis-sensor.md#proximitydeprecated-2>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[AMBIENT\_LIGHT](<../@ohos.sensor (传感器)/js-apis-sensor.md#ambient_lightdeprecated>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[AMBIENT\_LIGHT](<../@ohos.sensor (传感器)/js-apis-sensor.md#ambient_lightdeprecated-2>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[PEDOMETER](<../@ohos.sensor (传感器)/js-apis-sensor.md#pedometerdeprecated>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[PEDOMETER](<../@ohos.sensor (传感器)/js-apis-sensor.md#pedometerdeprecated-2>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[BAROMETER](<../@ohos.sensor (传感器)/js-apis-sensor.md#barometerdeprecated-1>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[BAROMETER](<../@ohos.sensor (传感器)/js-apis-sensor.md#barometerdeprecated-2>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[HEART\_RATE](<../@ohos.sensor (传感器)/js-apis-sensor.md#heart_ratedeprecated>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[HEART\_RATE](<../@ohos.sensor (传感器)/js-apis-sensor.md#heart_ratedeprecated-2>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[WEAR\_DETECTION](<../@ohos.sensor (传感器)/js-apis-sensor.md#wear_detectiondeprecated>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[WEAR\_DETECTION](<../@ohos.sensor (传感器)/js-apis-sensor.md#wear_detectiondeprecated-2>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[GYROSCOPE](<../@ohos.sensor (传感器)/js-apis-sensor.md#gyroscopedeprecated>)。
...
除Lite Wearable外，从API Version8开始，推荐使用[GYROSCOPE](<../@ohos.sensor (传感器)/js-apis-sensor.md#gyroscopedeprecated-2>)。
