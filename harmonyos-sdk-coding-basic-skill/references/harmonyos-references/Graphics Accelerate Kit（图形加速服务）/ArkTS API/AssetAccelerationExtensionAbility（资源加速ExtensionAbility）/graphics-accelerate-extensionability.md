...
scraped_at: 2026-06-01T16:30:35+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:454746a4ab90cdf5adbae3629e6688f249682e242ef8a454fdabf6ad1a316c79
---
...
* assetDownloadManager提供的接口仅支持调用如下方法：
  ...
  + [assetDownloadManager.fetchManifestUrl](../assetDownloadManager（资源包下载管理）/graphics-accelerate-assetdownloadmanager.md#assetdownloadmanagerfetchmanifesturl)
  + [assetDownloadManager.removeAssetDownloadTask](../assetDownloadManager（资源包下载管理）/graphics-accelerate-assetdownloadmanager.md#assetdownloadmanagerremoveassetdownloadtask)
  + [assetDownloadManager.fetchAllAssetDownloadTasks](../assetDownloadManager（资源包下载管理）/graphics-accelerate-assetdownloadmanager.md#assetdownloadmanagerfetchallassetdownloadtasks)
  + [assetDownloadManager.removeAllAssetDownloadTasks](../assetDownloadManager（资源包下载管理）/graphics-accelerate-assetdownloadmanager.md#assetdownloadmanagerremoveallassetdownloadtasks)
  + [assetDownloadManager.fetchGroupAssetDownloadTasks](../assetDownloadManager（资源包下载管理）/graphics-accelerate-assetdownloadmanager.md#assetdownloadmanagerfetchgroupassetdownloadtasks)
  + [assetDownloadManager.removeGroupAssetDownloadTasks](../assetDownloadManager（资源包下载管理）/graphics-accelerate-assetdownloadmanager.md#assetdownloadmanagerremovegroupassetdownloadtasks)
  + [assetDownloadManager.limitDownloadTaskSpeed](../assetDownloadManager（资源包下载管理）/graphics-accelerate-assetdownloadmanager.md#assetdownloadmanagerlimitdownloadtaskspeed)
  + [assetDownloadManager.reportDownloadProgress](../assetDownloadManager（资源包下载管理）/graphics-accelerate-assetdownloadmanager.md#assetdownloadmanagerreportdownloadprogress)
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| context | [AssetAccelerationExtensionContext](../AssetAccelerationExtensionContext（资源加速ExtensionContext）/graphics-accelerate-extensioncontext.md) | 否 | 否 | AssetAccelerationExtensionAbility的上下文环境，继承自[ExtensionContext](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/ExtensionContext/js-apis-inner-application-extensioncontext.md>)。 |
...
7. assetAccelerationExtensionInfo: AssetAccelerationExtensionInfo):
8. Promise<assetDownloadManager.AssetDownloadConfig[]> {
9. const context = this.context as common.ExtensionContext; // 若接口需要使用common.Context类型的上下文，可以从this.context中获取类型为common.ExtensionContext的上下文对象。
10. console.info('AssetAccelDemo', `application file directory = ${context.filesDir}`);
11. console.info('AssetAccelDemo', `onDownloadContentRequest enter, requestType: ${requestType}, manifestUrl: ${manifestUrl}.`);
12. // 构造资源包下载配置信息，用于函数返回值。download对象字段为演示用途，不应用于生产环境直接调用。
13. let downloadList: Array<assetDownloadManager.AssetDownloadConfig> = [];
14. let download: assetDownloadManager.AssetDownloadConfig = {
15. identifier: 'identifier', // 下载资源标识信息。
16. url: 'url', // 下载资源url。
17. isEssential: false, // 是否是必要下载资源。
18. groupId:'groupId', // 组ID，用于标识资源的版本信息。
19. fileName: 'fileName' // 下载资源的文件名。
20. };
21. downloadList.push(download);
22. await Promise.resolve();
23. return downloadList;
24. }
25. }
```
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| downloadTask | [assetDownloadManager.AssetDownloadTask](../assetDownloadManager（资源包下载管理）/graphics-accelerate-assetdownloadmanager.md#assetdownloadtask) | 是 | 下载任务信息。 |
...
| --- | --- | --- | --- |
| downloadTask | [assetDownloadManager.AssetDownloadTask](../assetDownloadManager（资源包下载管理）/graphics-accelerate-assetdownloadmanager.md#assetdownloadtask) | 是 | 下载任务信息。 |
| fault | [assetDownloadManager.DownloadFault](../assetDownloadManager（资源包下载管理）/graphics-accelerate-assetdownloadmanager.md#downloadfault) | 是 | 下载失败的原因。 |
