...
scraped_at: 2026-06-01T16:30:53+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:4ece8eb36ae75e6695337743bf1752afa6378494369029d5c4fc6fc553216767
---
## 概述

PhoneTabletTV

此结构体描述创建超帧上下文实例[FG\_Context\_VK](../../../模块/GraphicsAccelerate/_graphics_accelerate.md#fg_context_vk)所需的属性信息，该接口仅适配Vulkan图形API平台。
...
| 名称 | 描述 |
| --- | --- |
| VkInstance [vkInstance](_f_g___context_description___v_k.md#vkinstance) | Vulkan实例，需在[FG\_Context\_VK](../../../模块/GraphicsAccelerate/_graphics_accelerate.md#fg_context_vk)的整个生命周期内有效。 |
| VkPhysicalDevice [vkPhysicalDevice](_f_g___context_description___v_k.md#vkphysicaldevice) | Vulkan物理设备句柄，需在[FG\_Context\_VK](../../../模块/GraphicsAccelerate/_graphics_accelerate.md#fg_context_vk)的整个生命周期内有效。 |
| VkDevice [vkDevice](_f_g___context_description___v_k.md#vkdevice) | Vulkan逻辑设备句柄，需在[FG\_Context\_VK](../../../模块/GraphicsAccelerate/_graphics_accelerate.md#fg_context_vk)的整个生命周期内有效。 |
...
Vulkan逻辑设备句柄，需在[FG\_Context\_VK](../../../模块/GraphicsAccelerate/_graphics_accelerate.md#fg_context_vk)的整个生命周期内有效。
...
Vulkan实例，需在[FG\_Context\_VK](../../../模块/GraphicsAccelerate/_graphics_accelerate.md#fg_context_vk)的整个生命周期内有效。
...
Vulkan物理设备句柄，需在[FG\_Context\_VK](../../../模块/GraphicsAccelerate/_graphics_accelerate.md#fg_context_vk)的整个生命周期内有效。
