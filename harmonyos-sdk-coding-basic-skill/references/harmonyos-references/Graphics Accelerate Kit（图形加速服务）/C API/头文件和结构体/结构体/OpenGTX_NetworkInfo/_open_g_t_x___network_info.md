...
content_hash: sha256:3f0e2af82a3ea3e27c4f689ef4b5842abce1f2bc972f199e4b0855b1f1eb607c
---
## 概述
...
| 名称 | 描述 |
| --- | --- |
| [OpenGTX\_NetworkLatency](../OpenGTX_NetworkLatency/_open_g_t_x___network_latency.md) [networkLatency](_open_g_t_x___network_info.md#networklatency) | 游戏中的网络延迟。 如果没有上下行时延，则设置为total（总时延）的值。将游戏总时延以0ms、50ms、100ms、150ms、200ms分为5个档位，当档位发生变化时，游戏应用通知OpenGTX。 |
