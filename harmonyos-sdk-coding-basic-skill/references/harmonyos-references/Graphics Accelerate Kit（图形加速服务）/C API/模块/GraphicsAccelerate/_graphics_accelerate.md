...
scraped_at: 2026-06-11T16:40:43+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:3972a6aac2c867cf50dbc3e7cfac35046d558f06ba6300896ec4de86c974618f
---
## 概述
...
| 名称 | 描述 |
| --- | --- |
| [abr\_base.h](../../头文件和结构体/头文件/abr_base.h/abr__base_8h.md) | 声明不区分图形API平台的ABR（自适应稳态渲染）接口。 |
| [abr\_gles.h](../../头文件和结构体/头文件/abr_gles.h/abr__gles_8h.md) | 声明OpenGL ES图形API平台的ABR接口。 |
| [frame\_generation\_base.h](../../头文件和结构体/头文件/frame_generation_base.h/frame__generation__base_8h.md) | 声明不区分图形API平台的超帧接口。 |
| [frame\_generation\_gles.h](../../头文件和结构体/头文件/frame_generation_gles.h/frame__generation__gles_8h.md) | 声明OpenGL ES图形API平台的超帧接口。 |
| [frame\_generation\_vk.h](../../头文件和结构体/头文件/frame_generation_vk.h/frame__generation__vk_8h.md) | 声明Vulkan图形API平台的超帧接口。 |
| [opengtx\_base.h](../../头文件和结构体/头文件/opengtx_base.h/opengtx__base_8h.md) | 声明不区分OpenGL ES和Vulkan图形API平台的OpenGTX接口。 |
...
| 名称 | 描述 |
| --- | --- |
| struct [ABR\_Vector3](../../头文件和结构体/结构体/ABR_Vector3/_a_b_r___vector3.md) | 此结构体描述ABR三维向量。 |
| struct [ABR\_CameraData](../../头文件和结构体/结构体/ABR_CameraData/_a_b_r___camera_data.md) | 此结构体描述游戏应用每帧的相机运动数据，ABR会结合相机运动数据自适应调整FrameBuffer（帧缓冲，下文简称Buffer）分辨率因子。 |
| struct [FG\_Mat4x4](../../头文件和结构体/结构体/FG_Mat4x4/_f_g___mat4x4.md) | 此结构体描述列主序4x4矩阵。列主序是指在连续的线性内存地址中，优先按列遍历矩阵元素。 |
| struct [FG\_AlgorithmModeInfo](../../头文件和结构体/结构体/FG_AlgorithmModeInfo/_f_g___algorithm_mode_info.md) | 此结构体描述超帧算法模式信息。 |
| struct [FG\_Dimension2D](../../头文件和结构体/结构体/FG_Dimension2D/_f_g___dimension2_d.md) | 此结构体描述2D图像分辨率，以px为单位。 |
| struct [FG\_ResolutionInfo](../../头文件和结构体/结构体/FG_ResolutionInfo/_f_g___resolution_info.md) | 此结构体描述超帧输入输出图像的分辨率。 |
| struct [FG\_Vec3D](../../头文件和结构体/结构体/FG_Vec3D/_f_g___vec3_d.md) | 此结构体描述超帧三维向量。 |
| struct [FG\_PerFrameExtendedCameraInfo](../../头文件和结构体/结构体/FG_PerFrameExtendedCameraInfo/_f_g___per_frame_extended_camera_info.md) | 此结构体描述相机扩展信息。当视图投影矩阵的平移分量非常大时（超过十万），可以提供更加详细的相机信息以获得更加准确的超帧预测效果。 |
| struct [FG\_IntegrationInfo](../../头文件和结构体/结构体/FG_IntegrationInfo/_f_g___intergration_info.md) | 此结构体描述超帧集成的信息。包括送显模式，是否需要额外缓存深度和颜色纹理，以及是否需要翻转颜色纹理。仅在[FG\_PredictionMode](_graphics_accelerate.md#fg_predictionmode-1)为FG\_PREDICTION\_MODE\_INTERPOLATION时生效。 |
| struct [FG\_DispatchDescription\_GLES](../../头文件和结构体/结构体/FG_DispatchDescription_GLES/_f_g___dispatch_description___g_l_e_s.md) | 此结构体描述下发帧生成命令[HMS\_FG\_Dispatch\_GLES](_graphics_accelerate.md#hms_fg_dispatch_gles)需要的参数信息，每一帧都需要进行更新。该接口仅适配OpenGL ES图形API平台。 |
| struct [FG\_ContextDescription\_VK](../../头文件和结构体/结构体/FG_ContextDescription_VK/_f_g___context_description___v_k.md) | 此结构体描述创建超帧上下文实例[FG\_Context\_VK](_graphics_accelerate.md#fg_context_vk)所需的属性信息，该接口仅适配Vulkan图形API平台。 |
| struct [FG\_ImageFormat\_VK](../../头文件和结构体/结构体/FG_ImageFormat_VK/_f_g___image_format___v_k.md) | 此结构体描述超帧输入输出图像的格式信息，该接口仅适配Vulkan图形API平台。 |
| struct [FG\_ImageSync\_VK](../../头文件和结构体/结构体/FG_ImageSync_VK/_f_g___image_sync___v_k.md) | 此结构体描述超帧输入输出图像同步状态信息，用于创建超帧图像内存屏障。该接口仅适配Vulkan图形API平台。 |
| struct [FG\_ImageInfo\_VK](../../头文件和结构体/结构体/FG_ImageInfo_VK/_f_g___image_info___v_k.md) | 此结构体描述超帧输入输出图像信息，该接口仅适配Vulkan图形API平台。 |
| struct [FG\_DispatchDescription\_VK](../../头文件和结构体/结构体/FG_DispatchDescription_VK/_f_g___dispatch_description___v_k.md) | 此结构体描述下发帧生成命令[HMS\_FG\_Dispatch\_VK](_graphics_accelerate.md#hms_fg_dispatch_vk)需要的参数信息，每一帧都需要进行更新。该接口仅适配Vulkan图形API平台。 |
| struct [OpenGTX\_ConfigDescription](../../头文件和结构体/结构体/OpenGTX_ConfigDescription/_open_g_t_x___config_description.md) | 此结构体描述OpenGTX属性配置。 |
| struct [OpenGTX\_GameSceneInfo](../../头文件和结构体/结构体/OpenGTX_GameSceneInfo/_open_g_t_x___game_scene_info.md) | 此结构体描述游戏场景信息，游戏应用获取到场景后传递此参数。 |
| struct [OpenGTX\_FrameRenderInfo](../../头文件和结构体/结构体/OpenGTX_FrameRenderInfo/_open_g_t_x___frame_render_info.md) | 此结构体描述帧渲染信息，游戏应用获取到帧属性后传递此参数。该参数中的相机矩阵通常用于优化渲染层降负载方案的画质效果。 |
| struct [OpenGTX\_NetworkInfo](../../头文件和结构体/结构体/OpenGTX_NetworkInfo/_open_g_t_x___network_info.md) | 此结构体描述当前设备网络信息，游戏应用获取到网络信息后传递此参数。 |
| struct [OpenGTX\_ResolutionValue](../../头文件和结构体/结构体/OpenGTX_ResolutionValue/_open_g_t_x___resolution_value.md) | 此结构体描述游戏应用的分辨率值。 |
| struct [OpenGTX\_Vector3](../../头文件和结构体/结构体/OpenGTX_Vector3/_open_g_t_x___vector3.md) | 此结构体描述OpenGTX三维向量。 |
| struct [OpenGTX\_NetworkLatency](../../头文件和结构体/结构体/OpenGTX_NetworkLatency/_open_g_t_x___network_latency.md) | 此结构体描述当前设备网络延迟信息，游戏应用获取到网络延迟后传递此参数。该参数通常用于针对性优化网络延迟。 |
...
| typedef struct [ABR\_Vector3](../../头文件和结构体/结构体/ABR_Vector3/_a_b_r___vector3.md) [ABR\_Vector3](_graphics_accelerate.md#abr_vector3) | 此结构体描述ABR三维向量。 |
| typedef struct [ABR\_CameraData](../../头文件和结构体/结构体/ABR_CameraData/_a_b_r___camera_data.md) [ABR\_CameraData](_graphics_accelerate.md#abr_cameradata) | 此结构体描述游戏应用每帧的相机运动数据，ABR会结合相机运动数据自适应调整FrameBuffer（帧缓冲，下文简称Buffer）分辨率因子。 |
...
| typedef struct [FG\_Mat4x4](../../头文件和结构体/结构体/FG_Mat4x4/_f_g___mat4x4.md) [FG\_Mat4x4](_graphics_accelerate.md#fg_mat4x4) | 此结构体描述列主序4x4矩阵。列主序是指在连续的线性内存地址中，优先按列遍历矩阵元素。 |
...
| typedef struct [FG\_AlgorithmModeInfo](../../头文件和结构体/结构体/FG_AlgorithmModeInfo/_f_g___algorithm_mode_info.md) [FG\_AlgorithmModeInfo](_graphics_accelerate.md#fg_algorithmmodeinfo) | 此结构体描述超帧算法模式信息。 |
| typedef struct [FG\_Vec3D](../../头文件和结构体/结构体/FG_Vec3D/_f_g___vec3_d.md) [FG\_Vec3D](../../头文件和结构体/结构体/FG_Vec3D/_f_g___vec3_d.md) | 此结构体描述超帧三维向量。 |
| typedef struct [FG\_PerFrameExtendedCameraInfo](../../头文件和结构体/结构体/FG_PerFrameExtendedCameraInfo/_f_g___per_frame_extended_camera_info.md) [FG\_PerFrameExtendedCameraInfo](../../头文件和结构体/结构体/FG_PerFrameExtendedCameraInfo/_f_g___per_frame_extended_camera_info.md) | 此结构体描述相机扩展信息。当视图投影矩阵的平移分量非常大时（超过十万），可以提供更加详细的相机信息以获得更加准确的超帧预测效果。 |
| typedef struct [FG\_IntegrationInfo](../../头文件和结构体/结构体/FG_IntegrationInfo/_f_g___intergration_info.md) | 此结构体描述超帧集成的信息。包括送显模式，是否需要额外缓存深度和颜色纹理，以及是否需要翻转颜色纹理。仅在[FG\_PredictionMode](_graphics_accelerate.md#fg_predictionmode-1)为FG\_PREDICTION\_MODE\_INTERPOLATION时生效。 |
...
| typedef struct [FG\_Dimension2D](../../头文件和结构体/结构体/FG_Dimension2D/_f_g___dimension2_d.md) [FG\_Dimension2D](_graphics_accelerate.md#fg_dimension2d) | 此结构体描述2D图像分辨率，以px为单位。 |
| typedef struct [FG\_ResolutionInfo](../../头文件和结构体/结构体/FG_ResolutionInfo/_f_g___resolution_info.md) [FG\_ResolutionInfo](_graphics_accelerate.md#fg_resolutioninfo) | 此结构体描述超帧输入输出图像的分辨率。 |
...
| typedef struct [FG\_DispatchDescription\_GLES](../../头文件和结构体/结构体/FG_DispatchDescription_GLES/_f_g___dispatch_description___g_l_e_s.md) [FG\_DispatchDescription\_GLES](_graphics_accelerate.md#fg_dispatchdescription_gles) | 此结构体描述下发帧生成命令[HMS\_FG\_Dispatch\_GLES](_graphics_accelerate.md#hms_fg_dispatch_gles)需要的参数信息，每一帧都需要进行更新。该接口仅适配OpenGL ES图形API平台。 |
...
| typedef struct [FG\_ContextDescription\_VK](../../头文件和结构体/结构体/FG_ContextDescription_VK/_f_g___context_description___v_k.md) [FG\_ContextDescription\_VK](_graphics_accelerate.md#fg_contextdescription_vk) | 此结构体描述创建超帧上下文实例[FG\_Context\_VK](_graphics_accelerate.md#fg_context_vk)所需的属性信息，该接口仅适配Vulkan图形API平台。 |
| typedef struct [FG\_ImageFormat\_VK](../../头文件和结构体/结构体/FG_ImageFormat_VK/_f_g___image_format___v_k.md) [FG\_ImageFormat\_VK](_graphics_accelerate.md#fg_imageformat_vk) | 此结构体描述超帧输入输出图像的格式信息，该接口仅适配Vulkan图形API平台。 |
| typedef struct [FG\_ImageSync\_VK](../../头文件和结构体/结构体/FG_ImageSync_VK/_f_g___image_sync___v_k.md) [FG\_ImageSync\_VK](_graphics_accelerate.md#fg_imagesync_vk) | 此结构体描述超帧输入输出图像同步状态信息，用于创建超帧图像内存屏障。该接口仅适配Vulkan图形API平台。 |
| typedef struct [FG\_ImageInfo\_VK](../../头文件和结构体/结构体/FG_ImageInfo_VK/_f_g___image_info___v_k.md) [FG\_ImageInfo\_VK](_graphics_accelerate.md#fg_imageinfo_vk) | 此结构体描述超帧输入输出图像信息，该接口仅适配Vulkan图形API平台。 |
| typedef struct [FG\_DispatchDescription\_VK](../../头文件和结构体/结构体/FG_DispatchDescription_VK/_f_g___dispatch_description___v_k.md) [FG\_DispatchDescription\_VK](_graphics_accelerate.md#fg_dispatchdescription_vk) | 此结构体描述下发帧生成命令[HMS\_FG\_Dispatch\_VK](_graphics_accelerate.md#hms_fg_dispatch_vk)需要的参数信息，每一帧都需要进行更新。该接口仅适配Vulkan图形API平台。 |
...
| typedef struct [OpenGTX\_ConfigDescription](../../头文件和结构体/结构体/OpenGTX_ConfigDescription/_open_g_t_x___config_description.md) [OpenGTX\_ConfigDescription](_graphics_accelerate.md#opengtx_configdescription) | 此结构体描述OpenGTX属性配置。 |
| typedef struct [OpenGTX\_GameSceneInfo](../../头文件和结构体/结构体/OpenGTX_GameSceneInfo/_open_g_t_x___game_scene_info.md) [OpenGTX\_GameSceneInfo](_graphics_accelerate.md#opengtx_gamesceneinfo) | 此结构体描述游戏场景信息，游戏应用获取到场景后传递此参数。 |
| typedef struct [OpenGTX\_FrameRenderInfo](../../头文件和结构体/结构体/OpenGTX_FrameRenderInfo/_open_g_t_x___frame_render_info.md) [OpenGTX\_FrameRenderInfo](_graphics_accelerate.md#opengtx_framerenderinfo) | 此结构体描述帧渲染信息，游戏应用获取到帧属性后传递此参数。该参数中的相机矩阵通常用于优化渲染层降负载方案的画质效果。 |
| typedef struct [OpenGTX\_NetworkInfo](../../头文件和结构体/结构体/OpenGTX_NetworkInfo/_open_g_t_x___network_info.md) [OpenGTX\_NetworkInfo](_graphics_accelerate.md#opengtx_networkinfo) | 此结构体描述当前设备网络信息，游戏应用获取到网络信息后传递此参数。 |
| typedef struct [OpenGTX\_ResolutionValue](../../头文件和结构体/结构体/OpenGTX_ResolutionValue/_open_g_t_x___resolution_value.md) [OpenGTX\_ResolutionValue](_graphics_accelerate.md#opengtx_resolutionvalue) | 此结构体描述游戏应用的分辨率值。 |
| typedef struct [OpenGTX\_Vector3](../../头文件和结构体/结构体/OpenGTX_Vector3/_open_g_t_x___vector3.md) [OpenGTX\_Vector3](_graphics_accelerate.md#opengtx_vector3) | 此结构体描述OpenGTX三维向量。 |
| typedef struct [OpenGTX\_NetworkLatency](../../头文件和结构体/结构体/OpenGTX_NetworkLatency/_open_g_t_x___network_latency.md) [OpenGTX\_NetworkLatency](_graphics_accelerate.md#opengtx_networklatency) | 此结构体描述当前设备网络延迟信息，游戏应用获取到网络延迟后传递此参数。该参数通常用于针对性优化网络延迟。 |
...
| [FG\_ErrorCode](_graphics_accelerate.md#fg_errorcode-1) [HMS\_FG\_SetAlgorithmMode\_GLES](_graphics_accelerate.md#hms_fg_setalgorithmmode_gles)([FG\_Context\_GLES](_graphics_accelerate.md#fg_context_gles)\* context, const [FG\_AlgorithmModeInfo](../../头文件和结构体/结构体/FG_AlgorithmModeInfo/_f_g___algorithm_mode_info.md)\* predictionModeInfo) | 设置超帧预测算法模式和运动估计模式，必选。该接口仅适配OpenGL ES图形API平台。 |
| [FG\_ErrorCode](_graphics_accelerate.md#fg_errorcode-1) [HMS\_FG\_SetResolution\_GLES](_graphics_accelerate.md#hms_fg_setresolution_gles)([FG\_Context\_GLES](_graphics_accelerate.md#fg_context_gles)\* context, const [FG\_ResolutionInfo](../../头文件和结构体/结构体/FG_ResolutionInfo/_f_g___resolution_info.md)\* resolutionInfo) | 设置超帧输入输出图像分辨率，必选。该接口仅适配OpenGL ES图形API平台。 |
...
| [FG\_ErrorCode](_graphics_accelerate.md#fg_errorcode-1) [HMS\_FG\_Dispatch\_GLES](_graphics_accelerate.md#hms_fg_dispatch_gles)([FG\_Context\_GLES](_graphics_accelerate.md#fg_context_gles)\* context, const [FG\_DispatchDescription\_GLES](../../头文件和结构体/结构体/FG_DispatchDescription_GLES/_f_g___dispatch_description___g_l_e_s.md)\* desc) | 配置帧预测所需的参数信息，生成预测帧，当前处于激活状态时有效，该接口仅适配OpenGL ES图形API平台。 |
| [FG\_ErrorCode](_graphics_accelerate.md#fg_errorcode-1) [HMS\_FG\_SetExtendedCameraInfo\_GLES](_graphics_accelerate.md#hms_fg_setextendedcamerainfo_gles)([FG\_Context\_GLES](_graphics_accelerate.md#fg_context_gles)\* context, const [FG\_PerFrameExtendedCameraInfo](../../头文件和结构体/结构体/FG_PerFrameExtendedCameraInfo/_f_g___per_frame_extended_camera_info.md)\* info) | 设置超帧相机扩展属性信息，当视图投影矩阵的平移分量非常大时，提供该信息以获得更加准确的超帧效果。可选调用，该接口仅适配OpenGL ES图形API平台。 |
...
| [FG\_ErrorCode](_graphics_accelerate.md#fg_errorcode-1) [HMS\_FG\_SetIntegrationMode\_GLES](_graphics_accelerate.md#hms_fg_setintegrationmode_gles)([FG\_Context\_GLES](_graphics_accelerate.md#fg_context_gles)\* context, const [FG\_IntegrationInfo](../../头文件和结构体/结构体/FG_IntegrationInfo/_f_g___intergration_info.md)\* integrationInfo) | 设置超帧预测的集成信息，当[FG\_PredictionMode](_graphics_accelerate.md#fg_predictionmode-1)为FG\_PREDICTION\_MODE\_INTERPOLATION时，[FG\_IntegrationInfo](../../头文件和结构体/结构体/FG_IntegrationInfo/_f_g___intergration_info.md)中的presentMode、textureCachedByGame、needFlipInputColor、needFlipOutputColor成员才会生效。其他情况下这些参数应忽略或设置为默认值。该接口仅适配OpenGL ES图形API平台。 |
...
| [FG\_Context\_VK](_graphics_accelerate.md#fg_context_vk)\* [HMS\_FG\_CreateContext\_VK](_graphics_accelerate.md#hms_fg_createcontext_vk)(const [FG\_ContextDescription\_VK](../../头文件和结构体/结构体/FG_ContextDescription_VK/_f_g___context_description___v_k.md)\* contextDescription) | 创建超帧上下文实例，调用成功则返回指向[FG\_Context\_VK](_graphics_accelerate.md#fg_context_vk)对象的指针，失败返回nullptr。该接口仅适配Vulkan图形API平台。 |
| [FG\_ErrorCode](_graphics_accelerate.md#fg_errorcode-1) [HMS\_FG\_SetAlgorithmMode\_VK](_graphics_accelerate.md#hms_fg_setalgorithmmode_vk)([FG\_Context\_VK](_graphics_accelerate.md#fg_context_vk)\* context, const [FG\_AlgorithmModeInfo](../../头文件和结构体/结构体/FG_AlgorithmModeInfo/_f_g___algorithm_mode_info.md)\* predictionModeInfo) | 设置超帧算法模式，包括预测算法模式和运动估计模式，必选。该接口仅适配Vulkan图形API平台。 |
| [FG\_ErrorCode](_graphics_accelerate.md#fg_errorcode-1) [HMS\_FG\_SetResolution\_VK](_graphics_accelerate.md#hms_fg_setresolution_vk)([FG\_Context\_VK](_graphics_accelerate.md#fg_context_vk)\* context, const [FG\_ResolutionInfo](../../头文件和结构体/结构体/FG_ResolutionInfo/_f_g___resolution_info.md)\* resolutionInfo) | 设置超帧输入输出图像分辨率，必选。该接口仅适配Vulkan图形API平台。 |
...
| [FG\_ErrorCode](_graphics_accelerate.md#fg_errorcode-1) [HMS\_FG\_Dispatch\_VK](_graphics_accelerate.md#hms_fg_dispatch_vk)([FG\_Context\_VK](_graphics_accelerate.md#fg_context_vk)\* context, const [FG\_DispatchDescription\_VK](../../头文件和结构体/结构体/FG_DispatchDescription_VK/_f_g___dispatch_description___v_k.md)\* desc) | 配置帧预测所需的参数信息，生成预测帧，当前处于激活状态时有效，该接口仅适配Vulkan图形API平台。 |
...
| --- | --- |
| context | 已创建的ABR上下文实例，即指向[ABR\_Context](_graphics_accelerate.md#abr_context)实例的指针，非空，否则返回失败。 |
| data | 游戏应用每帧的相机运动数据，即指向ABR相机运动数据[ABR\_CameraData](../../头文件和结构体/结构体/ABR_CameraData/_a_b_r___camera_data.md)的指针，非空，否则返回失败。 |
...
| 名称 | 描述 |
| --- | --- |
| contextDescription | 指向创建超帧上下文实例所需属性信息结构体[FG\_ContextDescription\_VK](../../头文件和结构体/结构体/FG_ContextDescription_VK/_f_g___context_description___v_k.md)对象的指针，不允许为空。 |
...
| --- | --- |
| context | 已创建的超帧上下文实例，即指向[FG\_Context\_GLES](_graphics_accelerate.md#fg_context_gles)对象的指针，不允许为空。 |
| desc | 下发帧生成命令的参数结构体[FG\_DispatchDescription\_GLES](../../头文件和结构体/结构体/FG_DispatchDescription_GLES/_f_g___dispatch_description___g_l_e_s.md)的指针，不允许为空，需每帧更新。 |
...
| --- | --- |
| context | 已创建的超帧上下文实例，即指向[FG\_Context\_GLES](_graphics_accelerate.md#fg_context_gles)对象的指针，不允许为空。 |
| info | 指向相机扩展信息结构体[FG\_PerFrameExtendedCameraInfo](../../头文件和结构体/结构体/FG_PerFrameExtendedCameraInfo/_f_g___per_frame_extended_camera_info.md)对象的指针，不允许为空。 |
...
| --- | --- |
| context | 已创建的超帧上下文实例，即指向[FG\_Context\_VK](_graphics_accelerate.md#fg_context_vk)对象的指针，不允许为空。 |
| desc | 下发帧生成命令的参数结构体[FG\_DispatchDescription\_VK](../../头文件和结构体/结构体/FG_DispatchDescription_VK/_f_g___dispatch_description___v_k.md)的指针，不允许为空，需每帧更新。 |
...
| --- | --- |
| context | 已创建的超帧上下文实例，即指向[FG\_Context\_GLES](_graphics_accelerate.md#fg_context_gles)对象的指针，不允许为空。 |
| predictionModeInfo | 指向超帧算法模式结构体[FG\_AlgorithmModeInfo](../../头文件和结构体/结构体/FG_AlgorithmModeInfo/_f_g___algorithm_mode_info.md)对象的指针，不允许为空。 |
...
| --- | --- |
| context | 已创建的超帧上下文实例，即指向[FG\_Context\_VK](_graphics_accelerate.md#fg_context_vk)对象的指针，不允许为空。 |
| format | 指向超帧输入输出图像格式结构体[FG\_ImageFormat\_VK](../../头文件和结构体/结构体/FG_ImageFormat_VK/_f_g___image_format___v_k.md)对象的指针，不允许为空。 |
...
| --- | --- |
| context | 已创建的超帧上下文实例，即指向[FG\_Context\_GLES](_graphics_accelerate.md#fg_context_gles)对象的指针，不允许为空。 |
| resolutionInfo | 指向超帧输入输出图像分辨率结构体[FG\_ResolutionInfo](../../头文件和结构体/结构体/FG_ResolutionInfo/_f_g___resolution_info.md)对象的指针，不允许为空。 |
...
设置超帧预测的集成信息，当[FG\_PredictionMode](_graphics_accelerate.md#fg_predictionmode-1)为FG\_PREDICTION\_MODE\_INTERPOLATION时，[FG\_IntegrationInfo](../../头文件和结构体/结构体/FG_IntegrationInfo/_f_g___intergration_info.md)中的presentMode、textureCachedByGame、needFlipInputColor、needFlipOutputColor成员才会生效。其他情况下这些参数应忽略或设置为默认值。该接口仅适配OpenGL ES图形API平台。
...
| --- | --- |
| context | 已创建的超帧上下文实例，即指向[FG\_Context\_GLES](_graphics_accelerate.md#fg_context_gles)对象的指针，不允许为空。 |
| integrationInfo | 指向超帧集成信息的结构体[FG\_IntegrationInfo](../../头文件和结构体/结构体/FG_IntegrationInfo/_f_g___intergration_info.md)对象的指针，不允许为空。 |
...
| --- | --- |
| context | 已创建的OpenGTX上下文实例，即指向[OpenGTX\_Context](_graphics_accelerate.md#opengtx_context)实例的指针；非空，否则返回失败。 |
| frameRenderInfo | 帧渲染信息结构，即指向OpenGTX每帧渲染信息结构体[OpenGTX\_FrameRenderInfo](../../头文件和结构体/结构体/OpenGTX_FrameRenderInfo/_open_g_t_x___frame_render_info.md)的指针；非空，否则返回失败。 |
...
| --- | --- |
| context | 已创建的OpenGTX上下文实例，即指向[OpenGTX\_Context](_graphics_accelerate.md#opengtx_context)实例的指针；非空，否则返回失败。 |
| gameSceneInfo | 游戏场景信息，即指向OpenGTX场景信息结构体[OpenGTX\_GameSceneInfo](../../头文件和结构体/结构体/OpenGTX_GameSceneInfo/_open_g_t_x___game_scene_info.md)的指针；非空，否则返回失败。 |
...
| --- | --- |
| context | 已创建的OpenGTX上下文实例，即指向[OpenGTX\_Context](_graphics_accelerate.md#opengtx_context)实例的指针；非空，否则返回失败。 |
| networkInfo | 网络信息，即指向OpenGTX网络信息结构体[OpenGTX\_NetworkInfo](../../头文件和结构体/结构体/OpenGTX_NetworkInfo/_open_g_t_x___network_info.md)的指针；非空，否则返回失败。 |
...
| --- | --- |
| context | 已创建的OpenGTX上下文实例，即指向[OpenGTX\_Context](_graphics_accelerate.md#opengtx_context)实例的指针；非空，否则返回失败。 |
| config | OpenGTX上下文实例的初始化参数，即指向OpenGTX配置数据[OpenGTX\_ConfigDescription](../../头文件和结构体/结构体/OpenGTX_ConfigDescription/_open_g_t_x___config_description.md)的指针；非空，否则返回失败。 |
