...
scraped_at: 2026-06-01T16:34:19+08:00
doc_updated_at: 2026-05-12
content_hash: sha256:e15618fca847dadb0f7cfc362ac6098ddc52ef98c3c21fe4a58f27b7b5f6cffe
---
## 功能介绍
...
若需要解绑游戏官方账号与华为teamPlayerId的绑定关系，客户端侧可以调用[unbindPlayer](<../../ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunbindplayer>)接口实现，服务端可以调用本接口实现。
...
| teamPlayerId | 是 | String | HarmonyOS 5.0及以上游戏的玩家标识，通过调用[unionLogin](<../../ArkTS API/gamePlayer（基础游戏服务）/gameservice-gameplayer.md#gameplayerunionlogin>)接口返回，  最大长度256个字符。 |
...
4. 将待签名字符串使用游戏私钥按照RSA算法（SHA256WithRSA/PSS）进行签名，将签名后的字符串经过Base64编码，得到的字符串即为签名字符串。
   ...
   * 游戏私钥获取请参见[获取游戏密钥](<../../../../harmonyos-guides/应用服务/Game Service Kit（游戏服务）/附录/获取游戏密钥/gameservice-key.md>)。
