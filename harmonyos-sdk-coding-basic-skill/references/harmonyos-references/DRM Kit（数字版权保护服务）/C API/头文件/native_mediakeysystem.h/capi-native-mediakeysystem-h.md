...
scraped_at: 2026-06-01T16:21:45+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:32cd4eb20a6893eac422dff950f76dae161430bd6ca2926d312174b4dfc0ce92
---
## 概述
...
| [bool OH\_MediaKeySystem\_IsSupported2(const char \*name, const char \*mimeType)](capi-native-mediakeysystem-h.md#oh_mediakeysystem_issupported2) | - | 查询设备是否支持对应的DRM解决方案名称及媒体类型。可通过[OH\_MediaKeySystem\_IsSupported](capi-native-mediakeysystem-h.md#oh_mediakeysystem_issupported)接口先确认name参数对应的DRM解决方案是否是设备支持的。 |
...
| 参数项 | 描述 |
| --- | --- |
| [DRM\_EventType](../native_drm_common.h/capi-native-drm-common-h.md#drm_eventtype) eventType | 事件类型。 |
| uint8\_t \*info | 事件信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [MediaKeySystem](../../结构体/MediaKeySystem/capi-drm-mediakeysystem.md) \*mediaKeySystem | MediaKeySystem实例。 |
| [DRM\_EventType](../native_drm_common.h/capi-native-drm-common-h.md#drm_eventtype) eventType | 事件类型。 |
| uint8\_t \*info | 事件信息。 |
| int32\_t infoLen | 事件信息长度。 |
| char \*extra | 增量信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [DRM\_MediaKeySystemDescription](../../结构体/DRM_MediaKeySystemDescription/capi-drm-drm-mediakeysystemdescription.md) \*descs | DRM解决方案名称和唯一标识的列表。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：可能原因：  1.输入参数descs为空指针或输入参数count为空指针。  2.输入参数descs长度不足。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| const char \*name | 输入参数，DRM解决方案名称。可通过[OH\_MediaKeySystem\_GetMediaKeySystems](capi-native-mediakeysystem-h.md#oh_mediakeysystem_getmediakeysystems)接口获取设备支持的DRM解决方案名称。示例："com.wiseplay.drm"。 |
...
查询设备是否支持对应的DRM解决方案名称及媒体类型。可通过[OH\_MediaKeySystem\_IsSupported](capi-native-mediakeysystem-h.md#oh_mediakeysystem_issupported)接口先确认name参数对应的DRM解决方案是否是设备支持的。
...
| 参数项 | 描述 |
| --- | --- |
| const char \*name | 输入参数，DRM解决方案名称。可通过[OH\_MediaKeySystem\_GetMediaKeySystems](capi-native-mediakeysystem-h.md#oh_mediakeysystem_getmediakeysystems)接口获取设备支持的DRM解决方案名称。 |
...
| const char \*name | 输入参数，DRM解决方案名称。可通过[OH\_MediaKeySystem\_GetMediaKeySystems](capi-native-mediakeysystem-h.md#oh_mediakeysystem_getmediakeysystems)接口获取设备支持的DRM解决方案名称。 |
| const char \*mimeType | 输入参数，媒体类型，支持的媒体类型取决于DRM解决方案，如：video/avc、video/hevc。 |
| [DRM\_ContentProtectionLevel](../native_drm_common.h/capi-native-drm-common-h.md#drm_contentprotectionlevel) contentProtectionLevel | 输入参数，内容保护级别。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：可能原因：  1.输入参数name为空指针或长度为0。  2.输入参数mediaKeySystem为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。  DRM\_ERR\_SERVICE\_DIED：服务死亡。  DRM\_ERR\_MAX\_SYSTEM\_NUM\_REACHED：已创建的MediaKeySystem数量达到最大限制(64个)。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，输入参数configName为空指针，或输入参数value为空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，输入参数configName为空指针，或输入参数value为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，输入参数configName为空指针，输入参数value为空指针，或valueLen为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| --- | --- |
| [MediaKeySystem](../../结构体/MediaKeySystem/capi-drm-mediakeysystem.md) \*mediaKeySystem | MediaKeySystem实例。 |
| [DRM\_Statistics](../../结构体/DRM_Statistics/capi-drm-drm-statistics.md) \*statistics | 度量记录。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数statistics为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| --- | --- |
| [MediaKeySystem](../../结构体/MediaKeySystem/capi-drm-mediakeysystem.md) \*mediaKeySystem | MediaKeySystem实例。 |
| [DRM\_ContentProtectionLevel](../native_drm_common.h/capi-native-drm-common-h.md#drm_contentprotectionlevel) \*contentProtectionLevel | 内容保护级别。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数contentProtectionLevel为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或其它指针类型输入参数为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数response为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| --- | --- |
| [MediaKeySystem](../../结构体/MediaKeySystem/capi-drm-mediakeysystem.md) \*mediaKeySystem | MediaKeySystem实例。 |
| [DRM\_OfflineMediakeyIdArray](../../结构体/DRM_OfflineMediakeyIdArray/capi-drm-drm-offlinemediakeyidarray.md) \*offlineMediaKeyIds | 离线媒体密钥的媒体密钥标识列表。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_NO\_MEMORY：内存不足，内存分配失败。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数offlineMediaKeyIds为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| [DRM\_OfflineMediaKeyStatus](../native_drm_common.h/capi-native-drm-common-h.md#drm_offlinemediakeystatus) \*status | 媒体密钥状态。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或其它指针类型输入参数为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数offlineMediaKeyId为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| --- | --- |
| [MediaKeySystem](../../结构体/MediaKeySystem/capi-drm-mediakeysystem.md) \*mediaKeySystem | MediaKeySystem实例。 |
| [DRM\_CertificateStatus](../native_drm_common.h/capi-native-drm-common-h.md#drm_certificatestatus) \*certStatus | 设备DRM证书状态值。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效，或输入参数certStatus为空指针。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Drm\_ErrCode](../native_drm_err.h/capi-native-drm-err-h.md#drm_errcode) | DRM\_ERR\_OK：执行成功。  DRM\_ERR\_INVALID\_VAL：输入参数mediaKeySystem为空指针或无效。  DRM\_ERR\_UNKNOWN：发生内部错误，请查看日志详细信息。 |
