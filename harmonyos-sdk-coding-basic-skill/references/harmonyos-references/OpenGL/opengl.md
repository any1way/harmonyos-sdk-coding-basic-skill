...
scraped_at: 2026-06-01T16:42:34+08:00
doc_updated_at: 2026-03-26
content_hash: sha256:82125e75207f0b711116854cbede7a5dd8c9cdcb35edd4cce9c51415c88505dc
---
...
[native api中导出的OpenGL符号列表](../附录/OpenGL符号列表/opengl-symbol.md)

## OpenGL扩展接口及示例

OpenGL扩展接口及使用，可参考[OpenGL ES扩展接口](<../OpenGL ES/opengles.md#opengl-es扩展接口>)。

相关接口使用示例，可参考[OpenGL ES简单示例](<../OpenGL ES/opengles.md#简单示例>)。
...
* [NDK开发参考](../../harmonyos-guides/NDK开发/NDK开发导读/ndk-development-overview.md)
* [Node-API参考](../Node-API/napi.md)
* [XComponentNode参考](<../ArkUI（方舟UI框架）/ArkTS API/已停止维护的接口/XComponentNode/js-apis-arkui-xcomponentnode.md>)
* [XComponent参考](../ArkUI（方舟UI框架）/ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)
