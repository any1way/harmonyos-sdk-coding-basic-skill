...
scraped_at: 2026-06-01T16:38:48+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:4f9f8be90b8ef2777ad66c1d494a2b38d1713e970eadc7e2b6852d8ea528e1ba
---
...
通用错误码的详细介绍请参见和[模块错误码](<../ArkTS API错误码/preview-arkts-errcode.md>)。
...
当前支持加速的文件类型见[文件打开加速支持的文件类型](<../../../../harmonyos-guides/应用服务/Preview Kit（文件预览服务）/Preview Kit简介/preview-introduction.md#文件打开加速支持的文件类型>)，不支持的文件类型默认为未预加载状态，不需要调用该接口监听文件预加载状态变更。
