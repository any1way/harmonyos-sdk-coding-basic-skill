...
content_hash: sha256:034270f42cd285d3cc3fa38a5df760ecbe838b1c2dceccab31da556b6a68b334
---
说明
...
请更换[实况窗id](../liveViewManager/liveview-liveviewmanager.md#liveview)。
...
1. 检查[创建实况窗](../liveViewManager/liveview-liveviewmanager.md#liveviewmanagerstartliveview)是否成功。
2. 若创建成功，检查端侧通知中心实况窗是否存在。若不存在，请停止调用此[实况窗id](../liveViewManager/liveview-liveviewmanager.md#liveview)的接口。
...
当应用调用[liveViewManager.stopLiveView](../liveViewManager/liveview-liveviewmanager.md#liveviewmanagerstopliveview)函数结束实况窗后，在应用设置的keepTime内实况窗仍保留在通知中心。此时调用[liveViewManager.updateLiveView](../liveViewManager/liveview-liveviewmanager.md#liveviewmanagerupdateliveview)或[liveViewManager.stopLiveView](../liveViewManager/liveview-liveviewmanager.md#liveviewmanagerstopliveview)更新或结束同一id的实况窗。

**处理步骤**

应用调用[liveViewManager.stopLiveView](../liveViewManager/liveview-liveviewmanager.md#liveviewmanagerstopliveview)结束实况窗并设置keepTime，实况窗保留在通知中心期间，请勿复用该[实况窗id](../liveViewManager/liveview-liveviewmanager.md#liveview)调用更新、结束接口。
...
请修改序列号[sequence](../liveViewManager/liveview-liveviewmanager.md#liveview)后重新更新或结束实况窗。
