...
scraped_at: 2026-06-01T16:19:20+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:7a5870ceb101bef8527428ce6b8ef98c2bb77fb4c8f2a0b376a7c3f554c2c89d
---
说明
...
| 类型 | 说明 |
| --- | --- |
| Promise<[MediaTab](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#mediatab>)[]> | Promise对象，返回媒体标签页的集合。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [QueryMediaEntityParam](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#querymediaentityparam>) | 是 | 查询媒体实例的参数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PageMediaEntity](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#pagemediaentity>)> | Promise对象，返回查询的合集媒体实体对象。 |
...
| --- | --- | --- | --- |
| pageIndex | number | 是 | 页面的索引。 |
| sort | [Sort](../Enums/arkts-apis-avmusictemplate-e.md#sort) | 是 | 排序的枚举值。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Single](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#single>)> | Promise对象，返回Single对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Compilation](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#compilation>)[]> | Promise对象，返回与关键字相关的合集数组。 |
...
| searchType | [EntityType](../Enums/arkts-apis-avmusictemplate-e.md#entitytype) | 是 | 要搜索的媒体资源类型。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PageMediaEntity](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#pagemediaentity>)> | Promise对象，返回关键字相关的媒体实体的分页对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[MediaEntity](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#mediaentity>)[]> | Promise对象，返回推荐的媒体实例的数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[OperResult](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#operresult>)> | Promise对象，返回清除搜索历史的操作结果的对象。 |
...
| actionInfo | [DialogActionInfo](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#dialogactioninfo>) | 否 | 对话框动作结果的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| memberPurchaseType | [MemberPurchaseType](../Enums/arkts-apis-avmusictemplate-e.md#memberpurchasetype) | 是 | 购买会员的类型。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[MemberPurchaseInfo](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#memberpurchaseinfo>)[]> | Promise对象，返回会员购买信息的数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[CustomElement](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#customelement>)> | Promise对象，返回我的页面的自定义元素。 |
...
| mediaEntity | [MediaEntity](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#mediaentity>) | 是 | 媒体实例。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[OperResult](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#operresult>)> | Promise对象，返回下载媒体实体的操作结果对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| settingItem | [SettingItem](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#settingitem>) | 是 | 设置项。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[SettingItem](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#settingitem>)> | Promise对象，返回变更过的设置项。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[OperResult](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#operresult>)> | Promise对象，返回问题和建议的操作结果对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| command | [SearchPlayInfoType](../Enums/arkts-apis-avmusictemplate-e.md#searchplayinfotype) | 是 | 搜播信息的类型。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[OperResult](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#operresult>)> | Promise对象，返回搜播的操作结果对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mediaEntity | [MediaEntity](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#mediaentity>) | 是 | 需要播放的媒体实体。 |
...
| buttonInfo | [DialogInfo](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#dialoginfo>) | 是 | 对话框信息。 |
...
| --- | --- | --- | --- |
| tabId | string | 是 | 标签页的ID。 |
| tabContent | [MediaTabContent](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#mediatabcontent>) | 是 | 标签页的内容。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [WantAgent](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantAgent (WantAgent模块)/js-apis-app-ability-wantagent.md#wantagent>) | 是 | 媒体应用页面启动信息。 |
