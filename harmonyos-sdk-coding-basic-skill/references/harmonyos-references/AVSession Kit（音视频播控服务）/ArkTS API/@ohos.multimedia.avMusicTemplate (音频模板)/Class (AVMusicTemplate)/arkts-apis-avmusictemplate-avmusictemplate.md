...
scraped_at: 2026-06-01T16:19:16+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:e6ad064d0ac870d06547ecfa084f63b473c7a1313de937c55485e0d6fb37eb1a
---
调用[avMusicTemplate.createAVMusicTemplate](../Functions/arkts-apis-avmusictemplate-f.md#avmusictemplatecreateavmusictemplate)获取实例后，可获取其ID，启动音频模板界面，并配置数据获取方法。随后，同步数据给模板控制方，以完成后续操作。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[OperResult](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#operresult>)> | Promise对象，返回启动音频模板界面的操作结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMainTabsEvent](../Types/arkts-apis-avmusictemplate-t.md#querymaintabsevent) | 是 | 回调函数，返回查询主标签事件。 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)和[音频模板错误码](../../../错误码/音频模板错误码/errorcode-avmusictemplate.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMainTabsEvent](../Types/arkts-apis-avmusictemplate-t.md#querymaintabsevent) | 否 | 查询主标签事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMediaTabContentEvent](../Types/arkts-apis-avmusictemplate-t.md#querymediatabcontentevent) | 是 | 回调函数，返回查询媒体标签页内容的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMediaTabContentEvent](../Types/arkts-apis-avmusictemplate-t.md#querymediatabcontentevent) | 否 | 查询媒体标签页内容的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMediaEntityEvent](../Types/arkts-apis-avmusictemplate-t.md#querymediaentityevent) | 是 | 回调函数，返回查询媒体实体的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMediaEntityEvent](../Types/arkts-apis-avmusictemplate-t.md#querymediaentityevent) | 否 | 查询媒体实体的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCompilationEvent](../Types/arkts-apis-avmusictemplate-t.md#querycompilationevent) | 是 | 回调函数，返回查询合集的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCompilationEvent](../Types/arkts-apis-avmusictemplate-t.md#querycompilationevent) | 否 | 查询合集的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryPlaylistEvent](../Types/arkts-apis-avmusictemplate-t.md#queryplaylistevent) | 是 | 回调函数，返回查询播放列表的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryPlaylistEvent](../Types/arkts-apis-avmusictemplate-t.md#queryplaylistevent) | 否 | 查询播放列表的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCurrentSingleEvent](../Types/arkts-apis-avmusictemplate-t.md#querycurrentsingleevent) | 是 | 回调函数，返回查询当前单曲的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCurrentSingleEvent](../Types/arkts-apis-avmusictemplate-t.md#querycurrentsingleevent) | 否 | 查询当前单曲的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCompilationByKeywordEvent](../Types/arkts-apis-avmusictemplate-t.md#querycompilationbykeywordevent) | 是 | 回调函数，返回按关键字查询合集的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCompilationByKeywordEvent](../Types/arkts-apis-avmusictemplate-t.md#querycompilationbykeywordevent) | 否 | 按关键字查询合集的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMediaEntityByKeywordEvent](../Types/arkts-apis-avmusictemplate-t.md#querymediaentitybykeywordevent) | 是 | 回调函数，返回按关键字查询媒体实体的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMediaEntityByKeywordEvent](../Types/arkts-apis-avmusictemplate-t.md#querymediaentitybykeywordevent) | 否 | 按关键字查询媒体实体的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryRecommendMediaEntityListEvent](../Types/arkts-apis-avmusictemplate-t.md#queryrecommendmediaentitylistevent) | 是 | 回调函数，返回查询推荐媒体列表的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryRecommendMediaEntityListEvent](../Types/arkts-apis-avmusictemplate-t.md#queryrecommendmediaentitylistevent) | 否 | 查询推荐媒体列表的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryHotWordsEvent](../Types/arkts-apis-avmusictemplate-t.md#queryhotwordsevent) | 是 | 回调函数，返回查询热词的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryHotWordsEvent](../Types/arkts-apis-avmusictemplate-t.md#queryhotwordsevent) | 否 | 查询热词的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QuerySearchHistoryEvent](../Types/arkts-apis-avmusictemplate-t.md#querysearchhistoryevent) | 是 | 回调函数，返回查询搜索历史的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QuerySearchHistoryEvent](../Types/arkts-apis-avmusictemplate-t.md#querysearchhistoryevent) | 否 | 查询搜索历史的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ClearSearchHistoryEvent](../Types/arkts-apis-avmusictemplate-t.md#clearsearchhistoryevent) | 是 | 回调函数，返回清除搜索历史的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ClearSearchHistoryEvent](../Types/arkts-apis-avmusictemplate-t.md#clearsearchhistoryevent) | 否 | 清除搜索历史的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [LoginEvent](../Types/arkts-apis-avmusictemplate-t.md#loginevent) | 是 | 回调函数，返回登录事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [LoginEvent](../Types/arkts-apis-avmusictemplate-t.md#loginevent) | 否 | 登录事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [RequestDialogInfoEvent](../Types/arkts-apis-avmusictemplate-t.md#requestdialoginfoevent) | 是 | 回调函数，返回请求对话框信息的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [RequestDialogInfoEvent](../Types/arkts-apis-avmusictemplate-t.md#requestdialoginfoevent) | 否 | 请求对话框信息的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [HandleMemberPurchaseEvent](../Types/arkts-apis-avmusictemplate-t.md#handlememberpurchaseevent) | 是 | 回调函数，返回处理购买会员的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [HandleMemberPurchaseEvent](../Types/arkts-apis-avmusictemplate-t.md#handlememberpurchaseevent) | 否 | 处理购买会员的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMemberPurchaseEvent](../Types/arkts-apis-avmusictemplate-t.md#querymemberpurchaseevent) | 是 | 回调函数，返回查询购买会员的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryMemberPurchaseEvent](../Types/arkts-apis-avmusictemplate-t.md#querymemberpurchaseevent) | 否 | 查询购买会员的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCustomContentEvent](../Types/arkts-apis-avmusictemplate-t.md#querycustomcontentevent) | 是 | 回调函数，返回查询自定义内容的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [QueryCustomContentEvent](../Types/arkts-apis-avmusictemplate-t.md#querycustomcontentevent) | 否 | 查询自定义内容的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [DownloadMediaEntityEvent](../Types/arkts-apis-avmusictemplate-t.md#downloadmediaentityevent) | 是 | 回调函数，返回下载媒体实体的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [DownloadMediaEntityEvent](../Types/arkts-apis-avmusictemplate-t.md#downloadmediaentityevent) | 否 | 下载媒体实体的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [SettingsChangeEvent](../Types/arkts-apis-avmusictemplate-t.md#settingschangeevent) | 是 | 回调函数，返回设置改变的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [SettingsChangeEvent](../Types/arkts-apis-avmusictemplate-t.md#settingschangeevent) | 否 | 设置改变的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ProblemAndAdviceEvent](../Types/arkts-apis-avmusictemplate-t.md#problemandadviceevent) | 是 | 回调函数，返回问题与建议的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ProblemAndAdviceEvent](../Types/arkts-apis-avmusictemplate-t.md#problemandadviceevent) | 否 | 处理问题与建议的回调。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PlayForSearchEvent](../Types/arkts-apis-avmusictemplate-t.md#playforsearchevent) | 是 | 回调函数，返回搜播的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PlayForSearchEvent](../Types/arkts-apis-avmusictemplate-t.md#playforsearchevent) | 否 | 搜播的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ExecuteActionEvent](../Types/arkts-apis-avmusictemplate-t.md#executeactionevent) | 是 | 回调函数，返回执行操作的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ExecuteActionEvent](../Types/arkts-apis-avmusictemplate-t.md#executeactionevent) | 否 | 执行操作的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PlayMediaEntityEvent](../Types/arkts-apis-avmusictemplate-t.md#playmediaentityevent) | 是 | 回调函数，返回播放媒体实体的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PlayMediaEntityEvent](../Types/arkts-apis-avmusictemplate-t.md#playmediaentityevent) | 否 | 播放媒体实体的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [FavoriteMediaEntityEvent](../Types/arkts-apis-avmusictemplate-t.md#favoritemediaentityevent) | 是 | 回调函数，返回收藏媒体实体的事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [FavoriteMediaEntityEvent](../Types/arkts-apis-avmusictemplate-t.md#favoritemediaentityevent) | 否 | 收藏媒体实体的事件。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| userInfo | [UserInfo](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#userinfo>) | 是 | 用户信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [DialogControlType](../Types/arkts-apis-avmusictemplate-t.md#dialogcontroltype) | 是 | 对话框控制类型。 |
| dialogInfo | [DialogInfo](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#dialoginfo>) | 是 | 对话框信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| single | [Single](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#single>) | 是 | 当前单曲。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| entities | [MediaEntity](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#mediaentity>)[] | 是 | 媒体实体的数组。 |
...
| tabContent | [MediaTabContent](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#mediatabcontent>) | 是 | 媒体标签页内容。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| playlist | [PageMediaEntity](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#pagemediaentity>) | 是 | 分页媒体实体。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| single | [MediaEntity](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#mediaentity>) | 是 | 媒体实体。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| actionType | [ActionType](../Types/arkts-apis-avmusictemplate-t.md#actiontype) | 是 | 操作类型。 |
| customType | [CustomType](../Types/arkts-apis-avmusictemplate-t.md#customtype) | 是 | 自定义类型。 |
| customElement | [CustomElement](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#customelement>) | 是 | 自定义元素。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| settingItems | [SettingItem](<../Interfaces (其他)/arkts-apis-avmusictemplate-i.md#settingitem>)[] | 是 | 设置项数组。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [WantAgent](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.wantAgent (WantAgent模块)/js-apis-app-ability-wantagent.md#wantagent>) | 是 | 能力信息。 |
