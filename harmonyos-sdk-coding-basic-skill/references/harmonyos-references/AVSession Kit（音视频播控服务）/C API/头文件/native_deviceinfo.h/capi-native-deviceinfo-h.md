...
scraped_at: 2026-06-01T16:19:35+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:e26c7adccb28bb1ed0353d9544c2793e59413f7f9fe6c789f8d1e1ead4dc768a
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [AVSession\_OutputDeviceInfo](../../结构体/AVSession_OutputDeviceInfo/capi-ohavsession-avsession-outputdeviceinfo.md) | - | 目标设备信息的定义。 |
| [AVSession\_DeviceInfo](../../结构体/AVSession_DeviceInfo/capi-ohavsession-avsession-deviceinfo.md) | AVSession\_DeviceInfo | 设备信息的声明。该实例用于获取更多的设备信息及其详细属性。 |
...
| 参数项 | 描述 |
| --- | --- |
| [AVSession\_DeviceInfo](../../结构体/AVSession_DeviceInfo/capi-ohavsession-avsession-deviceinfo.md) \*deviceInfo | 表示设备信息实例指针。 |
| [AVSession\_AVCastCategory](../native_avsession_base.h/capi-native-avsession-base-h.md#avsession_avcastcategory) \*aVCastCategory | 返回aVCastCategory值的指针变量。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数deviceInfo为nullptr。  2. 参数aVCastCategory为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数deviceInfo为nullptr。  2. 参数deviceId为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数deviceInfo为nullptr。  2. 参数deviceName为nullptr。 |
...
| --- | --- |
| [AVSession\_DeviceInfo](../../结构体/AVSession_DeviceInfo/capi-ohavsession-avsession-deviceinfo.md) \*deviceInfo | 表示设备信息实例指针。 |
| [AVSession\_DeviceType](../native_avsession_base.h/capi-native-avsession-base-h.md#avsession_devicetype) \*deviceType | 返回设备类型的指针变量。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数deviceInfo为nullptr。  2. 参数deviceType为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVSession\_ErrCode](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avsession_errcode) | AV\_SESSION\_ERR\_SUCCESS：函数执行成功。  AV\_SESSION\_ERR\_INVALID\_PARAMETER：  1. 参数deviceInfo为nullptr。  2. 参数deviceProtocolType为nullptr。 |
