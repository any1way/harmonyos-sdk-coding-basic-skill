...
scraped_at: 2026-06-01T16:19:28+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:130a6e2cc8cf86766c0bc9b60d83cd542f4dfd34d19cd132ee0aa4f9e603b717
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_AVMetadataBuilderStruct](../../结构体/OH_AVMetadataBuilderStruct/capi-ohavsession-oh-avmetadatabuilderstruct.md) | OH\_AVMetadataBuilder | 会话元数据构造器。构造器用于构造会话元数据。 |
| [OH\_AVMetadataStruct](../../结构体/OH_AVMetadataStruct/capi-ohavsession-oh-avmetadatastruct.md) | OH\_AVMetadata | 会话元数据。资源设置的avmetadata的实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVMetadataBuilder](../../结构体/OH_AVMetadataBuilderStruct/capi-ohavsession-oh-avmetadatabuilderstruct.md)\*\* builder | 该引用指向创建的构造器实例。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：参数builder为nullptr。  AVMETADATA\_ERROR\_NO\_MEMORY：内存不足。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_AVMetadataBuilder](../../结构体/OH_AVMetadataBuilderStruct/capi-ohavsession-oh-avmetadatabuilderstruct.md)\* builder | 指向元数据构造器的实例。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：参数builder为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数assetId为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数title为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数artist为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数author为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数album为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数writer为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数composer为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数mediaImageUri为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数subtitle为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数description为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数lyric为nullptr。 |
...
| --- | --- |
| [OH\_AVMetadataBuilder](../../结构体/OH_AVMetadataBuilderStruct/capi-ohavsession-oh-avmetadatabuilderstruct.md)\* builder | 指向元数据构造器的实例。 |
| [AVMetadata\_SkipIntervals](../native_avsession_base.h/capi-native-avsession-base-h.md#avmetadata_skipintervals) intervals | 跳转的时间间隔。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数intervals为nullptr。 |
...
| --- | --- |
| [OH\_AVMetadataBuilder](../../结构体/OH_AVMetadataBuilderStruct/capi-ohavsession-oh-avmetadatabuilderstruct.md)\* builder | 指向元数据构造器的实例。 |
| uint32\_t filter | 此会话支持的协议。如果没有设置，默认为[AVSession\_ProtocolType](../native_avsession_base.h/capi-native-avsession-base-h.md#avsession_protocoltype).TYPE\_CAST\_PLUS\_STREAM。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数filter是无效的。 |
...
| --- | --- |
| [OH\_AVMetadataBuilder](../../结构体/OH_AVMetadataBuilderStruct/capi-ohavsession-oh-avmetadatabuilderstruct.md)\* builder | 指向元数据构造器的实例。 |
| [OH\_AVMetadata](../../结构体/OH_AVMetadataStruct/capi-ohavsession-oh-avmetadatastruct.md)\*\* avMetadata | 指向元数据的指针对象。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_NO\_MEMORY：内存不足。  AVMETADATA\_ERROR\_INVALID\_PARAM：  1. 参数builder为nullptr。  2. 参数avMetadata为nullptr。 |
...
| 类型 | 说明 |
| --- | --- |
| [AVMetadata\_Result](../native_avsession_errors.h/capi-native-avsession-errors-h.md#avmetadata_result) | AVMETADATA\_SUCCESS：函数执行成功。  AVMETADATA\_ERROR\_INVALID\_PARAM：参数avMetadata为nullptr。 |
