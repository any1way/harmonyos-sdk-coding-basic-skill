...
scraped_at: 2026-06-11T16:09:52+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:178de979356a9e0bb84e18de9777ca6dd7b0c0342e054c1e54d1fea6f192c429
---
...
**设备行为差异：** 该枚举在Wearable、TV中无效果，使用时请遵循[约束与限制](<../../../../harmonyos-guides/系统/安全/Device Security Kit（设备安全服务）/超级隐私模式/查询当前状态场景/devicesecurity-getsuperprivacymode.md#约束与限制>)部分的相关说明。
...
**设备行为差异：** 在存在超级隐私模式选项的Phone、PC/2in1、Tablet中可正常调用，在不存在超级隐私模式选项的Phone、PC/2in1、Tablet中返回1006200005错误码，开发者使用时请遵循[约束与限制](<../../../../harmonyos-guides/系统/安全/Device Security Kit（设备安全服务）/超级隐私模式/查询当前状态场景/devicesecurity-getsuperprivacymode.md#约束与限制>)部分的相关说明。
...
以下错误码的详细介绍请参见[ArkTS API错误码](<../ArkTS API错误码/SuperPrivacyMode（超级隐私模式）/errcode-devicesecurity-superprivacy.md>)。
