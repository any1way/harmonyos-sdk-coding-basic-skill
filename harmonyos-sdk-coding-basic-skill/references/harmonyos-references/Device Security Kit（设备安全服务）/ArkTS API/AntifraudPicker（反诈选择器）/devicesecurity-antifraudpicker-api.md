...
scraped_at: 2026-06-11T16:09:48+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:8abd1441749ec83ba10643007e84778e4be319e35a60561d4236e380405b52a0
---
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| maxSelectNumber | number | 否 | 是 | 最大可选项数。如果不传，则默认为50。取值范围为1~50，小于1或者大于50会抛出错误信息，错误码[401](<../ArkTS API错误码/AntifraudPicker（反诈选择器）/devicesecurity-arktsapi-errcode-antifraudpicker.md#section401-参数检查失败>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](<../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>) | 是 | 应用上下文。 |
...
以下错误码的详细介绍请参见[ArkTS API错误码](<../ArkTS API错误码/AntifraudPicker（反诈选择器）/devicesecurity-arktsapi-errcode-antifraudpicker.md>) **。**
