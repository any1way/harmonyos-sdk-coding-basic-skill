...
content_hash: sha256:46736db66d626b5ad55c0d08bcb317c8164315824b478982c87215b9c79e68d8
---
...
以下错误码的详细介绍请参见[ArkTS API错误码](<../ArkTS API错误码/DeviceVerify（应用设备状态检测）/devicesecurity-arktsapi-errcode-deviceverify.md>)。

| 错误码ID | 错误信息 |
| --- | --- |
| [201](<../ArkTS API错误码/DeviceVerify（应用设备状态检测）/devicesecurity-arktsapi-errcode-deviceverify.md#section201-权限校验失败>) | has no permission. |
| [1003300005](<../ArkTS API错误码/DeviceVerify（应用设备状态检测）/devicesecurity-arktsapi-errcode-deviceverify.md#section1003300005-内部异常>) | internal error. |
| [1003300006](<../ArkTS API错误码/DeviceVerify（应用设备状态检测）/devicesecurity-arktsapi-errcode-deviceverify.md#section1003300006-访问云端服务器异常>) | access cloud server fail. |
