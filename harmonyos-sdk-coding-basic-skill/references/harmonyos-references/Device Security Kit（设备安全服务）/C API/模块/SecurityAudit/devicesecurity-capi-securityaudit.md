...
scraped_at: 2026-06-11T16:10:12+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:c754c5ec464bc50296cce58049b117846fbe7ccf98b9cc327baacab90357be61
---
## 概述
...
| 名称 | 描述 |
| --- | --- |
| [security\_audit.h](../../头文件/security_audit.h/devicesecurity-capi-security-audit-8h.md) | 文件中定义了与安全审计相关的函数。 |
...
| 名称 | 描述 |
| --- | --- |
| typedef void(\* [SecurityAudit\_Handler](devicesecurity-capi-securityaudit.md#securityaudit_handler)) (const [SecurityAudit\_Event](<../../../../安全/Device Security Kit（设备安全服务）/C API/结构体/SecurityAudit_Event/devicesecurity-capi-structs-securityaudit-event.md>) \*events, uint64\_t count) | 定义事件处理函数。 |
