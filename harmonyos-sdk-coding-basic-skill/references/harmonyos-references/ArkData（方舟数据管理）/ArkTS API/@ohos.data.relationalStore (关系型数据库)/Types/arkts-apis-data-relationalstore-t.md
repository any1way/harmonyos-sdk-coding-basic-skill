...
scraped_at: 2026-06-01T15:33:32+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:0134eb8ff58615f6eede4b889d138bacda340c42e4beb81bcffa83a362c8cf70
---
说明
...
表示[Asset](<../Interfaces (其他)/arkts-apis-data-relationalstore-i.md#asset10>)类型的数组。

**系统能力：** SystemCapability.DistributedDataManager.RelationalStore.Core

| 类型 | 说明 |
| --- | --- |
| [Asset](<../Interfaces (其他)/arkts-apis-data-relationalstore-i.md#asset10>)[] | 表示Asset类型的数组。 |
...
| Asset10+ | 表示值类型为附件[Asset](<../Interfaces (其他)/arkts-apis-data-relationalstore-i.md#asset10>)。  当字段类型是Asset时，在创建表的sql语句中，类型应当为：ASSET。 |
