...
scraped_at: 2026-06-01T15:33:30+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:2de38ee6546188d1ca7c0947e199367189796e84ee35fd03e2c6c0dc17c3e02b
---
...
其中devices通过调用[deviceManager.getAvailableDeviceListSync](<../../../../网络/Distributed Service Kit（分布式管理服务）/ArkTS API/@ohos.distributedDeviceManager (设备管理)/js-apis-distributeddevicemanager.md#getavailabledevicelistsync>)方法得到。
...
| value | [ValueType](../Types/arkts-apis-data-relationalstore-t.md#valuetype) | 是 | 指示要与谓词匹配的值。 |
...
| --- | --- | --- | --- |
| field | string | 是 | 数据库表中的列名。 |
| low | [ValueType](../Types/arkts-apis-data-relationalstore-t.md#valuetype) | 是 | 指示与谓词匹配的最小值。 |
| high | [ValueType](../Types/arkts-apis-data-relationalstore-t.md#valuetype) | 是 | 指示与谓词匹配的最大值。 |
...
| field | string | 是 | 数据库表中的列名。 |
| low | [ValueType](../Types/arkts-apis-data-relationalstore-t.md#valuetype) | 是 | 指示与谓词匹配的最小值。 |
| high | [ValueType](../Types/arkts-apis-data-relationalstore-t.md#valuetype) | 是 | 指示要与谓词匹配的最大值。 |
...
| --- | --- | --- | --- |
| field | string | 是 | 数据库表中的列名。 |
| value | Array<[ValueType](../Types/arkts-apis-data-relationalstore-t.md#valuetype)> | 是 | 以ValueType型数组形式指定的要匹配的值。 |
...
| --- | --- | --- | --- |
| field | string | 是 | 数据库表中的列名。 |
| value | Array<[ValueType](../Types/arkts-apis-data-relationalstore-t.md#valuetype)> | 是 | 以ValueType数组形式指定的要匹配的值。 |
...
| args | Array<[ValueType](../Types/arkts-apis-data-relationalstore-t.md#valuetype)> | 否 | 条件中使用的参数，用来替换条件语句中的占位符，不传时默认为空数组。 |
