...
scraped_at: 2026-06-01T15:33:50+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:252c4cd049a1b00221669d578b7997d0062cfbfdbe7d2c45b133caf2c41825b2
---
...
从API Version 9开始，该接口不再维护，推荐使用新接口[ResultSet](<../../../@ohos.data.relationalStore (关系型数据库)/Interface (ResultSet)/arkts-apis-data-relationalstore-resultset.md>)。
...
需要通过[RdbStore.query()](<../../@ohos.data.rdb (关系型数据库)/js-apis-data-rdb.md#query>)获取resultSet对象。
...
6. console.info(TAG + "resultSet columnNames:" + resultSet.columnNames);
7. console.info(TAG + "resultSet columnCount:" + resultSet.columnCount);
8. });
```
...
4. resultSet.close();
5. }).catch((err) => {
6. console.error('resultset close failed');
7. });
```
