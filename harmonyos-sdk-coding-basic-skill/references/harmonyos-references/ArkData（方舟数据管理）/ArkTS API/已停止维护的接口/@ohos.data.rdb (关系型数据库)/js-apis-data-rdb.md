...
scraped_at: 2026-06-11T15:38:29+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:d8fe6ce6e99a3bbcbca85901ce409e3c4a7dcc8721a3e13875909e7c21aa805a
---
...
* 从API version 9开始，该接口不再维护，推荐使用新接口[@ohos.data.relationalStore](<../../@ohos.data.relationalStore (关系型数据库)/模块描述/arkts-apis-data-relationalstore.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | Context | 是 | 应用的上下文。  FA模型的应用Context定义见[Context](<../../../../Ability Kit（程序框架服务）/ArkTS API/FA模型能力的接口/app/Context (FA模型的上下文基类)/js-apis-inner-app-context.md>)。  Stage模型的应用Context定义见[Context](<../../../../Ability Kit（程序框架服务）/ArkTS API/FA模型能力的接口/app/Context (FA模型的上下文基类)/js-apis-inner-app-context.md>)。 |
...
8. if (err) {
9. console.error("Get RdbStore failed, err: " + err)
10. return
11. }
...
9. if (err) {
10. console.error("Get RdbStore failed, err: " + err)
11. return
12. }
...
6. console.info("Get RdbStore successfully.")
7. }).catch((err: BusinessError) => {
8. console.error("Get RdbStore failed, err: " + err)
9. })
```
...
17. console.error("Get RdbStore failed, err: " + err)
18. })
```
...
4. if (err) {
5. console.error("Delete RdbStore failed, err: " + err)
6. return
7. }
8. console.info("Delete RdbStore successfully.")
9. })
```
...
12. if (err) {
13. console.error("Delete RdbStore failed, err: " + err)
14. return
15. }
16. console.info("Delete RdbStore successfully.")
17. })
```
...
4. promise.then(() => {
5. console.info("Delete RdbStore successfully.")
6. }).catch((err: BusinessError) => {
7. console.error("Delete RdbStore failed, err: " + err)
8. })
```
...
16. console.error("Delete RdbStore failed, err: " + err)
17. })
```
...
8. if (err) {
9. console.error("create device manager failed, err=" + err);
10. return;
11. }
...
19. if (status) {
20. console.error("Insert failed");
21. return;
22. }
23. console.info("Insert is successful, rowId = " + rowId);
24. })
```
...
20. console.info("Insert is successful, rowId = " + rowId);
21. }).catch((status: number) => {
22. console.error("Insert failed");
23. })
```
...
40. if (status) {
41. console.error("batchInsert failed, status = " + status);
42. return;
43. }
44. console.info("batchInsert is successful, the number of values that were inserted = " + insertNum);
45. })
```
...
43. console.error("batchInsert failed, status = " + status);
44. })
```
...
21. if (err) {
22. console.error("Update failed, err: " + err)
23. return
24. }
25. console.info("Updated row count: " + rows)
26. })
```
...
22. console.info("Updated row count: " + rows)
23. }).catch((err: BusinessError) => {
24. console.error("Update failed, err: " + err)
25. })
```
...
4. if (err) {
5. console.error("Delete failed, err: " + err)
6. return
7. }
...
6. }).catch((err: BusinessError) => {
7. console.error("Delete failed, err: " + err)
8. })
```
...
| callback | AsyncCallback<[ResultSet](<../datardb/resultSet (结果集)/js-apis-data-resultset.md#resultset>)> | 是 | 指定callback回调函数。如果操作成功，则返回ResultSet对象。 |
...
4. if (err) {
5. console.error("Query failed, err: " + err)
6. return
7. }
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ResultSet](<../datardb/resultSet (结果集)/js-apis-data-resultset.md#resultset>)> | Promise对象。如果操作成功，则返回ResultSet对象。 |
...
7. }).catch((err: BusinessError) => {
8. console.error("Query failed, err: " + err)
9. })
```
...
2. if (err) {
3. console.error("Query failed, err: " + err)
4. return
5. }
...
6. console.error("Query failed, err: " + err)
7. })
```
...
3. if (err) {
4. console.error("ExecuteSql failed, err: " + err)
5. return
6. }
...
5. }).catch((err: BusinessError) => {
6. console.error("ExecuteSql failed, err: " + err)
7. })
```
...
2. if (err) {
3. console.error('SetDistributedTables failed, err: ' + err)
4. return
5. }
...
5. console.error("SetDistributedTables failed, err: " + err)
6. })
```
...
6. if (err) {
7. console.error("create device manager failed, err=" + err);
8. return;
9. }
...
16. if (err) {
17. console.error('ObtainDistributedTableName failed, err: ' + err)
18. return
19. }
...
19. console.error('ObtainDistributedTableName failed, err: ' + err)
20. })
```
...
20. if (err) {
21. console.error('Sync failed, err: ' + err)
22. return
23. }
24. console.info('Sync done.')
25. for (let i = 0; i < result.length; i++) {
26. console.info('device=' + result[i][0] + ' status=' + result[i][1])
27. }
28. })
```
...
21. console.info('Sync done.')
22. for (let i = 0; i < result.length; i++) {
23. console.info('device=' + result[i][0] + ' status=' + result[i][1])
24. }
25. }).catch((err: BusinessError) => {
26. console.error('Sync failed')
27. })
```
...
8. })
9. } catch (err) {
10. console.error('Register observer failed')
11. }
```
...
8. })
9. } catch (err) {
10. console.error('Unregister observer failed')
11. }
```
