...
scraped_at: 2026-06-01T15:33:51+08:00
doc_updated_at: 2026-03-19
content_hash: sha256:200d6b6c21ad2ee5cc9bbce451e1b820795c87b9ee83986775b25cd4684b7ab7
---
针对[ContentForm](<../../ArkTS API/@ohos.data.uniformDataStruct (标准化数据结构)/js-apis-data-uniformdatastruct.md#contentform14>)标准数据结构的内容卡片，支持设置标题（必选）、描述、应用图标、应用名称、跳转链接、内容图片。用户点击卡片时，执行传入的回调事件函数，若设置的跳转链接不为空，则跳转到指定的页面。
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| contentFormData | [uniformDataStruct.ContentForm](<../../ArkTS API/@ohos.data.uniformDataStruct (标准化数据结构)/js-apis-data-uniformdatastruct.md#contentform14>) | 是 | - | 内容卡片数据。 |
