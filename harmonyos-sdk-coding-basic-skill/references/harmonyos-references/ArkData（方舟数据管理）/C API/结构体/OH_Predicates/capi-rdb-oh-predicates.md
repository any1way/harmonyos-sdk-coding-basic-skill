...
scraped_at: 2026-06-11T15:39:10+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:6997958350f297004420da1dc44aadbd538c77c1408812f3d7f0c469fe802357
---
```
...
**所在头文件：** [oh\_predicates.h](../../头文件/oh_predicates.h/capi-oh-predicates-h.md)
...
| [OH\_VObject](../OH_VObject/capi-rdb-oh-vobject.md) \*valueObject | 表示指向[OH\_VObject](../OH_VObject/capi-rdb-oh-vobject.md)实例的指针，指示要与谓词匹配的值。 |
...
| OH\_Predicates \*predicates | 表示指向OH\_Predicates实例的指针。 |
| const char \*field | 数据库表中的列名。 |
| OH\_VObject \*valueObject | 表示指向[OH\_VObject](../OH_VObject/capi-rdb-oh-vobject.md)实例的指针，指示要与谓词匹配的值。 |
...
| OH\_Predicates \*predicates | 表示指向OH\_Predicates实例的指针。 |
| const char \*field | 数据库表中的列名。 |
| [OH\_VObject](../OH_VObject/capi-rdb-oh-vobject.md) type | 表示排序类型[OH\_VObject](../OH_VObject/capi-rdb-oh-vobject.md)。 |
