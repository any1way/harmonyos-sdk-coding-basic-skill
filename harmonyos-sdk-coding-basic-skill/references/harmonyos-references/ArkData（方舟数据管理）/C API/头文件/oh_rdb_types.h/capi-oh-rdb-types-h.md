...
scraped_at: 2026-06-01T15:34:09+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:ed4df2fca7797f000c3cbab0899be307bb62c2cb24623cf29290f640b810d414
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_RDB\_ReturningContext](../../结构体/OH_RDB_ReturningContext/capi-rdb-oh-rdb-returningcontext.md) | OH\_RDB\_ReturningContext | returning相关接口的上下文。 |
...
| 名称 | 描述 |
| --- | --- |
| [OH\_RDB\_ReturningContext \*OH\_RDB\_CreateReturningContext(void)](capi-oh-rdb-types-h.md#oh_rdb_createreturningcontext) | 创建[OH\_RDB\_ReturningContext](../../结构体/OH_RDB_ReturningContext/capi-rdb-oh-rdb-returningcontext.md)的实例对象。 |
| [void OH\_RDB\_DestroyReturningContext(OH\_RDB\_ReturningContext \*context)](capi-oh-rdb-types-h.md#oh_rdb_destroyreturningcontext) | 销毁[OH\_RDB\_ReturningContext](../../结构体/OH_RDB_ReturningContext/capi-rdb-oh-rdb-returningcontext.md)实例对象。 |
...
创建[OH\_RDB\_ReturningContext](../../结构体/OH_RDB_ReturningContext/capi-rdb-oh-rdb-returningcontext.md)的实例对象。
...
| 类型 | 说明 |
| --- | --- |
| [OH\_RDB\_ReturningContext \*](../../结构体/OH_RDB_ReturningContext/capi-rdb-oh-rdb-returningcontext.md) | 执行成功时返回指向[OH\_RDB\_ReturningContext](../../结构体/OH_RDB_ReturningContext/capi-rdb-oh-rdb-returningcontext.md)实例的指针。  否则返回nullptr。使用完成后必须通过[OH\_RDB\_DestroyReturningContext](capi-oh-rdb-types-h.md#oh_rdb_destroyreturningcontext)接口释放内存。 |
...
销毁[OH\_RDB\_ReturningContext](../../结构体/OH_RDB_ReturningContext/capi-rdb-oh-rdb-returningcontext.md)实例对象。
...
| 类型 | 说明 |
| --- | --- |
| OH\_Cursor \* | 返回指向[OH\_Cursor](../../结构体/OH_Cursor/capi-rdb-oh-cursor.md)结构体实例的指针。  如果获取游标失败，则返回nullptr。使用[OH\_RDB\_DestroyReturningContext](capi-oh-rdb-types-h.md#oh_rdb_destroyreturningcontext)接口释放内存时会销毁游标，无需单独释放。 |
