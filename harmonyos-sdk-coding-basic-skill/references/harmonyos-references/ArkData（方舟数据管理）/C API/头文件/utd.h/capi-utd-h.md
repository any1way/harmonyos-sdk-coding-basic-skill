...
scraped_at: 2026-06-01T15:34:20+08:00
doc_updated_at: 2026-03-27
content_hash: sha256:81c70c89df4c0356cdab34e74d7d879135cdbc3ce99c982dc4351fbb83cc08c0
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md) | OH\_Utd | 统一数据类型描述符。 |
...
| 名称 | 描述 |
| --- | --- |
| [OH\_Utd\* OH\_Utd\_Create(const char\* typeId)](capi-utd-h.md#oh_utd_create) | 创建统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)指针及实例对象。 |
| [void OH\_Utd\_Destroy(OH\_Utd\* pThis)](capi-utd-h.md#oh_utd_destroy) | 销毁统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)指针指向的实例对象。 |
| [const char\* OH\_Utd\_GetTypeId(OH\_Utd\* pThis)](capi-utd-h.md#oh_utd_gettypeid) | 获取统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)中的类型ID。 |
| [const char\* OH\_Utd\_GetDescription(OH\_Utd\* pThis)](capi-utd-h.md#oh_utd_getdescription) | 获取统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)中的描述信息。 |
| [const char\* OH\_Utd\_GetReferenceUrl(OH\_Utd\* pThis)](capi-utd-h.md#oh_utd_getreferenceurl) | 获取统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)中的URL信息。 |
| [const char\* OH\_Utd\_GetIconFile(OH\_Utd\* pThis)](capi-utd-h.md#oh_utd_geticonfile) | 获取统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)中的默认图标文件路径。 |
| [const char\*\* OH\_Utd\_GetBelongingToTypes(OH\_Utd\* pThis, unsigned int\* count)](capi-utd-h.md#oh_utd_getbelongingtotypes) | 获取统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)中的归属关系结果集。 |
| [const char\*\* OH\_Utd\_GetFilenameExtensions(OH\_Utd\* pThis, unsigned int\* count)](capi-utd-h.md#oh_utd_getfilenameextensions) | 获取统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)所关联的文件名后缀结果集。 |
| [const char\*\* OH\_Utd\_GetMimeTypes(OH\_Utd\* pThis, unsigned int\* count)](capi-utd-h.md#oh_utd_getmimetypes) | 获取[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)所关联的MIME类型结果集。 |
...
创建统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)指针及实例对象。
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)\* | 执行成功则返回一个指向统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)实例对象的指针，否则返回nullptr。  当不再需要使用指针时，请使用[OH\_Utd\_Destroy](capi-utd-h.md#oh_utd_destroy)销毁实例对象，否则会导致内存泄漏。 |
...
销毁统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)指针指向的实例对象。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)\* pThis | 表示指向统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)实例的指针。 |
...
获取统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)中的类型ID。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)\* pThis | 表示一个指向统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)对象的指针。 |
...
获取统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)中的描述信息。
...
获取统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)中的URL信息。
...
获取统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)中的默认图标文件路径。
...
获取统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)中的归属关系结果集。
...
获取统一数据类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)所关联的文件名后缀结果集。
...
获取[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)所关联的MIME类型结果集。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)\* utd1 | 表示一个指向标准化数据描述类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)对象的指针。 |
| [OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)\* utd2 | 表示一个指向标准化数据描述类型[OH\_Utd](../../结构体/OH_Utd/capi-udmf-oh-utd.md)对象的指针。 |
