...
scraped_at: 2026-06-01T15:34:03+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:a94bbb88ff465486ed160dec1d157afa62bdd0b991a47c3fd587e8a2d2c82baa
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_Data\_Value](../../结构体/OH_Data_Value/capi-rdb-oh-data-value.md) | OH\_Data\_Value | 定义[OH\_Data\_Value](../../结构体/OH_Data_Value/capi-rdb-oh-data-value.md)结构类型。 |
...
| 名称 | 描述 |
| --- | --- |
| [OH\_Data\_Value \*OH\_Value\_Create(void)](capi-oh-data-value-h.md#oh_value_create) | 创建[OH\_Data\_Value](../../结构体/OH_Data_Value/capi-rdb-oh-data-value.md)实例，用于储存单条键值对数据。 |
| [int OH\_Value\_Destroy(OH\_Data\_Value \*value)](capi-oh-data-value-h.md#oh_value_destroy) | 销毁[OH\_Data\_Value](../../结构体/OH_Data_Value/capi-rdb-oh-data-value.md)对象。 |
...
创建[OH\_Data\_Value](../../结构体/OH_Data_Value/capi-rdb-oh-data-value.md)实例，用于储存单条键值对数据。
...
| 类型 | 说明 |
| --- | --- |
| [OH\_Data\_Value](../../结构体/OH_Data_Value/capi-rdb-oh-data-value.md) | 执行成功时返回指向[OH\_Data\_Value](../../结构体/OH_Data_Value/capi-rdb-oh-data-value.md)实例的指针。否则返回nullptr。  使用完成后，必须通过[OH\_Value\_Destroy](capi-oh-data-value-h.md#oh_value_destroy)接口释放内存。 |
...
销毁[OH\_Data\_Value](../../结构体/OH_Data_Value/capi-rdb-oh-data-value.md)对象。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Data\_Value](../../结构体/OH_Data_Value/capi-rdb-oh-data-value.md) \*value | 表示指向[OH\_Data\_Value](../../结构体/OH_Data_Value/capi-rdb-oh-data-value.md)实例的指针。 |
...
| size\_t length | 该参数是输入参数，表示开发者传入的[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md)对象数组元素的个数。 |
...
| [OH\_Data\_Value](../../结构体/OH_Data_Value/capi-rdb-oh-data-value.md) \*value | 表示指向[OH\_Data\_Value](../../结构体/OH_Data_Value/capi-rdb-oh-data-value.md)实例的指针。 |
| [Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md) \*\*val | 表示指向[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md)对象的指针。  需要申请数据内存。  此函数仅填充数据。否则执行失败。 |
| size\_t inLen | 表示val的大小。可以通过[OH\_Values\_GetAssetsCount](../oh_data_values.h/capi-oh-data-values-h.md#oh_values_getassetscount)获取。 |
...
| size\_t inLen | 表示val的大小。可以通过[OH\_Values\_GetFloatVectorCount](../oh_data_values.h/capi-oh-data-values-h.md#oh_values_getfloatvectorcount)获取。 |
| size\_t \*outLen | 一个输出参数，表示实际获取的数据大小。 |
...
| size\_t inLen | 表示trueForm的大小。可以通过[OH\_Values\_GetUnlimitedIntBand](../oh_data_values.h/capi-oh-data-values-h.md#oh_values_getunlimitedintband)获取。 |
| size\_t \*outLen | 一个输出参数，表示实际获取的数据大小。 |
