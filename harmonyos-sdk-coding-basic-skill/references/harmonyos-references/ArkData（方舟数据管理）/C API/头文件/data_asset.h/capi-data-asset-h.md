...
content_hash: sha256:ddc16a6ce4c33672e7af78014129e54e139f42f56d27513ae6595ca094238e5a
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md) | Data\_Asset | 表示资产附件类型的数据。  提供资产附件的信息。 |
...
| [Data\_Asset \*OH\_Data\_Asset\_CreateOne(void)](capi-data-asset-h.md#oh_data_asset_createone) | 创建一个[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md)类型实例。 |
| [int OH\_Data\_Asset\_DestroyOne(Data\_Asset \*asset)](capi-data-asset-h.md#oh_data_asset_destroyone) | 销毁[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md) 对象并回收该对象占用的内存。 |
| [Data\_Asset \*\*OH\_Data\_Asset\_CreateMultiple(uint32\_t count)](capi-data-asset-h.md#oh_data_asset_createmultiple) | 创建指定数量的[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md)类型实例。 |
| [int OH\_Data\_Asset\_DestroyMultiple(Data\_Asset \*\*assets, uint32\_t count)](capi-data-asset-h.md#oh_data_asset_destroymultiple) | 销毁多个[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md) 对象并回收该对象占用的内存。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md) \*asset | 表示指向[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md)实例的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| int | 返回特定的错误码值。详细信息可以查看[OH\_Rdb\_ErrCode](../relational_store_error_code.h/capi-relational-store-error-code-h.md#oh_rdb_errcode)。  返回RDB\_OK表示成功。  返回RDB\_E\_INVALID\_ARGS表示无效参数。 |
...
| 类型 | 说明 |
| --- | --- |
| int | 返回特定的错误码值。详细信息可以查看[OH\_Rdb\_ErrCode](../relational_store_error_code.h/capi-relational-store-error-code-h.md#oh_rdb_errcode)。  返回RDB\_ERR表示函数执行异常。  返回RDB\_OK表示成功。  返回RDB\_E\_INVALID\_ARGS表示无效参数。 |
...
创建一个[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md)类型实例。
...
| 类型 | 说明 |
| --- | --- |
| [Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md) | 创建成功则返回一个指向[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md)结构体实例的指针，否则返回NULL。  使用完成后，必须通过[OH\_Data\_Asset\_DestroyOne](capi-data-asset-h.md#oh_data_asset_destroyone)接口释放内存。 |
...
销毁[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md) 对象并回收该对象占用的内存。
...
| 类型 | 说明 |
| --- | --- |
| int | 返回操作是否成功，成功时返回RDB\_OK，出错时返回对应的错误码。详细信息可以查看[OH\_Rdb\_ErrCode](../relational_store_error_code.h/capi-relational-store-error-code-h.md#oh_rdb_errcode)。 |
...
创建指定数量的[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md)类型实例。
...
| 类型 | 说明 |
| --- | --- |
| [Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md) | 创建成功则返回一个指向[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md)结构体实例的指针，否则返回NULL。  使用完成后，必须通过[OH\_Data\_Asset\_DestroyMultiple](capi-data-asset-h.md#oh_data_asset_destroymultiple)接口释放内存。 |
...
销毁多个[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md) 对象并回收该对象占用的内存。
...
| 参数项 | 描述 |
| --- | --- |
| [Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md) \*\*assets | 表示指向[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md)实例的指针。 |
| uint32\_t count | 代表需要销毁的[Data\_Asset](../../结构体/Data_Asset/capi-rdb-data-asset.md)类型对象的数量。 |
