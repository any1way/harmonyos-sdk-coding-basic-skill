...
scraped_at: 2026-06-01T15:34:01+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:12029e1869c849471d29ce72c401fc6884bc36eeb3c280ef40e05d33ad5d588c
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_Cursor](../../结构体/OH_Cursor/capi-rdb-oh-cursor.md) | OH\_Cursor | 提供通过查询数据库生成的数据库结果集的访问方法。结果集是指用户调用关系型数据库查询接口之后返回的结果集合，提供了多种灵活的数据访问方式，以便用户获取各项数据。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_Cursor](../../结构体/OH_Cursor/capi-rdb-oh-cursor.md) \*cursor | 表示指向[OH\_Cursor](../../结构体/OH_Cursor/capi-rdb-oh-cursor.md)实例的指针。 |
