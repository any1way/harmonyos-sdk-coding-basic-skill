...
scraped_at: 2026-06-11T16:49:45+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:6582f7776f2b0c49356bfc032532f84def5c5ee2533e43d0f2313d4e9988e532
---
...
以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)和[ArkTS API错误码](<../ArkTS API错误码/push-error-code.md>)。
...
以下错误码的详细介绍请参见[ArkTS API错误码](<../ArkTS API错误码/push-error-code.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| appProfileType | pushCommon.[AppProfileType](../pushCommon（推送服务公共信息）/push-pushcommon.md#appprofiletype) | 是 | 绑定账号类型，分为华为账号和应用账号。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pushType | [PushType](push-pushservice.md#pushservicepushtype) | 是 | 场景化消息类型。  **说明：**  · pushService.PushType中EMERGENCY（紧急事件消息场景）起始版本：5.0.0(12)。本场景仅为地震灾害等特殊场景使用。  · pushService.PushType中DEFAULT（通知消息场景）起始版本：5.0.2(14)。调用示例代码请参考[应用在前台时处理通知消息](<../../../../harmonyos-guides/应用服务/Push Kit（推送服务）/推送场景化消息/推送通知消息/发送通知消息/push-send-alert.md#应用在前台时处理通知消息>)中步骤3。  · IM（语音播报消息场景）调用示例代码请参考[开发步骤](<../../../../harmonyos-guides/应用服务/Push Kit（推送服务）/推送场景化消息/推送语音播报消息/发送语音播报消息/push-send-extend-noti.md#开发步骤>)中步骤3。  · VoIP（应用内通话消息场景）  调用示例代码请参考[开发步骤](<../../../../harmonyos-guides/应用服务/Push Kit（推送服务）/推送场景化消息/推送应用内通话消息/push-voip.md#开发步骤>)中步骤2。  · BACKGROUND（后台消息场景）  调用示例代码请参考[开发步骤](<../../../../harmonyos-guides/应用服务/Push Kit（推送服务）/推送场景化消息/推送后台消息/push-background.md#开发步骤>)中步骤5。 |
| ability | [Ability](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.Ability (Ability基类)/js-apis-app-ability-ability.md>) | 是 | [UIAbility](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)。 |
| onMessage | Callback<pushCommon.[PushPayload](../pushCommon（推送服务公共信息）/push-pushcommon.md#pushpayload)> | 是 | 回调函数，返回接收场景化消息的数据。 |
...
| ability | [Ability](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.Ability (Ability基类)/js-apis-app-ability-ability.md>) | 是 | [UIAbility](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)，包含UI界面的应用组件。 |
...
| callee | [Callee](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#callee>) | 是 | 通用组件服务端注册和解除客户端[Caller](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#caller>)通知送信的callback接口，从[UIAbility](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)中获取。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| PushPayload | pushCommon.[PushPayload](../pushCommon（推送服务公共信息）/push-pushcommon.md#pushpayload) | 是 | 分布式消息数据的参数定义。 |
