...
scraped_at: 2026-06-11T16:23:42+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:696438222bea82105dac8a064cee14f3809a4627236e016e34260ba458bc31c1
---
...
以下错误码的详细介绍请参见[用户状态感知错误码](../../错误码/用户状态感知错误码/errorcode-userstatus.md)和[通用错误码](../../../通用错误码/errorcode-universal.md)。
...
| --- | --- | --- | --- |
| type | string | 是 | 事件类型。type为“userAgeGroupDetected”，表示年龄群组检测功能。 |
| callback | Callback<[UserClassification](js-apis-awareness-userstatus.md#userclassificationdeprecated)> | 否 | 回调函数，返回检测结果。 |
