...
scraped_at: 2026-06-01T16:08:16+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:fba1db91a0ef49388f05fc36515f94fe706413f1a6c654c0c19a3a0c759dc8d8
---
...
错误码的详细介绍请参见[API错误码](../../API错误码/remote-communication-error-code.md)。

| 错误码ID | 错误信息 |
| --- | --- |
| [401](../../../../通用错误码/errorcode-universal.md#section401-参数检查失败) | Parameter error. |
| [1007900994](../../API错误码/remote-communication-error-code.md#section1007900994-会话数达到限制) | Sessions number reached limit. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| identifier | string | 否 | cookie仓库标识。只能包含大写字母、小写字母和下划线。  传入undefined、null或空字符串时默认为'default'。  传入其他字符时抛出[1007900401](../../API错误码/remote-communication-error-code.md#section1007900401-接口参数错误)错误。  具有同样标识的cookie仓库共享cookie信息（即具有同样标识的cookie仓库实例使用起来如同同一个实例）。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1007900401](../../API错误码/remote-communication-error-code.md#section1007900401-接口参数错误) | Parameter error. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cookies | [ResponseCookie](remote-communication-rcp.md#responsecookie) | [ResponseCookie](remote-communication-rcp.md#responsecookie)[] | 是 | 传入cookie仓库的cookie。cookie仓库里实际会存如下7项数据：domain、httpOnly、path、isSecure、expires、name和value。当两个cookie的name、domain、path三项完全相同时，视为同一个cookie。  path默认为'/'。  domain不设置或者设置为空字符串时抛出[1007900401](../../API错误码/remote-communication-error-code.md#section1007900401-接口参数错误)错误。  maxAge会转化为expires。maxAge和expires都设置时，使用maxAge。  expires应是符合[RFC 7231](https://www.rfc-editor.org/rfc/rfc7231.html)协议，并且是GMT时间的字符串，精确到秒，例如：'Wed, 21 Oct 2025 07:28:00 GMT'。当expires字段传入无效字符串时抛出[1007900401](../../API错误码/remote-communication-error-code.md#section1007900401-接口参数错误)错误。  系统会不定期清除expires过期的cookie。传入空数组时，仅将cookie仓库中现有的cookie存储到本地。 |
...
| --- | --- |
| [1007900401](../../API错误码/remote-communication-error-code.md#section1007900401-接口参数错误) | Parameter error. |
| [1007900999](../../API错误码/remote-communication-error-code.md#section1007900999-内部错误) | Internal Error. |
...
| pathPreference | [PathPreference](remote-communication-rcp.md#pathpreference) | 否 | 是 | HTTP请求路径首选项，此处配置的为建议路径，在实际使用过程中，系统会决定使用哪个路径。可以是'auto'或'cellular'路径。默认为'auto'路径。 |
...
| throwErrorWhenEnableCellularFailed | boolean | 否 | 是 | 配置当请求的pathPreference为'cellular'且蜂窝网络启用失败时是否抛出错误码。设置为true，表示抛出蜂窝连接超时错误码[1007900986](../../API错误码/remote-communication-error-code.md#section1007900986-建立蜂窝链接超时)；false表示不抛错误码，使用其他可用网络（如Wi-Fi）发送请求。默认值为false。  **起始版本：** 6.1.1(24) |
...
25. dns: {
26. // 例如对于 example.com，'192.168.1.2' 是有效的。
27. // 对于 sub.example.com，'192.168.2.1' 是有效的。
...
34. // 在创建会话时，若设置了DNS规则，则启用happyEyeballOnDnsRule
35. const sessionWithStaticDnsRulesAndHappyEyeball = rcp.createSession({
36. requestConfiguration: {
37. dns: {
38. dnsRules: staticDnsRules, // 在此设置DNS规则
39. happyEyeballOnDnsRule: true, // 在此启用happyEyeballOnDnsRule
40. }
41. }
42. });

44. // 在DNS规则设置时，在请求配置中启用happyEyeballOnDnsRule
45. const request = new rcp.Request('https://example.com');
46. request.configuration = {
47. dns: {
48. dnsRules: staticDnsRules, // 在此设置DNS规则
49. happyEyeballOnDnsRule: true, // 在此启用happyEyeballOnDnsRule
50. }
51. };
```
...
TLS版本可用范围配置属性，开发者能够设置安全相关TLS版本的上限和下限，并指定该范围内加密套件列表。如果最小版本大于最大版本，发起请求时抛出[401](../../../../通用错误码/errorcode-universal.md#section401-参数检查失败)错误。
...
请求的地址类型，链接到@[ohos.url](<../../../../ArkTS（方舟编程语言）/ArkTS API/@ohos.url (URL字符串解析)/js-apis-url.md>)中的URL。
...
提供 x509 证书类型，链接到@[ohos.security.cert](<../../../../安全/Device Certificate Kit（设备证书服务）/ArkTS API/@ohos.security.cert (证书模块)/js-apis-cert.md>)中的X509Cert。
...
文件系统中的文件，链接到@[ohos.file.fs](<../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md>)中的File。
...
可以随机访问的文件，链接到@[ohos.file.fs](<../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md>)中的RandomAccessFile。
...
提供数据流的形式，链接到@[ohos.file.fs](<../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md>)中的Stream。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fileOrPath | [Path](remote-communication-rcp.md#path) | [LocalFile](remote-communication-rcp.md#localfile) | [ReadFile](remote-communication-rcp.md#readfile) | 是 | 否 | 表示需要上传的文件或者上传文件的路径，参考[应用文件](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/app-file.md>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fileOrPath | [Path](remote-communication-rcp.md#path) | [LocalFile](remote-communication-rcp.md#localfile) | [ReadFile](remote-communication-rcp.md#readfile) | 是 | 表示需要上传的文件或者上传文件的路径，参考[应用文件](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/app-file.md>)。 |
...
将文件下载到文件夹或文件中。如果下载到文件夹，文件名将与服务器中的文件名相同。取值范围为以下表中类型的并集。其中，kind 用于指定想要下载到文件或目录，file 指的是具体需要下载到的目标文件或目录（参考[应用文件](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/app-file.md>)）。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1007900990](../../API错误码/remote-communication-error-code.md#section1007900990-内存不足) | Out of memory. |
...
| contentOrPath | [Path](remote-communication-rcp.md#path) | [FileContent](remote-communication-rcp.md#filecontent) | [GetDataCallback](remote-communication-rcp.md#getdatacallback) | 否 | 否 | 待发送到远程服务器的内容或文件路径。具体允许的类型见链接。 |
...
返回默认的JSON反序列化结果，如需要定制JSON反序列化方式，请参考[JSON解析与生成](<../../../../ArkTS（方舟编程语言）/ArkTS API/@ohos.util.json (JSON解析与生成)/js-apis-json.md>)。
...
6. session.fetch(request).then((response: rcp.Response) => {
7. if (response) {
8. let resJson = response.toJSON();
9. console.info(`response: ${JSON.stringify(resJson)}`);
10. }
11. }).catch((err: BusinessError) => {
12. console.error(`err: error code is ${err.code}, error data is ${err.data}`);
13. });
...
根据解析配置对[toString](remote-communication-rcp.md#tostring)方法返回的字符串进行JSON解析，并返回解析后的结果。详情请参阅[JSON解析与生成](<../../../../ArkTS（方舟编程语言）/ArkTS API/@ohos.util.json (JSON解析与生成)/js-apis-json.md>)的详细介绍。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [json.ParseOptions](<../../../../ArkTS（方舟编程语言）/ArkTS API/@ohos.util.json (JSON解析与生成)/js-apis-json.md#parseoptions>) | 是 | 解析配置项。支持定义处理BigInt的模式。 |
...
| pathToFolder | string | 否 | 否 | 指定存储缓存的文件路径。可以参考[应用文件](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/应用文件/app-file.md>)。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1007900985](../../API错误码/remote-communication-error-code.md#section1007900985-文件系统io错误) | File system IO error. |
...
26. }
27. };
28. await cache.set(key, cachedRecord, policy);
29. } catch (err) {
30. console.error(`Error: error code is ${err.code}, error data is ${err.data}`);
31. }
```
...
4. const session = rcp.createSession();
5. // 获取HTTP响应。
6. const response = await session.get('https://www.example.com');
7. // 根据HTTP响应创建HTTP响应缓存。
8. const cachedRecord = rcp.createCachedResponse(response);
9. console.info(`createCachedResponse result is ${JSON.stringify(cachedRecord)}`);
10. } catch (err) {
11. console.error(`Error: error code is ${err.code}, error data is ${err.data}`);
12. }
```
