...
content_hash: sha256:0eeb3a3e99fe6ec6e89a03ce1be8fffa20c542d59e77ca3dc065e0f53c2c89f0
---
...
| request | object | 是 | URPC请求对象。对象体积最大值为1MB。如果超出最大值，抛出错误码[1007910001](../../API错误码/remote-communication-error-code.md#section1007910001-请求数据传输错误)。 |
| returnValue | object | 是 | URPC响应对象。对象体积最大值为100KB。如果超出最大值，抛出错误码[1007910006](../../API错误码/remote-communication-error-code.md#section1007910006-请求大小达到上限)。 |
...
**错误码：** 错误码的详细介绍请参见[API错误码](../../API错误码/remote-communication-error-code.md)。
