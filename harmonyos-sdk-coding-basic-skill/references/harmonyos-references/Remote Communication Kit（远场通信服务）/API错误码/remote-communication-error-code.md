...
scraped_at: 2026-06-11T16:15:43+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:e7677762ac0e2e7fa940cbf0eabe4cbd40df04f2135368251d5cb71a6eb3bf81
---
说明
...
当请求数据量超大时推荐使用[OnDataReceive](<../../网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#ondatareceive>)。
...
可能是因为[StaticDnsRule](<../../网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#staticdnsrule>)或者[DynamicDnsRule](<../../网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#dynamicdnsrule>)传入的IP地址格式不正确。

**处理步骤**

确认[StaticDnsRule](<../../网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#staticdnsrule>)或者[DynamicDnsRule](<../../网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#dynamicdnsrule>)传入参数格式是否正确可用。
...
通过使用[PathPreference](<../../网络/Remote Communication Kit（远场通信服务）/ArkTS API/rcp（数据请求）/remote-communication-rcp.md#pathpreference>)的'cellular'模式拉起蜂窝数据连接时，因为条件不满足而导致激活蜂窝超时。
...
URPC请求超出开发者配置的[UrpcConnectConfiguration](<../../网络/Remote Communication Kit（远场通信服务）/ArkTS API/urpc（高性能rpc通信库）/remote-communication-urpcapi.md#urpcconnectconfiguration>)时长。
...
排查[UrpcStub](<../../网络/Remote Communication Kit（远场通信服务）/ArkTS API/urpc（高性能rpc通信库）/remote-communication-urpcapi.md#urpcstub>)类的声明和使用是否正确。
