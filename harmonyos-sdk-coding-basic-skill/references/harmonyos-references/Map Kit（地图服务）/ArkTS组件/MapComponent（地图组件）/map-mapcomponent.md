...
scraped_at: 2026-06-01T16:36:38+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:594fb7e083ffef89e62b766b635e2c84c213da93ac463d69a81a4fd319934be5
---
...
| --- | --- | --- | --- | --- | --- |
| mapOptions | [mapCommon.MapOptions](<../../ArkTS API/mapCommon（地图属性模型）/map-common.md#mapoptions>) | 否 | 否 | NA | 地图初始化参数。 |
| mapCallback | AsyncCallback<[map.MapComponentController](<../../ArkTS API/map（地图显示功能）/Class (MapComponentController)/map-map-mapcomponentcontroller.md>)> | 否 | 否 | NA | 回调函数，当地图初始化成功，err为undefined，data为获取到的[map.MapComponentController](<../../ArkTS API/map（地图显示功能）/Class (MapComponentController)/map-map-mapcomponentcontroller.md>)；否则为错误对象。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| markerDelegate | [map.MarkerDelegate](<../../ArkTS API/map（地图显示功能）/Interface (MarkerDelegate)/map-map-markerdelegate.md>) | 是 | 用于表示代理对象的标记。 |
