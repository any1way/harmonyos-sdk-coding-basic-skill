...
scraped_at: 2026-06-01T16:36:20+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:da1d6f4bace01109aac66d2dc24530b98b0881522b6b1e496189ff267769487c
---
本模块提供路径规划功能。
...
2. // 这些坐标为示例数据，实际应用中应通过定位服务或用户输入动态获取
3. origins: [{
4. "latitude": 31.9821213545843,
5. "longitude": 120.27745557768591
6. }],
7. destination: {
8. "latitude": 31.983545843,
9. "longitude": 120.27745557768591
10. },
11. waypoints: [
12. { "latitude": 31.967236140819114, "longitude": 120.27142088866847 },
13. { "latitude": 31.972868002238872, "longitude": 120.2943211817165 },
14. { "latitude": 31.98469327973332, "longitude": 120.29101107384068 }
15. ],
16. language: "zh_CN"
17. };
18. const result = await navi.getDrivingRoutes(params);
19. console.info("Succeeded in getting driving routes.");
```
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| waypoints | Array<[mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng)> | 否 | 是 | 途经点。最多可以输入5个途经点，异常值不处理。 |
...
| overviewPolyline | Array<[mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng)> | 否 | 是 | 表示该路线的编码后的折线经纬度。 |
...
| startLocation | [mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng) | 否 | 否 | 出发地的经纬度。 |
| startAddress | string | 否 | 是 | startLocation对应的地址详情。 |
| endLocation | [mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng) | 否 | 否 | 目的地的经纬度。 |
...
| startLocation | [mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng) | 否 | 否 | 出发地的经纬度。 |
| endLocation | [mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng) | 否 | 否 | 目的地的经纬度。 |
| polyline | Array<[mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng)> | 否 | 否 | 此路段的一系列坐标点（包含起点和终点坐标）。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| northeast | [mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng) | 否 | 否 | 东北角的位置。 |
| southwest | [mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng) | 否 | 否 | 西南角的位置。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| location | [mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng) | 否 | 否 | 途经点的经纬度。 |
...
| polyline | Array<[mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng)> | 否 | 否 | 路段的形状坐标。 |
...
| polyline | [mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng)[] | 否 | 是 | 路线的形状坐标。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| location | [mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng) | 否 | 否 | 地点的坐标。 |
...
| polyline | [mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng)[] | 否 | 否 | 路线的形状坐标。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| points | Array<[mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng)> | 否 | 否 | 道路贴合点集合，集合个数取值范围：[1,100]，且相邻两个点距离需小于等于500米。 |
