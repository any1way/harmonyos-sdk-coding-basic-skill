...
scraped_at: 2026-06-01T16:35:35+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:4fc398694088206deb19f6fb0cd6dad9fe1fef8bae96697fe5955481a5a61499
---
## 导入模块
...
覆盖物基础类。[Marker](<../Interface (Marker)/map-map-marker.md>)、[MapPolyline](<../Interface (MapPolyline)/map-map-mappolyline.md>)、[MapPolygon](<../Interface (MapPolygon)/map-map-mappolygon.md>)、[MapCircle](<../Interface (MapCircle)/map-map-mapcircle.md>)、[MapArc](<../Interface (MapArc)/map-map-maparc.md>)、[ImageOverlay](<../Interface (ImageOverlay)/map-map-imageoverlay.md>)、[BasePriorityOverlay](<../Interface (BasePriorityOverlay)/map-map-basepriorityoverlay.md>)等覆盖物继承该基础类。
