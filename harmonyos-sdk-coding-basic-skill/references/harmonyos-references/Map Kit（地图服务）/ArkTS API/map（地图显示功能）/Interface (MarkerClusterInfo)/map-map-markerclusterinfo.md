...
scraped_at: 2026-06-01T16:36:07+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:4db1d18d4e39ff4076188621e4880d7abdc5ec094fdc1166993d2a0f07188d9a
---
## 导入模块
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| marker | [Marker](<../Interface (Marker)/map-map-marker.md>) | 否 | 否 | 聚合图层的标记。 |
| clusterItems | Array<[mapCommon.ClusterItem](../../mapCommon（地图属性模型）/map-common.md#clusteritem)> | 否 | 否 | 聚合节点数组。 |
