...
scraped_at: 2026-06-01T16:35:56+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:457826088fe51b1d7a038f4de4f63b52f078ca57d7c290f9dfb5c2a932b4c052
---
## 导入模块
...
动画类的集合，继承[Animation](<../Class (Animation)/map-map-animation.md>)。
...
动画类集合继承[Animation](<../Class (Animation)/map-map-animation.md>)方法，仅shareInterpolator为true时共享插值器，其他属性不共享，不支持设置。
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| animation | [Animation](<../Class (Animation)/map-map-animation.md>) | 是 | 动画类集合增加动画。 |
