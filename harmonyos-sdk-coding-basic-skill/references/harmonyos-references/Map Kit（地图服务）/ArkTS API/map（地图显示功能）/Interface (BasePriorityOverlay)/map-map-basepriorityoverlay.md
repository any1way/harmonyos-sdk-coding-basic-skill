...
content_hash: sha256:ab46ea839aa6bd72436f1170306421d9e8d380dbb1ff67100d68e5cf440d7f95
---
## 导入模块
...
具有优先级控制的覆盖物基础类，继承[BaseOverlay](<../Interface (BaseOverlay)/map-map-baseoverlay.md>)。[PointAnnotation](<../Interface (PointAnnotation)/map-map-pointannotation.md>)和[Bubble](<../Interface (Bubble)/map-map-bubble.md>)继承该基础类。
...
设置覆盖物的动画。仅支持[AlphaAnimation](<../Class (AlphaAnimation)/map-map-alphaanimation.md>)、[ScaleAnimation](<../Class (ScaleAnimation)/map-map-scaleanimation.md>)和[AnimationSet](<../Class (AnimationSet)/map-map-animationset.md>)。
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| animation | [Animation](<../Class (Animation)/map-map-animation.md>) | 是 | 动画。 |
