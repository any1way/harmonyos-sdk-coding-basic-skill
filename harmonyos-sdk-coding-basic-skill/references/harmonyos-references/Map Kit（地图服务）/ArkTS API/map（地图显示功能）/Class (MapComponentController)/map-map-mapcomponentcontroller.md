...
scraped_at: 2026-06-01T16:35:38+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:37e34af60c8c04a77c2e67c666fbca7168eada8a3868ba20dced7636b5e47b4d
---
## 导入模块
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| update | [CameraUpdate](<../Interface (CameraUpdate)/map-map-cameraupdate.md>) | 是 | 相机状态将要发生的变化，异常值不处理。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| update | [CameraUpdate](<../Interface (CameraUpdate)/map-map-cameraupdate.md>) | 是 | 相机状态将要发生的变化，异常值返回401错误码。 |
| duration | number | 否 | 动画的持续时间，单位：ms，默认值为250，取值范围：大于0，异常值按默认值处理。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AnimateResult](<../Interface (AnimateResult)/map-map-animateresult.md>)> | Promise对象，返回[AnimateResult](<../Interface (AnimateResult)/map-map-animateresult.md>)。 |
...
在指定的持续时间内以动画的形式更新相机状态，并更新指定的marker。使用Promise异步回调。相机移动过程中不能被打断，否则[AnimateResult](<../Interface (AnimateResult)/map-map-animateresult.md>)的参数isCanceled返回值为true。
...
| --- | --- | --- | --- |
| update | [CameraUpdate](<../Interface (CameraUpdate)/map-map-cameraupdate.md>) | 是 | 相机状态将要发生的变化，异常值不处理。 |
| marker | [Marker](<../Interface (Marker)/map-map-marker.md>) | 是 | 标记，异常值不处理。 |
...
| --- | --- | --- | --- |
| update | [CameraUpdate](<../Interface (CameraUpdate)/map-map-cameraupdate.md>) | 是 | 相机状态将要发生的变化，异常值返回401错误码。 |
| markers | Array<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 是 | 一组标记。  **说明：**  一组标记的位置必须相同，否则会返回401错误码。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.CameraPosition](../../mapCommon（地图属性模型）/map-common.md#cameraposition) | 相机的当前状态信息。 |
...
指定一个[mapCommon.LatLngBounds](../../mapCommon（地图属性模型）/map-common.md#latlngbounds)来约束相机目标，使用户移动地图时，相机目标不会移出此边界。当设置新的边界时，新边界将覆盖之前设置的边界。
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| bounds | [mapCommon.LatLngBounds](../../mapCommon（地图属性模型）/map-common.md#latlngbounds) | 是 | 约束相机目标的边界，异常值不处理。  **说明：**  西南角纬度大于东北角纬度时不生效。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](../../mapCommon（地图属性模型）/map-common.md#mappoint) | 是 | 屏幕坐标点，异常值不处理。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| location | [geoLocationManager.Location](<../../../../Location Kit（位置服务）/ArkTS API/@ohos.geoLocationManager (位置服务)/js-apis-geolocationmanager.md#location>) | 是 | 用户的位置，异常值不处理。  **说明：**  location参数需使用WGS84坐标系。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| style | [mapCommon.MyLocationStyle](../../mapCommon（地图属性模型）/map-common.md#mylocationstyle) | 是 | 用户的位置样式，异常值不处理。  **说明：**  如果displayType（定位图标的展示样式）使用FOLLOW\_ROTATE（连续定位模式）需应用申请传感器权限：ohos.permission.ACCELEROMETER，具体可参考[声明权限](../../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| alignment | [mapCommon.LogoAlignment](../../mapCommon（地图属性模型）/map-common.md#logoalignment) | 是 | 地图Logo的对齐方式，异常值不处理。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| padding | [mapCommon.Padding](../../mapCommon（地图属性模型）/map-common.md#padding) | 是 | 地图边界与Logo之间的间距，异常值不处理。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| options | [mapCommon.MarkerOptions](../../mapCommon（地图属性模型）/map-common.md#markeroptions) | 是 | 标记的属性设置。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[Marker](<../Interface (Marker)/map-map-marker.md>)> | Promise对象，返回[Marker](<../Interface (Marker)/map-map-marker.md>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| options | [mapCommon.MapCircleOptions](../../mapCommon（地图属性模型）/map-common.md#mapcircleoptions) | 是 | 圆的属性设置。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[MapCircle](<../Interface (MapCircle)/map-map-mapcircle.md>)> | Promise对象，返回[MapCircle](<../Interface (MapCircle)/map-map-mapcircle.md>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| options | [mapCommon.MapPolylineOptions](../../mapCommon（地图属性模型）/map-common.md#mappolylineoptions) | 是 | 折线的属性设置。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[MapPolyline](<../Interface (MapPolyline)/map-map-mappolyline.md>)> | Promise对象，返回[MapPolyline](<../Interface (MapPolyline)/map-map-mappolyline.md>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| options | [mapCommon.MapPolygonOptions](../../mapCommon（地图属性模型）/map-common.md#mappolygonoptions) | 是 | 多边形的属性设置。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[MapPolygon](<../Interface (MapPolygon)/map-map-mappolygon.md>)> | Promise对象，返回[MapPolygon](<../Interface (MapPolygon)/map-map-mappolygon.md>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.PointAnnotationParams](../../mapCommon（地图属性模型）/map-common.md#pointannotationparams) | 是 | 点注释的属性设置。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[PointAnnotation](<../Interface (PointAnnotation)/map-map-pointannotation.md>)> | Promise对象，返回[PointAnnotation](<../Interface (PointAnnotation)/map-map-pointannotation.md>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.BubbleParams](../../mapCommon（地图属性模型）/map-common.md#bubbleparams) | 是 | 气泡的属性设置。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[Bubble](<../Interface (Bubble)/map-map-bubble.md>)> | Promise对象，返回[Bubble](<../Interface (Bubble)/map-map-bubble.md>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| padding | [mapCommon.Padding](../../mapCommon（地图属性模型）/map-common.md#padding) | 否 | 地图和边界的距离，异常值不处理。 |
...
| 类型 | 说明 |
| --- | --- |
| [Projection](<../Interface (Projection)/map-map-projection.md>) | [Projection](<../Interface (Projection)/map-map-projection.md>)对象。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| customMapStyleOptions | [mapCommon.CustomMapStyleOptions](../../mapCommon（地图属性模型）/map-common.md#custommapstyleoptions) | 是 | 自定义样式参数，异常值不处理。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.DayNightMode](../../mapCommon（地图属性模型）/map-common.md#daynightmode) | 日间夜间模式。  - DayNightMode.DAY：日间模式  - DayNightMode.NIGHT：夜间模式  - DayNightMode.AUTO：自动模式，如果系统打开深色开关，显示夜间模式，否则显示日间模式 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| mode | [mapCommon.DayNightMode](../../mapCommon（地图属性模型）/map-common.md#daynightmode) | 是 | 日间夜间模式，异常值不处理。 |
...
| **类型** | **说明** |
| --- | --- |
| [mapCommon.MapType](../../mapCommon（地图属性模型）/map-common.md#maptype) | 查询地图的类型。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| mapType | [mapCommon.MapType](../../mapCommon（地图属性模型）/map-common.md#maptype) | 是 | 地图类型，异常值不处理。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](../../mapCommon（地图属性模型）/map-common.md#mappoint) | 是 | 比例尺位置，异常值不处理。  **说明：**  比例尺在穿戴设备上默认处于左右居中位置，接口传入的positionX值在穿戴设备上不显示效果。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](../../mapCommon（地图属性模型）/map-common.md#mappoint) | 是 | 设置指南针位置，即指南针左上角相对地图组件左上角的偏移量，单位：px，异常值不处理。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.ClusterOverlayParams](../../mapCommon（地图属性模型）/map-common.md#clusteroverlayparams) | 是 | 聚合图层参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[ClusterOverlay](<../Interface (ClusterOverlay)/map-map-clusteroverlay.md>)> | Promise对象，返回[ClusterOverlay](<../Interface (ClusterOverlay)/map-map-clusteroverlay.md>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.ImageOverlayParams](../../mapCommon（地图属性模型）/map-common.md#imageoverlayparams) | 是 | 覆盖物参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[ImageOverlay](<../Interface (ImageOverlay)/map-map-imageoverlay.md>)> | Promise对象，返回[ImageOverlay](<../Interface (ImageOverlay)/map-map-imageoverlay.md>)。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | Promise对象，返回[image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.BuildingOverlayParams](../../mapCommon（地图属性模型）/map-common.md#buildingoverlayparams) | 是 | 3D建筑相关属性。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[BuildingOverlay](<../Interface (BuildingOverlay)/map-map-buildingoverlay.md>)> | Promise对象，返回[BuildingOverlay](<../Interface (BuildingOverlay)/map-map-buildingoverlay.md>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.TraceOverlayParams](../../mapCommon（地图属性模型）/map-common.md#traceoverlayparams) | 是 | 动态轨迹参数。 |
| markers | Array<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 否 | 动态轨迹的图片数组，异常值不处理。  **说明：**  一组标记的位置必须相同。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[TraceOverlay](<../Interface (TraceOverlay)/map-map-traceoverlay.md>)> | Promise对象，返回[TraceOverlay](<../Interface (TraceOverlay)/map-map-traceoverlay.md>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.MapArcParams](../../mapCommon（地图属性模型）/map-common.md#maparcparams) | 是 | 弧线的相关属性。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| MapArc | 返回[MapArc](<../Interface (MapArc)/map-map-maparc.md>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| types | Array<[mapCommon.MapElementType](../../mapCommon（地图属性模型）/map-common.md#mapelementtype)> | 是 | 四类地图元素的显示顺序，默认顺序为[1, 2, 3, 4]。  入参的长度必须是4，且必须是[mapCommon.MapElementType](../../mapCommon（地图属性模型）/map-common.md#mapelementtype)的4个取值，如果不满足，则返回错误码401。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.HeatmapParams](../../mapCommon（地图属性模型）/map-common.md#heatmapparams) | 是 | 添加热力图的参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[Heatmap](<../Interface (Heatmap)/map-map-heatmap.md>)> | Promise对象，返回[Heatmap](<../Interface (Heatmap)/map-map-heatmap.md>)，热力图覆盖物。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.MvtOverlayParams](../../mapCommon（地图属性模型）/map-common.md#mvtoverlayparams) | 是 | 矢量图层的参数。  **说明：**  使用在线下载方式添加矢量图层时（即使用[mapCommon.MvtOverlayParams](../../mapCommon（地图属性模型）/map-common.md#mvtoverlayparams)中[mapCommon.MvtSource](../../mapCommon（地图属性模型）/map-common.md#mvtsource)参数的tileUrl方式），需要申请访问网络的权限：ohos.permission.INTERNET。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [MvtOverlay](<../Interface (MvtOverlay)/map-map-mvtoverlay.md>) | 矢量图层管理对象。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.FlowFieldOverlayParams](../../mapCommon（地图属性模型）/map-common.md#flowfieldoverlayparams) | 是 | 流场图层的参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[FlowFieldOverlay](<../Interface (FlowFieldOverlay)/map-map-flowfieldoverlay.md>)> | Promise对象，返回流场图层的管理对象。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.MassPointOverlayParams](../../mapCommon（地图属性模型）/map-common.md#masspointoverlayparams) | 是 | 海量点图层的参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[MassPointOverlay](<../Interface (MassPointOverlay)/map-map-masspointoverlay.md>)> | Promise对象，返回海量点的管理对象。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| language | string | 是 | 地图语言，异常值不处理。语种取值请参见[地图组件支持语言](<../../../../../harmonyos-guides/应用服务/Map Kit（地图服务）/附录/支持的语言/map-language.md#地图组件支持语言>)列表。 |
...
| 类型 | 说明 |
| --- | --- |
| string | 地图语言。语种取值请参见[地图组件支持语言](<../../../../../harmonyos-guides/应用服务/Map Kit（地图服务）/附录/支持的语言/map-language.md#地图组件支持语言>)列表。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| isBelow | boolean | 是 | 我的位置图层是否位于覆盖物之下，异常值不处理。  - true：我的位置图层位于覆盖物之下  - false：我的位置图层位于覆盖物之上  **说明：**  该接口对[Marker](<../Interface (Marker)/map-map-marker.md>)、[MapPolyline](<../Interface (MapPolyline)/map-map-mappolyline.md>)、[MapPolygon](<../Interface (MapPolygon)/map-map-mappolygon.md>)、[MapCircle](<../Interface (MapCircle)/map-map-mapcircle.md>)、[PointAnnotation](<../Interface (PointAnnotation)/map-map-pointannotation.md>)、[Bubble](<../Interface (Bubble)/map-map-bubble.md>)、[ImageOverlay](<../Interface (ImageOverlay)/map-map-imageoverlay.md>)、[MapArc](<../Interface (MapArc)/map-map-maparc.md>)、[TraceOverlay](<../Interface (TraceOverlay)/map-map-traceoverlay.md>)、底图[Poi](../../mapCommon（地图属性模型）/map-common.md#poi)生效。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| params | [mapCommon.TileOverlayParams](../../mapCommon（地图属性模型）/map-common.md#tileoverlayparams) | [mapCommon.TileOverlayOptions](../../mapCommon（地图属性模型）/map-common.md#tileoverlayoptions) | 是 | 瓦片图层参数。  **说明：**  从6.0.0(20)版本开始，params属性支持[mapCommon.TileOverlayOptions](../../mapCommon（地图属性模型）/map-common.md#tileoverlayoptions)类型。 |
...
建议使用[MapEventManager.on(type: 'cameraChange')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#oncamerachange>)。
...
| callback | Callback<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 是 | 回调函数，返回[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)，监听地图相机状态变化事件。该回调不会在动画过程中触发，而是在动画结束时触发。 |
...
建议使用[MapEventManager.off(type: 'cameraChange')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offcamerachange>)。
...
建议使用[MapEventManager.on(type: 'cameraIdle')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#oncameraidle>)。
...
建议使用[MapEventManager.off(type: 'cameraIdle')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offcameraidle>)。
...
建议使用[MapEventManager.on(type: 'cameraMoveCancel')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#oncameramovecancel>)。
...
建议使用[MapEventManager.off(type: 'cameraMoveCancel')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offcameramovecancel>)。
...
建议使用[MapEventManager.on(type: 'cameraMove')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#oncameramove>)。
...
建议使用[MapEventManager.off(type: 'cameraMove')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offcameramove>)。
...
建议使用[MapEventManager.on(type: 'cameraMoveStart')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#oncameramovestart>)。
...
建议使用[MapEventManager.off(type: 'cameraMoveStart')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offcameramovestart>)。
...
建议使用[MapEventManager.on(type: 'mapClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onmapclick>)。
...
| callback | Callback<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 是 | 回调函数，返回[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)。 |
...
建议使用[MapEventManager.off(type: 'mapClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offmapclick>)。
...
建议使用[MapEventManager.on(type: 'mapLoad')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onmapload>)。
...
建议使用[MapEventManager.off(type: 'mapLoad')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offmapload>)。
...
建议使用[MapEventManager.on(type: 'mapLongClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onmaplongclick>)。
...
建议使用[MapEventManager.off(type: 'mapLongClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offmaplongclick>)。
...
建议使用[MapEventManager.on(type: 'myLocationButtonClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onmylocationbuttonclick>)。
...
建议使用[MapEventManager.off(type: 'myLocationButtonClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offmylocationbuttonclick>)。
...
建议使用[MapEventManager.on(type: 'myLocationClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onmylocationclick>)。
...
建议使用[MapEventManager.off(type: 'myLocationClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offmylocationclick>)。
...
建议使用[MapEventManager.on(type: 'poiClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onpoiclick>)。
...
| callback | Callback<[mapCommon.Poi](../../mapCommon（地图属性模型）/map-common.md#poi)> | 是 | 回调函数，返回[mapCommon.Poi](../../mapCommon（地图属性模型）/map-common.md#poi)。 |
...
建议使用[MapEventManager.off(type: 'poiClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offpoiclick>)。
...
建议使用[MapEventManager.on(type: 'markerClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onmarkerclick>)。
...
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 是 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)。 |
...
建议使用[MapEventManager.off(type: 'markerClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offmarkerclick>)。
...
建议使用[MapEventManager.on(type: 'markerDragStart')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onmarkerdragstart>)。
...
建议使用[MapEventManager.off(type: 'markerDragStart')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offmarkerdragstart>)。
...
建议使用[MapEventManager.on(type: 'markerDrag')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onmarkerdrag>)。
...
建议使用[MapEventManager.off(type: 'markerDrag')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offmarkerdrag>)。
...
建议使用[MapEventManager.on(type: 'markerDragEnd')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onmarkerdragend>)。
...
建议使用[MapEventManager.off(type: 'markerDragEnd')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offmarkerdragend>)。
...
建议使用[MapEventManager.on(type: 'circleClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#oncircleclick>)。
...
| callback | Callback<[MapCircle](<../Interface (MapCircle)/map-map-mapcircle.md>)> | 是 | 回调函数，返回[MapCircle](<../Interface (MapCircle)/map-map-mapcircle.md>)。 |
...
建议使用[MapEventManager.off(type: 'circleClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offcircleclick>)。
...
建议使用[MapEventManager.on(type: 'polylineClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onpolylineclick>)。
...
| callback | Callback<[MapPolyline](<../Interface (MapPolyline)/map-map-mappolyline.md>)> | 是 | 回调函数，返回[MapPolyline](<../Interface (MapPolyline)/map-map-mappolyline.md>)。 |
...
建议使用[MapEventManager.off(type: 'polylineClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offpolylineclick>)。
...
建议使用[MapEventManager.on(type: 'polygonClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onpolygonclick>)。
...
| callback | Callback<[MapPolygon](<../Interface (MapPolygon)/map-map-mappolygon.md>)> | 是 | 回调函数，返回[MapPolygon](<../Interface (MapPolygon)/map-map-mappolygon.md>)。 |
...
建议使用[MapEventManager.off(type: 'polygonClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offpolygonclick>)。
...
建议使用[MapEventManager.on(type: 'infoWindowClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#oninfowindowclick>)。
...
建议使用[MapEventManager.off(type: 'infoWindowClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offinfowindowclick>)。
...
建议使用[MapEventManager.on(type: 'infoWindowClose')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#oninfowindowclose>)。
...
建议使用[MapEventManager.off(type: 'infoWindowClose')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offinfowindowclose>)。
...
建议使用[MapEventManager.on(type: 'pointAnnotationClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onpointannotationclick>)。
...
| callback | Callback<[PointAnnotation](<../Interface (PointAnnotation)/map-map-pointannotation.md>)> | 是 | 回调函数，返回[PointAnnotation](<../Interface (PointAnnotation)/map-map-pointannotation.md>)。 |
...
建议使用[MapEventManager.off(type: 'pointAnnotationClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offpointannotationclick>)。
...
建议使用[MapEventManager.on(type: 'bubbleClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onbubbleclick>)。
...
| callback | Callback<[Bubble](<../Interface (Bubble)/map-map-bubble.md>)> | 是 | 回调函数，返回[Bubble](<../Interface (Bubble)/map-map-bubble.md>)。 |
...
建议使用[MapEventManager.off(type: 'bubbleClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offbubbleclick>)。
...
建议使用[MapEventManager.on(type: 'imageOverlayClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onimageoverlayclick>)。
...
| callback | Callback<[ImageOverlay](<../Interface (ImageOverlay)/map-map-imageoverlay.md>)> | 是 | 回调函数，返回[ImageOverlay](<../Interface (ImageOverlay)/map-map-imageoverlay.md>)。 |
...
建议使用[MapEventManager.off(type: 'imageOverlayClick')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offimageoverlayclick>)。
...
| --- | --- | --- | --- |
| type | string | 是 | 'imageOverlayClick'：监听覆盖物点击事件。 |
| callback | Callback<[ImageOverlay](<../Interface (ImageOverlay)/map-map-imageoverlay.md>)> | 否 | 回调函数，返回[ImageOverlay](<../Interface (ImageOverlay)/map-map-imageoverlay.md>)，当不填时清除所有监听回调。 |
...
建议使用[MapEventManager.on(type: 'error')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onerror>)。
...
| callback | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 是 | 回调函数，监听异常事件的回调。 |
...
建议使用[MapEventManager.off(type: 'error')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#offerror>)。
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| buildingId | string | 是 | 建筑物的ID。从[on('indoorMapEnter')](<../Interface (MapEventManager)/map-map-mapeventmanager.md#onindoormapenter>)方法的回调函数中获得，异常值不处理。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](../../mapCommon（地图属性模型）/map-common.md#mappoint) | 是 | 设置楼层调节控件的位置，单位：px，异常值不处理。 |
