...
scraped_at: 2026-06-11T16:46:19+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:c34ce8b32210cc2721abaeece58e46fbe16e6fc2e05a2e8d5146e497dace59be
---
## 导入模块
...
标记，继承[BaseOverlay](<../Interface (BaseOverlay)/map-map-baseoverlay.md>)。在调用map.[MapComponentController](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md>)类的[addMarker](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md#addmarker>)方法时会返回该类型的实例。
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng) | 标记的位置。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/Hd5REJj3Svmm3Nt-QBCMUA/zh-cn_image_0000002622860815.png?HW-CC-KV=V1&HW-CC-Date=20260611T084617Z&HW-CC-Expire=86400&HW-CC-Sign=520A0DD05D838802303AAA70FA2C3A5EBE4D4E99062AD24499B8AA836D529B28)
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| latLng | [mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng) | 是 | 标记的位置坐标，异常值不处理。 |
...
设置标记的动画，不支持[FontSizeAnimation](<../Class (FontSizeAnimation)/map-map-fontsizeanimation.md>)。
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| animation | [Animation](<../Class (Animation)/map-map-animation.md>) | 是 | 动画，异常值不处理。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| iconBuilder | [CustomBuilder](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 自定义组件，异常值不处理。 |
