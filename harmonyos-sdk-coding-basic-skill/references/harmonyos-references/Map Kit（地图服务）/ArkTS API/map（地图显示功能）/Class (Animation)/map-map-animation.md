...
scraped_at: 2026-06-01T16:35:49+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:592cd9f0576c717634ca9a9dc03b072f156106045066d3f8ececacff63ba58ae
---
## 导入模块
...
动画执行完成后的状态，默认值为[AnimationFillMode](../Enums/map-map-enums.md#animationfillmode).FORWARDS；

动画插值器，默认值为[Curve](<../../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curve>).Linear；

动画重复执行的次数，默认值为0；

重复执行的模式，默认值为[AnimationRepeatMode](../Enums/map-map-enums.md#animationrepeatmode).RESTART。
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| fillMode | [AnimationFillMode](../Enums/map-map-enums.md#animationfillmode) | 是 | 动画执行完成后的状态。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| curve | [Curves.Curve](<../../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curve>) | 是 | 动画插值器。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| repeatMode | [AnimationRepeatMode](../Enums/map-map-enums.md#animationrepeatmode) | 是 | 重复执行的模式。 |
