...
scraped_at: 2026-06-01T16:35:47+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:406d115ecc95d4226484b9561df9e4caf88aba54a083229aecd6fd3cca0bebd8
---
## 导入模块
...
用于在屏幕坐标和经纬度之间进行转换，在调用map.[MapComponentController](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md>)类的[getProjection](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md#getprojection>)方法时会返回该类型的实例。
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| point | [mapCommon.MapPoint](../../mapCommon（地图属性模型）/map-common.md#mappoint) | 是 | 屏幕上的坐标点，单位：px，异常值不处理。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng) | 经纬度坐标。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| position | [mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng) | 是 | 经纬度坐标，异常值不处理。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [mapCommon.MapPoint](../../mapCommon（地图属性模型）/map-common.md#mappoint) | 屏幕上的坐标点，单位：px。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.VisibleRegion](../../mapCommon（地图属性模型）/map-common.md#visibleregion) | 可见区域。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| center | [mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng) | 是 | 中心点经纬度坐标，异常值不处理。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLngBounds](../../mapCommon（地图属性模型）/map-common.md#latlngbounds) | 目标区域。 |
