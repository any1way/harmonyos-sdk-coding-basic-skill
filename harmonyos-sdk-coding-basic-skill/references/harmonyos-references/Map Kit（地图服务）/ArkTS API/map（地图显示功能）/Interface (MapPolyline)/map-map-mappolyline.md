...
scraped_at: 2026-06-01T16:35:41+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:a3717989375ca20ef0f75dde7fb981ce897b6ad52c44bfd65b77ecce928ebb7f
---
## 导入模块
...
折线，继承[BaseOverlay](<../Interface (BaseOverlay)/map-map-baseoverlay.md>)。在调用map.[MapComponentController](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md>)类的[addPolyline](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md#addpolyline>)方法时会返回该类型的实例。
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.CapStyle](../../mapCommon（地图属性模型）/map-common.md#capstyle) | 折线的末尾端点样式。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.JointType](../../mapCommon（地图属性模型）/map-common.md#jointtype) | 折线除起始和结束顶点之外的所有顶点的节点类型属性。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[mapCommon.PatternItem](../../mapCommon（地图属性模型）/map-common.md#patternitem)> | 折线的样式属性。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 折线的顶点坐标属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.CapStyle](../../mapCommon（地图属性模型）/map-common.md#capstyle) | 折线的起始端点样式。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| endCap | [mapCommon.CapStyle](../../mapCommon（地图属性模型）/map-common.md#capstyle) | 是 | 折线的末尾端点样式，异常值不处理。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| jointType | [mapCommon.JointType](../../mapCommon（地图属性模型）/map-common.md#jointtype) | 是 | 节点类型，异常值不处理。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| patterns | Array<[mapCommon.PatternItem](../../mapCommon（地图属性模型）/map-common.md#patternitem)> | 是 | [PatternItem](../../mapCommon（地图属性模型）/map-common.md#patternitem)对象的集合，异常值不处理。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| points | Array<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 是 | 折线顶点的集合。默认情况下，折线不闭合；要形成闭合的折线，起点和终点必须相同，异常值不处理。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| startCap | [mapCommon.CapStyle](../../mapCommon（地图属性模型）/map-common.md#capstyle) | 是 | 折线的起始端点样式，异常值不处理。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| customTexture | [ResourceStr](../../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 折线纹理。建议纹理使用没有背景色（透明色）的图片，异常值不处理。 |
