...
content_hash: sha256:e53d2637fcafa9d02dca0636b1f0b27f589dccbc6a8d1db443a0674ece9b1384
---
## 导入模块
...
点注释，继承[BasePriorityOverlay](<../Interface (BasePriorityOverlay)/map-map-basepriorityoverlay.md>)。在调用map.[MapComponentController](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md>)类的[addPointAnnotation](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md#addpointannotation>)方法时会返回该类型的实例。
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng) | 点注释的锚点坐标。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.Text](../../mapCommon（地图属性模型）/map-common.md#text) | 获取点注释第一标题的属性。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| text | [mapCommon.Text](../../mapCommon（地图属性模型）/map-common.md#text) | 是 | 第一标题属性（除content），异常值不处理。  **说明：**  约束条件：fontSize、strokeWidth大于等于0。 |
...
| 参数名 | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| animation | [FontSizeAnimation](<../Class (FontSizeAnimation)/map-map-fontsizeanimation.md>) | 是 | 点注释的标题动画。 |
