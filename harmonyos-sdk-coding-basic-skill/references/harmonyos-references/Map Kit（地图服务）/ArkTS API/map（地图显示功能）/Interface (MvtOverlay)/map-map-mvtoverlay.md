...
scraped_at: 2026-06-01T16:36:11+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:60a9ebf49937fab1666fc10b7912503a740ea6dd8bdcbe06a9e0de0e34b7d5ed
---
## 导入模块
...
矢量图层的管理对象。在调用map.[MapComponentController](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md>)类的[addMvtOverlay](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md#addmvtoverlay>)方法时会返回该类型的实例，继承[BaseOverlay](<../Interface (BaseOverlay)/map-map-baseoverlay.md>)。
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| layers | [mapCommon.MvtLayer](../../mapCommon（地图属性模型）/map-common.md#mvtlayer)[] | 是 | 矢量图层，建议矢量图层少于2000层，确保矢量图层的流畅度。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| addedLayers | [mapCommon.MvtLayer](../../mapCommon（地图属性模型）/map-common.md#mvtlayer)[] | 是 | 矢量图层。 |
