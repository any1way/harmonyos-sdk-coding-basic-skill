...
scraped_at: 2026-06-01T16:36:06+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:1dd226cca4a139c07befc29284d36305db271a1248803e22e3b057c3965708b8
---
## 导入模块
...
| --- | --- | --- | --- |
| type | string | 是 | 'cameraChange'：监听地图相机状态变化事件。 |
| callback | Callback<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 否 | 回调函数，返回[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)，取消监听地图相机状态变化事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 是 | 回调函数，返回[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)，监听地图点击事件。 |
...
off(type: 'mapClick', callback?: Callback<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'mapClick'：监听地图点击事件。 |
| callback | Callback<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 否 | 回调函数，返回[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)，取消监听地图点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 是 | 回调函数，返回[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)，监听地图长按事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'mapLongClick'：监听地图长按事件。 |
| callback | Callback<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 否 | 回调函数，返回[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)，取消监听地图长按事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 是 | 回调函数，返回[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)，监听我的位置点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'myLocationClick'：监听我的位置点击事件。 |
| callback | Callback<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 否 | 回调函数，返回[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)，取消监听我的位置点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[mapCommon.Poi](../../mapCommon（地图属性模型）/map-common.md#poi)> | 是 | 回调函数，返回[mapCommon.Poi](../../mapCommon（地图属性模型）/map-common.md#poi)，监听POI点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'poiClick'：监听POI点击事件。 |
| callback | Callback<[mapCommon.Poi](../../mapCommon（地图属性模型）/map-common.md#poi)> | 否 | 回调函数，返回[mapCommon.Poi](../../mapCommon（地图属性模型）/map-common.md#poi)，取消监听POI点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 是 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)，监听标记点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerClick'：监听标记点击事件。 |
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 否 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)，取消监听标记点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 是 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)，监听标记开始拖拽事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerDragStart'：监听标记开始拖拽事件。 |
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 否 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)，取消监听标记开始拖拽事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 是 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)，监听标记拖拽事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'markerDrag'：监听标记拖拽事件。 |
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 否 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)，取消监听标记拖拽事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 是 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)，监听标记拖拽结束事件。 |
...
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 否 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)，取消监听标记拖拽结束事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[MapCircle](<../Interface (MapCircle)/map-map-mapcircle.md>)> | 是 | 回调函数，返回[MapCircle](<../Interface (MapCircle)/map-map-mapcircle.md>)，监听圆点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'circleClick'：监听圆点击事件。 |
| callback | Callback<[MapCircle](<../Interface (MapCircle)/map-map-mapcircle.md>)> | 否 | 回调函数，返回[MapCircle](<../Interface (MapCircle)/map-map-mapcircle.md>)，取消监听圆点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[MapPolyline](<../Interface (MapPolyline)/map-map-mappolyline.md>)> | 是 | 回调函数，返回[MapPolyline](<../Interface (MapPolyline)/map-map-mappolyline.md>)，监听折线点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'polylineClick'：监听折线点击事件。 |
| callback | Callback<[MapPolyline](<../Interface (MapPolyline)/map-map-mappolyline.md>)> | 否 | 回调函数，返回[MapPolyline](<../Interface (MapPolyline)/map-map-mappolyline.md>)，取消监听折线点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[MapPolygon](<../Interface (MapPolygon)/map-map-mappolygon.md>)> | 是 | 回调函数，返回[MapPolygon](<../Interface (MapPolygon)/map-map-mappolygon.md>)，监听多边形点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'polygonClick'：监听多边形点击事件。 |
| callback | Callback<[MapPolygon](<../Interface (MapPolygon)/map-map-mappolygon.md>)> | 否 | 回调函数，返回[MapPolygon](<../Interface (MapPolygon)/map-map-mappolygon.md>)，取消监听多边形点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 是 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)，监听信息窗点击事件。 |
...
off(type: 'infoWindowClick', callback?: Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)>): void
...
| --- | --- | --- | --- |
| type | string | 是 | 'infoWindowClick'：监听信息窗点击事件。 |
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 否 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)，取消监听信息窗点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 是 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)，监听信息窗关闭事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'infoWindowClose'：监听信息窗关闭事件。 |
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 否 | 回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)，取消监听信息窗关闭事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[PointAnnotation](<../Interface (PointAnnotation)/map-map-pointannotation.md>)> | 是 | 回调函数，返回[PointAnnotation](<../Interface (PointAnnotation)/map-map-pointannotation.md>)，监听点注释点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'pointAnnotationClick'：监听点注释点击事件。 |
| callback | Callback<[PointAnnotation](<../Interface (PointAnnotation)/map-map-pointannotation.md>)> | 否 | 回调函数，返回[PointAnnotation](<../Interface (PointAnnotation)/map-map-pointannotation.md>)，取消监听点注释点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[Bubble](<../Interface (Bubble)/map-map-bubble.md>)> | 是 | 回调函数，返回[Bubble](<../Interface (Bubble)/map-map-bubble.md>)，监听气泡点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'bubbleClick'：监听气泡点击事件。 |
| callback | Callback<[Bubble](<../Interface (Bubble)/map-map-bubble.md>)> | 否 | 回调函数，返回[Bubble](<../Interface (Bubble)/map-map-bubble.md>)，取消监听气泡点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[ImageOverlay](<../Interface (ImageOverlay)/map-map-imageoverlay.md>)> | 是 | 回调函数，返回[ImageOverlay](<../Interface (ImageOverlay)/map-map-imageoverlay.md>)，监听覆盖物点击事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'imageOverlayClick'：监听覆盖物点击事件。 |
| callback | Callback<[ImageOverlay](<../Interface (ImageOverlay)/map-map-imageoverlay.md>)> | 否 | 回调函数，返回[ImageOverlay](<../Interface (ImageOverlay)/map-map-imageoverlay.md>)，取消监听覆盖物点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 是 | 回调函数，返回[ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>)，监听异常事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'error'：监听异常事件。 |
| callback | [ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 否 | 回调函数，返回[ErrorCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>)，取消监听异常事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| callback | Callback<[IndoorMapInfo](<../Interface (IndoorMapInfo)/map-map-indoormapinfo.md>)> | 是 | 回调函数，返回[IndoorMapInfo](<../Interface (IndoorMapInfo)/map-map-indoormapinfo.md>)，监听室内图进入事件。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 'indoorMapEnter'：监听室内图进入事件。 |
| callback | Callback<[IndoorMapInfo](<../Interface (IndoorMapInfo)/map-map-indoormapinfo.md>)> | 否 | 回调函数，返回[IndoorMapInfo](<../Interface (IndoorMapInfo)/map-map-indoormapinfo.md>)，取消监听室内图进入事件。 |
...
| callback | [MassPointOverlayCallback](../types/map-map-types.md#masspointoverlaycallback) | 是 | 回调函数，无返回结果，监听海量点图层点击事件。 |
...
| callback | [MassPointOverlayCallback](../types/map-map-types.md#masspointoverlaycallback) | 否 | 回调函数，无返回结果，取消监听海量点图层点击事件。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 是 | 标记长按事件的回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| callback | Callback<[Marker](<../Interface (Marker)/map-map-marker.md>)> | 否 | 标记长按事件的回调函数，返回[Marker](<../Interface (Marker)/map-map-marker.md>)。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| callback | Callback<[mapCommon.Poi](../../mapCommon（地图属性模型）/map-common.md#poi)> | 是 | 地图上POI长按事件的回调函数，返回[mapCommon.Poi](../../mapCommon（地图属性模型）/map-common.md#poi)。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| callback | Callback<[mapCommon.Poi](../../mapCommon（地图属性模型）/map-common.md#poi)> | 否 | 地图上POI长按事件的回调函数，返回[mapCommon.Poi](../../mapCommon（地图属性模型）/map-common.md#poi)。  - callback为空：取消所有callback回调。  - callback非空：取消指定的callback回调。 |
