...
content_hash: sha256:9c83256ba54cefb78de1280fe25efeb22b7342ef110300599fbdfd1d8fad302a
---
## 导入模块
...
多边形，继承[BaseOverlay](<../Interface (BaseOverlay)/map-map-baseoverlay.md>)。多边形可以是凸面或凹面，它可以跨越180子午线并且可以具有未填充的孔。在调用map.[MapComponentController](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md>)类的[addPolygon](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md#addpolygon>)方法时会返回该类型的实例。
...
| 类型 | 说明 |
| --- | --- |
| Array<Array<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)>> | 多边形的空心洞数组，其中空心洞是[LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 多边形的顶点坐标。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.JointType](../../mapCommon（地图属性模型）/map-common.md#jointtype) | 多边形的顶点样式。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[mapCommon.PatternItem](../../mapCommon（地图属性模型）/map-common.md#patternitem)> | 多边形的边框样式。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| holes | Array<Array<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)>> | 是 | 空心洞数组，其中空心洞是[LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)数组。异常值不处理。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| points | Array<[mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng)> | 是 | 顶点坐标数组。异常值不处理。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| jointType | [mapCommon.JointType](../../mapCommon（地图属性模型）/map-common.md#jointtype) | 是 | 顶点样式，异常值不处理。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| patterns | Array<[mapCommon.PatternItem](../../mapCommon（地图属性模型）/map-common.md#patternitem)> | 是 | [PatternItem](../../mapCommon（地图属性模型）/map-common.md#patternitem)对象的数组，异常值不处理。 |
