...
scraped_at: 2026-06-01T16:35:48+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:39ee20cc9ce68acad5bff190188943ec6eb37f893365240e7437417cbbde8333
---
## 导入模块
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| bounds | [mapCommon.LatLngBounds](../../mapCommon（地图属性模型）/map-common.md#latlngbounds) | 是 | LatLngBounds对象。 |
| position | [mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng) | 是 | 用于判断的位置坐标。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| src | [mapCommon.LatLngBounds](../../mapCommon（地图属性模型）/map-common.md#latlngbounds) | 是 | LatLngBounds对象。 |
| target | [mapCommon.LatLngBounds](../../mapCommon（地图属性模型）/map-common.md#latlngbounds) | 是 | 目标区域。 |
...
| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng) | 中心经纬度坐标。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| position | [mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng) | 是 | 位置坐标。 |
| bounds | [mapCommon.LatLngBounds](../../mapCommon（地图属性模型）/map-common.md#latlngbounds) | 否 | LatLngBounds对象。若为空则创建的LatLngBounds对象只包含位置坐标。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [mapCommon.LatLngBounds](../../mapCommon（地图属性模型）/map-common.md#latlngbounds) | 包含指定位置的LatLngBounds对象。 |
