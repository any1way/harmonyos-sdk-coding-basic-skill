...
scraped_at: 2026-06-01T16:35:43+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:35c4a7fcc24683bc1c5dea89225bb867f4b86b1eb4dd9f1720e83f4b663df193
---
## 导入模块
...
更新和查询圆的接口，继承[BaseOverlay](<../Interface (BaseOverlay)/map-map-baseoverlay.md>)。在调用map.[MapComponentController](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md>)类的[addCircle](<../Class (MapComponentController)/map-map-mapcomponentcontroller.md#addcircle>)方法时会返回该类型的实例。
...
| 类型 | 说明 |
| --- | --- |
| mapCommon.[LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng) | 获取圆心经纬度。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[mapCommon.PatternItem](../../mapCommon（地图属性模型）/map-common.md#patternitem)> | 圆的边框样式。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| center | [mapCommon.LatLng](../../mapCommon（地图属性模型）/map-common.md#latlng) | 是 | 圆心经纬度坐标。  圆的中心点纬度在[-85.051119, 85.051119]范围内才能画出圆。若圆中心点纬度为-85.051119或85.051119时，能画出半径为1米的圆。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| patterns | Array<[mapCommon.PatternItem](../../mapCommon（地图属性模型）/map-common.md#patternitem)> | 是 | 圆的边框样式。 |
