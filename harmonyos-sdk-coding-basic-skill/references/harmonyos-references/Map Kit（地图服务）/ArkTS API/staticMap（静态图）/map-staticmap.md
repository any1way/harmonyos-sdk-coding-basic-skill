...
scraped_at: 2026-06-01T16:36:25+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:7a37c2db9e38623d86ff6c52194735c74425fd1384327441318831b1ff357ee6
---
本模块提供获取静态图功能。
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| location | [mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng) | 否 | 否 | 地图的中心点坐标。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
| logoAlignment | [mapCommon.LogoAlignment](../mapCommon（地图属性模型）/map-common.md#logoalignment) | 否 | 是 | 地图logo的对齐模式，默认为BOTTOM\_START，表示左下角。  **元服务API：** 从版本4.1.0(11)开始，该接口支持在元服务中使用。 |
...
| dayNightMode | [mapCommon.DayNightMode](../mapCommon（地图属性模型）/map-common.md#daynightmode) | 否 | 是 | 昼夜模式，默认值为[mapCommon.DayNightMode](../mapCommon（地图属性模型）/map-common.md#daynightmode).DAY。  **起始版本：** 5.0.0(12)  **元服务API：** 从版本5.0.0(12)开始，该接口支持在元服务中使用。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| location | [mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng) | 否 | 否 | 标记点坐标。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| locations | Array<[mapCommon.LatLng](../mapCommon（地图属性模型）/map-common.md#latlng)> | 否 | 否 | 路径的坐标。 |
