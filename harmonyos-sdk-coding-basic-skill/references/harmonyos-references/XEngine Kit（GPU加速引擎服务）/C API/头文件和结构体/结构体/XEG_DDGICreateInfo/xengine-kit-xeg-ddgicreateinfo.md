...
content_hash: sha256:86d5c81266463fc76c9e3251b83809317c649649b84761a0d78c9ed854272dbd
---
## 概述

PhonePC/2in1TabletTV

此结构体描述创建具有DDGI特性的[XEG\_RTGI](../../../模块/XEngine/xengine-kit-xengine.md#xeg_rtgi)对象的信息，当结构体中的信息变化时，需要创建新的[XEG\_RTGI](../../../模块/XEngine/xengine-kit-xengine.md#xeg_rtgi)对象。
...
| 名称 | 描述 |
| --- | --- |
| XEG\_StructureType [sType](xengine-kit-xeg-ddgicreateinfo.md#stype) | 识别此结构的[XEG\_StructureType](../../../模块/XEngine/xengine-kit-xengine.md#xeg_structuretype)值，必须是XEG\_STRUCTURE\_TYPE\_DDGI\_CREATE\_INFO。 |
| const void \* [pNext](xengine-kit-xeg-ddgicreateinfo.md#pnext) | 指向扩展结构的指针。 |
| XEG\_RTGIQualityMode [qualityMode](xengine-kit-xeg-ddgicreateinfo.md#qualitymode) | 输出图像的质量模式，必须为[XEG\_RTGIQualityMode](../../../模块/XEngine/xengine-kit-xengine.md#xeg_rtgiqualitymode)中的枚举值。 |
...
识别此结构的[XEG\_StructureType](../../../模块/XEngine/xengine-kit-xengine.md#xeg_structuretype)值，必须是XEG\_STRUCTURE\_TYPE\_DDGI\_CREATE\_INFO。
