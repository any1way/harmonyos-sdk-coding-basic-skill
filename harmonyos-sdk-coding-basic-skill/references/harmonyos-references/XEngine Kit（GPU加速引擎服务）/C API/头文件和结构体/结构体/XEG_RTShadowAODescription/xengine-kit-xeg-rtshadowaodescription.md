...
scraped_at: 2026-06-01T16:31:58+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:4a932e584cd70779dff31105f29a994b993d29a38f4dbd8df0eaa3997c8ca3dd
---
## 概述
...
**所在头文件：** [xeg\_vulkan\_rt\_visible\_mask.h](../../头文件/xeg_vulkan_rt_visible_mask.h/xengine-kit-xeg-vulkan-rt-visible-mask-8h.md)
...
| 名称 | 描述 |
| --- | --- |
| XEG\_StructureType [sType](xengine-kit-xeg-rtshadowaodescription.md#stype) | 识别此结构的[XEG\_StructureType](../../../模块/XEngine/xengine-kit-xengine.md#xeg_structuretype)值，必须是XEG\_STRUCTURE\_TYPE\_RT\_SHADOWAO\_DESCRIPTION。 |
...
| bool [ndcFlipY](xengine-kit-xeg-rtshadowaodescription.md#ndcflipy) | 标识NDC空间与世界空间是否存在Y轴翻转关系。true表示翻转，false表示不翻转。默认值为false。 |
| const [XEG\_RTShadowParameters](../XEG_RTShadowParameters/xengine-kit-xeg-rtshadowparameters.md) \* [pRtShadowParameters](xengine-kit-xeg-rtshadowaodescription.md#prtshadowparameters) | 光线追踪阴影算法参数，当XEG\_RTShadowAOCreateInfo::enableRTShadow=true时不能为空。 |
| const [XEG\_RTAOParameters](../XEG_RTAOParameters/xengine-kit-xeg-rtaoparameters.md) \* [pRtAOParameters](xengine-kit-xeg-rtshadowaodescription.md#prtaoparameters) | 光线追踪环境光算法参数，当XEG\_RTShadowAOCreateInfo::enableRTAO=true时不能为空。 |
| const [XEG\_RTShadowAODenoiserParameters](../XEG_RTShadowAODenoiserParameters/xengine-kit-xeg-rtshadowaodenoiserparameters.md) \* [pRtShadowAODenoiserParameters](xengine-kit-xeg-rtshadowaodescription.md#prtshadowaodenoiserparameters) | 去噪参数，不能为空。光线追踪阴影和环境光遮蔽使用相同的去噪参数。 |
...
识别此结构的[XEG\_StructureType](../../../模块/XEngine/xengine-kit-xengine.md#xeg_structuretype)值，必须是XEG\_STRUCTURE\_TYPE\_RT\_SHADOWAO\_DESCRIPTION。
...
```
1. bool XEG_RTShadowAODescription::ndcFlipY  = false;
```
