...
scraped_at: 2026-06-01T16:31:35+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:da86f00166df2b02db302c104799e1a3104096f9f9e981f19dca1e98fbefe93e
---
## 概述
...
| 名称 | 描述 |
| --- | --- |
| typedef enum [XEG\_StructureType](../../../模块/XEngine/xengine-kit-xengine.md#xeg_structuretype) XEG\_StructureType | XEngine结构体类型的枚举。 |
| typedef VkResult(VKAPI\_PTR \* [PFN\_HMS\_XEG\_CmdSetSynchronization](../../../模块/XEngine/xengine-kit-xengine.md#pfn_hms_xeg_cmdsetsynchronization)) (VkCommandBuffer commandBuffer, const void \*xegHandle) | 设置同步信号，等待渲染结果写入指定图像的函数指针定义。使用RTGI特性时，为等待GI渲染结果到写入指定图像。 |
...
| 名称 | 描述 |
| --- | --- |
| VKAPI\_ATTR VkResult VKAPI\_CALL [HMS\_XEG\_CmdSetSynchronization](../../../模块/XEngine/xengine-kit-xengine.md#hms_xeg_cmdsetsynchronization) (VkCommandBuffer commandBuffer, const void \*xegHandle) | 设置同步信号，等待渲染结果写入指定图像。使用RTGI特性时，为等待GI渲染结果写入指定图像。 |
