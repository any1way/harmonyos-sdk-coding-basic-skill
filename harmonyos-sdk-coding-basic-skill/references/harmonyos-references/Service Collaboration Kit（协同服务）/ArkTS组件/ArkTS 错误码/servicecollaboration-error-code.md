...
title: ArkTS 错误码
breadcrumb: API参考 > 系统 > 网络 > Service Collaboration Kit（协同服务） > ArkTS组件 > ArkTS 错误码
category: harmonyos-references
scraped_at: 2026-06-11T16:15:54+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:f2b27d212c0a96be11307582d111daa202f7c53e44e2560a043b83c60ad3f8c3
---
说明
...
使用[createCollaborationServiceMenuItems](<../CollaborationService (跨设备互通组件)/servicecollaboration-collaborationservice.md#createcollaborationservicemenuitems-1>)传入的自定义图片张数canReceiveNumber小于等于0。

**处理步骤**

使用[createCollaborationServiceMenuItems](<../CollaborationService (跨设备互通组件)/servicecollaboration-collaborationservice.md#createcollaborationservicemenuitems-1>)时，自定义图片张数canReceiveNumber请传入1到50的值。
