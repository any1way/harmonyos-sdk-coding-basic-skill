...
scraped_at: 2026-06-11T16:15:49+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:d9199c65647df384c0e44131b72d28ae30b3c21525b5daab0255ec4e58f35e4e
---
...
设备列表选择器，需要在[Menu](../../../ArkUI（方舟UI框架）/ArkTS组件/菜单/Menu/ts-basic-components-menu.md)组件内调用。用于显示组网内具有对应能力的设备列表，此接口支持自定义对端图库能力图片选择的数量。
...
设备列表选择器，需要在[Menu](../../../ArkUI（方舟UI框架）/ArkTS组件/菜单/Menu/ts-basic-components-menu.md)组件内调用。用于显示组网内具有对应能力的设备列表，此接口支持自定义对端图库能力图片选择的数量和支持自定义选择对端的设备类型Phone、Tablet和PC/2in1设备。
...
以下部分错误状态的详细介绍请参见[ArkTS 错误码](<../ArkTS 错误码/servicecollaboration-error-code.md>)。
...
59. hilog.error(0, 'MEMOMOCK', 'Create pixel map failed: ' + error);
60. }).finally(() => {
...
60. Column() {
61. List() {
62. ForEach(this.videoItems, (item: VideoItem) => {
63. ListItem() {
64. Video({
65. src: item.src,
...
110. hilog.error(0, 'MEMOMOCK', 'Create pixel map failed: ' + error);
111. }).finally(() => {
112. imageSource.release();
113. });
114. }
115. }
116. }
