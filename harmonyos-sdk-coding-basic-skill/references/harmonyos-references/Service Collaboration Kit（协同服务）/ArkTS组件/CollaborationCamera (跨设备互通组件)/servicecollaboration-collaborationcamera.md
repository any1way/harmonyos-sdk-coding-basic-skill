...
scraped_at: 2026-06-11T16:15:48+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:dcbe62de853bb9f1493a741953f4f41c1b1b3f3d678037729d85356aa1d579c1
---
...
**废弃说明：** 从5.0.0(12)开始废弃，建议使用[CollaborationService](<../CollaborationService (跨设备互通组件)/servicecollaboration-collaborationservice.md>)替代。
...
设备列表选择器，需要在[Menu](../../../ArkUI（方舟UI框架）/ArkTS组件/菜单/Menu/ts-basic-components-menu.md)组件内调用。用于显示组网内具有对应能力的设备列表。

该方法为自定义构建函数，开发者在使用前需要先了解[@Builder](<../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md>)。

**废弃说明：** 从5.0.0(12) 开始废弃，建议使用[createCollaborationServiceMenuItems](<../CollaborationService (跨设备互通组件)/servicecollaboration-collaborationservice.md#createcollaborationservicemenuitems>)替代。
...
**废弃说明：** 从5.0.0(12) 开始废弃，建议使用[CollaborationServiceFilter](<../CollaborationService (跨设备互通组件)/servicecollaboration-collaborationservice.md#collaborationservicefilter>)替代。
...
该组件为自定义组件，开发者在使用前需要先了解[@Component](<../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/创建自定义组件/arkts-create-custom-components.md#component>)。

**废弃说明：** 从5.0.0(12) 开始废弃，建议使用[CollaborationServiceStateDialog](<../CollaborationService (跨设备互通组件)/servicecollaboration-collaborationservice.md#collaborationservicestatedialog>)替代。
...
**废弃说明：** 从5.0.0(12) 开始废弃，建议使用[onState](<../CollaborationService (跨设备互通组件)/servicecollaboration-collaborationservice.md#onstate>)替代。
...
以下错误码的详细介绍请参见[ArkTS 错误码](<../ArkTS 错误码/servicecollaboration-error-code.md>)。
...
**废弃说明：** 从5.0.0(12) 开始废弃，建议使用[build](<../CollaborationService (跨设备互通组件)/servicecollaboration-collaborationservice.md#build>)替代。
...
跨设备互通详细介绍可参考[跨设备互通特性简介](<../../../../harmonyos-guides/系统/网络/Service Collaboration Kit（协同服务）/跨设备互通（ArkTS）/跨设备互通特性简介/servicecollaboration-service-overview.md>)。
...
57. hilog.error(0, 'MEMOMOCK', 'Create pixel map failed: ' + error);
58. }).finally(() => {
59. imageSource.release();
60. });
61. }
62. }
```
