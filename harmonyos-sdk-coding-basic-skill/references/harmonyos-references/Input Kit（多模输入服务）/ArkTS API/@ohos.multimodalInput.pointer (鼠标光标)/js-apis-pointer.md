...
scraped_at: 2026-06-11T16:20:08+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:dd5169dccf51232a5f625c8c02d32cf37c2ad352dfddc44c0b1086f73b2376ec
---
...
| pixelMap | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 自定义光标资源。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pixelMap | [image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 否 | 否 | 自定义光标。最小限制为资源图本身的最小限制。最大限制为256 x 256px。 |
...
以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)和[鼠标光标错误码](../../错误码/鼠标光标错误码/errorcode-pointer.md)。
