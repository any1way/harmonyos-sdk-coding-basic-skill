...
scraped_at: 2026-06-11T16:20:02+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:9a8611ab05cb3df36091fdd440820edcf458f0838fd9fa6c5f09cfa3b32efb9e
---
...
| --- | --- | --- | --- |
| deviceId | number | 是 | 输入设备的唯一标识，同一个物理设备反复插拔或重启，设备ID可能会发生变化。 |
| keys | Array[<KeyCode>](<../@ohos.multimodalInput.keyCode (键值)/js-apis-keycode.md#keycode>) | 是 | 需要查询的键值，最多支持5个按键查询。 |
...
| --- | --- | --- | --- |
| deviceId | number | 是 | 输入设备的唯一标识，同一个物理设备反复插拔或重启，设备ID可能会发生变化。 |
| keys | Array[<KeyCode>](<../@ohos.multimodalInput.keyCode (键值)/js-apis-keycode.md#keycode>) | 是 | 需要查询的键值，最多支持查询5个按键。 |
...
以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)和[输入设备错误码](../../错误码/输入设备错误码/errorcode-inputdevice.md)。
