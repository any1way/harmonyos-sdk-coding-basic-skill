...
scraped_at: 2026-06-11T16:14:27+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:0ce57a73675038f966838e267734e6f46084240b398349c75a558829a26758f0
---
...
以下错误码的详细介绍请参考[增强连接错误码](../../错误码/增强连接错误码/errorcode-link-enhance.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceId | string | 是 | 连接的目标设备的deviceId，即对端设备的BLE MAC地址。BLE MAC的获取方法，请参考[查找设备](<../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/蓝牙/低功耗蓝牙/查找设备/ble-development-guide.md>)。 |
...
| reason | number | 否 | 否 | 连接成功返回0，连接失败返回错误码：  - 32390200：表示客户端连接超时。  - 32390201：表示服务端服务未启动。  - 32390300：表示内部错误。  更多关于错误码的详细介绍请参考[增强连接错误码](../../错误码/增强连接错误码/errorcode-link-enhance.md)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [ArrayBuffer](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/ArrayBuffer对象/arraybuffer-object.md) | 是 | 需要发送的数据，最大发送长度为1024字节。 |
...
| callback | Callback<[ArrayBuffer](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/ArrayBuffer对象/arraybuffer-object.md)> | 是 | 注册的回调函数。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 事件回调类型，支持的事件为'dataReceived'，收到数据时，触发该事件。 |
| callback | Callback<[ArrayBuffer](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/ArrayBuffer对象/arraybuffer-object.md)> | 否 | 注册的回调函数。 |
