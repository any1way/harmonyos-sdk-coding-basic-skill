...
scraped_at: 2026-06-11T16:14:28+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:56523b168e44c0c944eda21df301633b2f0df9f679ac9287b275a5d0fce1e939
---
...
1. 需要申请ohos.permission.ACCESS\_BLUETOOTH权限。如何配置和申请权限，具体操作请参考[声明权限](../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)和[向用户申请授权](../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/向用户申请授权/request-user-authorization.md)。
...
以下错误码的详细介绍请参考[代理通道管理错误码](../../错误码/代理通道管理错误码/errorcode-proxychannelmanager.md)和[通用错误码](../../../通用错误码/errorcode-universal.md)。
