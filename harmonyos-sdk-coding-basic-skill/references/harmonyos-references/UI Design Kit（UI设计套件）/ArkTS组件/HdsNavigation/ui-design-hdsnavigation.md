...
scraped_at: 2026-06-11T16:07:09+08:00
doc_updated_at: 2026-05-28
content_hash: sha256:9e67ff5ab6fe6fb2498ea2037eb40957c2dfebc0d5ac9cd8f15f572c4a397da5
---
...
HdsNavigation组件是路由导航的根视图容器，一般作为Page页面的根容器使用，其内部默认包含了标题栏、内容区和工具栏。其中内容区默认首页显示导航内容（HdsNavigation的子组件）或非首页显示（[HdsNavDestination](../HdsNavDestination/ui-design-hdsnavdestination.md)的子组件），首页和非首页通过路由进行切换。
...
可以包含子组件。 推荐使用[NavPathStack](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navpathstack10)配合[HdsNavDestination](../HdsNavDestination/ui-design-hdsnavdestination.md)属性进行页面路由。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pathInfos | [NavPathStack](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navpathstack10) | 否 | 路由栈信息。 |

## 属性

PhonePC/2in1TabletTV

除支持[通用属性](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/ts-component-general-attributes.md)外，还支持以下属性：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | Array<[ToolbarItem](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#toolbaritem10)> | [CustomBuilder](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 工具栏内容。  使用Array<[ToolbarItem](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#toolbaritem10)>写法设置的工具栏有如下特性：  - 如果为[Stack](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navigationmode9枚举说明)模式，不推荐使用该写法。推荐使用[CustomBuilder](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8)配合[ToolBar](../../../ArkUI（方舟UI框架）/ArkTS组件/系统预置UI组件库/ToolBar/ohos-arkui-advanced-toolbar.md)组件写法，避免布局显示问题。  - 工具栏所有选项均分底部工具栏，在每个均分内容区布局文本和图标。  - 最多支持显示5个图标，多余的图标会被放入自动生成的更多图标。  使用[CustomBuilder](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8)写法为用户自定义工具栏选项，除均分底部工具栏外不具备以上功能。 |
| options | [NavigationToolbarOptions](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navigationtoolbaroptions11) | 否 | 工具栏选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 是 | 导航栏宽度。  默认值：240。单位：vp。  undefined：行为不做处理，导航栏宽度与默认值保持一致。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [NavBarPosition](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navbarposition9枚举说明) | 是 | 导航栏位置。  默认值：NavBarPosition.Start。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [NavigationMode](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navigationmode9枚举说明) | 是 | 导航栏的显示模式。  默认值：NavigationMode.Auto。  自适应：基于组件宽度自适应单栏和双栏。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [NavigationDividerStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navigationdividerstyle23) | null | 是 | 设置双栏分割线样式。  配置为null时：隐藏分割线。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Dimension](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#dimension10) | 是 | 导航栏内容区最小宽度。  默认值：360。单位：vp。  undefined：行为不做处理，导航栏内容区最小宽度与默认值保持一致。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| types | Array <[LayoutSafeAreaType](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/安全区域/ts-universal-attributes-expand-safe-area.md#layoutsafeareatype12)> | 否 | 配置扩展安全区域的类型。  默认值：[LayoutSafeAreaType.SYSTEM]。 |
| edges | Array <[LayoutSafeAreaEdge](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/安全区域/ts-universal-attributes-expand-safe-area.md#layoutsafeareaedge12)> | 否 | 配置扩展安全区域的方向。  默认值：[LayoutSafeAreaEdge.TOP, LayoutSafeAreaEdge.BOTTOM]。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| originalStyle | [Optional](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[SystemBarStyle](<../../../ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interfaces (其他)/arkts-apis-window-i.md#systembarstyle12>)> | 是 | 系统状态栏初始样式。未设置systemBarStyle属性时，颜色默认值同主标题栏字体颜色。 |
| scrollEffectStyle | [Optional](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[SystemBarStyle](<../../../ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interfaces (其他)/arkts-apis-window-i.md#systembarstyle12>)> | 是 | HdsNavigation动态样式生效后，系统状态栏对应的动态样式。未设置systemBarStyle属性时，颜色默认值同主标题栏字体颜色。 |

说明

1. 不建议混合使用systemBarStyle属性和window设置状态栏样式的相关接口，例如：[setWindowSystemBarProperties](<../../../ArkUI（方舟UI框架）/ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setwindowsystembarproperties9>)。
2. [Split](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navigationmode9枚举说明)模式下的HdsNavigation，如果内容区没有HdsNavDestination，则遵从HdsNavigation首页的设置，反之则遵从栈顶HdsNavDestination的设置。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| recoverable | [Optional](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | HdsNavigation是否可恢复，默认为不可恢复。  默认值：false。  - true：页面栈可恢复。  - false：页面栈不可恢复。 |

说明

1. 使用该接口需要先设置HdsNavigation的[id属性](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#id)，否则该接口无效。
2. 该接口需要配合HdsNavDestination的[recoverable](../HdsNavDestination/ui-design-hdsnavdestination.md#recoverable)接口使用。
3. 恢复的过程中不可序列化的信息，例如不可序列化的参数与用户设置的onPop等，会被丢弃，无法恢复。
4. 当应用退到后台，因系统资源不足等原因被系统终止后，如果某页面已配置为可恢复，当应用再次被唤醒至前台时，系统将自动恢复该页面。详细说明请参考[UIAbility备份恢复](<../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/UIAbility组件/UIAbility备份恢复/ability-recover-guideline.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scrollers | Array<[Scroller](../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scroller)> | 是 | 可滚动容器组件的控制器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isEnabled | [Optional](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否开启拖拽条，默认为无拖拽条样式。  默认值：false。  - true：有拖拽条样式。  - false：无拖拽条样式。 |
...
控制是否开启[NavigationMode](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navigationmode9枚举说明)单双栏切换时的动效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isEnabled | [Optional](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否开启单双栏切换动效。  默认值：true。  - true：开启单双栏切换动效。  - false：关闭单双栏切换动效。 |
...
设置HdsNavigation的[WithTheme](../../../ArkUI（方舟UI框架）/ArkTS组件/主题/WithTheme/ts-container-with-theme.md)能力。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| placeholder | [ComponentContent](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md>) | 是 | 设置Navigation双栏模式下右侧的默认占位页。 |
...
设置是否启用HdsNavDestination页面的[onHidden](../HdsNavDestination/ui-design-hdsnavdestination.md#onhidden)、[onShown](../HdsNavDestination/ui-design-hdsnavdestination.md#onshown)生命周期与全模态的联动触发。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isEnabled | [Optional](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否启用HdsNavDestination页面onShown、onHidden生命周期与全模态的联动触发。  默认值：true。  - true：全模态拉起时，会触发当前HdsNavDestination页面的onHidden生命周期；全模态关闭时，会触发当前HdsNavDestination页面的onShown生命周期。  - false：HdsNavDestination页面onHidden、onShown生命周期不会因为全模态的拉起、关闭而触发。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callBack | [Callback](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#callback12)<boolean> | 是 | 参数为true时表示显示导航栏，为false时表示隐藏导航栏。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#callback12)<[NavigationMode](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navigationmode9枚举说明)> | 是 | - 参数为NavigationMode.Split时：当前HdsNavigation显示为双栏。  - 参数为NavigationMode.Stack时：当前HdsNavigation显示为单栏。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#callback12)<[HdsNavigationTitleMode](ui-design-hdsnavigation.md#hdsnavigationtitlemode)> | 是 | 参数为标题栏显示模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| from | [NavContentInfo](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navcontentinfo11) | 是 | 退场Destination的页面。 |
| to | [NavContentInfo](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navcontentinfo11) | 是 | 进场Destination的页面。 |
| operation | [NavigationOperation](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navigationoperation11枚举说明) | 是 | 转场类型。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [NavigationAnimatedTransition](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navigationanimatedtransition11) | undefined | 自定义转场动画协议。  undefined：返回未定义，执行默认转场动效。 |
...
| 类型 | 说明 |
| --- | --- |
| [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 字符串类型。 |
| [SymbolGlyphModifier](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#自定义modifier) | symbol资源类型。 |
| [PixelMap](<../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 图像像素类型。  **起始版本：** 6.0.0(20) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| dividerColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 标题栏分割线颜色。  默认值：$r('sys.color.comp\_divider')。 |
...
| thermoCtrl | boolean | 否 | 是 | 设置组件样式的生效策略是否跟随热管理档位[ThermalLevel](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/设备管理/@ohos.thermal (热管理)/js-apis-thermal.md#thermallevel>)信息管理。  默认值：false。  - true：跟随热管理档位信息生效组件样式，组件创建时，若ThermalLevel > OVERHEATED，关闭组件模糊效果。  - false：不跟随热管理档位信息生效组件样式。  **起始版本：** 6.1.0(23) |
...
| accessibilityText | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 标题栏信息标记的的无障碍文本属性。  当组件不包含文本属性时，屏幕朗读选中此组件时不播报，使用者无法清楚地知道当前选中了什么组件。为了解决此场景，开发人员可为不包含文字信息的组件设置无障碍文本，当屏幕朗读选中此组件时播报无障碍文本的内容，帮助屏幕朗读的使用者清楚地知道自己选中了什么组件。  默认值：""。  **起始版本：** 6.0.0(20) |
...
| label | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 图标型菜单项的文本。  默认值：""。 |
| isEnabled | boolean | 否 | 是 | 是否使能。  默认值：true。  - true：使能。  - false：未使能。 |
| action | [Callback](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#callback12)<void> | 否 | 是 | 当前选项被选中的事件回调。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| want | [Want](<../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 否 | 否 | 需要启动窗口的参数，有以下要求：  - 必填字段：abilityName, moduleName和bundleName；  - 应用限制：所有指定的名称（abilityName, moduleName 和bundleName）必须属于当前应用；  - 跨应用限制：多窗口功能不支持跨应用的能力。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| mainTitle | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 设置标题栏主标题。 |
| subTitle | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 设置标题栏副标题。不设置时，不显示副标题。 |
| subTitleBuilder | [CustomBuilder](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 否 | 是 | 设置副标题自定义区域。配置subTitle时，从subTitle尾部开始布局。该配置只在标题栏模式为HdsNavigationTitleMode.MODAL或者HdsNavDestinationTitleMode.MODAL时生效。  **起始版本：** 6.0.0(20) |
| subTitleComponent | [ComponentContent](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md>) | 否 | 是 | 设置副标题自定义区域。配置subTitle时，从subTitle尾部开始布局。该配置只在标题栏模式为HdsNavigationTitleMode.MODAL或者HdsNavDestinationTitleMode.MODAL时生效。  当同时配置了subTitleBuilder属性与subTitleComponent属性时，生效subTitleComponent属性。  **起始版本：** 6.0.1(21) |
| mainTitleId | string | 否 | 是 | 设置主标题的组件ID。  默认值：""。  **起始版本：** 6.0.0(20) |
| subTitleId | string | 否 | 是 | 设置副标题的组件ID。  默认值：""。  **起始版本：** 6.0.0(20) |
| mainTitleAccessibilityText | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 设置主标题的无障碍文本。  **起始版本：** 6.1.0(23) |
| subTitleAccessibilityText | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 设置副标题的无障碍文本。  **起始版本：** 6.1.0(23) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| builder | [CustomBuilder](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 否 | 否 | 设置标题底部自定义区域内容。 |
| builderComponent | [ComponentContent](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md>) | 否 | 是 | 设置标题底部自定义区域内容。  当同时配置了builder属性与builderComponent属性时，生效builderComponent属性。  **起始版本：** 6.0.1(21) |
| height | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置标题栏底部自定义区域高度。不支持设置百分比单位。  默认值：56vp。 |
...
| stackBuilder | [CustomBuilder](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 否 | 是 | 设置标题栏顶部自定义区域。  **起始版本：** 6.0.0(20) |
| stackBuilderComponent | [ComponentContent](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md>) | 否 | 是 | 设置标题栏顶部自定义区域。  当同时配置了stackBuilder属性与stackBuilderComponent属性时，生效stackBuilderComponent属性。  **起始版本：** 6.0.1(21) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| start | [LengthMetrics](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | 标题栏起始端内间距。  默认值：页面宽度小于600vp时，默认值为16vp，页面宽度大于等于840vp时，默认值为32vp，其他场景默认值为24vp。 |
| end | [LengthMetrics](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | 标题栏结束端内间距。  默认值：页面宽度小于600vp时，默认值为16vp，页面宽度大于等于800vp时，默认值为32vp，其他场景默认值为24vp。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| minWidth | [Dimension](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | 导航栏最小宽度。  默认值：240vp。 |
| maxWidth | [Dimension](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | 导航栏最大宽度。  默认值：组件宽度的40% ，且不大于 432，单位：vp。 |
...
| enableComponentSafeArea | boolean | 否 | 是 | 是否将标题栏设置为[组件级安全区](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#safeareapadding14)。  默认值：false。  - true：将标题栏设置为组件级安全区。  - false：不将标题栏设置为组件级安全区。  **起始版本：** 6.0.0(20) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| parent | [Scroller](../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scroller) | 否 | 否 | 可滚动容器组件的控制器。 |
| child | [Scroller](../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scroller) | 否 | 否 | 可滚动容器组件的控制器，child对应的组件需要是parent对应组件的子组件，且组件间存在嵌套滚动关系。 |

## WithThemeOptions

PhonePC/2in1TabletTV

标题栏[WithTheme](../../../ArkUI（方舟UI框架）/ArkTS组件/主题/WithTheme/ts-container-with-theme.md)能力配置信息。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| materialType | [hdsMaterial.MaterialType](<../../ArkTS API/hdsMaterial/ui-design-hdsmaterial.md#materialtype>) | 否 | 是 | 设置材质类型。  默认值：hdsMaterial.MaterialType.NONE。 |
| materialLevel | [hdsMaterial.MaterialLevel](<../../ArkTS API/hdsMaterial/ui-design-hdsmaterial.md#materiallevel>) | 否 | 是 | 设置材质等级。  默认值：hdsMaterial.MaterialLevel.ADAPTIVE  **说明**：  **推荐使用默认值ADAPTIVE档位：** 该模式下，系统会根据当前设备的算力动态调整组件的材质效果，实现性能与显示效果的最佳平衡体验。  **若未采用系统自适应能力：** 请先调用[getSystemMaterialTypes()](<../../ArkTS API/hdsMaterial/ui-design-hdsmaterial.md#getsystemmaterialtypes>)接口查询当前设备支持的材质能力，再根据查询结果选用相应的材质效果枚举：  1. 如果查询结果显示当前设备支持IMMERSIVE材质类型，可选用EXQUISITE或GENTLE效果。  2. 如果查询结果显示当前设备不支持IMMERSIVE材质类型，则建议使用SMOOTH效果，以降低卡顿和发热风险，保障用户体验。  **详细使用指导：** 请参见[HDS组件使用沉浸光感材质指南](<../../../../harmonyos-guides/应用框架/UI Design Kit（UI设计套件）/沉浸光感/ui-design-hds-component-material.md#使用自定义沉浸光感效果>)。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/XTrZ1WhyTyK19jStr7NkdA/zh-cn_image_0000002592380924.gif?HW-CC-KV=V1&HW-CC-Date=20260611T080619Z&HW-CC-Expire=86400&HW-CC-Sign=FAF30414049B01F2D66FDD97980C2DFDA4EAE93C8053D849F44508900B23CCD7 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0a/v3/zP1-9rKZTx-GBK9ss4Zj9w/zh-cn_image_0000002622860435.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T080619Z&HW-CC-Expire=86400&HW-CC-Sign=80C0E1D0659AAC006150A521F681B1C9117E2AF9D9D12EB06F12B7DFF59444A4 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a/v3/GcZKr-jbTteWGyRbJeiOBw/zh-cn_image_0000002622700553.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T080619Z&HW-CC-Expire=86400&HW-CC-Sign=C8CB83E578BD6A65E56C80605C68C708C813C2B3EAA07DB29CB910198FD5BDAA "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/nVOMjx8mSgSGydKBAU4IIw/zh-cn_image_0000002592220994.gif?HW-CC-KV=V1&HW-CC-Date=20260611T080619Z&HW-CC-Expire=86400&HW-CC-Sign=B6F42E201E9FFB4A17252C2D3C6A750109475EBC9BBEE7F4CD1474FDD30E3BB2 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0b/v3/xSeGZpscSIWgRz-RTe1vXw/zh-cn_image_0000002592380926.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T080619Z&HW-CC-Expire=86400&HW-CC-Sign=A49DBEF10686041F1FA69A77A56BB70F43B1E7F0A747D3FA08D803997D3233DA "点击放大")
...
44. subTitleBuilder: (): void => this.SubTitleBuilder(), // 自定义副标题区域
45. },
46. menu: {
47. value: [{
48. content: {
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/gjxiyIOLQu2X18uSvVbYcA/zh-cn_image_0000002622860437.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T080619Z&HW-CC-Expire=86400&HW-CC-Sign=31E356A49E7134BC463CE9816228DC385978EBF740904546396992D14FCE02CE "点击放大")

### 图标上绑定自定义menu

通过设置菜单项[HdsNavigationIconOptions](ui-design-hdsnavigation.md#hdsnavigationiconoptions)中的componentId属性，结合[promptAction.openMenu](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (PromptAction)/arkts-apis-uicontext-promptaction.md#openmenu18>)方法，绑定[TargetInfo](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Interfaces (其他)/arkts-apis-uicontext-i.md#targetinfo18>)中的Id属性为设置的componentId，可以在对应的图标上弹出用户自定义菜单。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/zRum6YZJS4a4QAuwf08L0Q/zh-cn_image_0000002622700555.gif?HW-CC-KV=V1&HW-CC-Date=20260611T080619Z&HW-CC-Expire=86400&HW-CC-Sign=EF36580441CDA2B58C945E57886B728BE7B7E734B9A68C3B1EAAB69F7C7DBCEB "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/aZ71mzFpTY2Do4ITUIWq5Q/zh-cn_image_0000002592220996.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T080619Z&HW-CC-Expire=86400&HW-CC-Sign=2EA4BC772A038E5DB88D1CA5DF70862FCE46C2731285C5E0B608AA1306CA75B0 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bb/v3/TN6yS2roS-OuafITKdoYHw/zh-cn_image_0000002592380928.gif?HW-CC-KV=V1&HW-CC-Date=20260611T080619Z&HW-CC-Expire=86400&HW-CC-Sign=B45F2AA16B45D44D3086C7772966D9B7FC85758D2FEE3A7906ACE274613175BF "点击放大")
...
39. Button('切换材质Type为None').onClick(() => {
40. // 无材质效果
41. this.materialType = hdsMaterial.MaterialType.NONE;
42. }).margin({ top: 2 })
43. }.height('100%')
44. }.edgeEffect(EdgeEffect.Spring).height('100%')
45. }
46. .titleBar({
47. content: {
48. title: {
...
52. value: [{
53. content: {
54. icon: $r('sys.symbol.search_things'),
55. label: 'search',
56. action: () => {
57. promptAction.openToast({ message: 'on click' });
58. },
59. }
60. }]
61. },
...
63. style: {
64. scrollEffectOpts: {
65. // 从6.1.0(23)开始， 新增IMMERSIVE_GRADIENT_BLUR类型，标题文字和图标样式从白色到黑色线性过渡。
66. scrollEffectType: ScrollEffectType.IMMERSIVE_GRADIENT_BLUR,
67. },
68. // 从6.1.0(23)开始，支持材质相关属性。
69. // 推荐与ScrollEffectType.IMMERSIVE_GRADIENT_BLUR（推荐沉浸式图文类的场景使用） 或 ScrollEffectType.GRADIENT_BLUR（推荐非沉浸式列表类的场景使用）搭配使用。
70. systemMaterialEffect: {
71. materialType: this.materialType,
72. materialLevel: this.materialLevel
73. }
74. },
75. })
76. .bindToScrollable([this.scrollerForScroll])
77. .hideBackButton(true)
78. .titleMode(HdsNavigationTitleMode.MINI)
79. .ignoreLayoutSafeArea([LayoutSafeAreaType.SYSTEM], [LayoutSafeAreaEdge.TOP, LayoutSafeAreaEdge.BOTTOM])
80. }
81. }
```
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/ch3KFewDQr2Jvw7Mrx2rfQ/zh-cn_image_0000002622860439.gif?HW-CC-KV=V1&HW-CC-Date=20260611T080619Z&HW-CC-Expire=86400&HW-CC-Sign=E0F1C51953113C653885A89093E1D9A81AB7FE01BD787FC3C58520B258E18500 "点击放大")

### 通过onReady获取栈

该示例主要演示如下两点功能：

1. [NavPathStack](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navpathstack10)无需声明为状态变量，也可以实现路由栈操作功能。
2. [HdsNavDestination](../HdsNavDestination/ui-design-hdsnavdestination.md)通过[onReady](../HdsNavDestination/ui-design-hdsnavdestination.md#onready)事件能够拿到对应的NavPathInfo和所属的[NavPathStack](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navpathstack10)。

**示例：**

```
1. // 从6.0.2(22)版本开始，无需手动导入HdsNavigationAttribute与HdsNavDestinationAttribute。具体请参考HdsNavigation与HdsNavDestination的导入模块说明。
2. import {
3. HdsNavDestination,
4. HdsNavigation,
5. HdsNavigationAttribute,
6. HdsNavDestinationAttribute,
7. HdsNavigationTitleMode
8. } from "@kit.UIDesignKit";

10. class PageParam {
11. constructor(num_: number) {
12. this.num = num_;
13. }
...
18. @Builder
19. export function PageOneBuilder(name: string, param: Object) {
20. PageOne();
21. }

23. @Component
24. struct PageOne {
25. private stack: NavPathStack | null = null;
26. private name: string = "";
27. private paramNum: number = 0;

29. build() {
30. HdsNavDestination() {
31. Column() {
32. Text("NavPathInfo: name: " + this.name + ", paramNum: " + this.paramNum)
...
37. .onClick(() => {
38. if (this.stack) {
39. let p = new PageParam(this.paramNum + 1);
40. this.stack.pushPath({ name: "pageOne", param: p });
41. }
42. })
43. Button('pop', { stateEffect: true, type: ButtonType.Capsule })
44. .width('80%')
45. .height(40)
46. .margin(20)
47. .onClick(() => {
...
53. }
54. .titleBar({
55. enableComponentSafeArea: true,
56. content: {
57. title: {
58. mainTitle: 'PageOne',
59. },
60. }
61. })
62. .onReady((ctx: NavDestinationContext) => {
63. // 在NavDestination中能够拿到传来的NavPathInfo和当前所处的NavPathStack
64. try {
65. this.name = ctx?.pathInfo?.name;
66. this.paramNum = (ctx?.pathInfo?.param as PageParam)?.num;
67. this.stack = ctx.pathStack;
68. } catch (e) {
69. console.error(`testTag onReady catch exception: ${JSON.stringify(e)}`);
70. }
71. })
72. }
73. }
...
75. @Entry
76. @Component
77. struct NavigationExample2 {
78. private stack: NavPathStack = new NavPathStack();

80. build() {
81. HdsNavigation(this.stack) {
82. Stack({ alignContent: Alignment.Center }) {
83. Button('pushPath', { stateEffect: true, type: ButtonType.Capsule })
84. .width('80%')
85. .height(40)
86. .margin(20)
87. .onClick(() => {
88. let p = new PageParam(1);
89. this.stack.pushPath({ name: "pageOne", param: p });
90. })
91. }
92. .width('100%')
93. .height('100%')
...
102. }
103. })
104. .titleMode(HdsNavigationTitleMode.MINI)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/zmlLPdG9TYulsuFUd93UlA/zh-cn_image_0000002622700557.gif?HW-CC-KV=V1&HW-CC-Date=20260611T080619Z&HW-CC-Expire=86400&HW-CC-Sign=A8C47BB6FC4FF6646AB27844BEA5CE8657A4B8D5403C30CA3A0C31F1E8D06457 "点击放大")
