...
scraped_at: 2026-06-11T16:07:20+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:8389485e5425008a3838fdecfa6418596b512fb0b9639f5709908e1a76ffc15a
---
说明
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| want | [Want](<../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 否 | 否 | 要启动窗口的参数，有以下要求：  1. 必填字段：abilityName, moduleName和bundleName；  2. 应用限制：所有指定的名称（abilityName, moduleName 和bundleName）必须属于当前应用；  3. 跨应用限制：多窗口功能不支持跨应用的能力。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| iconColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 组件图标颜色。  默认值：$r('sys.color.font\_primary')。 |
| iconWeight | number | [FontWeight](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#fontweight) | string | 否 | 是 | 组件图标粗细。  默认值：400。  **说明**：  - number类型取值[100,900]，取值间隔为100，默认为400，取值越大，字体越粗。  - string类型仅支持number类型取值的字符串形式，例如“400”，以及“Bold”、“Bolder”、“Lighter”、“Regular” 、“Medium”分别对应FontWeight中相应的枚举值。 |
| iconSize | number | string | [Resource](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resource) | 否 | 是 | 组件图标尺寸。  默认值：24\*24 vp。  **说明**：暂不支持百分比。 |
| backgroundColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 组件背景颜色。  默认值：$r('sys.color.comp\_background\_tertiary')。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| modifier | [TextModifier](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#自定义modifier) | 否 | 是 | 组件文本标题修改器。 |

## 属性

PhonePC/2in1TabletTV

支持大部分[通用属性](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/ts-component-general-attributes.md)。
...
支持大部分[通用事件](../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/ts-component-general-events.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/mx31IEPzSsSdBHnaYKH0vA/zh-cn_image_0000002622860447.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T080719Z&HW-CC-Expire=86400&HW-CC-Sign=A55A326FB70CA929121B5F321BC8FFD6BFD64A4BF8B1E463E5E3943620CA23E4)
