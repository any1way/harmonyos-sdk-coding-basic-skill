...
scraped_at: 2026-06-11T16:07:19+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:33f2d29f73833c791442df61e4adc2740993943d3b02967f73cd5d3fdd2bf66e
---
...
除支持[通用属性](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/ts-component-general-attributes.md)，还支持以下属性：
...
| frameRateRange | hdsEffect.[ExpectedFrameRateRange](<../../ArkTS API/hdsEffect/ui-design-hdseffect.md#expectedframeraterange>) | 否 | 视效场景帧率配置。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| backgroundMaskColors | Array<[ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor)> | 否 | 否 | 背景蒙层颜色数组。 |
| firstEdgeFlowLight | hdsEffect.[EdgeFlowLightParam](<../../ArkTS API/hdsEffect/ui-design-hdseffect.md#edgeflowlightparam>) | 否 | 否 | 第一条流光参数配置。 |
| secondEdgeFlowLight | hdsEffect.[EdgeFlowLightParam](<../../ArkTS API/hdsEffect/ui-design-hdseffect.md#edgeflowlightparam>) | 否 | 否 | 第二条流光参数配置。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/_s2ULdBZTJKBm8iKOtSDhw/zh-cn_image_0000002592380936.gif?HW-CC-KV=V1&HW-CC-Date=20260611T080718Z&HW-CC-Expire=86400&HW-CC-Sign=E6F5C797C8831B8BB9A956F4833439A4AFCDEA5E12C4A56D5DCC56F6D1B15404)
