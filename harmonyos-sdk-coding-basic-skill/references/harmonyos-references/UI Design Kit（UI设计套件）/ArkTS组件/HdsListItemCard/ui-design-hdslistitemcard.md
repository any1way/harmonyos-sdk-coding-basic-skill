...
scraped_at: 2026-06-11T16:07:18+08:00
doc_updated_at: 2026-05-28
content_hash: sha256:27eef466e37f30af16f6a7aef595acaa5b4263e4d2c2bc2e0af67aafe580d6f0
---
...
当前仅支持[通用属性](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/ts-component-general-attributes.md)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| customBuilder | [CustomBuilder](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 否 | 是 | A区（列表左侧）自定义内容。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| customBuilder | [CustomBuilder](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 否 | A区（列表左侧）自定义内容。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| customBuilder | [CustomBuilder](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 否 | 是 | C区（列表右侧）自定义内容。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| customBuilder | [CustomBuilder](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 否 | C区（列表右侧）自定义内容。 |
...
| cardHeight | [Dimension](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | HdsListItemCard列表项的高度，目前不支持使用[Percentage](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#percentage10)设置。 |
| cardWidth | [Dimension](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | HdsListItemCard列表项的宽度，目前不支持使用[Percentage](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#percentage10)设置。 |
| cardBackgroundColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | HdsListItemCard列表项的背景颜色。 |
| cardBorderRadius | [Dimension](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | HdsListItemCard列表项的边框圆角。 |
| cardPrefixMargin | [Dimension](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | HdsListItemCard列表项距离屏幕左侧的边距。 |
| cardSuffixMargin | [Dimension](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | HdsListItemCard列表项距离屏幕右侧的边距。 |
| hoverBorderRadius | [Dimension](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | HdsListItemCard列表项在悬浮状态下的边框圆角。 |
...
| customBuilder | [CustomBuilder](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 否 | 是 | B区（列表中间）自定义内容。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| accessibilityText | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 列表的无障碍文本属性。当组件不包含文本属性时，屏幕朗读选中此组件时不播报，使用者无法清楚地知道当前选中了什么组件。为了解决此场景，开发人员可为不包含文字信息的组件设置无障碍文本，当屏幕朗读选中此组件时播报无障碍文本的内容，帮助屏幕朗读的使用者清楚地知道自己选中了什么组件。  默认值：""。 |
| accessibilityDescription | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 列表的无障碍描述。此描述用于向用户详细解释当前组件，开发人员应为组件的这一属性提供较为详尽的文本说明，以协助用户理解即将执行的操作及其可能产生的后果。特别是当这些后果无法仅从组件的属性和无障碍文本中直接获知时。如果组件同时具备文本属性和无障碍说明属性，当组件被选中时，系统将首先播报组件的文本属性，随后播报无障碍说明属性的内容。  默认值：类型为switch时，默认值为"单指双击即可开启/关闭"，类型为checkbox时，默认值为"单指双击即可选中/取消选中"，其它类型默认值为"单指双击即可执行"。 |
| accessibilityLevel | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 无障碍重要性，用于控制当前项是否可被无障碍辅助服务所识别。  支持的值为：  "auto"：当前组件会转换"yes"。  "yes"：当前组件可被无障碍辅助服务所识别。  "no"：当前组件不可被无障碍辅助服务所识别。  "no-hide-descendants"：当前组件及其所有子组件不可被无障碍辅助服务所识别。  默认值："auto"。 |
...
| accessibilityRole | [AccessibilityRoleType](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/无障碍属性/ts-universal-attributes-accessibility.md#accessibilityroletype18枚举说明) | 否 | 是 | 设置无障碍节点的组件类型。特定组件类型有特定的朗读方式，可以根据应用诉求，修改组件类型，用于控制无障碍模式下对组件的朗读方式和朗读内容。不设置的时候，默认使用节点自身的组件类型。  **起始版本：** 6.1.0(23) |
| onAccessibilityActionIntercept | [AccessibilityActionInterceptCallback](../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/无障碍相关/无障碍控制操作/ts-universal-accessibility-event.md#accessibilityactioninterceptcallback20) | 否 | 是 | 注册onAccessibilityActionIntercept回调。该回调会在无障碍控制操作触发前调用，由注册方决定是否拦截该次无障碍动作，对不支持Click的组件注册也无法触发回调。  **起始版本：** 6.1.0(23) |
...
| modifier | [ImageModifier](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#自定义modifier) | 否 | 是 | Image属性样式修改器。 |
...
| badgeColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | Badge背板颜色。  显示信息标记时默认值：$r('sys.color.warning')。  不显示信息标记时默认值：$r('sys.color.comp\_background\_emphasize')。 |
| textColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | Badge中数字颜色。  默认值：$r('sys.color.font\_on\_primary')。 |
...
| selectColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 选择类元素被选中后的背板颜色。 |
...
| selectColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | ToggleButton被选中后的背板颜色。  默认值：#00000000。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| text | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | Text资源类型。 |
| modifier | [TextModifier](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#自定义modifier) | 否 | 是 | Text属性样式修改器。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 对应元素的颜色修改。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| text | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | Button内部的text文本内容。 |
| textColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | Button内部的text文本颜色。  TV上默认值为$r('sys.color.font\_primary')，其他设备上默认值为$r('sys.color.font\_emphasize')。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| arrowColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | C区（列表右侧）箭头的颜色。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| value | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 下拉按钮本身的文本内容。 |
| valueColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 下拉按钮本身的文本颜色。  默认值：$r('sys.color.font\_secondary')。 |
| arrowColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 下拉按钮箭头的颜色。  默认值：$r('sys.color.icon\_secondary')。 |
| optionValues | Array<[ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr)> | 否 | 否 | 下拉选项内容。 |
| optionSymbol | Array<[SymbolGlyphModifier](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#自定义modifier)> | 否 | 否 | 下拉选项Symbol图片。 |
...
| [SymbolGlyphModifier](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#自定义modifier) | SymbolGlyph属性样式修改器。 |
...
| --- | --- |
| [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 字符串类型。 |
| image.[PixelMap](<../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | PixelMap类型。 |
...
10. import { ImageModifier, TextModifier } from '@kit.ArkUI';
...
42. },
43. onClick: () => {
44. console.info('onclick icon');
45. }
46. }),
47. onClick: () => {
48. console.info('onclick hdslistitem');
49. }
50. })
51. }
...
74. if (num) {
75. console.info('switch is true');
76. } else {
77. console.info('switch is false');
78. }
79. }
80. })
81. })
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/6IIJgKthSv--O2KTrsSqvw/zh-cn_image_0000002592221004.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T080716Z&HW-CC-Expire=86400&HW-CC-Sign=5BE948F4AD2AAADACC8B22FF9BC33D0B65BE9104DF802C0E74E5EC81F8429DFB)
