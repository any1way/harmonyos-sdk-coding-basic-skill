...
scraped_at: 2026-06-11T16:07:12+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:9122a10edb26e1c1dab35ec9bd3c73a0dcd527f3d0d29ab1433199cafb54b22b
---
...
| label | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 菜单显示的文本内容。 |
| action | [Callback](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#callback12)<void> | 否 | 是 | 点击菜单时的回调。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| icon | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 设置一级菜单栏的图标，优先级高于symbol。 |
| symbol | [SymbolGlyphModifier](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#自定义modifier) | 否 | 是 | 设置一级菜单栏的图标。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/lJhVvzG3QTCDXEB9XkyyXA/zh-cn_image_0000002622700559.png?HW-CC-KV=V1&HW-CC-Date=20260611T080710Z&HW-CC-Expire=86400&HW-CC-Sign=22B04FB59CFBDF59A8A4866E17665ABF2215BBE4EFB9EA8580A26DFC548E3BEE)
