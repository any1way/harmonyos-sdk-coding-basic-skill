...
scraped_at: 2026-06-11T16:07:14+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:67c00a797219ff88f6387dc8b2ae948f136af9e71fdefa6cff9ac058095fcc08
---
...
子组件为[TabContent](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md)。
...
HdsTabs组件参数，继承自[TabsOptions](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#tabsoptions15)。
...
HdsTabs组件的控制器，用于控制HdsTabs组件进行页签切换。不支持一个HdsTabsController控制多个HdsTabs组件，继承自[TabsController](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#tabscontroller)。
...
| scroller | [Scroller](../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scroller) | 是 | 滚动组件的控制器。 |
| parentScroller | [Scroller](../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scroller) | 否 | 滚动组件的父控制器。 |
...
HdsTabs的控制器更新[迷你栏](<../../../../harmonyos-guides/应用框架/UI Design Kit（UI设计套件）/底部页签/设置页签栏的悬浮样式/ui-design-hds-tabs-bar-floating.md#迷你栏>)样式并伴随动效。
...
HdsTabs的控制器调用页签栏和[迷你栏](<../../../../harmonyos-guides/应用框架/UI Design Kit（UI设计套件）/底部页签/设置页签栏的悬浮样式/ui-design-hds-tabs-bar-floating.md#迷你栏>)的隐藏动效。
...
HdsTabs的控制器调用页签栏和[迷你栏](<../../../../harmonyos-guides/应用框架/UI Design Kit（UI设计套件）/底部页签/设置页签栏的悬浮样式/ui-design-hds-tabs-bar-floating.md#迷你栏>)的显示动效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BarPosition](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#barposition枚举说明) | 是 | 设置Tabs的页签位置。  默认值：BarPosition.Start。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 是 | TabBar的高度值。单位：vp。设置为'auto'时，TabBar自适应子组件高度，仅在横向Tabs下有效。设置为小于0或大于Tabs高度值时，按默认值显示。  默认值：  - 未设置带样式的TabBar且vertical属性为false时，默认值为48vp。  - 未设置带样式的TabBar且vertical属性为true时，默认值为Tabs的高度。  - 设置[SubTabBarStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md#subtabbarstyle9)样式且vertical属性为false时，默认值为48vp。设置SubTabBarStyle样式且vertical属性为true时，默认值为Tabs的高度。  - 设置[BottomTabBarStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md#bottomtabbarstyle9)样式且vertical属性为true时，默认值为Tabs的高度。  - 设置BottomTabBarStyle样式且vertical属性为false时，默认值为48vp。  - 设置Tabs为[悬浮样式](ui-design-hdstabs.md#barfloatingstyle)时，默认值为56vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | TabBar的背景颜色。  默认值：Color.Transparent。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [BlurStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#blurstyle9) | 是 | 背景模糊样式。 |
| options | [BackgroundBlurStyleOptions](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundblurstyleoptions10对象说明) | 否 | 背景模糊选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [BackgroundEffectOptions](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundeffectoptions11) | 是 | 设置TabBar背景属性包括：模糊半径、亮度、饱和度、颜色等。 |
...
| options | [ScrollableBarModeOptions](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#scrollablebarmodeoptions10对象说明) | 否 | Scrollable模式下的TabBar的布局样式。  **说明**：仅横向tabs（vertical为false）下有效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Optional](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[HdsDividerStyle](ui-design-hdstabs.md#hdsdividerstyle)> | 是 | 分割线样式，默认跟手渐变。  mode：分割线模式，可以设置为常隐，常显和跟手渐变显隐（当内容区超过页签栏）。  style：分割线的样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| backgroundStyle | [Optional](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[HdsTabsBackgroundStyle](ui-design-hdstabs.md#hdstabsbackgroundstyle)> | 是 | 设置模糊的颜色和高度，默认模糊效果失效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BlurStrategy](../HdsNavigation/ui-design-hdsnavigation.md#blurstrategy) | 是 | 设置页签栏的模糊生效策略。  默认值：BlurStrategy.ADAPTIVE。 |
...
| mode | [TabsCacheMode](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#tabscachemode19枚举说明) | 是 | 子组件的缓存模式。  默认值：TabsCacheMode.CACHE\_BOTH\_SIDE |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| barFloatingStyle | [Optional](../../../ArkUI（方舟UI框架）/ArkTS组件/通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[HdsTabsFloatingStyle](ui-design-hdstabs.md#hdstabsfloatingstyle)> | 否 | 设置页签为悬浮样式。 |
...
| barSideMargin | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 页签栏与HdsTabs左右边距。  默认值：HdsTabs宽度小于600vp时，默认边距16vp；HdsTabs宽度在600vp-840vp之间，默认边距24vp，HdsTabs宽度大于840vp，默认边距32vp。 |
| barBottomMargin | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 页签栏与HdsTabs底部距离。  默认值：页签栏距离底部0vp。 |
...
| lightColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 页签栏光效颜色。  默认值：深色模式#33E5E5E5，浅色模式#33fffffff。 |
...
设置页签栏或[迷你栏](<../../../../harmonyos-guides/应用框架/UI Design Kit（UI设计套件）/底部页签/设置页签栏的悬浮样式/ui-design-hds-tabs-bar-floating.md#迷你栏>)的分档宽度。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| smallWidth | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 当HdsTabs宽度小于440vp时，页签栏或迷你栏的宽度。  默认值：页签个数小于等于3，且HdsTabs宽度小于600vp时，单个页签宽度76vp。页签个数大于等于4时，页签栏最大宽度不超过328vp。迷你栏最大宽度不超过328vp。 |
| mediumWidth | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 当HdsTabs宽度在440vp-600vp之间，或宽度在600-840vp之间且高宽比小于0.8时，页签栏或迷你栏的宽度。  默认值：页签个数小于等于3，且HdsTabs宽度小于600vp时，单个页签宽度76vp，HdsTabs宽度大于600vp时，单个页签宽度80vp。页签个数大于等于4时，页签栏最大宽度不超过328vp。迷你栏最大宽度不超过328vp。 |
| largeWidth | [Length](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 当HdsTabs宽度大于840vp，或宽度在600vp-840vp之间且高宽比大于0.8时，页签栏或迷你栏的宽度。  默认值：页签个数小于等于3，单个页签宽度80vp。页签个数大于等于4时，页签栏最大宽度不超过328vp。迷你栏最大宽度不超过328vp。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| miniBarBuilder | [CustomBuilder](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8)|[ComponentContent](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md>) | 否 | 否 | 迷你栏自定义内容区。 |
...
页签栏和[迷你栏](<../../../../harmonyos-guides/应用框架/UI Design Kit（UI设计套件）/底部页签/设置页签栏的悬浮样式/ui-design-hds-tabs-bar-floating.md#迷你栏>)样式类型枚举。
...
页签栏和[迷你栏](<../../../../harmonyos-guides/应用框架/UI Design Kit（UI设计套件）/底部页签/设置页签栏的悬浮样式/ui-design-hds-tabs-bar-floating.md#迷你栏>)更新模式。
...
[迷你栏](<../../../../harmonyos-guides/应用框架/UI Design Kit（UI设计套件）/底部页签/设置页签栏的悬浮样式/ui-design-hds-tabs-bar-floating.md#迷你栏>)或者页签栏样式更新时触发回调。
...
[迷你栏](<../../../../harmonyos-guides/应用框架/UI Design Kit（UI设计套件）/底部页签/设置页签栏的悬浮样式/ui-design-hds-tabs-bar-floating.md#迷你栏>)折叠展开动效开始时回调。
...
[迷你栏](<../../../../harmonyos-guides/应用框架/UI Design Kit（UI设计套件）/底部页签/设置页签栏的悬浮样式/ui-design-hds-tabs-bar-floating.md#迷你栏>)折叠展开动效结束时回调。
...
| style | [DividerStyle](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#dividerstyle10对象说明) | 否 | 是 | 页签栏分割线样式。  默认值：  {strokeWidth: '1px', color: '#33000000'}. |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| maskColor | [ResourceColor](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 渐变模糊的颜色设置。  默认值：#CCFFFFFF。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#callback12)<number> | 是 | 底部页签切换时触发该事件，获取切换后的页签下标。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [OnTabsAnimationStartCallback](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#ontabsanimationstartcallback18) | 是 | 切换的动画开始时触发该事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [OnTabsContentWillChangeCallback](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#ontabscontentwillchangecallback18) | 是 | 自定义Tabs页面切换拦截事件能力。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#callback12)<number> | 是 | 被点击的index索引，索引从0开始计算。 |
...
2. 通过[TabsController控制器](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#tabscontroller)调用[changeIndex](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#changeindex)接口，开始切换动画时触发。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#callback12)<number> | 是 | 当前选中元素的索引。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#callback12)<number> | 是 | 将要隐藏元素的索引。 |
...
| [BarMode](../../../ArkUI（方舟UI框架）/ArkTS组件/导航与切换/Tabs/ts-container-tabs.md#barmode枚举说明) | TabBar布局模式。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/kMY3545cQxagRcwv4avZMg/zh-cn_image_0000002592221002.png?HW-CC-KV=V1&HW-CC-Date=20260611T080712Z&HW-CC-Expire=86400&HW-CC-Sign=73B11E413408916F94E433D07D34664C1AF546B4EE22A804CB2460246B6A6C20)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/A1klDJC_SqOm6vxUhYK-Gw/zh-cn_image_0000002592380934.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T080712Z&HW-CC-Expire=86400&HW-CC-Sign=76FAD368978423BD6F0E80011CAC3E32B8900CD55601E1F8FB9A85F6E3EB163A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/gc4FuzDxTcaK56HHWQVm9A/zh-cn_image_0000002622860445.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T080712Z&HW-CC-Expire=86400&HW-CC-Sign=C7969C943ED3CD04564253913829FBC291982B7D11F54513CBD7F15D6BF495D1)
