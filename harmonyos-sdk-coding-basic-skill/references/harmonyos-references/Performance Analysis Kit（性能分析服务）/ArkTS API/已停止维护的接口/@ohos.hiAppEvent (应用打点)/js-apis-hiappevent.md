...
content_hash: sha256:df61c2d8b75ef7ad10995d97975817a012de8c1b1efdba6c5d24e71bbc7f5808
---
本模块提供了应用事件打点能力，包括对打点数据的落盘，以及对打点功能的管理配置。

说明

* 本模块接口从API version 9开始废弃，建议使用新接口[@ohos.hiviewdfx.hiAppEvent](<../../@ohos.hiviewdfx.hiAppEvent (应用事件打点)/js-apis-hiviewdfx-hiappevent.md>)替代。
