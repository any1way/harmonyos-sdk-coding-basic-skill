...
scraped_at: 2026-06-11T16:24:54+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:e49fffc6028e5e43a77637bb9dd5df4aab68cb4a7f4e4563917346f7b8d06a4b
---
...
系统事件来源于系统服务，是系统预先定义的事件，这类事件信息中的事件参数对象params包含的字段已由各系统事件定义，具体字段含义在各系统事件指南的介绍中，例如[崩溃事件介绍](<../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/事件订阅/使用HiAppEvent订阅事件/系统事件/崩溃事件/崩溃事件介绍/hiappevent-watcher-crash-events.md>)。
...
以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)和[应用事件打点错误码](../../错误码/应用事件打点错误码/errorcode-hiappevent.md)。
...
可参考[Worker简介](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/Worker简介/worker-introduction.md)，以实现在子线程中调用接口。
...
| name | string | 否 | 事件名称。默认为空字符串，空字符串表示关联事件领域下的所有事件名称。事件名称可支持关联应用事件和系统事件，其中系统事件仅支持关联：  - [崩溃事件](<../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/事件订阅/使用HiAppEvent订阅事件/系统事件/崩溃事件/崩溃事件介绍/hiappevent-watcher-crash-events.md>)（hiAppEvent.event.APP\_CRASH）  - [应用冻屏事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-watcher-freeze-events)（hiAppEvent.event.APP\_FREEZE）  - [资源泄漏事件](<../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/事件订阅/使用HiAppEvent订阅事件/系统事件/资源泄漏事件/资源泄漏事件介绍/hiappevent-watcher-resourceleak-events.md>)（hiAppEvent.event.RESOURCE\_OVERLIMIT）。  **注意**：从API version 20开始，支持[资源泄漏事件](<../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/事件订阅/使用HiAppEvent订阅事件/系统事件/资源泄漏事件/资源泄漏事件介绍/hiappevent-watcher-resourceleak-events.md>)。 |
...
* MAIN\_THREAD\_JANK（参数配置详见[主线程超时事件检测](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-watcher-mainthreadjank-events#seteventconfig接口参数设置说明)）
* APP\_CRASH（参数配置详见[崩溃日志配置参数设置介绍](<../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/事件订阅/使用HiAppEvent订阅事件/系统事件/崩溃事件/崩溃事件介绍/hiappevent-watcher-crash-events.md#崩溃日志规格自定义参数设置>)）
* RESOURCE\_OVERLIMIT（参数配置详见[资源泄漏事件检测](<../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/事件订阅/使用HiAppEvent订阅事件/系统事件/资源泄漏事件/资源泄漏事件介绍/hiappevent-watcher-resourceleak-events.md#自定义规格设置>)）
...
不同类型应用上，系统事件的订阅规格不同，具体规格可参见[HiAppEvent约束与限制](<../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/事件订阅/HiAppEvent介绍/hiappevent-intro.md#约束与限制>)。
...
可参考[多线程并发概述](../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/多线程并发概述/multi-thread-concurrency-overview.md)，以实现在子线程中调用接口。
...
以下错误码的详细介绍请参见[应用事件打点错误码](../../错误码/应用事件打点错误码/errorcode-hiappevent.md)。
