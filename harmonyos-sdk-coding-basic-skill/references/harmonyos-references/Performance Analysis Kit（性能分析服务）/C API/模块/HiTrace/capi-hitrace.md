...
scraped_at: 2026-06-11T16:25:04+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:c82c26342077dd5d5f36545a57899d78090736b3751984b41b3140e42d60e5ce
---
## 概述
...
| 名称 | 描述 |
| --- | --- |
| [trace.h](../../头文件/trace.h/capi-trace-h.md) | HiTraceMeter和HiTraceChain模块接口定义，通过这些接口实现性能打点和分布式跟踪功能。  用户态trace格式使用竖线字符作为分隔符，所以通过HiTraceMeter接口传递的字符串类型参数应避免包含该字符，防止trace解析异常。  用户态trace总长度限制512字符，超过的部分将会被截断。 |
