...
scraped_at: 2026-06-11T16:25:07+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:a358172319cd72fde75f0eca0f8356bd628d64dccab39c579ada2ead2125401b
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [HiAppEvent\_AppEventInfo](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/HiAppEvent_AppEventInfo/capi-hiappevent-hiappevent-appeventinfo.md>) | HiAppEvent\_AppEventInfo | 单个事件信息，包含事件领域、事件名称、事件类型和事件携带的用json格式字符串表示的自定义参数列表。 |
| [HiAppEvent\_AppEventGroup](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/HiAppEvent_AppEventGroup/capi-hiappevent-hiappevent-appeventgroup.md>) | HiAppEvent\_AppEventGroup | 一组事件信息，包含事件组的名称，按名称分组的单个事件信息数组，事件数组的长度。 |
| [ParamListNode\*](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/ParamListNode/capi-hiappevent-paramlistnode8h.md>) | ParamList | 事件参数列表节点。 |
| [HiAppEvent\_Watcher](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/HiAppEvent_Watcher/capi-hiappevent-hiappevent-watcher.md>) | HiAppEvent\_Watcher | 用于接收app事件的监听器。 |
| [HiAppEvent\_Processor](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/HiAppEvent_Processor/capi-hiappevent-hiappevent-processor.md>) | HiAppEvent\_Processor | 应用事件上报的处理者。 |
| [HiAppEvent\_Config](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/HiAppEvent_Config/capi-hiappevent-hiappevent-config.md>) | HiAppEvent\_Config | 用于设置系统事件触发条件的配置对象。 |
...
| [int OH\_HiAppEvent\_SetEventConfig(const char\* name, HiAppEvent\_Config\* config)](capi-hiappevent-h.md#oh_hiappevent_seteventconfig) | - | 事件相关的配置参数设置方法。  不同的事件有不同的配置项，目前仅支持以下事件：  MAIN\_THREAD\_JANK（参数配置详见[主线程超时事件检测](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-watcher-mainthreadjank-events#oh_hiappevent_seteventconfig接口参数设置说明)）  MAIN\_THREAD\_JANK\_V2（参数配置详见[主线程超时事件检测](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-watcher-mainthreadjank-events#oh_hiappevent_seteventconfig接口参数设置说明)）  EVENT\_APP\_CRASH（参数配置详见[崩溃事件介绍](<../../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/事件订阅/使用HiAppEvent订阅事件/系统事件/崩溃事件/崩溃事件介绍/hiappevent-watcher-crash-events.md#oh_hiappevent_seteventconfig接口参数设置说明>)），从API version 24开始支持该事件。 |
...
| [const struct HiAppEvent\_AppEventGroup](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/HiAppEvent_AppEventGroup/capi-hiappevent-hiappevent-appeventgroup.md>)\* appEventGroups | 按照不同事件名称分组的事件组数组。 |
...
| 类型 | 说明 |
| --- | --- |
| [ParamList](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/ParamListNode/capi-hiappevent-paramlistnode8h.md>) | 指向参数列表对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ParamList](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/ParamListNode/capi-hiappevent-paramlistnode8h.md>) list | 参数列表对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ParamList](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/ParamListNode/capi-hiappevent-paramlistnode8h.md>) list | 需要添加参数的参数列表指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ParamList](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/ParamListNode/capi-hiappevent-paramlistnode8h.md>) | 添加参数后的参数列表指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| const char\* name | 配置项名称。名称可填[DISABLE](../hiappevent_cfg.h/capi-hiappevent-cfg-h.md#disable)和[MAX\_STORAGE](../hiappevent_cfg.h/capi-hiappevent-cfg-h.md#max_storage)。 |
| const char\* value | 配置项值。如果配置项名称是[DISABLE](../hiappevent_cfg.h/capi-hiappevent-cfg-h.md#disable)，值可以填“true”或者“false”；  如果配置项名称是[MAX\_STORAGE](../hiappevent_cfg.h/capi-hiappevent-cfg-h.md#max_storage)，配额值字符串只由数字字符和大小单位字符（单位字符支持[b|k|kb|m|mb|g|gb|t|tb]，不区分大小写）构成。  配额值字符串必须以数字开头，后面可以选择不传单位字符（默认使用byte作为单位），或者以单位字符结尾。 |
...
| 类型 | 说明 |
| --- | --- |
| [HiAppEvent\_Watcher](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/HiAppEvent_Watcher/capi-hiappevent-hiappevent-watcher.md>)\* | 接口调用成功时返回指向的新建监听器的指针，name参数异常时返回nullptr。 |
...
| 参数项 | 描述 |
| --- | --- |
| [HiAppEvent\_Watcher](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/HiAppEvent_Watcher/capi-hiappevent-hiappevent-watcher.md>)\* watcher | 指向监听器的指针（即OH\_HiAppEvent\_CreateWatcher接口返回的指针）。 |
...
| 类型 | 说明 |
| --- | --- |
| [HiAppEvent\_Processor](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/HiAppEvent_Processor/capi-hiappevent-hiappevent-processor.md>)\* | 接口调用成功时返回指向的新建处理者的指针，name参数异常时返回nullptr。 |
...
| 参数项 | 描述 |
| --- | --- |
| [HiAppEvent\_Processor](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/HiAppEvent_Processor/capi-hiappevent-hiappevent-processor.md>)\* processor | 指向处理者的指针（即OH\_HiAppEvent\_CreateProcessor接口返回的指针）。 |
...
| 类型 | 说明 |
| --- | --- |
| [HiAppEvent\_Config](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/HiAppEvent_Config/capi-hiappevent-hiappevent-config.md>)\* | 指向设置系统事件触发条件的配置对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [HiAppEvent\_Config](<../../../../调测调优/Performance Analysis Kit（性能分析服务）/C API/结构体/HiAppEvent_Config/capi-hiappevent-hiappevent-config.md>)\* config | 指向配置对象的指针（即OH\_HiAppEvent\_CreateConfig接口返回的指针）。 |
...
EVENT\_APP\_CRASH（参数配置详见[崩溃事件介绍](<../../../../../harmonyos-guides/系统/调测调优/Performance Analysis Kit（性能分析服务）/事件订阅/使用HiAppEvent订阅事件/系统事件/崩溃事件/崩溃事件介绍/hiappevent-watcher-crash-events.md#oh_hiappevent_seteventconfig接口参数设置说明>)），从API version 24开始支持该事件。
