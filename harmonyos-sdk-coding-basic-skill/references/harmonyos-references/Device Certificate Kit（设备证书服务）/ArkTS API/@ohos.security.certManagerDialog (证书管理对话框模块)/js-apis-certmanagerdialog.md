...
content_hash: sha256:6d5b1684c21763e2fd7099bc4810e33e6db4e759c371555e29ae1c7253f7bd59
---
...
| certPurpose | [certificateManager.CertificatePurpose](<../@ohos.security.certManager (证书管理模块)/js-apis-certmanager.md#certificatepurpose22>) | 否 | 是 | 表示证书用途。  若certTypes参数中存在CertificateType.CREDENTIAL\_UKEY类型，则certPurpose参数生效，表示根据指定的证书用途筛选USB Key的证书凭据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](<../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.common (Ability公共模块)/js-apis-app-ability-common.md#context>) | 是 | 表示应用的上下文信息。 |
...
以下错误码的详细介绍请参见[证书管理对话框错误码](../../错误码/证书管理对话框错误码/errorcode-certmanagerdialog.md)。
...
以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)和[证书管理对话框错误码](../../错误码/证书管理对话框错误码/errorcode-certmanagerdialog.md)。
