...
scraped_at: 2026-06-11T16:21:00+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:5c966c2d6585a0902295ac359f891715a0ca948f7de240c5fd29a25bcc15c019
---
...
全局通用限制类策略由restrictions统一提供，若要全局禁用蓝牙，请参考[@ohos.enterprise.restrictions（限制类策略）](<../@ohos.enterprise.restrictions （限制类策略）/js-apis-enterprise-restrictions.md>)。
...
1. 已经通过[setDisallowedPolicy](<../@ohos.enterprise.restrictions （限制类策略）/js-apis-enterprise-restrictions.md#restrictionssetdisallowedpolicy>)接口禁用了蓝牙。通过[setDisallowedPolicy](<../@ohos.enterprise.restrictions （限制类策略）/js-apis-enterprise-restrictions.md#restrictionssetdisallowedpolicy>)接口启用蓝牙后，可解除冲突。
...
添加蓝牙协议禁用名单。添加后，指定用户将无法使用该禁用名单中的蓝牙协议向其他设备外发文件。通过该接口禁用[GATT](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#gatt>)或[SPP](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#spp>)协议，对系统服务和系统应用不生效。
...
| state | [access.BluetoothState](<../../../../网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.access (蓝牙access模块)/js-apis-bluetooth-access.md#bluetoothstate>) | 否 | 否 | 表示设备的蓝牙状态。 |
| connectionState | [constant.ProfileConnectionState](<../../../../网络/Connectivity Kit（短距通信服务）/ArkTS API/@ohos.bluetooth.constant (蓝牙constant模块)/js-apis-bluetooth-constant.md#profileconnectionstate>) | 否 | 否 | 表示设备的蓝牙连接状态。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| GATT | 0 | [GATT协议](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#gatt>)。 |
| SPP | 1 | [SPP协议](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#spp>)。 |
| OPP | 2 | [OPP协议](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#opp>)。 |
