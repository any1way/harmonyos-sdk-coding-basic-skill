...
scraped_at: 2026-06-11T16:20:53+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:ec4bc928a88a0494817340a631bc6ce0aa05e026f9f9ac5853a9ce0286f1fb2f
---
...
本模块接口仅对设备管理应用开放，且调用接口前需激活设备管理应用，具体请参考[MDM Kit开发指南](<../../../../../harmonyos-guides/系统/基础功能/MDM Kit（企业设备管理服务）/MDM Kit开发指南/mdm-kit-guide.md>)。[applicationManager.isAppKioskAllowed](js-apis-enterprise-applicationmanager.md#applicationmanagerisappkioskallowed20)除外，该接口对所有应用开放。
...
**冲突规则：** [合并](<../../../../../harmonyos-guides/系统/基础功能/MDM Kit（企业设备管理服务）/多应用管控/mdm-kit-multi-mdm.md#规则4合并>)。
...
| appIds | Array<string> | 是 | 应用ID数组，指定具体应用。  **说明：** 从API version 21版本开始，支持传入应用的[appId](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appid)和[appIdentifier](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appidentifier)，推荐使用[appIdentifier](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appidentifier)。API version 20及之前版本，仅支持[appId](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appid)。 |
| accountId | number | 否 | 用户ID，取值范围：大于等于0。  accountId可以通过@ohos.account.osAccount中的[getOsAccountLocalId](<../../../Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.osAccount (系统账号管理)/js-apis-osaccount.md#getosaccountlocalid9-1>)等接口来获取。  - 调用接口时，若传入accountId，表示指定用户。  - 调用接口时，若未传入accountId，表示当前用户。 |
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| appIds | Array<string> | 是 | 应用ID数组，指定具体应用。  **说明：** 从API version 21版本开始，数组中的元素支持使用[appId](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appid)和[appIdentifier](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appidentifier)，仅移除传入的[appId](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appid)（或[appIdentifier](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appidentifier)），不会移除同一应用的[appIdentifier](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appidentifier)（或[appId](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appid)）。API version 20及之前版本，数组中的元素只支持使用[appId](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appid)。 |
| accountId | number | 否 | 用户ID，取值范围：大于等于0。  accountId可以通过@ohos.account.osAccount中的[getOsAccountLocalId](<../../../Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.osAccount (系统账号管理)/js-apis-osaccount.md#getosaccountlocalid9-1>)等接口来获取。  - 调用接口时，若传入accountId，表示指定用户。  - 调用接口时，若未传入accountId，表示当前用户。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<string> | 返回当前/指定用户下的应用运行禁止名单。  **说明：** API version 20及之前版本，返回值为应用[appId](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appid)列表。从API version 21版本开始，返回值为应用[appId](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appid)或[appIdentifier](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appidentifier)列表。 |
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| appIdentifiers | Array<string> | 是 | 应用[唯一标识符](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包常见问题/common-problem-of-application.md#什么是appidentifier)的数组，可以通过接口[bundleManager.getInstalledBundleList](../@ohos.enterprise.bundleManager（包管理）/js-apis-enterprise-bundlemanager.md#bundlemanagergetinstalledbundlelist20)获取bundleInfo.signatureInfo.appIdentifier。  取值范围：  - 单个用户下该名单总数不能超过200。例如100用户下已经设置了50个、101用户未设置，则100用户还能再设置150个，101用户还能再设置200个。 |
| accountId | number | 是 | 用户ID，取值范围：大于等于0。  accountId可以通过@ohos.account.osAccount中的[getOsAccountLocalId](<../../../Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.osAccount (系统账号管理)/js-apis-osaccount.md#getosaccountlocalid9-1>)等接口来获取。 |
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| autoStartApps | Array<[Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>)> | 是 | 开机自启动应用数组。数组长度上限为10。例如：如果名单中已有5个应用，则最多再通过本接口设置5个。Want中必须包含bundleName和abilityName。Ability支持UIAbility和ServiceExtensionAbility。当[abilities](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#abilities标签)标签中exported属性值为false时，不支持拉起Ability。从API version 24开始，新增支持通过Want的parameters属性中的isHiddenStart字段配置应用开机自启是否隐藏UI界面，true表示隐藏，false表示不隐藏。默认值是false。该参数设置为true时，应用必须[接入状态栏](<../../../../../harmonyos-guides/系统/基础功能/Desktop Extension Kit（桌面拓展服务）/应用接入状态栏/statusbar-extension-guide.md>)，否则自启设置失败（若当前仅设置一个应用自启时隐藏UI界面，该应用未接入状态栏，则抛出401异常；若设置多个应用，有一个设置成功，返回成功）。设置成功后，应用自启后不显示UI界面，仅在状态栏显示，UI进程存在。隐藏UI界面能力仅在PC/2in1和Tablet的PC模式中可正常使用。 |
...
14. // 下面为非必选参数
15. parameters: {
16. // 从API version 24开始支持，配置应用开机自启时，是否隐藏UI界面，true代表隐藏，该参数设置为true时，应用需接入状态栏，否则自启设置失败，抛出401异常。
17. isHiddenStart: true
18. }
19. }
20. ];

22. try {
23. applicationManager.addAutoStartApps(wantTemp, autoStartApps);
24. console.info('Succeeded in adding auto start applications.');
25. } catch(err) {
26. console.error(`Failed to add auto start applications. Code: ${err.code}, message: ${err.message}`);
27. }
```
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| autoStartApps | Array<[Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>)> | 是 | 开机自启动应用名单数组。Want中必须包含bundleName和abilityName。 |
| accountId | number | 是 | 用户ID，取值范围：大于等于0。  accountId可以通过@ohos.account.osAccount中的[getOsAccountLocalId](<../../../Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.osAccount (系统账号管理)/js-apis-osaccount.md#getosaccountlocalid9-1>)等接口来获取。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>)> | 应用自启动名单数组。从API version 24开始，支持返回是否隐藏UI的配置。 |
...
2. [
3. {
4. "bundleName": "com.example.edmtest",
5. "abilityName": "EntryAbility",
6. // 从API version 24支持
7. "parameters": {
8. "isHiddenStart": false
9. }
10. },
11. // ...
12. ]
...
15. // 下面为非必选参数
16. parameters: {
17. // 从API version 24开始支持，配置应用开机自启时，是否隐藏UI界面，true代表隐藏，该参数设置为true时，应用需接入状态栏，否则自启设置失败，抛出401异常。
18. isHiddenStart: true
19. }
20. }
21. ];

23. try {
24. applicationManager.addAutoStartApps(wantTemp, autoStartApps, 100, true);
25. console.info('Succeeded in adding auto start applications and set disallowModify.');
26. } catch(err) {
27. console.error(`Failed to add auto start applications and set disallowModify. Code: ${err.code}, message: ${err.message}`);
28. }
```
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| autoStartApp | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 开机自启动应用。Want中必须包含bundleName和abilityName。 |
| accountId | number | 是 | 用户ID，取值范围：大于等于0。  accountId可以通过@ohos.account.osAccount中的[getOsAccountLocalId](<../../../Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.osAccount (系统账号管理)/js-apis-osaccount.md#getosaccountlocalid9-1>)等接口来获取。 |
...
添加保活应用名单，添加后将自动保活应用进程。在开机和应用被杀死后，由系统主动拉起应用进程。添加至名单后的应用，需要[接入状态栏](<../../../../../harmonyos-guides/系统/基础功能/Desktop Extension Kit（桌面拓展服务）/应用接入状态栏/statusbar-extension-guide.md>)，保活才能生效。
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| bundleNames | Array<string> | 是 | 应用包名数组，指定需要添加至保活名单的应用，最大支持5个。应用需要满足条件：安装在普通用户下且应用接入[状态栏开放服务](<../../../../../harmonyos-guides/系统/基础功能/Desktop Extension Kit（桌面拓展服务）/应用接入状态栏/statusbar-extension-guide.md>)。否则，会报错误码9201005。 |
| accountId | number | 是 | 用户ID，取值范围：大于等于0。  accountId可以通过@ohos.account.osAccount中的[getOsAccountLocalId](<../../../Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.osAccount (系统账号管理)/js-apis-osaccount.md#getosaccountlocalid9-1>)等接口来获取。 |
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| bundleNames | Array<string> | 是 | 应用包名数组，指定需要添加至保活名单的应用，最大支持5个。  应用需要满足条件：安装在1用户下（1用户是支持三方应用单例运行的用户），且应用接入[后台服务](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/ExtensionAbility组件/使用AppServiceExtensionAbility组件实现后台服务/app-service-extension-ability.md#实现一个后台服务>)；或者安装在普通用户下且应用接入[状态栏开放服务](<../../../../../harmonyos-guides/系统/基础功能/Desktop Extension Kit（桌面拓展服务）/应用接入状态栏/statusbar-extension-guide.md>)。否则，会报错误码9201005。 |
| accountId | number | 是 | 用户ID，取值范围：大于等于0。  accountId可以通过@ohos.account.osAccount中的[getOsAccountLocalId](<../../../Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.osAccount (系统账号管理)/js-apis-osaccount.md#getosaccountlocalid9-1>)等接口来获取。 |
...
| appIndex | number | 是 | 应用分身索引，取值范围：大于等于0的整数。  appIndex可以通过@ohos.bundle.bundleManager中的[getAppCloneIdentity](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#bundlemanagergetappcloneidentity14>)等接口来获取。 |
| accountId | number | 是 | 用户ID，取值范围：大于等于0的整数。  accountId可以通过@ohos.account.osAccount中的[getOsAccountLocalId](<../../../Basic Services Kit（基础服务）/ArkTS API/账号管理/@ohos.account.osAccount (系统账号管理)/js-apis-osaccount.md#getosaccountlocalid9-1>)等接口来获取。 |
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| appIdentifiers | Array<string> | 是 | 应用[唯一标识符](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/BundleInfo/js-apis-bundlemanager-bundleinfo.md#signatureinfo>)的数组，可以通过接口[bundleManager.getBundleInfo](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#bundlemanagergetbundleinfo14-2>)获取bundleInfo.signatureInfo.appIdentifier。重复设置时，新设置的数组会覆盖旧的设置，最多设置200个。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<string> | 允许在Kiosk模式下运行的应用[唯一标识符](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/BundleInfo/js-apis-bundlemanager-bundleinfo.md#signatureinfo>)清单。 |
...
12. kioskFeatures.push(applicationManager.KioskFeature.ALLOW_GESTURE_CONTROL);
13. kioskFeatures.push(applicationManager.KioskFeature.ALLOW_SIDE_DOCK);
14. try {
15. applicationManager.setKioskFeatures(wantTemp, kioskFeatures);
16. console.info('Succeeded in setting kiosk feature.');
17. } catch (err) {
18. console.error(`Failed to set kiosk feature. Code is ${err.code}, message is ${err.message}`);
19. }
```
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| applicationInstances | Array<[common.ApplicationInstance](../@ohos.enterprise.common（Enterprise公共模块）/js-apis-enterprise-common.md#applicationinstance)> | 是 | 不可关停应用名单数组。不可关停应用名单最多支持包含10个应用，该数量限制不区分用户，即所有用户下添加应用的总和的最大限制为10个。例如：若当前名单中已有3个应用，则最多还能通过本接口为指定用户添加7个应用。 |
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| applicationInstances | Array<[common.ApplicationInstance](../@ohos.enterprise.common（Enterprise公共模块）/js-apis-enterprise-common.md#applicationinstance)> | 是 | 不可关停应用名单数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[common.ApplicationInstance](../@ohos.enterprise.common（Enterprise公共模块）/js-apis-enterprise-common.md#applicationinstance)> | 不可关停应用名单数组。 |
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| applicationInstances | Array<[common.ApplicationInstance](../@ohos.enterprise.common（Enterprise公共模块）/js-apis-enterprise-common.md#applicationinstance)> | 是 | 后台防冻结应用名单数组，后台防冻结应用名单最多支持包含10个应用，该数量限制不区分用户，即所有用户下添加应用的总和的最大限制为10个。例如：若当前名单中已有3个应用，则最多还能通过本接口为指定用户添加7个应用。 |
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| applicationInstances | Array<[common.ApplicationInstance](../@ohos.enterprise.common（Enterprise公共模块）/js-apis-enterprise-common.md#applicationinstance)> | 是 | 后台防冻结应用名单数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Array<[common.ApplicationInstance](../@ohos.enterprise.common（Enterprise公共模块）/js-apis-enterprise-common.md#applicationinstance)> | 后台防冻结应用名单数组。 |
...
11. // 需根据实际情况进行替换
12. let bundleName: string = 'com.example.exampleapplication';
13. let abilityName: string = 'EntryAbility';
14. applicationManager.addDockApp(wantTemp, bundleName, abilityName, 3);
15. console.info('Succeeded in adding dock app.');
16. } catch(err) {
17. console.error(`Failed to add dock app. Code: ${err.code}, message: ${err.message}`);
18. }
```
...
12. let bundleName: string = 'com.example.exampleapplication';
13. let abilityName: string = 'EntryAbility';
14. applicationManager.removeDockApp(wantTemp, bundleName, abilityName);
15. console.info('Succeeded in removing dock app.');
16. } catch(err) {
17. console.error(`Failed to remove dock app. Code: ${err.code}, message: ${err.message}`);
18. }
```
...
10. try {
11. let result: Array<applicationManager.DockInfo> = applicationManager.getDockApps(wantTemp);
12. console.info(`Succeeded in getting dock apps, result : ${JSON.stringify(result)}`);
13. } catch(err) {
14. console.error(`Failed to get dock apps. Code: ${err.code}, message: ${err.message}`);
15. }
```
