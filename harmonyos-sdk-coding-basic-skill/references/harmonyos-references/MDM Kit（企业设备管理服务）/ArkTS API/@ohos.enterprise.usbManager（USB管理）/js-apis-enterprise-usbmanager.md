...
scraped_at: 2026-06-11T16:21:23+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:cd7ed4484f15d6248d6d7ccc1a6f4fad1c9f5792cd5976ed0bae49735e241d2e
---
本模块提供USB管理能力。
...
全局通用限制类策略由restrictions统一提供，若要全局禁用USB，请参考[@ohos.enterprise.restrictions（限制类策略）](<../@ohos.enterprise.restrictions （限制类策略）/js-apis-enterprise-restrictions.md>)。
...
1. 已经通过[setDisallowedPolicy](<../@ohos.enterprise.restrictions （限制类策略）/js-apis-enterprise-restrictions.md#restrictionssetdisallowedpolicy>)接口禁用了设备USB或者USB转串口能力。
...
| usbDeviceIds | Array<[UsbDeviceId](js-apis-enterprise-usbmanager.md#usbdeviceid)> | 是 | USB设备ID数组，UsbDeviceId信息可以通过[getDevices](<../../../Basic Services Kit（基础服务）/ArkTS API/设备管理/@ohos.usbManager (USB管理)/js-apis-usbmanager.md#usbmanagergetdevices>)接口获取。USB设备可用名单数组长度上限为1000，若当前允许名单中已有300个USB设备ID，则只允许再添加700个。 |
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| usbDeviceIds | Array<[UsbDeviceId](js-apis-enterprise-usbmanager.md#usbdeviceid)> | 是 | USB设备ID数组，UsbDeviceId信息可以通过[getDevices](<../../../Basic Services Kit（基础服务）/ArkTS API/设备管理/@ohos.usbManager (USB管理)/js-apis-usbmanager.md#usbmanagergetdevices>)接口获取。 |
...
1. 已经通过[setDisallowedPolicy](<../@ohos.enterprise.restrictions （限制类策略）/js-apis-enterprise-restrictions.md#restrictionssetdisallowedpolicy>)接口禁用了设备USB能力。
...
3. 已经通过[setDisallowedPolicyForAccount](<../@ohos.enterprise.restrictions （限制类策略）/js-apis-enterprise-restrictions.md#restrictionssetdisallowedpolicyforaccount14>)接口禁用了某用户USB存储设备写入能力。
...
**冲突规则：** [从严管控](<../../../../../harmonyos-guides/系统/基础功能/MDM Kit（企业设备管理服务）/多应用管控/mdm-kit-multi-mdm.md#规则1从严管控>), 严格优先级： 禁用 > 只读 > 可读可写。
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| usbDevices | Array<[UsbDeviceType](js-apis-enterprise-usbmanager.md#usbdevicetype14)> | 是 | 要添加的USB设备类型的数组，UsbDeviceType信息可以通过[getDevices](<../../../Basic Services Kit（基础服务）/ArkTS API/设备管理/@ohos.usbManager (USB管理)/js-apis-usbmanager.md#usbmanagergetdevices>)接口获取。USB设备禁用名单数组长度上限为200，若当前禁用名单中已有100个USB设备ID，则只允许再添加100个。 |
...
| --- | --- | --- | --- |
| admin | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md>) | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。 |
| usbDevices | Array<[UsbDeviceType](js-apis-enterprise-usbmanager.md#usbdevicetype14)> | 是 | 要移除的USB设备类型的数组，UsbDeviceType信息可以通过[getDevices](<../../../Basic Services Kit（基础服务）/ArkTS API/设备管理/@ohos.usbManager (USB管理)/js-apis-usbmanager.md#usbmanagergetdevices>)接口获取。 |
