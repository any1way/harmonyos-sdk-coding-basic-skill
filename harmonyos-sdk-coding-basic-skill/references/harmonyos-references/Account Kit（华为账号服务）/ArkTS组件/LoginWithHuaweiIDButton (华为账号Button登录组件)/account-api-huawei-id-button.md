...
scraped_at: 2026-06-01T16:32:14+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:0ddc9ff55ca6d86b59772e82cf09a5c97bced802ca40dcd160a267ebbe22c515
---
本模块提供LoginWithHuaweiIDButton组件，应用通过集成该组件完成华为账号登录功能。

LoginWithHuaweiIDButton需要配合[loginComponentManager](<../loginComponentManager (华为账号登录组件管理)/account-api-component-manager.md>)一起使用，用于实现华为账号登录功能。LoginWithHuaweiIDButton组件文本内容默认支持多语言。
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| params | [LoginWithHuaweiIDButtonParams](<../loginComponentManager (华为账号登录组件管理)/account-api-component-manager.md#loginwithhuaweiidbuttonparams>) | 是 | - | LoginWithHuaweiIDButton组件参数。 |
| controller | [LoginWithHuaweiIDButtonController](<../loginComponentManager (华为账号登录组件管理)/account-api-component-manager.md#loginwithhuaweiidbuttoncontroller>) | 是 | - | LoginWithHuaweiIDButton组件控制器用来接收组件的点击事件。 |
