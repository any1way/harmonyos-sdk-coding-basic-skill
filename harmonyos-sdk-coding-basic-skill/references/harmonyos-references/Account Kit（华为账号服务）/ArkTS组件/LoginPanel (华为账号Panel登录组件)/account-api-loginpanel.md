...
scraped_at: 2026-06-01T16:32:13+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:f2a6a36d6efaee493dca1ab9e62d9c354099c248eb64edf55a5da33fc22d3e6f
---
本模块提供LoginPanel组件，应用通过集成该组件完成华为账号登录功能。

LoginPanel需要配合[loginComponentManager](<../loginComponentManager (华为账号登录组件管理)/account-api-component-manager.md>)一起使用，用于实现华为账号登录功能。LoginPanel内的按钮文本默认支持多语言。
...
| params | [LoginPanelParams](<../loginComponentManager (华为账号登录组件管理)/account-api-component-manager.md#loginpanelparams>) | 是 | - | LoginPanel组件参数。 |
| controller | [LoginPanelController](<../loginComponentManager (华为账号登录组件管理)/account-api-component-manager.md#loginpanelcontroller>) | 是 | - | LoginPanel组件控制器用来接收组件的点击事件。 |
