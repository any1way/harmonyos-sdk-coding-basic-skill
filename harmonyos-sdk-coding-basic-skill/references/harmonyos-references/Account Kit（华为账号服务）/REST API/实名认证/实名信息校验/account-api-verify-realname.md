...
scraped_at: 2026-06-11T16:42:37+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:19044ed25be5ebc587b567ad79b194155aca40bdee3c50d2fcf60c63bfa4c083
---
注意
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| access\_token | 是 | String | 通过[获取用户级凭证](../../开放接口调用凭证/获取用户级凭证/account-api-obtain-user-token.md)获取的Access Token。  **说明：**  本场景下Access Token只能使用一次，再次使用会报“access forbidden”错误。 |
