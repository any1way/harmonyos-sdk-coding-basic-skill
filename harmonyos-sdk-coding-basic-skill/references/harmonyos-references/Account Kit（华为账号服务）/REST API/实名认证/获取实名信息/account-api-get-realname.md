...
scraped_at: 2026-06-11T16:42:35+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:27eebde6227555402134d33e9899e6653ca45e18732282616a3c84107069dde1
---
注意
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| access\_token | 是 | String | 通过[获取用户级凭证](../../开放接口调用凭证/获取用户级凭证/account-api-obtain-user-token.md)获取的Access Token。 |
