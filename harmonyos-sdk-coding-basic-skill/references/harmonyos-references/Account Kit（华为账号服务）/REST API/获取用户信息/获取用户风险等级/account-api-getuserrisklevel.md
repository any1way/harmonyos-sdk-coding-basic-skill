...
scraped_at: 2026-06-01T16:32:31+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:6c63ebc02f235034080c3de7615fc48b4c97b9df94503b5dc88a5a434956359d
---
注意
...
当应用服务端需要[获取风险等级](<../../../../../harmonyos-guides/应用服务/Account Kit（华为账号服务）/获取华为账号用户信息/获取风险等级/概述/account-get-risklevel-introduction.md>)时，应用服务端向华为账号服务器调用该接口获取华为账号用户风险等级。
...
* 需确保调用端网络正常。
* 应用使用此功能之前，需要完成riskLevel（获取用户风险等级）的scope权限申请，在获取Authorization Code时携带riskLevel（获取用户风险等级）的scope，详见[开发前提](<../../../../../harmonyos-guides/应用服务/Account Kit（华为账号服务）/获取华为账号用户信息/获取风险等级/通过华为账号一键登录获取用户风险等级/account-get-risklevel-byquicklogin.md#开发前提>)。
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| accessToken | 是 | String | 通过[获取用户级凭证](../../开放接口调用凭证/获取用户级凭证/account-api-obtain-user-token.md)获取的Access Token。获取凭证时Authorization Code需包含riskLevel scope的授权。 |
