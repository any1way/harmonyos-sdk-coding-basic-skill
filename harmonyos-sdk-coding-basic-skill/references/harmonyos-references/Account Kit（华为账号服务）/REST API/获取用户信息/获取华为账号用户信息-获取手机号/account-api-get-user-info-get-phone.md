...
scraped_at: 2026-06-01T16:32:30+08:00
doc_updated_at: 2026-05-28
content_hash: sha256:886464097aec671a844c837c370fe3280d7def14d668eb6818c59a76e205fd4f
---
注意
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| access\_token | 是 | String | 通过[获取用户级凭证](../../开放接口调用凭证/获取用户级凭证/account-api-obtain-user-token.md)获取的Access Token。获取凭证时Authorization Code需包含phone scope的授权。 |
...
| mobileNumber | 否 | String | 用户选择授权给应用的手机号（华为账号绑定号码或用户选择的其他手机号），详见[获取手机号](<../../../../../harmonyos-guides/应用服务/Account Kit（华为账号服务）/获取华为账号用户信息/获取手机号/概述/account-get-phone-overview.md>)。  以下场景mobileNumber不返回：  - 用户未绑定手机号。  - 用户授权提供的手机号与华为账号的关联已被删除。  - 应用未申请phone的scope权限。  - 获取Authorization Code时不携带phone scope。 |
