...
scraped_at: 2026-06-11T16:42:27+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:b838698ac745b1be2ef11515fc4fb74c731f6dcc1f1e9663a21c473d6cefd90f
---
注意
...
| code | 是 | String | 当“grant\_type”为“authorization\_code”时，此参数必选。获取方式详见[LoginWithHuaweiIDResponse](<../../../ArkTS API/authentication (华为账号应用统一认证服务)/account-api-authentication.md#loginwithhuaweiidresponse>)或[AuthorizationWithHuaweiIDResponse](<../../../ArkTS API/authentication (华为账号应用统一认证服务)/account-api-authentication.md#authorizationwithhuaweiidresponse>)。 |
...
| id\_token | 是 | String | ID Token（JWT格式），详细信息请参见[验证ID Token有效性](<../../扩展能力/验证ID Token有效性/account-api-verify-id-token.md>)中ID Token描述。 |
...
| 1101 | 20182 | grant\_type值不正确。 | grant\_type可选值如下：  - “authorization\_code”：该场景用于[获取用户级凭证](account-api-obtain-user-token.md)。  - “refresh\_token”： 该场景用于[刷新用户级凭证](../刷新用户级凭证/account-api-obtain-refresh-token.md)。  - “client\_credentials”：该场景用于[获取应用级凭证](../获取应用级凭证/account-api-obtain-app-token.md)。 |
| 1102 | 20001 | client\_id为空。 | 请按照接口参数的要求，传入正确的client\_id参数。 |
| 1102 | 20151 | code为空。 | 请按照接口参数的要求，传入正确的code参数。 |
| 1102 | 20181 | grant\_type为空。 | grant\_type可选值如下：  - “authorization\_code”：该场景用于[获取用户级凭证](account-api-obtain-user-token.md)。  - “refresh\_token”： 该场景用于[刷新用户级凭证](../刷新用户级凭证/account-api-obtain-refresh-token.md)。  - “client\_credentials”：该场景用于[获取应用级凭证](../获取应用级凭证/account-api-obtain-app-token.md)。 |
