...
scraped_at: 2026-06-11T16:42:31+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:60bf7b584524847b5e656881d13c75e623ee305be319912380962d75a0f72429
---
注意
...
获取应用级凭证，访问被应用级权限管控的资源，例如[通过OpenID获取UnionID](../../扩展能力/通过OpenID获取UnionID/account-api-get-unionid.md)。
...
| 1101 | 20182 | grant\_type值不正确。 | grant\_type可选值如下：  - “authorization\_code”：该场景用于[获取用户级凭证](../获取用户级凭证/account-api-obtain-user-token.md)。  - “refresh\_token”： 该场景用于[刷新用户级凭证](../刷新用户级凭证/account-api-obtain-refresh-token.md)。  - “client\_credentials”：该场景用于[获取应用级凭证](account-api-obtain-app-token.md)。 |
| 1102 | 20001 | client\_id为空。 | 请按照接口参数的要求，传入正确的client\_id参数。 |
| 1102 | 20181 | grant\_type为空。 | grant\_type可选值如下：  - “authorization\_code”：该场景用于[获取用户级凭证](../获取用户级凭证/account-api-obtain-user-token.md)。  - “refresh\_token”： 该场景用于[刷新用户级凭证](../刷新用户级凭证/account-api-obtain-refresh-token.md)。  - “client\_credentials”：该场景用于[获取应用级凭证](account-api-obtain-app-token.md)。 |
