...
scraped_at: 2026-06-01T15:38:35+08:00
doc_updated_at: 2026-03-27
content_hash: sha256:5b3f8cdf0f3f9a779d51cf3dfa39c01fdc3f16ff9868c9f3edc06b5e497507ab
---
说明
...
从API version9开始，推荐使用[bundleManager.getBundleInfoForSelf](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.bundle.bundleManager (应用程序包管理模块)/js-apis-bundlemanager.md#bundlemanagergetbundleinfoforself>)。
...
从API version 7开始，推荐使用[@ohos.ability.featureAbility](<../../../../Ability Kit（程序框架服务）/ArkTS API/FA模型能力的接口/@ohos.ability.featureAbility (FeatureAbility模块)/js-apis-ability-featureability.md>)。
...
从API version 7开始，推荐使用[@ohos.window (窗口)](<../../窗口管理/@ohos.window (窗口)/模块描述/arkts-apis-window.md>)。
