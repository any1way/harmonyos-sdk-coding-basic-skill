...
scraped_at: 2026-06-01T15:38:31+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:e309c6a69ea3efc8947b1dcbed73cc2986f46b34c11f83a41f14d9c8ede771c4
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| displayId | number | 是 | 屏幕ID，应为非负整数。需要确保displayId准确才能成功获取到对应结果。可以通过[WindowProperties](<../../窗口管理/@ohos.window (窗口)/Interfaces (其他)/arkts-apis-window-i.md#windowproperties>)的displayId属性获取到准确的displayId作为入参。 |
...
以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)和[屏幕错误码](../../../错误码/图形图像/屏幕错误码/errorcode-display.md)。
...
以下错误码的详细介绍请参见[屏幕错误码](../../../错误码/图形图像/屏幕错误码/errorcode-display.md)。
...
以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)、[屏幕错误码](../../../错误码/图形图像/屏幕错误码/errorcode-display.md)。
...
| colorSpaces11+ | Array<[colorSpaceManager.ColorSpace](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.colorSpaceManager (色彩管理)/js-apis-colorspacemanager.md>)> | 是 | 否 | 显示设备支持的所有色域类型。  **系统能力：** SystemCapability.WindowManager.WindowManager.Core  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| hdrFormats11+ | Array<[hdrCapability.HDRFormat](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.hdrCapability (HDR能力)/js-apis-hdrcapability.md#hdrformat>)> | 是 | 否 | 显示设备支持的所有HDR格式。  **系统能力：** SystemCapability.WindowManager.WindowManager.Core  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
