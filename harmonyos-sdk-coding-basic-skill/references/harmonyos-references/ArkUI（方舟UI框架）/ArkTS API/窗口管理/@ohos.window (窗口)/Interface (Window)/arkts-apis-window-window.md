...
scraped_at: 2026-06-01T15:38:25+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:2fdf1fe86f2b90be564452333e9fb0cb81bd15b4f7bbf3d09120a4e3961d1f2d
---
当前窗口实例，窗口管理器管理的基本单元。

下列API示例中都需先使用[getLastWindow()](../Functions/arkts-apis-window-f.md#windowgetlastwindow9)、[createWindow()](../Functions/arkts-apis-window-f.md#windowcreatewindow9)、[findWindow()](../Functions/arkts-apis-window-f.md#windowfindwindow9)中的任一方法获取到Window实例（windowClass），再通过此实例调用对应方法。
...
调用该接口前，建议先通过[loadContent](<../Interface (WindowStage)/arkts-apis-window-windowstage.md#loadcontent9>)方法或者[setUIContent](arkts-apis-window-window.md#setuicontent9-1)方法完成页面加载。如果应用主窗口没有完成页面加载，直接调用该接口，界面会一直显示启动界面；如果系统窗口、应用子窗口、模态窗和全局悬浮窗没有完成页面加载，直接调用该接口，窗口会处于前台，但不可见。
...
以下错误码的详细介绍请参见[窗口错误码](../../../../错误码/图形图像/窗口错误码/errorcode-window.md)。
...
调用该接口前，建议优先通过[loadContent](<../Interface (WindowStage)/arkts-apis-window-windowstage.md#loadcontent9>)方法或者[setUIContent](arkts-apis-window-window.md#setuicontent9-1)方法完成页面加载。如果应用主窗口没有完成页面加载，直接调用该接口，界面会一直显示启动界面；如果系统窗口、应用子窗口、模态窗和全局悬浮窗没有完成页面加载，直接调用该接口，窗口会处于前台，但不可见。
...
调用该接口前，建议优先通过[loadContent](<../Interface (WindowStage)/arkts-apis-window-windowstage.md#loadcontent9>)方法或者[setUIContent](arkts-apis-window-window.md#setuicontent9-1)方法完成页面加载。如果应用主窗口没有完成页面加载，直接调用该接口，界面会一直显示启动界面；如果系统窗口、应用子窗口和全局悬浮窗没有完成页面加载，直接调用该接口，窗口会处于前台，但不可见。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ShowWindowOptions](<../Interfaces (其他)/arkts-apis-window-i.md#showwindowoptions20>) | 是 | 显示子窗口或系统窗口时的参数。 |
...
* 在[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下，窗口相对于屏幕左上顶点移动；在非自由窗口状态下，窗口相对于父窗口左上顶点移动。
* 若需在非自由窗口状态下实现相对于屏幕左上顶点的移动，请使用[moveWindowToGlobal()](arkts-apis-window-window.md#movewindowtoglobal15)。
* 该方法对非自由窗口状态下的主窗口无效。
* [自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下，若主窗口或子窗口的标题栏移出屏幕可视区域，系统将自动回弹窗口，确保标题栏保持可见。
...
以下错误码的详细介绍请参见[通用错误码](../../../../../通用错误码/errorcode-universal.md)和[窗口错误码](../../../../错误码/图形图像/窗口错误码/errorcode-window.md)。
...
| 窗口类型 | [自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态 | 非自由窗口状态 |
| --- | --- | --- |
...
| moveConfiguration | [MoveConfiguration](<../Interfaces (其他)/arkts-apis-window-i.md#moveconfiguration15>) | 否 | 窗口移动选项，仅支持主屏和扩展屏，未设置将默认保持为当前屏幕。 |
...
* 主窗处于自由悬浮窗口模式时，在非[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下调用不生效不报错。
* [自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下，若主窗口或子窗口的标题栏移出屏幕可视区域，系统将自动回弹窗口，确保标题栏保持可见。
...
基于[全局坐标系](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#全局坐标系)移动窗口位置，使用Promise异步回调。
...
| 类型 | 说明 |
| --- | --- |
| [Position](<../Interfaces (其他)/arkts-apis-window-i.md#position20>) | 返回转换后的坐标。 |
...
窗口存在大小限制[WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)，具体尺寸限制范围可以通过[getWindowLimits](arkts-apis-window-window.md#getwindowlimits11)接口进行查询。
...
* 主窗口处于自由悬浮窗口模式时，在非[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下调用不报错不生效。
...
* 在非[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下，主窗口调用不生效。
...
| 类型 | 说明 |
| --- | --- |
| [WindowProperties](<../Interfaces (其他)/arkts-apis-window-i.md#windowproperties>) | 当前窗口属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [WindowDensityInfo](<../Interfaces (其他)/arkts-apis-window-i.md#windowdensityinfo15>) | 当前窗口的显示大小缩放系数信息。当返回值为[-1, -1, -1]时，表示当前设备不支持使用该接口。 |
...
| 类型 | 说明 |
| --- | --- |
| [Rect](<../Interfaces (其他)/arkts-apis-window-i.md#rect7>) | 四元组分别表示距离屏幕左上角的x坐标、距离屏幕左上角的y坐标、缩放后的窗口宽度和缩放后的窗口高度。 |
...
* [自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的自由悬浮窗口模式（即窗口模式为[window.WindowStatusType.FLOATING](../Enums/arkts-apis-window-e.md#windowstatustype11)）下，仅存在固定态软键盘（[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_KEYBOARD）类型的避让区域。
* 主窗口在非自由窗口状态的自由悬浮窗口模式下，仅存在系统栏（[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_SYSTEM）类型的避让区域。
...
* 在[onWindowStageCreate()](<../../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onwindowstagecreate>)方法中，获取应用启动时的初始布局避让区域时可调用该接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7) | 是 | 表示避让区域类型。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [AvoidArea](<../Interfaces (其他)/arkts-apis-window-i.md#avoidarea7>) | 窗口内容避让区域。 |
...
* 主窗口在非[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的自由悬浮窗口模式（即窗口模式为[window.WindowStatusType.FLOATING](../Enums/arkts-apis-window-e.md#windowstatustype11)）下，仅存在系统栏（[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_SYSTEM）类型的避让区域。
* 主窗口在其余场景下，仅当在非自由悬浮窗口模式下或设备类型为Phone和Tablet，才能通过此接口获取计算后的避让区域，否则获取的避让区域为空。
* 子窗口在非自由窗口状态或非自由悬浮窗口模式下，仅当窗口的位置和大小与主窗口一致时，才能通过此接口获取计算后的避让区域，否则获取的避让区域为空。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7) | 是 | 表示避让区域类型。不支持获取软键盘类型的避让区域，传入TYPE\_KEYBOARD时，返回1300016错误码。 |
...
获取全局悬浮窗、模态窗或WindowType为系统类型的窗口是否可以获取窗口内容的避让区[AvoidArea](<../Interfaces (其他)/arkts-apis-window-i.md#avoidarea7>)。
...
**设备行为差异：** 该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备及不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用返回801错误码。
...
从HarmonyOS 5.0.2开始，该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用不生效也不报错，切换到非[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态时生效；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备及不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用。
...
从HarmonyOS 5.0.2开始，该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用不生效也不报错；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备及不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| keyFramePolicy | [KeyFramePolicy](<../Interfaces (其他)/arkts-apis-window-i.md#keyframepolicy20>) | 是 | 用于设置拖拽的关键帧策略。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[KeyFramePolicy](<../Interfaces (其他)/arkts-apis-window-i.md#keyframepolicy20>)> | Promise对象，返回实际生效的关键帧策略。 |
...
从HarmonyOS 5.0.0开始，该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用不生效也不报错；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备及不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| name | [SpecificSystemBar](../Types/arkts-apis-window-t.md#specificsystembar11) | 是 | 设置窗口全屏模式时，显示或隐藏的系统栏类型。 |
...
**设备行为差异：** 该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用不生效也不报错；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备及不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用。

**参数：**

| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| systemBarProperties | [SystemBarProperties](<../Interfaces (其他)/arkts-apis-window-i.md#systembarproperties>) | 是 | 状态栏的属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [SystemBarProperties](<../Interfaces (其他)/arkts-apis-window-i.md#systembarproperties>) | 当前状态栏属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [ColorMetrics](../../../UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12) | 是 | 要设置的状态栏颜色值。 |
...
| 类型 | 说明 |
| --- | --- |
| [StatusBarProperty](<../Interfaces (其他)/arkts-apis-window-i.md#statusbarproperty18>) | 当前状态栏属性，如状态栏颜色。 |
...
获取当前窗口的设备形态信息，比如是否处于[电脑模式](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#电脑模式)，是否支持自由窗口等，使用Promise异步回调，仅限测试使用。
...
| 类型 | 说明 |
| --- | --- |
| Promise<string> | 返回当前窗口的设备形态信息，是JSON对象序列化后的结果，使用时需要先反序列化成JSON对象。返回示例：{"isPcMode":false,"isSupportFreeWindowMode":true,"systemUiVisible":"1100"}。  返回值包含的不同字段的含义如下：  - isPcMode：表示当前设备是否处于[电脑模式](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#电脑模式)，true表示处于[电脑模式](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#电脑模式)，false表示不处于[电脑模式](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#电脑模式)。当前在PC/2in1设备上返回true。  - isSupportFreeWindowMode：表示当前设备是否支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)，true表示支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)，false表示不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)。  - systemUiVisible：表示系统UI的显隐状态，是由0和1组成的长度为4的字符串，其中0表示隐藏，1表示显示。从左到右，第一位表示状态栏的显隐状态，第二位表示导航条的显隐状态，第三位表示三键导航栏的显隐状态，第四位在HarmonyOS设备上暂不支持，默认值为0。 |
...
3. try {
4. windowClass.getWindowStateSnapshot().then((data) => {
5. let jsonObj: object = JSON.parse(data);
6. console.info(`Succeeded, data=${data}, isPcMode=${jsonObj["isPcMode"]}`);
7. }).catch((err: BusinessError) => {
8. console.error(`Failed. Cause code: ${err.code}, message: ${err.message}`);
9. });
10. } catch (exception) {
11. console.error(`Panic. Cause code: ${exception.code}, message: ${exception.message}`);
12. }
```
...
设置主窗口的显示方向属性，使用callback异步回调。相关横竖屏开发实践查询[横竖屏切换](../../../../../../best-practices/行业场景解决方案/影音娱乐/视频类应用横竖屏切换/bpta-landscape-and-portrait-development.md)。非主窗口调用后不生效不报错。
...
* 设备支持sensor旋转且未处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态：立即生效。
* 设备支持sensor旋转且处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态：调用不生效不报错，切换到非[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态后生效。
* 其他情况：不生效不报错。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| orientation | [Orientation](../Enums/arkts-apis-window-e.md#orientation9) | 是 | 窗口显示方向的属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [Orientation](../Enums/arkts-apis-window-e.md#orientation9) | 窗口显示方向的属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIContext](<../../../UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 返回UIContext实例对象。 |
...
| storage | [LocalStorage](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md>) | 是 | 页面级UI状态存储单元，这里用于为加载到窗口的页面内容传递状态属性。 |
| callback | AsyncCallback<void> | 是 | 回调函数。 |
...
根据指定路由页面名称为当前窗口加载[命名路由](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/设置组件导航和页面路由/页面路由 (@ohos.router)(不推荐)/arkts-routing.md#命名路由>)页面，通过LocalStorage传递状态属性至加载页面，使用callback异步回调。
...
根据指定路由页面名称为当前窗口加载[命名路由](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/设置组件导航和页面路由/页面路由 (@ohos.router)(不推荐)/arkts-routing.md#命名路由>)页面，使用callback异步回调。
...
根据指定路由页面名称为当前窗口加载[命名路由](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/设置组件导航和页面路由/页面路由 (@ohos.router)(不推荐)/arkts-routing.md#命名路由>)页面，通过LocalStorage传递状态属性至加载页面，使用Promise异步回调。
...
| --- | --- | --- | --- |
| name | string | 是 | 命名路由页面的名称。 |
| storage | [LocalStorage](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md>) | 否 | 页面级UI状态存储单元，这里用于为加载到窗口的页面内容传递状态属性，默认值为空。 |
...
| callback | Callback<[Size](<../Interfaces (其他)/arkts-apis-window-i.md#size7>)> | 是 | 回调函数。返回当前的窗口尺寸。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'windowSizeChange'，即窗口尺寸变化事件。 |
| callback | Callback<[Size](<../Interfaces (其他)/arkts-apis-window-i.md#size7>)> | 否 | 回调函数。返回当前的窗口尺寸。如果传入参数，则关闭该监听。如果未传入参数，则关闭窗口尺寸变化的监听。 |
...
* [自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的自由悬浮窗口模式（即窗口模式为[window.WindowStatusType.FLOATING](../Enums/arkts-apis-window-e.md#windowstatustype11)）下触发回调时，仅存在固定态软键盘（[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_KEYBOARD）类型的避让区域。
* 主窗口在非自由窗口状态的自由悬浮窗口模式下触发回调时，仅存在系统栏（[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_SYSTEM）类型的避让区域。
...
常见的触发避让区回调的场景如下：应用窗口在全屏模式、悬浮模式、分屏模式之间的切换；应用窗口旋转；可折叠设备在屏幕折叠状态发生变化；应用窗口在多设备之间的流转。实现沉浸式布局可参考[开发应用沉浸式效果](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/组件布局/开发应用沉浸式效果/arkts-develop-apply-immersive-effects.md>)。
...
| callback | Callback<[AvoidAreaOptions](<../Interfaces (其他)/arkts-apis-window-i.md#avoidareaoptions12>)> | 是 | 回调函数。返回当前避让区以及避让区类型。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'avoidAreaChange'，即系统避让区变化事件。 |
| callback | Callback<[AvoidAreaOptions](<../Interfaces (其他)/arkts-apis-window-i.md#avoidareaoptions12>)> | 否 | 回调函数。返回当前避让区以及避让区类型。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有系统避让区变化的监听。 |
...
开启固定态软键盘高度变化的监听。当软键盘从本窗口唤出且与窗口有重叠区域时，通知键盘高度变化。从API version 10开始，有关将软键盘设置为固定态或悬浮态的方法，请参见[changeFlag](<../../../../../IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethodEngine (输入法服务)/js-apis-inputmethodengine.md#changeflag10>)。
...
关闭固定态软键盘高度变化的监听，使应用程序不再接收键盘高度变化的通知。从API version 10开始，有关将软键盘设置为固定态或悬浮态的方法，请参见[changeFlag](<../../../../../IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethodEngine (输入法服务)/js-apis-inputmethodengine.md#changeflag10>)。
...
改变软键盘为固定态或者悬浮态方法详细介绍请参见[changeFlag](<../../../../../IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethodEngine (输入法服务)/js-apis-inputmethodengine.md#changeflag10>)。
...
| callback | Callback<[KeyboardInfo](<../Interfaces (其他)/arkts-apis-window-i.md#keyboardinfo18>)> | 是 | 回调函数。返回软键盘窗口信息。 |
...
关闭固定态软键盘即将开始显示的监听。改变输入法窗口为固定态或者悬浮态方法详细介绍请参见[changeFlag](<../../../../../IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethodEngine (输入法服务)/js-apis-inputmethodengine.md#changeflag10>)。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'keyboardWillShow'，即固定态软键盘即将开始显示的事件。 |
| callback | Callback<[KeyboardInfo](<../Interfaces (其他)/arkts-apis-window-i.md#keyboardinfo18>)> | 否 | 回调函数。返回软键盘窗口信息。若传入参数，则关闭该监听。如果未传入参数，则关闭所有固定态软键盘即将开始显示的监听。 |
...
关闭固定态软键盘即将开始隐藏的监听。改变输入法窗口为固定态切换至悬浮态方法详细介绍请参见[changeFlag](<../../../../../IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethodEngine (输入法服务)/js-apis-inputmethodengine.md#changeflag10>)。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'keyboardWillHide'，即固定态软键盘即将开始隐藏的事件。 |
| callback | Callback<[KeyboardInfo](<../Interfaces (其他)/arkts-apis-window-i.md#keyboardinfo18>)> | 否 | 回调函数。返回软键盘窗口信息。若传入参数，则关闭该监听。如果未传入参数，则关闭所有固定态软键盘即将开始隐藏的监听。 |
...
关闭固定态软键盘显示动画完成的监听。改变输入法窗口为固定态或者悬浮态方法详细介绍请参见[changeFlag](<../../../../../IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethodEngine (输入法服务)/js-apis-inputmethodengine.md#changeflag10>)。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'keyboardDidShow'，即固定态软键盘显示动画完成事件。 |
| callback | Callback<[KeyboardInfo](<../Interfaces (其他)/arkts-apis-window-i.md#keyboardinfo18>)> | 否 | 回调函数。返回软键盘窗口信息。若传入参数，则关闭该监听。如果未传入参数，则关闭所有固定态软键盘显示动画完成的监听。 |
...
关闭固定态软键盘隐藏动画完成的监听。改变输入法窗口为固定态切换至悬浮态方法详细介绍请参见[changeFlag](<../../../../../IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethodEngine (输入法服务)/js-apis-inputmethodengine.md#changeflag10>)。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'keyboardDidHide'，即固定态软键盘隐藏动画完成事件。 |
| callback | Callback<[KeyboardInfo](<../Interfaces (其他)/arkts-apis-window-i.md#keyboardinfo18>)> | 否 | 回调函数。返回软键盘窗口信息。若传入参数，则关闭该监听。如果未传入参数，则关闭所有固定态软键盘隐藏动画完成的监听。 |
...
| callback | Callback<[ScreenshotEventType](../Enums/arkts-apis-window-e.md#screenshoteventtype20)> | 是 | 回调函数。返回触发的截屏事件类型。 |
...
| callback | Callback<[ScreenshotEventType](../Enums/arkts-apis-window-e.md#screenshoteventtype20)> | 否 | 回调函数。返回触发的截屏事件类型。若传入参数，则关闭该监听。若未传入参数，则关闭所有窗口截图事件的监听。 |
...
| callback | Callback<[WindowEventType](../Enums/arkts-apis-window-e.md#windoweventtype10)> | 是 | 回调函数。返回当前的窗口生命周期状态。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'windowEvent'，即窗口生命周期变化事件。 |
| callback | Callback<[WindowEventType](../Enums/arkts-apis-window-e.md#windoweventtype10)> | 否 | 回调函数。返回当前的窗口生命周期状态。若传入参数，则关闭该监听。若未传入参数，则关闭所有窗口生命周期变化的监听。 |
...
| callback | Callback<[OcclusionState](../Enums/arkts-apis-window-e.md#occlusionstate22)> | 是 | 窗口可见性变化时的回调函数。详情见[可见性状态](../Enums/arkts-apis-window-e.md#occlusionstate22)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'occlusionStateChanged'，即窗口可见性变化事件。 |
| callback | Callback<[OcclusionState](../Enums/arkts-apis-window-e.md#occlusionstate22)> | 否 | 若传入参数，则关闭该监听。若未传入参数，则关闭所有窗口可见性变化的监听。 |
...
应用注册帧率变化监听后，只有当客户端UI内容发生重绘时（如页面切换、和可响应组件交互、设置背景色和透明度等），才会触发注册的回调。但当同时使用该接口和[postFrameCallback](<../../../UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#postframecallback12>)、[postDelayedFrameCallback](<../../../UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#postdelayedframecallback12>)、[displaySync.on('frame')](<../../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.displaySync (可变帧率)/js-apis-graphics-displaysync.md#onframe>)中的任意一个时，即使无UI内容重绘，也可能触发回调。
...
| callback | Callback<[FrameMetrics](<../Interfaces (其他)/arkts-apis-window-i.md#framemetrics22>)> | 是 | 窗口帧率指标变化时的回调函数。详情见帧率指标[FrameMetrics](<../Interfaces (其他)/arkts-apis-window-i.md#framemetrics22>)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件类型，固定为'frameMetricsMeasured'，即窗口帧率指标变化事件。 |
| callback | Callback<[FrameMetrics](<../Interfaces (其他)/arkts-apis-window-i.md#framemetrics22>)> | 否 | 若传入参数，则关闭该监听。若未传入参数，则关闭所有窗口帧率指标变化的监听。 |
...
在[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下，应用的[targetAPIVersion](../../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/app.json5配置文件/app-configuration-file.md#配置文件标签)设置小于14时，在窗口最大化状态（窗口铺满整个屏幕，2in1设备会有dock栏和状态栏，Tablet设备会有状态栏）时返回值对应为WindowStatusType::FULL\_SCREEN。应用的[targetAPIVersion](../../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/app.json5配置文件/app-configuration-file.md#配置文件标签)设置大于等于14时，在窗口最大化状态（窗口铺满整个屏幕，2in1设备会有dock栏和状态栏，Tablet设备会有状态栏）时返回值对应为WindowStatusType::MAXIMIZE。
...
| callback | Callback<[WindowStatusType](../Enums/arkts-apis-window-e.md#windowstatustype11)> | 是 | 回调函数。返回当前的窗口模式。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'windowStatusChange'，即窗口模式变化事件。 |
| callback | Callback<[WindowStatusType](../Enums/arkts-apis-window-e.md#windowstatustype11)> | 否 | 回调函数。返回当前的窗口模式。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有窗口模式变化的监听。 |
...
开启窗口模式变化的监听，当窗口windowStatus发生变化后进行通知（此时窗口[Rect](<../Interfaces (其他)/arkts-apis-window-i.md#rect7>)属性已经完成更新）。
...
| callback | Callback<[TitleButtonRect](<../Interfaces (其他)/arkts-apis-window-i.md#titlebuttonrect11>)> | 是 | 回调函数。返回当前标题栏上的最小化、最大化、关闭按钮矩形区域。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'windowTitleButtonRectChange'，即标题栏上的最小化、最大化、关闭按钮矩形区域变化事件。 |
| callback | Callback<[TitleButtonRect](<../Interfaces (其他)/arkts-apis-window-i.md#titlebuttonrect11>)> | 否 | 回调函数。返回当前标题栏上的最小化、最大化、关闭按钮矩形区域。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有标题栏上的最小化、最大化、关闭按钮矩形区域变化的监听。 |
...
| callback | Callback<[RectChangeOptions](<../Interfaces (其他)/arkts-apis-window-i.md#rectchangeoptions12>)> | 是 | 回调函数。返回当前窗口矩形变化值及变化原因。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'windowRectChange'，即窗口矩形变化事件。 |
| callback | Callback<[RectChangeOptions](<../Interfaces (其他)/arkts-apis-window-i.md#rectchangeoptions12>)> | 否 | 回调函数。返回当前的窗口矩形及变化原因。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有窗口矩形变化的监听。 |
...
开启[全局坐标系](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#全局坐标系)下窗口矩形（窗口位置及窗口大小）变化的监听事件。
...
关闭[全局坐标系](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#全局坐标系)下窗口矩形（窗口位置及窗口大小）变化的监听事件。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'rectChangeInGlobalDisplay'，即全局坐标系下窗口矩形变化事件。 |
| callback | Callback<[RectChangeOptions](<../Interfaces (其他)/arkts-apis-window-i.md#rectchangeoptions12>)> | 否 | 回调函数。返回当前的窗口矩形及变化原因。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有全局坐标系下窗口矩形变化的监听。 |
...
该接口触发的回调函数是异步执行。子窗口的同步关闭事件监听参考[on('subWindowClose')](arkts-apis-window-window.md#onsubwindowclose12)方法。主窗口的同步关闭事件监听参考[on('windowStageClose')](<../Interface (WindowStage)/arkts-apis-window-windowstage.md#onwindowstageclose14>)方法。
...
在HarmonyOS 6.1.0之前，该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备及不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用返回801错误码。

从HarmonyOS 6.1.0开始，该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备调用不报错不生效，切换到[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态后生效；在不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备调用不报错不生效。
...
开启窗口旋转变化的监听。[RotationChangeInfo](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeinfo19>)中窗口旋转事件类型为窗口即将旋转时，必须返回[RotationChangeResult](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeresult19>)。窗口旋转事件类型为窗口旋转结束时返回[RotationChangeResult](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeresult19>)不生效。

该函数只允许在主线程注册。同一个窗口多次注册同类型回调函数，只生效最新注册的同类型回调函数返回值。系统提供了超时保护机制，若20ms内窗口未返回[RotationChangeResult](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeresult19>)，系统不处理该返回值。
...
针对非PC/2in1且支持sensor旋转但不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备：可正常调用且立即生效。

针对非PC/2in1且支持sensor旋转，支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备：当处于非[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态时可正常调用该接口且立即生效；当处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态时，调用该接口时不生效也不报错，切换到非[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下生效。
...
| callback | RotationChangeCallback<[RotationChangeInfo](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeinfo19>), [RotationChangeResult](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeresult19>) | void> | 是 | 回调函数。返回窗口旋转信息[RotationChangeInfo](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeinfo19>)，应用返回当前窗口变化结果[RotationChangeResult](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeresult19>)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'rotationChange'，即窗口旋转变化事件。 |
| callback | RotationChangeCallback<[RotationChangeInfo](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeinfo19>), [RotationChangeResult](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeresult19>) | void> | 否 | 回调函数。如果传入参数，则关闭该监听。如果未传入参数，则关闭该窗口的所有监听。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| colorSpace | [ColorSpace](../Enums/arkts-apis-window-e.md#colorspace8) | 是 | 设置色域模式。 |
| callback | AsyncCallback<void> | 是 | 回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| [ColorSpace](../Enums/arkts-apis-window-e.md#colorspace8) | 当前色域模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | string | [ColorMetrics](../../../UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12)18+ | 是 | 需要设置的背景色，为十六进制RGB或ARGB颜色，不区分大小写，例如'#00FF00'或'#FF00FF00'。  从API version 18开始，此参数支持ColorMetrics类型。 |
...
* 从HarmonyOS 6.1.0开始，该接口在2in1和Tablet设备中可正常调用，在Tablet设备时仅在开启[自由多窗模式](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由多窗模式)或[电脑模式](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#电脑模式)下生效，在其他设备中返回801错误码。
...
从API version 22开始，调用[createVirtualScreen](<../../../屏幕管理/@ohos.display (屏幕属性)/js-apis-display.md#displaycreatevirtualscreen16>)接口创建虚拟屏，并设置supportsFocus配置项为false时，位于该虚拟屏的窗口无法调用该接口修改窗口的可获焦能力，如果调用，会抛出1300002错误码。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isFocusable | boolean | 是 | 窗口是否可获焦。true表示支持；false表示不支持。设置为false时，该窗口不支持绑定输入法和接收键盘事件，如需处理输入逻辑，建议参考[不可获焦窗口中输入框与输入法交互指南](<../../../../../../harmonyos-guides/应用框架/IME Kit（输入法开发服务）/不可获焦窗口中输入框与输入法交互指南/use-inputmethod-in-not-focusable-window.md>)。 |
| callback | AsyncCallback<void> | 是 | 回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[image.PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | 是 | 回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[image.PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | Promise对象。返回当前窗口截图。 |
...
| 类型 | 说明 |
| --- | --- |
| [image.PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 返回当前窗口截图。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ratio | number | 是 | 窗口内容布局（不含边框和标题栏等装饰）的宽高比。该参数为浮点数，受窗口最大最小尺寸限制，比例值下限为最小宽度/最大高度，上限为最大宽度/最小高度。窗口最大最小尺寸由[WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)和系统限制的交集决定，系统限制优先级高于[WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)。ratio的有效范围会随[WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)变化而变化。如果先设置了[WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)，后设置的ratio与其冲突，会返回错误码；如果先设置了ratio，后设置的[WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)与其冲突，窗口的宽高比可能会不跟随设置的宽高比（ratio）。 |
...
**设备行为差异：** 该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备及不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用不生效也不报错。

**参数：**

| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| presentation | [MaximizePresentation](../Enums/arkts-apis-window-e.md#maximizepresentation12) | 否 | 主窗口或子窗口最大化时的布局枚举。默认值window.MaximizePresentation.ENTER\_IMMERSIVE，即默认最大化时进入全屏模式。 |
...
实现最大化功能。主窗口可调用此接口实现最大化功能；子窗口需在创建时设置子窗口参数maximizeSupported为true，再调用此接口可实现最大化功能。在具备折叠功能的2in1设备上，支持控制悬停态（参考[折叠屏悬停态最佳实践](../../../../../../best-practices/一次开发，多端部署/多设备界面开发/特殊界面布局场景/折叠屏悬停态/bpta-folded-hover.md)）下主窗口的瀑布流模式行为，即窗口在悬停态下最大化时是否跨上下两个半屏显示。使用Promise异步回调。
...
* 针对主窗口，仅在[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下生效，非自由窗口状态下不生效不报错。
...
将当前窗口的主窗口恢复到前台显示，如果主窗口已处于前台，则会抬升主窗层级。此接口仅适用于类型为[TYPE\_FLOAT](../Enums/arkts-apis-window-e.md#windowtype7)的窗口，并且需在窗口触发过[DOWN](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#touchtype)事件后才能调用。使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| wantParameters | Record<string, Object> | 否 | 拉起窗口时会给主窗传递的自定义参数，主窗会在触发[onNewWant](<../../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.abilityLifecycleCallback (UIAbility生命周期回调监听器)/js-apis-app-abi_71548541.md#onnewwant12>)回调时收到。默认值为空，代表不向主窗传入任何自定义参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>) | 当前窗口尺寸限制。 |
...
错误码详情请参见[通用错误码](../../../../../通用错误码/errorcode-universal.md)和[窗口错误码](../../../../错误码/图形图像/窗口错误码/errorcode-window.md)。
...
* [自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下，处于自由悬浮窗口模式（即窗口模式为window.WindowStatusType.FLOATING）的窗口在尺寸变化时受[WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)约束。触发场景包括：应用主动改变窗口大小（如调用[resize()](arkts-apis-window-window.md#resize9)）；系统调节窗口大小（如分辨率变化、显示大小缩放系数变化）；用户拖拽缩放窗口。
* 非[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下，主窗口尺寸不受[WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)约束，其他类型窗口仍受[WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)约束。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowLimits | [WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>) | 是 | 目标窗口的尺寸限制，单位为px或vp。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)> | Promise对象。返回设置后的尺寸限制，为入参与系统尺寸限制的交集。 |
...
从HarmonyOS 5.1.1开始，该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备及不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用返回801错误码。

从HarmonyOS 6.1.0开始，该接口在Phone、Tablet、PC/2in1设备可正常调用，在其他设备调用返回801错误码。主窗在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备调用不报错不生效，切换到[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态后生效。
...
| --- | --- | --- | --- |
| windowLimits | [WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>) | 是 | 目标窗口的尺寸限制，单位为px或vp。 |
| isForcible | boolean | 是 | 是否强制设置窗口的尺寸限制。  入参[windowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)的单位为vp时：无论设置true还是false，都按照false处理，窗口宽高的最小值和最大值都取决于系统限制。  入参[windowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)的单位为px时：设置为true，表示窗口宽高最小值以系统限制值和40vp两者中的低数值为准，窗口宽高的最大值仍取决于系统限制；设置为false，表示窗口宽高的最小值和最大值都取决于系统限制。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[WindowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)> | Promise对象。返回设置后的窗口尺寸限制。  入参[windowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)的单位为vp时，返回入参与系统默认窗口尺寸限制的交集。  入参[windowLimits](<../Interfaces (其他)/arkts-apis-window-i.md#windowlimits11>)的单位为px时，isForcible为false则返回入参与系统默认窗口尺寸限制的交集；isForcible为true则返回入参与[系统限制的最小值与40vp两者中的低数值，系统限制的最大值]的交集。 |
...
* 对于主窗口：
  ...
  + 本接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；
  + 在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用不报错不生效，切换到[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态后生效；
  + 在不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用返回1300002或801错误码。
* 对于显示装饰栏的子窗口（即创建子窗口时设置[SubWindowOptions](<../Interfaces (其他)/arkts-apis-window-i.md#subwindowoptions11>)中的decorEnabled为true）：

  + 在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；
  + 在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用不报错不生效，切换到[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态后生效；
  + 在不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用。
* 对于不显示装饰栏的子窗口（即创建子窗口时设置[SubWindowOptions](<../Interfaces (其他)/arkts-apis-window-i.md#subwindowoptions11>)中的decorEnabled为false），调用本接口将返回1300002或801错误码。
...
| modalityType | [ModalityType](../Enums/arkts-apis-window-e.md#modalitytype14) | 是 | 子窗口模态类型。 |
...
**设备行为差异：** 该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备调用不报错不生效，切换到[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态后生效；在不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备调用不报错不生效。
...
从HarmonyOS 5.1.0开始，该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备及不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用返回801错误码。

**参数：**

| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dectorStyle | [DecorButtonStyle](<../Interfaces (其他)/arkts-apis-window-i.md#decorbuttonstyle14>) | 是 | 要设置的装饰栏按钮样式。 |
...
| 类型 | 说明 |
| --- | --- |
| [DecorButtonStyle](<../Interfaces (其他)/arkts-apis-window-i.md#decorbuttonstyle14>) | 返回当前窗口装饰栏上的按钮样式，窗口装饰按钮区域位于窗口的右上角。 |
...
**设备行为差异：** 该接口在支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；在不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用不生效也不报错。
...
| 类型 | 说明 |
| --- | --- |
| [TitleButtonRect](<../Interfaces (其他)/arkts-apis-window-i.md#titlebuttonrect11>) | 标题栏上的最小化、最大化、关闭按钮矩形区域，该区域位置坐标相对窗口右上角。 |
...
| 类型 | 说明 |
| --- | --- |
| [WindowStatusType](../Enums/arkts-apis-window-e.md#windowstatustype11) | 当前窗口模式。 |
...
判断当前窗口是否已获焦。为获取准确的获焦状态，需要在[WindowEventType](../Enums/arkts-apis-window-e.md#windoweventtype10)生命周期处于WINDOW\_ACTIVE之后调用。
...
**设备行为差异：** 该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备及不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用返回undefined。
...
| options | [SubWindowOptions](<../Interfaces (其他)/arkts-apis-window-i.md#subwindowoptions11>) | 是 | 子窗口参数。decorEnabled为true时，子窗口为非[沉浸式布局](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#沉浸式布局)；decorEnabled为false时，子窗口为沉浸式布局。 |
...
此接口只对应用主窗口生效，且需要在module.json5配置文件中[abilities](../../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#abilities标签)标签中配置preferMultiWindowOrientation属性为"landscape\_auto"。
...
[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下，对系统窗口、应用主窗口、应用子窗口、全局悬浮窗和模态窗口生效。非自由窗口状态下，仅对系统窗口、应用子窗口、全局悬浮窗和模态窗口生效，应用主窗口调用该接口返回801或1300004错误码。

仅在[onTouch](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)事件（其中，事件类型必须为TouchType.Down）的回调方法中调用此接口才会有移动效果，成功调用此接口后，窗口将跟随鼠标或触摸点移动。

在点击拖拽场景下，若不期望在按下时触发拖拽事件，则可以在事件类型为[TouchType.Move](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#touchtype)（需要保证当前行为已经触发TouchType.Down事件）时调用此接口，触发移动效果。
...
仅在[onTouch](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)事件（其中，事件类型必须为TouchType.Down）的回调方法中调用此接口才会有移动效果，成功调用此接口后，窗口将跟随鼠标移动。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| offsetX | number | 是 | 窗口移动时预期鼠标位置相对窗口左上角的x轴偏移量，单位为px，该参数仅支持整数输入，浮点数向下取整。负值为非法参数，大于窗口宽度为非法参数，窗口宽度可以在窗口属性[WindowProperties](<../Interfaces (其他)/arkts-apis-window-i.md#windowproperties>)中获取。 |
| offsetY | number | 是 | 窗口移动时预期鼠标位置相对窗口左上角的y轴偏移量，单位为px，该参数仅支持整数输入，浮点数向下取整。负值为非法参数，大于窗口高度为非法参数，窗口高度可以在窗口属性[WindowProperties](<../Interfaces (其他)/arkts-apis-window-i.md#windowproperties>)中获取。 |
...
设置当前窗口是否能接收[拖拽事件](../../../../ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md)，使用Promise异步回调。
...
获取当前窗口是否能接收[拖拽事件](../../../../ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md)的状态。
...
在HarmonyOS 6.0.0之前，该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备及不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用返回801错误码。
...
获取当前窗口是否为激活态。为准确获取激活态，需要在[WindowEventType](../Enums/arkts-apis-window-e.md#windoweventtype10)生命周期处于WINDOW\_ACTIVE之后调用。
...
在HarmonyOS 6.1.0之前，该接口在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备（Phone设备除外，在Phone设备上调用该接口会返回801错误码）上可正常调用；在支持并不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上调用不报错不生效；在不支持自由窗口的设备中返回801错误码。

从HarmonyOS 6.1.0开始，该接口在Phone、Tablet、2in1设备上可调用且不报错（当设备处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态时可正常调用此接口并生效；当设备不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态时调用此接口不生效不报错，设备切换到自由窗口状态时生效）；在其他设备中调用返回801错误码。
...
| anchor | [WindowAnchor](../Enums/arkts-apis-window-e.md#windowanchor20) | 否 | 一级子窗与主窗保持相对位置不变时的窗口锚点枚举。该参数仅在enabled为true时生效，默认值为window.WindowAnchor.TopStart，即默认锚点为窗口左上角。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transitionType | [WindowTransitionType](../Enums/arkts-apis-window-e.md#windowtransitiontype20) | 是 | 本次转场动画场景。当前只支持销毁场景。 |
| animation | [TransitionAnimation](<../Interfaces (其他)/arkts-apis-window-i.md#transitionanimation20>) | 是 | 本次转场动画配置。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionAnimation](<../Interfaces (其他)/arkts-apis-window-i.md#transitionanimation20>) | undefined | 对应场景下的转场动画配置。当未使用过[setWindowTransitionAnimation](arkts-apis-window-window.md#setwindowtransitionanimation20)接口时，返回undefined。 |
...
通过该接口改变子窗口的显示层级时，不会发生焦点切换。推荐使用[shiftAppWindowFocus()](../Functions/arkts-apis-window-f.md#windowshiftappwindowfocus11)进行焦点切换。
...
查询当前窗口是否为[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)模式。
...
窗口方向指窗口所在屏幕的方向，以窗口模块对横竖屏的定义方式表示，窗口的方向分别用0、1、2和3表示竖屏、反向横屏、反向竖屏和横屏四个方向，其对横竖屏的定义与[RotationChangeInfo](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeinfo19>)和枚举类[Orientation](../Enums/arkts-apis-window-e.md#orientation9)中对横竖屏的定义一致，如Orientation设置为LANDSCAPE时，窗口方向为横屏。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| from | [RotationInfoType](../Enums/arkts-apis-window-e.md#rotationinfotype23) | 是 | 待转换的值的类型。 |
| to | [RotationInfoType](../Enums/arkts-apis-window-e.md#rotationinfotype23) | 是 | 目标值的类型。 |
| value | number | 是 | 待转换的值。该参数为整数，浮点数输入将向下取整，取值范围为[0, 3]，范围外为非法参数（抛出错误码[401](../../../../../通用错误码/errorcode-universal.md#section401-参数检查失败)）。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| width | number | 是 | 当前窗口的目标宽度，单位为px，该参数仅支持整数输入，浮点数输入将向下取整，负值为非法参数（抛出错误码[401](../../../../../通用错误码/errorcode-universal.md#section401-参数检查失败)）。 |
| height | number | 是 | 当前窗口的目标高度，单位为px，该参数仅支持整数输入，浮点数输入将向下取整，负值为非法参数（抛出错误码[401](../../../../../通用错误码/errorcode-universal.md#section401-参数检查失败)）。 |
| callback | AsyncCallback<void> | 是 | 回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[WindowProperties](<../Interfaces (其他)/arkts-apis-window-i.md#windowproperties>)> | 是 | 回调函数。返回当前窗口属性。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[WindowProperties](<../Interfaces (其他)/arkts-apis-window-i.md#windowproperties>)> | Promise对象。返回当前窗口属性。 |
...
* [自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的自由悬浮窗口模式（即窗口模式为window.WindowStatusType.FLOATING）下，仅存在固定态软键盘（[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_KEYBOARD）类型的避让区域。
* 主窗口在非自由窗口状态的自由悬浮窗口模式下，仅存在系统栏（[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_SYSTEM）类型的避让区域。
* 主窗口在其余场景下，仅当在非自由悬浮窗口模式下或设备类型为Phone和Tablet，才能通过此接口获取计算后的避让区域，否则获取的避让区域为空。
* 子窗口在非自由窗口状态或非自由悬浮窗口模式下，仅当窗口的位置和大小与主窗口一致时，才能通过此接口获取计算后的避让区域，否则获取的避让区域为空。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7) | 是 | 表示避让区类型。 |
| callback | AsyncCallback<[AvoidArea](<../Interfaces (其他)/arkts-apis-window-i.md#avoidarea7>)> | 是 | 回调函数。返回窗口内容避让区域。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[AvoidArea](<../Interfaces (其他)/arkts-apis-window-i.md#avoidarea7>)> | Promise对象。返回窗口内容避让区域。 |
...
| callback | Callback<[AvoidArea](<../Interfaces (其他)/arkts-apis-window-i.md#avoidarea7>)> | 是 | 回调函数。返回当前避让区。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'systemAvoidAreaChange'，即系统避让区变化事件。 |
| callback | Callback<[AvoidArea](<../Interfaces (其他)/arkts-apis-window-i.md#avoidarea7>)> | 否 | 回调函数。返回当前避让区。若传入参数，则关闭该监听。若未传入参数，则关闭所有系统避让区变化的监听。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[ColorSpace](../Enums/arkts-apis-window-e.md#colorspace8)> | 是 | 回调函数。当获取成功，err为undefined，data为当前色域模式。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[ColorSpace](../Enums/arkts-apis-window-e.md#colorspace8)> | Promise对象。返回当前色域模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isFocusable | boolean | 是 | 点击时是否支持切换焦点窗口。true表示支持；false表示不支持。设置为false时，该窗口不支持绑定输入法和接收键盘事件，如需处理输入逻辑，建议参考[不可获焦窗口中输入框与输入法交互指南](<../../../../../../harmonyos-guides/应用框架/IME Kit（输入法开发服务）/不可获焦窗口中输入框与输入法交互指南/use-inputmethod-in-not-focusable-window.md>)。 |
| callback | AsyncCallback<void> | 是 | 回调函数。 |
