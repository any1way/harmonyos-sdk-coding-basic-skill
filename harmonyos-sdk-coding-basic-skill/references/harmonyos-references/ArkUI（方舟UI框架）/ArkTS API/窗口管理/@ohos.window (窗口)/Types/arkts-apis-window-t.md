...
scraped_at: 2026-06-01T15:38:27+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:430706e703420c2b26ac8753400a036e77d4b6e7ca3911de847b9804bba13c0a
---
说明
...
动画曲线参数。不同曲线类型[WindowAnimationCurve](../Enums/arkts-apis-window-e.md#windowanimationcurve20)，对应的WindowAnimationCurveParam参数含义不同。
...
开发者在使用时，回调函数参数类型为[RotationChangeInfo](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeinfo19>)，返回值类型为[RotationChangeResult](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeresult19>) | void。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | T | 是 | 回调函数调用时系统传入[RotationChangeInfo](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeinfo19>)类型的参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| U | 回调函数需要返回[RotationChangeResult](<../Interfaces (其他)/arkts-apis-window-i.md#rotationchangeresult19>) | void类型的返回值。 |
