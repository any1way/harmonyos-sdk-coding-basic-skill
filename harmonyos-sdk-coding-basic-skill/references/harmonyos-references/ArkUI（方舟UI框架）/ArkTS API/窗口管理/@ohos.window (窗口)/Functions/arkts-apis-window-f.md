...
scraped_at: 2026-06-01T15:38:14+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:92b98418db5dfa8cc7908065396b01f1059027e43d31c49154dcaabac3c33f50
---
说明
...
非[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态下，子窗口创建后默认是[沉浸式布局](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#沉浸式布局)。

自由窗口状态下，子窗口参数[decorEnabled](<../Interfaces (其他)/arkts-apis-window-i.md#configuration9>)为false时，子窗口创建后为沉浸式布局；子窗口参数decorEnabled为true，子窗口创建后为非沉浸式布局。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [Configuration](<../Interfaces (其他)/arkts-apis-window-i.md#configuration9>) | 是 | 创建窗口时的参数。 |
| callback | AsyncCallback<[Window](<../Interface (Window)/arkts-apis-window-window.md>)> | 是 | 回调函数。返回当前创建的窗口对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Window](<../Interface (Window)/arkts-apis-window-window.md>)> | Promise对象。返回当前创建的窗口对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| name | string | 是 | 窗口名称。查找子窗口或系统窗口时使用[Configuration](<../Interfaces (其他)/arkts-apis-window-i.md#configuration9>)中的窗口名称；查找主窗口时使用[getWindowName](<../../../UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getwindowname12>)获取当前实例的窗口名称。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Window](<../Interface (Window)/arkts-apis-window-window.md>) | 当前查找的窗口对象。如果查找指定名称对应的窗口不存在，则返回1300002错误码。 |
...
若无应用子窗口或子窗口未调用[showWindow()](<../Interface (Window)/arkts-apis-window-window.md#showwindow9>)进行显示，则返回应用主窗口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ctx | [BaseContext](<../../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/BaseContext/js-apis-inner-application-basecontext.md>) | 是 | 当前应用上下文信息。 |
| callback | AsyncCallback<[Window](<../Interface (Window)/arkts-apis-window-window.md>)> | 是 | 回调函数。返回当前应用内层级最高的窗口对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Window](<../Interface (Window)/arkts-apis-window-window.md>)> | Promise对象。返回当前应用内层级最高的窗口对象。 |
...
目标窗口需确保具有获得焦点的能力（可通过[setWindowFocusable()](<../Interface (Window)/arkts-apis-window-window.md#setwindowfocusable9>)设置），并确保调用[showWindow()](<../Interface (Window)/arkts-apis-window-window.md#showwindow9>)成功且执行完毕。

说明

在调用shiftAppWindowFocus()前，建议确保目标窗口已调用[loadContent()](<../Interface (Window)/arkts-apis-window-window.md#loadcontent9>)或[setUIContent()](<../Interface (Window)/arkts-apis-window-window.md#setuicontent9>)并生效，否则可能会导致不可见窗口获取焦点，造成功能异常或影响用户体验。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sourceWindowId | number | 是 | 源窗口id，必须是获焦状态。推荐使用[getWindowProperties()](<../Interface (Window)/arkts-apis-window-window.md#getwindowproperties9>)方法获取窗口id属性。 |
| targetWindowId | number | 是 | 目标窗口id。推荐使用[getWindowProperties()](<../Interface (Window)/arkts-apis-window-window.md#getwindowproperties9>)方法获取窗口id属性。 |
...
源窗口仅在[onTouch](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)事件（事件类型必须为TouchType.Down）的回调方法中调用此接口才会有鼠标输入事件转移效果，成功调用此接口后，系统会向源窗口补发鼠标按键抬起（TouchType.Up）事件，并且向目标窗口补发鼠标按键按下（TouchType.Down）事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sourceWindowId | number | 是 | 源窗口id。推荐使用[getWindowProperties()](<../Interface (Window)/arkts-apis-window-window.md#getwindowproperties9>)方法获取窗口id属性。 |
| targetWindowId | number | 是 | 目标窗口id。推荐使用[getWindowProperties()](<../Interface (Window)/arkts-apis-window-window.md#getwindowproperties9>)方法获取窗口id属性。 |
...
源窗口仅在[onTouch](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)事件（事件类型必须为TouchType.Down）的回调方法中调用此接口才会有触屏输入事件转移效果，成功调用此接口后，系统会向源窗口补发触屏抬起（TouchType.Up）事件，并且向目标窗口补发触屏按下（TouchType.Down）事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sourceWindowId | number | 是 | 源窗口id。推荐使用[getWindowProperties()](<../Interface (Window)/arkts-apis-window-window.md#getwindowproperties9>)方法获取窗口id属性。该参数应为大于0的整数，小于等于0时会返回错误码1300016。 |
| targetWindowId | number | 是 | 目标窗口id。推荐使用[getWindowProperties()](<../Interface (Window)/arkts-apis-window-window.md#getwindowproperties9>)方法获取窗口id属性。该参数应为大于0的整数，小于等于0时会返回错误码1300016。 |
| fingerId | number | 是 | 触屏事件的手指唯一标识符。推荐使用[TouchEvent](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明)对象中touches属性获取id。该参数应为大于等于0的整数，小于0时会返回错误码1300016。 |
...
查询本应用指定坐标下的可见窗口（可通过[on('windowVisibilityChange')](<../Interface (Window)/arkts-apis-window-window.md#onwindowvisibilitychange11>)接口监听）数组，按当前窗口层级排列，层级最高的窗口对应数组下标为0，使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| displayId | number | 是 | 查询窗口所在的displayId，该参数应为整数，传入非整数会忽略掉小数部分，可以在窗口属性[WindowProperties](<../Interfaces (其他)/arkts-apis-window-i.md#windowproperties>)中获取。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[Window](<../Interface (Window)/arkts-apis-window-window.md>)>> | Promise对象。返回获取到的窗口对象数组。 |
...
* 窗口通过[setWindowMask](<../Interface (Window)/arkts-apis-window-window.md#setwindowmask12>)接口设置异形窗口蒙层时，不会影响窗口可见状态计算，窗口仍可见，即使掩码全部设置为0，窗口依然按照其原本矩形大小参与可见状态计算。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| displayId | number | 是 | 需要获取窗口布局信息的displayId，该参数应为整数，且为当前实际存在屏幕的displayId，可以通过窗口属性[WindowProperties](<../Interfaces (其他)/arkts-apis-window-i.md#windowproperties>)获取。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<Array<[WindowLayoutInfo](<../Interfaces (其他)/arkts-apis-window-i.md#windowlayoutinfo15>)>> | Promise对象。返回获取到的窗口布局信息对象数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[WindowInfo](<../Interfaces (其他)/arkts-apis-window-i.md#windowinfo18>)>> | Promise对象，返回当前可见窗口的相关信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| displayId | number | 否 | 可选的屏幕ID，用于获取对应屏幕上的窗口模式信息。该参数应为大于等于0的整数，小于0时会返回错误码1300016，不传或传值为null以及undefined则代表查询所有屏幕，传入非整数会忽略掉小数部分。如果指定的屏幕不存在，返回值为0，推荐使用[getWindowProperties()](<../Interface (Window)/arkts-apis-window-window.md#getwindowproperties9>)方法获取窗口所在屏幕ID属性。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<number> | Promise对象。返回获取到的窗口模式。每一个二进制位代表一种窗口模式，当前支持的窗口模式见[GlobalWindowMode](../Enums/arkts-apis-window-e.md#globalwindowmode20)，返回值为对应窗口模式值按位进行或运算的结果。比如，当前屏幕上存在全屏窗口、自由悬浮窗口和画中画三种窗口，则返回值为0b1|0b100|0b1000 = 13。 |
...
设置或取消本应用进程下窗口的水印图片，使用Promise异步回调。该接口需要在[loadContent()](<../Interface (Window)/arkts-apis-window-window.md#loadcontent9>)或[setUIContent()](<../Interface (Window)/arkts-apis-window-window.md#setuicontent9>)调用生效后使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pixelMap | [image.PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | undefined | 是 | 传入image.PixelMap表示设置水印图片，传入undefined表示取消水印显示。  如果图片尺寸的宽和高同时超过窗口尺寸以及屏幕尺寸的宽和高，返回错误码1300016。  如果图片尺寸的宽或高超过窗口尺寸的宽或高，超出窗口宽或高的部分会被裁剪。  如果图片尺寸的宽或高小于窗口尺寸的宽或高，小于的部分会自动重复补充。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| moduleName | string | 是 | 需要设置的UIAbility所属模块名，moduleName的长度范围为0-200字节，仅支持设置当前同一应用包名内的模块。模块名由开发者在[module.json5配置文件](../../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#配置文件标签)中的name字段指定。 |
| abilityName | string | 是 | 需要设置的UIAbility名字，abilityName的长度范围为0-200字节，仅支持设置当前同一应用包名内的abilityName。UIAbility名由开发者在[module.json5配置文件abilities标签](../../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#abilities标签)的name字段指定。 |
| color | [ColorMetrics](../../../UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12) | 是 | 设置的启动页背景色。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<Array<[MainWindowInfo](<../Interfaces (其他)/arkts-apis-window-i.md#mainwindowinfo21>)>> | Promise对象。返回主窗口信息列表。 |
...
| config | [WindowSnapshotConfiguration](<../Interfaces (其他)/arkts-apis-window-i.md#windowsnapshotconfiguration21>) | 是 | 获取窗口截图时的配置信息。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<Array<[image.PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | undefined>> | Promise对象。截图的PixelMap列表，按传入的窗口ID数组的顺序排列。当窗口ID合法但无法找到对应的主窗口时，返回undefined。 |
...
子窗口创建后默认是[沉浸式布局](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#沉浸式布局)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| id | string | 是 | 窗口名字，即[Configuration](<../Interfaces (其他)/arkts-apis-window-i.md#configuration9>)中的name。 |
| type | [WindowType](../Enums/arkts-apis-window-e.md#windowtype7) | 是 | 窗口类型。 |
| callback | AsyncCallback<[Window](<../Interface (Window)/arkts-apis-window-window.md>)> | 是 | 回调函数。返回当前创建的子窗口对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Window](<../Interface (Window)/arkts-apis-window-window.md>)> | Promise对象。返回当前创建的子窗口对象。 |
...
| --- | --- | --- | --- |
| id | string | 是 | 窗口名字，即[Configuration](<../Interfaces (其他)/arkts-apis-window-i.md#configuration9>)中的name。 |
| callback | AsyncCallback<[Window](<../Interface (Window)/arkts-apis-window-window.md>)> | 是 | 回调函数。返回当前查找到的窗口对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Window](<../Interface (Window)/arkts-apis-window-window.md>)> | Promise对象。返回当前查找的窗口对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[Window](<../Interface (Window)/arkts-apis-window-window.md>)> | 是 | 回调函数。返回当前应用内最后显示的窗口对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[Window](<../Interface (Window)/arkts-apis-window-window.md>)> | Promise对象。返回当前应用内最后显示的窗口对象。 |
