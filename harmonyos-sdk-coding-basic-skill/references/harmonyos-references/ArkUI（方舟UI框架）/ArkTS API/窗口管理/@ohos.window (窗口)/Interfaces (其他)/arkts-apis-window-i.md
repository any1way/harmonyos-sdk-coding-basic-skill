...
scraped_at: 2026-06-11T15:43:22+08:00
doc_updated_at: 2026-05-07
content_hash: sha256:ba532664c683afbce05f1938b4d950318133c1361edbd84860b2ee3199989172
---
说明
...
| windowType | [WindowType](../Enums/arkts-apis-window-e.md#windowtype7) | 否 | 否 | 窗口类型。  **系统能力：** SystemCapability.WindowManager.WindowManager.Core |
| ctx | [BaseContext](<../../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/BaseContext/js-apis-inner-application-basecontext.md>) | 否 | 是 | 当前应用上下文信息。不设置，则默认为空。  FA模型下不需要使用该参数，即可创建子窗口，使用该参数时会报错。  Stage模型必须使用该参数，用于创建全局悬浮窗、模态窗或系统窗口。  **系统能力：** SystemCapability.WindowManager.WindowManager.Core |
...
窗口内容做[沉浸式布局](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#沉浸式布局)适配时，需要按照[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)对应的AvoidArea做窗口内容避让。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/L8Ht1JgaSfuk9eresux32A/zh-cn_image_0000002592219924.png?HW-CC-KV=V1&HW-CC-Date=20260611T074212Z&HW-CC-Expire=86400&HW-CC-Sign=810249EFE96E9D0A2F2700239E69180D9DAE1E4ABD921B2F0E8846DA17727A0B)

## UIEnvAvoidAreaVP23+

PhonePC/2in1TabletTVWearable

以vp为单位表示的窗口避让区域信息，在进行[沉浸式布局](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#沉浸式布局)适配时需关注。
...
窗口不同类型避让区域信息组成的[环境变量](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习响应式环境变量/@Env：环境变量/arkts-env-system-property.md>)数据类型，每种类型避让区域单位为px。

**系统能力：** SystemCapability.Window.SessionManager

| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| statusBar | [AvoidArea](arkts-apis-window-i.md#avoidarea7) | 否 | 否 | 表示[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_SYSTEM类型的避让区域，单位为px。 |
| cutout | [AvoidArea](arkts-apis-window-i.md#avoidarea7) | 否 | 否 | 表示[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_CUTOUT类型的避让区域，单位为px。 |
| keyboard | [AvoidArea](arkts-apis-window-i.md#avoidarea7) | 否 | 否 | 表示[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_KEYBOARD类型的避让区域，单位为px。 |
| navigationIndicator | [AvoidArea](arkts-apis-window-i.md#avoidarea7) | 否 | 否 | 表示[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_NAVIGATION\_INDICATOR类型的避让区域，单位为px。 |

## UIEnvWindowAvoidAreaInfoVP23+

PhonePC/2in1TabletTVWearable

窗口不同类型避让区域信息组成的[环境变量](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习响应式环境变量/@Env：环境变量/arkts-env-system-property.md>)数据类型，每种类型避让区域单位为vp。

**系统能力：** SystemCapability.Window.SessionManager

| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| statusBar | [UIEnvAvoidAreaVP](arkts-apis-window-i.md#uienvavoidareavp23) | 否 | 否 | 表示[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_SYSTEM类型的避让区域，单位为vp。 |
| cutout | [UIEnvAvoidAreaVP](arkts-apis-window-i.md#uienvavoidareavp23) | 否 | 否 | 表示[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_CUTOUT类型的避让区域，单位为vp。 |
| keyboard | [UIEnvAvoidAreaVP](arkts-apis-window-i.md#uienvavoidareavp23) | 否 | 否 | 表示[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_KEYBOARD类型的避让区域，单位为vp。 |
| navigationIndicator | [UIEnvAvoidAreaVP](arkts-apis-window-i.md#uienvavoidareavp23) | 否 | 否 | 表示[AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7)为TYPE\_NAVIGATION\_INDICATOR类型的避让区域，单位为vp。 |
...
| reason | [RectChangeReason](../Enums/arkts-apis-window-e.md#rectchangereason12) | 否 | 否 | 窗口矩形变化的原因。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [AvoidAreaType](../Enums/arkts-apis-window-e.md#avoidareatype7) | 否 | 否 | 系统避让区变化后返回的避让区域类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| windowRect7+ | [Rect](arkts-apis-window-i.md#rect7) | 否 | 否 | 窗口尺寸，其中左边界上边界是相对于窗口所在屏幕左上顶点计算，可在页面生命周期[onPageShow](../../../../ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#onpageshow)或应用生命周期[onForeground](<../../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onforeground>)阶段获取。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。  **系统能力：** SystemCapability.WindowManager.WindowManager.Core |
| drawableRect11+ | [Rect](arkts-apis-window-i.md#rect7) | 否 | 否 | 窗口内的可绘制区域尺寸，其中左边界上边界是相对于窗口左上顶点计算。在Stage模型下，需要在调用[loadContent()](<../Interface (Window)/arkts-apis-window-window.md#loadcontent9>)或[setUIContent()](<../Interface (Window)/arkts-apis-window-window.md#setuicontent9>)加载页面内容后获取该属性。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。  **系统能力：** SystemCapability.WindowManager.WindowManager.Core |
| type7+ | [WindowType](../Enums/arkts-apis-window-e.md#windowtype7) | 否 | 否 | 窗口类型。  当前存在主窗使用[getWindowProperties()](<../Interface (Window)/arkts-apis-window-window.md#getwindowproperties9>)接口返回type不准确的问题，开发者在创建窗口时已指明窗口类型，无需通过getWindowProperties()接口获取窗口类型。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。  **系统能力：** SystemCapability.WindowManager.WindowManager.Core |
...
| isLayoutFullScreen7+ | boolean | 否 | 否 | 对于子窗，如果设置了[沉浸式布局](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#沉浸式布局)，返回值为true。  对于主窗，如果设置了[沉浸式布局](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#沉浸式布局)且处于全屏模式，返回值为true。  其他情况下均返回false  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。  **系统能力：** SystemCapability.WindowManager.WindowManager.Core |
...
| brightness | number | 否 | 否 | 窗口亮度。通过[setWindowBrightness()](<../Interface (Window)/arkts-apis-window-window.md#setwindowbrightness9>)设置窗口的亮度值。该参数为浮点数，可设置的亮度范围为[0.0, 1.0]或-1.0，其取值1.0时表示最大亮度，取值-1.0时，表示亮度跟随系统。如果窗口没有设置亮度值，表示亮度跟随系统，此时获取到的亮度值为-1.0。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。  **系统能力：** SystemCapability.WindowManager.WindowManager.Core |
...
| isPrivacyMode7+ | boolean | 否 | 否 | 窗口是否为隐私模式。true表示窗口为隐私模式；false表示窗口为非隐私模式。可通过[setWindowPrivacyMode()](<../Interface (Window)/arkts-apis-window-window.md#setwindowprivacymode9>)设置窗口的隐私模式。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。  **系统能力：** SystemCapability.WindowManager.WindowManager.Core |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| colorMode | [ConfigurationConstant.ColorMode](<../../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.ConfigurationConstant (环境变量相关的常量定义)/js-apis-app-ability-configurationconstant.md#colormode>) | 否 | 是 | 颜色模式。深色模式下按钮颜色适配为浅色，浅色模式下按钮颜色适配为深色。未设置则默认跟随系统颜色模式。  **元服务API：** 从API version 14开始，该接口支持在元服务中使用。 |
...
窗口尺寸限制参数，应用可以通过[getWindowLimits](<../Interface (Window)/arkts-apis-window-window.md#getwindowlimits11>)获得当前窗口的尺寸限制（单位为px）；从API version 22开始，还可以通过[getWindowLimitsVP](<../Interface (Window)/arkts-apis-window-window.md#getwindowlimitsvp22>)获取窗口尺寸限制（单位为vp）。

窗口尺寸限制的最终生效结果由默认系统限制、应用配置和运行时设置的数据取交集得到，优先级从高到低依次为：

1. 应用通过[setWindowLimits](<../Interface (Window)/arkts-apis-window-window.md#setwindowlimits11>)设置窗口尺寸限制。
2. 应用在[startAbility](<../../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md#startability-2>)拉起窗口时通过[StartOptions](<../../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.StartOptions (startAbility的可选参数)/js-apis-app-ability-startoptions.md#startoptions>)指定窗口尺寸限制（API version 17开始支持）。
3. 应用在[module.json5配置文件中的abilities标签](../../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#abilities标签)中配置windowLimits。
...
| pixelUnit22+ | [PixelUnit](../Enums/arkts-apis-window-e.md#pixelunit22) | 否 | 是 | 窗口尺寸限制的单位，默认为px。可显式设置为px或vp。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| focusOnShow | boolean | 否 | 是 | 窗口调用[showWindow()](<../Interface (Window)/arkts-apis-window-window.md#showwindow20>)显示时是否自动获焦，默认为true。该参数对主窗、模态窗、dialog窗口不生效。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| curve | [WindowAnimationCurve](../Enums/arkts-apis-window-e.md#windowanimationcurve20) | 否 | 否 | 动画曲线类型。 |
| duration | number | 否 | 是 | 动画播放的时长，单位毫秒（ms）。  默认值：0，最大值：3000。  根据动画曲线类型决定是否必填。 |
| param | [WindowAnimationCurveParam](../Types/arkts-apis-window-t.md#windowanimationcurveparam20) | 否 | 是 | 动画曲线参数，根据动画曲线类型决定是否必填。 |
...
| windowStatusType | [WindowStatusType](../Enums/arkts-apis-window-e.md#windowstatustype11) | 否 | 否 | 窗口模式枚举。 |
| isFocused | boolean | 否 | 是 | 窗口是否获焦。true表示窗口获焦；false表示窗口未获焦。返回值与[isFocused()](<../Interface (Window)/arkts-apis-window-window.md#isfocused12>)接口一致。 |
...
**设备行为差异：** 该接口在Phone设备的非[自由多窗模式](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由多窗模式)、Tablet设备的非[自由多窗模式](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由多窗模式)且非电脑模式下可正常调用，在其他设备、[自由多窗模式](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由多窗模式)或电脑模式下调用不生效也不报错。

**系统能力：** SystemCapability.Window.SessionManager

| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [AnimationType](../Enums/arkts-apis-window-e.md#animationtype20) | 否 | 否 | 窗口动画类型。 |
...
| needAnimation23+ | boolean | 否 | 是 | 是否启用窗口创建动效。  传入true时，跟随系统默认动效。传入false时，表示关闭窗口创建动效，仅在[自由窗口状态](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)的情况下生效。  此参数不填时，默认为undefined，跟随系统默认动效。  **模型约束：** 此接口仅可在Stage模型下使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [RotationChangeType](../Enums/arkts-apis-window-e.md#rotationchangetype19) | 否 | 否 | 窗口旋转事件类型。 |
...
应用窗口与系统窗口大小存在限制，具体限制与相关规则可见[resize](<../Interface (Window)/arkts-apis-window-window.md#resize9>)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| rectType | [RectType](../Enums/arkts-apis-window-e.md#recttype19) | 否 | 否 | 窗口矩形区域坐标系类型。 |
...
| modalityType14+ | [ModalityType](../Enums/arkts-apis-window-e.md#modalitytype14) | 否 | 是 | 子窗口模态类型，仅当子窗口启用模态属性时生效。不设置，则默认为WINDOW\_MODALITY。  **元服务API：** 从API version 14开始，该接口支持在元服务中使用。 |
| windowRect18+ | [Rect](arkts-apis-window-i.md#rect7) | 否 | 是 | 子窗口矩形区域，其中子窗口存在大小限制，具体参考[resize()](<../Interface (Window)/arkts-apis-window-window.md#resize9>)方法。不设置且未调用[showWindow()](<../Interface (Window)/arkts-apis-window-window.md#showwindow9>)显示前，则默认为{left: 0, top: 0, width: 0, height: 0}。具体参考[设置应用子窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/管理应用窗口（Stage模型）/application-window-stage.md#设置应用子窗口)开发指南。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
...
| maximizeSupported19+ | boolean | 否 | 是 | 子窗口是否支持最大化特性。true表示子窗口支持最大化，false表示子窗口不支持最大化。不设置，则默认为false。  **元服务API：** 从API version 19开始，该接口支持在元服务中使用。  **设备行为差异：** 该参数在支持并处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上可正常调用；在不支持[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上，作为入参使用时，对应接口不生效不报错；在支持但不处于[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态的设备上，作为入参使用时，对应接口不生效不报错，切换到[自由窗口](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/窗口管理/窗口开发术语/window-terminology.md#自由窗口)状态后生效。 |
