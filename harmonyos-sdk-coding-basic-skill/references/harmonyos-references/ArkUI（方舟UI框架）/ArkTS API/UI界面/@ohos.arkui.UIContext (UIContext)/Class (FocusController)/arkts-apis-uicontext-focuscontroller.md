...
scraped_at: 2026-06-01T15:37:01+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:21727a512f2a9839a7aa6bce2fa3442140bcdb24d9773e36cfc36b3b2fc21376
---
...
* 以下API需先使用UIContext中的[getFocusController()](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md#getfocuscontroller12>)方法获取FocusController实例，再通过该实例调用对应方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 节点对应的[组件标识](../../../../ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md)。 |

**错误码：**

以下错误码的详细介绍请参见[焦点错误码](../../../../错误码/UI界面/焦点错误码/errorcode-focus.md)。
...
设置当前界面的[焦点激活态](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/支持焦点处理/arkts-common-events-focus-event.md>)。
...
焦点激活态可参考[基础概念：焦点激活态](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/支持焦点处理/arkts-common-events-focus-event.md#基础概念>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isAutoFocusTransfer | boolean | 是 | 设置页面切换时，新的页面是否需要主动获取焦点，例如[Router](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md>)、[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)、[Menu](../../../../ArkTS组件/菜单/Menu/ts-basic-components-menu.md)、[Dialog](<../../../../ArkTS组件/弹窗/弹出框 (Dialog)/ohos-arkui-advanced-dialog.md>)、[Popup](../../../../ArkTS组件/系统预置UI组件库/Popup/ohos-arkui-advanced-popup.md)等。true表示需要主动获取焦点，false表示不需要主动获取焦点。默认值为true。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [KeyProcessingMode](../../../../ArkTS组件/通用属性/交互属性/焦点控制/ts-universal-attributes-focus.md#keyprocessingmode15) | 是 | 按键处理模式。 |
