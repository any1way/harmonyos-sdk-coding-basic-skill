...
content_hash: sha256:cbc8e3ecac38f61d1b702f27e5e910c31e2f4f5596cb1fdf47f62c591dfb46e4
---
提供组件自定义场景下相关帧率的配置。
...
* 以下接口需先使用UIContext中的[requireDynamicSyncScene](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md#requiredynamicsyncscene12>)方法获取DynamicSyncScene对象，再通过此实例调用对应方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| range | [ExpectedFrameRateRange](<../../../../ArkTS组件/动画/显式动画 (animateTo)/ts-explicit-animation.md#expectedframeraterange11>) | 是 | 设置期望的帧率范围。  默认值：{min:0, max:120, expected: 120} |
...
| 类型 | 说明 |
| --- | --- |
| [ExpectedFrameRateRange](<../../../../ArkTS组件/动画/显式动画 (animateTo)/ts-explicit-animation.md#expectedframeraterange11>) | 期望帧率范围。 |
