...
scraped_at: 2026-06-01T15:37:05+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:b6a4e5554f65d18091d232be5edebb249fdd508cf16eb2de49c8d895c32963c7
---
提供Marquee组件相关帧率的配置。
...
* MarqueeDynamicSyncScene继承自[DynamicSyncScene](<../Class (DynamicSyncScene)/arkts-apis-uicontext-dynamicsyncscene.md>)，对应[Marquee](../../../../ArkTS组件/信息展示/Marquee/ts-basic-components-marquee.md)的动态帧率场景。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [MarqueeDynamicSyncSceneType](../Enums/arkts-apis-uicontext-e.md#marqueedynamicsyncscenetype14) | 是 | 否 | Marquee的动态帧率场景。 |
