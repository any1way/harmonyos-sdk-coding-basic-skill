...
content_hash: sha256:b2b7ecde07847e673149abc033ace3a4798a86fc3e0eda3240e07edf17800943
---
用于设置下一帧渲染时需要执行的任务。
...
* 以下API需要配合[UIContext](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[postFrameCallback](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md#postframecallback12>)和[postDelayedFrameCallback](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md#postdelayedframecallback12>)使用。开发者需要继承该类并重写[onFrame](arkts-apis-uicontext-framecallback.md#onframe12)或[onIdle](arkts-apis-uicontext-framecallback.md#onidle12)方法，实现具体的业务逻辑。
