...
scraped_at: 2026-06-11T15:42:01+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:af28eb33e9a687facb2f0bb78c163b99bb212c2fdc4de28a88926083428b8d57
---
提供绘制浮层的能力。
...
* 以下API需先使用UIContext中的[getOverlayManager()](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md#getoverlaymanager12>)方法获取到OverlayManager对象，再通过该对象调用对应方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) | 是 | 在OverlayManager的指定节点上添加此content。  **说明：**  新增的节点默认处于页面居中，按层级堆叠。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/6_CS6jRES12jn8Mu4VzeQQ/zh-cn_image_0000002622859317.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074200Z&HW-CC-Expire=86400&HW-CC-Sign=359CC298D5C336C522B1C3167CEC860248005139FA8AFAB2509AAF9DEC072F9E)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) | 是 | 在OverlayManager的指定节点上添加此content。  **说明：**  新增的节点默认处于页面居中位置，按层级堆叠。 |
| levelOrder | [LevelOrder](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#levelorder18>) | 否 | 新增浮层节点的显示顺序。  **说明：**  - 默认值：LevelOrder.clamp(0) |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/jX-03oX9RDe05mxWlOiMkw/zh-cn_image_0000002622699437.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074200Z&HW-CC-Expire=86400&HW-CC-Sign=B6E968E4CE9ADB157FB88CE25710EE5ADB876062C5B57259A6C1BF367A034AE4)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) | 是 | 在OverlayManager上删除此content。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) | 是 | 在OverlayManager上显示此content。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) | 是 | 在OverlayManager上隐藏此content。 |
