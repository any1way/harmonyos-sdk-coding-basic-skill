...
scraped_at: 2026-06-11T15:42:15+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:2585586f55ceb3c23408be7fce893dab088d251eb209d6ece790ddc28043f92e
---
提供UI组件行为变化的无感监听能力。
...
* 以下API需先使用UIContext中的[getUIObserver()](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md#getuiobserver11>)方法获取到UIObserver对象，再通过该对象调用对应方法。
...
监听[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的状态变化。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationUpdate'，即[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的状态变化。 |
| callback | Callback<observer.[NavDestinationInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationinfo>)> | 是 | 回调函数。返回当前的[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件状态。 |
...
取消监听[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的状态变化。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationUpdate'，即[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的状态变化。 |
| callback | Callback<observer.[NavDestinationInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationinfo>)> | 否 | 需要取消的监听回调，不传参数时，取消所有的[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)监听回调。 |
...
通过[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的id监听[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的状态变化。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationUpdate'，即[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的状态变化。 |
| options | { navigationId: [ResourceStr](../../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) } | 是 | 指定监听的[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的id。 |
| callback | Callback<observer.[NavDestinationInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationinfo>)> | 是 | 回调函数。返回当前的[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件状态。 |
...
取消通过[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的id监听[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的状态变化。
...
| type | string | 是 | 监听事件，固定为'navDestinationUpdate'，即[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的状态变化。 |
| options | { navigationId: [ResourceStr](../../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) } | 是 | 指定监听的[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的id。 |
| callback | Callback<observer.[NavDestinationInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationinfo>)> | 否 | 需要取消的监听回调，不传参数时，取消该[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)上所有的监听回调。 |
...
通过[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的uniqueId监听[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的状态变化，uniqueId可通过[queryNavigationInfo](../../../../ArkTS组件/自定义组件/自定义组件内置方法/ts-custom-component-api.md#querynavigationinfo12)获取。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationUpdateByUniqueId'，即[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的状态变化。 |
| navigationUniqueId | number | 是 | 指定监听的[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的uniqueId，可以通过[queryNavigationInfo](../../../../ArkTS组件/自定义组件/自定义组件内置方法/ts-custom-component-api.md#querynavigationinfo12)获取。 |
| callback | Callback<observer.[NavDestinationInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationinfo>)> | 是 | 回调函数。返回当前的[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件状态。 |

**示例：**

通过[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的uniqueId，可以触发[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的状态变化。
...
取消通过[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的uniqueId监听[NavDestination](../../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的变化。
...
监听所有滚动组件滚动事件的开始和结束。滚动组件包括[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)、[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)、[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)、[WaterFlow](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)、[ArcList](../../../../ArkTS组件/滚动与滑动/ArcList/ts-container-arclist.md)。
...
| callback | Callback<observer.[ScrollEventInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#scrolleventinfo12>)> | 是 | 回调函数。返回滚动事件的信息。 |
...
取消监听所有滚动组件滚动事件的开始和结束。滚动组件包括[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)、[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)、[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)、[WaterFlow](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)、[ArcList](../../../../ArkTS组件/滚动与滑动/ArcList/ts-container-arclist.md)。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'scrollEvent'，即滚动事件的开始和结束。 |
| callback | Callback<observer.[ScrollEventInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#scrolleventinfo12>)> | 否 | 回调函数。返回滚动事件的信息。不传参数时，取消所有滚动事件的监听回调。 |
...
监听指定id的滚动组件滚动事件的开始和结束。滚动组件包括[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)、[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)、[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)、[WaterFlow](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)、[ArcList](../../../../ArkTS组件/滚动与滑动/ArcList/ts-container-arclist.md)。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'scrollEvent'，即滚动事件的开始和结束。 |
| options | observer.[ObserverOptions](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#observeroptions12>) | 是 | Observer选项，包含指定监听的滚动组件的id。 |
| callback | Callback<observer.[ScrollEventInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#scrolleventinfo12>)> | 是 | 回调函数。返回滚动事件的信息。 |
...
取消监听指定id的滚动组件滚动事件的开始和结束。滚动组件包括[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)、[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)、[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)、[WaterFlow](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)、[ArcList](../../../../ArkTS组件/滚动与滑动/ArcList/ts-container-arclist.md)。
...
监听[Router](<../Class (Router)/arkts-apis-uicontext-router.md>)中page页面的状态变化。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'routerPageUpdate'，即[Router](<../Class (Router)/arkts-apis-uicontext-router.md>)中page页面的状态变化。 |
| callback | Callback<observer.[RouterPageInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#routerpageinfo>)> | 是 | 回调函数。携带[RouterPageInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#routerpageinfo>)对象，返回当前的page页面状态。 |
...
取消监听[Router](<../Class (Router)/arkts-apis-uicontext-router.md>)中page页面的状态变化。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'routerPageUpdate'，即[Router](<../Class (Router)/arkts-apis-uicontext-router.md>)中page页面的状态变化。 |
| callback | Callback<observer.[RouterPageInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#routerpageinfo>)> | 否 | 需要被注销的回调函数。不传参数时，取消所有[Router](<../Class (Router)/arkts-apis-uicontext-router.md>)中page页面状态变化的监听回调。 |
...
| callback | Callback<observer.[DensityInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#densityinfo12>)> | 是 | 回调函数。携带[DensityInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#densityinfo12>)，返回变化后的屏幕像素密度。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'densityUpdate'，即屏幕像素密度变化。 |
| callback | Callback<observer.[DensityInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#densityinfo12>)> | 否 | 需要被注销的回调函数。若不指定具体的回调函数，则注销该[UIContext](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md>)下所有屏幕像素密度变化事件监听。 |
...
监听[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的页面切换事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationSwitch'，即[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的页面切换事件。 |
| callback | Callback<observer.[NavDestinationSwitchInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationswitchinfo12>)> | 是 | 回调函数。携带[NavDestinationSwitchInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationswitchinfo12>)，返回页面切换事件的信息。 |
...
取消监听[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的页面切换事件。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationSwitch'，即[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的页面切换事件。 |
| callback | Callback<observer.[NavDestinationSwitchInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationswitchinfo12>)> | 否 | 需要被注销的回调函数。不传参数时，取消该[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)上所有的监听回调。 |
...
通过监听选项监听[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的页面切换事件。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationSwitch'，即[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的页面切换事件。 |
| observerOptions | observer.[NavDestinationSwitchObserverOptions](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationswitchobserveroptions12>) | 是 | 监听选项。 |
| callback | Callback<observer.[NavDestinationSwitchInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationswitchinfo12>)> | 是 | 回调函数。携带[NavDestinationSwitchInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationswitchinfo12>)，返回页面切换事件的信息。 |
...
取消通过监听选项监听[Navigation](../../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)的页面切换事件。
...
监听点击事件指令下发情况，所注册回调将于点击事件触发前触发。回调类型为[GestureEventListenerCallback](../Types/arkts-apis-uicontext-t.md#gestureeventlistenercallback12)。从API version 20开始支持屏幕朗读触控模式。
...
| callback | [GestureEventListenerCallback](../Types/arkts-apis-uicontext-t.md#gestureeventlistenercallback12) | 是 | 回调函数。可以获得点击事件的[GestureEvent](../../../../ArkTS组件/手势处理/手势公共接口/ts-gesture-common.md#gestureevent对象说明)和组件的[FrameNode](../../arkui/FrameNode/js-apis-arkui-framenode.md)。 |
...
| callback | [GestureEventListenerCallback](../Types/arkts-apis-uicontext-t.md#gestureeventlistenercallback12) | 否 | 需要被注销的回调函数。不传参数时，取消所有的点击事件指令下发监听回调。 |
...
监听点击事件指令下发情况，所注册回调将于点击事件触发后触发。回调类型为[GestureEventListenerCallback](../Types/arkts-apis-uicontext-t.md#gestureeventlistenercallback12)。从API version 20开始支持屏幕朗读触控模式。
...
监听点击事件指令下发情况，所注册回调将于点击事件触发前触发。回调类型为[ClickEventListenerCallback](../Types/arkts-apis-uicontext-t.md#clickeventlistenercallback12)。从API version 20开始支持屏幕朗读触控模式。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'willClick'，用于监听点击事件指令下发情况，所注册回调将于点击事件触发前触发。 |
| callback | [ClickEventListenerCallback](../Types/arkts-apis-uicontext-t.md#clickeventlistenercallback12) | 是 | 回调函数。可以获得点击事件的[ClickEvent](../../../../ArkTS组件/通用事件/交互响应事件/点击事件/ts-universal-events-click.md#clickevent)和组件的[FrameNode](../../arkui/FrameNode/js-apis-arkui-framenode.md)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'willClick'，即点击事件指令下发情况。 |
| callback | [ClickEventListenerCallback](../Types/arkts-apis-uicontext-t.md#clickeventlistenercallback12) | 否 | 需要被注销的回调函数。不传参数时，取消所有的点击事件指令下发监听回调。 |
...
监听点击事件指令下发情况，所注册回调将于点击事件触发后触发。回调类型为[ClickEventListenerCallback](../Types/arkts-apis-uicontext-t.md#clickeventlistenercallback12)。从API version 20开始支持屏幕朗读触控模式。
...
监听[TabContent](../../../../ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md)页面的切换事件。相比[on('tabChange')](arkts-apis-uicontext-uiobserver.md#ontabchange22)，本接口不支持监听Tabs组件初始化时，显示首个页签的事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'tabContentUpdate'，即[TabContent](../../../../ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md)页面的切换事件。 |
| callback | Callback<observer.[TabContentInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#tabcontentinfo12>)> | 是 | 回调函数。携带[TabContentInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#tabcontentinfo12>)，返回[TabContent](../../../../ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md)页面切换事件的信息。 |
...
取消监听[TabContent](../../../../ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md)页面的切换事件。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'tabContentUpdate'，即[TabContent](../../../../ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md)页面的切换事件。 |
| callback | Callback<observer.[TabContentInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#tabcontentinfo12>)> | 否 | 需要被注销的回调函数。不传参数时，取消该[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)上所有的监听回调。 |
...
通过[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件的id监听[TabContent](../../../../ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md)页面的切换事件。相比[on('tabChange')](arkts-apis-uicontext-uiobserver.md#ontabchange22-1)，本接口不支持监听Tabs组件初始化时，显示首个页签的事件。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'tabContentUpdate'，即[TabContent](../../../../ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md)页面的切换事件。 |
| options | observer.[ObserverOptions](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#observeroptions12>) | 是 | 指定监听的[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件的id。 |
| callback | Callback<observer.[TabContentInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#tabcontentinfo12>)> | 是 | 回调函数。携带TabContentInfo，返回[TabContent](../../../../ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md)页面切换事件的信息。 |
...
取消通过[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件的id监听[TabContent](../../../../ArkTS组件/导航与切换/TabContent/ts-container-tabcontent.md)页面的切换事件。
...
监听[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件页签的切换事件，支持多个[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件的监听。相比[on('tabContentUpdate')](arkts-apis-uicontext-uiobserver.md#ontabcontentupdate12)，本接口支持监听Tabs组件初始化时，显示首个页签的事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'tabChange'，即[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件页签的切换事件。 |
| callback | Callback<observer.[TabContentInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#tabcontentinfo12>)> | 是 | 回调函数。携带[TabContentInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#tabcontentinfo12>)，返回[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件页签的切换事件的信息。 |
...
取消监听所有的[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件页签的切换事件。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'tabChange'，即[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件页签的切换事件。 |
| callback | Callback<observer.[TabContentInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#tabcontentinfo12>)> | 否 | 需要被注销的回调函数。若不指定具体的回调函数，则注销所有通过[on('tabChange')](arkts-apis-uicontext-uiobserver.md#ontabchange22)接口注册的回调函数。  默认值：undefined |
...
监听指定[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件的页签切换事件。相比[on('tabContentUpdate')](arkts-apis-uicontext-uiobserver.md#ontabcontentupdate12-1)，本接口支持监听Tabs组件初始化时，显示首个页签的事件。
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'tabChange'，即[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件页签的切换事件。 |
| config | observer.[ObserverOptions](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#observeroptions12>) | 是 | 指定监听的[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件的id。 |
| callback | Callback<observer.[TabContentInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#tabcontentinfo12>)> | 是 | 回调函数。携带[TabContentInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#tabcontentinfo12>)，返回[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件页签的切换事件的信息。 |
...
取消监听指定[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件页签的切换事件。
...
| type | string | 是 | 监听事件，固定为'tabChange'，即[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件页签的切换事件。 |
| config | observer.[ObserverOptions](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#observeroptions12>) | 是 | 指定监听的[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件的id。 |
| callback | Callback<observer.[TabContentInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#tabcontentinfo12>)> | 否 | 需要被注销的回调函数。若不指定具体的回调函数，则注销config指定的[Tabs](../../../../ArkTS组件/导航与切换/Tabs/ts-container-tabs.md)组件下注册的所有的回调函数。  默认值：undefined |
...
| callback | Callback<observer.[TextChangeEventInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#textchangeeventinfo22>)> | 是 | 回调函数，返回文本变化的信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'textChange'，表示文本输入的变化。 |
| callback | Callback<observer.[TextChangeEventInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#textchangeeventinfo22>)> | 否 | 需要被注销的回调函数。不传参数时，取消输入框文本变化的所有全局监听。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'textChange'，表示文本输入的变化。 |
| identity | observer.[ObserverOptions](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#observeroptions12>) | 是 | 指定监听的文本输入组件的ID。 |
| callback | Callback<observer.[TextChangeEventInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#textchangeeventinfo22>)> | 是 | 回调函数。返回文本变化的信息。 |
...
| type | string | 是 | 监听事件，固定为'textChange'，表示文本输入的变化。 |
| identity | observer.[ObserverOptions](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#observeroptions12>) | 是 | 指定监听的文本输入组件的ID。 |
| callback | Callback<observer.[TextChangeEventInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#textchangeeventinfo22>)> | 否 | 需要被注销的回调函数。不传参数时，取消指定ID输入框文本变化的所有局部监听。 |
...
监听Pan手势[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件，在[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件执行之前执行callback回调。支持手指滑动、鼠标滑动、鼠标滚轮和触摸板拖动，暂不支持屏幕朗读触控模式。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'beforePanStart'，用于监听Pan手势[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件执行前的指令下发情况，所注册回调将于Pan手势[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件触发前触发。 |
| callback | [PanListenerCallback](../Types/arkts-apis-uicontext-t.md#panlistenercallback19) | 是 | 回调函数。可以获得Pan手势事件的[GestureEvent](../../../../ArkTS组件/手势处理/手势公共接口/ts-gesture-common.md#gestureevent对象说明)，[GestureRecognizer](../../../../ArkTS组件/手势处理/手势公共接口/ts-gesture-common.md#gesturerecognizer12)和组件的[FrameNode](../../arkui/FrameNode/js-apis-arkui-framenode.md)。 |
...
取消[on('beforePanStart')](arkts-apis-uicontext-uiobserver.md#onbeforepanstart19)监听Pan手势[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件执行前的callback回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'beforePanStart'，即Pan手势[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件执行前的指令下发情况。 |
| callback | [PanListenerCallback](../Types/arkts-apis-uicontext-t.md#panlistenercallback19) | 否 | 需要被注销的回调函数。不传参数时，取消所有的Pan手势[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件执行前的指令下发监听回调。 |
...
监听Pan手势[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件执行后的指令下发情况，在[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件执行之后执行callback回调。支持手指滑动、鼠标滑动、鼠标滚轮和触摸板拖动，暂不支持屏幕朗读触控模式。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'afterPanStart'，用于监听Pan手势[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件执行后的指令下发情况，所注册回调将于Pan手势[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件触发后触发。 |
| callback | [PanListenerCallback](../Types/arkts-apis-uicontext-t.md#panlistenercallback19) | 是 | 回调函数。可以获得Pan手势事件的[GestureEvent](../../../../ArkTS组件/手势处理/手势公共接口/ts-gesture-common.md#gestureevent对象说明)，[GestureRecognizer](../../../../ArkTS组件/手势处理/手势公共接口/ts-gesture-common.md#gesturerecognizer12)和组件的[FrameNode](../../arkui/FrameNode/js-apis-arkui-framenode.md)。 |
...
取消[on('afterPanStart')](arkts-apis-uicontext-uiobserver.md#onafterpanstart19)监听Pan手势[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件执行后的callback回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'afterPanStart'，即Pan手势[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件执行后的指令下发情况。 |
| callback | [PanListenerCallback](../Types/arkts-apis-uicontext-t.md#panlistenercallback19) | 否 | 需要被注销的回调函数。不传参数时，取消所有的Pan手势[onActionStart](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionstart)事件执行后的指令下发监听回调。 |
...
监听Pan手势[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件执行前的指令下发情况，在[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件执行之前执行callback回调。支持手指滑动、鼠标滑动、鼠标滚轮和触摸板拖动，暂不支持屏幕朗读触控模式。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'beforePanEnd'，用于监听Pan手势[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件执行前的指令下发情况，所注册回调将于Pan手势[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件触发前触发。 |
| callback | [PanListenerCallback](../Types/arkts-apis-uicontext-t.md#panlistenercallback19) | 是 | 回调函数。可以获得Pan手势事件的[GestureEvent](../../../../ArkTS组件/手势处理/手势公共接口/ts-gesture-common.md#gestureevent对象说明)，[GestureRecognizer](../../../../ArkTS组件/手势处理/手势公共接口/ts-gesture-common.md#gesturerecognizer12)和组件的[FrameNode](../../arkui/FrameNode/js-apis-arkui-framenode.md)。 |
...
取消[on('beforePanEnd')](arkts-apis-uicontext-uiobserver.md#onbeforepanend19)监听Pan手势[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件执行前的callback回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'beforePanEnd'，即Pan手势[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件执行前的指令下发情况。 |
| callback | [PanListenerCallback](../Types/arkts-apis-uicontext-t.md#panlistenercallback19) | 否 | 需要被注销的回调函数。不传参数时，取消所有的Pan手势[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件执行前的指令下发监听回调。 |
...
监听Pan手势[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件执行后的指令下发情况，在[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件执行之后执行callback回调。支持手指滑动、鼠标滑动、鼠标滚轮和触摸板拖动，暂不支持屏幕朗读触控模式。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'afterPanEnd'，用于监听Pan手势[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件执行后的指令下发情况，所注册回调将于Pan手势[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件触发后触发。 |
| callback | [PanListenerCallback](../Types/arkts-apis-uicontext-t.md#panlistenercallback19) | 是 | 回调函数。可以获得Pan手势事件的[GestureEvent](../../../../ArkTS组件/手势处理/手势公共接口/ts-gesture-common.md#gestureevent对象说明)，[GestureRecognizer](../../../../ArkTS组件/手势处理/手势公共接口/ts-gesture-common.md#gesturerecognizer12)和组件的[FrameNode](../../arkui/FrameNode/js-apis-arkui-framenode.md)。 |
...
取消[on('afterPanEnd')](arkts-apis-uicontext-uiobserver.md#onafterpanend19)监听Pan手势[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件执行后的callback回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'afterPanEnd'，即Pan手势[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件执行后的指令下发情况。 |
| callback | [PanListenerCallback](../Types/arkts-apis-uicontext-t.md#panlistenercallback19) | 否 | 需要被注销的回调函数。不传参数时，取消所有的Pan手势[onActionEnd](../../../../ArkTS组件/手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#onactionend)事件执行后的指令下发监听回调。 |
...
通常，当组件被移动到屏幕外时，会收到RENDER\_OUT的通知。但在某些情况下，即使组件移动到屏幕外也不会触发RENDER\_OUT通知。例如，具有缓存功能的组件[Swiper](../../../../ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md)，即使[cachedCount](../../../../ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md#cachedcount15)属性中的参数isShown配置为true，也不会触发RENDER\_OUT通知。
...
| nodeIdentity | [NodeIdentity](../Types/arkts-apis-uicontext-t.md#nodeidentity20) | 是 | 节点标识。 |
| callback | [NodeRenderStateChangeCallback](../Types/arkts-apis-uicontext-t.md#noderenderstatechangecallback20) | 是 | 回调函数。可以获得节点渲染状态改变事件的[NodeRenderState](../Enums/arkts-apis-uicontext-e.md#noderenderstate20)和组件的[FrameNode](../../arkui/FrameNode/js-apis-arkui-framenode.md)。 |

**错误码：**

以下错误码的详细介绍请参见[注册节点渲染状态监听错误码](../../../../错误码/UI界面/注册节点渲染状态监听错误码/errorcode-node-render-monitor.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/HdUHMz8nT_WSA9Kg0B-biw/zh-cn_image_0000002592379814.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074211Z&HW-CC-Expire=86400&HW-CC-Sign=25BEE935BC343087BD7AAB0D245036C0413E220500D3F27C4B6E0F821311E356)
...
| nodeIdentity | [NodeIdentity](../Types/arkts-apis-uicontext-t.md#nodeidentity20) | 是 | 节点标识。 |
| callback | [NodeRenderStateChangeCallback](../Types/arkts-apis-uicontext-t.md#noderenderstatechangecallback20) | 否 | 需要被注销的回调函数。不传参数时，取消该节点所有的渲染状态变化指令下发监听回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [GestureListenerType](../Enums/arkts-apis-uicontext-e.md#gesturelistenertype20) | 是 | 要监听的手势类型。 |
| option | [GestureObserverConfigs](<../Interfaces (其他)/arkts-apis-uicontext-i.md#gestureobserverconfigs20>) | 是 | 绑定全局监听器时的配置选项。 |
| callback | [GestureListenerCallback](../Types/arkts-apis-uicontext-t.md#gesturelistenercallback20) | 是 | 手势状态更新时的回调函数。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/6WCDhylFRm6TFtnNd26eig/zh-cn_image_0000002622859323.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074211Z&HW-CC-Expire=86400&HW-CC-Sign=09DE414478CBB8AAD55E66C2BBEA15B8BD7AC7A7BD01BA68F54725229028694B)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [GestureListenerType](../Enums/arkts-apis-uicontext-e.md#gesturelistenertype20) | 是 | 要移除监听器的事件类型。 |
| callback | [GestureListenerCallback](../Types/arkts-apis-uicontext-t.md#gesturelistenercallback20) | 否 | 待移除的回调函数（未提供时将清除该手势类型的所有回调）。 |
...
| callback | Callback<observer.[WindowSizeLayoutBreakpointInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#windowsizelayoutbreakpointinfo22>)> | 是 | 回调函数。携带WindowSizeLayoutBreakpointinfo，包含窗口宽度和高度所在的布局断点枚举。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'windowSizeLayoutBreakpointChange'，用于监听窗口尺寸布局断点发生改变。 |
| callback | Callback<observer.[WindowSizeLayoutBreakpointInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#windowsizelayoutbreakpointinfo22>)> | 否 | 需要被注销的回调函数。若不指定具体的回调函数，则注销该[UIContext](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md>)下所有窗口尺寸布局断点变化事件监听。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[SwiperContentInfo](<../Interfaces (其他)/arkts-apis-uicontext-i.md#swipercontentinfo22>)> | 是 | 回调函数。携带SwiperContentInfo，返回Swiper内容切换的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[SwiperContentInfo](<../Interfaces (其他)/arkts-apis-uicontext-i.md#swipercontentinfo22>)> | 否 | 需要被注销的回调函数。不传参数时，取消该Swiper上所有的监听回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | observer.[ObserverOptions](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#observeroptions12>) | 是 | 指定监听的Swiper组件信息。 |
| callback | Callback<[SwiperContentInfo](<../Interfaces (其他)/arkts-apis-uicontext-i.md#swipercontentinfo22>)> | 是 | 回调函数。携带SwiperContentInfo，返回Swiper内容切换的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<observer.[RouterPageInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#routerpageinfo>)> | 是 | 回调函数。携带RouterPageInfo，返回Router页面的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<observer.[RouterPageInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#routerpageinfo>)> | 否 | 需要被移除的回调函数。不传参数时，移除所有回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<observer.[NavDestinationInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationinfo>)> | 是 | 回调函数。携带NavDestinationInfo，返回NavDestination的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<observer.[NavDestinationInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationinfo>)> | 否 | 需要被移除的回调函数。不传参数时，移除所有回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| navigationUniqueId | number | 是 | 希望监听NavDestination所属的Navigation的唯一ID，可以通过[queryNavigationInfo](../../../../ArkTS组件/自定义组件/自定义组件内置方法/ts-custom-component-api.md#querynavigationinfo12)获取。 |
| callback | Callback<observer.[NavDestinationInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationinfo>)> | 是 | 回调函数。携带NavDestinationInfo，返回NavDestination的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| navigationUniqueId | number | 是 | 希望监听的NavDestination所属的Navigation的唯一ID，可以通过[queryNavigationInfo](../../../../ArkTS组件/自定义组件/自定义组件内置方法/ts-custom-component-api.md#querynavigationinfo12)获取。 |
| callback | Callback<observer.[NavDestinationInfo](<../../@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationinfo>)> | 否 | 需要被移除的回调函数。不传参数时，移除所有指定了相同navigationUniqueId的回调函数。 |
