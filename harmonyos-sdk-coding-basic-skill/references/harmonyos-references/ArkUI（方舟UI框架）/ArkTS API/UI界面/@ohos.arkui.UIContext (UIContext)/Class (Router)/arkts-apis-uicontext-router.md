...
scraped_at: 2026-06-01T15:37:12+08:00
doc_updated_at: 2026-05-08
content_hash: sha256:47d09ef9cf58085a25d36ca0b74439186576aff364322cbf6b1a7cd6210d0b26
---
...
* 以下API需先使用UIContext中的[getRouter()](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md#getrouter>)方法获取到Router对象，再通过该对象调用对应方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [router.RouterOptions](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md#routeroptions>) | 是 | 跳转页面描述信息。 |
...
| --- | --- | --- | --- |
| options | [router.RouterOptions](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md#routeroptions>) | 是 | 跳转页面描述信息。 |
| mode | [router.RouterMode](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md#routermode9>) | 是 | 跳转页面使用的模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [router.RouterOptions](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md#routeroptions>) | 是 | 替换页面描述信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [router.NamedRouterOptions](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md#namedrouteroptions10>) | 是 | 跳转页面描述信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [router.NamedRouterOptions](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md#namedrouteroptions10>) | 是 | 替换页面描述信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [router.RouterOptions](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md#routeroptions>) | 否 | 返回页面描述信息，其中参数url指路由跳转时返回到指定url的页面，如果页面栈中没有对应url的页面，则不响应该操作；如果栈中存在对应url的页面，则返回至index最大的同名页面。  如果url未设置，则返回上一页，页面不会重新构建，页面栈里面的page不会回收，出栈后会被回收。 |
...
| 类型 | 说明 |
| --- | --- |
| router.[RouterState](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md#routerstate>) | 页面状态信息。 |
...
| 类型 | 说明 |
| --- | --- |
| router.[RouterState](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md#routerstate>) | undefined | 返回页面状态信息。索引不存在时返回undefined。 |
...
getStateByUrl(url: string): Array<router.[RouterState](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md#routerstate>)>
...
| 类型 | 说明 |
| --- | --- |
| Array<router.[RouterState](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md#routerstate>)> | 页面状态信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [router.EnableAlertOptions](<../../@ohos.router (页面路由)(不推荐)/js-apis-router.md#enablealertoptions>) | 是 | 文本弹窗信息描述。 |
