...
scraped_at: 2026-06-11T15:41:57+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:d717e04c8bf7f1e4fb9781856d5f1f38e3585e1b79b3a2ed2c5cebb38354254d
---
...
* 以下API需先使用UIContext中的[getMagnifier()](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md#getmagnifier22>)方法获取Magnifier实例，再通过此实例调用对应方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| id | string | 是 | 组件id，可通过通用属性[id](../../../../ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#id)或[key](../../../../ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#key12)设置。当组件id为空字符串或未找到匹配id的组件时，不显示放大镜。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/xq_10rzXTRif35kPTYjnDA/zh-cn_image_0000002622699435.png?HW-CC-KV=V1&HW-CC-Date=20260611T074155Z&HW-CC-Expire=86400&HW-CC-Sign=AD05C9B1D523F2859A06E1851C587965323A9CD89683157D0B56CF46AB562FC4)
