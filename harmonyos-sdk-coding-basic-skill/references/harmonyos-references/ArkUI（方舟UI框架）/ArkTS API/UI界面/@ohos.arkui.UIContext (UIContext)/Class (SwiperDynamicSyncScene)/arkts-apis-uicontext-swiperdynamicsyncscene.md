...
content_hash: sha256:7b8d188f438c7e3d46f2e322b1d29ea65a1edac13c6930b65d73cdd806d2c7c1
---
提供Swiper组件相关帧率的配置。
...
* SwiperDynamicSyncScene继承自[DynamicSyncScene](<../Class (DynamicSyncScene)/arkts-apis-uicontext-dynamicsyncscene.md>)，对应Swiper的动态帧率场景。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type12+ | [SwiperDynamicSyncSceneType](../Enums/arkts-apis-uicontext-e.md#swiperdynamicsyncscenetype12) | 是 | 否 | Swiper的动态帧率场景。 |
