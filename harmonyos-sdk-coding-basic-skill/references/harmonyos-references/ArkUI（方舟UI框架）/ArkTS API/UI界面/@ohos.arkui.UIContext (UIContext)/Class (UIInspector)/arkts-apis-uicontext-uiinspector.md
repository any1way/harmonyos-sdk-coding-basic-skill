...
scraped_at: 2026-06-01T15:37:19+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:4bffd2d65c2f49a44317424b0e43fd6d60474d5bbfd7c522e7a7e6715b3054ac
---
...
* 以下API需先使用UIContext中的[getUIInspector()](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md#getuiinspector>)方法获取到UIInspector对象，再通过该对象调用对应方法。
...
| 类型 | 说明 |
| --- | --- |
| [inspector.ComponentObserver](<../../@ohos.arkui.inspector (布局回调)/js-apis-arkui-inspector.md#componentobserver>) | 组件回调事件监听句柄，用于注册和取消注册监听回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| id | string | number | 是 | 类型为string时，为指定的组件id，该id通过通用属性[id](../../../../ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#id)或者[key](../../../../ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#key12)设置。类型为number时，为系统分配的唯一标识的节点UniqueID，UniqueID通过[getUniqueId](../../arkui/FrameNode/js-apis-arkui-framenode.md#getuniqueid12)获取。使用UniqueID创建监听句柄时，请确保UniqueID对应的节点已经存在，否则后续监听无法生效。number的范围为1~2147483647的整数。 |
