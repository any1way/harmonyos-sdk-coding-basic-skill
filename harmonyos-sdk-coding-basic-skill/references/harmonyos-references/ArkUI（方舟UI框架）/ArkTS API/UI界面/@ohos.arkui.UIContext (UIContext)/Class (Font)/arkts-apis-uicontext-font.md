...
scraped_at: 2026-06-01T15:37:03+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:d415efd420b3dbb98628ee401a8f69de768ee1d1dd7a83e5677af641e0e50d21
---
注册自定义字体的信息。
...
* 以下API需先使用UIContext中的[getFont()](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md#getfont>)方法获取到Font对象，再通过该对象调用对应方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [font.FontOptions](<../../@ohos.font (注册自定义字体)/js-apis-font.md#fontoptions>) | 是 | 注册的自定义字体信息。  **说明：**  设置注册字体文件的路径，读取系统沙箱路径内的资源时，建议使用file://路径前缀的字符串，需要确保沙箱目录路径下的文件存在并且有可读权限。 |
...
| 类型 | 说明 |
| --- | --- |
| [font.FontInfo](<../../@ohos.font (注册自定义字体)/js-apis-font.md#fontinfo10>) | 字体的详细信息。  如果查询不到字体，返回undefined。 |
