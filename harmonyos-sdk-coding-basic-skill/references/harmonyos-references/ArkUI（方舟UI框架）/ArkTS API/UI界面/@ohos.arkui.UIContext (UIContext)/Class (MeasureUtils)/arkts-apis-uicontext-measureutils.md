...
scraped_at: 2026-06-11T15:41:59+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:eaf1ce22c0b0be6aecc403a468f61d58c9233a6eecfa71aa8ca317609ff20ec3
---
提供文本宽度、高度等相关计算。
...
* 以下API需先使用UIContext中的[getMeasureUtils()](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md#getmeasureutils12>)方法获取MeasureUtils实例，再通过此实例调用对应方法。
* 如需更多测算文本参数，比如[includeFontPadding](../../../../ArkTS组件/文本与输入/Text/ts-basic-components-text.md#includefontpadding23)和[fallbackLineSpacing](../../../../ArkTS组件/文本与输入/Text/ts-basic-components-text.md#fallbacklinespacing23)，建议使用图形对应测算接口[Paragraph](<../../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#paragraph>)接口。
* 调用文本计算接口时，不推荐同时用[ApplicationContext.setFontSizeScale](<../../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/ApplicationContext (应用上下文)/js-apis-inner-application-applicationcontext.md#applicationcontextsetfontsizescale13>)设置应用字体大小缩放比例。为了确保时序正确性，建议开发者自行监听字体缩放变化，以保证测算结果的准确性。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [MeasureOptions](<../../@ohos.measure (文本计算)/js-apis-measure.md#measureoptions>) | 是 | 被计算文本描述信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [SizeOptions](../../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#sizeoptions) | 返回文本所占布局宽度和高度。  **说明:**  没有传参constraintWidth的情况下，文本宽度返回值浮点数会向上取整。  文本宽度以及高度返回值单位均为px。 |
...
通过MeasureUtils的measureTextSize方法和unicode码点计算，手动实现文本截断。与设置[maxLines](../../../../ArkTS组件/文本与输入/Text/ts-basic-components-text.md#maxlines)、[textOverflow](../../../../ArkTS组件/文本与输入/Text/ts-basic-components-text.md#textoverflow)实现同样的效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/OIeV8BDORM-3QEi0QKk25g/zh-cn_image_0000002592219874.png?HW-CC-KV=V1&HW-CC-Date=20260611T074157Z&HW-CC-Expire=86400&HW-CC-Sign=A5C9CE5E08124E90991702AEA44E8F8599E0A49DF4A2C0916E732639F449A43D)
...
将属性字符串根据文本布局选项转换成对应的[Paragraph](<../../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#paragraph>)数组。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| styledString | [StyledString](../../../../ArkTS组件/文本与输入/属性字符串/ts-universal-styled-string.md#styledstring) | 是 | 待转换的属性字符串。 |
| options | [TextLayoutOptions](../../../../ArkTS组件/文本与输入/文本组件公共接口/ts-text-common.md#textlayoutoptions对象说明20) | 否 | 文本布局选项。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Array<[Paragraph](<../../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#paragraph>)> | [Paragraph](<../../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#paragraph>)的数组。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f7/v3/1grVbdQKSdyFPG9Ja1vlBw/zh-cn_image_0000002592379808.png?HW-CC-KV=V1&HW-CC-Date=20260611T074157Z&HW-CC-Expire=86400&HW-CC-Sign=32ACF60666064F035F5B995CCD7E21FD3C5FA9AC90072FFD7AAA2E669F72A42C)
