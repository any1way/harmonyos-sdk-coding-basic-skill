...
scraped_at: 2026-06-01T15:37:10+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:dc1e06bf47fd46380fee7794094935453b9e10ea6b5593123a82407a4b7310a3
---
...
* 以下API需先使用UIContext中的[getPromptAction()](<../Class (UIContext)/arkts-apis-uicontext-uicontext.md#getpromptaction>)方法获取到PromptAction对象，再通过该对象调用对应方法。
...
| 类型 | 说明 |
| --- | --- |
| [LevelOrder](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#levelorder18>) | 返回弹窗层级信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [promptAction.ShowToastOptions](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#showtoastoptions>) | 是 | Toast选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [promptAction.ShowDialogOptions](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#showdialogoptions>) | 是 | 页面显示对话框信息描述。 |
| callback | AsyncCallback<[promptAction.ShowDialogSuccessResponse](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#showdialogsuccessresponse>)> | 是 | 回调函数。弹出对话框成功，err为undefined，data为获取到的对话框响应结果，否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [promptAction.ShowDialogOptions](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#showdialogoptions>) | 是 | 对话框选项。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[promptAction.ShowDialogSuccessResponse](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#showdialogsuccessresponse>)> | Promise对象，返回对话框的响应结果。 |
...
showActionMenu(options: promptAction.ActionMenuOptions, callback: AsyncCallback<[promptAction.ActionMenuSuccessResponse](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#actionmenusuccessresponse>)>): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [promptAction.ActionMenuOptions](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#actionmenuoptions>) | 是 | 操作菜单选项。 |
| callback | AsyncCallback<[promptAction.ActionMenuSuccessResponse](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#actionmenusuccessresponse>)> | 是 | 回调函数。弹出操作菜单成功，err为undefined，data为获取到的操作菜单响应结果，否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[promptAction.ActionMenuSuccessResponse](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#actionmenusuccessresponse>)> | Promise对象，返回菜单的响应结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dialogContent | [ComponentContent<T>](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) | 是 | 自定义弹窗中显示的组件内容。 |
| options | [promptAction.BaseDialogOptions](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#basedialogoptions11>) | 否 | 弹窗样式。  **说明：** 如果BaseDialogOptions中的[isModal](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#basedialogoptions11>)与[showInSubWindow](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#basedialogoptions11>)同时设置为true，则只生效showInSubWindow = true，此时为非模态弹出框且不会显示蒙层，并在子窗口中显示。 |
...
以下错误码的详细介绍请参见[通用错误码](../../../../../通用错误码/errorcode-universal.md)和[弹窗错误码](../../../../错误码/UI界面/弹窗错误码/errorcode-promptaction.md)。
...
该示例通过监听[系统环境信息](<../../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Configuration (环境变量)/js-apis-app-ability-configuration.md>)（系统语言、深浅色等）的变化，调用[ComponentContent<T>](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) 的[update](../../arkui/BuilderNode/js-apis-arkui-buildernode.md#update)和[updateConfiguration](../../arkui/BuilderNode/js-apis-arkui-buildernode.md#updateconfiguration12)实现自定义弹窗的数据更新及节点的全量刷新。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [promptAction.CustomDialogOptions](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#customdialogoptions11>) | 是 | 自定义弹窗的内容。  **说明：** 如果BaseDialogOptions中的[isModal](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#basedialogoptions11>)与[showInSubWindow](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#basedialogoptions11>)同时设置为true，则只生效showInSubWindow = true，此时为非模态弹出框且不会显示蒙层，并在子窗口中显示。 |
...
| --- | --- | --- | --- |
| dialogContent | [ComponentContent<T>](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) | 是 | 自定义弹窗中显示的组件内容。 |
| controller | [promptAction.DialogController](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#dialogcontroller18>) | 是 | 自定义弹窗的控制器。 |
| options | [promptAction.BaseDialogOptions](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#basedialogoptions11>) | 否 | 自定义弹窗的样式。  **说明：** 如果BaseDialogOptions中的[isModal](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#basedialogoptions11>)与[showInSubWindow](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#basedialogoptions11>)同时设置为true，则只生效showInSubWindow = true，此时为非模态弹出框且不会显示蒙层，并在子窗口中显示。 |
...
| --- | --- | --- | --- |
| dialogContent | [ComponentContent<T>](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) | 是 | 自定义弹窗中显示的组件内容。 |
| options | [promptAction.BaseDialogOptions](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#basedialogoptions11>) | 是 | 弹窗样式，目前仅支持更新alignment、offset、autoCancel、maskColor。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| builder | [CustomBuilder](../../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | [CustomBuilderWithId](../Types/arkts-apis-uicontext-t.md#custombuilderwithid18) | 是 | 自定义弹窗的内容。 |
| controller | [promptAction.DialogController](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#dialogcontroller18>) | 否 | 自定义弹窗的控制器。 |
| options | [promptAction.DialogOptions](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#dialogoptions18>) | 否 | 自定义弹窗的样式。  **说明：** 如果BaseDialogOptions中的[isModal](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#basedialogoptions11>)与[showInSubWindow](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#basedialogoptions11>)同时设置为true，则只生效showInSubWindow = true，此时为非模态弹出框且不会显示蒙层，并在子窗口中显示。 |
...
* 如果在wrapBuilder中包含其他组件（例如：[Popup](../../../../ArkTS组件/系统预置UI组件库/Popup/ohos-arkui-advanced-popup.md)、[Chip](../../../../ArkTS组件/系统预置UI组件库/Chip/ohos-arkui-advanced-chip.md)组件），则[ComponentContent](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md#componentcontent-1)应采用带有四个参数的构造函数constructor，其中options参数应传递{ nestingBuilderSupported: true }。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent<T>](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) | 是 | popup弹窗中显示的组件内容。 |
| target | [TargetInfo](<../Interfaces (其他)/arkts-apis-uicontext-i.md#targetinfo18>) | 是 | 需要绑定组件的信息。 |
| options | [PopupCommonOptions](../../../../ArkTS组件/通用属性/弹窗控制/Popup控制/ts-universal-attributes-popup.md#popupcommonoptions18类型说明) | 否 | popup弹窗样式。 |
...
| --- | --- | --- | --- |
| content | [ComponentContent<T>](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) | 是 | popup弹窗中显示的组件内容。 |
| options | [PopupCommonOptions](../../../../ArkTS组件/通用属性/弹窗控制/Popup控制/ts-universal-attributes-popup.md#popupcommonoptions18类型说明) | 是 | popup弹窗样式。  **说明：**  不支持更新showInSubWindow、focusable、onStateChange、onWillDismiss、transition。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent<T>](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) | 是 | menu弹窗中显示的组件内容。 |
| target | [TargetInfo](<../Interfaces (其他)/arkts-apis-uicontext-i.md#targetinfo18>) | 是 | 需要绑定组件的信息。 |
| options | [MenuOptions](../../../../ArkTS组件/通用属性/弹窗控制/菜单控制/ts-universal-attributes-menu.md#menuoptions10) | 否 | menu弹窗样式。  **说明：**  title属性不生效。  preview参数仅支持设置MenuPreviewMode类型。 |
...
* 支持mask通过设置[MenuMaskType](../../../../ArkTS组件/通用属性/弹窗控制/菜单控制/ts-universal-attributes-menu.md#menumasktype20类型说明)实现更新蒙层样式，不支持mask通过设置boolean实现蒙层从无到有或者从有到无的更新。
...
| --- | --- | --- | --- |
| content | [ComponentContent<T>](../../arkui/ComponentContent/js-apis-arkui-componentcontent.md) | 是 | menu弹窗中显示的组件内容。 |
| options | [MenuOptions](../../../../ArkTS组件/通用属性/弹窗控制/菜单控制/ts-universal-attributes-menu.md#menuoptions10) | 是 | menu弹窗样式。  **说明：**  1. 不支持更新showInSubWindow、preview、previewAnimationOptions、transition、onAppear、aboutToAppear、onDisappear、aboutToDisappear、onWillAppear、onDidAppear、onWillDisappear和onDidDisappear。  2. 支持mask通过设置[MenuMaskType](../../../../ArkTS组件/通用属性/弹窗控制/菜单控制/ts-universal-attributes-menu.md#menumasktype20类型说明)实现更新蒙层样式，不支持mask通过设置boolean实现蒙层从无到有或者从有到无的更新。 |
...
showActionMenu(options: promptAction.ActionMenuOptions, callback: [promptAction.ActionMenuSuccessResponse](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#actionmenusuccessresponse>)): void
...
| --- | --- | --- | --- |
| options | [promptAction.ActionMenuOptions](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#actionmenuoptions>) | 是 | 操作菜单选项。 |
| callback | [promptAction.ActionMenuSuccessResponse](<../../@ohos.promptAction (弹窗)/js-apis-promptaction.md#actionmenusuccessresponse>) | 是 | 回调函数，返回菜单的响应结果。 |
