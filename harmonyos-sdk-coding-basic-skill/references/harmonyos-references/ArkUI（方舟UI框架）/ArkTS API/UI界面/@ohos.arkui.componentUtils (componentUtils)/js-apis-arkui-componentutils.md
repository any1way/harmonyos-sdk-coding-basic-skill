...
scraped_at: 2026-06-11T15:41:33+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:12ab47597231e4fabb820d690fa27d3b2984bcdf93875de352315eadc3bb8e6a
---
提供获取组件绘制区域坐标和大小的能力。
...
* 从API version 10开始支持，从API version 18开始废弃，建议使用[getRectangleById](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentUtils)/arkts-apis-uicontext-componentutils.md#getrectanglebyid>)替代。getRectangleById需先通过[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getComponentUtils](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getcomponentutils>)方法获取[ComponentUtils](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentUtils)/arkts-apis-uicontext-componentutils.md>)对象，然后通过该对象进行调用。
* 从API version 10开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getComponentUtils](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getcomponentutils>)方法获取当前UI上下文关联的[ComponentUtils](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentUtils)/arkts-apis-uicontext-componentutils.md>)对象。在目标组件布局完成后，通过该接口能够获取组件坐标和尺寸信息。建议在[布局回调](<../@ohos.arkui.inspector (布局回调)/js-apis-arkui-inspector.md>)中使用该接口。如果组件动态创建但未挂载组件树，则无法通过该接口获取正常的组件信息。因为组件在未挂载组件树的情况下，一般未经过UI框架正常的测量与布局，此时请确保组件正常挂载组件树后再尝试获取组件信息。
...
以下错误码的详细介绍请参见[接口调用异常错误码](../../../错误码/UI界面/接口调用异常错误码/errorcode-internal.md)。
...
推荐通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getComponentUtils](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getcomponentutils>)方法获取当前UI上下文关联的ComponentUtils对象。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/DeldxPxvQyuTm7Ci2S6iJQ/zh-cn_image_0000002592219864.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074132Z&HW-CC-Expire=86400&HW-CC-Sign=2B5238A231FB8E1CEA29BA8EABC91B2BCF700FF44D82D8976866A88405555DA5)
