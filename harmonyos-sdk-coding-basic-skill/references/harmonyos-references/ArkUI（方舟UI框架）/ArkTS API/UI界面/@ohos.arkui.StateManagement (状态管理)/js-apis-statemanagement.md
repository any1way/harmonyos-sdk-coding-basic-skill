...
scraped_at: 2026-06-01T15:37:29+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:1fa30b3242a1cf9dd3af82db140b59c9ca4bc87cf1b2240e92cfd577d82c9cc0
---
...
AppStorageV2具体UI使用说明，详见[AppStorageV2(应用全局的UI状态存储)](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V2）/管理应用拥有的状态/AppStorageV2 应用全局UI状态存储/arkts-new-appstoragev2.md>)。
...
将键值对数据储存在应用内存中。如果给定的key已经存在于[AppStorageV2](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V2）/管理应用拥有的状态/AppStorageV2 应用全局UI状态存储/arkts-new-appstoragev2.md>)中，返回对应的值；否则，通过获取默认值的构造器构造默认值，并返回。
...
将指定的键值对数据从[AppStorageV2](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V2）/管理应用拥有的状态/AppStorageV2 应用全局UI状态存储/arkts-new-appstoragev2.md>)里面删除。如果指定的键值不存在于AppStorageV2中，将删除失败。
...
获取[AppStorageV2](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V2）/管理应用拥有的状态/AppStorageV2 应用全局UI状态存储/arkts-new-appstoragev2.md>)中的所有key。
...
继承自[AppStorageV2](js-apis-statemanagement.md#appstoragev2)，PersistenceV2具体UI使用说明，详见[PersistenceV2(持久化存储UI状态)](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V2）/管理应用拥有的状态/PersistenceV2 持久化存储UI状态/arkts-new-persistencev2.md>)。
...
将键值对数据储存在应用磁盘中。如果给定的key已经存在于[PersistenceV2](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V2）/管理应用拥有的状态/PersistenceV2 持久化存储UI状态/arkts-new-persistencev2.md>)中，返回对应的值；否则，会通过获取默认值的构造器构造默认值，并返回。如果globalConnect的是[@ObservedV2](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-observedv2-and-trace)对象，该对象[@Trace](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-observedv2-and-trace)属性的变化，会触发整个关联对象的自动刷新；非@Trace属性变化则不会，如有必要，可调用[PersistenceV2.save](js-apis-statemanagement.md#save)接口手动存储。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [ConnectOptions<T>](js-apis-statemanagement.md#connectoptionst18) | 是 | 传入的connect参数，详细说明见ConnectOptions参数说明。 |
...
5、关联[@Observed](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Observed装饰器和@ObjectLink装饰器：嵌套类对象属性变化/arkts-observed-and-objectlink.md>)对象时，因为该类型的name属性未定义，需要指定key或者自定义name属性。
...
9、EL5加密要想生效，需要开发者在module.json中配置字段ohos.permission.PROTECT\_SCREEN\_LOCK\_DATA，使用说明见[声明权限](../../../../../harmonyos-guides/系统/安全/程序访问控制/应用权限管控/申请应用权限/声明权限/declare-permissions.md)。
...
将键值对数据储存在应用磁盘中。支持集合类型[Array，Map，Set，Date，collections.Array, collections.Map, collections.Set类型的持久化](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V2）/管理应用拥有的状态/PersistenceV2 持久化存储UI状态/arkts-new-persistencev2.md#globalconnect支持集合的类型>)。注意在持久化Array<ClassA>类型的数据时，需要调用[makeObserved](js-apis-statemanagement.md#makeobserved)使返回的对象被观察到。不支持多个嵌套集合，例如不支持Array<Array<ClassA>>的持久化。
...
由于非[@Trace](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-observedv2-and-trace)的数据改变不会触发[PersistenceV2](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V2）/管理应用拥有的状态/PersistenceV2 持久化存储UI状态/arkts-new-persistencev2.md>)的自动持久化，如有必要，可调用该接口持久化对应key的数据。
...
| areaMode | [contextConstant.AreaMode](<../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.contextConstant (Context相关常量)/js-apis-app-ability-contextconstant.md#areamode>) | 否 | 是 | 加密级别：EL1-EL5，详见[加密级别](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/应用上下文Context/application-context-stage.md#获取和修改加密分区>)，对应数值：0-4，不传时默认为EL2，不同加密级别对应不同的加密分区，即不同的存储路径，传入的加密等级数值不在0-4会直接运行crash。 |

## ConnectOptionsCollections<T, S>23+

PhonePC/2in1TabletTVWearable

[globalConnect](js-apis-statemanagement.md#globalconnect23)接口参数类型，ConnectOptionsCollections<T, S>继承自[ConnectOptions<T>](js-apis-statemanagement.md#connectoptionst18)。当开发者需要持久化容器类型数据（如Array<S>）时，需要使用ConnectOptionsCollections入参。
...
| Set<S> | 表示值类型为Set类型。 |
| [collections.Array](<../../../../ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Array)/arkts-apis-arkts-collections-array.md>)<S> | 表示值类型为collections.Array类型。 |
| [collections.Map](<../../../../ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Map)/arkts-apis-arkts-collections-map.md>)<string | number, S> | 表示值类型为collections.Map类型。 |
| [collections.Set](<../../../../ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/Class (Set)/arkts-apis-arkts-collections-set.md>)<S> | 表示值类型为collections.Set类型。 |
...
| reason | string | 否 | 否 | 对象是否可被观察的原因。  不可被观察原因：对象本身是不可被观察的。  可被观察原因或使用场景：  1. V1对象被[@Observed](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Observed装饰器和@ObjectLink装饰器：嵌套类对象属性变化/arkts-observed-and-objectlink.md>)装饰器装饰或对象是被[makeV1Observed](js-apis-statemanagement.md#makev1observed19)方法转换的。  2. V1对象被[@Observed](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Observed装饰器和@ObjectLink装饰器：嵌套类对象属性变化/arkts-observed-and-objectlink.md>)装饰器装饰或对象是被[makeV1Observed](js-apis-statemanagement.md#makev1observed19)方法转换的，但对象没有被UI组件使用。  3. V1对象被[enableV2Compatibility](js-apis-statemanagement.md#enablev2compatibility19)方法转换后传入V2组件。  4. V1对象被[enableV2Compatibility](js-apis-statemanagement.md#enablev2compatibility19)方法转换后传入V2组件，但没有被V2组件使用。  5. V2对象是被[@ObservedV2/@Trace](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-observedv2-and-trace)装饰的。  6. V2对象是被[makeObserved](js-apis-statemanagement.md#makeobserved)方法转换的。  7. V2对象属于Array/Map/Set/Date类型。  8. V2对象是被[@ObservedV2/@Trace](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-observedv2-and-trace)装饰的，但对象没有被UI组件使用。  9. V2对象是被[makeObserved](js-apis-statemanagement.md#makeobserved)方法转换的，但没有被UI组件使用。  10. V2对象属于Array/Map/Set/Date类型，但没有被UI组件使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| decoratorName | string | 否 | 否 | 当对象是V1对象时，值是对象关联的装饰器名称。  当V1对象使用[@Track](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理数据对象的状态/@Track装饰器：class对象属性级更新/arkts-track.md>)时，值为：'@Track'。  当V2对象使用[@Trace](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-observedv2-and-trace)时，值为：'@Trace'。  当V2对象使用[makeObserved](js-apis-statemanagement.md#makeobserved)时，值为：'MakeObserved'。  当V2对象使用[enableV2Compatibility](js-apis-statemanagement.md#enablev2compatibility19)时，值为：'EnableV2Compatible'。  当V2对象使用built-in类型数据时，值为：'ProxyObservedV2'。 |
| stateVariableName | string | 否 | 否 | 被装饰器装饰的属性名称。 |
| owningComponentOrClassName | string | 否 | 否 | V1对象返回被使用的组件名称。  V1对象有属性使用[@Track](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理数据对象的状态/@Track装饰器：class对象属性级更新/arkts-track.md>)装饰器时返回对象名称。  V2对象返回对象名称。 |
| owningComponentId | number | 否 | 否 | V1对象返回被使用的组件id。  **V1对象有属性使用[@Track](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理数据对象的状态/@Track装饰器：class对象属性级更新/arkts-track.md>)装饰器时和V2对象返回的是对象名称，无组件id，返回-1。** |
...
从状态管理框架包裹的代理对象中获取原始对象。详见[getTarget接口：获取状态管理框架代理前的原始对象](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/辅助接口/getTarget接口：获取状态管理框架代理前的原始对象/arkts-new-gettarget.md>)。
...
getLifecycle用于获取[自定义组件的生命周期](../../../ArkTS组件/自定义组件/自定义组件的生命周期（推荐）/ts-custom-component-new-lifecycle.md)实例。
...
| 类型 | 说明 |
| --- | --- |
| [CustomComponentLifecycle](../../../ArkTS组件/自定义组件/自定义组件的生命周期（推荐）/ts-custom-component-new-lifecycle.md#customcomponentlifecycle) | 自定义组件的生命周期实例。 |
...
判断数据对象是否为可观察对象，并返回观察结果。详见[canBeObserved接口：判断对象是否为可被观察对象](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/辅助接口/canBeObserved接口：判断对象是否可被观察/arkts-new-canbeobserved.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | T | 是 | 输入一个数据对象，判断其是否可被观察。支持Array、Map、Set和Date类型数据。  具体使用规则，详见[canBeObserved接口：判断对象是否为可被观察对象](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/辅助接口/canBeObserved接口：判断对象是否可被观察/arkts-new-canbeobserved.md>)。 |
...
将普通不可观察数据变为可观察数据。详见[makeObserved接口：将非观察数据变为可观察数据](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/辅助接口/makeObserved接口：将非观察数据变为可观察数据/arkts-new-makeobserved.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | T | 是 | 数据源对象。支持非@Observed和@ObservedV2装饰的class，JSON.parse返回的Object和@Sendable修饰的class。  支持Array、Map、Set和Date。  支持collections.Array, collections.Set和collections.Map。  具体使用规则，详见[makeObserved接口：将非观察数据变为可观察数据](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/辅助接口/makeObserved接口：将非观察数据变为可观察数据/arkts-new-makeobserved.md>)。 |
...
使V1的状态变量能够在@ComponentV2中观察，主要应用于状态管理V1、V2混用场景。详见[状态管理V1和V2混用指导（API version 19及之后）](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理V1-V2迁移指导/状态管理V1和V2混用场景/状态管理V1和V2混用指导（API version 19及之后）/arkts-v1-v2-mixusage.md>)。
...
该接口可搭配[enableV2Compatibility](js-apis-statemanagement.md#enablev2compatibility19)应用于状态管理V1和V2混用场景，详见[状态管理V1和V2混用指导（API version 19及之后）](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理V1-V2迁移指导/状态管理V1和V2混用场景/状态管理V1和V2混用指导（API version 19及之后）/arkts-v1-v2-mixusage.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | T | 是 | 数据源。支持普通class、Array、Map、Set、Date类型。  不支持[collections](<../../../../ArkTS（方舟编程语言）/ArkTS API/@arkts.collections (ArkTS容器集)/模块描述/arkts-apis-arkts-collections.md>)类型和[@Sendable](../../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/并发线程间通信/线程间通信对象/Sendable对象/Sendable对象简介/arkts-sendable.md)修饰的class。  不支持undefined和null。不支持状态管理V2的数据和[makeObserved](js-apis-statemanagement.md#makeobserved)的返回值。 |
...
创建只读的单向数据绑定实例，用于构建[@Builder](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md>)函数中参数类型为Binding的对应实参。
...
给状态管理V2的状态变量动态添加监听方法，详见[addMonitor/clearMonitor](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/辅助接口/addMonitorclearMonitor接口：动态添加取消监听/arkts-new-addmonitor-clearmonitor.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| target | object | 是 | 目标对象，仅支持[@ComponentV2](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/创建自定义组件/arkts-create-custom-components.md#componentv2>)和[@ObservedV2](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-observedv2-and-trace)实例。  对于不支持的类型，会抛出运行时错误，错误码见表格。 |
...
以下错误码的详细介绍请参见[状态管理错误码](../../../错误码/UI界面/状态管理错误码/errorcode-statemanagement.md)。
...
删除通过[addMonitor](js-apis-statemanagement.md#addmonitor20)给状态管理V2的状态变量添加的监听方法，详见[addMonitor/clearMonitor](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/辅助接口/addMonitorclearMonitor接口：动态添加取消监听/arkts-new-addmonitor-clearmonitor.md>)。
...
同步刷新指定的状态变量，该接口接收一个闭包函数，仅刷新闭包函数内的修改，包括更新[@Computed计算](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-computed)、[@Monitor回调](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-monitor)以及重新渲染UI节点，详见[applySync/flushUpdates/flushUIUpdates接口：同步刷新](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/辅助接口/applySyncflushUpdatesflushUIUpdates接口：同步刷新/arkts-new-applysync-flushupdates-flushuiupdates.md>)。
...
同步刷新在调用该函数之前所有的状态变量修改，包括更新@Computed计算、@Monitor回调以及重新渲染UI节点，详见[applySync/flushUpdates/flushUIUpdates接口：同步刷新](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/辅助接口/applySyncflushUpdatesflushUIUpdates接口：同步刷新/arkts-new-applysync-flushupdates-flushuiupdates.md>)。
...
立即处理在调用该函数之前所有的状态变量修改，同步[标脏](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理原理介绍/arkts-state-management-introduce.md#触发更新>)对应的UI节点，但不会同步执行@Computed计算和@Monitor回调，详见[applySync/flushUpdates/flushUIUpdates接口：同步刷新](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/辅助接口/applySyncflushUpdatesflushUIUpdates接口：同步刷新/arkts-new-applysync-flushupdates-flushuiupdates.md>)。
...
参数为[IMonitor](../../../ArkTS组件/状态管理与渲染控制/状态变量变化监听/ts-state-management-watch-monitor.md#imonitor12)类型的监听回调函数。
