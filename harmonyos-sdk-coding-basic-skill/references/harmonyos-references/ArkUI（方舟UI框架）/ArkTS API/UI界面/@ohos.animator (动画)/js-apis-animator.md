...
scraped_at: 2026-06-11T15:41:31+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:d0cd3cb060273570e4f70b7daf9e88a916ea29b324d9802fe81c02a016cec112
---
...
* 自定义组件中通常会持有一个由[createAnimator](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#createanimator>)接口返回的[AnimatorResult](js-apis-animator.md#animatorresult)对象，以确保动画对象在动画过程中不被析构，该对象通过回调捕获了自定义组件对象，因此需要在自定义组件销毁时的[aboutToDisappear](../../../ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttodisappear)生命周期中释放动画对象，以避免因循环依赖导致内存泄漏。详细示例可参考：[基于ArkTS扩展的声明式开发范式](js-apis-animator.md#基于arkts扩展的声明式开发范式)。
...
* 从API version 9开始支持，从API version 18开始废弃，建议使用[createAnimator](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#createanimator>)替代。
* 从API version 10开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[createAnimator](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#createanimator>)来明确UI的执行上下文。
...
推荐通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[createAnimator](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#createanimator>)接口明确UI上下文。
...
以下错误码的详细介绍请参考[通用错误码](../../../../通用错误码/errorcode-universal.md)和[接口调用异常错误码](../../../错误码/UI界面/接口调用异常错误码/errorcode-internal.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rateRange | [ExpectedFrameRateRange](<../../../ArkTS组件/动画/显式动画 (animateTo)/ts-explicit-animation.md#expectedframeraterange11>) | 是 | 设置期望的帧率范围。 |
...
fill(fillMode: [FillMode](../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#fillmode)): SimpleAnimatorOptions
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fillMode | [FillMode](../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#fillmode) | 是 | 设置animator动画填充方式，影响动画delay期间和结束时的表现。  默认值：FillMode.Forwards |
...
direction(direction: [PlayMode](../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#playmode)): SimpleAnimatorOptions
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| direction | [PlayMode](../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#playmode) | 是 | 设置animator动画播放方向。  默认值：PlayMode.Normal |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/xqRx-b8gTxOye0BeXM4BCg/zh-cn_image_0000002622859303.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074129Z&HW-CC-Expire=86400&HW-CC-Sign=E51B8E3D1905E541E6DA202C562BB80984ABF456876298DEB488222C6045B6C9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/0NnzcaKFS--AEKwuyMNy0Q/zh-cn_image_0000002622699423.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074129Z&HW-CC-Expire=86400&HW-CC-Sign=809F873EEEC6B837C485DB4893DA7E64192EF9231861E8254C746649C9E36055)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/F1Or7vgWSRKct_IytTeVvw/zh-cn_image_0000002592219862.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074129Z&HW-CC-Expire=86400&HW-CC-Sign=DE9C3CBA3E1CCA37549620507AD11C5381533385317B6D523A903C9B02FDCF72)
