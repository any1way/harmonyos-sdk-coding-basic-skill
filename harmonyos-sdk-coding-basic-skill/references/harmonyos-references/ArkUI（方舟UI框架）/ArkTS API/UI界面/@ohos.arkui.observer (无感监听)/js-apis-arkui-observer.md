...
scraped_at: 2026-06-01T15:36:48+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:b6823fd5296ebd8f12c71b76f307914dbe60784f2ddf06332de7fdd19ce66151
---
提供UI组件行为变化的无感监听能力。推荐使用[UIObserver](<../@ohos.arkui.UIContext (UIContext)/Class (UIObserver)/arkts-apis-uicontext-uiobserver.md>)进行组件监听。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| navigationId | [ResourceStr](../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 包含NavDestination组件的Navigation组件的id。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| name | [ResourceStr](../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | NavDestination组件的名称。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| mode15+ | [NavDestinationMode](../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md#navdestinationmode枚举说明11) | 否 | 是 | NavDestination类型。  **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
| uniqueId15+ | number | 否 | 是 | NavDestination组件的uniqueId。  **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
| size23+ | [Size](../arkui/Graphics/js-apis-arkui-graphics.md#size) | 否 | 是 | NavDestination组件的大小，单位是vp。  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。 |
...
| pathStack | [NavPathStack](../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navpathstack10) | 否 | 否 | Navigation组件的导航控制器。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| uniqueId20+ | number | 否 | 是 | Navigation组件的uniqueId，可以通过[queryNavigationInfo](../../../ArkTS组件/自定义组件/自定义组件内置方法/ts-custom-component-api.md#querynavigationinfo12)获取。  **元服务API：** 从API version 20开始，该接口支持在元服务中使用。 |
...
| axis20+ | [Axis](../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#axis) | 否 | 是 | 滚动组件的滚动方向。  **元服务API：** 从API version 20开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [UIAbilityContext](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md>) | [UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 否 | 否 | 触发生命周期的routerPage页面对应的上下文信息。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| size23+ | [Size](../arkui/Graphics/js-apis-arkui-graphics.md#size) | 否 | 是 | routerPage页面的大小，单位是vp。  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 否 | 否 | 屏幕像素密度变化时页面对应的上下文信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | [UIAbilityContext](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md>) | [UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 否 | 否 | 触发页面切换的Navigation对应的上下文信息。 |
| from | [NavDestinationInfo](js-apis-arkui-observer.md#navdestinationinfo) | [NavBar](../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navbar12) | 否 | 否 | 页面切换的源页面。 |
| to | [NavDestinationInfo](js-apis-arkui-observer.md#navdestinationinfo) | [NavBar](../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navbar12) | 否 | 否 | 页面切换的目的页面。 |
| operation | [NavigationOperation](../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md#navigationoperation11枚举说明) | 否 | 否 | 页面切换操作类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| navigationId | [ResourceStr](../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 指定需要监听的Navigation的ID。 |
...
| lastIndex22+ | number | 否 | 是 | 最近一次聚焦的TabsContent组件的下标索引。索引从0开始。仅在[on('tabChange')](<../@ohos.arkui.UIContext (UIContext)/Class (UIObserver)/arkts-apis-uicontext-uiobserver.md#ontabchange22>)的回调函数中存在。  **元服务API：** 从API version 22开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| widthBreakpoint | [WidthBreakpoint](../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#widthbreakpoint13) | 是 | 否 | 窗口宽度所在的布局断点枚举。 |
| heightBreakpoint | [HeightBreakpoint](../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#heightbreakpoint13) | 是 | 否 | 窗口高度所在的布局断点枚举。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听事件，固定为'navDestinationUpdate'，即NavDestination组件的状态变化。 |
| options | { navigationId: [ResourceStr](../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) } | 是 | 指定监听的Navigation的id。 |
| callback | Callback<[NavDestinationInfo](js-apis-arkui-observer.md#navdestinationinfo)> | 是 | 回调函数。返回当前的NavDestination组件状态。 |
...
| context | [UIAbilityContext](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md>) | [UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 是 | 上下文信息，用以指定监听页面的范围。 |
...
| context | [UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 是 | 上下文信息，用以指定监听页面的范围。 |
...
| context | [UIAbilityContext](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/UIAbilityContext/js-apis-inner-application-uiabilitycontext.md>) | [UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 是 | 上下文信息，用以指定监听页面切换事件的范围。 |
...
监听TabContent页面的切换事件。相比[on('tabChange')](<../@ohos.arkui.UIContext (UIContext)/Class (UIObserver)/arkts-apis-uicontext-uiobserver.md#ontabchange22>)，本接口不支持监听Tabs组件初始化时，显示首个页签的事件。
...
监听指定Tabs组件id的TabContent页面切换事件。相比[on('tabChange')](<../@ohos.arkui.UIContext (UIContext)/Class (UIObserver)/arkts-apis-uicontext-uiobserver.md#ontabchange22>)，本接口不支持监听Tabs组件初始化时，显示首个页签的事件。
