...
scraped_at: 2026-06-11T15:41:36+08:00
doc_updated_at: 2026-05-12
content_hash: sha256:bf9ffe934386fca4ab313799ac327c7adbfd0b36a41251bb0d92429336f127b7
---
...
* 从API version 10开始支持，从API version 18开始废弃，建议使用[executeDrag](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md#executedrag11>)替代。executeDrag需先通过[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getDragController](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getdragcontroller11>)方法获取[DragController](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md>)实例，然后通过该对象进行调用。
* 从API version 11开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getDragController](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getdragcontroller11>)方法获取当前UI上下文关联的[DragController](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md>)对象。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| custom | [CustomBuilder](../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | [DragItemInfo](../../../ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragiteminfo) | 是 | 拖拽发起后跟手效果所拖拽的对象。  **说明：**  不支持全局builder。如果builder中使用了[Image](../../../ArkTS组件/图片与视频/Image/ts-basic-components-image.md)组件，应尽量开启同步加载，即配置Image的[syncLoad](../../../ArkTS组件/图片与视频/Image/ts-basic-components-image.md#syncload8)为true。该builder只用于生成当次拖拽中显示的图片。builder的根组件宽高为0时，无法生成拖拽显示的图片导致拖拽失败。builder的修改不会同步到当前正在拖拽的图片，对builder的修改需要在下一次拖拽时生效。 |
| dragInfo | [DragInfo](js-apis-arkui-dragcontroller.md#draginfo) | 是 | 拖拽信息。 |
| callback | [AsyncCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#asynccallback>)<[DragEventParam](js-apis-arkui-dragcontroller.md#drageventparam12)> | 是 | 回调函数。当拖拽成功结束，err为undefined，data为获取到的DragEventParam；否则为错误对象。 |
...
推荐通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getDragController](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getdragcontroller11>)方法获取当前UI上下文关联的DragController对象。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/X57AnsbUQNCdOaDlh71u6w/zh-cn_image_0000002592379798.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074134Z&HW-CC-Expire=86400&HW-CC-Sign=13AB75FB4764FE523C42EA74D2E0E3773778031237364405B946740125742BCE)
...
* 从API version 10开始支持，从API version 18开始废弃，建议使用[executeDrag](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md#executedrag11-1>)替代。executeDrag需先通过[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getDragController](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getdragcontroller11>)方法获取[DragController](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md>)实例，然后通过该对象进行调用。
* 从API version 11开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getDragController](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getdragcontroller11>)方法获取当前UI上下文关联的[DragController](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md>)对象。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| custom | [CustomBuilder](../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | [DragItemInfo](../../../ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragiteminfo) | 是 | 拖拽发起后跟手效果所拖拽的对象。 |
| dragInfo | [DragInfo](js-apis-arkui-dragcontroller.md#draginfo) | 是 | 拖拽信息。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/GW0N-AxxTYi50VUZ07XXqQ/zh-cn_image_0000002622859307.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074134Z&HW-CC-Expire=86400&HW-CC-Sign=4FF4AA868D626DC3AF1C9FB88AA1888B1ADF696B665FD246A16274ECF72E38EB)
...
| data | [unifiedDataChannel.UnifiedData](<../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#unifieddata>) | 否 | 是 | 设置拖拽过程中携带的数据。  默认值：空  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| extraParams | string | 否 | 是 | 设置拖拽事件额外信息，具体功能暂未实现。  默认值：空  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| touchPoint11+ | [TouchPoint](../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#touchpoint11) | 否 | 是 | 配置跟手点坐标。不配置时，左右居中，顶部向下偏移20%。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| previewOptions11+ | [DragPreviewOptions](../../../ArkTS组件/通用属性/交互属性/拖拽控制/ts-universal-attributes-drag-drop.md#dragpreviewoptions11-1) | 否 | 是 | 设置拖拽过程中背板图处理模式及数量角标的显示。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| dataLoadParams20+ | [unifiedDataChannel.DataLoadParams](<../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#dataloadparams20>) | 否 | 是 | 设置拖起方延迟提供数据。调用此方法向系统提供数据加载参数，而非直接传入完整的数据对象。当用户将数据拖拽至目标应用程序并释放时，系统将使用此参数从起拖方请求实际数据。与data同时设置时，dataLoadParams生效。  默认值：空  **元服务API：** 从API version 20开始，该接口支持在元服务中使用。 |
...
* 从API version 11开始支持，从API version 18开始废弃，建议使用[createDragAction](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md#createdragaction11>)替代。createDragAction需先通过[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getDragController](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getdragcontroller11>)方法获取[DragController](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md>)实例，然后通过该对象进行调用。
* 从API version 11开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getDragController](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getdragcontroller11>)方法获取当前UI上下文关联的[DragController](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md>)对象。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| customArray | Array<[CustomBuilder](../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | [DragItemInfo](../../../ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragiteminfo)> | 是 | 拖拽发起后跟手效果所拖拽的对象。 |
| dragInfo | [DragInfo](js-apis-arkui-dragcontroller.md#draginfo) | 是 | 拖拽信息。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/zOQUtsgkQf-Yf85yCqD17A/zh-cn_image_0000002622699427.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074134Z&HW-CC-Expire=86400&HW-CC-Sign=D270D6149A1D71AC384620BD714CCDF21C13785F437AC4BDCD7DCFF4FEA3773A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/VpMhbb7TTEqxRC10kQXfVw/zh-cn_image_0000002592219866.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074134Z&HW-CC-Expire=86400&HW-CC-Sign=925D4F46574FBCC34094243E47788FBDC9D0B75B0E2A56BA8569D581F76BCFDA)
...
| event | [DragEvent](../../../ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragevent7) | 否 | 否 | 当前状态所对应的拖拽事件。通过dragController发起的dragEvent仅支持获取result和behavior，且用于拖拽结束状态。 |
...
| curve | [Curve](../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#curve) | [ICurve](<../@ohos.curves (插值计算)/js-apis-curve.md#icurve9>) | 否 | 是 | 设置动画曲线。  默认值：Curve.EaseInOut |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| event10+ | [DragEvent](../../../ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragevent7) | 否 | 否 | 拖拽事件信息，仅包括拖拽结果。 |
...
* 从API version 11开始支持，从API version 18开始废弃，建议使用[getDragPreview](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md#getdragpreview11>)替代。getDragPreview需先通过[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getDragController](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getdragcontroller11>)方法获取[DragController](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md>)实例，然后通过该对象进行调用。
* 从API version 11开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getDragController](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getdragcontroller11>)方法获取当前UI上下文关联的[DragController](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md>)对象。
...
设置背板蒙版颜色，在OnDrop和OnDragEnd回调中使用不生效，仅支持通过 [getDragPreview()](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md#getdragpreview11>) 方法获取到的对象上使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [ResourceColor](../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 背板蒙版颜色。 |
...
设置背板蒙版颜色变化动效，在OnDrop和OnDragEnd回调中使用不生效，仅支持通过 [getDragPreview()](<../@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md#getdragpreview11>) 方法获取到的对象上使用。
...
2. 在Index.ets中通过this.getUIContext().getSharedLocalStorage()获取UI上下文，进而获取DragController对象实施后续操作。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/0tFSThThRmiGUBJFMRhFqw/zh-cn_image_0000002592379800.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074134Z&HW-CC-Expire=86400&HW-CC-Sign=04B1B271BBDED077FA327E9435A5602A45D15CF5704CD2AE5797DF05FBAC5F93)

## DragStartRequestStatus18+

PhonePC/2in1TabletTVWearable

定义应用是否可以发起拖拽的枚举类型。仅在[onDragStart](../../../ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)调用时有效。
...
定义拖拽的悬停检测配置参数的接口。默认的配置参数通常已能满足需求。可以通过在绑定[onDragSpringLoading](../../../ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragspringloading20)时指定配置，或者通过在BEGIN状态期间使用[updateConfiguration](js-apis-arkui-dragcontroller.md#updateconfiguration20)方法动态修改的方式以自定义该配置参数。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| dataSummary | [unifiedDataChannel.Summary](<../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#summary>) | 否 | 是 | 拖拽数据的摘要，默认为null。 |
...
更新悬停检测的配置，仅在悬停检测状态为BEGIN时生效。应用程序通常在绑定[onDragSpringLoading](../../../ArkTS组件/通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragspringloading20)时设置悬停检测配置或使用默认配置。该方法不会修改绑定时的原始配置，而是在后续悬停检测中更新动态的配置信息。请谨慎使用本方法，因为不同的拖拽数据类型可能需要不同的UX时间。
