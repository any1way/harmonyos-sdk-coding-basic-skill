...
scraped_at: 2026-06-01T15:37:34+08:00
doc_updated_at: 2026-04-10
content_hash: sha256:d32dad2313061f8db79afa7f65140e3f2cfee2d0612b7db772e7cc63451ff632
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| want | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/已停止维护的接口/@ohos.application.Want (Want)/js-apis-application-want.md>) | 否 | 否 | 组件使用方Ability信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| want | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/已停止维护的接口/@ohos.application.Want (Want)/js-apis-application-want.md>) | 否 | 否 | 组件提供方Ability信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/已停止维护的接口/@ohos.application.Want (Want)/js-apis-application-want.md>) | 是 | Push请求发送方相关信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/已停止维护的接口/@ohos.application.Want (Want)/js-apis-application-want.md>) | 是 | request请求发送方相关信息。 |
| name | string | 是 | 模板名称。 |
| data | [KVObject](js-apis-plugincomponent.md#kvobject) | 是 | 数据。 |
