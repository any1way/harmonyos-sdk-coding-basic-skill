...
scraped_at: 2026-06-01T15:37:31+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:152002420a7cfb597aebed88528578bb11103088eebbd86c35f320f79c3bb62b
---
本模块提供注册自定义字体。
...
* 推荐使用字体引擎的[loadFontSync](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#loadfontsync>)接口注册自定义字体。
...
* 从API version 9开始支持，从API version 18开始废弃，建议使用[registerFont](<../@ohos.arkui.UIContext (UIContext)/Class (Font)/arkts-apis-uicontext-font.md#registerfont>)替代。registerFont需要先通过[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getFont](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getfont>)方法获取[Font](<../@ohos.arkui.UIContext (UIContext)/Class (Font)/arkts-apis-uicontext-font.md>)对象，然后通过该对象进行调用。且直接使用registerFont可能导致[UI上下文不明确](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/UI系统场景化能力/使用UI上下文接口操作界面（UIContext）/arkts-global-interface.md#ui上下文不明确>)的问题。
* 从API version 10开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getFont](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getfont>)方法获取当前UI上下文关联的[Font](<../@ohos.arkui.UIContext (UIContext)/Class (Font)/arkts-apis-uicontext-font.md>)对象。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| familyName | string | [Resource](../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#resource)10+ | 否 | 否 | 设置注册的字体名称。 |
| familySrc | string | [Resource](../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#resource)10+ | 否 | 否 | 设置注册字体文件的路径。  **说明：**  读取系统沙箱路径内的资源时，建议使用file://路径前缀的字符串，需要确保沙箱目录路径下的文件存在并且有可读权限。 |

说明

直接使用font可能导致[UI上下文不明确](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/UI系统场景化能力/使用UI上下文接口操作界面（UIContext）/arkts-global-interface.md#ui上下文不明确>)的问题，推荐通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getFont](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getfont>)方法获取当前UI上下文关联的[Font](<../@ohos.arkui.UIContext (UIContext)/Class (Font)/arkts-apis-uicontext-font.md>)对象。
...
应用若需全局使用自定义字体，请在EntryAbility.ets文件的[onWindowStageCreate](<../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md#onwindowstagecreate>)生命周期中，通过[windowStage.loadContent](<../../窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#loadcontent9>)回调注册。

在HSP工程中，不推荐采用相对路径的方式注册自定义字体，详见[通过$r访问HSP中的资源](../../../../../harmonyos-guides/基础入门/开发基础知识/应用程序包基础知识/应用程序包开发与使用/HSP/in-app-hsp.md)。
...
推荐使用[getSystemFontFullNamesByType](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#textgetsystemfontfullnamesbytype14>)接口获取系统最新支持的字体列表数据。

说明

* 从API version 10开始支持，从API version 18开始废弃，建议使用[getSystemFontList](<../@ohos.arkui.UIContext (UIContext)/Class (Font)/arkts-apis-uicontext-font.md#getsystemfontlist>)替代。getSystemFontList需要先通过[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getFont](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getfont>)方法获取[Font](<../@ohos.arkui.UIContext (UIContext)/Class (Font)/arkts-apis-uicontext-font.md>)对象，然后通过该对象进行调用。且直接使用getSystemFontList可能导致[UI上下文不明确](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/UI系统场景化能力/使用UI上下文接口操作界面（UIContext）/arkts-global-interface.md#ui上下文不明确>)的问题。
* 从API version 10开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getFont](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getfont>)方法获取当前UI上下文关联的[Font](<../@ohos.arkui.UIContext (UIContext)/Class (Font)/arkts-apis-uicontext-font.md>)对象。
...
* 从API version 10开始支持，从API version 18开始废弃，建议使用[getFontByName](<../@ohos.arkui.UIContext (UIContext)/Class (Font)/arkts-apis-uicontext-font.md#getfontbyname>)替代。getFontByName需要先通过[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getFont](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getfont>)方法获取[Font](<../@ohos.arkui.UIContext (UIContext)/Class (Font)/arkts-apis-uicontext-font.md>)对象，然后通过该对象进行调用。且直接使用getFontByName可能导致[UI上下文不明确](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/UI系统场景化能力/使用UI上下文接口操作界面（UIContext）/arkts-global-interface.md#ui上下文不明确>)的问题。
* 从API version 10开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getFont](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getfont>)方法获取当前UI上下文关联的[Font](<../@ohos.arkui.UIContext (UIContext)/Class (Font)/arkts-apis-uicontext-font.md>)对象。
...
| weight | number | 否 | 否 | 系统字体的字重。  取值范围：[100,900]，取值间隔为100，分别对应[FontWeight](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#fontweight>)枚举中的值。  默认值：100 |
| width | number | 否 | 否 | 系统字体的宽度。  取值范围：[1,9]，取值间隔为1，分别对应[FontWidth](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#fontwidth>)枚举中的值。 |
...
直接使用font可能导致实例不明确的问题，推荐通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getFont](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getfont>)方法获取当前UI上下文关联的[Font](<../@ohos.arkui.UIContext (UIContext)/Class (Font)/arkts-apis-uicontext-font.md>)对象。
...
该接口仅支持获取配置文件内的信息以及当UI上下文不明确时可能返回undefined，如果想要获取全量的字体配置信息，推荐使用字体引擎的[getSystemFontFullNamesByType](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#textgetsystemfontfullnamesbytype14>)接口。
