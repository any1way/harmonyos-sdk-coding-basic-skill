...
scraped_at: 2026-06-11T15:42:44+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:b4098c9b926c455fc44f5c12a5b52d1736501fe9a41a3105c203db0ce3a2924d
---
提供能够挂载系统组件的自定义节点BuilderNode。BuilderNode仅可作为叶子节点使用。使用方式参考[BuilderNode开发指南](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md>)。最佳实践请参考[组件动态创建-组件动态添加、更新和删除](../../../../../../best-practices/组件封装与复用/组件动态创建/bpta-ui-dynamic-operations.md#section153921947151012)。
...
* 若传入的Builder的根节点为语法节点（[if/else](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ifelse：条件渲染/arkts-rendering-control-ifelse.md>)/[ForEach](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ForEach：循环渲染/arkts-rendering-control-foreach.md>)/[LazyForEach](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md>)/[ContentSlot](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ContentSlot：混合开发/arkts-rendering-control-contentslot.md>)…）、[Span](../../../../ArkTS组件/文本与输入/Span/ts-basic-components-span.md)、[ContainerSpan](../../../../ArkTS组件/文本与输入/ContainerSpan/ts-basic-components-containerspan.md)、[SymbolSpan](../../../../ArkTS组件/文本与输入/SymbolSpan/ts-basic-components-symbolspan.md)或自定义组件，将额外生成一个[FrameNode](../FrameNode/js-apis-arkui-framenode.md)，在节点树中显示为“BuilderProxyNode”，这会导致树结构变化，影响某些测试的传递过程。详情参见[BuilderNode内的BuilderProxyNode导致树结构发生变化](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#buildernode内的builderproxynode导致树结构发生变化>)。
* 如果在跨页面复用BuilderNode时显示异常，可参考[跨页面复用注意事项](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#跨页面复用注意事项>)。
* 当前不支持在预览器中使用BuilderNode。
* BuilderNode下的自定义组件支持使用[@Prop装饰器](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Prop装饰器：父子单向同步/arkts-prop.md>)。不支持使用[@Link装饰器](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Link装饰器：父子双向同步/arkts-link.md>)来跨越BuilderNode同步外界的数据和状态。
* 如果BuilderNode的子节点是自定义组件，不支持该自定义组件使用[@Reusable装饰器](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md>)，详细内容参见[BuilderNode在子自定义组件中使用@Reusable装饰器](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#buildernode在子自定义组件中使用reusable装饰器>)。
* 从API version 12开始，自定义组件支持接收[LocalStorage](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md>)实例。可以通过[传递LocalStorage实例](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md#自定义组件接收localstorage实例>)来使用LocalStorage相关的装饰器[@LocalStorageProp](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md#localstorageprop>)、[@LocalStorageLink](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md#localstoragelink>)。
* 从API version 20开始，通过配置[BuildOptions](js-apis-arkui-buildernode.md#buildoptions12)，内部自定义组件的[@Consume](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Provide装饰器和@Consume装饰器：与后代组件双向同步/arkts-provide-and-consume.md>)支持接收所在页面的[@Provide](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Provide装饰器和@Consume装饰器：与后代组件双向同步/arkts-provide-and-consume.md>)数据。
* 其余装饰器行为未定义，不建议使用。
* 仅支持在自定义组件中使用[Repeat](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/Repeat：可复用的循环渲染/arkts-new-rendering-control-repeat.md>)。
...
* RENDER\_TYPE\_TEXTURE类型目前仅在[BuilderNode](js-apis-arkui-buildernode.md#buildernode-1)持有组件树的根节点为自定义组件时以及[XComponentNode](../../../已停止维护的接口/XComponentNode/js-apis-arkui-xcomponentnode.md)中设置生效。
* 在[BuilderNode](js-apis-arkui-buildernode.md#buildernode-1)的情况下，目前在作为根节点的自定义组件中支持纹理导出的有以下组件：[Badge](../../../../ArkTS组件/信息展示/Badge/ts-container-badge.md)、[Blank](../../../../ArkTS组件/空白与分隔/Blank/ts-basic-components-blank.md)、[Button](../../../../ArkTS组件/按钮与选择/Button/ts-basic-components-button.md)、[CanvasGradient](../../../../ArkTS组件/画布绘制/CanvasGradient/ts-components-canvas-canvasgradient.md)、[CanvasPattern](../../../../ArkTS组件/画布绘制/CanvasPattern/ts-components-canvas-canvaspattern.md)、[CanvasRenderingContext2D](../../../../ArkTS组件/画布绘制/CanvasRenderingContext2D/ts-canvasrenderingcontext2d.md)、[Canvas](../../../../ArkTS组件/画布绘制/Canvas/ts-components-canvas-canvas.md)、[CheckboxGroup](../../../../ArkTS组件/按钮与选择/CheckboxGroup/ts-basic-components-checkboxgroup.md)、[Checkbox](../../../../ArkTS组件/按钮与选择/Checkbox/ts-basic-components-checkbox.md)、[Circle](../../../../ArkTS组件/图形绘制/Circle/ts-drawing-components-circle.md)、[ColumnSplit](../../../../ArkTS组件/栅格与分栏/ColumnSplit/ts-container-columnsplit.md)、[Column](../../../../ArkTS组件/行列与堆叠/Column/ts-container-column.md)、[ContainerSpan](../../../../ArkTS组件/文本与输入/ContainerSpan/ts-basic-components-containerspan.md)、[Counter](../../../../ArkTS组件/信息展示/Counter/ts-container-counter.md)、[DataPanel](../../../../ArkTS组件/信息展示/DataPanel/ts-basic-components-datapanel.md)、[Divider](../../../../ArkTS组件/空白与分隔/Divider/ts-basic-components-divider.md)、[Ellipse](../../../../ArkTS组件/图形绘制/Ellipse/ts-drawing-components-ellipse.md)、[Flex](../../../../ArkTS组件/行列与堆叠/Flex/ts-container-flex.md)、[Gauge](../../../../ArkTS组件/信息展示/Gauge/ts-basic-components-gauge.md)、[Hyperlink](../../../../ArkTS组件/文本与输入/Hyperlink/ts-container-hyperlink.md)、[ImageBitmap](../../../../ArkTS组件/画布绘制/ImageBitmap/ts-components-canvas-imagebitmap.md)、[ImageData](../../../../ArkTS组件/画布绘制/ImageData/ts-components-canvas-imagedata.md)、[Image](../../../../ArkTS组件/图片与视频/Image/ts-basic-components-image.md)、[Line](../../../../ArkTS组件/图形绘制/Line/ts-drawing-components-line.md)、[LoadingProgress](../../../../ArkTS组件/信息展示/LoadingProgress/ts-basic-components-loadingprogress.md)、[Marquee](../../../../ArkTS组件/信息展示/Marquee/ts-basic-components-marquee.md)、[Matrix2D](../../../../ArkTS组件/画布绘制/Matrix2D/ts-components-canvas-matrix2d.md)、[OffscreenCanvasRenderingContext2D](../../../../ArkTS组件/画布绘制/OffscreenCanvasRenderingContext2D/ts-offscreencanvasrenderingcontext2d.md)、[OffscreenCanvas](../../../../ArkTS组件/画布绘制/OffscreenCanvas/ts-components-offscreencanvas.md)、[Path2D](../../../../ArkTS组件/画布绘制/Path2D/ts-components-canvas-path2d.md)、[Path](../../../../ArkTS组件/图形绘制/Path/ts-drawing-components-path.md)、[PatternLock](../../../../ArkTS组件/信息展示/PatternLock/ts-basic-components-patternlock.md)、[Polygon](../../../../ArkTS组件/图形绘制/Polygon/ts-drawing-components-polygon.md)、[Polyline](../../../../ArkTS组件/图形绘制/Polyline/ts-drawing-components-polyline.md)、[Progress](../../../../ArkTS组件/信息展示/Progress/ts-basic-components-progress.md)、[QRCode](../../../../ArkTS组件/信息展示/QRCode/ts-basic-components-qrcode.md)、[Radio](../../../../ArkTS组件/按钮与选择/Radio/ts-basic-components-radio.md)、[Rating](../../../../ArkTS组件/按钮与选择/Rating/ts-basic-components-rating.md)、[Rect](../../../../ArkTS组件/图形绘制/Rect/ts-drawing-components-rect.md)、[RelativeContainer](../../../../ArkTS组件/行列与堆叠/RelativeContainer/ts-container-relativecontainer.md)、[RowSplit](../../../../ArkTS组件/栅格与分栏/RowSplit/ts-container-rowsplit.md)、[Row](../../../../ArkTS组件/行列与堆叠/Row/ts-container-row.md)、[Shape](../../../../ArkTS组件/图形绘制/Shape/ts-drawing-components-shape.md)、[Slider](../../../../ArkTS组件/按钮与选择/Slider/ts-basic-components-slider.md)、[Span](../../../../ArkTS组件/文本与输入/Span/ts-basic-components-span.md)、[Stack](../../../../ArkTS组件/行列与堆叠/Stack/ts-container-stack.md)、[TextArea](../../../../ArkTS组件/文本与输入/TextArea/ts-basic-components-textarea.md)、[TextClock](../../../../ArkTS组件/信息展示/TextClock/ts-basic-components-textclock.md)、[TextInput](../../../../ArkTS组件/文本与输入/TextInput/ts-basic-components-textinput.md)、[TextTimer](../../../../ArkTS组件/信息展示/TextTimer/ts-basic-components-texttimer.md)、[Text](../../../../ArkTS组件/文本与输入/Text/ts-basic-components-text.md)、[Toggle](../../../../ArkTS组件/按钮与选择/Toggle/ts-basic-components-toggle.md)、[Video](../../../../ArkTS组件/图片与视频/Video/ts-media-components-video.md)（不含全屏播放能力）、[Web](<../../../../../ArkWeb（方舟Web）/ArkTS 组件/Web/组件描述/arkts-basic-components-web.md>)、[XComponent](../../../../ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)。
* 从API version 12开始，新增以下组件支持纹理导出：[DatePicker](../../../../ArkTS组件/按钮与选择/DatePicker/ts-basic-components-datepicker.md)、[ForEach](../../../../ArkTS组件/状态管理与渲染控制/ForEach/ts-rendering-control-foreach.md)、[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)、[if/else](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ifelse：条件渲染/arkts-rendering-control-ifelse.md>)、[LazyForEach](../../../../ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)、[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)、[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)、[Swiper](../../../../ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md)、[TimePicker](../../../../ArkTS组件/按钮与选择/TimePicker/ts-basic-components-timepicker.md)、[@Component](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/创建自定义组件/arkts-create-custom-components.md#component>)修饰的自定义组件、[NodeContainer](../../../../ArkTS组件/自定义占位组件/NodeContainer/ts-basic-components-nodecontainer.md)以及[NodeContainer](../../../../ArkTS组件/自定义占位组件/NodeContainer/ts-basic-components-nodecontainer.md)下挂载的[FrameNode](../FrameNode/js-apis-arkui-framenode.md)和[RenderNode](../RenderNode/js-apis-arkui-rendernode.md)。
* 使用方式可参考[同层渲染绘制](../../../../../../harmonyos-guides/应用框架/ArkWeb（方舟Web）/同层渲染/web-same-layer.md)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| selfIdealSize | [Size](../Graphics/js-apis-arkui-graphics.md#size) | 否 | 是 | 节点的理想大小。  默认值：{ width: 0, height: 0 } |
| type | [NodeRenderType](js-apis-arkui-buildernode.md#noderendertype) | 否 | 是 | 节点的渲染类型。  默认值：NodeRenderType.RENDER\_TYPE\_DISPLAY |
| surfaceId | string | 否 | 是 | 纹理接收方的surfaceId。纹理接收方一般为[OH\_NativeImage](<../../../../../ArkGraphics 2D（方舟2D图形服务）/C API/结构体/OH_NativeImage/capi-oh-nativeimage-oh-nativeimage.md>)。  surfaceId仅当type为NodeRenderType.RENDER\_TYPE\_TEXTURE时生效。  默认值："" |
...
| localStorage20+ | [LocalStorage](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理应用拥有的状态/LocalStorage：页面级UI状态存储/arkts-localstorage.md>) | 否 | 是 | 给当前BuilderNode设置LocalStorage，挂载在此BuilderNode下的自定义组件共享该LocalStorage。如果自定义组件构造函数同时也传入LocalStorage，优先使用构造函数中传入的LocalStorage。  默认值：null  **元服务API：** 从API version 20开始，该接口支持在元服务中使用。 |
| enableProvideConsumeCrossing20+ | boolean | 否 | 是 | 定义BuilderNode内[状态管理V1](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理概述/arkts-state-management-overview.md#状态管理v1>)自定义组件的[@Consume](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Provide装饰器和@Consume装饰器：与后代组件双向同步/arkts-provide-and-consume.md>)变量是否与BuilderNode外部的[@Provide](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Provide装饰器和@Consume装饰器：与后代组件双向同步/arkts-provide-and-consume.md>)变量双向同步，BuilderNode内[状态管理V2](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理概述/arkts-state-management-overview.md#状态管理v2>)自定义组件的[@Consumer](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V2）/管理组件拥有的状态/@Provider装饰器和@Consumer装饰器：跨组件层级双向同步/arkts-new-provider-and-consumer.md>)变量是否与BuilderNode外部的[@Provider](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V2）/管理组件拥有的状态/@Provider装饰器和@Consumer装饰器：跨组件层级双向同步/arkts-new-provider-and-consumer.md>)变量双向同步。  从API version 20开始支持状态管理V1自定义组件的双向同步，从API version 23开始支持状态管理V2自定义组件的双向同步。  true表示支持，false表示不支持。  默认值：false  **元服务API：** 从API version 20开始，该接口支持在元服务中使用。 |
...
| 类型 | 说明 |
| --- | --- |
| [TouchEvent](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明) | 触摸事件。 |
| [MouseEvent](../../../../ArkTS组件/通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md#mouseevent对象说明) | 鼠标事件。 |
| [AxisEvent](../../../../ArkTS组件/通用事件/基础输入事件/轴事件/ts-universal-events-axis.md#axisevent) | 轴事件。 |
...
BuilderNode支持通过无状态的UI方法[@Builder](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md>)生成组件树，并持有组件树的根节点。不支持定义为状态变量。BuilderNode中持有的FrameNode仅用于将该BuilderNode作为子节点挂载到其他FrameNode上。对BuilderNode持有的FrameNode进行属性设置与子节点操作可能会产生未定义行为，因此不建议通过BuilderNode的[getFrameNode](js-apis-arkui-buildernode.md#getframenode)方法和[FrameNode](../FrameNode/js-apis-arkui-framenode.md)的[getRenderNode](../FrameNode/js-apis-arkui-framenode.md#getrendernode)方法获取RenderNode，并通过[RenderNode](../RenderNode/js-apis-arkui-rendernode.md)的接口对其进行属性设置与子节点操作。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uiContext | [UIContext](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 是 | UI上下文，获取方式可参考[UIContext获取方法](<../../@ohos.arkui.node (自定义节点)/js-apis-arkui-node.md#uicontext获取方法>)。 |
...
依照传入的对象创建组件树，并持有组件树的根节点。无状态的UI方法[@Builder](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md>)最多拥有一个根节点。
...
* 需要操作BuilderNode中的对象时，需要保证其引用不被回收。当BuilderNode对象被虚拟机回收之后，它的[FrameNode](../FrameNode/js-apis-arkui-framenode.md)、[RenderNode](../RenderNode/js-apis-arkui-rendernode.md)对象也会与后端节点解引用。即从BuilderNode中获取的FrameNode对象不对应任何一个节点。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| builder | [WrappedBuilder<Args>](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/wrapBuilder：封装全局@Builder/arkts-wrapbuilder.md>) | 是 | 创建对应节点树的时候所需的无状态UI方法[@Builder](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md>)。 |
...
* @Builder进行创建和更新的规格参考[@Builder](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md>)。
* 最外层的@Builder只支持一个入参。
...
获取BuilderNode中的[FrameNode](../FrameNode/js-apis-arkui-framenode.md)。在BuilderNode执行build操作之后，才会生成FrameNode。
...
| 类型 | 说明 |
| --- | --- |
| [FrameNode](../FrameNode/js-apis-arkui-framenode.md) | null | 一个FrameNode对象。若该BuilderNode不包含FrameNode，则返回空对象null。 |

**示例1：**

BuilderNode作为[NodeContainer](../../../../ArkTS组件/自定义占位组件/NodeContainer/ts-basic-components-nodecontainer.md)的根节点返回。
...
BuilderNode的[FrameNode](../FrameNode/js-apis-arkui-framenode.md)挂到其它FrameNode下。
...
BuilderNode的[RenderNode](../RenderNode/js-apis-arkui-rendernode.md)挂到其它RenderNode下。由于RenderNode不传递布局约束，不推荐通过该方式挂载节点。
...
根据提供的参数更新BuilderNode，该参数与[build](js-apis-arkui-buildernode.md#build)方法调用时传入的参数类型相同。对自定义组件进行update的时候需要在自定义组件中将使用的变量定义为[@Prop](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@Prop装饰器：父子单向同步/arkts-prop.md>)类型。
...
OffsetA为buildNode相对于父组件的偏移量，可以通过FrameNode中的[getPositionToParent](../FrameNode/js-apis-arkui-framenode.md#getpositiontoparent12)获取。OffsetB为point点相对于buildNode的偏移量，可以通过[TouchEvent](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明) 获取。OffsetC为OffsetA与OffsetB的和，是传给postTouchEvent的最终结果。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/VPPbyhCYSg--d7ftm00SMQ/zh-cn_image_0000002622699455.png?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=07C8DCADFFEAA03B62BDF09DDF8998AF349B8B00E4C7C9CF046A953D76967B55)

说明

* 传入的坐标值需要转换为px，如果builderNode有仿射变换，则需要再叠加仿射变换。
* 在[webview](<../../../../../ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/模块描述/arkts-apis-webview.md>)中，内部已经处理过坐标系变换，可以将TouchEvent事件直接下发。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [TouchEvent](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明) | 是 | 触摸事件。 |
...
立即释放当前BuilderNode对象对[实体节点](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义节点概述/arkts-user-defined-node.md#基本概念>)的引用关系。关于BuilderNode的解绑场景请参见[节点解绑](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#解除实体节点引用关系>)。

说明

当BuilderNode对象调用dispose之后，会与后端实体节点解除引用关系。若前端对象BuilderNode无法释放，容易导致内存泄漏。建议在不再需要对该BuilderNode对象进行操作时，开发者主动调用dispose释放后端节点，以减少引用关系的复杂性，降低内存泄漏的风险。具体场景可见[BuilderNode前后端循环引用导致的内存泄漏问题](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发调试调优/UI开发常见问题/自定义节点常见问题/arkts-user-defined-node-faq.md#buildernode前后端循环引用导致的内存泄漏问题)。
...
触发BuilderNode中的自定义组件的复用。组件复用请参见[@Reusable装饰器：V1组件复用](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md>)。关于BuilderNode的解绑场景请参见[节点解绑](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#解除实体节点引用关系>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | Object | 否 | 用于复用BuilderNode的参数。该参数将直接用于BuilderNode中所有顶层自定义组件的复用，应该包含每个自定义组件的构造函数参数所需内容，否则，会导致未定义行为。调用此方法将同步触发内部自定义组件的[aboutToReuse](../../../../ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoreuse10)生命周期回调，并将该参数作为回调的入参。默认值为undefined，此时BuilderNode中的自定义组件将直接使用构造时的数据源。 |
...
触发BuilderNode中自定义组件的回收。自定义组件的回收是组件复用机制中的环节，具体信息请参见[@Reusable装饰器：V1组件复用](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md>)。

说明

BuilderNode通过reuse和recycle完成其内外自定义组件之间的复用事件传递，具体使用场景请参见[BuilderNode调用reuse和recycle接口实现节点复用能力](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#buildernode调用reuse和recycle接口实现节点复用能力>)。
...
传递系统环境变化事件，触发节点的全量更新。系统环境变化的相关信息请参见[@ohos.app.ability.Configuration (环境变量)](<../../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Configuration (环境变量)/js-apis-app-ability-configuration.md>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/JcAG79DCQp6f6V2G1XFhjw/zh-cn_image_0000002592219894.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=687A9DFD242A31FB66BC7B6440BCCE9E06AC862F6FB69FFFDEF7DBB8BB4EF646)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/CQCqxL4zSoO_n-7dZd9W6A/zh-cn_image_0000002592379828.png?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=C105773F1D0BA08FE147DE4083C8F66277CF81C0C152D4A0D23A25627B0AB2C1)

说明

* 传入的坐标值需要转换为px，坐标转换示例可以参考下面示例代码。
* 鼠标左键点击事件将转换为触摸事件，转发时应注意不在外层同时绑定触摸事件与鼠标事件，否则可能导致坐标偏移。这是由于在事件转换过程中，SourceType不会发生变化，规格可查看[onTouch](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)。
* 注入事件为轴事件[（AxisEvent）](../../../../ArkTS组件/通用事件/基础输入事件/轴事件/ts-universal-events-axis.md#axisevent)时，由于轴事件中缺少旋转轴信息，因此注入的事件无法触发[RotationGesture](../../../../ArkTS组件/手势处理/基础手势/RotationGesture/ts-basic-gestures-rotationgesture.md)。
* 转发的事件会在被分发到的目标组件所在的子树里做touchtest，并触发对应手势，原始事件也会触发当前组件所在组件树中的手势。不保证两类手势的竞争结果。
* 如果是开发者构造的事件，必填字段必须赋值，比如触摸事件的touches字段，轴事件的scrollStep字段。要保证事件的完整，比如触摸事件的[TouchType](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#touchtype)中DOWN和UP字段都要有，防止出现未定义行为。
* [webview](<../../../../../ArkWeb（方舟Web）/ArkTS API/@ohos.web.webview (Webview)/模块描述/arkts-apis-webview.md>)已经处理过坐标系变换，可以将事件直接下发。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/24/v3/kSfr4lK5QmueKGqmQCn0kA/zh-cn_image_0000002592379828.png?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=D14E6FE371BB5D024E2D12E31F42960ABBB633828E4AA60459183077E3B3F831)

说明

* 传入的坐标值单位需要转换为px，坐标转换示例可以参考下面示例代码。
* 系统在处理鼠标左键点击事件时将转换为触摸事件，转发时应注意不在外层同时绑定触摸事件与鼠标事件，否则可能导致坐标偏移。这是由于在事件转换过程中，[TouchType](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#touchtype)不会发生变化，规格可查看[onTouch](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)。
* 注入事件为轴事件[AxisEvent](../../../../ArkTS组件/通用事件/基础输入事件/轴事件/ts-universal-events-axis.md#axisevent)时，由于轴事件中缺少旋转轴信息，因此注入的事件无法触发旋转手势[RotationGesture](../../../../ArkTS组件/手势处理/基础手势/RotationGesture/ts-basic-gestures-rotationgesture.md)。
* 转发的事件会在被分发到的目标组件及其子组件里做事件处理，并触发对应手势。可以通过入参控制当前组件和目标组件手势是否为竞争关系。
* 如果event转化为对应的事件后，该事件为开发者构造的事件，必填字段必须赋值，比如触摸事件的touches字段，轴事件的scrollStep字段。要保证事件的完整，比如触摸事件的[TouchType](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#touchtype)中必须同时包含DOWN和UP两个字段，防止出现程序异常或意外崩溃。
* 支持同一个事件转发多次。
...
| competitionStrategy | [CompetitionStrategy](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#competitionstrategy24) | 否 | 分发事件的手势是否为竞争场景，默认为非竞争。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/AZpbRWrvSsCfD56ZWcz3lg/zh-cn_image_0000002622859337.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=A18FC7328CD968D0D0EAB3615AAEF1022BBAAC9F93309DB4FD9ECC009F830E9F)

## ReactiveBuilderNode22+

PhonePC/2in1TabletTVWearable

ReactiveBuilderNode支持通过无状态的UI方法[@Builder](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md>)生成组件树，并持有该组件树的根节点，不支持定义为状态变量。ReactiveBuilderNode中持有的[FrameNode](../FrameNode/js-apis-arkui-framenode.md)仅用于将此ReactiveBuilderNode作为子节点挂载到其他FrameNode上。对ReactiveBuilderNode持有的FrameNode进行属性设置与子节点操作可能会导致未定义行为，因此不建议通过ReactiveBuilderNode的[getFrameNode](js-apis-arkui-buildernode.md#getframenode)方法和[FrameNode](../FrameNode/js-apis-arkui-framenode.md)节点的[getRenderNode](../FrameNode/js-apis-arkui-framenode.md#getrendernode)方法获取RenderNode，并通过[RenderNode](../RenderNode/js-apis-arkui-rendernode.md)的接口对其进行属性设置与子节点操作。
...
用于构造ReactiveBuilderNode类。当将ReactiveBuilderNode生成的内容嵌入到其它[RenderNode](../RenderNode/js-apis-arkui-rendernode.md)中显示时，需要显式指定[RenderOptions](js-apis-arkui-buildernode.md#renderoptions)中的[selfIdealSize](js-apis-arkui-buildernode.md#renderoptions)，否则ReactiveBuilderNode内的节点默认父组件布局约束为[0, 0]。调用此接口，若不设置selfIdealSize则认为ReactiveBuilderNode中子树的根节点大小为[0, 0]。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uiContext | [UIContext](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 是 | UI上下文，获取方式可参考[UIContext获取方法](<../../@ohos.arkui.node (自定义节点)/js-apis-arkui-node.md#uicontext获取方法>)。uiContext需要为一个有效的值，即UI上下文正确，如果传入非法值或者未设置，会导致创建失败。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| builder | [WrappedBuilder<Args>](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/wrapBuilder：封装全局@Builder/arkts-wrapbuilder.md>) | 是 | 创建对应节点树时所需的无状态UI方法[@Builder](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md>)。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/5nIQ1-PsQTCBndTGuS0LHw/zh-cn_image_0000002622699457.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=66CD2628120CE6BD9F4306FE09FC0CB42AA9AA45858FD4F559BC9D2F09B25E4D)
...
获取ReactiveBuilderNode中的[FrameNode](../FrameNode/js-apis-arkui-framenode.md)。在ReactiveBuilderNode执行build操作之后，才会生成FrameNode。
...
| 类型 | 说明 |
| --- | --- |
| [FrameNode](../FrameNode/js-apis-arkui-framenode.md) | null | FrameNode对象。若该ReactiveBuilderNode不包含FrameNode，则返回空对象null。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/DiLWNA_aTQ-xKuykpcJglg/zh-cn_image_0000002592219896.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=35ABEA16E6FF2F5B7B4312B1A813A26C9E585DE145E86A6CA6F062E78675BCE7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/HZ_-q1z1SNmuUMNdzvpi9Q/zh-cn_image_0000002622699455.png?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=94473D470986D5473E8DE53E0F9444A730031BF1BFC795371DF1DD7715FE7890)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/fBxvxLLPTg6Q7QZ-ES2KgQ/zh-cn_image_0000002592379830.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=8C97E31700A4A3F63B607648E4BF5618E514F2D4E4A804DFC7D823639698CF9E)
...
立即释放当前ReactiveBuilderNode对象对[实体节点](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义节点概述/arkts-user-defined-node.md#基本概念>)的引用关系。关于ReactiveBuilderNode的解绑场景请参见[节点解绑](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#解除实体节点引用关系>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/kIVFFeKSTySQ_Xswnb6B1A/zh-cn_image_0000002622859339.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=B09A45E247643B527D0EF34D6B68A8047D825E578908B8071774463E7AADF0E2)
...
触发ReactiveBuilderNode中的自定义组件的复用。组件复用请参见[@Reusable装饰器：V1组件复用](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md>)。关于ReactiveBuilderNode的解绑场景请参见[节点解绑](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#解除实体节点引用关系>)。

ReactiveBuilderNode通过reuse和[recycle](js-apis-arkui-buildernode.md#recycle22)完成其内外自定义组件之间的复用事件传递，具体使用场景请参见[BuilderNode调用reuse和recycle接口实现节点复用能力](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#buildernode调用reuse和recycle接口实现节点复用能力>)。
...
触发ReactiveBuilderNode中自定义组件的回收。自定义组件的回收是组件复用机制中的环节，具体信息请参见[@Reusable装饰器：V1组件复用](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md>)。

ReactiveBuilderNode通过[reuse](js-apis-arkui-buildernode.md#reuse22)和recycle完成其内外自定义组件之间的复用事件传递，具体使用场景请参见[BuilderNode调用reuse和recycle接口实现节点复用能力](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#buildernode调用reuse和recycle接口实现节点复用能力>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/JkRZD5oKToaWXj-ykn-Afw/zh-cn_image_0000002622699459.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=7DC81D639589AAF94432799435F55BA7C14669838E8AB963B3D4C191C8D98028)
...
传递系统环境变化事件，触发节点的全量更新。可用于通知对象更新，是否更新所使用的系统环境由应用当前的系统环境变化决定。系统环境变化的相关信息请参见[@ohos.app.ability.Configuration (环境变量)](<../../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Configuration (环境变量)/js-apis-app-ability-configuration.md>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bf/v3/VIt3a_n2T-CRNpz0XAHurg/zh-cn_image_0000002592219898.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=662DA472734B3A05ED25BBD67BDCF758AE85CAD98AD18156E21AFFEA6B9FFF38)
...
根据提供的参数更新ReactiveBuilderNode。当ReactiveBuilderNode中[WrappedBuilder](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/wrapBuilder：封装全局@Builder/arkts-wrapbuilder.md>)对象封装的builder函数中使用的绑定参数是由V1装饰器（如@Observed）装饰的类实例时，需要在此类数据变更后手动调用此方法以更新数据，当使用V2装饰器（如@ObservedV2）装饰的类实例时，支持自动更新，无需手动调用。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/7mWESzw2QmKAbfoelHwKGA/zh-cn_image_0000002592379832.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=2DFBC23C2E67E906D97179CB1658DAFAB4D43219BFB2F7E732ABD29B56A24C4C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/RJdU4y0xTVeRn5e0SN6EdA/zh-cn_image_0000002622699455.png?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=DA97C64BB35DC8D0A51F7D30CC18C9F21D8CF76DAEB8B00CE870C0F70561F8FD)

说明

传入的坐标值需要转换为px，坐标转换示例可以参考下面示例代码。

鼠标左键点击事件将转换为触摸事件，转发时应注意不在外层且绑定触摸事件与鼠标事件，否则可能导致坐标偏移。这是由于在事件转换过程中，事件的[SourceType](../../../../ArkTS组件/手势处理/绑定手势/绑定手势事件/ts-gesture-settings.md#sourcetype枚举说明8)不会发生变化，规格可查看[onTouch](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)。

注入事件为轴事件[（AxisEvent）](../../../../ArkTS组件/通用事件/基础输入事件/轴事件/ts-universal-events-axis.md#axisevent)时，由于轴事件中缺少旋转轴信息，因此注入的事件无法触发[RotationGesture](../../../../ArkTS组件/手势处理/基础手势/RotationGesture/ts-basic-gestures-rotationgesture.md)。

转发的事件会在被分发到的目标组件所在的子树里做触摸测试（TouchTest），并触发对应手势，原始事件也会触发当前组件所在组件树中的手势。不保证两类手势的竞争结果。

如果是开发者构造的事件，必填字段必须赋值，比如触摸事件的touches字段、轴事件的scrollStep字段，同时要保证事件的完整，比如触摸事件的[TouchType](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#touchtype)中DOWN和UP字段都要有，防止出现未定义行为。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/RZzqK_UQT0uBpS02f2JemA/zh-cn_image_0000002592379828.png?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=D1E5D486E52082B753926F78B3EFC1EEEC46B30CB5E65C0390EAA5C80F554253)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/x4UWUZ5HRkerX1IqO7j0ew/zh-cn_image_0000002622859341.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=37226990A04FE444770DE866EC6296E453ABBD8A789856B598E42DDE77F565F5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/a8DH_h0LTRmuuvIYZY1M4g/zh-cn_image_0000002622699461.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=A6C2D419245AEA54C32E60C3D987EF2ED655CF35B6BA7E2F5104787165DAC44F)
...
该示例演示了在自定义组件中截获鼠标事件并进行坐标转换的完整流程。组件通过[onMouse](../../../../ArkTS组件/通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md#onmouse)回调读取本地x/y，再结合FrameNode.[getPositionToParent](../FrameNode/js-apis-arkui-framenode.md#getpositiontoparent12)()得到的偏移量，调用vp2px将相对坐标转换为像素坐标，更新[MouseEvent](../../../../ArkTS组件/通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md#mouseevent对象说明)的windowX/windowY、displayX/displayY。最后通过rootNode.[postInputEvent](js-apis-arkui-buildernode.md#postinputevent20)(event)将转换后的鼠标事件分发给子节点进行处理。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/xgWHjJxETqWXIRSVZmt9KQ/zh-cn_image_0000002592219900.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=09E1328400413DF1F7CB484793F023F4064A5A24DE59EBFB8C3FF06D55B11E53)

### 示例2（BuilderNode中触摸事件）

该示例演示了在自定义组件中截获触摸事件并对触点坐标进行转换的完整流程。在[onTouch](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)回调中，遍历[TouchEvent](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明)的changedTouches和touches数组，对每个触点的x/y加上组件偏移量并调用vp2px转换为像素，更新各自的windowX/windowY、displayX/displayY。最后同样通过rootNode.postInputEvent(event)将转换后的触摸事件分发给子节点处理。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/eqbknGuvRoKCM6yAtt9mGA/zh-cn_image_0000002592379834.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=962EAB8970ECCAD095D74AA389D0D2DC8EAA6FAFF6F65CA160CC9E4CD9D4A9F1)

### 示例3（BuilderNode中轴事件）

该示例演示了在自定义组件中截获滚轮或触控板轴事件并进行坐标转换的完整流程。在[onAxisEvent](../../../../ArkTS组件/通用事件/基础输入事件/轴事件/ts-universal-events-axis.md#onaxisevent)回调中，先获取事件的相对x/y，再加上组件偏移量后调用vp2px转换为像素，更新AxisEvent的windowX/windowY、displayX/displayY，最后通过rootNode.postInputEvent(event)将转换后的轴事件分发给子节点进行处理。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/WRnHZiYTQjmKhgCjPUL1Vg/zh-cn_image_0000002622859343.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=BBFE4C2F519F2F99F52FBE9006BB768CCE3590390611DE9B17C871BBCD3D98C3)

### 示例4（BuilderNode共享localStorage）

该示例演示了如何在BuilderNode通过build方法传入外部[localStorage](../../../../ArkTS组件/状态管理与渲染控制/应用级变量的状态管理/ts-state-management.md#localstorage9)，此时挂载在BuilderNode的所有自定义组件共享该localStorage。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/H00rRVR4RAuYBmcLcZdF7A/zh-cn_image_0000002622699463.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=389584685328EE26A2421A0D9DE02A61B35FD08E3FFCE49AFE52CA721DEAF676)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/uqXxzoweSziRS21ocNkSOA/zh-cn_image_0000002592219902.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=EBF4EBD8AEFFB68A9148CB45862CD53960182D1DED507DE5C29E20F49BD211C7)
...
该示例演示了在自定义组件中截获鼠标事件并进行坐标转换的完整流程。组件通过[onMouse](../../../../ArkTS组件/通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md#onmouse)回调读取本地x/y坐标，再结合FrameNode.[getPositionToParent](../FrameNode/js-apis-arkui-framenode.md#getpositiontoparent12)()得到的偏移量，调用[vp2px](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#vp2px12>)将相对坐标转换为像素坐标，更新[MouseEvent](../../../../ArkTS组件/通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md#mouseevent对象说明)的windowX/windowY、displayX/displayY。最后通过rootNode.[postInputEvent](js-apis-arkui-buildernode.md#postinputevent20)将转换后的鼠标事件分发给子节点进行处理。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/Ncrk1pFCTkqVOdmCtCTYRg/zh-cn_image_0000002592379836.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=228AF640DEE12FEF3BF0F998631A35585AF0B1344D5481374BB6E6CC4BBD2E9C)

### 示例14（ReactiveBuilderNode中触摸事件）

从API version 22版本开始支持。

该示例演示了在自定义组件中截获触摸事件并对触点坐标进行转换的完整流程。在[onTouch](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)回调中，遍历[TouchEvent](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明)的changedTouches和touches数组，对每个触点的x/y坐标加上组件偏移量并调用[vp2px](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#vp2px12>)转换为像素，更新各自的windowX/windowY、displayX/displayY。最后同样通过rootNode.[postInputEvent](js-apis-arkui-buildernode.md#postinputevent20)将转换后的触摸事件分发给子节点处理。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/f0pSkoJqTZasZef_458cDA/zh-cn_image_0000002622859345.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=5971A3F94F9401C158BA3EEC20637219520B3F66B60E5FCD3EBA48B48B71B4BD)

### 示例15（ReactiveBuilderNode中轴事件）

从API version 22版本开始支持。

该示例演示了在自定义组件中截获滚轮或触控板轴事件并进行坐标转换的完整流程。在[onAxisEvent](../../../../ArkTS组件/通用事件/基础输入事件/轴事件/ts-universal-events-axis.md#onaxisevent)回调中，先获取事件的相对x/y坐标，再加上组件偏移量后调用[vp2px](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#vp2px12>)转换为像素，更新AxisEvent的windowX/windowY、displayX/displayY，最后通过rootNode.[postInputEvent](js-apis-arkui-buildernode.md#postinputevent20)将转换后的轴事件分发给子节点进行处理。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/ml8jI0CeRDasoYp1BrDXiQ/zh-cn_image_0000002622699465.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=45382E47C08E3B3C42C68DDF73622EAD723433CED51F00211D2FC5FF306A30E6)

### 示例16（BuilderNode中带竞争策略的鼠标事件）

从API version 24开始，新增postInputEventWithStrategy接口。

该示例演示了在自定义组件中截获鼠标事件并进行坐标转换的完整流程。组件通过[onMouse](../../../../ArkTS组件/通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md#onmouse)回调读取当前触点坐标x/y，再结合FrameNode.[getPositionToParent](../FrameNode/js-apis-arkui-framenode.md#getpositiontoparent12)得到的偏移量，调用[vp2px](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#vp2px12>)将相对坐标转换为像素坐标，更新[MouseEvent](../../../../ArkTS组件/通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md#mouseevent对象说明)的windowX/windowY、displayX/displayY。选择不同的手势竞争策略[CompetitionStrategy](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#competitionstrategy24)，最后通过rootNode.[postInputEventWithStrategy](js-apis-arkui-buildernode.md#postinputeventwithstrategy24)将转换后的鼠标事件分发给子节点进行处理。
...
该示例演示了在自定义组件中截获触摸事件并对触点坐标进行转换的完整流程。在[onTouch](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#ontouch)回调中，遍历[TouchEvent](../../../../ArkTS组件/通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明)的changedTouches和touches数组，对每个触点的x/y加上组件偏移量并调用[vp2px](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#vp2px12>)转换为像素，更新每个触点的windowX/windowY、displayX/displayY。选择不同的手势竞争策略[CompetitionStrategy](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#competitionstrategy24)，最后同样通过rootNode.[postInputEventWithStrategy](js-apis-arkui-buildernode.md#postinputeventwithstrategy24)将转换后的触摸事件分发给子节点处理。
...
该示例演示了在自定义组件中截获滚轮或触控板轴事件并进行坐标转换的完整流程。在[onAxisEvent](../../../../ArkTS组件/通用事件/基础输入事件/轴事件/ts-universal-events-axis.md#onaxisevent)回调中，先获取事件的相对x/y，再加上组件偏移量后调用[vp2px](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#vp2px12>)转换为像素，更新AxisEvent的windowX/windowY、displayX/displayY，选择不同的手势竞争策略[CompetitionStrategy](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#competitionstrategy24)，最后通过rootNode.[postInputEventWithStrategy](js-apis-arkui-buildernode.md#postinputeventwithstrategy24)将转换后的轴事件分发给子节点进行处理。
