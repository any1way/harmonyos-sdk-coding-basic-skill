...
scraped_at: 2026-06-11T15:42:52+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:4acfcb9c796493022312e2712e9380e3a6b1cdaf5770deb1e2e2f68c8d34b48e
---
自定义节点相关属性定义的详细信息。
...
| 类型 | 说明 |
| --- | --- |
| [drawing.Canvas](<../../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Class (Canvas)/arkts-apis-graphics-drawing-canvas.md>) | 用于绘制的画布。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/koURmKw7Stm3sYxXPJtYlQ/zh-cn_image_0000002592379846.png?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=7000D9DF6B6868BBD5A61883018FB79A050B2D1B418416CB3DE34CFF791F0208)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/dweVPNaCRledpzlzvr0YCg/zh-cn_image_0000002622859355.png?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=4ED8A50D31AB81FA9DD452E058B2E7CBCD04D3F82B05B857DC77590B19FE2160)
...
使用[ColorSpace](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#colorspace20)和rgba格式颜色实例化ColorMetrics类。仅部分属性支持在display-p3色彩空间中设置颜色。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| colorSpace | [ColorSpace](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#colorspace20) | 是 | 颜色空间，用于指定颜色的色彩空间。使用ColorSpace.DISPLAY\_P3，需要对应窗口调用[setWindowColorSpace](<../../../窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setwindowcolorspace9-1>)接口，将当前窗口设置为广色域模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [ResourceColor](../../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 资源格式颜色。 |
...
以下错误码的详细介绍请参见[通用错误码](../../../../../通用错误码/errorcode-universal.md)和[系统资源错误码](../../../../错误码/UI界面/系统资源错误码/errorcode-system-resource.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/YmdI-1WwR3KoRpoKh5a-WA/zh-cn_image_0000002622699475.png?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=01405C91A25273E62625A8EEA26CB6F23710E9542689AF5875ADA0C8913D6842)
...
| 类型 | 说明 |
| --- | --- |
| [common2D.Rect](<../../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.common2D (2D图形通用数据类型)/js-apis-graphics-common2d.md#rect>) | 矩形区域。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| [commands](../../../../ArkTS组件/图形绘制/Path/ts-drawing-components-path.md#commands) | string | 否 | 否 | 路径绘制的指令字符串。像素单位的转换方法请参考[像素单位](../../../../ArkTS组件/公共定义/像素单位/ts-pixel-units.md)。  单位：px |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fillColor | number | 否 | 否 | 遮罩的填充颜色，使用ARGB格式。默认值为0XFF000000。  通过fillColor的透明度和亮度生成一个仅含透明度的颜色。亮度越高，颜色越透明。然后，使用[BlendMode.SRC\_IN](<../../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Enums/arkts-apis-graphics-drawing-e.md#blendmode>)方式与RenderNode本身的颜色混合，生成最终颜色。 |
| strokeColor | number | 否 | 否 | 遮罩的边框颜色，使用ARGB格式。默认值为0XFF000000。  通过strokeColor的透明度和亮度生成一个仅含透明度的颜色。亮度越高，颜色越透明。然后，使用[BlendMode.SRC\_IN](<../../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/Enums/arkts-apis-graphics-drawing-e.md#blendmode>)方式与RenderNode本身的颜色混合，生成最终颜色。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/FCxxuY3UR1i4Ef2cRcn7zA/zh-cn_image_0000002592219914.png?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=6F006321ADDCC45FF37DB587E78AA11D5877CEA013534F21C128269A3E64D40C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/XXyqYNXtSKKENsaPe01eDA/zh-cn_image_0000002592379848.png?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=178ADA0AA12B6013CB23CE8ED730981F019658D6027ECF24EA5178858BA727C9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/UZVaJbqyTZy7miBjDT9FwQ/zh-cn_image_0000002622859357.png?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=D20696BD7C3CB7B1B5B9F5E48ECBEF2ECFBA2FC36C0B42691897A3F59F31D8D3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/gFIVCXTdSVuLjl8v_MkZJw/zh-cn_image_0000002622699477.png?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=1DA8253B40C64748DCCF863CC790C3F861D90AF11E1E13B00FD8AF3D1DAEF244)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/44/v3/GIS7J3VyS9ySA9DFX63Y3g/zh-cn_image_0000002592219916.png?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=BB2962AA5531411638A5260CC520ADAF17188BE93B3E0139720A2C3EB94FB1A4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/zwFxSJH9TMS-e3u7Hx_WdQ/zh-cn_image_0000002592379850.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=624243083BCCE0DB8242E4B829A09243EF24D66566DEC56D8EEB83B766DE5C7A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/46/v3/S-hzDQNFRlqtdIN6O6T3LQ/zh-cn_image_0000002622859359.png?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=4E13DF7730EA9695654CA3E4EB1AD8E31687FA3B9C450AF817E867F1474F8337)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/GktPgPyuTK-ga59AL3gnRw/zh-cn_image_0000002622699479.png?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=E7B51BD9DFEDEDB68C4864ABA3018FC8E905BB58D04FBE45A4B0A3A4F8D4CC3B)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| all | [BorderStyle](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#borderstyle) | 是 | 边框样式。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Edges](js-apis-arkui-graphics.md#edgest12)<[BorderStyle](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#borderstyle)> | 边框样式均设置为传入值的边框样式对象。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/AcoUAiTGR3--nH5A_ZcuVg/zh-cn_image_0000002592219918.png?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=90715E9C5EDB1B5C594E4F16187C6A44F1AAED062B7D4B2590284960AAA2BB90)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/U9bGqOO0TLKo33HsAYVkCA/zh-cn_image_0000002592379852.png?HW-CC-KV=V1&HW-CC-Date=20260611T074245Z&HW-CC-Expire=86400&HW-CC-Sign=A02E74656F4E08F89ECF865BAD797F13EE8BCDE6501961E32EECC18E099D8AA8)
