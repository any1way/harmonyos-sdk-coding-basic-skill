...
scraped_at: 2026-06-11T15:42:40+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:eb0cb08d944debda27be5609f9d2cab70dbd6960030b43e3fc4e12d5c44bbe48
---
有两种创建实体封装组件的方式。开发者在开发过程中任选下面方式其一即可。

ComponentContent表示组件内容的实体封装，其对象支持在非UI组件中创建与传递，便于开发者对弹窗类组件进行解耦封装。其底层使用了BuilderNode，具体使用规格参考[BuilderNode](../BuilderNode/js-apis-arkui-buildernode.md)。

ReactiveComponentContent表示组件内容的实体封装，其对象支持在非UI组件中创建与传递，便于开发者对弹窗类组件进行解耦封装。其底层使用了ReactiveBuilderNode，具体使用规格参考[ReactiveBuilderNode](../BuilderNode/js-apis-arkui-buildernode.md#reactivebuildernode22)。
...
继承自[Content](../Content/js-apis-arkui-content.md#content-1)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uiContext | [UIContext](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 是 | 创建对应节点时所需要的UI上下文。 |
...
| builder | [WrappedBuilder<[T]>](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-wrapbuilder) | 是 | 封装带参builder函数的WrappedBuilder对象。 |
| args | T | 是 | WrappedBuilder对象封装的builder函数的参数。 |
| options | [BuildOptions](../BuilderNode/js-apis-arkui-buildernode.md#buildoptions12) | 是 | build的配置参数，判断是否支持@Builder中嵌套@Builder的行为。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/I_EnbMNATh6mqyWxin-R7A/zh-cn_image_0000002592219904.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=88753D0161824C209E27F5D948302729171CD34C3B4594282EC8679DD83C9690)
...
用于更新[WrappedBuilder](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/wrapBuilder：封装全局@Builder/arkts-wrapbuilder.md>)对象封装的builder函数参数，与constructor传入的参数类型保持一致。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| args | T | 是 | 用于更新[WrappedBuilder](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/wrapBuilder：封装全局@Builder/arkts-wrapbuilder.md>)对象封装的builder函数参数，与constructor传入的参数类型保持一致。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/dC2ymvTqR220VJs_uoNrpw/zh-cn_image_0000002592379838.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=7C13C74AABA8F112E516AB9D258738145D100C0311E3C577B7C403F213CFD148)
...
触发ComponentContent中的自定义组件的复用。组件复用请参见[@Reusable装饰器：V1组件复用](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md>)。关于ComponentContent的解绑场景请参见[解除实体节点引用关系](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#解除实体节点引用关系>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | Object | 否 | 用于复用ComponentContent的参数。该参数将直接用于ComponentContent中所有顶层自定义组件的复用，应该包含每个自定义组件的构造函数参数所需内容，否则会导致未定义行为。调用此方法将同步触发内部自定义组件的[aboutToReuse](../../../../ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoreuse10)生命周期回调，并将该参数作为回调的入参。默认值为undefined，此时ComponentContent中的自定义组件将直接使用构造时的数据源。 |
...
* 触发ComponentContent中自定义组件的回收。自定义组件的回收是组件复用机制中的环节，具体信息请参见[@Reusable装饰器：V1组件复用](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md>)。
* ComponentContent通过reuse和recycle完成其内外自定义组件之间的复用事件传递，具体使用场景请参见[BuilderNode调用reuse和recycle接口实现节点复用能力](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#buildernode调用reuse和recycle接口实现节点复用能力>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/sq2FEXLhQo6yL1DHNk2OiA/zh-cn_image_0000002622859347.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=DF1D2E5D42E3C2BB638B2E46ED6B30071A15A6818286203294D11A991EB9E2FF)
...
立即释放当前ComponentContent对象对[基本概念：实体节点](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义节点概述/arkts-user-defined-node.md#基本概念>)的引用关系。关于ComponentContent的解绑场景请参见[解除实体节点引用关系](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#解除实体节点引用关系>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/ZeQxZWpgQ6-DRK52QuJivg/zh-cn_image_0000002622699467.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=2DF593AC3A11FA6AC34CF393CF4DA6863B66828D33B3FA9969F339006AA1C60D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/qcucM44kQ_iap17VbykXOA/zh-cn_image_0000002592219906.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=A0B69C9931FBEA53949B6D85239D21EAF4369901E808BD5AD2FE856598AB5DD7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/ppa3ZVX4Qsic62vpg5_amw/zh-cn_image_0000002592379840.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=171F31367D44A51629FFC30B85E78E408C80E6DB93C3C3D9B7A38510A99CC7CB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/7JXOedfbTFqDjMjdmOAB8w/zh-cn_image_0000002622859349.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=F71B5A57CC327F35B9A2D634DE23D5FFEAB25C9AA546F7E99422562B7BA33607)

## ReactiveComponentContent22+

PhonePC/2in1TabletTVWearable

ReactiveComponentContent继承自[Content](../Content/js-apis-arkui-content.md#content-1)，是一个用于动态承载和复用UI内容的容器组件。它通过@Builder函数构建UI，并利用[ReactiveBuilderNode](../BuilderNode/js-apis-arkui-buildernode.md#reactivebuildernode22)生成和管理组件树。该组件的核心价值在于为动态内容提供完整的生命周期管理，使其能够融入ArkUI的组件复用体系，特别适用于长列表等需要高性能渲染的场景。
...
| builder | [WrappedBuilder<T>](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/wrapBuilder：封装全局@Builder/arkts-wrapbuilder.md>) | 是 | 封装带参@Builder函数的WrappedBuilder对象。 |
| config | [BuildOptions](../BuilderNode/js-apis-arkui-buildernode.md#buildoptions12) | 是 | 作用是配置Builder的构建行为，BuildOptions中所有属性都是可选的，默认值为BuildOptions中对应的默认值。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2/v3/MhUTSQbzTi2JOB1HpLwMXA/zh-cn_image_0000002592219904.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=C59D60CBDFE8C86810632C0D58DBE0F0E7EEF8B2CBA50953EFFD774817DF6E34)
...
触发ReactiveComponentContent中的自定义组件的复用。组件复用请参见[@Reusable装饰器：V1组件复用](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md>)。关于ReactiveComponentContent的解绑场景请参见[解除实体节点引用关系](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#解除实体节点引用关系>)。

ReactiveComponentContent通过reuse和[recycle](js-apis-arkui-componentcontent.md#recycle)接口完成其内外自定义组件之间的复用事件传递，具体使用场景请参见[BuilderNode调用reuse和recycle接口实现节点复用能力](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#buildernode调用reuse和recycle接口实现节点复用能力>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | Object | 否 | 用于复用[ReactiveComponentContent](js-apis-arkui-componentcontent.md#reactivecomponentcontent22)的参数。该参数将直接用于ReactiveComponentContent中所有顶层自定义组件的复用，应该包含每个自定义组件的构造函数参数所需内容，否则会导致未定义行为。调用此方法将同步触发内部自定义组件的[aboutToReuse](../../../../ArkTS组件/自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoreuse10)生命周期回调，并将该参数作为回调的入参。默认值为undefined，此时ReactiveComponentContent中的自定义组件将直接使用构造时的数据源。 |
...
触发ReactiveComponentContent中自定义组件的回收。自定义组件的回收是组件复用机制中的环节，具体信息请参见[@Reusable装饰器：V1组件复用](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件复用/@Reusable装饰器：V1组件复用/arkts-reusable.md>)。

ReactiveComponentContent通过[reuse](js-apis-arkui-componentcontent.md#reuse)和recycle完成其内外自定义组件之间的复用事件传递，具体使用场景请参见[BuilderNode调用reuse和recycle接口实现节点复用能力](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#buildernode调用reuse和recycle接口实现节点复用能力>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/HnxIy2y-RHW9gYRRR__UwQ/zh-cn_image_0000002622859347.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=A793ADD8BFD0DAE370DC2ACA7BEA98CBAF5B06CEBEDC845EF68D86139A098571)
...
立即释放当前ReactiveComponentContent对象对[实体节点](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义节点概述/arkts-user-defined-node.md#基本概念>)的引用关系。关于ReactiveComponentContent的解绑场景请参见[解除实体节点引用关系](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义声明式节点 (BuilderNode)/arkts-user-defined-arktsnode-buildernode.md#解除实体节点引用关系>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/DKS52lROTOWBVnD5kZRM-g/zh-cn_image_0000002622699469.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=34852C74EB4458C2C6168BA189551DCA7447F7CDC1B500528DBDC216E0AAB1D6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/9-F8-6JgS3ehCsH1MEW6IQ/zh-cn_image_0000002592219906.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=C6EAF58783BFEA3FE9A6EF3DF4977FFA0B93A28BCF737522E2A28A2FF24488A1)
...
更新ReactiveComponentContent。当ReactiveComponentContent中[WrappedBuilder](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/wrapBuilder：封装全局@Builder/arkts-wrapbuilder.md>)对象封装的builder函数中使用的绑定参数是由V1装饰器（如@Observed）装饰的类实例时，需要在此类数据变更后手动调用本接口更新数据，当使用V2装饰器（如@ObservedV2）装饰的类实例时，支持自动更新，无需手动调用。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/T7c8qjkIR2GbcqYXth3G7Q/zh-cn_image_0000002592219908.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=4C5BE6FDFA4823DFA74A13A227B703C1EDDAD002FE489645200CB4BA368B94DC)
...
设置当前ReactiveComponentContent对象是否继承父组件中自定义组件的冻结策略[ComponentOptions](../../../../ArkTS组件/自定义组件/自定义组件参数/ts-custom-component-parameter.md#componentoptions)。如果设置继承状态为false，则ReactiveComponentContent对象的冻结策略为false。在这种情况下，节点在不活跃状态下不会被冻结。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/qLEkeH8eSfm0FrnG9dGxEw/zh-cn_image_0000002592379842.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=95D618497279FC61AF26922608EE78EFA7918707CA71206005049817482F0C38)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/xCZ5hZW2REiG_X4VtUtbRg/zh-cn_image_0000002622859351.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074237Z&HW-CC-Expire=86400&HW-CC-Sign=4E30663B6FA2B7749FC2038F4BF9DC7ECAC3033A837EE1EC5E5A86DAA395C00D)
