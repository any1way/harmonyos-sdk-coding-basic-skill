...
scraped_at: 2026-06-01T15:38:05+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:5deecfaf0a9c6dbdf8f16c962bd0f0a7d631942b4193f167c11ece54444ad628
---
NodeContent是ArkUI提供的[ContentSlot](../../../../ArkTS组件/自定义占位组件/ContentSlot/ts-components-contentslot.md)的管理器。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [FrameNode](../FrameNode/js-apis-arkui-framenode.md) | 是 | 需要添加的FrameNode。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [FrameNode](../FrameNode/js-apis-arkui-framenode.md) | 是 | 需要删除的FrameNode。 |
