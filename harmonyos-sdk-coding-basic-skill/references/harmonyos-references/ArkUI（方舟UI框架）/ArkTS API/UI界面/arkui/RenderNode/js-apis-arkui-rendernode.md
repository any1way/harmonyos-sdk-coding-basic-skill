...
scraped_at: 2026-06-11T15:42:57+08:00
doc_updated_at: 2026-03-27
content_hash: sha256:d307a5cb7b44b0b78597eb6be4347b0a92c525b18129bb3ad83e5a951faeeff4
---
...
* 不建议对[BuilderNode](../BuilderNode/js-apis-arkui-buildernode.md)中的RenderNode进行修改操作。BuilderNode中持有的[FrameNode](../FrameNode/js-apis-arkui-framenode.md)仅用于将该BuilderNode作为子节点挂载到其他FrameNode上，对该FrameNode或对应的RenderNode进行属性设置与子节点操作可能会产生未定义行为，包括但不限于显示异常、事件异常、稳定性问题等。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | [Size](../Graphics/js-apis-arkui-graphics.md#size) | 是 | 将要设置的RenderNode的大小。 |
...
| 类型 | 说明 |
| --- | --- |
| [Size](../Graphics/js-apis-arkui-graphics.md#size) | 获取当前RenderNode的大小，默认值宽度和高度为0。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Position](../Graphics/js-apis-arkui-graphics.md#position) | 是 | 将要设置的RenderNode的位置。 |
...
| 类型 | 说明 |
| --- | --- |
| [Position](../Graphics/js-apis-arkui-graphics.md#position) | 获取当前RenderNode的位置，默认位置为{ x: 0, y: 0 }。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| frame | [Frame](../Graphics/js-apis-arkui-graphics.md#frame) | 是 | 将要设置的RenderNode的大小和位置。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pivot | [Pivot](../Graphics/js-apis-arkui-graphics.md#pivot) | 是 | 将要设置的RenderNode的轴心。 |
...
| 类型 | 说明 |
| --- | --- |
| [Pivot](../Graphics/js-apis-arkui-graphics.md#pivot) | 获取当前RenderNode的轴心，默认值为{ x: 0.5, y: 0.5}。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | [Scale](../Graphics/js-apis-arkui-graphics.md#scale) | 是 | 将要设置的RenderNode的缩放比例。 |
...
| 类型 | 说明 |
| --- | --- |
| [Scale](../Graphics/js-apis-arkui-graphics.md#scale) | 获取当前RenderNode的比例，默认值为{ x: 1, y: 1 }。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| translation | [Translation](../Graphics/js-apis-arkui-graphics.md#translation) | 是 | 将要设置的RenderNode的平移量。 |
...
| 类型 | 说明 |
| --- | --- |
| [Translation](../Graphics/js-apis-arkui-graphics.md#translation) | 获取当前RenderNode的平移量，默认值为{ x: 0, y: 0 }。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rotation | [Rotation](../Graphics/js-apis-arkui-graphics.md#rotation) | 是 | 将要设置的RenderNode的旋转角度。 |
...
| 类型 | 说明 |
| --- | --- |
| [Rotation](../Graphics/js-apis-arkui-graphics.md#rotation) | 当前RenderNode的旋转角度。默认值为{ x: 0, y: 0, z: 0}。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transform | [Matrix4](../Graphics/js-apis-arkui-graphics.md#matrix4) | 是 | 将要设置的RenderNode的变换矩阵。 |
...
| 类型 | 说明 |
| --- | --- |
| [Matrix4](../Graphics/js-apis-arkui-graphics.md#matrix4) | 当前RenderNode的变换矩阵。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| offset | [Offset](../Graphics/js-apis-arkui-graphics.md#offset) | 是 | 将要设置的RenderNode的阴影偏移。 |
...
| 类型 | 说明 |
| --- | --- |
| [Offset](../Graphics/js-apis-arkui-graphics.md#offset) | 当前RenderNode的阴影偏移，默认值为{ x: 0, y: 0 }。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/gUx8ofF8RQCrrF5fDWDwXA/zh-cn_image_0000002592219920.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074254Z&HW-CC-Expire=86400&HW-CC-Sign=E11138841EC1C319B22A3EEE7168D64F08E99C156DF006B468992E392C8AAD36)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/q5Zh3GjaQ3yfmR6kIbkPbw/zh-cn_image_0000002592379854.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074254Z&HW-CC-Expire=86400&HW-CC-Sign=7ADC66A0F15AA442A67D7BB4AAB681B1E56A1972AD0434FB4DDEB966BE999ACE)
...
该接口的[DrawContext](../Graphics/js-apis-arkui-graphics.md#drawcontext)中的Canvas是用于记录指令的临时Canvas，并非节点的真实Canvas。使用请参见[调整自定义绘制Canvas的变换矩阵](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义渲染节点 (RenderNode)/arkts-user-defined-arktsnode-rendernode.md#调整自定义绘制canvas的变换矩阵>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [DrawContext](../Graphics/js-apis-arkui-graphics.md#drawcontext) | 是 | 图形绘制上下文。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [Edges](../Graphics/js-apis-arkui-graphics.md#edgest12)<[BorderStyle](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#borderstyle)> | 是 | RenderNode的边框样式。 |
...
| 类型 | 说明 |
| --- | --- |
| [Edges](../Graphics/js-apis-arkui-graphics.md#edgest12)<[BorderStyle](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#borderstyle)> | RenderNode的边框样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| width | [Edges](../Graphics/js-apis-arkui-graphics.md#edgest12)<number> | 是 | RenderNode的边框宽度，单位为vp。 |
...
| 类型 | 说明 |
| --- | --- |
| [Edges](../Graphics/js-apis-arkui-graphics.md#edgest12)<number> | RenderNode的边框宽度，默认所有边框宽度为0vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Edges](../Graphics/js-apis-arkui-graphics.md#edgest12)<number> | 是 | RenderNode的边框颜色。 |
...
| 类型 | 说明 |
| --- | --- |
| [Edges](../Graphics/js-apis-arkui-graphics.md#edgest12)<number> | RenderNode的边框颜色，默认所有边框颜色为0XFF000000。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| radius | [BorderRadiuses](../Graphics/js-apis-arkui-graphics.md#borderradiuses12) | 是 | RenderNode的边框圆角，单位为vp。 |
...
| 类型 | 说明 |
| --- | --- |
| [BorderRadiuses](../Graphics/js-apis-arkui-graphics.md#borderradiuses12) | RenderNode的边框圆角，默认所有边框圆角为0vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shapeMask | [ShapeMask](../Graphics/js-apis-arkui-graphics.md#shapemask12) | 是 | RenderNode的遮罩。 |
...
| 类型 | 说明 |
| --- | --- |
| [ShapeMask](../Graphics/js-apis-arkui-graphics.md#shapemask12) | RenderNode的边框遮罩。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shapeClip | [ShapeClip](../Graphics/js-apis-arkui-graphics.md#shapeclip12) | 是 | RenderNode的裁剪形状。 |
...
| 类型 | 说明 |
| --- | --- |
| [ShapeClip](../Graphics/js-apis-arkui-graphics.md#shapeclip12) | RenderNode的裁剪形状。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/JATDMSykQ6ySxrO00uEQxQ/zh-cn_image_0000002622859363.png?HW-CC-KV=V1&HW-CC-Date=20260611T074254Z&HW-CC-Expire=86400&HW-CC-Sign=22F9B3E6E8F4B8BFB766DCB890B534484A272A4B7340BA6B92A6DFA0CB1A4F41)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| unit | [LengthMetricsUnit](../Graphics/js-apis-arkui-graphics.md#lengthmetricsunit12) | 是 | 设置RenderNode各个属性使用的单位。 |
...
| 类型 | 说明 |
| --- | --- |
| [LengthMetricsUnit](../Graphics/js-apis-arkui-graphics.md#lengthmetricsunit12) | 获取RenderNode各个属性使用的单位，默认值为LengthMetricsUnit.DEFAULT。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/18/v3/HSUuleaBQIGd5etNiBgkJA/zh-cn_image_0000002622699483.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074254Z&HW-CC-Expire=86400&HW-CC-Sign=C609B3F6D1A1CB62024F4B1D77F308504E91BE4BE6F0DA01347CC79AFE2A617C)
