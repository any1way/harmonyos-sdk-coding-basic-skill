...
scraped_at: 2026-06-11T15:42:50+08:00
doc_updated_at: 2026-05-28
content_hash: sha256:68539287c0eadf040a0fc7d33aafe2bbdac399aaaf77218cd889e293fa1ab1b8
---
FrameNode表示组件树的实体节点。[NodeController](../NodeController/js-apis-arkui-nodecontroller.md)可通过[BuilderNode](../BuilderNode/js-apis-arkui-buildernode.md)持有的FrameNode将其挂载到[NodeContainer](../../../../ArkTS组件/自定义占位组件/NodeContainer/ts-basic-components-nodecontainer.md)上，也可通过FrameNode获取[RenderNode](../RenderNode/js-apis-arkui-rendernode.md)，挂载到其他FrameNode上。最佳实践请参考[组件动态创建-组件动态添加、更新和删除](../../../../../../best-practices/组件封装与复用/组件动态创建/bpta-ui-dynamic-operations.md#section153921947151012)。
...
* 在[UI上下文不明确](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/UI系统场景化能力/使用UI上下文接口操作界面（UIContext）/arkts-global-interface.md#ui上下文不明确>)的场景中调用[FrameNode](js-apis-arkui-framenode.md#framenode-1)对象的接口时，建议使用[UIContext](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)的[runScopedTask](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#runscopedtask>)接口明确UI上下文，参考[执行绑定UI实例的闭包](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/UI系统场景化能力/使用UI上下文接口操作界面（UIContext）/arkts-global-interface.md#执行绑定ui实例的闭包>)示例。
* FrameNode的接口中，仅[Optional](../../../../ArkTS组件/通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)类型的必选参数支持传入null或undefined。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| maxSize | [Size](../Graphics/js-apis-arkui-graphics.md#size) | 否 | 否 | 最大尺寸。 |
| minSize | [Size](../Graphics/js-apis-arkui-graphics.md#size) | 否 | 否 | 最小尺寸。 |
| percentReference | [Size](../Graphics/js-apis-arkui-graphics.md#size) | 否 | 否 | 子节点计算百分比时的尺寸基准。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| NOT\_EXPAND | 0 | 表示不展开当前FrameNode的子节点。如果FrameNode包含[LazyForEach](../../../../ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)子节点，获取在主节点树上的子节点时，不展开当前FrameNode的子节点。子节点序列号按在主节点树上的子节点计算。 |
| EXPAND | 1 | 表示展开当前FrameNode的子节点。如果FrameNode包含[LazyForEach](../../../../ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)子节点，获取所有子节点时，展开当前FrameNode的子节点。子节点序列号按所有子节点计算。 |
| LAZY\_EXPAND | 2 | 表示按需展开当前FrameNode的子节点。如果FrameNode包含[LazyForEach](../../../../ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)子节点，获取在主树上的子节点时，不展开当前FrameNode的子节点；获取不在主树上的子节点时，展开当前FrameNode的子节点。子节点序列号按所有子节点计算。 |
...
| nativeEventRegistered | boolean | 否 | 否 | 是否以注册节点事件（[registerNodeEvent](<../../../../C API/结构体/ArkUI_NativeNodeAPI_1/capi-arkui-nativemodule-arkui-nativenodeapi-1.md#registernodeevent>)）的方式绑定事件。  true表示以注册节点事件的方式绑定事件，false表示没有以注册节点事件的方式绑定事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uiContext | [UIContext](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 是 | 创建对应节点时所需的UI上下文。 |
...
获取FrameNode中持有的[RenderNode](../RenderNode/js-apis-arkui-rendernode.md)。
...
| 类型 | 说明 |
| --- | --- |
| [RenderNode](../RenderNode/js-apis-arkui-rendernode.md) | null | 一个RenderNode对象。若该FrameNode不包含RenderNode，则返回空对象null。如果当前FrameNode为声明式组件创建的节点，则返回null。 |
...
| 类型 | 说明 |
| --- | --- |
| boolean | 判断当前节点是否可修改。  true表示当前节点可修改，false表示当前节点不可修改。  当节点为[自定义组件节点](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义节点概述/arkts-user-defined-node.md#自定义组件节点-framenode>)中的系统组件代理节点或节点已经[dispose](js-apis-arkui-framenode.md#dispose12)时返回false。  当返回false时，当前FrameNode不支持[appendChild](js-apis-arkui-framenode.md#appendchild12)、[insertChildAfter](js-apis-arkui-framenode.md#insertchildafter12)、[removeChild](js-apis-arkui-framenode.md#removechild12)、[clearChildren](js-apis-arkui-framenode.md#clearchildren12)、[createAnimation](js-apis-arkui-framenode.md#createanimation20)、[cancelAnimations](js-apis-arkui-framenode.md#cancelanimations20)的操作。 |
...
以下错误码的详细介绍请参见[自定义节点错误码](../../../../错误码/UI界面/自定义节点错误码/errorcode-node.md)。
...
当前仅支持根节点为以下类型组件的[BuilderNode](../BuilderNode/js-apis-arkui-buildernode.md#buildernode-1)进行移动操作：[Stack](../../../../ArkTS组件/行列与堆叠/Stack/ts-container-stack.md)、[XComponent](../../../../ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)、[EmbeddedComponent](../../../../ArkTS组件/渲染绘制/EmbeddedComponent/ts-container-embedded-component.md)。对于其他类型的组件，移动操作不会生效。
...
| 类型 | 说明 |
| --- | --- |
| [Position](../Graphics/js-apis-arkui-graphics.md#position) | 节点相对于窗口的位置偏移，单位为VP。 |
...
| 类型 | 说明 |
| --- | --- |
| [Position](../Graphics/js-apis-arkui-graphics.md#position) | 节点相对于父组件的位置偏移，单位为VP。 |
...
| 类型 | 说明 |
| --- | --- |
| [Position](../Graphics/js-apis-arkui-graphics.md#position) | 节点相对于屏幕的位置偏移，单位为VP。 |
...
| 类型 | 说明 |
| --- | --- |
| [Position](../Graphics/js-apis-arkui-graphics.md#position) | 节点相对于全局屏幕的位置偏移，单位为VP。 |
...
获取FrameNode相对于父组件带有绘制属性的位置偏移，单位为VP，绘制属性比如[transform](../../../../ArkTS组件/通用属性/视效与模糊/图形变换/ts-universal-attributes-transformation.md#transform), [translate](../../../../ArkTS组件/通用属性/视效与模糊/图形变换/ts-universal-attributes-transformation.md#translate)等，返回的坐标是组件布局时左上角变换后的坐标。
...
| 类型 | 说明 |
| --- | --- |
| [Position](../Graphics/js-apis-arkui-graphics.md#position) | 节点相对于父组件的位置偏移，单位为VP。 当设置了其他（比如：transform, translate等）绘制属性，由于浮点数精度的影响，返回值会有微小偏差。 |
...
获取FrameNode相对于窗口带有绘制属性的位置偏移，单位为VP，绘制属性比如[transform](../../../../ArkTS组件/通用属性/视效与模糊/图形变换/ts-universal-attributes-transformation.md#transform), [translate](../../../../ArkTS组件/通用属性/视效与模糊/图形变换/ts-universal-attributes-transformation.md#translate)等，返回的坐标是组件布局时左上角变换后的坐标。
...
| 类型 | 说明 |
| --- | --- |
| [Position](../Graphics/js-apis-arkui-graphics.md#position) | 节点相对于窗口的位置偏移，单位为VP。 当设置了其他（比如：transform, translate等）绘制属性，由于浮点数精度的影响，返回值会有微小偏差。 |
...
获取FrameNode相对于屏幕带有绘制属性的位置偏移，单位为VP，绘制属性比如[transform](../../../../ArkTS组件/通用属性/视效与模糊/图形变换/ts-universal-attributes-transformation.md#transform), [translate](../../../../ArkTS组件/通用属性/视效与模糊/图形变换/ts-universal-attributes-transformation.md#translate)等，返回的坐标是组件布局时左上角变换后的坐标。
...
| 类型 | 说明 |
| --- | --- |
| [Position](../Graphics/js-apis-arkui-graphics.md#position) | 节点相对于屏幕的位置偏移，单位为VP。 当设置了其他（比如：transform, translate等）绘制属性，由于浮点数精度的影响，返回值会有微小偏差。 |
...
| 类型 | 说明 |
| --- | --- |
| [Size](../Graphics/js-apis-arkui-graphics.md#size) | 节点测量后的大小，单位为PX。 |
...
| 类型 | 说明 |
| --- | --- |
| [Position](../Graphics/js-apis-arkui-graphics.md#position) | 节点布局后相对于父组件的位置偏移，单位为PX。 |
...
| 类型 | 说明 |
| --- | --- |
| [Edges](../Graphics/js-apis-arkui-graphics.md#edgest12)<[LengthMetrics](../Graphics/js-apis-arkui-graphics.md#lengthmetrics12)> | 用户设置的边框宽度。 |
...
| 类型 | 说明 |
| --- | --- |
| [Edges](../Graphics/js-apis-arkui-graphics.md#edgest12)<[LengthMetrics](../Graphics/js-apis-arkui-graphics.md#lengthmetrics12)> | 用户设置的内边距。 |
...
| 类型 | 说明 |
| --- | --- |
| [Edges](../Graphics/js-apis-arkui-graphics.md#edgest12)<[LengthMetrics](../Graphics/js-apis-arkui-graphics.md#lengthmetrics12)> | 用户设置的外边距。 |
...
| 类型 | 说明 |
| --- | --- |
| [SizeT](../Graphics/js-apis-arkui-graphics.md#sizett12)<[LengthMetrics](../Graphics/js-apis-arkui-graphics.md#lengthmetrics12)> | 用户设置的宽高。 |
...
获取用户设置的节点ID（通用属性设置的[组件标识](../../../../ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md)）。
...
| 类型 | 说明 |
| --- | --- |
| string | 用户设置的节点ID（通用属性设置的[组件标识](../../../../ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md)）。 |
...
获取节点的类型。系统组件类型为组件名称，例如，按钮组件[Button](../../../../ArkTS组件/按钮与选择/Button/ts-basic-components-button.md)的类型为Button。而对于自定义组件，若其有渲染内容，则其类型为\_\_Common\_\_。
...
获取节点的结构信息，该信息和DevEco Studio内置[ArkUI Inspector](../../../../../../harmonyos-guides/编写与调试应用/应用调试/布局分析/ide-arkui-inspector.md)工具里面的一致。
...
以查询[Button](../../../../ArkTS组件/按钮与选择/Button/ts-basic-components-button.md)组件节点为例获取到的Object结果部分值如下。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/ur-VuDDiQEO2UEMQiELnXQ/zh-cn_image_0000002622699471.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074241Z&HW-CC-Expire=86400&HW-CC-Sign=6E5AA786E13FF7A57D3A3AA914B26C68955DF41B16DBB3C3E74B4128508A861F)
...
获取FrameNode中持有的CommonAttribute接口，用于设置[通用属性](../../../../ArkTS组件/通用属性/ts-component-general-attributes.md)和[通用事件](../../../../ArkTS组件/通用事件/ts-component-general-events.md)。

仅可以修改自定义节点的属性。

说明

FrameNode的效果参考对齐方式为顶部起始端的[Stack](../../../../ArkTS组件/行列与堆叠/Stack/ts-container-stack.md)容器组件。

FrameNode的属性支持情况参考[属性或事件对attributemodifier的支持情况](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/Modifier机制/属性修改器 (AttributeModifier)/arkts-user-defined-extension-attributemodifier.md#属性或事件对attributemodifier的支持情况>)。
...
| 类型 | 说明 |
| --- | --- |
| [UICommonEvent](../../../../ArkTS组件/公共定义/设置事件回调/ts-uicommonevent.md#uicommonevent) | UICommonEvent对象，用于设置基础事件。 |
...
获取FrameNode中持有的UIGestureEvent对象，用于设置组件绑定的手势事件。通过gestureEvent接口设置的手势不会覆盖通过[绑定手势事件](../../../../ArkTS组件/手势处理/绑定手势/绑定手势事件/ts-gesture-settings.md)绑定的手势，两者同时设置了手势时，优先回调绑定手势事件设置的手势事件。
...
| 类型 | 说明 |
| --- | --- |
| [UIGestureEvent](../../../../ArkTS组件/手势处理/绑定手势/设置组件绑定的手势/ts-uigestureevent.md#uigestureevent) | UIGestureEvent对象，用于设置组件绑定的手势。 |
...
该接口的[DrawContext](../Graphics/js-apis-arkui-graphics.md#drawcontext)中的Canvas是用于记录指令的临时Canvas，并非节点的真实Canvas。使用请参见[调整自定义绘制Canvas的变换矩阵](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义组件节点 (FrameNode)/arkts-user-defined-arktsnode-framenode.md#调整自定义绘制canvas的变换矩阵>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [DrawContext](../Graphics/js-apis-arkui-graphics.md#drawcontext) | 是 | 图形绘制上下文。自绘制区域无法超出组件自身大小。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Position](../Graphics/js-apis-arkui-graphics.md#position) | 是 | 组件进行布局时使用的位置信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | [Size](../Graphics/js-apis-arkui-graphics.md#size) | 是 | FrameNode的测量后的尺寸。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Position](../Graphics/js-apis-arkui-graphics.md#position) | 是 | FrameNode的布局后的位置。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](../ComponentContent/js-apis-arkui-componentcontent.md)<T> | [ReactiveComponentContent](../ComponentContent/js-apis-arkui-componentcontent.md#reactivecomponentcontent22)<T>22+ | 是 | FrameNode节点中显示的组件内容。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/XrC153l8SzOXqtBL5D9y8Q/zh-cn_image_0000002592219910.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074241Z&HW-CC-Expire=86400&HW-CC-Sign=85C8D168BD87CD5FA1DBAA5931ABA2DCF8F03A64B142D58FFF5906FD383CD64B)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| eventType | [EventQueryType](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#eventquerytype19) | 是 | 要查询的交互事件类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| property | [AnimationPropertyType](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#animationpropertytype20) | 是 | 动画属性枚举。 |
...
| param | [AnimateParam](<../../../../ArkTS组件/动画/显式动画 (animateTo)/ts-explicit-animation.md#animateparam对象说明>) | 是 | 动画参数。包含时长、动画曲线、结束回调等参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| properties | [AnimationPropertyType](../../../../ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#animationpropertytype20)[] | 是 | 待取消的动画属性枚举数组。可以一次取消一个节点上的多个属性的动画。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Position](../Graphics/js-apis-arkui-graphics.md#position) | 是 | 当前节点坐标系中的相对坐标。 |
...
| 类型 | 说明 |
| --- | --- |
| [Position](../Graphics/js-apis-arkui-graphics.md#position) | 目标节点局部坐标系中的转换坐标。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| positionByLocal | [Position](../Graphics/js-apis-arkui-graphics.md#position) | 是 | 当前节点坐标系中的相对坐标。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Position](../Graphics/js-apis-arkui-graphics.md#position) | 当前节点所在窗口的坐标系中的转换坐标。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| positionByWindow | [Position](../Graphics/js-apis-arkui-graphics.md#position) | 是 | 当前节点所在窗口的坐标系中的相对坐标。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Position](../Graphics/js-apis-arkui-graphics.md#position) | 当前节点坐标系中的转换坐标。 |
...
使用typeNode创建[Text](../../../../ArkTS组件/文本与输入/Text/ts-basic-components-text.md)、[Image](../../../../ArkTS组件/图片与视频/Image/ts-basic-components-image.md)、[Select](../../../../ArkTS组件/按钮与选择/Select/ts-basic-components-select.md)、[Toggle](../../../../ArkTS组件/按钮与选择/Toggle/ts-basic-components-toggle.md)节点时，当传入的[UIContext](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)对应的UI实例销毁后，调用该接口会返回一个无效的FrameNode节点，无法正常挂载和显示。
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<TextInterface, TextAttribute> | 提供Text类型FrameNode节点。  TextInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为Text组件的构造函数类型。  TextAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回Text组件的属性设置对象。  TextInterface表示Text的[接口](../../../../ArkTS组件/文本与输入/Text/ts-basic-components-text.md#接口)，TextAttribute表示Text的[属性](../../../../ArkTS组件/文本与输入/Text/ts-basic-components-text.md#属性)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [UIContext](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 是 | 创建对应节点时所需的UI上下文。 |
...
将文本控制器[TextController](../../../../ArkTS组件/文本与输入/Text/ts-basic-components-text.md#textcontroller11)绑定到[Text](js-apis-arkui-framenode.md#text12)节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
| controller | [TextController](../../../../ArkTS组件/文本与输入/Text/ts-basic-components-text.md#textcontroller11) | 是 | 文本控制器。 |
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<RowInterface, RowAttribute> | 提供Row类型FrameNode节点。  RowInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为Row组件的构造函数类型。  RowAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回Row组件的属性设置对象。  RowInterface表示Row的[接口](../../../../ArkTS组件/行列与堆叠/Row/ts-container-row.md#接口)，RowAttribute表示Row的[属性](../../../../ArkTS组件/行列与堆叠/Row/ts-container-row.md#属性)。 |
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<StackInterface, StackAttribute> | 提供Stack类型FrameNode节点。  StackInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为Stack组件的构造函数类型。  StackAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回Stack组件的属性设置对象。  StackInterface表示Stack的[接口](../../../../ArkTS组件/行列与堆叠/Stack/ts-container-stack.md#接口)，StackAttribute表示Stack的[属性](../../../../ArkTS组件/行列与堆叠/Stack/ts-container-stack.md#属性)。 |
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<GridColInterface, GridColAttribute> | 提供GridCol类型FrameNode节点。  GridColInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为GridCol组件的构造函数类型。  GridColAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回GridCol组件的属性设置对象。  GridColInterface表示GridCol的[接口](../../../../ArkTS组件/栅格与分栏/GridCol/ts-container-gridcol.md#接口)，GridColAttribute表示GridCol的[属性](../../../../ArkTS组件/栅格与分栏/GridCol/ts-container-gridcol.md#属性)。 |
...
将控制器[SwiperController](../../../../ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md#swipercontroller)绑定到[Swiper](js-apis-arkui-framenode.md#swiper12)节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
| controller | [SwiperController](../../../../ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md#swipercontroller) | 是 | Swiper容器组件的控制器。 |
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<ScrollInterface, ScrollAttribute> | 提供Scroll类型FrameNode节点。  ScrollInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为Scroll组件的构造函数类型。  ScrollAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回Scroll组件的属性设置对象。  ScrollInterface表示Scroll的[接口](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#接口)，ScrollAttribute表示Scroll的[属性](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#属性)。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIScrollEvent](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#uiscrollevent19) | undefined | Scroll节点类型的滚动事件，若获取失败，则返回undefined。 |
...
将滚动控制器[Scroller](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scroller)绑定到[Scroll](js-apis-arkui-framenode.md#scroll12)节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
| controller | [Scroller](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scroller) | 是 | 滚动控制器。 |
| nodeType | 'Scroll' | 是 | 绑定滚动控制器的目标节点的节点类型为Scroll。 |

**错误码：**

以下错误码的详细介绍请参见[自定义节点错误码](../../../../错误码/UI界面/自定义节点错误码/errorcode-node.md)和[通用错误码](../../../../../通用错误码/errorcode-universal.md)。
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<RelativeContainerInterface, RelativeContainerAttribute> | 提供RelativeContainer类型FrameNode节点。  RelativeContainerInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为RelativeContainer组件的构造函数类型。  RelativeContainerAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回RelativeContainer组件的属性设置对象。  RelativeContainerInterface表示RelativeContainer的[接口](../../../../ArkTS组件/行列与堆叠/RelativeContainer/ts-container-relativecontainer.md#接口)，RelativeContainerAttribute表示RelativeContainer的[属性](../../../../ArkTS组件/行列与堆叠/RelativeContainer/ts-container-relativecontainer.md#属性)。 |
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<DividerInterface, DividerAttribute> | 提供Divider类型FrameNode节点。  DividerInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为RelativeContainer组件的构造函数类型。  DividerAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回Divider组件的属性设置对象。  DividerInterface表示Divider的[接口](../../../../ArkTS组件/空白与分隔/Divider/ts-basic-components-divider.md#接口)，DividerAttribute表示Divider的[属性](../../../../ArkTS组件/空白与分隔/Divider/ts-basic-components-divider.md#属性)。 |
...
获取[LoadingProgress](../../../../ArkTS组件/信息展示/LoadingProgress/ts-basic-components-loadingprogress.md)节点的属性。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则返回undefined。该接口不支持声明式方式创建的节点。
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<SearchInterface, SearchAttribute> | 提供Search类型FrameNode节点。  SearchInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为Search组件的构造函数类型。  SearchAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回Search组件的属性设置对象。  SearchInterface表示Search的[接口](../../../../ArkTS组件/文本与输入/Search/ts-basic-components-search.md#接口)，SearchAttribute表示Search的[属性](../../../../ArkTS组件/文本与输入/Search/ts-basic-components-search.md#属性)。 |
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<ImageInterface, ImageAttribute> | 提供Image类型FrameNode节点。  ImageInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为Image组件的构造函数类型。  ImageAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回Image组件的属性设置对象。  ImageInterface表示Image的[接口](../../../../ArkTS组件/图片与视频/Image/ts-basic-components-image.md#接口)，ImageAttribute表示Image的[属性](../../../../ArkTS组件/图片与视频/Image/ts-basic-components-image.md#属性)。 |
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<ListInterface, ListAttribute> | 提供List类型FrameNode节点。  ListInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为List组件的构造函数类型。  ListAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回List组件的属性设置对象。  ListInterface表示List的[接口](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md#接口)，ListAttribute表示List的[属性](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md#属性)。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIListEvent](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md#uilistevent19) | undefined | List节点类型的滚动事件，若获取失败，则返回undefined。 |
...
将滚动控制器[Scroller](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scroller)绑定到[List](js-apis-arkui-framenode.md#list12)节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<ListItemInterface, ListItemAttribute> | 提供ListItem类型FrameNode节点。  ListItemInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为ListItem组件的构造函数类型。  ListItemAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回ListItem组件的属性设置对象。  ListItemInterface表示ListItem的[接口](../../../../ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md#接口)，ListItemAttribute表示ListItem的[属性](../../../../ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md#属性)。 |
...
将输入框控制器[TextInputController](../../../../ArkTS组件/文本与输入/TextInput/ts-basic-components-textinput.md#textinputcontroller8)绑定到[TextInput](js-apis-arkui-framenode.md#textinput12)节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
| controller | [TextInputController](../../../../ArkTS组件/文本与输入/TextInput/ts-basic-components-textinput.md#textinputcontroller8) | 是 | 输入框控制器。 |
...
ListItemGroup类型的FrameNode节点类型。只允许添加[ListItem](../../../../ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md)类型子组件。
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<ListItemGroupInterface, ListItemGroupAttribute> | 提供ListItemGroup类型FrameNode节点。  ListItemGroupInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为ListItemGroup组件的构造函数类型。  ListItemGroupAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回ListItemGroup组件的属性设置对象。  ListItemGroupInterface表示ListItemGroup的[接口](../../../../ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md#接口)，ListItemGroupAttribute表示ListItemGroup的[属性](../../../../ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md#属性)。 |
...
WaterFlow类型的FrameNode节点类型。只允许添加[FlowItem](../../../../ArkTS组件/滚动与滑动/FlowItem/ts-container-flowitem.md)类型子组件。
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<WaterFlowInterface, WaterFlowAttribute> | 提供[WaterFlow](js-apis-arkui-framenode.md#waterflow12)类型FrameNode节点。  WaterFlowInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为WaterFlow组件的构造函数类型。  WaterFlowAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回WaterFlow组件的属性设置对象。  WaterFlowInterface表示WaterFlow的[接口](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md#接口)，WaterFlowAttribute表示WaterFlow的[属性](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md#属性)。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIWaterFlowEvent](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md#uiwaterflowevent19) | undefined | WaterFlow节点类型的滚动事件，若获取失败，则返回undefined。 |
...
将滚动控制器[Scroller](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scroller)绑定到[WaterFlow](js-apis-arkui-framenode.md#waterflow12)节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<FlowItemInterface, FlowItemAttribute> | 提供FlowItem类型FrameNode节点。  FlowItemInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为FlowItem组件的构造函数类型。  FlowItemAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回FlowItem组件的属性设置对象。  FlowItemInterface表示FlowItem的[接口](../../../../ArkTS组件/滚动与滑动/FlowItem/ts-container-flowitem.md#接口)，FlowItemAttribute表示FlowItem的[属性](../../../../ArkTS组件/滚动与滑动/FlowItem/ts-container-flowitem.md#属性)。 |
...
| context | [UIContext](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 是 | 创建对应节点时所需的UI上下文。 |
| nodeType | 'XComponent' | 是 | 创建XComponent类型的节点。 |
| options | [XComponentOptions](../../../../ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md#xcomponentoptions12) | 是 | 定义XComponent的具体配置参数。 |
...
| context | [UIContext](<../../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 是 | 创建对应节点时所需的UI上下文。 |
| nodeType | 'XComponent' | 是 | 创建XComponent类型的节点。 |
| parameters | [NativeXComponentParameters](../../../../ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md#nativexcomponentparameters19) | 是 | 定义XComponent的具体配置参数。 |
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<BadgeInterface, BadgeAttribute> | 提供Badge类型FrameNode节点。  BadgeInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为Badge组件的构造函数类型。  BadgeAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回Badge组件的属性设置对象。  BadgeInterface表示Badge的[接口](../../../../ArkTS组件/信息展示/Badge/ts-container-badge.md#接口)，BadgeAttribute表示Badge的[属性](../../../../ArkTS组件/信息展示/Badge/ts-container-badge.md#属性)。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIGridEvent](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md#uigridevent19) | undefined | Grid节点类型的滚动事件，若获取失败，则返回undefined。 |
...
将滚动控制器[Scroller](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scroller)绑定到[Grid](js-apis-arkui-framenode.md#grid14)节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<GridItemInterface, GridItemAttribute> | 提供GridItem类型FrameNode节点。  GridItemInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为GridItem组件的构造函数类型。  GridItemAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回GridItem组件的属性设置对象。  GridItemInterface表示GridItem的[接口](../../../../ArkTS组件/滚动与滑动/GridItem/ts-container-griditem.md#接口)，GridItemAttribute表示GridItem的[属性](../../../../ArkTS组件/滚动与滑动/GridItem/ts-container-griditem.md#属性)。 |
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<TextClockInterface, TextClockAttribute> | 提供TextClock类型FrameNode节点。  TextClockInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为TextClock组件的构造函数类型。  TextClockAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回TextClock组件的属性设置对象。  TextClockInterface表示TextClock的[接口](../../../../ArkTS组件/信息展示/TextClock/ts-basic-components-textclock.md#接口)，TextClockAttribute表示TextClock的[属性](../../../../ArkTS组件/信息展示/TextClock/ts-basic-components-textclock.md#属性)。 |
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<MarqueeInterface, MarqueeAttribute> | 提供Marquee类型FrameNode节点。  MarqueeInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为Marquee组件的构造函数类型。  MarqueeAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回Marquee组件的属性设置对象。  MarqueeInterface表示Marquee的[接口](../../../../ArkTS组件/信息展示/Marquee/ts-basic-components-marquee.md#接口)，MarqueeAttribute表示Marquee的[属性](../../../../ArkTS组件/信息展示/Marquee/ts-basic-components-marquee.md#属性)。 |
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<TextAreaInterface, TextAreaAttribute> | 提供TextArea类型FrameNode节点。  TextAreaInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为TextArea组件的构造函数类型。  TextAreaAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回TextArea组件的属性设置对象。  TextAreaInterface表示TextArea的[接口](../../../../ArkTS组件/文本与输入/TextArea/ts-basic-components-textarea.md#接口)，TextAreaAttribute表示TextArea的[属性](../../../../ArkTS组件/文本与输入/TextArea/ts-basic-components-textarea.md#属性)。 |
...
将输入框控制器[TextAreaController](../../../../ArkTS组件/文本与输入/TextArea/ts-basic-components-textarea.md#textareacontroller8)绑定到[TextArea](js-apis-arkui-framenode.md#textarea14)节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
| --- | --- | --- | --- |
| node | [FrameNode](js-apis-arkui-framenode.md) | 是 | 绑定输入框控制器的目标节点。 |
| controller | [TextAreaController](../../../../ArkTS组件/文本与输入/TextArea/ts-basic-components-textarea.md#textareacontroller8) | 是 | 输入框控制器。 |
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode<CheckboxGroupInterface, CheckboxGroupAttribute> | 提供CheckboxGroup类型FrameNode节点。  CheckboxGroupInterface用于[TypedFrameNode](js-apis-arkui-framenode.md#typedframenode12)的[initialize](js-apis-arkui-framenode.md#属性)接口的入参，入参为CheckboxGroup组件的构造函数类型。  CheckboxGroupAttribute用于TypedFrameNode的[attribute](js-apis-arkui-framenode.md#属性)接口的返回值，返回CheckboxGroup组件的属性设置对象。  CheckboxGroupInterface表示CheckboxGroup的[接口](../../../../ArkTS组件/按钮与选择/CheckboxGroup/ts-basic-components-checkboxgroup.md#接口)，CheckboxGroupAttribute表示CheckboxGroup的[属性](../../../../ArkTS组件/按钮与选择/CheckboxGroup/ts-basic-components-checkboxgroup.md#属性)。 |
...
[Toggle](../../../../ArkTS组件/按钮与选择/Toggle/ts-basic-components-toggle.md)类型的FrameNode节点类型。
...
| options | [ToggleOptions](../../../../ArkTS组件/按钮与选择/Toggle/ts-basic-components-toggle.md#toggleoptions18对象说明) | 否 | 创建Toggle节点的接口参数，仅可通过ToggleOptions中的type属性设置开关样式。 |
...
NodeAdapter提供FrameNode的数据懒加载能力，通过[LazyForEach](../../../../ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)实现接口功能。
...
重新加载全部数据操作。实际调用了LazyForEach中的[OnDataReloaded](../../../../ArkTS组件/状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md#ondatareloaded)接口通知组件重新加载所有数据。
...
获取所有有效数据。有效节点数据包括显示在屏幕上的节点以及预加载的节点。其中预加载节点的数量可依照LazyForEach的[使用限制](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md#使用限制>)，调整父容器的cachedCount属性进行设置。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/aKRIEhOPSK-VhLTxBoQs8A/zh-cn_image_0000002592379844.png?HW-CC-KV=V1&HW-CC-Date=20260611T074241Z&HW-CC-Expire=86400&HW-CC-Sign=25F0A9715B55DB061F22FF1BB45F5784DE0F0CDA865454B6289FF9991F101D79)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/lO0J7DaeSBC3FC1VOSx09w/zh-cn_image_0000002622859353.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074241Z&HW-CC-Expire=86400&HW-CC-Sign=5B28C2928A4A1E625171B0B79500208F8C9BBE91E451FBAA52AC52E6008F75A4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/zkoScDEgSVWy2Ulm06EPPA/zh-cn_image_0000002622699473.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074241Z&HW-CC-Expire=86400&HW-CC-Sign=5F8F66F031356C68BD7B3D621A1E2F04930332EBF8EB674C4CF6F9311D0C4CA6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/Oe76_w7qR2un9lqB7bN3jw/zh-cn_image_0000002592219912.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074241Z&HW-CC-Expire=86400&HW-CC-Sign=9B4E42FFDB260C2D975DEFC2F68BD24EE22CCFA49AABB1EB119CAD246B38B938)
