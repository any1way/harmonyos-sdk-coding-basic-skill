...
scraped_at: 2026-06-11T15:41:34+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:5a89649db78a93c3280ffda1b2872ef03444020fa392dc56c8b27c58ec579c5f
---
...
组件截图典型使用场景（如长截图）及最佳实践请参考[使用组件截图](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/UI系统场景化能力/使用组件截图（ComponentSnapshot）/arkts-uicontext-component-snapshot.md>)。

说明

* 本模块首批接口从API version 10开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
* 对于使用[XComponent](../../../ArkTS组件/渲染绘制/XComponent/ts-basic-components-xcomponent.md)的场景，例如：Video或者相机流媒体展示类组件，不建议使用组件截图相关接口，建议使用[createPixelMapFromSurface](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Functions/arkts-apis-image-f.md#imagecreatepixelmapfromsurface11>)直接获取图片。
* 如果组件自身内容不能填满组件大小区域，那么剩余位置截图返回的内容为透明像素。如果组件使用了[图像效果](../../../ArkTS组件/通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md)类属性或其他的效果类属性，则可能产生非用户预期的截图结果。请排查是否需要填充组件透明内容区域，或使用窗口截图接口[snapshot](<../../窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#snapshot9>)替代。
...
获取已加载的组件的截图，传入组件的[组件标识](../../../ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md)，找到对应组件进行截图。通过回调返回结果。

说明

* 从API version 10开始支持，从API version 18开始废弃，建议使用[get](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md#get12>)替代。get需先通过[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getcomponentsnapshot12>)方法获取[ComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md>)对象，然后通过该对象进行调用。
* 从API version 12开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getcomponentsnapshot12>)方法获取当前UI上下文关联的[ComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md>)对象。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| id | string | 是 | 目标组件的[组件标识](../../../ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md)。 |
| callback | [AsyncCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#asynccallback>)<image.[PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | 是 | 截图返回结果的回调。 |
...
直接使用componentSnapshot可能导致[UI上下文不明确](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/UI系统场景化能力/使用UI上下文接口操作界面（UIContext）/arkts-global-interface.md#ui上下文不明确>)的问题，建议使用getUIContext()获取[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)实例，并使用[getComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getcomponentsnapshot12>)获取绑定实例的componentSnapshot。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c/v3/IEBlkNRuRim3BAHPeIY0Fg/zh-cn_image_0000002592379796.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074132Z&HW-CC-Expire=86400&HW-CC-Sign=0107102EA183FC9BB288ABE3730A40D2B6E6BC212B2B146342381EE52AEB65FC)
...
获取已加载的组件的截图，传入组件的[组件标识](../../../ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md)，找到对应组件进行截图。通过Promise返回结果。

说明

* 从API version 10开始支持，从API version 18开始废弃，建议使用[get](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md#get12-1>)替代。get需先通过[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getcomponentsnapshot12>)方法获取[ComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md>)对象，然后通过该对象进行调用。
* 从API version 12开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getcomponentsnapshot12>)方法获取当前UI上下文关联的[ComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md>)对象。
* 截图会获取最近一帧的绘制内容。如果在组件触发更新的同时调用截图，更新的渲染内容不会被截取到，截图会返回上一帧的绘制内容。
...
| 类型 | 说明 |
| --- | --- |
| Promise<image.[PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | 截图返回的结果。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/34/v3/LLo4CI9dRhm_QWjXIbi16w/zh-cn_image_0000002592379796.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074132Z&HW-CC-Expire=86400&HW-CC-Sign=31B3F3588529A052709E698F9FF2FA45D61FD0458DCED00DBF3F2EB5053A21FF)
...
* 从API version 10开始支持，从API version 18开始废弃，建议使用[createFromBuilder](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md#createfrombuilder12>)替代。createFromBuilder需先通过[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getcomponentsnapshot12>)方法获取[ComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md>)对象，然后通过该对象进行调用。
* 从API version 12开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getcomponentsnapshot12>)方法获取当前UI上下文关联的[ComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md>)对象。
* 由于需要等待组件构建、渲染成功，离屏截图的回调有500ms以内的延迟。
* builder中的组件不支持设置动画相关的属性，如[transition](<../../../ArkTS组件/动画/组件内转场 (transition)/ts-transition-animation-component.md>)。
* 部分执行耗时任务的组件可能无法及时在截图前加载完成，因此会截取不到加载成功后的图像。例如：加载网络图片的[Image](../../../ArkTS组件/图片与视频/Image/ts-basic-components-image.md)组件、[Web](<../../../../ArkWeb（方舟Web）/ArkTS 组件/Web/组件描述/arkts-basic-components-web.md>)组件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| builder | [CustomBuilder](../../../ArkTS组件/公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 自定义组件构建函数。  **说明：** 不支持全局builder。  builder的根组件宽高为0时，截图操作会失败并抛出100001错误码。 |
| callback | [AsyncCallback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#asynccallback>)<image.[PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | 是 | 截图返回结果的回调。支持在回调中获取离屏组件绘制区域坐标和大小。 |
...
以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)、[截图错误码](../../../错误码/UI界面/截图错误码/errorcode-snapshot.md)和[接口调用异常错误码](../../../错误码/UI界面/接口调用异常错误码/errorcode-internal.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/AVE5VjnARDy1t-I8rVmLMA/zh-cn_image_0000002622859305.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074132Z&HW-CC-Expire=86400&HW-CC-Sign=0B17AF67C5BAB33629FB7BC9D9F5501E56D53A7AE78AE074D9DE16BE3FF8F94F)
...
* 从API version 10开始支持，从API version 18开始废弃，建议使用[createFromBuilder](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md#createfrombuilder12-1>)替代。createFromBuilder需先通过[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getcomponentsnapshot12>)方法获取[ComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md>)对象，然后通过该对象进行调用。
* 从API version 12开始，可以通过使用[UIContext](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[getComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#getcomponentsnapshot12>)方法获取当前UI上下文关联的[ComponentSnapshot](<../@ohos.arkui.UIContext (UIContext)/Class (ComponentSnapshot)/arkts-apis-uicontext-componentsnapshot.md>)对象。
* 由于需要等待组件构建、渲染成功，离屏截图的回调有500ms以内的延迟。
* builder中的组件不支持设置动画相关的属性，如[transition](<../../../ArkTS组件/动画/组件内转场 (transition)/ts-transition-animation-component.md>)。
* 部分执行耗时任务的组件可能无法及时在截图前加载完成，因此会截取不到加载成功后的图像。例如：加载网络图片的[Image](../../../ArkTS组件/图片与视频/Image/ts-basic-components-image.md)组件、[Web](<../../../../ArkWeb（方舟Web）/ArkTS 组件/Web/组件描述/arkts-basic-components-web.md>)组件。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/1_tfLljwRaOx6XVUgvKtvA/zh-cn_image_0000002622859305.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074132Z&HW-CC-Expire=86400&HW-CC-Sign=4F4FA15DC4D3A92A3FC8530E610A751C7FB3E8DE8455A90848F80B5B1C798671)
...
获取已加载的组件的截图，传入组件的[组件标识](../../../ArkTS组件/通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md)，找到对应组件进行截图。同步等待截图完成返回[PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)。
...
| 类型 | 说明 |
| --- | --- |
| image.[PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 截图返回的结果。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b4/v3/GkZQHY2xTxWbKPAj6WXlgw/zh-cn_image_0000002592379796.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074132Z&HW-CC-Expire=86400&HW-CC-Sign=72B1B2D27BFE0AFF693F1CB75E26FFC9FC26F370E774892E4F076F0F98D6B415)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| colorSpace | [colorSpaceManager.ColorSpace](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.colorSpaceManager (色彩管理)/js-apis-colorspacemanager.md#colorspace>) | 否 | 是 | 指定截图使用的色彩空间。  如果知道被截图组件使用的色彩空间，可以通过colorSpace字段指定，并将isAuto设置为false，以达到预期的截图效果。  取值范围：[colorSpaceManager.ColorSpace](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.colorSpaceManager (色彩管理)/js-apis-colorspacemanager.md#colorspace>)中DISPLAY\_P3、SRGB、DISPLAY\_BT2020\_SRGB。  默认值：SRGB  如果值为undefined、null或未设置，则使用默认值截图；其他异常值会导致截图失败，返回错误码160003。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c9/v3/kGo2ZDBsRpOuZf6o7yrMNw/zh-cn_image_0000002592379796.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074132Z&HW-CC-Expire=86400&HW-CC-Sign=641778E072D61A9B6D8FFC307D25FC8F04FD2FA0BCE7F05911A3055A24EB0B72)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/L4XNUfGAQTS6WmWZYy6-1Q/zh-cn_image_0000002592379796.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074132Z&HW-CC-Expire=86400&HW-CC-Sign=B8A71ED5BC7EAFD5B529C47B1AEFA5373400B69A04BCF0F83A611747C11066C5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/04/v3/yw6RNaetSnKfVb_4xWeqkQ/zh-cn_image_0000002622699425.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074132Z&HW-CC-Expire=86400&HW-CC-Sign=5F5ABE72D4257D68730F463951E6F43DFC61EEBB1F752C1FBF8DFDB5E0821E30)
