...
scraped_at: 2026-06-01T15:53:52+08:00
doc_updated_at: 2026-03-26
content_hash: sha256:b996eaf48bccff3c125e5935bc26645343d3715d50ba820e2f5cad51124465a2
---
说明
...
* 传入id错误、节点已经被销毁等。
* 对不具有获焦能力的组件请求焦点。具体组件可查询[组件获焦能力说明](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/支持焦点处理/arkts-common-events-focus-event.md#组件获焦能力说明>)。
