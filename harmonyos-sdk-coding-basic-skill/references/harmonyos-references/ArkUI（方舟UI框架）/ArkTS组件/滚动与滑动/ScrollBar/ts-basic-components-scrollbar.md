...
scraped_at: 2026-06-11T15:46:26+08:00
doc_updated_at: 2026-03-27
content_hash: sha256:21ba2f5f1ded0680ccaa0bfb0cfb313cb523bdae24efdd0b581140ab3946f4cb
---
滚动条组件ScrollBar，用于配合可滚动组件使用，如[ArcList](../ArcList/ts-container-arclist.md)、[List](../List/ts-container-list.md)、[Grid](../Grid/ts-container-grid.md)、[Scroll](../Scroll/ts-container-scroll.md)、[WaterFlow](../WaterFlow/ts-container-waterflow.md)。

说明

* 该组件从API version 8开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。
* ScrollBar主轴方向不设置大小时，采用父组件[布局约束](<../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#layoutconstraint12>)中的maxSize作为主轴方向大小。如果ScrollBar的父组件存在可滚动组件，如[ArcList](../ArcList/ts-container-arclist.md)、[List](../List/ts-container-list.md)、[Grid](../Grid/ts-container-grid.md)、[Scroll](../Scroll/ts-container-scroll.md)、[WaterFlow](../WaterFlow/ts-container-waterflow.md)，建议设置ScrollBar主轴方向大小，否则ScrollBar主轴方向大小可能为无穷大。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否执行嵌套滚动。设置为true执行嵌套滚动，设置为false不嵌套滚动。  默认值：false |

说明

滚动条使能嵌套滚动时，滚动条的滚动偏移量会先发送给绑定的内层滚动组件，内层滚动组件再根据设置的嵌套滚动优先级依次传递给外层父滚动组件。

WaterFlow组件的布局模式为移动窗口式（[WaterFlowLayoutMode.SLIDING\_WINDOW](../WaterFlow/ts-container-waterflow.md#waterflowlayoutmode12枚举说明)）时，不支持嵌套滚动。

设置嵌套滚动模式为[PARALLEL](../../公共定义/枚举说明/ts-appendix-enums.md#nestedscrollmode10)时，父子组件同时滚动，需要开发者在[onScrollFrameBegin](../Scroll/ts-container-scroll.md#onscrollframebegin9)中按照所需逻辑，自行设置父子组件滚动顺序。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ColorMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12>)> | 是 | 滚动条的颜色。  默认值：ColorMetrics.numeric(0x66182431) |
...
* ScrollBar组件的显隐是通过BarState设置，组件内部会自动根据BarState设置调整opacity来控制显隐，因此ScrollBar组件设置[opacity](../../通用属性/视效与模糊/透明度设置/ts-universal-attributes-opacity.md#opacity18)属性不生效。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| scroller | [Scroller](../Scroll/ts-container-scroll.md#scroller) | 否 | 否 | 可滚动组件的控制器。用于与可滚动组件进行绑定。 |
...
| state | [BarState](../../公共定义/枚举说明/ts-appendix-enums.md#barstate) | 否 | 是 | 滚动条状态。  默认值：BarState.Auto |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/pATwuAs-SRmJMtfEQ_Oc5A/zh-cn_image_0000002592220118.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074452Z&HW-CC-Expire=86400&HW-CC-Sign=79585BFCC93FADAE0FD3463DC3C870AAB0901772AF373196D3FBF8D2D4E6C6EE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/b0SgvPiwQXuL657dMSBAjA/zh-cn_image_0000002592380052.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074452Z&HW-CC-Expire=86400&HW-CC-Sign=AD510BFA501B0D5B7AFA232784EACBD741799120F0B4F55F96CA3A0CA531E49B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5f/v3/ttVScBRbQEWSIlz3Cvg-Yg/zh-cn_image_0000002622859561.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074452Z&HW-CC-Expire=86400&HW-CC-Sign=589A1BC706453129C1627F8C42D660D2792CA0649D042C9A687BC2280751612F)
