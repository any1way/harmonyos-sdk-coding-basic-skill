...
scraped_at: 2026-06-11T15:46:18+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:218ab0e908babae07efc28ba5e9c98877c10927114a3223ac1920ca9a6123b8c
---
...
* 该组件嵌套List子组件滚动时，若List不设置宽高，则默认全部加载，在对性能有要求的场景下建议指定List的宽高，最佳实践请参考[懒加载优化性能-Scroll嵌套List导致按需加载失效](../../../../../best-practices/性能/性能场景优化案例/界面渲染性能优化/懒加载优化性能/bpta-lazyforeach-optimization.md#section6296154115367)。
* 该组件滚动的前提是主轴方向大小小于内容大小。
* Scroll组件通用属性[clip](../../通用属性/视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip12)的默认值为true。
* Scroll组件的高度超出屏幕显示范围时，可以通过设置通用属性[layoutWeight](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#layoutweight)让Scroll高度适应主轴的剩余空间。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scroller | [Scroller](ts-container-scroll.md#scroller) | 否 | 可滚动组件的控制器。用于与可滚动组件进行绑定。  **说明：**  不允许和其他滚动类组件，如：[ArcList](../ArcList/ts-container-arclist.md)、[List](../List/ts-container-list.md)、[Grid](../Grid/ts-container-grid.md)、[Scroll](ts-container-scroll.md)和[WaterFlow](../WaterFlow/ts-container-waterflow.md)绑定同一个滚动控制对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| barState | [BarState](../../公共定义/枚举说明/ts-appendix-enums.md#barstate) | 是 | 滚动条状态。  默认值：BarState.Auto |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Color](../../公共定义/枚举说明/ts-appendix-enums.md#color) | number | string | 是 | 滚动条的颜色。  默认值：'#66182431'  number为HEX格式颜色，支持rgb或者argb，示例：0xffffff。  string为rgb或者argb格式颜色，示例：'#ffffff'。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Color](../../公共定义/枚举说明/ts-appendix-enums.md#color) | number | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 是 | 滚动条的颜色。  默认值：'#66182431'  number为HEX格式颜色，支持rgb或者argb，示例：0xffffff。string为rgb或者argb格式颜色，示例：'#ffffff'。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| edgeEffect | [EdgeEffect](../../公共定义/枚举说明/ts-appendix-enums.md#edgeeffect) | 是 | Scroll组件的边缘滑动效果，支持弹簧效果和阴影效果。  默认值：EdgeEffect.None |
| options11+ | [EdgeEffectOptions](../滚动组件通用接口/ts-container-scrollable-common.md#edgeeffectoptions11对象说明) | 否 | 组件内容大小小于组件自身时，是否开启滑动效果。设置为{ alwaysEnabled: true }会开启滑动效果，{ alwaysEnabled: false }不开启。  默认值：{ alwaysEnabled: true } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [NestedScrollOptions](../滚动组件通用接口/ts-container-scrollable-common.md#nestedscrolloptions10对象说明) | 是 | 嵌套滚动选项。  默认值：{ scrollForward: NestedScrollMode.SELF\_ONLY, scrollBackward: NestedScrollMode.SELF\_ONLY }  Scroll设置[enablePaging](ts-container-scroll.md#enablepaging11)或者[scrollSnap](ts-container-scroll.md#scrollsnap10)，并同时设置父组件优先的嵌套滚动时，嵌套滚动不生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | number | 是 | 设置Scroll组件内容的缩放比例，该参数支持[!!](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/!!语法：双向绑定/arkts-new-binding.md>)双向绑定变量。  默认值：1  取值范围：(0, +∞)，小于或等于0时按默认值1处理。 |
...
| [scrollBarMargin](../滚动组件通用接口/ts-container-scrollable-common.md#scrollbarmargin20) | [onScrollStart](ts-container-scroll.md#onscrollstart9) | [currentOffset](ts-container-scroll.md#currentoffset) |
...
| [clipContent](../滚动组件通用接口/ts-container-scrollable-common.md#clipcontent14) | - | - |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| snapAlign | [ScrollSnapAlign](../List/ts-container-list.md#scrollsnapalign10枚举说明) | 否 | 否 | 设置Scroll组件限位滚动时的对齐方式。  **说明：**  1.该属性默认值为ScrollSnapAlign.NONE。 |
| snapPagination | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | Array<Dimension> | 否 | 是 | 设置Scroll组件限位滚动时的分页点。  **说明：**  1.当属性为Dimension时，Dimension表示每页的大小，系统按照该大小进行分页。  2.当属性为Array<Dimension>时，每个Dimension表示分页点，系统按照分页点进行分页。每个Dimension的范围为[0,可滑动距离]。  3.当该属性不填或者Dimension为小于等于0的输入时，按异常值，无限位滚动处理。当该属性值为Array<Dimension>数组时，数组中的数值必须为单调递增。  4.当输入为百分比时，实际的大小为Scroll组件的视口与百分比数值之积。 |
...
不支持滚动组件通用事件中的[onWillScroll](../滚动组件通用接口/ts-container-scrollable-common.md#onwillscroll12)、[onDidScroll](../滚动组件通用接口/ts-container-scrollable-common.md#ondidscroll12)事件。
...
若通过onScrollFrameBegin事件和[scrollBy](ts-container-scroll.md#scrollby9)方法实现容器嵌套滚动，需设置子滚动节点的[EdgeEffect](ts-container-scroll.md#edgeeffect)为None。如Scroll嵌套List滚动时，List组件的[edgeEffect](../List/ts-container-list.md#edgeeffect)属性需设置为EdgeEffect.None，否则抛滑List，会触发List的边缘回弹动画，导致嵌套滚动失效。
...
滚动事件的回调函数在滚动过程中会被频繁触发，因此应避免在该回调函数中执行耗时操作，以防止应用出现卡顿和丢帧的问题。最佳实践请参考[主线程耗时操作优化指导-高频回调场景](../../../../../best-practices/性能/性能场景优化案例/界面渲染性能优化/主线程耗时操作优化/bpta-time-optimization-of-the-main-thread.md#section10112623611)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [OnScrollEdgeCallback](ts-container-scroll.md#onscrolledgecallback18) | 是 | 滚动到的边缘位置。  当Scroll设置为水平方向滚动时，上报[Edge.Center](../../公共定义/枚举说明/ts-appendix-enums.md#edge)表示水平方向起始位置，上报[Edge.Baseline](../../公共定义/枚举说明/ts-appendix-enums.md#edge)表示水平方向末尾位置。由于[Edge.Center](../../公共定义/枚举说明/ts-appendix-enums.md#edge)和[Edge.Baseline](../../公共定义/枚举说明/ts-appendix-enums.md#edge)枚举值已经废弃，推荐使用[onReachStart](../滚动组件通用接口/ts-container-scrollable-common.md#onreachstart11)、[onReachEnd](../滚动组件通用接口/ts-container-scrollable-common.md#onreachend11)事件监听是否滚动到边界。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](../../公共定义/基础类型定义/ts-types.md#voidcallback12) | 是 | 滚动开始回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](../../公共定义/基础类型定义/ts-types.md#voidcallback12) | 是 | 滚动停止回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](../../公共定义/基础类型定义/ts-types.md#voidcallback12) | 是 | 缩放开始回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [VoidCallback](../../公共定义/基础类型定义/ts-types.md#voidcallback12) | 是 | 缩放停止回调。 |
...
| xOffset | number | 是 | 相对于上一帧水平方向的偏移量，Scroll中的内容向左滚动时偏移量为正，向右滚动时偏移量为负。  单位vp。 |
| yOffset | number | 是 | 相对于上一帧竖直方向的偏移量，Scroll中的内容向上滚动时偏移量为正，向下滚动时偏移量为负。  单位vp。 |
| scrollState | [ScrollState](../List/ts-container-list.md#scrollstate枚举说明) | 是 | 当前滚动状态。 |

说明

若通过[onScrollFrameBegin](ts-container-scroll.md#onscrollframebegin9)事件和[scrollBy](ts-container-scroll.md#scrollby9)方法实现容器嵌套滚动，需设置子滚动节点的EdgeEffect为None。如Scroll嵌套List滚动时，List组件的[edgeEffect](../List/ts-container-list.md#edgeeffect)属性需设置为EdgeEffect.None。
...
| yOffset | number | 是 | 相对于上一帧竖直方向的偏移量，Scroll中的内容向上滚动时偏移量为正，向下滚动时偏移量为负。  单位vp。 |
| scrollState | [ScrollState](../List/ts-container-list.md#scrollstate枚举说明) | 是 | 当前滚动状态。 |
| scrollSource | [ScrollSource](../../公共定义/枚举说明/ts-appendix-enums.md#scrollsource12) | 是 | 当前滚动操作的来源。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| side | [Edge](../../公共定义/枚举说明/ts-appendix-enums.md#edge) | 是 | 滚动到的边缘位置。 |
...
| state | [ScrollState](../List/ts-container-list.md#scrollstate枚举说明) | 是 | 当前滑动状态。 |
...
3、以[aboutToAppear](../../自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoappear)为例，aboutToAppear在创建自定义组件的新实例后，在执行其build()方法之前执行。因此如果滚动组件在自定义组件build内，在该自定义组件aboutToAppear执行时，内部滚动组件还没有创建，是不能正常调用上述Scroller方法的。

4、以[onAppear](../../通用事件/组件变化事件/挂载卸载事件/ts-universal-events-show-hide.md#onappear)为例，组件挂载显示后触发此回调。因此在滚动组件的onAppear回调执行时，滚动组件已经创建并已经和Scroller绑定成功，是可以正常调用Scroller方法的。
...
* 各组件行为存在差异：
  ...
  + [ArcList](../ArcList/ts-container-arclist.md)和[List](../List/ts-container-list.md)组件会对所有经过的item进行加载和布局。
  + Grid组件和[SLIDING\_WINDOW](../WaterFlow/ts-container-waterflow.md#waterflowlayoutmode12枚举说明)模式的[WaterFlow](../WaterFlow/ts-container-waterflow.md)组件在跳转距离较大（大于2倍组件主轴高度）时，会直接估算出要显示的item。跳转指一帧滑动。
  + [ALWAYS\_TOP\_DOWN](../WaterFlow/ts-container-waterflow.md#waterflowlayoutmode12枚举说明)模式的WaterFlow组件向后跳转（即dx或dy为正值时）会加载和布局所有经过的item，向前跳转（即dx或dy为负值时）会直接跳转到对应位置。跳转指一帧滑动。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Edge](../../公共定义/枚举说明/ts-appendix-enums.md#edge) | 是 | 滚动到的边缘位置。 |
...
| direction | [Axis](../../公共定义/枚举说明/ts-appendix-enums.md#axis) | 否 | 设置滚动方向为水平或竖直方向。 |
...
2. Grid、List、WaterFlow组件有懒加载机制，组件内容没有加载并布局完成时，内容总偏移量通过估算得到，估算结果可能会有误差。其中List组件可以通过[childrenMainSize](../List/ts-container-list.md#childrenmainsize12)属性解决估算不准确的问题，Grid与WaterFlow估算不准暂无解决方案。
...
2.在[LazyForEach](../../状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md)、[ForEach](../../状态管理与渲染控制/ForEach/ts-rendering-control-foreach.md)、[Repeat](../../状态管理与渲染控制/Repeat/ts-rendering-control-repeat.md)刷新数据源时，需确保在数据刷新完成之后再调用此接口。

3.从API version 11开始，在List中支持[contentStartOffset](../List/ts-container-list.md#contentstartoffset11)和[contentEndOffset](../List/ts-container-list.md#contentendoffset11)。从API version 22开始，在Grid和Waterflow组件中支持设置[contentStartOffset](../滚动组件通用接口/ts-container-scrollable-common.md#contentstartoffset22)和[contentEndOffset](../滚动组件通用接口/ts-container-scrollable-common.md#contentendoffset22)。
...
* 各组件行为存在差异：
  ...
  + [ArcList](../ArcList/ts-container-arclist.md)和[List](../List/ts-container-list.md)组件会对所有经过的item进行加载和布局。
  + Grid组件和[SLIDING\_WINDOW](../WaterFlow/ts-container-waterflow.md#waterflowlayoutmode12枚举说明)模式的WaterFlow组件在跳转距离较大（大于2倍组件主轴高度）时，会直接估算出要显示的item。跳转指一帧滑动。
  + [ALWAYS\_TOP\_DOWN](../WaterFlow/ts-container-waterflow.md#waterflowlayoutmode12枚举说明)模式的WaterFlow组件向后跳转（即dx或dy为正值时）会加载和布局所有经过的item，向前跳转（即dx或dy为负值时）会直接跳转到对应位置。跳转指一帧滑动。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dx | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 水平方向滚动距离，不支持百分比形式。  取值范围：(-∞, +∞) |
| dy | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 竖直方向滚动距离，不支持百分比形式。  取值范围：(-∞, +∞) |
...
| 类型 | 说明 |
| --- | --- |
| [RectResult](../../通用事件/交互事件分发控制/自定义事件分发/ts-universal-attributes-on-child-touch-test.md#rectresult) | 子组件的大小和相对于组件的位置。  单位：vp。 |
...
| 类型 | 说明 |
| --- | --- |
| [SizeResult](../../自定义组件/自定义组件的自定义布局/ts-custom-component-layout.md#sizeresult10) | 滚动组件内容总大小，包括内容宽度和高度。  单位：vp |

**错误码**：

以下错误码详细介绍请参考[滚动类组件错误码](../../../错误码/UI界面/滚动类组件错误码/errorcode-scroll.md)。
...
| curve | [Curve](../../公共定义/枚举说明/ts-appendix-enums.md#curve) | [ICurve](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#icurve9>) | 否 | 是 | 设置滚动曲线。  默认值：Curve.Ease |
| canOverScroll | boolean | 否 | 是 | 设置滚动动画滚动到边界后，是否转换成越界回弹动画。  默认值：false  **说明：**  仅在设置为true，且组件的edgeEffect设置为[EdgeEffect.Spring](../../公共定义/枚举说明/ts-appendix-enums.md#edgeeffect)时，使用动画滚动到边界会转换为越界回弹动画，设置为false时，滚动到边界会直接停止动画，不会转换为越界回弹动画。  从API version 20开始，如果[ScrollOptions](ts-container-scroll.md#scrolloptions18对象说明)中的canOverScroll设置为true，表示滚动可以停留在过界位置，滚动动画过界后不会转换为回弹动画。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| extraOffset | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | 滑动到指定Index的额外偏移量。如果值为正数，则向底部额外偏移；如果值为负数，则向顶部额外偏移。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| xOffset | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | 水平滚动偏移。  默认值：0 |
| yOffset | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | 垂直滚动偏移。  默认值：0 |
...
frameNode中[getEvent('Scroll')](<../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#geteventscroll19>)方法的返回值，可用于给Scroll节点设置滚动事件。

UIScrollEvent继承于[UIScrollableCommonEvent](../滚动组件通用接口/ts-container-scrollable-common.md#uiscrollablecommonevent19)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/tGXiAcdMS-yPsrJ0GQTCXQ/zh-cn_image_0000002622859541.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=82A6EB82A55F15BCE07618AF7F92B9AB4DDA85887C556F856DB23AB4C0A449A5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/lBsfnksjTNGrZcfAwoU0uA/zh-cn_image_0000002622699661.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=251069341860E4BEB89D0C48A85A8B511D9FBF5CF2E132D07AD034B6D9593277)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/WqTAZArHQc-OPkIxWIzsQw/zh-cn_image_0000002592220100.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=4F4CEDE7CA32125BB7D0359DE81DA4A7CB2BB0A85B0958C6BB1803DB69B56C0B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/BzOpeiEKQ0C8pI4o02WIyg/zh-cn_image_0000002592380034.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=C4E5F18B0AA5DE5ADCD9590D5ADE9B2E9902C355D196A939A86D769BACCEBCC1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/GQ4jGGMyQsSoIfb6xs1P7w/zh-cn_image_0000002622859543.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=A7F20FC41DE7C4BE7CCB4E88DA18ABCE812C4A6A094ACCA9C6D81D9AE32B44E6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/-9MntXbtSV-8A1x6RVhcDQ/zh-cn_image_0000002622699663.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=27836335CC512B16FA4477B37B348D7DF6C1AD7C2580112CEFE1813CD19ACAE6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/seTgdI33QwiTheJrxOLAUA/zh-cn_image_0000002592220102.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=6C0C0E8982828E11766D7E33088D1F64C40CDD803BDFAAF205A6DADFDA1C1A31)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a2/v3/i1RumbDcQyy96UwuZDIAKg/zh-cn_image_0000002592380036.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=AD031F553BB708F423E5DBA554777D33168C3D40C4E9A39F1D51637CB7A51B91)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/V_P6aT9sS5WVGb9-yXTKnQ/zh-cn_image_0000002622859545.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=87B315223B627D7BA36D92322E9FF7C47DCC5A92E13F662AF1497A8CF0E2805E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/VJOZPdEjRASW78EeHCwVbw/zh-cn_image_0000002622699665.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=A182A41938556CCEB845ADCB1F70027FC5DD8309178ED0304862BEC77578E55A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/-Tm39y9vTN25PRX_jiwrsw/zh-cn_image_0000002592220104.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=B26161FB8B0D9A662721AAD814909946D853F60D6C79438C2A43DFF0772A4232)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/ilk3KyHOQ7CtljM5FpsXVQ/zh-cn_image_0000002592380038.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=4BE37C323F697D361D066AEEC28FDA825A265A670D8FEABD34EF2B47CC29B304)

### 示例13（设置滚动事件）

该示例通过FrameNode中的[getEvent('Scroll')](<../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#geteventscroll19>)获取[UIScrollEvent](ts-container-scroll.md#uiscrollevent19)，并为Scroll设置滚动事件回调，用于事件监听方因无法直接修改页面代码而无法使用声明式接口设置回调的场景。
