...
content_hash: sha256:f9199bbe216a4905881b822e5b0fc4d89ed91fd12f21735da8f84c5cc6a172cd
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sensitivity | Optional<[CrownSensitivity](../../公共定义/枚举说明/ts-appendix-enums.md#crownsensitivity18)> | 是 | 旋转表冠的灵敏度。  默认值：CrownSensitivity.MEDIUM |
...
设置边缘滑动效果。 目前支持的滑动效果参见[EdgeEffect](../../公共定义/枚举说明/ts-appendix-enums.md#edgeeffect)的枚举说明。调用控制器接口时回弹不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| edgeEffect | Optional<[EdgeEffect](../../公共定义/枚举说明/ts-appendix-enums.md#edgeeffect)> | 是 | 边缘滑动效果。  默认值：EdgeEffect.Spring |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Optional<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | 设置弧形指示器中，未选中导航点的颜色。  默认值：'#A9FFFFFF' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Optional<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | 设置弧形指示器中，选中导航点的颜色。  默认值：'#FF5EA1FF' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Optional<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | 设置弧形指示器被长按时，弧形指示器的颜色。  默认值：'#FF404040' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Optional<[LinearGradient](../../信息展示/DataPanel/ts-basic-components-datapanel.md#lineargradient10)> | 是 | 设置弧形指示器的遮罩渐变色。  起始颜色默认值：'#00000000'  结束颜色默认值：'#FF000000' |
...
| event | [SwiperAnimationEvent](../Swiper/ts-container-swiper.md#swiperanimationevent10对象说明) | 是 | 动画相关信息，包括主轴方向上当前显示元素和目标元素相对ArcSwiper起始位置的位移，以及离手速度。 |
...
| event | [SwiperAnimationEvent](../Swiper/ts-container-swiper.md#swiperanimationevent10对象说明) | 是 | 动画相关信息，只返回主轴方向上当前显示元素相对于ArcSwiper起始位置的位移。 |
...
ArcSwiper组件结合[LazyForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md>)使用时，不能在onChange事件里触发子页面UI的刷新。
...
当ArcSwiper切换动效结束时触发，包括动画过程中手势中断，通过[SwiperController](../Swiper/ts-container-swiper.md#swipercontroller)调用finishAnimation。参数为动画结束后的index值，多列ArcSwiper时，index为最左侧组件的索引。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/9LsxoqqlREuoC_dJRrqF6g/zh-cn_image_0000002592380044.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074619Z&HW-CC-Expire=86400&HW-CC-Sign=3F6947F9FD54325DED65094F03511D13FBBADD24E854FB35303E88AA385DCA1D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/q-CoY1enSXmw4qvUmpaArA/zh-cn_image_0000002622859553.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074619Z&HW-CC-Expire=86400&HW-CC-Sign=1A85FF37A762347A15B1132D5F00E8911808CE61CCAB7652A94540E06D811132)
