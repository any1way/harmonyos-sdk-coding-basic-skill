...
scraped_at: 2026-06-11T15:46:05+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:7405130084edec6ab6c2e1e4ea670acd7cd00f5e0c3786998fbc519667524f78
---
...
* 该组件的父组件只能是[List](../List/ts-container-list.md)或者[ListItemGroup](../ListItemGroup/ts-container-listitemgroup.md)。
* 当ListItem配合[LazyForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md>)使用时，ListItem子组件在ListItem创建时创建。配合[if/else](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ifelse：条件渲染/arkts-rendering-control-ifelse.md>)、[ForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ForEach：循环渲染/arkts-rendering-control-foreach.md>)使用时，或父组件为List/ListItemGroup时，ListItem子组件在ListItem布局时创建。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[sticky](../List/ts-container-list.md#sticky9)替代。
...
设置当前ListItem选中状态。该属性支持[$$](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)双向绑定变量。该属性需要在设置[多态样式](../../通用属性/多态样式/ts-universal-attributes-polymorphic-style.md)前使用才能生效选中态样式。
...
从API version 7开始支持，从API version 9开始废弃，建议使用List组件的[StickyStyle](../List/ts-container-list.md#stickystyle9枚举说明)替代。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| start | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | [SwipeActionItem](ts-container-listitem.md#swipeactionitem10对象说明) | 否 | 是 | ListItem向右划动时item左边的组件（List垂直布局时）或ListItem向下划动时item上方的组件（List水平布局时）。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| end | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | [SwipeActionItem](ts-container-listitem.md#swipeactionitem10对象说明) | 否 | 是 | ListItem向左划动时item右边的组件（List垂直布局时）或ListItem向上划动时item下方的组件（List水平布局时）。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| actionAreaDistance | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置组件长距离滑动删除距离阈值。即划出组件被完全滑进视窗后，继续滑动触发删除的距离阈值。  默认值：56vp  **说明：**  不支持设置百分比。  删除距离阈值大于item宽度减去划出组件宽度，或删除距离阈值小于等于0就不会设置删除区域。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [FrameNode](<../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md>) | 是 | ListItem节点对象。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/09/v3/ZbeNy2S4QiGIhiC5-go6Wg/zh-cn_image_0000002592220080.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074601Z&HW-CC-Expire=86400&HW-CC-Sign=1FCD777A16BE81B2268FF5E5E3C18B5690F2852F13C7F34BDB9DDFD6F2CD9849)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/_5OR0D-KRuSMGAM4COLzvg/zh-cn_image_0000002592380014.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074601Z&HW-CC-Expire=86400&HW-CC-Sign=6D8FB77B5D6BBC5100D406C4A02FF909F9E836BC4FB71C185AF2F961AFD281A5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/2wYWNB6HQtelahc_lCtqYw/zh-cn_image_0000002622859523.jpeg?HW-CC-KV=V1&HW-CC-Date=20260611T074601Z&HW-CC-Expire=86400&HW-CC-Sign=56A018AA74828D273D4B0B240E07313CE3A0B9EFC779417C201EA3DDE25BA55F)

### 示例4（通过ComponentContent设置划出组件）

该示例通过[ComponentContent](<../../../ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md#componentcontent-1>)设置ListItem中的划出组件操作时显示的操作项。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/4MHEGB_iS3i_xJ2BxAR0OQ/zh-cn_image_0000002622699643.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074601Z&HW-CC-Expire=86400&HW-CC-Sign=7302430D9C7906F202A8785E7B03342B346A9B02450E07580CC30F786EAFB317)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/Fa--_rAuTBmGjcTwO6ZS4A/zh-cn_image_0000002592220082.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074601Z&HW-CC-Expire=86400&HW-CC-Sign=C4B67B6ACFB5B7F5F8DCD2C09AE89720F52C9A28C805F10111E555EC62303FBD)
