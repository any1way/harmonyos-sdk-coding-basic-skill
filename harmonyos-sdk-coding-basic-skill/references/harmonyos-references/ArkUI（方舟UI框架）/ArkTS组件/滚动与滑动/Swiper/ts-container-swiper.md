...
scraped_at: 2026-06-11T15:46:20+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:15043340f8a3d52d5dfc78d1acd94c5d0fe22f63cd99bdfcf88bbb2e4e176f11
---
...
* Swiper组件通过内置的[PanGesture](../../手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md)拖动手势实现滑动轮播效果，将[disableSwipe](ts-container-swiper.md#disableswipe8)属性设为true时，会禁用该手势监听，从而阻止滑动操作。
* Swiper中复用[NodeContainer](../../自定义占位组件/NodeContainer/ts-basic-components-nodecontainer.md)时，禁止递归流程中子节点更新父节点状态变量。
...
* 子组件类型：系统组件和自定义组件，支持渲染控制类型（[if/else](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ifelse：条件渲染/arkts-rendering-control-ifelse.md>)、[ForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ForEach：循环渲染/arkts-rendering-control-foreach.md>)、[LazyForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md>)和[Repeat](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/Repeat：可复用的循环渲染/arkts-new-rendering-control-repeat.md>)）。不建议子组件中混用懒加载组件（包括LazyForEach、Repeat）和非懒加载组件，或者子组件中使用多个懒加载组件，否则可能导致懒加载组件预加载能力失效等问题。不建议在组件动画过程中对数据源进行操作，否则会导致布局出现异常。
* Swiper子组件的[visibility](../../通用属性/基础属性/显隐控制/ts-universal-attributes-visibility.md#visibility)属性设置为Visibility.None，且Swiper的displayCount属性设置为'auto'时，对应子组件在视窗内不占位，但不影响导航点个数；visibility属性设置为Visibility.None或者Visibility.Hidden时，对应子组件不显示，但依然会在视窗内占位。
* 当Swiper子组件设置了[offset](../../通用属性/布局与边框/位置设置/ts-universal-attributes-location.md#offset)属性时，会按照子组件的层级进行绘制，层级高的子组件会覆盖层级低的子组件。例如，Swiper包含3个子组件，其中第3个子组件设置了offset({ x : 100 })，那么在横向循环滑动中，第3个子组件会覆盖第1个子组件，此时可设置第1个子组件的[zIndex](../../通用属性/基础属性/Z序控制/ts-universal-attributes-z-order.md#zindex)属性值大于第3个子组件，使第1个子组件层级高于第3个子组件。
* 在走焦到用户定义的子节点时，导航点、箭头会由于[焦点样式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/支持焦点处理/arkts-common-events-focus-event.md#焦点样式>)修改zIndex的行为被遮挡。
* 在包含大量子组件的场景中，建议采用懒加载、缓存数据、预加载数据和组件复用等方法，以优化Swiper的性能并减少内存占用。最佳实践请参考[优化Swiper组件加载慢丢帧问题](../../../../../best-practices/性能/性能场景优化案例/界面渲染性能优化/Swiper组件加载丢帧优化/bpta-swiper_high_performance_development_guide.md)。
...
Swiper组件通用属性[clip](../../通用属性/视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip12)的默认值为true。
...
从API version 10开始，该属性支持[$$](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)双向绑定变量。
...
设置外部绑定的导航点组件控制器后，可以和外部导航点结合使用。外部导航点支持自定义设置显示位置和大小。详细介绍可参看[Indicator](../../导航与切换/Indicator/ts-swiper-components-indicator.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [EdgeEffect](../../公共定义/枚举说明/ts-appendix-enums.md#edgeeffect) | 是 | 边缘滑动效果。  默认值：EdgeEffect.Spring |
...
curve默认曲线为[interpolatingSpring](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curvesinterpolatingspring10>)，此时动画时长只受曲线自身参数影响，不再受duration的控制。不受duration控制的曲线可以查阅[插值计算](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md>)模块，比如，[springMotion](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curvesspringmotion9>)、[responsiveSpringMotion](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curvesresponsivespringmotion9>)和interpolatingSpring类型的曲线不受duration控制。如果希望动画时长受到duration控制，需要给curve设置其他曲线。
...
设置Swiper的动画曲线，默认为弹簧插值曲线，常用曲线参考[Curve枚举说明](../../公共定义/枚举说明/ts-appendix-enums.md#curve)，也可以通过[插值计算](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md>)模块提供的接口创建自定义的插值曲线对象。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Curve](../../公共定义/枚举说明/ts-appendix-enums.md#curve) | string | [ICurve](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#icurve9>) | 是 | Swiper的动画曲线。  string类型来源[curves.init](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curvesinitdeprecated>)，[curves.steps](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curvesstepsdeprecated>)，[curves.cubicBezier](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curvescubicbezierdeprecated>)，[curves.spring](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curvesspringdeprecated>)函数从API version 9开始废弃，推荐使用Curve和ICurve类型。  默认值：[interpolatingSpring](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curvesinterpolatingspring10>)(-1, 1, 328, 34) |
...
* 在连续滑动场景中，一屏显示一个Swiper子组件时，通常将cachedCount值设置为1或2即可。最佳实践请参考[优化Swiper组件加载慢丢帧问题-缓存数据项](../../../../../best-practices/性能/性能场景优化案例/界面渲染性能优化/Swiper组件加载丢帧优化/bpta-swiper_high_performance_development_guide.md#section143504547145)。
* 只在[LazyForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md>)和开启了virtualScroll开关的[Repeat](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/Repeat：可复用的循环渲染/arkts-new-rendering-control-repeat.md>)中生效，生效后超出显示及缓存范围的子节点会被释放。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [SwiperAutoFill](ts-container-swiper.md#swiperautofill10) | [ItemFillPolicy](../../公共定义/基础类型定义/ts-types.md#itemfillpolicy22) | 是 | 视窗内显示的子元素个数。  取值范围：(0, +∞)，设置小于等于0的值时，按照1处理。 |
...
使用nextMargin/prevMargin接口时，不要对子组件设置[constraintSize](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#constraintsize)属性，否则子节点主轴将不会被拉伸到预期长度，边距失去效果。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 后边距。不支持设置百分比。  默认值：0 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 前边距。不支持设置百分比。  默认值：0 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[PageFlipMode](../../公共定义/枚举说明/ts-appendix-enums.md#pageflipmode15)> | 是 | 鼠标滚轮翻页模式。  取undefined时，按取值为PageFlipMode.CONTINUOUS处理。 |
...
设置显示区域上方或前方插入或删除数据时是否保持可见内容位置不变。适用于使用单一[LazyForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md>)作为Swiper子节点的情况，通过LazyForEach的[onDataAdd](../../状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md#ondataadd8)、[onDataDelete](../../状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md#ondatadelete8)等接口修改数据源。其他场景下，显示区域上方或前方插入或删除数据，可见内容位置会变化。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [VoidCallback](../../公共定义/基础类型定义/ts-types.md#voidcallback12) | 否 | 动画结束的回调。 |
...
与[LazyForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md>)和自定义组件结合使用时，由于[LazyForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md>)只会保留缓存范围内的自定义组件，在缓存范围外的会被删除，因此需要开发者保证通过该接口预加载的节点index在缓存范围内。

说明

Swiper的preloadItems需要在Swiper创建之后去调用，首次预加载推荐在Swiper的[onAppear](../../通用事件/组件变化事件/挂载卸载事件/ts-universal-events-show-hide.md#onappear)生命周期中去控制。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| indices | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<Array<number>> | 是 | 需预加载的子节点的下标数组。 |
...
以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)和[滚动类组件错误码](../../../错误码/UI界面/滚动类组件错误码/errorcode-scroll.md)错误码。
...
设置导航点距离Swiper组件距离。由于导航点有默认交互区域，交互区域高度为32vp，所以无法让显示部分完全贴底。若想实现完全贴底，可以使用[IndicatorComponent](../../导航与切换/Indicator/ts-swiper-components-indicator.md#indicatorcomponent)组件，更灵活地调整位置。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 设置导航点左侧相对于Swiper的位置。  未设置left和right时，进行自适应大小布局，按照指示器本身大小和Swiper的大小在主轴方向上进行居中对齐。  设置为0时：按照0位置布局计算。  优先级：高于right属性。  取值范围：[0,Swiper宽度-导航点区域宽度]，超出该范围时，取最近的边界值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 设置导航点顶部相对于Swiper的位置。  未设置top和bottom时，进行自适应大小布局，按照指示器本身大小和Swiper的大小，在交叉轴方向上，位于底部，效果与设置bottom=0一致。  设置为0时：按照0位置布局计算。  优先级：高于bottom属性。  取值范围：[0,Swiper高度-导航点区域高度]，超出该范围时，取最近的边界值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 设置导航点右侧相对于Swiper的位置。  未设置left和right时，进行自适应大小布局，按照指示器本身大小和Swiper的大小在主轴方向上进行居中对齐。  设置为0时：按照0位置布局计算。  优先级：低于left属性。  取值范围：[0,Swiper宽度-导航点区域宽度]，超出该范围 时，取最近的边界值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 设置导航点底部相对于Swiper的位置。  未设置top和bottom时，进行自适应大小布局，按照指示器本身大小和Swiper的大小，在交叉轴方向上，位于底部，效果与设置bottom=0一致。  设置为0时：按照0位置布局计算。  优先级：低于top属性。  取值范围：[0,Swiper高度-导航点区域高度]，超出该范围时，取最近的边界值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bottom | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 设置导航点底部相对于Swiper的位置。  未设置top和bottom时，进行自适应大小布局，按照指示器本身大小和Swiper的大小，在交叉轴方向上，位于底部，效果与设置bottom=0一致。  设置为0时：按照0位置布局计算。  优先级：低于top属性。  取值范围：[0,Swiper高度-导航点区域高度]，超出该范围时，取最近的边界值。 |
...
在[RTL](../../状态管理与渲染控制/内置环境变量说明/ts-state-management-environment-variables.md#layoutdirection)模式下为导航点距离Swiper组件右边的距离，在[LTR](../../状态管理与渲染控制/内置环境变量说明/ts-state-management-environment-variables.md#layoutdirection)模式下为导航点距离Swiper组件左边的距离。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 是 | 设置在RTL模式下为导航点距离Swiper组件右边的距离，在LTR模式下为导航点距离Swiper组件左边的距离。  默认值：0  单位：vp  取值范围：[0, Swiper宽度-导航点区域宽度]，超出该范围时，取最近的边界值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 是 | 设置在RTL模式下为导航点距离Swiper组件左边的距离，在LTR模式下为导航点距离Swiper组件右边的距离。  默认值：0  单位：vp  取值范围：[0, Swiper宽度-导航点区域宽度]，超出该范围时，取最近的边界值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 设置Swiper组件圆点导航指示器的宽，不支持设置百分比。  默认值：6  单位：vp  取值范围：(0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 设置Swiper组件圆点导航指示器的高，不支持设置百分比。  默认值：6  单位：vp  取值范围：(0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 设置选中Swiper组件圆点导航指示器的宽，不支持设置百分比。  默认值：6  单位：vp  取值范围：(0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 设置选中Swiper组件圆点导航指示器的高，不支持设置百分比。  默认值：6  单位：vp  取值范围：(0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 设置Swiper组件圆点导航指示器的颜色。  默认值：'#1A182431'，浅灰色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 设置选中Swiper组件圆点导航指示器的颜色。  默认值：'#007DFF'，蓝色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| space | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 是 | 设置圆点导航点间距，不支持设置百分比。  默认值：PC/2in1设备上为10，其他设备为8。  单位：vp  取值范围：[0, +∞) |
...
数字导航点文本最大的字体缩放倍数[maxFontScale](../../文本与输入/Text/ts-basic-components-text.md#maxfontscale12)为2。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 设置Swiper组件数字导航点的字体颜色。  默认值：'#ff182431' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 设置选中Swiper组件数字导航点的字体颜色。  默认值：'#ff182431' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 是 | 设置Swiper组件数字导航点的字体样式。  只支持Font中size和weight参数，family和style设置不生效。  默认值：  { size: 14, weight: FontWeight.Normal } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 是 | 设置选中Swiper组件数字导航点的字体样式。  默认值：  { size: 14, weight: FontWeight.Normal } |
...
| backgroundSize | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置底板大小。  在导航点两侧显示：  默认值：24vp  在组件两侧显示：  默认值：32vp  不支持设置百分比。 |
| backgroundColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 设置底板颜色。  在导航点两侧显示：  默认值：'#00000000'  在组件两侧显示：  默认值：'#19182431' |
| arrowSize | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置箭头大小。  在导航点两侧显示时：  默认值：18vp  在组件两侧显示时：  默认值：24vp  **说明：**  showBackground为true时，arrowSize为backgroundSize的3/4。  不支持设置百分比。 |
| arrowColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 设置箭头颜色。  默认值：'#182431' |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| minSize | [VP](../../公共定义/基础类型定义/ts-types.md#vp10) | 否 | 否 | 设置元素显示最小宽度。  默认值：0 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](../../公共定义/基础类型定义/ts-types.md#callback12)<number> | 是 | 当前显示元素的索引。 |
...
* 调用此回调后，切换动画的逻辑将在渲染线程中执行，从而使处于空闲状态的主线程能够充分利用这段时间来加载子组件所需资源，减少后续在cachedCount范围内节点的预加载时间。最佳实践请参考[优化Swiper组件加载慢丢帧问题-提前加载数据](../../../../../best-practices/性能/性能场景优化案例/界面渲染性能优化/Swiper组件加载丢帧优化/bpta-swiper_high_performance_development_guide.md#section8783121513246)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](../../公共定义/基础类型定义/ts-types.md#callback12)<number> | 是 | 当前选中元素的索引。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](../../公共定义/基础类型定义/ts-types.md#callback12)<number> | 是 | 将要隐藏元素的索引。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](../../公共定义/基础类型定义/ts-types.md#callback12)<[ScrollState](../List/ts-container-list.md#scrollstate枚举说明)> | 是 | 滑动状态变化的回调。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| left | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置导航点左侧相对于Swiper的位置。  未设置left和right时，进行自适应大小布局，按照指示器本身大小和Swiper的大小在主轴方向上进行居中对齐  设置为0时：按照0位置布局计算  优先级：高于right属性  取值范围：[0,Swiper宽度-导航点区域宽度]，超出该范围时，取最近的边界值。 |
| top | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置导航点顶部相对于Swiper的位置。  未设置top和bottom时，进行自适应大小布局，按照指示器本身大小和Swiper的大小，在交叉轴方向上，位于底部，效果与设置bottom=0一致  设置为0时：按照0位置布局计算  优先级：高于bottom属性  取值范围：[0,Swiper高度-导航点区域高度]，超出该范围时，取最近的边界值。 |
| right | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置导航点右侧相对于Swiper的位置。  未设置left和right时，进行自适应大小布局，按照指示器本身大小和Swiper的大小在主轴方向上进行居中对齐  设置为0时：按照0位置布局计算  优先级：低于left属性  取值范围：[0,Swiper宽度-导航点区域宽度]，超出该范围时，取最近的边界值。 |
| bottom | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置导航点底部相对于Swiper的位置。  未设置top和bottom时，进行自适应大小布局，按照指示器本身大小和Swiper的大小，在交叉轴方向上，位于底部，效果与设置bottom=0一致  设置为0时：按照0位置布局计算  优先级：低于top属性  取值范围：[0,Swiper高度-导航点区域高度]，超出该范围时，取最近的边界值。 |
| size | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置导航点的直径，不支持设置百分比。  默认值：6vp |
| mask | boolean | 否 | 是 | 设置是否显示导航点蒙层样式。  true：显示导航点蒙层样式，false：不显示导航点蒙层样式。  默认值：false |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 设置导航点的颜色。  默认值：'#1A182431'，浅灰色。 |
| selectedColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 设置选中的导航点的颜色。  默认值：'#007DFF'，蓝色。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/9vuepiw9QjGka8jVAU0ndQ/zh-cn_image_0000002622859547.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=40CD1093943C900C1D68DF48B77B55DC7E6D658EEA1B339C33500EFE1581E20E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5/v3/pgZ7AQmUTN2iLJxyl99MiQ/zh-cn_image_0000002622699667.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=AB68EF3640957BE3AC8415212266E9F5A9475E0DB7D6E6401F8751F2F4F369D3)
...
51. .cachedCount(1, { independent: true }) // 从API version 24开始，新增CachedCountOptions.independent参数。在显示区域外各缓存一个子节点，和displayCount的按组显示数量解耦
52. .autoPlay(true)
53. .interval(4000)
54. .loop(true)
55. .duration(1000)
56. .itemSpace(10)
57. .indicator( // 设置圆点导航点样式
58. new DotIndicator()
59. .itemWidth(15)
60. .itemHeight(15)
61. .selectedItemWidth(15)
62. .selectedItemHeight(15)
63. .color(Color.Gray)
64. .selectedColor(Color.Blue))

66. Row({ space: 12 }) {
67. Button('showNext')
68. .onClick(() => {
69. this.swiperController.showNext();
70. })
71. Button('showPrevious')
72. .onClick(() => {
73. this.swiperController.showPrevious();
74. })
75. }.margin(5)
76. }.width('100%')
77. .margin({ top: 5 })
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/-h9DN8QBQyKN12GyYuhbew/zh-cn_image_0000002592220106.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=CD3F654065DBD02805DC1D15186BD4740C68B81C144EB8E9812EDA0D9C8063D2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/-__bs77oR8-Cb9fWImJEsA/zh-cn_image_0000002592380040.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=3C24A59B92992BD13C058C81A9733221D5C463A3168CED61C3881F81716B4148)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/xSoI_zBGRqas4qNaFOPriQ/zh-cn_image_0000002622859549.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=BA9A4FCE403F3F1D759F16D36137F1AE3F8DEDCDEC9A9BD7A51B4C3C9C115ED8)
...
该示例通过[onSelected](ts-container-swiper.md#onselected18)接口，实现了[Tabs](../../导航与切换/Tabs/ts-container-tabs.md)与Swiper联动切换。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/altKmG2FTdmn2JrrJEldkw/zh-cn_image_0000002622699669.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=93591A048C621959D4DCB7057AFB78DEAC986E57B39E37E02F68E16A829B0C27)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/Xt1sk9A6RR-mWiqCTZTz4A/zh-cn_image_0000002592220108.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=8E7CD54EE4793A1D268EE4D9907697B8A0B43758CA4D4081B8353E77DBA6F2F9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/r5YJrKgrRPeVkG2zTvPE-w/zh-cn_image_0000002592380042.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=289AFEF343FFD8661BA9E7726275365F2362A3B14B2262000C2D05789EF6E2F9)
...
Swiper宽度属于[sm](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/组件布局/构建布局/栅格布局 (GridRowGridCol)/arkts-layout-development-grid-layout.md#栅格容器断点>)及更小的断点区间时显示1列。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/b-qBE-mSSQW6tzNZBitEbw/zh-cn_image_0000002622859551.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=8745F8AB13BA24706E8B04C47B86C08EFA8EB38863677D955100FDBCFA0E9A37)

Swiper宽度属于[md](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/组件布局/构建布局/栅格布局 (GridRowGridCol)/arkts-layout-development-grid-layout.md#栅格容器断点>)断点区间时显示2列。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/IZcaan5RSt21AVFIMmfyGw/zh-cn_image_0000002622699671.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=EE9994A01EB07D57BF1C113E1E2BD11664E72346A3DEDA7721B6AAC10020326B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/76/v3/AepfpUvVTVepI0FbPUR6Yw/zh-cn_image_0000002592220110.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074613Z&HW-CC-Expire=86400&HW-CC-Sign=D3A843585533EA883858AE0287D1F8AF7B4FC544C464F369B9FAADC96F0AFDDD)
