...
scraped_at: 2026-06-11T15:46:12+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:3a86e6cea37da55f4c62377ce2918b0f2daf7770bf96bb1b0d19de8c2cc5e932
---
...
仅支持[GridItem](../GridItem/ts-container-griditem.md)子组件和自定义组件。自定义组件在Grid下使用时，建议使用GridItem作为自定义组件的顶层组件，不建议给自定义组件设置属性和事件方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scroller | [Scroller](../Scroll/ts-container-scroll.md#scroller) | 否 | 可滚动组件的控制器。用于与可滚动组件进行绑定。  **说明：**  不允许和其他滚动类组件，如：[ArcList](../ArcList/ts-container-arclist.md)、[List](../List/ts-container-list.md)、[Grid](ts-container-grid.md)、[Scroll](../Scroll/ts-container-scroll.md)和[WaterFlow](../WaterFlow/ts-container-waterflow.md)绑定同一个滚动控制对象。 |
...
为提高Grid在跳转、列数变化等场景的性能，应该尽量使用GridLayoutOptions。即使Grid中没有任何特殊的跨行跨列节点，也可以通过使用'Grid(this.scroller, {regularSize: [1, 1]})'的方式提高跳转性能。参考[优化Grid组件加载慢丢帧问题](../../../../../best-practices/性能/性能场景优化案例/界面渲染性能优化/Grid组件加载丢帧优化/bpta-improve_grid_performance.md)。
...
Grid组件使用通用属性[clip12+](../../通用属性/视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip12)和通用属性[clip18+](../../通用属性/视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip18)时默认值都为true。

设置Grid的padding后，如果子组件部分位于Grid内容区且部分位于padding区域内，则会显示；如果子组件完全位于padding区域内，则不会显示。如下图所示，GridItem1显示，而GridItem2不显示。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/-bth0gEFQECHBms1GPaZuQ/zh-cn_image_0000002622699647.png?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=D1C791579DB6FA37F4C01550BDFC82EF60620F5694BD7ADE4F62E9E4ED64D480)
...
当value设置为ItemFillPolicy类型时，将根据Grid组件宽度对应[断点类型](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/组件布局/构建布局/栅格布局 (GridRowGridCol)/arkts-layout-development-grid-layout.md#栅格容器断点>)确定列数。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | [ItemFillPolicy](../../公共定义/基础类型定义/ts-types.md#itemfillpolicy22) | 是 | 当前网格组件布局列的数量。 |
...
* 此模式下GridItem交叉轴方向尺寸与网格一致，可以通过设置[constraintSize](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#constraintsize)中的maxWidth或maxHeight限制GridItem交叉轴方向尺寸小于网格。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 列与列的间距。  默认值：0  取值范围：[0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 行与行的间距。  默认值：0  取值范围：[0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BarState](../../公共定义/枚举说明/ts-appendix-enums.md#barstate) | 是 | 滚动条状态。  默认值：BarState.Auto  **说明：**  API version 9及以下版本默认值为BarState.Off，API version 10及以上版本的默认值为BarState.Auto。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Color](../../公共定义/枚举说明/ts-appendix-enums.md#color) | number | string | 是 | 滚动条的颜色。  默认值：'#182431'（40%不透明度）  number为HEX格式颜色，支持rgb或者argb，示例：0xffffff。  string为rgb或者argb格式颜色，示例：'#ffffff'。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Color](../../公共定义/枚举说明/ts-appendix-enums.md#color) | number | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 是 | 滚动条的颜色。  默认值：'#182431'（40%不透明度）  number为HEX格式颜色，支持rgb或者argb，示例：0xffffff。string为rgb或者argb格式颜色，示例：'#ffffff'。 |
...
设置预加载的GridItem的数量，只在[LazyForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md>)和开启了[virtualScroll](../../状态管理与渲染控制/Repeat/ts-rendering-control-repeat.md#virtualscroll)开关的[Repeat](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/Repeat：可复用的循环渲染/arkts-new-rendering-control-repeat.md>)中生效。
...
设置缓存后会在Grid显示区域上下各缓存cachedCount\*列数个GridItem。配合裁剪[clip](../../通用属性/视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip12)或内容裁剪[clipContent](../滚动组件通用接口/ts-container-scrollable-common.md#clipcontent14)属性可以显示出预加载节点。
...
设置Grid是否进入编辑模式，进入编辑模式可以拖拽Grid组件内部[GridItem](../GridItem/ts-container-griditem.md)。
...
设置是否开启鼠标框选。开启框选后，可以配合GridItem的selected属性和onSelect事件获取GridItem的选中状态，还可以通过[多态样式](../../通用属性/多态样式/ts-universal-attributes-polymorphic-style.md)设置GridItem的选中态样式（GridItem默认无选中态样式）。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [EdgeEffect](../../公共定义/枚举说明/ts-appendix-enums.md#edgeeffect) | 是 | Grid组件的边缘滑动效果，支持弹簧效果和阴影效果。  默认值：EdgeEffect.None |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [NestedScrollOptions](../滚动组件通用接口/ts-container-scrollable-common.md#nestedscrolloptions10对象说明) | 是 | 嵌套滚动选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 是 | 摩擦系数。  默认值：非可穿戴设备为0.6，可穿戴设备为0.9。  从API version 11开始，非可穿戴设备默认值为0.7。  从API version 12开始，非可穿戴设备默认值为0.75。  取值范围：(0, +∞)，设置为小于等于0的值时，按默认值处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| alignment | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[GridItemAlignment](ts-container-grid.md#griditemalignment12枚举说明)> | 是 | 设置Grid中GridItem的对齐方式。  默认值：GridItemAlignment.DEFAULT |
...
由于拖拽检测也需要长按，且事件处理机制优先触发子组件事件，GridItem上绑定[LongPressGesture](../../手势处理/基础手势/LongPressGesture/ts-basic-gestures-longpressgesture.md#longpressgesture-1)时无法触发拖拽。如有长按和拖拽同时使用的需求可以使用通用拖拽事件。
...
网格滑动开始时触发。手指拖动网格或网格的滚动条触发的滑动开始时，会触发该事件。使用[Scroller](../Scroll/ts-container-scroll.md#scroller)滑动控制器触发的带动画的滑动，动画开始时会触发该事件。
...
网格滑动停止时触发。手指拖动网格或网格的滚动条触发的滑动，手指离开屏幕后滑动停止时会触发该事件。使用[Scroller](../Scroll/ts-container-scroll.md#scroller)滑动控制器触发的带动画的滑动，动画停止会触发该事件。
...
onScroll(event: (scrollOffset: number, scrollState: [ScrollState](../List/ts-container-list.md#scrollstate枚举说明)) => void)

网格滑动时触发。

说明

从API version 10开始支持，从API version 12开始废弃，建议使用[onDidScroll](../滚动组件通用接口/ts-container-scrollable-common.md#ondidscroll12)替代。
...
| scrollState | [ScrollState](../List/ts-container-list.md#scrollstate枚举说明) | 是 | 当前滑动状态。 |
...
frameNode中[getEvent('Grid')](<../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#geteventgrid19>)方法的返回值，可用于给Grid节点设置滚动事件。

UIGridEvent继承于[UIScrollableCommonEvent](../滚动组件通用接口/ts-container-scrollable-common.md#uiscrollablecommonevent19)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/49T-MtHoSo-ppc3pd9VLdA/zh-cn_image_0000002592220086.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=46E193602C2412A722B9B498BF51EDE776E14C4B7F99E6506C4A415C1C72ACDE)

### 示例2（可滚动Grid和滚动事件）

可滚动Grid，包括所有滚动属性和事件。

GridDataSource实现了LazyForEach数据源接口[IDataSource](../../状态管理与渲染控制/LazyForEach/ts-rendering-control-lazyforeach.md#idatasource)，用于通过LazyForEach给Grid提供子组件。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/mPiq5hXJS3eVGiFMNUDFAw/zh-cn_image_0000002592380020.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=DC7D09FE0B06F44EA285875F4024119223E9B81AF647E17E9BE8B3F47842F99C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/gYYhabrXQGC97wVrYJclVg/zh-cn_image_0000002622859529.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=84E702E6B36883A7EC888F27A3741BB8C98A7E175318EE6F4EBB92B417417247)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/JvsldbzLRl2bsCEx3VdF8A/zh-cn_image_0000002622699649.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=3367E228DCA7C266ACA060E911A0CC9E235DA15937BBB9B15528626D251608DF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/l2GGa1TmTSG2JwddVfwYRw/zh-cn_image_0000002592220088.png?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=7263EC1E8C46E799C7590486C02FC9CB3EBC1DCF92179F97F656DACDBEFACC11)

网格子组件拖拽过程中：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/46/v3/bkhiyti0Qkel-cpa9k68Ig/zh-cn_image_0000002592380022.png?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=A09CFDCA3E5DAFD91FE6B02EA9178EBE28CEC34D99E4DF34768F1BCCDFE710DF)

网格子组件1与子组件6拖拽交换位置后：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/76/v3/GXOKdZRjQdacBZK1X_vqKQ/zh-cn_image_0000002622859531.png?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=CA767F7F0FBDE4FAAFB12CF53E4F220E0B845BA10577A2B323A9FBC523AA17FA)

拖拽动画：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/H7LNjdsqR_CBlJis2I-gmw/zh-cn_image_0000002622699651.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=9C0E556C81F3EE87841F4CFCF3BC4D056886234E1E1EC6ADFD3DD56CA47DF771)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/A4_bgTQnR_SwHYCO6_E8mg/zh-cn_image_0000002592220090.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=BBB0D51A5E9F911441E0F6DAB9DC4D02D259F6EEB1EB7F2AD51949D23BE58C66)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/zQmc7yNqTgik3HcGt0qGHw/zh-cn_image_0000002592380024.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=AE0334D676AE2343193DA88F6C54251770C229951903996E780965435FEDB89D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/49aZgtTlSz6VwLoyiKdyEA/zh-cn_image_0000002622859533.png?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=D31BB10F54143E3415A95634919E042F561E50BF89BA90643D44D5086F09A7B3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/zwcud6GXSAq5YCQLgPyRkw/zh-cn_image_0000002622699653.png?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=56BD8ADDDC4B454A713D5C08F5D660E0669C0CBB90E51DBD08766372DCD3D4F6)

### 示例10（设置边缘渐隐）

通过[fadingEdge](../滚动组件通用接口/ts-container-scrollable-common.md#fadingedge14)属性来设置边缘渐隐效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/r3qJLReSRj2EztGFyGLwzw/zh-cn_image_0000002592220092.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=31A2B288773DB072F169D19A208BEE4B474129CE7A9116BB1C413A20A32FB06C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/4BXeSLBnQgGJw7L502uZ7w/zh-cn_image_0000002592380026.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=9B7C16BFFE04958150EF5385F802085C4D6EFBEDE00FD3A5814A9963DC3707BE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/xQm-8qo9QYagTjHi8UzKwg/zh-cn_image_0000002622859535.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=0E0B56BB51C2DA2FF71362AD886DB131EB80EB1E4D0AD1DDD34050F5EBC1DD02)

### 示例13（设置滚动事件）

该示例通过FrameNode中的[getEvent('Grid')](<../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#geteventgrid19>)获取[UIGridEvent](ts-container-grid.md#uigridevent19)，并为Grid设置滚动事件回调，用于事件监听方因无法直接修改页面代码而无法使用声明式接口设置回调的场景。
...
该示例通过[scrollToIndex](../Scroll/ts-container-scroll.md#scrolltoindex)接口，实现了Grid组件滚动到指定位置。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/aUeOg5toR7CJXgkQ3_tOUw/zh-cn_image_0000002622699655.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=DE6C0753AD1BFF4300AC48F83EB6AC7C7B59D0B9B854E81F5DE81AE24BA91921)

### 示例15（实现Grid滑动选择）

该示例通过[PanGesture](../../手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md#pangesture-1)接口，实现了Grid组件一边滑动一边选择的效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/t_VojZIoS76sxk3QvJKG7g/zh-cn_image_0000002592220094.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=58335B4FE357509D6093793168B535C8932D04A8787BD9EFB2E450FDB15BEF97)

### 示例16（实现GridItem自定义拖拽）

该示例通过[gesture](../../手势处理/绑定手势/绑定手势事件/ts-gesture-settings.md#gesture)接口，实现了GridItem组件自定义拖拽效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/MhFQawhDTd6368ArjJf5JA/zh-cn_image_0000002592380028.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=9EE3EDBA8FBEF83FD97E221FFD9E8F443B9646D3D892EE2B05EB635897DE36D0)

### 示例17（通过拖拽事件实现GridItem拖拽）

该示例通过[拖拽事件](../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md)实现拖拽GridItem到Grid边缘时Grid自动滚动的功能。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/yIHaFEoTRrmaW7_NCuqgcg/zh-cn_image_0000002622859537.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=9A79BD6A6EFBCCA239C59502DD087A9B1A71CF422FF511AFF84063B08AF76342)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/xsMfQIGPR56Ai9yPdGxnCg/zh-cn_image_0000002622699657.png?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=A23446B7AB542961E7CE7042671CC3D1E3B8E4534CE9C96F5A4AE4BE39099BBB)

Grid宽度属于md断点区间时显示3列。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/HTRGhkGCSzq4mihU3W44ew/zh-cn_image_0000002592220096.png?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=23FAB76AF10F8C844712A6491ABCEBCE88DD5290664CDAA8DC89DB1D39065EEA)

Grid宽度属于lg及更大的断点区间时显示5列。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/DOV4TtiFSd6FcyKygaGOGA/zh-cn_image_0000002592380030.png?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=096F7E8674DEC7DF6374CD3B91F96CB010EECB252076848A20C683C7F591E6DF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/23/v3/zY5S1E1QS6O97v6E-Dxi8g/zh-cn_image_0000002622859539.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=BB1D9DD96B0759CE498A57761BED6916150DCC7386930DA32850A65D52B53857)

### 示例20（设置多选聚拢动画）

该示例通过打开Grid多选聚拢动画开关，实现了在GridItem上长按弹出菜单时，通过[bindContextMenu](../../通用属性/弹窗控制/菜单控制/ts-universal-attributes-menu.md#bindcontextmenu8)聚拢显示范围内被选中的GridItem的效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/BVl2AZ8pS3yUoMwTeYpvIw/zh-cn_image_0000002622699659.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074608Z&HW-CC-Expire=86400&HW-CC-Sign=C7FF4A56E9F1A335D8A1D0445D8690A7E154413B564723A556D70694BD58CF97)
