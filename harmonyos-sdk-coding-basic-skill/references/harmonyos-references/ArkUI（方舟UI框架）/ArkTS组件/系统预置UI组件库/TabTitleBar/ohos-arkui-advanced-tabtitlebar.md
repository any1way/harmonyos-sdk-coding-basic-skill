...
scraped_at: 2026-06-11T15:50:29+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:94ddc497831b17b0c7f8cfcdfe19bd7cf44311244b537e78a47dd602ed08d7e8
---
...
* 该组件仅可在Stage模型下使用。
* 如果TabTitleBar设置[通用属性](../../通用属性/ts-component-general-attributes.md)和[通用事件](../../通用事件/ts-component-general-events.md)，编译工具链会额外生成节点\_\_Common\_\_，并将通用属性或通用事件挂载在\_\_Common\_\_上，而不是直接应用到TabTitleBar本身。这可能导致开发者设置的通用属性或通用事件不生效或不符合预期，因此，不建议TabTitleBar设置通用属性和通用事件。
...
| label13+ | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 图标标签描述。  **元服务API：** 从API version 13开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| title | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 文字页签。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| icon | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 图片页签资源。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| symbolStyle18+ | [SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier) | 否 | 是 | Symbol图片页签资源，优先级大于icon。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/zOcDMRZATI-DcSp53YHYXQ/zh-cn_image_0000002592380540.png?HW-CC-KV=V1&HW-CC-Date=20260611T075028Z&HW-CC-Expire=86400&HW-CC-Sign=8C9F4B5B56F05D39A174BFA205B2F4A441A404422D460EEDB856DC75B38E117A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/cOBWqEFLRui6aoDnoaa4vw/zh-cn_image_0000002622860051.png?HW-CC-KV=V1&HW-CC-Date=20260611T075028Z&HW-CC-Expire=86400&HW-CC-Sign=F1444BDB8FAEFD197958E08E5A26F5B16D45098EF0CF6308F5077B0ADA7863A5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/gxu1IUJXSa2tBqvLbxneHg/zh-cn_image_0000002622700169.png?HW-CC-KV=V1&HW-CC-Date=20260611T075028Z&HW-CC-Expire=86400&HW-CC-Sign=673E9A93BC2DCE7AA2CB34BBF3AF95DA02213744825B405B018DDEAA55D9C074)
