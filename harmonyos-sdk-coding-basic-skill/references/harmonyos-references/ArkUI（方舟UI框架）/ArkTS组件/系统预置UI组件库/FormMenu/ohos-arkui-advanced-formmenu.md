...
content_hash: sha256:7764cab638c982f9652f8d4013312bdbf8fbc80a0795d2f7ed346cab6575950c
---
...
卡片具体开发指导请参考[卡片开发指南](<../../../../../harmonyos-guides/应用框架/Form Kit（卡片开发服务）/Form Kit简介/formkit-overview.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md#want>) | 是 | 待发布功能组件的want信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| formBindingData | [formBindingData.FormBindingData](<../../../../Form Kit（卡片开发服务）/ArkTS API/@ohos.app.form.formBindingData (卡片数据绑定类)/js-apis-app-form-formbindingdata.md#formbindingdata>) | 否 | 是 | 卡片数据。 |
| callback | AsyncCallback<string> | 否 | 是 | 返回添加卡片是否成功的结果回调。返回为0表示卡片添加成功，非0表示卡片添加失败，失败时请参考[卡片错误码信息](<../../../../Form Kit（卡片开发服务）/错误码/卡片错误码/errorcode-form.md>)进行排查。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| options | [MenuItemOptions](../../菜单/MenuItem/ts-basic-components-menuitem.md#menuitemoptions对象说明) | 否 | 是 | 包含设置MenuItem的各项信息。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7/v3/kXS7U8DlQqCeyrPC5aZkww/zh-cn_image_0000002592380520.jpeg?HW-CC-KV=V1&HW-CC-Date=20260611T075009Z&HW-CC-Expire=86400&HW-CC-Sign=E941B307A812DB52B5F7C18CFC014F4B50E622B88AB561166BF49E89333F84E5)

**调用高级自定义控件桌面加桌结果**

左侧是formbindingdata为空加桌结果，右侧是formbindingdata为{ data: 'share' }的加桌结果。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/B_d8I_5TRlCdZ0Hd7Jk5tA/zh-cn_image_0000002622860031.jpeg?HW-CC-KV=V1&HW-CC-Date=20260611T075009Z&HW-CC-Expire=86400&HW-CC-Sign=3888568112E276DED8A7E6B711858EA3F74BD9CE53E11F5C270E6EFAED7488C7)
