...
scraped_at: 2026-06-11T15:50:03+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:a72ee97c83abc40665d1ce696d13976a5088c8756c8dd08c768b101ec3e3dd38
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| iconSize | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | 下载控件上图标的尺寸，不支持百分比。  默认值：16vp |
...
| fontSize | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | 下载控件上文字的尺寸，不支持百分比。  默认值：16fp |
| fontStyle | [FontStyle](../../公共定义/枚举说明/ts-appendix-enums.md#fontstyle) | 否 | 是 | 下载控件上文字的样式。  默认值：FontStyle.Normal |
| fontWeight | number|[FontWeight](../../公共定义/枚举说明/ts-appendix-enums.md#fontweight)|string | 否 | 是 | 下载控件上文字粗细，number类型取值[100, 900]，取值间隔为100，默认为400，取值越大，字体越粗。string类型仅支持number类型取值的字符串形式，例如"400"，以及"bold"、"bolder"、"lighter"、"regular"、"medium"，分别对应FontWeight中相应的枚举值。  默认值：FontWeight.Medium |
| fontFamily | string|[Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 是 | 下载控件上文字的字体。  默认字体：'HarmonyOS Sans' |
| fontColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 下载控件上文字的颜色。  默认值：#ffffffff |
| iconColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 下载控件上图标的颜色。  默认值：#ffffffff |
| textIconSpace | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | 下载控件中图标和文字的间距。  默认值：4vp |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/3W3Axa2fT8iUaMXJkhjniA/zh-cn_image_0000002592380504.png?HW-CC-KV=V1&HW-CC-Date=20260611T075001Z&HW-CC-Expire=86400&HW-CC-Sign=C3B9D2E5C018CCDEA2BDAC7C17AC7EEC5A11EBD2F080E00B6B898538359A71E8)
