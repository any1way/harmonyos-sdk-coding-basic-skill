...
content_hash: sha256:4e6ae5fdf4cdcae0ca1d7c3ab7d384aed7e290d17a84a93213a70da39d0db551
---
文本选择菜单，适用于[RichEditor](../../文本与输入/RichEditor/ts-basic-components-richeditor.md)组件通过[bindSelectionMenu](../../文本与输入/RichEditor/ts-basic-components-richeditor.md#bindselectionmenu)或[Text](../../文本与输入/Text/ts-basic-components-text.md)组件通过[bindSelectionMenu](../../文本与输入/Text/ts-basic-components-text.md#bindselectionmenu11)绑定自定义文本选择菜单，建议绑定鼠标右键或者鼠标选中方式弹出，不支持作为普通组件单独使用。
...
入参为空时，文本选择菜单组件SelectionMenu内容区大小及组件大小为零。表现例如，富文本组件[RichEditor](../../文本与输入/RichEditor/ts-basic-components-richeditor.md)使用[bindSelectionMenu](../../文本与输入/RichEditor/ts-basic-components-richeditor.md#bindselectionmenu)接口绑定一个SelectionMenu的右键菜单，则右键富文本组件区域时无任何菜单弹出。

**装饰器类型：**[@Builder](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md>)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| icon | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 图标资源。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| symbolStyle18+ | [SymbolGlyphModifier](../../文本与输入/输入框类组件通用接口/ts-universal-attributes-text-style.md#symbolglyphmodifier12) | 否 | 是 | Symbol图标资源，优先级大于icon。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
...
继承于[MenuItemOptions](../../菜单/MenuItem/ts-basic-components-menuitem.md#menuitemoptions对象说明)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| content | [RichEditorSelection](../../文本与输入/RichEditor/ts-basic-components-richeditor.md#richeditorselection) | 否 | 是 | 选中内容信息。 |

## 属性

PhonePC/2in1TabletTVWearable

不支持[通用属性](../../通用属性/ts-component-general-attributes.md)，宽度默认224vp， 高度自适应内容。
...
310. })
311. // 绑定鼠标右键操作自定义菜单
312. .bindSelectionMenu(RichEditorSpanType.TEXT, this.MyMenu3(), RichEditorResponseType.RIGHT_CLICK)
313. // 绑定鼠标选中操作自定义菜单
314. .bindSelectionMenu(RichEditorSpanType.TEXT, this.MyMenu2(), RichEditorResponseType.SELECT)
315. .borderWidth(1)
316. .borderColor(Color.Red)
317. .width(200)
318. .height(200)
319. .margin(10)
320. }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/N9EeyIBzTEazbYKm1Rq9SA/zh-cn_image_0000002592380532.gif?HW-CC-KV=V1&HW-CC-Date=20260611T075020Z&HW-CC-Expire=86400&HW-CC-Sign=AD37BA3D3D458C0057560DC10EC6D0890CC2CB8FAA4436607F8FF7645A67E2EF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/pXCfWo73RZiDfl1AYimzjQ/zh-cn_image_0000002622860043.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T075020Z&HW-CC-Expire=86400&HW-CC-Sign=E3A5C28AA9F099DE5B947CD66F751F91CAED630C72F57D83CC00240C37E2D39A)
