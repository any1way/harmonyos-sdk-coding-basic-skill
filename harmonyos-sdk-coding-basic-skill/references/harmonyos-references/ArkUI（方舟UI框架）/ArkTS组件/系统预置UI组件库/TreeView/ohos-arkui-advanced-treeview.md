...
scraped_at: 2026-06-11T15:50:33+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:140b6e521ff460dac2684fb8d16b51c8bef23fe96b037d5bf6235596b36aa497
---
...
* 该组件仅可在Stage模型下使用。
* 如果TreeView设置[通用属性](../../通用属性/ts-component-general-attributes.md)和[通用事件](../../通用事件/ts-component-general-events.md)，编译工具链会额外生成节点\_\_Common\_\_，并将通用属性或通用事件挂载在\_\_Common\_\_上，而不是直接应用到TreeView本身。这可能导致开发者设置的通用属性或通用事件不生效或不符合预期，因此，不建议TreeView设置通用属性和通用事件。
...
| parentSubTitle | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 父节点副文本。 |
| currentSubtitle | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 当前节点副文本。 |
...
| icon | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 图标。  默认值：空字符串  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| symbolIconStyle18+ | [SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier) | 否 | 是 | Symbol图标，优先级大于icon。  默认值：undefined  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| selectedIcon | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 选中图标。  默认值：空字符串  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| symbolSelectedIconStyle18+ | [SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier) | 否 | 是 | Symbol选中图标，优先级大于selectedIcon。  默认值：undefined  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| editIcon | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 编辑图标。  默认值：空字符串  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| symbolEditIconStyle18+ | [SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier) | 否 | 是 | Symbol编辑图标，优先级大于editIcon。  默认值：undefined  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| primaryTitle | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 主标题。  默认值：空字符串  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| secondaryTitle | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 副标题。  默认值：空字符串  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/73/v3/m2GBvsblR3OiQQR47ySbcA/zh-cn_image_0000002622860053.png?HW-CC-KV=V1&HW-CC-Date=20260611T075031Z&HW-CC-Expire=86400&HW-CC-Sign=F9F29C51E12965179DCD7E86FB941CD7FD9E8EB0EEFBBDBA9BC3825B3F947811)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/2VQLvYP-Rpe6pEnym3xDdw/zh-cn_image_0000002622700171.png?HW-CC-KV=V1&HW-CC-Date=20260611T075031Z&HW-CC-Expire=86400&HW-CC-Sign=BC3E30E096CC68AF1C4D9DE408405B3B6282DADC9BB69C22C5BA18F246D5CF4A)
