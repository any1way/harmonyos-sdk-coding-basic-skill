...
scraped_at: 2026-06-01T15:43:25+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:2ccf80d5a4c18e5e28a3d2219e7724962c452ece2bca7572aac0da9f4ac4c476
---
...
| 类型 | 说明 |
| --- | --- |
| [Scene](<../../../../ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/Scene/js-apis-inner-scene.md#scene-1>) | 用于设置场景。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 3D环境资源。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 自定义渲染管线的配置文件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 自定义渲染的shader文件资源。详细.shader文件格式请参考[.shader资源文件格式要求](<../../../../../harmonyos-guides/图形/ArkGraphics 3D（方舟3D图形）/ArkGraphics 3D资源创建以及使用/.shader资源文件格式要求/arkgraphics3d-shader-resource.md>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 自定义渲染用到的纹理资源。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | 是 | 3D渲染分辨率的宽度，当前仅支持设置Dimension.Percentage，取值范围是[0, 100%]。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | 是 | 3D渲染分辨率的高度，当前仅支持设置Dimension.Percentage，取值范围是[0, 100%]。 |
