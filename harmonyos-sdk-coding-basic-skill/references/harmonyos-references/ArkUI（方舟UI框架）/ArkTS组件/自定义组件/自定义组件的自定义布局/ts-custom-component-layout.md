...
scraped_at: 2026-06-11T15:49:47+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:7a115e698dda93e2756b419a0054819fbf22d511508bff42fa190257e1b6dafd
---
...
从API version 20开始，在自定义布局的自定义组件中，子组件若设置了[LayoutPolicy](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#layoutpolicy15)对象的fixAtIdealSize属性，表示尺寸将不受父组件约束，完全按照开发者自定义的尺寸范围布局。

自定义布局内不支持使用懒加载(包含[Repeat](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/Repeat：可复用的循环渲染/arkts-new-rendering-control-repeat.md>)和[LazyForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md>))。
...
| constraint | [ConstraintSizeOptions](../../公共定义/基础类型定义/ts-types.md#constraintsizeoptions) | 是 | 自定义组件的布局约束信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| borderWidth | [EdgeWidth](../../公共定义/基础类型定义/ts-types.md#edgewidths9) | 否 | 否 | 父组件（自定义组件）边框宽度。  单位：vp。 |
| margin | [Margin](../../公共定义/基础类型定义/ts-types.md#margin) | 否 | 否 | 父组件（自定义组件）margin信息。  单位：vp。 |
| padding | [Padding](../../公共定义/基础类型定义/ts-types.md#padding) | 否 | 否 | 父组件（自定义组件）padding信息。  单位：vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Position](../../公共定义/基础类型定义/ts-types.md#position) | 是 | 绝对位置。 |
...
| 类型 | 说明 |
| --- | --- |
| [DirectionalEdgesT](../../公共定义/基础类型定义/ts-types.md#directionaledgestt12)<number> | 子组件的margin信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [DirectionalEdgesT](../../公共定义/基础类型定义/ts-types.md#directionaledgestt12)<number> | 子组件的padding信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [DirectionalEdgesT](../../公共定义/基础类型定义/ts-types.md#directionaledgestt12)<number> | 子组件的borderWidth信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| constraint | [ConstraintSizeOptions](../../公共定义/基础类型定义/ts-types.md#constraintsizeoptions) | 是 | 约束尺寸。 |
...
| constraint | [ConstraintSizeOptions](../../公共定义/基础类型定义/ts-types.md#constraintsizeoptions) | 是 | 父组件constraint信息。 |
...
| id | string | 否 | 否 | 子组件id。 |
| constraint | [ConstraintSizeOptions](../../公共定义/基础类型定义/ts-types.md#constraintsizeoptions) | 否 | 否 | 子组件约束尺寸。 |
| borderInfo | [LayoutBorderInfo](ts-custom-component-layout.md#layoutborderinfodeprecated) | 否 | 否 | 子组件border信息。 |
| position | [Position](../../公共定义/基础类型定义/ts-types.md#position) | 否 | 否 | 子组件位置坐标。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| childConstraint | [ConstraintSizeOptions](../../公共定义/基础类型定义/ts-types.md#constraintsizeoptions) | 是 | 子组件的尺寸范围的约束信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| borderWidth | [EdgeWidths](../../公共定义/基础类型定义/ts-types.md#edgewidths9) | 否 | 否 | 边框宽度类型，用于描述组件边框不同方向的宽度。 |
| margin | [Margin](../../公共定义/基础类型定义/ts-types.md#margin) | 否 | 否 | 外边距类型，用于描述组件不同方向的外边距。 |
| padding | [Padding](../../公共定义/基础类型定义/ts-types.md#padding) | 否 | 否 | 内边距类型，用于描述组件不同方向的内边距。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/K3Ei1kU3RdC9NyNLy9JLAw/zh-cn_image_0000002592220562.png?HW-CC-KV=V1&HW-CC-Date=20260611T074946Z&HW-CC-Expire=86400&HW-CC-Sign=5852528379CF974F8B7FBC9E4060930D2FD0C0D3131DB3FDF5823F9B7F6A61D9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/XYvMAyTKSVe4YSpFgLeXQw/zh-cn_image_0000002592380494.png?HW-CC-KV=V1&HW-CC-Date=20260611T074946Z&HW-CC-Expire=86400&HW-CC-Sign=36235F3907CB8EF2FC380DD8C8A43B782276AA7847DEFB140B1793B8CC859A07)

### 示例3（获取子组件FrameNode并设置相关属性）

通过uniqueId获取子组件的[FrameNode](<../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md>)，并调用FrameNode的API接口修改尺寸、背景颜色。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/S9itbQ2_RRSA7brVuhw98g/zh-cn_image_0000002622860005.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074946Z&HW-CC-Expire=86400&HW-CC-Sign=439E84A682105BC3C5D110F7DA5D90664A5860B40F0372941FF582A5CEFFE553)

### 示例4（子组件超过父组件大小约束）

在自定义布局的自定义组件中，为子组件设置了[LayoutPolicy](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#layoutpolicy15)对象的fixAtIdealSize属性。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/UWeIBFbcQnKbEyCN02gHhw/zh-cn_image_0000002622700123.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074946Z&HW-CC-Expire=86400&HW-CC-Sign=B61830594C84629E3D42F201C98A6780556B2A1E76FDD9D241C383C603C44747)
