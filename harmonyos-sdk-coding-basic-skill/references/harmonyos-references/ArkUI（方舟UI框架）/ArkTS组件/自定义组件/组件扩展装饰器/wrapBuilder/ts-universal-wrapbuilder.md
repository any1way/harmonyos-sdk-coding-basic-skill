...
content_hash: sha256:4fcf2d4868796d30b59009163032227474a136cb30a99c877b5ed905ca4a635c
---
使用wrapBuilder封装全局@Builder，可以帮助维护代码。开发指南见[wrapBuilder：封装全局@Builder](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/wrapBuilder：封装全局@Builder/arkts-wrapbuilder.md>)。
