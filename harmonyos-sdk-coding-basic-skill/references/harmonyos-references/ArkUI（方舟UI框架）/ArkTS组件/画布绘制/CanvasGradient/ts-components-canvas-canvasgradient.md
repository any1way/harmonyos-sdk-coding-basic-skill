...
scraped_at: 2026-06-11T15:48:15+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:275093bf9706a999a51dd9d2e8d97447d40be9c4d8dd9d7d8795a32827192132
---
渐变对象。
...
| color | string | 是 | 设置渐变的颜色。颜色格式参考[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)中string类型说明。  未按格式设置颜色无渐变效果。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/JIywvnR8T3OrZLofd5YU0w/zh-cn_image_0000002622699957.png?HW-CC-KV=V1&HW-CC-Date=20260611T074814Z&HW-CC-Expire=86400&HW-CC-Sign=FDF38FBC0FEDC63CDB3F72112982B8754E45E60036F0271DDC2029F30A9806FE)
...
设置渐变断点值，包括偏移和颜色。支持设置rgb或者argb格式颜色。支持通过传入[ColorMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12>)类型设置P3色域颜色值，可在支持高色域的设备上获得更丰富的色彩表现。
...
| color | string | [ColorMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12>) | 是 | 设置渐变填充的颜色。  可以使用[colorWithSpace](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colorwithspace20>)方法构造指定色域属性[ColorSpace](../../公共定义/枚举说明/ts-appendix-enums.md#colorspace20)为SRGB或DISPLAY\_P3的颜色。每个渐变ColorMetrics的色域属性应当统一，设置不同色域的属性时将抛出异常，错误码：103701。  设置null和undefined无效，忽略本次断点值。 |
...
仅[CanvasRenderingContext2D](../CanvasRenderingContext2D/ts-canvasrenderingcontext2d.md)对象的[fillStyle](../CanvasRenderingContext2D/ts-canvasrenderingcontext2d.md#fillstyle)和[strokeStyle](../CanvasRenderingContext2D/ts-canvasrenderingcontext2d.md#strokestyle)属性支持设置P3广色域的CanvasGradient对象，且需要将Canvas组件所在窗口的色域模式通过[setWindowColorSpace](<../../../ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setwindowcolorspace9>)方法设置为广色域模式WIDE\_GAMUT。

**示例：**

通过addColorStop设置指定色域的渐变断点值，包括偏移和颜色。设置窗口色域模式为广色域参照方法[setWindowColorSpace](<../../../ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setwindowcolorspace9>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/J7H8hu9GR2Gbs-QzvD153Q/zh-cn_image_0000002592220396.png?HW-CC-KV=V1&HW-CC-Date=20260611T074814Z&HW-CC-Expire=86400&HW-CC-Sign=3B137DF0B8EF33F8D70C98B540A46D454732D2EBAD44A372675DDE2DDEA3A0E4)
