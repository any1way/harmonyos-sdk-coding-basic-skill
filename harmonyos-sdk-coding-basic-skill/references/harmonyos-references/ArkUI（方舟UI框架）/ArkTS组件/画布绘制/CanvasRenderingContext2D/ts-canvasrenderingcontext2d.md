...
scraped_at: 2026-06-11T15:48:21+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:f42448b38316559ef80ca9817b45995b04909fbc43ecb23dbbc5b1485a2d4c44
---
...
* 本文绘制接口在调用时会存入被关联的Canvas组件的指令队列中。仅当当前帧进入渲染阶段且关联的Canvas组件处于可见状态时，这些指令才会从队列中被提取并执行。因此，在Canvas组件不可见的情况下，应尽量避免频繁调用绘制接口，以防止指令在队列中堆积，从而避免内存占用过大的问题，具体示例请参考[控制在画布组件不可见时不进行绘制](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义绘制/使用画布绘制自定义图形 (Canvas)/arkts-drawing-customization-on-canvas.md#控制在画布组件不可见时不进行绘制>)。
...
* Canvas组件的宽或高超过8000px时使用CPU渲染，会导致性能明显下降，此时推荐使用[自定义渲染节点 (RenderNode)](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用自定义能力/自定义节点/自定义渲染节点 (RenderNode)/arkts-user-defined-arktsnode-rendernode.md>)。
...
| --- | --- | --- | --- |
| settings | [RenderingContextSettings](ts-canvasrenderingcontext2d.md#renderingcontextsettings) | 否 | 用来配置CanvasRenderingContext2D对象的参数，见[RenderingContextSettings](ts-canvasrenderingcontext2d.md#renderingcontextsettings)。  异常值undefined和null按[RenderingContextSettings](ts-canvasrenderingcontext2d.md#renderingcontextsettings)的默认值处理。 |
| unit | [LengthMetricsUnit](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetricsunit12>) | 否 | 用来配置CanvasRenderingContext2D对象的单位模式，配置后无法更改。  异常值undefined、NaN和Infinity按默认值处理。  默认值：DEFAULT |

**示例：**

以下示例展示了配置CanvasRenderingContext2D对象的单位模式，默认单位模式为LengthMetricsUnit.DEFAULT，对应默认单位vp，配置后无法动态更改。详细说明见[LengthMetricsUnit](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetricsunit12>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/YTRBhkgYQxWwrhIEyBJHQg/zh-cn_image_0000002622859841.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=3DA203102042CEC60DF66A2298D3592882771E2A0777C9714C3F4172FA2C4D17)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/xbTzBM5OQ56Vbz_zb17wfA/zh-cn_image_0000002622699959.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=E6F08642CDC66E3D749F17D79880F861F85858495064F0A4BE1C3982220EBAA0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/fCtoMhf6Q8OYWBdpe2oh1w/zh-cn_image_0000002592220398.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=E06F3012F401F984ED4538D9B61F97B87AA38B7E0B819C42294F4BE98D2D989E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/rxUTS5H1Q4O8gbOrEdHmxg/zh-cn_image_0000002592380332.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=B009FDAB6D8BFFA6BC649FF4C98CC95DEA89E627673ED2192480C3A06C22BC3E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/b8-DgkEKSzml3t3aHvyA2Q/zh-cn_image_0000002622859843.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=DF20000A610674B75A967642445C9295037C9271214D68042616A3F6E5AC3946)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b2/v3/cwMh90SJRBez4dy8BcgmWQ/zh-cn_image_0000002622699961.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=500D4B99FBFDBF3BEA9B1A71BB397CC99464A9C8063930E5FA641CB0B084EB39)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/iv7WPP4_Q2-xz05CKB0-_A/zh-cn_image_0000002592220400.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=DE298817911FED96A9920663FE7E358A570C01F46D34BB770559CFFCAAE08BFE)
...
从API version 20开始，支持通过该接口设置注册过的自定义字体（DevEco Studio的预览器不支持显示自定义字体）。自定义字体注册有以下两种方式。一种是通过ArkUI的异步接口this.uiContext.getFont().[registerFont](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (Font)/arkts-apis-uicontext-font.md#registerfont>)注册，调用后立即绘制可能会导致自定义字体不生效。另一种是直接调用字体引擎的fontCollection.[loadFontSync](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#loadfontsync>)接口来注册自定义字体到字体引擎。在直接调用字体引擎接口注册自定义字体时，fontCollection的实例需要是text.FontCollection.getGlobalInstance()，因为组件默认会从该实例加载字体。如果使用其他实例，可能会导致自定义字体不生效。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1
png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=C52FE2C8193170F5ECF3C6B35E7A84300BD9D950C17815BED36A36FE3E65E6C1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/Qhq-opKZRMi2EYEhj2R4Tw/zh-cn_image_0000002622859871.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=06D8589083FBD41DF7A5F4FC3963329F66F56EFFB4F556FED2389417844974CF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/23/v3/nT492fuGSG-0Gpz4396MfA/zh-cn_image_0000002622699989.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=3EB05C9FBA1DF7C352F2DF22F8250D968115A83F5450F6AB3A92316A1831C5B2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/nM-o-Oj2SWOwQ7uvh7vKcA/zh-cn_image_0000002592220428.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=AB1A61F66F21403D61C87F299308DD2059E9F90F0D7A3BEDD020CA4AA35CA120)
...
创建新的、空白的、指定大小的ImageData 对象，请参考[ImageData](../ImageData/ts-components-canvas-imagedata.md)，该接口存在内存拷贝行为，高耗时，应避免频繁使用。createImageData示例同[putImageData](ts-canvasrenderingcontext2d.md#putimagedata)。
...
根据一个现有的ImageData对象重新创建一个宽、高相同的ImageData对象（不会复制图像数据），请参考[ImageData](../ImageData/ts-components-canvas-imagedata.md)，该接口存在内存拷贝行为，高耗时，应避免频繁使用。createImageData示例同[putImageData](ts-canvasrenderingcontext2d.md#putimagedata)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageData | [ImageData](../ImageData/ts-components-canvas-imagedata.md) | 是 | 现有的ImageData对象。  异常值undefined和null按width和height为0的ImageData处理。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/wbBXPRIrR7K0N7f4sNysUg/zh-cn_image_0000002592380362.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=A4A09D86BAA8D5ED30228AF2AF98F46F1E98C54631A6178253618EA9904C8443)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/6H7SFtYORFq6PdKopWkVHA/zh-cn_image_0000002622859873.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=2ADFCADBE2D90C45127DDF77F95D0EF809AEB21CA5BD5503A0A792EA5A22F357)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/nShwua-rRXeSq6JbE5qfvw/zh-cn_image_0000002622699991.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=9202F526C5049F583B0598FF255705F9BAE25D7E921BFA30D99EFAB86C4FC2A3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/zRgV3ooVR-GSmzgOnAjMXw/zh-cn_image_0000002592220430.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=9FBE5AC73E2403DC1B3BF13275AC9BBB384AA2F96F6E0281A716D47F7EE1390F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/4s4tUJN4RkW_DtdR3H0JXA/zh-cn_image_0000002592380364.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=E3D6688DE0870D6D0FCC95FA6E0694F305BA4610126B5536D8A46FB465BBD581)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/7bbrh8hWQh2b3TK_5wXHxg/zh-cn_image_0000002622859875.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=FB483E82FBCE2D968BE5125BC8D5900D151118CD0BD74039A9D20A16A5FC04DE)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bitmap | [ImageBitmap](../ImageBitmap/ts-components-canvas-imagebitmap.md) | 是 | 待显示的ImageBitmap对象。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/GfnXlMqdR3S8fnIkozLbrg/zh-cn_image_0000002622699993.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=0A5977C01D9D56FED75D65F1EBF848F4C27B237EEAFD31D8A0C5568C59A282E3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/18/v3/x2qAIIy-QA6q66aTtNb6iw/zh-cn_image_0000002592220432.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=F7D0E6EA02C7E92506B9A02DFE1508C595C062A417D199C3E763FBA8DB4A75E7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/vPDuViZDQV-0Fwuy7v4uCQ/zh-cn_image_0000002592380366.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=66DA85C2EE3831F00688E20A1EDF2D999C933F3F1E4A925962402DC63E055746)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/76/v3/pPJV0QrXS1ysgyrc4upWww/zh-cn_image_0000002592380366.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=9552E59241A2B739532BF5934C5D15DADEA7B9493DDABEB36CAE25E3F27E3954)
...
| 类型 | 说明 |
| --- | --- |
| [CanvasGradient](../CanvasGradient/ts-components-canvas-canvasgradient.md) | 新的CanvasGradient对象，用于在canvas上创建渐变效果。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/qw64v3yfS5qHvKsuhQJSAw/zh-cn_image_0000002622699957.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=35E5DF9148D0B15BF317FBD68D5DDD246D7F91E68B04D00EFA4ABE96E7A68733)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/09/v3/7yPSA-1LQ5GV4NC7cibeTg/zh-cn_image_0000002622859877.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=214D5ABBD4FEB2F02E8D41B12EFDC8DBB86C80F7BE6A5B5773A15E7B59F3F1E3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/eXnmlGqlQ0Gzzd8Mj8Mr-A/zh-cn_image_0000002622699995.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=C945C460EAB24FB4C3DBE298B588D4385DBCFFABD1FEF6790E58507622FDB384)
...
避免在'onAttach'中执行绘制方法，应保证Canvas组件已经'[onReady](../Canvas/ts-components-canvas-canvas.md#onready)'再进行绘制。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/mLuCY1hUTQ63t7CIUQgLyA/zh-cn_image_0000002592220434.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=65E8D381EEE1B4FE89CFF562C5DD8DC9F9A6635666DFDEC68B1523CEF05114C3)
...
配置并启动AI分析功能，使用Promise异步回调。使用前需先设置[enableAnalyzer](../Canvas/ts-components-canvas-canvas.md#enableanalyzer12)为true，启用图像AI分析能力。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ImageAnalyzerConfig](../../图片与视频/图像类型定义/ts-image-common.md#imageanalyzerconfig12) | 是 | 执行AI分析所需要的入参，用于配置AI分析功能。  异常值undefined或null按无效值处理。 |
...
以下错误码的详细介绍请参见[图像AI分析错误码](../../../错误码/UI界面/图像AI分析错误码/errorcode-image-analyzer.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9/v3/r7VdWb5DQMuLc0vHFMQ1dg/zh-cn_image_0000002592380368.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=E91A24DFD720BE0C6DBE0C755CBA2B376C3A42E2CE34A4CCDAED798162AEFF59)
...
* 从该接口获取的CanvasRenderingContext2D对象不允许作为参数创建[Canvas](../Canvas/ts-components-canvas-canvas.md)组件，否则会导致应用崩溃。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| drawingContext | [DrawingRenderingContext](../DrawingRenderingContext/ts-drawingrenderingcontext.md) | 是 | 一个DrawingRenderingContext类型的对象。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/94qOSBy_Ra2q6Z-mhs0buA/zh-cn_image_0000002622859879.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=EE78A47B75214FFA049F16F949DE121F9F8A89FE6D46928DA5015AF084BF8CC1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4f/v3/Tk_M_v5TSz-MLKckgTp9Wg/zh-cn_image_0000002622699997.png?HW-CC-KV=V1&HW-CC-Date=20260611T074816Z&HW-CC-Expire=86400&HW-CC-Sign=7CE79827D94E33E76E709E9294DF499FB3AE63CB7E2333567900B0F61780F718)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| antialias | boolean | 否 | 表明canvas是否开启抗锯齿。  异常值undefined按默认值处理。  false：表示不开启抗锯齿功能，true：表示开启抗锯齿。  默认值：false  **说明：**  绘制文本默认开启抗锯齿效果，RenderingContextSettings的antialias无法影响绘制文本的抗锯齿效果，如需修改文本抗锯齿效果，请使用[antialias24+](ts-canvasrenderingcontext2d.md#antialias24)接口。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| antialias | boolean | 否 | 是 | 表明canvas是否开启抗锯齿。  异常值undefined按默认值处理。  false：表示不开启抗锯齿功能，true：表示开启抗锯齿。  默认值：false  **说明：**  绘制文本默认开启抗锯齿效果，RenderingContextSettings的antialias无法影响绘制文本的抗锯齿效果，如需修改文本抗锯齿效果，请使用[antialias24+](ts-canvasrenderingcontext2d.md#antialias24)接口。 |
