...
scraped_at: 2026-06-11T15:48:27+08:00
doc_updated_at: 2026-05-19
content_hash: sha256:36d15c5a0a1e30f576677e6eefd3add6079513b30730140e73b768ca5a140afa
---
OffscreenCanvas组件用于绘制自定义图形。

使用[Canvas](../Canvas/ts-components-canvas-canvas.md)组件或[CanvasRenderingContext2D](../CanvasRenderingContext2D/ts-canvasrenderingcontext2d.md)对象时，渲染、动画和用户交互通常发生在应用程序的主线程上，与画布动画和渲染相关的计算可能会影响应用程序性能。OffscreenCanvas提供了一个可以在屏幕外渲染的画布，这样可以在单独的线程中运行一些任务，从而避免影响应用程序主线程性能。

说明

该组件从API version 8开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

OffscreenCanvas无法在ServiceExtensionAbility中使用，ServiceExtensionAbility中建议使用[绘制模块](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.drawing (绘制模块)/模块描述/arkts-apis-graphics-drawing.md>)进行离屏绘制。
...
| width | number | 是 | OffscreenCanvas组件的宽度。  异常值NaN和Infinity按无效值处理。  默认单位为vp。 |
| height | number | 是 | OffscreenCanvas组件的高度。  异常值NaN和Infinity按无效值处理。  默认单位为vp。 |
| unit | [LengthMetricsUnit](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetricsunit12>) | 是 | 用来配置OffscreenCanvas对象的单位模式，配置后无法动态更改，配置方法同[CanvasRenderingContext2D](../CanvasRenderingContext2D/ts-canvasrenderingcontext2d.md)。  异常值NaN和Infinity按默认值处理。  默认值：DEFAULT |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/MZ3e0C9RR8mzvCVui3AdlQ/zh-cn_image_0000002592220444.png?HW-CC-KV=V1&HW-CC-Date=20260611T074825Z&HW-CC-Expire=86400&HW-CC-Sign=CF72FD15EAE2C6CD08A65335C251EF03191536039E3A9DE82F6CC6C7C2F5EBC7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/sCD-6rXTRIit9yeaZS6Zmg/zh-cn_image_0000002592380376.png?HW-CC-KV=V1&HW-CC-Date=20260611T074825Z&HW-CC-Expire=86400&HW-CC-Sign=B981E35DEE0B336A5B298C03CCA6090EE838131702F367C2078458F399174786)
...
| 类型 | 说明 |
| --- | --- |
| [ImageBitmap](../ImageBitmap/ts-components-canvas-imagebitmap.md) | 创建的ImageBitmap对象。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/kqVgYVCnTHKPlZfuQh3H0A/zh-cn_image_0000002622859887.png?HW-CC-KV=V1&HW-CC-Date=20260611T074825Z&HW-CC-Expire=86400&HW-CC-Sign=A43BE84CD1D8EEEF675FFBE1E741C5B6FC2614FB5901CC4CC3ADBE86BD859B83)
...
| options | [RenderingContextSettings](../CanvasRenderingContext2D/ts-canvasrenderingcontext2d.md#renderingcontextsettings) | 否 | 用来配置OffscreenCanvasRenderingContext2D对象的参数，见[RenderingContextSettings](../CanvasRenderingContext2D/ts-canvasrenderingcontext2d.md#renderingcontextsettings)。  异常值undefined和null按[RenderingContextSettings](../CanvasRenderingContext2D/ts-canvasrenderingcontext2d.md#renderingcontextsettings)的默认值处理。  默认值：null |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [OffscreenCanvasRenderingContext2D](../OffscreenCanvasRenderingContext2D/ts-offscreencanvasrenderingcontext2d.md) | OffscreenCanvas组件的绘图上下文。如果getContext方法的入参contextType为"2d"以外类型（包括null或者undefined），返回undefined，使用前应判断返回值是否为undefined。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5f/v3/GcuieYqcRmqxACN6JyK2Pw/zh-cn_image_0000002622700005.png?HW-CC-KV=V1&HW-CC-Date=20260611T074825Z&HW-CC-Expire=86400&HW-CC-Sign=BC39FB76D4783D6E41FF33592B9CB9AB1E42F10B28766C0DA574004B86D3C52C)

## OffscreenCanvas支持并发线程绘制

PhonePC/2in1TabletTVWearable

从API version 11开始，当应用创建[Worker线程](../../../../../harmonyos-guides/应用框架/ArkTS（方舟编程语言）/ArkTS并发/多线程并发/Worker简介/worker-introduction.md)，支持使用postMessage将OffscreenCanvas实例传到Worker中进行绘制，并使用onmessage接收Worker线程发送的绘制结果进行显示。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4f/v3/4OJfhOd9T4KmYodgUMEknQ/zh-cn_image_0000002592220446.png?HW-CC-KV=V1&HW-CC-Date=20260611T074825Z&HW-CC-Expire=86400&HW-CC-Sign=E90EE39E3F201021D103A425D5FB27744C858056DE5CC124034E167FC541BB45)
