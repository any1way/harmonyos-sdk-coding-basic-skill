...
scraped_at: 2026-06-01T15:41:47+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:a413dece40433bb018a565d78ab695a5b15ae896ba3ea31529a8487cd7c5d0da
---
通过[toolbar](../../通用属性/其他/工具栏设置/ts-universal-attributes-toolbar.md#toolbar)通用属性为窗口标题栏添加工具栏项。

说明

该组件从API version 20开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

该组件一般配合[toolbar](../../通用属性/其他/工具栏设置/ts-universal-attributes-toolbar.md#toolbar)通用属性进行使用。
...
默认在标题栏对应分栏开头位置创建工具栏项，分栏位置由绑定该[toolbar](../../通用属性/其他/工具栏设置/ts-universal-attributes-toolbar.md#toolbar)属性的组件所在分栏位置而定。
...
示例代码参考[toolbar](../../通用属性/其他/工具栏设置/ts-universal-attributes-toolbar.md#示例)。
