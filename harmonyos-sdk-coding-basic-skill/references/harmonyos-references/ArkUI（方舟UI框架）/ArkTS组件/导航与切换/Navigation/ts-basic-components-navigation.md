...
scraped_at: 2026-06-11T15:46:38+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:b6618085b9c58a3e84a805d7d9a2c3db4430e24c3cce86ecfee5a51048601e6d
---
Navigation组件是路由导航的根视图容器，一般作为Page页面的根容器使用，其内部默认包含了标题栏、内容区和工具栏，其中内容区默认首页显示导航内容（Navigation的子组件）或非首页显示（[NavDestination](../NavDestination/ts-basic-components-navdestination.md)的子组件），首页和非首页通过路由进行切换。

说明

* 该组件从API version 8开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。
* 该组件从API version 11开始默认支持安全区避让特性(默认值为：expandSafeArea([SafeAreaType.SYSTEM, SafeAreaType.KEYBOARD, SafeAreaType.CUTOUT], [SafeAreaEdge.TOP, SafeAreaEdge.BOTTOM]))，开发者可以重写该属性覆盖默认行为，API version 11之前的版本需配合[expandSafeArea](../../通用属性/布局与边框/安全区域/ts-universal-attributes-expand-safe-area.md#expandsafearea)属性实现安全区避让。
* [NavBar](ts-basic-components-navigation.md#navbar12)嵌套使用Navigation时，内层NavDestination的生命周期不和外层NavDestination以及全模态[bindContentCover](../../通用属性/模态转场设置/全屏模态转场/ts-universal-attributes-modal-transition.md#bindcontentcover)的生命周期进行联动。
...
* 不建议在[aboutToAppear](../../自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoappear)中使用栈操作，此时的页面还未构建完成，会导致白屏或跳转失败等问题。
...
从API version 9开始，推荐与[NavRouter](../../已停止维护的组件与接口/NavRouter/ts-basic-components-navrouter.md)组件搭配使用。
...
创建路由导航的根视图容器，适用于使用[NavRouter](../../已停止维护的组件与接口/NavRouter/ts-basic-components-navrouter.md)组件进行页面路由。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | Array<[NavigationMenuItem](ts-basic-components-navigation.md#navigationmenuitem)> | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 页面右上角菜单。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| items | Array<[NavigationMenuItem](ts-basic-components-navigation.md#navigationmenuitem)> | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 页面右上角菜单。 |
...
从API version 18开始，该参数支持[!!](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/!!语法：双向绑定/arkts-new-binding.md>)双向绑定变量。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 导航页宽度。  默认值：240  单位：vp  undefined：行为不做处理，导航页宽度与默认值保持一致。 |
...
不支持通过[SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier)对象的[fontSize](../../文本与输入/SymbolGlyph/ts-basic-components-symbolglyph.md#fontsize)属性修改图标大小、[effectStrategy](../../文本与输入/SymbolGlyph/ts-basic-components-symbolglyph.md#effectstrategy)属性修改动效、[symbolEffect](../../文本与输入/SymbolGlyph/ts-basic-components-symbolglyph.md#symboleffect12)属性修改动效类型。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | [PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | [SymbolGlyphModifier12+](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier) | 是 | 标题栏中返回键图标。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| icon | string | [PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | [SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier) | 是 | 标题栏中返回键图标。 |
| accessibilityText | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 返回键无障碍播报内容。  默认值：系统语言是中文时为“返回”，系统语言是英文时为“back”。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [[Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10), [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10)] | 是 | 导航页最小和最大宽度。设置异常值时按默认值处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | 是 | 导航页内容区最小宽度。  默认值：360  单位：vp  undefined：行为不做处理，导航页内容区最小宽度与默认值保持一致。  Auto模式断点计算：默认600vp，minNavBarWidth(240vp) + minContentWidth (360vp) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| types | Array <[LayoutSafeAreaType](../../通用属性/布局与边框/安全区域/ts-universal-attributes-expand-safe-area.md#layoutsafeareatype12)> | 否 | 配置扩展安全区域的类型。  默认值：  [LayoutSafeAreaType.SYSTEM] |
| edges | Array <[LayoutSafeAreaEdge](../../通用属性/布局与边框/安全区域/ts-universal-attributes-expand-safe-area.md#layoutsafeareaedge12)> | 否 | 配置扩展安全区域的方向。  默认值：  [LayoutSafeAreaEdge.TOP, LayoutSafeAreaEdge.BOTTOM]。 |
...
1. 不建议混合使用systemBarStyle属性和window设置状态栏样式的相关接口，例如：[setWindowSystemBarProperties](<../../../ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setwindowsystembarproperties9>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[SystemBarStyle](<../../../ArkTS API/窗口管理/@ohos.window (窗口)/Interfaces (其他)/arkts-apis-window-i.md#systembarstyle12>)> | 是 | 系统状态栏样式。 |
...
1. 使用该接口需要先设置Navigation的通用属性[id](../../通用属性/基础属性/组件标识/ts-universal-attributes-component-id.md#id)，否则该接口无效。
2. 该接口需要配合NavDestination的[recoverable](../NavDestination/ts-basic-components-navdestination.md#recoverable14)接口使用。
3. 恢复的过程中不可序列化的信息，例如不可序列化的参数与用户设置的onPop等，会被丢弃，无法恢复。
4. 当应用退到后台，因系统资源不足等原因被系统终止后，如果某页面已配置为可恢复，当应用再次被唤醒至前台时，系统将自动恢复该页面。详细说明请参考[UIAbility备份恢复](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/UIAbility组件/UIAbility备份恢复/ability-recover-guideline.md>)，详细使用请参考[示例18](ts-basic-components-navigation.md#示例18设置navigation可恢复)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| recoverable | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | Navigation是否可恢复，默认为不可恢复。  true：路由栈可恢复；false：路由栈不可恢复。  传入参数非法时，按false处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isEnabled | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否开启拖拽条，默认为无拖拽条样式。  true：有拖拽条样式；false：无拖拽条样式。  传入参数非法时，按false处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isEnabled | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否开启单双栏切换动效。  true：开启单双栏切换动效；false：关闭单双栏切换动效。  传入参数非法时，按true处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| placeholder | [ComponentContent](<../../../ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md#componentcontent-1>) | 是 | 设置Navigation双栏模式下右侧的默认占位页。 |
...
设置是否启用[NavDestination](../NavDestination/ts-basic-components-navdestination.md)页面[onHidden](../NavDestination/ts-basic-components-navdestination.md#onhidden10)、[onShown](../NavDestination/ts-basic-components-navdestination.md#onshown10)生命周期与全模态的联动触发。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | object | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 工具栏内容。 |
...
以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)、[页面路由错误码](../../../错误码/UI界面/页面路由错误码/errorcode-router.md)和[接口调用异常错误码](../../../错误码/UI界面/接口调用异常错误码/errorcode-internal.md)。
...
将路由栈内指定navDestinationId的NavDestination页面删除。navDestinationId可以在NavDestination的[onReady](../NavDestination/ts-basic-components-navdestination.md#onready11)回调中获取，也可以在[NavDestinationInfo](<../../../ArkTS API/UI界面/@ohos.arkui.observer (无感监听)/js-apis-arkui-observer.md#navdestinationinfo>)中获取。
...
| mode | [NavDestinationMode](../NavDestination/ts-basic-components-navdestination.md#navdestinationmode枚举说明11) | 否 | 是 | NavDestination的模式，如果是根视图(NavBar)，则返回值为undefined。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| from | [NavDestinationContext](../NavDestination/ts-basic-components-navdestination.md#navdestinationcontext11) | [NavBar](ts-basic-components-navigation.md#navbar12) | 是 | 页面跳转之前的栈顶页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。 |
| to | [NavDestinationContext](../NavDestination/ts-basic-components-navdestination.md#navdestinationcontext11) | [NavBar](ts-basic-components-navigation.md#navbar12) | 是 | 页面跳转之后的栈顶页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| value | string | [Resource14+](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | API version 9：显示菜单栏单个选项的文本。  从API version 10开始，不显示菜单栏单个选项的文本。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| icon | string | [Resource14+](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 是 | 菜单栏单个选项的图标资源路径。  **说明：**  当图标为SVG格式时，系统会默认设置fill颜色，覆盖SVG文件中自定义的fill属性，可能导致图标显示异常。建议在SVG文件中通过style样式设置fill来覆盖系统默认值，示例如下：  原始写法（fill属性会被系统默认值覆盖）：<rect fill="rgb(255,0,0)" .../>，建议修改为：<rect style="fill: rgb(255,0,0)" .../>。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| symbolIcon12+ | [SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier) | 否 | 是 | 菜单栏单个选项的symbol资源（优先级高于icon）。  **说明：**  不支持通过[SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier)对象的[fontSize](../../文本与输入/SymbolGlyph/ts-basic-components-symbolglyph.md#fontsize)属性修改图标大小、[effectStrategy](../../文本与输入/SymbolGlyph/ts-basic-components-symbolglyph.md#effectstrategy)属性修改动效、[symbolEffect](../../文本与输入/SymbolGlyph/ts-basic-components-symbolglyph.md#symboleffect12)属性修改动效类型。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| symbolIcon12+ | [SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier) | 否 | 是 | 工具栏单个选项的symbol资源（优先级高于icon）。  **说明：**  不支持通过[SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier)对象的[fontSize](../../文本与输入/SymbolGlyph/ts-basic-components-symbolglyph.md#fontsize)属性修改图标大小、[effectStrategy](../../文本与输入/SymbolGlyph/ts-basic-components-symbolglyph.md#effectstrategy)属性修改动效、[symbolEffect](../../文本与输入/SymbolGlyph/ts-basic-components-symbolglyph.md#symboleffect12)属性修改动效类型。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| activeSymbolIcon12+ | [SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier) | 否 | 是 | 工具栏单个选项处于ACTIVE态时的symbol资源（优先级高于activeIcon）。  **说明：**  不支持通过[SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier)对象的[fontSize](../../文本与输入/SymbolGlyph/ts-basic-components-symbolglyph.md#fontsize)属性修改图标大小、[effectStrategy](../../文本与输入/SymbolGlyph/ts-basic-components-symbolglyph.md#effectstrategy)属性修改动效、[symbolEffect](../../文本与输入/SymbolGlyph/ts-basic-components-symbolglyph.md#symboleffect12)属性修改动效类型。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| Free | 0 | 当内容为满一屏的可滚动组件时，标题随着内容向上滚动而缩小（子标题的大小不变、淡出）。向下滚动内容到顶时则恢复原样。  **说明：**  标题随着内容滚动大小联动的动效在title设置为ResourceStr和NavigationCommonTitle时生效，设置成其余自定义节点类型时字体样式无法变化，下拉时只影响标题栏偏移。  可滚动组件不满一屏时，如果想使用联动效果，就要使用滚动组件提供的[edgeEffect](../../滚动与滑动/List/ts-container-list.md#edgeeffect)接口将options参数设置为true。未滚动状态，标题栏高度与Full模式一致；滚动时，标题栏的最小高度与Mini模式一致。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| main | string | [Resource14+](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | 设置主标题。 |
| sub | string | [Resource14+](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | 设置副标题。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| builder | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 否 | 否 | 设置标题栏内容。 |
| height | [TitleHeight](../../公共定义/枚举说明/ts-appendix-enums.md#titleheight9) | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 否 | 设置标题栏高度。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 分割线的颜色。  默认值：#33000000，灰色。 |
| startMargin | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 分割线与侧边栏顶端的距离。  默认值：0  单位：vp  取值范围：[0, +∞) |
| endMargin | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 分割线与侧边栏底端的距离。  默认值：0  单位：vp  取值范围：[0, +∞) |
...
| SAFE\_AREA\_PADDING14+ | 2 | 将指定该模式的标题栏或工具栏设置为组件级安全区[safeAreaPadding](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#safeareapadding14)。  **元服务API：** 从API version 14开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| backgroundColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 标题栏背景颜色，不设置时为系统默认颜色。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| backgroundBlurStyle | [BlurStyle](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#blurstyle9) | 否 | 是 | 标题栏背景模糊样式，不设置时关闭背景模糊效果。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| backgroundBlurStyleOptions19+ | [BackgroundBlurStyleOptions](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundblurstyleoptions10对象说明) | 否 | 是 | 标题栏背景模糊选项。  **说明：**  只在设置了backgroundBlurStyle时生效。  不建议与backgroundEffect同时使用。  **元服务API：** 从API version 19开始，该接口支持在元服务中使用。 |
| backgroundEffect19+ | [BackgroundEffectOptions](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundeffectoptions11) | 否 | 是 | 设置标题栏背景属性包括：模糊半径，亮度，饱和度，颜色等。  **说明：**  不建议与backgroundBlurStyleOptions同时使用。  **元服务API：** 从API version 19开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| backgroundColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 工具栏背景颜色，不设置时为系统默认颜色。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| backgroundBlurStyle | [BlurStyle](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#blurstyle9) | 否 | 是 | 工具栏背景模糊样式，不设置时关闭背景模糊效果。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| backgroundBlurStyleOptions19+ | [BackgroundBlurStyleOptions](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundblurstyleoptions10对象说明) | 否 | 是 | 工具栏背景模糊选项。  **说明：**  只在设置了backgroundBlurStyle时生效。  不建议与backgroundEffect同时使用。  **元服务API：** 从API version 19开始，该接口支持在元服务中使用。 |
| backgroundEffect19+ | [BackgroundEffectOptions](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundeffectoptions11) | 否 | 是 | 设置工具栏背景属性包括：模糊半径，亮度，饱和度，颜色等。  **说明：**  不建议与backgroundBlurStyleOptions同时使用。  **元服务API：** 从API version 19开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| backgroundBlurStyle | [BlurStyle](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#blurstyle9) | 否 | 是 | 更多图标的菜单背景模糊样式，不设置时关闭背景模糊效果。 |
| backgroundBlurStyleOptions | [BackgroundBlurStyleOptions](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundblurstyleoptions10对象说明) | 否 | 是 | 更多图标的菜单背景模糊选项。  **说明：**  只在设置了backgroundBlurStyle时生效。  不建议与backgroundEffect同时使用。 |
| backgroundEffect | [BackgroundEffectOptions](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundeffectoptions11) | 否 | 是 | 设置更多图标的菜单背景属性包括：模糊半径，亮度，饱和度，颜色等。  **说明：**  不建议与backgroundBlurStyleOptions同时使用。 |
...
| 类型 | 说明 |
| --- | --- |
| [SystemBarStyle](<../../../ArkTS API/窗口管理/@ohos.window (窗口)/Interfaces (其他)/arkts-apis-window-i.md#systembarstyle12>) | 状态栏文字颜色。  默认值：'#0xE5FFFFFF' |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/J3HJ2mnhRJGMuUEhRjyDkw/zh-cn_image_0000002622699689.png?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=D1182E27A3E46ABB6088DADEE865CDCB275742B22521526F943DF8D2A067FA10)
...
在src/main目录下的[module.json5配置文件](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)中的module字段里配置"routerMap": "$profile:router\_map"，并在src/main/resources/base/profile目录下新增router\_map.json。router\_map.json示例如下。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4/v3/DvrLh_byTQmPJXnixMGTXw/zh-cn_image_0000002592220128.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=4C57D1E5EE56B09F1B0087D8FE06794491EA5B60C719A5165577FA7214000F83)

### 示例3（设置可交互转场动画）

该示例主要演示设置每个[NavDestination](../NavDestination/ts-basic-components-navdestination.md)子页面的自定义转场动画及可交互转场动画。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/ama7zve9T3uoQWFuw9219w/zh-cn_image_0000002592380062.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=9EEEF82905A10E9BDDA5595AE2A5CA894EDF561E764C409980F27FF3ED5EC603)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/c7GlSrgYR1CZA7fPKQkCvg/zh-cn_image_0000002622859571.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=C893F967051DBC94AF7CDBAEC4CB439C74F0476F1835B7B308A7B52D95279FAA)

### 示例5（设置背景颜色和模糊效果）

该示例主要演示设置Navigation主页的标题栏、工具栏和[NavDestination](../NavDestination/ts-basic-components-navdestination.md)页面的标题栏的背景颜色和背景模糊效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/dL62W7ooTMazaS-Vs29Ocg/zh-cn_image_0000002622699691.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=1C85B199898765ED087CB5BDAAF43E7E3421758B966068351010CE34D4B173E3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/sj3VLh--QHmGPTIU2xRm3g/zh-cn_image_0000002592220130.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=EDC62A4D3D194B9CBC104B5F3BB5DB00BC2DDF247CC1621ECAC9E50A0290065A)
...
2. [NavDestination](../NavDestination/ts-basic-components-navdestination.md)通过[onReady](../NavDestination/ts-basic-components-navdestination.md#onready11)事件能够拿到对应的[NavPathInfo](ts-basic-components-navigation.md#navpathinfo10)和所属的[NavPathStack](ts-basic-components-navigation.md#navpathstack10)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/2YFoRaszQV2uva0jlwEsNQ/zh-cn_image_0000002592380064.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=D7B5E02193CA8372DBA02F8610D1E65795862E719178D83529E97F9028CF83B5)

### 示例8（NavDestination生命周期时序）

该示例演示[NavDestination](../NavDestination/ts-basic-components-navdestination.md)的[onAppear](../../通用事件/组件变化事件/挂载卸载事件/ts-universal-events-show-hide.md#onappear)，[onDisAppear](../../通用事件/组件变化事件/挂载卸载事件/ts-universal-events-show-hide.md#ondisappear)，[onShown](../NavDestination/ts-basic-components-navdestination.md#onshown10)，[onHidden](../NavDestination/ts-basic-components-navdestination.md#onhidden10)，[onWillAppear](../NavDestination/ts-basic-components-navdestination.md#onwillappear12)，[onWillDisappear](../NavDestination/ts-basic-components-navdestination.md#onwilldisappear12)，[onWillShow](../NavDestination/ts-basic-components-navdestination.md#onwillshow12)，[onWillHide](../NavDestination/ts-basic-components-navdestination.md#onwillhide12)接口的生命周期时序。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/HxV7C662TS6IcxqNP6GWvA/zh-cn_image_0000002622859573.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=A4C2BFBE98E81F85F4C25388B4FFBBF8CBCDDA722907C61C19E23AABC48F0F56)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/F7oxjbvOQBOZnfmZNyWyxQ/zh-cn_image_0000002622699693.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=D7E8FAEBB223AED271E333D2281F812830520C468FB77C3EAEEA03505CC405D5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/QDrgvhXJSxqTPmCZHKsV6g/zh-cn_image_0000002592220132.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=00EF01FC9E7CECA5393200C999177294B3B92425BF70CBCA4FEA9C838BD2FB61)

### 示例11（使用Symbol组件）

该示例主要演示Navigation和[NavDestination](../NavDestination/ts-basic-components-navdestination.md)如何使用Symbol组件。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/3cNHd-OrQWSLNb2yneNnWA/zh-cn_image_0000002592380066.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=E758C4C0DAF22409994D2E3BF0490F87C93FF30F4AD1001C07270851ED773103)

### 示例12（设置自定义标题栏边距）

该示例主要演示Navigation和[NavDestination](../NavDestination/ts-basic-components-navdestination.md)如何设置自定义标题栏边距，如何通过TextModifier修改主副标题文本样式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/TnMb-9WpT5umZsS7G0gdHQ/zh-cn_image_0000002622859575.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=1968BC04EB523EFEFD29321807C3BA8EFE1363812B407219C764C5F04E7CABF0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2b/v3/GEuwkaKyS-q8WDs22-cpEw/zh-cn_image_0000002622699695.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=224EBA574D01A1E4431CE54EF6611F7A877807008683D067D185884137590007)
...
此示例在运行前需要在工程配置文件[module.json5](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)中的abilities字段里配置"orientation": "auto\_rotation"。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/lqJrCRYDROSRCR5G4fntdA/zh-cn_image_0000002592220134.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=32AC748ADCC77C28BDBDD916EE8DBBCC7EB7DD1EA96E393BCAD0CD4F7CDC4679)
...
在工程配置文件[module.json5](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)中的abilities字段里配置"orientation": "landscape"（该工程配置仅方便演示在横屏模式下的Navigation工具栏自适应能力，实际配置可自行设置为"auto\_rotation"）。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/Bbnbq8k_QeGmpefb-LbNDw/zh-cn_image_0000002592380068.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=4213E505CBA44E23C6D26D2212FFB060FD5AE0A7188CC625CDA7B5E78F91F51D)

### 示例16（Navigation使用NavDestination作为导航页）

该示例展示了Navigation组件通过配置[homeDestination](ts-basic-components-navigation.md#navigation20)参数，实现以[NavDestination](../NavDestination/ts-basic-components-navdestination.md)作为根导航页的效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/ors-8JJUTRaNJtmObHrEsw/zh-cn_image_0000002622859577.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=44C799CF51D94D2A20CE01007C53F0DD035ACE95CC223939D873DCE64549F744)

### 示例17（使用新增导航控制器方法）

该示例通过设置[setInterception](ts-basic-components-navigation.md#setinterception12)方法来实现路由拦截功能，并在[NavDestinationContext](../NavDestination/ts-basic-components-navdestination.md#navdestinationcontext11)中获取mode。
...
在src/main目录下的工程配置文件[module.json5](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)中的module字段里配置"routerMap": "$profile:router\_map"。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/Qmy-g9BrQHme8YWNELed2g/zh-cn_image_0000002622699697.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=A1E8A60C6FA3F71E7F1BDCE501EB90A13156E7D3B0318F20FB270DB156781610)

### 示例18（设置Navigation可恢复）

该示例演示如何使用[recoverable](ts-basic-components-navigation.md#recoverable14)配置Navigation可恢复，需要开发者在应用模块初始化时启用[UIAbility](<../../../../Ability Kit（程序框架服务）/ArkTS API/Stage模型能力的接口/@ohos.app.ability.UIAbility (带界面的应用组件)/js-apis-app-ability-uiability.md>)的备份恢复功能，可参考[UIAbility备份恢复](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/UIAbility组件/UIAbility备份恢复/ability-recover-guideline.md>)。
...
在src/main目录下[module.json5配置文件](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)中的module字段里配置"routerMap": "$profile:router\_map"，并在src/main/resources/base/profile目录下新增router\_map.json文件。示例如下：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/3bL2T5yMR8ah1TPZ70LG9w/zh-cn_image_0000002592220136.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=9689D3FE1CC33438C92C205E5BC295F80AB24945D20F92ADF5775DC63107594E)
