...
content_hash: sha256:1e375f6ba06fc04677ca30c19a108ca230879bab345457e0c78ba41e0e7c3ac9
---
导航点组件，提供圆点导航点以及数字导航点两种导航点样式。

将原[Swiper](../../滚动与滑动/Swiper/ts-container-swiper.md)组件中的[indicator](../../滚动与滑动/Swiper/ts-container-swiper.md#indicator)已有的能力作为一个单独组件提供给开发者使用。开发者可以不依赖Swiper组件单独显示导航点，也可以通过[IndicatorComponentController](ts-swiper-components-indicator.md#indicatorcomponentcontroller)与Swiper组件绑定使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| indicatorStyle | [DotIndicator](../../滚动与滑动/Swiper/ts-container-swiper.md#dotindicator10) | [DigitIndicator](../../滚动与滑动/Swiper/ts-container-swiper.md#digitindicator10) | 是 | 可选导航点指示器样式。  - DotIndicator：圆点指示器样式。  - DigitIndicator：数字指示器样式。  默认类型：DotIndicator。 |

说明

当indicatorStyle类型为DotIndicator且未与Swiper组件绑定时，[maxDisplayCount](../../滚动与滑动/Swiper/ts-container-swiper.md#maxdisplaycount12)不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](../../公共定义/基础类型定义/ts-types.md#callback12)<number> | 是 | 当前显示元素的索引变化时触发的回调。 |
...
该示例通过[Swiper](../../滚动与滑动/Swiper/ts-container-swiper.md)组件的[indicator](../../滚动与滑动/Swiper/ts-container-swiper.md#indicator)接口与[IndicatorComponent](ts-swiper-components-indicator.md#indicatorcomponent)的构造函数绑定同一[IndicatorComponentController](ts-swiper-components-indicator.md#indicatorcomponentcontroller)对象，实现了圆点单独导航点与Swiper的交互。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/4v-JptZwQ9uJzhXpQMy7uA/zh-cn_image_0000002592380060.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074631Z&HW-CC-Expire=86400&HW-CC-Sign=D12E081E486E066C0DF6F7B6E4E9D37E001B566DCB98E02F0181221B15F69B75)

### 示例2（数字单独导航点与Swiper绑定使用）

该示例通过[Swiper](../../滚动与滑动/Swiper/ts-container-swiper.md)组件的[indicator](../../滚动与滑动/Swiper/ts-container-swiper.md#indicator)接口与[IndicatorComponent](ts-swiper-components-indicator.md#indicatorcomponent)的构造函数绑定同一[IndicatorComponentController](ts-swiper-components-indicator.md#indicatorcomponentcontroller)对象，实现了数字单独导航点与Swiper的交互。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/dowPdOYFQ3ay6qYgoOBr5g/zh-cn_image_0000002622859569.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074631Z&HW-CC-Expire=86400&HW-CC-Sign=A3BE6604249BCEC1B0C44B10344EF298C4C662A239FF5BB6EB8DC7FD494984F9)
