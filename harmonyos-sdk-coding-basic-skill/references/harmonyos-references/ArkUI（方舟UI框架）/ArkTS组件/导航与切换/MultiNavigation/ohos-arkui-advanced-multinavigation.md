...
scraped_at: 2026-06-11T15:46:42+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:f9220f6c97935cadd85fb52e4ca006df7ea301381ad64373609f2a6adf000473
---
...
由于MultiNavigation存在多重栈嵌套，调用本文档明确说明的不支持接口或不在本文档支持接口列表中的接口(例如[getParent](../Navigation/ts-basic-components-navigation.md#getparent11)、[setInterception](../Navigation/ts-basic-components-navigation.md#setinterception12)、[pushDestination](../Navigation/ts-basic-components-navigation.md#pushdestination11)等)，可能会发生无法预期的问题。
...
MultiNavigation组件遵循默认的左起右清栈规则，这意味着从左侧主页点击时，会触发详情页的加载并同时清除右侧所有其他详情页，确保右侧仅展示最新加载的详情页。然而，若在右侧的详情页上再次执行详情页加载操作，系统将不会执行清栈动作。效果可参见[示例](ohos-arkui-advanced-multinavigation.md#示例)。
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| multiStack | [MultiNavPathStack](ohos-arkui-advanced-multinavigation.md#multinavpathstack) | 是 | [@State](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/状态管理（V1）/管理组件拥有的状态/@State装饰器：组件内状态/arkts-state.md>) | 设置路由栈。 |
| navDestination | [NavDestinationBuildFunction](ohos-arkui-advanced-multinavigation.md#navdestinationbuildfunction) | 是 | [@BuilderParam](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@BuilderParam装饰器：引用@Builder函数/arkts-builderparam.md>) | 设置加载目标页面的路由规则。 |
...
当前，MultiNavigation的路由栈仅支持由使用方自行创建，不支持通过回调方式获取。请勿使用[NavDestination](../NavDestination/ts-basic-components-navdestination.md)的[onReady](../NavDestination/ts-basic-components-navdestination.md#onready11)等类似事件或接口来获取NavPathStack并进行栈操作，因为这可能会导致不可预知的问题。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [NavPathInfo](../Navigation/ts-basic-components-navigation.md#navpathinfo10) | 是 | NavDestination页面的信息。 |
...
| --- | --- | --- | --- |
| info | [NavPathInfo](../Navigation/ts-basic-components-navigation.md#navpathinfo10) | 是 | NavDestination页面的信息。 |
| options | [NavigationOptions](../Navigation/ts-basic-components-navigation.md#navigationoptions12) | 否 | 页面栈操作选项。仅支持其中的animated字段。 |
| policy | [SplitPolicy](ohos-arkui-advanced-multinavigation.md#splitpolicy枚举说明) | 否 | 当前入栈页面的策略。默认值：DETAIL\_PAGE |
...
| name | string | 是 | NavDestination页面名称。 |
| param | Object | 是 | NavDestination页面详细参数。 |
| onPop | base.[Callback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[PopInfo](../Navigation/ts-basic-components-navigation.md#popinfo11)> | 否 | Callback回调，用于页面出栈时触发该回调处理返回结果。 |
| animated | boolean | 否 | 是否支持转场动画。  默认值：true  true：支持转场动画。  false：不支持转场动画。 |
| policy | [SplitPolicy](ohos-arkui-advanced-multinavigation.md#splitpolicy枚举说明) | 否 | 当前入栈页面的策略。默认值：DETAIL\_PAGE |
...
| 类型 | 说明 |
| --- | --- |
| [NavPathInfo](../Navigation/ts-basic-components-navigation.md#navpathinfo10) | undefined | 返回栈顶NavDestination页面的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [NavPathInfo](../Navigation/ts-basic-components-navigation.md#navpathinfo10) | 是 | 占位页页面信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [NavigationMode](../Navigation/ts-basic-components-navigation.md#navigationmode9枚举说明) | 是 | 当回调触发时的NavigationMode。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/M8dt7JvJSqCUIa3668m3NQ/zh-cn_image_0000002592380074.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074639Z&HW-CC-Expire=86400&HW-CC-Sign=6D724178688AF7645E34936BF4DE4EFF0FE140485CEA5E882F6C9682385FECDF)

主页跳转详情页效果演示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/pCTU8HyhTJin9RKz9959Qw/zh-cn_image_0000002622859583.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074639Z&HW-CC-Expire=86400&HW-CC-Sign=D24407589B5252983D24524357FE0CE2383064B86E802878EA2798C9D6DCA8A4)

全屏类型页面效果演示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/GvfRgx-QSMOnvKATaZKnmw/zh-cn_image_0000002622699703.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074639Z&HW-CC-Expire=86400&HW-CC-Sign=0472B36074EF54D8B6A29541EDAAD0863B376229DD1C38C39DCE52497CB1F427)
