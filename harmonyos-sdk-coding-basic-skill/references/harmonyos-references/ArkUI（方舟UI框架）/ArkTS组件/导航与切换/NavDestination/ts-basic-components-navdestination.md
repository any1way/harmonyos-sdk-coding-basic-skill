...
scraped_at: 2026-06-11T15:46:40+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:55f805bdf25e411f5541b3d2fa0638b0fa397665a08650213d4f55fdc501bca8
---
作为子页面的根容器，用于显示[Navigation](../Navigation/ts-basic-components-navigation.md)的内容区。

说明

* 该组件从API version 9开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。
* 该组件从API version 11开始默认支持安全区避让特性(默认值为：expandSafeArea([SafeAreaType.SYSTEM], [SafeAreaEdge.TOP, SafeAreaEdge.BOTTOM]))，开发者可以重写该属性覆盖默认行为，API version 11之前的版本需配合[expandSafeArea](../../通用属性/布局与边框/安全区域/ts-universal-attributes-expand-safe-area.md#expandsafearea)属性实现安全区避让。
...
* 不建议设置位置、大小等布局相关属性，可能会造成页面显示异常。例如在NavDestination上添加[zIndex](../../通用属性/基础属性/Z序控制/ts-universal-attributes-z-order.md#zindex)属性时，会覆盖掉系统设置的层级，可能导致出现显示异常。
...
创建[Navigation](../Navigation/ts-basic-components-navigation.md)子页面的根容器。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | [NavDestinationCommonTitle](ts-basic-components-navdestination.md#navdestinationcommontitle) | [NavDestinationCustomTitle](ts-basic-components-navdestination.md#navdestinationcustomtitle) | [Resource14+](../../公共定义/基础类型定义/ts-types.md#resource) | 是 | 页面标题。 |
| options12+ | [NavigationTitleOptions](../Navigation/ts-basic-components-navigation.md#navigationtitleoptions11) | 否 | 标题栏选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| toolbarParam | Array<[ToolbarItem](../Navigation/ts-basic-components-navigation.md#toolbaritem10)> | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 工具栏内容。  使用Array<[ToolbarItem](../Navigation/ts-basic-components-navigation.md#toolbaritem10)>写法设置的工具栏有如下特性：  -工具栏所有选项均分底部工具栏，在每个均分内容区布局文本和图标。  -竖屏模式最多支持显示5个图标，多余的图标会被放入自动生成的更多图标中，点击更多图标，可以展示剩余内容。横屏模式时，如果为[Split](../Navigation/ts-basic-components-navigation.md#navigationmode9枚举说明)模式，仍按照竖屏模式显示，如果为[Stack](../Navigation/ts-basic-components-navigation.md#navigationmode9枚举说明)模式需配合[menus](ts-basic-components-navdestination.md#menus12)属性的Array<[NavigationMenuItem](../Navigation/ts-basic-components-navigation.md#navigationmenuitem)>使用，底部工具栏会自动隐藏，同时底部工具栏所有选项移动至页面右上角菜单。  使用[CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8)写法为用户自定义工具栏选项，不具备以上功能。 |
| options | [NavigationToolbarOptions](../Navigation/ts-basic-components-navigation.md#navigationtoolbaroptions11) | 否 | 工具栏选项。包含工具栏背景颜色、工具栏背景模糊样式及模糊选项、工具栏背景属性、工具栏布局方式、是否隐藏工具栏的文本、工具栏更多图标的菜单选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | [PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | [SymbolGlyphModifier12+](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier) | 是 | 标题栏返回键图标。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| icon | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | [PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | [SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md#symbolglyphmodifier) | 是 | 标题栏返回键图标。 |
...
设置页面右上角菜单。不设置时不显示菜单项。使用Array<[NavigationMenuItem](../Navigation/ts-basic-components-navigation.md#navigationmenuitem)> 写法时，竖屏最多支持显示3个图标，横屏最多支持显示5个图标，多余的图标会被放入自动生成的更多图标。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | Array<[NavigationMenuItem](../Navigation/ts-basic-components-navigation.md#navigationmenuitem)> | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 页面右上角菜单。 |
...
设置页面右上角菜单。不设置时不显示菜单项。与[menus](ts-basic-components-navdestination.md#menus12)相比，新增菜单选项。使用Array<[NavigationMenuItem](../Navigation/ts-basic-components-navigation.md#navigationmenuitem)> 写法时，竖屏最多支持显示3个图标，横屏最多支持显示5个图标，多余的图标会被放入自动生成的更多图标。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| items | Array<[NavigationMenuItem](../Navigation/ts-basic-components-navigation.md#navigationmenuitem)> | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 页面右上角菜单。 |
| options | [NavigationMenuOptions](../Navigation/ts-basic-components-navigation.md#navigationmenuoptions19) | 否 | 页面右上角菜单选项。 |
...
* 组件想要扩展到非安全区域内，需隐藏或者设置标题栏和工具栏为[STACK](../Navigation/ts-basic-components-navigation.md#barstyle12枚举说明)模式。
...
* 其他使用限制请参考Navigation对应的[systemBarStyle](../Navigation/ts-basic-components-navigation.md#systembarstyle12)属性说明。
* 从API version 20开始，该接口支持在[attributeModifier](../../通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#attributemodifier)中调用。
...
配置NavDestination是否可恢复。如配置为可恢复，当应用进程异常退出并重新冷启动时，可自动创建该NavDestination。该功能需NavDestination对应的Navigation也配置了可恢复属性[recoverable](../Navigation/ts-basic-components-navigation.md#recoverable14)。

说明

该接口需要配合Navigation的[recoverable](../Navigation/ts-basic-components-navigation.md#recoverable14)接口使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| recoverable | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | NavDestination是否可恢复，默认为不可恢复。  默认值：false  true：路由栈可恢复。  false：路由栈不可恢复。 |
...
* 从API version 22开始，该接口支持在[attributeModifier](../../通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#attributemodifier)中调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scrollers | Array<[Scroller](../../滚动与滑动/Scroll/ts-container-scroll.md#scroller)> | 是 | 可滚动容器组件的控制器。 |
...
绑定NavDestination组件和嵌套的可滚动容器组件（支持[List](../../滚动与滑动/List/ts-container-list.md)、[Scroll](../../滚动与滑动/Scroll/ts-container-scroll.md)、[Grid](../../滚动与滑动/Grid/ts-container-grid.md)、[WaterFlow](../../滚动与滑动/WaterFlow/ts-container-waterflow.md)），当滑动父组件或子组件时，会触发所有与其绑定的NavDestination组件的标题栏和工具栏的显示和隐藏动效，上滑隐藏，下滑显示。一个NavDestination可与多个嵌套的可滚动容器组件绑定，嵌套的可滚动容器组件也可与多个NavDestination绑定。使用示例参见[示例1](ts-basic-components-navdestination.md#示例1标题栏工具栏与可滚动类组件联动)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| hide | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否隐藏标题栏中的返回键。  默认值：false  true：隐藏返回键。  false：显示返回键。 |
...
* 设置显示方向的实际效果依赖于具体的设备支持情况，具体参考窗口的[setPreferredOrientation](<../../../ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setpreferredorientation9-1>)接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| orientation | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Orientation](ts-basic-components-navdestination.md#orientation19)> | 是 | NavDestination页面对应的Orientation。 |
...
* 设置系统状态栏的实际效果依赖于具体的设备支持情况，具体参考窗口的[setSpecificSystemBarEnabled](<../../../ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setspecificsystembarenabled11>)接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 进入该NavDestination后，系统状态栏的显示/隐藏状态。  true：显示状态栏。  false：隐藏状态栏。 |
...
设置系统导航条的实际效果依赖于具体的设备支持情况，具体参考窗口的[setSpecificSystemBarEnabled](<../../../ArkTS API/窗口管理/@ohos.window (窗口)/Interface (Window)/arkts-apis-window-window.md#setspecificsystembarenabled11>)接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 进入该NavDestination后，系统导航条的显示/隐藏状态。  true：显示导航条。  false：隐藏导航条。 |
...
除支持[通用事件](../../通用事件/ts-component-general-events.md)外，还支持如下事件：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[VisibilityChangeReason](ts-basic-components-navdestination.md#visibilitychangereason21)>21+ | 是 | 当该NavDestination页面显示时触发此回调。  在API version 21之前，当NavDestination页面显示时触发回调。  从API version 21开始，回调会提供入参VisibilityChangeReason以说明onShown触发的原因。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[VisibilityChangeReason](ts-basic-components-navdestination.md#visibilitychangereason21)>21+ | 是 | 当该NavDestination页面隐藏时触发此回调。  在API version 21之前，当NavDestination页面隐藏时触发回调。  从API version 21开始，该回调会提供入参VisibilityChangeReason以说明onHidden触发的原因。 |
...
onReady(callback: [Callback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[NavDestinationContext](ts-basic-components-navdestination.md#navdestinationcontext11)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[NavDestinationContext](ts-basic-components-navdestination.md#navdestinationcontext11)> | 是 | 当NavDestination即将构建子组件之前会触发此回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Callback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<ESObject>> | 是 | 页面返回回调，入参为[pop](../Navigation/ts-basic-components-navigation.md#pop11)、[popToName](../Navigation/ts-basic-components-navigation.md#poptoname11)、[popToIndex](../Navigation/ts-basic-components-navigation.md#poptoindex11)接口传入的result参数。如果不传该参数，入参为undefined。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Callback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[NavDestinationActiveReason](ts-basic-components-navdestination.md#navdestinationactivereason17)>> | 是 | NavDestination由非激活态变为激活态的原因。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Callback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[NavDestinationActiveReason](ts-basic-components-navdestination.md#navdestinationactivereason17)>> | 是 | NavDestination由激活态变为非激活态的原因。 |
...
当之前存在于栈中的NavDestination页面通过[launchMode.MOVE\_TO\_TOP\_SINGLETON](../Navigation/ts-basic-components-navigation.md#launchmode12枚举说明)或[launchMode.POP\_TO\_SINGLETON](../Navigation/ts-basic-components-navigation.md#launchmode12枚举说明)移动到栈顶时，触发该回调。

说明

* [replacePath](../Navigation/ts-basic-components-navigation.md#replacepath11)、[replaceDestination](../Navigation/ts-basic-components-navigation.md#replacedestination18)不会触发该回调。
* 从API version 22开始，该接口支持在[attributeModifier](../../通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#attributemodifier)中调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Callback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<ESObject>> | 是 | onNewParam触发时的回调函数，入参为路由跳转时传递到目标页面的数据。 |
...
| height | [TitleHeight](../../公共定义/枚举说明/ts-appendix-enums.md#titleheight9) | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 否 | 设置标题栏高度。  取值范围：[0, +∞)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pathInfo | [NavPathInfo](../Navigation/ts-basic-components-navigation.md#navpathinfo10) | 否 | 否 | 跳转NavDestination时指定的参数。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| pathStack | [NavPathStack](../Navigation/ts-basic-components-navigation.md#navpathstack10) | 否 | 否 | 当前NavDestination所处的导航控制器。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| parent | [Scroller](../../滚动与滑动/Scroll/ts-container-scroll.md#scroller) | 否 | 否 | 可滚动容器组件的控制器。 |
| child | [Scroller](../../滚动与滑动/Scroll/ts-container-scroll.md#scroller) | 否 | 否 | 可滚动容器组件的控制器，child对应的组件需要是parent对应组件的子组件，且组件间存在嵌套滚动关系。 |
...
| curve | [Curve](../../公共定义/枚举说明/ts-appendix-enums.md#curve) | 否 | 是 | 动画的曲线类型，默认值为[Curve.EaseInOut](../../公共定义/枚举说明/ts-appendix-enums.md#curve)。 |
| delay | number | 否 | 是 | 转场动画的延迟。  默认值：0（毫秒）  单位：ms |
| event | Callback<void> | 否 | 否 | 指定转场动效的闭包函数，系统会根据闭包中对组件UI状态的修改，生成对应的过渡动画。参见[animateTo](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#animateto>)中的event。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| operation | [NavigationOperation](../Navigation/ts-basic-components-navigation.md#navigationoperation11枚举说明) | 是 | 当前页面转场的操作类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [Orientation](<../../../ArkTS API/窗口管理/@ohos.window (窗口)/Enums/arkts-apis-window-e.md#orientation9>) | 返回Orientation实例对象。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/CS4q6NgjQj2OHQMHqrWDHw/zh-cn_image_0000002592380070.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074633Z&HW-CC-Expire=86400&HW-CC-Sign=B9739F6E7A52CBC10A25865A03BA1B63E78EE6AFA9F9A1407712B9F9ECB2B178)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/5TOqhMIYRnyvfgUaORzoZg/zh-cn_image_0000002622859579.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074633Z&HW-CC-Expire=86400&HW-CC-Sign=6BC377C1F5D18D59B78E11148D512BAB9C2BFD9EF1F28F9F138F7DDE585103ED)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5d/v3/JBzQdmO5RgOIQ9hgzXTN6g/zh-cn_image_0000002622699699.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074633Z&HW-CC-Expire=86400&HW-CC-Sign=7712007D8E2E2825A8915C357D16BAAF97D949CD48875D17665BDE2FBB8B3A2A)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b2/v3/Qvs3t0iZS-uFK8OdejCxNg/zh-cn_image_0000002592220138.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074633Z&HW-CC-Expire=86400&HW-CC-Sign=F5CEBDBD795B4CFCFFE45C6573469E8B052A472B13470BF7D9021244CF38CE1C)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/Osiep5tDRRmm1pXg0nIW1w/zh-cn_image_0000002592380072.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074633Z&HW-CC-Expire=86400&HW-CC-Sign=9C1831A497659F176892536F4EE875F870A785E55435C39324B1907C8506AF6F)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/NXAaXi0mSrSLRTeNDkdXgg/zh-cn_image_0000002622859581.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074633Z&HW-CC-Expire=86400&HW-CC-Sign=395E851E0968ECB2A301B8E0AADD5E5C72614A3DD9043CAA8F87FA8F6623CC69)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/YIXB864yQ8uIKP9Kxlecqg/zh-cn_image_0000002622699701.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074633Z&HW-CC-Expire=86400&HW-CC-Sign=F3182569865A4F07BA215F0D1B8C83F30544EE966B18251DC94006B5915E2EE0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b2/v3/7_d0UURtTvuds1m2sXEXgw/zh-cn_image_0000002592220140.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074633Z&HW-CC-Expire=86400&HW-CC-Sign=FD6F111EC6EEA0F44699BEF641452E304FC4377462845FD5D25072E7CAB5BBB2)

NavDestination其他用法可参考[Navigation示例](../Navigation/ts-basic-components-navigation.md#示例)。
