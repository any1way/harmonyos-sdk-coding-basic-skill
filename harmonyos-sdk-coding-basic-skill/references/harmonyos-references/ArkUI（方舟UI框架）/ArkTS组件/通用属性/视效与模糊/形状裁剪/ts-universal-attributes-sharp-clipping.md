...
scraped_at: 2026-06-11T15:44:33+08:00
doc_updated_at: 2026-03-23
content_hash: sha256:8e52ede89028cdd0bbe59d868a50cc79ff97ccbf99a8eddf6129494ec4e41791
---
用于对组件进行裁剪、遮罩处理。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| clip | [Optional](../../动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 设置子组件是否按照当前组件边缘轮廓进行裁剪。  **说明：** 设置为true后，子组件超出当前组件范围外的区域将不响应绑定的手势事件。  当clip的值为undefined时，恢复为不对子组件超出当前组件范围外的区域进行裁剪。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | boolean | [CircleAttribute](../../../图形绘制/Circle/ts-drawing-components-circle.md) | [EllipseAttribute](../../../图形绘制/Ellipse/ts-drawing-components-ellipse.md) | [PathAttribute](../../../图形绘制/Path/ts-drawing-components-path.md) | [RectAttribute](../../../图形绘制/Rect/ts-drawing-components-rect.md) | 是 | 参数为相应类型的组件，按指定的形状对当前组件进行裁剪；参数为boolean类型时，设置是否按照父容器边缘轮廓进行裁剪。  默认值：false  **说明：** 参数为对应类型的组件时，裁剪不会导致被裁剪区域无法响应绑定的手势事件。参数为boolean类型时，裁剪会导致被裁剪区域无法响应绑定的手势事件。 |
...
形状中的[fill](<../../../../ArkTS API/UI界面/@ohos.arkui.shape (形状)/js-apis-arkui-shape.md#fill>)属性对clipShape接口不生效。
...
| 类型 | 说明 |
| --- | --- |
| [CircleShape](<../../../../ArkTS API/UI界面/@ohos.arkui.shape (形状)/js-apis-arkui-shape.md#circleshape>) | 圆形形状。 |
...
| 类型 | 说明 |
| --- | --- |
| [EllipseShape](<../../../../ArkTS API/UI界面/@ohos.arkui.shape (形状)/js-apis-arkui-shape.md#ellipseshape>) | 椭圆形状。 |
...
| 类型 | 说明 |
| --- | --- |
| [PathShape](<../../../../ArkTS API/UI界面/@ohos.arkui.shape (形状)/js-apis-arkui-shape.md#pathshape>) | 路径形状。 |
...
| 类型 | 说明 |
| --- | --- |
| [RectShape](<../../../../ArkTS API/UI界面/@ohos.arkui.shape (形状)/js-apis-arkui-shape.md#rectshape>) | 矩形形状。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mask | [Optional](../../动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ProgressMask](ts-universal-attributes-sharp-clipping.md#progressmask10)> | 是 | 在当前组件上加上可动态设置进度、最大值和颜色的遮罩。  当mask的值为undefined时，恢复为无进度遮罩效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CircleAttribute](../../../图形绘制/Circle/ts-drawing-components-circle.md) | [EllipseAttribute](../../../图形绘制/Ellipse/ts-drawing-components-ellipse.md) | [PathAttribute](../../../图形绘制/Path/ts-drawing-components-path.md) | [RectAttribute](../../../图形绘制/Rect/ts-drawing-components-rect.md) | [ProgressMask](ts-universal-attributes-sharp-clipping.md#progressmask10)10+ | 是 | 在当前组件上加上指定形状的遮罩。 |
...
| color | [ResourceColor](../../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 进度遮罩的颜色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 进度遮罩的颜色。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8c/v3/k7nqPsEURfC19m0KHx24JQ/zh-cn_image_0000002622859423.png?HW-CC-KV=V1&HW-CC-Date=20260611T074430Z&HW-CC-Expire=86400&HW-CC-Sign=9D3D8C8ABE1CF2DAF8936A4FB4E3078E40D0D0DB30E230703B3E0021F3448327)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/TdnqQBuyRa2ULtYbUFBZpQ/zh-cn_image_0000002622699543.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074430Z&HW-CC-Expire=86400&HW-CC-Sign=23562EEDD6BEB56B9C333EAECDBD96C1D53B196159D1A75420859FFCB8E2609C)
