...
scraped_at: 2026-06-11T15:44:21+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:8ade36bb21a09d7c346ba255c16daa421a5171473d0da30760256125b3840212
---
...
* 仅[Flex](../../../行列与堆叠/Flex/ts-container-flex.md)、[Column](../../../行列与堆叠/Column/ts-container-column.md)、[Row](../../../行列与堆叠/Row/ts-container-row.md)和[DynamicLayout](../../../动态布局/DynamicLayout/ts-container-dynamiclayout.md)支持下述四种属性，[GridRow](../../../栅格与分栏/GridRow/ts-container-gridrow.md)仅支持设置[alignSelf](ts-universal-attributes-flex-layout.md#alignself)。
...
使用[getInspectorByKey](../../基础属性/组件标识/ts-universal-attributes-component-id.md#getinspectorbykey9)获取flexShrink属性时，如果该节点未设置flexShrink属性，默认返回1。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 设置父容器压缩尺寸分配给此属性所在组件的比例。  父容器为[Column](../../../行列与堆叠/Column/ts-container-column.md)、[Row](../../../行列与堆叠/Row/ts-container-row.md)时，默认值：0，取值范围[0,+∞)。  父容器为[Flex](../../../行列与堆叠/Flex/ts-container-flex.md)时，默认值：1  [constraintSize](../尺寸设置/ts-universal-attributes-size.md#constraintsize)限制组件的尺寸范围。[Column](../../../行列与堆叠/Column/ts-container-column.md)和[Row](../../../行列与堆叠/Row/ts-container-row.md)即使设置了[constraintSize](../尺寸设置/ts-universal-attributes-size.md#constraintsize)，在未设置主轴尺寸（[width](../尺寸设置/ts-universal-attributes-size.md#width)/[height](../尺寸设置/ts-universal-attributes-size.md#height)/[size](../尺寸设置/ts-universal-attributes-size.md#size)）时仍遵守默认布局行为，在主轴上自适应子组件尺寸，此时flexShrink不生效。  设置异常值时，该属性为默认值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ItemAlign](../../../公共定义/枚举说明/ts-appendix-enums.md#itemalign) | 是 | 子组件在父容器交叉轴的对齐格式，会覆盖[Flex](../../../行列与堆叠/Flex/ts-container-flex.md)、[Column](../../../行列与堆叠/Column/ts-container-column.md)、[Row](../../../行列与堆叠/Row/ts-container-row.md)、[GridRow](../../../栅格与分栏/GridRow/ts-container-gridrow.md)布局容器中的alignItems设置。  [GridCol](../../../栅格与分栏/GridCol/ts-container-gridcol.md)可以绑定alignSelf属性来改变它自身在交叉轴方向上的布局。  默认值：ItemAlign.Auto |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/7ZbHCWpWTNmP4EuN-90MCQ/zh-cn_image_0000002592219960.png?HW-CC-KV=V1&HW-CC-Date=20260611T074420Z&HW-CC-Expire=86400&HW-CC-Sign=E3523594DF7231E974C76711D6596E1C59712ECF83C82A2C4AD85F2378468FCB)
