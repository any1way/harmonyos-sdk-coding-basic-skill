...
scraped_at: 2026-06-11T15:44:18+08:00
doc_updated_at: 2026-03-23
content_hash: sha256:b989da4a6322015d9c32f0157b81901fdf7f2838ed43f41d2eef07ffc79ac553
---
设置组件的宽高、边距。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../公共定义/基础类型定义/ts-types.md#length) | 是 | 要设置的组件宽度。  单位：vp |
...
* 在[TextInput](../../../文本与输入/TextInput/ts-basic-components-textinput.md)组件中，width设置auto表示自适应文本宽度。
* 在[AlphabetIndexer](../../../信息展示/AlphabetIndexer/ts-container-alphabet-indexer.md)组件中，width设置auto表示自适应宽度最大索引项的宽度。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../../公共定义/基础类型定义/ts-types.md#length) | 是 | 要设置的组件高度。  单位：vp |
...
在[Row](../../../行列与堆叠/Row/ts-container-row.md)、[Column](../../../行列与堆叠/Column/ts-container-column.md)、[RelativeContainer](../../../行列与堆叠/RelativeContainer/ts-container-relativecontainer.md)组件中，width、height设置auto表示自适应子组件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| widthValue | [Length](../../../公共定义/基础类型定义/ts-types.md#length) | [LayoutPolicy](ts-universal-attributes-size.md#layoutpolicy15) | 是 | 要设置的组件宽度。  单位：vp |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| heightValue | [Length](../../../公共定义/基础类型定义/ts-types.md#length) | [LayoutPolicy](ts-universal-attributes-size.md#layoutpolicy15) | 是 | 要设置的组件高度。  单位：vp |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SizeOptions](../../../公共定义/基础类型定义/ts-types.md#sizeoptions) | 是 | 设置宽高尺寸。  异常值：参数为undefined时，属性设置不生效；其它异常值时，size属性恢复到不配置时的默认行为。  单位：vp |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Padding](../../../公共定义/基础类型定义/ts-types.md#padding) | [Length](../../../公共定义/基础类型定义/ts-types.md#length) | [LocalizedPadding](../../../公共定义/基础类型定义/ts-types.md#localizedpadding12)12+ | 是 | 设置组件的内边距。  参数为Length类型时，四个方向内边距同时生效。  默认值：0  单位：vp  padding设置百分比时，上下左右内边距均以父容器的width作为基础值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Margin](../../../公共定义/基础类型定义/ts-types.md#margin) | [Length](../../../公共定义/基础类型定义/ts-types.md#length) | [LocalizedMargin](../../../公共定义/基础类型定义/ts-types.md#localizedmargin12)12+ | 是 | 设置组件的外边距。  参数为Length类型时，四个方向外边距同时生效。  默认值：0  单位：vp  margin设置百分比时，上下左右外边距均以父容器的width作为基础值。在[Row](../../../行列与堆叠/Row/ts-container-row.md)、[Column](../../../行列与堆叠/Column/ts-container-column.md)、[Flex](../../../行列与堆叠/Flex/ts-container-flex.md)交叉轴上布局时，子组件交叉轴的大小与margin的和为整体。  例如Column容器宽100，其中子组件宽50，margin left为10，right为20，子组件水平方向偏移10。 |
...
设置安全区边距属性。允许容器向自身添加组件级安全区域，供子组件延伸，支持[attributeModifier](../../动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#attributemodifier)动态设置属性方法。

说明

从API version 18开始，该接口支持在[attributeModifier](../../动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#attributemodifier)中调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| paddingValue | [Padding](../../../公共定义/基础类型定义/ts-types.md#padding) | [LengthMetrics](<../../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | [LocalizedPadding](../../../公共定义/基础类型定义/ts-types.md#localizedpadding12) | 是 | 设置组件的安全区边距。  默认值：0  单位：vp |
...
设置组件的布局权重，使组件在父容器（[Row](../../../行列与堆叠/Row/ts-container-row.md)/[Column](../../../行列与堆叠/Column/ts-container-column.md)/[Flex](../../../行列与堆叠/Flex/ts-container-flex.md)）的主轴方向按照权重分配尺寸。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | 是 | 父容器尺寸确定时，不设置layoutWeight属性或者layoutWeight属性生效值为0的元素优先占位，这些元素占位后在主轴留下的空间称为主轴剩余空间。设置了layoutWeight属性且layoutWeight属性生效值大于0的子元素会从主轴剩余空间中按照各自所设置的权重占比分配尺寸，分配时会忽略元素本身的尺寸设置。  默认值：0  **说明：**  仅在[Row](../../../行列与堆叠/Row/ts-container-row.md)/[Column](../../../行列与堆叠/Column/ts-container-column.md)/[Flex](../../../行列与堆叠/Flex/ts-container-flex.md)布局中生效。  可选值为大于等于0的数字，或者可以转换为数字的字符串。  如果容器中有子元素设置了layoutWeight属性，且设置的属性值大于0，则所有子元素不会再基于[flexShrink](../Flex布局/ts-universal-attributes-flex-layout.md#flexshrink)和[flexGrow](../Flex布局/ts-universal-attributes-flex-layout.md#flexgrow)布局。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ConstraintSizeOptions](../../../公共定义/基础类型定义/ts-types.md#constraintsizeoptions) | 是 | 设置约束尺寸。constraintSize的优先级高于Width和Height。取值结果参考constraintSize取值对width/height影响。  默认值：  {  minWidth: 0,  maxWidth: Infinity,  minHeight: 0,  maxHeight: Infinity  }  异常值：数值开头的字符串仅解析出数字部分，非数值开头的字符串解析为0；其它异常值时，constraintSize属性恢复到不配置时的默认行为。  单位：vp |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/I7cRMwNISE2M4MEY9BDP_w/zh-cn_image_0000002592219952.png?HW-CC-KV=V1&HW-CC-Date=20260611T074416Z&HW-CC-Expire=86400&HW-CC-Sign=4BC1C9F3730C4F53385CB15F0C29F35EC068B8F810CB6A30927C3383B02622BC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/l0sRktS7RjGlfmUtPABEhw/zh-cn_image_0000002592379886.png?HW-CC-KV=V1&HW-CC-Date=20260611T074416Z&HW-CC-Expire=86400&HW-CC-Sign=31676E49B634204A896B4B02416FE0A174657F665F03960D79846F6084A933AB)

从右至左显示语言示例图

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/ozZmJWWgSZynxoN_16HKEA/zh-cn_image_0000002622859395.png?HW-CC-KV=V1&HW-CC-Date=20260611T074416Z&HW-CC-Expire=86400&HW-CC-Sign=7CFD98518D8CFCA6E93A8FBFB8829CA0D674D42F0729911B1F7E8F2A61A66806)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/6orgg0fuSlOJy9zIpsrWAA/zh-cn_image_0000002622699515.png?HW-CC-KV=V1&HW-CC-Date=20260611T074416Z&HW-CC-Expire=86400&HW-CC-Sign=7A1598768C1D3A356B889C1DBA6CAE2D28A3DBB1ED616FF9BDE928E7D32E732A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/aMXV1sXGQYe512KDFfXI_A/zh-cn_image_0000002592219954.png?HW-CC-KV=V1&HW-CC-Date=20260611T074416Z&HW-CC-Expire=86400&HW-CC-Sign=5B16467AD6D7F10FFEA5A224BA98FDA4A413013339A20AA3C3D87B2F2926BFDD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0b/v3/Yy7iCqcfRYapeNLKvrEfjw/zh-cn_image_0000002592379888.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074416Z&HW-CC-Expire=86400&HW-CC-Sign=26A54B0FCE259BD114D802A4235A56DB99D13B57F7B367224617C9285AE23568)
