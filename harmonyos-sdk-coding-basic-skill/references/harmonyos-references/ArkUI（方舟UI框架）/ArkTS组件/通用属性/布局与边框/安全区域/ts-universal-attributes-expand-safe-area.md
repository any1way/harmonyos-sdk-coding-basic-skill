...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| types | Array <[SafeAreaType](ts-universal-attributes-expand-safe-area.md#safeareatype)> | 否 | 配置扩展安全区域的类型。未添加[Metadata](<../../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/Metadata/js-apis-bundlemanager-metadata.md>)配置项时，页面不避让挖孔，CUTOUT类型不生效。  默认值：[SafeAreaType.SYSTEM, SafeAreaType.CUTOUT, SafeAreaType.KEYBOARD]  非法值：按默认值处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [KeyboardAvoidMode](<../../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Enums/arkts-apis-uicontext-e.md#keyboardavoidmode11>) | 是 | 配置虚拟键盘抬起时页面的避让模式。  默认值：KeyboardAvoidMode.OFFSET，键盘抬起时默认避让模式为上抬。  setKeyboardAvoidMode传入异常值时，该属性设置不生效。 |
...
setKeyboardAvoidMode针对页面生效，对于弹窗类组件不生效，比如Dialog、Popup、Menu、BindSheet、BindContentCover、Toast、OverlayManager。弹窗类组件的避让模式可以参考[CustomDialogControllerOptions对象说明](<../../../弹窗/自定义弹窗 (CustomDialog)/ts-methods-custom-dialog-box.md#customdialogcontrolleroptions对象说明>)。
...
| 名称 | 说明 |
| --- | --- |
| [KeyboardAvoidMode](<../../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Enums/arkts-apis-uicontext-e.md#keyboardavoidmode11>) | 返回虚拟键盘抬起时的页面避让模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| types | Array <[LayoutSafeAreaType](ts-universal-attributes-expand-safe-area.md#layoutsafeareatype12)> | 否 | 扩展布局安全区域的类型。  默认值：[LayoutSafeAreaType.SYSTEM]，扩展至所有安全区域，比如：状态栏，导航栏和组件级安全区（[safeAreaPadding](../尺寸设置/ts-universal-attributes-size.md#safeareapadding14)）。  非法值：按默认值处理。 |
...
忽略布局安全区边缘的组件，如果其宽度或高度设置了[LayoutPolicy.matchParent](../尺寸设置/ts-universal-attributes-size.md#layoutpolicy15)，其大小和位置都会改变，否则仅改变其位置。
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| SYSTEM | 0 | 设置后，组件的布局范围可扩展至组件级安全区（[safeAreaPadding](../尺寸设置/ts-universal-attributes-size.md#safeareapadding14)）和页面级安全区（状态栏、导航栏、挖孔区）。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6/v3/VK2ZdZFEQoKceGOyOKwymA/zh-cn_image_0000002592379894.png?HW-CC-KV=V1&HW-CC-Date=20260611T074421Z&HW-CC-Expire=86400&HW-CC-Sign=C6AAC00C82F0A12F0558CF536AA52E80A291DC152C7C16BFA270A2382E746F3E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/XrGxTpOwRlS6yt_F66fS9g/zh-cn_image_0000002622859403.png?HW-CC-KV=V1&HW-CC-Date=20260611T074421Z&HW-CC-Expire=86400&HW-CC-Sign=7578D684FAF8C2AE369735D11F07C17FF239B6A25264D2796145B640A1032C8A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/dYhut6caTiabtUAI04qkeA/zh-cn_image_0000002622699523.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074421Z&HW-CC-Expire=86400&HW-CC-Sign=062404CACF61E4735BB434597EC01AB7F918B0C8A7BBCE7656404B1FBEC3F226)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/Y8BS4P6ASICbxNHWPU62bQ/zh-cn_image_0000002592219962.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074421Z&HW-CC-Expire=86400&HW-CC-Sign=F263F56114ACE963B27233DA7496FC417F4B5286A89BEAA1FEB1BC0A62505C1B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/Lcm-KlH3RQGBbJy4-4reww/zh-cn_image_0000002592379896.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074421Z&HW-CC-Expire=86400&HW-CC-Sign=71ABB730416FE868C3A71C9628CB297E837B6CD21B80A93AF5862E877F66DCD3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/49IxLQGVTBayw8hI0hY3fg/zh-cn_image_0000002622859405.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074421Z&HW-CC-Expire=86400&HW-CC-Sign=56CF3D1A72AB09287A290D22B691C530760519C0D604905CA3E0DA604678B014)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/BUTXHFJZT-6oPR5dleO1_Q/zh-cn_image_0000002622699525.png?HW-CC-KV=V1&HW-CC-Date=20260611T074421Z&HW-CC-Expire=86400&HW-CC-Sign=DA77E8EB2F592BA5FAECC7CDA62F1095D062109BDD8BD29C2A9E789BC0C41544)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/3Fuo4a2NRaeLLM4NpX_zlQ/zh-cn_image_0000002592219964.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074421Z&HW-CC-Expire=86400&HW-CC-Sign=9AD36E254927ED7084D190D09D52F237963882B50DACF41FC72B855D0B1B6E8C)

### 示例9（ignoreLayoutSafeArea配合LayoutPolicy.matchParent延伸组件布局范围）

该示例利用[ignoreLayoutSafeArea](ts-universal-attributes-expand-safe-area.md#ignorelayoutsafearea20)和[LayoutPolicy.matchParent](../尺寸设置/ts-universal-attributes-size.md#layoutpolicy15)同时改变组件大小和位置。相比未使用该属性，配置ignoreLayoutSafeArea后，Row组件基于Stack内容区、Stack组件级安全区，取其右下部分并撑满可用空间。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/sCw3PQ0wR_mh2T_GEUrM0w/zh-cn_image_0000002592379898.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074421Z&HW-CC-Expire=86400&HW-CC-Sign=88F80148237218CF1F3DBCAFE7BB9C561EA307795E6600D84DE713DC3BA5F0DE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/GggVFVRSS06wWzk98EY5Jw/zh-cn_image_0000002622859407.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074421Z&HW-CC-Expire=86400&HW-CC-Sign=D3FED2EA5E005A7E239E0EF12C2967645254602BBBA02CBD031DD2D3A2FD3E88)
