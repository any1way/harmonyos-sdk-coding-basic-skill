...
scraped_at: 2026-06-01T15:39:35+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:f04737d698b0459b1f1deff5a365473c4beb5068598277a34f957b06cc72aab8
---
...
* 若出现像素取整[问题](../组件级像素取整/ts-universal-attributes-pixelroundforcomponent.md#常见问题)，且使用[组件级像素取整](../组件级像素取整/ts-universal-attributes-pixelroundforcomponent.md)无法解决时，建议尝试采用PIXEL\_ROUND\_AFTER\_MEASURE模式。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [PixelRoundMode](../../../公共定义/枚举说明/ts-appendix-enums.md#pixelroundmode18) | 是 | 像素取整模式。  默认值：PixelRoundMode.PIXEL\_ROUND\_ON\_LAYOUT\_FINISH  设置异常值时，该属性为默认值。 |
...
| 类型 | 说明 |
| --- | --- |
| [PixelRoundMode](../../../公共定义/枚举说明/ts-appendix-enums.md#pixelroundmode18) | 当前页面的像素取整模式。 |
