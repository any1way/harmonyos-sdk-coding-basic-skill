...
scraped_at: 2026-06-11T15:44:20+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:8d0c4a06cc633efaa016f9de571392d1bdd7669f81ddf3a367295a95f62a1a67
---
...
设置aspectRatio属性后，组件宽高会受父组件内容区大小限制，[constraintSize](../尺寸设置/ts-universal-attributes-size.md#constraintsize)的优先级高于aspectRatio。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 设置当前组件在布局容器中显示的优先级。  默认值：1  **说明：**  仅在[Row](../../../行列与堆叠/Row/ts-container-row.md)/[Column](../../../行列与堆叠/Column/ts-container-column.md)/[Flex(单行)](../../../行列与堆叠/Flex/ts-container-flex.md)容器组件中生效。  小数点后的数字不作优先级区分，即区间为[x, x + 1)内的数字视为相同优先级。例如：1.0与1.9为同一优先级。  子组件的displayPriority均不大于1时，优先级没有区别。  当子组件的displayPriority大于1时，displayPriority数值越大，优先级越高。若父容器空间不足，隐藏低优先级子组件。若某一优先级的子组件被隐藏，则优先级更低的子组件也都被隐藏。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/7-WqP8m4RbSvIoHj0sacFA/zh-cn_image_0000002592379892.png?HW-CC-KV=V1&HW-CC-Date=20260611T074419Z&HW-CC-Expire=86400&HW-CC-Sign=7DFDE8A17B70D58883CC5ECEA9C0F030DE03B9F73C308560D17C29CC750AAC73)

**图2** 横屏显示

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/GmH0aR-pToadrp3b-tViQw/zh-cn_image_0000002622859401.png?HW-CC-KV=V1&HW-CC-Date=20260611T074419Z&HW-CC-Expire=86400&HW-CC-Sign=2FE4A656DD657DF78E479860972C96E3517E21B9FC507F6A2251336DDB742410)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/88/v3/z5sCGUcrSCShQBfHGSCZBg/zh-cn_image_0000002622699521.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074419Z&HW-CC-Expire=86400&HW-CC-Sign=ED61250738F30D21B5148F7EAAADECC725F2AEC6506E68BD541F46E8DAB301AC)
