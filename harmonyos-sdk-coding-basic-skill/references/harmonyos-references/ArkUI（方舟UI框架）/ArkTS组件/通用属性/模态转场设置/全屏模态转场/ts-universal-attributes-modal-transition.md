...
scraped_at: 2026-06-11T15:45:10+08:00
doc_updated_at: 2026-03-23
content_hash: sha256:a2598801fafa21d9397070045955635024bda4aebf719e322c3df2c500b357aa
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isShow | boolean | 是 | 是否显示全屏模态页面。  -true：显示全屏模态页面。  -false：隐藏全屏模态页面。  从API version 10开始，该参数支持[$$](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)双向绑定变量。  从API version 18开始，该参数支持[!!](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/!!语法：双向绑定/arkts-new-binding.md#系统组件参数双向绑定>)双向绑定变量。 |
| builder | [CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 配置全屏模态页面内容。builder里面的根节点需要唯一。 |
| type | [ModalTransition](../半模态转场/ts-universal-attributes-sheet-transition.md#modaltransition) | 否 | 全屏模态页面的系统转场方式。  默认值：ModalTransition.DEFAULT。  **说明：**  与transition同时设置时，此属性不生效。 |
...
| --- | --- | --- | --- |
| isShow | boolean | 是 | 是否显示全屏模态页面。  -true：显示全屏模态页面。  -false：隐藏全屏模态页面。  从API version 10开始，该参数支持[$$](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)双向绑定变量。  从API version 18开始，该参数支持[!!](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/!!语法：双向绑定/arkts-new-binding.md#系统组件参数双向绑定>)双向绑定变量。 |
| builder | [CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 配置全屏模态页面内容。 |
...
继承自[BindOptions](../半模态转场/ts-universal-attributes-sheet-transition.md#bindoptions)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| modalTransition | [ModalTransition](../半模态转场/ts-universal-attributes-sheet-transition.md#modaltransition) | 否 | 是 | 全屏模态页面的系统转场方式。  默认值：ModalTransition.DEFAULT。  **说明：**  与transition同时设置时，此属性不生效。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| transition12+ | [TransitionEffect](<../../../动画/组件内转场 (transition)/ts-transition-animation-component.md#transitioneffect10对象说明>) | 否 | 是 | 全屏模态页面的自定义转场方式。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| dismiss | [Callback](../../../公共定义/基础类型定义/ts-types.md#callback12)<void> | 否 | 否 | 全屏模态页面关闭回调函数。开发者需要退出页面时调用。 |
| reason | [DismissReason](../../弹窗控制/Popup控制/ts-universal-attributes-popup.md#dismissreason12枚举说明) | 否 | 否 | 返回本次拦截全屏模态页面退出的事件原因。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/02/v3/axUaTOfCQ8Cm-cmI6eAwHg/zh-cn_image_0000002622699589.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074508Z&HW-CC-Expire=86400&HW-CC-Sign=60278875C1A2DF9ECD38D66CFC3AE6D832EEDDF82F784E83053AE5A90F27A903)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/y4ZUa4aYQNGgxfs7A6Pjzg/zh-cn_image_0000002592220028.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074508Z&HW-CC-Expire=86400&HW-CC-Sign=30FEAE68C538DE86A437B807C50278C08DC5E370A22B95392252AEE111091753)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/sR8e6MlpQq-ucbAOwGdrZQ/zh-cn_image_0000002592379962.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074508Z&HW-CC-Expire=86400&HW-CC-Sign=81DD5A52FFF53148747DE10D789CCF951220E4ED7EDA30B4286C66D939C0741E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/P7xEc2u4QwKNyz2siPhR9Q/zh-cn_image_0000002622859471.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074508Z&HW-CC-Expire=86400&HW-CC-Sign=D58870B6E8ED658601DF8DC1EB8F13F7E58EA2693A59D2741BF437E4F3FDD624)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/Zs4N6e78RbCDio8AsS12aw/zh-cn_image_0000002622699591.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074508Z&HW-CC-Expire=86400&HW-CC-Sign=B4D1FEFD410CD600B8A7FAC583748448DD791FE6D33901EC3F94155065C6CDA3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/halaNLaeRs-uoSlhv7lWzA/zh-cn_image_0000002592220030.png?HW-CC-KV=V1&HW-CC-Date=20260611T074508Z&HW-CC-Expire=86400&HW-CC-Sign=9B0048AD92875D4E61962A4967E6BD59BC18375A4CD4E7074226C5C7E4462693)
