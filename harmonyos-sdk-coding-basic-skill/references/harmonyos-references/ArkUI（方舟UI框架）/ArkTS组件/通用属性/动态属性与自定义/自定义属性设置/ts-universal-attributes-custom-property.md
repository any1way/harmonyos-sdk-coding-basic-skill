...
content_hash: sha256:4ab3e36ad555ee6177327f002f48d082aa4eee34b19a192f6608eed166823519
---
...
设置组件的自定义属性。[自定义组件](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/创建自定义组件/arkts-create-custom-components.md>)不支持设置自定义属性。
...
在[Column](../../../行列与堆叠/Column/ts-container-column.md)组件上设置自定义属性，并在其对应的[FrameNode](<../../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#framenode-1>)上获取所设置的自定义属性。
