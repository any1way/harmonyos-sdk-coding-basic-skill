...
scraped_at: 2026-06-11T15:45:01+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:f42bb8ae98f4e920cbc61dfddcec829128728619ea52930332180d326b2e77a5
---
设置组件不同状态下的样式。
...
* 从API version 11开始支持另一种写法[attributeModifier](../动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#attributemodifier)，可根据开发者需要动态设置属性。
* 多态样式仅支持[通用属性](../ts-component-general-attributes.md)。如果多态样式不生效，则该属性可能为组件的私有属性，例如：fontColor、[TextInput](../../文本与输入/TextInput/ts-basic-components-textinput.md)组件的[backgroundColor](../基础属性/背景设置/ts-universal-attributes-background.md#backgroundcolor18)等。此时，可以通过attributeModifier动态设置组件属性来解决此问题。
...
* 多态样式的焦点态只有在[焦点激活态](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/支持焦点处理/arkts-common-events-focus-event.md#基础概念>)开启时生效。
...
* 当前多态样式的选中状态样式依赖组件选中属性值，可以使用[点击事件](../../通用事件/交互响应事件/点击事件/ts-universal-events-click.md)修改属性值，或使用属性自带[$$](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)双向绑定功能。
* 当前支持selected的组件及其参数/属性值：

  | 组件 | 支持的参数/属性 | 起始API版本 |
  | --- | --- | --- |
  | [Checkbox](../../按钮与选择/Checkbox/ts-basic-components-checkbox.md) | select | 10 |
  | [CheckboxGroup](../../按钮与选择/CheckboxGroup/ts-basic-components-checkboxgroup.md) | selectAll | 10 |
  | [Radio](../../按钮与选择/Radio/ts-basic-components-radio.md) | checked | 10 |
  | [Toggle](../../按钮与选择/Toggle/ts-basic-components-toggle.md) | isOn | 10 |
  | [ListItem](../../滚动与滑动/ListItem/ts-container-listitem.md) | selected | 10 |
  | [GridItem](../../滚动与滑动/GridItem/ts-container-griditem.md) | selected | 10 |
  | [MenuItem](../../菜单/MenuItem/ts-basic-components-menuitem.md) | selected | 10 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8/v3/QyreoOHBRrqlsLkCtG_YMg/zh-cn_image_0000002592220010.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074459Z&HW-CC-Expire=86400&HW-CC-Sign=20CA7C9BA1FBD0A8D20E6D5B8837D9732463C9ACA1CE722423F56B29645DD8C1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/cREWJs2GS6ypV7mUWER24Q/zh-cn_image_0000002592379944.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074459Z&HW-CC-Expire=86400&HW-CC-Sign=23BC536D6EEC22CF14F33809499E9638CD2FF6B1C3CC860DD264934BB9062A57)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/Lalwkvd7T-iC8lOmgG6okw/zh-cn_image_0000002622859453.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074459Z&HW-CC-Expire=86400&HW-CC-Sign=C337BBE238F5D934A7E64DE7A6B449D58C6C0264D534498203CF13C6F2E4A184)
