...
scraped_at: 2026-06-11T15:44:51+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:cc4f048dbd0bd047512811f6f48424c8487d7c4d0735c2b1b444952c9feda4ae
---
...
* 默认支持拖出能力的组件（可从组件上拖出数据）：[Search](../../../文本与输入/Search/ts-basic-components-search.md)、[TextInput](../../../文本与输入/TextInput/ts-basic-components-textinput.md)、[TextArea](../../../文本与输入/TextArea/ts-basic-components-textarea.md)、[RichEditor](../../../文本与输入/RichEditor/ts-basic-components-richeditor.md)、[Text](../../../文本与输入/Text/ts-basic-components-text.md)、[Image](../../../图片与视频/Image/ts-basic-components-image.md)、[Hyperlink](../../../文本与输入/Hyperlink/ts-container-hyperlink.md)，开发者可通过设置这些组件的[draggable](ts-universal-attributes-drag-drop.md#draggable)属性来控制对默认拖拽能力的使用。
* 默认支持拖入能力的组件（目标组件可响应拖入数据）：[Search](../../../文本与输入/Search/ts-basic-components-search.md)、[TextInput](../../../文本与输入/TextInput/ts-basic-components-textinput.md)、[TextArea](../../../文本与输入/TextArea/ts-basic-components-textarea.md)、[RichEditor](../../../文本与输入/RichEditor/ts-basic-components-richeditor.md)，开发者可通过设置这些组件的[allowDrop](ts-universal-attributes-drag-drop.md#allowdrop)属性为null来禁用对默认拖入能力的支持。
* 不支持拖出能力的组件（不可从组件上拖出数据）：[ArcScrollBar](../../../滚动与滑动/ArcScrollBar/ts-basic-components-arcscrollbar.md)、[MultiNavigation](../../../导航与切换/MultiNavigation/ohos-arkui-advanced-multinavigation.md)、[ToolBarItem](../../../导航与切换/ToolBarItem/ts-basic-components-toolbaritem.md)、[ArcSlider](../../../按钮与选择/ArcSlider/ohos-arkui-advanced-arcslider.md)、[Span](../../../文本与输入/Span/ts-basic-components-span.md)、[ImageSpan](../../../文本与输入/ImageSpan/ts-basic-components-imagespan.md)、[ContainerSpan](../../../文本与输入/ContainerSpan/ts-basic-components-containerspan.md)、[SymbolSpan](../../../文本与输入/SymbolSpan/ts-basic-components-symbolspan.md)、[ArcAlphabetIndexer](../../../信息展示/ArcAlphabetIndexer/ts-container-arc-alphabet-indexer.md)、[OffscreenCanvas](../../../画布绘制/OffscreenCanvas/ts-components-offscreencanvas.md)、[Menu](../../../菜单/Menu/ts-basic-components-menu.md)、[MenuItem](../../../菜单/MenuItem/ts-basic-components-menuitem.md)、[MenuItemGroup](../../../菜单/MenuItemGroup/ts-basic-components-menuitemgroup.md)、[PasteButton](../../../PasteButton/ts-security-components-pastebutton.md)、[SaveButton](../../../SaveButton/ts-security-components-savebutton.md)、[WithTheme](../../../主题/WithTheme/ts-container-with-theme.md)、[NavPushPathHelper](../../../AtomicService/NavPushPathHelper/ohos-atomicservice-navpushpathhelper.md)、[ContentSlot](../../../自定义占位组件/ContentSlot/ts-components-contentslot.md)、[Chip](../../../系统预置UI组件库/Chip/ohos-arkui-advanced-chip.md)、[ExceptionPrompt](../../../系统预置UI组件库/ExceptionPrompt/ohos-arkui-advanced-exceptionprompt.md)、[Filter](../../../系统预置UI组件库/Filter/ohos-arkui-advanced-filter.md)、[FormMenu](../../../系统预置UI组件库/FormMenu/ohos-arkui-advanced-formmenu.md)、[Popup](../../../系统预置UI组件库/Popup/ohos-arkui-advanced-popup.md)、[SelectionMenu](../../../系统预置UI组件库/SelectionMenu/ohos-arkui-advanced-selectionmenu.md)、[SplitLayout](../../../系统预置UI组件库/SplitLayout/ohos-arkui-advanced-splitlayout.md)以及所有弹窗类组件。

Text、TextInput、TextArea、Hyperlink、Image、RichEditor和Web组件的draggable属性默认为true，默认支持拖出能力。

其他支持拖出能力的组件需要开发者将draggable属性设置为true，并在[onDragStart](../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)等接口中实现数据传输相关内容，才能正确处理拖拽。

说明

Text组件需配合[copyOption](../../../文本与输入/Text/ts-basic-components-text.md#copyoption9)一起使用，设置copyOptions为CopyOptions.InApp或者CopyOptions.LocalDevice。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8) | [DragItemInfo](../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragiteminfo) | string12+ | 是 | 设置组件浮起和拖拽过程中的预览图，仅在[onDragStart](../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)拖拽方式中有效。  当组件支持拖拽并同时设置[bindContextMenu](../../弹窗控制/菜单控制/ts-universal-attributes-menu.md#bindcontextmenu8)的预览图时，则长按浮起的预览图以[bindContextMenu](../../弹窗控制/菜单控制/ts-universal-attributes-menu.md#bindcontextmenu8)设置的预览图为准。开发者在[onDragStart](../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)中返回的背板图优先级低于[dragPreview](ts-universal-attributes-drag-drop.md#dragpreview11)设置的预览图，当设置了[dragPreview](ts-universal-attributes-drag-drop.md#dragpreview11)预览图时，拖拽过程中的背板图使用[dragPreview](ts-universal-attributes-drag-drop.md#dragpreview11)预览图。由于[CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8)需要离线渲染之后才能使用，因此存在一定的性能开销和时延，推荐优先使用 [DragItemInfo](../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragiteminfo)中的[PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)方式。  当传入类型为string的id时，则将id对应组件的截图作为预览图。如果id对应的组件无法查找到，或者id对应的组件[Visibility](../../../公共定义/枚举说明/ts-appendix-enums.md#visibility)属性设置成None/Hidden，则对组件自身进行截图作为拖拽预览图。目前截图不含有亮度、阴影、模糊和旋转等视觉效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| preview | [CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8) | [DragItemInfo](../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragiteminfo) | string | 是 | 设置组件浮起和拖拽过程中的预览图，仅在[onDragStart](../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)拖拽方式中有效。  当组件支持拖拽并同时设置[bindContextMenu](../../弹窗控制/菜单控制/ts-universal-attributes-menu.md#bindcontextmenu8)的预览图时，则长按浮起的预览图以[bindContextMenu](../../弹窗控制/菜单控制/ts-universal-attributes-menu.md#bindcontextmenu8)设置的预览图为准。开发者在[onDragStart](../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)中返回的背板图优先级低于[dragPreview](ts-universal-attributes-drag-drop.md#dragpreview11)设置的预览图，当设置了[dragPreview](ts-universal-attributes-drag-drop.md#dragpreview11)预览图时，拖拽过程中的背板图使用[dragPreview](ts-universal-attributes-drag-drop.md#dragpreview11)预览图。由于[CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8)需要离线渲染之后才能使用，因此存在一定的性能开销和时延，推荐优先使用 [DragItemInfo](../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#dragiteminfo)中的[PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)方式。  当传入类型为string的id时，则将id对应组件的截图作为预览图。如果id对应的组件无法查找到，或者id对应的组件[Visibility](../../../公共定义/枚举说明/ts-appendix-enums.md#visibility)属性设置成None/Hidden，则对组件自身进行截图作为拖拽预览图。目前截图不含有亮度、阴影、模糊和旋转等视觉效果。 |
| config | [PreviewConfiguration](../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#previewconfiguration15) | 否 | 对自定义拖拽过程中的预览图进行配置。  只对[dragPreview](ts-universal-attributes-drag-drop.md#dragpreview11)中的预览生效。 |
...
| modifier12+ | [ImageModifier](ts-universal-attributes-drag-drop.md#imagemodifier12) | 否 | 是 | 用于配置拖拽背板图的样式Modifier对象，可使用图片组件所支持的属性和样式来配置背板图样式(参考示例6)，当前支持透明度，阴影，背景模糊度，圆角。文本拖拽只支持默认效果，不支持通过modifier进行自定义。  1.透明度  通过[opacity](../../视效与模糊/透明度设置/ts-universal-attributes-opacity.md#opacity)设置不透明度，不透明度的取值范围为0-1。设置0或不设置时采用背板图透明度的默认值0.95，设置1或异常值时不透明。  2.阴影  通过[shadow](../../视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadow)设置阴影。  3.背景模糊度  通过[backgroundEffect](../../基础属性/背景设置/ts-universal-attributes-background.md#backgroundeffect11)或[backgroundBlurStyle](../../基础属性/背景设置/ts-universal-attributes-background.md#backgroundblurstyle9)设置背景模糊度，如果两者同时设置，以后设置的属性为准。  4.圆角  通过[border](../../布局与边框/边框设置/ts-universal-attributes-border.md#border)或[borderRadius](../../布局与边框/边框设置/ts-universal-attributes-border.md#borderradius)设置圆角，当同时在mode和modifier中设置圆角，mode设置的圆角显示优先级低于modifier设置。  默认值：空，无法修改属性。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
当一个节点上同时设置长按浮起预览（参考[bindContextMenu](../../弹窗控制/菜单控制/ts-universal-attributes-menu.md#bindcontextmenu12)）与拖拽时，使用该字段设置长按浮起预览图与拖拽预览图过渡动效方式。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| isMultiSelectionEnabled | boolean | 否 | 是 | 表示拖拽过程中背板图是否支持多选聚拢效果。true表示支持多选聚拢效果，false表示不支持多选聚拢效果。该参数只在[Grid](../../../滚动与滑动/Grid/ts-container-grid.md)和[List](../../../滚动与滑动/List/ts-container-list.md)组件中的[GridItem](../../../滚动与滑动/GridItem/ts-container-griditem.md)组件和[ListItem](../../../滚动与滑动/ListItem/ts-container-listitem.md)组件生效。  当一个item组件设置为多选拖拽时，该组件的子组件不可拖拽。聚拢组件预览图设置的优先级为[dragPreview](ts-universal-attributes-drag-drop.md#dragpreview11)中的string，dragPreview中的PixelMap，组件自截图，不支持dragPreview中的Builder形式。  不支持组件绑定[bindContextMenu](../../弹窗控制/菜单控制/ts-universal-attributes-menu.md#bindcontextmenu12)中参数存在isShown的模式。  默认值：false  **元服务API**：从API version 12开始，该接口支持在元服务中使用。 |
...
| isLiftingDisabled15+ | boolean | 否 | 是 | 表示长按拖拽时，是否禁用浮起效果。true表示禁用浮起效果，false表示不禁用浮起效果。  如果设置为true，当组件支持拖拽并同时设置[bindContextMenu](../../弹窗控制/菜单控制/ts-universal-attributes-menu.md#bindcontextmenu8)时，仅弹出配置的自定义菜单预览。  默认值：false  **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
...
| enableHapticFeedback18+ | boolean | 否 | 是 | 表示拖拽时是否启用震动。true表示启用震动，false表示不启用震动。仅在存在蒙层的预览（通过[bindContextMenu](../../弹窗控制/菜单控制/ts-universal-attributes-menu.md#bindcontextmenu12)）场景生效。  **注意：** 仅当应用具备 ohos.permission.VIBRATE 权限，且用户启用了触感反馈时才会生效。  默认值：false  **元服务API**：从API version 18开始，该接口支持在元服务中使用。 |
...
| 类型 | 说明 |
| --- | --- |
| [UniformDataType](<../../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.uniformTypeDescriptor (标准化数据定义与描述)/js-apis-data-uniformtypedescriptor.md#uniformdatatype>) | 标准化数据类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageModifier](../../动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#自定义modifier) | 图片组件modifier对象。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/34JIa0daRi6laxJH5sX59w/zh-cn_image_0000002592379934.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074449Z&HW-CC-Expire=86400&HW-CC-Sign=AB162513D5235FC874FA1501BD83EC9AD54391CB415DDEE60BC234EE2EBF6BBF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/oXKP-EtSQPC1jC0TC4plEA/zh-cn_image_0000002622859443.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074449Z&HW-CC-Expire=86400&HW-CC-Sign=D30625C8DAD5ECAEC71721A62581C71663ACD94EAB6CB84A419E2E7E81707442)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/goM37TmgR3u9KEZGENsneA/zh-cn_image_0000002622699563.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074449Z&HW-CC-Expire=86400&HW-CC-Sign=936C7B2F7D1C4C097C84235CFEEA15FF64B41629175D33F15A3F180566ED2E2E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/H1zdk5TvSzuRq_wncqJDGw/zh-cn_image_0000002592220002.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074449Z&HW-CC-Expire=86400&HW-CC-Sign=7D55909FC264ABFDFCED78A4EBF03414B5E9AA16FE84543F4533752E202D25E8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/IOxoF0EqSZ24w7rY1AcEEQ/zh-cn_image_0000002592379936.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074449Z&HW-CC-Expire=86400&HW-CC-Sign=57A7DD0C02E9E7CE5A9D13ED76C2835FCE3641BE47856E52B98C5658EF2682FD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/-8U48me1QfWvwj8vtRO3Gw/zh-cn_image_0000002622859445.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074449Z&HW-CC-Expire=86400&HW-CC-Sign=FE1385D606E20A71ECFDF942F156E6CE24F0F3C9DE8E772B45CD9F86ABAC3497)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/ZNb8yfr9Q161VE4BPX_YgQ/zh-cn_image_0000002622699565.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074449Z&HW-CC-Expire=86400&HW-CC-Sign=7B4A887352AEEDF9664742D1FAAED1192B270AC2A85BBD44FDE9BCF07EBDA3DB)
...
从API version 15开始，示例9通过配置[onlyForLifting](../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#previewconfiguration15)实现自定义预览图，仅用于浮起效果以及配置[isLiftingDisabled](ts-universal-attributes-drag-drop.md#draginteractionoptions12)实现禁用浮起效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/ABCVgp23TWazh8B_lfAd8A/zh-cn_image_0000002592220004.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074449Z&HW-CC-Expire=86400&HW-CC-Sign=6463A8465518BAEC8183DCF3AB3D49E763CC62F5D585643DF7A187D2BA3547B0)

自定义预览图禁用浮起效果。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/NyyZ3rLARy2sdFfTSb2new/zh-cn_image_0000002592379938.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074449Z&HW-CC-Expire=86400&HW-CC-Sign=56A50D862C86F65552127CAED5C623E38B807A659024312EC35A466258A70347)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fd/v3/Yg8b5YGJRu-AlK32L1Dfuw/zh-cn_image_0000002622859447.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074449Z&HW-CC-Expire=86400&HW-CC-Sign=1C81E13D4BF95FD85E4842283A7122CF0E87B4A7BE19AE71DD986391D2CA3272)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/xGy3MkeqRzq_FQr8YCxkpA/zh-cn_image_0000002622699567.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074449Z&HW-CC-Expire=86400&HW-CC-Sign=4E6CA555E30CF2B3D4F4C0DCCCE20EE71E9660FF56B11B6F1D1A04E14975EFC5)

### 示例12（设置自定义组件落入）

从API version 23开始，示例12通过组件的[onDragStart](../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)接口传递其类型，并在目标组件的[allowDrop](ts-universal-attributes-drag-drop.md#allowdrop)属性中设置允许该类型落入，即可实现自定义组件的拖拽落入功能。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/99/v3/S0URbVkFRUa_AHUSsqU44A/zh-cn_image_0000002592220006.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074449Z&HW-CC-Expire=86400&HW-CC-Sign=C07051BF32FD4280C4AC3903EA6237F8AD534B1FFFC496752BCFBA63799F54DC)
