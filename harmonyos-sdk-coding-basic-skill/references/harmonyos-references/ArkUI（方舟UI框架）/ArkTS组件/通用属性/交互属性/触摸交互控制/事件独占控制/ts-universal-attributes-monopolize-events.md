...
scraped_at: 2026-06-11T15:44:58+08:00
doc_updated_at: 2026-04-08
content_hash: sha256:b2c6328a8b9435404be2fc302f546986ae6cc578a45dc1267a2012874465efdb
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| monopolize | boolean | 是 | 组件是否独占事件。true表示组件独占事件，false表示组件不独占事件。  默认值：false  **说明：**  1、如果第一根手指触发了组件事件独占，在抬起前又按下了一根手指，则第二根手指的交互继续处于组件独占状态，依次类推。  2、如果开发者通过[parallelGesture](../../../../手势处理/绑定手势/绑定手势事件/ts-gesture-settings.md#parallelgesture)绑定了与子组件同时触发的手势，如[PanGesture](../../../../手势处理/基础手势/PanGesture/ts-basic-gestures-pangesture.md)，子组件设置了独占控制且首个响应事件，则父组件的手势不会响应。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/9uDw62TmQCCry3j23dLeuQ/zh-cn_image_0000002592379942.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074457Z&HW-CC-Expire=86400&HW-CC-Sign=4FD8412FD40F55464915F89450AD53CAC4DC96B1158D806C2F3FFBC52FA81982)
