...
scraped_at: 2026-06-11T15:44:56+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:7e25be012cf096b40506cbd83ff736dd474197a8e84ed0869839861c2f2027f1
---
设置组件的响应热区。在ArkUI开发框架中，处理触屏事件和鼠标事件时，会在事件触发前进行按压点与组件响应热区的[触摸测试](<../../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/交互基础机制说明/arkts-interaction-basic-principles.md#触摸测试>)，以收集需响应事件的组件。基于测试结果，框架会分发相应的事件。影响[点击事件](../../../../通用事件/交互响应事件/点击事件/ts-universal-events-click.md)、[触摸事件](../../../../通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md)、[拖拽事件](../../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md)、[鼠标事件](../../../../通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md)、[轴事件](../../../../通用事件/基础输入事件/轴事件/ts-universal-events-axis.md)、[悬浮事件](../../../../通用事件/交互响应事件/悬浮事件/ts-universal-events-hover.md)、[无障碍悬浮事件](../../../../通用事件/无障碍相关/无障碍悬浮事件/ts-universal-accessibility-hover-event.md)和[手势事件](../../../../手势处理/绑定手势/绑定手势事件/ts-gesture-settings.md)的分发。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| x | [Length](../../../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 触摸点相对于组件左上角的x轴坐标。  默认值：0vp |
| y | [Length](../../../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 触摸点相对于组件左上角的y轴坐标。  默认值：0vp |
| width | [Length](../../../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 触摸热区的宽度。  默认值：'100%' |
| height | [Length](../../../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 触摸热区的高度。  默认值：'100%' |
...
* 百分比相对于组件自身宽高进行计算。
* 当父组件设置[clip](../../../视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip12)(true)时，子组件的响应会受到父组件触摸热区的影响，不在父组件触摸热区内的子组件无法响应手势和事件。
...
* 当父组件设置[clip](../../../视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip12)为true时，子组件的响应会受到父组件触摸热区的影响，不在父组件触摸热区内的子组件无法响应手势和事件。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| tool | [ResponseRegionSupportedTool](../../../../公共定义/枚举说明/ts-appendix-enums.md#responseregionsupportedtool22) | 否 | 是 | 触摸热区适用的输入工具类型。  默认值：ResponseRegionSupportedTool.ALL |
| x | [LengthMetrics](<../../../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | 触摸点相对于组件左上角的x轴坐标。  默认值：LengthMetrics.vp(0) |
| y | [LengthMetrics](<../../../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | 触摸点相对于组件左上角的y轴坐标。  默认值：LengthMetrics.vp(0) |
| width | [LengthMetrics](<../../../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | string | 否 | 是 | 触摸热区的宽度。  默认值：LengthMetrics.percent(1) |
| height | [LengthMetrics](<../../../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | string | 否 | 是 | 触摸热区的高度。  默认值：LengthMetrics.percent(1) |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/b23JUK4XRD2Mh2ynWJO8WA/zh-cn_image_0000002622859449.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074455Z&HW-CC-Expire=86400&HW-CC-Sign=70EA24FD4BFEFA4D8AD681952EF05B0E3D1394245ED08E6FF14CA49127777A67)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/tIxHHJzPTxyW-dWW9V4NAg/zh-cn_image_0000002622699569.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074455Z&HW-CC-Expire=86400&HW-CC-Sign=AF5F6A0A49DC657C991B9A21DD67726A3592357C2BB8D646B20E324AECDE7A74)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/ahcoNPKJTVSZVFllibaZgg/zh-cn_image_0000002592220008.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074455Z&HW-CC-Expire=86400&HW-CC-Sign=6DB3184E1E188D4A99670394F30A0D709E7D3E4B05CA8A99848012C6D071E67B)
