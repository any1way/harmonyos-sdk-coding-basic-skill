...
scraped_at: 2026-06-01T15:40:05+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:9c59fc9aefff050972a50e84c661336f6bba5c6fcf5d0cdc1fcaf749b2330bc1
---
设置组件的[触摸测试](<../../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/交互基础机制说明/arkts-interaction-basic-principles.md#触摸测试>)类型。在ArkUI开发框架中，处理触屏事件和鼠标事件时，会在事件触发前进行按压点与组件响应热区的触摸测试，以收集需响应事件的组件。基于测试结果，框架会分发相应的事件。hitTestBehavior属性用于设置不同的触摸测试响应模式，影响触摸测试收集结果及后续事件分发。具体影响参考[HitTestMode](../../../../公共定义/枚举说明/ts-appendix-enums.md#hittestmode9)枚举说明。影响[点击事件](../../../../通用事件/交互响应事件/点击事件/ts-universal-events-click.md)、[触摸事件](../../../../通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md)、[拖拽事件](../../../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md)、[鼠标事件](../../../../通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md)、[轴事件](../../../../通用事件/基础输入事件/轴事件/ts-universal-events-axis.md)、[悬浮事件](../../../../通用事件/交互响应事件/悬浮事件/ts-universal-events-hover.md)、[无障碍悬浮事件](../../../../通用事件/无障碍相关/无障碍悬浮事件/ts-universal-accessibility-hover-event.md)和[手势事件](../../../../手势处理/绑定手势/绑定手势事件/ts-gesture-settings.md)的分发。
...
* 存在新增节点时，如需该节点响应触摸测试，需要对其设置[HitTestMode](../../../../公共定义/枚举说明/ts-appendix-enums.md#hittestmode9)。当新增节点存在多层级节点时，仅需设置根节点的HitTestMode。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [HitTestMode](../../../../公共定义/枚举说明/ts-appendix-enums.md#hittestmode9) | 是 | 设置当前组件的触摸测试类型。 |
...
该示例通过设置不同的[HitTestMode](../../../../公共定义/枚举说明/ts-appendix-enums.md#hittestmode9)值演示了Block和Transparent的触摸测试效果。
...
该示例演示了在Stack组件中存在多节点触摸区域重叠时的触摸测试效果。此时设置[HitTestMode](../../../../公共定义/枚举说明/ts-appendix-enums.md#hittestmode9)为None时，重叠的背景区域无法响应触摸测试；只有设置为Transparent时，背景区域才能响应触摸测试。
