...
scraped_at: 2026-06-01T15:39:17+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:66fd854f3c9498ffacc1e19a1b226ece8c264e8dfd5e521f1b2ee587a7d4ccf2
---
...
组件标识的拓展能力仅用于对应用的测试，以下各个接口示例，需要在应用工程的ohosTest/ets/test目录中调试，具体可以参考[自动化测试框架使用指导](../../../../../../harmonyos-guides/应用测试/单元测试和UI测试/自动化测试框架使用指导/arkxtest-guidelines.md)。
...
| 类型 | 说明 |
| --- | --- |
| string | 组件属性列表的JSON字符串。  **说明**：  字符串信息包含组件的tag、id、位置信息(相对于窗口左上角的坐标)以及用于测试检查的组件所包含的相关属性信息。组件中每个字段的含义请参考[getInspectorInfo](<../../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getinspectorinfo12>)的返回值说明。 |
...
| 类型 | 说明 |
| --- | --- |
| Object | 组件树及组件属性列表的JSON对象。组件中每个字段的含义请参考[getInspectorInfo](<../../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getinspectorinfo12>)的返回值说明。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [TouchObject](../../../通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchobject) | 是 | 触发触摸事件的位置，event参数见[TouchObject](../../../通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchobject)的介绍。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [KeyEvent](../../../通用事件/基础输入事件/按键事件/ts-universal-events-key.md#keyevent对象说明) | 是 | 按键事件，event参数见[KeyEvent](../../../通用事件/基础输入事件/按键事件/ts-universal-events-key.md#keyevent对象说明)介绍。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [MouseEvent](../../../通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md#mouseevent对象说明) | 是 | 鼠标事件，event参数见[MouseEvent](../../../通用事件/基础输入事件/鼠标事件/ts-universal-mouse-key.md#mouseevent对象说明)介绍。 |
