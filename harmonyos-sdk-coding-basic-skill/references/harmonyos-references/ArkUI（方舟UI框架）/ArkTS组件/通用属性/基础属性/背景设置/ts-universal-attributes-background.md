...
scraped_at: 2026-06-11T15:44:12+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:0bdd2a0e3df07661148cd7069d6723a61196b8744e66b4a8155167b7d6c3dd8f
---
设置组件的背景样式。
...
设置组件背景。从API version 20开始，content参数新增了对[ResourceColor](../../../公共定义/基础类型定义/ts-types.md#resourcecolor)类型的支持，并新增了背景向父组件的安全区扩展的能力。

说明

* 不支持[onAppear](../../../通用事件/组件变化事件/挂载卸载事件/ts-universal-events-show-hide.md#onappear)和[onDisAppear](../../../通用事件/组件变化事件/挂载卸载事件/ts-universal-events-show-hide.md#ondisappear)等和节点挂载/卸载相关的事件。
* 从API version 20开始，该接口仅当content的入参类型为ResourceColor时支持在[attributeModifier](../../动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#attributemodifier)中调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8) | [ResourceColor](../../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 自定义背景。 |
| options | [BackgroundOptions](ts-universal-attributes-background.md#backgroundoptions20对象说明) | 否 | 设置自定义背景选项。  **说明：**  API version 20之前，options:  {  align?: [Alignment](../../../公共定义/枚举说明/ts-appendix-enums.md#alignment)  } |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| align10+ | [Alignment](../../../公共定义/枚举说明/ts-appendix-enums.md#alignment) | 否 | 是 | 自定义背景与组件的对齐方式。该属性仅对CustomBuilder类型的背景生效。如果设置了ignoresLayoutSafeAreaEdges，则背景的布局区域为包含了扩展安全区的范围。  默认值：Alignment.Center  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| ignoresLayoutSafeAreaEdges | Array<[LayoutSafeAreaEdge](../../布局与边框/安全区域/ts-universal-attributes-expand-safe-area.md#layoutsafeareaedge12)> | 否 | 是 | 配置背景要扩展到的安全区，包括：状态栏，导航栏和[safeAreaPadding](../../布局与边框/尺寸设置/ts-universal-attributes-size.md#safeareapadding14)。  默认值：  - CustomBuilder背景：[]，不扩展。  - ResourceColor背景：[LayoutSafeAreaEdge.ALL]，扩展至所有方向。  **元服务API：** 从API version 20开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 设置组件的背景色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Optional<[ResourceColor](../../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | 设置组件的背景色。  当color的值为undefined时，恢复为默认透明的背景色。 |
...
设置组件背景色。与[backgroundColor](ts-universal-attributes-background.md#backgroundcolor18)相比，color参数新增了对[ColorMetrics](<../../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12>)类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | Optional<[ResourceColor](../../../公共定义/基础类型定义/ts-types.md#resourcecolor) | [ColorMetrics](<../../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12>)> | 是 | 设置组件的背景色。  当color的值为undefined时，恢复为默认透明的背景色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | [ResourceStr](../../../公共定义/基础类型定义/ts-types.md#resourcestr) | [PixelMap12+](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 图片地址。API version 22及之前版本，支持网络图片资源地址、本地图片资源地址、Base64和PixelMap资源，不支持svg图片、gif和webp等类型的动图。 从API version 23开始，新增支持webp和gif类型的动图，显示动图第一帧，不支持其他类型的动图。 |
| repeat | [ImageRepeat](../../../公共定义/枚举说明/ts-appendix-enums.md#imagerepeat) | 否 | 设置背景图片的重复样式，默认不重复。当设置的背景图片为透明底色图片，且同时设置了backgroundColor时，二者叠加显示，背景颜色在最底部。 |
...
| options | [BackgroundImageOptions](../../视效与模糊/图像效果/ts-universal-attributes-image-effect.md#backgroundimageoptions18) | 否 | 设置背景图选项。 |
...
设置组件背景图片的宽度和高度。当未设置backgroundImageSize时，默认组件背景图片宽高效果为[ImageSize.Auto](../../../公共定义/枚举说明/ts-appendix-enums.md#imagesize)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SizeOptions](../../../公共定义/基础类型定义/ts-types.md#sizeoptions) | [ImageSize](../../../公共定义/枚举说明/ts-appendix-enums.md#imagesize) | 是 | 设置背景图像的高度和宽度。默认保持原图的比例不变。  width和height取值范围： [0, +∞)  ImageSize用于控制图片缩放显示模式，如保持比例、填充边界等。  **说明：**  width和height均设置为小于或等于0的值时，按值为0显示。当width和height中只有一个值未设置或者设置为小于等于0的值时，另一个会根据图片原始宽高比进行调整。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Position](../../../公共定义/基础类型定义/ts-types.md#position) | [Alignment](../../../公共定义/枚举说明/ts-appendix-enums.md#alignment) | 是 | 设置背景图在组件中显示位置，即相对于组件左上角的坐标。  x和y值设置百分比时，偏移量是相对组件自身宽高计算的。 |
...
| options11+ | [BlurOptions](../../视效与模糊/组件内容模糊/ts-universal-attributes-foreground-blur-style.md#bluroptions11) | 否 | 灰阶模糊参数。对图像中的黑白色进行色阶调整，使其趋于灰色更为柔和美观，对图像中的彩色调整没有效果。  默认值：grayscale: [0,0] |
...
| options | [BlurOptions](../../视效与模糊/组件内容模糊/ts-universal-attributes-foreground-blur-style.md#bluroptions11) | 否 | 灰阶模糊参数。对图像中的黑白色进行色阶调整，使其趋于灰色更为柔和美观，对图像中的彩色调整没有效果。  默认值：grayscale: [0,0] |
...
blur和backdropBlur是实时模糊接口，会每帧进行实时渲染，性能负载较高。当模糊内容和模糊半径都不需要变化时，建议使用静态模糊接口[blur](<../../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.effectKit (图像效果)/js-apis-effectkit.md#blur>)。
...
backgroundBlurStyle、blur和backdropBlur为实时接口，每帧执行实时渲染，性能负载较大。当模糊内容与模糊半径均无需变动时，推荐采用静态模糊接口[blur](<../../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.effectKit (图像效果)/js-apis-effectkit.md#blur>)。最佳实践请参考[图像模糊动效优化-使用场景](../../../../../../best-practices/图形/图像处理/图像模糊动效优化/bpta-fuzzy-scene-performance-optimization.md#section4945532519)。
...
backgroundEffect接口为实时接口，每帧对模糊等效果执行实时渲染，性能负载较大。当组件背景模糊效果无需变动时，推荐采用静态模糊接口[blur](<../../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.effectKit (图像效果)/js-apis-effectkit.md#blur>)实现模糊效果。最佳实践请参考：[图像模糊动效优化-使用场景](../../../../../../best-practices/图形/图像处理/图像模糊动效优化/bpta-fuzzy-scene-performance-optimization.md#section4945532519)。
...
| color | [ResourceColor](../../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 颜色，默认透明色。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| adaptiveColor | [AdaptiveColor](../../视效与模糊/组件内容模糊/ts-universal-attributes-foreground-blur-style.md#adaptivecolor枚举说明) | 否 | 是 | 背景模糊效果使用的取色模式，默认为DEFAULT。使用AVERAGE时color必须带有透明度，取色模式才生效。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| blurOptions | [BlurOptions](../../视效与模糊/组件内容模糊/ts-universal-attributes-foreground-blur-style.md#bluroptions11) | 否 | 是 | 灰阶模糊参数，默认为[0,0]。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| inactiveColor14+ | [ResourceColor](../../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 模糊不生效时使用的背景色。该参数需配合policy参数使用。当policy使模糊失效时，控件模糊效果会被移除，如果设置了inactiveColor会使用inactiveColor作为控件背景色。  **元服务API：** 从API version 14开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResizableOptions](../../../图片与视频/Image/ts-basic-components-image.md#resizableoptions11) | 是 | 图像拉伸时可调整大小的图像选项。 |
...
继承自[BlurStyleOptions](../../视效与模糊/组件内容模糊/ts-universal-attributes-foreground-blur-style.md#blurstyleoptions)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/i9i1HpR1QoC6jUt_HXOWDw/zh-cn_image_0000002622859383.png?HW-CC-KV=V1&HW-CC-Date=20260611T074410Z&HW-CC-Expire=86400&HW-CC-Sign=52A3BFD9E0EEA5AF88981D06341130C9ABA0176C4D05A28896968C5CF1EC5C96)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7c/v3/YA4uB1J8SkGaF3ARal204Q/zh-cn_image_0000002622699503.png?HW-CC-KV=V1&HW-CC-Date=20260611T074410Z&HW-CC-Expire=86400&HW-CC-Sign=96F39A27546DE8C026DFD1A3A6D7ABC205EFD8B101F9F5E0836E458D5247CD27)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/n2Z-bF7PQYCRdjZ465jT3g/zh-cn_image_0000002592219942.png?HW-CC-KV=V1&HW-CC-Date=20260611T074410Z&HW-CC-Expire=86400&HW-CC-Sign=BD7F4D2A93319F5D4E3F72493FB4471A49B41E3D7BF2E8D9E39294710B5D36A8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2c/v3/BbYelwUWQ_2bUZkrCfj1BA/zh-cn_image_0000002592379876.png?HW-CC-KV=V1&HW-CC-Date=20260611T074410Z&HW-CC-Expire=86400&HW-CC-Sign=B04E777084108ADD21B10D47047A8D2FDDD905386B8E4C1C3C42907DD967B9EA)

修改rate和lightUpDegree参数值为0.5,-0.1：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/zCMxioWGRP-KyjNtM9NB9A/zh-cn_image_0000002622859385.png?HW-CC-KV=V1&HW-CC-Date=20260611T074410Z&HW-CC-Expire=86400&HW-CC-Sign=F9587243A0F2A406C1B479B2C2FE87504E70BFD96C12639706358D7F7E1080D8)

去掉backgroundBrightness的设置，效果如下：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/Ftgnmn3-QMmdaxb0CxIGKQ/zh-cn_image_0000002622699505.png?HW-CC-KV=V1&HW-CC-Date=20260611T074410Z&HW-CC-Expire=86400&HW-CC-Sign=F9A726A41172B1093C7457076FCB95B7FD830CD2FAFEA70A2FEF110EFD762646)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/y6yOOIquTnO9ydhSeCpHgQ/zh-cn_image_0000002592219944.png?HW-CC-KV=V1&HW-CC-Date=20260611T074410Z&HW-CC-Expire=86400&HW-CC-Sign=7EC25746A4416D9C6830CA29CA6716D0DBA0F7DA835A5464464340DBC5CB3200)

### 示例6（设置文字异形模糊效果）

该示例通过[blendMode](../../视效与模糊/图像效果/ts-universal-attributes-image-effect.md#blendmode11)和backgroundEffect实现文字异形模糊效果。

如果出现漏线问题，开发者应首先确保两个blendMode所在组件大小严格相同。如果确认相同，可能是组件边界落在浮点数坐标上导致，可尝试设置[pixelRound](../../布局与边框/组件级像素取整/ts-universal-attributes-pixelroundforcomponent.md#pixelround)通用属性，使产生的白线、暗线两侧的组件边界对齐到整数像素坐标上。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/6mZ5ypsXTjuJZdkGtBUdsw/zh-cn_image_0000002592379878.jpeg?HW-CC-KV=V1&HW-CC-Date=20260611T074410Z&HW-CC-Expire=86400&HW-CC-Sign=8EA877D58F0216C42A7A93D8F71ED11E929875F5A253F6869802031E3AB4FB61)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/JbCAgI-dRUicd8Unrwz-Ww/zh-cn_image_0000002622859387.png?HW-CC-KV=V1&HW-CC-Date=20260611T074410Z&HW-CC-Expire=86400&HW-CC-Sign=F1258B37BE96CBE76A9DCCEFE603B7B4FBA68B9F4E50009A522E799B5CA2558B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/IYbnbSc9QTGOixVvQ10oAg/zh-cn_image_0000002622699507.png?HW-CC-KV=V1&HW-CC-Date=20260611T074410Z&HW-CC-Expire=86400&HW-CC-Sign=F1E440E475147BBDA0844A077E925C9D1CE8A30EA0579A69678ABF30FF44324F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/q2hY0XReQrqls-o2W8aLwA/zh-cn_image_0000002592219946.png?HW-CC-KV=V1&HW-CC-Date=20260611T074410Z&HW-CC-Expire=86400&HW-CC-Sign=3F2CECB8A63D4EE4DFD14FB5113EDEDA0EEED7AC26EBFBEA5681AA99FDF96875)
