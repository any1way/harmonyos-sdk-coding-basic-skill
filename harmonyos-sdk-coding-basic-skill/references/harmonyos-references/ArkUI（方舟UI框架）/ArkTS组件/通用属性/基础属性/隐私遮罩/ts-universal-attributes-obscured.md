...
content_hash: sha256:684e2885789f0c5591cb32a029c0b22b73c67fbcbafc21e436e561faaacb102a
---
用于对组件内容进行隐私遮罩处理。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| reasons | Array<[ObscuredReasons](../../../公共定义/枚举说明/ts-appendix-enums.md#obscuredreasons10)> | 是 | 设置组件内容的遮罩类型。  默认值：[]  仅支持[Image](../../../图片与视频/Image/ts-basic-components-image.md)组件、[Text](../../../文本与输入/Text/ts-basic-components-text.md)组件的隐私遮罩处理。  **说明：**  如需在图片加载过程中显示隐私遮罩，需要设置Image组件的宽度和高度。  Text组件设置子组件或设置[属性字符串](../../../文本与输入/属性字符串/ts-universal-styled-string.md)时，不支持隐私遮罩。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/3vgcJQx0SEiR952qrbrrUg/zh-cn_image_0000002622859393.png?HW-CC-KV=V1&HW-CC-Date=20260611T074413Z&HW-CC-Expire=86400&HW-CC-Sign=6A0381AF20269763EAB543842563E58BFB4DD16A6BE09DD6D81528BDB1BBB05F)
