...
content_hash: sha256:89b89128d11098b80473e8fb23377c86028ea3bf5f46155b60f94538270577e4
---
设置组件的浮层。
...
在当前组件上，增加遮罩文本或者叠加自定义组件以及[ComponentContent](ts-universal-attributes-overlay.md#componentcontent12)作为该组件的浮层。浮层的定位同样基于当前组件进行计算。浮层不通过组件树进行渲染，部分接口（例如[getRectangleById](<../../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (ComponentUtils)/arkts-apis-uicontext-componentutils.md#getrectanglebyid>)）不支持获取浮层中的组件。
...
* 多次调用overlay接口时，如果同时传入string类型和[CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8)类型，或者同时传入string类型和[ComponentContent](ts-universal-attributes-overlay.md#componentcontent12)类型，浮层内容会叠加显示。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | [CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8)10+ | [ComponentContent](ts-universal-attributes-overlay.md#componentcontent12)12+ | 是 | 遮罩文本内容或自定义组件构造函数。  **说明：**  自定义组件作为浮层时，不支持键盘走焦到自定义组件中。通过CustomBuilder设置浮层时，浮层中的内容会在页面刷新时销毁并重新创建，存在一定的性能损耗，页面频繁刷新的场景推荐使用ComponentContent方式设置浮层。 |
| options | [OverlayOptions](ts-universal-attributes-overlay.md#overlayoptions12) | 否 | 浮层的定位。  **说明：**  API version 12之前，options:  {  align?: [Alignment](../../../公共定义/枚举说明/ts-appendix-enums.md#alignment),  offset?: {x?: number, y?: number}  } |
...
overlay节点不支持[onAppear](../../../通用事件/组件变化事件/挂载卸载事件/ts-universal-events-show-hide.md#onappear)和[onDisAppear](../../../通用事件/组件变化事件/挂载卸载事件/ts-universal-events-show-hide.md#ondisappear)等和节点挂载/卸载相关的事件。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| align7+ | [Alignment](../../../公共定义/枚举说明/ts-appendix-enums.md#alignment) | 否 | 是 | 设置浮层相对于组件的方位。  默认值：TopStart  **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 类型 | 说明 |
| --- | --- |
| [ComponentContent](<../../../../ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md>)<T> | 组件内容的实体封装。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/ZWW_eZatR5G4zeeD4k3fEg/zh-cn_image_0000002592379880.png?HW-CC-KV=V1&HW-CC-Date=20260611T074411Z&HW-CC-Expire=86400&HW-CC-Sign=2C9621906B8F0E34CF96E1150515E1DC44111F2724E93EB29155775B454C5246)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/5oElM8QWSfuha2CQL2q1eg/zh-cn_image_0000002622859389.png?HW-CC-KV=V1&HW-CC-Date=20260611T074411Z&HW-CC-Expire=86400&HW-CC-Sign=E0772AC2C940E86CB06C4AD38CE578EC1609A6F73647AE00BC6ED9D15107C6D5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/qN92pabFQLCDTliUsNRkbg/zh-cn_image_0000002622699509.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074411Z&HW-CC-Expire=86400&HW-CC-Sign=0EF043A528B291A034935322188852344F4F0BA3BA78A0C7631EFA0E1165006B)
