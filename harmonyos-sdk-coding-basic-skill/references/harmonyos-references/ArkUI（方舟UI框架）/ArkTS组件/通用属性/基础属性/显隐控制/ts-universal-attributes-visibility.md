...
scraped_at: 2026-06-11T15:44:10+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:b7195e50f189a05dea357f46e0341e82cbfe21647fcb9d8e212fdd145da56f6d
---
控制组件是否可见。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Visibility](../../../公共定义/枚举说明/ts-appendix-enums.md#visibility) | 是 | 控制当前组件显示或隐藏。根据具体场景需要可使用[条件渲染](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ifelse：条件渲染/arkts-rendering-control-ifelse.md>)代替。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/Sg_CyrFoSbmmbayNnOL4AQ/zh-cn_image_0000002592379874.png?HW-CC-KV=V1&HW-CC-Date=20260611T074409Z&HW-CC-Expire=86400&HW-CC-Sign=552C0268745A37A83801D2C0F6B6735F6C07820896267A2FC12A4DFB5861DB32)
