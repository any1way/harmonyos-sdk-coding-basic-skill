...
scraped_at: 2026-06-11T15:45:23+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:42d3808a29e5213486e08268a663a80c91b9f73881887573e881ebdcd93aac7d
---
设置组件对应的工具栏。
...
* 该toolbar为组件通用属性，请注意与[Navigation](../../../导航与切换/Navigation/ts-basic-components-navigation.md)组件自身的toolbar属性进行区分。
...
为绑定该属性的组件，在窗口顶部标题栏相应分栏创建与该组件绑定的由[ToolBarItem](../../../导航与切换/ToolBarItem/ts-basic-components-toolbaritem.md)构成的工具栏，分栏位置依据绑定该属性的组件所在分栏位置确定。[CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8)必须由[ToolBarItem](../../../导航与切换/ToolBarItem/ts-basic-components-toolbaritem.md)构成，该工具栏才能生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 为当前组件配置CustomBuilder类型的自定义工具栏。 |
...
4. toolbar仅支持在[NavigationMode](../../../导航与切换/Navigation/ts-basic-components-navigation.md#navigationmode9枚举说明)为Split的场景中使用。
5. 标题栏高度会根据toolbar内的[ToolBarItem](../../../导航与切换/ToolBarItem/ts-basic-components-toolbaritem.md)组件在有限范围内浮动：

   * [ToolBarItem](../../../导航与切换/ToolBarItem/ts-basic-components-toolbaritem.md)组件与标题栏默认存在4VP的margin（外边距）。
   * 当[ToolBarItem](../../../导航与切换/ToolBarItem/ts-basic-components-toolbaritem.md)组件的最大高度小于等于48VP时，标题栏高度会调整为56VP，此设置适用于标题栏、工具栏、搜索栏等通用组件。
   * 当[ToolBarItem](../../../导航与切换/ToolBarItem/ts-basic-components-toolbaritem.md)组件的最大高度介于48VP到56VP之间时，标题栏高度会调整为64VP，此设置适用于图标与文字同时呈现的工具栏。
   * 当[ToolBarItem](../../../导航与切换/ToolBarItem/ts-basic-components-toolbaritem.md)组件的最大高度超过56VP时，标题栏高度会调整为72VP。如果[ToolBarItem](../../../导航与切换/ToolBarItem/ts-basic-components-toolbaritem.md)组件的最大高度超过64VP，则标题栏的高度保持为72VP，超出的区域会发生裁剪。

## 示例

PhonePC/2in1TabletTVWearable

该示例通过为[Navigation](../../../导航与切换/Navigation/ts-basic-components-navigation.md)下的[Button](../../../按钮与选择/Button/ts-basic-components-button.md)组件绑定toolbar通用属性，为标题栏Navbar分栏开头位置添加包含两个[Button](../../../按钮与选择/Button/ts-basic-components-button.md)组件工具栏项。为[NavDestination](../../../导航与切换/NavDestination/ts-basic-components-navdestination.md)下的[Text](../../../文本与输入/Text/ts-basic-components-text.md)组件绑定toolbar通用属性，为标题栏NavDestination分栏末尾位置添加包含一个滑动条组件和一个搜索栏组件工具栏项。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/izBRBWGXQVu5JJE6IlhxyA/zh-cn_image_0000002622699605.png?HW-CC-KV=V1&HW-CC-Date=20260611T074522Z&HW-CC-Expire=86400&HW-CC-Sign=A318BE40ECEE2D3697E317425E74EF58E66BF02C758DB4A03C91E75761D68049)
