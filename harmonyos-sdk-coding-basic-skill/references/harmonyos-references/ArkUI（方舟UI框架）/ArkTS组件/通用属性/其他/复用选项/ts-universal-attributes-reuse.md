...
scraped_at: 2026-06-01T15:40:29+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:7a533293d104b989a1fed3cf641ad4adcedaaee9ac7284587225c0e14922628e
---
reuse属性用于给@ReusableV2装饰的自定义组件指定复用选项。

本文档仅为API参考说明。实际功能使用与限制见[@ReusableV2装饰器：V2组件复用](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/自定义组件复用/@ReusableV2装饰器：V2组件复用/arkts-new-reusablev2.md>)。
