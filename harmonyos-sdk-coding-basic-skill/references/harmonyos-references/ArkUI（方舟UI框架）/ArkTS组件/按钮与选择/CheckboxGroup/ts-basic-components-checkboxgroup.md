...
scraped_at: 2026-06-11T15:46:53+08:00
doc_updated_at: 2026-04-08
content_hash: sha256:5b3b5edce2c478c267efe77697079555e1b448d68902684daa9fbb8301db2e00
---
...
在结合带缓存功能的组件使用时（如[List](../../滚动与滑动/List/ts-container-list.md)），未被创建的Checkbox选中状态需要应用手动控制。详细示例请参考[示例4](ts-basic-components-checkboxgroup.md#示例4设置全选)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| group | string | 否 | 是 | 群组名称。  默认值：undefined，默认状态下管理[CheckboxOptions](../Checkbox/ts-basic-components-checkbox.md#checkboxoptions对象说明)属性group信息为undefined的节点。  **说明：**  具有相同群组名称的多个CheckboxGroup，仅第一个CheckboxGroup生效。 |
...
设置是否全选。若同组的[Checkbox](../Checkbox/ts-basic-components-checkbox.md)显式设置了select属性，则Checkbox的优先级高。

在与带有缓存功能的组件（如[List](../../滚动与滑动/List/ts-container-list.md)）配合使用时，未创建的Checkbox选中状态需由开发者控制。
...
设置是否全选。若同组的[Checkbox](../Checkbox/ts-basic-components-checkbox.md)显式设置了select属性，则Checkbox的优先级高。与[selectAll](ts-basic-components-checkboxgroup.md#selectall)相比，isAllSelected参数新增了对undefined类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isAllSelected | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否全选。  当isAllSelected的值为undefined时取默认值false。  值为true时，多选框群组将全部被选中；值为false时，多选框群组将全部取消选中。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 被选中或部分选中状态的颜色。  默认值：$r('sys.color.ohos\_id\_color\_text\_primary\_activated')  异常值按照默认值处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resColor | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | 被选中或部分选中状态的颜色。  当resColor的值为undefined时，默认值：$r('sys.color.ohos\_id\_color\_text\_primary\_activated')  异常值按照默认值处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 非选中状态边框颜色。  默认值：$r('sys.color.ohos\_id\_color\_switch\_outline\_off')。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resColor | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | 非选中状态边框颜色。  当resColor的值为undefined时，默认值：$r('sys.color.ohos\_id\_color\_switch\_outline\_off')。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [MarkStyle](../../公共定义/基础类型定义/ts-types.md#markstyle10对象说明) | 是 | 多选框内部图标样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[MarkStyle](../../公共定义/基础类型定义/ts-types.md#markstyle10对象说明)> | 是 | 多选框内部图标样式。  当style的值为undefined时，维持上次取值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CheckBoxShape](../../公共定义/枚举说明/ts-appendix-enums.md#checkboxshape11) | 是 | 设置CheckboxGroup组件形状，包括圆形和圆角方形。  默认值：CheckBoxShape.CIRCLE  **说明：**  CheckboxGroup组件将按照设置的形状显示。  CheckboxGroup内所有未单独设置shape类型的Checkbox，其形状将与CheckboxGroup保持一致。  CheckboxGroup内已单独设置shape类型的Checkbox，其形状将优先于CheckboxGroup的设置，按照自身设置显示。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<ContentModifier<[CheckBoxGroupConfiguration](ts-basic-components-checkboxgroup.md#checkboxgroupconfiguration21对象说明)>> | 是 | 在CheckboxGroup组件上，定制内容区的方法。  modifier：内容修改器，开发者需要自定义类以实现ContentModifier接口。  当modifier的值为undefined时，不使用内容修改器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[OnCheckboxGroupChangeCallback](ts-basic-components-checkboxgroup.md#oncheckboxgroupchangecallback18)> | 是 | 多选框群组的信息。  当callback的值为undefined时，不使用回调函数。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/Tu_cweakTmyQOs8o5_ckaQ/zh-cn_image_0000002592380100.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074651Z&HW-CC-Expire=86400&HW-CC-Sign=0D78F7650755643049D289C59375B373E1A74D26E94D624CBEFB66DD8ACE7E91)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/Wwj1yG5DRzOTMmdaFQv97w/zh-cn_image_0000002622859609.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074651Z&HW-CC-Expire=86400&HW-CC-Sign=A2F043BBAF15BFC9068121B1DDE64C6F791255F3CD3BE55C8B44AA75E95FF2AE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/B1Pso9StQTaB7iZ3LCVqMw/zh-cn_image_0000002622699729.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074651Z&HW-CC-Expire=86400&HW-CC-Sign=8B831FD8BE48FEE7701BC35E5DD9B1694D0533BB2B8067AFB3ABE360C78C3CD0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/kCZVMorhTwGudBZ330Sgrw/zh-cn_image_0000002592220168.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074651Z&HW-CC-Expire=86400&HW-CC-Sign=8AFD3B59766C3C76BC2674BD98C091F8855E2329053C09EDB5F66ACD621A915D)
