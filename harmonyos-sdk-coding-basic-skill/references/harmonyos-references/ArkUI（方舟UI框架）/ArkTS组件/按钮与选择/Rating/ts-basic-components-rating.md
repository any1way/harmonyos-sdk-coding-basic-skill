...
scraped_at: 2026-06-11T15:47:03+08:00
doc_updated_at: 2026-04-08
content_hash: sha256:b00948510f630e9aa2fdb9555b3141bb833156040d536674537bd18493c28291
---
提供在给定范围内选择评分的组件。
...
* 当Rating的父节点有指定宽高时，需为Rating组件指定宽高，或为父节点设置值为true的[clip](../../通用属性/视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip18)属性。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| starCount | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<number> | 是 | 设置评分总数。  当starCount的值为undefined时，默认值：5 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<number> | 是 | 操作评级的步长。  当size的值为undefined时，默认值：0.5  取值范围：[0.1, stars] |
...
设置评分的样式。该属性所支持的图片类型能力参考[Image](../../图片与视频/Image/ts-basic-components-image.md)组件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ContentModifier<RatingConfiguration>](ts-basic-components-rating.md#ratingconfiguration12对象说明)> | 是 | 在Rating组件上，定制内容区的方法。  modifier：内容修改器，开发者需要自定义class实现ContentModifier接口。  当modifier的值为undefined时，不使用内容修改器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[OnRatingChangeCallback](ts-basic-components-rating.md#onratingchangecallback18)> | 是 | 操作评分条的评星变化时触发该回调。  当callback的值为undefined时，不使用回调函数。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| rating | number | 否 | 否 | 设置并接收评分值。  默认值：0  取值范围： [0, stars]  小于0取0，大于[stars](ts-basic-components-rating.md#stars)取最大值stars。  该参数支持[$$](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)双向绑定变量。  该参数支持[!!](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/!!语法：双向绑定/arkts-new-binding.md#系统组件参数双向绑定>)双向绑定变量。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| rating7+ | number | 否 | 否 | 设置并接收评分值。  默认值：0  取值范围： [0, stars]  小于0取0，大于[stars](ts-basic-components-rating.md#stars)取最大值stars。  该参数支持[$$](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)双向绑定变量。  **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| backgroundUri7+ | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 未选中的星级的图片链接，可由用户自定义或使用系统默认图片。  **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。  从API version 20开始，该接口支持设置Resource资源。参考[示例3（通过Resource资源设置评分的样式）](ts-basic-components-rating.md#示例3通过resource资源设置评分的样式)代码。 |
| foregroundUri7+ | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 选中的星级的图片路径，可由用户自定义或使用系统默认图片。  **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。  从API version 20开始，该接口支持设置Resource资源。参考[示例3（通过Resource资源设置评分的样式）](ts-basic-components-rating.md#示例3通过resource资源设置评分的样式)代码。 |
| secondaryUri7+ | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 部分选中的星级的图片路径，可由用户自定义或使用系统默认图片。  **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。  从API version 20开始，该接口支持设置Resource资源。参考[示例3（通过Resource资源设置评分的样式）](ts-basic-components-rating.md#示例3通过resource资源设置评分的样式)代码。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/01DuRJe9S3O1qPHjJz7zVg/zh-cn_image_0000002592380120.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074701Z&HW-CC-Expire=86400&HW-CC-Sign=45937268073564353E261E5997CCCBAE8417F32860556B8528B25502E617C4ED)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fd/v3/53zYQd44RDyRTTKKQgIuaA/zh-cn_image_0000002622859629.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074701Z&HW-CC-Expire=86400&HW-CC-Sign=EDE0422CA70BE28C7D5EDC0CE7B1F7A33D0C2697528B14D6F1A0973863BB8378)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/SRNu0bYnTAG0xHzX1Kg_9Q/zh-cn_image_0000002622699749.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074701Z&HW-CC-Expire=86400&HW-CC-Sign=E4FAAEA9F51D57A03AA43BB4E8EBAAA8274587385CB92C7D0368ACA0591022F4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/ZRsE91GFQ92dpP1MMPHR1A/zh-cn_image_0000002622699749.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074701Z&HW-CC-Expire=86400&HW-CC-Sign=4C9058D79C4C8CDDE2DA37FC0BE772041A7885502D8260B1E8EB3C79774146CC)
