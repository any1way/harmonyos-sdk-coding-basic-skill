...
scraped_at: 2026-06-11T15:47:04+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:34e9fadbeac06bbd137455d8e3cd6ab907d58690dfef8e7823dfe6665c2ce2ce
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| value | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 下拉选项内容。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| icon | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 下拉选项图片。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| symbolIcon12+ | [SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md) | 否 | 是 | 下拉选项Symbol图片。  symbolIcon优先级高于icon。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
从API version 18开始，该属性支持[!!](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/!!语法：双向绑定/arkts-new-binding.md#系统组件参数双向绑定>)双向绑定变量。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [Resource](../../公共定义/基础类型定义/ts-types.md#resource)11+ | 是 | 下拉菜单初始选项的索引，索引值从0开始。 |
...
该属性支持[$$](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)、[!!](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/!!语法：双向绑定/arkts-new-binding.md#系统组件参数双向绑定>)双向绑定变量。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| numCount | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<number | [Resource](../../公共定义/基础类型定义/ts-types.md#resource)> | 是 | 下拉菜单初始选项的索引。  当numCount的值为undefined时，选中第一项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr)11+ | 是 | 下拉按钮本身的文本内容。  **说明：** 文本长度大于列宽时，文本被截断。 |
...
该参数支持[$$](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)、[!!](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/!!语法：双向绑定/arkts-new-binding.md#系统组件参数双向绑定>)双向绑定变量。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resStr | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr)> | 是 | 下拉按钮本身的文本内容。  当resStr的值为undefined时维持上次取值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ControlSize](../Button/ts-basic-components-button.md#controlsize11枚举说明)11+ | 是 | Select组件的尺寸。  默认值：ControlSize.NORMAL |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ControlSize](../Button/ts-basic-components-button.md#controlsize11枚举说明)> | 是 | Select组件的尺寸。  当size的值为undefined时，默认值为ControlSize.NORMAL。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [ContentModifier](../../通用属性/动态属性与自定义/自定义内容/ts-universal-attributes-content-modifier.md#contentmodifiert)[<MenuItemConfiguration>](ts-basic-components-select.md#menuitemconfiguration12对象说明) | 是 | 在Select组件上，定制下拉菜单项内容区的方法。  modifier：内容修改器，开发者需要自定义class实现ContentModifier接口。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[DividerStyleOptions](../../公共定义/基础类型定义/ts-types.md#dividerstyleoptions12)> | 是 | 1.设置DividerOptions，则按设置的样式显示分割线。  默认值：  {  strokeWidth: '1px' ,  color: '#33182431'  }  2.设置为null或undefined时，展示默认分割线。  3.当mode为FLOAT\_ABOVE\_MENU时，strokeWidth设置过宽时，会覆盖文字。分割线会从每一个Item底部开始，同时向上向下画分割线。当mode为EMBEDDED\_IN\_MENU时，分割线在Menu中展开，独立占用高度。  4.startMargin和endMargin的默认值与不设置divider属性时的分割线样式保持一致。startMargin和endMargin的和与optionWidth的值相等时，不显示分割线。startMargin和endMargin的和超过optionWidth的值时，按照默认样式显示分割线。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 是 | 下拉按钮本身的文本样式。  API version 11及以前默认值：  {  size: $r('sys.float.ohos\_id\_text\_size\_button1'),  weight: FontWeight.Medium  }  API version 12以后，如果设置controlSize的值为：controlSize.SMALL，size默认值是$r('sys.float.ohos\_id\_text\_size\_button2')，否则为$r('sys.float.ohos\_id\_text\_size\_button1')。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| selectFont | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Font](../../公共定义/基础类型定义/ts-types.md#font)> | 是 | 下拉按钮本身的文本样式。  如果设置controlSize的值为：controlSize.SMALL，size默认值是$r('sys.float.ohos\_id\_text\_size\_button2')，否则为$r('sys.float.ohos\_id\_text\_size\_button1')。  当selectFont的值为undefined时，恢复为系统文本样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 下拉按钮本身的文本颜色。  默认值：$r('sys.color.ohos\_id\_color\_text\_primary')混合$r('sys.color.ohos\_id\_alpha\_content\_primary')的透明度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resColor | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | 下拉按钮本身的文本颜色。  当resColor的值为undefined时，默认值：$r('sys.color.ohos\_id\_color\_text\_primary')混合$r('sys.color.ohos\_id\_alpha\_content\_primary')的透明度。  当value的值为undefined时，维持上次取值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 下拉菜单选中项的背景色。  默认值：$r('sys.color.ohos\_id\_color\_component\_activated')混合$r('sys.color.ohos\_id\_alpha\_highlight\_bg')的透明度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resColor | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | 下拉菜单选中项的背景色。  当resColor的值为undefined时，默认值：$r('sys.color.ohos\_id\_color\_component\_activated')混合$r('sys.color.ohos\_id\_alpha\_highlight\_bg')的透明度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 是 | 下拉菜单选中项的文本样式。  默认值：  {  size: $r('sys.float.ohos\_id\_text\_size\_body1'),  weight: FontWeight.Regular  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| selectFont | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Font](../../公共定义/基础类型定义/ts-types.md#font)> | 是 | 下拉菜单选中项的文本样式。  当selectFont的值为undefined时，默认值：  {  size: $r('sys.float.ohos\_id\_text\_size\_body1'),  weight: FontWeight.Regular  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 下拉菜单选中项的文本颜色。  默认值：$r('sys.color.ohos\_id\_color\_text\_primary\_activated') |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resColor | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | 下拉菜单选中项的文本颜色。  当resColor的值为undefined时，默认值为$r('sys.color.ohos\_id\_color\_text\_primary\_activated')。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 下拉菜单项的背景色。  默认值：  API version 11之前，默认值为Color.White。  API version 11及之后，默认值为Color.Transparent。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resColor | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | 下拉菜单项的背景色。  当resColor的值为undefined时，下拉菜单项的背景色为Color.White。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 是 | 下拉菜单项的文本样式。  默认值：  {  size: $r('sys.float.ohos\_id\_text\_size\_body1'),  weight: FontWeight.Regular  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| selectFont | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Font](../../公共定义/基础类型定义/ts-types.md#font)> | 是 | 下拉菜单项的文本样式。  当selectFont的值为undefined时，默认值：  {  size: $r('sys.float.ohos\_id\_text\_size\_body1'),  weight: FontWeight.Regular  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 下拉菜单项的文本颜色。  默认值：$r('sys.color.ohos\_id\_color\_text\_primary') |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resColor | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | 下拉菜单项的文本颜色。  当resColor的值为undefined时，默认值：$r('sys.color.ohos\_id\_color\_text\_primary') |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 下拉菜单项的文本与箭头的间距。  默认值：8  **说明：** 设置string类型时，不支持百分比。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| spaceLength | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Length](../../公共定义/基础类型定义/ts-types.md#length)> | 是 | 下拉菜单项的文本与箭头之间的间距。  当spaceLength的值为undefined时，默认值：8 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ArrowPosition](ts-basic-components-select.md#arrowposition10枚举说明)> | 是 | 下拉菜单项的文本与箭头之间的对齐方式。  当position的值为undefined时，默认值：ArrowPosition.END |
...
| offset | [Offset](../../公共定义/基础类型定义/ts-types.md#offset) | 否 | 按照对齐类型对齐后，下拉菜单相对下拉按钮的偏移量。  默认值：{dx: 0, dy: 0} |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| alignType | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[MenuAlignType](ts-basic-components-select.md#menualigntype10枚举说明)> | 是 | 对齐方式类型。  当alignType的值为undefined时，默认值：MenuAlignType.START |
| offset | [Offset](../../公共定义/基础类型定义/ts-types.md#offset) | 否 | 按照对齐类型对齐后，下拉菜单相对下拉按钮的偏移量。  默认值：{dx: 0, dy: 0} |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | [OptionWidthMode](../../公共定义/枚举说明/ts-appendix-enums.md#optionwidthmode11) | 是 | 下拉菜单项的宽度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| width | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | [OptionWidthMode](../../公共定义/枚举说明/ts-appendix-enums.md#optionwidthmode11)> | 是 | 下拉菜单项的宽度。  当width的值为undefined时，属性无效，菜单项宽度设为默认值，即2栅格。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | 是 | 下拉菜单显示的最大高度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| height | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10)> | 是 | 下拉菜单显示的最大高度。  当height的值为undefined时，属性不生效，下拉菜单最大高度设为默认值，即下拉菜单最大高度默认值为屏幕可用高度的80%。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 下拉菜单的背景色。  默认值：  API version 11之前，默认值为$r('sys.color.ohos\_id\_color\_card\_bg')。  API version 11及之后，默认值为Color.Transparent。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resColor | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | 下拉菜单的背景色。  当resColor的值为undefined时，默认值为Color.Transparent。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BlurStyle](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#blurstyle9) | 是 | 下拉菜单的背景模糊材质。  默认值：BlurStyle.COMPONENT\_ULTRA\_THICK |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[BlurStyle](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#blurstyle9)> | 是 | 下拉菜单的背景模糊材质。  当style的值为undefined时，默认值：BlurStyle.COMPONENT\_ULTRA\_THICK |
...
textModifier(modifier: Optional<[TextModifier](../../通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[TextModifier](../../通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md)> | 是 | 在Select组件上，定制按钮文本样式的方法。  当modifier的值为undefined时，不自定义文本样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md)> | 是 | 在Select组件上，定制Select按钮下拉箭头图标样式的方法。  当modifier的值为undefined时，不自定义下拉箭头图标样式。 |

### optionTextModifier20+

PhonePC/2in1TabletTVWearable

optionTextModifier(modifier: Optional<[TextModifier](../../通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[TextModifier](../../通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md)> | 是 | 在Select组件上，定制Select下拉菜单未选中项样式的方法。  当modifier的值为undefined时，不自定义下拉菜单未选中项的文本样式。 |

### selectedOptionTextModifier20+

PhonePC/2in1TabletTVWearable

selectedOptionTextModifier(modifier: Optional<[TextModifier](../../通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md)>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[TextModifier](../../通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md)> | 是 | 设置下拉菜单项选中项的文本样式。  开发者可以根据需要管理和维护文本的样式进行设置。  当modifier的值为undefined时，不自定义下拉菜单项选中项的文本样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| showInSubWindow | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 设置下拉菜单是否显示在子窗中。  true代表下拉菜单显示在子窗中。  false代表下拉菜单不显示在子窗中。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[MenuKeyboardAvoidMode](../../通用属性/弹窗控制/菜单控制/ts-universal-attributes-menu.md#menukeyboardavoidmode23枚举说明)> | 是 | 设置下拉菜单是否避让软键盘。取值为undefined时，按照MenuKeyboardAvoidMode.NONE处理，不避让软键盘。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| distance | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)> | 是 | 设置下拉菜单避让软键盘的最小距离。设置为负数、undefined时，按照8vp处理。 |
...
开发者需要自定义class实现ContentModifier接口。继承自[CommonConfiguration](../../通用属性/动态属性与自定义/自定义内容/ts-universal-attributes-content-modifier.md#commonconfigurationt)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| value | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 下拉菜单项的文本内容。  **说明：**  当文本字符的长度超过菜单项文本区域的宽度时，文本将会被截断。 |
| icon | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 下拉菜单项的图片内容。  **说明：**  string格式可用于加载网络图片和本地图片。 |
| symbolIcon | [SymbolGlyphModifier](../../通用属性/动态属性与自定义/动态SymbolGlyphModifier属性设置/ts-attr-symbolglyphmodifier.md) | 否 | 是 | 下拉选项Symbol图片内容。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| width | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | [EdgeOutlineWidths](../../公共定义/基础类型定义/ts-types.md#edgeoutlinewidths11对象说明) | 否 | 是 | 设置外描边宽度，不支持百分比。  默认值：0 |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | [EdgeColors](../../公共定义/基础类型定义/ts-types.md#edgecolors9) | 否 | 是 | 设置外描边颜色。  默认值：#19ffffff |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[OnSelectCallback](ts-basic-components-select.md#onselectcallback18)> | 是 | 下拉菜单选中某一项的回调。  当callback的值为undefined时，不使用回调函数。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/53/v3/EREvOlbMTJC7OQgK-BFnQQ/zh-cn_image_0000002592220188.png?HW-CC-KV=V1&HW-CC-Date=20260611T074702Z&HW-CC-Expire=86400&HW-CC-Sign=5D143A373262DC7CCCB9C1561ACBE106EB69E4696E5434CD59DF29E2DF4C32EE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/8dVOyANzRXSh5veTPn1qNA/zh-cn_image_0000002592380122.png?HW-CC-KV=V1&HW-CC-Date=20260611T074702Z&HW-CC-Expire=86400&HW-CC-Sign=0C0943D2875801E75F80BA4BD14EC7826C2B004B177A8A44F80FD5503A99513C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/nJDF7GQYQuy2SCSHxwaXrg/zh-cn_image_0000002622859631.png?HW-CC-KV=V1&HW-CC-Date=20260611T074702Z&HW-CC-Expire=86400&HW-CC-Sign=326DB63E3DCA1D493A041725841231401F044E6F38EA401EB1A9D65409B039ED)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e3/v3/ZHsyfGzuQ4q_iRouG5gZ5g/zh-cn_image_0000002622699751.png?HW-CC-KV=V1&HW-CC-Date=20260611T074702Z&HW-CC-Expire=86400&HW-CC-Sign=E4CDC01182F59C46F9E36510219D51F7A90BC0AAAFA391C4A1A3B889FD4CC4DB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/DnSHhLXaRB-_cbpRbmpdmw/zh-cn_image_0000002592220190.png?HW-CC-KV=V1&HW-CC-Date=20260611T074702Z&HW-CC-Expire=86400&HW-CC-Sign=AD621EF32B3B8192E92AFA32D771745CD25A5B0B6BFEB231FDB6992CECE71E5F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/DkMafokGSxSYLOI8vwytZA/zh-cn_image_0000002592380124.png?HW-CC-KV=V1&HW-CC-Date=20260611T074702Z&HW-CC-Expire=86400&HW-CC-Sign=53BF3D9BD8BDC6C51E6E51F82D41C0A97A2E8EC985C25CECEB78C4900CF9434B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/qXYn6coLT9e86A-ZMVS6nA/zh-cn_image_0000002622859633.png?HW-CC-KV=V1&HW-CC-Date=20260611T074702Z&HW-CC-Expire=86400&HW-CC-Sign=9E6296A8A7438EF7D789D5C840E78A10477083EF69D8A1DBED3B6AB33A99337E)

### 示例8（设置分割线模式）

从API version 19开始，该示例通过配置[DividerStyleOptions](../../公共定义/基础类型定义/ts-types.md#dividerstyleoptions12)的mode属性设置分割线模式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/mekfLkSFTIWcB4WYBng7IQ/zh-cn_image_0000002622699753.png?HW-CC-KV=V1&HW-CC-Date=20260611T074702Z&HW-CC-Expire=86400&HW-CC-Sign=A07B3871B034245FA6B2DABBD04F6B584EEF61851491D0BD7C02E87C11CB411C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/aH1PDp8dTr2KK3nxpmVdKQ/zh-cn_image_0000002592220192.png?HW-CC-KV=V1&HW-CC-Date=20260611T074702Z&HW-CC-Expire=86400&HW-CC-Sign=21FFB5D99013227AAB6E02E2CBFBBCE4EC2641375C7FFED05D8875D0C1EF6879)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/xnFA2hRgQbGYdamO02NR-Q/zh-cn_image_0000002592380126.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074702Z&HW-CC-Expire=86400&HW-CC-Sign=593AB1837DA55598E30F1C2C506A0973D7AA44844290CD0FE71143D0B71853F3)
