...
content_hash: sha256:988af14ac6b517c81bfd38e83f210a757a6222085b1ac4c9d474271f0eba429b
---
...
| digitalCrownSensitivity | [CrownSensitivity](../../公共定义/枚举说明/ts-appendix-enums.md#crownsensitivity18) | 否 | 是 | 设置旋转表冠的灵敏度。  默认值：CrownSensitivity.MEDIUM  **装饰器类型：** @Trace |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [TouchEvent](../../通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md#touchevent对象说明) | 是 | 获得TouchEvent对象。 |
...
| digitalCrownSensitivity | [CrownSensitivity](../../公共定义/枚举说明/ts-appendix-enums.md#crownsensitivity18) | 否 | 是 | 设置旋转表冠的灵敏度。  默认值：CrownSensitivity.MEDIUM |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/ehZ4IgufSwq4XsMCoF9KWg/zh-cn_image_0000002592380132.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074707Z&HW-CC-Expire=86400&HW-CC-Sign=85A3BF6F8330772B5A1530FA4FC731831187B8E8335EBB729B47A495EC648AD9)
