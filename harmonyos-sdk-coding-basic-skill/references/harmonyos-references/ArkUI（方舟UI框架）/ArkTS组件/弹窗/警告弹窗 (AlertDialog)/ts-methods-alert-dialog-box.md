...
scraped_at: 2026-06-11T15:49:10+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:a10c3e1fabd64d4be13a2429689a0ae52939f177e9384910a511f9c2880bacee
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| title | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 弹窗标题。  API version 20之前，弹窗标题的对齐方式为左对齐。  API version 20及之后，弹窗标题的对齐方式为居中对齐。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| subtitle10+ | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 弹窗副标题。  API version 20之前，弹窗副标题的对齐方式为左对齐。  API version 20及之后，弹窗副标题的对齐方式为居中对齐。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| message | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 弹窗内容。  API version 20之前，弹窗内容的对齐方式为左对齐。  API version 20及之后，弹窗内容的对齐方式为居中对齐。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| borderWidth12+ | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | [EdgeWidths](../../公共定义/基础类型定义/ts-types.md#edgewidths9) | [LocalizedEdgeWidths](../../公共定义/基础类型定义/ts-types.md#localizededgewidths12) | 否 | 是 | 可分别设置4个边框宽度。  默认值：0  百分比参数方式：以父元素弹窗宽的百分比来设置弹窗的边框宽度。  当弹窗左边框和右边框大于弹窗宽度，弹窗上边框和下边框大于弹窗高度，显示可能不符合预期。  **说明：**  当borderWidth属性类型为LocalizedEdgeWidths时，支持随语言习惯改变布局顺序。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| levelUniqueId15+ | number | 否 | 是 | 设置页面级弹窗需要显示的层级下的[节点UniqueID](<../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#getuniqueid12>)。仅在levelMode属性设置为LevelMode.EMBEDDED时生效。  取值范围：大于等于0的数字。  **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
...
| 类型 | 说明 |
| --- | --- |
| [LevelOrder](<../../../ArkTS API/UI界面/@ohos.promptAction (弹窗)/js-apis-promptaction.md#levelorder18>) | 设置弹窗的显示顺序。 |
...
| style10+ | [DialogButtonStyle](../../公共定义/枚举说明/ts-appendix-enums.md#dialogbuttonstyle10) | 否 | 是 | 设置Button的风格样式，默认值DialogButtonStyle.DEFAULT。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| value10+ | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | Button的文本内容，若值为null，则该按钮不显示。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fontColor10+ | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | Button的文本颜色。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| backgroundColor10+ | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | Button背景颜色。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| action10+ | [VoidCallback](../../公共定义/基础类型定义/ts-types.md#voidcallback12) | 否 | 否 | Button选中时的回调。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| x | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 弹窗遮蔽层区域相对于窗口左上角的x轴坐标。  默认值：0vp |
| y | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 弹窗遮蔽层区域相对于窗口左上角的y轴坐标。  默认值：0vp |
| width | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 弹窗遮蔽层区域的宽度。  默认值：'100%' |
| height | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 弹窗遮蔽层区域的高度。  默认值：'100%' |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| wordBreak | [WordBreak](../../公共定义/枚举说明/ts-appendix-enums.md#wordbreak11) | 否 | 是 | 弹窗message内容的文本截断方式。  默认值：WordBreak.BREAK\_ALL |
...
从API version 7开始支持，从API version 18开始废弃，建议使用[showAlertDialog](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#showalertdialog>)替代。showAlertDialog需先获取[UIContext](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)实例后再进行调用。

从API version 10开始，可以通过使用[UIContext](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[showAlertDialog](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#showalertdialog>)来明确UI的执行上下文。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/uNSmnGFHRWKKsh-tt5vUXg/zh-cn_image_0000002622859947.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074908Z&HW-CC-Expire=86400&HW-CC-Sign=A1B0703CB314FAE98A6B3F53526EFBC65872F7DC7293BBF33E399AC0F4324D28)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/KhIII_8URdmmloRk8CiJgg/zh-cn_image_0000002622700065.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074908Z&HW-CC-Expire=86400&HW-CC-Sign=F5E3A59CD77ABB5B701BEA32871E7F7B1CEFB71636399F69FF3EC06BF964AF95)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/PNHvcOvgT8Svk7fCf4aDaQ/zh-cn_image_0000002592220506.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074908Z&HW-CC-Expire=86400&HW-CC-Sign=6AB0C081AF546F816957DF8F7EA550AB866757CCF31FBF221CD772489431E136)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/BnVNJAqGS62q_-fbbRWGhw/zh-cn_image_0000002592380438.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074908Z&HW-CC-Expire=86400&HW-CC-Sign=65497838D55B8FA5F04C9E67D3AAF3ADFD3986DECA1C54EA235EFE0230768392)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/6bWW_RvRRmulyRyYz01jOg/zh-cn_image_0000002622859949.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074908Z&HW-CC-Expire=86400&HW-CC-Sign=873DE06E3F44A6E1C28506B99699091B9A9F1A6D668513C114402A8FE37D0D68)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/5M4BD7asT86dz3lfkB5JUA/zh-cn_image_0000002622700067.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074908Z&HW-CC-Expire=86400&HW-CC-Sign=DA52EB4768E74C20E60442211BFE426DE703E9C2414792643C49651AFDB58562)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/HUbtFoFpRg6ZiHs9aaZeAQ/zh-cn_image_0000002592220508.png?HW-CC-KV=V1&HW-CC-Date=20260611T074908Z&HW-CC-Expire=86400&HW-CC-Sign=F54FE938F0C51661FE890CF5EF8B679D42B0536DFB5B24D802AF3FEAE4C97A0D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/o7k_05pHS9GusBAkhztIHA/zh-cn_image_0000002592380440.png?HW-CC-KV=V1&HW-CC-Date=20260611T074908Z&HW-CC-Expire=86400&HW-CC-Sign=5CD496EB81D5A918C3B97D441936EE4ECCA7E471615AB08D78EA533BFB4B206E)
