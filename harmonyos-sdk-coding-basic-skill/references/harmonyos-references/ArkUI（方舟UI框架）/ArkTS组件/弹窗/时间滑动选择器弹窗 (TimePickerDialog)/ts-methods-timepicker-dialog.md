...
scraped_at: 2026-06-11T15:49:17+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:a9c900800950edac5c07fd15879ffb30a0e4e65c7c360d93f3b44b8180a7ff15
---
...
从API version 8开始支持，从API version 18开始废弃，建议使用[showTimePickerDialog](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#showtimepickerdialog>)替代。showTimePickerDialog需先获取[UIContext](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)实例后再进行调用。

从API version 10开始，可以通过使用[UIContext](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[showTimePickerDialog](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#showtimepickerdialog>)来明确UI的执行上下文。
...
继承自[TimePickerOptions](../../按钮与选择/TimePicker/ts-basic-components-timepicker.md#timepickeroptions对象说明)。
...
| alignment10+ | [DialogAlignment](<../警告弹窗 (AlertDialog)/ts-methods-alert-dialog-box.md#dialogalignment枚举说明>) | 否 | 是 | 设置弹窗在垂直方向上的对齐方式。  默认值：DialogAlignment.Default  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| offset10+ | [Offset](../../公共定义/基础类型定义/ts-types.md#offset) | 否 | 是 | 设置弹窗相对alignment所在位置的偏移量。  默认值：{ dx: 0 , dy: 0 }  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| onAccept | (value: [TimePickerResult](../../按钮与选择/TimePicker/ts-basic-components-timepicker.md#timepickerresult对象说明)) => void | 否 | 是 | 点击弹窗中的“确定”按钮时触发该回调。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| onCancel | () => void | 否 | 是 | 点击弹窗中的“取消”按钮时触发该回调。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| onChange | (value: [TimePickerResult](../../按钮与选择/TimePicker/ts-basic-components-timepicker.md#timepickerresult对象说明)) => void | 否 | 是 | 滑动弹窗中的选择器后，选项归位至选中项位置时，触发该回调。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| shadow12+ | [ShadowOptions](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadowoptions对象说明) | [ShadowStyle](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadowstyle10枚举说明) | 否 | 是 | 设置弹窗背板的阴影。  **说明：**  当设备为2in1时，默认场景下获焦阴影值为ShadowStyle.OUTER\_FLOATING\_MD，失焦为ShadowStyle.OUTER\_FLOATING\_SM。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
推荐通过使用[UIContext](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[showTimePickerDialog](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#showtimepickerdialog>)来明确UI的执行上下文。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/ON8tmrYfTNG3Thb0CtubwA/zh-cn_image_0000002592380460.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074916Z&HW-CC-Expire=86400&HW-CC-Sign=BCCAC16245B9327549FB217213C6D71A8E586FEB1D4C4C357BFC8EA598040CFB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7d/v3/L7KJfwU-Q-i7i638AA-zFg/zh-cn_image_0000002622859971.png?HW-CC-KV=V1&HW-CC-Date=20260611T074916Z&HW-CC-Expire=86400&HW-CC-Sign=E5A8F4C05E5ED6BE71414566793A04A3D169176542BF59D3CE73E6F271A9C68C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/da/v3/S-jaaHJpQLKp1Wih61DCjg/zh-cn_image_0000002622700089.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074916Z&HW-CC-Expire=86400&HW-CC-Sign=A31E1C5E277F033C907E18675F89686185859CAC0471B79456FFA01D2F43D802)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/1MNNcD2pTV2UM0zv8Bewng/zh-cn_image_0000002592220530.png?HW-CC-KV=V1&HW-CC-Date=20260611T074916Z&HW-CC-Expire=86400&HW-CC-Sign=D0053A5517C5B74E54FB18ECF849F9C8EE53B2D5C52446F74EDA3B0CD5C4285D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/IMM8tDNwRl-E3SmwHb0pnQ/zh-cn_image_0000002592380462.png?HW-CC-KV=V1&HW-CC-Date=20260611T074916Z&HW-CC-Expire=86400&HW-CC-Sign=24B0EDB4E1A46A1CEEEAD9CE8EFC9717A5DBB355DEACBBC518F6D35C51643BFD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/XsibLOORR9-uptsmQSyujQ/zh-cn_image_0000002622859973.png?HW-CC-KV=V1&HW-CC-Date=20260611T074916Z&HW-CC-Expire=86400&HW-CC-Sign=22DA35C0D9739FA353D4DE35DAAD0DCA1BA35C96B2D72F2D08E53189FA08653E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/ZYDlxj56RVmB-UdGyYeQKw/zh-cn_image_0000002622700091.png?HW-CC-KV=V1&HW-CC-Date=20260611T074916Z&HW-CC-Expire=86400&HW-CC-Sign=9500CC3A3611C2002CDA78242E898392927CE9F0DA6E21B1BA85F1E8540D62D4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/An5GANXZRuigvHOudwvA1Q/zh-cn_image_0000002592220532.png?HW-CC-KV=V1&HW-CC-Date=20260611T074916Z&HW-CC-Expire=86400&HW-CC-Sign=C39AFE81AF73768A58DE12A4E628AE7C8DF38D630D6ED80AF69ECAB18A7B9E59)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f7/v3/Msuv6_iYQG25UsvCAF1TvA/zh-cn_image_0000002592380464.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074916Z&HW-CC-Expire=86400&HW-CC-Sign=25B9B3679DDD710CA88D6512176A332853530ABB1C499C401FDDCD5DCB3F85B0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/c0qgib8NTrmcy4WZTTGXKA/zh-cn_image_0000002622859975.png?HW-CC-KV=V1&HW-CC-Date=20260611T074916Z&HW-CC-Expire=86400&HW-CC-Sign=39622B46857932CDFAF5E44C0131BE42AF1CF28A35C11A271E462A9479F232CD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/rk4himH0QVi3bUpXBxZEag/zh-cn_image_0000002622700093.png?HW-CC-KV=V1&HW-CC-Date=20260611T074916Z&HW-CC-Expire=86400&HW-CC-Sign=6555C71AD713C011388C13D35A53882B82F466A1657C2AD5A3017B5C2FC59084)
