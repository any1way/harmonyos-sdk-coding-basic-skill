...
scraped_at: 2026-06-11T15:49:11+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:509b984f13cd918cdeefbaea244d6374ffce90ef16377431525b0256628a523a
---
列表弹窗。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| title | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | 弹窗标题。  当文本内容过长无法显示时，用省略号代替未显示的部分。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| subtitle10+ | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 弹窗副标题。  当文本内容过长无法显示时，用省略号代替未显示的部分。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| message | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | 弹窗内容。  文本超长时会触发滚动条。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| cancel | [VoidCallback](../../公共定义/基础类型定义/ts-types.md#voidcallback12) | 否 | 是 | 点击遮障层关闭dialog时的回调。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| alignment | [DialogAlignment](<../警告弹窗 (AlertDialog)/ts-methods-alert-dialog-box.md#dialogalignment枚举说明>) | 否 | 是 | 弹窗在竖直方向上的对齐方式。  默认值：DialogAlignment.Bottom  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。  **说明：**  若在UIExtension中设置showInSubWindow为true，弹窗将基于UIExtension的宿主窗口对齐。 |
...
| backgroundColor11+ | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 弹窗背板颜色。  默认值：Color.Transparent  **说明：**  backgroundColor会与模糊属性backgroundBlurStyle叠加产生效果，如果不符合预期，可将backgroundBlurStyle设置为BlurStyle.NONE，即可取消模糊。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| backgroundBlurStyle11+ | [BlurStyle](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#blurstyle9) | 否 | 是 | 弹窗背板模糊材质。  默认值：BlurStyle.COMPONENT\_ULTRA\_THICK  **说明：**  设置为BlurStyle.NONE即可关闭背景虚化。当设置了backgroundBlurStyle为非NONE值时，则不要设置backgroundColor，否则颜色显示将不符合预期效果。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| cornerRadius12+ | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | [BorderRadiuses](../../公共定义/基础类型定义/ts-types.md#borderradiuses9) | [LocalizedBorderRadiuses](../../公共定义/基础类型定义/ts-types.md#localizedborderradiuses12) | 否 | 是 | 设置背板的圆角半径。  可分别设置4个圆角的半径。  默认值：{ topLeft: '32vp', topRight: '32vp', bottomLeft: '32vp', bottomRight: '32vp' }  圆角大小受组件尺寸限制，最大值为组件宽或高的一半，若值为负，则按照默认值处理。  百分比参数方式：以父元素弹窗宽和高的百分比来设置弹窗的圆角。  **说明：**  当cornerRadius属性类型为LocalizedBorderRadiuses时，支持随语言习惯改变布局顺序。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| borderWidth12+ | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | [EdgeWidths](../../公共定义/基础类型定义/ts-types.md#edgewidths9) | [LocalizedEdgeWidths](../../公共定义/基础类型定义/ts-types.md#localizededgewidths12) | 否 | 是 | 设置弹窗背板的边框宽度。  可分别设置4个边框宽度。  默认值：0  百分比参数方式：以父元素弹窗宽的百分比来设置弹窗的边框宽度。  当弹窗左边框和右边框大于弹窗宽度，弹窗上边框和下边框大于弹窗高度，显示可能不符合预期。  **说明：**  当borderWidth属性类型为LocalizedEdgeWidths时，支持随语言习惯改变布局顺序。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| transition12+ | [TransitionEffect](<../../动画/组件内转场 (transition)/ts-transition-animation-component.md#transitioneffect10对象说明>) | 否 | 是 | 设置弹窗显示和退出的过渡效果。  **说明：**  1.如果不设置，则使用默认的显示/退出动效。  2.显示动效中按back键，打断显示动效，执行退出动效，动画效果为显示动效与退出动效的曲线叠加后的效果。  3.退出动效中按back键，不会打断退出动效，退出动效继续执行，继续按back键退出应用。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| title | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | 选项的文本内容。  文本超长时会触发滚动条。 |
| icon | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 是 | 选项的图标，默认无图标显示。  string格式可用于加载网络图片和本地图片，常用于加载网络图片。当使用相对路径引用本地图片时，例如Image("common/test.jpg")。 |
| action | [VoidCallback](../../公共定义/基础类型定义/ts-types.md#voidcallback12) | 否 | 否 | 选项选中的回调。 |
...
| 类型 | 说明 |
| --- | --- |
| [LevelMode](<../../../ArkTS API/UI界面/@ohos.promptAction (弹窗)/js-apis-promptaction.md#levelmode15枚举说明>) | 设置弹窗的显示层级。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImmersiveMode](<../../../ArkTS API/UI界面/@ohos.promptAction (弹窗)/js-apis-promptaction.md#immersivemode15枚举说明>) | 设置页面内弹窗的蒙层效果。 |
...
| reason | [DismissReason](../../通用属性/弹窗控制/Popup控制/ts-universal-attributes-popup.md#dismissreason12枚举说明) | 否 | 否 | Dialog无法关闭原因。根据开发者需求选择不同操作下，Dialog是否关闭。 |
...
| style10+ | [DialogButtonStyle](../../公共定义/枚举说明/ts-appendix-enums.md#dialogbuttonstyle10) | 否 | 是 | 设置Button的风格样式。  默认值：DialogButtonStyle.DEFAULT  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| value8+ | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | Button文本内容。  当文本内容过长无法显示时，用省略号代替未显示的部分。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| action8+ | [VoidCallback](../../公共定义/基础类型定义/ts-types.md#voidcallback12) | 否 | 否 | Button选中时的回调。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| dx | number | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | 弹出窗口相对于对齐位置dx的偏移量。  需要显式指定像素单位，如'10px'，也可设置百分比字符串，如'100%'。  **说明：**  不指定像素单位时，默认单位vp，如'10'，等同于10。 |
| dy | number | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | 弹出窗口相对于对齐位置dy的偏移量。  需要显式指定像素单位，如'10px'，也可设置百分比字符串，如'100%'。  **说明：**  不指定像素单位时，默认单位vp，如'10'，等同于10。 |
...
从API version 8开始支持，从API version 18开始废弃，建议使用[showActionSheet](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#showactionsheet>)替代。showActionSheet需先获取[UIContext](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)实例后再进行调用。

从API version 10开始，可以通过使用[UIContext](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中的[showActionSheet](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#showactionsheet>)来明确UI的执行上下文。
...
直接使用ActionSheet可能导致实例不明确的问题，建议使用getUIContext()获取[UIContext](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)实例，并使用[showActionSheet](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#showactionsheet>)调用绑定实例的ActionSheet.show()。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/L0OzkcJ1QKa6Id5MunAqZg/zh-cn_image_0000002622859951.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074909Z&HW-CC-Expire=86400&HW-CC-Sign=289B30F1DEFE8D192AB6843D3078332EB2FA16B122C1D74469BFF129D37CD458)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/8WClGhv9RLqQhUrL4JEfMw/zh-cn_image_0000002622700069.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074909Z&HW-CC-Expire=86400&HW-CC-Sign=3FD381A5B0106558AFC9C981F292D1700262F601C1E67204B9821D61E7B3A24F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/3DntoOTBTFiHTo8MtUVrmA/zh-cn_image_0000002592220510.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074909Z&HW-CC-Expire=86400&HW-CC-Sign=FD597F6B995235476EC31A743C77C1C533FB3406B76B91ECB98D8ED77E89F69C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/Ml44yjLVRv-ojbA13wBqmg/zh-cn_image_0000002592380442.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074909Z&HW-CC-Expire=86400&HW-CC-Sign=712E0FA9A043CD7F52CB4869DA679DEC2403230DDBD5326B9A547DC8D0A55575)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/i-sXKr3TSniMxlphh_801g/zh-cn_image_0000002622859953.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074909Z&HW-CC-Expire=86400&HW-CC-Sign=E5DBFB63E7091391326404A16C86D398182975681C6DB8DD628D3F0443B0E77C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/EgxI1vNCT7SM7jt23QGImg/zh-cn_image_0000002622700071.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074909Z&HW-CC-Expire=86400&HW-CC-Sign=FE6B0C4C0D7DAEA4AB4A266ABCBB86A2CF6BF0007AAF7C1B81F733608BDE7F8D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/PIj_KxPqR-KmgxrVKAY3Ig/zh-cn_image_0000002592220512.png?HW-CC-KV=V1&HW-CC-Date=20260611T074909Z&HW-CC-Expire=86400&HW-CC-Sign=6DA3AE19A6ED91F6900A97C5352717A78A136B9FF51F02776346B9616EE493F3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/8Qu3cVC2SYqRbL5oqvtuaQ/zh-cn_image_0000002592380444.png?HW-CC-KV=V1&HW-CC-Date=20260611T074909Z&HW-CC-Expire=86400&HW-CC-Sign=69DAFED428A3B6507EADBB224D3DBD1B3110A03E5BD9A9CE9290EB2C38CD7888)
