...
scraped_at: 2026-06-11T15:49:29+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:d09c5f6690bae24ebc95d89287e875f074f825b537b59b83b8e8e6c0944a2d57
---
...
WithTheme支持的系统组件如下：[TextInput](../../文本与输入/TextInput/ts-basic-components-textinput.md)、[Search](../../文本与输入/Search/ts-basic-components-search.md)、[Button](../../按钮与选择/Button/ts-basic-components-button.md)、[Badge](../../信息展示/Badge/ts-container-badge.md)、[Swiper](../../滚动与滑动/Swiper/ts-container-swiper.md)、[Text](../../文本与输入/Text/ts-basic-components-text.md)、[Select](../../按钮与选择/Select/ts-basic-components-select.md)、[Menu](../../菜单/Menu/ts-basic-components-menu.md)、[TimePicker](../../按钮与选择/TimePicker/ts-basic-components-timepicker.md)、[DatePicker](../../按钮与选择/DatePicker/ts-basic-components-datepicker.md)、[TextPicker](../../按钮与选择/TextPicker/ts-basic-components-textpicker.md)、[Checkbox](../../按钮与选择/Checkbox/ts-basic-components-checkbox.md)、[CheckboxGroup](../../按钮与选择/CheckboxGroup/ts-basic-components-checkboxgroup.md)、[Radio](../../按钮与选择/Radio/ts-basic-components-radio.md)、[Slider](../../按钮与选择/Slider/ts-basic-components-slider.md)、[Progress](../../信息展示/Progress/ts-basic-components-progress.md)、[QRCode](../../信息展示/QRCode/ts-basic-components-qrcode.md)、[Toggle](../../按钮与选择/Toggle/ts-basic-components-toggle.md)、[TextClock](../../信息展示/TextClock/ts-basic-components-textclock.md)、[PatternLock](../../信息展示/PatternLock/ts-basic-components-patternlock.md)、[Divider](../../空白与分隔/Divider/ts-basic-components-divider.md)。

WithTheme相关使用指导请参考[设置应用内主题换肤](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/主题设置/设置应用内主题换肤/theme_skinning.md>)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| theme | [CustomTheme](ts-container-with-theme.md#customtheme) | 否 | 是 | 用于自定义WithTheme作用域内组件缺省配色。  默认值：undefined，缺省样式跟随系统[token默认样式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/主题设置/设置应用内主题换肤/theme_skinning.md#系统缺省token色值>)。 |
| colorMode | [ThemeColorMode](../../通用属性/视效与模糊/组件内容模糊/ts-universal-attributes-foreground-blur-style.md#themecolormode枚举说明) | 否 | 是 | 用于指定WithTheme作用域内组件配色深浅色模式。  默认值：ThemeColorMode.SYSTEM |
...
| 类型 | 说明 |
| --- | --- |
| [CustomTheme](<../../../ArkTS API/UI界面/@ohos.arkui.theme(主题换肤)/js-apis-arkui-theme.md#customtheme>) | 自定义WithTheme作用域内组件缺省配色。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/CXKZHLpSTOmLnGJZCZH4vQ/zh-cn_image_0000002592220548.png?HW-CC-KV=V1&HW-CC-Date=20260611T074928Z&HW-CC-Expire=86400&HW-CC-Sign=6135388A04D5BE104AE93692C6E77B695ED99C828A5D53C56836803896A3231D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/7xc1ms6PRSKTJs1cGrLKyQ/zh-cn_image_0000002592380480.png?HW-CC-KV=V1&HW-CC-Date=20260611T074928Z&HW-CC-Expire=86400&HW-CC-Sign=7FDFC3DA585EBEC9D62FC515DD70C2FDC56FE38898796582F952D3AF1C101D39)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/MdSyTztNRIiiJvydx5L2qQ/zh-cn_image_0000002622859991.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074928Z&HW-CC-Expire=86400&HW-CC-Sign=8635E137AA1649520C8985E618C77CC640FE6DA7255B302C1045DB66F1814DEC)
