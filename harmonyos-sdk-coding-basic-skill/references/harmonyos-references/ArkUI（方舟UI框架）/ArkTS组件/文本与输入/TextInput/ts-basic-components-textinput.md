...
scraped_at: 2026-06-11T15:47:21+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:0d7489b232844769c99048689d9069f3f68a3c2c92558cc775b09ab74265455e
---
单行文本输入框组件。
...
该组件仅支持单文本样式，若需实现富文本样式，建议使用[RichEditor](../RichEditor/ts-basic-components-richeditor.md)组件。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| placeholder | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 设置无输入时的提示文本。 |
| text | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 设置输入框当前的文本内容。  建议通过onChange事件将状态变量与文本实时绑定，  避免组件刷新时TextInput中的文本内容异常。  从API version 10开始，该参数支持[$$](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)双向绑定变量。  从API version 18开始，该参数支持[!!](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/!!语法：双向绑定/arkts-new-binding.md#系统组件参数双向绑定>)双向绑定变量。 |
...
默认情况下，通用属性[padding](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#padding)的默认值为：
...
当输入框设置padding为0时，可设置[borderRadius](../../通用属性/布局与边框/边框设置/ts-universal-attributes-border.md#borderradius)为0避免光标被截断。当光标在文本框边缘显示异常时，请检查是否是padding、borderRadius属性影响造成。

从API version 10开始，单行输入框可设置.width('auto')使组件宽度自适应文本宽度，自适应时组件宽度受constraintSize属性以及父容器传递的最大最小宽度限制，其余使用方式参考[尺寸设置](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md)。
...
密码填充服务需要特定的输入框类型。如何使用密码填充服务参考[快速适配](../../../../../harmonyos-guides/系统/安全/密码自动填充服务/应用接入密码保险箱/快速适配/passwordvault-quick-adaptation.md)。

设置[密码模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#密码模式>)时，装饰线[decoration](ts-basic-components-textinput.md#decoration12)、下划线[showUnderline](ts-basic-components-textinput.md#showunderline10)不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | placeholder文本颜色。  默认值：跟随主题。  Wearable设备上默认值为：'#99ffffff' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 否 | placeholder文本样式。  Wearable设备上默认值为：18fp |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 字体颜色。  Wearable设备上默认值为：'#dbffffff' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 字体大小。fontSize为number类型时，使用fp单位。字体默认大小16fp。不支持设置百分比字符串。  Wearable设备上默认值为：18fp |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 字体列表。默认字体'HarmonyOS Sans'。  使用多个字体时，请用逗号','分隔，字体的优先级按顺序生效。例如：'Arial,HarmonyOS Sans'。  应用当前支持'HarmonyOS Sans'字体和自定义字体。  卡片当前仅支持'HarmonyOS Sans'字体。 |

说明

推荐使用[loadFontSync](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#loadfontsync>)注册自定义字体。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextInputStyle](ts-basic-components-textinput.md#textinputstyle9枚举说明) | [TextContentStyle](../../公共定义/枚举说明/ts-appendix-enums.md#textcontentstyle10) | 是 | 输入框为默认风格或内联输入风格。  默认值：TextInputStyle.Default |
...
可通过[align](../../通用属性/布局与边框/位置设置/ts-universal-attributes-location.md#align)属性控制文本段落在垂直方向上的位置。此组件中不可使用align属性控制文本段落在水平方向上的位置。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 文本输入时，文本框的显示单位。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | undefined | 否 | 错误状态下提示的错误文本或者不显示错误状态。  默认不显示错误状态。  Wearable设备上字体大小为：13fp，对齐方式为：居中对齐  **说明：**  从API version 12开始，value支持Resource类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BarState](../../公共定义/枚举说明/ts-appendix-enums.md#barstate) | 是 | 内联输入风格编辑态时滚动条的显示模式。  默认值：BarState.Auto |
...
具体使用指导请参考[为应用添加自动生成高强度密码的建议](../../../../../harmonyos-guides/系统/安全/密码自动填充服务/应用接入密码保险箱/自动填充/为应用添加自动生成高强度密码的建议/passwordvault-custom-strong-password-rules.md)。
...
设置右侧清除按钮样式，仅支持图片类型的图标。不支持[内联模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#内联模式>)。示例请参考[示例4（设置右侧清除按钮样式）](ts-basic-components-textinput.md#示例4设置右侧清除按钮样式)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [CancelButtonOptions](../Search/ts-basic-components-search.md#cancelbuttonoptions12对象说明) | 是 | 右侧清除按钮样式选项。  默认值：  {  style: CancelButtonStyle.INPUT  }  Wearable设备上默认值为：28vp |
...
设置初始状态时，是否全选文本。不支持[内联模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#内联模式>)。
...
当输入字符数大于最大字符数乘百分比值时，显示字符计数器。如果用户设置计数器时不设置InputCounterOptions，那么当前输入字符数超过最大字符数时，边框和计数器下标将变为红色。用户同时设置参数value为true和[InputCounterOptions](../输入框类组件通用接口/ts-universal-attributes-text-style.md#inputcounteroptions11对象说明)，当thresholdPercentage数值在有效区间内，且输入字符数超过最大字符数时，边框和计数器下标将变为红色，框体抖动。highlightBorder设置为false，则不显示红色边框，计数器默认显示红色，框体抖动。

[内联模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#内联模式>)、[密码模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#密码模式>)下字符计数器不显示。
...
| options | [InputCounterOptions](../输入框类组件通用接口/ts-universal-attributes-text-style.md#inputcounteroptions11对象说明) | 否 | 计数器的配置项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | [UnderlineColor](ts-basic-components-textinput.md#underlinecolor12对象说明) | undefined | 是 | 设置下划线颜色。  当设置下划线颜色模式时，修改下划线颜色。当只设定非特殊状态下的颜色，可以直接输入ResourceColor。设定值为undefined、null、无效值时，所有下划线恢复为默认值。  默认值：主题配置的下划线颜色。主题配置的默认下划线颜色为'#33182431'。 |
...
* 设置[密码模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#密码模式>)时，通过该接口设置行高[lineHeight](ts-basic-components-textinput.md#lineheight12)不生效。
...
设置[密码模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#密码模式>)时，不支持通过fontFeature设置文本样式。
...
设置文本断行规则。该属性在组件设置[内联模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#内联模式>)时样式生效，但对placeholder文本无效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [WordBreak](../../公共定义/枚举说明/ts-appendix-enums.md#wordbreak11) | 是 | 内联输入风格编辑态时断行规则。  默认值：WordBreak.BREAK\_WORD |
...
设置文本超长时的显示方式。仅在[内联模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#内联模式>)的编辑态、非编辑态下支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextOverflow](../../公共定义/枚举说明/ts-appendix-enums.md#textoverflow) | 是 | 文本超长时的显示方式。  [内联模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#内联模式>)非编辑态下默认值：TextOverflow.Ellipsis  内联模式编辑态下默认值：TextOverflow.Clip |

说明

TextInput组件不支持设置TextOverflow.MARQUEE模式，当设置为TextOverflow.MARQUEE模式时，[内联模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#内联模式>)非编辑态下显示为TextOverflow.Ellipsis，内联模式编辑态下以及非内联模式下显示为TextOverflow.Clip。
...
[密码模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#密码模式>)时，由于输入框后端的状态和前端应用侧的状态管理变量会不一致，可能导致末尾图标的状态异常。建议在[onSecurityStateChange](ts-basic-components-textinput.md#onsecuritystatechange12)上增加状态同步。参考[示例1（设置与获取光标位置）](ts-basic-components-textinput.md#示例1设置与获取光标位置)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| strategy | [LineBreakStrategy](../../公共定义/枚举说明/ts-appendix-enums.md#linebreakstrategy12) | 是 | 文本的折行规则。  默认值：LineBreakStrategy.GREEDY  **说明：**  仅设置[内联模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#内联模式>)时该属性生效。 |
...
设置右侧清除按钮样式，仅支持symbol图标。不支持[内联模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#内联模式>)。示例请参考[示例15（设置symbol类型清除按钮）](ts-basic-components-textinput.md#示例15设置symbol类型清除按钮)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| symbolOptions | [CancelButtonSymbolOptions](../Search/ts-basic-components-search.md#cancelbuttonsymboloptions12对象说明) | 是 | 右侧清除按钮样式。  默认值：  {  style: CancelButtonStyle.INPUT  } |
...
设置省略位置。ellipsisMode属性仅在[内联模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#内联模式>)下生效，需要配合overflow设置为TextOverflow.Ellipsis使用，单独设置ellipsisMode属性不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否启用自动填充动效。  true表示启用，false表示不启用。  默认值：true  **说明：**  启用之后，仅输入模式[InputType](ts-basic-components-textinput.md#inputtype枚举说明)设置为Password、NEW\_PASSWORD或NUMBER\_PASSWORD的输入框在进行自动填充时动效可生效。 |
...
| Inline | 内联输入风格。文本选中底板高度与输入框高度相同。  内联输入是在有明显的编辑态/非编辑态的区分场景下使用，例如：文件列表视图中的重命名。  不支持showError属性。  [内联模式](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/文本输入 (TextInputTextAreaSearch)/arkts-common-components-text-input.md#内联模式>)下，不支持拖入文本。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onIconSrc | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 是 | 密码输入模式时，能够切换密码可见时显示的图标。  string格式可用于加载网络图片和本地图片。 |
| offIconSrc | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 是 | 密码输入模式时，能够切换密码不可见时显示的图标。  string格式可用于加载网络图片和本地图片。 |
...
| options12+ | [SelectionOptions](../输入框类组件通用接口/ts-universal-attributes-text-style.md#selectionoptions12对象说明) | 否 | 选中文字时的配置。  默认值：MenuPolicy.DEFAULT  从API version 12开始，该接口中的options参数支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| typing | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | undefined | 否 | 是 | 键入时下划线颜色。不填写、undefined、null、无效值时恢复默认。 |
| normal | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | undefined | 否 | 是 | 非特殊状态时下划线颜色。不填写、undefined、null、无效值时恢复默认。 |
| error | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | undefined | 否 | 是 | 错误时下划线颜色。不填写、undefined、null、无效值时恢复默认。此选项会修改showCounter属性中达到最大字符数时的颜色。 |
| disable | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | undefined | 否 | 是 | 禁用时下划线颜色。不填写、undefined、null、无效值时恢复默认。 |
...
| event | [PasteEvent](../RichEditor/ts-basic-components-richeditor.md#pasteevent11) | 是 | 用户自定义的粘贴事件。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/S9Ds2YXmR7erZRELNsNBIg/zh-cn_image_0000002592380162.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=BFEEF49D1213FA6B05887565761C726240AC2850AF2FDEB3A76B2023FB61FD48)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/gdcrZEWpRGuxmo-LI-b7bg/zh-cn_image_0000002622859671.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=426FC1E4D9640EE1DC3DFBBA68911A2B300640843E8F1E7593CD480529932879)

### 示例3（设置自定义键盘）

该示例通过[customKeyboard](ts-basic-components-textinput.md#customkeyboard10)（从API version 10开始）属性分别将value中的入参类型设置为[CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8)和[ComponentContent](<../../../ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md#componentcontent-1>)，实现了自定义键盘的功能。

从API version 22开始[customKeyboard](ts-basic-components-textinput.md#customkeyboard10)属性新增了入参类型[ComponentContent](<../../../ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md#componentcontent-1>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/9HI8bgZsQ4CSmmifhBOx3w/zh-cn_image_0000002622699791.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=9AB256215A5AE9B5ED96335CD54ED6DA2908703BD1AE5F23D3FDD7735F04B2DD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/8eNue7RiTjuwGI_pfSGrIA/zh-cn_image_0000002592220230.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=3B4675BA6DE59BCE536777756AA4256AD962AE5F86CC0C94C553F65FE4DA79D5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/Kpu0rDvoQgi-MVRC_kzYlg/zh-cn_image_0000002592380164.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=D5F1277F6EB6CE542B08B36058487F38D283376252284A132B2C812F41707AD9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/4ndgaiLyQrecDK0dBxTpkw/zh-cn_image_0000002622859673.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=D06328C80BC3023CF1BB2EAC4E074622916E57CB6ED34CD7D97413F9E2679250)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8c/v3/QO1SDbVXSdmzReCViIjV5Q/zh-cn_image_0000002622699793.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=069AB17D213F3B22BEB315EC227061D5D359565D28F03BEF329F4FA14739B228)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/9ST_RvXcTMWNk4sdof6Juw/zh-cn_image_0000002592220232.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=7206A9F24BE00CA612B5CB26EEACDE8B32EDA8D5486C75340E5A972CCC2A402B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/qkTjqyl4T3q6VVvUgQO7FQ/zh-cn_image_0000002592380166.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=A523F59474F4B63C86358E3BA78D1E0D061ADAC948980804A307D54C604173DA)

### 示例10（自定义键盘避让）

该示例通过[customKeyboard](ts-basic-components-textinput.md#customkeyboard10)（从API version 10开始）属性配置[KeyboardOptions](../RichEditor/ts-basic-components-richeditor.md#keyboardoptions12)（从API version 12开始）接口实现了自定义键盘避让的效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/NX_ulf1iSJSWFDTPL60cNA/zh-cn_image_0000002622859675.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=F8EC3EE2F848A330A24B2AED15E535BEC7C3DB1CC301391E20BF08B1B33FF29A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/6Yv_03CAR_qULnyoo3GYiw/zh-cn_image_0000002622699795.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=7FD35F8DEC5742F711C9C8ADC712CEAB1081289D172A24EF76E6FDF337A8ECF1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0a/v3/b_twBnatR5u7fQNCemZRag/zh-cn_image_0000002592220234.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=35FFCFE54B4246F15EA0971500CAE829A7FA3638AE63BDF96171ABC69034BC29)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/3Z5viC0NQLyRrFyQypISwg/zh-cn_image_0000002592380168.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=602B03D4818A077E8512DBA0798F957F08BB8DE44B55420C5D36B92CFB8B920D)

### 示例14（文本扩展自定义菜单）

从API version 12开始，该示例通过[editMenuOptions](ts-basic-components-textinput.md#editmenuoptions12)接口实现了文本设置自定义菜单扩展项的文本内容、图标以及回调的功能，同时，可以在[onPrepareMenu](../文本组件公共接口/ts-text-common.md#属性-1)（从API version 20开始）回调中，进行菜单数据的设置。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/53/v3/4phgprTqRlOI1wQT2fLpcg/zh-cn_image_0000002622859677.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=FDD7DA7EA990F6707FE272B0929A76F600A7133E062FCA6579FB0432961A74DD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/W-7QVjCBS2mhsYaoqBdCYQ/zh-cn_image_0000002622699797.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=4E24DA55B9661E0D58081E7B68EE2F6138D37543FF08506ADBEF81EFBB662F41)
...
22. Row() {
23. Column({ space: 20 }) {
24. TextInput({ text: this.text })
25. .textOverflow(this.textOverflow[this.textOverflowIndex])
26. .ellipsisMode(this.ellipsisMode[this.ellipsisModeIndex])
27. .style(this.styleInput[this.styleInputIndex])
28. .fontSize(30)
29. .margin(30)
30. Button('更改ellipsisMode模式：' + this.ellipsisModeStr[this.ellipsisModeIndex]).onClick(() => {
31. this.ellipsisModeIndex++;
32. if (this.ellipsisModeIndex > (this.ellipsisModeStr.length - 1)) {
33. this.ellipsisModeIndex = 0;
34. }
35. }).fontSize(20)
36. Button('更改textOverflow模式：' + this.textOverflowStr[this.textOverflowIndex]).onClick(() => {
37. this.textOverflowIndex++;
38. if (this.textOverflowIndex > (this.textOverflowStr.length - 1)) {
39. this.textOverflowIndex = 0;
40. }
41. }).fontSize(20)
42. Button('更改Style大小：' + this.styleInputStr[this.styleInputIndex]).onClick(() => {
43. this.styleInputIndex++;
44. if (this.styleInputIndex > (this.styleInputStr.length - 1)) {
45. this.styleInputIndex = 0;
46. }
47. }).fontSize(20)
48. }
49. }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/vXIGhcWrSeSgfqem3x5cIQ/zh-cn_image_0000002592220236.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=B7CDD06DE02011BC75AE807D4B071C3EB41352578A60324DC336EC39C10244CB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/bPiKzktmQ3CRGO6nOiHgnA/zh-cn_image_0000002592380170.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=A2E73309E17CAC8F6F4B851B7CEF2CC193A3ABF2A8980889C1DFB5519CAD720A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/NpJbXfK1Thiv2fiTlnQ9Xw/zh-cn_image_0000002592220238.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=4D0D43C3782598A4A0FA8C2313DCEA705519EA1BD976C8DD9A9A3464DCFC474C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/L1U3QZ6KQ56JuavsEcHpmA/zh-cn_image_0000002592380172.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=AF6F1AA9DACA23B98894035C7651FEDF32F7EEDEAFAA3F6F6D028B34AFAE3E1D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/3I8SYf2lQGqCuCwZaDUeyw/zh-cn_image_0000002622859681.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=4B95078818F02ECB1CD818D2B877C3E0BB8861EC19CF9C3403179C941C325BC2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/LfgEZJ3IRhSCm-UKD8spDw/zh-cn_image_0000002622699801.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=C7F86F6A3FF294B462328659D9E70B58A9AF93B13B6C28E2D557F81340E7D5DC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/7R8gobYUSqW_3KzBl0V10Q/zh-cn_image_0000002592220240.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=EA46A9AAC40D47D064F47636C2ACBFB8DC747123813D92E15CAC8E01BCF0AEB1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/eWNTrk78Q2ydCLArgG9T-w/zh-cn_image_0000002592380174.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=165697A3549E1B9603BA1BE92FEB92A3DCA3C3A2CA2D26A640D8C03C8F4EBC90)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a/v3/LhtttUbMQi6U9KvvUXI2TA/zh-cn_image_0000002622859683.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=1B7052813AD9243FD70BFD8E850EF7EE42AFC56B1E2D3B8A00B4BF62161D09E8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/bRN5cgMFQ8Wr_luJ5apdyA/zh-cn_image_0000002622699803.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=F7BB086D51E33E7FE28EA280AF2708228714E36DC617787603603BA7499FF4EF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/CLRYWdRdTmW8rY5UvIZ_zg/zh-cn_image_0000002592220242.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=6FE247136E1041756F374EE47BBC81B00C582131DC02D7FED21B97C884D83524)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/eb/v3/j_SwwJiVS5qwFrava0Wlbg/zh-cn_image_0000002592380176.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=A16BA3F928C93856DA50CD38C0EE55FB204FFA1CBBFA0A5A3579B3C613357D75)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e2/v3/QblZthQiQJGpF2wU8UPnGw/zh-cn_image_0000002622859685.png?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=DD4D13DCB80E61AC468409248D1C1EC5EEDC690D15E0AF0050B4282B06842FA1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/DqA_zr22S7WLVqqPCMcqfw/zh-cn_image_0000002622699805.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074716Z&HW-CC-Expire=86400&HW-CC-Sign=30884072658AD1F1185D56A1E326AA0E78C70F7B8101F76672A7ED13BC916D4C)
