...
scraped_at: 2026-06-11T15:47:35+08:00
doc_updated_at: 2026-04-08
content_hash: sha256:6c4e0e818f8544ef0a25a8f1154dbc5ac261bffbbc087fd56715b4e276037f21
---
富文本组件，解析并显示HTML格式文本。
...
* 不适用场景：
  ...
  RichText组件不适用于对HTML字符串的显示效果进行较多自定义的应用场景。例如RichText组件不支持通过设置属性与事件，来修改背景颜色、字体颜色、字体大小、动态改变内容等。在这种情况下，推荐使用[Web组件](<../../../../ArkWeb（方舟Web）/ArkTS 组件/Web/组件描述/arkts-basic-components-web.md>)。
...
* 该组件不再更新和维护，推荐使用[Web组件](<../../../../ArkWeb（方舟Web）/ArkTS 组件/Web/组件描述/arkts-basic-components-web.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) 20+ | 是 | 表示HTML格式的字符串或者本地资源文件。 |
...
只支持[通用属性](../../通用属性/ts-component-general-attributes.md)中width，height，size，layoutWeight四个属性。由于padding，margin，constraintSize属性使用时与通用属性描述不符，暂不支持。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/hA_xdWOjRcClqWvEiliGKQ/zh-cn_image_0000002622859729.png?HW-CC-KV=V1&HW-CC-Date=20260611T074734Z&HW-CC-Expire=86400&HW-CC-Sign=30546542380D398B2511DA9DEF1857C2034262EFB7563708B1C566F5ABA54356)
