...
scraped_at: 2026-06-11T15:47:43+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:2e77689b90a86167dac4feaa5d5f12170a6ce99681c7883f32188ea4c4fedfd4
---
说明
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| width | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 光标尺寸，不支持百分比。  默认值：'2vp' |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 光标颜色。  默认值：'#ff007dff' |
...
以Text组件为例，完整示例请参考Text组件的[示例10（获取文本信息）](../Text/ts-basic-components-text.md#示例10获取文本信息)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | number | 是 | 相对于组件的横坐标。  单位：[px](../../公共定义/像素单位/ts-pixel-units.md#基本像素单位) |
| y | number | 是 | 相对于组件的纵坐标。  单位：[px](../../公共定义/像素单位/ts-pixel-units.md#基本像素单位) |
...
| autoFill23+ | [TextMenuItemId](ts-text-common.md#textmenuitemid12) | 是 | 否 | 自动填充，为一级菜单项。点击后会展开二级菜单项“密码保险箱”，仅支持[Search](../Search/ts-basic-components-search.md)、[TextInput](../TextInput/ts-basic-components-textinput.md)、[TextArea](../TextArea/ts-basic-components-textarea.md)或[RichEditor](../RichEditor/ts-basic-components-richeditor.md)。  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。 |
| passwordVault23+ | [TextMenuItemId](ts-text-common.md#textmenuitemid12) | 是 | 否 | 密码保险箱，为二级菜单项。点击该菜单项后会拉起密码保险箱应用，该应用提供自动填充账号密码能力，仅支持[Search](../Search/ts-basic-components-search.md)、[TextInput](../TextInput/ts-basic-components-textinput.md)、[TextArea](../TextArea/ts-basic-components-textarea.md)或[RichEditor](../RichEditor/ts-basic-components-richeditor.md)。  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| id | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 菜单的id。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| content | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 菜单名称。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| icon | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 菜单图标。  不支持网络图片。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| id | [TextMenuItemId](ts-text-common.md#textmenuitemid12) | 否 | 否 | 菜单id。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| labelInfo15+ | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 快捷键提示。  该字段仅2in1设备支持。  **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
...
该配置只支持[Text](../Text/ts-basic-components-text.md)组件和[RichEditor](../RichEditor/ts-basic-components-richeditor.md)组件。
...
| color12+ | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 设置文本识别成功后的实体颜色。  默认值：'#ff0a59f7'  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| decoration12+ | [DecorationStyleInterface](../属性字符串/ts-universal-styled-string.md#decorationstyleinterface) | 否 | 是 | 设置文本识别成功后的实体装饰线样式。  默认值：  {  type: TextDecorationType.Underline,  color: 与实体颜色一致,  style: TextDecorationStyle.SOLID  }  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| enablePreviewMenu20+ | boolean | 否 | 是 | 设置是否开启文本识别长按显示预览菜单。true表示开启，false表示未开启。  默认值：false  当[copyOptions](../RichEditor/ts-basic-components-richeditor.md#copyoptions)设置为None时，若enablePreviewMenu设置为true，长按AI实体也不能显示预览菜单。  **设备行为差异：** 该参数在Phone、Tablet中可正常调用，在PC/2in1、TV和Wearable等其他设备类型中无效果。  **元服务API：** 从API version 20开始，该接口支持在元服务中使用。 |
...
| replacementString | [StyledString](../属性字符串/ts-universal-styled-string.md#styledstring) | 否 | 否 | 用于替换的属性字符串。 |
| previewText | [StyledString](../属性字符串/ts-universal-styled-string.md#styledstring) | 否 | 是 | 预览内容属性字符串。  该属性用于表示语音输入、拍摄输入、输入法预上屏场景下的未提交上屏的临时输入内容。 |
...
| options | [SelectionOptions](../输入框类组件通用接口/ts-universal-attributes-text-style.md#selectionoptions12对象说明) | 否 | 选择项配置。 默认值继承[SelectionOptions](../输入框类组件通用接口/ts-universal-attributes-text-style.md#selectionoptions12对象说明)。 |
...
| 类型 | 说明 |
| --- | --- |
| [MutableStyledString](../属性字符串/ts-universal-styled-string.md#mutablestyledstring) | 富文本组件显示的属性字符串。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [TextDecorationType](../../公共定义/枚举说明/ts-appendix-enums.md#textdecorationtype) | 否 | 否 | 装饰线类型。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 否 | 装饰线颜色。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| style | [TextDecorationStyle](../../公共定义/枚举说明/ts-appendix-enums.md#textdecorationstyle12) | 否 | 是 | 装饰线样式。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 类型 | 说明 |
| --- | --- |
| [LineMetrics](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#linemetrics>) | 用于描述文本布局中单行文字的度量信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Affinity](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#affinity>) | 位置亲和度枚举。 |
...
| 类型 | 说明 |
| --- | --- |
| [TextBox](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#textbox>) | 文本矩形区域。 |
...
| 类型 | 说明 |
| --- | --- |
| [Paragraph](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#paragraph>) | 保存文本内容及样式的载体，支持排版与绘制操作。 |
...
| 类型 | 说明 |
| --- | --- |
| [RectHeightStyle](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#rectheightstyle>) | 矩形区域高度规格枚举。 |
...
| 类型 | 说明 |
| --- | --- |
| [RectWidthStyle](<../../../../ArkGraphics 2D（方舟2D图形服务）/ArkTS API/@ohos.graphics.text (文本模块)/js-apis-graphics-text.md#rectwidthstyle>) | 矩形区域宽度规格枚举。 |
...
| --- | --- | --- |
| DEFAULT | 0 | 显示在当前窗口中。 |
| PREFER\_WINDOW | 1 | 优先显示在独立窗口中，若不支持独立窗口，则显示在当前窗口中。  **说明：**  除应用主窗口、应用子窗口、系统模态窗口及系统桌面类型的窗口外，其他类型的窗口不支持将文本选择菜单显示在独立窗口中。  在预览器中不支持将文本选择菜单显示在独立窗口中。  在[UIExtension](<../../../ArkTS API/UI界面/@ohos.arkui.uiExtension (uiExtension)/js-apis-arkui-uiextension.md>)中不支持将文本选择菜单显示在独立窗口中。  当文本类组件已经显示在子窗类型的[Popup](../../系统预置UI组件库/Popup/ohos-arkui-advanced-popup.md)、[Dialog](<../../弹窗/弹出框 (Dialog)/ohos-arkui-advanced-dialog.md>)、[Toast](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用弹窗/即时反馈（Toast）/arkts-create-toast.md>)、[Menu](../../菜单/Menu/ts-basic-components-menu.md)中时，不支持将其对应的文本选择菜单显示在独立窗口中。  当TextInput、TextArea可支持拉起AutoFill时，不支持将其对应的文本选择菜单显示在独立窗口中。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| options | [LinearGradientOptions](../../通用属性/视效与模糊/颜色渐变/ts-universal-attributes-gradient-color.md#lineargradientoptions18对象说明) | 否 | 否 | 显示为线性渐变效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [LinearGradientOptions](../../通用属性/视效与模糊/颜色渐变/ts-universal-attributes-gradient-color.md#lineargradientoptions18对象说明) | 是 | 显示为线性渐变效果。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| options | [RadialGradientOptions](../../通用属性/视效与模糊/颜色渐变/ts-universal-attributes-gradient-color.md#radialgradientoptions18对象说明) | 否 | 否 | 显示为径向渐变效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [RadialGradientOptions](../../通用属性/视效与模糊/颜色渐变/ts-universal-attributes-gradient-color.md#radialgradientoptions18对象说明) | 是 | 显示为径向渐变效果。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 否 | 显示为纯色效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 显示为纯色效果。 |
...
数字翻牌动效。仅限正整数，不支持小数和负数。不支持渐变色和Text跑马灯模式。不支持选中，[copyOption](../Text/ts-basic-components-text.md#copyoption9)属性无效。当文本存在子组件时或通过属性字符串设置时，数字翻牌失效。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| constraintWidth | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | 设置被计算文本布局宽度。若不设置则宽度为单行布局所占最大宽度值。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 用于设置文本拖拽时的背板颜色。  默认值：跟随主题。默认主题时，浅色模式显示白色，深色模式显示黑色。 |
...
| 类型 | 说明 |
| --- | --- |
| [InputMethodExtraConfig](<../../../../IME Kit（输入法开发服务）/ArkTS API/@ohos.inputMethod.ExtraConfig (输入法扩展信息)/js-apis-inputmethod-extraconfig.md#inputmethodextraconfig>) | 输入法扩展信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| accessibilityText | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 无障碍文本属性。组件无文本属性时，屏幕朗读选中此组件不会播报。设置该属性后可为此类组件设置无障碍文本，屏幕朗读时将播报该文本，帮助使用者明确选中了什么组件。  默认值：''  值为undefined时，按默认值处理。 |
| accessibilityDescription | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 无障碍说明属性。此描述用于向用户详细解释当前组件，开发人员应提供详尽的文本说明，以协助用户理解即将执行的操作及其后果，尤其当这些后果无法仅从组件的属性和无障碍文本中直接获取时。  默认值：''  值为undefined时，按默认值处理。 |
