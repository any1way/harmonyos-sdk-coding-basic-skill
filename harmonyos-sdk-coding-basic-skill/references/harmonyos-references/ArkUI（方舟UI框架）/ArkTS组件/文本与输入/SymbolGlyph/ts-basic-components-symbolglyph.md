...
scraped_at: 2026-06-11T15:47:33+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:cbebf4de5559442b1ac910760f51fea325f642c161bd7804b38ae554bdedd1e2
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | SymbolGlyph组件的资源名，如 $r('sys.symbol.ohos\_wifi')。 |
...
支持[通用属性](../../通用属性/ts-component-general-attributes.md)，不支持文本通用属性，仅支持以下特有属性：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | Array<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 是 | SymbolGlyph组件颜色。  默认值：不同渲染策略下默认值不同。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 是 | SymbolGlyph组件大小。  默认值：16fp  单位：[fp](../../公共定义/像素单位/ts-pixel-units.md#基本像素单位)  不支持设置百分比字符串。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [FontWeight](../../公共定义/枚举说明/ts-appendix-enums.md#fontweight) | string | 是 | SymbolGlyph组件粗细。  默认值：FontWeight.Normal |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7c/v3/WWl0UcrGSTmFmyYX8NNVOA/zh-cn_image_0000002622699845.png?HW-CC-KV=V1&HW-CC-Date=20260611T074731Z&HW-CC-Expire=86400&HW-CC-Sign=5255CF6768547FD0EB03F3C9C07608B24E210CEEFC8BFE30872EEE39C01CD7DF)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<number | [Resource](../../公共定义/基础类型定义/ts-types.md#resource)> | 是 | SymbolGlyph组件最小的字体缩放倍数。  取值范围：[0, 1]  设置为0，缩放最小。  **说明：**  设置的值小于0时，按值为0处理。设置的值大于1，按值为1处理。异常值默认不生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<number | [Resource](../../公共定义/基础类型定义/ts-types.md#resource)> | 是 | SymbolGlyph组件最大的字体缩放倍数。  取值范围：[1, +∞)  **说明：**  设置的值小于1时，按值为1处理，异常值默认不生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shader | Array<[ShaderStyle](../文本组件公共接口/ts-text-common.md#shaderstyle20) | undefined> | [ShaderStyle](../文本组件公共接口/ts-text-common.md#shaderstyle20) | 是 | 径向渐变或线性渐变或纯色。  传入ShaderStyle时，覆盖所有层；传入数组时，数据项是ShaderStyle，则应用该层；数组项是undefined，则该层使用SymbolGlyph默认颜色，未设置的层也应用默认颜色。根据传入的参数区分处理径向渐变[RadialGradientStyle](../文本组件公共接口/ts-text-common.md#radialgradientstyle20)或线性渐变[LinearGradientStyle](../文本组件公共接口/ts-text-common.md#lineargradientstyle20)或纯色[ColorShaderStyle](../文本组件公共接口/ts-text-common.md#colorshaderstyle20)，最终设置到SymbolGlyph组件上显示为渐变色效果。  **说明：**  单位：[vp](../../公共定义/像素单位/ts-pixel-units.md#基本像素单位)  中心点请按百分比使用。如果使用的是非百分比（例如10PX），效果等同于设置1000%。  半径建议使用百分比。  百分比是基于图标大小的百分比，建议取值范围[0, 1)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shadow | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ShadowOptions](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadowoptions对象说明)> | 是 | SymbolGlyph组件的阴影效果。  单位：[vp](../../公共定义/像素单位/ts-pixel-units.md#基本像素单位)  默认值：{  radius：0,  color：Color.Black,  offsetX：0,  offsetY：0  }  不支持fill、type属性和color中的ColoringStrategy枚举值。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/TDQnjUcHShqsZrmZCW2eEA/zh-cn_image_0000002622859727.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074731Z&HW-CC-Expire=86400&HW-CC-Sign=FD121FF501E51888CBC194A4A8C4C9780896BBE01D5E71345FA5EA6140E81AD5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/vbXCXwJaQ8mLXxLF71WgjQ/zh-cn_image_0000002622699847.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074731Z&HW-CC-Expire=86400&HW-CC-Sign=383AD392B21EBBE42C7EADC2FB0F9D16549AA1CDD50EA6A998333F0C50608FD4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bf/v3/-tWVgdKOR3aFFXJ1eRVs8g/zh-cn_image_0000002592220286.jpeg?HW-CC-KV=V1&HW-CC-Date=20260611T074731Z&HW-CC-Expire=86400&HW-CC-Sign=00E6E4FFCE3B453B2BA8E99F0F213A37AB227C2A70FD8713794AC3E57988631E)
