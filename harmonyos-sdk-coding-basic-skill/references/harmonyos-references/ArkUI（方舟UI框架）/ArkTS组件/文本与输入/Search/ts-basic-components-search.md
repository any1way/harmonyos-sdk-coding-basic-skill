...
scraped_at: 2026-06-11T15:47:28+08:00
doc_updated_at: 2026-05-28
content_hash: sha256:46730766d2c3871d4b480f41bf271a9cb20af885618c1a729562efbef080e0ef
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 搜索框末尾搜索按钮文本内容。  从API version 20开始，支持Resource类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | placeholder文本颜色。  默认值：'#99182431'。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 否 | placeholder文本样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 否 | 搜索框内输入文本样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextAlign](../../公共定义/枚举说明/ts-appendix-enums.md#textalign) | 是 | 文本在搜索框中的对齐方式。  默认值：TextAlign.Start |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [IconOptions](ts-basic-components-search.md#iconoptions10对象说明) | [SymbolGlyphModifier](../输入框类组件通用接口/ts-universal-attributes-text-style.md#symbolglyphmodifier12) | 是 | 左侧搜索图标样式。  浅色模式默认值：  {  size: '16vp',  color: '#99000000',  src: ' '  }  深色模式默认值：  {  size: '16vp',  color: '#99ffffff',  src: ' '  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 输入文本的字体颜色。  默认值：'#FF182431'  Wearable设备上默认值为：'#dbffffff' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CaretStyle](../文本组件公共接口/ts-text-common.md#caretstyle10) | 是 | 光标样式。  默认值：  {  width: '2.0vp',  color: '#007DFF'  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [EnterKeyType](../TextInput/ts-basic-components-textinput.md#enterkeytype枚举说明) | 是 | 输入法回车键类型。  默认值：EnterKeyType.Search |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ColorMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12>)> | 是 | 设置分割线颜色。  默认使用系统的主题色：浅色模式下为0x33000000，显示为浅黑色，深色模式下为0x33FFFFFF，显示为浅白色。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| size | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 图标尺寸，不支持百分比。 |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 图标颜色。 |
| src | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 图标/图片源。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fontSize | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 文本按钮字体大小，不支持百分比。**元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fontColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 文本按钮字体颜色。**元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| --- | --- | --- | --- | --- |
| style | [CancelButtonStyle](ts-basic-components-search.md#cancelbuttonstyle10枚举说明) | 否 | 是 | 右侧清除按钮显示状态。 |
| icon | [SymbolGlyphModifier](../输入框类组件通用接口/ts-universal-attributes-text-style.md#symbolglyphmodifier12) | 否 | 是 | 右侧清除按钮Symbol图标。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnPasteCallback](../TextInput/ts-basic-components-textinput.md#onpastecallback18) | 是 | 粘贴回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnTextSelectionChangeCallback](../TextInput/ts-basic-components-textinput.md#ontextselectionchangecallback18) | 是 | 文本选择变化回调或光标位置变化回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnContentScrollCallback](../TextInput/ts-basic-components-textinput.md#oncontentscrollcallback18) | 是 | 文本内容滚动回调。 |
...
| options | [SelectionOptions](../输入框类组件通用接口/ts-universal-attributes-text-style.md#selectionoptions12对象说明) | 否 | 选中文字时的配置。  默认值：MenuPolicy.DEFAULT。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/lBP81iYlTGOBZQg4MXFbAw/zh-cn_image_0000002592220262.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=8EE977D4AF89791CDC2742F09B585544EAB3B988917370FDB8D9521F4429FC67)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/qxzcUElcTG-or0REw1QwIg/zh-cn_image_0000002592380196.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=F42B3B66372ED4A847DF46200E6CF122AB8AE7B516A05D3B116540EA63083F52)

### 示例3（设置自定义键盘）

该示例通过[customKeyboard](ts-basic-components-search.md#customkeyboard10)（从API version 10开始）属性分别将value中的入参类型设置为[CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8)和[ComponentContent](<../../../ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md#componentcontent-1>)，实现了自定义键盘的功能。

从API version 22开始[customKeyboard](ts-basic-components-search.md#customkeyboard10)属性新增了入参类型[ComponentContent](<../../../ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md#componentcontent-1>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/sFoKkAebRkOKsZZ6l3R-aA/zh-cn_image_0000002622859705.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=21998F3FB551306397672459039E4CD688E23823EAAB1AA9A0B9E6C44CA8F360)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/AhHkcR1rQB2zg8pO0JOpxA/zh-cn_image_0000002622699825.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=817B3F9602819EB551CB7206136ED460F97C4445C5B9B51A980A6B8387BB0215)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/AMdLfuKkQuCS-hL_BehczQ/zh-cn_image_0000002592220264.png?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=65E8D31E9A44F789872F09D9BDC3664D30161052B1C35F7E030218F41F658B6B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b0/v3/2J9-F6XNREWuO5l-AofzmQ/zh-cn_image_0000002592380198.png?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=51034B1CF94E35CD2BB98A9F346F47C210086D58829FB5F024808B33A192F11C)

### 示例7（自定义键盘避让）

该示例通过[customKeyboard](ts-basic-components-search.md#customkeyboard10)（从API version 10开始）属性配置[KeyboardOptions](../RichEditor/ts-basic-components-richeditor.md#keyboardoptions12)（从API version 12开始）接口实现了自定义键盘避让的效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/cm6_5yQkSBewgGqTjMSq7g/zh-cn_image_0000002622859707.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=CF83A3B997E54583A3DB8922D4FD246A964015EA27294F477593AD779BA47497)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/EmpMupLMRcSo2Wz3MiSuhg/zh-cn_image_0000002622699827.png?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=2BAD4907ACD2839FC67AF07212F9A4770434930EA916147AC06567684006BFCA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/cUM8szJhQgq1hQsXe2zr2g/zh-cn_image_0000002592220266.png?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=DCCF4822A1F4FF7D68B01A555F2328B36B1720D60555B8E37671266E63AB8B3F)

### 示例10（文本扩展自定义菜单）

从API version 12开始，该示例通过[editMenuOptions](ts-basic-components-search.md#editmenuoptions12)接口实现了文本设置自定义菜单扩展项的文本内容、图标以及回调的功能，同时，可以在[onPrepareMenu](../文本组件公共接口/ts-text-common.md#属性-1)（从API version 20开始）回调中，进行菜单数据的设置。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/HLvMgX3fRJCxnMDtQ4lQBw/zh-cn_image_0000002592380200.png?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=FCAEA7439B36F2DE2115B4DB4F584B8A5CEAC32C87CDE9B0C57EC376C9318BD0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/LyCGoFgoQhypxPr7DxNByA/zh-cn_image_0000002622859709.png?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=4411CB9BFDD88E280AA634BA5161AED5AB16651E41EA0BEFDB9B3AEE36FAC7B4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/_JLQgqHJR3i6Fqit0kv7UQ/zh-cn_image_0000002622699829.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=ECB8C4FA73D35486332CCCCA6FF8480CF0434FF4CEE4E89608441CB45D4349FF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/k7lfEZNVQb-P5z1IxsuGmQ/zh-cn_image_0000002592220268.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=E91C25FC074708187455610E15758FD0BF55B28DA60F59F5FBFEBE721FF6DD78)

### 示例14（设置默认获焦并拉起软键盘）

该示例通过[defaultFocus](../../通用属性/交互属性/焦点控制/ts-universal-attributes-focus.md#defaultfocus9)（从API version 9开始）、[enableKeyboardOnFocus](ts-basic-components-search.md#enablekeyboardonfocus10)（从API version 10开始）属性展示如何设置默认获焦并拉起软键盘。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8e/v3/VMfJm71VQt2jBnsrnKrBpA/zh-cn_image_0000002592380202.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074721Z&HW-CC-Expire=86400&HW-CC-Sign=9D9ED00EEFC94211B3F2D37C2E969D5CC3F91D68D246A7EAABBB5B719B02479B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3