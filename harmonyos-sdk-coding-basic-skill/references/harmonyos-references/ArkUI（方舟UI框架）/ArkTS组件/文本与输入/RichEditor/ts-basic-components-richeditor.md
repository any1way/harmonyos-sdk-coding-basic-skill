...
scraped_at: 2026-06-11T15:47:26+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:db20098ec8b2adbe2f9b2d2307460b153c28697f960129f0a8e0e4f337ae1006
---
支持图文混排和文本交互式编辑的组件。
...
* 不支持[borderImage](../../通用属性/布局与边框/图片边框设置/ts-universal-attributes-border-image.md#borderimage)属性。
...
自定义键盘支持接续功能，使用[setCustomKeyboardContinueFeature](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#setcustomkeyboardcontinuefeature23>)接口，可以设置自定义键盘之间切换时是否接续。

说明

从API version 23开始，该接口支持在[attributeModifier](../../通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#attributemodifier)中调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | [ComponentContent](<../../../ArkTS API/UI界面/arkui/ComponentContent/js-apis-arkui-componentcontent.md#componentcontent-1>)23+ | undefined23+ | 是 | 自定义键盘。  传入undefined时默认使用系统键盘。 |
...
设置自定义选择菜单。自定义菜单超长时，建议内部嵌套[Scroll](../../滚动与滑动/Scroll/ts-container-scroll.md)组件使用，避免键盘被遮挡。
...
| content | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 菜单的内容。 |
| responseType | [ResponseType](../../公共定义/枚举说明/ts-appendix-enums.md#responsetype8) | [RichEditorResponseType](ts-basic-components-richeditor.md#richeditorresponsetype11) | 是 | 菜单的响应类型。  默认值：  ResponseType.LongPress |
...
* 设置RichEditor组件的属性字符串时，请参考属性字符串[toHtml](../属性字符串/ts-universal-styled-string.md#tohtml14)接口文档，以了解支持转换为HTML的范围。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CopyOptions](../../公共定义/枚举说明/ts-appendix-enums.md#copyoptions9) | 是 | 组件支持文本内容是否可复制粘贴。  默认值：CopyOptions.LocalDevice |
...
AI菜单选项包括[TextMenuItemId](../文本组件公共接口/ts-text-common.md#textmenuitemid12)中的url（打开链接）、email（新建邮件）、phoneNumber（呼叫）、address（导航至该位置）、dateTime（新建日程提醒）。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [TextDataDetectorConfig](../文本组件公共接口/ts-text-common.md#textdatadetectorconfig11对象说明) | 是 | 文本识别配置。 |
...
AI菜单功能启用时，在组件中选中文本后，文本选择菜单能够展示对应的AI菜单项，包括[TextMenuItemId](../文本组件公共接口/ts-text-common.md#textmenuitemid12)中的url（打开连接）、email（新建邮件）、phoneNumber（呼叫）、address（导航前往）、dateTime（新建日程）。

AI菜单生效时，选中范围内需包括且仅包括一个完整的AI实体，才能展示对应的选项。该菜单项与[TextMenuItemId](../文本组件公共接口/ts-text-common.md#textmenuitemid12)中的askAI菜单项不同时出现。
...
该接口在CAPI场景使用时默认关闭。可以在工程的module.json5中配置[metadata](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（FA模型）/module对象内部结构/module-structure.md#metadata对象内部结构)字段控制是否启用预上屏，配置如下：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 无输入时的提示文本。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 输入框光标、手柄颜色。  默认值：'#007DFF' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 文本选中的底板颜色。  默认为20%不透明度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [EnterKeyType](../TextInput/ts-basic-components-textinput.md#enterkeytype枚举说明) | 是 | 软键盘输入法回车键类型。  默认为EnterKeyType.NEW\_LINE。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [BarState](../../公共定义/枚举说明/ts-appendix-enums.md#barstate) | 是 | 输入框滚动条的显示模式。  默认值：BarState.Auto |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| maxLength | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<number> | 是 | 文本的最大输入字符数。  默认值：Infinity，可以无限输入，支持undefined类型。  **说明：**  当不设置该属性或设置异常值时，取默认值，设置小数时，取整数部分。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| maxLines | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<number> | 是 | 设置富文本可显示的最大行数。maxLines为可显示行数，当设置maxLines时，超出内容可滚动显示。同时设置组件高度和最大行数，组件高度优先生效。  默认值：UINT32\_MAX，可以无限输入，支持undefined类型。  取值范围：(0, UINT32\_MAX] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| appearance | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[KeyboardAppearance](../文本组件公共接口/ts-text-common.md#keyboardappearance15枚举说明)> | 是 | 键盘外观。  默认值：KeyboardAppearance.NONE\_IMMERSIVE |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[UndoStyle](ts-basic-components-richeditor.md#undostyle20-1)> | 是 | 撤销还原是否保留原样式选项。默认值：UndoStyle.CLEAR\_STYLE |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enable | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否开启中文与西文的自动间距。  true为开启自动间距，false为不开启。  默认值：false |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ColorMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12>)> | 是 | 设置组件滚动条颜色。  默认值：'#66182431'，显示为灰色。  **说明：** 设置异常值时按默认值处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SelectedDragPreviewStyle](../文本组件公共接口/ts-text-common.md#selecteddragpreviewstyle23对象说明) | undefined | 是 | 拖动预览样式。如果设置为undefined，样式将被重置。 |
...
除支持[通用事件](../../通用事件/ts-component-general-events.md)外，还支持[OnDidChangeCallback](../文本组件公共接口/ts-text-common.md#ondidchangecallback12)、[StyledStringChangedListener](../文本组件公共接口/ts-text-common.md#styledstringchangedlistener12)、[StyledStringChangeValue](../文本组件公共接口/ts-text-common.md#styledstringchangevalue12)和以下事件：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[TextRange](../文本组件公共接口/ts-text-common.md#textrange12)> | 是 | TextRange为输入法本次输入内容的范围。  输入法完成输入时的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnDidChangeCallback](../文本组件公共接口/ts-text-common.md#ondidchangecallback12) | 是 | 图文变化前后的内容范围。 |
...
调用[IMEClient](../文本组件公共接口/ts-text-common.md#imeclient20对象说明)的[setExtraConfig](../文本组件公共接口/ts-text-common.md#setextraconfig22)方法设置输入法扩展信息。在绑定输入法成功后，输入法会收到扩展信息，输入法可以依据此信息实现自定义功能。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[IMEClient](../文本组件公共接口/ts-text-common.md#imeclient20对象说明)> | undefined | 是 | 在组件绑定输入法前触发的回调。  值为undefined时清除已绑定的回调事件。 |
...
| valueResource11+ | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 是 | 组件SymbolSpan内容。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fontColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 否 | 文本颜色。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fontSize | number | 否 | 否 | 字体大小，默认单位为fp。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fontStyle | [FontStyle](../../公共定义/枚举说明/ts-appendix-enums.md#fontstyle) | 否 | 否 | 字体样式。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| decoration | [DecorationStyleResult](../文本组件公共接口/ts-text-common.md#decorationstyleresult12) | 否 | 否 | 文本装饰线样式信息。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| textShadow12+ | Array<[ShadowOptions](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadowoptions对象说明)> | 否 | 是 | 文字阴影效果。  **说明：**  仅支持查询阴影模糊半径、颜色和偏移量。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| textBackgroundStyle18+ | [TextBackgroundStyle](../Span/ts-basic-components-span.md#textbackgroundstyle11对象说明) | 否 | 是 | 文本背景样式。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| strokeWidth23+ | number | 否 | 是 | 文本描边宽度。  单位为[vp](../../公共定义/像素单位/ts-pixel-units.md#基本像素单位)。  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。 |
| strokeColor23+ | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 文本描边颜色。  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fontColor | Array<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 否 | 否 | SymbolSpan组件颜色。  默认值：不同渲染策略下默认值不同。 |
| fontSize | number | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 否 | SymbolSpan组件大小，默认单位为fp。  默认值：跟随主题。 |
| fontWeight | number | [FontWeight](../../公共定义/枚举说明/ts-appendix-enums.md#fontweight) | string | 否 | 否 | SymbolSpan组件粗细。  number类型取值[100,900]，取值间隔为100，默认为400，取值越大，字体越粗。  string类型仅支持number类型取值的字符串形式，例如“400”，以及“bold”、“bolder”、“lighter”、“regular” 、“medium”分别对应FontWeight中相应的枚举值。  默认值：FontWeight.Normal。 |
| renderingStrategy | [SymbolRenderingStrategy](../SymbolGlyph/ts-basic-components-symbolglyph.md#symbolrenderingstrategy11枚举说明) | 否 | 否 | SymbolSpan组件渲染策略。  默认值：SymbolRenderingStrategy.SINGLE。 |
| effectStrategy | [SymbolEffectStrategy](../SymbolGlyph/ts-basic-components-symbolglyph.md#symboleffectstrategy11枚举说明) | 否 | 否 | SymbolSpan组件动效策略。  默认值：SymbolEffectStrategy.NONE。 |
...
| valuePixelMap | [PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 否 | 是 | 图片内容。 |
| valueResourceStr | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 图片资源id。 |
...
| verticalAlign | [ImageSpanAlignment](../../公共定义/枚举说明/ts-appendix-enums.md#imagespanalignment10) | 否 | 否 | 图片垂直对齐方式。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| objectFit | [ImageFit](../../公共定义/枚举说明/ts-appendix-enums.md#imagefit) | 否 | 否 | 图片缩放类型。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| margin | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | [Margin](../../公共定义/基础类型定义/ts-types.md#margin) | 否 | 是 | 外边距类型，用于描述组件不同方向的外边距。  参数为Dimension类型时，四个方向外边距同时生效。 |
| borderRadius | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | [BorderRadiuses](../../公共定义/基础类型定义/ts-types.md#borderradiuses9) | 否 | 是 | 圆角类型，用于描述组件边框圆角半径。  参数为Dimension类型时，不支持以Percentage形式设置。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| rangeBefore | [TextRange](../文本组件公共接口/ts-text-common.md#textrange12) | 否 | 否 | 即将被替换内容的开始和结束索引。 |
...
| options12+ | [SelectionOptions](../输入框类组件通用接口/ts-universal-attributes-text-style.md#selectionoptions12对象说明) | 否 | 选择项配置。 |
...
| 类型 | 说明 |
| --- | --- |
| [LayoutManager](../文本组件公共接口/ts-text-common.md#layoutmanager12) | 布局管理器对象。  当controller未绑定组件或绑定controller的组件被释放时，返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [PreviewText](../文本组件公共接口/ts-text-common.md#previewtext12) | 预上屏信息。  当controller未绑定组件或绑定controller的组件被释放时，返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [RectResult](../../通用事件/交互事件分发控制/自定义事件分发/ts-universal-attributes-on-child-touch-test.md#rectresult) | undefined | 当前光标与RichEditor的相对位置。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| styledString | [StyledString](../属性字符串/ts-universal-styled-string.md#styledstring) | 是 | 设置属性字符串样式的提示文本，其优先级高于[placeholder](ts-basic-components-richeditor.md#placeholder12)属性设置的提示文本。  提示文本不支持触发属性字符串[GestureStyle](../属性字符串/ts-universal-styled-string.md#gesturestyle)样式绑定的手势事件，以及[UrlStyle](../属性字符串/ts-universal-styled-string.md#urlstyle14)样式的超链接跳转能力。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 文本内容。  从API version 20开始，支持Resource类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 图片内容。 |
...
通用属性仅支持[size](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#size)、[padding](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#padding)、[margin](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#margin)、[aspectRatio](../../通用属性/布局与边框/布局约束/ts-universal-attributes-layout-constraints.md#aspectratio)、[borderStyle](../../通用属性/布局与边框/边框设置/ts-universal-attributes-border.md#borderstyle)、[borderWidth](../../通用属性/布局与边框/边框设置/ts-universal-attributes-border.md#borderwidth)、[borderColor](../../通用属性/布局与边框/边框设置/ts-universal-attributes-border.md#bordercolor)、[borderRadius](../../通用属性/布局与边框/边框设置/ts-universal-attributes-border.md#borderradius)、[backgroundColor](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundcolor)、[backgroundBlurStyle](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundblurstyle9)、[opacity](../../通用属性/视效与模糊/透明度设置/ts-universal-attributes-opacity.md#opacity)、[blur](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#blur)、[backdropBlur](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backdropblur)、[shadow](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadow)、[grayscale](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#grayscale)、[brightness](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#brightness)、[saturate](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#saturate)、[contrast](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#contrast)、[invert](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#invert)、[sepia](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#sepia)、[hueRotate](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#huerotate)、[colorBlend](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#colorblend)、[linearGradientBlur](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#lineargradientblur12)、[clip](../../通用属性/视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip12)、[mask](../../通用属性/视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#mask12)、[foregroundBlurStyle](../../通用属性/视效与模糊/组件内容模糊/ts-universal-attributes-foreground-blur-style.md#foregroundblurstyle)、[accessibilityGroup](../../通用属性/无障碍属性/ts-universal-attributes-accessibility.md#accessibilitygroup)、[accessibilityText](../../通用属性/无障碍属性/ts-universal-attributes-accessibility.md#accessibilitytext)、[accessibilityDescription](../../通用属性/无障碍属性/ts-universal-attributes-accessibility.md#accessibilitydescription)、[accessibilityLevel](../../通用属性/无障碍属性/ts-universal-attributes-accessibility.md#accessibilitylevel)、[sphericalEffect](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#sphericaleffect12)、[lightUpEffect](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#lightupeffect12)、[pixelStretchEffect](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#pixelstretcheffect12)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 自定义组件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 是 | symbol资源信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [StyledString](../属性字符串/ts-universal-styled-string.md#styledstring) | 是 | 转换前的属性字符串。 |
...
以下错误码的详细介绍请参考[通用错误码](../../../../通用错误码/errorcode-universal.md)。
...
| 类型 | 说明 |
| --- | --- |
| [StyledString](../属性字符串/ts-universal-styled-string.md#styledstring) | 转换后的属性字符串 |

**错误码：**

以下错误码详细介绍请参考[通用错误码](../../../../通用错误码/errorcode-universal.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| styledString | [StyledString](../属性字符串/ts-universal-styled-string.md#styledstring) | 是 | 属性字符串。  **说明：**  StyledString的子类[MutableStyledString](../属性字符串/ts-universal-styled-string.md#mutablestyledstring)也可以作为入参值。 |
...
| 类型 | 说明 |
| --- | --- |
| [MutableStyledString](../属性字符串/ts-universal-styled-string.md#mutablestyledstring) | 富文本组件显示的属性字符串。  当controller未绑定组件或绑定controller的组件被释放时，返回undefined。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| listener | [StyledStringChangedListener](../文本组件公共接口/ts-text-common.md#styledstringchangedlistener12) | 是 | 文本内容变化回调监听器。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| textAlign | [TextAlign](../../公共定义/枚举说明/ts-appendix-enums.md#textalign) | 否 | 是 | 设置文本段落在水平方向的对齐方式。默认值：TextAlign.START  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| leadingMargin | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | [LeadingMarginPlaceholder](ts-basic-components-richeditor.md#leadingmarginplaceholder11) | 否 | 是 | 设置文本段落缩进，当段落仅存在ImageSpan或BuilderSpan时，此属性值不生效。参数为Dimension类型时，不支持以Percentage形式设置。默认值：{"size":["0.00px","0.00px"]}  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| wordBreak12+ | [WordBreak](../../公共定义/枚举说明/ts-appendix-enums.md#wordbreak11) | 否 | 是 | 设置断行规则。  默认值：WordBreak.BREAK\_WORD  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| lineBreakStrategy12+ | [LineBreakStrategy](../../公共定义/枚举说明/ts-appendix-enums.md#linebreakstrategy12) | 否 | 是 | 设置折行规则。  默认值：LineBreakStrategy.GREEDY  在wordBreak不等于breakAll的时候生效，不支持连字符。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| paragraphSpacing19+ | number | 否 | 是 | 设置段落间距大小。  单位：fp  段落间距默认大小为0。  **元服务API：** 从API version 19开始，该接口支持在元服务中使用。 |
| textVerticalAlign20+ | [TextVerticalAlign](../文本组件公共接口/ts-text-common.md#textverticalalign20) | 否 | 是 | 设置文本段落在垂直方向的对齐方式。  默认值：TextVerticalAlign.BASELINE  **元服务API：** 从API version 20开始，该接口支持在元服务中使用。 |
| textDirection23+ | [TextDirection](../文本组件公共接口/ts-text-common.md#textdirection22) | 否 | 是 | 设置文本方向。  默认值：TextDirection.DEFAULT  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pixelMap | [PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 否 | 否 | 图片内容。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| size | [[Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10), [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10)] | 否 | 否 | 图片大小，不支持设置百分比。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fontColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 文本颜色。  默认值：$r('sys.color.font\_primary')。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fontSize | [Length](../../公共定义/基础类型定义/ts-types.md#length) | number | 否 | 是 | 设置字体大小，Length为number类型时，使用fp单位。字体默认大小16。不支持设置百分比字符串。字体大小设置为0时，显示默认字体大小。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fontStyle | [FontStyle](../../公共定义/枚举说明/ts-appendix-enums.md#fontstyle) | 否 | 是 | 字体样式。  默认值：FontStyle.Normal。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fontWeight | number | [FontWeight](../../公共定义/枚举说明/ts-appendix-enums.md#fontweight) | string | 否 | 是 | 字体粗细。  number类型取值[100,900]，取值间隔为100，默认为400，取值越大，字体越粗。  string类型仅支持number类型取值的字符串形式，例如“400”，以及“bold”、“bolder”、“lighter”、“regular” 、“medium”分别对应FontWeight中相应的枚举值。  默认值：FontWeight.Normal。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| fontFamily | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 设置字体列表。默认字体'HarmonyOS Sans'，当前支持'HarmonyOS Sans'字体和[注册自定义字体](<../../../ArkTS API/UI界面/@ohos.font (注册自定义字体)/js-apis-font.md>)。  默认字体:'HarmonyOS Sans'。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| decoration | [DecorationStyleInterface](../属性字符串/ts-universal-styled-string.md#decorationstyleinterface) | 否 | 是 | 设置文本装饰线的样式、颜色和粗细。  type默认值：TextDecorationType.None  color默认值：跟随字体颜色。  style默认值：TextDecorationStyle.SOLID  thicknessScale默认值：1.0  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| textShadow11+ | [ShadowOptions](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadowoptions对象说明) | Array<[ShadowOptions](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadowoptions对象说明)> | 否 | 是 | 设置文字阴影效果。该接口支持以数组形式入参，实现多重文字阴影。  **说明：**  仅支持设置阴影模糊半径、颜色和偏移量，不支持智能取色。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| lineHeight12+ | number | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 是 | 设置文本的文本行高，设置值不大于0时，不限制文本行高，自适应字体大小。number类型时单位为fp，不支持设置百分比字符串。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| fontFeature12+ | string | 否 | 是 | 设置文字特性效果，比如数字等宽的特性。如果未设置，默认为变宽数字。设置无效字符保持默认。  格式为：normal | <feature-tag-value>  <feature-tag-value>的格式为：<string> [ <integer> | on | off ]  <feature-tag-value>的个数可以有多个，中间用','隔开。  例如，使用等宽时钟数字的输入格式为："ss01" on。  Font Feature当前支持的属性见[fontFeature](../Text/ts-basic-components-text.md#fontfeature12)属性列表。  设置 Font Feature 属性，Font Feature 是 OpenType 字体的高级排版能力，如支持连字、数字等宽等特性，一般用在自定义字体中，其能力需要字体本身支持。  更多 Font Feature 能力介绍可参考 <https://www.w3.org/TR/css-fonts-3/#font-feature-settings-prop> 和 <https://sparanoid.com/lab/opentype-features/>  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| halfLeading18+ | boolean | 否 | 是 | 文本是否将行间距平分至行的顶部与底部。  true表示将行间距平分至行的顶部与底部，false则不平分。  默认值：false。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| textBackgroundStyle18+ | [TextBackgroundStyle](../Span/ts-basic-components-span.md#textbackgroundstyle11对象说明) | 否 | 是 | 文本背景样式。  默认值：  {  color: Color.Transparent,  radius: 0  }  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| strokeWidth23+ | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | number | 否 | 是 | 文本描边宽度。如果LengthMetrics的unit值是[PERCENT](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthunit12>)，当前设置不生效，作为0处理。  值小于0时为实体字，大于0时为轮廓字，等于0时无描边效果。  默认值：0vp。  单位：LengthMetrics类型时跟随LengthMetrics，number类型时是vp。  取值范围：(-∞, +∞)  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
| strokeColor23+ | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 文本描边颜色。  默认值：跟随字体颜色。  设置异常值时跟随字体颜色。  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| font | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 否 | 是 | 设置placeholder文本样式。  默认值遵循主题设置。 |
| fontColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 设置placeholder文本颜色。  默认值遵循主题设置。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| size | [[Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10), [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10)] | 否 | 是 | 图片宽度和高度。默认值：与objectFit的值相关，不同的objectFit值有不同的默认尺寸。objectFit的值为Cover时，图片高度为组件高度减去组件上下内边距，宽度为组件宽度减去组件左右内边距。不支持以Percentage形式设置。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| verticalAlign | [ImageSpanAlignment](../../公共定义/枚举说明/ts-appendix-enums.md#imagespanalignment10) | 否 | 是 | 图片垂直对齐方式。  默认值:ImageSpanAlignment.BOTTOM  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| objectFit | [ImageFit](../../公共定义/枚举说明/ts-appendix-enums.md#imagefit) | 否 | 是 | 图片缩放类型。  默认值:ImageFit.Cover。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fontColor | Array<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)> | 否 | 是 | 设置SymbolSpan组件颜色。  默认值：不同渲染策略下默认值不同。 |
| fontSize | number | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 是 | 设置SymbolSpan组件大小，默认单位为fp。  默认值：跟随主题。 |
| fontWeight | number | [FontWeight](../../公共定义/枚举说明/ts-appendix-enums.md#fontweight) | string | 否 | 是 | 设置SymbolSpan组件粗细。  number类型取值[100,900]，取值间隔为100，默认为400，取值越大，字体越粗。  string类型仅支持number类型取值的字符串形式，例如“400”，以及“bold”、“bolder”、“lighter”、“regular” 、“medium”分别对应FontWeight中相应的枚举值。  默认值：FontWeight.Normal。 |
| renderingStrategy | [SymbolRenderingStrategy](../SymbolGlyph/ts-basic-components-symbolglyph.md#symbolrenderingstrategy11枚举说明) | 否 | 是 | 设置SymbolSpan组件渲染策略。  默认值：SymbolRenderingStrategy.SINGLE。 |
| effectStrategy | [SymbolEffectStrategy](../SymbolGlyph/ts-basic-components-symbolglyph.md#symboleffectstrategy11枚举说明) | 否 | 是 | 设置SymbolSpan组件动效策略。  默认值：SymbolEffectStrategy.NONE。 |
...
| accessibilitySpanOptions23+ | [AccessibilitySpanOptions](../文本组件公共接口/ts-text-common.md#accessibilityspanoptions23对象说明) | 否 | 是 | 无障碍朗读功能属性。缺省时，取[AccessibilitySpanOptions](../文本组件公共接口/ts-text-common.md#accessibilityspanoptions23对象说明)的默认值。  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。  **模型约束：** 此接口仅可在Stage模型下使用。 |
...
| menuType13+ | [MenuType](../文本组件公共接口/ts-text-common.md#menutype13枚举说明) | 否 | 是 | 自定义选择菜单类型。  **元服务API：** 从API version 13开始，该接口支持在元服务中使用。  默认值：MenuType.SELECTION\_MENU。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| hapticFeedbackMode | [HapticFeedbackMode](../../通用属性/弹窗控制/菜单控制/ts-universal-attributes-menu.md#hapticfeedbackmode18) | 否 | 是 | 菜单弹出时振动效果，当ImageSpan或BuilderSpan绑定预览菜单时生效。  默认值：HapticFeedbackMode.DISABLED，菜单弹出时不振动。  **说明：** 仅当应用具备ohos.permission.VIBRATE权限，且用户启用了触感反馈时才会生效。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| onClick | Callback<[ClickEvent](../../通用事件/交互响应事件/点击事件/ts-universal-events-click.md#clickevent)> | 否 | 是 | [ClickEvent](../../通用事件/交互响应事件/点击事件/ts-universal-events-click.md#clickevent)为用户点击事件。  点击完成时回调事件。  双击时，第一次点击触发回调事件。 |
| onLongPress | Callback<[GestureEvent](../../手势处理/手势公共接口/ts-gesture-common.md#gestureevent对象说明)> | 否 | 是 | [GestureEvent](../../手势处理/手势公共接口/ts-gesture-common.md#gestureevent对象说明)为用户长按事件。  长按完成时回调事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enterKey | [EnterKeyType](../TextInput/ts-basic-components-textinput.md#enterkeytype枚举说明) | 是 | 软键盘输入法回车键类型。具体类型见EnterKeyType枚举说明。 |
| event | [SubmitEvent](../TextInput/ts-basic-components-textinput.md#submitevent11) | 是 | 当提交的时候，提供保持组件编辑状态的方法。EnterKeyType指定为NEW\_LINE时，默认保持编辑态。 |
...
| event | [HoverEvent](../../通用事件/交互响应事件/悬浮事件/ts-universal-events-hover.md#hoverevent10对象说明) | 是 | 设置悬浮事件。 |
...
| --- | --- | --- | --- | --- |
| spanPosition | [RichEditorSpanPosition](ts-basic-components-richeditor.md#richeditorspanposition) | 否 | 否 | Span位置。 |
| value | [PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 图片内容。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| url | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | url地址。  默认值：undefined |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/2-7mNxCdTseQ3gWZ2_I4rA/zh-cn_image_0000002592220244.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=FAE73C0819E2B4C1C316E2706AE1573B9C402B283CFD3557FA98BFE9229BCCCA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8c/v3/uWH2kfgASOatLRUAEMSXdA/zh-cn_image_0000002592380178.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=327A04016B26161B80B6B60241641B5DB2E389739B64EBA67EB5A8C0C8581B6B)

### 示例3（绑定自定义菜单）

通过[bindSelectionMenu](ts-basic-components-richeditor.md#bindselectionmenu)给组件绑定自定义菜单。

示例中的粘贴菜单项涉及读取剪贴板数据，因此需按规范[申请访问剪贴板权限](<../../../../../harmonyos-guides/系统/基础功能/Basic Services Kit（基础服务）/剪贴板服务/申请访问剪贴板权限/get-pastedata-permission-guidelines.md>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/VXsg0W07SiO44vwP0sUkdg/zh-cn_image_0000002622859687.png?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=68480A9FA3C5EF121BD92FCEE2565A6B90E59F6946847D13A41AC4B53997D0BF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/mdBi50QLQPS1rz54ReppPg/zh-cn_image_0000002622699807.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=18FB126FF870286ADA128A31FBFF81F0A8A5155645BCB6469E792311F0709C13)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d4/v3/6IC8z4pfTY27cZY55hlXgg/zh-cn_image_0000002592220246.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=1157ED7D1EF7A81D1783CE8109B83038F66A374C36B31EA4C496EBDDE9AD4DC6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/aS1_9bFgQC6F-AP1TygIGw/zh-cn_image_0000002592380180.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=8418DB445038527CB34F2597699DFCA43E38F97E98C8D2ECC46C853A2938DAC1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/DoQT0O6yS6-lo_Qhvb6jTQ/zh-cn_image_0000002622859689.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=7EFD1E86C5613E50FF2DB467C8C1F232F354E2B8C4A28222ECA891647BB180DB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/nzVdKpIGSyG1up2KM2r7lg/zh-cn_image_0000002622699809.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=FE174CBDF7F0EDD63539A4C64F2B82181940B2ADA002B421FD75130EC9D395D6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/drFwZbKrR8iTw7daKXh7lg/zh-cn_image_0000002592220248.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=1CB699D9433FAF5C301AB5E1C8543A42DD22BD6F16F8B25A87B0DCB6A45AD9EA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/R-KQfUuSTPad76z475duqQ/zh-cn_image_0000002592380182.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=5D300688E746EA9C19764B481A7EDDC8E2624D492D1EA858B5BBCC99C045B7B9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/g3E3zLtkR3uzTVtSgEArzg/zh-cn_image_0000002622859691.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=F0490AC6A164A31C7A74CA7F68153049AB640505BABBC93C48F7996D108A9869)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/03/v3/Z_D2mCqPTL6UN5SMyVDx5g/zh-cn_image_0000002622699811.png?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=6DC85EBD4BFA9C7C23548056EF5949EA9757924B2F88A465202A9EBB8BE3FC25)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/09/v3/0eoRkXzbQmG26HsdoqB0eg/zh-cn_image_0000002592220250.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=9D9DC70B37903542FD56E7EA3439ADAFBEA20C0D6C86C0F69738E387BAA801C6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/I1vWI0cNRwW5LFbp5WAdSQ/zh-cn_image_0000002592380184.png?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=AE31D87E84C565DEC2C24CB281915883BEB99FAA768E8698F307E8CF65D8F74A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/5pwPpyeJQ3CrHe5NCC3Rpw/zh-cn_image_0000002622859693.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=BFB156047E3FA3C0207172C65A3E744D63D04E66ACA093D9978806D3BAB410EA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8e/v3/duR9wNkzRdWTsq-BVTzPmg/zh-cn_image_0000002622699813.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=E74015BB040FD917F0EA3D90A42A64416400960C8F3EE20229C2A1BEDB8A6278)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/wh4R7XmnRNSt3nFVB96vRQ/zh-cn_image_0000002592220252.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=12778239115263155A0437B1F3E9D17EFCDC7273E325F8018A8AFAF93B08C190)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/eZVCV2oAT9GW_W4DumdvaA/zh-cn_image_0000002592380186.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=9E7679B8F04F56D4BF49FB8BC3715E67C99BA5C3ED5FE864DBB3817C09F6AAA9)

### 示例21（属性字符串基本功能）

从API version 20开始，该示例中[属性字符串](../属性字符串/ts-universal-styled-string.md)通过[RichEditorStyledStringController](ts-basic-components-richeditor.md#richeditorstyledstringcontroller12)中的[setStyledString](ts-basic-components-richeditor.md#setstyledstring12)方法与RichEditor组件绑定。通过[getStyledString](ts-basic-components-richeditor.md#getstyledstring12)接口获取富文本组件显示的属性字符串。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/QpFdWU4fSqKQ1Dx1jRK1Yw/zh-cn_image_0000002622859695.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=D45342DE40E8FD88CC2E15BB7BD02210A8CD67962C45F92843AA939D335E3942)

### 示例22（获取布局信息）

通过[getLayoutManager](ts-basic-components-richeditor.md#getlayoutmanager12)接口获取布局管理器对象，通过[getLineCount](../文本组件公共接口/ts-text-common.md#getlinecount12)接口获取组件内容或[placeholder](ts-basic-components-richeditor.md#placeholder12)的总行数，通过[getGlyphPositionAtCoordinate](../文本组件公共接口/ts-text-common.md#getglyphpositionatcoordinate12)接口获取较为接近给定坐标的字形的位置信息，通过[getLineMetrics](../文本组件公共接口/ts-text-common.md#getlinemetrics12)接口获取指定行的行信息、文本样式信息、以及字体属性信息。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/F24t4N7xRimspKYtQ9RUFw/zh-cn_image_0000002622699815.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=6677E907C46A031F2ABA29F02C72A0D437335412680407F9CFEE56F666DC0136)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/g9HwwamnQDGuVOy8RBuBeQ/zh-cn_image_0000002592220254.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=0E0091955F2D5F53EB8B6B952A24F4BF285D9A3880D4C92685826B81A4798C30)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/iMPX0efKTjWsM213E8YhRA/zh-cn_image_0000002592380188.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=6F107DF2D6F341DACB2813613D6EDC7EBFB8F9B58B7C1B4ADCBAEBF486511045)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/Fvnf3dApQhaGimtBvkToBw/zh-cn_image_0000002622859697.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=281E66A3B39D3A2A1858BAAD8AC266EE4C720D1EFB9C512C66CD95581BE978B2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4/v3/LoWEnqUnRDK5pFIyE0VfWQ/zh-cn_image_0000002622699817.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=D29B76FB470623E5456012AC2A9308E68B9271E95C5EAF716F4CFCA30B964064)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/VpkjcFuURTa8crrQWFCGAg/zh-cn_image_0000002592220256.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=A8597B91619DFC66D2C63BFD10DB3F12E71777DEBD022701815BC6842C188F1F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/TPCI-rvSTmeAmBLnkxflpw/zh-cn_image_0000002592380190.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=5087B51158559185FDCCCFF8BA0FA79EF7DE6E9F4A85A09FB26C7AB94CC783DC)
...
从API version 20开始，该示例通过[DecorationStyle](../属性字符串/ts-universal-styled-string.md#decorationstyle)中的thicknessScale设置装饰线粗细，通过[enableMultiType](../属性字符串/ts-universal-styled-string.md#decorationoptions20)设置多装饰线。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/hDoykx86T_qhe7f59k9Z9A/zh-cn_image_0000002622859699.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=F09A679FE322A97725FCAA0E4D512D97B94352ADEA36AFC261A61BE0CE264737)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/2JwroFCMS42WvaeG4T0gnQ/zh-cn_image_0000002622699819.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=F5773655AF9299C621A28A321594698C007F8F71EDC9471110AC2B3C2812268D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/QW5ZKkCsRDyFqSwYsmK-ZQ/zh-cn_image_0000002592220258.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=A60348619663682ED95C4C0EDCE932E78557999BD99EA9B7E294A558D216EB50)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/O0rqCYE6Qi6c8aRTIoUmdg/zh-cn_image_0000002592380192.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=1A3D69443408A58471EA4D4E48B4CFFF18AEDFF179C85B61C43E863B3180EA57)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/rZ_wME4ORuyj_xUiEhi4xA/zh-cn_image_0000002622859701.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=A92772CD12F1893F1D94E0C6CE530EA7F2D265579B0D2BA50974BDD078BA3194)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/hnhlULG5RW22D4eE70AnIQ/zh-cn_image_0000002622699821.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=75FD55BE44FA8DF6A330A56B6B262B82F15A188AE4D253357C49EF415F7C2D5D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/h5KPM1BaRX2wdE4QapYOUA/zh-cn_image_0000002592220260.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=92DF25511C77C4B4A56E4346B0CB615979DB35FDEBC53706AE979B6B11A78052)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/-a8LatswQrWiovw-DeqtVA/zh-cn_image_0000002592380194.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=C59FF568534611BE2CB01572E14C404D57C881356FE9787109425E88D43E9CEC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/CCI0Ju7qRN2AWLKukdl6Bg/zh-cn_image_0000002622859703.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=B3734569C48EFFAF49D913C82106ED6935B000F3F38DD2321BD540F6B6550D29)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/RcCG3f8QQq-Dy56gRoRYpg/zh-cn_image_0000002622699823.png?HW-CC-KV=V1&HW-CC-Date=20260611T074718Z&HW-CC-Expire=86400&HW-CC-Sign=8CDC47CC3577847EA38CD470B94322CF03387BE65055D53F22780D704030B3B6)
