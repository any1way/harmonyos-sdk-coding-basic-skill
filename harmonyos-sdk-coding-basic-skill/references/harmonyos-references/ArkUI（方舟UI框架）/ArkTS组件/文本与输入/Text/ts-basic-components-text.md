...
scraped_at: 2026-06-11T15:47:15+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:3cd42ce13b3d23b7a627e4b03d6156e29fde7106d89d7a2782168779b0d894e9
---
显示一段文本的组件。
...
可以包含[Span](../Span/ts-basic-components-span.md)、[ImageSpan](../ImageSpan/ts-basic-components-imagespan.md)、[SymbolSpan](../SymbolSpan/ts-basic-components-symbolspan.md)和[ContainerSpan](../ContainerSpan/ts-basic-components-containerspan.md)子组件。

说明

使用[子组件](ts-basic-components-text.md#子组件)实现[图文混排](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/图文混排/arkts-text-image-layout.md>)场景。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 文本内容。当不包含子组件[Span](../Span/ts-basic-components-span.md)和未设置[属性字符串](../属性字符串/ts-universal-styled-string.md)时该参数生效。  默认值：' '  **说明：**  显示内容的优先级：属性字符串>Span>Text的文本内容。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 文本基线的偏移量。  默认值：0  从API version 20开始，支持[Resource](../../公共定义/基础类型定义/ts-types.md#resource)类型。 |
...
bindSelectionMenu的长按响应时长为600ms，[bindContextMenu](../../通用属性/弹窗控制/菜单控制/ts-universal-attributes-menu.md#bindcontextmenu8)的长按响应时长为800ms，当两者同时绑定且触发方式均为长按时，优先响应bindSelectionMenu。

自定义菜单超长时，建议内部嵌套使用[Scroll](../../滚动与滑动/Scroll/ts-container-scroll.md)组件，避免键盘被遮挡。
...
| content | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 选择菜单的内容。 |
...
| options | [SelectionMenuOptions](../RichEditor/ts-basic-components-richeditor.md#selectionmenuoptions) | 否 | 选择菜单的选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 文本选中手柄颜色。  默认值：'#007DFF' |
...
可以设置为数字翻牌动效[NumericTextTransition](../文本组件公共接口/ts-text-common.md#numerictexttransition20)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transition | Optional<[ContentTransition](../文本组件公共接口/ts-text-common.md#contenttransition20)> | 是 | 文本动效属性。 |
...
* 当Text组件包含子组件时，仅支持[Span](../Span/ts-basic-components-span.md)和[ImageSpan](../ImageSpan/ts-basic-components-imagespan.md)子组件向剪贴板中添加HTML格式的内容。
* 设置Text组件的属性字符串时，请参考属性字符串[toHtml](../属性字符串/ts-universal-styled-string.md#tohtml14)接口文档，以了解支持转换为HTML的范围。
...
此时Text会监听onClick事件，手势事件为非冒泡事件，若需要点击Text组件区域响应父组件的点击手势事件，建议在父组件上使用[parallelGesture](../../手势处理/绑定手势/绑定手势事件/ts-gesture-settings.md#parallelgesture)绑定手势识别，也可参考[示例7（设置文本识别）](ts-basic-components-text.md#示例7设置文本识别)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CopyOptions](../../公共定义/枚举说明/ts-appendix-enums.md#copyoptions9) | 是 | 组件是否支持文本可复制粘贴。  默认值：CopyOptions.None |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [DecorationStyleInterface12+](../属性字符串/ts-universal-styled-string.md#decorationstyleinterface) | 是 | 文本装饰线样式对象。  默认值：  {  type: TextDecorationType.None,  color: Color.Black,  style: TextDecorationStyle.SOLID  }  **说明：**  style参数不支持卡片能力。 |
...
不能和[onDragStart](../../通用事件/交互响应事件/拖拽事件/ts-universal-events-drag-drop.md#ondragstart)事件同时使用。

当draggable设置为true时，需配合[CopyOptions](../../公共定义/枚举说明/ts-appendix-enums.md#copyoptions9)使用，设置copyOptions为CopyOptions.InApp或者CopyOptions.LocalDevice，支持对选中文本的拖拽及复制到输入框。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [EllipsisMode](../../公共定义/枚举说明/ts-appendix-enums.md#ellipsismode11) | 是 | 省略位置。  默认值：EllipsisMode.END |
...
* 从API version 20开始，支持选中文本后识别实体，在文本选择菜单与鼠标右键菜单中显示对应菜单选项。菜单选项包括[TextMenuItemId](../文本组件公共接口/ts-text-common.md#textmenuitemid12)中的url（打开链接）、email（新建邮件）、phoneNumber（呼叫）、address（导航至该位置）、dateTime（新建日程提醒）。选中文本后识别实体弹出对应菜单选项，要求在选中范围内包括一个完整的AI实体，才能展示对应的选项。例如，实体是https://developer.huawei.com时，只选中com，菜单不会显示打开链接选项。
* 从API version 20开始，支持在文本选择菜单中显示“问问小艺”选项。当copyOption设置为CopyOptions.LocalDevice或CopyOptions.CROSS\_DEVICE(deprecated)时，选中文本后：
  ...
  + 如果enableDataDetector设置为true，此时选中范围内，恰好有一个AI实体，展示[TextMenuItemId](../文本组件公共接口/ts-text-common.md#textmenuitemid12)中的对应的选项，此时不显示问问小艺选项。
...
开启触控反馈时，需要在工程的[module.json5配置文件](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)中配置requestPermissions字段开启振动权限，配置如下：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 是 | 文本样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fontValue | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 是 | 设置文本样式。 |
| options | [FontSettingOptions](../文本组件公共接口/ts-text-common.md#fontsettingoptions12对象说明) | 否 | 设置字体配置项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 字体颜色。  默认值：'#e6182431'  Wearable设备上默认值为：'#c5ffffff' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 是 | 字体族。默认字体'HarmonyOS Sans'。  使用多个字体时，请用逗号','分隔，字体的优先级按顺序生效。例如：'Arial,HarmonyOS Sans'。 |
...
字体排版引擎会对开发者传入的宽度[width](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#width)进行向下取整，保证是整型像素后进行排版。如果向上取整，可能会出现文字右侧被截断。

当多个Text组件在[Row](../../行列与堆叠/Row/ts-container-row.md)容器内布局且没有设置具体的布局分配信息时，Text会以Row的最大尺寸进行布局。如果需要子组件主轴累加的尺寸不超过Row容器主轴的尺寸，可以设置[layoutWeight](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#layoutweight)或者是以[Flex](../../通用属性/布局与边框/Flex布局/ts-universal-attributes-flex-layout.md)布局来约束子组件的主轴尺寸。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/hOzy-A8qSoSh6RAhCojr1w/zh-cn_image_0000002622859641.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=C76A1E49EB73228BF485EFE31CA5E29B7E38C324DD88D91BABC73C1EF912CD3D)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 是 | 字体大小。fontSize为number类型时，使用fp单位。不支持设置百分比字符串。  默认值：16fp  Wearable设备上默认值为：15fp |
...
仅Text组件生效，其子组件不生效。常见问题参考[设置enableVariableFontWeight为true后字重不能跟随设置调节](../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发调试调优/UI开发常见问题/使用文本常见问题/arkts-text-faq.md#设置enablevariablefontweight为true后字重不能跟随设置调节)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| weight | number | [FontWeight](../../公共定义/枚举说明/ts-appendix-enums.md#fontweight) | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 设置文本字重。number类型取值[100, 900]，取值间隔为100，默认为400，取值越大，字体越粗。string类型仅支持number类型取值的字符串形式，例如"400"，以及"bold"、"bolder"、"lighter"、"regular"、"medium"，分别对应FontWeight中相应的枚举值。  从API version 20开始，支持[Resource](../../公共定义/基础类型定义/ts-types.md#resource)类型。 |
| options | [FontSettingOptions](../文本组件公共接口/ts-text-common.md#fontsettingoptions12对象说明) | 否 | 设置字体配置项。  当options的参数enableVariableFontWeight取值false时，禁用可变字重调节，weight取值为[100, 900]范围内的整百数值时，字重取值为weight。weight是非整百数值时，字重取默认值400。  当options的参数enableVariableFontWeight取值true时，启用可变字重调节，weight取值为[100, 900]范围内任意整数时，字重取值为weight。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 文本字符间距。  默认值：0  单位：[fp](../../公共定义/像素单位/ts-pixel-units.md#基本像素单位)  从API version 20开始，支持[Resource](../../公共定义/基础类型定义/ts-types.md#resource)类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 是 | 文本的文本行高。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[TextMarqueeOptions](ts-basic-components-text.md#textmarqueeoptions18对象说明)> | 是 | 当Text组件的textOverflow属性设置为MARQUEE时，可通过marqueeOptions设置跑马灯动效具体的属性，如开关、步长、循环次数、方向等。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | number | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 是 | 文本最大的字体缩放倍数。  取值范围：[1, +∞)  **说明：**  设置的值小于1时，按值为1处理，其余异常值默认不生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | undefined | 是 | 文本的最大行高，不支持百分比。  设置的值不大于0时按0处理，设置为0时，最大行高不受限制。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scale | number | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 是 | 文本最小的字体缩放倍数。  取值范围：[0, 1]  **说明：**  设置的值小于0时按0处理，大于1时按1处理，其余异常值默认不生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | undefined | 是 | 文本的最小行高，不支持百分比。  设置的值不大于0时按0处理。 |
...
如果文本设置了[constraintSize](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#constraintsize)，那么组件最后显示高度会在[constraintSize](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#constraintsize)约束内。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| minLines | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<number> | 是 | 文本最小行数。  取值范围：[0, INT32\_MAX]  设置的值小于0时按0处理。 |
...
当纯空格文本设置优化行尾空格[optimizeTrailingSpace](ts-basic-components-text.md#optimizetrailingspace20)为true时，不允许同时设置文本背景色[backgroundColor](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundcolor)、空格装饰线[decoration](ts-basic-components-text.md#decoration)和对齐[textAlign](ts-basic-components-text.md#textalign)三个属性。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| optimize | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否优化每行末尾的空格。  true表示优化末尾空格，false则不优化。  默认值：false |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| supported | boolean | 是 | 是否支持卡片敏感隐私信息。  默认值为false，当设置为true时，隐私模式下文字将被遮罩为横杠“-”样式。  **说明：**  设置为null则表示不敏感。  进入隐私模式需要卡片框架支持。隐私遮罩的类型可以通过[obscured](../../通用属性/基础属性/隐私遮罩/ts-universal-attributes-obscured.md#obscured)配置。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 文本选中底板颜色。  默认值：'#007DFF' |
...
当selectionStart或selectionEnd位于截断的不可见区域时，文本不选中。当[clip](../../通用属性/视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip12)设置为false时，超出父组件的文本可以被选中。
...
可以显示为径向渐变[RadialGradientStyle](../文本组件公共接口/ts-text-common.md#radialgradientstyle20)或线性渐变[LinearGradientStyle](../文本组件公共接口/ts-text-common.md#lineargradientstyle20)或纯色[ColorShaderStyle](../文本组件公共接口/ts-text-common.md#colorshaderstyle20)的效果，shaderStyle的优先级高于[fontColor](../SymbolSpan/ts-basic-components-symbolspan.md#fontcolor)和AI识别，纯色建议使用[fontColor](../SymbolSpan/ts-basic-components-symbolspan.md#fontcolor)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shader | [ShaderStyle](../文本组件公共接口/ts-text-common.md#shaderstyle20) | 是 | 径向渐变或线性渐变或纯色。  根据传入的参数区分处理径向渐变[RadialGradientStyle](../文本组件公共接口/ts-text-common.md#radialgradientstyle20)或线性渐变[LinearGradientStyle](../文本组件公共接口/ts-text-common.md#lineargradientstyle20)或纯色[ColorShaderStyle](../文本组件公共接口/ts-text-common.md#colorshaderstyle20)，最终设置到Text文本上显示为渐变色效果。  **说明：**  当设置为径向渐变[RadialGradientStyle](../文本组件公共接口/ts-text-common.md#radialgradientstyle20)时，若[RadialGradientOptions](../../通用属性/视效与模糊/颜色渐变/ts-universal-attributes-gradient-color.md#radialgradientoptions18对象说明)的center参数设置到组件范围外时，可将repeating参数设置为true，此时渐变效果会更明显。 |
...
可通过[align](../../通用属性/布局与边框/位置设置/ts-universal-attributes-location.md#align)属性控制文本段落在垂直方向上的位置，此组件中不可通过align属性控制文本段落在水平方向上的位置，具体效果如下：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextAlign](../../公共定义/枚举说明/ts-appendix-enums.md#textalign) | 是 | 文本段落在水平方向的对齐方式。  默认值：TextAlign.Start  Wearable设备上默认值为：TextAlign.Center |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextCase](../../公共定义/枚举说明/ts-appendix-enums.md#textcase) | 是 | 文本大小写。  默认值：TextCase.Normal |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| textContentAlign | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[TextContentAlign](../文本组件公共接口/ts-text-common.md#textcontentalign21)> | 是 | 文本段落在垂直方向的对齐方式。  默认(undefined和异常值情况下)和align属性设置为Center效果一致。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 首行文本缩进。  默认值：0  单位：[fp](../../公共定义/像素单位/ts-pixel-units.md#基本像素单位)  取值范围：大于等于0。设置负数时，按默认值处理。 |
...
* 从API version 11开始，建议优先组合[textOverflow](ts-basic-components-text.md#textoverflow)和[wordBreak](ts-basic-components-text.md#wordbreak11)属性来设置截断方式，具体详见[示例4（设置文本断行及折行）](ts-basic-components-text.md#示例4设置文本断行及折行)、[如何解决Text组件文本为中文、数字、英文混合时显示省略号截断异常的问题](../../../../../harmonyos-faqs/应用框架开发/UI框架/方舟UI框架（ArkUI）/如何解决Text组件文本为中文、数字、英文混合时显示省略号截断异常的问题/faqs-arkui-347.md)。
...
* Text组件[clip](../../通用属性/视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip12)属性默认为true。
* 属性字符串的[CustomSpan](../属性字符串/ts-universal-styled-string.md#customspan)不支持跑马灯模式。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [TextSelectableMode](../../公共定义/枚举说明/ts-appendix-enums.md#textselectablemode12) | 是 | 文本是否支持可选择、可获焦。  默认值：TextSelectableMode.SELECTABLE\_UNFOCUSABLE |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ShadowOptions](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadowoptions对象说明) | Array<[ShadowOptions](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadowoptions对象说明)>11+ | 是 | 文字阴影效果。 |
...
* 一个段落下使用同一字号必须同时设置行高[lineHeight](ts-basic-components-text.md#lineheight)或者同一个段落不同字号文本混排时才有效果差异，否则设置了该属性任意枚举值和未设置该属性都是一样的排版效果。属性字符串[TextStyle](../属性字符串/ts-universal-styled-string.md#textstyle)中的SuperscriptStyle上下角标样式仅在[TextVerticalAlign](../文本组件公共接口/ts-text-common.md#textverticalalign20)属性值为TextVerticalAlign.BASELINE时生效，其余垂直对齐方式下上下角标文本和普通文本表现一致，无上下角标效果。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| textVerticalAlign | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[TextVerticalAlign](../文本组件公共接口/ts-text-common.md#textverticalalign20)> | 是 | 文本段落在垂直方向的对齐方式。  默认值：TextVerticalAlign.BASELINE |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [WordBreak](../../公共定义/枚举说明/ts-appendix-enums.md#wordbreak11) | 是 | 断行规则。  默认值：WordBreak.BREAK\_WORD |

## TextSpanType11+枚举说明

PhonePC/2in1TabletTVWearable

[Span](../Span/ts-basic-components-span.md)类型信息。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| overflow7+ | [TextOverflow](../../公共定义/枚举说明/ts-appendix-enums.md#textoverflow) | 否 | 否 | 文本超长时的显示方式。  默认值：TextOverflow.Clip  **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [StyledString](../属性字符串/ts-universal-styled-string.md#styledstring) | 是 | 属性字符串。  **说明：**  StyledString的子类[MutableStyledString](../属性字符串/ts-universal-styled-string.md#mutablestyledstring)也可以作为入参值。 |

说明

多次调用setStyledString，会用新的入参覆盖已绑定的属性字符串，而不是叠加新的入参。

属性字符串通过controller绑定时，需要等待布局完成后，绑定生效。当[measure](<../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md#measure12>)和setStyledString同时使用，开发者需要通过[@ohos.arkui.inspector (布局回调)](<../../../ArkTS API/UI界面/@ohos.arkui.inspector (布局回调)/js-apis-arkui-inspector.md>)判断布局完成，再绑定属性字符串。
...
这一区别体现在[aboutToAppear](../../自定义组件/自定义组件的生命周期/ts-custom-component-lifecycle.md#abouttoappear)中设置属性字符串，API 14及以下版本不生效，API 15及以上版本生效，推荐用法请参考[创建并应用StyledString和MutableStyledString](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/使用文本/属性字符串（StyledStringMutableStyledString）/arkts-styled-string.md#创建并应用styledstring和mutablestyledstring>)。
...
| 类型 | 说明 |
| --- | --- |
| [LayoutManager](../文本组件公共接口/ts-text-common.md#layoutmanager12) | 布局管理器对象。 |
...
| options | [SelectionOptions](../输入框类组件通用接口/ts-universal-attributes-text-style.md#selectionoptions12对象说明) | 否 | 选中文字时的配置。  默认值：SelectionOptions中MenuPolicy.DEFAULT |
...
| spacing23+ | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | 两轮跑马灯之间的间距。如果LengthMetrics的unit值是PERCENT，当前设置不生效，按默认值处理。  默认值：48.0vp  **元服务API：** 从API version 23开始，该接口支持在元服务中使用。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/bmHtMZOVRXCaBcvNVZL9-Q/zh-cn_image_0000002622699761.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=8BE3E36F5806578BEF5655C0D2EFAE2FF4581E1786888DE223B158559B9C356E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/CJkiaPE-SaWviP61Dj6lpA/zh-cn_image_0000002592220200.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=C9F2A944017F8D9D3DF88017FB8A16ED49289FE670B52C23155389BCD478005C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/ivzJw0lDQ9awbHdiH3AJjA/zh-cn_image_0000002592380134.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=F74403E1BF5F1519EFC8BEDA799AE3F9A2B82EB91FAFA9A90BA4EE4141FFB13B)

### 示例4（设置文本断行及折行）

该示例通过[wordBreak](ts-basic-components-text.md#wordbreak11)（从API version 11开始）、[lineBreakStrategy](ts-basic-components-text.md#linebreakstrategy12)（从API version 12开始）、[clip](../../通用属性/视效与模糊/形状裁剪/ts-universal-attributes-sharp-clipping.md#clip12)属性展示了文本在不同断行、折行规则下的效果以及文本超长时是否截断。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/qD72AiEwQYS8589nvlFpNw/zh-cn_image_0000002622859643.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=2DA1844C0434C4630B9B590067113BF21EADC9E4E37C7A163A943E44AAA8EF32)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/YPfAVumVRAOPtsOdyUqcfQ/zh-cn_image_0000002622699763.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=603752E146919105EBD566FE86A968656A42CD5BB335DBE605C6283F6E4E5FEE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/SQNth7PjSzuthCGzruvWIw/zh-cn_image_0000002592220202.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=70FC5840A16B9692A2A11B29E25E408C7CADAA2C361E93AB232DAD4847197D49)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/i-UERBUmRTeQPfizQH0Ysg/zh-cn_image_0000002592380136.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=EABEBBA37828F5158ECFF3E41C023F97D8835A226829D9CFD906501AA71E1785)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/tla37d4kQh-FrDAtFeKCWw/zh-cn_image_0000002622859645.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=B90C04630B0C478E87C056DD13A7D10B4C864BBCEB09D2F535912E783EDD85DC)

### 示例9（设置文本特性与行间距）

从API version 12开始，该示例通过[fontFeature](ts-basic-components-text.md#fontfeature12)、[lineSpacing](ts-basic-components-text.md#linespacing12)接口展示了设置文本特性与行间距的效果，同时，配置[LineSpacingOptions](../文本组件公共接口/ts-text-common.md#linespacingoptions20对象说明)中的onlyBetweenLines（从API version 20开始）属性，可以设置文本的行间距，是否仅在行与行之间生效。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/sxYQQzzsTFGNxPWJysz0EA/zh-cn_image_0000002622699765.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=E938A59C92FA2AD5136FBC2A571A9D566FA1BE0B59DC8B636EF88DA1A4EE5E4B)

### 示例10（获取文本信息）

从API version 12开始，该示例通过[getLayoutManager](ts-basic-components-text.md#getlayoutmanager12)接口调用文本的布局管理对象获取文本信息，同时，[LayoutManager](../文本组件公共接口/ts-text-common.md#layoutmanager12)中的[getRectsForRange](../文本组件公共接口/ts-text-common.md#getrectsforrange14)（从API version 14开始）接口可以获取指定矩形宽度和高度下，文本中任意区间范围内字符或占位符的绘制区域信息。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b4/v3/iZzdN5nrQCeBSDkBR2wloQ/zh-cn_image_0000002592220204.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=4AFA8DC9178EB0BAE70778384968C3ED51D2FFC58D0E436D9C38C6698B174337)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/3aH9djIXRiODyHWHziOm0w/zh-cn_image_0000002592380138.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=CF504E035A0E6BAD08169535E78E2F06240CC91EF9641E38502B8D5F6F1CB3A0)

### 示例12（文本扩展自定义菜单）

从API version 12开始，该示例通过[editMenuOptions](ts-basic-components-text.md#editmenuoptions12)接口实现了文本设置自定义菜单扩展项的文本内容、图标以及回调的功能，同时，可以在[onPrepareMenu](../文本组件公共接口/ts-text-common.md#属性-1)（从API version 20开始）回调中，进行菜单数据的设置。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7c/v3/Kl1zqKmVRqiZfrCoTp5Ovg/zh-cn_image_0000002622859647.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=76E34AD900FD327AAC3E9D19875AD137C49B018575B3C0C59AEC384E40031A5B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/dWEh7j_hSuyefsN8y-V5lg/zh-cn_image_0000002622699767.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=F25F002CDD7D7D7D2DBBDB72F6AA9F8A1D90DD3AD8DAFD1756836AE781619113)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/t99BZpLJRBO5zvkxZ6yl_A/zh-cn_image_0000002592220206.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=7B9D6C9015AC5C921EBBE3DA98563B2B7567861927D3CC6297195F7B3002B557)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/TW0_WbouQEKmcDIdxASaqQ/zh-cn_image_0000002592380140.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=B8B977614BD1B4C1ED49A052020381CE325D2C2B68878988562921E31BCB5229)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/F4iG9VL_QmqnMQ6A9T3ZaA/zh-cn_image_0000002622859649.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=9376F116F6A51F9D1BB84C34BA06EA6374F96178B2162C3C51B28114E364DFA9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/In_71Q25Tc6LOV57YZcX9w/zh-cn_image_0000002622699769.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=7CF51D5CD24593429571DDE833FF8F9B78C9F38929576A9444335B80D0C7B988)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7/v3/EAeRvITvStWXrU8fNDD-zQ/zh-cn_image_0000002592220208.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=DF645D57399BDE4E2EE2384BC4E54CFB294A3D013BAE10638B79AB9BF4049CFE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/oppK4hFURZ2WScepfL3z7g/zh-cn_image_0000002592380142.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=9D3122CC12BE047668B404775EA87B8815685196726872F084D494796848AD2A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/1EZMths9TJaiw4R8pRo3IA/zh-cn_image_0000002622859651.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=4DD000D3E027EB6E58C344AF65A8AFC2E97FD2F2054CA6371E0B2D69D2829026)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/Xtjz-jURTjuOS4bPRGIzyQ/zh-cn_image_0000002622699771.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=6B1A2ABF2AD8BAD97FC1E2E0C9A3CA7CB135C8F56C948218627ECA66C2998034)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/NHZOwO4FSjmELICvZp_uBA/zh-cn_image_0000002592220210.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=C86AA2523D4B0C5590F11C1618721003C393C06A8C154CD5DCD45FA87E727DE0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/8JGttltUSlaQ7Kytwn_muQ/zh-cn_image_0000002592380144.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=CE8CF4807086EF2FF26B9EB4CFE67369B8A7743C2E2946510938C1F0FB324E9C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/_sSVKa1QQyO2oPVNoVQXKA/zh-cn_image_0000002622859653.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=30B83A32BF0CC8F7FBA085CF5474FE71B3F4DCC30043C387065B3480DDCF0981)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4/v3/zWn-zT6gQ_mSdrq6CO-yyw/zh-cn_image_0000002622699773.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=260845C1636DFEB9DF271080956B9B617BABE4675281620B3352EC989006ADF6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/tJtva180Q3aQKggBfGuHIA/zh-cn_image_0000002592220212.png?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=650096A7D0DEB96770FD56680F193816329578D2EB6DA242A6392DD491A5B139)

### 示例27（获取指定坐标和范围对应的文本信息）

从API version 24开始，支持[getCharacterPositionAtCoordinate](../文本组件公共接口/ts-text-common.md#getcharacterpositionatcoordinate24)，[getGlyphRangeForCharacterRange](../文本组件公共接口/ts-text-common.md#getglyphrangeforcharacterrange24)，[getCharacterRangeForGlyphRange](../文本组件公共接口/ts-text-common.md#getcharacterrangeforglyphrange24)接口。该示例通过[getLayoutManager](ts-basic-components-text.md#getlayoutmanager12)接口调用文本的布局管理对象获取文本信息，通过[LayoutManager](../文本组件公共接口/ts-text-common.md#layoutmanager12)中的[getCharacterPositionAtCoordinate](../文本组件公共接口/ts-text-common.md#getcharacterpositionatcoordinate24)获取坐标字符的位置信息，通过[getGlyphRangeForCharacterRange](../文本组件公共接口/ts-text-common.md#getglyphrangeforcharacterrange24)根据字符索引范围获取字形索引范围和实际的字符索引范围，通过[getCharacterRangeForGlyphRange](../文本组件公共接口/ts-text-common.md#getcharacterrangeforglyphrange24)根据字形索引范围获取字符索引范围和实际的字形索引范围。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1b/v3/2_1RfaWtSj2R1WC01oayBw/zh-cn_image_0000002592380146.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074711Z&HW-CC-Expire=86400&HW-CC-Sign=052C2D848405C8086F324DC4245E802C5082B2BFCEA587AF275E65F17404A3E8)
