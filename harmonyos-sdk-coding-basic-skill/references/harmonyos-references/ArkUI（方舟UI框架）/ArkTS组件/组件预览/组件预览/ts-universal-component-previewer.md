...
scraped_at: 2026-06-01T15:44:30+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:594fc21a15c39be9053c65e95d06c7a3695519f3edad682b32d3ac1a4658a689
---
...
组件预览详情，请查看[组件预览特性文档](../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发调试调优/UI预览/ui-ide-previewer.md#组件预览)。
...
| deviceType | string | 否 | 是 | 组件预览渲染的设备类型，默认为Phone。设备类型枚举值参考[deviceTypes标签](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md#devicetypes标签)。 |
