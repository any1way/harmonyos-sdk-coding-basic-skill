...
content_hash: sha256:c3be225828e4fe6c2153f2212e87ffdc7a295b7020db945ea049a67b3627b1a0
---
...
继承自[GestureInterface<T>](../../手势公共接口/ts-gesture-common.md#gestureinterfacet11)，设置捏合手势事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [PinchGestureHandlerOptions](../../绑定手势/手势处理器/ts-gesturehandler.md#pinchgesturehandleroptions) | 否 | 捏合手势处理器配置参数。 |
...
在[GestureEvent](../../手势公共接口/ts-gesture-common.md#gestureevent对象说明)的fingerList元素中，手指索引编号与位置相对应，即fingerList[index]的id为index。对于先按下但未参与当前手势触发的手指，fingerList中对应的位置为空。建议开发者优先使用fingerInfos。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | Callback<[GestureEvent](../../手势公共接口/ts-gesture-common.md#gestureevent对象说明)> | 是 | 手势事件回调函数。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/Tat5iwl5R--GBZDAtl_p_A/zh-cn_image_0000002622699609.png?HW-CC-KV=V1&HW-CC-Date=20260611T074532Z&HW-CC-Expire=86400&HW-CC-Sign=73D46BB619A10576FBDCB243B814BA18F55615150480B4D16315A1F919D7C391)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/9rzGuKmJSbWrihZFZZ4IsA/zh-cn_image_0000002592220048.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074532Z&HW-CC-Expire=86400&HW-CC-Sign=BF8F4C90A4D2CF6CB5A1AC35A5CBFD21AE784A15BB344E763DA237C153818640)
