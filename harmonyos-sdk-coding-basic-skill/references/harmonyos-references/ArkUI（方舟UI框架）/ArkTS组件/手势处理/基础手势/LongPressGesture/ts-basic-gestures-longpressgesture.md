...
scraped_at: 2026-06-11T15:45:32+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:67eb5d4f67087527ff00ae95f5ff05a95df6dde54c9a8d0aa040342526394985
---
...
创建长按手势对象。继承自[GestureInterface<T>](../../手势公共接口/ts-gesture-common.md#gestureinterfacet11)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [LongPressGestureHandlerOptions](../../绑定手势/手势处理器/ts-gesturehandler.md#longpressgesturehandleroptions) | 否 | 长按手势处理器配置参数。 |
...
* 长按手势触发后，[GestureEvent](../../手势公共接口/ts-gesture-common.md#gestureevent对象说明)中fingerList和fingerInfo的信息仅在有手指按下时才会更新，手指抬起时不会更新。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | (event: [GestureEvent](../../手势公共接口/ts-gesture-common.md#gestureevent对象说明)) => void | 是 | 长按手势识别成功回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | (event: [GestureEvent](../../手势公共接口/ts-gesture-common.md#gestureevent对象说明)) => void | 是 | 长按手势结束回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | Callback<[GestureEvent](../../手势公共接口/ts-gesture-common.md#gestureevent对象说明)> | 是 | 长按手势取消回调函数。 |

## 示例

PhonePC/2in1TabletTVWearable

该示例通过LongPressGesture实现了长按手势的识别。从API version 22开始，支持通过[LongPressGestureHandlerOptions](../../绑定手势/手势处理器/ts-gesturehandler.md#longpressgesturehandleroptions)的allowableMovement属性设置识别手势的最大移动距离。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/HKYVqhetQNaTV9GXaFtksA/zh-cn_image_0000002592220046.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074530Z&HW-CC-Expire=86400&HW-CC-Sign=5CC3EA260CB135D2CDDDD99587FD2AFF5BFED192964C0045F8A54123770FD8EF)
