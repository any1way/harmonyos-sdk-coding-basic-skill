...
scraped_at: 2026-06-11T15:45:31+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:1c6b20535776be7d2abf855096fb2e9556118c5349bb907ade43547e4c2224b2
---
支持单击、双击和多次点击事件的识别。
...
创建点击手势对象。继承自[GestureInterface<T>](../../手势公共接口/ts-gesture-common.md#gestureinterfacet11)。

触发点击手势事件的设备类型为键盘或手柄时，事件的[SourceTool](../../绑定手势/绑定手势事件/ts-gesture-settings.md#sourcetool枚举说明9)值为Unknown，事件的[SourceType](../../绑定手势/绑定手势事件/ts-gesture-settings.md#sourcetype枚举说明8)值为KEY，JOYSTICK。
...
点击手势参数。继承自[BaseHandlerOptions](../../绑定手势/手势处理器/ts-gesturehandler.md#basehandleroptions15)。
...
组件通过手势事件绑定不同GestureType的手势对象，各手势对象在响应手势操作的事件回调中提供手势相关信息。下面通过TapGesture手势对象的[onAction](ts-basic-gestures-tapgesture.md#onaction)事件响应点击事件，获取事件相关信息。其余手势对象的事件定义见各个手势对象章节。 若需绑定多种手势，请使用[GestureGroup](../../GestureGroup/ts-combined-gestures.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | (event: [GestureEvent](../../手势公共接口/ts-gesture-common.md#gestureevent对象说明)) => void | 是 | 手势事件回调函数。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/F6tRoa7yQwyn8dIs93t8Vw/zh-cn_image_0000002622859487.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074530Z&HW-CC-Expire=86400&HW-CC-Sign=C4CEA179A6C87EF8ECBC5CC4611931EB379BDEEADCBF91F4091F8350E89B39AE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7e/v3/tTiqHItrSk--rIHVcchEzw/zh-cn_image_0000002622699607.png?HW-CC-KV=V1&HW-CC-Date=20260611T074530Z&HW-CC-Expire=86400&HW-CC-Sign=956671BE0471BF4F758A8D3D627D2FB5AEF4120DAE3598C15AA8609FD077AD3B)
