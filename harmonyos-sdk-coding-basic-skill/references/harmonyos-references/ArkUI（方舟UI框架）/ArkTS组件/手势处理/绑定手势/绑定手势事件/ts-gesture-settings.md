...
scraped_at: 2026-06-11T15:45:26+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:08595cd8c5fc48ec3ea25e01ceaacf63e20cde7f86489267b2b210504918d453
---
...
* 可以通过gesture、priorityGesture和parallelGesture给组件绑定手势识别，手势识别成功后可以通过事件回调通知组件。可以通过[触摸热区](../../../通用属性/交互属性/触摸交互控制/触摸热区设置/ts-universal-attributes-touch-target.md)指定可识别手势的区域。gesture、priorityGesture和parallelGesture当前不支持使用三目运算符（条件? 表达式1 : 表达式2）切换手势绑定。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| gesture | [GestureType](../../手势公共接口/ts-gesture-common.md#gesturetype) | 是 | 绑定的手势类型。 |
| mask | [GestureMask](../../手势公共接口/ts-gesture-common.md#gesturemask枚举说明) | 否 | 事件响应设置。  默认值：GestureMask.Normal |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| gesture | [GestureType](../../手势公共接口/ts-gesture-common.md#gesturetype) | 是 | 绑定的手势对象。 |
| mask | [GestureMask](../../手势公共接口/ts-gesture-common.md#gesturemask枚举说明) | 否 | 事件响应设置。  默认值：GestureMask.Normal |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/jscRScrpR0yhJPsCuhVSpA/zh-cn_image_0000002592220044.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074525Z&HW-CC-Expire=86400&HW-CC-Sign=75F4333554F763EAA3B5E6D20F1C5BE42CBF6A81CFD07FC5A9DC571AB3CDCA81)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/tgdLP54BSSquJezsp7gO9Q/zh-cn_image_0000002592379978.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074525Z&HW-CC-Expire=86400&HW-CC-Sign=2465726D9AAE975E12E3C9A5F2DC23E645F121BF0CD96BBAB5130DFCDA747495)
