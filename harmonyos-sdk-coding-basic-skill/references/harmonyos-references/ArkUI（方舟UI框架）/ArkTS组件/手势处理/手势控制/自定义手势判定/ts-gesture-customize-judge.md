...
scraped_at: 2026-06-11T15:45:40+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:6d1a2664020f9b2afeed1efc1fcbf76ff43687a9fd52bf502c997f176e358278
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | (gestureInfo: [GestureInfo](../../手势公共接口/ts-gesture-common.md#gestureinfo11对象说明), event: [BaseGestureEvent](../../手势公共接口/ts-gesture-common.md#basegestureevent11对象说明)) => [GestureJudgeResult](../../手势公共接口/ts-gesture-common.md#gesturejudgeresult11) | 是 | 自定义手势判定回调。当手势即将成功时，触发用户定义的回调获取结果。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| target | [EventTarget](../../../通用事件/交互响应事件/点击事件/ts-universal-events-click.md#eventtarget8) | 否 | 否 | 触发手势事件的元素对象。  **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| source | [SourceType](../../绑定手势/绑定手势事件/ts-gesture-settings.md#sourcetype枚举说明8) | 否 | 否 | 事件输入设备的类型。  **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| sourceTool9+ | [SourceTool](../../绑定手势/绑定手势事件/ts-gesture-settings.md#sourcetool枚举说明9) | 否 | 否 | 事件输入源的类型。  **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/aPPgy5riSEmPm3u6aQgSpA/zh-cn_image_0000002592379984.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074539Z&HW-CC-Expire=86400&HW-CC-Sign=68917C02DA66F72AE213896CFDA54963118013A7DD4C64E56FEF953F8B2F55EB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/24/v3/vXaDbf-eQemvhBfaRwt1BQ/zh-cn_image_0000002622859493.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074539Z&HW-CC-Expire=86400&HW-CC-Sign=DAEBEDCC637C41254C5E9879BB5B93DFAF6871275F2826E9D89158EFFDE620B5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/Z6uwB42VTv2R5VP9tTeRpw/zh-cn_image_0000002622699613.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074539Z&HW-CC-Expire=86400&HW-CC-Sign=589ED9BCB10B3B8635519962AB1935EAF89CE5A0FEDAE4C2BD975FDABACC9ADC)
