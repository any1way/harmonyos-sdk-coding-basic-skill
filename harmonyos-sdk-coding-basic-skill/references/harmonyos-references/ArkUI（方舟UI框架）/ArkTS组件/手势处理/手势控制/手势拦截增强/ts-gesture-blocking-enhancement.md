...
scraped_at: 2026-06-11T15:45:41+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:2ed52bc13065c9c2114e638fe5d05797c597a14da7d22badccf8dcedb8bf9c66
---
...
提供系统内置手势与响应链上其他组件的手势设置并行关系的回调事件。此接口对应的C API接口为[setInnerGestureParallelTo](<../../../../C API/结构体/ArkUI_NativeGestureAPI_1/capi-arkui-nativemodule-arkui-nativegestureapi-1.md#setinnergestureparallelto>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| current | [GestureRecognizer](../../手势公共接口/ts-gesture-common.md#gesturerecognizer12) | 是 | 当前组件的系统内置手势识别器，当前版本只提供内置的[GestureType](../../手势公共接口/ts-gesture-common.md#gesturetype11).PAN\_GESTURE类型的手势识别器。 |
| others | Array<[GestureRecognizer](../../手势公共接口/ts-gesture-common.md#gesturerecognizer12)> | 是 | 响应链上更高优先级的其他组件相同类别的手势识别器。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [GestureRecognizer](../../手势公共接口/ts-gesture-common.md#gesturerecognizer12) | 与current识别器绑定并行关系的某个手势识别器。 |
...
| exposeInnerGesture | boolean | 是 | 暴露内部手势标识。  默认值：false  **说明：**  如果是组合组件，此参数设置true，回调中的current参数则会包含组合组件内部的手势识别器。  当前仅支持[Tabs](../../../导航与切换/Tabs/ts-container-tabs.md)，其他组件请不要设置此参数。  设置为false时，功能与原接口[onGestureRecognizerJudgeBegin](ts-gesture-blocking-enhancement.md#ongesturerecognizerjudgebegin)相同。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [BaseGestureEvent](../../手势公共接口/ts-gesture-common.md#basegestureevent11对象说明) | 是 | 当前基础手势事件信息。 |
| current | [GestureRecognizer](../../手势公共接口/ts-gesture-common.md#gesturerecognizer12) | 是 | 当前即将要响应的识别器对象。 |
| recognizers | Array<[GestureRecognizer](../../手势公共接口/ts-gesture-common.md#gesturerecognizer12)> | 是 | 响应链上的其他手势识别器对象。 |
| touchRecognizers20+ | Array<[TouchRecognizer](../../手势公共接口/ts-gesture-common.md#touchrecognizer20)> | 否 | 响应链上的Touch识别器对象。 默认值为null，表示在当前手势绑定组件及其子孙组件没有可响应的Touch识别器。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [GestureJudgeResult](../../手势公共接口/ts-gesture-common.md#gesturejudgeresult11) | 手势是否裁决成功的判定结果。 |
...
提供在[触摸测试](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/交互基础机制说明/arkts-interaction-basic-principles.md#触摸测试>)结束后，指定手势识别器是否参与后续处理的能力。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [TouchTestDoneCallback](ts-gesture-blocking-enhancement.md#touchtestdonecallback20) | 是 | 回调函数，用于指定手势识别器是否参与后续处理。在[触摸测试](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/交互基础机制说明/arkts-interaction-basic-principles.md#触摸测试>)结束后，开始识别用户手势之前，会触发该回调来动态指定手势识别器是否参与后续处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [BaseGestureEvent](../../手势公共接口/ts-gesture-common.md#basegestureevent11对象说明) | 是 | [触摸测试](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/交互基础机制说明/arkts-interaction-basic-principles.md#触摸测试>)结束后的基础手势事件的信息。  **说明：**  仅包含BaseGestureEvent的信息，不包含其子类拓展信息。  axisHorizontal和axisVertical的值为0。 |
| recognizers | Array<[GestureRecognizer](../../手势公共接口/ts-gesture-common.md#gesturerecognizer12)> | 是 | [触摸测试](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/交互基础机制说明/arkts-interaction-basic-principles.md#触摸测试>)结束后，所有手势识别器对象。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0e/v3/7IFt2JBqRPG0BfntrJDezw/zh-cn_image_0000002592220052.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074539Z&HW-CC-Expire=86400&HW-CC-Sign=823E15F26460684ABDFEA899ACE518530C7BC61F86227E630B49BB44021CC5EF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8e/v3/Mte3T9KDSa2VbKTr_AwXhg/zh-cn_image_0000002592379986.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074539Z&HW-CC-Expire=86400&HW-CC-Sign=C45D3D3FC3E7CA31EFE43EECDCDBDFA16CA9691543276A9B68958271B0D7634C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/18/v3/EfhTG_UYTFe3XcoU91LG6A/zh-cn_image_0000002622859495.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074539Z&HW-CC-Expire=86400&HW-CC-Sign=A483B4D4527BC32F3A1AC47FF0F8278DB68C3AB13CB45692E7C0D187C7D569F6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/ZEC9sDxvTHCTTgZ0_urmJA/zh-cn_image_0000002622699615.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074539Z&HW-CC-Expire=86400&HW-CC-Sign=09C26BEEC8BB51BFCEF44CDCD69C03182D684FE739F34ACADE7D9864091C85E9)

### 示例5（自定义手势识别器是否参与手势处理）

从API version 20开始，该示例通过配置[onTouchTestDone](ts-gesture-blocking-enhancement.md#ontouchtestdone20)指定手势识别器不参与后续手势处理，触发回调时，调用[preventBegin](../../手势公共接口/ts-gesture-common.md#preventbegin20)阻止手势识别器参与后续处理。点击Tap2和Tap1的重合区域，不调用preventBegin时，触发Tap2对应的手势；调用preventBegin阻止Tap2时，触发Tap1对应的手势。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/cKmwmfPFQnKISH80SDVs7Q/zh-cn_image_0000002592220054.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074539Z&HW-CC-Expire=86400&HW-CC-Sign=829FD6B217C03B151D88C6C4CAF2551598346FC142A309FB40BF79587A4C69F1)
