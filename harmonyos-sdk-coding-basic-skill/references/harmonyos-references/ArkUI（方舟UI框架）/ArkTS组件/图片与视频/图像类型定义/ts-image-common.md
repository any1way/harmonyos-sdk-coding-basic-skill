...
scraped_at: 2026-06-01T15:42:46+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:85dc6d37ab9b33085edbf3acaea1a4e36b1dae7277f3ee4fc7bd2dfa5dbc3f2b
---
说明
...
| 类型 | 说明 |
| --- | --- |
| [PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 图像像素类，用于读取或写入图像数据以及获取图像信息。 |
...
该特性依赖设备能力，且需要和对应组件的[enableAnalyzer](../Image/ts-basic-components-image.md#enableanalyzer11)接口（例如[Image组件](../Image/ts-basic-components-image.md)）搭配使用。
