...
scraped_at: 2026-06-11T15:47:55+08:00
doc_updated_at: 2026-04-10
content_hash: sha256:e38d93027918e483aa540a79f6d75809bcdd2f6623fe6b55eb922d14516034e6
---
...
| selected7+ | number | 否 | 否 | 初始选中项索引值，若超出索引值范围，则取默认值0。与[selected](ts-container-alphabet-indexer.md#selected8)属性同时设置时，selected属性的优先级较高。  取值范围：[0, arrayValue.length-1]  该属性支持[$$](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)双向绑定变量。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |

## 属性

PhonePC/2in1TabletTVWearable

[width](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#width)属性设置"auto"时表示自适应宽度，宽度会随索引项最大宽度变化。

[padding](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#padding)属性默认为4vp。

文本最大的字体缩放倍数[maxFontScale](../../文本与输入/Text/ts-basic-components-text.md#maxfontscale12)和最小的字体缩放倍数[minFontScale](../../文本与输入/Text/ts-basic-components-text.md#minfontscale12)皆为1，不跟随系统字体大小调节变化。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 未选中项文本颜色。  默认值：0x99182431，显示为略带透明的棕色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 选中项文本颜色。  默认值：0xFF007DFF，显示为蓝色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 提示弹窗一级索引项文本颜色。  默认值：0xFF007DFF，显示为蓝色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 选中项背景颜色。  默认值：0x1A007DFF，显示为半透明的蓝绿色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 提示弹窗背景颜色。  弹窗的背景模糊材质效果会对背景色产生影响，可通过设置[popupBackgroundBlurStyle](ts-container-alphabet-indexer.md#popupbackgroundblurstyle12)属性值为NONE关闭背景模糊材质效果。  默认值：  API version 11及以前：0xFFFFFFFF，显示为白色。  API version 12及以后：#66808080，显示为半透明的灰色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 是 | 选中项文本样式。  默认值：  API version 11及以前：  {  size:'12.0fp',  style:FontStyle.Normal,  weight:FontWeight.Regular,  family:'HarmonyOS Sans'  }  API version 12及以后：  {  size:'10.0vp',  style:FontStyle.Normal,  weight:FontWeight.Medium,  family:'HarmonyOS Sans'  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 是 | 提示弹窗一级索引文本样式。  默认值：  {  size:'24.0vp',  style:FontStyle.Normal,  weight:FontWeight.Medium,  family:'HarmonyOS Sans'  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 是 | 未选中索引项文本样式。  默认值：  API version 11及以前：  {  size:'12.0fp',  style:FontStyle.Normal,  weight:FontWeight.Regular,  family:'HarmonyOS Sans'  }  API version 12及以后：  {  size:'10.0vp',  style:FontStyle.Normal,  weight:FontWeight.Medium,  family:'HarmonyOS Sans'  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | number | 是 | 索引项区域大小，索引项区域为正方形，即正方形边长。不支持设置为百分比。  实际取值会受到组件尺寸的约束，索引项宽度最大为组件宽度-左右[padding](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#padding)，索引项高度最大为（组件高度-上下[padding](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#padding)）/索引项个数。传入值小于等于0时，按照默认值处理。  默认值：16.0  单位：vp |
...
| offset10+ | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 提示弹窗与索引条之间间距，大于等于0为有效值，在不设置或设置为小于0的情况下间距与popupPosition.x相同。与[popupPosition](ts-container-alphabet-indexer.md#popupposition8)同时设置时，水平方向上offset生效，竖直方向上popupPosition.y生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Position](../../公共定义/基础类型定义/ts-types.md#position) | 是 | 弹出窗口相对于索引条上边框中点的位置。  默认值：{x: 60.0, y: 48.0} |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 提示弹窗二级索引选中项文本颜色。  默认值：#FF182431，显示为深暗蓝色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 提示弹窗二级索引未选中项文本颜色。  默认值：#FF182431，显示为深暗蓝色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 是 | 提示弹窗二级索引项文本样式。  默认值：  {  size:24,  weight:FontWeight.Medium  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 提示弹窗二级索引项背景颜色。  默认值：  API version 11及以前：#FFFFFFFF，显示为白色。  API version 12及以后：#00000000，显示为透明色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BlurStyle](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#blurstyle9) | 是 | 设置提示弹窗的背景模糊材质。  弹窗的背景模糊材质效果会对背景色[popupBackground](ts-container-alphabet-indexer.md#popupbackground)产生影响，可通过设置属性值为NONE关闭背景模糊材质效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 设置提示弹窗一级索引项背景颜色。  默认值：  提示弹窗只有一个索引项：#00FFFFFF。  提示弹窗有多个索引项：#0c182431。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | boolean | 是 | 是否支持触控反馈。  true：支持触控反馈。  false：不支持触控反馈。  默认值：true  开启触控反馈时，需要在工程的[module.json5](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)中配置requestPermissions字段开启振动权限，配置如下：  "requestPermissions": [{"name": "ohos.permission.VIBRATE"}] |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/41/v3/2lKSndKsTPycS6alFnnnbg/zh-cn_image_0000002622859811.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074753Z&HW-CC-Expire=86400&HW-CC-Sign=8921109128A9AE99B24D9D09A360B52171637CAD34A4EC6B9288A699FB33193E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0/v3/WvojN6rXSoumcRX4uZ7TjA/zh-cn_image_0000002622699929.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074753Z&HW-CC-Expire=86400&HW-CC-Sign=471022C859178432A02314F263160F8340BE759C049F43C20C9C1BF825EEEDFC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/_VpybDRBRS6mCE51LUy1UQ/zh-cn_image_0000002592220368.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074753Z&HW-CC-Expire=86400&HW-CC-Sign=2D13D2B71C79793BDB9745E31D4C6F01174E767D75AD8A462B249CED6483863F)
