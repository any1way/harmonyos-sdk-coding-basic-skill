...
scraped_at: 2026-06-11T15:48:03+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:5409e9041a7e424dd48082dc0db12320814992953496a1c4397a2aa1fad99dff
---
...
* 如果开发者有其他功能需求，可以使用[自定义组件](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/自定义组件/创建自定义组件/arkts-create-custom-components.md>)。例如自定义组件[CustomPatternLock](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/master/ArkUISample/CustomPatternLock)，通过[Canvas](../../画布绘制/Canvas/ts-components-canvas-canvas.md)组件实现了图案密码锁功能，开发者可在此基础上自行进行功能扩展。
...
PatternLock组件设置了通用属性宽高比[aspectRatio](../../通用属性/布局与边框/布局约束/ts-universal-attributes-layout-constraints.md#aspectratio)，且不等于1时（组件尺寸被设定为长方形），九宫格依然绘制为正方形（超出组件范围）。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 组件的宽度和高度。默认值：288vp |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 宫格中圆点的半径。  默认值：6vp  取值范围：(0, sideLength/11]。设置小于等于0的值时，按默认值处理；超过最大值时，按最大值处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 背景颜色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 宫格圆点在“未选中”状态的填充颜色。  默认值：'#ff182431' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 宫格圆点在“选中”状态的填充颜色。  默认值：'#ff182431' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 宫格圆点在“激活”状态的填充颜色。  默认值：'#ff182431' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 连线的颜色。  默认值：'#33182431' |
...
onDotConnect(callback: [Callback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<number>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](<../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<number> | 是 | 密码输入选中宫格圆点时触发该回调。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 背景圆环颜色。  默认值：'#33182431'。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| radius | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | 背景圆环的半径。  默认值：[circleRadius](ts-basic-components-patternlock.md#circleradius)的1.833倍（即11/6）。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/O33FZt01RZGue3U25OPEVQ/zh-cn_image_0000002622699941.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074802Z&HW-CC-Expire=86400&HW-CC-Sign=29AF336C1EFC3FC2CE5EA58346F9667536B05AEC07B70735D2E1144903B14EBA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/3e7f5DQgQHG4UeW_j4CCCA/zh-cn_image_0000002592220380.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074802Z&HW-CC-Expire=86400&HW-CC-Sign=44A86775AD59C0A2BC1947B0F972D1DCAFA937E7BFBEDC827C49C38DEBA240E5)
