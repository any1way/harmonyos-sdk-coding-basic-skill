...
scraped_at: 2026-06-11T15:48:07+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:cad5215d6fd82f53162ac0bf97d4caff9afabc95e09f48324c237a3ecef8bc4f
---
TextClock组件通过文本将当前系统时间显示在设备上。支持不同时区的时间显示，最高精度到秒级。

组件不可见时，时间变动将停止。组件的可见状态基于[onVisibleAreaChange](../../通用事件/组件变化事件/组件可见区域变化事件/ts-universal-component-visible-area-change-event.md#onvisibleareachange)处理，可见阈值ratios大于0即视为可见状态。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 显示时间格式。  从API version 20开始，支持Resource类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 字体颜色。  Wearable设备上默认值：'#c5ffffff'，其他设备默认值：'e6182431' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 字体大小。fontSize为number类型时，使用fp单位。字体默认大小16fp。不支持设置百分比字符串。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [FontStyle](../../公共定义/枚举说明/ts-appendix-enums.md#fontstyle) | 是 | 字体样式。  默认值：FontStyle.Normal，表示标准的字体样式（非斜体）。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [FontWeight](../../公共定义/枚举说明/ts-appendix-enums.md#fontweight) | string | 是 | 文本的字体粗细，number类型取值范围为[100, 900]，取值间隔为100，取值越大，字体越粗。number类型取值范围外的默认值为400。string类型仅支持number类型取值的字符串形式，例如"400"，以及"bold"、"bolder"、"lighter"、"regular"、"medium"，分别对应FontWeight中相应的枚举值。  默认值：FontWeight.Normal |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 字体列表。默认字体'HarmonyOS Sans'。  应用当前支持'HarmonyOS Sans'字体和[注册自定义字体](<../../../ArkTS API/UI界面/@ohos.font (注册自定义字体)/js-apis-font.md>)。  卡片当前仅支持'HarmonyOS Sans'字体。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ShadowOptions](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadowoptions对象说明) | Array<[ShadowOptions](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadowoptions对象说明)> | 是 | 文字的字体阴影效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [ContentModifier](../../通用属性/动态属性与自定义/自定义内容/ts-universal-attributes-content-modifier.md#contentmodifiert)<[TextClockConfiguration](ts-basic-components-textclock.md#textclockconfiguration12对象说明)> | 是 | 在TextClock组件上，定制内容区的方法。  modifier： 内容修改器，开发者需要自定义class实现ContentModifier接口。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dateTimeOptions | Optional<[DateTimeOptions](<../../../../Localization Kit（本地化开发服务）/ArkTS API/@ohos.intl (国际化-Intl)/js-apis-intl.md#datetimeoptionsdeprecated>)> | 是 | 设置小时是否显示前导0，只支持设置hour参数，参数值为{hour: "2-digit"}时表示显示前导0，参数值为{hour: "numeric"}时表示不显示前导0。  默认值：undefined，默认状态下，24小时制显示前导0，12小时制不显示前导0。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8e/v3/5HcgKVVTSkm_NM_hL_kUhg/zh-cn_image_0000002592220386.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074806Z&HW-CC-Expire=86400&HW-CC-Sign=C2DFF4C0728BEC0E967C0893F44EB686F8ABDE20C3100798EF9E24B5B0DADEF5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/Gj5TTmUwSXuM9jk-Q9bPOA/zh-cn_image_0000002592380320.png?HW-CC-KV=V1&HW-CC-Date=20260611T074806Z&HW-CC-Expire=86400&HW-CC-Sign=9557DD351724E574437A54A01FBAE18A50A61D101387B3B94506557BAFB530E2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/QExujtphQTyCM8-_osEAbw/zh-cn_image_0000002622859831.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074806Z&HW-CC-Expire=86400&HW-CC-Sign=B24ED9CFB01C923A3F91602C0E878D76F50E08A594DEC97AFE40C148659D7422)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/lIqH2__OQHe0exZzldcm2Q/zh-cn_image_0000002622699949.png?HW-CC-KV=V1&HW-CC-Date=20260611T074806Z&HW-CC-Expire=86400&HW-CC-Sign=00AAF05EACB83D1F7AC1F6C1DCD406DEE0E63B8AC1B8924FAB4AF4FD6983D12D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/96urIaQbQXm5LC5f_W2XGA/zh-cn_image_0000002592220388.png?HW-CC-KV=V1&HW-CC-Date=20260611T074806Z&HW-CC-Expire=86400&HW-CC-Sign=8515C487956355953ED29180A8A24033299FF764B069E30A44C97A11AA12757B)
