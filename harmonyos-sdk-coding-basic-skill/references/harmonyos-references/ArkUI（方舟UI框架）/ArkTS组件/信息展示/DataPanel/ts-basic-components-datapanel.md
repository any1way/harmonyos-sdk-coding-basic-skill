...
scraped_at: 2026-06-11T15:47:59+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:7f2c4f435789ae60ad66c3a12331949a5e47d343d9799979e167a4c589de931c
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 底板颜色。  默认值：'#08182431'，格式为十六进制ARGB值，前两位代表透明度。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 圆环粗细。  默认值：24  单位：vp  设置字符串类型参数时，如果不指定单位，默认单位为px，例如'10'，等同于'10px'。  **说明：**  设置小于0的值时，按默认值显示。  请合理设置圆环粗细，当value大于圆环半径时，圆环粗细会自动设置为圆环半径的12%。如果value过大，圆环可能会消失。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [ContentModifier](../../通用属性/动态属性与自定义/自定义内容/ts-universal-attributes-content-modifier.md#contentmodifiert)<[DataPanelConfiguration](ts-basic-components-datapanel.md#datapanelconfiguration12对象说明)> | 是 | 在DataPanel组件上，定制内容区的方法。  modifier：内容修改器，开发者需要自定义class实现ContentModifier接口。 |

## DataPanelShadowOptions10+对象说明

PhonePC/2in1TabletTVWearable

DataPanelShadowOptions继承自[MultiShadowOptions](../信息展示公共接口/ts-information-display-common.md#multishadowoptions)，具有MultiShadowOptions的全部属性。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| colors | Array<[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | [LinearGradient](ts-basic-components-datapanel.md#lineargradient10)> | 否 | 是 | 各数据段投影的颜色。  默认值：与valueColors值相同  **说明：**  若设置的投影颜色的个数少于数据段个数时，则显示的投影颜色的个数和设置的投影颜色个数一致。  若设置的投影颜色的个数多于数据段个数时，则显示的投影颜色的个数和数据段个数一致。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 否 | 渐变色断点处的颜色值。 |
| offset | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 否 | 渐变色断点（0~1之间的比例值，若数据值小于0则置为0，若数据值大于1则置为1）。  **说明：**  若传入字符串类型且内容为数字，则转换为对应的数值。  例如'10vp'转换为10，'10%'转换为0.1。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/uqq99dVZRHi3pemyJBwXHg/zh-cn_image_0000002622859815.png?HW-CC-KV=V1&HW-CC-Date=20260611T074757Z&HW-CC-Expire=86400&HW-CC-Sign=E57E22BBD4263BC37C480C9EFB70BC7D436F583C7066BCC1008C284C0E3C9B67)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/v9j0BiqvSM-K5G7bRq5O3A/zh-cn_image_0000002622699933.png?HW-CC-KV=V1&HW-CC-Date=20260611T074757Z&HW-CC-Expire=86400&HW-CC-Sign=244FF0E36C0798170B0D6E99A260406D0063FFE62D2FB4BAC912B268E581875D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/36/v3/nKZlcDF9TRmwxOZz_y0Xug/zh-cn_image_0000002592220372.png?HW-CC-KV=V1&HW-CC-Date=20260611T074757Z&HW-CC-Expire=86400&HW-CC-Sign=EB38AB6FE575B675AAAB9A552B59BAE9F048D9D8ADFA9CB6883E575E0D942DD6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/0wTYeFbcQpeaNNVueAph5Q/zh-cn_image_0000002592380306.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T074757Z&HW-CC-Expire=86400&HW-CC-Sign=E24B39F670185EDCDA35360974E96733C2102CC1D6EE5C74231FD2AC18BBC6FF)
