...
scraped_at: 2026-06-11T15:48:05+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:1c6dd2895e7a8f9c6d7375357c5c0d17df6810c6e010c49f0c4ba9e9e68959b1
---
...
该组件重写了通用属性[backgroundColor](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#backgroundcolor)，直接添加在Progress组件上，设置进度条的底色。如需设置整个Progress组件的背景色，需要在外层容器上添加backgroundColor，并用该容器包裹Progress组件。
...
从API version 10开始支持利用[LinearGradient](../DataPanel/ts-basic-components-datapanel.md#lineargradient10)设置Ring样式的渐变色。Ring类型不建议设置透明度，如需设置透明度，建议使用[DataPanel](../DataPanel/ts-basic-components-datapanel.md)。

从API version 23开始支持利用[LinearGradient](../DataPanel/ts-basic-components-datapanel.md#lineargradient10)设置Linear样式和Capsule样式的渐变色。API version 22及之前版本利用LinearGradient设置Linear样式和Capsule样式的渐变色时，会以默认主题色显示。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | [LinearGradient](../DataPanel/ts-basic-components-datapanel.md#lineargradient10) | 是 | 进度条前景色。  默认值：  - Capsule：  API version 9及以下：'#ff007dff'  API version 10：'#33006cde'  API version 11及以上：'#33007dff'  - Ring：  API version 9及以下：'#ff007dff'  API version 10及以上：起始端：'#ff86c1ff'，结束端：'#ff254ff7'  - 其他样式：'#ff007dff' |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [ContentModifier](../../通用属性/动态属性与自定义/自定义内容/ts-universal-attributes-content-modifier.md#contentmodifiert)<[ProgressConfiguration](ts-basic-components-progress.md#progressconfiguration12)> | 是 | 在progress组件上，定制内容区的方法。  modifier： 内容修改器，开发者需要自定义class实现ContentModifier接口。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isPrivacySensitiveMode | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 设置隐私敏感，隐私模式下进度清零，文字将被遮罩。true：打开隐私敏感；false：关闭隐私敏感。  默认值：false  **说明：**  设置null表示不敏感。 |

## ProgressConfiguration12+

PhonePC/2in1TabletTVWearable

进度条配置。继承自[CommonConfiguration](../../通用属性/动态属性与自定义/自定义内容/ts-universal-attributes-content-modifier.md#commonconfigurationt)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| strokeWidth | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置进度条宽度（不支持百分比设置）。  默认值：4.0vp  超出取值范围按默认值处理。 |
| scaleCount | number | 否 | 是 | 设置环形进度条总刻度数。  默认值：120vp  取值范围：[2, min(width, height)/scaleWidth/2/π]，超出取值范围时，样式显示为环形无刻度进度条。默认情况下宽高最小为77vp。 |
| scaleWidth | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置环形进度条刻度粗细（不支持百分比设置）。刻度粗细大于进度条宽度时，为系统默认粗细。  默认值：2.0vp |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| borderColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 内描边颜色。  默认值：  API version 10：'#33006cde'  API version 11及以上：'#33007dff' |
| borderWidth | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 内描边宽度（不支持百分比设置）。  默认值：1vp |
| content | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 文本内容，应用可自定义。  从API version 20开始，支持Resource类型。 |
| font | [Font](../../公共定义/基础类型定义/ts-types.md#font) | 否 | 是 | 文本样式。  默认值：  文本大小（不支持百分比设置）：12fp  其他文本参数跟随[Text](../../文本与输入/Text/ts-basic-components-text.md)组件的主题值。 |
| fontColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 是 | 文本颜色。  默认值：'#ff182431' |
...
| borderRadius18+ | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | Capsule进度条圆角半径（不支持百分比设置）。  取值范围：[0, height/2]。默认值：height / 2。  设置非法数值时，按照默认值处理。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| strokeWidth | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置进度条宽度（不支持百分比设置）。当宽度大于等于半径时，宽度默认修改为半径值的二分之一。  默认值：4.0vp |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| strokeWidth | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 设置进度条宽度（不支持百分比设置）。  默认值：4.0vp |
| strokeRadius | [PX](../../公共定义/基础类型定义/ts-types.md#px10) | [VP](../../公共定义/基础类型定义/ts-types.md#vp10) | [LPX](../../公共定义/基础类型定义/ts-types.md#lpx10) | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 是 | 设置线性进度条的圆角半径。  取值范围[0, strokeWidth / 2]。默认值：strokeWidth / 2。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fd/v3/4qrzoEcFS8Ox4BdqwBDhpw/zh-cn_image_0000002592380314.png?HW-CC-KV=V1&HW-CC-Date=20260611T074803Z&HW-CC-Expire=86400&HW-CC-Sign=D09907DDB11D222384B837B247D69CCAC5D1088350A8BCF42656D37C4F7A7C26)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/uoH-x1KHSdSzi7Uk6_501A/zh-cn_image_0000002622859825.png?HW-CC-KV=V1&HW-CC-Date=20260611T074803Z&HW-CC-Expire=86400&HW-CC-Sign=CCA2BE5219BF5E5CCAEA89D36371B95EBEF181C4B831C489815FC7F5E0CCB9EB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/8S3XH06QTx6jwEnCfs0vyw/zh-cn_image_0000002622699943.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074803Z&HW-CC-Expire=86400&HW-CC-Sign=A6BE152CFA30F434CE6CEE1764F0CA58FC18221AD74DB38BFD0BA555DDDC8514)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/Hi-rQSKdQ0yB_ATgDefKIA/zh-cn_image_0000002592220382.png?HW-CC-KV=V1&HW-CC-Date=20260611T074803Z&HW-CC-Expire=86400&HW-CC-Sign=88C383219F4F2F0E7078F2F4559218A400098626DB0934D9912A13862FC8AF93)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/pNOOzwovQ52eL2EoTZKOEA/zh-cn_image_0000002592380316.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074803Z&HW-CC-Expire=86400&HW-CC-Sign=DFFF66C83F453E00400EE5FF6A11A4AC8B075F247337B676983EF38E42148ADD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b8/v3/qEibdjAZSzmTqx3r3XThxw/zh-cn_image_0000002622859827.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074803Z&HW-CC-Expire=86400&HW-CC-Sign=9EED225DA05C3A01B502FA60752FC934902ADB09AAA5857A88E5ABB800771EB1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/FBcgnVqVT5Wj3s7aF7FFLw/zh-cn_image_0000002622699945.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074803Z&HW-CC-Expire=86400&HW-CC-Sign=06A65CD56EA29248E8E23F05C7CE2A543F7057FD873EBCB6FB40133651263941)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8f/v3/bDvCSB8zSfq658vvrmdKoA/zh-cn_image_0000002592220384.png?HW-CC-KV=V1&HW-CC-Date=20260611T074803Z&HW-CC-Expire=86400&HW-CC-Sign=B315659FA3300ADFC909ECF68286D3FDDDF383AC1E44EA2D5E3CB1B534AF6B34)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/wRpgDc6vRZGe2u0NbpMxWw/zh-cn_image_0000002592380318.png?HW-CC-KV=V1&HW-CC-Date=20260611T074803Z&HW-CC-Expire=86400&HW-CC-Sign=A091604240457FB8CD65211736B7EE903EAA3D3F764F0F6CC52F6666241586CD)
