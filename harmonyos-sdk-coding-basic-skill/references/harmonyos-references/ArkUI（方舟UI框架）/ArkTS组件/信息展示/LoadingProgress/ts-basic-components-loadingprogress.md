...
scraped_at: 2026-06-11T15:48:01+08:00
doc_updated_at: 2026-03-23
content_hash: sha256:5568387e86950b19c234b1231e6ca30e478da1fcddd192707f229475b0cb303b
---
用于显示加载动效的组件。

加载动效在组件不可见时停止，组件的可见状态基于[onVisibleAreaChange](../../通用事件/组件变化事件/组件可见区域变化事件/ts-universal-component-visible-area-change-event.md#onvisibleareachange)处理，可见阈值ratios大于0即视为可见状态。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 加载进度条的前景色。  默认值：  API version 10及以下：'#99666666'  API version 11及以上：'#ff666666' |
...
设置LoadingProgress动画是否显示。LoadingProgress动画不显示时，该组件依旧占位。通用属性[Visibility](../../公共定义/枚举说明/ts-appendix-enums.md#visibility).Hidden隐藏的是包括[border](../../通用属性/布局与边框/边框设置/ts-universal-attributes-border.md#border)、[padding](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#padding)等整个组件范围，而enableLoading=false只隐藏LoadingProgress本身动画内容，不包括border等。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/X3QyCoPyRXaR0Y5QbBol3w/zh-cn_image_0000002592220378.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074800Z&HW-CC-Expire=86400&HW-CC-Sign=DC42EC3A4858F651518C0ACA7624B9D5EF69821D62ED285DBBB7541199FE7215)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/UehmRmgwQgqUBalJpZrIYw/zh-cn_image_0000002592380312.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074800Z&HW-CC-Expire=86400&HW-CC-Sign=0FF19667306F624D278795E84FA04F88BAD04C3938D5478F5DAD288054403F1B)
