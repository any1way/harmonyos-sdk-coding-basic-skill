...
scraped_at: 2026-06-11T15:48:00+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:663e730ca63ea98377bd5091086f696e813bbcbf0012269483fb05cfcaf3d5f1
---
...
* 支持的子组件类型：系统组件和自定义组件，支持条件渲染控制[if/else](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ifelse：条件渲染/arkts-rendering-control-ifelse.md>)，不支持循环渲染控制[ForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/ForEach：循环渲染/arkts-rendering-control-foreach.md>)和[LazyForEach](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/LazyForEach：数据懒加载/arkts-rendering-control-lazyforeach.md>)。
...
参数类型为[ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor)，则圆环类型为单色环。

参数类型为[LinearGradient](../DataPanel/ts-basic-components-datapanel.md#lineargradient10)，则圆环类型为渐变环。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| length | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 环形量规图的环形厚度。  默认值：4  单位：vp  **说明：**  设置小于等于0的值时，按默认值显示。  环形厚度的最大值为圆环的半径，超过最大值按最大值处理。  不支持百分比。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CustomBuilder](../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 是 | 说明内容。  **说明：**  @Builder中的内容由开发者自定义，建议使用文本或者图片。  若自定义部分的宽高为百分比形式，则基准范围为圆环直径的44.4%\*25.4%的矩形（图片为28.6%\*28.6%），距离圆环底部0vp，左右居中。  设置null则不显示内容。  不设置则依赖是否设置数据最大最小值。  若设置最大最小值或者只设置其中一个，则显示最大最小值。  若未设置最大最小值，则不显示内容。  最大最小值显示在圆环底部，位置不可移动，若圆环开口角度设置不恰当，存在圆环遮挡文字的情况。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [ContentModifier](../../通用属性/动态属性与自定义/自定义内容/ts-universal-attributes-content-modifier.md#contentmodifiert)<[GaugeConfiguration](ts-basic-components-gauge.md#gaugeconfiguration12对象说明)> | 是 | 在Gauge组件上定制内容区的方法。  modifier：内容修改器，开发者需要自定义class实现ContentModifier接口。 |

## GaugeShadowOptions11+对象说明

PhonePC/2in1TabletTVWearable

GaugeShadowOptions继承自[MultiShadowOptions](../信息展示公共接口/ts-information-display-common.md#multishadowoptions)，具有MultiShadowOptions的全部属性。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| icon | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 图标资源路径。  **说明：**  不配置则使用系统默认样式，系统默认样式为三角形指针。  仅支持使用svg格式的图标，若使用其他格式，则使用默认的三角形样式指针。 |
| space | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | 否 | 是 | 指针距离圆环外边的间距。(不支持百分比)  默认值：8  单位：vp  **说明：**  对于默认的三角形样式指针，间距为黑色三角形到圆环外边的间距。  若设置值小于0，则使用默认值。  若设置值大于圆环半径，则使用默认值。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8/v3/xNosYkuPTt-nzm7XeYkqew/zh-cn_image_0000002622859817.png?HW-CC-KV=V1&HW-CC-Date=20260611T074758Z&HW-CC-Expire=86400&HW-CC-Sign=3982631CA5DACA1D8D2CCD143E98D10FC642B35C926E7FF3EFA5148C15A37DA0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/XVbiNstpTsGjPMuzSgv34w/zh-cn_image_0000002622699935.png?HW-CC-KV=V1&HW-CC-Date=20260611T074758Z&HW-CC-Expire=86400&HW-CC-Sign=E46FE11C8CCD5D8FFEFDA42B0E6D8292AA15C0982E54CB9712BA6F4AE3E38B53)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/0KddvebUQcmmcPRYFZtvwA/zh-cn_image_0000002592220374.png?HW-CC-KV=V1&HW-CC-Date=20260611T074758Z&HW-CC-Expire=86400&HW-CC-Sign=441AE36B642814764BDEBE60F14D165302EAF60AD1EB58ECD8EA3E8BD5EAC099)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6b/v3/pt30C_wAQ5aJ7vQKNcvtlw/zh-cn_image_0000002592380308.png?HW-CC-KV=V1&HW-CC-Date=20260611T074758Z&HW-CC-Expire=86400&HW-CC-Sign=AA9B1743E7698CC06D1DA1AB8E0767626F9E577861F630FC3DA9A3F623BA2DBD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0f/v3/kNBok__SQruBrXgzNrg-qw/zh-cn_image_0000002622859819.png?HW-CC-KV=V1&HW-CC-Date=20260611T074758Z&HW-CC-Expire=86400&HW-CC-Sign=E05107B84D920DF435394D4A78AC472F736A904535E4A67531994EA59D1EAD57)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/L3L2ahnRTamI5uRLcemM8w/zh-cn_image_0000002622699937.png?HW-CC-KV=V1&HW-CC-Date=20260611T074758Z&HW-CC-Expire=86400&HW-CC-Sign=A36DE116FF8EE5593240DF05163CDF8983BFF4CF7B98762B6FA58520B5A038C9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6b/v3/HgyxD0R3Qju-AMteH1olEQ/zh-cn_image_0000002592220376.png?HW-CC-KV=V1&HW-CC-Date=20260611T074758Z&HW-CC-Expire=86400&HW-CC-Sign=5CC7C99574780013F2F290BC05D079D8FEA22DB1952C6B5F3FF67F84D9395F9B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/69woBvOfRJiBsAIP5GkQqw/zh-cn_image_0000002592380310.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074758Z&HW-CC-Expire=86400&HW-CC-Sign=6848B673055D39B28DA8498FE4490573C4C3B20E31B56B3BF02E90B2A0F53661)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/oPCbbdtRRO-3U-rbsjTKDQ/zh-cn_image_0000002622859821.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074758Z&HW-CC-Expire=86400&HW-CC-Sign=FDE72185D67A9652CEB49ABBC4988A618D82E4D722C56A586963ACEE5AE82662)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/lZVgvR8tRsCcL3Ux6AE1fg/zh-cn_image_0000002622699939.png?HW-CC-KV=V1&HW-CC-Date=20260611T074758Z&HW-CC-Expire=86400&HW-CC-Sign=0C21769D69556D2A6A0A72082C8C4F6A57B60D00AC79E3530D0F6E06244F7E99)
