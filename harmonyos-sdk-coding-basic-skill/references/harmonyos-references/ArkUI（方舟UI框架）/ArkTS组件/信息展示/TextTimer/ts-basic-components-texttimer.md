...
scraped_at: 2026-06-11T15:48:08+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:0ca44416d7287fc77f59b36d38f68cf4700f27222ce4237f980fed47e67f3ae8
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 字体颜色。  Wearable设备上默认值为：'#c5ffffff'，显示白色。  其他设备上默认值：'#e6182431'，显示黑色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 是 | 字体大小。value为Length中的number类型时，单位为fp。字体大小默认为16fp。value为Length中的string类型时，设置值为非数字开头的字符串时，按0fp处理；设置值为数字开头的字符串时，如果数字后内容包含除[像素单位](../../公共定义/像素单位/ts-pixel-units.md)外的字符（如字母、特殊符号等），则取值字符串开头的数字部分，单位为fp。例如设置值为"abc"时取值为0fp，设置值为"10vp"时取值为10vp，设置值为"10vp11abc"时取值为10fp。不支持设置百分比字符串。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [FontStyle](../../公共定义/枚举说明/ts-appendix-enums.md#fontstyle) | 是 | 字体样式，例如斜体的字体样式。  默认值：FontStyle.Normal |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [FontWeight](../../公共定义/枚举说明/ts-appendix-enums.md#fontweight) | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 文本的字体粗细，number类型取值范围为[100, 900]，取值间隔为100，取值越大，字体越粗。number类型取值范围外的默认值为400。[ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr)类型仅支持number类型取值的字符串形式，例如"400"，以及"bold"、"bolder"、"lighter"、"regular"、"medium"，分别对应FontWeight中相应的枚举值。  默认值：FontWeight.Normal  从API version 20开始，支持Resource类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 字体列表。默认字体为'HarmonyOS Sans'。  应用当前支持'HarmonyOS Sans'字体和[注册自定义字体](<../../../ArkTS API/UI界面/@ohos.font (注册自定义字体)/js-apis-font.md>)。  卡片当前仅支持'HarmonyOS Sans'字体。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ShadowOptions](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadowoptions对象说明) | Array<[ShadowOptions](../../通用属性/视效与模糊/图像效果/ts-universal-attributes-image-effect.md#shadowoptions对象说明)> | 是 | 文字阴影效果的参数，包括颜色、模糊半径、偏移量。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [ContentModifier](../../通用属性/动态属性与自定义/自定义内容/ts-universal-attributes-content-modifier.md#contentmodifiert)<[TextTimerConfiguration](ts-basic-components-texttimer.md#texttimerconfiguration12对象说明)> | 是 | 在TextTimer组件上，定制内容区的方法。  modifier： 内容修改器，开发者需要自定义class实现ContentModifier接口。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/qAgyO8FXSvmOUqAzJifRmA/zh-cn_image_0000002592380322.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074806Z&HW-CC-Expire=86400&HW-CC-Sign=B649D00BB17B260A68009A91DA0368FE376C62AACF08E004932C7194A55C4F4F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/NZ4UU6UDSMeZKbKyTXk_ZQ/zh-cn_image_0000002622859833.png?HW-CC-KV=V1&HW-CC-Date=20260611T074806Z&HW-CC-Expire=86400&HW-CC-Sign=C77D1E6DEE278322985952AAC52CA42B7BDAACA60596AF7892D754B12B9B9D96)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/12/v3/hcL4c6ExSzi_UbXuaTfRdg/zh-cn_image_0000002622699951.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074806Z&HW-CC-Expire=86400&HW-CC-Sign=540A6CA90080FB6B3398D17188B8FC264A345635149CFAB1B56767A22CCDCA4A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b2/v3/SHhwaUvTR7GUrvQ7nmZc0g/zh-cn_image_0000002592220390.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074806Z&HW-CC-Expire=86400&HW-CC-Sign=365D0F4E34BB5972C948E4DEFC4DF9F0270186FD67E2F9C8646D68F3C0BC05EE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/df/v3/9m1yLkD8ToaYok0AoQjveg/zh-cn_image_0000002592380324.png?HW-CC-KV=V1&HW-CC-Date=20260611T074806Z&HW-CC-Expire=86400&HW-CC-Sign=5BA1B86B24DD1D28084CD785B09C46F2BCF86135BD0937ACD4D44F2E9B3A5185)
