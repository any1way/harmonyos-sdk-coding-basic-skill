...
scraped_at: 2026-06-11T15:47:54+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:023015e7de5be40597a02584a666b64cfff9ab25efdba0f08cace7d489206211
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ColorMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12>)> | 是 | 文字颜色。  默认值：0xFFFFFF，显示为白色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ColorMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12>)> | 是 | 选中项文字颜色。  默认值：0xFFFFFF，显示为白色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ColorMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12>)> | 是 | 提示弹窗文字颜色。  默认值：0xFFFFFF，显示为白色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ColorMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12>)> | 是 | 选中项背景颜色。  默认值：0x1F71FF，显示为深蓝色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[ColorMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#colormetrics12>)> | 是 | 提示弹窗背景色。  默认值：0xD8404040，显示为微透明的深灰色。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否使用提示弹窗。  true表示使用提示弹窗；false表示不使用提示弹窗。  默认值：false |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| font | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Font](../../公共定义/基础类型定义/ts-types.md#font)> | 是 | 选中项文字样式。  默认值：{  size:'13.0fp',  style:FontStyle.Normal,  weight:500,  family:'HarmonyOS Sans'  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| font | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Font](../../公共定义/基础类型定义/ts-types.md#font)> | 是 | 提示弹窗字体样式。  默认值：  {  size:'19.0fp',  style:FontStyle.Normal,  weight:500,  family:'HarmonyOS Sans'  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| font | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[Font](../../公共定义/基础类型定义/ts-types.md#font)> | 是 | 字母索引条默认字体样式。  默认值：  {  size:'13.0fp',  style:FontStyle.Normal,  weight:500,  family:'HarmonyOS Sans'  } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)> | 是 | 字母索引条字母区域大小，字母区域为圆形，即圆形直径。不支持设置为百分比。  默认值：24.0  单位：vp |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| index | Optional<number> | 是 | 选中项索引值。  默认值：0  该参数支持[!!](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/!!语法：双向绑定/arkts-new-binding.md>)双向绑定变量。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enable | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<boolean> | 是 | 是否使用自适应折叠模式。  默认值：true  true：使用自适应折叠模式。  false：不使用自适应折叠模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[BlurStyle](../../通用属性/基础属性/背景设置/ts-universal-attributes-background.md#blurstyle9)> | 是 | 设置提示弹窗的背景模糊材质。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [Optional](../../通用属性/动态属性与自定义/自定义属性设置/ts-universal-attributes-custom-property.md#optionalt)<[OnSelectCallback](ts-container-arc-alphabet-indexer.md#onselectcallback)> | 是 | 回调函数类型。 |
...
| selected | number | 否 | 否 | 初始选中项索引值，若超出索引值范围，则取默认值0。  该参数支持[!!](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/!!语法：双向绑定/arkts-new-binding.md>)双向绑定变量。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/4m2diyQuQ16idyajv25w4A/zh-cn_image_0000002592380302.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074753Z&HW-CC-Expire=86400&HW-CC-Sign=F6789C27381708828582C93625173B258123CC9E4F7134FFE1E6589C9AFDAB7E)
