...
content_hash: sha256:56f71b5fcc418e7122aebe9063b8f884c54c92db9a17c946fd9425598f70c5f6
---
用于显示单个二维码的组件。
...
* 该组件当前仅支持生成二维码，涉及扫码的业务场景，推荐使用[Scan Kit（统一扫码服务）](<../../../../../harmonyos-guides/媒体/Scan Kit（统一扫码服务）/scan-kit-guide.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 二维码内容字符串。最大支持512个字符，若超出，则截取前512个字符。  从API version 20开始，支持Resource类型。  **说明：**  设置为null时与设置字符串“null”效果一致；设置为undefined时与设置字符串“undefined”效果一致；当传入空字符串时，将生成无效二维码。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 二维码颜色。默认值：'#ff000000'，且不跟随系统深浅色模式切换而修改。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 二维码背景颜色。  默认值：Color.White  从API version 11开始，默认值改为'#ffffffff'，且不跟随系统深浅色模式切换而修改。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 是 | 二维码内容颜色的不透明度。  默认值：1  取值范围：[0, 1]，超出取值范围按默认值处理。 |

## 事件

PhonePC/2in1TabletTVWearable

通用事件支持[点击事件](../../通用事件/交互响应事件/点击事件/ts-universal-events-click.md)、[触摸事件](../../通用事件/基础输入事件/触摸事件/ts-universal-events-touch.md)和[挂载卸载事件](../../通用事件/组件变化事件/挂载卸载事件/ts-universal-events-show-hide.md)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2c/v3/ZtUipd0YQaKjuhHcejihgg/zh-cn_image_0000002622859829.png?HW-CC-KV=V1&HW-CC-Date=20260611T074804Z&HW-CC-Expire=86400&HW-CC-Sign=2B8E13F05A6DD7479FB0F5C39CECE76BC8F53745E37FA7DDE7D2E1321EE9D697)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/2o6lBABZTdCWvMlt4hKuFw/zh-cn_image_0000002622699947.png?HW-CC-KV=V1&HW-CC-Date=20260611T074804Z&HW-CC-Expire=86400&HW-CC-Sign=484438706F3F29346E739FD24FDFB41AFAB8E070E1659FAED95FA2573B4038EB)
