...
scraped_at: 2026-06-11T15:50:39+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:eb1e0cd996a35d57efdc0a5009ccd261872450c9a9c1fe084eb9c7575f91b147
---
说明
...
资源引用类型，用于设置组件属性的值。各类资源文件，需要放入特定子目录中存储管理，资源目录的示例请参考[资源分类](../../../../../harmonyos-guides/基础入门/资源分类与访问/resource-categories-and-access.md#资源分类)。
...
* $rawfile不支持通过[预览器](../../../../../harmonyos-guides/编写与调试应用/界面预览/查看ArkTSJS预览效果/ide-previewer-arkts-js.md)预览。
...
| 类型 | 说明 |
| --- | --- |
| string | 需要显式指定[像素单位](../像素单位/ts-pixel-units.md)，如'10px'，也可设置百分比字符串，如'100%'。  **说明：**  不指定像素单位时，默认单位vp，如'10'，等同于10。 |
| number | 默认单位vp。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| top | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 上内边距，组件内元素距组件顶部的尺寸。 |
| end | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 右内边距，组件内元素距组件右边界的尺寸。  从右至左显示语言模式下为  左内边距，组件内元素距组件左边界的尺寸。 |
| bottom | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 下内边距，组件内元素距组件底部的尺寸。 |
| start | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 左内边距，组件内元素距组件左边界的尺寸。  从右至左显示语言模式下为  右内边距，组件内元素距组件右边界的尺寸。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| top | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 上外边距，组件顶部距组件外元素的尺寸。 |
| end | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 右外边距，组件右边界距组件外元素的尺寸。  从右至左显示语言模式下为  左外边距，组件左边界距组件外元素的尺寸。 |
| bottom | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 下外边距，组件底部距组件外元素的尺寸。 |
| start | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 左外边距，组件左边界距组件外元素的尺寸。  从右至左显示语言模式下为  右外边距，组件右边界距组件外元素的尺寸。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| top | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 组件上边框宽度。 |
| end | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 组件右边框宽度。  从右至左显示语言模式下为组件左边框宽度。 |
| bottom | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 组件下边框宽度。 |
| start | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 组件左边框宽度。  从右至左显示语言模式下为组件右边框宽度。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| topStart | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 组件左上角圆角半径。  从右至左显示语言模式下为组件右上角圆角半径。 |
| topEnd | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 组件右上角圆角半径。  从右至左显示语言模式下为组件左上角圆角半径。 |
| bottomStart | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 组件左下角圆角半径。  从右至左显示语言模式下为组件右下角圆角半径。 |
| bottomEnd | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 组件右下角圆角半径。  从右至左显示语言模式下为组件左下角圆角半径。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| top | [BorderStyle](../枚举说明/ts-appendix-enums.md#borderstyle) | 否 | 是 | 组件上边框样式。 |
| right | [BorderStyle](../枚举说明/ts-appendix-enums.md#borderstyle) | 否 | 是 | 组件右边框样式。 |
| bottom | [BorderStyle](../枚举说明/ts-appendix-enums.md#borderstyle) | 否 | 是 | 组件下边框样式。 |
| left | [BorderStyle](../枚举说明/ts-appendix-enums.md#borderstyle) | 否 | 是 | 组件左边框样式。 |
...
type ResourceColor = [Color](../枚举说明/ts-appendix-enums.md#color) | number | string | [Resource](ts-types.md#resource)
...
| 类型 | 说明 |
| --- | --- |
| [Color](../枚举说明/ts-appendix-enums.md#color) | 颜色枚举值。 |
...
| weight | [FontWeight](../枚举说明/ts-appendix-enums.md#fontweight) | number | string | 否 | 是 | 设置文本的字体粗细，number类型取值[100, 900]，取值间隔为100，取值越大，字体越粗。  默认值：400 | FontWeight.Normal |
...
| style | [FontStyle](../枚举说明/ts-appendix-enums.md#fontstyle) | 否 | 是 | 设置文本的字体样式。  默认值：FontStyle.Normal |
...
| position | [Position](ts-types.md#position) | 目标元素左上角在以父元素为基准的[组件坐标系](../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/ArkUI术语/arkui-glossary.md#组件坐标系)中的位置。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| start | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | LTR模式时x轴相对左边坐标，RTL模式x轴相对右边坐标。 |
| top | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | y轴坐标。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| top | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | 相对顶边的偏移量。 |
| bottom | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | 相对底边的偏移量。 |
| start | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | LTR模式时相对左边的偏移量，RTL模式时相对右边的偏移量。 |
| end | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | LTR模式时相对右边的偏移量，RTL模式时相对左边的偏移量。 |
...
在[Row](../../行列与堆叠/Row/ts-container-row.md)、[Column](../../行列与堆叠/Column/ts-container-column.md)、[RelativeContainer](../../行列与堆叠/RelativeContainer/ts-container-relativecontainer.md)组件中，width、height设置auto表示自适应子组件。在[TextInput](../../文本与输入/TextInput/ts-basic-components-textinput.md)组件中，width设置auto表示自适应文本宽度。
...
| style | [EdgeStyles](ts-types.md#edgestyles9)9+ | [BorderStyle](../枚举说明/ts-appendix-enums.md#borderstyle) | 否 | 是 | 设置边框样式。  **元服务API：** 从API version 11开始，该接口支持在元服务中使用。  **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。 |
| dashGap12+ | [EdgeWidths](ts-types.md#edgewidths9) | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | [LocalizedEdgeWidths](ts-types.md#localizededgewidths12) | 否 | 是 | 设置虚线的线段间距，仅在边框样式为虚线时生效。  不支持设置百分比。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。  **卡片能力：** 该接口不支持在ArkTS卡片中使用。 |
| dashWidth12+ | [EdgeWidths](ts-types.md#edgewidths9) | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | [LocalizedEdgeWidths](ts-types.md#localizededgewidths12) | 否 | 是 | 设置虚线的线段长度，仅在边框样式为虚线时生效。  不支持设置百分比。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。  **卡片能力：** 该接口不支持在ArkTS卡片中使用。 |
...
| 名称 | 类型定义 | 描述 |
| --- | --- | --- |
| CustomBuilder | (() => any) | void | 生成用户自定义组件，在使用时结合[@Builder](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md>)使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| t | T | 是 | 生成用户自定义组件，在使用时结合[@Builder](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md>)使用，并允许传入一个参数。 |
...
| style | [OutlineStyle](../../通用属性/视效与模糊/外描边设置/ts-universal-attributes-outline.md#outlinestyle枚举说明) | [EdgeOutlineStyles](ts-types.md#edgeoutlinestyles11对象说明) | 否 | 是 | 设置外描边样式。  默认值：OutlineStyle.SOLID |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| left | [OutlineStyle](../../通用属性/视效与模糊/外描边设置/ts-universal-attributes-outline.md#outlinestyle枚举说明) | 否 | 是 | 左侧外描边样式。 |
| right | [OutlineStyle](../../通用属性/视效与模糊/外描边设置/ts-universal-attributes-outline.md#outlinestyle枚举说明) | 否 | 是 | 右侧外描边样式。 |
| top | [OutlineStyle](../../通用属性/视效与模糊/外描边设置/ts-universal-attributes-outline.md#outlinestyle枚举说明) | 否 | 是 | 上侧外描边样式。 |
| bottom | [OutlineStyle](../../通用属性/视效与模糊/外描边设置/ts-universal-attributes-outline.md#outlinestyle枚举说明) | 否 | 是 | 下侧外描边样式。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| strokeWidth | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 分割线的线宽。 |
| color | [ResourceColor](ts-types.md#resourcecolor) | 否 | 是 | 分割线的颜色。 |
| startMargin | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 分割线与菜单侧边起始端的距离。 |
| endMargin | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>)12+ | 否 | 是 | 分割线与菜单侧边结束端的距离。 |
| mode | [DividerMode](../枚举说明/ts-appendix-enums.md#dividermode19枚举说明)19+ | 否 | 是 | 设置分割线模式。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| start | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | 滚动条起始边距。  默认值：0，单位：vp |
| end | [LengthMetrics](<../../../ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#lengthmetrics12>) | 否 | 是 | 滚动条末尾边距。  默认值：0，单位：vp |
...
| 类型 | 说明 |
| --- | --- |
| [PresetFillType](../枚举说明/ts-appendix-enums.md#presetfilltype22) | 为不同响应式断点规格指定列数。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/aFfVu_-uQqm6d_MuGMl-ig/zh-cn_image_0000002592380546.png?HW-CC-KV=V1&HW-CC-Date=20260611T075037Z&HW-CC-Expire=86400&HW-CC-Sign=5EE7065EC7B00B42CD1CD420AFD856E03E6043CD51B705DC93D0BE60EAD4D627)

竖直方向同理，其值为组件到上锚点的距离Dtop与组件到竖直方向锚点间总距离Dtop + Dbottom的比值。下图中Dheight表示组件高度。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/CsD69wMzTbmFlSBBQGE7zw/zh-cn_image_0000002622860057.png?HW-CC-KV=V1&HW-CC-Date=20260611T075037Z&HW-CC-Expire=86400&HW-CC-Sign=F0DF6FD50CA5D3E27FB973938BB6575C830D5337A11A9DE5042E4046530618C0)
...
设置组件的无障碍操作的可选参数，用于限制或修改屏幕朗读等辅助应用发起的操作行为。仅[Slider](../../按钮与选择/Slider/ts-basic-components-slider.md)组件支持使用。在其他组件使用该接口时，编译环节可正常通过，但接口功能不生效。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| scrollStep | number | 否 | 是 | 无障碍手势触发的无障碍滚动操作中的组件操作步数。默认值基于组件默认值。  不支持的组件配置不生效。  当前支持组件：[slider](../../按钮与选择/Slider/ts-basic-components-slider.md)，用于slider组件聚焦后通过手势上下扫动触发slider组件的滑动操作。滑动距离：scrollStep\*[step](../../按钮与选择/Slider/ts-basic-components-slider.md#slideroptions对象说明)。取值范围：[1, ([max](../../按钮与选择/Slider/ts-basic-components-slider.md#slideroptions对象说明) - [min](../../按钮与选择/Slider/ts-basic-components-slider.md#slideroptions对象说明))/[step](../../按钮与选择/Slider/ts-basic-components-slider.md#slideroptions对象说明)]，默认值为1。超出取值范围时取默认值1；在取值范围内，scrollStep为非整数时向下取整。 |
