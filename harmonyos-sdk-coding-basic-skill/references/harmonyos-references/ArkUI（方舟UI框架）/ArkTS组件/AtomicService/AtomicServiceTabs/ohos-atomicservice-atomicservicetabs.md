...
scraped_at: 2026-06-11T15:49:35+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:9f71cfd6531ddc1d93b05f6c34a9076a5c57c6247a407b70a9bbfdfa3eed3501
---
...
| layoutMode18+ | [LayoutMode](../../导航与切换/TabContent/ts-container-tabcontent.md#layoutmode10) | 否 | @Prop | 设置底部页签的图片、文字排布的方式，默认值为LayoutMode.VERTICAL。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| barBackgroundColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | @Prop | 设置TabBar的背景颜色，默认值为透明。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| controller | [TabsController](../../导航与切换/Tabs/ts-container-tabs.md#tabscontroller) | 否 | - | Tabs组件的控制器，用于控制Tabs组件进行页签切换。默认值为new TabsController()。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| icon | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | [TabBarSymbol](../../导航与切换/TabContent/ts-container-tabcontent.md#tabbarsymbol12对象说明) | 是 | 页签内的图片内容。 |
| text | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 页签内的文字内容。 |
| unselectedColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 未选择时的页签颜色，默认值：#99182431。 |
| selectedColor | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 否 | 被选择时的页签颜色，默认值：#FF007DFF。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/S0PQiL35RjW9r-PQVa050A/zh-cn_image_0000002622859999.png?HW-CC-KV=V1&HW-CC-Date=20260611T074933Z&HW-CC-Expire=86400&HW-CC-Sign=98045567C64A6FF5B6A85035FB8BE06B4765A89A9E82D2331B0B89B8BCBA911E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/nU-v7ZNLQveGJTL1uQLIRg/zh-cn_image_0000002622700117.png?HW-CC-KV=V1&HW-CC-Date=20260611T074933Z&HW-CC-Expire=86400&HW-CC-Sign=A16BC7C3101C30EF54DB5BC63104BB5AA54C7CC1FBC5395D613CF511C96F753F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/eTzV2OChT_qnkIyg4e5FIw/zh-cn_image_0000002592220558.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074933Z&HW-CC-Expire=86400&HW-CC-Sign=F0C20863F37321E27C5062EC46DCFE1B114078883C86E77C0F143B3BD7BFFE96)
