...
scraped_at: 2026-06-11T15:49:40+08:00
doc_updated_at: 2026-03-27
content_hash: sha256:8a2dce447ef996ebde86a4dde493329ce3f5276c2627fa4b5518eef5f6b9d82c
---
当跳转的目标[NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)在不同的hsp分包，且未被主包依赖，首次运行元服务只会下载安装主包，需要使用NavPushPathHelper先下载安装相应hsp分包，再将指定的[NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面信息入栈。使[Navigation](../../导航与切换/Navigation/ts-basic-components-navigation.md)支持动态加载hsp分包后再跳转。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| navPathStack | [NavPathStack](../../导航与切换/Navigation/ts-basic-components-navigation.md#navpathstack10) | 是 | [Navigation](../../导航与切换/Navigation/ts-basic-components-navigation.md)路由栈。 |
...
先判断分包是否存在，若不存在，则通过moduleName下载分包，再将info指定的[NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面信息入栈，使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| moduleName | string | 是 | 目标[NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)所在分包的moduleName。 |
| info | [NavPathInfo](../../导航与切换/Navigation/ts-basic-components-navigation.md#navpathinfo10) | 是 | [NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面的信息。 |
...
以下错误码的详细介绍请参见[页面路由错误码](../../../错误码/UI界面/页面路由错误码/errorcode-router.md)。
...
具体根据options中指定不同的[LaunchMode](../../导航与切换/Navigation/ts-basic-components-navigation.md#launchmode12枚举说明)，有不同的行为。
...
| moduleName | string | 是 | 目标[NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)所在分包的moduleName。 |
| info | [NavPathInfo](../../导航与切换/Navigation/ts-basic-components-navigation.md#navpathinfo10) | 是 | [NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面的信息。 |
| options | [NavigationOptions](../../导航与切换/Navigation/ts-basic-components-navigation.md#navigationoptions12) | 否 | 页面栈操作选项。默认值为{ launchMode: LaunchMode.STANDARD, animated: true }。 |
...
先判断分包是否存在，若不存在，则通过moduleName下载分包，再将name指定的[NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面信息入栈，传递的数据为param，使用Promise异步回调。
...
| param | Object | 是 | [NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面详细参数。 |
| animated | boolean | 否 | 是否支持转场动画。  默认值：true。  true：支持转场动画。  false：不支持转场动画。 |
...
先判断分包是否存在，若不存在，则通过moduleName下载分包，再将name指定的[NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面信息入栈，传递的数据为param，添加onPop回调接收入栈页面出栈时的返回结果，并进行处理，使用Promise异步回调。
...
| name | string | 是 | [NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面名称。 |
| param | Object | 是 | [NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面详细参数。 |
| onPop | Callback<[PopInfo](../../导航与切换/Navigation/ts-basic-components-navigation.md#popinfo11)> | 是 | Callback回调，用于页面出栈时触发该回调处理返回结果。 |
| animated | boolean | 否 | 是否支持转场动画。  默认值：true。  true：支持转场动画。  false：不支持转场动画。 |
...
先判断分包是否存在，若不存在，则通过moduleName下载分包，再将name指定的[NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面信息入栈，传递的数据为param，并且添加用于页面出栈时处理返回结果的OnPop回调，使用Promise异步回调。
...
| name | string | 是 | [NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面名称。 |
| param | Object | 是 | [NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面详细参数。 |
| onPop | Callback<[PopInfo](../../导航与切换/Navigation/ts-basic-components-navigation.md#popinfo11)> | 是 | Callback回调，用于页面出栈时处理返回结果。 |
| animated | boolean | 否 | 是否支持转场动画。  默认值：true。  true：支持转场动画。  false：不支持转场动画。 |
...
先判断分包是否存在，若不存在，则通过moduleName下载分包，再将当前页面栈栈顶退出，将info指定的[NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)页面信息入栈，使用Promise异步回调。
...
| --- | --- | --- | --- |
| moduleName | string | 是 | 目标[NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)所在分包的moduleName。 |
| info | [NavPathInfo](../../导航与切换/Navigation/ts-basic-components-navigation.md#navpathinfo10) | 是 | 新栈顶页面参数信息 |
| animated | boolean | 否 | 是否支持转场动画。  默认值：true。  true：支持转场动画。  false：不支持转场动画。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0d/v3/hwpYvR0LTvWVB-PTMthZSg/zh-cn_image_0000002622700119.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074938Z&HW-CC-Expire=86400&HW-CC-Sign=C8306E8BD68866D8DB083097ADC9C31C7B0A89EE63BEAC1EBE50089ADB9860A7)
