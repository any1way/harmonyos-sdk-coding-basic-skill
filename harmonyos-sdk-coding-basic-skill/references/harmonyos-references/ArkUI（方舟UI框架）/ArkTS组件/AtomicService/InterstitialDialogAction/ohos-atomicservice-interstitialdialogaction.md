...
content_hash: sha256:6ee143e04f9c734895f0a598f7125dfe5eac203893b07f4301eef800ff996bc8
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| uiContext | [UIContext](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>) | 否 | 否 | UI上下文实例。 |
...
| title | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 弹框标题文本。默认为空字符串。 |
| subtitle | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 是 | 弹框副标题文本。默认为空字符串。 |
| titleColor | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | [Color](../../公共定义/枚举说明/ts-appendix-enums.md#color) | 否 | 是 | 弹框标题文本颜色。默认为$r('sys.color.ohos\_id\_color\_text\_primary\_contrary')。 |
| subtitleColor | [ResourceStr](../../公共定义/基础类型定义/ts-types.md#resourcestr) | [Color](../../公共定义/枚举说明/ts-appendix-enums.md#color) | 否 | 是 | 弹框副标题文本颜色。默认为$r('sys.color.ohos\_id\_color\_text\_secondary\_contrary')。 |
| backgroundImage | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 是 | 弹框背景图片。默认为纯色背景，颜色值为#EBEEF5。 |
| foregroundImage | [Resource](../../公共定义/基础类型定义/ts-types.md#resource) | 否 | 是 | 弹框前景图片。默认为空，即不显示前景图片。 |
...
10. if (dialogUIContext === null) {
11. hilog.info(0x0000, 'testTag', '%{public}s', 'dialogUIContext is null');
12. }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/CRQ0AAPJRLSk0xvejYq4iw/zh-cn_image_0000002592380490.png?HW-CC-KV=V1&HW-CC-Date=20260611T074935Z&HW-CC-Expire=86400&HW-CC-Sign=C505F4CDD4657278A5D53C43397F6071F49E9C2E086A83F88C5723387B599411)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/1myc3hzSSpCK5IV2HCj3-Q/zh-cn_image_0000002622860001.png?HW-CC-KV=V1&HW-CC-Date=20260611T074935Z&HW-CC-Expire=86400&HW-CC-Sign=4DDABEFC820CEFB802D93CF174B9FCDDEB072D95F5592929F02B9AE6B392A7A4)
