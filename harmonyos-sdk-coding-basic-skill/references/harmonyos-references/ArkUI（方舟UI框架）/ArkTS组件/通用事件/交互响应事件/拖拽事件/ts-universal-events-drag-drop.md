...
scraped_at: 2026-06-11T15:43:49+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:6eee6531132e7e361a511b5f16f8a58ad5c48dabf0c33afdd0edc7df1acf9389
---
...
文本类组件[Text](../../../文本与输入/Text/ts-basic-components-text.md)、[Search](../../../文本与输入/Search/ts-basic-components-search.md)、[TextInput](../../../文本与输入/TextInput/ts-basic-components-textinput.md)、[TextArea](../../../文本与输入/TextArea/ts-basic-components-textarea.md)、[RichEditor](../../../文本与输入/RichEditor/ts-basic-components-richeditor.md)对选中的文本内容进行拖拽时，不支持自定义预览图。当onDragStart与菜单预览一起使用或使用了默认支持拖拽能力的组件时，预览及菜单项上的自定义内容不支持拖拽。

说明

从API version 13开始，该接口支持在[attributeModifier](../../../通用属性/动态属性与自定义/动态属性设置/ts-universal-attributes-attribute-modifier.md#attributemodifier)中调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | (event: [DragEvent](ts-universal-events-drag-drop.md#dragevent7), extraParams?: string) => [CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8) | [DragItemInfo](ts-universal-events-drag-drop.md#dragiteminfo) | 是 | 回调函数。  **说明：**  event参数为拖拽事件的信息。  extraParams参数为拖拽事件的额外信息，需要解析为JSON格式，参考[extraParams](ts-universal-events-drag-drop.md#extraparams说明)说明。  CustomBuilder为拖拽过程中显示的组件信息，不支持全局builder。 |
...
关于悬停检测的触发机制及详细使用方法，请参考开发指南[支持悬停检测](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/支持统一拖拽/arkts-common-events-drag-event.md#支持悬停检测>)。
...
| configuration | [DragSpringLoadingConfiguration](<../../../../ArkTS API/UI界面/@ohos.arkui.dragController (DragController)/js-apis-arkui-dragcontroller.md#dragspringloadingconfiguration20>) | 否 | 悬停检测配置信息，为undefined时取[DragSpringLoadingConfiguration](<../../../../ArkTS API/UI界面/@ohos.arkui.dragController (DragController)/js-apis-arkui-dragcontroller.md#dragspringloadingconfiguration20>)默认值。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pixelMap | [PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 否 | 是 | 设置拖拽过程中显示的图片。 |
| builder | [CustomBuilder](../../../公共定义/基础类型定义/ts-types.md#custombuilder8) | 否 | 是 | 拖拽过程中显示自定义组件，如果设置了pixelMap，则忽略此值。  **说明：**  不支持全局builder。如果builder中使用了[Image](../../../图片与视频/Image/ts-basic-components-image.md)组件，应尽量开启同步加载，即配置Image的[syncLoad](../../../图片与视频/Image/ts-basic-components-image.md#syncload8)为true。该builder只用于生成当次拖拽中显示的图片，builder的修改不会同步到当前正在拖拽的图片，对builder的修改需要在下一次拖拽时生效。  builder传参时，建议传参格式为builder: ()=>{this.customBuilder()}，用以保证this指向的正确性。具体请参考[将@Builder装饰的函数当作CustomBuilder类型使用](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式基本语法/组件扩展/@Builder装饰器：自定义构建函数/arkts-builder.md#将builder装饰的函数当作custombuilder类型使用>)。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| selectedIndex | number | 当拖拽事件设在父容器的子元素时，selectedIndex表示当前被拖拽子元素是父容器第selectedIndex个子元素，selectedIndex从0开始。  仅在[ListItem](../../../滚动与滑动/ListItem/ts-container-listitem.md)组件的拖拽事件中生效，否则返回undefined。 |
| insertIndex | number | 当前拖拽元素在List组件中放下时，insertIndex表示被拖拽元素插入该组件的第insertIndex个位置，insertIndex从0开始。  仅在[List](../../../滚动与滑动/List/ts-container-list.md)组件的拖拽事件中生效，否则返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [UnifiedData](<../../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#unifieddata>) | 从DragEvent中获取拖拽相关数据。数据获取结果请参考错误码说明。 |

**错误码：**

以下错误码的详细介绍请参见[拖拽事件错误码](../../../../错误码/UI界面/拖拽事件错误码/errorcode-drag-event.md)。
...
| 类型 | 说明 |
| --- | --- |
| [Rectangle](../../../通用属性/交互属性/触摸交互控制/触摸热区设置/ts-universal-attributes-touch-target.md#rectangle对象说明) | 拖拽预览图相对于当前窗口的位置，以及预览图尺寸信息，单位vp，其中x和y代表预览图左上角的窗口坐标，width和height代表预览图的尺寸。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [DataSyncOptions](ts-universal-events-drag-drop.md#datasyncoptions15) | 是 | 获取拖拽数据时的参数，包含目标路径、文件冲突选项、进度条类型等。数据传输过程中可使用[cancelDataLoading](<../../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (DragController)/arkts-apis-uicontext-dragcontroller.md#canceldataloading15>)接口取消数据加载。 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码](../../../../../通用错误码/errorcode-universal.md)和[拖拽事件错误码](../../../../错误码/UI界面/拖拽事件错误码/errorcode-drag-event.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| customDropAnimation | [Callback<void>](<../../../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>) | 是 | 在此回调函数中实现自定义落位动效。  **说明：**  1. 该接口仅在onDrop回调中使用有效。  2. 使用前需设置useCustomDropAnimation为true，否则该接口不生效。  3. 不要在动画callback中实现与动效无关的逻辑，避免影响执行效率。 |
...
| 类型 | 说明 |
| --- | --- |
| [UnifiedData](<../../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#unifieddata>) | 拖拽相关的数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [Summary](<../../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#summary>) | 拖拽相关数据的简介。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataLoadParams](<../../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#dataloadparams20>) | 落入操作时使用的数据加载参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [GetDataParams](<../../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.unifiedDataChannel (标准化数据通路)/js-apis-data-unifieddatachannel.md#getdataparams15>) | 表示从[UDMF](<../../../../../ArkData（方舟数据管理）/C API/模块/UDMF/capi-udmf.md>)获取数据时的参数，包含目标路径、文件冲突选项、进度条类型等。 |
...
| 类型 | 说明 |
| --- | --- |
| [DragSpringLoadingConfiguration](<../../../../ArkTS API/UI界面/@ohos.arkui.dragController (DragController)/js-apis-arkui-dragcontroller.md#dragspringloadingconfiguration20>) | 定义拖拽的悬停检测配置参数的接口。 |
...
| 类型 | 说明 |
| --- | --- |
| [SpringLoadingContext](<../../../../ArkTS API/UI界面/@ohos.arkui.dragController (DragController)/js-apis-arkui-dragcontroller.md#springloadingcontext20>) | 定义回调上下文信息的类，用于在悬停检测回调中传递给应用程序，以便应用程序能访问拖拽状态。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4e/v3/oBEzUzjeR5admbmmGZGoQA/zh-cn_image_0000002592219930.png?HW-CC-KV=V1&HW-CC-Date=20260611T073953Z&HW-CC-Expire=86400&HW-CC-Sign=297EA1424997E2F0CF210F2E3C6FBFB143B1B82E3E14153CDB9D0957B7DEB85F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/bAPZY7aOTkCBlnbeAA0IYA/zh-cn_image_0000002592379864.gif?HW-CC-KV=V1&HW-CC-Date=20260611T073953Z&HW-CC-Expire=86400&HW-CC-Sign=711B6FDA3A1F1B7A8099BC37E557448D4C06A62A9E098329D7FC70231F09189B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/M0RqmEMCR76UtCKKNYHxZQ/zh-cn_image_0000002622859373.png?HW-CC-KV=V1&HW-CC-Date=20260611T073953Z&HW-CC-Expire=86400&HW-CC-Sign=AEF0AAA1FB61E36EEB477AEC6E37EEBA3F0AE160F5F6EB0665430754CC775551)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/8t1Sy0XuRkS8DlZHYv8kTw/zh-cn_image_0000002622699493.png?HW-CC-KV=V1&HW-CC-Date=20260611T073953Z&HW-CC-Expire=86400&HW-CC-Sign=496113CE7F2BA3947D30CBD5BFF79BBC7D73F80ACD5ADEC8B9613FFA4538FD9E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/gHOSKUd4Q26anNOD57zJAg/zh-cn_image_0000002592219932.gif?HW-CC-KV=V1&HW-CC-Date=20260611T073953Z&HW-CC-Expire=86400&HW-CC-Sign=AE9C44CF46C556977E021BAA299E53F4F4663D08BEA96CC0127CF5F4E54D4D1C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/ViUoPqtpQ-6sqZMZm6Bn6w/zh-cn_image_0000002592379866.gif?HW-CC-KV=V1&HW-CC-Date=20260611T073953Z&HW-CC-Expire=86400&HW-CC-Sign=AF34D585EA4B3CF314F1BA313C7D030825A7C552AF8FDD9828B13EC7B8EF5FBC)
