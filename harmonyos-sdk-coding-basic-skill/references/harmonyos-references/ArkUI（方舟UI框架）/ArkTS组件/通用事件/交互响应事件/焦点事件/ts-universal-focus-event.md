...
content_hash: sha256:55faec39271479657e779466ca10e3116f1fcf626dcbc94e1cfca293005c34e5
---
...
* 不支持嵌套滚动组件场景按键走焦。
* 存在默认交互逻辑的组件例如[Button](../../../按钮与选择/Button/ts-basic-components-button.md)、[TextInput](../../../文本与输入/TextInput/ts-basic-components-textinput.md)等，默认即为可获焦，[Text](../../../文本与输入/Text/ts-basic-components-text.md)、[Image](../../../图片与视频/Image/ts-basic-components-image.md)等组件默认状态为不可获焦，不可获焦状态下，无法触发焦点事件，需要设置[focusable](../../../通用属性/交互属性/焦点控制/ts-universal-attributes-focus.md#focusable)属性为true才可触发。
* 对于有获焦能力的容器组件，例如[Stack](../../../行列与堆叠/Stack/ts-container-stack.md)、[Row](../../../行列与堆叠/Row/ts-container-row.md)等，若不存在可获焦子组件，该容器组件不可获焦。为其配置onClick或是单指单击的Tap手势，且不显式配置focusable属性，该组件会隐式地成为可获焦组件。
* 焦点开发及组件获焦能力参考[支持焦点处理](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/添加交互响应/支持焦点处理/arkts-common-events-focus-event.md>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/yYHEt4aWQ0-QoPCX3XwDDQ/zh-cn_image_0000002622859375.png?HW-CC-KV=V1&HW-CC-Date=20260611T074348Z&HW-CC-Expire=86400&HW-CC-Sign=8B7AC67EF6B31A9396615E95F344E50559331FECE562710B27C7507EE26CAC5E)
