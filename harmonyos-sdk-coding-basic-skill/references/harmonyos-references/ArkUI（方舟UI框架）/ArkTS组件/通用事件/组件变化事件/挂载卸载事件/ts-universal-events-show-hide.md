...
scraped_at: 2026-06-11T15:44:02+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:200c88bd9101959f8567e732e6274f5d77b3758d8b5939a6df510cfaf3e38e22
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../../公共定义/基础类型定义/ts-types.md#callback12)<void> | 是 | onAttach事件的回调函数，表示组件已经挂载至组件树。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../../公共定义/基础类型定义/ts-types.md#callback12)<void> | 是 | onDetach事件的回调函数，表示组件已经从组件树卸载。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/FarbzLAQQOuxFQGfjvjcvw/zh-cn_image_0000002592219938.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074215Z&HW-CC-Expire=86400&HW-CC-Sign=22A80BFD4C6B418FD683E2B3618C187314298ED152897403ABA2EF5FE30286B8)
