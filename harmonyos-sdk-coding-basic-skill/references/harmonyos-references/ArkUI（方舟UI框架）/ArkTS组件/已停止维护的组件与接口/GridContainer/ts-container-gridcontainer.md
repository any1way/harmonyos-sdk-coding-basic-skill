...
scraped_at: 2026-06-11T15:50:45+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:2e49ab398cda59ddf88f0adae57df66a6771253eadbf399f5d510bb5b2e85e2f
---
纵向排布栅格布局容器，仅在栅格布局场景中使用。

说明

从API version 9开始，该组件不再维护，推荐使用新组件[GridCol](../../栅格与分栏/GridCol/ts-container-gridcol.md)、[GridRow](../../栅格与分栏/GridRow/ts-container-gridrow.md)。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[GridCol](../../栅格与分栏/GridCol/ts-container-gridcol.md#接口)或[GridRow](../../栅格与分栏/GridRow/ts-container-gridrow.md#接口)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[GridColOptions](../../栅格与分栏/GridCol/ts-container-gridcol.md#gridcoloptions对象说明)或[GridRowOptions](../../栅格与分栏/GridRow/ts-container-gridrow.md#gridrowoptions对象说明)替代。
...
从API version 7开始支持，从API version 9开始废弃，建议使用[GridColColumnOption](../../栅格与分栏/GridCol/ts-container-gridcol.md#gridcolcolumnoption)或[GridRowColumnOption](../../栅格与分栏/GridRow/ts-container-gridrow.md#gridrowcolumnoption)替代。
...
支持[通用属性](../../通用属性/ts-component-general-attributes.md)和Column组件的[属性方法](../../行列与堆叠/Column/ts-container-column.md#属性)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/n6WSt8BYRqmw8FlCqq19zA/zh-cn_image_0000002592380568.gif?HW-CC-KV=V1&HW-CC-Date=20260611T075044Z&HW-CC-Expire=86400&HW-CC-Sign=F2C943EA6F480FE3F8B56587B1B73D99BC3E741006D62456C5C3C2877D8927A8)
