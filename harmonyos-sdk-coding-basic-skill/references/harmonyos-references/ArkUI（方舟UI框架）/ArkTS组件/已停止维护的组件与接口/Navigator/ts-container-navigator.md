...
scraped_at: 2026-06-11T15:50:49+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:3ee85fc374f8416353a003587b134bee601e05c14ec486ea5bcd44428b669515
---
路由容器组件，提供路由跳转能力。

说明

从API version 13开始，该组件不再维护，建议使用[Navigation](../../导航与切换/Navigation/ts-basic-components-navigation.md)组件进行页面路由。
...
从API version 7开始支持，从API version 13开始废弃，建议使用[NavPathInfo](../../导航与切换/Navigation/ts-basic-components-navigation.md#navpathinfo10)替代。
...
从API version 7开始支持，从API version 13开始废弃，建议使用[NavigationAttribute](../../导航与切换/Navigation/ts-basic-components-navigation.md#属性)替代。NavigationAttribute为Navigation组件的属性。
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| Push | 1 | 跳转到应用内的指定页面。  **说明：**  从API version 7开始支持，从API version 13开始废弃，建议使用[pushPath](../../导航与切换/Navigation/ts-basic-components-navigation.md#pushpath10)替代。 |
| Replace | 2 | 用应用内的某个页面替换当前页面，并销毁被替换的页面。  **说明：**  从API version 7开始支持，从API version 13开始废弃，建议使用[replacePath](../../导航与切换/Navigation/ts-basic-components-navigation.md#replacepath11)替代。 |
| Back | 3 | 返回到指定的页面。指定的页面不存在栈中时不响应。未传入指定的页面时返回上一页。  **说明：**  从API version 7开始支持，从API version 13开始废弃，建议使用[pop](../../导航与切换/Navigation/ts-basic-components-navigation.md#pop10)替代。 |
...
从API version 7开始支持，从API version 13开始废弃，建议使用[Navigation](../../导航与切换/Navigation/ts-basic-components-navigation.md)替代。
...
从API version 7开始支持，从API version 13开始废弃，建议使用[param](../../导航与切换/Navigation/ts-basic-components-navigation.md#属性-1)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | object | 是 | 跳转时要同时传递到目标页面的数据，可在目标页面使用[router.getParams()](<../../../ArkTS API/UI界面/@ohos.router (页面路由)(不推荐)/js-apis-router.md#routergetparamsdeprecated>)获得。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/WQmB3XfiS_CYCSJ76_P09A/zh-cn_image_0000002592220638.gif?HW-CC-KV=V1&HW-CC-Date=20260611T075047Z&HW-CC-Expire=86400&HW-CC-Sign=61197DBDB21701420A7979D70BF83EBE4DBF4706AF7726FE21624383DFAF032D)
