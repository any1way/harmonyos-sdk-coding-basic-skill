...
scraped_at: 2026-06-11T15:50:47+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:f90045b5fbdd31738f8414aff4559dc44fd4af3eca160c2d2aec909ebe7ed4ab
---
导航组件，默认提供点击响应处理，不需要开发者自定义点击事件逻辑。

说明

从API version 13开始，该组件不再维护，推荐使用[NavPathStack](../../导航与切换/Navigation/ts-basic-components-navigation.md#navpathstack10)配合navDestination属性进行页面路由。
...
必须包含两个子组件，其中第二个子组件必须为[NavDestination](../../导航与切换/NavDestination/ts-basic-components-navdestination.md)。
...
从API version 9开始支持，从API version 13开始废弃，建议使用[NavPathStack](../../导航与切换/Navigation/ts-basic-components-navigation.md#navpathstack10)和[navDestination](../../导航与切换/Navigation/ts-basic-components-navigation.md#navdestination10)替代。
...
从API version 10开始支持，从API version 13开始废弃，建议使用[NavPathStack](../../导航与切换/Navigation/ts-basic-components-navigation.md#navpathstack10)和[navDestination](../../导航与切换/Navigation/ts-basic-components-navigation.md#navdestination10)替代。
...
从API version 10开始支持，从API version 13开始废弃，建议使用[LaunchMode](../../导航与切换/Navigation/ts-basic-components-navigation.md#launchmode12枚举说明)替代。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| name | string | 否 | 否 | 点击NavRouter跳转到的NavDestination页面的名称。  **说明：**  从API version 10开始支持，从API version 13开始废弃，建议使用[name](../../导航与切换/Navigation/ts-basic-components-navigation.md#属性-1)替代。 |
| param | unknown | 否 | 是 | 点击NavRouter跳转到NavDestination页面时，传递的参数。  **说明：**  从API version 10开始支持，从API version 13开始废弃，建议使用[param](../../导航与切换/Navigation/ts-basic-components-navigation.md#属性-1)替代。 |
...
从API version 9开始支持，从API version 13开始废弃，建议使用[onShown](../../导航与切换/NavDestination/ts-basic-components-navdestination.md#onshown10)和[onHidden](../../导航与切换/NavDestination/ts-basic-components-navdestination.md#onhidden10)替代。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/-Lv90-YsR02dbT6nSSIfjg/zh-cn_image_0000002622700197.gif?HW-CC-KV=V1&HW-CC-Date=20260611T075046Z&HW-CC-Expire=86400&HW-CC-Sign=155C141DA0EBEBCB96C98AC66A99DA23E31ED784146A1538FF2B327E305AACD1)
