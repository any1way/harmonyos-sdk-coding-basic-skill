...
scraped_at: 2026-06-11T15:50:51+08:00
doc_updated_at: 2026-05-08
content_hash: sha256:edf039e22905d9a2102060a2806fa07fbab7a85b947b8ed16d6bc7a6bcae21d5
---
步骤导航器组件，适用于引导用户按照步骤完成任务的导航场景。

说明

* 从API version 8开始支持，从API version 22开始废弃，建议使用[Swiper](../../滚动与滑动/Swiper/ts-container-swiper.md)替代。详细示例请参考[示例2](ts-basic-components-stepper.md#示例2使用swiper替代stepper)。
...
仅能包含子组件[StepperItem](../StepperItem/ts-basic-components-stepperitem.md)。
...
从API version 8开始支持，从API version 22开始废弃，建议使用[index](../../滚动与滑动/Swiper/ts-container-swiper.md#index)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | { index?: number } | 否 | 设置步骤导航器当前显示StepperItem的索引值。  取值范围：[0, 子组件的数量-1]  默认值：0  从API version 10开始，该参数支持[$$](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)双向绑定变量。 |
...
步骤导航器最后一个[StepperItem](../StepperItem/ts-basic-components-stepperitem.md)的[nextLabel](../StepperItem/ts-basic-components-stepperitem.md#nextlabeldeprecated)被点击时，并且[ItemState](../StepperItem/ts-basic-components-stepperitem.md#itemstate枚举说明)属性为Normal时，触发该回调。

说明

从API version 8开始支持，从API version 22开始废弃，建议使用[onChange](../../滚动与滑动/Swiper/ts-container-swiper.md#onchange)替代。
...
当前显示的[StepperItem](../StepperItem/ts-basic-components-stepperitem.md)状态为ItemState.Skip时，[nextLabel](../StepperItem/ts-basic-components-stepperitem.md#nextlabeldeprecated)被点击时触发该回调。
...
点击当前StepperItem的[prevLabel](../StepperItem/ts-basic-components-stepperitem.md#prevlabeldeprecated)进行步骤切换时触发该回调；或点击当前StepperItem的[nextLabel](../StepperItem/ts-basic-components-stepperitem.md#nextlabeldeprecated)，当前页面不为步骤导航器最后一个StepperItem且[ItemState](../StepperItem/ts-basic-components-stepperitem.md#itemstate枚举说明)属性为Normal时，触发该回调。
...
点击StepperItem的[nextLabel](../StepperItem/ts-basic-components-stepperitem.md#nextlabeldeprecated)切换下一步骤时，当前页面不为步骤导航器最后一个StepperItem且[ItemState](../StepperItem/ts-basic-components-stepperitem.md#itemstate枚举说明)属性为Normal时，触发该回调。
...
点击StepperItem的[prevLabel](../StepperItem/ts-basic-components-stepperitem.md#prevlabeldeprecated)切换上一步骤时触发该回调。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/KwltculbQdu4RWVQDZFRVQ/zh-cn_image_0000002622860083.gif?HW-CC-KV=V1&HW-CC-Date=20260611T075050Z&HW-CC-Expire=86400&HW-CC-Sign=36E0C7CD3A7D0C20E0A2020E34C9A0C17394DAFAE83A78C8BB3BDF145829DBC0)

### 示例2（使用Swiper替代Stepper）

该示例主要演示如何使用[Swiper](../../滚动与滑动/Swiper/ts-container-swiper.md)组件实现Stepper组件的功能，示例效果图同示例1。
