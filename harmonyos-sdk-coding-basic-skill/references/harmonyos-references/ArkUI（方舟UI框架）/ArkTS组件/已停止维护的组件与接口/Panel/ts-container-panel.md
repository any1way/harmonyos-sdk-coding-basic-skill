...
scraped_at: 2026-06-11T15:50:46+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:70dbd0b771476a7eb5cd0bc80850b93206072ee6cf1c6267245f0589960f7f15
---
可滑动面板，提供一种轻量的内容展示窗口，方便在不同尺寸中切换。

说明

从API version 12开始，该组件不再维护，推荐使用通用属性[bindSheet](../../通用属性/模态转场设置/半模态转场/ts-universal-attributes-sheet-transition.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| show | boolean | 是 | 控制Panel显示或隐藏。  **说明：**  如果设置为false时，则不占位隐藏。[Visible.None](../../通用属性/基础属性/显隐控制/ts-universal-attributes-visibility.md)或者show之间有一个生效时，都会生效不占位隐藏。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [PanelMode](ts-container-panel.md#panelmode枚举说明) | 是 | 设置可滑动面板的初始状态。  Minibar类型默认值：PanelMode.Mini；其余类型默认值：PanelMode.Half  从API version 10开始，该属性支持[$$](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式状态管理/语法糖/$$语法：系统组件双向同步/arkts-two-way-sync.md>)双向绑定变量。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Dimension](../../公共定义/基础类型定义/ts-types.md#dimension10) | [PanelHeight](ts-container-panel.md#panelheight10枚举说明) | 是 | 指定PanelType.CUSTOM状态下的高度。  默认值：0  **说明：**  不支持设置百分比。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [ResourceColor](../../公共定义/基础类型定义/ts-types.md#resourcecolor) | 是 | 指定Panel的背景蒙层。  默认值：'#08182431' |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/71/v3/1Ugn5dg9RWO0IIIRRkgNAw/zh-cn_image_0000002622860079.gif?HW-CC-KV=V1&HW-CC-Date=20260611T075045Z&HW-CC-Expire=86400&HW-CC-Sign=2AB7035B5E7F85D6393B049B1786EA7F8642B9CAE784930702414ABE5AD3AB3D)
