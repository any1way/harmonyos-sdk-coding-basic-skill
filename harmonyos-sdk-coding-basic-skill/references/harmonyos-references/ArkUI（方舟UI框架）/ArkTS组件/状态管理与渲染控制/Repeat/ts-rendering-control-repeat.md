...
scraped_at: 2026-06-01T15:45:19+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:9080ca489bdd2fc00475c158099852a165ef0532424787a37fb54a5c82233e0b
---
说明
...
本文档仅为API参数说明。组件描述和使用说明见[Repeat开发者指南](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/学习UI范式渲染控制/Repeat：可复用的循环渲染/arkts-new-rendering-control-repeat.md>)。
...
除支持[拖拽排序](../../通用属性/交互属性/拖拽排序/ts-universal-attributes-drag-sorting.md)属性外，还支持以下属性。
