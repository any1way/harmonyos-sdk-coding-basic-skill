...
scraped_at: 2026-06-11T15:45:53+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:80d726e2c6db97488421bb7924b033f2f08fab9585bedf8e4b093d9eae8d7923
---
栅格布局可以为布局提供规律性的结构，解决多尺寸多设备的动态布局问题，保证不同设备上各个模块的布局一致性。

栅格容器组件，仅可以和栅格子组件([GridCol](../GridCol/ts-container-gridcol.md))在栅格布局场景中使用。
...
| gutter | [Length](../../公共定义/基础类型定义/ts-types.md#length) | [GutterOption](ts-container-gridrow.md#gutteroption) | 否 | 是 | 栅格布局间距。  默认值：0  非法值：按默认值处理。  单位：vp |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| x | [Length](../../公共定义/基础类型定义/ts-types.md#length) | [GridRowSizeOption](ts-container-gridrow.md#gridrowsizeoption) | 否 | 是 | 栅格子组件水平方向间距。 |
| y | [Length](../../公共定义/基础类型定义/ts-types.md#length) | [GridRowSizeOption](ts-container-gridrow.md#gridrowsizeoption) | 否 | 是 | 栅格子组件竖直方向间距。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| xs | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 在最小宽度类型设备上，栅格子组件的间距。  默认值：0vp |
| sm | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 在小宽度类型设备上，栅格子组件的间距。  默认值：0vp |
| md | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 在中等宽度类型设备上，栅格子组件的间距。  默认值：0vp |
| lg | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 在大宽度类型设备上，栅格子组件的间距。  默认值：0vp |
| xl | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 在特大宽度类型设备上，栅格子组件的间距。  默认值：0vp |
| xxl | [Length](../../公共定义/基础类型定义/ts-types.md#length) | 否 | 是 | 在超大宽度类型设备上，栅格子组件的间距。  默认值：0vp |

## BreakPoints

PhonePC/2in1TabletTVWearable

设置栅格容器组件的断点。更多断点的说明参考[栅格容器断点](<../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (ArkTS声明式开发范式)/组件布局/构建布局/栅格布局 (GridRowGridCol)/arkts-layout-development-grid-layout.md#栅格容器断点>)。
...
* 例：Item1: GridCol({ span: 6 })， Item2: GridCol({ span: 8, offset:11 })。
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/Mq5SkXJKRVSOSmVt0LM30w/zh-cn_image_0000002622699627.png?HW-CC-KV=V1&HW-CC-Date=20260611T074519Z&HW-CC-Expire=86400&HW-CC-Sign=A5DB3BFBDC3CB691BE5BD0FDBDFB052A3013D64AA8BAB26360929CBBFC2EBAEC)
...
设置GridRow中的GridCol垂直主轴方向对齐方式。GridCol本身也可通过alignSelf([ItemAlign](../../公共定义/枚举说明/ts-appendix-enums.md#itemalign))设置自身对齐方式。当上述两种对齐方式都设置时，以GridCol自身设置为准。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ItemAlign](../../公共定义/枚举说明/ts-appendix-enums.md#itemalign) | 是 | GridRow中的GridCol垂直主轴方向对齐方式。  默认值：ItemAlign.Start  非法值：按默认值处理。  **说明**：  ItemAlign支持的枚举：ItemAlign.Start、ItemAlign.Center、ItemAlign.End、ItemAlign.Stretch。 |
...
* 当[断点参照物](ts-container-gridrow.md#breakpointsreference枚举说明)设置为BreakpointsReference.ComponentSize时，不建议在onBreakpointChange回调中动态修改GridRow组件的[padding](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#padding)或[margin](../../通用属性/布局与边框/尺寸设置/ts-universal-attributes-size.md#margin)属性值。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/c0vc7ppjTTm4tltAjgPKMQ/zh-cn_image_0000002592220066.png?HW-CC-KV=V1&HW-CC-Date=20260611T074519Z&HW-CC-Expire=86400&HW-CC-Sign=F99B61A5C5CF1057A80AEFC3F5E4B6AA453992FCF989829009BDAB308891BE34)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4e/v3/L7c5XInbTxSUAJQek1-iZA/zh-cn_image_0000002592380000.png?HW-CC-KV=V1&HW-CC-Date=20260611T074519Z&HW-CC-Expire=86400&HW-CC-Sign=B520181BB437F1DF97FE4D90DE8D7D5D03725DFB6C896712E335A2A27C6E969F)
