...
content_hash: sha256:476fe39cdf643908273efea3a2fa00deff8f0d6c2d05702bcd1d570d6dc15a7e
---
...
[geometryTransition](ts-transition-animation-geometrytransition.md)必须配合[animateTo](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#animateto>)使用才有动画效果，动效时长、曲线跟随[animateTo](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md#animateto>)中的配置，不支持[animation](<../属性动画 (animation)/ts-animatorproperty.md>)动画。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/mDcLU1MnQe2i22O28rycRA/zh-cn_image_0000002622700059.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074901Z&HW-CC-Expire=86400&HW-CC-Sign=14EE04FE11B379456B9A6E37C68870C4C9DB7F4C323AE7B82B869D5F5174DAF6)
