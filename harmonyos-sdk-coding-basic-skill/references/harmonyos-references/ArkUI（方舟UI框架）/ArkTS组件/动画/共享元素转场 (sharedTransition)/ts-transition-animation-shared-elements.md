...
scraped_at: 2026-06-11T15:49:02+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:3e8163ffe1010321b99cc2bdc982e37a15feaaca6c5ce31a4814d7da8f109630
---
可以通过设置组件的sharedTransition属性将该元素标记为共享元素并设置对应的共享元素转场动效。sharedTransition仅发生在[@ohos.router (页面路由)](<../../../ArkTS API/UI界面/@ohos.router (页面路由)(不推荐)/js-apis-router.md>)跳转时。
...
| curve | [Curve](../../公共定义/枚举说明/ts-appendix-enums.md#curve) | string | [ICurve](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#icurve9>) | 否 | 是 | 动画曲线。  推荐以Curve或ICurve形式指定。  当类型为string时，为动画插值曲线，取值参考[AnimateParam](<../显式动画 (animateTo)/ts-explicit-animation.md#animateparam对象说明>)的curve参数。  默认值：Curve.Linear |
| delay | number | 否 | 是 | 延迟播放时间。  取值范围：[0, +∞)  默认值：0  单位：毫秒 |
| motionPath | [MotionPathOptions](<../路径动画 (motionPath)/ts-motion-path-animation.md#motionpathoptions>) | 否 | 是 | 运动路径信息。 |
| zIndex | number | 否 | 是 | 设置Z轴。  取值范围：(-∞, +∞)  默认值：0 |
| type | [SharedTransitionEffectType](../../公共定义/枚举说明/ts-appendix-enums.md#sharedtransitioneffecttype) | 否 | 是 | 动画类型。  默认值：SharedTransitionEffectType.Exchange |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/Rh0CwYNYR128XtkleckggQ/zh-cn_image_0000002622859941.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074900Z&HW-CC-Expire=86400&HW-CC-Sign=31932E1B07D0C97D7D417922B172B82B89B482F170CDEFB693A3C7BC2518E382)
