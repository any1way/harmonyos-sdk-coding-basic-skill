...
scraped_at: 2026-06-11T15:48:57+08:00
doc_updated_at: 2026-04-24
content_hash: sha256:25603d9ea95cc8707cf7e2604d8f3ea2bcf0d500441083112b8af913521e5757
---
在[UIContext](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)中提供keyframeAnimateTo接口来指定若干个关键帧状态，实现分段的动画。同属性动画，布局类改变宽高的动画，内容都是直接到终点状态，例如文字、[Canvas](../../画布绘制/Canvas/ts-components-canvas-canvas.md)的内容等，如果要内容跟随宽高变化，可以使用[renderFit](../../通用属性/视效与模糊/组件内容填充方式/ts-universal-attributes-renderfit.md)属性配置。

说明

从API version 11开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

该接口为[UIContext](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)类的成员函数，需要通过UIContext实例对象调用。
...
| curve | [Curve](../../公共定义/枚举说明/ts-appendix-enums.md#curve)| string | [ICurve](<../显式动画 (animateTo)/ts-explicit-animation.md#icurve9>) | 否 | 是 | 该关键帧使用的动画曲线。  推荐以Curve或ICurve形式指定。  当类型为string时，为动画插值曲线，取值参考[AnimateParam](<../显式动画 (animateTo)/ts-explicit-animation.md#animateparam对象说明>)的curve参数。  默认值：Curve.EaseInOut  **说明：**  由于[springMotion](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curvesspringmotion9>)、[responsiveSpringMotion](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curvesresponsivespringmotion9>)、[interpolatingSpring](<../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curvesinterpolatingspring10>)曲线时长不生效，故不支持这三种曲线。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/0lc2s-veSCOKxg94Ij3EYA/zh-cn_image_0000002622859937.gif?HW-CC-KV=V1&HW-CC-Date=20260611T074855Z&HW-CC-Expire=86400&HW-CC-Sign=07097996E4B29D4D929ADCFD7F81EEFE59872679AF0B042FE8C4AF9406974959)
