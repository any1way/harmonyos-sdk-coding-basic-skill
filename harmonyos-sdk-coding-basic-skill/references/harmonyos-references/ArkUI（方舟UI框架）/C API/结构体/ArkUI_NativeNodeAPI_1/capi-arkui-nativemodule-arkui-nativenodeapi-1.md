...
scraped_at: 2026-06-11T15:56:33+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:99c839c07d1c97435bbac38cd77fd9572cc3e1c5d8477e4738327ba4de0fa44e
---
```
...
| 名称 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle (\*createNode)(ArkUI\_NodeType type)](capi-arkui-nativemodule-arkui-nativenodeapi-1.md#createnode) | 基于[ArkUI\_NodeType](../../头文件/native_node.h/capi-native-node-h.md#arkui_nodetype)生成对应的组件并返回组件对象指针。 |
...
基于[ArkUI\_NodeType](../../头文件/native_node.h/capi-native-node-h.md#arkui_nodetype)生成对应的组件并返回组件对象指针。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeType](../../头文件/native_node.h/capi-native-node-h.md#arkui_nodetype) type | 创建指定类型的UI组件节点。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) | 返回创建完成的组件操作指针，如果创建失败返回NULL。需要开发者自行管理返回的组件对象指针的生命周期，否则有可能导致Use After Free等进程崩溃或内存泄漏问题。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 组件指针对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) parent | 父节点指针。 |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) child | 子节点指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](../../头文件/native_type.h/capi-native-type-h.md#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../../头文件/native_type.h/capi-native-type-h.md#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_ARKTS\_NODE\_NOT\_SUPPORTED](../../头文件/native_type.h/capi-native-type-h.md#arkui_errorcode) 不支持对ArkTS创建的节点执行对应的操作。  [ARKUI\_ERROR\_CODE\_NODE\_IS\_ADOPTED](../../头文件/native_type.h/capi-native-type-h.md#arkui_errorcode) 节点已被接纳为附属节点。从API version 22开始支持。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](../../头文件/native_type.h/capi-native-type-h.md#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../../头文件/native_type.h/capi-native-type-h.md#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_ARKTS\_NODE\_NOT\_SUPPORTED](../../头文件/native_type.h/capi-native-type-h.md#arkui_errorcode) 不支持对ArkTS创建的节点执行对应的操作。  [ARKUI\_ERROR\_CODE\_ADAPTER\_EXIST](../../头文件/native_type.h/capi-native-type-h.md#arkui_errorcode) NodeAdapter已经存在。 |
...
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) parent | 父节点指针。 |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) child | 子节点指针。 |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) sibling | 前一个兄弟节点指针，如果为空则插入位置在最后面。 |
...
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) parent | 父节点指针。 |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) child | 子节点指针。 |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) sibling | 后一个兄弟节点指针，如果为空则插入位置在最后面。 |
...
在实际业务场景下，如果组件设置的属性包含由开发者申请的堆内存，需确保组件不再使用后再调用对应释放接口。例如：[ArkUI\_NodeAttributeType](../../头文件/native_node.h/capi-native-node-h.md#arkui_nodeattributetype)中的NODE\_TEXT\_CONTENT\_WITH\_STYLED\_STRING。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 需要设置属性的节点对象。 |
| [ArkUI\_NodeAttributeType](../../头文件/native_node.h/capi-native-node-h.md#arkui_nodeattributetype) attribute | 需要设置的属性类型。 |
| const [ArkUI\_AttributeItem](../ArkUI_AttributeItem/capi-arkui-nativemodule-arkui-attributeitem.md)\* item | 需要设置的属性值。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 需要获取属性的节点对象。 |
| [ArkUI\_NodeAttributeType](../../头文件/native_node.h/capi-native-node-h.md#arkui_nodeattributetype) attribute | 需要获取的属性类型。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| const [ArkUI\_AttributeItem](../ArkUI_AttributeItem/capi-arkui-nativemodule-arkui-attributeitem.md)\* | 当前属性类型的属性值，失败返回空指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 需要重置属性的节点对象。 |
| [ArkUI\_NodeAttributeType](../../头文件/native_node.h/capi-native-node-h.md#arkui_nodeattributetype) attribute | 需要重置的属性类型。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 需要注册事件的节点对象。 |
| [ArkUI\_NodeEventType](../../头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype) eventType | 需要注册的事件类型。 |
| int32\_t targetId | 自定义事件ID，当事件触发时在回调参数[ArkUI\_NodeEvent](../ArkUI_NodeEvent/capi-arkui-nativemodule-arkui-nodeevent.md) 中携带回来。 |
| void\* userData | 自定义事件参数，当事件触发时在回调参数[ArkUI\_NodeEvent](../ArkUI_NodeEvent/capi-arkui-nativemodule-arkui-nodeevent.md) 中携带回来。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 需要反注册事件的节点对象。 |
| [ArkUI\_NodeEventType](../../头文件/native_node.h/capi-native-node-h.md#arkui_nodeeventtype) eventType | 需要反注册的事件类型。 |
...
重复调用时会覆盖前一次注册的函数。 避免直接保存[ArkUI\_NodeEvent](../ArkUI_NodeEvent/capi-arkui-nativemodule-arkui-nodeevent.md)对象指针，数据会在回调结束后销毁。
...
| 参数项 | 描述 |
| --- | --- |
| void (\*eventReceiver)([ArkUI\_NodeEvent](../ArkUI_NodeEvent/capi-arkui-nativemodule-arkui-nodeevent.md)\* event) | 事件回调统一入口函数。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 需要标记重新执行测量、布局或者绘制的节点对象。 |
| [ArkUI\_NodeDirtyFlag](../../头文件/native_node.h/capi-native-node-h.md#arkui_nodedirtyflag) dirtyFlag | 重新执行测量、布局或者绘制的类型。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 目标节点对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) | 返回组件的指针，如果没有返回NULL。 |
...
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 需要注册事件的节点对象。 |
| [ArkUI\_NodeCustomEventType](../../头文件/native_node.h/capi-native-node-h.md#arkui_nodecustomeventtype) eventType | 需要注册的事件类型。 |
| int32\_t targetId | 自定义事件ID，当事件触发时在回调参数[ArkUI\_NodeCustomEvent](../ArkUI_NodeCustomEvent/capi-arkui-nativemodule-arkui-nodecustomevent.md) 中携带回来。 |
| void\* userData | 自定义事件参数，当事件触发时在回调参数[ArkUI\_NodeCustomEvent](../ArkUI_NodeCustomEvent/capi-arkui-nativemodule-arkui-nodecustomevent.md) 中携带回来。 |
...
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 需要反注册事件的节点对象。 |
| [ArkUI\_NodeCustomEventType](../../头文件/native_node.h/capi-native-node-h.md#arkui_nodecustomeventtype) eventType | 需要反注册的事件类型。 |
...
避免直接保存[ArkUI\_NodeCustomEvent](../ArkUI_NodeCustomEvent/capi-arkui-nativemodule-arkui-nodecustomevent.md)对象指针，数据会在回调结束后销毁。
...
| 参数项 | 描述 |
| --- | --- |
| void (\*eventReceiver)([ArkUI\_NodeCustomEvent](../ArkUI_NodeCustomEvent/capi-arkui-nativemodule-arkui-nodecustomevent.md)\* event) | 事件回调统一入口函数。 |
...
在布局回调函数中设置组件的位置。该接口优先级低于ArkUI\_NodeAttributeType中的[NODE\_POSITION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h-nodeattributetype-layoutattributes#node_position)。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_IntSize](../ArkUI_IntSize/capi-arkui-nativemodule-arkui-intsize.md) | ArkUI\_IntSize 组件的宽高。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_IntOffset](../ArkUI_IntOffset/capi-arkui-nativemodule-arkui-intoffset.md) | ArkUI\_IntOffset 组件的位置。 |
...
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 目标节点对象。 |
| [ArkUI\_LayoutConstraint](../ArkUI_LayoutConstraint/capi-arkui-nativemodule-arkui-layoutconstraint.md)\* Constraint | 约束尺寸。 |
...
避免直接保存[ArkUI\_NodeEvent](../ArkUI_NodeEvent/capi-arkui-nativemodule-arkui-nodeevent.md) 对象指针，数据会在回调结束后销毁。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 用于添加组件事件回调函数的对象。 |
| void (\*eventReceiver)([ArkUI\_NodeEvent](../ArkUI_NodeEvent/capi-arkui-nativemodule-arkui-nodeevent.md)\* event) | 组件事件回调函数。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 用于删除组件事件回调函数的对象。 |
| void (eventReceiver)([ArkUI\_NodeEvent](../ArkUI_NodeEvent/capi-arkui-nativemodule-arkui-nodeevent.md) event) | 待删除的组件事件回调函数。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 用于添加组件自定义事件回调函数的对象。 |
| void (\*eventReceiver)([ArkUI\_NodeCustomEvent](../ArkUI_NodeCustomEvent/capi-arkui-nativemodule-arkui-nodecustomevent.md)\* event) | 组件自定义事件回调函数。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 用于删除组件自定义事件回调函数的对象。 |
| void (\*eventReceiver)([ArkUI\_NodeCustomEvent](../ArkUI_NodeCustomEvent/capi-arkui-nativemodule-arkui-nodecustomevent.md)\* event) | 待删除的组件自定义事件回调函数。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 用于保存自定义数据的组件。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 保存了自定义数据的组件。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 用于指定单位的组件。 |
| [ArkUI\_LengthMetricUnit](../../头文件/native_type.h/capi-native-type-h.md#arkui_lengthmetricunit) unit | 单位类型[ArkUI\_LengthMetricUnit](../../头文件/native_type.h/capi-native-type-h.md#arkui_lengthmetricunit)，默认为 ARKUI\_LENGTH\_METRIC\_UNIT\_DEFAULT。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) parent | 目标节点对象。 |
