...
scraped_at: 2026-06-01T15:50:27+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:5d243eb23d5f6630a65307f7f523ab87c406194dbe24f5330adfe6ca23664929
---
```
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* | 返回创建的敲击手势指针。 |
...
| [ArkUI\_GestureDirectionMask](../../头文件/native_gesture.h/capi-native-gesture-h.md#变量) directions | 用于指定触发滑动的手势方向，此枚举值支持逻辑与(&)和逻辑或（|）运算。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* | 返回创建的滑动手势指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* | 返回创建的手势指针。 |
...
| [ArkUI\_GestureDirectionMask](../../头文件/native_gesture.h/capi-native-gesture-h.md#变量) directions | 触发快滑手势的滑动方向。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_GroupGestureMode](../../头文件/native_gesture.h/capi-native-gesture-h.md#arkui_groupgesturemode) gestureMode | 手势组模式。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* | 返回创建的手势组指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* recognizer | 需要销毁的手势的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* group | 需要被关联子手势的手势组。 |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* child | 子手势。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](../../头文件/native_type.h/capi-native-type-h.md#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../../头文件/native_type.h/capi-native-type-h.md#arkui_errorcode) 参数错误。比如添加手势到非手势组对象内。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* group | 需要被删除子手势的手势组。 |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* child | 子手势。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* recognizer | 需要被绑定回调事件的各类手势指针。 |
| [ArkUI\_GestureEventActionTypeMask](../../头文件/native_gesture.h/capi-native-gesture-h.md#变量) actionTypeMask | 需要相应的手势事件类型集合，一次性可以注册多个回调，在回调中区分回调事件类型。例：actionTypeMask = GESTURE\_EVENT\_ACTION\_ACCEPT | GESTURE\_EVENT\_ACTION\_UPDATE; |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 需要被绑定手势的ArkUI组件节点指针。 |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* recognizer | 绑定此节点的手势。 |
| [ArkUI\_GesturePriority](../../头文件/native_gesture.h/capi-native-gesture-h.md#arkui_gesturepriority) mode | 标识此手势的模式。 |
| [ArkUI\_GestureMask](../../头文件/native_gesture.h/capi-native-gesture-h.md#arkui_gesturemask) mask | 手势屏蔽模式。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 需要被移除手势的节点指针。 |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* recognizer | 需要被移除的手势。 |
...
| [ArkUI\_GestureInterruptResult](../../头文件/native_gesture.h/capi-native-gesture-h.md#arkui_gestureinterruptresult) (\*interrupter)([ArkUI\_GestureInterruptInfo](../ArkUI_GestureInterruptInfo/capi-arkui-nativemodule-arkui-gestureinterruptinfo.md)\* info) | 打断回调，info返回手势打断数据。interrupter返回GESTURE\_INTERRUPT\_RESULT\_CONTINUE，手势正常进行；返回GESTURE\_INTERRUPT\_RESULT\_REJECT，手势打断。设置此参数为nullptr时将取消注册回调函数。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_GestureRecognizer](../ArkUI_GestureRecognizer/capi-arkui-nativemodule-arkui-gesturerecognizer.md)\* recognizer | 手势指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_GestureRecognizerType](../../头文件/native_gesture.h/capi-native-gesture-h.md#arkui_gesturerecognizertype) | 手势类型。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_NodeHandle](../ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 需要被设置并行内部手势事件回调的ArkUI节点指针。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | [ARKUI\_ERROR\_CODE\_NO\_ERROR](../../头文件/native_type.h/capi-native-type-h.md#arkui_errorcode) - 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../../头文件/native_type.h/capi-native-type-h.md#arkui_errorcode) - 参数错误。 |
