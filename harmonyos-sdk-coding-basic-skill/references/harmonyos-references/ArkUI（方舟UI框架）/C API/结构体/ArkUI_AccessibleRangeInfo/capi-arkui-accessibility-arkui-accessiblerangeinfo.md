...
scraped_at: 2026-06-01T15:50:41+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:10186b5d94dfe56b500904074a42d1452ad0d15c237c57bd2c6603d29ad5cb5b
---
```
...
用于为特定组件（如[Slider](../../../ArkTS组件/按钮与选择/Slider/ts-basic-components-slider.md)、[Rating](../../../ArkTS组件/按钮与选择/Rating/ts-basic-components-rating.md)、[Progress](../../../ArkTS组件/信息展示/Progress/ts-basic-components-progress.md)组件）设置和获取其当前值、最大值和最小值。
