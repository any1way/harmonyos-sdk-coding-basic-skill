...
scraped_at: 2026-06-01T15:49:09+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:3bdaa11b5504318c4e46d3f3d69f0af09f5d72faaf44ff57810f6f76acc3aba9
---
```
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 辅助服务模式，参数类型[ArkUI\_AccessibilityMode](../../native_type.h/capi-native-type-h.md#arkui_accessibilitymode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].u32 | 配置无障碍操作类型，参数类型[ArkUI\_AccessibilityActionType](../../native_type.h/capi-native-type-h.md#arkui_accessibilityactiontype)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 参数类型为[ArkUI\_AccessibilityState](../../../结构体/ArkUI_AccessibilityState/capi-arkui-nativemodule-arkui-accessibilitystate.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 参数类型为[ArkUI\_AccessibilityValue](../../../结构体/ArkUI_AccessibilityValue/capi-arkui-nativemodule-arkui-accessibilityvalue.md)。 |
