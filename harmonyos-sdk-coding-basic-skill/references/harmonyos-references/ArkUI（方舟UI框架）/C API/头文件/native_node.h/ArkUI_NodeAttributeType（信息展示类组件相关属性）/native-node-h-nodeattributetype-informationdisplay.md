...
scraped_at: 2026-06-01T15:49:07+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:d0d554360412283d0b680836b61f897c028eb41580db30a95fd7925f7872db65
---
```
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 进度条类型枚举值[ArkUI\_ProgressType](../../native_type.h/capi-native-type-h.md#arkui_progresstype)，默认值为ARKUI\_PROGRESS\_TYPE\_LINEAR。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 进度条类型枚举值[ArkUI\_ProgressType](../../native_type.h/capi-native-type-h.md#arkui_progresstype)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 使用[ArkUI\_ProgressLinearStyleOption](../../../结构体/ArkUI_ProgressLinearStyleOption/arkui-nativemodule-arkui-progresslinearstyleoption.md)对象设置组件样式。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .object | 使用[ArkUI\_ProgressLinearStyleOption](../../../结构体/ArkUI_ProgressLinearStyleOption/arkui-nativemodule-arkui-progresslinearstyleoption.md)对象获取组件样式。 |
