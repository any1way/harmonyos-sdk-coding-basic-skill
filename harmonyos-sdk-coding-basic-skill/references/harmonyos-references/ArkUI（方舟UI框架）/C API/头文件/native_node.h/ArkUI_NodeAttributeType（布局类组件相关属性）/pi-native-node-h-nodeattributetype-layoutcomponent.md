...
scraped_at: 2026-06-01T15:49:00+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:68d7557a72042ad770a349036b3c7b31cb3cbea621ead0d231a9f092457c5c95
---
```
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 对齐方式，数据类型[ArkUI\_Alignment](../../native_type.h/capi-native-type-h.md#arkui_alignment)，默认值ARKUI\_ALIGNMENT\_CENTER。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 对齐方式，数据类型[ArkUI\_Alignment](../../native_type.h/capi-native-type-h.md#arkui_alignment)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 子组件在水平方向上的对齐格式，数据类型[ArkUI\_HorizontalAlignment](../../native_type.h/capi-native-type-h.md#arkui_horizontalalignment)，默认值ARKUI\_HORIZONTAL\_ALIGNMENT\_CENTER。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 子组件在水平方向上的对齐格式，数据类型[ArkUI\_HorizontalAlignment](../../native_type.h/capi-native-type-h.md#arkui_horizontalalignment)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 子组件在垂直方向上的对齐格式，数据类型[ArkUI\_FlexAlignment](../../native_type.h/capi-native-type-h.md#arkui_flexalignment)，默认值ARKUI\_FLEX\_ALIGNMENT\_START。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 子组件在垂直方向上的对齐格式，数据类型[ArkUI\_FlexAlignment](../../native_type.h/capi-native-type-h.md#arkui_flexalignment)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 子组件在垂直方向上的对齐格式，数据类型[ArkUI\_VerticalAlignment](../../native_type.h/capi-native-type-h.md#arkui_verticalalignment)，默认值ARKUI\_VERTICAL\_ALIGNMENT\_CENTER。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 子组件在垂直方向上的对齐格式，数据类型[ArkUI\_VerticalAlignment](../../native_type.h/capi-native-type-h.md#arkui_verticalalignment)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 子组件在水平方向上的对齐格式，数据类型[ArkUI\_FlexAlignment](../../native_type.h/capi-native-type-h.md#arkui_flexalignment)，默认值ARKUI\_FLEX\_ALIGNMENT\_START。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 子组件在水平方向上的对齐格式，数据类型[ArkUI\_FlexAlignment](../../native_type.h/capi-native-type-h.md#arkui_flexalignment)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0]?.i32 | 子组件在Flex容器上排列的方向[ArkUI\_FlexDirection](../../native_type.h/capi-native-type-h.md#arkui_flexdirection)，默认值为ARKUI\_FLEX\_DIRECTION\_ROW。 |
| .value[1]?.i32 | 排列规则[ArkUI\_FlexWrap](../../native_type.h/capi-native-type-h.md#arkui_flexwrap)，默认值为ARKUI\_FLEX\_WRAP\_NO\_WRAP。 |
| .value[2]?.i32 | 主轴上的对齐格式[ArkUI\_FlexAlignment](../../native_type.h/capi-native-type-h.md#arkui_flexalignment)，默认值为ARKUI\_FLEX\_ALIGNMENT\_START。 |
| .value[3]?.i32 | 交叉轴上的对齐格式[ArkUI\_ItemAlignment](../../native_type.h/capi-native-type-h.md#arkui_itemalignment)，默认值为ARKUI\_ITEM\_ALIGNMENT\_START。 |
| .value[4]?.i32 | 交叉轴中有额外的空间时，多行内容的对齐方式[ArkUI\_FlexAlignment](../../native_type.h/capi-native-type-h.md#arkui_flexalignment)，默认值为ARKUI\_FLEX\_ALIGNMENT\_START。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | RelativeContainer容器内的辅助线，参数类型为[ArkUI\_GuidelineOption](../../../结构体/ArkUI_GuidelineOption/capi-arkui-nativemodule-arkui-guidelineoption.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | RelativeContainer容器内的屏障，参数类型为[ArkUI\_BarrierOption](../../../结构体/ArkUI_BarrierOption/capi-arkui-nativemodule-arkui-barrieroption.md)。 |
