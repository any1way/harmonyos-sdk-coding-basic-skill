...
scraped_at: 2026-06-01T15:49:02+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:3e9d73050d80abb3ccf389480ee648ab18fa369a3dd2e3b0b551d0a1d789b2c7
---
```
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 控制当前组件的触摸测试类型，参数类型[ArkUI\_HitTestMode](../../native_type.h/capi-native-type-h.md#arkui_hittestmode)，默认值为ARKUI\_HIT\_TEST\_MODE\_DEFAULT。 |
...
| --- | --- |
| .string | 遮罩文本。 |
| .value[0]?.i32 | 可选值，浮层相对于组件的位置，参数类型[ArkUI\_Alignment](../../native_type.h/capi-native-type-h.md#arkui_alignment)，默认值为ARKUI\_ALIGNMENT\_TOP\_START。 |
| .value[1]?.f32 | 可选值，浮层基于自身左上角的偏移量X，单位为vp，默认值为0vp。 |
| .value[2]?.f32 | 可选值，浮层基于自身左上角的偏移量Y，单位为vp，默认值为0vp。 |
| .value[3]?.i32 | 可选值，浮层的布局方向，参数类型[ArkUI\_Direction](../../native_type.h/capi-native-type-h.md#arkui_direction)，默认值为ARKUI\_DIRECTION\_LTR。  在大部分场景下，这个参数都应该被设置成Auto，这个模式允许系统自动处理布局方向，如果在某些场景下需要保持特定的方向，设置这个属性为LTR（Left-to-Right）或者RTL（Right-to-Left）。从API version 21开始支持。 |
| .object | 用于overlay的节点树，参数类型为[ArkUI\_NodeHandle](../../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md)，默认值为nullptr。从API version 21开始支持。 |
...
| --- | --- |
| .string | 遮罩文本。 |
| .value[0].i32 | 浮层相对于组件的位置，参数类型[ArkUI\_Alignment](../../native_type.h/capi-native-type-h.md#arkui_alignment)，默认值为ARKUI\_ALIGNMENT\_TOP\_START。 |
| .value[1].f32 | 浮层基于自身左上角的偏移量X，单位为vp。 |
| .value[2].f32 | 浮层基于自身左上角的偏移量Y，单位为vp。 |
| .value[3].i32 | 浮层的布局方向，参数类型[ArkUI\_Direction](../../native_type.h/capi-native-type-h.md#arkui_direction)，默认值为ARKUI\_DIRECTION\_LTR。从API version 21开始支持。 |
| .object | 用于overlay的节点树，参数类型为[ArkUI\_NodeHandle](../../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md)。从API version 21开始支持。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0]?.u32 | 扩展安全区域的枚举值集合[ArkUI\_SafeAreaType](../../native_type.h/capi-native-type-h.md#arkui_safeareatype)，例如：ARKUI\_SAFE\_AREA\_TYPE\_SYSTEM | ARKUI\_SAFE\_AREA\_TYPE\_CUTOUT。 |
| .value[1]?.u32 | 扩展安全区域的方向枚举值集合[ArkUI\_SafeAreaEdge](../../native_type.h/capi-native-type-h.md#arkui_safeareaedge)，例如：ARKUI\_SAFE\_AREA\_EDGE\_TOP | ARKUI\_SAFE\_AREA\_EDGE\_BOTTOM。 |
...
| .?object | 参数类型为[ArkUI\_VisibleAreaEventOptions](../../../结构体/ArkUI_VisibleAreaEventOptions/i-arkui-nativemodule-arkui-visibleareaeventoptions.md)。 |
...
| --- | --- |
| .value[...].f32 | 占比数值。 |
| .object | 返回类型为[ArkUI\_VisibleAreaEventOptions](../../../结构体/ArkUI_VisibleAreaEventOptions/i-arkui-nativemodule-arkui-visibleareaeventoptions.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 走焦类型，定义在[ArkUI\_FocusMove](../../native_type.h/capi-native-type-h.md#arkui_focusmove)。 |
| .object | 下一个焦点。参数类型为[ArkUI\_NodeHandle](../../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 组件在悬停状态下的悬停效果。参数类型为[ArkUI\_HoverEffect](../../native_type.h/capi-native-type-h.md#arkui_hovereffect)。默认值为ARKUI\_HOVER\_EFFECT\_AUTO。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 组件在悬停状态下的悬停效果。参数类型为[ArkUI\_HoverEffect](../../native_type.h/capi-native-type-h.md#arkui_hovereffect)。 |
...
| --- | --- |
| .string | 焦点作用域标识符。 |
| .value[0].i32 | 焦点作用域内获焦优先级。参数类型为[ArkUI\_FocusPriority](../../native_type.h/capi-native-type-h.md#arkui_focuspriority)。默认值为ARKUI\_FOCUS\_PRIORITY\_AUTO。 |
...
| --- | --- |
| .string | 焦点作用域标识符。 |
| .value[0].i32 | 焦点作用域优先级。参数类型为[ArkUI\_FocusPriority](../../native_type.h/capi-native-type-h.md#arkui_focuspriority)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .data[0].i32 | 适用于此响应区域的事件工具类型。参数类型为[ArkUI\_ResponseRegionSupportedTool](../../native_type.h/capi-native-type-h.md#arkui_responseregionsupportedtool)。默认值：ARKUI\_RESPONSE\_REGIN\_SUPPORTED\_TOOL\_ALL。 |
