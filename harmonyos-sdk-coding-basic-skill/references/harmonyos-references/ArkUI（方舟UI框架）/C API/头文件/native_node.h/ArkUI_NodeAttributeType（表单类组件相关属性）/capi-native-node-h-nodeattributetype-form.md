...
scraped_at: 2026-06-01T15:49:04+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:edda1e6193b78510f8b5e3987c8d0acad5716f7e3e1b09227fdad23a15363532
---
```
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 设置Button按钮的样式，参数类型[ArkUI\_ButtonType](../../native_type.h/capi-native-type-h.md#arkui_buttontype)，默认值为ARKUI\_BUTTON\_TYPE\_CAPSULE。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 获取Button按钮的样式，参数类型[ArkUI\_ButtonType](../../native_type.h/capi-native-type-h.md#arkui_buttontype)，默认值为ARKUI\_BUTTON\_TYPE\_CAPSULE。 |
...
[CheckBox](../../../../ArkTS组件/按钮与选择/Checkbox/ts-basic-components-checkbox.md)多选框是否选中，支持属性设置，属性重置和属性获取。
...
[CheckBox](../../../../ArkTS组件/按钮与选择/Checkbox/ts-basic-components-checkbox.md)多选框选中状态颜色，支持属性设置，属性重置和属性获取。
...
[CheckBox](../../../../ArkTS组件/按钮与选择/Checkbox/ts-basic-components-checkbox.md)多选框非选中状态边框颜色，支持属性设置，属性重置和属性获取。
...
[CheckBox](../../../../ArkTS组件/按钮与选择/Checkbox/ts-basic-components-checkbox.md)多选框内部图标样式，支持属性设置，属性重置和属性获取。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 组件形状，参数类型[ArkUI\_CheckboxShape](../../native_type.h/capi-native-type-h.md#arkui_checkboxshape)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 形状参数。参数类型[ArkUI\_SliderBlockStyle](../../native_type.h/capi-native-type-h.md#arkui_sliderblockstyle)。 |
...
| .value[1].i32 | 裁剪类型，参数类型[ArkUI\_ShapeType](../../native_type.h/capi-native-type-h.md#arkui_shapetype)。rect类型为ARKUI\_SHAPE\_TYPE\_RECTANGLE；circle类型为ARKUI\_SHAPE\_TYPE\_CIRCLE；ellipse类型为ARKUI\_SHAPE\_TYPE\_ELLIPSE；path类型为ARKUI\_SHAPE\_TYPE\_PATH。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 显示样式，参数类型[ArkUI\_SliderDirection](../../native_type.h/capi-native-type-h.md#arkui_sliderdirection)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 显示样式，参数类型[ArkUI\_SliderStyle](../../native_type.h/capi-native-type-h.md#arkui_sliderstyle)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 参数类型 [ArkUI\_NodeHandle](../../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md)。前缀组件将放置在Slider组件的起始位置，通常在LTR布局的左侧。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 参数类型 [ArkUI\_NodeHandle](../../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md)。后缀组件将放置在Slider组件的尾侧位置，通常在LTR布局的右侧。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 参数类型为[ArkUI\_ColorStop](../../../结构体/ArkUI_ColorStop/capi-arkui-nativemodule-arkui-colorstop.md)。指定相对比例位置处的渐变色颜色，设置非法颜色直接跳过：  - colors：渐变色颜色。  - stops：渐变位置。  - size：颜色个数。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .object | 参数类型为[ArkUI\_ColorStop](../../../结构体/ArkUI_ColorStop/capi-arkui-nativemodule-arkui-colorstop.md)。指定相对比例位置处的渐变色颜色：  - colors：渐变色颜色。  - stops：渐变位置。  - size：颜色个数。 |
...
[CheckBoxGroup](../../../../ArkTS组件/按钮与选择/CheckboxGroup/ts-basic-components-checkboxgroup.md)多选框组是否全选, 支持属性设置，属性重置和属性获取。
...
[CheckBoxGroup](../../../../ArkTS组件/按钮与选择/CheckboxGroup/ts-basic-components-checkboxgroup.md)多选框选中状态颜色, 支持属性设置，属性重置和属性获取。
...
| 类型 | 说明 |
| --- | --- |
| .value[0].u32 | [CheckBoxGroup](../../../../ArkTS组件/按钮与选择/CheckboxGroup/ts-basic-components-checkboxgroup.md)多选框选中状态颜色, 0xARGB格式。例如0xFF1122FF。 |
...
[CheckBoxGroup](../../../../ArkTS组件/按钮与选择/CheckboxGroup/ts-basic-components-checkboxgroup.md)多选框未选中边框颜色, 支持属性设置，属性重置和属性获取。
...
[CheckBoxGroup](../../../../ArkTS组件/按钮与选择/CheckboxGroup/ts-basic-components-checkboxgroup.md)多选框内部图标样式, 支持属性设置，属性重置和属性获取。
...
[CheckBoxGroup](../../../../ArkTS组件/按钮与选择/CheckboxGroup/ts-basic-components-checkboxgroup.md)组件形状, 支持属性设置，属性重置和属性获取。
