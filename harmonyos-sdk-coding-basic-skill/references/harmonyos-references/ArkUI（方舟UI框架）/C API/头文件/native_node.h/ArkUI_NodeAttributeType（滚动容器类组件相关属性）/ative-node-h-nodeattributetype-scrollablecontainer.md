...
scraped_at: 2026-06-01T15:49:05+08:00
doc_updated_at: 2026-05-08
content_hash: sha256:e4dc8643b7fa6a3bcfde63baa32fee2d9ed406a04dd31ded867edc55c0876c8d
---
```
...
设置滚动条状态，支持属性设置，属性重置和属性获取接口。[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)/[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)/[WaterFlow](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)从API version 12开始支持，[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)从API version 22开始支持。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 滚动条状态，数据类型[ArkUI\_ScrollBarDisplayMode](../../native_type.h/capi-native-type-h.md#arkui_scrollbardisplaymode)，List、Grid、Scroll组件默认值为[ARKUI\_SCROLL\_BAR\_DISPLAY\_MODE\_AUTO](../../native_type.h/capi-native-type-h.md#arkui_scrollbardisplaymode)，WaterFlow组件默认值为[ARKUI\_SCROLL\_BAR\_DISPLAY\_MODE\_OFF](../../native_type.h/capi-native-type-h.md#arkui_scrollbardisplaymode)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 滚动条状态，数据类型[ArkUI\_ScrollBarDisplayMode](../../native_type.h/capi-native-type-h.md#arkui_scrollbardisplaymode)。 |
...
设置滚动条的宽度，支持属性设置，属性重置和属性获取接口。[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)/[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)/[WaterFlow](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)从API version 12开始支持，[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)从API version 22开始支持。
...
设置滚动条的颜色，支持属性设置，属性重置和属性获取接口。[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)/[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)/[WaterFlow](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)从API version 12开始支持，[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)从API version 22开始支持。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 滚动方向，数据类型[ArkUI\_ScrollDirection](../../native_type.h/capi-native-type-h.md#arkui_scrolldirection)，默认值[ARKUI\_SCROLL\_DIRECTION\_VERTICAL](../../native_type.h/capi-native-type-h.md#arkui_scrolldirection)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 滚动方向，数据类型[ArkUI\_ScrollDirection](../../native_type.h/capi-native-type-h.md#arkui_scrolldirection)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 边缘滑动效果，参数类型[ArkUI\_EdgeEffect](../../native_type.h/capi-native-type-h.md#arkui_edgeeffect)，Grid、Scroll、WaterFlow组件默认值为[ARKUI\_EDGE\_EFFECT\_NONE](../../native_type.h/capi-native-type-h.md#arkui_edgeeffect)，List组件默认值为[ARKUI\_EDGE\_EFFECT\_SPRING](../../native_type.h/capi-native-type-h.md#arkui_edgeeffect)。 |
| .value[1]?.i32 | 可选值，组件内容大小小于组件自身时，设置是否开启滑动效果，开启为1，关闭为0，List、Grid、WaterFlow组件默认值为0，Scroll组件默认值为1。 |
| .value[2]?.i32 | 边缘效果生效的方向，参数类型[ArkUI\_EffectEdge](../../native_type.h/capi-native-type-h.md#arkui_effectedge)，默认值[ARKUI\_EFFECT\_EDGE\_START](../../native_type.h/capi-native-type-h.md#arkui_effectedge) | [ARKUI\_EFFECT\_EDGE\_END](../../native_type.h/capi-native-type-h.md#arkui_effectedge)。  该参数从API version 18开始支持。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 边缘滑动效果，参数类型[ArkUI\_EdgeEffect](../../native_type.h/capi-native-type-h.md#arkui_edgeeffect)。 |
| .value[1].i32 | 组件内容大小小于组件自身时，设置是否开启滑动效果，开启为1，关闭为0。 |
| .value[2].i32 | 边缘效果生效的方向，参数类型[ArkUI\_EffectEdge](../../native_type.h/capi-native-type-h.md#arkui_effectedge)。该参数从API version 18开始支持。 |
...
设置[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)组件的限位滚动模式，支持属性设置，属性重置和属性获取接口。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | Scroll组件限位滚动时的对齐方式，数据类型[ArkUI\_ScrollSnapAlign](../../native_type.h/capi-native-type-h.md#arkui_scrollsnapalign)，默认值[ARKUI\_SCROLL\_SNAP\_ALIGN\_NONE](../../native_type.h/capi-native-type-h.md#arkui_scrollsnapalign)。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | Scroll组件限位滚动时的对齐方式，数据类型[ArkUI\_ScrollSnapAlign](../../native_type.h/capi-native-type-h.md#arkui_scrollsnapalign)。 |
| .value[1].i32 | 在Scroll组件限位滚动模式下，该参数设置为true后，不允许Scroll在开头和第一页间自由滑动，设置为false后，允许Scroll在开头和第一页间自由滑动，默认值true。该参数仅在限位点为多个时生效。 |
| .value[2].i32 | 在Scroll组件限位滚动模式下，该参数设置为true后，不允许Scroll在最后一页和末尾间自由滑动，设置为false后，允许Scroll在最后一页和末尾间自由滑动，默认值true。该参数仅在限位点为多个时生效。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 可滚动组件往末尾端滚动时的嵌套滚动，参数类型[ArkUI\_ScrollNestedMode](../../native_type.h/capi-native-type-h.md#arkui_scrollnestedmode)。 |
| .value[1].i32 | 可滚动组件往起始端滚动时的嵌套滚动，参数类型[ArkUI\_ScrollNestedMode](../../native_type.h/capi-native-type-h.md#arkui_scrollnestedmode)。 |
...
[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)滑动到指定位置，支持属性设置，属性重置和属性获取。
...
| .value[3]?.i32 | 可选值，滚动曲线，参数类型[ArkUI\_AnimationCurve](../../native_type.h/capi-native-type-h.md#arkui_animationcurve)。默认值为[ARKUI\_CURVE\_EASE](../../native_type.h/capi-native-type-h.md#arkui_animationcurve)。 |
...
[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)滚动到容器边缘位置，支持属性设置，属性获取。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 容器边缘位置，参数类型[ArkUI\_ScrollEdge](../../native_type.h/capi-native-type-h.md#arkui_scrolledge)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 容器是否位于边缘，-1：表示未处于边缘，如果处于边缘状态，参数类型[ArkUI\_ScrollEdge](../../native_type.h/capi-native-type-h.md#arkui_scrolledge)。 |
...
设置是否支持滑动翻页，支持属性设置，属性重置和属性获取接口。如果同时设置了滑动翻页[enablePaging](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#enablepaging11)和限位滚动[scrollSnap](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scrollsnap10)，则[scrollSnap](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#scrollsnap10)优先生效，[enablePaging](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md#enablepaging11)不生效。
...
设置滚动类组件内容起始端偏移量。[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)组件从API version 15开始支持，[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)/[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)/[WaterFlow](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)从API version 22开始支持。
...
设置滚动类组件内容末尾端偏移量。[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)组件从API version 15开始支持，[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)/[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)/[WaterFlow](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)从API version 22开始支持。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 内容裁剪模式，参数类型[ArkUI\_ContentClipMode](../../native_type.h/capi-native-type-h.md#arkui_contentclipmode)。[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)、[Scroll](../../../../ArkTS组件/滚动与滑动/Scroll/ts-container-scroll.md)组件默认值为[ARKUI\_CONTENT\_CLIP\_MODE\_BOUNDARY](../../native_type.h/capi-native-type-h.md#arkui_contentclipmode)，[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)、[WaterFlow](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)组件默认值为[ARKUI\_CONTENT\_CLIP\_MODE\_CONTENT\_ONLY](../../native_type.h/capi-native-type-h.md#arkui_contentclipmode)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 内容裁剪模式，参数类型[ArkUI\_ContentClipMode](../../native_type.h/capi-native-type-h.md#arkui_contentclipmode)。 |
...
设置[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)组件排列方向。支持属性设置，属性重置和属性获取接口。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | List组件排列方向，数据类型[ArkUI\_Axis](../../native_type.h/capi-native-type-h.md#arkui_axis)，默认值ARKUI\_AXIS\_VERTICAL。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | List组件排列方向，数据类型[ArkUI\_Axis](../../native_type.h/capi-native-type-h.md#arkui_axis)。 |
...
配合[ListItemGroup](../../../../ArkTS组件/滚动与滑动/ListItemGroup/ts-container-listitemgroup.md)组件使用，设置ListItemGroup中header和footer是否要吸顶或吸底，支持属性设置，属性重置和属性获取接口。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 配合ListItemGroup组件使用，设置ListItemGroup中header和footer是否要吸顶或吸底。数据类型[ArkUI\_StickyStyle](../../native_type.h/capi-native-type-h.md#arkui_stickystyle)，默认值ARKUI\_STICKY\_STYLE\_NONE。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 配合ListItemGroup组件使用，设置ListItemGroup中header和footer是否要吸顶或吸底。数据类型[ArkUI\_StickyStyle](../../native_type.h/capi-native-type-h.md#arkui_stickystyle)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 使用[ArkUI\_NodeAdapter](../../../结构体/ArkUI_NodeAdapter/capi-arkui-nativemodule-arkui-nodeadapter8h.md)对象作为适配器。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .object | 返回值格式为[ArkUI\_NodeAdapter](../../../结构体/ArkUI_NodeAdapter/capi-arkui-nativemodule-arkui-nodeadapter8h.md)。 |
...
| .value[2]?.i32 | 指定滑动到的元素与当前容器的对齐方式，参数类型[ArkUI\_ScrollAlignment](../../native_type.h/capi-native-type-h.md#arkui_scrollalignment), 默认值：[ARKUI\_SCROLL\_ALIGNMENT\_START](../../native_type.h/capi-native-type-h.md#arkui_scrollalignment)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 交叉轴方向的布局方式。参数类型[ArkUI\_ListItemAlign](../../native_type.h/capi-native-type-h.md#arkui_listitemalignment)。默认值：ARKUI\_LIST\_ITEM\_ALIGNMENT\_START。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 交叉轴方向的布局方式。参数类型[ArkUI\_ListItemAlign](../../native_type.h/capi-native-type-h.md#arkui_listitemalignment)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 参数格式为[ArkUI\_ListChildrenMainSize](../../../结构体/ArkUI_ListChildrenMainSize/capi-arkui-nativemodule-arkui-listchildrenmainsize.md)。 |
...
滑动到指定[ListItemGroup](../../../../ArkTS组件/滚动与滑动/ListItemGroup/ts-container-listitemgroup.md)中指定index。开启smooth动效时，会对经过的所有item进行加载和布局计算，当大量加载item时会导致性能问题。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 要滑动到的目标[ListItemGroup](../../../../ArkTS组件/滚动与滑动/ListItemGroup/ts-container-listitemgroup.md)在当前[List](../../../../ArkTS组件/滚动与滑动/List/ts-container-list.md)中的索引值。 |
| .value[1].i32 | 要滑动到的目标[ListItem](../../../../ArkTS组件/滚动与滑动/ListItem/ts-container-listitem.md)在[ListItemGroup](../../../../ArkTS组件/滚动与滑动/ListItemGroup/ts-container-listitemgroup.md)中的索引值。 |
| .value[2]?.i32 | 设置滑动到列表项在列表中的索引值时是否有动效，1表示有动效，0表示没有动效。默认值：0。 |
| .value[3]?.i32 | 指定滑动到的元素与当前容器的对齐方式，参数类型[ArkUI\_ScrollAlignment](../../native_type.h/capi-native-type-h.md#arkui_scrollalignment)。默认值：[ARKUI\_SCROLL\_ALIGNMENT\_START](../../native_type.h/capi-native-type-h.md#arkui_scrollalignment)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | List组件限位滚动时的对齐方式，数据类型[ArkUI\_ScrollSnapAlign](../../native_type.h/capi-native-type-h.md#arkui_scrollsnapalign)，默认值[ARKUI\_SCROLL\_SNAP\_ALIGN\_NONE](../../native_type.h/capi-native-type-h.md#arkui_scrollsnapalign)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | List组件限位滚动时的对齐方式，数据类型[ArkUI\_ScrollSnapAlign](../../native_type.h/capi-native-type-h.md#arkui_scrollsnapalign)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | List组件走焦换行模式，参数类型[ArkUI\_FocusWrapMode](../../native_type.h/capi-native-type-h.md#arkui_focuswrapmode)。默认值：ARKUI\_FOCUS\_WRAP\_MODE\_DEFAULT。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | List组件走焦换行模式，参数类型[ArkUI\_FocusWrapMode](../../native_type.h/capi-native-type-h.md#arkui_focuswrapmode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | List组件限位滚动动画速度，数据类型[ArkUI\_ScrollSnapAnimationSpeed](../../native_type.h/capi-native-type-h.md#arkui_scrollsnapanimationspeed)。默认值：ARKUI\_SCROLL\_SNAP\_ANIMATION\_NORMAL。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | List组件限位滚动动画速度，数据类型[ArkUI\_ScrollSnapAnimationSpeed](../../native_type.h/capi-native-type-h.md#arkui_scrollsnapanimationspeed)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 在不同断点规格下的列数，数据类型[ArkUI\_ItemFillPolicy](../../native_type.h/capi-native-type-h.md#arkui_itemfillpolicy)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 使用[ArkUI\_ListItemSwipeActionOption](../../../结构体/ArkUI_ListItemSwipeActionOption/arkui-nativemodule-arkui-listitemswipeactionoption.md)对象构造。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 使用[ArkUI\_NodeHandle](../../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md)对象作为ListItemGroup头部组件。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 使用[ArkUI\_NodeHandle](../../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md)对象作为ListItemGroup尾部组件。 |
...
[ListItemGroup](../../../../ArkTS组件/滚动与滑动/ListItemGroup/ts-container-listitemgroup.md)组件适配器，支持属性设置，属性重置和属性获取接口。
...
| 参数项 | 描述 |
| --- | --- |
| .object | 参数类型[ArkUI\_NodeHandle](../../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md)。 |
...
设置当下拉距离超过[refreshOffset](../../../../ArkTS组件/滚动与滑动/Refresh/ts-container-refresh.md#refreshoffset12)时是否触发刷新，支持属性设置，属性重置和属性获取接口。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 主轴方向，参数类型[ArkUI\_FlexDirection](../../native_type.h/capi-native-type-h.md#arkui_flexdirection)。默认值[ARKUI\_FLEX\_DIRECTION\_COLUMN](../../native_type.h/capi-native-type-h.md#arkui_flexdirection)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 主轴方向，参数类型[ArkUI\_FlexDirection](../../native_type.h/capi-native-type-h.md#arkui_flexdirection)。 |
...
设置当前瀑布流组件布局列的数量，不设置时默认1列，支持属性设置、重置和获取。例如，'1fr 1fr 2fr' 是将父组件分3列，将父组件允许的宽分为4等份，第1列占1份，第2列占1份，第3列占2份。可使用[columnsTemplate](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md#columnstemplate)('repeat(auto-fill,track-size)')根据给定的列宽track-size自动计算列数，其中repeat、auto-fill为关键字，track-size为可设置的宽度，支持的单位包括px、vp、%或有效数字，默认单位为vp。
...
设置当前瀑布流组件布局行的数量，不设置时默认1行，支持属性设置、重置和获取。例如，'1fr 1fr 2fr'是将父组件分3行，将父组件允许的高分为4等份，第1行占1份，第2行占1份，第3行占2份。可使用[rowsTemplate](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md#rowstemplate)('repeat(auto-fill,track-size)')根据给定的行高track-size自动计算行数，其中repeat、auto-fill为关键字，track-size为可设置的高度，支持的单位包括px、vp、%或有效数字，默认单位为vp。
...
| .object | 参数格式为[ArkUI\_WaterFlowSectionOption](../../../结构体/ArkUI_WaterFlowSectionOption/pi-arkui-nativemodule-arkui-waterflowsectionoption.md)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .object | 返回值格式为[ArkUI\_WaterFlowSectionOption](../../../结构体/ArkUI_WaterFlowSectionOption/pi-arkui-nativemodule-arkui-waterflowsectionoption.md)。 |
...
[WaterFlow](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)组件适配器，支持属性设置，属性重置和属性获取接口。
...
[WaterFlow](../../../../ArkTS组件/滚动与滑动/WaterFlow/ts-container-waterflow.md)组件Adapter缓存数量，支持属性设置，属性重置和属性获取接口。
...
| .value[0].i32 | 要滑动到的目标元素在当前容器中的索引值。 |
| .value[1]?.i32 | 设置滑动到列表项在列表中的索引值时是否有动效，1表示有动效，0表示没有动效。默认值：0。 |
| .value[2]?.i32 | 指定滑动到的元素与当前容器的对齐方式，参数类型[ArkUI\_ScrollAlignment](../../native_type.h/capi-native-type-h.md#arkui_scrollalignment)。默认值为：[ARKUI\_SCROLL\_ALIGNMENT\_START](../../native_type.h/capi-native-type-h.md#arkui_scrollalignment)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 布局模式，参数类型[ArkUI\_WaterFlowLayoutMode](../../native_type.h/capi-native-type-h.md#arkui_waterflowlayoutmode)，默认值：[ARKUI\_WATER\_FLOW\_LAYOUT\_MODE\_ALWAYS\_TOP\_DOWN](../../native_type.h/capi-native-type-h.md#arkui_waterflowlayoutmode)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 布局模式，参数类型[ArkUI\_WaterFlowLayoutMode](../../native_type.h/capi-native-type-h.md#arkui_waterflowlayoutmode)。 |
...
设置当前Grid组件布局列的数量，不设置时默认1列，支持属性设置、重置和获取。例如，'1fr 1fr 2fr' 是将父组件分3列，将父组件允许的宽分为4等份，第1列占1份，第2列占1份，第3列占2份。可使用[columnsTemplate](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md#columnstemplate)('repeat(auto-fill,track-size)')根据给定的列宽track-size自动计算列数，其中repeat、auto-fill为关键字，track-size为可设置的宽度，支持的单位包括px、vp、%或有效数字，默认单位为vp。
...
设置当前Grid布局行的数量或最小行高值，不设置时默认1行，支持属性设置、重置和获取。例如，'1fr 1fr 2fr'是将父组件分3行，将父组件允许的高分为4等份，第1行占1份，第2行占1份，第3行占2份。可使用[rowsTemplate](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md#rowstemplate)('repeat(auto-fill,track-size)')根据给定的行高track-size自动计算行数，其中repeat、auto-fill为关键字，track-size为可设置的高度，支持的单位包括px、vp、%或有效数字，默认单位为vp。
...
[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)组件适配器，支持属性设置，属性重置和属性获取接口。
...
[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)组件适配器缓存数量，支持属性设置，属性重置和属性获取接口。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 配合Grid组件适配器使用，设置[ArkUI\_NodeAdapter](../../../结构体/ArkUI_NodeAdapter/capi-arkui-nativemodule-arkui-nodeadapter8h.md)的缓存数量。 |
...
[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)组件走焦换行模式，支持属性设置，属性重置和属性获取接口。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | Grid组件走焦换行模式，参数类型[ArkUI\_FocusWrapMode](../../native_type.h/capi-native-type-h.md#arkui_focuswrapmode)。默认值：[FOCUS\_WRAP\_MODE\_DEFAULT](../../native_type.h/capi-native-type-h.md#arkui_focuswrapmode)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | Grid组件走焦换行模式，参数类型[ArkUI\_FocusWrapMode](../../native_type.h/capi-native-type-h.md#arkui_focuswrapmode)。 |
...
[Grid](../../../../ArkTS组件/滚动与滑动/Grid/ts-container-grid.md)组件是否同步加载子节点，支持属性设置，属性重置和属性获取接口。
...
设置Grid中[GridItem](../../../../ArkTS组件/滚动与滑动/GridItem/ts-container-griditem.md)的对齐方式，支持属性设置，属性重置和属性获取接口。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | Grid中GridItem的对齐方式，参数类型[ArkUI\_GridItemAlignment](../../native_type.h/capi-native-type-h.md#arkui_griditemalignment)。默认值：[GRID\_ITEM\_ALIGNMENT\_DEFAULT](../../native_type.h/capi-native-type-h.md#arkui_griditemalignment)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | Grid中GridItem的对齐方式，参数类型[ArkUI\_GridItemAlignment](../../native_type.h/capi-native-type-h.md#arkui_griditemalignment)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 参数格式为[ArkUI\_GridLayoutOptions](../../../结构体/ArkUI_GridLayoutOptions/capi-arkui-nativemodule-arkui-gridlayoutoptions.md)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .object | 返回值格式为[ArkUI\_GridLayoutOptions](../../../结构体/ArkUI_GridLayoutOptions/capi-arkui-nativemodule-arkui-gridlayoutoptions.md)。 |
...
| .value[2]?.i32 | 指定滑动到的目标元素与当前容器的对齐方式，参数类型[ArkUI\_ScrollAlignment](../../native_type.h/capi-native-type-h.md#arkui_scrollalignment)。默认值：ARKUI\_SCROLL\_ALIGNMENT\_AUTO。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | GridItem样式，参数类型[ArkUI\_GridItemStyle](../../native_type.h/capi-native-type-h.md#arkui_griditemstyle)。默认值：[GRID\_ITEM\_STYLE\_NONE](../../native_type.h/capi-native-type-h.md#arkui_griditemstyle)。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | GridItem样式，参数类型[ArkUI\_GridItemStyle](../../native_type.h/capi-native-type-h.md#arkui_griditemstyle)。 |
