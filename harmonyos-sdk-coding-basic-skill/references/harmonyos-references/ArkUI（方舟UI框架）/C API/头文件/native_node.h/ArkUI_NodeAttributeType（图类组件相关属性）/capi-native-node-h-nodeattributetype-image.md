...
scraped_at: 2026-06-01T15:49:15+08:00
doc_updated_at: 2026-04-30
content_hash: sha256:75d6a8509bc5f873a5f8ef9344cbd24ab88b2b7a2999eec63064d2fbdd441fdb
---
```
...
[image](../../../../ArkTS组件/图片与视频/Image/ts-basic-components-image.md)组件设置图片地址属性，支持属性设置，属性重置，属性获取接口。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示图片填充效果，取[ArkUI\_ObjectFit](../../native_type.h/capi-native-type-h.md#arkui_objectfit)枚举值。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示插值效果，取[ArkUI\_ImageInterpolation](../../native_type.h/capi-native-type-h.md#arkui_imageinterpolation)枚举值。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示图片重复样式，取[ArkUI\_ImageRepeat](../../native_type.h/capi-native-type-h.md#arkui_imagerepeat)枚举值。 |
...
| .object | 表示 PixelMap 图片数据，参数类型为[ArkUI\_DrawableDescriptor](../../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)；  .object参数和.string参数二选一，不可同时设置，不支持网络图片。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 参数类型[ArkUI\_ImageRenderMode](../../native_type.h/capi-native-type-h.md#arkui_imagerendermode)。 |
...
| .object | 参数类型为[OH\_Drawing\_Lattice](<../../../../../ArkGraphics 2D（方舟2D图形服务）/C API/结构体/OH_Drawing_Lattice/capi-drawing-oh-drawing-lattice.md>)。 |
...
| .value[1].i32 | 表示图片解码的高，单位px。当任意参数小于等于0时，属性设置失败并返回[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../../native_type.h/capi-native-type-h.md#arkui_errorcode)函数参数异常。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0...15].f32 | 4x4矩阵通过长度为16的浮点数数组来表示。当参数个数小于16，属性设置失败并返回[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../../native_type.h/capi-native-type-h.md#arkui_errorcode)函数参数异常；当参数个数大于16，只取前16个数据。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 支持图片拷贝的方式[ArkUI\_CopyOptions](../../native_type.h/capi-native-type-h.md#arkui_copyoptions)，默认值为ARKUI\_COPY\_OPTIONS\_NONE。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 支持图片拷贝的方式[ArkUI\_CopyOptions](../../native_type.h/capi-native-type-h.md#arkui_copyoptions)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 动态范围类型[ArkUI\_DynamicRangeMode](../../native_type.h/capi-native-type-h.md#arkui_dynamicrangemode)，默认值为ARKUI\_DYNAMIC\_RANGE\_MODE\_STANDARD。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 动态范围类型[ArkUI\_DynamicRangeMode](../../native_type.h/capi-native-type-h.md#arkui_dynamicrangemode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 期望的图像内容显示方向[ArkUI\_Orientation](../../native_type.h/capi-native-type-h.md#arkui_imagerotateorientation)，默认值为ARKUI\_ORIENTATION\_UP。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 期望的图像内容显示方向[ArkUI\_Orientation](../../native_type.h/capi-native-type-h.md#arkui_imagerotateorientation)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 自定义转场动效，参数类型[ArkUI\_ContentTransitionEffect](../../../结构体/ArkUI_ContentTransitionEffect/i-arkui-nativemodule-arkui-contenttransitioneffect.md)。 |
...
| .object | 表示PixelMap图片数据，参数类型为[ArkUI\_DrawableDescriptor](../../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)；  .object参数和.string参数二选一，不可同时设置，不支持网络图片。 |
...
| --- | --- |
| .string | 表示image组件加载过程中的占位图地址。 |
| .object | 表示PixelMap图片数据，参数类型为[ArkUI\_DrawableDescriptor](../../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)。 |
...
| --- | --- |
| .size | 图片帧的数量。 |
| .object | 图片帧数组，参数类型为[ArkUI\_ImageAnimatorFrameInfo](../../../结构体/ArkUI_ImageAnimatorFrameInfo/pi-arkui-nativemodule-arkui-imageanimatorframeinfo.md)数组。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 控制动画的播放状态，参数类型为[ArkUI\_AnimationStatus](../../native_type.h/capi-native-type-h.md#arkui_animationstatus)，默认值为初始状态。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 控制动画的播放状态，参数类型为[ArkUI\_AnimationStatus](../../native_type.h/capi-native-type-h.md#arkui_animationstatus)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 当前播放方向下，动画开始前和结束后的状态，参数类型为[ArkUI\_AnimationFillMode](../../native_type.h/capi-native-type-h.md#arkui_animationfillmode)，默认值为ARKUI\_ANIMATION\_FILL\_MODE\_FORWARDS。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 当前播放方向下，动画开始前和结束后的状态，参数类型为[ArkUI\_AnimationFillMode](../../native_type.h/capi-native-type-h.md#arkui_animationfillmode)。 |
