...
scraped_at: 2026-06-01T15:49:06+08:00
doc_updated_at: 2026-05-12
content_hash: sha256:cde38ff3634370d9238da347d2bbff4a89e2fc4c839cfdaa3e39edef0f939f84
---
```
...
设置Swiper的动画曲线，支持属性设置，属性重置和属性获取接口。未设置或未重置该属性时，动画曲线为[interpolatingSpring](<../../../../ArkTS API/UI界面/@ohos.curves (插值计算)/js-apis-curve.md#curvesinterpolatingspring10>)(-1, 1, 328, 34)；设置该属性异常时，取默认值ARKUI\_CURVE\_LINEAR。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 设置动画曲线参数，参数类型[ArkUI\_AnimationCurve](../../native_type.h/capi-native-type-h.md#arkui_animationcurve)，默认值为ARKUI\_CURVE\_LINEAR。 |
...
| --- | --- |
| .value[0].i32 | 子组件的索引值。 |
| .value[1]?.i32 | 跳转动画模式，参数类型[ArkUI\_SwiperAnimationMode](../../native_type.h/capi-native-type-h.md#arkui_swiperanimationmode)。仅当次调用有效。  该参数从API version 15开始支持。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 设置是否显示导航点箭头，参数类型[ArkUI\_SwiperArrow](../../native_type.h/capi-native-type-h.md#arkui_swiperarrow)，默认值为ARKUI\_SWIPER\_ARROW\_HIDE。 |
| .?object | 显示导航箭头时设置箭头样式，参数类型为[ArkUI\_SwiperArrowStyle](../../../结构体/ArkUI_SwiperArrowStyle/capi-arkui-nativemodule-arkui-swiperarrowstyle.md)。该参数从API version 19开始支持。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 设置是否显示导航点箭头，参数类型[ArkUI\_SwiperArrow](../../native_type.h/capi-native-type-h.md#arkui_swiperarrow)。 |
| .object | 箭头样式，参数类型为[ArkUI\_SwiperArrowStyle](../../../结构体/ArkUI_SwiperArrowStyle/capi-arkui-nativemodule-arkui-swiperarrowstyle.md)。该参数从API version 19开始支持。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 边缘滑动效果，参数类型[ArkUI\_EdgeEffect](../../native_type.h/capi-native-type-h.md#arkui_edgeeffect)，  默认值为ARKUI\_EDGE\_EFFECT\_SPRING。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 设置导航指示器的类型，参数类型[ArkUI\_SwiperIndicatorType](../../native_type.h/capi-native-type-h.md#arkui_swiperindicatortype)。 |
| .object | 导航指示器的类型为ARKUI\_SWIPER\_INDICATOR\_TYPE\_DOT时参数类型为[ArkUI\_SwiperIndicator](../../../结构体/ArkUI_SwiperIndicator/capi-arkui-nativemodule-arkui-swiperindicator.md)。  导航指示器的类型为ARKUI\_SWIPER\_INDICATOR\_TYPE\_DIGIT时参数类型为[ArkUI\_SwiperDigitIndicator](../../../结构体/ArkUI_SwiperDigitIndicator/capi-arkui-nativemodule-arkui-swiperdigitindicator.md)。  ArkUI\_SwiperDigitIndicator类型从API version 19开始支持。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 导航指示器的类型，参数类型[ArkUI\_SwiperIndicatorType](../../native_type.h/capi-native-type-h.md#arkui_swiperindicatortype)。 |
| .object | 导航指示器的类型为ARKUI\_SWIPER\_INDICATOR\_TYPE\_DOT时参数类型为[ArkUI\_SwiperIndicator](../../../结构体/ArkUI_SwiperIndicator/capi-arkui-nativemodule-arkui-swiperindicator.md)。  导航指示器的类型为ARKUI\_SWIPER\_INDICATOR\_TYPE\_DIGIT时参数类型为[ArkUI\_SwiperDigitIndicator](../../../结构体/ArkUI_SwiperDigitIndicator/capi-arkui-nativemodule-arkui-swiperdigitindicator.md)。  ArkUI\_SwiperDigitIndicator类型从API version 19开始支持。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | Swiper组件和父组件的嵌套滚动模式，参数类型[ArkUI\_SwiperNestedScrollMode](../../native_type.h/capi-native-type-h.md#arkui_swipernestedscrollmode)  默认值为：ARKUI\_SWIPER\_NESTED\_SRCOLL\_SELF\_ONLY。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | Swiper组件和父组件的嵌套滚动模式，参数类型[ArkUI\_SwiperNestedScrollMode](../../native_type.h/capi-native-type-h.md#arkui_swipernestedscrollmode)。 |
...
作为属性设置方法参数[ArkUI\_AttributeItem](../../../结构体/ArkUI_AttributeItem/capi-arkui-nativemodule-arkui-attributeitem.md)格式如下，作为属性获取方法返回值[ArkUI\_PageFlipMode](../../native_type.h/capi-native-type-h.md#arkui_pageflipmode)格式如下。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 设置组件鼠标滚轮翻页模式，参数类型[ArkUI\_PageFlipMode](../../native_type.h/capi-native-type-h.md#arkui_pageflipmode)。 |
