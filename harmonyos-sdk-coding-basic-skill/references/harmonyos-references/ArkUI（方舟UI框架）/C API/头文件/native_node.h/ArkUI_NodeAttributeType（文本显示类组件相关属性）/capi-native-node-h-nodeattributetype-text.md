...
scraped_at: 2026-06-01T15:49:11+08:00
doc_updated_at: 2026-05-18
content_hash: sha256:56996acfa7e095f2ecccb9f4ae404dceaa6be7fca637b264de97a166cdef3c5a
---
```
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 字体样式[ArkUI\_FontStyle](../../native_type.h/capi-native-type-h.md#arkui_fontstyle)，默认值为ARKUI\_FONT\_STYLE\_NORMAL。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 字体样式[ArkUI\_FontStyle](../../native_type.h/capi-native-type-h.md#arkui_fontstyle)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 字体粗细样式[ArkUI\_FontWeight](../../native_type.h/capi-native-type-h.md#arkui_fontweight)，默认值为ARKUI\_FONT\_WEIGHT\_NORMAL。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 字体粗细样式[ArkUI\_FontWeight](../../native_type.h/capi-native-type-h.md#arkui_fontweight)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 文本装饰线类型[ArkUI\_TextDecorationType](../../native_type.h/capi-native-type-h.md#arkui_textdecorationtype)，默认值为ARKUI\_TEXT\_DECORATION\_TYPE\_NONE。 |
| .value[1]?.u32 | 可选值，装饰线颜色，0xargb格式，形如 0xFFFF0000 表示红色。 |
| .value[2]?.i32 | 文本装饰线样式[ArkUI\_TextDecorationStyle](../../native_type.h/capi-native-type-h.md#arkui_textdecorationstyle)。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 文本装饰线类型[ArkUI\_TextDecorationType](../../native_type.h/capi-native-type-h.md#arkui_textdecorationtype)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示文本大小写类型[ArkUI\_TextCase](../../native_type.h/capi-native-type-h.md#arkui_textcase)，默认值为ARKUI\_TEXT\_CASE\_NORMAL。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 表示文本大小写类型[ArkUI\_TextCase](../../native_type.h/capi-native-type-h.md#arkui_textcase)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示文本水平对齐方式，取[ArkUI\_TextAlignment](../../native_type.h/capi-native-type-h.md#arkui_textalignment)枚举值。默认值为ARKUI\_TEXT\_ALIGNMENT\_START。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 表示文本水平对齐方式，取[ArkUI\_TextAlignment](../../native_type.h/capi-native-type-h.md#arkui_textalignment)枚举值。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示文本超长时的显示方式[ArkUI\_TextOverflow](../../native_type.h/capi-native-type-h.md#arkui_textoverflow)。默认值为ARKUI\_TEXT\_OVERFLOW\_NONE。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 表示文本超长时的显示方式。[ArkUI\_TextOverflow](../../native_type.h/capi-native-type-h.md#arkui_textoverflow)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 复制粘贴方式[ArkUI\_CopyOptions](../../native_type.h/capi-native-type-h.md#arkui_copyoptions)，默认值为ARKUI\_COPY\_OPTIONS\_NONE。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 复制粘贴方式[ArkUI\_CopyOptions](../../native_type.h/capi-native-type-h.md#arkui_copyoptions)。 |
...
| .value[1].i32 | 阴影类型[ArkUI\_ShadowType](../../native_type.h/capi-native-type-h.md#arkui_shadowtype)，默认值为ARKUI\_SHADOW\_TYPE\_COLOR。 |
...
| --- | --- |
| .value[0].f32 | 阴影模糊半径，单位为vp。 |
| .value[1].i32 | 阴影类型[ArkUI\_ShadowType](../../native_type.h/capi-native-type-h.md#arkui_shadowtype)。 |
...
| .value[1]?.i32 | 可选值，文本的字体粗细，参数类型[ArkUI\_FontWeight](../../native_type.h/capi-native-type-h.md#arkui_fontweight)。默认值为ARKUI\_FONT\_WEIGHT\_NORMAL。 |
| .value[2]?.i32 | 可选值，字体样式，参数类型[ArkUI\_FontStyle](../../native_type.h/capi-native-type-h.md#arkui_fontstyle)。默认值为ARKUI\_FONT\_STYLE\_NORMAL。 |
...
| .value[0].f32 | 文本尺寸，单位为fp。 |
| .value[1].i32 | 文本的字体粗细，参数类型[ArkUI\_FontWeight](../../native_type.h/capi-native-type-h.md#arkui_fontweight)。默认值为ARKUI\_FONT\_WEIGHT\_NORMAL。 |
| .value[2].i32 | 字体样式，参数类型[ArkUI\_FontStyle](../../native_type.h/capi-native-type-h.md#arkui_fontstyle)。默认值为ARKUI\_FONT\_STYLE\_NORMAL。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 参数类型[ArkUI\_TextHeightAdaptivePolicy](../../native_type.h/capi-native-type-h.md#arkui_textheightadaptivepolicy)。默认值为ARKUI\_TEXT\_HEIGHT\_ADAPTIVE\_POLICY\_MAX\_LINES\_FIRST。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 参数类型[ArkUI\_TextHeightAdaptivePolicy](../../native_type.h/capi-native-type-h.md#arkui_textheightadaptivepolicy)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 参数类型[ArkUI\_WordBreak](../../native_type.h/capi-native-type-h.md#arkui_wordbreak)。默认值为ARKUI\_WORD\_BREAK\_BREAK\_WORD。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 参数类型[ArkUI\_WordBreak](../../native_type.h/capi-native-type-h.md#arkui_wordbreak)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 参数类型[ArkUI\_EllipsisMode](../../native_type.h/capi-native-type-h.md#arkui_ellipsismode)。默认值为ARKUI\_ELLIPSIS\_MODE\_END。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 参数类型[ArkUI\_EllipsisMode](../../native_type.h/capi-native-type-h.md#arkui_ellipsismode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0...].i32 | 实体类型数组，参数类型[ArkUI\_TextDataDetectorType](../../native_type.h/capi-native-type-h.md#arkui_textdatadetectortype)。 |
...
Text组件使用格式化字符串对象设置文本内容属性，支持属性设置，属性重置，属性获取接口。配置自定义[OH\_Drawing\_Typography](<../../../../../ArkGraphics 2D（方舟2D图形服务）/C API/结构体/OH_Drawing_Typography/capi-drawing-oh-drawing-typography.md>)对象到Text组件，会跳过文本控件的布局测算阶段，需要注意：
...
| 参数项 | 描述 |
| --- | --- |
| .object | 表示 ArkUI\_StyledString 格式化字符串数据，参数类型为[ArkUI\_StyledString](../../../结构体/ArkUI_StyledString/capi-arkui-nativemodule-arkui-styledstring.md)。 |
...
| .value[1].i32 | 线性渐变的方向[ArkUI\_LinearGradientDirection](../../native_type.h/capi-native-type-h.md#arkui_lineargradientdirection)。设置除ARKUI\_LINEAR\_GRADIENT\_DIRECTION\_CUSTOM之外的线性渐变方向后，angle不生效。默认值：ARKUI\_LINEAR\_GRADIENT\_DIRECTION\_LEFT\_BOTTOM。 |
| .value[2].i32 | 为渐变的颜色重复着色，false表示不重复着色，true表示重复着色。默认值：false。 |
| .object | 参数类型为[ArkUI\_ColorStop](../../../结构体/ArkUI_ColorStop/capi-arkui-nativemodule-arkui-colorstop.md)。指定某百分比位置处的渐变色颜色，设置非法颜色直接跳过。 |
...
| .value[1].i32 | 线性渐变的方向[ArkUI\_LinearGradientDirection](../../native_type.h/capi-native-type-h.md#arkui_lineargradientdirection)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 文本内容垂直对齐方式[ArkUI\_TextVerticalAlignment](../../native_type.h/capi-native-type-h.md#arkui_textverticalalignment)，默认值：ARKUI\_TEXT\_VERTICAL\_ALIGNMENT\_BASELINE。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 文本内容垂直对齐方式[ArkUI\_TextVerticalAlignment](../../native_type.h/capi-native-type-h.md#arkui_textverticalalignment)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 文本内容区垂直对齐方式[ArkUI\_TextContentAlign](../../native_type.h/capi-native-type-h.md#arkui_textcontentalign)，默认值：ARKUI\_TEXT\_CONTENT\_ALIGN\_CENTER。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 文本内容区垂直对齐方式[ArkUI\_TextContentAlign](../../native_type.h/capi-native-type-h.md#arkui_textcontentalign)。 |
...
| 类型 | 说明 |
| --- | --- |
| .object | 文本布局管理器对象，参数类型为[ArkUI\_TextLayoutManager](../../../结构体/ArkUI_TextLayoutManager/capi-arkui-nativemodule-arkui-textlayoutmanager.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 文本菜单扩展项配置数据，参数类型为[ArkUI\_TextEditMenuOptions](../../../结构体/ArkUI_TextEditMenuOptions/capi-arkui-nativemodule-arkui-texteditmenuoptions.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 自定义文本选择菜单配置数据，参数类型为[ArkUI\_TextSelectionMenuOptions](../../../结构体/ArkUI_TextSelectionMenuOptions/-arkui-nativemodule-arkui-textselectionmenuoptions.md)。 |
...
| .object | 选择选项。参数类型为[ArkUI\_SelectionOptions](../../../结构体/ArkUI_SelectionOptions/capi-arkui-nativemodule-arkui-selectionoptions.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 文本跑马灯模式配置，参数类型为[ArkUI\_TextMarqueeOptions](../../../结构体/ArkUI_TextMarqueeOptions/capi-arkui-nativemodule-arkui-textmarqueeoptions.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示文本的排版方向，取[ArkUI\_TextDirection](../../native_type.h/capi-native-type-h.md#arkui_textdirection)枚举值。默认值为ARKUI\_TEXT\_DIRECTION\_DEFAULT。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 表示文本的排版方向，对应取值及含义请参考[ArkUI\_TextDirection](../../native_type.h/capi-native-type-h.md#arkui_textdirection)枚举值。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 文本选中状态下的拖拽预览样式。参数类型为[ArkUI\_SelectedDragPreviewStyle](../../../结构体/ArkUI_SelectedDragPreviewStyle/ui-nativemodule-arkui-textselecteddragpreviewstyle.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .string | 表示[span](../../../../ArkTS组件/文本与输入/Span/ts-basic-components-span.md)的文本内容。 |
...
| .value[2]?.i32 | 字体样式。可选。参数类型为[ArkUI\_FontStyle](../../native_type.h/capi-native-type-h.md#arkui_fontstyle)。默认值为ARKUI\_FONT\_STYLE\_NORMAL。 |
| ?.object | 字体配置。可选。参数类型为[OH\_ArkUI\_FontConfigs](../../../结构体/OH_ArkUI_FontConfigs/capi-arkui-nativemodule-oh-arkui-fontconfigs.md)。 |
...
| .value[2].i32 | 字体样式。参数类型为[ArkUI\_FontStyle](../../native_type.h/capi-native-type-h.md#arkui_fontstyle)。 |
| .object | 字体配置。参数类型为[OH\_ArkUI\_FontConfigs](../../../结构体/OH_ArkUI_FontConfigs/capi-arkui-nativemodule-oh-arkui-fontconfigs.md)。 |
...
| ?.object | 可选。文本字体粗细配置。参数类型为[OH\_ArkUI\_FontWeightConfigs](../../../结构体/OH_ArkUI_FontWeightConfigs/capi-arkui-nativemodule-oh-arkui-fontweightconfigs.md)。 |
...
| .object | 文本字体粗细配置。参数类型为[OH\_ArkUI\_FontWeightConfigs](../../../结构体/OH_ArkUI_FontWeightConfigs/capi-arkui-nativemodule-oh-arkui-fontweightconfigs.md)。 |
...
| .object | 表示 PixelMap 图片数据，参数类型为[ArkUI\_DrawableDescriptor](../../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)。  .object参数和.string参数二选一，不可同时设置。 |
...
| --- | --- |
| .string | 表示imageSpan的图片地址。 |
| .object | 表示 PixelMap 图片数据，参数类型为[ArkUI\_DrawableDescriptor](../../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示图片基于文本的对齐方式，取[ArkUI\_ImageSpanAlignment](../../native_type.h/capi-native-type-h.md#arkui_imagespanalignment)枚举值。 |
...
| .size | 表示滤镜数组大小为5x4。 |
| .object | 颜色滤波器指针，参数类型为[OH\_Drawing\_ColorFilter](<../../../../../ArkGraphics 2D（方舟2D图形服务）/C API/结构体/OH_Drawing_ColorFilter/capi-drawing-oh-drawing-colorfilter.md>)。  .object和.size参数只能二选一，不可同时设置。 |
...
| .value[0].f32 ~ .value[19].f32 | 表示滤镜矩阵数组。 |
| .size | 表示滤镜数组大小为5x4。 |
| .object | 颜色滤波器指针，参数类型为[OH\_Drawing\_ColorFilter](<../../../../../ArkGraphics 2D（方舟2D图形服务）/C API/结构体/OH_Drawing_ColorFilter/capi-drawing-oh-drawing-colorfilter.md>)。 |
