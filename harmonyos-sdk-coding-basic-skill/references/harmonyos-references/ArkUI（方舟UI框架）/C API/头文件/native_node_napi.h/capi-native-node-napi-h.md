...
scraped_at: 2026-06-11T15:54:23+08:00
doc_updated_at: 2026-06-09
content_hash: sha256:cb973b3d59e9213909d9a1b83aaeab0afb0c01ae3f7b9512ac731ae7492b9f67
---
## 概述

PhonePC/2in1TabletTVWearable

提供ArkTS侧的[FrameNode](<../../../ArkTS API/UI界面/arkui/FrameNode/js-apis-arkui-framenode.md>)转换[NodeHandle](../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md)的方式。
...
| [ArkUI\_NodeHandle](../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md)\* handle | ArkUI\_NodeHandle指针。 |
...
获取ArkTS侧创建的[UIContext](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (UIContext)/arkts-apis-uicontext-uicontext.md>)对象映射到Native侧的ArkUI\_ContextHandle。
...
| [ArkUI\_ContextHandle](../../结构体/ArkUI_Context/capi-arkui-nativemodule-arkui-context8h.md)\* context | ArkUI\_ContextHandle指针。 |
...
| [ArkUI\_NodeContentHandle](../../结构体/ArkUI_NodeContent/capi-arkui-nativemodule-arkui-nodecontent8h.md)\* content | ArkUI\_NodeContentHandle指针。 |
...
将ArkTS侧创建的[DrawableDescriptor](../../../ArkTS组件/图片与视频/Image/ts-basic-components-image.md#drawabledescriptor10)对象映射到Native侧的[ArkUI\_DrawableDescriptor](../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)。
...
| --- | --- |
| napi\_env env | napi的环境指针。 |
| napi\_value value | ArkTS侧创建的[DrawableDescriptor](../../../ArkTS组件/图片与视频/Image/ts-basic-components-image.md#drawabledescriptor10)对象。 |
| [ArkUI\_DrawableDescriptor](../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)\*\* drawableDescriptor | 接受ArkUI\_DrawableDescriptor指针的对象。 |
...
将ArkTS侧通过$r()获取的资源对象转换为Native侧可使用的[ArkUI\_DrawableDescriptor](../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)对象。
...
获取当前节点所在的[Navigation](../../../ArkTS组件/导航与切换/Navigation/ts-basic-components-navigation.md)组件的ID。
...
| int32\_t\* writeLength | 在返回[ARKUI\_ERROR\_CODE\_NO\_ERROR](../native_type.h/capi-native-type-h.md#arkui_errorcode)时表示实际写入到缓冲区的字符串长度。 在返回[ARKUI\_ERROR\_CODE\_BUFFER\_SIZE\_ERROR](../native_type.h/capi-native-type-h.md#arkui_errorcode)时表示可以容纳目标的最小缓冲区大小。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ErrorCode](../native_type.h/capi-native-type-h.md#arkui_errorcode) | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](../native_type.h/capi-native-type-h.md#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_GET\_INFO\_FAILED](../native_type.h/capi-native-type-h.md#arkui_errorcode) 查询信息失败，可能因为当前节点未挂载在页面下。  [ARKUI\_ERROR\_CODE\_BUFFER\_SIZE\_ERROR](../native_type.h/capi-native-type-h.md#arkui_errorcode) 数据大小超过指定的缓冲区大小。 |
...
获取当前节点所在的[NavDestination](../../../ArkTS组件/导航与切换/NavDestination/ts-basic-components-navdestination.md)组件的名称。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ErrorCode](../native_type.h/capi-native-type-h.md#arkui_errorcode) | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](../native_type.h/capi-native-type-h.md#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_NODE\_INDEX\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode) index为非法值。  [ARKUI\_ERROR\_CODE\_GET\_INFO\_FAILED](../native_type.h/capi-native-type-h.md#arkui_errorcode) 查询信息失败，可能因为当前节点未挂载在页面下。  [ARKUI\_ERROR\_CODE\_BUFFER\_SIZE\_ERROR](../native_type.h/capi-native-type-h.md#arkui_errorcode) 给定的buffer size小于可以容纳目标的最小缓冲区大小。 |
...
| --- | --- |
| [ArkUI\_NodeHandle](../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 指定的节点。 |
| [ArkUI\_NavDestinationState](../native_type.h/capi-native-type-h.md#arkui_navdestinationstate)\* state | NavDestination的状态值写回该参数中。 |
...
获取当前节点所在[Router](<../../../ArkTS API/UI界面/@ohos.arkui.UIContext (UIContext)/Class (Router)/arkts-apis-uicontext-router.md>)页面栈中的索引。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ErrorCode](../native_type.h/capi-native-type-h.md#arkui_errorcode) | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](../native_type.h/capi-native-type-h.md#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode) 指定的节点或传递的索引异常。  [ARKUI\_ERROR\_CODE\_GET\_INFO\_FAILED](../native_type.h/capi-native-type-h.md#arkui_errorcode) 查询信息失败，可能因为当前节点未挂载在页面下。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ErrorCode](../native_type.h/capi-native-type-h.md#arkui_errorcode) | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](../native_type.h/capi-native-type-h.md#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode) 函数参数异常。  [ARKUI\_ERROR\_CODE\_GET\_INFO\_FAILED](../native_type.h/capi-native-type-h.md#arkui_errorcode) 查询信息失败。  [ARKUI\_ERROR\_CODE\_BUFFER\_SIZE\_ERROR](../native_type.h/capi-native-type-h.md#arkui_errorcode) 给定的buffer size小于可以容纳目标的最小缓冲区大小。 |
...
| --- | --- |
| [ArkUI\_NodeHandle](../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) node | 指定的节点。 |
| [ArkUI\_RouterPageState](../native_type.h/capi-native-type-h.md#arkui_routerpagestate)\* state | Router页面的状态值写回该参数中。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ContextHandle](../../结构体/ArkUI_Context/capi-arkui-nativemodule-arkui-context8h.md) uiContext | [UIContext](../../../ArkTS组件/自定义组件/自定义组件内置方法/ts-custom-component-api.md#uicontext)对象指针，用以绑定实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ContextHandle](../../结构体/ArkUI_Context/capi-arkui-nativemodule-arkui-context8h.md) uiContext | UIContext对象，用以绑定实例。 |
