...
content_hash: sha256:77eb139ebf75e48ee41261c38cf63438064e72e9927a9570632a74e7c5e2b5d0
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkUI\_DrawableDescriptor](../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md) | ArkUI\_DrawableDescriptor | 定义DrawableDescriptor对象。 |
| [OH\_PixelmapNative](<../../../../Image Kit（图片处理服务）/C API/结构体/OH_PixelmapNative/capi-image-nativemodule-oh-pixelmapnative.md>) | - | 使用Image Kit定义的Native侧的OH\_PixelmapNative对象。 |
| [OH\_PixelmapNative\*](../../结构体/OH_PixelmapNative/capi-arkui-nativemodule-oh-pixelmapnative8h.md) | OH\_PixelmapNativeHandle | 定义OH\_PixelmapNative对象指针类型。 |
| [ArkUI\_Node](../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node-descriptor.md) | - | 定义ArkUI native组件实例对象。  **起始版本：** 22 |
| [ArkUI\_Node\*](../../结构体/ArkUI_Node/capi-arkui-nativemodule-arkui-node8h.md) | ArkUI\_NodeHandle | 定义ArkUI native组件实例对象指针定义。  **起始版本：** 22 |
| [ArkUI\_DrawableDescriptor\_AnimationController](../../结构体/ArkUI_DrawableDescriptor_AnimationController/capi-arkui-drawabledescriptoranimationcontroller.md) | ArkUI\_DrawableDescriptor\_AnimationController | 定义DrawableDescriptor动图控制器对象。  **起始版本：** 22 |
...
| [DrawableDescriptor\_AnimationStopMode](capi-drawable-descriptor-h.md#drawabledescriptor_animationstopmode) | DrawableDescriptor\_AnimationStopMode | 定义[DrawableDescriptor](../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)动图的停止模式。  **起始版本：** 24 |
...
定义[DrawableDescriptor](../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)动图的停止模式。
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PixelmapNativeHandle](../../结构体/OH_PixelmapNative/capi-arkui-nativemodule-oh-pixelmapnative8h.md) pixelMap | [OH\_PixelmapNative](../../结构体/OH_PixelmapNative/capi-struct.md)对象指针。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_DrawableDescriptor](../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)\* | 返回DrawableDescriptor对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH\_PixelmapNativeHandle](../../结构体/OH_PixelmapNative/capi-arkui-nativemodule-oh-pixelmapnative8h.md)\* array | PixelMap图片数组对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_DrawableDescriptor](../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)\* drawableDescriptor | DrawableDescriptor对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_PixelmapNativeHandle](../../结构体/OH_PixelmapNative/capi-arkui-nativemodule-oh-pixelmapnative8h.md) | [OH\_PixelmapNative](../../结构体/OH_PixelmapNative/capi-struct.md)对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH\_PixelmapNativeHandle](../../结构体/OH_PixelmapNative/capi-arkui-nativemodule-oh-pixelmapnative8h.md)\* | PixelMap图片数组指针。 |
...
| 类型 | 说明 |
| --- | --- |
| int32\_t | 错误码。  [ARKUI\_ERROR\_CODE\_NO\_ERROR](../native_type.h/capi-native-type-h.md#arkui_errorcode) 成功。  [ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode) 输入参数错误。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_DrawableDescriptor](../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)\* drawableDescriptor | [DrawableDescriptor](../../结构体/ArkUI_DrawableDescriptor/capi-arkui-nativemodule-arkui-drawabledescriptor.md)对象指针。 |
...
| [ArkUI\_DrawableDescriptor\_AnimationController](../../结构体/ArkUI_DrawableDescriptor_AnimationController/capi-arkui-drawabledescriptoranimationcontroller.md)\*\* controller | DrawableDescriptor动图控制器对象指针。 |
