...
scraped_at: 2026-06-01T15:48:45+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:4e5b1ffee3c8b5ce5677c99a4552de1ffcd33a3120a15ebd8c1f50c44795d89c
---
## 概述
...
| 枚举项 | 描述 |
| --- | --- |
| ARKUI\_NATIVE\_NODE = 0 | UI组件相关接口类型，详见[native\_node.h](../native_node.h/capi-native-node-h.md)中的[结构体](../native_node.h/capi-native-node-h.md#结构体)类型定义。 |
| ARKUI\_NATIVE\_DIALOG = 1 | 弹窗相关接口类型，详见[native\_dialog.h](../native_dialog.h/capi-native-dialog-h.md)中的[结构体](../native_dialog.h/capi-native-dialog-h.md#结构体)类型定义。 |
| ARKUI\_NATIVE\_GESTURE = 2 | 手势相关接口类型，详见[native\_gesture.h](../native_gesture.h/capi-native-gesture-h.md)中的[结构体](../native_gesture.h/capi-native-gesture-h.md#结构体)类型定义。 |
| ARKUI\_NATIVE\_ANIMATE = 3 | 动画相关接口类型。详见[native\_animate.h](../native_animate.h/capi-native-animate-h.md)中的[结构体](../native_animate.h/capi-native-animate-h.md#结构体)类型定义。 |
| ARKUI\_MULTI\_THREAD\_NATIVE\_NODE = 4 | 多线程UI组件相关接口类型，详见[native\_node.h](../native_node.h/capi-native-node-h.md)中的[结构体](../native_node.h/capi-native-node-h.md#结构体)类型定义。  **起始版本：** 22 |
...
| const char\* structName | native接口结构体的名称，通过查询对应头文件内结构体定义，例如位于[native\_node.h](../native_node.h/capi-native-node-h.md)中的"ArkUI\_NativeNodeAPI\_1"。 |
