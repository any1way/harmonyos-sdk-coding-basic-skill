...
scraped_at: 2026-06-01T15:49:47+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:8327b2fd904af66c6bb0fcb0afa276a7dc51214445ea890640590281574ae90b
---
## 概述
...
| 名称 | 描述 |
| --- | --- |
| [PictureInPicture\_PipConfig](../../结构体/PictureInPicture_PipConfig/capi-pictureinpicture-pipconfig.md) | 画中画参数配置器。 |
...
| int32\_t errcode | 画中画接口的通用状态码。具体可见[WindowManager\_ErrorCode](../oh_window_comm.h/capi-oh-window-comm-h.md#windowmanager_errorcode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [PictureInPicture\_PipConfig](../../结构体/PictureInPicture_PipConfig/capi-pictureinpicture-pipconfig.md)\* pipConfig | 用于接受创建的画中画参数配置器。 |
...
| 参数项 | 描述 |
| --- | --- |
| [PictureInPicture\_PipConfig](../../结构体/PictureInPicture_PipConfig/capi-pictureinpicture-pipconfig.md)\* pipConfig | 画中画参数配置器。 |
