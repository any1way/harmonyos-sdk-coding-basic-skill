...
scraped_at: 2026-06-11T15:54:11+08:00
doc_updated_at: 2026-06-05
content_hash: sha256:aced30206d674042b333b9f2f237063da1da54559e083da15e05efb2f82ea6b0
---
## 概述
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkUI\_ExpectedFrameRateRange](../../结构体/ArkUI_ExpectedFrameRateRange/capi-arkui-arkui-expectedframeraterange.md) | ArkUI\_ExpectedFrameRateRange | 设置动画的期望帧率。 |
| [ArkUI\_AnimateCompleteCallback](../../结构体/ArkUI_AnimateCompleteCallback/capi-arkui-arkui-animatecompletecallback.md) | ArkUI\_AnimateCompleteCallback | 动画播放结束回调类型。 |
| [ArkUI\_NativeAnimateAPI\_1](../../结构体/ArkUI_NativeAnimateAPI_1/capi-arkui-nativemodule-arkui-nativeanimateapi-1.md) | ArkUI\_NativeAnimateAPI\_1 | ArkUI提供的Native侧动画接口集合。 |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md) | ArkUI\_AnimateOption | 设置动画效果相关参数。 |
| [ArkUI\_Curve](../../结构体/ArkUI_Curve/capi-arkui-nativemodule-arkui-curve.md) | ArkUI\_Curve | 提供曲线的插值对象定义。 |
| [ArkUI\_Curve\*](../../结构体/ArkUI_Curve/capi-arkui-nativemodule-arkui-curve8h.md) | ArkUI\_CurveHandle | 定义曲线的插值对象指针定义。 |
| [ArkUI\_KeyframeAnimateOption](../../结构体/ArkUI_KeyframeAnimateOption/capi-arkui-arkui-keyframeanimateoption.md) | ArkUI\_KeyframeAnimateOption | 定义关键帧动画参数对象。 |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md) | ArkUI\_AnimatorOption | 定义animator动画参数对象。 |
| [ArkUI\_Animator\*](../../结构体/ArkUI_Animator/capi-arkui-nativemodule-arkui-animator8h.md) | ArkUI\_AnimatorHandle | 定义animator动画对象指针。 |
| [ArkUI\_AnimatorEvent](../../结构体/ArkUI_AnimatorEvent/capi-arkui-nativemodule-arkui-animatorevent.md) | ArkUI\_AnimatorEvent | 定义animator回调事件对象。 |
| [ArkUI\_AnimatorOnFrameEvent](../../结构体/ArkUI_AnimatorOnFrameEvent/capi-arkui-nativemodule-arkui-animatoronframeevent.md) | ArkUI\_AnimatorOnFrameEvent | 定义animator接收到帧时回调对象。 |
| [ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md) | ArkUI\_TransitionEffect | 定义transition属性配置转场参数对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md)\* | 新的动画效果参数指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md)\* option | 动画效果参数。  option为NULL时，操作无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md)\* option | 动画效果参数。  option为NULL时，返回0。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md)\* option | 动画效果参数。  option为NULL时，返回0.0。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md)\* option | 动画效果参数。  option为NULL时，返回-1。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_AnimationCurve](../native_type.h/capi-native-type-h.md#arkui_animationcurve) | 动画曲线。option异常时返回-1。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_AnimationPlayMode](../native_type.h/capi-native-type-h.md#arkui_animationplaymode) | 动画播放模式。option异常时返回-1。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md)\* option | 动画效果参数。  option为NULL时，返回NULL。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ExpectedFrameRateRange](../../结构体/ArkUI_ExpectedFrameRateRange/capi-arkui-arkui-expectedframeraterange.md)\* | 动画的期望帧率，单位为帧/秒（fps）。option异常时返回NULL。 |
...
| --- | --- |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md)\* option | 动画效果参数。  option为NULL时，操作无效。 |
| [ArkUI\_AnimationCurve](../native_type.h/capi-native-type-h.md#arkui_animationcurve) value | 动画曲线。默认值：[ARKUI\_CURVE\_LINEAR](../native_type.h/capi-native-type-h.md#arkui_animationcurve)，建议使用[ARKUI\_CURVE\_EASE\_IN\_OUT](../native_type.h/capi-native-type-h.md#arkui_animationcurve)获得更平滑的动画效果。  value值异常时，设置无效。 |
...
| --- | --- |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md)\* option | 动画效果参数。  option为NULL时，操作无效。 |
| [ArkUI\_AnimationPlayMode](../native_type.h/capi-native-type-h.md#arkui_animationplaymode) value | 动画播放模式。默认值：[ARKUI\_ANIMATION\_PLAY\_MODE\_NORMAL](../native_type.h/capi-native-type-h.md#arkui_animationplaymode)。  value值异常时，操作无效。 |
...
| --- | --- |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md)\* option | 动画效果参数。  option为NULL时，操作无效。 |
| [ArkUI\_ExpectedFrameRateRange](../../结构体/ArkUI_ExpectedFrameRateRange/capi-arkui-arkui-expectedframeraterange.md)\* value | 动画的期望帧率，单位为帧/秒（fps）。  value为NULL时，操作无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md)\* option | 设置动画效果相关参数。  option为NULL时，操作无效。 |
| [ArkUI\_CurveHandle](../../结构体/ArkUI_Curve/capi-arkui-nativemodule-arkui-curve8h.md) value | 动画曲线参数。  value为NULL时，操作无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md)\* option | 设置动画效果相关参数。  option为NULL时，返回NULL。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_CurveHandle](../../结构体/ArkUI_Curve/capi-arkui-nativemodule-arkui-curve8h.md) | 动画的动画曲线。参数option异常时返回NULL。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_KeyframeAnimateOption](../../结构体/ArkUI_KeyframeAnimateOption/capi-arkui-arkui-keyframeanimateoption.md)\* | 关键帧动画参数对象。size小于0时返回NULL，option异常时返回NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_KeyframeAnimateOption](../../结构体/ArkUI_KeyframeAnimateOption/capi-arkui-arkui-keyframeanimateoption.md)\* option | 关键帧动画参数对象。  option为NULL时，操作无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_KeyframeAnimateOption](../../结构体/ArkUI_KeyframeAnimateOption/capi-arkui-arkui-keyframeanimateoption.md)\* option | 关键帧动画参数。  option为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
...
| --- | --- |
| [ArkUI\_KeyframeAnimateOption](../../结构体/ArkUI_KeyframeAnimateOption/capi-arkui-arkui-keyframeanimateoption.md)\* option | 关键帧动画参数。  option为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
| int32\_t value | 动画播放次数。取值范围：[-1, +∞)，其中设置为0时不播放，-1表示无限次播放。默认值：1，表示播放一次。  value小于-1时，操作无效，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
...
设置关键帧动画播放完成回调。当关键帧动画[ArkUI\_KeyframeAnimateOption](../../结构体/ArkUI_KeyframeAnimateOption/capi-arkui-arkui-keyframeanimateoption.md)所有次数播放完成后调用。
...
| --- | --- |
| [ArkUI\_KeyframeAnimateOption](../../结构体/ArkUI_KeyframeAnimateOption/capi-arkui-arkui-keyframeanimateoption.md)\* option | 关键帧动画参数。  option为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
| [ArkUI\_ExpectedFrameRateRange](../../结构体/ArkUI_ExpectedFrameRateRange/capi-arkui-arkui-expectedframeraterange.md)\* frameRate | 关键帧动画的期望帧率。  frameRate为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
...
| int32\_t index | 状态索引值。  index小于0时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
...
| --- | --- |
| [ArkUI\_KeyframeAnimateOption](../../结构体/ArkUI_KeyframeAnimateOption/capi-arkui-arkui-keyframeanimateoption.md)\* option | 关键帧动画参数。  option为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
| [ArkUI\_CurveHandle](../../结构体/ArkUI_Curve/capi-arkui-nativemodule-arkui-curve8h.md) value | 该关键帧使用的动画曲线。默认值：[ARKUI\_CURVE\_EASE\_IN\_OUT](../native_type.h/capi-native-type-h.md#arkui_animationcurve)。 |
| int32\_t index | 状态索引值。取值范围：[0, size-1]，其中size为关键帧动画状态数。  index小于0或index超出范围时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_KeyframeAnimateOption](../../结构体/ArkUI_KeyframeAnimateOption/capi-arkui-arkui-keyframeanimateoption.md)\* option | 关键帧动画参数。  option为NULL时，返回0。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_KeyframeAnimateOption](../../结构体/ArkUI_KeyframeAnimateOption/capi-arkui-arkui-keyframeanimateoption.md)\* option | 关键帧动画参数。  option为NULL时，返回NULL。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ExpectedFrameRateRange](../../结构体/ArkUI_ExpectedFrameRateRange/capi-arkui-arkui-expectedframeraterange.md)\* | 关键帧动画参数的期望帧率。option异常时返回NULL。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_CurveHandle](../../结构体/ArkUI_Curve/capi-arkui-nativemodule-arkui-curve8h.md) | 动画曲线。参数异常时返回NULL。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* | animator动画对象参数指针。size小于0时返回NULL，option异常时返回NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画对象参数。  option为NULL时，操作无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画对象参数。  option为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
| int32\_t value | 播放的时长，单位为ms（毫秒），默认值0ms。取值范围：[0, +∞)。  value小于0时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
...
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画对象参数。  option为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
| [ArkUI\_AnimationFillMode](../native_type.h/capi-native-type-h.md#arkui_animationfillmode) value | 动画执行时组件在动画开始前和结束后的状态。默认值：[ARKUI\_ANIMATION\_FILL\_MODE\_FORWARDS](../native_type.h/capi-native-type-h.md#arkui_animationfillmode)。  value小于0时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
...
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画对象参数。  option为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
| [ArkUI\_AnimationDirection](../native_type.h/capi-native-type-h.md#arkui_animationdirection) value | 动画播放方向。  value小于0时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
...
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画对象参数。  option为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
| [ArkUI\_CurveHandle](../../结构体/ArkUI_Curve/capi-arkui-nativemodule-arkui-curve8h.md) value | 动画插值曲线。默认值：[ARKUI\_CURVE\_LINEAR](../native_type.h/capi-native-type-h.md#arkui_animationcurve)，建议使用[ARKUI\_CURVE\_EASE\_IN\_OUT](../native_type.h/capi-native-type-h.md#arkui_animationcurve)获得更平滑的动画效果。  value为NULL时，使用默认曲线[ARKUI\_CURVE\_LINEAR](../native_type.h/capi-native-type-h.md#arkui_animationcurve)。 |
...
当Animator动画为关键帧动画[ArkUI\_KeyframeAnimateOption](../../结构体/ArkUI_KeyframeAnimateOption/capi-arkui-arkui-keyframeanimateoption.md)时，此方法不生效。
...
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画对象参数。  option为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
| [ArkUI\_ExpectedFrameRateRange](../../结构体/ArkUI_ExpectedFrameRateRange/capi-arkui-arkui-expectedframeraterange.md)\* value | 期望的帧率范围对象。  value为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
...
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画对象参数。  option为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
| float time | 关键帧时间。取值范围：[0, 1], 必须是递增。默认值：按索引均匀分布（如第1帧为0.0，第2帧为0.5，第3帧为1.0）。  time小于0或time大于1时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
| float value | 关键帧数值。取值范围：(-∞, +∞)。 |
| int32\_t index | 关键帧的索引值。  index小于0时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
...
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画对象参数。  option为NULL时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
| [ArkUI\_CurveHandle](../../结构体/ArkUI_Curve/capi-arkui-nativemodule-arkui-curve8h.md) value | 动画插值曲线。默认值：NULL，表示线性插值。 |
| int32\_t index | 关键帧的索引值。  index小于0时，返回错误码[ARKUI\_ERROR\_CODE\_PARAM\_INVALID](../native_type.h/capi-native-type-h.md#arkui_errorcode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画参数。  option为NULL时，返回0。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画动画参数。option为NULL时，返回0。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画参数。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_AnimationFillMode](../native_type.h/capi-native-type-h.md#arkui_animationfillmode) | 动画执行时组件在动画开始前和结束后的状态。option异常时返回-1。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_AnimationDirection](../native_type.h/capi-native-type-h.md#arkui_animationdirection) | 动画播放方向。option异常时返回-1。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_CurveHandle](../../结构体/ArkUI_Curve/capi-arkui-nativemodule-arkui-curve8h.md) | 动画插值曲线。option异常时返回NULL。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_ExpectedFrameRateRange](../../结构体/ArkUI_ExpectedFrameRateRange/capi-arkui-arkui-expectedframeraterange.md)\* | 期望的帧率范围对象指针。函数参数异常时返回NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画对象参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_CurveHandle](../../结构体/ArkUI_Curve/capi-arkui-nativemodule-arkui-curve8h.md) | 动画插值曲线。函数参数异常时返回NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimatorEvent](../../结构体/ArkUI_AnimatorEvent/capi-arkui-nativemodule-arkui-animatorevent.md)\* event | 动画事件对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimatorOnFrameEvent](../../结构体/ArkUI_AnimatorOnFrameEvent/capi-arkui-nativemodule-arkui-animatoronframeevent.md)\* event | 动画事件对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimatorHandle](../../结构体/ArkUI_Animator/capi-arkui-nativemodule-arkui-animator8h.md) animatorHandle | animator动画对象。 |
| [ArkUI\_AnimatorOption](../../结构体/ArkUI_AnimatorOption/capi-arkui-nativemodule-arkui-animatoroption.md)\* option | animator动画参数。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_AnimationCurve](../native_type.h/capi-native-type-h.md#arkui_animationcurve) curve | 曲线类型。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_CurveHandle](../../结构体/ArkUI_Curve/capi-arkui-nativemodule-arkui-curve8h.md) | 曲线的插值对象指针。如果参数异常返回NULL。 |
...
构造弹簧曲线对象，曲线形状由弹簧参数决定，动画时长受[animation](capi-native-animate-h.md#oh_arkui_transitioneffect_setanimation)、[animateTo](../../结构体/ArkUI_NativeAnimateAPI_1/capi-arkui-nativemodule-arkui-nativeanimateapi-1.md#animateto)中的duration参数控制。
...
动画时间由曲线参数决定，不受[animation](capi-native-animate-h.md#oh_arkui_transitioneffect_setanimation)、[animateTo](../../结构体/ArkUI_NativeAnimateAPI_1/capi-arkui-nativemodule-arkui-nativeanimateapi-1.md#animateto)中的duration参数控制。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_CurveHandle](../../结构体/ArkUI_Curve/capi-arkui-nativemodule-arkui-curve8h.md) curveHandle | 曲线的插值对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md)\* | 组件转场时的透明度效果对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TranslationOptions](../../结构体/ArkUI_TranslationOptions/capi-arkui-nativemodule-arkui-translationoptions.md)\* translate | 组件转场时的平移参数对象。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md)\* | 组件转场时的平移效果对象。如果参数异常返回NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_ScaleOptions](../../结构体/ArkUI_ScaleOptions/capi-arkui-nativemodule-arkui-scaleoptions.md)\* scale | 组件转场时的缩放参数对象。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md)\* | 组件转场时的缩放效果对象。如果参数异常返回NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_RotationOptions](../../结构体/ArkUI_RotationOptions/capi-arkui-nativemodule-arkui-rotationoptions.md)\* rotate | 组件转场时的旋转参数对象。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md)\* | 组件转场时的旋转效果对象。如果参数异常返回NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TransitionEdge](../native_type.h/capi-native-type-h.md#arkui_transitionedge) edge | 平移类型。 |
...
如果不通过该函数构造[ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md)，则表明该效果在组件出现和消失时均生效。
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md)\* appear | 出现的转场效果。 |
| [ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md)\* disappear | 消失的转场效果。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| [ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md)\* | 非对称的转场效果对象。如果参数异常返回NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md)\* effect | 转场效果对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md)\* firstEffect | 转场效果。 |
| [ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md)\* secondEffect | 需要链式转场效果。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI\_TransitionEffect](../../结构体/ArkUI_TransitionEffect/capi-arkui-nativemodule-arkui-transitioneffect.md)\* effect | 转场效果。 |
| [ArkUI\_AnimateOption](../../结构体/ArkUI_AnimateOption/capi-arkui-nativemodule-arkui-animateoption.md)\* animation | 属性显示动画效果相关参数。 |
