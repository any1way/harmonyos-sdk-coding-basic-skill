...
scraped_at: 2026-06-01T15:49:46+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:7b94764b5cb94680b96db79412a0682f0d7abd73e149f0d398c615dc3d21480b
---
## 概述
...
| 参数项 | 描述 |
| --- | --- |
| [Input\_KeyEvent](<../../../../基础功能/Input Kit（多模输入服务）/C API/结构体/Input_KeyEvent/capi-input-input-keyevent.md>)\* keyEvent | 多模按键事件，具体可见[Input\_KeyEvent](<../../../../基础功能/Input Kit（多模输入服务）/C API/结构体/Input_KeyEvent/capi-input-input-keyevent.md>)，事件定义在oh\_input\_manager中。 |
...
| 类型 | 说明 |
| --- | --- |
| [WindowManager\_ErrorCode](../oh_window_comm.h/capi-oh-window-comm-h.md#windowmanager_errorcode) | 返回窗口管理接口的通用状态码，具体可见[WindowManager\_ErrorCode](../oh_window_comm.h/capi-oh-window-comm-h.md#windowmanager_errorcode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Input\_MouseEvent](<../../../../基础功能/Input Kit（多模输入服务）/C API/结构体/Input_MouseEvent/capi-input-input-mouseevent.md>)\* mouseEvent | 多模鼠标事件，具体可见[Input\_MouseEvent](<../../../../基础功能/Input Kit（多模输入服务）/C API/结构体/Input_MouseEvent/capi-input-input-mouseevent.md>)，事件定义在oh\_input\_manager中。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Input\_TouchEvent](<../../../../基础功能/Input Kit（多模输入服务）/C API/结构体/Input_TouchEvent/capi-input-input-touchevent.md>)\* touchEvent | 多模触摸事件，具体可见[Input\_TouchEvent](<../../../../基础功能/Input Kit（多模输入服务）/C API/结构体/Input_TouchEvent/capi-input-input-touchevent.md>)，事件定义在oh\_input\_manager中。 |
