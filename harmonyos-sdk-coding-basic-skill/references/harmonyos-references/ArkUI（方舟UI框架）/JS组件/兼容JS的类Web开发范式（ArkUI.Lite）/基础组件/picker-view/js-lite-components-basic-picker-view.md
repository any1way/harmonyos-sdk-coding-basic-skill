...
scraped_at: 2026-06-11T15:53:09+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:b2fcd61649e001706688079d64b5b1611ad26d6adb64e6ff432e3b4a4c1439e7
---
...
4. Selected：{{time}}
5. </text>
6. <picker-view class="time-picker" type="time" ref="pickerViewObj" selected="{{defaultTime}}" @change="handleChange"></picker-view>
7. </div>
```
...
24. },
25. onShow() {
26. this.$refs.pickerViewObj.rotation({focus: true})
27. },
28. onHide() {
29. this.$refs.pickerViewObj.rotation({focus: false})
30. }
31. }
```

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/4Uk3_49ZR5qCEIJbhkN13w/zh-cn_image_0000002622700443.png?HW-CC-KV=V1&HW-CC-Date=20260611T075308Z&HW-CC-Expire=86400&HW-CC-Sign=C95F3531DA7959CB4F671448AD6BA650C93D089F265C9E654A1D1D9BB2FFB5C6)
