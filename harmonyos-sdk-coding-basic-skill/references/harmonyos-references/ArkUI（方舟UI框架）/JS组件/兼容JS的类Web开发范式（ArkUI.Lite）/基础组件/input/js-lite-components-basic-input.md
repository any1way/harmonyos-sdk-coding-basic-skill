...
scraped_at: 2026-06-11T15:53:07+08:00
doc_updated_at: 2026-04-03
content_hash: sha256:bfdbe8dee0972fc2baa77b8e85d862cea08b77bd207959a388144d583b009902
---
交互式组件，包括单选框，多选框，按钮。
...
| 名称 | 类型 | 默认值 | 必填 | 描述 |
| --- | --- | --- | --- | --- |
| type | string | button | 否 | input组件类型，可选值为button，checkbox，radio，text。  button，checkbox，radio，text不支持动态修改。可选值定义如下：  - button：定义可点击的按钮。  - checkbox：定义多选框。  - radio：定义单选按钮，允许在多个拥有相同name值的选项中选中其中一个。  - text：定义用于文字输入的文本框，仅在支持输入法功能的真机设备上，支持点击拉起文字输入界面，[UI预览](../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发调试调优/UI预览/ui-ide-previewer.md)无效果。 |
...
* 当input类型为checkbox、radio时，支持如下事件：
  ...
  | click | - | 点击动作触发该事件。 |
  | longpress | - | 长按动作触发该事件。 |
  | swipe5+ | [SwipeEvent](../../组件通用信息/通用事件/js-lite-common-events.md) | 组件上快速滑动后触发。 |
...
1. type为button
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/MEU-LiiiS0K45Wq22XUsJQ/zh-cn_image_0000002622700441.png?HW-CC-KV=V1&HW-CC-Date=20260611T075306Z&HW-CC-Expire=86400&HW-CC-Sign=E73490ACB610D98B95E0F3001D6FA1F070335543A742B2F9B892161EFD8DEA95)
2. type为checkbox
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/jegd-4QWTuCpGP8AOpmfYg/zh-cn_image_0000002592220882.gif?HW-CC-KV=V1&HW-CC-Date=20260611T075306Z&HW-CC-Expire=86400&HW-CC-Sign=AD1374F17446D4772062CAB5FF3EDEA0BE0D3BBC70D03B283ACDC6612FE7A628)
3. type为radio
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/RyKeeMI-TIqCILzUvHSbmw/zh-cn_image_0000002592380814.gif?HW-CC-KV=V1&HW-CC-Date=20260611T075306Z&HW-CC-Expire=86400&HW-CC-Sign=90E53105CF26172C4DD2F359E1CF9B960419580A3A4732EFF57A301FDFD4824A)
