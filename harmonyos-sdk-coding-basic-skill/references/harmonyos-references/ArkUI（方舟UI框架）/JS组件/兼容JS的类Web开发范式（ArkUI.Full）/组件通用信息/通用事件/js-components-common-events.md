...
scraped_at: 2026-06-01T15:45:44+08:00
doc_updated_at: 2026-05-14
content_hash: sha256:098b04952d73f681e1e07f8282fc26b971f3a008714a71d9e96bcc9f6c2b4915
---
说明
...
除上述事件外，其他事件均为非冒泡事件，如[input的change事件](../../基础组件/input/js-components-basic-input.md#事件)，详见各个组件。
...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| dataSet6+ | Object | 组件上通过通用属性设置的[data-\*](../通用属性/js-components-common-attributes.md#常规属性)的自定义属性组成的集合。 |
...
| 参数名 | 参数类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| pixelMap | [PixelMap](<../../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 是 | 前端传入的图片资源。 |
