...
scraped_at: 2026-06-01T15:45:49+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:b864d32cc690e37540f4864ff6e381443002f17756eb3066863af36c0a56b819
---
...
* 项目中的字体文件：通过url指定项目中的字体文件路径(只支持绝对路径，详情请参见[资源和文件访问规则](<../../../../../../harmonyos-guides/应用框架/ArkUI（方舟UI框架）/UI开发 (兼容JS的类Web开发范式)/框架说明/文件组织/js-framework-file.md#文件访问规则>)章节)。
* 不支持设置多个src。
