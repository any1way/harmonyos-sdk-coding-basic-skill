...
scraped_at: 2026-06-11T15:52:31+08:00
doc_updated_at: 2026-03-23
content_hash: sha256:dd45e752955e6c22b2fb5794e087e88422c03db545d272e8223595f8c7819937
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/84/v3/irFvqc6GTfCquaobR7SiCQ/zh-cn_image_0000002592380660.gif?HW-CC-KV=V1&HW-CC-Date=20260611T075230Z&HW-CC-Expire=86400&HW-CC-Sign=F34C27E00256B652CA81CBC8E038F39D54B4881E53F121C7AD53BD4EF63C95CF)

## 自定义组件数据

PhonePC/2in1TabletTVWearable

自定义组件的js文件中可以通过声明data、props、computed等字段完成数据的定义、传递与处理，其中props与computed的具体使用请参考[数据传递与处理](../数据传递与处理/js-components-custom-props.md)章节。
