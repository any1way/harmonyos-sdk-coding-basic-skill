...
scraped_at: 2026-06-01T15:46:47+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:68cd5d6f9732af08f424aad74113420cda16da73468f6bd9ab315aa5b2648585
---
说明

从API version 4开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

ImageData对象可以存储[canvas组件](../canvas组件/js-components-canvas-canvas.md)渲染的像素数据。
