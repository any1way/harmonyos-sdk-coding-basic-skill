...
content_hash: sha256:879247c0a8839a53075f236c3bd1fa2f4b1c3d61df93616d391c05a9e37369a0
---
说明
...
| font-style | string | normal | 否 | 字体样式，仅设置texton和textoff生效。见text组件[font-style的样式属性](../text/js-components-basic-text.md#样式)。 |
| font-weight | number | string | normal | 否 | 字体粗细，仅设置texton和textoff生效。见text组件的[font-weight的样式属性](../text/js-components-basic-text.md#样式)。 |
| font-family | string | sans-serif | 否 | 字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](../../组件通用信息/自定义字体样式/js-components-common-customizing-font.md)指定的字体，会被选中作为文本的字体。仅设置texton和textoff生效。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/VxGMjnmiTDePUG0bDYl5dA/zh-cn_image_0000002622700233.gif?HW-CC-KV=V1&HW-CC-Date=20260611T075147Z&HW-CC-Expire=86400&HW-CC-Sign=8693FB1758E7CE9FA935C316C3415EE40D0C9F102BE03098DDC89FBF765CF207)
