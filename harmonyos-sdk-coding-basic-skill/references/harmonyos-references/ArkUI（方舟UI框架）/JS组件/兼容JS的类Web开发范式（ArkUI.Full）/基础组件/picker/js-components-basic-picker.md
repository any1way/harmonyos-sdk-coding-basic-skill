...
scraped_at: 2026-06-11T15:51:37+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:129be4c503ed087b163bc1bc6154175a666baff5cc587ae22bdc77b876e4e549
---
说明
...
| letter-spacing | <length> | 0 | 否 | 选择器的字符间距。见[text组件的letter-spacing样式属性](../text/js-components-basic-text.md#样式)。 |
| text-decoration | string | - | 否 | 选择器的文本修饰。见[text组件的text-decoration样式属性](../text/js-components-basic-text.md#样式)。 |
| font-style | string | normal | 否 | 选择器的字体样式。见[text组件的font-style样式属性](../text/js-components-basic-text.md#样式)。 |
| font-weight | number | string | normal | 否 | 选择器的字体粗细。见[text组件的font-weight样式属性](../text/js-components-basic-text.md#样式)。 |
| font-family | string | sans-serif | 否 | 选择器的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](../../组件通用信息/自定义字体样式/js-components-common-customizing-font.md)指定的字体，会被选中作为文本的字体。 |
...
除支持[通用方法](../../组件通用信息/通用方法/js-components-common-methods.md)外，支持如下方法：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0a/v3/C0s8bQRNQF2L2j06pZbYXw/zh-cn_image_0000002592380598.gif?HW-CC-KV=V1&HW-CC-Date=20260611T075136Z&HW-CC-Expire=86400&HW-CC-Sign=7F09797E8C4BE394BA65A07A635849725BF24B2A42352A06F565CDDD11D0BCA9)
