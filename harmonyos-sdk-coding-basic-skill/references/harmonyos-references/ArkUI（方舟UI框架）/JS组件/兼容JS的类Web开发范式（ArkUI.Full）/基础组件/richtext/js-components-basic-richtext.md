...
scraped_at: 2026-06-01T15:46:27+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:4274d048c7ef93a174f2a674377498a01d93a84b17004b1542f74cec8d063212
---
说明
...
仅支持[通用属性](../../组件通用信息/通用属性/js-components-common-attributes.md)中的id、style和class属性。

## 样式

PhonePC/2in1TabletTVWearable

仅支持[通用样式](../../组件通用信息/通用样式/js-components-common-styles.md)中的display和visibility样式。
