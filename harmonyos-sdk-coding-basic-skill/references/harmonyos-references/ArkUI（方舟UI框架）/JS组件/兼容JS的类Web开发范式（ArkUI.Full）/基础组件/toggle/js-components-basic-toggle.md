...
scraped_at: 2026-06-11T15:51:54+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:7e3c78e8cca765f1a9b8a0262a4b5e06b99460b79574c79ee3b58742ac36d2ce
---
说明
...
| font-weight | number | string | normal | 否 | 状态按钮的字体粗细。见[text组件font-weight的样式属性](../text/js-components-basic-text.md#样式)。 |
| font-family | <string> | sans-serif | 否 | 状态按钮的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](../../组件通用信息/自定义字体样式/js-components-common-customizing-font.md)指定的字体，会被选中作为文本的字体。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/z45CjpehS9uh9fAAB69rrA/zh-cn_image_0000002622700235.png?HW-CC-KV=V1&HW-CC-Date=20260611T075153Z&HW-CC-Expire=86400&HW-CC-Sign=CF0715C3CEBAF845A1AE40BECC3A5077D6A313849E41B281C5AABAAEA0AD47C7)
