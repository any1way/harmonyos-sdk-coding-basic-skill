...
scraped_at: 2026-06-11T15:51:46+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:da045d08464c6c5bcdcec5fa8cf09b21ba9442ecb6869a22f03785378fc98f1d
---
...
支持<[option](../option/js-components-basic-option.md)>。
...
| 名称 | 类型 | 必填 | 描述 |
| --- | --- | --- | --- |
| font-family | string | 否 | 字体样式列表，用逗号分隔。列表中第一个系统中存在的字体样式或者通过[自定义字体](../../组件通用信息/自定义字体样式/js-components-common-customizing-font.md)指定的字体样式，会被选中作为当前文本的字体样式。  默认值：sans-serif |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/88/v3/6yLLLoYqQTyxVU3TQANKfA/zh-cn_image_0000002592220672.png?HW-CC-KV=V1&HW-CC-Date=20260611T075145Z&HW-CC-Expire=86400&HW-CC-Sign=E2E9D7E8843E1D08D7B8FF1DA499F9015968090701800172BC19B79852AFBFF0)
