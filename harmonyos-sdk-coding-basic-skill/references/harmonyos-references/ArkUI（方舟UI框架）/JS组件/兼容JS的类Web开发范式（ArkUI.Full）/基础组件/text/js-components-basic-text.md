...
scraped_at: 2026-06-11T15:51:50+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:ce10c74511d7d1a55337085830db53629597e2b7d377eaaa059c7d1d322f8af6
---
说明
...
| allow-scale | boolean | true | 否 | 文本尺寸是否跟随系统设置字体缩放尺寸进行放大缩小。  如果需要支持动态生效，请参看config[配置文件的内部结构](../../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（FA模型）/应用配置文件概述（FA模型）/application-configuration-file-overview-fa.md#配置文件的内部结构)中config-changes标签。 |
...
| font-family | string | sans-serif | 否 | 设置文本的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](../../组件通用信息/自定义字体样式/js-components-common-customizing-font.md)指定的字体，会被选中作为文本的字体。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/44NqhvIPTXe5O6jaJyhWkA/zh-cn_image_0000002592220674.png?HW-CC-KV=V1&HW-CC-Date=20260611T075149Z&HW-CC-Expire=86400&HW-CC-Sign=97CCE9A5185D57922C35DB77C7070F45C79FC385A7B0A9CBFBCBD4E4077FBA86)
