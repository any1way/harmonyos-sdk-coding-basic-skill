...
scraped_at: 2026-06-11T15:51:33+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:feb6c3ee7a7929c6162ee6c716fc7d42cfde2ec7e4394b610e9704292344b3cd
---
说明
...
| font-weight | number | string | normal | 否 | 设置跑马灯中文字的字体的粗细，见[text组件font-weight的样式属性](../text/js-components-basic-text.md#样式)。 |
| font-family | string | sans-serif | 否 | 设置跑马灯中文字的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](../../组件通用信息/自定义字体样式/js-components-common-customizing-font.md)指定的字体，会被选中作为文本的字体。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/FlQlPjsSS2y0vH6Wa4KYdw/zh-cn_image_0000002622700225.gif?HW-CC-KV=V1&HW-CC-Date=20260611T075132Z&HW-CC-Expire=86400&HW-CC-Sign=6E46E63931A0E4EC9DBF9085A1B4C4BA7D12F561BD1C1E8586EEDB2985790808)
