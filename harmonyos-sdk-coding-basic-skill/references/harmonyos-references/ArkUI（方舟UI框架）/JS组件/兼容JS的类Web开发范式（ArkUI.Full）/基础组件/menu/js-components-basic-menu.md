...
scraped_at: 2026-06-11T15:51:35+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:f6046c6fd72ddfe5280d725244e083ffb42fcb50888a0b43d80154fad444755e
---
说明
...
<[option](../option/js-components-basic-option.md)>子组件。
...
| font-style | string | normal | 否 | 设置菜单的字体样式。见[text组件font-style的样式属性](../text/js-components-basic-text.md#样式)。 |
| font-weight | number | string | normal | 否 | 设置菜单的字体粗细。见[text组件font-weight的样式属性](../text/js-components-basic-text.md#样式)。 |
| font-family | string | sans-serif | 否 | 设置菜单的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](../../组件通用信息/自定义字体样式/js-components-common-customizing-font.md)指定的字体，会被选中作为文本的字体。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/9DNfwJYVRK2cUTTpikkXhA/zh-cn_image_0000002592220666.png?HW-CC-KV=V1&HW-CC-Date=20260611T075134Z&HW-CC-Expire=86400&HW-CC-Sign=23013A4AECE9F6CEBE5A6A329C251D6A053AFA5289EB1531C7586A9161069503)
