...
scraped_at: 2026-06-11T15:51:52+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:701e7d14277ebd7f3e5e1bb3e8a7b20dfa8eb24a46942cef7b1b46e3b755983a
---
说明

从API version 5开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。

工具栏[toolbar](../toolbar/js-components-basic-toolbar.md)子组件。 用于展示工具栏上的一个操作选项。
...
| font-family | string | sans-serif | 否 | 字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](../../组件通用信息/自定义字体样式/js-components-common-customizing-font.md)指定的字体，会被选中作为文本的字体。 |
| background | <linear-gradient> | - | 否 | 仅支持设置[渐变样式](../../组件通用信息/渐变样式/js-components-common-gradient.md)，与background-color、background-image不兼容。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/TVuqroHBSj2wTX24QMvwlw/zh-cn_image_0000002622860117.jpg?HW-CC-KV=V1&HW-CC-Date=20260611T075151Z&HW-CC-Expire=86400&HW-CC-Sign=4353D3EBFAA44931A11C44909ADB438BDDF7A764745C218558A35811133CF8DC)
