...
content_hash: sha256:b2a97b30a84fa5fd76f139bf4b267bafb981539204fdc929d3f4d98d0a6f26eb
---
说明
...
| font-weight | number | string | normal | 否 | 按钮的字体粗细。见[text组件font-weight的样式属性](../text/js-components-basic-text.md#样式)。 |
| font-family | <string> | sans-serif | 否 | 按钮的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](../../组件通用信息/自定义字体样式/js-components-common-customizing-font.md)指定的字体，会被选中作为文本的字体。 |
...
除支持[通用样式](../../组件通用信息/通用样式/js-components-common-styles.md)中background-color、opacity、display、visibility、position、[left|top|right|bottom]外，还支持如下样式：
...
| font-weight | number | string | normal | 否 | 弧形按钮的字体粗细。见[text组件font-weight的样式属性](../text/js-components-basic-text.md#样式)。 |
| font-family | <string> | sans-serif | 否 | 按钮的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](../../组件通用信息/自定义字体样式/js-components-common-customizing-font.md)指定的字体，会被选中作为文本的字体。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/vEh7mKXYRcCFMDVLtfqYIw/zh-cn_image_0000002622860101.png?HW-CC-KV=V1&HW-CC-Date=20260611T075126Z&HW-CC-Expire=86400&HW-CC-Sign=117B5759F3940951510151CB5B0F237AF652756D82AC9B8F845D76CBF277C56A)
