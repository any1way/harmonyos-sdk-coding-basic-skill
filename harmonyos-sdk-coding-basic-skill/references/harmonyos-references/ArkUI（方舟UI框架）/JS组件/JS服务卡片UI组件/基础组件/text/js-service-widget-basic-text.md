...
scraped_at: 2026-06-11T15:53:55+08:00
doc_updated_at: 2026-03-09
content_hash: sha256:12472a405edf6a493de77d9f0f49fee73a71adc3b922efa6922c0e1394eb3fa4
---
文本，用于呈现一段信息。
...
支持<[span](../span/js-service-widget-basic-span.md)>。
...
| font-family | string | sans-serif | 否 | 设置文本的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](../../组件通用信息/自定义字体样式/js-service-widget-common-customizing-font.md)指定的字体，会被选中作为文本的字体。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/2BDXTTSpSdqxlaiVJee8Bg/zh-cn_image_0000002622860347.png?HW-CC-KV=V1&HW-CC-Date=20260611T075354Z&HW-CC-Expire=86400&HW-CC-Sign=B49D594090372FC3493AAE0AB4B16B1BBA43AA60F130AF69F2383947DF008938)
