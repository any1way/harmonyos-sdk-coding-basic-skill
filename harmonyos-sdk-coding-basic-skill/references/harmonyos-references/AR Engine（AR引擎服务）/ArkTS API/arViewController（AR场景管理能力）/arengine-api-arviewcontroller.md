...
scraped_at: 2026-06-01T16:26:35+08:00
doc_updated_at: 2026-05-12
content_hash: sha256:2bb903e8c0d10d9fa066926e55158b59e83037a4292ae7b4bb0e74fd015c9426
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scene | [Scene](<../../../ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/Scene/js-apis-inner-scene.md#scene-1>) | 是 | AR呈现场景，用于管理空间节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Scene](<../../../ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/Scene/js-apis-inner-scene.md#scene-1>) | AR呈现场景，用于管理空间节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [arEngine.ARSession](../arEngine（AR增强现实能力）/arengine-api-arengine.md#arsession) | undefined | 获得的AR会话内容，AR会话正常设置之后返回为arEngine.ARSession，异常设置或异常操作导致ARViewContext未初始化成功，返回undefined。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| conf | [arEngine.ARConfig](../arEngine（AR增强现实能力）/arengine-api-arengine.md#arconfig) | 是 | [ARSession](../arEngine（AR增强现实能力）/arengine-api-arengine.md#arsession)的功能配置参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resourcePath | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 是 | 存储模型的路径。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [Node](<../../../ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneNode/js-apis-inner-scene-nodes.md#node>) | 是 | 新建锚点对应的AR场景节点。  **说明：** Node属于AGP（Ark Graphics Platform）渲染引擎能力，使用了AGP齐世界坐标系，与AR Engine所使用的重力对齐世界坐标系不一致，与anchor参数一同使用时需注意区分。具体参见[坐标系说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine简介/arengine-overview.md#坐标系说明>)。 |
| type | [arEngine.ARBlendShapeType](../arEngine（AR增强现实能力）/arengine-api-arengine.md#arblendshapetype) | 是 | 微表情类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Vec3](<../../../ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneType/js-apis-inner-scene-types.md#vec3>) | 是 | 位姿坐标信息 |
| rotation | [Quaternion](<../../../ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneType/js-apis-inner-scene-types.md#quaternion>) | 是 | 位姿朝向信息。 |

**返回值：**

| **类型** | **说明** |
| --- | --- |
| [arEngine.ARPose](../arEngine（AR增强现实能力）/arengine-api-arengine.md#arpose) | null | 转换后的位姿信息，若传入参数无效或创建[ARPose](../arEngine（AR增强现实能力）/arengine-api-arengine.md#arpose)对象失败则返回null。 |
...
| node | [Node](<../../../ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneNode/js-apis-inner-scene-nodes.md#node>) | 是 | 新建锚点对应的AR场景节点。  **说明：** Node属于AGP（Ark Graphics Platform）渲染引擎能力，使用了AGP齐世界坐标系，与AR Engine所使用的重力对齐世界坐标系不一致，与anchor参数一同使用时需注意区分。具体参见[坐标系说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine简介/arengine-overview.md#坐标系说明>)。 |
| anchor | [arEngine.ARAnchor](../arEngine（AR增强现实能力）/arengine-api-arengine.md#aranchor) | 是 | 新平面对应的新创建的锚点。  **说明：** [ARAnchor](../arEngine（AR增强现实能力）/arengine-api-arengine.md#aranchor)的位姿使用了AR Engine重力对齐世界坐标系。具体参见[坐标系说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine简介/arengine-overview.md#坐标系说明>)。 |
...
| ctx | [ARViewContext](arengine-api-arviewcontroller.md#arviewcontext) | 是 | 当前ARView的上下文信息（ARViewContext）。 |
| node | [Node](<../../../ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneNode/js-apis-inner-scene-nodes.md#node>) | 是 | 新建锚点对应的AR场景节点。  **说明：** Node属于AGP（Ark Graphics Platform）渲染引擎能力，使用了AGP齐世界坐标系，与AR Engine所使用的重力对齐世界坐标系不一致，与anchor参数一同使用时需注意区分。具体参见[坐标系说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine简介/arengine-overview.md#坐标系说明>)。 |
| anchor | [arEngine.ARAnchor](../arEngine（AR增强现实能力）/arengine-api-arengine.md#aranchor) | 是 | 更新锚点。  **说明：** [ARAnchor](../arEngine（AR增强现实能力）/arengine-api-arengine.md#aranchor)的位姿使用了AR Engine重力对齐世界坐标系。具体参见[坐标系说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine简介/arengine-overview.md#坐标系说明>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [arEngine.ARFeatureType](../arEngine（AR增强现实能力）/arengine-api-arengine.md#arfeaturetype) | 是 | 表示想要检查能否正常运行的AR特性。 |
