...
scraped_at: 2026-06-01T16:26:34+08:00
doc_updated_at: 2026-05-12
content_hash: sha256:571f85bb4921820f419de17cdae2b2a88b03a5f8fbe4afa977c556fb59a50ed4
---
...
| **名称** | **值** | **说明** |
| --- | --- | --- |
| NORMAL | 0 | 正常模式。  当添加的图片数量超过默认的最多图片数量（50）时，AR Engine会报告错误，错误信息见[1009200011](<../../AR Engine错误码/arengine-error-code.md#section1009200011-添加的图片数量超过最大数量>)。 |
...
| **名称** | **值** | **说明** |
| --- | --- | --- |
| GRAVITY | 0 | 由重力确定。  世界坐标系的Y轴与重力方向一致，原点为设备所在的原始位置。参见[坐标系说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine简介/arengine-overview.md#坐标系说明>)。 |
| GRAVITY\_AND\_HEADING | 1 | 由重力和指南针确定。  世界坐标系的Y轴与重力方向一致，X轴指向指南针北向，原点为设备所在的原始位置。参见[坐标系说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine简介/arengine-overview.md#坐标系说明>)。  **说明：** 该选项当前仅支持省电模式，请将[ARPowerMode](arengine-api-arengine.md#arpowermode)置为POWER\_SAVING以启动该选项。 |
...
**设备行为差异：** 该接口在部分Phone、部分Tablet、TV中可正常调用，在不支持的设备中无法正常调用。可使用[arViewController.isARTypeSupported](../arViewController（AR场景管理能力）/arengine-api-arviewcontroller.md#arviewcontrollerisartypesupported)接口查询能力是否支持。
...
以下错误码的详细介绍请参见[通用错误码](../../../通用错误码/errorcode-universal.md)和[AR Engine错误码](<../../AR Engine错误码/arengine-error-code.md>)。
...
以下错误码的详细介绍请参见[AR Engine错误码](<../../AR Engine错误码/arengine-error-code.md>)。
...
| pixelMap | [image.PixelMap](<../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.sendableImage (基于Sendable对象的图片处理)/js-apis-sendableimage.md#pixelmap>) | 是 | 图像的信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| id | ArrayBuffer | 是 | 否 | 稠密点云数据所有点的id数组。  **说明：** 该类型在使用时，如需转换则为int32类型，转换方法参考[数据类型转换说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine常见问题/数据类型转换说明/arengine-arraybuffer-info.md>)。 |
| position | ArrayBuffer | 是 | 否 | 稠密点云数据所有点的坐标，以及它们的置信度数组，格式为[x0, y0, z0, c0, x1, y1, z1, c1, x2, ...]。  **说明：** 该类型在使用时，如需转换则为float32类型，转换方法参考[数据类型转换说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine常见问题/数据类型转换说明/arengine-arraybuffer-info.md>)。 |
| color | ArrayBuffer | 是 | 否 | 稠密点云数据所有点的颜色，以 rgba 格式表示，格式为 [r0, g0, b0, a0, r1, g1, b1, a1, r2,...]。  **说明：** 该类型在使用时，如需转换则为int32类型，转换方法参考[数据类型转换说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine常见问题/数据类型转换说明/arengine-arraybuffer-info.md>)。 |
...
| buffer | ArrayBuffer | 是 | 否 | 当前帧的平面数据缓冲区对象。  **说明：** 该类型在使用时，如需转换则为int32类型，转换方法参考[数据类型转换说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine常见问题/数据类型转换说明/arengine-arraybuffer-info.md>)。 |
...
| viewMatrix | [Matrix4](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#matrix4>) | 是 | 否 | 摄像机在最新帧中的视图矩阵。 |
...
位姿信息可参考[坐标系说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine简介/arengine-overview.md#坐标系说明>)。
...
| **类型** | **说明** |
| --- | --- |
| [Matrix4](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#matrix4>) | 返回一个Matrix4对象。  Matrix4是一个包含16个浮点数的数组，表示OpenGL中的列主旋转变换矩阵。 |
...
| **类型** | **说明** |
| --- | --- |
| ArrayBuffer | 返回一个ArrayBuffer缓冲区对象，这个对象包含顶点坐标的数组。表示平面局部坐标系X-Z平面的坐标。  **说明：** 该类型在使用时，如需转换则为float32类型，转换方法参考[数据类型转换说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine常见问题/数据类型转换说明/arengine-arraybuffer-info.md>)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| rotation | [Quaternion](<../../../ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneType/js-apis-inner-scene-types.md#quaternion>) | 是 | 否 | 来自位姿对象的姿势数据，包括旋转分量。 |
| translation | [Vec3](<../../../ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneType/js-apis-inner-scene-types.md#vec3>) | 是 | 否 | 来自位姿对象的姿势数据，包括平移组件。 |
...
| **类型** | **说明** |
| --- | --- |
| [Matrix4](<../../../ArkUI（方舟UI框架）/ArkTS API/UI界面/arkui/Graphics/js-apis-arkui-graphics.md#matrix4>) | 返回一个包含16个浮点数的数组，按照列主序（column-major order）存储。 |
...
| **类型** | **说明** |
| --- | --- |
| ArrayBuffer | 返回一个ArrayBuffer缓冲区对象。这个缓冲区包含了顶点在平面局部坐标系X-Z平面的坐标。  **说明：** 该类型在使用时，如需转换则为float32类型，转换方法参考[数据类型转换说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine常见问题/数据类型转换说明/arengine-arraybuffer-info.md>)。 |
...
| **类型** | **说明** |
| --- | --- |
| ArrayBuffer | 返回一个ArrayBuffer缓冲区对象。这个缓冲区包含了顶点在平面局部坐标系X-Z平面的坐标。  **说明：** 该类型在使用时，如需转换则为int32类型，转换方法参考[数据类型转换说明](<../../../../harmonyos-guides/图形/AR Engine（AR引擎服务）/AR Engine常见问题/数据类型转换说明/arengine-arraybuffer-info.md>)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rotation | [Quaternion](<../../../ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneType/js-apis-inner-scene-types.md#quaternion>) | 是 | 表示旋转组件的数据。这个参数是Quaternion类型，通常是一个包含四个元素的数组，为四元数，用于表示和操作3D旋转。 |
| translation | [Vec3](<../../../ArkGraphics 3D（方舟3D图形）/ArkTS API/graphics3d/SceneType/js-apis-inner-scene-types.md#vec3>) | 是 | 表示平移组件的数据。这个参数是Vec3类型，通常是一个包含三个元素的数组，表示3D向量的x、y和z分量，用于表示物体的平移位置。 |
