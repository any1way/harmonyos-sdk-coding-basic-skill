...
scraped_at: 2026-06-11T16:35:21+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:badfd86ee1912cf9f22a41cb690bb851219808b14cfbf8f1238ec8d7cf428a07
---
...
* 该组件使用[AVPlayer](<../../../Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/Interface (AVPlayer)/arkts-apis-media-avplayer.md>)进行播放，同时开启的AVPlayer个数不建议超过3个，超过3个可能会出现视频播放卡顿现象。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| movingPhoto | [photoAccessHelper.MovingPhoto](<../../ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Interface (MovingPhoto)/arkts-apis-photoaccesshelper-movingphoto.md>) | 否 | 否 | 支持媒体库MovingPhoto数据源，具体信息详见[MovingPhoto](<../../ArkTS API/@ohos.file.photoAccessHelper (相册管理模块)/Interface (MovingPhoto)/arkts-apis-photoaccesshelper-movingphoto.md>)说明。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| imageAIOptions18+ | [ImageAIOptions](../../../ArkUI（方舟UI框架）/ArkTS组件/图片与视频/图像类型定义/ts-image-common.md#imageaioptions12) | 否 | 是 | 设置动态照片AI分析选项，可配置分析类型或绑定一个分析控制器。  **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ImageFit](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/枚举说明/ts-appendix-enums.md#imagefit) | 是 | 视频显示模式。  默认值：Cover。 |
...
除支持[通用事件](../../../ArkUI（方舟UI框架）/ArkTS组件/通用事件/ts-component-general-events.md)外，还支持以下事件：
...
一个MovingPhotoViewController对象可以控制一个MovingPhotoView，可用视频播放实例请参考[@ohos.multimedia.media](<../../../Media Kit（媒体服务）/ArkTS API/@ohos.multimedia.media (媒体服务)/模块描述/arkts-apis-media.md>)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/60/v3/dtkXzaOOQBKEej1p2B3PaA/zh-cn_image_0000002592381260.gif?HW-CC-KV=V1&HW-CC-Date=20260611T083520Z&HW-CC-Expire=86400&HW-CC-Sign=19CB1A57EDC816FAE4EFDEB5B49AD6F6DF35E43336D3254A5F501A178C0474E1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/IvsX_QlYTGiFQb3Jva4hKQ/zh-cn_image_0000002622860771.gif?HW-CC-KV=V1&HW-CC-Date=20260611T083520Z&HW-CC-Expire=86400&HW-CC-Sign=92165F9B0EFFB02DE2B9456E067ACB0987659A4714435A981309D484CC3608C8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/dX5cPQRNS1OzoWX54DmYMA/zh-cn_image_0000002622700889.gif?HW-CC-KV=V1&HW-CC-Date=20260611T083520Z&HW-CC-Expire=86400&HW-CC-Sign=857D571210B41F3E6509E7B5E57EA4C8E99D5D420964ECE851270D335BDCE072)
