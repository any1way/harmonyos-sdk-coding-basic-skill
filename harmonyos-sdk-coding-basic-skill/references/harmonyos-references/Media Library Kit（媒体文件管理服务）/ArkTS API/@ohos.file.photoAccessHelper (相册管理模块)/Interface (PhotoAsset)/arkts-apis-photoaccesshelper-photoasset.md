...
content_hash: sha256:2b0afff7b6d89022e8960ddf82c83e6d8770b9618dc18b62d86e4467b04667e9
---
提供封装文件属性的方法。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| uri | string | 是 | 否 | 媒体文件资源URI（如：file://media/Photo/1/IMG\_datetime\_0001/displayName.jpg），详情参见用户文件URI介绍中的[媒体文件URI](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#媒体文件uri>)。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| photoType | [PhotoType](../Enums/arkts-apis-photoaccesshelper-e.md#phototype) | 是 | 否 | 媒体文件类型。  **元服务API：** 从API version 20开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| member | string | 是 | 成员参数名称，在get时，除了'uri'、'media\_type'、'subtype'和'display\_name'四个属性之外，其他的属性都需要在fetchColumns中填入需要获取的[PhotoKeys](../Enums/arkts-apis-photoaccesshelper-e.md#photokeys)，例如：get title属性fetchColumns: ['title']。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [MemberType](../Types/arkts-apis-photoaccesshelper-t.md#membertype) | 获取PhotoAsset成员参数的值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| member | string | 是 | 成员参数名称例如：[PhotoKeys](../Enums/arkts-apis-photoaccesshelper-e.md#photokeys).TITLE。字符串长度的取值范围为[1, 255]。 |
| value | string | 是 | 设置成员参数名称，只能修改[PhotoKeys](../Enums/arkts-apis-photoaccesshelper-e.md#photokeys).TITLE的值。title的参数规格为：  - 不应包含扩展名。  - 文件名字符串长度的取值范围为[1, 255]（资产文件名为标题+扩展名）。  - 不允许出现的非法英文字符，包括：. \ / : \* ? " ' ` < > | { } [ ] |
...
错误码14000001，请参考 [PhotoKeys](../Enums/arkts-apis-photoaccesshelper-e.md#photokeys)获取有关文件名的格式和长度要求。
...
从API version 10开始支持，从API version 11开始废弃，建议使用[fileIo.close](<../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileioclose-1>)替代。
...
从API version 10开始支持，从API version 11开始废弃，建议使用[fileIo.close](<../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileioclose>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback<[image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | 是 | 回调函数。当获取文件的缩略图成功，err为undefined，data为缩略图的PixelMap；否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | [image.Size](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interfaces (其他)/arkts-apis-image-i.md#size>) | 是 | 缩略图尺寸。 |
| callback | AsyncCallback<[image.PixelMap](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>)> | 是 | 回调函数。当获取文件的缩略图成功，err为undefined，data为缩略图的PixelMap；否则为错误对象。 |
...
从API version 10开始支持，从API version 11开始废弃，建议使用[fileIo.open](<../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileioopen-1>)替代。
...
从API version 10开始支持，从API version 11开始废弃，建议使用[fileIo.open](<../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fs (文件管理)/js-apis-file-fs.md#fileioopen>)替代。
