...
scraped_at: 2026-06-01T16:25:47+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:6f902447c0a025def61cddc6a989e8daa988a62eb25e10f98c0911c36678485e
---
...
此接口返回的PhotoSelectResult对象中的photoUris具有永久授权，可通过调用接口[photoAccessHelper.getAssets](<../Interface (PhotoAccessHelper)/arkts-apis-photo_93807367.md#getassets>)去使用。具体操作请参考[媒体文件URI的使用方式](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#媒体文件uri的使用方式>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [PhotoSelectOptions](<../Classes (其他)/arkts-apis-photoaccesshelper-class.md#photoselectoptions>) | 否 | photoPicker选择选项，若无此参数，则默认选择媒体文件类型为图片和视频类型，默认选择媒体文件数量的最大值为50。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[PhotoSelectResult](<../Classes (其他)/arkts-apis-photoaccesshelper-class.md#photoselectresult>)> | Promise对象。返回photoPicker选择后的结果集 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)、[文件管理错误码](<../../../../Core File Kit（文件基础服务）/错误码/文件管理错误码/errorcode-filemanagement.md>)和[媒体库错误码](../../../错误码/媒体库错误码/errorcode-medialibrary.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [PhotoSelectOptions](<../Classes (其他)/arkts-apis-photoaccesshelper-class.md#photoselectoptions>) | 是 | photoPicker选择选项。 |
| callback | AsyncCallback<[PhotoSelectResult](<../Classes (其他)/arkts-apis-photoaccesshelper-class.md#photoselectresult>)> | 是 | callback 返回photoPicker选择后的结果集。 |
