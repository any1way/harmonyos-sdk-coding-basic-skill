...
scraped_at: 2026-06-01T16:25:56+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:b4382d7da111dfcda5e742c2342a54ee61034eb2aaa36dacdfae717c04f543bc
---
说明
...
通过picker的方式调用该接口来查询指定URI对应的图片或视频资源，不需要申请'ohos.permission.READ\_IMAGEVIDEO'权限，详情请参考[指定URI获取图片或视频资源](<../../../../../harmonyos-guides/媒体/Media Library Kit（媒体文件管理服务）/使用Picker选择媒体库资源/photoaccesshelper-photoviewpicker.md#指定uri获取图片或视频资源>)。

**参数：**

| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FetchOptions](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#fetchoptions>) | 是 | 图片和视频检索选项。 |
| callback | AsyncCallback<[FetchResult](<../Interface (FetchResult)/arkts-apis-photoaccesshelper-fetchresult.md>)<[PhotoAsset](<../Interface (PhotoAsset)/arkts-apis-photoaccesshelper-photoasset.md>)>> | 是 | callback返回图片和视频检索结果集。 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)和[文件管理错误码](<../../../../Core File Kit（文件基础服务）/错误码/文件管理错误码/errorcode-filemanagement.md>)。
...
phAccessHelper的创建请参考[photoAccessHelper.getPhotoAccessHelper](../Functions/arkts-apis-photoaccesshelper-f.md#photoaccesshelpergetphotoaccesshelper)的示例使用。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[FetchResult](<../Interface (FetchResult)/arkts-apis-photoaccesshelper-fetchresult.md>)<[PhotoAsset](<../Interface (PhotoAsset)/arkts-apis-photoaccesshelper-photoasset.md>)>> | Promise对象，返回图片和视频数据结果集。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| burstKey | string | 是 | 一组连拍照片的唯一标识：uuid（可传入[PhotoKeys](../Enums/arkts-apis-photoaccesshelper-e.md#photokeys)的BURST\_KEY）。字符串长度为36字节。 |
| options | [FetchOptions](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#fetchoptions>) | 是 | 连拍照片检索选项。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[FetchResult](<../Interface (FetchResult)/arkts-apis-photoaccesshelper-fetchresult.md>)<[PhotoAsset](<../Interface (PhotoAsset)/arkts-apis-photoaccesshelper-photoasset.md>)>> | Promise对象，返回连拍照片数据结果集。 |
...
在未申请相册管理模块权限'ohos.permission.WRITE\_IMAGEVIDEO'时，可以使用安全控件或授权弹窗的方式创建媒体资源，详情请参考[保存媒体库资源](<../../../../../harmonyos-guides/媒体/Media Library Kit（媒体文件管理服务）/保存媒体库资源/photoaccesshelper-savebutton.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| photoType | [PhotoType](../Enums/arkts-apis-photoaccesshelper-e.md#phototype) | 是 | 创建的文件类型，IMAGE或者VIDEO类型。 |
| extension | string | 是 | 文件名后缀参数，例如：'jpg'。 |
| options | [CreateOptions](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#createoptions>) | 是 | 创建选项，当前仅支持'title'，例如{title: 'testPhoto'}。  **注意：**  传入'subtype'选项，配置不生效，仅支持保存DEFAULT类型图片。  文件名中不允许出现非法英文字符，包括： . .. \ / : \* ? " ' ` < > | { } [ ] |
...
| photoType | [PhotoType](../Enums/arkts-apis-photoaccesshelper-e.md#phototype) | 是 | 创建的文件类型，IMAGE或者VIDEO类型。 |
| extension | string | 是 | 文件名后缀参数，例如：'jpg'。 |
| options | [CreateOptions](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#createoptions>) | 否 | 创建选项，当前仅支持'title'，例如{title: 'testPhoto'}。  **注意：**  传入'subtype'选项，配置不生效，仅支持保存DEFAULT类型图片。  文件名中不允许出现非法英文字符，包括： . .. \ / : \* ? " ' ` < > | { } [ ] |
...
在未申请相册管理模块权限'ohos.permission.WRITE\_IMAGEVIDEO'时，可以使用安全控件或授权弹窗的方式创建媒体资源，详情请参考[开发指南](<../../../../../harmonyos-guides/媒体/Media Library Kit（媒体文件管理服务）/保存媒体库资源/photoaccesshelper-savebutton.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| photoType | [PhotoType](../Enums/arkts-apis-photoaccesshelper-e.md#phototype) | 是 | 创建的文件类型。例如：IMAGE或者VIDEO类型。 |
| extension | string | 是 | 文件名后缀参数。例如：'jpg'。 |
...
以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)和[媒体库错误码](../../../错误码/媒体库错误码/errorcode-medialibrary.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [AlbumType](../Enums/arkts-apis-photoaccesshelper-e.md#albumtype) | 是 | 相册类型。 |
| subtype | [AlbumSubtype](../Enums/arkts-apis-photoaccesshelper-e.md#albumsubtype) | 是 | 相册子类型。 |
| options | [FetchOptions](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#fetchoptions>) | 是 | 检索选项。 |
| callback | AsyncCallback<[FetchResult](<../Interface (FetchResult)/arkts-apis-photoaccesshelper-fetchresult.md>)<[Album](<../Interface (Album)/arkts-apis-photoaccesshelper-album.md>)>> | 是 | callback返回获取相册的结果集。 |
...
| type | [AlbumType](../Enums/arkts-apis-photoaccesshelper-e.md#albumtype) | 是 | 相册类型。 |
| subtype | [AlbumSubtype](../Enums/arkts-apis-photoaccesshelper-e.md#albumsubtype) | 是 | 相册子类型。 |
| options | [FetchOptions](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#fetchoptions>) | 否 | 检索选项，不填时默认根据相册类型检索。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[FetchResult](<../Interface (FetchResult)/arkts-apis-photoaccesshelper-fetchresult.md>)<[Album](<../Interface (Album)/arkts-apis-photoaccesshelper-album.md>)>> | Promise对象，返回获取相册的结果集。 |

**错误码：**

以下错误码的详细介绍请参见[通用错误码](../../../../通用错误码/errorcode-universal.md)和[文件管理错误码](<../../../../Core File Kit（文件基础服务）/错误码/文件管理错误码/errorcode-filemanagement.md>)。

错误码13900012，请参考[开发准备](<../../../../../harmonyos-guides/媒体/Media Library Kit（媒体文件管理服务）/受限开放能力/开发准备/photoaccesshelper-preparation.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | string | 是 | PhotoAsset的uri, Album的uri或[DefaultChangeUri](../Enums/arkts-apis-photoaccesshelper-e.md#defaultchangeuri)的值。 |
...
| callback | Callback<[ChangeData](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#changedata>)> | 是 | 返回要监听的[ChangeData](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#changedata>)。注：uri可以注册多个不同的callback监听，[unRegisterChange](arkts-apis-photo_93807367.md#unregisterchange)可以关闭该uri所有监听，也可以关闭指定callback的监听。 |
...
| --- | --- | --- | --- |
| uri | string | 是 | PhotoAsset的uri, Album的uri或[DefaultChangeUri](../Enums/arkts-apis-photoaccesshelper-e.md#defaultchangeuri)的值。 |
| callback | Callback<[ChangeData](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#changedata>)> | 否 | 取消[registerChange](arkts-apis-photo_93807367.md#registerchange)注册时的callback的监听，不填时，取消该uri的所有监听。注：off指定注册的callback后不会进入此回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mediaChangeRequest | [MediaChangeRequest](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#mediachangerequest11>) | 是 | 媒体变更请求，支持资产变更请求和相册变更请求。 |
...
该接口依赖于[MediaChangeRequest](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#mediachangerequest11>)对象，详细代码示例请参见[MediaAssetChangeRequest](<../Class (MediaAssetChangeRequest)/kts-apis-photo_01462016.md>)和[MediaAlbumChangeRequest](<../Class (MediaAlbumChangeRequest)/kts-apis-photo_44704870.md>)中的接口示例。
...
弹框需显示应用名称，但无法直接获取。因此，调用此接口时，请确保[module.json5配置文件](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)中的abilities标签已配置label和icon项。需要注意的是，图标不受abilities标签中的icon项影响，不支持修改。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| srcFileUris | Array<string> | 是 | 需保存到媒体库中的图片/视频文件对应的[媒体文件URI](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#媒体文件uri>)。  **注意：**  - 一次弹窗最多保存100张图片。  - 仅支持处理图片、视频URI。  - 不支持手动拼接的URI，需调用接口获取，获取方式参考[媒体文件URI获取方式](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#媒体文件uri获取方式>)。 |
| photoCreationConfigs | Array<[PhotoCreationConfig](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#photocreationconfig12>)> | 是 | 保存图片或视频到媒体库的配置，包括文件名等，与srcFileUris保持一一对应。  **注意：**  传入'subtype'选项，配置项不生效，仅支持保存DEFAULT类型图片。 |
...
* 弹框需显示应用名称，名称和图标需在[module.json5配置文件](../../../../../harmonyos-guides/基础入门/开发基础知识/应用配置文件（Stage模型）/module.json5配置文件/module-configuration-file.md)的abilities标签中配置label和icon项。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| srcFileUris | Array<string> | 是 | 需保存到媒体库中的图片或视频文件对应的[媒体文件URI](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#媒体文件uri>)。  **注意：**  - 一次弹窗最多保存100张图片。  - 仅支持处理图片和视频URI。  - 不支持手动拼接URI，需调用接口获取，具体请参考[媒体文件URI获取方式](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#媒体文件uri获取方式>)。 |
| creationSettings | Array<[CreationSetting](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#creationsetting23>)> | 是 | 保存图片或视频到媒体库的配置，包括文件名等，与srcFileUris参数中的URI保持一一对应。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| srcFileUri | string | 是 | 需要保存到媒体库中的图片/视频文件所对应的[媒体文件URI](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#媒体文件uri>)。  **注意：**  - 一次弹窗最多保存1张图片。  - 仅支持处理图片、视频URI。  - 不支持手动拼接的URI，需调用接口获取，具体请参考[媒体文件URI获取方式](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#媒体文件uri获取方式>)。 |
| creationSetting | [CreationSetting](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#creationsetting23>) | 是 | 保存图片或视频到媒体库的配置（包括文件名等），与srcFileUri保持对应。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| photoCreationConfig | [PhotoCreationConfig](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#photocreationconfig12>); | 是 | 保存图片/视频到媒体库的配置，包括保存的文件名等。  **注意：**  传入'subtype'选项，配置项不生效，仅支持保存DEFAULT类型图片。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| creationSetting | [CreationSetting](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#creationsetting23>) | 是 | 保存图片或视频到媒体库时的配置项，包括保存的文件名等。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| srcFileUris | Array<string> | 是 | 需进行授权的图片/视频文件对应的[媒体文件URI](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#媒体文件uri>)。  **注意：**  仅支持处理图片、视频URI，且最大数量限制为100个。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| srcFileUris | Array<string> | 是 | 需进行授权的图片/视频文件对应的[媒体库uri](<../../../../../harmonyos-guides/应用框架/Core File Kit（文件基础服务）/用户文件/用户文件URI介绍/user-file-uri-intro.md#媒体文件uri>)。  **注意：**  仅支持处理图片、视频uri，且最大数量限制为100个。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| photoType | [PhotoType](../Enums/arkts-apis-photoaccesshelper-e.md#phototype) | 是 | 媒体文件类型。 |
...
| callback | Callback<[PhotoAssetChangeInfos](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#photoassetchangeinfos20>)> | 是 | 返回变更的媒体资产信息[PhotoAssetChangeInfos](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#photoassetchangeinfos20>)。  **注意：**  该接口可以注册多个不同的callback监听，[off('photoChange')](arkts-apis-photo_93807367.md#offphotochange20)既可以关闭所有监听，也可以关闭指定callback监听。 |
...
| callback | Callback<[PhotoAssetChangeInfos](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#photoassetchangeinfos20>)> | 否 | 取消[on('photoChange')](arkts-apis-photo_93807367.md#onphotochange20)注册时指定的callback监听；不填时，则取消对'photoChange'的所有监听。  **注意：**  取消注册的callback后，有资产发生变化时，不会进入此回调。 |
...
| callback | Callback<[AlbumChangeInfos](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#albumchangeinfos20>)> | 是 | 返回变更的相册信息[AlbumChangeInfos](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#albumchangeinfos20>)。  **注意：**  该接口可以注册多个不同的callback监听，[off('photoAlbumChange')](arkts-apis-photo_93807367.md#offphotoalbumchange20)既可以关闭所有监听，也可以关闭指定callback监听。 |
...
| callback | Callback<[AlbumChangeInfos](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#albumchangeinfos20>)> | 否 | 取消[on('photoAlbumChange')](arkts-apis-photo_93807367.md#onphotoalbumchange20)注册时指定的callback监听；不填时，则取消对'photoAlbumChange'的所有监听。  **注意：**  取消注册的callback后，有相册发生变化时，不会进入此回调。 |
...
以下错误码的详细介绍请参见[文件管理错误码](<../../../../Core File Kit（文件基础服务）/错误码/文件管理错误码/errorcode-filemanagement.md>)。
...
从API version 10开始支持，从API version 11开始废弃。建议使用[MediaAssetChangeRequest.deleteAssets](<../Class (MediaAssetChangeRequest)/kts-apis-photo_01462016.md#deleteassets11-1>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [RecentPhotoOptions](<../Classes (其他)/arkts-apis-photoaccesshelper-class.md#recentphotooptions20>) | 否 | 最近图片配置选项参数。若无此参数，则取按照创建时间排序的最新一张图片。  该参数在配置的情况下，需与RecentPhotoComponent组件中的options配置相同才可以查到一样的图片，否则可能存在接口能查到最近图片，组件没查到最近图片的情况。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise<[RecentPhotoInfo](<../Classes (其他)/arkts-apis-photoaccesshelper-class.md#recentphotoinfo20>)> | Promise对象，返回最近图片信息。 |
...
| callback | Callback<[PhotoAssetChangeInfos](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#photoassetchangeinfos20>)> | 是 | 返回变更的媒体资产信息[PhotoAssetChangeInfos](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#photoassetchangeinfos20>)。  **注意：**  该接口可以注册多个不同的callback监听。 |
...
| callback | Callback<[PhotoAssetChangeInfos](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#photoassetchangeinfos20>)> | 否 | 用于取消订阅的回调。不携带时，取消asset参数下所有callback。 |
...
| callback | Callback<[AlbumChangeInfos](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#albumchangeinfos20>)> | 是 | 返回变更的媒体相册信息[PhotoAssetChangeInfos](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#photoassetchangeinfos20>)。  **注意：**  该接口可以注册多个不同的callback监听。 |
...
| callback | Callback<[AlbumChangeInfos](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#albumchangeinfos20>)> | 否 | 用于取消订阅的回调。不携带时，取消album参数下所有callback。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| capability | [AssetCompatibleCapability](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#assetcompatiblecapability24>) | 是 | 资产兼容能力。 |
