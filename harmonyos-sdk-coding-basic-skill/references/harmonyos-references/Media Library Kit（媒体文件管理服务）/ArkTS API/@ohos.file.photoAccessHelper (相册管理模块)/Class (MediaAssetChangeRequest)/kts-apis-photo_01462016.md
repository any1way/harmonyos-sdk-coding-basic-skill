...
scraped_at: 2026-06-01T16:25:45+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:fcfe2cd96caa547128277ac782769d03fdcf4cb14a98fc1139bb4ba0769b27a1
---
MediaAssetChangeRequest implements [MediaChangeRequest](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#mediachangerequest11>).
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| comment23+ | string | 是 | 否 | 用于[MediaChangeRequest](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#mediachangerequest11>)类型校验。  如果类（如MediaAssetChangeRequest）对象可以访问，就说明该类是MediaChangeRequest的实现类。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| asset | [PhotoAsset](<../Interface (PhotoAsset)/arkts-apis-photoaccesshelper-photoasset.md>) | 是 | 需要变更的资产。 |
...
指定待创建资产的数据来源，可参考[@ohos.file.fileuri (文件URI)](<../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fileuri (文件URI)/js-apis-file-fileuri.md>)。
...
| 类型 | 说明 |
| --- | --- |
| [MediaAssetChangeRequest](kts-apis-photo_01462016.md) | 返回创建资产的变更请求。 |
...
| --- | --- | --- | --- |
| context | [Context](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>) | 是 | 传入Ability实例的上下文。 |
| photoType | [PhotoType](../Enums/arkts-apis-photoaccesshelper-e.md#phototype) | 是 | 待创建的文件类型，IMAGE或者VIDEO类型。 |
| extension | string | 是 | 文件扩展名，例如：'jpg'。 |
| options | [CreateOptions](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#createoptions>) | 否 | 创建选项，例如：{title: 'testPhoto'}。  文件名中不允许出现非法英文字符，包括： . .. \ / : \* ? " ' ` < > | { } [ ] |
...
| --- | --- | --- | --- |
| context | [Context](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/application/Context (Stage模型的上下文基类)/js-apis-inner-application-context.md>) | 是 | 传入Ability实例的上下文。 |
| assets | Array<[PhotoAsset](<../Interface (PhotoAsset)/arkts-apis-photoaccesshelper-photoasset.md>)> | 是 | 待删除的媒体文件数组，数组中元素个数不超过300个。 |
...
对于创建资产的变更请求，在调用接口[applyChanges](<../Interface (PhotoAccessHelper)/arkts-apis-photo_93807367.md#applychanges11>)的提交生效之前，该接口会返回null。
...
| 类型 | 说明 |
| --- | --- |
| [PhotoAsset](<../Interface (PhotoAsset)/arkts-apis-photoaccesshelper-photoasset.md>) | 返回当前资产变更请求中的资产。 |
...
通过文件URI从应用沙箱添加资源，待添加资源的数据来源可参考[@ohos.file.fileuri (文件URI)](<../../../../Core File Kit（文件基础服务）/ArkTS API/@ohos.file.fileuri (文件URI)/js-apis-file-fileuri.md>)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [ResourceType](../Enums/arkts-apis-photoaccesshelper-e.md#resourcetype11) | 是 | 待添加资源的类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageFileType | [ImageFileType](../Enums/arkts-apis-photoaccesshelper-e.md#imagefiletype13) | 是 | 需要保存的类型。 |
