...
content_hash: sha256:b6656ef8e4144e693861d701708caaf2d76b2739ad3df9dce1b5405d2af053d4
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | T | 是 | 已就绪的图片资源数据。泛型，支持[Picture](<../../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (Picture)/arkts-apis-image-picture.md>)数据类型。 |
