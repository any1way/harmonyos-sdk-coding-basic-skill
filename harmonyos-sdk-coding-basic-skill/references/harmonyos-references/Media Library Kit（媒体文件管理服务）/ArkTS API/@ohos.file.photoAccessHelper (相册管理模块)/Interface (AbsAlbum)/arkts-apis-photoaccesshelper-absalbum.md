...
content_hash: sha256:10f0737266a73a839ac50a940ed30cf19246943db474477d8c3ba0aaf3e7f7b7
---
说明
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| albumType | [AlbumType](../Enums/arkts-apis-photoaccesshelper-e.md#albumtype) | 是 | 否 | 相册类型。 |
| albumSubtype | [AlbumSubtype](../Enums/arkts-apis-photoaccesshelper-e.md#albumsubtype) | 是 | 否 | 相册子类型。 |
...
| callback | AsyncCallback<[FetchResult](<../Interface (FetchResult)/arkts-apis-photoaccesshelper-fetchresult.md>)<[PhotoAsset](<../Interface (PhotoAsset)/arkts-apis-photoaccesshelper-photoasset.md>)>> | 是 | 回调函数。当获取相册中的文件成功，err为undefined，data为获取到的图片和视频数据结果集[FetchResult](<../Interface (FetchResult)/arkts-apis-photoaccesshelper-fetchresult.md>)；否则为错误对象。 |
