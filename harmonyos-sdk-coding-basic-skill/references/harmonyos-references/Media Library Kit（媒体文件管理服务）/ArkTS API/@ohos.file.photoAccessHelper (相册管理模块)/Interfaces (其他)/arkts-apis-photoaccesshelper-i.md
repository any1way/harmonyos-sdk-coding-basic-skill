...
scraped_at: 2026-06-01T16:25:58+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:ad9dc49b45eea91d14b906feaa8a3dff34bed6535cb4860759956626d85bf49d
---
说明
...
媒体变更请求必须在调用[applyChanges](<../Interface (PhotoAccessHelper)/arkts-apis-photo_93807367.md#applychanges11>)后才会生效。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| comment23+ | string | 是 | 否 | 用于MediaChangeRequest类型校验。  如果类（如[MediaAssetChangeRequest](<../Class (MediaAssetChangeRequest)/kts-apis-photo_01462016.md>)或[MediaAlbumChangeRequest](<../Class (MediaAlbumChangeRequest)/kts-apis-photo_44704870.md>)）对象可以访问，就说明该类是MediaChangeRequest的实现类。 |
...
| subtype12+ | [PhotoSubtype](../Enums/arkts-apis-photoaccesshelper-e.md#photosubtype12) | 否 | 是 | 图片或者视频的文件子类型。  **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fetchColumns | Array<string> | 否 | 否 | 检索条件，指定列名查询。  对于照片，如果该参数为空，默认查询'uri'、'media\_type'、'subtype'和'display\_name'，使用[get](<../Interface (PhotoAsset)/arkts-apis-photoaccesshelper-photoasset.md#get>)接口获取当前对象的其他属性时将会报错。示例：fetchColumns: ['uri', 'title']。  对于相册，如果该参数为空，默认查询'uri'和'album\_name'。  **元服务API：** 从API version 20开始，该接口支持在元服务中使用。 |
| predicates | [dataSharePredicates.DataSharePredicates](<../../../../ArkData（方舟数据管理）/ArkTS API/@ohos.data.dataSharePredicates (数据共享谓词)/js-apis-data-datasharepredicates.md#datasharepredicates>) | 否 | 否 | 谓词查询，显示过滤条件。  **元服务API：** 从API version 20开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| deliveryMode | [DeliveryMode](../Enums/arkts-apis-photoaccesshelper-e.md#deliverymode11) | 否 | 否 | 请求资源分发模式，可以指定对于该资源的请求策略，可被配置为快速模式，高质量模式，均衡模式三种策略。 |
| compatibleMode15+ | [CompatibleMode](../Enums/arkts-apis-photoaccesshelper-e.md#compatiblemode15) | 否 | 是 | 配置HDR视频资源转码模式，可指定配置为转码和不转码两种策略。默认为原视频资源内容模式即不转码。 |
| mediaAssetProgressHandler15+ | [MediaAssetProgressHandler](<../Interface (MediaAssetProgressHandler)/s-apis-p_56923640.md>) | 否 | 是 | 配置HDR视频转码为SDR视频时的进度级回调。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [NotifyType](../Enums/arkts-apis-photoaccesshelper-e.md#notifytype) | 否 | 否 | ChangeData的通知类型。 |
| uris | Array<string> | 否 | 否 | 相同[NotifyType](../Enums/arkts-apis-photoaccesshelper-e.md#notifytype)的所有uri，可以是PhotoAsset或Album。 |
...
| photoType | [PhotoType](../Enums/arkts-apis-photoaccesshelper-e.md#phototype) | 否 | 否 | 创建的文件类型[PhotoType](../Enums/arkts-apis-photoaccesshelper-e.md#phototype)，IMAGE或者VIDEO。 |
| subtype | [PhotoSubtype](../Enums/arkts-apis-photoaccesshelper-e.md#photosubtype12) | 否 | 是 | 图片或者视频的文件子类型[PhotoSubtype](../Enums/arkts-apis-photoaccesshelper-e.md#photosubtype12)，不传入时默认为DEFAULT。 |
...
| fileNameExtension | string | 否 | 否 | 文件扩展名，例如'jpg'。 |
| photoType | [PhotoType](../Enums/arkts-apis-photoaccesshelper-e.md#phototype) | 否 | 否 | 创建的媒体文件类型[PhotoType](../Enums/arkts-apis-photoaccesshelper-e.md#phototype)，包含IMAGE或VIDEO。 |
...
| mediaType | [PhotoType](../Enums/arkts-apis-photoaccesshelper-e.md#phototype) | 否 | 否 | 媒体资产的类型（图片/视频）。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [NotifyChangeType](../Enums/arkts-apis-photoaccesshelper-e.md#notifychangetype20) | 否 | 否 | 媒体资产（图片/视频）变更的通知类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| albumType | [AlbumType](../Enums/arkts-apis-photoaccesshelper-e.md#albumtype) | 否 | 否 | 相册类型。 |
| albumSubtype | [AlbumSubtype](../Enums/arkts-apis-photoaccesshelper-e.md#albumsubtype) | 否 | 否 | 相册子类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [NotifyChangeType](../Enums/arkts-apis-photoaccesshelper-e.md#notifychangetype20) | 否 | 否 | 相册变更的通知类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| gridPinchModeType | [GridPinchModeType](../Enums/arkts-apis-photoaccesshelper-e.md#gridpinchmodetype23) | 否 | 是 | 宫格捏合模式类型，配置即支持捏合功能，反之不支持捏合功能。 |
| defaultGridLevel | [GridLevel](../Enums/arkts-apis-photoaccesshelper-e.md#gridlevel23) | 否 | 是 | 拉起picker后宫格档位，默认为STANDARD。 |
