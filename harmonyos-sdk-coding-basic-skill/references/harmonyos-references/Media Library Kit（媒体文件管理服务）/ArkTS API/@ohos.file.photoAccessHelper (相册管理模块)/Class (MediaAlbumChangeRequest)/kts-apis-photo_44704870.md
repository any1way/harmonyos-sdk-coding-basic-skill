...
scraped_at: 2026-06-01T16:25:44+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:92541e9940bee296941f9521a55c636c6602ff20dc5d48f721121f41928f9bc0
---
MediaAlbumChangeRequest implements [MediaChangeRequest](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#mediachangerequest11>).
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| comment23+ | string | 是 | 否 | 用于[MediaChangeRequest](<../Interfaces (其他)/arkts-apis-photoaccesshelper-i.md#mediachangerequest11>)类型校验。  如果类（如MediaAlbumChangeRequest）对象可以访问，就说明该类是MediaChangeRequest的实现类。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| album | [Album](<../Interface (Album)/arkts-apis-photoaccesshelper-album.md>) | 是 | 需要变更的相册。 |
...
对于创建相册的变更请求，在调用接口[applyChanges](<../Interface (PhotoAccessHelper)/arkts-apis-photo_93807367.md#applychanges11>)的提交生效之前，该接口会返回null。
...
| 类型 | 说明 |
| --- | --- |
| [Album](<../Interface (Album)/arkts-apis-photoaccesshelper-album.md>) | 返回当前相册变更请求中的相册。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| assets | Array<[PhotoAsset](<../Interface (PhotoAsset)/arkts-apis-photoaccesshelper-photoasset.md>)> | 是 | 待添加到相册中的资产数组。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| assets | Array<[PhotoAsset](<../Interface (PhotoAsset)/arkts-apis-photoaccesshelper-photoasset.md>)> | 是 | 待从相册中移除的资产数组。 |
