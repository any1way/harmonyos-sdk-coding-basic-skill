...
scraped_at: 2026-06-01T16:25:50+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:7272b9d71cc45e57d79be64c5ed3f10655425e248a0e32edf929906bb465187d
---
Album extends [AbsAlbum](<../Interface (AbsAlbum)/arkts-apis-photoaccesshelper-absalbum.md>).
...
从API version 10开始支持，从API version 11开始废弃。建议使用[MediaAlbumChangeRequest.addAssets](<../Class (MediaAlbumChangeRequest)/kts-apis-photo_44704870.md#addassets11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| assets | Array<[PhotoAsset](<../Interface (PhotoAsset)/arkts-apis-photoaccesshelper-photoasset.md>)> | 是 | 待添加到相册中的图片或视频数组。 |
...
从API version 10开始支持，从API version 11开始废弃。建议使用[MediaAlbumChangeRequest.removeAssets](<../Class (MediaAlbumChangeRequest)/kts-apis-photo_44704870.md#removeassets11>)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| assets | Array<[PhotoAsset](<../Interface (PhotoAsset)/arkts-apis-photoaccesshelper-photoasset.md>)> | 是 | 相册中待移除的图片或视频数组。 |
