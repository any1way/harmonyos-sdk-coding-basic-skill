...
scraped_at: 2026-06-11T16:45:04+08:00
doc_updated_at: 2026-05-12
content_hash: sha256:13e02d783d2717e7487114fa7263adeffedf45cb4fe0ba1d7f50dfa3bdac0072
---
## InAppPurchaseData
...
| price | 否 | number | 价格，单位：分。价格受如下因素影响：  - 开发者在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)中配置的商品价格  - 使用优惠后的价格，优惠类型包含[推介促销](<../../../../harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/商品购买/自动续期订阅商品购买/自动续期订阅说明/iap-subscription-functions.md#提供优惠>)、[优惠促销](<../../../../harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/商品购买/自动续期订阅商品购买/自动续期订阅说明/iap-subscription-functions.md#提供优惠>)、[挽留促销](<../../../../harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/商品购买/自动续期订阅商品购买/自动续期订阅说明/iap-subscription-functions.md#提供优惠>)  - 批量购买商品的总价格  **说明：** 为避免资金损失，在对支付结果验签成功后，必须对其进行校验。 |
...
| jwsPurchaseOrder | 否 | string | 包含订单信息的JWS格式数据。可参见[对返回结果验签](<../../REST API/对返回结果验签/iap-verifying-signature.md>)解码验签获取相关购买数据的JSON字符串，其包含的参数请参见[PurchaseOrderPayload](iap-data-model.md#purchaseorderpayload)。 |
| jwsSubscriptionStatus | 否 | string | 包含订阅状态信息的JWS格式数据。可参见[对返回结果验签](<../../REST API/对返回结果验签/iap-verifying-signature.md>)解码验签获取相关订阅状态信息的JSON字符串，其包含的参数请参见[SubGroupStatusPayload](iap-data-model.md#subgroupstatuspayload)。 |
...
| price | 是 | number | 价格，单位：分。价格受如下因素影响：  - 开发者在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)中配置的商品价格  - 使用优惠后的价格，优惠类型包含[推介促销](<../../../../harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/商品购买/自动续期订阅商品购买/自动续期订阅说明/iap-subscription-functions.md#提供优惠>)、[优惠促销](<../../../../harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/商品购买/自动续期订阅商品购买/自动续期订阅说明/iap-subscription-functions.md#提供优惠>)、[挽留促销](<../../../../harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/商品购买/自动续期订阅商品购买/自动续期订阅说明/iap-subscription-functions.md#提供优惠>)  - 批量购买商品的总价格 |
...
| 参数 | 是否必选 | 类型 | 说明 |
| --- | --- | --- | --- |
| subGroupGenerationId | 是 | string | 订阅组的代ID。  - 用户切换订阅商品时，此ID不会改变。  - 订阅失效且超出[保留期](<../../../../harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/商品购买/自动续期订阅商品购买/自动续期订阅说明/iap-subscription-functions.md#保留期>)后，用户重新购买商品时，此ID会改变。 |
| subscriptionId | 是 | string | 商品的订阅ID。以下场景，此ID会发生改变：  - 用户切换订阅商品时。  - 订阅失效且超出[保留期](<../../../../harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/商品购买/自动续期订阅商品购买/自动续期订阅说明/iap-subscription-functions.md#保留期>)后，用户重新购买商品时。 |
