...
content_hash: sha256:c7967966f87a41f2086becb8b864b0e910cdd76b564002817395483c69e3c573
---
## 功能介绍
...
| jwsPurchaseOrder | 是 | String | 已购订单相关状态信息的JWS格式数据。可参见对[返回结果验签](../对返回结果验签/iap-verifying-signature.md)处理，验签通过后解码获取相关订单状态信息，具体请参见表[PurchaseOrderPayload](../数据类型说明/iap-server-data-model.md#purchaseorderpayload)说明。 |
