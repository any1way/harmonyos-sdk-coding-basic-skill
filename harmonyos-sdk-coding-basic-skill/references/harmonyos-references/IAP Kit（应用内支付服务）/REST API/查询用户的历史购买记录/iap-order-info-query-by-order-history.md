...
scraped_at: 2026-06-01T16:34:57+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:152be9536dc564fb7a6333ac2c48f5100d85ae8fe6d573c79ac2f52dab8a1905
---
## 功能介绍
...
| jwsPurchaseOrderList | 否 | List<String> | 已购订单相关状态信息的JWS格式数据的数组。  可参见[返回结果验签](../对返回结果验签/iap-verifying-signature.md)处理，验签通过后解码获取相关订单状态信息，具体请参见[PurchaseOrderPayload](../数据类型说明/iap-server-data-model.md#purchaseorderpayload)说明。 |
