...
scraped_at: 2026-06-01T16:34:59+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:445c88c902782013d30107b9f36fe38e2308222998aa9877c44f13ba8cc1f81b
---
## 功能介绍
...
| notificationType | 否 | String | 通知主类型，不传查所有通知类型。通知主类型，具体请参见表[NotificationType](../服务端关键事件通知/iap-key-event-notifications.md#notificationtype)说明 |
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| responseCode | 是 | String | 返回码。  0：成功  失败，具体请参见[错误码](<../REST API错误码/iap-server-error-code.md>) |
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| jwsNotification | 是 | String | 通知内容信息，对通知内容NotificationPayload签名后的字符串。具体请参见表[NotificationPayload](../服务端关键事件通知/iap-key-event-notifications.md#notificationpayload)。  需要参见[对返回结果验签](../对返回结果验签/iap-verifying-signature.md)使用JWS签名方式对NotificationPayload消息体进行验签。 |
