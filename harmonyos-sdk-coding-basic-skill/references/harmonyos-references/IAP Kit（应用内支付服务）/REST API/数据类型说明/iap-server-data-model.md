...
scraped_at: 2026-06-01T16:35:04+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:0658f07b761683db375b9b07080d4fc653da99531c79e10852195e186fb1aeba
---
...
| applicationId | 是 | String | 应用ID，获取方式参见[配置应用身份信息](<../../../../harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/开发准备/配置应用身份信息/iap-config-app-identity-info.md>)。 |
...
| 参数 | 是否必选 | 类型 | 说明 |
| --- | --- | --- | --- |
| applicationId | 是 | String | APP ID，获取方式参见[配置应用身份信息](<../../../../harmonyos-guides/应用服务/IAP Kit（应用内支付服务）/开发准备/配置应用身份信息/iap-config-app-identity-info.md>)。 |
| productId | 是 | String | 商品ID。 |
...
| applicationUserName | 否 | String | 用户账户相关联的混淆字符串，唯一标识用户，传递优惠ID场景，可以传递该字段，若传递了本字段则需在[PurchaseParameter](<../../ArkTS API/IAP/iap-iap.md#purchaseparameter>)请求参数中传递一个相同的applicationUserName。 |
