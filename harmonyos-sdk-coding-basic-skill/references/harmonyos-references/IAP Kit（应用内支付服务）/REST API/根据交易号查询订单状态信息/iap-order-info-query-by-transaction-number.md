...
content_hash: sha256:6fb3d2223c9c8a036811171386ac45a857dd937f83b02a320702206109edf4f6
---
## 功能介绍
...
| jwsPurchaseOrder | 否 | String | 已购订单相关状态信息的JWS格式数据。  可参见[对返回结果验签](../对返回结果验签/iap-verifying-signature.md)处理，验签通过后解码获取相关订单状态信息，具体请参见[PurchaseOrderPayload](../数据类型说明/iap-server-data-model.md#purchaseorderpayload)说明。 |
