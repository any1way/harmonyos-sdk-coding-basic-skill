...
scraped_at: 2026-06-11T16:45:17+08:00
doc_updated_at: 2026-06-03
content_hash: sha256:cbcc86bbd71c465855bf2afbb8e57b7dcdda7a8bd13797bd6c88ff6d5f24cb59
---
## 功能介绍
...
* **接口URL：** {rootUrl}/subscription/harmony/v1/application/subscription/status/query
  ...
  说明：rootUrl具体请参见[站点信息](../公共说明/iap-rest-common-statement.md#站点信息)。
* **数据格式：**
...
| Authorization | 是 | String | 认证信息，使用JWT进行鉴权，具体请参见[Authorization说明](../生成服务端请求的token/iap-jwt-description.md#authorization说明)。 |
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| responseCode | 是 | String | 返回码。  0：成功。  其他：失败，具体请参见[错误码](<../REST API错误码/iap-server-error-code.md>)。 |
| responseMessage | 否 | String | 响应描述。 |
| jwsSubGroupStatus | 是 | String | 包含已购订阅相关状态信息的JWS格式数据。可参见[对返回结果验签](../对返回结果验签/iap-verifying-signature.md)解码验签获取相关订阅状态信息的JSON字符串，其包含的参数请参见[SubGroupStatusPayload](iap-query-subscription-status.md#subgroupstatuspayload)。 |
...
| lastPurchaseOrder | 否 | Object | 当前订阅最新的一笔购买订单。包含的参数请参见[PurchaseOrderPayload](../数据类型说明/iap-server-data-model.md#purchaseorderpayload)。 |
| recentPurchaseOrderList | 否 | List<Object> | 当前订阅最新的购买订单列表，包含续期、折算、延期等产生的购买订单。购买订单包含的参数请参见[PurchaseOrderPayload](../数据类型说明/iap-server-data-model.md#purchaseorderpayload)。 |
