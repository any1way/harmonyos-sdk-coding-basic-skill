...
scraped_at: 2026-06-01T16:05:24+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:eeeddf5f4f8093bcece56aae0a780c6e0e9c529ccec865822bdee0ce3e83c4e6
---
...
4. 轻量级智能穿戴产品不同于其他设备，仅支持[FA模型](<../../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Ability Kit术语/ability-terminology.md#fa模型>)，属性配置和接口调用方式与其他设备有所区别，详见示例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| elementName | [ElementName](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md>) | 是 | 所属应用声明NFC卡模拟能力的页面信息（至少包含bundleName、abilityName这两项的赋值），不可以为空。 |
...
start(elementName: [ElementName](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md>), aidList: string[]): void
...
stop(elementName: [ElementName](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md>)): void
