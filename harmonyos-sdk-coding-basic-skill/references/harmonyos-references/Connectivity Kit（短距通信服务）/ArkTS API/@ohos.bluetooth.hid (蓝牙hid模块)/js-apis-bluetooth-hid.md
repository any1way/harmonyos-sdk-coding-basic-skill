...
scraped_at: 2026-06-01T16:05:18+08:00
doc_updated_at: 2026-04-20
content_hash: sha256:c4386db0106d87c05839ee02bdbd2db892a0bc17f7630a4db639950f068b761b
---
本模块提供基于人机接口协议（Human Interface Device Profile，[HID](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid>)）技术的蓝牙人机交互能力，支持获取连接状态等方法。
...
| 类型 | 说明 |
| --- | --- |
| [baseProfile.BaseProfile](<../@ohos.bluetooth.baseProfile (蓝牙baseProfile模块)/js-apis-bluetooth-baseprofile.md#baseprofile>) | 基础Profile接口定义。 |
...
创建蓝牙[HID Host](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid-host>)实例。通过该实例可使用本端作为HID Host的接口，如：获取和其他设备间的蓝牙HID连接状态。
...
| 类型 | 说明 |
| --- | --- |
| HidHostProfile | 返回HID Host实例。  - 该类继承于[BaseProfile](js-apis-bluetooth-hid.md#baseprofile)，因此可以使用其父类中的方法。  - 和该实例角色相对应的是[HID Device](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid-device>)角色。 |
...
创建蓝牙[HID Device](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid-device>)实例。通过该实例可使用本端作为HID Device的接口，如：获取和其他设备间的蓝牙HID连接状态。
...
| 类型 | 说明 |
| --- | --- |
| [HidDeviceProfile](js-apis-bluetooth-hid.md#hiddeviceprofile23) | 返回HID Device实例。  - 该类继承于[BaseProfile](js-apis-bluetooth-hid.md#baseprofile)，因此可以使用其父类中的方法。  - 和该实例角色相对应的是[HID Host](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid-host>)角色。 |
...
该实例表示蓝牙HID通信中的[HID Device](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid-device>)角色。
...
* 和该实例角色相对应的是[HID Host](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid-host>)。
...
* 可通过订阅[on('connectionStateChange')](<../@ohos.bluetooth.baseProfile (蓝牙baseProfile模块)/js-apis-bluetooth-baseprofile.md#baseprofileonconnectionstatechange>)事件来感知连接是否成功。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceId | [BluetoothAddress](<../@ohos.bluetooth.common (蓝牙common模块)/js-apis-bluetooth-common.md#bluetoothaddress>) | 是 | 需要连接的对端蓝牙设备地址信息，HID设备中不涉及rawAddressType，无需给定该参数。 |
...
订阅HID主机向HID设备发送的[GET\_REPORT](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid>)传输请求事件，使用callback异步回调。收到回调后可以通过调用接口[replyReport](js-apis-bluetooth-hid.md#replyreport23)进行回复。当收到的数据不符合预期时，可以通过调用接口[reportError](js-apis-bluetooth-hid.md#reporterror23)进行回复。
...
取消订阅主机向HID设备发出的[GET\_REPORT](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid>)传输请求事件的回调。使用callback异步回调。
...
订阅HID主机向HID设备发送的[SET\_REPORT](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid>)传输请求事件，使用callback异步回调。当收到的数据不符合预期时，可以通过调用接口[reportError](js-apis-bluetooth-hid.md#reporterror23)进行回复。
...
取消订阅主机向HID设备发出的[SET\_REPORT](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid>)传输请求事件的回调。使用callback异步回调。
...
订阅HID主机向HID设备发送的[SET\_PROTOCOL](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid>)请求事件，使用callback异步回调。
...
取消订阅主机向HID设备发送的[SET\_PROTOCOL](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid>)请求事件的回调。使用callback异步回调。
...
描述HID设备在服务发现协议([SDP](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#sdp>))中的服务注册配置。该结构定义了HID设备的身份标识、能力描述和协议特征，是HID主机发现、识别和连接HID设备的关键参数。
...
描述HID主机向HID设备发送的[GET\_REPORT](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid>)传输请求事件的信息。
...
描述HID主机向HID设备发送的[SET\_REPORT](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/Connectivity Kit术语/terminology.md#hid>)传输请求事件的信息。
