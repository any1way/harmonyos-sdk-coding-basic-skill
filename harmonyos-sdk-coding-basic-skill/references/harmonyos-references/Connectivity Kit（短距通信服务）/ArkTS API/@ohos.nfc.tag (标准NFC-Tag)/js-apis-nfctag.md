...
scraped_at: 2026-06-01T16:05:27+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:b14528b2f5d31221a7f2bc6fee23f12679055cc931754e843a86240c73abd7e7
---
本模块主要用于操作及管理NFC Tag，提供后台读卡和前台应用优先分发两种读卡模式。

后台读卡是指不需要打开应用程序，电子设备通过NFC读取标签卡片后，根据标签卡片的类型匹配到一个或多个应用程序。如果仅匹配到一个，则直接拉起应用程序的读卡页面；如果是多个则弹出应用选择器，让用户选择指定的读卡应用。后台读卡不涉及tag相关接口，示例参考[nfc-tag开发指南](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/NFC/NFC标签读写开发指南/nfc-tag-access-guide.md#后台读取标签>)。
...
2. 调用本模块接口和常量时请使用canIUse("SystemCapability.Communication.NFC.Tag")判断设备是否支持NFC能力，否则可能导致应用运行稳定性问题，参考[nfc-tag开发指南](<../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/NFC/NFC标签读写开发指南/nfc-tag-access-guide.md>)。
3. 导入tag模块编辑器报错，在某个具体设备型号上能力可能超出工程默认设备定义的能力集范围，如需要使用此部分能力需额外配置自定义syscap，参考[syscap开发指南](../../../../系统能力SystemCapability使用指南/syscap.md)。
...
getNfcATag(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [NfcATag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcatag>)
...
| **类型** | **说明** |
| --- | --- |
| [NfcATag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcatag>) | NFC A类型Tag对象。 |

## tag.getNfcA9+

PhoneWearable

getNfcA(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [NfcATag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcatag>)
...
以下错误码的详细介绍请参见[NFC错误码](../../错误码/NFC错误码/errorcode-nfc.md)。
...
getNfcBTag(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [NfcBTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcbtag>)
...
| **类型** | **说明** |
| --- | --- |
| [NfcBTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcbtag>) | NFC B类型Tag对象。 |

## tag.getNfcB9+

PhoneWearable

getNfcB(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [NfcBTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcbtag>)
...
getNfcFTag(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [NfcFTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcftag>)
...
| **类型** | **说明** |
| --- | --- |
| [NfcFTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcftag>) | NFC F类型Tag对象。 |

## tag.getNfcF9+

PhoneWearable

getNfcF(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [NfcFTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcftag>)
...
getNfcVTag(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [NfcVTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcvtag>)
...
| **类型** | **说明** |
| --- | --- |
| [NfcVTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcvtag>) | NFC V类型Tag对象。 |

## tag.getNfcV9+

PhoneWearable

getNfcV(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [NfcVTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcvtag>)
...
getIsoDep(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [IsoDepTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#isodeptag9>)
...
| **类型** | **说明** |
| --- | --- |
| [IsoDepTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#isodeptag9>) | IsoDep类型Tag对象，通过该对象访问IsoDep类型的相关接口。 |
...
getNdef(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [NdefTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#ndeftag9>)
...
| **类型** | **说明** |
| --- | --- |
| [NdefTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#ndeftag9>) | NDEF类型Tag对象，通过该对象访问NDEF类型的相关接口。 |
...
getMifareClassic(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [MifareClassicTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#mifareclassictag9>)
...
| **类型** | **说明** |
| --- | --- |
| [MifareClassicTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#mifareclassictag9>) | MIFARE Classic类型Tag对象，通过该对象访问MIFARE Classic类型的相关接口。 |
...
getMifareUltralight(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [MifareUltralightTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#mifareultralighttag9>)
...
| **类型** | **说明** |
| --- | --- |
| [MifareUltralightTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#mifareultralighttag9>) | MIFARE Ultralight类型Tag对象，通过该对象访问MIFARE Ultralight类型的相关接口。 |
...
getNdefFormatable(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [NdefFormatableTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#ndefformatabletag9>)
...
| **类型** | **说明** |
| --- | --- |
| [NdefFormatableTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#ndefformatabletag9>) | NDEF Formatable类型Tag对象，通过该对象访问NDEF Formatable类型的相关接口。 |
...
getBarcodeTag(tagInfo: [TagInfo](js-apis-nfctag.md#taginfo)): [BarcodeTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#barcodetag18>)
...
| 类型 | 说明 |
| --- | --- |
| [BarcodeTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#barcodetag18>) | BarcodeTag类型Tag对象。 |
...
getTagInfo(want: [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md#want>)): [TagInfo](js-apis-nfctag.md#taginfo)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](<../../../../Ability Kit（程序框架服务）/ArkTS API/通用能力的接口(推荐)/@ohos.app.ability.Want (Want)/js-apis-app-ability-want.md#want>) | 是 | 分发Ability时，在系统onCreate入口函数的参数中获取。 |
...
registerForegroundDispatch(elementName: [ElementName](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md>), discTech: number[], callback: AsyncCallback<[TagInfo](js-apis-nfctag.md#taginfo)>): void
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| elementName | [ElementName](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md>) | 是 | 所属应用读卡的页面信息（至少包含bundleName、abilityName这两项的赋值），不可以为空。 |
...
unregisterForegroundDispatch(elementName: [ElementName](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md>)): void
...
on(type: 'readerMode', elementName: [ElementName](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md>), discTech: number[], callback: AsyncCallback<[TagInfo](js-apis-nfctag.md#taginfo)>): void
...
off(type: 'readerMode', elementName: [ElementName](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md>), callback?: AsyncCallback<[TagInfo](js-apis-nfctag.md#taginfo)>): void
...
| elementName | [ElementName](<../../../../Ability Kit（程序框架服务）/ArkTS API/接口依赖的元素及定义/bundleManager/ElementName/js-apis-bundlemanager-elementname.md>) | 是 | 所属应用读卡的页面信息（至少包含bundleName、abilityName这两项的赋值）。 |
...
9. function readerModeCb(tagInfo: tag.TagInfo) {
10. if (tagInfo == null) {
11. console.error('readerModeWithInterval tagInfo is invalid');
12. return;
13. }
14. console.info("readerModeWithInterval: tag found tagInfo = ", JSON.stringify(tagInfo));
15. // taginfo的其他操作
16. }
...
29. console.info("on start");
30. try {
31. tag.on('readerModeWithInterval', elementName, discTech, readerModeCb, interval);
32. } catch (e) {
33. console.error("tag.on error: " + (e as BusinessError).message);
34. }
35. }
...
38. console.info("onBackground");
39. try {
40. tag.off('readerModeWithInterval', elementName, readerModeCb);
41. } catch (e) {
42. console.error("tag.off error: " + (e as BusinessError).message);
43. }
44. }
...
47. console.info("onWindowStageDestroy");
48. try {
49. tag.off('readerModeWithInterval', elementName, readerModeCb);
50. } catch (e) {
51. console.error("tag.off error: " + (e as BusinessError).message);
52. }
53. }
...
messageToBytes(ndefMessage: [NdefMessage](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#ndefmessage9>)): number[]
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ndefMessage | [NdefMessage](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#ndefmessage9>) | 是 | NDEF消息数据对象。 |
...
createNdefMessage(data: number[]): [NdefMessage](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#ndefmessage9>)
...
| **类型** | **说明** |
| --- | --- |
| [NdefMessage](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#ndefmessage9>) | NDEF标签的Message，详见NDEF技术规范《NFCForum-TS-NDEF\_1.0》。 |
...
createNdefMessage(ndefRecords: NdefRecord[]): [NdefMessage](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#ndefmessage9>)
...
| 类型 | 说明 |
| --- | --- |
| [\_NfcATag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcatag>) | NfcATag 提供 NFC-A(ISO 14443-3A)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NfcBTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcbtag>) | NfcBTag 提供 NFC-B(ISO 14443-3B)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NfcFTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcftag>) | NfcFTag 提供对 NFC-F(JIS 6319-4)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NfcVTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#nfcvtag>) | NfcVTag 提供对 NFC-V(ISO 15693)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_IsoDepTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#isodeptag9>) | IsoDepTag 提供 ISO-DEP(ISO 14443-4)技术的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NdefTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#ndeftag9>) | 提供对已格式化为NDEF的NFC标签的数据和操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_MifareClassicTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#mifareclassictag9>) | MifareClassicTag提供对MIFARE Classic属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_MifareUltralightTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#mifareultralighttag9>) | MifareUltralightTag 提供对MIFARE Ultralight属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NdefFormatableTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#ndefformatabletag9>) | NdefFormatableTag为NDEF Formattable的标签提供格式化操作。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_BarcodeTag](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#barcodetag18>) | 提供对条形码标签的属性和I/O操作的访问。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_NdefMessage](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md#ndefmessage9>) | 获取NDEF消息中的所有记录。 |
...
| 类型 | 说明 |
| --- | --- |
| [\_TagSession](<../tag/tagSession (标准NFC-Tag TagSession)/js-apis-tagsession.md#tagsession>) | TagSession是所有[NFC Tag技术类型](<../tag/nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md>)的基类， 提供建立连接和发送数据等共同接口。 |
