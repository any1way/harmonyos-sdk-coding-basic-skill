...
scraped_at: 2026-06-01T16:05:38+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:745b7c7c01d55969a15a0fc5bbba82a386d9893ad403edf487f46f990f349c3b
---
...
TagSession是所有[nfcTag技术类型](<../nfctech (标准NFC-Tag Nfc 技术)/js-apis-nfctech.md>)的基类， 提供建立连接和发送数据等共同接口。

需要通过其子类来访问以下接口。在下面的示例中 统一用 getXXX()表示获取子类实例的方法。

具体使用时,请根据实际采用的nfcTag技术，选择对应的方法，具体请参见[nfcTag](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md>)文档。
...
从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[tag.getTagInfo](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#taggettaginfo9>)替代。
