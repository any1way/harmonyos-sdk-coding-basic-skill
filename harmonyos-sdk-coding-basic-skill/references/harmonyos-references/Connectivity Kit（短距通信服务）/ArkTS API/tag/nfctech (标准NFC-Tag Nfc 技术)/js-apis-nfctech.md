...
scraped_at: 2026-06-01T16:05:40+08:00
doc_updated_at: 2026-04-28
content_hash: sha256:addf30ecf0865f143fdcad69e1fb83e7477031da8f6226c67eb458d5d306fb0b
---
...
导入tag模块编辑器报错，在某个具体设备型号上能力可能超出工程默认设备定义的能力集范围，如需要使用此部分能力需额外配置自定义syscap，参考[syscap开发指南](../../../../../系统能力SystemCapability使用指南/syscap.md)。
...
NfcATag 提供 NFC-A(ISO 14443-3A)技术的属性和I/O操作的访问，继承自[TagSession](<../tagSession (标准NFC-Tag TagSession)/js-apis-tagsession.md>)。

TagSession是所有NFC Tag技术类型的基类， 提供建立连接和发送数据等共同接口。具体请参见[TagSession](<../tagSession (标准NFC-Tag TagSession)/js-apis-tagsession.md>)。

NfcATag获取方式请参考[nfc-tag开发指南](<../../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/NFC/NFC标签读写开发指南/nfc-tag-access-guide.md>)。
...
NfcBTag获取方式请参考[nfc-tag开发指南](<../../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/NFC/NFC标签读写开发指南/nfc-tag-access-guide.md>)。
...
NfcFTag获取方式请参考[nfc-tag开发指南](<../../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/NFC/NFC标签读写开发指南/nfc-tag-access-guide.md>)。
...
NfcVTag获取方式请参考[nfc-tag开发指南](<../../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/NFC/NFC标签读写开发指南/nfc-tag-access-guide.md>)。
...
IsoDepTag获取方式请参考[nfc-tag开发指南](<../../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/NFC/NFC标签读写开发指南/nfc-tag-access-guide.md>)。
...
getNdefRecords(): [tag.NdefRecord](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#ndefrecord9>)[]
...
| **类型** | **说明** |
| --- | --- |
| [tag.NdefRecord](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#ndefrecord9>)[] | NDEF标签的Record列表，详见NDEF技术规范《NFCForum-TS-NDEF\_1.0》。 |
...
NdefTag获取方式请参考[nfc-tag开发指南](<../../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/NFC/NFC标签读写开发指南/nfc-tag-access-guide.md>)。
...
getNdefTagType(): [tag.NfcForumType](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#nfcforumtype9>)
...
| **类型** | **说明** |
| --- | --- |
| [tag.NfcForumType](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#nfcforumtype9>) | NDEF标签类型，包括NFC FORUM TYPE 1/2/3/4等。 |
...
getNdefTagTypeString(type: [tag.NfcForumType](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#nfcforumtype9>)): string
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [tag.NfcForumType](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#nfcforumtype9>) | 是 | NDEF标签类型，包括NFC FORUM TYPE 1/2/3/4等。 |
...
MifareClassicTag提供对MIFARE Classic属性和I/O操作的访问，继承自[TagSession](<../tagSession (标准NFC-Tag TagSession)/js-apis-tagsession.md>)。

TagSession是所有NFC Tag技术类型的基类， 提供建立连接和发送数据等共同接口。具体请参见[TagSession](<../tagSession (标准NFC-Tag TagSession)/js-apis-tagsession.md>)。

MifareClassicTag获取方式请参考[nfc-tag开发指南](<../../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/NFC/NFC标签读写开发指南/nfc-tag-access-guide.md>)。
...
getType(): [tag.MifareClassicType](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#mifareclassictype9>)
...
| **类型** | **说明** |
| --- | --- |
| [tag.MifareClassicType](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#mifareclassictype9>) | MifareClassic标签的类型。 |
...
获取标签的存储空间大小，具体请参见[MifareClassicSize](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#mifareclassicsize9>)。
...
| **类型** | **说明** |
| --- | --- |
| number | 标签的大小，单位为字节，请参见[MifareClassicSize](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#mifareclassicsize9>)。 |
...
MifareUltralightTag获取方式请参考[nfc-tag开发指南](<../../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/NFC/NFC标签读写开发指南/nfc-tag-access-guide.md>)。
...
getType(): [tag.MifareUltralightType](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#mifareultralighttype9>)
...
| **类型** | **说明** |
| --- | --- |
| [tag.MifareUltralightType](<../../@ohos.nfc.tag (标准NFC-Tag)/js-apis-nfctag.md#mifareultralighttype9>) | MIFARE Ultralight标签的类型。 |
...
TagSession是所有NFC Tag 技术类型的基类， 提供建立连接和发送数据等共同接口。具体请参见[TagSession](<../tagSession (标准NFC-Tag TagSession)/js-apis-tagsession.md>)。

NdefFormatableTag获取方式请参考[nfc-tag开发指南](<../../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/NFC/NFC标签读写开发指南/nfc-tag-access-guide.md>)。
...
BarcodeTag获取方式请参考[nfc-tag开发指南](<../../../../../../harmonyos-guides/系统/网络/Connectivity Kit（短距通信服务）/NFC/NFC标签读写开发指南/nfc-tag-access-guide.md>)。
