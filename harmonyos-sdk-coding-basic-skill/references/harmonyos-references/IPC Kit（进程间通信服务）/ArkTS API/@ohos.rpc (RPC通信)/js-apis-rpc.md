...
scraped_at: 2026-06-01T15:59:25+08:00
doc_updated_at: 2026-05-26
content_hash: sha256:8fd808c973993e0969ec1071437df263201ca2565f3aa1d0013a7e3e91cc4e6d
---
...
以下错误码的详细介绍请参见[ohos.rpc错误码](../../错误码/RPC错误码/errorcode-rpc.md)
...
在本文档的示例中，通过this.getUIContext().getHostContext()来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需要在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](<../../../../harmonyos-guides/应用框架/Ability Kit（程序框架服务）/Stage模型开发指导/Stage模型应用组件/UIAbility组件/UIAbility组件基本用法/uiability-usage.md#获取uiability的上下文信息>)。
...
| TF\_ACCEPT\_FDS | number | 是 | 否 | 指示[sendMessageRequest](js-apis-rpc.md#sendmessagerequest9-2)接口可以传递文件描述符。 |
