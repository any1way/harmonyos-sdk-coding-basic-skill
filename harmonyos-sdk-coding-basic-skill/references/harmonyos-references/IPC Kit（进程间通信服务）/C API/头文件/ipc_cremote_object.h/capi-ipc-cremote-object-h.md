...
scraped_at: 2026-06-11T16:05:54+08:00
doc_updated_at: 2026-05-12
content_hash: sha256:b25438f704926955c3ba14b0269538c48cae7ebae15b34616be51775075a9d9e
---
## 概述
...
对应的开发指南及样例可参考[IPC与RPC通信开发指导(C/C++)](<../../../../../harmonyos-guides/应用框架/IPC Kit（进程间通信服务）/IPC与RPC通信开发指导(CC++)/ipc-capi-development-guideline.md>)
...
**相关模块：** [OHIPCRemoteObject](../../模块/OHIPCRemoteObject/capi-ohipcremoteobject.md)
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH\_IPC\_MessageOption](../../结构体/OH_IPC_MessageOption/capi-ohipcremoteobject-oh-ipc-messageoption.md) | - | IPC消息选项定义。 |
| [OHIPCDeathRecipient](../../结构体/OHIPCDeathRecipient/capi-ohipcremoteobject-ohipcdeathrecipient.md) | OHIPCDeathRecipient | 死亡通知对象。 |
...
| const [OHIPCParcel](../../模块/OHIPCParcel/capi-ohipcparcel.md) \*data | data 请求数据对象指针，不会为空，函数内不允许释放。 |
| [OHIPCParcel](../../模块/OHIPCParcel/capi-ohipcparcel.md) \*reply | reply 回应数据对象指针，不会为空，函数内不允许释放。如果函数返回错误，该值不允许写入数据。 |
...
| 类型 | 说明 |
| --- | --- |
| int | 成功返回[OH\_IPC\_ErrorCode#OH\_IPC\_SUCCESS](../ipc_error_code.h/capi-ipc-error-code-h.md#oh_ipc_errorcode)；  否则返回用户自定义错误码或系统错误码，自定义错误码范围：[1909001, 1909999]；  如果用户自定义错误码超出范围，将返回[OH\_IPC\_ErrorCode#OH\_IPC\_INVALID\_USER\_ERROR\_CODE](../ipc_error_code.h/capi-ipc-error-code-h.md#oh_ipc_errorcode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OHIPCRemoteStub](../../结构体/OHIPCRemoteStub/capi-ohipcparcel-ohipcremotestub.md) \*stub | stub 要销毁的OHIPCRemoteStub对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OHIPCRemoteProxy](../../结构体/OHIPCRemoteProxy/capi-ohipcparcel-ohipcremoteproxy.md) \*proxy | proxy 要销毁的OHIPCRemoteProxy对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [OHIPCRemoteProxy](../../结构体/OHIPCRemoteProxy/capi-ohipcparcel-ohipcremoteproxy.md) \*proxy | proxy OHIPCRemoteProxy对象指针，不能为空。 |
| uint32\_t code | code 用户定义的IPC命令字，范围：[0x01, 0x00ffffff]。 |
| const [OHIPCParcel](../../模块/OHIPCParcel/capi-ohipcparcel.md) \*data | data 请求数据对象指针，不能为空。 |
| [OHIPCParcel](../../模块/OHIPCParcel/capi-ohipcparcel.md) \*reply | reply 回应数据对象指针，同步请求时，不能为空；异步请求时，可以为空。 |
| const [OH\_IPC\_MessageOption](../../结构体/OH_IPC_MessageOption/capi-ohipcremoteobject-oh-ipc-messageoption.md) \*option | option消息选项指针，可以为空，为空时按同步处理。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| int | 发送成功返回[OH\_IPC\_ErrorCode#OH\_IPC\_SUCCESS](../ipc_error_code.h/capi-ipc-error-code-h.md#oh_ipc_errorcode)；  参数不合法时返回[OH\_IPC\_ErrorCode#OH\_IPC\_CHECK\_PARAM\_ERROR](../ipc_error_code.h/capi-ipc-error-code-h.md#oh_ipc_errorcode)；  远端OHIPCRemoteStub对象死亡返回[OH\_IPC\_ErrorCode#OH\_IPC\_DEAD\_REMOTE\_OBJECT](../ipc_error_code.h/capi-ipc-error-code-h.md#oh_ipc_errorcode)；  code超出范围返回[OH\_IPC\_ErrorCode#OH\_IPC\_CODE\_OUT\_OF\_RANGE](../ipc_error_code.h/capi-ipc-error-code-h.md#oh_ipc_errorcode)；  其它返回[OH\_IPC\_ErrorCode#OH\_IPC\_INNER\_ERROR](../ipc_error_code.h/capi-ipc-error-code-h.md#oh_ipc_errorcode)或用户自定义错误码。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OHIPCRemoteProxy](../../结构体/OHIPCRemoteProxy/capi-ohipcparcel-ohipcremoteproxy.md) \*proxy | proxy OHIPCRemoteProxy对象指针，不能为空。 |
...
| [OH\_IPC\_MemAllocator](../ipc_cparcel.h/capi-ipc-cparcel-h.md#oh_ipc_memallocator) allocator | allocator 用户指定的用来分配descriptor的内存分配器，不能为空。 |

**返回：**

| 类型 | 说明 |
| --- | --- |
| int | 发送成功返回[OH\_IPC\_ErrorCode#OH\_IPC\_SUCCESS](../ipc_error_code.h/capi-ipc-error-code-h.md#oh_ipc_errorcode)；  参数错误返回[OH\_IPC\_ErrorCode#OH\_IPC\_CHECK\_PARAM\_ERROR](../ipc_error_code.h/capi-ipc-error-code-h.md#oh_ipc_errorcode)；  远端OHIPCRemoteStub对象死亡返回[OH\_IPC\_ErrorCode#OH\_IPC\_DEAD\_REMOTE\_OBJECT](../ipc_error_code.h/capi-ipc-error-code-h.md#oh_ipc_errorcode)；  内存分配失败返回[OH\_IPC\_ErrorCode#OH\_IPC\_MEM\_ALLOCATOR\_ERROR](../ipc_error_code.h/capi-ipc-error-code-h.md#oh_ipc_errorcode)；  序列化读失败返回[OH\_IPC\_ErrorCode#OH\_IPC\_PARCEL\_READ\_ERROR](../ipc_error_code.h/capi-ipc-error-code-h.md#oh_ipc_errorcode)或用户自定义错误码。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OHIPCDeathRecipient](../../结构体/OHIPCDeathRecipient/capi-ohipcremoteobject-ohipcdeathrecipient.md) \*recipient | recipient 要销毁的OHIPCDeathRecipient对象指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OHIPCRemoteProxy](../../结构体/OHIPCRemoteProxy/capi-ohipcparcel-ohipcremoteproxy.md) \*proxy | proxy 需要添加死亡通知的OHIPCRemoteProxy对象指针，不能为空。 |
| [OHIPCDeathRecipient](../../结构体/OHIPCDeathRecipient/capi-ohipcremoteobject-ohipcdeathrecipient.md) \*recipient | recipient 用于接收远程对象死亡通知的死亡对象指针，不能为空。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OHIPCRemoteProxy](../../结构体/OHIPCRemoteProxy/capi-ohipcparcel-ohipcremoteproxy.md) \*proxy | proxy 需要移除死亡通知的OHIPCRemoteProxy对象指针，不能为空。 |
| [OHIPCDeathRecipient](../../结构体/OHIPCDeathRecipient/capi-ohipcremoteobject-ohipcdeathrecipient.md) \*recipient | recipient用于接收远程对象死亡通知的死亡对象指针，不能为空。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [OHIPCRemoteProxy](../../结构体/OHIPCRemoteProxy/capi-ohipcparcel-ohipcremoteproxy.md) \*proxy | proxy 需要判断远端是否死亡的OHIPCRemoteProxy对象指针，不能为空。 |
