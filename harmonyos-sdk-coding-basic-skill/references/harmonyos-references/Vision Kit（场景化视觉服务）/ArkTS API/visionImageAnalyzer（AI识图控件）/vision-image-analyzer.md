...
scraped_at: 2026-06-01T16:41:37+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:fde4e78cd3ce0de0826ce543561af552a77f131a6fd83bb5bee01806727ea5fc
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| value | [ResourceStr](../../../ArkUI（方舟UI框架）/ArkTS组件/公共定义/基础类型定义/ts-types.md#resourcestr) | 否 | 否 | 菜单内容。 |
| action | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<string | [Subject](vision-image-analyzer.md#subject)[]> | 否 | 否 | 菜单结果回调，包含文字选中结果和抠图结果。 |
...
| image | [PixelMap](<../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 否 | 否 | 主体识别的图片。 |
...
这是视觉图像控制器，用于控制交互。继承自[ImageAnalyzerController](../../../ArkUI（方舟UI框架）/ArkTS组件/图片与视频/图像类型定义/ts-image-common.md#imageanalyzercontroller12)类。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| point | [visionBase.Point](<../../../Core Vision Kit（基础视觉服务）/ArkTS API/visionBase（Core Vision Kit基类）/core-vision-vision-base-api.md#point>) | 是 | 相对于图片左上角位置点位（px）。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<[PixelMap](<../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | null> | Promise对象，对应id列表组装成的图片。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise<boolean> | Promise对象，返回是否开启视觉搜索。true表示开启视觉搜索，false表示关闭视觉搜索。在文字选择或主体识别状态时拉起会返回false。  **说明：**  视觉搜索若在[Swiper](../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md)容器切换图场景下无法生效，则需要在图片切换的[onAnimationStart](../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md#onanimationstart9)中置空一下当前选中图片的index，再由[onAnimationEnd](../../../ArkUI（方舟UI框架）/ArkTS组件/滚动与滑动/Swiper/ts-container-swiper.md#onanimationend9)时将当前选中index置成当前index，以此实现overlay跟随图片变动而变动。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[AIButtonStatus](vision-image-analyzer.md#aibuttonstatus)> | 是 | 回调函数。返回AIButton展示状态。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[AIButtonStatus](vision-image-analyzer.md#aibuttonstatus)> | 否 | 回调函数，返回AIButton展示状态。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[ImageAnalyzerVisibility](vision-image-analyzer.md#imageanalyzervisibility)> | 是 | 回调函数。返回AI识图控件可见状态。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[ImageAnalyzerVisibility](vision-image-analyzer.md#imageanalyzervisibility)> | 否 | 回调函数。返回AI识图控件可见状态。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<string> | 是 | 回调函数。返回文字分析结果。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<string> | 否 | 回调函数。返回文字分析结果。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<string> | 是 | 回调函数。返回文字选中结果。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<string> | 否 | 回调函数。返回文字选中结果。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[Subject](vision-image-analyzer.md#subject)[]> | 是 | 回调函数。返回主体分析结果对象数组。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[Subject](vision-image-analyzer.md#subject)[]> | 否 | 回调函数。返回主体分析结果对象数组。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[Subject](vision-image-analyzer.md#subject)[]> | 是 | 回调函数。返回选中的主体信息对象数组。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[Subject](vision-image-analyzer.md#subject)[]> | 否 | 回调函数。返回选中的主体信息对象数组。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[ObjectSearchPanelVisibility](vision-image-analyzer.md#objectsearchpanelvisibility)> | 是 | 回调函数。返回图片搜索事件信息。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<[ObjectSearchPanelVisibility](vision-image-analyzer.md#objectsearchpanelvisibility)> | 否 | 回调函数。返回图片搜索事件信息。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<void> | 是 | 回调函数。返回为空，表示光标移入图片内文字区域。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<void> | 否 | 回调函数。返回为空，表示光标移入图片内文字区域。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<void> | 是 | 回调函数。返回为空。表示光标移出图片内文字区域事件。 |
...
| callback | [Callback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#callback>)<void> | 否 | 回调函数。返回为空。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [ErrorCallback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 是 | 回调函数。返回AI识图异常场景错误信息。 |

**错误码：**

以下错误码的详细介绍请参见[ArkTS API错误码](<../../ArkTS API错误码/vision-error-code.md>)。
...
| callback | [ErrorCallback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#errorcallback>) | 否 | 回调函数。返回AI识图异常场景错误信息。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
