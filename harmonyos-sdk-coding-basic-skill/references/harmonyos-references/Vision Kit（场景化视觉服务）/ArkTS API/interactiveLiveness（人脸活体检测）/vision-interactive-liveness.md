...
scraped_at: 2026-06-01T16:41:35+08:00
doc_updated_at: 2026-04-29
content_hash: sha256:32bf031b1ed547ced67b89d1b4e2560fa9c59dc7c38099fde95e4b7dcea479ce
---
...
| challenge | string | 否 | 是 | 挑战值。仅用于安全摄像头场景（对应[initializeAttestContext](<../../../Device Security Kit（设备安全服务）/ArkTS API/TrustedAppService（可信应用服务）/devicesecurity-taas-api.md#initializeattestcontext>)方法中的“userData”字段）的活体检测。  使用安全摄像头场景的前提需要[开通Device Security服务](<../../../../harmonyos-guides/系统/安全/Device Security Kit（设备安全服务）/开发准备/开通Device Security服务/devicesecurity-deviceverify-activateservice.md>)。  长度范围是[16,128]之间（challenge传空或者undefined表示不使用安全摄像头）。  安全摄像头目前支持的设备详情请查看[约束与限制](<../../../../harmonyos-guides/系统/安全/Device Security Kit（设备安全服务）/可信应用服务/安全摄像头场景/devicesecurity-taas-securecamera.md#约束与限制>)。 |
...
| --- | --- | --- | --- |
| config | [InteractiveLivenessConfig](vision-interactive-liveness.md#interactivelivenessconfig) | 是 | 跳转到人脸活体检测页面的配置项。 |
| callback | [AsyncCallback](<../../../基础功能/Basic Services Kit（基础服务）/ArkTS API/其他/@ohos.base (公共回调信息)/js-apis-base.md#asynccallback>)<[InteractiveLivenessResult](vision-interactive-liveness.md#interactivelivenessresult) | undefined> | 是 | 回调函数。当人脸活体检测成功，err为undefined，data为获取到的InteractiveLivenessResult；否则为错误对象。当前只适用于RouteRedirectionMode.BACK\_MODE跳转模式。 |
...
| mPixelMap | [image.PixelMap](<../../../Image Kit（图片处理服务）/ArkTS API/@ohos.multimedia.image (图片处理)/Interface (PixelMap)/arkts-apis-image-pixelmap.md>) | 否 | 是 | 检测成功后返回最具有活体特征的图片。 |
